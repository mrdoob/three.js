...
function compareVertexPoints(a, b) {
...
export default QUnit.module('Maths', () => {
	...
	QUnit.module('Box3', () => {
		...
		QUnit.test('getVertexPoints', (assert) => {
			...
			assert.ok(compareVertexPoints(a.getVertexPoints(resPoints), t1), 'Passed!');
			...
			assert.ok(compareVertexPoints(b.getVertexPoints(resPoints), t2), 'Passed!');
			...
			assert.ok(compareVertexPoints(c.getVertexPoints(resPoints), t3), 'Passed!');
			...
			assert.ok(compareVertexPoints(d.getVertexPoints(resPoints), t4), 'Passed!');
