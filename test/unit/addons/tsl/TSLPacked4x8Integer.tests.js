...
export default QUnit.module( 'TSL', () => {
	...
	QUnit.module( 'packed 4x8 integer operations', () => {
		...
		gpuTest( 'pack4xU8 and pack4xI8 bit layout', ( { assert } ) => {
			...
			assert.eq( byte( pack4xU8( uvec4( 256, 0, 0, 0 ) ), 0 ), uint( 0 ), 'pack4xU8 truncates to the low byte' );
			assert.eq( byte( pack4xI8( ivec4( 128, 0, 0, 0 ) ), 0 ), uint( 0x80 ), 'pack4xI8 truncates to the low byte' );
