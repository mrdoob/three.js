...
THREE.MAXLoader = function ( manager ) {

	this.manager = ( manager !== undefined ) ? manager : THREE.DefaultLoadingManager;

};

THREE.MAXLoader.prototype = {

	constructor: THREE.MAXLoader,
	...
	parse: ( function () {
		...
		// Will still work with .3DS Files
		var normals = [
