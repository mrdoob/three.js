 /** The Shear modifier allows to incline objects, on the specified angle, in the set direction
 * options:
...
THREE.ShearModifier = function () {

};


THREE.ShearModifier.prototype = {

    constructor: THREE.ShearModifier,
    ...
    modify: function ( geometry ) {
		...
		var ShearMatrix =  new THREE.Matrix4(); // ShearMatrix = InverseP * matrix * P
		ShearMatrix.multiplyMatrices( P, matrix ); ShearMatrix.multiplyMatrices( ShearMatrix, InverseP );
		geometry.applyMatrix( ShearMatrix );
