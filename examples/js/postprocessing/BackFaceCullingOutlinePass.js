...
THREE.BackFaceCullingOutlinePass = function ( scene, camera, parameters ) {
	...
	this.clear = parameters.clear !== undefined ? parameters.clear : false; // assumes that outline rendering goes after normal scene rendering.
	...
	this.render = function ( renderer, writeBuffer, readBuffer, delta, maskActive ) {

		var scene = this.scene;
		var camera = this.camera;

		var tmpAutoClear = renderer.autoClear;
		var tmpShadowEnabled = renderer.shadowMap.enabled;
		...
		renderer.shadowMap.enabled = tmpShadowEnabled;

	};

};

THREE.BackFaceCullingOutlinePass.prototype = Object.create( THREE.Pass.prototype );
THREE.BackFaceCullingOutlinePass.prototype.constructor = THREE.BackFaceCullingOutlinePass;
