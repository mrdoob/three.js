...
/**
 *  Small change of ParallaxBarrierEffect To work on 3D TV sets or so.  
 *  Basicly these TVs are Row Interleaved format.
 *  @author racerxdl
 */
THREE.RowInterleavedEffect = function ( renderer ) {
	...
	var _material = new THREE.ShaderMaterial( {
        ...
        //  Here its the trick to RowInterleaved 3D, I changed the original gl_FragCoord.x of the Parallax Barrier to y.
