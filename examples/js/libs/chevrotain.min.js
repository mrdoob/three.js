		...
		var t = {
								...
								typeof (n = function () {
									...
									(t.prototype.saveState = function () {
										...
										(t.prototype.alternative = function () {
											for (var t = [], e = this.idx; this.isTerm(); )
												t.push(this.term());
											return {
												type: "Alternative",
												value: t,
				...
				105: (t, e, n) => {
					...
					Object.defineProperty(e, "__esModule", { value: !0 }),
						(e.defineNameProp =
							e.functionName =
							e.classNameFromInstance =
								void 0);
					var r = n(146);
					e.classNameFromInstance = function (t) {
						return o(t.constructor);
					};
					var i = "name";
					function o(t) {
					...
					Object.defineProperty(e, "__esModule", { value: !0 }),
						(e.addNoneTerminalToCst =
							...
							e.setNodeLocationOnlyOffset =
								void 0),
						(e.setNodeLocationOnlyOffset = function (t, e) {
							!0 === isNaN(t.startOffset)
								? ((t.startOffset = e.startOffset), (t.endOffset = e.endOffset))
								: t.endOffset < e.endOffset == 1 && (t.endOffset = e.endOffset);
						}),
				...
				169: (t, e, n) => {
								...
								((n.prototype = {
									visit: function (t, e) {
										if ((i.isArray(t) && (t = t[0]), !i.isUndefined(t)))
											return this[t.name](t.children, e);
									},
					...
					var u = ["constructor", "visit", "validateVisitor"];
					function l(t, e) {
						var n = [];
						for (var a in t)
							!i.isFunction(t[a]) ||
				...
				643: function (t, e, n) {
					...
					e.NotAllInputParsedException = d;
					var E = (function (t) {
						function e(e, n, r) {
							var i = t.call(this, e, n) || this;
				...
				870: function (t, e, n) {
					...
					var o = n(146),
						...
						f = n(841);
					function h(t) {
						return c.getProductionDslName(t) + "_#_" + t.idx + "_#_" + d(t);
					}
					function d(t) {
						return t instanceof p.Terminal
							? t.terminalType.name
							: t instanceof p.NonTerminal
							? t.nonTerminalName
							: "";
					}
					(e.validateGrammar = function (t, e, n, r, i) {
						var u = o.map(t, function (t) {
								return (function (t, e) {
									var n = new E();
									t.accept(n);
						...
						return o.flatten(u.concat(T, l, p, f, v, g, N));
					}),
						(e.identifyProductionForDuplicates = h);
					var E = (function (t) {
						function e() {
						...
						return (
							...
							(e.prototype.visitRepetitionMandatoryWithSeparator = function (
								t
							) {
								this.allProductions.push(t);
							}),
					...
					function y(t, e, n, r) {
						...
						var u = o.difference(a, r.concat([t])),
							l = o.map(u, function (e) {
								var i = o.cloneArr(r);
								return i.push(e), y(t, e, n, i);
							});
						return i.concat(o.flatten(l));
					}
					function T(t) {
						var e = [];
						if (o.isEmpty(t)) return e;
						var n = o.first(t);
						if (n instanceof p.NonTerminal) e.push(n.referencedRule);
						else if (
							n instanceof p.Alternative ||
							n instanceof p.Option ||
							n instanceof p.RepetitionMandatory ||
							n instanceof p.RepetitionMandatoryWithSeparator ||
							n instanceof p.RepetitionWithSeparator ||
							n instanceof p.Repetition
						)
							e = e.concat(T(n.definition));
						else if (n instanceof p.Alternation)
							e = o.flatten(
								o.map(n.definition, function (t) {
									return T(t.definition);
								})
							);
						else if (!(n instanceof p.Terminal))
					...
					(e.OccurrenceValidationCollector = E),
						(e.validateRuleDoesNotAlreadyExist = m),
						...
						(e.validateNoLeftRecursion = y),
						(e.getFirstNoneTerminal = T);
					var v = (function (t) {
						function e() {
							var e = (null !== t && t.apply(this, arguments)) || this;
						...
						return (
							...
							o.reduce(
								...
								function (r, i) {
									var c = i.idx,
										l = i.maxLookahead || e,
										p = u.getLookaheadPathsForOr(c, t, l, i),
										f = (function (t, e, n, r) {
											var i = [],
												c = a.reduce(
													t,
													function (n, r, o) {
														return (
															!0 === e.definition[o].ignoreAmbiguities ||
																a.forEach(r, function (r) {
																	...
																	a.forEach(t, function (t, n) {
																		o !== n &&
																			u.containsPath(t, r) &&
																			!0 !==
																				e.definition[n].ignoreAmbiguities &&
																			s.push(n);
																	}),
																		s.length > 1 &&
																			!u.containsPath(i, r) &&
																			(i.push(r), n.push({ alts: s, path: r }));
																}),
															n
														);
													},
					...
					(e.validateEmptyOrAlternative = R),
						(e.validateAmbiguousAlternationAlternatives = O);
					var g = (function (t) {
						function e() {
							var e = (null !== t && t.apply(this, arguments)) || this;
							return (e.allProductions = []), e;
						...
						return (
							a.forEach(t, function (t) {
								...
								a.forEach(o, function (i) {
									var o = u.getProdType(i),
										c = i.maxLookahead || e,
										l = i.idx,
										p = u.getLookaheadPathsForOptionalProd(l, t, o, c)[0];
									if (a.isEmpty(a.flatten(p))) {
						...
						return (
							a.forEach(o, function (t) {
								if (!0 !== e.definition[t.idx].ignoreAmbiguities) {
									var c = t.idx,
										l = t.path,
										p = a.findAll(o, function (t) {
											return (
												!0 !== e.definition[t.idx].ignoreAmbiguities &&
												t.idx < c &&
												u.isStrictPrefixOfPath(t.path, l)
											);
										}),
										f = a.map(p, function (t) {
											var i = [t.idx + 1, c + 1],
												o = 0 === e.idx ? "" : e.idx;
											return {
					...
					(e.RepetionCollector = g),
						(e.validateTooManyAlts = A),
						(e.validateSomeNonEmptyLookaheadPath = _),
						(e.checkPrefixAlternativesAmbiguities = N);
				},
				52: (t, e, n) => {
					"use strict";
					Object.defineProperty(e, "__esModule", { value: !0 }),
					...
					function s(t) {
						for (
							var e, n = [], i = t.definition, s = 0, c = i.length > s, u = !0;
							c && u;

						)
							(e = i[s]),
								(u = o.isOptionalProd(e)),
								(n = n.concat(a(e))),
								(s += 1),
								(c = i.length > s);
						return r.uniq(n);
					...
					(e.first = a),
						...
						(e.firstForBranching = c),
						(e.firstForTerminal = u);
				},
				917: function (t, e, n) {
					"use strict";
					var r,
						...
						l = (function (t) {
							...
							return (
								...
								(e.prototype.walkProdRef = function (t, e, n) {
									var r = p(t.referencedRule, t.idx) + this.topProd.name,
										i = e.concat(n),
										o = new u.Alternative({ definition: i }),
										s = a.first(o);
									this.follows[r] = s;
								}),
								e
					...
					(e.ResyncFollowsWalker = l),
						...
						(e.buildBetweenProdsFollowPrefix = p),
				...
				985: function (t, e, n) {
						...
						return (
							...
							(e.prototype.walkTerminal = function (t, e, n) {
								if (
									...
									var r = e.concat(n),
										i = new c.Alternative({ definition: r });
					...
					e.NextTerminalAfterManySepWalker = h;
					var d = (function (t) {
						function e() {
							return (null !== t && t.apply(this, arguments)) || this;
						}
							...
							for (; r.length < n && o < e.length; ) {
								...
								if (u instanceof c.Option) i = s(u.definition);
									...
									if (u instanceof c.RepetitionMandatoryWithSeparator)
										return s(
											(l = [
												new c.Alternative({ definition: u.definition }),
												new c.Repetition({
													definition: [
									...
									if (!a.isEmpty(E)) {
										...
										if (R === i) {
											var O = {
												idx: y,
												def: a.drop(E),
												ruleStack: a.dropRight(T),
												occurrenceStack: a.dropRight(v),
											};
											h.push(O);
										} else if (R instanceof c.Terminal)
											if (y < l - 1) {
												var g = y + 1;
												n(e[g], R.terminalType) &&
													((O = {
														idx: g,
														def: a.drop(E),
														ruleStack: T,
												...
												if (y !== l - 1) throw Error("non exhaustive match");
												f.push({
											...
											_.push(R.idx),
												(O = {
													idx: y,
													def: R.definition.concat(o, a.drop(E)),
													ruleStack: A,
													occurrenceStack: _,
												}),
												h.push(O);
											...
											var I = {
												idx: y,
												def: R.definition.concat(a.drop(E)),
												ruleStack: T,
												occurrenceStack: v,
											};
											h.push(I);
										} else if (R instanceof c.RepetitionMandatory) {
											var P = new c.Repetition({
												definition: R.definition,
												idx: R.idx,
											});
											(O = {
												idx: y,
												def: R.definition.concat([P], a.drop(E)),
												ruleStack: T,
												occurrenceStack: v,
											}),
												h.push(O);
										} else if (
											R instanceof c.RepetitionMandatoryWithSeparator
										) {
											var S = new c.Terminal({ terminalType: R.separator });
											(P = new c.Repetition({
												definition: [S].concat(R.definition),
												idx: R.idx,
											})),
												(O = {
													idx: y,
											...
											(N = {
												...
												h.push(N),
												h.push(s),
												(S = new c.Terminal({ terminalType: R.separator }));
											var k = new c.Repetition({
												definition: [S].concat(R.definition),
												idx: R.idx,
											});
											(I = {
												idx: y,
												def: R.definition.concat([k], a.drop(E)),
												ruleStack: T,
												occurrenceStack: v,
											}),
												h.push(I);
											...
											(N = {
												...
												h.push(I);
										else if (R instanceof c.Alternation)
											for (var L = R.definition.length - 1; L >= 0; L--) {
												var C = {
													idx: y,
													def: R.definition[L].definition.concat(a.drop(E)),
													ruleStack: T,
													occurrenceStack: v,
												};
												h.push(C), h.push(s);
											}
										else if (R instanceof c.Alternative)
											h.push({
												idx: y,
												def: R.definition.concat(a.drop(E)),
												ruleStack: T,
											...
											if (!(R instanceof c.Rule))
												throw Error("non exhaustive match");
											h.push(m(R, y, T, v));
										}
									}
								} else u && a.last(h).idx <= p && h.pop();
							}
							return f;
						});
				},
				209: (t, e) => {
					...
					Object.defineProperty(e, "__esModule", { value: !0 }),
						...
						(e.getKeyForAutomaticLookahead = function (t, e, n) {
							return n | e | t;
						}),
						e.BITS_FOR_ALT_IDX;
				},
				677: function (t, e, n) {
					...
					!(function (t) {
						...
						(e.getProdType = function (t) {
							if (t instanceof l.Option) return o.OPTION;
							if (t instanceof l.Repetition) return o.REPETITION;
							if (t instanceof l.RepetitionMandatory)
								return o.REPETITION_MANDATORY;
							if (t instanceof l.RepetitionMandatoryWithSeparator)
								return o.REPETITION_MANDATORY_WITH_SEPARATOR;
							if (t instanceof l.RepetitionWithSeparator)
								return o.REPETITION_WITH_SEPARATOR;
							if (t instanceof l.Alternation) return o.ALTERNATION;
							throw Error("non exhaustive match");
						}),
						(e.buildLookaheadFuncForOr = function (t, e, n, r, i, o) {
							...
							return o(
								...
								r,
								O(a)
									? u.tokenStructuredMatcherNoCategories
									: u.tokenStructuredMatcher,
								i
							);
						}),
								...
								return function (e) {
									for (
										...
										if (void 0 === u || !1 !== u.call(this))
											t: for (var l = 0; l < c; l++) {
												for (var p = s[l], f = p.length, h = 0; h < f; h++) {
													var d = this.LA(h + 1);
													if (!1 === n(d, p[h])) continue t;
												}
												return o;
											}
									}
							...
							for (
								var l = function (t) {
										for (var n = u[t], l = 0; l < n.length; l++) {
											var p = n[l].partialPath,
												f = n[l].suffixDef,
												h = E(p);
											if (m(i, h, t) || a.isEmpty(f) || p.length === e) {
												var d = r[t];
												if (!1 === R(d, p)) {
													d.push(p);
												...
												var v = s.possiblePathsFrom(f, c + 1, p);
												(o[t] = o[t].concat(v)),
													a.forEach(v, function (e) {
														var n = E(e.partialPath);
					...
					function T(t, e, n, r) {
						var i = new h(t, o.ALTERNATION, r);
						return e.accept(i), y(i.result, n);
					}
					function v(t, e, n, r) {
						var i = new h(t, n);
						e.accept(i);
						var o = i.result,
							a = new f(e, t, n).startWalking();
						return y(
							[
								new l.Alternative({ definition: o }),
								new l.Alternative({ definition: a }),
							],
							r
						);
					}
						...
						t: for (var n = 0; n < t.length; n++) {
							...
							if (r.length === e.length) {
								for (var i = 0; i < r.length; i++) {
									...
									if (
										!1 ==
										(o === a || void 0 !== a.categoryMatchesMap[o.tokenTypeIdx])
									)
										continue t;
								}
								return !0;
					...
					(e.lookAheadSequenceFromAlternatives = y),
						(e.getLookaheadPathsForOr = T),
						(e.getLookaheadPathsForOptionalProd = v),
						(e.containsPath = R),
						...
						o = (function () {
							...
							return (
								(t.prototype.walk = function (t, e) {
									...
									void 0 === e && (e = []),
										r.forEach(t.definition, function (o, a) {
											...
											else if (o instanceof i.Alternative) n.walkFlat(o, s, e);
								...
								(t.prototype.walkAtLeastOne = function (t, e, n) {
									var r = [new i.Option({ definition: t.definition })].concat(
										e,
										n
									);
									this.walk(t, r);
								...
								(t.prototype.walkOr = function (t, e, n) {
									...
									r.forEach(t.definition, function (t) {
										var e = new i.Alternative({ definition: [t] });
										o.walk(e, a);
									});
								}),
								t
				...
				941: function (t, e, n) {
					...
					var o,
						...
						R = n(906),
						O = n(803);
					(e.END_OF_FILE = c.createTokenInstance(
						c.EOF,
						"",
						NaN,
						NaN,
						...
						(e.DEFAULT_PARSER_CONFIG = Object.freeze({
							...
							outputCst: !0,
							errorMessageProvider: u.defaultParserErrorProvider,
						...
						((o =
							e.ParserDefinitionErrorType ||
							(e.ParserDefinitionErrorType = {}))[(o.INVALID_RULE_NAME = 0)] =
							"INVALID_RULE_NAME"),
						(o[(o.DUPLICATE_RULE_NAME = 1)] = "DUPLICATE_RULE_NAME"),
						(o[(o.INVALID_RULE_OVERRIDE = 2)] = "INVALID_RULE_OVERRIDE"),
						(o[(o.DUPLICATE_PRODUCTIONS = 3)] = "DUPLICATE_PRODUCTIONS"),
						(o[(o.UNRESOLVED_SUBRULE_REF = 4)] = "UNRESOLVED_SUBRULE_REF"),
						(o[(o.LEFT_RECURSION = 5)] = "LEFT_RECURSION"),
						(o[(o.NONE_LAST_EMPTY_ALT = 6)] = "NONE_LAST_EMPTY_ALT"),
						(o[(o.AMBIGUOUS_ALTS = 7)] = "AMBIGUOUS_ALTS"),
						(o[(o.CONFLICT_TOKENS_RULES_NAMESPACE = 8)] =
							"CONFLICT_TOKENS_RULES_NAMESPACE"),
						(o[(o.INVALID_TOKEN_NAME = 9)] = "INVALID_TOKEN_NAME"),
						(o[(o.NO_NON_EMPTY_LOOKAHEAD = 10)] = "NO_NON_EMPTY_LOOKAHEAD"),
						(o[(o.AMBIGUOUS_PREFIX_ALTS = 11)] = "AMBIGUOUS_PREFIX_ALTS"),
						(o[(o.TOO_MANY_ALTS = 12)] = "TOO_MANY_ALTS"),
					...
					var g = (function () {
						function t(t, n) {
							...
							if (
								...
								a.has(n, "ignoredIssues"))
							)
								throw new Error(
									"The <ignoredIssues> IParserConfig property has been deprecated.\n\tPlease use the <IGNORE_AMBIGUITIES> flag on the relevant DSL method instead.\n\tSee: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#IGNORING_AMBIGUITIES\n\tFor further details."
								);
							this.skipValidations = a.has(n, "skipValidations")
								? n.skipValidations
								...
								this.TRACE_INIT("performSelfAnalysis", function () {
									...
									e.TRACE_INIT("toFastProps", function () {
										...
										e.TRACE_INIT("Grammar Recording", function () {
											try {
												e.enableRecording(),
													a.forEach(e.definedRulesNames, function (t) {
									...
									if (
										...
										e.TRACE_INIT("Grammar Validations", function () {
											if (a.isEmpty(i) && !1 === e.skipValidations) {
												var t = l.validateGrammar({
													rules: a.values(e.gastProductionsCache),
													maxLookahead: e.maxLookahead,
													tokenTypes: a.values(e.tokensMap),
													errMsgProvider:
										...
										a.isEmpty(e.definitionErrors) &&
											(e.recoveryEnabled &&
												e.TRACE_INIT("computeAllProdsFollows", function () {
													var t = s.computeAllProdsFollows(
														a.values(e.gastProductionsCache)
													);
													e.resyncFollows = t;
												}),
										...
										throw (
											((n = a.map(e.definitionErrors, function (t) {
												return t.message;
											})),
											new Error(
						...
						s = (function () {
							...
							return (
								(t.prototype.initErrorHandler = function (t) {
									(this._errors = []),
										(this.errorMessageProvider = i.has(
											t,
								...
								(t.prototype.raiseEarlyExitException = function (t, e, n) {
									for (
										...
										c.push(this.LA(u));
									var l = this.errorMessageProvider.buildEarlyExitMessage({
									...
									throw this.SAVE_ERROR(
										new r.EarlyExitException(l, this.LA(1), this.LA(0))
									);
								}),
								(t.prototype.raiseNoAltException = function (t, e) {
									...
									throw this.SAVE_ERROR(
										new r.NoViableAltException(l, this.LA(1), u)
									);
								}),
								t
							);
				...
				688: (t, e, n) => {
					...
					Object.freeze(l);
					var p = Math.pow(2, u.BITS_FOR_OCCURRENCE_IDX) - 1,
						f = s.createToken({
							name: "RECORDING_PHASE_TOKEN",
							pattern: o.Lexer.NA,
						});
					a.augmentTokenTypes([f]);
					var h = s.createTokenInstance(
						f,
						...
						E = (function () {
							...
							return (
								...
								(t.prototype.topLevelRuleRecord = function (t, e) {
									try {
										var n = new i.Rule({ definition: [], name: t });
										return (
											(n.name = t),
								...
								(t.prototype.optionInternalRecord = function (t, e) {
									return m.call(this, i.Option, t, e);
								}),
								(t.prototype.atLeastOneInternalRecord = function (t, e) {
									m.call(this, i.RepetitionMandatory, e, t);
								}),
								(t.prototype.atLeastOneSepFirstInternalRecord = function (
									t,
									e
								) {
									m.call(this, i.RepetitionMandatoryWithSeparator, e, t, !0);
								}),
								(t.prototype.manyInternalRecord = function (t, e) {
									m.call(this, i.Repetition, e, t);
								}),
								(t.prototype.manySepFirstInternalRecord = function (t, e) {
									m.call(this, i.RepetitionWithSeparator, e, t, !0);
								}),
								(t.prototype.orInternalRecord = function (t, e) {
									return y.call(this, t, e);
								}),
								(t.prototype.subruleInternalRecord = function (t, e, n) {
									if ((v(e), !t || !1 === r.has(t, "ruleName"))) {
										var o = new Error(
											"<SUBRULE" +
												T(e) +
									...
									var a = r.peek(this.recordingProdStack),
										s = t.ruleName,
										c = new i.NonTerminal({
											idx: e,
											nonTerminalName: s,
									...
									return a.definition.push(c), this.outputCst ? d : l;
								}),
								(t.prototype.consumeInternalRecord = function (t, e, n) {
									if ((v(e), !a.hasShortKeyProperty(t))) {
										var o = new Error(
											"<CONSUME" +
												T(e) +
									...
									var s = r.peek(this.recordingProdStack),
										c = new i.Terminal({ idx: e, terminalType: t });
					...
					function m(t, e, n, i) {
						void 0 === i && (i = !1), v(n);
						var o = r.peek(this.recordingProdStack),
							a = r.isFunction(e) ? e : e.DEF,
							s = new t({ definition: [], idx: n });
						return (
							i && (s.separator = e.SEP),
							r.has(e, "MAX_LOOKAHEAD") && (s.maxLookahead = e.MAX_LOOKAHEAD),
					...
					function y(t, e) {
						...
						return (
							...
							r.forEach(s, function (t) {
								var e = new i.Alternative({ definition: [] });
								c.definition.push(e),
									r.has(t, "IGNORE_AMBIGUITIES")
										? (e.ignoreAmbiguities = t.IGNORE_AMBIGUITIES)
										: r.has(t, "GATE") && (e.ignoreAmbiguities = !0),
						...
						i = (function () {
							...
							return (
								...
								(t.prototype.LA = function (t) {
									...
									return e < 0 || this.tokVectorLength <= e
										? r.END_OF_FILE
										: this.tokVector[e];
								}),
					...
					var r = n(677),
						...
						c = (function () {
							...
							return (
								...
								(t.prototype.preComputeLookaheadFunctions = function (t) {
									...
									i.forEach(t, function (t) {
										e.TRACE_INIT(t.name + " Rule Lookahead", function () {
											var n = s.collectMethods(t),
												o = n.alternation,
												c = n.repetition,
												u = n.option,
												l = n.repetitionMandatory,
												p = n.repetitionMandatoryWithSeparator,
												f = n.repetitionWithSeparator;
											i.forEach(o, function (n) {
												var i = 0 === n.idx ? "" : n.idx;
												e.TRACE_INIT(
													"" + s.getProductionDslName(n) + i,
													function () {
														var i = r.buildLookaheadFuncForOr(
																n.idx,
																t,
																n.maxLookahead || e.maxLookahead,
																n.hasPredicates,
																e.dynamicTokensEnabled,
																e.lookAheadBuilderForAlternatives
															),
															o = a.getKeyForAutomaticLookahead(
																e.fullRuleNameToShort[t.name],
																a.OR_IDX,
																n.idx
															);
								...
								(t.prototype.computeLookaheadFunc = function (
									t,
									e,
									n,
									i,
									...
									this.TRACE_INIT("" + s + (0 === e ? "" : e), function () {
										var s = r.buildLookaheadFuncForOptionalProd(
												e,
												t,
												o || c.maxLookahead,
												c.dynamicTokensEnabled,
												i,
												c.lookAheadBuilderForOptional
											),
											u = a.getKeyForAutomaticLookahead(
												c.fullRuleNameToShort[t.name],
												n,
												e
											);
								...
								(t.prototype.initPerformanceTracer = function (t) {
									if (r.has(t, "traceInitPerf")) {
										var e = t.traceInitPerf,
											n = "number" == typeof e;
										(this.traceInitMaxIdent = n ? e : 1 / 0),
											(this.traceInitPerf = n ? e > 0 : e);
									} else
										(this.traceInitMaxIdent = 0),
											(this.traceInitPerf =
												i.DEFAULT_PARSER_CONFIG.traceInitPerf);
								...
								(t.prototype.TRACE_INIT = function (t, e) {
									if (!0 === this.traceInitPerf) {
										...
										var i = r.timer(e),
											o = i.time,
											a = i.value,
											s = o > 10 ? console.warn : console.log;
										return (
											this.traceInitIndent < this.traceInitMaxIdent &&
												s(n + "<-- <" + t + "> time: " + o + "ms"),
											this.traceInitIndent--,
							...
							return (
								...
								(t.prototype.getSerializedGastProductions = function () {
									return c.serializeGrammar(
										r.values(this.gastProductionsCache)
									);
								}),
								t
							);
						...
						h = (function () {
							...
							return (
								(t.prototype.initRecognizerEngine = function (t, e) {
									if (
										((this.className = f.classNameFromInstance(this)),
										(this.shortRuleNameToFull = {}),
										(this.fullRuleNameToShort = {}),
										(this.ruleShortNameIdx = 256),
										(this.tokenMatcher = p.tokenStructuredMatcherNoCategories),
										(this.definedRulesNames = []),
										(this.tokensMap = {}),
									...
									if (r.isArray(t))
										...
										r.has(t, "modes") &&
										r.every(r.flatten(r.values(t.modes)), p.isTokenType)
									) {
									...
									(this.tokenMatcher = o
										? p.tokenStructuredMatcherNoCategories
										: p.tokenStructuredMatcher),
								...
								(t.prototype.defineRule = function (t, e, n) {
									...
									var o = r.has(n, "resyncEnabled")
											? n.resyncEnabled
											: c.DEFAULT_RULE_CONFIG.resyncEnabled,
										a = r.has(n, "recoveryValueFunc")
											? n.recoveryValueFunc
											: c.DEFAULT_RULE_CONFIG.recoveryValueFunc,
										s =
											this.ruleShortNameIdx <<
											(i.BITS_FOR_METHOD_TYPE + i.BITS_FOR_OCCURRENCE_IDX);
									function u(t) {
										try {
											if (!0 === this.outputCst) {
												e.apply(this, t);
									...
									this.ruleShortNameIdx++,
										(this.shortRuleNameToFull[s] = t),
										(this.fullRuleNameToShort[t] = s);
									var l = function (e, n) {
										return (
											void 0 === e && (e = 0),
											this.ruleInvocationStateUpdate(s, t, e),
											u.call(this, n)
										);
									};
									return (l.ruleName = t), (l.originalGrammarAction = e), l;
								}),
									...
									if (o.isRecognitionException(t)) {
										...
										if (i) {
											...
											if (this.isInCurrentRuleReSyncSet(c))
												return (
													(a.resyncedTokens = this.reSyncTo(c)),
													this.outputCst
														? (((s =
																this.CST_STACK[
								...
								(t.prototype.atLeastOneInternalLogic = function (t, e, n) {
									...
									for (
										var p = this.doSingleRepetition(r);
										!0 === u.call(this) && !0 === p;
								...
								(t.prototype.atLeastOneSepFirstInternalLogic = function (
									t,
									e,
									n
								) {
									...
									for (
										...
										!0 === this.tokenMatcher(this.LA(1), c);

									)
										this.CONSUME(c), o.call(this);
									this.attemptInRepetitionRecovery(
										this.repetitionSepSecondInternal,
										[t, c, u, o, s.NextTerminalAfterAtLeastOneSepWalker],
										u,
										i.AT_LEAST_ONE_SEP_IDX,
										t,
								...
								(t.prototype.manyInternalLogic = function (t, e, n) {
									var r,
										o,
										a = this,
										c = this.getLaFuncFromCache(n);
									if (void 0 !== e.DEF) {
										if (((r = e.DEF), void 0 !== (o = e.GATE))) {
											var u = c;
											c = function () {
												return o.call(a) && u.call(a);
											};
										}
									} else r = e;
									for (var l = !0; !0 === c.call(this) && !0 === l; )
								...
								(t.prototype.manySepFirstInternalLogic = function (t, e, n) {
									...
									if (!0 === this.getLaFuncFromCache(n).call(this)) {
										...
										this.attemptInRepetitionRecovery(
											this.repetitionSepSecondInternal,
											[t, a, c, o, s.NextTerminalAfterManySepWalker],
											c,
											i.MANY_SEP_IDX,
											t,
								...
								(t.prototype.subruleInternalError = function (t, e, n) {
									throw (
										(o.isRecognitionException(t) &&
											...
											(this.cstPostNonTerminal(
												t.partialCstResult,
												void 0 !== e && void 0 !== e.LABEL ? e.LABEL : n
											),
								...
								(t.prototype.consumeInternal = function (t, e, n) {
									...
									return (
										this.cstPostTerminal(
											void 0 !== n && void 0 !== n.LABEL ? n.LABEL : t.name,
											r
										),
										r
									);
				...
				992: (t, e, n) => {
						...
						return (
							(t.prototype.initRecoverable = function (t) {
								(this.firstAfterRepMap = {}),
									...
									(this.recoveryEnabled = i.has(t, "recoveryEnabled")
										? t.recoveryEnabled
										: s.DEFAULT_PARSER_CONFIG.recoveryEnabled),
									this.recoveryEnabled &&
							...
							(t.prototype.tryInRepetitionRecovery = function (t, e, n, r) {
								for (
									...
									if (this.tokenMatcher(f, r)) return void h();
									if (n.call(this)) return h(), void t.apply(this, e);
							...
							(t.prototype.findReSyncTokenType = function () {
								for (
									var t = this.flattenFollowSet(), e = this.LA(1), n = 2;
									;
					...
					function l(t, e, n, i, o, a, s) {
						var c = this.getKeyForAutomaticLookahead(i, o),
							u = this.firstAfterRepMap[c];
						if (void 0 === u) {
							var l = this.getCurrRuleFullName();
							(u = new a(this.getGAstProductions()[l], o).startWalking()),
								(this.firstAfterRepMap[c] = u);
						}
						var p = u.token,
							f = u.occurrence,
							h = u.isEndOfRule;
						1 === this.RULE_STACK.length &&
							...
							void 0 === p &&
							((p = r.EOF), (f = 1)),
							this.shouldInRepetitionRecoveryBeTried(p, f, s) &&
							...
							return (
								(t.prototype.initTreeBuilder = function (t) {
									if (
										...
										(this.nodeLocationTracking = i.has(
											t,
											"nodeLocationTracking"
										)
											? t.nodeLocationTracking
											: a.DEFAULT_PARSER_CONFIG.nodeLocationTracking),
										this.outputCst)
									)
										if (/full/i.test(this.nodeLocationTracking))
											this.recoveryEnabled
												? ((this.setNodeLocationFromToken =
														r.setNodeLocationFull),
												  (this.setNodeLocationFromNode =
														r.setNodeLocationFull),
												  (this.cstPostRule = i.NOOP),
												  (this.setInitialNodeLocation =
														this.setInitialNodeLocationFullRecovery))
												: ((this.setNodeLocationFromToken = i.NOOP),
												  (this.setNodeLocationFromNode = i.NOOP),
								...
								(t.prototype.setInitialNodeLocationOnlyOffsetRegular =
									function (t) {
										t.location = {
								...
								(t.prototype.cstPostTerminal = function (t, e) {
									...
									r.addTerminalToCst(n, e, t),
										this.setNodeLocationFromToken(n.location, e);
								}),
								(t.prototype.cstPostNonTerminal = function (t, e) {
									var n = this.CST_STACK[this.CST_STACK.length - 1];
									r.addNoneTerminalToCst(n, e, t),
								...
								(t.prototype.getBaseCstVisitorConstructor = function () {
									if (i.isUndefined(this.baseCstVisitorConstructor)) {
										var t = o.createBaseSemanticVisitorConstructor(
											this.className,
											i.keys(this.gastProductionsCache)
										);
								...
								(t.prototype.getBaseCstVisitorConstructorWithDefaults =
									function () {
										if (
											i.isUndefined(this.baseCstVisitorWithDefaultsConstructor)
										) {
											...
											return (
												(this.baseCstVisitorWithDefaultsConstructor = t), t
											);
										}
				...
				178: function (t, e, n) {
					...
					(e.DEFAULT_MODE = "defaultMode"),
						...
						(e.analyzeTokenTypes = function (t, n) {
							...
							i("initCharCodeToOptimizedIndexMap", function () {
								!(function () {
									if (s.isEmpty(L)) {
										L = new Array(65536);
										for (var t = 0; t < 65536; t++)
											L[t] = t > 255 ? 255 + ~~(t / 255) : t;
									}
								})();
							}),
								i("Reject Lexer.NA", function () {
									r = s.reject(t, function (t) {
										return t.PATTERN === a.Lexer.NA;
									});
								});
							var o,
								u,
								...
								T,
								v = !1;
							i("Transform Patterns", function () {
								(v = !1),
									(o = s.map(r, function (t) {
										var e = t.PATTERN;
										if (s.isRegExp(e)) {
											var r = e.source;
											return 1 !== r.length ||
										...
										if (s.isFunction(e)) return (v = !0), { exec: e };
										if (s.has(e, "exec")) return (v = !0), e;
										if ("string" == typeof e) {
											if (1 === e.length) return e;
											var i = e.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"),
												o = new RegExp(i);
											return n.useSticky ? A(o) : g(o);
										}
										throw Error("non exhaustive match");
									}));
							}),
								i("misc mapping", function () {
								...
								i("Line Terminator Handling", function () {
									var t = S(n.lineTerminatorCharacters);
									(d = s.map(r, function (t) {
										return !1;
									})),
										"onlyOffset" !== n.positionTracking &&
											(d = s.map(r, function (e) {
												return s.has(e, "LINE_BREAKS")
													? e.LINE_BREAKS
													: !1 === I(e, t)
									...
									(E = s.map(r, _)),
										...
										(y = s.reduce(
											...
											function (t, e) {
												var n = e.GROUP;
												return (
													s.isString(n) && n !== a.Lexer.SKIPPED && (t[n] = []),
													t
												);
											},
											{}
										)),
										(T = s.map(o, function (t, e) {
											return {
												pattern: o[e],
												longerAlt: p[e],
												canLineTerminator: d[e],
												isCustom: E[e],
												short: m[e],
												group: l[e],
												push: f[e],
											...
											function (t, e, r) {
												if ("string" == typeof e.PATTERN) {
													...
													if (e.PATTERN.unicode)
														...
														var a = c.getOptimizedStartCodesIndices(
															e.PATTERN,
															n.ensureOptimizations
														);
														s.isEmpty(a) && (R = !1),
						...
						(e.validatePatterns = function (t, e) {
							...
							var i = p(r.valid),
								o = i.valid;
							return (n = (n = (n = (n = n.concat(i.errors)).concat(
								(function (t) {
									var e = [],
										n = s.filter(t, function (t) {
											return s.isRegExp(t.PATTERN);
										});
									return (e = (e = (e = (e = e.concat(h(n))).concat(
										m(n)
									)).concat(y(n))).concat(T(n))).concat(d(n));
								})(o)
							)).concat(v(o))).concat(R(o, e))).concat(O(o));
						}),
						(e.findMissingPatterns = l),
						(e.findInvalidPatterns = p);
					var f = /[^\\][\$]/;
					function h(t) {
						var e = (function (t) {
								function e() {
					...
					(e.findEndOfInputAnchor = h), (e.findEmptyMatchRegExps = d);
					var E = /[^\\[][\^]|^\^/;
					function m(t) {
						var e = (function (t) {
								function e() {
					...
					function v(t) {
						var e = s.filter(t, function (t) {
							...
							var e = t.GROUP;
							return (
								e !== a.Lexer.SKIPPED && e !== a.Lexer.NA && !s.isString(e)
							);
						});
						return s.map(e, function (t) {
							return {
							...
							s.forEach(t, function (t, r) {
								s.forEach(n, function (n) {
									...
									if (
										...
										e.push({
											message: u,
											type: a.LexerDefinitionErrorType.UNREACHABLE_PATTERN,
											tokenTypes: [t, c],
										});
									}
								});
					...
					function I(t, e) {
						...
						if (s.isRegExp(t.PATTERN)) {
							try {
								...
								return {
									issue: a.LexerDefinitionErrorType.IDENTIFY_TERMINATOR,
									errMsg: t.message,
								};
							}
							return !1;
						...
						if (_(t))
							return { issue: a.LexerDefinitionErrorType.CUSTOM_LINE_BREAK };
						throw Error("non exhaustive match");
					}
					function P(t, e) {
					...
					(e.findStartOfInputAnchor = m),
						(e.findUnsupportedFlags = y),
						(e.findDuplicatePatterns = T),
						(e.findInvalidGroupType = v),
						(e.findModesThatDoNotExist = R),
						(e.findUnreachablePatterns = O),
						(e.addStartOfInput = g),
						(e.addStickyFlag = A),
							...
							return (
								s.has(t, e.DEFAULT_MODE) ||
									i.push({
										...
										type: a.LexerDefinitionErrorType
							...
							return (
								e &&
									s.forEach(u, function (t) {
										var e = I(t, l);
										if (!1 !== e) {
											var n = { message: P(t, e), type: e.issue, tokenType: t };
											r.push(n);
						...
						(e.buildLineBreakIssueMessage = P),
						(e.minOptimizationVal = 256);
					var L = [];
					function C(t) {
						return t < e.minOptimizationVal ? t : L[t];
					}
					e.charCodeToOptimizedIndex = C;
				},
				495: (t, e) => {
					"use strict";
					Object.defineProperty(e, "__esModule", { value: !0 }),
				...
				27: (t, e, n) => {
					...
					((r =
						...
						(r[(r.INVALID_PATTERN = 1)] = "INVALID_PATTERN"),
						(r[(r.EOI_ANCHOR_FOUND = 2)] = "EOI_ANCHOR_FOUND"),
						(r[(r.UNSUPPORTED_FLAGS_FOUND = 3)] = "UNSUPPORTED_FLAGS_FOUND"),
						(r[(r.DUPLICATE_PATTERNS_FOUND = 4)] = "DUPLICATE_PATTERNS_FOUND"),
						(r[(r.INVALID_GROUP_TYPE_FOUND = 5)] = "INVALID_GROUP_TYPE_FOUND"),
						(r[(r.PUSH_MODE_DOES_NOT_EXIST = 6)] = "PUSH_MODE_DOES_NOT_EXIST"),
						(r[(r.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE = 7)] =
							"MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE"),
						(r[(r.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY = 8)] =
							"MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY"),
						(r[(r.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST = 9)] =
							"MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST"),
						(r[(r.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED = 10)] =
							"LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED"),
						(r[(r.SOI_ANCHOR_FOUND = 11)] = "SOI_ANCHOR_FOUND"),
						(r[(r.EMPTY_MATCH_PATTERN = 12)] = "EMPTY_MATCH_PATTERN"),
						(r[(r.NO_LINE_BREAKS_FLAGS = 13)] = "NO_LINE_BREAKS_FLAGS"),
						(r[(r.UNREACHABLE_PATTERN = 14)] = "UNREACHABLE_PATTERN"),
						(r[(r.IDENTIFY_TERMINATOR = 15)] = "IDENTIFY_TERMINATOR"),
						(r[(r.CUSTOM_LINE_BREAK = 16)] = "CUSTOM_LINE_BREAK");
					var u = {
						...
						safeMode: !1,
						errorMessageProvider: s.defaultLexerErrorProvider,
						traceInitPerf: !1,
						skipValidations: !1,
					};
					Object.freeze(u);
								...
								this.TRACE_INIT("Lexer Constructor", function () {
									...
									n.TRACE_INIT("Lexer Config handling", function () {
										if (
											...
											u.lineTerminatorsPattern
										)
											n.config.lineTerminatorsPattern =
												i.LineTerminatorOptimizedTester;
										else if (
											n.config.lineTerminatorCharacters ===
											u.lineTerminatorCharacters
										)
											throw Error(
										...
										(n.trackStartLines = /full|onlyStart/i.test(
											...
											o.isArray(t)
												? (((r = { modes: {} }).modes[i.DEFAULT_MODE] =
														o.cloneArr(t)),
												  (r[i.DEFAULT_MODE] = i.DEFAULT_MODE))
												: ((s = !1), (r = o.cloneObj(t)));
									}),
										...
										o.forEach(r.modes, function (t, e) {
											r.modes[e] = o.reject(t, function (t) {
												return o.isUndefined(t);
											});
										});
									var l = o.keys(r.modes);
									if (
										(o.forEach(r.modes, function (t, r) {
												...
												n.modes.push(r),
													!1 === n.config.skipValidations &&
														n.TRACE_INIT("validatePatterns", function () {
															n.lexerDefinitionErrors =
																n.lexerDefinitionErrors.concat(
																	i.validatePatterns(t, l)
																);
														}),
													o.isEmpty(n.lexerDefinitionErrors) &&
														(a.augmentTokenTypes(t),
														n.TRACE_INIT("analyzeTokenTypes", function () {
															s = i.analyzeTokenTypes(t, {
																lineTerminatorCharacters:
																	n.config.lineTerminatorCharacters,
														...
														(n.patternIdxToConfig[r] = s.patternIdxToConfig),
														(n.charCodeToPatternIdxToConfig[r] =
															s.charCodeToPatternIdxToConfig),
														(n.emptyGroups = o.merge(
															n.emptyGroups,
															s.emptyGroups
														)),
														(n.hasCustom = s.hasCustom || n.hasCustom),
														(n.canModeBeOptimized[r] = s.canBeOptimized));
											});
										}),
										...
										var p = o
											.map(n.lexerDefinitionErrors, function (t) {
												return t.message;
											})
											.join("-----------------------\n");
										throw new Error(
									...
									o.forEach(n.lexerDefinitionWarning, function (t) {
										o.PRINT_WARNING(t.message);
									}),
										n.TRACE_INIT(
											...
											function () {
												if (
													(i.SUPPORT_STICKY
														? ((n.chopInput = o.IDENTITY),
														  (n.match = n.matchWithTest))
														: ((n.updateLastIndex = o.NOOP),
														  (n.match = n.matchWithExec)),
													s && (n.handleModes = o.NOOP),
													!1 === n.trackStartLines &&
														(n.computeNewColumn = o.IDENTITY),
													!1 === n.trackEndLines &&
														(n.updateTokenEndLineColumnLocation = o.NOOP),
										...
										n.TRACE_INIT("Failed Optimization Warnings", function () {
											...
											if (e.ensureOptimizations && !o.isEmpty(t))
												throw Error(
													"Lexer Modes: < " +
														t.join(", ") +
										...
										n.TRACE_INIT("clearRegExpParserCache", function () {
											c.clearRegExpParserCache();
										}),
										n.TRACE_INIT("toFastProperties", function () {
											o.toFastProperties(n);
										});
								});
						}
						return (
							...
							(t.prototype.tokenizeInternal = function (t, e) {
								var n,
									...
									O = 0,
									g = 0,
									A = this.hasCustom ? 0 : Math.floor(t.length / 10),
									_ = new Array(A),
									N = [],
									I = this.trackStartLines ? 1 : void 0,
									P = this.trackStartLines ? 1 : void 0,
									S = i.cloneEmptyGroups(this.emptyGroups),
									k = this.trackStartLines,
								...
								function U(t) {
									var e = i.charCodeToOptimizedIndex(t),
										n = M[e];
									return void 0 === n ? F : n;
								}
								var j,
									G = function (t) {
										if (1 === b.length && void 0 === t.tokenType.PUSH_MODE) {
											var e =
												T.config.errorMessageProvider.buildUnableToPopLexerModeMessage(
													t
												);
											N.push({
												...
												column:
													void 0 !== t.startColumn ? t.startColumn : void 0,
											...
											b.pop();
											var n = o.last(b);
											(x = T.patternIdxToConfig[n]),
												(M = T.charCodeToPatternIdxToConfig[n]),
												(C = x.length);
											var r =
												T.canModeBeOptimized[n] && !1 === T.config.safeMode;
											D = M && r ? U : w;
										}
									};
								function B(t) {
									b.push(t),
										(M = this.charCodeToPatternIdxToConfig[t]),
										(x = this.patternIdxToConfig[t]),
										(C = x.length),
										(C = x.length);
									var e =
										this.canModeBeOptimized[t] && !1 === this.config.safeMode;
									D = M && e ? U : w;
								}
								for (B.call(this, e); O < R; ) {
									c = null;
									var W = v.charCodeAt(O),
										V = D(W),
										K = V.length;
									for (n = 0; n < K; n++) {
										var z = (j = V[n]).pattern;
										if (
											...
											!1 !== (et = j.short)
												? W === et && (c = z)
												: !0 === j.isCustom
												? null !== (y = z.exec(v, O, _, S))
													? ((c = y[0]),
													  void 0 !== y.payload && (u = y.payload))
													: (c = null)
												: (this.updateLastIndex(z, O),
												  (c = this.match(z, t, O))),
											null !== c)
										) {
											if (void 0 !== (s = j.longerAlt)) {
												var Y = x[s],
													H = Y.pattern;
												(l = null),
													!0 === Y.isCustom
														? null !== (y = H.exec(v, O, _, S))
															? ((a = y[0]),
															  void 0 !== y.payload && (l = y.payload))
															: (a = null)
														: (this.updateLastIndex(H, O),
														  (a = this.match(H, t, O))),
													a &&
														a.length > c.length &&
														((c = a), (u = l), (j = Y));
									...
									if (null !== c) {
										if (
											...
											void 0 !== (f = j.group) &&
												...
												this.handlePayload(d, u),
												!1 === f ? (g = this.addToken(_, g, d)) : S[f].push(d)),
											(t = this.chopInput(t, p)),
											(O += p),
											(P = this.computeNewColumn(P, p)),
											!0 === k && !0 === j.canLineTerminator)
										) {
											var X = 0,
												q = void 0,
												$ = void 0;
										...
										this.handleModes(j, G, B, d);
									} else {
										for (var Q = O, Z = I, J = P, tt = !1; !tt && O < R; )
											for (
												v.charCodeAt(O), t = this.chopInput(t, 1), O++, r = 0;
												r < C;
												r++
											) {
												var et,
												...
												if (
													((z = nt.pattern),
													!1 !== (et = nt.short)
														? v.charCodeAt(O) === et && (tt = !0)
														: !0 === nt.isCustom
														? (tt = null !== z.exec(v, O, _, S))
														: (this.updateLastIndex(z, O),
														  (tt = null !== z.exec(t))),
													!0 === tt)
												)
								...
								return (
									this.hasCustom || (_.length = g),
									{ tokens: _, groups: S, errors: N }
								);
							}),
							...
							(t.prototype.updateTokenEndLineColumnLocation = function (
								...
								void 0 !== e &&
									((c = (s = n === a - 1) ? -1 : 0),
									(1 === r && !0 === s) ||
										((t.endLine = i + c), (t.endColumn = o - 1 - c)));
							}),
				...
				480: function (t, e, n) {
					...
					function l(t, e, n) {
						switch (t.type) {
							case "Disjunction":
								for (var r = 0; r < t.value.length; r++) l(t.value[r], e, n);
								break;
							case "Alternative":
								var i = t.value;
								for (r = 0; r < i.length; r++) {
									...
									switch (s.type) {
										...
										case "Set":
											...
											a.forEach(s.value, function (t) {
												if ("number" == typeof t) p(t, e, n);
												else {
													var r = t;
													if (!0 === n)
														for (var i = r.from; i <= r.to; i++) p(i, e, n);
													else {
														for (
															i = r.from;
															...
															p(i, e, n);
														if (r.to >= c.minOptimizationVal)
															for (
																var o =
																		r.from >= c.minOptimizationVal
																			? r.from
																			: c.minOptimizationVal,
																	a = r.to,
																	s = c.charCodeToOptimizedIndex(o),
																	u = c.charCodeToOptimizedIndex(a),
																	l = s;
																l <= u;
																l++
															)
									...
									var f = void 0 !== s.quantifier && 0 === s.quantifier.atLeast;
									if (
										("Group" === s.type && !1 === h(s)) ||
										("Group" !== s.type && !1 === f)
									)
					...
					function p(t, e, n) {
						var r = c.charCodeToOptimizedIndex(t);
						(e[r] = r),
							!0 === n &&
								(function (t, e) {
									var n = String.fromCharCode(t),
										r = n.toUpperCase();
									if (r !== n)
										e[(i = c.charCodeToOptimizedIndex(r.charCodeAt(0)))] = i;
									else {
										var i,
											o = n.toLowerCase();
										o !== n &&
											(e[(i = c.charCodeToOptimizedIndex(o.charCodeAt(0)))] =
												i);
									}
								})(t, e);
					}
					...
					(e.failedOptimizationPrefixMsg =
						...
						(e.getOptimizedStartCodesIndices = function (t, n) {
							void 0 === n && (n = !1);
							try {
								var r = s.getRegExpAst(t);
								return l(r.value, {}, r.flags.ignoreCase);
							} catch (r) {
								if (r.message === u)
									n &&
										a.PRINT_WARNING(
					...
					var d = (function (t) {
						...
						return (
							...
							(e.prototype.visitSet = function (t) {
								t.complement
									? void 0 === f(t, this.targetCharCodes) && (this.found = !0)
									: void 0 !== f(t, this.targetCharCodes) && (this.found = !0);
							}),
							e
						);
				...
				201: (t, e, n) => {
					...
					function o(t) {
						r.forEach(t, function (t) {
							u(t) ||
								((e.tokenIdxToClass[e.tokenShortNameIdx] = t),
								(t.tokenTypeIdx = e.tokenShortNameIdx++)),
								l(t) &&
									!r.isArray(t.CATEGORIES) &&
									(t.CATEGORIES = [t.CATEGORIES]),
								l(t) || (t.CATEGORIES = []),
								p(t) || (t.categoryMatches = []),
								f(t) || (t.categoryMatchesMap = {});
						});
					}
					function a(t) {
						r.forEach(t, function (t) {
					...
					(e.tokenStructuredMatcher = function (t, e) {
						...
						(e.assignTokenDefaultProps = o),
						(e.assignCategoriesTokensProp = a),
						(e.assignCategoriesMapProp = s),
						(e.singleAssignCategoriesToksMap = c),
						(e.hasShortKeyProperty = u),
						(e.hasCategoriesProperty = l),
						(e.hasExtendingTokensTypesProperty = p),
				...
				736: (t, e, n) => {
					...
					function s(t) {
						return (function (t) {
							...
							if (
								((n.name = t.name),
								r.isUndefined(e) || (n.PATTERN = e),
								r.has(t, "parent"))
							)
								throw "The parent property is no longer supported.\nSee: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.";
							return (
								r.has(t, "categories") && (n.CATEGORIES = t.categories),
								o.augmentTokenTypes([n]),
								r.has(t, "label") && (n.LABEL = t.label),
								r.has(t, "group") && (n.GROUP = t.group),
								r.has(t, "pop_mode") && (n.POP_MODE = t.pop_mode),
								r.has(t, "push_mode") && (n.PUSH_MODE = t.push_mode),
								r.has(t, "longer_alt") && (n.LONGER_ALT = t.longer_alt),
								r.has(t, "line_breaks") && (n.LINE_BREAKS = t.line_breaks),
								r.has(t, "start_chars_hint") &&
									(n.START_CHARS_HINT = t.start_chars_hint),
								n
							);
						})(t);
					}
					(e.createToken = s),
						(e.EOF = s({ name: "EOF", pattern: i.Lexer.NA })),
						o.augmentTokenTypes([e.EOF]),
						...
						(e.tokenMatcher = function (t, e) {
							return o.tokenStructuredMatcher(t, e);
						});
				},
				979: (t, e) => {
					"use strict";
				...
				146: function (t, e) {
					...
					function a(t, e) {
						if (Array.isArray(t))
							...
							if (!E(t)) throw Error("non exhaustive match");
							var r = i(t);
		...
		return (
			(() => {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }),
					(t.Parser =
						t.createSyntaxDiagramsCode =
						t.clearCache =
						t.GAstVisitor =
						t.serializeProduction =
						t.serializeGrammar =
						t.Terminal =
						t.Rule =
						t.RepetitionWithSeparator =
						t.RepetitionMandatoryWithSeparator =
						t.RepetitionMandatory =
						t.Repetition =
						t.Option =
						t.NonTerminal =
						t.Alternative =
						t.Alternation =
						t.defaultLexerErrorProvider =
						t.NoViableAltException =
						t.NotAllInputParsedException =
						t.MismatchedTokenException =
						t.isRecognitionException =
						t.EarlyExitException =
						t.defaultParserErrorProvider =
						t.tokenName =
						t.tokenMatcher =
						t.tokenLabel =
						t.EOF =
						...
						t.Lexer =
						t.EMPTY_ALT =
						t.ParserDefinitionErrorType =
						t.EmbeddedActionsParser =
						t.CstParser =
						t.VERSION =
							void 0);
				var e = n(979);
				...
				var i = n(941);
				Object.defineProperty(t, "CstParser", {
					enumerable: !0,
					get: function () {
						return i.CstParser;
					},
				}),
					Object.defineProperty(t, "EmbeddedActionsParser", {
						enumerable: !0,
						get: function () {
							return i.EmbeddedActionsParser;
						},
					}),
					Object.defineProperty(t, "ParserDefinitionErrorType", {
						enumerable: !0,
						get: function () {
							return i.ParserDefinitionErrorType;
						},
					}),
					Object.defineProperty(t, "EMPTY_ALT", {
						enumerable: !0,
						get: function () {
							return i.EMPTY_ALT;
						},
				...
				Object.defineProperty(t, "Lexer", {
					...
					Object.defineProperty(t, "LexerDefinitionErrorType", {
						enumerable: !0,
						get: function () {
				...
				var a = n(736);
				Object.defineProperty(t, "createToken", {
					enumerable: !0,
					get: function () {
					...
					Object.defineProperty(t, "EOF", {
						enumerable: !0,
						get: function () {
							return a.EOF;
						},
					}),
					Object.defineProperty(t, "tokenLabel", {
						enumerable: !0,
						get: function () {
							return a.tokenLabel;
						},
					}),
					Object.defineProperty(t, "tokenMatcher", {
						enumerable: !0,
						get: function () {
							return a.tokenMatcher;
						},
					}),
					Object.defineProperty(t, "tokenName", {
						enumerable: !0,
						get: function () {
							return a.tokenName;
						},
				...
				var s = n(7);
				Object.defineProperty(t, "defaultParserErrorProvider", {
					enumerable: !0,
					get: function () {
				...
				Object.defineProperty(t, "EarlyExitException", {
					...
					Object.defineProperty(t, "isRecognitionException", {
						enumerable: !0,
						get: function () {
							return c.isRecognitionException;
						},
					}),
					Object.defineProperty(t, "MismatchedTokenException", {
						enumerable: !0,
						get: function () {
							return c.MismatchedTokenException;
						},
					}),
					Object.defineProperty(t, "NotAllInputParsedException", {
						enumerable: !0,
						get: function () {
							return c.NotAllInputParsedException;
						},
					}),
					Object.defineProperty(t, "NoViableAltException", {
						enumerable: !0,
						get: function () {
				...
				var u = n(495);
				Object.defineProperty(t, "defaultLexerErrorProvider", {
					enumerable: !0,
					get: function () {
				...
				var l = n(946);
				Object.defineProperty(t, "Alternation", {
					enumerable: !0,
					get: function () {
						return l.Alternation;
					},
				}),
					Object.defineProperty(t, "Alternative", {
						enumerable: !0,
						get: function () {
							return l.Alternative;
						},
					}),
					Object.defineProperty(t, "NonTerminal", {
						enumerable: !0,
						get: function () {
					...
					Object.defineProperty(t, "Repetition", {
						enumerable: !0,
						get: function () {
							return l.Repetition;
						},
					}),
					Object.defineProperty(t, "RepetitionMandatory", {
						enumerable: !0,
						get: function () {
							return l.RepetitionMandatory;
						},
					}),
					Object.defineProperty(t, "RepetitionMandatoryWithSeparator", {
						enumerable: !0,
						get: function () {
							return l.RepetitionMandatoryWithSeparator;
						},
					}),
					Object.defineProperty(t, "RepetitionWithSeparator", {
						enumerable: !0,
						get: function () {
				...
				var p = n(946);
				Object.defineProperty(t, "serializeGrammar", {
					enumerable: !0,
					get: function () {
						return p.serializeGrammar;
					},
				}),
					Object.defineProperty(t, "serializeProduction", {
						enumerable: !0,
						get: function () {
				...
				var f = n(841);
				Object.defineProperty(t, "GAstVisitor", {
					enumerable: !0,
					get: function () {
				...
				var h = n(781);
				Object.defineProperty(t, "createSyntaxDiagramsCode", {
					enumerable: !0,
					get: function () {
						return h.createSyntaxDiagramsCode;
					},
				});
				t.Parser = function () {
					throw new Error(
