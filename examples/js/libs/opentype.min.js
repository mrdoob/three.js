			...
			for (
				...
				for (
					...
					switch (c) {
						case "11":
							(f = h(t.current)) &&
								o.splice(r, 1, new Fr({ id: 11, tag: e.tag, substitution: f }));
							break;
						case "12":
							(f = h(t.current)) &&
								o.splice(r, 1, new Fr({ id: 12, tag: e.tag, substitution: f }));
							break;
						case "63":
							(f = h(t)),
								Array.isArray(f) &&
						...
						case "41":
							(f = h(t)) &&
								o.splice(r, 1, new Fr({ id: 41, tag: e.tag, substitution: f }));
							break;
						case "21":
							(f = h(t.current)) &&
								o.splice(r, 1, new Fr({ id: 21, tag: e.tag, substitution: f }));
					}
				...
				if (!Mr(e.char)) {
					...
					if (-1 !== s.indexOf(r)) {
						...
						a.forEach(function (e, t) {
							e instanceof Fr && (Wr(e, i, t), (u.context[t] = e.substitution));
						});
					}
				}
			});
