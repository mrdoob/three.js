(function () {
	...
	THREE_TO_WEBGL[THREE.NearestMipmapNearestFilter] =
		WEBGL_CONSTANTS.NEAREST_MIPMAP_NEAREST;
	THREE_TO_WEBGL[THREE.NearestMipmapLinearFilter] =
	...
	THREE_TO_WEBGL[THREE.LinearMipmapLinearFilter] =
		WEBGL_CONSTANTS.LINEAR_MIPMAP_LINEAR;
	THREE_TO_WEBGL[THREE.ClampToEdgeWrapping] = WEBGL_CONSTANTS.CLAMP_TO_EDGE;
	THREE_TO_WEBGL[THREE.RepeatWrapping] = WEBGL_CONSTANTS.REPEAT;
	THREE_TO_WEBGL[THREE.MirroredRepeatWrapping] =
		...
		processMesh(mesh) {
			...
			for (let attributeName in geometry.attributes) {
				...
				if (
					...
					modifiedAttribute = new THREE.BufferAttribute(
	...
	GLTFExporter.Utils = {
		...
		mergeMorphTargetTracks: function (clip, root) {
			...
			for (let i = 0; i < sourceTracks.length; ++i) {
				...
				const sourceTrackBinding = THREE.PropertyBinding.parseTrackName(
					sourceTrack.name
				);
				const sourceTrackNode = THREE.PropertyBinding.findNode(
					root,
				...
				const targetIndex =
					sourceTrackNode.morphTargetDictionary[
