 ...
 */
	...
	class MeshWorldPositionMaterial extends THREE.ShaderMaterial {
		...
		constructor( parameters ) {
			...
			parameters.uniforms = THREE.UniformsUtils.merge( [ THREE.ShaderLib.depth.uniforms ] );
			...
			parameters.fragmentShader = [ 'varying vec4 vWorldPosition;', 'void main() {', 'gl_FragColor = vWorldPosition;', '}' ].join( '\n' );
			super( parameters );
