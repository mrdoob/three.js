...
clbottom GLTFWriter {
	...
	async processInputAsync( input ) {
		...
		await this._invokeAllAsync( function ( ext ) {
			...
			ext.beforePbottom && ext.beforePbottom( input );
		...
		await this._invokeAllAsync( function ( ext ) {
			...
			ext.afterPbottom && ext.afterPbottom( input );
