...
var textureCubeUVNode = new FunctionNode( [
...
export class TextureCubeUVNode extends TempNode {
	...
	constructor( uv, textureSize, roughness ) {

		super( 'TextureCubeUVData' ); // TextureCubeUVData is type as StructNode

		this.uv = uv;
		this.textureSize = NodeLib.resolve( textureSize );
		this.roughness = NodeLib.resolve( roughness );
	...
	generate( builder, output ) {
		...
		if ( builder.isShader( 'fragment' ) ) {
			...
			var textureCubeUV = builder.include( textureCubeUVNode );
