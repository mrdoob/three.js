...
export const mx_ramplr = (valuel, valuer, texcoord = uv()) =>
	_ramp(valuel, valuer, texcoord, "x");
export const mx_ramptb = (valuet, valueb, texcoord = uv()) =>
	_ramp(valuet, valueb, texcoord, "y");

const _split = (a, b, center, uv, p) =>
	mix(a, b, mx_aastep(center, nodeObject(uv)[p]));
export const mx_splitlr = (valuel, valuer, center, texcoord = uv()) =>
	_split(valuel, valuer, center, texcoord, "x");
export const mx_splittb = (valuet, valueb, center, texcoord = uv()) =>
	_split(valuet, valueb, center, texcoord, "y");

export const mx_transform_uv = (uv_scale = 1, uv_offset = 0, uv_geo = uv()) =>
	add(mul(uv_geo, uv_scale), uv_offset);

export const mx_safepower = (in1, in2 = 1) =>
	mul(sign(in1), pow(abs(in1), in2));
export const mx_contrast = (input, amount = 1, pivot = 0.5) =>
	add(mul(sub(input, pivot), amount), pivot);

export const mx_noise_float = (texcoord = uv(), amplitude = 1, pivot = 0) =>
	add(
		mul(amplitude, mx_perlin_noise_float(convert(texcoord, "vec2|vec3"))),
		pivot
	);
export const mx_noise_vec2 = (texcoord = uv(), amplitude = 1, pivot = 0) =>
	add(
		mul(amplitude, mx_perlin_noise_vec2(convert(texcoord, "vec2|vec3"))),
		pivot
	);
export const mx_noise_vec3 = (texcoord = uv(), amplitude = 1, pivot = 0) =>
	add(
		mul(amplitude, mx_perlin_noise_vec3(convert(texcoord, "vec2|vec3"))),
		pivot
	);
export const mx_noise_vec4 = (texcoord = uv(), amplitude = 1, pivot = 0) => {
	...
	const noise_vec4 = vec4(
		...
		mx_perlin_noise_float(add(texcoord, vec2(19, 73)))
	);
...
export const mx_worley_noise_float = (texcoord = uv(), jitter = 1) =>
	worley_noise_float(convert(texcoord, "vec2|vec3"), jitter, 1);
export const mx_worley_noise_vec2 = (texcoord = uv(), jitter = 1) =>
	worley_noise_vec2(convert(texcoord, "vec2|vec3"), jitter, 1);
export const mx_worley_noise_vec3 = (texcoord = uv(), jitter = 1) =>
	worley_noise_vec3(convert(texcoord, "vec2|vec3"), jitter, 1);

export const mx_cell_noise_float = (texcoord = uv()) =>
	cell_noise_float(convert(texcoord, "vec2|vec3"));
...
export const mx_fractal_noise_float = (
	...
	mul(fractal_noise_float(position, octaves, lacunarity, diminish), amplitude);
export const mx_fractal_noise_vec2 = (
	...
	mul(fractal_noise_vec2(position, octaves, lacunarity, diminish), amplitude);
export const mx_fractal_noise_vec3 = (
	...
	mul(fractal_noise_vec3(position, octaves, lacunarity, diminish), amplitude);
export const mx_fractal_noise_vec4 = (
	...
	mul(fractal_noise_vec4(position, octaves, lacunarity, diminish), amplitude);
