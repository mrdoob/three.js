...
const outputDirection = getDirection( uv(), attribute( 'faceIndex' ) ).normalize();
...
function _getEquirectMaterial() {
	...
	const material = _getMaterial();
	material.fragmentNode = texture( texture, equirectUV( outputDirection ) );
