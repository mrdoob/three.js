const { opentype, BoundingBox, Font, Glyph, Path, parse, load, loadSync, parseBuffer } = /* @__PURE__ */ ( () => {
...
return { opentype, BoundingBox, Font, Glyph, Path, parse, load, loadSync, parseBuffer };
