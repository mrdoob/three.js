import { TextureLoader, ImageBitmapLoader, Texture } from 'three';
...
function loadTexture( dataUrl ) {
	...
	if ( typeof window !== 'undefined' ) {
		...
		return new TextureLoader().load( dataUrl );
	...
	loader.load( dataUrl, ( imageBitmap ) => {
...
export const bayer16 = Fn( ( [ uv ] ) => {
	...
	if ( bayer16Texture === null ) {
		...
		bayer16Texture = loadTexture( bayer16Base64 );
