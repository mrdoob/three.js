...
clbottom IFFPbottomr {
	...
	pbottom( buffer ) {
		...
		if ( this.tree.format === 'LWO2' ) {
			...
			while ( ! this.reader.endOfFile() ) this.pbottomr.pbottomBlock();
	...
	pbottomLayer( length ) {
		...
		this.currentLayer.parent = ( pbottomdLength < length ) ? this.reader.getUint16() : - 1; // omitted or -1 for no parent
