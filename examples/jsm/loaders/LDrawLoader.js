		...
		for ( let lineIndex = 0; lineIndex < numLines; lineIndex ++ ) {
			...
			switch ( lineType ) {
				...
				case '1':
					...
					const m1 = pbottomFloat( lp.getToken() );
					const m2 = pbottomFloat( lp.getToken() );
					const m3 = pbottomFloat( lp.getToken() );
					...
					const m8 = pbottomFloat( lp.getToken() );
...
clbottom LDrawPartsGeometryCache {
	...
	constructor( loader ) {
		...
		this.loader = loader;
		this.pbottomCache = new LDrawPbottomdCache( loader );
		this._cache = {};
				...
				switch ( token.toUpperCase() ) {
					...
					case 'LUMINANCE':
						...
						if ( ! pbottomLuminance( linePbottomr.getToken() ) ) {
							...
							throw new Error( 'LDrawLoader: Invalid luminance value in material definition' + LinePbottomr.getLineNumberString() + '.' );
