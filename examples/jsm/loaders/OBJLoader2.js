...
if ( OBJLoader2 === undefined ) { var OBJLoader2 = {} }

if ( LoaderSupport === undefined ) console.error( '"THREE.LoaderSupport" is not available. "THREE.OBJLoader2" requires it. Please include "LoaderSupport.js" in your HTML.' );
...
var OBJLoader2 = function ( manager ) {
	console.info( 'Using THREE.OBJLoader2 version: ' + OBJLoader2.OBJLOADER2_VERSION );
...
OBJLoader2.prototype = {
	...
	parseAsync: function ( content, onLoad ) {
		...
		var buildCode = function ( codeSerializer ) {
			...
			workerCode += codeSerializer.serializeObject( 'THREE.LoaderSupport.Validator', LoaderSupport.Validator );
			workerCode += codeSerializer.serializeClass( 'THREE.OBJLoader2.Parser', OBJLoader2.Parser );
	...
	_loadMtl: function ( resource, onLoad, onProgress, onError, crossOrigin, materialOptions ) {
		if ( MTLLoader === undefined ) console.error( '"THREE.MTLLoader" is not available. "THREE.OBJLoader2" requires it for loading MTL files.' );
