...
import { Volume } from '../../modules/Volume.js';var __NRRDLoader;__NRRDLoader = function ( manager ) {
...
__NRRDLoader.prototype = {

	constructor: __NRRDLoader,
		...
		function parseHeader( header ) {
			...
			for ( _i = 0, _len = lines.length; _i < _len; _i ++ ) {
				...
				if ( l.match( /NRRD\d+/ ) ) {
					...
					field = m[ 1 ].trim();
					data = m[ 2 ].trim();
					fn = __NRRDLoader.prototype.fieldFunctions[ field ];
					if ( fn ) {
...
export { __NRRDLoader as NRRDLoader };
