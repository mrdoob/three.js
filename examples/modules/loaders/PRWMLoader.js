...
( function ( THREE ) {
	...
	__PRWMLoader = function PRWMLoader( manager ) {

		this.manager = ( manager !== undefined ) ? manager : THREE.DefaultLoadingManager;

	};

	__PRWMLoader.prototype = {

		constructor: __PRWMLoader,
	...
	__PRWMLoader.isBigEndianPlatform = function () {
...
export { __PRWMLoader as PRWMLoader };
