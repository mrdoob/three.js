...
__KTXLoader = function ( manager ) {

	THREE.CompressedTextureLoader.call( this, manager );

	this._parser = __KTXLoader.parse;

};

__KTXLoader.prototype = Object.create( THREE.CompressedTextureLoader.prototype );
__KTXLoader.prototype.constructor = __KTXLoader;

__KTXLoader.parse = function ( buffer, loadMipmaps ) {
...
export { __KTXLoader as KTXLoader };
