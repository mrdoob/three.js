 ...
 * @class
 */
__LoaderSupport.Callbacks = (function () {

	var Validator = __LoaderSupport.Validator;
 ...
 */
__LoaderSupport.LoadedMeshUserOverride = (function () {
 ...
 */
__LoaderSupport.ResourceDescriptor = (function () {
 ...
 * @class
 */
__LoaderSupport.PrepData = (function () {
	...
	function PrepData( modelName ) {
		...
		this.resources = [];
		this.callbacks = new __LoaderSupport.Callbacks();
	}
	...
	PrepData.prototype.clone = function () {
		var clone = new __LoaderSupport.PrepData( this.modelName );
 ...
 * @class
 */
__LoaderSupport.MeshBuilder = (function () {
 ...
 * @class
 */
__LoaderSupport.WorkerRunnerRefImpl = (function () {
 ...
 * @class
 */
__LoaderSupport.WorkerSupport = (function () {
	...
	WorkerSupport.prototype.validate = function ( functionCodeBuilder, parserName, libLocations, libPath, runnerImpl ) {
		...
		if ( Validator.isValid( runnerImpl ) ) {
			...
			runnerImpl = __LoaderSupport.WorkerRunnerRefImpl;
 ...
 */
__LoaderSupport.WorkerDirector = (function () {
	...
	WorkerDirector.prototype.prepareWorkers = function ( globalCallbacks, maxQueueSize, maxWebWorkers ) {
		...
		for ( var instanceNo = 0; instanceNo < this.maxWebWorkers; instanceNo++ ) {
			...
			var workerSupport = new __LoaderSupport.WorkerSupport();
	...
	WorkerDirector.prototype._kickWorkerRun = function( prepData, supportDesc ) {
		...
		var updatedCallbacks = new __LoaderSupport.Callbacks();
	...
	WorkerDirector.prototype._buildLoader = function ( instanceNo ) {
		...
		if ( ! loader.hasOwnProperty( 'callbacks' ) || ! Validator.isValid( loader.callbacks ) ) {
			...
			loader.callbacks = new __LoaderSupport.Callbacks();
...
export { __LoaderSupport as LoaderSupport };
