...
import { LoaderSupport } from '../../modules/loaders/LoaderSupport.js';
import { MTLLoader } from '../../modules/loaders/MTLLoader.js';
var __OBJLoader2;

'use strict';

if ( __OBJLoader2 === undefined ) { __OBJLoader2 = {} }

if ( LoaderSupport === undefined ) console.error( '"LoaderSupport" is not available. "__OBJLoader2" requires it. Please include "LoaderSupport.js" in your HTML.' );
...
__OBJLoader2 = (function () {
	...
	OBJLoader2.prototype._loadMtl = function ( resource, onLoad, onProgress, onError, crossOrigin, materialOptions ) {
		if ( MTLLoader === undefined ) console.error( '"MTLLoader" is not available. "__OBJLoader2" requires it for loading MTL files.' );
...
export { __OBJLoader2 as OBJLoader2 };
