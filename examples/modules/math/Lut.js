...
var __Lut;
var __ColorMapKeywords;

__Lut = function ( colormap, numberofcolors ) {

	this.lut = [];
	this.map = __ColorMapKeywords[ colormap ];
...
__Lut.prototype = {
	...
	changeNumberOfColors: function ( numberofcolors ) {
		...
		return new __Lut( this.mapname, this.n );
	...
	addColorMap: function ( colormapName, arrayOfColors ) {
		...
		__ColorMapKeywords[ colormapName ] = arrayOfColors;
	...
	setLegendOn: function ( parameters ) {
		...
		this.map = __ColorMapKeywords[ this.mapname ];
...
export { __Lut as Lut, __ColorMapKeywords as ColorMapKeywords };
