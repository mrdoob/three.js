...
import { FXAAShader } from '../../modules/shaders/FXAAShader.js';
var __WebGLDeferredRenderer;
var __DeferredShaderChunk;
var __ShaderDeferredCommon;
var __ShaderDeferred;

__WebGLDeferredRenderer = function ( parameters ) {
	...
	function initPassFinal() {
		...
		_passFinal = new ShaderPass( __ShaderDeferred[ 'final' ] );
	...
	function createDeferredNormalDepthMaterial( originalMaterial ) {
		...
		var shader = ( _lightPrePass ) ? __ShaderDeferred[ 'normalDepthShininess' ] : __ShaderDeferred[ 'normalDepth' ];
	...
	function createDeferredColorMaterial( originalMaterial ) {
		...
		var shader = __ShaderDeferred[ 'color' ];
	...
	function createDeferredReconstructionMaterial( originalMaterial ) {
		...
		var shader = __ShaderDeferred[ 'reconstruction' ];
	...
	function createDeferredEmissiveLight() {
		...
		var shader = __ShaderDeferred[ 'emissiveLight' ];
	...
	function createDeferredPointLightMaterial() {
		...
		var shader = ( _lightPrePass ) ? __ShaderDeferred[ 'pointLightPre' ] : __ShaderDeferred[ 'pointLight' ];
	...
	function createDeferredSpotLightMaterial() {
		...
		var shader = ( _lightPrePass ) ? __ShaderDeferred[ 'spotLightPre' ] : __ShaderDeferred[ 'spotLight' ];
	...
	function createDeferredDirectionalLightMaterial() {
		...
		var shader = ( _lightPrePass ) ? __ShaderDeferred[ 'directionalLightPre' ] : __ShaderDeferred[ 'directionalLight' ];
	...
	function updateDeferredCommonUniforms( camera ) {
		...
		var uniforms = __ShaderDeferredCommon[ 'commonUniforms' ];
...
__ShaderDeferred = {
	...
	normalDepth: {
		...
		fragmentShader: [
			...
			__DeferredShaderChunk[ "packNormalDepth" ],
	...
	color: {
		...
		fragmentShader: [
			...
			__DeferredShaderChunk[ "packVector3" ],
			...
			__DeferredShaderChunk[ "packColor" ],
	...
	emissiveLight: {
		...
		uniforms: Object.assign(
			...
			__ShaderDeferredCommon[ 'commonUniforms' ]
		...
		fragmentShader: [
			...
			__DeferredShaderChunk[ "unpackFloat" ],

			"void main() {",

			__DeferredShaderChunk[ "computeTextureCoord" ],
			__DeferredShaderChunk[ "unpackColor" ],
	...
	pointLight: {
		...
		fragmentShader: [
			...
			__DeferredShaderChunk[ "computeTextureCoord" ],
			__DeferredShaderChunk[ "unpackNormalDepth" ],
			__DeferredShaderChunk[ "computeVertexPositionVS" ],
			...
			__DeferredShaderChunk[ "unpackColor" ],
			__DeferredShaderChunk[ "computeSpecular" ],
	...
	normalDepthShininess: {
		...
		fragmentShader: [
			...
			__DeferredShaderChunk[ "packNormal" ],
			...
			__DeferredShaderChunk[ "packNormalDepthShininess" ],
	...
	pointLightPre: {
		...
		fragmentShader: [
			...
			__DeferredShaderChunk[ "unpackFloat" ],
			__DeferredShaderChunk[ "unpackVector2" ],

			"void main() {",

			__DeferredShaderChunk[ "computeTextureCoord" ],
			__DeferredShaderChunk[ "unpackNormalDepthShininess" ],
			__DeferredShaderChunk[ "computeVertexPositionVS" ],
			...
			__DeferredShaderChunk[ "packLight" ],
...
export { __WebGLDeferredRenderer as WebGLDeferredRenderer, __DeferredShaderChunk as DeferredShaderChunk, __ShaderDeferredCommon as ShaderDeferredCommon, __ShaderDeferred as ShaderDeferred };
