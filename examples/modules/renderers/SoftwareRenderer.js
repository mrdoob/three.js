...
var __SoftwareRenderer;

__SoftwareRenderer = function ( parameters ) {
		...
		if ( shaders[ id ] === undefined || material.needsUpdate === true ) {
			...
			if ( material instanceof THREE.MeshBasicMaterial ||
				...
				if ( material.map ) {
					...
					var texture = new __SoftwareRenderer.Texture();
...
__SoftwareRenderer.Texture = function () {
...
export { __SoftwareRenderer as SoftwareRenderer };
