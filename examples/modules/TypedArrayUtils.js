...
__TypedArrayUtils.quicksortIP = function ( arr, eleSize, orderElement ) {
 ...
 */
 ...
 __TypedArrayUtils.Kdtree = function ( points, metric, eleSize ) {
	...
	function buildTree( points, depth, parent, pos ) {
		...
		__TypedArrayUtils.quicksortIP( points, eleSize, dim );
	...
	this.nearest = function ( point, maxNodes, maxDistance ) {
		...
		*/
		...
		bestNodes = new __TypedArrayUtils.Kdtree.BinaryHeap(
 ...
 */
__TypedArrayUtils.Kdtree.prototype.Node = function ( obj, depth, parent, pos ) {
...
__TypedArrayUtils.Kdtree.BinaryHeap = function ( scoreFunction ) {
...
__TypedArrayUtils.Kdtree.BinaryHeap.prototype = {
...
export { __TypedArrayUtils as TypedArrayUtils };
