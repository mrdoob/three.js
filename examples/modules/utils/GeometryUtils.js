...
__GeometryUtils = {
	...
	randomPointInFace: function ( face, geometry ) {
		...
		return __GeometryUtils.randomPointInTriangle( vA, vB, vC );
	...
	randomPointsInGeometry: function ( geometry, n ) {
		...
		for ( i = 0; i < il; i ++ ) {
			...
			face._area = __GeometryUtils.triangleArea( vA, vB, vC );
		...
		for ( i = 0; i < n; i ++ ) {
			...
			result[ i ] = __GeometryUtils.randomPointInFace( faces[ index ], geometry );
	...
	randomPointsInBufferGeometry: function ( geometry, n ) {
		...
		for ( i = 0; i < il; i ++ ) {
			...
			totalArea += __GeometryUtils.triangleArea( vA, vB, vC );
		...
		for ( i = 0; i < n; i ++ ) {
			...
			result[ i ] = __GeometryUtils.randomPointInTriangle( vA, vB, vC );
...
export { __GeometryUtils as GeometryUtils };
