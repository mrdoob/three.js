...
var __Lensflare;
var __LensflareElement;

__Lensflare = function () {

	THREE.Mesh.call( this, __Lensflare.Geometry, new THREE.MeshBasicMaterial( { opacity: 0, transparent: true } ) );
	...
	var geometry = __Lensflare.Geometry;
	...
	var shader = __LensflareElement.Shader;
...
__Lensflare.prototype = Object.create( THREE.Mesh.prototype );
__Lensflare.prototype.constructor = __Lensflare;
__Lensflare.prototype.isLensflare = true;

//

__LensflareElement = function ( texture, size, distance, color ) {
...
export { __Lensflare as Lensflare, __LensflareElement as LensflareElement };
