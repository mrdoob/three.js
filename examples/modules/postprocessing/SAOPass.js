...
import { DepthLimitedBlurShader, BlurShaderUtils } from '../../modules/shaders/DepthLimitedBlurShader.js';
import { SAOShader } from '../../modules/shaders/SAOShader.js';
import { UnpackDepthRGBAShader } from '../../modules/shaders/UnpackDepthRGBAShader.js';
var __SAOPass;

__SAOPass = function ( scene, camera, depthTexture, useNormals, resolution ) {
...
__SAOPass.prototype = Object.assign( Object.create( Pass.prototype ), {
	constructor: __SAOPass,
