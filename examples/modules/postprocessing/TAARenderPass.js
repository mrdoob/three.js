...
__TAARenderPass = function ( scene, camera, params ) {
...
__TAARenderPass.JitterVectors = SSAARenderPass.JitterVectors;

__TAARenderPass.prototype = Object.assign( Object.create( SSAARenderPass.prototype ), {

	constructor: __TAARenderPass,
	...
	render: function ( renderer, writeBuffer, readBuffer, delta ) {
		...
		var jitterOffsets = __TAARenderPass.JitterVectors[ 5 ];
...
export { __TAARenderPass as TAARenderPass };
