...
import { SSAOShader } from '../../modules/shaders/SSAOShader.js';var __SSAOPass;'use strict';
 ...
 * @class SSAOPass
 */
__SSAOPass = function ( scene, camera, width, height ) {
...
__SSAOPass.prototype = Object.create( ShaderPass.prototype );
 ...
 */
__SSAOPass.prototype.render = function ( renderer, writeBuffer, readBuffer, delta, maskActive ) {
 ...
 * @param {Scene} scene
 */
__SSAOPass.prototype.setScene = function ( scene ) {
 ...
 * @param {Camera} camera
 */
__SSAOPass.prototype.setCamera = function ( camera ) {
 ...
 * @param {Number} height
 */
__SSAOPass.prototype.setSize = function ( width, height ) {
