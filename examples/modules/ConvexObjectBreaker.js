...
import { ConvexBufferGeometry } from '../modules/geometries/ConvexGeometry.js';
var __ConvexObjectBreaker;

__ConvexObjectBreaker = function ( minSizeForBreak, smallDelta ) {
...
__ConvexObjectBreaker.prototype = {

	constructor: __ConvexObjectBreaker,
	...
	cutByPlane: function ( object, plane, output ) {
		...
		object.updateMatrix();
		__ConvexObjectBreaker.transformPlaneToLocalSpace( plane, object.matrix, localPlane );
...
__ConvexObjectBreaker.transformFreeVector = function ( v, m ) {
...
__ConvexObjectBreaker.transformFreeVectorInverse = function ( v, m ) {
...
__ConvexObjectBreaker.transformTiedVectorInverse = function ( v, m ) {
...
__ConvexObjectBreaker.transformPlaneToLocalSpace = function () {
	...
	return function transformPlaneToLocalSpace( plane, m, resultPlane ) {
		...
		var referencePoint = __ConvexObjectBreaker.transformTiedVectorInverse( plane.coplanarPoint( v1 ), m );

		__ConvexObjectBreaker.transformFreeVectorInverse( resultPlane.normal, m );
...
export { __ConvexObjectBreaker as ConvexObjectBreaker };
