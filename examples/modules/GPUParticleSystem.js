...
var __GPUParticleSystem;
var __GPUParticleContainer;

__GPUParticleSystem = function ( options ) {
	...
	this.init = function () {
		...
		for ( var i = 0; i < this.PARTICLE_CONTAINERS; i ++ ) {
			...
			var c = new __GPUParticleContainer( this.PARTICLES_PER_CONTAINER, this );
...
__GPUParticleSystem.prototype = Object.create( THREE.Object3D.prototype );
__GPUParticleSystem.prototype.constructor = __GPUParticleSystem;


// Subclass for particle containers, allows for very large arrays to be spread out

__GPUParticleContainer = function ( maxParticles, particleSystem ) {
...
__GPUParticleContainer.prototype = Object.create( THREE.Object3D.prototype );
__GPUParticleContainer.prototype.constructor = __GPUParticleContainer;

export { __GPUParticleSystem as GPUParticleSystem, __GPUParticleContainer as GPUParticleContainer };
