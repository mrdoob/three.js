...
BasicNode.prototype = Object.create(THREE.Node.prototype);
...
BasicNode.prototype.generate = function (builder) {
  ...
  if (builder.isShader('vertex')) {
    ...
    var output = ["#include <beginnormal_vertex>", "#include <defaultnormal_vertex>", "#ifndef FLAT_SHADED", " vNormal = normalize( transformedNormal );", "#endif", "#include <begin_vertex>"];
    ...
    builder.addParsCode(["varying vec3 vViewPosition;", "#ifndef FLAT_SHADED", " varying vec3 vNormal;", "#endif"].join("\n"));
    var output = ["#include <normal_fragment_begin>", color.code];
