...
function BlurNode(value, uv, radius, size) {
  ...
  this.radius = radius || new THREE.Vector2Node(1, 1);
  this.size = size;
  this.blurX = true;
  this.blurY = true;
...
BlurNode.prototype = Object.create(THREE.TempNode.prototype);
