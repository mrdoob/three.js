...
THREE.LensflareElement = THREE.Lensflare = void 0;

var Lensflare = function Lensflare() {
  Mesh.call(this, Lensflare.Geometry, new THREE.MeshBasicMaterial({
    opacity: 0,
    transparent: true
  }));
  this.type = 'Lensflare';
  ...
  var tempMap = new THREE.DataTexture(new Uint8Array(16 * 16 * 3), 16, 16, RGBFormat);
