...
THREE.TreesGeometry = THREE.SkyGeometry = THREE.RollerCoasterShadowGeometry = THREE.RollerCoasterLiftersGeometry = THREE.RollerCoasterGeometry = void 0;
...
var RollerCoasterGeometry = function RollerCoasterGeometry(curve, divisions) {
  ...
  var step = [new Vector3(-0.225, 0, 0), new Vector3(0, -0.050, 0), new Vector3(0, -0.175, 0), new Vector3(0, -0.050, 0), new Vector3(0.225, 0, 0), new Vector3(0, -0.175, 0)];
  var PI2 = Math.PI * 2;
  var sides = 5;
  var tube1 = [];
