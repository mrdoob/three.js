...
THREE.SubsurfaceScatteringShader = void 0;

function replaceAll(string, find, replace) {
  return string.split(find).join(replace);
}

var meshphong_frag_head = THREE.ShaderChunk["meshphong_frag"].slice(0, ShaderChunk["meshphong_frag"].indexOf('void main() {'));
...
var SubsurfaceScatteringShader = {
  uniforms: THREE.UniformsUtils.merge([ShaderLib["phong"].uniforms, {
    "thicknessMap": {
      value: null
    },
    "thicknessColor": {
