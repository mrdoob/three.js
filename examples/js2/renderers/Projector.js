...
THREE.Projector = THREE.RenderableSprite = THREE.RenderableLine = THREE.RenderableVertex = THREE.RenderableFace = THREE.RenderableObject = void 0;
...
var RenderableFace = function RenderableFace() {
  ...
  this.material = null;
  this.uvs = [new THREE.Vector2(), new Vector2(), new Vector2()];
  this.z = 0;
  this.renderOrder = 0;
};
...
var Projector = function Projector() {
  var _object,
    ...
    elements: []
      ...
      _clipBox = new THREE.Box3(new Vector3(-1, -1, -1), new Vector3(1, 1, 1)),
