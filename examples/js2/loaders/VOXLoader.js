...
VOXLoader.prototype = Object.assign(Object.create(THREE.Loader.prototype), {
  ...
  parse: function parse(buffer) {
    ...
    while (i < data.byteLength) {
      ...
      for (var j = 0; j < 4; j++) {
        _id += String.fromCharCode(data.getInt8(i++, true));
      }

      var chunkSize = data.getInt32(i, true);
      i += 4;
      data.getInt32(i, true);
      i += 4;

      if (_id === 'SIZE') {
        var x = data.getInt32(i, true);
        i += 4;
        var y = data.getInt32(i, true);
        i += 4;
        var z = data.getInt32(i, true);
        i += 4;
        chunk = {
        ...
        var numVoxels = data.getInt32(i, true);
        i += 4;
        ...
        for (var _j = 0; _j < 256; _j++) {
          palette[_j + 1] = data.getInt32(i, true);
          i += 4;
        }
