...
var UnrealBloomPass = function UnrealBloomPass(resolution, strength, radius, threshold) {
  ...
  this.resolution = resolution !== undefined ? new THREE.Vector2(resolution.x, resolution.y) : new Vector2(256, 256);
  ...
  this.bloomTintColors = [new THREE.Vector3(1, 1, 1), new Vector3(1, 1, 1), new Vector3(1, 1, 1), new Vector3(1, 1, 1), new Vector3(1, 1, 1)];
