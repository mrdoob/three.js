...
(function (f) {
  ...
  return function e(t, n, r) {
    ...
    2: [function (require, module, exports) {
      ...
      THREE.fail = function (r) {
        throw new Error(r);
      }, THREE.argument = function (r, t) {
        r || THREE.fail(t);
      }, THREE.assert = THREE.argument;
    }, {}],
    ...
    4: [function (require, module, exports) {
      ...
      function GlyphNames(e) {
        ...
        switch (e.version) {
          case 1:
            this.names = THREE.standardNames.slice();
            break;

          case 2:
            for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++) {
              this.names[l] = e.glyphNameIndex[l] < THREE.standardNames.length ? THREE.standardNames[e.glyphNameIndex[l]] : e.names[e.glyphNameIndex[l] - THREE.standardNames.length];
            }
          ...
          case 2.5:
            for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++) {
              this.names[l] = THREE.standardNames[l + e.glyphNameIndex[l]];
            }
      ...
      DefaultEncoding.prototype.charToGlyphIndex = function (e) {
        ...
        return this.names[e];
      }, THREE.cffStandardStrings = cffStandardStrings, THREE.cffStandardEncoding = cffStandardEncoding, THREE.cffExpertEncoding = cffExpertEncoding, THREE.standardNames = standardNames, THREE.DefaultEncoding = DefaultEncoding, THREE.CmapEncoding = CmapEncoding, THREE.CffEncoding = CffEncoding, THREE.GlyphNames = GlyphNames, THREE.addGlyphNames = addGlyphNames;
    }, {}],
    ...
    7: [function (require, module, exports) {
      ...
      }, THREE.GlyphSet = GlyphSet, THREE.glyphLoader = glyphLoader, THREE.ttfGlyphLoader = ttfGlyphLoader, THREE.cffGlyphLoader = cffGlyphLoader;
    }, {
      "./glyph": 6
    }],
    ...
    9: [function (require, module, exports) {
      ...
      THREE._parse = parse, THREE.Font = _font.Font, THREE.Glyph = glyph.Glyph, THREE.Path = path.Path, THREE.parse = parseBuffer, THREE.load = load, THREE.loadSync = loadSync;
    }, {
      "./encoding": 4,
      "./font": 5,
      "./glyph": 6,
    ...
    10: [function (require, module, exports) {
      ...
      THREE.getByte = function (t, r) {
        return t.getUint8(r);
      }, THREE.getCard8 = THREE.getByte, THREE.getUShort = THREE.getCard16 = getUShort, THREE.getShort = function (t, r) {
        return t.getInt16(r, !1);
      }, THREE.getULong = function (t, r) {
        return t.getUint32(r, !1);
      }, THREE.getFixed = function (t, r) {
        var e = t.getInt16(r, !1),
            s = t.getUint16(r + 2, !1);
        return e + s / 65535;
      }, THREE.getTag = function (t, r) {
        for (var e = "", s = r; r + 4 > s; s += 1) {
          e += String.fromCharCode(t.getInt8(s));
        }

        return e;
      }, THREE.getOffset = function (t, r, e) {
        for (var s = 0, a = 0; e > a; a += 1) {
          s <<= 8, s += t.getUint8(r + a);
        }

        return s;
      }, THREE.getBytes = function (t, r, e) {
        for (var s = [], a = r; e > a; a += 1) {
          s.push(t.getUint8(a));
        }

        return s;
      }, THREE.bytesToString = function (t) {
      ...
      Parser.prototype.parseByte = function () {
        ...
        var t = THREE.getULong(this.data, this.offset + this.relativeOffset);
        return this.relativeOffset += 4, t;
      }, Parser.prototype.parseFixed = function () {
        var t = THREE.getFixed(this.data, this.offset + this.relativeOffset);
        return this.relativeOffset += 4, t;
        ...
        var t = THREE.getULong(this.data, this.offset + this.relativeOffset + 4);
    ...
    13: [function (require, module, exports) {
      ...
      }, Coverage.prototype = Object.create(Table.prototype), Coverage.prototype.constructor = Coverage, ScriptList.prototype = Object.create(Table.prototype), ScriptList.prototype.constructor = ScriptList, FeatureList.prototype = Object.create(Table.prototype), FeatureList.prototype.constructor = FeatureList, LookupList.prototype = Object.create(Table.prototype), LookupList.prototype.constructor = LookupList, THREE.Record = THREE.Table = Table, THREE.Coverage = Coverage, THREE.ScriptList = ScriptList, THREE.FeatureList = FeatureList, THREE.LookupList = LookupList, THREE.ushortList = ushortList, THREE.tableList = tableList, THREE.recordList = recordList;
    }, {
      "./check": 2,
      "./types": 32
    }],
    14: [function (require, module, exports) {
      ...
      THREE.parse = parseCFFTable, THREE.make = makeCFFTable;
    }, {
      "../encoding": 4,
      "../glyphset": 7,
      "../parse": 10,
    ...
    15: [function (require, module, exports) {
      ...
      THREE.parse = parseCmapTable, THREE.make = makeCmapTable;
    }, {
      "../check": 2,
      "../parse": 10,
      "../table": 13
    ...
    16: [function (require, module, exports) {
      ...
      THREE.make = makeFvarTable, THREE.parse = parseFvarTable;
    }, {
      "../check": 2,
      "../parse": 10,
      "../table": 13
    ...
    19: [function (require, module, exports) {
      ...
      }, THREE.parse = parseGsubTable, THREE.make = makeGsubTable;
    }, {
      "../check": 2,
      "../parse": 10,
      "../table": 13
    ...
    20: [function (require, module, exports) {
      ...
      THREE.parse = parseHeadTable, THREE.make = makeHeadTable;
    }, {
      "../check": 2,
      "../parse": 10,
      "../table": 13
    ...
    21: [function (require, module, exports) {
      ...
      THREE.parse = parseHheaTable, THREE.make = makeHheaTable;
    }, {
      "../parse": 10,
      "../table": 13
    }],
    22: [function (require, module, exports) {
      ...
      THREE.parse = parseHmtxTable, THREE.make = makeHmtxTable;
    }, {
      "../parse": 10,
      "../table": 13
    }],
    ...
    25: [function (require, module, exports) {
      ...
      THREE.make = makeLtagTable, THREE.parse = parseLtagTable;
    }, {
      "../check": 2,
      "../parse": 10,
      "../table": 13
    ...
    26: [function (require, module, exports) {
      ...
      THREE.parse = parseMaxpTable, THREE.make = makeMaxpTable;
    }, {
      "../parse": 10,
      "../table": 13
    }],
    27: [function (require, module, exports) {
      ...
      THREE.parse = parseMetaTable, THREE.make = makeMetaTable;
    }, {
      "../check": 2,
      "../parse": 10,
      "../table": 13,
    ...
    28: [function (require, module, exports) {
      ...
      THREE.parse = parseNameTable, THREE.make = makeNameTable;
    }, {
      "../parse": 10,
      "../table": 13,
      "../types": 32
    ...
    29: [function (require, module, exports) {
      ...
      THREE.unicodeRanges = unicodeRanges, THREE.getUnicodeRange = getUnicodeRange, THREE.parse = parseOS2Table, THREE.make = makeOS2Table;
    }, {
      "../parse": 10,
      "../table": 13
    }],
    30: [function (require, module, exports) {
      ...
      THREE.parse = parsePostTable, THREE.make = makePostTable;
    }, {
      "../encoding": 4,
      "../parse": 10,
      "../table": 13
    ...
    31: [function (require, module, exports) {
      ...
      THREE.computeCheckSum = computeCheckSum, THREE.make = makeSfntTable, THREE.fontToTable = fontToSfntTable;
    }, {
      "../check": 2,
      "../table": 13,
      "./cff": 14,
    ...
    32: [function (require, module, exports) {
      ...
      encode.CHARSTRING = function (e) {
        ...
        return e.length;
      }, THREE.decode = decode, THREE.encode = encode, THREE.sizeOf = sizeOf;
    }, {
      "./check": 2
    }],
    33: [function (require, module, exports) {
      ...
      THREE.isBrowser = function () {
        return "undefined" != typeof window;
      }, THREE.isNode = function () {
        return "undefined" == typeof window;
      }, THREE.nodeBufferToArrayBuffer = function (r) {
        for (var e = new ArrayBuffer(r.length), n = new Uint8Array(e), t = 0; t < r.length; ++t) {
          n[t] = r[t];
        }

        return e;
      }, THREE.arrayBufferToNodeBuffer = function (r) {
        for (var e = new Buffer(r.byteLength), n = new Uint8Array(r), t = 0; t < e.length; ++t) {
          e[t] = n[t];
        }

        return e;
      }, THREE.checkArgument = function (r, e) {
        if (!r) throw e;
      };
    }, {}]
  }, {}, [9])(9);
