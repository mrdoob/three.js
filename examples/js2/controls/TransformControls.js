...
THREE.TransformControlsPlane = THREE.TransformControlsGizmo = THREE.TransformControls = void 0;
...
var TransformControlsGizmo = function TransformControlsGizmo() {
  ...
  var gizmoTranslate = {
    ...
    XYZ: [[new Mesh(new THREE.OctahedronBufferGeometry(0.1, 0), matWhiteTransparent.clone()), [0, 0, 0], [0, 0, 0]]],
    XY: [[new Mesh(new THREE.PlaneBufferGeometry(0.295, 0.295), matYellowTransparent.clone()), [0.15, 0.15, 0]], [new Line(lineGeometry, matLineYellow), [0.18, 0.3, 0], null, [0.125, 1, 1]], [new Line(lineGeometry, matLineYellow), [0.3, 0.18, 0], [0, 0, Math.PI / 2], [0.125, 1, 1]]],
  ...
  var pickerRotate = {
    X: [[new Mesh(new THREE.TorusBufferGeometry(1, 0.1, 4, 24), matInvisible), [0, 0, 0], [0, -Math.PI / 2, -Math.PI / 2]]],
    ...
    XYZE: [[new Mesh(new THREE.SphereBufferGeometry(0.7, 10, 8), matInvisible)]]
  };
  var gizmoScale = {
