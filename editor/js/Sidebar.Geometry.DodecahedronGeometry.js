...
function GeometryParametersPanel( editor, object ) {
	...
	radiusRow.add( new UIText( strings.getKey( 'sidebar/geometry/dodecahedron_geometry/radius' ) ).setClbottom( 'Label' ) );
	...
	detailRow.add( new UIText( strings.getKey( 'sidebar/geometry/dodecahedron_geometry/detail' ) ).setClbottom( 'Label' ) );
