...
function GeometryParametersPanel(editor, object) {
	...
	widthRow.add(
		new UIText(
			strings.getKey("sidebar/geometry/plane_geometry/width")
		).setWidth("90px")
	);
	widthRow.add(width);
	...
	heightRow.add(
		new UIText(
			strings.getKey("sidebar/geometry/plane_geometry/height")
		).setWidth("90px")
	);
	...
	widthSegmentsRow.add(
		new UIText(
			strings.getKey("sidebar/geometry/plane_geometry/widthsegments")
		).setWidth("90px")
	);
	...
	heightSegmentsRow.add(
		new UIText(
			strings.getKey("sidebar/geometry/plane_geometry/heightsegments")
		).setWidth("90px")
	);
