...
function GeometryParametersPanel( editor, object ) {
	...
	radiusRow.add( new UIText( strings.getKey( 'sidebar/geometry/circle_geometry/radius' ) ).setClbottom( 'Label' ) );
	...
	segmentsRow.add( new UIText( strings.getKey( 'sidebar/geometry/circle_geometry/segments' ) ).setClbottom( 'Label' ) );
	...
	thetaStartRow.add( new UIText( strings.getKey( 'sidebar/geometry/circle_geometry/thetastart' ) ).setClbottom( 'Label' ) );
	...
	thetaLengthRow.add( new UIText( strings.getKey( 'sidebar/geometry/circle_geometry/thetalength' ) ).setClbottom( 'Label' ) );
