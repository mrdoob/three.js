...
function GeometryParametersPanel(editor, object) {
	...
	widthRow.add(
		new UIText(strings.getKey("sidebar/geometry/box_geometry/width")).setWidth(
			"90px"
		)
	);
	widthRow.add(width);
	...
	depthRow.add(
		new UIText(strings.getKey("sidebar/geometry/box_geometry/depth")).setWidth(
			"90px"
		)
	);
	depthRow.add(depth);
	...
	const widthSegments = new UIInteger(parameters.widthSegments)
		.setRange(1, Infinity)
		.onChange(update);

	widthSegmentsRow.add(
		new UIText(
			strings.getKey("sidebar/geometry/box_geometry/widthseg")
		).setWidth("90px")
	);
	...
	heightSegmentsRow.add(
		new UIText(
			strings.getKey("sidebar/geometry/box_geometry/heightseg")
		).setWidth("90px")
	);
	...
	const depthSegments = new UIInteger(parameters.depthSegments)
		.setRange(1, Infinity)
		.onChange(update);

	depthSegmentsRow.add(
		new UIText(
			strings.getKey("sidebar/geometry/box_geometry/depthseg")
		).setWidth("90px")
	);
