...
import { MultipleSelectionControls } from './MultipleSelectionControls.js';
...
function Toolbar( editor ) {
	...
	translateIcon.title = getToolbarBtnHintText( strings.getKey( 'toolbar/translate' ), config.getKey( 'settings/shortcuts/translate' ) );
	...
	rotateIcon.title = getToolbarBtnHintText( strings.getKey( 'toolbar/rotate' ), config.getKey( 'settings/shortcuts/rotate' ) );
	...
	scaleIcon.title = getToolbarBtnHintText( strings.getKey( 'toolbar/scale' ), config.getKey( 'settings/shortcuts/scale' ) );
	...
	const multipleSelection = new MultipleSelectionControls( editor );
	...
	signals.transformModeChanged.add( function ( mode ) {
		...
		multipleSelection.toggleBtn.dom.classList.remove( 'selected' );
	...
	signals.disableMultipleSelection.add( function () {
