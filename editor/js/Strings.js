function Strings( config ) {
	...
	const values = {
		...
		pt: {
			'prompt/file/open': 'Quaisquer dados não salvos serão perdidos. Tem certeza?',
			'prompt/file/failedToOpenProject': 'Falha ao abrir o projeto!',
			'prompt/file/export/noMeshSelected': 'Nenhuma Mesh selecionada!',
			'prompt/file/export/noObjectSelected': 'Nenhum Objeto selecionado!',
			'prompt/file/export/duplicateNames': 'Alguns objetos compartilham o mesmo nome. Eles serão renomeados para garantir nomes únicos. Tem certeza?',
			'prompt/script/remove': 'Tem certeza?',
			'prompt/history/clear': 'O Histórico de Desfazer/Refazer será limpo. Tem certeza?',
			'prompt/history/preserve': 'O histórico será preservado entre as sessões.\nIsso pode impactar o desempenho ao trabalhar com texturas.',
			'prompt/history/forbid': 'Desfazer/Refazer desabilitado enquanto a cena está em execução.',
			'prompt/rendering/realistic/unsupportedMaterial': 'Sombreamento REALISTIC: apenas MeshStandardMaterial e MeshPhysicalMaterial são suportados',

			'command/AddObject': 'Adicionar Objeto',
			'command/AddScript': 'Adicionar Script',
			'command/MoveObject': 'Mover Objeto',
			'command/MultiCmds': 'Múltiplas Alterações',
			'command/RemoveObject': 'Remover Objeto',
			'command/RemoveScript': 'Remover Script',
			'command/SetColor': 'Definir Cor',
			'command/SetGeometry': 'Definir Geometria',
			'command/SetGeometryValue': 'Definir Valor da Geometria',
			'command/SetMaterialColor': 'Definir Cor do Material',
			'command/SetMaterial': 'Definir Material',
			'command/SetMaterialMap': 'Definir Mapa do Material',
			'command/SetMaterialRange': 'Definir Intervalo do Material',
			'command/SetMaterialValue': 'Definir Valor do Material',
			'command/SetMaterialVector': 'Definir Vetor do Material',
			'command/SetPosition': 'Definir Posição',
			'command/SetRotation': 'Definir Rotação',
			'command/SetScale': 'Definir Escala',
			'command/SetScene': 'Definir Cena',
			'command/SetScriptValue': 'Definir Valor do Script',
			'command/SetShadowValue': 'Definir Valor da Sombra',
			'command/SetTextureParameters': 'Definir Parâmetros da Textura',
			'command/SetUuid': 'Definir UUID',
			'command/SetValue': 'Definir Valor',

			'menubar/file': 'Arquivo',
			'menubar/file/new': 'Novo',
			'menubar/file/new/empty': 'Vazio',
			'menubar/file/new/Arkanoid': 'Arkanoid',
			'menubar/file/new/Camera': 'Câmera',
			'menubar/file/new/Particles': 'Partículas',
			'menubar/file/new/Pong': 'Pong',
			'menubar/file/new/Shaders': 'Shaders',
			'menubar/file/open': 'Abrir',
			'menubar/file/save': 'Salvar',
			'menubar/file/import': 'Importar',
			'menubar/file/export': 'Exportar',

			'menubar/edit': 'Editar',
			'menubar/edit/undo': 'Desfazer',
			'menubar/edit/redo': 'Refazer',
			'menubar/edit/center': 'Centralizar',
			'menubar/edit/clone': 'Clonar',
			'menubar/edit/delete': 'Excluir',

			'menubar/add': 'Adicionar',
			'menubar/add/group': 'Grupo',

			'menubar/add/mesh': 'Mesh',
			'menubar/add/mesh/plane': 'Plano',
			'menubar/add/mesh/box': 'Caixa',
			'menubar/add/mesh/capsule': 'Cápsula',
			'menubar/add/mesh/circle': 'Círculo',
			'menubar/add/mesh/cylinder': 'Cilindro',
			'menubar/add/mesh/ring': 'Anel',
			...
			'menubar/add/light/ambient': 'Ambiente',
			'menubar/add/light/directional': 'Direcional',
			'menubar/add/light/hemisphere': 'Hemisfério',
			'menubar/add/light/point': 'Ponto',
			'menubar/add/light/spot': 'Spot',

			'menubar/add/camera': 'Câmera',
			'menubar/add/camera/perspective': 'Perspectiva',
			'menubar/add/camera/orthographic': 'Ortográfica',

			'menubar/status/autosave': 'salvamento automático',

			'menubar/view': 'Visualizar',
			'menubar/view/fullscreen': 'Tela Cheia',
			'menubar/view/gridHelper': 'Auxiliar de Grade',
			'menubar/view/cameraHelpers': 'Auxiliares de Câmera',
			'menubar/view/lightHelpers': 'Auxiliares de Luz',
			'menubar/view/skeletonHelpers': 'Auxiliares de Esqueleto',

			'menubar/render': 'Renderização',
			'menubar/render/image': 'Imagem',
			'menubar/render/video': 'Vídeo',
			'menubar/render/quality': 'Qualidade',
			'menubar/render/cancel': 'Cancelar',

			'menubar/help': 'Ajuda',
			'menubar/help/source_code': 'Código Fonte',
			'menubar/help/icons': 'Pacote de Ícones',
			'menubar/help/about': 'Sobre',
			'menubar/help/manual': 'Manual',

			'sidebar/animations': 'Animações',
			'sidebar/animations/play': 'Reproduzir',
			'sidebar/animations/stop': 'Parar',
			'sidebar/animations/timescale': 'Escala de Tempo',

			'sidebar/scene': 'Cena',
			'sidebar/scene/background': 'Fundo',
			'sidebar/scene/environment': 'Ambiente',
			'sidebar/scene/fog': 'Névoa',

			'sidebar/properties/object': 'Objeto',
			'sidebar/properties/geometry': 'Geometria',
			'sidebar/properties/material': 'Material',
			'sidebar/properties/script': 'Script',

			'sidebar/object/type': 'Tipo',
			'sidebar/object/new': 'Novo',
			'sidebar/object/uuid': 'UUID',
			'sidebar/object/name': 'Nome',
			'sidebar/object/position': 'Posição',
			'sidebar/object/rotation': 'Rotação',
			'sidebar/object/scale': 'Escala',
			'sidebar/object/fov': 'FOV',
			'sidebar/object/left': 'Esquerda',
			'sidebar/object/right': 'Direita',
			'sidebar/object/top': 'Superior',
			'sidebar/object/bottom': 'Inferior',
			'sidebar/object/near': 'Próximo',
			'sidebar/object/far': 'Distante',
			'sidebar/object/intensity': 'Intensidade',
			'sidebar/object/color': 'Cor',
			'sidebar/object/groundcolor': 'Cor do Solo',
			'sidebar/object/distance': 'Distância',
			'sidebar/object/angle': 'Ângulo',
			'sidebar/object/penumbra': 'Penumbra',
			'sidebar/object/decay': 'Decaimento',
			'sidebar/object/shadow': 'Sombra',
			'sidebar/object/shadowIntensity': 'Intensidade da Sombra',
			'sidebar/object/shadowBias': 'Viés da Sombra',
			'sidebar/object/shadowNormalBias': 'Viés Normal da Sombra',
			'sidebar/object/shadowRadius': 'Raio da Sombra',
			'sidebar/object/cast': 'projetar',
			'sidebar/object/receive': 'receber',
			'sidebar/object/visible': 'Visível',
			'sidebar/object/frustumcull': 'Culling do Frustum',
			'sidebar/object/renderorder': 'Ordem de Renderização',
			'sidebar/object/userdata': 'Dados do Usuário',
			'sidebar/object/export': 'Exportar JSON',

			'sidebar/geometry/type': 'Tipo',
			'sidebar/geometry/new': 'Novo',
			'sidebar/geometry/uuid': 'UUID',
			'sidebar/geometry/name': 'Nome',
			'sidebar/geometry/bounds': 'Limites',
			'sidebar/geometry/userdata': 'Dados do Usuário',
			'sidebar/geometry/show_vertex_normals': 'Mostrar Normais dos Vértices',
			'sidebar/geometry/compute_vertex_normals': 'Calcular Normais dos Vértices',
			'sidebar/geometry/compute_vertex_tangents': 'Calcular Tangentes',
			'sidebar/geometry/center': 'Centralizar',
			'sidebar/geometry/export': 'Exportar JSON',
			'sidebar/geometry/morph': 'Alvos de Morfagem',

			'sidebar/geometry/box_geometry/width': 'Largura',
			'sidebar/geometry/box_geometry/height': 'Altura',
			'sidebar/geometry/box_geometry/depth': 'Profundidade',
			'sidebar/geometry/box_geometry/widthseg': 'Seg. Largura',
			'sidebar/geometry/box_geometry/heightseg': 'Seg. Altura',
			'sidebar/geometry/box_geometry/depthseg': 'Seg. Profundidade',

			'sidebar/geometry/buffer_geometry/attributes': 'Atributos',
			'sidebar/geometry/buffer_geometry/index': 'índice',
			'sidebar/geometry/buffer_geometry/morphAttributes': 'Atributos de Morfagem',
			'sidebar/geometry/buffer_geometry/morphRelative': 'Morfagem Relativa',

			'sidebar/geometry/capsule_geometry/radius': 'Raio',
			'sidebar/geometry/capsule_geometry/height': 'Altura',
			'sidebar/geometry/capsule_geometry/capseg': 'Seg. da Tampa',
			'sidebar/geometry/capsule_geometry/radialseg': 'Seg. Radiais',
			'sidebar/geometry/capsule_geometry/heightseg': 'Seg. Altura',

			'sidebar/geometry/circle_geometry/radius': 'Raio',
			'sidebar/geometry/circle_geometry/segments': 'Segmentos',
			'sidebar/geometry/circle_geometry/thetastart': 'Início Theta',
			'sidebar/geometry/circle_geometry/thetalength': 'Comprimento Theta',

			'sidebar/geometry/cylinder_geometry/radiustop': 'Raio superior',
			'sidebar/geometry/cylinder_geometry/radiusbottom': 'Raio inferior',
			'sidebar/geometry/cylinder_geometry/height': 'Altura',
			'sidebar/geometry/cylinder_geometry/radialsegments': 'Segmentos radiais',
			'sidebar/geometry/cylinder_geometry/heightsegments': 'Segmentos de altura',
			'sidebar/geometry/cylinder_geometry/openended': 'Aberto',

			'sidebar/geometry/extrude_geometry/curveSegments': 'Segmentos de Curva',
			'sidebar/geometry/extrude_geometry/steps': 'Passos',
			'sidebar/geometry/extrude_geometry/depth': 'Profundidade',
			'sidebar/geometry/extrude_geometry/bevelEnabled': 'Chanfro',
			'sidebar/geometry/extrude_geometry/bevelThickness': 'Espessura',
			'sidebar/geometry/extrude_geometry/bevelSize': 'Tamanho',
			'sidebar/geometry/extrude_geometry/bevelOffset': 'Deslocamento',
			'sidebar/geometry/extrude_geometry/bevelSegments': 'Segmentos',
			'sidebar/geometry/extrude_geometry/shape': 'Converter para Forma',

			'sidebar/geometry/dodecahedron_geometry/radius': 'Raio',
			'sidebar/geometry/dodecahedron_geometry/detail': 'Detalhe',

			'sidebar/geometry/icosahedron_geometry/radius': 'Raio',
			'sidebar/geometry/icosahedron_geometry/detail': 'Detalhe',

			'sidebar/geometry/octahedron_geometry/radius': 'Raio',
			'sidebar/geometry/octahedron_geometry/detail': 'Detalhe',

			'sidebar/geometry/tetrahedron_geometry/radius': 'Raio',
			'sidebar/geometry/tetrahedron_geometry/detail': 'Detalhe',

			'sidebar/geometry/lathe_geometry/segments': 'Segmentos',
			'sidebar/geometry/lathe_geometry/phistart': 'Início Phi (°)',
			'sidebar/geometry/lathe_geometry/philength': 'Comprimento Phi (°)',
			'sidebar/geometry/lathe_geometry/points': 'Pontos',

			'sidebar/geometry/plane_geometry/width': 'Largura',
			'sidebar/geometry/plane_geometry/height': 'Altura',
			'sidebar/geometry/plane_geometry/widthsegments': 'Segmentos de largura',
			'sidebar/geometry/plane_geometry/heightsegments': 'Segmentos de altura',

			'sidebar/geometry/ring_geometry/innerRadius': 'Raio interno',
			'sidebar/geometry/ring_geometry/outerRadius': 'Raio externo',
			'sidebar/geometry/ring_geometry/thetaSegments': 'Segmentos Theta',
			'sidebar/geometry/ring_geometry/phiSegments': 'Segmentos Phi',
			'sidebar/geometry/ring_geometry/thetastart': 'Início Theta',
			'sidebar/geometry/ring_geometry/thetalength': 'Comprimento Theta',

			'sidebar/geometry/text_geometry/text': 'Texto',
			'sidebar/geometry/text_geometry/size': 'Tamanho da fonte',
			'sidebar/geometry/text_geometry/depth': 'Profundidade de extrusão',
			'sidebar/geometry/text_geometry/scale': 'Escala',
			'sidebar/geometry/text_geometry/curveseg': 'Segmentos de curva',
			'sidebar/geometry/text_geometry/bevelenabled': 'Chanfro ativado',
			'sidebar/geometry/text_geometry/bevelthickness': 'Espessura do chanfro',
			'sidebar/geometry/text_geometry/bevelsize': 'Tamanho do chanfro',
			'sidebar/geometry/text_geometry/bevelOffset': 'Deslocamento do chanfro',
			'sidebar/geometry/text_geometry/bevelseg': 'Segmentos do chanfro',

			'sidebar/geometry/shape_geometry/curveSegments': 'Segmentos de Curva',
			'sidebar/geometry/shape_geometry/extrude': 'Extrusão',

			'sidebar/geometry/sphere_geometry/radius': 'Raio',
			'sidebar/geometry/sphere_geometry/widthsegments': 'Segmentos de largura',
			'sidebar/geometry/sphere_geometry/heightsegments': 'Segmentos de altura',
			'sidebar/geometry/sphere_geometry/phistart': 'Início Phi',
			'sidebar/geometry/sphere_geometry/philength': 'Comprimento Phi',
			'sidebar/geometry/sphere_geometry/thetastart': 'Início Theta',
			'sidebar/geometry/sphere_geometry/thetalength': 'Comprimento Theta',

			'sidebar/geometry/torus_geometry/radius': 'Raio',
			'sidebar/geometry/torus_geometry/tube': 'Tubo',
			'sidebar/geometry/torus_geometry/radialsegments': 'Segmentos radiais',
			'sidebar/geometry/torus_geometry/tubularsegments': 'Segmentos tubulares',
			'sidebar/geometry/torus_geometry/arc': 'Arco',

			'sidebar/geometry/torusKnot_geometry/radius': 'Raio',
			'sidebar/geometry/torusKnot_geometry/tube': 'Tubo',
			'sidebar/geometry/torusKnot_geometry/tubularsegments': 'Segmentos tubulares',
			'sidebar/geometry/torusKnot_geometry/radialsegments': 'Segmentos radiais',
			'sidebar/geometry/torusKnot_geometry/p': 'P',
			'sidebar/geometry/torusKnot_geometry/q': 'Q',

			'sidebar/geometry/tube_geometry/path': 'Caminho',
			'sidebar/geometry/tube_geometry/radius': 'Raio',
			'sidebar/geometry/tube_geometry/tube': 'Tubo',
			'sidebar/geometry/tube_geometry/tubularsegments': 'Segmentos tubulares',
			'sidebar/geometry/tube_geometry/radialsegments': 'Segmentos radiais',
			'sidebar/geometry/tube_geometry/closed': 'Fechado',
			'sidebar/geometry/tube_geometry/curvetype': 'Tipo de Curva',
			'sidebar/geometry/tube_geometry/tension': 'Tensão',

			'sidebar/material/new': 'Novo',
			'sidebar/material/copy': 'Copiar',
			'sidebar/material/paste': 'Colar',
			'sidebar/material/slot': 'Slot',
			'sidebar/material/type': 'Tipo',
			'sidebar/material/uuid': 'UUID',
			'sidebar/material/name': 'Nome',
			'sidebar/material/program': 'Programa',
			'sidebar/material/info': 'Informações',
			'sidebar/material/vertex': 'Vértice',
			'sidebar/material/fragment': 'Fragmento',
			'sidebar/material/color': 'Cor',
			'sidebar/material/depthPacking': 'Empacotamento de Profundidade',
			'sidebar/material/roughness': 'Rugosidade',
			'sidebar/material/metalness': 'Metalicidade',
			'sidebar/material/reflectivity': 'Refletividade',
			'sidebar/material/emissive': 'Emissivo',
			'sidebar/material/specular': 'Especular',
			'sidebar/material/shininess': 'Brilho',
			'sidebar/material/clearcoat': 'Clearcoat',
			'sidebar/material/clearcoatroughness': 'Rugosidade do Clearcoat',
			'sidebar/material/dispersion': 'Dispersão',
			'sidebar/material/ior': 'IOR',
			'sidebar/material/iridescence': 'Iridescência',
			'sidebar/material/iridescenceIOR': 'IOR do Filme Fino',
			'sidebar/material/iridescenceThicknessMax': 'Espessura do Filme Fino',
			'sidebar/material/sheen': 'Sheen',
			'sidebar/material/sheenroughness': 'Rugosidade do Sheen',
			'sidebar/material/sheencolor': 'Cor do Sheen',
			'sidebar/material/transmission': 'Transmissão',
			'sidebar/material/attenuationDistance': 'Distância de Atenuação',
			'sidebar/material/attenuationColor': 'Cor de Atenuação',
			'sidebar/material/thickness': 'Espessura',
			'sidebar/material/vertexcolors': 'Cores dos Vértices',
			'sidebar/material/matcap': 'Matcap',
			'sidebar/material/map': 'Mapa',
			'sidebar/material/alphamap': 'Mapa Alpha',
			'sidebar/material/bumpmap': 'Mapa de Relevo',
			'sidebar/material/normalmap': 'Mapa Normal',
			'sidebar/material/clearcoatmap': 'Mapa Clearcoat',
			'sidebar/material/clearcoatnormalmap': 'Mapa Normal Clearcoat',
			'sidebar/material/clearcoatroughnessmap': 'Mapa de Rugosidade Clearcoat',
			'sidebar/material/displacementmap': 'Mapa de Deslocamento',
			'sidebar/material/roughnessmap': 'Mapa Rugos.',
			'sidebar/material/metalnessmap': 'Mapa Metal.',
			'sidebar/material/specularmap': 'Mapa Especular',
			'sidebar/material/iridescencemap': 'Mapa Irid.',
			'sidebar/material/iridescencethicknessmap': 'Mapa de Espessura do Filme Fino',
			'sidebar/material/sheencolormap': 'Mapa de Cor do Sheen',
			'sidebar/material/sheenroughnessmap': 'Mapa Rugos. Sheen',
			'sidebar/material/envmap': 'Mapa de Ambiente',
			'sidebar/material/lightmap': 'Mapa de Luz',
			'sidebar/material/aomap': 'Mapa AO',
			'sidebar/material/emissivemap': 'Mapa Emissivo',
			'sidebar/material/gradientmap': 'Mapa Gradiente',
			'sidebar/material/transmissionmap': 'Mapa de Transmissão',
			'sidebar/material/thicknessmap': 'Mapa de Espessura',
			'sidebar/material/side': 'Lado',
			'sidebar/material/size': 'Tamanho',
			'sidebar/material/sizeAttenuation': 'Atenuação de Tamanho',
			'sidebar/material/flatShading': 'Sombreamento Plano',
			'sidebar/material/blending': 'Mistura',
			'sidebar/material/opacity': 'Opacidade',
			'sidebar/material/transparent': 'Transparente',
			'sidebar/material/forcesinglepass': 'Forçar Passagem Única',
			'sidebar/material/alphatest': 'Teste Alpha',
			'sidebar/material/depthtest': 'Teste de Profundidade',
			'sidebar/material/depthwrite': 'Escrita de Profundidade',
			'sidebar/material/wireframe': 'Wireframe',
			'sidebar/material/userdata': 'Dados do Usuário',
			'sidebar/material/export': 'Exportar JSON',

			'sidebar/script/new': 'Novo',
			'sidebar/script/edit': 'Editar',
			'sidebar/script/remove': 'Remover',

			'sidebar/project': 'Projeto',
			'sidebar/project/camera': 'Câmera',
			'sidebar/project/renderer': 'Renderizador',
			'sidebar/project/antialias': 'Antialiasing',
			'sidebar/project/shadows': 'Sombras',
			'sidebar/project/toneMapping': 'Mapeamento de Tons',
			'sidebar/project/geometries': 'Geometrias',
			'sidebar/project/materials': 'Materiais',
			'sidebar/project/textures': 'Texturas',
			'sidebar/project/Assign': 'Atribuir',

			'sidebar/project/app': 'App',
			'sidebar/project/app/play': 'Reproduzir',
			'sidebar/project/app/stop': 'Parar',
			'sidebar/project/app/title': 'Título',
			'sidebar/project/app/editable': 'Editável',
			'sidebar/project/app/publish': 'Publicar',

			'sidebar/project/image': 'Imagem',
			'sidebar/project/image/samples': 'Amostras',
			'sidebar/project/video': 'Vídeo',

			'sidebar/project/shading': 'Sombreamento',
			'sidebar/project/resolution': 'Resolução',
			'sidebar/project/duration': 'Duração',
			'sidebar/project/render': 'Renderizar',

			'sidebar/settings': 'Configurações',
			'sidebar/settings/language': 'Idioma',

			'sidebar/settings/shortcuts': 'Atalhos',
			'sidebar/settings/shortcuts/translate': 'Transladar',
			'sidebar/settings/shortcuts/rotate': 'Rotacionar',
			'sidebar/settings/shortcuts/scale': 'Escalonar',
			'sidebar/settings/shortcuts/undo': 'Desfazer',
			'sidebar/settings/shortcuts/focus': 'Foco',
			'sidebar/settings/shortcuts/perspective': 'Perspectiva',
			'sidebar/settings/shortcuts/orthographic': 'Ortográfica',

			'sidebar/history': 'Histórico',
			'sidebar/history/clear': 'Limpar',
			'sidebar/history/persistent': 'Persistente',

			'toolbar/translate': 'Transladar',
			'toolbar/rotate': 'Rotacionar',
			'toolbar/scale': 'Escalonar',
			'toolbar/local': 'Local',

			'viewport/controls/grid': 'Grade',
			'viewport/controls/helpers': 'Auxiliares',

			'viewport/info/object': 'Objeto',
			'viewport/info/objects': 'Objetos',
			'viewport/info/vertex': 'Vértice',
			'viewport/info/vertices': 'Vértices',
			'viewport/info/triangle': 'Triângulo',
			'viewport/info/triangles': 'Triângulos',
			'viewport/info/sample': 'Amostra',
			'viewport/info/samples': 'Amostras',
			'viewport/info/rendertime': 'Tempo de renderização',

			'script/title/vertexShader': 'Shader de Vértice',
			'script/title/fragmentShader': 'Shader de Fragmento',
			'script/title/programInfo': 'Propriedades do Programa',

			'dialog/gltf/title': 'Importar glTF',
			'dialog/gltf/asScene': 'Importar glTF como cena raiz',
			'dialog/texture/title': 'Parâmetros da Textura',
			'dialog/texture/group/preview': 'Pré-visualização',
			'dialog/texture/group/mapping': 'Mapeamento',
			'dialog/texture/group/filtering': 'Filtragem',
			'dialog/texture/group/transform': 'Transformar',
			'dialog/texture/group/color': 'Cor',
			'dialog/texture/mapping': 'Mapeamento',
			'dialog/texture/wrapS': 'Wrap S',
			'dialog/texture/wrapT': 'Wrap T',
			'dialog/texture/magFilter': 'Filtro de Ampliação',
			'dialog/texture/minFilter': 'Filtro de Redução',
			'dialog/texture/anisotropy': 'Anisotropia',
			'dialog/texture/offset': 'Deslocamento',
			'dialog/texture/repeat': 'Repetição',
			'dialog/texture/center': 'Centro',
			'dialog/texture/rotation': 'Rotação',
			'dialog/texture/premultiplyAlpha': 'Pré-multiplicar Alfa',
			'dialog/texture/colorSpace': 'Espaço de Cor',
			'dialog/ok': 'OK',
