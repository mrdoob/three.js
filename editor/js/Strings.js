function Strings( config ) {
	...
	var values = {
		...
		en: {
			...
			'sidebar/textures/encoding/linear': 'LinearEncoding',
			'sidebar/textures/encoding/srgb': 'sRGBEncoding',
			'sidebar/textures/encoding/gamma': 'GammaEncoding',
			'sidebar/textures/encoding/rgbe': 'RGBEEncoding',
			'sidebar/textures/encoding/logluv': 'LogLuvEncoding',
			'sidebar/textures/encoding/rbgm7': 'RGBM7Encoding',
			'sidebar/textures/encoding/rgbm16': 'RGBM16Encoding',
			'sidebar/textures/encoding/rgbd': 'RGBDEncoding',
			'sidebar/textures/encoding/basicdepthpacking': 'BasicDepthPacking',
			'sidebar/textures/encoding/rgbapacking': 'RGBADepthPacking',

			'sidebar/textures/format/alpha': 'Alpha',
			'sidebar/textures/format/red': 'Red',
			'sidebar/textures/format/redinteger': 'RedInteger',
			'sidebar/textures/format/rg': 'RG',
			'sidebar/textures/format/rginteger': 'RGIneteger',
			'sidebar/textures/format/rgb': 'RGB',
			'sidebar/textures/format/rgbinteger': 'RGBIneteger',
			'sidebar/textures/format/rgba': 'RGBA',
			'sidebar/textures/format/rgbaineteger': 'RGBAInteger',
			'sidebar/textures/format/luminance': 'Luminance',
			'sidebar/textures/format/luminancealpha': 'LuminanceAlpha',
			'sidebar/textures/format/rgbe': 'RGBE',
			'sidebar/textures/format/depth': 'Depth',
			'sidebar/textures/format/depthstencil': 'DepthStencil',

			'sidebar/textures/mapping/uv': 'UV',
			'sidebar/textures/mapping/cubereflection': 'CubeReflection',
			'sidebar/textures/mapping/cuberefraction': 'CubeRefraction',
			'sidebar/textures/mapping/equirectangularreflection': 'EquirectangularReflection',
			'sidebar/textures/mapping/equirectangularrefraction': 'EquirectangularRefraction',
			'sidebar/textures/mapping/cubeuvreflection': 'CubeUVReflection',
			'sidebar/textures/mapping/cubeuvrefraction': 'CubeUVRefraction',

			'sidebar/textures/wrapping/repeat': 'Repeat',
			'sidebar/textures/wrapping/calmptoedge': 'ClampToEdge',
			'sidebar/textures/wrapping/mirroredrepeat': 'MirroredRepeat',

			'sidebar/textures/magfilter/nearest': 'Nearest',
			'sidebar/textures/magfilter/linear': 'Linear',

			'sidebar/textures/min/nearest': 'Nearest',
			'sidebar/textures/min/nearestmipmapnearest': 'NearestMipmapNearest',
			'sidebar/textures/min/nearestmipmapline': 'NearestMipmapLine',
			'sidebar/textures/min/linear': 'Linear',
			'sidebar/textures/min/linearmipmapnearest': 'LinearMipmapNearest',
			'sidebar/textures/min/linearmipmaplinear': 'LinearMipmapLinear',
