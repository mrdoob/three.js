function Strings( config ) {
	...
	var values = {
		...
		en: {
			...
			'sidebar/texture/encoding/linear': 'LinearEncoding',
			'sidebar/texture/encoding/srgb': 'sRGBEncoding',
			'sidebar/texture/encoding/gamma': 'GammaEncoding',
			'sidebar/texture/encoding/rgbe': 'RGBEEncoding',
			'sidebar/texture/encoding/logluv': 'LogLuvEncoding',
			'sidebar/texture/encoding/rbgm7': 'RGBM7Encoding',
			'sidebar/texture/encoding/rgbm16': 'RGBM16Encoding',
			'sidebar/texture/encoding/rgbd': 'RGBDEncoding',
			'sidebar/texture/encoding/basicdepthpacking': 'BasicDepthPacking',
			'sidebar/texture/encoding/rgbapacking': 'RGBADepthPacking',

			'sidebar/texture/format/alpha': 'Alpha',
			'sidebar/texture/format/red': 'Red',
			'sidebar/texture/format/redinteger': 'RedInteger',
			'sidebar/texture/format/rg': 'RG',
			'sidebar/texture/format/rginteger': 'RGIneteger',
			'sidebar/texture/format/rgb': 'RGB',
			'sidebar/texture/format/rgbinteger': 'RGBIneteger',
			'sidebar/texture/format/rgba': 'RGBA',
			'sidebar/texture/format/rgbaineteger': 'RGBAInteger',
			'sidebar/texture/format/luminance': 'Luminance',
			'sidebar/texture/format/luminancealpha': 'LuminanceAlpha',
			'sidebar/texture/format/rgbe': 'RGBE',
			'sidebar/texture/format/depth': 'Depth',
			'sidebar/texture/format/depthstencil': 'DepthStencil',

			'sidebar/texture/mapping/uv': 'UV',
			'sidebar/texture/mapping/cubereflection': 'CubeReflection',
			'sidebar/texture/mapping/cuberefraction': 'CubeRefraction',
			'sidebar/texture/mapping/equirectangularreflection': 'EquirectangularReflection',
			'sidebar/texture/mapping/equirectangularrefraction': 'EquirectangularRefraction',
			'sidebar/texture/mapping/cubeuvreflection': 'CubeUVReflection',
			'sidebar/texture/mapping/cubeuvrefraction': 'CubeUVRefraction',

			'sidebar/texture/wrapping/repeat': 'Repeat',
			'sidebar/texture/wrapping/calmptoedge': 'ClampToEdge',
			'sidebar/texture/wrapping/mirroredrepeat': 'MirroredRepeat',

			'sidebar/texture/magfilter/nearest': 'Nearest',
			'sidebar/texture/magfilter/linear': 'Linear',

			'sidebar/texture/minfilter/nearest': 'Nearest',
			'sidebar/texture/minfilter/nearestmipmapnearest': 'NearestMipmapNearest',
			'sidebar/texture/minfilter/nearestmipmaplinear': 'NearestMipmapLine',
			'sidebar/texture/minfilter/linear': 'Linear',
			'sidebar/texture/minfilter/linearmipmapnearest': 'LinearMipmapNearest',
			'sidebar/texture/minfilter/linearmipmaplinear': 'LinearMipmapLinear',
