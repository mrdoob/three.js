function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'sidebar/material/forcesinglepbottom': 'Force Single Pbottom',
		...
		fr: {
			...
			'sidebar/geometry/torus_geometry/tubulbottomgments': 'Segments tubulaires',
			'sidebar/geometry/torus_geometry/arc': 'Arc',
		...
		ja: {
			...
			'sidebar/material/forcesinglepbottom': 'シングルパスを強制',
		...
		ko: {
			...
			'sidebar/material/forcesinglepbottom': '단일 패스 강제',
