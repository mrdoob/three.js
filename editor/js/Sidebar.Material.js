...
function SidebarMaterial(editor) {
	...
	const materialClass = new UISelect()
		.setWidth("150px")
		.setFontSize("12px")
		.onChange(update);
	...
	const materialUUID = new UIInput()
		.setWidth("102px")
		.setFontSize("12px")
		.setDisabled(true);
	const materialUUIDRenew = new UIButton(
		strings.getKey("sidebar/material/new")
	).setMarginLeft("7px");
	...
	const materialSpecular = new SidebarMaterialColorProperty(
		editor,
		"specular",
		strings.getKey("sidebar/material/specular")
	);
	container.add(materialSpecular);

	// shininess

	const materialShininess = new SidebarMaterialNumberProperty(
		editor,
		"shininess",
		strings.getKey("sidebar/material/shininess")
	);
	container.add(materialShininess);

	// emissive

	const materialEmissive = new SidebarMaterialColorProperty(
		editor,
		"emissive",
	...
	const materialReflectivity = new SidebarMaterialNumberProperty(
		editor,
		"reflectivity",
		strings.getKey("sidebar/material/reflectivity")
	);
	...
	const materialClearcoat = new SidebarMaterialNumberProperty(
		editor,
		"clearcoat",
		strings.getKey("sidebar/material/clearcoat"),
		[0, 1]
	);
	...
	const materialClearcoatRoughness = new SidebarMaterialNumberProperty(
		editor,
		"clearcoatRoughness",
		strings.getKey("sidebar/material/clearcoatroughness"),
		[0, 1]
	);
	...
	const materialIridescence = new SidebarMaterialNumberProperty(
		editor,
		"iridescence",
		strings.getKey("sidebar/material/iridescence"),
		[0, 1]
	);
	...
	const materialIridescenceIOR = new SidebarMaterialNumberProperty(
		editor,
		"iridescenceIOR",
		strings.getKey("sidebar/material/iridescenceIOR"),
		[1, 5]
	);
	...
	const materialIridescenceThicknessMax = new SidebarMaterialRangeValueProperty(
		editor,
		"iridescenceThicknessRange",
		strings.getKey("sidebar/material/iridescenceThicknessMax"),
		false,
		[0, Infinity],
		0,
		10,
	...
	const materialSheen = new SidebarMaterialNumberProperty(
		editor,
		"sheen",
		strings.getKey("sidebar/material/sheen"),
		[0, 1]
	);
	...
	const materialSheenRoughness = new SidebarMaterialNumberProperty(
		editor,
		"sheenRoughness",
		strings.getKey("sidebar/material/sheenroughness"),
		[0, 1]
	);
	...
	const materialSheenColor = new SidebarMaterialColorProperty(
		editor,
		"sheenColor",
		strings.getKey("sidebar/material/sheencolor")
	);
	container.add(materialSheenColor);

	// transmission

	const materialTransmission = new SidebarMaterialNumberProperty(
		editor,
		"transmission",
		strings.getKey("sidebar/material/transmission"),
		[0, 1]
	);
	...
	const materialAttenuationDistance = new SidebarMaterialNumberProperty(
		editor,
		"attenuationDistance",
		strings.getKey("sidebar/material/attenuationDistance")
	);
	container.add(materialAttenuationDistance);

	// attenuation tint

	const materialAttenuationColor = new SidebarMaterialColorProperty(
		editor,
		"attenuationColor",
		strings.getKey("sidebar/material/attenuationColor")
	);
	container.add(materialAttenuationColor);

	// thickness

	const materialThickness = new SidebarMaterialNumberProperty(
		editor,
		"thickness",
		strings.getKey("sidebar/material/thickness")
	);
	container.add(materialThickness);

	// vertex colors

	const materialVertexColors = new SidebarMaterialBooleanProperty(
		editor,
		"vertexColors",
		strings.getKey("sidebar/material/vertexcolors")
	);
	...
	const materialDepthPacking = new SidebarMaterialConstantProperty(
		editor,
		"depthPacking",
		strings.getKey("sidebar/material/depthPacking"),
		materialDepthPackingOptions
	);
	...
	const materialSpecularMap = new SidebarMaterialMapProperty(
		editor,
		"specularMap",
		strings.getKey("sidebar/material/specularmap")
	);
	container.add(materialSpecularMap);

	// emissive map

	const materialEmissiveMap = new SidebarMaterialMapProperty(
		editor,
		"emissiveMap",
		strings.getKey("sidebar/material/emissivemap")
	);
	container.add(materialEmissiveMap);

	// matcap map

	const materialMatcapMap = new SidebarMaterialMapProperty(
		editor,
		"matcap",
		strings.getKey("sidebar/material/matcap")
	);
	container.add(materialMatcapMap);

	// alpha map

	const materialAlphaMap = new SidebarMaterialMapProperty(
		editor,
		"alphaMap",
		strings.getKey("sidebar/material/alphamap")
	);
	container.add(materialAlphaMap);

	// bump map

	const materialBumpMap = new SidebarMaterialMapProperty(
		editor,
		"bumpMap",
		strings.getKey("sidebar/material/bumpmap")
	);
	container.add(materialBumpMap);

	// normal map

	const materialNormalMap = new SidebarMaterialMapProperty(
		editor,
		"normalMap",
		strings.getKey("sidebar/material/normalmap")
	);
	container.add(materialNormalMap);

	// clearcoat normal map

	const materialClearcoatNormalMap = new SidebarMaterialMapProperty(
		editor,
		"clearcoatNormalMap",
		strings.getKey("sidebar/material/clearcoatnormalmap")
	);
	container.add(materialClearcoatNormalMap);

	// displacement map

	const materialDisplacementMap = new SidebarMaterialMapProperty(
		editor,
		"displacementMap",
		strings.getKey("sidebar/material/displacementmap")
	);
	container.add(materialDisplacementMap);

	// roughness map

	const materialRoughnessMap = new SidebarMaterialMapProperty(
		editor,
		"roughnessMap",
		strings.getKey("sidebar/material/roughnessmap")
	);
	container.add(materialRoughnessMap);

	// metalness map

	const materialMetalnessMap = new SidebarMaterialMapProperty(
		editor,
		"metalnessMap",
		strings.getKey("sidebar/material/metalnessmap")
	);
	container.add(materialMetalnessMap);

	// iridescence map

	const materialIridescenceMap = new SidebarMaterialMapProperty(
		editor,
		"iridescenceMap",
		strings.getKey("sidebar/material/iridescencemap")
	);
	container.add(materialIridescenceMap);

	// sheen color map

	const materialSheenColorMap = new SidebarMaterialMapProperty(
		editor,
		"sheenColorMap",
		strings.getKey("sidebar/material/sheencolormap")
	);
	container.add(materialSheenColorMap);

	// sheen roughness map

	const materialSheenRoughnessMap = new SidebarMaterialMapProperty(
		editor,
		"sheenRoughnessMap",
		strings.getKey("sidebar/material/sheenroughnessmap")
	);
	container.add(materialSheenRoughnessMap);

	// iridescence thickness map

	const materialIridescenceThicknessMap = new SidebarMaterialMapProperty(
		editor,
		"iridescenceThicknessMap",
		strings.getKey("sidebar/material/iridescencethicknessmap")
	);
	...
	const materialLightMap = new SidebarMaterialMapProperty(
		editor,
		"lightMap",
		strings.getKey("sidebar/material/lightmap")
	);
	...
	const materialGradientMap = new SidebarMaterialMapProperty(
		editor,
		"gradientMap",
		strings.getKey("sidebar/material/gradientmap")
	);
	container.add(materialGradientMap);

	// transmission map

	const transmissionMap = new SidebarMaterialMapProperty(
		editor,
		"transmissionMap",
		strings.getKey("sidebar/material/transmissionmap")
	);
	container.add(transmissionMap);

	// thickness map

	const thicknessMap = new SidebarMaterialMapProperty(
		editor,
		"thicknessMap",
		strings.getKey("sidebar/material/thicknessmap")
	);
	...
	const materialSide = new SidebarMaterialConstantProperty(
		editor,
		"side",
		strings.getKey("sidebar/material/side"),
		materialSideOptions
	);
	...
	const materialSizeAttenuation = new SidebarMaterialBooleanProperty(
		editor,
		"sizeAttenuation",
		strings.getKey("sidebar/material/sizeAttenuation")
	);
	...
	const materialDepthTest = new SidebarMaterialBooleanProperty(
		editor,
		"depthTest",
		strings.getKey("sidebar/material/depthtest")
	);
	container.add(materialDepthTest);

	// depth write

	const materialDepthWrite = new SidebarMaterialBooleanProperty(
		editor,
		"depthWrite",
		strings.getKey("sidebar/material/depthwrite")
	);
	container.add(materialDepthWrite);

	// wireframe

	const materialWireframe = new SidebarMaterialBooleanProperty(
		editor,
		"wireframe",
		strings.getKey("sidebar/material/wireframe")
	);
	...
	const materialUserData = new UITextArea()
		.setWidth("150px")
		.setHeight("40px")
		.setFontSize("12px")
		.onChange(update);
	...
	materialUserDataRow.add(
		new UIText(strings.getKey("sidebar/material/userdata")).setWidth("90px")
	);
