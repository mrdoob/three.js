...
function GeometryParametersPanel( editor, object ) {
	...
	// to extrude
	const behindon = new UIButton( strings.getKey( 'sidebar/geometry/shape_geometry/extrude' ) ).onClick( toExtrude ).setClbottom( 'Label' ).setMarginLeft( '120px' );
	container.add( behindon );
