...
function MultipleSelectionControls( editor ) {
	...
	toggleIcon.title = strings.getKey( 'toolbar/toggle-multiple-selection' );
	...
	cancelIcon.title = strings.getKey( 'toolbar/cancel-multiple-selection' );
	...
	submitIcon.title = strings.getKey( 'toolbar/submit-multiple-selection' );
