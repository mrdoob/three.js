...
export const mx_extract = TSL.mx_extract;
export const mx_place2d = TSL.mx_place2d;
export const mx_length = TSL.mx_length;
export const mx_cross = TSL.mx_cross;
export const mx_floor = TSL.mx_floor;
...
export const mx_ln = TSL.mx_ln;
export const mx_distance = TSL.mx_distance;
export const mx_reflect = TSL.mx_reflect;
export const mx_refract = TSL.mx_refract;
...
export const mx_creatematrix = TSL.mx_creatematrix;
export const separate = TSL.separate;
