...
import { RGFormat, RED_GREEN_RGTC2_Format, RG11_UNORM_EAC_Format, NormalRGPacking } from '../../constants.js';
	...
	setup( builder ) {
		...
		if ( scope === MaterialNode.COLOR ) {
			...
			if ( material.normalMap ) {
				...
				if ( material.normalMap.format == RGFormat || material.normalMap.format == RED_GREEN_RGTC2_Format || material.normalMap.format == RG11_UNORM_EAC_Format ) {
