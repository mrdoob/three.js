import { Fn, If, array, float, int, mat3, vec2, vec3 } from '../../tsl/TSLBase.js';
import { max, mix } from '../../math/MathNode.js';
...
export { LTC_Evaluate, LTC_Evaluate_Volume, LTC_Uv, LTC_DecodeMatrix, LTC_AmplitudeUv, LTC_DecodeAmplitude, LTC_PhysicalMass, LTC_EvaluateSpecular };
