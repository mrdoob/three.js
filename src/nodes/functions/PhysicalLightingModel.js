...
import { diffuseColor, diffuseContribution, diffuseContributionOverPi, specularColor, specularColorBlended, specularF90, roughness, metalness, clearcoat, clearcoatRoughness, sheen, sheenRoughness, iridescence, iridescenceIOR, iridescenceThickness, ior, thickness, transmission, attenuationDistance, attenuationColor, dispersion } from '../core/PropertyNode.js';
...
class PhysicalLightingModel extends LightingModel {
	...
	direct( { lightDirection, lightColor, reflectedLight }, /* builder */ ) {
		...
		reflectedLight.directDiffuse.addAssign( irradiance.mul( diffuseContributionOverPi ) );
	...
	indirectDiffuse( builder ) {
		...
		const diffuse = irradiance.mul( diffuseContributionOverPi ).toVar();
