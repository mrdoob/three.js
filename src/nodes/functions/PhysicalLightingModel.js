...
class PhysicalLightingModel extends LightingModel {
	...
	direct( { lightDirection, lightColor, reflectedLight } ) {
		...
		if ( this.clearcoat === true ) {
			...
			this.clearcoatSpecularDirect.addAssign( ccIrradiance.mul( BRDF_GGX( { lightDirection, f0: clearcoatF0, f90: clearcoatF90, roughness: clearcoatRoughness, normal: clearcoatNormalView } ) ) );
