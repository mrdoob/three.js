...
class NodeBuilder {
	...
	_getBindGroup(groupName, bindings) {
		...
		for (const binding of bindings) {
			...
			sharedGroup = sharedGroup && (binding.groupNode ? binding.groupNode.shared !== true : false);
	...
	sortBindingGroups() {
		...
		bindingsGroups.sort((a, b) => {

			const orderA = a.bindings[0].groupNode ? a.bindings[0].groupNode.order : 0;
			const orderB = b.bindings[0].groupNode ? b.bindings[0].groupNode.order : 0;
