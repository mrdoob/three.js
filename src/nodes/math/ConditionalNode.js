 ...
 *
 * The `ternary()` method is called in a chaining fashion on a condition. The parameter nodes of `ternary()`
 ...
 */
export const ternary = /*@__PURE__*/ nodeProxy( ConditionalNode ).setParameterLength( 2, 3 );

/**
 * TSL function for creating a conditional node. Renamed to {@link ternary}.
 *
 * @deprecated since r186. Use {@link ternary} instead.
 * @tsl
 * @function
 * @param {Node} condNode - The node that defines the condition.
 * @param {Node} ifNode - The node that is evaluate when the condition ends up `true`.
...
export const select = ( ...params ) => {
	...
	warnOnce( 'TSL: "select()" has been renamed to "ternary()".' ); // @deprecated r186

	return ternary( ...params );

};

addMethodChaining( 'ternary', ternary );
