...
import { createElementNS, probeAsync } from '../utils.js';
...
function WebGLRenderer( parameters = {} ) {
	...
	this.createReadbackBuffer = function ( byteLength ) {
		...
		_gl.bufferData( _gl.PIXEL_PACK_BUFFER, byteLength, gl.STREAM_READ );
				...
				try {
					...
					if ( ( x >= 0 && x <= ( renderTarget.width - width ) ) && ( y >= 0 && y <= ( renderTarget.height - height ) ) ) {
						...
						if ( ! asyncOptions.glBuffer )
							_gl.bufferData( _gl.PIXEL_PACK_BUFFER, buffer.byteLength, gl.STREAM_READ );
