	...
	function uploadTexture( textureProperties, texture, slot ) {
		...
		if ( texture.isDepthTexture ) {
			...
			if ( texture.format === DepthStencilFormat ) {
				...
				glInternalFormat = isWebGL2 ? _gl.DEPTH24_STENCIL8 : _gl.DEPTH_STENCIL;
		...
		if ( isCube ) {
			...
			if ( isMultisample ) {
				...
				for ( var i = 0; i < numViews; ++ i ) {
					...
					_gl.framebufferTextureLayer( _gl.FRAMEBUFFER, _gl.DEPTH_STENCIL_ATTACHMENT, depthStencilTexture, 0, i );
