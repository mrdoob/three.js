...
function WebGLProgram( renderer, code, parameters ) {
	...
	if ( parameters.isRawShaderMaterial ) {
		...
		prefixFragment = [
			...
			parameters.envMap && ( parameters.isWebGL2 || parameters.rendererExtensionShaderTextureLod ) ? '#define TEXTURE_LOD_EXT' : '',
