...
class ObjectLoader extends Loader {
	...
	parseAsync( json ) {
		...
		return new Promise( ( resolve ) => this.parse( json, resolve ) );
	...
	parseImages( json, onLoad ) {
		...
		if ( json !== undefined && json.length > 0 ) {
			...
			const manager = new LoadingManager( () => onLoad( images ) );
	...
	parseImagesAsync( json ) {
		...
		return new Promise( ( resolve ) => this.parseImages( json, resolve ) );
