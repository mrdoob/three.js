...
MorphBlendMesh.prototype.update = function ( delta ) {
	...
	for ( i = 0, il = this.animationsList.length; i < il; i ++ ) {
		...
		keyframe = animation.startFrame + _Math.clamp( Math.floor( animation.time / frameTime ), 0, animation.length - 1 );
