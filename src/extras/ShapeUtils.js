...
ShapeUtils.triangulateShape = function ( contour, holes ) {
	...
	/* To maintain reference to old shape,
	 * one must match coordinates, or offset
	 * the indices from original arrays. 
	...
	for ( i = 0, il = allpoints.length; i < il; i ++ ) {
		...
		if ( allPointsMap[ key ] !== undefined ) {
			...
			console.warn( "Shape: Duplicate point", key );
	...
	var triangles = FontUtils.Triangulate( shapeWithoutHoles, false ); // True returns indices for points of spooled shape
...
ShapeUtils.b2p1 = function ( t, p ) {

	return 2 * ( 1 - t ) * t * p;

};

ShapeUtils.b2p2 = function ( t, p ) {
