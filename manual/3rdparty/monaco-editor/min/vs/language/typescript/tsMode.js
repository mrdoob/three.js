	...
	function (e, t) {
		...
		function i(e, t, n) {
			...
			if (((r += e.messageText), n++, e.next))
				for (var a = 0, s = e.next; a < s.length; a++) {
					r += i(s[a], t, n);
				}
			return r;
		}
		...
		!(function (e) {
			...
			(t.flattenDiagnosticMessageText = i);
		var s,
			u = (function () {
				function e(e) {
					this._worker = e;
		...
		var c = (function (e) {
			function t(t, n, r) {
				...
				return (
					o._disposables.push(o._defaults.onDidChange(s)),
					o._disposables.push(o._defaults.onDidExtraLibsChange(s)),
			...
			return (
										...
										: ((u = s
												...
												.filter(function (e) {
													return (
														-1 ===
														(
															c._defaults.getDiagnosticsOptions()
																.diagnosticCodesToIgnore || []
														).indexOf(e.code)
													);
												})
												.map(function (t) {
													return c._convertDiagnostics(e, t);
												})),
										  monaco.editor.setModelMarkers(e, this._selector, u),
										  [2]);
							}
						});
					});
				...
				(t.prototype._convertDiagnostics = function (e, t) {
					...
					return {
						...
						endLineNumber: c,
						endColumn: l,
						message: i(t.messageText, "\n"),
						code: t.code.toString(),
						tags: t.reportsUnnecessary ? [monaco.MarkerTag.Unnecessary] : [],
					...
					if (t) {
						...
						return (
							t.forEach(function (t) {
								var r = e;
								if (t.file) {
									var o = monaco.Uri.parse(t.file.fileName);
									r = monaco.editor.getModel(o);
								}
								if (r) {
									var a = t.start || 0,
										s = t.length || 1,
		...
		var l = (function (e) {
			...
			return (
						...
						return __generator(this, function (c) {
							switch (c.label) {
								...
								case 1:
									return [
										4,
										c.sent().getCompletionsAtPosition(a.toString(), s),
									];
								case 2:
												...
												2,
												{
													suggestions: u.entries.map(function (r) {
														...
														if (r.replacementSpan) {
															var u = e.getPositionAt(r.replacementSpan.start),
																c = e.getPositionAt(
				...
				(t.prototype.resolveCompletionItem = function (e, n, r, o) {
					return __awaiter(this, void 0, void 0, function () {
						var n, o, i, s, u;
						return __generator(this, function (c) {
							switch (c.label) {
								...
								case 1:
									return [
										...
										c
											.sent()
											.getCompletionEntryDetails(o.toString(), s, n.label),
									];
								case 2:
									return !(u = c.sent()) || e.isDisposed()
										? [2, n]
										: [
												2,
												{
													...
													position: i,
													label: u.name,
													kind: t.convertKind(u.kind),
													detail: a(u.displayParts),
													documentation: { value: a(u.documentation) },
												},
										  ];
							}
						});
				...
				(t.convertKind = function (e) {
					switch (e) {
						...
						case _.memberVariable:
						case _.memberGetAccessor:
						case _.memberSetAccessor:
							return monaco.languages.CompletionItemKind.Field;
						case _.function:
						case _.memberFunction:
						case _.constructSignature:
						case _.callSignature:
						case _.indexSignature:
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (s) {
							switch (s.label) {
								...
								case 1:
									return [4, s.sent().getSignatureHelpItems(n.toString(), r)];
								case 2:
									return !(o = s.sent()) || e.isDisposed()
										? [2]
										: ((i = {
										  ...
										  o.items.forEach(function (e) {
												...
												(t.documentation = a(e.documentation)),
													(t.label += a(e.prefixDisplayParts)),
													e.parameters.forEach(function (n, r, o) {
														var i = a(n.displayParts),
															s = {
																label: i,
																documentation: a(n.documentation),
															};
														(t.label += i),
															t.parameters.push(s),
															r < o.length - 1 &&
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (c) {
							switch (c.label) {
								...
								case 1:
									return [4, c.sent().getQuickInfoAtPosition(n.toString(), r)];
								case 2:
									return !(o = c.sent()) || e.isDisposed()
										? [2]
										: ((i = a(o.documentation)),
										  (s = o.tags
												? o.tags
								...
								case 2:
									return !(o = a.sent()) || e.isDisposed()
										...
										: [
												...
												o.map(function (t) {
													return {
														range: i._textSpanToRange(e, t.textSpan),
		...
		var f = (function (e) {
			...
			return (
				...
				(t.prototype.provideDefinition = function (e, t, n) {
					return __awaiter(this, void 0, void 0, function () {
						var n, o, i, a, s, u, c, l, p;
						return __generator(this, function (g) {
							switch (g.label) {
								case 0:
									return (
										(n = e.uri), (o = e.getOffsetAt(t)), [4, this._worker(n)]
									);
								case 1:
									return [4, g.sent().getDefinitionAtPosition(n.toString(), o)];
								case 2:
									if (!(i = g.sent()) || e.isDisposed()) return [2];
									for (a = [], s = 0, u = i; s < u.length; s++)
										(c = u[s]),
											(l = r.parse(c.fileName)),
											(p = monaco.editor.getModel(l)) &&
												a.push({
													uri: l,
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (g) {
							switch (g.label) {
								...
								case 1:
									return [4, g.sent().getReferencesAtPosition(n.toString(), o)];
								case 2:
									if (!(i = g.sent()) || e.isDisposed()) return [2];
									for (a = [], s = 0, u = i; s < u.length; s++)
										(c = u[s]),
									...
									return !(n = a.sent()) || e.isDisposed()
										...
										: ((r = function (t, n, o) {
												var a = {
													...
													detail: "",
													kind:
														v[n.kind] || monaco.languages.SymbolKind.Variable,
													range: i._textSpanToRange(e, n.spans[0]),
													selectionRange: i._textSpanToRange(e, n.spans[0]),
													tags: [],
													containerName: o,
												};
												if (n.childItems && n.childItems.length > 0)
													for (var s = 0, u = n.childItems; s < u.length; s++) {
														var c = u[s];
														r(t, c, a.name);
													}
												t.push(a);
		...
		(v[_.module] = monaco.languages.SymbolKind.Module),
			(v[_.class] = monaco.languages.SymbolKind.Class),
			(v[_.enum] = monaco.languages.SymbolKind.Enum),
			(v[_.interface] = monaco.languages.SymbolKind.Interface),
			(v[_.memberFunction] = monaco.languages.SymbolKind.Method),
			(v[_.memberVariable] = monaco.languages.SymbolKind.Property),
			(v[_.memberGetAccessor] = monaco.languages.SymbolKind.Property),
			(v[_.memberSetAccessor] = monaco.languages.SymbolKind.Property),
			(v[_.variable] = monaco.languages.SymbolKind.Variable),
			(v[_.const] = monaco.languages.SymbolKind.Variable),
			(v[_.localVariable] = monaco.languages.SymbolKind.Variable),
			(v[_.variable] = monaco.languages.SymbolKind.Variable),
			(v[_.function] = monaco.languages.SymbolKind.Function),
			(v[_.localFunction] = monaco.languages.SymbolKind.Function);
		var b = (function (e) {
			function t() {
				return (null !== e && e.apply(this, arguments)) || this;
			}
								...
								case 2:
									return !(a = u.sent()) || e.isDisposed()
										...
										: [
												2,
												a.map(function (t) {
													return s._convertTextChanges(e, t);
												}),
										  ];
							}
						});
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (u) {
							switch (u.label) {
								case 0:
									return (
										(o = e.uri), (i = e.getOffsetAt(t)), [4, this._worker(o)]
									);
								case 1:
									return [
										4,
		...
		var w = (function (e) {
			...
			return (
							...
							switch (l.label) {
								case 0:
									return (
										...
										(a = b._convertOptions(e.getOptions())),
										(s = n.markers
											.filter(function (e) {
												return e.code;
											})
								...
								case 1:
									return [
										4,
										l.sent().getCodeFixesAtPosition(r.toString(), o, i, s, a),
									];
								case 2:
				...
				(t.prototype._tsCodeFixActionToMonacoCodeAction = function (e, t, n) {
					for (var r = [], o = 0, i = n.changes; o < i.length; o++)
						for (var a = 0, s = i[o].textChanges; a < s.length; a++) {
							var u = s[a];
							r.push({
								resource: e.uri,
								edit: {
						...
						return __generator(this, function (d) {
							switch (d.label) {
								...
								case 1:
									return [
										4,
										(a = d.sent()).getRenameInfo(o, i, {
											allowRenameOfImportPath: !1,
										}),
									];
								case 2:
									if (!1 === (s = d.sent()).canRename)
										return [
											2,
											{ edits: [], rejectReason: s.localizedErrorMessage },
										];
									if (void 0 !== s.fileToRename)
										throw new Error("Renaming files is not supported.");
									return [4, a.findRenameLocations(o, i, !1, !1, !1)];
								case 3:
									if (!(u = d.sent()) || e.isDisposed()) return [2];
									for (c = [], l = 0, p = u; l < p.length; l++)
										(g = p[l]),
											c.push({
												resource: monaco.Uri.parse(g.fileName),
												edit: {
			...
			function a(e, t) {
				...
				return (
					monaco.languages.registerCompletionItemProvider(
						t,
						new r.SuggestAdapter(i)
					),
					monaco.languages.registerSignatureHelpProvider(
						t,
						new r.SignatureHelpAdapter(i)
					),
					monaco.languages.registerHoverProvider(t, new r.QuickInfoAdapter(i)),
					monaco.languages.registerDocumentHighlightProvider(
						t,
						new r.OccurrencesAdapter(i)
					),
					monaco.languages.registerDefinitionProvider(
						t,
						new r.DefinitionAdapter(i)
					),
					monaco.languages.registerReferenceProvider(
						t,
						new r.ReferenceAdapter(i)
					),
					monaco.languages.registerDocumentSymbolProvider(
						t,
						new r.OutlineAdapter(i)
					),
					monaco.languages.registerDocumentRangeFormattingEditProvider(
						t,
						new r.FormatAdapter(i)
					),
					monaco.languages.registerOnTypeFormattingEditProvider(
						t,
						new r.FormatOnTypeAdapter(i)
					),
					monaco.languages.registerCodeActionProvider(
						t,
						new r.CodeActionAdaptor(i)
					),
					monaco.languages.registerRenameProvider(t, new r.RenameAdapter(i)),
					new r.DiagnosticsAdapter(e, t, i),
					i
				);
			}
			Object.defineProperty(t, "__esModule", { value: !0 }),
