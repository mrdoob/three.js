		...
		return (
			...
			(e.prototype.scanUnquotedString = function () {
				...
				return this._unquotedString(t)
					? this.finishToken(e, n.UnquotedString, t.join(""))
					: null;
			}),
			(e.prototype.scan = function () {
				...
				return this.stream.eos()
					? this.finishToken(t, n.EOF)
					: this.scanNext(t);
			}),
			(e.prototype.scanNext = function (e) {
				if (this.stream.advanceIfChars([S, q, g, g]))
					return this.finishToken(e, n.CDO);
				if (this.stream.advanceIfChars([g, g, k]))
					return this.finishToken(e, n.CDC);
				var t = [];
				...
				if (this.stream.advanceIfChar(T))
					return (
						(t = ["#"]),
						this._name(t)
							? this.finishToken(e, n.Hash, t.join(""))
							: this.finishToken(e, n.Delim)
					);
				if (this.stream.advanceIfChar(q))
					return this.finishToken(e, n.Exclamation);
				if (this._number()) {
					var i = this.stream.pos();
					if (
						((t = [this.stream.substring(e, i)]), this.stream.advanceIfChar(y))
					)
				...
				return null !== a
					...
					: void 0 !== (a = B[this.stream.peekChar()])
					? (this.stream.advance(1), this.finishToken(e, a))
					: this.stream.peekChar(0) === h && this.stream.peekChar(1) === u
					...
					: this.stream.peekChar(0) === v && this.stream.peekChar(1) === u
			...
			(e.prototype.comment = function () {
				if (this.stream.advanceIfChars([E, v])) {
					var e = !1,
						t = !1;
					return (
						this.stream.advanceWhileChar(function (n) {
							return t && n === E ? ((e = !0), !1) : ((t = n === v), !0);
						}),
			...
			(e.prototype._number = function () {
				var e,
					t = 0;
				return (
					this.stream.peekChar() === K && (t = 1),
					(e = this.stream.peekChar(t)) >= d &&
						e <= p &&
						(this.stream.advance(t + 1),
						this.stream.advanceWhileChar(function (e) {
							return (e >= d && e <= p) || (0 === t && e === K);
						}),
						!0)
				);
			}),
				...
				switch (t) {
					...
					case z:
						return (
							...
							t === R && this.stream.advanceIfChar(z) && e.push("\n"),
							!0
						);
				}
				return !1;
			...
			(e.prototype._escape = function (e, t) {
				...
				if (n === D) {
					...
					if (r > 0) {
						...
						return (
							n === N || n === M ? this.stream.advance(1) : this._newline([]),
							!0
						);
					}
					if (n !== R && n !== _ && n !== z)
			...
			(e.prototype._string = function (e) {
				if (this.stream.peekChar() === P || this.stream.peekChar() === I) {
...
!(function (e) {
	...
	Object.defineProperty(t, "__esModule", { value: !0 }),
		(function (e) {
			(e[(e.Undefined = 0)] = "Undefined"),
				...
				(e[(e.SelectorCombinatorAllSiblings = 10)] =
					"SelectorCombinatorAllSiblings"),
				(e[(e.SelectorCombinatorShadowPiercingDescendant = 11)] =
				...
				(e[(e.UnknownAtRule = 72)] = "UnknownAtRule"),
				(e[(e.Use = 73)] = "Use"),
				(e[(e.ModuleConfiguration = 74)] = "ModuleConfiguration"),
				(e[(e.Forward = 75)] = "Forward"),
				(e[(e.ForwardVisibility = 76)] = "ForwardVisibility"),
				(e[(e.Module = 77)] = "Module");
		...
		(function (e) {
			(e[(e.Mixin = 0)] = "Mixin"),
				...
				(e[(e.Module = 6)] = "Module"),
				(e[(e.Forward = 7)] = "Forward"),
				(e[(e.ForwardVisibility = 8)] = "ForwardVisibility");
		})(t.ReferenceType || (t.ReferenceType = {})),
		(t.getNodeAtOffset = r),
		(t.getNodePath = function (e, t) {
			for (var n = r(e, t), i = []; n; ) i.unshift(n), (n = n.parent);
			return i;
		}),
	...
	var i = (function () {
		...
		return (
			...
			(e.prototype.getParent = function () {
				for (var e = this.parent; e instanceof o; ) e = e.parent;
				return e;
			}),
	...
	var d = (function (e) {
		...
		return (
			...
			(t.prototype.getSelectors = function () {
				return this.selectors || (this.selectors = new o(this)), this.selectors;
			}),
	...
	var b = (function (e) {
		...
		return (
			...
			(t.prototype.getFullPropertyName = function () {
				...
				if (this.parent instanceof l && this.parent.getParent() instanceof _) {
	...
	var v = (function (e) {
		...
		return (
			...
			(t.prototype.getArguments = function () {
				return this.arguments || (this.arguments = new o(this)), this.arguments;
			}),
			t
		);
	})(i);
	...
	var T = (function (e) {
		...
		return (
			...
			(t.prototype.getVariables = function () {
				return this.variables || (this.variables = new o(this)), this.variables;
			}),
			t
		);
	})(c);
	...
	var E = (function (e) {
		...
		return (
			...
			(t.prototype.getParameters = function () {
				return (
					this.parameters || (this.parameters = new o(this)), this.parameters
				);
			}),
			t
		);
	})(c);
	t.FunctionDeclaration = E;
	var z = (function (e) {
		function t(t, n) {
			return e.call(this, t, n) || this;
		}
	...
	var K = (function (e) {
		...
		return (
			...
			(t.prototype.getMediums = function () {
				return this.mediums || (this.mediums = new o(this)), this.mediums;
			}),
			t
		);
	})(i);
	...
	var ee = ".".charCodeAt(0),
		...
		re = (function (e) {
			...
			return (
				...
				(t.prototype.getValue = function () {
					for (
						var e, t = this.getText(), n = 0, r = 0, i = t.length;
						r < i && ((e = t.charCodeAt(r)), (te <= e && e <= ne) || e === ee);
						r++
					)
						n += 1;
					return {
	...
	var le = (function (e) {
		...
		return (
			...
			(t.prototype.getNamespaces = function () {
				return (
					this.namespaces || (this.namespaces = new o(this)), this.namespaces
				);
			}),
			(t.prototype.setIdentifier = function (e) {
				return this.setNode("identifier", e, 0);
	...
	(function (e) {
		...
		(t.CSSIssueType = r),
			(t.ParseError = {
				...
				IdentifierOrWildcardExpected: new r(
					"css-idorwildcardexpected",
					n("expected.idorwildcard", "identifier or wildcard expected")
				),
				WildcardExpected: new r(
					"css-wildcardexpected",
					n("expected.wildcard", "wildcard expected")
				),
				IdentifierOrVariableExpected: new r(
					"css-idorvarexpected",
					n("expected.idorvar", "identifier or variable expected")
				),
			});
	}),
	(function (e) {
		if ("object" == typeof module && "object" == typeof module.exports) {
			...
			"function" == typeof define &&
				define.amd &&
				define(
					"vscode-css-languageservice/data/webCustomData",
					["require", "exports"],
					e
				);
	})(function (e, t) {
						...
						this.dataProviders.forEach(function (t) {
							t.provideProperties().forEach(function (t) {
								...
								t.providePseudoElements().forEach(function (t) {
									e._pseudoElementSet[t.name] ||
										(e._pseudoElementSet[t.name] = t);
								});
						}),
	...
	(function (e) {
		...
		function r(e) {
			...
			var t = "";
			e.status && (t += n(e.status)), (t += e.description);
			var r = o(e.browsers);
			return (
				r && (t += "\n(" + r + ")"),
				"syntax" in e && (t += "\n\nSyntax: " + e.syntax),
		...
		function i(e) {
			if (!e.description || "" === e.description) return "";
			var t = "";
			e.status && (t += n(e.status)),
				"string" == typeof e.description
					? (t += e.description)
					: (t = e.description.value);
			var r = o(e.browsers);
			return (
				r && (t += "\n\n(" + r + ")"),
				"syntax" in e && (t += "\n\nSyntax: " + e.syntax),
					...
					: e
							.map(function (e) {
								var n = "",
									...
									o = r[2];
								return (
									i in t.browserNames && (n += t.browserNames[i]),
									o && (n += " " + o),
									n
								);
							})
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			...
			(t.getEntryDescription = function (e, t) {
				return t
					? { kind: "markdown", value: i(e) }
					: { kind: "plaintext", value: r(e) };
			}),
			(t.getBrowserLabel = o);
	}),
	(function (e) {
		...
		(t.colorFunctions = [
			...
			(t.isColorConstructor = o),
			(t.isColorValue = function (e) {
			...
			(t.getColorValue = function (e) {
				...
				if (e.type === n.NodeType.Function) {
					...
					if (d && d.parent && d.parent.type === n.NodeType.BinaryExpression) {
						...
						if (
							p.parent &&
							p.parent.type === n.NodeType.ListEntry &&
							p.parent.key === p
						)
							return null;
					}
	...
	(function (e) {
		...
		n(e("./entry")),
			...
			n(e("./dataProvider")),
			n(e("./dataManager")),
			(t.cssDataManager = new i.CSSDataManager([
				new o.CSSDataProvider(r.cssData),
			]));
	});
var __spreadArrays =
		...
		a = (function () {
			...
			return (
				(e.prototype.peekIdent = function (e) {
					return (
						n.TokenType.Ident === this.token.type &&
				...
				(e.prototype.peekKeyword = function (e) {
					return (
						n.TokenType.AtKeyword === this.token.type &&
						e.length === this.token.text.length &&
						e === this.token.text.toLowerCase()
					);
				}),
				...
				(e.prototype.finish = function (e, t, n, i) {
					if (
						!(e instanceof r.Nodelist) &&
						(t && this.markError(e, t, n, i), this.prevToken)
					) {
				...
				(e.prototype._parseStylesheet = function () {
					for (
						...
						e.addChild(this._parseStylesheetStart());
				...
				(e.prototype._parseRuleset = function (e) {
					...
					for (; this.accept(n.TokenType.Comma); )
						if (!o.addChild(this._parseSelector(e)))
							return this.finish(t, i.ParseError.SelectorExpected);
				...
				(e.prototype._parseDeclarations = function (e) {
					...
					for (var o = e(); t.addChild(o) && !this.peek(n.TokenType.CurlyR); ) {
						...
						for (
							o &&
							this.prevToken &&
							this.prevToken.type === n.TokenType.SemiColon &&
							(o.semicolonPosition = this.prevToken.offset);
							this.accept(n.TokenType.SemiColon);
				...
				(e.prototype._parseDeclaration = function (e) {
					...
					if (!this.accept(n.TokenType.Colon)) {
						var o = e
							? __spreadArrays(e, [n.TokenType.SemiColon])
							: [n.TokenType.SemiColon];
						return this.finish(
							t,
							i.ParseError.ColonExpected,
							[n.TokenType.Colon],
							o
						);
					}
					return (
						...
						t.setValue(this._parseExpr())
							? (t.addChild(this._parsePrio()),
							  this.peek(n.TokenType.SemiColon) &&
				...
				(e.prototype._tryParseCustomPropertyDeclaration = function () {
					...
					if (!this.accept(n.TokenType.Colon))
						return this.finish(e, i.ParseError.ColonExpected, [
							n.TokenType.Colon,
						]);
					this.prevToken && (e.colonPosition = this.prevToken.offset);
					var t = this.mark();
					if (this.peek(n.TokenType.CurlyL)) {
						var o = this.create(r.CustomPropertySet),
							a = this._parseDeclarations(
					...
					var l = this._parseExpr();
					return l &&
						!l.isErroneous(!0) &&
						(this._parsePrio(), this.peek(n.TokenType.SemiColon))
						? (e.setValue(l),
						  (e.semicolonPosition = this.token.offset),
						  this.finish(e))
						: (this.restoreAtMark(t),
							...
							case n.TokenType.EOF:
								...
								return (
									a > 0
										...
										: s > 0 && (l = i.ParseError.RightParenthesisExpected),
									this.finish(e, l)
								);
						}
						this.consumeToken();
					...
					return (
						...
						e.addChild(this._parseURILiteral()) ||
							...
							? this.accept(n.TokenType.SemiColon)
								? this.finish(e)
								: this.finish(e, i.ParseError.SemiColonExpected)
							: this.finish(e, i.ParseError.URIExpected, [
									n.TokenType.SemiColon,
							  ])
					);
				}),
				...
				(e.prototype._parseKeyframe = function () {
					if (!this.peekRegExp(n.TokenType.AtKeyword, this.keyframeRegex))
						return null;
					...
					return (
						...
						t.matches("@-ms-keyframes") &&
							this.markError(t, i.ParseError.UnknownKeyword),
				...
				(e.prototype._tryParseKeyframeSelector = function () {
					...
					for (; this.accept(n.TokenType.Comma); )
						if (
							...
							return this.restoreAtMark(t), null;
					return this.peek(n.TokenType.CurlyL)
						? this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
						: (this.restoreAtMark(t), null);
				}),
				...
				(e.prototype._parseSupportsCondition = function () {
					...
					if (this.acceptIdent("not"))
						...
						(e.addChild(this._parseSupportsConditionInParens()),
						this.peekRegExp(n.TokenType.Ident, /^(and|or)$/i))
					)
				...
				(e.prototype._parseSupportsConditionInParens = function () {
						...
						return (
							...
							this._parseSupportsCondition()
								? this.accept(n.TokenType.ParenthesisR)
									? (this.prevToken && (e.rParent = this.prevToken.offset),
									  this.finish(e))
									: this.finish(
											e,
											i.ParseError.RightParenthesisExpected,
											[n.TokenType.ParenthesisR],
											[]
									  )
								: this.finish(e, i.ParseError.ConditionExpected)
						);
					if (this.peek(n.TokenType.Ident)) {
						...
						if (
							...
							for (var o = 1; this.token.type !== n.TokenType.EOF && 0 !== o; )
								this.token.type === n.TokenType.ParenthesisL
									? o++
									: this.token.type === n.TokenType.ParenthesisR && o--,
									this.consumeToken();
							return this.finish(e);
						}
						this.restoreAtMark(t);
					...
					return this.finish(
						e,
						i.ParseError.LeftParenthesisExpected,
						[],
						[n.TokenType.ParenthesisL]
					);
				}),
				...
				(e.prototype._parseMedia = function (e) {
					...
					return (
						...
						t.addChild(this._parseMediaQueryList())
							...
							: this.finish(t, i.ParseError.MediaQueryExpected)
					);
				}),
				(e.prototype._parseMediaQueryList = function () {
					...
					if (!e.addChild(this._parseMediaQuery([n.TokenType.CurlyL])))
						return this.finish(e, i.ParseError.MediaQueryExpected);
					for (; this.accept(n.TokenType.Comma); )
						if (!e.addChild(this._parseMediaQuery([n.TokenType.CurlyL])))
							return this.finish(e, i.ParseError.MediaQueryExpected);
					return this.finish(e);
				...
				(e.prototype._parseMediaQuery = function (e) {
					...
					for (; o; )
						if (t.addChild(this._parseMediaContentStart()))
							...
							if (!this.accept(n.TokenType.ParenthesisL))
								return s
									? this.finish(t, i.ParseError.LeftParenthesisExpected, [], e)
									: null;
				...
				(e.prototype._parsePageMarginBox = function () {
					...
					return (
						this.acceptOneKeyword(o.pageBoxDirectives) ||
							this.markError(
								e,
								i.ParseError.UnknownAtRule,
								[],
								[n.TokenType.CurlyL]
							),
						this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
				...
				(e.prototype._parsePageSelector = function () {
					if (!this.peek(n.TokenType.Ident) && !this.peek(n.TokenType.Colon))
						return null;
					var e = this.create(r.Node);
					return (
						e.addChild(this._parseIdent()),
				...
				(e.prototype._parseUnknownAtRule = function () {
					...
					e: for (;;) {
						switch (this.token.type) {
							...
							case n.TokenType.EOF:
								return o > 0
									? this.finish(e, i.ParseError.RightCurlyExpected)
									: a > 0
							...
							case n.TokenType.CurlyR:
								if ((o--, t > 0 && 0 === o)) {
									if ((this.consumeToken(), a > 0))
										return this.finish(
											e,
											i.ParseError.RightSquareBracketExpected
										);
									if (s > 0)
										return this.finish(
											e,
				...
				(e.prototype._parseOperator = function () {
					if (
						...
						this.peekDelim("+") ||
						this.peekDelim("-") ||
						this.peek(n.TokenType.Dashmatch) ||
						this.peek(n.TokenType.Includes) ||
						this.peek(n.TokenType.SubstringOperator) ||
						this.peek(n.TokenType.PrefixOperator) ||
						this.peek(n.TokenType.SuffixOperator) ||
						this.peekDelim("=")
					) {
					...
					if (this.peekDelim(">")) {
						...
						if (!this.hasWhitespace() && this.acceptDelim(">")) {
							if (!this.hasWhitespace() && this.acceptDelim(">"))
								return (
									(e.type =
										r.NodeType.SelectorCombinatorShadowPiercingDescendant),
									this.finish(e)
								);
							this.restoreAtMark(t);
						}
						return (
							(e.type = r.NodeType.SelectorCombinatorParent), this.finish(e)
						);
					}
					if (this.peekDelim("+")) {
						...
						return (
							this.consumeToken(),
							(e.type = r.NodeType.SelectorCombinatorSibling),
							this.finish(e)
						);
					}
					if (this.peekDelim("~")) {
						...
						return (
							this.consumeToken(),
							(e.type = r.NodeType.SelectorCombinatorAllSiblings),
							this.finish(e)
						);
					}
					if (this.peekDelim("/")) {
							...
							if (
								(t.addChild(
									this.try(function () {
										...
										for (
											;
											e.accept(n.TokenType.Comma) &&
											t.addChild(e._parseSelector(!1));

										);
										return e.peek(n.TokenType.ParenthesisR)
											? e.finish(t)
											: null;
								...
								return this.finish(t, i.ParseError.RightParenthesisExpected);
						}
						return this.finish(t);
					}
					return null;
				...
				(e.prototype._tryParsePseudoIdentifier = function () {
					...
					return (
						...
						this.hasWhitespace()
							...
							: (this.accept(n.TokenType.Colon) &&
									this.hasWhitespace() &&
									this.markError(t, i.ParseError.IdentifierExpected),
							  t.addChild(this._parseIdent()) ||
									this.markError(t, i.ParseError.IdentifierExpected),
							  t)
					);
				...
				(e.prototype._parsePrio = function () {
					...
					return this.accept(n.TokenType.Exclamation) &&
				...
				(e.prototype._parseNamedLine = function () {
					...
					return this.accept(n.TokenType.BracketR)
						? this.finish(e)
						: this.finish(e, i.ParseError.RightSquareBracketExpected);
				}),
				...
				(e.prototype._parseNumeric = function () {
					if (
						this.peek(n.TokenType.Num) ||
						this.peek(n.TokenType.Percentage) ||
						this.peek(n.TokenType.Resolution) ||
						this.peek(n.TokenType.Length) ||
						this.peek(n.TokenType.EMS) ||
						this.peek(n.TokenType.EXS) ||
						this.peek(n.TokenType.Angle) ||
						this.peek(n.TokenType.Time) ||
						this.peek(n.TokenType.Dimension) ||
						this.peek(n.TokenType.Freq)
					) {
				...
				(e.prototype._parseStringLiteral = function () {
					if (
						!this.peek(n.TokenType.String) &&
						!this.peek(n.TokenType.BadString)
					)
						return null;
				...
				(e.prototype._parseURILiteral = function () {
					if (!this.peekRegExp(n.TokenType.Ident, /^url(-prefix)?$/i))
						return null;
					var e = this.mark(),
						t = this.createNode(r.NodeType.URILiteral);
					return (
						this.accept(n.TokenType.Ident),
						this.hasWhitespace() || !this.peek(n.TokenType.ParenthesisL)
							? (this.restoreAtMark(e), null)
				...
				(e.prototype._parseFunction = function () {
					...
					if (t.getArguments().addChild(this._parseFunctionArgument()))
						for (
							;
							this.accept(n.TokenType.Comma) &&
							!this.peek(n.TokenType.ParenthesisR);
				...
				(e.prototype._parseFunctionIdentifier = function () {
					...
					if (
						((e.referenceTypes = [r.ReferenceType.Function]),
...
!(function (e) {
		...
		i = (function () {
			...
			return (
				...
				(e.prototype.findInScope = function (e, t) {
					...
					return o.offset <= e && o.offset + o.length >= e + t
						? o.findInScope(e, t)
						: this;
				}),
	...
	var a = (function () {
		...
		return (
			...
			(e.prototype.visitNode = function (e) {
				switch (e.type) {
					case n.NodeType.Keyframe:
						return (
							this.addSymbol(e, e.getName(), void 0, n.ReferenceType.Keyframe),
							!0
						);
					...
					case n.NodeType.MixinDeclaration:
						return (
							this.addSymbol(e, e.getName(), void 0, n.ReferenceType.Mixin), !0
						);
					case n.NodeType.FunctionDeclaration:
						return (
							this.addSymbol(e, e.getName(), void 0, n.ReferenceType.Function),
							!0
						);
					...
					case n.NodeType.Each:
						...
						if (o)
							for (
								var s = 0, a = i.getVariables().getChildren();
								s < a.length;
								s++
							) {
								var l = a[s];
			...
			(e.prototype.visitRuleSet = function (e) {
				...
				if (t)
					for (
						var r = 0, i = e.getSelectors().getChildren();
						r < i.length;
						r++
					) {
						var o = i[r];
						o instanceof n.Selector &&
							1 === o.getChildren().length &&
							t.addSymbol(
								new s(o.getChild(0).getText(), void 0, o, n.ReferenceType.Rule)
							);
					}
				return !0;
			}),
		...
		return (
			...
			(e.prototype.internalFindSymbol = function (e, t) {
				...
				if (
					...
					e.parent instanceof n.FunctionArgument &&
						e.parent.getParent() instanceof n.Function)
				) {
				...
				if (!r) return null;
				for (
					var s = e.getText(), a = this.global.findScope(r.offset, r.length);
					a;
			...
			(e.prototype.evaluateReferenceTypes = function (e) {
				...
				return e.findAParent(n.NodeType.Selector, n.NodeType.ExtendsReference)
					? [n.ReferenceType.Rule]
					: null;
			}),
			...
			(e.prototype.matchesSymbol = function (e, t) {
				...
				return (
					!(!r || -1 === r.indexOf(t.type)) &&
					this.internalFindSymbol(e, r) === t
				);
			}),
	...
	(function (e) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						var t = e;
						return (
							x.objectLiteral(t) && x.number(t.line) && x.number(t.character)
						);
					});
			})((n = t.Position || (t.Position = {}))),
			(function (e) {
				(e.create = function (e, t, r, i) {
					if (x.number(e) && x.number(t) && x.number(r) && x.number(i))
					...
					(e.is = function (e) {
						var t = e;
						return x.objectLiteral(t) && n.is(t.start) && n.is(t.end);
					});
			})((r = t.Range || (t.Range = {}))),
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						...
						return (
							...
							(r.is(t.targetSelectionRange) ||
								x.undefined(t.targetSelectionRange)) &&
							(r.is(t.originSelectionRange) ||
								x.undefined(t.originSelectionRange))
						);
					});
			...
			(function (e) {
				(e.create = function (e, t, n) {
					...
					(e.is = function (e) {
						...
						return (
							x.string(t.label) &&
							(x.undefined(t.textEdit) || c.is(t)) &&
							(x.undefined(t.additionalTextEdits) ||
								x.typedArray(t.additionalTextEdits, c.is))
						);
					});
			...
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						var t = e;
						return x.defined(t) && i.is(t.location) && x.string(t.message);
					});
			})(
				(s =
					...
					(e.is = function (e) {
						...
						return (
							...
							(x.undefined(t.relatedInformation) ||
								x.typedArray(t.relatedInformation, s.is))
						);
					});
			...
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						var t = e;
						return (
							x.defined(t) && f.is(t.textDocument) && Array.isArray(t.edits)
						);
					});
						...
						(void 0 === t.documentChanges ||
							t.documentChanges.every(function (e) {
								return x.string(e.kind)
									? p.is(e) || h.is(e) || m.is(e)
									: d.is(e);
							}))
					);
				};
			})((u = t.WorkspaceEdit || (t.WorkspaceEdit = {})));
		var f,
			g,
			b,
			y,
		...
		(t.WorkspaceChange = w),
			...
			(function (e) {
				e.is = function (e) {
					var t = e;
					return x.objectLiteral(e) && g.is(t.kind) && x.string(t.value);
				};
				...
				(e.create = function (e, t, n, r, i, o) {
					...
					(e.is = function (e) {
						...
						return (
							...
							(void 0 === t.detail || x.string(t.detail)) &&
			...
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						...
						return (
							x.defined(t) &&
							x.typedArray(t.diagnostics, a.is) &&
				...
				(e.create = function (e, t, n) {
					...
					(e.is = function (e) {
						...
						return (
							t &&
							x.string(t.title) &&
							(void 0 === t.diagnostics || x.typedArray(t.diagnostics, a.is)) &&
				...
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						...
						return (
							x.defined(t) &&
							r.is(t.range) &&
							(x.undefined(t.command) || l.is(t.command))
						);
					});
			...
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						var t = e;
						return (
							x.defined(t) && x.number(t.tabSize) && x.boolean(t.insertSpaces)
						);
					});
					...
					for (var o = 0, s = t; o < s.length; o++) {
						...
						if (e.isIncremental(a)) {
							...
							var p = Math.max(l.start.line, 0),
								...
								u = r(a.text, !1, c);
							if (h - p === u.length)
								for (var f = 0, g = u.length; f < g; f++) m[f + p + 1] = u[f];
							else
								u.length < 1e4
									? m.splice.apply(m, [p + 1, h - p].concat(u))
									: (this._lineOffsets = m =
											m.slice(0, p + 1).concat(u, m.slice(h + 1)));
							var b = a.text.length - (d - c);
							if (0 !== b)
								for (f = p + 1 + u.length, g = m.length; f < g; f++)
									m[f] = m[f] + b;
						} else {
							if (!e.isFull(a))
			...
			(e.create = function (e, t, r, i) {
				...
				(e.applyEdits = function (e, t) {
					for (
						...
						(n = n.substring(0, l) + a.newText + n.substring(c, n.length)),
							(i = l);
					}
					return n;
				});
	...
	(function (e) {
		...
		var n,
			...
			l = e("vscode-nls"),
			c = e("../utils/objects"),
			d = l.loadMessageBundle(),
			p = a.InsertTextFormat.Snippet;
		!(function (e) {
			(e.Enums = " "),
				(e.Normal = "d"),
				(e.VendorPrefixed = "x"),
		...
		var h = (function () {
			function e(e, t) {
				void 0 === e && (e = null),
					...
					(this.clientCapabilities = t),
					(this.completionParticipants = []),
					(this.valueTypes = [
						r.NodeType.Identifier,
						r.NodeType.Value,
						r.NodeType.StringLiteral,
						r.NodeType.URILiteral,
						r.NodeType.NumericValue,
						r.NodeType.HexColorValue,
						r.NodeType.VariableName,
						r.NodeType.Prio,
					]);
			}
			return (
				...
				(e.prototype.getSymbolContext = function () {
					return (
						this.symbolContext ||
							(this.symbolContext = new i.Symbols(this.styleSheet)),
						this.symbolContext
					);
				}),
				...
				(e.prototype.doComplete = function (e, t, n) {
					(this.offset = e.offsetAt(t)),
						...
						(this.defaultReplaceRange = a.Range.create(
							a.Position.create(
								this.position.line,
					...
					try {
						...
						for (var o = this.nodePath.length - 1; o >= 0; o--) {
							var s = this.nodePath[o];
							if (s instanceof r.Property)
								this.getCompletionsForDeclarationProperty(s.getParent(), i);
							else if (s instanceof r.Expression)
								s.parent instanceof r.Interpolation
									? this.getVariableProposals(null, i)
									: this.getCompletionsForExpression(s, i);
							else if (s instanceof r.SimpleSelector) {
								var l = s.findAParent(
									r.NodeType.ExtendsReference,
									r.NodeType.Ruleset
								);
								if (l)
									if (l.type === r.NodeType.ExtendsReference)
										this.getCompletionsForExtendsReference(l, s, i);
									else {
										var c = l;
										this.getCompletionsForSelector(c, c && c.isNested(), i);
									}
							} else if (s instanceof r.FunctionArgument)
								this.getCompletionsForFunctionArgument(s, s.getParent(), i);
							else if (s instanceof r.Declarations)
								this.getCompletionsForDeclarations(s, i);
							else if (s instanceof r.VariableDeclaration)
								this.getCompletionsForVariableDeclaration(s, i);
							else if (s instanceof r.RuleSet)
								this.getCompletionsForRuleSet(s, i);
							else if (s instanceof r.Interpolation)
								this.getCompletionsForInterpolation(s, i);
							else if (s instanceof r.FunctionDeclaration)
								this.getCompletionsForFunctionDeclaration(s, i);
							else if (s instanceof r.MixinReference)
								this.getCompletionsForMixinReference(s, i);
							else if (s instanceof r.Function)
								this.getCompletionsForFunctionArgument(null, s, i);
							else if (s instanceof r.Supports)
								this.getCompletionsForSupports(s, i);
							else if (s instanceof r.SupportsCondition)
								this.getCompletionsForSupportsCondition(s, i);
							else if (s instanceof r.ExtendsReference)
								this.getCompletionsForExtendsReference(s, null, i);
							else if (s.type === r.NodeType.URILiteral)
								this.getCompletionForUriLiteralValue(s, i);
							else if (null === s.parent) this.getCompletionForTopLevel(i);
							else {
								if (
									s.type !== r.NodeType.StringLiteral ||
									!this.isImportPathParent(s.parent.type)
								)
									continue;
								this.getCompletionForImportPath(s, i);
							}
							if (i.items.length > 0 || this.offset > s.offset)
				...
				(e.prototype.finalize = function (e) {
					return (
						e.items.some(function (e) {
							return !!e.sortText || "-" === e.label[0];
						}) &&
							e.items.forEach(function (e, t) {
								e.sortText
									? "-" === e.label[0]
										? (e.sortText += n.VendorPrefixed + "_" + u(t))
										: (e.sortText += n.Normal + "_" + u(t))
									: "-" === e.label[0]
									? (e.sortText = n.VendorPrefixed + "_" + u(t))
									: (e.sortText = n.Normal + "_" + u(t));
							}),
				...
				(e.prototype.getPropertyProposals = function (e, t) {
					...
					return (
						o.cssDataManager.getProperties().forEach(function (d) {
							var p,
								h,
								u = !1;
							e
								? ((p = r.getCompletionRange(e.getProperty())),
								  (h = d.name),
								  c.isDefined(e.colonPosition) || ((h += ": "), (u = !0)))
								: ((p = r.getCompletionRange(null)),
								  (h = d.name + ": "),
								  (u = !0)),
								!e && l && (h += "$0;"),
								e &&
									!e.semicolonPosition &&
									l &&
									r.offset >= r.textDocument.offsetAt(p.end) &&
									(h += "$0;");
							var f = {
								label: d.name,
								documentation: o.getEntryDescription(
									d,
									r.doesSupportMarkdown()
								),
							...
							d.restrictions || (u = !1),
								...
								s.startsWith(d.name, "-") && (f.sortText = n.VendorPrefixed),
								t.items.push(f);
						}),
					...
					"isTriggerPropertyValueCompletionEnabled",
					{
						get: function () {
							return (
								...
								void 0 ===
									this.settings.completion.triggerPropertyValueCompletion ||
								this.settings.completion.triggerPropertyValueCompletion
							);
						},
						enumerable: !0,
					...
					"isCompletePropertyWithSemicolonEnabled",
					{
						get: function () {
							return (
								...
								!this.settings.completion ||
								void 0 ===
									this.settings.completion.completePropertyWithSemicolon ||
								this.settings.completion.completePropertyWithSemicolon
							);
						},
						enumerable: !0,
				...
				(e.prototype.getCompletionsForDeclarationValue = function (e, t) {
					for (
						var n = this,
							...
							s = o.cssDataManager.getProperty(i),
							l = e.getValue() || null;
						l && l.hasChildren();

					)
						l = l.findChildAtOffset(this.offset, !1);
					if (
						(this.completionParticipants.forEach(function (e) {
							e.onCssPropertyValue &&
								e.onCssPropertyValue({
									...
									range: n.getCompletionRange(l),
								});
						}),
						s)
					) {
						if (s.restrictions)
							for (var c = 0, d = s.restrictions; c < d.length; c++) {
								switch (d[c]) {
									case "color":
										this.getColorProposals(s, l, t);
										break;
									case "position":
										this.getPositionProposals(s, l, t);
										break;
									case "repeat":
										this.getRepeatStyleProposals(s, l, t);
										break;
									case "line-style":
										this.getLineStyleProposals(s, l, t);
										break;
									case "line-width":
										this.getLineWidthProposals(s, l, t);
										break;
									case "geometry-box":
										this.getGeometryBoxProposals(s, l, t);
										break;
									case "box":
										this.getBoxProposals(s, l, t);
										break;
									case "image":
										this.getImageProposals(s, l, t);
										break;
									case "timing-function":
										this.getTimingFunctionProposals(s, l, t);
										break;
									case "shape":
										this.getBasicShapeProposals(s, l, t);
								}
							}
						this.getValueEnumProposals(s, l, t),
							this.getCSSWideKeywordProposals(s, l, t),
							this.getUnitProposals(s, l, t);
					} else
						for (
							var p = 0,
								h = (function (e, t) {
									...
									function o(e) {
										return (
											(e instanceof r.Identifier ||
												e instanceof r.NumericValue ||
												e instanceof r.HexColorValue) &&
												i.add(e.getText()),
											!0
										);
									}
							...
							t.items.push({
								label: m,
								textEdit: a.TextEdit.replace(this.getCompletionRange(l), m),
								kind: a.CompletionItemKind.Value,
							});
						}
					return (
						this.getVariableProposals(l, t), this.getTermProposals(s, l, t), t
					);
				}),
				...
				(e.prototype.getCSSWideKeywordProposals = function (e, t, n) {
					for (var r in o.cssWideKeywords)
						n.items.push({
							label: r,
				...
				(e.prototype.getCompletionsForInterpolation = function (e, t) {
					return (
						this.offset >= e.offset + 2 && this.getVariableProposals(null, t), t
					);
				}),
				(e.prototype.getVariableProposals = function (e, t) {
					for (
						var i = 0,
							o = this.getSymbolContext().findSymbolsAtOffset(
								this.offset,
								r.ReferenceType.Variable
							);
						i < o.length;
						i++
					) {
						...
						if (
							("string" == typeof p.documentation &&
								y(p.documentation) &&
								(p.kind = a.CompletionItemKind.Color),
							l.node.type === r.NodeType.FunctionParameter)
						) {
							var h = l.node.getParent();
							h.type === r.NodeType.MixinDeclaration &&
								(p.detail = d(
									"completion.argument",
									"argument from '{0}'",
									h.getName()
					...
					for (
						...
						var o = i[n],
							l = {
								...
								textEdit: a.TextEdit.replace(
									this.getCompletionRange(null),
									o.name
								),
								kind: a.CompletionItemKind.Variable,
							};
						"string" == typeof l.documentation &&
							y(l.documentation) &&
							(l.kind = a.CompletionItemKind.Color),
							e.items.push(l);
					}
					return e;
				}),
						...
						for (var l = 0, c = e.restrictions; l < c.length; l++) {
							...
							if (p)
								for (var h = 0, m = p; h < m.length; h++) {
									...
									n.items.push({
										label: u,
										textEdit: a.TextEdit.replace(this.getCompletionRange(t), u),
				...
				(e.prototype.getPositionProposals = function (e, t, n) {
					for (var r in o.positionKeywords)
						n.items.push({
							label: r,
				...
				(e.prototype.getRepeatStyleProposals = function (e, t, n) {
					for (var r in o.repeatStyleKeywords)
						n.items.push({
							label: r,
				...
				(e.prototype.getLineStyleProposals = function (e, t, n) {
					for (var r in o.lineStyleKeywords)
						n.items.push({
							label: r,
				...
				(e.prototype.getGeometryBoxProposals = function (e, t, n) {
					for (var r in o.geometryBoxKeywords)
						n.items.push({
							label: r,
				...
				(e.prototype.getCompletionsForStylesheet = function (e) {
					...
					return t
						? t instanceof r.RuleSet
							? this.getCompletionsForRuleSet(t, e)
							: t instanceof r.Supports
				...
				(e.prototype.getCompletionForTopLevel = function (e) {
					var t = this;
					return (
						o.cssDataManager.getAtDirectives().forEach(function (n) {
							e.items.push({
								label: n.name,
								textEdit: a.TextEdit.replace(
									t.getCompletionRange(null),
									n.name
								),
								documentation: o.getEntryDescription(
									n,
									t.doesSupportMarkdown()
								),
				...
				(e.prototype.getCompletionsForSelector = function (e, t, i) {
					var l = this,
						c = this.findInNodePath(
							r.NodeType.PseudoSelector,
							r.NodeType.IdentifierSelector,
							r.NodeType.ClassSelector,
							r.NodeType.ElementNameSelector
						);
					if (
						(!c &&
						...
						o.cssDataManager.getPseudoClasses().forEach(function (e) {
							var t = g(e.name),
								r = {
									label: e.name,
									...
									documentation: o.getEntryDescription(
										e,
										l.doesSupportMarkdown()
									),
									tags: m(e) ? [a.CompletionItemTag.Deprecated] : [],
									kind: a.CompletionItemKind.Function,
									insertTextFormat: e.name !== t ? p : void 0,
								};
							s.startsWith(e.name, ":-") && (r.sortText = n.VendorPrefixed),
								i.items.push(r);
						}),
						o.cssDataManager.getPseudoElements().forEach(function (e) {
							var t = g(e.name),
								r = {
									label: e.name,
									textEdit: a.TextEdit.replace(l.getCompletionRange(c), t),
						...
						for (var d = 0, h = o.html5Tags; d < h.length; d++) {
							var u = h[d];
							i.items.push({
								label: u,
					...
					if (
						...
						w &&
							0 === e.getSelectors().getChildren().indexOf(w) &&
				...
				(e.prototype.getCompletionsForExpression = function (e, t) {
					var n = e.getParent();
					if (n instanceof r.FunctionArgument)
						return (
							this.getCompletionsForFunctionArgument(n, n.getParent(), t), t
						);
					var i = e.findParent(r.NodeType.Declaration);
					if (!i) return this.getTermProposals(null, null, t), t;
					var o = e.findChildAtOffset(this.offset, !0);
					return o
						? o instanceof r.NumericValue || o instanceof r.Identifier
					...
					for (
						var n = 0,
							i = this.getSymbolContext().findSymbolsAtOffset(
								this.offset,
								r.ReferenceType.Mixin
							);
						n < i.length;
						n++
					) {
						var o = i[n];
						o.node instanceof r.MixinDeclaration &&
							t.items.push(
								this.makeTermProposal(o, o.node.getParameters(), null)
							);
					}
					return t;
				}),
				(e.prototype.getTermProposals = function (e, t, n) {
					for (
						var i = 0,
							o = this.getSymbolContext().findSymbolsAtOffset(
								this.offset,
								r.ReferenceType.Function
							);
						i < o.length;
						i++
					) {
						var s = o[i];
						s.node instanceof r.FunctionDeclaration &&
							n.items.push(this.makeTermProposal(s, s.node.getParameters(), t));
					}
					return n;
				}),
				(e.prototype.makeTermProposal = function (e, t, i) {
					...
					var o = t.getChildren().map(function (e) {
							return e instanceof r.FunctionParameter
								? e.getName()
								: e.getText();
						}),
						s =
				...
				(e.prototype.getCompletionsForSupports = function (e, t) {
					...
					if (!n || this.offset <= n.offset) {
						...
						return i instanceof r.SupportsCondition
					...
					return (
						this.completionParticipants.forEach(function (e) {
							e.onCssURILiteralValue &&
								e.onCssURILiteralValue({ uriValue: n, position: r, range: i });
						}),
						t
					);
				}),
				(e.prototype.getCompletionForImportPath = function (e, t) {
					var n = this;
					return (
						this.completionParticipants.forEach(function (t) {
							t.onCssImportPath &&
								t.onCssImportPath({
									pathValue: e.getText(),
									position: n.position,
				...
				(e.prototype.doesSupportMarkdown = function () {
					if (!c.isDefined(this.supportsMarkdown)) {
						if (!c.isDefined(this.clientCapabilities))
		...
		function m(e) {
			return !(
				!e.status ||
				("nonstandard" !== e.status && "obsolete" !== e.status)
			);
		}
		function u(e) {
			var t = e.toString();
		...
		var b = (function () {
			...
			return (
				(e.prototype.visitNode = function (e) {
					return (
						(e instanceof r.HexColorValue ||
							(e instanceof r.Function && o.isColorConstructor(e))) &&
		...
		function y(e) {
			return (
				e.toLowerCase() in o.colors ||
				/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(e)
			);
		}
	});
__extends =
...
!(function (e) {
		...
		s = (function () {
			...
			return (
				...
				(e.prototype.findRoot = function () {
					for (var e = this; e.parent && !(e.parent instanceof a); )
						e = e.parent;
					return e;
				}),
			...
			return (
				(e.prototype.print = function (e) {
					return (
						(this.result = []),
						e instanceof a
							? e.children && this.doPrint(e.children, 0)
							: this.doPrint([e], 0),
				...
				(e.prototype.doPrintElement = function (e, t) {
					...
					if (e instanceof l || "…" === n) this.writeLine(t, n);
					else {
						var r = ["<"];
						if ((n ? r.push(n) : r.push("element"), e.attributes))
							for (var i = 0, o = e.attributes; i < o.length; i++) {
								...
								if ("name" !== s.name) {
									...
									var a = s.value;
									a && (r.push("="), r.push(c.ensure(a, this.quote)));
								}
							}
	...
	function h(e, t) {
		for (var r = new s(), i = 0, o = e.getChildren(); i < o.length; i++) {
			var a = o[i];
			switch (a.type) {
				case n.NodeType.SelectorCombinator:
					if (t) {
						var l = a.getText().split("&");
						if (1 === l.length) {
							r.addAttr("name", l[0]);
							break;
						}
						if (((r = t.cloneWithParent()), l[0])) r.findRoot().prepend(l[0]);
				...
				case n.NodeType.ElementNameSelector:
					var h = a.getText();
					r.addAttr("name", "*" === h ? "element" : m(h));
					break;
				case n.NodeType.ClassSelector:
					r.addAttr("class", m(a.getText().substring(1)));
					break;
				case n.NodeType.IdentifierSelector:
					r.addAttr("id", m(a.getText().substring(1)));
					break;
				case n.NodeType.MixinDeclaration:
					r.addAttr("class", a.getName());
					break;
				case n.NodeType.PseudoSelector:
					r.addAttr(m(a.getText()), "");
					break;
	...
	function u(e) {
		...
		return (
			(function e(r) {
				r.getChildren().forEach(function (r) {
					switch (r.type) {
						case n.NodeType.IdentifierSelector:
							t.id++;
							break;
						...
						case n.NodeType.PseudoSelector:
							...
							if (
								(function (e) {
									var t = e.match(/^::?([\w-]+)/);
									return (
										!!t && !!i.cssDataManager.getPseudoElement("::" + t[1])
									);
								})(o)
							)
								t.tag++;
							else {
								if (o.match(/^:not/i)) break;
								t.attr++;
							}
					}
					r.getChildren().length > 0 && e(r);
				});
			})(e),
			o(
				"specificity",
	...
	var f = (function () {
		...
		return (
			(e.prototype.processSelector = function (e) {
				var t = null;
				if (
					!(this.element instanceof a) &&
					e.getChildren().some(function (e) {
						return (
							e.hasChildren() &&
							e.getChild(0).type === n.NodeType.SelectorCombinator
						);
					})
				) {
					var r = this.element.findRoot();
					r.parent instanceof a &&
						((t = this.element),
						(this.element = r.parent),
						this.element.removeChild(r),
						(this.prev = null));
				}
				for (var i = 0, o = e.getChildren(); i < o.length; i++) {
					var s = o[i];
					if (s instanceof n.SimpleSelector) {
						...
						this.prev &&
							this.prev.matches("~") &&
							(this.element.addChild(h(s)), this.element.addChild(new l("⋮")));
						var d = h(s, t),
							p = d.findRoot();
						this.element.addChild(p), (this.element = d);
					}
					(s instanceof n.SimpleSelector ||
						s.type === n.NodeType.SelectorCombinatorParent ||
						s.type === n.NodeType.SelectorCombinatorShadowPiercingDescendant ||
						s.type === n.NodeType.SelectorCombinatorSibling ||
						s.type === n.NodeType.SelectorCombinatorAllSiblings) &&
						(this.prev = s);
				}
			}),
			e
	...
	function b(e) {
		...
		for (var s = new f(t), l = r.length - 1; l >= 0; l--) {
			var c = r[l].getSelectors().getChild(0);
			c && s.processSelector(c);
		}
		return s.processSelector(e), t;
	}
	t.selectorToElement = b;
}),
	(function (e) {
		if ("object" == typeof module && "object" == typeof module.exports) {
			var t = e(require, exports);
			...
			l = (function () {
				...
				return (
					(e.prototype.doHover = function (e, t, a) {
						function l(t) {
							return s.Range.create(
								e.positionAt(t.offset),
								e.positionAt(t.end)
							);
						}
						for (
							var c = e.offsetAt(t), d = n.getNodePath(a, c), p = null, h = 0;
							h < d.length;
							h++
						) {
							var m = d[h];
							if (m instanceof n.Selector) {
								p = { contents: i.selectorToMarkedString(m), range: l(m) };
								break;
							}
							if (m instanceof n.SimpleSelector) {
								o.startsWith(m.getText(), "@") ||
									(p = {
										contents: i.simpleSelectorToMarkedString(m),
										range: l(m),
									});
								break;
							}
							if (m instanceof n.Declaration) {
								var u = m.getFullPropertyName();
								(g = r.cssDataManager.getProperty(u)) &&
									(p = {
										contents: r.getEntryDescription(
											g,
											this.doesSupportMarkdown()
										),
										range: l(m),
									});
							} else if (m instanceof n.UnknownAtRule) {
								var f = m.getText();
								(g = r.cssDataManager.getAtDirective(f)) &&
									(p = {
										contents: r.getEntryDescription(
											g,
											this.doesSupportMarkdown()
								...
								m instanceof n.Node &&
								m.type === n.NodeType.PseudoSelector
							) {
								var g,
									b = m.getText();
								(g =
									"::" === b.slice(0, 2)
										? r.cssDataManager.getPseudoElement(b)
										: r.cssDataManager.getPseudoClass(b)) &&
									(p = {
										contents: r.getEntryDescription(
											g,
											this.doesSupportMarkdown()
					...
					(e.prototype.convertContents = function (e) {
						return this.doesSupportMarkdown()
							? e
							: "string" == typeof e
							? e
							: "kind" in e
					...
					(e.prototype.doesSupportMarkdown = function () {
						if (!a.isDefined(this.supportsMarkdown)) {
							if (!a.isDefined(this.clientCapabilities))
								return (this.supportsMarkdown = !0), this.supportsMarkdown;
							var e =
								this.clientCapabilities.textDocument &&
							...
							this.supportsMarkdown =
								...
								-1 !== e.contentFormat.indexOf(s.MarkupKind.Markdown);
						}
						return this.supportsMarkdown;
					}),
					e
...
!(function (e) {
		...
		c = (function () {
			...
			return (
				(e.prototype.findDefinition = function (e, t, n) {
					...
					return l ? { uri: e.uri, range: p(l.node, e) } : null;
				}),
				...
				(e.prototype.findDocumentHighlights = function (e, t, n) {
					...
					if (
						!a ||
						a.type === i.NodeType.Stylesheet ||
						a.type === i.NodeType.Declarations
					)
						return r;
					a.type === i.NodeType.Identifier &&
						a.parent &&
						a.parent.type === i.NodeType.ClassSelector &&
						(a = a.parent);
					...
					return (
						n.accept(function (t) {
							if (c) {
								if (l.matchesSymbol(t, c))
									return r.push({ kind: h(t), range: p(t, e) }), !1;
							} else a && a.type === t.type && t.matches(d) && r.push({ kind: h(t), range: p(t, e) });
							return !0;
						}),
						r
					);
				...
				(e.prototype.findDocumentLinks = function (e, t, n) {
					...
					return (
						t.accept(function (t) {
							if (t.type === i.NodeType.URILiteral)
								return (
									(s = (function (e, t, n) {
							...
							if (t.parent && r.isRawStringDocumentLinkNode(t.parent)) {
								var s,
									l = t.getText();
				...
				(e.prototype.findDocumentLinks2 = function (e, t, n) {
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (r) {
							return [2, this.findDocumentLinks(e, t, n)];
						});
					});
				}),
				(e.prototype.findDocumentSymbols = function (e, t) {
					...
					return (
						t.accept(function (t) {
							var o = { name: null, kind: n.SymbolKind.Class, location: null },
								s = t;
							if (t instanceof i.Selector)
								return (
									(o.name = t.getText()),
									(s = t.findAParent(
										i.NodeType.Ruleset,
										i.NodeType.ExtendsReference
									)) &&
										((o.location = n.Location.create(e.uri, p(s, e))),
										r.push(o)),
									!1
								);
							if (t instanceof i.VariableDeclaration)
								(o.name = t.getName()), (o.kind = n.SymbolKind.Variable);
							else if (t instanceof i.MixinDeclaration)
								(o.name = t.getName()), (o.kind = n.SymbolKind.Method);
							else if (t instanceof i.FunctionDeclaration)
								(o.name = t.getName()), (o.kind = n.SymbolKind.Function);
							else if (t instanceof i.Keyframe)
								o.name = l("literal.keyframes", "@keyframes {0}", t.getName());
							else if (t instanceof i.FontFace)
								o.name = l("literal.fontface", "@font-face");
							else if (t instanceof i.Media) {
								var a = t.getChild(0);
								a instanceof i.Medialist &&
									((o.name = "@media " + a.getText()),
									(o.kind = n.SymbolKind.Module));
							}
							return (
								o.name &&
									((o.location = n.Location.create(e.uri, p(s, e))), r.push(o)),
								!0
							);
						}),
						r
				...
				(e.prototype.getColorPresentations = function (e, t, r, i) {
					...
					(o =
						1 === r.alpha
							? "rgb(" + l + ", " + c + ", " + d + ")"
							: "rgba(" + l + ", " + c + ", " + d + ", " + r.alpha + ")"),
						a.push({ label: o, textEdit: n.TextEdit.replace(i, o) }),
						(o =
							1 === r.alpha
								? "#" + m(l) + m(c) + m(d)
								: "#" + m(l) + m(c) + m(d) + m(Math.round(255 * r.alpha))),
						a.push({ label: o, textEdit: n.TextEdit.replace(i, o) });
				...
				(e.prototype.doRename = function (e, t, r, i) {
					var o,
						s = this.findDocumentHighlights(e, t, i).map(function (e) {
							return n.TextEdit.replace(e.range, r);
						});
					return { changes: ((o = {}), (o[e.uri] = s), o) };
				}),
				e
			);
		})();
	function d(e, t, n) {
		...
		var r = t.getText(),
			i = p(t, e);
		return i.start.line === i.end.line && i.start.character === i.end.character
			? null
			: ((a.startsWith(r, "'") || a.startsWith(r, '"')) && (r = r.slice(1, -1)),
			  {
					range: i,
					target:
						a.startsWith(r, "http://") || a.startsWith(r, "https://")
							? r
							: /^\w+:\/\//g.test(r)
							? r
							: n.resolveReference(r, e.uri),
			  });
	}
	function p(e, t) {
	...
	function h(e) {
		...
		if (
			...
			e.parent &&
			e.parent instanceof i.Property &&
			e.isCustomProperty
		)
		...
		(t.Setting = l),
			(t.Rules = {
				...
				UnknownAtRules: new a(
					"unknownAtRules",
					r("rule.unknownAtRules", "Unknown at-rule."),
					i
				),
				IEStarHack: new a(
					"ieHack",
				...
				return (
					(e.prototype.doCodeActions = function (e, t, n, r) {
						return this.doCodeActions2(e, t, n, r).map(function (t) {
							var n =
								t.edit && t.edit.documentChanges && t.edit.documentChanges[0];
					...
					(e.prototype.getFixesForUnknownProperty = function (e, t, n, o) {
						var l = t.getName(),
							c = [];
						r.cssDataManager.getProperties().forEach(function (e) {
							var t = i.difference(l, e.name);
							t >= l.length / 2 && c.push({ property: e.name, score: t });
						}),
							c.sort(function (e, t) {
								return t.score - e.score;
							});
						for (var d = 3, p = 0, h = c; p < h.length; p++) {
							var m = h[p].property,
								u = a("css.codeaction.rename", "Rename to '{0}'", m),
								f = s.TextEdit.replace(n.range, m),
								g = s.VersionedTextDocumentIdentifier.create(e.uri, e.version),
								b = { documentChanges: [s.TextDocumentEdit.create(g, [f])] },
								y = s.CodeAction.create(u, b, s.CodeActionKind.QuickFix);
							if (((y.diagnostics = [n]), o.push(y), --d <= 0)) return;
						}
					}),
					(e.prototype.appendFixesForMarker = function (e, t, r, i) {
						if (r.code === o.Rules.UnknownProperty.id)
							for (
								var s = e.offsetAt(r.range.start),
								...
								if (d instanceof n.Declaration) {
									var p = d.getProperty();
									if (p && p.offset === s && p.end === a)
										return void this.getFixesForUnknownProperty(e, p, r, i);
								}
							}
					}),
					e
	...
	(function (e) {
		...
		var n = e("../utils/arrays"),
			r = function (e) {
				(this.fullPropertyName = e.getFullPropertyName().toLowerCase()),
					(this.node = e);
			};
		function i(e, t, r, i) {
			var o = e[t];
		...
		function l(e, t) {
			return (
				void 0 === t && (t = !0),
				(!t || !a(e, ["initial", "unset"])) && 0 !== parseFloat(e.getText())
			);
		}
		function c(e, t) {
			return (
		...
		function d(e, t) {
			return (
				void 0 === t && (t = !0),
				!a(e, ["none", "hidden"]) && (!t || !a(e, ["initial", "unset"]))
			);
		}
		function p(e, t) {
			return (
					...
					if (void 0 !== a)
						switch (i.fullPropertyName) {
							...
							case "height":
								...
								break;
							default:
								var m = i.fullPropertyName.split("-");
								switch (m[0]) {
									case "border":
										switch (m[1]) {
											case void 0:
			...
			c = (function () {
				function e(e, t) {
					...
					(this.warnings = []),
						...
						(this.keyframes = new l()),
						(this.validProperties = {});
					var i = t.getSetting(r.Settings.ValidProperties);
					Array.isArray(i) &&
				...
				return (
					...
					(e.prototype.findValueInExpression = function (e, t) {
						...
						return (
							e.accept(function (e) {
								return (
									e.type === i.NodeType.Identifier && e.matches(t) && (n = !0),
									!n
								);
							}),
							n
					...
					(e.prototype.getMissingNames = function (e, t) {
						...
						for (r = 0; r < n.length; r++) {
							...
							s &&
								(o =
									null === o
										? a("namelist.single", "'{0}'", s)
										: a("namelist.concatenated", "{0}, '{1}'", o, s));
						}
						return o;
					}),
					(e.prototype.visitNode = function (e) {
					...
					(e.prototype.visitUnknownAtRule = function (e) {
						...
						return (
							!!t &&
							!n.cssDataManager.getAtDirective(t.getText()) &&
							(this.addEntry(
								t,
								r.Rules.UnknownAtRules,
					...
					(e.prototype.validateKeyframes = function () {
						...
						for (var t in this.keyframes.data) {
							...
							if (i || 1 !== n.length) {
								var o = this.getMissingNames(e, n);
								if (o || i)
									for (
										var s = 0, l = this.keyframes.data[t].nodes;
										s < l.length;
										s++
									) {
										var c = l[s];
										if (i) {
											...
											this.addEntry(
												c,
												r.Rules.IncludeStandardPropertyWhenUsingVendorPrefix,
												d
											);
										}
										if (o) {
											...
											this.addEntry(c, r.Rules.AllVendorPrefixes, d);
										}
									}
							}
						}
					...
					(e.prototype.visitSimpleSelector = function (e) {
						...
						return (
							1 === e.length &&
								"*" === t &&
								this.addEntry(e, r.Rules.UniversalSelector),
							"#" === t && this.addEntry(e, r.Rules.AvoidIdSelector),
							!0
						);
					}),
					...
					(e.prototype.visitRuleSet = function (t) {
						...
						if (!c) return !1;
						c.hasChildren() ||
							this.addEntry(t.getSelectors(), r.Rules.EmptyRuleSet);
						for (var d = [], p = 0, h = c.getChildren(); p < h.length; p++) {
							(R = h[p]) instanceof i.Declaration && d.push(new o.Element(R));
						}
						var m = o.default(d);
						if (m.width) {
							var u = [];
							if (
								(m.right.value && (u = s.union(u, m.right.properties)),
								m.left.value && (u = s.union(u, m.left.properties)),
								0 !== u.length)
							) {
								for (var f = 0, g = u; f < g.length; f++) {
									var b = g[f];
									this.addEntry(b.node, r.Rules.BewareOfBoxModelSize);
								}
								this.addEntry(m.width.node, r.Rules.BewareOfBoxModelSize);
							}
						}
						if (m.height) {
							u = [];
							if (
								(m.top.value && (u = s.union(u, m.top.properties)),
								m.bottom.value && (u = s.union(u, m.bottom.properties)),
								0 !== u.length)
							) {
								for (var y = 0, v = u; y < v.length; y++) {
									b = v[y];
									this.addEntry(b.node, r.Rules.BewareOfBoxModelSize);
								}
								this.addEntry(m.height.node, r.Rules.BewareOfBoxModelSize);
							}
						}
						var w = this.fetchWithValue(d, "display", "inline");
						if (w.length > 0)
							for (
								var x = 0,
									S = [
								...
								for (
									var k = S[x], C = this.fetch(d, k), T = 0;
									T < C.length;
									T++
								) {
									var F = C[T].node,
										D = F.getValue();
									("float" !== k || (D && !D.matches("none"))) &&
										this.addEntry(
											F,
						...
						if (
							(w = this.fetchWithValue(d, "display", "inline-block")).length > 0
						)
							for (C = this.fetch(d, "float"), T = 0; T < C.length; T++) {
								var E = C[T].node;
								(D = E.getValue()) &&
									!D.matches("none") &&
									this.addEntry(
						...
						if ((w = this.fetchWithValue(d, "display", "block")).length > 0)
							for (
								C = this.fetch(d, "vertical-align"), T = 0;
								T < C.length;
								T++
							)
								this.addEntry(
						...
						var z = this.fetch(d, "float");
						for (T = 0; T < z.length; T++) {
							var R = z[T];
							this.isValidPropertyDeclaration(R) ||
								this.addEntry(R.node, r.Rules.AvoidFloat);
						}
						for (var _ = 0; _ < d.length; _++) {
							if (
								"background" !== (R = d[_]).fullPropertyName &&
								!this.validProperties[R.fullPropertyName]
							)
								if (
									(D = R.node.getValue()) &&
									"-" !== this.documentText.charAt(D.offset)
								) {
									var I = this.fetch(d, R.fullPropertyName);
									if (I.length > 1)
										for (var P = 0; P < I.length; P++) {
											var N = I[P].node.getValue();
											N &&
												"-" !== this.documentText.charAt(N.offset) &&
												I[P] !== R &&
												this.addEntry(R.node, r.Rules.DuplicateDeclarations);
										}
								}
						}
						if (!t.getSelectors().matches(":export")) {
							for (var M = new l(), A = !1, O = 0, W = d; O < W.length; O++) {
								var L = (R = W[O]).node;
								if (this.isCSSDeclaration(L)) {
									var j = R.fullPropertyName,
										U = j.charAt(0);
									if ("-" === U) {
										if ("-" !== j.charAt(1)) {
											n.cssDataManager.isKnownProperty(j) ||
												this.validProperties[j] ||
												this.addEntry(
													L.getProperty(),
													r.Rules.UnknownVendorSpecificProperty
												);
											var V = L.getNonPrefixedPropertyName();
											M.add(V, j, L.getProperty());
										}
									} else {
										var K = j;
										("*" !== U && "_" !== U) ||
											(this.addEntry(L.getProperty(), r.Rules.IEStarHack),
											(j = j.substr(1))),
											n.cssDataManager.isKnownProperty(K) ||
												n.cssDataManager.isKnownProperty(j) ||
												this.validProperties[j] ||
												this.addEntry(
													L.getProperty(),
													r.Rules.UnknownProperty,
													a(
							...
							if (!A)
								for (var q in M.data) {
									var B = M.data[q],
										$ = B.names,
										G =
											n.cssDataManager.isStandardProperty(q) &&
											-1 === $.indexOf(q);
									if (G || 1 !== $.length) {
										for (
											var H = [], J = ((_ = 0), e.prefixes.length);
											_ < J;
											_++
										) {
											var X = e.prefixes[_];
											n.cssDataManager.isStandardProperty(X + q) &&
												H.push(X + q);
										}
										var Y = this.getMissingNames(H, $);
										if (Y || G)
											for (var Z = 0, Q = B.nodes; Z < Q.length; Z++) {
												var ee = Q[Z];
												if (G) {
													var te = a(
												...
												if (Y) {
													...
													this.addEntry(ee, r.Rules.AllVendorPrefixes, te);
												}
											}
									}
								}
					...
					(e.prototype.visitPrio = function (e) {
						return this.addEntry(e, r.Rules.AvoidImportant), !0;
					}),
					(e.prototype.visitNumericValue = function (e) {
						var t = e.findParent(i.NodeType.Function);
						if (t && "calc" === t.getName()) return !0;
						var o = e.findParent(i.NodeType.Declaration);
						if (o && o.getValue()) {
							var s = e.getValue();
							if (
								!s.unit ||
								-1 === n.units.length.indexOf(s.unit.toLowerCase())
							)
								return !0;
							0 === parseFloat(s.value) &&
								s.unit &&
								!this.validProperties[o.getFullPropertyName()] &&
								this.addEntry(e, r.Rules.ZeroWithUnit);
						}
						return !0;
					}),
					(e.prototype.visitFontFace = function (e) {
						...
						if (!t) return !1;
						for (
							var n = !1, i = !1, o = !1, s = 0, a = t.getChildren();
							s < a.length;
							s++
						) {
							var l = a[s];
							if (this.isCSSDeclaration(l)) {
								...
								"src" === c && (n = !0), "font-family" === c && (i = !0);
							} else o = !0;
						}
						return (
							o ||
								(n && i) ||
								this.addEntry(e, r.Rules.RequiredPropertiesForFontFace),
							!0
						);
					}),
					...
					(e.prototype.visitHexColorValue = function (e) {
						...
						return (
							9 !== t &&
								...
								5 !== t &&
								4 !== t &&
								this.addEntry(e, r.Rules.HexColorLength),
							!1
						);
					}),
			...
			s = (function () {
				...
				return (
					...
					(e.prototype.doValidation = function (e, t, s) {
						if ((void 0 === s && (s = this.settings), s && !1 === s.validate))
							return [];
						var a = [];
						a.push.apply(a, n.ParseErrorCollector.entries(t)),
							a.push.apply(
								a,
								i.LintVisitor.entries(
									t,
									e,
									new r.LintConfigurationSettings(s && s.lint)
								)
							);
						var l = [];
...
!(function (e) {
	...
	var n = e("./cssScanner"),
		...
		u = ".".charCodeAt(0),
		f = "@".charCodeAt(0),
		g = n.TokenType.CustomToken;
	(t.VariableName = g++),
		(t.InterpolationFunction = g++),
		(t.Default = g++),
		(t.EqualsOperator = g++),
		(t.NotEqualsOperator = g++),
		(t.GreaterEqualsOperator = g++),
		(t.SmallerEqualsOperator = g++),
		(t.Ellipsis = g++),
		(t.Module = g++),
		(t.Forward = g++),
		(t.Use = g++);
	var b = (function (e) {
		...
		return (
			__extends(g, e),
			(g.prototype.scanNext = function (r) {
				if (this.stream.advanceIfChar(a)) {
					var i = ["$"];
					if (this.ident(i))
						return this.finishToken(r, t.VariableName, i.join(""));
					this.stream.goBackTo(r);
				}
				if (this.stream.advanceIfChars([l, c]))
					return this.finishToken(r, t.InterpolationFunction);
				if (this.stream.advanceIfChars([d, d]))
					return this.finishToken(r, t.EqualsOperator);
				if (this.stream.advanceIfChars([p, d]))
					return this.finishToken(r, t.NotEqualsOperator);
				if (this.stream.advanceIfChar(h))
					return this.stream.advanceIfChar(d)
				...
				if (this.stream.advanceIfChar(m))
					return this.stream.advanceIfChar(d)
						...
						: this.finishToken(r, n.TokenType.Delim);
				if (this.stream.advanceIfChars([u, u, u]))
					return this.finishToken(r, t.Ellipsis);
				if (this.stream.advanceIfChar(f)) {
					i = ["@"];
					if (this.ident(i)) {
						var o = i.join("");
						if ("@forward" === o) return this.finishToken(r, t.Forward, o);
						if ("@use" === o) return this.finishToken(r, t.Use, o);
					}
					this.stream.goBackTo(r);
				}
				return e.prototype.scanNext.call(this, r);
			}),
			(g.prototype.comment = function () {
				return (
					!!e.prototype.comment.call(this) ||
...
!(function (e) {
	...
	var n = e("./scssScanner"),
		...
		l = (function (e) {
			...
			return (
				__extends(t, e),
				(t.prototype._parseStylesheetStart = function () {
					return (
						this._parseForward() ||
						this._parseUse() ||
						e.prototype._parseStylesheetStart.call(this)
					);
				}),
				(t.prototype._parseStylesheetStatement = function () {
					return this.peek(r.TokenType.AtKeyword)
						? this._parseWarnAndDebug() ||
								...
								e.prototype._parseStylesheetAtStatement.call(this)
				...
				(t.prototype._parseVariableDeclaration = function (e) {
					...
					for (; this.accept(r.TokenType.Exclamation); ) {
						if (!this.peekRegExp(r.TokenType.Ident, /^(default|global)$/))
							return this.finish(t, a.ParseError.UnknownKeyword);
						this.consumeToken();
					}
					return (
						this.peek(r.TokenType.SemiColon) &&
				...
				(t.prototype._parseModuleMember = function () {
					...
					return t.setIdentifier(this._parseIdent([o.ReferenceType.Module]))
						? this.hasWhitespace() ||
						  !this.acceptDelim(".") ||
						  this.hasWhitespace()
							? (this.restoreAtMark(e), null)
							...
							? t
							: this.finish(t, a.ParseError.IdentifierOrVariableExpected)
						: null;
				}),
				(t.prototype._parseIdent = function (e) {
					var t = this;
					if (
						!this.peek(r.TokenType.Ident) &&
						!this.peek(n.InterpolationFunction) &&
						!this.peekDelim("-")
					)
						return null;
					var i = this.create(o.Identifier);
					(i.referenceTypes = e),
						(i.isCustomProperty = this.peekRegExp(r.TokenType.Ident, /^--/));
					for (
						var s, a = !1;
						(this.accept(r.TokenType.Ident) ||
							i.addChild(
								((s = void 0),
								(s = t.mark()),
								t.acceptDelim("-") &&
								(t.hasWhitespace() || t.acceptDelim("-"), t.hasWhitespace())
									? (t.restoreAtMark(s), null)
									: t._parseInterpolation())
							) ||
							(a && (this.acceptDelim("-") || this.accept(r.TokenType.Num)))) &&
						((a = !0), !this.hasWhitespace());

					);
					return a ? this.finish(i) : null;
				}),
				(t.prototype._parseTerm = function () {
					var t = this.create(o.Term);
					if (t.setExpression(this._parseModuleMember())) return this.finish(t);
					var n = e.prototype._parseTerm.call(this);
					return (
						n ||
						(t.setExpression(this._parseVariable()) ||
						t.setExpression(this._parseSelectorCombinator()) ||
						t.setExpression(this._tryParsePrio())
							? this.finish(t)
							: null)
					);
				}),
					...
					if (this.peek(n.InterpolationFunction)) {
						...
						return (
							...
							e.addChild(this._parseExpr()) || this._parseSelectorCombinator()
								...
								: this.accept(r.TokenType.CurlyR)
								? this.finish(e)
								: this.finish(e, a.ParseError.ExpressionExpected)
						);
					}
					return null;
				}),
				...
				(t.prototype._parseExtends = function () {
					if (this.peekKeyword("@extend")) {
						...
						for (; this.accept(r.TokenType.Comma); )
							e.getSelectors().addChild(this._parseSimpleSelector());
						return this.accept(r.TokenType.Exclamation) &&
							!this.acceptIdent("optional")
							? this.finish(e, a.ParseError.UnknownKeyword)
							: this.finish(e);
					}
					return null;
				}),
					...
					if (this.peekDelim("&")) {
						...
						for (
							...
							(this.acceptDelim("-") ||
								...
								this.accept(r.TokenType.Dimension) ||
								e.addChild(this._parseIdent()) ||
								this.acceptDelim("&"));
				...
				(t.prototype._parseElementName = function () {
					...
					return n &&
						!this.hasWhitespace() &&
						this.peek(r.TokenType.ParenthesisL)
						? (this.restoreAtMark(t), null)
						: n;
				}),
				(t.prototype._tryParsePseudoIdentifier = function () {
					return (
						...
						e.prototype._tryParsePseudoIdentifier.call(this)
					);
				}),
							...
							? this.acceptIdent("from")
								? t.addChild(this._parseBinaryExpr())
									? this.acceptIdent("to") || this.acceptIdent("through")
										? t.addChild(this._parseBinaryExpr())
											? this._parseBody(t, e)
											: this.finish(t, a.ParseError.ExpressionExpected, [
													r.TokenType.CurlyR,
											  ])
										: this.finish(t, s.SCSSParseError.ThroughOrToExpected, [
												r.TokenType.CurlyR,
										  ])
									: this.finish(t, a.ParseError.ExpressionExpected, [
											r.TokenType.CurlyR,
									  ])
								: this.finish(t, s.SCSSParseError.FromExpected, [
										r.TokenType.CurlyR,
								  ])
							: this.finish(t, a.ParseError.VariableNameExpected, [
									r.TokenType.CurlyR,
							  ])
					);
				}),
				(t.prototype._parseEachStatement = function (e) {
					...
					if (!n.addChild(this._parseVariable()))
						return this.finish(t, a.ParseError.VariableNameExpected, [
							r.TokenType.CurlyR,
						]);
					for (; this.accept(r.TokenType.Comma); )
						if (!n.addChild(this._parseVariable()))
					...
					return (
						...
						this.acceptIdent("in")
							...
							: this.finish(t, s.SCSSParseError.InExpected, [
									r.TokenType.CurlyR,
							  ])
					);
				}),
				...
				(t.prototype._parseFunctionDeclaration = function () {
					...
					if (
						(this.consumeToken(),
						!e.setIdentifier(this._parseIdent([o.ReferenceType.Function])))
					)
				...
				(t.prototype._parseMixinDeclaration = function () {
					...
					if (
						(this.consumeToken(),
						!e.setIdentifier(this._parseIdent([o.ReferenceType.Mixin])))
					)
						return this.finish(e, a.ParseError.IdentifierExpected, [
							r.TokenType.CurlyR,
						]);
					...
					return e.setIdentifier(this._parseVariable())
						? (this.accept(n.Ellipsis),
						  ...
						  !e.setDefaultValue(this._parseExpr(!0))
								? this.finish(
										e,
										a.ParseError.VariableValueExpected,
										[],
				...
				(t.prototype._parseMixinReference = function () {
					...
					if (
						...
						(t.referenceTypes = [o.ReferenceType.Module]),
							i.setIdentifier(t),
							e.setIdentifier(n),
							e.addChild(i);
					}
					...
					if (this.peek(r.TokenType.CurlyL)) {
						var s = this.create(o.BodyDeclaration);
						this._parseBody(
							s,
				...
				(t.prototype._parseUse = function () {
					if (!this.peek(n.Use)) return null;
					...
					if (
						...
						if (!this.peekRegExp(r.TokenType.Ident, /as|with/))
							return this.finish(e, a.ParseError.UnknownKeyword);
						if (
							this.acceptIdent("as") &&
							!e.setIdentifier(this._parseIdent([o.ReferenceType.Module])) &&
							!this.acceptDelim("*")
						)
					...
					return this.accept(r.TokenType.SemiColon) ||
						this.accept(r.TokenType.EOF)
						? this.finish(e)
				...
				(t.prototype._parseModuleConfigDeclaration = function () {
					...
					return e.setIdentifier(this._parseVariable())
						? this.accept(r.TokenType.Colon) && e.setValue(this._parseExpr(!0))
							? this.finish(e)
							: this.finish(
									e,
									a.ParseError.VariableValueExpected,
				...
				(t.prototype._parseForward = function () {
					if (!this.peek(n.Forward)) return null;
					...
					if (
						...
						if (!this.peekRegExp(r.TokenType.Ident, /as|hide|show/))
							return this.finish(e, a.ParseError.UnknownKeyword);
						if (this.acceptIdent("as")) {
							...
							if (!e.setIdentifier(t))
								return this.finish(e, a.ParseError.IdentifierExpected);
							if (this.hasWhitespace() || !this.acceptDelim("*"))
								return this.finish(e, a.ParseError.WildcardExpected);
						}
						if (
							(this.peekIdent("hide") || this.peekIdent("show")) &&
							!e.addChild(this._parseForwardVisibility())
						)
							return this.finish(e, a.ParseError.IdentifierOrVariableExpected);
					}
					return this.accept(r.TokenType.SemiColon) ||
						this.accept(r.TokenType.EOF)
						? this.finish(e)
	...
	var n = e("./cssCompletion"),
		...
		s = (function (e) {
			function t(n) {
				...
				return a(t.scssModuleLoaders), a(t.scssModuleBuiltIns), r;
			}
			return (
				__extends(t, e),
				(t.prototype.isImportPathParent = function (t) {
					return (
						t === r.NodeType.Forward ||
						t === r.NodeType.Use ||
						e.prototype.isImportPathParent.call(this, t)
					);
				}),
				(t.prototype.getCompletionForImportPath = function (n, i) {
					var o,
						s = n.getParent().type;
					return (
						(s !== r.NodeType.Forward && s !== r.NodeType.Use) ||
							(o = i.items).push.apply(o, t.scssModuleBuiltIns),
						e.prototype.getCompletionForImportPath.call(this, n, i)
					);
				}),
				...
				(t.prototype.getCompletionsForSelector = function (n, r, i) {
					return (
						this.createFunctionProposals(t.selectorFuncs, null, !0, i),
						...
						n &&
							(o = o.filter(function (e) {
								return (
									!e.type ||
									!n.restrictions ||
									-1 !== n.restrictions.indexOf(e.type)
								);
							})),
				...
				(t.prototype.getCompletionsForExtendsReference = function (e, t, n) {
					for (
						var o = 0,
							s = this.getSymbolContext().findSymbolsAtOffset(
								this.offset,
								r.ReferenceType.Rule
							);
						o < s.length;
						o++
					) {
				...
				(t.prototype.getCompletionForTopLevel = function (t) {
					return (
						...
						this.getCompletionForModuleLoaders(t),
	...
	var d = (function (e) {
		...
		return (
			...
			(c.prototype.escapedJavaScript = function () {
				return this.stream.peekChar() === a
					? (this.stream.advance(1),
					  this.stream.advanceWhileChar(function (e) {
							return e !== a;
					  }),
					  this.stream.advanceIfChar(a)
							? n.TokenType.EscapedJavaScript
							: n.TokenType.BadEscapedJavaScript)
					: null;
			}),
			c
		);
...
!(function (e) {
	...
	var n = e("./lessScanner"),
		...
		a = (function (e) {
			...
			return (
				__extends(t, e),
				(t.prototype._parseStylesheetStatement = function (t) {
					return (
						void 0 === t && (t = !1),
						this.peek(r.TokenType.AtKeyword)
							? this._parseVariableDeclaration() ||
							  this._parsePlugin() ||
							  e.prototype._parseStylesheetAtStatement.call(this, t)
				...
				(t.prototype._parseImport = function () {
					...
					return e.addChild(this._parseURILiteral()) ||
						...
						? (this.peek(r.TokenType.SemiColon) ||
								...
								e.setMedialist(this._parseMediaQueryList()),
						  this.finish(e))
						: this.finish(e, s.ParseError.URIOrStringExpected, [
								r.TokenType.SemiColon,
						  ]);
				}),
				(t.prototype._parsePlugin = function () {
					...
					return (
						this.consumeToken(),
						e.addChild(this._parseStringLiteral())
							? this.accept(r.TokenType.SemiColon)
								? this.finish(e)
								: this.finish(e, s.ParseError.SemiColonExpected)
							: this.finish(e, s.ParseError.StringLiteralExpected)
					);
				}),
				...
				(t.prototype._parseDetachedRuleSet = function () {
					...
					if (this.peekDelim("#") || this.peekDelim(".")) {
						if (
							(this.consumeToken(),
							this.hasWhitespace() || !this.accept(r.TokenType.ParenthesisL))
						)
							return this.restoreAtMark(e), null;
						...
						if (t.getParameters().addChild(this._parseMixinParameter()))
							for (
								...
								t.getParameters().addChild(this._parseMixinParameter()) ||
									this.markError(
										t,
										s.ParseError.IdentifierExpected,
										[],
										[r.TokenType.ParenthesisR]
									);
						if (!this.accept(r.TokenType.ParenthesisR))
					...
					return (
						this._parseBody(n, this._parseDetachedRuleSetBody.bind(this)),
						this.finish(n)
					);
				}),
				...
				(t.prototype._addLookupChildren = function (e) {
					...
					for (
						var t = !1;
						this.peek(r.TokenType.BracketL) && (t = !0),
				...
				(t.prototype._parseVariable = function (e, t) {
					...
					if (!this.peekDelim("@") && !n && !this.peek(r.TokenType.AtKeyword))
						return null;
					for (
						var i = this.create(o.Variable), s = this.mark();
						this.acceptDelim("@") || (!e && this.acceptDelim("$"));

					)
						if (this.hasWhitespace()) return this.restoreAtMark(s), null;
					return (this.accept(r.TokenType.AtKeyword) ||
						this.accept(r.TokenType.Ident)) &&
						(t ||
							!this.peek(r.TokenType.BracketL) ||
							this._addLookupChildren(i))
						? i
				...
				(t.prototype._parseTerm = function () {
					...
					return (
						t ||
						((t = this.create(o.Term)).setExpression(this._parseVariable()) ||
						t.setExpression(this._parseEscaped()) ||
						t.setExpression(this._tryParseMixinReference(!1))
							? this.finish(t)
							: null)
					);
				}),
				(t.prototype._parseEscaped = function () {
					if (
						this.peek(r.TokenType.EscapedJavaScript) ||
						this.peek(r.TokenType.BadEscapedJavaScript)
					) {
					...
					if (this.peekDelim("~")) {
						...
						return (
							this.consumeToken(),
							this.accept(r.TokenType.String) ||
							this.accept(r.TokenType.EscapedJavaScript)
								? this.finish(e)
								: this.finish(e, s.ParseError.TermExpected)
						);
					}
					return null;
				}),
				...
				(t.prototype._parseKeyframeIdent = function () {
					return (
						this._parseIdent([o.ReferenceType.Keyframe]) ||
						this._parseVariable()
					);
				}),
				(t.prototype._parseKeyframeSelector = function () {
					return (
						this._parseDetachedRuleSetMixin() ||
						e.prototype._parseKeyframeSelector.call(this)
					);
				}),
				(t.prototype._parseSimpleSelectorBody = function () {
					return (
				...
				(t.prototype._parseSelector = function (e) {
					...
					for (
						...
						n = !0;
						var i = this.mark();
						if (t.addChild(this._parseGuard()) && this.peek(r.TokenType.CurlyL))
							break;
				...
				(t.prototype._parsePropertyIdentifier = function (e) {
					...
					if (
						...
						!this.peekRegExp(this.token.type, t)
					)
						return null;
					var n = this.mark(),
				...
				(t.prototype._acceptInterpolatedIdent = function (e, t) {
					for (
						...
						(s() || e.addChild(this._parseInterpolation() || this.try(o))) &&
					...
					if (this.peekDelim("@") || this.peekDelim("$")) {
						...
						return (
							...
							this.hasWhitespace() || !this.accept(r.TokenType.CurlyL)
								...
								? this.accept(r.TokenType.CurlyR)
									? this.finish(t)
									: this.finish(t, s.ParseError.RightCurlyExpected)
				...
				(t.prototype._completeExtends = function (e) {
					if (!this.accept(r.TokenType.ParenthesisL))
						return this.finish(e, s.ParseError.LeftParenthesisExpected);
					var t = e.getSelectors();
					if (!t.addChild(this._parseSelector(!0)))
						return this.finish(e, s.ParseError.SelectorExpected);
					for (; this.accept(r.TokenType.Comma); )
						if (!t.addChild(this._parseSelector(!0)))
							return this.finish(e, s.ParseError.SelectorExpected);
					return this.accept(r.TokenType.ParenthesisR)
				...
				(t.prototype._parseDetachedRuleSetMixin = function () {
					...
					return !t.addChild(this._parseVariable(!0)) ||
						...
						? this.accept(r.TokenType.ParenthesisR)
							? this.finish(t)
							: this.finish(t, s.ParseError.RightParenthesisExpected)
						: (this.restoreAtMark(e), null);
				}),
				(t.prototype._tryParseMixinReference = function (e) {
					...
					if (!this.hasWhitespace() && this.accept(r.TokenType.ParenthesisL)) {
						if (
							((l = !0), n.getArguments().addChild(this._parseMixinArgument()))
						)
							for (
								;
								(this.accept(r.TokenType.Comma) ||
				...
				(t.prototype._parseMixinParameter = function () {
					...
					return (
						e.setIdentifier(this._parseVariable()) &&
							(this.accept(r.TokenType.Colon), (a = !0)),
						e.setDefaultValue(
				...
				(t.prototype._parseFunctionIdentifier = function () {
					if (this.peekDelim("%")) {
						...
						return (
							(t.referenceTypes = [o.ReferenceType.Function]),
							this.consumeToken(),
							this.finish(t)
						);
					}
		...
		t.getFoldingRanges = function (e, t) {
			return (function (e, t) {
				...
				(function (e) {
					...
					(c.ignoreComment = !1), c.setSource(e.getText());
					var d = c.scan(),
						p = null,
						h = function () {
							switch (d.type) {
								...
								case r.InterpolationFunction:
									l.push({ line: t(d), type: "brace", isStart: !0 });
									break;
								case n.TokenType.CurlyR:
									if (0 !== l.length) {
										if (!(u = o(l, "brace"))) break;
										var i = s(d);
										"brace" === u.type &&
											(p && s(p) !== i && i--,
											u.line !== i &&
								...
								case n.TokenType.Comment:
									var h = function (e) {
											return "#region" === e
												? { line: t(d), type: "comment", isStart: !0 }
												: { line: s(d), type: "comment", isStart: !1 };
										},
										m = (function (t) {
											var n = t.text.match(
									...
									if (m)
										if (m.isStart) l.push(m);
										else {
											var u;
											if (!(u = o(l, "comment"))) break;
											"comment" === u.type &&
												u.line !== m.line &&
												a.push({
													startLine: u.line,
	...
	(function (e) {
		...
		t.getSelectionRanges = function (e, t, i) {
			return t.map(function (t) {
				for (
					var o = (function (t) {
							var n = i.findChildAtOffset(e.offsetAt(t), !0);
							if (!n) return [];
							var o = [];
							for (; n; )
								n.parent &&
								n.offset === n.parent.offset &&
								n.end === n.parent.end
									? (n = n.parent)
									: (n.type === r.NodeType.Declarations
											? o.push([n.offset + 1, n.end - 1])
											: o.push([n.offset, n.end]),
									  (n = n.parent));
							return o;
						})(t),
						s = void 0,
					...
					s = n.SelectionRange.create(
						n.Range.create(e.positionAt(o[a][0]), e.positionAt(o[a][1])),
						s
					);
	...
	var l = "/",
		...
		d = (function () {
			...
			return (
				...
				(e.file = function (e) {
					var t = "";
					if ((r && (e = e.replace(/\\/g, l)), e[0] === l && e[1] === l)) {
						var n = e.indexOf(l, 2);
						-1 === n
							? ((t = e.substring(2)), (e = l))
...
!(function (e) {
	if ("object" == typeof module && "object" == typeof module.exports) {
		...
		"function" == typeof define &&
			define.amd &&
			define(
				"vscode-css-languageservice/services/scssNavigation",
				[
					"require",
					"exports",
					"./cssNavigation",
	...
	var n = e("./cssNavigation"),
		...
		s = (function (e) {
			function t(t) {
				var n = e.call(this) || this;
				return (n.fileSystemProvider = t), n;
			}
			return (
				__extends(t, e),
				(t.prototype.isRawStringDocumentLinkNode = function (t) {
					return (
						e.prototype.isRawStringDocumentLinkNode.call(this, t) ||
						t.type === i.NodeType.Use ||
						t.type === i.NodeType.Forward
					);
				}),
				(t.prototype.findDocumentLinks2 = function (e, t, n) {
					return __awaiter(this, void 0, void 0, function () {
						function i(e) {
							return __awaiter(this, void 0, void 0, function () {
								var t;
								return __generator(this, function (n) {
									switch (n.label) {
										case 0:
											...
											n.label = 1;
										case 1:
											return n.trys.push([1, 3, , 4]), [4, a.stat(e)];
										case 2:
											return (t = n.sent()).type === r.FileType.Unknown &&
												-1 === t.size
												? [2, !1]
												: [2, !0];
										case 3:
						...
						return __generator(this, function (r) {
							switch (r.label) {
								case 0:
									if (
										((s = this.findDocumentLinks(e, t, n)),
										(a = this.fileSystemProvider),
										(l = []),
										!a)
									)
										return [3, 9];
									(c = 0), (r.label = 1);
								case 1:
									if (!(c < s.length)) return [3, 8];
									if (!(d = s[c].target)) return [3, 7];
									p = null;
									try {
										p = o.URI.parse(d);
									} catch (e) {
										if (e instanceof URIError) return [3, 7];
										throw e;
									}
									return (h = (function (e) {
										if (
											...
											if (e.path.endsWith("/"))
												return [
													e.with({ path: e.path + "index.scss" }).toString(),
													e.with({ path: e.path + "_index.scss" }).toString(),
												];
											var t = e.path.split("/"),
												n = t[t.length - 1],
												r = e.path.slice(0, -n.length);
											if (n.startsWith("_"))
												return e.path.endsWith(".scss")
													? void 0
													: [e.with({ path: e.path + ".scss" }).toString()];
											var i = n + ".scss",
												o = function (t) {
													return e.with({ path: r + t }).toString();
												};
											return [
												o(i),
												o("_" + i),
												o(i.slice(0, -5) + "/index.scss"),
												o(i.slice(0, -5) + "/_index.scss"),
												o(i.slice(0, -5) + ".css"),
											];
										}
									})(p))
										...
										: [4, i(d)];
								case 2:
									return r.sent() && l.push(s[c]), [3, 7];
								case 3:
									(m = 0), (r.label = 4);
								case 4:
									return m < h.length ? [4, i(h[m])] : [3, 7];
								case 5:
									if (r.sent())
										return (
											l.push(__assign(__assign({}, s[c]), { target: h[m] })),
											[3, 7]
										);
									r.label = 6;
								case 6:
	...
	(function (e) {
		...
		var n = e("./parser/cssParser"),
			...
			u = e("./services/cssSelectionRange"),
			f = e("./services/scssNavigation");
		function g(e, t, n, r, i, o) {
			return {
				configure: function (e) {
					o.configure(e), t.configure(e);
				},
		...
		function b(e) {
			e &&
				...
				m.cssDataManager.addDataProviders(e.customDataProviders);
		}
		!(function (e) {
			for (var n in e) t.hasOwnProperty(n) || (t[n] = e[n]);
		})(e("./cssLanguageTypes")),
			(t.getCSSLanguageService = function (e) {
				return (
					...
					g(
						new n.Parser(),
						new r.CSSCompletion(null, e && e.clientCapabilities),
						new i.CSSHover(e && e.clientCapabilities),
						new o.CSSNavigation(),
						new s.CSSCodeActions(),
						new a.CSSValidation()
					)
				);
			}),
			(t.getSCSSLanguageService = function (e) {
				return (
					...
					g(
						new l.SCSSParser(),
						new c.SCSSCompletion(e && e.clientCapabilities),
						new i.CSSHover(e && e.clientCapabilities),
						new f.SCSSNavigation(e && e.fileSystemProvider),
						new s.CSSCodeActions(),
						new a.CSSValidation()
					)
				);
			...
			(t.getLESSLanguageService = function (e) {
				return (
					...
					g(
						new d.LESSParser(),
						new p.LESSCompletion(e && e.clientCapabilities),
						new i.CSSHover(e && e.clientCapabilities),
						new o.CSSNavigation(),
						new s.CSSCodeActions(),
						new a.CSSValidation()
	...
	define(
		...
		["require", "exports", "vscode-css-languageservice"],
		function (e, t, n) {
			"use strict";
			Object.defineProperty(t, "__esModule", { value: !0 });
			var r = (function () {
