...
define(
	...
	(function (e) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			...
			(function (e) {
				(e.create = function (e, t, i, r) {
					if (y.number(e) && y.number(t) && y.number(i) && y.number(r))
					...
					(e.is = function (e) {
						var t = e;
						return y.objectLiteral(t) && n.is(t.start) && n.is(t.end);
					});
			})((i = t.Range || (t.Range = {}))),
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						...
						return (
							...
							(i.is(t.targetSelectionRange) ||
								y.undefined(t.targetSelectionRange)) &&
			...
			(function (e) {
				(e.create = function (e, t, n) {
					...
					(e.is = function (e) {
						...
						return (
							y.string(t.label) &&
							(y.undefined(t.textEdit) || c.is(t)) &&
							(y.undefined(t.additionalTextEdits) ||
								y.typedArray(t.additionalTextEdits, c.is))
						);
					});
			...
			(function (e) {
				(e.create = function (e, t, n, i, r) {
					...
					return (
						y.defined(n) && (a.startCharacter = n),
						y.defined(i) && (a.endCharacter = i),
						y.defined(r) && (a.kind = r),
						a
					);
				}),
					(e.is = function (e) {
			...
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						var t = e;
						return y.defined(t) && r.is(t.location) && y.string(t.message);
					});
			})(
				(o =
			...
			(function (e) {
				(e.create = function (e, t, n, i, r, a) {
					...
					return (
						...
						y.defined(i) && (o.code = i),
						y.defined(r) && (o.source = r),
					...
					(e.is = function (e) {
						...
						return (
							...
							(y.undefined(t.relatedInformation) ||
								y.typedArray(t.relatedInformation, o.is))
						);
					});
			...
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						var t = e;
						return (
							y.defined(t) && f.is(t.textDocument) && Array.isArray(t.edits)
						);
					});
			})((d = t.TextDocumentEdit || (t.TextDocumentEdit = {}))),
			(function (e) {
				(e.create = function (e, t) {
						...
						(void 0 === t.documentChanges ||
							t.documentChanges.every(function (e) {
								return y.string(e.kind)
									? h.is(e) || u.is(e) || p.is(e)
									: d.is(e);
							}))
					);
				};
			})((m = t.WorkspaceEdit || (t.WorkspaceEdit = {})));
		var f,
			g,
			b,
			_,
				...
				return (
					...
					(e.prototype.createFile = function (e, t) {
						this.checkDocumentChanges(),
							this._workspaceEdit.documentChanges.push(h.create(e, t));
					}),
					(e.prototype.renameFile = function (e, t, n) {
						this.checkDocumentChanges(),
							this._workspaceEdit.documentChanges.push(u.create(e, t, n));
					}),
		...
		(t.WorkspaceChange = w),
			...
			(function (e) {
				e.is = function (e) {
					var t = e;
					return y.objectLiteral(e) && g.is(t.kind) && y.string(t.value);
				};
			})((b = t.MarkupContent || (t.MarkupContent = {}))),
			(function (e) {
				(e.Text = 1),
					(e.Method = 2),
					(e.Function = 3),
			...
			})((_ = t.MarkedString || (t.MarkedString = {}))),
			(function (e) {
				e.is = function (e) {
					var t = e;
					return (
			...
			(function (e) {
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						...
						return (
							y.defined(t) &&
							y.typedArray(t.diagnostics, s.is) &&
				...
				(e.create = function (e, t, n) {
					...
					(e.is = function (e) {
						...
						return (
							t &&
							y.string(t.title) &&
							(void 0 === t.diagnostics || y.typedArray(t.diagnostics, s.is)) &&
							(void 0 === t.kind || y.string(t.kind)) &&
							(void 0 !== t.edit || void 0 !== t.command) &&
							(void 0 === t.command || l.is(t.command)) &&
							(void 0 === t.isPreferred || y.boolean(t.isPreferred)) &&
				...
				(e.create = function (e, t) {
					...
					(e.is = function (e) {
						...
						return (
							y.defined(t) &&
							i.is(t.range) &&
							(y.undefined(t.command) || l.is(t.command))
						);
					});
	...
	(function (e) {
		...
		t.createScanner = function (e, t, n) {
			...
			var m,
				...
				y = n,
				T = 0,
				k = i.TokenType.Unknown;
			function S() {
				return w.advanceIfRegExp(/^[_:\w][_:\w-.\d]*/).toLowerCase();
			}
			function x(e, t, n) {
				return (k = t), (T = e), (m = n), t;
			}
			return {
				scan: function () {
					var e = w.pos(),
						...
						n = (function e() {
							var t,
								n = w.pos();
							if (w.eos()) return x(n, i.TokenType.EOS);
							switch (y) {
								case i.ScannerState.WithinComment:
									return w.advanceIfChars([s, s, c])
										? ((y = i.ScannerState.WithinContent),
										  x(n, i.TokenType.EndCommentTag))
										: (w.advanceUntilChars([s, s, c]),
										  x(n, i.TokenType.Comment));
								case i.ScannerState.WithinDoctype:
									return w.advanceIfChar(c)
										? ((y = i.ScannerState.WithinContent),
										  x(n, i.TokenType.EndDoctypeTag))
										: (w.advanceUntilChar(c), x(n, i.TokenType.Doctype));
								case i.ScannerState.WithinContent:
									if (w.advanceIfChar(l)) {
										if (!w.eos() && w.peekChar() === o) {
											if (w.advanceIfChars([o, s, s]))
												return (
													(y = i.ScannerState.WithinComment),
													x(n, i.TokenType.StartCommentTag)
												);
											if (w.advanceIfRegExp(/^!doctype/i))
												return (
													(y = i.ScannerState.WithinDoctype),
													x(n, i.TokenType.StartDoctypeTag)
												);
										}
										return w.advanceIfChar(d)
											? ((y = i.ScannerState.AfterOpeningEndTag),
											  x(n, i.TokenType.EndTagOpen))
											: ((y = i.ScannerState.AfterOpeningStartTag),
											  x(n, i.TokenType.StartTagOpen));
									}
									return w.advanceUntilChar(l), x(n, i.TokenType.Content);
								case i.ScannerState.AfterOpeningEndTag:
									return S().length > 0
										? ((y = i.ScannerState.WithinEndTag),
										  x(n, i.TokenType.EndTag))
										: w.skipWhitespace()
										? x(
												n,
								...
								case i.ScannerState.WithinEndTag:
									if (w.skipWhitespace()) return x(n, i.TokenType.Whitespace);
									if (w.advanceIfChar(c))
										return (
											(y = i.ScannerState.WithinContent),
											x(n, i.TokenType.EndTagClose)
										);
									t = r("error.tagNameExpected", "Closing bracket expected.");
									break;
								case i.ScannerState.AfterOpeningStartTag:
									return (
										...
										g.length > 0
											? ((f = !1),
											  (y = i.ScannerState.WithinTag),
											  x(n, i.TokenType.StartTag))
											: w.skipWhitespace()
											? x(
													n,
													i.TokenType.Whitespace,
								...
								case i.ScannerState.WithinTag:
									return w.skipWhitespace()
										? ((f = !0), x(n, i.TokenType.Whitespace))
										: f &&
										  (b = w
												.advanceIfRegExp(/^[^\s"'>/=\x00-\x0F\x7F\x80-\x9F]*/)
												.toLowerCase()).length > 0
										? ((y = i.ScannerState.AfterAttributeName),
										  (f = !1),
										  x(n, i.TokenType.AttributeName))
										: w.advanceIfChars([d, c])
										? ((y = i.ScannerState.WithinContent),
										  x(n, i.TokenType.StartTagSelfClose))
										: w.advanceIfChar(c)
										? ((y =
												"script" === g
													? _ && v[_]
								...
								case i.ScannerState.AfterAttributeName:
									return w.skipWhitespace()
										? ((f = !0), x(n, i.TokenType.Whitespace))
										: w.advanceIfChar(h)
										? ((y = i.ScannerState.BeforeAttributeValue),
										  x(n, i.TokenType.DelimiterAssign))
										: ((y = i.ScannerState.WithinTag), e());
								case i.ScannerState.BeforeAttributeValue:
									if (w.skipWhitespace()) return x(n, i.TokenType.Whitespace);
									var a = w.advanceIfRegExp(/^[^\s"'`=<>]+/);
									if (a.length > 0)
										return (
											w.peekChar() === c &&
												w.peekChar(-1) === d &&
												(w.goBack(1), (a = a.substr(0, a.length - 1))),
											"type" === b && (_ = a),
											(y = i.ScannerState.WithinTag),
											(f = !1),
											x(n, i.TokenType.AttributeValue)
										);
									var m = w.peekChar();
									return m === p || m === u
										? (w.advance(1),
										  w.advanceUntilChar(m) && w.advance(1),
										  "type" === b &&
												(_ = w.getSource().substring(n + 1, w.pos() - 1)),
										  (y = i.ScannerState.WithinTag),
										  (f = !1),
										  x(n, i.TokenType.AttributeValue))
										: ((y = i.ScannerState.WithinTag), (f = !1), e());
								case i.ScannerState.WithinScriptContent:
									for (var T = 1; !w.eos(); ) {
										var k = w.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
										if (0 === k.length)
											return w.goToEnd(), x(n, i.TokenType.Script);
										if ("\x3c!--" === k) 1 === T && (T = 2);
										else if ("--\x3e" === k) T = 1;
										else if ("/" !== k[1]) 2 === T && (T = 3);
										else {
									...
									return (
										(y = i.ScannerState.WithinContent),
										n < w.pos() ? x(n, i.TokenType.Script) : e()
									);
								case i.ScannerState.WithinStyleContent:
									return (
										w.advanceUntilRegExp(/<\/style/i),
										(y = i.ScannerState.WithinContent),
										n < w.pos() ? x(n, i.TokenType.Styles) : e()
									);
							}
							return (
								w.advance(1),
								(y = i.ScannerState.WithinContent),
								x(n, i.TokenType.Unknown, t)
							);
						})();
					return n !== i.TokenType.EOS && e === w.pos()
						? (console.log(
				...
				getTokenText: function () {
					return w.getSource().substring(T, w.pos());
				},
			...
			o = (function () {
				...
				return (
					...
					(e.prototype.findNodeBefore = function (e) {
						var t =
							i.findFirst(this.children, function (t) {
								return e <= t.start;
							}) - 1;
						if (t >= 0) {
	...
	(function (e) {
		...
		(t.HTMLDataProvider = i),
			(t.generateDocumentation = function (e, t) {
				var i = { kind: t ? "markdown" : "plaintext", value: "" };
				if (e.description) {
					var r = n.normalizeMarkupContent(e.description);
					r && (i.value += r.value);
				}
				return (
					e.references &&
	...
	(function (e) {
		...
		t.builtinDataProviders = [new n.HTMLDataProvider("html5", i.htmlData)];
		var r = [];
		(t.getAllDataProviders = function () {
			return t.builtinDataProviders.concat(r);
		}),
	...
	(function (e) {
		...
		var n = e("vscode-languageserver-types"),
			...
			r = e("../htmlLanguageTypes"),
			a = e("../parser/htmlEntities"),
			o = e("vscode-nls"),
			s = e("../utils/strings"),
			l = e("../languageFacts/builtinDataProviders"),
			c = e("../languageFacts/fact"),
			d = e("../utils/object"),
			h = e("../languageFacts/dataProvider"),
			u = o.loadMessageBundle(),
			p = (function () {
				function e(e) {
					(this.clientCapabilities = e), (this.completionParticipants = []);
				}
				return (
					...
					(e.prototype._doComplete = function (e, t, o, d) {
						var p = { isIncomplete: !1, items: [] },
							g = this.completionParticipants,
							b = l.getAllDataProviders().filter(function (t) {
								return (
									t.isApplicable(e.languageId) && (!d || !1 !== d[t.getId()])
								);
							}),
							_ = this.doesSupportMarkdown(),
							v = e.getText(),
							w = e.offsetAt(t),
							y = o.findNodeBefore(w);
						if (!y) return p;
						var T,
							k = i.createScanner(v, y.start),
							S = "";
						function x(t, n) {
							return (
								void 0 === n && (n = w),
							...
							return (
								b.forEach(function (e) {
									e.provideTags().forEach(function (e) {
										p.items.push({
											label: e.name,
											kind: n.CompletionItemKind.Property,
											documentation: h.generateDocumentation(e, _),
											textEdit: n.TextEdit.replace(i, e.name),
											insertTextFormat: n.InsertTextFormat.PlainText,
										});
									});
								}),
								p
						...
						function M(e) {
							for (var t = e; t > 0; ) {
								var n = v.charAt(t - 1);
								if ("\n\r".indexOf(n) >= 0) return v.substring(t, e);
								if (!m(n)) return null;
								t--;
							}
							return v.substring(0, e);
						}
						function E(e, t, i) {
							void 0 === i && (i = w);
							var a = x(e, i),
							...
							for (t && (s = s.parent); s; ) {
								var l = s.tag;
								if (l && (!s.closed || (s.endTagStart && s.endTagStart > w))) {
									var c = {
											label: "/" + l,
											kind: n.CompletionItemKind.Property,
											filterText: "/" + l,
											textEdit: n.TextEdit.replace(a, "/" + l + o),
											insertTextFormat: n.InsertTextFormat.PlainText,
										},
										d = M(s.start),
										u = M(e - 1);
									if (null !== d && null !== u && d !== u) {
										var m = d + "</" + l + o;
										(c.textEdit = n.TextEdit.replace(x(e - 1 - u.length), m)),
											(c.filterText = u + "</" + l);
									}
									return p.items.push(c), p;
								}
								s = s.parent;
							}
							return t
								...
								: (b.forEach(function (e) {
										e.provideTags().forEach(function (e) {
											p.items.push({
												...
												documentation: h.generateDocumentation(e, _),
												filterText: "/" + e + o,
												textEdit: n.TextEdit.replace(a, "/" + e + o),
												insertTextFormat: n.InsertTextFormat.PlainText,
											});
										});
								  }),
						...
						function A(t, i) {
							if (d && d.hideAutoCompleteProposals) return p;
							if (!c.isVoidElement(i)) {
								var r = e.positionAt(t);
								p.items.push({
									label: "</" + i + ">",
									kind: n.CompletionItemKind.Property,
									filterText: "</" + i + ">",
									textEdit: n.TextEdit.insert(r, "$0</" + i + ">"),
									insertTextFormat: n.InsertTextFormat.Snippet,
								});
							}
							return p;
						}
						function R(e, t) {
							return L(e, t), E(e, !0, t), p;
						}
						function I(e, t) {
							void 0 === t && (t = w);
							for (var i = w; i < t && "<" !== v[i]; ) i++;
							var a = x(e, i),
								l = f(
									v,
									t,
									r.ScannerState.AfterAttributeName,
							...
							return (
								b.forEach(function (e) {
									e.provideAttributes(c).forEach(function (e) {
										if (!d[e.name]) {
											d[e.name] = !0;
											var t,
												i = e.name;
												...
												p.items.push({
													...
													kind:
														"handler" === e.valueSet
															...
															: n.CompletionItemKind.Value,
													documentation: h.generateDocumentation(e, _),
													textEdit: n.TextEdit.replace(a, i),
													insertTextFormat: n.InsertTextFormat.Snippet,
													command: t,
												});
										}
								...
								(function (e, t) {
									...
									Object.keys(i).forEach(function (t) {
										return p.items.push({
											label: t,
											kind: n.CompletionItemKind.Value,
											textEdit: n.TextEdit.replace(e, i[t]),
											insertTextFormat: n.InsertTextFormat.Snippet,
										});
									});
								})(a, d),
						...
						function C(i, r) {
							...
							if (
								...
								(a = x(u, f)),
									(s = w >= c && w <= d ? v.substring(c, w) : ""),
									(o = !1);
							} else (a = x(i, r)), (s = v.substring(i, w)), (o = !0);
							var y = S.toLowerCase(),
								k = T.toLowerCase();
							if (g.length > 0)
								for (var L = x(i, r), M = 0, E = g; M < E.length; M++) {
									var A = E[M];
							...
							return (
								b.forEach(function (e) {
									e.provideValues(y, k).forEach(function (e) {
										var t = o ? '"' + e.name + '"' : e.name;
										p.items.push({
											label: e.name,
											filterText: t,
											kind: n.CompletionItemKind.Unit,
											documentation: h.generateDocumentation(e, _),
											textEdit: n.TextEdit.replace(a, t),
											insertTextFormat: n.InsertTextFormat.PlainText,
										});
									});
								}),
						...
						function U() {
							for (
								var e = w - 1, i = t.character;
								e >= 0 && s.isLetterOrDigit(v, e);

							)
								e--, i--;
							if (e >= 0 && "&" === v[e]) {
								var r = n.Range.create(n.Position.create(t.line, i - 1), t);
								for (var o in a.entities)
									if (s.endsWith(o, ";")) {
										var l = "&" + o;
										p.items.push({
											label: l,
											...
											documentation: u(
												"entity.propose",
												"Character entity representing '" + a.entities[o] + "'"
											),
											textEdit: n.TextEdit.replace(r, l),
											insertTextFormat: n.InsertTextFormat.PlainText,
										});
									}
							}
						...
						for (
							var W, D = k.scan();
							D !== r.TokenType.EOS && k.getTokenOffset() <= w;

						) {
							switch (D) {
								case r.TokenType.StartTagOpen:
									if (k.getTokenEnd() === w) {
										var P = z(r.TokenType.StartTag);
										return (
											0 === t.line &&
												((W = void 0),
												(W = x(w, P)),
												p.items.push({
													...
													textEdit: n.TextEdit.replace(W, "!DOCTYPE html>"),
													insertTextFormat: n.InsertTextFormat.PlainText,
												})),
											R(w, P)
										);
									...
									break;
								case r.TokenType.StartTag:
									if (k.getTokenOffset() <= w && w <= k.getTokenEnd())
										return L(k.getTokenOffset(), k.getTokenEnd());
									S = k.getTokenText();
									break;
								case r.TokenType.AttributeName:
									if (k.getTokenOffset() <= w && w <= k.getTokenEnd())
										return I(k.getTokenOffset(), k.getTokenEnd());
									T = k.getTokenText();
									break;
								case r.TokenType.DelimiterAssign:
									if (k.getTokenEnd() === w) {
										P = z(r.TokenType.AttributeValue);
										return C(w, P);
									}
									break;
								case r.TokenType.AttributeValue:
									if (k.getTokenOffset() <= w && w <= k.getTokenEnd())
										return C(k.getTokenOffset(), k.getTokenEnd());
									break;
								case r.TokenType.Whitespace:
									if (w <= k.getTokenEnd())
										switch (k.getScannerState()) {
											case r.ScannerState.AfterOpeningStartTag:
												return R(k.getTokenOffset(), z(r.TokenType.StartTag));
											case r.ScannerState.WithinTag:
											case r.ScannerState.AfterAttributeName:
												return I(k.getTokenEnd());
											case r.ScannerState.BeforeAttributeValue:
												return C(k.getTokenEnd());
											case r.ScannerState.AfterOpeningEndTag:
												return E(k.getTokenOffset() - 1, !1);
											case r.ScannerState.WithinContent:
												return H();
										}
									break;
								case r.TokenType.EndTagOpen:
									if (w <= k.getTokenEnd())
										return E(k.getTokenOffset() + 1, !1, z(r.TokenType.EndTag));
									break;
								case r.TokenType.EndTag:
									if (w <= k.getTokenEnd())
										for (var q = k.getTokenOffset() - 1; q >= 0; ) {
											var O = v.charAt(q);
											if ("/" === O) return E(q, !1, k.getTokenEnd());
											if (!m(O)) break;
											q--;
										}
									break;
								case r.TokenType.StartTagClose:
									if (w <= k.getTokenEnd() && S) return A(k.getTokenEnd(), S);
									break;
								case r.TokenType.Content:
									if (w <= k.getTokenEnd()) return H();
									break;
								default:
									if (w <= k.getTokenEnd()) return p;
							}
							D = k.scan();
						}
						return p;
					...
					(e.prototype.doTagComplete = function (e, t, n) {
						...
						if (">" === o) {
							if (
								(l = n.findNodeBefore(a)) &&
								l.tag &&
								!c.isVoidElement(l.tag) &&
								l.start < a &&
								(!l.endTagStart || l.endTagStart > a)
							)
								for (
									var s = (d = i.createScanner(e.getText(), l.start)).scan();
									s !== r.TokenType.EOS && d.getTokenEnd() <= a;

								) {
									if (s === r.TokenType.StartTagClose && d.getTokenEnd() === a)
										return "$0</" + l.tag + ">";
									s = d.scan();
								}
						} else if ("/" === o) {
							for (var l = n.findNodeBefore(a); l && l.closed; ) l = l.parent;
							if (l && l.tag) {
								var d;
								for (
									s = (d = i.createScanner(e.getText(), l.start)).scan();
									s !== r.TokenType.EOS && d.getTokenEnd() <= a;

								) {
									if (s === r.TokenType.EndTagOpen && d.getTokenEnd() === a)
										return l.tag + ">";
									s = d.scan();
								}
							}
					...
					(e.prototype.doesSupportMarkdown = function () {
						if (!d.isDefined(this.supportsMarkdown)) {
							if (!d.isDefined(this.clientCapabilities))
							...
							this.supportsMarkdown =
								...
								-1 !== e.contentFormat.indexOf(n.MarkupKind.Markdown);
						}
		...
		function f(e, t, n, a) {
			for (
				var o = i.createScanner(e, t, n), s = o.scan();
				s === r.TokenType.Whitespace;
	...
	(function (e) {
		...
		var n = e("../parser/htmlScanner"),
			...
			r = e("../htmlLanguageTypes"),
			a = e("../languageFacts/builtinDataProviders"),
			o = e("../utils/object"),
			s = e("../languageFacts/dataProvider"),
			l = (function () {
				function e(e) {
				...
				return (
					(e.prototype.doHover = function (e, t, i) {
						var o = this.convertContents.bind(this),
							l = this.doesSupportMarkdown(),
							c = e.offsetAt(t),
							d = i.findNodeAt(c);
						if (!d || !d.tag) return null;
						var h = a.getAllDataProviders().filter(function (t) {
						...
						function u(e, t, n) {
							...
							for (
								var i = function (i) {
										var r = null;
										if (
											(i.provideTags().forEach(function (i) {
												if (i.name.toLowerCase() === e.toLowerCase()) {
													var a = n ? "<" + e + ">" : "</" + e + ">",
														o = s.generateDocumentation(i, l);
													(o.value = "```html\n" + a + "\n```\n" + o.value),
														(r = { contents: o, range: t });
												}
											}),
											r)
										)
											return (r.contents = o(r.contents)), { value: r };
									},
									r = 0,
									a = h;
								r < a.length;
						...
						function p(t, i) {
							for (
								var a = n.createScanner(e.getText(), i), o = a.scan();
								o !== r.TokenType.EOS &&
								(a.getTokenEnd() < c || (a.getTokenEnd() === c && o !== t));

							)
								o = a.scan();
							return o === t && c <= a.getTokenEnd()
								? {
						...
						if (d.endTagStart && c >= d.endTagStart) {
							var m = p(r.TokenType.EndTag, d.endTagStart);
							return m ? u(d.tag, m, !1) : null;
						}
						var f = p(r.TokenType.StartTag, d.start);
						if (f) return u(d.tag, f, !0);
						var g = p(r.TokenType.AttributeName, d.start);
						if (g)
							return (function (e, t, n) {
											...
											if (
												(i.provideAttributes(e).forEach(function (e) {
													t === e.name &&
														e.description &&
														(r = {
															contents: s.generateDocumentation(e, l),
															range: n,
														});
												}),
												r)
								...
								return null;
							})((_ = d.tag), e.getText(g), g);
						var b = p(r.TokenType.AttributeValue, d.start);
						if (b) {
							var _ = d.tag,
								v = (function (e) {
								...
								w = (function (t, i) {
									for (
										var a = n.createScanner(e.getText(), t),
											o = a.scan(),
											s = void 0;
										o !== r.TokenType.EOS && a.getTokenEnd() <= i;

									)
										(o = a.scan()) === r.TokenType.AttributeName &&
											(s = a.getTokenText());
									return s;
								})(d.start, e.offsetAt(b.start));
							if (w)
									...
									for (
										var r = function (r) {
												...
												if (
													...
													return (a.contents = o(a.contents)), { value: a };
											},
											a = 0,
											c = h;
										a < c.length;
					...
					(e.prototype.doesSupportMarkdown = function () {
						if (!o.isDefined(this.supportsMarkdown)) {
							if (!o.isDefined(this.clientCapabilities))
								return (this.supportsMarkdown = !0), this.supportsMarkdown;
							var e =
								this.clientCapabilities &&
								this.clientCapabilities.textDocument &&
							...
							this.supportsMarkdown =
								...
								e.contentFormat &&
								Array.isArray(e.contentFormat) &&
								-1 !== e.contentFormat.indexOf(i.MarkupKind.Markdown);
						}
						return this.supportsMarkdown;
					}),
					e
			...
			function (e, t, n) {
				...
				(m.prototype._get_tag_open_token = function (e) {
					...
					return (
						...
						(t.is_inline_element =
							h(t.tag_name, this._options.inline) || "{" === t.tag_start_char),
						t
					);
				}),
	...
	(function (e) {
		...
		t.format = function (e, t, c) {
			var d = e.getText(),
				h = !0,
				u = 0,
				p = c.tabSize || 4;
			if (t) {
				for (var m = e.offsetAt(t.start), f = m; f > 0 && l(d, f - 1); ) f--;
				0 === f || s(d, f - 1) ? (m = f) : f < m && (m = f + 1);
				for (var g = e.offsetAt(t.end), b = g; b < d.length && l(d, b); ) b++;
				(b === d.length || s(d, b)) && (g = b),
					(t = n.Range.create(e.positionAt(m), e.positionAt(g)));
				var _ = d.substring(0, m);
				if (new RegExp(/.*[<][^>]*$/).test(_))
					return [{ range: t, newText: (d = d.substring(m, g)) }];
				if (((h = g === d.length), (d = d.substring(m, g)), 0 !== m)) {
					var v = e.offsetAt(n.Position.create(t.start.line, 0));
					u = (function (e, t, n) {
						var i = t,
							r = 0,
							a = n.tabSize || 4;
				...
				t = n.Range.create(n.Position.create(0, 0), e.positionAt(d.length));
			var w = {
					indent_size: p,
					indent_char: c.insertSpaces ? " " : "\t",
					indent_empty_lines: a(c, "indentEmptyLines", !1),
					wrap_line_length: a(c, "wrapLineLength", 120),
					unformatted: o(c, "unformatted", void 0),
					content_unformatted: o(c, "contentUnformatted", void 0),
					...
					end_with_newline: h && a(c, "endWithNewline", !1),
					extra_liners: o(c, "extraLiners", void 0),
					wrap_attributes: a(c, "wrapAttributes", "auto"),
					wrap_attributes_indent_size: a(c, "wrapAttributesIndentSize", void 0),
					eol: "\n",
				},
				y = i.html_beautify(d.replace(/^\s+/, ""), w);
			if (u > 0) {
				var T = c.insertSpaces ? r.repeat(" ", p * u) : r.repeat("\t", u);
				(y = y.split("\n").join("\n" + T)),
					0 === t.start.character && (y = T + y);
			}
			return [{ range: t, newText: y }];
		};
	});
var __extends =
	(this && this.__extends) ||
...
!(function (e) {
	...
	(function (e) {
		...
		function l(e, t, n, o, l, c) {
			...
			if (
					...
					if (!/^\s*javascript\:/i.test(t) && !/[\n\r]/.test(t))
						return (
							...
							/^https?:\/\//i.test(t) || /^file:\/\//i.test(t)
								...
								? e + t
								: /^\/\//i.test(t)
								? (r.startsWith(e, "https://") ? "https" : "http") +
								  ":" +
								  t.replace(/^\s*/g, "")
								: n
				...
				if (
					...
					return {
						range: i.Range.create(e.positionAt(o), e.positionAt(l)),
						target: p,
					};
			}
		}
		t.findDocumentLinks = function (e, t) {
			for (
				...
				switch (c) {
					case o.TokenType.StartTag:
						if (!u) h = "base" === a.getTokenText().toLowerCase();
						break;
					case o.TokenType.AttributeName:
						d = a.getTokenText().toLowerCase();
						break;
					case o.TokenType.AttributeValue:
						if ("src" === d || "href" === d) {
							var m = a.getTokenText();
							if (!h)
								(b = l(e, t, m, a.getTokenOffset(), a.getTokenEnd(), u)) &&
									i.push(b);
							h &&
								void 0 === u &&
								(u = s(m)) &&
							...
							p[s(a.getTokenText())] = a.getTokenOffset();
						}
				}
				c = a.scan();
			}
			for (var f = 0, g = i; f < g.length; f++) {
				var b = g[f],
					_ = e.uri + "#";
				if (b.target && r.startsWith(b.target, _)) {
	...
	(function (e) {
		...
		function o(e, t) {
			return a(e.start, t) && a(t, e.end);
		}
		function s(e, t, i) {
			for (
				var a = n.createScanner(t.getText(), i), o = a.scan();
				o !== r.TokenType.EOS && o !== e;

			)
				o = a.scan();
			return o !== r.TokenType.EOS
				? {
		...
		t.findDocumentHighlights = function (e, t, n) {
			...
			if (!l.tag) return [];
			var c = [],
				d = s(r.TokenType.StartTag, e, l.start),
				h =
					"number" == typeof l.endTagStart &&
					s(r.TokenType.EndTag, e, l.endTagStart);
			return (
				((d && o(d, t)) || (h && o(h, t))) &&
					(d && c.push({ kind: i.DocumentHighlightKind.Read, range: d }),
					h && c.push({ kind: i.DocumentHighlightKind.Read, range: h })),
				c
			);
		};
	}),
				...
				t.roots.forEach(function (t) {
					!(function e(t, i, r, a) {
						var o = (function (e) {
							...
							s = n.Location.create(
								t.uri,
								n.Range.create(t.positionAt(i.start), t.positionAt(i.end))
							),
							l = {
								name: o,
								location: s,
	...
	(function (e) {
		...
		var n = e("vscode-languageserver-types"),
			i = e("../htmlLanguageTypes"),
			r = e("../parser/htmlScanner"),
			a = e("../languageFacts/fact");
		t.getFoldingRanges = function (e, t) {
			var o = r.createScanner(e.getText()),
				s = o.scan(),
				l = [],
				c = [],
				d = null,
				h = -1;
			function u(e) {
				l.push(e), (h = e.startLine);
			}
			for (; s !== i.TokenType.EOS; ) {
				switch (s) {
					case i.TokenType.StartTag:
						var p = o.getTokenText(),
							m = e.positionAt(o.getTokenOffset()).line;
						c.push({ startLine: m, tagName: p }), (d = p);
						break;
					case i.TokenType.EndTag:
						d = o.getTokenText();
						break;
					case i.TokenType.StartTagClose:
						if (!d || !a.isVoidElement(d)) break;
					case i.TokenType.EndTagClose:
					case i.TokenType.StartTagSelfClose:
						for (var f = c.length - 1; f >= 0 && c[f].tagName !== d; ) f--;
						if (f >= 0) {
							var g = c[f];
							(c.length = f),
								(_ = e.positionAt(o.getTokenOffset()).line - 1) >
									(m = g.startLine) &&
									h !== m &&
									u({ startLine: m, endLine: _ });
						}
						break;
					case i.TokenType.Comment:
						m = e.positionAt(o.getTokenOffset()).line;
						var b = o.getTokenText().match(/^\s*#(region\b)|(endregion\b)/);
						if (b)
							if (b[1]) c.push({ startLine: m, tagName: "" });
							else {
								for (f = c.length - 1; f >= 0 && c[f].tagName.length; ) f--;
								if (f >= 0) {
									var _;
									g = c[f];
									(c.length = f),
	...
	(function (e) {
		...
		function o(e, t, r) {
			for (
				var o = n.Range.create(e.positionAt(t.start), e.positionAt(t.end)),
					s = e.getText(o),
					l = r - t.start,
					c = i.createScanner(s),
					d = c.scan(),
				...
				switch (d) {
					case a.TokenType.AttributeName:
						if (l < c.getTokenOffset()) {
							p = !1;
							break;
						}
						l <= c.getTokenEnd() &&
							u.unshift([c.getTokenOffset(), c.getTokenEnd()]),
							(p = !0),
							(m = c.getTokenOffset());
						break;
					case a.TokenType.AttributeValue:
						if (!p) break;
						var f = c.getTokenText();
						if (l < c.getTokenOffset()) {
							u.push([m, c.getTokenEnd()]);
							break;
						}
						l >= c.getTokenOffset() &&
							l <= c.getTokenEnd() &&
							...
							(('"' === f[0] && '"' === f[f.length - 1]) ||
								("'" === f[0] && "'" === f[f.length - 1])) &&
								l >= c.getTokenOffset() + 1 &&
								l <= c.getTokenEnd() - 1 &&
								u.unshift([c.getTokenOffset() + 1, c.getTokenEnd() - 1]),
							u.push([m, c.getTokenEnd()]));
				}
				d = c.scan();
			}
			...
			return t.map(function (t) {
				for (
					var i = (function (e, t) {
							...
							if (
								(l.unshift([s.start, s.end]), s.start < a && a < s.startTagEnd)
							) {
								l.unshift([s.start + 1, s.startTagEnd - 1]);
								d = o(e, s, a);
								return (l = d.concat(l));
							}
							return s.startTagEnd <= a && a <= s.endTagStart
					...
					var c = i[l];
					(a && c[0] === a[0] && c[1] === a[1]) ||
						(s = n.SelectionRange.create(
							n.Range.create(e.positionAt(i[l][0]), e.positionAt(i[l][1])),
							s
						)),
						(a = c);
				}
					...
					for (var a = 0, o = t; a < o.length; a++) {
						...
						if (e.isIncremental(s)) {
							...
							if (u - h === m.length)
								...
								m.length < 1e4
									? p.splice.apply(p, [h + 1, u - h].concat(m))
									: (this._lineOffsets = p =
	...
	(function (e) {
		...
		var i = e("./parser/htmlScanner"),
			...
			h = e("./services/htmlRename"),
			u = e("./services/htmlMatchingTagPosition"),
			p = e("./services/htmlFolding"),
			m = e("./services/htmlSelectionRange"),
			f = e("./languageFacts/builtinDataProviders"),
			g = e("./languageFacts/dataProvider");
		n(e("./htmlLanguageTypes"));
		var b = e("vscode-languageserver-textdocument");
		(t.TextDocument = b.TextDocument),
			n(e("vscode-languageserver-types")),
			(t.getLanguageService = function (e) {
				var t = new o.HTMLHover(e && e.clientCapabilities),
					n = new a.HTMLCompletion(e && e.clientCapabilities);
				return (
					e &&
						e.customDataProviders &&
						f.handleCustomDataProviders(e.customDataProviders),
					{
						...
						doRename: h.doRename,
						findMatchingTagPosition: u.findMatchingTagPosition,
					}
				);
			}),
			(t.newHTMLDataProvider = function (e, t) {
				return new g.HTMLDataProvider(e, t);
			});
	}),
	define(
	...
	define(
		...
		function (e, t, n) {
				...
				a = (function () {
					function e(e, t, n) {
						...
						var r = function (e) {
							...
							a = function (e) {
								monaco.editor.setModelMarkers(e, i._languageId, []);
			...
			function d(e) {
				if (e) return { range: l(e.range), text: e.newText };
			}
			t.DiagnosticsAdapter = a;
			var h = (function () {
				function e(e) {
					this._worker = e;
				}
				return (
					...
					(e.prototype.provideCompletionItems = function (e, t, i, a) {
						var o = e.uri;
						return this._worker(o)
							.then(function (e) {
								return e.doComplete(o.toString(), s(t));
							})
							.then(function (i) {
								if (i) {
			...
			function p(e) {
				if (e) return Array.isArray(e) ? e.map(u) : [u(e)];
			}
			t.CompletionAdapter = h;
			var m = (function () {
				function e(e) {
					this._worker = e;
				}
				return (
					(e.prototype.provideHover = function (e, t, n) {
						...
						return this._worker(i)
							.then(function (e) {
								return e.doHover(i.toString(), s(t));
							})
							.then(function (e) {
								if (e) return { range: l(e.range), contents: p(e.contents) };
							});
					}),
					e
				);
			...
			var g = (function () {
				...
				return (
					(e.prototype.provideDocumentHighlights = function (e, t, n) {
						...
						return this._worker(i)
							.then(function (e) {
								return e.findDocumentHighlights(i.toString(), s(t));
							})
							.then(function (e) {
								if (e)
									return e.map(function (e) {
										return { range: l(e.range), kind: f(e.kind) };
									});
							});
					}),
					e
								...
								if (e)
									return e.map(function (e) {
										return {
											...
											kind: b(e.kind),
											tags: [],
											range: l(e.location.range),
											selectionRange: l(e.location.range),
										};
									});
							});
					}),
								...
								if (e)
									return {
										links: e.map(function (e) {
											return { range: l(e.range), url: e.target };
										}),
									};
							});
					}),
				...
				return (
					(e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
						...
						return this._worker(i).then(function (e) {
							return e.format(i.toString(), null, w(t)).then(function (e) {
							...
							return e
								.format(
									...
									(function (e) {
										if (e)
											return {
												start: s(e.getStartPosition()),
												end: s(e.getEndPosition()),
											};
									})(t),
									w(n)
								)
			...
			t.DocumentRangeFormattingEditProvider = T;
			var k = (function () {
				function e(e) {
					this._worker = e;
				}
				return (
					(e.prototype.provideRenameEdits = function (e, t, n, r) {
						...
						return this._worker(a)
							.then(function (e) {
								return e.doRename(a.toString(), s(t), n);
							})
							.then(function (e) {
								return (function (e) {
									...
									for (var n in e.changes)
										for (
											var r = i.parse(n), a = 0, o = e.changes[n];
											a < o.length;
											a++
										) {
											var s = o[a];
											t.push({
												resource: r,
												edit: { range: l(s.range), text: s.newText },
											});
										}
									return { edits: t };
								})(e);
			...
			var x = (function () {
				...
				return (
					(e.prototype.provideSelectionRanges = function (e, t, n) {
						...
						return this._worker(i)
							.then(function (e) {
								return e.getSelectionRanges(i.toString(), t.map(s));
							})
							.then(function (e) {
								if (e)
									return e.map(function (e) {
										for (var t = []; e; )
											t.push({ range: l(e.range) }), (e = e.parent);
										return t;
									});
							});
					}),
			...
			Object.defineProperty(t, "__esModule", { value: !0 }),
				(t.setupMode1 = function (e) {
					...
					monaco.languages.registerCompletionItemProvider(
						a,
						new i.CompletionAdapter(r)
					),
						monaco.languages.registerHoverProvider(a, new i.HoverAdapter(r)),
						monaco.languages.registerDocumentHighlightProvider(
							a,
							new i.DocumentHighlightAdapter(r)
						),
						monaco.languages.registerLinkProvider(
							a,
							new i.DocumentLinkAdapter(r)
						),
						monaco.languages.registerFoldingRangeProvider(
							a,
							new i.FoldingRangeAdapter(r)
						),
						monaco.languages.registerDocumentSymbolProvider(
							a,
							new i.DocumentSymbolAdapter(r)
						),
						monaco.languages.registerSelectionRangeProvider(
							a,
							new i.SelectionRangeAdapter(r)
						),
						monaco.languages.registerRenameProvider(a, new i.RenameAdapter(r)),
						"html" === a &&
							(monaco.languages.registerDocumentFormattingEditProvider(
								a,
								new i.DocumentFormattingEditProvider(r)
							),
							monaco.languages.registerDocumentRangeFormattingEditProvider(
								a,
								new i.DocumentRangeFormattingEditProvider(r)
							),
							new i.DiagnosticsAdapter(a, r, e));
				}),
				(t.setupMode = function (e) {
					var t = [],
						o = [],
						s = new n.WorkerManager(e);
					t.push(s);
					var l,
						c,
						d = function () {
					...
					return (
						(l = e.languageId),
						(c = e.modeConfiguration),
						a(o),
						c.completionItems &&
							o.push(
								monaco.languages.registerCompletionItemProvider(
									l,
									new i.CompletionAdapter(d)
								)
							),
						c.hovers &&
							o.push(
								monaco.languages.registerHoverProvider(l, new i.HoverAdapter(d))
							),
						c.documentHighlights &&
							o.push(
								monaco.languages.registerDocumentHighlightProvider(
									l,
									new i.DocumentHighlightAdapter(d)
								)
							),
						c.links &&
							o.push(
						...
						c.documentFormattingEdits &&
							o.push(
								monaco.languages.registerDocumentFormattingEditProvider(
									l,
									new i.DocumentFormattingEditProvider(d)
								)
							),
						c.documentRangeFormattingEdits &&
							o.push(
								monaco.languages.registerDocumentRangeFormattingEditProvider(
									l,
									new i.DocumentRangeFormattingEditProvider(d)
								)
							),
						c.diagnostics && o.push(new i.DiagnosticsAdapter(l, d, e)),
						t.push(r(o)),
						r(t)
					);
				});
