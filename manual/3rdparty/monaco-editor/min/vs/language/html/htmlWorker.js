					...
					(e.prototype._doComplete = function (e, t, o, d) {
						...
						for (
							...
							switch (D) {
								...
								case r.TokenType.EndTagOpen:
									if (w <= k.getTokenEnd())
										return E(k.getTokenOffset() + 1, !1, I(r.TokenType.EndTag));
									break;
								case r.TokenType.EndTag:
									if (w <= k.getTokenEnd())
										for (var O = k.getTokenOffset() - 1; O >= 0; ) {
											var P = v.charAt(O);
											if ("/" === P) return E(O, !1, k.getTokenEnd());
											if (!m(P)) break;
											O--;
										}
									break;
			...
			var r = (function () {
				...
				return (
					...
					(e.prototype._getTextDocument = function (e) {
						for (
							var t = 0, i = this._ctx.getMirrorModels();
							t < i.length;
							t++
						) {
							var r = i[t];
