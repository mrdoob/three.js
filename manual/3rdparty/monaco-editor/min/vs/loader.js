						...
						e.Utilities.forEachProperty(t, function (t, r) {
							...
							void 0 !== o.ignoreDuplicateModules
								? (o.ignoreDuplicateModules =
										o.ignoreDuplicateModules.concat(r))
					...
					(t.prototype._initNodeRequire = function (e, t) {
						...
						if (r && !this._didPatchNodeRequire) {
							...
							o.prototype._compile = function (e, i) {
								...
								return (
									n._handleCachedData(h, d, u, !l.cachedData, t),
							...
							this._readSourceAndCachedData(f, g, l, function (e, n, d, a) {
								if (e) i(e);
									...
									(l =
										...
										(l = u(l, f));
									var c = { filename: p, cachedData: d },
										h = s._createAndEvalScript(r, l, c, o, i);
									s._handleCachedData(h, l, g, _ && !d, r),
										s._verifyCachedData(h, l, g, a, r);
								}
							});
						}
					}),
							...
							u = function () {
								setTimeout(function () {
									...
									0 === i.length ||
										...
										d >= 5 ||
										((s = i.length),
										o._fs.writeFile(r, Buffer.concat([a, i]), function (e) {
