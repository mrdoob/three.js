...
define("vs/editor/editor.main.nls.de", {
	...
	"vs/base/browser/ui/keybindingLabel/keybindingLabel": ["Ungebunden"],
	"vs/base/browser/ui/list/listWidget": [
		"{0}. Verwenden Sie die Navigationstasten, um zu navigieren.",
	],
	...
	"vs/editor/browser/widget/diffReview": [
		...
		"1 Zeile",
		"{0} Zeilen",
		"Unterschied von {0} zu {1}: Original: {2}, {3}, geändert: {4}, {5}",
		"leer",
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"Steuert, ob der Diff-Editor Änderungen an führenden oder nachgestellten Leerzeichen als Diffs anzeigt.",
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Steuert, ob der Suchvorgang für den ausgewählten Text oder die gesamte Datei im Editor ausgeführt wird.",
		...
		"Konfiguriert Schriftartenligaturen",
		...
		"Maßstab für in der Minimap gezeichnete Inhalte",
		...
		'Legt fest, ob unerwartete Textänderungen beim Akzeptieren von Vervollständigungen hervorgehoben werden sollen, z. B. wenn "insertMode" auf "replace" festgelegt ist, aber die Vervollständigung nur "insert" unterstützt.',
		...
		"Steuert, ob ein aktiver Ausschnitt Schnellvorschläge verhindert.",
		...
		"Steuert, ob der Editor eine Auswahl automatisch umschließen soll.",
		...
		'Steuert die Mindestanzahl sichtbarer vorangehender und nachfolgender Zeilen, die den Cursor umgeben. Wird in anderen Editoren als "scrollOff" oder "scrollOffset" bezeichnet.',
		...
		'Steuert die Strategie für die Berechnung von Faltungsbereichen. "auto" verwendet eine sprachspezifische Faltungsstrategie (falls verfügbar). "indentation" verwendet die einzugsbasierte Faltungsstrategie.',
		...
		"Struktur fokussieren, wenn Sie den Peek-Editor öffnen",
	...
	"vs/editor/common/standaloneStrings": [
		...
		"Zu Zeile {0} und Zeichen {1} wechseln",
		"Gehe zu Zeile {0}",
		"Zeilennummer zwischen 1 und {0} eingeben, zu der navigiert werden soll",
		"Ein Zeichen zwischen 1 und {0} eingeben, um dorthin zu navigieren",
		"Aktuelle Zeile: {0}. gehe zu Zeile {1}.",
		"Eine Zeilennummer eingeben, gefolgt von einem optionalen Doppelpunkt und einer Zeichennummer, um dorthin zu navigieren",
		"Gehe zu Zeile...",
		"{0}, {1}, Befehle",
		"{0}, Befehle",
		"Name der auszuführenden Aktion eingeben",
		"Befehlspalette",
		"{0}, Symbole",
		"Geben Sie den Namen eines Bezeichners ein, zu dem Sie navigieren möchten.",
		"Gehe zu Symbol...",
		"Symbole ({0})",
		"Module ({0})",
		"Klassen ({0})",
		...
		"Aufrufe ({0})",
		"Editor-Inhalt",
		"Drücken Sie STRG + F1, um die Barrierefreiheitsoptionen aufzurufen.",
	...
	"vs/editor/contrib/caretOperations/transpose": ["Buchstaben austauschen"],
	...
	"vs/editor/contrib/contextmenu/contextmenu": ["Editor-Kontextmenü anzeigen"],
	...
	"vs/editor/contrib/parameterHints/parameterHintsWidget": ["{0}, Hinweis"],
	...
	"vs/editor/contrib/rename/renameInputField": [
		...
		"{0} zum Umbenennen, {1} zum Anzeigen als Vorschau",
	],
	...
	"vs/editor/contrib/suggest/suggestWidget": [
		...
		"{0} für mehr...",
		"Element {0}, Dok.: {1}",
		"{0} zum Einfügen, {1} zum Ersetzen",
		"{0} zum Ersetzen, {1} zum Einfügen",
		"{0} zum Akzeptieren",
	],
	...
	"vs/platform/list/browser/listService": [
		...
		"Legt fest, ob Listen und Strukturen horizontales Scrollen in der Workbench unterstützen.",
		"Steuert, ob Bäume horizontales Scrollen in der Workbench unterstützen.",
		'Diese Einstellung ist veraltet. Verwenden Sie stattdessen "{0}".',
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Hervorhebungs-Rahmenfarbe des letzten Tabstopps eines Codeausschnitts.",
