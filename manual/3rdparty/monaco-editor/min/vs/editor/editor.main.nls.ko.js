...
define("vs/editor/editor.main.nls.ko", {
	...
	"vs/base/browser/ui/aria/aria": ["{0}(다시 발생함)", "{0} ({1}번 발생하다)"],
	...
	"vs/base/browser/ui/findinput/replaceInput": ["입력", "대/소문자 보존"],
	"vs/base/browser/ui/inputbox/inputBox": [
		"오류: {0}",
		"경고: {0}",
		"정보: {0}",
	],
	"vs/base/browser/ui/keybindingLabel/keybindingLabel": ["바인딩 안 됨"],
	...
	"vs/editor/common/config/editorOptions": [
		...
		"완료를 수락하는 동안 예기치 않은 텍스트 수정이 강조 표시되도록 할지 여부를 제어합니다.(예: 'insertMode'는 '바꾸기'이지만 완료는 '삽입'만 지원합니다.)",
		...
		"커서 스타일을 제어합니다.",
		"커서 주위에 표시되는 선행 및 후행 줄의 최소 수를 제어합니다. 다른 편집기에서는 'scrollOff' 또는 'scrollOffset'이라고 합니다.",
	...
	"vs/editor/contrib/caretOperations/transpose": ["문자 바꾸기"],
	...
	"vs/editor/contrib/contextmenu/contextmenu": ["편집기 상황에 맞는 메뉴 표시"],
	...
	"vs/editor/contrib/format/formatActions": ["문서 서식", "선택 영역 서식"],
	...
	"vs/editor/contrib/parameterHints/parameterHints": ["매개 변수 힌트 트리거"],
	"vs/editor/contrib/parameterHints/parameterHintsWidget": ["{0}, 힌트"],
	...
	"vs/editor/contrib/tokenization/tokenization": ["개발자: 강제로 다시 토큰화"],
