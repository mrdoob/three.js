...
define("vs/editor/editor.main.nls.fr", {
	...
	"vs/base/browser/ui/findinput/replaceInput": ["Entrée", "Préserver la casse"],
	"vs/base/browser/ui/inputbox/inputBox": [
		"Erreur : {0}",
		"Avertissement : {0}",
		"Info : {0}",
	],
	"vs/base/browser/ui/keybindingLabel/keybindingLabel": ["Indépendant"],
	...
	"vs/base/common/severity": ["Erreur", "Avertissement", "Info"],
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Configure les ligatures de police.",
		...
		"Échelle du contenu dessiné dans le minimap.",
		...
		"Contrôle si les modifications de texte inattendues en cas d'acceptation de la complétion doivent être mises en surbrillance, par exemple 'insertMode' est défini sur 'replace', mais la complétion prend seulement en charge 'insert'.",
	...
	"vs/editor/contrib/caretOperations/transpose": ["Transposer les lettres"],
	...
	"vs/editor/contrib/parameterHints/parameterHintsWidget": ["{0}, conseil"],
