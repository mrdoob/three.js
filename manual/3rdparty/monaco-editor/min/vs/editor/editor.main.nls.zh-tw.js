...
define("vs/editor/editor.main.nls.zh-tw", {
	...
	"vs/base/browser/ui/aria/aria": ["{0} (再次出現)", "{0} (出現 {1} 次)"],
	...
	"vs/base/browser/ui/findinput/replaceInput": ["輸入", "保留案例"],
	"vs/base/browser/ui/inputbox/inputBox": [
		"錯誤: {0}",
		"警告: {0}",
		"資訊: {0}",
	],
	"vs/base/browser/ui/keybindingLabel/keybindingLabel": ["未繫結"],
	"vs/base/browser/ui/list/listWidget": ["{0}。請使用導覽鍵來導覽。"],
	...
	"vs/editor/browser/widget/codeEditorWidget": ["游標數已限制為 {0} 個。"],
	...
	"vs/editor/common/config/editorOptions": [
		...
		"控制接受完成時的非預期文字修改是否應醒目提示，例如: `insertMode` 為 `replace` 但完成只支援 `insert`。",
		"控制對於拚錯字是否進行篩選和排序其建議",
		"控制排序是否會偏好游標附近出現的字組。",
		...
		"控制是否應啟用平滑插入點動畫。 ",
		"控制資料指標樣式。",
		"控制游標上下周圍的最少可見行數。在某些編輯器中稱為 'scrollOff' 或 `scrollOffset`。",
	...
	"vs/editor/contrib/caretOperations/transpose": ["調換字母"],
	...
	"vs/editor/contrib/contextmenu/contextmenu": ["顯示編輯器內容功能表"],
	"vs/editor/contrib/cursorUndo/cursorUndo": ["游標復原", "游標重做"],
	...
	"vs/editor/contrib/format/formatActions": ["格式化文件", "格式化選取範圍"],
	...
	"vs/editor/contrib/hover/hover": ["動態顯示", "顯示定義預覽懸停"],
	...
	"vs/editor/contrib/message/messageController": ["無法在唯讀編輯器中編輯"],
	...
	"vs/editor/contrib/parameterHints/parameterHints": ["觸發參數提示"],
	"vs/editor/contrib/parameterHints/parameterHintsWidget": ["{0}，提示"],
	...
	"vs/editor/contrib/tokenization/tokenization": ["開發人員: 強制重新置放"],
	...
	"vs/platform/markers/common/markers": ["錯誤", "警告", "資訊"],
