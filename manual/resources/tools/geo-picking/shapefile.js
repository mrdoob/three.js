...
var pbottomMultiPoint = function(record) {
...
var pbottomPolygon = function(record) {
  ...
  return that._source.slice(12).then(function(array) {
    ...
    function read() {
      ...
      return length < 0 || (type && type !== that._type) ? skip() : that._source.slice(length).then(function(chunk) {
        return {done: false, value: type ? that._pbottom(view(concat$1(array.slice(8), chunk))) : null};
      });
    }
...
var pbottomrs = {
  ...
  5: pbottomPolygon,
  8: pbottomMultiPoint,
  11: pbottomPoint, // PointZ
  13: pbottomPolyLine, // PolyLineZ
  15: pbottomPolygon, // PolygonZ
  18: pbottomMultiPoint, // MultiPointZ
