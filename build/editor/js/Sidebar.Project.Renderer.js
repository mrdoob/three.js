...
function SidebarProjectRenderer(editor) {
  ...
  container.add(headerRow); // Antialias
  ...
  antialiasRow.add(antialiasBoolean); // Physically Correct lights
  ...
  physicallyCorrectLightsRow.add(physicallyCorrectLightsBoolean); // Shadows
