...
function Loader(editor) {
      ...
      case '3dm':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              Rhino3dmLoader
            } = await import('../../examples/jsm/loaders/3DMLoader.js');
      ...
      case '3ds':
        {
          reader.addEventListener('load', async function (event) {
            const {
              TDSLoader
            } = await import('../../examples/jsm/loaders/TDSLoader.js');
      ...
      case '3mf':
        {
          reader.addEventListener('load', async function (event) {
            const {
              ThreeMFLoader
            } = await import('../../examples/jsm/loaders/3MFLoader.js');
      ...
      case 'amf':
        {
          reader.addEventListener('load', async function (event) {
            const {
              AMFLoader
            } = await import('../../examples/jsm/loaders/AMFLoader.js');
      ...
      case 'dae':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              ColladaLoader
            } = await import('../../examples/jsm/loaders/ColladaLoader.js');
      ...
      case 'drc':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              DRACOLoader
            } = await import('../../examples/jsm/loaders/DRACOLoader.js');
      ...
      case 'fbx':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              FBXLoader
            } = await import('../../examples/jsm/loaders/FBXLoader.js');
      ...
      case 'glb':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              GLTFLoader
            } = await import('../../examples/jsm/loaders/GLTFLoader.js');
      ...
      case 'json':
        {
          reader.addEventListener('load', function (event) {
            const contents = event.target.result; // 2.0
      ...
      case 'ifc':
        {
          reader.addEventListener('load', async function (event) {
            const {
              IFCLoader
            } = await import('../../examples/jsm/loaders/IFCLoader.js');
      ...
      case 'kmz':
        {
          reader.addEventListener('load', async function (event) {
            const {
              KMZLoader
            } = await import('../../examples/jsm/loaders/KMZLoader.js');
      ...
      case 'mpd':
        {
          reader.addEventListener('load', async function (event) {
            const {
              LDrawLoader
            } = await import('../../examples/jsm/loaders/LDrawLoader.js');
            const loader = new LDrawLoader();
            loader.setPath('../../examples/models/ldraw/officialLibrary/');
            loader.parse(event.target.result, undefined, function (group) {
              group.name = filename; // Convert from LDraw coordinates: rotate 180 degrees around OX
      ...
      case 'md2':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              MD2Loader
            } = await import('../../examples/jsm/loaders/MD2Loader.js');
      ...
      case 'obj':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              OBJLoader
            } = await import('../../examples/jsm/loaders/OBJLoader.js');
      ...
      case 'ply':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              PLYLoader
            } = await import('../../examples/jsm/loaders/PLYLoader.js');
      ...
      case 'stl':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              STLLoader
            } = await import('../../examples/jsm/loaders/STLLoader.js');
      ...
      case 'svg':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              SVGLoader
            } = await import('../../examples/jsm/loaders/SVGLoader.js');
      ...
      case 'vox':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              VOXLoader,
              VOXMesh
            } = await import('../../examples/jsm/loaders/VOXLoader.js');
      ...
      case 'vtp':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              VTKLoader
            } = await import('../../examples/jsm/loaders/VTKLoader.js');
      ...
      case 'wrl':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              VRMLLoader
            } = await import('../../examples/jsm/loaders/VRMLLoader.js');
      ...
      case 'xyz':
        {
          reader.addEventListener('load', async function (event) {
            ...
            const {
              XYZLoader
            } = await import('../../examples/jsm/loaders/XYZLoader.js');
  ...
  async function handleZIP(contents) {
    const zip = unzipSync(new Uint8Array(contents)); // Poly

    if (zip['model.obj'] && zip['materials.mtl']) {
      const {
        MTLLoader
      } = await import('../../examples/jsm/loaders/MTLLoader.js');
      const {
        OBJLoader
      } = await import('../../examples/jsm/loaders/OBJLoader.js');
