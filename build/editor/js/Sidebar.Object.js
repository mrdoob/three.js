...
function SidebarObject(editor) {
  ...
  container.setDisplay('none'); // Actions
  ...
  */
  ...
  container.add(objectTypeRow); // uuid
  ...
  container.add(objectUUIDRow); // name
  ...
  container.add(objectNameRow); // position
  ...
  container.add(objectPositionRow); // rotation
  ...
  container.add(objectRotationRow); // scale
  ...
  container.add(objectScaleRow); // fov
  ...
  container.add(objectFovRow); // left
  ...
  container.add(objectLeftRow); // right
  ...
  container.add(objectRightRow); // top
  ...
  container.add(objectTopRow); // bottom
  ...
  container.add(objectBottomRow); // near
  ...
  container.add(objectNearRow); // far
  ...
  container.add(objectFarRow); // intensity
  ...
  container.add(objectIntensityRow); // color
  ...
  container.add(objectColorRow); // ground color
  ...
  container.add(objectGroundColorRow); // distance
  ...
  container.add(objectDistanceRow); // angle
  ...
  container.add(objectAngleRow); // penumbra
  ...
  container.add(objectPenumbraRow); // decay
  ...
  container.add(objectDecayRow); // shadow
  ...
  container.add(objectShadowRow); // shadow bias
  ...
  container.add(objectShadowBiasRow); // shadow normal offset
  ...
  container.add(objectShadowNormalBiasRow); // shadow radius
  ...
  container.add(objectShadowRadiusRow); // visible
  ...
  container.add(objectVisibleRow); // frustumCulled
  ...
  container.add(objectFrustumCulledRow); // renderOrder
  ...
  container.add(objectRenderOrderRow); // user data
