...
function SidebarProjectMaterials(editor) {
  ...
  assignMaterial.onClick(function () {
    ...
    if (selectedObject !== null) {
      const oldMaterial = selectedObject.material; // only assing materials to objects with a material property (e.g. avoid assigning material to THREE.Group)
  ...
  buttonsRow.add(assignMaterial); // Signals
