...
(function (i) {
  ...
  function g(a, b) {
    if (typeof a !== "function") throw Error("listener is a required param of {fn}() and should be a Function.".replace("{fn}", b));
  }
  ...
  e.prototype = {
    ...
    _indexOfListener: function (a, b) {
      for (var c = this._bindings.length, d; c--;) if (d = this._bindings[c], d._listener === a && d.context === b) return c;
  ...
  typeof define === "function" && define.amd ? define(function () {
    return f;
  }) : typeof module !== "undefined" && module.exports ? module.exports = f : i.signals = f;
})(this);