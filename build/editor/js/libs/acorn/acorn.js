(function (f) {
  ...
  return function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
      ...
      exports.parse = parse; // This function tries to parse a single expression at a given
    ...
    2: [function (require, module, exports) {
      ...
      var pp = Parser.prototype; // Check if property name clashes with already added.
    ...
    3: [function (require, module, exports) {
      ...
      exports.isIdentifierStart = isIdentifierStart; // Test whether a given character is part of an identifier.
    ...
    4: [function (require, module, exports) {
      ...
      var lineBreakG = require("./whitespace").lineBreakG; // These are used when `options.locations` is on, for the
      ...
      var pp = Parser.prototype; // This function is used to raise exceptions on parse errors. It
    ...
    5: [function (require, module, exports) {
      ...
      var pp = Parser.prototype; // Convert existing expression atom to assignable pattern
      // if possible.
    ...
    6: [function (require, module, exports) {
      ...
      var SourceLocation = require("./location").SourceLocation; // Start an AST node, attaching a start offset.
    ...
    7: [function (require, module, exports) {
      ...
      var SourceLocation = require("./location").SourceLocation; // A second optional argument can be given to further configure
    ...
    9: [function (require, module, exports) {
      ...
      function Parser(options, input, startPos) {
        ...
        this.input = input; // Set up token state
        ...
        this.strict = this.inModule = this.options.sourceType === "module"; // Flags to track whether we are in a function, a generator.
    ...
    10: [function (require, module, exports) {
      ...
      var pp = Parser.prototype; // ### Statement parsing
    ...
    12: [function (require, module, exports) {
      ...
      var nonASCIIwhitespace = _whitespace.nonASCIIwhitespace; // Object type used to represent tokens. Note that normally, tokens
      ...
      pp.readToken_lt_gt = function (code) {
        ...
        if (next == 33 && code == 60 && this.input.charCodeAt(this.pos + 2) == 45 && this.input.charCodeAt(this.pos + 3) == 45) {
          if (this.inModule) unexpected(); // `<!--`, an XML-style comment that should be interpreted as a line comment
      ...
      } catch (e) {} // Parse a regular expression. Some context-awareness is necessary,
    ...
    14: [function (require, module, exports) {
      ...
      exports.isArray = isArray; // Checks if an object has a property.
