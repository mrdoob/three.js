...
function GeometryParametersPanel(editor, object) {
  ...
  container.add(radiusRow); // length
  ...
  container.add(lengthRow); // capSegments
  ...
  container.add(capSegmentsRow); // radialSegments
  ...
  function update() {
    editor.execute(new SetGeometryCommand(editor, object, new THREE.CapsuleGeometry(radius.getValue(), length.getValue(), capSegments.getValue(), radialSegments.getValue())));
  }
