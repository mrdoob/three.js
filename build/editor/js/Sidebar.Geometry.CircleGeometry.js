...
function GeometryParametersPanel(editor, object) {
  ...
  container.add(radiusRow); // segments
  ...
  container.add(segmentsRow); // thetaStart
  ...
  function update() {
    editor.execute(new SetGeometryCommand(editor, object, new THREE.CircleGeometry(radius.getValue(), segments.getValue(), thetaStart.getValue() * THREE.MathUtils.DEG2RAD, thetaLength.getValue() * THREE.MathUtils.DEG2RAD)));
  }
