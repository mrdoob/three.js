...
function GeometryParametersPanel(editor, object) {
  ...
  var container = new UIRow(); // set lattice a,b, and c vectors based on the LineSegments vertices
  ...
  const c = vertices[17].sub(vertices[0]).toArray(); // lattice a vector
  ...
  aRow.add(aX, aY, aZ);
  container.add(aRow); // lattice b vector
  ...
  bRow.add(bX, bY, bZ);
  container.add(bRow); // lattice c vector
  ...
  function update(object) {
    ...
    const vertices = [[0, 0, 0], [cell.ax, cell.ay, cell.az], [cell.bx, cell.by, cell.bz], [cell.ax + cell.bx, cell.ay + cell.by, cell.az + cell.bz], [cell.cx, cell.cy, cell.cz], [cell.cx + cell.ax, cell.cy + cell.ay, cell.cz + cell.az], [cell.cx + cell.bx, cell.cy + cell.by, cell.cz + cell.bz], [cell.cx + cell.ax + cell.bx, cell.cy + cell.ay + cell.by, cell.cz + cell.az + cell.bz]]; // edges of the cell forming a continuous line
