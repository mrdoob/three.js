...
function GeometryParametersPanel(editor, object) {
  ...
  tubeRow.add(tube);
  container.add(tubeRow); // radialSegments
  ...
  container.add(radialSegmentsRow); // tubularSegments
  ...
  container.add(tubularSegmentsRow); // arc
  ...
  function update() {
    editor.execute(new SetGeometryCommand(editor, object, new THREE.TorusGeometry(radius.getValue(), tube.getValue(), radialSegments.getValue(), tubularSegments.getValue(), arc.getValue() * THREE.MathUtils.DEG2RAD)));
  }
