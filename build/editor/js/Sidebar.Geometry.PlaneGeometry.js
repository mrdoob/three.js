...
function GeometryParametersPanel(editor, object) {
  ...
  const parameters = geometry.parameters; // width
  ...
  container.add(heightRow); // widthSegments
  ...
  container.add(widthSegmentsRow); // heightSegments
  ...
  function update() {
    editor.execute(new SetGeometryCommand(editor, object, new THREE.PlaneGeometry(width.getValue(), height.getValue(), widthSegments.getValue(), heightSegments.getValue())));
  }
