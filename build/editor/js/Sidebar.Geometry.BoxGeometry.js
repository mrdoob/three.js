...
function GeometryParametersPanel(editor, object) {
  ...
  depthRow.add(depth);
  container.add(depthRow); // widthSegments
  ...
  container.add(heightSegmentsRow); // depthSegments
  ...
  function update() {
    editor.execute(new SetGeometryCommand(editor, object, new THREE.BoxGeometry(width.getValue(), height.getValue(), depth.getValue(), widthSegments.getValue(), heightSegments.getValue(), depthSegments.getValue())));
  }
