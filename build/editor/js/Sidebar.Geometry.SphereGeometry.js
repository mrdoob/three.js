...
function GeometryParametersPanel(editor, object) {
  ...
  container.add(radiusRow); // widthSegments
  ...
  container.add(heightSegmentsRow); // phiStart
  ...
  container.add(phiStartRow); // phiLength
  ...
  container.add(phiLengthRow); // thetaStart
  ...
  container.add(thetaStartRow); // thetaLength
  ...
  function update() {
    editor.execute(new SetGeometryCommand(editor, object, new THREE.SphereGeometry(radius.getValue(), widthSegments.getValue(), heightSegments.getValue(), phiStart.getValue() * THREE.MathUtils.DEG2RAD, phiLength.getValue() * THREE.MathUtils.DEG2RAD, thetaStart.getValue() * THREE.MathUtils.DEG2RAD, thetaLength.getValue() * THREE.MathUtils.DEG2RAD)));
  }
