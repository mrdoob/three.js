...
function GeometryParametersPanel(editor, object) {
  ...
  const parameters = geometry.parameters; // radiusTop
  ...
  container.add(radiusTopRow); // radiusBottom
  ...
  container.add(radiusBottomRow); // height
  ...
  container.add(heightRow); // radialSegments
  ...
  container.add(radialSegmentsRow); // heightSegments
  ...
  container.add(heightSegmentsRow); // openEnded
  ...
  function update() {
    editor.execute(new SetGeometryCommand(editor, object, new THREE.CylinderGeometry(radiusTop.getValue(), radiusBottom.getValue(), height.getValue(), radialSegments.getValue(), heightSegments.getValue(), openEnded.getValue())));
  }
