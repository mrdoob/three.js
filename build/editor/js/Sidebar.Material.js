...
function SidebarMaterial(editor) {
  ...
  container.setPaddingTop('20px'); // Current material slot
  ...
  container.add(materialSlotRow); // type
  ...
  container.add(materialClassRow); // uuid
  ...
  container.add(materialUUIDRow); // name
  ...
  container.add(materialClearcoatRoughness); // transmission
  ...
  container.add(materialTransmission); // attenuation distance
  ...
  container.add(materialAttenuationDistance); // attenuation tint
  ...
  container.add(materialVertexColors); // depth packing
  ...
  container.add(materialClearcoatNormalMap); // displacement map
  ...
  container.add(materialDisplacementMap); // roughness map
  ...
  container.add(materialRoughnessMap); // metalness map
  ...
  container.add(materialSizeAttenuation); // flatShading
  ...
  container.add(materialFlatShading); // blending
  ...
  function update() {
    ...
    if (material) {
      ...
      if (material.type !== materialClass.getValue()) {
        ...
        editor.addMaterial(material); // TODO Copy other references in the scene graph
...
const vertexShaderVariables = ['uniform mat4 projectionMatrix;', 'uniform mat4 modelViewMatrix;\n', 'attribute vec3 position;\n\n'].join('\n');
