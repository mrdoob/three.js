...
function SidebarProjectVideo(editor) {
  ...
  resolutionRow.add(new UIText('fps').setFontSize('12px')); // Duration
  ...
  container.add(videoDurationRow); // Render
  ...
  container.add(renderButton); // SAVE
