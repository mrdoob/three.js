...
function MenubarAdd(editor) {
  ...
  options.add(new UIHorizontalRule()); // Box
  ...
  options.add(option); // Dodecahedron
  ...
  options.add(option); // Icosahedron
  ...
  options.add(option); // Tetrahedron
  ...
  options.add(option); // Tube

  option = new UIRow();
  option.setClass('option');
  option.setTextContent(strings.getKey('menubar/add/tube'));
  option.onClick(function () {
    const path = new THREE.CatmullRomCurve3([new THREE.Vector3(2, 2, -2), new THREE.Vector3(2, -2, -0.6666666666666667), new THREE.Vector3(-2, -2, 0.6666666666666667), new THREE.Vector3(-2, 2, 2)]);
  ...
  */
  ...
  options.add(new UIHorizontalRule()); // AmbientLight
  ...
  options.add(option); // DirectionalLight
  ...
  options.add(option); // HemisphereLight
  ...
  options.add(new UIHorizontalRule()); // OrthographicCamera
  ...
  options.add(option); // PerspectiveCamera
