...
e.width=d;e.height=f;var g=e.getContext("2d");g.drawImage(a,0,0);for(var h=g.getImageData(0,0,d,f).data,k=g.createImageData(d,f),l=k.data,m=0;m<d;m++)for(var q=0;q<f;q++){var n=0>q-1?0:q-1,r=q+1>f-1?f-1:q+1,s=0>m-1?0:m-1,p=m+1>d-1?d-1:m+1,w=[],y=[0,0,h[4*(q*d+m)]/255*c];w.push([-1,0,h[4*(q*d+s)]/255*c]);w.push([-1,-1,h[4*(n*d+s)]/255*c]);w.push([0,-1,h[4*(n*d+m)]/255*c]);w.push([1,-1,h[4*(n*d+p)]/255*c]);w.push([1,0,h[4*(q*d+p)]/255*c]);w.push([1,1,h[4*(r*d+p)]/255*c]);w.push([0,1,h[4*(r*d+m)]/255*
c]);w.push([-1,1,h[4*(r*d+s)]/255*c]);n=[];s=w.length;for(r=0;r<s;r++){var p=w[r],t=w[(r+1)%s],p=[p[0]-y[0],p[1]-y[1],p[2]-y[2]],t=[t[0]-y[0],t[1]-y[1],t[2]-y[2]];n.push(b([p[1]*t[2]-p[2]*t[1],p[2]*t[0]-p[0]*t[2],p[0]*t[1]-p[1]*t[0]]))}w=[0,0,0];for(r=0;r<n.length;r++)w[0]+=n[r][0],w[1]+=n[r][1],w[2]+=n[r][2];w[0]/=n.length;w[1]/=n.length;w[2]/=n.length;y=4*(q*d+m);l[y]=(w[0]+1)/2*255|0;l[y+1]=(w[1]+1)/2*255|0;l[y+2]=255*w[2]|0;l[y+3]=255}g.putImageData(k,0,0);return e},generateDataTexture:function(a,
...
a},drawText:function(a){var c=this.getFace(),b=this.size/c.resolution,d=0,f=String(a).split(""),e=f.length,g=[];for(a=0;a<e;a++){var h=new THREE.Path,h=this.extractGlyphPoints(f[a],c,b,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(a,c,b,d,f){var e=[],g,h,k,l,m,q,n,r,s,p,w,y=c.glyphs[a]||c.glyphs["?"];if(y){if(y.o)for(c=y._cachedOutline||(y._cachedOutline=y.o.split(" ")),l=c.length,a=0;a<l;)switch(k=c[a++],k){case "m":k=c[a++]*b+d;m=c[a++]*b;f.moveTo(k,m);
break;case "l":k=c[a++]*b+d;m=c[a++]*b;f.lineTo(k,m);break;case "q":k=c[a++]*b+d;m=c[a++]*b;r=c[a++]*b+d;s=c[a++]*b;f.quadraticCurveTo(r,s,k,m);if(g=e[e.length-1])for(q=g.x,n=g.y,g=1,h=this.divisions;g<=h;g++){var t=g/h;THREE.Shape.Utils.b2(t,q,r,k);THREE.Shape.Utils.b2(t,n,s,m)}break;case "b":if(k=c[a++]*b+d,m=c[a++]*b,r=c[a++]*b+d,s=c[a++]*b,p=c[a++]*b+d,w=c[a++]*b,f.bezierCurveTo(r,s,p,w,k,m),g=e[e.length-1])for(q=g.x,n=g.y,g=1,h=this.divisions;g<=h;g++)t=g/h,THREE.Shape.Utils.b3(t,q,r,p,k),THREE.Shape.Utils.b3(t,
...
(function(a){var c=function(b){for(var a=b.length,c=0,e=a-1,g=0;g<a;e=g++)c+=b[e].x*b[g].y-b[g].x*b[e].y;return 0.5*c};a.Triangulate=function(b,a){var f=b.length;if(3>f)return null;var e=[],g=[],h=[],k,l,m;if(0<c(b))for(l=0;l<f;l++)g[l]=l;else for(l=0;l<f;l++)g[l]=f-1-l;var q=2*f;for(l=f-1;2<f;){if(0>=q--){console.log("Warning, unable to triangulate polygon!");break}k=l;f<=k&&(k=0);l=k+1;f<=l&&(l=0);m=l+1;f<=m&&(m=0);var n;a:{var r=n=void 0,s=void 0,p=void 0,w=void 0,y=void 0,t=void 0,H=void 0,u=
void 0,r=b[g[k]].x,s=b[g[k]].y,p=b[g[l]].x,w=b[g[l]].y,y=b[g[m]].x,t=b[g[m]].y;if(1E-10>(p-r)*(t-s)-(w-s)*(y-r))n=!1;else{var D=void 0,z=void 0,x=void 0,A=void 0,B=void 0,v=void 0,J=void 0,C=void 0,G=void 0,N=void 0,G=C=J=u=H=void 0,D=y-p,z=t-w,x=r-y,A=s-t,B=p-r,v=w-s;for(n=0;n<f;n++)if(H=b[g[n]].x,u=b[g[n]].y,!(H===r&&u===s||H===p&&u===w||H===y&&u===t)&&(J=H-r,C=u-s,G=H-p,N=u-w,H-=y,u-=t,G=D*N-z*G,J=B*C-v*J,C=x*u-A*H,-1E-10<=G&&-1E-10<=C&&-1E-10<=J)){n=!1;break a}n=!0}}if(n){e.push([b[g[k]],b[g[l]],
b[g[m]]]);h.push([g[k],g[l],g[m]]);k=l;for(m=l+1;m<f;k++,m++)g[k]=g[m];f--;q=2*f}}return a?h:e};a.Triangulate.area=c;return a})(THREE.FontUtils);self._typeface_js={faces:THREE.FontUtils.faces,loadFace:THREE.FontUtils.loadFace};THREE.typeface_js=self._typeface_js;
THREE.Audio=function(a){THREE.Object3D.call(this);this.type="Audio";this.context=a.context;this.source=this.context.createBufferSource();this.gain=this.context.createGain();this.gain.connect(this.context.destination);this.panner=this.context.createPanner();this.panner.connect(this.gain)};THREE.Audio.prototype=Object.create(THREE.Object3D.prototype);
THREE.Audio.prototype.load=function(a){var c=this,b=new XMLHttpRequest;b.open("GET",a,!0);b.responseType="arraybuffer";b.onload=function(b){c.context.decodeAudioData(this.response,function(b){c.source.buffer=b;c.source.connect(c.panner);c.source.start()})};b.send();return this};THREE.Audio.prototype.setRefDistance=function(a){this.panner.refDistance=a};THREE.Audio.prototype.setRolloffFactor=function(a){this.panner.rolloffFactor=a};
THREE.Audio.prototype.updateMatrixWorld=function(){var a=new THREE.Vector3;return function(c){THREE.Object3D.prototype.updateMatrixWorld.call(this,c);a.setFromMatrixPosition(this.matrixWorld);this.panner.setPosition(a.x,a.y,a.z)}}();THREE.AudioListener=function(){THREE.Object3D.call(this);this.type="AudioListener";this.context=new AudioContext};THREE.AudioListener.prototype=Object.create(THREE.Object3D.prototype);
THREE.AudioListener.prototype.updateMatrixWorld=function(){var a=new THREE.Vector3,c=new THREE.Quaternion,b=new THREE.Vector3,d=new THREE.Vector3,f=new THREE.Vector3,e=new THREE.Vector3;return function(g){THREE.Object3D.prototype.updateMatrixWorld.call(this,g);g=this.context.listener;this.matrixWorld.decompose(a,c,b);d.set(0,0,-1).applyQuaternion(c);f.subVectors(a,e);g.setPosition(a.x,a.y,a.z);g.setOrientation(d.x,d.y,d.z,this.up.x,this.up.y,this.up.z);g.setVelocity(f.x,f.y,f.z);e.copy(a)}}();
THREE.Curve=function(){};THREE.Curve.prototype.getPoint=function(a){console.log("Warning, getPoint() not implemented!");return null};THREE.Curve.prototype.getPointAt=function(a){a=this.getUtoTmapping(a);return this.getPoint(a)};THREE.Curve.prototype.getPoints=function(a){a||(a=5);var c,b=[];for(c=0;c<=a;c++)b.push(this.getPoint(c/a));return b};THREE.Curve.prototype.getSpacedPoints=function(a){a||(a=5);var c,b=[];for(c=0;c<=a;c++)b.push(this.getPointAt(c/a));return b};
...
THREE.CurvePath.prototype.getBoundingBox=function(){var a=this.getPoints(),c,b,d,f,e,g;c=b=Number.NEGATIVE_INFINITY;f=e=Number.POSITIVE_INFINITY;var h,k,l,m,q=a[0]instanceof THREE.Vector3;m=q?new THREE.Vector3:new THREE.Vector2;k=0;for(l=a.length;k<l;k++)h=a[k],h.x>c?c=h.x:h.x<f&&(f=h.x),h.y>b?b=h.y:h.y<e&&(e=h.y),q&&(h.z>d?d=h.z:h.z<g&&(g=h.z)),m.add(h);a={minX:f,minY:e,maxX:c,maxY:b};q&&(a.maxZ=d,a.minZ=g);return a};
...
THREE.Path.prototype.getPoints=function(a,c){if(this.useSpacedPoints)return console.log("tata"),this.getSpacedPoints(a,c);a=a||12;var b=[],d,f,e,g,h,k,l,m,q,n,r,s,p;d=0;for(f=this.actions.length;d<f;d++)switch(e=this.actions[d],g=e.action,e=e.args,g){case THREE.PathActions.MOVE_TO:b.push(new THREE.Vector2(e[0],e[1]));break;case THREE.PathActions.LINE_TO:b.push(new THREE.Vector2(e[0],e[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=e[2];k=e[3];q=e[0];n=e[1];0<b.length?(g=b[b.length-1],r=g.x,
s=g.y):(g=this.actions[d-1].args,r=g[g.length-2],s=g[g.length-1]);for(e=1;e<=a;e++)p=e/a,g=THREE.Shape.Utils.b2(p,r,q,h),p=THREE.Shape.Utils.b2(p,s,n,k),b.push(new THREE.Vector2(g,p));break;case THREE.PathActions.BEZIER_CURVE_TO:h=e[4];k=e[5];q=e[0];n=e[1];l=e[2];m=e[3];0<b.length?(g=b[b.length-1],r=g.x,s=g.y):(g=this.actions[d-1].args,r=g[g.length-2],s=g[g.length-1]);for(e=1;e<=a;e++)p=e/a,g=THREE.Shape.Utils.b3(p,r,q,l,h),p=THREE.Shape.Utils.b3(p,s,n,m,k),b.push(new THREE.Vector2(g,p));break;case THREE.PathActions.CSPLINE_THRU:g=
this.actions[d-1].args;p=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=a*e[0].length;p=p.concat(e[0]);p=new THREE.SplineCurve(p);for(e=1;e<=g;e++)b.push(p.getPointAt(e/g));break;case THREE.PathActions.ARC:h=e[0];k=e[1];n=e[2];l=e[3];g=e[4];q=!!e[5];r=g-l;s=2*a;for(e=1;e<=s;e++)p=e/s,q||(p=1-p),p=l+p*r,g=h+n*Math.cos(p),p=k+n*Math.sin(p),b.push(new THREE.Vector2(g,p));break;case THREE.PathActions.ELLIPSE:for(h=e[0],k=e[1],n=e[2],m=e[3],l=e[4],g=e[5],q=!!e[6],r=g-l,s=2*a,e=1;e<=s;e++)p=e/s,q||
(p=1-p),p=l+p*r,g=h+n*Math.cos(p),p=k+m*Math.sin(p),b.push(new THREE.Vector2(g,p))}d=b[b.length-1];1E-10>Math.abs(d.x-b[0].x)&&1E-10>Math.abs(d.y-b[0].y)&&b.splice(b.length-1,1);c&&b.push(b[0]);return b};
...
h=[];var m=[],q=[],n=0,r;m[n]=void 0;q[n]=[];var s,p;s=0;for(p=f.length;s<p;s++)g=f[s],r=g.getPoints(),e=THREE.Shape.Utils.isClockWise(r),(e=a?!e:e)?(!l&&m[n]&&n++,m[n]={s:new THREE.Shape,p:r},m[n].s.actions=g.actions,m[n].s.curves=g.curves,l&&n++,q[n]=[]):q[n].push({h:g,p:r[0]});if(!m[0])return b(f);if(1<m.length){s=!1;p=[];g=0;for(f=m.length;g<f;g++)h[g]=[];g=0;for(f=m.length;g<f;g++)for(e=q[g],l=0;l<e.length;l++){n=e[l];r=!0;for(var w=0;w<m.length;w++)d(n.p,m[w].p)&&(g!=w&&p.push({froms:g,tos:w,
hole:l}),r?(r=!1,h[w].push(n)):s=!0);r&&h[g].push(n)}0<p.length&&(s||(q=h))}s=0;for(p=m.length;s<p;s++)for(h=m[s].s,k.push(h),g=q[s],f=0,e=g.length;f<e;f++)h.holes.push(g[f].h);return k};THREE.Shape=function(){THREE.Path.apply(this,arguments);this.holes=[]};THREE.Shape.prototype=Object.create(THREE.Path.prototype);THREE.Shape.prototype.extrude=function(a){return new THREE.ExtrudeGeometry(this,a)};THREE.Shape.prototype.makeGeometry=function(a){return new THREE.ShapeGeometry(this,a)};
...
THREE.Shape.Utils={triangulateShape:function(a,c){function b(b,a,c){return b.x!=a.x?b.x<a.x?b.x<=c.x&&c.x<=a.x:a.x<=c.x&&c.x<=b.x:b.y<a.y?b.y<=c.y&&c.y<=a.y:a.y<=c.y&&c.y<=b.y}function d(a,c,d,g,f){var e=c.x-a.x,h=c.y-a.y,k=g.x-d.x,l=g.y-d.y,m=a.x-d.x,q=a.y-d.y,x=h*k-e*l,A=h*m-e*q;if(1E-10<Math.abs(x)){if(0<x){if(0>A||A>x)return[];k=l*m-k*q;if(0>k||k>x)return[]}else{if(0<A||A<x)return[];k=l*m-k*q;if(0<k||k<x)return[]}if(0==k)return!f||0!=A&&A!=x?[a]:[];if(k==x)return!f||0!=A&&A!=x?[c]:[];if(0==A)return[d];
if(A==x)return[g];f=k/x;return[{x:a.x+f*e,y:a.y+f*h}]}if(0!=A||l*m!=k*q)return[];h=0==e&&0==h;k=0==k&&0==l;if(h&&k)return a.x!=d.x||a.y!=d.y?[]:[a];if(h)return b(d,g,a)?[a]:[];if(k)return b(a,c,d)?[d]:[];0!=e?(a.x<c.x?(e=a,k=a.x,h=c,a=c.x):(e=c,k=c.x,h=a,a=a.x),d.x<g.x?(c=d,x=d.x,l=g,d=g.x):(c=g,x=g.x,l=d,d=d.x)):(a.y<c.y?(e=a,k=a.y,h=c,a=c.y):(e=c,k=c.y,h=a,a=a.y),d.y<g.y?(c=d,x=d.y,l=g,d=g.y):(c=g,x=g.y,l=d,d=d.y));return k<=x?a<x?[]:a==x?f?[]:[c]:a<=d?[c,h]:[c,l]:k>d?[]:k==d?f?[]:[e]:a<=d?[e,h]:
...
d=k.length-1;g=b-1;0>g&&(g=d);e=b+1;e>d&&(e=0);return(d=f(k[b],k[g],k[e],h[a]))?!0:!1}function g(a,b){var c,e;for(c=0;c<h.length;c++)if(e=c+1,e%=h.length,e=d(a,b,h[c],h[e],!0),0<e.length)return!0;return!1}function e(a,c){var g,f,h,k;for(g=0;g<l.length;g++)for(f=b[l[g]],h=0;h<f.length;h++)if(k=h+1,k%=f.length,k=d(a,c,f[h],f[k],!0),0<k.length)return!0;return!1}var h=a.concat(),k,l=[],m,q,z,x,A,B=[],v,J,C,G=0;for(m=b.length;G<m;G++)l.push(G);v=0;for(var N=2*l.length;0<l.length;){N--;if(0>N){console.log("Infinite Loop! Holes left:"+
l.length+", Probably Hole outside Shape!");break}for(q=v;q<h.length;q++){z=h[q];m=-1;for(G=0;G<l.length;G++)if(x=l[G],A=z.x+":"+z.y+":"+x,void 0===B[A]){k=b[x];for(J=0;J<k.length;J++)if(x=k[J],c(q,J)&&!g(z,x)&&!e(z,x)){m=J;l.splice(G,1);v=h.slice(0,q+1);x=h.slice(q);J=k.slice(m);C=k.slice(0,m+1);h=v.concat(J).concat(C).concat(x);v=q;break}if(0<=m)break;B[A]=!0}if(0<=m)break}}return h}(a,c);var q=THREE.FontUtils.Triangulate(e,!1);e=0;for(g=q.length;e<g;e++)for(k=q[e],h=0;3>h;h++)l=k[h].x+":"+k[h].y,
...
n+(-3*(b-c)-2*a-d)*f+a*e+b};return function(e){if(!1!==this.isPlaying&&(this.currentTime+=e*this.timeScale,0!==this.weight)){e=this.data.length;if(this.currentTime>e||0>this.currentTime)if(this.loop)this.currentTime%=e,0>this.currentTime&&(this.currentTime+=e),this.reset();else{this.stop();return}e=0;for(var h=this.hierarchy.length;e<h;e++)for(var k=this.hierarchy[e],l=k.animationCache.animations[this.data.name],m=k.animationCache.blending,q=0;3>q;q++){var n=this.keyTypes[q],r=l.prevKey[n],s=l.nextKey[n];
if(r&&r[n]&&s&&s[n]){if(0<this.timeScale&&s.time<=this.currentTime||0>this.timeScale&&r.time>=this.currentTime){r=this.data.hierarchy[e].keys[0];for(s=this.getNextKeyWith(n,e,1);s.time<this.currentTime&&s.index>r.index;)r=s,s=this.getNextKeyWith(n,e,s.index+1);l.prevKey[n]=r;l.nextKey[n]=s}k.matrixAutoUpdate=!0;k.matrixWorldNeedsUpdate=!0;var p=(this.currentTime-r.time)/(s.time-r.time),w=r[n],y=s[n];0>p&&(p=0);1<p&&(p=1);if("pos"===n)if(this.interpolationType===THREE.AnimationHandler.LINEAR)b.x=w[0]+
(y[0]-w[0])*p,b.y=w[1]+(y[1]-w[1])*p,b.z=w[2]+(y[2]-w[2])*p,r=this.weight/(this.weight+m.positionWeight),k.position.lerp(b,r),m.positionWeight+=this.weight;else{if(this.interpolationType===THREE.AnimationHandler.CATMULLROM||this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD)a[0]=this.getPrevKeyWith("pos",e,r.index-1).pos,a[1]=w,a[2]=y,a[3]=this.getNextKeyWith("pos",e,s.index+1).pos,p=0.33*p+0.33,s=f(a,p),r=this.weight/(this.weight+m.positionWeight),m.positionWeight+=this.weight,n=
k.position,n.x+=(s[0]-n.x)*r,n.y+=(s[1]-n.y)*r,n.z+=(s[2]-n.z)*r,this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD&&(p=f(a,1.01*p),c.set(p[0],p[1],p[2]),c.sub(n),c.y=0,c.normalize(),p=Math.atan2(c.x,c.z),k.rotation.set(0,p,0))}else"rot"===n?(THREE.Quaternion.slerp(w,y,d,p),0===m.quaternionWeight?(k.quaternion.copy(d),m.quaternionWeight=this.weight):(r=this.weight/(this.weight+m.quaternionWeight),THREE.Quaternion.slerp(k.quaternion,d,k.quaternion,r),m.quaternionWeight+=this.weight)):
"scl"===n&&(b.x=w[0]+(y[0]-w[0])*p,b.y=w[1]+(y[1]-w[1])*p,b.z=w[2]+(y[2]-w[2])*p,r=this.weight/(this.weight+m.scaleWeight),k.scale.lerp(b,r),m.scaleWeight+=this.weight)}}return!0}}}();
...
THREE.CylinderGeometry=function(a,c,b,d,f,e){THREE.Geometry.call(this);this.type="CylinderGeometry";this.parameters={radiusTop:a,radiusBottom:c,height:b,radialSegments:d,heightSegments:f,openEnded:e};a=void 0!==a?a:20;c=void 0!==c?c:20;b=void 0!==b?b:100;d=d||8;f=f||1;e=void 0!==e?e:!1;var g=b/2,h,k,l=[],m=[];for(k=0;k<=f;k++){var q=[],n=[],r=k/f,s=r*(c-a)+a;for(h=0;h<=d;h++){var p=h/d,w=new THREE.Vector3;w.x=s*Math.sin(p*Math.PI*2);w.y=-r*b+g;w.z=s*Math.cos(p*Math.PI*2);this.vertices.push(w);q.push(this.vertices.length-
1);n.push(new THREE.Vector2(p,1-r))}l.push(q);m.push(n)}b=(c-a)/b;for(h=0;h<d;h++)for(0!==a?(q=this.vertices[l[0][h]].clone(),n=this.vertices[l[0][h+1]].clone()):(q=this.vertices[l[1][h]].clone(),n=this.vertices[l[1][h+1]].clone()),q.setY(Math.sqrt(q.x*q.x+q.z*q.z)*b).normalize(),n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*b).normalize(),k=0;k<f;k++){var r=l[k][h],s=l[k+1][h],p=l[k+1][h+1],w=l[k][h+1],y=q.clone(),t=q.clone(),H=n.clone(),u=n.clone(),D=m[k][h].clone(),z=m[k+1][h].clone(),x=m[k+1][h+1].clone(),
A=m[k][h+1].clone();this.faces.push(new THREE.Face3(r,s,w,[y,t,u]));this.faceVertexUvs[0].push([D,z,A]);this.faces.push(new THREE.Face3(s,p,w,[t.clone(),H,u.clone()]));this.faceVertexUvs[0].push([z.clone(),x,A.clone()])}if(!1===e&&0<a)for(this.vertices.push(new THREE.Vector3(0,g,0)),h=0;h<d;h++)r=l[0][h],s=l[0][h+1],p=this.vertices.length-1,y=new THREE.Vector3(0,1,0),t=new THREE.Vector3(0,1,0),H=new THREE.Vector3(0,1,0),D=m[0][h].clone(),z=m[0][h+1].clone(),x=new THREE.Vector2(z.x,0),this.faces.push(new THREE.Face3(r,
s,p,[y,t,H])),this.faceVertexUvs[0].push([D,z,x]);if(!1===e&&0<c)for(this.vertices.push(new THREE.Vector3(0,-g,0)),h=0;h<d;h++)r=l[k][h+1],s=l[k][h],p=this.vertices.length-1,y=new THREE.Vector3(0,-1,0),t=new THREE.Vector3(0,-1,0),H=new THREE.Vector3(0,-1,0),D=m[k][h+1].clone(),z=m[k][h].clone(),x=new THREE.Vector2(z.x,1),this.faces.push(new THREE.Face3(r,s,p,[y,t,H])),this.faceVertexUvs[0].push([D,z,x]);this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
Math.sign(g)&&(a=!0),a?(c=-e,a=d,d=Math.sqrt(h)):(c=d,a=e,d=Math.sqrt(h/2));return new THREE.Vector2(c/d,a/d)}function f(b,d){var e,f;for(E=b.length;0<=--E;){e=E;f=E-1;0>f&&(f=b.length-1);for(var g=0,h=r+2*m,g=0;g<h;g++){var k=P*g,l=P*(g+1),p=d+e+k,k=d+f+k,n=d+f+l,l=d+e+l,q=b,s=g,u=h,w=e,y=f,p=p+C,k=k+C,n=n+C,l=l+C;J.faces.push(new THREE.Face3(p,k,l,null,null,t));J.faces.push(new THREE.Face3(k,n,l,null,null,t));p=H.generateSideWallUV(J,a,q,c,p,k,n,l,s,u,w,y);J.faceVertexUvs[0].push([p[0],p[1],p[3]]);
J.faceVertexUvs[0].push([p[1],p[2],p[3]])}}}function e(a,b,c){J.vertices.push(new THREE.Vector3(a,b,c))}function g(b,d,e,f){b+=C;d+=C;e+=C;J.faces.push(new THREE.Face3(b,d,e,null,null,y));b=f?H.generateBottomUV(J,a,c,b,d,e):H.generateTopUV(J,a,c,b,d,e);J.faceVertexUvs[0].push(b)}var h=void 0!==c.amount?c.amount:100,k=void 0!==c.bevelThickness?c.bevelThickness:6,l=void 0!==c.bevelSize?c.bevelSize:k-2,m=void 0!==c.bevelSegments?c.bevelSegments:3,q=void 0!==c.bevelEnabled?c.bevelEnabled:!0,n=void 0!==
c.curveSegments?c.curveSegments:12,r=void 0!==c.steps?c.steps:1,s=c.extrudePath,p,w=!1,y=c.material,t=c.extrudeMaterial,H=void 0!==c.UVGenerator?c.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,u,D,z,x;s&&(p=s.getSpacedPoints(r),w=!0,q=!1,u=void 0!==c.frames?c.frames:new THREE.TubeGeometry.FrenetFrames(s,r,!1),D=new THREE.Vector3,z=new THREE.Vector3,x=new THREE.Vector3);q||(l=k=m=0);var A,B,v,J=this,C=this.vertices.length,s=a.extractPoints(n),n=s.shape,G=s.holes;if(s=!THREE.Shape.Utils.isClockWise(n)){n=
...
U.push(Q);T=T.concat(Q)}for(I=0;I<m;I++){F=I/m;R=k*(1-F);K=l*Math.sin(F*Math.PI/2);E=0;for(F=L.length;E<F;E++)M=b(L[E],s[E],K),e(M.x,M.y,-R);B=0;for(v=G.length;B<v;B++)for(A=G[B],Q=U[B],E=0,F=A.length;E<F;E++)M=b(A[E],Q[E],K),e(M.x,M.y,-R)}K=l;for(E=0;E<P;E++)M=q?b(n[E],T[E],K):n[E],w?(z.copy(u.normals[0]).multiplyScalar(M.x),D.copy(u.binormals[0]).multiplyScalar(M.y),x.copy(p[0]).add(z).add(D),e(x.x,x.y,x.z)):e(M.x,M.y,0);for(F=1;F<=r;F++)for(E=0;E<P;E++)M=q?b(n[E],T[E],K):n[E],w?(z.copy(u.normals[F]).multiplyScalar(M.x),
D.copy(u.binormals[F]).multiplyScalar(M.y),x.copy(p[F]).add(z).add(D),e(x.x,x.y,x.z)):e(M.x,M.y,h/r*F);for(I=m-1;0<=I;I--){F=I/m;R=k*(1-F);K=l*Math.sin(F*Math.PI/2);E=0;for(F=L.length;E<F;E++)M=b(L[E],s[E],K),e(M.x,M.y,h+R);B=0;for(v=G.length;B<v;B++)for(A=G[B],Q=U[B],E=0,F=A.length;E<F;E++)M=b(A[E],Q[E],K),w?e(M.x,M.y+p[r-1].y,p[r-1].x+R):e(M.x,M.y,h+R)}(function(){if(q){var a;a=0*P;for(E=0;E<S;E++)O=N[E],g(O[2]+a,O[1]+a,O[0]+a,!0);a=r+2*m;a*=P;for(E=0;E<S;E++)O=N[E],g(O[0]+a,O[1]+a,O[2]+a,!1)}else{for(E=
0;E<S;E++)O=N[E],g(O[2],O[1],O[0],!0);for(E=0;E<S;E++)O=N[E],g(O[0]+P*r,O[1]+P*r,O[2]+P*r,!1)}})();(function(){var a=0;f(L,a);a+=L.length;B=0;for(v=G.length;B<v;B++)A=G[B],f(A,a),a+=A.length})()};
THREE.ExtrudeGeometry.WorldUVGenerator={generateTopUV:function(a,c,b,d,f,e){c=a.vertices[f].x;f=a.vertices[f].y;b=a.vertices[e].x;e=a.vertices[e].y;return[new THREE.Vector2(a.vertices[d].x,a.vertices[d].y),new THREE.Vector2(c,f),new THREE.Vector2(b,e)]},generateBottomUV:function(a,c,b,d,f,e){return this.generateTopUV(a,c,b,d,f,e)},generateSideWallUV:function(a,c,b,d,f,e,g,h,k,l,m,q){c=a.vertices[f].x;b=a.vertices[f].y;f=a.vertices[f].z;d=a.vertices[e].x;k=a.vertices[e].y;e=a.vertices[e].z;l=a.vertices[g].x;
m=a.vertices[g].y;g=a.vertices[g].z;q=a.vertices[h].x;var n=a.vertices[h].y;a=a.vertices[h].z;return 0.01>Math.abs(b-k)?[new THREE.Vector2(c,1-f),new THREE.Vector2(d,1-e),new THREE.Vector2(l,1-g),new THREE.Vector2(q,1-a)]:[new THREE.Vector2(b,1-f),new THREE.Vector2(k,1-e),new THREE.Vector2(m,1-g),new THREE.Vector2(n,1-a)]}};THREE.ExtrudeGeometry.__v1=new THREE.Vector2;THREE.ExtrudeGeometry.__v2=new THREE.Vector2;THREE.ExtrudeGeometry.__v3=new THREE.Vector2;THREE.ExtrudeGeometry.__v4=new THREE.Vector2;
...
THREE.LatheGeometry=function(a,c,b,d){THREE.Geometry.call(this);this.type="LatheGeometry";this.parameters={points:a,segments:c,phiStart:b,phiLength:d};c=c||12;b=b||0;d=d||2*Math.PI;for(var f=1/(a.length-1),e=1/c,g=0,h=c;g<=h;g++)for(var k=b+g*e*d,l=Math.cos(k),m=Math.sin(k),k=0,q=a.length;k<q;k++){var n=a[k],r=new THREE.Vector3;r.x=l*n.x-m*n.y;r.y=m*n.x+l*n.y;r.z=n.z;this.vertices.push(r)}b=a.length;g=0;for(h=c;g<h;g++)for(k=0,q=a.length-1;k<q;k++){c=m=k+b*g;d=m+b;var l=m+1+b,m=m+1,n=g*e,r=k*f,s=
n+e,p=r+f;this.faces.push(new THREE.Face3(c,d,m));this.faceVertexUvs[0].push([new THREE.Vector2(n,r),new THREE.Vector2(s,r),new THREE.Vector2(n,p)]);this.faces.push(new THREE.Face3(d,l,m));this.faceVertexUvs[0].push([new THREE.Vector2(s,r),new THREE.Vector2(s,p),new THREE.Vector2(n,p)])}this.mergeVertices();this.computeFaceNormals();this.computeVertexNormals()};THREE.LatheGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.PlaneGeometry=function(a,c,b,d){console.info("THREE.PlaneGeometry: Consider using THREE.PlaneBufferGeometry for lower memory footprint.");THREE.Geometry.call(this);this.type="PlaneGeometry";this.parameters={width:a,height:c,widthSegments:b,heightSegments:d};this.fromBufferGeometry(new THREE.PlaneBufferGeometry(a,c,b,d))};THREE.PlaneGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.PlaneBufferGeometry=function(a,c,b,d){THREE.BufferGeometry.call(this);this.type="PlaneBufferGeometry";this.parameters={width:a,height:c,widthSegments:b,heightSegments:d};var f=a/2,e=c/2;b=b||1;d=d||1;var g=b+1,h=d+1,k=a/b,l=c/d;c=new Float32Array(g*h*3);a=new Float32Array(g*h*3);for(var m=new Float32Array(g*h*2),q=0,n=0,r=0;r<h;r++)for(var s=r*l-e,p=0;p<g;p++)c[q]=p*k-f,c[q+1]=-s,a[q+2]=1,m[n]=p/b,m[n+1]=1-r/d,q+=3,n+=2;q=0;f=new (65535<c.length/3?Uint32Array:Uint16Array)(b*d*6);for(r=0;r<d;r++)for(p=
0;p<b;p++)e=p+g*(r+1),h=p+1+g*(r+1),k=p+1+g*r,f[q]=p+g*r,f[q+1]=e,f[q+2]=k,f[q+3]=e,f[q+4]=h,f[q+5]=k,q+=6;this.addAttribute("index",new THREE.BufferAttribute(f,1));this.addAttribute("position",new THREE.BufferAttribute(c,3));this.addAttribute("normal",new THREE.BufferAttribute(a,3));this.addAttribute("uv",new THREE.BufferAttribute(m,2))};THREE.PlaneBufferGeometry.prototype=Object.create(THREE.BufferGeometry.prototype);
THREE.RingGeometry=function(a,c,b,d,f,e){THREE.Geometry.call(this);this.type="RingGeometry";this.parameters={innerRadius:a,outerRadius:c,thetaSegments:b,phiSegments:d,thetaStart:f,thetaLength:e};a=a||0;c=c||50;f=void 0!==f?f:0;e=void 0!==e?e:2*Math.PI;b=void 0!==b?Math.max(3,b):8;d=void 0!==d?Math.max(1,d):8;var g,h=[],k=a,l=(c-a)/d;for(a=0;a<d+1;a++){for(g=0;g<b+1;g++){var m=new THREE.Vector3,q=f+g/b*e;m.x=k*Math.cos(q);m.y=k*Math.sin(q);this.vertices.push(m);h.push(new THREE.Vector2((m.x/c+1)/2,
(m.y/c+1)/2))}k+=l}c=new THREE.Vector3(0,0,1);for(a=0;a<d;a++)for(f=a*(b+1),g=0;g<b;g++)e=q=g+f,l=q+b+1,m=q+b+2,this.faces.push(new THREE.Face3(e,l,m,[c.clone(),c.clone(),c.clone()])),this.faceVertexUvs[0].push([h[e].clone(),h[l].clone(),h[m].clone()]),e=q,l=q+b+2,m=q+1,this.faces.push(new THREE.Face3(e,l,m,[c.clone(),c.clone(),c.clone()])),this.faceVertexUvs[0].push([h[e].clone(),h[l].clone(),h[m].clone()]);this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,k)};
THREE.RingGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.SphereGeometry=function(a,c,b,d,f,e,g){THREE.Geometry.call(this);this.type="SphereGeometry";this.parameters={radius:a,widthSegments:c,heightSegments:b,phiStart:d,phiLength:f,thetaStart:e,thetaLength:g};a=a||50;c=Math.max(3,Math.floor(c)||8);b=Math.max(2,Math.floor(b)||6);d=void 0!==d?d:0;f=void 0!==f?f:2*Math.PI;e=void 0!==e?e:0;g=void 0!==g?g:Math.PI;var h,k,l=[],m=[];for(k=0;k<=b;k++){var q=[],n=[];for(h=0;h<=c;h++){var r=h/c,s=k/b,p=new THREE.Vector3;p.x=-a*Math.cos(d+r*f)*Math.sin(e+s*g);
p.y=a*Math.cos(e+s*g);p.z=a*Math.sin(d+r*f)*Math.sin(e+s*g);this.vertices.push(p);q.push(this.vertices.length-1);n.push(new THREE.Vector2(r,1-s))}l.push(q);m.push(n)}for(k=0;k<b;k++)for(h=0;h<c;h++){d=l[k][h+1];f=l[k][h];e=l[k+1][h];g=l[k+1][h+1];var q=this.vertices[d].clone().normalize(),n=this.vertices[f].clone().normalize(),r=this.vertices[e].clone().normalize(),s=this.vertices[g].clone().normalize(),p=m[k][h+1].clone(),w=m[k][h].clone(),y=m[k+1][h].clone(),t=m[k+1][h+1].clone();Math.abs(this.vertices[d].y)===
a?(p.x=(p.x+w.x)/2,this.faces.push(new THREE.Face3(d,e,g,[q,r,s])),this.faceVertexUvs[0].push([p,y,t])):Math.abs(this.vertices[e].y)===a?(y.x=(y.x+t.x)/2,this.faces.push(new THREE.Face3(d,f,e,[q,n,r])),this.faceVertexUvs[0].push([p,w,y])):(this.faces.push(new THREE.Face3(d,f,g,[q,n,s])),this.faceVertexUvs[0].push([p,w,t]),this.faces.push(new THREE.Face3(f,e,g,[n.clone(),r,s.clone()])),this.faceVertexUvs[0].push([w.clone(),y,t.clone()]))}this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,
...
THREE.TorusGeometry=function(a,c,b,d,f){THREE.Geometry.call(this);this.type="TorusGeometry";this.parameters={radius:a,tube:c,radialSegments:b,tubularSegments:d,arc:f};a=a||100;c=c||40;b=b||8;d=d||6;f=f||2*Math.PI;for(var e=new THREE.Vector3,g=[],h=[],k=0;k<=b;k++)for(var l=0;l<=d;l++){var m=l/d*f,q=k/b*Math.PI*2;e.x=a*Math.cos(m);e.y=a*Math.sin(m);var n=new THREE.Vector3;n.x=(a+c*Math.cos(q))*Math.cos(m);n.y=(a+c*Math.cos(q))*Math.sin(m);n.z=c*Math.sin(q);this.vertices.push(n);g.push(new THREE.Vector2(l/
...
THREE.TorusKnotGeometry=function(a,c,b,d,f,e,g){function h(a,b,c,d,e){var f=Math.cos(a),g=Math.sin(a);a*=b/c;b=Math.cos(a);f*=d*(2+b)*0.5;g=d*(2+b)*g*0.5;d=e*d*Math.sin(a)*0.5;return new THREE.Vector3(f,g,d)}THREE.Geometry.call(this);this.type="TorusKnotGeometry";this.parameters={radius:a,tube:c,radialSegments:b,tubularSegments:d,p:f,q:e,heightScale:g};a=a||100;c=c||40;b=b||64;d=d||8;f=f||2;e=e||3;g=g||1;for(var k=Array(b),l=new THREE.Vector3,m=new THREE.Vector3,q=new THREE.Vector3,n=0;n<b;++n){k[n]=
Array(d);var r=n/b*2*f*Math.PI,s=h(r,e,f,a,g),r=h(r+0.01,e,f,a,g);l.subVectors(r,s);m.addVectors(r,s);q.crossVectors(l,m);m.crossVectors(q,l);q.normalize();m.normalize();for(r=0;r<d;++r){var p=r/d*2*Math.PI,w=-c*Math.cos(p),p=c*Math.sin(p),y=new THREE.Vector3;y.x=s.x+w*m.x+p*q.x;y.y=s.y+w*m.y+p*q.y;y.z=s.z+w*m.z+p*q.z;k[n][r]=this.vertices.push(y)-1}}for(n=0;n<b;++n)for(r=0;r<d;++r)f=(n+1)%b,e=(r+1)%d,a=k[n][r],c=k[f][r],f=k[f][e],e=k[n][e],g=new THREE.Vector2(n/b,r/d),l=new THREE.Vector2((n+1)/b,
r/d),m=new THREE.Vector2((n+1)/b,(r+1)/d),q=new THREE.Vector2(n/b,(r+1)/d),this.faces.push(new THREE.Face3(a,c,e)),this.faceVertexUvs[0].push([g,l,q]),this.faces.push(new THREE.Face3(c,f,e)),this.faceVertexUvs[0].push([l.clone(),m,q.clone()]);this.computeFaceNormals();this.computeVertexNormals()};THREE.TorusKnotGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.TubeGeometry=function(a,c,b,d,f){THREE.Geometry.call(this);this.type="TubeGeometry";this.parameters={path:a,segments:c,radius:b,radialSegments:d,closed:f};c=c||64;b=b||1;d=d||8;f=f||!1;var e=[],g,h,k=c+1,l,m,q,n,r=new THREE.Vector3,s,p,w;s=new THREE.TubeGeometry.FrenetFrames(a,c,f);p=s.normals;w=s.binormals;this.tangents=s.tangents;this.normals=p;this.binormals=w;for(s=0;s<k;s++)for(e[s]=[],l=s/(k-1),n=a.getPointAt(l),g=p[s],h=w[s],l=0;l<d;l++)m=l/d*2*Math.PI,q=-b*Math.cos(m),m=b*Math.sin(m),
r.copy(n),r.x+=q*g.x+m*h.x,r.y+=q*g.y+m*h.y,r.z+=q*g.z+m*h.z,e[s][l]=this.vertices.push(new THREE.Vector3(r.x,r.y,r.z))-1;for(s=0;s<c;s++)for(l=0;l<d;l++)k=f?(s+1)%c:s+1,r=(l+1)%d,a=e[s][l],b=e[k][l],k=e[k][r],r=e[s][r],p=new THREE.Vector2(s/c,l/d),w=new THREE.Vector2((s+1)/c,l/d),g=new THREE.Vector2((s+1)/c,(l+1)/d),h=new THREE.Vector2(s/c,(l+1)/d),this.faces.push(new THREE.Face3(a,b,r)),this.faceVertexUvs[0].push([p,w,h]),this.faces.push(new THREE.Face3(b,k,r)),this.faceVertexUvs[0].push([w.clone(),
...
Math.pow(2,b);Math.pow(4,b);for(var d=f(k.vertices[a.a]),g=f(k.vertices[a.b]),h=f(k.vertices[a.c]),l=[],p=0;p<=c;p++){l[p]=[];for(var m=f(d.clone().lerp(h,p/c)),n=f(g.clone().lerp(h,p/c)),r=c-p,q=0;q<=r;q++)l[p][q]=0==q&&p==c?m:f(m.clone().lerp(n,q/r))}for(p=0;p<c;p++)for(q=0;q<2*(c-p)-1;q++)d=Math.floor(q/2),0==q%2?e(l[p][d+1],l[p+1][d],l[p][d]):e(l[p][d+1],l[p+1][d+1],l[p+1][d])}function h(a,b,c){0>c&&1===a.x&&(a=new THREE.Vector2(a.x-1,a.y));0===b.x&&0===b.z&&(a=new THREE.Vector2(c/2/Math.PI+0.5,
a.y));return a.clone()}THREE.Geometry.call(this);this.type="PolyhedronGeometry";this.parameters={vertices:a,indices:c,radius:b,detail:d};b=b||1;d=d||0;for(var k=this,l=0,m=a.length;l<m;l+=3)f(new THREE.Vector3(a[l],a[l+1],a[l+2]));a=this.vertices;for(var q=[],n=l=0,m=c.length;l<m;l+=3,n++){var r=a[c[l]],s=a[c[l+1]],p=a[c[l+2]];q[n]=new THREE.Face3(r.index,s.index,p.index,[r.clone(),s.clone(),p.clone()])}for(var w=new THREE.Vector3,l=0,m=q.length;l<m;l++)g(q[l],d);l=0;for(m=this.faceVertexUvs[0].length;l<
m;l++)c=this.faceVertexUvs[0][l],d=c[0].x,a=c[1].x,q=c[2].x,n=Math.max(d,Math.max(a,q)),r=Math.min(d,Math.min(a,q)),0.9<n&&0.1>r&&(0.2>d&&(c[0].x+=1),0.2>a&&(c[1].x+=1),0.2>q&&(c[2].x+=1));l=0;for(m=this.vertices.length;l<m;l++)this.vertices[l].multiplyScalar(b);this.mergeVertices();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,b)};THREE.PolyhedronGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.ParametricGeometry=function(a,c,b){THREE.Geometry.call(this);this.type="ParametricGeometry";this.parameters={func:a,slices:c,stacks:b};var d=this.vertices,f=this.faces,e=this.faceVertexUvs[0],g,h,k,l,m=c+1;for(g=0;g<=b;g++)for(l=g/b,h=0;h<=c;h++)k=h/c,k=a(k,l),d.push(k);var q,n,r,s;for(g=0;g<b;g++)for(h=0;h<c;h++)a=g*m+h,d=g*m+h+1,l=(g+1)*m+h+1,k=(g+1)*m+h,q=new THREE.Vector2(h/c,g/b),n=new THREE.Vector2((h+1)/c,g/b),r=new THREE.Vector2((h+1)/c,(g+1)/b),s=new THREE.Vector2(h/c,(g+1)/b),f.push(new THREE.Face3(a,
...
THREE.EdgesHelper=function(a,c){var b=void 0!==c?c:16777215,d=[0,0],f={},e=function(a,b){return a-b},g=["a","b","c"],h=new THREE.BufferGeometry,k=a.geometry.clone();k.mergeVertices();k.computeFaceNormals();for(var l=k.vertices,k=k.faces,m=0,q=0,n=k.length;q<n;q++)for(var r=k[q],s=0;3>s;s++){d[0]=r[g[s]];d[1]=r[g[(s+1)%3]];d.sort(e);var p=d.toString();void 0===f[p]?(f[p]={vert1:d[0],vert2:d[1],face1:q,face2:void 0},m++):f[p].face2=q}h.addAttribute("position",new THREE.BufferAttribute(new Float32Array(6*
...
THREE.VertexTangentsHelper.prototype.update=function(a){var c=new THREE.Vector3;return function(a){a=["a","b","c","d"];this.object.updateMatrixWorld(!0);for(var d=this.geometry.vertices,f=this.object.geometry.vertices,e=this.object.geometry.faces,g=this.object.matrixWorld,h=0,k=0,l=e.length;k<l;k++)for(var m=e[k],q=0,n=m.vertexTangents.length;q<n;q++){var r=m.vertexTangents[q];d[h].copy(f[m[a[q]]]).applyMatrix4(g);c.copy(r).transformDirection(g).multiplyScalar(this.size);c.add(d[h]);h+=1;d[h].copy(c);
h+=1}this.geometry.verticesNeedUpdate=!0;return this}}();
THREE.WireframeHelper=function(a,c){var b=void 0!==c?c:16777215,d=[0,0],f={},e=function(a,b){return a-b},g=["a","b","c"],h=new THREE.BufferGeometry;if(a.geometry instanceof THREE.Geometry){for(var k=a.geometry.vertices,l=a.geometry.faces,m=0,q=new Uint32Array(6*l.length),n=0,r=l.length;n<r;n++)for(var s=l[n],p=0;3>p;p++){d[0]=s[g[p]];d[1]=s[g[(p+1)%3]];d.sort(e);var w=d.toString();void 0===f[w]&&(q[2*m]=d[0],q[2*m+1]=d[1],f[w]=!0,m++)}d=new Float32Array(6*m);n=0;for(r=m;n<r;n++)for(p=0;2>p;p++)m=
k[q[2*n+p]],g=6*n+3*p,d[g+0]=m.x,d[g+1]=m.y,d[g+2]=m.z;h.addAttribute("position",new THREE.BufferAttribute(d,3))}else if(a.geometry instanceof THREE.BufferGeometry){if(void 0!==a.geometry.attributes.index){for(var k=a.geometry.attributes.position.array,r=a.geometry.attributes.index.array,l=a.geometry.offsets,m=0,q=new Uint32Array(2*r.length),s=0,y=l.length;s<y;++s)for(var p=l[s].start,w=l[s].count,g=l[s].index,n=p,t=p+w;n<t;n+=3)for(p=0;3>p;p++)d[0]=g+r[n+p],d[1]=g+r[n+(p+1)%3],d.sort(e),w=d.toString(),
void 0===f[w]&&(q[2*m]=d[0],q[2*m+1]=d[1],f[w]=!0,m++);d=new Float32Array(6*m);n=0;for(r=m;n<r;n++)for(p=0;2>p;p++)g=6*n+3*p,m=3*q[2*n+p],d[g+0]=k[m],d[g+1]=k[m+1],d[g+2]=k[m+2]}else for(k=a.geometry.attributes.position.array,m=k.length/3,q=m/3,d=new Float32Array(6*m),n=0,r=q;n<r;n++)for(p=0;3>p;p++)g=18*n+6*p,q=9*n+3*p,d[g+0]=k[q],d[g+1]=k[q+1],d[g+2]=k[q+2],m=9*n+(p+1)%3*3,d[g+3]=k[m],d[g+4]=k[m+1],d[g+5]=k[m+2];h.addAttribute("position",new THREE.BufferAttribute(d,3))}THREE.Line.call(this,h,new THREE.LineBasicMaterial({color:b}),
...
THREE.LensFlarePlugin=function(){function a(a,c){var d=b.createProgram(),e=b.createShader(b.FRAGMENT_SHADER),f=b.createShader(b.VERTEX_SHADER),g="precision "+c+" float;\nprecision "+c+" int;\n";b.shaderSource(e,g+a.fragmentShader);b.shaderSource(f,g+a.vertexShader);b.compileShader(e);b.compileShader(f);b.attachShader(d,e);b.attachShader(d,f);b.linkProgram(d);return d}var c=[],b,d,f,e,g,h,k,l,m,q,n,r,s;this.init=function(c){b=c.context;d=c;f=c.getPrecision();e=new Float32Array(16);g=new Uint16Array(6);
...
THREE.DepthPassPlugin=function(){function a(b,c,d){if(c.visible){var e=f[c.id];if(e&&(!1===c.frustumCulled||!0===m.intersectsObject(c)))for(var g=0,h=e.length;g<h;g++){var k=e[g];c._modelViewMatrix.multiplyMatrices(d.matrixWorldInverse,c.matrixWorld);n.push(k)}g=0;for(h=c.children.length;g<h;g++)a(b,c.children[g],d)}}this.enabled=!1;this.renderTarget=null;var c,b,d,f,e,g,h,k,l,m=new THREE.Frustum,q=new THREE.Matrix4,n=[];this.init=function(a,m,p,n){c=a.context;b=a;d=m;f=p;e=n;a=THREE.ShaderLib.depthRGBA;
...
!0;h._shadowPass=!0;k._shadowPass=!0;l._shadowPass=!0};this.render=function(a,b){this.enabled&&this.update(a,b)};this.update=function(f,s){var p,w,y,t,H,u;c.clearColor(1,1,1,1);c.disable(c.BLEND);b.setDepthTest(!0);!0===f.autoUpdate&&f.updateMatrixWorld();s.matrixWorldInverse.getInverse(s.matrixWorld);q.multiplyMatrices(s.projectionMatrix,s.matrixWorldInverse);m.setFromMatrix(q);b.setRenderTarget(this.renderTarget);b.clear();n.length=0;a(f,f,s);var D;p=0;for(w=n.length;p<w;p++)H=n[p],u=H.object,y=
