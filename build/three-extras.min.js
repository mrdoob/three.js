...
255,i>>8&255,i>>16&255,i>>24&255)),d}d.mipmapCount=1;h[2]&131072&&!1!==a&&(d.mipmapCount=Math.max(1,h[7]));d.isCubemap=h[28]&512?!0:!1;d.width=h[4];d.height=h[3];for(var h=h[1]+4,f=d.width,g=d.height,i=d.isCubemap?6:1,k=0;k<i;k++){for(var n=0;n<d.mipmapCount;n++){if(j){var m;m=f;for(var p=g,q=4*m*p,l=new Uint8Array(b,h,q),q=new Uint8Array(q),s=0,t=0,r=0;r<p;r++)for(var B=0;B<m;B++){var x=l[t];t++;var u=l[t];t++;var v=l[t];t++;var z=l[t];t++;q[s]=v;s++;q[s]=u;s++;q[s]=x;s++;q[s]=z;s++}m=q;p=m.length}else p=
Math.max(4,f)/4*Math.max(4,g)/4*e,m=new Uint8Array(b,h,p);d.mipmaps.push({data:m,width:f,height:g});h+=p;f=Math.max(0.5*f,1);g=Math.max(0.5*g,1)}f=d.width;g=d.height}return d},getNormalMap:function(b,a){var c=function(a){var b=Math.sqrt(a[0]*a[0]+a[1]*a[1]+a[2]*a[2]);return[a[0]/b,a[1]/b,a[2]/b]},a=a|1,d=b.width,e=b.height,f=document.createElement("canvas");f.width=d;f.height=e;var g=f.getContext("2d");g.drawImage(b,0,0);for(var h=g.getImageData(0,0,d,e).data,i=g.createImageData(d,e),j=i.data,k=0;k<
d;k++)for(var n=0;n<e;n++){var m=0>n-1?0:n-1,p=n+1>e-1?e-1:n+1,q=0>k-1?0:k-1,l=k+1>d-1?d-1:k+1,s=[],t=[0,0,h[4*(n*d+k)]/255*a];s.push([-1,0,h[4*(n*d+q)]/255*a]);s.push([-1,-1,h[4*(m*d+q)]/255*a]);s.push([0,-1,h[4*(m*d+k)]/255*a]);s.push([1,-1,h[4*(m*d+l)]/255*a]);s.push([1,0,h[4*(n*d+l)]/255*a]);s.push([1,1,h[4*(p*d+l)]/255*a]);s.push([0,1,h[4*(p*d+k)]/255*a]);s.push([-1,1,h[4*(p*d+q)]/255*a]);m=[];q=s.length;for(p=0;p<q;p++){var l=s[p],r=s[(p+1)%q],l=[l[0]-t[0],l[1]-t[1],l[2]-t[2]],r=[r[0]-t[0],
r[1]-t[1],r[2]-t[2]];m.push(c([l[1]*r[2]-l[2]*r[1],l[2]*r[0]-l[0]*r[2],l[0]*r[1]-l[1]*r[0]]))}s=[0,0,0];for(p=0;p<m.length;p++)s[0]+=m[p][0],s[1]+=m[p][1],s[2]+=m[p][2];s[0]/=m.length;s[1]/=m.length;s[2]/=m.length;t=4*(n*d+k);j[t]=255*((s[0]+1)/2)|0;j[t+1]=255*((s[1]+1)/2)|0;j[t+2]=255*s[2]|0;j[t+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(b,a,c){for(var d=b*a,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+
...
0,e=String(b).split(""),f=e.length,g=[],b=0;b<f;b++){var h=new THREE.Path,h=this.extractGlyphPoints(e[b],a,c,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(b,a,c,d,e){var f=[],g,h,i,j,k,n,m,p,q,l,s,t=a.glyphs[b]||a.glyphs["?"];if(t){if(t.o){a=t._cachedOutline||(t._cachedOutline=t.o.split(" "));j=a.length;for(b=0;b<j;)switch(i=a[b++],i){case "m":i=a[b++]*c+d;k=a[b++]*c;e.moveTo(i,k);break;case "l":i=a[b++]*c+d;k=a[b++]*c;e.lineTo(i,k);break;case "q":i=a[b++]*
c+d;k=a[b++]*c;p=a[b++]*c+d;q=a[b++]*c;e.quadraticCurveTo(p,q,i,k);if(g=f[f.length-1]){n=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++){var r=g/h;THREE.Shape.Utils.b2(r,n,p,i);THREE.Shape.Utils.b2(r,m,q,k)}}break;case "b":if(i=a[b++]*c+d,k=a[b++]*c,p=a[b++]*c+d,q=a[b++]*-c,l=a[b++]*c+d,s=a[b++]*-c,e.bezierCurveTo(i,k,p,q,l,s),g=f[f.length-1]){n=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++)r=g/h,THREE.Shape.Utils.b3(r,n,p,l,i),THREE.Shape.Utils.b3(r,m,q,s,k)}}}return{offset:t.ha*c,path:e}}}};
...
(function(b){var a=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};b.Triangulate=function(b,d){var e=b.length;if(3>e)return null;var f=[],g=[],h=[],i,j,k;if(0<a(b))for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var n=2*e;for(j=e-1;2<e;){if(0>=n--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);k=j+1;e<=k&&(k=0);var m;a:{var p=m=void 0,q=void 0,l=void 0,s=void 0,t=void 0,r=void 0,B=void 0,x=
void 0,p=b[g[i]].x,q=b[g[i]].y,l=b[g[j]].x,s=b[g[j]].y,t=b[g[k]].x,r=b[g[k]].y;if(1E-10>(l-p)*(r-q)-(s-q)*(t-p))m=!1;else{var u=void 0,v=void 0,z=void 0,w=void 0,A=void 0,D=void 0,E=void 0,I=void 0,H=void 0,K=void 0,H=I=E=x=B=void 0,u=t-l,v=r-s,z=p-t,w=q-r,A=l-p,D=s-q;for(m=0;m<e;m++)if(!(m===i||m===j||m===k))if(B=b[g[m]].x,x=b[g[m]].y,E=B-p,I=x-q,H=B-l,K=x-s,B-=t,x-=r,H=u*K-v*H,E=A*I-D*E,I=z*x-w*B,-1E-10<=H&&-1E-10<=I&&-1E-10<=E){m=!1;break a}m=!0}}if(m){f.push([b[g[i]],b[g[j]],b[g[k]]]);h.push([g[i],
...
THREE.Path.prototype.getPoints=function(b,a){if(this.useSpacedPoints)return console.log("tata"),this.getSpacedPoints(b,a);var b=b||12,c=[],d,e,f,g,h,i,j,k,n,m,p,q,l;d=0;for(e=this.actions.length;d<e;d++)switch(f=this.actions[d],g=f.action,f=f.args,g){case THREE.PathActions.MOVE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.LINE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=f[2];i=f[3];n=f[0];m=f[1];0<c.length?(g=c[c.length-1],p=g.x,
q=g.y):(g=this.actions[d-1].args,p=g[g.length-2],q=g[g.length-1]);for(f=1;f<=b;f++)l=f/b,g=THREE.Shape.Utils.b2(l,p,n,h),l=THREE.Shape.Utils.b2(l,q,m,i),c.push(new THREE.Vector2(g,l));break;case THREE.PathActions.BEZIER_CURVE_TO:h=f[4];i=f[5];n=f[0];m=f[1];j=f[2];k=f[3];0<c.length?(g=c[c.length-1],p=g.x,q=g.y):(g=this.actions[d-1].args,p=g[g.length-2],q=g[g.length-1]);for(f=1;f<=b;f++)l=f/b,g=THREE.Shape.Utils.b3(l,p,n,j,h),l=THREE.Shape.Utils.b3(l,q,m,k,i),c.push(new THREE.Vector2(g,l));break;case THREE.PathActions.CSPLINE_THRU:g=
this.actions[d-1].args;l=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=b*f[0].length;l=l.concat(f[0]);l=new THREE.SplineCurve(l);for(f=1;f<=g;f++)c.push(l.getPointAt(f/g));break;case THREE.PathActions.ARC:h=f[0];i=f[1];m=f[2];j=f[3];g=f[4];n=!!f[5];p=g-j;q=2*b;for(f=1;f<=q;f++)l=f/q,n||(l=1-l),l=j+l*p,g=h+m*Math.cos(l),l=i+m*Math.sin(l),c.push(new THREE.Vector2(g,l));break;case THREE.PathActions.ELLIPSE:h=f[0];i=f[1];m=f[2];k=f[3];j=f[4];g=f[5];n=!!f[6];p=g-j;q=2*b;for(f=1;f<=q;f++)l=f/q,n||
(l=1-l),l=j+l*p,g=h+m*Math.cos(l),l=i+k*Math.sin(l),c.push(new THREE.Vector2(g,l))}d=c[c.length-1];1E-10>Math.abs(d.x-c[0].x)&&1E-10>Math.abs(d.y-c[0].y)&&c.splice(c.length-1,1);a&&c.push(c[0]);return c};
...
THREE.Shape.Utils={removeHoles:function(b,a){var c=b.concat(),d=c.concat(),e,f,g,h,i,j,k,n,m,p,q=[];for(i=0;i<a.length;i++){j=a[i];Array.prototype.push.apply(d,j);f=Number.POSITIVE_INFINITY;for(e=0;e<j.length;e++){m=j[e];p=[];for(n=0;n<c.length;n++)k=c[n],k=m.distanceToSquared(k),p.push(k),k<f&&(f=k,g=e,h=n)}e=0<=h-1?h-1:c.length-1;f=0<=g-1?g-1:j.length-1;var l=[j[g],c[h],c[e]];n=THREE.FontUtils.Triangulate.area(l);var s=[j[g],j[f],c[h]];m=THREE.FontUtils.Triangulate.area(s);p=h;k=g;h+=1;g+=-1;0>
h&&(h+=c.length);h%=c.length;0>g&&(g+=j.length);g%=j.length;e=0<=h-1?h-1:c.length-1;f=0<=g-1?g-1:j.length-1;l=[j[g],c[h],c[e]];l=THREE.FontUtils.Triangulate.area(l);s=[j[g],j[f],c[h]];s=THREE.FontUtils.Triangulate.area(s);n+m>l+s&&(h=p,g=k,0>h&&(h+=c.length),h%=c.length,0>g&&(g+=j.length),g%=j.length,e=0<=h-1?h-1:c.length-1,f=0<=g-1?g-1:j.length-1);n=c.slice(0,h);m=c.slice(h);p=j.slice(g);k=j.slice(0,g);f=[j[g],j[f],c[h]];q.push([j[g],c[h],c[e]]);q.push(f);c=n.concat(p).concat(k).concat(m)}return{shape:c,
...
THREE.Animation.prototype.update=function(b){if(!1!==this.isPlaying){var a=["pos","rot","scl"],c,d,e,f,g,h,i,j,k;k=this.currentTime+=b*this.timeScale;j=this.currentTime%=this.data.length;parseInt(Math.min(j*this.data.fps,this.data.length*this.data.fps),10);for(var n=0,m=this.hierarchy.length;n<m;n++){b=this.hierarchy[n];i=b.animationCache;for(var p=0;3>p;p++){c=a[p];g=i.prevKey[c];h=i.nextKey[c];if(h.time<=k){if(j<k)if(this.loop){if(g=this.data.hierarchy[n].keys[0],h=this.getNextKeyWith(c,n,1),g!=
h)for(;h.time<j;)g=h,h=this.getNextKeyWith(c,n,h.index+1)}else{this.stop();return}else{do g=h,h=this.getNextKeyWith(c,n,h.index+1);while(h.time<j&&g!=h)}i.prevKey[c]=g;i.nextKey[c]=h}b.matrixAutoUpdate=!0;b.matrixWorldNeedsUpdate=!0;d=(j-g.time)/(h.time-g.time);e=g[c];f=h[c];if(0>d||1<d)console.log("THREE.Animation.update: Warning! Scale out of bounds:"+d+" on bone "+n),d=0>d?0:1;if("pos"===c)if(c=b.position,this.interpolationType===THREE.AnimationHandler.LINEAR)c.x=e[0]+(f[0]-e[0])*d,c.y=e[1]+(f[1]-
e[1])*d,c.z=e[2]+(f[2]-e[2])*d;else{if(this.interpolationType===THREE.AnimationHandler.CATMULLROM||this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD)this.points[0]=this.getPrevKeyWith("pos",n,g.index-1).pos,this.points[1]=e,this.points[2]=f,this.points[3]=this.getNextKeyWith("pos",n,h.index+1).pos,d=0.33*d+0.33,e=this.interpolateCatmullRom(this.points,d),c.x=e[0],c.y=e[1],c.z=e[2],this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD&&(d=this.interpolateCatmullRom(this.points,
...
THREE.CombinedCamera.prototype.toTopView=function(){this.rotation.x=-Math.PI/2;this.rotation.y=0;this.rotation.z=0;this.rotationAutoUpdate=!1};THREE.CombinedCamera.prototype.toBottomView=function(){this.rotation.x=Math.PI/2;this.rotation.y=0;this.rotation.z=0;this.rotationAutoUpdate=!1};THREE.CircleGeometry=function(b,a,c,d,e){THREE.Geometry.call(this);this.radius=b=b||50;this.segments=a=void 0!==a?Math.max(3,a):8;this.thetaStart=c=void 0!==c?c:0;this.thetaLength=d=void 0!==d?d:2*Math.PI;e>=b&&(console.warn("CircleGeometry: Can't set the innerRadius to be greater than the radius."),e=0);var f,g=[];if(!e){f=new THREE.Vector3;var h=new THREE.Vector2(0.5,0.5);this.vertices.push(f);g.push(h)}for(f=0;f<=a;f++){var i;e&&(i=new THREE.Vector3,i.x=e*Math.cos(c+f/a*d),i.y=e*Math.sin(c+f/a*
d),this.vertices.push(i),g.push(new THREE.Vector2((i.x/b+1)/2,(i.y/b+1)/2)));i=new THREE.Vector3;i.x=b*Math.cos(c+f/a*d);i.y=b*Math.sin(c+f/a*d);this.vertices.push(i);g.push(new THREE.Vector2((i.x/b+1)/2,(i.y/b+1)/2))}c=new THREE.Vector3(0,0,-1);for(f=1;f<=a;f++)if(e){d=2*(f-1)+1;i=2*(f-1);var j=2*f+1,k=2*f;this.faces.push(new THREE.Face3(d,i,j,[c,c,c]));this.faces.push(new THREE.Face3(i,k,j,[c,c,c]));this.faceVertexUvs[0].push([g[d],g[i],g[j]]);this.faceVertexUvs[0].push([g[i],g[k],g[j]])}else d=
f,i=f+1,j=0,this.faces.push(new THREE.Face3(d,i,j,[c,c,c])),this.faceVertexUvs[0].push([g[f],g[f+1],h]);this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,b)};THREE.CircleGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CubeGeometry=function(b,a,c,d,e,f){function g(a,b,c,d,e,f,g,l){var s,t=h.widthSegments,r=h.heightSegments,B=e/2,x=f/2,u=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)s="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)s="y",r=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)s="x",t=h.depthSegments;var v=t+1,z=r+1,w=e/t,A=f/r,D=new THREE.Vector3;D[s]=0<g?1:-1;for(e=0;e<z;e++)for(f=0;f<v;f++){var E=new THREE.Vector3;E[a]=(f*w-B)*c;E[b]=(e*A-x)*d;E[s]=g;h.vertices.push(E)}for(e=
0;e<r;e++)for(f=0;f<t;f++)x=f+v*e,a=f+v*(e+1),b=f+1+v*(e+1),c=f+1+v*e,d=new THREE.Vector2(f/t,1-e/r),g=new THREE.Vector2(f/t,1-(e+1)/r),s=new THREE.Vector2((f+1)/t,1-(e+1)/r),B=new THREE.Vector2((f+1)/t,1-e/r),x=new THREE.Face3(x+u,a+u,c+u),x.normal.copy(D),x.vertexNormals.push(D.clone(),D.clone(),D.clone()),x.materialIndex=l,h.faces.push(x),h.faceVertexUvs[0].push([d,g,B]),x=new THREE.Face3(a+u,b+u,c+u),x.normal.copy(D),x.vertexNormals.push(D.clone(),D.clone(),D.clone()),x.materialIndex=l,h.faces.push(x),
h.faceVertexUvs[0].push([g.clone(),s,B.clone()])}THREE.Geometry.call(this);var h=this;this.width=b;this.height=a;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;b=this.width/2;a=this.height/2;c=this.depth/2;g("z","y",-1,-1,this.depth,this.height,b,0);g("z","y",1,-1,this.depth,this.height,-b,1);g("x","z",1,1,this.width,this.depth,a,2);g("x","z",1,-1,this.width,this.depth,-a,3);g("x","y",1,-1,this.width,this.height,c,4);g("x","y",-1,-1,this.width,this.height,-c,
5);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CylinderGeometry=function(b,a,c,d,e,f){THREE.Geometry.call(this);this.radiusTop=b=void 0!==b?b:20;this.radiusBottom=a=void 0!==a?a:20;this.height=c=void 0!==c?c:100;this.radialSegments=d=d||8;this.heightSegments=e=e||1;this.openEnded=f=void 0!==f?f:!1;var g=c/2,h,i,j=[],k=[];for(i=0;i<=e;i++){var n=[],m=[],p=i/e,q=p*(a-b)+b;for(h=0;h<=d;h++){var l=h/d,s=new THREE.Vector3;s.x=q*Math.sin(2*l*Math.PI);s.y=-p*c+g;s.z=q*Math.cos(2*l*Math.PI);this.vertices.push(s);n.push(this.vertices.length-1);m.push(new THREE.Vector2(l,
1-p))}j.push(n);k.push(m)}c=(a-b)/c;for(h=0;h<d;h++){0!==b?(n=this.vertices[j[0][h]].clone(),m=this.vertices[j[0][h+1]].clone()):(n=this.vertices[j[1][h]].clone(),m=this.vertices[j[1][h+1]].clone());n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<e;i++){var p=j[i][h],q=j[i+1][h],l=j[i+1][h+1],s=j[i][h+1],t=n.clone(),r=n.clone(),B=m.clone(),x=m.clone(),u=k[i][h].clone(),v=k[i+1][h].clone(),z=k[i+1][h+1].clone(),w=k[i][h+1].clone();this.faces.push(new THREE.Face3(p,
q,s,[t,r,x]));this.faceVertexUvs[0].push([u,v,w]);this.faces.push(new THREE.Face3(q,l,s,[r,B,x]));this.faceVertexUvs[0].push([v,z,w])}}if(!1===f&&0<b){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++)p=j[0][h],q=j[0][h+1],l=this.vertices.length-1,t=new THREE.Vector3(0,1,0),r=new THREE.Vector3(0,1,0),B=new THREE.Vector3(0,1,0),u=k[0][h].clone(),v=k[0][h+1].clone(),z=new THREE.Vector2(v.u,0),this.faces.push(new THREE.Face3(p,q,l,[t,r,B])),this.faceVertexUvs[0].push([u,v,z])}if(!1===f&&0<
a){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)p=j[i][h+1],q=j[i][h],l=this.vertices.length-1,t=new THREE.Vector3(0,-1,0),r=new THREE.Vector3(0,-1,0),B=new THREE.Vector3(0,-1,0),u=k[i][h+1].clone(),v=k[i][h].clone(),z=new THREE.Vector2(v.u,1),this.faces.push(new THREE.Face3(p,q,l,[t,r,B])),this.faceVertexUvs[0].push([u,v,z])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(b,a){"undefined"!==typeof b&&(THREE.Geometry.call(this),b=b instanceof Array?b:[b],this.shapebb=b[b.length-1].getBoundingBox(),this.addShapeList(b,a),this.computeCentroids(),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(b,a){for(var c=b.length,d=0;d<c;d++)this.addShape(b[d],a)};
...
p+2*k,g=0;g<h;g++){var i=L*g,j=L*(g+1),n=d+e+i,i=d+f+i,l=d+f+j,j=d+e+j,m=c,q=g,s=h,t=e,u=f,n=n+I,i=i+I,l=l+I,j=j+I;E.faces.push(new THREE.Face3(n,i,j,null,null,r));E.faces.push(new THREE.Face3(i,l,j,null,null,r));n=B.generateSideWallUV(E,b,m,a,n,i,l,j,q,s,t,u);E.faceVertexUvs[0].push([n[0],n[1],n[3]]);E.faceVertexUvs[0].push([n[1],n[2],n[3]])}}}function f(a,b,c){E.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=I;d+=I;e+=I;E.faces.push(new THREE.Face3(c,d,e,null,null,t));c=f?B.generateBottomUV(E,
b,a,c,d,e):B.generateTopUV(E,b,a,c,d,e);E.faceVertexUvs[0].push(c)}var h=void 0!==a.amount?a.amount:100,i=void 0!==a.bevelThickness?a.bevelThickness:6,j=void 0!==a.bevelSize?a.bevelSize:i-2,k=void 0!==a.bevelSegments?a.bevelSegments:3,n=void 0!==a.bevelEnabled?a.bevelEnabled:!0,m=void 0!==a.curveSegments?a.curveSegments:12,p=void 0!==a.steps?a.steps:1,q=a.extrudePath,l,s=!1,t=a.material,r=a.extrudeMaterial,B=void 0!==a.UVGenerator?a.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,x,u,v,z;q&&(l=
q.getSpacedPoints(p),s=!0,n=!1,x=void 0!==a.frames?a.frames:new THREE.TubeGeometry.FrenetFrames(q,p,!1),u=new THREE.Vector3,v=new THREE.Vector3,z=new THREE.Vector3);n||(j=i=k=0);var w,A,D,E=this,I=this.vertices.length,m=b.extractPoints(m),H=m.shape,m=m.holes;if(q=!THREE.Shape.Utils.isClockWise(H)){H=H.reverse();A=0;for(D=m.length;A<D;A++)w=m[A],THREE.Shape.Utils.isClockWise(w)&&(m[A]=w.reverse());q=!1}var K=THREE.Shape.Utils.triangulateShape(H,m),q=H;A=0;for(D=m.length;A<D;A++)w=m[A],H=H.concat(w);
var F,C,N,G,L=H.length,O=K.length,P=[],y=0,J=q.length;F=J-1;for(C=y+1;y<J;y++,F++,C++)F===J&&(F=0),C===J&&(C=0),P[y]=d(q[y],q[F],q[C]);var R=[],M,Q=P.concat();A=0;for(D=m.length;A<D;A++){w=m[A];M=[];y=0;J=w.length;F=J-1;for(C=y+1;y<J;y++,F++,C++)F===J&&(F=0),C===J&&(C=0),M[y]=d(w[y],w[F],w[C]);R.push(M);Q=Q.concat(M)}for(F=0;F<k;F++){w=F/k;N=i*(1-w);C=j*Math.sin(w*Math.PI/2);y=0;for(J=q.length;y<J;y++)G=c(q[y],P[y],C),f(G.x,G.y,-N);A=0;for(D=m.length;A<D;A++){w=m[A];M=R[A];y=0;for(J=w.length;y<J;y++)G=
c(w[y],M[y],C),f(G.x,G.y,-N)}}C=j;for(y=0;y<L;y++)G=n?c(H[y],Q[y],C):H[y],s?(v.copy(x.normals[0]).multiplyScalar(G.x),u.copy(x.binormals[0]).multiplyScalar(G.y),z.copy(l[0]).add(v).add(u),f(z.x,z.y,z.z)):f(G.x,G.y,0);for(w=1;w<=p;w++)for(y=0;y<L;y++)G=n?c(H[y],Q[y],C):H[y],s?(v.copy(x.normals[w]).multiplyScalar(G.x),u.copy(x.binormals[w]).multiplyScalar(G.y),z.copy(l[w]).add(v).add(u),f(z.x,z.y,z.z)):f(G.x,G.y,h/p*w);for(F=k-1;0<=F;F--){w=F/k;N=i*(1-w);C=j*Math.sin(w*Math.PI/2);y=0;for(J=q.length;y<
J;y++)G=c(q[y],P[y],C),f(G.x,G.y,h+N);A=0;for(D=m.length;A<D;A++){w=m[A];M=R[A];y=0;for(J=w.length;y<J;y++)G=c(w[y],M[y],C),s?f(G.x,G.y+l[p-1].y,l[p-1].x+N):f(G.x,G.y,h+N)}}if(n){i=0*L;for(y=0;y<O;y++)h=K[y],g(h[2]+i,h[1]+i,h[0]+i,!0);i=L*(p+2*k);for(y=0;y<O;y++)h=K[y],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(y=0;y<O;y++)h=K[y],g(h[2],h[1],h[0],!0);for(y=0;y<O;y++)h=K[y],g(h[0]+L*p,h[1]+L*p,h[2]+L*p,!1)}h=0;e(q,h);h+=q.length;A=0;for(D=m.length;A<D;A++)w=m[A],e(w,h),h+=w.length};
...
i=i.concat(g);j=i.length;f=k.length;for(e=0;e<j;e++)g=i[e],this.vertices.push(new THREE.Vector3(g.x,g.y,0));for(e=0;e<f;e++)j=k[e],i=j[0]+h,g=j[1]+h,j=j[2]+h,this.faces.push(new THREE.Face3(i,g,j,null,null,c)),this.faceVertexUvs[0].push(d.generateBottomUV(this,b,a,i,g,j))};THREE.LatheGeometry=function(b,a,c,d){THREE.Geometry.call(this);for(var a=a||12,c=c||0,d=d||2*Math.PI,e=1/(b.length-1),f=1/a,g=0,h=a;g<=h;g++)for(var i=c+g*f*d,j=Math.cos(i),k=Math.sin(i),i=0,n=b.length;i<n;i++){var m=b[i],p=new THREE.Vector3;p.x=j*m.x-k*m.y;p.y=k*m.x+j*m.y;p.z=m.z;this.vertices.push(p)}c=b.length;g=0;for(h=a;g<h;g++){i=0;for(n=b.length-1;i<n;i++){var a=k=i+c*g,d=k+c,j=k+1+c,k=k+1,m=g*f,p=i*e,q=m+f,l=p+e;this.faces.push(new THREE.Face3(a,d,k));this.faceVertexUvs[0].push([new THREE.Vector2(m,
p),new THREE.Vector2(q,p),new THREE.Vector2(m,l)]);this.faces.push(new THREE.Face3(d,j,k));this.faceVertexUvs[0].push([new THREE.Vector2(q,p),new THREE.Vector2(q,l),new THREE.Vector2(m,l)])}}this.mergeVertices();this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.LatheGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.PlaneGeometry=function(b,a,c,d,e){THREE.Geometry.call(this);this.width=b;this.height=a;this.widthSegments=c||1;this.heightSegments=d||1;for(var f=b/2,g=a/2,c=this.widthSegments,d=this.heightSegments,h=c+1,i=d+1,j=this.width/c,k=this.height/d,n=new THREE.Vector3(0,0,1),e=e||1,b=0;b<i;b++)for(a=0;a<h;a++)this.vertices.push(new THREE.Vector3(a*j-f,-(b*k-g),0));for(b=0;b<d;b++)for(a=0;a<c;a++){var m=a+h*b,f=a+h*(b+1),g=a+1+h*(b+1),i=a+1+h*b,j=new THREE.Vector2(a/c*e,1-b*e/d),k=new THREE.Vector2(a/
c*e,1-(b+1)*e/d),p=new THREE.Vector2((a+1)*e/c,1-(b+1)*e/d),q=new THREE.Vector2((a+1)*e/c,1-b*e/d),m=new THREE.Face3(m,f,i);m.normal.copy(n);m.vertexNormals.push(n.clone(),n.clone(),n.clone());this.faces.push(m);this.faceVertexUvs[0].push([j,k,q]);m=new THREE.Face3(f,g,i);m.normal.copy(n);m.vertexNormals.push(n.clone(),n.clone(),n.clone());this.faces.push(m);this.faceVertexUvs[0].push([k.clone(),p,q.clone()])}this.computeCentroids()};THREE.PlaneGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.RingGeometry=function(b,a,c,d,e,f){THREE.Geometry.call(this);for(var b=b||0,a=a||50,e=void 0!==e?e:0,f=void 0!==f?f:2*Math.PI,c=void 0!==c?Math.max(3,c):8,d=void 0!==d?Math.max(3,d):8,g=[],h=b,i=(a-b)/d,b=0;b<=d;b++){for(a=0;a<=c;a++){var j=new THREE.Vector3,k=e+a/c*f;j.x=h*Math.cos(k);j.y=h*Math.sin(k);this.vertices.push(j);g.push(new THREE.Vector2((j.x/h+1)/2,-(j.y/h+1)/2+1))}h+=i}e=new THREE.Vector3(0,0,1);for(b=0;b<d;b++){f=b*c;for(a=0;a<=c;a++){var k=a+f,i=k+b,j=k+c+b,n=k+c+1+b;this.faces.push(new THREE.Face3(i,
j,n,[e,e,e]));this.faceVertexUvs[0].push([g[i],g[j],g[n]]);i=k+b;j=k+c+1+b;n=k+1+b;this.faces.push(new THREE.Face3(i,j,n,[e,e,e]));this.faceVertexUvs[0].push([g[i],g[j],g[n]])}}this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,h)};THREE.RingGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.SphereGeometry=function(b,a,c,d,e,f,g){THREE.Geometry.call(this);this.radius=b=b||50;this.widthSegments=a=Math.max(3,Math.floor(a)||8);this.heightSegments=c=Math.max(2,Math.floor(c)||6);this.phiStart=d=void 0!==d?d:0;this.phiLength=e=void 0!==e?e:2*Math.PI;this.thetaStart=f=void 0!==f?f:0;this.thetaLength=g=void 0!==g?g:Math.PI;var h,i,j=[],k=[];for(i=0;i<=c;i++){var n=[],m=[];for(h=0;h<=a;h++){var p=h/a,q=i/c,l=new THREE.Vector3;l.x=-b*Math.cos(d+p*e)*Math.sin(f+q*g);l.y=b*Math.cos(f+q*g);
l.z=b*Math.sin(d+p*e)*Math.sin(f+q*g);this.vertices.push(l);n.push(this.vertices.length-1);m.push(new THREE.Vector2(p,1-q))}j.push(n);k.push(m)}for(i=0;i<this.heightSegments;i++)for(h=0;h<this.widthSegments;h++){var a=j[i][h+1],c=j[i][h],d=j[i+1][h],e=j[i+1][h+1],f=this.vertices[a].clone().normalize(),g=this.vertices[c].clone().normalize(),n=this.vertices[d].clone().normalize(),m=this.vertices[e].clone().normalize(),p=k[i][h+1].clone(),q=k[i][h].clone(),l=k[i+1][h].clone(),s=k[i+1][h+1].clone();Math.abs(this.vertices[a].y)===
this.radius?(this.faces.push(new THREE.Face3(a,d,e,[f,n,m])),this.faceVertexUvs[0].push([p,l,s])):Math.abs(this.vertices[d].y)===this.radius?(this.faces.push(new THREE.Face3(a,c,d,[f,g,n])),this.faceVertexUvs[0].push([p,q,l])):(this.faces.push(new THREE.Face3(a,c,e,[f,g,m])),this.faceVertexUvs[0].push([p,q,s]),this.faces.push(new THREE.Face3(c,d,e,[g,n,m])),this.faceVertexUvs[0].push([q.clone(),l,s.clone()]))}this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,
...
f!==d.currentFrame&&(this.morphTargetInfluences[d.lastFrame]=0,this.morphTargetInfluences[d.currentFrame]=1*g,this.morphTargetInfluences[f]=0,d.lastFrame=d.currentFrame,d.currentFrame=f);e=d.time%e/e;d.directionBackwards&&(e=1-e);this.morphTargetInfluences[d.currentFrame]=e*g;this.morphTargetInfluences[d.lastFrame]=(1-e)*g}}};THREE.LensFlarePlugin=function(){function b(b,c){var d=a.createProgram(),e=a.createShader(a.FRAGMENT_SHADER),f=a.createShader(a.VERTEX_SHADER),g="precision "+c+" float;\nprecision "+c+" int;\n";a.shaderSource(e,g+b.fragmentShader);a.shaderSource(f,g+b.vertexShader);a.compileShader(e);a.compileShader(f);a.attachShader(d,e);a.attachShader(d,f);a.linkProgram(d);return d}var a,c,d,e,f,g,h,i,j,k,n,m,p;this.init=function(q){a=q.context;c=q;d=q.getPrecision();e=new Float32Array(16);f=new Uint16Array(6);
...
a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MAG_FILTER,a.NEAREST);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.NEAREST);0>=a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS)?(k=!1,n=b(THREE.ShaderFlares.lensFlare,d)):(k=!0,n=b(THREE.ShaderFlares.lensFlareVertexTexture,d));m={};p={};m.vertex=a.getAttribLocation(n,"position");m.uv=a.getAttribLocation(n,"uv");p.renderType=a.getUniformLocation(n,"renderType");p.map=a.getUniformLocation(n,"map");p.occlusionMap=a.getUniformLocation(n,"occlusionMap");
p.opacity=a.getUniformLocation(n,"opacity");p.color=a.getUniformLocation(n,"color");p.scale=a.getUniformLocation(n,"scale");p.rotation=a.getUniformLocation(n,"rotation");p.screenPosition=a.getUniformLocation(n,"screenPosition")};this.render=function(b,d,e,f){var b=b.__webglFlares,r=b.length;if(r){var B=new THREE.Vector3,x=f/e,u=0.5*e,v=0.5*f,z=16/f,w=new THREE.Vector2(z*x,z),A=new THREE.Vector3(1,1,0),D=new THREE.Vector2(1,1),E=p,z=m;a.useProgram(n);a.enableVertexAttribArray(m.vertex);a.enableVertexAttribArray(m.uv);
a.uniform1i(E.occlusionMap,0);a.uniform1i(E.map,1);a.bindBuffer(a.ARRAY_BUFFER,g);a.vertexAttribPointer(z.vertex,2,a.FLOAT,!1,16,0);a.vertexAttribPointer(z.uv,2,a.FLOAT,!1,16,8);a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,h);a.disable(a.CULL_FACE);a.depthMask(!1);var I,H,K,F,C;for(I=0;I<r;I++)if(z=16/f,w.set(z*x,z),F=b[I],B.set(F.matrixWorld.elements[12],F.matrixWorld.elements[13],F.matrixWorld.elements[14]),B.applyMatrix4(d.matrixWorldInverse),B.applyProjection(d.projectionMatrix),A.copy(B),D.x=A.x*u+u,
D.y=A.y*v+v,k||0<D.x&&D.x<e&&0<D.y&&D.y<f){a.activeTexture(a.TEXTURE1);a.bindTexture(a.TEXTURE_2D,i);a.copyTexImage2D(a.TEXTURE_2D,0,a.RGB,D.x-8,D.y-8,16,16,0);a.uniform1i(E.renderType,0);a.uniform2f(E.scale,w.x,w.y);a.uniform3f(E.screenPosition,A.x,A.y,A.z);a.disable(a.BLEND);a.enable(a.DEPTH_TEST);a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0);a.activeTexture(a.TEXTURE0);a.bindTexture(a.TEXTURE_2D,j);a.copyTexImage2D(a.TEXTURE_2D,0,a.RGBA,D.x-8,D.y-8,16,16,0);a.uniform1i(E.renderType,1);a.disable(a.DEPTH_TEST);
a.activeTexture(a.TEXTURE1);a.bindTexture(a.TEXTURE_2D,i);a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0);F.positionScreen.copy(A);F.customUpdateCallback?F.customUpdateCallback(F):F.updateLensFlares();a.uniform1i(E.renderType,2);a.enable(a.BLEND);H=0;for(K=F.lensFlares.length;H<K;H++)C=F.lensFlares[H],0.001<C.opacity&&0.001<C.scale&&(A.x=C.x,A.y=C.y,A.z=C.z,z=C.size*C.scale/f,w.x=z*x,w.y=z,a.uniform3f(E.screenPosition,A.x,A.y,A.z),a.uniform2f(E.scale,w.x,w.y),a.uniform1f(E.rotation,C.rotation),a.uniform1f(E.opacity,
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(b,c){a.shadowMapEnabled&&a.shadowMapAutoUpdate&&this.update(b,c)};this.update=function(n,m){var p,q,l,s,t,r,B,x,u,v,z=[];s=0;b.clearColor(1,1,1,1);b.disable(b.BLEND);b.enable(b.CULL_FACE);b.frontFace(b.CCW);a.shadowMapCullFace===
THREE.CullFaceFront?b.cullFace(b.FRONT):b.cullFace(b.BACK);a.setDepthTest(!0);p=0;for(q=n.__lights.length;p<q;p++)if(l=n.__lights[p],l.castShadow)if(l instanceof THREE.DirectionalLight&&l.shadowCascade)for(t=0;t<l.shadowCascadeCount;t++){if(l.shadowCascadeArray[t])r=l.shadowCascadeArray[t];else{u=l;v=t;r=new THREE.DirectionalLight;r.isVirtual=!0;r.onlyShadow=!0;r.castShadow=!0;r.shadowCameraNear=u.shadowCameraNear;r.shadowCameraFar=u.shadowCameraFar;r.shadowCameraLeft=u.shadowCameraLeft;r.shadowCameraRight=
u.shadowCameraRight;r.shadowCameraBottom=u.shadowCameraBottom;r.shadowCameraTop=u.shadowCameraTop;r.shadowCameraVisible=u.shadowCameraVisible;r.shadowDarkness=u.shadowDarkness;r.shadowBias=u.shadowCascadeBias[v];r.shadowMapWidth=u.shadowCascadeWidth[v];r.shadowMapHeight=u.shadowCascadeHeight[v];r.pointsWorld=[];r.pointsFrustum=[];B=r.pointsWorld;x=r.pointsFrustum;for(var w=0;8>w;w++)B[w]=new THREE.Vector3,x[w]=new THREE.Vector3;B=u.shadowCascadeNearZ[v];u=u.shadowCascadeFarZ[v];x[0].set(-1,-1,B);
x[1].set(1,-1,B);x[2].set(-1,1,B);x[3].set(1,1,B);x[4].set(-1,-1,u);x[5].set(1,-1,u);x[6].set(-1,1,u);x[7].set(1,1,u);r.originalCamera=m;x=new THREE.Gyroscope;x.position=l.shadowCascadeOffset;x.add(r);x.add(r.target);m.add(x);l.shadowCascadeArray[t]=r;console.log("Created virtualLight",r)}v=l;B=t;u=v.shadowCascadeArray[B];u.position.copy(v.position);u.target.position.copy(v.target.position);u.lookAt(u.target.position);u.shadowCameraVisible=v.shadowCameraVisible;u.shadowDarkness=v.shadowDarkness;u.shadowBias=
v.shadowCascadeBias[B];x=v.shadowCascadeNearZ[B];v=v.shadowCascadeFarZ[B];u=u.pointsFrustum;u[0].z=x;u[1].z=x;u[2].z=x;u[3].z=x;u[4].z=v;u[5].z=v;u[6].z=v;u[7].z=v;z[s]=r;s++}else z[s]=l,s++;p=0;for(q=z.length;p<q;p++){l=z[p];l.shadowMap||(t=THREE.LinearFilter,a.shadowMapType===THREE.PCFSoftShadowMap&&(t=THREE.NearestFilter),l.shadowMap=new THREE.WebGLRenderTarget(l.shadowMapWidth,l.shadowMapHeight,{minFilter:t,magFilter:t,format:THREE.RGBAFormat}),l.shadowMapSize=new THREE.Vector2(l.shadowMapWidth,
...
!0===n.autoUpdate&&n.updateMatrixWorld()}l.shadowCameraVisible&&!l.cameraHelper&&(l.cameraHelper=new THREE.CameraHelper(l.shadowCamera),l.shadowCamera.add(l.cameraHelper));if(l.isVirtual&&l.originalCamera==m){t=m;s=l.shadowCamera;r=l.pointsFrustum;x=l.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(u=0;8>u;u++)v=x[u],v.copy(r[u]),THREE.ShadowMapPlugin.__projector.unprojectVector(v,t),v.applyMatrix4(s.matrixWorldInverse),v.x<i.x&&(i.x=v.x),v.x>j.x&&(j.x=v.x),
v.y<i.y&&(i.y=v.y),v.y>j.y&&(j.y=v.y),v.z<i.z&&(i.z=v.z),v.z>j.z&&(j.z=v.z);s.left=i.x;s.right=j.x;s.top=j.y;s.bottom=i.y;s.updateProjectionMatrix()}s=l.shadowMap;r=l.shadowMatrix;t=l.shadowCamera;t.position.getPositionFromMatrix(l.matrixWorld);k.getPositionFromMatrix(l.target.matrixWorld);t.lookAt(k);t.updateMatrixWorld();t.matrixWorldInverse.getInverse(t.matrixWorld);l.cameraHelper&&(l.cameraHelper.visible=l.shadowCameraVisible);l.shadowCameraVisible&&l.cameraHelper.update();r.set(0.5,0,0,0.5,0,
0.5,0,0.5,0,0,0.5,0.5,0,0,0,1);r.multiply(t.projectionMatrix);r.multiply(t.matrixWorldInverse);h.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse);g.setFromMatrix(h);a.setRenderTarget(s);a.clear();v=n.__webglObjects;l=0;for(s=v.length;l<s;l++)if(x=v[l],u=x.object,x.render=!1,u.visible&&u.castShadow&&(!(u instanceof THREE.Mesh||u instanceof THREE.ParticleSystem)||!u.frustumCulled||g.intersectsObject(u)))u._modelViewMatrix.multiplyMatrices(t.matrixWorldInverse,u.matrixWorld),x.render=!0;l=0;
for(s=v.length;l<s;l++)x=v[l],x.render&&(u=x.object,r=x.buffer,w=u.material instanceof THREE.MeshFaceMaterial?u.material.materials[0]:u.material,B=0<u.geometry.morphTargets.length&&w.morphTargets,w=u instanceof THREE.SkinnedMesh&&w.skinning,B=u.customDepthMaterial?u.customDepthMaterial:w?B?f:e:B?d:c,r instanceof THREE.BufferGeometry?a.renderBufferDirect(t,n.__lights,null,B,r,u,x.offsetIndices):a.renderBuffer(t,n.__lights,null,B,r,u));v=n.__webglObjectsImmediate;l=0;for(s=v.length;l<s;l++)x=v[l],u=
x.object,u.visible&&u.castShadow&&(u._modelViewMatrix.multiplyMatrices(t.matrixWorldInverse,u.matrixWorld),a.renderImmediateObject(t,n.__lights,null,c,u))}p=a.getClearColor();q=a.getClearAlpha();b.clearColor(p.r,p.g,p.b,q);b.enable(b.BLEND);a.shadowMapCullFace===THREE.CullFaceFront&&b.cullFace(b.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;THREE.SpritePlugin=function(){function b(a,b){return a.z!==b.z?b.z-a.z:b.id-a.id}var a,c,d,e,f,g,h,i,j,k;this.init=function(b){a=b.context;c=b;d=b.getPrecision();e=new Float32Array(16);f=new Uint16Array(6);b=0;e[b++]=-1;e[b++]=-1;e[b++]=0;e[b++]=0;e[b++]=1;e[b++]=-1;e[b++]=1;e[b++]=0;e[b++]=1;e[b++]=1;e[b++]=1;e[b++]=1;e[b++]=-1;e[b++]=1;e[b++]=0;e[b++]=1;b=0;f[b++]=0;f[b++]=1;f[b++]=2;f[b++]=0;f[b++]=2;f[b++]=3;g=a.createBuffer();h=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,g);a.bufferData(a.ARRAY_BUFFER,
e,a.STATIC_DRAW);a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,h);a.bufferData(a.ELEMENT_ARRAY_BUFFER,f,a.STATIC_DRAW);var b=THREE.ShaderSprite.sprite,m=a.createProgram(),p=a.createShader(a.FRAGMENT_SHADER),q=a.createShader(a.VERTEX_SHADER),l="precision "+d+" float;\nprecision "+d+" int;\n";a.shaderSource(p,l+b.fragmentShader);a.shaderSource(q,l+b.vertexShader);a.compileShader(p);a.compileShader(q);a.attachShader(m,p);a.attachShader(m,q);a.linkProgram(m);i=m;j={};k={};j.position=a.getAttribLocation(i,"position");
...
s=l.length;if(s){var t=j,r=k,B=q/f,f=0.5*f,x=0.5*q;a.useProgram(i);a.enableVertexAttribArray(t.position);a.enableVertexAttribArray(t.uv);a.disable(a.CULL_FACE);a.enable(a.BLEND);a.bindBuffer(a.ARRAY_BUFFER,g);a.vertexAttribPointer(t.position,2,a.FLOAT,!1,16,0);a.vertexAttribPointer(t.uv,2,a.FLOAT,!1,16,8);a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,h);a.uniformMatrix4fv(r.projectionMatrix,!1,e.projectionMatrix.elements);a.activeTexture(a.TEXTURE0);a.uniform1i(r.map,0);var u=t=0,v=d.fog;v?(a.uniform3f(r.fogColor,
v.color.r,v.color.g,v.color.b),v instanceof THREE.Fog?(a.uniform1f(r.fogNear,v.near),a.uniform1f(r.fogFar,v.far),a.uniform1i(r.fogType,1),u=t=1):v instanceof THREE.FogExp2&&(a.uniform1f(r.fogDensity,v.density),a.uniform1i(r.fogType,2),u=t=2)):(a.uniform1i(r.fogType,0),u=t=0);for(var z,w,A=[],v=0;v<s;v++)z=l[v],w=z.material,z.visible&&0!==w.opacity&&(w.useScreenCoordinates?z.z=-z.position.z:(z._modelViewMatrix.multiplyMatrices(e.matrixWorldInverse,z.matrixWorld),z.z=-z._modelViewMatrix.elements[14]));
l.sort(b);for(v=0;v<s;v++)z=l[v],w=z.material,z.visible&&0!==w.opacity&&(w.map&&w.map.image&&w.map.image.width)&&(a.uniform1f(r.alphaTest,w.alphaTest),!0===w.useScreenCoordinates?(a.uniform1i(r.useScreenCoordinates,1),a.uniform3f(r.screenPosition,(z.position.x*c.devicePixelRatio-f)/f,(x-z.position.y*c.devicePixelRatio)/x,Math.max(0,Math.min(1,z.position.z))),A[0]=c.devicePixelRatio,A[1]=c.devicePixelRatio):(a.uniform1i(r.useScreenCoordinates,0),a.uniform1i(r.sizeAttenuation,w.sizeAttenuation?1:0),
a.uniformMatrix4fv(r.modelViewMatrix,!1,z._modelViewMatrix.elements),A[0]=1,A[1]=1),e=d.fog&&w.fog?u:0,t!==e&&(a.uniform1i(r.fogType,e),t=e),e=1/(w.scaleByViewport?q:1),A[0]*=e*B*z.scale.x,A[1]*=e*z.scale.y,a.uniform2f(r.uvScale,w.uvScale.x,w.uvScale.y),a.uniform2f(r.uvOffset,w.uvOffset.x,w.uvOffset.y),a.uniform2f(r.alignment,w.alignment.x,w.alignment.y),a.uniform1f(r.opacity,w.opacity),a.uniform3f(r.color,w.color.r,w.color.g,w.color.b),a.uniform1f(r.rotation,z.rotation),a.uniform2fv(r.scale,A),c.setBlending(w.blending,
w.blendEquation,w.blendSrc,w.blendDst),c.setDepthTest(w.depthTest),c.setDepthWrite(w.depthWrite),c.setTexture(w.map,0),a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0));a.enable(a.CULL_FACE)}}};THREE.DepthPassPlugin=function(){this.enabled=!1;this.renderTarget=null;var b,a,c,d,e,f,g=new THREE.Frustum,h=new THREE.Matrix4;this.init=function(g){b=g.context;a=g;var g=THREE.ShaderLib.depthRGBA,h=THREE.UniformsUtils.clone(g.uniforms);c=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h});d=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,b){this.enabled&&this.update(a,b)};this.update=function(i,j){var k,n,m,p,q,l,s;b.clearColor(1,1,1,1);b.disable(b.BLEND);a.setDepthTest(!0);!0===i.autoUpdate&&i.updateMatrixWorld();j.matrixWorldInverse.getInverse(j.matrixWorld);
h.multiplyMatrices(j.projectionMatrix,j.matrixWorldInverse);g.setFromMatrix(h);a.setRenderTarget(this.renderTarget);a.clear();s=i.__webglObjects;k=0;for(n=s.length;k<n;k++)if(q=s[k],l=q.object,q.render=!1,l.visible&&(!(l instanceof THREE.Mesh||l instanceof THREE.ParticleSystem)||!l.frustumCulled||g.intersectsObject(l)))l._modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,l.matrixWorld),q.render=!0;var t;k=0;for(n=s.length;k<n;k++)if(q=s[k],q.render&&(l=q.object,m=q.buffer,!(l instanceof THREE.ParticleSystem)||
l.customDepthMaterial))(t=l.material instanceof THREE.MeshFaceMaterial?l.material.materials[0]:l.material)&&a.setMaterialFaces(l.material),p=0<l.geometry.morphTargets.length&&t.morphTargets,t=l instanceof THREE.SkinnedMesh&&t.skinning,p=l.customDepthMaterial?l.customDepthMaterial:t?p?f:e:p?d:c,m instanceof THREE.BufferGeometry?a.renderBufferDirect(j,i.__lights,null,p,m,l,q.offsetIndices):a.renderBuffer(j,i.__lights,null,p,m,l);s=i.__webglObjectsImmediate;k=0;for(n=s.length;k<n;k++)q=s[k],l=q.object,
l.visible&&(l._modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,l.matrixWorld),a.renderImmediateObject(j,i.__lights,null,c,l));k=a.getClearColor();n=a.getClearAlpha();b.clearColor(k.r,k.g,k.b,n);b.enable(b.BLEND)}};THREE.ShaderFlares={lensFlareVertexTexture:{vertexShader:"uniform lowp int renderType;\nuniform vec3 screenPosition;\nuniform vec2 scale;\nuniform float rotation;\nuniform sampler2D occlusionMap;\nattribute vec2 position;\nattribute vec2 uv;\nvarying vec2 vUV;\nvarying float vVisibility;\nvoid main() {\nvUV = uv;\nvec2 pos = position;\nif( renderType == 2 ) {\nvec4 visibility = texture2D( occlusionMap, vec2( 0.1, 0.1 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.5, 0.1 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.9, 0.1 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.9, 0.5 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.9, 0.9 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.5, 0.9 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.1, 0.9 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.1, 0.5 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.5, 0.5 ) );\nvVisibility =        visibility.r / 9.0;\nvVisibility *= 1.0 - visibility.g / 9.0;\nvVisibility *=       visibility.b / 9.0;\nvVisibility *= 1.0 - visibility.a / 9.0;\npos.x = cos( rotation ) * position.x - sin( rotation ) * position.y;\npos.y = sin( rotation ) * position.x + cos( rotation ) * position.y;\n}\ngl_Position = vec4( ( pos * scale + screenPosition.xy ).xy, screenPosition.z, 1.0 );\n}",
