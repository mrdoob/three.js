...
var e={mipmaps:[],width:0,height:0,format:null,mipmapCount:1},f=c("DXT1"),g=c("DXT3"),h=c("DXT5"),k=new Int32Array(b,0,31);if(542327876!==k[0])return console.error("ImageUtils.parseDDS(): Invalid magic number in DDS header"),e;if(!k[20]&4)return console.error("ImageUtils.parseDDS(): Unsupported format, must contain a FourCC code"),e;var l=k[21],m=!1;switch(l){case f:f=8;e.format=THREE.RGB_S3TC_DXT1_Format;break;case g:f=16;e.format=THREE.RGBA_S3TC_DXT3_Format;break;case h:f=16;e.format=THREE.RGBA_S3TC_DXT5_Format;
break;default:if(32==k[22]&&k[23]&16711680&&k[24]&65280&&k[25]&255&&k[26]&4278190080)m=!0,f=64,e.format=THREE.RGBAFormat;else return console.error("ImageUtils.parseDDS(): Unsupported FourCC code: ",String.fromCharCode(l&255,l>>8&255,l>>16&255,l>>24&255)),e}e.mipmapCount=1;k[2]&131072&&!1!==a&&(e.mipmapCount=Math.max(1,k[7]));e.isCubemap=k[28]&512?!0:!1;e.width=k[4];e.height=k[3];for(var k=k[1]+4,g=e.width,h=e.height,l=e.isCubemap?6:1,p=0;p<l;p++){for(var r=0;r<e.mipmapCount;r++){if(m)var q=d(b,k,
...
e),l=k.data,m=0;m<d;m++)for(var p=0;p<e;p++){var r=0>p-1?0:p-1,q=p+1>e-1?e-1:p+1,s=0>m-1?0:m-1,n=m+1>d-1?d-1:m+1,u=[],v=[0,0,h[4*(p*d+m)]/255*a];u.push([-1,0,h[4*(p*d+s)]/255*a]);u.push([-1,-1,h[4*(r*d+s)]/255*a]);u.push([0,-1,h[4*(r*d+m)]/255*a]);u.push([1,-1,h[4*(r*d+n)]/255*a]);u.push([1,0,h[4*(p*d+n)]/255*a]);u.push([1,1,h[4*(q*d+n)]/255*a]);u.push([0,1,h[4*(q*d+m)]/255*a]);u.push([-1,1,h[4*(q*d+s)]/255*a]);r=[];s=u.length;for(q=0;q<s;q++){var n=u[q],t=u[(q+1)%s],n=[n[0]-v[0],n[1]-v[1],n[2]-v[2]],
t=[t[0]-v[0],t[1]-v[1],t[2]-v[2]];r.push(c([n[1]*t[2]-n[2]*t[1],n[2]*t[0]-n[0]*t[2],n[0]*t[1]-n[1]*t[0]]))}u=[0,0,0];for(q=0;q<r.length;q++)u[0]+=r[q][0],u[1]+=r[q][1],u[2]+=r[q][2];u[0]/=r.length;u[1]/=r.length;u[2]/=r.length;v=4*(p*d+m);l[v]=(u[0]+1)/2*255|0;l[v+1]=(u[1]+1)/2*255|0;l[v+2]=255*u[2]|0;l[v+3]=255}g.putImageData(k,0,0);return f},generateDataTexture:function(b,a,c){var d=b*a,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g);c=Math.floor(255*c.b);for(var h=0;h<d;h++)e[3*
...
String(b).split(""),f=e.length,g=[];for(b=0;b<f;b++){var h=new THREE.Path,h=this.extractGlyphPoints(e[b],a,c,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(b,a,c,d,e){var f=[],g,h,k,l,m,p,r,q,s,n,u,v=a.glyphs[b]||a.glyphs["?"];if(v){if(v.o)for(a=v._cachedOutline||(v._cachedOutline=v.o.split(" ")),l=a.length,b=0;b<l;)switch(k=a[b++],k){case "m":k=a[b++]*c+d;m=a[b++]*c;e.moveTo(k,m);break;case "l":k=a[b++]*c+d;m=a[b++]*c;e.lineTo(k,m);break;case "q":k=a[b++]*
c+d;m=a[b++]*c;q=a[b++]*c+d;s=a[b++]*c;e.quadraticCurveTo(q,s,k,m);if(g=f[f.length-1])for(p=g.x,r=g.y,g=1,h=this.divisions;g<=h;g++){var t=g/h;THREE.Shape.Utils.b2(t,p,q,k);THREE.Shape.Utils.b2(t,r,s,m)}break;case "b":if(k=a[b++]*c+d,m=a[b++]*c,q=a[b++]*c+d,s=a[b++]*-c,n=a[b++]*c+d,u=a[b++]*-c,e.bezierCurveTo(k,m,q,s,n,u),g=f[f.length-1])for(p=g.x,r=g.y,g=1,h=this.divisions;g<=h;g++)t=g/h,THREE.Shape.Utils.b3(t,p,q,n,k),THREE.Shape.Utils.b3(t,r,s,u,m)}return{offset:v.ha*c,path:e}}}};
...
(function(b){var a=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};b.Triangulate=function(b,d){var e=b.length;if(3>e)return null;var f=[],g=[],h=[],k,l,m;if(0<a(b))for(l=0;l<e;l++)g[l]=l;else for(l=0;l<e;l++)g[l]=e-1-l;var p=2*e;for(l=e-1;2<e;){if(0>=p--){console.log("Warning, unable to triangulate polygon!");break}k=l;e<=k&&(k=0);l=k+1;e<=l&&(l=0);m=l+1;e<=m&&(m=0);var r;a:{var q=r=void 0,s=void 0,n=void 0,u=void 0,v=void 0,t=void 0,D=void 0,y=
void 0,q=b[g[k]].x,s=b[g[k]].y,n=b[g[l]].x,u=b[g[l]].y,v=b[g[m]].x,t=b[g[m]].y;if(1E-10>(n-q)*(t-s)-(u-s)*(v-q))r=!1;else{var x=void 0,w=void 0,z=void 0,B=void 0,A=void 0,F=void 0,G=void 0,K=void 0,H=void 0,N=void 0,H=K=G=y=D=void 0,x=v-n,w=t-u,z=q-v,B=s-t,A=n-q,F=u-s;for(r=0;r<e;r++)if(D=b[g[r]].x,y=b[g[r]].y,!(D===q&&y===s||D===n&&y===u||D===v&&y===t)&&(G=D-q,K=y-s,H=D-n,N=y-u,D-=v,y-=t,H=x*N-w*H,G=A*K-F*G,K=z*y-B*D,-1E-10<=H&&-1E-10<=K&&-1E-10<=G)){r=!1;break a}r=!0}}if(r){f.push([b[g[k]],b[g[l]],
b[g[m]]]);h.push([g[k],g[l],g[m]]);k=l;for(m=l+1;m<e;k++,m++)g[k]=g[m];e--;p=2*e}}return d?h:f};b.Triangulate.area=a;return b})(THREE.FontUtils);self._typeface_js={faces:THREE.FontUtils.faces,loadFace:THREE.FontUtils.loadFace};THREE.typeface_js=self._typeface_js;THREE.Curve=function(){};THREE.Curve.prototype.getPoint=function(b){console.log("Warning, getPoint() not implemented!");return null};THREE.Curve.prototype.getPointAt=function(b){b=this.getUtoTmapping(b);return this.getPoint(b)};THREE.Curve.prototype.getPoints=function(b){b||(b=5);var a,c=[];for(a=0;a<=b;a++)c.push(this.getPoint(a/b));return c};THREE.Curve.prototype.getSpacedPoints=function(b){b||(b=5);var a,c=[];for(a=0;a<=b;a++)c.push(this.getPointAt(a/b));return c};
...
THREE.CurvePath.prototype.getBoundingBox=function(){var b=this.getPoints(),a,c,d,e,f,g;a=c=Number.NEGATIVE_INFINITY;e=f=Number.POSITIVE_INFINITY;var h,k,l,m,p=b[0]instanceof THREE.Vector3;m=p?new THREE.Vector3:new THREE.Vector2;k=0;for(l=b.length;k<l;k++)h=b[k],h.x>a?a=h.x:h.x<e&&(e=h.x),h.y>c?c=h.y:h.y<f&&(f=h.y),p&&(h.z>d?d=h.z:h.z<g&&(g=h.z)),m.add(h);b={minX:e,minY:f,maxX:a,maxY:c};p&&(b.maxZ=d,b.minZ=g);return b};
...
THREE.Path.prototype.getPoints=function(b,a){if(this.useSpacedPoints)return console.log("tata"),this.getSpacedPoints(b,a);b=b||12;var c=[],d,e,f,g,h,k,l,m,p,r,q,s,n;d=0;for(e=this.actions.length;d<e;d++)switch(f=this.actions[d],g=f.action,f=f.args,g){case THREE.PathActions.MOVE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.LINE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=f[2];k=f[3];p=f[0];r=f[1];0<c.length?(g=c[c.length-1],q=g.x,
s=g.y):(g=this.actions[d-1].args,q=g[g.length-2],s=g[g.length-1]);for(f=1;f<=b;f++)n=f/b,g=THREE.Shape.Utils.b2(n,q,p,h),n=THREE.Shape.Utils.b2(n,s,r,k),c.push(new THREE.Vector2(g,n));break;case THREE.PathActions.BEZIER_CURVE_TO:h=f[4];k=f[5];p=f[0];r=f[1];l=f[2];m=f[3];0<c.length?(g=c[c.length-1],q=g.x,s=g.y):(g=this.actions[d-1].args,q=g[g.length-2],s=g[g.length-1]);for(f=1;f<=b;f++)n=f/b,g=THREE.Shape.Utils.b3(n,q,p,l,h),n=THREE.Shape.Utils.b3(n,s,r,m,k),c.push(new THREE.Vector2(g,n));break;case THREE.PathActions.CSPLINE_THRU:g=
this.actions[d-1].args;n=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=b*f[0].length;n=n.concat(f[0]);n=new THREE.SplineCurve(n);for(f=1;f<=g;f++)c.push(n.getPointAt(f/g));break;case THREE.PathActions.ARC:h=f[0];k=f[1];r=f[2];l=f[3];g=f[4];p=!!f[5];q=g-l;s=2*b;for(f=1;f<=s;f++)n=f/s,p||(n=1-n),n=l+n*q,g=h+r*Math.cos(n),n=k+r*Math.sin(n),c.push(new THREE.Vector2(g,n));break;case THREE.PathActions.ELLIPSE:for(h=f[0],k=f[1],r=f[2],m=f[3],l=f[4],g=f[5],p=!!f[6],q=g-l,s=2*b,f=1;f<=s;f++)n=f/s,p||
(n=1-n),n=l+n*q,g=h+r*Math.cos(n),n=k+m*Math.sin(n),c.push(new THREE.Vector2(g,n))}d=c[c.length-1];1E-10>Math.abs(d.x-c[0].x)&&1E-10>Math.abs(d.y-c[0].y)&&c.splice(c.length-1,1);a&&c.push(c[0]);return c};
THREE.Path.prototype.toShapes=function(b){function a(a,b){for(var c=b.length,d=!1,e=c-1,f=0;f<c;e=f++){var g=b[e],k=b[f],h=k.x-g.x,l=k.y-g.y;if(1E-10<Math.abs(l)){if(0>l&&(g=b[f],h=-h,k=b[e],l=-l),!(a.y<g.y||a.y>k.y))if(a.y==g.y){if(a.x==g.x)return!0}else{e=l*(a.x-g.x)-h*(a.y-g.y);if(0==e)return!0;0>e||(d=!d)}}else if(a.y==g.y&&(k.x<=a.x&&a.x<=g.x||g.x<=a.x&&a.x<=k.x))return!0}return d}var c,d,e,f,g=[],h=new THREE.Path;c=0;for(d=this.actions.length;c<d;c++)e=this.actions[c],f=e.args,e=e.action,e==
THREE.PathActions.MOVE_TO&&0!=h.actions.length&&(g.push(h),h=new THREE.Path),h[e].apply(h,f);0!=h.actions.length&&g.push(h);if(0==g.length)return[];var k,l,m;f=[];if(1==g.length)return l=g[0],m=new THREE.Shape,m.actions=l.actions,m.curves=l.curves,f.push(m),f;var p=!THREE.Shape.Utils.isClockWise(g[0].getPoints()),p=b?!p:p;m=[];h=[];e=[];var r=0,q;h[r]=void 0;e[r]=[];c=0;for(d=g.length;c<d;c++)l=g[c],q=l.getPoints(),k=THREE.Shape.Utils.isClockWise(q),(k=b?!k:k)?(!p&&h[r]&&r++,h[r]={s:new THREE.Shape,
p:q},h[r].s.actions=l.actions,h[r].s.curves=l.curves,p&&r++,e[r]=[]):e[r].push({h:l,p:q[0]});if(1<h.length){c=!1;d=[];b=0;for(g=h.length;b<g;b++)m[b]=[];b=0;for(g=h.length;b<g;b++)for(l=e[b],k=0;k<l.length;k++){p=l[k];r=!0;for(q=0;q<h.length;q++)a(p.p,h[q].p)&&(b!=q&&d.push({froms:b,tos:q,hole:k}),r?(r=!1,m[q].push(p)):c=!0);r&&m[b].push(p)}0<d.length&&(c||(e=m))}c=0;for(d=h.length;c<d;c++)for(m=h[c].s,f.push(m),b=e[c],g=0,l=b.length;g<l;g++)m.holes.push(b[g].h);return f};THREE.Shape=function(){THREE.Path.apply(this,arguments);this.holes=[]};THREE.Shape.prototype=Object.create(THREE.Path.prototype);THREE.Shape.prototype.extrude=function(b){return new THREE.ExtrudeGeometry(this,b)};THREE.Shape.prototype.makeGeometry=function(b){return new THREE.ShapeGeometry(this,b)};THREE.Shape.prototype.getPointsHoles=function(b){var a,c=this.holes.length,d=[];for(a=0;a<c;a++)d[a]=this.holes[a].getTransformedPoints(b,this.bends);return d};
...
THREE.Shape.Utils={triangulateShape:function(b,a){function c(a,b,c){return a.x!=b.x?a.x<b.x?a.x<=c.x&&c.x<=b.x:b.x<=c.x&&c.x<=a.x:a.y<b.y?a.y<=c.y&&c.y<=b.y:b.y<=c.y&&c.y<=a.y}function d(a,b,d,e,f){var g=b.x-a.x,k=b.y-a.y,h=e.x-d.x,l=e.y-d.y,m=a.x-d.x,p=a.y-d.y,z=k*h-g*l,B=k*m-g*p;if(1E-10<Math.abs(z)){if(0<z){if(0>B||B>z)return[];h=l*m-h*p;if(0>h||h>z)return[]}else{if(0<B||B<z)return[];h=l*m-h*p;if(0<h||h<z)return[]}if(0==h)return!f||0!=B&&B!=z?[a]:[];if(h==z)return!f||0!=B&&B!=z?[b]:[];if(0==B)return[d];
if(B==z)return[e];f=h/z;return[{x:a.x+f*g,y:a.y+f*k}]}if(0!=B||l*m!=h*p)return[];k=0==g&&0==k;h=0==h&&0==l;if(k&&h)return a.x!=d.x||a.y!=d.y?[]:[a];if(k)return c(d,e,a)?[a]:[];if(h)return c(a,b,d)?[d]:[];0!=g?(a.x<b.x?(g=a,h=a.x,k=b,a=b.x):(g=b,h=b.x,k=a,a=a.x),d.x<e.x?(b=d,z=d.x,l=e,d=e.x):(b=e,z=e.x,l=d,d=d.x)):(a.y<b.y?(g=a,h=a.y,k=b,a=b.y):(g=b,h=b.y,k=a,a=a.y),d.y<e.y?(b=d,z=d.y,l=e,d=e.y):(b=e,z=e.y,l=d,d=d.y));return h<=z?a<z?[]:a==z?f?[]:[b]:a<=d?[b,k]:[b,l]:h>d?[]:h==d?f?[]:[g]:a<=d?[g,k]:
[g,l]}function e(a,b,c,d){var e=b.x-a.x,f=b.y-a.y;b=c.x-a.x;c=c.y-a.y;var g=d.x-a.x;d=d.y-a.y;a=e*c-f*b;e=e*d-f*g;return 1E-10<Math.abs(a)?(b=g*c-d*b,0<a?0<=e&&0<=b:0<=e||0<=b):0<e}var f,g,h,k,l,m={};h=b.concat();f=0;for(g=a.length;f<g;f++)Array.prototype.push.apply(h,a[f]);f=0;for(g=h.length;f<g;f++)l=h[f].x+":"+h[f].y,void 0!==m[l]&&console.log("Duplicate point",l),m[l]=f;f=function(a,b){function c(a,b){var d=h.length-1,f=a-1;0>f&&(f=d);var g=a+1;g>d&&(g=0);d=e(h[a],h[f],h[g],k[b]);if(!d)return!1;
d=k.length-1;f=b-1;0>f&&(f=d);g=b+1;g>d&&(g=0);return(d=e(k[b],k[f],k[g],h[a]))?!0:!1}function f(a,b){var c,e;for(c=0;c<h.length;c++)if(e=c+1,e%=h.length,e=d(a,b,h[c],h[e],!0),0<e.length)return!0;return!1}function g(a,c){var e,f,h,k;for(e=0;e<l.length;e++)for(f=b[l[e]],h=0;h<f.length;h++)if(k=h+1,k%=f.length,k=d(a,c,f[h],f[k],!0),0<k.length)return!0;return!1}var h=a.concat(),k,l=[],m,p,w,z,B,A=[],F,G,K,H=0;for(m=b.length;H<m;H++)l.push(H);for(var N=2*l.length;0<l.length;){N--;if(0>N){console.log("Infinite Loop! Holes left:"+
l.length+", Probably Hole outside Shape!");break}for(p=0;p<h.length;p++){w=h[p];m=-1;for(H=0;H<l.length;H++)if(z=l[H],B=w.x+":"+w.y+":"+z,void 0===A[B]){k=b[z];for(F=0;F<k.length;F++)if(z=k[F],c(p,F)&&!f(w,z)&&!g(w,z)){m=F;l.splice(H,1);z=h.slice(0,p+1);F=h.slice(p);G=k.slice(m);K=k.slice(0,m+1);h=z.concat(G).concat(K).concat(F);break}if(0<=m)break;A[B]=!0}if(0<=m)break}}return h}(b,a);var p=THREE.FontUtils.Triangulate(f,!1);f=0;for(g=p.length;f<g;f++)for(k=p[f],h=0;3>h;h++)l=k[h].x+":"+k[h].y,l=
...
0;d<b.hierarchy[c].keys.length;d++){var m={};for(l in h){for(k=0;k<b.hierarchy[c].keys[d].morphTargets.length;k++)if(b.hierarchy[c].keys[d].morphTargets[k]===l){m[l]=b.hierarchy[c].keys[d].morphTargetsInfluences[k];break}k===b.hierarchy[c].keys[d].morphTargets.length&&(m[l]=0)}b.hierarchy[c].keys[d].morphTargetsInfluences=m}}for(d=1;d<b.hierarchy[c].keys.length;d++)b.hierarchy[c].keys[d].time===b.hierarchy[c].keys[d-1].time&&(b.hierarchy[c].keys.splice(d,1),d--);for(d=0;d<b.hierarchy[c].keys.length;d++)b.hierarchy[c].keys[d].index=
...
THREE.Animation.prototype.reset=function(){for(var b=0,a=this.hierarchy.length;b<a;b++){var c=this.hierarchy[b];c.matrixAutoUpdate=!0;void 0===c.animationCache&&(c.animationCache={},c.animationCache.prevKey={pos:0,rot:0,scl:0},c.animationCache.nextKey={pos:0,rot:0,scl:0},c.animationCache.originalMatrix=c instanceof THREE.Bone?c.skinMatrix:c.matrix);var d=c.animationCache.prevKey,c=c.animationCache.nextKey;d.pos=this.data.hierarchy[b].keys[0];d.rot=this.data.hierarchy[b].keys[0];d.scl=this.data.hierarchy[b].keys[0];
c.pos=this.getNextKeyWith("pos",b,1);c.rot=this.getNextKeyWith("rot",b,1);c.scl=this.getNextKeyWith("scl",b,1)}};
THREE.Animation.prototype.update=function(){var b=[],a=new THREE.Vector3,c=function(a,b){var c=[],h=[],k,l,m,p,r,q;k=(a.length-1)*b;l=Math.floor(k);k-=l;c[0]=0===l?l:l-1;c[1]=l;c[2]=l>a.length-2?l:l+1;c[3]=l>a.length-3?l:l+2;l=a[c[0]];p=a[c[1]];r=a[c[2]];q=a[c[3]];c=k*k;m=k*c;h[0]=d(l[0],p[0],r[0],q[0],k,c,m);h[1]=d(l[1],p[1],r[1],q[1],k,c,m);h[2]=d(l[2],p[2],r[2],q[2],k,c,m);return h},d=function(a,b,c,d,k,l,m){a=0.5*(c-a);d=0.5*(d-b);return(2*(b-c)+a+d)*m+(-3*(b-c)-2*a-d)*l+a*k+b};return function(d){if(!1!==
this.isPlaying){this.currentTime+=d*this.timeScale;var f;d=["pos","rot","scl"];var g=this.data.length;if(!0===this.loop&&this.currentTime>g)this.currentTime%=g,this.reset();else if(!1===this.loop&&this.currentTime>g){this.stop();return}this.currentTime=Math.min(this.currentTime,g);for(var g=0,h=this.hierarchy.length;g<h;g++)for(var k=this.hierarchy[g],l=k.animationCache,m=0;3>m;m++){f=d[m];var p=l.prevKey[f],r=l.nextKey[f];if(r.time<=this.currentTime){p=this.data.hierarchy[g].keys[0];for(r=this.getNextKeyWith(f,
g,1);r.time<this.currentTime&&r.index>p.index;)p=r,r=this.getNextKeyWith(f,g,r.index+1);l.prevKey[f]=p;l.nextKey[f]=r}k.matrixAutoUpdate=!0;k.matrixWorldNeedsUpdate=!0;var q=(this.currentTime-p.time)/(r.time-p.time),s=p[f],n=r[f];0>q&&(q=0);1<q&&(q=1);if("pos"===f)if(f=k.position,this.interpolationType===THREE.AnimationHandler.LINEAR)f.x=s[0]+(n[0]-s[0])*q,f.y=s[1]+(n[1]-s[1])*q,f.z=s[2]+(n[2]-s[2])*q;else{if(this.interpolationType===THREE.AnimationHandler.CATMULLROM||this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD)b[0]=
this.getPrevKeyWith("pos",g,p.index-1).pos,b[1]=s,b[2]=n,b[3]=this.getNextKeyWith("pos",g,r.index+1).pos,q=0.33*q+0.33,p=c(b,q),f.x=p[0],f.y=p[1],f.z=p[2],this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD&&(q=c(b,1.01*q),a.set(q[0],q[1],q[2]),a.sub(f),a.y=0,a.normalize(),f=Math.atan2(a.x,a.z),k.rotation.set(0,f,0))}else"rot"===f?THREE.Quaternion.slerp(s,n,k.quaternion,q):"scl"===f&&(f=k.scale,f.x=s[0]+(n[0]-s[0])*q,f.y=s[1]+(n[1]-s[1])*q,f.z=s[2]+(n[2]-s[2])*q)}}}}();
...
THREE.CombinedCamera.prototype.toTopView=function(){this.rotation.x=-Math.PI/2;this.rotation.y=0;this.rotation.z=0;this.rotationAutoUpdate=!1};THREE.CombinedCamera.prototype.toBottomView=function(){this.rotation.x=Math.PI/2;this.rotation.y=0;this.rotation.z=0;this.rotationAutoUpdate=!1};THREE.BoxGeometry=function(b,a,c,d,e,f){function g(a,b,c,d,e,f,g,n){var u,v=h.widthSegments,t=h.heightSegments,D=e/2,y=f/2,x=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)u="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)u="y",t=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)u="x",v=h.depthSegments;var w=v+1,z=t+1,B=e/v,A=f/t,F=new THREE.Vector3;F[u]=0<g?1:-1;for(e=0;e<z;e++)for(f=0;f<w;f++){var G=new THREE.Vector3;G[a]=(f*B-D)*c;G[b]=(e*A-y)*d;G[u]=g;h.vertices.push(G)}for(e=
0;e<t;e++)for(f=0;f<v;f++)y=f+w*e,a=f+w*(e+1),b=f+1+w*(e+1),c=f+1+w*e,d=new THREE.Vector2(f/v,1-e/t),g=new THREE.Vector2(f/v,1-(e+1)/t),u=new THREE.Vector2((f+1)/v,1-(e+1)/t),D=new THREE.Vector2((f+1)/v,1-e/t),y=new THREE.Face3(y+x,a+x,c+x),y.normal.copy(F),y.vertexNormals.push(F.clone(),F.clone(),F.clone()),y.materialIndex=n,h.faces.push(y),h.faceVertexUvs[0].push([d,g,D]),y=new THREE.Face3(a+x,b+x,c+x),y.normal.copy(F),y.vertexNormals.push(F.clone(),F.clone(),F.clone()),y.materialIndex=n,h.faces.push(y),
h.faceVertexUvs[0].push([g.clone(),u,D.clone()])}THREE.Geometry.call(this);this.parameters={width:b,height:a,depth:c,widthSegments:d,heightSegments:e,depthSegments:f};this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;var h=this;d=b/2;e=a/2;f=c/2;g("z","y",-1,-1,c,a,d,0);g("z","y",1,-1,c,a,-d,1);g("x","z",1,1,b,c,e,2);g("x","z",1,-1,b,c,-e,3);g("x","y",1,-1,b,a,f,4);g("x","y",-1,-1,b,a,-f,5);this.mergeVertices()};THREE.BoxGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CircleGeometry=function(b,a,c,d){THREE.Geometry.call(this);this.radius=b=b||50;this.segments=a=void 0!==a?Math.max(3,a):8;this.thetaStart=c=void 0!==c?c:0;this.thetaLength=d=void 0!==d?d:2*Math.PI;var e,f=[];e=new THREE.Vector3;var g=new THREE.Vector2(0.5,0.5);this.vertices.push(e);f.push(g);for(e=0;e<=a;e++){var h=new THREE.Vector3,k=c+e/a*d;h.x=b*Math.cos(k);h.y=b*Math.sin(k);this.vertices.push(h);f.push(new THREE.Vector2((h.x/b+1)/2,(h.y/b+1)/2))}c=new THREE.Vector3(0,0,1);for(e=1;e<=a;e++)this.faces.push(new THREE.Face3(e,
e+1,0,[c.clone(),c.clone(),c.clone()])),this.faceVertexUvs[0].push([f[e].clone(),f[e+1].clone(),g.clone()]);this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,b)};THREE.CircleGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CubeGeometry=function(b,a,c,d,e,f){console.warn("DEPRECATED: THREE.CubeGeometry is deprecated. Use THREE.BoxGeometry instead.");return new THREE.BoxGeometry(b,a,c,d,e,f)};THREE.CylinderGeometry=function(b,a,c,d,e,f){THREE.Geometry.call(this);this.parameters={radiusTop:b,radiusBottom:a,height:c,radialSegments:d,heightSegments:e,openEnded:f};b=void 0!==b?b:20;a=void 0!==a?a:20;c=void 0!==c?c:100;d=d||8;e=e||1;f=void 0!==f?f:!1;var g=c/2,h,k,l=[],m=[];for(k=0;k<=e;k++){var p=[],r=[],q=k/e,s=q*(a-b)+b;for(h=0;h<=d;h++){var n=h/d,u=new THREE.Vector3;u.x=s*Math.sin(n*Math.PI*2);u.y=-q*c+g;u.z=s*Math.cos(n*Math.PI*2);this.vertices.push(u);p.push(this.vertices.length-1);r.push(new THREE.Vector2(n,
1-q))}l.push(p);m.push(r)}c=(a-b)/c;for(h=0;h<d;h++)for(0!==b?(p=this.vertices[l[0][h]].clone(),r=this.vertices[l[0][h+1]].clone()):(p=this.vertices[l[1][h]].clone(),r=this.vertices[l[1][h+1]].clone()),p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize(),r.setY(Math.sqrt(r.x*r.x+r.z*r.z)*c).normalize(),k=0;k<e;k++){var q=l[k][h],s=l[k+1][h],n=l[k+1][h+1],u=l[k][h+1],v=p.clone(),t=p.clone(),D=r.clone(),y=r.clone(),x=m[k][h].clone(),w=m[k+1][h].clone(),z=m[k+1][h+1].clone(),B=m[k][h+1].clone();this.faces.push(new THREE.Face3(q,
s,u,[v,t,y]));this.faceVertexUvs[0].push([x,w,B]);this.faces.push(new THREE.Face3(s,n,u,[t.clone(),D,y.clone()]));this.faceVertexUvs[0].push([w.clone(),z,B.clone()])}if(!1===f&&0<b)for(this.vertices.push(new THREE.Vector3(0,g,0)),h=0;h<d;h++)q=l[0][h],s=l[0][h+1],n=this.vertices.length-1,v=new THREE.Vector3(0,1,0),t=new THREE.Vector3(0,1,0),D=new THREE.Vector3(0,1,0),x=m[0][h].clone(),w=m[0][h+1].clone(),z=new THREE.Vector2(w.x,0),this.faces.push(new THREE.Face3(q,s,n,[v,t,D])),this.faceVertexUvs[0].push([x,
w,z]);if(!1===f&&0<a)for(this.vertices.push(new THREE.Vector3(0,-g,0)),h=0;h<d;h++)q=l[k][h+1],s=l[k][h],n=this.vertices.length-1,v=new THREE.Vector3(0,-1,0),t=new THREE.Vector3(0,-1,0),D=new THREE.Vector3(0,-1,0),x=m[k][h+1].clone(),w=m[k][h].clone(),z=new THREE.Vector2(w.x,1),this.faces.push(new THREE.Face3(q,s,n,[v,t,D])),this.faceVertexUvs[0].push([x,w,z]);this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(b,a){"undefined"!==typeof b&&(THREE.Geometry.call(this),b=b instanceof Array?b:[b],this.shapebb=b[b.length-1].getBoundingBox(),this.addShapeList(b,a),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(b,a){for(var c=b.length,d=0;d<c;d++)this.addShape(b[d],a)};
...
(a=!0):d(f)==d(h)&&(a=!0),a?(c=-f,a=e,e=Math.sqrt(k)):(c=e,a=f,e=Math.sqrt(k/2));return new THREE.Vector2(c/e,a/e)}function e(c,d){var e,f;for(C=c.length;0<=--C;){e=C;f=C-1;0>f&&(f=c.length-1);for(var g=0,h=q+2*m,g=0;g<h;g++){var k=P*g,l=P*(g+1),n=d+e+k,k=d+f+k,p=d+f+l,l=d+e+l,r=c,s=g,v=h,u=e,x=f,n=n+K,k=k+K,p=p+K,l=l+K;G.faces.push(new THREE.Face3(n,k,l,null,null,t));G.faces.push(new THREE.Face3(k,p,l,null,null,t));n=D.generateSideWallUV(G,b,r,a,n,k,p,l,s,v,u,x);G.faceVertexUvs[0].push([n[0],n[1],
n[3]]);G.faceVertexUvs[0].push([n[1],n[2],n[3]])}}}function f(a,b,c){G.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=K;d+=K;e+=K;G.faces.push(new THREE.Face3(c,d,e,null,null,v));c=f?D.generateBottomUV(G,b,a,c,d,e):D.generateTopUV(G,b,a,c,d,e);G.faceVertexUvs[0].push(c)}var h=void 0!==a.amount?a.amount:100,k=void 0!==a.bevelThickness?a.bevelThickness:6,l=void 0!==a.bevelSize?a.bevelSize:k-2,m=void 0!==a.bevelSegments?a.bevelSegments:3,p=void 0!==a.bevelEnabled?a.bevelEnabled:!0,r=
void 0!==a.curveSegments?a.curveSegments:12,q=void 0!==a.steps?a.steps:1,s=a.extrudePath,n,u=!1,v=a.material,t=a.extrudeMaterial,D=void 0!==a.UVGenerator?a.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,y,x,w,z;s&&(n=s.getSpacedPoints(q),u=!0,p=!1,y=void 0!==a.frames?a.frames:new THREE.TubeGeometry.FrenetFrames(s,q,!1),x=new THREE.Vector3,w=new THREE.Vector3,z=new THREE.Vector3);p||(l=k=m=0);var B,A,F,G=this,K=this.vertices.length,s=b.extractPoints(r),r=s.shape,H=s.holes;if(s=!THREE.Shape.Utils.isClockWise(r)){r=
r.reverse();A=0;for(F=H.length;A<F;A++)B=H[A],THREE.Shape.Utils.isClockWise(B)&&(H[A]=B.reverse());s=!1}var N=THREE.Shape.Utils.triangulateShape(r,H),L=r;A=0;for(F=H.length;A<F;A++)B=H[A],r=r.concat(B);var E,I,J,R,M,P=r.length,O,S=N.length,s=[],C=0;J=L.length;E=J-1;for(I=C+1;C<J;C++,E++,I++)E===J&&(E=0),I===J&&(I=0),s[C]=d(L[C],L[E],L[I]);var U=[],Q,T=s.concat();A=0;for(F=H.length;A<F;A++){B=H[A];Q=[];C=0;J=B.length;E=J-1;for(I=C+1;C<J;C++,E++,I++)E===J&&(E=0),I===J&&(I=0),Q[C]=d(B[C],B[E],B[I]);
U.push(Q);T=T.concat(Q)}for(E=0;E<m;E++){J=E/m;R=k*(1-J);I=l*Math.sin(J*Math.PI/2);C=0;for(J=L.length;C<J;C++)M=c(L[C],s[C],I),f(M.x,M.y,-R);A=0;for(F=H.length;A<F;A++)for(B=H[A],Q=U[A],C=0,J=B.length;C<J;C++)M=c(B[C],Q[C],I),f(M.x,M.y,-R)}I=l;for(C=0;C<P;C++)M=p?c(r[C],T[C],I):r[C],u?(w.copy(y.normals[0]).multiplyScalar(M.x),x.copy(y.binormals[0]).multiplyScalar(M.y),z.copy(n[0]).add(w).add(x),f(z.x,z.y,z.z)):f(M.x,M.y,0);for(J=1;J<=q;J++)for(C=0;C<P;C++)M=p?c(r[C],T[C],I):r[C],u?(w.copy(y.normals[J]).multiplyScalar(M.x),
x.copy(y.binormals[J]).multiplyScalar(M.y),z.copy(n[J]).add(w).add(x),f(z.x,z.y,z.z)):f(M.x,M.y,h/q*J);for(E=m-1;0<=E;E--){J=E/m;R=k*(1-J);I=l*Math.sin(J*Math.PI/2);C=0;for(J=L.length;C<J;C++)M=c(L[C],s[C],I),f(M.x,M.y,h+R);A=0;for(F=H.length;A<F;A++)for(B=H[A],Q=U[A],C=0,J=B.length;C<J;C++)M=c(B[C],Q[C],I),u?f(M.x,M.y+n[q-1].y,n[q-1].x+R):f(M.x,M.y,h+R)}(function(){if(p){var a;a=0*P;for(C=0;C<S;C++)O=N[C],g(O[2]+a,O[1]+a,O[0]+a,!0);a=q+2*m;a*=P;for(C=0;C<S;C++)O=N[C],g(O[0]+a,O[1]+a,O[2]+a,!1)}else{for(C=
0;C<S;C++)O=N[C],g(O[2],O[1],O[0],!0);for(C=0;C<S;C++)O=N[C],g(O[0]+P*q,O[1]+P*q,O[2]+P*q,!1)}})();(function(){var a=0;e(L,a);a+=L.length;A=0;for(F=H.length;A<F;A++)B=H[A],e(B,a),a+=B.length})()};
THREE.ExtrudeGeometry.WorldUVGenerator={generateTopUV:function(b,a,c,d,e,f){a=b.vertices[e].x;e=b.vertices[e].y;c=b.vertices[f].x;f=b.vertices[f].y;return[new THREE.Vector2(b.vertices[d].x,b.vertices[d].y),new THREE.Vector2(a,e),new THREE.Vector2(c,f)]},generateBottomUV:function(b,a,c,d,e,f){return this.generateTopUV(b,a,c,d,e,f)},generateSideWallUV:function(b,a,c,d,e,f,g,h,k,l,m,p){a=b.vertices[e].x;c=b.vertices[e].y;e=b.vertices[e].z;d=b.vertices[f].x;k=b.vertices[f].y;f=b.vertices[f].z;l=b.vertices[g].x;
m=b.vertices[g].y;g=b.vertices[g].z;p=b.vertices[h].x;var r=b.vertices[h].y;b=b.vertices[h].z;return 0.01>Math.abs(c-k)?[new THREE.Vector2(a,1-e),new THREE.Vector2(d,1-f),new THREE.Vector2(l,1-g),new THREE.Vector2(p,1-b)]:[new THREE.Vector2(c,1-e),new THREE.Vector2(k,1-f),new THREE.Vector2(m,1-g),new THREE.Vector2(r,1-b)]}};THREE.ExtrudeGeometry.__v1=new THREE.Vector2;THREE.ExtrudeGeometry.__v2=new THREE.Vector2;THREE.ExtrudeGeometry.__v3=new THREE.Vector2;THREE.ExtrudeGeometry.__v4=new THREE.Vector2;
...
THREE.ShapeGeometry.prototype.addShape=function(b,a){void 0===a&&(a={});var c=a.material,d=void 0===a.UVGenerator?THREE.ExtrudeGeometry.WorldUVGenerator:a.UVGenerator,e,f,g,h=this.vertices.length;e=b.extractPoints(void 0!==a.curveSegments?a.curveSegments:12);var k=e.shape,l=e.holes;if(!THREE.Shape.Utils.isClockWise(k))for(k=k.reverse(),e=0,f=l.length;e<f;e++)g=l[e],THREE.Shape.Utils.isClockWise(g)&&(l[e]=g.reverse());var m=THREE.Shape.Utils.triangulateShape(k,l);e=0;for(f=l.length;e<f;e++)g=l[e],
k=k.concat(g);l=k.length;f=m.length;for(e=0;e<l;e++)g=k[e],this.vertices.push(new THREE.Vector3(g.x,g.y,0));for(e=0;e<f;e++)l=m[e],k=l[0]+h,g=l[1]+h,l=l[2]+h,this.faces.push(new THREE.Face3(k,g,l,null,null,c)),this.faceVertexUvs[0].push(d.generateBottomUV(this,b,a,k,g,l))};THREE.LatheGeometry=function(b,a,c,d){THREE.Geometry.call(this);a=a||12;c=c||0;d=d||2*Math.PI;for(var e=1/(b.length-1),f=1/a,g=0,h=a;g<=h;g++)for(var k=c+g*f*d,l=Math.cos(k),m=Math.sin(k),k=0,p=b.length;k<p;k++){var r=b[k],q=new THREE.Vector3;q.x=l*r.x-m*r.y;q.y=m*r.x+l*r.y;q.z=r.z;this.vertices.push(q)}c=b.length;g=0;for(h=a;g<h;g++)for(k=0,p=b.length-1;k<p;k++){a=m=k+c*g;d=m+c;var l=m+1+c,m=m+1,r=g*f,q=k*e,s=r+f,n=q+e;this.faces.push(new THREE.Face3(a,d,m));this.faceVertexUvs[0].push([new THREE.Vector2(r,
q),new THREE.Vector2(s,q),new THREE.Vector2(r,n)]);this.faces.push(new THREE.Face3(d,l,m));this.faceVertexUvs[0].push([new THREE.Vector2(s,q),new THREE.Vector2(s,n),new THREE.Vector2(r,n)])}this.mergeVertices();this.computeFaceNormals();this.computeVertexNormals()};THREE.LatheGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.PlaneGeometry=function(b,a,c,d){THREE.Geometry.call(this);this.width=b;this.height=a;this.widthSegments=c||1;this.heightSegments=d||1;var e=b/2,f=a/2;c=this.widthSegments;d=this.heightSegments;var g=c+1,h=d+1,k=this.width/c,l=this.height/d,m=new THREE.Vector3(0,0,1);for(b=0;b<h;b++)for(a=0;a<g;a++)this.vertices.push(new THREE.Vector3(a*k-e,-(b*l-f),0));for(b=0;b<d;b++)for(a=0;a<c;a++){var p=a+g*b,e=a+g*(b+1),f=a+1+g*(b+1),h=a+1+g*b,k=new THREE.Vector2(a/c,1-b/d),l=new THREE.Vector2(a/c,1-(b+
1)/d),r=new THREE.Vector2((a+1)/c,1-(b+1)/d),q=new THREE.Vector2((a+1)/c,1-b/d),p=new THREE.Face3(p,e,h);p.normal.copy(m);p.vertexNormals.push(m.clone(),m.clone(),m.clone());this.faces.push(p);this.faceVertexUvs[0].push([k,l,q]);p=new THREE.Face3(e,f,h);p.normal.copy(m);p.vertexNormals.push(m.clone(),m.clone(),m.clone());this.faces.push(p);this.faceVertexUvs[0].push([l.clone(),r,q.clone()])}this.computeCentroids()};THREE.PlaneGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.RingGeometry=function(b,a,c,d,e,f){THREE.Geometry.call(this);b=b||0;a=a||50;e=void 0!==e?e:0;f=void 0!==f?f:2*Math.PI;c=void 0!==c?Math.max(3,c):8;d=void 0!==d?Math.max(3,d):8;var g,h=[],k=b,l=(a-b)/d;for(b=0;b<=d;b++){for(g=0;g<=c;g++){var m=new THREE.Vector3,p=e+g/c*f;m.x=k*Math.cos(p);m.y=k*Math.sin(p);this.vertices.push(m);h.push(new THREE.Vector2((m.x/a+1)/2,(m.y/a+1)/2))}k+=l}a=new THREE.Vector3(0,0,1);for(b=0;b<d;b++)for(e=b*c,g=0;g<=c;g++)p=g+e,f=p+b,l=p+c+b,m=p+c+1+b,this.faces.push(new THREE.Face3(f,
l,m,[a.clone(),a.clone(),a.clone()])),this.faceVertexUvs[0].push([h[f].clone(),h[l].clone(),h[m].clone()]),f=p+b,l=p+c+1+b,m=p+1+b,this.faces.push(new THREE.Face3(f,l,m,[a.clone(),a.clone(),a.clone()])),this.faceVertexUvs[0].push([h[f].clone(),h[l].clone(),h[m].clone()]);this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,k)};THREE.RingGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.SphereGeometry=function(b,a,c,d,e,f,g){THREE.Geometry.call(this);this.parameters={radius:b,widthSegments:a,heightSegments:c,phiStart:d,phiLength:e,thetaStart:f,thetaLength:g};b=b||50;a=Math.max(3,Math.floor(a)||8);c=Math.max(2,Math.floor(c)||6);d=void 0!==d?d:0;e=void 0!==e?e:2*Math.PI;f=void 0!==f?f:0;g=void 0!==g?g:Math.PI;var h,k,l=[],m=[];for(k=0;k<=c;k++){var p=[],r=[];for(h=0;h<=a;h++){var q=h/a,s=k/c,n=new THREE.Vector3;n.x=-b*Math.cos(d+q*e)*Math.sin(f+s*g);n.y=b*Math.cos(f+s*g);n.z=
b*Math.sin(d+q*e)*Math.sin(f+s*g);this.vertices.push(n);p.push(this.vertices.length-1);r.push(new THREE.Vector2(q,1-s))}l.push(p);m.push(r)}for(k=0;k<c;k++)for(h=0;h<a;h++){d=l[k][h+1];e=l[k][h];f=l[k+1][h];g=l[k+1][h+1];var p=this.vertices[d].clone().normalize(),r=this.vertices[e].clone().normalize(),q=this.vertices[f].clone().normalize(),s=this.vertices[g].clone().normalize(),n=m[k][h+1].clone(),u=m[k][h].clone(),v=m[k+1][h].clone(),t=m[k+1][h+1].clone();Math.abs(this.vertices[d].y)===b?(n.x=(n.x+
u.x)/2,this.faces.push(new THREE.Face3(d,f,g,[p,q,s])),this.faceVertexUvs[0].push([n,v,t])):Math.abs(this.vertices[f].y)===b?(v.x=(v.x+t.x)/2,this.faces.push(new THREE.Face3(d,e,f,[p,r,q])),this.faceVertexUvs[0].push([n,u,v])):(this.faces.push(new THREE.Face3(d,e,g,[p,r,s])),this.faceVertexUvs[0].push([n,u,t]),this.faces.push(new THREE.Face3(e,f,g,[r.clone(),q,s.clone()])),this.faceVertexUvs[0].push([u.clone(),v,t.clone()]))}this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,
b)};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.TextGeometry=function(b,a){a=a||{};var c=THREE.FontUtils.generateShapes(b,a);a.amount=void 0!==a.height?a.height:50;void 0===a.bevelThickness&&(a.bevelThickness=10);void 0===a.bevelSize&&(a.bevelSize=8);void 0===a.bevelEnabled&&(a.bevelEnabled=!1);THREE.ExtrudeGeometry.call(this,c,a)};THREE.TextGeometry.prototype=Object.create(THREE.ExtrudeGeometry.prototype);THREE.TorusGeometry=function(b,a,c,d,e){THREE.Geometry.call(this);this.parameters={radius:b,tube:a,radialSegments:c,tubularSegments:d,arc:e};b=b||100;a=a||40;c=c||8;d=d||6;e=e||2*Math.PI;for(var f=new THREE.Vector3,g=[],h=[],k=0;k<=c;k++)for(var l=0;l<=d;l++){var m=l/d*e,p=k/c*Math.PI*2;f.x=b*Math.cos(m);f.y=b*Math.sin(m);var r=new THREE.Vector3;r.x=(b+a*Math.cos(p))*Math.cos(m);r.y=(b+a*Math.cos(p))*Math.sin(m);r.z=a*Math.sin(p);this.vertices.push(r);g.push(new THREE.Vector2(l/d,k/c));h.push(r.clone().sub(f).normalize())}for(k=
1;k<=c;k++)for(l=1;l<=d;l++)b=(d+1)*k+l-1,a=(d+1)*(k-1)+l-1,e=(d+1)*(k-1)+l,f=(d+1)*k+l,m=new THREE.Face3(b,a,f,[h[b].clone(),h[a].clone(),h[f].clone()]),this.faces.push(m),this.faceVertexUvs[0].push([g[b].clone(),g[a].clone(),g[f].clone()]),m=new THREE.Face3(a,e,f,[h[a].clone(),h[e].clone(),h[f].clone()]),this.faces.push(m),this.faceVertexUvs[0].push([g[a].clone(),g[e].clone(),g[f].clone()]);this.computeFaceNormals()};THREE.TorusGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.TorusKnotGeometry=function(b,a,c,d,e,f,g){function h(a,b,c,d,e){var f=Math.cos(a),g=Math.sin(a);a*=b/c;b=Math.cos(a);f*=d*(2+b)*0.5;g=d*(2+b)*g*0.5;d=e*d*Math.sin(a)*0.5;return new THREE.Vector3(f,g,d)}THREE.Geometry.call(this);this.parameters={radius:b,tube:a,radialSegments:c,tubularSegments:d,p:e,q:f,heightScale:g};b=b||100;a=a||40;c=c||64;d=d||8;e=e||2;f=f||3;g=g||1;for(var k=Array(c),l=new THREE.Vector3,m=new THREE.Vector3,p=new THREE.Vector3,r=0;r<c;++r){k[r]=Array(d);var q=r/c*2*e*Math.PI,
s=h(q,f,e,b,g),q=h(q+0.01,f,e,b,g);l.subVectors(q,s);m.addVectors(q,s);p.crossVectors(l,m);m.crossVectors(p,l);p.normalize();m.normalize();for(q=0;q<d;++q){var n=q/d*2*Math.PI,u=-a*Math.cos(n),n=a*Math.sin(n),v=new THREE.Vector3;v.x=s.x+u*m.x+n*p.x;v.y=s.y+u*m.y+n*p.y;v.z=s.z+u*m.z+n*p.z;k[r][q]=this.vertices.push(v)-1}}for(r=0;r<c;++r)for(q=0;q<d;++q)e=(r+1)%c,f=(q+1)%d,b=k[r][q],a=k[e][q],e=k[e][f],f=k[r][f],g=new THREE.Vector2(r/c,q/d),l=new THREE.Vector2((r+1)/c,q/d),m=new THREE.Vector2((r+1)/
c,(q+1)/d),p=new THREE.Vector2(r/c,(q+1)/d),this.faces.push(new THREE.Face3(b,a,f)),this.faceVertexUvs[0].push([g,l,p]),this.faces.push(new THREE.Face3(a,e,f)),this.faceVertexUvs[0].push([l.clone(),m,p.clone()]);this.computeFaceNormals();this.computeVertexNormals()};THREE.TorusKnotGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.TubeGeometry=function(b,a,c,d,e){THREE.Geometry.call(this);this.parameters={path:b,segments:a,radius:c,radialSegments:d,closed:e};a=a||64;c=c||1;d=d||8;e=e||!1;var f=[],g,h,k=a+1,l,m,p,r,q=new THREE.Vector3,s,n,u;s=new THREE.TubeGeometry.FrenetFrames(b,a,e);n=s.normals;u=s.binormals;this.tangents=s.tangents;this.normals=n;this.binormals=u;for(s=0;s<k;s++)for(f[s]=[],l=s/(k-1),r=b.getPointAt(l),g=n[s],h=u[s],l=0;l<d;l++)m=l/d*2*Math.PI,p=-c*Math.cos(m),m=c*Math.sin(m),q.copy(r),q.x+=p*g.x+m*
h.x,q.y+=p*g.y+m*h.y,q.z+=p*g.z+m*h.z,f[s][l]=this.vertices.push(new THREE.Vector3(q.x,q.y,q.z))-1;for(s=0;s<a;s++)for(l=0;l<d;l++)k=e?(s+1)%a:s+1,q=(l+1)%d,b=f[s][l],c=f[k][l],k=f[k][q],q=f[s][q],n=new THREE.Vector2(s/a,l/d),u=new THREE.Vector2((s+1)/a,l/d),g=new THREE.Vector2((s+1)/a,(l+1)/d),h=new THREE.Vector2(s/a,(l+1)/d),this.faces.push(new THREE.Face3(b,c,q)),this.faceVertexUvs[0].push([n,u,h]),this.faces.push(new THREE.Face3(c,k,q)),this.faceVertexUvs[0].push([u.clone(),g,h.clone()]);this.computeFaceNormals();
this.computeVertexNormals()};THREE.TubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.TubeGeometry.FrenetFrames=function(b,a,c){new THREE.Vector3;var d=new THREE.Vector3;new THREE.Vector3;var e=[],f=[],g=[],h=new THREE.Vector3,k=new THREE.Matrix4;a+=1;var l,m,p;this.tangents=e;this.normals=f;this.binormals=g;for(l=0;l<a;l++)m=l/(a-1),e[l]=b.getTangentAt(m),e[l].normalize();f[0]=new THREE.Vector3;g[0]=new THREE.Vector3;b=Number.MAX_VALUE;l=Math.abs(e[0].x);m=Math.abs(e[0].y);p=Math.abs(e[0].z);l<=b&&(b=l,d.set(1,0,0));m<=b&&(b=m,d.set(0,1,0));p<=b&&d.set(0,0,1);h.crossVectors(e[0],
...
THREE.VertexTangentsHelper.prototype.update=function(b){var a=new THREE.Vector3;return function(b){b=["a","b","c","d"];this.object.updateMatrixWorld(!0);for(var d=this.geometry.vertices,e=this.object.geometry.vertices,f=this.object.geometry.faces,g=this.object.matrixWorld,h=0,k=0,l=f.length;k<l;k++)for(var m=f[k],p=0,r=m.vertexTangents.length;p<r;p++){var q=m.vertexTangents[p];d[h].copy(e[m[b[p]]]).applyMatrix4(g);a.copy(q).transformDirection(g).multiplyScalar(this.size);a.add(d[h]);h+=1;d[h].copy(a);
h+=1}this.geometry.verticesNeedUpdate=!0;return this}}();THREE.WireframeHelper=function(b,a){var c=void 0!==a?a:16777215,d=[0,0],e={},f=function(a,b){return a-b},g=["a","b","c"],h=new THREE.BufferGeometry;if(b.geometry instanceof THREE.Geometry){for(var k=b.geometry.vertices,l=b.geometry.faces,m=0,p=new Uint32Array(6*l.length),r=0,q=l.length;r<q;r++)for(var s=l[r],n=0;3>n;n++){d[0]=s[g[n]];d[1]=s[g[(n+1)%3]];d.sort(f);var u=d.toString();void 0===e[u]&&(p[2*m]=d[0],p[2*m+1]=d[1],e[u]=!0,m++)}h.addAttribute("position",new THREE.Float32Attribute(2*m,3));d=
h.attributes.position.array;r=0;for(q=m;r<q;r++)for(n=0;2>n;n++)m=k[p[2*r+n]],g=6*r+3*n,d[g+0]=m.x,d[g+1]=m.y,d[g+2]=m.z}else if(b.geometry instanceof THREE.BufferGeometry&&void 0!==b.geometry.attributes.index){for(var k=b.geometry.attributes.position.array,q=b.geometry.attributes.index.array,l=b.geometry.offsets,m=0,p=new Uint32Array(2*q.length),s=0,v=l.length;s<v;++s)for(var n=l[s].start,u=l[s].count,g=l[s].index,r=n,t=n+u;r<t;r+=3)for(n=0;3>n;n++)d[0]=g+q[r+n],d[1]=g+q[r+(n+1)%3],d.sort(f),u=d.toString(),
void 0===e[u]&&(p[2*m]=d[0],p[2*m+1]=d[1],e[u]=!0,m++);h.addAttribute("position",new THREE.Float32Attribute(2*m,3));d=h.attributes.position.array;r=0;for(q=m;r<q;r++)for(n=0;2>n;n++)g=6*r+3*n,m=3*p[2*r+n],d[g+0]=k[m],d[g+1]=k[m+1],d[g+2]=k[m+2]}else if(b.geometry instanceof THREE.BufferGeometry)for(k=b.geometry.attributes.position.array,m=k.length/3,p=m/3,h.addAttribute("position",new THREE.Float32Attribute(2*m,3)),d=h.attributes.position.array,r=0,q=p;r<q;r++)for(n=0;3>n;n++)g=18*r+6*n,p=9*r+3*n,
d[g+0]=k[p],d[g+1]=k[p+1],d[g+2]=k[p+2],m=9*r+(n+1)%3*3,d[g+3]=k[m],d[g+4]=k[m+1],d[g+5]=k[m+2];THREE.Line.call(this,h,new THREE.LineBasicMaterial({color:c}),THREE.LinePieces);this.matrixAutoUpdate=!1;this.matrixWorld=b.matrixWorld};THREE.WireframeHelper.prototype=Object.create(THREE.Line.prototype);THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(b){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);THREE.LensFlare=function(b,a,c,d,e){THREE.Object3D.call(this);this.lensFlares=[];this.positionScreen=new THREE.Vector3;this.customUpdateCallback=void 0;void 0!==b&&this.add(b,a,c,d,e)};THREE.LensFlare.prototype=Object.create(THREE.Object3D.prototype);
...
f!==d.currentFrame&&(this.morphTargetInfluences[d.lastFrame]=0,this.morphTargetInfluences[d.currentFrame]=1*g,this.morphTargetInfluences[f]=0,d.lastFrame=d.currentFrame,d.currentFrame=f);e=d.time%e/e;d.directionBackwards&&(e=1-e);this.morphTargetInfluences[d.currentFrame]=e*g;this.morphTargetInfluences[d.lastFrame]=(1-e)*g}}};THREE.LensFlarePlugin=function(){function b(b,c){var d=a.createProgram(),e=a.createShader(a.FRAGMENT_SHADER),f=a.createShader(a.VERTEX_SHADER),g="precision "+c+" float;\nprecision "+c+" int;\n";a.shaderSource(e,g+b.fragmentShader);a.shaderSource(f,g+b.vertexShader);a.compileShader(e);a.compileShader(f);a.attachShader(d,e);a.attachShader(d,f);a.linkProgram(d);return d}var a,c,d,e,f,g,h,k,l,m,p,r,q;this.init=function(s){a=s.context;c=s;d=s.getPrecision();e=new Float32Array(16);f=new Uint16Array(6);
...
a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MAG_FILTER,a.NEAREST);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.NEAREST);0>=a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS)?(m=!1,p=b(THREE.ShaderFlares.lensFlare,d)):(m=!0,p=b(THREE.ShaderFlares.lensFlareVertexTexture,d));r={};q={};r.vertex=a.getAttribLocation(p,"position");r.uv=a.getAttribLocation(p,"uv");q.renderType=a.getUniformLocation(p,"renderType");q.map=a.getUniformLocation(p,"map");q.occlusionMap=a.getUniformLocation(p,"occlusionMap");
q.opacity=a.getUniformLocation(p,"opacity");q.color=a.getUniformLocation(p,"color");q.scale=a.getUniformLocation(p,"scale");q.rotation=a.getUniformLocation(p,"rotation");q.screenPosition=a.getUniformLocation(p,"screenPosition")};this.render=function(b,d,e,f){b=b.__webglFlares;var t=b.length;if(t){var D=new THREE.Vector3,y=f/e,x=0.5*e,w=0.5*f,z=16/f,B=new THREE.Vector2(z*y,z),A=new THREE.Vector3(1,1,0),F=new THREE.Vector2(1,1),G=q,z=r;a.useProgram(p);a.enableVertexAttribArray(r.vertex);a.enableVertexAttribArray(r.uv);
a.uniform1i(G.occlusionMap,0);a.uniform1i(G.map,1);a.bindBuffer(a.ARRAY_BUFFER,g);a.vertexAttribPointer(z.vertex,2,a.FLOAT,!1,16,0);a.vertexAttribPointer(z.uv,2,a.FLOAT,!1,16,8);a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,h);a.disable(a.CULL_FACE);a.depthMask(!1);var K,H,N,L,E;for(K=0;K<t;K++)if(z=16/f,B.set(z*y,z),L=b[K],D.set(L.matrixWorld.elements[12],L.matrixWorld.elements[13],L.matrixWorld.elements[14]),D.applyMatrix4(d.matrixWorldInverse),D.applyProjection(d.projectionMatrix),A.copy(D),F.x=A.x*x+x,
F.y=A.y*w+w,m||0<F.x&&F.x<e&&0<F.y&&F.y<f)for(a.activeTexture(a.TEXTURE1),a.bindTexture(a.TEXTURE_2D,k),a.copyTexImage2D(a.TEXTURE_2D,0,a.RGB,F.x-8,F.y-8,16,16,0),a.uniform1i(G.renderType,0),a.uniform2f(G.scale,B.x,B.y),a.uniform3f(G.screenPosition,A.x,A.y,A.z),a.disable(a.BLEND),a.enable(a.DEPTH_TEST),a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0),a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,l),a.copyTexImage2D(a.TEXTURE_2D,0,a.RGBA,F.x-8,F.y-8,16,16,0),a.uniform1i(G.renderType,1),a.disable(a.DEPTH_TEST),
a.activeTexture(a.TEXTURE1),a.bindTexture(a.TEXTURE_2D,k),a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0),L.positionScreen.copy(A),L.customUpdateCallback?L.customUpdateCallback(L):L.updateLensFlares(),a.uniform1i(G.renderType,2),a.enable(a.BLEND),H=0,N=L.lensFlares.length;H<N;H++)E=L.lensFlares[H],0.001<E.opacity&&0.001<E.scale&&(A.x=E.x,A.y=E.y,A.z=E.z,z=E.size*E.scale/f,B.x=z*y,B.y=z,a.uniform3f(G.screenPosition,A.x,A.y,A.z),a.uniform2f(G.scale,B.x,B.y),a.uniform1f(G.rotation,E.rotation),a.uniform1f(G.opacity,
E.opacity),a.uniform3f(G.color,E.color.r,E.color.g,E.color.b),c.setBlending(E.blending,E.blendEquation,E.blendSrc,E.blendDst),c.setTexture(E.texture,1),a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0));a.enable(a.CULL_FACE);a.enable(a.DEPTH_TEST);a.depthMask(!0)}}};THREE.ShadowMapPlugin=function(){var b,a,c,d,e,f,g=new THREE.Frustum,h=new THREE.Matrix4,k=new THREE.Vector3,l=new THREE.Vector3,m=new THREE.Vector3;this.init=function(g){b=g.context;a=g;g=THREE.ShaderLib.depthRGBA;var h=THREE.UniformsUtils.clone(g.uniforms);c=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h});d=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(b,c){a.shadowMapEnabled&&a.shadowMapAutoUpdate&&this.update(b,c)};this.update=function(p,r){var q,s,n,u,v,t,D,y,x,w,z=[];u=0;b.clearColor(1,1,1,1);b.disable(b.BLEND);b.enable(b.CULL_FACE);b.frontFace(b.CCW);a.shadowMapCullFace===
THREE.CullFaceFront?b.cullFace(b.FRONT):b.cullFace(b.BACK);a.setDepthTest(!0);q=0;for(s=p.__lights.length;q<s;q++)if(n=p.__lights[q],n.castShadow)if(n instanceof THREE.DirectionalLight&&n.shadowCascade)for(v=0;v<n.shadowCascadeCount;v++){if(n.shadowCascadeArray[v])t=n.shadowCascadeArray[v];else{x=n;w=v;t=new THREE.DirectionalLight;t.isVirtual=!0;t.onlyShadow=!0;t.castShadow=!0;t.shadowCameraNear=x.shadowCameraNear;t.shadowCameraFar=x.shadowCameraFar;t.shadowCameraLeft=x.shadowCameraLeft;t.shadowCameraRight=
x.shadowCameraRight;t.shadowCameraBottom=x.shadowCameraBottom;t.shadowCameraTop=x.shadowCameraTop;t.shadowCameraVisible=x.shadowCameraVisible;t.shadowDarkness=x.shadowDarkness;t.shadowBias=x.shadowCascadeBias[w];t.shadowMapWidth=x.shadowCascadeWidth[w];t.shadowMapHeight=x.shadowCascadeHeight[w];t.pointsWorld=[];t.pointsFrustum=[];D=t.pointsWorld;y=t.pointsFrustum;for(var B=0;8>B;B++)D[B]=new THREE.Vector3,y[B]=new THREE.Vector3;D=x.shadowCascadeNearZ[w];x=x.shadowCascadeFarZ[w];y[0].set(-1,-1,D);
y[1].set(1,-1,D);y[2].set(-1,1,D);y[3].set(1,1,D);y[4].set(-1,-1,x);y[5].set(1,-1,x);y[6].set(-1,1,x);y[7].set(1,1,x);t.originalCamera=r;y=new THREE.Gyroscope;y.position.copy(n.shadowCascadeOffset);y.add(t);y.add(t.target);r.add(y);n.shadowCascadeArray[v]=t;console.log("Created virtualLight",t)}w=n;D=v;x=w.shadowCascadeArray[D];x.position.copy(w.position);x.target.position.copy(w.target.position);x.lookAt(x.target.position);x.shadowCameraVisible=w.shadowCameraVisible;x.shadowDarkness=w.shadowDarkness;
x.shadowBias=w.shadowCascadeBias[D];y=w.shadowCascadeNearZ[D];w=w.shadowCascadeFarZ[D];x=x.pointsFrustum;x[0].z=y;x[1].z=y;x[2].z=y;x[3].z=y;x[4].z=w;x[5].z=w;x[6].z=w;x[7].z=w;z[u]=t;u++}else z[u]=n,u++;q=0;for(s=z.length;q<s;q++){n=z[q];n.shadowMap||(v=THREE.LinearFilter,a.shadowMapType===THREE.PCFSoftShadowMap&&(v=THREE.NearestFilter),n.shadowMap=new THREE.WebGLRenderTarget(n.shadowMapWidth,n.shadowMapHeight,{minFilter:v,magFilter:v,format:THREE.RGBAFormat}),n.shadowMapSize=new THREE.Vector2(n.shadowMapWidth,
n.shadowMapHeight),n.shadowMatrix=new THREE.Matrix4);if(!n.shadowCamera){if(n instanceof THREE.SpotLight)n.shadowCamera=new THREE.PerspectiveCamera(n.shadowCameraFov,n.shadowMapWidth/n.shadowMapHeight,n.shadowCameraNear,n.shadowCameraFar);else if(n instanceof THREE.DirectionalLight)n.shadowCamera=new THREE.OrthographicCamera(n.shadowCameraLeft,n.shadowCameraRight,n.shadowCameraTop,n.shadowCameraBottom,n.shadowCameraNear,n.shadowCameraFar);else{console.error("Unsupported light type for shadow");continue}p.add(n.shadowCamera);
!0===p.autoUpdate&&p.updateMatrixWorld()}n.shadowCameraVisible&&!n.cameraHelper&&(n.cameraHelper=new THREE.CameraHelper(n.shadowCamera),n.shadowCamera.add(n.cameraHelper));if(n.isVirtual&&n.originalCamera==r){v=r;u=n.shadowCamera;t=n.pointsFrustum;y=n.pointsWorld;k.set(Infinity,Infinity,Infinity);l.set(-Infinity,-Infinity,-Infinity);for(x=0;8>x;x++)w=y[x],w.copy(t[x]),THREE.ShadowMapPlugin.__projector.unprojectVector(w,v),w.applyMatrix4(u.matrixWorldInverse),w.x<k.x&&(k.x=w.x),w.x>l.x&&(l.x=w.x),
w.y<k.y&&(k.y=w.y),w.y>l.y&&(l.y=w.y),w.z<k.z&&(k.z=w.z),w.z>l.z&&(l.z=w.z);u.left=k.x;u.right=l.x;u.top=l.y;u.bottom=k.y;u.updateProjectionMatrix()}u=n.shadowMap;t=n.shadowMatrix;v=n.shadowCamera;v.position.setFromMatrixPosition(n.matrixWorld);m.setFromMatrixPosition(n.target.matrixWorld);v.lookAt(m);v.updateMatrixWorld();v.matrixWorldInverse.getInverse(v.matrixWorld);n.cameraHelper&&(n.cameraHelper.visible=n.shadowCameraVisible);n.shadowCameraVisible&&n.cameraHelper.update();t.set(0.5,0,0,0.5,0,
0.5,0,0.5,0,0,0.5,0.5,0,0,0,1);t.multiply(v.projectionMatrix);t.multiply(v.matrixWorldInverse);h.multiplyMatrices(v.projectionMatrix,v.matrixWorldInverse);g.setFromMatrix(h);a.setRenderTarget(u);a.clear();w=p.__webglObjects;n=0;for(u=w.length;n<u;n++)y=w[n],x=y.object,y.render=!1,!x.visible||!x.castShadow||(x instanceof THREE.Mesh||x instanceof THREE.ParticleSystem)&&x.frustumCulled&&!g.intersectsObject(x)||(x._modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,x.matrixWorld),y.render=!0);n=0;
for(u=w.length;n<u;n++)y=w[n],y.render&&(x=y.object,t=y.buffer,B=x.material instanceof THREE.MeshFaceMaterial?x.material.materials[0]:x.material,D=void 0!==x.geometry.morphTargets&&0<x.geometry.morphTargets.length&&B.morphTargets,B=x instanceof THREE.SkinnedMesh&&B.skinning,D=x.customDepthMaterial?x.customDepthMaterial:B?D?f:e:D?d:c,t instanceof THREE.BufferGeometry?a.renderBufferDirect(v,p.__lights,null,D,t,x,y.offsetIndices):a.renderBuffer(v,p.__lights,null,D,t,x));w=p.__webglObjectsImmediate;n=
0;for(u=w.length;n<u;n++)y=w[n],x=y.object,x.visible&&x.castShadow&&(x._modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,x.matrixWorld),a.renderImmediateObject(v,p.__lights,null,c,x))}q=a.getClearColor();s=a.getClearAlpha();b.clearColor(q.r,q.g,q.b,s);b.enable(b.BLEND);a.shadowMapCullFace===THREE.CullFaceFront&&b.cullFace(b.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;THREE.SpritePlugin=function(){var b,a,c,d,e,f,g,h,k,l,m,p,r,q,s,n,u;function v(a,b){return a.z!==b.z?b.z-a.z:b.id-a.id}var t,D,y,x,w,z,B,A;this.init=function(v){t=v.context;D=v;x=new Float32Array([-0.5,-0.5,0,0,0.5,-0.5,1,0,0.5,0.5,1,1,-0.5,0.5,0,1]);w=new Uint16Array([0,1,2,0,2,3]);z=t.createBuffer();B=t.createBuffer();t.bindBuffer(t.ARRAY_BUFFER,z);t.bufferData(t.ARRAY_BUFFER,x,t.STATIC_DRAW);t.bindBuffer(t.ELEMENT_ARRAY_BUFFER,B);t.bufferData(t.ELEMENT_ARRAY_BUFFER,w,t.STATIC_DRAW);v=t.createProgram();
var G=t.createShader(t.VERTEX_SHADER),K=t.createShader(t.FRAGMENT_SHADER);t.shaderSource(G,["precision "+D.getPrecision()+" float;","uniform mat4 modelViewMatrix;\nuniform mat4 projectionMatrix;\nuniform float rotation;\nuniform vec2 scale;\nuniform vec2 uvOffset;\nuniform vec2 uvScale;\nattribute vec2 position;\nattribute vec2 uv;\nvarying vec2 vUV;\nvoid main() {\nvUV = uvOffset + uv * uvScale;\nvec2 alignedPosition = position * scale;\nvec2 rotatedPosition;\nrotatedPosition.x = cos( rotation ) * alignedPosition.x - sin( rotation ) * alignedPosition.y;\nrotatedPosition.y = sin( rotation ) * alignedPosition.x + cos( rotation ) * alignedPosition.y;\nvec4 finalPosition;\nfinalPosition = modelViewMatrix * vec4( 0.0, 0.0, 0.0, 1.0 );\nfinalPosition.xy += rotatedPosition;\nfinalPosition = projectionMatrix * finalPosition;\ngl_Position = finalPosition;\n}"].join("\n"));
t.shaderSource(K,["precision "+D.getPrecision()+" float;","uniform vec3 color;\nuniform sampler2D map;\nuniform float opacity;\nuniform int fogType;\nuniform vec3 fogColor;\nuniform float fogDensity;\nuniform float fogNear;\nuniform float fogFar;\nuniform float alphaTest;\nvarying vec2 vUV;\nvoid main() {\nvec4 texture = texture2D( map, vUV );\nif ( texture.a < alphaTest ) discard;\ngl_FragColor = vec4( color * texture.xyz, texture.a * opacity );\nif ( fogType > 0 ) {\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\nfloat fogFactor = 0.0;\nif ( fogType == 1 ) {\nfogFactor = smoothstep( fogNear, fogFar, depth );\n} else {\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n}\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n}\n}"].join("\n"));
t.compileShader(G);t.compileShader(K);t.attachShader(v,G);t.attachShader(v,K);t.linkProgram(v);A=v;n=t.getAttribLocation(A,"position");u=t.getAttribLocation(A,"uv");b=t.getUniformLocation(A,"uvOffset");a=t.getUniformLocation(A,"uvScale");c=t.getUniformLocation(A,"rotation");d=t.getUniformLocation(A,"scale");e=t.getUniformLocation(A,"color");f=t.getUniformLocation(A,"map");g=t.getUniformLocation(A,"opacity");h=t.getUniformLocation(A,"modelViewMatrix");k=t.getUniformLocation(A,"projectionMatrix");l=
t.getUniformLocation(A,"fogType");m=t.getUniformLocation(A,"fogDensity");p=t.getUniformLocation(A,"fogNear");r=t.getUniformLocation(A,"fogFar");q=t.getUniformLocation(A,"fogColor");s=t.getUniformLocation(A,"alphaTest");v=document.createElement("canvas");v.width=8;v.height=8;G=v.getContext("2d");G.fillStyle="#ffffff";G.fillRect(0,0,v.width,v.height);y=new THREE.Texture(v);y.needsUpdate=!0};this.render=function(x,w,K,H){K=x.__webglSprites;if(H=K.length){t.useProgram(A);t.enableVertexAttribArray(n);
t.enableVertexAttribArray(u);t.disable(t.CULL_FACE);t.enable(t.BLEND);t.bindBuffer(t.ARRAY_BUFFER,z);t.vertexAttribPointer(n,2,t.FLOAT,!1,16,0);t.vertexAttribPointer(u,2,t.FLOAT,!1,16,8);t.bindBuffer(t.ELEMENT_ARRAY_BUFFER,B);t.uniformMatrix4fv(k,!1,w.projectionMatrix.elements);t.activeTexture(t.TEXTURE0);t.uniform1i(f,0);var N=0,L=0,E=x.fog;E?(t.uniform3f(q,E.color.r,E.color.g,E.color.b),E instanceof THREE.Fog?(t.uniform1f(p,E.near),t.uniform1f(r,E.far),t.uniform1i(l,1),L=N=1):E instanceof THREE.FogExp2&&
(t.uniform1f(m,E.density),t.uniform1i(l,2),L=N=2)):(t.uniform1i(l,0),L=N=0);for(var I,J=[],E=0;E<H;E++)I=K[E],!1!==I.visible&&(I._modelViewMatrix.multiplyMatrices(w.matrixWorldInverse,I.matrixWorld),I.z=-I._modelViewMatrix.elements[14]);K.sort(v);for(E=0;E<H;E++)I=K[E],!1!==I.visible&&(w=I.material,t.uniform1f(s,w.alphaTest),t.uniformMatrix4fv(h,!1,I._modelViewMatrix.elements),J[0]=I.scale.x,J[1]=I.scale.y,I=x.fog&&w.fog?L:0,N!==I&&(t.uniform1i(l,I),N=I),null!==w.map?(t.uniform2f(b,w.map.offset.x,
w.map.offset.y),t.uniform2f(a,w.map.repeat.x,w.map.repeat.y)):(t.uniform2f(b,0,0),t.uniform2f(a,1,1)),t.uniform1f(g,w.opacity),t.uniform3f(e,w.color.r,w.color.g,w.color.b),t.uniform1f(c,w.rotation),t.uniform2fv(d,J),D.setBlending(w.blending,w.blendEquation,w.blendSrc,w.blendDst),D.setDepthTest(w.depthTest),D.setDepthWrite(w.depthWrite),w.map&&w.map.image&&w.map.image.width?D.setTexture(w.map,0):D.setTexture(y,0),t.drawElements(t.TRIANGLES,6,t.UNSIGNED_SHORT,0));t.enable(t.CULL_FACE)}}};THREE.DepthPassPlugin=function(){this.enabled=!1;this.renderTarget=null;var b,a,c,d,e,f,g=new THREE.Frustum,h=new THREE.Matrix4;this.init=function(g){b=g.context;a=g;g=THREE.ShaderLib.depthRGBA;var h=THREE.UniformsUtils.clone(g.uniforms);c=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h});d=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,b){this.enabled&&this.update(a,b)};this.update=function(k,l){var m,p,r,q,s,n,u;b.clearColor(1,1,1,1);b.disable(b.BLEND);a.setDepthTest(!0);!0===k.autoUpdate&&k.updateMatrixWorld();l.matrixWorldInverse.getInverse(l.matrixWorld);
h.multiplyMatrices(l.projectionMatrix,l.matrixWorldInverse);g.setFromMatrix(h);a.setRenderTarget(this.renderTarget);a.clear();u=k.__webglObjects;m=0;for(p=u.length;m<p;m++)s=u[m],n=s.object,s.render=!1,!n.visible||(n instanceof THREE.Mesh||n instanceof THREE.ParticleSystem)&&n.frustumCulled&&!g.intersectsObject(n)||(n._modelViewMatrix.multiplyMatrices(l.matrixWorldInverse,n.matrixWorld),s.render=!0);var v;m=0;for(p=u.length;m<p;m++)s=u[m],s.render&&(n=s.object,r=s.buffer,n instanceof THREE.ParticleSystem&&
!n.customDepthMaterial||((v=n.material instanceof THREE.MeshFaceMaterial?n.material.materials[0]:n.material)&&a.setMaterialFaces(n.material),q=void 0!==n.geometry.morphTargets&&0<n.geometry.morphTargets.length&&v.morphTargets,v=n instanceof THREE.SkinnedMesh&&v.skinning,q=n.customDepthMaterial?n.customDepthMaterial:v?q?f:e:q?d:c,r instanceof THREE.BufferGeometry?a.renderBufferDirect(l,k.__lights,null,q,r,n,s.offsetIndices):a.renderBuffer(l,k.__lights,null,q,r,n)));u=k.__webglObjectsImmediate;m=0;
for(p=u.length;m<p;m++)s=u[m],n=s.object,n.visible&&(n._modelViewMatrix.multiplyMatrices(l.matrixWorldInverse,n.matrixWorld),a.renderImmediateObject(l,k.__lights,null,c,n));m=a.getClearColor();p=a.getClearAlpha();b.clearColor(m.r,m.g,m.b,p);b.enable(b.BLEND)}};THREE.ShaderFlares={lensFlareVertexTexture:{vertexShader:"uniform lowp int renderType;\nuniform vec3 screenPosition;\nuniform vec2 scale;\nuniform float rotation;\nuniform sampler2D occlusionMap;\nattribute vec2 position;\nattribute vec2 uv;\nvarying vec2 vUV;\nvarying float vVisibility;\nvoid main() {\nvUV = uv;\nvec2 pos = position;\nif( renderType == 2 ) {\nvec4 visibility = texture2D( occlusionMap, vec2( 0.1, 0.1 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.5, 0.1 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.9, 0.1 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.9, 0.5 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.9, 0.9 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.5, 0.9 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.1, 0.9 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.1, 0.5 ) );\nvisibility += texture2D( occlusionMap, vec2( 0.5, 0.5 ) );\nvVisibility =        visibility.r / 9.0;\nvVisibility *= 1.0 - visibility.g / 9.0;\nvVisibility *=       visibility.b / 9.0;\nvVisibility *= 1.0 - visibility.a / 9.0;\npos.x = cos( rotation ) * position.x - sin( rotation ) * position.y;\npos.y = sin( rotation ) * position.x + cos( rotation ) * position.y;\n}\ngl_Position = vec4( ( pos * scale + screenPosition.xy ).xy, screenPosition.z, 1.0 );\n}",
