...
(function(b){var a=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};b.Triangulate=function(b,d){var e=b.length;if(3>e)return null;var f=[],g=[],h=[],k,l,n;if(0<a(b))for(l=0;l<e;l++)g[l]=l;else for(l=0;l<e;l++)g[l]=e-1-l;var p=2*e;for(l=e-1;2<e;){if(0>=p--){console.log("Warning, unable to triangulate polygon!");break}k=l;e<=k&&(k=0);l=k+1;e<=l&&(l=0);n=l+1;e<=n&&(n=0);var r;a:{var q=r=void 0,s=void 0,m=void 0,u=void 0,v=void 0,t=void 0,D=void 0,y=
void 0,q=b[g[k]].x,s=b[g[k]].y,m=b[g[l]].x,u=b[g[l]].y,v=b[g[n]].x,t=b[g[n]].y;if(1E-10>(m-q)*(t-s)-(u-s)*(v-q))r=!1;else{var x=void 0,w=void 0,z=void 0,B=void 0,A=void 0,F=void 0,G=void 0,K=void 0,H=void 0,N=void 0,H=K=G=y=D=void 0,x=v-m,w=t-u,z=q-v,B=s-t,A=m-q,F=u-s;for(r=0;r<e;r++)if(D=b[g[r]].x,y=b[g[r]].y,!(D===q&&y===s||D===m&&y===u||D===v&&y===t)&&(G=D-q,K=y-s,H=D-m,N=y-u,D-=v,y-=t,H=x*N-w*H,G=A*K-F*G,K=z*y-B*D,-1E-10<=H&&-1E-10<=K&&-1E-10<=G)){r=!1;break a}r=!0}}if(r){f.push([b[g[k]],b[g[l]],
...
THREE.PathActions.MOVE_TO&&0!=h.actions.length&&(g.push(h),h=new THREE.Path),h[e].apply(h,f);0!=h.actions.length&&g.push(h);if(0==g.length)return[];var k,l,n;f=[];if(1==g.length)return l=g[0],n=new THREE.Shape,n.actions=l.actions,n.curves=l.curves,f.push(n),f;var p=!THREE.Shape.Utils.isClockWise(g[0].getPoints()),p=b?!p:p;n=[];h=[];e=[];var r=0,q;h[r]=void 0;e[r]=[];c=0;for(d=g.length;c<d;c++)l=g[c],q=l.getPoints(),k=THREE.Shape.Utils.isClockWise(q),(k=b?!k:k)?(!p&&h[r]&&r++,h[r]={s:new THREE.Shape,
p:q},h[r].s.actions=l.actions,h[r].s.curves=l.curves,p&&r++,e[r]=[]):e[r].push({h:l,p:q[0]});if(1<h.length){c=!1;d=[];b=0;for(g=h.length;b<g;b++)n[b]=[];b=0;for(g=h.length;b<g;b++)for(l=e[b],k=0;k<l.length;k++){p=l[k];r=!0;for(q=0;q<h.length;q++)a(p.p,h[q].p)&&(b!=q&&d.push({froms:b,tos:q,hole:k}),r?(r=!1,n[q].push(p)):c=!0);r&&n[b].push(p)}0<d.length&&(c||(e=n))}c=0;for(d=h.length;c<d;c++)for(n=h[c].s,f.push(n),b=e[c],g=0,l=b.length;g<l;g++)n.holes.push(b[g].h);return f};THREE.Shape=function(){THREE.Path.apply(this,arguments);this.holes=[]};THREE.Shape.prototype=Object.create(THREE.Path.prototype);THREE.Shape.prototype.extrude=function(b){return new THREE.ExtrudeGeometry(this,b)};THREE.Shape.prototype.makeGeometry=function(b){return new THREE.ShapeGeometry(this,b)};THREE.Shape.prototype.getPointsHoles=function(b){var a,c=this.holes.length,d=[];for(a=0;a<c;a++)d[a]=this.holes[a].getTransformedPoints(b,this.bends);return d};
...
THREE.Shape.Utils={triangulateShape:function(b,a){function c(a,b,c){return a.x!=b.x?a.x<b.x?a.x<=c.x&&c.x<=b.x:b.x<=c.x&&c.x<=a.x:a.y<b.y?a.y<=c.y&&c.y<=b.y:b.y<=c.y&&c.y<=a.y}function d(a,b,d,e,f){var g=b.x-a.x,k=b.y-a.y,h=e.x-d.x,l=e.y-d.y,n=a.x-d.x,p=a.y-d.y,z=k*h-g*l,B=k*n-g*p;if(1E-10<Math.abs(z)){if(0<z){if(0>B||B>z)return[];h=l*n-h*p;if(0>h||h>z)return[]}else{if(0<B||B<z)return[];h=l*n-h*p;if(0<h||h<z)return[]}if(0==h)return!f||0!=B&&B!=z?[a]:[];if(h==z)return!f||0!=B&&B!=z?[b]:[];if(0==B)return[d];
if(B==z)return[e];f=h/z;return[{x:a.x+f*g,y:a.y+f*k}]}if(0!=B||l*n!=h*p)return[];k=0==g&&0==k;h=0==h&&0==l;if(k&&h)return a.x!=d.x||a.y!=d.y?[]:[a];if(k)return c(d,e,a)?[a]:[];if(h)return c(a,b,d)?[d]:[];0!=g?(a.x<b.x?(g=a,h=a.x,k=b,a=b.x):(g=b,h=b.x,k=a,a=a.x),d.x<e.x?(b=d,z=d.x,l=e,d=e.x):(b=e,z=e.x,l=d,d=d.x)):(a.y<b.y?(g=a,h=a.y,k=b,a=b.y):(g=b,h=b.y,k=a,a=a.y),d.y<e.y?(b=d,z=d.y,l=e,d=e.y):(b=e,z=e.y,l=d,d=d.y));return h<=z?a<z?[]:a==z?f?[]:[b]:a<=d?[b,k]:[b,l]:h>d?[]:h==d?f?[]:[g]:a<=d?[g,k]:
[g,l]}function e(a,b,c,d){var e=b.x-a.x,f=b.y-a.y;b=c.x-a.x;c=c.y-a.y;var g=d.x-a.x;d=d.y-a.y;a=e*c-f*b;e=e*d-f*g;return 1E-10<Math.abs(a)?(b=g*c-d*b,0<a?0<=e&&0<=b:0<=e||0<=b):0<e}var f,g,h,k,l,n={};h=b.concat();f=0;for(g=a.length;f<g;f++)Array.prototype.push.apply(h,a[f]);f=0;for(g=h.length;f<g;f++)l=h[f].x+":"+h[f].y,void 0!==n[l]&&console.log("Duplicate point",l),n[l]=f;f=function(a,b){function c(a,b){var d=h.length-1,f=a-1;0>f&&(f=d);var g=a+1;g>d&&(g=0);d=e(h[a],h[f],h[g],k[b]);if(!d)return!1;
d=k.length-1;f=b-1;0>f&&(f=d);g=b+1;g>d&&(g=0);return(d=e(k[b],k[f],k[g],h[a]))?!0:!1}function f(a,b){var c,e;for(c=0;c<h.length;c++)if(e=c+1,e%=h.length,e=d(a,b,h[c],h[e],!0),0<e.length)return!0;return!1}function g(a,c){var e,f,h,k;for(e=0;e<l.length;e++)for(f=b[l[e]],h=0;h<f.length;h++)if(k=h+1,k%=f.length,k=d(a,c,f[h],f[k],!0),0<k.length)return!0;return!1}var h=a.concat(),k,l=[],n,p,w,z,B,A=[],F,G,K,H=0;for(n=b.length;H<n;H++)l.push(H);for(var N=2*l.length;0<l.length;){N--;if(0>N){console.log("Infinite Loop! Holes left:"+
l.length+", Probably Hole outside Shape!");break}for(p=0;p<h.length;p++){w=h[p];n=-1;for(H=0;H<l.length;H++)if(z=l[H],B=w.x+":"+w.y+":"+z,void 0===A[B]){k=b[z];for(F=0;F<k.length;F++)if(z=k[F],c(p,F)&&!f(w,z)&&!g(w,z)){n=F;l.splice(H,1);z=h.slice(0,p+1);F=h.slice(p);G=k.slice(n);K=k.slice(0,n+1);h=z.concat(G).concat(K).concat(F);break}if(0<=n)break;A[B]=!0}if(0<=n)break}}return h}(b,a);var p=THREE.FontUtils.Triangulate(f,!1);f=0;for(g=p.length;f<g;f++)for(k=p[f],h=0;3>h;h++)l=k[h].x+":"+k[h].y,l=
...
g,1);r.time<this.currentTime&&r.index>p.index;)p=r,r=this.getNextKeyWith(f,g,r.index+1);l.prevKey[f]=p;l.nextKey[f]=r}k.matrixAutoUpdate=!0;k.matrixWorldNeedsUpdate=!0;var q=(this.currentTime-p.time)/(r.time-p.time),s=p[f],m=r[f];0>q&&(q=0);1<q&&(q=1);if("pos"===f)if(f=k.position,this.interpolationType===THREE.AnimationHandler.LINEAR)f.x=s[0]+(m[0]-s[0])*q,f.y=s[1]+(m[1]-s[1])*q,f.z=s[2]+(m[2]-s[2])*q;else{if(this.interpolationType===THREE.AnimationHandler.CATMULLROM||this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD)b[0]=
this.getPrevKeyWith("pos",g,p.index-1).pos,b[1]=s,b[2]=m,b[3]=this.getNextKeyWith("pos",g,r.index+1).pos,q=0.33*q+0.33,p=c(b,q),f.x=p[0],f.y=p[1],f.z=p[2],this.interpolationType===THREE.AnimationHandler.CATMULLROM_FORWARD&&(q=c(b,1.01*q),a.set(q[0],q[1],q[2]),a.sub(f),a.y=0,a.normalize(),f=Math.atan2(a.x,a.z),k.rotation.set(0,f,0))}else"rot"===f?THREE.Quaternion.slerp(s,m,k.quaternion,q):"scl"===f&&(f=k.scale,f.x=s[0]+(m[0]-s[0])*q,f.y=s[1]+(m[1]-s[1])*q,f.z=s[2]+(m[2]-s[2])*q)}}}}();
...
(a=!0):d(f)==d(h)&&(a=!0),a?(c=-f,a=e,e=Math.sqrt(k)):(c=e,a=f,e=Math.sqrt(k/2));return new THREE.Vector2(c/e,a/e)}function e(c,d){var e,f;for(C=c.length;0<=--C;){e=C;f=C-1;0>f&&(f=c.length-1);for(var g=0,h=q+2*n,g=0;g<h;g++){var k=P*g,l=P*(g+1),m=d+e+k,k=d+f+k,p=d+f+l,l=d+e+l,r=c,s=g,v=h,u=e,x=f,m=m+K,k=k+K,p=p+K,l=l+K;G.faces.push(new THREE.Face3(m,k,l,null,null,t));G.faces.push(new THREE.Face3(k,p,l,null,null,t));m=D.generateSideWallUV(G,b,r,a,m,k,p,l,s,v,u,x);G.faceVertexUvs[0].push([m[0],m[1],
m[3]]);G.faceVertexUvs[0].push([m[1],m[2],m[3]])}}}function f(a,b,c){G.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=K;d+=K;e+=K;G.faces.push(new THREE.Face3(c,d,e,null,null,v));c=f?D.generateBottomUV(G,b,a,c,d,e):D.generateTopUV(G,b,a,c,d,e);G.faceVertexUvs[0].push(c)}var h=void 0!==a.amount?a.amount:100,k=void 0!==a.bevelThickness?a.bevelThickness:6,l=void 0!==a.bevelSize?a.bevelSize:k-2,n=void 0!==a.bevelSegments?a.bevelSegments:3,p=void 0!==a.bevelEnabled?a.bevelEnabled:!0,r=
void 0!==a.curveSegments?a.curveSegments:12,q=void 0!==a.steps?a.steps:1,s=a.extrudePath,m,u=!1,v=a.material,t=a.extrudeMaterial,D=void 0!==a.UVGenerator?a.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,y,x,w,z;s&&(m=s.getSpacedPoints(q),u=!0,p=!1,y=void 0!==a.frames?a.frames:new THREE.TubeGeometry.FrenetFrames(s,q,!1),x=new THREE.Vector3,w=new THREE.Vector3,z=new THREE.Vector3);p||(l=k=n=0);var B,A,F,G=this,K=this.vertices.length,s=b.extractPoints(r),r=s.shape,H=s.holes;if(s=!THREE.Shape.Utils.isClockWise(r)){r=
...
U.push(Q);T=T.concat(Q)}for(E=0;E<n;E++){J=E/n;R=k*(1-J);I=l*Math.sin(J*Math.PI/2);C=0;for(J=L.length;C<J;C++)M=c(L[C],s[C],I),f(M.x,M.y,-R);A=0;for(F=H.length;A<F;A++)for(B=H[A],Q=U[A],C=0,J=B.length;C<J;C++)M=c(B[C],Q[C],I),f(M.x,M.y,-R)}I=l;for(C=0;C<P;C++)M=p?c(r[C],T[C],I):r[C],u?(w.copy(y.normals[0]).multiplyScalar(M.x),x.copy(y.binormals[0]).multiplyScalar(M.y),z.copy(m[0]).add(w).add(x),f(z.x,z.y,z.z)):f(M.x,M.y,0);for(J=1;J<=q;J++)for(C=0;C<P;C++)M=p?c(r[C],T[C],I):r[C],u?(w.copy(y.normals[J]).multiplyScalar(M.x),
x.copy(y.binormals[J]).multiplyScalar(M.y),z.copy(m[J]).add(w).add(x),f(z.x,z.y,z.z)):f(M.x,M.y,h/q*J);for(E=n-1;0<=E;E--){J=E/n;R=k*(1-J);I=l*Math.sin(J*Math.PI/2);C=0;for(J=L.length;C<J;C++)M=c(L[C],s[C],I),f(M.x,M.y,h+R);A=0;for(F=H.length;A<F;A++)for(B=H[A],Q=U[A],C=0,J=B.length;C<J;C++)M=c(B[C],Q[C],I),u?f(M.x,M.y+m[q-1].y,m[q-1].x+R):f(M.x,M.y,h+R)}(function(){if(p){var a;a=0*P;for(C=0;C<S;C++)O=N[C],g(O[2]+a,O[1]+a,O[0]+a,!0);a=q+2*n;a*=P;for(C=0;C<S;C++)O=N[C],g(O[0]+a,O[1]+a,O[2]+a,!1)}else{for(C=
...
F.y=A.y*w+w,n||0<F.x&&F.x<e&&0<F.y&&F.y<f)for(a.activeTexture(a.TEXTURE1),a.bindTexture(a.TEXTURE_2D,k),a.copyTexImage2D(a.TEXTURE_2D,0,a.RGB,F.x-8,F.y-8,16,16,0),a.uniform1i(G.renderType,0),a.uniform2f(G.scale,B.x,B.y),a.uniform3f(G.screenPosition,A.x,A.y,A.z),a.disable(a.BLEND),a.enable(a.DEPTH_TEST),a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0),a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,l),a.copyTexImage2D(a.TEXTURE_2D,0,a.RGBA,F.x-8,F.y-8,16,16,0),a.uniform1i(G.renderType,1),a.disable(a.DEPTH_TEST),
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(b,c){a.shadowMapEnabled&&a.shadowMapAutoUpdate&&this.update(b,c)};this.update=function(p,r){var q,s,m,u,v,t,D,y,x,w,z=[];u=0;b.clearColor(1,1,1,1);b.disable(b.BLEND);b.enable(b.CULL_FACE);b.frontFace(b.CCW);a.shadowMapCullFace===
...
y[1].set(1,-1,D);y[2].set(-1,1,D);y[3].set(1,1,D);y[4].set(-1,-1,x);y[5].set(1,-1,x);y[6].set(-1,1,x);y[7].set(1,1,x);t.originalCamera=r;y=new THREE.Gyroscope;y.position.copy(m.shadowCascadeOffset);y.add(t);y.add(t.target);r.add(y);m.shadowCascadeArray[v]=t;console.log("Created virtualLight",t)}w=m;D=v;x=w.shadowCascadeArray[D];x.position.copy(w.position);x.target.position.copy(w.target.position);x.lookAt(x.target.position);x.shadowCameraVisible=w.shadowCameraVisible;x.shadowDarkness=w.shadowDarkness;
x.shadowBias=w.shadowCascadeBias[D];y=w.shadowCascadeNearZ[D];w=w.shadowCascadeFarZ[D];x=x.pointsFrustum;x[0].z=y;x[1].z=y;x[2].z=y;x[3].z=y;x[4].z=w;x[5].z=w;x[6].z=w;x[7].z=w;z[u]=t;u++}else z[u]=m,u++;q=0;for(s=z.length;q<s;q++){m=z[q];m.shadowMap||(v=THREE.LinearFilter,a.shadowMapType===THREE.PCFSoftShadowMap&&(v=THREE.NearestFilter),m.shadowMap=new THREE.WebGLRenderTarget(m.shadowMapWidth,m.shadowMapHeight,{minFilter:v,magFilter:v,format:THREE.RGBAFormat}),m.shadowMapSize=new THREE.Vector2(m.shadowMapWidth,
