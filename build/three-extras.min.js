...
void 0,q=b[g[k]].x,s=b[g[k]].y,n=b[g[l]].x,u=b[g[l]].y,v=b[g[m]].x,t=b[g[m]].y;if(1E-10>(n-q)*(t-s)-(u-s)*(v-q))r=!1;else{var x=void 0,w=void 0,z=void 0,B=void 0,A=void 0,G=void 0,F=void 0,K=void 0,H=void 0,N=void 0,H=K=F=y=D=void 0,x=v-n,w=t-u,z=q-v,B=s-t,A=n-q,G=u-s;for(r=0;r<e;r++)if(D=b[g[r]].x,y=b[g[r]].y,!(D===q&&y===s||D===n&&y===u||D===v&&y===t)&&(F=D-q,K=y-s,H=D-n,N=y-u,D-=v,y-=t,H=x*N-w*H,F=A*K-G*F,K=z*y-B*D,-1E-10<=H&&-1E-10<=K&&-1E-10<=F)){r=!1;break a}r=!0}}if(r){f.push([b[g[k]],b[g[l]],
...
h=[];var m=[],p=[],r=0,q;m[r]=void 0;p[r]=[];var s,n;s=0;for(n=e.length;s<n;s++)g=e[s],q=g.getPoints(),f=THREE.Shape.Utils.isClockWise(q),(f=b?!f:f)?(!l&&m[r]&&r++,m[r]={s:new THREE.Shape,p:q},m[r].s.actions=g.actions,m[r].s.curves=g.curves,l&&r++,p[r]=[]):p[r].push({h:g,p:q[0]});if(!m[0])return c(e);if(1<m.length){s=!1;n=[];g=0;for(e=m.length;g<e;g++)h[g]=[];g=0;for(e=m.length;g<e;g++)for(f=p[g],l=0;l<f.length;l++){r=f[l];q=!0;for(var u=0;u<m.length;u++)d(r.p,m[u].p)&&(g!=u&&n.push({froms:g,tos:u,
hole:l}),q?(q=!1,h[u].push(r)):s=!0);q&&h[g].push(r)}0<n.length&&(s||(p=h))}s=0;for(n=m.length;s<n;s++)for(h=m[s].s,k.push(h),g=p[s],e=0,f=g.length;e<f;e++)h.holes.push(g[e].h);return k};THREE.Shape=function(){THREE.Path.apply(this,arguments);this.holes=[]};THREE.Shape.prototype=Object.create(THREE.Path.prototype);THREE.Shape.prototype.extrude=function(b){return new THREE.ExtrudeGeometry(this,b)};THREE.Shape.prototype.makeGeometry=function(b){return new THREE.ShapeGeometry(this,b)};THREE.Shape.prototype.getPointsHoles=function(b){var a,c=this.holes.length,d=[];for(a=0;a<c;a++)d[a]=this.holes[a].getTransformedPoints(b,this.bends);return d};
...
d=k.length-1;f=b-1;0>f&&(f=d);g=b+1;g>d&&(g=0);return(d=e(k[b],k[f],k[g],h[a]))?!0:!1}function f(a,b){var c,e;for(c=0;c<h.length;c++)if(e=c+1,e%=h.length,e=d(a,b,h[c],h[e],!0),0<e.length)return!0;return!1}function g(a,c){var e,f,h,k;for(e=0;e<l.length;e++)for(f=b[l[e]],h=0;h<f.length;h++)if(k=h+1,k%=f.length,k=d(a,c,f[h],f[k],!0),0<k.length)return!0;return!1}var h=a.concat(),k,l=[],m,p,w,z,B,A=[],G,F,K,H=0;for(m=b.length;H<m;H++)l.push(H);G=0;for(var N=2*l.length;0<l.length;){N--;if(0>N){console.log("Infinite Loop! Holes left:"+
l.length+", Probably Hole outside Shape!");break}for(p=G;p<h.length;p++){w=h[p];m=-1;for(H=0;H<l.length;H++)if(z=l[H],B=w.x+":"+w.y+":"+z,void 0===A[B]){k=b[z];for(F=0;F<k.length;F++)if(z=k[F],c(p,F)&&!f(w,z)&&!g(w,z)){m=F;l.splice(H,1);G=h.slice(0,p+1);z=h.slice(p);F=k.slice(m);K=k.slice(0,m+1);h=G.concat(F).concat(K).concat(z);G=p;break}if(0<=m)break;A[B]=!0}if(0<=m)break}}return h}(b,a);var p=THREE.FontUtils.Triangulate(f,!1);f=0;for(g=p.length;f<g;f++)for(k=p[f],h=0;3>h;h++)l=k[h].x+":"+k[h].y,
...
(a=!0):d(f)==d(h)&&(a=!0),a?(c=-f,a=e,e=Math.sqrt(k)):(c=e,a=f,e=Math.sqrt(k/2));return new THREE.Vector2(c/e,a/e)}function e(c,d){var e,f;for(C=c.length;0<=--C;){e=C;f=C-1;0>f&&(f=c.length-1);for(var g=0,h=q+2*m,g=0;g<h;g++){var k=P*g,l=P*(g+1),n=d+e+k,k=d+f+k,p=d+f+l,l=d+e+l,r=c,s=g,u=h,v=e,x=f,n=n+K,k=k+K,p=p+K,l=l+K;F.faces.push(new THREE.Face3(n,k,l,null,null,t));F.faces.push(new THREE.Face3(k,p,l,null,null,t));n=D.generateSideWallUV(F,b,r,a,n,k,p,l,s,u,v,x);F.faceVertexUvs[0].push([n[0],n[1],
n[3]]);F.faceVertexUvs[0].push([n[1],n[2],n[3]])}}}function f(a,b,c){F.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=K;d+=K;e+=K;F.faces.push(new THREE.Face3(c,d,e,null,null,v));c=f?D.generateBottomUV(F,b,a,c,d,e):D.generateTopUV(F,b,a,c,d,e);F.faceVertexUvs[0].push(c)}var h=void 0!==a.amount?a.amount:100,k=void 0!==a.bevelThickness?a.bevelThickness:6,l=void 0!==a.bevelSize?a.bevelSize:k-2,m=void 0!==a.bevelSegments?a.bevelSegments:3,p=void 0!==a.bevelEnabled?a.bevelEnabled:!0,r=
void 0!==a.curveSegments?a.curveSegments:12,q=void 0!==a.steps?a.steps:1,s=a.extrudePath,n,u=!1,v=a.material,t=a.extrudeMaterial,D=void 0!==a.UVGenerator?a.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,y,x,w,z;s&&(n=s.getSpacedPoints(q),u=!0,p=!1,y=void 0!==a.frames?a.frames:new THREE.TubeGeometry.FrenetFrames(s,q,!1),x=new THREE.Vector3,w=new THREE.Vector3,z=new THREE.Vector3);p||(l=k=m=0);var B,A,G,F=this,K=this.vertices.length,s=b.extractPoints(r),r=s.shape,H=s.holes;if(s=!THREE.Shape.Utils.isClockWise(r)){r=
r.reverse();A=0;for(G=H.length;A<G;A++)B=H[A],THREE.Shape.Utils.isClockWise(B)&&(H[A]=B.reverse());s=!1}var N=THREE.Shape.Utils.triangulateShape(r,H),L=r;A=0;for(G=H.length;A<G;A++)B=H[A],r=r.concat(B);var E,I,J,R,M,P=r.length,O,S=N.length,s=[],C=0;J=L.length;E=J-1;for(I=C+1;C<J;C++,E++,I++)E===J&&(E=0),I===J&&(I=0),s[C]=d(L[C],L[E],L[I]);var U=[],Q,T=s.concat();A=0;for(G=H.length;A<G;A++){B=H[A];Q=[];C=0;J=B.length;E=J-1;for(I=C+1;C<J;C++,E++,I++)E===J&&(E=0),I===J&&(I=0),Q[C]=d(B[C],B[E],B[I]);
U.push(Q);T=T.concat(Q)}for(E=0;E<m;E++){J=E/m;R=k*(1-J);I=l*Math.sin(J*Math.PI/2);C=0;for(J=L.length;C<J;C++)M=c(L[C],s[C],I),f(M.x,M.y,-R);A=0;for(G=H.length;A<G;A++)for(B=H[A],Q=U[A],C=0,J=B.length;C<J;C++)M=c(B[C],Q[C],I),f(M.x,M.y,-R)}I=l;for(C=0;C<P;C++)M=p?c(r[C],T[C],I):r[C],u?(w.copy(y.normals[0]).multiplyScalar(M.x),x.copy(y.binormals[0]).multiplyScalar(M.y),z.copy(n[0]).add(w).add(x),f(z.x,z.y,z.z)):f(M.x,M.y,0);for(J=1;J<=q;J++)for(C=0;C<P;C++)M=p?c(r[C],T[C],I):r[C],u?(w.copy(y.normals[J]).multiplyScalar(M.x),
x.copy(y.binormals[J]).multiplyScalar(M.y),z.copy(n[J]).add(w).add(x),f(z.x,z.y,z.z)):f(M.x,M.y,h/q*J);for(E=m-1;0<=E;E--){J=E/m;R=k*(1-J);I=l*Math.sin(J*Math.PI/2);C=0;for(J=L.length;C<J;C++)M=c(L[C],s[C],I),f(M.x,M.y,h+R);A=0;for(G=H.length;A<G;A++)for(B=H[A],Q=U[A],C=0,J=B.length;C<J;C++)M=c(B[C],Q[C],I),u?f(M.x,M.y+n[q-1].y,n[q-1].x+R):f(M.x,M.y,h+R)}(function(){if(p){var a;a=0*P;for(C=0;C<S;C++)O=N[C],g(O[2]+a,O[1]+a,O[0]+a,!0);a=q+2*m;a*=P;for(C=0;C<S;C++)O=N[C],g(O[0]+a,O[1]+a,O[2]+a,!1)}else{for(C=
0;C<S;C++)O=N[C],g(O[2],O[1],O[0],!0);for(C=0;C<S;C++)O=N[C],g(O[0]+P*q,O[1]+P*q,O[2]+P*q,!1)}})();(function(){var a=0;e(L,a);a+=L.length;A=0;for(G=H.length;A<G;A++)B=H[A],e(B,a),a+=B.length})()};
...
1)/d),r=new THREE.Vector2((a+1)/c,1-(b+1)/d),q=new THREE.Vector2((a+1)/c,1-b/d),p=new THREE.Face3(p,e,h);p.normal.copy(m);p.vertexNormals.push(m.clone(),m.clone(),m.clone());this.faces.push(p);this.faceVertexUvs[0].push([k,l,q]);p=new THREE.Face3(e,f,h);p.normal.copy(m);p.vertexNormals.push(m.clone(),m.clone(),m.clone());this.faces.push(p);this.faceVertexUvs[0].push([l.clone(),r,q.clone()])}};THREE.PlaneGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.RingGeometry=function(b,a,c,d,e,f){THREE.Geometry.call(this);b=b||0;a=a||50;e=void 0!==e?e:0;f=void 0!==f?f:2*Math.PI;c=void 0!==c?Math.max(3,c):8;d=void 0!==d?Math.max(3,d):8;var g,h=[],k=b,l=(a-b)/d;for(b=0;b<=d;b++){for(g=0;g<=c;g++){var m=new THREE.Vector3,p=e+g/c*f;m.x=k*Math.cos(p);m.y=k*Math.sin(p);this.vertices.push(m);h.push(new THREE.Vector2((m.x/a+1)/2,(m.y/a+1)/2))}k+=l}a=new THREE.Vector3(0,0,1);for(b=0;b<d;b++)for(e=b*c,g=0;g<=c;g++)p=g+e,f=p+b,l=p+c+b,m=p+c+1+b,this.faces.push(new THREE.Face3(f,
...
q.opacity=a.getUniformLocation(p,"opacity");q.color=a.getUniformLocation(p,"color");q.scale=a.getUniformLocation(p,"scale");q.rotation=a.getUniformLocation(p,"rotation");q.screenPosition=a.getUniformLocation(p,"screenPosition")};this.render=function(b,d,e,f){b=b.__webglFlares;var t=b.length;if(t){var D=new THREE.Vector3,y=f/e,x=0.5*e,w=0.5*f,z=16/f,B=new THREE.Vector2(z*y,z),A=new THREE.Vector3(1,1,0),G=new THREE.Vector2(1,1),F=q,z=r;a.useProgram(p);a.enableVertexAttribArray(r.vertex);a.enableVertexAttribArray(r.uv);
a.uniform1i(F.occlusionMap,0);a.uniform1i(F.map,1);a.bindBuffer(a.ARRAY_BUFFER,g);a.vertexAttribPointer(z.vertex,2,a.FLOAT,!1,16,0);a.vertexAttribPointer(z.uv,2,a.FLOAT,!1,16,8);a.bindBuffer(a.ELEMENT_ARRAY_BUFFER,h);a.disable(a.CULL_FACE);a.depthMask(!1);var K,H,N,L,E;for(K=0;K<t;K++)if(z=16/f,B.set(z*y,z),L=b[K],D.set(L.matrixWorld.elements[12],L.matrixWorld.elements[13],L.matrixWorld.elements[14]),D.applyMatrix4(d.matrixWorldInverse),D.applyProjection(d.projectionMatrix),A.copy(D),G.x=A.x*x+x,
G.y=A.y*w+w,m||0<G.x&&G.x<e&&0<G.y&&G.y<f)for(a.activeTexture(a.TEXTURE1),a.bindTexture(a.TEXTURE_2D,k),a.copyTexImage2D(a.TEXTURE_2D,0,a.RGB,G.x-8,G.y-8,16,16,0),a.uniform1i(F.renderType,0),a.uniform2f(F.scale,B.x,B.y),a.uniform3f(F.screenPosition,A.x,A.y,A.z),a.disable(a.BLEND),a.enable(a.DEPTH_TEST),a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0),a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,l),a.copyTexImage2D(a.TEXTURE_2D,0,a.RGBA,G.x-8,G.y-8,16,16,0),a.uniform1i(F.renderType,1),a.disable(a.DEPTH_TEST),
a.activeTexture(a.TEXTURE1),a.bindTexture(a.TEXTURE_2D,k),a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0),L.positionScreen.copy(A),L.customUpdateCallback?L.customUpdateCallback(L):L.updateLensFlares(),a.uniform1i(F.renderType,2),a.enable(a.BLEND),H=0,N=L.lensFlares.length;H<N;H++)E=L.lensFlares[H],0.001<E.opacity&&0.001<E.scale&&(A.x=E.x,A.y=E.y,A.z=E.z,z=E.size*E.scale/f,B.x=z*y,B.y=z,a.uniform3f(F.screenPosition,A.x,A.y,A.z),a.uniform2f(F.scale,B.x,B.y),a.uniform1f(F.rotation,E.rotation),a.uniform1f(F.opacity,
E.opacity),a.uniform3f(F.color,E.color.r,E.color.g,E.color.b),c.setBlending(E.blending,E.blendEquation,E.blendSrc,E.blendDst),c.setTexture(E.texture,1),a.drawElements(a.TRIANGLES,6,a.UNSIGNED_SHORT,0));a.enable(a.CULL_FACE);a.enable(a.DEPTH_TEST);a.depthMask(!0)}}};THREE.ShadowMapPlugin=function(){var b,a,c,d,e,f,g=new THREE.Frustum,h=new THREE.Matrix4,k=new THREE.Vector3,l=new THREE.Vector3,m=new THREE.Vector3;this.init=function(g){b=g.context;a=g;g=THREE.ShaderLib.depthRGBA;var h=THREE.UniformsUtils.clone(g.uniforms);c=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h});d=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,
...
var F=t.createShader(t.VERTEX_SHADER),K=t.createShader(t.FRAGMENT_SHADER);t.shaderSource(F,["precision "+D.getPrecision()+" float;","uniform mat4 modelViewMatrix;\nuniform mat4 projectionMatrix;\nuniform float rotation;\nuniform vec2 scale;\nuniform vec2 uvOffset;\nuniform vec2 uvScale;\nattribute vec2 position;\nattribute vec2 uv;\nvarying vec2 vUV;\nvoid main() {\nvUV = uvOffset + uv * uvScale;\nvec2 alignedPosition = position * scale;\nvec2 rotatedPosition;\nrotatedPosition.x = cos( rotation ) * alignedPosition.x - sin( rotation ) * alignedPosition.y;\nrotatedPosition.y = sin( rotation ) * alignedPosition.x + cos( rotation ) * alignedPosition.y;\nvec4 finalPosition;\nfinalPosition = modelViewMatrix * vec4( 0.0, 0.0, 0.0, 1.0 );\nfinalPosition.xy += rotatedPosition;\nfinalPosition = projectionMatrix * finalPosition;\ngl_Position = finalPosition;\n}"].join("\n"));
