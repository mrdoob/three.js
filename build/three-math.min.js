...
a.x;b[13]=a.y;b[14]=a.z;return this},getInverse:function(a,b){var c=this.elements,d=a.elements,e=d[0],g=d[4],f=d[8],h=d[12],i=d[1],j=d[5],k=d[9],l=d[13],m=d[2],p=d[6],q=d[10],r=d[14],n=d[3],s=d[7],t=d[11],u=d[15];c[0]=k*r*s-l*q*s+l*p*t-j*r*t-k*p*u+j*q*u;c[4]=h*q*s-f*r*s-h*p*t+g*r*t+f*p*u-g*q*u;c[8]=f*l*s-h*k*s+h*j*t-g*l*t-f*j*u+g*k*u;c[12]=h*k*p-f*l*p-h*j*q+g*l*q+f*j*r-g*k*r;c[1]=l*q*n-k*r*n-l*m*t+i*r*t+k*m*u-i*q*u;c[5]=f*r*n-h*q*n+h*m*t-e*r*t-f*m*u+e*q*u;c[9]=h*k*n-f*l*n-h*i*t+e*l*t+f*i*u-e*k*u;
c[13]=f*l*m-h*k*m+h*i*q-e*l*q-f*i*r+e*k*r;c[2]=j*r*n-l*p*n+l*m*s-i*r*s-j*m*u+i*p*u;c[6]=h*p*n-g*r*n-h*m*s+e*r*s+g*m*u-e*p*u;c[10]=g*l*n-h*j*n+h*i*s-e*l*s-g*i*u+e*j*u;c[14]=h*j*m-g*l*m-h*i*p+e*l*p+g*i*r-e*j*r;c[3]=k*p*n-j*q*n-k*m*s+i*q*s+j*m*t-i*p*t;c[7]=g*q*n-f*p*n+f*m*s-e*q*s-g*m*t+e*p*t;c[11]=f*j*n-g*k*n-f*i*s+e*k*s+g*i*t-e*j*t;c[15]=g*k*m-f*j*m+f*i*p-e*k*p-g*i*q+e*j*q;c=d[0]*c[0]+d[1]*c[4]+d[2]*c[8]+d[3]*c[12];if(0==c){if(b)throw Error("Matrix4.getInverse(): can't invert matrix, determinant is 0");
