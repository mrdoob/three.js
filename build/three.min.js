...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),m=Math.sin(b),p=1-j,n=d*e*p,s=d*f*p,p=e*f*p,d=d*m,r=e*m,m=f*m,f=g+(1-g)*j,g=n+m,e=s-r,n=n-m,h=h+(1-h)*j,m=p+d,s=s+r,p=p-d,i=i+(1-i)*j,j=c[0],d=c[1],r=c[2],l=c[3],t=c[4],u=c[5],E=c[6],y=c[7],q=c[8],G=c[9],A=c[10],z=c[11];c[0]=f*j+g*t+e*q;c[1]=f*d+g*u+e*G;c[2]=f*r+g*E+e*A;c[3]=f*l+g*y+e*z;c[4]=n*j+h*t+m*q;c[5]=n*d+h*u+m*G;c[6]=n*r+h*E+m*A;c[7]=n*l+h*y+m*z;c[8]=s*j+p*t+i*q;c[9]=s*d+p*u+i*G;c[10]=s*r+p*E+i*A;c[11]=s*l+p*y+i*z;
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,v){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];m=g[e];p=g[f];n=g[v];s=i.x-h.x;r=j.x-h.x;l=i.y-h.y;t=j.y-h.y;u=i.z-h.z;E=j.z-h.z;y=p.x-m.x;q=n.x-m.x;G=p.y-m.y;A=n.y-m.y;z=1/(y*A-q*G);F.set((A*s-G*r)*z,(A*l-G*t)*z,(A*u-G*E)*z);M.set((y*r-q*s)*z,(y*t-q*l)*z,(y*E-q*u)*z);I[b].addSelf(F);I[c].addSelf(F);I[d].addSelf(F);D[b].addSelf(M);D[c].addSelf(M);D[d].addSelf(M)}var b,c,d,e,f,g,h,i,j,m,p,n,s,r,l,t,u,E,
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,j,m,p,n,s,r,l,t,u,E,y,q;function G(a){return a%4?4-a%4:0}function A(a,b){return(new Uint8Array(a,b,1))[0]}function z(a,b){return(new Uint32Array(a,b,1))[0]}function v(b,c){var d,e,f,g,h,i,j,m=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=m[3*d],f=m[3*d+1],g=m[3*d+2],h=K[2*e],e=K[2*e+1],i=K[2*f],j=K[2*f+1],f=K[2*g],g=K[2*g+1],J.faceVertexUvs[0].push([new THREE.Vector2(h,e),new THREE.Vector2(i,j),new THREE.Vector2(f,
...
g,h,[new THREE.Vector3(L[3*j],L[3*j+1],L[3*j+2]),new THREE.Vector3(s,l,m),new THREE.Vector3(r,q,n)],null,i))}}function B(b,c,d,e){for(var f,g,h,i,j,m,n,p,s,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),l=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];m=d[4*e];n=d[4*e+1];p=d[4*e+2];s=d[4*e+3];j=l[e];var r=L[3*n],q=L[3*n+1];n=L[3*n+2];var t=L[3*p],u=L[3*p+1];p=L[3*p+2];var v=L[3*s],y=L[3*s+1];s=L[3*s+2];J.faces.push(new THREE.Face4(f,g,h,i,[new THREE.Vector3(L[3*
m],L[3*m+1],L[3*m+2]),new THREE.Vector3(r,q,n),new THREE.Vector3(t,u,p),new THREE.Vector3(v,y,s)],null,j))}}var J=this,C=0,L=[],K=[],U,O,$;THREE.Geometry.call(this);q=a;O=C;E=new Uint8Array(q,O,12);r="";for(u=0;12>u;u++)r+=String.fromCharCode(E[O+u]);b=A(q,O+12);A(q,O+13);A(q,O+14);A(q,O+15);c=A(q,O+16);d=A(q,O+17);e=A(q,O+18);j=A(q,O+19);m=z(q,O+20);p=z(q,O+20+4);n=z(q,O+20+8);s=z(q,O+20+12);r=z(q,O+20+16);l=z(q,O+20+20);t=z(q,O+20+24);u=z(q,O+20+28);E=z(q,O+20+32);y=z(q,O+20+36);q=z(q,O+20+40);
C+=b;O=3*c+j;$=4*c+j;U=s*O;b=r*(O+3*d);c=l*(O+3*e);j=t*(O+3*d+3*e);O=u*$;d=E*($+4*d);e=y*($+4*e);$=C;var C=new Float32Array(a,C,3*m),wa,N,na,la;for(wa=0;wa<m;wa++)N=C[3*wa],na=C[3*wa+1],la=C[3*wa+2],J.vertices.push(new THREE.Vector3(N,na,la));m=C=$+3*m*Float32Array.BYTES_PER_ELEMENT;if(p){C=new Int8Array(a,C,3*p);for($=0;$<p;$++)wa=C[3*$],N=C[3*$+1],na=C[3*$+2],L.push(wa/127,N/127,na/127)}C=m+3*p*Int8Array.BYTES_PER_ELEMENT;p=C+=G(3*p);if(n){m=new Float32Array(a,C,2*n);for(C=0;C<n;C++)$=m[2*C],wa=
m[2*C+1],K.push($,wa)}n=C=p+2*n*Float32Array.BYTES_PER_ELEMENT;U=n+U+G(2*s);p=U+b+G(2*r);b=p+c+G(2*l);c=b+j+G(2*t);O=c+O+G(2*u);j=O+d+G(2*E);d=j+e+G(2*y);l&&(e=p+3*l*Uint32Array.BYTES_PER_ELEMENT,D(l,p,e+3*l*Uint32Array.BYTES_PER_ELEMENT),v(l,e));t&&(l=b+3*t*Uint32Array.BYTES_PER_ELEMENT,e=l+3*t*Uint32Array.BYTES_PER_ELEMENT,M(t,b,l,e+3*t*Uint32Array.BYTES_PER_ELEMENT),v(t,e));y&&(t=j+4*y*Uint32Array.BYTES_PER_ELEMENT,F(y,j,t+4*y*Uint32Array.BYTES_PER_ELEMENT),I(y,t));q&&(y=d+4*q*Uint32Array.BYTES_PER_ELEMENT,
t=y+4*q*Uint32Array.BYTES_PER_ELEMENT,B(q,d,y,t+4*q*Uint32Array.BYTES_PER_ELEMENT),I(q,t));s&&D(s,n,n+3*s*Uint32Array.BYTES_PER_ELEMENT);r&&(s=U+3*r*Uint32Array.BYTES_PER_ELEMENT,M(r,U,s,s+3*r*Uint32Array.BYTES_PER_ELEMENT));u&&F(u,c,c+4*u*Uint32Array.BYTES_PER_ELEMENT);E&&(r=O+4*E*Uint32Array.BYTES_PER_ELEMENT,B(E,O,r,r+4*E*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals()};e.prototype=Object.create(THREE.Geometry.prototype);e=new e(c);c=this.initMaterials(d,c);this.needsTangents(c)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,j,m,p,n,s,r,l,t,u,E,y,q=a.faces;r=a.vertices;var G=a.normals,A=a.colors,z=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&z++;for(f=0;f<z;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(j=r.length;i<j;)m=new THREE.Vector3,m.x=r[i++]*e,m.y=r[i++]*e,m.z=r[i++]*e,d.vertices.push(m);i=0;for(j=q.length;i<j;){r=q[i++];m=r&1;h=r&2;f=r&4;g=r&8;n=r&16;p=r&32;l=r&64;r&=128;m?(t=new THREE.Face4,
t.a=q[i++],t.b=q[i++],t.c=q[i++],t.d=q[i++],m=4):(t=new THREE.Face3,t.a=q[i++],t.b=q[i++],t.c=q[i++],m=3);h&&(h=q[i++],t.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<z;f++)u=a.uvs[f],s=q[i++],y=u[2*s],s=u[2*s+1],d.faceUvs[f][h]=new THREE.Vector2(y,s);if(g)for(f=0;f<z;f++){u=a.uvs[f];E=[];for(g=0;g<m;g++)s=q[i++],y=u[2*s],s=u[2*s+1],E[g]=new THREE.Vector2(y,s);d.faceVertexUvs[f][h]=E}n&&(n=3*q[i++],g=new THREE.Vector3,g.x=G[n++],g.y=G[n++],g.z=G[n],t.normal=g);if(p)for(f=0;f<m;f++)n=3*q[i++],g=
new THREE.Vector3,g.x=G[n++],g.y=G[n++],g.z=G[n],t.vertexNormals.push(g);l&&(p=q[i++],p=new THREE.Color(A[p]),t.color=p);if(r)for(f=0;f<m;f++)p=q[i++],p=new THREE.Color(A[p]),t.vertexColors.push(p);d.faces.push(t)}if(a.skinWeights){i=0;for(j=a.skinWeights.length;i<j;i+=2)q=a.skinWeights[i],G=a.skinWeights[i+1],d.skinWeights.push(new THREE.Vector4(q,G,0,0))}if(a.skinIndices){i=0;for(j=a.skinIndices.length;i<j;i+=2)q=a.skinIndices[i],G=a.skinIndices[i+1],d.skinIndices.push(new THREE.Vector4(q,G,0,0))}d.bones=
a.bones;d.animation=a.animation;if(void 0!==a.morphTargets){i=0;for(j=a.morphTargets.length;i<j;i++){d.morphTargets[i]={};d.morphTargets[i].name=a.morphTargets[i].name;d.morphTargets[i].vertices=[];A=d.morphTargets[i].vertices;z=a.morphTargets[i].vertices;q=0;for(G=z.length;q<G;q+=3)r=new THREE.Vector3,r.x=z[q]*e,r.y=z[q+1]*e,r.z=z[q+2]*e,A.push(r)}}if(void 0!==a.morphColors){i=0;for(j=a.morphColors.length;i<j;i++){d.morphColors[i]={};d.morphColors[i].name=a.morphColors[i].name;d.morphColors[i].colors=
...
m.hierarchyHandlerMap[l.type].loaderObject;c.addEventListener?(c.addEventListener("load",h(p,a,s,l)),c.load(d(l.url,D.urlBaseType))):c.options?c.load(d(l.url,D.urlBaseType),h(p,a,s,l)):c.load(d(l.url,D.urlBaseType),h(p,a,s,l),e)}else if(void 0!==l.geometry){if(n=v.geometries[l.geometry]){q=!1;s=v.materials[l.material];q=s instanceof THREE.ShaderMaterial;e=l.position;g=l.rotation;i=l.scale;c=l.matrix;j=0;l.material||(s=new THREE.MeshFaceMaterial(v.face_materials[l.geometry]));s instanceof THREE.MeshFaceMaterial&&
0===s.materials.length&&(s=new THREE.MeshFaceMaterial(v.face_materials[l.geometry]));if(s instanceof THREE.MeshFaceMaterial)for(var z=0;z<s.materials.length;z++)q=q||s.materials[z]instanceof THREE.ShaderMaterial;q&&n.computeTangents();l.skin?q=new THREE.SkinnedMesh(n,s):l.morph?(q=new THREE.MorphAnimMesh(n,s),void 0!==l.duration&&(q.duration=l.duration),void 0!==l.time&&(q.time=l.time),void 0!==l.mirroredLoop&&(q.mirroredLoop=l.mirroredLoop),s.morphNormals&&n.computeMorphNormals()):q=new THREE.Mesh(n,
...
v.scene.add(c.object.target));c.object.target.properties.targetInverse=c.object}b(v)}}var m=this,p=THREE.Loader.prototype.extractUrlBase(c),n,s,r,l,t,u,E,y,q,G,A,z,v,I=[],D=a,F;for(F in this.geometryHandlerMap)a=this.geometryHandlerMap[F].loaderClass,this.geometryHandlerMap[F].loaderObject=new a;for(F in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[F].loaderClass,this.hierarchyHandlerMap[F].loaderObject=new a;G=q=0;v={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},
...
document.createElement("canvas"),p,n,s,r,l=m.getContext("2d"),t=new THREE.Color(0),u=0,E=1,y=0,q=null,G=null,A=null,z=null,v=null,I,D,F,M,B=new THREE.RenderableVertex,J=new THREE.RenderableVertex,C,L,K,U,O,$,wa,N,na,la,Ma,Q,R=new THREE.Color,ba=new THREE.Color,da=new THREE.Color,P=new THREE.Color,ja=new THREE.Color,Y=new THREE.Color,ga=new THREE.Color,Ca={},Va={},ta,Da,ea,Ha,gb,vb,qb,ub,Kb,Lb,tb=new THREE.Rectangle,Sa=new THREE.Rectangle,ma=new THREE.Rectangle,xb=!1,Na=new THREE.Color,kb=new THREE.Color,
...
(hb.r+=pa.r,hb.g+=pa.g,hb.b+=pa.b)}}nc=0;for(Uc=h.length;nc<Uc;nc++)if(oa=h[nc],aa=oa.material,!(void 0===aa||!1===aa.visible)){ma.empty();if(oa instanceof THREE.RenderableParticle){I=oa;I.x*=s;I.y*=r;var pa=I,db=oa;b(aa.opacity);c(aa.blending);var Gb=void 0,Hb=void 0,yb=void 0,zb=void 0,Ac=oa=void 0,md=void 0;aa instanceof THREE.ParticleBasicMaterial?null===aa.map?(yb=db.object.scale.x,zb=db.object.scale.y,yb*=db.scale.x*s,zb*=db.scale.y*r,ma.set(pa.x-yb,pa.y-zb,pa.x+yb,pa.y+zb),!1!==tb.intersects(ma)&&
(e(aa.color.getStyle()),l.save(),l.translate(pa.x,pa.y),l.rotate(-db.rotation),l.scale(yb,zb),l.fillRect(-1,-1,2,2),l.restore())):(oa=aa.map.image,Ac=oa.width>>1,md=oa.height>>1,yb=db.scale.x*s,zb=db.scale.y*r,Gb=yb*Ac,Hb=zb*md,ma.set(pa.x-Gb,pa.y-Hb,pa.x+Gb,pa.y+Hb),!1!==tb.intersects(ma)&&(l.save(),l.translate(pa.x,pa.y),l.rotate(-db.rotation),l.scale(yb,-zb),l.translate(-Ac,-md),l.drawImage(oa,0,0),l.restore())):aa instanceof THREE.ParticleCanvasMaterial&&(Gb=db.scale.x*s,Hb=db.scale.y*r,ma.set(pa.x-
Gb,pa.y-Hb,pa.x+Gb,pa.y+Hb),!1!==tb.intersects(ma)&&(d(aa.color.getStyle()),e(aa.color.getStyle()),l.save(),l.translate(pa.x,pa.y),l.rotate(-db.rotation),l.scale(Gb,Hb),aa.program(l),l.restore()))}else oa instanceof THREE.RenderableLine?(I=oa.v1,D=oa.v2,I.positionScreen.x*=s,I.positionScreen.y*=r,D.positionScreen.x*=s,D.positionScreen.y*=r,ma.addPoint(I.positionScreen.x,I.positionScreen.y),ma.addPoint(D.positionScreen.x,D.positionScreen.y),!0===tb.intersects(ma)&&(pa=I,db=D,b(aa.opacity),c(aa.blending),
l.beginPath(),l.moveTo(pa.positionScreen.x,pa.positionScreen.y),l.lineTo(db.positionScreen.x,db.positionScreen.y),aa instanceof THREE.LineBasicMaterial&&(pa=aa.linewidth,A!==pa&&(A=l.lineWidth=pa),pa=aa.linecap,z!==pa&&(z=l.lineCap=pa),pa=aa.linejoin,v!==pa&&(v=l.lineJoin=pa),d(aa.color.getStyle()),l.stroke(),ma.inflate(2*aa.linewidth)))):oa instanceof THREE.RenderableFace3?(I=oa.v1,D=oa.v2,F=oa.v3,I.positionScreen.x*=s,I.positionScreen.y*=r,D.positionScreen.x*=s,D.positionScreen.y*=r,F.positionScreen.x*=
s,F.positionScreen.y*=r,!0===aa.overdraw&&(lb(I.positionScreen,D.positionScreen),lb(D.positionScreen,F.positionScreen),lb(F.positionScreen,I.positionScreen)),ma.add3Points(I.positionScreen.x,I.positionScreen.y,D.positionScreen.x,D.positionScreen.y,F.positionScreen.x,F.positionScreen.y),!0===tb.intersects(ma)&&n(I,D,F,0,1,2,oa,aa,a)):oa instanceof THREE.RenderableFace4&&(I=oa.v1,D=oa.v2,F=oa.v3,M=oa.v4,I.positionScreen.x*=s,I.positionScreen.y*=r,D.positionScreen.x*=s,D.positionScreen.y*=r,F.positionScreen.x*=
s,F.positionScreen.y*=r,M.positionScreen.x*=s,M.positionScreen.y*=r,B.positionScreen.copy(D.positionScreen),J.positionScreen.copy(M.positionScreen),!0===aa.overdraw&&(lb(I.positionScreen,D.positionScreen),lb(D.positionScreen,M.positionScreen),lb(M.positionScreen,I.positionScreen),lb(F.positionScreen,B.positionScreen),lb(F.positionScreen,J.positionScreen)),ma.addPoint(I.positionScreen.x,I.positionScreen.y),ma.addPoint(D.positionScreen.x,D.positionScreen.y),ma.addPoint(F.positionScreen.x,F.positionScreen.y),
...
M=q.hemi.groundColors,N=q.hemi.positions,ba=0,Y=0,O=0,U=0,$=0,na=0,la=0,Ca=0,S=s=0,c=S=S=0,f=b.length;c<f;c++)j=b[c],j.onlyShadow||(p=j.color,r=j.intensity,s=j.distance,j instanceof THREE.AmbientLight?j.visible&&(Q.gammaInput?(m+=p.r*p.r,n+=p.g*p.g,l+=p.b*p.b):(m+=p.r,n+=p.g,l+=p.b)):j instanceof THREE.DirectionalLight?($+=1,j.visible&&(s=3*ba,Q.gammaInput?v(t,s,p,r*r):I(t,s,p,r),Ra.copy(j.matrixWorld.getPosition()),Ra.subSelf(j.target.matrixWorld.getPosition()),Ra.normalize(),u[s]=Ra.x,u[s+1]=Ra.y,
u[s+2]=Ra.z,ba+=1)):j instanceof THREE.PointLight?(na+=1,j.visible&&(S=3*Y,Q.gammaInput?v(y,S,p,r*r):I(y,S,p,r),r=j.matrixWorld.getPosition(),z[S]=r.x,z[S+1]=r.y,z[S+2]=r.z,D[Y]=s,Y+=1)):j instanceof THREE.SpotLight?(la+=1,j.visible&&(S=3*O,Q.gammaInput?v(C,S,p,r*r):I(C,S,p,r),r=j.matrixWorld.getPosition(),E[S]=r.x,E[S+1]=r.y,E[S+2]=r.z,G[O]=s,Ra.copy(r),Ra.subSelf(j.target.matrixWorld.getPosition()),Ra.normalize(),F[S]=Ra.x,F[S+1]=Ra.y,F[S+2]=Ra.z,J[O]=Math.cos(j.angle),R[O]=j.exponent,O+=1)):j instanceof
THREE.HemisphereLight&&(Ca+=1,j.visible&&(p=j.color,s=j.groundColor,S=3*U,Q.gammaInput?(r*=r,v(P,S,p,r),v(M,S,s,r)):(I(P,S,p,r),I(M,S,s,r)),Ra.copy(j.matrixWorld.getPosition()),Ra.normalize(),N[S]=Ra.x,N[S+1]=Ra.y,N[S+2]=Ra.z,U+=1)));c=3*ba;for(f=Math.max(t.length,3*$);c<f;c++)t[c]=0;c=3*ba;for(f=Math.max(u.length,3*$);c<f;c++)u[c]=0;c=3*Y;for(f=Math.max(y.length,3*na);c<f;c++)y[c]=0;c=3*Y;for(f=Math.max(z.length,3*na);c<f;c++)z[c]=0;c=Y;for(f=Math.max(D.length,na);c<f;c++)D[c]=0;c=3*O;for(f=Math.max(C.length,
...
a.__objectsAdded[0],j=a,m=void 0,l=void 0,p=void 0,s=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,b instanceof THREE.Mesh)if(l=b.geometry,p=b.material,l instanceof THREE.Geometry){if(void 0===l.geometryGroups){var r=l,v=void 0,z=void 0,A=void 0,B=void 0,D=void 0,C=void 0,F={},G=r.morphTargets.length,I=r.morphNormals.length,J=p instanceof THREE.MeshFaceMaterial;r.geometryGroups={};v=0;for(z=r.faces.length;v<z;v++)A=r.faces[v],B=
J?A.materialIndex:0,void 0===F[B]&&(F[B]={hash:B,counter:0}),C=F[B].hash+"_"+F[B].counter,void 0===r.geometryGroups[C]&&(r.geometryGroups[C]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:G,numMorphNormals:I}),D=A instanceof THREE.Face3?3:4,65535<r.geometryGroups[C].vertices+D&&(F[B].counter+=1,C=F[B].hash+"_"+F[B].counter,void 0===r.geometryGroups[C]&&(r.geometryGroups[C]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:G,numMorphNormals:I})),A instanceof THREE.Face3?
...
a.vertexShader=p.vertexShader;a.fragmentShader=p.fragmentShader}var s,r,q;e=s=r=q=p=0;for(f=b.length;e<f;e++)g=b[e],g.onlyShadow||(g instanceof THREE.DirectionalLight&&s++,g instanceof THREE.PointLight&&r++,g instanceof THREE.SpotLight&&q++,g instanceof THREE.HemisphereLight&&p++);e=s;f=r;g=q;h=p;p=s=0;for(q=b.length;p<q;p++)r=b[p],r.castShadow&&(r instanceof THREE.SpotLight&&s++,r instanceof THREE.DirectionalLight&&!r.shadowCascade&&s++);l=s;xc&&d&&d.useVertexTexture?m=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),
b=Math.floor((b-20)/4),void 0!==d&&d instanceof THREE.SkinnedMesh&&(b=Math.min(d.bones.length,b),b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")),m=b);a:{r=a.fragmentShader;q=a.vertexShader;p=a.uniforms;b=a.attributes;s=a.defines;var c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,
...
shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,v,d=[];n?d.push(n):(d.push(r),d.push(q));for(u in s)d.push(u),d.push(s[u]);for(t in c)d.push(t),d.push(c[t]);n=d.join();t=0;for(u=R.length;t<u;t++)if(d=R[t],d.code===n){d.usedTimes++;j=d.program;break a}t=[];for(v in s)u=s[v],!1!==u&&(u="#define "+v+" "+u,t.push(u));u=t.join("\n");
v=k.createProgram();t=["precision "+U+" float;",u,yc?"#define VERTEX_TEXTURES":"",Q.gammaInput?"#define GAMMA_INPUT":"",Q.gammaOutput?"#define GAMMA_OUTPUT":"",Q.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_HEMI_LIGHTS "+c.maxHemiLights,"#define MAX_SHADOWS "+c.maxShadows,"#define MAX_BONES "+c.maxBones,c.map?"#define USE_MAP":"",c.envMap?"#define USE_ENVMAP":
"",c.lightMap?"#define USE_LIGHTMAP":"",c.bumpMap?"#define USE_BUMPMAP":"",c.normalMap?"#define USE_NORMALMAP":"",c.specularMap?"#define USE_SPECULARMAP":"",c.vertexColors?"#define USE_COLOR":"",c.skinning?"#define USE_SKINNING":"",c.useVertexTexture?"#define BONE_TEXTURE":"",c.boneTextureWidth?"#define N_BONE_PIXEL_X "+c.boneTextureWidth.toFixed(1):"",c.boneTextureHeight?"#define N_BONE_PIXEL_Y "+c.boneTextureHeight.toFixed(1):"",c.morphTargets?"#define USE_MORPHTARGETS":"",c.morphNormals?"#define USE_MORPHNORMALS":
"",c.perPixel?"#define PHONG_PER_PIXEL":"",c.wrapAround?"#define WRAP_AROUND":"",c.doubleSided?"#define DOUBLE_SIDED":"",c.flipSided?"#define FLIP_SIDED":"",c.shadowMapEnabled?"#define USE_SHADOWMAP":"",c.shadowMapSoft?"#define SHADOWMAP_SOFT":"",c.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",c.shadowMapCascade?"#define SHADOWMAP_CASCADE":"",c.sizeAttenuation?"#define USE_SIZEATTENUATION":"","uniform mat4 modelMatrix;\nuniform mat4 modelViewMatrix;\nuniform mat4 projectionMatrix;\nuniform mat4 viewMatrix;\nuniform mat3 normalMatrix;\nuniform vec3 cameraPosition;\nattribute vec3 position;\nattribute vec3 normal;\nattribute vec2 uv;\nattribute vec2 uv2;\n#ifdef USE_COLOR\nattribute vec3 color;\n#endif\n#ifdef USE_MORPHTARGETS\nattribute vec3 morphTarget0;\nattribute vec3 morphTarget1;\nattribute vec3 morphTarget2;\nattribute vec3 morphTarget3;\n#ifdef USE_MORPHNORMALS\nattribute vec3 morphNormal0;\nattribute vec3 morphNormal1;\nattribute vec3 morphNormal2;\nattribute vec3 morphNormal3;\n#else\nattribute vec3 morphTarget4;\nattribute vec3 morphTarget5;\nattribute vec3 morphTarget6;\nattribute vec3 morphTarget7;\n#endif\n#endif\n#ifdef USE_SKINNING\nattribute vec4 skinIndex;\nattribute vec4 skinWeight;\n#endif\n"].join("\n");
...
", gl error ["+k.getError()+"]");k.deleteShader(u);k.deleteShader(t);v.uniforms={};v.attributes={};var y;t="viewMatrix modelViewMatrix projectionMatrix normalMatrix modelMatrix cameraPosition morphTargetInfluences".split(" ");c.useVertexTexture?t.push("boneTexture"):t.push("boneGlobalMatrices");for(y in p)t.push(y);y=t;t=0;for(u=y.length;t<u;t++)d=y[t],v.uniforms[d]=k.getUniformLocation(v,d);t="position normal uv uv2 tangent color skinIndex skinWeight lineDistance".split(" ");for(y=0;y<c.maxMorphTargets;y++)t.push("morphTarget"+
...
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],g=[],h=[],i,j,m;if(0<b(a))for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var p=2*e;for(j=e-1;2<e;){if(0>=p--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);m=j+1;e<=m&&(m=0);var n;a:{var s=n=void 0,r=void 0,l=void 0,t=void 0,u=void 0,E=void 0,y=void 0,q=
void 0,s=a[g[i]].x,r=a[g[i]].y,l=a[g[j]].x,t=a[g[j]].y,u=a[g[m]].x,E=a[g[m]].y;if(1E-10>(l-s)*(E-r)-(t-r)*(u-s))n=!1;else{var G=void 0,A=void 0,z=void 0,v=void 0,I=void 0,D=void 0,F=void 0,M=void 0,B=void 0,J=void 0,B=M=F=q=y=void 0,G=u-l,A=E-t,z=s-u,v=r-E,I=l-s,D=t-r;for(n=0;n<e;n++)if(!(n===i||n===j||n===m))if(y=a[g[n]].x,q=a[g[n]].y,F=y-s,M=q-r,B=y-l,J=q-t,y-=u,q-=E,B=G*J-A*B,F=I*M-D*F,M=z*q-v*y,0<=B&&0<=M&&0<=F){n=!1;break a}n=!0}}if(n){f.push([a[g[i]],a[g[j]],a[g[m]]]);h.push([g[i],g[j],g[m]]);
...
n=this.vertices[j[0][h+1]].clone()):(p=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var s=j[i][h],r=j[i+1][h],l=j[i+1][h+1],t=j[i][h+1],u=p.clone(),E=p.clone(),y=n.clone(),q=n.clone(),G=m[i][h].clone(),A=m[i+1][h].clone(),z=m[i+1][h+1].clone(),v=m[i][h+1].clone();this.faces.push(new THREE.Face4(s,r,l,t,[u,E,y,q]));this.faceVertexUvs[0].push([G,A,z,v])}}if(!f&&0<
a){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++)s=j[0][h],r=j[0][h+1],l=this.vertices.length-1,u=new THREE.Vector3(0,1,0),E=new THREE.Vector3(0,1,0),y=new THREE.Vector3(0,1,0),G=m[0][h].clone(),A=m[0][h+1].clone(),z=new THREE.Vector2(A.u,0),this.faces.push(new THREE.Face3(s,r,l,[u,E,y])),this.faceVertexUvs[0].push([G,A,z])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)s=j[i][h+1],r=j[i][h],l=this.vertices.length-1,u=new THREE.Vector3(0,-1,0),E=new THREE.Vector3(0,
-1,0),y=new THREE.Vector3(0,-1,0),G=m[i][h+1].clone(),A=m[i][h].clone(),z=new THREE.Vector2(A.u,1),this.faces.push(new THREE.Face3(s,r,l,[u,E,y])),this.faceVertexUvs[0].push([G,A,z])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(a,b){for(var c=a.length,d=0;d<c;d++)this.addShape(a[d],b)};
...
for(var g=0,h=s+2*m,g=0;g<h;g++){var i=O*g,j=O*(g+1),l=d+e+i,i=d+f+i,n=d+f+j,j=d+e+j,p=c,r=g,q=h,t=e,u=f,l=l+M,i=i+M,n=n+M,j=j+M;F.faces.push(new THREE.Face4(l,i,n,j,null,null,E));l=y.generateSideWallUV(F,a,p,b,l,i,n,j,r,q,t,u);F.faceVertexUvs[0].push(l)}}}function f(a,b,c){F.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=M;d+=M;e+=M;F.faces.push(new THREE.Face3(c,d,e,null,null,u));c=f?y.generateBottomUV(F,a,b,c,d,e):y.generateTopUV(F,a,b,c,d,e);F.faceVertexUvs[0].push(c)}var h=void 0!==
b.amount?b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,m=void 0!==b.bevelSegments?b.bevelSegments:3,p=void 0!==b.bevelEnabled?b.bevelEnabled:!0,n=void 0!==b.curveSegments?b.curveSegments:12,s=void 0!==b.steps?b.steps:1,r=b.extrudePath,l,t=!1,u=b.material,E=b.extrudeMaterial,y=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,q,G,A,z;r&&(l=r.getSpacedPoints(s),t=!0,p=!1,q=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(r,
s,!1),G=new THREE.Vector3,A=new THREE.Vector3,z=new THREE.Vector3);p||(j=i=m=0);var v,I,D,F=this,M=this.vertices.length,n=a.extractPoints(n),B=n.shape,n=n.holes;if(r=!THREE.Shape.Utils.isClockWise(B)){B=B.reverse();I=0;for(D=n.length;I<D;I++)v=n[I],THREE.Shape.Utils.isClockWise(v)&&(n[I]=v.reverse());r=!1}var J=THREE.Shape.Utils.triangulateShape(B,n),r=B;I=0;for(D=n.length;I<D;I++)v=n[I],B=B.concat(v);var C,L,K,U,O=B.length,$=J.length,wa=[],N=0,na=r.length;C=na-1;for(L=N+1;N<na;N++,C++,L++)C===na&&
(C=0),L===na&&(L=0),wa[N]=d(r[N],r[C],r[L]);var la=[],Ma,Q=wa.concat();I=0;for(D=n.length;I<D;I++){v=n[I];Ma=[];N=0;na=v.length;C=na-1;for(L=N+1;N<na;N++,C++,L++)C===na&&(C=0),L===na&&(L=0),Ma[N]=d(v[N],v[C],v[L]);la.push(Ma);Q=Q.concat(Ma)}for(C=0;C<m;C++){v=C/m;K=i*(1-v);L=j*Math.sin(v*Math.PI/2);N=0;for(na=r.length;N<na;N++)U=c(r[N],wa[N],L),f(U.x,U.y,-K);I=0;for(D=n.length;I<D;I++){v=n[I];Ma=la[I];N=0;for(na=v.length;N<na;N++)U=c(v[N],Ma[N],L),f(U.x,U.y,-K)}}L=j;for(N=0;N<O;N++)U=p?c(B[N],Q[N],
L):B[N],t?(A.copy(q.normals[0]).multiplyScalar(U.x),G.copy(q.binormals[0]).multiplyScalar(U.y),z.copy(l[0]).addSelf(A).addSelf(G),f(z.x,z.y,z.z)):f(U.x,U.y,0);for(v=1;v<=s;v++)for(N=0;N<O;N++)U=p?c(B[N],Q[N],L):B[N],t?(A.copy(q.normals[v]).multiplyScalar(U.x),G.copy(q.binormals[v]).multiplyScalar(U.y),z.copy(l[v]).addSelf(A).addSelf(G),f(z.x,z.y,z.z)):f(U.x,U.y,h/s*v);for(C=m-1;0<=C;C--){v=C/m;K=i*(1-v);L=j*Math.sin(v*Math.PI/2);N=0;for(na=r.length;N<na;N++)U=c(r[N],wa[N],L),f(U.x,U.y,h+K);I=0;for(D=
n.length;I<D;I++){v=n[I];Ma=la[I];N=0;for(na=v.length;N<na;N++)U=c(v[N],Ma[N],L),t?f(U.x,U.y+l[s-1].y,l[s-1].x+K):f(U.x,U.y,h+K)}}if(p){i=0*O;for(N=0;N<$;N++)h=J[N],g(h[2]+i,h[1]+i,h[0]+i,!0);i=O*(s+2*m);for(N=0;N<$;N++)h=J[N],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(N=0;N<$;N++)h=J[N],g(h[2],h[1],h[0],!0);for(N=0;N<$;N++)h=J[N],g(h[0]+O*s,h[1]+O*s,h[2]+O*s,!1)}h=0;e(r,h);h+=r.length;I=0;for(D=n.length;I<D;I++)v=n[I],e(v,h),h+=v.length};
...
A=0;for(z=D.length;A<z;A++){v=D[A];M=J;var C=v,L=q;void 0===I[M]&&(I[M]={});I[M][C]=L;M=B;C=q;void 0===I[M]&&(I[M]={});I[M][v]=C}2>D.length&&(E[q]=!0)}for(q in n)D=n[q],v=D[0],M=D[1],B=q.split("_"),J=B[0],B=B[1],z=new THREE.Vector3,b(0<D.length,"an edge without faces?!"),1==D.length?(z.addSelf(s[J]),z.addSelf(s[B]),z.multiplyScalar(0.5)):(z.addSelf(t[v]),z.addSelf(t[M]),z.addSelf(s[J]),z.addSelf(s[B]),z.multiplyScalar(0.25)),u[q]=l+r.length+G,h.push(z),G++,m.supportUVs&&(z=new THREE.Vector2,z.x=f(J,
v).x+f(B,v).x,z.y=f(J,v).y+f(B,v).y,z.x/=2,z.y/=2,g(u[q],v,z),2<=D.length&&(b(2==D.length,"did we plan for more than 2 edges?"),z=new THREE.Vector2,z.x=f(J,M).x+f(B,M).x,z.y=f(J,M).y+f(B,M).y,z.x/=2,z.y/=2,g(u[q],M,z)));c("-- Step 2 done");var K,U;z=["123","12","2","23"];M=["123","23","3","31"];var C=["123","31","1","12"],L=["1234","12","2","23"],O=["1234","23","3","34"],$=["1234","34","4","41"],wa=["1234","41","1","12"];q=0;for(G=t.length;q<G;q++)v=r[q],D=l+q,v instanceof THREE.Face3?(J=p(v.a,v.b),
B=p(v.b,v.c),K=p(v.c,v.a),e(D,u[J],v.b,u[B],v,z,q),e(D,u[B],v.c,u[K],v,M,q),e(D,u[K],v.a,u[J],v,C,q)):v instanceof THREE.Face4?(J=p(v.a,v.b),B=p(v.b,v.c),K=p(v.c,v.d),U=p(v.d,v.a),e(D,u[J],v.b,u[B],v,L,q),e(D,u[B],v.c,u[K],v,O,q),e(D,u[K],v.d,u[U],v,$,q),e(D,u[U],v.a,u[J],v,wa,q)):c("face should be a face!",v);u=new THREE.Vector3;v=new THREE.Vector3;q=0;for(G=s.length;q<G;q++)if(void 0!==F[q]){u.set(0,0,0);v.set(0,0,0);B=new THREE.Vector3(0,0,0);D=0;for(A in I[q])u.addSelf(t[A]),D++;M=0;J=F[q].length;
z=D!=J;for(A=0;A<J;A++)E[p(F[q][A][0],F[q][A][1])]&&M++;u.divideScalar(D);M=0;if(z){for(A=0;A<J;A++)if(D=F[q][A],C=1==n[p(D[0],D[1])].length)D=s[D[0]].clone().addSelf(s[D[1]]).divideScalar(2),v.addSelf(D),M++;v.divideScalar(4);b(2==M,"should have only 2 boundary edges")}else{for(A=0;A<J;A++)D=F[q][A],D=s[D[0]].clone().addSelf(s[D[1]]).divideScalar(2),v.addSelf(D);v.divideScalar(J)}B.addSelf(s[q]);z?(B.divideScalar(2),B.addSelf(v)):(B.multiplyScalar(J-3),B.addSelf(u),B.addSelf(v.multiplyScalar(2)),
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(m,p){var n,s,r,l,t,u,E,y,q,G=[];l=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFace===THREE.CullFaceFront?
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(!0);n=0;for(s=m.__lights.length;n<s;n++)if(r=m.__lights[n],r.castShadow)if(r instanceof THREE.DirectionalLight&&r.shadowCascade)for(t=0;t<r.shadowCascadeCount;t++){var A;if(r.shadowCascadeArray[t])A=r.shadowCascadeArray[t];else{q=r;E=t;A=new THREE.DirectionalLight;A.isVirtual=!0;A.onlyShadow=!0;A.castShadow=!0;A.shadowCameraNear=q.shadowCameraNear;A.shadowCameraFar=q.shadowCameraFar;A.shadowCameraLeft=q.shadowCameraLeft;A.shadowCameraRight=q.shadowCameraRight;
...
new THREE.CameraHelper(r.shadowCamera),r.shadowCamera.add(r.cameraHelper));if(r.isVirtual&&A.originalCamera==p){t=p;l=r.shadowCamera;u=r.pointsFrustum;q=r.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(E=0;8>E;E++)y=q[E],y.copy(u[E]),THREE.ShadowMapPlugin.__projector.unprojectVector(y,t),l.matrixWorldInverse.multiplyVector3(y),y.x<i.x&&(i.x=y.x),y.x>j.x&&(j.x=y.x),y.y<i.y&&(i.y=y.y),y.y>j.y&&(j.y=y.y),y.z<i.z&&(i.z=y.z),y.z>j.z&&(j.z=y.z);l.left=i.x;l.right=
...
G.far),b.uniform1i(u.fogType,1),q=t=1):G instanceof THREE.FogExp2&&(b.uniform1f(u.fogDensity,G.density),b.uniform1i(u.fogType,2),q=t=2)):(b.uniform1i(u.fogType,0),q=t=0);for(var A,z,v=[],G=0;G<l;G++)A=r[G],z=A.material,A.visible&&0!==z.opacity&&(z.useScreenCoordinates?A.z=-A.position.z:(A._modelViewMatrix.multiply(e.matrixWorldInverse,A.matrixWorld),A.z=-A._modelViewMatrix.elements[14]));r.sort(a);for(G=0;G<l;G++)A=r[G],z=A.material,A.visible&&0!==z.opacity&&(z.map&&z.map.image&&z.map.image.width)&&
(b.uniform1f(u.alphaTest,z.alphaTest),z.useScreenCoordinates?(b.uniform1i(u.useScreenCoordinates,1),b.uniform3f(u.screenPosition,(A.position.x-n)/n,(y-A.position.y)/y,Math.max(0,Math.min(1,A.position.z)))):(b.uniform1i(u.useScreenCoordinates,0),b.uniform1i(u.sizeAttenuation,z.sizeAttenuation?1:0),b.uniformMatrix4fv(u.modelViewMatrix,!1,A._modelViewMatrix.elements)),e=d.fog&&z.fog?q:0,t!==e&&(b.uniform1i(u.fogType,e),t=e),e=1/(z.scaleByViewport?s:1),v[0]=e*E*A.scale.x,v[1]=e*A.scale.y,b.uniform2f(u.uvScale,
