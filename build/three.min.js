...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],j=c[1],m=c[5],p=c[9],n=c[13],r=c[2],s=c[6],l=c[10],t=c[14],u=c[3],E=c[7],y=c[11],c=c[15],q=d[0],F=d[4],A=d[8],
z=d[12],v=d[1],I=d[5],D=d[9],G=d[13],M=d[2],B=d[6],J=d[10],C=d[14],L=d[3],K=d[7],U=d[11],d=d[15];e[0]=f*q+g*v+h*M+i*L;e[4]=f*F+g*I+h*B+i*K;e[8]=f*A+g*D+h*J+i*U;e[12]=f*z+g*G+h*C+i*d;e[1]=j*q+m*v+p*M+n*L;e[5]=j*F+m*I+p*B+n*K;e[9]=j*A+m*D+p*J+n*U;e[13]=j*z+m*G+p*C+n*d;e[2]=r*q+s*v+l*M+t*L;e[6]=r*F+s*I+l*B+t*K;e[10]=r*A+s*D+l*J+t*U;e[14]=r*z+s*G+l*C+t*d;e[3]=u*q+E*v+y*M+c*L;e[7]=u*F+E*I+y*B+c*K;e[11]=u*A+E*D+y*J+c*U;e[15]=u*z+E*G+y*C+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),m=Math.sin(b),p=1-j,n=d*e*p,r=d*f*p,p=e*f*p,d=d*m,s=e*m,m=f*m,f=g+(1-g)*j,g=n+m,e=r-s,n=n-m,h=h+(1-h)*j,m=p+d,r=r+s,p=p-d,i=i+(1-i)*j,j=c[0],d=c[1],s=c[2],l=c[3],t=c[4],u=c[5],E=c[6],y=c[7],q=c[8],F=c[9],A=c[10],z=c[11];c[0]=f*j+g*t+e*q;c[1]=f*d+g*u+e*F;c[2]=f*s+g*E+e*A;c[3]=f*l+g*y+e*z;c[4]=n*j+h*t+m*q;c[5]=n*d+h*u+m*F;c[6]=n*s+h*E+m*A;c[7]=n*l+h*y+m*z;c[8]=r*j+p*t+i*q;c[9]=r*d+p*u+i*F;c[10]=r*s+p*E+i*A;c[11]=r*l+p*y+i*z;
...
c)return!1;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return!0}var e,f,g=[],h=0,i,j,m=[],p=0,n,r,s=[],l=0,t,u=[],E=0,y,q,F=[],A=0,z,v,I=[],D=0,G={objects:[],sprites:[],lights:[],elements:[]},M=new THREE.Vector3,B=new THREE.Vector4,J=new THREE.Matrix4,C=new THREE.Matrix4,L=new THREE.Matrix3,K=new THREE.Frustum,U=new THREE.Vector4,O=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);J.multiply(b.projectionMatrix,b.matrixWorldInverse);J.multiplyVector3(a);return a};
this.unprojectVector=function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);J.multiply(b.matrixWorld,b.projectionMatrixInverse);J.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Raycaster(a,c)};this.projectScene=function(g,h,p,ma){var la=h.near,Ma=h.far,Q=!1,R,ba,da,P,ja,Y,ga,Ea,Va,ta,pa,ea,Ha,Db,ub;v=q=t=r=0;G.elements.length=0;g.updateMatrixWorld();
...
p;g++)if(Ea=G.objects[g].object,Va=Ea.matrixWorld,j=0,Ea instanceof THREE.Mesh){ta=Ea.geometry;da=ta.vertices;pa=ta.faces;ta=ta.faceVertexUvs;L.getInverse(Va);L.transpose();Ha=Ea.material instanceof THREE.MeshFaceMaterial;Db=!0===Ha?Ea.material:null;R=0;for(ba=da.length;R<ba;R++)i=b(),i.positionWorld.copy(da[R]),Va.multiplyVector3(i.positionWorld),i.positionScreen.copy(i.positionWorld),J.multiplyVector4(i.positionScreen),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,
i.visible=i.positionScreen.z>la&&i.positionScreen.z<Ma;da=0;for(R=pa.length;da<R;da++)if(ba=pa[da],ub=!0===Ha?Db.materials[ba.materialIndex]:Ea.material,void 0!==ub){Y=ub.side;if(ba instanceof THREE.Face3)if(P=m[ba.a],ja=m[ba.b],ga=m[ba.c],!0===P.visible&&!0===ja.visible&&!0===ga.visible)if(Q=0>(ga.positionScreen.x-P.positionScreen.x)*(ja.positionScreen.y-P.positionScreen.y)-(ga.positionScreen.y-P.positionScreen.y)*(ja.positionScreen.x-P.positionScreen.x),Y===THREE.DoubleSide||Q===(Y===THREE.FrontSide))r===
l?(ea=new THREE.RenderableFace3,s.push(ea),l++,r++,n=ea):n=s[r++],n.v1.copy(P),n.v2.copy(ja),n.v3.copy(ga);else continue;else continue;else if(ba instanceof THREE.Face4)if(P=m[ba.a],ja=m[ba.b],ga=m[ba.c],ea=m[ba.d],!0===P.visible&&!0===ja.visible&&!0===ga.visible&&!0===ea.visible)if(Q=0>(ea.positionScreen.x-P.positionScreen.x)*(ja.positionScreen.y-P.positionScreen.y)-(ea.positionScreen.y-P.positionScreen.y)*(ja.positionScreen.x-P.positionScreen.x)||0>(ja.positionScreen.x-ga.positionScreen.x)*(ea.positionScreen.y-
ga.positionScreen.y)-(ja.positionScreen.y-ga.positionScreen.y)*(ea.positionScreen.x-ga.positionScreen.x),Y===THREE.DoubleSide||Q===(Y===THREE.FrontSide)){if(t===E){var tb=new THREE.RenderableFace4;u.push(tb);E++;t++;n=tb}else n=u[t++];n.v1.copy(P);n.v2.copy(ja);n.v3.copy(ga);n.v4.copy(ea)}else continue;else continue;n.normalWorld.copy(ba.normal);!1===Q&&(Y===THREE.BackSide||Y===THREE.DoubleSide)&&n.normalWorld.negate();L.multiplyVector3(n.normalWorld).normalize();n.centroidWorld.copy(ba.centroid);
Va.multiplyVector3(n.centroidWorld);n.centroidScreen.copy(n.centroidWorld);J.multiplyVector3(n.centroidScreen);ga=ba.vertexNormals;P=0;for(ja=ga.length;P<ja;P++)ea=n.vertexNormalsWorld[P],ea.copy(ga[P]),!1===Q&&(Y===THREE.BackSide||Y===THREE.DoubleSide)&&ea.negate(),L.multiplyVector3(ea).normalize();n.vertexNormalsLength=ga.length;P=0;for(ja=ta.length;P<ja;P++)if(ea=ta[P][da],void 0!==ea){Y=0;for(ga=ea.length;Y<ga;Y++)n.uvs[P][Y]=ea[Y]}n.color=ba.color;n.material=ub;n.z=n.centroidScreen.z;G.elements.push(n)}}else if(Ea instanceof
THREE.Line){C.multiply(J,Va);da=Ea.geometry.vertices;P=b();P.positionScreen.copy(da[0]);C.multiplyVector4(P.positionScreen);Va=Ea.type===THREE.LinePieces?2:1;R=1;for(ba=da.length;R<ba;R++)P=b(),P.positionScreen.copy(da[R]),C.multiplyVector4(P.positionScreen),0<(R+1)%Va||(ja=m[j-2],U.copy(P.positionScreen),O.copy(ja.positionScreen),!0===d(U,O)&&(U.multiplyScalar(1/U.w),O.multiplyScalar(1/O.w),q===A?(pa=new THREE.RenderableLine,F.push(pa),A++,q++,y=pa):y=F[q++],y.v1.positionScreen.copy(U),y.v2.positionScreen.copy(O),
y.z=Math.max(U.z,O.z),y.material=Ea.material,G.elements.push(y)))}g=0;for(p=G.sprites.length;g<p;g++)Ea=G.sprites[g].object,Va=Ea.matrixWorld,Ea instanceof THREE.Particle&&(B.set(Va.elements[12],Va.elements[13],Va.elements[14],1),J.multiplyVector4(B),B.z/=B.w,0<B.z&&1>B.z&&(v===D?(la=new THREE.RenderableParticle,I.push(la),D++,v++,z=la):z=I[v++],z.object=Ea,z.x=B.x/B.w,z.y=B.y/B.w,z.z=B.z,z.rotation=Ea.rotation.z,z.scale.x=Ea.scale.x*Math.abs(z.x-(B.x+h.projectionMatrix.elements[0])/(B.w+h.projectionMatrix.elements[12])),
z.scale.y=Ea.scale.y*Math.abs(z.y-(B.y+h.projectionMatrix.elements[5])/(B.w+h.projectionMatrix.elements[13])),z.material=Ea.material,G.elements.push(z)));!0===ma&&G.elements.sort(c);return G}};THREE.Face3=function(a,b,c,d,e,f){this.a=a;this.b=b;this.c=c;this.normal=d instanceof THREE.Vector3?d:new THREE.Vector3;this.vertexNormals=d instanceof Array?d:[];this.color=e instanceof THREE.Color?e:new THREE.Color;this.vertexColors=e instanceof Array?e:[];this.vertexTangents=[];this.materialIndex=void 0!==f?f:0;this.centroid=new THREE.Vector3};
...
this.attributes.normal.array,b,c,d,e=0,f=a.length;e<f;e+=3)b=a[e],c=a[e+1],d=a[e+2],b=1/Math.sqrt(b*b+c*c+d*d),a[e]*=b,a[e+1]*=b,a[e+2]*=b},computeTangents:function(){function a(a){$.x=d[3*a];$.y=d[3*a+1];$.z=d[3*a+2];wa.copy($);ma=i[a];U.copy(ma);U.subSelf($.multiplyScalar($.dot(ma))).normalize();O.cross(wa,ma);la=O.dot(j[a]);N=0>la?-1:1;h[4*a]=U.x;h[4*a+1]=U.y;h[4*a+2]=U.z;h[4*a+3]=N}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===
...
var m,p,n,r,s,l,t,u,E,y,q,F,A,z,v,f=new THREE.Vector3,g=new THREE.Vector3,I,D,G,M,B,J,C,L=this.offsets;G=0;for(M=L.length;G<M;++G){D=L[G].start;B=L[G].count;var K=L[G].index;I=D;for(D+=B;I<D;I+=3)B=K+b[I],J=K+b[I+1],C=K+b[I+2],m=c[3*B],p=c[3*B+1],n=c[3*B+2],r=c[3*J],s=c[3*J+1],l=c[3*J+2],t=c[3*C],u=c[3*C+1],E=c[3*C+2],y=e[2*B],q=e[2*B+1],F=e[2*J],A=e[2*J+1],z=e[2*C],v=e[2*C+1],r-=m,m=t-m,s-=p,p=u-p,l-=n,n=E-n,F-=y,y=z-y,A-=q,q=v-q,v=1/(F*q-y*A),f.set((q*r-A*m)*v,(q*s-A*p)*v,(q*l-A*n)*v),g.set((F*
m-y*r)*v,(F*p-y*s)*v,(F*n-y*l)*v),i[B].addSelf(f),i[J].addSelf(f),i[C].addSelf(f),j[B].addSelf(g),j[J].addSelf(g),j[C].addSelf(g)}var U=new THREE.Vector3,O=new THREE.Vector3,$=new THREE.Vector3,wa=new THREE.Vector3,N,ma,la;G=0;for(M=L.length;G<M;++G){D=L[G].start;B=L[G].count;K=L[G].index;I=D;for(D+=B;I<D;I+=3)B=K+b[I],J=K+b[I+1],C=K+b[I+2],a(B),a(J),a(C)}this.tangentsNeedUpdate=this.hasTangents=!0}}};THREE.Camera=function(){THREE.Object3D.call(this);this.matrixWorldInverse=new THREE.Matrix4;this.projectionMatrix=new THREE.Matrix4;this.projectionMatrixInverse=new THREE.Matrix4};THREE.Camera.prototype=Object.create(THREE.Object3D.prototype);THREE.Camera.prototype.lookAt=function(a){this.matrix.lookAt(this.position,a,this.up);!0===this.rotationAutoUpdate&&(!1===this.useQuaternion?this.rotation.setEulerFromRotationMatrix(this.matrix,this.eulerOrder):this.quaternion.copy(this.matrix.decompose()[1]))};THREE.OrthographicCamera=function(a,b,c,d,e,f){THREE.Camera.call(this);this.left=a;this.right=b;this.top=c;this.bottom=d;this.near=void 0!==e?e:0.1;this.far=void 0!==f?f:2E3;this.updateProjectionMatrix()};THREE.OrthographicCamera.prototype=Object.create(THREE.Camera.prototype);THREE.OrthographicCamera.prototype.updateProjectionMatrix=function(){this.projectionMatrix.makeOrthographic(this.left,this.right,this.top,this.bottom,this.near,this.far)};THREE.PerspectiveCamera=function(a,b,c,d){THREE.Camera.call(this);this.fov=void 0!==a?a:50;this.aspect=void 0!==b?b:1;this.near=void 0!==c?c:0.1;this.far=void 0!==d?d:2E3;this.updateProjectionMatrix()};THREE.PerspectiveCamera.prototype=Object.create(THREE.Camera.prototype);THREE.PerspectiveCamera.prototype.setLens=function(a,b){void 0===b&&(b=24);this.fov=2*Math.atan(b/(2*a))*(180/Math.PI);this.updateProjectionMatrix()};
...
a}function d(a){a=Math.log(a)/Math.LN2;return Math.pow(2,Math.round(a))}function e(a,e,f,h,i,j,t){var u=f.toLowerCase().endsWith(".dds"),E=b+"/"+f;if(u){var y=THREE.ImageUtils.loadCompressedTexture(E);a[e]=y}else y=document.createElement("canvas"),a[e]=new THREE.Texture(y);a[e].sourceFile=f;h&&(a[e].repeat.set(h[0],h[1]),1!==h[0]&&(a[e].wrapS=THREE.RepeatWrapping),1!==h[1]&&(a[e].wrapT=THREE.RepeatWrapping));i&&a[e].offset.set(i[0],i[1]);j&&(f={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,j,m,p,n,r,s,l,t,u,E,y,q;function F(a){return a%4?4-a%4:0}function A(a,b){return(new Uint8Array(a,b,1))[0]}function z(a,b){return(new Uint32Array(a,b,1))[0]}function v(b,c){var d,e,f,g,h,i,j,m=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=m[3*d],f=m[3*d+1],g=m[3*d+2],h=K[2*e],e=K[2*e+1],i=K[2*f],j=K[2*f+1],f=K[2*g],g=K[2*g+1],J.faceVertexUvs[0].push([new THREE.Vector2(h,e),new THREE.Vector2(i,j),new THREE.Vector2(f,
g)])}function I(b,c){var d,e,f,g,h,i,j,m,n,p=new Uint32Array(a,c,4*b);for(d=0;d<b;d++)e=p[4*d],f=p[4*d+1],g=p[4*d+2],h=p[4*d+3],i=K[2*e],e=K[2*e+1],j=K[2*f],m=K[2*f+1],f=K[2*g],n=K[2*g+1],g=K[2*h],h=K[2*h+1],J.faceVertexUvs[0].push([new THREE.Vector2(i,e),new THREE.Vector2(j,m),new THREE.Vector2(f,n),new THREE.Vector2(g,h)])}function D(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],J.faces.push(new THREE.Face3(e,f,g,null,
...
g,h,[new THREE.Vector3(L[3*j],L[3*j+1],L[3*j+2]),new THREE.Vector3(r,l,m),new THREE.Vector3(s,q,n)],null,i))}}function B(b,c,d,e){for(var f,g,h,i,j,m,n,p,r,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),l=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];m=d[4*e];n=d[4*e+1];p=d[4*e+2];r=d[4*e+3];j=l[e];var s=L[3*n],q=L[3*n+1];n=L[3*n+2];var t=L[3*p],u=L[3*p+1];p=L[3*p+2];var v=L[3*r],y=L[3*r+1];r=L[3*r+2];J.faces.push(new THREE.Face4(f,g,h,i,[new THREE.Vector3(L[3*
m],L[3*m+1],L[3*m+2]),new THREE.Vector3(s,q,n),new THREE.Vector3(t,u,p),new THREE.Vector3(v,y,r)],null,j))}}var J=this,C=0,L=[],K=[],U,O,$;THREE.Geometry.call(this);q=a;O=C;E=new Uint8Array(q,O,12);s="";for(u=0;12>u;u++)s+=String.fromCharCode(E[O+u]);b=A(q,O+12);A(q,O+13);A(q,O+14);A(q,O+15);c=A(q,O+16);d=A(q,O+17);e=A(q,O+18);j=A(q,O+19);m=z(q,O+20);p=z(q,O+20+4);n=z(q,O+20+8);r=z(q,O+20+12);s=z(q,O+20+16);l=z(q,O+20+20);t=z(q,O+20+24);u=z(q,O+20+28);E=z(q,O+20+32);y=z(q,O+20+36);q=z(q,O+20+40);
C+=b;O=3*c+j;$=4*c+j;U=r*O;b=s*(O+3*d);c=l*(O+3*e);j=t*(O+3*d+3*e);O=u*$;d=E*($+4*d);e=y*($+4*e);$=C;var C=new Float32Array(a,C,3*m),wa,N,ma,la;for(wa=0;wa<m;wa++)N=C[3*wa],ma=C[3*wa+1],la=C[3*wa+2],J.vertices.push(new THREE.Vector3(N,ma,la));m=C=$+3*m*Float32Array.BYTES_PER_ELEMENT;if(p){C=new Int8Array(a,C,3*p);for($=0;$<p;$++)wa=C[3*$],N=C[3*$+1],ma=C[3*$+2],L.push(wa/127,N/127,ma/127)}C=m+3*p*Int8Array.BYTES_PER_ELEMENT;p=C+=F(3*p);if(n){m=new Float32Array(a,C,2*n);for(C=0;C<n;C++)$=m[2*C],wa=
m[2*C+1],K.push($,wa)}n=C=p+2*n*Float32Array.BYTES_PER_ELEMENT;U=n+U+F(2*r);p=U+b+F(2*s);b=p+c+F(2*l);c=b+j+F(2*t);O=c+O+F(2*u);j=O+d+F(2*E);d=j+e+F(2*y);l&&(e=p+3*l*Uint32Array.BYTES_PER_ELEMENT,D(l,p,e+3*l*Uint32Array.BYTES_PER_ELEMENT),v(l,e));t&&(l=b+3*t*Uint32Array.BYTES_PER_ELEMENT,e=l+3*t*Uint32Array.BYTES_PER_ELEMENT,M(t,b,l,e+3*t*Uint32Array.BYTES_PER_ELEMENT),v(t,e));y&&(t=j+4*y*Uint32Array.BYTES_PER_ELEMENT,G(y,j,t+4*y*Uint32Array.BYTES_PER_ELEMENT),I(y,t));q&&(y=d+4*q*Uint32Array.BYTES_PER_ELEMENT,
t=y+4*q*Uint32Array.BYTES_PER_ELEMENT,B(q,d,y,t+4*q*Uint32Array.BYTES_PER_ELEMENT),I(q,t));r&&D(r,n,n+3*r*Uint32Array.BYTES_PER_ELEMENT);s&&(r=U+3*s*Uint32Array.BYTES_PER_ELEMENT,M(s,U,r,r+3*s*Uint32Array.BYTES_PER_ELEMENT));u&&G(u,c,c+4*u*Uint32Array.BYTES_PER_ELEMENT);E&&(s=O+4*E*Uint32Array.BYTES_PER_ELEMENT,B(E,O,s,s+4*E*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals()};e.prototype=Object.create(THREE.Geometry.prototype);e=new e(c);c=this.initMaterials(d,c);this.needsTangents(c)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,j,m,p,n,r,s,l,t,u,E,y,q=a.faces;s=a.vertices;var F=a.normals,A=a.colors,z=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&z++;for(f=0;f<z;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(j=s.length;i<j;)m=new THREE.Vector3,m.x=s[i++]*e,m.y=s[i++]*e,m.z=s[i++]*e,d.vertices.push(m);i=0;for(j=q.length;i<j;){s=q[i++];m=s&1;h=s&2;f=s&4;g=s&8;n=s&16;p=s&32;l=s&64;s&=128;m?(t=new THREE.Face4,
t.a=q[i++],t.b=q[i++],t.c=q[i++],t.d=q[i++],m=4):(t=new THREE.Face3,t.a=q[i++],t.b=q[i++],t.c=q[i++],m=3);h&&(h=q[i++],t.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<z;f++)u=a.uvs[f],r=q[i++],y=u[2*r],r=u[2*r+1],d.faceUvs[f][h]=new THREE.Vector2(y,r);if(g)for(f=0;f<z;f++){u=a.uvs[f];E=[];for(g=0;g<m;g++)r=q[i++],y=u[2*r],r=u[2*r+1],E[g]=new THREE.Vector2(y,r);d.faceVertexUvs[f][h]=E}n&&(n=3*q[i++],g=new THREE.Vector3,g.x=F[n++],g.y=F[n++],g.z=F[n],t.normal=g);if(p)for(f=0;f<m;f++)n=3*q[i++],g=
new THREE.Vector3,g.x=F[n++],g.y=F[n++],g.z=F[n],t.vertexNormals.push(g);l&&(p=q[i++],p=new THREE.Color(A[p]),t.color=p);if(s)for(f=0;f<m;f++)p=q[i++],p=new THREE.Color(A[p]),t.vertexColors.push(p);d.faces.push(t)}if(a.skinWeights){i=0;for(j=a.skinWeights.length;i<j;i+=2)q=a.skinWeights[i],F=a.skinWeights[i+1],d.skinWeights.push(new THREE.Vector4(q,F,0,0))}if(a.skinIndices){i=0;for(j=a.skinIndices.length;i<j;i+=2)q=a.skinIndices[i],F=a.skinIndices[i+1],d.skinIndices.push(new THREE.Vector4(q,F,0,0))}d.bones=
a.bones;d.animation=a.animation;if(void 0!==a.morphTargets){i=0;for(j=a.morphTargets.length;i<j;i++){d.morphTargets[i]={};d.morphTargets[i].name=a.morphTargets[i].name;d.morphTargets[i].vertices=[];A=d.morphTargets[i].vertices;z=a.morphTargets[i].vertices;q=0;for(F=z.length;q<F;q+=3)s=new THREE.Vector3,s.x=z[q]*e,s.y=z[q+1]*e,s.z=z[q+2]*e,A.push(s)}}if(void 0!==a.morphColors){i=0;for(j=a.morphColors.length;i<j;i++){d.morphColors[i]={};d.morphColors[i].name=a.morphColors[i].name;d.morphColors[i].colors=
[];F=d.morphColors[i].colors;A=a.morphColors[i].colors;e=0;for(q=A.length;e<q;e+=3)z=new THREE.Color(16755200),z.setRGB(A[e],A[e+1],A[e+2]),F.push(z)}}d.computeCentroids();d.computeFaceNormals();a=this.initMaterials(a.materials,c);this.needsTangents(a)&&d.computeTangents();b(d,a)};THREE.LoadingMonitor=function(){THREE.EventTarget.call(this);var a=this,b=0,c=0,d=function(){b++;a.dispatchEvent({type:"progress",loaded:b,total:c});b===c&&a.dispatchEvent({type:"load"})};this.add=function(a){c++;a.addEventListener("load",d,!1)}};THREE.SceneLoader=function(){this.onLoadStart=function(){};this.onLoadProgress=function(){};this.onLoadComplete=function(){};this.callbackSync=function(){};this.callbackProgress=function(){};this.geometryHandlerMap={};this.hierarchyHandlerMap={};this.addGeometryHandler("ascii",THREE.JSONLoader);this.addGeometryHandler("binary",THREE.BinaryLoader)};THREE.SceneLoader.prototype.constructor=THREE.SceneLoader;
...
m.hierarchyHandlerMap[l.type].loaderObject;c.addEventListener?(c.addEventListener("load",h(p,a,r,l)),c.load(d(l.url,D.urlBaseType))):c.options?c.load(d(l.url,D.urlBaseType),h(p,a,r,l)):c.load(d(l.url,D.urlBaseType),h(p,a,r,l),e)}else if(void 0!==l.geometry){if(n=v.geometries[l.geometry]){q=!1;r=v.materials[l.material];q=r instanceof THREE.ShaderMaterial;e=l.position;g=l.rotation;i=l.scale;c=l.matrix;j=0;l.material||(r=new THREE.MeshFaceMaterial(v.face_materials[l.geometry]));r instanceof THREE.MeshFaceMaterial&&
0===r.materials.length&&(r=new THREE.MeshFaceMaterial(v.face_materials[l.geometry]));if(r instanceof THREE.MeshFaceMaterial)for(var z=0;z<r.materials.length;z++)q=q||r.materials[z]instanceof THREE.ShaderMaterial;q&&n.computeTangents();l.skin?q=new THREE.SkinnedMesh(n,r):l.morph?(q=new THREE.MorphAnimMesh(n,r),void 0!==l.duration&&(q.duration=l.duration),void 0!==l.time&&(q.time=l.time),void 0!==l.mirroredLoop&&(q.mirroredLoop=l.mirroredLoop),r.morphNormals&&n.computeMorphNormals()):q=new THREE.Mesh(n,
...
16777215,y=void 0!==l.intensity?l.intensity:1,"DirectionalLight"===l.type?(e=l.direction,u=new THREE.DirectionalLight(E,y),u.position.set(e[0],e[1],e[2]),l.target&&(I.push({object:u,targetName:l.target}),u.target=null)):"PointLight"===l.type?(e=l.position,c=l.distance,u=new THREE.PointLight(E,y,c),u.position.set(e[0],e[1],e[2])):"AmbientLight"===l.type&&(u=new THREE.AmbientLight(E)),a.add(u),u.name=p,v.lights[p]=u,v.objects[p]=u):"PerspectiveCamera"===l.type||"OrthographicCamera"===l.type?("PerspectiveCamera"===
...
f.useQuaternion=!0):f.rotation.set(h[0],h[1],h[2]);f.scale.set(n[0],n[1],n[2]);c&&f.traverse(function(a){a.material=c});b.add(f);v.objects[a]=f;e();q-=1;m.onLoadComplete();j()}}function i(a){return function(b,c){v.geometries[a]=b;v.face_materials[a]=c}}function j(){m.callbackProgress({totalModels:A,totalTextures:z,loadedModels:A-q,loadedTextures:z-F},v);m.onLoadProgress();if(0===q&&0===F){for(var a=0;a<I.length;a++){var c=I[a],d=v.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,
v.scene.add(c.object.target));c.object.target.properties.targetInverse=c.object}b(v)}}var m=this,p=THREE.Loader.prototype.extractUrlBase(c),n,r,s,l,t,u,E,y,q,F,A,z,v,I=[],D=a,G;for(G in this.geometryHandlerMap)a=this.geometryHandlerMap[G].loaderClass,this.geometryHandlerMap[G].loaderObject=new a;for(G in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[G].loaderClass,this.hierarchyHandlerMap[G].loaderObject=new a;F=q=0;v={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},
objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(D.transform&&(G=D.transform.position,a=D.transform.rotation,c=D.transform.scale,G&&v.scene.position.set(G[0],G[1],G[2]),a&&v.scene.rotation.set(a[0],a[1],a[2]),c&&v.scene.scale.set(c[0],c[1],c[2]),G||a||c))v.scene.updateMatrix(),v.scene.updateMatrixWorld();G=function(a){return function(){F-=a;j();m.onLoadComplete()}};for(var M in D.fogs)a=D.fogs[M],"linear"===a.type?l=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(l=new THREE.FogExp2(0,a.density)),
a=a.color,l.color.setRGB(a[0],a[1],a[2]),v.fogs[M]=l;for(var B in D.geometries)l=D.geometries[B],l.type in this.geometryHandlerMap&&(q+=1,m.onLoadStart());for(var J in D.objects)l=D.objects[J],l.type&&l.type in this.hierarchyHandlerMap&&(q+=1,m.onLoadStart());A=q;for(B in D.geometries)if(l=D.geometries[B],"cube"===l.type)n=new THREE.CubeGeometry(l.width,l.height,l.depth,l.widthSegments,l.heightSegments,l.depthSegments),v.geometries[B]=n;else if("plane"===l.type)n=new THREE.PlaneGeometry(l.width,l.height,
...
n;else if(l.type in this.geometryHandlerMap){J={};for(t in l)"type"!==t&&"url"!==t&&(J[t]=l[t]);this.geometryHandlerMap[l.type].loaderObject.load(d(l.url,D.urlBaseType),g(B),J)}else"embedded"===l.type&&(J=D.embeds[l.id],J.metadata=D.metadata,J&&this.geometryHandlerMap.ascii.loaderObject.createModel(J,i(B),""));for(var C in D.textures)if(B=D.textures[C],B.url instanceof Array){F+=B.url.length;for(t=0;t<B.url.length;t++)m.onLoadStart()}else F+=1,m.onLoadStart();z=F;for(C in D.textures){B=D.textures[C];
void 0!==B.mapping&&void 0!==THREE[B.mapping]&&(B.mapping=new THREE[B.mapping]);if(B.url instanceof Array){J=B.url.length;l=[];for(t=0;t<J;t++)l[t]=d(B.url[t],D.urlBaseType);t=(t=l[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(l,B.mapping,G(J)):THREE.ImageUtils.loadTextureCube(l,B.mapping,G(J))}else t=B.url.toLowerCase().endsWith(".dds"),J=d(B.url,D.urlBaseType),l=G(1),t=t?THREE.ImageUtils.loadCompressedTexture(J,B.mapping,l):THREE.ImageUtils.loadTexture(J,B.mapping,l),void 0!==
...
"combine"===K?C.parameters[K]="MixOperation"==C.parameters[K]?THREE.MixOperation:THREE.MultiplyOperation:"vertexColors"===K?"face"==C.parameters[K]?C.parameters[K]=THREE.FaceColors:C.parameters[K]&&(C.parameters[K]=THREE.VertexColors):"wrapRGB"===K&&(G=C.parameters[K],C.parameters[K]=new THREE.Vector3(G[0],G[1],G[2]));void 0!==C.parameters.opacity&&1>C.parameters.opacity&&(C.parameters.transparent=!0);C.parameters.normalMap?(G=THREE.ShaderUtils.lib.normal,B=THREE.UniformsUtils.clone(G.uniforms),t=
...
THREE.Scene.prototype.__removeObject=function(a){if(a instanceof THREE.Light){var b=this.__lights.indexOf(a);-1!==b&&this.__lights.splice(b,1)}else a instanceof THREE.Camera||(b=this.__objects.indexOf(a),-1!==b&&(this.__objects.splice(b,1),this.__objectsRemoved.push(a),b=this.__objectsAdded.indexOf(a),-1!==b&&this.__objectsAdded.splice(b,1)));for(b=0;b<a.children.length;b++)this.__removeObject(a.children[b])};THREE.Fog=function(a,b,c){this.name="";this.color=new THREE.Color(a);this.near=void 0!==b?b:1;this.far=void 0!==c?c:1E3};THREE.Fog.prototype.clone=function(){return new THREE.Fog(this.color.getHex(),this.near,this.far)};THREE.FogExp2=function(a,b){this.name="";this.color=new THREE.Color(a);this.density=void 0!==b?b:2.5E-4};THREE.FogExp2.prototype.clone=function(){return new THREE.FogExp2(this.color.getHex(),this.density)};THREE.CanvasRenderer=function(a){function b(a){E!==a&&(E=l.globalAlpha=a)}function c(a){y!==a&&(a===THREE.NormalBlending?l.globalCompositeOperation="source-over":a===THREE.AdditiveBlending?l.globalCompositeOperation="lighter":a===THREE.SubtractiveBlending&&(l.globalCompositeOperation="darker"),y=a)}function d(a){q!==a&&(q=l.strokeStyle=a)}function e(a){F!==a&&(F=l.fillStyle=a)}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},f=this,g,h,i,j=new THREE.Projector,m=void 0!==a.canvas?a.canvas:
document.createElement("canvas"),p,n,r,s,l=m.getContext("2d"),t=new THREE.Color(0),u=0,E=1,y=0,q=null,F=null,A=null,z=null,v=null,I,D,G,M,B=new THREE.RenderableVertex,J=new THREE.RenderableVertex,C,L,K,U,O,$,wa,N,ma,la,Ma,Q,R=new THREE.Color,ba=new THREE.Color,da=new THREE.Color,P=new THREE.Color,ja=new THREE.Color,Y=new THREE.Color,ga=new THREE.Color,Ea={},Va={},ta,pa,ea,Ha,Db,ub,qb,tb,Kb,Lb,ab=new THREE.Box2,za=new THREE.Box2,Na=new THREE.Box2,wb=!1,Qa=new THREE.Color,kb=new THREE.Color,hb=new THREE.Color,
xa=new THREE.Vector3,bb,fb,mc,ib,Eb,Sa,a=16;bb=document.createElement("canvas");bb.width=bb.height=2;fb=bb.getContext("2d");fb.fillStyle="rgba(0,0,0,1)";fb.fillRect(0,0,2,2);mc=fb.getImageData(0,0,2,2);ib=mc.data;Eb=document.createElement("canvas");Eb.width=Eb.height=a;Sa=Eb.getContext("2d");Sa.translate(-a/2,-a/2);Sa.scale(a,a);a--;this.domElement=m;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){p=a;n=b;r=Math.floor(p/2);s=
Math.floor(n/2);m.width=p;m.height=n;ab.min.set(-r,-s);ab.max.set(r,s);za.min.set(-r,-s);za.max.set(r,s);E=1;y=0;v=z=A=F=q=null};this.setClearColor=function(a,b){t.copy(a);u=void 0!==b?b:1;za.min.set(-r,-s);za.max.set(r,s)};this.setClearColorHex=function(a,b){t.setHex(a);u=void 0!==b?b:1;za.min.set(-r,-s);za.max.set(r,s)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){l.setTransform(1,0,0,-1,r,s);!1===za.empty()&&(za.intersect(ab),za.expandByScalar(2),1>u&&l.clearRect(za.min.x|0,
...
k,c.b+=g.b*k)}else f instanceof THREE.PointLight&&(h=f.matrixWorld.getPosition(),k=b.dot(xa.sub(h,a).normalize()),0>=k||(k*=0==f.distance?1:1-Math.min(a.distanceTo(h)/f.distance,1),0!=k&&(k*=f.intensity,c.r+=g.r*k,c.g+=g.g*k,c.b+=g.b*k)))}}function n(a,d,e,g,h,i,j,l){f.info.render.vertices+=3;f.info.render.faces++;b(l.opacity);c(l.blending);C=a.positionScreen.x;L=a.positionScreen.y;K=d.positionScreen.x;U=d.positionScreen.y;O=e.positionScreen.x;$=e.positionScreen.y;p(C,L,K,U,O,$);(l instanceof THREE.MeshLambertMaterial||
l instanceof THREE.MeshPhongMaterial)&&null===l.map&&null===l.map?(Y.copy(l.color),ga.copy(l.emissive),l.vertexColors===THREE.FaceColors&&(Y.r*=j.color.r,Y.g*=j.color.g,Y.b*=j.color.b),!0===wb?!1===l.wireframe&&l.shading==THREE.SmoothShading&&3==j.vertexNormalsLength?(ba.r=da.r=P.r=Qa.r,ba.g=da.g=P.g=Qa.g,ba.b=da.b=P.b=Qa.b,k(j.v1.positionWorld,j.vertexNormalsWorld[0],ba),k(j.v2.positionWorld,j.vertexNormalsWorld[1],da),k(j.v3.positionWorld,j.vertexNormalsWorld[2],P),ba.r=ba.r*Y.r+ga.r,ba.g=ba.g*
Y.g+ga.g,ba.b=ba.b*Y.b+ga.b,da.r=da.r*Y.r+ga.r,da.g=da.g*Y.g+ga.g,da.b=da.b*Y.b+ga.b,P.r=P.r*Y.r+ga.r,P.g=P.g*Y.g+ga.g,P.b=P.b*Y.b+ga.b,ja.r=0.5*(da.r+P.r),ja.g=0.5*(da.g+P.g),ja.b=0.5*(da.b+P.b),ea=F(ba,da,P,ja),E(C,L,K,U,O,$,0,0,1,0,0,1,ea)):(R.r=Qa.r,R.g=Qa.g,R.b=Qa.b,k(j.centroidWorld,j.normalWorld,R),R.r=R.r*Y.r+ga.r,R.g=R.g*Y.g+ga.g,R.b=R.b*Y.b+ga.b,!0===l.wireframe?t(R,l.wireframeLinewidth,l.wireframeLinecap,l.wireframeLinejoin):u(R)):!0===l.wireframe?t(l.color,l.wireframeLinewidth,l.wireframeLinecap,
l.wireframeLinejoin):u(l.color)):l instanceof THREE.MeshBasicMaterial||l instanceof THREE.MeshLambertMaterial||l instanceof THREE.MeshPhongMaterial?null!==l.map?l.map.mapping instanceof THREE.UVMapping&&(Ha=j.uvs[0],y(C,L,K,U,O,$,Ha[g].x,Ha[g].y,Ha[h].x,Ha[h].y,Ha[i].x,Ha[i].y,l.map)):null!==l.envMap?l.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=m.matrixWorldInverse,xa.copy(j.vertexNormalsWorld[g]),Db=0.5*(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])+0.5,ub=0.5*(xa.x*
a.elements[1]+xa.y*a.elements[5]+xa.z*a.elements[9])+0.5,xa.copy(j.vertexNormalsWorld[h]),qb=0.5*(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])+0.5,tb=0.5*(xa.x*a.elements[1]+xa.y*a.elements[5]+xa.z*a.elements[9])+0.5,xa.copy(j.vertexNormalsWorld[i]),Kb=0.5*(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])+0.5,Lb=0.5*(xa.x*a.elements[1]+xa.y*a.elements[5]+xa.z*a.elements[9])+0.5,y(C,L,K,U,O,$,Db,ub,qb,tb,Kb,Lb,l.envMap)):(R.copy(l.color),l.vertexColors===THREE.FaceColors&&(R.r*=
j.color.r,R.g*=j.color.g,R.b*=j.color.b),!0===l.wireframe?t(R,l.wireframeLinewidth,l.wireframeLinecap,l.wireframeLinejoin):u(R)):l instanceof THREE.MeshDepthMaterial?(ta=m.near,pa=m.far,ba.r=ba.g=ba.b=1-jb(a.positionScreen.z,ta,pa),da.r=da.g=da.b=1-jb(d.positionScreen.z,ta,pa),P.r=P.g=P.b=1-jb(e.positionScreen.z,ta,pa),ja.r=0.5*(da.r+P.r),ja.g=0.5*(da.g+P.g),ja.b=0.5*(da.b+P.b),ea=F(ba,da,P,ja),E(C,L,K,U,O,$,0,0,1,0,0,1,ea)):l instanceof THREE.MeshNormalMaterial&&(R.r=zc(j.normalWorld.x),R.g=zc(j.normalWorld.y),
R.b=zc(j.normalWorld.z),!0===l.wireframe?t(R,l.wireframeLinewidth,l.wireframeLinecap,l.wireframeLinejoin):u(R))}function p(a,b,c,d,e,f){l.beginPath();l.moveTo(a,b);l.lineTo(c,d);l.lineTo(e,f);l.closePath()}function q(a,b,c,d,e,f,g,h){l.beginPath();l.moveTo(a,b);l.lineTo(c,d);l.lineTo(e,f);l.lineTo(g,h);l.closePath()}function t(a,b,c,e){A!==b&&(A=l.lineWidth=b);z!==c&&(z=l.lineCap=c);v!==e&&(v=l.lineJoin=e);d(a.getStyle());l.stroke();Na.expandByScalar(2*b)}function u(a){e(a.getStyle());l.fill()}function y(a,
b,c,d,f,g,h,k,i,j,m,jb,n){if(!(n instanceof THREE.DataTexture||void 0===n.image||0==n.image.width)){if(!0===n.needsUpdate){var p=n.wrapS==THREE.RepeatWrapping,lb=n.wrapT==THREE.RepeatWrapping;Ea[n.id]=l.createPattern(n.image,!0===p&&!0===lb?"repeat":!0===p&&!1===lb?"repeat-x":!1===p&&!0===lb?"repeat-y":"no-repeat");n.needsUpdate=!1}void 0===Ea[n.id]?e("rgba(0,0,0,1)"):e(Ea[n.id]);var p=n.offset.x/n.repeat.x,lb=n.offset.y/n.repeat.y,r=n.image.width*n.repeat.x,s=n.image.height*n.repeat.y,h=(h+p)*r,
k=(1-k+lb)*s,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+p)*r-h,j=(1-j+lb)*s-k,m=(m+p)*r-h,jb=(1-jb+lb)*s-k,p=i*jb-m*j;0===p?(void 0===Va[n.id]&&(b=document.createElement("canvas"),b.width=n.image.width,b.height=n.image.height,b=b.getContext("2d"),b.drawImage(n.image,0,0),Va[n.id]=b.getImageData(0,0,n.image.width,n.image.height).data),b=Va[n.id],h=4*(Math.floor(h)+Math.floor(k)*n.image.width),R.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),u(R)):(p=1/p,n=(jb*c-j*f)*p,j=(jb*d-j*g)*p,c=(i*f-m*c)*p,d=(i*g-m*d)*p,a=a-n*h-
c*k,h=b-j*h-d*k,l.save(),l.transform(n,j,c,d,a,h),l.fill(),l.restore())}}function E(a,b,c,d,e,f,g,h,k,i,j,m,jb){var n,p;n=jb.width-1;p=jb.height-1;g*=n;h*=p;c-=a;d-=b;e-=a;f-=b;k=k*n-g;i=i*p-h;j=j*n-g;m=m*p-h;p=1/(k*m-j*i);n=(m*c-i*e)*p;i=(m*d-i*f)*p;c=(k*e-j*c)*p;d=(k*f-j*d)*p;a=a-n*g-c*h;b=b-i*g-d*h;l.save();l.transform(n,i,c,d,a,b);l.clip();l.drawImage(jb,0,0);l.restore()}function F(a,b,c,d){ib[0]=255*a.r|0;ib[1]=255*a.g|0;ib[2]=255*a.b|0;ib[4]=255*b.r|0;ib[5]=255*b.g|0;ib[6]=255*b.b|0;ib[8]=255*
c.r|0;ib[9]=255*c.g|0;ib[10]=255*c.b|0;ib[12]=255*d.r|0;ib[13]=255*d.g|0;ib[14]=255*d.b|0;fb.putImageData(mc,0,0);Sa.drawImage(bb,0,0);return Eb}function jb(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function zc(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function lb(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===m instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{var nc,Uc,na,
aa;!0===this.autoClear?this.clear():l.setTransform(1,0,0,-1,r,s);f.info.render.vertices=0;f.info.render.faces=0;g=j.projectScene(a,m,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;wb=0<i.length;if(!0===wb){Qa.setRGB(0,0,0);kb.setRGB(0,0,0);hb.setRGB(0,0,0);nc=0;for(Uc=i.length;nc<Uc;nc++){aa=i[nc];var oa=aa.color;aa instanceof THREE.AmbientLight?(Qa.r+=oa.r,Qa.g+=oa.g,Qa.b+=oa.b):aa instanceof THREE.DirectionalLight?(kb.r+=oa.r,kb.g+=oa.g,kb.b+=oa.b):aa instanceof THREE.PointLight&&(hb.r+=
oa.r,hb.g+=oa.g,hb.b+=oa.b)}}nc=0;for(Uc=h.length;nc<Uc;nc++)if(na=h[nc],aa=na.material,!(void 0===aa||!1===aa.visible)){Na.makeEmpty();if(na instanceof THREE.RenderableParticle){I=na;I.x*=r;I.y*=s;var oa=I,eb=na;b(aa.opacity);c(aa.blending);var Gb=void 0,Hb=void 0,xb=void 0,yb=void 0,Ac=na=void 0,md=void 0;aa instanceof THREE.ParticleBasicMaterial?null===aa.map?(xb=eb.object.scale.x,yb=eb.object.scale.y,xb*=eb.scale.x*r,yb*=eb.scale.y*s,Na.min.set(oa.x-xb,oa.y-yb),Na.max.set(oa.x+xb,oa.y+yb),!1!==
ab.isIntersection(Na)&&(e(aa.color.getStyle()),l.save(),l.translate(oa.x,oa.y),l.rotate(-eb.rotation),l.scale(xb,yb),l.fillRect(-1,-1,2,2),l.restore())):(na=aa.map.image,Ac=na.width>>1,md=na.height>>1,xb=eb.scale.x*r,yb=eb.scale.y*s,Gb=xb*Ac,Hb=yb*md,Na.min.set(oa.x-Gb,oa.y-Hb),Na.max.set(oa.x+Gb,oa.y+Hb),!1!==ab.isIntersection(Na)&&(l.save(),l.translate(oa.x,oa.y),l.rotate(-eb.rotation),l.scale(xb,-yb),l.translate(-Ac,-md),l.drawImage(na,0,0),l.restore())):aa instanceof THREE.ParticleCanvasMaterial&&
(Gb=eb.scale.x*r,Hb=eb.scale.y*s,Na.min.set(oa.x-Gb,oa.y-Hb),Na.max.set(oa.x+Gb,oa.y+Hb),!1!==ab.isIntersection(Na)&&(d(aa.color.getStyle()),e(aa.color.getStyle()),l.save(),l.translate(oa.x,oa.y),l.rotate(-eb.rotation),l.scale(Gb,Hb),aa.program(l),l.restore()))}else na instanceof THREE.RenderableLine?(I=na.v1,D=na.v2,I.positionScreen.x*=r,I.positionScreen.y*=s,D.positionScreen.x*=r,D.positionScreen.y*=s,Na.setFromPoints([I.positionScreen,D.positionScreen]),!0===ab.isIntersection(Na)&&(oa=I,eb=D,b(aa.opacity),
c(aa.blending),l.beginPath(),l.moveTo(oa.positionScreen.x,oa.positionScreen.y),l.lineTo(eb.positionScreen.x,eb.positionScreen.y),aa instanceof THREE.LineBasicMaterial&&(oa=aa.linewidth,A!==oa&&(A=l.lineWidth=oa),oa=aa.linecap,z!==oa&&(z=l.lineCap=oa),oa=aa.linejoin,v!==oa&&(v=l.lineJoin=oa),d(aa.color.getStyle()),l.stroke(),Na.expandByScalar(2*aa.linewidth)))):na instanceof THREE.RenderableFace3?(I=na.v1,D=na.v2,G=na.v3,I.positionScreen.x*=r,I.positionScreen.y*=s,D.positionScreen.x*=r,D.positionScreen.y*=
s,G.positionScreen.x*=r,G.positionScreen.y*=s,!0===aa.overdraw&&(lb(I.positionScreen,D.positionScreen),lb(D.positionScreen,G.positionScreen),lb(G.positionScreen,I.positionScreen)),Na.setFromPoints([I.positionScreen,D.positionScreen,G.positionScreen]),!0===ab.isIntersection(Na)&&n(I,D,G,0,1,2,na,aa,a)):na instanceof THREE.RenderableFace4&&(I=na.v1,D=na.v2,G=na.v3,M=na.v4,I.positionScreen.x*=r,I.positionScreen.y*=s,D.positionScreen.x*=r,D.positionScreen.y*=s,G.positionScreen.x*=r,G.positionScreen.y*=
s,M.positionScreen.x*=r,M.positionScreen.y*=s,B.positionScreen.copy(D.positionScreen),J.positionScreen.copy(M.positionScreen),!0===aa.overdraw&&(lb(I.positionScreen,D.positionScreen),lb(D.positionScreen,M.positionScreen),lb(M.positionScreen,I.positionScreen),lb(G.positionScreen,B.positionScreen),lb(G.positionScreen,J.positionScreen)),Na.setFromPoints([I.positionScreen,D.positionScreen,G.positionScreen,M.positionScreen]),!0===ab.isIntersection(Na)&&(oa=I,eb=D,Gb=G,Hb=M,xb=B,yb=J,Ac=a,f.info.render.vertices+=
4,f.info.render.faces++,b(aa.opacity),c(aa.blending),void 0!==aa.map&&null!==aa.map||void 0!==aa.envMap&&null!==aa.envMap?(n(oa,eb,Hb,0,1,3,na,aa,Ac),n(xb,Gb,yb,1,2,3,na,aa,Ac)):(C=oa.positionScreen.x,L=oa.positionScreen.y,K=eb.positionScreen.x,U=eb.positionScreen.y,O=Gb.positionScreen.x,$=Gb.positionScreen.y,wa=Hb.positionScreen.x,N=Hb.positionScreen.y,ma=xb.positionScreen.x,la=xb.positionScreen.y,Ma=yb.positionScreen.x,Q=yb.positionScreen.y,aa instanceof THREE.MeshLambertMaterial||aa instanceof
THREE.MeshPhongMaterial?(Y.copy(aa.color),ga.copy(aa.emissive),aa.vertexColors===THREE.FaceColors&&(Y.r*=na.color.r,Y.g*=na.color.g,Y.b*=na.color.b),!0===wb?!1===aa.wireframe&&aa.shading==THREE.SmoothShading&&4==na.vertexNormalsLength?(ba.r=da.r=P.r=ja.r=Qa.r,ba.g=da.g=P.g=ja.g=Qa.g,ba.b=da.b=P.b=ja.b=Qa.b,k(na.v1.positionWorld,na.vertexNormalsWorld[0],ba),k(na.v2.positionWorld,na.vertexNormalsWorld[1],da),k(na.v4.positionWorld,na.vertexNormalsWorld[3],P),k(na.v3.positionWorld,na.vertexNormalsWorld[2],
ja),ba.r=ba.r*Y.r+ga.r,ba.g=ba.g*Y.g+ga.g,ba.b=ba.b*Y.b+ga.b,da.r=da.r*Y.r+ga.r,da.g=da.g*Y.g+ga.g,da.b=da.b*Y.b+ga.b,P.r=P.r*Y.r+ga.r,P.g=P.g*Y.g+ga.g,P.b=P.b*Y.b+ga.b,ja.r=ja.r*Y.r+ga.r,ja.g=ja.g*Y.g+ga.g,ja.b=ja.b*Y.b+ga.b,ea=F(ba,da,P,ja),p(C,L,K,U,wa,N),E(C,L,K,U,wa,N,0,0,1,0,0,1,ea),p(ma,la,O,$,Ma,Q),E(ma,la,O,$,Ma,Q,1,0,1,1,0,1,ea)):(R.r=Qa.r,R.g=Qa.g,R.b=Qa.b,k(na.centroidWorld,na.normalWorld,R),R.r=R.r*Y.r+ga.r,R.g=R.g*Y.g+ga.g,R.b=R.b*Y.b+ga.b,q(C,L,K,U,O,$,wa,N),!0===aa.wireframe?t(R,aa.wireframeLinewidth,
aa.wireframeLinecap,aa.wireframeLinejoin):u(R)):(R.r=Y.r+ga.r,R.g=Y.g+ga.g,R.b=Y.b+ga.b,q(C,L,K,U,O,$,wa,N),!0===aa.wireframe?t(R,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(R))):aa instanceof THREE.MeshBasicMaterial?(R.copy(aa.color),aa.vertexColors===THREE.FaceColors&&(R.r*=na.color.r,R.g*=na.color.g,R.b*=na.color.b),q(C,L,K,U,O,$,wa,N),!0===aa.wireframe?t(R,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(R)):aa instanceof THREE.MeshNormalMaterial?(R.r=zc(na.normalWorld.x),
R.g=zc(na.normalWorld.y),R.b=zc(na.normalWorld.z),q(C,L,K,U,O,$,wa,N),!0===aa.wireframe?t(R,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(R)):aa instanceof THREE.MeshDepthMaterial&&(ta=m.near,pa=m.far,ba.r=ba.g=ba.b=1-jb(oa.positionScreen.z,ta,pa),da.r=da.g=da.b=1-jb(eb.positionScreen.z,ta,pa),P.r=P.g=P.b=1-jb(Hb.positionScreen.z,ta,pa),ja.r=ja.g=ja.b=1-jb(Gb.positionScreen.z,ta,pa),ea=F(ba,da,P,ja),p(C,L,K,U,wa,N),E(C,L,K,U,wa,N,0,0,1,0,0,1,ea),p(ma,la,O,$,Ma,Q),E(ma,la,O,$,Ma,
...
i.buffer),k.bufferData(k.ARRAY_BUFFER,i.array,b));a.tangentsNeedUpdate&&void 0!==d&&(k.bindBuffer(k.ARRAY_BUFFER,d.buffer),k.bufferData(k.ARRAY_BUFFER,d.array,b));if(c)for(var j in a.attributes)delete a.attributes[j].array}function j(a){bb[a]||(k.enableVertexAttribArray(a),bb[a]=!0)}function m(){for(var a in bb)bb[a]&&(k.disableVertexAttribArray(a),bb[a]=!1)}function p(a,b){return a.z!==b.z?b.z-a.z:b.id-a.id}function n(a,b){return b[0]-a[0]}function r(a,b,c){if(a.length)for(var d=0,e=a.length;d<e;d++)ga=
da=null,ja=Y=pa=ta=tb=qb=ea=-1,vb=!0,a[d].render(b,c,hb,xa),ga=da=null,ja=Y=pa=ta=tb=qb=ea=-1,vb=!0}function s(a,b,c,d,e,f,g,h){var k,i,j,m;b?(i=a.length-1,m=b=-1):(i=0,b=a.length,m=1);for(var n=i;n!==b;n+=m)if(k=a[n],k.render){i=k.object;j=k.buffer;if(h)k=h;else{k=k[c];if(!k)continue;g&&Q.setBlending(k.blending,k.blendEquation,k.blendSrc,k.blendDst);Q.setDepthTest(k.depthTest);Q.setDepthWrite(k.depthWrite);D(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits)}Q.setMaterialFaces(k);j instanceof
THREE.BufferGeometry?Q.renderBufferDirect(d,e,f,k,j,i):Q.renderBuffer(d,e,f,k,j,i)}}function l(a,b,c,d,e,f,g){for(var h,k,i=0,j=a.length;i<j;i++)if(h=a[i],k=h.object,k.visible){if(g)h=g;else{h=h[b];if(!h)continue;f&&Q.setBlending(h.blending,h.blendEquation,h.blendSrc,h.blendDst);Q.setDepthTest(h.depthTest);Q.setDepthWrite(h.depthWrite);D(h.polygonOffset,h.polygonOffsetFactor,h.polygonOffsetUnits)}Q.renderImmediateObject(c,d,e,h,k)}}function t(a,b,c){a.push({buffer:b,object:c,opaque:null,transparent:null})}
function u(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return!0;return!1}function E(a){for(var b in a.attributes)a.attributes[b].needsUpdate=!1}function y(a,b){for(var c=a.length-1;0<=c;c--)a[c].object===b&&a.splice(c,1)}function q(a,b){for(var c=a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function F(a,b,c,d,e){Va=0;d.needsUpdate&&(d.program&&Q.deallocateMaterial(d),Q.initMaterial(d,b,c,e),d.needsUpdate=!1);d.morphTargets&&!e.__webglMorphTargetInfluences&&(e.__webglMorphTargetInfluences=
new Float32Array(Q.maxMorphTargets));var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==da&&(k.useProgram(g),da=g,f=!0);d.id!==ja&&(ja=d.id,f=!0);if(f||a!==ga)k.uniformMatrix4fv(h.projectionMatrix,!1,a.projectionMatrix.elements),a!==ga&&(ga=a);if(d.skinning)if(xc&&e.useVertexTexture){if(null!==h.boneTexture){var j=A();k.uniform1i(h.boneTexture,j);Q.setTexture(e.boneTexture,j)}}else null!==h.boneGlobalMatrices&&k.uniformMatrix4fv(h.boneGlobalMatrices,!1,e.boneMatrices);if(f){c&&d.fog&&(i.fogColor.value=
c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(vb){for(var m=0,n=0,l=0,p,r,s,q=Sc,t=q.directional.colors,u=q.directional.positions,y=q.point.colors,z=q.point.positions,C=q.point.distances,D=q.spot.colors,E=q.spot.positions,F=q.spot.distances,G=q.spot.directions,J=q.spot.anglesCos,R=q.spot.exponents,P=q.hemi.skyColors,
M=q.hemi.groundColors,N=q.hemi.positions,ba=0,Y=0,O=0,U=0,$=0,ma=0,la=0,Ea=0,S=r=0,c=S=S=0,f=b.length;c<f;c++)j=b[c],j.onlyShadow||(p=j.color,s=j.intensity,r=j.distance,j instanceof THREE.AmbientLight?j.visible&&(Q.gammaInput?(m+=p.r*p.r,n+=p.g*p.g,l+=p.b*p.b):(m+=p.r,n+=p.g,l+=p.b)):j instanceof THREE.DirectionalLight?($+=1,j.visible&&(r=3*ba,Q.gammaInput?v(t,r,p,s*s):I(t,r,p,s),Sa.copy(j.matrixWorld.getPosition()),Sa.subSelf(j.target.matrixWorld.getPosition()),Sa.normalize(),u[r]=Sa.x,u[r+1]=Sa.y,
u[r+2]=Sa.z,ba+=1)):j instanceof THREE.PointLight?(ma+=1,j.visible&&(S=3*Y,Q.gammaInput?v(y,S,p,s*s):I(y,S,p,s),s=j.matrixWorld.getPosition(),z[S]=s.x,z[S+1]=s.y,z[S+2]=s.z,C[Y]=r,Y+=1)):j instanceof THREE.SpotLight?(la+=1,j.visible&&(S=3*O,Q.gammaInput?v(D,S,p,s*s):I(D,S,p,s),s=j.matrixWorld.getPosition(),E[S]=s.x,E[S+1]=s.y,E[S+2]=s.z,F[O]=r,Sa.copy(s),Sa.subSelf(j.target.matrixWorld.getPosition()),Sa.normalize(),G[S]=Sa.x,G[S+1]=Sa.y,G[S+2]=Sa.z,J[O]=Math.cos(j.angle),R[O]=j.exponent,O+=1)):j instanceof
THREE.HemisphereLight&&(Ea+=1,j.visible&&(p=j.color,r=j.groundColor,S=3*U,Q.gammaInput?(s*=s,v(P,S,p,s),v(M,S,r,s)):(I(P,S,p,s),I(M,S,r,s)),Sa.copy(j.matrixWorld.getPosition()),Sa.normalize(),N[S]=Sa.x,N[S+1]=Sa.y,N[S+2]=Sa.z,U+=1)));c=3*ba;for(f=Math.max(t.length,3*$);c<f;c++)t[c]=0;c=3*ba;for(f=Math.max(u.length,3*$);c<f;c++)u[c]=0;c=3*Y;for(f=Math.max(y.length,3*ma);c<f;c++)y[c]=0;c=3*Y;for(f=Math.max(z.length,3*ma);c<f;c++)z[c]=0;c=Y;for(f=Math.max(C.length,ma);c<f;c++)C[c]=0;c=3*O;for(f=Math.max(D.length,
3*la);c<f;c++)D[c]=0;c=3*O;for(f=Math.max(E.length,3*la);c<f;c++)E[c]=0;c=3*O;for(f=Math.max(G.length,3*la);c<f;c++)G[c]=0;c=O;for(f=Math.max(J.length,la);c<f;c++)J[c]=0;c=O;for(f=Math.max(R.length,la);c<f;c++)R[c]=0;c=O;for(f=Math.max(F.length,la);c<f;c++)F[c]=0;c=3*U;for(f=Math.max(P.length,3*Ea);c<f;c++)P[c]=0;c=3*U;for(f=Math.max(M.length,3*Ea);c<f;c++)M[c]=0;c=3*U;for(f=Math.max(N.length,3*Ea);c<f;c++)N[c]=0;q.directional.length=ba;q.point.length=Y;q.spot.length=O;q.hemi.length=U;q.ambient[0]=
m;q.ambient[1]=n;q.ambient[2]=l;vb=!1}c=Sc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=c.spot.directions;i.spotLightAngleCos.value=
...
this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var Q=this,R=[],ba=0,da=null,P=null,ja=-1,Y=null,ga=null,Ea=0,Va=0,ta=-1,pa=-1,ea=-1,Ha=-1,Db=-1,ub=-1,qb=-1,tb=-1,Kb=null,Lb=null,ab=null,za=null,Na=0,wb=0,Qa=0,kb=0,hb=0,xa=0,bb={},fb=new THREE.Frustum,mc=new THREE.Matrix4,ib=new THREE.Matrix4,
Eb=new THREE.Vector3,Sa=new THREE.Vector3,vb=!0,Sc={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Fb,rb;try{if(!(k=K.getContext("experimental-webgl",{alpha:O,premultipliedAlpha:$,antialias:wa,stencil:N,preserveDrawingBuffer:ma})))throw"Error creating WebGL context.";}catch(ld){console.error(ld)}a=
k.getExtension("OES_texture_float");O=k.getExtension("OES_standard_derivatives");Fb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");rb=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");a||console.log("THREE.WebGLRenderer: Float textures not supported.");O||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");
...
f instanceof THREE.Ribbon&&(k.drawArrays(k.TRIANGLE_STRIP,0,e.__webglVertexCount),Q.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,i=a.__lights,j=a.fog;ja=-1;vb=!0;this.autoUpdateScene&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b.matrixWorldInverse.getInverse(b.matrixWorld);mc.multiply(b.projectionMatrix,b.matrixWorldInverse);fb.setFromMatrix(mc);
this.autoUpdateObjects&&this.initWebGLObjects(a);r(this.renderPluginsPre,a,b);Q.info.render.calls=0;Q.info.render.vertices=0;Q.info.render.faces=0;Q.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.render=!1,g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||fb.contains(g))){z(g,b);var m=f,n=m.buffer,
...
a.__objectsAdded[0],j=a,m=void 0,l=void 0,p=void 0,r=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,b instanceof THREE.Mesh)if(l=b.geometry,p=b.material,l instanceof THREE.Geometry){if(void 0===l.geometryGroups){var s=l,v=void 0,z=void 0,A=void 0,B=void 0,D=void 0,C=void 0,F={},G=s.morphTargets.length,I=s.morphNormals.length,J=p instanceof THREE.MeshFaceMaterial;s.geometryGroups={};v=0;for(z=s.faces.length;v<z;v++)A=s.faces[v],B=
J?A.materialIndex:0,void 0===F[B]&&(F[B]={hash:B,counter:0}),C=F[B].hash+"_"+F[B].counter,void 0===s.geometryGroups[C]&&(s.geometryGroups[C]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:G,numMorphNormals:I}),D=A instanceof THREE.Face3?3:4,65535<s.geometryGroups[C].vertices+D&&(F[B].counter+=1,C=F[B].hash+"_"+F[B].counter,void 0===s.geometryGroups[C]&&(s.geometryGroups[C]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:G,numMorphNormals:I})),A instanceof THREE.Face3?
s.geometryGroups[C].faces3.push(v):s.geometryGroups[C].faces4.push(v),s.geometryGroups[C].vertices+=D;s.geometryGroupsList=[];var R=void 0;for(R in s.geometryGroups)s.geometryGroups[R].id=Ea++,s.geometryGroupsList.push(s.geometryGroups[R])}for(m in l.geometryGroups)if(r=l.geometryGroups[m],!r.__webglVertexBuffer){var P=r;P.__webglVertexBuffer=k.createBuffer();P.__webglNormalBuffer=k.createBuffer();P.__webglTangentBuffer=k.createBuffer();P.__webglColorBuffer=k.createBuffer();P.__webglUVBuffer=k.createBuffer();
...
d(r,b);l.verticesNeedUpdate=!0;l.morphTargetsNeedUpdate=!0;l.elementsNeedUpdate=!0;l.uvsNeedUpdate=!0;l.normalsNeedUpdate=!0;l.tangentsNeedUpdate=!0;l.colorsNeedUpdate=!0}}else l instanceof THREE.BufferGeometry&&h(l);else if(b instanceof THREE.Ribbon){if(l=b.geometry,!l.__webglVertexBuffer){var M=l;M.__webglVertexBuffer=k.createBuffer();M.__webglColorBuffer=k.createBuffer();M.__webglNormalBuffer=k.createBuffer();Q.info.memory.geometries++;var N=l,Y=b,ba=N.vertices.length;N.__vertexArray=new Float32Array(3*
ba);N.__colorArray=new Float32Array(3*ba);N.__normalArray=new Float32Array(3*ba);N.__webglVertexCount=ba;c(N,Y);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=!0;l.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(l=b.geometry,!l.__webglVertexBuffer){var O=l;O.__webglVertexBuffer=k.createBuffer();O.__webglColorBuffer=k.createBuffer();O.__webglLineDistanceBuffer=k.createBuffer();Q.info.memory.geometries++;var da=l,ga=b,U=da.vertices.length;da.__vertexArray=new Float32Array(3*U);da.__colorArray=
...
la);ea.__sortArray=[];ea.__webglParticleCount=la;c(ea,ma);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=!0}else l instanceof THREE.BufferGeometry&&h(l);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(l=b.geometry,l instanceof THREE.BufferGeometry)t(j.__webglObjects,l,b);else for(m in l.geometryGroups)r=l.geometryGroups[m],t(j.__webglObjects,r,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(l=b.geometry,t(j.__webglObjects,l,b)):b instanceof THREE.ImmediateRenderObject||
b.immediateRenderCallback?j.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof THREE.Sprite?j.__webglSprites.push(b):b instanceof THREE.LensFlare&&j.__webglFlares.push(b);b.__webglActive=!0}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var $=a.__objectsRemoved[0],Ma=a;$ instanceof THREE.Mesh||$ instanceof THREE.ParticleSystem||$ instanceof THREE.Ribbon||$ instanceof THREE.Line?y(Ma.__webglObjects,$):$ instanceof THREE.Sprite?q(Ma.__webglSprites,$):$ instanceof
THREE.LensFlare?q(Ma.__webglFlares,$):($ instanceof THREE.ImmediateRenderObject||$.immediateRenderCallback)&&y(Ma.__webglObjectsImmediate,$);$.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var wa=0,Va=a.__webglObjects.length;wa<Va;wa++){var ta=a.__webglObjects[wa].object,S=ta.geometry,za=void 0,xa=void 0,pa=void 0;if(ta instanceof THREE.Mesh)if(S instanceof THREE.BufferGeometry)(S.verticesNeedUpdate||S.elementsNeedUpdate||S.uvsNeedUpdate||S.normalsNeedUpdate||S.colorsNeedUpdate||S.tangentsNeedUpdate)&&
...
ub=!S.dynamic,ab=pa;if(sa.__inittedArrays){var Db=f(ab),qb=ab.vertexColors?ab.vertexColors:!1,tb=g(ab),kb=Db===THREE.SmoothShading,H=void 0,Z=void 0,bb=void 0,T=void 0,hb=void 0,fb=void 0,Mb=void 0,wb=void 0,gc=void 0,rb=void 0,vb=void 0,V=void 0,W=void 0,X=void 0,ra=void 0,Nb=void 0,Ob=void 0,Pb=void 0,Fb=void 0,Qb=void 0,Rb=void 0,Sb=void 0,Kb=void 0,Tb=void 0,Ub=void 0,Vb=void 0,Lb=void 0,Wb=void 0,Xb=void 0,Yb=void 0,Hc=void 0,Zb=void 0,$b=void 0,ac=void 0,Ic=void 0,ya=void 0,xc=void 0,oc=void 0,
Bc=void 0,Cc=void 0,Wa=void 0,yc=void 0,Ta=void 0,Ua=void 0,pc=void 0,hc=void 0,Oa=0,Ra=0,ic=0,jc=0,zb=0,cb=0,Ca=0,gb=0,Pa=0,fa=0,ka=0,x=0,Aa=void 0,Xa=sa.__vertexArray,Jc=sa.__uvArray,Kc=sa.__uv2Array,Ab=sa.__normalArray,Ia=sa.__tangentArray,Ya=sa.__colorArray,Ja=sa.__skinIndexArray,Ka=sa.__skinWeightArray,nd=sa.__morphTargetsArrays,od=sa.__morphNormalsArrays,pd=sa.__webglCustomAttributesList,w=void 0,bc=sa.__faceArray,sb=sa.__lineArray,mb=Sa.geometry,Sc=mb.elementsNeedUpdate,Gc=mb.uvsNeedUpdate,
Tc=mb.normalsNeedUpdate,kd=mb.tangentsNeedUpdate,ld=mb.colorsNeedUpdate,Jd=mb.morphTargetsNeedUpdate,tc=mb.vertices,ua=sa.faces3,va=sa.faces4,db=mb.faces,qd=mb.faceVertexUvs[0],rd=mb.faceVertexUvs[1],uc=mb.skinIndices,qc=mb.skinWeights,rc=mb.morphTargets,Vc=mb.morphNormals;if(mb.verticesNeedUpdate){H=0;for(Z=ua.length;H<Z;H++)T=db[ua[H]],V=tc[T.a],W=tc[T.b],X=tc[T.c],Xa[Ra]=V.x,Xa[Ra+1]=V.y,Xa[Ra+2]=V.z,Xa[Ra+3]=W.x,Xa[Ra+4]=W.y,Xa[Ra+5]=W.z,Xa[Ra+6]=X.x,Xa[Ra+7]=X.y,Xa[Ra+8]=X.z,Ra+=9;H=0;for(Z=
va.length;H<Z;H++)T=db[va[H]],V=tc[T.a],W=tc[T.b],X=tc[T.c],ra=tc[T.d],Xa[Ra]=V.x,Xa[Ra+1]=V.y,Xa[Ra+2]=V.z,Xa[Ra+3]=W.x,Xa[Ra+4]=W.y,Xa[Ra+5]=W.z,Xa[Ra+6]=X.x,Xa[Ra+7]=X.y,Xa[Ra+8]=X.z,Xa[Ra+9]=ra.x,Xa[Ra+10]=ra.y,Xa[Ra+11]=ra.z,Ra+=12;k.bindBuffer(k.ARRAY_BUFFER,sa.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Xa,Ha)}if(Jd){Wa=0;for(yc=rc.length;Wa<yc;Wa++){H=ka=0;for(Z=ua.length;H<Z;H++)pc=ua[H],T=db[pc],V=rc[Wa].vertices[T.a],W=rc[Wa].vertices[T.b],X=rc[Wa].vertices[T.c],Ta=nd[Wa],Ta[ka]=V.x,
Ta[ka+1]=V.y,Ta[ka+2]=V.z,Ta[ka+3]=W.x,Ta[ka+4]=W.y,Ta[ka+5]=W.z,Ta[ka+6]=X.x,Ta[ka+7]=X.y,Ta[ka+8]=X.z,ab.morphNormals&&(kb?(hc=Vc[Wa].vertexNormals[pc],Qb=hc.a,Rb=hc.b,Sb=hc.c):Sb=Rb=Qb=Vc[Wa].faceNormals[pc],Ua=od[Wa],Ua[ka]=Qb.x,Ua[ka+1]=Qb.y,Ua[ka+2]=Qb.z,Ua[ka+3]=Rb.x,Ua[ka+4]=Rb.y,Ua[ka+5]=Rb.z,Ua[ka+6]=Sb.x,Ua[ka+7]=Sb.y,Ua[ka+8]=Sb.z),ka+=9;H=0;for(Z=va.length;H<Z;H++)pc=va[H],T=db[pc],V=rc[Wa].vertices[T.a],W=rc[Wa].vertices[T.b],X=rc[Wa].vertices[T.c],ra=rc[Wa].vertices[T.d],Ta=nd[Wa],
...
k.bufferData(k.ARRAY_BUFFER,nd[Wa],Ha);ab.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,sa.__webglMorphNormalsBuffers[Wa]),k.bufferData(k.ARRAY_BUFFER,od[Wa],Ha))}}if(qc.length){H=0;for(Z=ua.length;H<Z;H++)T=db[ua[H]],Wb=qc[T.a],Xb=qc[T.b],Yb=qc[T.c],Ka[fa]=Wb.x,Ka[fa+1]=Wb.y,Ka[fa+2]=Wb.z,Ka[fa+3]=Wb.w,Ka[fa+4]=Xb.x,Ka[fa+5]=Xb.y,Ka[fa+6]=Xb.z,Ka[fa+7]=Xb.w,Ka[fa+8]=Yb.x,Ka[fa+9]=Yb.y,Ka[fa+10]=Yb.z,Ka[fa+11]=Yb.w,Zb=uc[T.a],$b=uc[T.b],ac=uc[T.c],Ja[fa]=Zb.x,Ja[fa+1]=Zb.y,Ja[fa+2]=Zb.z,Ja[fa+3]=Zb.w,
Ja[fa+4]=$b.x,Ja[fa+5]=$b.y,Ja[fa+6]=$b.z,Ja[fa+7]=$b.w,Ja[fa+8]=ac.x,Ja[fa+9]=ac.y,Ja[fa+10]=ac.z,Ja[fa+11]=ac.w,fa+=12;H=0;for(Z=va.length;H<Z;H++)T=db[va[H]],Wb=qc[T.a],Xb=qc[T.b],Yb=qc[T.c],Hc=qc[T.d],Ka[fa]=Wb.x,Ka[fa+1]=Wb.y,Ka[fa+2]=Wb.z,Ka[fa+3]=Wb.w,Ka[fa+4]=Xb.x,Ka[fa+5]=Xb.y,Ka[fa+6]=Xb.z,Ka[fa+7]=Xb.w,Ka[fa+8]=Yb.x,Ka[fa+9]=Yb.y,Ka[fa+10]=Yb.z,Ka[fa+11]=Yb.w,Ka[fa+12]=Hc.x,Ka[fa+13]=Hc.y,Ka[fa+14]=Hc.z,Ka[fa+15]=Hc.w,Zb=uc[T.a],$b=uc[T.b],ac=uc[T.c],Ic=uc[T.d],Ja[fa]=Zb.x,Ja[fa+1]=Zb.y,
Ja[fa+2]=Zb.z,Ja[fa+3]=Zb.w,Ja[fa+4]=$b.x,Ja[fa+5]=$b.y,Ja[fa+6]=$b.z,Ja[fa+7]=$b.w,Ja[fa+8]=ac.x,Ja[fa+9]=ac.y,Ja[fa+10]=ac.z,Ja[fa+11]=ac.w,Ja[fa+12]=Ic.x,Ja[fa+13]=Ic.y,Ja[fa+14]=Ic.z,Ja[fa+15]=Ic.w,fa+=16;0<fa&&(k.bindBuffer(k.ARRAY_BUFFER,sa.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ja,Ha),k.bindBuffer(k.ARRAY_BUFFER,sa.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ka,Ha))}if(ld&&qb){H=0;for(Z=ua.length;H<Z;H++)T=db[ua[H]],Mb=T.vertexColors,wb=T.color,3===Mb.length&&qb===
THREE.VertexColors?(Tb=Mb[0],Ub=Mb[1],Vb=Mb[2]):Vb=Ub=Tb=wb,Ya[Pa]=Tb.r,Ya[Pa+1]=Tb.g,Ya[Pa+2]=Tb.b,Ya[Pa+3]=Ub.r,Ya[Pa+4]=Ub.g,Ya[Pa+5]=Ub.b,Ya[Pa+6]=Vb.r,Ya[Pa+7]=Vb.g,Ya[Pa+8]=Vb.b,Pa+=9;H=0;for(Z=va.length;H<Z;H++)T=db[va[H]],Mb=T.vertexColors,wb=T.color,4===Mb.length&&qb===THREE.VertexColors?(Tb=Mb[0],Ub=Mb[1],Vb=Mb[2],Lb=Mb[3]):Lb=Vb=Ub=Tb=wb,Ya[Pa]=Tb.r,Ya[Pa+1]=Tb.g,Ya[Pa+2]=Tb.b,Ya[Pa+3]=Ub.r,Ya[Pa+4]=Ub.g,Ya[Pa+5]=Ub.b,Ya[Pa+6]=Vb.r,Ya[Pa+7]=Vb.g,Ya[Pa+8]=Vb.b,Ya[Pa+9]=Lb.r,Ya[Pa+10]=Lb.g,
Ya[Pa+11]=Lb.b,Pa+=12;0<Pa&&(k.bindBuffer(k.ARRAY_BUFFER,sa.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Ya,Ha))}if(kd&&mb.hasTangents){H=0;for(Z=ua.length;H<Z;H++)T=db[ua[H]],gc=T.vertexTangents,Nb=gc[0],Ob=gc[1],Pb=gc[2],Ia[Ca]=Nb.x,Ia[Ca+1]=Nb.y,Ia[Ca+2]=Nb.z,Ia[Ca+3]=Nb.w,Ia[Ca+4]=Ob.x,Ia[Ca+5]=Ob.y,Ia[Ca+6]=Ob.z,Ia[Ca+7]=Ob.w,Ia[Ca+8]=Pb.x,Ia[Ca+9]=Pb.y,Ia[Ca+10]=Pb.z,Ia[Ca+11]=Pb.w,Ca+=12;H=0;for(Z=va.length;H<Z;H++)T=db[va[H]],gc=T.vertexTangents,Nb=gc[0],Ob=gc[1],Pb=gc[2],Fb=gc[3],Ia[Ca]=
Nb.x,Ia[Ca+1]=Nb.y,Ia[Ca+2]=Nb.z,Ia[Ca+3]=Nb.w,Ia[Ca+4]=Ob.x,Ia[Ca+5]=Ob.y,Ia[Ca+6]=Ob.z,Ia[Ca+7]=Ob.w,Ia[Ca+8]=Pb.x,Ia[Ca+9]=Pb.y,Ia[Ca+10]=Pb.z,Ia[Ca+11]=Pb.w,Ia[Ca+12]=Fb.x,Ia[Ca+13]=Fb.y,Ia[Ca+14]=Fb.z,Ia[Ca+15]=Fb.w,Ca+=16;k.bindBuffer(k.ARRAY_BUFFER,sa.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Ia,Ha)}if(Tc&&Db){H=0;for(Z=ua.length;H<Z;H++)if(T=db[ua[H]],hb=T.vertexNormals,fb=T.normal,3===hb.length&&kb)for(ya=0;3>ya;ya++)oc=hb[ya],Ab[cb]=oc.x,Ab[cb+1]=oc.y,Ab[cb+2]=oc.z,cb+=3;else for(ya=
0;3>ya;ya++)Ab[cb]=fb.x,Ab[cb+1]=fb.y,Ab[cb+2]=fb.z,cb+=3;H=0;for(Z=va.length;H<Z;H++)if(T=db[va[H]],hb=T.vertexNormals,fb=T.normal,4===hb.length&&kb)for(ya=0;4>ya;ya++)oc=hb[ya],Ab[cb]=oc.x,Ab[cb+1]=oc.y,Ab[cb+2]=oc.z,cb+=3;else for(ya=0;4>ya;ya++)Ab[cb]=fb.x,Ab[cb+1]=fb.y,Ab[cb+2]=fb.z,cb+=3;k.bindBuffer(k.ARRAY_BUFFER,sa.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,Ab,Ha)}if(Gc&&qd&&tb){H=0;for(Z=ua.length;H<Z;H++)if(bb=ua[H],rb=qd[bb],void 0!==rb)for(ya=0;3>ya;ya++)Bc=rb[ya],Jc[ic]=Bc.x,Jc[ic+
1]=Bc.y,ic+=2;H=0;for(Z=va.length;H<Z;H++)if(bb=va[H],rb=qd[bb],void 0!==rb)for(ya=0;4>ya;ya++)Bc=rb[ya],Jc[ic]=Bc.x,Jc[ic+1]=Bc.y,ic+=2;0<ic&&(k.bindBuffer(k.ARRAY_BUFFER,sa.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,Jc,Ha))}if(Gc&&rd&&tb){H=0;for(Z=ua.length;H<Z;H++)if(bb=ua[H],vb=rd[bb],void 0!==vb)for(ya=0;3>ya;ya++)Cc=vb[ya],Kc[jc]=Cc.x,Kc[jc+1]=Cc.y,jc+=2;H=0;for(Z=va.length;H<Z;H++)if(bb=va[H],vb=rd[bb],void 0!==vb)for(ya=0;4>ya;ya++)Cc=vb[ya],Kc[jc]=Cc.x,Kc[jc+1]=Cc.y,jc+=2;0<jc&&(k.bindBuffer(k.ARRAY_BUFFER,
sa.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,Kc,Ha))}if(Sc){H=0;for(Z=ua.length;H<Z;H++)bc[zb]=Oa,bc[zb+1]=Oa+1,bc[zb+2]=Oa+2,zb+=3,sb[gb]=Oa,sb[gb+1]=Oa+1,sb[gb+2]=Oa,sb[gb+3]=Oa+2,sb[gb+4]=Oa+1,sb[gb+5]=Oa+2,gb+=6,Oa+=3;H=0;for(Z=va.length;H<Z;H++)bc[zb]=Oa,bc[zb+1]=Oa+1,bc[zb+2]=Oa+3,bc[zb+3]=Oa+1,bc[zb+4]=Oa+2,bc[zb+5]=Oa+3,zb+=6,sb[gb]=Oa,sb[gb+1]=Oa+1,sb[gb+2]=Oa,sb[gb+3]=Oa+3,sb[gb+4]=Oa+1,sb[gb+5]=Oa+2,sb[gb+6]=Oa+2,sb[gb+7]=Oa+3,gb+=8,Oa+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,sa.__webglFaceBuffer);
k.bufferData(k.ELEMENT_ARRAY_BUFFER,bc,Ha);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,sa.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,sb,Ha)}if(pd){ya=0;for(xc=pd.length;ya<xc;ya++)if(w=pd[ya],w.__original.needsUpdate){x=0;if(1===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)T=db[ua[H]],w.array[x]=w.value[T.a],w.array[x+1]=w.value[T.b],w.array[x+2]=w.value[T.c],x+=3;H=0;for(Z=va.length;H<Z;H++)T=db[va[H]],w.array[x]=w.value[T.a],w.array[x+1]=w.value[T.b],w.array[x+
2]=w.value[T.c],w.array[x+3]=w.value[T.d],x+=4}else{if("faces"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)Aa=w.value[ua[H]],w.array[x]=Aa,w.array[x+1]=Aa,w.array[x+2]=Aa,x+=3;H=0;for(Z=va.length;H<Z;H++)Aa=w.value[va[H]],w.array[x]=Aa,w.array[x+1]=Aa,w.array[x+2]=Aa,w.array[x+3]=Aa,x+=4}}else if(2===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)T=db[ua[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=W.x,w.array[x+3]=W.y,
w.array[x+4]=X.x,w.array[x+5]=X.y,x+=6;H=0;for(Z=va.length;H<Z;H++)T=db[va[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],ra=w.value[T.d],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=W.x,w.array[x+3]=W.y,w.array[x+4]=X.x,w.array[x+5]=X.y,w.array[x+6]=ra.x,w.array[x+7]=ra.y,x+=8}else{if("faces"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)X=W=V=Aa=w.value[ua[H]],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=W.x,w.array[x+3]=W.y,w.array[x+4]=X.x,w.array[x+5]=X.y,x+=6;H=0;for(Z=va.length;H<Z;H++)ra=X=W=
V=Aa=w.value[va[H]],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=W.x,w.array[x+3]=W.y,w.array[x+4]=X.x,w.array[x+5]=X.y,w.array[x+6]=ra.x,w.array[x+7]=ra.y,x+=8}}else if(3===w.size){var ca;ca="c"===w.type?["r","g","b"]:["x","y","z"];if(void 0===w.boundTo||"vertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)T=db[ua[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+
6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],x+=9;H=0;for(Z=va.length;H<Z;H++)T=db[va[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],ra=w.value[T.d],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],w.array[x+9]=ra[ca[0]],w.array[x+10]=ra[ca[1]],w.array[x+11]=ra[ca[2]],x+=12}else if("faces"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)X=W=V=Aa=
w.value[ua[H]],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],x+=9;H=0;for(Z=va.length;H<Z;H++)ra=X=W=V=Aa=w.value[va[H]],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],w.array[x+9]=ra[ca[0]],w.array[x+10]=
ra[ca[1]],w.array[x+11]=ra[ca[2]],x+=12}else if("faceVertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)Aa=w.value[ua[H]],V=Aa[0],W=Aa[1],X=Aa[2],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],x+=9;H=0;for(Z=va.length;H<Z;H++)Aa=w.value[va[H]],V=Aa[0],W=Aa[1],X=Aa[2],ra=Aa[3],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=
W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],w.array[x+9]=ra[ca[0]],w.array[x+10]=ra[ca[1]],w.array[x+11]=ra[ca[2]],x+=12}}else if(4===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)T=db[ua[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+
9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,x+=12;H=0;for(Z=va.length;H<Z;H++)T=db[va[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],ra=w.value[T.d],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,w.array[x+12]=ra.x,w.array[x+13]=ra.y,w.array[x+14]=ra.z,w.array[x+15]=ra.w,x+=16}else if("faces"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)X=W=V=Aa=
w.value[ua[H]],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,x+=12;H=0;for(Z=va.length;H<Z;H++)ra=X=W=V=Aa=w.value[va[H]],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,w.array[x+12]=ra.x,
w.array[x+13]=ra.y,w.array[x+14]=ra.z,w.array[x+15]=ra.w,x+=16}else if("faceVertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)Aa=w.value[ua[H]],V=Aa[0],W=Aa[1],X=Aa[2],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,x+=12;H=0;for(Z=va.length;H<Z;H++)Aa=w.value[va[H]],V=Aa[0],W=Aa[1],X=Aa[2],ra=Aa[3],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=
V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,w.array[x+12]=ra.x,w.array[x+13]=ra.y,w.array[x+14]=ra.z,w.array[x+15]=ra.w,x+=16}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,Ha)}}ub&&(delete sa.__inittedArrays,delete sa.__colorArray,delete sa.__normalArray,delete sa.__tangentArray,delete sa.__uvArray,delete sa.__uv2Array,delete sa.__faceArray,delete sa.__vertexArray,
delete sa.__lineArray,delete sa.__skinIndexArray,delete sa.__skinWeightArray)}}S.verticesNeedUpdate=!1;S.morphTargetsNeedUpdate=!1;S.elementsNeedUpdate=!1;S.uvsNeedUpdate=!1;S.normalsNeedUpdate=!1;S.colorsNeedUpdate=!1;S.tangentsNeedUpdate=!1;S.buffersNeedUpdate=!1;pa.attributes&&E(pa)}else if(ta instanceof THREE.Ribbon){pa=e(ta,S);xa=pa.attributes&&u(pa);if(S.verticesNeedUpdate||S.colorsNeedUpdate||S.normalsNeedUpdate||xa){var Bb=S,Wc=k.DYNAMIC_DRAW,Lc=void 0,Mc=void 0,Nc=void 0,Xc=void 0,Ba=void 0,
Yc=void 0,Zc=void 0,$c=void 0,xd=void 0,Za=void 0,Dc=void 0,Fa=void 0,nb=void 0,yd=Bb.vertices,zd=Bb.colors,Ad=Bb.normals,Kd=yd.length,Ld=zd.length,Md=Ad.length,ad=Bb.__vertexArray,bd=Bb.__colorArray,cd=Bb.__normalArray,Nd=Bb.colorsNeedUpdate,Od=Bb.normalsNeedUpdate,sd=Bb.__webglCustomAttributesList;if(Bb.verticesNeedUpdate){for(Lc=0;Lc<Kd;Lc++)Xc=yd[Lc],Ba=3*Lc,ad[Ba]=Xc.x,ad[Ba+1]=Xc.y,ad[Ba+2]=Xc.z;k.bindBuffer(k.ARRAY_BUFFER,Bb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,ad,Wc)}if(Nd){for(Mc=
...
Fa.value[Za];else if(2===Fa.size)for(Za=0;Za<Dc;Za++)nb=Fa.value[Za],Fa.array[Ba]=nb.x,Fa.array[Ba+1]=nb.y,Ba+=2;else if(3===Fa.size)if("c"===Fa.type)for(Za=0;Za<Dc;Za++)nb=Fa.value[Za],Fa.array[Ba]=nb.r,Fa.array[Ba+1]=nb.g,Fa.array[Ba+2]=nb.b,Ba+=3;else for(Za=0;Za<Dc;Za++)nb=Fa.value[Za],Fa.array[Ba]=nb.x,Fa.array[Ba+1]=nb.y,Fa.array[Ba+2]=nb.z,Ba+=3;else if(4===Fa.size)for(Za=0;Za<Dc;Za++)nb=Fa.value[Za],Fa.array[Ba]=nb.x,Fa.array[Ba+1]=nb.y,Fa.array[Ba+2]=nb.z,Fa.array[Ba+3]=nb.w,Ba+=4;k.bindBuffer(k.ARRAY_BUFFER,
Fa.buffer);k.bufferData(k.ARRAY_BUFFER,Fa.array,Wc)}}}S.verticesNeedUpdate=!1;S.colorsNeedUpdate=!1;S.normalsNeedUpdate=!1;pa.attributes&&E(pa)}else if(ta instanceof THREE.Line){pa=e(ta,S);xa=pa.attributes&&u(pa);if(S.verticesNeedUpdate||S.colorsNeedUpdate||S.lineDistancesNeedUpdate||xa){var Cb=S,dd=k.DYNAMIC_DRAW,Oc=void 0,Pc=void 0,Qc=void 0,ed=void 0,La=void 0,fd=void 0,Bd=Cb.vertices,Cd=Cb.colors,Dd=Cb.lineDistances,Pd=Bd.length,Qd=Cd.length,Rd=Dd.length,gd=Cb.__vertexArray,hd=Cb.__colorArray,
Ed=Cb.__lineDistanceArray,Sd=Cb.colorsNeedUpdate,Td=Cb.lineDistancesNeedUpdate,td=Cb.__webglCustomAttributesList,id=void 0,Fd=void 0,$a=void 0,Ec=void 0,ob=void 0,Ga=void 0;if(Cb.verticesNeedUpdate){for(Oc=0;Oc<Pd;Oc++)ed=Bd[Oc],La=3*Oc,gd[La]=ed.x,gd[La+1]=ed.y,gd[La+2]=ed.z;k.bindBuffer(k.ARRAY_BUFFER,Cb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,gd,dd)}if(Sd){for(Pc=0;Pc<Qd;Pc++)fd=Cd[Pc],La=3*Pc,hd[La]=fd.r,hd[La+1]=fd.g,hd[La+2]=fd.b;k.bindBuffer(k.ARRAY_BUFFER,Cb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,
hd,dd)}if(Td){for(Qc=0;Qc<Rd;Qc++)Ed[Qc]=Dd[Qc];k.bindBuffer(k.ARRAY_BUFFER,Cb.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,Ed,dd)}if(td){id=0;for(Fd=td.length;id<Fd;id++)if(Ga=td[id],Ga.needsUpdate&&(void 0===Ga.boundTo||"vertices"===Ga.boundTo)){La=0;Ec=Ga.value.length;if(1===Ga.size)for($a=0;$a<Ec;$a++)Ga.array[$a]=Ga.value[$a];else if(2===Ga.size)for($a=0;$a<Ec;$a++)ob=Ga.value[$a],Ga.array[La]=ob.x,Ga.array[La+1]=ob.y,La+=2;else if(3===Ga.size)if("c"===Ga.type)for($a=0;$a<Ec;$a++)ob=
...
THREE.ParticleSystem)if(S instanceof THREE.BufferGeometry)(S.verticesNeedUpdate||S.colorsNeedUpdate)&&i(S,k.DYNAMIC_DRAW,!S.dynamic),S.verticesNeedUpdate=!1,S.colorsNeedUpdate=!1;else{pa=e(ta,S);xa=pa.attributes&&u(pa);if(S.verticesNeedUpdate||S.colorsNeedUpdate||ta.sortParticles||xa){var cc=S,ud=k.DYNAMIC_DRAW,Rc=ta,pb=void 0,dc=void 0,ec=void 0,ia=void 0,fc=void 0,sc=void 0,jd=cc.vertices,vd=jd.length,wd=cc.colors,Gd=wd.length,vc=cc.__vertexArray,wc=cc.__colorArray,kc=cc.__sortArray,Hd=cc.verticesNeedUpdate,
Id=cc.colorsNeedUpdate,lc=cc.__webglCustomAttributesList,Ib=void 0,Fc=void 0,qa=void 0,Jb=void 0,Da=void 0,ha=void 0;if(Rc.sortParticles){ib.copy(mc);ib.multiplySelf(Rc.matrixWorld);for(pb=0;pb<vd;pb++)ec=jd[pb],Eb.copy(ec),ib.multiplyVector3(Eb),kc[pb]=[Eb.z,pb];kc.sort(n);for(pb=0;pb<vd;pb++)ec=jd[kc[pb][1]],ia=3*pb,vc[ia]=ec.x,vc[ia+1]=ec.y,vc[ia+2]=ec.z;for(dc=0;dc<Gd;dc++)ia=3*dc,sc=wd[kc[dc][1]],wc[ia]=sc.r,wc[ia+1]=sc.g,wc[ia+2]=sc.b;if(lc){Ib=0;for(Fc=lc.length;Ib<Fc;Ib++)if(ha=lc[Ib],void 0===
...
2]=Da.z,ia+=3;else if(4===ha.size)for(qa=0;qa<Jb;qa++)fc=kc[qa][1],Da=ha.value[fc],ha.array[ia]=Da.x,ha.array[ia+1]=Da.y,ha.array[ia+2]=Da.z,ha.array[ia+3]=Da.w,ia+=4}}else{if(Hd)for(pb=0;pb<vd;pb++)ec=jd[pb],ia=3*pb,vc[ia]=ec.x,vc[ia+1]=ec.y,vc[ia+2]=ec.z;if(Id)for(dc=0;dc<Gd;dc++)sc=wd[dc],ia=3*dc,wc[ia]=sc.r,wc[ia+1]=sc.g,wc[ia+2]=sc.b;if(lc){Ib=0;for(Fc=lc.length;Ib<Fc;Ib++)if(ha=lc[Ib],ha.needsUpdate&&(void 0===ha.boundTo||"vertices"===ha.boundTo))if(Jb=ha.value.length,ia=0,1===ha.size)for(qa=
...
a.vertexShader=p.vertexShader;a.fragmentShader=p.fragmentShader}var r,s,q;e=g=s=q=p=0;for(f=b.length;e<f;e++)r=b[e],r.onlyShadow||(r instanceof THREE.DirectionalLight&&g++,r instanceof THREE.PointLight&&s++,r instanceof THREE.SpotLight&&q++,r instanceof THREE.HemisphereLight&&p++);e=g;f=s;g=q;h=p;p=r=0;for(q=b.length;p<q;p++)s=b[p],s.castShadow&&(s instanceof THREE.SpotLight&&r++,s instanceof THREE.DirectionalLight&&!s.shadowCascade&&r++);l=r;xc&&d&&d.useVertexTexture?m=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),
...
k.getError()+"]");k.deleteShader(t);k.deleteShader(u);v.uniforms={};v.attributes={};var y;t="viewMatrix modelViewMatrix projectionMatrix normalMatrix modelMatrix cameraPosition morphTargetInfluences".split(" ");c.useVertexTexture?t.push("boneTexture"):t.push("boneGlobalMatrices");for(y in p)t.push(y);y=t;t=0;for(u=y.length;t<u;t++)p=y[t],v.uniforms[p]=k.getUniformLocation(v,p);t="position normal uv uv2 tangent color skinIndex skinWeight lineDistance".split(" ");for(y=0;y<c.maxMorphTargets;y++)t.push("morphTarget"+
y);for(y=0;y<c.maxMorphNormals;y++)t.push("morphNormal"+y);for(j in b)t.push(j);j=t;y=0;for(b=j.length;y<b;y++)t=j[y],v.attributes[t]=k.getAttribLocation(v,t);v.id=ba++;R.push({program:v,code:n,usedTimes:1});Q.info.memory.programs=R.length;j=v}a.program=j;y=a.program.attributes;if(a.morphTargets){a.numSupportedMorphTargets=0;b="morphTarget";for(j=0;j<this.maxMorphTargets;j++)v=b+j,0<=y[v]&&a.numSupportedMorphTargets++}if(a.morphNormals){a.numSupportedMorphNormals=0;b="morphNormal";for(j=0;j<this.maxMorphNormals;j++)v=
b+j,0<=y[v]&&a.numSupportedMorphNormals++}a.uniformsList=[];for(i in a.uniforms)a.uniformsList.push([a.uniforms[i],i])};this.setFaceCulling=function(a,b){a===THREE.CullFaceNone?k.disable(k.CULL_FACE):(b===THREE.FrontFaceDirectionCW?k.frontFace(k.CW):k.frontFace(k.CCW),a===THREE.CullFaceBack?k.cullFace(k.BACK):a===THREE.CullFaceFront?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK),k.enable(k.CULL_FACE))};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,a=a.side===THREE.BackSide;ta!==
b&&(b?k.disable(k.CULL_FACE):k.enable(k.CULL_FACE),ta=b);pa!==a&&(a?k.frontFace(k.CW):k.frontFace(k.CCW),pa=a)};this.setDepthTest=function(a){qb!==a&&(a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST),qb=a)};this.setDepthWrite=function(a){tb!==a&&(k.depthMask(a),tb=a)};this.setBlending=function(a,b,c,d){a!==ea&&(a===THREE.NoBlending?k.disable(k.BLEND):a===THREE.AdditiveBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.SRC_ALPHA,k.ONE)):a===THREE.SubtractiveBlending?(k.enable(k.BLEND),
k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.SRC_COLOR)):a===THREE.CustomBlending?k.enable(k.BLEND):(k.enable(k.BLEND),k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD),k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)),ea=a);if(a===THREE.CustomBlending){if(b!==Ha&&(k.blendEquation(L(b)),Ha=b),c!==Db||d!==ub)k.blendFunc(L(c),L(d)),Db=c,ub=d}else ub=
Db=Ha=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.__webglTexture=k.createTexture(),Q.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);k.pixelStorei(k.UNPACK_ALIGNMENT,a.unpackAlignment);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=L(a.format),f=L(a.type);B(k.TEXTURE_2D,
...
a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=Qa,a=kb,d=Na,e=wb);b!==P&&(k.bindFramebuffer(k.FRAMEBUFFER,b),k.viewport(d,e,c,a),P=b);hb=c;xa=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);
...
b.push(j.clone());f.a=e;f.b=e+1;f.c=e+2;f.d=e+3}else g=f.a,h=f.b,i=f.c,g=a.vertices[g],h=a.vertices[h],i=a.vertices[i],b.push(g.clone()),b.push(h.clone()),b.push(i.clone()),f.a=e,f.b=e+1,f.c=e+2}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,e,f,g,h,i,j,m,p,n,r,s,l,t,u,E,y,q,F=[],A=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)A[c]=[];c=0;for(d=a.faces.length;c<d;c++)if(e=a.faces[c],e instanceof THREE.Face3)if(f=e.a,g=e.b,h=e.c,j=a.vertices[f],m=a.vertices[g],p=a.vertices[h],
r=j.distanceTo(m),s=m.distanceTo(p),n=j.distanceTo(p),r>b||s>b||n>b){i=a.vertices.length;y=e.clone();q=e.clone();r>=s&&r>=n?(j=j.clone(),j.lerpSelf(m,0.5),y.a=f,y.b=i,y.c=h,q.a=i,q.b=g,q.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),y.vertexNormals[1].copy(f),q.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),y.vertexColors[1].copy(f),q.vertexColors[0].copy(f)),e=0):s>=r&&s>=n?(j=
m.clone(),j.lerpSelf(p,0.5),y.a=f,y.b=g,y.c=i,q.a=i,q.b=h,q.c=f,3===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerpSelf(e.vertexNormals[2],0.5),y.vertexNormals[2].copy(f),q.vertexNormals[0].copy(f),q.vertexNormals[1].copy(e.vertexNormals[2]),q.vertexNormals[2].copy(e.vertexNormals[0])),3===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),y.vertexColors[2].copy(f),q.vertexColors[0].copy(f),q.vertexColors[1].copy(e.vertexColors[2]),q.vertexColors[2].copy(e.vertexColors[0])),
e=1):(j=j.clone(),j.lerpSelf(p,0.5),y.a=f,y.b=g,y.c=i,q.a=i,q.b=g,q.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[2],0.5),y.vertexNormals[2].copy(f),q.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[2],0.5),y.vertexColors[2].copy(f),q.vertexColors[0].copy(f)),e=2);F.push(y,q);a.vertices.push(j);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],q=j[0],h=
j[1],y=j[2],0===e?(m=q.clone(),m.lerpSelf(h,0.5),j=[q.clone(),m.clone(),y.clone()],h=[m.clone(),h.clone(),y.clone()]):1===e?(m=h.clone(),m.lerpSelf(y,0.5),j=[q.clone(),h.clone(),m.clone()],h=[m.clone(),y.clone(),q.clone()]):(m=q.clone(),m.lerpSelf(y,0.5),j=[q.clone(),h.clone(),m.clone()],h=[m.clone(),h.clone(),y.clone()]),A[f].push(j,h))}else{F.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,j=a.vertices[f],m=a.vertices[g],p=a.vertices[h],
n=a.vertices[i],r=j.distanceTo(m),s=m.distanceTo(p),l=p.distanceTo(n),t=j.distanceTo(n),r>b||s>b||l>b||t>b){u=a.vertices.length;E=a.vertices.length+1;y=e.clone();q=e.clone();r>=s&&r>=l&&r>=t||l>=s&&l>=r&&l>=t?(r=j.clone(),r.lerpSelf(m,0.5),m=p.clone(),m.lerpSelf(n,0.5),y.a=f,y.b=u,y.c=E,y.d=i,q.a=u,q.b=g,q.c=h,q.d=E,4===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),g=e.vertexNormals[2].clone(),g.lerpSelf(e.vertexNormals[3],0.5),y.vertexNormals[1].copy(f),
y.vertexNormals[2].copy(g),q.vertexNormals[0].copy(f),q.vertexNormals[3].copy(g)),4===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),g=e.vertexColors[2].clone(),g.lerpSelf(e.vertexColors[3],0.5),y.vertexColors[1].copy(f),y.vertexColors[2].copy(g),q.vertexColors[0].copy(f),q.vertexColors[3].copy(g)),e=0):(r=m.clone(),r.lerpSelf(p,0.5),m=n.clone(),m.lerpSelf(j,0.5),y.a=f,y.b=g,y.c=u,y.d=E,q.a=E,q.b=u,q.c=h,q.d=i,4===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),
f.lerpSelf(e.vertexNormals[2],0.5),g=e.vertexNormals[3].clone(),g.lerpSelf(e.vertexNormals[0],0.5),y.vertexNormals[2].copy(f),y.vertexNormals[3].copy(g),q.vertexNormals[0].copy(g),q.vertexNormals[1].copy(f)),4===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),g=e.vertexColors[3].clone(),g.lerpSelf(e.vertexColors[0],0.5),y.vertexColors[2].copy(f),y.vertexColors[3].copy(g),q.vertexColors[0].copy(g),q.vertexColors[1].copy(f)),e=1);F.push(y,q);a.vertices.push(r,m);
f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],q=j[0],h=j[1],y=j[2],j=j[3],0===e?(m=q.clone(),m.lerpSelf(h,0.5),p=y.clone(),p.lerpSelf(j,0.5),q=[q.clone(),m.clone(),p.clone(),j.clone()],h=[m.clone(),h.clone(),y.clone(),p.clone()]):(m=h.clone(),m.lerpSelf(y,0.5),p=j.clone(),p.lerpSelf(q,0.5),q=[q.clone(),h.clone(),m.clone(),p.clone()],h=[p.clone(),m.clone(),y.clone(),j.clone()]),A[f].push(q,h))}else{F.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}a.faces=
...
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],g=[],h=[],i,j,m;if(0<b(a))for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var p=2*e;for(j=e-1;2<e;){if(0>=p--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);m=j+1;e<=m&&(m=0);var n;a:{var r=n=void 0,s=void 0,l=void 0,t=void 0,u=void 0,E=void 0,y=void 0,q=
void 0,r=a[g[i]].x,s=a[g[i]].y,l=a[g[j]].x,t=a[g[j]].y,u=a[g[m]].x,E=a[g[m]].y;if(1E-10>(l-r)*(E-s)-(t-s)*(u-r))n=!1;else{var F=void 0,A=void 0,z=void 0,v=void 0,I=void 0,D=void 0,G=void 0,M=void 0,B=void 0,J=void 0,B=M=G=q=y=void 0,F=u-l,A=E-t,z=r-u,v=s-E,I=l-r,D=t-s;for(n=0;n<e;n++)if(!(n===i||n===j||n===m))if(y=a[g[n]].x,q=a[g[n]].y,G=y-r,M=q-s,B=y-l,J=q-t,y-=u,q-=E,B=F*J-A*B,G=I*M-D*G,M=z*q-v*y,0<=B&&0<=M&&0<=G){n=!1;break a}n=!0}}if(n){f.push([a[g[i]],a[g[j]],a[g[m]]]);h.push([g[i],g[j],g[m]]);
...
this.faceVertexUvs[0].push([f[e],f[e+1],g]);this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,a)};THREE.CircleGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,l){var t,u=h.widthSegments,E=h.heightSegments,y=e/2,q=f/2,F=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)t="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)t="y",E=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)t="x",u=h.depthSegments;var A=u+1,z=E+1,v=e/u,I=f/E,D=new THREE.Vector3;D[t]=0<g?1:-1;for(e=0;e<z;e++)for(f=0;f<A;f++){var G=new THREE.Vector3;G[a]=(f*v-y)*c;G[b]=(e*I-q)*d;G[t]=g;h.vertices.push(G)}for(e=
0;e<E;e++)for(f=0;f<u;f++)a=new THREE.Face4(f+A*e+F,f+A*(e+1)+F,f+1+A*(e+1)+F,f+1+A*e+F),a.normal.copy(D),a.vertexNormals.push(D.clone(),D.clone(),D.clone(),D.clone()),a.materialIndex=l,h.faces.push(a),h.faceVertexUvs[0].push([new THREE.Vector2(f/u,1-e/E),new THREE.Vector2(f/u,1-(e+1)/E),new THREE.Vector2((f+1)/u,1-(e+1)/E),new THREE.Vector2((f+1)/u,1-e/E)])}THREE.Geometry.call(this);var h=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=
...
n=this.vertices[j[0][h+1]].clone()):(p=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var r=j[i][h],s=j[i+1][h],l=j[i+1][h+1],t=j[i][h+1],u=p.clone(),E=p.clone(),y=n.clone(),q=n.clone(),F=m[i][h].clone(),A=m[i+1][h].clone(),z=m[i+1][h+1].clone(),v=m[i][h+1].clone();this.faces.push(new THREE.Face4(r,s,l,t,[u,E,y,q]));this.faceVertexUvs[0].push([F,A,z,v])}}if(!f&&0<
a){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++)r=j[0][h],s=j[0][h+1],l=this.vertices.length-1,u=new THREE.Vector3(0,1,0),E=new THREE.Vector3(0,1,0),y=new THREE.Vector3(0,1,0),F=m[0][h].clone(),A=m[0][h+1].clone(),z=new THREE.Vector2(A.u,0),this.faces.push(new THREE.Face3(r,s,l,[u,E,y])),this.faceVertexUvs[0].push([F,A,z])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)r=j[i][h+1],s=j[i][h],l=this.vertices.length-1,u=new THREE.Vector3(0,-1,0),E=new THREE.Vector3(0,
-1,0),y=new THREE.Vector3(0,-1,0),F=m[i][h+1].clone(),A=m[i][h].clone(),z=new THREE.Vector2(A.u,1),this.faces.push(new THREE.Face3(r,s,l,[u,E,y])),this.faceVertexUvs[0].push([F,A,z])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(a,b){for(var c=a.length,d=0;d<c;d++)this.addShape(a[d],b)};
...
for(var g=0,h=r+2*m,g=0;g<h;g++){var i=O*g,j=O*(g+1),l=d+e+i,i=d+f+i,n=d+f+j,j=d+e+j,p=c,s=g,q=h,t=e,u=f,l=l+M,i=i+M,n=n+M,j=j+M;G.faces.push(new THREE.Face4(l,i,n,j,null,null,E));l=y.generateSideWallUV(G,a,p,b,l,i,n,j,s,q,t,u);G.faceVertexUvs[0].push(l)}}}function f(a,b,c){G.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=M;d+=M;e+=M;G.faces.push(new THREE.Face3(c,d,e,null,null,u));c=f?y.generateBottomUV(G,a,b,c,d,e):y.generateTopUV(G,a,b,c,d,e);G.faceVertexUvs[0].push(c)}var h=void 0!==
b.amount?b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,m=void 0!==b.bevelSegments?b.bevelSegments:3,p=void 0!==b.bevelEnabled?b.bevelEnabled:!0,n=void 0!==b.curveSegments?b.curveSegments:12,r=void 0!==b.steps?b.steps:1,s=b.extrudePath,l,t=!1,u=b.material,E=b.extrudeMaterial,y=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,q,F,A,z;s&&(l=s.getSpacedPoints(r),t=!0,p=!1,q=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(s,
r,!1),F=new THREE.Vector3,A=new THREE.Vector3,z=new THREE.Vector3);p||(j=i=m=0);var v,I,D,G=this,M=this.vertices.length,n=a.extractPoints(n),B=n.shape,n=n.holes;if(s=!THREE.Shape.Utils.isClockWise(B)){B=B.reverse();I=0;for(D=n.length;I<D;I++)v=n[I],THREE.Shape.Utils.isClockWise(v)&&(n[I]=v.reverse());s=!1}var J=THREE.Shape.Utils.triangulateShape(B,n),s=B;I=0;for(D=n.length;I<D;I++)v=n[I],B=B.concat(v);var C,L,K,U,O=B.length,$=J.length,wa=[],N=0,ma=s.length;C=ma-1;for(L=N+1;N<ma;N++,C++,L++)C===ma&&
(C=0),L===ma&&(L=0),wa[N]=d(s[N],s[C],s[L]);var la=[],Ma,Q=wa.concat();I=0;for(D=n.length;I<D;I++){v=n[I];Ma=[];N=0;ma=v.length;C=ma-1;for(L=N+1;N<ma;N++,C++,L++)C===ma&&(C=0),L===ma&&(L=0),Ma[N]=d(v[N],v[C],v[L]);la.push(Ma);Q=Q.concat(Ma)}for(C=0;C<m;C++){v=C/m;K=i*(1-v);L=j*Math.sin(v*Math.PI/2);N=0;for(ma=s.length;N<ma;N++)U=c(s[N],wa[N],L),f(U.x,U.y,-K);I=0;for(D=n.length;I<D;I++){v=n[I];Ma=la[I];N=0;for(ma=v.length;N<ma;N++)U=c(v[N],Ma[N],L),f(U.x,U.y,-K)}}L=j;for(N=0;N<O;N++)U=p?c(B[N],Q[N],
L):B[N],t?(A.copy(q.normals[0]).multiplyScalar(U.x),F.copy(q.binormals[0]).multiplyScalar(U.y),z.copy(l[0]).addSelf(A).addSelf(F),f(z.x,z.y,z.z)):f(U.x,U.y,0);for(v=1;v<=r;v++)for(N=0;N<O;N++)U=p?c(B[N],Q[N],L):B[N],t?(A.copy(q.normals[v]).multiplyScalar(U.x),F.copy(q.binormals[v]).multiplyScalar(U.y),z.copy(l[v]).addSelf(A).addSelf(F),f(z.x,z.y,z.z)):f(U.x,U.y,h/r*v);for(C=m-1;0<=C;C--){v=C/m;K=i*(1-v);L=j*Math.sin(v*Math.PI/2);N=0;for(ma=s.length;N<ma;N++)U=c(s[N],wa[N],L),f(U.x,U.y,h+K);I=0;for(D=
n.length;I<D;I++){v=n[I];Ma=la[I];N=0;for(ma=v.length;N<ma;N++)U=c(v[N],Ma[N],L),t?f(U.x,U.y+l[r-1].y,l[r-1].x+K):f(U.x,U.y,h+K)}}if(p){i=0*O;for(N=0;N<$;N++)h=J[N],g(h[2]+i,h[1]+i,h[0]+i,!0);i=O*(r+2*m);for(N=0;N<$;N++)h=J[N],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(N=0;N<$;N++)h=J[N],g(h[2],h[1],h[0],!0);for(N=0;N<$;N++)h=J[N],g(h[0]+O*r,h[1]+O*r,h[2]+O*r,!1)}h=0;e(s,h);h+=s.length;I=0;for(D=n.length;I<D;I++)v=n[I],e(v,h),h+=v.length};
...
1],p.r+=q.r,p.g+=q.g,p.b+=q.b;p.r/=r.length;p.g/=r.length;p.b/=r.length;n.vertexColors[s]=p}}i.push(n);m.supportUVs&&(g=[f(a,""),f(b,l),f(d,l),f(e,l)],g[0]?g[1]?g[2]?g[3]?j.push(g):c("d :( ",e+":"+l):c("c :( ",d+":"+l):c("b :( ",b+":"+l):c("a :( ",a+":"+l))}function f(a,b){var e=a+":"+b,f=y[e];return!f?(a>=l&&a<l+s.length?c("face pt"):c("edge pt"),d("warning, UV not found for",e),null):f}function g(a,b,c){var e=a+":"+b;e in y?d("dup vertexNo",a,"oldFaceNo",b,"value",c,"key",e,y[e]):y[e]=c}var h=[],
i=[],j=[],m=this,p=THREE.GeometryUtils.orderedKey,n=THREE.GeometryUtils.computeEdgeFaces,r=a.vertices,s=a.faces,l=r.length,h=r.concat(),t=[],u={},E={},y={},q,F,A,z,v,I=a.faceVertexUvs[0],D;c("originalFaces, uvs, originalVerticesLength",s.length,I.length,l);if(m.supportUVs){q=0;for(F=I.length;q<F;q++){A=0;for(z=I[q].length;A<z;A++)D=s[q]["abcd".charAt(A)],g(D,q,I[q][A])}}0==I.length&&(m.supportUVs=!1);q=0;for(var G in y)q++;q||(m.supportUVs=!1,c("no uvs"));q=0;for(F=s.length;q<F;q++)v=s[q],t.push(v.centroid),
h.push(v.centroid),m.supportUVs&&(z=new THREE.Vector2,v instanceof THREE.Face3?(z.x=f(v.a,q).x+f(v.b,q).x+f(v.c,q).x,z.y=f(v.a,q).y+f(v.b,q).y+f(v.c,q).y,z.x/=3,z.y/=3):v instanceof THREE.Face4&&(z.x=f(v.a,q).x+f(v.b,q).x+f(v.c,q).x+f(v.d,q).x,z.y=f(v.a,q).y+f(v.b,q).y+f(v.c,q).y+f(v.d,q).y,z.x/=4,z.y/=4),g(l+q,"",z));var n=n(a),M;F=0;var B,J;G={};I={};for(q in n){D=n[q];B=q.split("_");J=B[0];B=B[1];A=J;v=[J,B];void 0===G[A]&&(G[A]=[]);G[A].push(v);A=B;v=[J,B];void 0===G[A]&&(G[A]=[]);G[A].push(v);
A=0;for(z=D.length;A<z;A++){v=D[A];M=J;var C=v,L=q;void 0===I[M]&&(I[M]={});I[M][C]=L;M=B;C=q;void 0===I[M]&&(I[M]={});I[M][v]=C}2>D.length&&(E[q]=!0)}for(q in n)D=n[q],v=D[0],M=D[1],B=q.split("_"),J=B[0],B=B[1],z=new THREE.Vector3,b(0<D.length,"an edge without faces?!"),1==D.length?(z.addSelf(r[J]),z.addSelf(r[B]),z.multiplyScalar(0.5)):(z.addSelf(t[v]),z.addSelf(t[M]),z.addSelf(r[J]),z.addSelf(r[B]),z.multiplyScalar(0.25)),u[q]=l+s.length+F,h.push(z),F++,m.supportUVs&&(z=new THREE.Vector2,z.x=f(J,
v).x+f(B,v).x,z.y=f(J,v).y+f(B,v).y,z.x/=2,z.y/=2,g(u[q],v,z),2<=D.length&&(b(2==D.length,"did we plan for more than 2 edges?"),z=new THREE.Vector2,z.x=f(J,M).x+f(B,M).x,z.y=f(J,M).y+f(B,M).y,z.x/=2,z.y/=2,g(u[q],M,z)));c("-- Step 2 done");var K,U;z=["123","12","2","23"];M=["123","23","3","31"];var C=["123","31","1","12"],L=["1234","12","2","23"],O=["1234","23","3","34"],$=["1234","34","4","41"],wa=["1234","41","1","12"];q=0;for(F=t.length;q<F;q++)v=s[q],D=l+q,v instanceof THREE.Face3?(J=p(v.a,v.b),
B=p(v.b,v.c),K=p(v.c,v.a),e(D,u[J],v.b,u[B],v,z,q),e(D,u[B],v.c,u[K],v,M,q),e(D,u[K],v.a,u[J],v,C,q)):v instanceof THREE.Face4?(J=p(v.a,v.b),B=p(v.b,v.c),K=p(v.c,v.d),U=p(v.d,v.a),e(D,u[J],v.b,u[B],v,L,q),e(D,u[B],v.c,u[K],v,O,q),e(D,u[K],v.d,u[U],v,$,q),e(D,u[U],v.a,u[J],v,wa,q)):c("face should be a face!",v);u=new THREE.Vector3;v=new THREE.Vector3;q=0;for(F=r.length;q<F;q++)if(void 0!==G[q]){u.set(0,0,0);v.set(0,0,0);B=new THREE.Vector3(0,0,0);D=0;for(A in I[q])u.addSelf(t[A]),D++;M=0;J=G[q].length;
z=D!=J;for(A=0;A<J;A++)E[p(G[q][A][0],G[q][A][1])]&&M++;u.divideScalar(D);M=0;if(z){for(A=0;A<J;A++)if(D=G[q][A],C=1==n[p(D[0],D[1])].length)D=r[D[0]].clone().addSelf(r[D[1]]).divideScalar(2),v.addSelf(D),M++;v.divideScalar(4);b(2==M,"should have only 2 boundary edges")}else{for(A=0;A<J;A++)D=G[q][A],D=r[D[0]].clone().addSelf(r[D[1]]).divideScalar(2),v.addSelf(D);v.divideScalar(J)}B.addSelf(r[q]);z?(B.divideScalar(2),B.addSelf(v)):(B.multiplyScalar(J-3),B.addSelf(u),B.addSelf(v.multiplyScalar(2)),
...
"color");n.scale=b.getUniformLocation(m,"scale");n.rotation=b.getUniformLocation(m,"rotation");n.screenPosition=b.getUniformLocation(m,"screenPosition")};this.render=function(a,d,e,t){var a=a.__webglFlares,u=a.length;if(u){var E=new THREE.Vector3,y=t/e,q=0.5*e,F=0.5*t,A=16/t,z=new THREE.Vector2(A*y,A),v=new THREE.Vector3(1,1,0),I=new THREE.Vector2(1,1),D=n,A=p;b.useProgram(m);b.enableVertexAttribArray(p.vertex);b.enableVertexAttribArray(p.uv);b.uniform1i(D.occlusionMap,0);b.uniform1i(D.map,1);b.bindBuffer(b.ARRAY_BUFFER,
f);b.vertexAttribPointer(A.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(A.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var G,M,B,J,C;for(G=0;G<u;G++)if(A=16/t,z.set(A*y,A),J=a[G],E.set(J.matrixWorld.elements[12],J.matrixWorld.elements[13],J.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(E),d.projectionMatrix.multiplyVector3(E),v.copy(E),I.x=v.x*q+q,I.y=v.y*F+F,j||0<I.x&&I.x<e&&0<I.y&&I.y<t){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,
h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,I.x-8,I.y-8,16,16,0);b.uniform1i(D.renderType,0);b.uniform2f(D.scale,z.x,z.y);b.uniform3f(D.screenPosition,v.x,v.y,v.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,I.x-8,I.y-8,16,16,0);b.uniform1i(D.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,
6,b.UNSIGNED_SHORT,0);J.positionScreen.copy(v);J.customUpdateCallback?J.customUpdateCallback(J):J.updateLensFlares();b.uniform1i(D.renderType,2);b.enable(b.BLEND);M=0;for(B=J.lensFlares.length;M<B;M++)C=J.lensFlares[M],0.001<C.opacity&&0.001<C.scale&&(v.x=C.x,v.y=C.y,v.z=C.z,A=C.size*C.scale/t,z.x=A*y,z.y=A,b.uniform3f(D.screenPosition,v.x,v.y,v.z),b.uniform2f(D.scale,z.x,z.y),b.uniform1f(D.rotation,C.rotation),b.uniform1f(D.opacity,C.opacity),b.uniform3f(D.color,C.color.r,C.color.g,C.color.b),c.setBlending(C.blending,
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(m,p){var n,r,s,l,t,u,E,y,q,F=[];l=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFace===THREE.CullFaceFront?
...
A.shadowCameraBottom=q.shadowCameraBottom;A.shadowCameraTop=q.shadowCameraTop;A.shadowCameraVisible=q.shadowCameraVisible;A.shadowDarkness=q.shadowDarkness;A.shadowBias=q.shadowCascadeBias[E];A.shadowMapWidth=q.shadowCascadeWidth[E];A.shadowMapHeight=q.shadowCascadeHeight[E];A.pointsWorld=[];A.pointsFrustum=[];y=A.pointsWorld;u=A.pointsFrustum;for(var z=0;8>z;z++)y[z]=new THREE.Vector3,u[z]=new THREE.Vector3;y=q.shadowCascadeNearZ[E];q=q.shadowCascadeFarZ[E];u[0].set(-1,-1,y);u[1].set(1,-1,y);u[2].set(-1,
1,y);u[3].set(1,1,y);u[4].set(-1,-1,q);u[5].set(1,-1,q);u[6].set(-1,1,q);u[7].set(1,1,q);A.originalCamera=p;u=new THREE.Gyroscope;u.position=s.shadowCascadeOffset;u.add(A);u.add(A.target);p.add(u);s.shadowCascadeArray[t]=A;console.log("Created virtualLight",A)}E=s;y=t;q=E.shadowCascadeArray[y];q.position.copy(E.position);q.target.position.copy(E.target.position);q.lookAt(q.target);q.shadowCameraVisible=E.shadowCameraVisible;q.shadowDarkness=E.shadowDarkness;q.shadowBias=E.shadowCascadeBias[y];u=E.shadowCascadeNearZ[y];
E=E.shadowCascadeFarZ[y];q=q.pointsFrustum;q[0].z=u;q[1].z=u;q[2].z=u;q[3].z=u;q[4].z=E;q[5].z=E;q[6].z=E;q[7].z=E;F[l]=A;l++}else F[l]=s,l++;n=0;for(r=F.length;n<r;n++){s=F[n];s.shadowMap||(t=THREE.LinearFilter,b.shadowMapType===THREE.PCFSoftShadowMap&&(t=THREE.NearestFilter),s.shadowMap=new THREE.WebGLRenderTarget(s.shadowMapWidth,s.shadowMapHeight,{minFilter:t,magFilter:t,format:THREE.RGBAFormat}),s.shadowMapSize=new THREE.Vector2(s.shadowMapWidth,s.shadowMapHeight),s.shadowMatrix=new THREE.Matrix4);
...
!s.cameraHelper&&(s.cameraHelper=new THREE.CameraHelper(s.shadowCamera),s.shadowCamera.add(s.cameraHelper));if(s.isVirtual&&A.originalCamera==p){t=p;l=s.shadowCamera;u=s.pointsFrustum;q=s.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(E=0;8>E;E++)y=q[E],y.copy(u[E]),THREE.ShadowMapPlugin.__projector.unprojectVector(y,t),l.matrixWorldInverse.multiplyVector3(y),y.x<i.x&&(i.x=y.x),y.x>j.x&&(j.x=y.x),y.y<i.y&&(i.y=y.y),y.y>j.y&&(j.y=y.y),y.z<i.z&&(i.z=y.z),y.z>
j.z&&(j.z=y.z);l.left=i.x;l.right=j.x;l.top=j.y;l.bottom=i.y;l.updateProjectionMatrix()}l=s.shadowMap;u=s.shadowMatrix;t=s.shadowCamera;t.position.copy(s.matrixWorld.getPosition());t.lookAt(s.target.matrixWorld.getPosition());t.updateMatrixWorld();t.matrixWorldInverse.getInverse(t.matrixWorld);s.cameraHelper&&(s.cameraHelper.visible=s.shadowCameraVisible);s.shadowCameraVisible&&s.cameraHelper.update();u.set(0.5,0,0,0.5,0,0.5,0,0.5,0,0,0.5,0.5,0,0,0,1);u.multiplySelf(t.projectionMatrix);u.multiplySelf(t.matrixWorldInverse);
h.multiply(t.projectionMatrix,t.matrixWorldInverse);g.setFromMatrix(h);b.setRenderTarget(l);b.clear();q=m.__webglObjects;s=0;for(l=q.length;s<l;s++)if(E=q[s],u=E.object,E.render=!1,u.visible&&u.castShadow&&(!(u instanceof THREE.Mesh||u instanceof THREE.ParticleSystem)||!u.frustumCulled||g.contains(u)))u._modelViewMatrix.multiply(t.matrixWorldInverse,u.matrixWorld),E.render=!0;s=0;for(l=q.length;s<l;s++)E=q[s],E.render&&(u=E.object,E=E.buffer,z=u.material instanceof THREE.MeshFaceMaterial?u.material.materials[0]:
u.material,y=0<u.geometry.morphTargets.length&&z.morphTargets,z=u instanceof THREE.SkinnedMesh&&z.skinning,y=u.customDepthMaterial?u.customDepthMaterial:z?y?f:e:y?d:c,E instanceof THREE.BufferGeometry?b.renderBufferDirect(t,m.__lights,null,y,E,u):b.renderBuffer(t,m.__lights,null,y,E,u));q=m.__webglObjectsImmediate;s=0;for(l=q.length;s<l;s++)E=q[s],u=E.object,u.visible&&u.castShadow&&(u._modelViewMatrix.multiply(t.matrixWorldInverse,u.matrixWorld),b.renderImmediateObject(t,m.__lights,null,c,u))}n=
...
F.far),b.uniform1i(u.fogType,1),q=t=1):F instanceof THREE.FogExp2&&(b.uniform1f(u.fogDensity,F.density),b.uniform1i(u.fogType,2),q=t=2)):(b.uniform1i(u.fogType,0),q=t=0);for(var A,z,v=[],F=0;F<l;F++)A=s[F],z=A.material,A.visible&&0!==z.opacity&&(z.useScreenCoordinates?A.z=-A.position.z:(A._modelViewMatrix.multiply(e.matrixWorldInverse,A.matrixWorld),A.z=-A._modelViewMatrix.elements[14]));s.sort(a);for(F=0;F<l;F++)A=s[F],z=A.material,A.visible&&0!==z.opacity&&(z.map&&z.map.image&&z.map.image.width)&&
(b.uniform1f(u.alphaTest,z.alphaTest),z.useScreenCoordinates?(b.uniform1i(u.useScreenCoordinates,1),b.uniform3f(u.screenPosition,(A.position.x-n)/n,(y-A.position.y)/y,Math.max(0,Math.min(1,A.position.z)))):(b.uniform1i(u.useScreenCoordinates,0),b.uniform1i(u.sizeAttenuation,z.sizeAttenuation?1:0),b.uniformMatrix4fv(u.modelViewMatrix,!1,A._modelViewMatrix.elements)),e=d.fog&&z.fog?q:0,t!==e&&(b.uniform1i(u.fogType,e),t=e),e=1/(z.scaleByViewport?r:1),v[0]=e*E*A.scale.x,v[1]=e*A.scale.y,b.uniform2f(u.uvScale,
z.uvScale.x,z.uvScale.y),b.uniform2f(u.uvOffset,z.uvOffset.x,z.uvOffset.y),b.uniform2f(u.alignment,z.alignment.x,z.alignment.y),b.uniform1f(u.opacity,z.opacity),b.uniform3f(u.color,z.color.r,z.color.g,z.color.b),b.uniform1f(u.rotation,A.rotation),b.uniform2fv(u.scale,v),c.setBlending(z.blending,z.blendEquation,z.blendSrc,z.blendDst),c.setDepthTest(z.depthTest),c.setDepthWrite(z.depthWrite),c.setTexture(z.map,0),b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0));b.enable(b.CULL_FACE)}}};THREE.DepthPassPlugin=function(){this.enabled=!1;this.renderTarget=null;var a,b,c,d,e,f,g=new THREE.Frustum,h=new THREE.Matrix4;this.init=function(g){a=g.context;b=g;var g=THREE.ShaderLib.depthRGBA,h=THREE.UniformsUtils.clone(g.uniforms);c=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h});d=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,
