...
v=d[12],z=d[1],E=d[5],B=d[9],J=d[13],K=d[2],C=d[6],L=d[10],I=d[14],M=d[3],Q=d[7],O=d[11],d=d[15];e[0]=f*t+g*z+h*K+i*M;e[4]=f*F+g*E+h*C+i*Q;e[8]=f*A+g*B+h*L+i*O;e[12]=f*v+g*J+h*I+i*d;e[1]=j*t+l*z+m*K+n*M;e[5]=j*F+l*E+m*C+n*Q;e[9]=j*A+l*B+m*L+n*O;e[13]=j*v+l*J+m*I+n*d;e[2]=p*t+q*z+r*K+u*M;e[6]=p*F+q*E+r*C+u*Q;e[10]=p*A+q*B+r*L+u*O;e[14]=p*v+q*J+r*I+u*d;e[3]=s*t+D*z+x*K+c*M;e[7]=s*F+D*E+x*C+c*Q;e[11]=s*A+D*B+x*L+c*O;e[15]=s*v+D*J+x*I+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
this.elements,c=a.elements,d=c[0],e=c[4],f=c[8],g=c[12],h=c[1],i=c[5],j=c[9],l=c[13],m=c[2],n=c[6],p=c[10],q=c[14],r=c[3],u=c[7],s=c[11],c=c[15];b[0]=j*q*u-l*p*u+l*n*s-i*q*s-j*n*c+i*p*c;b[4]=g*p*u-f*q*u-g*n*s+e*q*s+f*n*c-e*p*c;b[8]=f*l*u-g*j*u+g*i*s-e*l*s-f*i*c+e*j*c;b[12]=g*j*n-f*l*n-g*i*p+e*l*p+f*i*q-e*j*q;b[1]=l*p*r-j*q*r-l*m*s+h*q*s+j*m*c-h*p*c;b[5]=f*q*r-g*p*r+g*m*s-d*q*s-f*m*c+d*p*c;b[9]=g*j*r-f*l*r-g*h*s+d*l*s+f*h*c-d*j*c;b[13]=f*l*m-g*j*m+g*h*p-d*l*p-f*h*q+d*j*q;b[2]=i*q*r-l*n*r+l*m*u-h*q*
u-i*m*c+h*n*c;b[6]=g*n*r-e*q*r-g*m*u+d*q*u+e*m*c-d*n*c;b[10]=e*l*r-g*i*r+g*h*u-d*l*u-e*h*c+d*i*c;b[14]=g*i*m-e*l*m-g*h*n+d*l*n+e*h*q-d*i*q;b[3]=j*n*r-i*p*r-j*m*u+h*p*u+i*m*s-h*n*s;b[7]=e*p*r-f*n*r+f*m*u-d*p*u-e*m*s+d*n*s;b[11]=f*i*r-e*j*r-f*h*u+d*j*u+e*h*s-d*i*s;b[15]=e*j*m-f*i*m+f*h*n-d*j*n-e*h*p+d*i*p;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,e=a.y,f=a.z,g=Math.cos(d),d=Math.sin(d),h=Math.cos(e),e=Math.sin(e),i=Math.cos(f),f=
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),l=Math.sin(b),m=1-j,n=d*e*m,p=d*f*m,m=e*f*m,d=d*l,q=e*l,l=f*l,f=g+(1-g)*j,g=n+l,e=p-q,n=n-l,h=h+(1-h)*j,l=m+d,p=p+q,m=m-d,i=i+(1-i)*j,j=c[0],d=c[1],q=c[2],r=c[3],u=c[4],s=c[5],D=c[6],x=c[7],t=c[8],F=c[9],A=c[10],v=c[11];c[0]=f*j+g*u+e*t;c[1]=f*d+g*s+e*F;c[2]=f*q+g*D+e*A;c[3]=f*r+g*x+e*v;c[4]=n*j+h*u+l*t;c[5]=n*d+h*s+l*F;c[6]=n*q+h*D+l*A;c[7]=n*r+h*x+l*v;c[8]=p*j+m*u+i*t;c[9]=p*d+m*s+i*F;c[10]=p*q+m*D+i*A;c[11]=p*r+m*x+i*v;
...
ba.positionScreen.y)-(ja.positionScreen.y-ba.positionScreen.y)*(qa.positionScreen.x-ba.positionScreen.x),da===THREE.DoubleSide||Ia===(da===THREE.FrontSide)){if(u===D){var nb=new THREE.RenderableFace4;s.push(nb);D++;u++;n=nb}else n=s[u++];n.v1.copy(Z);n.v2.copy(ja);n.v3.copy(ba);n.v4.copy(qa)}else continue;else continue;n.normalWorld.copy(ca.normal);!1===Ia&&(da===THREE.BackSide||da===THREE.DoubleSide)&&n.normalWorld.negate();M.multiplyVector3(n.normalWorld).normalize();n.centroidWorld.copy(ca.centroid);
...
J.elements.push(n)}}else if(oa instanceof THREE.Line){I.multiply(L,eb);ia=oa.geometry.vertices;Z=b();Z.positionScreen.copy(ia[0]);I.multiplyVector4(Z.positionScreen);eb=oa.type===THREE.LinePieces?2:1;H=1;for(ca=ia.length;H<ca;H++)Z=b(),Z.positionScreen.copy(ia[H]),I.multiplyVector4(Z.positionScreen),0<(H+1)%eb||(ja=l[j-2],O.copy(Z.positionScreen),R.copy(ja.positionScreen),!0===d(O,R)&&(O.multiplyScalar(1/O.w),R.multiplyScalar(1/R.w),t===A?(za=new THREE.RenderableLine,F.push(za),A++,t++,x=za):x=F[t++],
...
0}var e=this.offsets,f=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,m,n,p,q=new THREE.Vector3,r=new THREE.Vector3,u=new THREE.Vector3,s=new THREE.Vector3,D=new THREE.Vector3;c=0;for(d=e.length;c<d;++c){b=e[c].start;i=e[c].count;var x=e[c].index;a=b;for(b+=i;a<b;a+=3)i=x+f[a],j=x+f[a+1],l=x+f[a+2],m=g[3*i],n=g[3*i+1],p=g[3*i+2],q.set(m,n,p),m=g[3*j],n=g[3*j+1],p=g[3*j+2],r.set(m,n,p),m=g[3*l],n=g[3*l+1],p=g[3*l+2],u.set(m,n,p),s.sub(u,r),D.sub(q,
r),s.crossSelf(D),h[3*i]+=s.x,h[3*i+1]+=s.y,h[3*i+2]+=s.z,h[3*j]+=s.x,h[3*j+1]+=s.y,h[3*j+2]+=s.z,h[3*l]+=s.x,h[3*l+1]+=s.y,h[3*l+2]+=s.z}this.normalizeNormals();this.normalsNeedUpdate=!0}},normalizeNormals:function(){for(var a=this.attributes.normal.array,b,c,d,e=0,f=a.length;e<f;e+=3)b=a[e],c=a[e+1],d=a[e+2],b=1/Math.sqrt(b*b+c*c+d*d),a[e]*=b,a[e+1]*=b,a[e+2]*=b},computeTangents:function(){function a(a){T.x=d[3*a];T.y=d[3*a+1];T.z=d[3*a+2];N.copy(T);S=i[a];O.copy(S);O.subSelf(T.multiplyScalar(T.dot(S))).normalize();
R.cross(N,S);aa=R.dot(j[a]);P=0>aa?-1:1;h[4*a]=O.x;h[4*a+1]=O.y;h[4*a+2]=O.z;h[4*a+3]=P}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===this.attributes.uv)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,e=this.attributes.uv.array,f=c.length/3;if(void 0===this.attributes.tangent){var g=
4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,m,n,p,q,r,u,s,D,x,t,F,A,v,z,f=new THREE.Vector3,g=new THREE.Vector3,E,B,J,K,C,L,I,M=this.offsets;J=0;for(K=M.length;J<K;++J){B=M[J].start;C=M[J].count;var Q=M[J].index;E=B;for(B+=C;E<B;E+=3)C=Q+b[E],L=Q+b[E+1],I=Q+b[E+2],l=c[3*C],m=c[3*C+1],n=c[3*C+2],p=c[3*L],q=c[3*L+1],r=c[3*L+2],u=c[3*I],s=c[3*I+1],D=c[3*
I+2],x=e[2*C],t=e[2*C+1],F=e[2*L],A=e[2*L+1],v=e[2*I],z=e[2*I+1],p-=l,l=u-l,q-=m,m=s-m,r-=n,n=D-n,F-=x,x=v-x,A-=t,t=z-t,z=1/(F*t-x*A),f.set((t*p-A*l)*z,(t*q-A*m)*z,(t*r-A*n)*z),g.set((F*l-x*p)*z,(F*m-x*q)*z,(F*n-x*r)*z),i[C].addSelf(f),i[L].addSelf(f),i[I].addSelf(f),j[C].addSelf(g),j[L].addSelf(g),j[I].addSelf(g)}var O=new THREE.Vector3,R=new THREE.Vector3,T=new THREE.Vector3,N=new THREE.Vector3,P,S,aa;J=0;for(K=M.length;J<K;++J){B=M[J].start;C=M[J].count;Q=M[J].index;E=B;for(B+=C;E<B;E+=3)C=Q+b[E],
L=Q+b[E+1],I=Q+b[E+2],a(C),a(L),a(I)}this.tangentsNeedUpdate=this.hasTangents=!0}},deallocate:function(){var a=THREE.GeometryLibrary.indexOf(this);-1!==a&&THREE.GeometryLibrary.splice(a,1)}};THREE.Spline=function(a){function b(a,b,c,d,e,f,g){a=0.5*(c-a);d=0.5*(d-b);return(2*(b-c)+a+d)*g+(-3*(b-c)-2*a-d)*f+a*e+b}this.points=a;var c=[],d={x:0,y:0,z:0},e,f,g,h,i,j,l,m,n;this.initFromArray=function(a){this.points=[];for(var b=0;b<a.length;b++)this.points[b]={x:a[b][0],y:a[b][1],z:a[b][2]}};this.getPoint=function(a){e=(this.points.length-1)*a;f=Math.floor(e);g=e-f;c[0]=0===f?f:f-1;c[1]=f;c[2]=f>this.points.length-2?this.points.length-1:f+1;c[3]=f>this.points.length-3?this.points.length-1:
...
a}function d(a){a=Math.log(a)/Math.LN2;return Math.pow(2,Math.round(a))}function e(a,e,f,h,i,j,u){var s=f.toLowerCase().endsWith(".dds"),D=b+"/"+f;if(s){var x=THREE.ImageUtils.loadCompressedTexture(D);a[e]=x}else x=document.createElement("canvas"),a[e]=new THREE.Texture(x);a[e].sourceFile=f;h&&(a[e].repeat.set(h[0],h[1]),1!==h[0]&&(a[e].wrapS=THREE.RepeatWrapping),1!==h[1]&&(a[e].wrapT=THREE.RepeatWrapping));i&&a[e].offset.set(i[0],i[1]);j&&(f={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},
void 0!==f[j[0]]&&(a[e].wrapS=f[j[0]]),void 0!==f[j[1]]&&(a[e].wrapT=f[j[1]]));u&&(a[e].anisotropy=u);if(!s){var t=a[e],a=new Image;a.onload=function(){if(!c(this.width)||!c(this.height)){var a=d(this.width),b=d(this.height);t.image.width=a;t.image.height=b;t.image.getContext("2d").drawImage(this,0,0,a,b)}else t.image=this;t.needsUpdate=!0};a.crossOrigin=g.crossOrigin;a.src=D}}function f(a){return(255*a[0]<<16)+(255*a[1]<<8)+255*a[2]}var g=this,h="MeshLambertMaterial",i={color:15658734,opacity:1,
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,j,l,m,n,p,q,r,u,s,D,x,t=a.faces;q=a.vertices;var F=a.normals,A=a.colors,v=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&v++;for(f=0;f<v;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(j=q.length;i<j;)l=new THREE.Vector3,l.x=q[i++]*e,l.y=q[i++]*e,l.z=q[i++]*e,d.vertices.push(l);i=0;for(j=t.length;i<j;){q=t[i++];l=q&1;h=q&2;f=q&4;g=q&8;n=q&16;m=q&32;r=q&64;q&=128;l?(u=new THREE.Face4,
u.a=t[i++],u.b=t[i++],u.c=t[i++],u.d=t[i++],l=4):(u=new THREE.Face3,u.a=t[i++],u.b=t[i++],u.c=t[i++],l=3);h&&(h=t[i++],u.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<v;f++)s=a.uvs[f],p=t[i++],x=s[2*p],p=s[2*p+1],d.faceUvs[f][h]=new THREE.UV(x,p);if(g)for(f=0;f<v;f++){s=a.uvs[f];D=[];for(g=0;g<l;g++)p=t[i++],x=s[2*p],p=s[2*p+1],D[g]=new THREE.UV(x,p);d.faceVertexUvs[f][h]=D}n&&(n=3*t[i++],g=new THREE.Vector3,g.x=F[n++],g.y=F[n++],g.z=F[n],u.normal=g);if(m)for(f=0;f<l;f++)n=3*t[i++],g=new THREE.Vector3,
g.x=F[n++],g.y=F[n++],g.z=F[n],u.vertexNormals.push(g);r&&(m=t[i++],m=new THREE.Color(A[m]),u.color=m);if(q)for(f=0;f<l;f++)m=t[i++],m=new THREE.Color(A[m]),u.vertexColors.push(m);d.faces.push(u)}if(a.skinWeights){i=0;for(j=a.skinWeights.length;i<j;i+=2)t=a.skinWeights[i],F=a.skinWeights[i+1],d.skinWeights.push(new THREE.Vector4(t,F,0,0))}if(a.skinIndices){i=0;for(j=a.skinIndices.length;i<j;i+=2)t=a.skinIndices[i],F=a.skinIndices[i+1],d.skinIndices.push(new THREE.Vector4(t,F,0,0))}d.bones=a.bones;
d.animation=a.animation;if(void 0!==a.morphTargets){i=0;for(j=a.morphTargets.length;i<j;i++){d.morphTargets[i]={};d.morphTargets[i].name=a.morphTargets[i].name;d.morphTargets[i].vertices=[];A=d.morphTargets[i].vertices;v=a.morphTargets[i].vertices;t=0;for(F=v.length;t<F;t+=3)q=new THREE.Vector3,q.x=v[t]*e,q.y=v[t+1]*e,q.z=v[t+2]*e,A.push(q)}}if(void 0!==a.morphColors){i=0;for(j=a.morphColors.length;i<j;i++){d.morphColors[i]={};d.morphColors[i].name=a.morphColors[i].name;d.morphColors[i].colors=[];
F=d.morphColors[i].colors;A=a.morphColors[i].colors;e=0;for(t=A.length;e<t;e+=3)v=new THREE.Color(16755200),v.setRGB(A[e],A[e+1],A[e+2]),F.push(v)}}d.computeCentroids();d.computeFaceNormals();a=this.initMaterials(a.materials,c);this.needsTangents(a)&&d.computeTangents();b(d,a)};THREE.LoadingMonitor=function(){THREE.EventTarget.call(this);var a=this,b=0,c=0,d=function(){b++;a.dispatchEvent({type:"progress",loaded:b,total:c});b===c&&a.dispatchEvent({type:"load"})};this.add=function(a){c++;a.addEventListener("load",d,!1)}};THREE.SceneLoader=function(){this.onLoadStart=function(){};this.onLoadProgress=function(){};this.onLoadComplete=function(){};this.callbackSync=function(){};this.callbackProgress=function(){};this.geometryHandlerMap={};this.hierarchyHandlerMap={};this.addGeometryHandler("ascii",THREE.JSONLoader);this.addGeometryHandler("binary",THREE.BinaryLoader)};THREE.SceneLoader.prototype.constructor=THREE.SceneLoader;
...
n.options?n.load(d(e.url,S.urlBaseType),h(c,a,B,e)):n.load(d(e.url,S.urlBaseType),h(c,a,B,e),i)}else if(void 0!==e.geometry){if(E=N.geometries[e.geometry]){g=!1;B=N.materials[e.material];g=B instanceof THREE.ShaderMaterial;x=e.position;t=e.rotation;F=e.quaternion;A=e.scale;s=e.matrix;F=0;e.material||(B=new THREE.MeshFaceMaterial(N.face_materials[e.geometry]));B instanceof THREE.MeshFaceMaterial&&0===B.materials.length&&(B=new THREE.MeshFaceMaterial(N.face_materials[e.geometry]));if(B instanceof THREE.MeshFaceMaterial)for(i=
0;i<B.materials.length;i++)g=g||B.materials[i]instanceof THREE.ShaderMaterial;g&&E.computeTangents();e.skin?g=new THREE.SkinnedMesh(E,B):e.morph?(g=new THREE.MorphAnimMesh(E,B),void 0!==e.duration&&(g.duration=e.duration),void 0!==e.time&&(g.time=e.time),void 0!==e.mirroredLoop&&(g.mirroredLoop=e.mirroredLoop),B.morphNormals&&E.computeMorphNormals()):g=new THREE.Mesh(E,B);g.name=c;s?(g.matrixAutoUpdate=!1,g.matrix.set(s[0],s[1],s[2],s[3],s[4],s[5],s[6],s[7],s[8],s[9],s[10],s[11],s[12],s[13],s[14],
s[15])):(g.position.set(x[0],x[1],x[2]),F?(g.quaternion.set(F[0],F[1],F[2],F[3]),g.useQuaternion=!0):g.rotation.set(t[0],t[1],t[2]),g.scale.set(A[0],A[1],A[2]));g.visible=e.visible;g.castShadow=e.castShadow;g.receiveShadow=e.receiveShadow;a.add(g);N.objects[c]=g}}else"DirectionalLight"===e.type||"PointLight"===e.type||"AmbientLight"===e.type?(I=void 0!==e.color?e.color:16777215,M=void 0!==e.intensity?e.intensity:1,"DirectionalLight"===e.type?(x=e.direction,L=new THREE.DirectionalLight(I,M),L.position.set(x[0],
...
v.right,v.top,v.bottom,v.near,v.far)),x=e.position,J.position.set(x[0],x[1],x[2]),a.add(J),J.name=c,N.cameras[c]=J,N.objects[c]=J):(x=e.position,t=e.rotation,F=e.quaternion,A=e.scale,F=0,g=new THREE.Object3D,g.name=c,g.position.set(x[0],x[1],x[2]),F?(g.quaternion.set(F[0],F[1],F[2],F[3]),g.useQuaternion=!0):g.rotation.set(t[0],t[1],t[2]),g.scale.set(A[0],A[1],A[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),N.objects[c]=g,N.empties[c]=g);if(g){if(void 0!==e.properties)for(var m in e.properties)g.properties[m]=
...
n,p,q,r,u,s,D,x,t,F,A,v,z,E,B,J,K,C,L,I,M,Q,O,R,T,N,P=[],S=a,aa;for(aa in this.geometryHandlerMap)a=this.geometryHandlerMap[aa].loaderClass,this.geometryHandlerMap[aa].loaderObject=new a;for(aa in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[aa].loaderClass,this.hierarchyHandlerMap[aa].loaderObject=new a;O=Q=0;N={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(S.transform&&(aa=S.transform.position,a=S.transform.rotation,
...
n.anisotropy),n.repeat&&(C.repeat.set(n.repeat[0],n.repeat[1]),1!==n.repeat[0]&&(C.wrapS=THREE.RepeatWrapping),1!==n.repeat[1]&&(C.wrapT=THREE.RepeatWrapping)),n.offset&&C.offset.set(n.offset[0],n.offset[1]),n.wrap&&(ga={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==ga[n.wrap[0]]&&(C.wrapS=ga[n.wrap[0]]),void 0!==ga[n.wrap[1]]&&(C.wrapT=ga[n.wrap[1]]));N.textures[r]=C}for(p in S.materials){s=S.materials[p];for(z in s.parameters)"envMap"===z||"map"===z||"lightMap"===z||
"bumpMap"===z?s.parameters[z]=N.textures[s.parameters[z]]:"shading"===z?s.parameters[z]="flat"===s.parameters[z]?THREE.FlatShading:THREE.SmoothShading:"side"===z?s.parameters[z]="double"==s.parameters[z]?THREE.DoubleSide:"back"==s.parameters[z]?THREE.BackSide:THREE.FrontSide:"blending"===z?s.parameters[z]=s.parameters[z]in THREE?THREE[s.parameters[z]]:THREE.NormalBlending:"combine"===z?s.parameters[z]="MixOperation"==s.parameters[z]?THREE.MixOperation:THREE.MultiplyOperation:"vertexColors"===z?"face"==
s.parameters[z]?s.parameters[z]=THREE.FaceColors:s.parameters[z]&&(s.parameters[z]=THREE.VertexColors):"wrapRGB"===z&&(r=s.parameters[z],s.parameters[z]=new THREE.Vector3(r[0],r[1],r[2]));void 0!==s.parameters.opacity&&1>s.parameters.opacity&&(s.parameters.transparent=!0);s.parameters.normalMap?(r=THREE.ShaderUtils.lib.normal,aa=THREE.UniformsUtils.clone(r.uniforms),n=s.parameters.color,C=s.parameters.specular,ga=s.parameters.ambient,q=s.parameters.shininess,aa.tNormal.value=N.textures[s.parameters.normalMap],
s.parameters.normalScale&&aa.uNormalScale.value.set(s.parameters.normalScale[0],s.parameters.normalScale[1]),s.parameters.map&&(aa.tDiffuse.value=s.parameters.map,aa.enableDiffuse.value=!0),s.parameters.envMap&&(aa.tCube.value=s.parameters.envMap,aa.enableReflection.value=!0,aa.uReflectivity.value=s.parameters.reflectivity),s.parameters.lightMap&&(aa.tAO.value=s.parameters.lightMap,aa.enableAO.value=!0),s.parameters.specularMap&&(aa.tSpecular.value=N.textures[s.parameters.specularMap],aa.enableSpecular.value=
!0),s.parameters.displacementMap&&(aa.tDisplacement.value=N.textures[s.parameters.displacementMap],aa.enableDisplacement.value=!0,aa.uDisplacementBias.value=s.parameters.displacementBias,aa.uDisplacementScale.value=s.parameters.displacementScale),aa.uDiffuseColor.value.setHex(n),aa.uSpecularColor.value.setHex(C),aa.uAmbientColor.value.setHex(ga),aa.uShininess.value=q,s.parameters.opacity&&(aa.uOpacity.value=s.parameters.opacity),B=new THREE.ShaderMaterial({fragmentShader:r.fragmentShader,vertexShader:r.vertexShader,
uniforms:aa,lights:!0,fog:!0})):B=new THREE[s.type](s.parameters);N.materials[p]=B}for(p in S.materials)if(s=S.materials[p],s.parameters.materials){z=[];for(C=0;C<s.parameters.materials.length;C++)z.push(N.materials[s.parameters.materials[C]]);N.materials[p].materials=z}e();N.cameras&&S.defaults.camera&&(N.currentCamera=N.cameras[S.defaults.camera]);N.fogs&&S.defaults.fog&&(N.scene.fog=N.fogs[S.defaults.fog]);v=S.defaults.bgcolor;N.bgColor=new THREE.Color;N.bgColor.setRGB(v[0],v[1],v[2]);N.bgColorAlpha=
...
3*ja);c<f;c++)ca[c]=0;c=3*R;for(f=Math.max(K.length,3*ja);c<f;c++)K[c]=0;s.directional.length=N;s.point.length=ba;s.spot.length=S;s.hemi.length=R;s.ambient[0]=l;s.ambient[1]=n;s.ambient[2]=m;Db=!1}c=xc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;
...
x);for(x=0;x<c.maxMorphNormals;x++)t.push("morphNormal"+x);for(j in b)t.push(j);j=t;x=0;for(b=j.length;x<b;x++)t=j[x],v.attributes[t]=k.getAttribLocation(v,t);v.id=ia++;ca.push({program:v,code:m,usedTimes:1});H.info.memory.programs=ca.length;j=v}a.program=j;x=a.program.attributes;if(a.morphTargets){a.numSupportedMorphTargets=0;b="morphTarget";for(j=0;j<this.maxMorphTargets;j++)v=b+j,0<=x[v]&&a.numSupportedMorphTargets++}if(a.morphNormals){a.numSupportedMorphNormals=0;b="morphNormal";for(j=0;j<this.maxMorphNormals;j++)v=
...
b.push(i.clone());b.push(j.clone());f.a=e;f.b=e+1;f.c=e+2;f.d=e+3}else g=f.a,h=f.b,i=f.c,g=a.vertices[g],h=a.vertices[h],i=a.vertices[i],b.push(g.clone()),b.push(h.clone()),b.push(i.clone()),f.a=e,f.b=e+1,f.c=e+2}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,e,f,g,h,i,j,l,m,n,p,q,r,u,s,D,x,t,F=[],A=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)A[c]=[];c=0;for(d=a.faces.length;c<d;c++)if(e=a.faces[c],e instanceof THREE.Face3)if(f=e.a,g=e.b,h=e.c,j=a.vertices[f],l=a.vertices[g],
m=a.vertices[h],p=j.distanceTo(l),q=l.distanceTo(m),n=j.distanceTo(m),p>b||q>b||n>b){i=a.vertices.length;x=e.clone();t=e.clone();p>=q&&p>=n?(j=j.clone(),j.lerpSelf(l,0.5),x.a=f,x.b=i,x.c=h,t.a=i,t.b=g,t.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),x.vertexNormals[1].copy(f),t.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),x.vertexColors[1].copy(f),t.vertexColors[0].copy(f)),e=0):
q>=p&&q>=n?(j=l.clone(),j.lerpSelf(m,0.5),x.a=f,x.b=g,x.c=i,t.a=i,t.b=h,t.c=f,3===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerpSelf(e.vertexNormals[2],0.5),x.vertexNormals[2].copy(f),t.vertexNormals[0].copy(f),t.vertexNormals[1].copy(e.vertexNormals[2]),t.vertexNormals[2].copy(e.vertexNormals[0])),3===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),x.vertexColors[2].copy(f),t.vertexColors[0].copy(f),t.vertexColors[1].copy(e.vertexColors[2]),t.vertexColors[2].copy(e.vertexColors[0])),
e=1):(j=j.clone(),j.lerpSelf(m,0.5),x.a=f,x.b=g,x.c=i,t.a=i,t.b=g,t.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[2],0.5),x.vertexNormals[2].copy(f),t.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[2],0.5),x.vertexColors[2].copy(f),t.vertexColors[0].copy(f)),e=2);F.push(x,t);a.vertices.push(j);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],t=j[0],h=
j[1],x=j[2],0===e?(l=t.clone(),l.lerpSelf(h,0.5),j=[t.clone(),l.clone(),x.clone()],h=[l.clone(),h.clone(),x.clone()]):1===e?(l=h.clone(),l.lerpSelf(x,0.5),j=[t.clone(),h.clone(),l.clone()],h=[l.clone(),x.clone(),t.clone()]):(l=t.clone(),l.lerpSelf(x,0.5),j=[t.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),x.clone()]),A[f].push(j,h))}else{F.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,j=a.vertices[f],l=a.vertices[g],m=a.vertices[h],
n=a.vertices[i],p=j.distanceTo(l),q=l.distanceTo(m),r=m.distanceTo(n),u=j.distanceTo(n),p>b||q>b||r>b||u>b){s=a.vertices.length;D=a.vertices.length+1;x=e.clone();t=e.clone();p>=q&&p>=r&&p>=u||r>=q&&r>=p&&r>=u?(p=j.clone(),p.lerpSelf(l,0.5),l=m.clone(),l.lerpSelf(n,0.5),x.a=f,x.b=s,x.c=D,x.d=i,t.a=s,t.b=g,t.c=h,t.d=D,4===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),g=e.vertexNormals[2].clone(),g.lerpSelf(e.vertexNormals[3],0.5),x.vertexNormals[1].copy(f),
x.vertexNormals[2].copy(g),t.vertexNormals[0].copy(f),t.vertexNormals[3].copy(g)),4===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),g=e.vertexColors[2].clone(),g.lerpSelf(e.vertexColors[3],0.5),x.vertexColors[1].copy(f),x.vertexColors[2].copy(g),t.vertexColors[0].copy(f),t.vertexColors[3].copy(g)),e=0):(p=l.clone(),p.lerpSelf(m,0.5),l=n.clone(),l.lerpSelf(j,0.5),x.a=f,x.b=g,x.c=s,x.d=D,t.a=D,t.b=s,t.c=h,t.d=i,4===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),
f.lerpSelf(e.vertexNormals[2],0.5),g=e.vertexNormals[3].clone(),g.lerpSelf(e.vertexNormals[0],0.5),x.vertexNormals[2].copy(f),x.vertexNormals[3].copy(g),t.vertexNormals[0].copy(g),t.vertexNormals[1].copy(f)),4===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),g=e.vertexColors[3].clone(),g.lerpSelf(e.vertexColors[0],0.5),x.vertexColors[2].copy(f),x.vertexColors[3].copy(g),t.vertexColors[0].copy(g),t.vertexColors[1].copy(f)),e=1);F.push(x,t);a.vertices.push(p,l);
f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],t=j[0],h=j[1],x=j[2],j=j[3],0===e?(l=t.clone(),l.lerpSelf(h,0.5),m=x.clone(),m.lerpSelf(j,0.5),t=[t.clone(),l.clone(),m.clone(),j.clone()],h=[l.clone(),h.clone(),x.clone(),m.clone()]):(l=h.clone(),l.lerpSelf(x,0.5),m=j.clone(),m.lerpSelf(t,0.5),t=[t.clone(),h.clone(),l.clone(),m.clone()],h=[m.clone(),l.clone(),x.clone(),j.clone()]),A[f].push(t,h))}else{F.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}a.faces=
...
0>m-1?0:m-1,p=m+1>e-1?e-1:m+1,q=0>l-1?0:l-1,r=l+1>d-1?d-1:l+1,u=[],s=[0,0,h[4*(m*d+l)]/255*b];u.push([-1,0,h[4*(m*d+q)]/255*b]);u.push([-1,-1,h[4*(n*d+q)]/255*b]);u.push([0,-1,h[4*(n*d+l)]/255*b]);u.push([1,-1,h[4*(n*d+r)]/255*b]);u.push([1,0,h[4*(m*d+r)]/255*b]);u.push([1,1,h[4*(p*d+r)]/255*b]);u.push([0,1,h[4*(p*d+l)]/255*b]);u.push([-1,1,h[4*(p*d+q)]/255*b]);n=[];q=u.length;for(p=0;p<q;p++){var r=u[p],D=u[(p+1)%q],r=[r[0]-s[0],r[1]-s[1],r[2]-s[2]],D=[D[0]-s[0],D[1]-s[1],D[2]-s[2]];n.push(c([r[1]*
D[2]-r[2]*D[1],r[2]*D[0]-r[0]*D[2],r[0]*D[1]-r[1]*D[0]]))}u=[0,0,0];for(p=0;p<n.length;p++)u[0]+=n[p][0],u[1]+=n[p][1],u[2]+=n[p][2];u[0]/=n.length;u[1]/=n.length;u[2]/=n.length;s=4*(m*d+l);j[s]=255*((u[0]+1)/2)|0;j[s+1]=255*((u[1]+1)/2)|0;j[s+2]=255*u[2]|0;j[s+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+1]=g,e[3*h+2]=c;a=new THREE.DataTexture(e,
...
0,e=String(a).split(""),f=e.length,g=[],a=0;a<f;a++){var h=new THREE.Path,h=this.extractGlyphPoints(e[a],b,c,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(a,b,c,d,e){var f=[],g,h,i,j,l,m,n,p,q,r,u,s=b.glyphs[a]||b.glyphs["?"];if(s){if(s.o){b=s._cachedOutline||(s._cachedOutline=s.o.split(" "));j=b.length;for(a=0;a<j;)switch(i=b[a++],i){case "m":i=b[a++]*c+d;l=b[a++]*c;e.moveTo(i,l);break;case "l":i=b[a++]*c+d;l=b[a++]*c;e.lineTo(i,l);break;case "q":i=b[a++]*
c+d;l=b[a++]*c;p=b[a++]*c+d;q=b[a++]*c;e.quadraticCurveTo(p,q,i,l);if(g=f[f.length-1]){m=g.x;n=g.y;g=1;for(h=this.divisions;g<=h;g++){var D=g/h;THREE.Shape.Utils.b2(D,m,p,i);THREE.Shape.Utils.b2(D,n,q,l)}}break;case "b":if(i=b[a++]*c+d,l=b[a++]*c,p=b[a++]*c+d,q=b[a++]*-c,r=b[a++]*c+d,u=b[a++]*-c,e.bezierCurveTo(i,l,p,q,r,u),g=f[f.length-1]){m=g.x;n=g.y;g=1;for(h=this.divisions;g<=h;g++)D=g/h,THREE.Shape.Utils.b3(D,m,p,r,i),THREE.Shape.Utils.b3(D,n,q,u,l)}}}return{offset:s.ha*c,path:e}}}};
THREE.FontUtils.generateShapes=function(a,b){var b=b||{},c=void 0!==b.curveSegments?b.curveSegments:4,d=void 0!==b.font?b.font:"helvetiker",e=void 0!==b.weight?b.weight:"normal",f=void 0!==b.style?b.style:"normal";THREE.FontUtils.size=void 0!==b.size?b.size:100;THREE.FontUtils.divisions=c;THREE.FontUtils.face=d;THREE.FontUtils.weight=e;THREE.FontUtils.style=f;c=THREE.FontUtils.drawText(a).paths;d=[];e=0;for(f=c.length;e<f;e++)Array.prototype.push.apply(d,c[e].toShapes());return d};
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],g=[],h=[],i,j,l;if(0<b(a))for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var m=2*e;for(j=e-1;2<e;){if(0>=m--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);l=j+1;e<=l&&(l=0);var n;a:{n=a;var p=i,q=j,r=l,u=e,s=g,D=void 0,x=void 0,t=void 0,F=void 0,A=void 0,
v=void 0,z=void 0,E=void 0,B=void 0,x=n[s[p]].x,t=n[s[p]].y,F=n[s[q]].x,A=n[s[q]].y,v=n[s[r]].x,z=n[s[r]].y;if(1E-10>(F-x)*(z-t)-(A-t)*(v-x))n=!1;else{for(D=0;D<u;D++)if(!(D==p||D==q||D==r)){var E=n[s[D]].x,B=n[s[D]].y,J=void 0,K=void 0,C=void 0,L=void 0,I=void 0,M=void 0,Q=void 0,O=void 0,R=void 0,T=void 0,N=void 0,P=void 0,J=C=I=void 0,J=v-F,K=z-A,C=x-v,L=t-z,I=F-x,M=A-t,Q=E-x,O=B-t,R=E-F,T=B-A,N=E-v,P=B-z,J=J*T-K*R,I=I*O-M*Q,C=C*P-L*N;if(0<=J&&0<=C&&0<=I){n=!1;break a}}n=!0}}if(n){f.push([a[g[i]],
...
f[e+1],g]);this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:a}};THREE.CircleGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,r){var u,s=h.widthSegments,D=h.heightSegments,x=e/2,t=f/2,F=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)u="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)u="y",D=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)u="x",s=h.depthSegments;var A=s+1,v=D+1,z=e/s,E=f/D,B=new THREE.Vector3;B[u]=0<g?1:-1;for(e=0;e<v;e++)for(f=0;f<A;f++){var J=new THREE.Vector3;J[a]=(f*z-x)*c;J[b]=(e*E-t)*d;J[u]=g;h.vertices.push(J)}for(e=
0;e<D;e++)for(f=0;f<s;f++)a=new THREE.Face4(f+A*e+F,f+A*(e+1)+F,f+1+A*(e+1)+F,f+1+A*e+F),a.normal.copy(B),a.vertexNormals.push(B.clone(),B.clone(),B.clone(),B.clone()),a.materialIndex=r,h.faces.push(a),h.faceVertexUvs[0].push([new THREE.UV(f/s,1-e/D),new THREE.UV(f/s,1-(e+1)/D),new THREE.UV((f+1)/s,1-(e+1)/D),new THREE.UV((f+1)/s,1-e/D)])}THREE.Geometry.call(this);var h=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;a=this.width/
...
1]].clone()):(m=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var p=j[i][h],q=j[i+1][h],r=j[i+1][h+1],u=j[i][h+1],s=m.clone(),D=m.clone(),x=n.clone(),t=n.clone(),F=l[i][h].clone(),A=l[i+1][h].clone(),v=l[i+1][h+1].clone(),z=l[i][h+1].clone();this.faces.push(new THREE.Face4(p,q,r,u,[s,D,x,t]));this.faceVertexUvs[0].push([F,A,v,z])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
g,0));for(h=0;h<d;h++)p=j[0][h],q=j[0][h+1],r=this.vertices.length-1,s=new THREE.Vector3(0,1,0),D=new THREE.Vector3(0,1,0),x=new THREE.Vector3(0,1,0),F=l[0][h].clone(),A=l[0][h+1].clone(),v=new THREE.UV(A.u,0),this.faces.push(new THREE.Face3(p,q,r,[s,D,x])),this.faceVertexUvs[0].push([F,A,v])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)p=j[i][h+1],q=j[i][h],r=this.vertices.length-1,s=new THREE.Vector3(0,-1,0),D=new THREE.Vector3(0,-1,0),x=new THREE.Vector3(0,-1,0),F=
l[i][h+1].clone(),A=l[i][h].clone(),v=new THREE.UV(A.u,1),this.faces.push(new THREE.Face3(p,q,r,[s,D,x])),this.faceVertexUvs[0].push([F,A,v])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(a,b){for(var c=a.length,d=0;d<c;d++)this.addShape(a[d],b)};
...
for(var g=0,h=n+2*l,g=0;g<h;g++){var i=R*g,j=R*(g+1),m=d+e+i,i=d+f+i,p=d+f+j,j=d+e+j,q=c,r=g,t=h,u=e,v=f,m=m+J,i=i+J,p=p+J,j=j+J;B.faces.push(new THREE.Face4(m,i,p,j,null,null,s));m=D.generateSideWallUV(B,a,q,b,m,i,p,j,r,t,u,v);B.faceVertexUvs[0].push(m)}}}function f(a,b,c){B.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=J;d+=J;e+=J;B.faces.push(new THREE.Face3(c,d,e,null,null,u));c=f?D.generateBottomUV(B,a,b,c,d,e):D.generateTopUV(B,a,b,c,d,e);B.faceVertexUvs[0].push(c)}var h=void 0!==
b.amount?b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,l=void 0!==b.bevelSegments?b.bevelSegments:3,m=void 0!==b.bevelEnabled?b.bevelEnabled:!0,n=void 0!==b.steps?b.steps:1,p=b.extrudePath,q,r=!1,u=b.material,s=b.extrudeMaterial,D=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,x,t,F,A;p&&(q=p.getSpacedPoints(n),r=!0,m=!1,x=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(p,n,!1),t=new THREE.Vector3,F=new THREE.Vector3,
...
[],ga,Ia=N.concat();z=0;for(E=p.length;z<E;z++){v=p[z];ga=[];P=0;S=v.length;I=S-1;for(M=P+1;P<S;P++,I++,M++)I===S&&(I=0),M===S&&(M=0),ga[P]=d(v[P],v[I],v[M]);aa.push(ga);Ia=Ia.concat(ga)}for(I=0;I<l;I++){v=I/l;Q=i*(1-v);M=j*Math.sin(v*Math.PI/2);P=0;for(S=C.length;P<S;P++)O=c(C[P],N[P],M),f(O.x,O.y,-Q);z=0;for(E=p.length;z<E;z++){v=p[z];ga=aa[z];P=0;for(S=v.length;P<S;P++)O=c(v[P],ga[P],M),f(O.x,O.y,-Q)}}M=j;for(P=0;P<R;P++)O=m?c(K[P],Ia[P],M):K[P],r?(F.copy(x.normals[0]).multiplyScalar(O.x),t.copy(x.binormals[0]).multiplyScalar(O.y),
A.copy(q[0]).addSelf(F).addSelf(t),f(A.x,A.y,A.z)):f(O.x,O.y,0);for(v=1;v<=n;v++)for(P=0;P<R;P++)O=m?c(K[P],Ia[P],M):K[P],r?(F.copy(x.normals[v]).multiplyScalar(O.x),t.copy(x.binormals[v]).multiplyScalar(O.y),A.copy(q[v]).addSelf(F).addSelf(t),f(A.x,A.y,A.z)):f(O.x,O.y,h/n*v);for(I=l-1;0<=I;I--){v=I/l;Q=i*(1-v);M=j*Math.sin(v*Math.PI/2);P=0;for(S=C.length;P<S;P++)O=c(C[P],N[P],M),f(O.x,O.y,h+Q);z=0;for(E=p.length;z<E;z++){v=p[z];ga=aa[z];P=0;for(S=v.length;P<S;P++)O=c(v[P],ga[P],M),r?f(O.x,O.y+q[n-
...
i=[],j=[],l=this,m=THREE.GeometryUtils.orderedKey,n=THREE.GeometryUtils.computeEdgeFaces,p=a.vertices,q=a.faces,r=p.length,h=p.concat(),u=[],s={},D={},x={},t,F,A,v,z,E=a.faceVertexUvs[0],B;c("originalFaces, uvs, originalVerticesLength",q.length,E.length,r);if(l.supportUVs){t=0;for(F=E.length;t<F;t++){A=0;for(v=E[t].length;A<v;A++)B=q[t]["abcd".charAt(A)],g(B,t,E[t][A])}}0==E.length&&(l.supportUVs=!1);t=0;for(var J in x)t++;t||(l.supportUVs=!1,c("no uvs"));t=0;for(F=q.length;t<F;t++)z=q[t],u.push(z.centroid),
h.push(z.centroid),l.supportUVs&&(v=new THREE.UV,z instanceof THREE.Face3?(v.u=f(z.a,t).u+f(z.b,t).u+f(z.c,t).u,v.v=f(z.a,t).v+f(z.b,t).v+f(z.c,t).v,v.u/=3,v.v/=3):z instanceof THREE.Face4&&(v.u=f(z.a,t).u+f(z.b,t).u+f(z.c,t).u+f(z.d,t).u,v.v=f(z.a,t).v+f(z.b,t).v+f(z.c,t).v+f(z.d,t).v,v.u/=4,v.v/=4),g(r+t,"",v));var n=n(a),K;F=0;var C,L;J={};E={};for(t in n){B=n[t];C=t.split("_");L=C[0];C=C[1];A=L;z=[L,C];void 0===J[A]&&(J[A]=[]);J[A].push(z);A=C;z=[L,C];void 0===J[A]&&(J[A]=[]);J[A].push(z);A=0;
for(v=B.length;A<v;A++){z=B[A];K=L;var I=z,M=t;void 0===E[K]&&(E[K]={});E[K][I]=M;K=C;I=t;void 0===E[K]&&(E[K]={});E[K][z]=I}2>B.length&&(D[t]=!0)}for(t in n)B=n[t],z=B[0],K=B[1],C=t.split("_"),L=C[0],C=C[1],v=new THREE.Vector3,b(0<B.length,"an edge without faces?!"),1==B.length?(v.addSelf(p[L]),v.addSelf(p[C]),v.multiplyScalar(0.5)):(v.addSelf(u[z]),v.addSelf(u[K]),v.addSelf(p[L]),v.addSelf(p[C]),v.multiplyScalar(0.25)),s[t]=r+q.length+F,h.push(v),F++,l.supportUVs&&(v=new THREE.UV,v.u=f(L,z).u+f(C,
z).u,v.v=f(L,z).v+f(C,z).v,v.u/=2,v.v/=2,g(s[t],z,v),2<=B.length&&(b(2==B.length,"did we plan for more than 2 edges?"),v=new THREE.UV,v.u=f(L,K).u+f(C,K).u,v.v=f(L,K).v+f(C,K).v,v.u/=2,v.v/=2,g(s[t],K,v)));c("-- Step 2 done");var Q,O;v=["123","12","2","23"];K=["123","23","3","31"];var I=["123","31","1","12"],M=["1234","12","2","23"],R=["1234","23","3","34"],T=["1234","34","4","41"],N=["1234","41","1","12"];t=0;for(F=u.length;t<F;t++)z=q[t],B=r+t,z instanceof THREE.Face3?(L=m(z.a,z.b),C=m(z.b,z.c),
Q=m(z.c,z.a),e(B,s[L],z.b,s[C],z,v,t),e(B,s[C],z.c,s[Q],z,K,t),e(B,s[Q],z.a,s[L],z,I,t)):z instanceof THREE.Face4?(L=m(z.a,z.b),C=m(z.b,z.c),Q=m(z.c,z.d),O=m(z.d,z.a),e(B,s[L],z.b,s[C],z,M,t),e(B,s[C],z.c,s[Q],z,R,t),e(B,s[Q],z.d,s[O],z,T,t),e(B,s[O],z.a,s[L],z,N,t)):c("face should be a face!",z);s=new THREE.Vector3;z=new THREE.Vector3;t=0;for(F=p.length;t<F;t++)if(void 0!==J[t]){s.set(0,0,0);z.set(0,0,0);C=new THREE.Vector3(0,0,0);B=0;for(A in E[t])s.addSelf(u[A]),B++;K=0;L=J[t].length;v=B!=L;for(A=
0;A<L;A++)D[m(J[t][A][0],J[t][A][1])]&&K++;s.divideScalar(B);K=0;if(v){for(A=0;A<L;A++)if(B=J[t][A],I=1==n[m(B[0],B[1])].length)B=p[B[0]].clone().addSelf(p[B[1]]).divideScalar(2),z.addSelf(B),K++;z.divideScalar(4);b(2==K,"should have only 2 boundary edges")}else{for(A=0;A<L;A++)B=J[t][A],B=p[B[0]].clone().addSelf(p[B[1]]).divideScalar(2),z.addSelf(B);z.divideScalar(L)}C.addSelf(p[t]);v?(C.divideScalar(2),C.addSelf(z)):(C.multiplyScalar(L-3),C.addSelf(s),C.addSelf(z.multiplyScalar(2)),C.divideScalar(L));
...
"color");n.scale=b.getUniformLocation(l,"scale");n.rotation=b.getUniformLocation(l,"rotation");n.screenPosition=b.getUniformLocation(l,"screenPosition")};this.render=function(a,d,e,u){var a=a.__webglFlares,s=a.length;if(s){var D=new THREE.Vector3,x=u/e,t=0.5*e,F=0.5*u,A=16/u,v=new THREE.Vector2(A*x,A),z=new THREE.Vector3(1,1,0),E=new THREE.Vector2(1,1),B=n,A=m;b.useProgram(l);b.enableVertexAttribArray(m.vertex);b.enableVertexAttribArray(m.uv);b.uniform1i(B.occlusionMap,0);b.uniform1i(B.map,1);b.bindBuffer(b.ARRAY_BUFFER,
f);b.vertexAttribPointer(A.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(A.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var J,K,C,L,I;for(J=0;J<s;J++)if(A=16/u,v.set(A*x,A),L=a[J],D.set(L.matrixWorld.elements[12],L.matrixWorld.elements[13],L.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(D),d.projectionMatrix.multiplyVector3(D),z.copy(D),E.x=z.x*t+t,E.y=z.y*F+F,j||0<E.x&&E.x<e&&0<E.y&&E.y<u){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,m){var n,p,q,r,u,s,D,x,t,F=[];r=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(!0);n=0;for(p=l.__lights.length;n<p;n++)if(q=l.__lights[n],q.castShadow)if(q instanceof THREE.DirectionalLight&&q.shadowCascade)for(u=0;u<q.shadowCascadeCount;u++){var A;if(q.shadowCascadeArray[u])A=q.shadowCascadeArray[u];else{t=q;D=u;A=new THREE.DirectionalLight;A.isVirtual=!0;A.onlyShadow=!0;A.castShadow=!0;A.shadowCameraNear=t.shadowCameraNear;A.shadowCameraFar=t.shadowCameraFar;A.shadowCameraLeft=t.shadowCameraLeft;A.shadowCameraRight=t.shadowCameraRight;
A.shadowCameraBottom=t.shadowCameraBottom;A.shadowCameraTop=t.shadowCameraTop;A.shadowCameraVisible=t.shadowCameraVisible;A.shadowDarkness=t.shadowDarkness;A.shadowBias=t.shadowCascadeBias[D];A.shadowMapWidth=t.shadowCascadeWidth[D];A.shadowMapHeight=t.shadowCascadeHeight[D];A.pointsWorld=[];A.pointsFrustum=[];x=A.pointsWorld;s=A.pointsFrustum;for(var v=0;8>v;v++)x[v]=new THREE.Vector3,s[v]=new THREE.Vector3;x=t.shadowCascadeNearZ[D];t=t.shadowCascadeFarZ[D];s[0].set(-1,-1,x);s[1].set(1,-1,x);s[2].set(-1,
1,x);s[3].set(1,1,x);s[4].set(-1,-1,t);s[5].set(1,-1,t);s[6].set(-1,1,t);s[7].set(1,1,t);A.originalCamera=m;s=new THREE.Gyroscope;s.position=q.shadowCascadeOffset;s.add(A);s.add(A.target);m.add(s);q.shadowCascadeArray[u]=A;console.log("Created virtualLight",A)}D=q;x=u;t=D.shadowCascadeArray[x];t.position.copy(D.position);t.target.position.copy(D.target.position);t.lookAt(t.target);t.shadowCameraVisible=D.shadowCameraVisible;t.shadowDarkness=D.shadowDarkness;t.shadowBias=D.shadowCascadeBias[x];s=D.shadowCascadeNearZ[x];
