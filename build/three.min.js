...
[]);for(;a.__objectsAdded.length;)t(a.__objectsAdded[0],a),a.__objectsAdded.splice(0,1);for(;a.__objectsRemoved.length;)u(a.__objectsRemoved[0],a),a.__objectsRemoved.splice(0,1);for(var b=0,c=a.__webglObjects.length;b<c;b++){var h=a.__webglObjects[b].object;void 0===h.__webglInit&&(void 0!==h.__webglActive&&u(h,a),t(h,a));var i=h,j=i.geometry,m=void 0,n=void 0,p=void 0;if(j instanceof THREE.BufferGeometry){var q=k.DYNAMIC_DRAW,v=!j.dynamic,w=j.attributes,A=void 0,z=void 0;for(A in w)z=w[A],z.needsUpdate&&
("index"===A?(k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,z.buffer),k.bufferData(k.ELEMENT_ARRAY_BUFFER,z.array,q)):(k.bindBuffer(k.ARRAY_BUFFER,z.buffer),k.bufferData(k.ARRAY_BUFFER,z.array,q)),z.needsUpdate=!1),v&&!z.dynamic&&(z.array=null)}else if(i instanceof THREE.Mesh){for(var C=0,H=j.geometryGroupsList.length;C<H;C++)if(m=j.geometryGroupsList[C],p=e(i,m),j.buffersNeedUpdate&&d(m,i),n=p.attributes&&s(p),j.verticesNeedUpdate||j.morphTargetsNeedUpdate||j.elementsNeedUpdate||j.uvsNeedUpdate||j.normalsNeedUpdate||
j.colorsNeedUpdate||j.tangentsNeedUpdate||n){var B=m,F=i,E=k.DYNAMIC_DRAW,J=!j.dynamic,I=p;if(B.__inittedArrays){var K=f(I),L=I.vertexColors?I.vertexColors:!1,M=g(I),U=K===THREE.SmoothShading,G=void 0,D=void 0,N=void 0,Q=void 0,O=void 0,Y=void 0,T=void 0,X=void 0,V=void 0,$=void 0,wa=void 0,R=void 0,S=void 0,P=void 0,ba=void 0,ea=void 0,da=void 0,ya=void 0,ha=void 0,ga=void 0,Ga=void 0,ia=void 0,eb=void 0,ja=void 0,ka=void 0,pa=void 0,ra=void 0,ma=void 0,na=void 0,oa=void 0,xa=void 0,qa=void 0,sa=
void 0,ta=void 0,Ea=void 0,za=void 0,Ra=void 0,lb=void 0,mb=void 0,Qa=void 0,bb=void 0,Za=void 0,$a=void 0,ab=void 0,La=void 0,Ja=void 0,Va=0,Xa=0,Sa=0,Ua=0,Ka=0,jb=0,Ca=0,ob=0,Wa=0,Z=0,fa=0,y=0,Aa=void 0,cb=B.__vertexArray,fb=B.__uvArray,gb=B.__uv2Array,Ta=B.__normalArray,Ma=B.__tangentArray,db=B.__colorArray,Na=B.__skinIndexArray,Oa=B.__skinWeightArray,vb=B.__morphTargetsArrays,xb=B.__morphNormalsArrays,yb=B.__webglCustomAttributesList,x=void 0,Kb=B.__faceArray,tb=B.__lineArray,pb=F.geometry,Ib=
pb.elementsNeedUpdate,Gb=pb.uvsNeedUpdate,Pb=pb.normalsNeedUpdate,Qb=pb.tangentsNeedUpdate,Ub=pb.colorsNeedUpdate,Vb=pb.morphTargetsNeedUpdate,$b=pb.vertices,ua=B.faces3,va=B.faces4,kb=pb.faces,Hb=pb.faceVertexUvs[0],Jb=pb.faceVertexUvs[1],ac=pb.skinIndices,Xb=pb.skinWeights,Yb=pb.morphTargets,Eb=pb.morphNormals;if(pb.verticesNeedUpdate){G=0;for(D=ua.length;G<D;G++)Q=kb[ua[G]],R=$b[Q.a],S=$b[Q.b],P=$b[Q.c],cb[Xa]=R.x,cb[Xa+1]=R.y,cb[Xa+2]=R.z,cb[Xa+3]=S.x,cb[Xa+4]=S.y,cb[Xa+5]=S.z,cb[Xa+6]=P.x,cb[Xa+
7]=P.y,cb[Xa+8]=P.z,Xa+=9;G=0;for(D=va.length;G<D;G++)Q=kb[va[G]],R=$b[Q.a],S=$b[Q.b],P=$b[Q.c],ba=$b[Q.d],cb[Xa]=R.x,cb[Xa+1]=R.y,cb[Xa+2]=R.z,cb[Xa+3]=S.x,cb[Xa+4]=S.y,cb[Xa+5]=S.z,cb[Xa+6]=P.x,cb[Xa+7]=P.y,cb[Xa+8]=P.z,cb[Xa+9]=ba.x,cb[Xa+10]=ba.y,cb[Xa+11]=ba.z,Xa+=12;k.bindBuffer(k.ARRAY_BUFFER,B.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,cb,E)}if(Vb){bb=0;for(Za=Yb.length;bb<Za;bb++){G=fa=0;for(D=ua.length;G<D;G++)La=ua[G],Q=kb[La],R=Yb[bb].vertices[Q.a],S=Yb[bb].vertices[Q.b],P=Yb[bb].vertices[Q.c],
$a=vb[bb],$a[fa]=R.x,$a[fa+1]=R.y,$a[fa+2]=R.z,$a[fa+3]=S.x,$a[fa+4]=S.y,$a[fa+5]=S.z,$a[fa+6]=P.x,$a[fa+7]=P.y,$a[fa+8]=P.z,I.morphNormals&&(U?(Ja=Eb[bb].vertexNormals[La],ga=Ja.a,Ga=Ja.b,ia=Ja.c):ia=Ga=ga=Eb[bb].faceNormals[La],ab=xb[bb],ab[fa]=ga.x,ab[fa+1]=ga.y,ab[fa+2]=ga.z,ab[fa+3]=Ga.x,ab[fa+4]=Ga.y,ab[fa+5]=Ga.z,ab[fa+6]=ia.x,ab[fa+7]=ia.y,ab[fa+8]=ia.z),fa+=9;G=0;for(D=va.length;G<D;G++)La=va[G],Q=kb[La],R=Yb[bb].vertices[Q.a],S=Yb[bb].vertices[Q.b],P=Yb[bb].vertices[Q.c],ba=Yb[bb].vertices[Q.d],
$a=vb[bb],$a[fa]=R.x,$a[fa+1]=R.y,$a[fa+2]=R.z,$a[fa+3]=S.x,$a[fa+4]=S.y,$a[fa+5]=S.z,$a[fa+6]=P.x,$a[fa+7]=P.y,$a[fa+8]=P.z,$a[fa+9]=ba.x,$a[fa+10]=ba.y,$a[fa+11]=ba.z,I.morphNormals&&(U?(Ja=Eb[bb].vertexNormals[La],ga=Ja.a,Ga=Ja.b,ia=Ja.c,eb=Ja.d):eb=ia=Ga=ga=Eb[bb].faceNormals[La],ab=xb[bb],ab[fa]=ga.x,ab[fa+1]=ga.y,ab[fa+2]=ga.z,ab[fa+3]=Ga.x,ab[fa+4]=Ga.y,ab[fa+5]=Ga.z,ab[fa+6]=ia.x,ab[fa+7]=ia.y,ab[fa+8]=ia.z,ab[fa+9]=eb.x,ab[fa+10]=eb.y,ab[fa+11]=eb.z),fa+=12;k.bindBuffer(k.ARRAY_BUFFER,B.__webglMorphTargetsBuffers[bb]);
k.bufferData(k.ARRAY_BUFFER,vb[bb],E);I.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,B.__webglMorphNormalsBuffers[bb]),k.bufferData(k.ARRAY_BUFFER,xb[bb],E))}}if(Xb.length){G=0;for(D=ua.length;G<D;G++)Q=kb[ua[G]],ma=Xb[Q.a],na=Xb[Q.b],oa=Xb[Q.c],Oa[Z]=ma.x,Oa[Z+1]=ma.y,Oa[Z+2]=ma.z,Oa[Z+3]=ma.w,Oa[Z+4]=na.x,Oa[Z+5]=na.y,Oa[Z+6]=na.z,Oa[Z+7]=na.w,Oa[Z+8]=oa.x,Oa[Z+9]=oa.y,Oa[Z+10]=oa.z,Oa[Z+11]=oa.w,qa=ac[Q.a],sa=ac[Q.b],ta=ac[Q.c],Na[Z]=qa.x,Na[Z+1]=qa.y,Na[Z+2]=qa.z,Na[Z+3]=qa.w,Na[Z+4]=sa.x,Na[Z+
5]=sa.y,Na[Z+6]=sa.z,Na[Z+7]=sa.w,Na[Z+8]=ta.x,Na[Z+9]=ta.y,Na[Z+10]=ta.z,Na[Z+11]=ta.w,Z+=12;G=0;for(D=va.length;G<D;G++)Q=kb[va[G]],ma=Xb[Q.a],na=Xb[Q.b],oa=Xb[Q.c],xa=Xb[Q.d],Oa[Z]=ma.x,Oa[Z+1]=ma.y,Oa[Z+2]=ma.z,Oa[Z+3]=ma.w,Oa[Z+4]=na.x,Oa[Z+5]=na.y,Oa[Z+6]=na.z,Oa[Z+7]=na.w,Oa[Z+8]=oa.x,Oa[Z+9]=oa.y,Oa[Z+10]=oa.z,Oa[Z+11]=oa.w,Oa[Z+12]=xa.x,Oa[Z+13]=xa.y,Oa[Z+14]=xa.z,Oa[Z+15]=xa.w,qa=ac[Q.a],sa=ac[Q.b],ta=ac[Q.c],Ea=ac[Q.d],Na[Z]=qa.x,Na[Z+1]=qa.y,Na[Z+2]=qa.z,Na[Z+3]=qa.w,Na[Z+4]=sa.x,Na[Z+
5]=sa.y,Na[Z+6]=sa.z,Na[Z+7]=sa.w,Na[Z+8]=ta.x,Na[Z+9]=ta.y,Na[Z+10]=ta.z,Na[Z+11]=ta.w,Na[Z+12]=Ea.x,Na[Z+13]=Ea.y,Na[Z+14]=Ea.z,Na[Z+15]=Ea.w,Z+=16;0<Z&&(k.bindBuffer(k.ARRAY_BUFFER,B.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Na,E),k.bindBuffer(k.ARRAY_BUFFER,B.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Oa,E))}if(Ub&&L){G=0;for(D=ua.length;G<D;G++)Q=kb[ua[G]],T=Q.vertexColors,X=Q.color,3===T.length&&L===THREE.VertexColors?(ja=T[0],ka=T[1],pa=T[2]):pa=ka=ja=X,db[Wa]=ja.r,db[Wa+
...
db,E))}if(Qb&&pb.hasTangents){G=0;for(D=ua.length;G<D;G++)Q=kb[ua[G]],V=Q.vertexTangents,ea=V[0],da=V[1],ya=V[2],Ma[Ca]=ea.x,Ma[Ca+1]=ea.y,Ma[Ca+2]=ea.z,Ma[Ca+3]=ea.w,Ma[Ca+4]=da.x,Ma[Ca+5]=da.y,Ma[Ca+6]=da.z,Ma[Ca+7]=da.w,Ma[Ca+8]=ya.x,Ma[Ca+9]=ya.y,Ma[Ca+10]=ya.z,Ma[Ca+11]=ya.w,Ca+=12;G=0;for(D=va.length;G<D;G++)Q=kb[va[G]],V=Q.vertexTangents,ea=V[0],da=V[1],ya=V[2],ha=V[3],Ma[Ca]=ea.x,Ma[Ca+1]=ea.y,Ma[Ca+2]=ea.z,Ma[Ca+3]=ea.w,Ma[Ca+4]=da.x,Ma[Ca+5]=da.y,Ma[Ca+6]=da.z,Ma[Ca+7]=da.w,Ma[Ca+8]=ya.x,
Ma[Ca+9]=ya.y,Ma[Ca+10]=ya.z,Ma[Ca+11]=ya.w,Ma[Ca+12]=ha.x,Ma[Ca+13]=ha.y,Ma[Ca+14]=ha.z,Ma[Ca+15]=ha.w,Ca+=16;k.bindBuffer(k.ARRAY_BUFFER,B.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Ma,E)}if(Pb&&K){G=0;for(D=ua.length;G<D;G++)if(Q=kb[ua[G]],O=Q.vertexNormals,Y=Q.normal,3===O.length&&U)for(za=0;3>za;za++)lb=O[za],Ta[jb]=lb.x,Ta[jb+1]=lb.y,Ta[jb+2]=lb.z,jb+=3;else for(za=0;3>za;za++)Ta[jb]=Y.x,Ta[jb+1]=Y.y,Ta[jb+2]=Y.z,jb+=3;G=0;for(D=va.length;G<D;G++)if(Q=kb[va[G]],O=Q.vertexNormals,Y=Q.normal,
...
B.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,fb,E))}if(Gb&&Jb&&M){G=0;for(D=ua.length;G<D;G++)if(N=ua[G],wa=Jb[N],void 0!==wa)for(za=0;3>za;za++)Qa=wa[za],gb[Ua]=Qa.x,gb[Ua+1]=Qa.y,Ua+=2;G=0;for(D=va.length;G<D;G++)if(N=va[G],wa=Jb[N],void 0!==wa)for(za=0;4>za;za++)Qa=wa[za],gb[Ua]=Qa.x,gb[Ua+1]=Qa.y,Ua+=2;0<Ua&&(k.bindBuffer(k.ARRAY_BUFFER,B.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,gb,E))}if(Ib){G=0;for(D=ua.length;G<D;G++)Kb[Ka]=Va,Kb[Ka+1]=Va+1,Kb[Ka+2]=Va+2,Ka+=3,tb[ob]=Va,tb[ob+1]=Va+
1,tb[ob+2]=Va,tb[ob+3]=Va+2,tb[ob+4]=Va+1,tb[ob+5]=Va+2,ob+=6,Va+=3;G=0;for(D=va.length;G<D;G++)Kb[Ka]=Va,Kb[Ka+1]=Va+1,Kb[Ka+2]=Va+3,Kb[Ka+3]=Va+1,Kb[Ka+4]=Va+2,Kb[Ka+5]=Va+3,Ka+=6,tb[ob]=Va,tb[ob+1]=Va+1,tb[ob+2]=Va,tb[ob+3]=Va+3,tb[ob+4]=Va+1,tb[ob+5]=Va+2,tb[ob+6]=Va+2,tb[ob+7]=Va+3,ob+=8,Va+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,B.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Kb,E);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,B.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,tb,E)}if(yb){za=
0;for(Ra=yb.length;za<Ra;za++)if(x=yb[za],x.__original.needsUpdate){y=0;if(1===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){G=0;for(D=ua.length;G<D;G++)Q=kb[ua[G]],x.array[y]=x.value[Q.a],x.array[y+1]=x.value[Q.b],x.array[y+2]=x.value[Q.c],y+=3;G=0;for(D=va.length;G<D;G++)Q=kb[va[G]],x.array[y]=x.value[Q.a],x.array[y+1]=x.value[Q.b],x.array[y+2]=x.value[Q.c],x.array[y+3]=x.value[Q.d],y+=4}else{if("faces"===x.boundTo){G=0;for(D=ua.length;G<D;G++)Aa=x.value[ua[G]],x.array[y]=Aa,x.array[y+1]=
Aa,x.array[y+2]=Aa,y+=3;G=0;for(D=va.length;G<D;G++)Aa=x.value[va[G]],x.array[y]=Aa,x.array[y+1]=Aa,x.array[y+2]=Aa,x.array[y+3]=Aa,y+=4}}else if(2===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){G=0;for(D=ua.length;G<D;G++)Q=kb[ua[G]],R=x.value[Q.a],S=x.value[Q.b],P=x.value[Q.c],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=S.x,x.array[y+3]=S.y,x.array[y+4]=P.x,x.array[y+5]=P.y,y+=6;G=0;for(D=va.length;G<D;G++)Q=kb[va[G]],R=x.value[Q.a],S=x.value[Q.b],P=x.value[Q.c],ba=x.value[Q.d],x.array[y]=
R.x,x.array[y+1]=R.y,x.array[y+2]=S.x,x.array[y+3]=S.y,x.array[y+4]=P.x,x.array[y+5]=P.y,x.array[y+6]=ba.x,x.array[y+7]=ba.y,y+=8}else{if("faces"===x.boundTo){G=0;for(D=ua.length;G<D;G++)P=S=R=Aa=x.value[ua[G]],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=S.x,x.array[y+3]=S.y,x.array[y+4]=P.x,x.array[y+5]=P.y,y+=6;G=0;for(D=va.length;G<D;G++)ba=P=S=R=Aa=x.value[va[G]],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=S.x,x.array[y+3]=S.y,x.array[y+4]=P.x,x.array[y+5]=P.y,x.array[y+6]=ba.x,x.array[y+7]=
ba.y,y+=8}}else if(3===x.size){var W;W="c"===x.type?["r","g","b"]:["x","y","z"];if(void 0===x.boundTo||"vertices"===x.boundTo){G=0;for(D=ua.length;G<D;G++)Q=kb[ua[G]],R=x.value[Q.a],S=x.value[Q.b],P=x.value[Q.c],x.array[y]=R[W[0]],x.array[y+1]=R[W[1]],x.array[y+2]=R[W[2]],x.array[y+3]=S[W[0]],x.array[y+4]=S[W[1]],x.array[y+5]=S[W[2]],x.array[y+6]=P[W[0]],x.array[y+7]=P[W[1]],x.array[y+8]=P[W[2]],y+=9;G=0;for(D=va.length;G<D;G++)Q=kb[va[G]],R=x.value[Q.a],S=x.value[Q.b],P=x.value[Q.c],ba=x.value[Q.d],
x.array[y]=R[W[0]],x.array[y+1]=R[W[1]],x.array[y+2]=R[W[2]],x.array[y+3]=S[W[0]],x.array[y+4]=S[W[1]],x.array[y+5]=S[W[2]],x.array[y+6]=P[W[0]],x.array[y+7]=P[W[1]],x.array[y+8]=P[W[2]],x.array[y+9]=ba[W[0]],x.array[y+10]=ba[W[1]],x.array[y+11]=ba[W[2]],y+=12}else if("faces"===x.boundTo){G=0;for(D=ua.length;G<D;G++)P=S=R=Aa=x.value[ua[G]],x.array[y]=R[W[0]],x.array[y+1]=R[W[1]],x.array[y+2]=R[W[2]],x.array[y+3]=S[W[0]],x.array[y+4]=S[W[1]],x.array[y+5]=S[W[2]],x.array[y+6]=P[W[0]],x.array[y+7]=P[W[1]],
x.array[y+8]=P[W[2]],y+=9;G=0;for(D=va.length;G<D;G++)ba=P=S=R=Aa=x.value[va[G]],x.array[y]=R[W[0]],x.array[y+1]=R[W[1]],x.array[y+2]=R[W[2]],x.array[y+3]=S[W[0]],x.array[y+4]=S[W[1]],x.array[y+5]=S[W[2]],x.array[y+6]=P[W[0]],x.array[y+7]=P[W[1]],x.array[y+8]=P[W[2]],x.array[y+9]=ba[W[0]],x.array[y+10]=ba[W[1]],x.array[y+11]=ba[W[2]],y+=12}else if("faceVertices"===x.boundTo){G=0;for(D=ua.length;G<D;G++)Aa=x.value[ua[G]],R=Aa[0],S=Aa[1],P=Aa[2],x.array[y]=R[W[0]],x.array[y+1]=R[W[1]],x.array[y+2]=
R[W[2]],x.array[y+3]=S[W[0]],x.array[y+4]=S[W[1]],x.array[y+5]=S[W[2]],x.array[y+6]=P[W[0]],x.array[y+7]=P[W[1]],x.array[y+8]=P[W[2]],y+=9;G=0;for(D=va.length;G<D;G++)Aa=x.value[va[G]],R=Aa[0],S=Aa[1],P=Aa[2],ba=Aa[3],x.array[y]=R[W[0]],x.array[y+1]=R[W[1]],x.array[y+2]=R[W[2]],x.array[y+3]=S[W[0]],x.array[y+4]=S[W[1]],x.array[y+5]=S[W[2]],x.array[y+6]=P[W[0]],x.array[y+7]=P[W[1]],x.array[y+8]=P[W[2]],x.array[y+9]=ba[W[0]],x.array[y+10]=ba[W[1]],x.array[y+11]=ba[W[2]],y+=12}}else if(4===x.size)if(void 0===
x.boundTo||"vertices"===x.boundTo){G=0;for(D=ua.length;G<D;G++)Q=kb[ua[G]],R=x.value[Q.a],S=x.value[Q.b],P=x.value[Q.c],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=R.z,x.array[y+3]=R.w,x.array[y+4]=S.x,x.array[y+5]=S.y,x.array[y+6]=S.z,x.array[y+7]=S.w,x.array[y+8]=P.x,x.array[y+9]=P.y,x.array[y+10]=P.z,x.array[y+11]=P.w,y+=12;G=0;for(D=va.length;G<D;G++)Q=kb[va[G]],R=x.value[Q.a],S=x.value[Q.b],P=x.value[Q.c],ba=x.value[Q.d],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=R.z,x.array[y+3]=R.w,x.array[y+
4]=S.x,x.array[y+5]=S.y,x.array[y+6]=S.z,x.array[y+7]=S.w,x.array[y+8]=P.x,x.array[y+9]=P.y,x.array[y+10]=P.z,x.array[y+11]=P.w,x.array[y+12]=ba.x,x.array[y+13]=ba.y,x.array[y+14]=ba.z,x.array[y+15]=ba.w,y+=16}else if("faces"===x.boundTo){G=0;for(D=ua.length;G<D;G++)P=S=R=Aa=x.value[ua[G]],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=R.z,x.array[y+3]=R.w,x.array[y+4]=S.x,x.array[y+5]=S.y,x.array[y+6]=S.z,x.array[y+7]=S.w,x.array[y+8]=P.x,x.array[y+9]=P.y,x.array[y+10]=P.z,x.array[y+11]=P.w,y+=12;
G=0;for(D=va.length;G<D;G++)ba=P=S=R=Aa=x.value[va[G]],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=R.z,x.array[y+3]=R.w,x.array[y+4]=S.x,x.array[y+5]=S.y,x.array[y+6]=S.z,x.array[y+7]=S.w,x.array[y+8]=P.x,x.array[y+9]=P.y,x.array[y+10]=P.z,x.array[y+11]=P.w,x.array[y+12]=ba.x,x.array[y+13]=ba.y,x.array[y+14]=ba.z,x.array[y+15]=ba.w,y+=16}else if("faceVertices"===x.boundTo){G=0;for(D=ua.length;G<D;G++)Aa=x.value[ua[G]],R=Aa[0],S=Aa[1],P=Aa[2],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=R.z,x.array[y+
3]=R.w,x.array[y+4]=S.x,x.array[y+5]=S.y,x.array[y+6]=S.z,x.array[y+7]=S.w,x.array[y+8]=P.x,x.array[y+9]=P.y,x.array[y+10]=P.z,x.array[y+11]=P.w,y+=12;G=0;for(D=va.length;G<D;G++)Aa=x.value[va[G]],R=Aa[0],S=Aa[1],P=Aa[2],ba=Aa[3],x.array[y]=R.x,x.array[y+1]=R.y,x.array[y+2]=R.z,x.array[y+3]=R.w,x.array[y+4]=S.x,x.array[y+5]=S.y,x.array[y+6]=S.z,x.array[y+7]=S.w,x.array[y+8]=P.x,x.array[y+9]=P.y,x.array[y+10]=P.z,x.array[y+11]=P.w,x.array[y+12]=ba.x,x.array[y+13]=ba.y,x.array[y+14]=ba.z,x.array[y+
15]=ba.w,y+=16}k.bindBuffer(k.ARRAY_BUFFER,x.buffer);k.bufferData(k.ARRAY_BUFFER,x.array,E)}}J&&(delete B.__inittedArrays,delete B.__colorArray,delete B.__normalArray,delete B.__tangentArray,delete B.__uvArray,delete B.__uv2Array,delete B.__faceArray,delete B.__vertexArray,delete B.__lineArray,delete B.__skinIndexArray,delete B.__skinWeightArray)}}j.verticesNeedUpdate=!1;j.morphTargetsNeedUpdate=!1;j.elementsNeedUpdate=!1;j.uvsNeedUpdate=!1;j.normalsNeedUpdate=!1;j.colorsNeedUpdate=!1;j.tangentsNeedUpdate=
!1;j.buffersNeedUpdate=!1;p.attributes&&r(p)}else if(i instanceof THREE.Ribbon){p=e(i,j);n=p.attributes&&s(p);if(j.verticesNeedUpdate||j.colorsNeedUpdate||j.normalsNeedUpdate||n){var zb=j,Fb=k.DYNAMIC_DRAW,Db=void 0,kc=void 0,lc=void 0,Rb=void 0,Ba=void 0,tc=void 0,uc=void 0,vc=void 0,dc=void 0,hb=void 0,ec=void 0,Ha=void 0,qb=void 0,hc=zb.vertices,ic=zb.colors,jc=zb.normals,qc=hc.length,rc=ic.length,Gc=jc.length,wc=zb.__vertexArray,xc=zb.__colorArray,yc=zb.__normalArray,Hc=zb.colorsNeedUpdate,Ic=
zb.normalsNeedUpdate,Lc=zb.__webglCustomAttributesList;if(zb.verticesNeedUpdate){for(Db=0;Db<qc;Db++)Rb=hc[Db],Ba=3*Db,wc[Ba]=Rb.x,wc[Ba+1]=Rb.y,wc[Ba+2]=Rb.z;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,wc,Fb)}if(Hc){for(kc=0;kc<rc;kc++)tc=ic[kc],Ba=3*kc,xc[Ba]=tc.r,xc[Ba+1]=tc.g,xc[Ba+2]=tc.b;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,xc,Fb)}if(Ic){for(lc=0;lc<Gc;lc++)uc=jc[lc],Ba=3*lc,yc[Ba]=uc.x,yc[Ba+1]=uc.y,yc[Ba+2]=uc.z;
k.bindBuffer(k.ARRAY_BUFFER,zb.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yc,Fb)}if(Lc){vc=0;for(dc=Lc.length;vc<dc;vc++)if(Ha=Lc[vc],Ha.needsUpdate&&(void 0===Ha.boundTo||"vertices"===Ha.boundTo)){Ba=0;ec=Ha.value.length;if(1===Ha.size)for(hb=0;hb<ec;hb++)Ha.array[hb]=Ha.value[hb];else if(2===Ha.size)for(hb=0;hb<ec;hb++)qb=Ha.value[hb],Ha.array[Ba]=qb.x,Ha.array[Ba+1]=qb.y,Ba+=2;else if(3===Ha.size)if("c"===Ha.type)for(hb=0;hb<ec;hb++)qb=Ha.value[hb],Ha.array[Ba]=qb.r,Ha.array[Ba+1]=qb.g,Ha.array[Ba+
2]=qb.b,Ba+=3;else for(hb=0;hb<ec;hb++)qb=Ha.value[hb],Ha.array[Ba]=qb.x,Ha.array[Ba+1]=qb.y,Ha.array[Ba+2]=qb.z,Ba+=3;else if(4===Ha.size)for(hb=0;hb<ec;hb++)qb=Ha.value[hb],Ha.array[Ba]=qb.x,Ha.array[Ba+1]=qb.y,Ha.array[Ba+2]=qb.z,Ha.array[Ba+3]=qb.w,Ba+=4;k.bindBuffer(k.ARRAY_BUFFER,Ha.buffer);k.bufferData(k.ARRAY_BUFFER,Ha.array,Fb)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.normalsNeedUpdate=!1;p.attributes&&r(p)}else if(i instanceof THREE.Line){p=e(i,j);n=p.attributes&&s(p);if(j.verticesNeedUpdate||
j.colorsNeedUpdate||j.lineDistancesNeedUpdate||n){var Ab=j,zc=k.DYNAMIC_DRAW,mc=void 0,nc=void 0,oc=void 0,Ac=void 0,Pa=void 0,Bc=void 0,Qc=Ab.vertices,Rc=Ab.colors,Sc=Ab.lineDistances,Yc=Qc.length,Zc=Rc.length,$c=Sc.length,Cc=Ab.__vertexArray,Dc=Ab.__colorArray,Tc=Ab.__lineDistanceArray,ad=Ab.colorsNeedUpdate,bd=Ab.lineDistancesNeedUpdate,Mc=Ab.__webglCustomAttributesList,Ec=void 0,Uc=void 0,ib=void 0,fc=void 0,rb=void 0,Ia=void 0;if(Ab.verticesNeedUpdate){for(mc=0;mc<Yc;mc++)Ac=Qc[mc],Pa=3*mc,Cc[Pa]=
Ac.x,Cc[Pa+1]=Ac.y,Cc[Pa+2]=Ac.z;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Cc,zc)}if(ad){for(nc=0;nc<Zc;nc++)Bc=Rc[nc],Pa=3*nc,Dc[Pa]=Bc.r,Dc[Pa+1]=Bc.g,Dc[Pa+2]=Bc.b;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Dc,zc)}if(bd){for(oc=0;oc<$c;oc++)Tc[oc]=Sc[oc];k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,Tc,zc)}if(Mc){Ec=0;for(Uc=Mc.length;Ec<Uc;Ec++)if(Ia=Mc[Ec],Ia.needsUpdate&&(void 0===
Ia.boundTo||"vertices"===Ia.boundTo)){Pa=0;fc=Ia.value.length;if(1===Ia.size)for(ib=0;ib<fc;ib++)Ia.array[ib]=Ia.value[ib];else if(2===Ia.size)for(ib=0;ib<fc;ib++)rb=Ia.value[ib],Ia.array[Pa]=rb.x,Ia.array[Pa+1]=rb.y,Pa+=2;else if(3===Ia.size)if("c"===Ia.type)for(ib=0;ib<fc;ib++)rb=Ia.value[ib],Ia.array[Pa]=rb.r,Ia.array[Pa+1]=rb.g,Ia.array[Pa+2]=rb.b,Pa+=3;else for(ib=0;ib<fc;ib++)rb=Ia.value[ib],Ia.array[Pa]=rb.x,Ia.array[Pa+1]=rb.y,Ia.array[Pa+2]=rb.z,Pa+=3;else if(4===Ia.size)for(ib=0;ib<fc;ib++)rb=
Ia.value[ib],Ia.array[Pa]=rb.x,Ia.array[Pa+1]=rb.y,Ia.array[Pa+2]=rb.z,Ia.array[Pa+3]=rb.w,Pa+=4;k.bindBuffer(k.ARRAY_BUFFER,Ia.buffer);k.bufferData(k.ARRAY_BUFFER,Ia.array,zc)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.lineDistancesNeedUpdate=!1;p.attributes&&r(p)}else if(i instanceof THREE.ParticleSystem){p=e(i,j);n=p.attributes&&s(p);if(j.verticesNeedUpdate||j.colorsNeedUpdate||i.sortParticles||n){var Lb=j,Nc=k.DYNAMIC_DRAW,pc=i,sb=void 0,Mb=void 0,Nb=void 0,ca=void 0,Ob=void 0,Zb=void 0,
Fc=Lb.vertices,Oc=Fc.length,Pc=Lb.colors,Vc=Pc.length,bc=Lb.__vertexArray,cc=Lb.__colorArray,Sb=Lb.__sortArray,Wc=Lb.verticesNeedUpdate,Xc=Lb.colorsNeedUpdate,Tb=Lb.__webglCustomAttributesList,Bb=void 0,gc=void 0,la=void 0,Cb=void 0,Da=void 0,aa=void 0;if(pc.sortParticles){nb.copy(ub);nb.multiply(pc.matrixWorld);for(sb=0;sb<Oc;sb++)Nb=Fc[sb],Fa.copy(Nb),Fa.applyProjection(nb),Sb[sb]=[Fa.z,sb];Sb.sort(l);for(sb=0;sb<Oc;sb++)Nb=Fc[Sb[sb][1]],ca=3*sb,bc[ca]=Nb.x,bc[ca+1]=Nb.y,bc[ca+2]=Nb.z;for(Mb=0;Mb<
Vc;Mb++)ca=3*Mb,Zb=Pc[Sb[Mb][1]],cc[ca]=Zb.r,cc[ca+1]=Zb.g,cc[ca+2]=Zb.b;if(Tb){Bb=0;for(gc=Tb.length;Bb<gc;Bb++)if(aa=Tb[Bb],void 0===aa.boundTo||"vertices"===aa.boundTo)if(ca=0,Cb=aa.value.length,1===aa.size)for(la=0;la<Cb;la++)Ob=Sb[la][1],aa.array[la]=aa.value[Ob];else if(2===aa.size)for(la=0;la<Cb;la++)Ob=Sb[la][1],Da=aa.value[Ob],aa.array[ca]=Da.x,aa.array[ca+1]=Da.y,ca+=2;else if(3===aa.size)if("c"===aa.type)for(la=0;la<Cb;la++)Ob=Sb[la][1],Da=aa.value[Ob],aa.array[ca]=Da.r,aa.array[ca+1]=
Da.g,aa.array[ca+2]=Da.b,ca+=3;else for(la=0;la<Cb;la++)Ob=Sb[la][1],Da=aa.value[Ob],aa.array[ca]=Da.x,aa.array[ca+1]=Da.y,aa.array[ca+2]=Da.z,ca+=3;else if(4===aa.size)for(la=0;la<Cb;la++)Ob=Sb[la][1],Da=aa.value[Ob],aa.array[ca]=Da.x,aa.array[ca+1]=Da.y,aa.array[ca+2]=Da.z,aa.array[ca+3]=Da.w,ca+=4}}else{if(Wc)for(sb=0;sb<Oc;sb++)Nb=Fc[sb],ca=3*sb,bc[ca]=Nb.x,bc[ca+1]=Nb.y,bc[ca+2]=Nb.z;if(Xc)for(Mb=0;Mb<Vc;Mb++)Zb=Pc[Mb],ca=3*Mb,cc[ca]=Zb.r,cc[ca+1]=Zb.g,cc[ca+2]=Zb.b;if(Tb){Bb=0;for(gc=Tb.length;Bb<
gc;Bb++)if(aa=Tb[Bb],aa.needsUpdate&&(void 0===aa.boundTo||"vertices"===aa.boundTo))if(Cb=aa.value.length,ca=0,1===aa.size)for(la=0;la<Cb;la++)aa.array[la]=aa.value[la];else if(2===aa.size)for(la=0;la<Cb;la++)Da=aa.value[la],aa.array[ca]=Da.x,aa.array[ca+1]=Da.y,ca+=2;else if(3===aa.size)if("c"===aa.type)for(la=0;la<Cb;la++)Da=aa.value[la],aa.array[ca]=Da.r,aa.array[ca+1]=Da.g,aa.array[ca+2]=Da.b,ca+=3;else for(la=0;la<Cb;la++)Da=aa.value[la],aa.array[ca]=Da.x,aa.array[ca+1]=Da.y,aa.array[ca+2]=Da.z,
ca+=3;else if(4===aa.size)for(la=0;la<Cb;la++)Da=aa.value[la],aa.array[ca]=Da.x,aa.array[ca+1]=Da.y,aa.array[ca+2]=Da.z,aa.array[ca+3]=Da.w,ca+=4}}if(Wc||pc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,Lb.__webglVertexBuffer),k.bufferData(k.ARRAY_BUFFER,bc,Nc);if(Xc||pc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,Lb.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,cc,Nc);if(Tb){Bb=0;for(gc=Tb.length;Bb<gc;Bb++)if(aa=Tb[Bb],aa.needsUpdate||pc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,aa.buffer),k.bufferData(k.ARRAY_BUFFER,
aa.array,Nc)}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;p.attributes&&r(p)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h;a.addEventListener("dispose",qc);var i,j,l,m,n;a instanceof THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.LineDashedMaterial?
n="dashed":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var p=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(p.uniforms);a.vertexShader=p.vertexShader;a.fragmentShader=p.fragmentShader}var q=e=0,r=0;f=p=0;for(var s=b.length;f<s;f++)g=b[f],g.onlyShadow||(g instanceof THREE.DirectionalLight&&e++,g instanceof THREE.PointLight&&q++,g instanceof THREE.SpotLight&&r++,g instanceof THREE.HemisphereLight&&p++);f=q;g=r;h=p;r=p=0;for(q=b.length;r<q;r++)s=b[r],s.castShadow&&(s instanceof
...
n=d.join();t=0;for(u=U.length;t<u;t++)if(d=U[t],d.code===n){d.usedTimes++;j=d.program;break a}t="SHADOWMAP_TYPE_BASIC";c.shadowMapType===THREE.PCFShadowMap?t="SHADOWMAP_TYPE_PCF":c.shadowMapType===THREE.PCFSoftShadowMap&&(t="SHADOWMAP_TYPE_PCF_SOFT");u=[];for(v in s)d=s[v],!1!==d&&(d="#define "+v+" "+d,u.push(d));d=u.join("\n");v=k.createProgram();u=["precision "+K+" float;",d,Ua?"#define VERTEX_TEXTURES":"",N.gammaInput?"#define GAMMA_INPUT":"",N.gammaOutput?"#define GAMMA_OUTPUT":"",N.physicallyBasedShading?
