...
lerpSelf:function(a,b){this.x=this.x+(a.x-this.x)*b;this.y=this.y+(a.y-this.y)*b;return this},equals:function(a){return a.x===this.x&&a.y===this.y},isZero:function(a){return this.lengthSq()<(a!==void 0?a:1E-4)},clone:function(){return new THREE.Vector2(this.x,this.y)}};THREE.Vector3=function(a,b,c){this.x=a||0;this.y=b||0;this.z=c||0};
...
b;this.y=c;this.z=a;return this},equals:function(a){return a.x===this.x&&a.y===this.y&&a.z===this.z},isZero:function(a){return this.lengthSq()<(a!==void 0?a:1E-4)},clone:function(){return new THREE.Vector3(this.x,this.y,this.z)}};THREE.Vector4=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=d!==void 0?d:1};
...
transpose:function(){var a,b=this.elements;a=b[1];b[1]=b[3];b[3]=a;a=b[2];b[2]=b[6];b[6]=a;a=b[5];b[5]=b[7];b[7]=a;return this},transposeIntoArray:function(a){var b=this.m;a[0]=b[0];a[1]=b[3];a[2]=b[6];a[3]=b[1];a[4]=b[4];a[5]=b[7];a[6]=b[2];a[7]=b[5];a[8]=b[8];return this}};THREE.Matrix4=function(a,b,c,d,f,e,g,h,i,j,l,n,m,q,o,p){this.elements=new Float32Array(16);this.set(a!==void 0?a:1,b||0,c||0,d||0,f||0,e!==void 0?e:1,g||0,h||0,i||0,j||0,l!==void 0?l:1,n||0,m||0,q||0,o||0,p!==void 0?p:1)};
...
a.z+b[15]*a.w:1;return c},determinant:function(){var a=this.elements,b=a[0],c=a[4],d=a[8],f=a[12],e=a[1],g=a[5],h=a[9],i=a[13],j=a[2],l=a[6],n=a[10],m=a[14],q=a[3],o=a[7],p=a[11],a=a[15];return f*h*l*q-d*i*l*q-f*g*n*q+c*i*n*q+d*g*m*q-c*h*m*q-f*h*j*o+d*i*j*o+f*e*n*o-b*i*n*o-d*e*m*o+b*h*m*o+f*g*j*p-c*i*j*p-f*e*l*p+b*i*l*p+c*e*m*p-b*g*m*p-d*g*j*a+c*h*j*a+d*e*l*a-b*h*l*a-c*e*n*a+b*g*n*a},transpose:function(){var a=this.elements,b;b=a[1];a[1]=a[4];a[4]=b;b=a[2];a[2]=a[8];a[8]=b;b=a[6];a[6]=a[9];a[9]=b;
...
a[9],a[10])},getInverse:function(a){var b=this.elements,c=a.elements,d=c[0],f=c[4],e=c[8],g=c[12],h=c[1],i=c[5],j=c[9],l=c[13],n=c[2],m=c[6],q=c[10],o=c[14],p=c[3],r=c[7],t=c[11],c=c[15];b[0]=j*o*r-l*q*r+l*m*t-i*o*t-j*m*c+i*q*c;b[4]=g*q*r-e*o*r-g*m*t+f*o*t+e*m*c-f*q*c;b[8]=e*l*r-g*j*r+g*i*t-f*l*t-e*i*c+f*j*c;b[12]=g*j*m-e*l*m-g*i*q+f*l*q+e*i*o-f*j*o;b[1]=l*q*p-j*o*p-l*n*t+h*o*t+j*n*c-h*q*c;b[5]=e*o*p-g*q*p+g*n*t-d*o*t-e*n*c+d*q*c;b[9]=g*j*p-e*l*p-g*h*t+d*l*t+e*h*c-d*j*c;b[13]=e*l*n-g*j*n+g*h*q-d*
l*q-e*h*o+d*j*o;b[2]=i*o*p-l*m*p+l*n*r-h*o*r-i*n*c+h*m*c;b[6]=g*m*p-f*o*p-g*n*r+d*o*r+f*n*c-d*m*c;b[10]=f*l*p-g*i*p+g*h*r-d*l*r-f*h*c+d*i*c;b[14]=g*i*n-f*l*n-g*h*m+d*l*m+f*h*o-d*i*o;b[3]=j*m*p-i*q*p-j*n*r+h*q*r+i*n*t-h*m*t;b[7]=f*q*p-e*m*p+e*n*r-d*q*r-f*n*t+d*m*t;b[11]=e*i*p-f*j*p-e*h*r+d*j*r+f*h*t-d*i*t;b[15]=f*j*n-e*i*n+e*h*m-d*j*m-f*h*q+d*i*q;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,f=a.y,e=a.z,g=Math.cos(d),d=Math.sin(d),
...
THREE.Frustum.prototype.setFromMatrix=function(a){var b=this.planes,c=a.elements,a=c[0],d=c[1],f=c[2],e=c[3],g=c[4],h=c[5],i=c[6],j=c[7],l=c[8],n=c[9],m=c[10],q=c[11],o=c[12],p=c[13],r=c[14],c=c[15];b[0].set(e-a,j-g,q-l,c-o);b[1].set(e+a,j+g,q+l,c+o);b[2].set(e+d,j+h,q+n,c+p);b[3].set(e-d,j-h,q-n,c-p);b[4].set(e-f,j-i,q-m,c-r);b[5].set(e+f,j+i,q+m,c+r);for(d=0;d<6;d++){a=b[d];a.divideScalar(Math.sqrt(a.x*a.x+a.y*a.y+a.z*a.z))}};
...
b);var a=j.dot(j),b=j.dot(l),c=j.dot(n),f=l.dot(l),d=l.dot(n),e=1/(a*f-b*b),f=(f*c-b*d)*e,a=(a*d-b*c)*e;return f>=0&&a>=0&&f+a<1},o=function(i,j,l){var n,p;if(i instanceof a.Particle){n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>i.scale.x)return l;p={distance:n,point:i.position,face:null,object:i};l.push(p)}else if(i instanceof a.Mesh){var o=i.geometry.boundingSphere.radius*i.matrixWorld.getMaxScaleOnAxis();n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>o)return l;var w,
A,J=i.geometry,D=J.vertices,F,B,E;F=i.geometry.materials;B=i.material instanceof a.MeshFaceMaterial;var H,Q=j.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(j.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(j.direction);h.rotateAxis(d).normalize();o=0;for(w=J.faces.length;o<w;o++){p=J.faces[o];n=B===true?F[p.materialIndex]:i.material;if(n!==void 0){E=n.side;f.sub(p.centroid,c);e=p.normal;n=d.dot(e);if(!(Math.abs(n)<Q)){A=e.dot(f)/n;if(!(A<0)&&(E===
a.DoubleSide||(E===a.FrontSide?n<0:n>0))){g.add(c,d.multiplyScalar(A));if(p instanceof a.Face3){n=D[p.a];A=D[p.b];E=D[p.c];if(q(g,n,A,E)){A=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(A);if(!(n<j.near||n>j.far)){p={distance:n,point:A,face:p,faceIndex:o,object:i};l.push(p)}}}else if(p instanceof a.Face4){n=D[p.a];A=D[p.b];E=D[p.c];H=D[p.d];if(q(g,n,A,H)||q(g,A,E,H)){A=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(A);if(!(n<j.near||n>j.far)){p={distance:n,point:A,face:p,faceIndex:o,
object:i};l.push(p)}}}}}}}}},p=function(a,b,c){for(var a=a.getDescendants(),d=0,f=a.length;d<f;d++)o(a[d],b,c)};a.Ray.prototype.precision=1E-4;a.Ray.prototype.set=function(a,b){this.origin=a;this.direction=b};a.Ray.prototype.intersectObject=function(a,b){var c=[];b===true&&p(a,this,c);o(a,this,c);c.sort(i);return c};a.Ray.prototype.intersectObjects=function(a,b){for(var c=[],d=0,f=a.length;d<f;d++){o(a[d],this,c);b===true&&p(a[d],this,c)}c.sort(i);return c}})(THREE);
...
THREE.Object3D=function(){this.id=THREE.Object3DCount++;this.name="";this.properties={};this.parent=void 0;this.children=[];this.up=new THREE.Vector3(0,1,0);this.position=new THREE.Vector3;this.rotation=new THREE.Vector3;this.eulerOrder=THREE.Object3D.defaultEulerOrder;this.scale=new THREE.Vector3(1,1,1);this.renderDepth=null;this.rotationAutoUpdate=true;this.matrix=new THREE.Matrix4;this.matrixWorld=new THREE.Matrix4;this.matrixRotationWorld=new THREE.Matrix4;this.matrixWorldNeedsUpdate=this.matrixAutoUpdate=
...
void 0&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);Q.multiply(h.projectionMatrix,h.matrixWorldInverse);K.setFromMatrix(Q);e=0;B.objects.length=0;B.sprites.length=0;B.lights.length=0;var gb=function(b){for(var c=0,d=b.children.length;c<d;c++){var e=b.children[c];if(e.visible!==false){if(e instanceof THREE.Light)B.lights.push(e);else if(e instanceof THREE.Mesh||e instanceof THREE.Line){if(e.frustumCulled===false||K.contains(e)===true){f=a();f.object=e;if(e.renderDepth!==null)f.z=
e.renderDepth;else{E.copy(e.matrixWorld.getPosition());Q.multiplyVector3(E);f.z=E.z}B.objects.push(f)}}else if(e instanceof THREE.Sprite||e instanceof THREE.Particle){f=a();f.object=e;if(e.renderDepth!==null)f.z=e.renderDepth;else{E.copy(e.matrixWorld.getPosition());Q.multiplyVector3(E);f.z=E.z}B.sprites.push(f)}else{f=a();f.object=e;if(e.renderDepth!==null)f.z=e.renderDepth;else{E.copy(e.matrixWorld.getPosition());Q.multiplyVector3(E);f.z=E.z}B.objects.push(f)}gb(e)}}};gb(g);n===true&&B.objects.sort(c);
g=0;for(n=B.objects.length;g<n;g++){ca=B.objects[g].object;Ja=ca.matrixWorld;j=0;if(ca instanceof THREE.Mesh){ua=ca.geometry;La=ca.geometry.materials;ga=ua.vertices;Wa=ua.faces;Xa=ua.faceVertexUvs;ua=ca.matrixRotationWorld.extractRotation(Ja);kb=ca.material instanceof THREE.MeshFaceMaterial;wa=0;for(O=ga.length;wa<O;wa++){i=b();i.positionWorld.copy(ga[wa]);Ja.multiplyVector3(i.positionWorld);i.positionScreen.copy(i.positionWorld);Q.multiplyVector4(i.positionScreen);i.positionScreen.x=i.positionScreen.x/
i.positionScreen.w;i.positionScreen.y=i.positionScreen.y/i.positionScreen.w;i.visible=i.positionScreen.z>fa&&i.positionScreen.z<S}ga=0;for(wa=Wa.length;ga<wa;ga++){O=Wa[ga];Ta=kb===true?La[O.materialIndex]:ca.material;if(Ta!==void 0){ia=Ta.side;if(O instanceof THREE.Face3){P=l[O.a];X=l[O.b];$=l[O.c];if(P.visible===true&&X.visible===true&&$.visible===true){ra=($.positionScreen.x-P.positionScreen.x)*(X.positionScreen.y-P.positionScreen.y)-($.positionScreen.y-P.positionScreen.y)*(X.positionScreen.x-
P.positionScreen.x)<0;if(ia===THREE.DoubleSide||ra===(ia===THREE.FrontSide)){if(q===p){oa=new THREE.RenderableFace3;o.push(oa);p++;q++;m=oa}else m=o[q++];m.v1.copy(P);m.v2.copy(X);m.v3.copy($)}else continue}else continue}else if(O instanceof THREE.Face4){P=l[O.a];X=l[O.b];$=l[O.c];oa=l[O.d];if(P.visible===true&&X.visible===true&&$.visible===true&&oa.visible===true){ra=(oa.positionScreen.x-P.positionScreen.x)*(X.positionScreen.y-P.positionScreen.y)-(oa.positionScreen.y-P.positionScreen.y)*(X.positionScreen.x-
P.positionScreen.x)<0||(X.positionScreen.x-$.positionScreen.x)*(oa.positionScreen.y-$.positionScreen.y)-(X.positionScreen.y-$.positionScreen.y)*(oa.positionScreen.x-$.positionScreen.x)<0;if(ia===THREE.DoubleSide||ra===(ia===THREE.FrontSide)){if(r===u){var rb=new THREE.RenderableFace4;t.push(rb);u++;r++;m=rb}else m=t[r++];m.v1.copy(P);m.v2.copy(X);m.v3.copy($);m.v4.copy(oa)}else continue}else continue}m.normalWorld.copy(O.normal);ra===false&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&m.normalWorld.negate();
ua.multiplyVector3(m.normalWorld);m.centroidWorld.copy(O.centroid);Ja.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);Q.multiplyVector3(m.centroidScreen);$=O.vertexNormals;P=0;for(X=$.length;P<X;P++){oa=m.vertexNormalsWorld[P];oa.copy($[P]);ra===false&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&oa.negate();ua.multiplyVector3(oa)}m.vertexNormalsLength=$.length;P=0;for(X=Xa.length;P<X;P++){oa=Xa[P][ga];if(oa!==void 0){ia=0;for($=oa.length;ia<$;ia++)m.uvs[P][ia]=oa[ia]}}m.color=
O.color;m.material=Ta;m.z=m.centroidScreen.z;B.elements.push(m)}}}else if(ca instanceof THREE.Line){L.multiply(Q,Ja);ga=ca.geometry.vertices;P=b();P.positionScreen.copy(ga[0]);L.multiplyVector4(P.positionScreen);Ja=ca.type===THREE.LinePieces?2:1;wa=1;for(O=ga.length;wa<O;wa++){P=b();P.positionScreen.copy(ga[wa]);L.multiplyVector4(P.positionScreen);if(!((wa+1)%Ja>0)){X=l[j-2];I.copy(P.positionScreen);M.copy(X.positionScreen);if(d(I,M)===true){I.multiplyScalar(1/I.w);M.multiplyScalar(1/M.w);if(s===
w){La=new THREE.RenderableLine;z.push(La);w++;s++;v=La}else v=z[s++];v.v1.positionScreen.copy(I);v.v2.positionScreen.copy(M);v.z=Math.max(I.z,M.z);v.material=ca.material;B.elements.push(v)}}}}}g=0;for(n=B.sprites.length;g<n;g++){ca=B.sprites[g].object;Ja=ca.matrixWorld;if(ca instanceof THREE.Particle){H.set(Ja.elements[12],Ja.elements[13],Ja.elements[14],1);Q.multiplyVector4(H);H.z=H.z/H.w;if(H.z>0&&H.z<1){if(J===F){fa=new THREE.RenderableParticle;D.push(fa);F++;J++;A=fa}else A=D[J++];A.object=ca;
A.x=H.x/H.w;A.y=H.y/H.w;A.z=H.z;A.rotation=ca.rotation.z;A.scale.x=ca.scale.x*Math.abs(A.x-(H.x+h.projectionMatrix.elements[0])/(H.w+h.projectionMatrix.elements[12]));A.scale.y=ca.scale.y*Math.abs(A.y-(H.y+h.projectionMatrix.elements[5])/(H.w+h.projectionMatrix.elements[13]));A.material=ca.material;B.elements.push(A)}}}N===true&&B.elements.sort(c);return B}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=d!==void 0?d:1};
...
i=g.faceNormals[c];j=g.vertexNormals[c];i.copy(f.normal);if(f instanceof THREE.Face3){j.a.copy(f.vertexNormals[0]);j.b.copy(f.vertexNormals[1]);j.c.copy(f.vertexNormals[2])}else{j.a.copy(f.vertexNormals[0]);j.b.copy(f.vertexNormals[1]);j.c.copy(f.vertexNormals[2]);j.d.copy(f.vertexNormals[3])}}}c=0;for(d=this.faces.length;c<d;c++){f=this.faces[c];f.normal=f.__originalFaceNormal;f.vertexNormals=f.__originalVertexNormals}},computeTangents:function(){function a(a,b,c,d,f,e,H){h=a.vertices[b];i=a.vertices[c];
j=a.vertices[d];l=g[f];n=g[e];m=g[H];q=i.x-h.x;o=j.x-h.x;p=i.y-h.y;r=j.y-h.y;t=i.z-h.z;u=j.z-h.z;v=n.u-l.u;s=m.u-l.u;z=n.v-l.v;w=m.v-l.v;A=1/(v*w-s*z);B.set((w*q-z*o)*A,(w*p-z*r)*A,(w*t-z*u)*A);E.set((v*o-s*q)*A,(v*r-s*p)*A,(v*u-s*t)*A);D[b].addSelf(B);D[c].addSelf(B);D[d].addSelf(B);F[b].addSelf(E);F[c].addSelf(E);F[d].addSelf(E)}var b,c,d,f,e,g,h,i,j,l,n,m,q,o,p,r,t,u,v,s,z,w,A,J,D=[],F=[],B=new THREE.Vector3,E=new THREE.Vector3,H=new THREE.Vector3,Q=new THREE.Vector3,L=new THREE.Vector3;b=0;for(c=
this.vertices.length;b<c;b++){D[b]=new THREE.Vector3;F[b]=new THREE.Vector3}b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];g=this.faceVertexUvs[0][b];if(e instanceof THREE.Face3)a(this,e.a,e.b,e.c,0,1,2);else if(e instanceof THREE.Face4){a(this,e.a,e.b,e.d,0,1,3);a(this,e.b,e.c,e.d,1,2,3)}}var K=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];for(d=0;d<e.vertexNormals.length;d++){L.copy(e.vertexNormals[d]);f=e[K[d]];J=D[f];H.copy(J);H.subSelf(L.multiplyScalar(L.dot(J))).normalize();
Q.cross(e.vertexNormals[d],J);f=Q.dot(F[f]);f=f<0?-1:1;e.vertexTangents[d]=new THREE.Vector4(H.x,H.y,H.z,f)}}this.hasTangents=true},computeBoundingBox:function(){if(!this.boundingBox)this.boundingBox={min:new THREE.Vector3,max:new THREE.Vector3};if(this.vertices.length>0){var a;a=this.vertices[0];this.boundingBox.min.copy(a);this.boundingBox.max.copy(a);for(var b=this.boundingBox.min,c=this.boundingBox.max,d=1,f=this.vertices.length;d<f;d++){a=this.vertices[d];if(a.x<b.x)b.x=a.x;else if(a.x>c.x)c.x=
...
0}var f=this.offsets,e=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,n,m,q,o=new THREE.Vector3,p=new THREE.Vector3,r=new THREE.Vector3,t=new THREE.Vector3,u=new THREE.Vector3;c=0;for(d=f.length;c<d;++c){b=f[c].start;i=f[c].count;var v=f[c].index;a=b;for(b=b+i;a<b;a=a+3){i=v+e[a];j=v+e[a+1];l=v+e[a+2];n=g[i*3];m=g[i*3+1];q=g[i*3+2];o.set(n,m,q);n=g[j*3];m=g[j*3+1];q=g[j*3+2];p.set(n,m,q);n=g[l*3];m=g[l*3+1];q=g[l*3+2];r.set(n,m,q);t.sub(r,p);u.sub(o,
p);t.crossSelf(u);h[i*3]=h[i*3]+t.x;h[i*3+1]=h[i*3+1]+t.y;h[i*3+2]=h[i*3+2]+t.z;h[j*3]=h[j*3]+t.x;h[j*3+1]=h[j*3+1]+t.y;h[j*3+2]=h[j*3+2]+t.z;h[l*3]=h[l*3]+t.x;h[l*3+1]=h[l*3+1]+t.y;h[l*3+2]=h[l*3+2]+t.z}}a=0;for(b=h.length;a<b;a=a+3){n=h[a];m=h[a+1];q=h[a+2];c=1/Math.sqrt(n*n+m*m+q*q);h[a]=h[a]*c;h[a+1]=h[a+1]*c;h[a+2]=h[a+2]*c}this.normalsNeedUpdate=true}},computeTangents:function(){function a(a){Z.x=d[a*3];Z.y=d[a*3+1];Z.z=d[a*3+2];ea.copy(Z);fa=i[a];M.copy(fa);M.subSelf(Z.multiplyScalar(Z.dot(fa))).normalize();
T.cross(ea,fa);S=T.dot(j[a]);N=S<0?-1:1;h[a*4]=M.x;h[a*4+1]=M.y;h[a*4+2]=M.z;h[a*4+3]=N}if(this.attributes.index===void 0||this.attributes.position===void 0||this.attributes.normal===void 0||this.attributes.uv===void 0)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,e=c.length/3;if(this.attributes.tangent===
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<e;g++){i[g]=new THREE.Vector3;j[g]=new THREE.Vector3}var l,n,m,q,o,p,r,t,u,v,s,z,w,A,J,e=new THREE.Vector3,g=new THREE.Vector3,D,F,B,E,H,Q,L,K=this.offsets;B=0;for(E=K.length;B<E;++B){F=K[B].start;H=K[B].count;var I=K[B].index;D=F;for(F=F+H;D<F;D=D+3){H=I+b[D];Q=I+b[D+1];L=I+b[D+2];l=c[H*3];n=c[H*3+1];m=c[H*3+2];q=c[Q*3];o=c[Q*3+1];p=c[Q*3+2];r=c[L*3];
t=c[L*3+1];u=c[L*3+2];v=f[H*2];s=f[H*2+1];z=f[Q*2];w=f[Q*2+1];A=f[L*2];J=f[L*2+1];q=q-l;l=r-l;o=o-n;n=t-n;p=p-m;m=u-m;z=z-v;v=A-v;w=w-s;s=J-s;J=1/(z*s-v*w);e.set((s*q-w*l)*J,(s*o-w*n)*J,(s*p-w*m)*J);g.set((z*l-v*q)*J,(z*n-v*o)*J,(z*m-v*p)*J);i[H].addSelf(e);i[Q].addSelf(e);i[L].addSelf(e);j[H].addSelf(g);j[Q].addSelf(g);j[L].addSelf(g)}}var M=new THREE.Vector3,T=new THREE.Vector3,Z=new THREE.Vector3,ea=new THREE.Vector3,N,fa,S;B=0;for(E=K.length;B<E;++B){F=K[B].start;H=K[B].count;I=K[B].index;D=F;
for(F=F+H;D<F;D=D+3){H=I+b[D];Q=I+b[D+1];L=I+b[D+2];a(H);a(Q);a(L)}}this.tangentsNeedUpdate=this.hasTangents=true}}};
...
Math.log(a)/Math.LN2;return Math.floor(a)==a}function d(a){a=Math.log(a)/Math.LN2;return Math.pow(2,Math.round(a))}function f(a,f,e,h,i,j,r){var t=e.toLowerCase().endsWith(".dds"),u=b+"/"+e;if(t){var v=THREE.ImageUtils.loadCompressedTexture(u);a[f]=v}else{v=document.createElement("canvas");a[f]=new THREE.Texture(v)}a[f].sourceFile=e;if(h){a[f].repeat.set(h[0],h[1]);if(h[0]!==1)a[f].wrapS=THREE.RepeatWrapping;if(h[1]!==1)a[f].wrapT=THREE.RepeatWrapping}i&&a[f].offset.set(i[0],i[1]);if(j){e={repeat:THREE.RepeatWrapping,
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,j,l,n,m,q,o,p,r,t,u,v,s;function z(a){return a%4?4-a%4:0}function w(a,b){return(new Uint8Array(a,b,1))[0]}function A(a,b){return(new Uint32Array(a,b,1))[0]}function J(b,c){var d,f,e,g,h,i,j,l,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=I[f*2];f=I[f*2+1];i=I[e*2];j=I[e*2+1];e=I[g*2];l=I[g*2+1];g=Q.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,j));m.push(new THREE.UV(e,
l));g.push(m)}}function D(b,c){var d,f,e,g,h,i,j,l,n,m,p=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){f=p[d*4];e=p[d*4+1];g=p[d*4+2];h=p[d*4+3];i=I[f*2];f=I[f*2+1];j=I[e*2];n=I[e*2+1];l=I[g*2];m=I[g*2+1];g=I[h*2];e=I[h*2+1];h=Q.faceVertexUvs[0];var o=[];o.push(new THREE.UV(i,f));o.push(new THREE.UV(j,n));o.push(new THREE.UV(l,m));o.push(new THREE.UV(g,e));h.push(o)}}function F(b,c,d){for(var f,e,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*3];e=c[d*3+1];g=c[d*3+2];h=i[d];
Q.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function B(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=j[d];Q.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function E(b,c,d,f){for(var e,g,h,i,j,l,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];j=d[f*3];l=d[f*3+1];n=d[f*3+2];i=m[f];var p=K[l*3],o=K[l*3+1];l=K[l*3+2];var q=K[n*3],
r=K[n*3+1];n=K[n*3+2];Q.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(K[j*3],K[j*3+1],K[j*3+2]),new THREE.Vector3(p,o,l),new THREE.Vector3(q,r,n)],null,i))}}function H(b,c,d,f){for(var e,g,h,i,j,l,n,m,p,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),o=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];l=d[f*4];n=d[f*4+1];m=d[f*4+2];p=d[f*4+3];j=o[f];var q=K[n*3],r=K[n*3+1];n=K[n*3+2];var s=K[m*3],t=K[m*3+1];m=K[m*3+2];var u=K[p*3],v=K[p*3+1];p=K[p*3+2];Q.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(K[l*3],K[l*3+1],K[l*3+2]),new THREE.Vector3(q,r,n),new THREE.Vector3(s,t,m),new THREE.Vector3(u,v,p)],null,j))}}var Q=this,L=0,K=[],I=[],M,T,Z;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(Q,d,b);s=a;T=L;b=new Uint8Array(s,T,12);p="";for(u=0;u<12;u++)p=p+String.fromCharCode(b[T+u]);c=w(s,T+12);w(s,T+13);w(s,T+14);w(s,T+15);f=w(s,T+16);i=w(s,T+17);j=w(s,T+18);l=w(s,T+19);n=A(s,T+20);m=A(s,T+20+4);q=A(s,T+20+8);o=A(s,T+20+12);p=A(s,T+20+16);r=A(s,T+20+20);t=
A(s,T+20+24);u=A(s,T+20+28);b=A(s,T+20+32);v=A(s,T+20+36);s=A(s,T+20+40);L=L+c;T=f*3+l;Z=f*4+l;M=o*T;c=p*(T+i*3);f=r*(T+j*3);l=t*(T+i*3+j*3);T=u*Z;i=b*(Z+i*4);j=v*(Z+j*4);Z=L;var L=new Float32Array(a,L,n*3),ea,N,fa,S;for(ea=0;ea<n;ea++){N=L[ea*3];fa=L[ea*3+1];S=L[ea*3+2];Q.vertices.push(new THREE.Vector3(N,fa,S))}n=L=Z+n*3*Float32Array.BYTES_PER_ELEMENT;if(m){L=new Int8Array(a,L,m*3);for(Z=0;Z<m;Z++){ea=L[Z*3];N=L[Z*3+1];fa=L[Z*3+2];K.push(ea/127,N/127,fa/127)}}L=n+m*3*Int8Array.BYTES_PER_ELEMENT;
m=L=L+z(m*3);if(q){L=new Float32Array(a,L,q*2);for(n=0;n<q;n++){Z=L[n*2];ea=L[n*2+1];I.push(Z,ea)}}q=L=m+q*2*Float32Array.BYTES_PER_ELEMENT;M=q+M+z(o*2);m=M+c+z(p*2);c=m+f+z(r*2);f=c+l+z(t*2);T=f+T+z(u*2);l=T+i+z(b*2);i=l+j+z(v*2);if(r){j=m+r*Uint32Array.BYTES_PER_ELEMENT*3;F(r,m,j+r*Uint32Array.BYTES_PER_ELEMENT*3);J(r,j)}if(t){r=c+t*Uint32Array.BYTES_PER_ELEMENT*3;j=r+t*Uint32Array.BYTES_PER_ELEMENT*3;E(t,c,r,j+t*Uint32Array.BYTES_PER_ELEMENT*3);J(t,j)}if(v){t=l+v*Uint32Array.BYTES_PER_ELEMENT*
4;B(v,l,t+v*Uint32Array.BYTES_PER_ELEMENT*4);D(v,t)}if(s){v=i+s*Uint32Array.BYTES_PER_ELEMENT*4;t=v+s*Uint32Array.BYTES_PER_ELEMENT*4;H(s,i,v,t+s*Uint32Array.BYTES_PER_ELEMENT*4);D(s,t)}o&&F(o,q,q+o*Uint32Array.BYTES_PER_ELEMENT*3);if(p){o=M+p*Uint32Array.BYTES_PER_ELEMENT*3;E(p,M,o,o+p*Uint32Array.BYTES_PER_ELEMENT*3)}u&&B(u,f,f+u*Uint32Array.BYTES_PER_ELEMENT*4);if(b){p=T+b*Uint32Array.BYTES_PER_ELEMENT*4;H(b,T,p,p+b*Uint32Array.BYTES_PER_ELEMENT*4)}this.computeCentroids();this.computeFaceNormals();
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,j,l,n,m,q,o,p,r,t,u,v=a.faces;q=a.vertices;var s=a.normals,z=a.colors,w=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&w++;for(e=0;e<w;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}c=0;for(i=q.length;c<i;){j=new THREE.Vector3;j.x=q[c++]*f;j.y=q[c++]*f;j.z=q[c++]*f;d.vertices.push(j)}c=0;for(i=v.length;c<i;){q=v[c++];j=q&1;h=q&2;e=q&4;g=q&8;n=q&
16;l=q&32;o=q&64;q=q&128;if(j){p=new THREE.Face4;p.a=v[c++];p.b=v[c++];p.c=v[c++];p.d=v[c++];j=4}else{p=new THREE.Face3;p.a=v[c++];p.b=v[c++];p.c=v[c++];j=3}if(h){h=v[c++];p.materialIndex=h}h=d.faces.length;if(e)for(e=0;e<w;e++){r=a.uvs[e];m=v[c++];u=r[m*2];m=r[m*2+1];d.faceUvs[e][h]=new THREE.UV(u,m)}if(g)for(e=0;e<w;e++){r=a.uvs[e];t=[];for(g=0;g<j;g++){m=v[c++];u=r[m*2];m=r[m*2+1];t[g]=new THREE.UV(u,m)}d.faceVertexUvs[e][h]=t}if(n){n=v[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];
p.normal=g}if(l)for(e=0;e<j;e++){n=v[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];p.vertexNormals.push(g)}if(o){l=v[c++];l=new THREE.Color(z[l]);p.color=l}if(q)for(e=0;e<j;e++){l=v[c++];l=new THREE.Color(z[l]);p.vertexColors.push(l)}d.faces.push(p)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c=c+2){v=a.skinWeights[c];s=a.skinWeights[c+1];d.skinWeights.push(new THREE.Vector4(v,s,0,0))}}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c=c+2){v=a.skinIndices[c];s=a.skinIndices[c+
1];d.skinIndices.push(new THREE.Vector4(v,s,0,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets!==void 0){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];z=d.morphTargets[c].vertices;w=a.morphTargets[c].vertices;v=0;for(s=w.length;v<s;v=v+3){q=new THREE.Vector3;q.x=w[v]*f;q.y=w[v+1]*f;q.z=w[v+2]*f;z.push(q)}}}if(a.morphColors!==void 0){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};
d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=[];s=d.morphColors[c].colors;z=a.morphColors[c].colors;f=0;for(v=z.length;f<v;f=f+3){w=new THREE.Color(16755200);w.setRGB(z[f],z[f+1],z[f+2]);s.push(w)}}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};THREE.GeometryLoader=function(){THREE.EventTarget.call(this);this.path=this.crossOrigin=null};
...
m}}var g=a.faces,o=a.vertices,m=a.normals,j=a.colors,l=0;if(a.uvs)for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&l++;for(e=0;e<l;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}n=0;for(q=o.length;n<q;){var p=new THREE.Vector3;p.x=o[n++]*f;p.y=o[n++]*f;p.z=o[n++]*f;d.vertices.push(p)}n=0;for(q=g.length;n<q;){var r=g[n++],t=r&2,e=r&4,u=r&8,v=r&16,o=r&32,s=r&64,p=r&128;if(r&1){r=new THREE.Face4;r.a=g[n++];r.b=g[n++];r.c=g[n++];r.d=g[n++];var z=4}else{r=new THREE.Face3;r.a=g[n++];r.b=g[n++];r.c=g[n++];z=3}if(t){t=
g[n++];r.materialIndex=t}var w=d.faces.length;if(e)for(e=0;e<l;e++){var A=a.uvs[e],t=g[n++],J=A[t*2],t=A[t*2+1];d.faceUvs[e][w]=new THREE.UV(J,t)}if(u)for(e=0;e<l;e++){for(var A=a.uvs[e],u=[],D=0;D<z;D++){t=g[n++];J=A[t*2];t=A[t*2+1];u[D]=new THREE.UV(J,t)}d.faceVertexUvs[e][w]=u}if(v){v=g[n++]*3;t=new THREE.Vector3;t.x=m[v++];t.y=m[v++];t.z=m[v];r.normal=t}if(o)for(e=0;e<z;e++){v=g[n++]*3;t=new THREE.Vector3;t.x=m[v++];t.y=m[v++];t.z=m[v];r.vertexNormals.push(t)}if(s){o=g[n++];r.color=new THREE.Color(j[o])}if(p)for(e=
0;e<z;e++){o=g[n++];r.vertexColors.push(new THREE.Color(j[o]))}d.faces.push(r)}if(a.skinWeights){e=0;for(g=a.skinWeights.length;e<g;e=e+2)d.skinWeights.push(new THREE.Vector4(a.skinWeights[e],a.skinWeights[e+1],0,0))}if(a.skinIndices){e=0;for(g=a.skinIndices.length;e<g;e=e+2){m=0;d.skinIndices.push(new THREE.Vector4(a.skinIndices[e],a.skinIndices[e+1],m,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets){e=0;for(g=a.morphTargets.length;e<g;e++){d.morphTargets[e]={};d.morphTargets[e].name=
a.morphTargets[e].name;d.morphTargets[e].vertices=[];m=d.morphTargets[e].vertices;j=a.morphTargets[e].vertices;t=0;for(l=j.length;t<l;t=t+3){p=new THREE.Vector3;p.x=j[t]*f;p.y=j[t+1]*f;p.z=j[t+2]*f;m.push(p)}}}if(a.morphColors){e=0;for(g=a.morphColors.length;e<g;e++){d.morphColors[e]={};d.morphColors[e].name=a.morphColors[e].name;d.morphColors[e].colors=[];f=d.morphColors[e].colors;j=a.morphColors[e].colors;m=0;for(l=j.length;m<l;m=m+3){n=new THREE.Color(16755200);n.setRGB(j[m],j[m+1],j[m+2]);f.push(n)}}}d.computeCentroids();
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return b=="relativeToHTML"?a:j+"/"+a}function f(a,b){for(var c in b)if(I.objects[c]===void 0){var d=b[c],e=null;if(d.geometry!==void 0){if(J=I.geometries[d.geometry]){e=false;D=I.materials[d.materials[0]];(e=D instanceof THREE.ShaderMaterial)&&J.computeTangents();u=d.position;v=d.rotation;s=d.quaternion;z=d.scale;r=d.matrix;s=0;d.materials.length===0&&(D=new THREE.MeshFaceMaterial);d.materials.length>1&&(D=new THREE.MeshFaceMaterial);
if(d.morph){e=new THREE.MorphAnimMesh(J,D);if(d.duration!==void 0)e.duration=d.duration;if(d.time!==void 0)e.time=d.time;if(d.mirroredLoop!==void 0)e.mirroredLoop=d.mirroredLoop;D.morphNormals&&J.computeMorphNormals()}else e=new THREE.Mesh(J,D);e.name=c;if(r){e.matrixAutoUpdate=false;e.matrix.set(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15])}else{e.position.set(u[0],u[1],u[2]);if(s){e.quaternion.set(s[0],s[1],s[2],s[3]);e.useQuaternion=true}else e.rotation.set(v[0],
v[1],v[2]);e.scale.set(z[0],z[1],z[2])}e.visible=d.visible;e.castShadow=d.castShadow;e.receiveShadow=d.receiveShadow;a.add(e);I.objects[c]=e}}else{u=d.position;v=d.rotation;s=d.quaternion;z=d.scale;s=0;e=new THREE.Object3D;e.name=c;e.position.set(u[0],u[1],u[2]);if(s){e.quaternion.set(s[0],s[1],s[2],s[3]);e.useQuaternion=true}else e.rotation.set(v[0],v[1],v[2]);e.scale.set(z[0],z[1],z[2]);e.visible=d.visible!==void 0?d.visible:false;a.add(e);I.objects[c]=e;I.empties[c]=e}if(e){if(d.properties!==void 0)for(var g in d.properties)e.properties[g]=
d.properties[g];d.children!==void 0&&f(e,d.children)}}}function e(a){return function(b){I.geometries[a]=b;f(I.scene,M.objects);H=H-1;i.onLoadComplete();h()}}function g(a){return function(b){I.geometries[a]=b}}function h(){i.callbackProgress({totalModels:L,totalTextures:K,loadedModels:L-H,loadedTextures:K-Q},I);i.onLoadProgress();H===0&&Q===0&&b(I)}var i=this,j=THREE.Loader.prototype.extractUrlBase(c),l,n,m,q,o,p,r,t,u,v,s,z,w,A,J,D,F,B,E,H,Q,L,K,I,M=a;for(w in this.geometryHandlerMap)this.geometryHandlerMap[w].loaderObject=
new this.geometryHandlerMap[w].loaderClass;Q=H=0;I={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(M.transform){a=M.transform.position;c=M.transform.rotation;w=M.transform.scale;a&&I.scene.position.set(a[0],a[1],a[2]);c&&I.scene.rotation.set(c[0],c[1],c[2]);w&&I.scene.scale.set(w[0],w[1],w[2]);if(a||c||w){I.scene.updateMatrix();I.scene.updateMatrixWorld()}}a=function(a){return function(){Q=Q-a;h();i.onLoadComplete()}};for(q in M.cameras){w=
M.cameras[q];w.type==="perspective"?F=new THREE.PerspectiveCamera(w.fov,w.aspect,w.near,w.far):w.type==="ortho"&&(F=new THREE.OrthographicCamera(w.left,w.right,w.top,w.bottom,w.near,w.far));u=w.position;c=w.target;w=w.up;F.position.set(u[0],u[1],u[2]);F.target=new THREE.Vector3(c[0],c[1],c[2]);w&&F.up.set(w[0],w[1],w[2]);I.cameras[q]=F}for(m in M.lights){c=M.lights[m];q=c.color!==void 0?c.color:16777215;F=c.intensity!==void 0?c.intensity:1;if(c.type==="directional"){u=c.direction;t=new THREE.DirectionalLight(q,
F);t.position.set(u[0],u[1],u[2]);t.position.normalize()}else if(c.type==="point"){u=c.position;t=c.distance;t=new THREE.PointLight(q,F,t);t.position.set(u[0],u[1],u[2])}else c.type==="ambient"&&(t=new THREE.AmbientLight(q));I.scene.add(t);I.lights[m]=t}for(o in M.fogs){m=M.fogs[o];m.type==="linear"?B=new THREE.Fog(0,m.near,m.far):m.type==="exp2"&&(B=new THREE.FogExp2(0,m.density));w=m.color;B.color.setRGB(w[0],w[1],w[2]);I.fogs[o]=B}if(I.cameras&&M.defaults.camera)I.currentCamera=I.cameras[M.defaults.camera];
if(I.fogs&&M.defaults.fog)I.scene.fog=I.fogs[M.defaults.fog];w=M.defaults.bgcolor;I.bgColor=new THREE.Color;I.bgColor.setRGB(w[0],w[1],w[2]);I.bgColorAlpha=M.defaults.bgalpha;for(l in M.geometries){o=M.geometries[l];if(o.type in this.geometryHandlerMap){H=H+1;i.onLoadStart()}}L=H;for(l in M.geometries){o=M.geometries[l];if(o.type==="cube"){J=new THREE.CubeGeometry(o.width,o.height,o.depth,o.segmentsWidth,o.segmentsHeight,o.segmentsDepth,null,o.flipped,o.sides);I.geometries[l]=J}else if(o.type==="plane"){J=
new THREE.PlaneGeometry(o.width,o.height,o.segmentsWidth,o.segmentsHeight);I.geometries[l]=J}else if(o.type==="sphere"){J=new THREE.SphereGeometry(o.radius,o.segmentsWidth,o.segmentsHeight);I.geometries[l]=J}else if(o.type==="cylinder"){J=new THREE.CylinderGeometry(o.topRad,o.botRad,o.height,o.radSegs,o.heightSegs);I.geometries[l]=J}else if(o.type==="torus"){J=new THREE.TorusGeometry(o.radius,o.tube,o.segmentsR,o.segmentsT);I.geometries[l]=J}else if(o.type==="icosahedron"){J=new THREE.IcosahedronGeometry(o.radius,
o.subdivisions);I.geometries[l]=J}else if(o.type in this.geometryHandlerMap){B={};for(E in o)E!=="type"&&E!=="url"&&(B[E]=o[E]);this.geometryHandlerMap[o.type].loaderObject.load(d(o.url,M.urlBaseType),e(l),B)}else if(o.type==="embedded"){o=M.embeds[o.id];o.metadata=M.metadata;o&&this.geometryHandlerMap.ascii.loaderObject.createModel(o,g(l),"")}}for(p in M.textures){l=M.textures[p];if(l.url instanceof Array){Q=Q+l.url.length;for(E=0;E<l.url.length;E++)i.onLoadStart()}else{Q=Q+1;i.onLoadStart()}}K=
Q;for(p in M.textures){l=M.textures[p];if(l.mapping!==void 0&&THREE[l.mapping]!==void 0)l.mapping=new THREE[l.mapping];if(l.url instanceof Array){o=l.url.length;B=[];for(E=0;E<o;E++)B[E]=d(l.url[E],M.urlBaseType);E=(E=B[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(B,l.mapping,a(o)):THREE.ImageUtils.loadTextureCube(B,l.mapping,a(o))}else{E=l.url.toLowerCase().endsWith(".dds");o=d(l.url,M.urlBaseType);B=a(1);E=E?THREE.ImageUtils.loadCompressedTexture(o,l.mapping,B):THREE.ImageUtils.loadTexture(o,
l.mapping,B);if(THREE[l.minFilter]!==void 0)E.minFilter=THREE[l.minFilter];if(THREE[l.magFilter]!==void 0)E.magFilter=THREE[l.magFilter];if(l.anisotropy)E.anisotropy=l.anisotropy;if(l.repeat){E.repeat.set(l.repeat[0],l.repeat[1]);if(l.repeat[0]!==1)E.wrapS=THREE.RepeatWrapping;if(l.repeat[1]!==1)E.wrapT=THREE.RepeatWrapping}l.offset&&E.offset.set(l.offset[0],l.offset[1]);if(l.wrap){o={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(o[l.wrap[0]]!==void 0)E.wrapS=o[l.wrap[0]];if(o[l.wrap[1]]!==
void 0)E.wrapT=o[l.wrap[1]]}}I.textures[p]=E}for(n in M.materials){r=M.materials[n];for(A in r.parameters)if(A==="envMap"||A==="map"||A==="lightMap"||A==="bumpMap")r.parameters[A]=I.textures[r.parameters[A]];else if(A==="shading")r.parameters[A]=r.parameters[A]==="flat"?THREE.FlatShading:THREE.SmoothShading;else if(A==="side")r.parameters[A]=r.parameters[A]=="double"?THREE.DoubleSide:r.parameters[A]=="back"?THREE.BackSide:THREE.FrontSide;else if(A==="blending")r.parameters[A]=r.parameters[A]in THREE?
THREE[r.parameters[A]]:THREE.NormalBlending;else if(A==="combine")r.parameters[A]=r.parameters[A]=="MixOperation"?THREE.MixOperation:THREE.MultiplyOperation;else if(A==="vertexColors")if(r.parameters[A]=="face")r.parameters[A]=THREE.FaceColors;else{if(r.parameters[A])r.parameters[A]=THREE.VertexColors}else if(A==="wrapRGB"){p=r.parameters[A];r.parameters[A]=new THREE.Vector3(p[0],p[1],p[2])}if(r.parameters.opacity!==void 0&&r.parameters.opacity<1)r.parameters.transparent=true;if(r.parameters.normalMap){p=
THREE.ShaderUtils.lib.normal;a=THREE.UniformsUtils.clone(p.uniforms);l=r.parameters.color;E=r.parameters.specular;o=r.parameters.ambient;B=r.parameters.shininess;a.tNormal.value=I.textures[r.parameters.normalMap];r.parameters.normalScale&&a.uNormalScale.value.set(r.parameters.normalScale[0],r.parameters.normalScale[1]);if(r.parameters.map){a.tDiffuse.value=r.parameters.map;a.enableDiffuse.value=true}if(r.parameters.envMap){a.tCube.value=r.parameters.envMap;a.enableReflection.value=true;a.uReflectivity.value=
...
THREE.CanvasRenderer=function(a){function b(a){if(u!==a)u=p.globalAlpha=a}function c(a){if(v!==a){if(a===THREE.NormalBlending)p.globalCompositeOperation="source-over";else if(a===THREE.AdditiveBlending)p.globalCompositeOperation="lighter";else if(a===THREE.SubtractiveBlending)p.globalCompositeOperation="darker";v=a}}function d(a){if(s!==a)s=p.strokeStyle=a}function f(a){if(z!==a)z=p.fillStyle=a}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},e=this,g,h,i,j=new THREE.Projector,l=a.canvas!==
void 0?a.canvas:document.createElement("canvas"),n,m,q,o,p=l.getContext("2d"),r=new THREE.Color(0),t=0,u=1,v=0,s=null,z=null,w=null,A=null,J=null,D,F,B,E,H=new THREE.RenderableVertex,Q=new THREE.RenderableVertex,L,K,I,M,T,Z,ea,N,fa,S,ra,wa,O=new THREE.Color,ga=new THREE.Color,P=new THREE.Color,X=new THREE.Color,ia=new THREE.Color,$=new THREE.Color,ca=new THREE.Color,Ja={},ua={},La,Wa,oa,Xa,kb,Ta,gb,rb,Qb,fb,bb=new THREE.Rectangle,Ma=new THREE.Rectangle,za=new THREE.Rectangle,xb=false,Ga=new THREE.Color,
sb=new THREE.Color,hb=new THREE.Color,xa=new THREE.Vector3,ib,ab,Ya,Ha,yb,k,a=16;ib=document.createElement("canvas");ib.width=ib.height=2;ab=ib.getContext("2d");ab.fillStyle="rgba(0,0,0,1)";ab.fillRect(0,0,2,2);Ya=ab.getImageData(0,0,2,2);Ha=Ya.data;yb=document.createElement("canvas");yb.width=yb.height=a;k=yb.getContext("2d");k.translate(-a/2,-a/2);k.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=true;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,
b){n=a;m=b;q=Math.floor(n/2);o=Math.floor(m/2);l.width=n;l.height=m;bb.set(-q,-o,q,o);Ma.set(-q,-o,q,o);u=1;v=0;J=A=w=z=s=null};this.setClearColor=function(a,b){r.copy(a);t=b!==void 0?b:1;Ma.set(-q,-o,q,o)};this.setClearColorHex=function(a,b){r.setHex(a);t=b!==void 0?b:1;Ma.set(-q,-o,q,o)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){p.setTransform(1,0,0,-1,q,o);if(Ma.isEmpty()===false){Ma.minSelf(bb);Ma.inflate(2);t<1&&p.clearRect(Math.floor(Ma.getX()),Math.floor(Ma.getY()),Math.floor(Ma.getWidth()),
Math.floor(Ma.getHeight()));if(t>0){c(THREE.NormalBlending);b(1);f("rgba("+Math.floor(r.r*255)+","+Math.floor(r.g*255)+","+Math.floor(r.b*255)+","+t+")");p.fillRect(Math.floor(Ma.getX()),Math.floor(Ma.getY()),Math.floor(Ma.getWidth()),Math.floor(Ma.getHeight()))}Ma.empty()}};this.render=function(a,l){function n(a,b,c){for(var d=0,f=i.length;d<f;d++){var e=i[d],g=e.color;if(e instanceof THREE.DirectionalLight){var h=e.matrixWorld.getPosition().normalize(),k=b.dot(h);if(!(k<=0)){k=k*e.intensity;c.r=
c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}else if(e instanceof THREE.PointLight){h=e.matrixWorld.getPosition();k=b.dot(xa.sub(h,a).normalize());if(!(k<=0)){k=k*(e.distance==0?1:1-Math.min(a.distanceTo(h)/e.distance,1));if(k!=0){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}}}}function m(a,d,f,g,h,i,k,j){e.info.render.vertices=e.info.render.vertices+3;e.info.render.faces++;b(j.opacity);c(j.blending);L=a.positionScreen.x;K=a.positionScreen.y;I=d.positionScreen.x;M=d.positionScreen.y;T=f.positionScreen.x;
Z=f.positionScreen.y;r(L,K,I,M,T,Z);if((j instanceof THREE.MeshLambertMaterial||j instanceof THREE.MeshPhongMaterial)&&j.map===null&&j.map===null){$.copy(j.color);ca.copy(j.emissive);if(j.vertexColors===THREE.FaceColors){$.r=$.r*k.color.r;$.g=$.g*k.color.g;$.b=$.b*k.color.b}if(xb===true)if(j.wireframe===false&&j.shading==THREE.SmoothShading&&k.vertexNormalsLength==3){ga.r=P.r=X.r=Ga.r;ga.g=P.g=X.g=Ga.g;ga.b=P.b=X.b=Ga.b;n(k.v1.positionWorld,k.vertexNormalsWorld[0],ga);n(k.v2.positionWorld,k.vertexNormalsWorld[1],
P);n(k.v3.positionWorld,k.vertexNormalsWorld[2],X);ga.r=ga.r*$.r+ca.r;ga.g=ga.g*$.g+ca.g;ga.b=ga.b*$.b+ca.b;P.r=P.r*$.r+ca.r;P.g=P.g*$.g+ca.g;P.b=P.b*$.b+ca.b;X.r=X.r*$.r+ca.r;X.g=X.g*$.g+ca.g;X.b=X.b*$.b+ca.b;ia.r=(P.r+X.r)*0.5;ia.g=(P.g+X.g)*0.5;ia.b=(P.b+X.b)*0.5;oa=Ec(ga,P,X,ia);ic(L,K,I,M,T,Z,0,0,1,0,0,1,oa)}else{O.r=Ga.r;O.g=Ga.g;O.b=Ga.b;n(k.centroidWorld,k.normalWorld,O);O.r=O.r*$.r+ca.r;O.g=O.g*$.g+ca.g;O.b=O.b*$.b+ca.b;j.wireframe===true?t(O,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):
u(O)}else j.wireframe===true?t(j.color,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):u(j.color)}else if(j instanceof THREE.MeshBasicMaterial||j instanceof THREE.MeshLambertMaterial||j instanceof THREE.MeshPhongMaterial)if(j.map!==null){if(j.map.mapping instanceof THREE.UVMapping){Xa=k.uvs[0];Ea(L,K,I,M,T,Z,Xa[g].u,Xa[g].v,Xa[h].u,Xa[h].v,Xa[i].u,Xa[i].v,j.map)}}else if(j.envMap!==null){if(j.envMap.mapping instanceof THREE.SphericalReflectionMapping){a=l.matrixWorldInverse;xa.copy(k.vertexNormalsWorld[g]);
kb=(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])*0.5+0.5;Ta=(xa.x*a.elements[1]+xa.y*a.elements[5]+xa.z*a.elements[9])*0.5+0.5;xa.copy(k.vertexNormalsWorld[h]);gb=(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])*0.5+0.5;rb=(xa.x*a.elements[1]+xa.y*a.elements[5]+xa.z*a.elements[9])*0.5+0.5;xa.copy(k.vertexNormalsWorld[i]);Qb=(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])*0.5+0.5;fb=(xa.x*a.elements[1]+xa.y*a.elements[5]+xa.z*a.elements[9])*0.5+0.5;Ea(L,K,I,M,T,Z,
kb,Ta,gb,rb,Qb,fb,j.envMap)}}else{O.copy(j.color);if(j.vertexColors===THREE.FaceColors){O.r=O.r*k.color.r;O.g=O.g*k.color.g;O.b=O.b*k.color.b}j.wireframe===true?t(O,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):u(O)}else if(j instanceof THREE.MeshDepthMaterial){La=l.near;Wa=l.far;ga.r=ga.g=ga.b=1-fc(a.positionScreen.z,La,Wa);P.r=P.g=P.b=1-fc(d.positionScreen.z,La,Wa);X.r=X.g=X.b=1-fc(f.positionScreen.z,La,Wa);ia.r=(P.r+X.r)*0.5;ia.g=(P.g+X.g)*0.5;ia.b=(P.b+X.b)*0.5;oa=Ec(ga,P,X,ia);
ic(L,K,I,M,T,Z,0,0,1,0,0,1,oa)}else if(j instanceof THREE.MeshNormalMaterial){O.r=v(k.normalWorld.x);O.g=v(k.normalWorld.y);O.b=v(k.normalWorld.z);j.wireframe===true?t(O,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):u(O)}}function r(a,b,c,d,f,e){p.beginPath();p.moveTo(a,b);p.lineTo(c,d);p.lineTo(f,e);p.closePath()}function s(a,b,c,d,f,e,g,h){p.beginPath();p.moveTo(a,b);p.lineTo(c,d);p.lineTo(f,e);p.lineTo(g,h);p.closePath()}function t(a,b,c,f){if(w!==b)w=p.lineWidth=b;if(A!==c)A=p.lineCap=
c;if(J!==f)J=p.lineJoin=f;d(a.getContextStyle());p.stroke();za.inflate(b*2)}function u(a){f(a.getContextStyle());p.fill()}function Ea(a,b,c,d,e,g,h,i,k,j,l,n,m){if(!(m instanceof THREE.DataTexture||m.image===void 0||m.image.width==0)){if(m.needsUpdate===true){var Ea=m.wrapS==THREE.RepeatWrapping,o=m.wrapT==THREE.RepeatWrapping;Ja[m.id]=p.createPattern(m.image,Ea===true&&o===true?"repeat":Ea===true&&o===false?"repeat-x":Ea===false&&o===true?"repeat-y":"no-repeat");m.needsUpdate=false}Ja[m.id]===void 0?
f("rgba(0,0,0,1)"):f(Ja[m.id]);var Ea=m.offset.x/m.repeat.x,o=m.offset.y/m.repeat.y,q=m.image.width*m.repeat.x,r=m.image.height*m.repeat.y,h=(h+Ea)*q,i=(1-i+o)*r,c=c-a,d=d-b,e=e-a,g=g-b,k=(k+Ea)*q-h,j=(1-j+o)*r-i,l=(l+Ea)*q-h,n=(1-n+o)*r-i,Ea=k*n-l*j;if(Ea===0){if(ua[m.id]===void 0){b=document.createElement("canvas");b.width=m.image.width;b.height=m.image.height;b=b.getContext("2d");b.drawImage(m.image,0,0);ua[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data}b=ua[m.id];h=(Math.floor(h)+
Math.floor(i)*m.image.width)*4;O.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255);u(O)}else{Ea=1/Ea;m=(n*c-j*e)*Ea;j=(n*d-j*g)*Ea;c=(k*e-l*c)*Ea;d=(k*g-l*d)*Ea;a=a-m*h-c*i;h=b-j*h-d*i;p.save();p.transform(m,j,c,d,a,h);p.fill();p.restore()}}}function ic(a,b,c,d,f,e,g,h,i,k,j,l,n){var m,Ea;m=n.width-1;Ea=n.height-1;g=g*m;h=h*Ea;c=c-a;d=d-b;f=f-a;e=e-b;i=i*m-g;k=k*Ea-h;j=j*m-g;l=l*Ea-h;Ea=1/(i*l-j*k);m=(l*c-k*f)*Ea;k=(l*d-k*e)*Ea;c=(i*f-j*c)*Ea;d=(i*e-j*d)*Ea;a=a-m*g-c*h;b=b-k*g-d*h;p.save();p.transform(m,k,c,
d,a,b);p.clip();p.drawImage(n,0,0);p.restore()}function Ec(a,b,c,d){Ha[0]=a.r*255|0;Ha[1]=a.g*255|0;Ha[2]=a.b*255|0;Ha[4]=b.r*255|0;Ha[5]=b.g*255|0;Ha[6]=b.b*255|0;Ha[8]=c.r*255|0;Ha[9]=c.g*255|0;Ha[10]=c.b*255|0;Ha[12]=d.r*255|0;Ha[13]=d.g*255|0;Ha[14]=d.b*255|0;ab.putImageData(Ya,0,0);k.drawImage(ib,0,0);return yb}function fc(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function v(a){a=(a+1)*0.5;return a<0?0:a>1?1:a}function z(a,b){var c=b.x-a.x,d=b.y-a.y,f=c*c+d*d;if(f!==0){f=1/Math.sqrt(f);c=c*f;d=
d*f;b.x=b.x+c;b.y=b.y+d;a.x=a.x-c;a.y=a.y-d}}if(l instanceof THREE.Camera===false)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{var Xb,Gc,ka,aa;this.autoClear===true?this.clear():p.setTransform(1,0,0,-1,q,o);e.info.render.vertices=0;e.info.render.faces=0;g=j.projectScene(a,l,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;xb=i.length>0;if(xb===true){Ga.setRGB(0,0,0);sb.setRGB(0,0,0);hb.setRGB(0,0,0);Xb=0;for(Gc=i.length;Xb<Gc;Xb++){aa=i[Xb];
var la=aa.color;if(aa instanceof THREE.AmbientLight){Ga.r=Ga.r+la.r;Ga.g=Ga.g+la.g;Ga.b=Ga.b+la.b}else if(aa instanceof THREE.DirectionalLight){sb.r=sb.r+la.r;sb.g=sb.g+la.g;sb.b=sb.b+la.b}else if(aa instanceof THREE.PointLight){hb.r=hb.r+la.r;hb.g=hb.g+la.g;hb.b=hb.b+la.b}}}Xb=0;for(Gc=h.length;Xb<Gc;Xb++){ka=h[Xb];aa=ka.material;if(!(aa===void 0||aa.visible===false)){za.empty();if(ka instanceof THREE.RenderableParticle){D=ka;D.x=D.x*q;D.y=D.y*o;var la=D,Za=ka;b(aa.opacity);c(aa.blending);var tb=
void 0,ub=void 0,lb=void 0,mb=void 0,lc=ka=void 0,Vc=void 0;if(aa instanceof THREE.ParticleBasicMaterial)if(aa.map===null){lb=Za.object.scale.x;mb=Za.object.scale.y;lb=lb*Za.scale.x*q;mb=mb*Za.scale.y*o;za.set(la.x-lb,la.y-mb,la.x+lb,la.y+mb);if(bb.intersects(za)!==false){f(aa.color.getContextStyle());p.save();p.translate(la.x,la.y);p.rotate(-Za.rotation);p.scale(lb,mb);p.fillRect(-1,-1,2,2);p.restore()}}else{ka=aa.map.image;lc=ka.width>>1;Vc=ka.height>>1;lb=Za.scale.x*q;mb=Za.scale.y*o;tb=lb*lc;
ub=mb*Vc;za.set(la.x-tb,la.y-ub,la.x+tb,la.y+ub);if(bb.intersects(za)!==false){p.save();p.translate(la.x,la.y);p.rotate(-Za.rotation);p.scale(lb,-mb);p.translate(-lc,-Vc);p.drawImage(ka,0,0);p.restore()}}else if(aa instanceof THREE.ParticleCanvasMaterial){tb=Za.scale.x*q;ub=Za.scale.y*o;za.set(la.x-tb,la.y-ub,la.x+tb,la.y+ub);if(bb.intersects(za)!==false){d(aa.color.getContextStyle());f(aa.color.getContextStyle());p.save();p.translate(la.x,la.y);p.rotate(-Za.rotation);p.scale(tb,ub);aa.program(p);
p.restore()}}}else if(ka instanceof THREE.RenderableLine){D=ka.v1;F=ka.v2;D.positionScreen.x=D.positionScreen.x*q;D.positionScreen.y=D.positionScreen.y*o;F.positionScreen.x=F.positionScreen.x*q;F.positionScreen.y=F.positionScreen.y*o;za.addPoint(D.positionScreen.x,D.positionScreen.y);za.addPoint(F.positionScreen.x,F.positionScreen.y);if(bb.intersects(za)===true){la=D;Za=F;b(aa.opacity);c(aa.blending);p.beginPath();p.moveTo(la.positionScreen.x,la.positionScreen.y);p.lineTo(Za.positionScreen.x,Za.positionScreen.y);
if(aa instanceof THREE.LineBasicMaterial){la=aa.linewidth;if(w!==la)w=p.lineWidth=la;la=aa.linecap;if(A!==la)A=p.lineCap=la;la=aa.linejoin;if(J!==la)J=p.lineJoin=la;d(aa.color.getContextStyle());p.stroke();za.inflate(aa.linewidth*2)}}}else if(ka instanceof THREE.RenderableFace3){D=ka.v1;F=ka.v2;B=ka.v3;D.positionScreen.x=D.positionScreen.x*q;D.positionScreen.y=D.positionScreen.y*o;F.positionScreen.x=F.positionScreen.x*q;F.positionScreen.y=F.positionScreen.y*o;B.positionScreen.x=B.positionScreen.x*
q;B.positionScreen.y=B.positionScreen.y*o;if(aa.overdraw===true){z(D.positionScreen,F.positionScreen);z(F.positionScreen,B.positionScreen);z(B.positionScreen,D.positionScreen)}za.add3Points(D.positionScreen.x,D.positionScreen.y,F.positionScreen.x,F.positionScreen.y,B.positionScreen.x,B.positionScreen.y);bb.intersects(za)===true&&m(D,F,B,0,1,2,ka,aa,a)}else if(ka instanceof THREE.RenderableFace4){D=ka.v1;F=ka.v2;B=ka.v3;E=ka.v4;D.positionScreen.x=D.positionScreen.x*q;D.positionScreen.y=D.positionScreen.y*
o;F.positionScreen.x=F.positionScreen.x*q;F.positionScreen.y=F.positionScreen.y*o;B.positionScreen.x=B.positionScreen.x*q;B.positionScreen.y=B.positionScreen.y*o;E.positionScreen.x=E.positionScreen.x*q;E.positionScreen.y=E.positionScreen.y*o;H.positionScreen.copy(F.positionScreen);Q.positionScreen.copy(E.positionScreen);if(aa.overdraw===true){z(D.positionScreen,F.positionScreen);z(F.positionScreen,E.positionScreen);z(E.positionScreen,D.positionScreen);z(B.positionScreen,H.positionScreen);z(B.positionScreen,
Q.positionScreen)}za.addPoint(D.positionScreen.x,D.positionScreen.y);za.addPoint(F.positionScreen.x,F.positionScreen.y);za.addPoint(B.positionScreen.x,B.positionScreen.y);za.addPoint(E.positionScreen.x,E.positionScreen.y);if(bb.intersects(za)===true){la=D;Za=F;tb=B;ub=E;lb=H;mb=Q;lc=a;e.info.render.vertices=e.info.render.vertices+4;e.info.render.faces++;b(aa.opacity);c(aa.blending);if(aa.map!==void 0&&aa.map!==null||aa.envMap!==void 0&&aa.envMap!==null){m(la,Za,ub,0,1,3,ka,aa,lc);m(lb,tb,mb,1,2,3,
ka,aa,lc)}else{L=la.positionScreen.x;K=la.positionScreen.y;I=Za.positionScreen.x;M=Za.positionScreen.y;T=tb.positionScreen.x;Z=tb.positionScreen.y;ea=ub.positionScreen.x;N=ub.positionScreen.y;fa=lb.positionScreen.x;S=lb.positionScreen.y;ra=mb.positionScreen.x;wa=mb.positionScreen.y;if(aa instanceof THREE.MeshLambertMaterial||aa instanceof THREE.MeshPhongMaterial){$.copy(aa.color);ca.copy(aa.emissive);if(aa.vertexColors===THREE.FaceColors){$.r=$.r*ka.color.r;$.g=$.g*ka.color.g;$.b=$.b*ka.color.b}if(xb===
true)if(aa.wireframe===false&&aa.shading==THREE.SmoothShading&&ka.vertexNormalsLength==4){ga.r=P.r=X.r=ia.r=Ga.r;ga.g=P.g=X.g=ia.g=Ga.g;ga.b=P.b=X.b=ia.b=Ga.b;n(ka.v1.positionWorld,ka.vertexNormalsWorld[0],ga);n(ka.v2.positionWorld,ka.vertexNormalsWorld[1],P);n(ka.v4.positionWorld,ka.vertexNormalsWorld[3],X);n(ka.v3.positionWorld,ka.vertexNormalsWorld[2],ia);ga.r=ga.r*$.r+ca.r;ga.g=ga.g*$.g+ca.g;ga.b=ga.b*$.b+ca.b;P.r=P.r*$.r+ca.r;P.g=P.g*$.g+ca.g;P.b=P.b*$.b+ca.b;X.r=X.r*$.r+ca.r;X.g=X.g*$.g+ca.g;
X.b=X.b*$.b+ca.b;ia.r=ia.r*$.r+ca.r;ia.g=ia.g*$.g+ca.g;ia.b=ia.b*$.b+ca.b;oa=Ec(ga,P,X,ia);r(L,K,I,M,ea,N);ic(L,K,I,M,ea,N,0,0,1,0,0,1,oa);r(fa,S,T,Z,ra,wa);ic(fa,S,T,Z,ra,wa,1,0,1,1,0,1,oa)}else{O.r=Ga.r;O.g=Ga.g;O.b=Ga.b;n(ka.centroidWorld,ka.normalWorld,O);O.r=O.r*$.r+ca.r;O.g=O.g*$.g+ca.g;O.b=O.b*$.b+ca.b;s(L,K,I,M,T,Z,ea,N);aa.wireframe===true?t(O,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(O)}else{O.r=$.r+ca.r;O.g=$.g+ca.g;O.b=$.b+ca.b;s(L,K,I,M,T,Z,ea,N);aa.wireframe===
true?t(O,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(O)}}else if(aa instanceof THREE.MeshBasicMaterial){O.copy(aa.color);if(aa.vertexColors===THREE.FaceColors){O.r=O.r*ka.color.r;O.g=O.g*ka.color.g;O.b=O.b*ka.color.b}s(L,K,I,M,T,Z,ea,N);aa.wireframe===true?t(O,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(O)}else if(aa instanceof THREE.MeshNormalMaterial){O.r=v(ka.normalWorld.x);O.g=v(ka.normalWorld.y);O.b=v(ka.normalWorld.z);s(L,K,I,M,T,Z,ea,N);aa.wireframe===
true?t(O,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(O)}else if(aa instanceof THREE.MeshDepthMaterial){La=l.near;Wa=l.far;ga.r=ga.g=ga.b=1-fc(la.positionScreen.z,La,Wa);P.r=P.g=P.b=1-fc(Za.positionScreen.z,La,Wa);X.r=X.g=X.b=1-fc(ub.positionScreen.z,La,Wa);ia.r=ia.g=ia.b=1-fc(tb.positionScreen.z,La,Wa);oa=Ec(ga,P,X,ia);r(L,K,I,M,ea,N);ic(L,K,I,M,ea,N,0,0,1,0,0,1,oa);r(fa,S,T,Z,ra,wa);ic(fa,S,T,Z,ra,wa,1,0,1,1,0,1,oa)}}}}Ma.addRectangle(za)}}p.setTransform(1,0,0,1,0,0)}}};
...
c,d;for(b in a.attributes){d=b==="index"?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;c=a.attributes[b];c.buffer=k.createBuffer();k.bindBuffer(d,c.buffer);k.bufferData(d,c.array,k.STATIC_DRAW)}}function g(a,b,c){var d,f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,p=a.verticesNeedUpdate,o=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){ib.copy(xa);ib.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];ab.copy(f);ib.multiplyVector3(ab);
n[d]=[ab.z,d]}n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[n[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[n[d][1]];m[e]=f.r;m[e+1]=f.g;m[e+2]=f.b}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.boundTo===void 0||h.boundTo==="vertices"){e=0;f=h.value.length;if(h.size===1)for(d=0;d<f;d++){g=n[d][1];h.array[d]=h.value[g]}else if(h.size===2)for(d=0;d<f;d++){g=n[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;e=e+2}else if(h.size===3)if(h.type==="c")for(d=0;d<
f;d++){g=n[d][1];g=h.value[g];h.array[e]=g.r;h.array[e+1]=g.g;h.array[e+2]=g.b;e=e+3}else for(d=0;d<f;d++){g=n[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;h.array[e+2]=g.z;e=e+3}else if(h.size===4)for(d=0;d<f;d++){g=n[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;h.array[e+2]=g.z;h.array[e+3]=g.w;e=e+4}}}}}else{if(p)for(d=0;d<g;d++){f=h[d];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}if(o)for(d=0;d<j;d++){f=i[d];e=d*3;m[e]=f.r;m[e+1]=f.g;m[e+2]=f.b}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.needsUpdate&&
...
i.buffer);k.bufferData(k.ARRAY_BUFFER,i.array,b)}if(a.tangentsNeedUpdate&&d!==void 0){k.bindBuffer(k.ARRAY_BUFFER,d.buffer);k.bufferData(k.ARRAY_BUFFER,d.array,b)}if(c)for(var j in a.attributes)delete a.attributes[j].array}function i(a,b){return b.z-a.z}function j(a,b){return b[1]-a[1]}function l(a,b,c){if(a.length)for(var d=0,e=a.length;d<e;d++){ia=O=null;P=X=ua=Ja=Ta=kb=La=-1;Ha=true;a[d].render(b,c,Ga,sb);ia=O=null;P=X=ua=Ja=Ta=kb=La=-1;Ha=true}}function n(a,b,c,d,e,f,g,h){var i,k,j,l;if(b){k=
a.length-1;l=b=-1}else{k=0;b=a.length;l=1}for(var m=k;m!==b;m=m+l){i=a[m];if(i.render){k=i.object;j=i.buffer;if(h)i=h;else{i=i[c];if(!i)continue;g&&S.setBlending(i.blending,i.blendEquation,i.blendSrc,i.blendDst);S.setDepthTest(i.depthTest);S.setDepthWrite(i.depthWrite);A(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits)}S.setMaterialFaces(i);j instanceof THREE.BufferGeometry?S.renderBufferDirect(d,e,f,i,j,k):S.renderBuffer(d,e,f,i,j,k)}}}function m(a,b,c,d,e,f,g){for(var h,i,k=0,j=a.length;k<
j;k++){h=a[k];i=h.object;if(i.visible){if(g)h=g;else{h=h[b];if(!h)continue;f&&S.setBlending(h.blending,h.blendEquation,h.blendSrc,h.blendDst);S.setDepthTest(h.depthTest);S.setDepthWrite(h.depthWrite);A(h.polygonOffset,h.polygonOffsetFactor,h.polygonOffsetUnits)}S.renderImmediateObject(c,d,e,h,i)}}}function q(a,b,c){a.push({buffer:b,object:c,opaque:null,transparent:null})}function o(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return true;return false}function p(a){for(var b in a.attributes)a.attributes[b].needsUpdate=
false}function r(a,b){for(var c=a.length-1;c>=0;c--)a[c].object===b&&a.splice(c,1)}function t(a,b){for(var c=a.length-1;c>=0;c--)a[c]===b&&a.splice(c,1)}function u(a,b,c,d,e){ca=0;if(d.needsUpdate){d.program&&S.deallocateMaterial(d);S.initMaterial(d,b,c,e);d.needsUpdate=false}if(d.morphTargets&&!e.__webglMorphTargetInfluences)e.__webglMorphTargetInfluences=new Float32Array(S.maxMorphTargets);var f=false,g=d.program,h=g.uniforms,i=d.uniforms;if(g!==O){k.useProgram(g);O=g;f=true}if(d.id!==P){P=d.id;
f=true}if(f||a!==ia){k.uniformMatrix4fv(h.projectionMatrix,false,a._projectionMatrixArray);a!==ia&&(ia=a)}if(d.skinning)if(kc&&e.useVertexTexture){if(h.boneTexture!==null){var j=v();k.uniform1i(h.boneTexture,j);S.setTexture(e.boneTexture,j)}}else h.boneGlobalMatrices!==null&&k.uniformMatrix4fv(h.boneGlobalMatrices,false,e.boneMatrices);if(f){if(c&&d.fog){i.fogColor.value=c.color;if(c instanceof THREE.Fog){i.fogNear.value=c.near;i.fogFar.value=c.far}else if(c instanceof THREE.FogExp2)i.fogDensity.value=
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(Ha){for(var l=0,m=0,n=0,p,o,q,r,s=yb,t=s.directional.colors,u=s.directional.positions,A=s.point.colors,D=s.point.positions,E=s.point.distances,B=s.spot.colors,J=s.spot.positions,K=s.spot.distances,I=s.spot.directions,L=s.spot.angles,M=s.spot.exponents,N=s.hemi.skyColors,X=s.hemi.groundColors,$=s.hemi.positions,ga=0,T=0,ea=0,fa=0,c=p=q=q=o=0,f=b.length;c<f;c++){j=b[c];if(!j.onlyShadow&&j.visible){p=
j.color;r=j.intensity;o=j.distance;if(j instanceof THREE.AmbientLight)if(S.gammaInput){l=l+p.r*p.r;m=m+p.g*p.g;n=n+p.b*p.b}else{l=l+p.r;m=m+p.g;n=n+p.b}else if(j instanceof THREE.DirectionalLight){o=ga*3;S.gammaInput?z(t,o,p,r*r):w(t,o,p,r);Ya.copy(j.matrixWorld.getPosition());Ya.subSelf(j.target.matrixWorld.getPosition());Ya.normalize();u[o]=Ya.x;u[o+1]=Ya.y;u[o+2]=Ya.z;ga=ga+1}else if(j instanceof THREE.PointLight){q=T*3;S.gammaInput?z(A,q,p,r*r):w(A,q,p,r);r=j.matrixWorld.getPosition();D[q]=r.x;
D[q+1]=r.y;D[q+2]=r.z;E[T]=o;T=T+1}else if(j instanceof THREE.SpotLight){q=ea*3;S.gammaInput?z(B,q,p,r*r):w(B,q,p,r);r=j.matrixWorld.getPosition();J[q]=r.x;J[q+1]=r.y;J[q+2]=r.z;K[ea]=o;Ya.copy(r);Ya.subSelf(j.target.matrixWorld.getPosition());Ya.normalize();I[q]=Ya.x;I[q+1]=Ya.y;I[q+2]=Ya.z;L[ea]=Math.cos(j.angle);M[ea]=j.exponent;ea=ea+1}else if(j instanceof THREE.HemisphereLight){o=j.color;q=j.groundColor;p=fa*3;if(S.gammaInput){r=r*r;z(N,p,o,r);z(X,p,q,r)}else{w(N,p,o,r);w(X,p,q,r)}r=j.matrixWorld.getPosition();
$[p]=r.x;$[p+1]=r.y;$[p+2]=r.z;fa=fa+1}}}c=ga*3;for(f=t.length;c<f;c++)t[c]=0;c=T*3;for(f=A.length;c<f;c++)A[c]=0;c=ea*3;for(f=B.length;c<f;c++)B[c]=0;c=fa*3;for(f=N.length;c<f;c++)N[c]=0;c=fa*3;for(f=X.length;c<f;c++)X[c]=0;s.directional.length=ga;s.point.length=T;s.spot.length=ea;s.hemi.length=fa;s.ambient[0]=l;s.ambient[1]=m;s.ambient[2]=n;Ha=false}c=yb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;
...
c.hemi.positions}if(d instanceof THREE.MeshBasicMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.MeshPhongMaterial){i.opacity.value=d.opacity;S.gammaInput?i.diffuse.value.copyGammaToLinear(d.color):i.diffuse.value=d.color;i.map.value=d.map;i.lightMap.value=d.lightMap;i.specularMap.value=d.specularMap;if(d.bumpMap){i.bumpMap.value=d.bumpMap;i.bumpScale.value=d.bumpScale}if(d.normalMap){i.normalMap.value=d.normalMap;i.normalScale.value.copy(d.normalScale)}var Z;if(d.map)Z=d.map;
else if(d.specularMap)Z=d.specularMap;else if(d.normalMap)Z=d.normalMap;else if(d.bumpMap)Z=d.bumpMap;if(Z!==void 0){c=Z.offset;Z=Z.repeat;i.offsetRepeat.value.set(c.x,c.y,Z.x,Z.y)}i.envMap.value=d.envMap;i.flipEnvMap.value=d.envMap instanceof THREE.WebGLRenderTargetCube?1:-1;i.reflectivity.value=d.reflectivity;i.refractionRatio.value=d.refractionRatio;i.combine.value=d.combine;i.useRefract.value=d.envMap&&d.envMap.mapping instanceof THREE.CubeRefractionMapping}if(d instanceof THREE.LineBasicMaterial){i.diffuse.value=
d.color;i.opacity.value=d.opacity}else if(d instanceof THREE.ParticleBasicMaterial){i.psColor.value=d.color;i.opacity.value=d.opacity;i.size.value=d.size;i.scale.value=Q.height/2;i.map.value=d.map}else if(d instanceof THREE.MeshPhongMaterial){i.shininess.value=d.shininess;if(S.gammaInput){i.ambient.value.copyGammaToLinear(d.ambient);i.emissive.value.copyGammaToLinear(d.emissive);i.specular.value.copyGammaToLinear(d.specular)}else{i.ambient.value=d.ambient;i.emissive.value=d.emissive;i.specular.value=
d.specular}d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)}else if(d instanceof THREE.MeshLambertMaterial){if(S.gammaInput){i.ambient.value.copyGammaToLinear(d.ambient);i.emissive.value.copyGammaToLinear(d.emissive)}else{i.ambient.value=d.ambient;i.emissive.value=d.emissive}d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)}else if(d instanceof THREE.MeshDepthMaterial){i.mNear.value=a.near;i.mFar.value=a.far;i.opacity.value=d.opacity}else if(d instanceof THREE.MeshNormalMaterial)i.opacity.value=d.opacity;
if(e.receiveShadow&&!d._shadowPass&&i.shadowMatrix){c=Z=0;for(f=b.length;c<f;c++){j=b[c];if(j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade)){i.shadowMap.value[Z]=j.shadowMap;i.shadowMapSize.value[Z]=j.shadowMapSize;i.shadowMatrix.value[Z]=j.shadowMatrix;i.shadowDarkness.value[Z]=j.shadowDarkness;i.shadowBias.value[Z]=j.shadowBias;Z++}}}b=d.uniformsList;i=0;for(Z=b.length;i<Z;i++)if(f=g.uniforms[b[i][1]]){c=b[i][0];l=c.type;j=c.value;if(l==="i")k.uniform1i(f,
j);else if(l==="f")k.uniform1f(f,j);else if(l==="v2")k.uniform2f(f,j.x,j.y);else if(l==="v3")k.uniform3f(f,j.x,j.y,j.z);else if(l==="v4")k.uniform4f(f,j.x,j.y,j.z,j.w);else if(l==="c")k.uniform3f(f,j.r,j.g,j.b);else if(l==="iv1")k.uniform1iv(f,j);else if(l==="iv")k.uniform3iv(f,j);else if(l==="fv1")k.uniform1fv(f,j);else if(l==="fv")k.uniform3fv(f,j);else if(l==="v2v"){if(c._array===void 0)c._array=new Float32Array(2*j.length);l=0;for(m=j.length;l<m;l++){n=l*2;c._array[n]=j[l].x;c._array[n+1]=j[l].y}k.uniform2fv(f,
c._array)}else if(l==="v3v"){if(c._array===void 0)c._array=new Float32Array(3*j.length);l=0;for(m=j.length;l<m;l++){n=l*3;c._array[n]=j[l].x;c._array[n+1]=j[l].y;c._array[n+2]=j[l].z}k.uniform3fv(f,c._array)}else if(l==="v4v"){if(c._array===void 0)c._array=new Float32Array(4*j.length);l=0;for(m=j.length;l<m;l++){n=l*4;c._array[n]=j[l].x;c._array[n+1]=j[l].y;c._array[n+2]=j[l].z;c._array[n+3]=j[l].w}k.uniform4fv(f,c._array)}else if(l==="m4"){if(c._array===void 0)c._array=new Float32Array(16);j.flattenToArray(c._array);
k.uniformMatrix4fv(f,false,c._array)}else if(l==="m4v"){if(c._array===void 0)c._array=new Float32Array(16*j.length);l=0;for(m=j.length;l<m;l++)j[l].flattenToArrayOffset(c._array,l*16);k.uniformMatrix4fv(f,false,c._array)}else if(l==="t"){n=j;j=v();k.uniform1i(f,j);if(n)if(n.image instanceof Array&&n.image.length===6){c=n;f=j;if(c.image.length===6)if(c.needsUpdate){if(!c.image.__webglTextureCube)c.image.__webglTextureCube=k.createTexture();k.activeTexture(k.TEXTURE0+f);k.bindTexture(k.TEXTURE_CUBE_MAP,
c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;l<6;l++)if(S.autoScaleCubemaps&&!f){m=j;n=l;s=c.image[l];u=Uc;if(!(s.width<=u&&s.height<=u)){A=Math.max(s.width,s.height);t=Math.floor(s.width*u/A);u=Math.floor(s.height*u/A);A=document.createElement("canvas");A.width=t;A.height=u;A.getContext("2d").drawImage(s,0,0,s.width,s.height,0,0,t,u);s=A}m[n]=s}else j[l]=c.image[l];l=j[0];m=(l.width&l.width-1)===0&&(l.height&l.height-
1)===0;n=H(c.format);s=H(c.type);F(k.TEXTURE_CUBE_MAP,c,m);for(l=0;l<6;l++)if(f){u=j[l].mipmaps;A=0;for(D=u.length;A<D;A++){t=u[A];k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,A,n,t.width,t.height,0,t.data)}}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,n,n,s,j[l]);c.generateMipmaps&&m&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=false;if(c.onUpdate)c.onUpdate()}else{k.activeTexture(k.TEXTURE0+f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}}else if(n instanceof
THREE.WebGLRenderTargetCube){c=n;k.activeTexture(k.TEXTURE0+j);k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)}else S.setTexture(n,j)}else if(l==="tv"){if(c._array===void 0)c._array=[];l=0;for(m=c.value.length;l<m;l++)c._array[l]=v();k.uniform1iv(f,c._array);l=0;for(m=c.value.length;l<m;l++){n=c.value[l];j=c._array[l];n&&S.setTexture(n,j)}}}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&h.cameraPosition!==null){b=a.matrixWorld.getPosition();k.uniform3f(h.cameraPosition,
b.x,b.y,b.z)}(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&h.viewMatrix!==null&&k.uniformMatrix4fv(h.viewMatrix,false,a._viewMatrixArray)}k.uniformMatrix4fv(h.modelViewMatrix,false,e._modelViewMatrix.elements);h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,false,e._normalMatrix.elements);h.modelMatrix!==null&&k.uniformMatrix4fv(h.modelMatrix,false,e.matrixWorld.elements);return g}function v(){var a=ca;a>=sc&&console.warn("Trying to use "+
a+" texture units while this GPU supports only "+sc);ca=ca+1;return a}function s(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function z(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function w(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function A(a,b,c){if(gb!==a){a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL);gb=a}if(a&&(rb!==b||Qb!==c)){k.polygonOffset(b,c);rb=b;
Qb=c}}function J(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function D(a,b){var c;a==="fragment"?c=k.createShader(k.FRAGMENT_SHADER):a==="vertex"&&(c=k.createShader(k.VERTEX_SHADER));k.shaderSource(c,b);k.compileShader(c);if(!k.getShaderParameter(c,k.COMPILE_STATUS)){console.error(k.getShaderInfoLog(c));console.error(J(b));return null}return c}function F(a,b,c){if(c){k.texParameteri(a,k.TEXTURE_WRAP_S,H(b.wrapS));k.texParameteri(a,k.TEXTURE_WRAP_T,H(b.wrapT));
k.texParameteri(a,k.TEXTURE_MAG_FILTER,H(b.magFilter));k.texParameteri(a,k.TEXTURE_MIN_FILTER,H(b.minFilter))}else{k.texParameteri(a,k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE);k.texParameteri(a,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE);k.texParameteri(a,k.TEXTURE_MAG_FILTER,E(b.magFilter));k.texParameteri(a,k.TEXTURE_MIN_FILTER,E(b.minFilter))}if(Rb&&b.type!==THREE.FloatType&&(b.anisotropy>1||b.__oldAnisotropy)){k.texParameterf(a,Rb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,Fc));b.__oldAnisotropy=b.anisotropy}}
function B(a,b){k.bindRenderbuffer(k.RENDERBUFFER,a);if(b.depthBuffer&&!b.stencilBuffer){k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_COMPONENT16,b.width,b.height);k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_ATTACHMENT,k.RENDERBUFFER,a)}else if(b.depthBuffer&&b.stencilBuffer){k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_STENCIL,b.width,b.height);k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_STENCIL_ATTACHMENT,k.RENDERBUFFER,a)}else k.renderbufferStorage(k.RENDERBUFFER,k.RGBA4,b.width,b.height)}
...
if(a===THREE.SrcAlphaSaturateFactor)return k.SRC_ALPHA_SATURATE;if(zb!==void 0){if(a===THREE.RGB_S3TC_DXT1_Format)return zb.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT1_Format)return zb.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT3_Format)return zb.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===THREE.RGBA_S3TC_DXT5_Format)return zb.COMPRESSED_RGBA_S3TC_DXT5_EXT}return 0}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},Q=a.canvas!==void 0?a.canvas:document.createElement("canvas"),
L=a.precision!==void 0?a.precision:"highp",K=a.alpha!==void 0?a.alpha:true,I=a.premultipliedAlpha!==void 0?a.premultipliedAlpha:true,M=a.antialias!==void 0?a.antialias:false,T=a.stencil!==void 0?a.stencil:true,Z=a.preserveDrawingBuffer!==void 0?a.preserveDrawingBuffer:false,ea=a.clearColor!==void 0?new THREE.Color(a.clearColor):new THREE.Color(0),N=a.clearAlpha!==void 0?a.clearAlpha:0,fa=a.maxLights!==void 0?a.maxLights:4;this.domElement=Q;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=
...
vertices:0,faces:0,points:0}};var S=this,ra=[],wa=0,O=null,ga=null,P=-1,X=null,ia=null,$=0,ca=0,Ja=-1,ua=-1,La=-1,Wa=-1,oa=-1,Xa=-1,kb=-1,Ta=-1,gb=null,rb=null,Qb=null,fb=null,bb=0,Ma=0,za=0,xb=0,Ga=0,sb=0,hb=new THREE.Frustum,xa=new THREE.Matrix4,ib=new THREE.Matrix4,ab=new THREE.Vector4,Ya=new THREE.Vector3,Ha=true,yb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],
...
zb=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");a||console.log("THREE.WebGLRenderer: Float textures not supported.");K||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");Rb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");zb||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");k.clearColor(0,0,0,1);k.clearDepth(1);
k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(ea.r,ea.g,ea.b,N);this.context=k;var sc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),K=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Uc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),Fc=Rb?k.getParameter(Rb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):
0,jc=K>0,kc=jc&&a;zb&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};this.supportsVertexTextures=function(){return jc};this.getMaxAnisotropy=function(){return Fc};this.setSize=function(a,b){Q.width=a;Q.height=b;this.setViewport(0,0,Q.width,Q.height)};this.setViewport=function(a,b,c,d){bb=a!==void 0?a:0;Ma=b!==void 0?b:0;za=c!==void 0?c:Q.width;xb=d!==void 0?d:Q.height;k.viewport(bb,Ma,za,xb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=
function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){ea.setHex(a);N=b;k.clearColor(ea.r,ea.g,ea.b,N)};this.setClearColor=function(a,b){ea.copy(a);N=b;k.clearColor(ea.r,ea.g,ea.b,N)};this.getClearColor=function(){return ea};this.getClearAlpha=function(){return N};this.clear=function(a,b,c){var d=0;if(a===void 0||a)d=d|k.COLOR_BUFFER_BIT;if(b===void 0||b)d=d|k.DEPTH_BUFFER_BIT;if(c===void 0||c)d=d|k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,
...
0&&b.skinWeight>=0){k.bindBuffer(k.ARRAY_BUFFER,f.__webglSkinIndicesBuffer);k.vertexAttribPointer(b.skinIndex,4,k.FLOAT,false,0,0);k.bindBuffer(k.ARRAY_BUFFER,f.__webglSkinWeightsBuffer);k.vertexAttribPointer(b.skinWeight,4,k.FLOAT,false,0,0)}}if(e instanceof THREE.Mesh){if(d.wireframe){d=d.wireframeLinewidth;if(d!==fb){k.lineWidth(d);fb=d}a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,f.__webglLineBuffer);k.drawElements(k.LINES,f.__webglLineCount,k.UNSIGNED_SHORT,0)}else{a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,
f.__webglFaceBuffer);k.drawElements(k.TRIANGLES,f.__webglFaceCount,k.UNSIGNED_SHORT,0)}S.info.render.calls++;S.info.render.vertices=S.info.render.vertices+f.__webglFaceCount;S.info.render.faces=S.info.render.faces+f.__webglFaceCount/3}else if(e instanceof THREE.Line){e=e.type===THREE.LineStrip?k.LINE_STRIP:k.LINES;d=d.linewidth;if(d!==fb){k.lineWidth(d);fb=d}k.drawArrays(e,0,f.__webglLineCount);S.info.render.calls++}else if(e instanceof THREE.ParticleSystem){k.drawArrays(k.POINTS,0,f.__webglParticleCount);
S.info.render.calls++;S.info.render.points=S.info.render.points+f.__webglParticleCount}else if(e instanceof THREE.Ribbon){k.drawArrays(k.TRIANGLE_STRIP,0,f.__webglVertexCount);S.info.render.calls++}}};this.render=function(a,b,c,d){if(b instanceof THREE.Camera===false)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var f,e,g,h,j=a.__lights,p=a.fog;P=-1;Ha=true;this.autoUpdateScene&&a.updateMatrixWorld();b.parent===void 0&&b.updateMatrixWorld();if(!b._viewMatrixArray)b._viewMatrixArray=
new Float32Array(16);if(!b._projectionMatrixArray)b._projectionMatrixArray=new Float32Array(16);b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);xa.multiply(b.projectionMatrix,b.matrixWorldInverse);hb.setFromMatrix(xa);this.autoUpdateObjects&&this.initWebGLObjects(a);l(this.renderPluginsPre,a,b);S.info.render.calls=0;S.info.render.vertices=0;S.info.render.faces=0;S.info.render.points=
0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;for(f=h.length;d<f;d++){e=h[d];g=e.object;e.render=false;if(g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||hb.contains(g))){s(g,b);var o=e,q=o.object,r=o.buffer,t=void 0,t=t=void 0,t=q.material;if(t instanceof THREE.MeshFaceMaterial){t=r.materialIndex;if(t>=0){t=q.geometry.materials[t];if(t.transparent){o.transparent=
t;o.opaque=null}else{o.opaque=t;o.transparent=null}}}else if(t)if(t.transparent){o.transparent=t;o.opaque=null}else{o.opaque=t;o.transparent=null}e.render=true;if(this.sortObjects===true)if(g.renderDepth!==null)e.z=g.renderDepth;else{ab.copy(g.matrixWorld.getPosition());xa.multiplyVector3(ab);e.z=ab.z}}}this.sortObjects&&h.sort(i);h=a.__webglObjectsImmediate;d=0;for(f=h.length;d<f;d++){e=h[d];g=e.object;if(g.visible){s(g,b);g=e.object.material;if(g.transparent){e.transparent=g;e.opaque=null}else{e.opaque=
g;e.transparent=null}}}if(a.overrideMaterial){d=a.overrideMaterial;this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst);this.setDepthTest(d.depthTest);this.setDepthWrite(d.depthWrite);A(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits);n(a.__webglObjects,false,"",b,j,p,true,d);m(a.__webglObjectsImmediate,"",b,j,p,false,d)}else{this.setBlending(THREE.NormalBlending);n(a.__webglObjects,true,"opaque",b,j,p,false);m(a.__webglObjectsImmediate,"opaque",b,j,p,false);n(a.__webglObjects,
false,"transparent",b,j,p,true);m(a.__webglObjectsImmediate,"transparent",b,j,p,true)}l(this.renderPluginsPost,a,b);if(c&&c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&c.minFilter!==THREE.LinearFilter)if(c instanceof THREE.WebGLRenderTargetCube){k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture);k.generateMipmap(k.TEXTURE_CUBE_MAP);k.bindTexture(k.TEXTURE_CUBE_MAP,null)}else{k.bindTexture(k.TEXTURE_2D,c.__webglTexture);k.generateMipmap(k.TEXTURE_2D);k.bindTexture(k.TEXTURE_2D,null)}this.setDepthTest(true);
...
i._modelViewMatrix=new THREE.Matrix4;i._normalMatrix=new THREE.Matrix3;if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.Geometry){if(m.geometryGroups===void 0){var s=m,u=void 0,v=void 0,w=void 0,z=void 0,A=void 0,D=void 0,B=void 0,E={},J=s.morphTargets.length,F=s.morphNormals.length;s.geometryGroups={};u=0;for(v=s.faces.length;u<v;u++){w=s.faces[u];z=w.materialIndex;D=z!==void 0?z:-1;E[D]===void 0&&(E[D]={hash:D,counter:0});B=E[D].hash+"_"+E[D].counter;s.geometryGroups[B]===void 0&&
(s.geometryGroups[B]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:J,numMorphNormals:F});A=w instanceof THREE.Face3?3:4;if(s.geometryGroups[B].vertices+A>65535){E[D].counter=E[D].counter+1;B=E[D].hash+"_"+E[D].counter;s.geometryGroups[B]===void 0&&(s.geometryGroups[B]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:J,numMorphNormals:F})}w instanceof THREE.Face3?s.geometryGroups[B].faces3.push(u):s.geometryGroups[B].faces4.push(u);s.geometryGroups[B].vertices=s.geometryGroups[B].vertices+
A}s.geometryGroupsList=[];var H=void 0;for(H in s.geometryGroups){s.geometryGroups[H].id=$++;s.geometryGroupsList.push(s.geometryGroups[H])}}for(l in m.geometryGroups){n=m.geometryGroups[l];if(!n.__webglVertexBuffer){var O=n;O.__webglVertexBuffer=k.createBuffer();O.__webglNormalBuffer=k.createBuffer();O.__webglTangentBuffer=k.createBuffer();O.__webglColorBuffer=k.createBuffer();O.__webglUVBuffer=k.createBuffer();O.__webglUV2Buffer=k.createBuffer();O.__webglSkinIndicesBuffer=k.createBuffer();O.__webglSkinWeightsBuffer=
k.createBuffer();O.__webglFaceBuffer=k.createBuffer();O.__webglLineBuffer=k.createBuffer();var I=void 0,K=void 0;if(O.numMorphTargets){O.__webglMorphTargetsBuffers=[];I=0;for(K=O.numMorphTargets;I<K;I++)O.__webglMorphTargetsBuffers.push(k.createBuffer())}if(O.numMorphNormals){O.__webglMorphNormalsBuffers=[];I=0;for(K=O.numMorphNormals;I<K;I++)O.__webglMorphNormalsBuffers.push(k.createBuffer())}S.info.memory.geometries++;var P=n,L=i,M=L.geometry,N=P.faces3,Q=P.faces4,X=N.length*3+Q.length*4,ca=N.length*
1+Q.length*2,ga=N.length*3+Q.length*4,T=c(L,P),Z=f(T),ea=d(T),fa=T.vertexColors?T.vertexColors:false;P.__vertexArray=new Float32Array(X*3);if(ea)P.__normalArray=new Float32Array(X*3);if(M.hasTangents)P.__tangentArray=new Float32Array(X*4);if(fa)P.__colorArray=new Float32Array(X*3);if(Z){if(M.faceUvs.length>0||M.faceVertexUvs.length>0)P.__uvArray=new Float32Array(X*2);if(M.faceUvs.length>1||M.faceVertexUvs.length>1)P.__uv2Array=new Float32Array(X*2)}if(L.geometry.skinWeights.length&&L.geometry.skinIndices.length){P.__skinIndexArray=
new Float32Array(X*4);P.__skinWeightArray=new Float32Array(X*4)}P.__faceArray=new Uint16Array(ca*3);P.__lineArray=new Uint16Array(ga*2);var ia=void 0,ra=void 0;if(P.numMorphTargets){P.__morphTargetsArrays=[];ia=0;for(ra=P.numMorphTargets;ia<ra;ia++)P.__morphTargetsArrays.push(new Float32Array(X*3))}if(P.numMorphNormals){P.__morphNormalsArrays=[];ia=0;for(ra=P.numMorphNormals;ia<ra;ia++)P.__morphNormalsArrays.push(new Float32Array(X*3))}P.__webglFaceCount=ca*3;P.__webglLineCount=ga*2;if(T.attributes){if(P.__webglCustomAttributesList===
void 0)P.__webglCustomAttributesList=[];var Ja=void 0;for(Ja in T.attributes){var oa=T.attributes[Ja],ua={},xa;for(xa in oa)ua[xa]=oa[xa];if(!ua.__webglInitialized||ua.createUniqueBuffers){ua.__webglInitialized=true;var wa=1;ua.type==="v2"?wa=2:ua.type==="v3"?wa=3:ua.type==="v4"?wa=4:ua.type==="c"&&(wa=3);ua.size=wa;ua.array=new Float32Array(X*wa);ua.buffer=k.createBuffer();ua.buffer.belongsToAttribute=Ja;oa.needsUpdate=true;ua.__original=oa}P.__webglCustomAttributesList.push(ua)}}P.__inittedArrays=
true;m.verticesNeedUpdate=true;m.morphTargetsNeedUpdate=true;m.elementsNeedUpdate=true;m.uvsNeedUpdate=true;m.normalsNeedUpdate=true;m.tangentsNeedUpdate=true;m.colorsNeedUpdate=true}}}else m instanceof THREE.BufferGeometry&&e(m)}else if(i instanceof THREE.Ribbon){m=i.geometry;if(!m.__webglVertexBuffer){var La=m;La.__webglVertexBuffer=k.createBuffer();La.__webglColorBuffer=k.createBuffer();S.info.memory.geometries++;var za=m,Ga=za.vertices.length;za.__vertexArray=new Float32Array(Ga*3);za.__colorArray=
new Float32Array(Ga*3);za.__webglVertexCount=Ga;m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}}else if(i instanceof THREE.Line){m=i.geometry;if(!m.__webglVertexBuffer){var Ma=m;Ma.__webglVertexBuffer=k.createBuffer();Ma.__webglColorBuffer=k.createBuffer();S.info.memory.geometries++;var Ha=m,Wa=i,Xa=Ha.vertices.length;Ha.__vertexArray=new Float32Array(Xa*3);Ha.__colorArray=new Float32Array(Xa*3);Ha.__webglLineCount=Xa;b(Ha,Wa);m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}}else if(i instanceof
THREE.ParticleSystem){m=i.geometry;if(!m.__webglVertexBuffer)if(m instanceof THREE.Geometry){var Ya=m;Ya.__webglVertexBuffer=k.createBuffer();Ya.__webglColorBuffer=k.createBuffer();S.info.memory.geometries++;var Ta=m,kb=i,bb=Ta.vertices.length;Ta.__vertexArray=new Float32Array(bb*3);Ta.__colorArray=new Float32Array(bb*3);Ta.__sortArray=[];Ta.__webglParticleCount=bb;b(Ta,kb);m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}else m instanceof THREE.BufferGeometry&&e(m)}}if(!i.__webglActive){if(i instanceof
...
THREE.LensFlare&&j.__webglFlares.push(i);i.__webglActive=true}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var nb=a.__objectsRemoved[0],ab=a;nb instanceof THREE.Mesh||nb instanceof THREE.ParticleSystem||nb instanceof THREE.Ribbon||nb instanceof THREE.Line?r(ab.__webglObjects,nb):nb instanceof THREE.Sprite?t(ab.__webglSprites,nb):nb instanceof THREE.LensFlare?t(ab.__webglFlares,nb):(nb instanceof THREE.ImmediateRenderObject||nb.immediateRenderCallback)&&r(ab.__webglObjectsImmediate,
nb);nb.__webglActive=false;a.__objectsRemoved.splice(0,1)}for(var hb=0,sb=a.__webglObjects.length;hb<sb;hb++){var vb=a.__webglObjects[hb].object,ha=vb.geometry,ib=void 0,gb=void 0,cb=void 0;if(vb instanceof THREE.Mesh)if(ha instanceof THREE.BufferGeometry){(ha.verticesNeedUpdate||ha.elementsNeedUpdate||ha.uvsNeedUpdate||ha.normalsNeedUpdate||ha.colorsNeedUpdate||ha.tangentsNeedUpdate)&&h(ha,k.DYNAMIC_DRAW,!ha.dynamic);ha.verticesNeedUpdate=false;ha.elementsNeedUpdate=false;ha.uvsNeedUpdate=false;
ha.normalsNeedUpdate=false;ha.colorsNeedUpdate=false;ha.tangentsNeedUpdate=false}else{for(var rb=0,xb=ha.geometryGroupsList.length;rb<xb;rb++){ib=ha.geometryGroupsList[rb];cb=c(vb,ib);gb=cb.attributes&&o(cb);if(ha.verticesNeedUpdate||ha.morphTargetsNeedUpdate||ha.elementsNeedUpdate||ha.uvsNeedUpdate||ha.normalsNeedUpdate||ha.colorsNeedUpdate||ha.tangentsNeedUpdate||gb){var na=ib,yb=vb,ob=k.DYNAMIC_DRAW,zb=!ha.dynamic,fb=cb;if(na.__inittedArrays){var Rb=d(fb),Qb=fb.vertexColors?fb.vertexColors:false,
jc=f(fb),Hc=Rb===THREE.SmoothShading,C=void 0,Y=void 0,Yb=void 0,R=void 0,mc=void 0,Zb=void 0,wb=void 0,Ic=void 0,Sb=void 0,nc=void 0,oc=void 0,U=void 0,V=void 0,W=void 0,ma=void 0,Ab=void 0,Bb=void 0,Cb=void 0,tc=void 0,Db=void 0,Eb=void 0,Fb=void 0,uc=void 0,Gb=void 0,Hb=void 0,Ib=void 0,vc=void 0,Jb=void 0,Kb=void 0,Lb=void 0,wc=void 0,Mb=void 0,Nb=void 0,Ob=void 0,xc=void 0,sa=void 0,kc=void 0,$b=void 0,pc=void 0,qc=void 0,Pa=void 0,sc=void 0,Na=void 0,Oa=void 0,ac=void 0,Tb=void 0,Fa=0,Ka=0,
Ub=0,Vb=0,pb=0,Ua=0,va=0,$a=0,Ia=0,da=0,ja=0,y=0,ta=void 0,Qa=na.__vertexArray,yc=na.__uvArray,zc=na.__uv2Array,qb=na.__normalArray,Aa=na.__tangentArray,Ra=na.__colorArray,Ba=na.__skinIndexArray,Ca=na.__skinWeightArray,Wc=na.__morphTargetsArrays,Xc=na.__morphNormalsArrays,Yc=na.__webglCustomAttributesList,x=void 0,Pb=na.__faceArray,jb=na.__lineArray,db=yb.geometry,Fc=db.elementsNeedUpdate,cd=db.uvsNeedUpdate,Tc=db.normalsNeedUpdate,Uc=db.tangentsNeedUpdate,jd=db.colorsNeedUpdate,kd=db.morphTargetsNeedUpdate,
gc=db.vertices,pa=na.faces3,qa=na.faces4,Va=db.faces,Zc=db.faceVertexUvs[0],$c=db.faceVertexUvs[1],hc=db.skinIndices,bc=db.skinWeights,cc=db.morphTargets,Jc=db.morphNormals;if(db.verticesNeedUpdate){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];U=gc[R.a];V=gc[R.b];W=gc[R.c];Qa[Ka]=U.x;Qa[Ka+1]=U.y;Qa[Ka+2]=U.z;Qa[Ka+3]=V.x;Qa[Ka+4]=V.y;Qa[Ka+5]=V.z;Qa[Ka+6]=W.x;Qa[Ka+7]=W.y;Qa[Ka+8]=W.z;Ka=Ka+9}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];U=gc[R.a];V=gc[R.b];W=gc[R.c];ma=gc[R.d];Qa[Ka]=U.x;Qa[Ka+1]=U.y;Qa[Ka+
2]=U.z;Qa[Ka+3]=V.x;Qa[Ka+4]=V.y;Qa[Ka+5]=V.z;Qa[Ka+6]=W.x;Qa[Ka+7]=W.y;Qa[Ka+8]=W.z;Qa[Ka+9]=ma.x;Qa[Ka+10]=ma.y;Qa[Ka+11]=ma.z;Ka=Ka+12}k.bindBuffer(k.ARRAY_BUFFER,na.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Qa,ob)}if(kd){Pa=0;for(sc=cc.length;Pa<sc;Pa++){C=ja=0;for(Y=pa.length;C<Y;C++){ac=pa[C];R=Va[ac];U=cc[Pa].vertices[R.a];V=cc[Pa].vertices[R.b];W=cc[Pa].vertices[R.c];Na=Wc[Pa];Na[ja]=U.x;Na[ja+1]=U.y;Na[ja+2]=U.z;Na[ja+3]=V.x;Na[ja+4]=V.y;Na[ja+5]=V.z;Na[ja+6]=W.x;Na[ja+7]=W.y;Na[ja+
8]=W.z;if(fb.morphNormals){if(Hc){Tb=Jc[Pa].vertexNormals[ac];Db=Tb.a;Eb=Tb.b;Fb=Tb.c}else Fb=Eb=Db=Jc[Pa].faceNormals[ac];Oa=Xc[Pa];Oa[ja]=Db.x;Oa[ja+1]=Db.y;Oa[ja+2]=Db.z;Oa[ja+3]=Eb.x;Oa[ja+4]=Eb.y;Oa[ja+5]=Eb.z;Oa[ja+6]=Fb.x;Oa[ja+7]=Fb.y;Oa[ja+8]=Fb.z}ja=ja+9}C=0;for(Y=qa.length;C<Y;C++){ac=qa[C];R=Va[ac];U=cc[Pa].vertices[R.a];V=cc[Pa].vertices[R.b];W=cc[Pa].vertices[R.c];ma=cc[Pa].vertices[R.d];Na=Wc[Pa];Na[ja]=U.x;Na[ja+1]=U.y;Na[ja+2]=U.z;Na[ja+3]=V.x;Na[ja+4]=V.y;Na[ja+5]=V.z;Na[ja+6]=W.x;
Na[ja+7]=W.y;Na[ja+8]=W.z;Na[ja+9]=ma.x;Na[ja+10]=ma.y;Na[ja+11]=ma.z;if(fb.morphNormals){if(Hc){Tb=Jc[Pa].vertexNormals[ac];Db=Tb.a;Eb=Tb.b;Fb=Tb.c;uc=Tb.d}else uc=Fb=Eb=Db=Jc[Pa].faceNormals[ac];Oa=Xc[Pa];Oa[ja]=Db.x;Oa[ja+1]=Db.y;Oa[ja+2]=Db.z;Oa[ja+3]=Eb.x;Oa[ja+4]=Eb.y;Oa[ja+5]=Eb.z;Oa[ja+6]=Fb.x;Oa[ja+7]=Fb.y;Oa[ja+8]=Fb.z;Oa[ja+9]=uc.x;Oa[ja+10]=uc.y;Oa[ja+11]=uc.z}ja=ja+12}k.bindBuffer(k.ARRAY_BUFFER,na.__webglMorphTargetsBuffers[Pa]);k.bufferData(k.ARRAY_BUFFER,Wc[Pa],ob);if(fb.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,
na.__webglMorphNormalsBuffers[Pa]);k.bufferData(k.ARRAY_BUFFER,Xc[Pa],ob)}}}if(bc.length){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];Jb=bc[R.a];Kb=bc[R.b];Lb=bc[R.c];Ca[da]=Jb.x;Ca[da+1]=Jb.y;Ca[da+2]=Jb.z;Ca[da+3]=Jb.w;Ca[da+4]=Kb.x;Ca[da+5]=Kb.y;Ca[da+6]=Kb.z;Ca[da+7]=Kb.w;Ca[da+8]=Lb.x;Ca[da+9]=Lb.y;Ca[da+10]=Lb.z;Ca[da+11]=Lb.w;Mb=hc[R.a];Nb=hc[R.b];Ob=hc[R.c];Ba[da]=Mb.x;Ba[da+1]=Mb.y;Ba[da+2]=Mb.z;Ba[da+3]=Mb.w;Ba[da+4]=Nb.x;Ba[da+5]=Nb.y;Ba[da+6]=Nb.z;Ba[da+7]=Nb.w;Ba[da+8]=Ob.x;Ba[da+9]=Ob.y;
Ba[da+10]=Ob.z;Ba[da+11]=Ob.w;da=da+12}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];Jb=bc[R.a];Kb=bc[R.b];Lb=bc[R.c];wc=bc[R.d];Ca[da]=Jb.x;Ca[da+1]=Jb.y;Ca[da+2]=Jb.z;Ca[da+3]=Jb.w;Ca[da+4]=Kb.x;Ca[da+5]=Kb.y;Ca[da+6]=Kb.z;Ca[da+7]=Kb.w;Ca[da+8]=Lb.x;Ca[da+9]=Lb.y;Ca[da+10]=Lb.z;Ca[da+11]=Lb.w;Ca[da+12]=wc.x;Ca[da+13]=wc.y;Ca[da+14]=wc.z;Ca[da+15]=wc.w;Mb=hc[R.a];Nb=hc[R.b];Ob=hc[R.c];xc=hc[R.d];Ba[da]=Mb.x;Ba[da+1]=Mb.y;Ba[da+2]=Mb.z;Ba[da+3]=Mb.w;Ba[da+4]=Nb.x;Ba[da+5]=Nb.y;Ba[da+6]=Nb.z;Ba[da+7]=
Nb.w;Ba[da+8]=Ob.x;Ba[da+9]=Ob.y;Ba[da+10]=Ob.z;Ba[da+11]=Ob.w;Ba[da+12]=xc.x;Ba[da+13]=xc.y;Ba[da+14]=xc.z;Ba[da+15]=xc.w;da=da+16}if(da>0){k.bindBuffer(k.ARRAY_BUFFER,na.__webglSkinIndicesBuffer);k.bufferData(k.ARRAY_BUFFER,Ba,ob);k.bindBuffer(k.ARRAY_BUFFER,na.__webglSkinWeightsBuffer);k.bufferData(k.ARRAY_BUFFER,Ca,ob)}}if(jd&&Qb){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];wb=R.vertexColors;Ic=R.color;if(wb.length===3&&Qb===THREE.VertexColors){Gb=wb[0];Hb=wb[1];Ib=wb[2]}else Ib=Hb=Gb=Ic;Ra[Ia]=
Gb.r;Ra[Ia+1]=Gb.g;Ra[Ia+2]=Gb.b;Ra[Ia+3]=Hb.r;Ra[Ia+4]=Hb.g;Ra[Ia+5]=Hb.b;Ra[Ia+6]=Ib.r;Ra[Ia+7]=Ib.g;Ra[Ia+8]=Ib.b;Ia=Ia+9}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];wb=R.vertexColors;Ic=R.color;if(wb.length===4&&Qb===THREE.VertexColors){Gb=wb[0];Hb=wb[1];Ib=wb[2];vc=wb[3]}else vc=Ib=Hb=Gb=Ic;Ra[Ia]=Gb.r;Ra[Ia+1]=Gb.g;Ra[Ia+2]=Gb.b;Ra[Ia+3]=Hb.r;Ra[Ia+4]=Hb.g;Ra[Ia+5]=Hb.b;Ra[Ia+6]=Ib.r;Ra[Ia+7]=Ib.g;Ra[Ia+8]=Ib.b;Ra[Ia+9]=vc.r;Ra[Ia+10]=vc.g;Ra[Ia+11]=vc.b;Ia=Ia+12}if(Ia>0){k.bindBuffer(k.ARRAY_BUFFER,
na.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Ra,ob)}}if(Uc&&db.hasTangents){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];Sb=R.vertexTangents;Ab=Sb[0];Bb=Sb[1];Cb=Sb[2];Aa[va]=Ab.x;Aa[va+1]=Ab.y;Aa[va+2]=Ab.z;Aa[va+3]=Ab.w;Aa[va+4]=Bb.x;Aa[va+5]=Bb.y;Aa[va+6]=Bb.z;Aa[va+7]=Bb.w;Aa[va+8]=Cb.x;Aa[va+9]=Cb.y;Aa[va+10]=Cb.z;Aa[va+11]=Cb.w;va=va+12}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];Sb=R.vertexTangents;Ab=Sb[0];Bb=Sb[1];Cb=Sb[2];tc=Sb[3];Aa[va]=Ab.x;Aa[va+1]=Ab.y;Aa[va+2]=Ab.z;Aa[va+3]=Ab.w;Aa[va+
4]=Bb.x;Aa[va+5]=Bb.y;Aa[va+6]=Bb.z;Aa[va+7]=Bb.w;Aa[va+8]=Cb.x;Aa[va+9]=Cb.y;Aa[va+10]=Cb.z;Aa[va+11]=Cb.w;Aa[va+12]=tc.x;Aa[va+13]=tc.y;Aa[va+14]=tc.z;Aa[va+15]=tc.w;va=va+16}k.bindBuffer(k.ARRAY_BUFFER,na.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,ob)}if(Tc&&Rb){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];mc=R.vertexNormals;Zb=R.normal;if(mc.length===3&&Hc)for(sa=0;sa<3;sa++){$b=mc[sa];qb[Ua]=$b.x;qb[Ua+1]=$b.y;qb[Ua+2]=$b.z;Ua=Ua+3}else for(sa=0;sa<3;sa++){qb[Ua]=Zb.x;qb[Ua+1]=Zb.y;qb[Ua+
2]=Zb.z;Ua=Ua+3}}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];mc=R.vertexNormals;Zb=R.normal;if(mc.length===4&&Hc)for(sa=0;sa<4;sa++){$b=mc[sa];qb[Ua]=$b.x;qb[Ua+1]=$b.y;qb[Ua+2]=$b.z;Ua=Ua+3}else for(sa=0;sa<4;sa++){qb[Ua]=Zb.x;qb[Ua+1]=Zb.y;qb[Ua+2]=Zb.z;Ua=Ua+3}}k.bindBuffer(k.ARRAY_BUFFER,na.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,qb,ob)}if(cd&&Zc&&jc){C=0;for(Y=pa.length;C<Y;C++){Yb=pa[C];nc=Zc[Yb];if(nc!==void 0)for(sa=0;sa<3;sa++){pc=nc[sa];yc[Ub]=pc.u;yc[Ub+1]=pc.v;Ub=Ub+2}}C=0;for(Y=
qa.length;C<Y;C++){Yb=qa[C];nc=Zc[Yb];if(nc!==void 0)for(sa=0;sa<4;sa++){pc=nc[sa];yc[Ub]=pc.u;yc[Ub+1]=pc.v;Ub=Ub+2}}if(Ub>0){k.bindBuffer(k.ARRAY_BUFFER,na.__webglUVBuffer);k.bufferData(k.ARRAY_BUFFER,yc,ob)}}if(cd&&$c&&jc){C=0;for(Y=pa.length;C<Y;C++){Yb=pa[C];oc=$c[Yb];if(oc!==void 0)for(sa=0;sa<3;sa++){qc=oc[sa];zc[Vb]=qc.u;zc[Vb+1]=qc.v;Vb=Vb+2}}C=0;for(Y=qa.length;C<Y;C++){Yb=qa[C];oc=$c[Yb];if(oc!==void 0)for(sa=0;sa<4;sa++){qc=oc[sa];zc[Vb]=qc.u;zc[Vb+1]=qc.v;Vb=Vb+2}}if(Vb>0){k.bindBuffer(k.ARRAY_BUFFER,
na.__webglUV2Buffer);k.bufferData(k.ARRAY_BUFFER,zc,ob)}}if(Fc){C=0;for(Y=pa.length;C<Y;C++){Pb[pb]=Fa;Pb[pb+1]=Fa+1;Pb[pb+2]=Fa+2;pb=pb+3;jb[$a]=Fa;jb[$a+1]=Fa+1;jb[$a+2]=Fa;jb[$a+3]=Fa+2;jb[$a+4]=Fa+1;jb[$a+5]=Fa+2;$a=$a+6;Fa=Fa+3}C=0;for(Y=qa.length;C<Y;C++){Pb[pb]=Fa;Pb[pb+1]=Fa+1;Pb[pb+2]=Fa+3;Pb[pb+3]=Fa+1;Pb[pb+4]=Fa+2;Pb[pb+5]=Fa+3;pb=pb+6;jb[$a]=Fa;jb[$a+1]=Fa+1;jb[$a+2]=Fa;jb[$a+3]=Fa+3;jb[$a+4]=Fa+1;jb[$a+5]=Fa+2;jb[$a+6]=Fa+2;jb[$a+7]=Fa+3;$a=$a+8;Fa=Fa+4}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,
na.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Pb,ob);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,na.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,jb,ob)}if(Yc){sa=0;for(kc=Yc.length;sa<kc;sa++){x=Yc[sa];if(x.__original.needsUpdate){y=0;if(x.size===1)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];x.array[y]=x.value[R.a];x.array[y+1]=x.value[R.b];x.array[y+2]=x.value[R.c];y=y+3}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];x.array[y]=x.value[R.a];x.array[y+
1]=x.value[R.b];x.array[y+2]=x.value[R.c];x.array[y+3]=x.value[R.d];y=y+4}}else{if(x.boundTo==="faces"){C=0;for(Y=pa.length;C<Y;C++){ta=x.value[pa[C]];x.array[y]=ta;x.array[y+1]=ta;x.array[y+2]=ta;y=y+3}C=0;for(Y=qa.length;C<Y;C++){ta=x.value[qa[C]];x.array[y]=ta;x.array[y+1]=ta;x.array[y+2]=ta;x.array[y+3]=ta;y=y+4}}}else if(x.size===2)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];U=x.value[R.a];V=x.value[R.b];W=x.value[R.c];x.array[y]=U.x;x.array[y+1]=U.y;
x.array[y+2]=V.x;x.array[y+3]=V.y;x.array[y+4]=W.x;x.array[y+5]=W.y;y=y+6}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];U=x.value[R.a];V=x.value[R.b];W=x.value[R.c];ma=x.value[R.d];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=V.x;x.array[y+3]=V.y;x.array[y+4]=W.x;x.array[y+5]=W.y;x.array[y+6]=ma.x;x.array[y+7]=ma.y;y=y+8}}else{if(x.boundTo==="faces"){C=0;for(Y=pa.length;C<Y;C++){W=V=U=ta=x.value[pa[C]];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=V.x;x.array[y+3]=V.y;x.array[y+4]=W.x;x.array[y+5]=W.y;
y=y+6}C=0;for(Y=qa.length;C<Y;C++){ma=W=V=U=ta=x.value[qa[C]];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=V.x;x.array[y+3]=V.y;x.array[y+4]=W.x;x.array[y+5]=W.y;x.array[y+6]=ma.x;x.array[y+7]=ma.y;y=y+8}}}else if(x.size===3){var ba;ba=x.type==="c"?["r","g","b"]:["x","y","z"];if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];U=x.value[R.a];V=x.value[R.b];W=x.value[R.c];x.array[y]=U[ba[0]];x.array[y+1]=U[ba[1]];x.array[y+2]=U[ba[2]];x.array[y+3]=V[ba[0]];x.array[y+
4]=V[ba[1]];x.array[y+5]=V[ba[2]];x.array[y+6]=W[ba[0]];x.array[y+7]=W[ba[1]];x.array[y+8]=W[ba[2]];y=y+9}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];U=x.value[R.a];V=x.value[R.b];W=x.value[R.c];ma=x.value[R.d];x.array[y]=U[ba[0]];x.array[y+1]=U[ba[1]];x.array[y+2]=U[ba[2]];x.array[y+3]=V[ba[0]];x.array[y+4]=V[ba[1]];x.array[y+5]=V[ba[2]];x.array[y+6]=W[ba[0]];x.array[y+7]=W[ba[1]];x.array[y+8]=W[ba[2]];x.array[y+9]=ma[ba[0]];x.array[y+10]=ma[ba[1]];x.array[y+11]=ma[ba[2]];y=y+12}}else if(x.boundTo===
"faces"){C=0;for(Y=pa.length;C<Y;C++){W=V=U=ta=x.value[pa[C]];x.array[y]=U[ba[0]];x.array[y+1]=U[ba[1]];x.array[y+2]=U[ba[2]];x.array[y+3]=V[ba[0]];x.array[y+4]=V[ba[1]];x.array[y+5]=V[ba[2]];x.array[y+6]=W[ba[0]];x.array[y+7]=W[ba[1]];x.array[y+8]=W[ba[2]];y=y+9}C=0;for(Y=qa.length;C<Y;C++){ma=W=V=U=ta=x.value[qa[C]];x.array[y]=U[ba[0]];x.array[y+1]=U[ba[1]];x.array[y+2]=U[ba[2]];x.array[y+3]=V[ba[0]];x.array[y+4]=V[ba[1]];x.array[y+5]=V[ba[2]];x.array[y+6]=W[ba[0]];x.array[y+7]=W[ba[1]];x.array[y+
8]=W[ba[2]];x.array[y+9]=ma[ba[0]];x.array[y+10]=ma[ba[1]];x.array[y+11]=ma[ba[2]];y=y+12}}else if(x.boundTo==="faceVertices"){C=0;for(Y=pa.length;C<Y;C++){ta=x.value[pa[C]];U=ta[0];V=ta[1];W=ta[2];x.array[y]=U[ba[0]];x.array[y+1]=U[ba[1]];x.array[y+2]=U[ba[2]];x.array[y+3]=V[ba[0]];x.array[y+4]=V[ba[1]];x.array[y+5]=V[ba[2]];x.array[y+6]=W[ba[0]];x.array[y+7]=W[ba[1]];x.array[y+8]=W[ba[2]];y=y+9}C=0;for(Y=qa.length;C<Y;C++){ta=x.value[qa[C]];U=ta[0];V=ta[1];W=ta[2];ma=ta[3];x.array[y]=U[ba[0]];x.array[y+
1]=U[ba[1]];x.array[y+2]=U[ba[2]];x.array[y+3]=V[ba[0]];x.array[y+4]=V[ba[1]];x.array[y+5]=V[ba[2]];x.array[y+6]=W[ba[0]];x.array[y+7]=W[ba[1]];x.array[y+8]=W[ba[2]];x.array[y+9]=ma[ba[0]];x.array[y+10]=ma[ba[1]];x.array[y+11]=ma[ba[2]];y=y+12}}}else if(x.size===4)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(Y=pa.length;C<Y;C++){R=Va[pa[C]];U=x.value[R.a];V=x.value[R.b];W=x.value[R.c];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=U.z;x.array[y+3]=U.w;x.array[y+4]=V.x;x.array[y+5]=V.y;x.array[y+
6]=V.z;x.array[y+7]=V.w;x.array[y+8]=W.x;x.array[y+9]=W.y;x.array[y+10]=W.z;x.array[y+11]=W.w;y=y+12}C=0;for(Y=qa.length;C<Y;C++){R=Va[qa[C]];U=x.value[R.a];V=x.value[R.b];W=x.value[R.c];ma=x.value[R.d];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=U.z;x.array[y+3]=U.w;x.array[y+4]=V.x;x.array[y+5]=V.y;x.array[y+6]=V.z;x.array[y+7]=V.w;x.array[y+8]=W.x;x.array[y+9]=W.y;x.array[y+10]=W.z;x.array[y+11]=W.w;x.array[y+12]=ma.x;x.array[y+13]=ma.y;x.array[y+14]=ma.z;x.array[y+15]=ma.w;y=y+16}}else if(x.boundTo===
"faces"){C=0;for(Y=pa.length;C<Y;C++){W=V=U=ta=x.value[pa[C]];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=U.z;x.array[y+3]=U.w;x.array[y+4]=V.x;x.array[y+5]=V.y;x.array[y+6]=V.z;x.array[y+7]=V.w;x.array[y+8]=W.x;x.array[y+9]=W.y;x.array[y+10]=W.z;x.array[y+11]=W.w;y=y+12}C=0;for(Y=qa.length;C<Y;C++){ma=W=V=U=ta=x.value[qa[C]];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=U.z;x.array[y+3]=U.w;x.array[y+4]=V.x;x.array[y+5]=V.y;x.array[y+6]=V.z;x.array[y+7]=V.w;x.array[y+8]=W.x;x.array[y+9]=W.y;x.array[y+
10]=W.z;x.array[y+11]=W.w;x.array[y+12]=ma.x;x.array[y+13]=ma.y;x.array[y+14]=ma.z;x.array[y+15]=ma.w;y=y+16}}else if(x.boundTo==="faceVertices"){C=0;for(Y=pa.length;C<Y;C++){ta=x.value[pa[C]];U=ta[0];V=ta[1];W=ta[2];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=U.z;x.array[y+3]=U.w;x.array[y+4]=V.x;x.array[y+5]=V.y;x.array[y+6]=V.z;x.array[y+7]=V.w;x.array[y+8]=W.x;x.array[y+9]=W.y;x.array[y+10]=W.z;x.array[y+11]=W.w;y=y+12}C=0;for(Y=qa.length;C<Y;C++){ta=x.value[qa[C]];U=ta[0];V=ta[1];W=ta[2];ma=
ta[3];x.array[y]=U.x;x.array[y+1]=U.y;x.array[y+2]=U.z;x.array[y+3]=U.w;x.array[y+4]=V.x;x.array[y+5]=V.y;x.array[y+6]=V.z;x.array[y+7]=V.w;x.array[y+8]=W.x;x.array[y+9]=W.y;x.array[y+10]=W.z;x.array[y+11]=W.w;x.array[y+12]=ma.x;x.array[y+13]=ma.y;x.array[y+14]=ma.z;x.array[y+15]=ma.w;y=y+16}}k.bindBuffer(k.ARRAY_BUFFER,x.buffer);k.bufferData(k.ARRAY_BUFFER,x.array,ob)}}}if(zb){delete na.__inittedArrays;delete na.__colorArray;delete na.__normalArray;delete na.__tangentArray;delete na.__uvArray;delete na.__uv2Array;
delete na.__faceArray;delete na.__vertexArray;delete na.__lineArray;delete na.__skinIndexArray;delete na.__skinWeightArray}}}}ha.verticesNeedUpdate=false;ha.morphTargetsNeedUpdate=false;ha.elementsNeedUpdate=false;ha.uvsNeedUpdate=false;ha.normalsNeedUpdate=false;ha.colorsNeedUpdate=false;ha.tangentsNeedUpdate=false;cb.attributes&&p(cb)}else if(vb instanceof THREE.Ribbon){if(ha.verticesNeedUpdate||ha.colorsNeedUpdate){var dc=ha,dd=k.DYNAMIC_DRAW,Ac=void 0,Bc=void 0,Kc=void 0,ec=void 0,Lc=void 0,ed=
dc.vertices,fd=dc.colors,ld=ed.length,md=fd.length,Mc=dc.__vertexArray,Nc=dc.__colorArray,nd=dc.colorsNeedUpdate;if(dc.verticesNeedUpdate){for(Ac=0;Ac<ld;Ac++){Kc=ed[Ac];ec=Ac*3;Mc[ec]=Kc.x;Mc[ec+1]=Kc.y;Mc[ec+2]=Kc.z}k.bindBuffer(k.ARRAY_BUFFER,dc.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Mc,dd)}if(nd){for(Bc=0;Bc<md;Bc++){Lc=fd[Bc];ec=Bc*3;Nc[ec]=Lc.r;Nc[ec+1]=Lc.g;Nc[ec+2]=Lc.b}k.bindBuffer(k.ARRAY_BUFFER,dc.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Nc,dd)}}ha.verticesNeedUpdate=false;
ha.colorsNeedUpdate=false}else if(vb instanceof THREE.Line){cb=c(vb,ib);gb=cb.attributes&&o(cb);if(ha.verticesNeedUpdate||ha.colorsNeedUpdate||gb){var Wb=ha,ad=k.DYNAMIC_DRAW,Cc=void 0,Dc=void 0,Oc=void 0,Da=void 0,Pc=void 0,gd=Wb.vertices,hd=Wb.colors,od=gd.length,pd=hd.length,Qc=Wb.__vertexArray,Rc=Wb.__colorArray,qd=Wb.colorsNeedUpdate,bd=Wb.__webglCustomAttributesList,Sc=void 0,id=void 0,Sa=void 0,rc=void 0,eb=void 0,ya=void 0;if(Wb.verticesNeedUpdate){for(Cc=0;Cc<od;Cc++){Oc=gd[Cc];Da=Cc*3;Qc[Da]=
Oc.x;Qc[Da+1]=Oc.y;Qc[Da+2]=Oc.z}k.bindBuffer(k.ARRAY_BUFFER,Wb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Qc,ad)}if(qd){for(Dc=0;Dc<pd;Dc++){Pc=hd[Dc];Da=Dc*3;Rc[Da]=Pc.r;Rc[Da+1]=Pc.g;Rc[Da+2]=Pc.b}k.bindBuffer(k.ARRAY_BUFFER,Wb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Rc,ad)}if(bd){Sc=0;for(id=bd.length;Sc<id;Sc++){ya=bd[Sc];if(ya.needsUpdate&&(ya.boundTo===void 0||ya.boundTo==="vertices")){Da=0;rc=ya.value.length;if(ya.size===1)for(Sa=0;Sa<rc;Sa++)ya.array[Sa]=ya.value[Sa];else if(ya.size===
2)for(Sa=0;Sa<rc;Sa++){eb=ya.value[Sa];ya.array[Da]=eb.x;ya.array[Da+1]=eb.y;Da=Da+2}else if(ya.size===3)if(ya.type==="c")for(Sa=0;Sa<rc;Sa++){eb=ya.value[Sa];ya.array[Da]=eb.r;ya.array[Da+1]=eb.g;ya.array[Da+2]=eb.b;Da=Da+3}else for(Sa=0;Sa<rc;Sa++){eb=ya.value[Sa];ya.array[Da]=eb.x;ya.array[Da+1]=eb.y;ya.array[Da+2]=eb.z;Da=Da+3}else if(ya.size===4)for(Sa=0;Sa<rc;Sa++){eb=ya.value[Sa];ya.array[Da]=eb.x;ya.array[Da+1]=eb.y;ya.array[Da+2]=eb.z;ya.array[Da+3]=eb.w;Da=Da+4}k.bindBuffer(k.ARRAY_BUFFER,
ya.buffer);k.bufferData(k.ARRAY_BUFFER,ya.array,ad)}}}}ha.verticesNeedUpdate=false;ha.colorsNeedUpdate=false;cb.attributes&&p(cb)}else if(vb instanceof THREE.ParticleSystem)if(ha instanceof THREE.BufferGeometry){(ha.verticesNeedUpdate||ha.colorsNeedUpdate)&&h(ha,k.DYNAMIC_DRAW,!ha.dynamic);ha.verticesNeedUpdate=false;ha.colorsNeedUpdate=false}else{cb=c(vb,ib);gb=cb.attributes&&o(cb);(ha.verticesNeedUpdate||ha.colorsNeedUpdate||vb.sortParticles||gb)&&g(ha,k.DYNAMIC_DRAW,vb);ha.verticesNeedUpdate=false;
ha.colorsNeedUpdate=false;cb.attributes&&p(cb)}}};this.initMaterial=function(a,b,c,d){var f,e,g,h,i,j,l,m,n;a instanceof THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var p=THREE.ShaderLib[n];a.uniforms=
THREE.UniformsUtils.clone(p.uniforms);a.vertexShader=p.vertexShader;a.fragmentShader=p.fragmentShader}var o,q,r;f=o=q=r=p=0;for(e=b.length;f<e;f++){g=b[f];if(!g.onlyShadow){g instanceof THREE.DirectionalLight&&o++;g instanceof THREE.PointLight&&q++;g instanceof THREE.SpotLight&&r++;g instanceof THREE.HemisphereLight&&p++}}if(q+r+o+p<=fa)f=o;else{f=Math.ceil(fa*o/(q+o));r=q=fa-f;p=f}e=q;g=r;h=p;p=o=0;for(r=b.length;p<r;p++){q=b[p];if(q.castShadow){q instanceof THREE.SpotLight&&o++;q instanceof THREE.DirectionalLight&&
!q.shadowCascade&&o++}}m=o;if(kc&&d&&d.useVertexTexture)l=1024;else{b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS);b=Math.floor((b-20)/4);if(d!==void 0&&d instanceof THREE.SkinnedMesh){b=Math.min(d.bones.length,b);b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")}l=b}var s;a:{q=a.fragmentShader;r=a.vertexShader;p=a.uniforms;b=a.attributes;o=a.defines;var c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,
bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,sizeAttenuation:a.sizeAttenuation,skinning:a.skinning,maxBones:l,useVertexTexture:kc&&d&&d.useVertexTexture,boneTextureWidth:d&&d.boneTextureWidth,boneTextureHeight:d&&d.boneTextureHeight,morphTargets:a.morphTargets,morphNormals:a.morphNormals,maxMorphTargets:this.maxMorphTargets,maxMorphNormals:this.maxMorphNormals,maxDirLights:f,maxPointLights:e,maxSpotLights:g,maxHemiLights:h,
maxShadows:m,shadowMapEnabled:this.shadowMapEnabled&&d.receiveShadow,shadowMapSoft:this.shadowMapSoft,shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,v,d=[];if(n)d.push(n);else{d.push(q);d.push(r)}for(u in o){d.push(u);d.push(o[u])}for(t in c){d.push(t);d.push(c[t])}n=d.join();t=0;for(u=ra.length;t<u;t++){d=ra[t];if(d.code===
n){d.usedTimes++;s=d.program;break a}}t=[];for(v in o){u=o[v];if(u!==false){u="#define "+v+" "+u;t.push(u)}}u=t.join("\n");v=k.createProgram();t=["precision "+L+" float;",u,jc?"#define VERTEX_TEXTURES":"",S.gammaInput?"#define GAMMA_INPUT":"",S.gammaOutput?"#define GAMMA_OUTPUT":"",S.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_HEMI_LIGHTS "+
...
k.VALIDATE_STATUS)+", gl error ["+k.getError()+"]");k.deleteShader(u);k.deleteShader(t);v.uniforms={};v.attributes={};var w;t=["viewMatrix","modelViewMatrix","projectionMatrix","normalMatrix","modelMatrix","cameraPosition","morphTargetInfluences"];c.useVertexTexture?t.push("boneTexture"):t.push("boneGlobalMatrices");for(w in p)t.push(w);w=t;t=0;for(u=w.length;t<u;t++){d=w[t];v.uniforms[d]=k.getUniformLocation(v,d)}t=["position","normal","uv","uv2","tangent","color","skinIndex","skinWeight"];for(w=
0;w<c.maxMorphTargets;w++)t.push("morphTarget"+w);for(w=0;w<c.maxMorphNormals;w++)t.push("morphNormal"+w);for(s in b)t.push(s);s=t;w=0;for(t=s.length;w<t;w++){u=s[w];v.attributes[u]=k.getAttribLocation(v,u)}v.id=wa++;ra.push({program:v,code:n,usedTimes:1});S.info.memory.programs=ra.length;s=v}a.program=s;s=a.program.attributes;s.position>=0&&k.enableVertexAttribArray(s.position);s.color>=0&&k.enableVertexAttribArray(s.color);s.normal>=0&&k.enableVertexAttribArray(s.normal);s.tangent>=0&&k.enableVertexAttribArray(s.tangent);
...
v+j;if(s[w]>=0){k.enableVertexAttribArray(s[w]);a.numSupportedMorphNormals++}}}a.uniformsList=[];for(i in a.uniforms)a.uniformsList.push([a.uniforms[i],i])};this.setFaceCulling=function(a,b){if(a){!b||b==="ccw"?k.frontFace(k.CCW):k.frontFace(k.CW);a==="back"?k.cullFace(k.BACK):a==="front"?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK);k.enable(k.CULL_FACE)}else k.disable(k.CULL_FACE)};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,a=a.side===THREE.BackSide;if(Ja!==b){b?k.disable(k.CULL_FACE):
k.enable(k.CULL_FACE);Ja=b}if(ua!==a){a?k.frontFace(k.CW):k.frontFace(k.CCW);ua=a}};this.setDepthTest=function(a){if(kb!==a){a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST);kb=a}};this.setDepthWrite=function(a){if(Ta!==a){k.depthMask(a);Ta=a}};this.setBlending=function(a,b,c,d){if(a!==La){if(a===THREE.NoBlending)k.disable(k.BLEND);else if(a===THREE.AdditiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE)}else if(a===THREE.SubtractiveBlending){k.enable(k.BLEND);
k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)}else if(a===THREE.MultiplyBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.SRC_COLOR)}else if(a===THREE.CustomBlending)k.enable(k.BLEND);else{k.enable(k.BLEND);k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD);k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)}La=a}if(a===THREE.CustomBlending){if(b!==Wa){k.blendEquation(H(b));Wa=b}if(c!==oa||d!==Xa){k.blendFunc(H(c),H(d));
oa=c;Xa=d}}else Xa=oa=Wa=null};this.setTexture=function(a,b){if(a.needsUpdate){if(!a.__webglInit){a.__webglInit=true;a.__webglTexture=k.createTexture();S.info.memory.textures++}k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=(c.width&c.width-1)===0&&(c.height&c.height-1)===0,f=H(a.format),e=H(a.type);F(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var e=
...
if(a&&!a.__webglFramebuffer){if(a.depthBuffer===void 0)a.depthBuffer=true;if(a.stencilBuffer===void 0)a.stencilBuffer=true;a.__webglTexture=k.createTexture();var c=(a.width&a.width-1)===0&&(a.height&a.height-1)===0,d=H(a.format),f=H(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);F(k.TEXTURE_CUBE_MAP,a,c);for(var e=0;e<6;e++){a.__webglFramebuffer[e]=k.createFramebuffer();a.__webglRenderbuffer[e]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+
e,0,d,a.width,a.height,0,d,f,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+e;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[e]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);B(a.__webglRenderbuffer[e],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);F(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,f,null);d=
k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);B(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;f=d=0}else{b=null;c=za;a=xb;d=bb;f=Ma}if(b!==ga){k.bindFramebuffer(k.FRAMEBUFFER,
b);k.viewport(d,f,c,a);ga=b}Ga=c;sb=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
THREE.GeometryUtils={merge:function(a,b){for(var c,d,f=a.vertices.length,e=b instanceof THREE.Mesh?b.geometry:b,g=a.vertices,h=e.vertices,i=a.faces,j=e.faces,l=a.faceVertexUvs[0],n=e.faceVertexUvs[0],m={},q=0;q<a.materials.length;q++)m[a.materials[q].id]=q;if(b instanceof THREE.Mesh){b.matrixAutoUpdate&&b.updateMatrix();c=b.matrix;d=new THREE.Matrix4;d.extractRotation(c,b.scale)}for(var q=0,o=h.length;q<o;q++){var p=h[q].clone();c&&c.multiplyVector3(p);g.push(p)}q=0;for(o=j.length;q<o;q++){var g=
j[q],r,t,u=g.vertexNormals,v=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+f,g.b+f,g.c+f):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+f,g.b+f,g.c+f,g.d+f));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(p=u.length;h<p;h++){t=u[h].clone();d&&d.multiplyVector3(t);r.vertexNormals.push(t)}r.color.copy(g.color);h=0;for(p=v.length;h<p;h++){t=v[h];r.vertexColors.push(t.clone())}if(g.materialIndex!==void 0){h=e.materials[g.materialIndex];p=h.id;v=m[p];if(v===void 0){v=
a.materials.length;m[p]=v;a.materials.push(h)}r.materialIndex=v}r.centroid.copy(g.centroid);c&&c.multiplyVector3(r.centroid);i.push(r)}q=0;for(o=n.length;q<o;q++){c=n[q];d=[];h=0;for(p=c.length;h<p;h++)d.push(new THREE.UV(c[h].u,c[h].v));l.push(d)}},clone:function(a){var b=new THREE.Geometry,c,d=a.vertices,f=a.faces,e=a.faceVertexUvs[0];if(a.materials)b.materials=a.materials.slice();a=0;for(c=d.length;a<c;a++)b.vertices.push(d[a].clone());a=0;for(c=f.length;a<c;a++)b.faces.push(f[a].clone());a=0;
...
e.a;h=e.b;i=e.c;g=a.vertices[g];h=a.vertices[h];i=a.vertices[i];b.push(g.clone());b.push(h.clone());b.push(i.clone());e.a=f;e.b=f+1;e.c=f+2}}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,f,e,g,h,i,j,l,n,m,q,o,p,r,t,u,v,s,z=[],w=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)w[c]=[];c=0;for(d=a.faces.length;c<d;c++){f=a.faces[c];if(f instanceof THREE.Face3){e=f.a;g=f.b;h=f.c;j=a.vertices[e];l=a.vertices[g];n=a.vertices[h];q=j.distanceTo(l);o=l.distanceTo(n);m=j.distanceTo(n);if(q>
b||o>b||m>b){i=a.vertices.length;v=f.clone();s=f.clone();if(q>=o&&q>=m){j=j.clone();j.lerpSelf(l,0.5);v.a=e;v.b=i;v.c=h;s.a=i;s.b=g;s.c=h;if(f.vertexNormals.length===3){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);v.vertexNormals[1].copy(e);s.vertexNormals[0].copy(e)}if(f.vertexColors.length===3){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[1],0.5);v.vertexColors[1].copy(e);s.vertexColors[0].copy(e)}f=0}else if(o>=q&&o>=m){j=l.clone();j.lerpSelf(n,0.5);v.a=e;v.b=g;v.c=
...
j.lerpSelf(n,0.5);v.a=e;v.b=g;v.c=i;s.a=i;s.b=g;s.c=h;if(f.vertexNormals.length===3){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[2],0.5);v.vertexNormals[2].copy(e);s.vertexNormals[0].copy(e)}if(f.vertexColors.length===3){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[2],0.5);v.vertexColors[2].copy(e);s.vertexColors[0].copy(e)}f=2}z.push(v,s);a.vertices.push(j);e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){j=a.faceVertexUvs[e][c];s=j[0];h=j[1];v=j[2];if(f===
0){l=s.clone();l.lerpSelf(h,0.5);j=[s.clone(),l.clone(),v.clone()];h=[l.clone(),h.clone(),v.clone()]}else if(f===1){l=h.clone();l.lerpSelf(v,0.5);j=[s.clone(),h.clone(),l.clone()];h=[l.clone(),v.clone(),s.clone()]}else{l=s.clone();l.lerpSelf(v,0.5);j=[s.clone(),h.clone(),l.clone()];h=[l.clone(),h.clone(),v.clone()]}w[e].push(j,h)}}else{z.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)w[e].push(a.faceVertexUvs[e][c])}}else{e=f.a;g=f.b;h=f.c;i=f.d;j=a.vertices[e];l=a.vertices[g];n=a.vertices[h];m=
a.vertices[i];q=j.distanceTo(l);o=l.distanceTo(n);p=n.distanceTo(m);r=j.distanceTo(m);if(q>b||o>b||p>b||r>b){t=a.vertices.length;u=a.vertices.length+1;v=f.clone();s=f.clone();if(q>=o&&q>=p&&q>=r||p>=o&&p>=q&&p>=r){q=j.clone();q.lerpSelf(l,0.5);l=n.clone();l.lerpSelf(m,0.5);v.a=e;v.b=t;v.c=u;v.d=i;s.a=t;s.b=g;s.c=h;s.d=u;if(f.vertexNormals.length===4){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);g=f.vertexNormals[2].clone();g.lerpSelf(f.vertexNormals[3],0.5);v.vertexNormals[1].copy(e);
...
e.lerpSelf(f.vertexNormals[2],0.5);g=f.vertexNormals[3].clone();g.lerpSelf(f.vertexNormals[0],0.5);v.vertexNormals[2].copy(e);v.vertexNormals[3].copy(g);s.vertexNormals[0].copy(g);s.vertexNormals[1].copy(e)}if(f.vertexColors.length===4){e=f.vertexColors[1].clone();e.lerpSelf(f.vertexColors[2],0.5);g=f.vertexColors[3].clone();g.lerpSelf(f.vertexColors[0],0.5);v.vertexColors[2].copy(e);v.vertexColors[3].copy(g);s.vertexColors[0].copy(g);s.vertexColors[1].copy(e)}f=1}z.push(v,s);a.vertices.push(q,l);
e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){j=a.faceVertexUvs[e][c];s=j[0];h=j[1];v=j[2];j=j[3];if(f===0){l=s.clone();l.lerpSelf(h,0.5);n=v.clone();n.lerpSelf(j,0.5);s=[s.clone(),l.clone(),n.clone(),j.clone()];h=[l.clone(),h.clone(),v.clone(),n.clone()]}else{l=h.clone();l.lerpSelf(v,0.5);n=j.clone();n.lerpSelf(s,0.5);s=[s.clone(),h.clone(),l.clone(),n.clone()];h=[n.clone(),l.clone(),v.clone(),j.clone()]}w[e].push(s,h)}}else{z.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)w[e].push(a.faceVertexUvs[e][c])}}}a.faces=
z;a.faceVertexUvs=w}};THREE.GeometryUtils.random=THREE.Math.random16;THREE.GeometryUtils.__v1=new THREE.Vector3;
...
THREE.Path.prototype.getPoints=function(a,b){if(this.useSpacedPoints){console.log("tata");return this.getSpacedPoints(a,b)}var a=a||12,c=[],d,f,e,g,h,i,j,l,n,m,q,o,p;d=0;for(f=this.actions.length;d<f;d++){e=this.actions[d];g=e.action;e=e.args;switch(g){case THREE.PathActions.MOVE_TO:c.push(new THREE.Vector2(e[0],e[1]));break;case THREE.PathActions.LINE_TO:c.push(new THREE.Vector2(e[0],e[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=e[2];i=e[3];n=e[0];m=e[1];if(c.length>0){g=c[c.length-1];
q=g.x;o=g.y}else{g=this.actions[d-1].args;q=g[g.length-2];o=g[g.length-1]}for(e=1;e<=a;e++){p=e/a;g=THREE.Shape.Utils.b2(p,q,n,h);p=THREE.Shape.Utils.b2(p,o,m,i);c.push(new THREE.Vector2(g,p))}break;case THREE.PathActions.BEZIER_CURVE_TO:h=e[4];i=e[5];n=e[0];m=e[1];j=e[2];l=e[3];if(c.length>0){g=c[c.length-1];q=g.x;o=g.y}else{g=this.actions[d-1].args;q=g[g.length-2];o=g[g.length-1]}for(e=1;e<=a;e++){p=e/a;g=THREE.Shape.Utils.b3(p,q,n,j,h);p=THREE.Shape.Utils.b3(p,o,m,l,i);c.push(new THREE.Vector2(g,
p))}break;case THREE.PathActions.CSPLINE_THRU:g=this.actions[d-1].args;p=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=a*e[0].length;p=p.concat(e[0]);p=new THREE.SplineCurve(p);for(e=1;e<=g;e++)c.push(p.getPointAt(e/g));break;case THREE.PathActions.ARC:h=e[0];i=e[1];m=e[2];j=e[3];g=e[4];n=!!e[5];q=g-j;o=a*2;for(e=1;e<=o;e++){p=e/o;n||(p=1-p);p=j+p*q;g=h+m*Math.cos(p);p=i+m*Math.sin(p);c.push(new THREE.Vector2(g,p))}break;case THREE.PathActions.ELLIPSE:h=e[0];i=e[1];m=e[2];l=e[3];j=e[4];g=e[5];
n=!!e[6];q=g-j;o=a*2;for(e=1;e<=o;e++){p=e/o;n||(p=1-p);p=j+p*q;g=h+m*Math.cos(p);p=i+l*Math.sin(p);c.push(new THREE.Vector2(g,p))}}}d=c[c.length-1];Math.abs(d.x-c[0].x)<1E-10&&Math.abs(d.y-c[0].y)<1E-10&&c.splice(c.length-1,1);b&&c.push(c[0]);return c};
...
THREE.Shape.Utils={removeHoles:function(a,b){var c=a.concat(),d=c.concat(),f,e,g,h,i,j,l,n,m,q,o=[];for(i=0;i<b.length;i++){j=b[i];Array.prototype.push.apply(d,j);e=Number.POSITIVE_INFINITY;for(f=0;f<j.length;f++){m=j[f];q=[];for(n=0;n<c.length;n++){l=c[n];l=m.distanceToSquared(l);q.push(l);if(l<e){e=l;g=f;h=n}}}f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:j.length-1;var p=[j[g],c[h],c[f]];n=THREE.FontUtils.Triangulate.area(p);var r=[j[g],j[e],c[h]];m=THREE.FontUtils.Triangulate.area(r);q=h;l=g;h=h+1;g=g+
-1;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+j.length);g=g%j.length;f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:j.length-1;p=[j[g],c[h],c[f]];p=THREE.FontUtils.Triangulate.area(p);r=[j[g],j[e],c[h]];r=THREE.FontUtils.Triangulate.area(r);if(n+m>p+r){h=q;g=l;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+j.length);g=g%j.length;f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:j.length-1}n=c.slice(0,h);m=c.slice(h);q=j.slice(g);l=j.slice(0,g);e=[j[g],j[e],c[h]];o.push([j[g],c[h],c[f]]);o.push(e);c=n.concat(q).concat(l).concat(m)}return{shape:c,
...
THREE.RollControls=function(a,b){this.object=a;this.domElement=b!==void 0?b:document;this.mouseLook=true;this.autoForward=false;this.rollSpeed=this.movementSpeed=this.lookSpeed=1;this.constrainVertical=[-0.9,0.9];this.object.matrixAutoUpdate=false;this.forward=new THREE.Vector3(0,0,1);this.roll=0;var c=new THREE.Vector3,d=new THREE.Vector3,f=new THREE.Vector3,e=new THREE.Matrix4,g=false,h=1,i=0,j=0,l=0,n=0,m=0,q=0,o=0;this.handleResize=function(){q=window.innerWidth/2;o=window.innerHeight/2};this.update=
...
THREE.SphereGeometry=function(a,b,c,d,f,e,g){THREE.Geometry.call(this);var a=a||50,d=d!==void 0?d:0,f=f!==void 0?f:Math.PI*2,e=e!==void 0?e:0,g=g!==void 0?g:Math.PI,b=Math.max(3,Math.floor(b)||8),c=Math.max(2,Math.floor(c)||6),h,i,j=[],l=[];for(i=0;i<=c;i++){var n=[],m=[];for(h=0;h<=b;h++){var q=h/b,o=i/c,p=new THREE.Vector3;p.x=-a*Math.cos(d+q*f)*Math.sin(e+o*g);p.y=a*Math.cos(e+o*g);p.z=a*Math.sin(d+q*f)*Math.sin(e+o*g);this.vertices.push(p);n.push(this.vertices.length-1);m.push(new THREE.UV(q,
1-o))}j.push(n);l.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=j[i][h+1],f=j[i][h],e=j[i+1][h],g=j[i+1][h+1],n=this.vertices[d].clone().normalize(),m=this.vertices[f].clone().normalize(),q=this.vertices[e].clone().normalize(),o=this.vertices[g].clone().normalize(),p=l[i][h+1].clone(),r=l[i][h].clone(),t=l[i+1][h].clone(),u=l[i+1][h+1].clone();if(Math.abs(this.vertices[d].y)==a){this.faces.push(new THREE.Face3(d,e,g,[n,q,o]));this.faceVertexUvs[0].push([p,t,u])}else if(Math.abs(this.vertices[e].y)==
a){this.faces.push(new THREE.Face3(d,f,e,[n,m,q]));this.faceVertexUvs[0].push([p,r,t])}else{this.faces.push(new THREE.Face4(d,f,e,g,[n,m,q,o]));this.faceVertexUvs[0].push([p,r,t,u])}}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:a}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.TubeGeometry=function(a,b,c,d,f,e){THREE.Geometry.call(this);this.path=a;this.segments=b||64;this.radius=c||1;this.segmentsRadius=d||8;this.closed=f||false;if(e)this.debug=new THREE.Object3D;this.grid=[];var g,h,e=this.segments+1,i,j,l,n=new THREE.Vector3,m,q,o,b=new THREE.TubeGeometry.FrenetFrames(a,b,f);m=b.tangents;q=b.normals;o=b.binormals;this.tangents=m;this.normals=q;this.binormals=o;for(b=0;b<e;b++){this.grid[b]=[];d=b/(e-1);l=a.getPointAt(d);d=m[b];g=q[b];h=o[b];if(this.debug){this.debug.add(new THREE.ArrowHelper(d,
...
THREE.ParametricGeometry=function(a,b,c,d){THREE.Geometry.call(this);var f=this.vertices,e=this.faces,g=this.faceVertexUvs[0],d=d===void 0?false:d,h,i,j,l,n=b+1;for(h=0;h<=c;h++){l=h/c;for(i=0;i<=b;i++){j=i/b;j=a(j,l);f.push(j)}}var m,q,o,p;for(h=0;h<c;h++)for(i=0;i<b;i++){a=h*n+i;f=h*n+i+1;l=(h+1)*n+i;j=(h+1)*n+i+1;m=new THREE.UV(i/b,h/c);q=new THREE.UV((i+1)/b,h/c);o=new THREE.UV(i/b,(h+1)/c);p=new THREE.UV((i+1)/b,(h+1)/c);if(d){e.push(new THREE.Face3(a,f,l));e.push(new THREE.Face3(f,j,l));g.push([m,
q,o]);g.push([q,p,o])}else{e.push(new THREE.Face4(a,f,j,l));g.push([m,q,p,o])}}this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.ParametricGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.SubdivisionModifier=function(a){this.subdivisions=a===void 0?1:a;this.useOldVertexColors=false;this.supportUVs=true;this.debug=false};THREE.SubdivisionModifier.prototype.modify=function(a){for(var b=this.subdivisions;b-- >0;)this.smooth(a)};function orderedKey(a,b){return Math.min(a,b)+"_"+Math.max(a,b)}
...
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(true);m=0;for(q=l.__lights.length;m<q;m++){o=l.__lights[m];if(o.castShadow)if(o instanceof THREE.DirectionalLight&&o.shadowCascade)for(r=0;r<o.shadowCascadeCount;r++){var w;if(o.shadowCascadeArray[r])w=o.shadowCascadeArray[r];else{s=o;u=r;w=new THREE.DirectionalLight;w.isVirtual=true;w.onlyShadow=true;w.castShadow=true;w.shadowCameraNear=s.shadowCameraNear;w.shadowCameraFar=s.shadowCameraFar;w.shadowCameraLeft=s.shadowCameraLeft;w.shadowCameraRight=
s.shadowCameraRight;w.shadowCameraBottom=s.shadowCameraBottom;w.shadowCameraTop=s.shadowCameraTop;w.shadowCameraVisible=s.shadowCameraVisible;w.shadowDarkness=s.shadowDarkness;w.shadowBias=s.shadowCascadeBias[u];w.shadowMapWidth=s.shadowCascadeWidth[u];w.shadowMapHeight=s.shadowCascadeHeight[u];w.pointsWorld=[];w.pointsFrustum=[];v=w.pointsWorld;t=w.pointsFrustum;for(var A=0;A<8;A++){v[A]=new THREE.Vector3;t[A]=new THREE.Vector3}v=s.shadowCascadeNearZ[u];s=s.shadowCascadeFarZ[u];t[0].set(-1,-1,v);
t[1].set(1,-1,v);t[2].set(-1,1,v);t[3].set(1,1,v);t[4].set(-1,-1,s);t[5].set(1,-1,s);t[6].set(-1,1,s);t[7].set(1,1,s);w.originalCamera=n;t=new THREE.Gyroscope;t.position=o.shadowCascadeOffset;t.add(w);t.add(w.target);n.add(t);o.shadowCascadeArray[r]=w;console.log("Created virtualLight",w)}u=o;v=r;s=u.shadowCascadeArray[v];s.position.copy(u.position);s.target.position.copy(u.target.position);s.lookAt(s.target);s.shadowCameraVisible=u.shadowCameraVisible;s.shadowDarkness=u.shadowDarkness;s.shadowBias=
u.shadowCascadeBias[v];t=u.shadowCascadeNearZ[v];u=u.shadowCascadeFarZ[v];s=s.pointsFrustum;s[0].z=t;s[1].z=t;s[2].z=t;s[3].z=t;s[4].z=u;s[5].z=u;s[6].z=u;s[7].z=u;z[p]=w;p++}else{z[p]=o;p++}}m=0;for(q=z.length;m<q;m++){o=z[m];if(!o.shadowMap){o.shadowMap=new THREE.WebGLRenderTarget(o.shadowMapWidth,o.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});o.shadowMapSize=new THREE.Vector2(o.shadowMapWidth,o.shadowMapHeight);o.shadowMatrix=new THREE.Matrix4}if(!o.shadowCamera){if(o instanceof
...
!o.cameraHelper){o.cameraHelper=new THREE.CameraHelper(o.shadowCamera);o.shadowCamera.add(o.cameraHelper)}if(o.isVirtual&&w.originalCamera==n){r=n;p=o.shadowCamera;t=o.pointsFrustum;s=o.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(u=0;u<8;u++){v=s[u];v.copy(t[u]);THREE.ShadowMapPlugin.__projector.unprojectVector(v,r);p.matrixWorldInverse.multiplyVector3(v);if(v.x<i.x)i.x=v.x;if(v.x>j.x)j.x=v.x;if(v.y<i.y)i.y=v.y;if(v.y>j.y)j.y=v.y;if(v.z<i.z)i.z=v.z;if(v.z>
j.z)j.z=v.z}p.left=i.x;p.right=j.x;p.top=j.y;p.bottom=i.y;p.updateProjectionMatrix()}p=o.shadowMap;t=o.shadowMatrix;r=o.shadowCamera;r.position.copy(o.matrixWorld.getPosition());r.lookAt(o.target.matrixWorld.getPosition());r.updateMatrixWorld();r.matrixWorldInverse.getInverse(r.matrixWorld);if(o.cameraHelper)o.cameraHelper.visible=o.shadowCameraVisible;o.shadowCameraVisible&&o.cameraHelper.update();t.set(0.5,0,0,0.5,0,0.5,0,0.5,0,0,0.5,0.5,0,0,0,1);t.multiplySelf(r.projectionMatrix);t.multiplySelf(r.matrixWorldInverse);
if(!r._viewMatrixArray)r._viewMatrixArray=new Float32Array(16);if(!r._projectionMatrixArray)r._projectionMatrixArray=new Float32Array(16);r.matrixWorldInverse.flattenToArray(r._viewMatrixArray);r.projectionMatrix.flattenToArray(r._projectionMatrixArray);h.multiply(r.projectionMatrix,r.matrixWorldInverse);g.setFromMatrix(h);b.setRenderTarget(p);b.clear();s=l.__webglObjects;o=0;for(p=s.length;o<p;o++){u=s[o];t=u.object;u.render=false;if(t.visible&&t.castShadow&&(!(t instanceof THREE.Mesh)||!t.frustumCulled||
g.contains(t))){t._modelViewMatrix.multiply(r.matrixWorldInverse,t.matrixWorld);u.render=true}}o=0;for(p=s.length;o<p;o++){u=s[o];if(u.render){t=u.object;u=u.buffer;v=t.customDepthMaterial?t.customDepthMaterial:t instanceof THREE.SkinnedMesh?t.geometry.morphTargets.length?e:f:t.geometry.morphTargets.length?d:c;u instanceof THREE.BufferGeometry?b.renderBufferDirect(r,l.__lights,null,v,u,t):b.renderBuffer(r,l.__lights,null,v,u,t)}}s=l.__webglObjectsImmediate;o=0;for(p=s.length;o<p;o++){u=s[o];t=u.object;
...
g);b.bufferData(b.ELEMENT_ARRAY_BUFFER,f,b.STATIC_DRAW);var a=THREE.ShaderSprite.sprite,m=b.createProgram(),q=b.createShader(b.FRAGMENT_SHADER),o=b.createShader(b.VERTEX_SHADER);b.shaderSource(q,a.fragmentShader);b.shaderSource(o,a.vertexShader);b.compileShader(q);b.compileShader(o);b.attachShader(m,q);b.attachShader(m,o);b.linkProgram(m);h=m;i={};j={};i.position=b.getAttribLocation(h,"position");i.uv=b.getAttribLocation(h,"uv");j.uvOffset=b.getUniformLocation(h,"uvOffset");j.uvScale=b.getUniformLocation(h,
...
j.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");l=false};this.render=function(d,f,q,o){var d=d.__webglSprites,p=d.length;if(p){var r=i,t=j,u=o/q,q=q*0.5,v=o*0.5,s=true;b.useProgram(h);if(!l){b.enableVertexAttribArray(r.position);b.enableVertexAttribArray(r.uv);l=true}b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(true);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(r.position,2,b.FLOAT,false,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
g);b.uniformMatrix4fv(t.projectionMatrix,false,f._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(t.map,0);for(var z,w=[],r=0;r<p;r++){z=d[r];if(z.visible&&z.opacity!==0)if(z.useScreenCoordinates)z.z=-z.position.z;else{z._modelViewMatrix.multiply(f.matrixWorldInverse,z.matrixWorld);z.z=-z._modelViewMatrix.elements[14]}}d.sort(a);for(r=0;r<p;r++){z=d[r];if(z.visible&&z.opacity!==0&&z.map&&z.map.image&&z.map.image.width){if(z.useScreenCoordinates){b.uniform1i(t.useScreenCoordinates,1);
b.uniform3f(t.screenPosition,(z.position.x-q)/q,(v-z.position.y)/v,Math.max(0,Math.min(1,z.position.z)))}else{b.uniform1i(t.useScreenCoordinates,0);b.uniform1i(t.affectedByDistance,z.affectedByDistance?1:0);b.uniformMatrix4fv(t.modelViewMatrix,false,z._modelViewMatrix.elements)}f=z.map.image.width/(z.scaleByViewport?o:1);w[0]=f*u*z.scale.x;w[1]=f*z.scale.y;b.uniform2f(t.uvScale,z.uvScale.x,z.uvScale.y);b.uniform2f(t.uvOffset,z.uvOffset.x,z.uvOffset.y);b.uniform2f(t.alignment,z.alignment.x,z.alignment.y);
b.uniform1f(t.opacity,z.opacity);b.uniform3f(t.color,z.color.r,z.color.g,z.color.b);b.uniform1f(t.rotation,z.rotation);b.uniform2fv(t.scale,w);if(z.mergeWith3D&&!s){b.enable(b.DEPTH_TEST);s=true}else if(!z.mergeWith3D&&s){b.disable(b.DEPTH_TEST);s=false}c.setBlending(z.blending,z.blendEquation,z.blendSrc,z.blendDst);c.setTexture(z.map,0);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
