...
a).lengthSq()},getPositionFromMatrix:function(a){this.x=a.elements[12];this.y=a.elements[13];this.z=a.elements[14];return this},setEulerFromRotationMatrix:function(a,b){function c(a){return Math.min(Math.max(a,-1),1)}var d=a.elements,f=d[0],e=d[4],g=d[8],h=d[1],i=d[5],j=d[9],l=d[2],n=d[6],d=d[10];if(b===void 0||b==="XYZ"){this.y=Math.asin(c(g));if(Math.abs(g)<0.99999){this.x=Math.atan2(-j,d);this.z=Math.atan2(-e,f)}else{this.x=Math.atan2(h,i);this.z=0}}else if(b==="YXZ"){this.x=Math.asin(-c(j));if(Math.abs(j)<
0.99999){this.y=Math.atan2(g,d);this.z=Math.atan2(h,i)}else{this.y=Math.atan2(-l,f);this.z=0}}else if(b==="ZXY"){this.x=Math.asin(c(n));if(Math.abs(n)<0.99999){this.y=Math.atan2(-l,d);this.z=Math.atan2(-e,i)}else{this.y=0;this.z=Math.atan2(g,f)}}else if(b==="ZYX"){this.y=Math.asin(-c(l));if(Math.abs(l)<0.99999){this.x=Math.atan2(n,d);this.z=Math.atan2(h,f)}else{this.x=0;this.z=Math.atan2(-e,i)}}else if(b==="YZX"){this.z=Math.asin(c(h));if(Math.abs(h)<0.99999){this.x=Math.atan2(-j,i);this.y=Math.atan2(-l,
...
f=THREE.Matrix4.__v1,e=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();if(g.length()===0)g.z=1;f.cross(c,g).normalize();if(f.length()===0){g.x=g.x+1E-4;f.cross(c,g).normalize()}e.cross(g,f);d[0]=f.x;d[4]=e.x;d[8]=g.x;d[1]=f.y;d[5]=e.y;d[9]=g.y;d[2]=f.z;d[6]=e.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,f=this.elements,e=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],n=c[9],m=c[13],q=c[2],p=c[6],o=c[10],r=c[14],s=c[3],t=c[7],v=c[11],c=c[15],u=d[0],A=d[4],
x=d[8],B=d[12],J=d[1],y=d[5],I=d[9],F=d[13],H=d[2],G=d[6],M=d[10],D=d[14],K=d[3],P=d[7],L=d[11],d=d[15];f[0]=e*u+g*J+h*H+i*K;f[4]=e*A+g*y+h*G+i*P;f[8]=e*x+g*I+h*M+i*L;f[12]=e*B+g*F+h*D+i*d;f[1]=j*u+l*J+n*H+m*K;f[5]=j*A+l*y+n*G+m*P;f[9]=j*x+l*I+n*M+m*L;f[13]=j*B+l*F+n*D+m*d;f[2]=q*u+p*J+o*H+r*K;f[6]=q*A+p*y+o*G+r*P;f[10]=q*x+p*I+o*M+r*L;f[14]=q*B+p*F+o*D+r*d;f[3]=s*u+t*J+v*H+c*K;f[7]=s*A+t*y+v*G+c*P;f[11]=s*x+t*I+v*M+c*L;f[15]=s*B+t*F+v*D+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
a[9],a[10])},getInverse:function(a){var b=this.elements,c=a.elements,d=c[0],f=c[4],e=c[8],g=c[12],h=c[1],i=c[5],j=c[9],l=c[13],n=c[2],m=c[6],q=c[10],p=c[14],o=c[3],r=c[7],s=c[11],c=c[15];b[0]=j*p*r-l*q*r+l*m*s-i*p*s-j*m*c+i*q*c;b[4]=g*q*r-e*p*r-g*m*s+f*p*s+e*m*c-f*q*c;b[8]=e*l*r-g*j*r+g*i*s-f*l*s-e*i*c+f*j*c;b[12]=g*j*m-e*l*m-g*i*q+f*l*q+e*i*p-f*j*p;b[1]=l*q*o-j*p*o-l*n*s+h*p*s+j*n*c-h*q*c;b[5]=e*p*o-g*q*o+g*n*s-d*p*s-e*n*c+d*q*c;b[9]=g*j*o-e*l*o-g*h*s+d*l*s+e*h*c-d*j*c;b[13]=e*l*n-g*j*n+g*h*q-d*
l*q-e*h*p+d*j*p;b[2]=i*p*o-l*m*o+l*n*r-h*p*r-i*n*c+h*m*c;b[6]=g*m*o-f*p*o-g*n*r+d*p*r+f*n*c-d*m*c;b[10]=f*l*o-g*i*o+g*h*r-d*l*r-f*h*c+d*i*c;b[14]=g*i*n-f*l*n-g*h*m+d*l*m+f*h*p-d*i*p;b[3]=j*m*o-i*q*o-j*n*r+h*q*r+i*n*s-h*m*s;b[7]=f*q*o-e*m*o+e*n*r-d*q*r-f*n*s+d*m*s;b[11]=e*i*o-f*j*o-e*h*r+d*j*r+f*h*s-d*i*s;b[15]=f*j*n-e*i*n+e*h*m-d*j*m-f*h*q+d*i*q;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,f=a.y,e=a.z,g=Math.cos(d),d=Math.sin(d),
...
b);var a=j.dot(j),b=j.dot(l),c=j.dot(n),f=l.dot(l),d=l.dot(n),e=1/(a*f-b*b),f=(f*c-b*d)*e,a=(a*d-b*c)*e;return f>=0&&a>=0&&f+a<1},p=function(i,l,j){var n,o;if(i instanceof a.Particle){n=m(l.origin,l.direction,i.matrixWorld.getPosition());if(n>i.scale.x)return j;o={distance:n,point:i.position,face:null,object:i};j.push(o)}else if(i instanceof a.Mesh){var p=i.geometry.boundingSphere.radius*i.matrixWorld.getMaxScaleOnAxis();n=m(l.origin,l.direction,i.matrixWorld.getPosition());if(n>p)return j;var x,
B,J=i.geometry,y=J.vertices,I,F,H;I=i.geometry.materials;F=i.material instanceof a.MeshFaceMaterial;var G,M=l.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(l.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(l.direction);h.rotateAxis(d).normalize();p=0;for(x=J.faces.length;p<x;p++){o=J.faces[p];n=F===true?I[o.materialIndex]:i.material;if(n!==void 0){H=n.side;f.sub(o.centroid,c);e=o.normal;n=d.dot(e);if(!(Math.abs(n)<M)){B=e.dot(f)/n;if(!(B<0)&&(H===
a.DoubleSide||(H===a.FrontSide?n<0:n>0))){g.add(c,d.multiplyScalar(B));if(o instanceof a.Face3){n=y[o.a];B=y[o.b];H=y[o.c];if(q(g,n,B,H)){B=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(B);if(!(n<l.near||n>l.far)){o={distance:n,point:B,face:o,faceIndex:p,object:i};j.push(o)}}}else if(o instanceof a.Face4){n=y[o.a];B=y[o.b];H=y[o.c];G=y[o.d];if(q(g,n,B,G)||q(g,B,H,G)){B=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(B);if(!(n<l.near||n>l.far)){o={distance:n,point:B,face:o,faceIndex:p,
object:i};j.push(o)}}}}}}}}},o=function(a,b,c){for(var a=a.getDescendants(),b=0,d=a.length;b<d;b++)p(a[b],this,c)};a.Ray.prototype.precision=1E-4;a.Ray.prototype.intersectObject=function(a,b){var c=[];b===true&&o(a,this,c);p(a,this,c);c.sort(i);return c};a.Ray.prototype.intersectObjects=function(a,b){for(var c=[],d=0,f=a.length;d<f;d++){p(a[d],this,c);b===true&&o(a[d],this,c)}c.sort(i);return c}})(THREE);
...
if(d<c)return false;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return true}var f,e,g=[],h=0,i,j,l=[],n=0,m,q,p=[],o=0,r,s=[],t=0,v,u,A=[],x=0,B,J,y=[],I=0,F={objects:[],sprites:[],lights:[],elements:[]},H=new THREE.Vector3,G=new THREE.Vector4,M=new THREE.Matrix4,D=new THREE.Matrix4,K=new THREE.Frustum,P=new THREE.Vector4,L=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);M.multiply(b.projectionMatrix,b.matrixWorldInverse);M.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);M.multiply(b.matrixWorld,b.projectionMatrixInverse);M.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n){var C=h.near,aa=h.far,wa=false,ka,Ba,ca,Y,U,$,ea,da,ia,ta,Fa,Ga,Qa,pa,Za,Ua,qb;J=u=r=q=0;F.elements.length=0;g.updateMatrixWorld();h.parent===
void 0&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);M.multiply(h.projectionMatrix,h.matrixWorldInverse);K.setFromMatrix(M);e=0;F.objects.length=0;F.sprites.length=0;F.lights.length=0;var hb=function(b){if(b.visible!==false){if((b instanceof THREE.Mesh||b instanceof THREE.Line)&&(b.frustumCulled===false||K.contains(b)===true)){H.copy(b.matrixWorld.getPosition());M.multiplyVector3(H);f=a();f.object=b;f.z=H.z;F.objects.push(f)}else if(b instanceof THREE.Sprite||b instanceof THREE.Particle){H.copy(b.matrixWorld.getPosition());
M.multiplyVector3(H);f=a();f.object=b;f.z=H.z;F.sprites.push(f)}else b instanceof THREE.Light&&F.lights.push(b);for(var c=0,d=b.children.length;c<d;c++)hb(b.children[c])}};hb(g);g=0;for(ka=F.objects.length;g<ka;g++){ia=F.objects[g].object;ta=ia.matrixWorld;j=0;if(ia instanceof THREE.Mesh){Fa=ia.geometry;Ga=ia.geometry.materials;Y=Fa.vertices;Qa=Fa.faces;Za=Fa.faceVertexUvs;Fa=ia.matrixRotationWorld.extractRotation(ta);qb=ia.material instanceof THREE.MeshFaceMaterial;Ba=0;for(ca=Y.length;Ba<ca;Ba++){i=
b();i.positionWorld.copy(Y[Ba]);ta.multiplyVector3(i.positionWorld);i.positionScreen.copy(i.positionWorld);M.multiplyVector4(i.positionScreen);i.positionScreen.x=i.positionScreen.x/i.positionScreen.w;i.positionScreen.y=i.positionScreen.y/i.positionScreen.w;i.visible=i.positionScreen.z>C&&i.positionScreen.z<aa}Y=0;for(Ba=Qa.length;Y<Ba;Y++){da=Qa[Y];ca=qb===true?Ga[da.materialIndex]:ia.material;if(ca!==void 0){ea=ca.side;if(da instanceof THREE.Face3){U=l[da.a];$=l[da.b];pa=l[da.c];if(U.visible===true&&
$.visible===true&&pa.visible===true){wa=(pa.positionScreen.x-U.positionScreen.x)*($.positionScreen.y-U.positionScreen.y)-(pa.positionScreen.y-U.positionScreen.y)*($.positionScreen.x-U.positionScreen.x)<0;if(ea===THREE.DoubleSide||wa===(ea===THREE.FrontSide)){if(q===o){Ua=new THREE.RenderableFace3;p.push(Ua);o++;q++;m=Ua}else m=p[q++];m.v1.copy(U);m.v2.copy($);m.v3.copy(pa)}else continue}else continue}else if(da instanceof THREE.Face4){U=l[da.a];$=l[da.b];pa=l[da.c];Ua=l[da.d];if(U.visible===true&&
$.visible===true&&pa.visible===true&&Ua.visible===true){wa=(Ua.positionScreen.x-U.positionScreen.x)*($.positionScreen.y-U.positionScreen.y)-(Ua.positionScreen.y-U.positionScreen.y)*($.positionScreen.x-U.positionScreen.x)<0||($.positionScreen.x-pa.positionScreen.x)*(Ua.positionScreen.y-pa.positionScreen.y)-($.positionScreen.y-pa.positionScreen.y)*(Ua.positionScreen.x-pa.positionScreen.x)<0;if(ea===THREE.DoubleSide||wa===(ea===THREE.FrontSide)){if(r===t){var db=new THREE.RenderableFace4;s.push(db);
t++;r++;m=db}else m=s[r++];m.v1.copy(U);m.v2.copy($);m.v3.copy(pa);m.v4.copy(Ua)}else continue}else continue}m.normalWorld.copy(da.normal);wa===false&&(ea===THREE.BackSide||ea===THREE.DoubleSide)&&m.normalWorld.negate();Fa.multiplyVector3(m.normalWorld);m.centroidWorld.copy(da.centroid);ta.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);M.multiplyVector3(m.centroidScreen);da=da.vertexNormals;U=0;for($=da.length;U<$;U++){pa=m.vertexNormalsWorld[U];pa.copy(da[U]);wa===false&&
(ea===THREE.BackSide||ea===THREE.DoubleSide)&&pa.negate();Fa.multiplyVector3(pa)}m.vertexNormalsLength=da.length;U=0;for($=Za.length;U<$;U++){pa=Za[U][Y];if(pa!==void 0){ea=0;for(da=pa.length;ea<da;ea++)m.uvs[U][ea]=pa[ea]}}m.material=ca;m.z=m.centroidScreen.z;F.elements.push(m)}}}else if(ia instanceof THREE.Line){D.multiply(M,ta);Y=ia.geometry.vertices;U=b();U.positionScreen.copy(Y[0]);D.multiplyVector4(U.positionScreen);ta=ia.type===THREE.LinePieces?2:1;Ba=1;for(ca=Y.length;Ba<ca;Ba++){U=b();U.positionScreen.copy(Y[Ba]);
D.multiplyVector4(U.positionScreen);if(!((Ba+1)%ta>0)){$=l[j-2];P.copy(U.positionScreen);L.copy($.positionScreen);if(d(P,L)===true){P.multiplyScalar(1/P.w);L.multiplyScalar(1/L.w);if(u===x){Ga=new THREE.RenderableLine;A.push(Ga);x++;u++;v=Ga}else v=A[u++];v.v1.positionScreen.copy(P);v.v2.positionScreen.copy(L);v.z=Math.max(P.z,L.z);v.material=ia.material;F.elements.push(v)}}}}}g=0;for(ka=F.sprites.length;g<ka;g++){ia=F.sprites[g].object;ta=ia.matrixWorld;if(ia instanceof THREE.Particle){G.set(ta.elements[12],
ta.elements[13],ta.elements[14],1);M.multiplyVector4(G);G.z=G.z/G.w;if(G.z>0&&G.z<1){if(J===I){C=new THREE.RenderableParticle;y.push(C);I++;J++;B=C}else B=y[J++];B.object=ia;B.x=G.x/G.w;B.y=G.y/G.w;B.z=G.z;B.rotation=ia.rotation.z;B.scale.x=ia.scale.x*Math.abs(B.x-(G.x+h.projectionMatrix.elements[0])/(G.w+h.projectionMatrix.elements[12]));B.scale.y=ia.scale.y*Math.abs(B.y-(G.y+h.projectionMatrix.elements[5])/(G.w+h.projectionMatrix.elements[13]));B.material=ia.material;F.elements.push(B)}}}n&&F.elements.sort(c);
...
i=g.faceNormals[c];j=g.vertexNormals[c];i.copy(f.normal);if(f instanceof THREE.Face3){j.a.copy(f.vertexNormals[0]);j.b.copy(f.vertexNormals[1]);j.c.copy(f.vertexNormals[2])}else{j.a.copy(f.vertexNormals[0]);j.b.copy(f.vertexNormals[1]);j.c.copy(f.vertexNormals[2]);j.d.copy(f.vertexNormals[3])}}}c=0;for(d=this.faces.length;c<d;c++){f=this.faces[c];f.normal=f.__originalFaceNormal;f.vertexNormals=f.__originalVertexNormals}},computeTangents:function(){function a(a,b,c,d,f,e,D){h=a.vertices[b];i=a.vertices[c];
j=a.vertices[d];l=g[f];n=g[e];m=g[D];q=i.x-h.x;p=j.x-h.x;o=i.y-h.y;r=j.y-h.y;s=i.z-h.z;t=j.z-h.z;v=n.u-l.u;u=m.u-l.u;A=n.v-l.v;x=m.v-l.v;B=1/(v*x-u*A);F.set((x*q-A*p)*B,(x*o-A*r)*B,(x*s-A*t)*B);H.set((v*p-u*q)*B,(v*r-u*o)*B,(v*t-u*s)*B);y[b].addSelf(F);y[c].addSelf(F);y[d].addSelf(F);I[b].addSelf(H);I[c].addSelf(H);I[d].addSelf(H)}var b,c,d,f,e,g,h,i,j,l,n,m,q,p,o,r,s,t,v,u,A,x,B,J,y=[],I=[],F=new THREE.Vector3,H=new THREE.Vector3,G=new THREE.Vector3,M=new THREE.Vector3,D=new THREE.Vector3;b=0;for(c=
this.vertices.length;b<c;b++){y[b]=new THREE.Vector3;I[b]=new THREE.Vector3}b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];g=this.faceVertexUvs[0][b];if(e instanceof THREE.Face3)a(this,e.a,e.b,e.c,0,1,2);else if(e instanceof THREE.Face4){a(this,e.a,e.b,e.d,0,1,3);a(this,e.b,e.c,e.d,1,2,3)}}var K=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];for(d=0;d<e.vertexNormals.length;d++){D.copy(e.vertexNormals[d]);f=e[K[d]];J=y[f];G.copy(J);G.subSelf(D.multiplyScalar(D.dot(J))).normalize();
M.cross(e.vertexNormals[d],J);f=M.dot(I[f]);f=f<0?-1:1;e.vertexTangents[d]=new THREE.Vector4(G.x,G.y,G.z,f)}}this.hasTangents=true},computeBoundingBox:function(){if(!this.boundingBox)this.boundingBox={min:new THREE.Vector3,max:new THREE.Vector3};if(this.vertices.length>0){var a;a=this.vertices[0];this.boundingBox.min.copy(a);this.boundingBox.max.copy(a);for(var b=this.boundingBox.min,c=this.boundingBox.max,d=1,f=this.vertices.length;d<f;d++){a=this.vertices[d];if(a.x<b.x)b.x=a.x;else if(a.x>c.x)c.x=
...
0}var f=this.offsets,e=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,n,m,q,p=new THREE.Vector3,o=new THREE.Vector3,r=new THREE.Vector3,s=new THREE.Vector3,t=new THREE.Vector3;c=0;for(d=f.length;c<d;++c){b=f[c].start;i=f[c].count;var v=f[c].index;a=b;for(b=b+i;a<b;a=a+3){i=v+e[a];j=v+e[a+1];l=v+e[a+2];n=g[i*3];m=g[i*3+1];q=g[i*3+2];p.set(n,m,q);n=g[j*3];m=g[j*3+1];q=g[j*3+2];o.set(n,m,q);n=g[l*3];m=g[l*3+1];q=g[l*3+2];r.set(n,m,q);s.sub(r,o);t.sub(p,
o);s.crossSelf(t);h[i*3]=h[i*3]+s.x;h[i*3+1]=h[i*3+1]+s.y;h[i*3+2]=h[i*3+2]+s.z;h[j*3]=h[j*3]+s.x;h[j*3+1]=h[j*3+1]+s.y;h[j*3+2]=h[j*3+2]+s.z;h[l*3]=h[l*3]+s.x;h[l*3+1]=h[l*3+1]+s.y;h[l*3+2]=h[l*3+2]+s.z}}a=0;for(b=h.length;a<b;a=a+3){n=h[a];m=h[a+1];q=h[a+2];c=1/Math.sqrt(n*n+m*m+q*q);h[a]=h[a]*c;h[a+1]=h[a+1]*c;h[a+2]=h[a+2]*c}this.normalsNeedUpdate=true}},computeTangents:function(){function a(a){X.x=d[a*3];X.y=d[a*3+1];X.z=d[a*3+2];O.copy(X);aa=i[a];L.copy(aa);L.subSelf(X.multiplyScalar(X.dot(aa))).normalize();
N.cross(O,aa);wa=N.dot(j[a]);C=wa<0?-1:1;h[a*4]=L.x;h[a*4+1]=L.y;h[a*4+2]=L.z;h[a*4+3]=C}if(this.attributes.index===void 0||this.attributes.position===void 0||this.attributes.normal===void 0||this.attributes.uv===void 0)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,e=c.length/3;if(this.attributes.tangent===
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<e;g++){i[g]=new THREE.Vector3;j[g]=new THREE.Vector3}var l,n,m,q,p,o,r,s,t,v,u,A,x,B,J,e=new THREE.Vector3,g=new THREE.Vector3,y,I,F,H,G,M,D,K=this.offsets;F=0;for(H=K.length;F<H;++F){I=K[F].start;G=K[F].count;var P=K[F].index;y=I;for(I=I+G;y<I;y=y+3){G=P+b[y];M=P+b[y+1];D=P+b[y+2];l=c[G*3];n=c[G*3+1];m=c[G*3+2];q=c[M*3];p=c[M*3+1];o=c[M*3+2];r=c[D*3];
s=c[D*3+1];t=c[D*3+2];v=f[G*2];u=f[G*2+1];A=f[M*2];x=f[M*2+1];B=f[D*2];J=f[D*2+1];q=q-l;l=r-l;p=p-n;n=s-n;o=o-m;m=t-m;A=A-v;v=B-v;x=x-u;u=J-u;J=1/(A*u-v*x);e.set((u*q-x*l)*J,(u*p-x*n)*J,(u*o-x*m)*J);g.set((A*l-v*q)*J,(A*n-v*p)*J,(A*m-v*o)*J);i[G].addSelf(e);i[M].addSelf(e);i[D].addSelf(e);j[G].addSelf(g);j[M].addSelf(g);j[D].addSelf(g)}}var L=new THREE.Vector3,N=new THREE.Vector3,X=new THREE.Vector3,O=new THREE.Vector3,C,aa,wa;F=0;for(H=K.length;F<H;++F){I=K[F].start;G=K[F].count;P=K[F].index;y=I;
for(I=I+G;y<I;y=y+3){G=P+b[y];M=P+b[y+1];D=P+b[y+2];a(G);a(M);a(D)}}this.tangentsNeedUpdate=this.hasTangents=true}}};
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,j,l,n,m,q,p,o,r,s,t,v,u;function A(a){return a%4?4-a%4:0}function x(a,b){return(new Uint8Array(a,b,1))[0]}function B(a,b){return(new Uint32Array(a,b,1))[0]}function J(b,c){var d,f,e,g,h,i,l,j,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=P[f*2];f=P[f*2+1];i=P[e*2];l=P[e*2+1];e=P[g*2];j=P[g*2+1];g=M.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,l));m.push(new THREE.UV(e,
j));g.push(m)}}function y(b,c){var d,f,e,g,h,i,l,j,n,m,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){f=o[d*4];e=o[d*4+1];g=o[d*4+2];h=o[d*4+3];i=P[f*2];f=P[f*2+1];l=P[e*2];n=P[e*2+1];j=P[g*2];m=P[g*2+1];g=P[h*2];e=P[h*2+1];h=M.faceVertexUvs[0];var p=[];p.push(new THREE.UV(i,f));p.push(new THREE.UV(l,n));p.push(new THREE.UV(j,m));p.push(new THREE.UV(g,e));h.push(p)}}function I(b,c,d){for(var f,e,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*3];e=c[d*3+1];g=c[d*3+2];h=i[d];
M.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function F(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),l=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=l[d];M.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function H(b,c,d,f){for(var e,g,h,i,l,j,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];l=d[f*3];j=d[f*3+1];n=d[f*3+2];i=m[f];var o=K[j*3],p=K[j*3+1];j=K[j*3+2];var q=K[n*3],
u=K[n*3+1];n=K[n*3+2];M.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(K[l*3],K[l*3+1],K[l*3+2]),new THREE.Vector3(o,p,j),new THREE.Vector3(q,u,n)],null,i))}}function G(b,c,d,f){for(var e,g,h,i,l,j,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];j=d[f*4];n=d[f*4+1];m=d[f*4+2];o=d[f*4+3];l=p[f];var q=K[n*3],u=K[n*3+1];n=K[n*3+2];var s=K[m*3],r=K[m*3+1];m=K[m*3+2];var t=K[o*3],v=K[o*3+1];o=K[o*3+2];M.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(K[j*3],K[j*3+1],K[j*3+2]),new THREE.Vector3(q,u,n),new THREE.Vector3(s,r,m),new THREE.Vector3(t,v,o)],null,l))}}var M=this,D=0,K=[],P=[],L,N,X;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(M,d,b);u=a;N=D;b=new Uint8Array(u,N,12);o="";for(t=0;t<12;t++)o=o+String.fromCharCode(b[N+t]);c=x(u,N+12);x(u,N+13);x(u,N+14);x(u,N+15);f=x(u,N+16);i=x(u,N+17);j=x(u,N+18);l=x(u,N+19);n=B(u,N+20);m=B(u,N+20+4);q=B(u,N+20+8);p=B(u,N+20+12);o=B(u,N+20+16);r=B(u,N+20+20);s=
B(u,N+20+24);t=B(u,N+20+28);b=B(u,N+20+32);v=B(u,N+20+36);u=B(u,N+20+40);D=D+c;N=f*3+l;X=f*4+l;L=p*N;c=o*(N+i*3);f=r*(N+j*3);l=s*(N+i*3+j*3);N=t*X;i=b*(X+i*4);j=v*(X+j*4);X=D;var D=new Float32Array(a,D,n*3),O,C,aa,wa;for(O=0;O<n;O++){C=D[O*3];aa=D[O*3+1];wa=D[O*3+2];M.vertices.push(new THREE.Vector3(C,aa,wa))}n=D=X+n*3*Float32Array.BYTES_PER_ELEMENT;if(m){D=new Int8Array(a,D,m*3);for(X=0;X<m;X++){O=D[X*3];C=D[X*3+1];aa=D[X*3+2];K.push(O/127,C/127,aa/127)}}D=n+m*3*Int8Array.BYTES_PER_ELEMENT;m=D=D+
A(m*3);if(q){D=new Float32Array(a,D,q*2);for(n=0;n<q;n++){X=D[n*2];O=D[n*2+1];P.push(X,O)}}q=D=m+q*2*Float32Array.BYTES_PER_ELEMENT;L=q+L+A(p*2);m=L+c+A(o*2);c=m+f+A(r*2);f=c+l+A(s*2);N=f+N+A(t*2);l=N+i+A(b*2);i=l+j+A(v*2);if(r){j=m+r*Uint32Array.BYTES_PER_ELEMENT*3;I(r,m,j+r*Uint32Array.BYTES_PER_ELEMENT*3);J(r,j)}if(s){r=c+s*Uint32Array.BYTES_PER_ELEMENT*3;j=r+s*Uint32Array.BYTES_PER_ELEMENT*3;H(s,c,r,j+s*Uint32Array.BYTES_PER_ELEMENT*3);J(s,j)}if(v){s=l+v*Uint32Array.BYTES_PER_ELEMENT*4;F(v,l,
s+v*Uint32Array.BYTES_PER_ELEMENT*4);y(v,s)}if(u){v=i+u*Uint32Array.BYTES_PER_ELEMENT*4;s=v+u*Uint32Array.BYTES_PER_ELEMENT*4;G(u,i,v,s+u*Uint32Array.BYTES_PER_ELEMENT*4);y(u,s)}p&&I(p,q,q+p*Uint32Array.BYTES_PER_ELEMENT*3);if(o){p=L+o*Uint32Array.BYTES_PER_ELEMENT*3;H(o,L,p,p+o*Uint32Array.BYTES_PER_ELEMENT*3)}t&&F(t,f,f+t*Uint32Array.BYTES_PER_ELEMENT*4);if(b){o=N+b*Uint32Array.BYTES_PER_ELEMENT*4;G(b,N,o,o+b*Uint32Array.BYTES_PER_ELEMENT*4)}this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,j,l,n,m,q,p,o,r,s,t,v=a.faces;q=a.vertices;var u=a.normals,A=a.colors,x=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&x++;for(e=0;e<x;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}c=0;for(i=q.length;c<i;){j=new THREE.Vector3;j.x=q[c++]*f;j.y=q[c++]*f;j.z=q[c++]*f;d.vertices.push(j)}c=0;for(i=v.length;c<i;){q=v[c++];j=q&1;h=q&2;e=q&4;g=q&8;n=q&
16;l=q&32;p=q&64;q=q&128;if(j){o=new THREE.Face4;o.a=v[c++];o.b=v[c++];o.c=v[c++];o.d=v[c++];j=4}else{o=new THREE.Face3;o.a=v[c++];o.b=v[c++];o.c=v[c++];j=3}if(h){h=v[c++];o.materialIndex=h}h=d.faces.length;if(e)for(e=0;e<x;e++){r=a.uvs[e];m=v[c++];t=r[m*2];m=r[m*2+1];d.faceUvs[e][h]=new THREE.UV(t,m)}if(g)for(e=0;e<x;e++){r=a.uvs[e];s=[];for(g=0;g<j;g++){m=v[c++];t=r[m*2];m=r[m*2+1];s[g]=new THREE.UV(t,m)}d.faceVertexUvs[e][h]=s}if(n){n=v[c++]*3;g=new THREE.Vector3;g.x=u[n++];g.y=u[n++];g.z=u[n];
o.normal=g}if(l)for(e=0;e<j;e++){n=v[c++]*3;g=new THREE.Vector3;g.x=u[n++];g.y=u[n++];g.z=u[n];o.vertexNormals.push(g)}if(p){l=v[c++];l=new THREE.Color(A[l]);o.color=l}if(q)for(e=0;e<j;e++){l=v[c++];l=new THREE.Color(A[l]);o.vertexColors.push(l)}d.faces.push(o)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c=c+2){v=a.skinWeights[c];u=a.skinWeights[c+1];d.skinWeights.push(new THREE.Vector4(v,u,0,0))}}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c=c+2){v=a.skinIndices[c];u=a.skinIndices[c+
1];d.skinIndices.push(new THREE.Vector4(v,u,0,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets!==void 0){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];A=d.morphTargets[c].vertices;x=a.morphTargets[c].vertices;v=0;for(u=x.length;v<u;v=v+3){q=new THREE.Vector3;q.x=x[v]*f;q.y=x[v+1]*f;q.z=x[v+2]*f;A.push(q)}}}if(a.morphColors!==void 0){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};
d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=[];u=d.morphColors[c].colors;A=a.morphColors[c].colors;f=0;for(v=A.length;f<v;f=f+3){x=new THREE.Color(16755200);x.setRGB(A[f],A[f+1],A[f+2]);u.push(x)}}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};THREE.GeometryLoader=function(){THREE.EventTarget.call(this);this.path=this.crossOrigin=null};
...
l.enableDiffuse.value=true}if(m.specularMap){l.tSpecular.value=m.specularMap;l.enableSpecular.value=true}if(m.lightMap){l.tAO.value=m.lightMap;l.enableAO.value=true}l.uDiffuseColor.value.setHex(m.color);l.uSpecularColor.value.setHex(m.specular);l.uAmbientColor.value.setHex(m.ambient);l.uShininess.value=m.shininess;if(m.opacity!==void 0)l.uOpacity.value=m.opacity;m=new THREE.ShaderMaterial({fragmentShader:j.fragmentShader,vertexShader:j.vertexShader,uniforms:l,lights:true,fog:true})}else m=new THREE[n](m);
if(g.DbgName!==void 0)m.name=g.DbgName;d.materials[e]=m}}var g=a.faces,p=a.vertices,m=a.normals,j=a.colors,l=0;if(a.uvs)for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&l++;for(e=0;e<l;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}n=0;for(q=p.length;n<q;){var o=new THREE.Vector3;o.x=p[n++]*f;o.y=p[n++]*f;o.z=p[n++]*f;d.vertices.push(o)}n=0;for(q=g.length;n<q;){var r=g[n++],s=r&2,e=r&4,t=r&8,v=r&16,p=r&32,u=r&64,o=r&128;if(r&1){r=new THREE.Face4;r.a=g[n++];r.b=g[n++];r.c=g[n++];r.d=g[n++];var A=4}else{r=new THREE.Face3;
r.a=g[n++];r.b=g[n++];r.c=g[n++];A=3}if(s){s=g[n++];r.materialIndex=s}var x=d.faces.length;if(e)for(e=0;e<l;e++){var B=a.uvs[e],s=g[n++],J=B[s*2],s=B[s*2+1];d.faceUvs[e][x]=new THREE.UV(J,s)}if(t)for(e=0;e<l;e++){for(var B=a.uvs[e],t=[],y=0;y<A;y++){s=g[n++];J=B[s*2];s=B[s*2+1];t[y]=new THREE.UV(J,s)}d.faceVertexUvs[e][x]=t}if(v){v=g[n++]*3;s=new THREE.Vector3;s.x=m[v++];s.y=m[v++];s.z=m[v];r.normal=s}if(p)for(e=0;e<A;e++){v=g[n++]*3;s=new THREE.Vector3;s.x=m[v++];s.y=m[v++];s.z=m[v];r.vertexNormals.push(s)}if(u){p=
g[n++];r.color=new THREE.Color(j[p])}if(o)for(e=0;e<A;e++){p=g[n++];r.vertexColors.push(new THREE.Color(j[p]))}d.faces.push(r)}if(a.skinWeights){e=0;for(g=a.skinWeights.length;e<g;e=e+2)d.skinWeights.push(new THREE.Vector4(a.skinWeights[e],a.skinWeights[e+1],0,0))}if(a.skinIndices){e=0;for(g=a.skinIndices.length;e<g;e=e+2){m=0;d.skinIndices.push(new THREE.Vector4(a.skinIndices[e],a.skinIndices[e+1],m,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets){e=0;for(g=a.morphTargets.length;e<
g;e++){d.morphTargets[e]={};d.morphTargets[e].name=a.morphTargets[e].name;d.morphTargets[e].vertices=[];m=d.morphTargets[e].vertices;j=a.morphTargets[e].vertices;s=0;for(l=j.length;s<l;s=s+3){o=new THREE.Vector3;o.x=j[s]*f;o.y=j[s+1]*f;o.z=j[s+2]*f;m.push(o)}}}if(a.morphColors){e=0;for(g=a.morphColors.length;e<g;e++){d.morphColors[e]={};d.morphColors[e].name=a.morphColors[e].name;d.morphColors[e].colors=[];f=d.morphColors[e].colors;j=a.morphColors[e].colors;m=0;for(l=j.length;m<l;m=m+3){n=new THREE.Color(16755200);
n.setRGB(j[m],j[m+1],j[m+2]);f.push(n)}}}d.computeCentroids();d.computeFaceNormals();return d}};THREE.SceneLoader=function(){this.onLoadStart=function(){};this.onLoadProgress=function(){};this.onLoadComplete=function(){};this.callbackSync=function(){};this.callbackProgress=function(){}};THREE.SceneLoader.prototype.constructor=THREE.SceneLoader;
...
THREE.SceneLoader.prototype.createScene=function(a,b,c){function d(a,b){return b=="relativeToHTML"?a:j+"/"+a}function f(a,b){var c;for(m in b)if(O.objects[m]===void 0){s=b[m];if(s.geometry!==void 0){if(F=O.geometries[s.geometry]){c=false;H=O.materials[s.materials[0]];(c=H instanceof THREE.ShaderMaterial)&&F.computeTangents();A=s.position;x=s.rotation;B=s.quaternion;J=s.scale;t=s.matrix;B=0;s.materials.length==0&&(H=new THREE.MeshFaceMaterial);s.materials.length>1&&(H=new THREE.MeshFaceMaterial);c=
new THREE.Mesh(F,H);c.name=m;if(t){c.matrixAutoUpdate=false;c.matrix.set(t[0],t[1],t[2],t[3],t[4],t[5],t[6],t[7],t[8],t[9],t[10],t[11],t[12],t[13],t[14],t[15])}else{c.position.set(A[0],A[1],A[2]);if(B){c.quaternion.set(B[0],B[1],B[2],B[3]);c.useQuaternion=true}else c.rotation.set(x[0],x[1],x[2]);c.scale.set(J[0],J[1],J[2])}c.visible=s.visible;c.castShadow=s.castShadow;c.receiveShadow=s.receiveShadow;a.add(c);O.objects[m]=c}}else{A=s.position;x=s.rotation;B=s.quaternion;J=s.scale;B=0;c=new THREE.Object3D;
c.name=m;c.position.set(A[0],A[1],A[2]);if(B){c.quaternion.set(B[0],B[1],B[2],B[3]);c.useQuaternion=true}else c.rotation.set(x[0],x[1],x[2]);c.scale.set(J[0],J[1],J[2]);c.visible=s.visible!==void 0?s.visible:false;a.add(c);O.objects[m]=c;O.empties[m]=c}if(s.properties!==void 0)for(var d in s.properties)c.properties[d]=s.properties[d];s.children!==void 0&&f(c,s.children)}}function e(a){return function(b){O.geometries[a]=b;f(O.scene,D.objects);P=P-1;i.onLoadComplete();h()}}function g(a){return function(b){O.geometries[a]=
b}}function h(){i.callbackProgress({totalModels:N,totalTextures:X,loadedModels:N-P,loadedTextures:X-L},O);i.onLoadProgress();P===0&&L===0&&b(O)}var i=this,j=THREE.Loader.prototype.extractUrlBase(c),l,n,m,q,p,o,r,s,t,v,u,A,x,B,J,y,I,F,H,G,M,D,K,P,L,N,X,O;D=a;c=new THREE.BinaryLoader;K=new THREE.JSONLoader;L=P=0;O={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(D.transform){a=D.transform.position;v=D.transform.rotation;y=D.transform.scale;
a&&O.scene.position.set(a[0],a[1],a[2]);v&&O.scene.rotation.set(v[0],v[1],v[2]);y&&O.scene.scale.set(y[0],y[1],y[2]);if(a||v||y){O.scene.updateMatrix();O.scene.updateMatrixWorld()}}a=function(a){return function(){L=L-a;h();i.onLoadComplete()}};for(p in D.cameras){y=D.cameras[p];y.type==="perspective"?G=new THREE.PerspectiveCamera(y.fov,y.aspect,y.near,y.far):y.type==="ortho"&&(G=new THREE.OrthographicCamera(y.left,y.right,y.top,y.bottom,y.near,y.far));A=y.position;v=y.target;y=y.up;G.position.set(A[0],
A[1],A[2]);G.target=new THREE.Vector3(v[0],v[1],v[2]);y&&G.up.set(y[0],y[1],y[2]);O.cameras[p]=G}for(q in D.lights){v=D.lights[q];p=v.color!==void 0?v.color:16777215;G=v.intensity!==void 0?v.intensity:1;if(v.type==="directional"){A=v.direction;u=new THREE.DirectionalLight(p,G);u.position.set(A[0],A[1],A[2]);u.position.normalize()}else if(v.type==="point"){A=v.position;u=v.distance;u=new THREE.PointLight(p,G,u);u.position.set(A[0],A[1],A[2])}else v.type==="ambient"&&(u=new THREE.AmbientLight(p));O.scene.add(u);
O.lights[q]=u}for(o in D.fogs){q=D.fogs[o];q.type==="linear"?M=new THREE.Fog(0,q.near,q.far):q.type==="exp2"&&(M=new THREE.FogExp2(0,q.density));y=q.color;M.color.setRGB(y[0],y[1],y[2]);O.fogs[o]=M}if(O.cameras&&D.defaults.camera)O.currentCamera=O.cameras[D.defaults.camera];if(O.fogs&&D.defaults.fog)O.scene.fog=O.fogs[D.defaults.fog];y=D.defaults.bgcolor;O.bgColor=new THREE.Color;O.bgColor.setRGB(y[0],y[1],y[2]);O.bgColorAlpha=D.defaults.bgalpha;for(l in D.geometries){o=D.geometries[l];if(o.type==
"bin_mesh"||o.type=="ascii_mesh"){P=P+1;i.onLoadStart()}}N=P;for(l in D.geometries){o=D.geometries[l];if(o.type==="cube"){F=new THREE.CubeGeometry(o.width,o.height,o.depth,o.segmentsWidth,o.segmentsHeight,o.segmentsDepth,null,o.flipped,o.sides);O.geometries[l]=F}else if(o.type==="plane"){F=new THREE.PlaneGeometry(o.width,o.height,o.segmentsWidth,o.segmentsHeight);O.geometries[l]=F}else if(o.type==="sphere"){F=new THREE.SphereGeometry(o.radius,o.segmentsWidth,o.segmentsHeight);O.geometries[l]=F}else if(o.type===
"cylinder"){F=new THREE.CylinderGeometry(o.topRad,o.botRad,o.height,o.radSegs,o.heightSegs);O.geometries[l]=F}else if(o.type==="torus"){F=new THREE.TorusGeometry(o.radius,o.tube,o.segmentsR,o.segmentsT);O.geometries[l]=F}else if(o.type==="icosahedron"){F=new THREE.IcosahedronGeometry(o.radius,o.subdivisions);O.geometries[l]=F}else if(o.type==="bin_mesh")c.load(d(o.url,D.urlBaseType),e(l));else if(o.type==="ascii_mesh")K.load(d(o.url,D.urlBaseType),e(l));else if(o.type==="embedded_mesh"){o=D.embeds[o.id];
o.metadata=D.metadata;o&&K.createModel(o,g(l),"")}}for(r in D.textures){l=D.textures[r];if(l.url instanceof Array){L=L+l.url.length;for(o=0;o<l.url.length;o++)i.onLoadStart()}else{L=L+1;i.onLoadStart()}}X=L;for(r in D.textures){l=D.textures[r];if(l.mapping!==void 0&&THREE[l.mapping]!==void 0)l.mapping=new THREE[l.mapping];if(l.url instanceof Array){o=l.url.length;M=[];for(c=0;c<o;c++)M[c]=d(l.url[c],D.urlBaseType);o=THREE.ImageUtils.loadTextureCube(M,l.mapping,a(o))}else{o=THREE.ImageUtils.loadTexture(d(l.url,
D.urlBaseType),l.mapping,a(1));if(THREE[l.minFilter]!==void 0)o.minFilter=THREE[l.minFilter];if(THREE[l.magFilter]!==void 0)o.magFilter=THREE[l.magFilter];if(l.repeat){o.repeat.set(l.repeat[0],l.repeat[1]);if(l.repeat[0]!==1)o.wrapS=THREE.RepeatWrapping;if(l.repeat[1]!==1)o.wrapT=THREE.RepeatWrapping}l.offset&&o.offset.set(l.offset[0],l.offset[1]);if(l.wrap){M={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(M[l.wrap[0]]!==void 0)o.wrapS=M[l.wrap[0]];if(M[l.wrap[1]]!==void 0)o.wrapT=
M[l.wrap[1]]}}O.textures[r]=o}for(n in D.materials){t=D.materials[n];for(I in t.parameters)if(I==="envMap"||I==="map"||I==="lightMap")t.parameters[I]=O.textures[t.parameters[I]];else if(I==="shading")t.parameters[I]=t.parameters[I]=="flat"?THREE.FlatShading:THREE.SmoothShading;else if(I==="blending")t.parameters[I]=t.parameters[I]in THREE?THREE[t.parameters[I]]:THREE.NormalBlending;else if(I==="combine")t.parameters[I]=t.parameters[I]=="MixOperation"?THREE.MixOperation:THREE.MultiplyOperation;else if(I===
"vertexColors")if(t.parameters[I]=="face")t.parameters[I]=THREE.FaceColors;else if(t.parameters[I])t.parameters[I]=THREE.VertexColors;if(t.parameters.opacity!==void 0&&t.parameters.opacity<1)t.parameters.transparent=true;if(t.parameters.normalMap){r=THREE.ShaderUtils.lib.normal;a=THREE.UniformsUtils.clone(r.uniforms);l=t.parameters.color;o=t.parameters.specular;M=t.parameters.ambient;c=t.parameters.shininess;a.tNormal.value=O.textures[t.parameters.normalMap];if(t.parameters.normalMapFactor)a.uNormalScale.value=
t.parameters.normalMapFactor;if(t.parameters.map){a.tDiffuse.value=t.parameters.map;a.enableDiffuse.value=true}if(t.parameters.lightMap){a.tAO.value=t.parameters.lightMap;a.enableAO.value=true}if(t.parameters.specularMap){a.tSpecular.value=O.textures[t.parameters.specularMap];a.enableSpecular.value=true}a.uDiffuseColor.value.setHex(l);a.uSpecularColor.value.setHex(o);a.uAmbientColor.value.setHex(M);a.uShininess.value=c;if(t.parameters.opacity)a.uOpacity.value=t.parameters.opacity;H=new THREE.ShaderMaterial({fragmentShader:r.fragmentShader,
vertexShader:r.vertexShader,uniforms:a,lights:true,fog:true})}else H=new THREE[t.type](t.parameters);O.materials[n]=H}f(O.scene,D.objects);i.callbackSync(O);h()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
THREE.CanvasRenderer=function(a){function b(a){if(t!==a)t=o.globalAlpha=a}function c(a){if(v!==a){if(a===THREE.NormalBlending)o.globalCompositeOperation="source-over";else if(a===THREE.AdditiveBlending)o.globalCompositeOperation="lighter";else if(a===THREE.SubtractiveBlending)o.globalCompositeOperation="darker";v=a}}function d(a){if(u!==a)u=o.strokeStyle=a}function f(a){if(A!==a)A=o.fillStyle=a}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},e=this,g,h,i,j=new THREE.Projector,l=a.canvas!==
void 0?a.canvas:document.createElement("canvas"),n,m,q,p,o=l.getContext("2d"),r=new THREE.Color(0),s=0,t=1,v=0,u=null,A=null,x=null,B=null,J=null,y,I,F,H,G=new THREE.RenderableVertex,M=new THREE.RenderableVertex,D,K,P,L,N,X,O,C,aa,wa,ka,Ba,ca=new THREE.Color,Y=new THREE.Color,U=new THREE.Color,$=new THREE.Color,ea=new THREE.Color,da=[],ia=[],ta,Fa,Ga,Qa,pa,Za,Ua,qb,hb,db,cb=new THREE.Rectangle,Ha=new THREE.Rectangle,Ca=new THREE.Rectangle,eb=false,Ia=new THREE.Color,ib=new THREE.Color,jb=new THREE.Color,
ua=new THREE.Vector3,tb,Va,Xa,Ka,fb,k,a=16;tb=document.createElement("canvas");tb.width=tb.height=2;Va=tb.getContext("2d");Va.fillStyle="rgba(0,0,0,1)";Va.fillRect(0,0,2,2);Xa=Va.getImageData(0,0,2,2);Ka=Xa.data;fb=document.createElement("canvas");fb.width=fb.height=a;k=fb.getContext("2d");k.translate(-a/2,-a/2);k.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=true;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){n=a;m=b;q=Math.floor(n/2);p=Math.floor(m/
2);l.width=n;l.height=m;cb.set(-q,-p,q,p);Ha.set(-q,-p,q,p);t=1;v=0;J=B=x=A=u=null};this.setClearColor=function(a,b){r.copy(a);s=b!==void 0?b:1;Ha.set(-q,-p,q,p)};this.setClearColorHex=function(a,b){r.setHex(a);s=b!==void 0?b:1;Ha.set(-q,-p,q,p)};this.clear=function(){o.setTransform(1,0,0,-1,q,p);if(Ha.isEmpty()===false){Ha.minSelf(cb);Ha.inflate(2);s<1&&o.clearRect(Math.floor(Ha.getX()),Math.floor(Ha.getY()),Math.floor(Ha.getWidth()),Math.floor(Ha.getHeight()));if(s>0){c(THREE.NormalBlending);b(1);
f("rgba("+Math.floor(r.r*255)+","+Math.floor(r.g*255)+","+Math.floor(r.b*255)+","+s+")");o.fillRect(Math.floor(Ha.getX()),Math.floor(Ha.getY()),Math.floor(Ha.getWidth()),Math.floor(Ha.getHeight()))}Ha.empty()}};this.render=function(a,l){function n(a,b,c){for(var d=0,f=i.length;d<f;d++){var e=i[d],g=e.color;if(e instanceof THREE.DirectionalLight){var h=e.matrixWorld.getPosition().normalize(),k=b.dot(h);if(!(k<=0)){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}else if(e instanceof THREE.PointLight){h=
e.matrixWorld.getPosition();k=b.dot(ua.sub(h,a).normalize());if(!(k<=0)){k=k*(e.distance==0?1:1-Math.min(a.distanceTo(h)/e.distance,1));if(k!=0){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}}}}function m(a,d,f,g,h,i,k,j){e.info.render.vertices=e.info.render.vertices+3;e.info.render.faces++;b(j.opacity);c(j.blending);D=a.positionScreen.x;K=a.positionScreen.y;P=d.positionScreen.x;L=d.positionScreen.y;N=f.positionScreen.x;X=f.positionScreen.y;u(D,K,P,L,N,X);if(j instanceof THREE.MeshBasicMaterial)if(j.map!==
null){if(j.map.mapping instanceof THREE.UVMapping){Qa=k.uvs[0];t(D,K,P,L,N,X,Qa[g].u,Qa[g].v,Qa[h].u,Qa[h].v,Qa[i].u,Qa[i].v,j.map)}}else if(j.envMap!==null){if(j.envMap.mapping instanceof THREE.SphericalReflectionMapping){a=l.matrixWorldInverse;ua.copy(k.vertexNormalsWorld[g]);pa=(ua.x*a.elements[0]+ua.y*a.elements[4]+ua.z*a.elements[8])*0.5+0.5;Za=(ua.x*a.elements[1]+ua.y*a.elements[5]+ua.z*a.elements[9])*0.5+0.5;ua.copy(k.vertexNormalsWorld[h]);Ua=(ua.x*a.elements[0]+ua.y*a.elements[4]+ua.z*a.elements[8])*
0.5+0.5;qb=(ua.x*a.elements[1]+ua.y*a.elements[5]+ua.z*a.elements[9])*0.5+0.5;ua.copy(k.vertexNormalsWorld[i]);hb=(ua.x*a.elements[0]+ua.y*a.elements[4]+ua.z*a.elements[8])*0.5+0.5;db=(ua.x*a.elements[1]+ua.y*a.elements[5]+ua.z*a.elements[9])*0.5+0.5;t(D,K,P,L,N,X,pa,Za,Ua,qb,hb,db,j.envMap)}}else j.wireframe===true?r(j.color,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):Nb(j.color);else if(j instanceof THREE.MeshLambertMaterial)if(eb===true)if(j.wireframe===false&&j.shading==THREE.SmoothShading&&
k.vertexNormalsLength==3){Y.r=U.r=$.r=Ia.r;Y.g=U.g=$.g=Ia.g;Y.b=U.b=$.b=Ia.b;n(k.v1.positionWorld,k.vertexNormalsWorld[0],Y);n(k.v2.positionWorld,k.vertexNormalsWorld[1],U);n(k.v3.positionWorld,k.vertexNormalsWorld[2],$);Y.r=Math.max(0,Math.min(j.color.r*Y.r,1));Y.g=Math.max(0,Math.min(j.color.g*Y.g,1));Y.b=Math.max(0,Math.min(j.color.b*Y.b,1));U.r=Math.max(0,Math.min(j.color.r*U.r,1));U.g=Math.max(0,Math.min(j.color.g*U.g,1));U.b=Math.max(0,Math.min(j.color.b*U.b,1));$.r=Math.max(0,Math.min(j.color.r*
$.r,1));$.g=Math.max(0,Math.min(j.color.g*$.g,1));$.b=Math.max(0,Math.min(j.color.b*$.b,1));ea.r=(U.r+$.r)*0.5;ea.g=(U.g+$.g)*0.5;ea.b=(U.b+$.b)*0.5;Ga=Vb(Y,U,$,ea);wb(D,K,P,L,N,X,0,0,1,0,0,1,Ga)}else{ca.r=Ia.r;ca.g=Ia.g;ca.b=Ia.b;n(k.centroidWorld,k.normalWorld,ca);ca.r=Math.max(0,Math.min(j.color.r*ca.r,1));ca.g=Math.max(0,Math.min(j.color.g*ca.g,1));ca.b=Math.max(0,Math.min(j.color.b*ca.b,1));j.wireframe===true?r(ca,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):Nb(ca)}else j.wireframe===
true?r(j.color,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):Nb(j.color);else if(j instanceof THREE.MeshDepthMaterial){ta=l.near;Fa=l.far;Y.r=Y.g=Y.b=1-v(a.positionScreen.z,ta,Fa);U.r=U.g=U.b=1-v(d.positionScreen.z,ta,Fa);$.r=$.g=$.b=1-v(f.positionScreen.z,ta,Fa);ea.r=(U.r+$.r)*0.5;ea.g=(U.g+$.g)*0.5;ea.b=(U.b+$.b)*0.5;Ga=Vb(Y,U,$,ea);wb(D,K,P,L,N,X,0,0,1,0,0,1,Ga)}else if(j instanceof THREE.MeshNormalMaterial){ca.r=jc(k.normalWorld.x);ca.g=jc(k.normalWorld.y);ca.b=jc(k.normalWorld.z);
j.wireframe===true?r(ca,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):Nb(ca)}}function u(a,b,c,d,f,e){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.closePath()}function s(a,b,c,d,f,e,g,h){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.lineTo(g,h);o.closePath()}function r(a,b,c,f){if(x!==b)x=o.lineWidth=b;if(B!==c)B=o.lineCap=c;if(J!==f)J=o.lineJoin=f;d(a.getContextStyle());o.stroke();Ca.inflate(b*2)}function Nb(a){f(a.getContextStyle());o.fill()}function t(a,
b,c,d,e,g,h,i,k,j,l,n,m){if(!(m.image===void 0||m.image.width===0)){if(m.needsUpdate===true||da[m.id]===void 0){var p=m.wrapS==THREE.RepeatWrapping,q=m.wrapT==THREE.RepeatWrapping;da[m.id]=o.createPattern(m.image,p===true&&q===true?"repeat":p===true&&q===false?"repeat-x":p===false&&q===true?"repeat-y":"no-repeat");m.needsUpdate=false}f(da[m.id]);var p=m.offset.x/m.repeat.x,q=m.offset.y/m.repeat.y,Vb=m.image.width*m.repeat.x,wb=m.image.height*m.repeat.y,h=(h+p)*Vb,i=(1-i+q)*wb,c=c-a,d=d-b,e=e-a,g=
g-b,k=(k+p)*Vb-h,j=(1-j+q)*wb-i,l=(l+p)*Vb-h,n=(1-n+q)*wb-i,p=k*n-l*j;if(p===0){if(ia[m.id]===void 0){b=document.createElement("canvas");b.width=m.image.width;b.height=m.image.height;b=b.getContext("2d");b.drawImage(m.image,0,0);ia[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data}b=ia[m.id];h=(Math.floor(h)+Math.floor(i)*m.image.width)*4;ca.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255);Nb(ca)}else{p=1/p;m=(n*c-j*e)*p;j=(n*d-j*g)*p;c=(k*e-l*c)*p;d=(k*g-l*d)*p;a=a-m*h-c*i;h=b-j*h-d*i;o.save();o.transform(m,
j,c,d,a,h);o.fill();o.restore()}}}function wb(a,b,c,d,f,e,g,h,i,k,j,l,m){var n,p;n=m.width-1;p=m.height-1;g=g*n;h=h*p;c=c-a;d=d-b;f=f-a;e=e-b;i=i*n-g;k=k*p-h;j=j*n-g;l=l*p-h;p=1/(i*l-j*k);n=(l*c-k*f)*p;k=(l*d-k*e)*p;c=(i*f-j*c)*p;d=(i*e-j*d)*p;a=a-n*g-c*h;b=b-k*g-d*h;o.save();o.transform(n,k,c,d,a,b);o.clip();o.drawImage(m,0,0);o.restore()}function Vb(a,b,c,d){var f=a.r*255|0,e=a.g*255|0,a=a.b*255|0,g=b.r*255|0,h=b.g*255|0,b=b.b*255|0,i=c.r*255|0,j=c.g*255|0,c=c.b*255|0,l=d.r*255|0,m=d.g*255|0,d=
d.b*255|0;Ka[0]=f<0?0:f>255?255:f;Ka[1]=e<0?0:e>255?255:e;Ka[2]=a<0?0:a>255?255:a;Ka[4]=g<0?0:g>255?255:g;Ka[5]=h<0?0:h>255?255:h;Ka[6]=b<0?0:b>255?255:b;Ka[8]=i<0?0:i>255?255:i;Ka[9]=j<0?0:j>255?255:j;Ka[10]=c<0?0:c>255?255:c;Ka[12]=l<0?0:l>255?255:l;Ka[13]=m<0?0:m>255?255:m;Ka[14]=d<0?0:d>255?255:d;Va.putImageData(Xa,0,0);k.drawImage(tb,0,0);return fb}function v(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function jc(a){a=(a+1)*0.5;return a<0?0:a>1?1:a}function A(a,b){var c=b.x-a.x,d=b.y-a.y,f=c*c+
d*d;if(f!==0){f=1/Math.sqrt(f);c=c*f;d=d*f;b.x=b.x+c;b.y=b.y+d;a.x=a.x-c;a.y=a.y-d}}if(l instanceof THREE.Camera===false)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{var Wb,Fc,la,V;this.autoClear===true?this.clear():o.setTransform(1,0,0,-1,q,p);e.info.render.vertices=0;e.info.render.faces=0;g=j.projectScene(a,l,this.sortElements);h=g.elements;i=g.lights;eb=i.length>0;if(eb===true){Ia.setRGB(0,0,0);ib.setRGB(0,0,0);jb.setRGB(0,0,0);Wb=0;for(Fc=i.length;Wb<
Fc;Wb++){V=i[Wb];var ha=V.color;if(V instanceof THREE.AmbientLight){Ia.r=Ia.r+ha.r;Ia.g=Ia.g+ha.g;Ia.b=Ia.b+ha.b}else if(V instanceof THREE.DirectionalLight){ib.r=ib.r+ha.r;ib.g=ib.g+ha.g;ib.b=ib.b+ha.b}else if(V instanceof THREE.PointLight){jb.r=jb.r+ha.r;jb.g=jb.g+ha.g;jb.b=jb.b+ha.b}}}Wb=0;for(Fc=h.length;Wb<Fc;Wb++){la=h[Wb];V=la.material;if(!(V===void 0||V.visible===false)){Ca.empty();if(la instanceof THREE.RenderableParticle){y=la;y.x=y.x*q;y.y=y.y*p;var ha=y,Wa=la;b(V.opacity);c(V.blending);
var rb=void 0,sb=void 0,kb=void 0,lb=void 0,kc=la=void 0,Uc=void 0;if(V instanceof THREE.ParticleBasicMaterial)if(V.map===null){kb=Wa.object.scale.x;lb=Wa.object.scale.y;kb=kb*Wa.scale.x*q;lb=lb*Wa.scale.y*p;Ca.set(ha.x-kb,ha.y-lb,ha.x+kb,ha.y+lb);if(cb.intersects(Ca)!==false){f(V.color.getContextStyle());o.save();o.translate(ha.x,ha.y);o.rotate(-Wa.rotation);o.scale(kb,lb);o.fillRect(-1,-1,2,2);o.restore()}}else{la=V.map.image;kc=la.width>>1;Uc=la.height>>1;kb=Wa.scale.x*q;lb=Wa.scale.y*p;rb=kb*
kc;sb=lb*Uc;Ca.set(ha.x-rb,ha.y-sb,ha.x+rb,ha.y+sb);if(cb.intersects(Ca)!==false){o.save();o.translate(ha.x,ha.y);o.rotate(-Wa.rotation);o.scale(kb,-lb);o.translate(-kc,-Uc);o.drawImage(la,0,0);o.restore()}}else if(V instanceof THREE.ParticleCanvasMaterial){rb=Wa.scale.x*q;sb=Wa.scale.y*p;Ca.set(ha.x-rb,ha.y-sb,ha.x+rb,ha.y+sb);if(cb.intersects(Ca)!==false){d(V.color.getContextStyle());f(V.color.getContextStyle());o.save();o.translate(ha.x,ha.y);o.rotate(-Wa.rotation);o.scale(rb,sb);V.program(o);
o.restore()}}}else if(la instanceof THREE.RenderableLine){y=la.v1;I=la.v2;y.positionScreen.x=y.positionScreen.x*q;y.positionScreen.y=y.positionScreen.y*p;I.positionScreen.x=I.positionScreen.x*q;I.positionScreen.y=I.positionScreen.y*p;Ca.addPoint(y.positionScreen.x,y.positionScreen.y);Ca.addPoint(I.positionScreen.x,I.positionScreen.y);if(cb.intersects(Ca)===true){ha=y;Wa=I;b(V.opacity);c(V.blending);o.beginPath();o.moveTo(ha.positionScreen.x,ha.positionScreen.y);o.lineTo(Wa.positionScreen.x,Wa.positionScreen.y);
if(V instanceof THREE.LineBasicMaterial){ha=V.linewidth;if(x!==ha)x=o.lineWidth=ha;ha=V.linecap;if(B!==ha)B=o.lineCap=ha;ha=V.linejoin;if(J!==ha)J=o.lineJoin=ha;d(V.color.getContextStyle());o.stroke();Ca.inflate(V.linewidth*2)}}}else if(la instanceof THREE.RenderableFace3){y=la.v1;I=la.v2;F=la.v3;y.positionScreen.x=y.positionScreen.x*q;y.positionScreen.y=y.positionScreen.y*p;I.positionScreen.x=I.positionScreen.x*q;I.positionScreen.y=I.positionScreen.y*p;F.positionScreen.x=F.positionScreen.x*q;F.positionScreen.y=
F.positionScreen.y*p;if(V.overdraw===true){A(y.positionScreen,I.positionScreen);A(I.positionScreen,F.positionScreen);A(F.positionScreen,y.positionScreen)}Ca.add3Points(y.positionScreen.x,y.positionScreen.y,I.positionScreen.x,I.positionScreen.y,F.positionScreen.x,F.positionScreen.y);cb.intersects(Ca)===true&&m(y,I,F,0,1,2,la,V,a)}else if(la instanceof THREE.RenderableFace4){y=la.v1;I=la.v2;F=la.v3;H=la.v4;y.positionScreen.x=y.positionScreen.x*q;y.positionScreen.y=y.positionScreen.y*p;I.positionScreen.x=
I.positionScreen.x*q;I.positionScreen.y=I.positionScreen.y*p;F.positionScreen.x=F.positionScreen.x*q;F.positionScreen.y=F.positionScreen.y*p;H.positionScreen.x=H.positionScreen.x*q;H.positionScreen.y=H.positionScreen.y*p;G.positionScreen.copy(I.positionScreen);M.positionScreen.copy(H.positionScreen);if(V.overdraw===true){A(y.positionScreen,I.positionScreen);A(I.positionScreen,H.positionScreen);A(H.positionScreen,y.positionScreen);A(F.positionScreen,G.positionScreen);A(F.positionScreen,M.positionScreen)}Ca.addPoint(y.positionScreen.x,
y.positionScreen.y);Ca.addPoint(I.positionScreen.x,I.positionScreen.y);Ca.addPoint(F.positionScreen.x,F.positionScreen.y);Ca.addPoint(H.positionScreen.x,H.positionScreen.y);if(cb.intersects(Ca)===true){ha=y;Wa=I;rb=F;sb=H;kb=G;lb=M;kc=a;e.info.render.vertices=e.info.render.vertices+4;e.info.render.faces++;b(V.opacity);c(V.blending);if(V.map!==void 0&&V.map!==null||V.envMap!==void 0&&V.envMap!==null){m(ha,Wa,sb,0,1,3,la,V,kc);m(kb,rb,lb,1,2,3,la,V,kc)}else{D=ha.positionScreen.x;K=ha.positionScreen.y;
P=Wa.positionScreen.x;L=Wa.positionScreen.y;N=rb.positionScreen.x;X=rb.positionScreen.y;O=sb.positionScreen.x;C=sb.positionScreen.y;aa=kb.positionScreen.x;wa=kb.positionScreen.y;ka=lb.positionScreen.x;Ba=lb.positionScreen.y;if(V instanceof THREE.MeshBasicMaterial){s(D,K,P,L,N,X,O,C);V.wireframe===true?r(V.color,V.wireframeLinewidth,V.wireframeLinecap,V.wireframeLinejoin):Nb(V.color)}else if(V instanceof THREE.MeshLambertMaterial)if(eb===true)if(V.wireframe===false&&V.shading==THREE.SmoothShading&&
la.vertexNormalsLength==4){Y.r=U.r=$.r=ea.r=Ia.r;Y.g=U.g=$.g=ea.g=Ia.g;Y.b=U.b=$.b=ea.b=Ia.b;n(la.v1.positionWorld,la.vertexNormalsWorld[0],Y);n(la.v2.positionWorld,la.vertexNormalsWorld[1],U);n(la.v4.positionWorld,la.vertexNormalsWorld[3],$);n(la.v3.positionWorld,la.vertexNormalsWorld[2],ea);Y.r=Math.max(0,Math.min(V.color.r*Y.r,1));Y.g=Math.max(0,Math.min(V.color.g*Y.g,1));Y.b=Math.max(0,Math.min(V.color.b*Y.b,1));U.r=Math.max(0,Math.min(V.color.r*U.r,1));U.g=Math.max(0,Math.min(V.color.g*U.g,1));
U.b=Math.max(0,Math.min(V.color.b*U.b,1));$.r=Math.max(0,Math.min(V.color.r*$.r,1));$.g=Math.max(0,Math.min(V.color.g*$.g,1));$.b=Math.max(0,Math.min(V.color.b*$.b,1));ea.r=Math.max(0,Math.min(V.color.r*ea.r,1));ea.g=Math.max(0,Math.min(V.color.g*ea.g,1));ea.b=Math.max(0,Math.min(V.color.b*ea.b,1));Ga=Vb(Y,U,$,ea);u(D,K,P,L,O,C);wb(D,K,P,L,O,C,0,0,1,0,0,1,Ga);u(aa,wa,N,X,ka,Ba);wb(aa,wa,N,X,ka,Ba,1,0,1,1,0,1,Ga)}else{ca.r=Ia.r;ca.g=Ia.g;ca.b=Ia.b;n(la.centroidWorld,la.normalWorld,ca);ca.r=Math.max(0,
Math.min(V.color.r*ca.r,1));ca.g=Math.max(0,Math.min(V.color.g*ca.g,1));ca.b=Math.max(0,Math.min(V.color.b*ca.b,1));s(D,K,P,L,N,X,O,C);V.wireframe===true?r(ca,V.wireframeLinewidth,V.wireframeLinecap,V.wireframeLinejoin):Nb(ca)}else{s(D,K,P,L,N,X,O,C);V.wireframe===true?r(V.color,V.wireframeLinewidth,V.wireframeLinecap,V.wireframeLinejoin):Nb(V.color)}else if(V instanceof THREE.MeshNormalMaterial){ca.r=jc(la.normalWorld.x);ca.g=jc(la.normalWorld.y);ca.b=jc(la.normalWorld.z);s(D,K,P,L,N,X,O,C);V.wireframe===
true?r(ca,V.wireframeLinewidth,V.wireframeLinecap,V.wireframeLinejoin):Nb(ca)}else if(V instanceof THREE.MeshDepthMaterial){ta=l.near;Fa=l.far;Y.r=Y.g=Y.b=1-v(ha.positionScreen.z,ta,Fa);U.r=U.g=U.b=1-v(Wa.positionScreen.z,ta,Fa);$.r=$.g=$.b=1-v(sb.positionScreen.z,ta,Fa);ea.r=ea.g=ea.b=1-v(rb.positionScreen.z,ta,Fa);Ga=Vb(Y,U,$,ea);u(D,K,P,L,O,C);wb(D,K,P,L,O,C,0,0,1,0,0,1,Ga);u(aa,wa,N,X,ka,Ba);wb(aa,wa,N,X,ka,Ba,1,0,1,1,0,1,Ga)}}}}Ha.addRectangle(Ca)}}o.setTransform(1,0,0,1,0,0)}}};
...
value:null},bumpScale:{type:"f",value:1}},fog:{fogDensity:{type:"f",value:2.5E-4},fogNear:{type:"f",value:1},fogFar:{type:"f",value:2E3},fogColor:{type:"c",value:new THREE.Color(16777215)}},lights:{ambientLightColor:{type:"fv",value:[]},directionalLightDirection:{type:"fv",value:[]},directionalLightColor:{type:"fv",value:[]},hemisphereLightPosition:{type:"fv",value:[]},hemisphereLightSkyColor:{type:"fv",value:[]},hemisphereLightGroundColor:{type:"fv",value:[]},pointLightColor:{type:"fv",value:[]},
pointLightPosition:{type:"fv",value:[]},pointLightDistance:{type:"fv1",value:[]},spotLightColor:{type:"fv",value:[]},spotLightPosition:{type:"fv",value:[]},spotLightDirection:{type:"fv",value:[]},spotLightDistance:{type:"fv1",value:[]},spotLightAngle:{type:"fv1",value:[]},spotLightExponent:{type:"fv1",value:[]}},particle:{psColor:{type:"c",value:new THREE.Color(15658734)},opacity:{type:"f",value:1},size:{type:"f",value:1},scale:{type:"f",value:1},map:{type:"t",value:null},fogDensity:{type:"f",value:2.5E-4},
fogNear:{type:"f",value:1},fogFar:{type:"f",value:2E3},fogColor:{type:"c",value:new THREE.Color(16777215)}},shadowmap:{shadowMap:{type:"tv",value:[]},shadowMapSize:{type:"v2v",value:[]},shadowBias:{type:"fv1",value:[]},shadowDarkness:{type:"fv1",value:[]},shadowMatrix:{type:"m4v",value:[]}}};
...
THREE.ShaderChunk.fog_pars_fragment,THREE.ShaderChunk.shadowmap_pars_fragment,"void main() {\ngl_FragColor = vec4( psColor, opacity );",THREE.ShaderChunk.map_particle_fragment,THREE.ShaderChunk.alphatest_fragment,THREE.ShaderChunk.color_fragment,THREE.ShaderChunk.shadowmap_fragment,THREE.ShaderChunk.fog_fragment,"}"].join("\n")},depthRGBA:{uniforms:{},vertexShader:[THREE.ShaderChunk.morphtarget_pars_vertex,THREE.ShaderChunk.skinning_pars_vertex,"void main() {",THREE.ShaderChunk.skinbase_vertex,THREE.ShaderChunk.morphtarget_vertex,
...
f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){tb.copy(ua);tb.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];Va.copy(f);tb.multiplyVector3(Va);n[d]=[Va.z,d]}n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[n[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[n[d][1]];m[e]=f.r;m[e+1]=f.g;m[e+2]=f.b}if(q){i=0;
...
4)for(d=0;d<f;d++){g=n[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;h.array[e+2]=g.z;h.array[e+3]=g.w;e=e+4}}}}}else{if(o)for(d=0;d<g;d++){f=h[d];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}if(p)for(d=0;d<j;d++){f=i[d];e=d*3;m[e]=f.r;m[e+1]=f.g;m[e+2]=f.b}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.needsUpdate&&(h.boundTo===void 0||h.boundTo==="vertices")){f=h.value.length;e=0;if(h.size===1)for(d=0;d<f;d++)h.array[d]=h.value[d];else if(h.size===2)for(d=0;d<f;d++){g=h.value[d];h.array[e]=g.x;h.array[e+
...
a.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,m,b)}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.needsUpdate||c.sortParticles){k.bindBuffer(k.ARRAY_BUFFER,h.buffer);k.bufferData(k.ARRAY_BUFFER,h.array,b)}}}}function g(a,b){return b.z-a.z}function h(a,b){return b[1]-a[1]}function i(a,b,c){if(a.length)for(var d=0,f=a.length;d<f;d++){U=ka=null;ca=Y=ia=da=Za=pa=ta=-1;Ka=true;a[d].render(b,c,Ia,ib);U=ka=null;ca=Y=ia=da=Za=pa=ta=-1;Ka=true}}function j(a,b,c,d,f,e,g,h){var i,k,j,l;if(b){k=a.length-1;
l=b=-1}else{k=0;b=a.length;l=1}for(var m=k;m!==b;m=m+l){i=a[m];if(i.render){k=i.object;j=i.buffer;if(h)i=h;else{i=i[c];if(!i)continue;g&&C.setBlending(i.blending,i.blendEquation,i.blendSrc,i.blendDst);C.setDepthTest(i.depthTest);C.setDepthWrite(i.depthWrite);A(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits)}C.setMaterialFaces(i);j instanceof THREE.BufferGeometry?C.renderBufferDirect(d,f,e,i,j,k):C.renderBuffer(d,f,e,i,j,k)}}}function l(a,b,c,d,f,e,g){for(var h,i,k=0,j=a.length;k<j;k++){h=
a[k];i=h.object;if(i.visible){if(g)h=g;else{h=h[b];if(!h)continue;e&&C.setBlending(h.blending,h.blendEquation,h.blendSrc,h.blendDst);C.setDepthTest(h.depthTest);C.setDepthWrite(h.depthWrite);A(h.polygonOffset,h.polygonOffsetFactor,h.polygonOffsetUnits)}C.renderImmediateObject(c,d,f,h,i)}}}function n(a,b,c){a.push({buffer:b,object:c,opaque:null,transparent:null})}function m(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return true;return false}function q(a){for(var b in a.attributes)a.attributes[b].needsUpdate=
false}function p(a,b){for(var c=a.length-1;c>=0;c--)a[c].object===b&&a.splice(c,1)}function o(a,b){for(var c=a.length-1;c>=0;c--)a[c]===b&&a.splice(c,1)}function r(a,b,c,d,f){ea=0;if(d.needsUpdate){d.program&&C.deallocateMaterial(d);C.initMaterial(d,b,c,f);d.needsUpdate=false}if(d.morphTargets&&!f.__webglMorphTargetInfluences)f.__webglMorphTargetInfluences=new Float32Array(C.maxMorphTargets);var e=false,g=d.program,h=g.uniforms,i=d.uniforms;if(g!==ka){k.useProgram(g);ka=g;e=true}if(d.id!==ca){ca=
d.id;e=true}if(e||a!==U){k.uniformMatrix4fv(h.projectionMatrix,false,a._projectionMatrixArray);a!==U&&(U=a)}if(d.skinning)if(ec&&f.useVertexTexture){if(h.boneTexture!==null){var j=s();k.uniform1i(h.boneTexture,j);C.setTexture(f.boneTexture,j)}}else h.boneGlobalMatrices!==null&&k.uniformMatrix4fv(h.boneGlobalMatrices,false,f.boneMatrices);if(e){if(c&&d.fog){i.fogColor.value=c.color;if(c instanceof THREE.Fog){i.fogNear.value=c.near;i.fogFar.value=c.far}else if(c instanceof THREE.FogExp2)i.fogDensity.value=
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(Ka){for(var l=0,m=0,n=0,o,p,q,r,t=fb,y=t.directional.colors,x=t.directional.positions,A=t.point.colors,B=t.point.positions,D=t.point.distances,G=t.spot.colors,I=t.spot.positions,K=t.spot.distances,O=t.spot.directions,M=t.spot.angles,L=t.spot.exponents,N=t.hemi.skyColors,P=t.hemi.groundColors,Y=t.hemi.positions,$=0,X=0,aa=0,ia=0,c=o=q=q=p=0,e=b.length;c<e;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=
j.color;r=j.intensity;p=j.distance;if(j instanceof THREE.AmbientLight)if(C.gammaInput){l=l+o.r*o.r;m=m+o.g*o.g;n=n+o.b*o.b}else{l=l+o.r;m=m+o.g;n=n+o.b}else if(j instanceof THREE.DirectionalLight){p=$*3;C.gammaInput?v(y,p,o,r*r):u(y,p,o,r);Xa.copy(j.matrixWorld.getPosition());Xa.subSelf(j.target.matrixWorld.getPosition());Xa.normalize();x[p]=Xa.x;x[p+1]=Xa.y;x[p+2]=Xa.z;$=$+1}else if(j instanceof THREE.PointLight){q=X*3;C.gammaInput?v(A,q,o,r*r):u(A,q,o,r);r=j.matrixWorld.getPosition();B[q]=r.x;B[q+
1]=r.y;B[q+2]=r.z;D[X]=p;X=X+1}else if(j instanceof THREE.SpotLight){q=aa*3;C.gammaInput?v(G,q,o,r*r):u(G,q,o,r);r=j.matrixWorld.getPosition();I[q]=r.x;I[q+1]=r.y;I[q+2]=r.z;K[aa]=p;Xa.copy(r);Xa.subSelf(j.target.matrixWorld.getPosition());Xa.normalize();O[q]=Xa.x;O[q+1]=Xa.y;O[q+2]=Xa.z;M[aa]=Math.cos(j.angle);L[aa]=j.exponent;aa=aa+1}else if(j instanceof THREE.HemisphereLight){p=j.color;q=j.groundColor;o=ia*3;if(C.gammaInput){r=r*r;v(N,o,p,r);v(P,o,q,r)}else{u(N,o,p,r);u(P,o,q,r)}r=j.matrixWorld.getPosition();
Y[o]=r.x;Y[o+1]=r.y;Y[o+2]=r.z;ia=ia+1}}}c=$*3;for(e=y.length;c<e;c++)y[c]=0;c=X*3;for(e=A.length;c<e;c++)A[c]=0;c=aa*3;for(e=G.length;c<e;c++)G[c]=0;c=ia*3;for(e=N.length;c<e;c++)N[c]=0;c=ia*3;for(e=P.length;c<e;c++)P[c]=0;t.directional.length=$;t.point.length=X;t.spot.length=aa;t.hemi.length=ia;t.ambient[0]=l;t.ambient[1]=m;t.ambient[2]=n;Ka=false}c=fb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;
...
c.hemi.positions}if(d instanceof THREE.MeshBasicMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.MeshPhongMaterial){i.opacity.value=d.opacity;C.gammaInput?i.diffuse.value.copyGammaToLinear(d.color):i.diffuse.value=d.color;i.map.value=d.map;i.lightMap.value=d.lightMap;i.specularMap.value=d.specularMap;if(d.bumpMap){i.bumpMap.value=d.bumpMap;i.bumpScale.value=d.bumpScale}var da;if(d.map)da=d.map;else if(d.specularMap)da=d.specularMap;else if(d.bumpMap)da=d.bumpMap;if(da!==void 0){c=
da.offset;da=da.repeat;i.offsetRepeat.value.set(c.x,c.y,da.x,da.y)}i.envMap.value=d.envMap;i.flipEnvMap.value=d.envMap instanceof THREE.WebGLRenderTargetCube?1:-1;i.reflectivity.value=d.reflectivity;i.refractionRatio.value=d.refractionRatio;i.combine.value=d.combine;i.useRefract.value=d.envMap&&d.envMap.mapping instanceof THREE.CubeRefractionMapping}if(d instanceof THREE.LineBasicMaterial){i.diffuse.value=d.color;i.opacity.value=d.opacity}else if(d instanceof THREE.ParticleBasicMaterial){i.psColor.value=
d.color;i.opacity.value=d.opacity;i.size.value=d.size;i.scale.value=H.height/2;i.map.value=d.map}else if(d instanceof THREE.MeshPhongMaterial){i.shininess.value=d.shininess;if(C.gammaInput){i.ambient.value.copyGammaToLinear(d.ambient);i.emissive.value.copyGammaToLinear(d.emissive);i.specular.value.copyGammaToLinear(d.specular)}else{i.ambient.value=d.ambient;i.emissive.value=d.emissive;i.specular.value=d.specular}d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)}else if(d instanceof THREE.MeshLambertMaterial){if(C.gammaInput){i.ambient.value.copyGammaToLinear(d.ambient);
i.emissive.value.copyGammaToLinear(d.emissive)}else{i.ambient.value=d.ambient;i.emissive.value=d.emissive}d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)}else if(d instanceof THREE.MeshDepthMaterial){i.mNear.value=a.near;i.mFar.value=a.far;i.opacity.value=d.opacity}else if(d instanceof THREE.MeshNormalMaterial)i.opacity.value=d.opacity;if(f.receiveShadow&&!d._shadowPass&&i.shadowMatrix){c=da=0;for(e=b.length;c<e;c++){j=b[c];if(j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&
!j.shadowCascade)){i.shadowMap.value[da]=j.shadowMap;i.shadowMapSize.value[da]=j.shadowMapSize;i.shadowMatrix.value[da]=j.shadowMatrix;i.shadowDarkness.value[da]=j.shadowDarkness;i.shadowBias.value[da]=j.shadowBias;da++}}}b=d.uniformsList;i=0;for(da=b.length;i<da;i++)if(e=g.uniforms[b[i][1]]){c=b[i][0];l=c.type;j=c.value;if(l==="i")k.uniform1i(e,j);else if(l==="f")k.uniform1f(e,j);else if(l==="v2")k.uniform2f(e,j.x,j.y);else if(l==="v3")k.uniform3f(e,j.x,j.y,j.z);else if(l==="v4")k.uniform4f(e,j.x,
...
for(m=j.length;l<m;l++)j[l].flattenToArrayOffset(c._array,l*16);k.uniformMatrix4fv(e,false,c._array)}else if(l==="t"){n=j;j=s();k.uniform1i(e,j);if(n)if(n.image instanceof Array&&n.image.length===6){c=n;e=j;if(c.image.length===6)if(c.needsUpdate){if(!c.image.__webglTextureCube)c.image.__webglTextureCube=k.createTexture();k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);e=[];for(j=0;j<6;j++)if(C.autoScaleCubemaps){l=
e;m=j;n=c.image[j];y=Tc;if(!(n.width<=y&&n.height<=y)){x=Math.max(n.width,n.height);t=Math.floor(n.width*y/x);y=Math.floor(n.height*y/x);x=document.createElement("canvas");x.width=t;x.height=y;x.getContext("2d").drawImage(n,0,0,n.width,n.height,0,0,t,y);n=x}l[m]=n}else e[j]=c.image[j];j=e[0];l=(j.width&j.width-1)===0&&(j.height&j.height-1)===0;m=F(c.format);n=F(c.type);J(k.TEXTURE_CUBE_MAP,c,l);for(j=0;j<6;j++)k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,m,m,n,e[j]);c.generateMipmaps&&l&&k.generateMipmap(k.TEXTURE_CUBE_MAP);
c.needsUpdate=false;if(c.onUpdate)c.onUpdate()}else{k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}}else if(n instanceof THREE.WebGLRenderTargetCube){c=n;k.activeTexture(k.TEXTURE0+j);k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)}else C.setTexture(n,j)}else if(l==="tv"){if(c._array===void 0)c._array=[];l=0;for(m=c.value.length;l<m;l++)c._array[l]=s();k.uniform1iv(e,c._array);l=0;for(m=c.value.length;l<m;l++){n=c.value[l];j=c._array[l];n&&C.setTexture(n,
...
false,f._normalMatrix.elements);h.modelMatrix!==null&&k.uniformMatrix4fv(h.modelMatrix,false,f.matrixWorld.elements);return g}function s(){var a=ea;a>=sc&&console.warn("Trying to use "+a+" texture units while this GPU supports only "+sc);ea=ea+1;return a}function t(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function v(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function u(a,b,c,d){a[b]=
c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function A(a,b,c){if(Ua!==a){a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL);Ua=a}if(a&&(qb!==b||hb!==c)){k.polygonOffset(b,c);qb=b;hb=c}}function x(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function B(a,b){var c;a==="fragment"?c=k.createShader(k.FRAGMENT_SHADER):a==="vertex"&&(c=k.createShader(k.VERTEX_SHADER));k.shaderSource(c,b);k.compileShader(c);if(!k.getShaderParameter(c,k.COMPILE_STATUS)){console.error(k.getShaderInfoLog(c));
console.error(x(b));return null}return c}function J(a,b,c){if(c){k.texParameteri(a,k.TEXTURE_WRAP_S,F(b.wrapS));k.texParameteri(a,k.TEXTURE_WRAP_T,F(b.wrapT));k.texParameteri(a,k.TEXTURE_MAG_FILTER,F(b.magFilter));k.texParameteri(a,k.TEXTURE_MIN_FILTER,F(b.minFilter))}else{k.texParameteri(a,k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE);k.texParameteri(a,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE);k.texParameteri(a,k.TEXTURE_MAG_FILTER,I(b.magFilter));k.texParameteri(a,k.TEXTURE_MIN_FILTER,I(b.minFilter))}if(Ub&&b.type!==
THREE.FloatType&&(b.anisotropy>1||b.__oldAnisotropy)){k.texParameterf(a,Ub.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,Ec));b.__oldAnisotropy=b.anisotropy}}function y(a,b){k.bindRenderbuffer(k.RENDERBUFFER,a);if(b.depthBuffer&&!b.stencilBuffer){k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_COMPONENT16,b.width,b.height);k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_ATTACHMENT,k.RENDERBUFFER,a)}else if(b.depthBuffer&&b.stencilBuffer){k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_STENCIL,b.width,
b.height);k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_STENCIL_ATTACHMENT,k.RENDERBUFFER,a)}else k.renderbufferStorage(k.RENDERBUFFER,k.RGBA4,b.width,b.height)}function I(a){return a===THREE.NearestFilter||a===THREE.NearestMipMapNearestFilter||a===THREE.NearestMipMapLinearFilter?k.NEAREST:k.LINEAR}function F(a){return a===THREE.RepeatWrapping?k.REPEAT:a===THREE.ClampToEdgeWrapping?k.CLAMP_TO_EDGE:a===THREE.MirroredRepeatWrapping?k.MIRRORED_REPEAT:a===THREE.NearestFilter?k.NEAREST:a===THREE.NearestMipMapNearestFilter?
k.NEAREST_MIPMAP_NEAREST:a===THREE.NearestMipMapLinearFilter?k.NEAREST_MIPMAP_LINEAR:a===THREE.LinearFilter?k.LINEAR:a===THREE.LinearMipMapNearestFilter?k.LINEAR_MIPMAP_NEAREST:a===THREE.LinearMipMapLinearFilter?k.LINEAR_MIPMAP_LINEAR:a===THREE.UnsignedByteType?k.UNSIGNED_BYTE:a===THREE.UnsignedShort4444Type?k.UNSIGNED_SHORT_4_4_4_4:a===THREE.UnsignedShort5551Type?k.UNSIGNED_SHORT_5_5_5_1:a===THREE.UnsignedShort565Type?k.UNSIGNED_SHORT_5_6_5:a===THREE.ByteType?k.BYTE:a===THREE.ShortType?k.SHORT:a===
THREE.UnsignedShortType?k.UNSIGNED_SHORT:a===THREE.IntType?k.INT:a===THREE.UnsignedIntType?k.UNSIGNED_INT:a===THREE.FloatType?k.FLOAT:a===THREE.AlphaFormat?k.ALPHA:a===THREE.RGBFormat?k.RGB:a===THREE.RGBAFormat?k.RGBA:a===THREE.LuminanceFormat?k.LUMINANCE:a===THREE.LuminanceAlphaFormat?k.LUMINANCE_ALPHA:a===THREE.AddEquation?k.FUNC_ADD:a===THREE.SubtractEquation?k.FUNC_SUBTRACT:a===THREE.ReverseSubtractEquation?k.FUNC_REVERSE_SUBTRACT:a===THREE.ZeroFactor?k.ZERO:a===THREE.OneFactor?k.ONE:a===THREE.SrcColorFactor?
k.SRC_COLOR:a===THREE.OneMinusSrcColorFactor?k.ONE_MINUS_SRC_COLOR:a===THREE.SrcAlphaFactor?k.SRC_ALPHA:a===THREE.OneMinusSrcAlphaFactor?k.ONE_MINUS_SRC_ALPHA:a===THREE.DstAlphaFactor?k.DST_ALPHA:a===THREE.OneMinusDstAlphaFactor?k.ONE_MINUS_DST_ALPHA:a===THREE.DstColorFactor?k.DST_COLOR:a===THREE.OneMinusDstColorFactor?k.ONE_MINUS_DST_COLOR:a===THREE.SrcAlphaSaturateFactor?k.SRC_ALPHA_SATURATE:0}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},H=a.canvas!==void 0?a.canvas:document.createElement("canvas"),
G=a.precision!==void 0?a.precision:"highp",M=a.alpha!==void 0?a.alpha:true,D=a.premultipliedAlpha!==void 0?a.premultipliedAlpha:true,K=a.antialias!==void 0?a.antialias:false,P=a.stencil!==void 0?a.stencil:true,L=a.preserveDrawingBuffer!==void 0?a.preserveDrawingBuffer:false,N=a.clearColor!==void 0?new THREE.Color(a.clearColor):new THREE.Color(0),X=a.clearAlpha!==void 0?a.clearAlpha:0,O=a.maxLights!==void 0?a.maxLights:4;this.domElement=H;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=
...
vertices:0,faces:0,points:0}};var C=this,aa=[],wa=0,ka=null,Ba=null,ca=-1,Y=null,U=null,$=0,ea=0,da=-1,ia=-1,ta=-1,Fa=-1,Ga=-1,Qa=-1,pa=-1,Za=-1,Ua=null,qb=null,hb=null,db=null,cb=0,Ha=0,Ca=0,eb=0,Ia=0,ib=0,jb=new THREE.Frustum,ua=new THREE.Matrix4,tb=new THREE.Matrix4,Va=new THREE.Vector4,Xa=new THREE.Vector3,Ka=true,fb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],
angles:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Ub;try{if(!(k=H.getContext("experimental-webgl",{alpha:M,premultipliedAlpha:D,antialias:K,stencil:P,preserveDrawingBuffer:L})))throw"Error creating WebGL context.";}catch(Sc){console.error(Sc)}a=k.getExtension("OES_texture_float");M=k.getExtension("OES_standard_derivatives");Ub=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
a||console.log("THREE.WebGLRenderer: Float textures not supported.");M||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");Ub||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(N.r,N.g,
N.b,X);this.context=k;var sc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),M=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Tc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),Ec=Ub?k.getParameter(Ub.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,fc=M>0,ec=fc&&a;this.getContext=function(){return k};this.supportsVertexTextures=function(){return fc};this.getMaxAnisotropy=function(){return Ec};this.setSize=function(a,b){H.width=a;H.height=b;this.setViewport(0,0,H.width,H.height)};
this.setViewport=function(a,b,c,d){cb=a!==void 0?a:0;Ha=b!==void 0?b:0;Ca=c!==void 0?c:H.width;eb=d!==void 0?d:H.height;k.viewport(cb,Ha,Ca,eb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){N.setHex(a);X=b;k.clearColor(N.r,N.g,N.b,X)};this.setClearColor=function(a,b){N.copy(a);X=b;k.clearColor(N.r,N.g,N.b,X)};this.getClearColor=function(){return N};this.getClearAlpha=
function(){return X};this.clear=function(a,b,c){var d=0;if(a===void 0||a)d=d|k.COLOR_BUFFER_BIT;if(b===void 0||b)d=d|k.DEPTH_BUFFER_BIT;if(c===void 0||c)d=d|k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};this.addPrePlugin=function(a){a.init(this);this.renderPluginsPre.push(a)};this.deallocateObject=function(a){if(a.__webglInit){a.__webglInit=false;delete a._modelViewMatrix;
delete a._normalMatrix;delete a._normalMatrixArray;delete a._modelViewMatrixArray;delete a._modelMatrixArray;if(a instanceof THREE.Mesh)for(var b in a.geometry.geometryGroups){var c=a.geometry.geometryGroups[b];k.deleteBuffer(c.__webglVertexBuffer);k.deleteBuffer(c.__webglNormalBuffer);k.deleteBuffer(c.__webglTangentBuffer);k.deleteBuffer(c.__webglColorBuffer);k.deleteBuffer(c.__webglUVBuffer);k.deleteBuffer(c.__webglUV2Buffer);k.deleteBuffer(c.__webglSkinIndicesBuffer);k.deleteBuffer(c.__webglSkinWeightsBuffer);
k.deleteBuffer(c.__webglFaceBuffer);k.deleteBuffer(c.__webglLineBuffer);var d=void 0,e=void 0;if(c.numMorphTargets){d=0;for(e=c.numMorphTargets;d<e;d++)k.deleteBuffer(c.__webglMorphTargetsBuffers[d])}if(c.numMorphNormals){d=0;for(e=c.numMorphNormals;d<e;d++)k.deleteBuffer(c.__webglMorphNormalsBuffers[d])}if(c.__webglCustomAttributesList){d=void 0;for(d in c.__webglCustomAttributesList)k.deleteBuffer(c.__webglCustomAttributesList[d].buffer)}C.info.memory.geometries--}else if(a instanceof THREE.Ribbon){a=
a.geometry;k.deleteBuffer(a.__webglVertexBuffer);k.deleteBuffer(a.__webglColorBuffer);C.info.memory.geometries--}else if(a instanceof THREE.Line){a=a.geometry;k.deleteBuffer(a.__webglVertexBuffer);k.deleteBuffer(a.__webglColorBuffer);C.info.memory.geometries--}else if(a instanceof THREE.ParticleSystem){a=a.geometry;k.deleteBuffer(a.__webglVertexBuffer);k.deleteBuffer(a.__webglColorBuffer);C.info.memory.geometries--}}};this.deallocateTexture=function(a){if(a.__webglInit){a.__webglInit=false;k.deleteTexture(a.__webglTexture);
C.info.memory.textures--}};this.deallocateRenderTarget=function(a){if(a&&a.__webglTexture){k.deleteTexture(a.__webglTexture);if(a instanceof THREE.WebGLRenderTargetCube)for(var b=0;b<6;b++){k.deleteFramebuffer(a.__webglFramebuffer[b]);k.deleteRenderbuffer(a.__webglRenderbuffer[b])}else{k.deleteFramebuffer(a.__webglFramebuffer);k.deleteRenderbuffer(a.__webglRenderbuffer)}}};this.deallocateMaterial=function(a){var b=a.program;if(b){a.program=void 0;var c,d,e=false,a=0;for(c=aa.length;a<c;a++){d=aa[a];
if(d.program===b){d.usedTimes--;d.usedTimes===0&&(e=true);break}}if(e){e=[];a=0;for(c=aa.length;a<c;a++){d=aa[a];d.program!==b&&e.push(d)}aa=e;k.deleteProgram(b);C.info.memory.programs--}}};this.updateShadowMap=function(a,b){ka=null;ca=Y=Za=pa=ta=-1;Ka=true;ia=da=-1;this.shadowMapPlugin.update(a,b)};this.renderBufferImmediate=function(a,b,c){if(a.hasPositions&&!a.__webglVertexBuffer)a.__webglVertexBuffer=k.createBuffer();if(a.hasNormals&&!a.__webglNormalBuffer)a.__webglNormalBuffer=k.createBuffer();
if(a.hasUvs&&!a.__webglUvBuffer)a.__webglUvBuffer=k.createBuffer();if(a.hasColors&&!a.__webglColorBuffer)a.__webglColorBuffer=k.createBuffer();if(a.hasPositions){k.bindBuffer(k.ARRAY_BUFFER,a.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,a.positionArray,k.DYNAMIC_DRAW);k.enableVertexAttribArray(b.attributes.position);k.vertexAttribPointer(b.attributes.position,3,k.FLOAT,false,0,0)}if(a.hasNormals){k.bindBuffer(k.ARRAY_BUFFER,a.__webglNormalBuffer);if(c.shading===THREE.FlatShading){var d,e,f,g,
h,i,j,l,n,m,o,p=a.count*3;for(o=0;o<p;o=o+9){m=a.normalArray;d=m[o];e=m[o+1];f=m[o+2];g=m[o+3];i=m[o+4];l=m[o+5];h=m[o+6];j=m[o+7];n=m[o+8];d=(d+g+h)/3;e=(e+i+j)/3;f=(f+l+n)/3;m[o]=d;m[o+1]=e;m[o+2]=f;m[o+3]=d;m[o+4]=e;m[o+5]=f;m[o+6]=d;m[o+7]=e;m[o+8]=f}}k.bufferData(k.ARRAY_BUFFER,a.normalArray,k.DYNAMIC_DRAW);k.enableVertexAttribArray(b.attributes.normal);k.vertexAttribPointer(b.attributes.normal,3,k.FLOAT,false,0,0)}if(a.hasUvs&&c.map){k.bindBuffer(k.ARRAY_BUFFER,a.__webglUvBuffer);k.bufferData(k.ARRAY_BUFFER,
...
e.attributes.index.buffer)}k.drawElements(k.TRIANGLES,f[d].count,k.UNSIGNED_SHORT,f[d].start*2);C.info.render.calls++;C.info.render.vertices=C.info.render.vertices+f[d].count;C.info.render.faces=C.info.render.faces+f[d].count/3}}}};this.renderBuffer=function(a,b,c,d,e,f){if(d.visible!==false){var g,i,c=r(a,b,c,d,f),b=c.attributes,a=false,c=e.id*16777215+c.id*2+(d.wireframe?1:0);if(c!==Y){Y=c;a=true}if(!d.morphTargets&&b.position>=0){if(a){k.bindBuffer(k.ARRAY_BUFFER,e.__webglVertexBuffer);k.vertexAttribPointer(b.position,
...
if(b.uv2>=0)if(e.__webglUV2Buffer){k.bindBuffer(k.ARRAY_BUFFER,e.__webglUV2Buffer);k.vertexAttribPointer(b.uv2,2,k.FLOAT,false,0,0);k.enableVertexAttribArray(b.uv2)}else k.disableVertexAttribArray(b.uv2);if(d.skinning&&b.skinIndex>=0&&b.skinWeight>=0){k.bindBuffer(k.ARRAY_BUFFER,e.__webglSkinIndicesBuffer);k.vertexAttribPointer(b.skinIndex,4,k.FLOAT,false,0,0);k.bindBuffer(k.ARRAY_BUFFER,e.__webglSkinWeightsBuffer);k.vertexAttribPointer(b.skinWeight,4,k.FLOAT,false,0,0)}}if(f instanceof THREE.Mesh){if(d.wireframe){d=
d.wireframeLinewidth;if(d!==db){k.lineWidth(d);db=d}a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglLineBuffer);k.drawElements(k.LINES,e.__webglLineCount,k.UNSIGNED_SHORT,0)}else{a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglFaceBuffer);k.drawElements(k.TRIANGLES,e.__webglFaceCount,k.UNSIGNED_SHORT,0)}C.info.render.calls++;C.info.render.vertices=C.info.render.vertices+e.__webglFaceCount;C.info.render.faces=C.info.render.faces+e.__webglFaceCount/3}else if(f instanceof THREE.Line){f=f.type===THREE.LineStrip?
k.LINE_STRIP:k.LINES;d=d.linewidth;if(d!==db){k.lineWidth(d);db=d}k.drawArrays(f,0,e.__webglLineCount);C.info.render.calls++}else if(f instanceof THREE.ParticleSystem){k.drawArrays(k.POINTS,0,e.__webglParticleCount);C.info.render.calls++;C.info.render.points=C.info.render.points+e.__webglParticleCount}else if(f instanceof THREE.Ribbon){k.drawArrays(k.TRIANGLE_STRIP,0,e.__webglVertexCount);C.info.render.calls++}}};this.render=function(a,b,c,d){if(b instanceof THREE.Camera===false)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
else{var e,f,h,m,n=a.__lights,o=a.fog;ca=-1;Ka=true;this.autoUpdateScene&&a.updateMatrixWorld();b.parent===void 0&&b.updateMatrixWorld();if(!b._viewMatrixArray)b._viewMatrixArray=new Float32Array(16);if(!b._projectionMatrixArray)b._projectionMatrixArray=new Float32Array(16);b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);ua.multiply(b.projectionMatrix,b.matrixWorldInverse);jb.setFromMatrix(ua);
this.autoUpdateObjects&&this.initWebGLObjects(a);i(this.renderPluginsPre,a,b);C.info.render.calls=0;C.info.render.vertices=0;C.info.render.faces=0;C.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);m=a.__webglObjects;d=0;for(e=m.length;d<e;d++){f=m[d];h=f.object;f.render=false;if(h.visible&&(!(h instanceof THREE.Mesh||h instanceof THREE.ParticleSystem)||!h.frustumCulled||jb.contains(h))){t(h,b);var p=f,q=p.object,
r=p.buffer,u=void 0,u=u=void 0,u=q.material;if(u instanceof THREE.MeshFaceMaterial){u=r.materialIndex;if(u>=0){u=q.geometry.materials[u];if(u.transparent){p.transparent=u;p.opaque=null}else{p.opaque=u;p.transparent=null}}}else if(u)if(u.transparent){p.transparent=u;p.opaque=null}else{p.opaque=u;p.transparent=null}f.render=true;if(this.sortObjects)if(h.renderDepth)f.z=h.renderDepth;else{Va.copy(h.matrixWorld.getPosition());ua.multiplyVector3(Va);f.z=Va.z}}}this.sortObjects&&m.sort(g);m=a.__webglObjectsImmediate;
d=0;for(e=m.length;d<e;d++){f=m[d];h=f.object;if(h.visible){t(h,b);h=f.object.material;if(h.transparent){f.transparent=h;f.opaque=null}else{f.opaque=h;f.transparent=null}}}if(a.overrideMaterial){d=a.overrideMaterial;this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst);this.setDepthTest(d.depthTest);this.setDepthWrite(d.depthWrite);A(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits);j(a.__webglObjects,false,"",b,n,o,true,d);l(a.__webglObjectsImmediate,"",b,n,o,false,d)}else{this.setBlending(THREE.NormalBlending);
j(a.__webglObjects,true,"opaque",b,n,o,false);l(a.__webglObjectsImmediate,"opaque",b,n,o,false);j(a.__webglObjects,false,"transparent",b,n,o,true);l(a.__webglObjectsImmediate,"transparent",b,n,o,true)}i(this.renderPluginsPost,a,b);if(c&&c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&c.minFilter!==THREE.LinearFilter)if(c instanceof THREE.WebGLRenderTargetCube){k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture);k.generateMipmap(k.TEXTURE_CUBE_MAP);k.bindTexture(k.TEXTURE_CUBE_MAP,null)}else{k.bindTexture(k.TEXTURE_2D,
c.__webglTexture);k.generateMipmap(k.TEXTURE_2D);k.bindTexture(k.TEXTURE_2D,null)}this.setDepthTest(true);this.setDepthWrite(true)}};this.renderImmediateObject=function(a,b,c,d,e){var f=r(a,b,c,d,e);Y=-1;C.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,jb):e.render(function(a){C.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){if(!a.__webglObjects){a.__webglObjects=[];a.__webglObjectsImmediate=[];a.__webglSprites=[];a.__webglFlares=[]}for(;a.__objectsAdded.length;){var g=
a.__objectsAdded[0],h=a,i=void 0,j=void 0,l=void 0;if(!g.__webglInit){g.__webglInit=true;g._modelViewMatrix=new THREE.Matrix4;g._normalMatrix=new THREE.Matrix3;if(g instanceof THREE.Mesh){j=g.geometry;if(j instanceof THREE.Geometry){if(j.geometryGroups===void 0){var r=j,u=void 0,s=void 0,t=void 0,v=void 0,y=void 0,x=void 0,A=void 0,B={},D=r.morphTargets.length,J=r.morphNormals.length;r.geometryGroups={};u=0;for(s=r.faces.length;u<s;u++){t=r.faces[u];v=t.materialIndex;x=v!==void 0?v:-1;B[x]===void 0&&
(B[x]={hash:x,counter:0});A=B[x].hash+"_"+B[x].counter;r.geometryGroups[A]===void 0&&(r.geometryGroups[A]={faces3:[],faces4:[],materialIndex:v,vertices:0,numMorphTargets:D,numMorphNormals:J});y=t instanceof THREE.Face3?3:4;if(r.geometryGroups[A].vertices+y>65535){B[x].counter=B[x].counter+1;A=B[x].hash+"_"+B[x].counter;r.geometryGroups[A]===void 0&&(r.geometryGroups[A]={faces3:[],faces4:[],materialIndex:v,vertices:0,numMorphTargets:D,numMorphNormals:J})}t instanceof THREE.Face3?r.geometryGroups[A].faces3.push(u):
r.geometryGroups[A].faces4.push(u);r.geometryGroups[A].vertices=r.geometryGroups[A].vertices+y}r.geometryGroupsList=[];var F=void 0;for(F in r.geometryGroups){r.geometryGroups[F].id=$++;r.geometryGroupsList.push(r.geometryGroups[F])}}for(i in j.geometryGroups){l=j.geometryGroups[i];if(!l.__webglVertexBuffer){var G=l;G.__webglVertexBuffer=k.createBuffer();G.__webglNormalBuffer=k.createBuffer();G.__webglTangentBuffer=k.createBuffer();G.__webglColorBuffer=k.createBuffer();G.__webglUVBuffer=k.createBuffer();
G.__webglUV2Buffer=k.createBuffer();G.__webglSkinIndicesBuffer=k.createBuffer();G.__webglSkinWeightsBuffer=k.createBuffer();G.__webglFaceBuffer=k.createBuffer();G.__webglLineBuffer=k.createBuffer();var I=void 0,U=void 0;if(G.numMorphTargets){G.__webglMorphTargetsBuffers=[];I=0;for(U=G.numMorphTargets;I<U;I++)G.__webglMorphTargetsBuffers.push(k.createBuffer())}if(G.numMorphNormals){G.__webglMorphNormalsBuffers=[];I=0;for(U=G.numMorphNormals;I<U;I++)G.__webglMorphNormalsBuffers.push(k.createBuffer())}C.info.memory.geometries++;
var H=l,K=g,O=K.geometry,M=H.faces3,ca=H.faces4,L=M.length*3+ca.length*4,N=M.length*1+ca.length*2,P=M.length*3+ca.length*4,Y=c(K,H),aa=f(Y),X=d(Y),da=Y.vertexColors?Y.vertexColors:false;H.__vertexArray=new Float32Array(L*3);if(X)H.__normalArray=new Float32Array(L*3);if(O.hasTangents)H.__tangentArray=new Float32Array(L*4);if(da)H.__colorArray=new Float32Array(L*3);if(aa){if(O.faceUvs.length>0||O.faceVertexUvs.length>0)H.__uvArray=new Float32Array(L*2);if(O.faceUvs.length>1||O.faceVertexUvs.length>
1)H.__uv2Array=new Float32Array(L*2)}if(K.geometry.skinWeights.length&&K.geometry.skinIndices.length){H.__skinIndexArray=new Float32Array(L*4);H.__skinWeightArray=new Float32Array(L*4)}H.__faceArray=new Uint16Array(N*3);H.__lineArray=new Uint16Array(P*2);var ea=void 0,ia=void 0;if(H.numMorphTargets){H.__morphTargetsArrays=[];ea=0;for(ia=H.numMorphTargets;ea<ia;ea++)H.__morphTargetsArrays.push(new Float32Array(L*3))}if(H.numMorphNormals){H.__morphNormalsArrays=[];ea=0;for(ia=H.numMorphNormals;ea<ia;ea++)H.__morphNormalsArrays.push(new Float32Array(L*
3))}H.__webglFaceCount=N*3;H.__webglLineCount=P*2;if(Y.attributes){if(H.__webglCustomAttributesList===void 0)H.__webglCustomAttributesList=[];var ta=void 0;for(ta in Y.attributes){var wa=Y.attributes[ta],ka={},Fa;for(Fa in wa)ka[Fa]=wa[Fa];if(!ka.__webglInitialized||ka.createUniqueBuffers){ka.__webglInitialized=true;var pa=1;ka.type==="v2"?pa=2:ka.type==="v3"?pa=3:ka.type==="v4"?pa=4:ka.type==="c"&&(pa=3);ka.size=pa;ka.array=new Float32Array(L*pa);ka.buffer=k.createBuffer();ka.buffer.belongsToAttribute=
ta;wa.needsUpdate=true;ka.__original=wa}H.__webglCustomAttributesList.push(ka)}}H.__inittedArrays=true;j.verticesNeedUpdate=true;j.morphTargetsNeedUpdate=true;j.elementsNeedUpdate=true;j.uvsNeedUpdate=true;j.normalsNeedUpdate=true;j.tangentsNeedUpdate=true;j.colorsNeedUpdate=true}}}else if(j instanceof THREE.BufferGeometry){var Ba=j,ua=void 0,Ga=void 0,Ca=void 0;for(ua in Ba.attributes){Ca=ua==="index"?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;Ga=Ba.attributes[ua];Ga.buffer=k.createBuffer();k.bindBuffer(Ca,
Ga.buffer);k.bufferData(Ca,Ga.array,k.STATIC_DRAW)}}}else if(g instanceof THREE.Ribbon){j=g.geometry;if(!j.__webglVertexBuffer){var Ia=j;Ia.__webglVertexBuffer=k.createBuffer();Ia.__webglColorBuffer=k.createBuffer();C.info.memory.geometries++;var Ha=j,Ka=Ha.vertices.length;Ha.__vertexArray=new Float32Array(Ka*3);Ha.__colorArray=new Float32Array(Ka*3);Ha.__webglVertexCount=Ka;j.verticesNeedUpdate=true;j.colorsNeedUpdate=true}}else if(g instanceof THREE.Line){j=g.geometry;if(!j.__webglVertexBuffer){var Ua=
j;Ua.__webglVertexBuffer=k.createBuffer();Ua.__webglColorBuffer=k.createBuffer();C.info.memory.geometries++;var Qa=j,Xa=g,Za=Qa.vertices.length;Qa.__vertexArray=new Float32Array(Za*3);Qa.__colorArray=new Float32Array(Za*3);Qa.__webglLineCount=Za;b(Qa,Xa);j.verticesNeedUpdate=true;j.colorsNeedUpdate=true}}else if(g instanceof THREE.ParticleSystem){j=g.geometry;if(!j.__webglVertexBuffer){var cb=j;cb.__webglVertexBuffer=k.createBuffer();cb.__webglColorBuffer=k.createBuffer();C.info.geometries++;var Va=
j,jb=g,qb=Va.vertices.length;Va.__vertexArray=new Float32Array(qb*3);Va.__colorArray=new Float32Array(qb*3);Va.__sortArray=[];Va.__webglParticleCount=qb;b(Va,jb);j.verticesNeedUpdate=true;j.colorsNeedUpdate=true}}}if(!g.__webglActive){if(g instanceof THREE.Mesh){j=g.geometry;if(j instanceof THREE.BufferGeometry)n(h.__webglObjects,j,g);else for(i in j.geometryGroups){l=j.geometryGroups[i];n(h.__webglObjects,l,g)}}else if(g instanceof THREE.Ribbon||g instanceof THREE.Line||g instanceof THREE.ParticleSystem){j=
g.geometry;n(h.__webglObjects,j,g)}else g instanceof THREE.ImmediateRenderObject||g.immediateRenderCallback?h.__webglObjectsImmediate.push({object:g,opaque:null,transparent:null}):g instanceof THREE.Sprite?h.__webglSprites.push(g):g instanceof THREE.LensFlare&&h.__webglFlares.push(g);g.__webglActive=true}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var mb=a.__objectsRemoved[0],db=a;mb instanceof THREE.Mesh||mb instanceof THREE.ParticleSystem||mb instanceof THREE.Ribbon||mb instanceof
THREE.Line?p(db.__webglObjects,mb):mb instanceof THREE.Sprite?o(db.__webglSprites,mb):mb instanceof THREE.LensFlare?o(db.__webglFlares,mb):(mb instanceof THREE.ImmediateRenderObject||mb.immediateRenderCallback)&&p(db.__webglObjectsImmediate,mb);mb.__webglActive=false;a.__objectsRemoved.splice(0,1)}for(var ib=0,tb=a.__webglObjects.length;ib<tb;ib++){var ub=a.__webglObjects[ib].object,fa=ub.geometry,hb=void 0,eb=void 0,$a=void 0;if(ub instanceof THREE.Mesh)if(fa instanceof THREE.BufferGeometry){if(fa.verticesNeedUpdate||
fa.elementsNeedUpdate||fa.uvsNeedUpdate||fa.normalsNeedUpdate||fa.colorsNeedUpdate||fa.tangentsNeedUpdate){var Ob=fa,fb=k.DYNAMIC_DRAW,Ub=!fa.dynamic,lc=Ob.attributes,ec=lc.index,fc=lc.position,Vc=lc.normal,Wc=lc.uv,Xc=lc.color,Yc=lc.tangent;if(Ob.elementsNeedUpdate&&ec!==void 0){k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ec.buffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,ec.array,fb)}if(Ob.verticesNeedUpdate&&fc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,fc.buffer);k.bufferData(k.ARRAY_BUFFER,fc.array,fb)}if(Ob.normalsNeedUpdate&&
Vc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Vc.buffer);k.bufferData(k.ARRAY_BUFFER,Vc.array,fb)}if(Ob.uvsNeedUpdate&&Wc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Wc.buffer);k.bufferData(k.ARRAY_BUFFER,Wc.array,fb)}if(Ob.colorsNeedUpdate&&Xc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Xc.buffer);k.bufferData(k.ARRAY_BUFFER,Xc.array,fb)}if(Ob.tangentsNeedUpdate&&Yc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Yc.buffer);k.bufferData(k.ARRAY_BUFFER,Yc.array,fb)}if(Ub){var sc=void 0;for(sc in Ob.attributes)delete Ob.attributes[sc].array}}fa.verticesNeedUpdate=
false;fa.elementsNeedUpdate=false;fa.uvsNeedUpdate=false;fa.normalsNeedUpdate=false;fa.colorsNeedUpdate=false;fa.tangentsNeedUpdate=false}else{for(var Zc=0,Ec=fa.geometryGroupsList.length;Zc<Ec;Zc++){hb=fa.geometryGroupsList[Zc];$a=c(ub,hb);eb=$a.attributes&&m($a);if(fa.verticesNeedUpdate||fa.morphTargetsNeedUpdate||fa.elementsNeedUpdate||fa.uvsNeedUpdate||fa.normalsNeedUpdate||fa.colorsNeedUpdate||fa.tangentsNeedUpdate||eb){var ma=hb,Sc=ub,nb=k.DYNAMIC_DRAW,Tc=!fa.dynamic,gc=$a;if(ma.__inittedArrays){var hd=
d(gc),$c=gc.vertexColors?gc.vertexColors:false,id=f(gc),Gc=hd===THREE.SmoothShading,E=void 0,W=void 0,Xb=void 0,Q=void 0,mc=void 0,Yb=void 0,vb=void 0,Hc=void 0,Pb=void 0,nc=void 0,oc=void 0,R=void 0,S=void 0,T=void 0,ja=void 0,xb=void 0,yb=void 0,zb=void 0,tc=void 0,Ab=void 0,Bb=void 0,Cb=void 0,uc=void 0,Db=void 0,Eb=void 0,Fb=void 0,vc=void 0,Gb=void 0,Hb=void 0,Ib=void 0,wc=void 0,Jb=void 0,Kb=void 0,Lb=void 0,xc=void 0,qa=void 0,jd=void 0,Zb=void 0,pc=void 0,qc=void 0,Na=void 0,kd=void 0,La=
void 0,Ma=void 0,$b=void 0,Qb=void 0,Da=0,Ja=0,Rb=0,Sb=0,ob=0,Sa=0,sa=0,Ya=0,Ea=0,ba=0,ga=0,z=0,ra=void 0,Oa=ma.__vertexArray,yc=ma.__uvArray,zc=ma.__uv2Array,pb=ma.__normalArray,xa=ma.__tangentArray,Pa=ma.__colorArray,ya=ma.__skinIndexArray,za=ma.__skinWeightArray,ad=ma.__morphTargetsArrays,bd=ma.__morphNormalsArrays,cd=ma.__webglCustomAttributesList,w=void 0,Mb=ma.__faceArray,gb=ma.__lineArray,ab=Sc.geometry,sd=ab.elementsNeedUpdate,ld=ab.uvsNeedUpdate,td=ab.normalsNeedUpdate,ud=ab.tangentsNeedUpdate,
vd=ab.colorsNeedUpdate,wd=ab.morphTargetsNeedUpdate,hc=ab.vertices,na=ma.faces3,oa=ma.faces4,Ta=ab.faces,dd=ab.faceVertexUvs[0],ed=ab.faceVertexUvs[1],ic=ab.skinIndices,ac=ab.skinWeights,bc=ab.morphTargets,Ic=ab.morphNormals;if(ab.verticesNeedUpdate){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];R=hc[Q.a];S=hc[Q.b];T=hc[Q.c];Oa[Ja]=R.x;Oa[Ja+1]=R.y;Oa[Ja+2]=R.z;Oa[Ja+3]=S.x;Oa[Ja+4]=S.y;Oa[Ja+5]=S.z;Oa[Ja+6]=T.x;Oa[Ja+7]=T.y;Oa[Ja+8]=T.z;Ja=Ja+9}E=0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];R=hc[Q.a];S=hc[Q.b];
T=hc[Q.c];ja=hc[Q.d];Oa[Ja]=R.x;Oa[Ja+1]=R.y;Oa[Ja+2]=R.z;Oa[Ja+3]=S.x;Oa[Ja+4]=S.y;Oa[Ja+5]=S.z;Oa[Ja+6]=T.x;Oa[Ja+7]=T.y;Oa[Ja+8]=T.z;Oa[Ja+9]=ja.x;Oa[Ja+10]=ja.y;Oa[Ja+11]=ja.z;Ja=Ja+12}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Oa,nb)}if(wd){Na=0;for(kd=bc.length;Na<kd;Na++){E=ga=0;for(W=na.length;E<W;E++){$b=na[E];Q=Ta[$b];R=bc[Na].vertices[Q.a];S=bc[Na].vertices[Q.b];T=bc[Na].vertices[Q.c];La=ad[Na];La[ga]=R.x;La[ga+1]=R.y;La[ga+2]=R.z;La[ga+3]=S.x;La[ga+
4]=S.y;La[ga+5]=S.z;La[ga+6]=T.x;La[ga+7]=T.y;La[ga+8]=T.z;if(gc.morphNormals){if(Gc){Qb=Ic[Na].vertexNormals[$b];Ab=Qb.a;Bb=Qb.b;Cb=Qb.c}else Cb=Bb=Ab=Ic[Na].faceNormals[$b];Ma=bd[Na];Ma[ga]=Ab.x;Ma[ga+1]=Ab.y;Ma[ga+2]=Ab.z;Ma[ga+3]=Bb.x;Ma[ga+4]=Bb.y;Ma[ga+5]=Bb.z;Ma[ga+6]=Cb.x;Ma[ga+7]=Cb.y;Ma[ga+8]=Cb.z}ga=ga+9}E=0;for(W=oa.length;E<W;E++){$b=oa[E];Q=Ta[$b];R=bc[Na].vertices[Q.a];S=bc[Na].vertices[Q.b];T=bc[Na].vertices[Q.c];ja=bc[Na].vertices[Q.d];La=ad[Na];La[ga]=R.x;La[ga+1]=R.y;La[ga+2]=R.z;
La[ga+3]=S.x;La[ga+4]=S.y;La[ga+5]=S.z;La[ga+6]=T.x;La[ga+7]=T.y;La[ga+8]=T.z;La[ga+9]=ja.x;La[ga+10]=ja.y;La[ga+11]=ja.z;if(gc.morphNormals){if(Gc){Qb=Ic[Na].vertexNormals[$b];Ab=Qb.a;Bb=Qb.b;Cb=Qb.c;uc=Qb.d}else uc=Cb=Bb=Ab=Ic[Na].faceNormals[$b];Ma=bd[Na];Ma[ga]=Ab.x;Ma[ga+1]=Ab.y;Ma[ga+2]=Ab.z;Ma[ga+3]=Bb.x;Ma[ga+4]=Bb.y;Ma[ga+5]=Bb.z;Ma[ga+6]=Cb.x;Ma[ga+7]=Cb.y;Ma[ga+8]=Cb.z;Ma[ga+9]=uc.x;Ma[ga+10]=uc.y;Ma[ga+11]=uc.z}ga=ga+12}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglMorphTargetsBuffers[Na]);k.bufferData(k.ARRAY_BUFFER,
ad[Na],nb);if(gc.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglMorphNormalsBuffers[Na]);k.bufferData(k.ARRAY_BUFFER,bd[Na],nb)}}}if(ac.length){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];Gb=ac[Q.a];Hb=ac[Q.b];Ib=ac[Q.c];za[ba]=Gb.x;za[ba+1]=Gb.y;za[ba+2]=Gb.z;za[ba+3]=Gb.w;za[ba+4]=Hb.x;za[ba+5]=Hb.y;za[ba+6]=Hb.z;za[ba+7]=Hb.w;za[ba+8]=Ib.x;za[ba+9]=Ib.y;za[ba+10]=Ib.z;za[ba+11]=Ib.w;Jb=ic[Q.a];Kb=ic[Q.b];Lb=ic[Q.c];ya[ba]=Jb.x;ya[ba+1]=Jb.y;ya[ba+2]=Jb.z;ya[ba+3]=Jb.w;ya[ba+4]=Kb.x;ya[ba+5]=
Kb.y;ya[ba+6]=Kb.z;ya[ba+7]=Kb.w;ya[ba+8]=Lb.x;ya[ba+9]=Lb.y;ya[ba+10]=Lb.z;ya[ba+11]=Lb.w;ba=ba+12}E=0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];Gb=ac[Q.a];Hb=ac[Q.b];Ib=ac[Q.c];wc=ac[Q.d];za[ba]=Gb.x;za[ba+1]=Gb.y;za[ba+2]=Gb.z;za[ba+3]=Gb.w;za[ba+4]=Hb.x;za[ba+5]=Hb.y;za[ba+6]=Hb.z;za[ba+7]=Hb.w;za[ba+8]=Ib.x;za[ba+9]=Ib.y;za[ba+10]=Ib.z;za[ba+11]=Ib.w;za[ba+12]=wc.x;za[ba+13]=wc.y;za[ba+14]=wc.z;za[ba+15]=wc.w;Jb=ic[Q.a];Kb=ic[Q.b];Lb=ic[Q.c];xc=ic[Q.d];ya[ba]=Jb.x;ya[ba+1]=Jb.y;ya[ba+2]=Jb.z;ya[ba+
3]=Jb.w;ya[ba+4]=Kb.x;ya[ba+5]=Kb.y;ya[ba+6]=Kb.z;ya[ba+7]=Kb.w;ya[ba+8]=Lb.x;ya[ba+9]=Lb.y;ya[ba+10]=Lb.z;ya[ba+11]=Lb.w;ya[ba+12]=xc.x;ya[ba+13]=xc.y;ya[ba+14]=xc.z;ya[ba+15]=xc.w;ba=ba+16}if(ba>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglSkinIndicesBuffer);k.bufferData(k.ARRAY_BUFFER,ya,nb);k.bindBuffer(k.ARRAY_BUFFER,ma.__webglSkinWeightsBuffer);k.bufferData(k.ARRAY_BUFFER,za,nb)}}if(vd&&$c){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];vb=Q.vertexColors;Hc=Q.color;if(vb.length===3&&$c===THREE.VertexColors){Db=
vb[0];Eb=vb[1];Fb=vb[2]}else Fb=Eb=Db=Hc;Pa[Ea]=Db.r;Pa[Ea+1]=Db.g;Pa[Ea+2]=Db.b;Pa[Ea+3]=Eb.r;Pa[Ea+4]=Eb.g;Pa[Ea+5]=Eb.b;Pa[Ea+6]=Fb.r;Pa[Ea+7]=Fb.g;Pa[Ea+8]=Fb.b;Ea=Ea+9}E=0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];vb=Q.vertexColors;Hc=Q.color;if(vb.length===4&&$c===THREE.VertexColors){Db=vb[0];Eb=vb[1];Fb=vb[2];vc=vb[3]}else vc=Fb=Eb=Db=Hc;Pa[Ea]=Db.r;Pa[Ea+1]=Db.g;Pa[Ea+2]=Db.b;Pa[Ea+3]=Eb.r;Pa[Ea+4]=Eb.g;Pa[Ea+5]=Eb.b;Pa[Ea+6]=Fb.r;Pa[Ea+7]=Fb.g;Pa[Ea+8]=Fb.b;Pa[Ea+9]=vc.r;Pa[Ea+10]=vc.g;Pa[Ea+
11]=vc.b;Ea=Ea+12}if(Ea>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Pa,nb)}}if(ud&&ab.hasTangents){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];Pb=Q.vertexTangents;xb=Pb[0];yb=Pb[1];zb=Pb[2];xa[sa]=xb.x;xa[sa+1]=xb.y;xa[sa+2]=xb.z;xa[sa+3]=xb.w;xa[sa+4]=yb.x;xa[sa+5]=yb.y;xa[sa+6]=yb.z;xa[sa+7]=yb.w;xa[sa+8]=zb.x;xa[sa+9]=zb.y;xa[sa+10]=zb.z;xa[sa+11]=zb.w;sa=sa+12}E=0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];Pb=Q.vertexTangents;xb=Pb[0];yb=Pb[1];zb=Pb[2];tc=Pb[3];xa[sa]=
xb.x;xa[sa+1]=xb.y;xa[sa+2]=xb.z;xa[sa+3]=xb.w;xa[sa+4]=yb.x;xa[sa+5]=yb.y;xa[sa+6]=yb.z;xa[sa+7]=yb.w;xa[sa+8]=zb.x;xa[sa+9]=zb.y;xa[sa+10]=zb.z;xa[sa+11]=zb.w;xa[sa+12]=tc.x;xa[sa+13]=tc.y;xa[sa+14]=tc.z;xa[sa+15]=tc.w;sa=sa+16}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,xa,nb)}if(td&&hd){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];mc=Q.vertexNormals;Yb=Q.normal;if(mc.length===3&&Gc)for(qa=0;qa<3;qa++){Zb=mc[qa];pb[Sa]=Zb.x;pb[Sa+1]=Zb.y;pb[Sa+2]=Zb.z;Sa=Sa+3}else for(qa=
0;qa<3;qa++){pb[Sa]=Yb.x;pb[Sa+1]=Yb.y;pb[Sa+2]=Yb.z;Sa=Sa+3}}E=0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];mc=Q.vertexNormals;Yb=Q.normal;if(mc.length===4&&Gc)for(qa=0;qa<4;qa++){Zb=mc[qa];pb[Sa]=Zb.x;pb[Sa+1]=Zb.y;pb[Sa+2]=Zb.z;Sa=Sa+3}else for(qa=0;qa<4;qa++){pb[Sa]=Yb.x;pb[Sa+1]=Yb.y;pb[Sa+2]=Yb.z;Sa=Sa+3}}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,pb,nb)}if(ld&&dd&&id){E=0;for(W=na.length;E<W;E++){Xb=na[E];nc=dd[Xb];if(nc!==void 0)for(qa=0;qa<3;qa++){pc=nc[qa];
yc[Rb]=pc.u;yc[Rb+1]=pc.v;Rb=Rb+2}}E=0;for(W=oa.length;E<W;E++){Xb=oa[E];nc=dd[Xb];if(nc!==void 0)for(qa=0;qa<4;qa++){pc=nc[qa];yc[Rb]=pc.u;yc[Rb+1]=pc.v;Rb=Rb+2}}if(Rb>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglUVBuffer);k.bufferData(k.ARRAY_BUFFER,yc,nb)}}if(ld&&ed&&id){E=0;for(W=na.length;E<W;E++){Xb=na[E];oc=ed[Xb];if(oc!==void 0)for(qa=0;qa<3;qa++){qc=oc[qa];zc[Sb]=qc.u;zc[Sb+1]=qc.v;Sb=Sb+2}}E=0;for(W=oa.length;E<W;E++){Xb=oa[E];oc=ed[Xb];if(oc!==void 0)for(qa=0;qa<4;qa++){qc=oc[qa];zc[Sb]=qc.u;
zc[Sb+1]=qc.v;Sb=Sb+2}}if(Sb>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglUV2Buffer);k.bufferData(k.ARRAY_BUFFER,zc,nb)}}if(sd){E=0;for(W=na.length;E<W;E++){Mb[ob]=Da;Mb[ob+1]=Da+1;Mb[ob+2]=Da+2;ob=ob+3;gb[Ya]=Da;gb[Ya+1]=Da+1;gb[Ya+2]=Da;gb[Ya+3]=Da+2;gb[Ya+4]=Da+1;gb[Ya+5]=Da+2;Ya=Ya+6;Da=Da+3}E=0;for(W=oa.length;E<W;E++){Mb[ob]=Da;Mb[ob+1]=Da+1;Mb[ob+2]=Da+3;Mb[ob+3]=Da+1;Mb[ob+4]=Da+2;Mb[ob+5]=Da+3;ob=ob+6;gb[Ya]=Da;gb[Ya+1]=Da+1;gb[Ya+2]=Da;gb[Ya+3]=Da+3;gb[Ya+4]=Da+1;gb[Ya+5]=Da+2;gb[Ya+6]=Da+2;
gb[Ya+7]=Da+3;Ya=Ya+8;Da=Da+4}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ma.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Mb,nb);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ma.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,gb,nb)}if(cd){qa=0;for(jd=cd.length;qa<jd;qa++){w=cd[qa];if(w.__original.needsUpdate){z=0;if(w.size===1)if(w.boundTo===void 0||w.boundTo==="vertices"){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];w.array[z]=w.value[Q.a];w.array[z+1]=w.value[Q.b];w.array[z+2]=w.value[Q.c];z=z+3}E=
0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];w.array[z]=w.value[Q.a];w.array[z+1]=w.value[Q.b];w.array[z+2]=w.value[Q.c];w.array[z+3]=w.value[Q.d];z=z+4}}else{if(w.boundTo==="faces"){E=0;for(W=na.length;E<W;E++){ra=w.value[na[E]];w.array[z]=ra;w.array[z+1]=ra;w.array[z+2]=ra;z=z+3}E=0;for(W=oa.length;E<W;E++){ra=w.value[oa[E]];w.array[z]=ra;w.array[z+1]=ra;w.array[z+2]=ra;w.array[z+3]=ra;z=z+4}}}else if(w.size===2)if(w.boundTo===void 0||w.boundTo==="vertices"){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];R=
w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=S.x;w.array[z+3]=S.y;w.array[z+4]=T.x;w.array[z+5]=T.y;z=z+6}E=0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];ja=w.value[Q.d];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=S.x;w.array[z+3]=S.y;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=ja.x;w.array[z+7]=ja.y;z=z+8}}else{if(w.boundTo==="faces"){E=0;for(W=na.length;E<W;E++){T=S=R=ra=w.value[na[E]];w.array[z]=R.x;w.array[z+
1]=R.y;w.array[z+2]=S.x;w.array[z+3]=S.y;w.array[z+4]=T.x;w.array[z+5]=T.y;z=z+6}E=0;for(W=oa.length;E<W;E++){ja=T=S=R=ra=w.value[oa[E]];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=S.x;w.array[z+3]=S.y;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=ja.x;w.array[z+7]=ja.y;z=z+8}}}else if(w.size===3){var Z;Z=w.type==="c"?["r","g","b"]:["x","y","z"];if(w.boundTo===void 0||w.boundTo==="vertices"){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];w.array[z]=R[Z[0]];
w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];z=z+9}E=0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];ja=w.value[Q.d];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];w.array[z+9]=ja[Z[0]];w.array[z+10]=ja[Z[1]];
w.array[z+11]=ja[Z[2]];z=z+12}}else if(w.boundTo==="faces"){E=0;for(W=na.length;E<W;E++){T=S=R=ra=w.value[na[E]];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];z=z+9}E=0;for(W=oa.length;E<W;E++){ja=T=S=R=ra=w.value[oa[E]];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];
w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];w.array[z+9]=ja[Z[0]];w.array[z+10]=ja[Z[1]];w.array[z+11]=ja[Z[2]];z=z+12}}else if(w.boundTo==="faceVertices"){E=0;for(W=na.length;E<W;E++){ra=w.value[na[E]];R=ra[0];S=ra[1];T=ra[2];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];z=z+9}E=0;for(W=oa.length;E<W;E++){ra=w.value[oa[E]];R=ra[0];S=ra[1];T=ra[2];ja=ra[3];w.array[z]=
R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];w.array[z+9]=ja[Z[0]];w.array[z+10]=ja[Z[1]];w.array[z+11]=ja[Z[2]];z=z+12}}}else if(w.size===4)if(w.boundTo===void 0||w.boundTo==="vertices"){E=0;for(W=na.length;E<W;E++){Q=Ta[na[E]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=
S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;z=z+12}E=0;for(W=oa.length;E<W;E++){Q=Ta[oa[E]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];ja=w.value[Q.d];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;w.array[z+12]=ja.x;w.array[z+13]=ja.y;w.array[z+14]=ja.z;w.array[z+15]=ja.w;z=z+
16}}else if(w.boundTo==="faces"){E=0;for(W=na.length;E<W;E++){T=S=R=ra=w.value[na[E]];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;z=z+12}E=0;for(W=oa.length;E<W;E++){ja=T=S=R=ra=w.value[oa[E]];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;
w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;w.array[z+12]=ja.x;w.array[z+13]=ja.y;w.array[z+14]=ja.z;w.array[z+15]=ja.w;z=z+16}}else if(w.boundTo==="faceVertices"){E=0;for(W=na.length;E<W;E++){ra=w.value[na[E]];R=ra[0];S=ra[1];T=ra[2];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;z=z+12}E=0;for(W=oa.length;E<W;E++){ra=w.value[oa[E]];
R=ra[0];S=ra[1];T=ra[2];ja=ra[3];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;w.array[z+12]=ja.x;w.array[z+13]=ja.y;w.array[z+14]=ja.z;w.array[z+15]=ja.w;z=z+16}}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,nb)}}}if(Tc){delete ma.__inittedArrays;delete ma.__colorArray;delete ma.__normalArray;delete ma.__tangentArray;
delete ma.__uvArray;delete ma.__uv2Array;delete ma.__faceArray;delete ma.__vertexArray;delete ma.__lineArray;delete ma.__skinIndexArray;delete ma.__skinWeightArray}}}}fa.verticesNeedUpdate=false;fa.morphTargetsNeedUpdate=false;fa.elementsNeedUpdate=false;fa.uvsNeedUpdate=false;fa.normalsNeedUpdate=false;fa.colorsNeedUpdate=false;fa.tangentsNeedUpdate=false;$a.attributes&&q($a)}else if(ub instanceof THREE.Ribbon){if(fa.verticesNeedUpdate||fa.colorsNeedUpdate){var cc=fa,md=k.DYNAMIC_DRAW,Ac=void 0,
Bc=void 0,Jc=void 0,dc=void 0,Kc=void 0,nd=cc.vertices,od=cc.colors,xd=nd.length,yd=od.length,Lc=cc.__vertexArray,Mc=cc.__colorArray,zd=cc.colorsNeedUpdate;if(cc.verticesNeedUpdate){for(Ac=0;Ac<xd;Ac++){Jc=nd[Ac];dc=Ac*3;Lc[dc]=Jc.x;Lc[dc+1]=Jc.y;Lc[dc+2]=Jc.z}k.bindBuffer(k.ARRAY_BUFFER,cc.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Lc,md)}if(zd){for(Bc=0;Bc<yd;Bc++){Kc=od[Bc];dc=Bc*3;Mc[dc]=Kc.r;Mc[dc+1]=Kc.g;Mc[dc+2]=Kc.b}k.bindBuffer(k.ARRAY_BUFFER,cc.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,
Mc,md)}}fa.verticesNeedUpdate=false;fa.colorsNeedUpdate=false}else if(ub instanceof THREE.Line){$a=c(ub,hb);eb=$a.attributes&&m($a);if(fa.verticesNeedUpdate||fa.colorsNeedUpdate||eb){var Tb=fa,fd=k.DYNAMIC_DRAW,Cc=void 0,Dc=void 0,Nc=void 0,Aa=void 0,Oc=void 0,pd=Tb.vertices,qd=Tb.colors,Ad=pd.length,Bd=qd.length,Pc=Tb.__vertexArray,Qc=Tb.__colorArray,Cd=Tb.colorsNeedUpdate,gd=Tb.__webglCustomAttributesList,Rc=void 0,rd=void 0,Ra=void 0,rc=void 0,bb=void 0,va=void 0;if(Tb.verticesNeedUpdate){for(Cc=
0;Cc<Ad;Cc++){Nc=pd[Cc];Aa=Cc*3;Pc[Aa]=Nc.x;Pc[Aa+1]=Nc.y;Pc[Aa+2]=Nc.z}k.bindBuffer(k.ARRAY_BUFFER,Tb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Pc,fd)}if(Cd){for(Dc=0;Dc<Bd;Dc++){Oc=qd[Dc];Aa=Dc*3;Qc[Aa]=Oc.r;Qc[Aa+1]=Oc.g;Qc[Aa+2]=Oc.b}k.bindBuffer(k.ARRAY_BUFFER,Tb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Qc,fd)}if(gd){Rc=0;for(rd=gd.length;Rc<rd;Rc++){va=gd[Rc];if(va.needsUpdate&&(va.boundTo===void 0||va.boundTo==="vertices")){Aa=0;rc=va.value.length;if(va.size===1)for(Ra=0;Ra<rc;Ra++)va.array[Ra]=
va.value[Ra];else if(va.size===2)for(Ra=0;Ra<rc;Ra++){bb=va.value[Ra];va.array[Aa]=bb.x;va.array[Aa+1]=bb.y;Aa=Aa+2}else if(va.size===3)if(va.type==="c")for(Ra=0;Ra<rc;Ra++){bb=va.value[Ra];va.array[Aa]=bb.r;va.array[Aa+1]=bb.g;va.array[Aa+2]=bb.b;Aa=Aa+3}else for(Ra=0;Ra<rc;Ra++){bb=va.value[Ra];va.array[Aa]=bb.x;va.array[Aa+1]=bb.y;va.array[Aa+2]=bb.z;Aa=Aa+3}else if(va.size===4)for(Ra=0;Ra<rc;Ra++){bb=va.value[Ra];va.array[Aa]=bb.x;va.array[Aa+1]=bb.y;va.array[Aa+2]=bb.z;va.array[Aa+3]=bb.w;Aa=
Aa+4}k.bindBuffer(k.ARRAY_BUFFER,va.buffer);k.bufferData(k.ARRAY_BUFFER,va.array,fd)}}}}fa.verticesNeedUpdate=false;fa.colorsNeedUpdate=false;$a.attributes&&q($a)}else if(ub instanceof THREE.ParticleSystem){$a=c(ub,hb);eb=$a.attributes&&m($a);(fa.verticesNeedUpdate||fa.colorsNeedUpdate||ub.sortParticles||eb)&&e(fa,k.DYNAMIC_DRAW,ub);fa.verticesNeedUpdate=false;fa.colorsNeedUpdate=false;$a.attributes&&q($a)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,m,n;a instanceof THREE.MeshDepthMaterial?
n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var o=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,q;p=h=f=e=o=0;for(g=b.length;p<g;p++){q=
b[p];if(!q.onlyShadow){q instanceof THREE.DirectionalLight&&h++;q instanceof THREE.PointLight&&f++;q instanceof THREE.SpotLight&&e++;q instanceof THREE.HemisphereLight&&o++}}if(f+e+h+o<=O){p=h;g=e}else{p=Math.ceil(O*h/(f+h));g=f=O-p;o=p}e=p;h=o;o=m=0;for(p=b.length;o<p;o++){q=b[o];if(q.castShadow){q instanceof THREE.SpotLight&&m++;q instanceof THREE.DirectionalLight&&!q.shadowCascade&&m++}}if(ec&&d&&d.useVertexTexture)l=1024;else{b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS);b=Math.floor((b-20)/
...
maxBones:l,useVertexTexture:ec&&d&&d.useVertexTexture,boneTextureWidth:d&&d.boneTextureWidth,boneTextureHeight:d&&d.boneTextureHeight,morphTargets:a.morphTargets,morphNormals:a.morphNormals,maxMorphTargets:this.maxMorphTargets,maxMorphNormals:this.maxMorphNormals,maxDirLights:e,maxPointLights:f,maxSpotLights:g,maxHemiLights:h,maxShadows:m,shadowMapEnabled:this.shadowMapEnabled&&d.receiveShadow,shadowMapSoft:this.shadowMapSoft,shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,
alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide},u,d=[];if(n)d.push(n);else{d.push(q);d.push(p)}for(u in c){d.push(u);d.push(c[u])}n=d.join();u=0;for(d=aa.length;u<d;u++){e=aa[u];if(e.code===n){e.usedTimes++;r=e.program;break a}}u=k.createProgram();d=["precision "+G+" float;",fc?"#define VERTEX_TEXTURES":"",C.gammaInput?"#define GAMMA_INPUT":"",C.gammaOutput?"#define GAMMA_OUTPUT":"",C.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":
"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_HEMI_LIGHTS "+c.maxHemiLights,"#define MAX_SHADOWS "+c.maxShadows,"#define MAX_BONES "+c.maxBones,c.map?"#define USE_MAP":"",c.envMap?"#define USE_ENVMAP":"",c.lightMap?"#define USE_LIGHTMAP":"",c.bumpMap?"#define USE_BUMPMAP":"",c.specularMap?"#define USE_SPECULARMAP":"",c.vertexColors?"#define USE_COLOR":"",c.skinning?"#define USE_SKINNING":"",c.useVertexTexture?
...
e=["precision "+G+" float;",c.bumpMap?"#extension GL_OES_standard_derivatives : enable":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_HEMI_LIGHTS "+c.maxHemiLights,"#define MAX_SHADOWS "+c.maxShadows,c.alphaTest?"#define ALPHATEST "+c.alphaTest:"",C.gammaInput?"#define GAMMA_INPUT":"",C.gammaOutput?"#define GAMMA_OUTPUT":"",C.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"",c.useFog&&c.fog?
"#define USE_FOG":"",c.useFog&&c.fog instanceof THREE.FogExp2?"#define FOG_EXP2":"",c.map?"#define USE_MAP":"",c.envMap?"#define USE_ENVMAP":"",c.lightMap?"#define USE_LIGHTMAP":"",c.bumpMap?"#define USE_BUMPMAP":"",c.specularMap?"#define USE_SPECULARMAP":"",c.vertexColors?"#define USE_COLOR":"",c.metal?"#define METAL":"",c.perPixel?"#define PHONG_PER_PIXEL":"",c.wrapAround?"#define WRAP_AROUND":"",c.doubleSided?"#define DOUBLE_SIDED":"",c.shadowMapEnabled?"#define USE_SHADOWMAP":"",c.shadowMapSoft?
"#define SHADOWMAP_SOFT":"",c.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",c.shadowMapCascade?"#define SHADOWMAP_CASCADE":"","uniform mat4 viewMatrix;\nuniform vec3 cameraPosition;\n"].join("\n");e=B("fragment",e+q);d=B("vertex",d+p);k.attachShader(u,d);k.attachShader(u,e);k.linkProgram(u);k.getProgramParameter(u,k.LINK_STATUS)||console.error("Could not initialise shader\nVALIDATE_STATUS: "+k.getProgramParameter(u,k.VALIDATE_STATUS)+", gl error ["+k.getError()+"]");k.deleteShader(e);k.deleteShader(d);
u.uniforms={};u.attributes={};var s,d=["viewMatrix","modelViewMatrix","projectionMatrix","normalMatrix","modelMatrix","cameraPosition","morphTargetInfluences"];c.useVertexTexture?d.push("boneTexture"):d.push("boneGlobalMatrices");for(s in o)d.push(s);s=d;d=0;for(o=s.length;d<o;d++){e=s[d];u.uniforms[e]=k.getUniformLocation(u,e)}d=["position","normal","uv","uv2","tangent","color","skinIndex","skinWeight"];for(s=0;s<c.maxMorphTargets;s++)d.push("morphTarget"+s);for(s=0;s<c.maxMorphNormals;s++)d.push("morphNormal"+
s);for(r in b)d.push(r);r=d;s=0;for(c=r.length;s<c;s++){d=r[s];u.attributes[d]=k.getAttribLocation(u,d)}u.id=wa++;aa.push({program:u,code:n,usedTimes:1});C.info.memory.programs=aa.length;r=u}a.program=r;r=a.program.attributes;r.position>=0&&k.enableVertexAttribArray(r.position);r.color>=0&&k.enableVertexAttribArray(r.color);r.normal>=0&&k.enableVertexAttribArray(r.normal);r.tangent>=0&&k.enableVertexAttribArray(r.tangent);if(a.skinning&&r.skinIndex>=0&&r.skinWeight>=0){k.enableVertexAttribArray(r.skinIndex);
k.enableVertexAttribArray(r.skinWeight)}if(a.attributes)for(j in a.attributes)r[j]!==void 0&&r[j]>=0&&k.enableVertexAttribArray(r[j]);if(a.morphTargets){a.numSupportedMorphTargets=0;u="morphTarget";for(j=0;j<this.maxMorphTargets;j++){s=u+j;if(r[s]>=0){k.enableVertexAttribArray(r[s]);a.numSupportedMorphTargets++}}}if(a.morphNormals){a.numSupportedMorphNormals=0;u="morphNormal";for(j=0;j<this.maxMorphNormals;j++){s=u+j;if(r[s]>=0){k.enableVertexAttribArray(r[s]);a.numSupportedMorphNormals++}}}a.uniformsList=
[];for(i in a.uniforms)a.uniformsList.push([a.uniforms[i],i])};this.setFaceCulling=function(a,b){if(a){!b||b==="ccw"?k.frontFace(k.CCW):k.frontFace(k.CW);a==="back"?k.cullFace(k.BACK):a==="front"?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK);k.enable(k.CULL_FACE)}else k.disable(k.CULL_FACE)};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,a=a.side===THREE.BackSide;if(da!==b){b?k.disable(k.CULL_FACE):k.enable(k.CULL_FACE);da=b}if(ia!==a){a?k.frontFace(k.CW):k.frontFace(k.CCW);
ia=a}};this.setDepthTest=function(a){if(pa!==a){a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST);pa=a}};this.setDepthWrite=function(a){if(Za!==a){k.depthMask(a);Za=a}};this.setBlending=function(a,b,c,d){if(a!==ta){if(a===THREE.NoBlending)k.disable(k.BLEND);else if(a===THREE.AdditiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE)}else if(a===THREE.SubtractiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)}else if(a===
THREE.MultiplyBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.SRC_COLOR)}else if(a===THREE.CustomBlending)k.enable(k.BLEND);else{k.enable(k.BLEND);k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD);k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)}ta=a}if(a===THREE.CustomBlending){if(b!==Fa){k.blendEquation(F(b));Fa=b}if(c!==Ga||d!==Qa){k.blendFunc(F(c),F(d));Ga=c;Qa=d}}else Qa=Ga=Fa=null};this.setTexture=function(a,b){if(a.needsUpdate){if(!a.__webglInit){a.__webglInit=
true;a.__webglTexture=k.createTexture();C.info.memory.textures++}k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=(c.width&c.width-1)===0&&(c.height&c.height-1)===0,e=F(a.format),f=F(a.type);J(k.TEXTURE_2D,a,d);a instanceof THREE.DataTexture?k.texImage2D(k.TEXTURE_2D,0,e,c.width,c.height,0,e,f,c.data):k.texImage2D(k.TEXTURE_2D,0,e,e,f,a.image);a.generateMipmaps&&
d&&k.generateMipmap(k.TEXTURE_2D);a.needsUpdate=false;if(a.onUpdate)a.onUpdate()}else{k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture)}};this.setRenderTarget=function(a){var b=a instanceof THREE.WebGLRenderTargetCube;if(a&&!a.__webglFramebuffer){if(a.depthBuffer===void 0)a.depthBuffer=true;if(a.stencilBuffer===void 0)a.stencilBuffer=true;a.__webglTexture=k.createTexture();var c=(a.width&a.width-1)===0&&(a.height&a.height-1)===0,d=F(a.format),e=F(a.type);if(b){a.__webglFramebuffer=
[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);J(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;f<6;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);y(a.__webglRenderbuffer[f],
a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);J(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null);d=k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);y(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,
null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;e=d=0}else{b=null;c=Ca;a=eb;d=cb;e=Ha}if(b!==Ba){k.bindFramebuffer(k.FRAMEBUFFER,b);k.viewport(d,e,c,a);Ba=b}Ia=c;ib=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
j[q],r,s,t=g.vertexNormals,v=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+f,g.b+f,g.c+f):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+f,g.b+f,g.c+f,g.d+f));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(o=t.length;h<o;h++){s=t[h].clone();d&&d.multiplyVector3(s);r.vertexNormals.push(s)}r.color.copy(g.color);h=0;for(o=v.length;h<o;h++){s=v[h];r.vertexColors.push(s.clone())}if(g.materialIndex!==void 0){h=e.materials[g.materialIndex];o=h.id;v=m[o];if(v===void 0){v=
a.materials.length;m[o]=v;a.materials.push(h)}r.materialIndex=v}r.centroid.copy(g.centroid);c&&c.multiplyVector3(r.centroid);i.push(r)}q=0;for(p=n.length;q<p;q++){c=n[q];d=[];h=0;for(o=c.length;h<o;h++)d.push(new THREE.UV(c[h].u,c[h].v));l.push(d)}},clone:function(a){var b=new THREE.Geometry,c,d=a.vertices,f=a.faces,e=a.faceVertexUvs[0];if(a.materials)b.materials=a.materials.slice();a=0;for(c=d.length;a<c;a++)b.vertices.push(d[a].clone());a=0;for(c=f.length;a<c;a++)b.faces.push(f[a].clone());a=0;
...
m.vertexColors[1]=d.vertexColors[2].clone();m.vertexColors[2]=d.vertexColors[3].clone()}e.push(n,m);d=0;for(f=a.faceVertexUvs.length;d<f;d++)if(a.faceVertexUvs[d].length){n=a.faceVertexUvs[d][b];i=n[1];j=n[2];l=n[3];n=[n[0].clone(),i.clone(),l.clone()];i=[i.clone(),j.clone(),l.clone()];h[d].push(n,i)}d=0;for(f=a.faceUvs.length;d<f;d++)if(a.faceUvs[d].length){i=a.faceUvs[d][b];g[d].push(i,i)}}else{e.push(d);d=0;for(f=a.faceUvs.length;d<f;d++)g[d].push(a.faceUvs[d]);d=0;for(f=a.faceVertexUvs.length;d<
...
j.lerpSelf(n,0.5);v.a=e;v.b=g;v.c=i;u.a=i;u.b=g;u.c=h;if(f.vertexNormals.length===3){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[2],0.5);v.vertexNormals[2].copy(e);u.vertexNormals[0].copy(e)}if(f.vertexColors.length===3){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[2],0.5);v.vertexColors[2].copy(e);u.vertexColors[0].copy(e)}f=2}A.push(v,u);a.vertices.push(j);e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){j=a.faceVertexUvs[e][c];u=j[0];h=j[1];v=j[2];if(f===
0){l=u.clone();l.lerpSelf(h,0.5);j=[u.clone(),l.clone(),v.clone()];h=[l.clone(),h.clone(),v.clone()]}else if(f===1){l=h.clone();l.lerpSelf(v,0.5);j=[u.clone(),h.clone(),l.clone()];h=[l.clone(),v.clone(),u.clone()]}else{l=u.clone();l.lerpSelf(v,0.5);j=[u.clone(),h.clone(),l.clone()];h=[l.clone(),h.clone(),v.clone()]}x[e].push(j,h)}}else{A.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)x[e].push(a.faceVertexUvs[e][c])}}else{e=f.a;g=f.b;h=f.c;i=f.d;j=a.vertices[e];l=a.vertices[g];n=a.vertices[h];m=
a.vertices[i];q=j.distanceTo(l);p=l.distanceTo(n);o=n.distanceTo(m);r=j.distanceTo(m);if(q>b||p>b||o>b||r>b){s=a.vertices.length;t=a.vertices.length+1;v=f.clone();u=f.clone();if(q>=p&&q>=o&&q>=r||o>=p&&o>=q&&o>=r){q=j.clone();q.lerpSelf(l,0.5);l=n.clone();l.lerpSelf(m,0.5);v.a=e;v.b=s;v.c=t;v.d=i;u.a=s;u.b=g;u.c=h;u.d=t;if(f.vertexNormals.length===4){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);g=f.vertexNormals[2].clone();g.lerpSelf(f.vertexNormals[3],0.5);v.vertexNormals[1].copy(e);
v.vertexNormals[2].copy(g);u.vertexNormals[0].copy(e);u.vertexNormals[3].copy(g)}if(f.vertexColors.length===4){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[1],0.5);g=f.vertexColors[2].clone();g.lerpSelf(f.vertexColors[3],0.5);v.vertexColors[1].copy(e);v.vertexColors[2].copy(g);u.vertexColors[0].copy(e);u.vertexColors[3].copy(g)}f=0}else{q=l.clone();q.lerpSelf(n,0.5);l=m.clone();l.lerpSelf(j,0.5);v.a=e;v.b=g;v.c=s;v.d=t;u.a=t;u.b=s;u.c=h;u.d=i;if(f.vertexNormals.length===4){e=f.vertexNormals[1].clone();
...
e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){j=a.faceVertexUvs[e][c];u=j[0];h=j[1];v=j[2];j=j[3];if(f===0){l=u.clone();l.lerpSelf(h,0.5);n=v.clone();n.lerpSelf(j,0.5);u=[u.clone(),l.clone(),n.clone(),j.clone()];h=[l.clone(),h.clone(),v.clone(),n.clone()]}else{l=h.clone();l.lerpSelf(v,0.5);n=j.clone();n.lerpSelf(u,0.5);u=[u.clone(),h.clone(),l.clone(),n.clone()];h=[n.clone(),l.clone(),v.clone(),j.clone()]}x[e].push(u,h)}}else{A.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)x[e].push(a.faceVertexUvs[e][c])}}}a.faces=
...
f.loadCount+1;if(f.loadCount===6){e.needsUpdate=true;c&&c()}};f[b].crossOrigin=this.crossOrigin;f[b].src=a[b]}return e},getNormalMap:function(a,b){var c=function(a){var b=Math.sqrt(a[0]*a[0]+a[1]*a[1]+a[2]*a[2]);return[a[0]/b,a[1]/b,a[2]/b]},b=b|1,d=a.width,f=a.height,e=document.createElement("canvas");e.width=d;e.height=f;var g=e.getContext("2d");g.drawImage(a,0,0);for(var h=g.getImageData(0,0,d,f).data,i=g.createImageData(d,f),j=i.data,l=0;l<d;l++)for(var n=0;n<f;n++){var m=n-1<0?0:n-1,q=n+1>f-
1?f-1:n+1,p=l-1<0?0:l-1,o=l+1>d-1?d-1:l+1,r=[],s=[0,0,h[(n*d+l)*4]/255*b];r.push([-1,0,h[(n*d+p)*4]/255*b]);r.push([-1,-1,h[(m*d+p)*4]/255*b]);r.push([0,-1,h[(m*d+l)*4]/255*b]);r.push([1,-1,h[(m*d+o)*4]/255*b]);r.push([1,0,h[(n*d+o)*4]/255*b]);r.push([1,1,h[(q*d+o)*4]/255*b]);r.push([0,1,h[(q*d+l)*4]/255*b]);r.push([-1,1,h[(q*d+p)*4]/255*b]);m=[];p=r.length;for(q=0;q<p;q++){var o=r[q],t=r[(q+1)%p],o=[o[0]-s[0],o[1]-s[1],o[2]-s[2]],t=[t[0]-s[0],t[1]-s[1],t[2]-s[2]];m.push(c([o[1]*t[2]-o[2]*t[1],o[2]*
t[0]-o[0]*t[2],o[0]*t[1]-o[1]*t[0]]))}r=[0,0,0];for(q=0;q<m.length;q++){r[0]=r[0]+m[q][0];r[1]=r[1]+m[q][1];r[2]=r[2]+m[q][2]}r[0]=r[0]/m.length;r[1]=r[1]/m.length;r[2]=r[2]/m.length;s=(n*d+l)*4;j[s]=(r[0]+1)/2*255|0;j[s+1]=(r[1]+1)/2*255|0;j[s+2]=r[2]*255|0;j[s+3]=255}g.putImageData(i,0,0);return e},generateDataTexture:function(a,b,c){for(var d=a*b,f=new Uint8Array(3*d),e=Math.floor(c.r*255),g=Math.floor(c.g*255),c=Math.floor(c.b*255),h=0;h<d;h++){f[h*3]=e;f[h*3+1]=g;f[h*3+2]=c}a=new THREE.DataTexture(f,
...
0,f=String(a).split(""),e=f.length,g=[],a=0;a<e;a++){var h=new THREE.Path,h=this.extractGlyphPoints(f[a],b,c,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(a,b,c,d,f){var e=[],g,h,i,j,l,n,m,q,p,o,r,s=b.glyphs[a]||b.glyphs["?"];if(s){if(s.o){b=s._cachedOutline||(s._cachedOutline=s.o.split(" "));j=b.length;for(a=0;a<j;){i=b[a++];switch(i){case "m":i=b[a++]*c+d;l=b[a++]*c;f.moveTo(i,l);break;case "l":i=b[a++]*c+d;l=b[a++]*c;f.lineTo(i,l);break;case "q":i=b[a++]*
c+d;l=b[a++]*c;q=b[a++]*c+d;p=b[a++]*c;f.quadraticCurveTo(q,p,i,l);if(g=e[e.length-1]){n=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++){var t=g/h;THREE.Shape.Utils.b2(t,n,q,i);THREE.Shape.Utils.b2(t,m,p,l)}}break;case "b":i=b[a++]*c+d;l=b[a++]*c;q=b[a++]*c+d;p=b[a++]*-c;o=b[a++]*c+d;r=b[a++]*-c;f.bezierCurveTo(i,l,q,p,o,r);if(g=e[e.length-1]){n=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++){t=g/h;THREE.Shape.Utils.b3(t,n,q,o,i);THREE.Shape.Utils.b3(t,m,p,r,l)}}}}}return{offset:s.ha*c,path:f}}}};
...
(function(a){var b=function(a){for(var b=a.length,f=0,e=b-1,g=0;g<b;e=g++)f=f+(a[e].x*a[g].y-a[g].x*a[e].y);return f*0.5};a.Triangulate=function(a,d){var f=a.length;if(f<3)return null;var e=[],g=[],h=[],i,j,l;if(b(a)>0)for(j=0;j<f;j++)g[j]=j;else for(j=0;j<f;j++)g[j]=f-1-j;var n=2*f;for(j=f-1;f>2;){if(n--<=0){console.log("Warning, unable to triangulate polygon!");break}i=j;f<=i&&(i=0);j=i+1;f<=j&&(j=0);l=j+1;f<=l&&(l=0);var m;a:{m=a;var q=i,p=j,o=l,r=f,s=g,t=void 0,v=void 0,u=void 0,A=void 0,x=void 0,
B=void 0,J=void 0,y=void 0,I=void 0,v=m[s[q]].x,u=m[s[q]].y,A=m[s[p]].x,x=m[s[p]].y,B=m[s[o]].x,J=m[s[o]].y;if(1E-10>(A-v)*(J-u)-(x-u)*(B-v))m=false;else{for(t=0;t<r;t++)if(!(t==q||t==p||t==o)){var y=m[s[t]].x,I=m[s[t]].y,F=void 0,H=void 0,G=void 0,M=void 0,D=void 0,K=void 0,P=void 0,L=void 0,N=void 0,X=void 0,O=void 0,C=void 0,F=G=D=void 0,F=B-A,H=J-x,G=v-B,M=u-J,D=A-v,K=x-u,P=y-v,L=I-u,N=y-A,X=I-x,O=y-B,C=I-J,F=F*X-H*N,D=D*L-K*P,G=G*C-M*O;if(F>=0&&G>=0&&D>=0){m=false;break a}}m=true}}if(m){e.push([a[g[i]],
...
this.domElement.addEventListener("mousemove",function(a){if(c.enabled){if(f){h=i=c.getMouseProjectionOnBall(a.clientX,a.clientY);j=l=c.getMouseOnScreen(a.clientX,a.clientY);n=m=c.getMouseOnScreen(a.clientX,a.clientY);f=false}e!==-1&&(e===0&&!c.noRotate?i=c.getMouseProjectionOnBall(a.clientX,a.clientY):e===1&&!c.noZoom?l=c.getMouseOnScreen(a.clientX,a.clientY):e===2&&!c.noPan&&(m=c.getMouseOnScreen(a.clientX,a.clientY)))}},false);this.domElement.addEventListener("mousedown",function(a){if(c.enabled){a.preventDefault();
a.stopPropagation();if(e===-1){e=a.button;e===0&&!c.noRotate?h=i=c.getMouseProjectionOnBall(a.clientX,a.clientY):e===1&&!c.noZoom?j=l=c.getMouseOnScreen(a.clientX,a.clientY):this.noPan||(n=m=c.getMouseOnScreen(a.clientX,a.clientY))}}},false);this.domElement.addEventListener("mouseup",function(a){if(c.enabled){a.preventDefault();a.stopPropagation();e=-1}},false);window.addEventListener("keydown",function(a){if(c.enabled&&e===-1){a.keyCode===c.keys[0]&&!c.noRotate?e=0:a.keyCode===c.keys[1]&&!c.noZoom?
...
THREE.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*e.autoRotateSpeed}function d(a){a.preventDefault();if(t===s.ROTATE){i.set(a.clientX,a.clientY);j.sub(i,h);e.rotateLeft(2*Math.PI*j.x/g*e.userRotateSpeed);e.rotateUp(2*Math.PI*j.y/g*e.userRotateSpeed);h.copy(i)}else if(t===s.ZOOM){n.set(a.clientX,a.clientY);m.sub(n,l);m.y>0?e.zoomIn():e.zoomOut();l.copy(n)}}function f(){if(e.userRotate){document.removeEventListener("mousemove",d,false);document.removeEventListener("mouseup",f,false);
t=s.NONE}}THREE.EventTarget.call(this);this.object=a;this.domElement=b!==void 0?b:document;this.center=new THREE.Vector3;this.userZoom=true;this.userZoomSpeed=1;this.userRotate=true;this.userRotateSpeed=1;this.autoRotate=false;this.autoRotateSpeed=2;var e=this,g=1800,h=new THREE.Vector2,i=new THREE.Vector2,j=new THREE.Vector2,l=new THREE.Vector2,n=new THREE.Vector2,m=new THREE.Vector2,q=0,p=0,o=1,r=new THREE.Vector3,s={NONE:-1,ROTATE:0,ZOOM:1},t=s.NONE,v={type:"change"};this.rotateLeft=function(a){a===
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function i(a,b,c,g,h,i,l,m){var n,o=d||1,p=f||1,q=h/2,r=i/2,s=j.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=e||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=e||1}var t=o+1,v=p+1,X=h/o,O=i/p,C=new THREE.Vector3;C[n]=l>0?1:-1;for(h=0;h<v;h++)for(i=0;i<t;i++){var aa=new THREE.Vector3;aa[a]=(i*X-q)*c;aa[b]=(h*O-r)*g;aa[n]=l;j.vertices.push(aa)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
t*h+s,i+t*(h+1)+s,i+1+t*(h+1)+s,i+1+t*h+s);a.normal.copy(C);a.vertexNormals.push(C.clone(),C.clone(),C.clone(),C.clone());a.materialIndex=m;j.faces.push(a);j.faceVertexUvs[0].push([new THREE.UV(i/o,1-h/p),new THREE.UV(i/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-h/p)])}}THREE.Geometry.call(this);var j=this,l=a/2,n=b/2,m=c/2,q,p,o,r,s,t;if(g!==void 0){if(g instanceof Array)this.materials=g;else{this.materials=[];for(q=0;q<6;q++)this.materials.push(g)}q=0;r=1;p=2;s=3;o=4;t=
5}else this.materials=[];this.sides={px:true,nx:true,py:true,ny:true,pz:true,nz:true};if(h!=void 0)for(var v in h)this.sides[v]!==void 0&&(this.sides[v]=h[v]);this.sides.px&&i("z","y",-1,-1,c,b,l,q);this.sides.nx&&i("z","y",1,-1,c,b,-l,r);this.sides.py&&i("x","z",1,1,a,c,n,p);this.sides.ny&&i("x","z",1,-1,a,c,-n,s);this.sides.pz&&i("x","y",1,-1,a,b,m,o);this.sides.nz&&i("x","y",-1,-1,a,b,-m,t);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
this.vertices[j[0][h+1]].clone()}else{n=this.vertices[j[1][h]].clone();m=this.vertices[j[1][h+1]].clone()}n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<f;i++){var q=j[i][h],p=j[i+1][h],o=j[i+1][h+1],r=j[i][h+1],s=n.clone(),t=n.clone(),v=m.clone(),u=m.clone(),A=l[i][h].clone(),x=l[i+1][h].clone(),B=l[i+1][h+1].clone(),J=l[i][h+1].clone();this.faces.push(new THREE.Face4(q,p,o,r,[s,t,v,u]));this.faceVertexUvs[0].push([A,x,B,J])}}if(!e&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){q=j[0][h];p=j[0][h+1];o=this.vertices.length-1;s=new THREE.Vector3(0,1,0);t=new THREE.Vector3(0,1,0);v=new THREE.Vector3(0,1,0);A=l[0][h].clone();x=l[0][h+1].clone();B=new THREE.UV(x.u,0);this.faces.push(new THREE.Face3(q,p,o,[s,t,v]));this.faceVertexUvs[0].push([A,x,B])}}if(!e&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){q=j[i][h+1];p=j[i][h];o=this.vertices.length-1;s=new THREE.Vector3(0,-1,0);t=new THREE.Vector3(0,
-1,0);v=new THREE.Vector3(0,-1,0);A=l[i][h+1].clone();x=l[i][h].clone();B=new THREE.UV(x.u,1);this.faces.push(new THREE.Face3(q,p,o,[s,t,v]));this.faceVertexUvs[0].push([A,x,B])}}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
h.copy(b).addSelf(f);i.copy(c).addSelf(g);f=d.dot(g);g=i.subSelf(h).dot(g);if(f===0){console.log("Either infinite or no solutions!");g===0?console.log("Its finite solutions."):console.log("Too bad, no solutions.")}g=g/f;if(g<0){b=Math.atan2(b.y-a.y,b.x-a.x);a=Math.atan2(c.y-a.y,c.x-a.x);b>a&&(a=a+Math.PI*2);c=(b+a)/2;a=-Math.cos(c);c=-Math.sin(c);return new THREE.Vector2(a,c)}return d.multiplyScalar(g).addSelf(h).subSelf(a).clone()}function f(c,d){var e,f;for(C=c.length;--C>=0;){e=C;f=C-1;f<0&&(f=
c.length-1);for(var g=0,h=m+l*2,g=0;g<h;g++){var i=N*g,j=N*(g+1),n=d+e+i,i=d+f+i,o=d+f+j,j=d+e+j,p=c,q=g,r=h,u=e,v=f,n=n+F,i=i+F,o=o+F,j=j+F;I.faces.push(new THREE.Face4(n,i,o,j,null,null,s));n=t.generateSideWallUV(I,a,p,b,n,i,o,j,q,r,u,v);I.faceVertexUvs[0].push(n)}}}function e(a,b,c){I.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+F;d=d+F;e=e+F;I.faces.push(new THREE.Face3(c,d,e,null,null,r));c=f?t.generateBottomUV(I,a,b,c,d,e):t.generateTopUV(I,a,b,c,d,e);I.faceVertexUvs[0].push(c)}
var h=b.amount!==void 0?b.amount:100,i=b.bevelThickness!==void 0?b.bevelThickness:6,j=b.bevelSize!==void 0?b.bevelSize:i-2,l=b.bevelSegments!==void 0?b.bevelSegments:3,n=b.bevelEnabled!==void 0?b.bevelEnabled:true,m=b.steps!==void 0?b.steps:1,q=b.extrudePath,p,o=false,r=b.material,s=b.extrudeMaterial,t=b.UVGenerator!==void 0?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,v,u,A,x;if(q){p=q.getSpacedPoints(m);o=true;n=false;v=b.frames!==void 0?b.frames:new THREE.TubeGeometry.FrenetFrames(q,m,
false);u=new THREE.Vector3;A=new THREE.Vector3;x=new THREE.Vector3}if(!n)j=i=l=0;var B,J,y,I=this,F=this.vertices.length,q=a.extractPoints(),H=q.shape,q=q.holes,G=!THREE.Shape.Utils.isClockWise(H);if(G){H=H.reverse();J=0;for(y=q.length;J<y;J++){B=q[J];THREE.Shape.Utils.isClockWise(B)&&(q[J]=B.reverse())}G=false}var M=THREE.Shape.Utils.triangulateShape(H,q),G=H;J=0;for(y=q.length;J<y;J++){B=q[J];H=H.concat(B)}var D,K,P,L,N=H.length,X=M.length,O=[],C=0,aa=G.length;D=aa-1;for(K=C+1;C<aa;C++,D++,K++){D===
aa&&(D=0);K===aa&&(K=0);O[C]=d(G[C],G[D],G[K])}var wa=[],ka,Ba=O.concat();J=0;for(y=q.length;J<y;J++){B=q[J];ka=[];C=0;aa=B.length;D=aa-1;for(K=C+1;C<aa;C++,D++,K++){D===aa&&(D=0);K===aa&&(K=0);ka[C]=d(B[C],B[D],B[K])}wa.push(ka);Ba=Ba.concat(ka)}for(D=0;D<l;D++){B=D/l;P=i*(1-B);K=j*Math.sin(B*Math.PI/2);C=0;for(aa=G.length;C<aa;C++){L=c(G[C],O[C],K);e(L.x,L.y,-P)}J=0;for(y=q.length;J<y;J++){B=q[J];ka=wa[J];C=0;for(aa=B.length;C<aa;C++){L=c(B[C],ka[C],K);e(L.x,L.y,-P)}}}K=j;for(C=0;C<N;C++){L=n?c(H[C],
Ba[C],K):H[C];if(o){A.copy(v.normals[0]).multiplyScalar(L.x);u.copy(v.binormals[0]).multiplyScalar(L.y);x.copy(p[0]).addSelf(A).addSelf(u);e(x.x,x.y,x.z)}else e(L.x,L.y,0)}for(B=1;B<=m;B++)for(C=0;C<N;C++){L=n?c(H[C],Ba[C],K):H[C];if(o){A.copy(v.normals[B]).multiplyScalar(L.x);u.copy(v.binormals[B]).multiplyScalar(L.y);x.copy(p[B]).addSelf(A).addSelf(u);e(x.x,x.y,x.z)}else e(L.x,L.y,h/m*B)}for(D=l-1;D>=0;D--){B=D/l;P=i*(1-B);K=j*Math.sin(B*Math.PI/2);C=0;for(aa=G.length;C<aa;C++){L=c(G[C],O[C],K);
e(L.x,L.y,h+P)}J=0;for(y=q.length;J<y;J++){B=q[J];ka=wa[J];C=0;for(aa=B.length;C<aa;C++){L=c(B[C],ka[C],K);o?e(L.x,L.y+p[m-1].y,p[m-1].x+P):e(L.x,L.y,h+P)}}}if(n){i=N*0;for(C=0;C<X;C++){h=M[C];g(h[2]+i,h[1]+i,h[0]+i,true)}i=N*(m+l*2);for(C=0;C<X;C++){h=M[C];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(C=0;C<X;C++){h=M[C];g(h[2],h[1],h[0],true)}for(C=0;C<X;C++){h=M[C];g(h[0]+N*m,h[1]+N*m,h[2]+N*m,false)}}h=0;f(G,h);h=h+G.length;J=0;for(y=q.length;J<y;J++){B=q[J];f(B,h);h=h+B.length}};
...
1-p))}j.push(n);l.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=j[i][h+1],f=j[i][h],e=j[i+1][h],g=j[i+1][h+1],n=this.vertices[d].clone().normalize(),m=this.vertices[f].clone().normalize(),q=this.vertices[e].clone().normalize(),p=this.vertices[g].clone().normalize(),o=l[i][h+1].clone(),r=l[i][h].clone(),s=l[i+1][h].clone(),t=l[i+1][h+1].clone();if(Math.abs(this.vertices[d].y)==a){this.faces.push(new THREE.Face3(d,e,g,[n,q,p]));this.faceVertexUvs[0].push([o,s,t])}else if(Math.abs(this.vertices[e].y)==
a){this.faces.push(new THREE.Face3(d,f,e,[n,m,q]));this.faceVertexUvs[0].push([o,r,s])}else{this.faces.push(new THREE.Face4(d,f,e,g,[n,m,q,p]));this.faceVertexUvs[0].push([o,r,s,t])}}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:a}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.SubdivisionModifier.prototype.smooth=function(a){function b(){l.debug&&console.log.apply(console,arguments)}function c(){console&&console.log.apply(console,arguments)}function d(a,c,d,f,g,h,n){var m=new THREE.Face4(a,c,d,f,null,g.color,g.materialIndex);if(l.useOldVertexColors){m.vertexColors=[];for(var o,p,q,r=0;r<4;r++){q=h[r];o=new THREE.Color;o.setRGB(0,0,0);for(var s=0;s<q.length;s++){p=g.vertexColors[q[s]-1];o.r=o.r+p.r;o.g=o.g+p.g;o.b=o.b+p.b}o.r=o.r/q.length;o.g=o.g/q.length;o.b=o.b/
q.length;m.vertexColors[r]=o}}i.push(m);if(l.supportUVs){g=[e(a,""),e(c,n),e(d,n),e(f,n)];g[0]?g[1]?g[2]?g[3]?j.push(g):b("d :( ",f+":"+n):b("c :( ",d+":"+n):b("b :( ",c+":"+n):b("a :( ",a+":"+n)}}function f(a,b){return Math.min(a,b)+"_"+Math.max(a,b)}function e(a,d){var e=a+":"+d,f=r[e];if(!f){a>=s&&a<s+m.length?b("face pt"):b("edge pt");c("warning, UV not found for",e);return null}return f}function g(a,b,d){var e=a+":"+b;e in r?c("dup vertexNo",a,"oldFaceNo",b,"value",d,"key",e,r[e]):r[e]=d}var h=
[],i=[],j=[],l=this,n=a.vertices,m=a.faces,h=n.concat(),q=[],p={},o={},r={},s=n.length,t,v,u,A,x,B=a.faceVertexUvs[0];b("originalFaces, uvs, originalVerticesLength",m.length,B.length,s);if(l.supportUVs){t=0;for(v=B.length;t<v;t++){u=0;for(A=B[t].length;u<A;u++){x=m[t]["abcd".charAt(u)];g(x,t,B[t][u])}}}if(B.length==0)l.supportUVs=false;t=0;for(var J in r)t++;if(!t){l.supportUVs=false;b("no uvs")}b("-- Original Faces + Vertices UVs completed",r,"vs",B.length);var y;t=0;for(v=m.length;t<v;t++){x=m[t];
q.push(x.centroid);h.push(x.centroid);if(l.supportUVs){y=new THREE.UV;if(x instanceof THREE.Face3){y.u=e(x.a,t).u+e(x.b,t).u+e(x.c,t).u;y.v=e(x.a,t).v+e(x.b,t).v+e(x.c,t).v;y.u=y.u/3;y.v=y.v/3}else if(x instanceof THREE.Face4){y.u=e(x.a,t).u+e(x.b,t).u+e(x.c,t).u+e(x.d,t).u;y.v=e(x.a,t).v+e(x.b,t).v+e(x.c,t).v+e(x.d,t).v;y.u=y.u/4;y.v=y.v/4}g(s+t,"",y)}}b("-- added UVs for new Faces",r);J=function(a,b){I[a]===void 0&&(I[a]=[]);I[a].push(b)};var I={},B=0;for(v=a.faces.length;B<v;B++){x=a.faces[B];
if(x instanceof THREE.Face3){y=f(x.a,x.b);J(y,B);y=f(x.b,x.c);J(y,B);y=f(x.c,x.a);J(y,B)}else if(x instanceof THREE.Face4){y=f(x.a,x.b);J(y,B);y=f(x.b,x.c);J(y,B);y=f(x.c,x.d);J(y,B);y=f(x.d,x.a);J(y,B)}}v=I;var F=0,H,G;J={};B={};for(t in v){y=v[t];H=t.split("_");G=H[0];H=H[1];u=G;x=[G,H];J[u]===void 0&&(J[u]=[]);J[u].push(x);u=H;x=[G,H];J[u]===void 0&&(J[u]=[]);J[u].push(x);u=0;for(A=y.length;u<A;u++){x=y[u];var M=G,D=x,K=t;B[M]===void 0&&(B[M]={});B[M][D]=K;M=H;D=t;B[M]===void 0&&(B[M]={});B[M][x]=
D}y.length<2&&(o[t]=true)}b("vertexEdgeMap",J,"vertexFaceMap",B);for(t in v){y=v[t];x=y[0];A=y[1];H=t.split("_");G=H[0];H=H[1];y=new THREE.Vector3;if(o[t]){y.addSelf(n[G]);y.addSelf(n[H]);y.multiplyScalar(0.5)}else{y.addSelf(q[x]);y.addSelf(q[A]);y.addSelf(n[G]);y.addSelf(n[H]);y.multiplyScalar(0.25)}p[t]=s+m.length+F;h.push(y);F++;if(l.supportUVs){y=new THREE.UV;y.u=e(G,x).u+e(H,x).u;y.v=e(G,x).v+e(H,x).v;y.u=y.u/2;y.v=y.v/2;g(p[t],x,y);if(!o[t]){y=new THREE.UV;y.u=e(G,A).u+e(H,A).u;y.v=e(G,A).v+
e(H,A).v;y.u=y.u/2;y.v=y.v/2;g(p[t],A,y)}}}b("-- Step 2 done");var P,L;H=["123","12","2","23"];A=["123","23","3","31"];var M=["123","31","1","12"],D=["1234","12","2","23"],K=["1234","23","3","34"],N=["1234","34","4","41"],X=["1234","41","1","12"];t=0;for(v=q.length;t<v;t++){x=m[t];y=s+t;if(x instanceof THREE.Face3){F=f(x.a,x.b);G=f(x.b,x.c);P=f(x.c,x.a);d(y,p[F],x.b,p[G],x,H,t);d(y,p[G],x.c,p[P],x,A,t);d(y,p[P],x.a,p[F],x,M,t)}else if(x instanceof THREE.Face4){F=f(x.a,x.b);G=f(x.b,x.c);P=f(x.c,x.d);
L=f(x.d,x.a);d(y,p[F],x.b,p[G],x,D,t);d(y,p[G],x.c,p[P],x,K,t);d(y,p[P],x.d,p[L],x,N,t);d(y,p[L],x.a,p[F],x,X,t)}else b("face should be a face!",x)}p=new THREE.Vector3;x=new THREE.Vector3;t=0;for(v=n.length;t<v;t++)if(J[t]!==void 0){p.set(0,0,0);x.set(0,0,0);G=new THREE.Vector3(0,0,0);y=0;for(u in B[t]){p.addSelf(q[u]);y++}H=0;F=J[t].length;for(u=0;u<F;u++)o[f(J[t][u][0],J[t][u][1])]&&H++;if(H!=2){p.divideScalar(y);for(u=0;u<F;u++){y=J[t][u];y=n[y[0]].clone().addSelf(n[y[1]]).divideScalar(2);x.addSelf(y)}x.divideScalar(F);
G.addSelf(n[t]);G.multiplyScalar(F-3);G.addSelf(p);G.addSelf(x.multiplyScalar(2));G.divideScalar(F);h[t]=G}}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=j;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);
...
"color");m.scale=b.getUniformLocation(l,"scale");m.rotation=b.getUniformLocation(l,"rotation");m.screenPosition=b.getUniformLocation(l,"screenPosition");q=false};this.render=function(a,d,f,s){var a=a.__webglFlares,t=a.length;if(t){var v=new THREE.Vector3,u=s/f,A=f*0.5,x=s*0.5,B=16/s,J=new THREE.Vector2(B*u,B),y=new THREE.Vector3(1,1,0),I=new THREE.Vector2(1,1),F=m,B=n;b.useProgram(l);if(!q){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);q=true}b.uniform1i(F.occlusionMap,0);b.uniform1i(F.map,
1);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(B.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(B.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var H,G,M,D,K;for(H=0;H<t;H++){B=16/s;J.set(B*u,B);D=a[H];v.set(D.matrixWorld.elements[12],D.matrixWorld.elements[13],D.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(v);d.projectionMatrix.multiplyVector3(v);y.copy(v);I.x=y.x*A+A;I.y=y.y*x+x;if(j||I.x>0&&I.x<f&&I.y>0&&
I.y<s){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,I.x-8,I.y-8,16,16,0);b.uniform1i(F.renderType,0);b.uniform2f(F.scale,J.x,J.y);b.uniform3f(F.screenPosition,y.x,y.y,y.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,I.x-8,I.y-8,16,16,0);b.uniform1i(F.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);
...
j.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");l=false};this.render=function(d,f,q,p){var d=d.__webglSprites,o=d.length;if(o){var r=i,s=j,t=p/q,q=q*0.5,v=p*0.5,u=true;b.useProgram(h);if(!l){b.enableVertexAttribArray(r.position);b.enableVertexAttribArray(r.uv);l=true}b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(true);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(r.position,2,b.FLOAT,false,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
g);b.uniformMatrix4fv(s.projectionMatrix,false,f._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(s.map,0);for(var A,x=[],r=0;r<o;r++){A=d[r];if(A.visible&&A.opacity!==0)if(A.useScreenCoordinates)A.z=-A.position.z;else{A._modelViewMatrix.multiply(f.matrixWorldInverse,A.matrixWorld);A.z=-A._modelViewMatrix.elements[14]}}d.sort(a);for(r=0;r<o;r++){A=d[r];if(A.visible&&A.opacity!==0&&A.map&&A.map.image&&A.map.image.width){if(A.useScreenCoordinates){b.uniform1i(s.useScreenCoordinates,1);
b.uniform3f(s.screenPosition,(A.position.x-q)/q,(v-A.position.y)/v,Math.max(0,Math.min(1,A.position.z)))}else{b.uniform1i(s.useScreenCoordinates,0);b.uniform1i(s.affectedByDistance,A.affectedByDistance?1:0);b.uniformMatrix4fv(s.modelViewMatrix,false,A._modelViewMatrix.elements)}f=A.map.image.width/(A.scaleByViewport?p:1);x[0]=f*t*A.scale.x;x[1]=f*A.scale.y;b.uniform2f(s.uvScale,A.uvScale.x,A.uvScale.y);b.uniform2f(s.uvOffset,A.uvOffset.x,A.uvOffset.y);b.uniform2f(s.alignment,A.alignment.x,A.alignment.y);
b.uniform1f(s.opacity,A.opacity);b.uniform3f(s.color,A.color.r,A.color.g,A.color.b);b.uniform1f(s.rotation,A.rotation);b.uniform2fv(s.scale,x);if(A.mergeWith3D&&!u){b.enable(b.DEPTH_TEST);u=true}else if(!A.mergeWith3D&&u){b.disable(b.DEPTH_TEST);u=false}c.setBlending(A.blending,A.blendEquation,A.blendSrc,A.blendDst);c.setTexture(A.map,0);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
