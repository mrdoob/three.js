...
value:0}},bump:{bumpMap:{type:"t",value:4,texture:null},bumpScale:{type:"f",value:1}},normalmap:{normalMap:{type:"t",value:4,texture:null},normalScale:{type:"f",value:1}},fog:{fogDensity:{type:"f",value:2.5E-4},fogNear:{type:"f",value:1},fogFar:{type:"f",value:2E3},fogColor:{type:"c",value:new THREE.Color(16777215)}},lights:{ambientLightColor:{type:"fv",value:[]},directionalLightDirection:{type:"fv",value:[]},directionalLightColor:{type:"fv",value:[]},pointLightColor:{type:"fv",value:[]},pointLightPosition:{type:"fv",
value:[]},pointLightDistance:{type:"fv1",value:[]},spotLightColor:{type:"fv",value:[]},spotLightPosition:{type:"fv",value:[]},spotLightDirection:{type:"fv",value:[]},spotLightDistance:{type:"fv1",value:[]},spotLightAngle:{type:"fv1",value:[]},spotLightExponent:{type:"fv1",value:[]}},particle:{psColor:{type:"c",value:new THREE.Color(15658734)},opacity:{type:"f",value:1},size:{type:"f",value:1},scale:{type:"f",value:1},map:{type:"t",value:0,texture:null},fogDensity:{type:"f",value:2.5E-4},fogNear:{type:"f",
value:1},fogFar:{type:"f",value:2E3},fogColor:{type:"c",value:new THREE.Color(16777215)}},shadowmap:{shadowMap:{type:"tv",value:6,texture:[]},shadowMapSize:{type:"v2v",value:[]},shadowBias:{type:"fv1",value:[]},shadowDarkness:{type:"fv1",value:[]},shadowMatrix:{type:"m4v",value:[]}}};
...
function c(a,b){if(a.material&&!(a.material instanceof THREE.MeshFaceMaterial))return a.material;if(b.materialIndex>=0)return a.geometry.materials[b.materialIndex]}function d(a){return a instanceof THREE.MeshBasicMaterial&&!a.envMap||a instanceof THREE.MeshDepthMaterial?false:a&&a.shading!==void 0&&a.shading===THREE.SmoothShading?THREE.SmoothShading:THREE.FlatShading}function f(a){return a.map||a.lightMap||a.bumpMap||a.normalMap||a.specularMap||a instanceof THREE.ShaderMaterial?true:false}function e(a,
b,c){var d,f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,n=a.__colorArray,m=a.__sortArray,o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){Ea.copy(Za);Ea.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];Ta.copy(f);Ea.multiplyVector3(Ta);m[d]=[Ta.z,d]}m.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[m[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[m[d][1]];n[e]=f.r;n[e+1]=f.g;n[e+2]=f.b}if(q){i=
0;for(j=q.length;i<j;i++){h=q[i];if(h.boundTo===void 0||h.boundTo==="vertices"){e=0;f=h.value.length;if(h.size===1)for(d=0;d<f;d++){g=m[d][1];h.array[d]=h.value[g]}else if(h.size===2)for(d=0;d<f;d++){g=m[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;e=e+2}else if(h.size===3)if(h.type==="c")for(d=0;d<f;d++){g=m[d][1];g=h.value[g];h.array[e]=g.r;h.array[e+1]=g.g;h.array[e+2]=g.b;e=e+3}else for(d=0;d<f;d++){g=m[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;h.array[e+2]=g.z;e=e+3}else if(h.size===
...
THREE.MeshBasicMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.MeshPhongMaterial){i.opacity.value=d.opacity;H.gammaInput?i.diffuse.value.copyGammaToLinear(d.color):i.diffuse.value=d.color;i.map.texture=d.map;i.lightMap.texture=d.lightMap;i.specularMap.texture=d.specularMap;if(d.bumpMap){i.bumpMap.texture=d.bumpMap;i.bumpScale.value=d.bumpScale}if(d.normalMap){i.normalMap.texture=d.normalMap;i.normalScale.value=d.normalScale}var M;if(d.map)M=d.map;else if(d.specularMap)M=d.specularMap;
else if(d.normalMap)M=d.normalMap;else if(d.bumpMap)M=d.bumpMap;if(M!==void 0){c=M.offset;M=M.repeat;i.offsetRepeat.value.set(c.x,c.y,M.x,M.y)}i.envMap.texture=d.envMap;i.flipEnvMap.value=d.envMap instanceof THREE.WebGLRenderTargetCube?1:-1;i.reflectivity.value=d.reflectivity;i.refractionRatio.value=d.refractionRatio;i.combine.value=d.combine;i.useRefract.value=d.envMap&&d.envMap.mapping instanceof THREE.CubeRefractionMapping}if(d instanceof THREE.LineBasicMaterial){i.diffuse.value=d.color;i.opacity.value=
d.opacity}else if(d instanceof THREE.ParticleBasicMaterial){i.psColor.value=d.color;i.opacity.value=d.opacity;i.size.value=d.size;i.scale.value=v.height/2;i.map.texture=d.map}else if(d instanceof THREE.MeshPhongMaterial){i.shininess.value=d.shininess;if(H.gammaInput){i.ambient.value.copyGammaToLinear(d.ambient);i.emissive.value.copyGammaToLinear(d.emissive);i.specular.value.copyGammaToLinear(d.specular)}else{i.ambient.value=d.ambient;i.emissive.value=d.emissive;i.specular.value=d.specular}d.wrapAround&&
i.wrapRGB.value.copy(d.wrapRGB)}else if(d instanceof THREE.MeshLambertMaterial){if(H.gammaInput){i.ambient.value.copyGammaToLinear(d.ambient);i.emissive.value.copyGammaToLinear(d.emissive)}else{i.ambient.value=d.ambient;i.emissive.value=d.emissive}d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)}else if(d instanceof THREE.MeshDepthMaterial){i.mNear.value=a.near;i.mFar.value=a.far;i.opacity.value=d.opacity}else if(d instanceof THREE.MeshNormalMaterial)i.opacity.value=d.opacity;if(f.receiveShadow&&!d._shadowPass&&
i.shadowMatrix){c=M=0;for(e=b.length;c<e;c++){j=b[c];if(j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade)){i.shadowMap.texture[M]=j.shadowMap;i.shadowMapSize.value[M]=j.shadowMapSize;i.shadowMatrix.value[M]=j.shadowMatrix;i.shadowDarkness.value[M]=j.shadowDarkness;i.shadowBias.value[M]=j.shadowBias;M++}}}b=d.uniformsList;i=0;for(M=b.length;i<M;i++)if(j=g.uniforms[b[i][1]]){c=b[i][0];l=c.type;e=c.value;if(l==="i")k.uniform1i(j,e);else if(l==="f")k.uniform1f(j,
e);else if(l==="v2")k.uniform2f(j,e.x,e.y);else if(l==="v3")k.uniform3f(j,e.x,e.y,e.z);else if(l==="v4")k.uniform4f(j,e.x,e.y,e.z,e.w);else if(l==="c")k.uniform3f(j,e.r,e.g,e.b);else if(l==="iv1")k.uniform1iv(j,e);else if(l==="iv")k.uniform3iv(j,e);else if(l==="fv1")k.uniform1fv(j,e);else if(l==="fv")k.uniform3fv(j,e);else if(l==="v2v"){if(c._array===void 0)c._array=new Float32Array(2*e.length);l=0;for(n=e.length;l<n;l++){m=l*2;c._array[m]=e[l].x;c._array[m+1]=e[l].y}k.uniform2fv(j,c._array)}else if(l===
"v3v"){if(c._array===void 0)c._array=new Float32Array(3*e.length);l=0;for(n=e.length;l<n;l++){m=l*3;c._array[m]=e[l].x;c._array[m+1]=e[l].y;c._array[m+2]=e[l].z}k.uniform3fv(j,c._array)}else if(l==="v4v"){if(c._array===void 0)c._array=new Float32Array(4*e.length);l=0;for(n=e.length;l<n;l++){m=l*4;c._array[m]=e[l].x;c._array[m+1]=e[l].y;c._array[m+2]=e[l].z;c._array[m+3]=e[l].w}k.uniform4fv(j,c._array)}else if(l==="m4"){if(c._array===void 0)c._array=new Float32Array(16);e.flattenToArray(c._array);
k.uniformMatrix4fv(j,false,c._array)}else if(l==="m4v"){if(c._array===void 0)c._array=new Float32Array(16*e.length);l=0;for(n=e.length;l<n;l++)e[l].flattenToArrayOffset(c._array,l*16);k.uniformMatrix4fv(j,false,c._array)}else if(l==="t"){k.uniform1i(j,e);if(j=c.texture)if(j.image instanceof Array&&j.image.length===6){c=j;if(c.image.length===6)if(c.needsUpdate){if(!c.image.__webglTextureCube)c.image.__webglTextureCube=k.createTexture();k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,
c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);e=[];for(j=0;j<6;j++)if(H.autoScaleCubemaps){l=e;n=j;m=c.image[j];s=Nb;if(!(m.width<=s&&m.height<=s)){t=Math.max(m.width,m.height);r=Math.floor(m.width*s/t);s=Math.floor(m.height*s/t);t=document.createElement("canvas");t.width=r;t.height=s;t.getContext("2d").drawImage(m,0,0,m.width,m.height,0,0,r,s);m=t}l[n]=m}else e[j]=c.image[j];j=e[0];l=(j.width&j.width-1)===0&&(j.height&j.height-1)===0;n=C(c.format);m=C(c.type);x(k.TEXTURE_CUBE_MAP,
c,l);for(j=0;j<6;j++)k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,n,n,m,e[j]);c.generateMipmaps&&l&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=false;if(c.onUpdate)c.onUpdate()}else{k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}}else if(j instanceof THREE.WebGLRenderTargetCube){c=j;k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)}else H.setTexture(j,e)}else if(l==="tv"){if(c._array===void 0){c._array=[];l=0;for(n=
c.texture.length;l<n;l++)c._array[l]=e+l}k.uniform1iv(j,c._array);l=0;for(n=c.texture.length;l<n;l++)(j=c.texture[l])&&H.setTexture(j,c._array[l])}}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&h.cameraPosition!==null){b=a.matrixWorld.getPosition();k.uniform3f(h.cameraPosition,b.x,b.y,b.z)}(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&h.viewMatrix!==null&&k.uniformMatrix4fv(h.viewMatrix,
false,a._viewMatrixArray)}if(d.skinning)if(jc&&f.useVertexTexture){if(h.boneTexture!==null){k.uniform1i(h.boneTexture,12);H.setTexture(f.boneTexture,12)}}else h.boneGlobalMatrices!==null&&k.uniformMatrix4fv(h.boneGlobalMatrices,false,f.boneMatrices);k.uniformMatrix4fv(h.modelViewMatrix,false,f._modelViewMatrix.elements);h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,false,f._normalMatrix.elements);h.modelMatrix!==null&&k.uniformMatrix4fv(h.modelMatrix,false,f.matrixWorld.elements);return g}function s(a,
b){a._modelViewMatrix.multiply(b.matrixWorldInverse,a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function t(a,b,c){if(Sa!==a){a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL);Sa=a}if(a&&(Va!==b||Mb!==c)){k.polygonOffset(b,c);Va=b;Mb=c}}function u(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function z(a,b){var c;a==="fragment"?c=k.createShader(k.FRAGMENT_SHADER):a==="vertex"&&(c=k.createShader(k.VERTEX_SHADER));
k.shaderSource(c,b);k.compileShader(c);if(!k.getShaderParameter(c,k.COMPILE_STATUS)){console.error(k.getShaderInfoLog(c));console.error(u(b));return null}return c}function x(a,b,c){if(c){k.texParameteri(a,k.TEXTURE_WRAP_S,C(b.wrapS));k.texParameteri(a,k.TEXTURE_WRAP_T,C(b.wrapT));k.texParameteri(a,k.TEXTURE_MAG_FILTER,C(b.magFilter));k.texParameteri(a,k.TEXTURE_MIN_FILTER,C(b.minFilter))}else{k.texParameteri(a,k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE);k.texParameteri(a,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE);k.texParameteri(a,
k.TEXTURE_MAG_FILTER,B(b.magFilter));k.texParameteri(a,k.TEXTURE_MIN_FILTER,B(b.minFilter))}if(eb&&b.type!==THREE.FloatType&&(b.anisotropy>1||b.__oldAnisotropy)){k.texParameterf(a,eb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,jb));b.__oldAnisotropy=b.anisotropy}}function A(a,b){k.bindRenderbuffer(k.RENDERBUFFER,a);if(b.depthBuffer&&!b.stencilBuffer){k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_COMPONENT16,b.width,b.height);k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_ATTACHMENT,k.RENDERBUFFER,
a)}else if(b.depthBuffer&&b.stencilBuffer){k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_STENCIL,b.width,b.height);k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_STENCIL_ATTACHMENT,k.RENDERBUFFER,a)}else k.renderbufferStorage(k.RENDERBUFFER,k.RGBA4,b.width,b.height)}function B(a){return a===THREE.NearestFilter||a===THREE.NearestMipMapNearestFilter||a===THREE.NearestMipMapLinearFilter?k.NEAREST:k.LINEAR}function C(a){return a===THREE.RepeatWrapping?k.REPEAT:a===THREE.ClampToEdgeWrapping?k.CLAMP_TO_EDGE:
a===THREE.MirroredRepeatWrapping?k.MIRRORED_REPEAT:a===THREE.NearestFilter?k.NEAREST:a===THREE.NearestMipMapNearestFilter?k.NEAREST_MIPMAP_NEAREST:a===THREE.NearestMipMapLinearFilter?k.NEAREST_MIPMAP_LINEAR:a===THREE.LinearFilter?k.LINEAR:a===THREE.LinearMipMapNearestFilter?k.LINEAR_MIPMAP_NEAREST:a===THREE.LinearMipMapLinearFilter?k.LINEAR_MIPMAP_LINEAR:a===THREE.UnsignedByteType?k.UNSIGNED_BYTE:a===THREE.UnsignedShort4444Type?k.UNSIGNED_SHORT_4_4_4_4:a===THREE.UnsignedShort5551Type?k.UNSIGNED_SHORT_5_5_5_1:
a===THREE.UnsignedShort565Type?k.UNSIGNED_SHORT_5_6_5:a===THREE.ByteType?k.BYTE:a===THREE.ShortType?k.SHORT:a===THREE.UnsignedShortType?k.UNSIGNED_SHORT:a===THREE.IntType?k.INT:a===THREE.UnsignedIntType?k.UNSIGNED_INT:a===THREE.FloatType?k.FLOAT:a===THREE.AlphaFormat?k.ALPHA:a===THREE.RGBFormat?k.RGB:a===THREE.RGBAFormat?k.RGBA:a===THREE.LuminanceFormat?k.LUMINANCE:a===THREE.LuminanceAlphaFormat?k.LUMINANCE_ALPHA:a===THREE.AddEquation?k.FUNC_ADD:a===THREE.SubtractEquation?k.FUNC_SUBTRACT:a===THREE.ReverseSubtractEquation?
...
e,f,g,h,i,j,l,n,o,m,p=a.count*3;for(m=0;m<p;m=m+9){o=a.normalArray;d=o[m];e=o[m+1];f=o[m+2];g=o[m+3];i=o[m+4];l=o[m+5];h=o[m+6];j=o[m+7];n=o[m+8];d=(d+g+h)/3;e=(e+i+j)/3;f=(f+l+n)/3;o[m]=d;o[m+1]=e;o[m+2]=f;o[m+3]=d;o[m+4]=e;o[m+5]=f;o[m+6]=d;o[m+7]=e;o[m+8]=f}}k.bufferData(k.ARRAY_BUFFER,a.normalArray,k.DYNAMIC_DRAW);k.enableVertexAttribArray(b.attributes.normal);k.vertexAttribPointer(b.attributes.normal,3,k.FLOAT,false,0,0)}if(a.hasUvs&&c.map){k.bindBuffer(k.ARRAY_BUFFER,a.__webglUvBuffer);k.bufferData(k.ARRAY_BUFFER,
...
k.drawElements(k.TRIANGLES,e.__webglFaceCount,k.UNSIGNED_SHORT,0)}H.info.render.calls++;H.info.render.vertices=H.info.render.vertices+e.__webglFaceCount;H.info.render.faces=H.info.render.faces+e.__webglFaceCount/3}else if(f instanceof THREE.Line){f=f.type===THREE.LineStrip?k.LINE_STRIP:k.LINES;d=d.linewidth;if(d!==ub){k.lineWidth(d);ub=d}k.drawArrays(f,0,e.__webglLineCount);H.info.render.calls++}else if(f instanceof THREE.ParticleSystem){k.drawArrays(k.POINTS,0,e.__webglParticleCount);H.info.render.calls++;
H.info.render.points=H.info.render.points+e.__webglParticleCount}else if(f instanceof THREE.Ribbon){k.drawArrays(k.TRIANGLE_STRIP,0,e.__webglVertexCount);H.info.render.calls++}}};this.render=function(a,b,c,d){if(b instanceof THREE.Camera===false)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,h,n,o=a.__lights,m=a.fog;ha=-1;ta=true;this.autoUpdateScene&&a.updateMatrixWorld();b.parent===void 0&&b.updateMatrixWorld();if(!b._viewMatrixArray)b._viewMatrixArray=
new Float32Array(16);if(!b._projectionMatrixArray)b._projectionMatrixArray=new Float32Array(16);b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);Za.multiply(b.projectionMatrix,b.matrixWorldInverse);Da.setFromMatrix(Za);this.autoUpdateObjects&&this.initWebGLObjects(a);i(this.renderPluginsPre,a,b);H.info.render.calls=0;H.info.render.vertices=0;H.info.render.faces=0;H.info.render.points=
...
b,o,m,true);l(a.__webglObjectsImmediate,"transparent",b,o,m,true)}i(this.renderPluginsPost,a,b);if(c&&c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&c.minFilter!==THREE.LinearFilter)if(c instanceof THREE.WebGLRenderTargetCube){k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture);k.generateMipmap(k.TEXTURE_CUBE_MAP);k.bindTexture(k.TEXTURE_CUBE_MAP,null)}else{k.bindTexture(k.TEXTURE_2D,c.__webglTexture);k.generateMipmap(k.TEXTURE_2D);k.bindTexture(k.TEXTURE_2D,null)}this.setDepthTest(true);this.setDepthWrite(true)}};
this.renderImmediateObject=function(a,b,c,d,e){var f=r(a,b,c,d,e);ia=-1;H.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,Da):e.render(function(a){H.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){if(!a.__webglObjects){a.__webglObjects=[];a.__webglObjectsImmediate=[];a.__webglSprites=[];a.__webglFlares=[]}for(;a.__objectsAdded.length;){var g=a.__objectsAdded[0],h=a,i=void 0,j=void 0,l=void 0;if(!g.__webglInit){g.__webglInit=true;g._modelViewMatrix=new THREE.Matrix4;
g._normalMatrix=new THREE.Matrix3;if(g instanceof THREE.Mesh){j=g.geometry;if(j instanceof THREE.Geometry){if(j.geometryGroups===void 0){var r=j,s=void 0,u=void 0,t=void 0,z=void 0,v=void 0,x=void 0,A=void 0,C={},B=r.morphTargets.length,E=r.morphNormals.length;r.geometryGroups={};s=0;for(u=r.faces.length;s<u;s++){t=r.faces[s];z=t.materialIndex;x=z!==void 0?z:-1;C[x]===void 0&&(C[x]={hash:x,counter:0});A=C[x].hash+"_"+C[x].counter;r.geometryGroups[A]===void 0&&(r.geometryGroups[A]={faces3:[],faces4:[],
materialIndex:z,vertices:0,numMorphTargets:B,numMorphNormals:E});v=t instanceof THREE.Face3?3:4;if(r.geometryGroups[A].vertices+v>65535){C[x].counter=C[x].counter+1;A=C[x].hash+"_"+C[x].counter;r.geometryGroups[A]===void 0&&(r.geometryGroups[A]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:B,numMorphNormals:E})}t instanceof THREE.Face3?r.geometryGroups[A].faces3.push(s):r.geometryGroups[A].faces4.push(s);r.geometryGroups[A].vertices=r.geometryGroups[A].vertices+v}r.geometryGroupsList=
[];var I=void 0;for(I in r.geometryGroups){r.geometryGroups[I].id=Z++;r.geometryGroupsList.push(r.geometryGroups[I])}}for(i in j.geometryGroups){l=j.geometryGroups[i];if(!l.__webglVertexBuffer){var F=l;F.__webglVertexBuffer=k.createBuffer();F.__webglNormalBuffer=k.createBuffer();F.__webglTangentBuffer=k.createBuffer();F.__webglColorBuffer=k.createBuffer();F.__webglUVBuffer=k.createBuffer();F.__webglUV2Buffer=k.createBuffer();F.__webglSkinVertexABuffer=k.createBuffer();F.__webglSkinVertexBBuffer=k.createBuffer();
F.__webglSkinIndicesBuffer=k.createBuffer();F.__webglSkinWeightsBuffer=k.createBuffer();F.__webglFaceBuffer=k.createBuffer();F.__webglLineBuffer=k.createBuffer();var J=void 0,L=void 0;if(F.numMorphTargets){F.__webglMorphTargetsBuffers=[];J=0;for(L=F.numMorphTargets;J<L;J++)F.__webglMorphTargetsBuffers.push(k.createBuffer())}if(F.numMorphNormals){F.__webglMorphNormalsBuffers=[];J=0;for(L=F.numMorphNormals;J<L;J++)F.__webglMorphNormalsBuffers.push(k.createBuffer())}H.info.memory.geometries++;var G=
l,M=g,Q=M.geometry,P=G.faces3,O=G.faces4,$=P.length*3+O.length*4,R=P.length*1+O.length*2,W=P.length*3+O.length*4,ba=c(M,G),V=f(ba),ca=d(ba),ha=ba.vertexColors?ba.vertexColors:false;G.__vertexArray=new Float32Array($*3);if(ca)G.__normalArray=new Float32Array($*3);if(Q.hasTangents)G.__tangentArray=new Float32Array($*4);if(ha)G.__colorArray=new Float32Array($*3);if(V){if(Q.faceUvs.length>0||Q.faceVertexUvs.length>0)G.__uvArray=new Float32Array($*2);if(Q.faceUvs.length>1||Q.faceVertexUvs.length>1)G.__uv2Array=
new Float32Array($*2)}if(M.geometry.skinWeights.length&&M.geometry.skinIndices.length){G.__skinVertexAArray=new Float32Array($*4);G.__skinVertexBArray=new Float32Array($*4);G.__skinIndexArray=new Float32Array($*4);G.__skinWeightArray=new Float32Array($*4)}G.__faceArray=new Uint16Array(R*3);G.__lineArray=new Uint16Array(W*2);var ma=void 0,ia=void 0;if(G.numMorphTargets){G.__morphTargetsArrays=[];ma=0;for(ia=G.numMorphTargets;ma<ia;ma++)G.__morphTargetsArrays.push(new Float32Array($*3))}if(G.numMorphNormals){G.__morphNormalsArrays=
[];ma=0;for(ia=G.numMorphNormals;ma<ia;ma++)G.__morphNormalsArrays.push(new Float32Array($*3))}G.__webglFaceCount=R*3;G.__webglLineCount=W*2;if(ba.attributes){if(G.__webglCustomAttributesList===void 0)G.__webglCustomAttributesList=[];var sa=void 0;for(sa in ba.attributes){var qa=ba.attributes[sa],da={},bb;for(bb in qa)da[bb]=qa[bb];if(!da.__webglInitialized||da.createUniqueBuffers){da.__webglInitialized=true;var Ia=1;da.type==="v2"?Ia=2:da.type==="v3"?Ia=3:da.type==="v4"?Ia=4:da.type==="c"&&(Ia=3);
da.size=Ia;da.array=new Float32Array($*Ia);da.buffer=k.createBuffer();da.buffer.belongsToAttribute=sa;qa.needsUpdate=true;da.__original=qa}G.__webglCustomAttributesList.push(da)}}G.__inittedArrays=true;j.verticesNeedUpdate=true;j.morphTargetsNeedUpdate=true;j.elementsNeedUpdate=true;j.uvsNeedUpdate=true;j.normalsNeedUpdate=true;j.tangentsNeedUpdate=true;j.colorsNeedUpdate=true}}}else if(j instanceof THREE.BufferGeometry){var ta=j,Da=void 0,Ea=void 0,Sa=void 0;for(Da in ta.attributes){Sa=Da==="index"?
k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;Ea=ta.attributes[Da];Ea.buffer=k.createBuffer();k.bindBuffer(Sa,Ea.buffer);k.bufferData(Sa,Ea.array,k.STATIC_DRAW)}}}else if(g instanceof THREE.Ribbon){j=g.geometry;if(!j.__webglVertexBuffer){var La=j;La.__webglVertexBuffer=k.createBuffer();La.__webglColorBuffer=k.createBuffer();H.info.memory.geometries++;var Ka=j,Va=Ka.vertices.length;Ka.__vertexArray=new Float32Array(Va*3);Ka.__colorArray=new Float32Array(Va*3);Ka.__webglVertexCount=Va;j.verticesNeedUpdate=
true;j.colorsNeedUpdate=true}}else if(g instanceof THREE.Line){j=g.geometry;if(!j.__webglVertexBuffer){var Wa=j;Wa.__webglVertexBuffer=k.createBuffer();Wa.__webglColorBuffer=k.createBuffer();H.info.memory.geometries++;var Ta=j,hb=g,eb=Ta.vertices.length;Ta.__vertexArray=new Float32Array(eb*3);Ta.__colorArray=new Float32Array(eb*3);Ta.__webglLineCount=eb;b(Ta,hb);j.verticesNeedUpdate=true;j.colorsNeedUpdate=true}}else if(g instanceof THREE.ParticleSystem){j=g.geometry;if(!j.__webglVertexBuffer){var ub=
j;ub.__webglVertexBuffer=k.createBuffer();ub.__webglColorBuffer=k.createBuffer();H.info.geometries++;var Za=j,Ub=g,vb=Za.vertices.length;Za.__vertexArray=new Float32Array(vb*3);Za.__colorArray=new Float32Array(vb*3);Za.__sortArray=[];Za.__webglParticleCount=vb;b(Za,Ub);j.verticesNeedUpdate=true;j.colorsNeedUpdate=true}}}if(!g.__webglActive){if(g instanceof THREE.Mesh){j=g.geometry;if(j instanceof THREE.BufferGeometry)o(h.__webglObjects,j,g);else for(i in j.geometryGroups){l=j.geometryGroups[i];o(h.__webglObjects,
l,g)}}else if(g instanceof THREE.Ribbon||g instanceof THREE.Line||g instanceof THREE.ParticleSystem){j=g.geometry;o(h.__webglObjects,j,g)}else g instanceof THREE.ImmediateRenderObject||g.immediateRenderCallback?h.__webglObjectsImmediate.push({object:g,opaque:null,transparent:null}):g instanceof THREE.Sprite?h.__webglSprites.push(g):g instanceof THREE.LensFlare&&h.__webglFlares.push(g);g.__webglActive=true}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var mb=a.__objectsRemoved[0],ib=
a;mb instanceof THREE.Mesh||mb instanceof THREE.ParticleSystem||mb instanceof THREE.Ribbon||mb instanceof THREE.Line?q(ib.__webglObjects,mb):mb instanceof THREE.Sprite?n(ib.__webglSprites,mb):mb instanceof THREE.LensFlare?n(ib.__webglFlares,mb):(mb instanceof THREE.ImmediateRenderObject||mb.immediateRenderCallback)&&q(ib.__webglObjectsImmediate,mb);mb.__webglActive=false;a.__objectsRemoved.splice(0,1)}for(var Mb=0,Nb=a.__webglObjects.length;Mb<Nb;Mb++){var sb=a.__webglObjects[Mb].object,ea=sb.geometry,
jb=void 0,fb=void 0,$a=void 0;if(sb instanceof THREE.Mesh)if(ea instanceof THREE.BufferGeometry){if(ea.verticesNeedUpdate||ea.elementsNeedUpdate||ea.uvsNeedUpdate||ea.normalsNeedUpdate||ea.colorsNeedUpdate||ea.tangentsNeedUpdate){var Ob=ea,gb=k.DYNAMIC_DRAW,Cc=!ea.dynamic,vc=Ob.attributes,jc=vc.index,cd=vc.position,dd=vc.normal,ed=vc.uv,fd=vc.color,gd=vc.tangent;if(Ob.elementsNeedUpdate&&jc!==void 0){k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,jc.buffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,jc.array,gb)}if(Ob.verticesNeedUpdate&&
cd!==void 0){k.bindBuffer(k.ARRAY_BUFFER,cd.buffer);k.bufferData(k.ARRAY_BUFFER,cd.array,gb)}if(Ob.normalsNeedUpdate&&dd!==void 0){k.bindBuffer(k.ARRAY_BUFFER,dd.buffer);k.bufferData(k.ARRAY_BUFFER,dd.array,gb)}if(Ob.uvsNeedUpdate&&ed!==void 0){k.bindBuffer(k.ARRAY_BUFFER,ed.buffer);k.bufferData(k.ARRAY_BUFFER,ed.array,gb)}if(Ob.colorsNeedUpdate&&fd!==void 0){k.bindBuffer(k.ARRAY_BUFFER,fd.buffer);k.bufferData(k.ARRAY_BUFFER,fd.array,gb)}if(Ob.tangentsNeedUpdate&&gd!==void 0){k.bindBuffer(k.ARRAY_BUFFER,
gd.buffer);k.bufferData(k.ARRAY_BUFFER,gd.array,gb)}if(Cc){var qd=void 0;for(qd in Ob.attributes)delete Ob.attributes[qd].array}}ea.verticesNeedUpdate=false;ea.elementsNeedUpdate=false;ea.uvsNeedUpdate=false;ea.normalsNeedUpdate=false;ea.colorsNeedUpdate=false;ea.tangentsNeedUpdate=false}else{for(var hd=0,Cd=ea.geometryGroupsList.length;hd<Cd;hd++){jb=ea.geometryGroupsList[hd];$a=c(sb,jb);fb=$a.attributes&&m($a);if(ea.verticesNeedUpdate||ea.morphTargetsNeedUpdate||ea.elementsNeedUpdate||ea.uvsNeedUpdate||
ea.normalsNeedUpdate||ea.colorsNeedUpdate||ea.tangentsNeedUpdate||fb){var ga=jb,Dd=sb,cb=k.DYNAMIC_DRAW,Ed=!ea.dynamic,nc=$a;if(ga.__inittedArrays){var rd=d(nc),id=nc.vertexColors?nc.vertexColors:false,sd=f(nc),Oc=rd===THREE.SmoothShading,D=void 0,X=void 0,rb=void 0,N=void 0,wc=void 0,Xb=void 0,tb=void 0,Pc=void 0,Pb=void 0,xc=void 0,yc=void 0,S=void 0,T=void 0,U=void 0,ka=void 0,wb=void 0,xb=void 0,yb=void 0,Dc=void 0,zb=void 0,Ab=void 0,Bb=void 0,Ec=void 0,Cb=void 0,Db=void 0,Eb=void 0,Fc=void 0,
Fb=void 0,Gb=void 0,Hb=void 0,Gc=void 0,Ib=void 0,Jb=void 0,Kb=void 0,Hc=void 0,Yb=void 0,Zb=void 0,$b=void 0,Qc=void 0,ac=void 0,bc=void 0,cc=void 0,Rc=void 0,pa=void 0,td=void 0,dc=void 0,zc=void 0,Ac=void 0,Oa=void 0,ud=void 0,Ma=void 0,Na=void 0,ec=void 0,Qb=void 0,Fa=0,Ja=0,Rb=0,Sb=0,nb=0,Ua=0,ua=0,Xa=0,Ga=0,K=0,fa=0,y=0,ra=void 0,Pa=ga.__vertexArray,Ic=ga.__uvArray,Jc=ga.__uv2Array,ob=ga.__normalArray,xa=ga.__tangentArray,Qa=ga.__colorArray,ya=ga.__skinVertexAArray,za=ga.__skinVertexBArray,
Aa=ga.__skinIndexArray,Ba=ga.__skinWeightArray,jd=ga.__morphTargetsArrays,kd=ga.__morphNormalsArrays,ld=ga.__webglCustomAttributesList,w=void 0,Lb=ga.__faceArray,db=ga.__lineArray,Ya=Dd.geometry,Fd=Ya.elementsNeedUpdate,vd=Ya.uvsNeedUpdate,Gd=Ya.normalsNeedUpdate,Hd=Ya.tangentsNeedUpdate,Id=Ya.colorsNeedUpdate,Jd=Ya.morphTargetsNeedUpdate,oc=Ya.vertices,na=ga.faces3,oa=ga.faces4,Ha=Ya.faces,md=Ya.faceVertexUvs[0],nd=Ya.faceVertexUvs[1],pc=Ya.skinVerticesA,qc=Ya.skinVerticesB,rc=Ya.skinIndices,fc=
Ya.skinWeights,gc=Ya.morphTargets,Sc=Ya.morphNormals;if(Ya.verticesNeedUpdate){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];S=oc[N.a];T=oc[N.b];U=oc[N.c];Pa[Ja]=S.x;Pa[Ja+1]=S.y;Pa[Ja+2]=S.z;Pa[Ja+3]=T.x;Pa[Ja+4]=T.y;Pa[Ja+5]=T.z;Pa[Ja+6]=U.x;Pa[Ja+7]=U.y;Pa[Ja+8]=U.z;Ja=Ja+9}D=0;for(X=oa.length;D<X;D++){N=Ha[oa[D]];S=oc[N.a];T=oc[N.b];U=oc[N.c];ka=oc[N.d];Pa[Ja]=S.x;Pa[Ja+1]=S.y;Pa[Ja+2]=S.z;Pa[Ja+3]=T.x;Pa[Ja+4]=T.y;Pa[Ja+5]=T.z;Pa[Ja+6]=U.x;Pa[Ja+7]=U.y;Pa[Ja+8]=U.z;Pa[Ja+9]=ka.x;Pa[Ja+10]=ka.y;Pa[Ja+
11]=ka.z;Ja=Ja+12}k.bindBuffer(k.ARRAY_BUFFER,ga.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Pa,cb)}if(Jd){Oa=0;for(ud=gc.length;Oa<ud;Oa++){D=fa=0;for(X=na.length;D<X;D++){ec=na[D];N=Ha[ec];S=gc[Oa].vertices[N.a];T=gc[Oa].vertices[N.b];U=gc[Oa].vertices[N.c];Ma=jd[Oa];Ma[fa]=S.x;Ma[fa+1]=S.y;Ma[fa+2]=S.z;Ma[fa+3]=T.x;Ma[fa+4]=T.y;Ma[fa+5]=T.z;Ma[fa+6]=U.x;Ma[fa+7]=U.y;Ma[fa+8]=U.z;if(nc.morphNormals){if(Oc){Qb=Sc[Oa].vertexNormals[ec];zb=Qb.a;Ab=Qb.b;Bb=Qb.c}else Bb=Ab=zb=Sc[Oa].faceNormals[ec];
Na=kd[Oa];Na[fa]=zb.x;Na[fa+1]=zb.y;Na[fa+2]=zb.z;Na[fa+3]=Ab.x;Na[fa+4]=Ab.y;Na[fa+5]=Ab.z;Na[fa+6]=Bb.x;Na[fa+7]=Bb.y;Na[fa+8]=Bb.z}fa=fa+9}D=0;for(X=oa.length;D<X;D++){ec=oa[D];N=Ha[ec];S=gc[Oa].vertices[N.a];T=gc[Oa].vertices[N.b];U=gc[Oa].vertices[N.c];ka=gc[Oa].vertices[N.d];Ma=jd[Oa];Ma[fa]=S.x;Ma[fa+1]=S.y;Ma[fa+2]=S.z;Ma[fa+3]=T.x;Ma[fa+4]=T.y;Ma[fa+5]=T.z;Ma[fa+6]=U.x;Ma[fa+7]=U.y;Ma[fa+8]=U.z;Ma[fa+9]=ka.x;Ma[fa+10]=ka.y;Ma[fa+11]=ka.z;if(nc.morphNormals){if(Oc){Qb=Sc[Oa].vertexNormals[ec];
zb=Qb.a;Ab=Qb.b;Bb=Qb.c;Ec=Qb.d}else Ec=Bb=Ab=zb=Sc[Oa].faceNormals[ec];Na=kd[Oa];Na[fa]=zb.x;Na[fa+1]=zb.y;Na[fa+2]=zb.z;Na[fa+3]=Ab.x;Na[fa+4]=Ab.y;Na[fa+5]=Ab.z;Na[fa+6]=Bb.x;Na[fa+7]=Bb.y;Na[fa+8]=Bb.z;Na[fa+9]=Ec.x;Na[fa+10]=Ec.y;Na[fa+11]=Ec.z}fa=fa+12}k.bindBuffer(k.ARRAY_BUFFER,ga.__webglMorphTargetsBuffers[Oa]);k.bufferData(k.ARRAY_BUFFER,jd[Oa],cb);if(nc.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,ga.__webglMorphNormalsBuffers[Oa]);k.bufferData(k.ARRAY_BUFFER,kd[Oa],cb)}}}if(fc.length){D=
0;for(X=na.length;D<X;D++){N=Ha[na[D]];Fb=fc[N.a];Gb=fc[N.b];Hb=fc[N.c];Ba[K]=Fb.x;Ba[K+1]=Fb.y;Ba[K+2]=Fb.z;Ba[K+3]=Fb.w;Ba[K+4]=Gb.x;Ba[K+5]=Gb.y;Ba[K+6]=Gb.z;Ba[K+7]=Gb.w;Ba[K+8]=Hb.x;Ba[K+9]=Hb.y;Ba[K+10]=Hb.z;Ba[K+11]=Hb.w;Ib=rc[N.a];Jb=rc[N.b];Kb=rc[N.c];Aa[K]=Ib.x;Aa[K+1]=Ib.y;Aa[K+2]=Ib.z;Aa[K+3]=Ib.w;Aa[K+4]=Jb.x;Aa[K+5]=Jb.y;Aa[K+6]=Jb.z;Aa[K+7]=Jb.w;Aa[K+8]=Kb.x;Aa[K+9]=Kb.y;Aa[K+10]=Kb.z;Aa[K+11]=Kb.w;Yb=pc[N.a];Zb=pc[N.b];$b=pc[N.c];ya[K]=Yb.x;ya[K+1]=Yb.y;ya[K+2]=Yb.z;ya[K+3]=1;ya[K+
4]=Zb.x;ya[K+5]=Zb.y;ya[K+6]=Zb.z;ya[K+7]=1;ya[K+8]=$b.x;ya[K+9]=$b.y;ya[K+10]=$b.z;ya[K+11]=1;ac=qc[N.a];bc=qc[N.b];cc=qc[N.c];za[K]=ac.x;za[K+1]=ac.y;za[K+2]=ac.z;za[K+3]=1;za[K+4]=bc.x;za[K+5]=bc.y;za[K+6]=bc.z;za[K+7]=1;za[K+8]=cc.x;za[K+9]=cc.y;za[K+10]=cc.z;za[K+11]=1;K=K+12}D=0;for(X=oa.length;D<X;D++){N=Ha[oa[D]];Fb=fc[N.a];Gb=fc[N.b];Hb=fc[N.c];Gc=fc[N.d];Ba[K]=Fb.x;Ba[K+1]=Fb.y;Ba[K+2]=Fb.z;Ba[K+3]=Fb.w;Ba[K+4]=Gb.x;Ba[K+5]=Gb.y;Ba[K+6]=Gb.z;Ba[K+7]=Gb.w;Ba[K+8]=Hb.x;Ba[K+9]=Hb.y;Ba[K+10]=
Hb.z;Ba[K+11]=Hb.w;Ba[K+12]=Gc.x;Ba[K+13]=Gc.y;Ba[K+14]=Gc.z;Ba[K+15]=Gc.w;Ib=rc[N.a];Jb=rc[N.b];Kb=rc[N.c];Hc=rc[N.d];Aa[K]=Ib.x;Aa[K+1]=Ib.y;Aa[K+2]=Ib.z;Aa[K+3]=Ib.w;Aa[K+4]=Jb.x;Aa[K+5]=Jb.y;Aa[K+6]=Jb.z;Aa[K+7]=Jb.w;Aa[K+8]=Kb.x;Aa[K+9]=Kb.y;Aa[K+10]=Kb.z;Aa[K+11]=Kb.w;Aa[K+12]=Hc.x;Aa[K+13]=Hc.y;Aa[K+14]=Hc.z;Aa[K+15]=Hc.w;Yb=pc[N.a];Zb=pc[N.b];$b=pc[N.c];Qc=pc[N.d];ya[K]=Yb.x;ya[K+1]=Yb.y;ya[K+2]=Yb.z;ya[K+3]=1;ya[K+4]=Zb.x;ya[K+5]=Zb.y;ya[K+6]=Zb.z;ya[K+7]=1;ya[K+8]=$b.x;ya[K+9]=$b.y;ya[K+
10]=$b.z;ya[K+11]=1;ya[K+12]=Qc.x;ya[K+13]=Qc.y;ya[K+14]=Qc.z;ya[K+15]=1;ac=qc[N.a];bc=qc[N.b];cc=qc[N.c];Rc=qc[N.d];za[K]=ac.x;za[K+1]=ac.y;za[K+2]=ac.z;za[K+3]=1;za[K+4]=bc.x;za[K+5]=bc.y;za[K+6]=bc.z;za[K+7]=1;za[K+8]=cc.x;za[K+9]=cc.y;za[K+10]=cc.z;za[K+11]=1;za[K+12]=Rc.x;za[K+13]=Rc.y;za[K+14]=Rc.z;za[K+15]=1;K=K+16}if(K>0){k.bindBuffer(k.ARRAY_BUFFER,ga.__webglSkinVertexABuffer);k.bufferData(k.ARRAY_BUFFER,ya,cb);k.bindBuffer(k.ARRAY_BUFFER,ga.__webglSkinVertexBBuffer);k.bufferData(k.ARRAY_BUFFER,
za,cb);k.bindBuffer(k.ARRAY_BUFFER,ga.__webglSkinIndicesBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,cb);k.bindBuffer(k.ARRAY_BUFFER,ga.__webglSkinWeightsBuffer);k.bufferData(k.ARRAY_BUFFER,Ba,cb)}}if(Id&&id){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];tb=N.vertexColors;Pc=N.color;if(tb.length===3&&id===THREE.VertexColors){Cb=tb[0];Db=tb[1];Eb=tb[2]}else Eb=Db=Cb=Pc;Qa[Ga]=Cb.r;Qa[Ga+1]=Cb.g;Qa[Ga+2]=Cb.b;Qa[Ga+3]=Db.r;Qa[Ga+4]=Db.g;Qa[Ga+5]=Db.b;Qa[Ga+6]=Eb.r;Qa[Ga+7]=Eb.g;Qa[Ga+8]=Eb.b;Ga=Ga+9}D=0;for(X=
oa.length;D<X;D++){N=Ha[oa[D]];tb=N.vertexColors;Pc=N.color;if(tb.length===4&&id===THREE.VertexColors){Cb=tb[0];Db=tb[1];Eb=tb[2];Fc=tb[3]}else Fc=Eb=Db=Cb=Pc;Qa[Ga]=Cb.r;Qa[Ga+1]=Cb.g;Qa[Ga+2]=Cb.b;Qa[Ga+3]=Db.r;Qa[Ga+4]=Db.g;Qa[Ga+5]=Db.b;Qa[Ga+6]=Eb.r;Qa[Ga+7]=Eb.g;Qa[Ga+8]=Eb.b;Qa[Ga+9]=Fc.r;Qa[Ga+10]=Fc.g;Qa[Ga+11]=Fc.b;Ga=Ga+12}if(Ga>0){k.bindBuffer(k.ARRAY_BUFFER,ga.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Qa,cb)}}if(Hd&&Ya.hasTangents){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];Pb=N.vertexTangents;
wb=Pb[0];xb=Pb[1];yb=Pb[2];xa[ua]=wb.x;xa[ua+1]=wb.y;xa[ua+2]=wb.z;xa[ua+3]=wb.w;xa[ua+4]=xb.x;xa[ua+5]=xb.y;xa[ua+6]=xb.z;xa[ua+7]=xb.w;xa[ua+8]=yb.x;xa[ua+9]=yb.y;xa[ua+10]=yb.z;xa[ua+11]=yb.w;ua=ua+12}D=0;for(X=oa.length;D<X;D++){N=Ha[oa[D]];Pb=N.vertexTangents;wb=Pb[0];xb=Pb[1];yb=Pb[2];Dc=Pb[3];xa[ua]=wb.x;xa[ua+1]=wb.y;xa[ua+2]=wb.z;xa[ua+3]=wb.w;xa[ua+4]=xb.x;xa[ua+5]=xb.y;xa[ua+6]=xb.z;xa[ua+7]=xb.w;xa[ua+8]=yb.x;xa[ua+9]=yb.y;xa[ua+10]=yb.z;xa[ua+11]=yb.w;xa[ua+12]=Dc.x;xa[ua+13]=Dc.y;xa[ua+
14]=Dc.z;xa[ua+15]=Dc.w;ua=ua+16}k.bindBuffer(k.ARRAY_BUFFER,ga.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,xa,cb)}if(Gd&&rd){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];wc=N.vertexNormals;Xb=N.normal;if(wc.length===3&&Oc)for(pa=0;pa<3;pa++){dc=wc[pa];ob[Ua]=dc.x;ob[Ua+1]=dc.y;ob[Ua+2]=dc.z;Ua=Ua+3}else for(pa=0;pa<3;pa++){ob[Ua]=Xb.x;ob[Ua+1]=Xb.y;ob[Ua+2]=Xb.z;Ua=Ua+3}}D=0;for(X=oa.length;D<X;D++){N=Ha[oa[D]];wc=N.vertexNormals;Xb=N.normal;if(wc.length===4&&Oc)for(pa=0;pa<4;pa++){dc=wc[pa];ob[Ua]=
dc.x;ob[Ua+1]=dc.y;ob[Ua+2]=dc.z;Ua=Ua+3}else for(pa=0;pa<4;pa++){ob[Ua]=Xb.x;ob[Ua+1]=Xb.y;ob[Ua+2]=Xb.z;Ua=Ua+3}}k.bindBuffer(k.ARRAY_BUFFER,ga.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,ob,cb)}if(vd&&md&&sd){D=0;for(X=na.length;D<X;D++){rb=na[D];N=Ha[rb];xc=md[rb];if(xc!==void 0)for(pa=0;pa<3;pa++){zc=xc[pa];Ic[Rb]=zc.u;Ic[Rb+1]=zc.v;Rb=Rb+2}}D=0;for(X=oa.length;D<X;D++){rb=oa[D];N=Ha[rb];xc=md[rb];if(xc!==void 0)for(pa=0;pa<4;pa++){zc=xc[pa];Ic[Rb]=zc.u;Ic[Rb+1]=zc.v;Rb=Rb+2}}if(Rb>0){k.bindBuffer(k.ARRAY_BUFFER,
ga.__webglUVBuffer);k.bufferData(k.ARRAY_BUFFER,Ic,cb)}}if(vd&&nd&&sd){D=0;for(X=na.length;D<X;D++){rb=na[D];N=Ha[rb];yc=nd[rb];if(yc!==void 0)for(pa=0;pa<3;pa++){Ac=yc[pa];Jc[Sb]=Ac.u;Jc[Sb+1]=Ac.v;Sb=Sb+2}}D=0;for(X=oa.length;D<X;D++){rb=oa[D];N=Ha[rb];yc=nd[rb];if(yc!==void 0)for(pa=0;pa<4;pa++){Ac=yc[pa];Jc[Sb]=Ac.u;Jc[Sb+1]=Ac.v;Sb=Sb+2}}if(Sb>0){k.bindBuffer(k.ARRAY_BUFFER,ga.__webglUV2Buffer);k.bufferData(k.ARRAY_BUFFER,Jc,cb)}}if(Fd){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];Lb[nb]=Fa;Lb[nb+
1]=Fa+1;Lb[nb+2]=Fa+2;nb=nb+3;db[Xa]=Fa;db[Xa+1]=Fa+1;db[Xa+2]=Fa;db[Xa+3]=Fa+2;db[Xa+4]=Fa+1;db[Xa+5]=Fa+2;Xa=Xa+6;Fa=Fa+3}D=0;for(X=oa.length;D<X;D++){N=Ha[oa[D]];Lb[nb]=Fa;Lb[nb+1]=Fa+1;Lb[nb+2]=Fa+3;Lb[nb+3]=Fa+1;Lb[nb+4]=Fa+2;Lb[nb+5]=Fa+3;nb=nb+6;db[Xa]=Fa;db[Xa+1]=Fa+1;db[Xa+2]=Fa;db[Xa+3]=Fa+3;db[Xa+4]=Fa+1;db[Xa+5]=Fa+2;db[Xa+6]=Fa+2;db[Xa+7]=Fa+3;Xa=Xa+8;Fa=Fa+4}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ga.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Lb,cb);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,
ga.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,db,cb)}if(ld){pa=0;for(td=ld.length;pa<td;pa++){w=ld[pa];if(w.__original.needsUpdate){y=0;if(w.size===1)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];w.array[y]=w.value[N.a];w.array[y+1]=w.value[N.b];w.array[y+2]=w.value[N.c];y=y+3}D=0;for(X=oa.length;D<X;D++){N=Ha[oa[D]];w.array[y]=w.value[N.a];w.array[y+1]=w.value[N.b];w.array[y+2]=w.value[N.c];w.array[y+3]=w.value[N.d];y=y+4}}else{if(w.boundTo===
"faces"){D=0;for(X=na.length;D<X;D++){ra=w.value[na[D]];w.array[y]=ra;w.array[y+1]=ra;w.array[y+2]=ra;y=y+3}D=0;for(X=oa.length;D<X;D++){ra=w.value[oa[D]];w.array[y]=ra;w.array[y+1]=ra;w.array[y+2]=ra;w.array[y+3]=ra;y=y+4}}}else if(w.size===2)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];S=w.value[N.a];T=w.value[N.b];U=w.value[N.c];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=T.x;w.array[y+3]=T.y;w.array[y+4]=U.x;w.array[y+5]=U.y;y=y+6}D=0;for(X=oa.length;D<
X;D++){N=Ha[oa[D]];S=w.value[N.a];T=w.value[N.b];U=w.value[N.c];ka=w.value[N.d];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=T.x;w.array[y+3]=T.y;w.array[y+4]=U.x;w.array[y+5]=U.y;w.array[y+6]=ka.x;w.array[y+7]=ka.y;y=y+8}}else{if(w.boundTo==="faces"){D=0;for(X=na.length;D<X;D++){U=T=S=ra=w.value[na[D]];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=T.x;w.array[y+3]=T.y;w.array[y+4]=U.x;w.array[y+5]=U.y;y=y+6}D=0;for(X=oa.length;D<X;D++){ka=U=T=S=ra=w.value[oa[D]];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+
2]=T.x;w.array[y+3]=T.y;w.array[y+4]=U.x;w.array[y+5]=U.y;w.array[y+6]=ka.x;w.array[y+7]=ka.y;y=y+8}}}else if(w.size===3){var aa;aa=w.type==="c"?["r","g","b"]:["x","y","z"];if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];S=w.value[N.a];T=w.value[N.b];U=w.value[N.c];w.array[y]=S[aa[0]];w.array[y+1]=S[aa[1]];w.array[y+2]=S[aa[2]];w.array[y+3]=T[aa[0]];w.array[y+4]=T[aa[1]];w.array[y+5]=T[aa[2]];w.array[y+6]=U[aa[0]];w.array[y+7]=U[aa[1]];w.array[y+8]=U[aa[2]];
y=y+9}D=0;for(X=oa.length;D<X;D++){N=Ha[oa[D]];S=w.value[N.a];T=w.value[N.b];U=w.value[N.c];ka=w.value[N.d];w.array[y]=S[aa[0]];w.array[y+1]=S[aa[1]];w.array[y+2]=S[aa[2]];w.array[y+3]=T[aa[0]];w.array[y+4]=T[aa[1]];w.array[y+5]=T[aa[2]];w.array[y+6]=U[aa[0]];w.array[y+7]=U[aa[1]];w.array[y+8]=U[aa[2]];w.array[y+9]=ka[aa[0]];w.array[y+10]=ka[aa[1]];w.array[y+11]=ka[aa[2]];y=y+12}}else if(w.boundTo==="faces"){D=0;for(X=na.length;D<X;D++){U=T=S=ra=w.value[na[D]];w.array[y]=S[aa[0]];w.array[y+1]=S[aa[1]];
w.array[y+2]=S[aa[2]];w.array[y+3]=T[aa[0]];w.array[y+4]=T[aa[1]];w.array[y+5]=T[aa[2]];w.array[y+6]=U[aa[0]];w.array[y+7]=U[aa[1]];w.array[y+8]=U[aa[2]];y=y+9}D=0;for(X=oa.length;D<X;D++){ka=U=T=S=ra=w.value[oa[D]];w.array[y]=S[aa[0]];w.array[y+1]=S[aa[1]];w.array[y+2]=S[aa[2]];w.array[y+3]=T[aa[0]];w.array[y+4]=T[aa[1]];w.array[y+5]=T[aa[2]];w.array[y+6]=U[aa[0]];w.array[y+7]=U[aa[1]];w.array[y+8]=U[aa[2]];w.array[y+9]=ka[aa[0]];w.array[y+10]=ka[aa[1]];w.array[y+11]=ka[aa[2]];y=y+12}}else if(w.boundTo===
"faceVertices"){D=0;for(X=na.length;D<X;D++){ra=w.value[na[D]];S=ra[0];T=ra[1];U=ra[2];w.array[y]=S[aa[0]];w.array[y+1]=S[aa[1]];w.array[y+2]=S[aa[2]];w.array[y+3]=T[aa[0]];w.array[y+4]=T[aa[1]];w.array[y+5]=T[aa[2]];w.array[y+6]=U[aa[0]];w.array[y+7]=U[aa[1]];w.array[y+8]=U[aa[2]];y=y+9}D=0;for(X=oa.length;D<X;D++){ra=w.value[oa[D]];S=ra[0];T=ra[1];U=ra[2];ka=ra[3];w.array[y]=S[aa[0]];w.array[y+1]=S[aa[1]];w.array[y+2]=S[aa[2]];w.array[y+3]=T[aa[0]];w.array[y+4]=T[aa[1]];w.array[y+5]=T[aa[2]];w.array[y+
6]=U[aa[0]];w.array[y+7]=U[aa[1]];w.array[y+8]=U[aa[2]];w.array[y+9]=ka[aa[0]];w.array[y+10]=ka[aa[1]];w.array[y+11]=ka[aa[2]];y=y+12}}}else if(w.size===4)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(X=na.length;D<X;D++){N=Ha[na[D]];S=w.value[N.a];T=w.value[N.b];U=w.value[N.c];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;y=y+12}D=
0;for(X=oa.length;D<X;D++){N=Ha[oa[D]];S=w.value[N.a];T=w.value[N.b];U=w.value[N.c];ka=w.value[N.d];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;w.array[y+12]=ka.x;w.array[y+13]=ka.y;w.array[y+14]=ka.z;w.array[y+15]=ka.w;y=y+16}}else if(w.boundTo==="faces"){D=0;for(X=na.length;D<X;D++){U=T=S=ra=w.value[na[D]];w.array[y]=S.x;w.array[y+1]=S.y;
w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;y=y+12}D=0;for(X=oa.length;D<X;D++){ka=U=T=S=ra=w.value[oa[D]];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;w.array[y+12]=ka.x;w.array[y+13]=ka.y;w.array[y+14]=ka.z;w.array[y+
15]=ka.w;y=y+16}}else if(w.boundTo==="faceVertices"){D=0;for(X=na.length;D<X;D++){ra=w.value[na[D]];S=ra[0];T=ra[1];U=ra[2];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;y=y+12}D=0;for(X=oa.length;D<X;D++){ra=w.value[oa[D]];S=ra[0];T=ra[1];U=ra[2];ka=ra[3];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+
5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;w.array[y+12]=ka.x;w.array[y+13]=ka.y;w.array[y+14]=ka.z;w.array[y+15]=ka.w;y=y+16}}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,cb)}}}if(Ed){delete ga.__inittedArrays;delete ga.__colorArray;delete ga.__normalArray;delete ga.__tangentArray;delete ga.__uvArray;delete ga.__uv2Array;delete ga.__faceArray;delete ga.__vertexArray;delete ga.__lineArray;delete ga.__skinVertexAArray;
delete ga.__skinVertexBArray;delete ga.__skinIndexArray;delete ga.__skinWeightArray}}}}ea.verticesNeedUpdate=false;ea.morphTargetsNeedUpdate=false;ea.elementsNeedUpdate=false;ea.uvsNeedUpdate=false;ea.normalsNeedUpdate=false;ea.colorsNeedUpdate=false;ea.tangentsNeedUpdate=false;$a.attributes&&p($a)}else if(sb instanceof THREE.Ribbon){if(ea.verticesNeedUpdate||ea.colorsNeedUpdate){var hc=ea,wd=k.DYNAMIC_DRAW,Kc=void 0,Lc=void 0,Tc=void 0,ic=void 0,Uc=void 0,xd=hc.vertices,yd=hc.colors,Kd=xd.length,
Ld=yd.length,Vc=hc.__vertexArray,Wc=hc.__colorArray,Md=hc.colorsNeedUpdate;if(hc.verticesNeedUpdate){for(Kc=0;Kc<Kd;Kc++){Tc=xd[Kc];ic=Kc*3;Vc[ic]=Tc.x;Vc[ic+1]=Tc.y;Vc[ic+2]=Tc.z}k.bindBuffer(k.ARRAY_BUFFER,hc.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Vc,wd)}if(Md){for(Lc=0;Lc<Ld;Lc++){Uc=yd[Lc];ic=Lc*3;Wc[ic]=Uc.r;Wc[ic+1]=Uc.g;Wc[ic+2]=Uc.b}k.bindBuffer(k.ARRAY_BUFFER,hc.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Wc,wd)}}ea.verticesNeedUpdate=false;ea.colorsNeedUpdate=false}else if(sb instanceof
THREE.Line){$a=c(sb,jb);fb=$a.attributes&&m($a);if(ea.verticesNeedUpdate||ea.colorsNeedUpdate||fb){var Tb=ea,od=k.DYNAMIC_DRAW,Mc=void 0,Nc=void 0,Xc=void 0,Ca=void 0,Yc=void 0,zd=Tb.vertices,Ad=Tb.colors,Nd=zd.length,Od=Ad.length,Zc=Tb.__vertexArray,$c=Tb.__colorArray,Pd=Tb.colorsNeedUpdate,pd=Tb.__webglCustomAttributesList,ad=void 0,Bd=void 0,Ra=void 0,Bc=void 0,ab=void 0,wa=void 0;if(Tb.verticesNeedUpdate){for(Mc=0;Mc<Nd;Mc++){Xc=zd[Mc];Ca=Mc*3;Zc[Ca]=Xc.x;Zc[Ca+1]=Xc.y;Zc[Ca+2]=Xc.z}k.bindBuffer(k.ARRAY_BUFFER,
Tb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Zc,od)}if(Pd){for(Nc=0;Nc<Od;Nc++){Yc=Ad[Nc];Ca=Nc*3;$c[Ca]=Yc.r;$c[Ca+1]=Yc.g;$c[Ca+2]=Yc.b}k.bindBuffer(k.ARRAY_BUFFER,Tb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,$c,od)}if(pd){ad=0;for(Bd=pd.length;ad<Bd;ad++){wa=pd[ad];if(wa.needsUpdate&&(wa.boundTo===void 0||wa.boundTo==="vertices")){Ca=0;Bc=wa.value.length;if(wa.size===1)for(Ra=0;Ra<Bc;Ra++)wa.array[Ra]=wa.value[Ra];else if(wa.size===2)for(Ra=0;Ra<Bc;Ra++){ab=wa.value[Ra];wa.array[Ca]=
ab.x;wa.array[Ca+1]=ab.y;Ca=Ca+2}else if(wa.size===3)if(wa.type==="c")for(Ra=0;Ra<Bc;Ra++){ab=wa.value[Ra];wa.array[Ca]=ab.r;wa.array[Ca+1]=ab.g;wa.array[Ca+2]=ab.b;Ca=Ca+3}else for(Ra=0;Ra<Bc;Ra++){ab=wa.value[Ra];wa.array[Ca]=ab.x;wa.array[Ca+1]=ab.y;wa.array[Ca+2]=ab.z;Ca=Ca+3}else if(wa.size===4)for(Ra=0;Ra<Bc;Ra++){ab=wa.value[Ra];wa.array[Ca]=ab.x;wa.array[Ca+1]=ab.y;wa.array[Ca+2]=ab.z;wa.array[Ca+3]=ab.w;Ca=Ca+4}k.bindBuffer(k.ARRAY_BUFFER,wa.buffer);k.bufferData(k.ARRAY_BUFFER,wa.array,od)}}}}ea.verticesNeedUpdate=
false;ea.colorsNeedUpdate=false;$a.attributes&&p($a)}else if(sb instanceof THREE.ParticleSystem){$a=c(sb,jb);fb=$a.attributes&&m($a);(ea.verticesNeedUpdate||ea.colorsNeedUpdate||sb.sortParticles||fb)&&e(ea,k.DYNAMIC_DRAW,sb);ea.verticesNeedUpdate=false;ea.colorsNeedUpdate=false;$a.attributes&&p($a)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,n;a instanceof THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":
a instanceof THREE.MeshLambertMaterial?n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var o=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var m,p;m=g=e=o=0;for(f=b.length;m<f;m++){p=b[m];if(!p.onlyShadow){p instanceof THREE.DirectionalLight&&g++;p instanceof THREE.PointLight&&e++;p instanceof
THREE.SpotLight&&o++}}if(e+o+g<=M){m=g;f=e}else{m=Math.ceil(M*g/(e+g));o=f=M-m}e=m;g=o;o=l=0;for(m=b.length;o<m;o++){p=b[o];if(p.castShadow){p instanceof THREE.SpotLight&&l++;p instanceof THREE.DirectionalLight&&!p.shadowCascade&&l++}}if(jc&&d&&d.useVertexTexture)j=1024;else{b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS);b=Math.floor((b-20)/4);if(d!==void 0&&d instanceof THREE.SkinnedMesh){b=Math.min(d.bones.length,b);b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+
", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")}j=b}var q;a:{p=a.fragmentShader;m=a.vertexShader;var o=a.uniforms,b=a.attributes,c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,sizeAttenuation:a.sizeAttenuation,skinning:a.skinning,maxBones:j,useVertexTexture:jc&&d&&d.useVertexTexture,boneTextureWidth:d&&d.boneTextureWidth,boneTextureHeight:d&&d.boneTextureHeight,
morphTargets:a.morphTargets,morphNormals:a.morphNormals,maxMorphTargets:this.maxMorphTargets,maxMorphNormals:this.maxMorphNormals,maxDirLights:e,maxPointLights:f,maxSpotLights:g,maxShadows:l,shadowMapEnabled:this.shadowMapEnabled&&d.receiveShadow,shadowMapSoft:this.shadowMapSoft,shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide},r,d=[];if(n)d.push(n);else{d.push(p);
d.push(m)}for(r in c){d.push(r);d.push(c[r])}n=d.join();r=0;for(d=V.length;r<d;r++){e=V[r];if(e.code===n){e.usedTimes++;q=e.program;break a}}r=k.createProgram();d=["precision "+J+" float;",Cc?"#define VERTEX_TEXTURES":"",H.gammaInput?"#define GAMMA_INPUT":"",H.gammaOutput?"#define GAMMA_OUTPUT":"",H.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_SHADOWS "+
...
e=["precision "+J+" float;",c.bumpMap||c.normalMap?"#extension GL_OES_standard_derivatives : enable":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_SHADOWS "+c.maxShadows,c.alphaTest?"#define ALPHATEST "+c.alphaTest:"",H.gammaInput?"#define GAMMA_INPUT":"",H.gammaOutput?"#define GAMMA_OUTPUT":"",H.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"",c.useFog&&c.fog?"#define USE_FOG":"",c.useFog&&
c.fog instanceof THREE.FogExp2?"#define FOG_EXP2":"",c.map?"#define USE_MAP":"",c.envMap?"#define USE_ENVMAP":"",c.lightMap?"#define USE_LIGHTMAP":"",c.bumpMap?"#define USE_BUMPMAP":"",c.normalMap?"#define USE_NORMALMAP":"",c.specularMap?"#define USE_SPECULARMAP":"",c.vertexColors?"#define USE_COLOR":"",c.metal?"#define METAL":"",c.perPixel?"#define PHONG_PER_PIXEL":"",c.wrapAround?"#define WRAP_AROUND":"",c.doubleSided?"#define DOUBLE_SIDED":"",c.shadowMapEnabled?"#define USE_SHADOWMAP":"",c.shadowMapSoft?
"#define SHADOWMAP_SOFT":"",c.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",c.shadowMapCascade?"#define SHADOWMAP_CASCADE":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;",""];e=e.join("\n");e=z("fragment",e+p);d=z("vertex",d+m);k.attachShader(r,d);k.attachShader(r,e);k.linkProgram(r);k.getProgramParameter(r,k.LINK_STATUS)||console.error("Could not initialise shader\nVALIDATE_STATUS: "+k.getProgramParameter(r,k.VALIDATE_STATUS)+", gl error ["+k.getError()+"]");k.deleteShader(e);k.deleteShader(d);
r.uniforms={};r.attributes={};var s,d=["viewMatrix","modelViewMatrix","projectionMatrix","normalMatrix","modelMatrix","cameraPosition","morphTargetInfluences"];c.useVertexTexture?d.push("boneTexture"):d.push("boneGlobalMatrices");for(s in o)d.push(s);s=d;d=0;for(o=s.length;d<o;d++){e=s[d];r.uniforms[e]=k.getUniformLocation(r,e)}d=["position","normal","uv","uv2","tangent","color","skinVertexA","skinVertexB","skinIndex","skinWeight"];for(s=0;s<c.maxMorphTargets;s++)d.push("morphTarget"+s);for(s=0;s<
c.maxMorphNormals;s++)d.push("morphNormal"+s);for(q in b)d.push(q);q=d;s=0;for(c=q.length;s<c;s++){d=q[s];r.attributes[d]=k.getAttribLocation(r,d)}r.id=Q++;V.push({program:r,code:n,usedTimes:1});H.info.memory.programs=V.length;q=r}a.program=q;q=a.program.attributes;q.position>=0&&k.enableVertexAttribArray(q.position);q.color>=0&&k.enableVertexAttribArray(q.color);q.normal>=0&&k.enableVertexAttribArray(q.normal);q.tangent>=0&&k.enableVertexAttribArray(q.tangent);if(a.skinning&&q.skinVertexA>=0&&q.skinVertexB>=
0&&q.skinIndex>=0&&q.skinWeight>=0){k.enableVertexAttribArray(q.skinVertexA);k.enableVertexAttribArray(q.skinVertexB);k.enableVertexAttribArray(q.skinIndex);k.enableVertexAttribArray(q.skinWeight)}if(a.attributes)for(i in a.attributes)q[i]!==void 0&&q[i]>=0&&k.enableVertexAttribArray(q[i]);if(a.morphTargets){a.numSupportedMorphTargets=0;r="morphTarget";for(i=0;i<this.maxMorphTargets;i++){s=r+i;if(q[s]>=0){k.enableVertexAttribArray(q[s]);a.numSupportedMorphTargets++}}}if(a.morphNormals){a.numSupportedMorphNormals=
0;r="morphNormal";for(i=0;i<this.maxMorphNormals;i++){s=r+i;if(q[s]>=0){k.enableVertexAttribArray(q[s]);a.numSupportedMorphNormals++}}}a.uniformsList=[];for(h in a.uniforms)a.uniformsList.push([a.uniforms[h],h])};this.setFaceCulling=function(a,b){if(a){!b||b==="ccw"?k.frontFace(k.CCW):k.frontFace(k.CW);a==="back"?k.cullFace(k.BACK):a==="front"?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK);k.enable(k.CULL_FACE)}else k.disable(k.CULL_FACE)};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,
a=a.side===THREE.BackSide;if(ba!==b){b?k.disable(k.CULL_FACE):k.enable(k.CULL_FACE);ba=b}if($!==a){a?k.frontFace(k.CW):k.frontFace(k.CCW);$=a}};this.setDepthTest=function(a){if(qa!==a){a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST);qa=a}};this.setDepthWrite=function(a){if(Ia!==a){k.depthMask(a);Ia=a}};this.setBlending=function(a,b,c,d){if(a!==ca){if(a===THREE.NoBlending)k.disable(k.BLEND);else if(a===THREE.AdditiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE)}else if(a===
THREE.SubtractiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)}else if(a===THREE.MultiplyBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.SRC_COLOR)}else if(a===THREE.CustomBlending)k.enable(k.BLEND);else{k.enable(k.BLEND);k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD);k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)}ca=a}if(a===THREE.CustomBlending){if(b!==ma){k.blendEquation(C(b));ma=
b}if(c!==sa||d!==bb){k.blendFunc(C(c),C(d));sa=c;bb=d}}else bb=sa=ma=null};this.setTexture=function(a,b){if(a.needsUpdate){if(!a.__webglInit){a.__webglInit=true;a.__webglTexture=k.createTexture();H.info.memory.textures++}k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=(c.width&c.width-1)===0&&(c.height&c.height-1)===0,e=C(a.format),f=C(a.type);
x(k.TEXTURE_2D,a,d);a instanceof THREE.DataTexture?k.texImage2D(k.TEXTURE_2D,0,e,c.width,c.height,0,e,f,c.data):k.texImage2D(k.TEXTURE_2D,0,e,e,f,a.image);a.generateMipmaps&&d&&k.generateMipmap(k.TEXTURE_2D);a.needsUpdate=false;if(a.onUpdate)a.onUpdate()}else{k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture)}};this.setRenderTarget=function(a){var b=a instanceof THREE.WebGLRenderTargetCube;if(a&&!a.__webglFramebuffer){if(a.depthBuffer===void 0)a.depthBuffer=true;if(a.stencilBuffer===
void 0)a.stencilBuffer=true;a.__webglTexture=k.createTexture();var c=(a.width&a.width-1)===0&&(a.height&a.height-1)===0,d=C(a.format),e=C(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);x(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;f<6;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+
f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);A(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);x(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null);d=k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,
k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);A(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;e=d=0}else{b=null;c=fb;a=gb;d=Ub;e=vb}if(b!==W){k.bindFramebuffer(k.FRAMEBUFFER,b);k.viewport(d,e,c,a);W=b}hb=c;Ka=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;
...
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);E.positionScreen.copy(v);E.customUpdateCallback?E.customUpdateCallback(E):E.updateLensFlares();b.uniform1i(F.renderType,2);b.enable(b.BLEND);P=0;for(G=E.lensFlares.length;P<G;P++){I=E.lensFlares[P];if(I.opacity>0.0010&&I.scale>0.0010){v.x=I.x;v.y=I.y;v.z=I.z;B=I.size*I.scale/s;C.x=B*z;C.y=B;b.uniform3f(F.screenPosition,v.x,v.y,v.z);b.uniform2f(F.scale,C.x,C.y);b.uniform1f(F.rotation,I.rotation);b.uniform1f(F.opacity,I.opacity);
