...
0;f<j;f++){g=i[f];this.vertices.push(new THREE.Vector3(g.x,g.y,0))}for(f=0;f<e;f++){j=l[f];i=j[2];g=j[1];j=j[0];i=i+h;g=g+h;j=j+h;this.faces.push(new THREE.Face3(i,g,j,null,null,c));i=d.generateBottomUV(this,a,b,i,g,j);this.faceVertexUvs[0].push(i)}};
