...
v=d[12],u=d[1],D=d[5],C=d[9],G=d[13],N=d[2],B=d[6],J=d[10],H=d[14],I=d[3],L=d[7],P=d[11],d=d[15];e[0]=f*r+g*u+h*N+i*I;e[4]=f*E+g*D+h*B+i*L;e[8]=f*z+g*C+h*J+i*P;e[12]=f*v+g*G+h*H+i*d;e[1]=j*r+l*u+m*N+n*I;e[5]=j*E+l*D+m*B+n*L;e[9]=j*z+l*C+m*J+n*P;e[13]=j*v+l*G+m*H+n*d;e[2]=p*r+o*u+s*N+t*I;e[6]=p*E+o*D+s*B+t*L;e[10]=p*z+o*C+s*J+t*P;e[14]=p*v+o*G+s*H+t*d;e[3]=q*r+A*u+w*N+c*I;e[7]=q*E+A*D+w*B+c*L;e[11]=q*z+A*C+w*J+c*P;e[15]=q*v+A*G+w*H+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
e.z=f.renderDepth:(N.copy(f.matrixWorld.getPosition()),J.multiplyVector3(N),e.z=N.z),G.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(N.copy(f.matrixWorld.getPosition()),J.multiplyVector3(N),e.z=N.z),G.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(N.copy(f.matrixWorld.getPosition()),J.multiplyVector3(N),e.z=N.z),G.objects.push(e));gb(f)}}};gb(g);!0===m&&G.objects.sort(c);g=0;for(m=G.objects.length;g<
...
G.elements.push(n)}}else if(Aa instanceof THREE.Line){H.multiply(J,ua);fa=Aa.geometry.vertices;V=b();V.positionScreen.copy(fa[0]);H.multiplyVector4(V.positionScreen);ua=Aa.type===THREE.LinePieces?2:1;R=1;for(ga=fa.length;R<ga;R++)V=b(),V.positionScreen.copy(fa[R]),H.multiplyVector4(V.positionScreen),0<(R+1)%ua||(aa=l[j-2],P.copy(V.positionScreen),S.copy(aa.positionScreen),!0===d(P,S)&&(P.multiplyScalar(1/P.w),S.multiplyScalar(1/S.w),r===z?(Ka=new THREE.RenderableLine,E.push(Ka),z++,r++,w=Ka):w=E[r++],
w.v1.positionScreen.copy(P),w.v2.positionScreen.copy(S),w.z=Math.max(P.z,S.z),w.material=Aa.material,G.elements.push(w)))}g=0;for(m=G.sprites.length;g<m;g++)Aa=G.sprites[g].object,ua=Aa.matrixWorld,Aa instanceof THREE.Particle&&(B.set(ua.elements[12],ua.elements[13],ua.elements[14],1),J.multiplyVector4(B),B.z/=B.w,0<B.z&&1>B.z&&(u===C?(Z=new THREE.RenderableParticle,D.push(Z),C++,u++,v=Z):v=D[u++],v.object=Aa,v.x=B.x/B.w,v.y=B.y/B.w,v.z=B.z,v.rotation=Aa.rotation.z,v.scale.x=Aa.scale.x*Math.abs(v.x-
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,u){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];l=g[e];m=g[f];n=g[u];p=i.x-h.x;o=j.x-h.x;s=i.y-h.y;t=j.y-h.y;q=i.z-h.z;A=j.z-h.z;w=m.u-l.u;r=n.u-l.u;E=m.v-l.v;z=n.v-l.v;v=1/(w*z-r*E);G.set((z*p-E*o)*v,(z*s-E*t)*v,(z*q-E*A)*v);N.set((w*o-r*p)*v,(w*t-r*s)*v,(w*A-r*q)*v);D[b].addSelf(G);D[c].addSelf(G);D[d].addSelf(G);C[b].addSelf(N);C[c].addSelf(N);C[d].addSelf(N)}var b,c,d,e,f,g,h,i,j,l,m,n,p,o,s,t,q,A,
w,r,E,z,v,u,D=[],C=[],G=new THREE.Vector3,N=new THREE.Vector3,B=new THREE.Vector3,J=new THREE.Vector3,H=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)D[b]=new THREE.Vector3,C[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var I=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<
...
s),q.crossSelf(A),h[3*i]+=q.x,h[3*i+1]+=q.y,h[3*i+2]+=q.z,h[3*j]+=q.x,h[3*j+1]+=q.y,h[3*j+2]+=q.z,h[3*l]+=q.x,h[3*l+1]+=q.y,h[3*l+2]+=q.z}this.normalizeNormals();this.normalsNeedUpdate=!0}},normalizeNormals:function(){for(var a=this.attributes.normal.array,b,c,d,e=0,f=a.length;e<f;e+=3)b=a[e],c=a[e+1],d=a[e+2],b=1/Math.sqrt(b*b+c*c+d*d),a[e]*=b,a[e+1]*=b,a[e+2]*=b},computeTangents:function(){function a(a){U.x=d[3*a];U.y=d[3*a+1];U.z=d[3*a+2];M.copy(U);Q=i[a];P.copy(Q);P.subSelf(U.multiplyScalar(U.dot(Q))).normalize();
S.cross(M,Q);Z=S.dot(j[a]);O=0>Z?-1:1;h[4*a]=P.x;h[4*a+1]=P.y;h[4*a+2]=P.z;h[4*a+3]=O}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===this.attributes.uv)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,e=this.attributes.uv.array,f=c.length/3;if(void 0===this.attributes.tangent){var g=
4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,m,n,p,o,s,t,q,A,w,r,E,z,v,u,f=new THREE.Vector3,g=new THREE.Vector3,D,C,G,N,B,J,H,I=this.offsets;G=0;for(N=I.length;G<N;++G){C=I[G].start;B=I[G].count;var L=I[G].index;D=C;for(C+=B;D<C;D+=3)B=L+b[D],J=L+b[D+1],H=L+b[D+2],l=c[3*B],m=c[3*B+1],n=c[3*B+2],p=c[3*J],o=c[3*J+1],s=c[3*J+2],t=c[3*H],q=c[3*H+1],A=c[3*
H+2],w=e[2*B],r=e[2*B+1],E=e[2*J],z=e[2*J+1],v=e[2*H],u=e[2*H+1],p-=l,l=t-l,o-=m,m=q-m,s-=n,n=A-n,E-=w,w=v-w,z-=r,r=u-r,u=1/(E*r-w*z),f.set((r*p-z*l)*u,(r*o-z*m)*u,(r*s-z*n)*u),g.set((E*l-w*p)*u,(E*m-w*o)*u,(E*n-w*s)*u),i[B].addSelf(f),i[J].addSelf(f),i[H].addSelf(f),j[B].addSelf(g),j[J].addSelf(g),j[H].addSelf(g)}var P=new THREE.Vector3,S=new THREE.Vector3,U=new THREE.Vector3,M=new THREE.Vector3,O,Q,Z;G=0;for(N=I.length;G<N;++G){C=I[G].start;B=I[G].count;L=I[G].index;D=C;for(C+=B;D<C;D+=3)B=L+b[D],
...
P=n+P+E(2*p);m=P+b+E(2*o);b=m+c+E(2*s);c=b+j+E(2*t);S=c+S+E(2*q);j=S+d+E(2*A);d=j+e+E(2*w);s&&(e=m+3*s*Uint32Array.BYTES_PER_ELEMENT,C(s,m,e+3*s*Uint32Array.BYTES_PER_ELEMENT),u(s,e));t&&(s=b+3*t*Uint32Array.BYTES_PER_ELEMENT,e=s+3*t*Uint32Array.BYTES_PER_ELEMENT,N(t,b,s,e+3*t*Uint32Array.BYTES_PER_ELEMENT),u(t,e));w&&(t=j+4*w*Uint32Array.BYTES_PER_ELEMENT,G(w,j,t+4*w*Uint32Array.BYTES_PER_ELEMENT),D(w,t));r&&(w=d+4*r*Uint32Array.BYTES_PER_ELEMENT,t=w+4*r*Uint32Array.BYTES_PER_ELEMENT,B(r,d,w,t+4*
r*Uint32Array.BYTES_PER_ELEMENT),D(r,t));p&&C(p,n,n+3*p*Uint32Array.BYTES_PER_ELEMENT);o&&(p=P+3*o*Uint32Array.BYTES_PER_ELEMENT,N(o,P,p,p+3*o*Uint32Array.BYTES_PER_ELEMENT));q&&G(q,c,c+4*q*Uint32Array.BYTES_PER_ELEMENT);A&&(o=S+4*A*Uint32Array.BYTES_PER_ELEMENT,B(A,S,o,o+4*A*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&this.computeTangents()};e.prototype=Object.create(THREE.Geometry.prototype);b(new e(c),this.initMaterials(d,
...
n.options?n.load(d(e.url,Q.urlBaseType),h(c,a,C,e)):n.load(d(e.url,Q.urlBaseType),h(c,a,C,e),i)}else if(void 0!==e.geometry){if(D=M.geometries[e.geometry])g=!1,C=M.materials[e.material],(g=C instanceof THREE.ShaderMaterial)&&D.computeTangents(),w=e.position,r=e.rotation,E=e.quaternion,z=e.scale,q=e.matrix,E=0,e.material||(C=new THREE.MeshFaceMaterial(M.face_materials[e.geometry])),C instanceof THREE.MeshFaceMaterial&&0===C.materials.length&&(C=new THREE.MeshFaceMaterial(M.face_materials[e.geometry])),
e.skin?g=new THREE.SkinnedMesh(D,C):e.morph?(g=new THREE.MorphAnimMesh(D,C),void 0!==e.duration&&(g.duration=e.duration),void 0!==e.time&&(g.time=e.time),void 0!==e.mirroredLoop&&(g.mirroredLoop=e.mirroredLoop),C.morphNormals&&D.computeMorphNormals()):g=new THREE.Mesh(D,C),g.name=c,q?(g.matrixAutoUpdate=!1,g.matrix.set(q[0],q[1],q[2],q[3],q[4],q[5],q[6],q[7],q[8],q[9],q[10],q[11],q[12],q[13],q[14],q[15])):(g.position.set(w[0],w[1],w[2]),E?(g.quaternion.set(E[0],E[1],E[2],E[3]),g.useQuaternion=!0):
g.rotation.set(r[0],r[1],r[2]),g.scale.set(z[0],z[1],z[2])),g.visible=e.visible,g.castShadow=e.castShadow,g.receiveShadow=e.receiveShadow,a.add(g),M.objects[c]=g}else"DirectionalLight"===e.type||"PointLight"===e.type||"AmbientLight"===e.type?(H=void 0!==e.color?e.color:16777215,I=void 0!==e.intensity?e.intensity:1,"DirectionalLight"===e.type?(w=e.direction,J=new THREE.DirectionalLight(H,I),J.position.set(w[0],w[1],w[2]),e.target&&(O.push({object:J,targetName:e.target}),J.target=null)):"PointLight"===
e.type?(w=e.position,A=e.distance,J=new THREE.PointLight(H,I,A),J.position.set(w[0],w[1],w[2])):"AmbientLight"===e.type&&(J=new THREE.AmbientLight(H)),a.add(J),J.name=c,M.lights[c]=J,M.objects[c]=J):"PerspectiveCamera"===e.type||"OrthographicCamera"===e.type?("PerspectiveCamera"===e.type?G=new THREE.PerspectiveCamera(e.fov,e.aspect,e.near,e.far):"OrthographicCamera"===e.type&&(G=new THREE.OrthographicCamera(v.left,v.right,v.top,v.bottom,v.near,v.far)),w=e.position,G.position.set(w[0],w[1],w[2]),a.add(G),
G.name=c,M.cameras[c]=G,M.objects[c]=G):(w=e.position,r=e.rotation,E=e.quaternion,z=e.scale,E=0,g=new THREE.Object3D,g.name=c,g.position.set(w[0],w[1],w[2]),E?(g.quaternion.set(E[0],E[1],E[2],E[3]),g.useQuaternion=!0):g.rotation.set(r[0],r[1],r[2]),g.scale.set(z[0],z[1],z[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),M.objects[c]=g,M.empties[c]=g);if(g){if(void 0!==e.properties)for(var m in e.properties)g.properties[m]=e.properties[m];void 0!==e.children&&f(g,e.children)}}}function g(a){return function(b,
c){M.geometries[a]=b;M.face_materials[a]=c;e();L-=1;l.onLoadComplete();j()}}function h(a,b,c,d){return function(f){var f=f.content?f.content:f.dae?f.scene:f,g=d.position,h=d.rotation,i=d.quaternion,n=d.scale;f.position.set(g[0],g[1],g[2]);i?(f.quaternion.set(i[0],i[1],i[2],i[3]),f.useQuaternion=!0):f.rotation.set(h[0],h[1],h[2]);f.scale.set(n[0],n[1],n[2]);c&&f.traverse(function(a){a.material=c});b.add(f);M.objects[a]=f;e();L-=1;l.onLoadComplete();j()}}function i(a){return function(b,c){M.geometries[a]=
b;M.face_materials[a]=c}}function j(){l.callbackProgress({totalModels:S,totalTextures:U,loadedModels:S-L,loadedTextures:U-P},M);l.onLoadProgress();if(0===L&&0===P){for(var a=0;a<O.length;a++){var c=O[a],d=M.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,M.scene.add(c.object.target));c.object.target.properties.targetInverse=c.object}b(M)}}var l=this,m=THREE.Loader.prototype.extractUrlBase(c),n,p,o,s,t,q,A,w,r,E,z,v,u,D,C,G,N,B,J,H,I,L,P,S,U,M,O=[],Q=a,Z;for(Z in this.geometryHandlerMap)a=
this.geometryHandlerMap[Z].loaderClass,this.geometryHandlerMap[Z].loaderObject=new a;for(Z in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[Z].loaderClass,this.hierarchyHandlerMap[Z].loaderObject=new a;P=L=0;M={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(Q.transform&&(Z=Q.transform.position,a=Q.transform.rotation,c=Q.transform.scale,Z&&M.scene.position.set(Z[0],Z[1],Z[2]),a&&M.scene.rotation.set(a[0],a[1],
a[2]),c&&M.scene.scale.set(c[0],c[1],c[2]),Z||a||c))M.scene.updateMatrix(),M.scene.updateMatrixWorld();Z=function(a){return function(){P-=a;j();l.onLoadComplete()}};for(o in Q.fogs)a=Q.fogs[o],"linear"===a.type?N=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(N=new THREE.FogExp2(0,a.density)),v=a.color,N.color.setRGB(v[0],v[1],v[2]),M.fogs[o]=N;for(n in Q.geometries)t=Q.geometries[n],t.type in this.geometryHandlerMap&&(L+=1,l.onLoadStart());for(var K in Q.objects)o=Q.objects[K],o.type&&o.type in
this.hierarchyHandlerMap&&(L+=1,l.onLoadStart());S=L;for(n in Q.geometries)if(t=Q.geometries[n],"cube"===t.type)D=new THREE.CubeGeometry(t.width,t.height,t.depth,t.widthSegments,t.heightSegments,t.depthSegments),M.geometries[n]=D;else if("plane"===t.type)D=new THREE.PlaneGeometry(t.width,t.height,t.widthSegments,t.heightSegments),M.geometries[n]=D;else if("sphere"===t.type)D=new THREE.SphereGeometry(t.radius,t.widthSegments,t.heightSegments),M.geometries[n]=D;else if("cylinder"===t.type)D=new THREE.CylinderGeometry(t.topRad,
t.botRad,t.height,t.radSegs,t.heightSegs),M.geometries[n]=D;else if("torus"===t.type)D=new THREE.TorusGeometry(t.radius,t.tube,t.segmentsR,t.segmentsT),M.geometries[n]=D;else if("icosahedron"===t.type)D=new THREE.IcosahedronGeometry(t.radius,t.subdivisions),M.geometries[n]=D;else if(t.type in this.geometryHandlerMap){K={};for(B in t)"type"!==B&&"url"!==B&&(K[B]=t[B]);this.geometryHandlerMap[t.type].loaderObject.load(d(t.url,Q.urlBaseType),g(n),K)}else"embedded"===t.type&&(K=Q.embeds[t.id],K.metadata=
Q.metadata,K&&this.geometryHandlerMap.ascii.loaderObject.createModel(K,i(n),""));for(s in Q.textures)if(n=Q.textures[s],n.url instanceof Array){P+=n.url.length;for(B=0;B<n.url.length;B++)l.onLoadStart()}else P+=1,l.onLoadStart();U=P;for(s in Q.textures){n=Q.textures[s];void 0!==n.mapping&&void 0!==THREE[n.mapping]&&(n.mapping=new THREE[n.mapping]);if(n.url instanceof Array){K=n.url.length;o=[];for(B=0;B<K;B++)o[B]=d(n.url[B],Q.urlBaseType);B=(B=o[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(o,
n.mapping,Z(K)):THREE.ImageUtils.loadTextureCube(o,n.mapping,Z(K))}else{B=n.url.toLowerCase().endsWith(".dds");K=d(n.url,Q.urlBaseType);o=Z(1);B=B?THREE.ImageUtils.loadCompressedTexture(K,n.mapping,o):THREE.ImageUtils.loadTexture(K,n.mapping,o);void 0!==THREE[n.minFilter]&&(B.minFilter=THREE[n.minFilter]);void 0!==THREE[n.magFilter]&&(B.magFilter=THREE[n.magFilter]);n.anisotropy&&(B.anisotropy=n.anisotropy);if(n.repeat&&(B.repeat.set(n.repeat[0],n.repeat[1]),1!==n.repeat[0]&&(B.wrapS=THREE.RepeatWrapping),
1!==n.repeat[1]))B.wrapT=THREE.RepeatWrapping;n.offset&&B.offset.set(n.offset[0],n.offset[1]);if(n.wrap&&(K={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==K[n.wrap[0]]&&(B.wrapS=K[n.wrap[0]]),void 0!==K[n.wrap[1]]))B.wrapT=K[n.wrap[1]]}M.textures[s]=B}for(p in Q.materials){q=Q.materials[p];for(u in q.parameters)"envMap"===u||"map"===u||"lightMap"===u||"bumpMap"===u?q.parameters[u]=M.textures[q.parameters[u]]:"shading"===u?q.parameters[u]="flat"===q.parameters[u]?THREE.FlatShading:
THREE.SmoothShading:"side"===u?q.parameters[u]="double"==q.parameters[u]?THREE.DoubleSide:"back"==q.parameters[u]?THREE.BackSide:THREE.FrontSide:"blending"===u?q.parameters[u]=q.parameters[u]in THREE?THREE[q.parameters[u]]:THREE.NormalBlending:"combine"===u?q.parameters[u]="MixOperation"==q.parameters[u]?THREE.MixOperation:THREE.MultiplyOperation:"vertexColors"===u?"face"==q.parameters[u]?q.parameters[u]=THREE.FaceColors:q.parameters[u]&&(q.parameters[u]=THREE.VertexColors):"wrapRGB"===u&&(s=q.parameters[u],
q.parameters[u]=new THREE.Vector3(s[0],s[1],s[2]));void 0!==q.parameters.opacity&&1>q.parameters.opacity&&(q.parameters.transparent=!0);q.parameters.normalMap?(s=THREE.ShaderUtils.lib.normal,Z=THREE.UniformsUtils.clone(s.uniforms),n=q.parameters.color,B=q.parameters.specular,K=q.parameters.ambient,o=q.parameters.shininess,Z.tNormal.value=M.textures[q.parameters.normalMap],q.parameters.normalScale&&Z.uNormalScale.value.set(q.parameters.normalScale[0],q.parameters.normalScale[1]),q.parameters.map&&
(Z.tDiffuse.value=q.parameters.map,Z.enableDiffuse.value=!0),q.parameters.envMap&&(Z.tCube.value=q.parameters.envMap,Z.enableReflection.value=!0,Z.uReflectivity.value=q.parameters.reflectivity),q.parameters.lightMap&&(Z.tAO.value=q.parameters.lightMap,Z.enableAO.value=!0),q.parameters.specularMap&&(Z.tSpecular.value=M.textures[q.parameters.specularMap],Z.enableSpecular.value=!0),q.parameters.displacementMap&&(Z.tDisplacement.value=M.textures[q.parameters.displacementMap],Z.enableDisplacement.value=
!0,Z.uDisplacementBias.value=q.parameters.displacementBias,Z.uDisplacementScale.value=q.parameters.displacementScale),Z.uDiffuseColor.value.setHex(n),Z.uSpecularColor.value.setHex(B),Z.uAmbientColor.value.setHex(K),Z.uShininess.value=o,q.parameters.opacity&&(Z.uOpacity.value=q.parameters.opacity),C=new THREE.ShaderMaterial({fragmentShader:s.fragmentShader,vertexShader:s.vertexShader,uniforms:Z,lights:!0,fog:!0})):C=new THREE[q.type](q.parameters);M.materials[p]=C}for(p in Q.materials)if(q=Q.materials[p],
q.parameters.materials){u=[];for(B=0;B<q.parameters.materials.length;B++)u.push(M.materials[q.parameters.materials[B]]);M.materials[p].materials=u}e();M.cameras&&Q.defaults.camera&&(M.currentCamera=M.cameras[Q.defaults.camera]);M.fogs&&Q.defaults.fog&&(M.scene.fog=M.fogs[Q.defaults.fog]);v=Q.defaults.bgcolor;M.bgColor=new THREE.Color;M.bgColor.setRGB(v[0],v[1],v[2]);M.bgColorAlpha=Q.defaults.bgalpha;l.callbackSync(M);j()};
...
document.createElement("canvas"),m,n,p,o,s=l.getContext("2d"),t=new THREE.Color(0),q=0,A=1,w=0,r=null,E=null,z=null,v=null,u=null,D,C,G,N,B=new THREE.RenderableVertex,J=new THREE.RenderableVertex,H,I,L,P,S,U,M,O,Q,Z,K,ja,R=new THREE.Color,ga=new THREE.Color,fa=new THREE.Color,V=new THREE.Color,aa=new THREE.Color,ca=new THREE.Color,ia=new THREE.Color,Aa={},ua={},Ba,Ka,va,db,xb,Ua,gb,lb,Ab,Bb,fb=new THREE.Rectangle,wa=new THREE.Rectangle,La=new THREE.Rectangle,mb=!1,Na=new THREE.Color,Za=new THREE.Color,
...
o,G.positionScreen.x*=p,G.positionScreen.y*=o,N.positionScreen.x*=p,N.positionScreen.y*=o,B.positionScreen.copy(C.positionScreen),J.positionScreen.copy(N.positionScreen),!0===da.overdraw&&(Xb(D.positionScreen,C.positionScreen),Xb(C.positionScreen,N.positionScreen),Xb(N.positionScreen,D.positionScreen),Xb(G.positionScreen,B.positionScreen),Xb(G.positionScreen,J.positionScreen)),La.addPoint(D.positionScreen.x,D.positionScreen.y),La.addPoint(C.positionScreen.x,C.positionScreen.y),La.addPoint(G.positionScreen.x,
G.positionScreen.y),La.addPoint(N.positionScreen.x,N.positionScreen.y),!0===fb.intersects(La)))(na=D,bb=C,E=G,zb=N,rb=B,sb=J,hc=a,f.info.render.vertices+=4,f.info.render.faces++,b(da.opacity),c(da.blending),void 0!==da.map&&null!==da.map||void 0!==da.envMap&&null!==da.envMap)?(m(na,bb,zb,0,1,3,ma,da,hc),m(rb,E,sb,1,2,3,ma,da,hc)):(H=na.positionScreen.x,I=na.positionScreen.y,L=bb.positionScreen.x,P=bb.positionScreen.y,S=E.positionScreen.x,U=E.positionScreen.y,M=zb.positionScreen.x,O=zb.positionScreen.y,
...
Ka),V.r=V.g=V.b=1-Cb(zb.positionScreen.z,Ba,Ka),aa.r=aa.g=aa.b=1-Cb(E.positionScreen.z,Ba,Ka),va=wc(ga,fa,V,aa),q(H,I,L,P,M,O),oa(H,I,L,P,M,O,0,0,1,0,0,1,va),q(Q,Z,S,U,K,ja),oa(Q,Z,S,U,K,ja,1,0,1,1,0,1,va));wa.addRectangle(La)}s.setTransform(1,0,0,1,0,0)}}};
...
t=Oc,q.width<=t&&q.height<=t||(w=Math.max(q.width,q.height),r=Math.floor(q.width*t/w),t=Math.floor(q.height*t/w),w=document.createElement("canvas"),w.width=r,w.height=t,w.getContext("2d").drawImage(q,0,0,q.width,q.height,0,0,r,t),q=w),n[m]=q):j[l]=c.image[l];l=j[0];n=0===(l.width&l.width-1)&&0===(l.height&l.height-1);m=H(c.format);q=H(c.type);N(k.TEXTURE_CUBE_MAP,c,n);for(l=0;6>l;l++)if(f){t=j[l].mipmaps;w=0;for(A=t.length;w<A;w++)r=t[w],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,w,m,
...
b.geometry,!m.__webglVertexBuffer){var J=m;J.__webglVertexBuffer=k.createBuffer();J.__webglColorBuffer=k.createBuffer();J.__webglNormalBuffer=k.createBuffer();K.info.memory.geometries++;var Q=m,P=b,M=Q.vertices.length;Q.__vertexArray=new Float32Array(3*M);Q.__colorArray=new Float32Array(3*M);Q.__normalArray=new Float32Array(3*M);Q.__webglVertexCount=M;c(Q,P);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(m=b.geometry,!m.__webglVertexBuffer){var N=
m;N.__webglVertexBuffer=k.createBuffer();N.__webglColorBuffer=k.createBuffer();N.__webglLineDistanceBuffer=k.createBuffer();K.info.memory.geometries++;var L=m,fa=b,ga=L.vertices.length;L.__vertexArray=new Float32Array(3*ga);L.__colorArray=new Float32Array(3*ga);L.__lineDistanceArray=new Float32Array(1*ga);L.__webglLineCount=ga;c(L,fa);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.lineDistancesNeedUpdate=!0}}else if(b instanceof THREE.ParticleSystem&&(m=b.geometry,!m.__webglVertexBuffer))if(m instanceof
...
function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.__webglTexture=k.createTexture(),K.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=H(a.format),f=H(a.type);N(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var f=a.mipmaps,g=0,h=f.length;g<
...
a.depthBuffer&&(a.depthBuffer=!0);void 0===a.stencilBuffer&&(a.stencilBuffer=!0);a.__webglTexture=k.createTexture();var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=H(a.format),e=H(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);N(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,
a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);B(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=k.createFramebuffer(),a.__webglRenderbuffer=k.createRenderbuffer(),k.bindTexture(k.TEXTURE_2D,a.__webglTexture),N(k.TEXTURE_2D,a,c),k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=k.TEXTURE_2D,
...
v=void 0,u=void 0,D=void 0,C=void 0,w=n[q[p]].x,r=n[q[p]].y,E=n[q[o]].x,z=n[q[o]].y,v=n[q[s]].x,u=n[q[s]].y;if(1E-10>(E-w)*(u-r)-(z-r)*(v-w))n=!1;else{for(A=0;A<t;A++)if(!(A==p||A==o||A==s)){var D=n[q[A]].x,C=n[q[A]].y,G=void 0,N=void 0,B=void 0,J=void 0,H=void 0,I=void 0,L=void 0,P=void 0,S=void 0,U=void 0,M=void 0,O=void 0,G=B=H=void 0,G=v-E,N=u-z,B=w-v,J=r-u,H=E-w,I=z-r,L=D-w,P=C-r,S=D-E,U=C-z,M=D-v,O=C-u,G=G*U-N*S,H=H*P-I*L,B=B*O-J*M;if(0<=G&&0<=B&&0<=H){n=!1;break a}}n=!0}}if(n){f.push([a[g[i]],
...
z=new THREE.Vector3);m||(j=i=l=0);var v,u,D,C=this,G=this.vertices.length,p=a.extractPoints(),N=p.shape,p=p.holes,B=!THREE.Shape.Utils.isClockWise(N);if(B){N=N.reverse();u=0;for(D=p.length;u<D;u++)v=p[u],THREE.Shape.Utils.isClockWise(v)&&(p[u]=v.reverse());B=!1}var J=THREE.Shape.Utils.triangulateShape(N,p),B=N;u=0;for(D=p.length;u<D;u++)v=p[u],N=N.concat(v);var H,I,L,P,S=N.length,U=J.length,M=[],O=0,Q=B.length;H=Q-1;for(I=O+1;O<Q;O++,H++,I++)H===Q&&(H=0),I===Q&&(I=0),M[O]=d(B[O],B[H],B[I]);var Z=
[],K,ja=M.concat();u=0;for(D=p.length;u<D;u++){v=p[u];K=[];O=0;Q=v.length;H=Q-1;for(I=O+1;O<Q;O++,H++,I++)H===Q&&(H=0),I===Q&&(I=0),K[O]=d(v[O],v[H],v[I]);Z.push(K);ja=ja.concat(K)}for(H=0;H<l;H++){v=H/l;L=i*(1-v);I=j*Math.sin(v*Math.PI/2);O=0;for(Q=B.length;O<Q;O++)P=c(B[O],M[O],I),f(P.x,P.y,-L);u=0;for(D=p.length;u<D;u++){v=p[u];K=Z[u];O=0;for(Q=v.length;O<Q;O++)P=c(v[O],K[O],I),f(P.x,P.y,-L)}}I=j;for(O=0;O<S;O++)P=m?c(N[O],ja[O],I):N[O],s?(E.copy(w.normals[0]).multiplyScalar(P.x),r.copy(w.binormals[0]).multiplyScalar(P.y),
z.copy(o[0]).addSelf(E).addSelf(r),f(z.x,z.y,z.z)):f(P.x,P.y,0);for(v=1;v<=n;v++)for(O=0;O<S;O++)P=m?c(N[O],ja[O],I):N[O],s?(E.copy(w.normals[v]).multiplyScalar(P.x),r.copy(w.binormals[v]).multiplyScalar(P.y),z.copy(o[v]).addSelf(E).addSelf(r),f(z.x,z.y,z.z)):f(P.x,P.y,h/n*v);for(H=l-1;0<=H;H--){v=H/l;L=i*(1-v);I=j*Math.sin(v*Math.PI/2);O=0;for(Q=B.length;O<Q;O++)P=c(B[O],M[O],I),f(P.x,P.y,h+L);u=0;for(D=p.length;u<D;u++){v=p[u];K=Z[u];O=0;for(Q=v.length;O<Q;O++)P=c(v[O],K[O],I),s?f(P.x,P.y+o[n-1].y,
o[n-1].x+L):f(P.x,P.y,h+L)}}if(m){i=0*S;for(O=0;O<U;O++)h=J[O],g(h[2]+i,h[1]+i,h[0]+i,!0);i=S*(n+2*l);for(O=0;O<U;O++)h=J[O],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(O=0;O<U;O++)h=J[O],g(h[2],h[1],h[0],!0);for(O=0;O<U;O++)h=J[O],g(h[0]+S*n,h[1]+S*n,h[2]+S*n,!1)}h=0;e(B,h);h+=B.length;u=0;for(D=p.length;u<D;u++)v=p[u],e(v,h),h+=v.length};
...
h.push(u.centroid),l.supportUVs&&(v=new THREE.UV,u instanceof THREE.Face3?(v.u=f(u.a,r).u+f(u.b,r).u+f(u.c,r).u,v.v=f(u.a,r).v+f(u.b,r).v+f(u.c,r).v,v.u/=3,v.v/=3):u instanceof THREE.Face4&&(v.u=f(u.a,r).u+f(u.b,r).u+f(u.c,r).u+f(u.d,r).u,v.v=f(u.a,r).v+f(u.b,r).v+f(u.c,r).v+f(u.d,r).v,v.u/=4,v.v/=4),g(s+r,"",v));var n=n(a),N;E=0;var B,J;G={};D={};for(r in n){C=n[r];B=r.split("_");J=B[0];B=B[1];z=J;u=[J,B];void 0===G[z]&&(G[z]=[]);G[z].push(u);z=B;u=[J,B];void 0===G[z]&&(G[z]=[]);G[z].push(u);z=0;
for(v=C.length;z<v;z++){u=C[z];N=J;var H=u,I=r;void 0===D[N]&&(D[N]={});D[N][H]=I;N=B;H=r;void 0===D[N]&&(D[N]={});D[N][u]=H}2>C.length&&(A[r]=!0)}for(r in n)if(C=n[r],u=C[0],N=C[1],B=r.split("_"),J=B[0],B=B[1],v=new THREE.Vector3,b(0<C.length,"an edge without faces?!"),1==C.length?(v.addSelf(p[J]),v.addSelf(p[B]),v.multiplyScalar(0.5)):(v.addSelf(t[u]),v.addSelf(t[N]),v.addSelf(p[J]),v.addSelf(p[B]),v.multiplyScalar(0.25)),q[r]=s+o.length+E,h.push(v),E++,l.supportUVs)v=new THREE.UV,v.u=f(J,u).u+
f(B,u).u,v.v=f(J,u).v+f(B,u).v,v.u/=2,v.v/=2,g(q[r],u,v),2<=C.length&&(b(2==C.length,"did we plan for more than 2 edges?"),v=new THREE.UV,v.u=f(J,N).u+f(B,N).u,v.v=f(J,N).v+f(B,N).v,v.u/=2,v.v/=2,g(q[r],N,v));c("-- Step 2 done");var L,P;v=["123","12","2","23"];N=["123","23","3","31"];var H=["123","31","1","12"],I=["1234","12","2","23"],S=["1234","23","3","34"],U=["1234","34","4","41"],M=["1234","41","1","12"];r=0;for(E=t.length;r<E;r++)u=o[r],C=s+r,u instanceof THREE.Face3?(J=m(u.a,u.b),B=m(u.b,u.c),
L=m(u.c,u.a),e(C,q[J],u.b,q[B],u,v,r),e(C,q[B],u.c,q[L],u,N,r),e(C,q[L],u.a,q[J],u,H,r)):u instanceof THREE.Face4?(J=m(u.a,u.b),B=m(u.b,u.c),L=m(u.c,u.d),P=m(u.d,u.a),e(C,q[J],u.b,q[B],u,I,r),e(C,q[B],u.c,q[L],u,S,r),e(C,q[L],u.d,q[P],u,U,r),e(C,q[P],u.a,q[J],u,M,r)):c("face should be a face!",u);q=new THREE.Vector3;u=new THREE.Vector3;r=0;for(E=p.length;r<E;r++)if(void 0!==G[r]){q.set(0,0,0);u.set(0,0,0);B=new THREE.Vector3(0,0,0);C=0;for(z in D[r])q.addSelf(t[z]),C++;N=0;J=G[r].length;v=C!=J;for(z=
0;z<J;z++)A[m(G[r][z][0],G[r][z][1])]&&N++;q.divideScalar(C);N=0;if(v){for(z=0;z<J;z++)if(C=G[r][z],H=1==n[m(C[0],C[1])].length)C=p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2),u.addSelf(C),N++;u.divideScalar(4);b(2==N,"should have only 2 boundary edges")}else{for(z=0;z<J;z++)C=G[r][z],C=p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2),u.addSelf(C);u.divideScalar(J)}B.addSelf(p[r]);v?(B.divideScalar(2),B.addSelf(u)):(B.multiplyScalar(J-3),B.addSelf(q),B.addSelf(u.multiplyScalar(2)),B.divideScalar(J));
...
1);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(v.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(v.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var N,B,J,H,I;for(N=0;N<A;N++)if(v=16/q,u.set(v*r,v),H=a[N],w.set(H.matrixWorld.elements[12],H.matrixWorld.elements[13],H.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(w),d.projectionMatrix.multiplyVector3(w),D.copy(w),C.x=D.x*E+E,C.y=D.y*z+z,j||0<C.x&&C.x<e&&0<C.y&&C.y<q){b.activeTexture(b.TEXTURE1);
