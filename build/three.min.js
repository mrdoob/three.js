...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],m=c[9],n=c[13],p=c[2],o=c[6],s=c[10],t=c[14],r=c[3],z=c[7],x=c[11],c=c[15],q=d[0],E=d[4],A=d[8],
u=d[12],v=d[1],D=d[5],C=d[9],G=d[13],M=d[2],B=d[6],K=d[10],H=d[14],I=d[3],O=d[7],N=d[11],d=d[15];e[0]=f*q+g*v+h*M+i*I;e[4]=f*E+g*D+h*B+i*O;e[8]=f*A+g*C+h*K+i*N;e[12]=f*u+g*G+h*H+i*d;e[1]=j*q+l*v+m*M+n*I;e[5]=j*E+l*D+m*B+n*O;e[9]=j*A+l*C+m*K+n*N;e[13]=j*u+l*G+m*H+n*d;e[2]=p*q+o*v+s*M+t*I;e[6]=p*E+o*D+s*B+t*O;e[10]=p*A+o*C+s*K+t*N;e[14]=p*u+o*G+s*H+t*d;e[3]=r*q+z*v+x*M+c*I;e[7]=r*E+z*D+x*B+c*O;e[11]=r*A+z*C+x*K+c*N;e[15]=r*u+z*G+x*H+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),l=Math.sin(b),m=1-j,n=d*e*m,p=d*f*m,m=e*f*m,d=d*l,o=e*l,l=f*l,f=g+(1-g)*j,g=n+l,e=p-o,n=n-l,h=h+(1-h)*j,l=m+d,p=p+o,m=m-d,i=i+(1-i)*j,j=c[0],d=c[1],o=c[2],s=c[3],t=c[4],r=c[5],z=c[6],x=c[7],q=c[8],E=c[9],A=c[10],u=c[11];c[0]=f*j+g*t+e*q;c[1]=f*d+g*r+e*E;c[2]=f*o+g*z+e*A;c[3]=f*s+g*x+e*u;c[4]=n*j+h*t+l*q;c[5]=n*d+h*r+l*E;c[6]=n*o+h*z+l*A;c[7]=n*s+h*x+l*u;c[8]=p*j+m*t+i*q;c[9]=p*d+m*r+i*E;c[10]=p*o+m*z+i*A;c[11]=p*s+m*x+i*u;
...
p=o.vertices,E=h.material instanceof a.MeshFaceMaterial,A=!0===E?h.material.materials:null,l=h.material.side,u,v,D,C=i.precision;h.matrixRotationWorld.extractRotation(h.matrixWorld);b.copy(i.origin);g.getInverse(h.matrixWorld);c.copy(b);g.multiplyVector3(c);d.copy(i.direction);g.rotateAxis(d).normalize();for(var G=0,M=o.faces.length;G<M;G++){var B=o.faces[G],l=!0===E?A[B.materialIndex]:h.material;if(void 0!==l&&(l=l.side,e.sub(B.centroid,c),v=B.normal,u=d.dot(v),!(Math.abs(u)<C)&&(v=v.dot(e)/u,!(0>
v)&&(l===a.DoubleSide||(l===a.FrontSide?0>u:0<u)))))if(f.add(c,d.multiplyScalar(v)),B instanceof a.Face3)l=p[B.a],u=p[B.b],v=p[B.c],n(f,l,u,v)&&(u=h.matrixWorld.multiplyVector3(f.clone()),l=b.distanceTo(u),l<i.near||l>i.far||j.push({distance:l,point:u,face:B,faceIndex:G,object:h}));else if(B instanceof a.Face4&&(l=p[B.a],u=p[B.b],v=p[B.c],D=p[B.d],n(f,l,u,D)||n(f,u,v,D)))u=h.matrixWorld.multiplyVector3(f.clone()),l=b.distanceTo(u),l<i.near||l>i.far||j.push({distance:l,point:u,face:B,faceIndex:G,object:h})}}},
...
c)return!1;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return!0}var e,f,g=[],h=0,i,j,l=[],m=0,n,p,o=[],s=0,t,r=[],z=0,x,q,E=[],A=0,u,v,D=[],C=0,G={objects:[],sprites:[],lights:[],elements:[]},M=new THREE.Vector3,B=new THREE.Vector4,K=new THREE.Matrix4,H=new THREE.Matrix4,I=new THREE.Matrix3,O=new THREE.Frustum,N=new THREE.Vector4,P=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);K.multiply(b.projectionMatrix,b.matrixWorldInverse);K.multiplyVector3(a);return a};
this.unprojectVector=function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);K.multiply(b.matrixWorld,b.projectionMatrixInverse);K.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,m,U){var Q=h.near,da=h.far,T=!1,R,ca,ia,aa,ja,$,fa,Ka,Na,La,Ga,pa,Ba,db,qb;v=q=t=p=0;G.elements.length=0;g.updateMatrixWorld();
void 0===h.parent&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);K.multiply(h.projectionMatrix,h.matrixWorldInverse);O.setFromMatrix(K);f=0;G.objects.length=0;G.sprites.length=0;G.lights.length=0;var jb=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof THREE.Light)G.lights.push(f);else if(f instanceof THREE.Mesh||f instanceof THREE.Line){if(!1===f.frustumCulled||!0===O.contains(f))e=a(),e.object=f,null!==f.renderDepth?
e.z=f.renderDepth:(M.copy(f.matrixWorld.getPosition()),K.multiplyVector3(M),e.z=M.z),G.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(M.copy(f.matrixWorld.getPosition()),K.multiplyVector3(M),e.z=M.z),G.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(M.copy(f.matrixWorld.getPosition()),K.multiplyVector3(M),e.z=M.z),G.objects.push(e));jb(f)}}};jb(g);!0===m&&G.objects.sort(c);g=0;for(m=G.objects.length;g<
m;g++)if(Ka=G.objects[g].object,Na=Ka.matrixWorld,j=0,Ka instanceof THREE.Mesh){La=Ka.geometry;ia=La.vertices;Ga=La.faces;La=La.faceVertexUvs;I.getInverse(Na);I.transpose();Ba=Ka.material instanceof THREE.MeshFaceMaterial;db=!0===Ba?Ka.material:null;R=0;for(ca=ia.length;R<ca;R++)i=b(),i.positionWorld.copy(ia[R]),Na.multiplyVector3(i.positionWorld),i.positionScreen.copy(i.positionWorld),K.multiplyVector4(i.positionScreen),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,
i.visible=i.positionScreen.z>Q&&i.positionScreen.z<da;ia=0;for(R=Ga.length;ia<R;ia++)if(ca=Ga[ia],qb=!0===Ba?db.materials[ca.materialIndex]:Ka.material,void 0!==qb){$=qb.side;if(ca instanceof THREE.Face3)if(aa=l[ca.a],ja=l[ca.b],fa=l[ca.c],!0===aa.visible&&!0===ja.visible&&!0===fa.visible)if(T=0>(fa.positionScreen.x-aa.positionScreen.x)*(ja.positionScreen.y-aa.positionScreen.y)-(fa.positionScreen.y-aa.positionScreen.y)*(ja.positionScreen.x-aa.positionScreen.x),$===THREE.DoubleSide||T===($===THREE.FrontSide))p===
s?(pa=new THREE.RenderableFace3,o.push(pa),s++,p++,n=pa):n=o[p++],n.v1.copy(aa),n.v2.copy(ja),n.v3.copy(fa);else continue;else continue;else if(ca instanceof THREE.Face4)if(aa=l[ca.a],ja=l[ca.b],fa=l[ca.c],pa=l[ca.d],!0===aa.visible&&!0===ja.visible&&!0===fa.visible&&!0===pa.visible)if(T=0>(pa.positionScreen.x-aa.positionScreen.x)*(ja.positionScreen.y-aa.positionScreen.y)-(pa.positionScreen.y-aa.positionScreen.y)*(ja.positionScreen.x-aa.positionScreen.x)||0>(ja.positionScreen.x-fa.positionScreen.x)*
(pa.positionScreen.y-fa.positionScreen.y)-(ja.positionScreen.y-fa.positionScreen.y)*(pa.positionScreen.x-fa.positionScreen.x),$===THREE.DoubleSide||T===($===THREE.FrontSide)){if(t===z){var ob=new THREE.RenderableFace4;r.push(ob);z++;t++;n=ob}else n=r[t++];n.v1.copy(aa);n.v2.copy(ja);n.v3.copy(fa);n.v4.copy(pa)}else continue;else continue;n.normalWorld.copy(ca.normal);!1===T&&($===THREE.BackSide||$===THREE.DoubleSide)&&n.normalWorld.negate();I.multiplyVector3(n.normalWorld).normalize();n.centroidWorld.copy(ca.centroid);
Na.multiplyVector3(n.centroidWorld);n.centroidScreen.copy(n.centroidWorld);K.multiplyVector3(n.centroidScreen);fa=ca.vertexNormals;aa=0;for(ja=fa.length;aa<ja;aa++)pa=n.vertexNormalsWorld[aa],pa.copy(fa[aa]),!1===T&&($===THREE.BackSide||$===THREE.DoubleSide)&&pa.negate(),I.multiplyVector3(pa).normalize();n.vertexNormalsLength=fa.length;aa=0;for(ja=La.length;aa<ja;aa++)if(pa=La[aa][ia],void 0!==pa){$=0;for(fa=pa.length;$<fa;$++)n.uvs[aa][$]=pa[$]}n.color=ca.color;n.material=qb;n.z=n.centroidScreen.z;
G.elements.push(n)}}else if(Ka instanceof THREE.Line){H.multiply(K,Na);ia=Ka.geometry.vertices;aa=b();aa.positionScreen.copy(ia[0]);H.multiplyVector4(aa.positionScreen);Na=Ka.type===THREE.LinePieces?2:1;R=1;for(ca=ia.length;R<ca;R++)aa=b(),aa.positionScreen.copy(ia[R]),H.multiplyVector4(aa.positionScreen),0<(R+1)%Na||(ja=l[j-2],N.copy(aa.positionScreen),P.copy(ja.positionScreen),!0===d(N,P)&&(N.multiplyScalar(1/N.w),P.multiplyScalar(1/P.w),q===A?(Ga=new THREE.RenderableLine,E.push(Ga),A++,q++,x=Ga):
x=E[q++],x.v1.positionScreen.copy(N),x.v2.positionScreen.copy(P),x.z=Math.max(N.z,P.z),x.material=Ka.material,G.elements.push(x)))}g=0;for(m=G.sprites.length;g<m;g++)Ka=G.sprites[g].object,Na=Ka.matrixWorld,Ka instanceof THREE.Particle&&(B.set(Na.elements[12],Na.elements[13],Na.elements[14],1),K.multiplyVector4(B),B.z/=B.w,0<B.z&&1>B.z&&(v===C?(Q=new THREE.RenderableParticle,D.push(Q),C++,v++,u=Q):u=D[v++],u.object=Ka,u.x=B.x/B.w,u.y=B.y/B.w,u.z=B.z,u.rotation=Ka.rotation.z,u.scale.x=Ka.scale.x*Math.abs(u.x-
(B.x+h.projectionMatrix.elements[0])/(B.w+h.projectionMatrix.elements[12])),u.scale.y=Ka.scale.y*Math.abs(u.y-(B.y+h.projectionMatrix.elements[5])/(B.w+h.projectionMatrix.elements[13])),u.material=Ka.material,G.elements.push(u)));!0===U&&G.elements.sort(c);return G}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=void 0!==d?d:1};
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,v){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];l=g[e];m=g[f];n=g[v];p=i.x-h.x;o=j.x-h.x;s=i.y-h.y;t=j.y-h.y;r=i.z-h.z;z=j.z-h.z;x=m.u-l.u;q=n.u-l.u;E=m.v-l.v;A=n.v-l.v;u=1/(x*A-q*E);G.set((A*p-E*o)*u,(A*s-E*t)*u,(A*r-E*z)*u);M.set((x*o-q*p)*u,(x*t-q*s)*u,(x*z-q*r)*u);D[b].addSelf(G);D[c].addSelf(G);D[d].addSelf(G);C[b].addSelf(M);C[c].addSelf(M);C[d].addSelf(M)}var b,c,d,e,f,g,h,i,j,l,m,n,p,o,s,t,r,z,
x,q,E,A,u,v,D=[],C=[],G=new THREE.Vector3,M=new THREE.Vector3,B=new THREE.Vector3,K=new THREE.Vector3,H=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)D[b]=new THREE.Vector3,C[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var I=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<
f.vertexNormals.length;d++)H.copy(f.vertexNormals[d]),e=f[I[d]],v=D[e],B.copy(v),B.subSelf(H.multiplyScalar(H.dot(v))).normalize(),K.cross(f.vertexNormals[d],v),e=K.dot(C[e]),e=0>e?-1:1,f.vertexTangents[d]=new THREE.Vector4(B.x,B.y,B.z,e)}this.hasTangents=!0},computeLineDistances:function(){for(var a=0,b=this.vertices,c=0,d=b.length;c<d;c++)0<c&&(a+=b[c].distanceTo(b[c-1])),this.lineDistances[c]=a},computeBoundingBox:function(){this.boundingBox||(this.boundingBox={min:new THREE.Vector3,max:new THREE.Vector3});
...
0}var e=this.offsets,f=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,m,n,p,o=new THREE.Vector3,s=new THREE.Vector3,t=new THREE.Vector3,r=new THREE.Vector3,z=new THREE.Vector3;c=0;for(d=e.length;c<d;++c){b=e[c].start;i=e[c].count;var x=e[c].index;a=b;for(b+=i;a<b;a+=3)i=x+f[a],j=x+f[a+1],l=x+f[a+2],m=g[3*i],n=g[3*i+1],p=g[3*i+2],o.set(m,n,p),m=g[3*j],n=g[3*j+1],p=g[3*j+2],s.set(m,n,p),m=g[3*l],n=g[3*l+1],p=g[3*l+2],t.set(m,n,p),r.sub(t,s),z.sub(o,
s),r.crossSelf(z),h[3*i]+=r.x,h[3*i+1]+=r.y,h[3*i+2]+=r.z,h[3*j]+=r.x,h[3*j+1]+=r.y,h[3*j+2]+=r.z,h[3*l]+=r.x,h[3*l+1]+=r.y,h[3*l+2]+=r.z}this.normalizeNormals();this.normalsNeedUpdate=!0}},normalizeNormals:function(){for(var a=this.attributes.normal.array,b,c,d,e=0,f=a.length;e<f;e+=3)b=a[e],c=a[e+1],d=a[e+2],b=1/Math.sqrt(b*b+c*c+d*d),a[e]*=b,a[e+1]*=b,a[e+2]*=b},computeTangents:function(){function a(a){Z.x=d[3*a];Z.y=d[3*a+1];Z.z=d[3*a+2];L.copy(Z);U=i[a];N.copy(U);N.subSelf(Z.multiplyScalar(Z.dot(U))).normalize();
P.cross(L,U);Q=P.dot(j[a]);J=0>Q?-1:1;h[4*a]=N.x;h[4*a+1]=N.y;h[4*a+2]=N.z;h[4*a+3]=J}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===this.attributes.uv)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,e=this.attributes.uv.array,f=c.length/3;if(void 0===this.attributes.tangent){var g=
4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,m,n,p,o,s,t,r,z,x,q,E,A,u,v,f=new THREE.Vector3,g=new THREE.Vector3,D,C,G,M,B,K,H,I=this.offsets;G=0;for(M=I.length;G<M;++G){C=I[G].start;B=I[G].count;var O=I[G].index;D=C;for(C+=B;D<C;D+=3)B=O+b[D],K=O+b[D+1],H=O+b[D+2],l=c[3*B],m=c[3*B+1],n=c[3*B+2],p=c[3*K],o=c[3*K+1],s=c[3*K+2],t=c[3*H],r=c[3*H+1],z=c[3*
H+2],x=e[2*B],q=e[2*B+1],E=e[2*K],A=e[2*K+1],u=e[2*H],v=e[2*H+1],p-=l,l=t-l,o-=m,m=r-m,s-=n,n=z-n,E-=x,x=u-x,A-=q,q=v-q,v=1/(E*q-x*A),f.set((q*p-A*l)*v,(q*o-A*m)*v,(q*s-A*n)*v),g.set((E*l-x*p)*v,(E*m-x*o)*v,(E*n-x*s)*v),i[B].addSelf(f),i[K].addSelf(f),i[H].addSelf(f),j[B].addSelf(g),j[K].addSelf(g),j[H].addSelf(g)}var N=new THREE.Vector3,P=new THREE.Vector3,Z=new THREE.Vector3,L=new THREE.Vector3,J,U,Q;G=0;for(M=I.length;G<M;++G){C=I[G].start;B=I[G].count;O=I[G].index;D=C;for(C+=B;D<C;D+=3)B=O+b[D],
K=O+b[D+1],H=O+b[D+2],a(B),a(K),a(H)}this.tangentsNeedUpdate=this.hasTangents=!0}},deallocate:function(){var a=THREE.GeometryLibrary.indexOf(this);-1!==a&&THREE.GeometryLibrary.splice(a,1)}};
...
a}function d(a){a=Math.log(a)/Math.LN2;return Math.pow(2,Math.round(a))}function e(a,e,f,h,i,j,t){var r=f.toLowerCase().endsWith(".dds"),z=b+"/"+f;if(r){var x=THREE.ImageUtils.loadCompressedTexture(z);a[e]=x}else x=document.createElement("canvas"),a[e]=new THREE.Texture(x);a[e].sourceFile=f;if(h&&(a[e].repeat.set(h[0],h[1]),1!==h[0]&&(a[e].wrapS=THREE.RepeatWrapping),1!==h[1]))a[e].wrapT=THREE.RepeatWrapping;i&&a[e].offset.set(i[0],i[1]);if(j&&(f={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,j,l,m,n,p,o,s,t,r,z,x,q;function E(a){return a%4?4-a%4:0}function A(a,b){return(new Uint8Array(a,b,1))[0]}function u(a,b){return(new Uint32Array(a,b,1))[0]}function v(b,c){var d,e,f,g,h,i,j,l=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=l[3*d],f=l[3*d+1],g=l[3*d+2],h=O[2*e],e=O[2*e+1],i=O[2*f],j=O[2*f+1],f=O[2*g],g=O[2*g+1],K.faceVertexUvs[0].push([new THREE.UV(h,e),new THREE.UV(i,j),new THREE.UV(f,g)])}function D(b,
c){var d,e,f,g,h,i,j,l,n,m=new Uint32Array(a,c,4*b);for(d=0;d<b;d++)e=m[4*d],f=m[4*d+1],g=m[4*d+2],h=m[4*d+3],i=O[2*e],e=O[2*e+1],j=O[2*f],l=O[2*f+1],f=O[2*g],n=O[2*g+1],g=O[2*h],h=O[2*h+1],K.faceVertexUvs[0].push([new THREE.UV(i,e),new THREE.UV(j,l),new THREE.UV(f,n),new THREE.UV(g,h)])}function C(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],K.faces.push(new THREE.Face3(e,f,g,null,null,h))}function G(b,c,d){for(var e,
...
j],I[3*j+1],I[3*j+2]),new THREE.Vector3(o,p,l),new THREE.Vector3(s,r,n)],null,i))}}function B(b,c,d,e){for(var f,g,h,i,j,l,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];l=d[4*e];n=d[4*e+1];m=d[4*e+2];o=d[4*e+3];j=p[e];var s=I[3*n],r=I[3*n+1];n=I[3*n+2];var q=I[3*m],t=I[3*m+1];m=I[3*m+2];var v=I[3*o],u=I[3*o+1];o=I[3*o+2];K.faces.push(new THREE.Face4(f,g,h,i,[new THREE.Vector3(I[3*l],I[3*l+1],I[3*l+2]),new THREE.Vector3(s,
r,n),new THREE.Vector3(q,t,m),new THREE.Vector3(v,u,o)],null,j))}}var K=this,H=0,I=[],O=[],N,P,Z;THREE.Geometry.call(this);q=a;P=H;z=new Uint8Array(q,P,12);o="";for(r=0;12>r;r++)o+=String.fromCharCode(z[P+r]);b=A(q,P+12);A(q,P+13);A(q,P+14);A(q,P+15);c=A(q,P+16);d=A(q,P+17);e=A(q,P+18);j=A(q,P+19);l=u(q,P+20);m=u(q,P+20+4);n=u(q,P+20+8);p=u(q,P+20+12);o=u(q,P+20+16);s=u(q,P+20+20);t=u(q,P+20+24);r=u(q,P+20+28);z=u(q,P+20+32);x=u(q,P+20+36);q=u(q,P+20+40);H+=b;P=3*c+j;Z=4*c+j;N=p*P;b=o*(P+3*d);c=s*
(P+3*e);j=t*(P+3*d+3*e);P=r*Z;d=z*(Z+4*d);e=x*(Z+4*e);Z=H;var H=new Float32Array(a,H,3*l),L,J,U,Q;for(L=0;L<l;L++)J=H[3*L],U=H[3*L+1],Q=H[3*L+2],K.vertices.push(new THREE.Vector3(J,U,Q));l=H=Z+3*l*Float32Array.BYTES_PER_ELEMENT;if(m){H=new Int8Array(a,H,3*m);for(Z=0;Z<m;Z++)L=H[3*Z],J=H[3*Z+1],U=H[3*Z+2],I.push(L/127,J/127,U/127)}H=l+3*m*Int8Array.BYTES_PER_ELEMENT;m=H+=E(3*m);if(n){l=new Float32Array(a,H,2*n);for(H=0;H<n;H++)Z=l[2*H],L=l[2*H+1],O.push(Z,L)}n=H=m+2*n*Float32Array.BYTES_PER_ELEMENT;
N=n+N+E(2*p);m=N+b+E(2*o);b=m+c+E(2*s);c=b+j+E(2*t);P=c+P+E(2*r);j=P+d+E(2*z);d=j+e+E(2*x);s&&(e=m+3*s*Uint32Array.BYTES_PER_ELEMENT,C(s,m,e+3*s*Uint32Array.BYTES_PER_ELEMENT),v(s,e));t&&(s=b+3*t*Uint32Array.BYTES_PER_ELEMENT,e=s+3*t*Uint32Array.BYTES_PER_ELEMENT,M(t,b,s,e+3*t*Uint32Array.BYTES_PER_ELEMENT),v(t,e));x&&(t=j+4*x*Uint32Array.BYTES_PER_ELEMENT,G(x,j,t+4*x*Uint32Array.BYTES_PER_ELEMENT),D(x,t));q&&(x=d+4*q*Uint32Array.BYTES_PER_ELEMENT,t=x+4*q*Uint32Array.BYTES_PER_ELEMENT,B(q,d,x,t+4*
q*Uint32Array.BYTES_PER_ELEMENT),D(q,t));p&&C(p,n,n+3*p*Uint32Array.BYTES_PER_ELEMENT);o&&(p=N+3*o*Uint32Array.BYTES_PER_ELEMENT,M(o,N,p,p+3*o*Uint32Array.BYTES_PER_ELEMENT));r&&G(r,c,c+4*r*Uint32Array.BYTES_PER_ELEMENT);z&&(o=P+4*z*Uint32Array.BYTES_PER_ELEMENT,B(z,P,o,o+4*z*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals()};e.prototype=Object.create(THREE.Geometry.prototype);e=new e(c);c=this.initMaterials(d,c);this.needsTangents(c)&&e.computeTangents();b(e,c)};
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,j,l,m,n,p,o,s,t,r,z,x,q=a.faces;o=a.vertices;var E=a.normals,A=a.colors,u=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&u++;for(f=0;f<u;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(j=o.length;i<j;)l=new THREE.Vector3,l.x=o[i++]*e,l.y=o[i++]*e,l.z=o[i++]*e,d.vertices.push(l);i=0;for(j=q.length;i<j;){o=q[i++];l=o&1;h=o&2;f=o&4;g=o&8;n=o&16;m=o&32;s=o&64;o&=128;l?(t=new THREE.Face4,
t.a=q[i++],t.b=q[i++],t.c=q[i++],t.d=q[i++],l=4):(t=new THREE.Face3,t.a=q[i++],t.b=q[i++],t.c=q[i++],l=3);h&&(h=q[i++],t.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<u;f++)r=a.uvs[f],p=q[i++],x=r[2*p],p=r[2*p+1],d.faceUvs[f][h]=new THREE.UV(x,p);if(g)for(f=0;f<u;f++){r=a.uvs[f];z=[];for(g=0;g<l;g++)p=q[i++],x=r[2*p],p=r[2*p+1],z[g]=new THREE.UV(x,p);d.faceVertexUvs[f][h]=z}n&&(n=3*q[i++],g=new THREE.Vector3,g.x=E[n++],g.y=E[n++],g.z=E[n],t.normal=g);if(m)for(f=0;f<l;f++)n=3*q[i++],g=new THREE.Vector3,
...
d.animation=a.animation;if(void 0!==a.morphTargets){i=0;for(j=a.morphTargets.length;i<j;i++){d.morphTargets[i]={};d.morphTargets[i].name=a.morphTargets[i].name;d.morphTargets[i].vertices=[];A=d.morphTargets[i].vertices;u=a.morphTargets[i].vertices;q=0;for(E=u.length;q<E;q+=3)o=new THREE.Vector3,o.x=u[q]*e,o.y=u[q+1]*e,o.z=u[q+2]*e,A.push(o)}}if(void 0!==a.morphColors){i=0;for(j=a.morphColors.length;i<j;i++){d.morphColors[i]={};d.morphColors[i].name=a.morphColors[i].name;d.morphColors[i].colors=[];
E=d.morphColors[i].colors;A=a.morphColors[i].colors;e=0;for(q=A.length;e<q;e+=3)u=new THREE.Color(16755200),u.setRGB(A[e],A[e+1],A[e+2]),E.push(u)}}d.computeCentroids();d.computeFaceNormals();a=this.initMaterials(a.materials,c);this.needsTangents(a)&&d.computeTangents();b(d,a)};
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return"relativeToHTML"==b?a:m+"/"+a}function e(){f(L.scene,U.objects)}function f(a,b){for(var c in b)if(void 0===L.objects[c]){var e=b[c],g=null;if(e.type&&e.type in l.hierarchyHandlerMap&&void 0===e.loading){var i={},j;for(j in t)"type"!==j&&"url"!==j&&(i[j]=t[j]);C=L.materials[e.material];e.loading=!0;var n=l.hierarchyHandlerMap[e.type].loaderObject;n.addEventListener?(n.addEventListener("load",h(c,a,C,e)),n.load(d(e.url,U.urlBaseType))):
n.options?n.load(d(e.url,U.urlBaseType),h(c,a,C,e)):n.load(d(e.url,U.urlBaseType),h(c,a,C,e),i)}else if(void 0!==e.geometry){if(D=L.geometries[e.geometry]){g=!1;C=L.materials[e.material];g=C instanceof THREE.ShaderMaterial;x=e.position;q=e.rotation;E=e.quaternion;A=e.scale;r=e.matrix;E=0;e.material||(C=new THREE.MeshFaceMaterial(L.face_materials[e.geometry]));C instanceof THREE.MeshFaceMaterial&&0===C.materials.length&&(C=new THREE.MeshFaceMaterial(L.face_materials[e.geometry]));if(C instanceof THREE.MeshFaceMaterial)for(i=
...
r[15])):(g.position.set(x[0],x[1],x[2]),E?(g.quaternion.set(E[0],E[1],E[2],E[3]),g.useQuaternion=!0):g.rotation.set(q[0],q[1],q[2]),g.scale.set(A[0],A[1],A[2]));g.visible=e.visible;g.castShadow=e.castShadow;g.receiveShadow=e.receiveShadow;a.add(g);L.objects[c]=g}}else"DirectionalLight"===e.type||"PointLight"===e.type||"AmbientLight"===e.type?(H=void 0!==e.color?e.color:16777215,I=void 0!==e.intensity?e.intensity:1,"DirectionalLight"===e.type?(x=e.direction,K=new THREE.DirectionalLight(H,I),K.position.set(x[0],
x[1],x[2]),e.target&&(J.push({object:K,targetName:e.target}),K.target=null)):"PointLight"===e.type?(x=e.position,z=e.distance,K=new THREE.PointLight(H,I,z),K.position.set(x[0],x[1],x[2])):"AmbientLight"===e.type&&(K=new THREE.AmbientLight(H)),a.add(K),K.name=c,L.lights[c]=K,L.objects[c]=K):"PerspectiveCamera"===e.type||"OrthographicCamera"===e.type?("PerspectiveCamera"===e.type?G=new THREE.PerspectiveCamera(e.fov,e.aspect,e.near,e.far):"OrthographicCamera"===e.type&&(G=new THREE.OrthographicCamera(u.left,
u.right,u.top,u.bottom,u.near,u.far)),x=e.position,G.position.set(x[0],x[1],x[2]),a.add(G),G.name=c,L.cameras[c]=G,L.objects[c]=G):(x=e.position,q=e.rotation,E=e.quaternion,A=e.scale,E=0,g=new THREE.Object3D,g.name=c,g.position.set(x[0],x[1],x[2]),E?(g.quaternion.set(E[0],E[1],E[2],E[3]),g.useQuaternion=!0):g.rotation.set(q[0],q[1],q[2]),g.scale.set(A[0],A[1],A[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),L.objects[c]=g,L.empties[c]=g);if(g){if(void 0!==e.properties)for(var m in e.properties)g.properties[m]=
e.properties[m];void 0!==e.children&&f(g,e.children)}}}function g(a){return function(b,c){L.geometries[a]=b;L.face_materials[a]=c;e();O-=1;l.onLoadComplete();j()}}function h(a,b,c,d){return function(f){var f=f.content?f.content:f.dae?f.scene:f,g=d.position,h=d.rotation,i=d.quaternion,n=d.scale;f.position.set(g[0],g[1],g[2]);i?(f.quaternion.set(i[0],i[1],i[2],i[3]),f.useQuaternion=!0):f.rotation.set(h[0],h[1],h[2]);f.scale.set(n[0],n[1],n[2]);c&&f.traverse(function(a){a.material=c});b.add(f);L.objects[a]=
f;e();O-=1;l.onLoadComplete();j()}}function i(a){return function(b,c){L.geometries[a]=b;L.face_materials[a]=c}}function j(){l.callbackProgress({totalModels:P,totalTextures:Z,loadedModels:P-O,loadedTextures:Z-N},L);l.onLoadProgress();if(0===O&&0===N){for(var a=0;a<J.length;a++){var c=J[a],d=L.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,L.scene.add(c.object.target));c.object.target.properties.targetInverse=c.object}b(L)}}var l=this,m=THREE.Loader.prototype.extractUrlBase(c),
n,p,o,s,t,r,z,x,q,E,A,u,v,D,C,G,M,B,K,H,I,O,N,P,Z,L,J=[],U=a,Q;for(Q in this.geometryHandlerMap)a=this.geometryHandlerMap[Q].loaderClass,this.geometryHandlerMap[Q].loaderObject=new a;for(Q in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[Q].loaderClass,this.hierarchyHandlerMap[Q].loaderObject=new a;N=O=0;L={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(U.transform&&(Q=U.transform.position,a=U.transform.rotation,
c=U.transform.scale,Q&&L.scene.position.set(Q[0],Q[1],Q[2]),a&&L.scene.rotation.set(a[0],a[1],a[2]),c&&L.scene.scale.set(c[0],c[1],c[2]),Q||a||c))L.scene.updateMatrix(),L.scene.updateMatrixWorld();Q=function(a){return function(){N-=a;j();l.onLoadComplete()}};for(o in U.fogs)a=U.fogs[o],"linear"===a.type?M=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(M=new THREE.FogExp2(0,a.density)),u=a.color,M.color.setRGB(u[0],u[1],u[2]),L.fogs[o]=M;for(n in U.geometries)t=U.geometries[n],t.type in this.geometryHandlerMap&&
(O+=1,l.onLoadStart());for(var da in U.objects)o=U.objects[da],o.type&&o.type in this.hierarchyHandlerMap&&(O+=1,l.onLoadStart());P=O;for(n in U.geometries)if(t=U.geometries[n],"cube"===t.type)D=new THREE.CubeGeometry(t.width,t.height,t.depth,t.widthSegments,t.heightSegments,t.depthSegments),L.geometries[n]=D;else if("plane"===t.type)D=new THREE.PlaneGeometry(t.width,t.height,t.widthSegments,t.heightSegments),L.geometries[n]=D;else if("sphere"===t.type)D=new THREE.SphereGeometry(t.radius,t.widthSegments,
t.heightSegments),L.geometries[n]=D;else if("cylinder"===t.type)D=new THREE.CylinderGeometry(t.topRad,t.botRad,t.height,t.radSegs,t.heightSegs),L.geometries[n]=D;else if("torus"===t.type)D=new THREE.TorusGeometry(t.radius,t.tube,t.segmentsR,t.segmentsT),L.geometries[n]=D;else if("icosahedron"===t.type)D=new THREE.IcosahedronGeometry(t.radius,t.subdivisions),L.geometries[n]=D;else if(t.type in this.geometryHandlerMap){da={};for(B in t)"type"!==B&&"url"!==B&&(da[B]=t[B]);this.geometryHandlerMap[t.type].loaderObject.load(d(t.url,
U.urlBaseType),g(n),da)}else"embedded"===t.type&&(da=U.embeds[t.id],da.metadata=U.metadata,da&&this.geometryHandlerMap.ascii.loaderObject.createModel(da,i(n),""));for(s in U.textures)if(n=U.textures[s],n.url instanceof Array){N+=n.url.length;for(B=0;B<n.url.length;B++)l.onLoadStart()}else N+=1,l.onLoadStart();Z=N;for(s in U.textures){n=U.textures[s];void 0!==n.mapping&&void 0!==THREE[n.mapping]&&(n.mapping=new THREE[n.mapping]);if(n.url instanceof Array){da=n.url.length;o=[];for(B=0;B<da;B++)o[B]=
d(n.url[B],U.urlBaseType);B=(B=o[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(o,n.mapping,Q(da)):THREE.ImageUtils.loadTextureCube(o,n.mapping,Q(da))}else{B=n.url.toLowerCase().endsWith(".dds");da=d(n.url,U.urlBaseType);o=Q(1);B=B?THREE.ImageUtils.loadCompressedTexture(da,n.mapping,o):THREE.ImageUtils.loadTexture(da,n.mapping,o);void 0!==THREE[n.minFilter]&&(B.minFilter=THREE[n.minFilter]);void 0!==THREE[n.magFilter]&&(B.magFilter=THREE[n.magFilter]);n.anisotropy&&(B.anisotropy=
n.anisotropy);if(n.repeat&&(B.repeat.set(n.repeat[0],n.repeat[1]),1!==n.repeat[0]&&(B.wrapS=THREE.RepeatWrapping),1!==n.repeat[1]))B.wrapT=THREE.RepeatWrapping;n.offset&&B.offset.set(n.offset[0],n.offset[1]);if(n.wrap&&(da={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==da[n.wrap[0]]&&(B.wrapS=da[n.wrap[0]]),void 0!==da[n.wrap[1]]))B.wrapT=da[n.wrap[1]]}L.textures[s]=B}for(p in U.materials){r=U.materials[p];for(v in r.parameters)"envMap"===v||"map"===v||"lightMap"===v||
"bumpMap"===v?r.parameters[v]=L.textures[r.parameters[v]]:"shading"===v?r.parameters[v]="flat"===r.parameters[v]?THREE.FlatShading:THREE.SmoothShading:"side"===v?r.parameters[v]="double"==r.parameters[v]?THREE.DoubleSide:"back"==r.parameters[v]?THREE.BackSide:THREE.FrontSide:"blending"===v?r.parameters[v]=r.parameters[v]in THREE?THREE[r.parameters[v]]:THREE.NormalBlending:"combine"===v?r.parameters[v]="MixOperation"==r.parameters[v]?THREE.MixOperation:THREE.MultiplyOperation:"vertexColors"===v?"face"==
r.parameters[v]?r.parameters[v]=THREE.FaceColors:r.parameters[v]&&(r.parameters[v]=THREE.VertexColors):"wrapRGB"===v&&(s=r.parameters[v],r.parameters[v]=new THREE.Vector3(s[0],s[1],s[2]));void 0!==r.parameters.opacity&&1>r.parameters.opacity&&(r.parameters.transparent=!0);r.parameters.normalMap?(s=THREE.ShaderUtils.lib.normal,Q=THREE.UniformsUtils.clone(s.uniforms),n=r.parameters.color,B=r.parameters.specular,da=r.parameters.ambient,o=r.parameters.shininess,Q.tNormal.value=L.textures[r.parameters.normalMap],
r.parameters.normalScale&&Q.uNormalScale.value.set(r.parameters.normalScale[0],r.parameters.normalScale[1]),r.parameters.map&&(Q.tDiffuse.value=r.parameters.map,Q.enableDiffuse.value=!0),r.parameters.envMap&&(Q.tCube.value=r.parameters.envMap,Q.enableReflection.value=!0,Q.uReflectivity.value=r.parameters.reflectivity),r.parameters.lightMap&&(Q.tAO.value=r.parameters.lightMap,Q.enableAO.value=!0),r.parameters.specularMap&&(Q.tSpecular.value=L.textures[r.parameters.specularMap],Q.enableSpecular.value=
!0),r.parameters.displacementMap&&(Q.tDisplacement.value=L.textures[r.parameters.displacementMap],Q.enableDisplacement.value=!0,Q.uDisplacementBias.value=r.parameters.displacementBias,Q.uDisplacementScale.value=r.parameters.displacementScale),Q.uDiffuseColor.value.setHex(n),Q.uSpecularColor.value.setHex(B),Q.uAmbientColor.value.setHex(da),Q.uShininess.value=o,r.parameters.opacity&&(Q.uOpacity.value=r.parameters.opacity),C=new THREE.ShaderMaterial({fragmentShader:s.fragmentShader,vertexShader:s.vertexShader,
uniforms:Q,lights:!0,fog:!0})):C=new THREE[r.type](r.parameters);L.materials[p]=C}for(p in U.materials)if(r=U.materials[p],r.parameters.materials){v=[];for(B=0;B<r.parameters.materials.length;B++)v.push(L.materials[r.parameters.materials[B]]);L.materials[p].materials=v}e();L.cameras&&U.defaults.camera&&(L.currentCamera=L.cameras[U.defaults.camera]);L.fogs&&U.defaults.fog&&(L.scene.fog=L.fogs[U.defaults.fog]);u=U.defaults.bgcolor;L.bgColor=new THREE.Color;L.bgColor.setRGB(u[0],u[1],u[2]);L.bgColorAlpha=
U.defaults.bgalpha;l.callbackSync(L);j()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
THREE.ParticleBasicMaterial.prototype.clone=function(){var a=new THREE.ParticleBasicMaterial;THREE.Material.prototype.clone.call(this,a);a.color.copy(this.color);a.map=this.map;a.size=this.size;a.sizeAttenuation=this.sizeAttenuation;a.vertexColors=this.vertexColors;a.fog=this.fog;return a};THREE.ParticleDepthMaterial=function(a){THREE.Material.call(this);this.color=new THREE.Color(16777215);this.map=null;this.size=1;this.sizeAttenuation=!0;this.setValues(a)};
THREE.ParticleDepthMaterial.prototype=Object.create(THREE.Material.prototype);THREE.ParticleDepthMaterial.prototype.clone=function(){var a=new THREE.ParticleDepthMaterial;THREE.Material.prototype.clone.call(this,a);a.color.copy(this.color);a.map=this.map;a.size=this.size;a.sizeAttenuation=this.sizeAttenuation;return a};THREE.ParticleCanvasMaterial=function(a){THREE.Material.call(this);this.color=new THREE.Color(16777215);this.program=function(){};this.setValues(a)};
THREE.ParticleCanvasMaterial.prototype=Object.create(THREE.Material.prototype);THREE.ParticleCanvasMaterial.prototype.clone=function(){var a=new THREE.ParticleCanvasMaterial;THREE.Material.prototype.clone.call(this,a);a.color.copy(this.color);a.program=this.program;return a};THREE.ParticleDOMMaterial=function(a){this.element=a};THREE.ParticleDOMMaterial.prototype.clone=function(){return new THREE.ParticleDOMMaterial(this.element)};
...
THREE.CanvasRenderer=function(a){function b(a){z!==a&&(z=s.globalAlpha=a)}function c(a){x!==a&&(a===THREE.NormalBlending?s.globalCompositeOperation="source-over":a===THREE.AdditiveBlending?s.globalCompositeOperation="lighter":a===THREE.SubtractiveBlending&&(s.globalCompositeOperation="darker"),x=a)}function d(a){q!==a&&(q=s.strokeStyle=a)}function e(a){E!==a&&(E=s.fillStyle=a)}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},f=this,g,h,i,j=new THREE.Projector,l=void 0!==a.canvas?a.canvas:
document.createElement("canvas"),m,n,p,o,s=l.getContext("2d"),t=new THREE.Color(0),r=0,z=1,x=0,q=null,E=null,A=null,u=null,v=null,D,C,G,M,B=new THREE.RenderableVertex,K=new THREE.RenderableVertex,H,I,O,N,P,Z,L,J,U,Q,da,T,R=new THREE.Color,ca=new THREE.Color,ia=new THREE.Color,aa=new THREE.Color,ja=new THREE.Color,$=new THREE.Color,fa=new THREE.Color,Ka={},Na={},La,Ga,pa,Ba,db,qb,jb,ob,Ab,Bb,nb=new THREE.Rectangle,Oa=new THREE.Rectangle,va=new THREE.Rectangle,kb=!1,la=new THREE.Color,fb=new THREE.Color,
eb=new THREE.Color,qa=new THREE.Vector3,pb,$a,rb,Ra,Ha,Xa,a=16;pb=document.createElement("canvas");pb.width=pb.height=2;$a=pb.getContext("2d");$a.fillStyle="rgba(0,0,0,1)";$a.fillRect(0,0,2,2);rb=$a.getImageData(0,0,2,2);Ra=rb.data;Ha=document.createElement("canvas");Ha.width=Ha.height=a;Xa=Ha.getContext("2d");Xa.translate(-a/2,-a/2);Xa.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){m=a;n=b;p=
Math.floor(m/2);o=Math.floor(n/2);l.width=m;l.height=n;nb.set(-p,-o,p,o);Oa.set(-p,-o,p,o);z=1;x=0;v=u=A=E=q=null};this.setClearColor=function(a,b){t.copy(a);r=void 0!==b?b:1;Oa.set(-p,-o,p,o)};this.setClearColorHex=function(a,b){t.setHex(a);r=void 0!==b?b:1;Oa.set(-p,-o,p,o)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){s.setTransform(1,0,0,-1,p,o);!1===Oa.isEmpty()&&(Oa.minSelf(nb),Oa.inflate(2),1>r&&s.clearRect(Math.floor(Oa.getX()),Math.floor(Oa.getY()),Math.floor(Oa.getWidth()),
Math.floor(Oa.getHeight())),0<r&&(c(THREE.NormalBlending),b(1),e("rgba("+Math.floor(255*t.r)+","+Math.floor(255*t.g)+","+Math.floor(255*t.b)+","+r+")"),s.fillRect(Math.floor(Oa.getX()),Math.floor(Oa.getY()),Math.floor(Oa.getWidth()),Math.floor(Oa.getHeight()))),Oa.empty())};this.render=function(a,k){function l(a,b,c){for(var d=0,e=i.length;d<e;d++){var f=i[d],g=f.color;if(f instanceof THREE.DirectionalLight){var h=f.matrixWorld.getPosition().normalize(),k=b.dot(h);0>=k||(k*=f.intensity,c.r+=g.r*k,
c.g+=g.g*k,c.b+=g.b*k)}else f instanceof THREE.PointLight&&(h=f.matrixWorld.getPosition(),k=b.dot(qa.sub(h,a).normalize()),0>=k||(k*=0==f.distance?1:1-Math.min(a.distanceTo(h)/f.distance,1),0!=k&&(k*=f.intensity,c.r+=g.r*k,c.g+=g.g*k,c.b+=g.b*k)))}}function n(a,d,e,g,h,i,j,o){f.info.render.vertices+=3;f.info.render.faces++;b(o.opacity);c(o.blending);H=a.positionScreen.x;I=a.positionScreen.y;O=d.positionScreen.x;N=d.positionScreen.y;P=e.positionScreen.x;Z=e.positionScreen.y;m(H,I,O,N,P,Z);(o instanceof
THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)&&null===o.map&&null===o.map?($.copy(o.color),fa.copy(o.emissive),o.vertexColors===THREE.FaceColors&&($.r*=j.color.r,$.g*=j.color.g,$.b*=j.color.b),!0===kb)?!1===o.wireframe&&o.shading==THREE.SmoothShading&&3==j.vertexNormalsLength?(ca.r=ia.r=aa.r=la.r,ca.g=ia.g=aa.g=la.g,ca.b=ia.b=aa.b=la.b,l(j.v1.positionWorld,j.vertexNormalsWorld[0],ca),l(j.v2.positionWorld,j.vertexNormalsWorld[1],ia),l(j.v3.positionWorld,j.vertexNormalsWorld[2],aa),
ca.r=ca.r*$.r+fa.r,ca.g=ca.g*$.g+fa.g,ca.b=ca.b*$.b+fa.b,ia.r=ia.r*$.r+fa.r,ia.g=ia.g*$.g+fa.g,ia.b=ia.b*$.b+fa.b,aa.r=aa.r*$.r+fa.r,aa.g=aa.g*$.g+fa.g,aa.b=aa.b*$.b+fa.b,ja.r=0.5*(ia.r+aa.r),ja.g=0.5*(ia.g+aa.g),ja.b=0.5*(ia.b+aa.b),pa=bb(ca,ia,aa,ja),z(H,I,O,N,P,Z,0,0,1,0,0,1,pa)):(R.r=la.r,R.g=la.g,R.b=la.b,l(j.centroidWorld,j.normalWorld,R),R.r=R.r*$.r+fa.r,R.g=R.g*$.g+fa.g,R.b=R.b*$.b+fa.b,!0===o.wireframe?q(R,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(R)):!0===o.wireframe?
q(o.color,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(o.color):o instanceof THREE.MeshBasicMaterial||o instanceof THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial?null!==o.map?o.map.mapping instanceof THREE.UVMapping&&(Ba=j.uvs[0],x(H,I,O,N,P,Z,Ba[g].u,Ba[g].v,Ba[h].u,Ba[h].v,Ba[i].u,Ba[i].v,o.map)):null!==o.envMap?o.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=k.matrixWorldInverse,qa.copy(j.vertexNormalsWorld[g]),db=0.5*(qa.x*a.elements[0]+qa.y*
a.elements[4]+qa.z*a.elements[8])+0.5,qb=0.5*(qa.x*a.elements[1]+qa.y*a.elements[5]+qa.z*a.elements[9])+0.5,qa.copy(j.vertexNormalsWorld[h]),jb=0.5*(qa.x*a.elements[0]+qa.y*a.elements[4]+qa.z*a.elements[8])+0.5,ob=0.5*(qa.x*a.elements[1]+qa.y*a.elements[5]+qa.z*a.elements[9])+0.5,qa.copy(j.vertexNormalsWorld[i]),Ab=0.5*(qa.x*a.elements[0]+qa.y*a.elements[4]+qa.z*a.elements[8])+0.5,Bb=0.5*(qa.x*a.elements[1]+qa.y*a.elements[5]+qa.z*a.elements[9])+0.5,x(H,I,O,N,P,Z,db,qb,jb,ob,Ab,Bb,o.envMap)):(R.copy(o.color),
o.vertexColors===THREE.FaceColors&&(R.r*=j.color.r,R.g*=j.color.g,R.b*=j.color.b),!0===o.wireframe?q(R,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(R)):o instanceof THREE.MeshDepthMaterial?(La=k.near,Ga=k.far,ca.r=ca.g=ca.b=1-dc(a.positionScreen.z,La,Ga),ia.r=ia.g=ia.b=1-dc(d.positionScreen.z,La,Ga),aa.r=aa.g=aa.b=1-dc(e.positionScreen.z,La,Ga),ja.r=0.5*(ia.r+aa.r),ja.g=0.5*(ia.g+aa.g),ja.b=0.5*(ia.b+aa.b),pa=bb(ca,ia,aa,ja),z(H,I,O,N,P,Z,0,0,1,0,0,1,pa)):o instanceof THREE.MeshNormalMaterial&&
(R.r=Db(j.normalWorld.x),R.g=Db(j.normalWorld.y),R.b=Db(j.normalWorld.z),!0===o.wireframe?q(R,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(R))}function m(a,b,c,d,e,f){s.beginPath();s.moveTo(a,b);s.lineTo(c,d);s.lineTo(e,f);s.closePath()}function r(a,b,c,d,e,f,g,h){s.beginPath();s.moveTo(a,b);s.lineTo(c,d);s.lineTo(e,f);s.lineTo(g,h);s.closePath()}function q(a,b,c,e){A!==b&&(A=s.lineWidth=b);u!==c&&(u=s.lineCap=c);v!==e&&(v=s.lineJoin=e);d(a.getContextStyle());s.stroke();va.inflate(2*
b)}function t(a){e(a.getContextStyle());s.fill()}function x(a,b,c,d,f,g,h,k,i,j,l,bb,n){if(!(n instanceof THREE.DataTexture||void 0===n.image||0==n.image.width)){if(!0===n.needsUpdate){var m=n.wrapS==THREE.RepeatWrapping,o=n.wrapT==THREE.RepeatWrapping;Ka[n.id]=s.createPattern(n.image,!0===m&&!0===o?"repeat":!0===m&&!1===o?"repeat-x":!1===m&&!0===o?"repeat-y":"no-repeat");n.needsUpdate=!1}void 0===Ka[n.id]?e("rgba(0,0,0,1)"):e(Ka[n.id]);var m=n.offset.x/n.repeat.x,o=n.offset.y/n.repeat.y,Db=n.image.width*
n.repeat.x,p=n.image.height*n.repeat.y,h=(h+m)*Db,k=(1-k+o)*p,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+m)*Db-h,j=(1-j+o)*p-k,l=(l+m)*Db-h,bb=(1-bb+o)*p-k,m=i*bb-l*j;0===m?(void 0===Na[n.id]&&(b=document.createElement("canvas"),b.width=n.image.width,b.height=n.image.height,b=b.getContext("2d"),b.drawImage(n.image,0,0),Na[n.id]=b.getImageData(0,0,n.image.width,n.image.height).data),b=Na[n.id],h=4*(Math.floor(h)+Math.floor(k)*n.image.width),R.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),t(R)):(m=1/m,n=(bb*c-j*f)*m,j=
(bb*d-j*g)*m,c=(i*f-l*c)*m,d=(i*g-l*d)*m,a=a-n*h-c*k,h=b-j*h-d*k,s.save(),s.transform(n,j,c,d,a,h),s.fill(),s.restore())}}function z(a,b,c,d,e,f,g,h,k,i,j,l,n){var bb,m;bb=n.width-1;m=n.height-1;g*=bb;h*=m;c-=a;d-=b;e-=a;f-=b;k=k*bb-g;i=i*m-h;j=j*bb-g;l=l*m-h;m=1/(k*l-j*i);bb=(l*c-i*e)*m;i=(l*d-i*f)*m;c=(k*e-j*c)*m;d=(k*f-j*d)*m;a=a-bb*g-c*h;b=b-i*g-d*h;s.save();s.transform(bb,i,c,d,a,b);s.clip();s.drawImage(n,0,0);s.restore()}function bb(a,b,c,d){Ra[0]=255*a.r|0;Ra[1]=255*a.g|0;Ra[2]=255*a.b|0;Ra[4]=
255*b.r|0;Ra[5]=255*b.g|0;Ra[6]=255*b.b|0;Ra[8]=255*c.r|0;Ra[9]=255*c.g|0;Ra[10]=255*c.b|0;Ra[12]=255*d.r|0;Ra[13]=255*d.g|0;Ra[14]=255*d.b|0;$a.putImageData(rb,0,0);Xa.drawImage(pb,0,0);return Ha}function dc(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function Db(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function Yb(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===k instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
else{var Zb,zc,ma,ea;!0===this.autoClear?this.clear():s.setTransform(1,0,0,-1,p,o);f.info.render.vertices=0;f.info.render.faces=0;g=j.projectScene(a,k,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;kb=0<i.length;if(!0===kb){la.setRGB(0,0,0);fb.setRGB(0,0,0);eb.setRGB(0,0,0);Zb=0;for(zc=i.length;Zb<zc;Zb++){ea=i[Zb];var na=ea.color;ea instanceof THREE.AmbientLight?(la.r+=na.r,la.g+=na.g,la.b+=na.b):ea instanceof THREE.DirectionalLight?(fb.r+=na.r,fb.g+=na.g,fb.b+=na.b):ea instanceof THREE.PointLight&&
(eb.r+=na.r,eb.g+=na.g,eb.b+=na.b)}}Zb=0;for(zc=h.length;Zb<zc;Zb++)if(ma=h[Zb],ea=ma.material,!(void 0===ea||!1===ea.visible)){va.empty();if(ma instanceof THREE.RenderableParticle){D=ma;D.x*=p;D.y*=o;var na=D,ab=ma;b(ea.opacity);c(ea.blending);var zb=void 0,E=void 0,sb=void 0,tb=void 0,ic=ma=void 0,Rc=void 0;ea instanceof THREE.ParticleBasicMaterial?null===ea.map?(sb=ab.object.scale.x,tb=ab.object.scale.y,sb*=ab.scale.x*p,tb*=ab.scale.y*o,va.set(na.x-sb,na.y-tb,na.x+sb,na.y+tb),!1!==nb.intersects(va)&&
(e(ea.color.getContextStyle()),s.save(),s.translate(na.x,na.y),s.rotate(-ab.rotation),s.scale(sb,tb),s.fillRect(-1,-1,2,2),s.restore())):(ma=ea.map.image,ic=ma.width>>1,Rc=ma.height>>1,sb=ab.scale.x*p,tb=ab.scale.y*o,zb=sb*ic,E=tb*Rc,va.set(na.x-zb,na.y-E,na.x+zb,na.y+E),!1!==nb.intersects(va)&&(s.save(),s.translate(na.x,na.y),s.rotate(-ab.rotation),s.scale(sb,-tb),s.translate(-ic,-Rc),s.drawImage(ma,0,0),s.restore())):ea instanceof THREE.ParticleCanvasMaterial&&(zb=ab.scale.x*p,E=ab.scale.y*o,va.set(na.x-
zb,na.y-E,na.x+zb,na.y+E),!1!==nb.intersects(va)&&(d(ea.color.getContextStyle()),e(ea.color.getContextStyle()),s.save(),s.translate(na.x,na.y),s.rotate(-ab.rotation),s.scale(zb,E),ea.program(s),s.restore()))}else if(ma instanceof THREE.RenderableLine){if(D=ma.v1,C=ma.v2,D.positionScreen.x*=p,D.positionScreen.y*=o,C.positionScreen.x*=p,C.positionScreen.y*=o,va.addPoint(D.positionScreen.x,D.positionScreen.y),va.addPoint(C.positionScreen.x,C.positionScreen.y),!0===nb.intersects(va)&&(na=D,ab=C,b(ea.opacity),
c(ea.blending),s.beginPath(),s.moveTo(na.positionScreen.x,na.positionScreen.y),s.lineTo(ab.positionScreen.x,ab.positionScreen.y),ea instanceof THREE.LineBasicMaterial))na=ea.linewidth,A!==na&&(A=s.lineWidth=na),na=ea.linecap,u!==na&&(u=s.lineCap=na),na=ea.linejoin,v!==na&&(v=s.lineJoin=na),d(ea.color.getContextStyle()),s.stroke(),va.inflate(2*ea.linewidth)}else if(ma instanceof THREE.RenderableFace3)D=ma.v1,C=ma.v2,G=ma.v3,D.positionScreen.x*=p,D.positionScreen.y*=o,C.positionScreen.x*=p,C.positionScreen.y*=
o,G.positionScreen.x*=p,G.positionScreen.y*=o,!0===ea.overdraw&&(Yb(D.positionScreen,C.positionScreen),Yb(C.positionScreen,G.positionScreen),Yb(G.positionScreen,D.positionScreen)),va.add3Points(D.positionScreen.x,D.positionScreen.y,C.positionScreen.x,C.positionScreen.y,G.positionScreen.x,G.positionScreen.y),!0===nb.intersects(va)&&n(D,C,G,0,1,2,ma,ea,a);else if(ma instanceof THREE.RenderableFace4&&(D=ma.v1,C=ma.v2,G=ma.v3,M=ma.v4,D.positionScreen.x*=p,D.positionScreen.y*=o,C.positionScreen.x*=p,C.positionScreen.y*=
o,G.positionScreen.x*=p,G.positionScreen.y*=o,M.positionScreen.x*=p,M.positionScreen.y*=o,B.positionScreen.copy(C.positionScreen),K.positionScreen.copy(M.positionScreen),!0===ea.overdraw&&(Yb(D.positionScreen,C.positionScreen),Yb(C.positionScreen,M.positionScreen),Yb(M.positionScreen,D.positionScreen),Yb(G.positionScreen,B.positionScreen),Yb(G.positionScreen,K.positionScreen)),va.addPoint(D.positionScreen.x,D.positionScreen.y),va.addPoint(C.positionScreen.x,C.positionScreen.y),va.addPoint(G.positionScreen.x,
G.positionScreen.y),va.addPoint(M.positionScreen.x,M.positionScreen.y),!0===nb.intersects(va)))(na=D,ab=C,zb=G,E=M,sb=B,tb=K,ic=a,f.info.render.vertices+=4,f.info.render.faces++,b(ea.opacity),c(ea.blending),void 0!==ea.map&&null!==ea.map||void 0!==ea.envMap&&null!==ea.envMap)?(n(na,ab,E,0,1,3,ma,ea,ic),n(sb,zb,tb,1,2,3,ma,ea,ic)):(H=na.positionScreen.x,I=na.positionScreen.y,O=ab.positionScreen.x,N=ab.positionScreen.y,P=zb.positionScreen.x,Z=zb.positionScreen.y,L=E.positionScreen.x,J=E.positionScreen.y,
U=sb.positionScreen.x,Q=sb.positionScreen.y,da=tb.positionScreen.x,T=tb.positionScreen.y,ea instanceof THREE.MeshLambertMaterial||ea instanceof THREE.MeshPhongMaterial)?($.copy(ea.color),fa.copy(ea.emissive),ea.vertexColors===THREE.FaceColors&&($.r*=ma.color.r,$.g*=ma.color.g,$.b*=ma.color.b),!0===kb)?!1===ea.wireframe&&ea.shading==THREE.SmoothShading&&4==ma.vertexNormalsLength?(ca.r=ia.r=aa.r=ja.r=la.r,ca.g=ia.g=aa.g=ja.g=la.g,ca.b=ia.b=aa.b=ja.b=la.b,l(ma.v1.positionWorld,ma.vertexNormalsWorld[0],
ca),l(ma.v2.positionWorld,ma.vertexNormalsWorld[1],ia),l(ma.v4.positionWorld,ma.vertexNormalsWorld[3],aa),l(ma.v3.positionWorld,ma.vertexNormalsWorld[2],ja),ca.r=ca.r*$.r+fa.r,ca.g=ca.g*$.g+fa.g,ca.b=ca.b*$.b+fa.b,ia.r=ia.r*$.r+fa.r,ia.g=ia.g*$.g+fa.g,ia.b=ia.b*$.b+fa.b,aa.r=aa.r*$.r+fa.r,aa.g=aa.g*$.g+fa.g,aa.b=aa.b*$.b+fa.b,ja.r=ja.r*$.r+fa.r,ja.g=ja.g*$.g+fa.g,ja.b=ja.b*$.b+fa.b,pa=bb(ca,ia,aa,ja),m(H,I,O,N,L,J),z(H,I,O,N,L,J,0,0,1,0,0,1,pa),m(U,Q,P,Z,da,T),z(U,Q,P,Z,da,T,1,0,1,1,0,1,pa)):(R.r=
la.r,R.g=la.g,R.b=la.b,l(ma.centroidWorld,ma.normalWorld,R),R.r=R.r*$.r+fa.r,R.g=R.g*$.g+fa.g,R.b=R.b*$.b+fa.b,r(H,I,O,N,P,Z,L,J),!0===ea.wireframe?q(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):t(R)):(R.r=$.r+fa.r,R.g=$.g+fa.g,R.b=$.b+fa.b,r(H,I,O,N,P,Z,L,J),!0===ea.wireframe?q(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):t(R)):ea instanceof THREE.MeshBasicMaterial?(R.copy(ea.color),ea.vertexColors===THREE.FaceColors&&(R.r*=ma.color.r,R.g*=ma.color.g,R.b*=
ma.color.b),r(H,I,O,N,P,Z,L,J),!0===ea.wireframe?q(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):t(R)):ea instanceof THREE.MeshNormalMaterial?(R.r=Db(ma.normalWorld.x),R.g=Db(ma.normalWorld.y),R.b=Db(ma.normalWorld.z),r(H,I,O,N,P,Z,L,J),!0===ea.wireframe?q(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):t(R)):ea instanceof THREE.MeshDepthMaterial&&(La=k.near,Ga=k.far,ca.r=ca.g=ca.b=1-dc(na.positionScreen.z,La,Ga),ia.r=ia.g=ia.b=1-dc(ab.positionScreen.z,La,Ga),
aa.r=aa.g=aa.b=1-dc(E.positionScreen.z,La,Ga),ja.r=ja.g=ja.b=1-dc(zb.positionScreen.z,La,Ga),pa=bb(ca,ia,aa,ja),m(H,I,O,N,L,J),z(H,I,O,N,L,J,0,0,1,0,0,1,pa),m(U,Q,P,Z,da,T),z(U,Q,P,Z,da,T,1,0,1,1,0,1,pa));Oa.addRectangle(va)}s.setTransform(1,0,0,1,0,0)}}};
...
value:1},scale:{type:"f",value:1},map:{type:"t",value:null},fogDensity:{type:"f",value:2.5E-4},fogNear:{type:"f",value:1},fogFar:{type:"f",value:2E3},fogColor:{type:"c",value:new THREE.Color(16777215)}},shadowmap:{shadowMap:{type:"tv",value:[]},shadowMapSize:{type:"v2v",value:[]},shadowBias:{type:"fv1",value:[]},shadowDarkness:{type:"fv1",value:[]},shadowMatrix:{type:"m4v",value:[]}},depthmap:{mNear:{type:"f",value:1},mFar:{type:"f",value:2E3},opacity:{type:"f",value:1}}};
THREE.ShaderLib={depth:{uniforms:THREE.UniformsLib.depthmap,vertexShader:"void main() {\ngl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );\n}",fragmentShader:["uniform float mNear;\nuniform float mFar;\nuniform float opacity;\nvoid main() {",THREE.ShaderChunk.depthmap_fragment,"gl_FragColor = vec4( vec3( color ), opacity );\n}"].join("\n")},normal:{uniforms:{opacity:{type:"f",value:1}},vertexShader:"varying vec3 vNormal;\nvoid main() {\nvec4 mvPosition = modelViewMatrix * vec4( position, 1.0 );\nvNormal = normalize( normalMatrix * normal );\ngl_Position = projectionMatrix * mvPosition;\n}",
...
"}"].join("\n"),fragmentShader:["uniform vec3 diffuse;\nuniform float opacity;",THREE.ShaderChunk.color_pars_fragment,THREE.ShaderChunk.map_pars_fragment,THREE.ShaderChunk.lightmap_pars_fragment,THREE.ShaderChunk.envmap_pars_fragment,THREE.ShaderChunk.fog_pars_fragment,THREE.ShaderChunk.shadowmap_pars_fragment,THREE.ShaderChunk.specularmap_pars_fragment,"void main() {\ngl_FragColor = vec4( diffuse, opacity );",THREE.ShaderChunk.map_fragment,THREE.ShaderChunk.alphatest_fragment,THREE.ShaderChunk.specularmap_fragment,
THREE.ShaderChunk.lightmap_fragment,THREE.ShaderChunk.color_fragment,THREE.ShaderChunk.envmap_fragment,THREE.ShaderChunk.shadowmap_fragment,THREE.ShaderChunk.linear_to_gamma_fragment,THREE.ShaderChunk.fog_fragment,"}"].join("\n")},lambert:{uniforms:THREE.UniformsUtils.merge([THREE.UniformsLib.common,THREE.UniformsLib.fog,THREE.UniformsLib.lights,THREE.UniformsLib.shadowmap,{ambient:{type:"c",value:new THREE.Color(16777215)},emissive:{type:"c",value:new THREE.Color(0)},wrapRGB:{type:"v3",value:new THREE.Vector3(1,
1,1)}}]),vertexShader:["#define LAMBERT\nvarying vec3 vLightFront;\n#ifdef DOUBLE_SIDED\nvarying vec3 vLightBack;\n#endif",THREE.ShaderChunk.map_pars_vertex,THREE.ShaderChunk.lightmap_pars_vertex,THREE.ShaderChunk.envmap_pars_vertex,THREE.ShaderChunk.lights_lambert_pars_vertex,THREE.ShaderChunk.color_pars_vertex,THREE.ShaderChunk.morphtarget_pars_vertex,THREE.ShaderChunk.skinning_pars_vertex,THREE.ShaderChunk.shadowmap_pars_vertex,"void main() {",THREE.ShaderChunk.map_vertex,THREE.ShaderChunk.lightmap_vertex,
THREE.ShaderChunk.color_vertex,THREE.ShaderChunk.morphnormal_vertex,THREE.ShaderChunk.skinbase_vertex,THREE.ShaderChunk.skinnormal_vertex,THREE.ShaderChunk.defaultnormal_vertex,THREE.ShaderChunk.morphtarget_vertex,THREE.ShaderChunk.skinning_vertex,THREE.ShaderChunk.default_vertex,THREE.ShaderChunk.worldpos_vertex,THREE.ShaderChunk.envmap_vertex,THREE.ShaderChunk.lights_lambert_vertex,THREE.ShaderChunk.shadowmap_vertex,"}"].join("\n"),fragmentShader:["uniform float opacity;\nvarying vec3 vLightFront;\n#ifdef DOUBLE_SIDED\nvarying vec3 vLightBack;\n#endif",
THREE.ShaderChunk.color_pars_fragment,THREE.ShaderChunk.map_pars_fragment,THREE.ShaderChunk.lightmap_pars_fragment,THREE.ShaderChunk.envmap_pars_fragment,THREE.ShaderChunk.fog_pars_fragment,THREE.ShaderChunk.shadowmap_pars_fragment,THREE.ShaderChunk.specularmap_pars_fragment,"void main() {\ngl_FragColor = vec4( vec3 ( 1.0 ), opacity );",THREE.ShaderChunk.map_fragment,THREE.ShaderChunk.alphatest_fragment,THREE.ShaderChunk.specularmap_fragment,"#ifdef DOUBLE_SIDED\nif ( gl_FrontFacing )\ngl_FragColor.xyz *= vLightFront;\nelse\ngl_FragColor.xyz *= vLightBack;\n#else\ngl_FragColor.xyz *= vLightFront;\n#endif",
...
THREE.ShaderChunk.fog_fragment,"}"].join("\n")},particle_depth:{uniforms:THREE.UniformsUtils.merge([THREE.UniformsLib.particle,THREE.UniformsLib.depthmap]),vertexShader:["uniform float size;\nuniform float scale;",THREE.ShaderChunk.color_pars_vertex,"void main() {",THREE.ShaderChunk.color_vertex,"vec4 mvPosition = modelViewMatrix * vec4( position, 1.0 );\n#ifdef USE_SIZEATTENUATION\ngl_PointSize = size * ( scale / length( mvPosition.xyz ) );\n#else\ngl_PointSize = size;\n#endif\ngl_Position = projectionMatrix * mvPosition;",
THREE.ShaderChunk.worldpos_vertex,"}"].join("\n"),fragmentShader:["uniform vec3 psColor;\nuniform float opacity;\nuniform float mNear;\nuniform float mFar;",THREE.ShaderChunk.color_pars_fragment,THREE.ShaderChunk.map_particle_pars_fragment,"void main() {\ngl_FragColor = vec4( psColor, opacity );",THREE.ShaderChunk.map_particle_fragment,THREE.ShaderChunk.depthmap_fragment,"gl_FragColor = vec4( vec3( color ), gl_FragColor.a );\n}"].join("\n")},dashed:{uniforms:THREE.UniformsUtils.merge([THREE.UniformsLib.common,
...
o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,s=a.__webglCustomAttributesList;if(c.sortParticles){rb.copy($a);rb.multiplySelf(c.matrixWorld);for(d=0;d<g;d++)e=h[d],Ra.copy(e),rb.multiplyVector3(Ra),m[d]=[Ra.z,d];m.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++)e=h[m[d][1]],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;for(d=0;d<j;d++)f=3*d,e=i[m[d][1]],n[f]=e.r,n[f+1]=e.g,n[f+2]=e.b;if(s){i=0;for(j=s.length;i<j;i++)if(h=s[i],void 0===h.boundTo||"vertices"===h.boundTo)if(f=0,e=h.value.length,1===h.size)for(d=
...
0,e=a.length;d<e;d++)fa=ia=null,ja=$=Ga=La=ob=jb=pa=-1,Xa=!0,a[d].render(b,c,eb,qa),fa=ia=null,ja=$=Ga=La=ob=jb=pa=-1,Xa=!0}function p(a,b,c,d,e,f,g,h){var i,k,j,l;b?(k=a.length-1,l=b=-1):(k=0,b=a.length,l=1);for(var n=k;n!==b;n+=l)if(i=a[n],i.render){k=i.object;j=i.buffer;if(h)i=h;else{i=i[c];if(!i)continue;g&&T.setBlending(i.blending,i.blendEquation,i.blendSrc,i.blendDst);T.setDepthTest(i.depthTest);T.setDepthWrite(i.depthWrite);C(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits)}T.setMaterialFaces(i);
j instanceof THREE.BufferGeometry?T.renderBufferDirect(d,e,f,i,j,k):T.renderBuffer(d,e,f,i,j,k)}}function o(a,b,c,d,e,f,g){for(var h,i,k=0,j=a.length;k<j;k++)if(h=a[k],i=h.object,i.visible){if(g)h=g;else{h=h[b];if(!h)continue;f&&T.setBlending(h.blending,h.blendEquation,h.blendSrc,h.blendDst);T.setDepthTest(h.depthTest);T.setDepthWrite(h.depthWrite);C(h.polygonOffset,h.polygonOffsetFactor,h.polygonOffsetUnits)}T.renderImmediateObject(c,d,e,h,i)}}function s(a,b,c){a.push({buffer:b,object:c,opaque:null,
transparent:null})}function t(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return!0;return!1}function r(a){for(var b in a.attributes)a.attributes[b].needsUpdate=!1}function z(a,b){for(var c=a.length-1;0<=c;c--)a[c].object===b&&a.splice(c,1)}function x(a,b){for(var c=a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function q(a,b,c,d,e){Na=0;d.needsUpdate&&(d.program&&T.deallocateMaterial(d),T.initMaterial(d,b,c,e),d.needsUpdate=!1);d.morphTargets&&!e.__webglMorphTargetInfluences&&(e.__webglMorphTargetInfluences=
new Float32Array(T.maxMorphTargets));var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==ia&&(k.useProgram(g),ia=g,f=!0);d.id!==ja&&(ja=d.id,f=!0);if(f||a!==fa)k.uniformMatrix4fv(h.projectionMatrix,!1,a._projectionMatrixArray),a!==fa&&(fa=a);if(d.skinning)if(gc&&e.useVertexTexture){if(null!==h.boneTexture){var j=A();k.uniform1i(h.boneTexture,j);T.setTexture(e.boneTexture,j)}}else null!==h.boneGlobalMatrices&&k.uniformMatrix4fv(h.boneGlobalMatrices,!1,e.boneMatrices);if(f){c&&d.fog&&(i.fogColor.value=
c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(Xa){for(var l=0,n=0,m=0,o,p,s,r=xc,q=r.directional.colors,t=r.directional.positions,u=r.point.colors,x=r.point.positions,z=r.point.distances,C=r.spot.colors,G=r.spot.positions,R=r.spot.distances,H=r.spot.directions,aa=r.spot.anglesCos,J=r.spot.exponents,K=r.hemi.skyColors,
M=r.hemi.groundColors,L=r.hemi.positions,O=0,N=0,ca=0,$=0,P=0,U=0,Q=0,da=0,Z=p=0,c=Z=Z=0,f=b.length;c<f;c++)j=b[c],j.onlyShadow||(o=j.color,s=j.intensity,p=j.distance,j instanceof THREE.AmbientLight?j.visible&&(T.gammaInput?(l+=o.r*o.r,n+=o.g*o.g,m+=o.b*o.b):(l+=o.r,n+=o.g,m+=o.b)):j instanceof THREE.DirectionalLight?(P+=1,j.visible&&(p=3*O,T.gammaInput?v(q,p,o,s*s):D(q,p,o,s),Ha.copy(j.matrixWorld.getPosition()),Ha.subSelf(j.target.matrixWorld.getPosition()),Ha.normalize(),t[p]=Ha.x,t[p+1]=Ha.y,
t[p+2]=Ha.z,O+=1)):j instanceof THREE.PointLight?(U+=1,j.visible&&(Z=3*N,T.gammaInput?v(u,Z,o,s*s):D(u,Z,o,s),s=j.matrixWorld.getPosition(),x[Z]=s.x,x[Z+1]=s.y,x[Z+2]=s.z,z[N]=p,N+=1)):j instanceof THREE.SpotLight?(Q+=1,j.visible&&(Z=3*ca,T.gammaInput?v(C,Z,o,s*s):D(C,Z,o,s),s=j.matrixWorld.getPosition(),G[Z]=s.x,G[Z+1]=s.y,G[Z+2]=s.z,R[ca]=p,Ha.copy(s),Ha.subSelf(j.target.matrixWorld.getPosition()),Ha.normalize(),H[Z]=Ha.x,H[Z+1]=Ha.y,H[Z+2]=Ha.z,aa[ca]=Math.cos(j.angle),J[ca]=j.exponent,ca+=1)):
j instanceof THREE.HemisphereLight&&(da+=1,j.visible&&(o=j.color,p=j.groundColor,Z=3*$,T.gammaInput?(s*=s,v(K,Z,o,s),v(M,Z,p,s)):(D(K,Z,o,s),D(M,Z,p,s)),Ha.copy(j.matrixWorld.getPosition()),Ha.normalize(),L[Z]=Ha.x,L[Z+1]=Ha.y,L[Z+2]=Ha.z,$+=1)));c=3*O;for(f=Math.max(q.length,3*P);c<f;c++)q[c]=0;c=3*O;for(f=Math.max(t.length,3*P);c<f;c++)t[c]=0;c=3*N;for(f=Math.max(u.length,3*U);c<f;c++)u[c]=0;c=3*N;for(f=Math.max(x.length,3*U);c<f;c++)x[c]=0;c=N;for(f=Math.max(z.length,U);c<f;c++)z[c]=0;c=3*ca;for(f=
Math.max(C.length,3*Q);c<f;c++)C[c]=0;c=3*ca;for(f=Math.max(G.length,3*Q);c<f;c++)G[c]=0;c=3*ca;for(f=Math.max(H.length,3*Q);c<f;c++)H[c]=0;c=ca;for(f=Math.max(aa.length,Q);c<f;c++)aa[c]=0;c=ca;for(f=Math.max(J.length,Q);c<f;c++)J[c]=0;c=ca;for(f=Math.max(R.length,Q);c<f;c++)R[c]=0;c=3*$;for(f=Math.max(K.length,3*da);c<f;c++)K[c]=0;c=3*$;for(f=Math.max(M.length,3*da);c<f;c++)M[c]=0;c=3*$;for(f=Math.max(L.length,3*da);c<f;c++)L[c]=0;r.directional.length=O;r.point.length=N;r.spot.length=ca;r.hemi.length=
$;r.ambient[0]=l;r.ambient[1]=n;r.ambient[2]=m;Xa=!1}c=xc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=c.spot.directions;i.spotLightAngleCos.value=
c.spot.anglesCos;i.spotLightExponent.value=c.spot.exponents;i.hemisphereLightSkyColor.value=c.hemi.skyColors;i.hemisphereLightGroundColor.value=c.hemi.groundColors;i.hemisphereLightDirection.value=c.hemi.positions}if(d instanceof THREE.MeshBasicMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.MeshPhongMaterial){i.opacity.value=d.opacity;T.gammaInput?i.diffuse.value.copyGammaToLinear(d.color):i.diffuse.value=d.color;i.map.value=d.map;i.lightMap.value=d.lightMap;i.specularMap.value=
...
d.refractionRatio;i.combine.value=d.combine;i.useRefract.value=d.envMap&&d.envMap.mapping instanceof THREE.CubeRefractionMapping}d instanceof THREE.LineBasicMaterial?(i.diffuse.value=d.color,i.opacity.value=d.opacity):d instanceof THREE.LineDashedMaterial?(i.diffuse.value=d.color,i.opacity.value=d.opacity,i.dashSize.value=d.dashSize,i.totalSize.value=d.dashSize+d.gapSize,i.scale.value=d.scale):d instanceof THREE.ParticleBasicMaterial?E(i,d):d instanceof THREE.MeshPhongMaterial?(i.shininess.value=
d.shininess,T.gammaInput?(i.ambient.value.copyGammaToLinear(d.ambient),i.emissive.value.copyGammaToLinear(d.emissive),i.specular.value.copyGammaToLinear(d.specular)):(i.ambient.value=d.ambient,i.emissive.value=d.emissive,i.specular.value=d.specular),d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)):d instanceof THREE.MeshLambertMaterial?(T.gammaInput?(i.ambient.value.copyGammaToLinear(d.ambient),i.emissive.value.copyGammaToLinear(d.emissive)):(i.ambient.value=d.ambient,i.emissive.value=d.emissive),d.wrapAround&&
i.wrapRGB.value.copy(d.wrapRGB)):d instanceof THREE.MeshDepthMaterial?(i.mNear.value=a.near,i.mFar.value=a.far,i.opacity.value=d.opacity):d instanceof THREE.ParticleDepthMaterial?(i.mNear.value=a.near,i.mFar.value=a.far,E(i,d)):d instanceof THREE.MeshNormalMaterial&&(i.opacity.value=d.opacity);if(e.receiveShadow&&!d._shadowPass&&i.shadowMatrix){c=V=0;for(f=b.length;c<f;c++)if(j=b[c],j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade))i.shadowMap.value[V]=
j.shadowMap,i.shadowMapSize.value[V]=j.shadowMapSize,i.shadowMatrix.value[V]=j.shadowMatrix,i.shadowDarkness.value[V]=j.shadowDarkness,i.shadowBias.value[V]=j.shadowBias,V++}b=d.uniformsList;i=0;for(V=b.length;i<V;i++)if(f=g.uniforms[b[i][1]])if(c=b[i][0],l=c.type,j=c.value,"i"===l)k.uniform1i(f,j);else if("f"===l)k.uniform1f(f,j);else if("v2"===l)k.uniform2f(f,j.x,j.y);else if("v3"===l)k.uniform3f(f,j.x,j.y,j.z);else if("v4"===l)k.uniform4f(f,j.x,j.y,j.z,j.w);else if("c"===l)k.uniform3f(f,j.r,j.g,
...
l);k.uniformMatrix4fv(f,!1,c._array)}else if("t"===l){if(m=j,j=A(),k.uniform1i(f,j),m)if(m.image instanceof Array&&6===m.image.length){if(c=m,f=j,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=k.createTexture());k.activeTexture(k.TEXTURE0+f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)T.autoScaleCubemaps&&!f?(n=j,m=l,r=c.image[l],t=
Qc,r.width<=t&&r.height<=t||(u=Math.max(r.width,r.height),q=Math.floor(r.width*t/u),t=Math.floor(r.height*t/u),u=document.createElement("canvas"),u.width=q,u.height=t,u.getContext("2d").drawImage(r,0,0,r.width,r.height,0,0,q,t),r=u),n[m]=r):j[l]=c.image[l];l=j[0];n=0===(l.width&l.width-1)&&0===(l.height&l.height-1);m=I(c.format);r=I(c.type);B(k.TEXTURE_CUBE_MAP,c,n);for(l=0;6>l;l++)if(f){t=j[l].mipmaps;u=0;for(x=t.length;u<x;u++)q=t[u],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,u,m,q.width,
q.height,0,q.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,m,m,r,j[l]);c.generateMipmaps&&n&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else m instanceof THREE.WebGLRenderTargetCube?(c=m,k.activeTexture(k.TEXTURE0+j),k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)):T.setTexture(m,j)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(n=c.value.length;l<
n;l++)c._array[l]=A();k.uniform1iv(f,c._array);l=0;for(n=c.value.length;l<n;l++)m=c.value[l],j=c._array[l],m&&T.setTexture(m,j)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==h.cameraPosition)b=a.matrixWorld.getPosition(),k.uniform3f(h.cameraPosition,b.x,b.y,b.z);(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&null!==h.viewMatrix&&k.uniformMatrix4fv(h.viewMatrix,!1,a._viewMatrixArray)}k.uniformMatrix4fv(h.modelViewMatrix,
!1,e._modelViewMatrix.elements);h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,!1,e._normalMatrix.elements);null!==h.modelMatrix&&k.uniformMatrix4fv(h.modelMatrix,!1,e.matrixWorld.elements);return g}function E(a,b){a.psColor.value=b.color;a.opacity.value=b.opacity;a.size.value=b.size;a.scale.value=O.height/2;a.map.value=b.map}function A(){var a=Na;a>=yc&&console.warn("Trying to use "+a+" texture units while this GPU supports only "+yc);Na+=1;return a}function u(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,
a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function v(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function D(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function C(a,b,c){Ab!==a&&(a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL),Ab=a);if(a&&(Bb!==b||nb!==c))k.polygonOffset(b,c),Bb=b,nb=c}function G(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function M(a,b){var c;"fragment"===
a?c=k.createShader(k.FRAGMENT_SHADER):"vertex"===a&&(c=k.createShader(k.VERTEX_SHADER));k.shaderSource(c,b);k.compileShader(c);return!k.getShaderParameter(c,k.COMPILE_STATUS)?(console.error(k.getShaderInfoLog(c)),console.error(G(b)),null):c}function B(a,b,c){c?(k.texParameteri(a,k.TEXTURE_WRAP_S,I(b.wrapS)),k.texParameteri(a,k.TEXTURE_WRAP_T,I(b.wrapT)),k.texParameteri(a,k.TEXTURE_MAG_FILTER,I(b.magFilter)),k.texParameteri(a,k.TEXTURE_MIN_FILTER,I(b.minFilter))):(k.texParameteri(a,k.TEXTURE_WRAP_S,
k.CLAMP_TO_EDGE),k.texParameteri(a,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE),k.texParameteri(a,k.TEXTURE_MAG_FILTER,H(b.magFilter)),k.texParameteri(a,k.TEXTURE_MIN_FILTER,H(b.minFilter)));if(yb&&b.type!==THREE.FloatType&&(1<b.anisotropy||b.__oldAnisotropy))k.texParameterf(a,yb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,nc)),b.__oldAnisotropy=b.anisotropy}function K(a,b){k.bindRenderbuffer(k.RENDERBUFFER,a);b.depthBuffer&&!b.stencilBuffer?(k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_COMPONENT16,b.width,
b.height),k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_ATTACHMENT,k.RENDERBUFFER,a)):b.depthBuffer&&b.stencilBuffer?(k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_STENCIL,b.width,b.height),k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_STENCIL_ATTACHMENT,k.RENDERBUFFER,a)):k.renderbufferStorage(k.RENDERBUFFER,k.RGBA4,b.width,b.height)}function H(a){return a===THREE.NearestFilter||a===THREE.NearestMipMapNearestFilter||a===THREE.NearestMipMapLinearFilter?k.NEAREST:k.LINEAR}function I(a){if(a===THREE.RepeatWrapping)return k.REPEAT;
...
THREE.SrcAlphaFactor)return k.SRC_ALPHA;if(a===THREE.OneMinusSrcAlphaFactor)return k.ONE_MINUS_SRC_ALPHA;if(a===THREE.DstAlphaFactor)return k.DST_ALPHA;if(a===THREE.OneMinusDstAlphaFactor)return k.ONE_MINUS_DST_ALPHA;if(a===THREE.DstColorFactor)return k.DST_COLOR;if(a===THREE.OneMinusDstColorFactor)return k.ONE_MINUS_DST_COLOR;if(a===THREE.SrcAlphaSaturateFactor)return k.SRC_ALPHA_SATURATE;if(void 0!==lb){if(a===THREE.RGB_S3TC_DXT1_Format)return lb.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT1_Format)return lb.COMPRESSED_RGBA_S3TC_DXT1_EXT;
if(a===THREE.RGBA_S3TC_DXT3_Format)return lb.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===THREE.RGBA_S3TC_DXT5_Format)return lb.COMPRESSED_RGBA_S3TC_DXT5_EXT}return 0}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},O=void 0!==a.canvas?a.canvas:document.createElement("canvas"),N=void 0!==a.precision?a.precision:"highp",P=void 0!==a.alpha?a.alpha:!0,Z=void 0!==a.premultipliedAlpha?a.premultipliedAlpha:!0,L=void 0!==a.antialias?a.antialias:!1,J=void 0!==a.stencil?a.stencil:!0,U=void 0!==a.preserveDrawingBuffer?
a.preserveDrawingBuffer:!1,Q=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),da=void 0!==a.clearAlpha?a.clearAlpha:0;this.domElement=O;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapCullFrontFaces=this.shadowMapSoft=this.shadowMapAutoUpdate=!0;this.shadowMapCascade=
this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var T=this,R=[],ca=0,ia=null,aa=null,ja=-1,$=null,fa=null,Ka=0,Na=0,La=-1,Ga=-1,pa=-1,Ba=-1,db=-1,qb=-1,jb=-1,ob=-1,Ab=null,Bb=null,nb=null,Oa=null,va=0,kb=0,la=0,fb=0,eb=0,qa=0,pb=new THREE.Frustum,$a=new THREE.Matrix4,rb=new THREE.Matrix4,Ra=new THREE.Vector4,
Ha=new THREE.Vector3,Xa=!0,xc={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,yb,lb;try{if(!(k=O.getContext("experimental-webgl",{alpha:P,premultipliedAlpha:Z,antialias:L,stencil:J,preserveDrawingBuffer:U})))throw"Error creating WebGL context.";}catch(Pc){console.error(Pc)}a=k.getExtension("OES_texture_float");
P=k.getExtension("OES_standard_derivatives");yb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");lb=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");a||console.log("THREE.WebGLRenderer: Float textures not supported.");P||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");
yb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");lb||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(Q.r,Q.g,Q.b,da);this.context=k;var yc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),
P=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Qc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),nc=yb?k.getParameter(yb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,hc=0<P,gc=hc&&a;lb&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};this.supportsVertexTextures=function(){return hc};this.getMaxAnisotropy=function(){return nc};this.setSize=function(a,b){O.width=a;O.height=b;this.setViewport(0,0,O.width,O.height)};this.setViewport=function(a,
b,c,d){va=void 0!==a?a:0;kb=void 0!==b?b:0;la=void 0!==c?c:O.width;fb=void 0!==d?d:O.height;k.viewport(va,kb,la,fb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){Q.setHex(a);da=b;k.clearColor(Q.r,Q.g,Q.b,da)};this.setClearColor=function(a,b){Q.copy(a);da=b;k.clearColor(Q.r,Q.g,Q.b,da)};this.getClearColor=function(){return Q};this.getClearAlpha=function(){return da};
...
k.deleteBuffer(d.__webglLineBuffer);var e=void 0,f=void 0;if(d.numMorphTargets){e=0;for(f=d.numMorphTargets;e<f;e++)k.deleteBuffer(d.__webglMorphTargetsBuffers[e])}if(d.numMorphNormals){e=0;for(f=d.numMorphNormals;e<f;e++)k.deleteBuffer(d.__webglMorphNormalsBuffers[e])}b(d);T.info.memory.geometries--}else a instanceof THREE.Ribbon?(a=a.geometry,k.deleteBuffer(a.__webglVertexBuffer),k.deleteBuffer(a.__webglColorBuffer),k.deleteBuffer(a.__webglNormalBuffer),b(a),T.info.memory.geometries--):a instanceof
THREE.Line?(a=a.geometry,k.deleteBuffer(a.__webglVertexBuffer),k.deleteBuffer(a.__webglColorBuffer),k.deleteBuffer(a.__webglLineDistanceBuffer),b(a),T.info.memory.geometries--):a instanceof THREE.ParticleSystem&&(a=a.geometry,k.deleteBuffer(a.__webglVertexBuffer),k.deleteBuffer(a.__webglColorBuffer),b(a),T.info.memory.geometries--)};this.deallocateTexture=function(a){a.__webglInit&&(a.__webglInit=!1,k.deleteTexture(a.__webglTexture),T.info.memory.textures--)};this.deallocateRenderTarget=function(a){if(a&&
...
k.disableVertexAttribArray(a.uv));i=e.attributes.color;if(0<=a.color&&i){var j=i.itemSize;k.bindBuffer(k.ARRAY_BUFFER,i.buffer);k.vertexAttribPointer(a.color,j,k.FLOAT,!1,0,4*g*j)}h=e.attributes.tangent;0<=a.tangent&&h&&(i=h.itemSize,k.bindBuffer(k.ARRAY_BUFFER,h.buffer),k.vertexAttribPointer(a.tangent,i,k.FLOAT,!1,0,4*g*i));k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.attributes.index.buffer)}k.drawElements(k.TRIANGLES,f[d].count,k.UNSIGNED_SHORT,2*f[d].start);T.info.render.calls++;T.info.render.vertices+=
f[d].count;T.info.render.faces+=f[d].count/3}}else f instanceof THREE.ParticleSystem&&b&&(h=e.attributes.position,i=h.itemSize,k.bindBuffer(k.ARRAY_BUFFER,h.buffer),k.vertexAttribPointer(a.position,i,k.FLOAT,!1,0,0),i=e.attributes.color,0<=a.color&&i&&(j=i.itemSize,k.bindBuffer(k.ARRAY_BUFFER,i.buffer),k.vertexAttribPointer(a.color,j,k.FLOAT,!1,0,0)),k.drawArrays(k.POINTS,0,h.numItems/3),T.info.render.calls++,T.info.render.points+=h.numItems/3)};this.renderBuffer=function(a,b,c,d,e,f){if(!1!==d.visible){var g,
...
i++}else{h=[];g=f.morphTargetInfluences;var j,l=g.length;for(j=0;j<l;j++)i=g[j],0<i&&h.push([j,i]);h.length>d.numSupportedMorphTargets?(h.sort(m),h.length=d.numSupportedMorphTargets):h.length>d.numSupportedMorphNormals?h.sort(m):0===h.length&&h.push([0,0]);for(i=0;i<d.numSupportedMorphTargets;)h[i]?(j=h[i][0],k.bindBuffer(k.ARRAY_BUFFER,e.__webglMorphTargetsBuffers[j]),k.vertexAttribPointer(c["morphTarget"+i],3,k.FLOAT,!1,0,0),d.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,e.__webglMorphNormalsBuffers[j]),
...
k.vertexAttribPointer(b.skinIndex,4,k.FLOAT,!1,0,0),k.bindBuffer(k.ARRAY_BUFFER,e.__webglSkinWeightsBuffer),k.vertexAttribPointer(b.skinWeight,4,k.FLOAT,!1,0,0));0<=b.lineDistance&&(k.bindBuffer(k.ARRAY_BUFFER,e.__webglLineDistanceBuffer),k.vertexAttribPointer(b.lineDistance,1,k.FLOAT,!1,0,0))}f instanceof THREE.Mesh?(d.wireframe?(d=d.wireframeLinewidth,d!==Oa&&(k.lineWidth(d),Oa=d),a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglLineBuffer),k.drawElements(k.LINES,e.__webglLineCount,k.UNSIGNED_SHORT,
0)):(a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglFaceBuffer),k.drawElements(k.TRIANGLES,e.__webglFaceCount,k.UNSIGNED_SHORT,0)),T.info.render.calls++,T.info.render.vertices+=e.__webglFaceCount,T.info.render.faces+=e.__webglFaceCount/3):f instanceof THREE.Line?(f=f.type===THREE.LineStrip?k.LINE_STRIP:k.LINES,d=d.linewidth,d!==Oa&&(k.lineWidth(d),Oa=d),k.drawArrays(f,0,e.__webglLineCount),T.info.render.calls++):f instanceof THREE.ParticleSystem?(k.drawArrays(k.POINTS,0,e.__webglParticleCount),T.info.render.calls++,
T.info.render.points+=e.__webglParticleCount):f instanceof THREE.Ribbon&&(k.drawArrays(k.TRIANGLE_STRIP,0,e.__webglVertexCount),T.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,i=a.__lights,j=a.fog;ja=-1;Xa=!0;this.autoUpdateScene&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b._viewMatrixArray||(b._viewMatrixArray=new Float32Array(16));
b._projectionMatrixArray||(b._projectionMatrixArray=new Float32Array(16));b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);$a.multiply(b.projectionMatrix,b.matrixWorldInverse);pb.setFromMatrix($a);this.autoUpdateObjects&&this.initWebGLObjects(a);n(this.renderPluginsPre,a,b);T.info.render.calls=0;T.info.render.vertices=0;T.info.render.faces=0;T.info.render.points=0;this.setRenderTarget(c);
(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.render=!1,g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||pb.contains(g))){u(g,b);var m=f,s=m.buffer,r=void 0,q=r=void 0,q=m.object.material;if(q instanceof THREE.MeshFaceMaterial)r=s.materialIndex,0<=r&&(r=q.materials[r],r.transparent?(m.transparent=r,m.opaque=null):(m.opaque=r,m.transparent=
null));else if(r=q)r.transparent?(m.transparent=r,m.opaque=null):(m.opaque=r,m.transparent=null);f.render=!0;!0===this.sortObjects&&(null!==g.renderDepth?f.z=g.renderDepth:(Ra.copy(g.matrixWorld.getPosition()),$a.multiplyVector3(Ra),f.z=Ra.z),f.id=g.id)}this.sortObjects&&h.sort(l);h=a.__webglObjectsImmediate;d=0;for(e=h.length;d<e;d++)f=h[d],g=f.object,g.visible&&(u(g,b),g=f.object.material,g.transparent?(f.transparent=g,f.opaque=null):(f.opaque=g,f.transparent=null));a.overrideMaterial?(d=a.overrideMaterial,
...
q(a,b,c,d,e);$=-1;T.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,pb):e.render(function(a){T.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=a.__objectsAdded[0],l=a,n=void 0,m=void 0,o=void 0,p=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,
b instanceof THREE.Mesh)if(m=b.geometry,o=b.material,m instanceof THREE.Geometry){if(void 0===m.geometryGroups){var q=m,u=void 0,v=void 0,A=void 0,B=void 0,C=void 0,D=void 0,E=void 0,G={},H=q.morphTargets.length,I=q.morphNormals.length,R=o instanceof THREE.MeshFaceMaterial;q.geometryGroups={};u=0;for(v=q.faces.length;u<v;u++)A=q.faces[u],B=R?A.materialIndex:void 0,D=void 0!==B?B:-1,void 0===G[D]&&(G[D]={hash:D,counter:0}),E=G[D].hash+"_"+G[D].counter,void 0===q.geometryGroups[E]&&(q.geometryGroups[E]=
{faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:H,numMorphNormals:I}),C=A instanceof THREE.Face3?3:4,65535<q.geometryGroups[E].vertices+C&&(G[D].counter+=1,E=G[D].hash+"_"+G[D].counter,void 0===q.geometryGroups[E]&&(q.geometryGroups[E]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:H,numMorphNormals:I})),A instanceof THREE.Face3?q.geometryGroups[E].faces3.push(u):q.geometryGroups[E].faces4.push(u),q.geometryGroups[E].vertices+=C;q.geometryGroupsList=[];var aa=void 0;
for(aa in q.geometryGroups)q.geometryGroups[aa].id=Ka++,q.geometryGroupsList.push(q.geometryGroups[aa])}for(n in m.geometryGroups)if(p=m.geometryGroups[n],!p.__webglVertexBuffer){var J=p;J.__webglVertexBuffer=k.createBuffer();J.__webglNormalBuffer=k.createBuffer();J.__webglTangentBuffer=k.createBuffer();J.__webglColorBuffer=k.createBuffer();J.__webglUVBuffer=k.createBuffer();J.__webglUV2Buffer=k.createBuffer();J.__webglSkinIndicesBuffer=k.createBuffer();J.__webglSkinWeightsBuffer=k.createBuffer();
J.__webglFaceBuffer=k.createBuffer();J.__webglLineBuffer=k.createBuffer();var K=void 0,ca=void 0;if(J.numMorphTargets){J.__webglMorphTargetsBuffers=[];K=0;for(ca=J.numMorphTargets;K<ca;K++)J.__webglMorphTargetsBuffers.push(k.createBuffer())}if(J.numMorphNormals){J.__webglMorphNormalsBuffers=[];K=0;for(ca=J.numMorphNormals;K<ca;K++)J.__webglMorphNormalsBuffers.push(k.createBuffer())}T.info.memory.geometries++;d(p,b);m.verticesNeedUpdate=!0;m.morphTargetsNeedUpdate=!0;m.elementsNeedUpdate=!0;m.uvsNeedUpdate=
!0;m.normalsNeedUpdate=!0;m.tangentsNeedUpdate=!0;m.colorsNeedUpdate=!0}}else m instanceof THREE.BufferGeometry&&h(m);else if(b instanceof THREE.Ribbon){if(m=b.geometry,!m.__webglVertexBuffer){var M=m;M.__webglVertexBuffer=k.createBuffer();M.__webglColorBuffer=k.createBuffer();M.__webglNormalBuffer=k.createBuffer();T.info.memory.geometries++;var L=m,O=b,N=L.vertices.length;L.__vertexArray=new Float32Array(3*N);L.__colorArray=new Float32Array(3*N);L.__normalArray=new Float32Array(3*N);L.__webglVertexCount=
N;c(L,O);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(m=b.geometry,!m.__webglVertexBuffer){var $=m;$.__webglVertexBuffer=k.createBuffer();$.__webglColorBuffer=k.createBuffer();$.__webglLineDistanceBuffer=k.createBuffer();T.info.memory.geometries++;var Q=m,P=b,U=Q.vertices.length;Q.__vertexArray=new Float32Array(3*U);Q.__colorArray=new Float32Array(3*U);Q.__lineDistanceArray=new Float32Array(1*U);Q.__webglLineCount=U;c(Q,P);m.verticesNeedUpdate=
!0;m.colorsNeedUpdate=!0;m.lineDistancesNeedUpdate=!0}}else if(b instanceof THREE.ParticleSystem&&(m=b.geometry,!m.__webglVertexBuffer))if(m instanceof THREE.Geometry){var ia=m;ia.__webglVertexBuffer=k.createBuffer();ia.__webglColorBuffer=k.createBuffer();T.info.memory.geometries++;var fa=m,Z=b,ja=fa.vertices.length;fa.__vertexArray=new Float32Array(3*ja);fa.__colorArray=new Float32Array(3*ja);fa.__sortArray=[];fa.__webglParticleCount=ja;c(fa,Z);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}else m instanceof
THREE.BufferGeometry&&h(m);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(m=b.geometry,m instanceof THREE.BufferGeometry)s(l.__webglObjects,m,b);else for(n in m.geometryGroups)p=m.geometryGroups[n],s(l.__webglObjects,p,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(m=b.geometry,s(l.__webglObjects,m,b)):b instanceof THREE.ImmediateRenderObject||b.immediateRenderCallback?l.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof
THREE.Sprite?l.__webglSprites.push(b):b instanceof THREE.LensFlare&&l.__webglFlares.push(b);b.__webglActive=!0}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var da=a.__objectsRemoved[0],pa=a;da instanceof THREE.Mesh||da instanceof THREE.ParticleSystem||da instanceof THREE.Ribbon||da instanceof THREE.Line?z(pa.__webglObjects,da):da instanceof THREE.Sprite?x(pa.__webglSprites,da):da instanceof THREE.LensFlare?x(pa.__webglFlares,da):(da instanceof THREE.ImmediateRenderObject||da.immediateRenderCallback)&&
z(pa.__webglObjectsImmediate,da);da.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var Na=0,La=a.__webglObjects.length;Na<La;Na++){var qa=a.__webglObjects[Na].object,V=qa.geometry,Ga=void 0,va=void 0,la=void 0;if(qa instanceof THREE.Mesh)if(V instanceof THREE.BufferGeometry)(V.verticesNeedUpdate||V.elementsNeedUpdate||V.uvsNeedUpdate||V.normalsNeedUpdate||V.colorsNeedUpdate||V.tangentsNeedUpdate)&&j(V,k.DYNAMIC_DRAW,!V.dynamic),V.verticesNeedUpdate=!1,V.elementsNeedUpdate=!1,V.uvsNeedUpdate=
!1,V.normalsNeedUpdate=!1,V.colorsNeedUpdate=!1,V.tangentsNeedUpdate=!1;else{for(var Ha=0,Oa=V.geometryGroupsList.length;Ha<Oa;Ha++)if(Ga=V.geometryGroupsList[Ha],la=e(qa,Ga),V.buffersNeedUpdate&&d(Ga,qa),va=la.attributes&&t(la),V.verticesNeedUpdate||V.morphTargetsNeedUpdate||V.elementsNeedUpdate||V.uvsNeedUpdate||V.normalsNeedUpdate||V.colorsNeedUpdate||V.tangentsNeedUpdate||va){var ra=Ga,Ra=qa,Ba=k.DYNAMIC_DRAW,qb=!V.dynamic,db=la;if(ra.__inittedArrays){var nb=f(db),jb=db.vertexColors?db.vertexColors:
!1,ob=g(db),fb=nb===THREE.SmoothShading,F=void 0,ba=void 0,Xa=void 0,S=void 0,eb=void 0,$a=void 0,Cb=void 0,pb=void 0,Ub=void 0,kb=void 0,lb=void 0,W=void 0,X=void 0,Y=void 0,oa=void 0,Eb=void 0,Fb=void 0,Gb=void 0,rb=void 0,Hb=void 0,Ib=void 0,Jb=void 0,yb=void 0,Kb=void 0,Lb=void 0,Mb=void 0,Ab=void 0,Nb=void 0,Ob=void 0,Pb=void 0,Bb=void 0,Qb=void 0,Rb=void 0,Sb=void 0,oc=void 0,ua=void 0,gc=void 0,$b=void 0,jc=void 0,kc=void 0,Sa=void 0,hc=void 0,Pa=void 0,Qa=void 0,ac=void 0,Vb=void 0,Ia=0,Ma=
0,Wb=0,Xb=0,ub=0,Ya=0,ya=0,cb=0,Ja=0,ha=0,ka=0,y=0,wa=void 0,Ta=ra.__vertexArray,pc=ra.__uvArray,qc=ra.__uv2Array,vb=ra.__normalArray,Ca=ra.__tangentArray,Ua=ra.__colorArray,Da=ra.__skinIndexArray,Ea=ra.__skinWeightArray,Sc=ra.__morphTargetsArrays,Tc=ra.__morphNormalsArrays,Uc=ra.__webglCustomAttributesList,w=void 0,Tb=ra.__faceArray,mb=ra.__lineArray,gb=Ra.geometry,xc=gb.elementsNeedUpdate,nc=gb.uvsNeedUpdate,yc=gb.normalsNeedUpdate,Pc=gb.tangentsNeedUpdate,Qc=gb.colorsNeedUpdate,hd=gb.morphTargetsNeedUpdate,
ec=gb.vertices,sa=ra.faces3,ta=ra.faces4,Za=gb.faces,Vc=gb.faceVertexUvs[0],Wc=gb.faceVertexUvs[1],fc=gb.skinIndices,bc=gb.skinWeights,cc=gb.morphTargets,Ac=gb.morphNormals;if(gb.verticesNeedUpdate){F=0;for(ba=sa.length;F<ba;F++)S=Za[sa[F]],W=ec[S.a],X=ec[S.b],Y=ec[S.c],Ta[Ma]=W.x,Ta[Ma+1]=W.y,Ta[Ma+2]=W.z,Ta[Ma+3]=X.x,Ta[Ma+4]=X.y,Ta[Ma+5]=X.z,Ta[Ma+6]=Y.x,Ta[Ma+7]=Y.y,Ta[Ma+8]=Y.z,Ma+=9;F=0;for(ba=ta.length;F<ba;F++)S=Za[ta[F]],W=ec[S.a],X=ec[S.b],Y=ec[S.c],oa=ec[S.d],Ta[Ma]=W.x,Ta[Ma+1]=W.y,Ta[Ma+
2]=W.z,Ta[Ma+3]=X.x,Ta[Ma+4]=X.y,Ta[Ma+5]=X.z,Ta[Ma+6]=Y.x,Ta[Ma+7]=Y.y,Ta[Ma+8]=Y.z,Ta[Ma+9]=oa.x,Ta[Ma+10]=oa.y,Ta[Ma+11]=oa.z,Ma+=12;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Ta,Ba)}if(hd){Sa=0;for(hc=cc.length;Sa<hc;Sa++){F=ka=0;for(ba=sa.length;F<ba;F++)ac=sa[F],S=Za[ac],W=cc[Sa].vertices[S.a],X=cc[Sa].vertices[S.b],Y=cc[Sa].vertices[S.c],Pa=Sc[Sa],Pa[ka]=W.x,Pa[ka+1]=W.y,Pa[ka+2]=W.z,Pa[ka+3]=X.x,Pa[ka+4]=X.y,Pa[ka+5]=X.z,Pa[ka+6]=Y.x,Pa[ka+7]=Y.y,Pa[ka+
8]=Y.z,db.morphNormals&&(fb?(Vb=Ac[Sa].vertexNormals[ac],Hb=Vb.a,Ib=Vb.b,Jb=Vb.c):Jb=Ib=Hb=Ac[Sa].faceNormals[ac],Qa=Tc[Sa],Qa[ka]=Hb.x,Qa[ka+1]=Hb.y,Qa[ka+2]=Hb.z,Qa[ka+3]=Ib.x,Qa[ka+4]=Ib.y,Qa[ka+5]=Ib.z,Qa[ka+6]=Jb.x,Qa[ka+7]=Jb.y,Qa[ka+8]=Jb.z),ka+=9;F=0;for(ba=ta.length;F<ba;F++)ac=ta[F],S=Za[ac],W=cc[Sa].vertices[S.a],X=cc[Sa].vertices[S.b],Y=cc[Sa].vertices[S.c],oa=cc[Sa].vertices[S.d],Pa=Sc[Sa],Pa[ka]=W.x,Pa[ka+1]=W.y,Pa[ka+2]=W.z,Pa[ka+3]=X.x,Pa[ka+4]=X.y,Pa[ka+5]=X.z,Pa[ka+6]=Y.x,Pa[ka+
7]=Y.y,Pa[ka+8]=Y.z,Pa[ka+9]=oa.x,Pa[ka+10]=oa.y,Pa[ka+11]=oa.z,db.morphNormals&&(fb?(Vb=Ac[Sa].vertexNormals[ac],Hb=Vb.a,Ib=Vb.b,Jb=Vb.c,yb=Vb.d):yb=Jb=Ib=Hb=Ac[Sa].faceNormals[ac],Qa=Tc[Sa],Qa[ka]=Hb.x,Qa[ka+1]=Hb.y,Qa[ka+2]=Hb.z,Qa[ka+3]=Ib.x,Qa[ka+4]=Ib.y,Qa[ka+5]=Ib.z,Qa[ka+6]=Jb.x,Qa[ka+7]=Jb.y,Qa[ka+8]=Jb.z,Qa[ka+9]=yb.x,Qa[ka+10]=yb.y,Qa[ka+11]=yb.z),ka+=12;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglMorphTargetsBuffers[Sa]);k.bufferData(k.ARRAY_BUFFER,Sc[Sa],Ba);db.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,
ra.__webglMorphNormalsBuffers[Sa]),k.bufferData(k.ARRAY_BUFFER,Tc[Sa],Ba))}}if(bc.length){F=0;for(ba=sa.length;F<ba;F++)S=Za[sa[F]],Nb=bc[S.a],Ob=bc[S.b],Pb=bc[S.c],Ea[ha]=Nb.x,Ea[ha+1]=Nb.y,Ea[ha+2]=Nb.z,Ea[ha+3]=Nb.w,Ea[ha+4]=Ob.x,Ea[ha+5]=Ob.y,Ea[ha+6]=Ob.z,Ea[ha+7]=Ob.w,Ea[ha+8]=Pb.x,Ea[ha+9]=Pb.y,Ea[ha+10]=Pb.z,Ea[ha+11]=Pb.w,Qb=fc[S.a],Rb=fc[S.b],Sb=fc[S.c],Da[ha]=Qb.x,Da[ha+1]=Qb.y,Da[ha+2]=Qb.z,Da[ha+3]=Qb.w,Da[ha+4]=Rb.x,Da[ha+5]=Rb.y,Da[ha+6]=Rb.z,Da[ha+7]=Rb.w,Da[ha+8]=Sb.x,Da[ha+9]=Sb.y,
Da[ha+10]=Sb.z,Da[ha+11]=Sb.w,ha+=12;F=0;for(ba=ta.length;F<ba;F++)S=Za[ta[F]],Nb=bc[S.a],Ob=bc[S.b],Pb=bc[S.c],Bb=bc[S.d],Ea[ha]=Nb.x,Ea[ha+1]=Nb.y,Ea[ha+2]=Nb.z,Ea[ha+3]=Nb.w,Ea[ha+4]=Ob.x,Ea[ha+5]=Ob.y,Ea[ha+6]=Ob.z,Ea[ha+7]=Ob.w,Ea[ha+8]=Pb.x,Ea[ha+9]=Pb.y,Ea[ha+10]=Pb.z,Ea[ha+11]=Pb.w,Ea[ha+12]=Bb.x,Ea[ha+13]=Bb.y,Ea[ha+14]=Bb.z,Ea[ha+15]=Bb.w,Qb=fc[S.a],Rb=fc[S.b],Sb=fc[S.c],oc=fc[S.d],Da[ha]=Qb.x,Da[ha+1]=Qb.y,Da[ha+2]=Qb.z,Da[ha+3]=Qb.w,Da[ha+4]=Rb.x,Da[ha+5]=Rb.y,Da[ha+6]=Rb.z,Da[ha+7]=Rb.w,
Da[ha+8]=Sb.x,Da[ha+9]=Sb.y,Da[ha+10]=Sb.z,Da[ha+11]=Sb.w,Da[ha+12]=oc.x,Da[ha+13]=oc.y,Da[ha+14]=oc.z,Da[ha+15]=oc.w,ha+=16;0<ha&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Da,Ba),k.bindBuffer(k.ARRAY_BUFFER,ra.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ea,Ba))}if(Qc&&jb){F=0;for(ba=sa.length;F<ba;F++)S=Za[sa[F]],Cb=S.vertexColors,pb=S.color,3===Cb.length&&jb===THREE.VertexColors?(Kb=Cb[0],Lb=Cb[1],Mb=Cb[2]):Mb=Lb=Kb=pb,Ua[Ja]=Kb.r,Ua[Ja+1]=Kb.g,
Ua[Ja+2]=Kb.b,Ua[Ja+3]=Lb.r,Ua[Ja+4]=Lb.g,Ua[Ja+5]=Lb.b,Ua[Ja+6]=Mb.r,Ua[Ja+7]=Mb.g,Ua[Ja+8]=Mb.b,Ja+=9;F=0;for(ba=ta.length;F<ba;F++)S=Za[ta[F]],Cb=S.vertexColors,pb=S.color,4===Cb.length&&jb===THREE.VertexColors?(Kb=Cb[0],Lb=Cb[1],Mb=Cb[2],Ab=Cb[3]):Ab=Mb=Lb=Kb=pb,Ua[Ja]=Kb.r,Ua[Ja+1]=Kb.g,Ua[Ja+2]=Kb.b,Ua[Ja+3]=Lb.r,Ua[Ja+4]=Lb.g,Ua[Ja+5]=Lb.b,Ua[Ja+6]=Mb.r,Ua[Ja+7]=Mb.g,Ua[Ja+8]=Mb.b,Ua[Ja+9]=Ab.r,Ua[Ja+10]=Ab.g,Ua[Ja+11]=Ab.b,Ja+=12;0<Ja&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,
Ua,Ba))}if(Pc&&gb.hasTangents){F=0;for(ba=sa.length;F<ba;F++)S=Za[sa[F]],Ub=S.vertexTangents,Eb=Ub[0],Fb=Ub[1],Gb=Ub[2],Ca[ya]=Eb.x,Ca[ya+1]=Eb.y,Ca[ya+2]=Eb.z,Ca[ya+3]=Eb.w,Ca[ya+4]=Fb.x,Ca[ya+5]=Fb.y,Ca[ya+6]=Fb.z,Ca[ya+7]=Fb.w,Ca[ya+8]=Gb.x,Ca[ya+9]=Gb.y,Ca[ya+10]=Gb.z,Ca[ya+11]=Gb.w,ya+=12;F=0;for(ba=ta.length;F<ba;F++)S=Za[ta[F]],Ub=S.vertexTangents,Eb=Ub[0],Fb=Ub[1],Gb=Ub[2],rb=Ub[3],Ca[ya]=Eb.x,Ca[ya+1]=Eb.y,Ca[ya+2]=Eb.z,Ca[ya+3]=Eb.w,Ca[ya+4]=Fb.x,Ca[ya+5]=Fb.y,Ca[ya+6]=Fb.z,Ca[ya+7]=Fb.w,
Ca[ya+8]=Gb.x,Ca[ya+9]=Gb.y,Ca[ya+10]=Gb.z,Ca[ya+11]=Gb.w,Ca[ya+12]=rb.x,Ca[ya+13]=rb.y,Ca[ya+14]=rb.z,Ca[ya+15]=rb.w,ya+=16;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Ca,Ba)}if(yc&&nb){F=0;for(ba=sa.length;F<ba;F++)if(S=Za[sa[F]],eb=S.vertexNormals,$a=S.normal,3===eb.length&&fb)for(ua=0;3>ua;ua++)$b=eb[ua],vb[Ya]=$b.x,vb[Ya+1]=$b.y,vb[Ya+2]=$b.z,Ya+=3;else for(ua=0;3>ua;ua++)vb[Ya]=$a.x,vb[Ya+1]=$a.y,vb[Ya+2]=$a.z,Ya+=3;F=0;for(ba=ta.length;F<ba;F++)if(S=Za[ta[F]],
eb=S.vertexNormals,$a=S.normal,4===eb.length&&fb)for(ua=0;4>ua;ua++)$b=eb[ua],vb[Ya]=$b.x,vb[Ya+1]=$b.y,vb[Ya+2]=$b.z,Ya+=3;else for(ua=0;4>ua;ua++)vb[Ya]=$a.x,vb[Ya+1]=$a.y,vb[Ya+2]=$a.z,Ya+=3;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,vb,Ba)}if(nc&&Vc&&ob){F=0;for(ba=sa.length;F<ba;F++)if(Xa=sa[F],kb=Vc[Xa],void 0!==kb)for(ua=0;3>ua;ua++)jc=kb[ua],pc[Wb]=jc.u,pc[Wb+1]=jc.v,Wb+=2;F=0;for(ba=ta.length;F<ba;F++)if(Xa=ta[F],kb=Vc[Xa],void 0!==kb)for(ua=0;4>ua;ua++)jc=
kb[ua],pc[Wb]=jc.u,pc[Wb+1]=jc.v,Wb+=2;0<Wb&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,pc,Ba))}if(nc&&Wc&&ob){F=0;for(ba=sa.length;F<ba;F++)if(Xa=sa[F],lb=Wc[Xa],void 0!==lb)for(ua=0;3>ua;ua++)kc=lb[ua],qc[Xb]=kc.u,qc[Xb+1]=kc.v,Xb+=2;F=0;for(ba=ta.length;F<ba;F++)if(Xa=ta[F],lb=Wc[Xa],void 0!==lb)for(ua=0;4>ua;ua++)kc=lb[ua],qc[Xb]=kc.u,qc[Xb+1]=kc.v,Xb+=2;0<Xb&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,qc,Ba))}if(xc){F=0;for(ba=
sa.length;F<ba;F++)Tb[ub]=Ia,Tb[ub+1]=Ia+1,Tb[ub+2]=Ia+2,ub+=3,mb[cb]=Ia,mb[cb+1]=Ia+1,mb[cb+2]=Ia,mb[cb+3]=Ia+2,mb[cb+4]=Ia+1,mb[cb+5]=Ia+2,cb+=6,Ia+=3;F=0;for(ba=ta.length;F<ba;F++)Tb[ub]=Ia,Tb[ub+1]=Ia+1,Tb[ub+2]=Ia+3,Tb[ub+3]=Ia+1,Tb[ub+4]=Ia+2,Tb[ub+5]=Ia+3,ub+=6,mb[cb]=Ia,mb[cb+1]=Ia+1,mb[cb+2]=Ia,mb[cb+3]=Ia+3,mb[cb+4]=Ia+1,mb[cb+5]=Ia+2,mb[cb+6]=Ia+2,mb[cb+7]=Ia+3,cb+=8,Ia+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ra.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Tb,Ba);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,
ra.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,mb,Ba)}if(Uc){ua=0;for(gc=Uc.length;ua<gc;ua++)if(w=Uc[ua],w.__original.needsUpdate){y=0;if(1===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){F=0;for(ba=sa.length;F<ba;F++)S=Za[sa[F]],w.array[y]=w.value[S.a],w.array[y+1]=w.value[S.b],w.array[y+2]=w.value[S.c],y+=3;F=0;for(ba=ta.length;F<ba;F++)S=Za[ta[F]],w.array[y]=w.value[S.a],w.array[y+1]=w.value[S.b],w.array[y+2]=w.value[S.c],w.array[y+3]=w.value[S.d],y+=4}else{if("faces"===w.boundTo){F=
0;for(ba=sa.length;F<ba;F++)wa=w.value[sa[F]],w.array[y]=wa,w.array[y+1]=wa,w.array[y+2]=wa,y+=3;F=0;for(ba=ta.length;F<ba;F++)wa=w.value[ta[F]],w.array[y]=wa,w.array[y+1]=wa,w.array[y+2]=wa,w.array[y+3]=wa,y+=4}}else if(2===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){F=0;for(ba=sa.length;F<ba;F++)S=Za[sa[F]],W=w.value[S.a],X=w.value[S.b],Y=w.value[S.c],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=X.x,w.array[y+3]=X.y,w.array[y+4]=Y.x,w.array[y+5]=Y.y,y+=6;F=0;for(ba=ta.length;F<ba;F++)S=
Za[ta[F]],W=w.value[S.a],X=w.value[S.b],Y=w.value[S.c],oa=w.value[S.d],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=X.x,w.array[y+3]=X.y,w.array[y+4]=Y.x,w.array[y+5]=Y.y,w.array[y+6]=oa.x,w.array[y+7]=oa.y,y+=8}else{if("faces"===w.boundTo){F=0;for(ba=sa.length;F<ba;F++)Y=X=W=wa=w.value[sa[F]],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=X.x,w.array[y+3]=X.y,w.array[y+4]=Y.x,w.array[y+5]=Y.y,y+=6;F=0;for(ba=ta.length;F<ba;F++)oa=Y=X=W=wa=w.value[ta[F]],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=
X.x,w.array[y+3]=X.y,w.array[y+4]=Y.x,w.array[y+5]=Y.y,w.array[y+6]=oa.x,w.array[y+7]=oa.y,y+=8}}else if(3===w.size){var ga;ga="c"===w.type?["r","g","b"]:["x","y","z"];if(void 0===w.boundTo||"vertices"===w.boundTo){F=0;for(ba=sa.length;F<ba;F++)S=Za[sa[F]],W=w.value[S.a],X=w.value[S.b],Y=w.value[S.c],w.array[y]=W[ga[0]],w.array[y+1]=W[ga[1]],w.array[y+2]=W[ga[2]],w.array[y+3]=X[ga[0]],w.array[y+4]=X[ga[1]],w.array[y+5]=X[ga[2]],w.array[y+6]=Y[ga[0]],w.array[y+7]=Y[ga[1]],w.array[y+8]=Y[ga[2]],y+=
9;F=0;for(ba=ta.length;F<ba;F++)S=Za[ta[F]],W=w.value[S.a],X=w.value[S.b],Y=w.value[S.c],oa=w.value[S.d],w.array[y]=W[ga[0]],w.array[y+1]=W[ga[1]],w.array[y+2]=W[ga[2]],w.array[y+3]=X[ga[0]],w.array[y+4]=X[ga[1]],w.array[y+5]=X[ga[2]],w.array[y+6]=Y[ga[0]],w.array[y+7]=Y[ga[1]],w.array[y+8]=Y[ga[2]],w.array[y+9]=oa[ga[0]],w.array[y+10]=oa[ga[1]],w.array[y+11]=oa[ga[2]],y+=12}else if("faces"===w.boundTo){F=0;for(ba=sa.length;F<ba;F++)Y=X=W=wa=w.value[sa[F]],w.array[y]=W[ga[0]],w.array[y+1]=W[ga[1]],
w.array[y+2]=W[ga[2]],w.array[y+3]=X[ga[0]],w.array[y+4]=X[ga[1]],w.array[y+5]=X[ga[2]],w.array[y+6]=Y[ga[0]],w.array[y+7]=Y[ga[1]],w.array[y+8]=Y[ga[2]],y+=9;F=0;for(ba=ta.length;F<ba;F++)oa=Y=X=W=wa=w.value[ta[F]],w.array[y]=W[ga[0]],w.array[y+1]=W[ga[1]],w.array[y+2]=W[ga[2]],w.array[y+3]=X[ga[0]],w.array[y+4]=X[ga[1]],w.array[y+5]=X[ga[2]],w.array[y+6]=Y[ga[0]],w.array[y+7]=Y[ga[1]],w.array[y+8]=Y[ga[2]],w.array[y+9]=oa[ga[0]],w.array[y+10]=oa[ga[1]],w.array[y+11]=oa[ga[2]],y+=12}else if("faceVertices"===
w.boundTo){F=0;for(ba=sa.length;F<ba;F++)wa=w.value[sa[F]],W=wa[0],X=wa[1],Y=wa[2],w.array[y]=W[ga[0]],w.array[y+1]=W[ga[1]],w.array[y+2]=W[ga[2]],w.array[y+3]=X[ga[0]],w.array[y+4]=X[ga[1]],w.array[y+5]=X[ga[2]],w.array[y+6]=Y[ga[0]],w.array[y+7]=Y[ga[1]],w.array[y+8]=Y[ga[2]],y+=9;F=0;for(ba=ta.length;F<ba;F++)wa=w.value[ta[F]],W=wa[0],X=wa[1],Y=wa[2],oa=wa[3],w.array[y]=W[ga[0]],w.array[y+1]=W[ga[1]],w.array[y+2]=W[ga[2]],w.array[y+3]=X[ga[0]],w.array[y+4]=X[ga[1]],w.array[y+5]=X[ga[2]],w.array[y+
6]=Y[ga[0]],w.array[y+7]=Y[ga[1]],w.array[y+8]=Y[ga[2]],w.array[y+9]=oa[ga[0]],w.array[y+10]=oa[ga[1]],w.array[y+11]=oa[ga[2]],y+=12}}else if(4===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){F=0;for(ba=sa.length;F<ba;F++)S=Za[sa[F]],W=w.value[S.a],X=w.value[S.b],Y=w.value[S.c],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=W.z,w.array[y+3]=W.w,w.array[y+4]=X.x,w.array[y+5]=X.y,w.array[y+6]=X.z,w.array[y+7]=X.w,w.array[y+8]=Y.x,w.array[y+9]=Y.y,w.array[y+10]=Y.z,w.array[y+11]=Y.w,y+=12;F=0;
for(ba=ta.length;F<ba;F++)S=Za[ta[F]],W=w.value[S.a],X=w.value[S.b],Y=w.value[S.c],oa=w.value[S.d],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=W.z,w.array[y+3]=W.w,w.array[y+4]=X.x,w.array[y+5]=X.y,w.array[y+6]=X.z,w.array[y+7]=X.w,w.array[y+8]=Y.x,w.array[y+9]=Y.y,w.array[y+10]=Y.z,w.array[y+11]=Y.w,w.array[y+12]=oa.x,w.array[y+13]=oa.y,w.array[y+14]=oa.z,w.array[y+15]=oa.w,y+=16}else if("faces"===w.boundTo){F=0;for(ba=sa.length;F<ba;F++)Y=X=W=wa=w.value[sa[F]],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+
2]=W.z,w.array[y+3]=W.w,w.array[y+4]=X.x,w.array[y+5]=X.y,w.array[y+6]=X.z,w.array[y+7]=X.w,w.array[y+8]=Y.x,w.array[y+9]=Y.y,w.array[y+10]=Y.z,w.array[y+11]=Y.w,y+=12;F=0;for(ba=ta.length;F<ba;F++)oa=Y=X=W=wa=w.value[ta[F]],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=W.z,w.array[y+3]=W.w,w.array[y+4]=X.x,w.array[y+5]=X.y,w.array[y+6]=X.z,w.array[y+7]=X.w,w.array[y+8]=Y.x,w.array[y+9]=Y.y,w.array[y+10]=Y.z,w.array[y+11]=Y.w,w.array[y+12]=oa.x,w.array[y+13]=oa.y,w.array[y+14]=oa.z,w.array[y+15]=oa.w,
y+=16}else if("faceVertices"===w.boundTo){F=0;for(ba=sa.length;F<ba;F++)wa=w.value[sa[F]],W=wa[0],X=wa[1],Y=wa[2],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=W.z,w.array[y+3]=W.w,w.array[y+4]=X.x,w.array[y+5]=X.y,w.array[y+6]=X.z,w.array[y+7]=X.w,w.array[y+8]=Y.x,w.array[y+9]=Y.y,w.array[y+10]=Y.z,w.array[y+11]=Y.w,y+=12;F=0;for(ba=ta.length;F<ba;F++)wa=w.value[ta[F]],W=wa[0],X=wa[1],Y=wa[2],oa=wa[3],w.array[y]=W.x,w.array[y+1]=W.y,w.array[y+2]=W.z,w.array[y+3]=W.w,w.array[y+4]=X.x,w.array[y+5]=
X.y,w.array[y+6]=X.z,w.array[y+7]=X.w,w.array[y+8]=Y.x,w.array[y+9]=Y.y,w.array[y+10]=Y.z,w.array[y+11]=Y.w,w.array[y+12]=oa.x,w.array[y+13]=oa.y,w.array[y+14]=oa.z,w.array[y+15]=oa.w,y+=16}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,Ba)}}qb&&(delete ra.__inittedArrays,delete ra.__colorArray,delete ra.__normalArray,delete ra.__tangentArray,delete ra.__uvArray,delete ra.__uv2Array,delete ra.__faceArray,delete ra.__vertexArray,delete ra.__lineArray,delete ra.__skinIndexArray,
delete ra.__skinWeightArray)}}V.verticesNeedUpdate=!1;V.morphTargetsNeedUpdate=!1;V.elementsNeedUpdate=!1;V.uvsNeedUpdate=!1;V.normalsNeedUpdate=!1;V.colorsNeedUpdate=!1;V.tangentsNeedUpdate=!1;V.buffersNeedUpdate=!1;la.attributes&&r(la)}else if(qa instanceof THREE.Ribbon){la=e(qa,V);va=la.attributes&&t(la);if(V.verticesNeedUpdate||V.colorsNeedUpdate||V.normalsNeedUpdate||va){var wb=V,Bc=k.DYNAMIC_DRAW,rc=void 0,sc=void 0,tc=void 0,Cc=void 0,xa=void 0,Dc=void 0,Ec=void 0,Fc=void 0,Zc=void 0,Va=void 0,
lc=void 0,za=void 0,hb=void 0,$c=wb.vertices,ad=wb.colors,bd=wb.normals,id=$c.length,jd=ad.length,kd=bd.length,Gc=wb.__vertexArray,Hc=wb.__colorArray,Ic=wb.__normalArray,ld=wb.colorsNeedUpdate,md=wb.normalsNeedUpdate,Xc=wb.__webglCustomAttributesList;if(wb.verticesNeedUpdate){for(rc=0;rc<id;rc++)Cc=$c[rc],xa=3*rc,Gc[xa]=Cc.x,Gc[xa+1]=Cc.y,Gc[xa+2]=Cc.z;k.bindBuffer(k.ARRAY_BUFFER,wb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Gc,Bc)}if(ld){for(sc=0;sc<jd;sc++)Dc=ad[sc],xa=3*sc,Hc[xa]=Dc.r,Hc[xa+
1]=Dc.g,Hc[xa+2]=Dc.b;k.bindBuffer(k.ARRAY_BUFFER,wb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Hc,Bc)}if(md){for(tc=0;tc<kd;tc++)Ec=bd[tc],xa=3*tc,Ic[xa]=Ec.x,Ic[xa+1]=Ec.y,Ic[xa+2]=Ec.z;k.bindBuffer(k.ARRAY_BUFFER,wb.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,Ic,Bc)}if(Xc){Fc=0;for(Zc=Xc.length;Fc<Zc;Fc++)if(za=Xc[Fc],za.needsUpdate&&(void 0===za.boundTo||"vertices"===za.boundTo)){xa=0;lc=za.value.length;if(1===za.size)for(Va=0;Va<lc;Va++)za.array[Va]=za.value[Va];else if(2===za.size)for(Va=
0;Va<lc;Va++)hb=za.value[Va],za.array[xa]=hb.x,za.array[xa+1]=hb.y,xa+=2;else if(3===za.size)if("c"===za.type)for(Va=0;Va<lc;Va++)hb=za.value[Va],za.array[xa]=hb.r,za.array[xa+1]=hb.g,za.array[xa+2]=hb.b,xa+=3;else for(Va=0;Va<lc;Va++)hb=za.value[Va],za.array[xa]=hb.x,za.array[xa+1]=hb.y,za.array[xa+2]=hb.z,xa+=3;else if(4===za.size)for(Va=0;Va<lc;Va++)hb=za.value[Va],za.array[xa]=hb.x,za.array[xa+1]=hb.y,za.array[xa+2]=hb.z,za.array[xa+3]=hb.w,xa+=4;k.bindBuffer(k.ARRAY_BUFFER,za.buffer);k.bufferData(k.ARRAY_BUFFER,
za.array,Bc)}}}V.verticesNeedUpdate=!1;V.colorsNeedUpdate=!1;V.normalsNeedUpdate=!1;la.attributes&&r(la)}else if(qa instanceof THREE.Line){la=e(qa,V);va=la.attributes&&t(la);if(V.verticesNeedUpdate||V.colorsNeedUpdate||V.lineDistancesNeedUpdate||va){var xb=V,Jc=k.DYNAMIC_DRAW,uc=void 0,vc=void 0,wc=void 0,Kc=void 0,Fa=void 0,Lc=void 0,cd=xb.vertices,dd=xb.colors,ed=xb.lineDistances,nd=cd.length,od=dd.length,pd=ed.length,Mc=xb.__vertexArray,Nc=xb.__colorArray,fd=xb.__lineDistanceArray,qd=xb.colorsNeedUpdate,
rd=xb.lineDistancesNeedUpdate,Yc=xb.__webglCustomAttributesList,Oc=void 0,gd=void 0,Wa=void 0,mc=void 0,ib=void 0,Aa=void 0;if(xb.verticesNeedUpdate){for(uc=0;uc<nd;uc++)Kc=cd[uc],Fa=3*uc,Mc[Fa]=Kc.x,Mc[Fa+1]=Kc.y,Mc[Fa+2]=Kc.z;k.bindBuffer(k.ARRAY_BUFFER,xb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Mc,Jc)}if(qd){for(vc=0;vc<od;vc++)Lc=dd[vc],Fa=3*vc,Nc[Fa]=Lc.r,Nc[Fa+1]=Lc.g,Nc[Fa+2]=Lc.b;k.bindBuffer(k.ARRAY_BUFFER,xb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Nc,Jc)}if(rd){for(wc=0;wc<
pd;wc++)fd[wc]=ed[wc];k.bindBuffer(k.ARRAY_BUFFER,xb.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,fd,Jc)}if(Yc){Oc=0;for(gd=Yc.length;Oc<gd;Oc++)if(Aa=Yc[Oc],Aa.needsUpdate&&(void 0===Aa.boundTo||"vertices"===Aa.boundTo)){Fa=0;mc=Aa.value.length;if(1===Aa.size)for(Wa=0;Wa<mc;Wa++)Aa.array[Wa]=Aa.value[Wa];else if(2===Aa.size)for(Wa=0;Wa<mc;Wa++)ib=Aa.value[Wa],Aa.array[Fa]=ib.x,Aa.array[Fa+1]=ib.y,Fa+=2;else if(3===Aa.size)if("c"===Aa.type)for(Wa=0;Wa<mc;Wa++)ib=Aa.value[Wa],Aa.array[Fa]=
ib.r,Aa.array[Fa+1]=ib.g,Aa.array[Fa+2]=ib.b,Fa+=3;else for(Wa=0;Wa<mc;Wa++)ib=Aa.value[Wa],Aa.array[Fa]=ib.x,Aa.array[Fa+1]=ib.y,Aa.array[Fa+2]=ib.z,Fa+=3;else if(4===Aa.size)for(Wa=0;Wa<mc;Wa++)ib=Aa.value[Wa],Aa.array[Fa]=ib.x,Aa.array[Fa+1]=ib.y,Aa.array[Fa+2]=ib.z,Aa.array[Fa+3]=ib.w,Fa+=4;k.bindBuffer(k.ARRAY_BUFFER,Aa.buffer);k.bufferData(k.ARRAY_BUFFER,Aa.array,Jc)}}}V.verticesNeedUpdate=!1;V.colorsNeedUpdate=!1;V.lineDistancesNeedUpdate=!1;la.attributes&&r(la)}else qa instanceof THREE.ParticleSystem&&
(V instanceof THREE.BufferGeometry?((V.verticesNeedUpdate||V.colorsNeedUpdate)&&j(V,k.DYNAMIC_DRAW,!V.dynamic),V.verticesNeedUpdate=!1,V.colorsNeedUpdate=!1):(la=e(qa,V),va=la.attributes&&t(la),(V.verticesNeedUpdate||V.colorsNeedUpdate||qa.sortParticles||va)&&i(V,k.DYNAMIC_DRAW,qa),V.verticesNeedUpdate=!1,V.colorsNeedUpdate=!1,la.attributes&&r(la)))}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,m,n;a instanceof THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":
a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.LineDashedMaterial?n="dashed":a instanceof THREE.ParticleBasicMaterial?n="particle_basic":a instanceof THREE.ParticleDepthMaterial&&(n="particle_depth");if(n){var o=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,
s,r;e=p=s=r=o=0;for(f=b.length;e<f;e++)g=b[e],g.onlyShadow||(g instanceof THREE.DirectionalLight&&p++,g instanceof THREE.PointLight&&s++,g instanceof THREE.SpotLight&&r++,g instanceof THREE.HemisphereLight&&o++);e=p;f=s;g=r;h=o;o=p=0;for(r=b.length;o<r;o++)s=b[o],s.castShadow&&(s instanceof THREE.SpotLight&&p++,s instanceof THREE.DirectionalLight&&!s.shadowCascade&&p++);m=p;gc&&d&&d.useVertexTexture?l=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),b=Math.floor((b-20)/4),void 0!==d&&d instanceof
...
x);for(x=0;x<c.maxMorphNormals;x++)t.push("morphNormal"+x);for(q in b)t.push(q);q=t;x=0;for(b=q.length;x<b;x++)t=q[x],v.attributes[t]=k.getAttribLocation(v,t);v.id=ca++;R.push({program:v,code:n,usedTimes:1});T.info.memory.programs=R.length;q=v}a.program=q;q=a.program.attributes;0<=q.position&&k.enableVertexAttribArray(q.position);0<=q.color&&k.enableVertexAttribArray(q.color);0<=q.normal&&k.enableVertexAttribArray(q.normal);0<=q.tangent&&k.enableVertexAttribArray(q.tangent);0<=q.lineDistance&&k.enableVertexAttribArray(q.lineDistance);
a.skinning&&(0<=q.skinIndex&&0<=q.skinWeight)&&(k.enableVertexAttribArray(q.skinIndex),k.enableVertexAttribArray(q.skinWeight));if(a.attributes)for(j in a.attributes)void 0!==q[j]&&0<=q[j]&&k.enableVertexAttribArray(q[j]);if(a.morphTargets){a.numSupportedMorphTargets=0;v="morphTarget";for(j=0;j<this.maxMorphTargets;j++)x=v+j,0<=q[x]&&(k.enableVertexAttribArray(q[x]),a.numSupportedMorphTargets++)}if(a.morphNormals){a.numSupportedMorphNormals=0;v="morphNormal";for(j=0;j<this.maxMorphNormals;j++)x=v+
j,0<=q[x]&&(k.enableVertexAttribArray(q[x]),a.numSupportedMorphNormals++)}a.uniformsList=[];for(i in a.uniforms)a.uniformsList.push([a.uniforms[i],i])};this.setFaceCulling=function(a,b){a?(!b||"ccw"===b?k.frontFace(k.CCW):k.frontFace(k.CW),"back"===a?k.cullFace(k.BACK):"front"===a?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK),k.enable(k.CULL_FACE)):k.disable(k.CULL_FACE)};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,a=a.side===THREE.BackSide;La!==b&&(b?k.disable(k.CULL_FACE):
k.enable(k.CULL_FACE),La=b);Ga!==a&&(a?k.frontFace(k.CW):k.frontFace(k.CCW),Ga=a)};this.setDepthTest=function(a){jb!==a&&(a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST),jb=a)};this.setDepthWrite=function(a){ob!==a&&(k.depthMask(a),ob=a)};this.setBlending=function(a,b,c,d){a!==pa&&(a===THREE.NoBlending?k.disable(k.BLEND):a===THREE.AdditiveBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.SRC_ALPHA,k.ONE)):a===THREE.SubtractiveBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),
k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.SRC_COLOR)):a===THREE.CustomBlending?k.enable(k.BLEND):(k.enable(k.BLEND),k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD),k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)),pa=a);if(a===THREE.CustomBlending){if(b!==Ba&&(k.blendEquation(I(b)),Ba=b),c!==db||d!==qb)k.blendFunc(I(c),I(d)),db=c,qb=d}else qb=db=Ba=null};this.setTexture=
function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.__webglTexture=k.createTexture(),T.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=I(a.format),f=I(a.type);B(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var f=a.mipmaps,g=0,h=f.length;g<
...
a.depthBuffer&&(a.depthBuffer=!0);void 0===a.stencilBuffer&&(a.stencilBuffer=!0);a.__webglTexture=k.createTexture();var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=I(a.format),e=I(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);B(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,
a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);K(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=k.createFramebuffer(),a.__webglRenderbuffer=k.createRenderbuffer(),k.bindTexture(k.TEXTURE_2D,a.__webglTexture),B(k.TEXTURE_2D,a,c),k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=k.TEXTURE_2D,
k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0),K(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=la,a=fb,d=va,e=kb);b!==aa&&(k.bindFramebuffer(k.FRAMEBUFFER,
b),k.viewport(d,e,c,a),aa=b);eb=c;qa=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
b.push(i.clone());b.push(j.clone());f.a=e;f.b=e+1;f.c=e+2;f.d=e+3}else g=f.a,h=f.b,i=f.c,g=a.vertices[g],h=a.vertices[h],i=a.vertices[i],b.push(g.clone()),b.push(h.clone()),b.push(i.clone()),f.a=e,f.b=e+1,f.c=e+2}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,e,f,g,h,i,j,l,m,n,p,o,s,t,r,z,x,q,E=[],A=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)A[c]=[];c=0;for(d=a.faces.length;c<d;c++)if(e=a.faces[c],e instanceof THREE.Face3)if(f=e.a,g=e.b,h=e.c,j=a.vertices[f],l=a.vertices[g],
m=a.vertices[h],p=j.distanceTo(l),o=l.distanceTo(m),n=j.distanceTo(m),p>b||o>b||n>b){i=a.vertices.length;x=e.clone();q=e.clone();p>=o&&p>=n?(j=j.clone(),j.lerpSelf(l,0.5),x.a=f,x.b=i,x.c=h,q.a=i,q.b=g,q.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),x.vertexNormals[1].copy(f),q.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),x.vertexColors[1].copy(f),q.vertexColors[0].copy(f)),e=0):
o>=p&&o>=n?(j=l.clone(),j.lerpSelf(m,0.5),x.a=f,x.b=g,x.c=i,q.a=i,q.b=h,q.c=f,3===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerpSelf(e.vertexNormals[2],0.5),x.vertexNormals[2].copy(f),q.vertexNormals[0].copy(f),q.vertexNormals[1].copy(e.vertexNormals[2]),q.vertexNormals[2].copy(e.vertexNormals[0])),3===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),x.vertexColors[2].copy(f),q.vertexColors[0].copy(f),q.vertexColors[1].copy(e.vertexColors[2]),q.vertexColors[2].copy(e.vertexColors[0])),
e=1):(j=j.clone(),j.lerpSelf(m,0.5),x.a=f,x.b=g,x.c=i,q.a=i,q.b=g,q.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[2],0.5),x.vertexNormals[2].copy(f),q.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[2],0.5),x.vertexColors[2].copy(f),q.vertexColors[0].copy(f)),e=2);E.push(x,q);a.vertices.push(j);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],q=j[0],h=
j[1],x=j[2],0===e?(l=q.clone(),l.lerpSelf(h,0.5),j=[q.clone(),l.clone(),x.clone()],h=[l.clone(),h.clone(),x.clone()]):1===e?(l=h.clone(),l.lerpSelf(x,0.5),j=[q.clone(),h.clone(),l.clone()],h=[l.clone(),x.clone(),q.clone()]):(l=q.clone(),l.lerpSelf(x,0.5),j=[q.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),x.clone()]),A[f].push(j,h))}else{E.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,j=a.vertices[f],l=a.vertices[g],m=a.vertices[h],
n=a.vertices[i],p=j.distanceTo(l),o=l.distanceTo(m),s=m.distanceTo(n),t=j.distanceTo(n),p>b||o>b||s>b||t>b){r=a.vertices.length;z=a.vertices.length+1;x=e.clone();q=e.clone();p>=o&&p>=s&&p>=t||s>=o&&s>=p&&s>=t?(p=j.clone(),p.lerpSelf(l,0.5),l=m.clone(),l.lerpSelf(n,0.5),x.a=f,x.b=r,x.c=z,x.d=i,q.a=r,q.b=g,q.c=h,q.d=z,4===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),g=e.vertexNormals[2].clone(),g.lerpSelf(e.vertexNormals[3],0.5),x.vertexNormals[1].copy(f),
x.vertexNormals[2].copy(g),q.vertexNormals[0].copy(f),q.vertexNormals[3].copy(g)),4===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),g=e.vertexColors[2].clone(),g.lerpSelf(e.vertexColors[3],0.5),x.vertexColors[1].copy(f),x.vertexColors[2].copy(g),q.vertexColors[0].copy(f),q.vertexColors[3].copy(g)),e=0):(p=l.clone(),p.lerpSelf(m,0.5),l=n.clone(),l.lerpSelf(j,0.5),x.a=f,x.b=g,x.c=r,x.d=z,q.a=z,q.b=r,q.c=h,q.d=i,4===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),
f.lerpSelf(e.vertexNormals[2],0.5),g=e.vertexNormals[3].clone(),g.lerpSelf(e.vertexNormals[0],0.5),x.vertexNormals[2].copy(f),x.vertexNormals[3].copy(g),q.vertexNormals[0].copy(g),q.vertexNormals[1].copy(f)),4===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),g=e.vertexColors[3].clone(),g.lerpSelf(e.vertexColors[0],0.5),x.vertexColors[2].copy(f),x.vertexColors[3].copy(g),q.vertexColors[0].copy(g),q.vertexColors[1].copy(f)),e=1);E.push(x,q);a.vertices.push(p,l);
f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],q=j[0],h=j[1],x=j[2],j=j[3],0===e?(l=q.clone(),l.lerpSelf(h,0.5),m=x.clone(),m.lerpSelf(j,0.5),q=[q.clone(),l.clone(),m.clone(),j.clone()],h=[l.clone(),h.clone(),x.clone(),m.clone()]):(l=h.clone(),l.lerpSelf(x,0.5),m=j.clone(),m.lerpSelf(q,0.5),q=[q.clone(),h.clone(),l.clone(),m.clone()],h=[m.clone(),l.clone(),x.clone(),j.clone()]),A[f].push(q,h))}else{E.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}a.faces=
...
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],g=[],h=[],i,j,l;if(0<b(a))for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var m=2*e;for(j=e-1;2<e;){if(0>=m--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);l=j+1;e<=l&&(l=0);var n;a:{n=a;var p=i,o=j,s=l,t=e,r=g,z=void 0,x=void 0,q=void 0,E=void 0,A=void 0,
u=void 0,v=void 0,D=void 0,C=void 0,x=n[r[p]].x,q=n[r[p]].y,E=n[r[o]].x,A=n[r[o]].y,u=n[r[s]].x,v=n[r[s]].y;if(1E-10>(E-x)*(v-q)-(A-q)*(u-x))n=!1;else{for(z=0;z<t;z++)if(!(z==p||z==o||z==s)){var D=n[r[z]].x,C=n[r[z]].y,G=void 0,M=void 0,B=void 0,K=void 0,H=void 0,I=void 0,O=void 0,N=void 0,P=void 0,Z=void 0,L=void 0,J=void 0,G=B=H=void 0,G=u-E,M=v-A,B=x-u,K=q-v,H=E-x,I=A-q,O=D-x,N=C-q,P=D-E,Z=C-A,L=D-u,J=C-v,G=G*Z-M*P,H=H*N-I*O,B=B*J-K*L;if(0<=G&&0<=B&&0<=H){n=!1;break a}}n=!0}}if(n){f.push([a[g[i]],
...
THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,s){var t,r=h.widthSegments,z=h.heightSegments,x=e/2,q=f/2,E=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)t="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)t="y",z=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)t="x",r=h.depthSegments;var A=r+1,u=z+1,v=e/r,D=f/z,C=new THREE.Vector3;C[t]=0<g?1:-1;for(e=0;e<u;e++)for(f=0;f<A;f++){var G=new THREE.Vector3;G[a]=(f*v-x)*c;G[b]=(e*D-q)*d;G[t]=g;h.vertices.push(G)}for(e=
...
1]].clone()):(m=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var p=j[i][h],o=j[i+1][h],s=j[i+1][h+1],t=j[i][h+1],r=m.clone(),z=m.clone(),x=n.clone(),q=n.clone(),E=l[i][h].clone(),A=l[i+1][h].clone(),u=l[i+1][h+1].clone(),v=l[i][h+1].clone();this.faces.push(new THREE.Face4(p,o,s,t,[r,z,x,q]));this.faceVertexUvs[0].push([E,A,u,v])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
g,0));for(h=0;h<d;h++)p=j[0][h],o=j[0][h+1],s=this.vertices.length-1,r=new THREE.Vector3(0,1,0),z=new THREE.Vector3(0,1,0),x=new THREE.Vector3(0,1,0),E=l[0][h].clone(),A=l[0][h+1].clone(),u=new THREE.UV(A.u,0),this.faces.push(new THREE.Face3(p,o,s,[r,z,x])),this.faceVertexUvs[0].push([E,A,u])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)p=j[i][h+1],o=j[i][h],s=this.vertices.length-1,r=new THREE.Vector3(0,-1,0),z=new THREE.Vector3(0,-1,0),x=new THREE.Vector3(0,-1,0),E=
l[i][h+1].clone(),A=l[i][h].clone(),u=new THREE.UV(A.u,1),this.faces.push(new THREE.Face3(p,o,s,[r,z,x])),this.faceVertexUvs[0].push([E,A,u])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};
...
for(var g=0,h=n+2*l,g=0;g<h;g++){var i=P*g,j=P*(g+1),m=d+e+i,i=d+f+i,o=d+f+j,j=d+e+j,p=c,s=g,q=h,t=e,u=f,m=m+G,i=i+G,o=o+G,j=j+G;C.faces.push(new THREE.Face4(m,i,o,j,null,null,r));m=z.generateSideWallUV(C,a,p,b,m,i,o,j,s,q,t,u);C.faceVertexUvs[0].push(m)}}}function f(a,b,c){C.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=G;d+=G;e+=G;C.faces.push(new THREE.Face3(c,d,e,null,null,t));c=f?z.generateBottomUV(C,a,b,c,d,e):z.generateTopUV(C,a,b,c,d,e);C.faceVertexUvs[0].push(c)}var h=void 0!==
b.amount?b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,l=void 0!==b.bevelSegments?b.bevelSegments:3,m=void 0!==b.bevelEnabled?b.bevelEnabled:!0,n=void 0!==b.steps?b.steps:1,p=b.extrudePath,o,s=!1,t=b.material,r=b.extrudeMaterial,z=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,x,q,E,A;p&&(o=p.getSpacedPoints(n),s=!0,m=!1,x=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(p,n,!1),q=new THREE.Vector3,E=new THREE.Vector3,
A=new THREE.Vector3);m||(j=i=l=0);var u,v,D,C=this,G=this.vertices.length,p=a.extractPoints(),M=p.shape,p=p.holes,B=!THREE.Shape.Utils.isClockWise(M);if(B){M=M.reverse();v=0;for(D=p.length;v<D;v++)u=p[v],THREE.Shape.Utils.isClockWise(u)&&(p[v]=u.reverse());B=!1}var K=THREE.Shape.Utils.triangulateShape(M,p),B=M;v=0;for(D=p.length;v<D;v++)u=p[v],M=M.concat(u);var H,I,O,N,P=M.length,Z=K.length,L=[],J=0,U=B.length;H=U-1;for(I=J+1;J<U;J++,H++,I++)H===U&&(H=0),I===U&&(I=0),L[J]=d(B[J],B[H],B[I]);var Q=
[],da,T=L.concat();v=0;for(D=p.length;v<D;v++){u=p[v];da=[];J=0;U=u.length;H=U-1;for(I=J+1;J<U;J++,H++,I++)H===U&&(H=0),I===U&&(I=0),da[J]=d(u[J],u[H],u[I]);Q.push(da);T=T.concat(da)}for(H=0;H<l;H++){u=H/l;O=i*(1-u);I=j*Math.sin(u*Math.PI/2);J=0;for(U=B.length;J<U;J++)N=c(B[J],L[J],I),f(N.x,N.y,-O);v=0;for(D=p.length;v<D;v++){u=p[v];da=Q[v];J=0;for(U=u.length;J<U;J++)N=c(u[J],da[J],I),f(N.x,N.y,-O)}}I=j;for(J=0;J<P;J++)N=m?c(M[J],T[J],I):M[J],s?(E.copy(x.normals[0]).multiplyScalar(N.x),q.copy(x.binormals[0]).multiplyScalar(N.y),
A.copy(o[0]).addSelf(E).addSelf(q),f(A.x,A.y,A.z)):f(N.x,N.y,0);for(u=1;u<=n;u++)for(J=0;J<P;J++)N=m?c(M[J],T[J],I):M[J],s?(E.copy(x.normals[u]).multiplyScalar(N.x),q.copy(x.binormals[u]).multiplyScalar(N.y),A.copy(o[u]).addSelf(E).addSelf(q),f(A.x,A.y,A.z)):f(N.x,N.y,h/n*u);for(H=l-1;0<=H;H--){u=H/l;O=i*(1-u);I=j*Math.sin(u*Math.PI/2);J=0;for(U=B.length;J<U;J++)N=c(B[J],L[J],I),f(N.x,N.y,h+O);v=0;for(D=p.length;v<D;v++){u=p[v];da=Q[v];J=0;for(U=u.length;J<U;J++)N=c(u[J],da[J],I),s?f(N.x,N.y+o[n-
1].y,o[n-1].x+O):f(N.x,N.y,h+O)}}if(m){i=0*P;for(J=0;J<Z;J++)h=K[J],g(h[2]+i,h[1]+i,h[0]+i,!0);i=P*(n+2*l);for(J=0;J<Z;J++)h=K[J],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(J=0;J<Z;J++)h=K[J],g(h[2],h[1],h[0],!0);for(J=0;J<Z;J++)h=K[J],g(h[0]+P*n,h[1]+P*n,h[2]+P*n,!1)}h=0;e(B,h);h+=B.length;v=0;for(D=p.length;v<D;v++)u=p[v],e(u,h),h+=u.length};
...
1],o.r+=p.r,o.g+=p.g,o.b+=p.b;o.r/=q.length;o.g/=q.length;o.b/=q.length;n.vertexColors[r]=o}}i.push(n);l.supportUVs&&(g=[f(a,""),f(b,m),f(d,m),f(e,m)],g[0]?g[1]?g[2]?g[3]?j.push(g):c("d :( ",e+":"+m):c("c :( ",d+":"+m):c("b :( ",b+":"+m):c("a :( ",a+":"+m))}function f(a,b){var e=a+":"+b,f=x[e];return!f?(a>=s&&a<s+o.length?c("face pt"):c("edge pt"),d("warning, UV not found for",e),null):f}function g(a,b,c){var e=a+":"+b;e in x?d("dup vertexNo",a,"oldFaceNo",b,"value",c,"key",e,x[e]):x[e]=c}var h=[],
i=[],j=[],l=this,m=THREE.GeometryUtils.orderedKey,n=THREE.GeometryUtils.computeEdgeFaces,p=a.vertices,o=a.faces,s=p.length,h=p.concat(),t=[],r={},z={},x={},q,E,A,u,v,D=a.faceVertexUvs[0],C;c("originalFaces, uvs, originalVerticesLength",o.length,D.length,s);if(l.supportUVs){q=0;for(E=D.length;q<E;q++){A=0;for(u=D[q].length;A<u;A++)C=o[q]["abcd".charAt(A)],g(C,q,D[q][A])}}0==D.length&&(l.supportUVs=!1);q=0;for(var G in x)q++;q||(l.supportUVs=!1,c("no uvs"));q=0;for(E=o.length;q<E;q++)v=o[q],t.push(v.centroid),
h.push(v.centroid),l.supportUVs&&(u=new THREE.UV,v instanceof THREE.Face3?(u.u=f(v.a,q).u+f(v.b,q).u+f(v.c,q).u,u.v=f(v.a,q).v+f(v.b,q).v+f(v.c,q).v,u.u/=3,u.v/=3):v instanceof THREE.Face4&&(u.u=f(v.a,q).u+f(v.b,q).u+f(v.c,q).u+f(v.d,q).u,u.v=f(v.a,q).v+f(v.b,q).v+f(v.c,q).v+f(v.d,q).v,u.u/=4,u.v/=4),g(s+q,"",u));var n=n(a),M;E=0;var B,K;G={};D={};for(q in n){C=n[q];B=q.split("_");K=B[0];B=B[1];A=K;v=[K,B];void 0===G[A]&&(G[A]=[]);G[A].push(v);A=B;v=[K,B];void 0===G[A]&&(G[A]=[]);G[A].push(v);A=0;
for(u=C.length;A<u;A++){v=C[A];M=K;var H=v,I=q;void 0===D[M]&&(D[M]={});D[M][H]=I;M=B;H=q;void 0===D[M]&&(D[M]={});D[M][v]=H}2>C.length&&(z[q]=!0)}for(q in n)if(C=n[q],v=C[0],M=C[1],B=q.split("_"),K=B[0],B=B[1],u=new THREE.Vector3,b(0<C.length,"an edge without faces?!"),1==C.length?(u.addSelf(p[K]),u.addSelf(p[B]),u.multiplyScalar(0.5)):(u.addSelf(t[v]),u.addSelf(t[M]),u.addSelf(p[K]),u.addSelf(p[B]),u.multiplyScalar(0.25)),r[q]=s+o.length+E,h.push(u),E++,l.supportUVs)u=new THREE.UV,u.u=f(K,v).u+
f(B,v).u,u.v=f(K,v).v+f(B,v).v,u.u/=2,u.v/=2,g(r[q],v,u),2<=C.length&&(b(2==C.length,"did we plan for more than 2 edges?"),u=new THREE.UV,u.u=f(K,M).u+f(B,M).u,u.v=f(K,M).v+f(B,M).v,u.u/=2,u.v/=2,g(r[q],M,u));c("-- Step 2 done");var O,N;u=["123","12","2","23"];M=["123","23","3","31"];var H=["123","31","1","12"],I=["1234","12","2","23"],P=["1234","23","3","34"],Z=["1234","34","4","41"],L=["1234","41","1","12"];q=0;for(E=t.length;q<E;q++)v=o[q],C=s+q,v instanceof THREE.Face3?(K=m(v.a,v.b),B=m(v.b,v.c),
O=m(v.c,v.a),e(C,r[K],v.b,r[B],v,u,q),e(C,r[B],v.c,r[O],v,M,q),e(C,r[O],v.a,r[K],v,H,q)):v instanceof THREE.Face4?(K=m(v.a,v.b),B=m(v.b,v.c),O=m(v.c,v.d),N=m(v.d,v.a),e(C,r[K],v.b,r[B],v,I,q),e(C,r[B],v.c,r[O],v,P,q),e(C,r[O],v.d,r[N],v,Z,q),e(C,r[N],v.a,r[K],v,L,q)):c("face should be a face!",v);r=new THREE.Vector3;v=new THREE.Vector3;q=0;for(E=p.length;q<E;q++)if(void 0!==G[q]){r.set(0,0,0);v.set(0,0,0);B=new THREE.Vector3(0,0,0);C=0;for(A in D[q])r.addSelf(t[A]),C++;M=0;K=G[q].length;u=C!=K;for(A=
0;A<K;A++)z[m(G[q][A][0],G[q][A][1])]&&M++;r.divideScalar(C);M=0;if(u){for(A=0;A<K;A++)if(C=G[q][A],H=1==n[m(C[0],C[1])].length)C=p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2),v.addSelf(C),M++;v.divideScalar(4);b(2==M,"should have only 2 boundary edges")}else{for(A=0;A<K;A++)C=G[q][A],C=p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2),v.addSelf(C);v.divideScalar(K)}B.addSelf(p[q]);u?(B.divideScalar(2),B.addSelf(v)):(B.multiplyScalar(K-3),B.addSelf(r),B.addSelf(v.multiplyScalar(2)),B.divideScalar(K));
...
"color");n.scale=b.getUniformLocation(l,"scale");n.rotation=b.getUniformLocation(l,"rotation");n.screenPosition=b.getUniformLocation(l,"screenPosition");p=!1};this.render=function(a,d,e,r){var a=a.__webglFlares,z=a.length;if(z){var x=new THREE.Vector3,q=r/e,E=0.5*e,A=0.5*r,u=16/r,v=new THREE.Vector2(u*q,u),D=new THREE.Vector3(1,1,0),C=new THREE.Vector2(1,1),G=n,u=m;b.useProgram(l);p||(b.enableVertexAttribArray(m.vertex),b.enableVertexAttribArray(m.uv),p=!0);b.uniform1i(G.occlusionMap,0);b.uniform1i(G.map,
1);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(u.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(u.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var M,B,K,H,I;for(M=0;M<z;M++)if(u=16/r,v.set(u*q,u),H=a[M],x.set(H.matrixWorld.elements[12],H.matrixWorld.elements[13],H.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(x),d.projectionMatrix.multiplyVector3(x),D.copy(x),C.x=D.x*E+E,C.y=D.y*A+A,j||0<C.x&&C.x<e&&0<C.y&&C.y<r){b.activeTexture(b.TEXTURE1);
b.bindTexture(b.TEXTURE_2D,h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,C.x-8,C.y-8,16,16,0);b.uniform1i(G.renderType,0);b.uniform2f(G.scale,v.x,v.y);b.uniform3f(G.screenPosition,D.x,D.y,D.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,C.x-8,C.y-8,16,16,0);b.uniform1i(G.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,
h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);H.positionScreen.copy(D);H.customUpdateCallback?H.customUpdateCallback(H):H.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);B=0;for(K=H.lensFlares.length;B<K;B++)I=H.lensFlares[B],0.0010<I.opacity&&0.0010<I.scale&&(D.x=I.x,D.y=I.y,D.z=I.z,u=I.size*I.scale/r,v.x=u*q,v.y=u,b.uniform3f(G.screenPosition,D.x,D.y,D.z),b.uniform2f(G.scale,v.x,v.y),b.uniform1f(G.rotation,I.rotation),b.uniform1f(G.opacity,I.opacity),b.uniform3f(G.color,I.color.r,
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,m){var n,p,o,s,t,r,z,x,q,E=[];s=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
...
A.shadowCameraBottom=q.shadowCameraBottom;A.shadowCameraTop=q.shadowCameraTop;A.shadowCameraVisible=q.shadowCameraVisible;A.shadowDarkness=q.shadowDarkness;A.shadowBias=q.shadowCascadeBias[z];A.shadowMapWidth=q.shadowCascadeWidth[z];A.shadowMapHeight=q.shadowCascadeHeight[z];A.pointsWorld=[];A.pointsFrustum=[];x=A.pointsWorld;r=A.pointsFrustum;for(var u=0;8>u;u++)x[u]=new THREE.Vector3,r[u]=new THREE.Vector3;x=q.shadowCascadeNearZ[z];q=q.shadowCascadeFarZ[z];r[0].set(-1,-1,x);r[1].set(1,-1,x);r[2].set(-1,
1,x);r[3].set(1,1,x);r[4].set(-1,-1,q);r[5].set(1,-1,q);r[6].set(-1,1,q);r[7].set(1,1,q);A.originalCamera=m;r=new THREE.Gyroscope;r.position=o.shadowCascadeOffset;r.add(A);r.add(A.target);m.add(r);o.shadowCascadeArray[t]=A;console.log("Created virtualLight",A)}z=o;x=t;q=z.shadowCascadeArray[x];q.position.copy(z.position);q.target.position.copy(z.target.position);q.lookAt(q.target);q.shadowCameraVisible=z.shadowCameraVisible;q.shadowDarkness=z.shadowDarkness;q.shadowBias=z.shadowCascadeBias[x];r=z.shadowCascadeNearZ[x];
z=z.shadowCascadeFarZ[x];q=q.pointsFrustum;q[0].z=r;q[1].z=r;q[2].z=r;q[3].z=r;q[4].z=z;q[5].z=z;q[6].z=z;q[7].z=z;E[s]=A;s++}else E[s]=o,s++;n=0;for(p=E.length;n<p;n++){o=E[n];o.shadowMap||(o.shadowMap=new THREE.WebGLRenderTarget(o.shadowMapWidth,o.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat}),o.shadowMapSize=new THREE.Vector2(o.shadowMapWidth,o.shadowMapHeight),o.shadowMatrix=new THREE.Matrix4);if(!o.shadowCamera){if(o instanceof THREE.SpotLight)o.shadowCamera=
...
new THREE.CameraHelper(o.shadowCamera),o.shadowCamera.add(o.cameraHelper));if(o.isVirtual&&A.originalCamera==m){t=m;s=o.shadowCamera;r=o.pointsFrustum;q=o.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(z=0;8>z;z++)if(x=q[z],x.copy(r[z]),THREE.ShadowMapPlugin.__projector.unprojectVector(x,t),s.matrixWorldInverse.multiplyVector3(x),x.x<i.x&&(i.x=x.x),x.x>j.x&&(j.x=x.x),x.y<i.y&&(i.y=x.y),x.y>j.y&&(j.y=x.y),x.z<i.z&&(i.z=x.z),x.z>j.z)j.z=x.z;s.left=i.x;s.right=
...
!r.frustumCulled||g.contains(r)))r._modelViewMatrix.multiply(t.matrixWorldInverse,r.matrixWorld),z.render=!0;o=0;for(s=q.length;o<s;o++)z=q[o],z.render&&(r=z.object,z=z.buffer,u=r.material instanceof THREE.MeshFaceMaterial?r.material.materials[0]:r.material,x=0<r.geometry.morphTargets.length&&u.morphTargets,u=r instanceof THREE.SkinnedMesh&&u.skinning,x=r.customDepthMaterial?r.customDepthMaterial:u?x?f:e:x?d:c,z instanceof THREE.BufferGeometry?b.renderBufferDirect(t,l.__lights,null,x,z,r):b.renderBuffer(t,
l.__lights,null,x,z,r));q=l.__webglObjectsImmediate;o=0;for(s=q.length;o<s;o++)z=q[o],r=z.object,r.visible&&r.castShadow&&(r._modelViewMatrix.multiply(t.matrixWorldInverse,r.matrixWorld),b.renderImmediateObject(t,l.__lights,null,c,r))}n=b.getClearColor();p=b.getClearAlpha();a.clearColor(n.r,n.g,n.b,p);a.enable(a.BLEND);b.shadowMapCullFrontFaces&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;
...
j.modelViewMatrix=b.getUniformLocation(h,"modelViewMatrix");j.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");j.fogType=b.getUniformLocation(h,"fogType");j.fogDensity=b.getUniformLocation(h,"fogDensity");j.fogNear=b.getUniformLocation(h,"fogNear");j.fogFar=b.getUniformLocation(h,"fogFar");j.fogColor=b.getUniformLocation(h,"fogColor");l=!1};this.render=function(d,e,p,o){var s=d.__webglSprites,t=s.length;if(t){var r=i,z=j,x=o/p,p=0.5*p,q=0.5*o,E=!0;b.useProgram(h);l||(b.enableVertexAttribArray(r.position),
b.enableVertexAttribArray(r.uv),l=!0);b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(!0);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(r.position,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.uniformMatrix4fv(z.projectionMatrix,!1,e._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(z.map,0);var A=r=0,u=d.fog;u?(b.uniform3f(z.fogColor,u.color.r,u.color.g,u.color.b),u instanceof THREE.Fog?(b.uniform1f(z.fogNear,u.near),
b.uniform1f(z.fogFar,u.far),b.uniform1i(z.fogType,1),A=r=1):u instanceof THREE.FogExp2&&(b.uniform1f(z.fogDensity,u.density),b.uniform1i(z.fogType,2),A=r=2)):(b.uniform1i(z.fogType,0),A=r=0);for(var v,D=[],u=0;u<t;u++)v=s[u],v.visible&&0!==v.opacity&&(v.useScreenCoordinates?v.z=-v.position.z:(v._modelViewMatrix.multiply(e.matrixWorldInverse,v.matrixWorld),v.z=-v._modelViewMatrix.elements[14]));s.sort(a);for(u=0;u<t;u++)if(v=s[u],v.visible&&0!==v.opacity&&v.map&&v.map.image&&v.map.image.width)v.useScreenCoordinates?
(b.uniform1i(z.useScreenCoordinates,1),b.uniform3f(z.screenPosition,(v.position.x-p)/p,(q-v.position.y)/q,Math.max(0,Math.min(1,v.position.z)))):(b.uniform1i(z.useScreenCoordinates,0),b.uniform1i(z.affectedByDistance,v.affectedByDistance?1:0),b.uniformMatrix4fv(z.modelViewMatrix,!1,v._modelViewMatrix.elements)),e=d.fog&&v.fog?A:0,r!==e&&(b.uniform1i(z.fogType,e),r=e),e=1/(v.scaleByViewport?o:1),D[0]=e*x*v.scale.x,D[1]=e*v.scale.y,b.uniform2f(z.uvScale,v.uvScale.x,v.uvScale.y),b.uniform2f(z.uvOffset,
v.uvOffset.x,v.uvOffset.y),b.uniform2f(z.alignment,v.alignment.x,v.alignment.y),b.uniform1f(z.opacity,v.opacity),b.uniform3f(z.color,v.color.r,v.color.g,v.color.b),b.uniform1f(z.rotation,v.rotation),b.uniform2fv(z.scale,D),v.mergeWith3D&&!E?(b.enable(b.DEPTH_TEST),E=!0):!v.mergeWith3D&&E&&(b.disable(b.DEPTH_TEST),E=!1),c.setBlending(v.blending,v.blendEquation,v.blendSrc,v.blendDst),c.setTexture(v.map,0),b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);
b.depthMask(!0)}}};
