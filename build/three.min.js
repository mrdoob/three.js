...
a).lengthSq()},getPositionFromMatrix:function(a){this.x=a.elements[12];this.y=a.elements[13];this.z=a.elements[14];return this},setEulerFromRotationMatrix:function(a,b){function c(a){return Math.min(Math.max(a,-1),1)}var d=a.elements,f=d[0],e=d[4],g=d[8],h=d[1],i=d[5],j=d[9],l=d[2],m=d[6],d=d[10];if(b===void 0||b==="XYZ"){this.y=Math.asin(c(g));if(Math.abs(g)<0.99999){this.x=Math.atan2(-j,d);this.z=Math.atan2(-e,f)}else{this.x=Math.atan2(h,i);this.z=0}}else if(b==="YXZ"){this.x=Math.asin(-c(j));if(Math.abs(j)<
0.99999){this.y=Math.atan2(g,d);this.z=Math.atan2(h,i)}else{this.y=Math.atan2(-l,f);this.z=0}}else if(b==="ZXY"){this.x=Math.asin(c(m));if(Math.abs(m)<0.99999){this.y=Math.atan2(-l,d);this.z=Math.atan2(-e,i)}else{this.y=0;this.z=Math.atan2(g,f)}}else if(b==="ZYX"){this.y=Math.asin(-c(l));if(Math.abs(l)<0.99999){this.x=Math.atan2(m,d);this.z=Math.atan2(h,f)}else{this.x=0;this.z=Math.atan2(-e,i)}}else if(b==="YZX"){this.z=Math.asin(c(h));if(Math.abs(h)<0.99999){this.x=Math.atan2(-j,i);this.y=Math.atan2(-l,
f)}else{this.x=0;this.y=Math.atan2(l,d)}}else if(b==="XZY"){this.z=Math.asin(-c(e));if(Math.abs(e)<0.99999){this.x=Math.atan2(m,i);this.y=Math.atan2(g,f)}else{this.x=Math.atan2(-g,d);this.y=0}}return this},setEulerFromQuaternion:function(a,b){function c(a){return Math.min(Math.max(a,-1),1)}var d=a.x*a.x,f=a.y*a.y,e=a.z*a.z,g=a.w*a.w;if(b===void 0||b==="XYZ"){this.x=Math.atan2(2*(a.x*a.w-a.y*a.z),g-d-f+e);this.y=Math.asin(c(2*(a.x*a.z+a.y*a.w)));this.z=Math.atan2(2*(a.z*a.w-a.x*a.y),g+d-f-e)}else if(b===
...
a.z+b[15]*a.w:1;return c},determinant:function(){var a=this.elements,b=a[0],c=a[4],d=a[8],f=a[12],e=a[1],g=a[5],h=a[9],i=a[13],j=a[2],l=a[6],m=a[10],n=a[14],q=a[3],o=a[7],p=a[11],a=a[15];return f*h*l*q-d*i*l*q-f*g*m*q+c*i*m*q+d*g*n*q-c*h*n*q-f*h*j*o+d*i*j*o+f*e*m*o-b*i*m*o-d*e*n*o+b*h*n*o+f*g*j*p-c*i*j*p-f*e*l*p+b*i*l*p+c*e*n*p-b*g*n*p-d*g*j*a+c*h*j*a+d*e*l*a-b*h*l*a-c*e*m*a+b*g*m*a},transpose:function(){var a=this.elements,b;b=a[1];a[1]=a[4];a[4]=b;b=a[2];a[2]=a[8];a[8]=b;b=a[6];a[6]=a[9];a[9]=b;
...
a[9],a[10])},getInverse:function(a){var b=this.elements,c=a.elements,d=c[0],f=c[4],e=c[8],g=c[12],h=c[1],i=c[5],j=c[9],l=c[13],m=c[2],n=c[6],q=c[10],o=c[14],p=c[3],s=c[7],r=c[11],c=c[15];b[0]=j*o*s-l*q*s+l*n*r-i*o*r-j*n*c+i*q*c;b[4]=g*q*s-e*o*s-g*n*r+f*o*r+e*n*c-f*q*c;b[8]=e*l*s-g*j*s+g*i*r-f*l*r-e*i*c+f*j*c;b[12]=g*j*n-e*l*n-g*i*q+f*l*q+e*i*o-f*j*o;b[1]=l*q*p-j*o*p-l*m*r+h*o*r+j*m*c-h*q*c;b[5]=e*o*p-g*q*p+g*m*r-d*o*r-e*m*c+d*q*c;b[9]=g*j*p-e*l*p-g*h*r+d*l*r+e*h*c-d*j*c;b[13]=e*l*m-g*j*m+g*h*q-d*
l*q-e*h*o+d*j*o;b[2]=i*o*p-l*n*p+l*m*s-h*o*s-i*m*c+h*n*c;b[6]=g*n*p-f*o*p-g*m*s+d*o*s+f*m*c-d*n*c;b[10]=f*l*p-g*i*p+g*h*s-d*l*s-f*h*c+d*i*c;b[14]=g*i*m-f*l*m-g*h*n+d*l*n+f*h*o-d*i*o;b[3]=j*n*p-i*q*p-j*m*s+h*q*s+i*m*r-h*n*r;b[7]=f*q*p-e*n*p+e*m*s-d*q*s-f*m*r+d*n*r;b[11]=e*i*p-f*j*p-e*h*s+d*j*s+f*h*r-d*i*r;b[15]=f*j*m-e*i*m+e*h*n-d*j*n-f*h*q+d*i*q;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,f=a.y,e=a.z,g=Math.cos(d),d=Math.sin(d),
h=Math.cos(f),f=Math.sin(f),i=Math.cos(e),e=Math.sin(e);if(b===void 0||b==="XYZ"){var j=g*i,l=g*e,m=d*i,n=d*e;c[0]=h*i;c[4]=-h*e;c[8]=f;c[1]=l+m*f;c[5]=j-n*f;c[9]=-d*h;c[2]=n-j*f;c[6]=m+l*f;c[10]=g*h}else if(b==="YXZ"){j=h*i;l=h*e;m=f*i;n=f*e;c[0]=j+n*d;c[4]=m*d-l;c[8]=g*f;c[1]=g*e;c[5]=g*i;c[9]=-d;c[2]=l*d-m;c[6]=n+j*d;c[10]=g*h}else if(b==="ZXY"){j=h*i;l=h*e;m=f*i;n=f*e;c[0]=j-n*d;c[4]=-g*e;c[8]=m+l*d;c[1]=l+m*d;c[5]=g*i;c[9]=n-j*d;c[2]=-g*f;c[6]=d;c[10]=g*h}else if(b==="ZYX"){j=g*i;l=g*e;m=d*i;
n=d*e;c[0]=h*i;c[4]=m*f-l;c[8]=j*f+n;c[1]=h*e;c[5]=n*f+j;c[9]=l*f-m;c[2]=-f;c[6]=d*h;c[10]=g*h}else if(b==="YZX"){j=g*h;l=g*f;m=d*h;n=d*f;c[0]=h*i;c[4]=n-j*e;c[8]=m*e+l;c[1]=e;c[5]=g*i;c[9]=-d*i;c[2]=-f*i;c[6]=l*e+m;c[10]=j-n*e}else if(b==="XZY"){j=g*h;l=g*f;m=d*h;n=d*f;c[0]=h*i;c[4]=-e;c[8]=f*i;c[1]=j*e+n;c[5]=g*i;c[9]=l*e-m;c[2]=m*e-l;c[6]=d*i;c[10]=n*e+j}return this},setRotationFromQuaternion:function(a){var b=this.elements,c=a.x,d=a.y,f=a.z,e=a.w,g=c+c,h=d+d,i=f+f,a=c*g,j=c*h,c=c*i,l=d*h,d=d*
...
this.y,h=this.z,i=this.w,j=i*c+g*f-h*d,l=i*d+h*c-e*f,m=i*f+e*d-g*c,c=-e*c-g*d-h*f;b.x=j*i+c*-e+l*-h-m*-g;b.y=l*i+c*-g+m*-e-j*-h;b.z=m*i+c*-h+j*-g-l*-e;return b},slerpSelf:function(a,b){var c=this.x,d=this.y,f=this.z,e=this.w,g=e*a.w+c*a.x+d*a.y+f*a.z;if(g<0){this.w=-a.w;this.x=-a.x;this.y=-a.y;this.z=-a.z;g=-g}else this.copy(a);if(g>=1){this.w=e;this.x=c;this.y=d;this.z=f;return this}var h=Math.acos(g),i=Math.sqrt(1-g*g);if(Math.abs(i)<0.001){this.w=0.5*(e+this.w);this.x=0.5*(c+this.x);this.y=0.5*
...
i(a.height);j.image=document.createElement("canvas");j.image.width=b;j.image.height=c;j.image.getContext("2d").drawImage(a,0,0,b,c)}else j.image=a;j.needsUpdate=true});a.crossOrigin=c.crossOrigin;a.load(c.path+"/"+f);b&&b.add(a)},l=function(a){return(a[0]*255<<16)+(a[1]*255<<8)+a[2]*255},m="MeshLambertMaterial",n={color:15658734,opacity:1,map:null,lightMap:null,normalMap:null,bumpMap:null,wireframe:false};if(g.shading){var q=g.shading.toLowerCase();q==="phong"?m="MeshPhongMaterial":q==="basic"&&(m=
"MeshBasicMaterial")}if(g.blending!==void 0&&THREE[g.blending]!==void 0)n.blending=THREE[g.blending];if(g.transparent!==void 0||g.opacity<1)n.transparent=g.transparent;if(g.depthTest!==void 0)n.depthTest=g.depthTest;if(g.depthWrite!==void 0)n.depthWrite=g.depthWrite;if(g.vertexColors!==void 0)if(g.vertexColors=="face")n.vertexColors=THREE.FaceColors;else if(g.vertexColors)n.vertexColors=THREE.VertexColors;if(g.colorDiffuse)n.color=l(g.colorDiffuse);else if(g.DbgColor)n.color=g.DbgColor;if(g.colorSpecular)n.specular=
...
f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,n=a.__colorArray,m=a.__sortArray,o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){Fa.copy(tb);Fa.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];Wa.copy(f);Fa.multiplyVector3(Wa);m[d]=[Wa.z,d]}m.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[m[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[m[d][1]];n[e]=f.r;n[e+1]=f.g;n[e+2]=f.b}if(q){i=0;
...
THREE.Path.prototype.getPoints=function(a,b){if(this.useSpacedPoints){console.log("tata");return this.getSpacedPoints(a,b)}var a=a||12,c=[],d,f,e,g,h,i,j,l,m,n,q,o,p;d=0;for(f=this.actions.length;d<f;d++){e=this.actions[d];g=e.action;e=e.args;switch(g){case THREE.PathActions.MOVE_TO:c.push(new THREE.Vector2(e[0],e[1]));break;case THREE.PathActions.LINE_TO:c.push(new THREE.Vector2(e[0],e[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=e[2];i=e[3];m=e[0];n=e[1];if(c.length>0){g=c[c.length-1];
q=g.x;o=g.y}else{g=this.actions[d-1].args;q=g[g.length-2];o=g[g.length-1]}for(e=1;e<=a;e++){p=e/a;g=THREE.Shape.Utils.b2(p,q,m,h);p=THREE.Shape.Utils.b2(p,o,n,i);c.push(new THREE.Vector2(g,p))}break;case THREE.PathActions.BEZIER_CURVE_TO:h=e[4];i=e[5];m=e[0];n=e[1];j=e[2];l=e[3];if(c.length>0){g=c[c.length-1];q=g.x;o=g.y}else{g=this.actions[d-1].args;q=g[g.length-2];o=g[g.length-1]}for(e=1;e<=a;e++){p=e/a;g=THREE.Shape.Utils.b3(p,q,m,j,h);p=THREE.Shape.Utils.b3(p,o,n,l,i);c.push(new THREE.Vector2(g,
p))}break;case THREE.PathActions.CSPLINE_THRU:g=this.actions[d-1].args;p=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=a*e[0].length;p=p.concat(e[0]);p=new THREE.SplineCurve(p);for(e=1;e<=g;e++)c.push(p.getPointAt(e/g));break;case THREE.PathActions.ARC:h=e[0];i=e[1];n=e[2];j=e[3];g=e[4];m=!!e[5];q=g-j;o=a*2;for(e=1;e<=o;e++){p=e/o;m||(p=1-p);p=j+p*q;g=h+n*Math.cos(p);p=i+n*Math.sin(p);c.push(new THREE.Vector2(g,p))}break;case THREE.PathActions.ELLIPSE:h=e[0];i=e[1];n=e[2];l=e[3];j=e[4];g=e[5];
m=!!e[6];q=g-j;o=a*2;for(e=1;e<=o;e++){p=e/o;m||(p=1-p);p=j+p*q;g=h+n*Math.cos(p);p=i+l*Math.sin(p);c.push(new THREE.Vector2(g,p))}}}d=c[c.length-1];Math.abs(d.x-c[0].x)<1E-10&&Math.abs(d.y-c[0].y)<1E-10&&c.splice(c.length-1,1);b&&c.push(c[0]);return c};
...
THREE.Shape.Utils={removeHoles:function(a,b){var c=a.concat(),d=c.concat(),f,e,g,h,i,j,l,m,n,q,o=[];for(i=0;i<b.length;i++){j=b[i];Array.prototype.push.apply(d,j);e=Number.POSITIVE_INFINITY;for(f=0;f<j.length;f++){n=j[f];q=[];for(m=0;m<c.length;m++){l=c[m];l=n.distanceToSquared(l);q.push(l);if(l<e){e=l;g=f;h=m}}}f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:j.length-1;var p=[j[g],c[h],c[f]];m=THREE.FontUtils.Triangulate.area(p);var s=[j[g],j[e],c[h]];n=THREE.FontUtils.Triangulate.area(s);q=h;l=g;h=h+1;g=g+
-1;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+j.length);g=g%j.length;f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:j.length-1;p=[j[g],c[h],c[f]];p=THREE.FontUtils.Triangulate.area(p);s=[j[g],j[e],c[h]];s=THREE.FontUtils.Triangulate.area(s);if(m+n>p+s){h=q;g=l;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+j.length);g=g%j.length;f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:j.length-1}m=c.slice(0,h);n=c.slice(h);q=j.slice(g);l=j.slice(0,g);e=[j[g],j[e],c[h]];o.push([j[g],c[h],c[f]]);o.push(e);c=m.concat(q).concat(l).concat(n)}return{shape:c,
...
THREE.RollControls=function(a,b){this.object=a;this.domElement=b!==void 0?b:document;this.mouseLook=true;this.autoForward=false;this.rollSpeed=this.movementSpeed=this.lookSpeed=1;this.constrainVertical=[-0.9,0.9];this.object.matrixAutoUpdate=false;this.forward=new THREE.Vector3(0,0,1);this.roll=0;var c=new THREE.Vector3,d=new THREE.Vector3,f=new THREE.Vector3,e=new THREE.Matrix4,g=false,h=1,i=0,j=0,l=0,m=0,n=0,q=0,o=0;this.handleResize=function(){q=window.innerWidth/2;o=window.innerHeight/2};this.update=
...
THREE.ParametricGeometry=function(a,b,c,d){THREE.Geometry.call(this);var f=this.vertices,e=this.faces,g=this.faceVertexUvs[0],d=d===void 0?false:d,h,i,j,l,m=b+1;for(h=0;h<=c;h++){l=h/c;for(i=0;i<=b;i++){j=i/b;j=a(j,l);f.push(j)}}var n,q,o,p;for(h=0;h<c;h++)for(i=0;i<b;i++){a=h*m+i;f=h*m+i+1;l=(h+1)*m+i;j=(h+1)*m+i+1;n=new THREE.UV(i/b,h/c);q=new THREE.UV((i+1)/b,h/c);o=new THREE.UV(i/b,(h+1)/c);p=new THREE.UV((i+1)/b,(h+1)/c);if(d){e.push(new THREE.Face3(a,f,l));e.push(new THREE.Face3(f,j,l));g.push([n,
q,o]);g.push([q,p,o])}else{e.push(new THREE.Face4(a,f,j,l));g.push([n,q,p,o])}}this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.ParametricGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.ConvexGeometry=function(a){function b(a){var b=a.length();return new THREE.UV(a.x/b,a.y/b)}THREE.Geometry.call(this);for(var c=[[0,1,2],[0,2,1]],d=3;d<a.length;d++){var f=d,e=a[f].clone(),g=e.length();e.x=e.x+g*(Math.random()-0.5)*2E-6;e.y=e.y+g*(Math.random()-0.5)*2E-6;e.z=e.z+g*(Math.random()-0.5)*2E-6;for(var g=[],h=0;h<c.length;){var i=c[h],j=e,l=a[i[0]],m;m=l;var n=a[i[1]],q=a[i[2]],o=new THREE.Vector3,p=new THREE.Vector3;o.sub(q,n);p.sub(m,n);o.crossSelf(p);o.isZero()||o.normalize();m=
...
d:c;l instanceof THREE.BufferGeometry?b.renderBufferDirect(h,g.__lights,null,m,l,n):b.renderBuffer(h,g.__lights,null,m,l,n)}}q=g.__webglObjectsImmediate;i=0;for(j=q.length;i<j;i++){l=q[i];n=l.object;if(n.visible&&n.castShadow){n._modelViewMatrix.multiply(h.matrixWorldInverse,n.matrixWorld);b.renderImmediateObject(h,g.__lights,null,c,n)}}i=b.getClearColor();j=b.getClearAlpha();a.clearColor(i.r,i.g,i.b,j);a.enable(a.BLEND)}};
