...
c)return!1;a.lerp(b,c);b.lerp(a,1-d);return!0}var e,f,g=[],h=0,i,k,m=[],n=0,l,s,q=[],p=0,r,w=[],x=0,v,t,I=[],E=0,C,z,G=[],F=0,J={objects:[],sprites:[],lights:[],elements:[]},V=new THREE.Vector3,B=new THREE.Vector4,T=new THREE.Matrix4,A=new THREE.Matrix4,H,L=new THREE.Matrix4,M=new THREE.Matrix3,P=new THREE.Matrix3,ca=new THREE.Vector3,oa=new THREE.Frustum,K=new THREE.Vector4,ha=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);A.multiplyMatrices(b.projectionMatrix,
b.matrixWorldInverse);return a.applyMatrix4(A)};this.unprojectVector=function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);A.multiplyMatrices(b.matrixWorld,b.projectionMatrixInverse);return a.applyMatrix4(A)};this.pickingRay=function(a,b){a.z=-1;var c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.sub(a).normalize();return new THREE.Raycaster(a,c)};this.projectScene=function(g,h,n,ia){var wa=h.near,ya=h.far,sa=!1,ga,fa,xa,pa,za,Oa,ja,ta,qa,kb,Ja,
Ya,qb;z=t=r=s=0;J.elements.length=0;g.updateMatrixWorld();void 0===h.parent&&h.updateMatrixWorld();T.copy(h.matrixWorldInverse.getInverse(h.matrixWorld));A.multiplyMatrices(h.projectionMatrix,T);P.getInverse(T);P.transpose();oa.setFromMatrix(A);f=0;J.objects.length=0;J.sprites.length=0;J.lights.length=0;var Db=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof THREE.Light)J.lights.push(f);else if(f instanceof THREE.Mesh||f instanceof THREE.Line){if(!1===
...
Oa=0;for(pa=qa.length;Oa<pa;Oa++)if(Ja=qa[Oa][xa],void 0!==Ja){za=0;for(ja=Ja.length;za<ja;za++)l.uvs[Oa][za]=Ja[za]}l.color=fa.color;l.material=zb;ca.copy(l.centroidModel);ca.applyMatrix4(A);l.z=ca.z;J.elements.push(l)}}}else if(ta instanceof THREE.Line){L.multiplyMatrices(A,H);xa=ta.geometry.vertices;pa=b();pa.positionScreen.copy(xa[0]);pa.positionScreen.applyMatrix4(L);kb=ta.type===THREE.LinePieces?2:1;ga=1;for(fa=xa.length;ga<fa;ga++)pa=b(),pa.positionScreen.copy(xa[ga]),pa.positionScreen.applyMatrix4(L),
...
b,c,d,e,f,z){h=a.vertices[b];i=a.vertices[c];k=a.vertices[d];m=g[e];n=g[f];l=g[z];s=i.x-h.x;q=k.x-h.x;p=i.y-h.y;r=k.y-h.y;w=i.z-h.z;x=k.z-h.z;v=n.x-m.x;t=l.x-m.x;I=n.y-m.y;E=l.y-m.y;C=1/(v*E-t*I);J.set((E*s-I*q)*C,(E*p-I*r)*C,(E*w-I*x)*C);V.set((v*q-t*s)*C,(v*r-t*p)*C,(v*x-t*w)*C);G[b].add(J);G[c].add(J);G[d].add(J);F[b].add(V);F[c].add(V);F[d].add(V)}var b,c,d,e,f,g,h,i,k,m,n,l,s,q,p,r,w,x,v,t,I,E,C,z,G=[],F=[],J=new THREE.Vector3,V=new THREE.Vector3,B=new THREE.Vector3,T=new THREE.Vector3,A=new THREE.Vector3;
b=0;for(c=this.vertices.length;b<c;b++)G[b]=new THREE.Vector3,F[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var H=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<f.vertexNormals.length;d++)A.copy(f.vertexNormals[d]),e=f[H[d]],z=G[e],B.copy(z),B.sub(A.multiplyScalar(A.dot(z))).normalize(),
T.crossVectors(f.vertexNormals[d],z),e=T.dot(F[e]),e=0>e?-1:1,f.vertexTangents[d]=new THREE.Vector4(B.x,B.y,B.z,e)}this.hasTangents=!0},computeLineDistances:function(){for(var a=0,b=this.vertices,c=0,d=b.length;c<d;c++)0<c&&(a+=b[c].distanceTo(b[c-1])),this.lineDistances[c]=a},computeBoundingBox:function(){null===this.boundingBox&&(this.boundingBox=new THREE.Box3);this.boundingBox.setFromPoints(this.vertices)},computeBoundingSphere:function(){null===this.boundingSphere&&(this.boundingSphere=new THREE.Sphere);
...
m,n),p.subVectors(q,s),r.subVectors(l,s),p.cross(r),f[3*g]+=p.x,f[3*g+1]+=p.y,f[3*g+2]+=p.z,f[3*h]+=p.x,f[3*h+1]+=p.y,f[3*h+2]+=p.z,f[3*i]+=p.x,f[3*i+1]+=p.y,f[3*i+2]+=p.z}}else{a=0;for(b=e.length;a<b;a+=9)k=e[a],m=e[a+1],n=e[a+2],l.set(k,m,n),k=e[a+3],m=e[a+4],n=e[a+5],s.set(k,m,n),k=e[a+6],m=e[a+7],n=e[a+8],q.set(k,m,n),p.subVectors(q,s),r.subVectors(l,s),p.cross(r),f[a]=p.x,f[a+1]=p.y,f[a+2]=p.z,f[a+3]=p.x,f[a+4]=p.y,f[a+5]=p.z,f[a+6]=p.x,f[a+7]=p.y,f[a+8]=p.z}this.normalizeNormals();this.normalsNeedUpdate=
...
new THREE.Vector3,k[g]=new THREE.Vector3;var m,n,l,s,q,p,r,w,x,v,t,I,E,C,z,f=new THREE.Vector3,g=new THREE.Vector3,G,F,J,V,B,T,A,H=this.offsets;J=0;for(V=H.length;J<V;++J){F=H[J].start;B=H[J].count;var L=H[J].index;G=F;for(F+=B;G<F;G+=3)B=L+b[G],T=L+b[G+1],A=L+b[G+2],m=c[3*B],n=c[3*B+1],l=c[3*B+2],s=c[3*T],q=c[3*T+1],p=c[3*T+2],r=c[3*A],w=c[3*A+1],x=c[3*A+2],v=e[2*B],t=e[2*B+1],I=e[2*T],E=e[2*T+1],C=e[2*A],z=e[2*A+1],s-=m,m=r-m,q-=n,n=w-n,p-=l,l=x-l,I-=v,v=C-v,E-=t,t=z-t,z=1/(I*t-v*E),f.set((t*s-
E*m)*z,(t*q-E*n)*z,(t*p-E*l)*z),g.set((I*m-v*s)*z,(I*n-v*q)*z,(I*l-v*p)*z),i[B].add(f),i[T].add(f),i[A].add(f),k[B].add(g),k[T].add(g),k[A].add(g)}var M=new THREE.Vector3,P=new THREE.Vector3,ca=new THREE.Vector3,oa=new THREE.Vector3,K,ha,ea;J=0;for(V=H.length;J<V;++J){F=H[J].start;B=H[J].count;L=H[J].index;G=F;for(F+=B;G<F;G+=3)B=L+b[G],T=L+b[G+1],A=L+b[G+2],a(B),a(T),a(A)}this.tangentsNeedUpdate=this.hasTangents=!0}},dispose:function(){this.dispatchEvent({type:"dispose"})}};THREE.Camera=function(){THREE.Object3D.call(this);this.matrixWorldInverse=new THREE.Matrix4;this.projectionMatrix=new THREE.Matrix4;this.projectionMatrixInverse=new THREE.Matrix4};THREE.Camera.prototype=Object.create(THREE.Object3D.prototype);THREE.Camera.prototype.lookAt=function(a){this.matrix.lookAt(this.position,a,this.up);!0===this.rotationAutoUpdate&&(!1===this.useQuaternion?this.rotation.setEulerFromRotationMatrix(this.matrix,this.eulerOrder):this.quaternion.copy(this.matrix.decompose()[1]))};THREE.OrthographicCamera=function(a,b,c,d,e,f){THREE.Camera.call(this);this.left=a;this.right=b;this.top=c;this.bottom=d;this.near=void 0!==e?e:0.1;this.far=void 0!==f?f:2E3;this.updateProjectionMatrix()};THREE.OrthographicCamera.prototype=Object.create(THREE.Camera.prototype);THREE.OrthographicCamera.prototype.updateProjectionMatrix=function(){this.projectionMatrix.makeOrthographic(this.left,this.right,this.top,this.bottom,this.near,this.far)};THREE.PerspectiveCamera=function(a,b,c,d){THREE.Camera.call(this);this.fov=void 0!==a?a:50;this.aspect=void 0!==b?b:1;this.near=void 0!==c?c:0.1;this.far=void 0!==d?d:2E3;this.updateProjectionMatrix()};THREE.PerspectiveCamera.prototype=Object.create(THREE.Camera.prototype);THREE.PerspectiveCamera.prototype.setLens=function(a,b){void 0===b&&(b=24);this.fov=2*THREE.Math.radToDeg(Math.atan(b/(2*a)));this.updateProjectionMatrix()};
...
function(a,m){function l(a,b,c){for(var d=0,e=i.length;d<e;d++){var f=i[d];pa.copy(f.color);if(f instanceof THREE.DirectionalLight){var g=f.matrixWorld.getPosition().normalize(),h=b.dot(g);0>=h||(h*=f.intensity,c.add(pa.multiplyScalar(h)))}else f instanceof THREE.PointLight&&(g=f.matrixWorld.getPosition(),h=b.dot(pb.subVectors(g,a).normalize()),0>=h||(h*=0==f.distance?1:1-Math.min(a.distanceTo(g)/f.distance,1),0!=h&&(h*=f.intensity,c.add(pa.multiplyScalar(h)))))}}function n(a,d,e,g,h,j,i,k){f.info.render.vertices+=
...
W=0,V=0,Y=0,fa=0,ca=0,wa=0,pa=0,sa=0,U=m=0,c=s=U=0,f=b.length;c<f;c++)m=b[c],m.onlyShadow||(p=m.color,q=m.intensity,s=m.distance,m instanceof THREE.AmbientLight?m.visible&&(O.gammaInput?(k+=p.r*p.r,l+=p.g*p.g,n+=p.b*p.b):(k+=p.r,l+=p.g,n+=p.b)):m instanceof THREE.DirectionalLight?(ca+=1,m.visible&&(Ga.copy(m.matrixWorld.getPosition()),Ga.sub(m.target.matrixWorld.getPosition()),Ga.normalize(),0===Ga.x&&0===Ga.y&&0===Ga.z||(m=3*W,w[m]=Ga.x,w[m+1]=Ga.y,w[m+2]=Ga.z,O.gammaInput?z(t,m,p,q*q):G(t,m,p,q),
W+=1))):m instanceof THREE.PointLight?(wa+=1,m.visible&&(U=3*V,O.gammaInput?z(v,U,p,q*q):G(v,U,p,q),q=m.matrixWorld.getPosition(),x[U]=q.x,x[U+1]=q.y,x[U+2]=q.z,A[V]=s,V+=1)):m instanceof THREE.SpotLight?(pa+=1,m.visible&&(U=3*Y,O.gammaInput?z(C,U,p,q*q):G(C,U,p,q),q=m.matrixWorld.getPosition(),F[U]=q.x,F[U+1]=q.y,F[U+2]=q.z,J[Y]=s,Ga.copy(q),Ga.sub(m.target.matrixWorld.getPosition()),Ga.normalize(),I[U]=Ga.x,I[U+1]=Ga.y,I[U+2]=Ga.z,K[Y]=Math.cos(m.angle),ia[Y]=m.exponent,Y+=1)):m instanceof THREE.HemisphereLight&&
...
a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function V(a,b){var c;"fragment"===a?c=j.createShader(j.FRAGMENT_SHADER):"vertex"===a&&(c=j.createShader(j.VERTEX_SHADER));j.shaderSource(c,b);j.compileShader(c);return!j.getShaderParameter(c,j.COMPILE_STATUS)?(console.error(j.getShaderInfoLog(c)),console.error(J(b)),null):c}function B(a,b,c){c?(j.texParameteri(a,j.TEXTURE_WRAP_S,H(b.wrapS)),j.texParameteri(a,j.TEXTURE_WRAP_T,H(b.wrapT)),j.texParameteri(a,j.TEXTURE_MAG_FILTER,H(b.magFilter)),
j.texParameteri(a,j.TEXTURE_MIN_FILTER,H(b.minFilter))):(j.texParameteri(a,j.TEXTURE_WRAP_S,j.CLAMP_TO_EDGE),j.texParameteri(a,j.TEXTURE_WRAP_T,j.CLAMP_TO_EDGE),j.texParameteri(a,j.TEXTURE_MAG_FILTER,A(b.magFilter)),j.texParameteri(a,j.TEXTURE_MIN_FILTER,A(b.minFilter)));if(Eb&&b.type!==THREE.FloatType&&(1<b.anisotropy||b.__oldAnisotropy))j.texParameterf(a,Eb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,Ac)),b.__oldAnisotropy=b.anisotropy}function T(a,b){j.bindRenderbuffer(j.RENDERBUFFER,a);b.depthBuffer&&
...
d.vertexColors[3].clone(),l.vertexColors[0]=d.vertexColors[1].clone(),l.vertexColors[1]=d.vertexColors[2].clone(),l.vertexColors[2]=d.vertexColors[3].clone());f.push(n,l);d=0;for(e=a.faceVertexUvs.length;d<e;d++)a.faceVertexUvs[d].length&&(n=a.faceVertexUvs[d][b],i=n[1],k=n[2],m=n[3],n=[n[0].clone(),i.clone(),m.clone()],i=[i.clone(),k.clone(),m.clone()],h[d].push(n,i));d=0;for(e=a.faceUvs.length;d<e;d++)a.faceUvs[d].length&&(i=a.faceUvs[d][b],g[d].push(i,i))}else{f.push(d);d=0;for(e=a.faceUvs.length;d<
...
b.push(k.clone());f.a=e;f.b=e+1;f.c=e+2;f.d=e+3}else g=f.a,h=f.b,i=f.c,g=a.vertices[g],h=a.vertices[h],i=a.vertices[i],b.push(g.clone()),b.push(h.clone()),b.push(i.clone()),f.a=e,f.b=e+1,f.c=e+2}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,e,f,g,h,i,k,m,n,l,s,q,p,r,w,x,v,t,I=[],E=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)E[c]=[];c=0;for(d=a.faces.length;c<d;c++)if(e=a.faces[c],e instanceof THREE.Face3)if(f=e.a,g=e.b,h=e.c,k=a.vertices[f],m=a.vertices[g],n=a.vertices[h],
s=k.distanceTo(m),q=m.distanceTo(n),l=k.distanceTo(n),s>b||q>b||l>b){i=a.vertices.length;v=e.clone();t=e.clone();s>=q&&s>=l?(k=k.clone(),k.lerp(m,0.5),v.a=f,v.b=i,v.c=h,t.a=i,t.b=g,t.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerp(e.vertexNormals[1],0.5),v.vertexNormals[1].copy(f),t.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerp(e.vertexColors[1],0.5),v.vertexColors[1].copy(f),t.vertexColors[0].copy(f)),e=0):q>=s&&q>=l?(k=m.clone(),k.lerp(n,
0.5),v.a=f,v.b=g,v.c=i,t.a=i,t.b=h,t.c=f,3===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerp(e.vertexNormals[2],0.5),v.vertexNormals[2].copy(f),t.vertexNormals[0].copy(f),t.vertexNormals[1].copy(e.vertexNormals[2]),t.vertexNormals[2].copy(e.vertexNormals[0])),3===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerp(e.vertexColors[2],0.5),v.vertexColors[2].copy(f),t.vertexColors[0].copy(f),t.vertexColors[1].copy(e.vertexColors[2]),t.vertexColors[2].copy(e.vertexColors[0])),e=1):
(k=k.clone(),k.lerp(n,0.5),v.a=f,v.b=g,v.c=i,t.a=i,t.b=g,t.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerp(e.vertexNormals[2],0.5),v.vertexNormals[2].copy(f),t.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerp(e.vertexColors[2],0.5),v.vertexColors[2].copy(f),t.vertexColors[0].copy(f)),e=2);I.push(v,t);a.vertices.push(k);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(k=a.faceVertexUvs[f][c],t=k[0],h=k[1],v=k[2],0===e?
(m=t.clone(),m.lerp(h,0.5),k=[t.clone(),m.clone(),v.clone()],h=[m.clone(),h.clone(),v.clone()]):1===e?(m=h.clone(),m.lerp(v,0.5),k=[t.clone(),h.clone(),m.clone()],h=[m.clone(),v.clone(),t.clone()]):(m=t.clone(),m.lerp(v,0.5),k=[t.clone(),h.clone(),m.clone()],h=[m.clone(),h.clone(),v.clone()]),E[f].push(k,h))}else{I.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)E[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,k=a.vertices[f],m=a.vertices[g],n=a.vertices[h],l=a.vertices[i],s=k.distanceTo(m),
q=m.distanceTo(n),p=n.distanceTo(l),r=k.distanceTo(l),s>b||q>b||p>b||r>b){w=a.vertices.length;x=a.vertices.length+1;v=e.clone();t=e.clone();s>=q&&s>=p&&s>=r||p>=q&&p>=s&&p>=r?(s=k.clone(),s.lerp(m,0.5),m=n.clone(),m.lerp(l,0.5),v.a=f,v.b=w,v.c=x,v.d=i,t.a=w,t.b=g,t.c=h,t.d=x,4===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerp(e.vertexNormals[1],0.5),g=e.vertexNormals[2].clone(),g.lerp(e.vertexNormals[3],0.5),v.vertexNormals[1].copy(f),v.vertexNormals[2].copy(g),t.vertexNormals[0].copy(f),
t.vertexNormals[3].copy(g)),4===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerp(e.vertexColors[1],0.5),g=e.vertexColors[2].clone(),g.lerp(e.vertexColors[3],0.5),v.vertexColors[1].copy(f),v.vertexColors[2].copy(g),t.vertexColors[0].copy(f),t.vertexColors[3].copy(g)),e=0):(s=m.clone(),s.lerp(n,0.5),m=l.clone(),m.lerp(k,0.5),v.a=f,v.b=g,v.c=w,v.d=x,t.a=x,t.b=w,t.c=h,t.d=i,4===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerp(e.vertexNormals[2],0.5),g=e.vertexNormals[3].clone(),
g.lerp(e.vertexNormals[0],0.5),v.vertexNormals[2].copy(f),v.vertexNormals[3].copy(g),t.vertexNormals[0].copy(g),t.vertexNormals[1].copy(f)),4===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerp(e.vertexColors[2],0.5),g=e.vertexColors[3].clone(),g.lerp(e.vertexColors[0],0.5),v.vertexColors[2].copy(f),v.vertexColors[3].copy(g),t.vertexColors[0].copy(g),t.vertexColors[1].copy(f)),e=1);I.push(v,t);a.vertices.push(s,m);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(k=a.faceVertexUvs[f][c],
t=k[0],h=k[1],v=k[2],k=k[3],0===e?(m=t.clone(),m.lerp(h,0.5),n=v.clone(),n.lerp(k,0.5),t=[t.clone(),m.clone(),n.clone(),k.clone()],h=[m.clone(),h.clone(),v.clone(),n.clone()]):(m=h.clone(),m.lerp(v,0.5),n=k.clone(),n.lerp(t,0.5),t=[t.clone(),h.clone(),m.clone(),n.clone()],h=[n.clone(),m.clone(),v.clone(),k.clone()]),E[f].push(t,h))}else{I.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)E[f].push(a.faceVertexUvs[f][c])}a.faces=I;a.faceVertexUvs=E},setMaterialIndex:function(a,b,c,d){a=a.faces;d=d||
a.length-1;for(c=c||0;c<=d;c++)a[c].materialIndex=b}};THREE.GeometryUtils.random=THREE.Math.random16;THREE.GeometryUtils.__v1=new THREE.Vector3;THREE.GeometryUtils.__v2=new THREE.Vector3;THREE.ImageUtils={crossOrigin:"anonymous",loadTexture:function(a,b,c,d){var e=new Image,f=new THREE.Texture(e,b),b=new THREE.ImageLoader;b.addEventListener("load",function(a){f.image=a.content;f.needsUpdate=!0;c&&c(f)});b.addEventListener("error",function(a){d&&d(a.message)});b.crossOrigin=this.crossOrigin;b.load(a,e);f.sourceFile=a;return f},loadCompressedTexture:function(a,b,c,d){var e=new THREE.CompressedTexture;e.mapping=b;var f=new XMLHttpRequest;f.onload=function(){var a=THREE.ImageUtils.parseDDS(f.response,
...
THREE.Curve.create=function(a,b){a.prototype=Object.create(THREE.Curve.prototype);a.prototype.getPoint=b;return a};THREE.LineCurve3=THREE.Curve.create(function(a,b){this.v1=a;this.v2=b},function(a){var b=new THREE.Vector3;b.sub(this.v2,this.v1);b.multiplyScalar(a);b.add(this.v1);return b});
...
g=0;g<h;g++){var i=P*g,k=P*(g+1),l=d+e+i,i=d+f+i,n=d+f+k,k=d+e+k,p=c,q=g,r=h,t=e,w=f,l=l+V,i=i+V,n=n+V,k=k+V;J.faces.push(new THREE.Face4(l,i,n,k,null,null,x));l=v.generateSideWallUV(J,a,p,b,l,i,n,k,q,r,t,w);J.faceVertexUvs[0].push(l)}}}function f(a,b,c){J.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=V;d+=V;e+=V;J.faces.push(new THREE.Face3(c,d,e,null,null,w));c=f?v.generateBottomUV(J,a,b,c,d,e):v.generateTopUV(J,a,b,c,d,e);J.faceVertexUvs[0].push(c)}var h=void 0!==b.amount?b.amount:
100,i=void 0!==b.bevelThickness?b.bevelThickness:6,k=void 0!==b.bevelSize?b.bevelSize:i-2,m=void 0!==b.bevelSegments?b.bevelSegments:3,n=void 0!==b.bevelEnabled?b.bevelEnabled:!0,l=void 0!==b.curveSegments?b.curveSegments:12,s=void 0!==b.steps?b.steps:1,q=b.extrudePath,p,r=!1,w=b.material,x=b.extrudeMaterial,v=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,t,I,E,C;q&&(p=q.getSpacedPoints(s),r=!0,n=!1,t=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(q,s,
!1),I=new THREE.Vector3,E=new THREE.Vector3,C=new THREE.Vector3);n||(k=i=m=0);var z,G,F,J=this,V=this.vertices.length,l=a.extractPoints(l),B=l.shape,l=l.holes;if(q=!THREE.Shape.Utils.isClockWise(B)){B=B.reverse();G=0;for(F=l.length;G<F;G++)z=l[G],THREE.Shape.Utils.isClockWise(z)&&(l[G]=z.reverse());q=!1}var T=THREE.Shape.Utils.triangulateShape(B,l),q=B;G=0;for(F=l.length;G<F;G++)z=l[G],B=B.concat(z);var A,H,L,M,P=B.length,ca=T.length,oa=[],K=0,ha=q.length;A=ha-1;for(H=K+1;K<ha;K++,A++,H++)A===ha&&
...
k,m)),g.push([l,s,q]),g.push([s,p,q])):(f.push(new THREE.Face4(a,e,k,m)),g.push([l,s,p,q]));this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.ParametricGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ConvexGeometry=function(a){function b(a){var b=a.length();return new THREE.Vector2(a.x/b,a.y/b)}THREE.Geometry.call(this);for(var c=[[0,1,2],[0,2,1]],d=3;d<a.length;d++){var e=d,f=a[e].clone(),g=f.length();f.x+=g*2E-6*(Math.random()-0.5);f.y+=g*2E-6*(Math.random()-0.5);f.z+=g*2E-6*(Math.random()-0.5);for(var g=[],h=0;h<c.length;){var i=c[h],k=f,m=a[i[0]],n;n=m;var l=a[i[1]],s=a[i[2]],q=new THREE.Vector3,p=new THREE.Vector3;q.subVectors(s,l);p.subVectors(n,l);q.cross(p);q.normalize();n=q;m=n.dot(m);
...
(k.z=v.z);p.left=i.x;p.right=k.x;p.top=k.y;p.bottom=i.y;p.updateProjectionMatrix()}p=q.shadowMap;w=q.shadowMatrix;r=q.shadowCamera;r.position.copy(q.matrixWorld.getPosition());r.lookAt(q.target.matrixWorld.getPosition());r.updateMatrixWorld();r.matrixWorldInverse.getInverse(r.matrixWorld);q.cameraHelper&&(q.cameraHelper.visible=q.shadowCameraVisible);q.shadowCameraVisible&&q.cameraHelper.update();w.set(0.5,0,0,0.5,0,0.5,0,0.5,0,0,0.5,0.5,0,0,0,1);w.multiply(r.projectionMatrix);w.multiply(r.matrixWorldInverse);
h.multiplyMatrices(r.projectionMatrix,r.matrixWorldInverse);g.setFromMatrix(h);b.setRenderTarget(p);b.clear();t=m.__webglObjects;q=0;for(p=t.length;q<p;q++)if(x=t[q],w=x.object,x.render=!1,w.visible&&w.castShadow&&(!(w instanceof THREE.Mesh||w instanceof THREE.ParticleSystem)||!w.frustumCulled||g.intersectsObject(w)))w._modelViewMatrix.multiplyMatrices(r.matrixWorldInverse,w.matrixWorld),x.render=!0;q=0;for(p=t.length;q<p;q++)x=t[q],x.render&&(w=x.object,x=x.buffer,C=w.material instanceof THREE.MeshFaceMaterial?
w.material.materials[0]:w.material,v=0<w.geometry.morphTargets.length&&C.morphTargets,C=w instanceof THREE.SkinnedMesh&&C.skinning,v=w.customDepthMaterial?w.customDepthMaterial:C?v?f:e:v?d:c,x instanceof THREE.BufferGeometry?b.renderBufferDirect(r,m.__lights,null,v,x,w):b.renderBuffer(r,m.__lights,null,v,x,w));t=m.__webglObjectsImmediate;q=0;for(p=t.length;q<p;q++)x=t[q],w=x.object,w.visible&&w.castShadow&&(w._modelViewMatrix.multiplyMatrices(r.matrixWorldInverse,w.matrixWorld),b.renderImmediateObject(r,
