...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,v){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];l=g[e];p=g[f];n=g[v];r=i.x-h.x;q=j.x-h.x;m=i.y-h.y;t=j.y-h.y;u=i.z-h.z;E=j.z-h.z;B=p.u-l.u;s=n.u-l.u;F=p.v-l.v;A=n.v-l.v;w=1/(B*A-s*F);H.set((A*r-F*q)*w,(A*m-F*t)*w,(A*u-F*E)*w);M.set((B*q-s*r)*w,(B*t-s*m)*w,(B*E-s*u)*w);I[b].addSelf(H);I[c].addSelf(H);I[d].addSelf(H);C[b].addSelf(M);C[c].addSelf(M);C[d].addSelf(M)}var b,c,d,e,f,g,h,i,j,l,p,n,r,q,m,t,u,E,
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,j,l,p,n,r,q,m,t,u,E,B,s;function F(a){return a%4?4-a%4:0}function A(a,b){return(new Uint8Array(a,b,1))[0]}function w(a,b){return(new Uint32Array(a,b,1))[0]}function v(b,c){var d,e,f,g,h,i,j,l=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=l[3*d],f=l[3*d+1],g=l[3*d+2],h=K[2*e],e=K[2*e+1],i=K[2*f],j=K[2*f+1],f=K[2*g],g=K[2*g+1],J.faceVertexUvs[0].push([new THREE.UV(h,e),new THREE.UV(i,j),new THREE.UV(f,g)])}function I(b,
c){var d,e,f,g,h,i,j,l,n,p=new Uint32Array(a,c,4*b);for(d=0;d<b;d++)e=p[4*d],f=p[4*d+1],g=p[4*d+2],h=p[4*d+3],i=K[2*e],e=K[2*e+1],j=K[2*f],l=K[2*f+1],f=K[2*g],n=K[2*g+1],g=K[2*h],h=K[2*h+1],J.faceVertexUvs[0].push([new THREE.UV(i,e),new THREE.UV(j,l),new THREE.UV(f,n),new THREE.UV(g,h)])}function C(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],J.faces.push(new THREE.Face3(e,f,g,null,null,h))}function H(b,c,d){for(var e,
f,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[4*d],f=c[4*d+1],g=c[4*d+2],h=c[4*d+3],i=j[d],J.faces.push(new THREE.Face4(e,f,g,h,null,null,i))}function M(b,c,d,e){for(var f,g,h,i,j,l,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[3*e];g=c[3*e+1];h=c[3*e+2];j=d[3*e];l=d[3*e+1];n=d[3*e+2];i=p[e];var r=L[3*l],m=L[3*l+1];l=L[3*l+2];var q=L[3*n],s=L[3*n+1];n=L[3*n+2];J.faces.push(new THREE.Face3(f,g,h,[new THREE.Vector3(L[3*
j],L[3*j+1],L[3*j+2]),new THREE.Vector3(r,m,l),new THREE.Vector3(q,s,n)],null,i))}}function z(b,c,d,e){for(var f,g,h,i,j,l,n,p,r,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),m=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];l=d[4*e];n=d[4*e+1];p=d[4*e+2];r=d[4*e+3];j=m[e];var q=L[3*n],s=L[3*n+1];n=L[3*n+2];var t=L[3*p],u=L[3*p+1];p=L[3*p+2];var v=L[3*r],w=L[3*r+1];r=L[3*r+2];J.faces.push(new THREE.Face4(f,g,h,i,[new THREE.Vector3(L[3*l],L[3*l+1],L[3*l+2]),new THREE.Vector3(q,
s,n),new THREE.Vector3(t,u,p),new THREE.Vector3(v,w,r)],null,j))}}var J=this,D=0,L=[],K=[],U,N,ia;THREE.Geometry.call(this);s=a;N=D;E=new Uint8Array(s,N,12);q="";for(u=0;12>u;u++)q+=String.fromCharCode(E[N+u]);b=A(s,N+12);A(s,N+13);A(s,N+14);A(s,N+15);c=A(s,N+16);d=A(s,N+17);e=A(s,N+18);j=A(s,N+19);l=w(s,N+20);p=w(s,N+20+4);n=w(s,N+20+8);r=w(s,N+20+12);q=w(s,N+20+16);m=w(s,N+20+20);t=w(s,N+20+24);u=w(s,N+20+28);E=w(s,N+20+32);B=w(s,N+20+36);s=w(s,N+20+40);D+=b;N=3*c+j;ia=4*c+j;U=r*N;b=q*(N+3*d);c=
m*(N+3*e);j=t*(N+3*d+3*e);N=u*ia;d=E*(ia+4*d);e=B*(ia+4*e);ia=D;var D=new Float32Array(a,D,3*l),sa,O,la,ja;for(sa=0;sa<l;sa++)O=D[3*sa],la=D[3*sa+1],ja=D[3*sa+2],J.vertices.push(new THREE.Vector3(O,la,ja));l=D=ia+3*l*Float32Array.BYTES_PER_ELEMENT;if(p){D=new Int8Array(a,D,3*p);for(ia=0;ia<p;ia++)sa=D[3*ia],O=D[3*ia+1],la=D[3*ia+2],L.push(sa/127,O/127,la/127)}D=l+3*p*Int8Array.BYTES_PER_ELEMENT;p=D+=F(3*p);if(n){l=new Float32Array(a,D,2*n);for(D=0;D<n;D++)ia=l[2*D],sa=l[2*D+1],K.push(ia,sa)}n=D=p+
2*n*Float32Array.BYTES_PER_ELEMENT;U=n+U+F(2*r);p=U+b+F(2*q);b=p+c+F(2*m);c=b+j+F(2*t);N=c+N+F(2*u);j=N+d+F(2*E);d=j+e+F(2*B);m&&(e=p+3*m*Uint32Array.BYTES_PER_ELEMENT,C(m,p,e+3*m*Uint32Array.BYTES_PER_ELEMENT),v(m,e));t&&(m=b+3*t*Uint32Array.BYTES_PER_ELEMENT,e=m+3*t*Uint32Array.BYTES_PER_ELEMENT,M(t,b,m,e+3*t*Uint32Array.BYTES_PER_ELEMENT),v(t,e));B&&(t=j+4*B*Uint32Array.BYTES_PER_ELEMENT,H(B,j,t+4*B*Uint32Array.BYTES_PER_ELEMENT),I(B,t));s&&(B=d+4*s*Uint32Array.BYTES_PER_ELEMENT,t=B+4*s*Uint32Array.BYTES_PER_ELEMENT,
z(s,d,B,t+4*s*Uint32Array.BYTES_PER_ELEMENT),I(s,t));r&&C(r,n,n+3*r*Uint32Array.BYTES_PER_ELEMENT);q&&(r=U+3*q*Uint32Array.BYTES_PER_ELEMENT,M(q,U,r,r+3*q*Uint32Array.BYTES_PER_ELEMENT));u&&H(u,c,c+4*u*Uint32Array.BYTES_PER_ELEMENT);E&&(q=N+4*E*Uint32Array.BYTES_PER_ELEMENT,z(E,N,q,q+4*E*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals()};e.prototype=Object.create(THREE.Geometry.prototype);e=new e(c);c=this.initMaterials(d,c);this.needsTangents(c)&&e.computeTangents();
...
t.a=s[i++],t.b=s[i++],t.c=s[i++],t.d=s[i++],l=4):(t=new THREE.Face3,t.a=s[i++],t.b=s[i++],t.c=s[i++],l=3);h&&(h=s[i++],t.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<w;f++)u=a.uvs[f],r=s[i++],B=u[2*r],r=u[2*r+1],d.faceUvs[f][h]=new THREE.UV(B,r);if(g)for(f=0;f<w;f++){u=a.uvs[f];E=[];for(g=0;g<l;g++)r=s[i++],B=u[2*r],r=u[2*r+1],E[g]=new THREE.UV(B,r);d.faceVertexUvs[f][h]=E}n&&(n=3*s[i++],g=new THREE.Vector3,g.x=F[n++],g.y=F[n++],g.z=F[n],t.normal=g);if(p)for(f=0;f<l;f++)n=3*s[i++],g=new THREE.Vector3,
g.x=F[n++],g.y=F[n++],g.z=F[n],t.vertexNormals.push(g);m&&(p=s[i++],p=new THREE.Color(A[p]),t.color=p);if(q)for(f=0;f<l;f++)p=s[i++],p=new THREE.Color(A[p]),t.vertexColors.push(p);d.faces.push(t)}if(a.skinWeights){i=0;for(j=a.skinWeights.length;i<j;i+=2)s=a.skinWeights[i],F=a.skinWeights[i+1],d.skinWeights.push(new THREE.Vector4(s,F,0,0))}if(a.skinIndices){i=0;for(j=a.skinIndices.length;i<j;i+=2)s=a.skinIndices[i],F=a.skinIndices[i+1],d.skinIndices.push(new THREE.Vector4(s,F,0,0))}d.bones=a.bones;
...
0;e<E;e++)for(f=0;f<u;f++)a=new THREE.Face4(f+A*e+F,f+A*(e+1)+F,f+1+A*(e+1)+F,f+1+A*e+F),a.normal.copy(C),a.vertexNormals.push(C.clone(),C.clone(),C.clone(),C.clone()),a.materialIndex=m,h.faces.push(a),h.faceVertexUvs[0].push([new THREE.UV(f/u,1-e/E),new THREE.UV(f/u,1-(e+1)/E),new THREE.UV((f+1)/u,1-(e+1)/E),new THREE.UV((f+1)/u,1-e/E)])}THREE.Geometry.call(this);var h=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;a=this.width/
2;b=this.height/2;c=this.depth/2;g("z","y",-1,-1,this.depth,this.height,a,0);g("z","y",1,-1,this.depth,this.height,-a,1);g("x","z",1,1,this.width,this.depth,b,2);g("x","z",1,-1,this.width,this.depth,-b,3);g("x","y",1,-1,this.width,this.height,c,4);g("x","y",-1,-1,this.width,this.height,-c,5);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CylinderGeometry=function(a,b,c,d,e,f){THREE.Geometry.call(this);var a=void 0!==a?a:20,b=void 0!==b?b:20,c=void 0!==c?c:100,g=c/2,d=d||8,e=e||1,h,i,j=[],l=[];for(i=0;i<=e;i++){var p=[],n=[],r=i/e,q=r*(b-a)+a;for(h=0;h<=d;h++){var m=h/d,t=new THREE.Vector3;t.x=q*Math.sin(2*m*Math.PI);t.y=-r*c+g;t.z=q*Math.cos(2*m*Math.PI);this.vertices.push(t);p.push(this.vertices.length-1);n.push(new THREE.UV(m,1-r))}j.push(p);l.push(n)}c=(b-a)/c;for(h=0;h<d;h++){0!==a?(p=this.vertices[j[0][h]].clone(),n=this.vertices[j[0][h+
1]].clone()):(p=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var r=j[i][h],q=j[i+1][h],m=j[i+1][h+1],t=j[i][h+1],u=p.clone(),E=p.clone(),B=n.clone(),s=n.clone(),F=l[i][h].clone(),A=l[i+1][h].clone(),w=l[i+1][h+1].clone(),v=l[i][h+1].clone();this.faces.push(new THREE.Face4(r,q,m,t,[u,E,B,s]));this.faceVertexUvs[0].push([F,A,w,v])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
g,0));for(h=0;h<d;h++)r=j[0][h],q=j[0][h+1],m=this.vertices.length-1,u=new THREE.Vector3(0,1,0),E=new THREE.Vector3(0,1,0),B=new THREE.Vector3(0,1,0),F=l[0][h].clone(),A=l[0][h+1].clone(),w=new THREE.UV(A.u,0),this.faces.push(new THREE.Face3(r,q,m,[u,E,B])),this.faceVertexUvs[0].push([F,A,w])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)r=j[i][h+1],q=j[i][h],m=this.vertices.length-1,u=new THREE.Vector3(0,-1,0),E=new THREE.Vector3(0,-1,0),B=new THREE.Vector3(0,-1,0),F=
l[i][h+1].clone(),A=l[i][h].clone(),w=new THREE.UV(A.u,1),this.faces.push(new THREE.Face3(r,q,m,[u,E,B])),this.faceVertexUvs[0].push([F,A,w])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(a,b){for(var c=a.length,d=0;d<c;d++)this.addShape(a[d],b)};
...
g=a.vertices[g].z,p=a.vertices[h].x,n=a.vertices[h].y,a=a.vertices[h].z;return 0.01>Math.abs(c-i)?[new THREE.UV(b,1-e),new THREE.UV(d,1-f),new THREE.UV(j,1-g),new THREE.UV(p,1-a)]:[new THREE.UV(c,1-e),new THREE.UV(i,1-f),new THREE.UV(l,1-g),new THREE.UV(n,1-a)]}};THREE.ExtrudeGeometry.__v1=new THREE.Vector2;THREE.ExtrudeGeometry.__v2=new THREE.Vector2;THREE.ExtrudeGeometry.__v3=new THREE.Vector2;THREE.ExtrudeGeometry.__v4=new THREE.Vector2;THREE.ExtrudeGeometry.__v5=new THREE.Vector2;
...
Math.cos(f+p*g);n.z=this.radius*Math.sin(d+l*e)*Math.sin(f+p*g);this.vertices.push(n);i.push(this.vertices.length-1);j.push(new THREE.UV(l,1-p))}c.push(i);h.push(j)}for(b=0;b<this.heightSegments;b++)for(a=0;a<this.widthSegments;a++){var d=c[b][a+1],e=c[b][a],f=c[b+1][a],g=c[b+1][a+1],i=this.vertices[d].clone().normalize(),j=this.vertices[e].clone().normalize(),l=this.vertices[f].clone().normalize(),p=this.vertices[g].clone().normalize(),n=h[b][a+1].clone(),r=h[b][a].clone(),q=h[b+1][a].clone(),m=
h[b+1][a+1].clone();Math.abs(this.vertices[d].y)===this.radius?(this.faces.push(new THREE.Face3(d,f,g,[i,l,p])),this.faceVertexUvs[0].push([n,q,m])):Math.abs(this.vertices[f].y)===this.radius?(this.faces.push(new THREE.Face3(d,e,f,[i,j,l])),this.faceVertexUvs[0].push([n,r,q])):(this.faces.push(new THREE.Face4(d,e,f,g,[i,j,l,p])),this.faceVertexUvs[0].push([n,r,q,m]))}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:this.radius}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.TextGeometry=function(a,b){var c=THREE.FontUtils.generateShapes(a,b);b.amount=void 0!==b.height?b.height:50;void 0===b.bevelThickness&&(b.bevelThickness=10);void 0===b.bevelSize&&(b.bevelSize=8);void 0===b.bevelEnabled&&(b.bevelEnabled=!1);THREE.ExtrudeGeometry.call(this,c,b)};THREE.TextGeometry.prototype=Object.create(THREE.ExtrudeGeometry.prototype);THREE.TorusGeometry=function(a,b,c,d,e){THREE.Geometry.call(this);this.radius=a||100;this.tube=b||40;this.radialSegments=c||8;this.tubularSegments=d||6;this.arc=e||2*Math.PI;e=new THREE.Vector3;a=[];b=[];for(c=0;c<=this.radialSegments;c++)for(d=0;d<=this.tubularSegments;d++){var f=d/this.tubularSegments*this.arc,g=2*c/this.radialSegments*Math.PI;e.x=this.radius*Math.cos(f);e.y=this.radius*Math.sin(f);var h=new THREE.Vector3;h.x=(this.radius+this.tube*Math.cos(g))*Math.cos(f);h.y=(this.radius+this.tube*
...
(b+1)%this.segments:b+1,f=(d+1)%this.radiusSegments,a=this.grid[b][d],c=this.grid[e][d],e=this.grid[e][f],f=this.grid[b][f],p=new THREE.UV(b/this.segments,d/this.radiusSegments),n=new THREE.UV((b+1)/this.segments,d/this.radiusSegments),r=new THREE.UV((b+1)/this.segments,(d+1)/this.radiusSegments),g=new THREE.UV(b/this.segments,(d+1)/this.radiusSegments),this.faces.push(new THREE.Face4(a,c,e,f)),this.faceVertexUvs[0].push([p,n,r,g]);this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};
...
h.push(v.centroid),l.supportUVs&&(w=new THREE.UV,v instanceof THREE.Face3?(w.u=f(v.a,s).u+f(v.b,s).u+f(v.c,s).u,w.v=f(v.a,s).v+f(v.b,s).v+f(v.c,s).v,w.u/=3,w.v/=3):v instanceof THREE.Face4&&(w.u=f(v.a,s).u+f(v.b,s).u+f(v.c,s).u+f(v.d,s).u,w.v=f(v.a,s).v+f(v.b,s).v+f(v.c,s).v+f(v.d,s).v,w.u/=4,w.v/=4),g(m+s,"",w));var n=n(a),M;F=0;var z,J;H={};I={};for(s in n){C=n[s];z=s.split("_");J=z[0];z=z[1];A=J;v=[J,z];void 0===H[A]&&(H[A]=[]);H[A].push(v);A=z;v=[J,z];void 0===H[A]&&(H[A]=[]);H[A].push(v);A=0;
for(w=C.length;A<w;A++){v=C[A];M=J;var D=v,L=s;void 0===I[M]&&(I[M]={});I[M][D]=L;M=z;D=s;void 0===I[M]&&(I[M]={});I[M][v]=D}2>C.length&&(E[s]=!0)}for(s in n)C=n[s],v=C[0],M=C[1],z=s.split("_"),J=z[0],z=z[1],w=new THREE.Vector3,b(0<C.length,"an edge without faces?!"),1==C.length?(w.addSelf(r[J]),w.addSelf(r[z]),w.multiplyScalar(0.5)):(w.addSelf(t[v]),w.addSelf(t[M]),w.addSelf(r[J]),w.addSelf(r[z]),w.multiplyScalar(0.25)),u[s]=m+q.length+F,h.push(w),F++,l.supportUVs&&(w=new THREE.UV,w.u=f(J,v).u+f(z,
v).u,w.v=f(J,v).v+f(z,v).v,w.u/=2,w.v/=2,g(u[s],v,w),2<=C.length&&(b(2==C.length,"did we plan for more than 2 edges?"),w=new THREE.UV,w.u=f(J,M).u+f(z,M).u,w.v=f(J,M).v+f(z,M).v,w.u/=2,w.v/=2,g(u[s],M,w)));c("-- Step 2 done");var K,U;w=["123","12","2","23"];M=["123","23","3","31"];var D=["123","31","1","12"],L=["1234","12","2","23"],N=["1234","23","3","34"],ia=["1234","34","4","41"],sa=["1234","41","1","12"];s=0;for(F=t.length;s<F;s++)v=q[s],C=m+s,v instanceof THREE.Face3?(J=p(v.a,v.b),z=p(v.b,v.c),
K=p(v.c,v.a),e(C,u[J],v.b,u[z],v,w,s),e(C,u[z],v.c,u[K],v,M,s),e(C,u[K],v.a,u[J],v,D,s)):v instanceof THREE.Face4?(J=p(v.a,v.b),z=p(v.b,v.c),K=p(v.c,v.d),U=p(v.d,v.a),e(C,u[J],v.b,u[z],v,L,s),e(C,u[z],v.c,u[K],v,N,s),e(C,u[K],v.d,u[U],v,ia,s),e(C,u[U],v.a,u[J],v,sa,s)):c("face should be a face!",v);u=new THREE.Vector3;v=new THREE.Vector3;s=0;for(F=r.length;s<F;s++)if(void 0!==H[s]){u.set(0,0,0);v.set(0,0,0);z=new THREE.Vector3(0,0,0);C=0;for(A in I[s])u.addSelf(t[A]),C++;M=0;J=H[s].length;w=C!=J;
for(A=0;A<J;A++)E[p(H[s][A][0],H[s][A][1])]&&M++;u.divideScalar(C);M=0;if(w){for(A=0;A<J;A++)if(C=H[s][A],D=1==n[p(C[0],C[1])].length)C=r[C[0]].clone().addSelf(r[C[1]]).divideScalar(2),v.addSelf(C),M++;v.divideScalar(4);b(2==M,"should have only 2 boundary edges")}else{for(A=0;A<J;A++)C=H[s][A],C=r[C[0]].clone().addSelf(r[C[1]]).divideScalar(2),v.addSelf(C);v.divideScalar(J)}z.addSelf(r[s]);w?(z.divideScalar(2),z.addSelf(v)):(z.multiplyScalar(J-3),z.addSelf(u),z.addSelf(v.multiplyScalar(2)),z.divideScalar(J));
