...
transpose:function(){var a,b=this.elements;a=b[1];b[1]=b[3];b[3]=a;a=b[2];b[2]=b[6];b[6]=a;a=b[5];b[5]=b[7];b[7]=a;return this},transposeIntoArray:function(a){var b=this.m;a[0]=b[0];a[1]=b[3];a[2]=b[6];a[3]=b[1];a[4]=b[4];a[5]=b[7];a[6]=b[2];a[7]=b[5];a[8]=b[8];return this}};THREE.Matrix4=function(a,b,c,d,f,e,g,h,i,l,j,n,m,q,p,o){this.elements=new Float32Array(16);this.set(a!==void 0?a:1,b||0,c||0,d||0,f||0,e!==void 0?e:1,g||0,h||0,i||0,l||0,j!==void 0?j:1,n||0,m||0,q||0,p||0,o!==void 0?o:1)};
...
f=THREE.Matrix4.__v1,e=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();if(g.length()===0)g.z=1;f.cross(c,g).normalize();if(f.length()===0){g.x=g.x+1E-4;f.cross(c,g).normalize()}e.cross(g,f);d[0]=f.x;d[4]=e.x;d[8]=g.x;d[1]=f.y;d[5]=e.y;d[9]=g.y;d[2]=f.z;d[6]=e.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,f=this.elements,e=c[0],g=c[4],h=c[8],i=c[12],l=c[1],j=c[5],n=c[9],m=c[13],q=c[2],p=c[6],o=c[10],r=c[14],s=c[3],u=c[7],w=c[11],c=c[15],t=d[0],B=d[4],
v=d[8],A=d[12],D=d[1],z=d[5],M=d[9],G=d[13],H=d[2],E=d[6],O=d[10],F=d[14],J=d[3],I=d[7],K=d[11],d=d[15];f[0]=e*t+g*D+h*H+i*J;f[4]=e*B+g*z+h*E+i*I;f[8]=e*v+g*M+h*O+i*K;f[12]=e*A+g*G+h*F+i*d;f[1]=l*t+j*D+n*H+m*J;f[5]=l*B+j*z+n*E+m*I;f[9]=l*v+j*M+n*O+m*K;f[13]=l*A+j*G+n*F+m*d;f[2]=q*t+p*D+o*H+r*J;f[6]=q*B+p*z+o*E+r*I;f[10]=q*v+p*M+o*O+r*K;f[14]=q*A+p*G+o*F+r*d;f[3]=s*t+u*D+w*H+c*J;f[7]=s*B+u*z+w*E+c*I;f[11]=s*v+u*M+w*O+c*K;f[15]=s*A+u*G+w*F+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
a.z+b[15]*a.w:1;return c},determinant:function(){var a=this.elements,b=a[0],c=a[4],d=a[8],f=a[12],e=a[1],g=a[5],h=a[9],i=a[13],l=a[2],j=a[6],n=a[10],m=a[14],q=a[3],p=a[7],o=a[11],a=a[15];return f*h*j*q-d*i*j*q-f*g*n*q+c*i*n*q+d*g*m*q-c*h*m*q-f*h*l*p+d*i*l*p+f*e*n*p-b*i*n*p-d*e*m*p+b*h*m*p+f*g*l*o-c*i*l*o-f*e*j*o+b*i*j*o+c*e*m*o-b*g*m*o-d*g*l*a+c*h*l*a+d*e*j*a-b*h*j*a-c*e*n*a+b*g*n*a},transpose:function(){var a=this.elements,b;b=a[1];a[1]=a[4];a[4]=b;b=a[2];a[2]=a[8];a[8]=b;b=a[6];a[6]=a[9];a[9]=b;
...
a[9],a[10])},getInverse:function(a){var b=this.elements,c=a.elements,d=c[0],f=c[4],e=c[8],g=c[12],h=c[1],i=c[5],l=c[9],j=c[13],n=c[2],m=c[6],q=c[10],p=c[14],o=c[3],r=c[7],s=c[11],c=c[15];b[0]=l*p*r-j*q*r+j*m*s-i*p*s-l*m*c+i*q*c;b[4]=g*q*r-e*p*r-g*m*s+f*p*s+e*m*c-f*q*c;b[8]=e*j*r-g*l*r+g*i*s-f*j*s-e*i*c+f*l*c;b[12]=g*l*m-e*j*m-g*i*q+f*j*q+e*i*p-f*l*p;b[1]=j*q*o-l*p*o-j*n*s+h*p*s+l*n*c-h*q*c;b[5]=e*p*o-g*q*o+g*n*s-d*p*s-e*n*c+d*q*c;b[9]=g*l*o-e*j*o-g*h*s+d*j*s+e*h*c-d*l*c;b[13]=e*j*n-g*l*n+g*h*q-d*
j*q-e*h*p+d*l*p;b[2]=i*p*o-j*m*o+j*n*r-h*p*r-i*n*c+h*m*c;b[6]=g*m*o-f*p*o-g*n*r+d*p*r+f*n*c-d*m*c;b[10]=f*j*o-g*i*o+g*h*r-d*j*r-f*h*c+d*i*c;b[14]=g*i*n-f*j*n-g*h*m+d*j*m+f*h*p-d*i*p;b[3]=l*m*o-i*q*o-l*n*r+h*q*r+i*n*s-h*m*s;b[7]=f*q*o-e*m*o+e*n*r-d*q*r-f*n*s+d*m*s;b[11]=e*i*o-f*l*o-e*h*r+d*l*r+f*h*s-d*i*s;b[15]=f*l*n-e*i*n+e*h*m-d*l*m-f*h*q+d*i*q;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,f=a.y,e=a.z,g=Math.cos(d),d=Math.sin(d),
...
THREE.Frustum.prototype.setFromMatrix=function(a){var b=this.planes,c=a.elements,a=c[0],d=c[1],f=c[2],e=c[3],g=c[4],h=c[5],i=c[6],l=c[7],j=c[8],n=c[9],m=c[10],q=c[11],p=c[12],o=c[13],r=c[14],c=c[15];b[0].set(e-a,l-g,q-j,c-p);b[1].set(e+a,l+g,q+j,c+p);b[2].set(e+d,l+h,q+n,c+o);b[3].set(e-d,l-h,q-n,c-o);b[4].set(e-f,l-i,q-m,c-r);b[5].set(e+f,l+i,q+m,c+r);for(d=0;d<6;d++){a=b[d];a.divideScalar(Math.sqrt(a.x*a.x+a.y*a.y+a.z*a.z))}};
...
A,D=i.geometry,z=D.vertices,M,G,H;M=i.geometry.materials;G=i.material instanceof a.MeshFaceMaterial;var E,O=j.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(j.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(j.direction);h.rotateAxis(d).normalize();p=0;for(v=D.faces.length;p<v;p++){o=D.faces[p];n=G===true?M[o.materialIndex]:i.material;if(n!==void 0){H=n.side;f.sub(o.centroid,c);e=o.normal;n=d.dot(e);if(!(Math.abs(n)<O)){A=e.dot(f)/n;if(!(A<0)&&(H===
a.DoubleSide||(H===a.FrontSide?n<0:n>0))){g.add(c,d.multiplyScalar(A));if(o instanceof a.Face3){n=z[o.a];A=z[o.b];H=z[o.c];if(q(g,n,A,H)){A=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(A);if(!(n<j.near||n>j.far)){o={distance:n,point:A,face:o,faceIndex:p,object:i};l.push(o)}}}else if(o instanceof a.Face4){n=z[o.a];A=z[o.b];H=z[o.c];E=z[o.d];if(q(g,n,A,E)||q(g,A,H,E)){A=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(A);if(!(n<j.near||n>j.far)){o={distance:n,point:A,face:o,faceIndex:p,
...
if(d<c)return false;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return true}var f,e,g=[],h=0,i,l,j=[],n=0,m,q,p=[],o=0,r,s=[],u=0,w,t,B=[],v=0,A,D,z=[],M=0,G={objects:[],sprites:[],lights:[],elements:[]},H=new THREE.Vector3,E=new THREE.Vector4,O=new THREE.Matrix4,F=new THREE.Matrix4,J=new THREE.Frustum,I=new THREE.Vector4,K=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);O.multiply(b.projectionMatrix,b.matrixWorldInverse);O.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);O.multiply(b.matrixWorld,b.projectionMatrixInverse);O.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n,L){var ba=h.near,Q=h.far,fa=false,ta,da,ga,N,U,ia,Ia,pa,ua,Ca,Ja,Xa,ja,pb,Oa,Ya;D=t=r=q=0;G.elements.length=0;g.updateMatrixWorld();h.parent===
void 0&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);O.multiply(h.projectionMatrix,h.matrixWorldInverse);J.setFromMatrix(O);e=0;G.objects.length=0;G.sprites.length=0;G.lights.length=0;var qb=function(b){if(b.visible!==false){if((b instanceof THREE.Mesh||b instanceof THREE.Line)&&(b.frustumCulled===false||J.contains(b)===true)){f=a();f.object=b;if(b.renderDepth!==null)f.z=b.renderDepth;else{H.copy(b.matrixWorld.getPosition());O.multiplyVector3(H);f.z=H.z}G.objects.push(f)}else if(b instanceof
THREE.Sprite||b instanceof THREE.Particle){f=a();f.object=b;if(b.renderDepth!==null)f.z=b.renderDepth;else{H.copy(b.matrixWorld.getPosition());O.multiplyVector3(H);f.z=H.z}G.sprites.push(f)}else b instanceof THREE.Light&&G.lights.push(b);for(var c=0,d=b.children.length;c<d;c++)qb(b.children[c])}};qb(g);n===true&&G.objects.sort(c);g=0;for(n=G.objects.length;g<n;g++){pa=G.objects[g].object;ua=pa.matrixWorld;l=0;if(pa instanceof THREE.Mesh){Ca=pa.geometry;Ja=pa.geometry.materials;ga=Ca.vertices;Xa=Ca.faces;
pb=Ca.faceVertexUvs;Ca=pa.matrixRotationWorld.extractRotation(ua);Ya=pa.material instanceof THREE.MeshFaceMaterial;ta=0;for(da=ga.length;ta<da;ta++){i=b();i.positionWorld.copy(ga[ta]);ua.multiplyVector3(i.positionWorld);i.positionScreen.copy(i.positionWorld);O.multiplyVector4(i.positionScreen);i.positionScreen.x=i.positionScreen.x/i.positionScreen.w;i.positionScreen.y=i.positionScreen.y/i.positionScreen.w;i.visible=i.positionScreen.z>ba&&i.positionScreen.z<Q}ga=0;for(ta=Xa.length;ga<ta;ga++){Ia=Xa[ga];
da=Ya===true?Ja[Ia.materialIndex]:pa.material;if(da!==void 0){ia=da.side;if(Ia instanceof THREE.Face3){N=j[Ia.a];U=j[Ia.b];ja=j[Ia.c];if(N.visible===true&&U.visible===true&&ja.visible===true){fa=(ja.positionScreen.x-N.positionScreen.x)*(U.positionScreen.y-N.positionScreen.y)-(ja.positionScreen.y-N.positionScreen.y)*(U.positionScreen.x-N.positionScreen.x)<0;if(ia===THREE.DoubleSide||fa===(ia===THREE.FrontSide)){if(q===o){Oa=new THREE.RenderableFace3;p.push(Oa);o++;q++;m=Oa}else m=p[q++];m.v1.copy(N);
m.v2.copy(U);m.v3.copy(ja)}else continue}else continue}else if(Ia instanceof THREE.Face4){N=j[Ia.a];U=j[Ia.b];ja=j[Ia.c];Oa=j[Ia.d];if(N.visible===true&&U.visible===true&&ja.visible===true&&Oa.visible===true){fa=(Oa.positionScreen.x-N.positionScreen.x)*(U.positionScreen.y-N.positionScreen.y)-(Oa.positionScreen.y-N.positionScreen.y)*(U.positionScreen.x-N.positionScreen.x)<0||(U.positionScreen.x-ja.positionScreen.x)*(Oa.positionScreen.y-ja.positionScreen.y)-(U.positionScreen.y-ja.positionScreen.y)*
(Oa.positionScreen.x-ja.positionScreen.x)<0;if(ia===THREE.DoubleSide||fa===(ia===THREE.FrontSide)){if(r===u){var wb=new THREE.RenderableFace4;s.push(wb);u++;r++;m=wb}else m=s[r++];m.v1.copy(N);m.v2.copy(U);m.v3.copy(ja);m.v4.copy(Oa)}else continue}else continue}m.normalWorld.copy(Ia.normal);fa===false&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&m.normalWorld.negate();Ca.multiplyVector3(m.normalWorld);m.centroidWorld.copy(Ia.centroid);ua.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);
O.multiplyVector3(m.centroidScreen);Ia=Ia.vertexNormals;N=0;for(U=Ia.length;N<U;N++){ja=m.vertexNormalsWorld[N];ja.copy(Ia[N]);fa===false&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&ja.negate();Ca.multiplyVector3(ja)}m.vertexNormalsLength=Ia.length;N=0;for(U=pb.length;N<U;N++){ja=pb[N][ga];if(ja!==void 0){ia=0;for(Ia=ja.length;ia<Ia;ia++)m.uvs[N][ia]=ja[ia]}}m.material=da;m.z=m.centroidScreen.z;G.elements.push(m)}}}else if(pa instanceof THREE.Line){F.multiply(O,ua);ga=pa.geometry.vertices;N=b();
N.positionScreen.copy(ga[0]);F.multiplyVector4(N.positionScreen);ua=pa.type===THREE.LinePieces?2:1;ta=1;for(da=ga.length;ta<da;ta++){N=b();N.positionScreen.copy(ga[ta]);F.multiplyVector4(N.positionScreen);if(!((ta+1)%ua>0)){U=j[l-2];I.copy(N.positionScreen);K.copy(U.positionScreen);if(d(I,K)===true){I.multiplyScalar(1/I.w);K.multiplyScalar(1/K.w);if(t===v){Ja=new THREE.RenderableLine;B.push(Ja);v++;t++;w=Ja}else w=B[t++];w.v1.positionScreen.copy(I);w.v2.positionScreen.copy(K);w.z=Math.max(I.z,K.z);
w.material=pa.material;G.elements.push(w)}}}}}g=0;for(n=G.sprites.length;g<n;g++){pa=G.sprites[g].object;ua=pa.matrixWorld;if(pa instanceof THREE.Particle){E.set(ua.elements[12],ua.elements[13],ua.elements[14],1);O.multiplyVector4(E);E.z=E.z/E.w;if(E.z>0&&E.z<1){if(D===M){ba=new THREE.RenderableParticle;z.push(ba);M++;D++;A=ba}else A=z[D++];A.object=pa;A.x=E.x/E.w;A.y=E.y/E.w;A.z=E.z;A.rotation=pa.rotation.z;A.scale.x=pa.scale.x*Math.abs(A.x-(E.x+h.projectionMatrix.elements[0])/(E.w+h.projectionMatrix.elements[12]));
A.scale.y=pa.scale.y*Math.abs(A.y-(E.y+h.projectionMatrix.elements[5])/(E.w+h.projectionMatrix.elements[13]));A.material=pa.material;G.elements.push(A)}}}L===true&&G.elements.sort(c);return G}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=d!==void 0?d:1};
...
l=a.vertices[d];j=g[f];n=g[e];m=g[D];q=i.x-h.x;p=l.x-h.x;o=i.y-h.y;r=l.y-h.y;s=i.z-h.z;u=l.z-h.z;w=n.u-j.u;t=m.u-j.u;B=n.v-j.v;v=m.v-j.v;A=1/(w*v-t*B);G.set((v*q-B*p)*A,(v*o-B*r)*A,(v*s-B*u)*A);H.set((w*p-t*q)*A,(w*r-t*o)*A,(w*u-t*s)*A);z[b].addSelf(G);z[c].addSelf(G);z[d].addSelf(G);M[b].addSelf(H);M[c].addSelf(H);M[d].addSelf(H)}var b,c,d,f,e,g,h,i,l,j,n,m,q,p,o,r,s,u,w,t,B,v,A,D,z=[],M=[],G=new THREE.Vector3,H=new THREE.Vector3,E=new THREE.Vector3,O=new THREE.Vector3,F=new THREE.Vector3;b=0;for(c=
this.vertices.length;b<c;b++){z[b]=new THREE.Vector3;M[b]=new THREE.Vector3}b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];g=this.faceVertexUvs[0][b];if(e instanceof THREE.Face3)a(this,e.a,e.b,e.c,0,1,2);else if(e instanceof THREE.Face4){a(this,e.a,e.b,e.d,0,1,3);a(this,e.b,e.c,e.d,1,2,3)}}var J=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];for(d=0;d<e.vertexNormals.length;d++){F.copy(e.vertexNormals[d]);f=e[J[d]];D=z[f];E.copy(D);E.subSelf(F.multiplyScalar(F.dot(D))).normalize();
O.cross(e.vertexNormals[d],D);f=O.dot(M[f]);f=f<0?-1:1;e.vertexTangents[d]=new THREE.Vector4(E.x,E.y,E.z,f)}}this.hasTangents=true},computeBoundingBox:function(){if(!this.boundingBox)this.boundingBox={min:new THREE.Vector3,max:new THREE.Vector3};if(this.vertices.length>0){var a;a=this.vertices[0];this.boundingBox.min.copy(a);this.boundingBox.max.copy(a);for(var b=this.boundingBox.min,c=this.boundingBox.max,d=1,f=this.vertices.length;d<f;d++){a=this.vertices[d];if(a.x<b.x)b.x=a.x;else if(a.x>c.x)c.x=
...
0}var f=this.offsets,e=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,l,j,n,m,q,p=new THREE.Vector3,o=new THREE.Vector3,r=new THREE.Vector3,s=new THREE.Vector3,u=new THREE.Vector3;c=0;for(d=f.length;c<d;++c){b=f[c].start;i=f[c].count;var w=f[c].index;a=b;for(b=b+i;a<b;a=a+3){i=w+e[a];l=w+e[a+1];j=w+e[a+2];n=g[i*3];m=g[i*3+1];q=g[i*3+2];p.set(n,m,q);n=g[l*3];m=g[l*3+1];q=g[l*3+2];o.set(n,m,q);n=g[j*3];m=g[j*3+1];q=g[j*3+2];r.set(n,m,q);s.sub(r,o);u.sub(p,
o);s.crossSelf(u);h[i*3]=h[i*3]+s.x;h[i*3+1]=h[i*3+1]+s.y;h[i*3+2]=h[i*3+2]+s.z;h[l*3]=h[l*3]+s.x;h[l*3+1]=h[l*3+1]+s.y;h[l*3+2]=h[l*3+2]+s.z;h[j*3]=h[j*3]+s.x;h[j*3+1]=h[j*3+1]+s.y;h[j*3+2]=h[j*3+2]+s.z}}a=0;for(b=h.length;a<b;a=a+3){n=h[a];m=h[a+1];q=h[a+2];c=1/Math.sqrt(n*n+m*m+q*q);h[a]=h[a]*c;h[a+1]=h[a+1]*c;h[a+2]=h[a+2]*c}this.normalsNeedUpdate=true}},computeTangents:function(){function a(a){Y.x=d[a*3];Y.y=d[a*3+1];Y.z=d[a*3+2];$.copy(Y);ba=i[a];K.copy(ba);K.subSelf(Y.multiplyScalar(Y.dot(ba))).normalize();
...
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],l=[],g=0;g<e;g++){i[g]=new THREE.Vector3;l[g]=new THREE.Vector3}var j,n,m,q,p,o,r,s,u,w,t,B,v,A,D,e=new THREE.Vector3,g=new THREE.Vector3,z,M,G,H,E,O,F,J=this.offsets;G=0;for(H=J.length;G<H;++G){M=J[G].start;E=J[G].count;var I=J[G].index;z=M;for(M=M+E;z<M;z=z+3){E=I+b[z];O=I+b[z+1];F=I+b[z+2];j=c[E*3];n=c[E*3+1];m=c[E*3+2];q=c[O*3];p=c[O*3+1];o=c[O*3+2];r=c[F*3];
s=c[F*3+1];u=c[F*3+2];w=f[E*2];t=f[E*2+1];B=f[O*2];v=f[O*2+1];A=f[F*2];D=f[F*2+1];q=q-j;j=r-j;p=p-n;n=s-n;o=o-m;m=u-m;B=B-w;w=A-w;v=v-t;t=D-t;D=1/(B*t-w*v);e.set((t*q-v*j)*D,(t*p-v*n)*D,(t*o-v*m)*D);g.set((B*j-w*q)*D,(B*n-w*p)*D,(B*m-w*o)*D);i[E].addSelf(e);i[O].addSelf(e);i[F].addSelf(e);l[E].addSelf(g);l[O].addSelf(g);l[F].addSelf(g)}}var K=new THREE.Vector3,V=new THREE.Vector3,Y=new THREE.Vector3,$=new THREE.Vector3,L,ba,Q;G=0;for(H=J.length;G<H;++G){M=J[G].start;E=J[G].count;I=J[G].index;z=M;
for(M=M+E;z<M;z=z+3){E=I+b[z];O=I+b[z+1];F=I+b[z+2];a(E);a(O);a(F)}}this.tangentsNeedUpdate=this.hasTangents=true}}};
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,l,j,n,m,q,p,o,r,s,u,w,t;function B(a){return a%4?4-a%4:0}function v(a,b){return(new Uint8Array(a,b,1))[0]}function A(a,b){return(new Uint32Array(a,b,1))[0]}function D(b,c){var d,f,e,g,h,i,j,l,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=I[f*2];f=I[f*2+1];i=I[e*2];j=I[e*2+1];e=I[g*2];l=I[g*2+1];g=O.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,j));m.push(new THREE.UV(e,
...
O.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function G(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=j[d];O.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function H(b,c,d,f){for(var e,g,h,i,j,l,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];j=d[f*3];l=d[f*3+1];n=d[f*3+2];i=m[f];var o=J[l*3],p=J[l*3+1];l=J[l*3+2];var q=J[n*3],
r=J[n*3+1];n=J[n*3+2];O.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(J[j*3],J[j*3+1],J[j*3+2]),new THREE.Vector3(o,p,l),new THREE.Vector3(q,r,n)],null,i))}}function E(b,c,d,f){for(var e,g,h,i,j,l,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];l=d[f*4];n=d[f*4+1];m=d[f*4+2];o=d[f*4+3];j=p[f];var q=J[n*3],r=J[n*3+1];n=J[n*3+2];var t=J[m*3],s=J[m*3+1];m=J[m*3+2];var v=J[o*3],u=J[o*3+1];o=J[o*3+2];O.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(J[l*3],J[l*3+1],J[l*3+2]),new THREE.Vector3(q,r,n),new THREE.Vector3(t,s,m),new THREE.Vector3(v,u,o)],null,j))}}var O=this,F=0,J=[],I=[],K,V,Y;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(O,d,b);t=a;V=F;b=new Uint8Array(t,V,12);o="";for(u=0;u<12;u++)o=o+String.fromCharCode(b[V+u]);c=v(t,V+12);v(t,V+13);v(t,V+14);v(t,V+15);f=v(t,V+16);i=v(t,V+17);l=v(t,V+18);j=v(t,V+19);n=A(t,V+20);m=A(t,V+20+4);q=A(t,V+20+8);p=A(t,V+20+12);o=A(t,V+20+16);r=A(t,V+20+20);s=
A(t,V+20+24);u=A(t,V+20+28);b=A(t,V+20+32);w=A(t,V+20+36);t=A(t,V+20+40);F=F+c;V=f*3+j;Y=f*4+j;K=p*V;c=o*(V+i*3);f=r*(V+l*3);j=s*(V+i*3+l*3);V=u*Y;i=b*(Y+i*4);l=w*(Y+l*4);Y=F;var F=new Float32Array(a,F,n*3),$,L,ba,Q;for($=0;$<n;$++){L=F[$*3];ba=F[$*3+1];Q=F[$*3+2];O.vertices.push(new THREE.Vector3(L,ba,Q))}n=F=Y+n*3*Float32Array.BYTES_PER_ELEMENT;if(m){F=new Int8Array(a,F,m*3);for(Y=0;Y<m;Y++){$=F[Y*3];L=F[Y*3+1];ba=F[Y*3+2];J.push($/127,L/127,ba/127)}}F=n+m*3*Int8Array.BYTES_PER_ELEMENT;m=F=F+B(m*
3);if(q){F=new Float32Array(a,F,q*2);for(n=0;n<q;n++){Y=F[n*2];$=F[n*2+1];I.push(Y,$)}}q=F=m+q*2*Float32Array.BYTES_PER_ELEMENT;K=q+K+B(p*2);m=K+c+B(o*2);c=m+f+B(r*2);f=c+j+B(s*2);V=f+V+B(u*2);j=V+i+B(b*2);i=j+l+B(w*2);if(r){l=m+r*Uint32Array.BYTES_PER_ELEMENT*3;M(r,m,l+r*Uint32Array.BYTES_PER_ELEMENT*3);D(r,l)}if(s){r=c+s*Uint32Array.BYTES_PER_ELEMENT*3;l=r+s*Uint32Array.BYTES_PER_ELEMENT*3;H(s,c,r,l+s*Uint32Array.BYTES_PER_ELEMENT*3);D(s,l)}if(w){s=j+w*Uint32Array.BYTES_PER_ELEMENT*4;G(w,j,s+w*
Uint32Array.BYTES_PER_ELEMENT*4);z(w,s)}if(t){w=i+t*Uint32Array.BYTES_PER_ELEMENT*4;s=w+t*Uint32Array.BYTES_PER_ELEMENT*4;E(t,i,w,s+t*Uint32Array.BYTES_PER_ELEMENT*4);z(t,s)}p&&M(p,q,q+p*Uint32Array.BYTES_PER_ELEMENT*3);if(o){p=K+o*Uint32Array.BYTES_PER_ELEMENT*3;H(o,K,p,p+o*Uint32Array.BYTES_PER_ELEMENT*3)}u&&G(u,f,f+u*Uint32Array.BYTES_PER_ELEMENT*4);if(b){o=V+b*Uint32Array.BYTES_PER_ELEMENT*4;E(b,V,o,o+b*Uint32Array.BYTES_PER_ELEMENT*4)}this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,l,j,n,m,q,p,o,r,s,u,w=a.faces;q=a.vertices;var t=a.normals,B=a.colors,v=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&v++;for(e=0;e<v;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}c=0;for(i=q.length;c<i;){l=new THREE.Vector3;l.x=q[c++]*f;l.y=q[c++]*f;l.z=q[c++]*f;d.vertices.push(l)}c=0;for(i=w.length;c<i;){q=w[c++];l=q&1;h=q&2;e=q&4;g=q&8;n=q&
16;j=q&32;p=q&64;q=q&128;if(l){o=new THREE.Face4;o.a=w[c++];o.b=w[c++];o.c=w[c++];o.d=w[c++];l=4}else{o=new THREE.Face3;o.a=w[c++];o.b=w[c++];o.c=w[c++];l=3}if(h){h=w[c++];o.materialIndex=h}h=d.faces.length;if(e)for(e=0;e<v;e++){r=a.uvs[e];m=w[c++];u=r[m*2];m=r[m*2+1];d.faceUvs[e][h]=new THREE.UV(u,m)}if(g)for(e=0;e<v;e++){r=a.uvs[e];s=[];for(g=0;g<l;g++){m=w[c++];u=r[m*2];m=r[m*2+1];s[g]=new THREE.UV(u,m)}d.faceVertexUvs[e][h]=s}if(n){n=w[c++]*3;g=new THREE.Vector3;g.x=t[n++];g.y=t[n++];g.z=t[n];
o.normal=g}if(j)for(e=0;e<l;e++){n=w[c++]*3;g=new THREE.Vector3;g.x=t[n++];g.y=t[n++];g.z=t[n];o.vertexNormals.push(g)}if(p){j=w[c++];j=new THREE.Color(B[j]);o.color=j}if(q)for(e=0;e<l;e++){j=w[c++];j=new THREE.Color(B[j]);o.vertexColors.push(j)}d.faces.push(o)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c=c+2){w=a.skinWeights[c];t=a.skinWeights[c+1];d.skinWeights.push(new THREE.Vector4(w,t,0,0))}}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c=c+2){w=a.skinIndices[c];t=a.skinIndices[c+
1];d.skinIndices.push(new THREE.Vector4(w,t,0,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets!==void 0){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];B=d.morphTargets[c].vertices;v=a.morphTargets[c].vertices;w=0;for(t=v.length;w<t;w=w+3){q=new THREE.Vector3;q.x=v[w]*f;q.y=v[w+1]*f;q.z=v[w+2]*f;B.push(q)}}}if(a.morphColors!==void 0){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};
d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=[];t=d.morphColors[c].colors;B=a.morphColors[c].colors;f=0;for(w=B.length;f<w;f=f+3){v=new THREE.Color(16755200);v.setRGB(B[f],B[f+1],B[f+2]);t.push(v)}}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};THREE.GeometryLoader=function(){THREE.EventTarget.call(this);this.path=this.crossOrigin=null};
...
a,true);d.send(null);var f=new THREE.LoadingMonitor;f.addEventListener("load",function(){b.dispatchEvent({type:"load",content:c})});f.add(d)},parse:function(a,b){var c=this,d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;if(a.materials){d.materials=[];for(var e=0;e<a.materials.length;++e){var g=a.materials[e],h=function(a){a=Math.log(a)/Math.LN2;return Math.floor(a)==a},i=function(a){a=Math.log(a)/Math.LN2;return Math.pow(2,Math.round(a))},l=function(a,d,f,e,g,j){a[d]=new THREE.Texture;a[d].sourceFile=
...
m.specularMap;j.enableSpecular.value=true}if(m.lightMap){j.tAO.value=m.lightMap;j.enableAO.value=true}j.uDiffuseColor.value.setHex(m.color);j.uSpecularColor.value.setHex(m.specular);j.uAmbientColor.value.setHex(m.ambient);j.uShininess.value=m.shininess;if(m.opacity!==void 0)j.uOpacity.value=m.opacity;m=new THREE.ShaderMaterial({fragmentShader:l.fragmentShader,vertexShader:l.vertexShader,uniforms:j,lights:true,fog:true})}else m=new THREE[n](m);if(g.DbgName!==void 0)m.name=g.DbgName;d.materials[e]=
m}}var g=a.faces,p=a.vertices,m=a.normals,l=a.colors,j=0;if(a.uvs)for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&j++;for(e=0;e<j;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}n=0;for(q=p.length;n<q;){var o=new THREE.Vector3;o.x=p[n++]*f;o.y=p[n++]*f;o.z=p[n++]*f;d.vertices.push(o)}n=0;for(q=g.length;n<q;){var r=g[n++],s=r&2,e=r&4,u=r&8,w=r&16,p=r&32,t=r&64,o=r&128;if(r&1){r=new THREE.Face4;r.a=g[n++];r.b=g[n++];r.c=g[n++];r.d=g[n++];var B=4}else{r=new THREE.Face3;r.a=g[n++];r.b=g[n++];r.c=g[n++];B=3}if(s){s=
g[n++];r.materialIndex=s}var v=d.faces.length;if(e)for(e=0;e<j;e++){var A=a.uvs[e],s=g[n++],D=A[s*2],s=A[s*2+1];d.faceUvs[e][v]=new THREE.UV(D,s)}if(u)for(e=0;e<j;e++){for(var A=a.uvs[e],u=[],z=0;z<B;z++){s=g[n++];D=A[s*2];s=A[s*2+1];u[z]=new THREE.UV(D,s)}d.faceVertexUvs[e][v]=u}if(w){w=g[n++]*3;s=new THREE.Vector3;s.x=m[w++];s.y=m[w++];s.z=m[w];r.normal=s}if(p)for(e=0;e<B;e++){w=g[n++]*3;s=new THREE.Vector3;s.x=m[w++];s.y=m[w++];s.z=m[w];r.vertexNormals.push(s)}if(t){p=g[n++];r.color=new THREE.Color(l[p])}if(o)for(e=
0;e<B;e++){p=g[n++];r.vertexColors.push(new THREE.Color(l[p]))}d.faces.push(r)}if(a.skinWeights){e=0;for(g=a.skinWeights.length;e<g;e=e+2)d.skinWeights.push(new THREE.Vector4(a.skinWeights[e],a.skinWeights[e+1],0,0))}if(a.skinIndices){e=0;for(g=a.skinIndices.length;e<g;e=e+2){m=0;d.skinIndices.push(new THREE.Vector4(a.skinIndices[e],a.skinIndices[e+1],m,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets){e=0;for(g=a.morphTargets.length;e<g;e++){d.morphTargets[e]={};d.morphTargets[e].name=
a.morphTargets[e].name;d.morphTargets[e].vertices=[];m=d.morphTargets[e].vertices;l=a.morphTargets[e].vertices;s=0;for(j=l.length;s<j;s=s+3){o=new THREE.Vector3;o.x=l[s]*f;o.y=l[s+1]*f;o.z=l[s+2]*f;m.push(o)}}}if(a.morphColors){e=0;for(g=a.morphColors.length;e<g;e++){d.morphColors[e]={};d.morphColors[e].name=a.morphColors[e].name;d.morphColors[e].colors=[];f=d.morphColors[e].colors;l=a.morphColors[e].colors;m=0;for(j=l.length;m<j;m=m+3){n=new THREE.Color(16755200);n.setRGB(l[m],l[m+1],l[m+2]);f.push(n)}}}d.computeCentroids();
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return b=="relativeToHTML"?a:l+"/"+a}function f(a,b){for(var c in b)if(I.objects[c]===void 0){var d=b[c],e=null;if(d.geometry!==void 0){if(D=I.geometries[d.geometry]){e=false;z=I.materials[d.materials[0]];(e=z instanceof THREE.ShaderMaterial)&&D.computeTangents();u=d.position;w=d.rotation;t=d.quaternion;B=d.scale;r=d.matrix;t=0;d.materials.length===0&&(z=new THREE.MeshFaceMaterial);d.materials.length>1&&(z=new THREE.MeshFaceMaterial);
if(d.morph){e=new THREE.MorphAnimMesh(D,z);if(d.duration!==void 0)e.duration=d.duration;if(d.time!==void 0)e.time=d.time;if(d.mirroredLoop!==void 0)e.mirroredLoop=d.mirroredLoop;z.morphNormals&&D.computeMorphNormals()}else e=new THREE.Mesh(D,z);e.name=c;if(r){e.matrixAutoUpdate=false;e.matrix.set(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15])}else{e.position.set(u[0],u[1],u[2]);if(t){e.quaternion.set(t[0],t[1],t[2],t[3]);e.useQuaternion=true}else e.rotation.set(w[0],
w[1],w[2]);e.scale.set(B[0],B[1],B[2])}e.visible=d.visible;e.castShadow=d.castShadow;e.receiveShadow=d.receiveShadow;a.add(e);I.objects[c]=e}}else{u=d.position;w=d.rotation;t=d.quaternion;B=d.scale;t=0;e=new THREE.Object3D;e.name=c;e.position.set(u[0],u[1],u[2]);if(t){e.quaternion.set(t[0],t[1],t[2],t[3]);e.useQuaternion=true}else e.rotation.set(w[0],w[1],w[2]);e.scale.set(B[0],B[1],B[2]);e.visible=d.visible!==void 0?d.visible:false;a.add(e);I.objects[c]=e;I.empties[c]=e}if(e){if(d.properties!==void 0)for(var g in d.properties)e.properties[g]=
d.properties[g];d.children!==void 0&&f(e,d.children)}}}function e(a){return function(b){I.geometries[a]=b;f(I.scene,K.objects);E=E-1;i.onLoadComplete();h()}}function g(a){return function(b){I.geometries[a]=b}}function h(){i.callbackProgress({totalModels:F,totalTextures:J,loadedModels:F-E,loadedTextures:J-O},I);i.onLoadProgress();E===0&&O===0&&b(I)}var i=this,l=THREE.Loader.prototype.extractUrlBase(c),j,n,m,q,p,o,r,s,u,w,t,B,v,A,D,z,M,G,H,E,O,F,J,I,K=a;for(v in this.geometryHandlerMap)this.geometryHandlerMap[v].loaderObject=
new this.geometryHandlerMap[v].loaderClass;O=E=0;I={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(K.transform){a=K.transform.position;c=K.transform.rotation;v=K.transform.scale;a&&I.scene.position.set(a[0],a[1],a[2]);c&&I.scene.rotation.set(c[0],c[1],c[2]);v&&I.scene.scale.set(v[0],v[1],v[2]);if(a||c||v){I.scene.updateMatrix();I.scene.updateMatrixWorld()}}a=function(a){return function(){O=O-a;h();i.onLoadComplete()}};for(q in K.cameras){v=
K.cameras[q];v.type==="perspective"?M=new THREE.PerspectiveCamera(v.fov,v.aspect,v.near,v.far):v.type==="ortho"&&(M=new THREE.OrthographicCamera(v.left,v.right,v.top,v.bottom,v.near,v.far));u=v.position;c=v.target;v=v.up;M.position.set(u[0],u[1],u[2]);M.target=new THREE.Vector3(c[0],c[1],c[2]);v&&M.up.set(v[0],v[1],v[2]);I.cameras[q]=M}for(m in K.lights){c=K.lights[m];q=c.color!==void 0?c.color:16777215;M=c.intensity!==void 0?c.intensity:1;if(c.type==="directional"){u=c.direction;s=new THREE.DirectionalLight(q,
M);s.position.set(u[0],u[1],u[2]);s.position.normalize()}else if(c.type==="point"){u=c.position;s=c.distance;s=new THREE.PointLight(q,M,s);s.position.set(u[0],u[1],u[2])}else c.type==="ambient"&&(s=new THREE.AmbientLight(q));I.scene.add(s);I.lights[m]=s}for(p in K.fogs){m=K.fogs[p];m.type==="linear"?G=new THREE.Fog(0,m.near,m.far):m.type==="exp2"&&(G=new THREE.FogExp2(0,m.density));v=m.color;G.color.setRGB(v[0],v[1],v[2]);I.fogs[p]=G}if(I.cameras&&K.defaults.camera)I.currentCamera=I.cameras[K.defaults.camera];
...
p.subdivisions);I.geometries[j]=D}else if(p.type in this.geometryHandlerMap){G={};for(H in p)H!=="type"&&H!=="url"&&(G[H]=p[H]);this.geometryHandlerMap[p.type].loaderObject.load(d(p.url,K.urlBaseType),e(j),G)}else if(p.type==="embedded"){p=K.embeds[p.id];p.metadata=K.metadata;p&&this.geometryHandlerMap.ascii.loaderObject.createModel(p,g(j),"")}}for(o in K.textures){j=K.textures[o];if(j.url instanceof Array){O=O+j.url.length;for(H=0;H<j.url.length;H++)i.onLoadStart()}else{O=O+1;i.onLoadStart()}}J=
O;for(o in K.textures){j=K.textures[o];if(j.mapping!==void 0&&THREE[j.mapping]!==void 0)j.mapping=new THREE[j.mapping];if(j.url instanceof Array){H=j.url.length;p=[];for(G=0;G<H;G++)p[G]=d(j.url[G],K.urlBaseType);H=THREE.ImageUtils.loadTextureCube(p,j.mapping,a(H))}else{H=THREE.ImageUtils.loadTexture(d(j.url,K.urlBaseType),j.mapping,a(1));if(THREE[j.minFilter]!==void 0)H.minFilter=THREE[j.minFilter];if(THREE[j.magFilter]!==void 0)H.magFilter=THREE[j.magFilter];if(j.anisotropy)H.anisotropy=j.anisotropy;
...
THREE.CanvasRenderer=function(a){function b(a){if(u!==a)u=o.globalAlpha=a}function c(a){if(w!==a){if(a===THREE.NormalBlending)o.globalCompositeOperation="source-over";else if(a===THREE.AdditiveBlending)o.globalCompositeOperation="lighter";else if(a===THREE.SubtractiveBlending)o.globalCompositeOperation="darker";w=a}}function d(a){if(t!==a)t=o.strokeStyle=a}function f(a){if(B!==a)B=o.fillStyle=a}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},e=this,g,h,i,l=new THREE.Projector,j=a.canvas!==
void 0?a.canvas:document.createElement("canvas"),n,m,q,p,o=j.getContext("2d"),r=new THREE.Color(0),s=0,u=1,w=0,t=null,B=null,v=null,A=null,D=null,z,M,G,H,E=new THREE.RenderableVertex,O=new THREE.RenderableVertex,F,J,I,K,V,Y,$,L,ba,Q,fa,ta,da=new THREE.Color,ga=new THREE.Color,N=new THREE.Color,U=new THREE.Color,ia=new THREE.Color,Ia={},pa={},ua,Ca,Ja,Xa,ja,pb,Oa,Ya,qb,wb,fb=new THREE.Rectangle,Fa=new THREE.Rectangle,xa=new THREE.Rectangle,xb=false,Ga=new THREE.Color,$a=new THREE.Color,rb=new THREE.Color,
...
p=Math.floor(m/2);j.width=n;j.height=m;fb.set(-q,-p,q,p);Fa.set(-q,-p,q,p);u=1;w=0;D=A=v=B=t=null};this.setClearColor=function(a,b){r.copy(a);s=b!==void 0?b:1;Fa.set(-q,-p,q,p)};this.setClearColorHex=function(a,b){r.setHex(a);s=b!==void 0?b:1;Fa.set(-q,-p,q,p)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){o.setTransform(1,0,0,-1,q,p);if(Fa.isEmpty()===false){Fa.minSelf(fb);Fa.inflate(2);s<1&&o.clearRect(Math.floor(Fa.getX()),Math.floor(Fa.getY()),Math.floor(Fa.getWidth()),Math.floor(Fa.getHeight()));
if(s>0){c(THREE.NormalBlending);b(1);f("rgba("+Math.floor(r.r*255)+","+Math.floor(r.g*255)+","+Math.floor(r.b*255)+","+s+")");o.fillRect(Math.floor(Fa.getX()),Math.floor(Fa.getY()),Math.floor(Fa.getWidth()),Math.floor(Fa.getHeight()))}Fa.empty()}};this.render=function(a,k){function j(a,b,c){for(var d=0,f=i.length;d<f;d++){var e=i[d],g=e.color;if(e instanceof THREE.DirectionalLight){var h=e.matrixWorld.getPosition().normalize(),k=b.dot(h);if(!(k<=0)){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=
...
m(F,J,I,K,V,Y);if((o instanceof THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)&&o.map===null&&o.map===null)if(xb===true){g=o.color;h=o.emissive;if(o.wireframe===false&&o.shading==THREE.SmoothShading&&l.vertexNormalsLength==3){ga.r=N.r=U.r=Ga.r;ga.g=N.g=U.g=Ga.g;ga.b=N.b=U.b=Ga.b;j(l.v1.positionWorld,l.vertexNormalsWorld[0],ga);j(l.v2.positionWorld,l.vertexNormalsWorld[1],N);j(l.v3.positionWorld,l.vertexNormalsWorld[2],U);ga.r=g.r*ga.r+h.r;ga.g=g.g*ga.g+h.g;ga.b=g.b*ga.b+h.b;N.r=
g.r*N.r+h.r;N.g=g.g*N.g+h.g;N.b=g.b*N.b+h.b;U.r=g.r*U.r+h.r;U.g=g.g*U.g+h.g;U.b=g.b*U.b+h.b;ia.r=(N.r+U.r)*0.5;ia.g=(N.g+U.g)*0.5;ia.b=(N.b+U.b)*0.5;Ja=va(ga,N,U,ia);w(F,J,I,K,V,Y,0,0,1,0,0,1,Ja)}else{da.r=Ga.r;da.g=Ga.g;da.b=Ga.b;j(l.centroidWorld,l.normalWorld,da);da.r=g.r*da.r+h.r;da.g=g.g*da.g+h.g;da.b=g.b*da.b+h.b;o.wireframe===true?t(da,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):s(da)}}else o.wireframe===true?t(o.color,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):
...
true?this.clear():o.setTransform(1,0,0,-1,q,p);e.info.render.vertices=0;e.info.render.faces=0;g=l.projectScene(a,k,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;xb=i.length>0;if(xb===true){Ga.setRGB(0,0,0);$a.setRGB(0,0,0);rb.setRGB(0,0,0);Vb=0;for(Ec=i.length;Vb<Ec;Vb++){X=i[Vb];var ca=X.color;if(X instanceof THREE.AmbientLight){Ga.r=Ga.r+ca.r;Ga.g=Ga.g+ca.g;Ga.b=Ga.b+ca.b}else if(X instanceof THREE.DirectionalLight){$a.r=$a.r+ca.r;$a.g=$a.g+ca.g;$a.b=$a.b+ca.b}else if(X instanceof
...
B.v1;M=B.v2;G=B.v3;z.positionScreen.x=z.positionScreen.x*q;z.positionScreen.y=z.positionScreen.y*p;M.positionScreen.x=M.positionScreen.x*q;M.positionScreen.y=M.positionScreen.y*p;G.positionScreen.x=G.positionScreen.x*q;G.positionScreen.y=G.positionScreen.y*p;if(X.overdraw===true){sb(z.positionScreen,M.positionScreen);sb(M.positionScreen,G.positionScreen);sb(G.positionScreen,z.positionScreen)}xa.add3Points(z.positionScreen.x,z.positionScreen.y,M.positionScreen.x,M.positionScreen.y,G.positionScreen.x,
G.positionScreen.y);fb.intersects(xa)===true&&n(z,M,G,0,1,2,B,X,a)}else if(B instanceof THREE.RenderableFace4){z=B.v1;M=B.v2;G=B.v3;H=B.v4;z.positionScreen.x=z.positionScreen.x*q;z.positionScreen.y=z.positionScreen.y*p;M.positionScreen.x=M.positionScreen.x*q;M.positionScreen.y=M.positionScreen.y*p;G.positionScreen.x=G.positionScreen.x*q;G.positionScreen.y=G.positionScreen.y*p;H.positionScreen.x=H.positionScreen.x*q;H.positionScreen.y=H.positionScreen.y*p;E.positionScreen.copy(M.positionScreen);O.positionScreen.copy(H.positionScreen);
if(X.overdraw===true){sb(z.positionScreen,M.positionScreen);sb(M.positionScreen,H.positionScreen);sb(H.positionScreen,z.positionScreen);sb(G.positionScreen,E.positionScreen);sb(G.positionScreen,O.positionScreen)}xa.addPoint(z.positionScreen.x,z.positionScreen.y);xa.addPoint(M.positionScreen.x,M.positionScreen.y);xa.addPoint(G.positionScreen.x,G.positionScreen.y);xa.addPoint(H.positionScreen.x,H.positionScreen.y);if(fb.intersects(xa)===true){oa=z;Ea=M;tb=G;jb=H;kb=E;Wb=O;ca=B;B=a;e.info.render.vertices=
...
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(hb){for(var l=0,m=0,n=0,o,p,q,r,t=qc,s=t.directional.colors,u=t.directional.positions,z=t.point.colors,A=t.point.positions,D=t.point.distances,G=t.spot.colors,H=t.spot.positions,I=t.spot.distances,F=t.spot.directions,J=t.spot.angles,K=t.spot.exponents,L=t.hemi.skyColors,U=t.hemi.groundColors,ga=t.hemi.positions,V=0,$=0,ba=0,Y=0,c=o=q=q=p=0,e=b.length;c<e;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=
j.color;r=j.intensity;p=j.distance;if(j instanceof THREE.AmbientLight)if(Q.gammaInput){l=l+o.r*o.r;m=m+o.g*o.g;n=n+o.b*o.b}else{l=l+o.r;m=m+o.g;n=n+o.b}else if(j instanceof THREE.DirectionalLight){p=V*3;Q.gammaInput?B(s,p,o,r*r):v(s,p,o,r);Qa.copy(j.matrixWorld.getPosition());Qa.subSelf(j.target.matrixWorld.getPosition());Qa.normalize();u[p]=Qa.x;u[p+1]=Qa.y;u[p+2]=Qa.z;V=V+1}else if(j instanceof THREE.PointLight){q=$*3;Q.gammaInput?B(z,q,o,r*r):v(z,q,o,r);r=j.matrixWorld.getPosition();A[q]=r.x;A[q+
1]=r.y;A[q+2]=r.z;D[$]=p;$=$+1}else if(j instanceof THREE.SpotLight){q=ba*3;Q.gammaInput?B(G,q,o,r*r):v(G,q,o,r);r=j.matrixWorld.getPosition();H[q]=r.x;H[q+1]=r.y;H[q+2]=r.z;I[ba]=p;Qa.copy(r);Qa.subSelf(j.target.matrixWorld.getPosition());Qa.normalize();F[q]=Qa.x;F[q+1]=Qa.y;F[q+2]=Qa.z;J[ba]=Math.cos(j.angle);K[ba]=j.exponent;ba=ba+1}else if(j instanceof THREE.HemisphereLight){p=j.color;q=j.groundColor;o=Y*3;if(Q.gammaInput){r=r*r;B(L,o,p,r);B(U,o,q,r)}else{v(L,o,p,r);v(U,o,q,r)}r=j.matrixWorld.getPosition();
ga[o]=r.x;ga[o+1]=r.y;ga[o+2]=r.z;Y=Y+1}}}c=V*3;for(e=s.length;c<e;c++)s[c]=0;c=$*3;for(e=z.length;c<e;c++)z[c]=0;c=ba*3;for(e=G.length;c<e;c++)G[c]=0;c=Y*3;for(e=L.length;c<e;c++)L[c]=0;c=Y*3;for(e=U.length;c<e;c++)U[c]=0;t.directional.length=V;t.point.length=$;t.spot.length=ba;t.hemi.length=Y;t.ambient[0]=l;t.ambient[1]=m;t.ambient[2]=n;hb=false}c=qc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=
...
c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);e=[];for(j=0;j<6;j++)if(Q.autoScaleCubemaps){l=e;m=j;n=c.image[j];s=Sc;if(!(n.width<=s&&n.height<=s)){u=Math.max(n.width,n.height);t=Math.floor(n.width*s/u);s=Math.floor(n.height*s/u);u=document.createElement("canvas");u.width=t;u.height=s;u.getContext("2d").drawImage(n,0,0,n.width,n.height,0,0,t,s);n=u}l[m]=n}else e[j]=c.image[j];j=e[0];l=(j.width&j.width-1)===0&&(j.height&j.height-1)===0;m=E(c.format);n=E(c.type);M(k.TEXTURE_CUBE_MAP,
...
false,a=0;for(c=fa.length;a<c;a++){d=fa[a];if(d.program===b){d.usedTimes--;d.usedTimes===0&&(e=true);break}}if(e){e=[];a=0;for(c=fa.length;a<c;a++){d=fa[a];d.program!==b&&e.push(d)}fa=e;k.deleteProgram(b);Q.info.memory.programs--}}};this.updateShadowMap=function(a,b){da=null;N=U=Ya=Oa=Ja=-1;hb=true;Ca=ua=-1;this.shadowMapPlugin.update(a,b)};this.renderBufferImmediate=function(a,b,c){if(a.hasPositions&&!a.__webglVertexBuffer)a.__webglVertexBuffer=k.createBuffer();if(a.hasNormals&&!a.__webglNormalBuffer)a.__webglNormalBuffer=
...
i],3,k.FLOAT,false,0,0);if(d.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,e.__webglMorphNormalsBuffers[h[i]]);k.vertexAttribPointer(c["morphNormal"+i],3,k.FLOAT,false,0,0)}f.__webglMorphTargetInfluences[i]=g[h[i]];i++}}else{h=[];g=f.morphTargetInfluences;var j,m=g.length;for(j=0;j<m;j++){i=g[j];i>0&&h.push([j,i])}if(h.length>d.numSupportedMorphTargets){h.sort(l);h.length=d.numSupportedMorphTargets}else h.length>d.numSupportedMorphNormals?h.sort(l):h.length===0&&h.push([0,0]);for(i=0;i<d.numSupportedMorphTargets;){if(h[i]){j=
...
a.__objectsAdded[0],j=a,l=void 0,m=void 0,n=void 0;if(!i.__webglInit){i.__webglInit=true;i._modelViewMatrix=new THREE.Matrix4;i._normalMatrix=new THREE.Matrix3;if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.Geometry){if(m.geometryGroups===void 0){var t=m,u=void 0,v=void 0,w=void 0,z=void 0,A=void 0,B=void 0,D=void 0,E={},G=t.morphTargets.length,H=t.morphNormals.length;t.geometryGroups={};u=0;for(v=t.faces.length;u<v;u++){w=t.faces[u];z=w.materialIndex;B=z!==void 0?z:-1;E[B]===void 0&&
(E[B]={hash:B,counter:0});D=E[B].hash+"_"+E[B].counter;t.geometryGroups[D]===void 0&&(t.geometryGroups[D]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:G,numMorphNormals:H});A=w instanceof THREE.Face3?3:4;if(t.geometryGroups[D].vertices+A>65535){E[B].counter=E[B].counter+1;D=E[B].hash+"_"+E[B].counter;t.geometryGroups[D]===void 0&&(t.geometryGroups[D]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:G,numMorphNormals:H})}w instanceof THREE.Face3?t.geometryGroups[D].faces3.push(u):
t.geometryGroups[D].faces4.push(u);t.geometryGroups[D].vertices=t.geometryGroups[D].vertices+A}t.geometryGroupsList=[];var I=void 0;for(I in t.geometryGroups){t.geometryGroups[I].id=Ia++;t.geometryGroupsList.push(t.geometryGroups[I])}}for(l in m.geometryGroups){n=m.geometryGroups[l];if(!n.__webglVertexBuffer){var F=n;F.__webglVertexBuffer=k.createBuffer();F.__webglNormalBuffer=k.createBuffer();F.__webglTangentBuffer=k.createBuffer();F.__webglColorBuffer=k.createBuffer();F.__webglUVBuffer=k.createBuffer();
...
void 0,Na=void 0,$b=void 0,Rb=void 0,Ha=0,La=0,Sb=0,Tb=0,nb=0,Va=0,sa=0,Za=0,Ka=0,aa=0,ha=0,y=0,ra=void 0,Sa=la.__vertexArray,xc=la.__uvArray,yc=la.__uv2Array,ob=la.__normalArray,ya=la.__tangentArray,Ta=la.__colorArray,za=la.__skinIndexArray,Aa=la.__skinWeightArray,Uc=la.__morphTargetsArrays,Vc=la.__morphNormalsArrays,Wc=la.__webglCustomAttributesList,x=void 0,Ob=la.__faceArray,ib=la.__lineArray,db=xb.geometry,Dc=db.elementsNeedUpdate,ad=db.uvsNeedUpdate,Rc=db.normalsNeedUpdate,Sc=db.tangentsNeedUpdate,
hd=db.colorsNeedUpdate,id=db.morphTargetsNeedUpdate,gc=db.vertices,ma=la.faces3,na=la.faces4,Wa=db.faces,Xc=db.faceVertexUvs[0],Yc=db.faceVertexUvs[1],hc=db.skinIndices,ac=db.skinWeights,bc=db.morphTargets,Hc=db.morphNormals;if(db.verticesNeedUpdate){C=0;for(W=ma.length;C<W;C++){P=Wa[ma[C]];R=gc[P.a];S=gc[P.b];T=gc[P.c];Sa[La]=R.x;Sa[La+1]=R.y;Sa[La+2]=R.z;Sa[La+3]=S.x;Sa[La+4]=S.y;Sa[La+5]=S.z;Sa[La+6]=T.x;Sa[La+7]=T.y;Sa[La+8]=T.z;La=La+9}C=0;for(W=na.length;C<W;C++){P=Wa[na[C]];R=gc[P.a];S=gc[P.b];
T=gc[P.c];ka=gc[P.d];Sa[La]=R.x;Sa[La+1]=R.y;Sa[La+2]=R.z;Sa[La+3]=S.x;Sa[La+4]=S.y;Sa[La+5]=S.z;Sa[La+6]=T.x;Sa[La+7]=T.y;Sa[La+8]=T.z;Sa[La+9]=ka.x;Sa[La+10]=ka.y;Sa[La+11]=ka.z;La=La+12}k.bindBuffer(k.ARRAY_BUFFER,la.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Sa,mb)}if(id){Ra=0;for(rc=bc.length;Ra<rc;Ra++){C=ha=0;for(W=ma.length;C<W;C++){$b=ma[C];P=Wa[$b];R=bc[Ra].vertices[P.a];S=bc[Ra].vertices[P.b];T=bc[Ra].vertices[P.c];Ma=Uc[Ra];Ma[ha]=R.x;Ma[ha+1]=R.y;Ma[ha+2]=R.z;Ma[ha+3]=S.x;Ma[ha+
4]=S.y;Ma[ha+5]=S.z;Ma[ha+6]=T.x;Ma[ha+7]=T.y;Ma[ha+8]=T.z;if(gb.morphNormals){if(Fc){Rb=Hc[Ra].vertexNormals[$b];Cb=Rb.a;Db=Rb.b;Eb=Rb.c}else Eb=Db=Cb=Hc[Ra].faceNormals[$b];Na=Vc[Ra];Na[ha]=Cb.x;Na[ha+1]=Cb.y;Na[ha+2]=Cb.z;Na[ha+3]=Db.x;Na[ha+4]=Db.y;Na[ha+5]=Db.z;Na[ha+6]=Eb.x;Na[ha+7]=Eb.y;Na[ha+8]=Eb.z}ha=ha+9}C=0;for(W=na.length;C<W;C++){$b=na[C];P=Wa[$b];R=bc[Ra].vertices[P.a];S=bc[Ra].vertices[P.b];T=bc[Ra].vertices[P.c];ka=bc[Ra].vertices[P.d];Ma=Uc[Ra];Ma[ha]=R.x;Ma[ha+1]=R.y;Ma[ha+2]=R.z;
Ma[ha+3]=S.x;Ma[ha+4]=S.y;Ma[ha+5]=S.z;Ma[ha+6]=T.x;Ma[ha+7]=T.y;Ma[ha+8]=T.z;Ma[ha+9]=ka.x;Ma[ha+10]=ka.y;Ma[ha+11]=ka.z;if(gb.morphNormals){if(Fc){Rb=Hc[Ra].vertexNormals[$b];Cb=Rb.a;Db=Rb.b;Eb=Rb.c;tc=Rb.d}else tc=Eb=Db=Cb=Hc[Ra].faceNormals[$b];Na=Vc[Ra];Na[ha]=Cb.x;Na[ha+1]=Cb.y;Na[ha+2]=Cb.z;Na[ha+3]=Db.x;Na[ha+4]=Db.y;Na[ha+5]=Db.z;Na[ha+6]=Eb.x;Na[ha+7]=Eb.y;Na[ha+8]=Eb.z;Na[ha+9]=tc.x;Na[ha+10]=tc.y;Na[ha+11]=tc.z}ha=ha+12}k.bindBuffer(k.ARRAY_BUFFER,la.__webglMorphTargetsBuffers[Ra]);k.bufferData(k.ARRAY_BUFFER,
Uc[Ra],mb);if(gb.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,la.__webglMorphNormalsBuffers[Ra]);k.bufferData(k.ARRAY_BUFFER,Vc[Ra],mb)}}}if(ac.length){C=0;for(W=ma.length;C<W;C++){P=Wa[ma[C]];Ib=ac[P.a];Jb=ac[P.b];Kb=ac[P.c];Aa[aa]=Ib.x;Aa[aa+1]=Ib.y;Aa[aa+2]=Ib.z;Aa[aa+3]=Ib.w;Aa[aa+4]=Jb.x;Aa[aa+5]=Jb.y;Aa[aa+6]=Jb.z;Aa[aa+7]=Jb.w;Aa[aa+8]=Kb.x;Aa[aa+9]=Kb.y;Aa[aa+10]=Kb.z;Aa[aa+11]=Kb.w;Lb=hc[P.a];Mb=hc[P.b];Nb=hc[P.c];za[aa]=Lb.x;za[aa+1]=Lb.y;za[aa+2]=Lb.z;za[aa+3]=Lb.w;za[aa+4]=Mb.x;za[aa+5]=
Mb.y;za[aa+6]=Mb.z;za[aa+7]=Mb.w;za[aa+8]=Nb.x;za[aa+9]=Nb.y;za[aa+10]=Nb.z;za[aa+11]=Nb.w;aa=aa+12}C=0;for(W=na.length;C<W;C++){P=Wa[na[C]];Ib=ac[P.a];Jb=ac[P.b];Kb=ac[P.c];vc=ac[P.d];Aa[aa]=Ib.x;Aa[aa+1]=Ib.y;Aa[aa+2]=Ib.z;Aa[aa+3]=Ib.w;Aa[aa+4]=Jb.x;Aa[aa+5]=Jb.y;Aa[aa+6]=Jb.z;Aa[aa+7]=Jb.w;Aa[aa+8]=Kb.x;Aa[aa+9]=Kb.y;Aa[aa+10]=Kb.z;Aa[aa+11]=Kb.w;Aa[aa+12]=vc.x;Aa[aa+13]=vc.y;Aa[aa+14]=vc.z;Aa[aa+15]=vc.w;Lb=hc[P.a];Mb=hc[P.b];Nb=hc[P.c];wc=hc[P.d];za[aa]=Lb.x;za[aa+1]=Lb.y;za[aa+2]=Lb.z;za[aa+
3]=Lb.w;za[aa+4]=Mb.x;za[aa+5]=Mb.y;za[aa+6]=Mb.z;za[aa+7]=Mb.w;za[aa+8]=Nb.x;za[aa+9]=Nb.y;za[aa+10]=Nb.z;za[aa+11]=Nb.w;za[aa+12]=wc.x;za[aa+13]=wc.y;za[aa+14]=wc.z;za[aa+15]=wc.w;aa=aa+16}if(aa>0){k.bindBuffer(k.ARRAY_BUFFER,la.__webglSkinIndicesBuffer);k.bufferData(k.ARRAY_BUFFER,za,mb);k.bindBuffer(k.ARRAY_BUFFER,la.__webglSkinWeightsBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,mb)}}if(hd&&ec){C=0;for(W=ma.length;C<W;C++){P=Wa[ma[C]];vb=P.vertexColors;Gc=P.color;if(vb.length===3&&ec===THREE.VertexColors){Fb=
vb[0];Gb=vb[1];Hb=vb[2]}else Hb=Gb=Fb=Gc;Ta[Ka]=Fb.r;Ta[Ka+1]=Fb.g;Ta[Ka+2]=Fb.b;Ta[Ka+3]=Gb.r;Ta[Ka+4]=Gb.g;Ta[Ka+5]=Gb.b;Ta[Ka+6]=Hb.r;Ta[Ka+7]=Hb.g;Ta[Ka+8]=Hb.b;Ka=Ka+9}C=0;for(W=na.length;C<W;C++){P=Wa[na[C]];vb=P.vertexColors;Gc=P.color;if(vb.length===4&&ec===THREE.VertexColors){Fb=vb[0];Gb=vb[1];Hb=vb[2];uc=vb[3]}else uc=Hb=Gb=Fb=Gc;Ta[Ka]=Fb.r;Ta[Ka+1]=Fb.g;Ta[Ka+2]=Fb.b;Ta[Ka+3]=Gb.r;Ta[Ka+4]=Gb.g;Ta[Ka+5]=Gb.b;Ta[Ka+6]=Hb.r;Ta[Ka+7]=Hb.g;Ta[Ka+8]=Hb.b;Ta[Ka+9]=uc.r;Ta[Ka+10]=uc.g;Ta[Ka+
...
ib[Za+7]=Ha+3;Za=Za+8;Ha=Ha+4}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,la.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Ob,mb);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,la.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,ib,mb)}if(Wc){qa=0;for(qc=Wc.length;qa<qc;qa++){x=Wc[qa];if(x.__original.needsUpdate){y=0;if(x.size===1)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(W=ma.length;C<W;C++){P=Wa[ma[C]];x.array[y]=x.value[P.a];x.array[y+1]=x.value[P.b];x.array[y+2]=x.value[P.c];y=y+3}C=
0;for(W=na.length;C<W;C++){P=Wa[na[C]];x.array[y]=x.value[P.a];x.array[y+1]=x.value[P.b];x.array[y+2]=x.value[P.c];x.array[y+3]=x.value[P.d];y=y+4}}else{if(x.boundTo==="faces"){C=0;for(W=ma.length;C<W;C++){ra=x.value[ma[C]];x.array[y]=ra;x.array[y+1]=ra;x.array[y+2]=ra;y=y+3}C=0;for(W=na.length;C<W;C++){ra=x.value[na[C]];x.array[y]=ra;x.array[y+1]=ra;x.array[y+2]=ra;x.array[y+3]=ra;y=y+4}}}else if(x.size===2)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(W=ma.length;C<W;C++){P=Wa[ma[C]];R=
x.value[P.a];S=x.value[P.b];T=x.value[P.c];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=S.x;x.array[y+3]=S.y;x.array[y+4]=T.x;x.array[y+5]=T.y;y=y+6}C=0;for(W=na.length;C<W;C++){P=Wa[na[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];ka=x.value[P.d];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=S.x;x.array[y+3]=S.y;x.array[y+4]=T.x;x.array[y+5]=T.y;x.array[y+6]=ka.x;x.array[y+7]=ka.y;y=y+8}}else{if(x.boundTo==="faces"){C=0;for(W=ma.length;C<W;C++){T=S=R=ra=x.value[ma[C]];x.array[y]=R.x;x.array[y+
1]=R.y;x.array[y+2]=S.x;x.array[y+3]=S.y;x.array[y+4]=T.x;x.array[y+5]=T.y;y=y+6}C=0;for(W=na.length;C<W;C++){ka=T=S=R=ra=x.value[na[C]];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=S.x;x.array[y+3]=S.y;x.array[y+4]=T.x;x.array[y+5]=T.y;x.array[y+6]=ka.x;x.array[y+7]=ka.y;y=y+8}}}else if(x.size===3){var Z;Z=x.type==="c"?["r","g","b"]:["x","y","z"];if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(W=ma.length;C<W;C++){P=Wa[ma[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];x.array[y]=R[Z[0]];
x.array[y+1]=R[Z[1]];x.array[y+2]=R[Z[2]];x.array[y+3]=S[Z[0]];x.array[y+4]=S[Z[1]];x.array[y+5]=S[Z[2]];x.array[y+6]=T[Z[0]];x.array[y+7]=T[Z[1]];x.array[y+8]=T[Z[2]];y=y+9}C=0;for(W=na.length;C<W;C++){P=Wa[na[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];ka=x.value[P.d];x.array[y]=R[Z[0]];x.array[y+1]=R[Z[1]];x.array[y+2]=R[Z[2]];x.array[y+3]=S[Z[0]];x.array[y+4]=S[Z[1]];x.array[y+5]=S[Z[2]];x.array[y+6]=T[Z[0]];x.array[y+7]=T[Z[1]];x.array[y+8]=T[Z[2]];x.array[y+9]=ka[Z[0]];x.array[y+10]=ka[Z[1]];
x.array[y+11]=ka[Z[2]];y=y+12}}else if(x.boundTo==="faces"){C=0;for(W=ma.length;C<W;C++){T=S=R=ra=x.value[ma[C]];x.array[y]=R[Z[0]];x.array[y+1]=R[Z[1]];x.array[y+2]=R[Z[2]];x.array[y+3]=S[Z[0]];x.array[y+4]=S[Z[1]];x.array[y+5]=S[Z[2]];x.array[y+6]=T[Z[0]];x.array[y+7]=T[Z[1]];x.array[y+8]=T[Z[2]];y=y+9}C=0;for(W=na.length;C<W;C++){ka=T=S=R=ra=x.value[na[C]];x.array[y]=R[Z[0]];x.array[y+1]=R[Z[1]];x.array[y+2]=R[Z[2]];x.array[y+3]=S[Z[0]];x.array[y+4]=S[Z[1]];x.array[y+5]=S[Z[2]];x.array[y+6]=T[Z[0]];
x.array[y+7]=T[Z[1]];x.array[y+8]=T[Z[2]];x.array[y+9]=ka[Z[0]];x.array[y+10]=ka[Z[1]];x.array[y+11]=ka[Z[2]];y=y+12}}else if(x.boundTo==="faceVertices"){C=0;for(W=ma.length;C<W;C++){ra=x.value[ma[C]];R=ra[0];S=ra[1];T=ra[2];x.array[y]=R[Z[0]];x.array[y+1]=R[Z[1]];x.array[y+2]=R[Z[2]];x.array[y+3]=S[Z[0]];x.array[y+4]=S[Z[1]];x.array[y+5]=S[Z[2]];x.array[y+6]=T[Z[0]];x.array[y+7]=T[Z[1]];x.array[y+8]=T[Z[2]];y=y+9}C=0;for(W=na.length;C<W;C++){ra=x.value[na[C]];R=ra[0];S=ra[1];T=ra[2];ka=ra[3];x.array[y]=
R[Z[0]];x.array[y+1]=R[Z[1]];x.array[y+2]=R[Z[2]];x.array[y+3]=S[Z[0]];x.array[y+4]=S[Z[1]];x.array[y+5]=S[Z[2]];x.array[y+6]=T[Z[0]];x.array[y+7]=T[Z[1]];x.array[y+8]=T[Z[2]];x.array[y+9]=ka[Z[0]];x.array[y+10]=ka[Z[1]];x.array[y+11]=ka[Z[2]];y=y+12}}}else if(x.size===4)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(W=ma.length;C<W;C++){P=Wa[ma[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=
S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;y=y+12}C=0;for(W=na.length;C<W;C++){P=Wa[na[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];ka=x.value[P.d];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;x.array[y+12]=ka.x;x.array[y+13]=ka.y;x.array[y+14]=ka.z;x.array[y+15]=ka.w;y=y+
16}}else if(x.boundTo==="faces"){C=0;for(W=ma.length;C<W;C++){T=S=R=ra=x.value[ma[C]];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;y=y+12}C=0;for(W=na.length;C<W;C++){ka=T=S=R=ra=x.value[na[C]];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;
x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;x.array[y+12]=ka.x;x.array[y+13]=ka.y;x.array[y+14]=ka.z;x.array[y+15]=ka.w;y=y+16}}else if(x.boundTo==="faceVertices"){C=0;for(W=ma.length;C<W;C++){ra=x.value[ma[C]];R=ra[0];S=ra[1];T=ra[2];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;y=y+12}C=0;for(W=na.length;C<W;C++){ra=x.value[na[C]];
R=ra[0];S=ra[1];T=ra[2];ka=ra[3];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;x.array[y+12]=ka.x;x.array[y+13]=ka.y;x.array[y+14]=ka.z;x.array[y+15]=ka.w;y=y+16}}k.bindBuffer(k.ARRAY_BUFFER,x.buffer);k.bufferData(k.ARRAY_BUFFER,x.array,mb)}}}if(yb){delete la.__inittedArrays;delete la.__colorArray;delete la.__normalArray;delete la.__tangentArray;
delete la.__uvArray;delete la.__uv2Array;delete la.__faceArray;delete la.__vertexArray;delete la.__lineArray;delete la.__skinIndexArray;delete la.__skinWeightArray}}}}ea.verticesNeedUpdate=false;ea.morphTargetsNeedUpdate=false;ea.elementsNeedUpdate=false;ea.uvsNeedUpdate=false;ea.normalsNeedUpdate=false;ea.colorsNeedUpdate=false;ea.tangentsNeedUpdate=false;cb.attributes&&o(cb)}else if(ub instanceof THREE.Ribbon){if(ea.verticesNeedUpdate||ea.colorsNeedUpdate){var cc=ea,bd=k.DYNAMIC_DRAW,zc=void 0,
...
Lc,bd)}}ea.verticesNeedUpdate=false;ea.colorsNeedUpdate=false}else if(ub instanceof THREE.Line){cb=c(ub,bb);ab=cb.attributes&&p(cb);if(ea.verticesNeedUpdate||ea.colorsNeedUpdate||ab){var Ub=ea,Zc=k.DYNAMIC_DRAW,Bc=void 0,Cc=void 0,Mc=void 0,Ba=void 0,Nc=void 0,ed=Ub.vertices,fd=Ub.colors,md=ed.length,nd=fd.length,Oc=Ub.__vertexArray,Pc=Ub.__colorArray,od=Ub.colorsNeedUpdate,$c=Ub.__webglCustomAttributesList,Qc=void 0,gd=void 0,Ua=void 0,pc=void 0,eb=void 0,wa=void 0;if(Ub.verticesNeedUpdate){for(Bc=
...
Ba+4}k.bindBuffer(k.ARRAY_BUFFER,wa.buffer);k.bufferData(k.ARRAY_BUFFER,wa.array,Zc)}}}}ea.verticesNeedUpdate=false;ea.colorsNeedUpdate=false;cb.attributes&&o(cb)}else if(ub instanceof THREE.ParticleSystem)if(ea instanceof THREE.BufferGeometry){(ea.verticesNeedUpdate||ea.colorsNeedUpdate)&&h(ea,k.DYNAMIC_DRAW,!ea.dynamic);ea.verticesNeedUpdate=false;ea.colorsNeedUpdate=false}else{cb=c(ub,bb);ab=cb.attributes&&p(cb);(ea.verticesNeedUpdate||ea.colorsNeedUpdate||ub.sortParticles||ab)&&g(ea,k.DYNAMIC_DRAW,
ub);ea.verticesNeedUpdate=false;ea.colorsNeedUpdate=false;cb.attributes&&o(cb)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,m,n;a instanceof THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var o=
THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,q;p=h=f=e=o=0;for(g=b.length;p<g;p++){q=b[p];if(!q.onlyShadow){q instanceof THREE.DirectionalLight&&h++;q instanceof THREE.PointLight&&f++;q instanceof THREE.SpotLight&&e++;q instanceof THREE.HemisphereLight&&o++}}if(f+e+h+o<=ba){p=h;g=e}else{p=Math.ceil(ba*h/(f+h));g=f=ba-p;o=p}e=p;h=o;o=m=0;for(p=b.length;o<p;o++){q=b[o];if(q.castShadow){q instanceof THREE.SpotLight&&
...
0;s<c.maxMorphTargets;s++)d.push("morphTarget"+s);for(s=0;s<c.maxMorphNormals;s++)d.push("morphNormal"+s);for(r in b)d.push(r);r=d;s=0;for(c=r.length;s<c;s++){d=r[s];t.attributes[d]=k.getAttribLocation(t,d)}t.id=ta++;fa.push({program:t,code:n,usedTimes:1});Q.info.memory.programs=fa.length;r=t}a.program=r;r=a.program.attributes;r.position>=0&&k.enableVertexAttribArray(r.position);r.color>=0&&k.enableVertexAttribArray(r.color);r.normal>=0&&k.enableVertexAttribArray(r.normal);r.tangent>=0&&k.enableVertexAttribArray(r.tangent);
...
ja=c;pb=d}}else pb=ja=Xa=null};this.setTexture=function(a,b){if(a.needsUpdate){if(!a.__webglInit){a.__webglInit=true;a.__webglTexture=k.createTexture();Q.info.memory.textures++}k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=(c.width&c.width-1)===0&&(c.height&c.height-1)===0,e=E(a.format),f=E(a.type);M(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var f=
...
if(a&&!a.__webglFramebuffer){if(a.depthBuffer===void 0)a.depthBuffer=true;if(a.stencilBuffer===void 0)a.stencilBuffer=true;a.__webglTexture=k.createTexture();var c=(a.width&a.width-1)===0&&(a.height&a.height-1)===0,d=E(a.format),e=E(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);M(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;f<6;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+
f,0,d,a.width,a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);G(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);M(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null);d=
k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);G(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;e=d=0}else{b=null;c=Ga;a=$a;d=xa;e=xb}if(b!==ga){k.bindFramebuffer(k.FRAMEBUFFER,
...
THREE.GeometryUtils={merge:function(a,b){for(var c,d,f=a.vertices.length,e=b instanceof THREE.Mesh?b.geometry:b,g=a.vertices,h=e.vertices,i=a.faces,l=e.faces,j=a.faceVertexUvs[0],n=e.faceVertexUvs[0],m={},q=0;q<a.materials.length;q++)m[a.materials[q].id]=q;if(b instanceof THREE.Mesh){b.matrixAutoUpdate&&b.updateMatrix();c=b.matrix;d=new THREE.Matrix4;d.extractRotation(c,b.scale)}for(var q=0,p=h.length;q<p;q++){var o=h[q].clone();c&&c.multiplyVector3(o);g.push(o)}q=0;for(p=l.length;q<p;q++){var g=
l[q],r,s,u=g.vertexNormals,w=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+f,g.b+f,g.c+f):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+f,g.b+f,g.c+f,g.d+f));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(o=u.length;h<o;h++){s=u[h].clone();d&&d.multiplyVector3(s);r.vertexNormals.push(s)}r.color.copy(g.color);h=0;for(o=w.length;h<o;h++){s=w[h];r.vertexColors.push(s.clone())}if(g.materialIndex!==void 0){h=e.materials[g.materialIndex];o=h.id;w=m[o];if(w===void 0){w=
a.materials.length;m[o]=w;a.materials.push(h)}r.materialIndex=w}r.centroid.copy(g.centroid);c&&c.multiplyVector3(r.centroid);i.push(r)}q=0;for(p=n.length;q<p;q++){c=n[q];d=[];h=0;for(o=c.length;h<o;h++)d.push(new THREE.UV(c[h].u,c[h].v));j.push(d)}},clone:function(a){var b=new THREE.Geometry,c,d=a.vertices,f=a.faces,e=a.faceVertexUvs[0];if(a.materials)b.materials=a.materials.slice();a=0;for(c=d.length;a<c;a++)b.vertices.push(d[a].clone());a=0;for(c=f.length;a<c;a++)b.faces.push(f[a].clone());a=0;
...
e.a;h=e.b;i=e.c;g=a.vertices[g];h=a.vertices[h];i=a.vertices[i];b.push(g.clone());b.push(h.clone());b.push(i.clone());e.a=f;e.b=f+1;e.c=f+2}}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,f,e,g,h,i,l,j,n,m,q,p,o,r,s,u,w,t,B=[],v=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)v[c]=[];c=0;for(d=a.faces.length;c<d;c++){f=a.faces[c];if(f instanceof THREE.Face3){e=f.a;g=f.b;h=f.c;l=a.vertices[e];j=a.vertices[g];n=a.vertices[h];q=l.distanceTo(j);p=j.distanceTo(n);m=l.distanceTo(n);if(q>
b||p>b||m>b){i=a.vertices.length;w=f.clone();t=f.clone();if(q>=p&&q>=m){l=l.clone();l.lerpSelf(j,0.5);w.a=e;w.b=i;w.c=h;t.a=i;t.b=g;t.c=h;if(f.vertexNormals.length===3){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);w.vertexNormals[1].copy(e);t.vertexNormals[0].copy(e)}if(f.vertexColors.length===3){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[1],0.5);w.vertexColors[1].copy(e);t.vertexColors[0].copy(e)}f=0}else if(p>=q&&p>=m){l=j.clone();l.lerpSelf(n,0.5);w.a=e;w.b=g;w.c=
i;t.a=i;t.b=h;t.c=e;if(f.vertexNormals.length===3){e=f.vertexNormals[1].clone();e.lerpSelf(f.vertexNormals[2],0.5);w.vertexNormals[2].copy(e);t.vertexNormals[0].copy(e);t.vertexNormals[1].copy(f.vertexNormals[2]);t.vertexNormals[2].copy(f.vertexNormals[0])}if(f.vertexColors.length===3){e=f.vertexColors[1].clone();e.lerpSelf(f.vertexColors[2],0.5);w.vertexColors[2].copy(e);t.vertexColors[0].copy(e);t.vertexColors[1].copy(f.vertexColors[2]);t.vertexColors[2].copy(f.vertexColors[0])}f=1}else{l=l.clone();
l.lerpSelf(n,0.5);w.a=e;w.b=g;w.c=i;t.a=i;t.b=g;t.c=h;if(f.vertexNormals.length===3){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[2],0.5);w.vertexNormals[2].copy(e);t.vertexNormals[0].copy(e)}if(f.vertexColors.length===3){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[2],0.5);w.vertexColors[2].copy(e);t.vertexColors[0].copy(e)}f=2}B.push(w,t);a.vertices.push(l);e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){l=a.faceVertexUvs[e][c];t=l[0];h=l[1];w=l[2];if(f===
0){j=t.clone();j.lerpSelf(h,0.5);l=[t.clone(),j.clone(),w.clone()];h=[j.clone(),h.clone(),w.clone()]}else if(f===1){j=h.clone();j.lerpSelf(w,0.5);l=[t.clone(),h.clone(),j.clone()];h=[j.clone(),w.clone(),t.clone()]}else{j=t.clone();j.lerpSelf(w,0.5);l=[t.clone(),h.clone(),j.clone()];h=[j.clone(),h.clone(),w.clone()]}v[e].push(l,h)}}else{B.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)v[e].push(a.faceVertexUvs[e][c])}}else{e=f.a;g=f.b;h=f.c;i=f.d;l=a.vertices[e];j=a.vertices[g];n=a.vertices[h];m=
a.vertices[i];q=l.distanceTo(j);p=j.distanceTo(n);o=n.distanceTo(m);r=l.distanceTo(m);if(q>b||p>b||o>b||r>b){s=a.vertices.length;u=a.vertices.length+1;w=f.clone();t=f.clone();if(q>=p&&q>=o&&q>=r||o>=p&&o>=q&&o>=r){q=l.clone();q.lerpSelf(j,0.5);j=n.clone();j.lerpSelf(m,0.5);w.a=e;w.b=s;w.c=u;w.d=i;t.a=s;t.b=g;t.c=h;t.d=u;if(f.vertexNormals.length===4){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);g=f.vertexNormals[2].clone();g.lerpSelf(f.vertexNormals[3],0.5);w.vertexNormals[1].copy(e);
w.vertexNormals[2].copy(g);t.vertexNormals[0].copy(e);t.vertexNormals[3].copy(g)}if(f.vertexColors.length===4){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[1],0.5);g=f.vertexColors[2].clone();g.lerpSelf(f.vertexColors[3],0.5);w.vertexColors[1].copy(e);w.vertexColors[2].copy(g);t.vertexColors[0].copy(e);t.vertexColors[3].copy(g)}f=0}else{q=j.clone();q.lerpSelf(n,0.5);j=m.clone();j.lerpSelf(l,0.5);w.a=e;w.b=g;w.c=s;w.d=u;t.a=u;t.b=s;t.c=h;t.d=i;if(f.vertexNormals.length===4){e=f.vertexNormals[1].clone();
e.lerpSelf(f.vertexNormals[2],0.5);g=f.vertexNormals[3].clone();g.lerpSelf(f.vertexNormals[0],0.5);w.vertexNormals[2].copy(e);w.vertexNormals[3].copy(g);t.vertexNormals[0].copy(g);t.vertexNormals[1].copy(e)}if(f.vertexColors.length===4){e=f.vertexColors[1].clone();e.lerpSelf(f.vertexColors[2],0.5);g=f.vertexColors[3].clone();g.lerpSelf(f.vertexColors[0],0.5);w.vertexColors[2].copy(e);w.vertexColors[3].copy(g);t.vertexColors[0].copy(g);t.vertexColors[1].copy(e)}f=1}B.push(w,t);a.vertices.push(q,j);
e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){l=a.faceVertexUvs[e][c];t=l[0];h=l[1];w=l[2];l=l[3];if(f===0){j=t.clone();j.lerpSelf(h,0.5);n=w.clone();n.lerpSelf(l,0.5);t=[t.clone(),j.clone(),n.clone(),l.clone()];h=[j.clone(),h.clone(),w.clone(),n.clone()]}else{j=h.clone();j.lerpSelf(w,0.5);n=l.clone();n.lerpSelf(t,0.5);t=[t.clone(),h.clone(),j.clone(),n.clone()];h=[n.clone(),j.clone(),w.clone(),l.clone()]}v[e].push(t,h)}}else{B.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)v[e].push(a.faceVertexUvs[e][c])}}}a.faces=
...
s=[0,0,h[(n*d+j)*4]/255*b];r.push([-1,0,h[(n*d+p)*4]/255*b]);r.push([-1,-1,h[(m*d+p)*4]/255*b]);r.push([0,-1,h[(m*d+j)*4]/255*b]);r.push([1,-1,h[(m*d+o)*4]/255*b]);r.push([1,0,h[(n*d+o)*4]/255*b]);r.push([1,1,h[(q*d+o)*4]/255*b]);r.push([0,1,h[(q*d+j)*4]/255*b]);r.push([-1,1,h[(q*d+p)*4]/255*b]);m=[];p=r.length;for(q=0;q<p;q++){var o=r[q],u=r[(q+1)%p],o=[o[0]-s[0],o[1]-s[1],o[2]-s[2]],u=[u[0]-s[0],u[1]-s[1],u[2]-s[2]];m.push(c([o[1]*u[2]-o[2]*u[1],o[2]*u[0]-o[0]*u[2],o[0]*u[1]-o[1]*u[0]]))}r=[0,0,
0];for(q=0;q<m.length;q++){r[0]=r[0]+m[q][0];r[1]=r[1]+m[q][1];r[2]=r[2]+m[q][2]}r[0]=r[0]/m.length;r[1]=r[1]/m.length;r[2]=r[2]/m.length;s=(n*d+j)*4;l[s]=(r[0]+1)/2*255|0;l[s+1]=(r[1]+1)/2*255|0;l[s+2]=r[2]*255|0;l[s+3]=255}g.putImageData(i,0,0);return e},generateDataTexture:function(a,b,c){for(var d=a*b,f=new Uint8Array(3*d),e=Math.floor(c.r*255),g=Math.floor(c.g*255),c=Math.floor(c.b*255),h=0;h<d;h++){f[h*3]=e;f[h*3+1]=g;f[h*3+2]=c}a=new THREE.DataTexture(f,a,b,THREE.RGBFormat);a.needsUpdate=true;
return a}};
...
(function(a){var b=function(a){for(var b=a.length,f=0,e=b-1,g=0;g<b;e=g++)f=f+(a[e].x*a[g].y-a[g].x*a[e].y);return f*0.5};a.Triangulate=function(a,d){var f=a.length;if(f<3)return null;var e=[],g=[],h=[],i,l,j;if(b(a)>0)for(l=0;l<f;l++)g[l]=l;else for(l=0;l<f;l++)g[l]=f-1-l;var n=2*f;for(l=f-1;f>2;){if(n--<=0){console.log("Warning, unable to triangulate polygon!");break}i=l;f<=i&&(i=0);l=i+1;f<=l&&(l=0);j=l+1;f<=j&&(j=0);var m;a:{m=a;var q=i,p=l,o=j,r=f,s=g,u=void 0,w=void 0,t=void 0,B=void 0,v=void 0,
A=void 0,D=void 0,z=void 0,M=void 0,w=m[s[q]].x,t=m[s[q]].y,B=m[s[p]].x,v=m[s[p]].y,A=m[s[o]].x,D=m[s[o]].y;if(1E-10>(B-w)*(D-t)-(v-t)*(A-w))m=false;else{for(u=0;u<r;u++)if(!(u==q||u==p||u==o)){var z=m[s[u]].x,M=m[s[u]].y,G=void 0,H=void 0,E=void 0,O=void 0,F=void 0,J=void 0,I=void 0,K=void 0,V=void 0,Y=void 0,$=void 0,L=void 0,G=E=F=void 0,G=A-B,H=D-v,E=w-A,O=t-D,F=B-w,J=v-t,I=z-w,K=M-t,V=z-B,Y=M-v,$=z-A,L=M-D,G=G*Y-H*V,F=F*K-J*I,E=E*L-O*$;if(G>=0&&E>=0&&F>=0){m=false;break a}}m=true}}if(m){e.push([a[g[i]],
...
THREE.Shape.Utils={removeHoles:function(a,b){var c=a.concat(),d=c.concat(),f,e,g,h,i,l,j,n,m,q,p=[];for(i=0;i<b.length;i++){l=b[i];Array.prototype.push.apply(d,l);e=Number.POSITIVE_INFINITY;for(f=0;f<l.length;f++){m=l[f];q=[];for(n=0;n<c.length;n++){j=c[n];j=m.distanceToSquared(j);q.push(j);if(j<e){e=j;g=f;h=n}}}f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:l.length-1;var o=[l[g],c[h],c[f]];n=THREE.FontUtils.Triangulate.area(o);var r=[l[g],l[e],c[h]];m=THREE.FontUtils.Triangulate.area(r);q=h;j=g;h=h+1;g=g+
-1;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+l.length);g=g%l.length;f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:l.length-1;o=[l[g],c[h],c[f]];o=THREE.FontUtils.Triangulate.area(o);r=[l[g],l[e],c[h]];r=THREE.FontUtils.Triangulate.area(r);if(n+m>o+r){h=q;g=j;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+l.length);g=g%l.length;f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:l.length-1}n=c.slice(0,h);m=c.slice(h);q=l.slice(g);j=l.slice(0,g);e=[l[g],l[e],c[h]];p.push([l[g],c[h],c[f]]);p.push(e);c=n.concat(q).concat(j).concat(m)}return{shape:c,
...
THREE.RollControls=function(a,b){this.object=a;this.domElement=b!==void 0?b:document;this.mouseLook=true;this.autoForward=false;this.rollSpeed=this.movementSpeed=this.lookSpeed=1;this.constrainVertical=[-0.9,0.9];this.object.matrixAutoUpdate=false;this.forward=new THREE.Vector3(0,0,1);this.roll=0;var c=new THREE.Vector3,d=new THREE.Vector3,f=new THREE.Vector3,e=new THREE.Matrix4,g=false,h=1,i=0,l=0,j=0,n=0,m=0,q=0,p=0;this.handleResize=function(){q=window.innerWidth/2;p=window.innerHeight/2};this.update=
...
0){d.dispatchEvent(p);f.copy(d.object.position)}};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},false);this.domElement.addEventListener("mousemove",function(a){if(d.enabled){if(e){i=l=d.getMouseProjectionOnBall(a.clientX,a.clientY);j=n=d.getMouseOnScreen(a.clientX,a.clientY);m=q=d.getMouseOnScreen(a.clientX,a.clientY);e=false}g!==-1&&(g===0&&!d.noRotate?l=d.getMouseProjectionOnBall(a.clientX,a.clientY):g===1&&!d.noZoom?n=d.getMouseOnScreen(a.clientX,a.clientY):g===
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function i(a,b,c,g,h,i,j,m){var n,o=d||1,p=f||1,q=h/2,r=i/2,s=l.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=e||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=e||1}var u=o+1,w=p+1,Y=h/o,$=i/p,L=new THREE.Vector3;L[n]=j>0?1:-1;for(h=0;h<w;h++)for(i=0;i<u;i++){var ba=new THREE.Vector3;ba[a]=(i*Y-q)*c;ba[b]=(h*$-r)*g;ba[n]=j;l.vertices.push(ba)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
u*h+s,i+u*(h+1)+s,i+1+u*(h+1)+s,i+1+u*h+s);a.normal.copy(L);a.vertexNormals.push(L.clone(),L.clone(),L.clone(),L.clone());a.materialIndex=m;l.faces.push(a);l.faceVertexUvs[0].push([new THREE.UV(i/o,1-h/p),new THREE.UV(i/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-h/p)])}}THREE.Geometry.call(this);var l=this,j=a/2,n=b/2,m=c/2,q,p,o,r,s,u;if(g!==void 0){if(g instanceof Array)this.materials=g;else{this.materials=[];for(q=0;q<6;q++)this.materials.push(g)}q=0;r=1;p=2;s=3;o=4;u=
5}else this.materials=[];this.sides={px:true,nx:true,py:true,ny:true,pz:true,nz:true};if(h!=void 0)for(var w in h)this.sides[w]!==void 0&&(this.sides[w]=h[w]);this.sides.px&&i("z","y",-1,-1,c,b,j,q);this.sides.nx&&i("z","y",1,-1,c,b,-j,r);this.sides.py&&i("x","z",1,1,a,c,n,p);this.sides.ny&&i("x","z",1,-1,a,c,-n,s);this.sides.pz&&i("x","y",1,-1,a,b,m,o);this.sides.nz&&i("x","y",-1,-1,a,b,-m,u);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.CylinderGeometry=function(a,b,c,d,f,e){THREE.Geometry.call(this);var a=a!==void 0?a:20,b=b!==void 0?b:20,c=c!==void 0?c:100,g=c/2,d=d||8,f=f||1,h,i,l=[],j=[];for(i=0;i<=f;i++){var n=[],m=[],q=i/f,p=q*(b-a)+a;for(h=0;h<=d;h++){var o=h/d,r=new THREE.Vector3;r.x=p*Math.sin(o*Math.PI*2);r.y=-q*c+g;r.z=p*Math.cos(o*Math.PI*2);this.vertices.push(r);n.push(this.vertices.length-1);m.push(new THREE.UV(o,1-q))}l.push(n);j.push(m)}c=(b-a)/c;for(h=0;h<d;h++){if(a!==0){n=this.vertices[l[0][h]].clone();m=
this.vertices[l[0][h+1]].clone()}else{n=this.vertices[l[1][h]].clone();m=this.vertices[l[1][h+1]].clone()}n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<f;i++){var q=l[i][h],p=l[i+1][h],o=l[i+1][h+1],r=l[i][h+1],s=n.clone(),u=n.clone(),w=m.clone(),t=m.clone(),B=j[i][h].clone(),v=j[i+1][h].clone(),A=j[i+1][h+1].clone(),D=j[i][h+1].clone();this.faces.push(new THREE.Face4(q,p,o,r,[s,u,w,t]));this.faceVertexUvs[0].push([B,v,A,D])}}if(!e&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){q=l[0][h];p=l[0][h+1];o=this.vertices.length-1;s=new THREE.Vector3(0,1,0);u=new THREE.Vector3(0,1,0);w=new THREE.Vector3(0,1,0);B=j[0][h].clone();v=j[0][h+1].clone();A=new THREE.UV(v.u,0);this.faces.push(new THREE.Face3(q,p,o,[s,u,w]));this.faceVertexUvs[0].push([B,v,A])}}if(!e&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){q=l[i][h+1];p=l[i][h];o=this.vertices.length-1;s=new THREE.Vector3(0,-1,0);u=new THREE.Vector3(0,
-1,0);w=new THREE.Vector3(0,-1,0);B=j[i][h+1].clone();v=j[i][h].clone();A=new THREE.UV(v.u,1);this.faces.push(new THREE.Face3(q,p,o,[s,u,w]));this.faceVertexUvs[0].push([B,v,A])}}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
c.length-1);for(var g=0,h=m+j*2,g=0;g<h;g++){var i=V*g,l=V*(g+1),n=d+e+i,i=d+f+i,o=d+f+l,l=d+e+l,p=c,q=g,r=h,t=e,v=f,n=n+G,i=i+G,o=o+G,l=l+G;M.faces.push(new THREE.Face4(n,i,o,l,null,null,s));n=u.generateSideWallUV(M,a,p,b,n,i,o,l,q,r,t,v);M.faceVertexUvs[0].push(n)}}}function e(a,b,c){M.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+G;d=d+G;e=e+G;M.faces.push(new THREE.Face3(c,d,e,null,null,r));c=f?u.generateBottomUV(M,a,b,c,d,e):u.generateTopUV(M,a,b,c,d,e);M.faceVertexUvs[0].push(c)}
var h=b.amount!==void 0?b.amount:100,i=b.bevelThickness!==void 0?b.bevelThickness:6,l=b.bevelSize!==void 0?b.bevelSize:i-2,j=b.bevelSegments!==void 0?b.bevelSegments:3,n=b.bevelEnabled!==void 0?b.bevelEnabled:true,m=b.steps!==void 0?b.steps:1,q=b.extrudePath,p,o=false,r=b.material,s=b.extrudeMaterial,u=b.UVGenerator!==void 0?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,w,t,B,v;if(q){p=q.getSpacedPoints(m);o=true;n=false;w=b.frames!==void 0?b.frames:new THREE.TubeGeometry.FrenetFrames(q,m,
false);t=new THREE.Vector3;B=new THREE.Vector3;v=new THREE.Vector3}if(!n)l=i=j=0;var A,D,z,M=this,G=this.vertices.length,q=a.extractPoints(),H=q.shape,q=q.holes,E=!THREE.Shape.Utils.isClockWise(H);if(E){H=H.reverse();D=0;for(z=q.length;D<z;D++){A=q[D];THREE.Shape.Utils.isClockWise(A)&&(q[D]=A.reverse())}E=false}var O=THREE.Shape.Utils.triangulateShape(H,q),E=H;D=0;for(z=q.length;D<z;D++){A=q[D];H=H.concat(A)}var F,J,I,K,V=H.length,Y=O.length,$=[],L=0,ba=E.length;F=ba-1;for(J=L+1;L<ba;L++,F++,J++){F===
ba&&(F=0);J===ba&&(J=0);$[L]=d(E[L],E[F],E[J])}var Q=[],fa,ta=$.concat();D=0;for(z=q.length;D<z;D++){A=q[D];fa=[];L=0;ba=A.length;F=ba-1;for(J=L+1;L<ba;L++,F++,J++){F===ba&&(F=0);J===ba&&(J=0);fa[L]=d(A[L],A[F],A[J])}Q.push(fa);ta=ta.concat(fa)}for(F=0;F<j;F++){A=F/j;I=i*(1-A);J=l*Math.sin(A*Math.PI/2);L=0;for(ba=E.length;L<ba;L++){K=c(E[L],$[L],J);e(K.x,K.y,-I)}D=0;for(z=q.length;D<z;D++){A=q[D];fa=Q[D];L=0;for(ba=A.length;L<ba;L++){K=c(A[L],fa[L],J);e(K.x,K.y,-I)}}}J=l;for(L=0;L<V;L++){K=n?c(H[L],
ta[L],J):H[L];if(o){B.copy(w.normals[0]).multiplyScalar(K.x);t.copy(w.binormals[0]).multiplyScalar(K.y);v.copy(p[0]).addSelf(B).addSelf(t);e(v.x,v.y,v.z)}else e(K.x,K.y,0)}for(A=1;A<=m;A++)for(L=0;L<V;L++){K=n?c(H[L],ta[L],J):H[L];if(o){B.copy(w.normals[A]).multiplyScalar(K.x);t.copy(w.binormals[A]).multiplyScalar(K.y);v.copy(p[A]).addSelf(B).addSelf(t);e(v.x,v.y,v.z)}else e(K.x,K.y,h/m*A)}for(F=j-1;F>=0;F--){A=F/j;I=i*(1-A);J=l*Math.sin(A*Math.PI/2);L=0;for(ba=E.length;L<ba;L++){K=c(E[L],$[L],J);
e(K.x,K.y,h+I)}D=0;for(z=q.length;D<z;D++){A=q[D];fa=Q[D];L=0;for(ba=A.length;L<ba;L++){K=c(A[L],fa[L],J);o?e(K.x,K.y+p[m-1].y,p[m-1].x+I):e(K.x,K.y,h+I)}}}if(n){i=V*0;for(L=0;L<Y;L++){h=O[L];g(h[2]+i,h[1]+i,h[0]+i,true)}i=V*(m+j*2);for(L=0;L<Y;L++){h=O[L];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(L=0;L<Y;L++){h=O[L];g(h[2],h[1],h[0],true)}for(L=0;L<Y;L++){h=O[L];g(h[0]+V*m,h[1]+V*m,h[2]+V*m,false)}}h=0;f(E,h);h=h+E.length;D=0;for(z=q.length;D<z;D++){A=q[D];f(A,h);h=h+A.length}};
...
THREE.SphereGeometry=function(a,b,c,d,f,e,g){THREE.Geometry.call(this);var a=a||50,d=d!==void 0?d:0,f=f!==void 0?f:Math.PI*2,e=e!==void 0?e:0,g=g!==void 0?g:Math.PI,b=Math.max(3,Math.floor(b)||8),c=Math.max(2,Math.floor(c)||6),h,i,l=[],j=[];for(i=0;i<=c;i++){var n=[],m=[];for(h=0;h<=b;h++){var q=h/b,p=i/c,o=new THREE.Vector3;o.x=-a*Math.cos(d+q*f)*Math.sin(e+p*g);o.y=a*Math.cos(e+p*g);o.z=a*Math.sin(d+q*f)*Math.sin(e+p*g);this.vertices.push(o);n.push(this.vertices.length-1);m.push(new THREE.UV(q,
1-p))}l.push(n);j.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=l[i][h+1],f=l[i][h],e=l[i+1][h],g=l[i+1][h+1],n=this.vertices[d].clone().normalize(),m=this.vertices[f].clone().normalize(),q=this.vertices[e].clone().normalize(),p=this.vertices[g].clone().normalize(),o=j[i][h+1].clone(),r=j[i][h].clone(),s=j[i+1][h].clone(),u=j[i+1][h+1].clone();if(Math.abs(this.vertices[d].y)==a){this.faces.push(new THREE.Face3(d,e,g,[n,q,p]));this.faceVertexUvs[0].push([o,s,u])}else if(Math.abs(this.vertices[e].y)==
a){this.faces.push(new THREE.Face3(d,f,e,[n,m,q]));this.faceVertexUvs[0].push([o,r,s])}else{this.faces.push(new THREE.Face4(d,f,e,g,[n,m,q,p]));this.faceVertexUvs[0].push([o,r,s,u])}}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:a}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.TubeGeometry=function(a,b,c,d,f,e){THREE.Geometry.call(this);this.path=a;this.segments=b||64;this.radius=c||1;this.segmentsRadius=d||8;this.closed=f||false;if(e)this.debug=new THREE.Object3D;this.grid=[];var g,h,e=this.segments+1,i,l,j,n=new THREE.Vector3,m,q,p,b=new THREE.TubeGeometry.FrenetFrames(a,b,f);m=b.tangents;q=b.normals;p=b.binormals;this.tangents=m;this.normals=q;this.binormals=p;for(b=0;b<e;b++){this.grid[b]=[];d=b/(e-1);j=a.getPointAt(d);d=m[b];g=q[b];h=p[b];if(this.debug){this.debug.add(new THREE.ArrowHelper(d,
...
THREE.ParametricGeometry=function(a,b,c,d){THREE.Geometry.call(this);var f=this.vertices,e=this.faces,g=this.faceVertexUvs[0],d=d===void 0?false:d,h,i,l,j,n=b+1;for(h=0;h<=c;h++){j=h/c;for(i=0;i<=b;i++){l=i/b;l=a(l,j);f.push(l)}}var m,q,p,o;for(h=0;h<c;h++)for(i=0;i<b;i++){a=h*n+i;f=h*n+i+1;j=(h+1)*n+i;l=(h+1)*n+i+1;m=new THREE.UV(i/b,h/c);q=new THREE.UV((i+1)/b,h/c);p=new THREE.UV(i/b,(h+1)/c);o=new THREE.UV((i+1)/b,(h+1)/c);if(d){e.push(new THREE.Face3(a,f,j));e.push(new THREE.Face3(f,l,j));g.push([m,
q,p]);g.push([q,o,p])}else{e.push(new THREE.Face4(a,f,l,j));g.push([m,q,o,p])}}this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.ParametricGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.ConvexGeometry=function(a){function b(a){var b=a.length();return new THREE.UV(a.x/b,a.y/b)}THREE.Geometry.call(this);for(var c=[[0,1,2],[0,2,1]],d=3;d<a.length;d++){var f=d,e=a[f].clone(),g=e.length();e.x=e.x+g*(Math.random()-0.5)*2E-6;e.y=e.y+g*(Math.random()-0.5)*2E-6;e.z=e.z+g*(Math.random()-0.5)*2E-6;for(var g=[],h=0;h<c.length;){var i=c[h],l=e,j=a[i[0]],n;n=j;var m=a[i[1]],q=a[i[2]],p=new THREE.Vector3,o=new THREE.Vector3;p.sub(q,m);o.sub(n,m);p.crossSelf(o);p.isZero()||p.normalize();n=
...
q.length;n.vertexColors[r]=o}}i.push(n);if(j.supportUVs){g=[e(a,""),e(c,m),e(d,m),e(f,m)];g[0]?g[1]?g[2]?g[3]?l.push(g):b("d :( ",f+":"+m):b("c :( ",d+":"+m):b("b :( ",c+":"+m):b("a :( ",a+":"+m)}}function f(a,b){return Math.min(a,b)+"_"+Math.max(a,b)}function e(a,d){var e=a+":"+d,f=r[e];if(!f){a>=s&&a<s+m.length?b("face pt"):b("edge pt");c("warning, UV not found for",e);return null}return f}function g(a,b,d){var e=a+":"+b;e in r?c("dup vertexNo",a,"oldFaceNo",b,"value",d,"key",e,r[e]):r[e]=d}var h=
[],i=[],l=[],j=this,n=a.vertices,m=a.faces,h=n.concat(),q=[],p={},o={},r={},s=n.length,u,w,t,B,v,A=a.faceVertexUvs[0];b("originalFaces, uvs, originalVerticesLength",m.length,A.length,s);if(j.supportUVs){u=0;for(w=A.length;u<w;u++){t=0;for(B=A[u].length;t<B;t++){v=m[u]["abcd".charAt(t)];g(v,u,A[u][t])}}}if(A.length==0)j.supportUVs=false;u=0;for(var D in r)u++;if(!u){j.supportUVs=false;b("no uvs")}b("-- Original Faces + Vertices UVs completed",r,"vs",A.length);var z;u=0;for(w=m.length;u<w;u++){v=m[u];
q.push(v.centroid);h.push(v.centroid);if(j.supportUVs){z=new THREE.UV;if(v instanceof THREE.Face3){z.u=e(v.a,u).u+e(v.b,u).u+e(v.c,u).u;z.v=e(v.a,u).v+e(v.b,u).v+e(v.c,u).v;z.u=z.u/3;z.v=z.v/3}else if(v instanceof THREE.Face4){z.u=e(v.a,u).u+e(v.b,u).u+e(v.c,u).u+e(v.d,u).u;z.v=e(v.a,u).v+e(v.b,u).v+e(v.c,u).v+e(v.d,u).v;z.u=z.u/4;z.v=z.v/4}g(s+u,"",z)}}b("-- added UVs for new Faces",r);D=function(a,b){M[a]===void 0&&(M[a]=[]);M[a].push(b)};var M={},A=0;for(w=a.faces.length;A<w;A++){v=a.faces[A];
if(v instanceof THREE.Face3){z=f(v.a,v.b);D(z,A);z=f(v.b,v.c);D(z,A);z=f(v.c,v.a);D(z,A)}else if(v instanceof THREE.Face4){z=f(v.a,v.b);D(z,A);z=f(v.b,v.c);D(z,A);z=f(v.c,v.d);D(z,A);z=f(v.d,v.a);D(z,A)}}w=M;var G=0,H,E;D={};A={};for(u in w){z=w[u];H=u.split("_");E=H[0];H=H[1];t=E;v=[E,H];D[t]===void 0&&(D[t]=[]);D[t].push(v);t=H;v=[E,H];D[t]===void 0&&(D[t]=[]);D[t].push(v);t=0;for(B=z.length;t<B;t++){v=z[t];var O=E,F=v,J=u;A[O]===void 0&&(A[O]={});A[O][F]=J;O=H;F=u;A[O]===void 0&&(A[O]={});A[O][v]=
F}z.length<2&&(o[u]=true)}b("vertexEdgeMap",D,"vertexFaceMap",A);for(u in w){z=w[u];v=z[0];B=z[1];H=u.split("_");E=H[0];H=H[1];z=new THREE.Vector3;if(o[u]){z.addSelf(n[E]);z.addSelf(n[H]);z.multiplyScalar(0.5)}else{z.addSelf(q[v]);z.addSelf(q[B]);z.addSelf(n[E]);z.addSelf(n[H]);z.multiplyScalar(0.25)}p[u]=s+m.length+G;h.push(z);G++;if(j.supportUVs){z=new THREE.UV;z.u=e(E,v).u+e(H,v).u;z.v=e(E,v).v+e(H,v).v;z.u=z.u/2;z.v=z.v/2;g(p[u],v,z);if(!o[u]){z=new THREE.UV;z.u=e(E,B).u+e(H,B).u;z.v=e(E,B).v+
e(H,B).v;z.u=z.u/2;z.v=z.v/2;g(p[u],B,z)}}}b("-- Step 2 done");var I,K;H=["123","12","2","23"];B=["123","23","3","31"];var O=["123","31","1","12"],F=["1234","12","2","23"],J=["1234","23","3","34"],V=["1234","34","4","41"],Y=["1234","41","1","12"];u=0;for(w=q.length;u<w;u++){v=m[u];z=s+u;if(v instanceof THREE.Face3){G=f(v.a,v.b);E=f(v.b,v.c);I=f(v.c,v.a);d(z,p[G],v.b,p[E],v,H,u);d(z,p[E],v.c,p[I],v,B,u);d(z,p[I],v.a,p[G],v,O,u)}else if(v instanceof THREE.Face4){G=f(v.a,v.b);E=f(v.b,v.c);I=f(v.c,v.d);
K=f(v.d,v.a);d(z,p[G],v.b,p[E],v,F,u);d(z,p[E],v.c,p[I],v,J,u);d(z,p[I],v.d,p[K],v,V,u);d(z,p[K],v.a,p[G],v,Y,u)}else b("face should be a face!",v)}p=new THREE.Vector3;v=new THREE.Vector3;u=0;for(w=n.length;u<w;u++)if(D[u]!==void 0){p.set(0,0,0);v.set(0,0,0);E=new THREE.Vector3(0,0,0);z=0;for(t in A[u]){p.addSelf(q[t]);z++}H=0;G=D[u].length;for(t=0;t<G;t++)o[f(D[u][t][0],D[u][t][1])]&&H++;if(H!=2){p.divideScalar(z);for(t=0;t<G;t++){z=D[u][t];z=n[z[0]].clone().addSelf(n[z[1]]).divideScalar(2);v.addSelf(z)}v.divideScalar(G);
E.addSelf(n[u]);E.multiplyScalar(G-3);E.addSelf(p);E.addSelf(v.multiplyScalar(2));E.divideScalar(G);h[u]=E}}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=l;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);
...
THREE.LensFlarePlugin=function(){function a(a){var c=b.createProgram(),d=b.createShader(b.FRAGMENT_SHADER),e=b.createShader(b.VERTEX_SHADER);b.shaderSource(d,a.fragmentShader);b.shaderSource(e,a.vertexShader);b.compileShader(d);b.compileShader(e);b.attachShader(c,d);b.attachShader(c,e);b.linkProgram(c);return c}var b,c,d,f,e,g,h,i,l,j,n,m,q;this.init=function(p){b=p.context;c=p;d=new Float32Array(16);f=new Uint16Array(6);p=0;d[p++]=-1;d[p++]=-1;d[p++]=0;d[p++]=0;d[p++]=1;d[p++]=-1;d[p++]=1;d[p++]=
...
"color");m.scale=b.getUniformLocation(j,"scale");m.rotation=b.getUniformLocation(j,"rotation");m.screenPosition=b.getUniformLocation(j,"screenPosition");q=false};this.render=function(a,d,f,s){var a=a.__webglFlares,u=a.length;if(u){var w=new THREE.Vector3,t=s/f,B=f*0.5,v=s*0.5,A=16/s,D=new THREE.Vector2(A*t,A),z=new THREE.Vector3(1,1,0),M=new THREE.Vector2(1,1),G=m,A=n;b.useProgram(j);if(!q){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);q=true}b.uniform1i(G.occlusionMap,0);b.uniform1i(G.map,
1);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(A.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(A.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var H,E,O,F,J;for(H=0;H<u;H++){A=16/s;D.set(A*t,A);F=a[H];w.set(F.matrixWorld.elements[12],F.matrixWorld.elements[13],F.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(w);d.projectionMatrix.multiplyVector3(w);z.copy(w);M.x=z.x*B+B;M.y=z.y*v+v;if(l||M.x>0&&M.x<f&&M.y>0&&
M.y<s){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,M.x-8,M.y-8,16,16,0);b.uniform1i(G.renderType,0);b.uniform2f(G.scale,D.x,D.y);b.uniform3f(G.screenPosition,z.x,z.y,z.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,M.x-8,M.y-8,16,16,0);b.uniform1i(G.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);F.positionScreen.copy(z);F.customUpdateCallback?F.customUpdateCallback(F):F.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);E=0;for(O=F.lensFlares.length;E<O;E++){J=F.lensFlares[E];if(J.opacity>0.001&&J.scale>0.001){z.x=J.x;z.y=J.y;z.z=J.z;A=J.size*J.scale/s;D.x=A*t;D.y=A;b.uniform3f(G.screenPosition,z.x,z.y,z.z);b.uniform2f(G.scale,D.x,D.y);b.uniform1f(G.rotation,J.rotation);b.uniform1f(G.opacity,J.opacity);
...
vertexShader:g.vertexShader,uniforms:h,skinning:true});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:true,skinning:true});c._shadowPass=true;d._shadowPass=true;f._shadowPass=true;e._shadowPass=true};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(j,n){var m,q,p,o,r,s,u,w,t,B=[];o=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(true);m=0;for(q=j.__lights.length;m<q;m++){p=j.__lights[m];if(p.castShadow)if(p instanceof THREE.DirectionalLight&&p.shadowCascade)for(r=0;r<p.shadowCascadeCount;r++){var v;if(p.shadowCascadeArray[r])v=p.shadowCascadeArray[r];else{t=p;u=r;v=new THREE.DirectionalLight;v.isVirtual=true;v.onlyShadow=true;v.castShadow=true;v.shadowCameraNear=t.shadowCameraNear;v.shadowCameraFar=t.shadowCameraFar;v.shadowCameraLeft=t.shadowCameraLeft;v.shadowCameraRight=
t.shadowCameraRight;v.shadowCameraBottom=t.shadowCameraBottom;v.shadowCameraTop=t.shadowCameraTop;v.shadowCameraVisible=t.shadowCameraVisible;v.shadowDarkness=t.shadowDarkness;v.shadowBias=t.shadowCascadeBias[u];v.shadowMapWidth=t.shadowCascadeWidth[u];v.shadowMapHeight=t.shadowCascadeHeight[u];v.pointsWorld=[];v.pointsFrustum=[];w=v.pointsWorld;s=v.pointsFrustum;for(var A=0;A<8;A++){w[A]=new THREE.Vector3;s[A]=new THREE.Vector3}w=t.shadowCascadeNearZ[u];t=t.shadowCascadeFarZ[u];s[0].set(-1,-1,w);
s[1].set(1,-1,w);s[2].set(-1,1,w);s[3].set(1,1,w);s[4].set(-1,-1,t);s[5].set(1,-1,t);s[6].set(-1,1,t);s[7].set(1,1,t);v.originalCamera=n;s=new THREE.Gyroscope;s.position=p.shadowCascadeOffset;s.add(v);s.add(v.target);n.add(s);p.shadowCascadeArray[r]=v;console.log("Created virtualLight",v)}u=p;w=r;t=u.shadowCascadeArray[w];t.position.copy(u.position);t.target.position.copy(u.target.position);t.lookAt(t.target);t.shadowCameraVisible=u.shadowCameraVisible;t.shadowDarkness=u.shadowDarkness;t.shadowBias=
u.shadowCascadeBias[w];s=u.shadowCascadeNearZ[w];u=u.shadowCascadeFarZ[w];t=t.pointsFrustum;t[0].z=s;t[1].z=s;t[2].z=s;t[3].z=s;t[4].z=u;t[5].z=u;t[6].z=u;t[7].z=u;B[o]=v;o++}else{B[o]=p;o++}}m=0;for(q=B.length;m<q;m++){p=B[m];if(!p.shadowMap){p.shadowMap=new THREE.WebGLRenderTarget(p.shadowMapWidth,p.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});p.shadowMapSize=new THREE.Vector2(p.shadowMapWidth,p.shadowMapHeight);p.shadowMatrix=new THREE.Matrix4}if(!p.shadowCamera){if(p instanceof
THREE.SpotLight)p.shadowCamera=new THREE.PerspectiveCamera(p.shadowCameraFov,p.shadowMapWidth/p.shadowMapHeight,p.shadowCameraNear,p.shadowCameraFar);else if(p instanceof THREE.DirectionalLight)p.shadowCamera=new THREE.OrthographicCamera(p.shadowCameraLeft,p.shadowCameraRight,p.shadowCameraTop,p.shadowCameraBottom,p.shadowCameraNear,p.shadowCameraFar);else{console.error("Unsupported light type for shadow");continue}j.add(p.shadowCamera);b.autoUpdateScene&&j.updateMatrixWorld()}if(p.shadowCameraVisible&&
!p.cameraHelper){p.cameraHelper=new THREE.CameraHelper(p.shadowCamera);p.shadowCamera.add(p.cameraHelper)}if(p.isVirtual&&v.originalCamera==n){r=n;o=p.shadowCamera;s=p.pointsFrustum;t=p.pointsWorld;i.set(Infinity,Infinity,Infinity);l.set(-Infinity,-Infinity,-Infinity);for(u=0;u<8;u++){w=t[u];w.copy(s[u]);THREE.ShadowMapPlugin.__projector.unprojectVector(w,r);o.matrixWorldInverse.multiplyVector3(w);if(w.x<i.x)i.x=w.x;if(w.x>l.x)l.x=w.x;if(w.y<i.y)i.y=w.y;if(w.y>l.y)l.y=w.y;if(w.z<i.z)i.z=w.z;if(w.z>
l.z)l.z=w.z}o.left=i.x;o.right=l.x;o.top=l.y;o.bottom=i.y;o.updateProjectionMatrix()}o=p.shadowMap;s=p.shadowMatrix;r=p.shadowCamera;r.position.copy(p.matrixWorld.getPosition());r.lookAt(p.target.matrixWorld.getPosition());r.updateMatrixWorld();r.matrixWorldInverse.getInverse(r.matrixWorld);if(p.cameraHelper)p.cameraHelper.visible=p.shadowCameraVisible;p.shadowCameraVisible&&p.cameraHelper.update();s.set(0.5,0,0,0.5,0,0.5,0,0.5,0,0,0.5,0.5,0,0,0,1);s.multiplySelf(r.projectionMatrix);s.multiplySelf(r.matrixWorldInverse);
if(!r._viewMatrixArray)r._viewMatrixArray=new Float32Array(16);if(!r._projectionMatrixArray)r._projectionMatrixArray=new Float32Array(16);r.matrixWorldInverse.flattenToArray(r._viewMatrixArray);r.projectionMatrix.flattenToArray(r._projectionMatrixArray);h.multiply(r.projectionMatrix,r.matrixWorldInverse);g.setFromMatrix(h);b.setRenderTarget(o);b.clear();t=j.__webglObjects;p=0;for(o=t.length;p<o;p++){u=t[p];s=u.object;u.render=false;if(s.visible&&s.castShadow&&(!(s instanceof THREE.Mesh)||!s.frustumCulled||
g.contains(s))){s._modelViewMatrix.multiply(r.matrixWorldInverse,s.matrixWorld);u.render=true}}p=0;for(o=t.length;p<o;p++){u=t[p];if(u.render){s=u.object;u=u.buffer;w=s.customDepthMaterial?s.customDepthMaterial:s instanceof THREE.SkinnedMesh?s.geometry.morphTargets.length?e:f:s.geometry.morphTargets.length?d:c;u instanceof THREE.BufferGeometry?b.renderBufferDirect(r,j.__lights,null,w,u,s):b.renderBuffer(r,j.__lights,null,w,u,s)}}t=j.__webglObjectsImmediate;p=0;for(o=t.length;p<o;p++){u=t[p];s=u.object;
if(s.visible&&s.castShadow){s._modelViewMatrix.multiply(r.matrixWorldInverse,s.matrixWorld);b.renderImmediateObject(r,j.__lights,null,c,s)}}}m=b.getClearColor();q=b.getClearAlpha();a.clearColor(m.r,m.g,m.b,q);a.enable(a.BLEND);b.shadowMapCullFrontFaces&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;
...
g);b.bufferData(b.ELEMENT_ARRAY_BUFFER,f,b.STATIC_DRAW);var a=THREE.ShaderSprite.sprite,m=b.createProgram(),q=b.createShader(b.FRAGMENT_SHADER),p=b.createShader(b.VERTEX_SHADER);b.shaderSource(q,a.fragmentShader);b.shaderSource(p,a.vertexShader);b.compileShader(q);b.compileShader(p);b.attachShader(m,q);b.attachShader(m,p);b.linkProgram(m);h=m;i={};l={};i.position=b.getAttribLocation(h,"position");i.uv=b.getAttribLocation(h,"uv");l.uvOffset=b.getUniformLocation(h,"uvOffset");l.uvScale=b.getUniformLocation(h,
...
l.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");j=false};this.render=function(d,f,q,p){var d=d.__webglSprites,o=d.length;if(o){var r=i,s=l,u=p/q,q=q*0.5,w=p*0.5,t=true;b.useProgram(h);if(!j){b.enableVertexAttribArray(r.position);b.enableVertexAttribArray(r.uv);j=true}b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(true);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(r.position,2,b.FLOAT,false,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
g);b.uniformMatrix4fv(s.projectionMatrix,false,f._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(s.map,0);for(var B,v=[],r=0;r<o;r++){B=d[r];if(B.visible&&B.opacity!==0)if(B.useScreenCoordinates)B.z=-B.position.z;else{B._modelViewMatrix.multiply(f.matrixWorldInverse,B.matrixWorld);B.z=-B._modelViewMatrix.elements[14]}}d.sort(a);for(r=0;r<o;r++){B=d[r];if(B.visible&&B.opacity!==0&&B.map&&B.map.image&&B.map.image.width){if(B.useScreenCoordinates){b.uniform1i(s.useScreenCoordinates,1);
b.uniform3f(s.screenPosition,(B.position.x-q)/q,(w-B.position.y)/w,Math.max(0,Math.min(1,B.position.z)))}else{b.uniform1i(s.useScreenCoordinates,0);b.uniform1i(s.affectedByDistance,B.affectedByDistance?1:0);b.uniformMatrix4fv(s.modelViewMatrix,false,B._modelViewMatrix.elements)}f=B.map.image.width/(B.scaleByViewport?p:1);v[0]=f*u*B.scale.x;v[1]=f*B.scale.y;b.uniform2f(s.uvScale,B.uvScale.x,B.uvScale.y);b.uniform2f(s.uvOffset,B.uvOffset.x,B.uvOffset.y);b.uniform2f(s.alignment,B.alignment.x,B.alignment.y);
b.uniform1f(s.opacity,B.opacity);b.uniform3f(s.color,B.color.r,B.color.g,B.color.b);b.uniform1f(s.rotation,B.rotation);b.uniform2fv(s.scale,v);if(B.mergeWith3D&&!t){b.enable(b.DEPTH_TEST);t=true}else if(!B.mergeWith3D&&t){b.disable(b.DEPTH_TEST);t=false}c.setBlending(B.blending,B.blendEquation,B.blendSrc,B.blendDst);c.setTexture(B.map,0);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
