...
THREE.Frustum.prototype.setFromMatrix=function(a){var b=this.planes,c=a.elements,a=c[0],d=c[1],e=c[2],f=c[3],g=c[4],h=c[5],i=c[6],j=c[7],l=c[8],p=c[9],n=c[10],r=c[11],q=c[12],m=c[13],t=c[14],c=c[15];b[0].set(f-a,j-g,r-l,c-q);b[1].set(f+a,j+g,r+l,c+q);b[2].set(f+d,j+h,r+p,c+m);b[3].set(f-d,j-h,r-p,c-m);b[4].set(f-e,j-i,r-n,c-t);b[5].set(f+e,j+i,r+n,c+t);for(d=0;6>d;d++)a=b[d],a.divideScalar(Math.sqrt(a.x*a.x+a.y*a.y+a.z*a.z))};
