...
w=d[12],v=d[1],C=d[5],E=d[9],G=d[13],P=d[2],B=d[6],J=d[10],H=d[14],I=d[3],L=d[7],N=d[11],d=d[15];e[0]=f*s+g*v+h*P+i*I;e[4]=f*D+g*C+h*B+i*L;e[8]=f*z+g*E+h*J+i*N;e[12]=f*w+g*G+h*H+i*d;e[1]=j*s+l*v+n*P+m*I;e[5]=j*D+l*C+n*B+m*L;e[9]=j*z+l*E+n*J+m*N;e[13]=j*w+l*G+n*H+m*d;e[2]=p*s+o*v+q*P+t*I;e[6]=p*D+o*C+q*B+t*L;e[10]=p*z+o*E+q*J+t*N;e[14]=p*w+o*G+q*H+t*d;e[3]=r*s+A*v+u*P+c*I;e[7]=r*D+A*C+u*B+c*L;e[11]=r*z+A*E+u*J+c*N;e[15]=r*w+A*G+u*H+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
this.unprojectVector=function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);J.multiply(b.matrixWorld,b.projectionMatrixInverse);J.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n,Q){var $=h.near,K=h.far,ja=!1,R,ha,da,Y,aa,ba,ia,wa,ua,Ca,Ka,va,cb,xb,Ua;v=s=t=p=0;G.elements.length=0;g.updateMatrixWorld();
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,v){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];l=g[e];n=g[f];m=g[v];p=i.x-h.x;o=j.x-h.x;q=i.y-h.y;t=j.y-h.y;r=i.z-h.z;A=j.z-h.z;u=n.u-l.u;s=m.u-l.u;D=n.v-l.v;z=m.v-l.v;w=1/(u*z-s*D);G.set((z*p-D*o)*w,(z*q-D*t)*w,(z*r-D*A)*w);P.set((u*o-s*p)*w,(u*t-s*q)*w,(u*A-s*r)*w);C[b].addSelf(G);C[c].addSelf(G);C[d].addSelf(G);E[b].addSelf(P);E[c].addSelf(P);E[d].addSelf(P)}var b,c,d,e,f,g,h,i,j,l,n,m,p,o,q,t,r,A,
...
4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,n,m,p,o,q,t,r,A,u,s,D,z,w,v,f=new THREE.Vector3,g=new THREE.Vector3,C,E,G,P,B,J,H,I=this.offsets;G=0;for(P=I.length;G<P;++G){E=I[G].start;B=I[G].count;var L=I[G].index;C=E;for(E+=B;C<E;C+=3)B=L+b[C],J=L+b[C+1],H=L+b[C+2],l=c[3*B],n=c[3*B+1],m=c[3*B+2],p=c[3*J],o=c[3*J+1],q=c[3*J+2],t=c[3*H],r=c[3*H+1],A=c[3*
H+2],u=e[2*B],s=e[2*B+1],D=e[2*J],z=e[2*J+1],w=e[2*H],v=e[2*H+1],p-=l,l=t-l,o-=n,n=r-n,q-=m,m=A-m,D-=u,u=w-u,z-=s,s=v-s,v=1/(D*s-u*z),f.set((s*p-z*l)*v,(s*o-z*n)*v,(s*q-z*m)*v),g.set((D*l-u*p)*v,(D*n-u*o)*v,(D*m-u*q)*v),i[B].addSelf(f),i[J].addSelf(f),i[H].addSelf(f),j[B].addSelf(g),j[J].addSelf(g),j[H].addSelf(g)}var N=new THREE.Vector3,S=new THREE.Vector3,T=new THREE.Vector3,M=new THREE.Vector3,O,Q,$;G=0;for(P=I.length;G<P;++G){E=I[G].start;B=I[G].count;L=I[G].index;C=E;for(E+=B;C<E;C+=3)B=L+b[C],
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(b){var c,e,i,j,l,n,m,p,o,q,t,r,A,u,s;function D(a){return a%4?4-a%4:0}function z(a,b){return(new Uint8Array(a,b,1))[0]}function w(a,b){return(new Uint32Array(a,b,1))[0]}function v(b,c){var d,e,f,g,h,i,j,l,m=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){e=m[3*d];f=m[3*d+1];g=m[3*d+2];h=L[2*e];e=L[2*e+1];i=L[2*f];j=L[2*f+1];f=L[2*g];l=L[2*g+1];g=J.faceVertexUvs[0];var n=[];n.push(new THREE.UV(h,e));n.push(new THREE.UV(i,j));n.push(new THREE.UV(f,
l));g.push(n)}}function C(b,c){var d,e,f,g,h,i,j,l,m,n,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){e=o[4*d];f=o[4*d+1];g=o[4*d+2];h=o[4*d+3];i=L[2*e];e=L[2*e+1];j=L[2*f];m=L[2*f+1];l=L[2*g];n=L[2*g+1];g=L[2*h];f=L[2*h+1];h=J.faceVertexUvs[0];var p=[];p.push(new THREE.UV(i,e));p.push(new THREE.UV(j,m));p.push(new THREE.UV(l,n));p.push(new THREE.UV(g,f));h.push(p)}}function E(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],
...
g,h,i,[new THREE.Vector3(I[3*l],I[3*l+1],I[3*l+2]),new THREE.Vector3(q,r,m),new THREE.Vector3(t,s,n),new THREE.Vector3(u,v,o)],null,j))}}var J=this,H=0,I=[],L=[],N,S,T;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(J,d,b);s=a;S=H;b=new Uint8Array(s,S,12);q="";for(A=0;12>A;A++)q+=String.fromCharCode(b[S+A]);c=z(s,S+12);z(s,S+13);z(s,S+14);z(s,S+15);e=z(s,S+16);i=z(s,S+17);j=z(s,S+18);l=z(s,S+19);n=w(s,S+20);m=w(s,S+20+4);p=w(s,S+20+8);o=w(s,S+20+12);q=w(s,S+20+16);t=w(s,S+20+20);r=
w(s,S+20+24);A=w(s,S+20+28);b=w(s,S+20+32);u=w(s,S+20+36);s=w(s,S+20+40);H+=c;S=3*e+l;T=4*e+l;N=o*S;c=q*(S+3*i);e=t*(S+3*j);l=r*(S+3*i+3*j);S=A*T;i=b*(T+4*i);j=u*(T+4*j);T=H;var H=new Float32Array(a,H,3*n),M,O,Q,$;for(M=0;M<n;M++)O=H[3*M],Q=H[3*M+1],$=H[3*M+2],J.vertices.push(new THREE.Vector3(O,Q,$));n=H=T+3*n*Float32Array.BYTES_PER_ELEMENT;if(m){H=new Int8Array(a,H,3*m);for(T=0;T<m;T++)M=H[3*T],O=H[3*T+1],Q=H[3*T+2],I.push(M/127,O/127,Q/127)}H=n+3*m*Int8Array.BYTES_PER_ELEMENT;m=H+=D(3*m);if(p){H=
new Float32Array(a,H,2*p);for(n=0;n<p;n++)T=H[2*n],M=H[2*n+1],L.push(T,M)}p=H=m+2*p*Float32Array.BYTES_PER_ELEMENT;N=p+N+D(2*o);m=N+c+D(2*q);c=m+e+D(2*t);e=c+l+D(2*r);S=e+S+D(2*A);l=S+i+D(2*b);i=l+j+D(2*u);t&&(j=m+3*t*Uint32Array.BYTES_PER_ELEMENT,E(t,m,j+3*t*Uint32Array.BYTES_PER_ELEMENT),v(t,j));r&&(t=c+3*r*Uint32Array.BYTES_PER_ELEMENT,j=t+3*r*Uint32Array.BYTES_PER_ELEMENT,P(r,c,t,j+3*r*Uint32Array.BYTES_PER_ELEMENT),v(r,j));u&&(r=l+4*u*Uint32Array.BYTES_PER_ELEMENT,G(u,l,r+4*u*Uint32Array.BYTES_PER_ELEMENT),
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return"relativeToHTML"==b?a:n+"/"+a}function e(){f(M.scene,Q.objects)}function f(a,b){for(var c in b)if(void 0===M.objects[c]){var e=b[c],g=null;if(e.type&&e.type in l.hierarchyHandlerMap&&void 0===e.loading){var i={},j;for(j in t)"type"!==j&&"url"!==j&&(i[j]=t[j]);E=M.materials[e.material];e.loading=!0;var m=l.hierarchyHandlerMap[e.type].loaderObject;m.addEventListener?(m.addEventListener("load",h(c,a,E,e)),m.load(d(e.url,Q.urlBaseType))):
...
D?(g.quaternion.set(D[0],D[1],D[2],D[3]),g.useQuaternion=!0):g.rotation.set(s[0],s[1],s[2]),g.scale.set(z[0],z[1],z[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),M.objects[c]=g,M.empties[c]=g);if(g){if(void 0!==e.properties)for(var n in e.properties)g.properties[n]=e.properties[n];void 0!==e.children&&f(g,e.children)}}}function g(a){return function(b){M.geometries[a]=b;e();L-=1;l.onLoadComplete();j()}}function h(a,b,c,d){return function(f){var f=f.content?f.content:f.dae?f.scene:f,g=d.position,
...
a.near,a.far):"exp2"===a.type&&(P=new THREE.FogExp2(0,a.density)),w=a.color,P.color.setRGB(w[0],w[1],w[2]),M.fogs[o]=P;for(m in Q.geometries)t=Q.geometries[m],t.type in this.geometryHandlerMap&&(L+=1,l.onLoadStart());for(var K in Q.objects)o=Q.objects[K],o.type&&o.type in this.hierarchyHandlerMap&&(L+=1,l.onLoadStart());S=L;for(m in Q.geometries)if(t=Q.geometries[m],"cube"===t.type)C=new THREE.CubeGeometry(t.width,t.height,t.depth,t.widthSegments,t.heightSegments,t.depthSegments,null,t.flipped,t.sides),
M.geometries[m]=C;else if("plane"===t.type)C=new THREE.PlaneGeometry(t.width,t.height,t.widthSegments,t.heightSegments),M.geometries[m]=C;else if("sphere"===t.type)C=new THREE.SphereGeometry(t.radius,t.widthSegments,t.heightSegments),M.geometries[m]=C;else if("cylinder"===t.type)C=new THREE.CylinderGeometry(t.topRad,t.botRad,t.height,t.radSegs,t.heightSegs),M.geometries[m]=C;else if("torus"===t.type)C=new THREE.TorusGeometry(t.radius,t.tube,t.segmentsR,t.segmentsT),M.geometries[m]=C;else if("icosahedron"===
t.type)C=new THREE.IcosahedronGeometry(t.radius,t.subdivisions),M.geometries[m]=C;else if(t.type in this.geometryHandlerMap){K={};for(B in t)"type"!==B&&"url"!==B&&(K[B]=t[B]);this.geometryHandlerMap[t.type].loaderObject.load(d(t.url,Q.urlBaseType),g(m),K)}else"embedded"===t.type&&(K=Q.embeds[t.id],K.metadata=Q.metadata,K&&this.geometryHandlerMap.ascii.loaderObject.createModel(K,i(m),""));for(q in Q.textures)if(m=Q.textures[q],m.url instanceof Array){N+=m.url.length;for(B=0;B<m.url.length;B++)l.onLoadStart()}else N+=
1,l.onLoadStart();T=N;for(q in Q.textures){m=Q.textures[q];void 0!==m.mapping&&void 0!==THREE[m.mapping]&&(m.mapping=new THREE[m.mapping]);if(m.url instanceof Array){K=m.url.length;o=[];for(B=0;B<K;B++)o[B]=d(m.url[B],Q.urlBaseType);B=(B=o[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(o,m.mapping,$(K)):THREE.ImageUtils.loadTextureCube(o,m.mapping,$(K))}else{B=m.url.toLowerCase().endsWith(".dds");K=d(m.url,Q.urlBaseType);o=$(1);B=B?THREE.ImageUtils.loadCompressedTexture(K,m.mapping,
...
Y),ha.r=ha.r*ba.r+ia.r,ha.g=ha.g*ba.g+ia.g,ha.b=ha.b*ba.b+ia.b,da.r=da.r*ba.r+ia.r,da.g=da.g*ba.g+ia.g,da.b=da.b*ba.b+ia.b,Y.r=Y.r*ba.r+ia.r,Y.g=Y.g*ba.g+ia.g,Y.b=Y.b*ba.b+ia.b,aa.r=0.5*(da.r+Y.r),aa.g=0.5*(da.g+Y.g),aa.b=0.5*(da.b+Y.b),va=wc(ha,da,Y,aa),ma(H,I,L,N,S,T,0,0,1,0,0,1,va)):(R.r=Na.r,R.g=Na.g,R.b=Na.b,m(i.centroidWorld,i.normalWorld,R),R.r=R.r*ba.r+ia.r,R.g=R.g*ba.g+ia.g,R.b=R.b*ba.b+ia.b,!0===j.wireframe?s(R,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):u(R)):!0===j.wireframe?
...
a.elements[4]+ka.z*a.elements[8])+0.5,Ua=0.5*(ka.x*a.elements[1]+ka.y*a.elements[5]+ka.z*a.elements[9])+0.5,ka.copy(i.vertexNormalsWorld[h]),fb=0.5*(ka.x*a.elements[0]+ka.y*a.elements[4]+ka.z*a.elements[8])+0.5,kb=0.5*(ka.x*a.elements[1]+ka.y*a.elements[5]+ka.z*a.elements[9])+0.5,ka.copy(i.vertexNormalsWorld[k]),Bb=0.5*(ka.x*a.elements[0]+ka.y*a.elements[4]+ka.z*a.elements[8])+0.5,Cb=0.5*(ka.x*a.elements[1]+ka.y*a.elements[5]+ka.z*a.elements[9])+0.5,A(H,I,L,N,S,T,xb,Ua,fb,kb,Bb,Cb,j.envMap)):(R.copy(j.color),
j.vertexColors===THREE.FaceColors&&(R.r*=i.color.r,R.g*=i.color.g,R.b*=i.color.b),!0===j.wireframe?s(R,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):u(R)):j instanceof THREE.MeshDepthMaterial?(Ca=l.near,Ka=l.far,ha.r=ha.g=ha.b=1-nb(a.positionScreen.z,Ca,Ka),da.r=da.g=da.b=1-nb(d.positionScreen.z,Ca,Ka),Y.r=Y.g=Y.b=1-nb(e.positionScreen.z,Ca,Ka),aa.r=0.5*(da.r+Y.r),aa.g=0.5*(da.g+Y.g),aa.b=0.5*(da.b+Y.b),va=wc(ha,da,Y,aa),ma(H,I,L,N,S,T,0,0,1,0,0,1,va)):j instanceof THREE.MeshNormalMaterial&&
...
G.positionScreen.y),La.addPoint(P.positionScreen.x,P.positionScreen.y),!0===eb.intersects(La)))(oa=C,D=E,zb=G,Ab=P,rb=B,sb=J,hc=a,f.info.render.vertices+=4,f.info.render.faces++,b(ea.opacity),c(ea.blending),void 0!==ea.map&&null!==ea.map||void 0!==ea.envMap&&null!==ea.envMap)?(n(oa,D,Ab,0,1,3,na,ea,hc),n(rb,zb,sb,1,2,3,na,ea,hc)):(H=oa.positionScreen.x,I=oa.positionScreen.y,L=D.positionScreen.x,N=D.positionScreen.y,S=zb.positionScreen.x,T=zb.positionScreen.y,M=Ab.positionScreen.x,O=Ab.positionScreen.y,
Q=rb.positionScreen.x,$=rb.positionScreen.y,K=sb.positionScreen.x,ja=sb.positionScreen.y,ea instanceof THREE.MeshLambertMaterial||ea instanceof THREE.MeshPhongMaterial)?(ba.copy(ea.color),ia.copy(ea.emissive),ea.vertexColors===THREE.FaceColors&&(ba.r*=na.color.r,ba.g*=na.color.g,ba.b*=na.color.b),!0===lb)?!1===ea.wireframe&&ea.shading==THREE.SmoothShading&&4==na.vertexNormalsLength?(ha.r=da.r=Y.r=aa.r=Na.r,ha.g=da.g=Y.g=aa.g=Na.g,ha.b=da.b=Y.b=aa.b=Na.b,m(na.v1.positionWorld,na.vertexNormalsWorld[0],
ha),m(na.v2.positionWorld,na.vertexNormalsWorld[1],da),m(na.v4.positionWorld,na.vertexNormalsWorld[3],Y),m(na.v3.positionWorld,na.vertexNormalsWorld[2],aa),ha.r=ha.r*ba.r+ia.r,ha.g=ha.g*ba.g+ia.g,ha.b=ha.b*ba.b+ia.b,da.r=da.r*ba.r+ia.r,da.g=da.g*ba.g+ia.g,da.b=da.b*ba.b+ia.b,Y.r=Y.r*ba.r+ia.r,Y.g=Y.g*ba.g+ia.g,Y.b=Y.b*ba.b+ia.b,aa.r=aa.r*ba.r+ia.r,aa.g=aa.g*ba.g+ia.g,aa.b=aa.b*ba.b+ia.b,va=wc(ha,da,Y,aa),r(H,I,L,N,M,O),ma(H,I,L,N,M,O,0,0,1,0,0,1,va),r(Q,$,S,T,K,ja),ma(Q,$,S,T,K,ja,1,0,1,1,0,1,va)):
(R.r=Na.r,R.g=Na.g,R.b=Na.b,m(na.centroidWorld,na.normalWorld,R),R.r=R.r*ba.r+ia.r,R.g=R.g*ba.g+ia.g,R.b=R.b*ba.b+ia.b,t(H,I,L,N,S,T,M,O),!0===ea.wireframe?s(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):u(R)):(R.r=ba.r+ia.r,R.g=ba.g+ia.g,R.b=ba.b+ia.b,t(H,I,L,N,S,T,M,O),!0===ea.wireframe?s(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):u(R)):ea instanceof THREE.MeshBasicMaterial?(R.copy(ea.color),ea.vertexColors===THREE.FaceColors&&(R.r*=na.color.r,R.g*=na.color.g,
R.b*=na.color.b),t(H,I,L,N,S,T,M,O),!0===ea.wireframe?s(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):u(R)):ea instanceof THREE.MeshNormalMaterial?(R.r=gc(na.normalWorld.x),R.g=gc(na.normalWorld.y),R.b=gc(na.normalWorld.z),t(H,I,L,N,S,T,M,O),!0===ea.wireframe?s(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):u(R)):ea instanceof THREE.MeshDepthMaterial&&(Ca=l.near,Ka=l.far,ha.r=ha.g=ha.b=1-nb(oa.positionScreen.z,Ca,Ka),da.r=da.g=da.b=1-nb(D.positionScreen.z,Ca,
Ka),Y.r=Y.g=Y.b=1-nb(Ab.positionScreen.z,Ca,Ka),aa.r=aa.g=aa.b=1-nb(zb.positionScreen.z,Ca,Ka),va=wc(ha,da,Y,aa),r(H,I,L,N,M,O),ma(H,I,L,N,M,O,0,0,1,0,0,1,va),r(Q,$,S,T,K,ja),ma(Q,$,S,T,K,ja,1,0,1,1,0,1,va));xa.addRectangle(La)}q.setTransform(1,0,0,1,0,0)}}};
...
M;r.spot.length=L;r.hemi.length=da;r.ambient[0]=l;r.ambient[1]=m;r.ambient[2]=n;gb=!1}c=qb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=
...
j=[];for(l=0;6>l;l++)K.autoScaleCubemaps&&!f?(m=j,n=l,r=c.image[l],s=Oc,r.width<=s&&r.height<=s||(u=Math.max(r.width,r.height),t=Math.floor(r.width*s/u),s=Math.floor(r.height*s/u),u=document.createElement("canvas"),u.width=t,u.height=s,u.getContext("2d").drawImage(r,0,0,r.width,r.height,0,0,t,s),r=u),m[n]=r):j[l]=c.image[l];l=j[0];m=0===(l.width&l.width-1)&&0===(l.height&l.height-1);n=H(c.format);r=H(c.type);P(k.TEXTURE_CUBE_MAP,c,m);for(l=0;6>l;l++)if(f){s=j[l].mipmaps;u=0;for(z=s.length;u<z;u++)t=
...
!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var K=this,ja=[],R=0,ha=null,da=null,Y=-1,aa=null,ba=null,ia=0,wa=0,ua=-1,Ca=-1,Ka=-1,va=-1,cb=-1,xb=-1,Ua=-1,fb=-1,kb=null,Bb=null,Cb=null,eb=null,xa=0,La=0,lb=0,Na=0,Za=0,db=0,ka=new THREE.Frustum,$a=new THREE.Matrix4,ab=new THREE.Matrix4,mb=new THREE.Vector4,ta=new THREE.Vector3,
...
k.createBuffer();var J=void 0,Y=void 0;if(R.numMorphTargets){R.__webglMorphTargetsBuffers=[];J=0;for(Y=R.numMorphTargets;J<Y;J++)R.__webglMorphTargetsBuffers.push(k.createBuffer())}if(R.numMorphNormals){R.__webglMorphNormalsBuffers=[];J=0;for(Y=R.numMorphNormals;J<Y;J++)R.__webglMorphNormalsBuffers.push(k.createBuffer())}K.info.memory.geometries++;d(o,b);n.verticesNeedUpdate=!0;n.morphTargetsNeedUpdate=!0;n.elementsNeedUpdate=!0;n.uvsNeedUpdate=!0;n.normalsNeedUpdate=!0;n.tangentsNeedUpdate=!0;n.colorsNeedUpdate=
!0}}else n instanceof THREE.BufferGeometry&&h(n);else if(b instanceof THREE.Ribbon){if(n=b.geometry,!n.__webglVertexBuffer){var O=n;O.__webglVertexBuffer=k.createBuffer();O.__webglColorBuffer=k.createBuffer();O.__webglNormalBuffer=k.createBuffer();K.info.memory.geometries++;var Q=n,P=b,L=Q.vertices.length;Q.__vertexArray=new Float32Array(3*L);Q.__colorArray=new Float32Array(3*L);Q.__normalArray=new Float32Array(3*L);Q.__webglVertexCount=L;c(Q,P);n.verticesNeedUpdate=!0;n.colorsNeedUpdate=!0;n.normalsNeedUpdate=
!0}}else if(b instanceof THREE.Line){if(n=b.geometry,!n.__webglVertexBuffer){var N=n;N.__webglVertexBuffer=k.createBuffer();N.__webglColorBuffer=k.createBuffer();N.__webglLineDistanceBuffer=k.createBuffer();K.info.memory.geometries++;var M=n,S=b,da=M.vertices.length;M.__vertexArray=new Float32Array(3*da);M.__colorArray=new Float32Array(3*da);M.__lineDistanceArray=new Float32Array(1*da);M.__webglLineCount=da;c(M,S);n.verticesNeedUpdate=!0;n.colorsNeedUpdate=!0;n.lineDistancesNeedUpdate=!0}}else if(b instanceof
...
THREE.Path.prototype.getPoints=function(a,b){if(this.useSpacedPoints)return console.log("tata"),this.getSpacedPoints(a,b);var a=a||12,c=[],d,e,f,g,h,i,j,l,n,m,p,o,q;d=0;for(e=this.actions.length;d<e;d++)switch(f=this.actions[d],g=f.action,f=f.args,g){case THREE.PathActions.MOVE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.LINE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=f[2];i=f[3];n=f[0];m=f[1];0<c.length?(g=c[c.length-1],p=g.x,
o=g.y):(g=this.actions[d-1].args,p=g[g.length-2],o=g[g.length-1]);for(f=1;f<=a;f++)q=f/a,g=THREE.Shape.Utils.b2(q,p,n,h),q=THREE.Shape.Utils.b2(q,o,m,i),c.push(new THREE.Vector2(g,q));break;case THREE.PathActions.BEZIER_CURVE_TO:h=f[4];i=f[5];n=f[0];m=f[1];j=f[2];l=f[3];0<c.length?(g=c[c.length-1],p=g.x,o=g.y):(g=this.actions[d-1].args,p=g[g.length-2],o=g[g.length-1]);for(f=1;f<=a;f++)q=f/a,g=THREE.Shape.Utils.b3(q,p,n,j,h),q=THREE.Shape.Utils.b3(q,o,m,l,i),c.push(new THREE.Vector2(g,q));break;case THREE.PathActions.CSPLINE_THRU:g=
this.actions[d-1].args;q=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=a*f[0].length;q=q.concat(f[0]);q=new THREE.SplineCurve(q);for(f=1;f<=g;f++)c.push(q.getPointAt(f/g));break;case THREE.PathActions.ARC:h=f[0];i=f[1];m=f[2];j=f[3];g=f[4];n=!!f[5];p=g-j;o=2*a;for(f=1;f<=o;f++)q=f/o,n||(q=1-q),q=j+q*p,g=h+m*Math.cos(q),q=i+m*Math.sin(q),c.push(new THREE.Vector2(g,q));break;case THREE.PathActions.ELLIPSE:h=f[0];i=f[1];m=f[2];l=f[3];j=f[4];g=f[5];n=!!f[6];p=g-j;o=2*a;for(f=1;f<=o;f++)q=f/o,n||
(q=1-q),q=j+q*p,g=h+m*Math.cos(q),q=i+l*Math.sin(q),c.push(new THREE.Vector2(g,q))}d=c[c.length-1];1E-10>Math.abs(d.x-c[0].x)&&1E-10>Math.abs(d.y-c[0].y)&&c.splice(c.length-1,1);b&&c.push(c[0]);return c};
...
THREE.CubeGeometry=function(a,b,c,d,e,f,g,h){function i(a,b,c,d,e,f,g,h){var i,l=j.widthSegments,m=j.heightSegments,n=e/2,o=f/2,p=j.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)i="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)i="y",m=j.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)i="x",l=j.depthSegments;var q=l+1,t=m+1,L=e/l,N=f/m,S=new THREE.Vector3;S[i]=0<g?1:-1;for(e=0;e<t;e++)for(f=0;f<q;f++){var T=new THREE.Vector3;T[a]=(f*L-n)*c;T[b]=(e*N-o)*d;T[i]=g;j.vertices.push(T)}for(e=
0;e<m;e++)for(f=0;f<l;f++)a=new THREE.Face4(f+q*e+p,f+q*(e+1)+p,f+1+q*(e+1)+p,f+1+q*e+p),a.normal.copy(S),a.vertexNormals.push(S.clone(),S.clone(),S.clone(),S.clone()),a.materialIndex=h,j.faces.push(a),j.faceVertexUvs[0].push([new THREE.UV(f/l,1-e/m),new THREE.UV(f/l,1-(e+1)/m),new THREE.UV((f+1)/l,1-(e+1)/m),new THREE.UV((f+1)/l,1-e/m)])}THREE.Geometry.call(this);var j=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;var a=this.width/
...
[],K,ja=M.concat();v=0;for(C=p.length;v<C;v++){w=p[v];K=[];O=0;Q=w.length;H=Q-1;for(I=O+1;O<Q;O++,H++,I++)H===Q&&(H=0),I===Q&&(I=0),K[O]=d(w[O],w[H],w[I]);$.push(K);ja=ja.concat(K)}for(H=0;H<l;H++){w=H/l;L=i*(1-w);I=j*Math.sin(w*Math.PI/2);O=0;for(Q=B.length;O<Q;O++)N=c(B[O],M[O],I),f(N.x,N.y,-L);v=0;for(C=p.length;v<C;v++){w=p[v];K=$[v];O=0;for(Q=w.length;O<Q;O++)N=c(w[O],K[O],I),f(N.x,N.y,-L)}}I=j;for(O=0;O<S;O++)N=n?c(P[O],ja[O],I):P[O],q?(D.copy(u.normals[0]).multiplyScalar(N.x),s.copy(u.binormals[0]).multiplyScalar(N.y),
z.copy(o[0]).addSelf(D).addSelf(s),f(z.x,z.y,z.z)):f(N.x,N.y,0);for(w=1;w<=m;w++)for(O=0;O<S;O++)N=n?c(P[O],ja[O],I):P[O],q?(D.copy(u.normals[w]).multiplyScalar(N.x),s.copy(u.binormals[w]).multiplyScalar(N.y),z.copy(o[w]).addSelf(D).addSelf(s),f(z.x,z.y,z.z)):f(N.x,N.y,h/m*w);for(H=l-1;0<=H;H--){w=H/l;L=i*(1-w);I=j*Math.sin(w*Math.PI/2);O=0;for(Q=B.length;O<Q;O++)N=c(B[O],M[O],I),f(N.x,N.y,h+L);v=0;for(C=p.length;v<C;v++){w=p[v];K=$[v];O=0;for(Q=w.length;O<Q;O++)N=c(w[O],K[O],I),q?f(N.x,N.y+o[m-1].y,
o[m-1].x+L):f(N.x,N.y,h+L)}}if(n){i=0*S;for(O=0;O<T;O++)h=J[O],g(h[2]+i,h[1]+i,h[0]+i,!0);i=S*(m+2*l);for(O=0;O<T;O++)h=J[O],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(O=0;O<T;O++)h=J[O],g(h[2],h[1],h[0],!0);for(O=0;O<T;O++)h=J[O],g(h[0]+S*m,h[1]+S*m,h[2]+S*m,!1)}h=0;e(B,h);h+=B.length;v=0;for(C=p.length;v<C;v++)w=p[v],e(w,h),h+=w.length};
...
h[b+1][a+1].clone();Math.abs(this.vertices[d].y)===this.radius?(this.faces.push(new THREE.Face3(d,f,g,[i,l,n])),this.faceVertexUvs[0].push([m,o,q])):Math.abs(this.vertices[f].y)===this.radius?(this.faces.push(new THREE.Face3(d,e,f,[i,j,l])),this.faceVertexUvs[0].push([m,p,o])):(this.faces.push(new THREE.Face4(d,e,f,g,[i,j,l,n])),this.faceVertexUvs[0].push([m,p,o,q]))}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:this.radius}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.TubeGeometry=function(a,b,c,d,e,f){THREE.Geometry.call(this);this.path=a;this.segments=b||64;this.radius=c||1;this.radiusSegments=d||8;this.closed=e||!1;f&&(this.debug=new THREE.Object3D);this.grid=[];var g,h,f=this.segments+1,i,j,l,n=new THREE.Vector3,m,p,o,b=new THREE.TubeGeometry.FrenetFrames(a,b,e);m=b.tangents;p=b.normals;o=b.binormals;this.tangents=m;this.normals=p;this.binormals=o;for(b=0;b<f;b++){this.grid[b]=[];d=b/(f-1);l=a.getPointAt(d);d=m[b];g=p[b];h=o[b];this.debug&&(this.debug.add(new THREE.ArrowHelper(d,
l,c,255)),this.debug.add(new THREE.ArrowHelper(g,l,c,16711680)),this.debug.add(new THREE.ArrowHelper(h,l,c,65280)));for(d=0;d<this.radiusSegments;d++)i=2*(d/this.radiusSegments)*Math.PI,j=-this.radius*Math.cos(i),i=this.radius*Math.sin(i),n.copy(l),n.x+=j*g.x+i*h.x,n.y+=j*g.y+i*h.y,n.z+=j*g.z+i*h.z,this.grid[b][d]=this.vertices.push(new THREE.Vector3(n.x,n.y,n.z))-1}for(b=0;b<this.segments;b++)for(d=0;d<this.radiusSegments;d++)f=e?(b+1)%this.segments:b+1,n=(d+1)%this.radiusSegments,a=this.grid[b][d],
