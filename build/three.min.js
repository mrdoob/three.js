...
f=THREE.Matrix4.__v1,e=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();if(g.length()===0)g.z=1;f.cross(c,g).normalize();if(f.length()===0){g.x=g.x+1E-4;f.cross(c,g).normalize()}e.cross(g,f);d[0]=f.x;d[4]=e.x;d[8]=g.x;d[1]=f.y;d[5]=e.y;d[9]=g.y;d[2]=f.z;d[6]=e.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,f=this.elements,e=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],n=c[9],m=c[13],q=c[2],p=c[6],o=c[10],r=c[14],t=c[3],u=c[7],v=c[11],c=c[15],s=d[0],A=d[4],
y=d[8],B=d[12],I=d[1],x=d[5],H=d[9],G=d[13],F=d[2],E=d[6],M=d[10],C=d[14],L=d[3],P=d[7],J=d[11],d=d[15];f[0]=e*s+g*I+h*F+i*L;f[4]=e*A+g*x+h*E+i*P;f[8]=e*y+g*H+h*M+i*J;f[12]=e*B+g*G+h*C+i*d;f[1]=j*s+l*I+n*F+m*L;f[5]=j*A+l*x+n*E+m*P;f[9]=j*y+l*H+n*M+m*J;f[13]=j*B+l*G+n*C+m*d;f[2]=q*s+p*I+o*F+r*L;f[6]=q*A+p*x+o*E+r*P;f[10]=q*y+p*H+o*M+r*J;f[14]=q*B+p*G+o*C+r*d;f[3]=t*s+u*I+v*F+c*L;f[7]=t*A+u*x+v*E+c*P;f[11]=t*y+u*H+v*M+c*J;f[15]=t*B+u*G+v*C+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
b);var a=j.dot(j),b=j.dot(l),c=j.dot(n),f=l.dot(l),d=l.dot(n),e=1/(a*f-b*b),f=(f*c-b*d)*e,a=(a*d-b*c)*e;return f>=0&&a>=0&&f+a<1},p=function(i,l,j){var n,o;if(i instanceof a.Particle){n=m(l.origin,l.direction,i.matrixWorld.getPosition());if(n>i.scale.x)return j;o={distance:n,point:i.position,face:null,object:i};j.push(o)}else if(i instanceof a.Mesh){var p=i.geometry.boundingSphere.radius*i.matrixWorld.getMaxScaleOnAxis();n=m(l.origin,l.direction,i.matrixWorld.getPosition());if(n>p)return j;var y,
B,I=i.geometry,x=I.vertices,H,G,F;H=i.geometry.materials;G=i.material instanceof a.MeshFaceMaterial;var E,M=l.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(l.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(l.direction);h.rotateAxis(d).normalize();p=0;for(y=I.faces.length;p<y;p++){o=I.faces[p];n=G===true?H[o.materialIndex]:i.material;if(n!==void 0){F=n.side;f.sub(o.centroid,c);e=o.normal;n=d.dot(e);if(!(Math.abs(n)<M)){B=e.dot(f)/n;if(!(B<0)&&(F===
a.DoubleSide||(F===a.FrontSide?n<0:n>0))){g.add(c,d.multiplyScalar(B));if(o instanceof a.Face3){n=x[o.a];B=x[o.b];F=x[o.c];if(q(g,n,B,F)){B=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(B);if(!(n<l.near||n>l.far)){o={distance:n,point:B,face:o,faceIndex:p,object:i};j.push(o)}}}else if(o instanceof a.Face4){n=x[o.a];B=x[o.b];F=x[o.c];E=x[o.d];if(q(g,n,B,E)||q(g,B,F,E)){B=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(B);if(!(n<l.near||n>l.far)){o={distance:n,point:B,face:o,faceIndex:p,
...
b.parent;b!==void 0&&b instanceof THREE.Scene&&b.__addObject(a)}},remove:function(a){var b=this.children.indexOf(a);if(b!==-1){a.parent=void 0;this.children.splice(b,1);for(b=this;b.parent!==void 0;)b=b.parent;b!==void 0&&b instanceof THREE.Scene&&b.__removeObject(a)}},getChildByName:function(a,b){var c,d,f;c=0;for(d=this.children.length;c<d;c++){f=this.children[c];if(f.name===a)return f;if(b){f=f.getChildByName(a,b);if(f!==void 0)return f}}},getDescendants:function(a){a===void 0&&(a=[]);Array.prototype.push.apply(a,
this.children);for(var b=0,c=this.children.length;b<c;b++)this.children[b].getDescendants(a);return a},updateMatrix:function(){this.matrix.setPosition(this.position);this.useQuaternion===true?this.matrix.setRotationFromQuaternion(this.quaternion):this.matrix.setRotationFromEuler(this.rotation,this.eulerOrder);if(this.scale.x!==1||this.scale.y!==1||this.scale.z!==1){this.matrix.scale(this.scale);this.boundRadiusScale=Math.max(this.scale.x,Math.max(this.scale.y,this.scale.z))}this.matrixWorldNeedsUpdate=
...
if(d<c)return false;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return true}var f,e,g=[],h=0,i,j,l=[],n=0,m,q,p=[],o=0,r,t=[],u=0,v,s,A=[],y=0,B,I,x=[],H=0,G={objects:[],sprites:[],lights:[],elements:[]},F=new THREE.Vector3,E=new THREE.Vector4,M=new THREE.Matrix4,C=new THREE.Matrix4,L=new THREE.Frustum,P=new THREE.Vector4,J=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);M.multiply(b.projectionMatrix,b.matrixWorldInverse);M.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);M.multiply(b.matrixWorld,b.projectionMatrixInverse);M.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n){var O=h.near,ba=h.far,ua=false,ha,na,aa,fa,U,Y,ea,oa,pa,xa,Ca,Da,Qa,va,fb,Ua,qb;I=s=r=q=0;G.elements.length=0;g.updateMatrixWorld();h.parent===
void 0&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);M.multiply(h.projectionMatrix,h.matrixWorldInverse);L.setFromMatrix(M);e=0;G.objects.length=0;G.sprites.length=0;G.lights.length=0;var gb=function(b){if(b.visible!==false){if((b instanceof THREE.Mesh||b instanceof THREE.Line)&&(b.frustumCulled===false||L.contains(b)===true)){F.copy(b.matrixWorld.getPosition());M.multiplyVector3(F);f=a();f.object=b;f.z=F.z;G.objects.push(f)}else if(b instanceof THREE.Sprite||b instanceof THREE.Particle){F.copy(b.matrixWorld.getPosition());
M.multiplyVector3(F);f=a();f.object=b;f.z=F.z;G.sprites.push(f)}else b instanceof THREE.Light&&G.lights.push(b);for(var c=0,d=b.children.length;c<d;c++)gb(b.children[c])}};gb(g);g=0;for(ha=G.objects.length;g<ha;g++){pa=G.objects[g].object;xa=pa.matrixWorld;j=0;if(pa instanceof THREE.Mesh){Ca=pa.geometry;Da=pa.geometry.materials;fa=Ca.vertices;Qa=Ca.faces;fb=Ca.faceVertexUvs;Ca=pa.matrixRotationWorld.extractRotation(xa);qb=pa.material instanceof THREE.MeshFaceMaterial;na=0;for(aa=fa.length;na<aa;na++){i=
b();i.positionWorld.copy(fa[na]);xa.multiplyVector3(i.positionWorld);i.positionScreen.copy(i.positionWorld);M.multiplyVector4(i.positionScreen);i.positionScreen.x=i.positionScreen.x/i.positionScreen.w;i.positionScreen.y=i.positionScreen.y/i.positionScreen.w;i.visible=i.positionScreen.z>O&&i.positionScreen.z<ba}fa=0;for(na=Qa.length;fa<na;fa++){oa=Qa[fa];aa=qb===true?Da[oa.materialIndex]:pa.material;if(aa!==void 0){ea=aa.side;if(oa instanceof THREE.Face3){U=l[oa.a];Y=l[oa.b];va=l[oa.c];if(U.visible===
true&&Y.visible===true&&va.visible===true){ua=(va.positionScreen.x-U.positionScreen.x)*(Y.positionScreen.y-U.positionScreen.y)-(va.positionScreen.y-U.positionScreen.y)*(Y.positionScreen.x-U.positionScreen.x)<0;if(ea===THREE.DoubleSide||ua===(ea===THREE.FrontSide)){if(q===o){Ua=new THREE.RenderableFace3;p.push(Ua);o++;q++;m=Ua}else m=p[q++];m.v1.copy(U);m.v2.copy(Y);m.v3.copy(va)}else continue}else continue}else if(oa instanceof THREE.Face4){U=l[oa.a];Y=l[oa.b];va=l[oa.c];Ua=l[oa.d];if(U.visible===
true&&Y.visible===true&&va.visible===true&&Ua.visible===true){ua=(Ua.positionScreen.x-U.positionScreen.x)*(Y.positionScreen.y-U.positionScreen.y)-(Ua.positionScreen.y-U.positionScreen.y)*(Y.positionScreen.x-U.positionScreen.x)<0||(Y.positionScreen.x-va.positionScreen.x)*(Ua.positionScreen.y-va.positionScreen.y)-(Y.positionScreen.y-va.positionScreen.y)*(Ua.positionScreen.x-va.positionScreen.x)<0;if(ea===THREE.DoubleSide||ua===(ea===THREE.FrontSide)){if(r===u){var ub=new THREE.RenderableFace4;t.push(ub);
u++;r++;m=ub}else m=t[r++];m.v1.copy(U);m.v2.copy(Y);m.v3.copy(va);m.v4.copy(Ua)}else continue}else continue}m.normalWorld.copy(oa.normal);ua===false&&(ea===THREE.BackSide||ea===THREE.DoubleSide)&&m.normalWorld.negate();Ca.multiplyVector3(m.normalWorld);m.centroidWorld.copy(oa.centroid);xa.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);M.multiplyVector3(m.centroidScreen);oa=oa.vertexNormals;U=0;for(Y=oa.length;U<Y;U++){va=m.vertexNormalsWorld[U];va.copy(oa[U]);ua===false&&
(ea===THREE.BackSide||ea===THREE.DoubleSide)&&va.negate();Ca.multiplyVector3(va)}m.vertexNormalsLength=oa.length;U=0;for(Y=fb.length;U<Y;U++){va=fb[U][fa];if(va!==void 0){ea=0;for(oa=va.length;ea<oa;ea++)m.uvs[U][ea]=va[ea]}}m.material=aa;m.z=m.centroidScreen.z;G.elements.push(m)}}}else if(pa instanceof THREE.Line){C.multiply(M,xa);fa=pa.geometry.vertices;U=b();U.positionScreen.copy(fa[0]);C.multiplyVector4(U.positionScreen);xa=pa.type===THREE.LinePieces?2:1;na=1;for(aa=fa.length;na<aa;na++){U=b();
U.positionScreen.copy(fa[na]);C.multiplyVector4(U.positionScreen);if(!((na+1)%xa>0)){Y=l[j-2];P.copy(U.positionScreen);J.copy(Y.positionScreen);if(d(P,J)===true){P.multiplyScalar(1/P.w);J.multiplyScalar(1/J.w);if(s===y){Da=new THREE.RenderableLine;A.push(Da);y++;s++;v=Da}else v=A[s++];v.v1.positionScreen.copy(P);v.v2.positionScreen.copy(J);v.z=Math.max(P.z,J.z);v.material=pa.material;G.elements.push(v)}}}}}g=0;for(ha=G.sprites.length;g<ha;g++){pa=G.sprites[g].object;xa=pa.matrixWorld;if(pa instanceof
THREE.Particle){E.set(xa.elements[12],xa.elements[13],xa.elements[14],1);M.multiplyVector4(E);E.z=E.z/E.w;if(E.z>0&&E.z<1){if(I===H){O=new THREE.RenderableParticle;x.push(O);H++;I++;B=O}else B=x[I++];B.object=pa;B.x=E.x/E.w;B.y=E.y/E.w;B.z=E.z;B.rotation=pa.rotation.z;B.scale.x=pa.scale.x*Math.abs(B.x-(E.x+h.projectionMatrix.elements[0])/(E.w+h.projectionMatrix.elements[12]));B.scale.y=pa.scale.y*Math.abs(B.y-(E.y+h.projectionMatrix.elements[5])/(E.w+h.projectionMatrix.elements[13]));B.material=pa.material;
G.elements.push(B)}}}n&&G.elements.sort(c);return G}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=d!==void 0?d:1};
...
j=a.vertices[d];l=g[f];n=g[e];m=g[C];q=i.x-h.x;p=j.x-h.x;o=i.y-h.y;r=j.y-h.y;t=i.z-h.z;u=j.z-h.z;v=n.u-l.u;s=m.u-l.u;A=n.v-l.v;y=m.v-l.v;B=1/(v*y-s*A);G.set((y*q-A*p)*B,(y*o-A*r)*B,(y*t-A*u)*B);F.set((v*p-s*q)*B,(v*r-s*o)*B,(v*u-s*t)*B);x[b].addSelf(G);x[c].addSelf(G);x[d].addSelf(G);H[b].addSelf(F);H[c].addSelf(F);H[d].addSelf(F)}var b,c,d,f,e,g,h,i,j,l,n,m,q,p,o,r,t,u,v,s,A,y,B,I,x=[],H=[],G=new THREE.Vector3,F=new THREE.Vector3,E=new THREE.Vector3,M=new THREE.Vector3,C=new THREE.Vector3;b=0;for(c=
this.vertices.length;b<c;b++){x[b]=new THREE.Vector3;H[b]=new THREE.Vector3}b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];g=this.faceVertexUvs[0][b];if(e instanceof THREE.Face3)a(this,e.a,e.b,e.c,0,1,2);else if(e instanceof THREE.Face4){a(this,e.a,e.b,e.d,0,1,3);a(this,e.b,e.c,e.d,1,2,3)}}var L=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];for(d=0;d<e.vertexNormals.length;d++){C.copy(e.vertexNormals[d]);f=e[L[d]];I=x[f];E.copy(I);E.subSelf(C.multiplyScalar(C.dot(I))).normalize();
M.cross(e.vertexNormals[d],I);f=M.dot(H[f]);f=f<0?-1:1;e.vertexTangents[d]=new THREE.Vector4(E.x,E.y,E.z,f)}}this.hasTangents=true},computeBoundingBox:function(){if(!this.boundingBox)this.boundingBox={min:new THREE.Vector3,max:new THREE.Vector3};if(this.vertices.length>0){var a;a=this.vertices[0];this.boundingBox.min.copy(a);this.boundingBox.max.copy(a);for(var b=this.boundingBox.min,c=this.boundingBox.max,d=1,f=this.vertices.length;d<f;d++){a=this.vertices[d];if(a.x<b.x)b.x=a.x;else if(a.x>c.x)c.x=
...
0}var f=this.offsets,e=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,n,m,q,p=new THREE.Vector3,o=new THREE.Vector3,r=new THREE.Vector3,t=new THREE.Vector3,u=new THREE.Vector3;c=0;for(d=f.length;c<d;++c){b=f[c].start;i=f[c].count;var v=f[c].index;a=b;for(b=b+i;a<b;a=a+3){i=v+e[a];j=v+e[a+1];l=v+e[a+2];n=g[i*3];m=g[i*3+1];q=g[i*3+2];p.set(n,m,q);n=g[j*3];m=g[j*3+1];q=g[j*3+2];o.set(n,m,q);n=g[l*3];m=g[l*3+1];q=g[l*3+2];r.set(n,m,q);t.sub(r,o);u.sub(p,
o);t.crossSelf(u);h[i*3]=h[i*3]+t.x;h[i*3+1]=h[i*3+1]+t.y;h[i*3+2]=h[i*3+2]+t.z;h[j*3]=h[j*3]+t.x;h[j*3+1]=h[j*3+1]+t.y;h[j*3+2]=h[j*3+2]+t.z;h[l*3]=h[l*3]+t.x;h[l*3+1]=h[l*3+1]+t.y;h[l*3+2]=h[l*3+2]+t.z}}a=0;for(b=h.length;a<b;a=a+3){n=h[a];m=h[a+1];q=h[a+2];c=1/Math.sqrt(n*n+m*m+q*q);h[a]=h[a]*c;h[a+1]=h[a+1]*c;h[a+2]=h[a+2]*c}this.normalsNeedUpdate=true}},computeTangents:function(){function a(a){K.x=d[a*3];K.y=d[a*3+1];K.z=d[a*3+2];N.copy(K);ba=i[a];J.copy(ba);J.subSelf(K.multiplyScalar(K.dot(ba))).normalize();
W.cross(N,ba);ua=W.dot(j[a]);O=ua<0?-1:1;h[a*4]=J.x;h[a*4+1]=J.y;h[a*4+2]=J.z;h[a*4+3]=O}if(this.attributes.index===void 0||this.attributes.position===void 0||this.attributes.normal===void 0||this.attributes.uv===void 0)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,e=c.length/3;if(this.attributes.tangent===
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<e;g++){i[g]=new THREE.Vector3;j[g]=new THREE.Vector3}var l,n,m,q,p,o,r,t,u,v,s,A,y,B,I,e=new THREE.Vector3,g=new THREE.Vector3,x,H,G,F,E,M,C,L=this.offsets;G=0;for(F=L.length;G<F;++G){H=L[G].start;E=L[G].count;var P=L[G].index;x=H;for(H=H+E;x<H;x=x+3){E=P+b[x];M=P+b[x+1];C=P+b[x+2];l=c[E*3];n=c[E*3+1];m=c[E*3+2];q=c[M*3];p=c[M*3+1];o=c[M*3+2];r=c[C*3];
t=c[C*3+1];u=c[C*3+2];v=f[E*2];s=f[E*2+1];A=f[M*2];y=f[M*2+1];B=f[C*2];I=f[C*2+1];q=q-l;l=r-l;p=p-n;n=t-n;o=o-m;m=u-m;A=A-v;v=B-v;y=y-s;s=I-s;I=1/(A*s-v*y);e.set((s*q-y*l)*I,(s*p-y*n)*I,(s*o-y*m)*I);g.set((A*l-v*q)*I,(A*n-v*p)*I,(A*m-v*o)*I);i[E].addSelf(e);i[M].addSelf(e);i[C].addSelf(e);j[E].addSelf(g);j[M].addSelf(g);j[C].addSelf(g)}}var J=new THREE.Vector3,W=new THREE.Vector3,K=new THREE.Vector3,N=new THREE.Vector3,O,ba,ua;G=0;for(F=L.length;G<F;++G){H=L[G].start;E=L[G].count;P=L[G].index;x=H;
for(H=H+E;x<H;x=x+3){E=P+b[x];M=P+b[x+1];C=P+b[x+2];a(E);a(M);a(C)}}this.tangentsNeedUpdate=this.hasTangents=true}}};
...
h[j[1]]}var t=a[f],a=b+"/"+e,f=new Image;f.onload=function(){if(!c(this.width)||!c(this.height)){var a=d(this.width),b=d(this.height);t.image.width=a;t.image.height=b;t.image.getContext("2d").drawImage(this,0,0,a,b)}else t.image=this;t.needsUpdate=true};f.crossOrigin=g.crossOrigin;f.src=a}function e(a){return(a[0]*255<<16)+(a[1]*255<<8)+a[2]*255}var g=this,h="MeshLambertMaterial",i={color:15658734,opacity:1,map:null,lightMap:null,normalMap:null,bumpMap:null,wireframe:false};if(a.shading){var j=a.shading.toLowerCase();
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,j,l,n,m,q,p,o,r,t,u,v,s;function A(a){return a%4?4-a%4:0}function y(a,b){return(new Uint8Array(a,b,1))[0]}function B(a,b){return(new Uint32Array(a,b,1))[0]}function I(b,c){var d,f,e,g,h,i,l,j,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=P[f*2];f=P[f*2+1];i=P[e*2];l=P[e*2+1];e=P[g*2];j=P[g*2+1];g=M.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,l));m.push(new THREE.UV(e,
j));g.push(m)}}function x(b,c){var d,f,e,g,h,i,l,j,n,m,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){f=o[d*4];e=o[d*4+1];g=o[d*4+2];h=o[d*4+3];i=P[f*2];f=P[f*2+1];l=P[e*2];n=P[e*2+1];j=P[g*2];m=P[g*2+1];g=P[h*2];e=P[h*2+1];h=M.faceVertexUvs[0];var p=[];p.push(new THREE.UV(i,f));p.push(new THREE.UV(l,n));p.push(new THREE.UV(j,m));p.push(new THREE.UV(g,e));h.push(p)}}function H(b,c,d){for(var f,e,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*3];e=c[d*3+1];g=c[d*3+2];h=i[d];
M.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function G(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),l=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=l[d];M.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function F(b,c,d,f){for(var e,g,h,i,l,j,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];l=d[f*3];j=d[f*3+1];n=d[f*3+2];i=m[f];var o=L[j*3],p=L[j*3+1];j=L[j*3+2];var q=L[n*3],
s=L[n*3+1];n=L[n*3+2];M.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(L[l*3],L[l*3+1],L[l*3+2]),new THREE.Vector3(o,p,j),new THREE.Vector3(q,s,n)],null,i))}}function E(b,c,d,f){for(var e,g,h,i,l,j,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];j=d[f*4];n=d[f*4+1];m=d[f*4+2];o=d[f*4+3];l=p[f];var q=L[n*3],s=L[n*3+1];n=L[n*3+2];var t=L[m*3],r=L[m*3+1];m=L[m*3+2];var u=L[o*3],v=L[o*3+1];o=L[o*3+2];M.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(L[j*3],L[j*3+1],L[j*3+2]),new THREE.Vector3(q,s,n),new THREE.Vector3(t,r,m),new THREE.Vector3(u,v,o)],null,l))}}var M=this,C=0,L=[],P=[],J,W,K;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(M,d,b);s=a;W=C;b=new Uint8Array(s,W,12);o="";for(u=0;u<12;u++)o=o+String.fromCharCode(b[W+u]);c=y(s,W+12);y(s,W+13);y(s,W+14);y(s,W+15);f=y(s,W+16);i=y(s,W+17);j=y(s,W+18);l=y(s,W+19);n=B(s,W+20);m=B(s,W+20+4);q=B(s,W+20+8);p=B(s,W+20+12);o=B(s,W+20+16);r=B(s,W+20+20);t=
B(s,W+20+24);u=B(s,W+20+28);b=B(s,W+20+32);v=B(s,W+20+36);s=B(s,W+20+40);C=C+c;W=f*3+l;K=f*4+l;J=p*W;c=o*(W+i*3);f=r*(W+j*3);l=t*(W+i*3+j*3);W=u*K;i=b*(K+i*4);j=v*(K+j*4);K=C;var C=new Float32Array(a,C,n*3),N,O,ba,ua;for(N=0;N<n;N++){O=C[N*3];ba=C[N*3+1];ua=C[N*3+2];M.vertices.push(new THREE.Vector3(O,ba,ua))}n=C=K+n*3*Float32Array.BYTES_PER_ELEMENT;if(m){C=new Int8Array(a,C,m*3);for(K=0;K<m;K++){N=C[K*3];O=C[K*3+1];ba=C[K*3+2];L.push(N/127,O/127,ba/127)}}C=n+m*3*Int8Array.BYTES_PER_ELEMENT;m=C=C+
A(m*3);if(q){C=new Float32Array(a,C,q*2);for(n=0;n<q;n++){K=C[n*2];N=C[n*2+1];P.push(K,N)}}q=C=m+q*2*Float32Array.BYTES_PER_ELEMENT;J=q+J+A(p*2);m=J+c+A(o*2);c=m+f+A(r*2);f=c+l+A(t*2);W=f+W+A(u*2);l=W+i+A(b*2);i=l+j+A(v*2);if(r){j=m+r*Uint32Array.BYTES_PER_ELEMENT*3;H(r,m,j+r*Uint32Array.BYTES_PER_ELEMENT*3);I(r,j)}if(t){r=c+t*Uint32Array.BYTES_PER_ELEMENT*3;j=r+t*Uint32Array.BYTES_PER_ELEMENT*3;F(t,c,r,j+t*Uint32Array.BYTES_PER_ELEMENT*3);I(t,j)}if(v){t=l+v*Uint32Array.BYTES_PER_ELEMENT*4;G(v,l,
t+v*Uint32Array.BYTES_PER_ELEMENT*4);x(v,t)}if(s){v=i+s*Uint32Array.BYTES_PER_ELEMENT*4;t=v+s*Uint32Array.BYTES_PER_ELEMENT*4;E(s,i,v,t+s*Uint32Array.BYTES_PER_ELEMENT*4);x(s,t)}p&&H(p,q,q+p*Uint32Array.BYTES_PER_ELEMENT*3);if(o){p=J+o*Uint32Array.BYTES_PER_ELEMENT*3;F(o,J,p,p+o*Uint32Array.BYTES_PER_ELEMENT*3)}u&&G(u,f,f+u*Uint32Array.BYTES_PER_ELEMENT*4);if(b){o=W+b*Uint32Array.BYTES_PER_ELEMENT*4;E(b,W,o,o+b*Uint32Array.BYTES_PER_ELEMENT*4)}this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,j,l,n,m,q,p,o,r,t,u,v=a.faces;q=a.vertices;var s=a.normals,A=a.colors,y=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&y++;for(e=0;e<y;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}c=0;for(i=q.length;c<i;){j=new THREE.Vector3;j.x=q[c++]*f;j.y=q[c++]*f;j.z=q[c++]*f;d.vertices.push(j)}c=0;for(i=v.length;c<i;){q=v[c++];j=q&1;h=q&2;e=q&4;g=q&8;n=q&
16;l=q&32;p=q&64;q=q&128;if(j){o=new THREE.Face4;o.a=v[c++];o.b=v[c++];o.c=v[c++];o.d=v[c++];j=4}else{o=new THREE.Face3;o.a=v[c++];o.b=v[c++];o.c=v[c++];j=3}if(h){h=v[c++];o.materialIndex=h}h=d.faces.length;if(e)for(e=0;e<y;e++){r=a.uvs[e];m=v[c++];u=r[m*2];m=r[m*2+1];d.faceUvs[e][h]=new THREE.UV(u,m)}if(g)for(e=0;e<y;e++){r=a.uvs[e];t=[];for(g=0;g<j;g++){m=v[c++];u=r[m*2];m=r[m*2+1];t[g]=new THREE.UV(u,m)}d.faceVertexUvs[e][h]=t}if(n){n=v[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];
o.normal=g}if(l)for(e=0;e<j;e++){n=v[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];o.vertexNormals.push(g)}if(p){l=v[c++];l=new THREE.Color(A[l]);o.color=l}if(q)for(e=0;e<j;e++){l=v[c++];l=new THREE.Color(A[l]);o.vertexColors.push(l)}d.faces.push(o)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c=c+2){v=a.skinWeights[c];s=a.skinWeights[c+1];d.skinWeights.push(new THREE.Vector4(v,s,0,0))}}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c=c+2){v=a.skinIndices[c];s=a.skinIndices[c+
1];d.skinIndices.push(new THREE.Vector4(v,s,0,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets!==void 0){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];A=d.morphTargets[c].vertices;y=a.morphTargets[c].vertices;v=0;for(s=y.length;v<s;v=v+3){q=new THREE.Vector3;q.x=y[v]*f;q.y=y[v+1]*f;q.z=y[v+2]*f;A.push(q)}}}if(a.morphColors!==void 0){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};
...
if(g.DbgName!==void 0)m.name=g.DbgName;d.materials[e]=m}}var g=a.faces,p=a.vertices,m=a.normals,j=a.colors,l=0;if(a.uvs)for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&l++;for(e=0;e<l;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}n=0;for(q=p.length;n<q;){var o=new THREE.Vector3;o.x=p[n++]*f;o.y=p[n++]*f;o.z=p[n++]*f;d.vertices.push(o)}n=0;for(q=g.length;n<q;){var r=g[n++],t=r&2,e=r&4,u=r&8,v=r&16,p=r&32,s=r&64,o=r&128;if(r&1){r=new THREE.Face4;r.a=g[n++];r.b=g[n++];r.c=g[n++];r.d=g[n++];var A=4}else{r=new THREE.Face3;
r.a=g[n++];r.b=g[n++];r.c=g[n++];A=3}if(t){t=g[n++];r.materialIndex=t}var y=d.faces.length;if(e)for(e=0;e<l;e++){var B=a.uvs[e],t=g[n++],I=B[t*2],t=B[t*2+1];d.faceUvs[e][y]=new THREE.UV(I,t)}if(u)for(e=0;e<l;e++){for(var B=a.uvs[e],u=[],x=0;x<A;x++){t=g[n++];I=B[t*2];t=B[t*2+1];u[x]=new THREE.UV(I,t)}d.faceVertexUvs[e][y]=u}if(v){v=g[n++]*3;t=new THREE.Vector3;t.x=m[v++];t.y=m[v++];t.z=m[v];r.normal=t}if(p)for(e=0;e<A;e++){v=g[n++]*3;t=new THREE.Vector3;t.x=m[v++];t.y=m[v++];t.z=m[v];r.vertexNormals.push(t)}if(s){p=
...
g;e++){d.morphTargets[e]={};d.morphTargets[e].name=a.morphTargets[e].name;d.morphTargets[e].vertices=[];m=d.morphTargets[e].vertices;j=a.morphTargets[e].vertices;t=0;for(l=j.length;t<l;t=t+3){o=new THREE.Vector3;o.x=j[t]*f;o.y=j[t+1]*f;o.z=j[t+2]*f;m.push(o)}}}if(a.morphColors){e=0;for(g=a.morphColors.length;e<g;e++){d.morphColors[e]={};d.morphColors[e].name=a.morphColors[e].name;d.morphColors[e].colors=[];f=d.morphColors[e].colors;j=a.morphColors[e].colors;m=0;for(l=j.length;m<l;m=m+3){n=new THREE.Color(16755200);
...
THREE.SceneLoader.prototype.createScene=function(a,b,c){function d(a,b){return b=="relativeToHTML"?a:j+"/"+a}function f(a,b){var c;for(m in b)if(N.objects[m]===void 0){t=b[m];if(t.geometry!==void 0){if(G=N.geometries[t.geometry]){c=false;F=N.materials[t.materials[0]];(c=F instanceof THREE.ShaderMaterial)&&G.computeTangents();A=t.position;y=t.rotation;B=t.quaternion;I=t.scale;u=t.matrix;B=0;t.materials.length==0&&(F=new THREE.MeshFaceMaterial);t.materials.length>1&&(F=new THREE.MeshFaceMaterial);c=
new THREE.Mesh(G,F);c.name=m;if(u){c.matrixAutoUpdate=false;c.matrix.set(u[0],u[1],u[2],u[3],u[4],u[5],u[6],u[7],u[8],u[9],u[10],u[11],u[12],u[13],u[14],u[15])}else{c.position.set(A[0],A[1],A[2]);if(B){c.quaternion.set(B[0],B[1],B[2],B[3]);c.useQuaternion=true}else c.rotation.set(y[0],y[1],y[2]);c.scale.set(I[0],I[1],I[2])}c.visible=t.visible;c.castShadow=t.castShadow;c.receiveShadow=t.receiveShadow;a.add(c);N.objects[m]=c}}else{A=t.position;y=t.rotation;B=t.quaternion;I=t.scale;B=0;c=new THREE.Object3D;
c.name=m;c.position.set(A[0],A[1],A[2]);if(B){c.quaternion.set(B[0],B[1],B[2],B[3]);c.useQuaternion=true}else c.rotation.set(y[0],y[1],y[2]);c.scale.set(I[0],I[1],I[2]);c.visible=t.visible!==void 0?t.visible:false;a.add(c);N.objects[m]=c;N.empties[m]=c}if(t.properties!==void 0)for(var d in t.properties)c.properties[d]=t.properties[d];t.children!==void 0&&f(c,t.children)}}function e(a){return function(b){N.geometries[a]=b;f(N.scene,C.objects);P=P-1;i.onLoadComplete();h()}}function g(a){return function(b){N.geometries[a]=
b}}function h(){i.callbackProgress({totalModels:W,totalTextures:K,loadedModels:W-P,loadedTextures:K-J},N);i.onLoadProgress();P===0&&J===0&&b(N)}var i=this,j=THREE.Loader.prototype.extractUrlBase(c),l,n,m,q,p,o,r,t,u,v,s,A,y,B,I,x,H,G,F,E,M,C,L,P,J,W,K,N;C=a;c=new THREE.BinaryLoader;L=new THREE.JSONLoader;J=P=0;N={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(C.transform){a=C.transform.position;v=C.transform.rotation;x=C.transform.scale;
a&&N.scene.position.set(a[0],a[1],a[2]);v&&N.scene.rotation.set(v[0],v[1],v[2]);x&&N.scene.scale.set(x[0],x[1],x[2]);if(a||v||x){N.scene.updateMatrix();N.scene.updateMatrixWorld()}}a=function(a){return function(){J=J-a;h();i.onLoadComplete()}};for(p in C.cameras){x=C.cameras[p];x.type==="perspective"?E=new THREE.PerspectiveCamera(x.fov,x.aspect,x.near,x.far):x.type==="ortho"&&(E=new THREE.OrthographicCamera(x.left,x.right,x.top,x.bottom,x.near,x.far));A=x.position;v=x.target;x=x.up;E.position.set(A[0],
A[1],A[2]);E.target=new THREE.Vector3(v[0],v[1],v[2]);x&&E.up.set(x[0],x[1],x[2]);N.cameras[p]=E}for(q in C.lights){v=C.lights[q];p=v.color!==void 0?v.color:16777215;E=v.intensity!==void 0?v.intensity:1;if(v.type==="directional"){A=v.direction;s=new THREE.DirectionalLight(p,E);s.position.set(A[0],A[1],A[2]);s.position.normalize()}else if(v.type==="point"){A=v.position;s=v.distance;s=new THREE.PointLight(p,E,s);s.position.set(A[0],A[1],A[2])}else v.type==="ambient"&&(s=new THREE.AmbientLight(p));N.scene.add(s);
N.lights[q]=s}for(o in C.fogs){q=C.fogs[o];q.type==="linear"?M=new THREE.Fog(0,q.near,q.far):q.type==="exp2"&&(M=new THREE.FogExp2(0,q.density));x=q.color;M.color.setRGB(x[0],x[1],x[2]);N.fogs[o]=M}if(N.cameras&&C.defaults.camera)N.currentCamera=N.cameras[C.defaults.camera];if(N.fogs&&C.defaults.fog)N.scene.fog=N.fogs[C.defaults.fog];x=C.defaults.bgcolor;N.bgColor=new THREE.Color;N.bgColor.setRGB(x[0],x[1],x[2]);N.bgColorAlpha=C.defaults.bgalpha;for(l in C.geometries){o=C.geometries[l];if(o.type==
"bin_mesh"||o.type=="ascii_mesh"){P=P+1;i.onLoadStart()}}W=P;for(l in C.geometries){o=C.geometries[l];if(o.type==="cube"){G=new THREE.CubeGeometry(o.width,o.height,o.depth,o.segmentsWidth,o.segmentsHeight,o.segmentsDepth,null,o.flipped,o.sides);N.geometries[l]=G}else if(o.type==="plane"){G=new THREE.PlaneGeometry(o.width,o.height,o.segmentsWidth,o.segmentsHeight);N.geometries[l]=G}else if(o.type==="sphere"){G=new THREE.SphereGeometry(o.radius,o.segmentsWidth,o.segmentsHeight);N.geometries[l]=G}else if(o.type===
"cylinder"){G=new THREE.CylinderGeometry(o.topRad,o.botRad,o.height,o.radSegs,o.heightSegs);N.geometries[l]=G}else if(o.type==="torus"){G=new THREE.TorusGeometry(o.radius,o.tube,o.segmentsR,o.segmentsT);N.geometries[l]=G}else if(o.type==="icosahedron"){G=new THREE.IcosahedronGeometry(o.radius,o.subdivisions);N.geometries[l]=G}else if(o.type==="bin_mesh")c.load(d(o.url,C.urlBaseType),e(l));else if(o.type==="ascii_mesh")L.load(d(o.url,C.urlBaseType),e(l));else if(o.type==="embedded_mesh"){o=C.embeds[o.id];
o.metadata=C.metadata;o&&L.createModel(o,g(l),"")}}for(r in C.textures){l=C.textures[r];if(l.url instanceof Array){J=J+l.url.length;for(o=0;o<l.url.length;o++)i.onLoadStart()}else{J=J+1;i.onLoadStart()}}K=J;for(r in C.textures){l=C.textures[r];if(l.mapping!==void 0&&THREE[l.mapping]!==void 0)l.mapping=new THREE[l.mapping];if(l.url instanceof Array){o=l.url.length;M=[];for(c=0;c<o;c++)M[c]=d(l.url[c],C.urlBaseType);o=THREE.ImageUtils.loadTextureCube(M,l.mapping,a(o))}else{o=THREE.ImageUtils.loadTexture(d(l.url,
...
M[l.wrap[1]]}}N.textures[r]=o}for(n in C.materials){u=C.materials[n];for(H in u.parameters)if(H==="envMap"||H==="map"||H==="lightMap")u.parameters[H]=N.textures[u.parameters[H]];else if(H==="shading")u.parameters[H]=u.parameters[H]=="flat"?THREE.FlatShading:THREE.SmoothShading;else if(H==="blending")u.parameters[H]=u.parameters[H]in THREE?THREE[u.parameters[H]]:THREE.NormalBlending;else if(H==="combine")u.parameters[H]=u.parameters[H]=="MixOperation"?THREE.MixOperation:THREE.MultiplyOperation;else if(H===
"vertexColors")if(u.parameters[H]=="face")u.parameters[H]=THREE.FaceColors;else if(u.parameters[H])u.parameters[H]=THREE.VertexColors;if(u.parameters.opacity!==void 0&&u.parameters.opacity<1)u.parameters.transparent=true;if(u.parameters.normalMap){r=THREE.ShaderUtils.lib.normal;a=THREE.UniformsUtils.clone(r.uniforms);l=u.parameters.color;o=u.parameters.specular;M=u.parameters.ambient;c=u.parameters.shininess;a.tNormal.value=N.textures[u.parameters.normalMap];if(u.parameters.normalMapFactor)a.uNormalScale.value=
u.parameters.normalMapFactor;if(u.parameters.map){a.tDiffuse.value=u.parameters.map;a.enableDiffuse.value=true}if(u.parameters.lightMap){a.tAO.value=u.parameters.lightMap;a.enableAO.value=true}if(u.parameters.specularMap){a.tSpecular.value=N.textures[u.parameters.specularMap];a.enableSpecular.value=true}a.uDiffuseColor.value.setHex(l);a.uSpecularColor.value.setHex(o);a.uAmbientColor.value.setHex(M);a.uShininess.value=c;if(u.parameters.opacity)a.uOpacity.value=u.parameters.opacity;F=new THREE.ShaderMaterial({fragmentShader:r.fragmentShader,
vertexShader:r.vertexShader,uniforms:a,lights:true,fog:true})}else F=new THREE[u.type](u.parameters);N.materials[n]=F}f(N.scene,C.objects);i.callbackSync(N);h()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
void 0?a.canvas:document.createElement("canvas"),n,m,q,p,o=l.getContext("2d"),r=new THREE.Color(0),t=0,u=1,v=0,s=null,A=null,y=null,B=null,I=null,x,H,G,F,E=new THREE.RenderableVertex,M=new THREE.RenderableVertex,C,L,P,J,W,K,N,O,ba,ua,ha,na,aa=new THREE.Color,fa=new THREE.Color,U=new THREE.Color,Y=new THREE.Color,ea=new THREE.Color,oa=[],pa=[],xa,Ca,Da,Qa,va,fb,Ua,qb,gb,ub,Ya=new THREE.Rectangle,Ia=new THREE.Rectangle,Ea=new THREE.Rectangle,hb=false,Ga=new THREE.Color,cb=new THREE.Color,Za=new THREE.Color,
sa=new THREE.Vector3,Ka,Va,ib,k,eb,jb,a=16;Ka=document.createElement("canvas");Ka.width=Ka.height=2;Va=Ka.getContext("2d");Va.fillStyle="rgba(0,0,0,1)";Va.fillRect(0,0,2,2);ib=Va.getImageData(0,0,2,2);k=ib.data;eb=document.createElement("canvas");eb.width=eb.height=a;jb=eb.getContext("2d");jb.translate(-a/2,-a/2);jb.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=true;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){n=a;m=b;q=Math.floor(n/2);p=
Math.floor(m/2);l.width=n;l.height=m;Ya.set(-q,-p,q,p);Ia.set(-q,-p,q,p);u=1;v=0;I=B=y=A=s=null};this.setClearColor=function(a,b){r.copy(a);t=b!==void 0?b:1;Ia.set(-q,-p,q,p)};this.setClearColorHex=function(a,b){r.setHex(a);t=b!==void 0?b:1;Ia.set(-q,-p,q,p)};this.clear=function(){o.setTransform(1,0,0,-1,q,p);if(Ia.isEmpty()===false){Ia.minSelf(Ya);Ia.inflate(2);t<1&&o.clearRect(Math.floor(Ia.getX()),Math.floor(Ia.getY()),Math.floor(Ia.getWidth()),Math.floor(Ia.getHeight()));if(t>0){c(THREE.NormalBlending);
b(1);f("rgba("+Math.floor(r.r*255)+","+Math.floor(r.g*255)+","+Math.floor(r.b*255)+","+t+")");o.fillRect(Math.floor(Ia.getX()),Math.floor(Ia.getY()),Math.floor(Ia.getWidth()),Math.floor(Ia.getHeight()))}Ia.empty()}};this.render=function(a,l){function n(a,b,c){for(var d=0,f=i.length;d<f;d++){var e=i[d],g=e.color;if(e instanceof THREE.DirectionalLight){var h=e.matrixWorld.getPosition().normalize(),k=b.dot(h);if(!(k<=0)){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}else if(e instanceof
THREE.PointLight){h=e.matrixWorld.getPosition();k=b.dot(sa.sub(h,a).normalize());if(!(k<=0)){k=k*(e.distance==0?1:1-Math.min(a.distanceTo(h)/e.distance,1));if(k!=0){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}}}}function m(a,d,f,g,h,i,k,j){e.info.render.vertices=e.info.render.vertices+3;e.info.render.faces++;b(j.opacity);c(j.blending);C=a.positionScreen.x;L=a.positionScreen.y;P=d.positionScreen.x;J=d.positionScreen.y;W=f.positionScreen.x;K=f.positionScreen.y;s(C,L,P,J,W,K);if(j instanceof
THREE.MeshBasicMaterial)if(j.map!==null){if(j.map.mapping instanceof THREE.UVMapping){Qa=k.uvs[0];hc(C,L,P,J,W,K,Qa[g].u,Qa[g].v,Qa[h].u,Qa[h].v,Qa[i].u,Qa[i].v,j.map)}}else if(j.envMap!==null){if(j.envMap.mapping instanceof THREE.SphericalReflectionMapping){a=l.matrixWorldInverse;sa.copy(k.vertexNormalsWorld[g]);va=(sa.x*a.elements[0]+sa.y*a.elements[4]+sa.z*a.elements[8])*0.5+0.5;fb=(sa.x*a.elements[1]+sa.y*a.elements[5]+sa.z*a.elements[9])*0.5+0.5;sa.copy(k.vertexNormalsWorld[h]);Ua=(sa.x*a.elements[0]+
sa.y*a.elements[4]+sa.z*a.elements[8])*0.5+0.5;qb=(sa.x*a.elements[1]+sa.y*a.elements[5]+sa.z*a.elements[9])*0.5+0.5;sa.copy(k.vertexNormalsWorld[i]);gb=(sa.x*a.elements[0]+sa.y*a.elements[4]+sa.z*a.elements[8])*0.5+0.5;ub=(sa.x*a.elements[1]+sa.y*a.elements[5]+sa.z*a.elements[9])*0.5+0.5;hc(C,L,P,J,W,K,va,fb,Ua,qb,gb,ub,j.envMap)}}else j.wireframe===true?t(j.color,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):Nb(j.color);else if(j instanceof THREE.MeshLambertMaterial)if(hb===true)if(j.wireframe===
false&&j.shading==THREE.SmoothShading&&k.vertexNormalsLength==3){fa.r=U.r=Y.r=Ga.r;fa.g=U.g=Y.g=Ga.g;fa.b=U.b=Y.b=Ga.b;n(k.v1.positionWorld,k.vertexNormalsWorld[0],fa);n(k.v2.positionWorld,k.vertexNormalsWorld[1],U);n(k.v3.positionWorld,k.vertexNormalsWorld[2],Y);fa.r=Math.max(0,Math.min(j.color.r*fa.r,1));fa.g=Math.max(0,Math.min(j.color.g*fa.g,1));fa.b=Math.max(0,Math.min(j.color.b*fa.b,1));U.r=Math.max(0,Math.min(j.color.r*U.r,1));U.g=Math.max(0,Math.min(j.color.g*U.g,1));U.b=Math.max(0,Math.min(j.color.b*
U.b,1));Y.r=Math.max(0,Math.min(j.color.r*Y.r,1));Y.g=Math.max(0,Math.min(j.color.g*Y.g,1));Y.b=Math.max(0,Math.min(j.color.b*Y.b,1));ea.r=(U.r+Y.r)*0.5;ea.g=(U.g+Y.g)*0.5;ea.b=(U.b+Y.b)*0.5;Da=u(fa,U,Y,ea);r(C,L,P,J,W,K,0,0,1,0,0,1,Da)}else{aa.r=Ga.r;aa.g=Ga.g;aa.b=Ga.b;n(k.centroidWorld,k.normalWorld,aa);aa.r=Math.max(0,Math.min(j.color.r*aa.r,1));aa.g=Math.max(0,Math.min(j.color.g*aa.g,1));aa.b=Math.max(0,Math.min(j.color.b*aa.b,1));j.wireframe===true?t(aa,j.wireframeLinewidth,j.wireframeLinecap,
j.wireframeLinejoin):Nb(aa)}else j.wireframe===true?t(j.color,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):Nb(j.color);else if(j instanceof THREE.MeshDepthMaterial){xa=l.near;Ca=l.far;fa.r=fa.g=fa.b=1-v(a.positionScreen.z,xa,Ca);U.r=U.g=U.b=1-v(d.positionScreen.z,xa,Ca);Y.r=Y.g=Y.b=1-v(f.positionScreen.z,xa,Ca);ea.r=(U.r+Y.r)*0.5;ea.g=(U.g+Y.g)*0.5;ea.b=(U.b+Y.b)*0.5;Da=u(fa,U,Y,ea);r(C,L,P,J,W,K,0,0,1,0,0,1,Da)}else if(j instanceof THREE.MeshNormalMaterial){aa.r=A(k.normalWorld.x);
aa.g=A(k.normalWorld.y);aa.b=A(k.normalWorld.z);j.wireframe===true?t(aa,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):Nb(aa)}}function s(a,b,c,d,f,e){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.closePath()}function rb(a,b,c,d,f,e,g,h){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.lineTo(g,h);o.closePath()}function t(a,b,c,f){if(y!==b)y=o.lineWidth=b;if(B!==c)B=o.lineCap=c;if(I!==f)I=o.lineJoin=f;d(a.getContextStyle());o.stroke();Ea.inflate(b*2)}function Nb(a){f(a.getContextStyle());
o.fill()}function hc(a,b,c,d,e,g,h,i,k,j,l,n,m){if(!(m.image===void 0||m.image.width===0)){if(m.needsUpdate===true||oa[m.id]===void 0){var p=m.wrapS==THREE.RepeatWrapping,rb=m.wrapT==THREE.RepeatWrapping;oa[m.id]=o.createPattern(m.image,p===true&&rb===true?"repeat":p===true&&rb===false?"repeat-x":p===false&&rb===true?"repeat-y":"no-repeat");m.needsUpdate=false}f(oa[m.id]);var p=m.offset.x/m.repeat.x,rb=m.offset.y/m.repeat.y,q=m.image.width*m.repeat.x,hc=m.image.height*m.repeat.y,h=(h+p)*q,i=(1-i+
rb)*hc,c=c-a,d=d-b,e=e-a,g=g-b,k=(k+p)*q-h,j=(1-j+rb)*hc-i,l=(l+p)*q-h,n=(1-n+rb)*hc-i,p=k*n-l*j;if(p===0){if(pa[m.id]===void 0){b=document.createElement("canvas");b.width=m.image.width;b.height=m.image.height;b=b.getContext("2d");b.drawImage(m.image,0,0);pa[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data}b=pa[m.id];h=(Math.floor(h)+Math.floor(i)*m.image.width)*4;aa.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255);Nb(aa)}else{p=1/p;m=(n*c-j*e)*p;j=(n*d-j*g)*p;c=(k*e-l*c)*p;d=(k*g-l*d)*p;a=a-m*h-
c*i;h=b-j*h-d*i;o.save();o.transform(m,j,c,d,a,h);o.fill();o.restore()}}}function r(a,b,c,d,f,e,g,h,i,k,j,l,m){var n,p;n=m.width-1;p=m.height-1;g=g*n;h=h*p;c=c-a;d=d-b;f=f-a;e=e-b;i=i*n-g;k=k*p-h;j=j*n-g;l=l*p-h;p=1/(i*l-j*k);n=(l*c-k*f)*p;k=(l*d-k*e)*p;c=(i*f-j*c)*p;d=(i*e-j*d)*p;a=a-n*g-c*h;b=b-k*g-d*h;o.save();o.transform(n,k,c,d,a,b);o.clip();o.drawImage(m,0,0);o.restore()}function u(a,b,c,d){var f=a.r*255|0,e=a.g*255|0,a=a.b*255|0,g=b.r*255|0,h=b.g*255|0,b=b.b*255|0,i=c.r*255|0,j=c.g*255|0,c=
c.b*255|0,l=d.r*255|0,m=d.g*255|0,d=d.b*255|0;k[0]=f<0?0:f>255?255:f;k[1]=e<0?0:e>255?255:e;k[2]=a<0?0:a>255?255:a;k[4]=g<0?0:g>255?255:g;k[5]=h<0?0:h>255?255:h;k[6]=b<0?0:b>255?255:b;k[8]=i<0?0:i>255?255:i;k[9]=j<0?0:j>255?255:j;k[10]=c<0?0:c>255?255:c;k[12]=l<0?0:l>255?255:l;k[13]=m<0?0:m>255?255:m;k[14]=d<0?0:d>255?255:d;Va.putImageData(ib,0,0);jb.drawImage(Ka,0,0);return eb}function v(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function A(a){a=(a+1)*0.5;return a<0?0:a>1?1:a}function Ub(a,b){var c=
b.x-a.x,d=b.y-a.y,f=c*c+d*d;if(f!==0){f=1/Math.sqrt(f);c=c*f;d=d*f;b.x=b.x+c;b.y=b.y+d;a.x=a.x-c;a.y=a.y-d}}if(l instanceof THREE.Camera===false)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{var Vb,Ec,ja,V;this.autoClear===true?this.clear():o.setTransform(1,0,0,-1,q,p);e.info.render.vertices=0;e.info.render.faces=0;g=j.projectScene(a,l,this.sortElements);h=g.elements;i=g.lights;hb=i.length>0;if(hb===true){Ga.setRGB(0,0,0);cb.setRGB(0,0,0);Za.setRGB(0,
0,0);Vb=0;for(Ec=i.length;Vb<Ec;Vb++){V=i[Vb];var ga=V.color;if(V instanceof THREE.AmbientLight){Ga.r=Ga.r+ga.r;Ga.g=Ga.g+ga.g;Ga.b=Ga.b+ga.b}else if(V instanceof THREE.DirectionalLight){cb.r=cb.r+ga.r;cb.g=cb.g+ga.g;cb.b=cb.b+ga.b}else if(V instanceof THREE.PointLight){Za.r=Za.r+ga.r;Za.g=Za.g+ga.g;Za.b=Za.b+ga.b}}}Vb=0;for(Ec=h.length;Vb<Ec;Vb++){ja=h[Vb];V=ja.material;if(!(V===void 0||V.visible===false)){Ea.empty();if(ja instanceof THREE.RenderableParticle){x=ja;x.x=x.x*q;x.y=x.y*p;var ga=x,Wa=
ja;b(V.opacity);c(V.blending);var sb=void 0,tb=void 0,kb=void 0,lb=void 0,ic=ja=void 0,Sc=void 0;if(V instanceof THREE.ParticleBasicMaterial)if(V.map===null){kb=Wa.object.scale.x;lb=Wa.object.scale.y;kb=kb*Wa.scale.x*q;lb=lb*Wa.scale.y*p;Ea.set(ga.x-kb,ga.y-lb,ga.x+kb,ga.y+lb);if(Ya.intersects(Ea)!==false){f(V.color.getContextStyle());o.save();o.translate(ga.x,ga.y);o.rotate(-Wa.rotation);o.scale(kb,lb);o.fillRect(-1,-1,2,2);o.restore()}}else{ja=V.map.image;ic=ja.width>>1;Sc=ja.height>>1;kb=Wa.scale.x*
q;lb=Wa.scale.y*p;sb=kb*ic;tb=lb*Sc;Ea.set(ga.x-sb,ga.y-tb,ga.x+sb,ga.y+tb);if(Ya.intersects(Ea)!==false){o.save();o.translate(ga.x,ga.y);o.rotate(-Wa.rotation);o.scale(kb,-lb);o.translate(-ic,-Sc);o.drawImage(ja,0,0);o.restore()}}else if(V instanceof THREE.ParticleCanvasMaterial){sb=Wa.scale.x*q;tb=Wa.scale.y*p;Ea.set(ga.x-sb,ga.y-tb,ga.x+sb,ga.y+tb);if(Ya.intersects(Ea)!==false){d(V.color.getContextStyle());f(V.color.getContextStyle());o.save();o.translate(ga.x,ga.y);o.rotate(-Wa.rotation);o.scale(sb,
tb);V.program(o);o.restore()}}}else if(ja instanceof THREE.RenderableLine){x=ja.v1;H=ja.v2;x.positionScreen.x=x.positionScreen.x*q;x.positionScreen.y=x.positionScreen.y*p;H.positionScreen.x=H.positionScreen.x*q;H.positionScreen.y=H.positionScreen.y*p;Ea.addPoint(x.positionScreen.x,x.positionScreen.y);Ea.addPoint(H.positionScreen.x,H.positionScreen.y);if(Ya.intersects(Ea)===true){ga=x;Wa=H;b(V.opacity);c(V.blending);o.beginPath();o.moveTo(ga.positionScreen.x,ga.positionScreen.y);o.lineTo(Wa.positionScreen.x,
Wa.positionScreen.y);if(V instanceof THREE.LineBasicMaterial){ga=V.linewidth;if(y!==ga)y=o.lineWidth=ga;ga=V.linecap;if(B!==ga)B=o.lineCap=ga;ga=V.linejoin;if(I!==ga)I=o.lineJoin=ga;d(V.color.getContextStyle());o.stroke();Ea.inflate(V.linewidth*2)}}}else if(ja instanceof THREE.RenderableFace3){x=ja.v1;H=ja.v2;G=ja.v3;x.positionScreen.x=x.positionScreen.x*q;x.positionScreen.y=x.positionScreen.y*p;H.positionScreen.x=H.positionScreen.x*q;H.positionScreen.y=H.positionScreen.y*p;G.positionScreen.x=G.positionScreen.x*
q;G.positionScreen.y=G.positionScreen.y*p;if(V.overdraw===true){Ub(x.positionScreen,H.positionScreen);Ub(H.positionScreen,G.positionScreen);Ub(G.positionScreen,x.positionScreen)}Ea.add3Points(x.positionScreen.x,x.positionScreen.y,H.positionScreen.x,H.positionScreen.y,G.positionScreen.x,G.positionScreen.y);Ya.intersects(Ea)===true&&m(x,H,G,0,1,2,ja,V,a)}else if(ja instanceof THREE.RenderableFace4){x=ja.v1;H=ja.v2;G=ja.v3;F=ja.v4;x.positionScreen.x=x.positionScreen.x*q;x.positionScreen.y=x.positionScreen.y*
p;H.positionScreen.x=H.positionScreen.x*q;H.positionScreen.y=H.positionScreen.y*p;G.positionScreen.x=G.positionScreen.x*q;G.positionScreen.y=G.positionScreen.y*p;F.positionScreen.x=F.positionScreen.x*q;F.positionScreen.y=F.positionScreen.y*p;E.positionScreen.copy(H.positionScreen);M.positionScreen.copy(F.positionScreen);if(V.overdraw===true){Ub(x.positionScreen,H.positionScreen);Ub(H.positionScreen,F.positionScreen);Ub(F.positionScreen,x.positionScreen);Ub(G.positionScreen,E.positionScreen);Ub(G.positionScreen,
M.positionScreen)}Ea.addPoint(x.positionScreen.x,x.positionScreen.y);Ea.addPoint(H.positionScreen.x,H.positionScreen.y);Ea.addPoint(G.positionScreen.x,G.positionScreen.y);Ea.addPoint(F.positionScreen.x,F.positionScreen.y);if(Ya.intersects(Ea)===true){ga=x;Wa=H;sb=G;tb=F;kb=E;lb=M;ic=a;e.info.render.vertices=e.info.render.vertices+4;e.info.render.faces++;b(V.opacity);c(V.blending);if(V.map!==void 0&&V.map!==null||V.envMap!==void 0&&V.envMap!==null){m(ga,Wa,tb,0,1,3,ja,V,ic);m(kb,sb,lb,1,2,3,ja,V,ic)}else{C=
ga.positionScreen.x;L=ga.positionScreen.y;P=Wa.positionScreen.x;J=Wa.positionScreen.y;W=sb.positionScreen.x;K=sb.positionScreen.y;N=tb.positionScreen.x;O=tb.positionScreen.y;ba=kb.positionScreen.x;ua=kb.positionScreen.y;ha=lb.positionScreen.x;na=lb.positionScreen.y;if(V instanceof THREE.MeshBasicMaterial){rb(C,L,P,J,W,K,N,O);V.wireframe===true?t(V.color,V.wireframeLinewidth,V.wireframeLinecap,V.wireframeLinejoin):Nb(V.color)}else if(V instanceof THREE.MeshLambertMaterial)if(hb===true)if(V.wireframe===
false&&V.shading==THREE.SmoothShading&&ja.vertexNormalsLength==4){fa.r=U.r=Y.r=ea.r=Ga.r;fa.g=U.g=Y.g=ea.g=Ga.g;fa.b=U.b=Y.b=ea.b=Ga.b;n(ja.v1.positionWorld,ja.vertexNormalsWorld[0],fa);n(ja.v2.positionWorld,ja.vertexNormalsWorld[1],U);n(ja.v4.positionWorld,ja.vertexNormalsWorld[3],Y);n(ja.v3.positionWorld,ja.vertexNormalsWorld[2],ea);fa.r=Math.max(0,Math.min(V.color.r*fa.r,1));fa.g=Math.max(0,Math.min(V.color.g*fa.g,1));fa.b=Math.max(0,Math.min(V.color.b*fa.b,1));U.r=Math.max(0,Math.min(V.color.r*
U.r,1));U.g=Math.max(0,Math.min(V.color.g*U.g,1));U.b=Math.max(0,Math.min(V.color.b*U.b,1));Y.r=Math.max(0,Math.min(V.color.r*Y.r,1));Y.g=Math.max(0,Math.min(V.color.g*Y.g,1));Y.b=Math.max(0,Math.min(V.color.b*Y.b,1));ea.r=Math.max(0,Math.min(V.color.r*ea.r,1));ea.g=Math.max(0,Math.min(V.color.g*ea.g,1));ea.b=Math.max(0,Math.min(V.color.b*ea.b,1));Da=u(fa,U,Y,ea);s(C,L,P,J,N,O);r(C,L,P,J,N,O,0,0,1,0,0,1,Da);s(ba,ua,W,K,ha,na);r(ba,ua,W,K,ha,na,1,0,1,1,0,1,Da)}else{aa.r=Ga.r;aa.g=Ga.g;aa.b=Ga.b;n(ja.centroidWorld,
ja.normalWorld,aa);aa.r=Math.max(0,Math.min(V.color.r*aa.r,1));aa.g=Math.max(0,Math.min(V.color.g*aa.g,1));aa.b=Math.max(0,Math.min(V.color.b*aa.b,1));rb(C,L,P,J,W,K,N,O);V.wireframe===true?t(aa,V.wireframeLinewidth,V.wireframeLinecap,V.wireframeLinejoin):Nb(aa)}else{rb(C,L,P,J,W,K,N,O);V.wireframe===true?t(V.color,V.wireframeLinewidth,V.wireframeLinecap,V.wireframeLinejoin):Nb(V.color)}else if(V instanceof THREE.MeshNormalMaterial){aa.r=A(ja.normalWorld.x);aa.g=A(ja.normalWorld.y);aa.b=A(ja.normalWorld.z);
rb(C,L,P,J,W,K,N,O);V.wireframe===true?t(aa,V.wireframeLinewidth,V.wireframeLinecap,V.wireframeLinejoin):Nb(aa)}else if(V instanceof THREE.MeshDepthMaterial){xa=l.near;Ca=l.far;fa.r=fa.g=fa.b=1-v(ga.positionScreen.z,xa,Ca);U.r=U.g=U.b=1-v(Wa.positionScreen.z,xa,Ca);Y.r=Y.g=Y.b=1-v(tb.positionScreen.z,xa,Ca);ea.r=ea.g=ea.b=1-v(sb.positionScreen.z,xa,Ca);Da=u(fa,U,Y,ea);s(C,L,P,J,N,O);r(C,L,P,J,N,O,0,0,1,0,0,1,Da);s(ba,ua,W,K,ha,na);r(ba,ua,W,K,ha,na,1,0,1,1,0,1,Da)}}}}Ia.addRectangle(Ea)}}o.setTransform(1,
0,0,1,0,0)}}};
...
value:null},bumpScale:{type:"f",value:1}},fog:{fogDensity:{type:"f",value:2.5E-4},fogNear:{type:"f",value:1},fogFar:{type:"f",value:2E3},fogColor:{type:"c",value:new THREE.Color(16777215)}},lights:{ambientLightColor:{type:"fv",value:[]},directionalLightDirection:{type:"fv",value:[]},directionalLightColor:{type:"fv",value:[]},pointLightColor:{type:"fv",value:[]},pointLightPosition:{type:"fv",value:[]},pointLightDistance:{type:"fv1",value:[]},spotLightColor:{type:"fv",value:[]},spotLightPosition:{type:"fv",
value:[]},spotLightDirection:{type:"fv",value:[]},spotLightDistance:{type:"fv1",value:[]},spotLightAngle:{type:"fv1",value:[]},spotLightExponent:{type:"fv1",value:[]}},particle:{psColor:{type:"c",value:new THREE.Color(15658734)},opacity:{type:"f",value:1},size:{type:"f",value:1},scale:{type:"f",value:1},map:{type:"t",value:null},fogDensity:{type:"f",value:2.5E-4},fogNear:{type:"f",value:1},fogFar:{type:"f",value:2E3},fogColor:{type:"c",value:new THREE.Color(16777215)}},shadowmap:{shadowMap:{type:"tv",
value:[]},shadowMapSize:{type:"v2v",value:[]},shadowBias:{type:"fv1",value:[]},shadowDarkness:{type:"fv1",value:[]},shadowMatrix:{type:"m4v",value:[]}}};
...
f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){Za.copy(cb);Za.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];sa.copy(f);Za.multiplyVector3(sa);n[d]=[sa.z,d]}n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[n[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[n[d][1]];m[e]=f.r;m[e+1]=f.g;m[e+2]=f.b}if(q){i=0;
...
a.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,m,b)}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.needsUpdate||c.sortParticles){k.bindBuffer(k.ARRAY_BUFFER,h.buffer);k.bufferData(k.ARRAY_BUFFER,h.array,b)}}}}function g(a,b){return b.z-a.z}function h(a,b){return b[1]-a[1]}function i(a,b,c){if(a.length)for(var d=0,f=a.length;d<f;d++){aa=ba=null;ha=na=ea=Y=Qa=Da=oa=-1;Va=true;a[d].render(b,c,Ea,hb);aa=ba=null;ha=na=ea=Y=Qa=Da=oa=-1;Va=true}}function j(a,b,c,d,f,e,g,h){var i,k,j,l;if(b){k=a.length-
1;l=b=-1}else{k=0;b=a.length;l=1}for(var m=k;m!==b;m=m+l){i=a[m];if(i.render){k=i.object;j=i.buffer;if(h)i=h;else{i=i[c];if(!i)continue;g&&K.setBlending(i.blending,i.blendEquation,i.blendSrc,i.blendDst);K.setDepthTest(i.depthTest);K.setDepthWrite(i.depthWrite);v(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits)}K.setMaterialFaces(i);j instanceof THREE.BufferGeometry?K.renderBufferDirect(d,f,e,i,j,k):K.renderBuffer(d,f,e,i,j,k)}}}function l(a,b,c,d,f,e,g){for(var h,i,k=0,j=a.length;k<j;k++){h=
a[k];i=h.object;if(i.visible){if(g)h=g;else{h=h[b];if(!h)continue;e&&K.setBlending(h.blending,h.blendEquation,h.blendSrc,h.blendDst);K.setDepthTest(h.depthTest);K.setDepthWrite(h.depthWrite);v(h.polygonOffset,h.polygonOffsetFactor,h.polygonOffsetUnits)}K.renderImmediateObject(c,d,f,h,i)}}}function n(a,b,c){a.push({buffer:b,object:c,opaque:null,transparent:null})}function m(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return true;return false}function q(a){for(var b in a.attributes)a.attributes[b].needsUpdate=
false}function p(a,b){for(var c=a.length-1;c>=0;c--)a[c].object===b&&a.splice(c,1)}function o(a,b){for(var c=a.length-1;c>=0;c--)a[c]===b&&a.splice(c,1)}function r(a,b,c,d,f){U=0;if(d.needsUpdate){d.program&&K.deallocateMaterial(d);K.initMaterial(d,b,c,f);d.needsUpdate=false}if(d.morphTargets&&!f.__webglMorphTargetInfluences)f.__webglMorphTargetInfluences=new Float32Array(K.maxMorphTargets);var e=false,g=d.program,h=g.uniforms,i=d.uniforms;if(g!==ba){k.useProgram(g);ba=g;e=true}if(d.id!==ha){ha=d.id;
e=true}if(e||a!==aa){k.uniformMatrix4fv(h.projectionMatrix,false,a._projectionMatrixArray);a!==aa&&(aa=a)}if(d.skinning)if(dc&&f.useVertexTexture){if(h.boneTexture!==null){var j=t();k.uniform1i(h.boneTexture,j);K.setTexture(f.boneTexture,j)}}else h.boneGlobalMatrices!==null&&k.uniformMatrix4fv(h.boneGlobalMatrices,false,f.boneMatrices);if(e){if(c&&d.fog){i.fogColor.value=c.color;if(c instanceof THREE.Fog){i.fogNear.value=c.near;i.fogFar.value=c.far}else if(c instanceof THREE.FogExp2)i.fogDensity.value=
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(Va){for(var l=0,m=0,n=0,o,p,q,s=ib,r=s.directional.colors,u=s.directional.positions,v=s.point.colors,A=s.point.positions,B=s.point.distances,C=s.spot.colors,I=s.spot.positions,G=s.spot.distances,E=s.spot.directions,O=s.spot.angles,L=s.spot.exponents,F=0,N=0,P=0,J=q=0,c=J=0,e=b.length;c<e;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=j.color;p=j.intensity;q=j.distance;if(j instanceof THREE.AmbientLight)if(K.gammaInput){l=
l+o.r*o.r;m=m+o.g*o.g;n=n+o.b*o.b}else{l=l+o.r;m=m+o.g;n=n+o.b}else if(j instanceof THREE.DirectionalLight){q=F*3;if(K.gammaInput){r[q]=o.r*o.r*p*p;r[q+1]=o.g*o.g*p*p;r[q+2]=o.b*o.b*p*p}else{r[q]=o.r*p;r[q+1]=o.g*p;r[q+2]=o.b*p}Ka.copy(j.matrixWorld.getPosition());Ka.subSelf(j.target.matrixWorld.getPosition());Ka.normalize();u[q]=Ka.x;u[q+1]=Ka.y;u[q+2]=Ka.z;F=F+1}else if(j instanceof THREE.PointLight){J=N*3;if(K.gammaInput){v[J]=o.r*o.r*p*p;v[J+1]=o.g*o.g*p*p;v[J+2]=o.b*o.b*p*p}else{v[J]=o.r*p;v[J+
1]=o.g*p;v[J+2]=o.b*p}o=j.matrixWorld.getPosition();A[J]=o.x;A[J+1]=o.y;A[J+2]=o.z;B[N]=q;N=N+1}else if(j instanceof THREE.SpotLight){J=P*3;if(K.gammaInput){C[J]=o.r*o.r*p*p;C[J+1]=o.g*o.g*p*p;C[J+2]=o.b*o.b*p*p}else{C[J]=o.r*p;C[J+1]=o.g*p;C[J+2]=o.b*p}o=j.matrixWorld.getPosition();I[J]=o.x;I[J+1]=o.y;I[J+2]=o.z;G[P]=q;Ka.copy(o);Ka.subSelf(j.target.matrixWorld.getPosition());Ka.normalize();E[J]=Ka.x;E[J+1]=Ka.y;E[J+2]=Ka.z;O[P]=Math.cos(j.angle);L[P]=j.exponent;P=P+1}}}c=F*3;for(e=r.length;c<e;c++)r[c]=
0;c=N*3;for(e=v.length;c<e;c++)v[c]=0;c=P*3;for(e=C.length;c<e;c++)C[c]=0;s.directional.length=F;s.point.length=N;s.spot.length=P;s.ambient[0]=l;s.ambient[1]=m;s.ambient[2]=n;Va=false}c=ib;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=
c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=c.spot.directions;i.spotLightAngle.value=c.spot.angles;i.spotLightExponent.value=c.spot.exponents}if(d instanceof THREE.MeshBasicMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.MeshPhongMaterial){i.opacity.value=d.opacity;K.gammaInput?i.diffuse.value.copyGammaToLinear(d.color):i.diffuse.value=d.color;i.map.value=d.map;i.lightMap.value=d.lightMap;i.specularMap.value=d.specularMap;if(d.bumpMap){i.bumpMap.value=
d.bumpMap;i.bumpScale.value=d.bumpScale}var M;if(d.map)M=d.map;else if(d.specularMap)M=d.specularMap;else if(d.bumpMap)M=d.bumpMap;if(M!==void 0){c=M.offset;M=M.repeat;i.offsetRepeat.value.set(c.x,c.y,M.x,M.y)}i.envMap.value=d.envMap;i.flipEnvMap.value=d.envMap instanceof THREE.WebGLRenderTargetCube?1:-1;i.reflectivity.value=d.reflectivity;i.refractionRatio.value=d.refractionRatio;i.combine.value=d.combine;i.useRefract.value=d.envMap&&d.envMap.mapping instanceof THREE.CubeRefractionMapping}if(d instanceof
THREE.LineBasicMaterial){i.diffuse.value=d.color;i.opacity.value=d.opacity}else if(d instanceof THREE.ParticleBasicMaterial){i.psColor.value=d.color;i.opacity.value=d.opacity;i.size.value=d.size;i.scale.value=H.height/2;i.map.value=d.map}else if(d instanceof THREE.MeshPhongMaterial){i.shininess.value=d.shininess;if(K.gammaInput){i.ambient.value.copyGammaToLinear(d.ambient);i.emissive.value.copyGammaToLinear(d.emissive);i.specular.value.copyGammaToLinear(d.specular)}else{i.ambient.value=d.ambient;
i.emissive.value=d.emissive;i.specular.value=d.specular}d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)}else if(d instanceof THREE.MeshLambertMaterial){if(K.gammaInput){i.ambient.value.copyGammaToLinear(d.ambient);i.emissive.value.copyGammaToLinear(d.emissive)}else{i.ambient.value=d.ambient;i.emissive.value=d.emissive}d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)}else if(d instanceof THREE.MeshDepthMaterial){i.mNear.value=a.near;i.mFar.value=a.far;i.opacity.value=d.opacity}else if(d instanceof THREE.MeshNormalMaterial)i.opacity.value=
d.opacity;if(f.receiveShadow&&!d._shadowPass&&i.shadowMatrix){c=M=0;for(e=b.length;c<e;c++){j=b[c];if(j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade)){i.shadowMap.value[M]=j.shadowMap;i.shadowMapSize.value[M]=j.shadowMapSize;i.shadowMatrix.value[M]=j.shadowMatrix;i.shadowDarkness.value[M]=j.shadowDarkness;i.shadowBias.value[M]=j.shadowBias;M++}}}b=d.uniformsList;i=0;for(M=b.length;i<M;i++)if(e=g.uniforms[b[i][1]]){c=b[i][0];l=c.type;j=c.value;if(l===
...
new Float32Array(16);j.flattenToArray(c._array);k.uniformMatrix4fv(e,false,c._array)}else if(l==="m4v"){if(c._array===void 0)c._array=new Float32Array(16*j.length);l=0;for(m=j.length;l<m;l++)j[l].flattenToArrayOffset(c._array,l*16);k.uniformMatrix4fv(e,false,c._array)}else if(l==="t"){n=j;j=t();k.uniform1i(e,j);if(n)if(n.image instanceof Array&&n.image.length===6){c=n;e=j;if(c.image.length===6)if(c.needsUpdate){if(!c.image.__webglTextureCube)c.image.__webglTextureCube=k.createTexture();k.activeTexture(k.TEXTURE0+
e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);e=[];for(j=0;j<6;j++)if(K.autoScaleCubemaps){l=e;m=j;n=c.image[j];r=Rc;if(!(n.width<=r&&n.height<=r)){u=Math.max(n.width,n.height);s=Math.floor(n.width*r/u);r=Math.floor(n.height*r/u);u=document.createElement("canvas");u.width=s;u.height=r;u.getContext("2d").drawImage(n,0,0,n.width,n.height,0,0,s,r);n=u}l[m]=n}else e[j]=c.image[j];j=e[0];l=(j.width&j.width-1)===0&&(j.height&j.height-1)===0;
m=x(c.format);n=x(c.type);y(k.TEXTURE_CUBE_MAP,c,l);for(j=0;j<6;j++)k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,m,m,n,e[j]);c.generateMipmaps&&l&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=false;if(c.onUpdate)c.onUpdate()}else{k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}}else if(n instanceof THREE.WebGLRenderTargetCube){c=n;k.activeTexture(k.TEXTURE0+j);k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)}else K.setTexture(n,j)}else if(l==="tv"){if(c._array===
void 0)c._array=[];l=0;for(m=c.value.length;l<m;l++)c._array[l]=t();k.uniform1iv(e,c._array);l=0;for(m=c.value.length;l<m;l++){n=c.value[l];j=c._array[l];n&&K.setTexture(n,j)}}}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&h.cameraPosition!==null){b=a.matrixWorld.getPosition();k.uniform3f(h.cameraPosition,b.x,b.y,b.z)}(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&h.viewMatrix!==
null&&k.uniformMatrix4fv(h.viewMatrix,false,a._viewMatrixArray)}k.uniformMatrix4fv(h.modelViewMatrix,false,f._modelViewMatrix.elements);h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,false,f._normalMatrix.elements);h.modelMatrix!==null&&k.uniformMatrix4fv(h.modelMatrix,false,f.matrixWorld.elements);return g}function t(){var a=U;a>=qc&&console.warn("Trying to use "+a+" texture units while this GPU supports only "+qc);U=U+1;return a}function u(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,
a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function v(a,b,c){if(va!==a){a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL);va=a}if(a&&(fb!==b||Ua!==c)){k.polygonOffset(b,c);fb=b;Ua=c}}function s(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function A(a,b){var c;a==="fragment"?c=k.createShader(k.FRAGMENT_SHADER):a==="vertex"&&(c=k.createShader(k.VERTEX_SHADER));k.shaderSource(c,b);k.compileShader(c);
if(!k.getShaderParameter(c,k.COMPILE_STATUS)){console.error(k.getShaderInfoLog(c));console.error(s(b));return null}return c}function y(a,b,c){if(c){k.texParameteri(a,k.TEXTURE_WRAP_S,x(b.wrapS));k.texParameteri(a,k.TEXTURE_WRAP_T,x(b.wrapT));k.texParameteri(a,k.TEXTURE_MAG_FILTER,x(b.magFilter));k.texParameteri(a,k.TEXTURE_MIN_FILTER,x(b.minFilter))}else{k.texParameteri(a,k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE);k.texParameteri(a,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE);k.texParameteri(a,k.TEXTURE_MAG_FILTER,I(b.magFilter));
k.texParameteri(a,k.TEXTURE_MIN_FILTER,I(b.minFilter))}if(eb&&b.type!==THREE.FloatType&&(b.anisotropy>1||b.__oldAnisotropy)){k.texParameterf(a,eb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,Dc));b.__oldAnisotropy=b.anisotropy}}function B(a,b){k.bindRenderbuffer(k.RENDERBUFFER,a);if(b.depthBuffer&&!b.stencilBuffer){k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_COMPONENT16,b.width,b.height);k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_ATTACHMENT,k.RENDERBUFFER,a)}else if(b.depthBuffer&&b.stencilBuffer){k.renderbufferStorage(k.RENDERBUFFER,
k.DEPTH_STENCIL,b.width,b.height);k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_STENCIL_ATTACHMENT,k.RENDERBUFFER,a)}else k.renderbufferStorage(k.RENDERBUFFER,k.RGBA4,b.width,b.height)}function I(a){return a===THREE.NearestFilter||a===THREE.NearestMipMapNearestFilter||a===THREE.NearestMipMapLinearFilter?k.NEAREST:k.LINEAR}function x(a){return a===THREE.RepeatWrapping?k.REPEAT:a===THREE.ClampToEdgeWrapping?k.CLAMP_TO_EDGE:a===THREE.MirroredRepeatWrapping?k.MIRRORED_REPEAT:a===THREE.NearestFilter?
...
a||{},H=a.canvas!==void 0?a.canvas:document.createElement("canvas"),G=a.precision!==void 0?a.precision:"highp",F=a.alpha!==void 0?a.alpha:true,E=a.premultipliedAlpha!==void 0?a.premultipliedAlpha:true,M=a.antialias!==void 0?a.antialias:false,C=a.stencil!==void 0?a.stencil:true,L=a.preserveDrawingBuffer!==void 0?a.preserveDrawingBuffer:false,P=a.clearColor!==void 0?new THREE.Color(a.clearColor):new THREE.Color(0),J=a.clearAlpha!==void 0?a.clearAlpha:0,W=a.maxLights!==void 0?a.maxLights:4;this.domElement=
...
this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var K=this,N=[],O=0,ba=null,ua=null,ha=-1,na=null,aa=null,fa=0,U=0,Y=-1,ea=-1,oa=-1,pa=-1,xa=-1,Ca=-1,Da=-1,Qa=-1,va=null,fb=null,Ua=null,qb=null,gb=0,ub=0,Ya=0,Ia=0,Ea=0,hb=0,Ga=new THREE.Frustum,cb=new THREE.Matrix4,Za=new THREE.Matrix4,sa=new THREE.Vector4,Ka=new THREE.Vector3,Va=true,ib={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},
spot:{length:0,colors:[],positions:[],distances:[],directions:[],angles:[],exponents:[]}},k,eb;try{if(!(k=H.getContext("experimental-webgl",{alpha:F,premultipliedAlpha:E,antialias:M,stencil:C,preserveDrawingBuffer:L})))throw"Error creating WebGL context.";}catch(jb){console.error(jb)}a=k.getExtension("OES_texture_float");F=k.getExtension("OES_standard_derivatives");eb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
a||console.log("THREE.WebGLRenderer: Float textures not supported.");F||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");eb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(P.r,P.g,
P.b,J);this.context=k;var qc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),F=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Rc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),Dc=eb?k.getParameter(eb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,rc=F>0,dc=rc&&a;this.getContext=function(){return k};this.supportsVertexTextures=function(){return rc};this.getMaxAnisotropy=function(){return Dc};this.setSize=function(a,b){H.width=a;H.height=b;this.setViewport(0,0,H.width,H.height)};
this.setViewport=function(a,b,c,d){gb=a!==void 0?a:0;ub=b!==void 0?b:0;Ya=c!==void 0?c:H.width;Ia=d!==void 0?d:H.height;k.viewport(gb,ub,Ya,Ia)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){P.setHex(a);J=b;k.clearColor(P.r,P.g,P.b,J)};this.setClearColor=function(a,b){P.copy(a);J=b;k.clearColor(P.r,P.g,P.b,J)};this.getClearColor=function(){return P};this.getClearAlpha=
function(){return J};this.clear=function(a,b,c){var d=0;if(a===void 0||a)d=d|k.COLOR_BUFFER_BIT;if(b===void 0||b)d=d|k.DEPTH_BUFFER_BIT;if(c===void 0||c)d=d|k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};this.addPrePlugin=function(a){a.init(this);this.renderPluginsPre.push(a)};this.deallocateObject=function(a){if(a.__webglInit){a.__webglInit=false;delete a._modelViewMatrix;
...
r(a,b,c,d,e);a=c.attributes;b=false;d=f.id*16777215+c.id*2+(d.wireframe?1:0);if(d!==na){na=d;b=true}if(e instanceof THREE.Mesh){e=f.offsets;e.length>1&&(b=true);d=0;for(c=e.length;d<c;++d){var g=e[d].index;if(b){var h=f.attributes.position,i=h.itemSize;k.bindBuffer(k.ARRAY_BUFFER,h.buffer);k.vertexAttribPointer(a.position,i,k.FLOAT,false,0,g*i*4);h=f.attributes.normal;if(a.normal>=0&&h){i=h.itemSize;k.bindBuffer(k.ARRAY_BUFFER,h.buffer);k.vertexAttribPointer(a.normal,i,k.FLOAT,false,0,g*i*4)}h=f.attributes.uv;
if(a.uv>=0&&h)if(h.buffer){i=h.itemSize;k.bindBuffer(k.ARRAY_BUFFER,h.buffer);k.vertexAttribPointer(a.uv,i,k.FLOAT,false,0,g*i*4);k.enableVertexAttribArray(a.uv)}else k.disableVertexAttribArray(a.uv);h=f.attributes.color;if(a.color>=0&&h){i=h.itemSize;k.bindBuffer(k.ARRAY_BUFFER,h.buffer);k.vertexAttribPointer(a.color,i,k.FLOAT,false,0,g*i*4)}h=f.attributes.tangent;if(a.tangent>=0&&h){i=h.itemSize;k.bindBuffer(k.ARRAY_BUFFER,h.buffer);k.vertexAttribPointer(a.tangent,i,k.FLOAT,false,0,g*i*4)}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,
f.attributes.index.buffer)}k.drawElements(k.TRIANGLES,e[d].count,k.UNSIGNED_SHORT,e[d].start*2);K.info.render.calls++;K.info.render.vertices=K.info.render.vertices+e[d].count;K.info.render.faces=K.info.render.faces+e[d].count/3}}}};this.renderBuffer=function(a,b,c,d,f,e){if(d.visible!==false){var g,i,c=r(a,b,c,d,e),b=c.attributes,a=false,c=f.id*16777215+c.id*2+(d.wireframe?1:0);if(c!==na){na=c;a=true}if(!d.morphTargets&&b.position>=0){if(a){k.bindBuffer(k.ARRAY_BUFFER,f.__webglVertexBuffer);k.vertexAttribPointer(b.position,
3,k.FLOAT,false,0,0)}}else if(e.morphTargetBase){c=d.program.attributes;if(e.morphTargetBase!==-1){k.bindBuffer(k.ARRAY_BUFFER,f.__webglMorphTargetsBuffers[e.morphTargetBase]);k.vertexAttribPointer(c.position,3,k.FLOAT,false,0,0)}else if(c.position>=0){k.bindBuffer(k.ARRAY_BUFFER,f.__webglVertexBuffer);k.vertexAttribPointer(c.position,3,k.FLOAT,false,0,0)}if(e.morphTargetForcedOrder.length){var j=0;i=e.morphTargetForcedOrder;for(g=e.morphTargetInfluences;j<d.numSupportedMorphTargets&&j<i.length;){k.bindBuffer(k.ARRAY_BUFFER,
f.__webglMorphTargetsBuffers[i[j]]);k.vertexAttribPointer(c["morphTarget"+j],3,k.FLOAT,false,0,0);if(d.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,f.__webglMorphNormalsBuffers[i[j]]);k.vertexAttribPointer(c["morphNormal"+j],3,k.FLOAT,false,0,0)}e.__webglMorphTargetInfluences[j]=g[i[j]];j++}}else{i=[];g=e.morphTargetInfluences;var l,m=g.length;for(l=0;l<m;l++){j=g[l];j>0&&i.push([l,j])}if(i.length>d.numSupportedMorphTargets){i.sort(h);i.length=d.numSupportedMorphTargets}else i.length>d.numSupportedMorphNormals?
i.sort(h):i.length===0&&i.push([0,0]);for(j=0;j<d.numSupportedMorphTargets;){if(i[j]){l=i[j][0];k.bindBuffer(k.ARRAY_BUFFER,f.__webglMorphTargetsBuffers[l]);k.vertexAttribPointer(c["morphTarget"+j],3,k.FLOAT,false,0,0);if(d.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,f.__webglMorphNormalsBuffers[l]);k.vertexAttribPointer(c["morphNormal"+j],3,k.FLOAT,false,0,0)}e.__webglMorphTargetInfluences[j]=g[l]}else{k.vertexAttribPointer(c["morphTarget"+j],3,k.FLOAT,false,0,0);d.morphNormals&&k.vertexAttribPointer(c["morphNormal"+
j],3,k.FLOAT,false,0,0);e.__webglMorphTargetInfluences[j]=0}j++}}d.program.uniforms.morphTargetInfluences!==null&&k.uniform1fv(d.program.uniforms.morphTargetInfluences,e.__webglMorphTargetInfluences)}if(a){if(f.__webglCustomAttributesList){g=0;for(i=f.__webglCustomAttributesList.length;g<i;g++){c=f.__webglCustomAttributesList[g];if(b[c.buffer.belongsToAttribute]>=0){k.bindBuffer(k.ARRAY_BUFFER,c.buffer);k.vertexAttribPointer(b[c.buffer.belongsToAttribute],c.size,k.FLOAT,false,0,0)}}}if(b.color>=0){k.bindBuffer(k.ARRAY_BUFFER,
f.__webglColorBuffer);k.vertexAttribPointer(b.color,3,k.FLOAT,false,0,0)}if(b.normal>=0){k.bindBuffer(k.ARRAY_BUFFER,f.__webglNormalBuffer);k.vertexAttribPointer(b.normal,3,k.FLOAT,false,0,0)}if(b.tangent>=0){k.bindBuffer(k.ARRAY_BUFFER,f.__webglTangentBuffer);k.vertexAttribPointer(b.tangent,4,k.FLOAT,false,0,0)}if(b.uv>=0)if(f.__webglUVBuffer){k.bindBuffer(k.ARRAY_BUFFER,f.__webglUVBuffer);k.vertexAttribPointer(b.uv,2,k.FLOAT,false,0,0);k.enableVertexAttribArray(b.uv)}else k.disableVertexAttribArray(b.uv);
if(b.uv2>=0)if(f.__webglUV2Buffer){k.bindBuffer(k.ARRAY_BUFFER,f.__webglUV2Buffer);k.vertexAttribPointer(b.uv2,2,k.FLOAT,false,0,0);k.enableVertexAttribArray(b.uv2)}else k.disableVertexAttribArray(b.uv2);if(d.skinning&&b.skinIndex>=0&&b.skinWeight>=0){k.bindBuffer(k.ARRAY_BUFFER,f.__webglSkinIndicesBuffer);k.vertexAttribPointer(b.skinIndex,4,k.FLOAT,false,0,0);k.bindBuffer(k.ARRAY_BUFFER,f.__webglSkinWeightsBuffer);k.vertexAttribPointer(b.skinWeight,4,k.FLOAT,false,0,0)}}if(e instanceof THREE.Mesh){if(d.wireframe){d=
d.wireframeLinewidth;if(d!==qb){k.lineWidth(d);qb=d}a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,f.__webglLineBuffer);k.drawElements(k.LINES,f.__webglLineCount,k.UNSIGNED_SHORT,0)}else{a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,f.__webglFaceBuffer);k.drawElements(k.TRIANGLES,f.__webglFaceCount,k.UNSIGNED_SHORT,0)}K.info.render.calls++;K.info.render.vertices=K.info.render.vertices+f.__webglFaceCount;K.info.render.faces=K.info.render.faces+f.__webglFaceCount/3}else if(e instanceof THREE.Line){e=e.type===THREE.LineStrip?
k.LINE_STRIP:k.LINES;d=d.linewidth;if(d!==qb){k.lineWidth(d);qb=d}k.drawArrays(e,0,f.__webglLineCount);K.info.render.calls++}else if(e instanceof THREE.ParticleSystem){k.drawArrays(k.POINTS,0,f.__webglParticleCount);K.info.render.calls++;K.info.render.points=K.info.render.points+f.__webglParticleCount}else if(e instanceof THREE.Ribbon){k.drawArrays(k.TRIANGLE_STRIP,0,f.__webglVertexCount);K.info.render.calls++}}};this.render=function(a,b,c,d){if(b instanceof THREE.Camera===false)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
else{var f,e,h,m,n=a.__lights,o=a.fog;ha=-1;Va=true;this.autoUpdateScene&&a.updateMatrixWorld();b.parent===void 0&&b.updateMatrixWorld();if(!b._viewMatrixArray)b._viewMatrixArray=new Float32Array(16);if(!b._projectionMatrixArray)b._projectionMatrixArray=new Float32Array(16);b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);cb.multiply(b.projectionMatrix,b.matrixWorldInverse);Ga.setFromMatrix(cb);
this.autoUpdateObjects&&this.initWebGLObjects(a);i(this.renderPluginsPre,a,b);K.info.render.calls=0;K.info.render.vertices=0;K.info.render.faces=0;K.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);m=a.__webglObjects;d=0;for(f=m.length;d<f;d++){e=m[d];h=e.object;e.render=false;if(h.visible&&(!(h instanceof THREE.Mesh||h instanceof THREE.ParticleSystem)||!h.frustumCulled||Ga.contains(h))){u(h,b);var p=e,q=p.object,
s=p.buffer,r=void 0,r=r=void 0,r=q.material;if(r instanceof THREE.MeshFaceMaterial){r=s.materialIndex;if(r>=0){r=q.geometry.materials[r];if(r.transparent){p.transparent=r;p.opaque=null}else{p.opaque=r;p.transparent=null}}}else if(r)if(r.transparent){p.transparent=r;p.opaque=null}else{p.opaque=r;p.transparent=null}e.render=true;if(this.sortObjects)if(h.renderDepth)e.z=h.renderDepth;else{sa.copy(h.matrixWorld.getPosition());cb.multiplyVector3(sa);e.z=sa.z}}}this.sortObjects&&m.sort(g);m=a.__webglObjectsImmediate;
d=0;for(f=m.length;d<f;d++){e=m[d];h=e.object;if(h.visible){u(h,b);h=e.object.material;if(h.transparent){e.transparent=h;e.opaque=null}else{e.opaque=h;e.transparent=null}}}if(a.overrideMaterial){d=a.overrideMaterial;this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst);this.setDepthTest(d.depthTest);this.setDepthWrite(d.depthWrite);v(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits);j(a.__webglObjects,false,"",b,n,o,true,d);l(a.__webglObjectsImmediate,"",b,n,o,false,d)}else{this.setBlending(THREE.NormalBlending);
...
c.__webglTexture);k.generateMipmap(k.TEXTURE_2D);k.bindTexture(k.TEXTURE_2D,null)}this.setDepthTest(true);this.setDepthWrite(true)}};this.renderImmediateObject=function(a,b,c,d,f){var e=r(a,b,c,d,f);na=-1;K.setMaterialFaces(d);f.immediateRenderCallback?f.immediateRenderCallback(e,k,Ga):f.render(function(a){K.renderBufferImmediate(a,e,d)})};this.initWebGLObjects=function(a){if(!a.__webglObjects){a.__webglObjects=[];a.__webglObjectsImmediate=[];a.__webglSprites=[];a.__webglFlares=[]}for(;a.__objectsAdded.length;){var g=
a.__objectsAdded[0],h=a,i=void 0,j=void 0,l=void 0;if(!g.__webglInit){g.__webglInit=true;g._modelViewMatrix=new THREE.Matrix4;g._normalMatrix=new THREE.Matrix3;if(g instanceof THREE.Mesh){j=g.geometry;if(j instanceof THREE.Geometry){if(j.geometryGroups===void 0){var r=j,s=void 0,t=void 0,u=void 0,v=void 0,x=void 0,y=void 0,A=void 0,B={},C=r.morphTargets.length,I=r.morphNormals.length;r.geometryGroups={};s=0;for(t=r.faces.length;s<t;s++){u=r.faces[s];v=u.materialIndex;y=v!==void 0?v:-1;B[y]===void 0&&
(B[y]={hash:y,counter:0});A=B[y].hash+"_"+B[y].counter;r.geometryGroups[A]===void 0&&(r.geometryGroups[A]={faces3:[],faces4:[],materialIndex:v,vertices:0,numMorphTargets:C,numMorphNormals:I});x=u instanceof THREE.Face3?3:4;if(r.geometryGroups[A].vertices+x>65535){B[y].counter=B[y].counter+1;A=B[y].hash+"_"+B[y].counter;r.geometryGroups[A]===void 0&&(r.geometryGroups[A]={faces3:[],faces4:[],materialIndex:v,vertices:0,numMorphTargets:C,numMorphNormals:I})}u instanceof THREE.Face3?r.geometryGroups[A].faces3.push(s):
r.geometryGroups[A].faces4.push(s);r.geometryGroups[A].vertices=r.geometryGroups[A].vertices+x}r.geometryGroupsList=[];var G=void 0;for(G in r.geometryGroups){r.geometryGroups[G].id=fa++;r.geometryGroupsList.push(r.geometryGroups[G])}}for(i in j.geometryGroups){l=j.geometryGroups[i];if(!l.__webglVertexBuffer){var E=l;E.__webglVertexBuffer=k.createBuffer();E.__webglNormalBuffer=k.createBuffer();E.__webglTangentBuffer=k.createBuffer();E.__webglColorBuffer=k.createBuffer();E.__webglUVBuffer=k.createBuffer();
E.__webglUV2Buffer=k.createBuffer();E.__webglSkinIndicesBuffer=k.createBuffer();E.__webglSkinWeightsBuffer=k.createBuffer();E.__webglFaceBuffer=k.createBuffer();E.__webglLineBuffer=k.createBuffer();var H=void 0,J=void 0;if(E.numMorphTargets){E.__webglMorphTargetsBuffers=[];H=0;for(J=E.numMorphTargets;H<J;H++)E.__webglMorphTargetsBuffers.push(k.createBuffer())}if(E.numMorphNormals){E.__webglMorphNormalsBuffers=[];H=0;for(J=E.numMorphNormals;H<J;H++)E.__webglMorphNormalsBuffers.push(k.createBuffer())}K.info.memory.geometries++;
var F=l,U=g,O=U.geometry,M=F.faces3,L=F.faces4,N=M.length*3+L.length*4,P=M.length*1+L.length*2,aa=M.length*3+L.length*4,Y=c(U,F),W=f(Y),ea=d(Y),ba=Y.vertexColors?Y.vertexColors:false;F.__vertexArray=new Float32Array(N*3);if(ea)F.__normalArray=new Float32Array(N*3);if(O.hasTangents)F.__tangentArray=new Float32Array(N*4);if(ba)F.__colorArray=new Float32Array(N*3);if(W){if(O.faceUvs.length>0||O.faceVertexUvs.length>0)F.__uvArray=new Float32Array(N*2);if(O.faceUvs.length>1||O.faceVertexUvs.length>1)F.__uv2Array=
new Float32Array(N*2)}if(U.geometry.skinWeights.length&&U.geometry.skinIndices.length){F.__skinIndexArray=new Float32Array(N*4);F.__skinWeightArray=new Float32Array(N*4)}F.__faceArray=new Uint16Array(P*3);F.__lineArray=new Uint16Array(aa*2);var pa=void 0,oa=void 0;if(F.numMorphTargets){F.__morphTargetsArrays=[];pa=0;for(oa=F.numMorphTargets;pa<oa;pa++)F.__morphTargetsArrays.push(new Float32Array(N*3))}if(F.numMorphNormals){F.__morphNormalsArrays=[];pa=0;for(oa=F.numMorphNormals;pa<oa;pa++)F.__morphNormalsArrays.push(new Float32Array(N*
3))}F.__webglFaceCount=P*3;F.__webglLineCount=aa*2;if(Y.attributes){if(F.__webglCustomAttributesList===void 0)F.__webglCustomAttributesList=[];var xa=void 0;for(xa in Y.attributes){var ua=Y.attributes[xa],ha={},na;for(na in ua)ha[na]=ua[na];if(!ha.__webglInitialized||ha.createUniqueBuffers){ha.__webglInitialized=true;var Ca=1;ha.type==="v2"?Ca=2:ha.type==="v3"?Ca=3:ha.type==="v4"?Ca=4:ha.type==="c"&&(Ca=3);ha.size=Ca;ha.array=new Float32Array(N*Ca);ha.buffer=k.createBuffer();ha.buffer.belongsToAttribute=
xa;ua.needsUpdate=true;ha.__original=ua}F.__webglCustomAttributesList.push(ha)}}F.__inittedArrays=true;j.verticesNeedUpdate=true;j.morphTargetsNeedUpdate=true;j.elementsNeedUpdate=true;j.uvsNeedUpdate=true;j.normalsNeedUpdate=true;j.tangentsNeedUpdate=true;j.colorsNeedUpdate=true}}}else if(j instanceof THREE.BufferGeometry){var sa=j,va=void 0,Da=void 0,Ea=void 0;for(va in sa.attributes){Ea=va==="index"?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;Da=sa.attributes[va];Da.buffer=k.createBuffer();k.bindBuffer(Ea,
Da.buffer);k.bufferData(Ea,Da.array,k.STATIC_DRAW)}}}else if(g instanceof THREE.Ribbon){j=g.geometry;if(!j.__webglVertexBuffer){var Ga=j;Ga.__webglVertexBuffer=k.createBuffer();Ga.__webglColorBuffer=k.createBuffer();K.info.memory.geometries++;var Ia=j,Qa=Ia.vertices.length;Ia.__vertexArray=new Float32Array(Qa*3);Ia.__colorArray=new Float32Array(Qa*3);Ia.__webglVertexCount=Qa;j.verticesNeedUpdate=true;j.colorsNeedUpdate=true}}else if(g instanceof THREE.Line){j=g.geometry;if(!j.__webglVertexBuffer){var Ua=
j;Ua.__webglVertexBuffer=k.createBuffer();Ua.__webglColorBuffer=k.createBuffer();K.info.memory.geometries++;var Ka=j,qb=g,Ya=Ka.vertices.length;Ka.__vertexArray=new Float32Array(Ya*3);Ka.__colorArray=new Float32Array(Ya*3);Ka.__webglLineCount=Ya;b(Ka,qb);j.verticesNeedUpdate=true;j.colorsNeedUpdate=true}}else if(g instanceof THREE.ParticleSystem){j=g.geometry;if(!j.__webglVertexBuffer){var cb=j;cb.__webglVertexBuffer=k.createBuffer();cb.__webglColorBuffer=k.createBuffer();K.info.geometries++;var Va=
j,eb=g,fb=Va.vertices.length;Va.__vertexArray=new Float32Array(fb*3);Va.__colorArray=new Float32Array(fb*3);Va.__sortArray=[];Va.__webglParticleCount=fb;b(Va,eb);j.verticesNeedUpdate=true;j.colorsNeedUpdate=true}}}if(!g.__webglActive){if(g instanceof THREE.Mesh){j=g.geometry;if(j instanceof THREE.BufferGeometry)n(h.__webglObjects,j,g);else for(i in j.geometryGroups){l=j.geometryGroups[i];n(h.__webglObjects,l,g)}}else if(g instanceof THREE.Ribbon||g instanceof THREE.Line||g instanceof THREE.ParticleSystem){j=
g.geometry;n(h.__webglObjects,j,g)}else g instanceof THREE.ImmediateRenderObject||g.immediateRenderCallback?h.__webglObjectsImmediate.push({object:g,opaque:null,transparent:null}):g instanceof THREE.Sprite?h.__webglSprites.push(g):g instanceof THREE.LensFlare&&h.__webglFlares.push(g);g.__webglActive=true}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var mb=a.__objectsRemoved[0],Za=a;mb instanceof THREE.Mesh||mb instanceof THREE.ParticleSystem||mb instanceof THREE.Ribbon||mb instanceof
THREE.Line?p(Za.__webglObjects,mb):mb instanceof THREE.Sprite?o(Za.__webglSprites,mb):mb instanceof THREE.LensFlare?o(Za.__webglFlares,mb):(mb instanceof THREE.ImmediateRenderObject||mb.immediateRenderCallback)&&p(Za.__webglObjectsImmediate,mb);mb.__webglActive=false;a.__objectsRemoved.splice(0,1)}for(var gb=0,ub=a.__webglObjects.length;gb<ub;gb++){var vb=a.__webglObjects[gb].object,ca=vb.geometry,hb=void 0,ib=void 0,$a=void 0;if(vb instanceof THREE.Mesh)if(ca instanceof THREE.BufferGeometry){if(ca.verticesNeedUpdate||
ca.elementsNeedUpdate||ca.uvsNeedUpdate||ca.normalsNeedUpdate||ca.colorsNeedUpdate||ca.tangentsNeedUpdate){var Ob=ca,jb=k.DYNAMIC_DRAW,rc=!ca.dynamic,jc=Ob.attributes,dc=jc.index,Tc=jc.position,Uc=jc.normal,Vc=jc.uv,Wc=jc.color,Xc=jc.tangent;if(Ob.elementsNeedUpdate&&dc!==void 0){k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,dc.buffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,dc.array,jb)}if(Ob.verticesNeedUpdate&&Tc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Tc.buffer);k.bufferData(k.ARRAY_BUFFER,Tc.array,jb)}if(Ob.normalsNeedUpdate&&
Uc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Uc.buffer);k.bufferData(k.ARRAY_BUFFER,Uc.array,jb)}if(Ob.uvsNeedUpdate&&Vc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Vc.buffer);k.bufferData(k.ARRAY_BUFFER,Vc.array,jb)}if(Ob.colorsNeedUpdate&&Wc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Wc.buffer);k.bufferData(k.ARRAY_BUFFER,Wc.array,jb)}if(Ob.tangentsNeedUpdate&&Xc!==void 0){k.bindBuffer(k.ARRAY_BUFFER,Xc.buffer);k.bufferData(k.ARRAY_BUFFER,Xc.array,jb)}if(rc){var qc=void 0;for(qc in Ob.attributes)delete Ob.attributes[qc].array}}ca.verticesNeedUpdate=
false;ca.elementsNeedUpdate=false;ca.uvsNeedUpdate=false;ca.normalsNeedUpdate=false;ca.colorsNeedUpdate=false;ca.tangentsNeedUpdate=false}else{for(var Yc=0,Dc=ca.geometryGroupsList.length;Yc<Dc;Yc++){hb=ca.geometryGroupsList[Yc];$a=c(vb,hb);ib=$a.attributes&&m($a);if(ca.verticesNeedUpdate||ca.morphTargetsNeedUpdate||ca.elementsNeedUpdate||ca.uvsNeedUpdate||ca.normalsNeedUpdate||ca.colorsNeedUpdate||ca.tangentsNeedUpdate||ib){var ka=hb,Rc=vb,nb=k.DYNAMIC_DRAW,rd=!ca.dynamic,ec=$a;if(ka.__inittedArrays){var gd=
d(ec),Zc=ec.vertexColors?ec.vertexColors:false,hd=f(ec),Fc=gd===THREE.SmoothShading,D=void 0,X=void 0,Wb=void 0,Q=void 0,kc=void 0,Xb=void 0,wb=void 0,Gc=void 0,Pb=void 0,lc=void 0,mc=void 0,R=void 0,S=void 0,T=void 0,ia=void 0,xb=void 0,yb=void 0,zb=void 0,sc=void 0,Ab=void 0,Bb=void 0,Cb=void 0,tc=void 0,Db=void 0,Eb=void 0,Fb=void 0,uc=void 0,Gb=void 0,Hb=void 0,Ib=void 0,vc=void 0,Jb=void 0,Kb=void 0,Lb=void 0,wc=void 0,qa=void 0,id=void 0,Yb=void 0,nc=void 0,oc=void 0,Na=void 0,jd=void 0,La=
void 0,Ma=void 0,Zb=void 0,Qb=void 0,Fa=0,Ja=0,Rb=0,Sb=0,ob=0,Sa=0,ta=0,Xa=0,Ha=0,$=0,da=0,z=0,ra=void 0,Oa=ka.__vertexArray,xc=ka.__uvArray,yc=ka.__uv2Array,pb=ka.__normalArray,ya=ka.__tangentArray,Pa=ka.__colorArray,za=ka.__skinIndexArray,Aa=ka.__skinWeightArray,$c=ka.__morphTargetsArrays,ad=ka.__morphNormalsArrays,bd=ka.__webglCustomAttributesList,w=void 0,Mb=ka.__faceArray,db=ka.__lineArray,ab=Rc.geometry,sd=ab.elementsNeedUpdate,kd=ab.uvsNeedUpdate,td=ab.normalsNeedUpdate,ud=ab.tangentsNeedUpdate,
vd=ab.colorsNeedUpdate,wd=ab.morphTargetsNeedUpdate,fc=ab.vertices,la=ka.faces3,ma=ka.faces4,Ta=ab.faces,cd=ab.faceVertexUvs[0],dd=ab.faceVertexUvs[1],gc=ab.skinIndices,$b=ab.skinWeights,ac=ab.morphTargets,Hc=ab.morphNormals;if(ab.verticesNeedUpdate){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];R=fc[Q.a];S=fc[Q.b];T=fc[Q.c];Oa[Ja]=R.x;Oa[Ja+1]=R.y;Oa[Ja+2]=R.z;Oa[Ja+3]=S.x;Oa[Ja+4]=S.y;Oa[Ja+5]=S.z;Oa[Ja+6]=T.x;Oa[Ja+7]=T.y;Oa[Ja+8]=T.z;Ja=Ja+9}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];R=fc[Q.a];S=fc[Q.b];
T=fc[Q.c];ia=fc[Q.d];Oa[Ja]=R.x;Oa[Ja+1]=R.y;Oa[Ja+2]=R.z;Oa[Ja+3]=S.x;Oa[Ja+4]=S.y;Oa[Ja+5]=S.z;Oa[Ja+6]=T.x;Oa[Ja+7]=T.y;Oa[Ja+8]=T.z;Oa[Ja+9]=ia.x;Oa[Ja+10]=ia.y;Oa[Ja+11]=ia.z;Ja=Ja+12}k.bindBuffer(k.ARRAY_BUFFER,ka.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Oa,nb)}if(wd){Na=0;for(jd=ac.length;Na<jd;Na++){D=da=0;for(X=la.length;D<X;D++){Zb=la[D];Q=Ta[Zb];R=ac[Na].vertices[Q.a];S=ac[Na].vertices[Q.b];T=ac[Na].vertices[Q.c];La=$c[Na];La[da]=R.x;La[da+1]=R.y;La[da+2]=R.z;La[da+3]=S.x;La[da+
4]=S.y;La[da+5]=S.z;La[da+6]=T.x;La[da+7]=T.y;La[da+8]=T.z;if(ec.morphNormals){if(Fc){Qb=Hc[Na].vertexNormals[Zb];Ab=Qb.a;Bb=Qb.b;Cb=Qb.c}else Cb=Bb=Ab=Hc[Na].faceNormals[Zb];Ma=ad[Na];Ma[da]=Ab.x;Ma[da+1]=Ab.y;Ma[da+2]=Ab.z;Ma[da+3]=Bb.x;Ma[da+4]=Bb.y;Ma[da+5]=Bb.z;Ma[da+6]=Cb.x;Ma[da+7]=Cb.y;Ma[da+8]=Cb.z}da=da+9}D=0;for(X=ma.length;D<X;D++){Zb=ma[D];Q=Ta[Zb];R=ac[Na].vertices[Q.a];S=ac[Na].vertices[Q.b];T=ac[Na].vertices[Q.c];ia=ac[Na].vertices[Q.d];La=$c[Na];La[da]=R.x;La[da+1]=R.y;La[da+2]=R.z;
La[da+3]=S.x;La[da+4]=S.y;La[da+5]=S.z;La[da+6]=T.x;La[da+7]=T.y;La[da+8]=T.z;La[da+9]=ia.x;La[da+10]=ia.y;La[da+11]=ia.z;if(ec.morphNormals){if(Fc){Qb=Hc[Na].vertexNormals[Zb];Ab=Qb.a;Bb=Qb.b;Cb=Qb.c;tc=Qb.d}else tc=Cb=Bb=Ab=Hc[Na].faceNormals[Zb];Ma=ad[Na];Ma[da]=Ab.x;Ma[da+1]=Ab.y;Ma[da+2]=Ab.z;Ma[da+3]=Bb.x;Ma[da+4]=Bb.y;Ma[da+5]=Bb.z;Ma[da+6]=Cb.x;Ma[da+7]=Cb.y;Ma[da+8]=Cb.z;Ma[da+9]=tc.x;Ma[da+10]=tc.y;Ma[da+11]=tc.z}da=da+12}k.bindBuffer(k.ARRAY_BUFFER,ka.__webglMorphTargetsBuffers[Na]);k.bufferData(k.ARRAY_BUFFER,
$c[Na],nb);if(ec.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,ka.__webglMorphNormalsBuffers[Na]);k.bufferData(k.ARRAY_BUFFER,ad[Na],nb)}}}if($b.length){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];Gb=$b[Q.a];Hb=$b[Q.b];Ib=$b[Q.c];Aa[$]=Gb.x;Aa[$+1]=Gb.y;Aa[$+2]=Gb.z;Aa[$+3]=Gb.w;Aa[$+4]=Hb.x;Aa[$+5]=Hb.y;Aa[$+6]=Hb.z;Aa[$+7]=Hb.w;Aa[$+8]=Ib.x;Aa[$+9]=Ib.y;Aa[$+10]=Ib.z;Aa[$+11]=Ib.w;Jb=gc[Q.a];Kb=gc[Q.b];Lb=gc[Q.c];za[$]=Jb.x;za[$+1]=Jb.y;za[$+2]=Jb.z;za[$+3]=Jb.w;za[$+4]=Kb.x;za[$+5]=Kb.y;za[$+6]=Kb.z;
za[$+7]=Kb.w;za[$+8]=Lb.x;za[$+9]=Lb.y;za[$+10]=Lb.z;za[$+11]=Lb.w;$=$+12}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];Gb=$b[Q.a];Hb=$b[Q.b];Ib=$b[Q.c];vc=$b[Q.d];Aa[$]=Gb.x;Aa[$+1]=Gb.y;Aa[$+2]=Gb.z;Aa[$+3]=Gb.w;Aa[$+4]=Hb.x;Aa[$+5]=Hb.y;Aa[$+6]=Hb.z;Aa[$+7]=Hb.w;Aa[$+8]=Ib.x;Aa[$+9]=Ib.y;Aa[$+10]=Ib.z;Aa[$+11]=Ib.w;Aa[$+12]=vc.x;Aa[$+13]=vc.y;Aa[$+14]=vc.z;Aa[$+15]=vc.w;Jb=gc[Q.a];Kb=gc[Q.b];Lb=gc[Q.c];wc=gc[Q.d];za[$]=Jb.x;za[$+1]=Jb.y;za[$+2]=Jb.z;za[$+3]=Jb.w;za[$+4]=Kb.x;za[$+5]=Kb.y;za[$+6]=Kb.z;
za[$+7]=Kb.w;za[$+8]=Lb.x;za[$+9]=Lb.y;za[$+10]=Lb.z;za[$+11]=Lb.w;za[$+12]=wc.x;za[$+13]=wc.y;za[$+14]=wc.z;za[$+15]=wc.w;$=$+16}if($>0){k.bindBuffer(k.ARRAY_BUFFER,ka.__webglSkinIndicesBuffer);k.bufferData(k.ARRAY_BUFFER,za,nb);k.bindBuffer(k.ARRAY_BUFFER,ka.__webglSkinWeightsBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,nb)}}if(vd&&Zc){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];wb=Q.vertexColors;Gc=Q.color;if(wb.length===3&&Zc===THREE.VertexColors){Db=wb[0];Eb=wb[1];Fb=wb[2]}else Fb=Eb=Db=Gc;Pa[Ha]=Db.r;
Pa[Ha+1]=Db.g;Pa[Ha+2]=Db.b;Pa[Ha+3]=Eb.r;Pa[Ha+4]=Eb.g;Pa[Ha+5]=Eb.b;Pa[Ha+6]=Fb.r;Pa[Ha+7]=Fb.g;Pa[Ha+8]=Fb.b;Ha=Ha+9}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];wb=Q.vertexColors;Gc=Q.color;if(wb.length===4&&Zc===THREE.VertexColors){Db=wb[0];Eb=wb[1];Fb=wb[2];uc=wb[3]}else uc=Fb=Eb=Db=Gc;Pa[Ha]=Db.r;Pa[Ha+1]=Db.g;Pa[Ha+2]=Db.b;Pa[Ha+3]=Eb.r;Pa[Ha+4]=Eb.g;Pa[Ha+5]=Eb.b;Pa[Ha+6]=Fb.r;Pa[Ha+7]=Fb.g;Pa[Ha+8]=Fb.b;Pa[Ha+9]=uc.r;Pa[Ha+10]=uc.g;Pa[Ha+11]=uc.b;Ha=Ha+12}if(Ha>0){k.bindBuffer(k.ARRAY_BUFFER,
ka.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Pa,nb)}}if(ud&&ab.hasTangents){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];Pb=Q.vertexTangents;xb=Pb[0];yb=Pb[1];zb=Pb[2];ya[ta]=xb.x;ya[ta+1]=xb.y;ya[ta+2]=xb.z;ya[ta+3]=xb.w;ya[ta+4]=yb.x;ya[ta+5]=yb.y;ya[ta+6]=yb.z;ya[ta+7]=yb.w;ya[ta+8]=zb.x;ya[ta+9]=zb.y;ya[ta+10]=zb.z;ya[ta+11]=zb.w;ta=ta+12}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];Pb=Q.vertexTangents;xb=Pb[0];yb=Pb[1];zb=Pb[2];sc=Pb[3];ya[ta]=xb.x;ya[ta+1]=xb.y;ya[ta+2]=xb.z;ya[ta+3]=xb.w;ya[ta+
4]=yb.x;ya[ta+5]=yb.y;ya[ta+6]=yb.z;ya[ta+7]=yb.w;ya[ta+8]=zb.x;ya[ta+9]=zb.y;ya[ta+10]=zb.z;ya[ta+11]=zb.w;ya[ta+12]=sc.x;ya[ta+13]=sc.y;ya[ta+14]=sc.z;ya[ta+15]=sc.w;ta=ta+16}k.bindBuffer(k.ARRAY_BUFFER,ka.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,ya,nb)}if(td&&gd){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];kc=Q.vertexNormals;Xb=Q.normal;if(kc.length===3&&Fc)for(qa=0;qa<3;qa++){Yb=kc[qa];pb[Sa]=Yb.x;pb[Sa+1]=Yb.y;pb[Sa+2]=Yb.z;Sa=Sa+3}else for(qa=0;qa<3;qa++){pb[Sa]=Xb.x;pb[Sa+1]=Xb.y;pb[Sa+
2]=Xb.z;Sa=Sa+3}}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];kc=Q.vertexNormals;Xb=Q.normal;if(kc.length===4&&Fc)for(qa=0;qa<4;qa++){Yb=kc[qa];pb[Sa]=Yb.x;pb[Sa+1]=Yb.y;pb[Sa+2]=Yb.z;Sa=Sa+3}else for(qa=0;qa<4;qa++){pb[Sa]=Xb.x;pb[Sa+1]=Xb.y;pb[Sa+2]=Xb.z;Sa=Sa+3}}k.bindBuffer(k.ARRAY_BUFFER,ka.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,pb,nb)}if(kd&&cd&&hd){D=0;for(X=la.length;D<X;D++){Wb=la[D];lc=cd[Wb];if(lc!==void 0)for(qa=0;qa<3;qa++){nc=lc[qa];xc[Rb]=nc.u;xc[Rb+1]=nc.v;Rb=Rb+2}}D=0;for(X=
ma.length;D<X;D++){Wb=ma[D];lc=cd[Wb];if(lc!==void 0)for(qa=0;qa<4;qa++){nc=lc[qa];xc[Rb]=nc.u;xc[Rb+1]=nc.v;Rb=Rb+2}}if(Rb>0){k.bindBuffer(k.ARRAY_BUFFER,ka.__webglUVBuffer);k.bufferData(k.ARRAY_BUFFER,xc,nb)}}if(kd&&dd&&hd){D=0;for(X=la.length;D<X;D++){Wb=la[D];mc=dd[Wb];if(mc!==void 0)for(qa=0;qa<3;qa++){oc=mc[qa];yc[Sb]=oc.u;yc[Sb+1]=oc.v;Sb=Sb+2}}D=0;for(X=ma.length;D<X;D++){Wb=ma[D];mc=dd[Wb];if(mc!==void 0)for(qa=0;qa<4;qa++){oc=mc[qa];yc[Sb]=oc.u;yc[Sb+1]=oc.v;Sb=Sb+2}}if(Sb>0){k.bindBuffer(k.ARRAY_BUFFER,
ka.__webglUV2Buffer);k.bufferData(k.ARRAY_BUFFER,yc,nb)}}if(sd){D=0;for(X=la.length;D<X;D++){Mb[ob]=Fa;Mb[ob+1]=Fa+1;Mb[ob+2]=Fa+2;ob=ob+3;db[Xa]=Fa;db[Xa+1]=Fa+1;db[Xa+2]=Fa;db[Xa+3]=Fa+2;db[Xa+4]=Fa+1;db[Xa+5]=Fa+2;Xa=Xa+6;Fa=Fa+3}D=0;for(X=ma.length;D<X;D++){Mb[ob]=Fa;Mb[ob+1]=Fa+1;Mb[ob+2]=Fa+3;Mb[ob+3]=Fa+1;Mb[ob+4]=Fa+2;Mb[ob+5]=Fa+3;ob=ob+6;db[Xa]=Fa;db[Xa+1]=Fa+1;db[Xa+2]=Fa;db[Xa+3]=Fa+3;db[Xa+4]=Fa+1;db[Xa+5]=Fa+2;db[Xa+6]=Fa+2;db[Xa+7]=Fa+3;Xa=Xa+8;Fa=Fa+4}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,
ka.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Mb,nb);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ka.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,db,nb)}if(bd){qa=0;for(id=bd.length;qa<id;qa++){w=bd[qa];if(w.__original.needsUpdate){z=0;if(w.size===1)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];w.array[z]=w.value[Q.a];w.array[z+1]=w.value[Q.b];w.array[z+2]=w.value[Q.c];z=z+3}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];w.array[z]=w.value[Q.a];w.array[z+
1]=w.value[Q.b];w.array[z+2]=w.value[Q.c];w.array[z+3]=w.value[Q.d];z=z+4}}else{if(w.boundTo==="faces"){D=0;for(X=la.length;D<X;D++){ra=w.value[la[D]];w.array[z]=ra;w.array[z+1]=ra;w.array[z+2]=ra;z=z+3}D=0;for(X=ma.length;D<X;D++){ra=w.value[ma[D]];w.array[z]=ra;w.array[z+1]=ra;w.array[z+2]=ra;w.array[z+3]=ra;z=z+4}}}else if(w.size===2)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];w.array[z]=R.x;w.array[z+1]=R.y;
w.array[z+2]=S.x;w.array[z+3]=S.y;w.array[z+4]=T.x;w.array[z+5]=T.y;z=z+6}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];ia=w.value[Q.d];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=S.x;w.array[z+3]=S.y;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=ia.x;w.array[z+7]=ia.y;z=z+8}}else{if(w.boundTo==="faces"){D=0;for(X=la.length;D<X;D++){T=S=R=ra=w.value[la[D]];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=S.x;w.array[z+3]=S.y;w.array[z+4]=T.x;w.array[z+5]=T.y;
z=z+6}D=0;for(X=ma.length;D<X;D++){ia=T=S=R=ra=w.value[ma[D]];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=S.x;w.array[z+3]=S.y;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=ia.x;w.array[z+7]=ia.y;z=z+8}}}else if(w.size===3){var Z;Z=w.type==="c"?["r","g","b"]:["x","y","z"];if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=
S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];z=z+9}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];ia=w.value[Q.d];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];w.array[z+9]=ia[Z[0]];w.array[z+10]=ia[Z[1]];w.array[z+11]=ia[Z[2]];z=z+12}}else if(w.boundTo==="faces"){D=0;for(X=
la.length;D<X;D++){T=S=R=ra=w.value[la[D]];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];z=z+9}D=0;for(X=ma.length;D<X;D++){ia=T=S=R=ra=w.value[ma[D]];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];w.array[z+9]=ia[Z[0]];
w.array[z+10]=ia[Z[1]];w.array[z+11]=ia[Z[2]];z=z+12}}else if(w.boundTo==="faceVertices"){D=0;for(X=la.length;D<X;D++){ra=w.value[la[D]];R=ra[0];S=ra[1];T=ra[2];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];z=z+9}D=0;for(X=ma.length;D<X;D++){ra=w.value[ma[D]];R=ra[0];S=ra[1];T=ra[2];ia=ra[3];w.array[z]=R[Z[0]];w.array[z+1]=R[Z[1]];w.array[z+2]=R[Z[2]];w.array[z+
3]=S[Z[0]];w.array[z+4]=S[Z[1]];w.array[z+5]=S[Z[2]];w.array[z+6]=T[Z[0]];w.array[z+7]=T[Z[1]];w.array[z+8]=T[Z[2]];w.array[z+9]=ia[Z[0]];w.array[z+10]=ia[Z[1]];w.array[z+11]=ia[Z[2]];z=z+12}}}else if(w.size===4)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(X=la.length;D<X;D++){Q=Ta[la[D]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+
9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;z=z+12}D=0;for(X=ma.length;D<X;D++){Q=Ta[ma[D]];R=w.value[Q.a];S=w.value[Q.b];T=w.value[Q.c];ia=w.value[Q.d];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;w.array[z+12]=ia.x;w.array[z+13]=ia.y;w.array[z+14]=ia.z;w.array[z+15]=ia.w;z=z+16}}else if(w.boundTo==="faces"){D=0;for(X=la.length;D<X;D++){T=S=
R=ra=w.value[la[D]];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;z=z+12}D=0;for(X=ma.length;D<X;D++){ia=T=S=R=ra=w.value[ma[D]];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;w.array[z+
12]=ia.x;w.array[z+13]=ia.y;w.array[z+14]=ia.z;w.array[z+15]=ia.w;z=z+16}}else if(w.boundTo==="faceVertices"){D=0;for(X=la.length;D<X;D++){ra=w.value[la[D]];R=ra[0];S=ra[1];T=ra[2];w.array[z]=R.x;w.array[z+1]=R.y;w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;z=z+12}D=0;for(X=ma.length;D<X;D++){ra=w.value[ma[D]];R=ra[0];S=ra[1];T=ra[2];ia=ra[3];w.array[z]=R.x;w.array[z+1]=R.y;
w.array[z+2]=R.z;w.array[z+3]=R.w;w.array[z+4]=S.x;w.array[z+5]=S.y;w.array[z+6]=S.z;w.array[z+7]=S.w;w.array[z+8]=T.x;w.array[z+9]=T.y;w.array[z+10]=T.z;w.array[z+11]=T.w;w.array[z+12]=ia.x;w.array[z+13]=ia.y;w.array[z+14]=ia.z;w.array[z+15]=ia.w;z=z+16}}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,nb)}}}if(rd){delete ka.__inittedArrays;delete ka.__colorArray;delete ka.__normalArray;delete ka.__tangentArray;delete ka.__uvArray;delete ka.__uv2Array;delete ka.__faceArray;
delete ka.__vertexArray;delete ka.__lineArray;delete ka.__skinIndexArray;delete ka.__skinWeightArray}}}}ca.verticesNeedUpdate=false;ca.morphTargetsNeedUpdate=false;ca.elementsNeedUpdate=false;ca.uvsNeedUpdate=false;ca.normalsNeedUpdate=false;ca.colorsNeedUpdate=false;ca.tangentsNeedUpdate=false;$a.attributes&&q($a)}else if(vb instanceof THREE.Ribbon){if(ca.verticesNeedUpdate||ca.colorsNeedUpdate){var bc=ca,ld=k.DYNAMIC_DRAW,zc=void 0,Ac=void 0,Ic=void 0,cc=void 0,Jc=void 0,md=bc.vertices,nd=bc.colors,
xd=md.length,yd=nd.length,Kc=bc.__vertexArray,Lc=bc.__colorArray,zd=bc.colorsNeedUpdate;if(bc.verticesNeedUpdate){for(zc=0;zc<xd;zc++){Ic=md[zc];cc=zc*3;Kc[cc]=Ic.x;Kc[cc+1]=Ic.y;Kc[cc+2]=Ic.z}k.bindBuffer(k.ARRAY_BUFFER,bc.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Kc,ld)}if(zd){for(Ac=0;Ac<yd;Ac++){Jc=nd[Ac];cc=Ac*3;Lc[cc]=Jc.r;Lc[cc+1]=Jc.g;Lc[cc+2]=Jc.b}k.bindBuffer(k.ARRAY_BUFFER,bc.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Lc,ld)}}ca.verticesNeedUpdate=false;ca.colorsNeedUpdate=
false}else if(vb instanceof THREE.Line){$a=c(vb,hb);ib=$a.attributes&&m($a);if(ca.verticesNeedUpdate||ca.colorsNeedUpdate||ib){var Tb=ca,ed=k.DYNAMIC_DRAW,Bc=void 0,Cc=void 0,Mc=void 0,Ba=void 0,Nc=void 0,od=Tb.vertices,pd=Tb.colors,Ad=od.length,Bd=pd.length,Oc=Tb.__vertexArray,Pc=Tb.__colorArray,Cd=Tb.colorsNeedUpdate,fd=Tb.__webglCustomAttributesList,Qc=void 0,qd=void 0,Ra=void 0,pc=void 0,bb=void 0,wa=void 0;if(Tb.verticesNeedUpdate){for(Bc=0;Bc<Ad;Bc++){Mc=od[Bc];Ba=Bc*3;Oc[Ba]=Mc.x;Oc[Ba+1]=
Mc.y;Oc[Ba+2]=Mc.z}k.bindBuffer(k.ARRAY_BUFFER,Tb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Oc,ed)}if(Cd){for(Cc=0;Cc<Bd;Cc++){Nc=pd[Cc];Ba=Cc*3;Pc[Ba]=Nc.r;Pc[Ba+1]=Nc.g;Pc[Ba+2]=Nc.b}k.bindBuffer(k.ARRAY_BUFFER,Tb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Pc,ed)}if(fd){Qc=0;for(qd=fd.length;Qc<qd;Qc++){wa=fd[Qc];if(wa.needsUpdate&&(wa.boundTo===void 0||wa.boundTo==="vertices")){Ba=0;pc=wa.value.length;if(wa.size===1)for(Ra=0;Ra<pc;Ra++)wa.array[Ra]=wa.value[Ra];else if(wa.size===2)for(Ra=
0;Ra<pc;Ra++){bb=wa.value[Ra];wa.array[Ba]=bb.x;wa.array[Ba+1]=bb.y;Ba=Ba+2}else if(wa.size===3)if(wa.type==="c")for(Ra=0;Ra<pc;Ra++){bb=wa.value[Ra];wa.array[Ba]=bb.r;wa.array[Ba+1]=bb.g;wa.array[Ba+2]=bb.b;Ba=Ba+3}else for(Ra=0;Ra<pc;Ra++){bb=wa.value[Ra];wa.array[Ba]=bb.x;wa.array[Ba+1]=bb.y;wa.array[Ba+2]=bb.z;Ba=Ba+3}else if(wa.size===4)for(Ra=0;Ra<pc;Ra++){bb=wa.value[Ra];wa.array[Ba]=bb.x;wa.array[Ba+1]=bb.y;wa.array[Ba+2]=bb.z;wa.array[Ba+3]=bb.w;Ba=Ba+4}k.bindBuffer(k.ARRAY_BUFFER,wa.buffer);
k.bufferData(k.ARRAY_BUFFER,wa.array,ed)}}}}ca.verticesNeedUpdate=false;ca.colorsNeedUpdate=false;$a.attributes&&q($a)}else if(vb instanceof THREE.ParticleSystem){$a=c(vb,hb);ib=$a.attributes&&m($a);(ca.verticesNeedUpdate||ca.colorsNeedUpdate||vb.sortParticles||ib)&&e(ca,k.DYNAMIC_DRAW,vb);ca.verticesNeedUpdate=false;ca.colorsNeedUpdate=false;$a.attributes&&q($a)}}};this.initMaterial=function(a,b,c,d){var f,e,g,h,i,j,l,m;a instanceof THREE.MeshDepthMaterial?m="depth":a instanceof THREE.MeshNormalMaterial?
m="normal":a instanceof THREE.MeshBasicMaterial?m="basic":a instanceof THREE.MeshLambertMaterial?m="lambert":a instanceof THREE.MeshPhongMaterial?m="phong":a instanceof THREE.LineBasicMaterial?m="basic":a instanceof THREE.ParticleBasicMaterial&&(m="particle_basic");if(m){var n=THREE.ShaderLib[m];a.uniforms=THREE.UniformsUtils.clone(n.uniforms);a.vertexShader=n.vertexShader;a.fragmentShader=n.fragmentShader}var o,p;o=g=f=n=0;for(e=b.length;o<e;o++){p=b[o];if(!p.onlyShadow){p instanceof THREE.DirectionalLight&&
g++;p instanceof THREE.PointLight&&f++;p instanceof THREE.SpotLight&&n++}}if(f+n+g<=W){o=g;e=f}else{o=Math.ceil(W*g/(f+g));n=e=W-o}f=o;g=n;n=l=0;for(o=b.length;n<o;n++){p=b[n];if(p.castShadow){p instanceof THREE.SpotLight&&l++;p instanceof THREE.DirectionalLight&&!p.shadowCascade&&l++}}if(dc&&d&&d.useVertexTexture)j=1024;else{b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS);b=Math.floor((b-20)/4);if(d!==void 0&&d instanceof THREE.SkinnedMesh){b=Math.min(d.bones.length,b);b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+
d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")}j=b}var q;a:{p=a.fragmentShader;o=a.vertexShader;var n=a.uniforms,b=a.attributes,c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,sizeAttenuation:a.sizeAttenuation,skinning:a.skinning,maxBones:j,useVertexTexture:dc&&d&&d.useVertexTexture,boneTextureWidth:d&&d.boneTextureWidth,boneTextureHeight:d&&d.boneTextureHeight,morphTargets:a.morphTargets,
morphNormals:a.morphNormals,maxMorphTargets:this.maxMorphTargets,maxMorphNormals:this.maxMorphNormals,maxDirLights:f,maxPointLights:e,maxSpotLights:g,maxShadows:l,shadowMapEnabled:this.shadowMapEnabled&&d.receiveShadow,shadowMapSoft:this.shadowMapSoft,shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide},r,d=[];if(m)d.push(m);else{d.push(p);d.push(o)}for(r in c){d.push(r);
d.push(c[r])}m=d.join();r=0;for(d=N.length;r<d;r++){f=N[r];if(f.code===m){f.usedTimes++;q=f.program;break a}}r=k.createProgram();d=["precision "+G+" float;",rc?"#define VERTEX_TEXTURES":"",K.gammaInput?"#define GAMMA_INPUT":"",K.gammaOutput?"#define GAMMA_OUTPUT":"",K.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_SHADOWS "+c.maxShadows,"#define MAX_BONES "+
...
"#define SHADOWMAP_DEBUG":"",c.shadowMapCascade?"#define SHADOWMAP_CASCADE":"","uniform mat4 viewMatrix;\nuniform vec3 cameraPosition;\n"].join("\n");f=A("fragment",f+p);d=A("vertex",d+o);k.attachShader(r,d);k.attachShader(r,f);k.linkProgram(r);k.getProgramParameter(r,k.LINK_STATUS)||console.error("Could not initialise shader\nVALIDATE_STATUS: "+k.getProgramParameter(r,k.VALIDATE_STATUS)+", gl error ["+k.getError()+"]");k.deleteShader(f);k.deleteShader(d);r.uniforms={};r.attributes={};var s,d=["viewMatrix",
"modelViewMatrix","projectionMatrix","normalMatrix","modelMatrix","cameraPosition","morphTargetInfluences"];c.useVertexTexture?d.push("boneTexture"):d.push("boneGlobalMatrices");for(s in n)d.push(s);s=d;d=0;for(n=s.length;d<n;d++){f=s[d];r.uniforms[f]=k.getUniformLocation(r,f)}d=["position","normal","uv","uv2","tangent","color","skinIndex","skinWeight"];for(s=0;s<c.maxMorphTargets;s++)d.push("morphTarget"+s);for(s=0;s<c.maxMorphNormals;s++)d.push("morphNormal"+s);for(q in b)d.push(q);q=d;s=0;for(c=
q.length;s<c;s++){d=q[s];r.attributes[d]=k.getAttribLocation(r,d)}r.id=O++;N.push({program:r,code:m,usedTimes:1});K.info.memory.programs=N.length;q=r}a.program=q;q=a.program.attributes;q.position>=0&&k.enableVertexAttribArray(q.position);q.color>=0&&k.enableVertexAttribArray(q.color);q.normal>=0&&k.enableVertexAttribArray(q.normal);q.tangent>=0&&k.enableVertexAttribArray(q.tangent);if(a.skinning&&q.skinIndex>=0&&q.skinWeight>=0){k.enableVertexAttribArray(q.skinIndex);k.enableVertexAttribArray(q.skinWeight)}if(a.attributes)for(i in a.attributes)q[i]!==
...
function(a,b){if(a){!b||b==="ccw"?k.frontFace(k.CCW):k.frontFace(k.CW);a==="back"?k.cullFace(k.BACK):a==="front"?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK);k.enable(k.CULL_FACE)}else k.disable(k.CULL_FACE)};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,a=a.side===THREE.BackSide;if(Y!==b){b?k.disable(k.CULL_FACE):k.enable(k.CULL_FACE);Y=b}if(ea!==a){a?k.frontFace(k.CW):k.frontFace(k.CCW);ea=a}};this.setDepthTest=function(a){if(Da!==a){a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST);
Da=a}};this.setDepthWrite=function(a){if(Qa!==a){k.depthMask(a);Qa=a}};this.setBlending=function(a,b,c,d){if(a!==oa){if(a===THREE.NoBlending)k.disable(k.BLEND);else if(a===THREE.AdditiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE)}else if(a===THREE.SubtractiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)}else if(a===THREE.MultiplyBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,
k.SRC_COLOR)}else if(a===THREE.CustomBlending)k.enable(k.BLEND);else{k.enable(k.BLEND);k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD);k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)}oa=a}if(a===THREE.CustomBlending){if(b!==pa){k.blendEquation(x(b));pa=b}if(c!==xa||d!==Ca){k.blendFunc(x(c),x(d));xa=c;Ca=d}}else Ca=xa=pa=null};this.setTexture=function(a,b){if(a.needsUpdate){if(!a.__webglInit){a.__webglInit=true;a.__webglTexture=k.createTexture();K.info.memory.textures++}k.activeTexture(k.TEXTURE0+
b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=(c.width&c.width-1)===0&&(c.height&c.height-1)===0,f=x(a.format),e=x(a.type);y(k.TEXTURE_2D,a,d);a instanceof THREE.DataTexture?k.texImage2D(k.TEXTURE_2D,0,f,c.width,c.height,0,f,e,c.data):k.texImage2D(k.TEXTURE_2D,0,f,f,e,a.image);a.generateMipmaps&&d&&k.generateMipmap(k.TEXTURE_2D);a.needsUpdate=false;if(a.onUpdate)a.onUpdate()}else{k.activeTexture(k.TEXTURE0+
b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture)}};this.setRenderTarget=function(a){var b=a instanceof THREE.WebGLRenderTargetCube;if(a&&!a.__webglFramebuffer){if(a.depthBuffer===void 0)a.depthBuffer=true;if(a.stencilBuffer===void 0)a.stencilBuffer=true;a.__webglTexture=k.createTexture();var c=(a.width&a.width-1)===0&&(a.height&a.height-1)===0,d=x(a.format),f=x(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);y(k.TEXTURE_CUBE_MAP,a,c);
for(var e=0;e<6;e++){a.__webglFramebuffer[e]=k.createFramebuffer();a.__webglRenderbuffer[e]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+e,0,d,a.width,a.height,0,d,f,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+e;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[e]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);B(a.__webglRenderbuffer[e],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=
k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);y(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,f,null);d=k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);B(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,
null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;f=d=0}else{b=null;c=Ya;a=Ia;d=gb;f=ub}if(b!==ua){k.bindFramebuffer(k.FRAMEBUFFER,b);k.viewport(d,f,c,a);ua=b}Ea=c;hb=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
j[q],r,t,u=g.vertexNormals,v=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+f,g.b+f,g.c+f):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+f,g.b+f,g.c+f,g.d+f));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(o=u.length;h<o;h++){t=u[h].clone();d&&d.multiplyVector3(t);r.vertexNormals.push(t)}r.color.copy(g.color);h=0;for(o=v.length;h<o;h++){t=v[h];r.vertexColors.push(t.clone())}if(g.materialIndex!==void 0){h=e.materials[g.materialIndex];o=h.id;v=m[o];if(v===void 0){v=
...
a.vertices[i];q=j.distanceTo(l);p=l.distanceTo(n);o=n.distanceTo(m);r=j.distanceTo(m);if(q>b||p>b||o>b||r>b){t=a.vertices.length;u=a.vertices.length+1;v=f.clone();s=f.clone();if(q>=p&&q>=o&&q>=r||o>=p&&o>=q&&o>=r){q=j.clone();q.lerpSelf(l,0.5);l=n.clone();l.lerpSelf(m,0.5);v.a=e;v.b=t;v.c=u;v.d=i;s.a=t;s.b=g;s.c=h;s.d=u;if(f.vertexNormals.length===4){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);g=f.vertexNormals[2].clone();g.lerpSelf(f.vertexNormals[3],0.5);v.vertexNormals[1].copy(e);
v.vertexNormals[2].copy(g);s.vertexNormals[0].copy(e);s.vertexNormals[3].copy(g)}if(f.vertexColors.length===4){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[1],0.5);g=f.vertexColors[2].clone();g.lerpSelf(f.vertexColors[3],0.5);v.vertexColors[1].copy(e);v.vertexColors[2].copy(g);s.vertexColors[0].copy(e);s.vertexColors[3].copy(g)}f=0}else{q=l.clone();q.lerpSelf(n,0.5);l=m.clone();l.lerpSelf(j,0.5);v.a=e;v.b=g;v.c=t;v.d=u;s.a=u;s.b=t;s.c=h;s.d=i;if(f.vertexNormals.length===4){e=f.vertexNormals[1].clone();
e.lerpSelf(f.vertexNormals[2],0.5);g=f.vertexNormals[3].clone();g.lerpSelf(f.vertexNormals[0],0.5);v.vertexNormals[2].copy(e);v.vertexNormals[3].copy(g);s.vertexNormals[0].copy(g);s.vertexNormals[1].copy(e)}if(f.vertexColors.length===4){e=f.vertexColors[1].clone();e.lerpSelf(f.vertexColors[2],0.5);g=f.vertexColors[3].clone();g.lerpSelf(f.vertexColors[0],0.5);v.vertexColors[2].copy(e);v.vertexColors[3].copy(g);s.vertexColors[0].copy(g);s.vertexColors[1].copy(e)}f=1}A.push(v,s);a.vertices.push(q,l);
e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){j=a.faceVertexUvs[e][c];s=j[0];h=j[1];v=j[2];j=j[3];if(f===0){l=s.clone();l.lerpSelf(h,0.5);n=v.clone();n.lerpSelf(j,0.5);s=[s.clone(),l.clone(),n.clone(),j.clone()];h=[l.clone(),h.clone(),v.clone(),n.clone()]}else{l=h.clone();l.lerpSelf(v,0.5);n=j.clone();n.lerpSelf(s,0.5);s=[s.clone(),h.clone(),l.clone(),n.clone()];h=[n.clone(),l.clone(),v.clone(),j.clone()]}y[e].push(s,h)}}else{A.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)y[e].push(a.faceVertexUvs[e][c])}}}a.faces=
...
1?f-1:n+1,p=l-1<0?0:l-1,o=l+1>d-1?d-1:l+1,r=[],t=[0,0,h[(n*d+l)*4]/255*b];r.push([-1,0,h[(n*d+p)*4]/255*b]);r.push([-1,-1,h[(m*d+p)*4]/255*b]);r.push([0,-1,h[(m*d+l)*4]/255*b]);r.push([1,-1,h[(m*d+o)*4]/255*b]);r.push([1,0,h[(n*d+o)*4]/255*b]);r.push([1,1,h[(q*d+o)*4]/255*b]);r.push([0,1,h[(q*d+l)*4]/255*b]);r.push([-1,1,h[(q*d+p)*4]/255*b]);m=[];p=r.length;for(q=0;q<p;q++){var o=r[q],u=r[(q+1)%p],o=[o[0]-t[0],o[1]-t[1],o[2]-t[2]],u=[u[0]-t[0],u[1]-t[1],u[2]-t[2]];m.push(c([o[1]*u[2]-o[2]*u[1],o[2]*
u[0]-o[0]*u[2],o[0]*u[1]-o[1]*u[0]]))}r=[0,0,0];for(q=0;q<m.length;q++){r[0]=r[0]+m[q][0];r[1]=r[1]+m[q][1];r[2]=r[2]+m[q][2]}r[0]=r[0]/m.length;r[1]=r[1]/m.length;r[2]=r[2]/m.length;t=(n*d+l)*4;j[t]=(r[0]+1)/2*255|0;j[t+1]=(r[1]+1)/2*255|0;j[t+2]=r[2]*255|0;j[t+3]=255}g.putImageData(i,0,0);return e},generateDataTexture:function(a,b,c){for(var d=a*b,f=new Uint8Array(3*d),e=Math.floor(c.r*255),g=Math.floor(c.g*255),c=Math.floor(c.b*255),h=0;h<d;h++){f[h*3]=e;f[h*3+1]=g;f[h*3+2]=c}a=new THREE.DataTexture(f,
...
(function(a){var b=function(a){for(var b=a.length,f=0,e=b-1,g=0;g<b;e=g++)f=f+(a[e].x*a[g].y-a[g].x*a[e].y);return f*0.5};a.Triangulate=function(a,d){var f=a.length;if(f<3)return null;var e=[],g=[],h=[],i,j,l;if(b(a)>0)for(j=0;j<f;j++)g[j]=j;else for(j=0;j<f;j++)g[j]=f-1-j;var n=2*f;for(j=f-1;f>2;){if(n--<=0){console.log("Warning, unable to triangulate polygon!");break}i=j;f<=i&&(i=0);j=i+1;f<=j&&(j=0);l=j+1;f<=l&&(l=0);var m;a:{m=a;var q=i,p=j,o=l,r=f,t=g,u=void 0,v=void 0,s=void 0,A=void 0,y=void 0,
B=void 0,I=void 0,x=void 0,H=void 0,v=m[t[q]].x,s=m[t[q]].y,A=m[t[p]].x,y=m[t[p]].y,B=m[t[o]].x,I=m[t[o]].y;if(1E-10>(A-v)*(I-s)-(y-s)*(B-v))m=false;else{for(u=0;u<r;u++)if(!(u==q||u==p||u==o)){var x=m[t[u]].x,H=m[t[u]].y,G=void 0,F=void 0,E=void 0,M=void 0,C=void 0,L=void 0,P=void 0,J=void 0,W=void 0,K=void 0,N=void 0,O=void 0,G=E=C=void 0,G=B-A,F=I-y,E=v-B,M=s-I,C=A-v,L=y-s,P=x-v,J=H-s,W=x-A,K=H-y,N=x-B,O=H-I,G=G*K-F*W,C=C*J-L*P,E=E*O-M*N;if(G>=0&&E>=0&&C>=0){m=false;break a}}m=true}}if(m){e.push([a[g[i]],
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function i(a,b,c,g,h,i,l,m){var n,o=d||1,p=f||1,q=h/2,r=i/2,t=j.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=e||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=e||1}var u=o+1,v=p+1,K=h/o,N=i/p,O=new THREE.Vector3;O[n]=l>0?1:-1;for(h=0;h<v;h++)for(i=0;i<u;i++){var ba=new THREE.Vector3;ba[a]=(i*K-q)*c;ba[b]=(h*N-r)*g;ba[n]=l;j.vertices.push(ba)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
u*h+t,i+u*(h+1)+t,i+1+u*(h+1)+t,i+1+u*h+t);a.normal.copy(O);a.vertexNormals.push(O.clone(),O.clone(),O.clone(),O.clone());a.materialIndex=m;j.faces.push(a);j.faceVertexUvs[0].push([new THREE.UV(i/o,1-h/p),new THREE.UV(i/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-h/p)])}}THREE.Geometry.call(this);var j=this,l=a/2,n=b/2,m=c/2,q,p,o,r,t,u;if(g!==void 0){if(g instanceof Array)this.materials=g;else{this.materials=[];for(q=0;q<6;q++)this.materials.push(g)}q=0;r=1;p=2;t=3;o=4;u=
5}else this.materials=[];this.sides={px:true,nx:true,py:true,ny:true,pz:true,nz:true};if(h!=void 0)for(var v in h)this.sides[v]!==void 0&&(this.sides[v]=h[v]);this.sides.px&&i("z","y",-1,-1,c,b,l,q);this.sides.nx&&i("z","y",1,-1,c,b,-l,r);this.sides.py&&i("x","z",1,1,a,c,n,p);this.sides.ny&&i("x","z",1,-1,a,c,-n,t);this.sides.pz&&i("x","y",1,-1,a,b,m,o);this.sides.nz&&i("x","y",-1,-1,a,b,-m,u);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
this.vertices[j[0][h+1]].clone()}else{n=this.vertices[j[1][h]].clone();m=this.vertices[j[1][h+1]].clone()}n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<f;i++){var q=j[i][h],p=j[i+1][h],o=j[i+1][h+1],r=j[i][h+1],t=n.clone(),u=n.clone(),v=m.clone(),s=m.clone(),A=l[i][h].clone(),y=l[i+1][h].clone(),B=l[i+1][h+1].clone(),I=l[i][h+1].clone();this.faces.push(new THREE.Face4(q,p,o,r,[t,u,v,s]));this.faceVertexUvs[0].push([A,y,B,I])}}if(!e&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){q=j[0][h];p=j[0][h+1];o=this.vertices.length-1;t=new THREE.Vector3(0,1,0);u=new THREE.Vector3(0,1,0);v=new THREE.Vector3(0,1,0);A=l[0][h].clone();y=l[0][h+1].clone();B=new THREE.UV(y.u,0);this.faces.push(new THREE.Face3(q,p,o,[t,u,v]));this.faceVertexUvs[0].push([A,y,B])}}if(!e&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){q=j[i][h+1];p=j[i][h];o=this.vertices.length-1;t=new THREE.Vector3(0,-1,0);u=new THREE.Vector3(0,
-1,0);v=new THREE.Vector3(0,-1,0);A=l[i][h+1].clone();y=l[i][h].clone();B=new THREE.UV(y.u,1);this.faces.push(new THREE.Face3(q,p,o,[t,u,v]));this.faceVertexUvs[0].push([A,y,B])}}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
c.length-1);for(var g=0,h=m+l*2,g=0;g<h;g++){var i=W*g,j=W*(g+1),n=d+e+i,i=d+f+i,o=d+f+j,j=d+e+j,p=c,q=g,r=h,s=e,v=f,n=n+G,i=i+G,o=o+G,j=j+G;H.faces.push(new THREE.Face4(n,i,o,j,null,null,t));n=u.generateSideWallUV(H,a,p,b,n,i,o,j,q,r,s,v);H.faceVertexUvs[0].push(n)}}}function e(a,b,c){H.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+G;d=d+G;e=e+G;H.faces.push(new THREE.Face3(c,d,e,null,null,r));c=f?u.generateBottomUV(H,a,b,c,d,e):u.generateTopUV(H,a,b,c,d,e);H.faceVertexUvs[0].push(c)}
var h=b.amount!==void 0?b.amount:100,i=b.bevelThickness!==void 0?b.bevelThickness:6,j=b.bevelSize!==void 0?b.bevelSize:i-2,l=b.bevelSegments!==void 0?b.bevelSegments:3,n=b.bevelEnabled!==void 0?b.bevelEnabled:true,m=b.steps!==void 0?b.steps:1,q=b.extrudePath,p,o=false,r=b.material,t=b.extrudeMaterial,u=b.UVGenerator!==void 0?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,v,s,A,y;if(q){p=q.getSpacedPoints(m);o=true;n=false;v=b.frames!==void 0?b.frames:new THREE.TubeGeometry.FrenetFrames(q,m,
false);s=new THREE.Vector3;A=new THREE.Vector3;y=new THREE.Vector3}if(!n)j=i=l=0;var B,I,x,H=this,G=this.vertices.length,q=a.extractPoints(),F=q.shape,q=q.holes,E=!THREE.Shape.Utils.isClockWise(F);if(E){F=F.reverse();I=0;for(x=q.length;I<x;I++){B=q[I];THREE.Shape.Utils.isClockWise(B)&&(q[I]=B.reverse())}E=false}var M=THREE.Shape.Utils.triangulateShape(F,q),E=F;I=0;for(x=q.length;I<x;I++){B=q[I];F=F.concat(B)}var C,L,P,J,W=F.length,K=M.length,N=[],O=0,ba=E.length;C=ba-1;for(L=O+1;O<ba;O++,C++,L++){C===
ba&&(C=0);L===ba&&(L=0);N[O]=d(E[O],E[C],E[L])}var ua=[],ha,na=N.concat();I=0;for(x=q.length;I<x;I++){B=q[I];ha=[];O=0;ba=B.length;C=ba-1;for(L=O+1;O<ba;O++,C++,L++){C===ba&&(C=0);L===ba&&(L=0);ha[O]=d(B[O],B[C],B[L])}ua.push(ha);na=na.concat(ha)}for(C=0;C<l;C++){B=C/l;P=i*(1-B);L=j*Math.sin(B*Math.PI/2);O=0;for(ba=E.length;O<ba;O++){J=c(E[O],N[O],L);e(J.x,J.y,-P)}I=0;for(x=q.length;I<x;I++){B=q[I];ha=ua[I];O=0;for(ba=B.length;O<ba;O++){J=c(B[O],ha[O],L);e(J.x,J.y,-P)}}}L=j;for(O=0;O<W;O++){J=n?c(F[O],
na[O],L):F[O];if(o){A.copy(v.normals[0]).multiplyScalar(J.x);s.copy(v.binormals[0]).multiplyScalar(J.y);y.copy(p[0]).addSelf(A).addSelf(s);e(y.x,y.y,y.z)}else e(J.x,J.y,0)}for(B=1;B<=m;B++)for(O=0;O<W;O++){J=n?c(F[O],na[O],L):F[O];if(o){A.copy(v.normals[B]).multiplyScalar(J.x);s.copy(v.binormals[B]).multiplyScalar(J.y);y.copy(p[B]).addSelf(A).addSelf(s);e(y.x,y.y,y.z)}else e(J.x,J.y,h/m*B)}for(C=l-1;C>=0;C--){B=C/l;P=i*(1-B);L=j*Math.sin(B*Math.PI/2);O=0;for(ba=E.length;O<ba;O++){J=c(E[O],N[O],L);
e(J.x,J.y,h+P)}I=0;for(x=q.length;I<x;I++){B=q[I];ha=ua[I];O=0;for(ba=B.length;O<ba;O++){J=c(B[O],ha[O],L);o?e(J.x,J.y+p[m-1].y,p[m-1].x+P):e(J.x,J.y,h+P)}}}if(n){i=W*0;for(O=0;O<K;O++){h=M[O];g(h[2]+i,h[1]+i,h[0]+i,true)}i=W*(m+l*2);for(O=0;O<K;O++){h=M[O];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(O=0;O<K;O++){h=M[O];g(h[2],h[1],h[0],true)}for(O=0;O<K;O++){h=M[O];g(h[0]+W*m,h[1]+W*m,h[2]+W*m,false)}}h=0;f(E,h);h=h+E.length;I=0;for(x=q.length;I<x;I++){B=q[I];f(B,h);h=h+B.length}};
...
q.length;m.vertexColors[r]=o}}i.push(m);if(l.supportUVs){g=[e(a,""),e(c,n),e(d,n),e(f,n)];g[0]?g[1]?g[2]?g[3]?j.push(g):b("d :( ",f+":"+n):b("c :( ",d+":"+n):b("b :( ",c+":"+n):b("a :( ",a+":"+n)}}function f(a,b){return Math.min(a,b)+"_"+Math.max(a,b)}function e(a,d){var e=a+":"+d,f=r[e];if(!f){a>=t&&a<t+m.length?b("face pt"):b("edge pt");c("warning, UV not found for",e);return null}return f}function g(a,b,d){var e=a+":"+b;e in r?c("dup vertexNo",a,"oldFaceNo",b,"value",d,"key",e,r[e]):r[e]=d}var h=
[],i=[],j=[],l=this,n=a.vertices,m=a.faces,h=n.concat(),q=[],p={},o={},r={},t=n.length,u,v,s,A,y,B=a.faceVertexUvs[0];b("originalFaces, uvs, originalVerticesLength",m.length,B.length,t);if(l.supportUVs){u=0;for(v=B.length;u<v;u++){s=0;for(A=B[u].length;s<A;s++){y=m[u]["abcd".charAt(s)];g(y,u,B[u][s])}}}if(B.length==0)l.supportUVs=false;u=0;for(var I in r)u++;if(!u){l.supportUVs=false;b("no uvs")}b("-- Original Faces + Vertices UVs completed",r,"vs",B.length);var x;u=0;for(v=m.length;u<v;u++){y=m[u];
q.push(y.centroid);h.push(y.centroid);if(l.supportUVs){x=new THREE.UV;if(y instanceof THREE.Face3){x.u=e(y.a,u).u+e(y.b,u).u+e(y.c,u).u;x.v=e(y.a,u).v+e(y.b,u).v+e(y.c,u).v;x.u=x.u/3;x.v=x.v/3}else if(y instanceof THREE.Face4){x.u=e(y.a,u).u+e(y.b,u).u+e(y.c,u).u+e(y.d,u).u;x.v=e(y.a,u).v+e(y.b,u).v+e(y.c,u).v+e(y.d,u).v;x.u=x.u/4;x.v=x.v/4}g(t+u,"",x)}}b("-- added UVs for new Faces",r);I=function(a,b){H[a]===void 0&&(H[a]=[]);H[a].push(b)};var H={},B=0;for(v=a.faces.length;B<v;B++){y=a.faces[B];
if(y instanceof THREE.Face3){x=f(y.a,y.b);I(x,B);x=f(y.b,y.c);I(x,B);x=f(y.c,y.a);I(x,B)}else if(y instanceof THREE.Face4){x=f(y.a,y.b);I(x,B);x=f(y.b,y.c);I(x,B);x=f(y.c,y.d);I(x,B);x=f(y.d,y.a);I(x,B)}}v=H;var G=0,F,E;I={};B={};for(u in v){x=v[u];F=u.split("_");E=F[0];F=F[1];s=E;y=[E,F];I[s]===void 0&&(I[s]=[]);I[s].push(y);s=F;y=[E,F];I[s]===void 0&&(I[s]=[]);I[s].push(y);s=0;for(A=x.length;s<A;s++){y=x[s];var M=E,C=y,L=u;B[M]===void 0&&(B[M]={});B[M][C]=L;M=F;C=u;B[M]===void 0&&(B[M]={});B[M][y]=
C}x.length<2&&(o[u]=true)}b("vertexEdgeMap",I,"vertexFaceMap",B);for(u in v){x=v[u];y=x[0];A=x[1];F=u.split("_");E=F[0];F=F[1];x=new THREE.Vector3;if(o[u]){x.addSelf(n[E]);x.addSelf(n[F]);x.multiplyScalar(0.5)}else{x.addSelf(q[y]);x.addSelf(q[A]);x.addSelf(n[E]);x.addSelf(n[F]);x.multiplyScalar(0.25)}p[u]=t+m.length+G;h.push(x);G++;if(l.supportUVs){x=new THREE.UV;x.u=e(E,y).u+e(F,y).u;x.v=e(E,y).v+e(F,y).v;x.u=x.u/2;x.v=x.v/2;g(p[u],y,x);if(!o[u]){x=new THREE.UV;x.u=e(E,A).u+e(F,A).u;x.v=e(E,A).v+
e(F,A).v;x.u=x.u/2;x.v=x.v/2;g(p[u],A,x)}}}b("-- Step 2 done");var P,J;F=["123","12","2","23"];A=["123","23","3","31"];var M=["123","31","1","12"],C=["1234","12","2","23"],L=["1234","23","3","34"],W=["1234","34","4","41"],K=["1234","41","1","12"];u=0;for(v=q.length;u<v;u++){y=m[u];x=t+u;if(y instanceof THREE.Face3){G=f(y.a,y.b);E=f(y.b,y.c);P=f(y.c,y.a);d(x,p[G],y.b,p[E],y,F,u);d(x,p[E],y.c,p[P],y,A,u);d(x,p[P],y.a,p[G],y,M,u)}else if(y instanceof THREE.Face4){G=f(y.a,y.b);E=f(y.b,y.c);P=f(y.c,y.d);
J=f(y.d,y.a);d(x,p[G],y.b,p[E],y,C,u);d(x,p[E],y.c,p[P],y,L,u);d(x,p[P],y.d,p[J],y,W,u);d(x,p[J],y.a,p[G],y,K,u)}else b("face should be a face!",y)}p=new THREE.Vector3;y=new THREE.Vector3;u=0;for(v=n.length;u<v;u++)if(I[u]!==void 0){p.set(0,0,0);y.set(0,0,0);E=new THREE.Vector3(0,0,0);x=0;for(s in B[u]){p.addSelf(q[s]);x++}F=0;G=I[u].length;for(s=0;s<G;s++)o[f(I[u][s][0],I[u][s][1])]&&F++;if(F!=2){p.divideScalar(x);for(s=0;s<G;s++){x=I[u][s];x=n[x[0]].clone().addSelf(n[x[1]]).divideScalar(2);y.addSelf(x)}y.divideScalar(G);
E.addSelf(n[u]);E.multiplyScalar(G-3);E.addSelf(p);E.addSelf(y.multiplyScalar(2));E.divideScalar(G);h[u]=E}}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=j;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);
...
"color");m.scale=b.getUniformLocation(l,"scale");m.rotation=b.getUniformLocation(l,"rotation");m.screenPosition=b.getUniformLocation(l,"screenPosition");q=false};this.render=function(a,d,f,t){var a=a.__webglFlares,u=a.length;if(u){var v=new THREE.Vector3,s=t/f,A=f*0.5,y=t*0.5,B=16/t,I=new THREE.Vector2(B*s,B),x=new THREE.Vector3(1,1,0),H=new THREE.Vector2(1,1),G=m,B=n;b.useProgram(l);if(!q){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);q=true}b.uniform1i(G.occlusionMap,0);b.uniform1i(G.map,
1);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(B.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(B.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var F,E,M,C,L;for(F=0;F<u;F++){B=16/t;I.set(B*s,B);C=a[F];v.set(C.matrixWorld.elements[12],C.matrixWorld.elements[13],C.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(v);d.projectionMatrix.multiplyVector3(v);x.copy(v);H.x=x.x*A+A;H.y=x.y*y+y;if(j||H.x>0&&H.x<f&&H.y>0&&
H.y<t){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,H.x-8,H.y-8,16,16,0);b.uniform1i(G.renderType,0);b.uniform2f(G.scale,I.x,I.y);b.uniform3f(G.screenPosition,x.x,x.y,x.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,H.x-8,H.y-8,16,16,0);b.uniform1i(G.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);C.positionScreen.copy(x);C.customUpdateCallback?C.customUpdateCallback(C):C.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);E=0;for(M=C.lensFlares.length;E<M;E++){L=C.lensFlares[E];if(L.opacity>0.001&&L.scale>0.001){x.x=L.x;x.y=L.y;x.z=L.z;B=L.size*L.scale/t;I.x=B*s;I.y=B;b.uniform3f(G.screenPosition,x.x,x.y,x.z);b.uniform2f(G.scale,I.x,I.y);b.uniform1f(G.rotation,L.rotation);b.uniform1f(G.opacity,L.opacity);
...
vertexShader:g.vertexShader,uniforms:h,skinning:true});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:true,skinning:true});c._shadowPass=true;d._shadowPass=true;f._shadowPass=true;e._shadowPass=true};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,n){var m,q,p,o,r,t,u,v,s,A=[];o=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);b.shadowMapCullFrontFaces?a.cullFace(a.FRONT):
a.cullFace(a.BACK);b.setDepthTest(true);m=0;for(q=l.__lights.length;m<q;m++){p=l.__lights[m];if(p.castShadow)if(p instanceof THREE.DirectionalLight&&p.shadowCascade)for(r=0;r<p.shadowCascadeCount;r++){var y;if(p.shadowCascadeArray[r])y=p.shadowCascadeArray[r];else{s=p;u=r;y=new THREE.DirectionalLight;y.isVirtual=true;y.onlyShadow=true;y.castShadow=true;y.shadowCameraNear=s.shadowCameraNear;y.shadowCameraFar=s.shadowCameraFar;y.shadowCameraLeft=s.shadowCameraLeft;y.shadowCameraRight=s.shadowCameraRight;
y.shadowCameraBottom=s.shadowCameraBottom;y.shadowCameraTop=s.shadowCameraTop;y.shadowCameraVisible=s.shadowCameraVisible;y.shadowDarkness=s.shadowDarkness;y.shadowBias=s.shadowCascadeBias[u];y.shadowMapWidth=s.shadowCascadeWidth[u];y.shadowMapHeight=s.shadowCascadeHeight[u];y.pointsWorld=[];y.pointsFrustum=[];v=y.pointsWorld;t=y.pointsFrustum;for(var B=0;B<8;B++){v[B]=new THREE.Vector3;t[B]=new THREE.Vector3}v=s.shadowCascadeNearZ[u];s=s.shadowCascadeFarZ[u];t[0].set(-1,-1,v);t[1].set(1,-1,v);t[2].set(-1,
1,v);t[3].set(1,1,v);t[4].set(-1,-1,s);t[5].set(1,-1,s);t[6].set(-1,1,s);t[7].set(1,1,s);y.originalCamera=n;t=new THREE.Gyroscope;t.position=p.shadowCascadeOffset;t.add(y);t.add(y.target);n.add(t);p.shadowCascadeArray[r]=y;console.log("Created virtualLight",y)}u=p;v=r;s=u.shadowCascadeArray[v];s.position.copy(u.position);s.target.position.copy(u.target.position);s.lookAt(s.target);s.shadowCameraVisible=u.shadowCameraVisible;s.shadowDarkness=u.shadowDarkness;s.shadowBias=u.shadowCascadeBias[v];t=u.shadowCascadeNearZ[v];
u=u.shadowCascadeFarZ[v];s=s.pointsFrustum;s[0].z=t;s[1].z=t;s[2].z=t;s[3].z=t;s[4].z=u;s[5].z=u;s[6].z=u;s[7].z=u;A[o]=y;o++}else{A[o]=p;o++}}m=0;for(q=A.length;m<q;m++){p=A[m];if(!p.shadowMap){p.shadowMap=new THREE.WebGLRenderTarget(p.shadowMapWidth,p.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});p.shadowMapSize=new THREE.Vector2(p.shadowMapWidth,p.shadowMapHeight);p.shadowMatrix=new THREE.Matrix4}if(!p.shadowCamera){if(p instanceof THREE.SpotLight)p.shadowCamera=
...
new Float32Array(16);if(!r._projectionMatrixArray)r._projectionMatrixArray=new Float32Array(16);r.matrixWorldInverse.flattenToArray(r._viewMatrixArray);r.projectionMatrix.flattenToArray(r._projectionMatrixArray);h.multiply(r.projectionMatrix,r.matrixWorldInverse);g.setFromMatrix(h);b.setRenderTarget(o);b.clear();s=l.__webglObjects;p=0;for(o=s.length;p<o;p++){u=s[p];t=u.object;u.render=false;if(t.visible&&t.castShadow&&(!(t instanceof THREE.Mesh)||!t.frustumCulled||g.contains(t))){t._modelViewMatrix.multiply(r.matrixWorldInverse,
t.matrixWorld);u.render=true}}p=0;for(o=s.length;p<o;p++){u=s[p];if(u.render){t=u.object;u=u.buffer;v=t.customDepthMaterial?t.customDepthMaterial:t instanceof THREE.SkinnedMesh?t.geometry.morphTargets.length?e:f:t.geometry.morphTargets.length?d:c;u instanceof THREE.BufferGeometry?b.renderBufferDirect(r,l.__lights,null,v,u,t):b.renderBuffer(r,l.__lights,null,v,u,t)}}s=l.__webglObjectsImmediate;p=0;for(o=s.length;p<o;p++){u=s[p];t=u.object;if(t.visible&&t.castShadow){t._modelViewMatrix.multiply(r.matrixWorldInverse,
t.matrixWorld);b.renderImmediateObject(r,l.__lights,null,c,t)}}}m=b.getClearColor();q=b.getClearAlpha();a.clearColor(m.r,m.g,m.b,q);a.enable(a.BLEND);b.shadowMapCullFrontFaces&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;
...
j.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");l=false};this.render=function(d,f,q,p){var d=d.__webglSprites,o=d.length;if(o){var r=i,t=j,u=p/q,q=q*0.5,v=p*0.5,s=true;b.useProgram(h);if(!l){b.enableVertexAttribArray(r.position);b.enableVertexAttribArray(r.uv);l=true}b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(true);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(r.position,2,b.FLOAT,false,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
g);b.uniformMatrix4fv(t.projectionMatrix,false,f._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(t.map,0);for(var A,y=[],r=0;r<o;r++){A=d[r];if(A.visible&&A.opacity!==0)if(A.useScreenCoordinates)A.z=-A.position.z;else{A._modelViewMatrix.multiply(f.matrixWorldInverse,A.matrixWorld);A.z=-A._modelViewMatrix.elements[14]}}d.sort(a);for(r=0;r<o;r++){A=d[r];if(A.visible&&A.opacity!==0&&A.map&&A.map.image&&A.map.image.width){if(A.useScreenCoordinates){b.uniform1i(t.useScreenCoordinates,1);
b.uniform3f(t.screenPosition,(A.position.x-q)/q,(v-A.position.y)/v,Math.max(0,Math.min(1,A.position.z)))}else{b.uniform1i(t.useScreenCoordinates,0);b.uniform1i(t.affectedByDistance,A.affectedByDistance?1:0);b.uniformMatrix4fv(t.modelViewMatrix,false,A._modelViewMatrix.elements)}f=A.map.image.width/(A.scaleByViewport?p:1);y[0]=f*u*A.scale.x;y[1]=f*A.scale.y;b.uniform2f(t.uvScale,A.uvScale.x,A.uvScale.y);b.uniform2f(t.uvOffset,A.uvOffset.x,A.uvOffset.y);b.uniform2f(t.alignment,A.alignment.x,A.alignment.y);
b.uniform1f(t.opacity,A.opacity);b.uniform3f(t.color,A.color.r,A.color.g,A.color.b);b.uniform1f(t.rotation,A.rotation);b.uniform2fv(t.scale,y);if(A.mergeWith3D&&!s){b.enable(b.DEPTH_TEST);s=true}else if(!A.mergeWith3D&&s){b.disable(b.DEPTH_TEST);s=false}c.setBlending(A.blending,A.blendEquation,A.blendSrc,A.blendDst);c.setTexture(A.map,0);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
