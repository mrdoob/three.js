...
m?(sa=new THREE.RenderableFace3,s.push(sa),m++,r++,l=sa):l=s[r++],l.v1.copy(V),l.v2.copy(ja),l.v3.copy(ga);else continue;else continue;else if(aa instanceof THREE.Face4)if(V=n[aa.a],ja=n[aa.b],ga=n[aa.c],sa=n[aa.d],!0===V.visible&&!0===ja.visible&&!0===ga.visible&&!0===sa.visible)if(N=0>(sa.positionScreen.x-V.positionScreen.x)*(ja.positionScreen.y-V.positionScreen.y)-(sa.positionScreen.y-V.positionScreen.y)*(ja.positionScreen.x-V.positionScreen.x)||0>(ja.positionScreen.x-ga.positionScreen.x)*(sa.positionScreen.y-
ga.positionScreen.y)-(ja.positionScreen.y-ga.positionScreen.y)*(sa.positionScreen.x-ga.positionScreen.x),Z===THREE.DoubleSide||N===(Z===THREE.FrontSide)){if(q===y){var pb=new THREE.RenderableFace4;u.push(pb);y++;q++;l=pb}else l=u[q++];l.v1.copy(V);l.v2.copy(ja);l.v3.copy(ga);l.v4.copy(sa)}else continue;else continue;l.normalWorld.copy(aa.normal);!1===N&&(Z===THREE.BackSide||Z===THREE.DoubleSide)&&l.normalWorld.negate();J.multiplyVector3(l.normalWorld).normalize();l.centroidWorld.copy(aa.centroid);
za.multiplyVector3(l.centroidWorld);l.centroidScreen.copy(l.centroidWorld);L.multiplyVector3(l.centroidScreen);ga=aa.vertexNormals;V=0;for(ja=ga.length;V<ja;V++)sa=l.vertexNormalsWorld[V],sa.copy(ga[V]),!1===N&&(Z===THREE.BackSide||Z===THREE.DoubleSide)&&sa.negate(),J.multiplyVector3(sa).normalize();l.vertexNormalsLength=ga.length;V=0;for(ja=Da.length;V<ja;V++)if(sa=Da[V][fa],void 0!==sa){Z=0;for(ga=sa.length;Z<ga;Z++)l.uvs[V][Z]=sa[Z]}l.color=aa.color;l.material=kb;l.z=l.centroidScreen.z;I.elements.push(l)}}else if(oa instanceof
THREE.Line){z.multiply(L,za);fa=oa.geometry.vertices;V=b();V.positionScreen.copy(fa[0]);z.multiplyVector4(V.positionScreen);za=oa.type===THREE.LinePieces?2:1;O=1;for(aa=fa.length;O<aa;O++)V=b(),V.positionScreen.copy(fa[O]),z.multiplyVector4(V.positionScreen),0<(O+1)%za||(ja=n[k-2],R.copy(V.positionScreen),P.copy(ja.positionScreen),!0===d(R,P)&&(R.multiplyScalar(1/R.w),P.multiplyScalar(1/P.w),t===C?(Ta=new THREE.RenderableLine,F.push(Ta),C++,t++,w=Ta):w=F[t++],w.v1.positionScreen.copy(R),w.v2.positionScreen.copy(P),
w.z=Math.max(R.z,P.z),w.material=oa.material,I.elements.push(w)))}g=0;for(p=I.sprites.length;g<p;g++)oa=I.sprites[g].object,za=oa.matrixWorld,oa instanceof THREE.Particle&&(D.set(za.elements[12],za.elements[13],za.elements[14],1),L.multiplyVector4(D),D.z/=D.w,0<D.z&&1>D.z&&(A===G?(ya=new THREE.RenderableParticle,H.push(ya),G++,A++,B=ya):B=H[A++],B.object=oa,B.x=D.x/D.w,B.y=D.y/D.w,B.z=D.z,B.rotation=oa.rotation.z,B.scale.x=oa.scale.x*Math.abs(B.x-(D.x+h.projectionMatrix.elements[0])/(D.w+h.projectionMatrix.elements[12])),
B.scale.y=oa.scale.y*Math.abs(B.y-(D.y+h.projectionMatrix.elements[5])/(D.w+h.projectionMatrix.elements[13])),B.material=oa.material,I.elements.push(B)));!0===pa&&I.elements.sort(c);return I}};THREE.Face3=function(a,b,c,d,e,f){this.a=a;this.b=b;this.c=c;this.normal=d instanceof THREE.Vector3?d:new THREE.Vector3;this.vertexNormals=d instanceof Array?d:[];this.color=e instanceof THREE.Color?e:new THREE.Color;this.vertexColors=e instanceof Array?e:[];this.vertexTangents=[];this.materialIndex=void 0!==f?f:0;this.centroid=new THREE.Vector3};
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,A){h=a.vertices[b];i=a.vertices[c];k=a.vertices[d];n=g[e];p=g[f];l=g[A];r=i.x-h.x;s=k.x-h.x;m=i.y-h.y;q=k.y-h.y;u=i.z-h.z;y=k.z-h.z;w=p.x-n.x;t=l.x-n.x;F=p.y-n.y;C=l.y-n.y;B=1/(w*C-t*F);I.set((C*r-F*s)*B,(C*m-F*q)*B,(C*u-F*y)*B);$.set((w*s-t*r)*B,(w*q-t*m)*B,(w*y-t*u)*B);H[b].addSelf(I);H[c].addSelf(I);H[d].addSelf(I);G[b].addSelf($);G[c].addSelf($);G[d].addSelf($)}var b,c,d,e,f,g,h,i,k,n,p,l,r,s,m,q,u,y,
w,t,F,C,B,A,H=[],G=[],I=new THREE.Vector3,$=new THREE.Vector3,D=new THREE.Vector3,L=new THREE.Vector3,z=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)H[b]=new THREE.Vector3,G[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var J=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<
f.vertexNormals.length;d++)z.copy(f.vertexNormals[d]),e=f[J[d]],A=H[e],D.copy(A),D.subSelf(z.multiplyScalar(z.dot(A))).normalize(),L.cross(f.vertexNormals[d],A),e=L.dot(G[e]),e=0>e?-1:1,f.vertexTangents[d]=new THREE.Vector4(D.x,D.y,D.z,e)}this.hasTangents=!0},computeLineDistances:function(){for(var a=0,b=this.vertices,c=0,d=b.length;c<d;c++)0<c&&(a+=b[c].distanceTo(b[c-1])),this.lineDistances[c]=a},computeBoundingBox:function(){null===this.boundingBox&&(this.boundingBox=new THREE.Box3);this.boundingBox.setFromPoints(this.vertices)},
...
var n,p,l,r,s,m,q,u,y,w,t,F,C,B,A,f=new THREE.Vector3,g=new THREE.Vector3,H,G,I,$,D,L,z,J=this.offsets;I=0;for($=J.length;I<$;++I){G=J[I].start;D=J[I].count;var K=J[I].index;H=G;for(G+=D;H<G;H+=3)D=K+b[H],L=K+b[H+1],z=K+b[H+2],n=c[3*D],p=c[3*D+1],l=c[3*D+2],r=c[3*L],s=c[3*L+1],m=c[3*L+2],q=c[3*z],u=c[3*z+1],y=c[3*z+2],w=e[2*D],t=e[2*D+1],F=e[2*L],C=e[2*L+1],B=e[2*z],A=e[2*z+1],r-=n,n=q-n,s-=p,p=u-p,m-=l,l=y-l,F-=w,w=B-w,C-=t,t=A-t,A=1/(F*t-w*C),f.set((t*r-C*n)*A,(t*s-C*p)*A,(t*m-C*l)*A),g.set((F*
n-w*r)*A,(F*p-w*s)*A,(F*l-w*m)*A),i[D].addSelf(f),i[L].addSelf(f),i[z].addSelf(f),k[D].addSelf(g),k[L].addSelf(g),k[z].addSelf(g)}var R=new THREE.Vector3,P=new THREE.Vector3,ca=new THREE.Vector3,xa=new THREE.Vector3,M,pa,ya;I=0;for($=J.length;I<$;++I){G=J[I].start;D=J[I].count;K=J[I].index;H=G;for(G+=D;H<G;H+=3)D=K+b[H],L=K+b[H+1],z=K+b[H+2],a(D),a(L),a(z)}this.tangentsNeedUpdate=this.hasTangents=!0}},dispose:function(){this.dispatchEvent({type:"dispose"})}};THREE.Camera=function(){THREE.Object3D.call(this);this.matrixWorldInverse=new THREE.Matrix4;this.projectionMatrix=new THREE.Matrix4;this.projectionMatrixInverse=new THREE.Matrix4};THREE.Camera.prototype=Object.create(THREE.Object3D.prototype);THREE.Camera.prototype.lookAt=function(a){this.matrix.lookAt(this.position,a,this.up);!0===this.rotationAutoUpdate&&(!1===this.useQuaternion?this.rotation.setEulerFromRotationMatrix(this.matrix,this.eulerOrder):this.quaternion.copy(this.matrix.decompose()[1]))};THREE.OrthographicCamera=function(a,b,c,d,e,f){THREE.Camera.call(this);this.left=a;this.right=b;this.top=c;this.bottom=d;this.near=void 0!==e?e:0.1;this.far=void 0!==f?f:2E3;this.updateProjectionMatrix()};THREE.OrthographicCamera.prototype=Object.create(THREE.Camera.prototype);THREE.OrthographicCamera.prototype.updateProjectionMatrix=function(){this.projectionMatrix.makeOrthographic(this.left,this.right,this.top,this.bottom,this.near,this.far)};THREE.PerspectiveCamera=function(a,b,c,d){THREE.Camera.call(this);this.fov=void 0!==a?a:50;this.aspect=void 0!==b?b:1;this.near=void 0!==c?c:0.1;this.far=void 0!==d?d:2E3;this.updateProjectionMatrix()};THREE.PerspectiveCamera.prototype=Object.create(THREE.Camera.prototype);THREE.PerspectiveCamera.prototype.setLens=function(a,b){void 0===b&&(b=24);this.fov=2*THREE.Math.radToDeg(Math.atan(b/(2*a)));this.updateProjectionMatrix()};
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,k,n,p,l,r,s,m,q,u,y,w,t;function F(a){return a%4?4-a%4:0}function C(a,b){return(new Uint8Array(a,b,1))[0]}function B(a,b){return(new Uint32Array(a,b,1))[0]}function A(b,c){var d,e,f,g,h,i,k,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=n[3*d],f=n[3*d+1],g=n[3*d+2],h=K[2*e],e=K[2*e+1],i=K[2*f],k=K[2*f+1],f=K[2*g],g=K[2*g+1],L.faceVertexUvs[0].push([new THREE.Vector2(h,e),new THREE.Vector2(i,k),new THREE.Vector2(f,
g)])}function H(b,c){var d,e,f,g,h,i,k,n,l,p=new Uint32Array(a,c,4*b);for(d=0;d<b;d++)e=p[4*d],f=p[4*d+1],g=p[4*d+2],h=p[4*d+3],i=K[2*e],e=K[2*e+1],k=K[2*f],n=K[2*f+1],f=K[2*g],l=K[2*g+1],g=K[2*h],h=K[2*h+1],L.faceVertexUvs[0].push([new THREE.Vector2(i,e),new THREE.Vector2(k,n),new THREE.Vector2(f,l),new THREE.Vector2(g,h)])}function G(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],L.faces.push(new THREE.Face3(e,f,g,null,
null,h))}function I(b,c,d){for(var e,f,g,h,i,c=new Uint32Array(a,c,4*b),k=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[4*d],f=c[4*d+1],g=c[4*d+2],h=c[4*d+3],i=k[d],L.faces.push(new THREE.Face4(e,f,g,h,null,null,i))}function $(b,c,d,e){for(var f,g,h,i,k,n,l,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[3*e];g=c[3*e+1];h=c[3*e+2];k=d[3*e];n=d[3*e+1];l=d[3*e+2];i=p[e];var r=J[3*n],m=J[3*n+1];n=J[3*n+2];var s=J[3*l],q=J[3*l+1];l=J[3*l+2];L.faces.push(new THREE.Face3(f,
g,h,[new THREE.Vector3(J[3*k],J[3*k+1],J[3*k+2]),new THREE.Vector3(r,m,n),new THREE.Vector3(s,q,l)],null,i))}}function D(b,c,d,e){for(var f,g,h,i,k,n,l,p,r,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),m=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];n=d[4*e];l=d[4*e+1];p=d[4*e+2];r=d[4*e+3];k=m[e];var s=J[3*l],q=J[3*l+1];l=J[3*l+2];var t=J[3*p],u=J[3*p+1];p=J[3*p+2];var w=J[3*r],y=J[3*r+1];r=J[3*r+2];L.faces.push(new THREE.Face4(f,g,h,i,[new THREE.Vector3(J[3*
n],J[3*n+1],J[3*n+2]),new THREE.Vector3(s,q,l),new THREE.Vector3(t,u,p),new THREE.Vector3(w,y,r)],null,k))}}var L=this,z=0,J=[],K=[],R,P,ca;THREE.Geometry.call(this);t=a;P=z;y=new Uint8Array(t,P,12);s="";for(u=0;12>u;u++)s+=String.fromCharCode(y[P+u]);b=C(t,P+12);C(t,P+13);C(t,P+14);C(t,P+15);c=C(t,P+16);d=C(t,P+17);e=C(t,P+18);k=C(t,P+19);n=B(t,P+20);p=B(t,P+20+4);l=B(t,P+20+8);r=B(t,P+20+12);s=B(t,P+20+16);m=B(t,P+20+20);q=B(t,P+20+24);u=B(t,P+20+28);y=B(t,P+20+32);w=B(t,P+20+36);t=B(t,P+20+40);
z+=b;P=3*c+k;ca=4*c+k;R=r*P;b=s*(P+3*d);c=m*(P+3*e);k=q*(P+3*d+3*e);P=u*ca;d=y*(ca+4*d);e=w*(ca+4*e);ca=z;var z=new Float32Array(a,z,3*n),xa,M,pa,ya;for(xa=0;xa<n;xa++)M=z[3*xa],pa=z[3*xa+1],ya=z[3*xa+2],L.vertices.push(new THREE.Vector3(M,pa,ya));n=z=ca+3*n*Float32Array.BYTES_PER_ELEMENT;if(p){z=new Int8Array(a,z,3*p);for(ca=0;ca<p;ca++)xa=z[3*ca],M=z[3*ca+1],pa=z[3*ca+2],J.push(xa/127,M/127,pa/127)}z=n+3*p*Int8Array.BYTES_PER_ELEMENT;p=z+=F(3*p);if(l){n=new Float32Array(a,z,2*l);for(z=0;z<l;z++)ca=
n[2*z],xa=n[2*z+1],K.push(ca,xa)}l=z=p+2*l*Float32Array.BYTES_PER_ELEMENT;R=l+R+F(2*r);p=R+b+F(2*s);b=p+c+F(2*m);c=b+k+F(2*q);P=c+P+F(2*u);k=P+d+F(2*y);d=k+e+F(2*w);m&&(e=p+3*m*Uint32Array.BYTES_PER_ELEMENT,G(m,p,e+3*m*Uint32Array.BYTES_PER_ELEMENT),A(m,e));q&&(m=b+3*q*Uint32Array.BYTES_PER_ELEMENT,e=m+3*q*Uint32Array.BYTES_PER_ELEMENT,$(q,b,m,e+3*q*Uint32Array.BYTES_PER_ELEMENT),A(q,e));w&&(q=k+4*w*Uint32Array.BYTES_PER_ELEMENT,I(w,k,q+4*w*Uint32Array.BYTES_PER_ELEMENT),H(w,q));t&&(w=d+4*t*Uint32Array.BYTES_PER_ELEMENT,
q=w+4*t*Uint32Array.BYTES_PER_ELEMENT,D(t,d,w,q+4*t*Uint32Array.BYTES_PER_ELEMENT),H(t,q));r&&G(r,l,l+3*r*Uint32Array.BYTES_PER_ELEMENT);s&&(r=R+3*s*Uint32Array.BYTES_PER_ELEMENT,$(s,R,r,r+3*s*Uint32Array.BYTES_PER_ELEMENT));u&&I(u,c,c+4*u*Uint32Array.BYTES_PER_ELEMENT);y&&(s=P+4*y*Uint32Array.BYTES_PER_ELEMENT,D(y,P,s,s+4*y*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals()};e.prototype=Object.create(THREE.Geometry.prototype);e=new e(c);c=this.initMaterials(d,c);this.needsTangents(c)&&
...
l;else if(m.type in this.geometryHandlerMap){L={};for(q in m)"type"!==q&&"url"!==q&&(L[q]=m[q]);this.geometryHandlerMap[m.type].loaderObject.load(d(m.url,G.urlBaseType),g(D),L)}else"embedded"===m.type&&(L=G.embeds[m.id],L.metadata=G.metadata,L&&this.geometryHandlerMap.ascii.loaderObject.createModel(L,i(D),""));for(var z in G.textures)if(D=G.textures[z],D.url instanceof Array){F+=D.url.length;for(q=0;q<D.url.length;q++)n.onLoadStart()}else F+=1,n.onLoadStart();B=F;for(z in G.textures){D=G.textures[z];
void 0!==D.mapping&&void 0!==THREE[D.mapping]&&(D.mapping=new THREE[D.mapping]);if(D.url instanceof Array){L=D.url.length;m=[];for(q=0;q<L;q++)m[q]=d(D.url[q],G.urlBaseType);q=(q=m[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(m,D.mapping,I(L)):THREE.ImageUtils.loadTextureCube(m,D.mapping,I(L))}else q=D.url.toLowerCase().endsWith(".dds"),L=d(D.url,G.urlBaseType),m=I(1),q=q?THREE.ImageUtils.loadCompressedTexture(L,D.mapping,m):THREE.ImageUtils.loadTexture(L,D.mapping,m),void 0!==
...
L[D.wrap[1]]));A.textures[z]=q}var J,K;for(J in G.materials){z=G.materials[J];for(K in z.parameters)"envMap"===K||"map"===K||"lightMap"===K||"bumpMap"===K?z.parameters[K]=A.textures[z.parameters[K]]:"shading"===K?z.parameters[K]="flat"===z.parameters[K]?THREE.FlatShading:THREE.SmoothShading:"side"===K?z.parameters[K]="double"==z.parameters[K]?THREE.DoubleSide:"back"==z.parameters[K]?THREE.BackSide:THREE.FrontSide:"blending"===K?z.parameters[K]=z.parameters[K]in THREE?THREE[z.parameters[K]]:THREE.NormalBlending:
"combine"===K?z.parameters[K]=z.parameters[K]in THREE?THREE[z.parameters[K]]:THREE.MultiplyOperation:"vertexColors"===K?"face"==z.parameters[K]?z.parameters[K]=THREE.FaceColors:z.parameters[K]&&(z.parameters[K]=THREE.VertexColors):"wrapRGB"===K&&(I=z.parameters[K],z.parameters[K]=new THREE.Vector3(I[0],I[1],I[2]));void 0!==z.parameters.opacity&&1>z.parameters.opacity&&(z.parameters.transparent=!0);z.parameters.normalMap?(I=THREE.ShaderUtils.lib.normal,D=THREE.UniformsUtils.clone(I.uniforms),q=z.parameters.color,
L=z.parameters.specular,m=z.parameters.ambient,$=z.parameters.shininess,D.tNormal.value=A.textures[z.parameters.normalMap],z.parameters.normalScale&&D.uNormalScale.value.set(z.parameters.normalScale[0],z.parameters.normalScale[1]),z.parameters.map&&(D.tDiffuse.value=z.parameters.map,D.enableDiffuse.value=!0),z.parameters.envMap&&(D.tCube.value=z.parameters.envMap,D.enableReflection.value=!0,D.uReflectivity.value=z.parameters.reflectivity),z.parameters.lightMap&&(D.tAO.value=z.parameters.lightMap,
D.enableAO.value=!0),z.parameters.specularMap&&(D.tSpecular.value=A.textures[z.parameters.specularMap],D.enableSpecular.value=!0),z.parameters.displacementMap&&(D.tDisplacement.value=A.textures[z.parameters.displacementMap],D.enableDisplacement.value=!0,D.uDisplacementBias.value=z.parameters.displacementBias,D.uDisplacementScale.value=z.parameters.displacementScale),D.uDiffuseColor.value.setHex(q),D.uSpecularColor.value.setHex(L),D.uAmbientColor.value.setHex(m),D.uShininess.value=$,z.parameters.opacity&&
(D.uOpacity.value=z.parameters.opacity),r=new THREE.ShaderMaterial({fragmentShader:I.fragmentShader,vertexShader:I.vertexShader,uniforms:D,lights:!0,fog:!0})):r=new THREE[z.type](z.parameters);A.materials[J]=r}for(J in G.materials)if(z=G.materials[J],z.parameters.materials){K=[];for(q=0;q<z.parameters.materials.length;q++)K.push(A.materials[z.parameters.materials[q]]);A.materials[J].materials=K}e();A.cameras&&G.defaults.camera&&(A.currentCamera=A.cameras[G.defaults.camera]);A.fogs&&G.defaults.fog&&
...
document.createElement("canvas"),p,l,r,s,m=n.getContext("2d"),q=new THREE.Color(0),u=0,y=1,w=0,t=null,F=null,C=null,B=null,A=null,H,G,I,$,D=new THREE.RenderableVertex,L=new THREE.RenderableVertex,z,J,K,R,P,ca,xa,M,pa,ya,ua,N,O=new THREE.Color,aa=new THREE.Color,fa=new THREE.Color,V=new THREE.Color,ja=new THREE.Color,Z=new THREE.Color,ga=new THREE.Color,oa={},za={},Da,Ta,sa,nb,Bb,kb,eb,pb,jc,Lb,Ua=new THREE.Box2,ma=new THREE.Box2,Ra=new THREE.Box2,Cb=!1,Ha=new THREE.Color,qb=new THREE.Color,fb=new THREE.Color,
...
jc=0.5*(Oa.x*a.elements[0]+Oa.y*a.elements[4]+Oa.z*a.elements[8])+0.5,Lb=0.5*(Oa.x*a.elements[1]+Oa.y*a.elements[5]+Oa.z*a.elements[9])+0.5,w(z,J,K,R,P,ca,Bb,kb,eb,pb,jc,Lb,da.envMap)):(O.copy(da.color),da.vertexColors===THREE.FaceColors&&(O.r*=k.color.r,O.g*=k.color.g,O.b*=k.color.b),!0===da.wireframe?t(O,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):u(O)):da instanceof THREE.MeshDepthMaterial?(Da=j.near,Ta=j.far,aa.r=aa.g=aa.b=1-Va(a.positionScreen.z,Da,Ta),fa.r=fa.g=fa.b=1-Va(d.positionScreen.z,
Da,Ta),V.r=V.g=V.b=1-Va(e.positionScreen.z,Da,Ta),ja.r=0.5*(fa.r+V.r),ja.g=0.5*(fa.g+V.g),ja.b=0.5*(fa.b+V.b),sa=F(aa,fa,V,ja),y(z,J,K,R,P,ca,0,0,1,0,0,1,sa)):da instanceof THREE.MeshNormalMaterial&&(O.r=gb(k.normalWorld.x),O.g=gb(k.normalWorld.y),O.b=gb(k.normalWorld.z),!0===da.wireframe?t(O,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):u(O))}function p(a,b,c,d,e,f){m.beginPath();m.moveTo(a,b);m.lineTo(c,d);m.lineTo(e,f);m.closePath()}function q(a,b,c,d,e,f,g,h){m.beginPath();m.moveTo(a,
b);m.lineTo(c,d);m.lineTo(e,f);m.lineTo(g,h);m.closePath()}function t(a,b,c,e){C!==b&&(C=m.lineWidth=b);B!==c&&(B=m.lineCap=c);A!==e&&(A=m.lineJoin=e);d(a.getStyle());m.stroke();Ra.expandByScalar(2*b)}function u(a){e(a.getStyle());m.fill()}function w(a,b,c,d,f,g,h,j,i,k,da,n,l){if(!(l instanceof THREE.DataTexture||void 0===l.image||0==l.image.width)){if(!0===l.needsUpdate){var p=l.wrapS==THREE.RepeatWrapping,r=l.wrapT==THREE.RepeatWrapping;oa[l.id]=m.createPattern(l.image,!0===p&&!0===r?"repeat":
!0===p&&!1===r?"repeat-x":!1===p&&!0===r?"repeat-y":"no-repeat");l.needsUpdate=!1}void 0===oa[l.id]?e("rgba(0,0,0,1)"):e(oa[l.id]);var p=l.offset.x/l.repeat.x,r=l.offset.y/l.repeat.y,s=l.image.width*l.repeat.x,q=l.image.height*l.repeat.y,h=(h+p)*s,j=(1-j+r)*q,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+p)*s-h,k=(1-k+r)*q-j,da=(da+p)*s-h,n=(1-n+r)*q-j,p=i*n-da*k;0===p?(void 0===za[l.id]&&(b=document.createElement("canvas"),b.width=l.image.width,b.height=l.image.height,b=b.getContext("2d"),b.drawImage(l.image,0,0),
za[l.id]=b.getImageData(0,0,l.image.width,l.image.height).data),b=za[l.id],h=4*(Math.floor(h)+Math.floor(j)*l.image.width),O.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),u(O)):(p=1/p,l=(n*c-k*f)*p,k=(n*d-k*g)*p,c=(i*f-da*c)*p,d=(i*g-da*d)*p,a=a-l*h-c*j,h=b-k*h-d*j,m.save(),m.transform(l,k,c,d,a,h),m.fill(),m.restore())}}function y(a,b,c,d,e,f,g,h,j,i,k,da,n){var l,p;l=n.width-1;p=n.height-1;g*=l;h*=p;c-=a;d-=b;e-=a;f-=b;j=j*l-g;i=i*p-h;k=k*l-g;da=da*p-h;p=1/(j*da-k*i);l=(da*c-i*e)*p;i=(da*d-i*f)*p;c=(j*
e-k*c)*p;d=(j*f-k*d)*p;a=a-l*g-c*h;b=b-i*g-d*h;m.save();m.transform(l,i,c,d,a,b);m.clip();m.drawImage(n,0,0);m.restore()}function F(a,b,c,d){sb[0]=255*a.r|0;sb[1]=255*a.g|0;sb[2]=255*a.b|0;sb[4]=255*b.r|0;sb[5]=255*b.g|0;sb[6]=255*b.b|0;sb[8]=255*c.r|0;sb[9]=255*c.g|0;sb[10]=255*c.b|0;sb[12]=255*d.r|0;sb[13]=255*d.g|0;sb[14]=255*d.b|0;yb.putImageData(kc,0,0);Ea.drawImage(Za,0,0);return Ib}function Va(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function gb(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function tb(a,
b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===j instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{!0===this.autoClear&&this.clear();m.setTransform(1,0,0,-1,r,s);f.info.render.vertices=0;f.info.render.faces=0;g=k.projectScene(a,j,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;Cb=0<i.length;if(!0===Cb){Ha.setRGB(0,0,0);qb.setRGB(0,0,0);fb.setRGB(0,0,0);for(var zb=
...
hb=void 0,da=ka=void 0,ed=void 0;X instanceof THREE.ParticleBasicMaterial?null===X.map?(ob=$a.object.scale.x,hb=$a.object.scale.y,ob*=$a.scale.x*r,hb*=$a.scale.y*s,Ra.min.set(la.x-ob,la.y-hb),Ra.max.set(la.x+ob,la.y+hb),!1!==Ua.isIntersectionBox(Ra)&&(e(X.color.getStyle()),m.save(),m.translate(la.x,la.y),m.rotate(-$a.rotation),m.scale(ob,hb),m.fillRect(-1,-1,2,2),m.restore())):(ka=X.map.image,da=ka.width>>1,ed=ka.height>>1,ob=$a.scale.x*r,hb=$a.scale.y*s,Wa=ob*da,ab=hb*ed,Ra.min.set(la.x-Wa,la.y-
ab),Ra.max.set(la.x+Wa,la.y+ab),!1!==Ua.isIntersectionBox(Ra)&&(m.save(),m.translate(la.x,la.y),m.rotate(-$a.rotation),m.scale(ob,-hb),m.translate(-da,-ed),m.drawImage(ka,0,0),m.restore())):X instanceof THREE.ParticleCanvasMaterial&&(Wa=$a.scale.x*r,ab=$a.scale.y*s,Ra.min.set(la.x-Wa,la.y-ab),Ra.max.set(la.x+Wa,la.y+ab),!1!==Ua.isIntersectionBox(Ra)&&(d(X.color.getStyle()),e(X.color.getStyle()),m.save(),m.translate(la.x,la.y),m.rotate(-$a.rotation),m.scale(Wa,ab),X.program(m),m.restore()))}else ka instanceof
THREE.RenderableLine?(H=ka.v1,G=ka.v2,H.positionScreen.x*=r,H.positionScreen.y*=s,G.positionScreen.x*=r,G.positionScreen.y*=s,Ra.setFromPoints([H.positionScreen,G.positionScreen]),!0===Ua.isIntersectionBox(Ra)&&(la=H,$a=G,b(X.opacity),c(X.blending),m.beginPath(),m.moveTo(la.positionScreen.x,la.positionScreen.y),m.lineTo($a.positionScreen.x,$a.positionScreen.y),X instanceof THREE.LineBasicMaterial&&(la=X.linewidth,C!==la&&(C=m.lineWidth=la),la=X.linecap,B!==la&&(B=m.lineCap=la),la=X.linejoin,A!==la&&
(A=m.lineJoin=la),d(X.color.getStyle()),m.stroke(),Ra.expandByScalar(2*X.linewidth)))):ka instanceof THREE.RenderableFace3?(H=ka.v1,G=ka.v2,I=ka.v3,H.positionScreen.x*=r,H.positionScreen.y*=s,G.positionScreen.x*=r,G.positionScreen.y*=s,I.positionScreen.x*=r,I.positionScreen.y*=s,!0===X.overdraw&&(tb(H.positionScreen,G.positionScreen),tb(G.positionScreen,I.positionScreen),tb(I.positionScreen,H.positionScreen)),Ra.setFromPoints([H.positionScreen,G.positionScreen,I.positionScreen]),!0===Ua.isIntersectionBox(Ra)&&
l(H,G,I,0,1,2,ka,X,a)):ka instanceof THREE.RenderableFace4&&(H=ka.v1,G=ka.v2,I=ka.v3,$=ka.v4,H.positionScreen.x*=r,H.positionScreen.y*=s,G.positionScreen.x*=r,G.positionScreen.y*=s,I.positionScreen.x*=r,I.positionScreen.y*=s,$.positionScreen.x*=r,$.positionScreen.y*=s,D.positionScreen.copy(G.positionScreen),L.positionScreen.copy($.positionScreen),!0===X.overdraw&&(tb(H.positionScreen,G.positionScreen),tb(G.positionScreen,$.positionScreen),tb($.positionScreen,H.positionScreen),tb(I.positionScreen,
D.positionScreen),tb(I.positionScreen,L.positionScreen)),Ra.setFromPoints([H.positionScreen,G.positionScreen,I.positionScreen,$.positionScreen]),!0===Ua.isIntersectionBox(Ra)&&(la=H,$a=G,Wa=I,ab=$,ob=D,hb=L,da=a,f.info.render.vertices+=4,f.info.render.faces++,b(X.opacity),c(X.blending),void 0!==X.map&&null!==X.map||void 0!==X.envMap&&null!==X.envMap?(l(la,$a,ab,0,1,3,ka,X,da),l(ob,Wa,hb,1,2,3,ka,X,da)):(z=la.positionScreen.x,J=la.positionScreen.y,K=$a.positionScreen.x,R=$a.positionScreen.y,P=Wa.positionScreen.x,
...
V.b=ja.b=Ha.b,n(ka.v1.positionWorld,ka.vertexNormalsWorld[0],aa),n(ka.v2.positionWorld,ka.vertexNormalsWorld[1],fa),n(ka.v4.positionWorld,ka.vertexNormalsWorld[3],V),n(ka.v3.positionWorld,ka.vertexNormalsWorld[2],ja),aa.r=aa.r*Z.r+ga.r,aa.g=aa.g*Z.g+ga.g,aa.b=aa.b*Z.b+ga.b,fa.r=fa.r*Z.r+ga.r,fa.g=fa.g*Z.g+ga.g,fa.b=fa.b*Z.b+ga.b,V.r=V.r*Z.r+ga.r,V.g=V.g*Z.g+ga.g,V.b=V.b*Z.b+ga.b,ja.r=ja.r*Z.r+ga.r,ja.g=ja.g*Z.g+ga.g,ja.b=ja.b*Z.b+ga.b,sa=F(aa,fa,V,ja),p(z,J,K,R,xa,M),y(z,J,K,R,xa,M,0,0,1,0,0,1,sa),
p(pa,ya,P,ca,ua,N),y(pa,ya,P,ca,ua,N,1,0,1,1,0,1,sa)):(O.r=Ha.r,O.g=Ha.g,O.b=Ha.b,n(ka.centroidWorld,ka.normalWorld,O),O.r=O.r*Z.r+ga.r,O.g=O.g*Z.g+ga.g,O.b=O.b*Z.b+ga.b,q(z,J,K,R,P,ca,xa,M),!0===X.wireframe?t(O,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):u(O)):(O.r=Z.r+ga.r,O.g=Z.g+ga.g,O.b=Z.b+ga.b,q(z,J,K,R,P,ca,xa,M),!0===X.wireframe?t(O,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):u(O))):X instanceof THREE.MeshBasicMaterial?(O.copy(X.color),X.vertexColors===THREE.FaceColors&&
(O.r*=ka.color.r,O.g*=ka.color.g,O.b*=ka.color.b),q(z,J,K,R,P,ca,xa,M),!0===X.wireframe?t(O,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):u(O)):X instanceof THREE.MeshNormalMaterial?(O.r=gb(ka.normalWorld.x),O.g=gb(ka.normalWorld.y),O.b=gb(ka.normalWorld.z),q(z,J,K,R,P,ca,xa,M),!0===X.wireframe?t(O,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):u(O)):X instanceof THREE.MeshDepthMaterial&&(Da=j.near,Ta=j.far,aa.r=aa.g=aa.b=1-Va(la.positionScreen.z,Da,Ta),fa.r=fa.g=fa.b=
1-Va($a.positionScreen.z,Da,Ta),V.r=V.g=V.b=1-Va(ab.positionScreen.z,Da,Ta),ja.r=ja.g=ja.b=1-Va(Wa.positionScreen.z,Da,Ta),sa=F(aa,fa,V,ja),p(z,J,K,R,xa,M),y(z,J,K,R,xa,M,0,0,1,0,0,1,sa),p(pa,ya,P,ca,ua,N),y(pa,ya,P,ca,ua,N,1,0,1,1,0,1,sa)))));ma.union(Ra)}}m.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(Va){for(var n,l=k=0,m=0,p,r,s,q=Jc,t=q.directional.colors,u=q.directional.positions,w=q.point.colors,y=q.point.positions,z=q.point.distances,B=q.spot.colors,F=q.spot.positions,G=q.spot.distances,O=q.spot.directions,I=q.spot.anglesCos,L=q.spot.exponents,V=q.hemi.skyColors,M=q.hemi.groundColors,Z=q.hemi.positions,
aa=0,R=0,P=0,X=0,$=0,la=0,ka=0,ca=0,W=n=0,c=s=W=0,f=b.length;c<f;c++)n=b[c],n.onlyShadow||(p=n.color,r=n.intensity,s=n.distance,n instanceof THREE.AmbientLight?n.visible&&(N.gammaInput?(k+=p.r*p.r,l+=p.g*p.g,m+=p.b*p.b):(k+=p.r,l+=p.g,m+=p.b)):n instanceof THREE.DirectionalLight?($+=1,n.visible&&(Ea.copy(n.matrixWorld.getPosition()),Ea.subSelf(n.target.matrixWorld.getPosition()),Ea.normalize(),0===Ea.x&&0===Ea.y&&0===Ea.z||(n=3*aa,u[n]=Ea.x,u[n+1]=Ea.y,u[n+2]=Ea.z,N.gammaInput?A(t,n,p,r*r):H(t,n,
p,r),aa+=1))):n instanceof THREE.PointLight?(la+=1,n.visible&&(W=3*R,N.gammaInput?A(w,W,p,r*r):H(w,W,p,r),r=n.matrixWorld.getPosition(),y[W]=r.x,y[W+1]=r.y,y[W+2]=r.z,z[R]=s,R+=1)):n instanceof THREE.SpotLight?(ka+=1,n.visible&&(W=3*P,N.gammaInput?A(B,W,p,r*r):H(B,W,p,r),r=n.matrixWorld.getPosition(),F[W]=r.x,F[W+1]=r.y,F[W+2]=r.z,G[P]=s,Ea.copy(r),Ea.subSelf(n.target.matrixWorld.getPosition()),Ea.normalize(),O[W]=Ea.x,O[W+1]=Ea.y,O[W+2]=Ea.z,I[P]=Math.cos(n.angle),L[P]=n.exponent,P+=1)):n instanceof
THREE.HemisphereLight&&(ca+=1,n.visible&&(Ea.copy(n.matrixWorld.getPosition()),Ea.normalize(),0===Ea.x&&0===Ea.y&&0===Ea.z||(s=3*X,Z[s]=Ea.x,Z[s+1]=Ea.y,Z[s+2]=Ea.z,p=n.color,n=n.groundColor,N.gammaInput?(r*=r,A(V,s,p,r),A(M,s,n,r)):(H(V,s,p,r),H(M,s,n,r)),X+=1))));c=3*aa;for(f=Math.max(t.length,3*$);c<f;c++)t[c]=0;c=3*R;for(f=Math.max(w.length,3*la);c<f;c++)w[c]=0;c=3*P;for(f=Math.max(B.length,3*ka);c<f;c++)B[c]=0;c=3*X;for(f=Math.max(V.length,3*ca);c<f;c++)V[c]=0;c=3*X;for(f=Math.max(M.length,3*
ca);c<f;c++)M[c]=0;q.directional.length=aa;q.point.length=R;q.spot.length=P;q.hemi.length=X;q.ambient[0]=k;q.ambient[1]=l;q.ambient[2]=m;Va=!1}c=Jc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;
...
k.castShadow&&(k instanceof THREE.SpotLight||k instanceof THREE.DirectionalLight&&!k.shadowCascade))i.shadowMap.value[oa]=k.shadowMap,i.shadowMapSize.value[oa]=k.shadowMapSize,i.shadowMatrix.value[oa]=k.shadowMatrix,i.shadowDarkness.value[oa]=k.shadowDarkness,i.shadowBias.value[oa]=k.shadowBias,oa++}b=d.uniformsList;i=0;for(oa=b.length;i<oa;i++)if(f=g.uniforms[b[i][1]])if(c=b[i][0],l=c.type,k=c.value,"i"===l)j.uniform1i(f,k);else if("f"===l)j.uniform1f(f,k);else if("v2"===l)j.uniform2f(f,k.x,k.y);
else if("v3"===l)j.uniform3f(f,k.x,k.y,k.z);else if("v4"===l)j.uniform4f(f,k.x,k.y,k.z,k.w);else if("c"===l)j.uniform3f(f,k.r,k.g,k.b);else if("iv1"===l)j.uniform1iv(f,k);else if("iv"===l)j.uniform3iv(f,k);else if("fv1"===l)j.uniform1fv(f,k);else if("fv"===l)j.uniform3fv(f,k);else if("v2v"===l){void 0===c._array&&(c._array=new Float32Array(2*k.length));l=0;for(m=k.length;l<m;l++)q=2*l,c._array[q]=k[l].x,c._array[q+1]=k[l].y;j.uniform2fv(f,c._array)}else if("v3v"===l){void 0===c._array&&(c._array=
new Float32Array(3*k.length));l=0;for(m=k.length;l<m;l++)q=3*l,c._array[q]=k[l].x,c._array[q+1]=k[l].y,c._array[q+2]=k[l].z;j.uniform3fv(f,c._array)}else if("v4v"===l){void 0===c._array&&(c._array=new Float32Array(4*k.length));l=0;for(m=k.length;l<m;l++)q=4*l,c._array[q]=k[l].x,c._array[q+1]=k[l].y,c._array[q+2]=k[l].z,c._array[q+3]=k[l].w;j.uniform4fv(f,c._array)}else if("m4"===l)void 0===c._array&&(c._array=new Float32Array(16)),k.flattenToArray(c._array),j.uniformMatrix4fv(f,!1,c._array);else if("m4v"===
l){void 0===c._array&&(c._array=new Float32Array(16*k.length));l=0;for(m=k.length;l<m;l++)k[l].flattenToArrayOffset(c._array,16*l);j.uniformMatrix4fv(f,!1,c._array)}else if("t"===l){if(q=k,k=C(),j.uniform1i(f,k),q)if(q.image instanceof Array&&6===q.image.length){if(c=q,f=k,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=j.createTexture(),N.info.memory.textures++);j.activeTexture(j.TEXTURE0+f);j.bindTexture(j.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);
j.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;k=[];for(l=0;6>l;l++)N.autoScaleCubemaps&&!f?(m=k,q=l,t=c.image[l],w=bd,t.width<=w&&t.height<=w||(y=Math.max(t.width,t.height),u=Math.floor(t.width*w/y),w=Math.floor(t.height*w/y),y=document.createElement("canvas"),y.width=u,y.height=w,y.getContext("2d").drawImage(t,0,0,t.width,t.height,0,0,u,w),t=y),m[q]=t):k[l]=c.image[l];l=k[0];m=0===(l.width&l.width-1)&&0===(l.height&l.height-1);q=J(c.format);t=J(c.type);D(j.TEXTURE_CUBE_MAP,
c,m);for(l=0;6>l;l++)if(f){w=k[l].mipmaps;y=0;for(z=w.length;y<z;y++)u=w[y],j.compressedTexImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+l,y,q,u.width,u.height,0,u.data)}else j.texImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,q,q,t,k[l]);c.generateMipmaps&&m&&j.generateMipmap(j.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else j.activeTexture(j.TEXTURE0+f),j.bindTexture(j.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else q instanceof THREE.WebGLRenderTargetCube?(c=q,j.activeTexture(j.TEXTURE0+
k),j.bindTexture(j.TEXTURE_CUBE_MAP,c.__webglTexture)):N.setTexture(q,k)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(m=c.value.length;l<m;l++)c._array[l]=C();j.uniform1iv(f,c._array);l=0;for(m=c.value.length;l<m;l++)q=c.value[l],k=c._array[l],q&&N.setTexture(q,k)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==h.cameraPosition)b=a.matrixWorld.getPosition(),j.uniform3f(h.cameraPosition,b.x,b.y,b.z);(d instanceof THREE.MeshPhongMaterial||
...
j.TEXTURE_MIN_FILTER,J(b.minFilter))):(j.texParameteri(a,j.TEXTURE_WRAP_S,j.CLAMP_TO_EDGE),j.texParameteri(a,j.TEXTURE_WRAP_T,j.CLAMP_TO_EDGE),j.texParameteri(a,j.TEXTURE_MAG_FILTER,z(b.magFilter)),j.texParameteri(a,j.TEXTURE_MIN_FILTER,z(b.minFilter)));if(dc&&b.type!==THREE.FloatType&&(1<b.anisotropy||b.__oldAnisotropy))j.texParameterf(a,dc.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,Kc)),b.__oldAnisotropy=b.anisotropy}function L(a,b){j.bindRenderbuffer(j.RENDERBUFFER,a);b.depthBuffer&&!b.stencilBuffer?
...
a.color&&l&&(m=l.itemSize,j.bindBuffer(j.ARRAY_BUFFER,l.buffer),k(a.color),j.vertexAttribPointer(a.color,m,j.FLOAT,!1,0,4*h*m));l=e.attributes.tangent;0<=a.tangent&&l&&(m=l.itemSize,j.bindBuffer(j.ARRAY_BUFFER,l.buffer),k(a.tangent),j.vertexAttribPointer(a.tangent,m,j.FLOAT,!1,0,4*h*m));j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,f.buffer)}j.drawElements(j.TRIANGLES,d[c].count,j.UNSIGNED_SHORT,2*d[c].start);N.info.render.calls++;N.info.render.vertices+=d[c].count;N.info.render.faces+=d[c].count/3}}else b&&
...
if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,void 0!==b.geometry&&void 0===b.geometry.__webglInit&&(b.geometry.__webglInit=!0,b.geometry.addEventListener("dispose",$a)),b instanceof THREE.Mesh)if(m=b.geometry,p=b.material,m instanceof THREE.Geometry){if(void 0===m.geometryGroups){var s=m,z=void 0,A=void 0,B=void 0,C=void 0,D=void 0,F=void 0,G={},O=s.morphTargets.length,H=s.morphNormals.length,I=p instanceof THREE.MeshFaceMaterial;s.geometryGroups=
{};z=0;for(A=s.faces.length;z<A;z++)B=s.faces[z],C=I?B.materialIndex:0,void 0===G[C]&&(G[C]={hash:C,counter:0}),F=G[C].hash+"_"+G[C].counter,void 0===s.geometryGroups[F]&&(s.geometryGroups[F]={faces3:[],faces4:[],materialIndex:C,vertices:0,numMorphTargets:O,numMorphNormals:H}),D=B instanceof THREE.Face3?3:4,65535<s.geometryGroups[F].vertices+D&&(G[C].counter+=1,F=G[C].hash+"_"+G[C].counter,void 0===s.geometryGroups[F]&&(s.geometryGroups[F]={faces3:[],faces4:[],materialIndex:C,vertices:0,numMorphTargets:O,
numMorphNormals:H})),B instanceof THREE.Face3?s.geometryGroups[F].faces3.push(z):s.geometryGroups[F].faces4.push(z),s.geometryGroups[F].vertices+=D;s.geometryGroupsList=[];var K=void 0;for(K in s.geometryGroups)s.geometryGroups[K].id=oa++,s.geometryGroupsList.push(s.geometryGroups[K])}for(n in m.geometryGroups)if(r=m.geometryGroups[n],!r.__webglVertexBuffer){var J=r;J.__webglVertexBuffer=j.createBuffer();J.__webglNormalBuffer=j.createBuffer();J.__webglTangentBuffer=j.createBuffer();J.__webglColorBuffer=
...
d(r,b);m.verticesNeedUpdate=!0;m.morphTargetsNeedUpdate=!0;m.elementsNeedUpdate=!0;m.uvsNeedUpdate=!0;m.normalsNeedUpdate=!0;m.tangentsNeedUpdate=!0;m.colorsNeedUpdate=!0}}else m instanceof THREE.BufferGeometry&&h(m);else if(b instanceof THREE.Ribbon){if(m=b.geometry,!m.__webglVertexBuffer){var M=m;M.__webglVertexBuffer=j.createBuffer();M.__webglColorBuffer=j.createBuffer();M.__webglNormalBuffer=j.createBuffer();N.info.memory.geometries++;var aa=m,Z=b,fa=aa.vertices.length;aa.__vertexArray=new Float32Array(3*
fa);aa.__colorArray=new Float32Array(3*fa);aa.__normalArray=new Float32Array(3*fa);aa.__webglVertexCount=fa;c(aa,Z);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(m=b.geometry,!m.__webglVertexBuffer){var R=m;R.__webglVertexBuffer=j.createBuffer();R.__webglColorBuffer=j.createBuffer();R.__webglLineDistanceBuffer=j.createBuffer();N.info.memory.geometries++;var P=m,ga=b,X=P.vertices.length;P.__vertexArray=new Float32Array(3*X);P.__colorArray=
new Float32Array(3*X);P.__lineDistanceArray=new Float32Array(1*X);P.__webglLineCount=X;c(P,ga);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.lineDistancesNeedUpdate=!0}}else if(b instanceof THREE.ParticleSystem&&(m=b.geometry,!m.__webglVertexBuffer))if(m instanceof THREE.Geometry){var $=m;$.__webglVertexBuffer=j.createBuffer();$.__webglColorBuffer=j.createBuffer();N.info.memory.geometries++;var ja=m,la=b,ka=ja.vertices.length;ja.__vertexArray=new Float32Array(3*ka);ja.__colorArray=new Float32Array(3*
ka);ja.__sortArray=[];ja.__webglParticleCount=ka;c(ja,la);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}else m instanceof THREE.BufferGeometry&&h(m);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(m=b.geometry,m instanceof THREE.BufferGeometry)q(k.__webglObjects,m,b);else for(n in m.geometryGroups)r=m.geometryGroups[n],q(k.__webglObjects,r,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(m=b.geometry,q(k.__webglObjects,m,b)):b instanceof THREE.ImmediateRenderObject||
b.immediateRenderCallback?k.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof THREE.Sprite?k.__webglSprites.push(b):b instanceof THREE.LensFlare&&k.__webglFlares.push(b);b.__webglActive=!0}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var ca=a.__objectsRemoved[0],pa=a;ca instanceof THREE.Mesh||ca instanceof THREE.ParticleSystem||ca instanceof THREE.Ribbon||ca instanceof THREE.Line?w(pa.__webglObjects,ca):ca instanceof THREE.Sprite?t(pa.__webglSprites,
ca):ca instanceof THREE.LensFlare?t(pa.__webglFlares,ca):(ca instanceof THREE.ImmediateRenderObject||ca.immediateRenderCallback)&&w(pa.__webglObjectsImmediate,ca);ca.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var sa=0,ya=a.__webglObjects.length;sa<ya;sa++){var za=a.__webglObjects[sa].object,W=za.geometry,xa=void 0,Da=void 0,ma=void 0;if(za instanceof THREE.Mesh)if(W instanceof THREE.BufferGeometry)(W.verticesNeedUpdate||W.elementsNeedUpdate||W.uvsNeedUpdate||W.normalsNeedUpdate||W.colorsNeedUpdate||
...
Pa+3,rb+=8,Pa+=4;j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,ta.__webglFaceBuffer);j.bufferData(j.ELEMENT_ARRAY_BUFFER,Zb,ua);j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,ta.__webglLineBuffer);j.bufferData(j.ELEMENT_ARRAY_BUFFER,Ab,ua)}if(fd){Aa=0;for(dc=fd.length;Aa<dc;Aa++)if(v=fd[Aa],v.__original.needsUpdate){x=0;if(1===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=mb[va[E]],v.array[x]=v.value[Q.a],v.array[x+1]=v.value[Q.b],v.array[x+2]=v.value[Q.c],x+=3;E=0;for(Y=wa.length;E<
Y;E++)Q=mb[wa[E]],v.array[x]=v.value[Q.a],v.array[x+1]=v.value[Q.b],v.array[x+2]=v.value[Q.c],v.array[x+3]=v.value[Q.d],x+=4}else{if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],v.array[x]=Ba,v.array[x+1]=Ba,v.array[x+2]=Ba,x+=3;E=0;for(Y=wa.length;E<Y;E++)Ba=v.value[wa[E]],v.array[x]=Ba,v.array[x+1]=Ba,v.array[x+2]=Ba,v.array[x+3]=Ba,x+=4}}else if(2===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=mb[va[E]],S=v.value[Q.a],T=v.value[Q.b],
U=v.value[Q.c],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=T.x,v.array[x+3]=T.y,v.array[x+4]=U.x,v.array[x+5]=U.y,x+=6;E=0;for(Y=wa.length;E<Y;E++)Q=mb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],ra=v.value[Q.d],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=T.x,v.array[x+3]=T.y,v.array[x+4]=U.x,v.array[x+5]=U.y,v.array[x+6]=ra.x,v.array[x+7]=ra.y,x+=8}else{if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)U=T=S=Ba=v.value[va[E]],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=T.x,v.array[x+
3]=T.y,v.array[x+4]=U.x,v.array[x+5]=U.y,x+=6;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=T.x,v.array[x+3]=T.y,v.array[x+4]=U.x,v.array[x+5]=U.y,v.array[x+6]=ra.x,v.array[x+7]=ra.y,x+=8}}else if(3===v.size){var ba;ba="c"===v.type?["r","g","b"]:["x","y","z"];if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=mb[va[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],v.array[x]=S[ba[0]],v.array[x+1]=S[ba[1]],v.array[x+2]=
S[ba[2]],v.array[x+3]=T[ba[0]],v.array[x+4]=T[ba[1]],v.array[x+5]=T[ba[2]],v.array[x+6]=U[ba[0]],v.array[x+7]=U[ba[1]],v.array[x+8]=U[ba[2]],x+=9;E=0;for(Y=wa.length;E<Y;E++)Q=mb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],ra=v.value[Q.d],v.array[x]=S[ba[0]],v.array[x+1]=S[ba[1]],v.array[x+2]=S[ba[2]],v.array[x+3]=T[ba[0]],v.array[x+4]=T[ba[1]],v.array[x+5]=T[ba[2]],v.array[x+6]=U[ba[0]],v.array[x+7]=U[ba[1]],v.array[x+8]=U[ba[2]],v.array[x+9]=ra[ba[0]],v.array[x+10]=ra[ba[1]],v.array[x+11]=
ra[ba[2]],x+=12}else if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)U=T=S=Ba=v.value[va[E]],v.array[x]=S[ba[0]],v.array[x+1]=S[ba[1]],v.array[x+2]=S[ba[2]],v.array[x+3]=T[ba[0]],v.array[x+4]=T[ba[1]],v.array[x+5]=T[ba[2]],v.array[x+6]=U[ba[0]],v.array[x+7]=U[ba[1]],v.array[x+8]=U[ba[2]],x+=9;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[x]=S[ba[0]],v.array[x+1]=S[ba[1]],v.array[x+2]=S[ba[2]],v.array[x+3]=T[ba[0]],v.array[x+4]=T[ba[1]],v.array[x+5]=T[ba[2]],v.array[x+6]=U[ba[0]],
v.array[x+7]=U[ba[1]],v.array[x+8]=U[ba[2]],v.array[x+9]=ra[ba[0]],v.array[x+10]=ra[ba[1]],v.array[x+11]=ra[ba[2]],x+=12}else if("faceVertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],S=Ba[0],T=Ba[1],U=Ba[2],v.array[x]=S[ba[0]],v.array[x+1]=S[ba[1]],v.array[x+2]=S[ba[2]],v.array[x+3]=T[ba[0]],v.array[x+4]=T[ba[1]],v.array[x+5]=T[ba[2]],v.array[x+6]=U[ba[0]],v.array[x+7]=U[ba[1]],v.array[x+8]=U[ba[2]],x+=9;E=0;for(Y=wa.length;E<Y;E++)Ba=v.value[wa[E]],S=Ba[0],T=Ba[1],U=Ba[2],ra=
Ba[3],v.array[x]=S[ba[0]],v.array[x+1]=S[ba[1]],v.array[x+2]=S[ba[2]],v.array[x+3]=T[ba[0]],v.array[x+4]=T[ba[1]],v.array[x+5]=T[ba[2]],v.array[x+6]=U[ba[0]],v.array[x+7]=U[ba[1]],v.array[x+8]=U[ba[2]],v.array[x+9]=ra[ba[0]],v.array[x+10]=ra[ba[1]],v.array[x+11]=ra[ba[2]],x+=12}}else if(4===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=mb[va[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=S.z,v.array[x+3]=S.w,v.array[x+
4]=T.x,v.array[x+5]=T.y,v.array[x+6]=T.z,v.array[x+7]=T.w,v.array[x+8]=U.x,v.array[x+9]=U.y,v.array[x+10]=U.z,v.array[x+11]=U.w,x+=12;E=0;for(Y=wa.length;E<Y;E++)Q=mb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],ra=v.value[Q.d],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=S.z,v.array[x+3]=S.w,v.array[x+4]=T.x,v.array[x+5]=T.y,v.array[x+6]=T.z,v.array[x+7]=T.w,v.array[x+8]=U.x,v.array[x+9]=U.y,v.array[x+10]=U.z,v.array[x+11]=U.w,v.array[x+12]=ra.x,v.array[x+13]=ra.y,v.array[x+14]=ra.z,v.array[x+
15]=ra.w,x+=16}else if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)U=T=S=Ba=v.value[va[E]],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=S.z,v.array[x+3]=S.w,v.array[x+4]=T.x,v.array[x+5]=T.y,v.array[x+6]=T.z,v.array[x+7]=T.w,v.array[x+8]=U.x,v.array[x+9]=U.y,v.array[x+10]=U.z,v.array[x+11]=U.w,x+=12;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=S.z,v.array[x+3]=S.w,v.array[x+4]=T.x,v.array[x+5]=T.y,v.array[x+6]=T.z,v.array[x+7]=T.w,v.array[x+
8]=U.x,v.array[x+9]=U.y,v.array[x+10]=U.z,v.array[x+11]=U.w,v.array[x+12]=ra.x,v.array[x+13]=ra.y,v.array[x+14]=ra.z,v.array[x+15]=ra.w,x+=16}else if("faceVertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],S=Ba[0],T=Ba[1],U=Ba[2],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=S.z,v.array[x+3]=S.w,v.array[x+4]=T.x,v.array[x+5]=T.y,v.array[x+6]=T.z,v.array[x+7]=T.w,v.array[x+8]=U.x,v.array[x+9]=U.y,v.array[x+10]=U.z,v.array[x+11]=U.w,x+=12;E=0;for(Y=wa.length;E<Y;E++)Ba=v.value[wa[E]],
S=Ba[0],T=Ba[1],U=Ba[2],ra=Ba[3],v.array[x]=S.x,v.array[x+1]=S.y,v.array[x+2]=S.z,v.array[x+3]=S.w,v.array[x+4]=T.x,v.array[x+5]=T.y,v.array[x+6]=T.z,v.array[x+7]=T.w,v.array[x+8]=U.x,v.array[x+9]=U.y,v.array[x+10]=U.z,v.array[x+11]=U.w,v.array[x+12]=ra.x,v.array[x+13]=ra.y,v.array[x+14]=ra.z,v.array[x+15]=ra.w,x+=16}j.bindBuffer(j.ARRAY_BUFFER,v.buffer);j.bufferData(j.ARRAY_BUFFER,v.array,ua)}}Ra&&(delete ta.__inittedArrays,delete ta.__colorArray,delete ta.__normalArray,delete ta.__tangentArray,
delete ta.__uvArray,delete ta.__uv2Array,delete ta.__faceArray,delete ta.__vertexArray,delete ta.__lineArray,delete ta.__skinIndexArray,delete ta.__skinWeightArray)}}W.verticesNeedUpdate=!1;W.morphTargetsNeedUpdate=!1;W.elementsNeedUpdate=!1;W.uvsNeedUpdate=!1;W.normalsNeedUpdate=!1;W.colorsNeedUpdate=!1;W.tangentsNeedUpdate=!1;W.buffersNeedUpdate=!1;ma.attributes&&y(ma)}else if(za instanceof THREE.Ribbon){ma=e(za,W);Da=ma.attributes&&u(ma);if(W.verticesNeedUpdate||W.colorsNeedUpdate||W.normalsNeedUpdate||
...
ha.buffer),j.bufferData(j.ARRAY_BUFFER,ha.array,kd)}}W.verticesNeedUpdate=!1;W.colorsNeedUpdate=!1;ma.attributes&&y(ma)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h;a.addEventListener("dispose",ob);var i,k,l,n,m;a instanceof THREE.MeshDepthMaterial?m="depth":a instanceof THREE.MeshNormalMaterial?m="normal":a instanceof THREE.MeshBasicMaterial?m="basic":a instanceof THREE.MeshLambertMaterial?m="lambert":a instanceof THREE.MeshPhongMaterial?m="phong":a instanceof THREE.LineBasicMaterial?m="basic":
a instanceof THREE.LineDashedMaterial?m="dashed":a instanceof THREE.ParticleBasicMaterial&&(m="particle_basic");if(m){var p=THREE.ShaderLib[m];a.uniforms=THREE.UniformsUtils.clone(p.uniforms);a.vertexShader=p.vertexShader;a.fragmentShader=p.fragmentShader}var r,q,s;e=g=q=s=p=0;for(f=b.length;e<f;e++)r=b[e],r.onlyShadow||(r instanceof THREE.DirectionalLight&&g++,r instanceof THREE.PointLight&&q++,r instanceof THREE.SpotLight&&s++,r instanceof THREE.HemisphereLight&&p++);e=g;f=q;g=s;h=p;p=r=0;for(s=
b.length;p<s;p++)q=b[p],q.castShadow&&(q instanceof THREE.SpotLight&&r++,q instanceof THREE.DirectionalLight&&!q.shadowCascade&&r++);n=r;gb&&d&&d.useVertexTexture?l=1024:(b=j.getParameter(j.MAX_VERTEX_UNIFORM_VECTORS),b=Math.floor((b-20)/4),void 0!==d&&d instanceof THREE.SkinnedMesh&&(b=Math.min(d.bones.length,b),b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")),l=b);a:{q=a.fragmentShader;s=a.vertexShader;
p=a.uniforms;b=a.attributes;r=a.defines;var c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,fogExp:c instanceof THREE.FogExp2,sizeAttenuation:a.sizeAttenuation,skinning:a.skinning,maxBones:l,useVertexTexture:gb&&d&&d.useVertexTexture,boneTextureWidth:d&&d.boneTextureWidth,boneTextureHeight:d&&d.boneTextureHeight,morphTargets:a.morphTargets,morphNormals:a.morphNormals,maxMorphTargets:this.maxMorphTargets,
maxMorphNormals:this.maxMorphNormals,maxDirLights:e,maxPointLights:f,maxSpotLights:g,maxHemiLights:h,maxShadows:n,shadowMapEnabled:this.shadowMapEnabled&&d.receiveShadow,shadowMapType:this.shadowMapType,shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,w,d=[];m?d.push(m):(d.push(q),d.push(s));for(u in r)d.push(u),d.push(r[u]);
for(t in c)d.push(t),d.push(c[t]);m=d.join();t=0;for(u=O.length;t<u;t++)if(d=O[t],d.code===m){d.usedTimes++;k=d.program;break a}t="SHADOWMAP_TYPE_BASIC";c.shadowMapType===THREE.PCFShadowMap?t="SHADOWMAP_TYPE_PCF":c.shadowMapType===THREE.PCFSoftShadowMap&&(t="SHADOWMAP_TYPE_PCF_SOFT");u=[];for(w in r)d=r[w],!1!==d&&(d="#define "+w+" "+d,u.push(d));d=u.join("\n");w=j.createProgram();u=["precision "+R+" float;",d,rc?"#define VERTEX_TEXTURES":"",N.gammaInput?"#define GAMMA_INPUT":"",N.gammaOutput?"#define GAMMA_OUTPUT":
...
"",c.shadowMapEnabled?"#define USE_SHADOWMAP":"",c.shadowMapEnabled?"#define "+t:"",c.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",c.shadowMapCascade?"#define SHADOWMAP_CASCADE":"","uniform mat4 viewMatrix;\nuniform vec3 cameraPosition;\n"].join("\n");t=$("fragment",t+q);u=$("vertex",u+s);j.attachShader(w,u);j.attachShader(w,t);j.linkProgram(w);j.getProgramParameter(w,j.LINK_STATUS)||console.error("Could not initialise shader\nVALIDATE_STATUS: "+j.getProgramParameter(w,j.VALIDATE_STATUS)+", gl error ["+
...
void 0,r=a[g[i]].x,s=a[g[i]].y,m=a[g[k]].x,q=a[g[k]].y,u=a[g[n]].x,y=a[g[n]].y;if(1E-10>(m-r)*(y-s)-(q-s)*(u-r))l=!1;else{var F=void 0,C=void 0,B=void 0,A=void 0,H=void 0,G=void 0,I=void 0,$=void 0,D=void 0,L=void 0,D=$=I=t=w=void 0,F=u-m,C=y-q,B=r-u,A=s-y,H=m-r,G=q-s;for(l=0;l<e;l++)if(!(l===i||l===k||l===n))if(w=a[g[l]].x,t=a[g[l]].y,I=w-r,$=t-s,D=w-m,L=t-q,w-=u,t-=y,D=F*L-C*D,I=H*$-G*I,$=B*t-A*w,0<=D&&0<=$&&0<=I){l=!1;break a}l=!0}}if(l){f.push([a[g[i]],a[g[k]],a[g[n]]]);h.push([g[i],g[k],g[n]]);
...
this.faceVertexUvs[0].push([f[e],f[e+1],g]);this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,a)};THREE.CircleGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,m){var q,u=h.widthSegments,y=h.heightSegments,w=e/2,t=f/2,F=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)q="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)q="y",y=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)q="x",u=h.depthSegments;var C=u+1,B=y+1,A=e/u,H=f/y,G=new THREE.Vector3;G[q]=0<g?1:-1;for(e=0;e<B;e++)for(f=0;f<C;f++){var I=new THREE.Vector3;I[a]=(f*A-w)*c;I[b]=(e*H-t)*d;I[q]=g;h.vertices.push(I)}for(e=
...
for(var g=0,h=r+2*n,g=0;g<h;g++){var i=P*g,k=P*(g+1),l=d+e+i,i=d+f+i,m=d+f+k,k=d+e+k,p=c,q=g,s=h,t=e,u=f,l=l+$,i=i+$,m=m+$,k=k+$;I.faces.push(new THREE.Face4(l,i,m,k,null,null,y));l=w.generateSideWallUV(I,a,p,b,l,i,m,k,q,s,t,u);I.faceVertexUvs[0].push(l)}}}function f(a,b,c){I.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=$;d+=$;e+=$;I.faces.push(new THREE.Face3(c,d,e,null,null,u));c=f?w.generateBottomUV(I,a,b,c,d,e):w.generateTopUV(I,a,b,c,d,e);I.faceVertexUvs[0].push(c)}var h=void 0!==
...
r,!1),F=new THREE.Vector3,C=new THREE.Vector3,B=new THREE.Vector3);p||(k=i=n=0);var A,H,G,I=this,$=this.vertices.length,l=a.extractPoints(l),D=l.shape,l=l.holes;if(s=!THREE.Shape.Utils.isClockWise(D)){D=D.reverse();H=0;for(G=l.length;H<G;H++)A=l[H],THREE.Shape.Utils.isClockWise(A)&&(l[H]=A.reverse());s=!1}var L=THREE.Shape.Utils.triangulateShape(D,l),s=D;H=0;for(G=l.length;H<G;H++)A=l[H],D=D.concat(A);var z,J,K,R,P=D.length,ca=L.length,xa=[],M=0,pa=s.length;z=pa-1;for(J=M+1;M<pa;M++,z++,J++)z===pa&&
(z=0),J===pa&&(J=0),xa[M]=d(s[M],s[z],s[J]);var ya=[],ua,N=xa.concat();H=0;for(G=l.length;H<G;H++){A=l[H];ua=[];M=0;pa=A.length;z=pa-1;for(J=M+1;M<pa;M++,z++,J++)z===pa&&(z=0),J===pa&&(J=0),ua[M]=d(A[M],A[z],A[J]);ya.push(ua);N=N.concat(ua)}for(z=0;z<n;z++){A=z/n;K=i*(1-A);J=k*Math.sin(A*Math.PI/2);M=0;for(pa=s.length;M<pa;M++)R=c(s[M],xa[M],J),f(R.x,R.y,-K);H=0;for(G=l.length;H<G;H++){A=l[H];ua=ya[H];M=0;for(pa=A.length;M<pa;M++)R=c(A[M],ua[M],J),f(R.x,R.y,-K)}}J=k;for(M=0;M<P;M++)R=p?c(D[M],N[M],
J):D[M],q?(C.copy(t.normals[0]).multiplyScalar(R.x),F.copy(t.binormals[0]).multiplyScalar(R.y),B.copy(m[0]).addSelf(C).addSelf(F),f(B.x,B.y,B.z)):f(R.x,R.y,0);for(A=1;A<=r;A++)for(M=0;M<P;M++)R=p?c(D[M],N[M],J):D[M],q?(C.copy(t.normals[A]).multiplyScalar(R.x),F.copy(t.binormals[A]).multiplyScalar(R.y),B.copy(m[A]).addSelf(C).addSelf(F),f(B.x,B.y,B.z)):f(R.x,R.y,h/r*A);for(z=n-1;0<=z;z--){A=z/n;K=i*(1-A);J=k*Math.sin(A*Math.PI/2);M=0;for(pa=s.length;M<pa;M++)R=c(s[M],xa[M],J),f(R.x,R.y,h+K);H=0;for(G=
l.length;H<G;H++){A=l[H];ua=ya[H];M=0;for(pa=A.length;M<pa;M++)R=c(A[M],ua[M],J),q?f(R.x,R.y+m[r-1].y,m[r-1].x+K):f(R.x,R.y,h+K)}}if(p){i=0*P;for(M=0;M<ca;M++)h=L[M],g(h[2]+i,h[1]+i,h[0]+i,!0);i=P*(r+2*n);for(M=0;M<ca;M++)h=L[M],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(M=0;M<ca;M++)h=L[M],g(h[2],h[1],h[0],!0);for(M=0;M<ca;M++)h=L[M],g(h[0]+P*r,h[1]+P*r,h[2]+P*r,!1)}h=0;e(s,h);h+=s.length;H=0;for(G=l.length;H<G;H++)A=l[H],e(A,h),h+=A.length};
...
"color");l.scale=b.getUniformLocation(n,"scale");l.rotation=b.getUniformLocation(n,"rotation");l.screenPosition=b.getUniformLocation(n,"screenPosition")};this.render=function(a,d,e,q){var a=a.__webglFlares,u=a.length;if(u){var y=new THREE.Vector3,w=q/e,t=0.5*e,F=0.5*q,C=16/q,B=new THREE.Vector2(C*w,C),A=new THREE.Vector3(1,1,0),H=new THREE.Vector2(1,1),G=l,C=p;b.useProgram(n);b.enableVertexAttribArray(p.vertex);b.enableVertexAttribArray(p.uv);b.uniform1i(G.occlusionMap,0);b.uniform1i(G.map,1);b.bindBuffer(b.ARRAY_BUFFER,
f);b.vertexAttribPointer(C.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(C.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var I,$,D,L,z;for(I=0;I<u;I++)if(C=16/q,B.set(C*w,C),L=a[I],y.set(L.matrixWorld.elements[12],L.matrixWorld.elements[13],L.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(y),d.projectionMatrix.multiplyVector3(y),A.copy(y),H.x=A.x*t+t,H.y=A.y*F+F,k||0<H.x&&H.x<e&&0<H.y&&H.y<q){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,
h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,H.x-8,H.y-8,16,16,0);b.uniform1i(G.renderType,0);b.uniform2f(G.scale,B.x,B.y);b.uniform3f(G.screenPosition,A.x,A.y,A.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,H.x-8,H.y-8,16,16,0);b.uniform1i(G.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,
6,b.UNSIGNED_SHORT,0);L.positionScreen.copy(A);L.customUpdateCallback?L.customUpdateCallback(L):L.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);$=0;for(D=L.lensFlares.length;$<D;$++)z=L.lensFlares[$],0.001<z.opacity&&0.001<z.scale&&(A.x=z.x,A.y=z.y,A.z=z.z,C=z.size*z.scale/q,B.x=C*w,B.y=C,b.uniform3f(G.screenPosition,A.x,A.y,A.z),b.uniform2f(G.scale,B.x,B.y),b.uniform1f(G.rotation,z.rotation),b.uniform1f(G.opacity,z.opacity),b.uniform3f(G.color,z.color.r,z.color.g,z.color.b),c.setBlending(z.blending,
