...
a[9],a[10])},getInverse:function(a){var b=this.elements,c=a.elements,d=c[0],f=c[4],e=c[8],g=c[12],h=c[1],i=c[5],l=c[9],j=c[13],n=c[2],m=c[6],q=c[10],p=c[14],o=c[3],r=c[7],t=c[11],c=c[15];b[0]=l*p*r-j*q*r+j*m*t-i*p*t-l*m*c+i*q*c;b[4]=g*q*r-e*p*r-g*m*t+f*p*t+e*m*c-f*q*c;b[8]=e*j*r-g*l*r+g*i*t-f*j*t-e*i*c+f*l*c;b[12]=g*l*m-e*j*m-g*i*q+f*j*q+e*i*p-f*l*p;b[1]=j*q*o-l*p*o-j*n*t+h*p*t+l*n*c-h*q*c;b[5]=e*p*o-g*q*o+g*n*t-d*p*t-e*n*c+d*q*c;b[9]=g*l*o-e*j*o-g*h*t+d*j*t+e*h*c-d*l*c;b[13]=e*j*n-g*l*n+g*h*q-d*
j*q-e*h*p+d*l*p;b[2]=i*p*o-j*m*o+j*n*r-h*p*r-i*n*c+h*m*c;b[6]=g*m*o-f*p*o-g*n*r+d*p*r+f*n*c-d*m*c;b[10]=f*j*o-g*i*o+g*h*r-d*j*r-f*h*c+d*i*c;b[14]=g*i*n-f*j*n-g*h*m+d*j*m+f*h*p-d*i*p;b[3]=l*m*o-i*q*o-l*n*r+h*q*r+i*n*t-h*m*t;b[7]=f*q*o-e*m*o+e*n*r-d*q*r-f*n*t+d*m*t;b[11]=e*i*o-f*l*o-e*h*r+d*l*r+f*h*t-d*i*t;b[15]=f*l*n-e*i*n+e*h*m-d*l*m-f*h*q+d*i*q;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,f=a.y,e=a.z,g=Math.cos(d),d=Math.sin(d),
...
if(d<c)return false;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return true}var f,e,g=[],h=0,i,l,j=[],n=0,m,q,p=[],o=0,r,t=[],u=0,w,s,B=[],v=0,A,D,z=[],M=0,G={objects:[],sprites:[],lights:[],elements:[]},H=new THREE.Vector3,E=new THREE.Vector4,O=new THREE.Matrix4,F=new THREE.Matrix4,J=new THREE.Frustum,I=new THREE.Vector4,K=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);O.multiply(b.projectionMatrix,b.matrixWorldInverse);O.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);O.multiply(b.matrixWorld,b.projectionMatrixInverse);O.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n,L){var ba=h.near,Q=h.far,fa=false,ta,da,ga,N,U,ia,Ia,pa,ua,Ca,Ja,Xa,ja,pb,Oa,Ya;D=s=r=q=0;G.elements.length=0;g.updateMatrixWorld();h.parent===
...
N.positionScreen.copy(ga[0]);F.multiplyVector4(N.positionScreen);ua=pa.type===THREE.LinePieces?2:1;ta=1;for(da=ga.length;ta<da;ta++){N=b();N.positionScreen.copy(ga[ta]);F.multiplyVector4(N.positionScreen);if(!((ta+1)%ua>0)){U=j[l-2];I.copy(N.positionScreen);K.copy(U.positionScreen);if(d(I,K)===true){I.multiplyScalar(1/I.w);K.multiplyScalar(1/K.w);if(s===v){Ja=new THREE.RenderableLine;B.push(Ja);v++;s++;w=Ja}else w=B[s++];w.v1.positionScreen.copy(I);w.v2.positionScreen.copy(K);w.z=Math.max(I.z,K.z);
...
l=a.vertices[d];j=g[f];n=g[e];m=g[D];q=i.x-h.x;p=l.x-h.x;o=i.y-h.y;r=l.y-h.y;t=i.z-h.z;u=l.z-h.z;w=n.u-j.u;s=m.u-j.u;B=n.v-j.v;v=m.v-j.v;A=1/(w*v-s*B);G.set((v*q-B*p)*A,(v*o-B*r)*A,(v*t-B*u)*A);H.set((w*p-s*q)*A,(w*r-s*o)*A,(w*u-s*t)*A);z[b].addSelf(G);z[c].addSelf(G);z[d].addSelf(G);M[b].addSelf(H);M[c].addSelf(H);M[d].addSelf(H)}var b,c,d,f,e,g,h,i,l,j,n,m,q,p,o,r,t,u,w,s,B,v,A,D,z=[],M=[],G=new THREE.Vector3,H=new THREE.Vector3,E=new THREE.Vector3,O=new THREE.Vector3,F=new THREE.Vector3;b=0;for(c=
...
0}var f=this.offsets,e=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,l,j,n,m,q,p=new THREE.Vector3,o=new THREE.Vector3,r=new THREE.Vector3,t=new THREE.Vector3,u=new THREE.Vector3;c=0;for(d=f.length;c<d;++c){b=f[c].start;i=f[c].count;var w=f[c].index;a=b;for(b=b+i;a<b;a=a+3){i=w+e[a];l=w+e[a+1];j=w+e[a+2];n=g[i*3];m=g[i*3+1];q=g[i*3+2];p.set(n,m,q);n=g[l*3];m=g[l*3+1];q=g[l*3+2];o.set(n,m,q);n=g[j*3];m=g[j*3+1];q=g[j*3+2];r.set(n,m,q);t.sub(r,o);u.sub(p,
...
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],l=[],g=0;g<e;g++){i[g]=new THREE.Vector3;l[g]=new THREE.Vector3}var j,n,m,q,p,o,r,t,u,w,s,B,v,A,D,e=new THREE.Vector3,g=new THREE.Vector3,z,M,G,H,E,O,F,J=this.offsets;G=0;for(H=J.length;G<H;++G){M=J[G].start;E=J[G].count;var I=J[G].index;z=M;for(M=M+E;z<M;z=z+3){E=I+b[z];O=I+b[z+1];F=I+b[z+2];j=c[E*3];n=c[E*3+1];m=c[E*3+2];q=c[O*3];p=c[O*3+1];o=c[O*3+2];r=c[F*3];
t=c[F*3+1];u=c[F*3+2];w=f[E*2];s=f[E*2+1];B=f[O*2];v=f[O*2+1];A=f[F*2];D=f[F*2+1];q=q-j;j=r-j;p=p-n;n=t-n;o=o-m;m=u-m;B=B-w;w=A-w;v=v-s;s=D-s;D=1/(B*s-w*v);e.set((s*q-v*j)*D,(s*p-v*n)*D,(s*o-v*m)*D);g.set((B*j-w*q)*D,(B*n-w*p)*D,(B*m-w*o)*D);i[E].addSelf(e);i[O].addSelf(e);i[F].addSelf(e);l[E].addSelf(g);l[O].addSelf(g);l[F].addSelf(g)}}var K=new THREE.Vector3,V=new THREE.Vector3,Y=new THREE.Vector3,$=new THREE.Vector3,L,ba,Q;G=0;for(H=J.length;G<H;++G){M=J[G].start;E=J[G].count;I=J[G].index;z=M;
...
Math.log(a)/Math.LN2;return Math.floor(a)==a}function d(a){a=Math.log(a)/Math.LN2;return Math.pow(2,Math.round(a))}function f(a,f,e,h,i,l,r){var t=e.toLowerCase().endsWith(".dds"),u=b+"/"+e;if(t){var w=THREE.ImageUtils.loadCompressedTexture(u);a[f]=w}else{w=document.createElement("canvas");a[f]=new THREE.Texture(w)}a[f].sourceFile=e;if(h){a[f].repeat.set(h[0],h[1]);if(h[0]!==1)a[f].wrapS=THREE.RepeatWrapping;if(h[1]!==1)a[f].wrapT=THREE.RepeatWrapping}i&&a[f].offset.set(i[0],i[1]);if(l){e={repeat:THREE.RepeatWrapping,
mirror:THREE.MirroredRepeatWrapping};if(e[l[0]]!==void 0)a[f].wrapS=e[l[0]];if(e[l[1]]!==void 0)a[f].wrapT=e[l[1]]}if(r)a[f].anisotropy=r;if(!t){var s=a[f],a=new Image;a.onload=function(){if(!c(this.width)||!c(this.height)){var a=d(this.width),b=d(this.height);s.image.width=a;s.image.height=b;s.image.getContext("2d").drawImage(this,0,0,a,b)}else s.image=this;s.needsUpdate=true};a.crossOrigin=g.crossOrigin;a.src=u}}function e(a){return(a[0]*255<<16)+(a[1]*255<<8)+a[2]*255}var g=this,h="MeshLambertMaterial",
i={color:15658734,opacity:1,map:null,lightMap:null,normalMap:null,bumpMap:null,wireframe:false};if(a.shading){var l=a.shading.toLowerCase();l==="phong"?h="MeshPhongMaterial":l==="basic"&&(h="MeshBasicMaterial")}if(a.blending!==void 0&&THREE[a.blending]!==void 0)i.blending=THREE[a.blending];if(a.transparent!==void 0||a.opacity<1)i.transparent=a.transparent;if(a.depthTest!==void 0)i.depthTest=a.depthTest;if(a.depthWrite!==void 0)i.depthWrite=a.depthWrite;if(a.visible!==void 0)i.visible=a.visible;if(a.flipSided!==
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,l,j,n,m,q,p,o,r,t,u,w,s;function B(a){return a%4?4-a%4:0}function v(a,b){return(new Uint8Array(a,b,1))[0]}function A(a,b){return(new Uint32Array(a,b,1))[0]}function D(b,c){var d,f,e,g,h,i,j,l,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=I[f*2];f=I[f*2+1];i=I[e*2];j=I[e*2+1];e=I[g*2];l=I[g*2+1];g=O.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,j));m.push(new THREE.UV(e,
...
g,h,i,[new THREE.Vector3(J[l*3],J[l*3+1],J[l*3+2]),new THREE.Vector3(q,r,n),new THREE.Vector3(s,t,m),new THREE.Vector3(v,u,o)],null,j))}}var O=this,F=0,J=[],I=[],K,V,Y;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(O,d,b);s=a;V=F;b=new Uint8Array(s,V,12);o="";for(u=0;u<12;u++)o=o+String.fromCharCode(b[V+u]);c=v(s,V+12);v(s,V+13);v(s,V+14);v(s,V+15);f=v(s,V+16);i=v(s,V+17);l=v(s,V+18);j=v(s,V+19);n=A(s,V+20);m=A(s,V+20+4);q=A(s,V+20+8);p=A(s,V+20+12);o=A(s,V+20+16);r=A(s,V+20+20);t=
A(s,V+20+24);u=A(s,V+20+28);b=A(s,V+20+32);w=A(s,V+20+36);s=A(s,V+20+40);F=F+c;V=f*3+j;Y=f*4+j;K=p*V;c=o*(V+i*3);f=r*(V+l*3);j=t*(V+i*3+l*3);V=u*Y;i=b*(Y+i*4);l=w*(Y+l*4);Y=F;var F=new Float32Array(a,F,n*3),$,L,ba,Q;for($=0;$<n;$++){L=F[$*3];ba=F[$*3+1];Q=F[$*3+2];O.vertices.push(new THREE.Vector3(L,ba,Q))}n=F=Y+n*3*Float32Array.BYTES_PER_ELEMENT;if(m){F=new Int8Array(a,F,m*3);for(Y=0;Y<m;Y++){$=F[Y*3];L=F[Y*3+1];ba=F[Y*3+2];J.push($/127,L/127,ba/127)}}F=n+m*3*Int8Array.BYTES_PER_ELEMENT;m=F=F+B(m*
3);if(q){F=new Float32Array(a,F,q*2);for(n=0;n<q;n++){Y=F[n*2];$=F[n*2+1];I.push(Y,$)}}q=F=m+q*2*Float32Array.BYTES_PER_ELEMENT;K=q+K+B(p*2);m=K+c+B(o*2);c=m+f+B(r*2);f=c+j+B(t*2);V=f+V+B(u*2);j=V+i+B(b*2);i=j+l+B(w*2);if(r){l=m+r*Uint32Array.BYTES_PER_ELEMENT*3;M(r,m,l+r*Uint32Array.BYTES_PER_ELEMENT*3);D(r,l)}if(t){r=c+t*Uint32Array.BYTES_PER_ELEMENT*3;l=r+t*Uint32Array.BYTES_PER_ELEMENT*3;H(t,c,r,l+t*Uint32Array.BYTES_PER_ELEMENT*3);D(t,l)}if(w){t=j+w*Uint32Array.BYTES_PER_ELEMENT*4;G(w,j,t+w*
Uint32Array.BYTES_PER_ELEMENT*4);z(w,t)}if(s){w=i+s*Uint32Array.BYTES_PER_ELEMENT*4;t=w+s*Uint32Array.BYTES_PER_ELEMENT*4;E(s,i,w,t+s*Uint32Array.BYTES_PER_ELEMENT*4);z(s,t)}p&&M(p,q,q+p*Uint32Array.BYTES_PER_ELEMENT*3);if(o){p=K+o*Uint32Array.BYTES_PER_ELEMENT*3;H(o,K,p,p+o*Uint32Array.BYTES_PER_ELEMENT*3)}u&&G(u,f,f+u*Uint32Array.BYTES_PER_ELEMENT*4);if(b){o=V+b*Uint32Array.BYTES_PER_ELEMENT*4;E(b,V,o,o+b*Uint32Array.BYTES_PER_ELEMENT*4)}this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,l,j,n,m,q,p,o,r,t,u,w=a.faces;q=a.vertices;var s=a.normals,B=a.colors,v=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&v++;for(e=0;e<v;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}c=0;for(i=q.length;c<i;){l=new THREE.Vector3;l.x=q[c++]*f;l.y=q[c++]*f;l.z=q[c++]*f;d.vertices.push(l)}c=0;for(i=w.length;c<i;){q=w[c++];l=q&1;h=q&2;e=q&4;g=q&8;n=q&
16;j=q&32;p=q&64;q=q&128;if(l){o=new THREE.Face4;o.a=w[c++];o.b=w[c++];o.c=w[c++];o.d=w[c++];l=4}else{o=new THREE.Face3;o.a=w[c++];o.b=w[c++];o.c=w[c++];l=3}if(h){h=w[c++];o.materialIndex=h}h=d.faces.length;if(e)for(e=0;e<v;e++){r=a.uvs[e];m=w[c++];u=r[m*2];m=r[m*2+1];d.faceUvs[e][h]=new THREE.UV(u,m)}if(g)for(e=0;e<v;e++){r=a.uvs[e];t=[];for(g=0;g<l;g++){m=w[c++];u=r[m*2];m=r[m*2+1];t[g]=new THREE.UV(u,m)}d.faceVertexUvs[e][h]=t}if(n){n=w[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];
o.normal=g}if(j)for(e=0;e<l;e++){n=w[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];o.vertexNormals.push(g)}if(p){j=w[c++];j=new THREE.Color(B[j]);o.color=j}if(q)for(e=0;e<l;e++){j=w[c++];j=new THREE.Color(B[j]);o.vertexColors.push(j)}d.faces.push(o)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c=c+2){w=a.skinWeights[c];s=a.skinWeights[c+1];d.skinWeights.push(new THREE.Vector4(w,s,0,0))}}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c=c+2){w=a.skinIndices[c];s=a.skinIndices[c+
...
m}}var g=a.faces,p=a.vertices,m=a.normals,l=a.colors,j=0;if(a.uvs)for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&j++;for(e=0;e<j;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}n=0;for(q=p.length;n<q;){var o=new THREE.Vector3;o.x=p[n++]*f;o.y=p[n++]*f;o.z=p[n++]*f;d.vertices.push(o)}n=0;for(q=g.length;n<q;){var r=g[n++],t=r&2,e=r&4,u=r&8,w=r&16,p=r&32,s=r&64,o=r&128;if(r&1){r=new THREE.Face4;r.a=g[n++];r.b=g[n++];r.c=g[n++];r.d=g[n++];var B=4}else{r=new THREE.Face3;r.a=g[n++];r.b=g[n++];r.c=g[n++];B=3}if(t){t=
g[n++];r.materialIndex=t}var v=d.faces.length;if(e)for(e=0;e<j;e++){var A=a.uvs[e],t=g[n++],D=A[t*2],t=A[t*2+1];d.faceUvs[e][v]=new THREE.UV(D,t)}if(u)for(e=0;e<j;e++){for(var A=a.uvs[e],u=[],z=0;z<B;z++){t=g[n++];D=A[t*2];t=A[t*2+1];u[z]=new THREE.UV(D,t)}d.faceVertexUvs[e][v]=u}if(w){w=g[n++]*3;t=new THREE.Vector3;t.x=m[w++];t.y=m[w++];t.z=m[w];r.normal=t}if(p)for(e=0;e<B;e++){w=g[n++]*3;t=new THREE.Vector3;t.x=m[w++];t.y=m[w++];t.z=m[w];r.vertexNormals.push(t)}if(s){p=g[n++];r.color=new THREE.Color(l[p])}if(o)for(e=
...
a.morphTargets[e].name;d.morphTargets[e].vertices=[];m=d.morphTargets[e].vertices;l=a.morphTargets[e].vertices;t=0;for(j=l.length;t<j;t=t+3){o=new THREE.Vector3;o.x=l[t]*f;o.y=l[t+1]*f;o.z=l[t+2]*f;m.push(o)}}}if(a.morphColors){e=0;for(g=a.morphColors.length;e<g;e++){d.morphColors[e]={};d.morphColors[e].name=a.morphColors[e].name;d.morphColors[e].colors=[];f=d.morphColors[e].colors;l=a.morphColors[e].colors;m=0;for(j=l.length;m<j;m=m+3){n=new THREE.Color(16755200);n.setRGB(l[m],l[m+1],l[m+2]);f.push(n)}}}d.computeCentroids();
...
void 0?a.canvas:document.createElement("canvas"),n,m,q,p,o=j.getContext("2d"),r=new THREE.Color(0),t=0,u=1,w=0,s=null,B=null,v=null,A=null,D=null,z,M,G,H,E=new THREE.RenderableVertex,O=new THREE.RenderableVertex,F,J,I,K,V,Y,$,L,ba,Q,fa,ta,da=new THREE.Color,ga=new THREE.Color,N=new THREE.Color,U=new THREE.Color,ia=new THREE.Color,Ia={},pa={},ua,Ca,Ja,Xa,ja,pb,Oa,Ya,qb,wb,fb=new THREE.Rectangle,Fa=new THREE.Rectangle,xa=new THREE.Rectangle,xb=false,Ga=new THREE.Color,$a=new THREE.Color,rb=new THREE.Color,
...
if(t>0){c(THREE.NormalBlending);b(1);f("rgba("+Math.floor(r.r*255)+","+Math.floor(r.g*255)+","+Math.floor(r.b*255)+","+t+")");o.fillRect(Math.floor(Fa.getX()),Math.floor(Fa.getY()),Math.floor(Fa.getWidth()),Math.floor(Fa.getHeight()))}Fa.empty()}};this.render=function(a,k){function j(a,b,c){for(var d=0,f=i.length;d<f;d++){var e=i[d],g=e.color;if(e instanceof THREE.DirectionalLight){var h=e.matrixWorld.getPosition().normalize(),k=b.dot(h);if(!(k<=0)){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=
...
a.elements[1]+Da.y*a.elements[5]+Da.z*a.elements[9])*0.5+0.5;Da.copy(l.vertexNormalsWorld[h]);Oa=(Da.x*a.elements[0]+Da.y*a.elements[4]+Da.z*a.elements[8])*0.5+0.5;Ya=(Da.x*a.elements[1]+Da.y*a.elements[5]+Da.z*a.elements[9])*0.5+0.5;Da.copy(l.vertexNormalsWorld[i]);qb=(Da.x*a.elements[0]+Da.y*a.elements[4]+Da.z*a.elements[8])*0.5+0.5;wb=(Da.x*a.elements[1]+Da.y*a.elements[5]+Da.z*a.elements[9])*0.5+0.5;u(F,J,I,K,V,Y,ja,pb,Oa,Ya,qb,wb,o.envMap)}}else o.wireframe===true?s(o.color,o.wireframeLinewidth,
o.wireframeLinecap,o.wireframeLinejoin):t(o.color);else if(o instanceof THREE.MeshDepthMaterial){ua=k.near;Ca=k.far;ga.r=ga.g=ga.b=1-fc(a.positionScreen.z,ua,Ca);N.r=N.g=N.b=1-fc(d.positionScreen.z,ua,Ca);U.r=U.g=U.b=1-fc(f.positionScreen.z,ua,Ca);ia.r=(N.r+U.r)*0.5;ia.g=(N.g+U.g)*0.5;ia.b=(N.b+U.b)*0.5;Ja=va(ga,N,U,ia);w(F,J,I,K,V,Y,0,0,1,0,0,1,Ja)}else if(o instanceof THREE.MeshNormalMaterial){da.r=jc(l.normalWorld.x);da.g=jc(l.normalWorld.y);da.b=jc(l.normalWorld.z);o.wireframe===true?s(da,o.wireframeLinewidth,
o.wireframeLinecap,o.wireframeLinejoin):t(da)}}function m(a,b,c,d,f,e){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.closePath()}function r(a,b,c,d,f,e,g,h){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.lineTo(g,h);o.closePath()}function s(a,b,c,f){if(v!==b)v=o.lineWidth=b;if(A!==c)A=o.lineCap=c;if(D!==f)D=o.lineJoin=f;d(a.getContextStyle());o.stroke();xa.inflate(b*2)}function t(a){f(a.getContextStyle());o.fill()}function u(a,b,c,d,e,g,h,i,k,j,l,n,m){if(!(m instanceof THREE.DataTexture||
...
a.__objectsAdded[0],j=a,l=void 0,m=void 0,n=void 0;if(!i.__webglInit){i.__webglInit=true;i._modelViewMatrix=new THREE.Matrix4;i._normalMatrix=new THREE.Matrix3;if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.Geometry){if(m.geometryGroups===void 0){var s=m,u=void 0,v=void 0,w=void 0,z=void 0,A=void 0,B=void 0,D=void 0,E={},G=s.morphTargets.length,H=s.morphNormals.length;s.geometryGroups={};u=0;for(v=s.faces.length;u<v;u++){w=s.faces[u];z=w.materialIndex;B=z!==void 0?z:-1;E[B]===void 0&&
(E[B]={hash:B,counter:0});D=E[B].hash+"_"+E[B].counter;s.geometryGroups[D]===void 0&&(s.geometryGroups[D]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:G,numMorphNormals:H});A=w instanceof THREE.Face3?3:4;if(s.geometryGroups[D].vertices+A>65535){E[B].counter=E[B].counter+1;D=E[B].hash+"_"+E[B].counter;s.geometryGroups[D]===void 0&&(s.geometryGroups[D]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:G,numMorphNormals:H})}w instanceof THREE.Face3?s.geometryGroups[D].faces3.push(u):
...
l[q],r,t,u=g.vertexNormals,w=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+f,g.b+f,g.c+f):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+f,g.b+f,g.c+f,g.d+f));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(o=u.length;h<o;h++){t=u[h].clone();d&&d.multiplyVector3(t);r.vertexNormals.push(t)}r.color.copy(g.color);h=0;for(o=w.length;h<o;h++){t=w[h];r.vertexColors.push(t.clone())}if(g.materialIndex!==void 0){h=e.materials[g.materialIndex];o=h.id;w=m[o];if(w===void 0){w=
...
l.lerpSelf(n,0.5);w.a=e;w.b=g;w.c=i;s.a=i;s.b=g;s.c=h;if(f.vertexNormals.length===3){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[2],0.5);w.vertexNormals[2].copy(e);s.vertexNormals[0].copy(e)}if(f.vertexColors.length===3){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[2],0.5);w.vertexColors[2].copy(e);s.vertexColors[0].copy(e)}f=2}B.push(w,s);a.vertices.push(l);e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){l=a.faceVertexUvs[e][c];s=l[0];h=l[1];w=l[2];if(f===
0){j=s.clone();j.lerpSelf(h,0.5);l=[s.clone(),j.clone(),w.clone()];h=[j.clone(),h.clone(),w.clone()]}else if(f===1){j=h.clone();j.lerpSelf(w,0.5);l=[s.clone(),h.clone(),j.clone()];h=[j.clone(),w.clone(),s.clone()]}else{j=s.clone();j.lerpSelf(w,0.5);l=[s.clone(),h.clone(),j.clone()];h=[j.clone(),h.clone(),w.clone()]}v[e].push(l,h)}}else{B.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)v[e].push(a.faceVertexUvs[e][c])}}else{e=f.a;g=f.b;h=f.c;i=f.d;l=a.vertices[e];j=a.vertices[g];n=a.vertices[h];m=
a.vertices[i];q=l.distanceTo(j);p=j.distanceTo(n);o=n.distanceTo(m);r=l.distanceTo(m);if(q>b||p>b||o>b||r>b){t=a.vertices.length;u=a.vertices.length+1;w=f.clone();s=f.clone();if(q>=p&&q>=o&&q>=r||o>=p&&o>=q&&o>=r){q=l.clone();q.lerpSelf(j,0.5);j=n.clone();j.lerpSelf(m,0.5);w.a=e;w.b=t;w.c=u;w.d=i;s.a=t;s.b=g;s.c=h;s.d=u;if(f.vertexNormals.length===4){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);g=f.vertexNormals[2].clone();g.lerpSelf(f.vertexNormals[3],0.5);w.vertexNormals[1].copy(e);
w.vertexNormals[2].copy(g);s.vertexNormals[0].copy(e);s.vertexNormals[3].copy(g)}if(f.vertexColors.length===4){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[1],0.5);g=f.vertexColors[2].clone();g.lerpSelf(f.vertexColors[3],0.5);w.vertexColors[1].copy(e);w.vertexColors[2].copy(g);s.vertexColors[0].copy(e);s.vertexColors[3].copy(g)}f=0}else{q=j.clone();q.lerpSelf(n,0.5);j=m.clone();j.lerpSelf(l,0.5);w.a=e;w.b=g;w.c=t;w.d=u;s.a=u;s.b=t;s.c=h;s.d=i;if(f.vertexNormals.length===4){e=f.vertexNormals[1].clone();
...
e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){l=a.faceVertexUvs[e][c];s=l[0];h=l[1];w=l[2];l=l[3];if(f===0){j=s.clone();j.lerpSelf(h,0.5);n=w.clone();n.lerpSelf(l,0.5);s=[s.clone(),j.clone(),n.clone(),l.clone()];h=[j.clone(),h.clone(),w.clone(),n.clone()]}else{j=h.clone();j.lerpSelf(w,0.5);n=l.clone();n.lerpSelf(s,0.5);s=[s.clone(),h.clone(),j.clone(),n.clone()];h=[n.clone(),j.clone(),w.clone(),l.clone()]}v[e].push(s,h)}}else{B.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)v[e].push(a.faceVertexUvs[e][c])}}}a.faces=
...
THREE.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*e.autoRotateSpeed}function d(a){a.preventDefault();if(u===t.ROTATE){i.set(a.clientX,a.clientY);l.sub(i,h);e.rotateLeft(2*Math.PI*l.x/g*e.userRotateSpeed);e.rotateUp(2*Math.PI*l.y/g*e.userRotateSpeed);h.copy(i)}else if(u===t.ZOOM){n.set(a.clientX,a.clientY);m.sub(n,j);m.y>0?e.zoomIn():e.zoomOut();j.copy(n)}}function f(){if(e.userRotate){document.removeEventListener("mousemove",d,false);document.removeEventListener("mouseup",f,false);
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function i(a,b,c,g,h,i,j,m){var n,o=d||1,p=f||1,q=h/2,r=i/2,t=l.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=e||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=e||1}var u=o+1,w=p+1,Y=h/o,$=i/p,L=new THREE.Vector3;L[n]=j>0?1:-1;for(h=0;h<w;h++)for(i=0;i<u;i++){var ba=new THREE.Vector3;ba[a]=(i*Y-q)*c;ba[b]=(h*$-r)*g;ba[n]=j;l.vertices.push(ba)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
...
this.vertices[l[0][h+1]].clone()}else{n=this.vertices[l[1][h]].clone();m=this.vertices[l[1][h+1]].clone()}n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<f;i++){var q=l[i][h],p=l[i+1][h],o=l[i+1][h+1],r=l[i][h+1],t=n.clone(),u=n.clone(),w=m.clone(),s=m.clone(),B=j[i][h].clone(),v=j[i+1][h].clone(),A=j[i+1][h+1].clone(),D=j[i][h+1].clone();this.faces.push(new THREE.Face4(q,p,o,r,[t,u,w,s]));this.faceVertexUvs[0].push([B,v,A,D])}}if(!e&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){q=l[0][h];p=l[0][h+1];o=this.vertices.length-1;t=new THREE.Vector3(0,1,0);u=new THREE.Vector3(0,1,0);w=new THREE.Vector3(0,1,0);B=j[0][h].clone();v=j[0][h+1].clone();A=new THREE.UV(v.u,0);this.faces.push(new THREE.Face3(q,p,o,[t,u,w]));this.faceVertexUvs[0].push([B,v,A])}}if(!e&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){q=l[i][h+1];p=l[i][h];o=this.vertices.length-1;t=new THREE.Vector3(0,-1,0);u=new THREE.Vector3(0,
...
c.length-1);for(var g=0,h=m+j*2,g=0;g<h;g++){var i=V*g,l=V*(g+1),n=d+e+i,i=d+f+i,o=d+f+l,l=d+e+l,p=c,q=g,r=h,s=e,v=f,n=n+G,i=i+G,o=o+G,l=l+G;M.faces.push(new THREE.Face4(n,i,o,l,null,null,t));n=u.generateSideWallUV(M,a,p,b,n,i,o,l,q,r,s,v);M.faceVertexUvs[0].push(n)}}}function e(a,b,c){M.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+G;d=d+G;e=e+G;M.faces.push(new THREE.Face3(c,d,e,null,null,r));c=f?u.generateBottomUV(M,a,b,c,d,e):u.generateTopUV(M,a,b,c,d,e);M.faceVertexUvs[0].push(c)}
...
false);s=new THREE.Vector3;B=new THREE.Vector3;v=new THREE.Vector3}if(!n)l=i=j=0;var A,D,z,M=this,G=this.vertices.length,q=a.extractPoints(),H=q.shape,q=q.holes,E=!THREE.Shape.Utils.isClockWise(H);if(E){H=H.reverse();D=0;for(z=q.length;D<z;D++){A=q[D];THREE.Shape.Utils.isClockWise(A)&&(q[D]=A.reverse())}E=false}var O=THREE.Shape.Utils.triangulateShape(H,q),E=H;D=0;for(z=q.length;D<z;D++){A=q[D];H=H.concat(A)}var F,J,I,K,V=H.length,Y=O.length,$=[],L=0,ba=E.length;F=ba-1;for(J=L+1;L<ba;L++,F++,J++){F===
...
ta[L],J):H[L];if(o){B.copy(w.normals[0]).multiplyScalar(K.x);s.copy(w.binormals[0]).multiplyScalar(K.y);v.copy(p[0]).addSelf(B).addSelf(s);e(v.x,v.y,v.z)}else e(K.x,K.y,0)}for(A=1;A<=m;A++)for(L=0;L<V;L++){K=n?c(H[L],ta[L],J):H[L];if(o){B.copy(w.normals[A]).multiplyScalar(K.x);s.copy(w.binormals[A]).multiplyScalar(K.y);v.copy(p[A]).addSelf(B).addSelf(s);e(v.x,v.y,v.z)}else e(K.x,K.y,h/m*A)}for(F=j-1;F>=0;F--){A=F/j;I=i*(1-A);J=l*Math.sin(A*Math.PI/2);L=0;for(ba=E.length;L<ba;L++){K=c(E[L],$[L],J);
...
1-p))}l.push(n);j.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=l[i][h+1],f=l[i][h],e=l[i+1][h],g=l[i+1][h+1],n=this.vertices[d].clone().normalize(),m=this.vertices[f].clone().normalize(),q=this.vertices[e].clone().normalize(),p=this.vertices[g].clone().normalize(),o=j[i][h+1].clone(),r=j[i][h].clone(),t=j[i+1][h].clone(),u=j[i+1][h+1].clone();if(Math.abs(this.vertices[d].y)==a){this.faces.push(new THREE.Face3(d,e,g,[n,q,p]));this.faceVertexUvs[0].push([o,t,u])}else if(Math.abs(this.vertices[e].y)==
...
q.push(v.centroid);h.push(v.centroid);if(j.supportUVs){z=new THREE.UV;if(v instanceof THREE.Face3){z.u=e(v.a,u).u+e(v.b,u).u+e(v.c,u).u;z.v=e(v.a,u).v+e(v.b,u).v+e(v.c,u).v;z.u=z.u/3;z.v=z.v/3}else if(v instanceof THREE.Face4){z.u=e(v.a,u).u+e(v.b,u).u+e(v.c,u).u+e(v.d,u).u;z.v=e(v.a,u).v+e(v.b,u).v+e(v.c,u).v+e(v.d,u).v;z.u=z.u/4;z.v=z.v/4}g(t+u,"",z)}}b("-- added UVs for new Faces",r);D=function(a,b){M[a]===void 0&&(M[a]=[]);M[a].push(b)};var M={},A=0;for(w=a.faces.length;A<w;A++){v=a.faces[A];
if(v instanceof THREE.Face3){z=f(v.a,v.b);D(z,A);z=f(v.b,v.c);D(z,A);z=f(v.c,v.a);D(z,A)}else if(v instanceof THREE.Face4){z=f(v.a,v.b);D(z,A);z=f(v.b,v.c);D(z,A);z=f(v.c,v.d);D(z,A);z=f(v.d,v.a);D(z,A)}}w=M;var G=0,H,E;D={};A={};for(u in w){z=w[u];H=u.split("_");E=H[0];H=H[1];s=E;v=[E,H];D[s]===void 0&&(D[s]=[]);D[s].push(v);s=H;v=[E,H];D[s]===void 0&&(D[s]=[]);D[s].push(v);s=0;for(B=z.length;s<B;s++){v=z[s];var O=E,F=v,J=u;A[O]===void 0&&(A[O]={});A[O][F]=J;O=H;F=u;A[O]===void 0&&(A[O]={});A[O][v]=
F}z.length<2&&(o[u]=true)}b("vertexEdgeMap",D,"vertexFaceMap",A);for(u in w){z=w[u];v=z[0];B=z[1];H=u.split("_");E=H[0];H=H[1];z=new THREE.Vector3;if(o[u]){z.addSelf(n[E]);z.addSelf(n[H]);z.multiplyScalar(0.5)}else{z.addSelf(q[v]);z.addSelf(q[B]);z.addSelf(n[E]);z.addSelf(n[H]);z.multiplyScalar(0.25)}p[u]=t+m.length+G;h.push(z);G++;if(j.supportUVs){z=new THREE.UV;z.u=e(E,v).u+e(H,v).u;z.v=e(E,v).v+e(H,v).v;z.u=z.u/2;z.v=z.v/2;g(p[u],v,z);if(!o[u]){z=new THREE.UV;z.u=e(E,B).u+e(H,B).u;z.v=e(E,B).v+
e(H,B).v;z.u=z.u/2;z.v=z.v/2;g(p[u],B,z)}}}b("-- Step 2 done");var I,K;H=["123","12","2","23"];B=["123","23","3","31"];var O=["123","31","1","12"],F=["1234","12","2","23"],J=["1234","23","3","34"],V=["1234","34","4","41"],Y=["1234","41","1","12"];u=0;for(w=q.length;u<w;u++){v=m[u];z=t+u;if(v instanceof THREE.Face3){G=f(v.a,v.b);E=f(v.b,v.c);I=f(v.c,v.a);d(z,p[G],v.b,p[E],v,H,u);d(z,p[E],v.c,p[I],v,B,u);d(z,p[I],v.a,p[G],v,O,u)}else if(v instanceof THREE.Face4){G=f(v.a,v.b);E=f(v.b,v.c);I=f(v.c,v.d);
K=f(v.d,v.a);d(z,p[G],v.b,p[E],v,F,u);d(z,p[E],v.c,p[I],v,J,u);d(z,p[I],v.d,p[K],v,V,u);d(z,p[K],v.a,p[G],v,Y,u)}else b("face should be a face!",v)}p=new THREE.Vector3;v=new THREE.Vector3;u=0;for(w=n.length;u<w;u++)if(D[u]!==void 0){p.set(0,0,0);v.set(0,0,0);E=new THREE.Vector3(0,0,0);z=0;for(s in A[u]){p.addSelf(q[s]);z++}H=0;G=D[u].length;for(s=0;s<G;s++)o[f(D[u][s][0],D[u][s][1])]&&H++;if(H!=2){p.divideScalar(z);for(s=0;s<G;s++){z=D[u][s];z=n[z[0]].clone().addSelf(n[z[1]]).divideScalar(2);v.addSelf(z)}v.divideScalar(G);
...
1);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(A.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(A.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var H,E,O,F,J;for(H=0;H<u;H++){A=16/t;D.set(A*s,A);F=a[H];w.set(F.matrixWorld.elements[12],F.matrixWorld.elements[13],F.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(w);d.projectionMatrix.multiplyVector3(w);z.copy(w);M.x=z.x*B+B;M.y=z.y*v+v;if(l||M.x>0&&M.x<f&&M.y>0&&
...
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);F.positionScreen.copy(z);F.customUpdateCallback?F.customUpdateCallback(F):F.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);E=0;for(O=F.lensFlares.length;E<O;E++){J=F.lensFlares[E];if(J.opacity>0.001&&J.scale>0.001){z.x=J.x;z.y=J.y;z.z=J.z;A=J.size*J.scale/t;D.x=A*s;D.y=A;b.uniform3f(G.screenPosition,z.x,z.y,z.z);b.uniform2f(G.scale,D.x,D.y);b.uniform1f(G.rotation,J.rotation);b.uniform1f(G.opacity,J.opacity);
