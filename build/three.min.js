...
[];s=d.morphColors[c].colors;z=a.morphColors[c].colors;f=0;for(v=z.length;f<v;f+=3)w=new THREE.Color(16755200),w.setRGB(z[f],z[f+1],z[f+2]),s.push(w)}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};THREE.GeometryLoader=function(){THREE.EventTarget.call(this);this.path=this.crossOrigin=null};
