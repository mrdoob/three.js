...
f=THREE.Matrix4.__v1,e=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();if(g.length()===0)g.z=1;f.cross(c,g).normalize();if(f.length()===0){g.x=g.x+1E-4;f.cross(c,g).normalize()}e.cross(g,f);d[0]=f.x;d[4]=e.x;d[8]=g.x;d[1]=f.y;d[5]=e.y;d[9]=g.y;d[2]=f.z;d[6]=e.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,f=this.elements,e=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],n=c[9],m=c[13],q=c[2],p=c[6],o=c[10],r=c[14],t=c[3],u=c[7],v=c[11],c=c[15],s=d[0],z=d[4],
w=d[8],A=d[12],L=d[1],D=d[5],H=d[9],B=d[13],E=d[2],J=d[6],O=d[10],F=d[14],K=d[3],I=d[7],M=d[11],d=d[15];f[0]=e*s+g*L+h*E+i*K;f[4]=e*z+g*D+h*J+i*I;f[8]=e*w+g*H+h*O+i*M;f[12]=e*A+g*B+h*F+i*d;f[1]=j*s+l*L+n*E+m*K;f[5]=j*z+l*D+n*J+m*I;f[9]=j*w+l*H+n*O+m*M;f[13]=j*A+l*B+n*F+m*d;f[2]=q*s+p*L+o*E+r*K;f[6]=q*z+p*D+o*J+r*I;f[10]=q*w+p*H+o*O+r*M;f[14]=q*A+p*B+o*F+r*d;f[3]=t*s+u*L+v*E+c*K;f[7]=t*z+u*D+v*J+c*I;f[11]=t*w+u*H+v*O+c*M;f[15]=t*A+u*B+v*F+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
b);var a=j.dot(j),b=j.dot(l),c=j.dot(n),f=l.dot(l),d=l.dot(n),e=1/(a*f-b*b),f=(f*c-b*d)*e,a=(a*d-b*c)*e;return f>=0&&a>=0&&f+a<1},p=function(i,j,l){var n,o;if(i instanceof a.Particle){n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>i.scale.x)return l;o={distance:n,point:i.position,face:null,object:i};l.push(o)}else if(i instanceof a.Mesh){var p=i.geometry.boundingSphere.radius*i.matrixWorld.getMaxScaleOnAxis();n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>p)return l;var w,
A,L=i.geometry,D=L.vertices,H,B,E;H=i.geometry.materials;B=i.material instanceof a.MeshFaceMaterial;var J,O=j.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(j.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(j.direction);h.rotateAxis(d).normalize();p=0;for(w=L.faces.length;p<w;p++){o=L.faces[p];n=B===true?H[o.materialIndex]:i.material;if(n!==void 0){E=n.side;f.sub(o.centroid,c);e=o.normal;n=d.dot(e);if(!(Math.abs(n)<O)){A=e.dot(f)/n;if(!(A<0)&&(E===
a.DoubleSide||(E===a.FrontSide?n<0:n>0))){g.add(c,d.multiplyScalar(A));if(o instanceof a.Face3){n=D[o.a];A=D[o.b];E=D[o.c];if(q(g,n,A,E)){A=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(A);if(!(n<j.near||n>j.far)){o={distance:n,point:A,face:o,faceIndex:p,object:i};l.push(o)}}}else if(o instanceof a.Face4){n=D[o.a];A=D[o.b];E=D[o.c];J=D[o.d];if(q(g,n,A,J)||q(g,A,E,J)){A=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(A);if(!(n<j.near||n>j.far)){o={distance:n,point:A,face:o,faceIndex:p,
...
if(d<c)return false;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return true}var f,e,g=[],h=0,i,j,l=[],n=0,m,q,p=[],o=0,r,t=[],u=0,v,s,z=[],w=0,A,L,D=[],H=0,B={objects:[],sprites:[],lights:[],elements:[]},E=new THREE.Vector3,J=new THREE.Vector4,O=new THREE.Matrix4,F=new THREE.Matrix4,K=new THREE.Frustum,I=new THREE.Vector4,M=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);O.multiply(b.projectionMatrix,b.matrixWorldInverse);O.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);O.multiply(b.matrixWorld,b.projectionMatrixInverse);O.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n,N){var $=h.near,Q=h.far,ga=false,ua,ea,ha,V,U,ja,Ja,qa,va,Da,Ka,Za,ka,rb,Qa,$a;L=s=r=q=0;B.elements.length=0;g.updateMatrixWorld();h.parent===
void 0&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);O.multiply(h.projectionMatrix,h.matrixWorldInverse);K.setFromMatrix(O);e=0;B.objects.length=0;B.sprites.length=0;B.lights.length=0;var xb=function(b){for(var c=0,d=b.children.length;c<d;c++){var e=b.children[c];if(e.visible!==false){if(e instanceof THREE.Light)B.lights.push(e);else if(e instanceof THREE.Mesh||e instanceof THREE.Line){if(e.frustumCulled===false||K.contains(e)===true){f=a();f.object=e;if(e.renderDepth!==null)f.z=
e.renderDepth;else{E.copy(e.matrixWorld.getPosition());O.multiplyVector3(E);f.z=E.z}B.objects.push(f)}}else if(e instanceof THREE.Sprite||e instanceof THREE.Particle){f=a();f.object=e;if(e.renderDepth!==null)f.z=e.renderDepth;else{E.copy(e.matrixWorld.getPosition());O.multiplyVector3(E);f.z=E.z}B.sprites.push(f)}else{f=a();f.object=e;if(e.renderDepth!==null)f.z=e.renderDepth;else{E.copy(e.matrixWorld.getPosition());O.multiplyVector3(E);f.z=E.z}B.objects.push(f)}xb(e)}}};xb(g);n===true&&B.objects.sort(c);
g=0;for(n=B.objects.length;g<n;g++){qa=B.objects[g].object;va=qa.matrixWorld;j=0;if(qa instanceof THREE.Mesh){Da=qa.geometry;Ka=qa.geometry.materials;ha=Da.vertices;Za=Da.faces;rb=Da.faceVertexUvs;Da=qa.matrixRotationWorld.extractRotation(va);$a=qa.material instanceof THREE.MeshFaceMaterial;ua=0;for(ea=ha.length;ua<ea;ua++){i=b();i.positionWorld.copy(ha[ua]);va.multiplyVector3(i.positionWorld);i.positionScreen.copy(i.positionWorld);O.multiplyVector4(i.positionScreen);i.positionScreen.x=i.positionScreen.x/
i.positionScreen.w;i.positionScreen.y=i.positionScreen.y/i.positionScreen.w;i.visible=i.positionScreen.z>$&&i.positionScreen.z<Q}ha=0;for(ua=Za.length;ha<ua;ha++){Ja=Za[ha];ea=$a===true?Ka[Ja.materialIndex]:qa.material;if(ea!==void 0){ja=ea.side;if(Ja instanceof THREE.Face3){V=l[Ja.a];U=l[Ja.b];ka=l[Ja.c];if(V.visible===true&&U.visible===true&&ka.visible===true){ga=(ka.positionScreen.x-V.positionScreen.x)*(U.positionScreen.y-V.positionScreen.y)-(ka.positionScreen.y-V.positionScreen.y)*(U.positionScreen.x-
V.positionScreen.x)<0;if(ja===THREE.DoubleSide||ga===(ja===THREE.FrontSide)){if(q===o){Qa=new THREE.RenderableFace3;p.push(Qa);o++;q++;m=Qa}else m=p[q++];m.v1.copy(V);m.v2.copy(U);m.v3.copy(ka)}else continue}else continue}else if(Ja instanceof THREE.Face4){V=l[Ja.a];U=l[Ja.b];ka=l[Ja.c];Qa=l[Ja.d];if(V.visible===true&&U.visible===true&&ka.visible===true&&Qa.visible===true){ga=(Qa.positionScreen.x-V.positionScreen.x)*(U.positionScreen.y-V.positionScreen.y)-(Qa.positionScreen.y-V.positionScreen.y)*
(U.positionScreen.x-V.positionScreen.x)<0||(U.positionScreen.x-ka.positionScreen.x)*(Qa.positionScreen.y-ka.positionScreen.y)-(U.positionScreen.y-ka.positionScreen.y)*(Qa.positionScreen.x-ka.positionScreen.x)<0;if(ja===THREE.DoubleSide||ga===(ja===THREE.FrontSide)){if(r===u){var yb=new THREE.RenderableFace4;t.push(yb);u++;r++;m=yb}else m=t[r++];m.v1.copy(V);m.v2.copy(U);m.v3.copy(ka);m.v4.copy(Qa)}else continue}else continue}m.normalWorld.copy(Ja.normal);ga===false&&(ja===THREE.BackSide||ja===THREE.DoubleSide)&&
m.normalWorld.negate();Da.multiplyVector3(m.normalWorld);m.centroidWorld.copy(Ja.centroid);va.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);O.multiplyVector3(m.centroidScreen);Ja=Ja.vertexNormals;V=0;for(U=Ja.length;V<U;V++){ka=m.vertexNormalsWorld[V];ka.copy(Ja[V]);ga===false&&(ja===THREE.BackSide||ja===THREE.DoubleSide)&&ka.negate();Da.multiplyVector3(ka)}m.vertexNormalsLength=Ja.length;V=0;for(U=rb.length;V<U;V++){ka=rb[V][ha];if(ka!==void 0){ja=0;for(Ja=ka.length;ja<
Ja;ja++)m.uvs[V][ja]=ka[ja]}}m.material=ea;m.z=m.centroidScreen.z;B.elements.push(m)}}}else if(qa instanceof THREE.Line){F.multiply(O,va);ha=qa.geometry.vertices;V=b();V.positionScreen.copy(ha[0]);F.multiplyVector4(V.positionScreen);va=qa.type===THREE.LinePieces?2:1;ua=1;for(ea=ha.length;ua<ea;ua++){V=b();V.positionScreen.copy(ha[ua]);F.multiplyVector4(V.positionScreen);if(!((ua+1)%va>0)){U=l[j-2];I.copy(V.positionScreen);M.copy(U.positionScreen);if(d(I,M)===true){I.multiplyScalar(1/I.w);M.multiplyScalar(1/
M.w);if(s===w){Ka=new THREE.RenderableLine;z.push(Ka);w++;s++;v=Ka}else v=z[s++];v.v1.positionScreen.copy(I);v.v2.positionScreen.copy(M);v.z=Math.max(I.z,M.z);v.material=qa.material;B.elements.push(v)}}}}}g=0;for(n=B.sprites.length;g<n;g++){qa=B.sprites[g].object;va=qa.matrixWorld;if(qa instanceof THREE.Particle){J.set(va.elements[12],va.elements[13],va.elements[14],1);O.multiplyVector4(J);J.z=J.z/J.w;if(J.z>0&&J.z<1){if(L===H){$=new THREE.RenderableParticle;D.push($);H++;L++;A=$}else A=D[L++];A.object=
qa;A.x=J.x/J.w;A.y=J.y/J.w;A.z=J.z;A.rotation=qa.rotation.z;A.scale.x=qa.scale.x*Math.abs(A.x-(J.x+h.projectionMatrix.elements[0])/(J.w+h.projectionMatrix.elements[12]));A.scale.y=qa.scale.y*Math.abs(A.y-(J.y+h.projectionMatrix.elements[5])/(J.w+h.projectionMatrix.elements[13]));A.material=qa.material;B.elements.push(A)}}}N===true&&B.elements.sort(c);return B}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=d!==void 0?d:1};
...
i=g.faceNormals[c];j=g.vertexNormals[c];i.copy(f.normal);if(f instanceof THREE.Face3){j.a.copy(f.vertexNormals[0]);j.b.copy(f.vertexNormals[1]);j.c.copy(f.vertexNormals[2])}else{j.a.copy(f.vertexNormals[0]);j.b.copy(f.vertexNormals[1]);j.c.copy(f.vertexNormals[2]);j.d.copy(f.vertexNormals[3])}}}c=0;for(d=this.faces.length;c<d;c++){f=this.faces[c];f.normal=f.__originalFaceNormal;f.vertexNormals=f.__originalVertexNormals}},computeTangents:function(){function a(a,b,c,d,f,e,J){h=a.vertices[b];i=a.vertices[c];
j=a.vertices[d];l=g[f];n=g[e];m=g[J];q=i.x-h.x;p=j.x-h.x;o=i.y-h.y;r=j.y-h.y;t=i.z-h.z;u=j.z-h.z;v=n.u-l.u;s=m.u-l.u;z=n.v-l.v;w=m.v-l.v;A=1/(v*w-s*z);B.set((w*q-z*p)*A,(w*o-z*r)*A,(w*t-z*u)*A);E.set((v*p-s*q)*A,(v*r-s*o)*A,(v*u-s*t)*A);D[b].addSelf(B);D[c].addSelf(B);D[d].addSelf(B);H[b].addSelf(E);H[c].addSelf(E);H[d].addSelf(E)}var b,c,d,f,e,g,h,i,j,l,n,m,q,p,o,r,t,u,v,s,z,w,A,L,D=[],H=[],B=new THREE.Vector3,E=new THREE.Vector3,J=new THREE.Vector3,O=new THREE.Vector3,F=new THREE.Vector3;b=0;for(c=
this.vertices.length;b<c;b++){D[b]=new THREE.Vector3;H[b]=new THREE.Vector3}b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];g=this.faceVertexUvs[0][b];if(e instanceof THREE.Face3)a(this,e.a,e.b,e.c,0,1,2);else if(e instanceof THREE.Face4){a(this,e.a,e.b,e.d,0,1,3);a(this,e.b,e.c,e.d,1,2,3)}}var K=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];for(d=0;d<e.vertexNormals.length;d++){F.copy(e.vertexNormals[d]);f=e[K[d]];L=D[f];J.copy(L);J.subSelf(F.multiplyScalar(F.dot(L))).normalize();
O.cross(e.vertexNormals[d],L);f=O.dot(H[f]);f=f<0?-1:1;e.vertexTangents[d]=new THREE.Vector4(J.x,J.y,J.z,f)}}this.hasTangents=true},computeBoundingBox:function(){if(!this.boundingBox)this.boundingBox={min:new THREE.Vector3,max:new THREE.Vector3};if(this.vertices.length>0){var a;a=this.vertices[0];this.boundingBox.min.copy(a);this.boundingBox.max.copy(a);for(var b=this.boundingBox.min,c=this.boundingBox.max,d=1,f=this.vertices.length;d<f;d++){a=this.vertices[d];if(a.x<b.x)b.x=a.x;else if(a.x>c.x)c.x=
...
o);t.crossSelf(u);h[i*3]=h[i*3]+t.x;h[i*3+1]=h[i*3+1]+t.y;h[i*3+2]=h[i*3+2]+t.z;h[j*3]=h[j*3]+t.x;h[j*3+1]=h[j*3+1]+t.y;h[j*3+2]=h[j*3+2]+t.z;h[l*3]=h[l*3]+t.x;h[l*3+1]=h[l*3+1]+t.y;h[l*3+2]=h[l*3+2]+t.z}}a=0;for(b=h.length;a<b;a=a+3){n=h[a];m=h[a+1];q=h[a+2];c=1/Math.sqrt(n*n+m*m+q*q);h[a]=h[a]*c;h[a+1]=h[a+1]*c;h[a+2]=h[a+2]*c}this.normalsNeedUpdate=true}},computeTangents:function(){function a(a){Z.x=d[a*3];Z.y=d[a*3+1];Z.z=d[a*3+2];da.copy(Z);$=i[a];M.copy($);M.subSelf(Z.multiplyScalar(Z.dot($))).normalize();
W.cross(da,$);Q=W.dot(j[a]);N=Q<0?-1:1;h[a*4]=M.x;h[a*4+1]=M.y;h[a*4+2]=M.z;h[a*4+3]=N}if(this.attributes.index===void 0||this.attributes.position===void 0||this.attributes.normal===void 0||this.attributes.uv===void 0)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,e=c.length/3;if(this.attributes.tangent===
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<e;g++){i[g]=new THREE.Vector3;j[g]=new THREE.Vector3}var l,n,m,q,p,o,r,t,u,v,s,z,w,A,L,e=new THREE.Vector3,g=new THREE.Vector3,D,H,B,E,J,O,F,K=this.offsets;B=0;for(E=K.length;B<E;++B){H=K[B].start;J=K[B].count;var I=K[B].index;D=H;for(H=H+J;D<H;D=D+3){J=I+b[D];O=I+b[D+1];F=I+b[D+2];l=c[J*3];n=c[J*3+1];m=c[J*3+2];q=c[O*3];p=c[O*3+1];o=c[O*3+2];r=c[F*3];
t=c[F*3+1];u=c[F*3+2];v=f[J*2];s=f[J*2+1];z=f[O*2];w=f[O*2+1];A=f[F*2];L=f[F*2+1];q=q-l;l=r-l;p=p-n;n=t-n;o=o-m;m=u-m;z=z-v;v=A-v;w=w-s;s=L-s;L=1/(z*s-v*w);e.set((s*q-w*l)*L,(s*p-w*n)*L,(s*o-w*m)*L);g.set((z*l-v*q)*L,(z*n-v*p)*L,(z*m-v*o)*L);i[J].addSelf(e);i[O].addSelf(e);i[F].addSelf(e);j[J].addSelf(g);j[O].addSelf(g);j[F].addSelf(g)}}var M=new THREE.Vector3,W=new THREE.Vector3,Z=new THREE.Vector3,da=new THREE.Vector3,N,$,Q;B=0;for(E=K.length;B<E;++B){H=K[B].start;J=K[B].count;I=K[B].index;D=H;
for(H=H+J;D<H;D=D+3){J=I+b[D];O=I+b[D+1];F=I+b[D+2];a(J);a(O);a(F)}}this.tangentsNeedUpdate=this.hasTangents=true}}};
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,j,l,n,m,q,p,o,r,t,u,v,s;function z(a){return a%4?4-a%4:0}function w(a,b){return(new Uint8Array(a,b,1))[0]}function A(a,b){return(new Uint32Array(a,b,1))[0]}function L(b,c){var d,f,e,g,h,i,j,l,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=I[f*2];f=I[f*2+1];i=I[e*2];j=I[e*2+1];e=I[g*2];l=I[g*2+1];g=O.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,j));m.push(new THREE.UV(e,
l));g.push(m)}}function D(b,c){var d,f,e,g,h,i,j,l,n,m,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){f=o[d*4];e=o[d*4+1];g=o[d*4+2];h=o[d*4+3];i=I[f*2];f=I[f*2+1];j=I[e*2];n=I[e*2+1];l=I[g*2];m=I[g*2+1];g=I[h*2];e=I[h*2+1];h=O.faceVertexUvs[0];var p=[];p.push(new THREE.UV(i,f));p.push(new THREE.UV(j,n));p.push(new THREE.UV(l,m));p.push(new THREE.UV(g,e));h.push(p)}}function H(b,c,d){for(var f,e,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*3];e=c[d*3+1];g=c[d*3+2];h=i[d];
O.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function B(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=j[d];O.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function E(b,c,d,f){for(var e,g,h,i,j,l,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];j=d[f*3];l=d[f*3+1];n=d[f*3+2];i=m[f];var o=K[l*3],p=K[l*3+1];l=K[l*3+2];var q=K[n*3],
r=K[n*3+1];n=K[n*3+2];O.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(K[j*3],K[j*3+1],K[j*3+2]),new THREE.Vector3(o,p,l),new THREE.Vector3(q,r,n)],null,i))}}function J(b,c,d,f){for(var e,g,h,i,j,l,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];l=d[f*4];n=d[f*4+1];m=d[f*4+2];o=d[f*4+3];j=p[f];var q=K[n*3],r=K[n*3+1];n=K[n*3+2];var s=K[m*3],t=K[m*3+1];m=K[m*3+2];var u=K[o*3],v=K[o*3+1];o=K[o*3+2];O.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(K[l*3],K[l*3+1],K[l*3+2]),new THREE.Vector3(q,r,n),new THREE.Vector3(s,t,m),new THREE.Vector3(u,v,o)],null,j))}}var O=this,F=0,K=[],I=[],M,W,Z;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(O,d,b);s=a;W=F;b=new Uint8Array(s,W,12);o="";for(u=0;u<12;u++)o=o+String.fromCharCode(b[W+u]);c=w(s,W+12);w(s,W+13);w(s,W+14);w(s,W+15);f=w(s,W+16);i=w(s,W+17);j=w(s,W+18);l=w(s,W+19);n=A(s,W+20);m=A(s,W+20+4);q=A(s,W+20+8);p=A(s,W+20+12);o=A(s,W+20+16);r=A(s,W+20+20);t=
A(s,W+20+24);u=A(s,W+20+28);b=A(s,W+20+32);v=A(s,W+20+36);s=A(s,W+20+40);F=F+c;W=f*3+l;Z=f*4+l;M=p*W;c=o*(W+i*3);f=r*(W+j*3);l=t*(W+i*3+j*3);W=u*Z;i=b*(Z+i*4);j=v*(Z+j*4);Z=F;var F=new Float32Array(a,F,n*3),da,N,$,Q;for(da=0;da<n;da++){N=F[da*3];$=F[da*3+1];Q=F[da*3+2];O.vertices.push(new THREE.Vector3(N,$,Q))}n=F=Z+n*3*Float32Array.BYTES_PER_ELEMENT;if(m){F=new Int8Array(a,F,m*3);for(Z=0;Z<m;Z++){da=F[Z*3];N=F[Z*3+1];$=F[Z*3+2];K.push(da/127,N/127,$/127)}}F=n+m*3*Int8Array.BYTES_PER_ELEMENT;m=F=
F+z(m*3);if(q){F=new Float32Array(a,F,q*2);for(n=0;n<q;n++){Z=F[n*2];da=F[n*2+1];I.push(Z,da)}}q=F=m+q*2*Float32Array.BYTES_PER_ELEMENT;M=q+M+z(p*2);m=M+c+z(o*2);c=m+f+z(r*2);f=c+l+z(t*2);W=f+W+z(u*2);l=W+i+z(b*2);i=l+j+z(v*2);if(r){j=m+r*Uint32Array.BYTES_PER_ELEMENT*3;H(r,m,j+r*Uint32Array.BYTES_PER_ELEMENT*3);L(r,j)}if(t){r=c+t*Uint32Array.BYTES_PER_ELEMENT*3;j=r+t*Uint32Array.BYTES_PER_ELEMENT*3;E(t,c,r,j+t*Uint32Array.BYTES_PER_ELEMENT*3);L(t,j)}if(v){t=l+v*Uint32Array.BYTES_PER_ELEMENT*4;B(v,
l,t+v*Uint32Array.BYTES_PER_ELEMENT*4);D(v,t)}if(s){v=i+s*Uint32Array.BYTES_PER_ELEMENT*4;t=v+s*Uint32Array.BYTES_PER_ELEMENT*4;J(s,i,v,t+s*Uint32Array.BYTES_PER_ELEMENT*4);D(s,t)}p&&H(p,q,q+p*Uint32Array.BYTES_PER_ELEMENT*3);if(o){p=M+o*Uint32Array.BYTES_PER_ELEMENT*3;E(o,M,p,p+o*Uint32Array.BYTES_PER_ELEMENT*3)}u&&B(u,f,f+u*Uint32Array.BYTES_PER_ELEMENT*4);if(b){o=W+b*Uint32Array.BYTES_PER_ELEMENT*4;J(b,W,o,o+b*Uint32Array.BYTES_PER_ELEMENT*4)}this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,j,l,n,m,q,p,o,r,t,u,v=a.faces;q=a.vertices;var s=a.normals,z=a.colors,w=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&w++;for(e=0;e<w;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}c=0;for(i=q.length;c<i;){j=new THREE.Vector3;j.x=q[c++]*f;j.y=q[c++]*f;j.z=q[c++]*f;d.vertices.push(j)}c=0;for(i=v.length;c<i;){q=v[c++];j=q&1;h=q&2;e=q&4;g=q&8;n=q&
16;l=q&32;p=q&64;q=q&128;if(j){o=new THREE.Face4;o.a=v[c++];o.b=v[c++];o.c=v[c++];o.d=v[c++];j=4}else{o=new THREE.Face3;o.a=v[c++];o.b=v[c++];o.c=v[c++];j=3}if(h){h=v[c++];o.materialIndex=h}h=d.faces.length;if(e)for(e=0;e<w;e++){r=a.uvs[e];m=v[c++];u=r[m*2];m=r[m*2+1];d.faceUvs[e][h]=new THREE.UV(u,m)}if(g)for(e=0;e<w;e++){r=a.uvs[e];t=[];for(g=0;g<j;g++){m=v[c++];u=r[m*2];m=r[m*2+1];t[g]=new THREE.UV(u,m)}d.faceVertexUvs[e][h]=t}if(n){n=v[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];
o.normal=g}if(l)for(e=0;e<j;e++){n=v[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];o.vertexNormals.push(g)}if(p){l=v[c++];l=new THREE.Color(z[l]);o.color=l}if(q)for(e=0;e<j;e++){l=v[c++];l=new THREE.Color(z[l]);o.vertexColors.push(l)}d.faces.push(o)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c=c+2){v=a.skinWeights[c];s=a.skinWeights[c+1];d.skinWeights.push(new THREE.Vector4(v,s,0,0))}}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c=c+2){v=a.skinIndices[c];s=a.skinIndices[c+
...
d.properties[g];d.children!==void 0&&f(e,d.children)}}}function e(a){return function(b){I.geometries[a]=b;f(I.scene,M.objects);J=J-1;i.onLoadComplete();h()}}function g(a){return function(b){I.geometries[a]=b}}function h(){i.callbackProgress({totalModels:F,totalTextures:K,loadedModels:F-J,loadedTextures:K-O},I);i.onLoadProgress();J===0&&O===0&&b(I)}var i=this,j=THREE.Loader.prototype.extractUrlBase(c),l,n,m,q,p,o,r,t,u,v,s,z,w,A,L,D,H,B,E,J,O,F,K,I,M=a;for(w in this.geometryHandlerMap)this.geometryHandlerMap[w].loaderObject=
new this.geometryHandlerMap[w].loaderClass;O=J=0;I={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(M.transform){a=M.transform.position;c=M.transform.rotation;w=M.transform.scale;a&&I.scene.position.set(a[0],a[1],a[2]);c&&I.scene.rotation.set(c[0],c[1],c[2]);w&&I.scene.scale.set(w[0],w[1],w[2]);if(a||c||w){I.scene.updateMatrix();I.scene.updateMatrixWorld()}}a=function(a){return function(){O=O-a;h();i.onLoadComplete()}};for(q in M.cameras){w=
M.cameras[q];w.type==="perspective"?H=new THREE.PerspectiveCamera(w.fov,w.aspect,w.near,w.far):w.type==="ortho"&&(H=new THREE.OrthographicCamera(w.left,w.right,w.top,w.bottom,w.near,w.far));u=w.position;c=w.target;w=w.up;H.position.set(u[0],u[1],u[2]);H.target=new THREE.Vector3(c[0],c[1],c[2]);w&&H.up.set(w[0],w[1],w[2]);I.cameras[q]=H}for(m in M.lights){c=M.lights[m];q=c.color!==void 0?c.color:16777215;H=c.intensity!==void 0?c.intensity:1;if(c.type==="directional"){u=c.direction;t=new THREE.DirectionalLight(q,
H);t.position.set(u[0],u[1],u[2]);t.position.normalize()}else if(c.type==="point"){u=c.position;t=c.distance;t=new THREE.PointLight(q,H,t);t.position.set(u[0],u[1],u[2])}else c.type==="ambient"&&(t=new THREE.AmbientLight(q));I.scene.add(t);I.lights[m]=t}for(p in M.fogs){m=M.fogs[p];m.type==="linear"?B=new THREE.Fog(0,m.near,m.far):m.type==="exp2"&&(B=new THREE.FogExp2(0,m.density));w=m.color;B.color.setRGB(w[0],w[1],w[2]);I.fogs[p]=B}if(I.cameras&&M.defaults.camera)I.currentCamera=I.cameras[M.defaults.camera];
if(I.fogs&&M.defaults.fog)I.scene.fog=I.fogs[M.defaults.fog];w=M.defaults.bgcolor;I.bgColor=new THREE.Color;I.bgColor.setRGB(w[0],w[1],w[2]);I.bgColorAlpha=M.defaults.bgalpha;for(l in M.geometries){p=M.geometries[l];if(p.type in this.geometryHandlerMap){J=J+1;i.onLoadStart()}}F=J;for(l in M.geometries){p=M.geometries[l];if(p.type==="cube"){L=new THREE.CubeGeometry(p.width,p.height,p.depth,p.segmentsWidth,p.segmentsHeight,p.segmentsDepth,null,p.flipped,p.sides);I.geometries[l]=L}else if(p.type==="plane"){L=
new THREE.PlaneGeometry(p.width,p.height,p.segmentsWidth,p.segmentsHeight);I.geometries[l]=L}else if(p.type==="sphere"){L=new THREE.SphereGeometry(p.radius,p.segmentsWidth,p.segmentsHeight);I.geometries[l]=L}else if(p.type==="cylinder"){L=new THREE.CylinderGeometry(p.topRad,p.botRad,p.height,p.radSegs,p.heightSegs);I.geometries[l]=L}else if(p.type==="torus"){L=new THREE.TorusGeometry(p.radius,p.tube,p.segmentsR,p.segmentsT);I.geometries[l]=L}else if(p.type==="icosahedron"){L=new THREE.IcosahedronGeometry(p.radius,
p.subdivisions);I.geometries[l]=L}else if(p.type in this.geometryHandlerMap){B={};for(E in p)E!=="type"&&E!=="url"&&(B[E]=p[E]);this.geometryHandlerMap[p.type].loaderObject.load(d(p.url,M.urlBaseType),e(l),B)}else if(p.type==="embedded"){p=M.embeds[p.id];p.metadata=M.metadata;p&&this.geometryHandlerMap.ascii.loaderObject.createModel(p,g(l),"")}}for(o in M.textures){l=M.textures[o];if(l.url instanceof Array){O=O+l.url.length;for(E=0;E<l.url.length;E++)i.onLoadStart()}else{O=O+1;i.onLoadStart()}}K=
O;for(o in M.textures){l=M.textures[o];if(l.mapping!==void 0&&THREE[l.mapping]!==void 0)l.mapping=new THREE[l.mapping];if(l.url instanceof Array){p=l.url.length;B=[];for(E=0;E<p;E++)B[E]=d(l.url[E],M.urlBaseType);E=(E=B[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(B,l.mapping,a(p)):THREE.ImageUtils.loadTextureCube(B,l.mapping,a(p))}else{E=l.url.toLowerCase().endsWith(".dds");p=d(l.url,M.urlBaseType);B=a(1);E=E?THREE.ImageUtils.loadCompressedTexture(p,l.mapping,B):THREE.ImageUtils.loadTexture(p,
l.mapping,B);if(THREE[l.minFilter]!==void 0)E.minFilter=THREE[l.minFilter];if(THREE[l.magFilter]!==void 0)E.magFilter=THREE[l.magFilter];if(l.anisotropy)E.anisotropy=l.anisotropy;if(l.repeat){E.repeat.set(l.repeat[0],l.repeat[1]);if(l.repeat[0]!==1)E.wrapS=THREE.RepeatWrapping;if(l.repeat[1]!==1)E.wrapT=THREE.RepeatWrapping}l.offset&&E.offset.set(l.offset[0],l.offset[1]);if(l.wrap){p={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(p[l.wrap[0]]!==void 0)E.wrapS=p[l.wrap[0]];if(p[l.wrap[1]]!==
void 0)E.wrapT=p[l.wrap[1]]}}I.textures[o]=E}for(n in M.materials){r=M.materials[n];for(A in r.parameters)if(A==="envMap"||A==="map"||A==="lightMap"||A==="bumpMap")r.parameters[A]=I.textures[r.parameters[A]];else if(A==="shading")r.parameters[A]=r.parameters[A]==="flat"?THREE.FlatShading:THREE.SmoothShading;else if(A==="side")r.parameters[A]=r.parameters[A]=="double"?THREE.DoubleSide:r.parameters[A]=="back"?THREE.BackSide:THREE.FrontSide;else if(A==="blending")r.parameters[A]=r.parameters[A]in THREE?
...
THREE.CanvasRenderer=function(a){function b(a){if(u!==a)u=o.globalAlpha=a}function c(a){if(v!==a){if(a===THREE.NormalBlending)o.globalCompositeOperation="source-over";else if(a===THREE.AdditiveBlending)o.globalCompositeOperation="lighter";else if(a===THREE.SubtractiveBlending)o.globalCompositeOperation="darker";v=a}}function d(a){if(s!==a)s=o.strokeStyle=a}function f(a){if(z!==a)z=o.fillStyle=a}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},e=this,g,h,i,j=new THREE.Projector,l=a.canvas!==
void 0?a.canvas:document.createElement("canvas"),n,m,q,p,o=l.getContext("2d"),r=new THREE.Color(0),t=0,u=1,v=0,s=null,z=null,w=null,A=null,L=null,D,H,B,E,J=new THREE.RenderableVertex,O=new THREE.RenderableVertex,F,K,I,M,W,Z,da,N,$,Q,ga,ua,ea=new THREE.Color,ha=new THREE.Color,V=new THREE.Color,U=new THREE.Color,ja=new THREE.Color,Ja={},qa={},va,Da,Ka,Za,ka,rb,Qa,$a,xb,yb,hb=new THREE.Rectangle,Ga=new THREE.Rectangle,ya=new THREE.Rectangle,sb=false,Ha=new THREE.Color,bb=new THREE.Color,tb=new THREE.Color,
Ea=new THREE.Vector3,cb,db,ib,Ra,Sa,jb,a=16;cb=document.createElement("canvas");cb.width=cb.height=2;db=cb.getContext("2d");db.fillStyle="rgba(0,0,0,1)";db.fillRect(0,0,2,2);ib=db.getImageData(0,0,2,2);Ra=ib.data;Sa=document.createElement("canvas");Sa.width=Sa.height=a;jb=Sa.getContext("2d");jb.translate(-a/2,-a/2);jb.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=true;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){n=a;m=b;q=Math.floor(n/2);
p=Math.floor(m/2);l.width=n;l.height=m;hb.set(-q,-p,q,p);Ga.set(-q,-p,q,p);u=1;v=0;L=A=w=z=s=null};this.setClearColor=function(a,b){r.copy(a);t=b!==void 0?b:1;Ga.set(-q,-p,q,p)};this.setClearColorHex=function(a,b){r.setHex(a);t=b!==void 0?b:1;Ga.set(-q,-p,q,p)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){o.setTransform(1,0,0,-1,q,p);if(Ga.isEmpty()===false){Ga.minSelf(hb);Ga.inflate(2);t<1&&o.clearRect(Math.floor(Ga.getX()),Math.floor(Ga.getY()),Math.floor(Ga.getWidth()),Math.floor(Ga.getHeight()));
if(t>0){c(THREE.NormalBlending);b(1);f("rgba("+Math.floor(r.r*255)+","+Math.floor(r.g*255)+","+Math.floor(r.b*255)+","+t+")");o.fillRect(Math.floor(Ga.getX()),Math.floor(Ga.getY()),Math.floor(Ga.getWidth()),Math.floor(Ga.getHeight()))}Ga.empty()}};this.render=function(a,k){function l(a,b,c){for(var d=0,f=i.length;d<f;d++){var e=i[d],g=e.color;if(e instanceof THREE.DirectionalLight){var h=e.matrixWorld.getPosition().normalize(),k=b.dot(h);if(!(k<=0)){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=
c.b+g.b*k}}else if(e instanceof THREE.PointLight){h=e.matrixWorld.getPosition();k=b.dot(Ea.sub(h,a).normalize());if(!(k<=0)){k=k*(e.distance==0?1:1-Math.min(a.distanceTo(h)/e.distance,1));if(k!=0){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}}}}function n(a,d,f,g,h,i,j,o){e.info.render.vertices=e.info.render.vertices+3;e.info.render.faces++;b(o.opacity);c(o.blending);F=a.positionScreen.x;K=a.positionScreen.y;I=d.positionScreen.x;M=d.positionScreen.y;W=f.positionScreen.x;Z=f.positionScreen.y;
m(F,K,I,M,W,Z);if((o instanceof THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)&&o.map===null&&o.map===null)if(sb===true){g=o.color;h=o.emissive;if(o.wireframe===false&&o.shading==THREE.SmoothShading&&j.vertexNormalsLength==3){ha.r=V.r=U.r=Ha.r;ha.g=V.g=U.g=Ha.g;ha.b=V.b=U.b=Ha.b;l(j.v1.positionWorld,j.vertexNormalsWorld[0],ha);l(j.v2.positionWorld,j.vertexNormalsWorld[1],V);l(j.v3.positionWorld,j.vertexNormalsWorld[2],U);ha.r=g.r*ha.r+h.r;ha.g=g.g*ha.g+h.g;ha.b=g.b*ha.b+h.b;V.r=
g.r*V.r+h.r;V.g=g.g*V.g+h.g;V.b=g.b*V.b+h.b;U.r=g.r*U.r+h.r;U.g=g.g*U.g+h.g;U.b=g.b*U.b+h.b;ja.r=(V.r+U.r)*0.5;ja.g=(V.g+U.g)*0.5;ja.b=(V.b+U.b)*0.5;Ka=wa(ha,V,U,ja);v(F,K,I,M,W,Z,0,0,1,0,0,1,Ka)}else{ea.r=Ha.r;ea.g=Ha.g;ea.b=Ha.b;l(j.centroidWorld,j.normalWorld,ea);ea.r=g.r*ea.r+h.r;ea.g=g.g*ea.g+h.g;ea.b=g.b*ea.b+h.b;o.wireframe===true?s(ea,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(ea)}}else o.wireframe===true?s(o.color,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):
t(o.color);else if(o instanceof THREE.MeshBasicMaterial||o instanceof THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)if(o.map!==null){if(o.map.mapping instanceof THREE.UVMapping){Za=j.uvs[0];u(F,K,I,M,W,Z,Za[g].u,Za[g].v,Za[h].u,Za[h].v,Za[i].u,Za[i].v,o.map)}}else if(o.envMap!==null){if(o.envMap.mapping instanceof THREE.SphericalReflectionMapping){a=k.matrixWorldInverse;Ea.copy(j.vertexNormalsWorld[g]);ka=(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;rb=(Ea.x*
a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;Ea.copy(j.vertexNormalsWorld[h]);Qa=(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;$a=(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;Ea.copy(j.vertexNormalsWorld[i]);xb=(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;yb=(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;u(F,K,I,M,W,Z,ka,rb,Qa,$a,xb,yb,o.envMap)}}else o.wireframe===true?s(o.color,o.wireframeLinewidth,
o.wireframeLinecap,o.wireframeLinejoin):t(o.color);else if(o instanceof THREE.MeshDepthMaterial){va=k.near;Da=k.far;ha.r=ha.g=ha.b=1-gc(a.positionScreen.z,va,Da);V.r=V.g=V.b=1-gc(d.positionScreen.z,va,Da);U.r=U.g=U.b=1-gc(f.positionScreen.z,va,Da);ja.r=(V.r+U.r)*0.5;ja.g=(V.g+U.g)*0.5;ja.b=(V.b+U.b)*0.5;Ka=wa(ha,V,U,ja);v(F,K,I,M,W,Z,0,0,1,0,0,1,Ka)}else if(o instanceof THREE.MeshNormalMaterial){ea.r=kc(j.normalWorld.x);ea.g=kc(j.normalWorld.y);ea.b=kc(j.normalWorld.z);o.wireframe===true?s(ea,o.wireframeLinewidth,
o.wireframeLinecap,o.wireframeLinejoin):t(ea)}}function m(a,b,c,d,f,e){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.closePath()}function r(a,b,c,d,f,e,g,h){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.lineTo(g,h);o.closePath()}function s(a,b,c,f){if(w!==b)w=o.lineWidth=b;if(A!==c)A=o.lineCap=c;if(L!==f)L=o.lineJoin=f;d(a.getContextStyle());o.stroke();ya.inflate(b*2)}function t(a){f(a.getContextStyle());o.fill()}function u(a,b,c,d,e,g,h,i,k,j,l,n,m){if(!(m instanceof THREE.DataTexture||
m.image===void 0||m.image.width==0)){if(m.needsUpdate===true){var wa=m.wrapS==THREE.RepeatWrapping,p=m.wrapT==THREE.RepeatWrapping;Ja[m.id]=o.createPattern(m.image,wa===true&&p===true?"repeat":wa===true&&p===false?"repeat-x":wa===false&&p===true?"repeat-y":"no-repeat");m.needsUpdate=false}Ja[m.id]===void 0?f("rgba(0,0,0,1)"):f(Ja[m.id]);var wa=m.offset.x/m.repeat.x,p=m.offset.y/m.repeat.y,q=m.image.width*m.repeat.x,r=m.image.height*m.repeat.y,h=(h+wa)*q,i=(1-i+p)*r,c=c-a,d=d-b,e=e-a,g=g-b,k=(k+wa)*
q-h,j=(1-j+p)*r-i,l=(l+wa)*q-h,n=(1-n+p)*r-i,wa=k*n-l*j;if(wa===0){if(qa[m.id]===void 0){b=document.createElement("canvas");b.width=m.image.width;b.height=m.image.height;b=b.getContext("2d");b.drawImage(m.image,0,0);qa[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data}b=qa[m.id];h=(Math.floor(h)+Math.floor(i)*m.image.width)*4;ea.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255);t(ea)}else{wa=1/wa;m=(n*c-j*e)*wa;j=(n*d-j*g)*wa;c=(k*e-l*c)*wa;d=(k*g-l*d)*wa;a=a-m*h-c*i;h=b-j*h-d*i;o.save();o.transform(m,
j,c,d,a,h);o.fill();o.restore()}}}function v(a,b,c,d,f,e,g,h,i,k,j,l,m){var n,wa;n=m.width-1;wa=m.height-1;g=g*n;h=h*wa;c=c-a;d=d-b;f=f-a;e=e-b;i=i*n-g;k=k*wa-h;j=j*n-g;l=l*wa-h;wa=1/(i*l-j*k);n=(l*c-k*f)*wa;k=(l*d-k*e)*wa;c=(i*f-j*c)*wa;d=(i*e-j*d)*wa;a=a-n*g-c*h;b=b-k*g-d*h;o.save();o.transform(n,k,c,d,a,b);o.clip();o.drawImage(m,0,0);o.restore()}function wa(a,b,c,d){Ra[0]=a.r*255|0;Ra[1]=a.g*255|0;Ra[2]=a.b*255|0;Ra[4]=b.r*255|0;Ra[5]=b.g*255|0;Ra[6]=b.b*255|0;Ra[8]=c.r*255|0;Ra[9]=c.g*255|0;Ra[10]=
c.b*255|0;Ra[12]=d.r*255|0;Ra[13]=d.g*255|0;Ra[14]=d.b*255|0;db.putImageData(ib,0,0);jb.drawImage(cb,0,0);return Sa}function gc(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function kc(a){a=(a+1)*0.5;return a<0?0:a>1?1:a}function Wb(a,b){var c=b.x-a.x,d=b.y-a.y,f=c*c+d*d;if(f!==0){f=1/Math.sqrt(f);c=c*f;d=d*f;b.x=b.x+c;b.y=b.y+d;a.x=a.x-c;a.y=a.y-d}}if(k instanceof THREE.Camera===false)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{var z,Fc,La,Y;this.autoClear===
true?this.clear():o.setTransform(1,0,0,-1,q,p);e.info.render.vertices=0;e.info.render.faces=0;g=j.projectScene(a,k,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;sb=i.length>0;if(sb===true){Ha.setRGB(0,0,0);bb.setRGB(0,0,0);tb.setRGB(0,0,0);z=0;for(Fc=i.length;z<Fc;z++){Y=i[z];var ca=Y.color;if(Y instanceof THREE.AmbientLight){Ha.r=Ha.r+ca.r;Ha.g=Ha.g+ca.g;Ha.b=Ha.b+ca.b}else if(Y instanceof THREE.DirectionalLight){bb.r=bb.r+ca.r;bb.g=bb.g+ca.g;bb.b=bb.b+ca.b}else if(Y instanceof THREE.PointLight){tb.r=
tb.r+ca.r;tb.g=tb.g+ca.g;tb.b=tb.b+ca.b}}}z=0;for(Fc=h.length;z<Fc;z++){La=h[z];Y=La.material;if(!(Y===void 0||Y.visible===false)){ya.empty();if(La instanceof THREE.RenderableParticle){D=La;D.x=D.x*q;D.y=D.y*p;var ca=D,pa=La;b(Y.opacity);c(Y.blending);var Fa=void 0,ub=void 0,lb=void 0,mb=void 0,Xb=void 0,Uc=La=void 0;if(Y instanceof THREE.ParticleBasicMaterial)if(Y.map===null){lb=pa.object.scale.x;mb=pa.object.scale.y;lb=lb*pa.scale.x*q;mb=mb*pa.scale.y*p;ya.set(ca.x-lb,ca.y-mb,ca.x+lb,ca.y+mb);if(hb.intersects(ya)!==
false){f(Y.color.getContextStyle());o.save();o.translate(ca.x,ca.y);o.rotate(-pa.rotation);o.scale(lb,mb);o.fillRect(-1,-1,2,2);o.restore()}}else{Xb=Y.map.image;La=Xb.width>>1;Uc=Xb.height>>1;lb=pa.scale.x*q;mb=pa.scale.y*p;Fa=lb*La;ub=mb*Uc;ya.set(ca.x-Fa,ca.y-ub,ca.x+Fa,ca.y+ub);if(hb.intersects(ya)!==false){o.save();o.translate(ca.x,ca.y);o.rotate(-pa.rotation);o.scale(lb,-mb);o.translate(-La,-Uc);o.drawImage(Xb,0,0);o.restore()}}else if(Y instanceof THREE.ParticleCanvasMaterial){Fa=pa.scale.x*
q;ub=pa.scale.y*p;ya.set(ca.x-Fa,ca.y-ub,ca.x+Fa,ca.y+ub);if(hb.intersects(ya)!==false){d(Y.color.getContextStyle());f(Y.color.getContextStyle());o.save();o.translate(ca.x,ca.y);o.rotate(-pa.rotation);o.scale(Fa,ub);Y.program(o);o.restore()}}}else if(La instanceof THREE.RenderableLine){D=La.v1;H=La.v2;D.positionScreen.x=D.positionScreen.x*q;D.positionScreen.y=D.positionScreen.y*p;H.positionScreen.x=H.positionScreen.x*q;H.positionScreen.y=H.positionScreen.y*p;ya.addPoint(D.positionScreen.x,D.positionScreen.y);
ya.addPoint(H.positionScreen.x,H.positionScreen.y);if(hb.intersects(ya)===true){ca=D;pa=H;b(Y.opacity);c(Y.blending);o.beginPath();o.moveTo(ca.positionScreen.x,ca.positionScreen.y);o.lineTo(pa.positionScreen.x,pa.positionScreen.y);if(Y instanceof THREE.LineBasicMaterial){ca=Y.linewidth;if(w!==ca)w=o.lineWidth=ca;ca=Y.linecap;if(A!==ca)A=o.lineCap=ca;ca=Y.linejoin;if(L!==ca)L=o.lineJoin=ca;d(Y.color.getContextStyle());o.stroke();ya.inflate(Y.linewidth*2)}}}else if(La instanceof THREE.RenderableFace3){D=
La.v1;H=La.v2;B=La.v3;D.positionScreen.x=D.positionScreen.x*q;D.positionScreen.y=D.positionScreen.y*p;H.positionScreen.x=H.positionScreen.x*q;H.positionScreen.y=H.positionScreen.y*p;B.positionScreen.x=B.positionScreen.x*q;B.positionScreen.y=B.positionScreen.y*p;if(Y.overdraw===true){Wb(D.positionScreen,H.positionScreen);Wb(H.positionScreen,B.positionScreen);Wb(B.positionScreen,D.positionScreen)}ya.add3Points(D.positionScreen.x,D.positionScreen.y,H.positionScreen.x,H.positionScreen.y,B.positionScreen.x,
B.positionScreen.y);hb.intersects(ya)===true&&n(D,H,B,0,1,2,La,Y,a)}else if(La instanceof THREE.RenderableFace4){D=La.v1;H=La.v2;B=La.v3;E=La.v4;D.positionScreen.x=D.positionScreen.x*q;D.positionScreen.y=D.positionScreen.y*p;H.positionScreen.x=H.positionScreen.x*q;H.positionScreen.y=H.positionScreen.y*p;B.positionScreen.x=B.positionScreen.x*q;B.positionScreen.y=B.positionScreen.y*p;E.positionScreen.x=E.positionScreen.x*q;E.positionScreen.y=E.positionScreen.y*p;J.positionScreen.copy(H.positionScreen);
O.positionScreen.copy(E.positionScreen);if(Y.overdraw===true){Wb(D.positionScreen,H.positionScreen);Wb(H.positionScreen,E.positionScreen);Wb(E.positionScreen,D.positionScreen);Wb(B.positionScreen,J.positionScreen);Wb(B.positionScreen,O.positionScreen)}ya.addPoint(D.positionScreen.x,D.positionScreen.y);ya.addPoint(H.positionScreen.x,H.positionScreen.y);ya.addPoint(B.positionScreen.x,B.positionScreen.y);ya.addPoint(E.positionScreen.x,E.positionScreen.y);if(hb.intersects(ya)===true){pa=D;Fa=H;ub=B;lb=
E;mb=J;Xb=O;ca=La;La=a;e.info.render.vertices=e.info.render.vertices+4;e.info.render.faces++;b(Y.opacity);c(Y.blending);if(Y.map!==void 0&&Y.map!==null||Y.envMap!==void 0&&Y.envMap!==null){n(pa,Fa,lb,0,1,3,ca,Y,La);n(mb,ub,Xb,1,2,3,ca,Y,La)}else{F=pa.positionScreen.x;K=pa.positionScreen.y;I=Fa.positionScreen.x;M=Fa.positionScreen.y;W=ub.positionScreen.x;Z=ub.positionScreen.y;da=lb.positionScreen.x;N=lb.positionScreen.y;$=mb.positionScreen.x;Q=mb.positionScreen.y;ga=Xb.positionScreen.x;ua=Xb.positionScreen.y;
if(Y instanceof THREE.MeshLambertMaterial||Y instanceof THREE.MeshPhongMaterial)if(sb===true){pa=Y.color;Fa=Y.emissive;if(Y.wireframe===false&&Y.shading==THREE.SmoothShading&&ca.vertexNormalsLength==4){ha.r=V.r=U.r=ja.r=Ha.r;ha.g=V.g=U.g=ja.g=Ha.g;ha.b=V.b=U.b=ja.b=Ha.b;l(ca.v1.positionWorld,ca.vertexNormalsWorld[0],ha);l(ca.v2.positionWorld,ca.vertexNormalsWorld[1],V);l(ca.v4.positionWorld,ca.vertexNormalsWorld[3],U);l(ca.v3.positionWorld,ca.vertexNormalsWorld[2],ja);ha.r=pa.r*ha.r+Fa.r;ha.g=pa.g*
ha.g+Fa.g;ha.b=pa.b*ha.b+Fa.b;V.r=pa.r*V.r+Fa.r;V.g=pa.g*V.g+Fa.g;V.b=pa.b*V.b+Fa.b;U.r=pa.r*U.r+Fa.r;U.g=pa.g*U.g+Fa.g;U.b=pa.b*U.b+Fa.b;ja.r=pa.r*ja.r+Fa.r;ja.g=pa.g*ja.g+Fa.g;ja.b=pa.b*ja.b+Fa.b;Ka=wa(ha,V,U,ja);m(F,K,I,M,da,N);v(F,K,I,M,da,N,0,0,1,0,0,1,Ka);m($,Q,W,Z,ga,ua);v($,Q,W,Z,ga,ua,1,0,1,1,0,1,Ka)}else{ea.r=Ha.r;ea.g=Ha.g;ea.b=Ha.b;l(ca.centroidWorld,ca.normalWorld,ea);ea.r=pa.r*ea.r+Fa.r;ea.g=pa.g*ea.g+Fa.g;ea.b=pa.b*ea.b+Fa.b;r(F,K,I,M,W,Z,da,N);Y.wireframe===true?s(ea,Y.wireframeLinewidth,
Y.wireframeLinecap,Y.wireframeLinejoin):t(ea)}}else{r(F,K,I,M,W,Z,da,N);Y.wireframe===true?s(Y.color,Y.wireframeLinewidth,Y.wireframeLinecap,Y.wireframeLinejoin):t(Y.color)}else if(Y instanceof THREE.MeshBasicMaterial){r(F,K,I,M,W,Z,da,N);Y.wireframe===true?s(Y.color,Y.wireframeLinewidth,Y.wireframeLinecap,Y.wireframeLinejoin):t(Y.color)}else if(Y instanceof THREE.MeshNormalMaterial){ea.r=kc(ca.normalWorld.x);ea.g=kc(ca.normalWorld.y);ea.b=kc(ca.normalWorld.z);r(F,K,I,M,W,Z,da,N);Y.wireframe===true?
s(ea,Y.wireframeLinewidth,Y.wireframeLinecap,Y.wireframeLinejoin):t(ea)}else if(Y instanceof THREE.MeshDepthMaterial){va=k.near;Da=k.far;ha.r=ha.g=ha.b=1-gc(pa.positionScreen.z,va,Da);V.r=V.g=V.b=1-gc(Fa.positionScreen.z,va,Da);U.r=U.g=U.b=1-gc(lb.positionScreen.z,va,Da);ja.r=ja.g=ja.b=1-gc(ub.positionScreen.z,va,Da);Ka=wa(ha,V,U,ja);m(F,K,I,M,da,N);v(F,K,I,M,da,N,0,0,1,0,0,1,Ka);m($,Q,W,Z,ga,ua);v($,Q,W,Z,ga,ua,1,0,1,1,0,1,Ka)}}}}Ga.addRectangle(ya)}}o.setTransform(1,0,0,1,0,0)}}};
...
c,d;for(b in a.attributes){d=b==="index"?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;c=a.attributes[b];c.buffer=k.createBuffer();k.bindBuffer(d,c.buffer);k.bufferData(d,c.array,k.STATIC_DRAW)}}function g(a,b,c){var d,f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){ib.copy(db);ib.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];Ra.copy(f);ib.multiplyVector3(Ra);
n[d]=[Ra.z,d]}n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[n[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[n[d][1]];m[e]=f.r;m[e+1]=f.g;m[e+2]=f.b}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.boundTo===void 0||h.boundTo==="vertices"){e=0;f=h.value.length;if(h.size===1)for(d=0;d<f;d++){g=n[d][1];h.array[d]=h.value[g]}else if(h.size===2)for(d=0;d<f;d++){g=n[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;e=e+2}else if(h.size===3)if(h.type==="c")for(d=0;d<
...
i.buffer);k.bufferData(k.ARRAY_BUFFER,i.array,b)}if(a.tangentsNeedUpdate&&d!==void 0){k.bindBuffer(k.ARRAY_BUFFER,d.buffer);k.bufferData(k.ARRAY_BUFFER,d.array,b)}if(c)for(var j in a.attributes)delete a.attributes[j].array}function i(a,b){return b.z-a.z}function j(a,b){return b[1]-a[1]}function l(a,b,c){if(a.length)for(var d=0,e=a.length;d<e;d++){ja=ea=null;V=U=Da=va=$a=Qa=Ka=-1;jb=true;a[d].render(b,c,tb,Ea);ja=ea=null;V=U=Da=va=$a=Qa=Ka=-1;jb=true}}function n(a,b,c,d,e,f,g,h){var i,k,j,l;if(b){k=
a.length-1;l=b=-1}else{k=0;b=a.length;l=1}for(var m=k;m!==b;m=m+l){i=a[m];if(i.render){k=i.object;j=i.buffer;if(h)i=h;else{i=i[c];if(!i)continue;g&&Q.setBlending(i.blending,i.blendEquation,i.blendSrc,i.blendDst);Q.setDepthTest(i.depthTest);Q.setDepthWrite(i.depthWrite);A(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits)}Q.setMaterialFaces(i);j instanceof THREE.BufferGeometry?Q.renderBufferDirect(d,e,f,i,j,k):Q.renderBuffer(d,e,f,i,j,k)}}}function m(a,b,c,d,e,f,g){for(var h,i,k=0,j=a.length;k<
...
false}function r(a,b){for(var c=a.length-1;c>=0;c--)a[c].object===b&&a.splice(c,1)}function t(a,b){for(var c=a.length-1;c>=0;c--)a[c]===b&&a.splice(c,1)}function u(a,b,c,d,e){qa=0;if(d.needsUpdate){d.program&&Q.deallocateMaterial(d);Q.initMaterial(d,b,c,e);d.needsUpdate=false}if(d.morphTargets&&!e.__webglMorphTargetInfluences)e.__webglMorphTargetInfluences=new Float32Array(Q.maxMorphTargets);var f=false,g=d.program,h=g.uniforms,i=d.uniforms;if(g!==ea){k.useProgram(g);ea=g;f=true}if(d.id!==V){V=d.id;
f=true}if(f||a!==ja){k.uniformMatrix4fv(h.projectionMatrix,false,a._projectionMatrixArray);a!==ja&&(ja=a)}if(d.skinning)if(fc&&e.useVertexTexture){if(h.boneTexture!==null){var j=v();k.uniform1i(h.boneTexture,j);Q.setTexture(e.boneTexture,j)}}else h.boneGlobalMatrices!==null&&k.uniformMatrix4fv(h.boneGlobalMatrices,false,e.boneMatrices);if(f){if(c&&d.fog){i.fogColor.value=c.color;if(c instanceof THREE.Fog){i.fogNear.value=c.near;i.fogFar.value=c.far}else if(c instanceof THREE.FogExp2)i.fogDensity.value=
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(jb){for(var l=0,m=0,n=0,o,p,q,r,s=rc,t=s.directional.colors,u=s.directional.positions,A=s.point.colors,D=s.point.positions,E=s.point.distances,B=s.spot.colors,L=s.spot.positions,K=s.spot.distances,I=s.spot.directions,F=s.spot.angles,M=s.spot.exponents,N=s.hemi.skyColors,U=s.hemi.groundColors,ha=s.hemi.positions,W=0,da=0,$=0,Z=0,c=o=q=q=p=0,f=b.length;c<f;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=
j.color;r=j.intensity;p=j.distance;if(j instanceof THREE.AmbientLight)if(Q.gammaInput){l=l+o.r*o.r;m=m+o.g*o.g;n=n+o.b*o.b}else{l=l+o.r;m=m+o.g;n=n+o.b}else if(j instanceof THREE.DirectionalLight){p=W*3;Q.gammaInput?z(t,p,o,r*r):w(t,p,o,r);Sa.copy(j.matrixWorld.getPosition());Sa.subSelf(j.target.matrixWorld.getPosition());Sa.normalize();u[p]=Sa.x;u[p+1]=Sa.y;u[p+2]=Sa.z;W=W+1}else if(j instanceof THREE.PointLight){q=da*3;Q.gammaInput?z(A,q,o,r*r):w(A,q,o,r);r=j.matrixWorld.getPosition();D[q]=r.x;
D[q+1]=r.y;D[q+2]=r.z;E[da]=p;da=da+1}else if(j instanceof THREE.SpotLight){q=$*3;Q.gammaInput?z(B,q,o,r*r):w(B,q,o,r);r=j.matrixWorld.getPosition();L[q]=r.x;L[q+1]=r.y;L[q+2]=r.z;K[$]=p;Sa.copy(r);Sa.subSelf(j.target.matrixWorld.getPosition());Sa.normalize();I[q]=Sa.x;I[q+1]=Sa.y;I[q+2]=Sa.z;F[$]=Math.cos(j.angle);M[$]=j.exponent;$=$+1}else if(j instanceof THREE.HemisphereLight){p=j.color;q=j.groundColor;o=Z*3;if(Q.gammaInput){r=r*r;z(N,o,p,r);z(U,o,q,r)}else{w(N,o,p,r);w(U,o,q,r)}r=j.matrixWorld.getPosition();
ha[o]=r.x;ha[o+1]=r.y;ha[o+2]=r.z;Z=Z+1}}}c=W*3;for(f=t.length;c<f;c++)t[c]=0;c=da*3;for(f=A.length;c<f;c++)A[c]=0;c=$*3;for(f=B.length;c<f;c++)B[c]=0;c=Z*3;for(f=N.length;c<f;c++)N[c]=0;c=Z*3;for(f=U.length;c<f;c++)U[c]=0;s.directional.length=W;s.point.length=da;s.spot.length=$;s.hemi.length=Z;s.ambient[0]=l;s.ambient[1]=m;s.ambient[2]=n;jb=false}c=rc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=
...
THREE.MeshBasicMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.MeshPhongMaterial){i.opacity.value=d.opacity;Q.gammaInput?i.diffuse.value.copyGammaToLinear(d.color):i.diffuse.value=d.color;i.map.value=d.map;i.lightMap.value=d.lightMap;i.specularMap.value=d.specularMap;if(d.bumpMap){i.bumpMap.value=d.bumpMap;i.bumpScale.value=d.bumpScale}if(d.normalMap){i.normalMap.value=d.normalMap;i.normalScale.value.copy(d.normalScale)}var ga;if(d.map)ga=d.map;else if(d.specularMap)ga=d.specularMap;
else if(d.normalMap)ga=d.normalMap;else if(d.bumpMap)ga=d.bumpMap;if(ga!==void 0){c=ga.offset;ga=ga.repeat;i.offsetRepeat.value.set(c.x,c.y,ga.x,ga.y)}i.envMap.value=d.envMap;i.flipEnvMap.value=d.envMap instanceof THREE.WebGLRenderTargetCube?1:-1;i.reflectivity.value=d.reflectivity;i.refractionRatio.value=d.refractionRatio;i.combine.value=d.combine;i.useRefract.value=d.envMap&&d.envMap.mapping instanceof THREE.CubeRefractionMapping}if(d instanceof THREE.LineBasicMaterial){i.diffuse.value=d.color;
...
i.shadowMatrix){c=ga=0;for(f=b.length;c<f;c++){j=b[c];if(j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade)){i.shadowMap.value[ga]=j.shadowMap;i.shadowMapSize.value[ga]=j.shadowMapSize;i.shadowMatrix.value[ga]=j.shadowMatrix;i.shadowDarkness.value[ga]=j.shadowDarkness;i.shadowBias.value[ga]=j.shadowBias;ga++}}}b=d.uniformsList;i=0;for(ga=b.length;i<ga;i++)if(f=g.uniforms[b[i][1]]){c=b[i][0];l=c.type;j=c.value;if(l==="i")k.uniform1i(f,j);else if(l===
"f")k.uniform1f(f,j);else if(l==="v2")k.uniform2f(f,j.x,j.y);else if(l==="v3")k.uniform3f(f,j.x,j.y,j.z);else if(l==="v4")k.uniform4f(f,j.x,j.y,j.z,j.w);else if(l==="c")k.uniform3f(f,j.r,j.g,j.b);else if(l==="iv1")k.uniform1iv(f,j);else if(l==="iv")k.uniform3iv(f,j);else if(l==="fv1")k.uniform1fv(f,j);else if(l==="fv")k.uniform3fv(f,j);else if(l==="v2v"){if(c._array===void 0)c._array=new Float32Array(2*j.length);l=0;for(m=j.length;l<m;l++){n=l*2;c._array[n]=j[l].x;c._array[n+1]=j[l].y}k.uniform2fv(f,
...
F=a.precision!==void 0?a.precision:"highp",K=a.alpha!==void 0?a.alpha:true,I=a.premultipliedAlpha!==void 0?a.premultipliedAlpha:true,M=a.antialias!==void 0?a.antialias:false,W=a.stencil!==void 0?a.stencil:true,Z=a.preserveDrawingBuffer!==void 0?a.preserveDrawingBuffer:false,da=a.clearColor!==void 0?new THREE.Color(a.clearColor):new THREE.Color(0),N=a.clearAlpha!==void 0?a.clearAlpha:0,$=a.maxLights!==void 0?a.maxLights:4;this.domElement=O;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=
...
vertices:0,faces:0,points:0}};var Q=this,ga=[],ua=0,ea=null,ha=null,V=-1,U=null,ja=null,Ja=0,qa=0,va=-1,Da=-1,Ka=-1,Za=-1,ka=-1,rb=-1,Qa=-1,$a=-1,xb=null,yb=null,hb=null,Ga=null,ya=0,sb=0,Ha=0,bb=0,tb=0,Ea=0,cb=new THREE.Frustum,db=new THREE.Matrix4,ib=new THREE.Matrix4,Ra=new THREE.Vector4,Sa=new THREE.Vector3,jb=true,rc={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],
angles:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Qb,zb;try{if(!(k=O.getContext("experimental-webgl",{alpha:K,premultipliedAlpha:I,antialias:M,stencil:W,preserveDrawingBuffer:Z})))throw"Error creating WebGL context.";}catch(Sc){console.error(Sc)}a=k.getExtension("OES_texture_float");K=k.getExtension("OES_standard_derivatives");Qb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
zb=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");a||console.log("THREE.WebGLRenderer: Float textures not supported.");K||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");Qb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");zb||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");k.clearColor(0,0,0,1);k.clearDepth(1);
k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(da.r,da.g,da.b,N);this.context=k;var Ec=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),K=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Tc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),sc=Qb?k.getParameter(Qb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):
0,jc=K>0,fc=jc&&a;zb&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};this.supportsVertexTextures=function(){return jc};this.getMaxAnisotropy=function(){return sc};this.setSize=function(a,b){O.width=a;O.height=b;this.setViewport(0,0,O.width,O.height)};this.setViewport=function(a,b,c,d){ya=a!==void 0?a:0;sb=b!==void 0?b:0;Ha=c!==void 0?c:O.width;bb=d!==void 0?d:O.height;k.viewport(ya,sb,Ha,bb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=
function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){da.setHex(a);N=b;k.clearColor(da.r,da.g,da.b,N)};this.setClearColor=function(a,b){da.copy(a);N=b;k.clearColor(da.r,da.g,da.b,N)};this.getClearColor=function(){return da};this.getClearAlpha=function(){return N};this.clear=function(a,b,c){var d=0;if(a===void 0||a)d=d|k.COLOR_BUFFER_BIT;if(b===void 0||b)d=d|k.DEPTH_BUFFER_BIT;if(c===void 0||c)d=d|k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,
...
f.__webglFaceBuffer);k.drawElements(k.TRIANGLES,f.__webglFaceCount,k.UNSIGNED_SHORT,0)}Q.info.render.calls++;Q.info.render.vertices=Q.info.render.vertices+f.__webglFaceCount;Q.info.render.faces=Q.info.render.faces+f.__webglFaceCount/3}else if(e instanceof THREE.Line){e=e.type===THREE.LineStrip?k.LINE_STRIP:k.LINES;d=d.linewidth;if(d!==Ga){k.lineWidth(d);Ga=d}k.drawArrays(e,0,f.__webglLineCount);Q.info.render.calls++}else if(e instanceof THREE.ParticleSystem){k.drawArrays(k.POINTS,0,f.__webglParticleCount);
Q.info.render.calls++;Q.info.render.points=Q.info.render.points+f.__webglParticleCount}else if(e instanceof THREE.Ribbon){k.drawArrays(k.TRIANGLE_STRIP,0,f.__webglVertexCount);Q.info.render.calls++}}};this.render=function(a,b,c,d){if(b instanceof THREE.Camera===false)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var f,e,g,h,j=a.__lights,o=a.fog;V=-1;jb=true;this.autoUpdateScene&&a.updateMatrixWorld();b.parent===void 0&&b.updateMatrixWorld();if(!b._viewMatrixArray)b._viewMatrixArray=
new Float32Array(16);if(!b._projectionMatrixArray)b._projectionMatrixArray=new Float32Array(16);b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);db.multiply(b.projectionMatrix,b.matrixWorldInverse);cb.setFromMatrix(db);this.autoUpdateObjects&&this.initWebGLObjects(a);l(this.renderPluginsPre,a,b);Q.info.render.calls=0;Q.info.render.vertices=0;Q.info.render.faces=0;Q.info.render.points=
0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;for(f=h.length;d<f;d++){e=h[d];g=e.object;e.render=false;if(g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||cb.contains(g))){s(g,b);var p=e,q=p.object,r=p.buffer,t=void 0,t=t=void 0,t=q.material;if(t instanceof THREE.MeshFaceMaterial){t=r.materialIndex;if(t>=0){t=q.geometry.materials[t];if(t.transparent){p.transparent=
t;p.opaque=null}else{p.opaque=t;p.transparent=null}}}else if(t)if(t.transparent){p.transparent=t;p.opaque=null}else{p.opaque=t;p.transparent=null}e.render=true;if(this.sortObjects===true)if(g.renderDepth!==null)e.z=g.renderDepth;else{Ra.copy(g.matrixWorld.getPosition());db.multiplyVector3(Ra);e.z=Ra.z}}}this.sortObjects&&h.sort(i);h=a.__webglObjectsImmediate;d=0;for(f=h.length;d<f;d++){e=h[d];g=e.object;if(g.visible){s(g,b);g=e.object.material;if(g.transparent){e.transparent=g;e.opaque=null}else{e.opaque=
...
this.setDepthWrite(true)}};this.renderImmediateObject=function(a,b,c,d,f){var e=u(a,b,c,d,f);U=-1;Q.setMaterialFaces(d);f.immediateRenderCallback?f.immediateRenderCallback(e,k,cb):f.render(function(a){Q.renderBufferImmediate(a,e,d)})};this.initWebGLObjects=function(a){if(!a.__webglObjects){a.__webglObjects=[];a.__webglObjectsImmediate=[];a.__webglSprites=[];a.__webglFlares=[]}for(;a.__objectsAdded.length;){var i=a.__objectsAdded[0],j=a,l=void 0,m=void 0,n=void 0;if(!i.__webglInit){i.__webglInit=true;
i._modelViewMatrix=new THREE.Matrix4;i._normalMatrix=new THREE.Matrix3;if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.Geometry){if(m.geometryGroups===void 0){var s=m,u=void 0,v=void 0,w=void 0,z=void 0,A=void 0,D=void 0,B=void 0,E={},L=s.morphTargets.length,H=s.morphNormals.length;s.geometryGroups={};u=0;for(v=s.faces.length;u<v;u++){w=s.faces[u];z=w.materialIndex;D=z!==void 0?z:-1;E[D]===void 0&&(E[D]={hash:D,counter:0});B=E[D].hash+"_"+E[D].counter;s.geometryGroups[B]===void 0&&
(s.geometryGroups[B]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:L,numMorphNormals:H});A=w instanceof THREE.Face3?3:4;if(s.geometryGroups[B].vertices+A>65535){E[D].counter=E[D].counter+1;B=E[D].hash+"_"+E[D].counter;s.geometryGroups[B]===void 0&&(s.geometryGroups[B]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:L,numMorphNormals:H})}w instanceof THREE.Face3?s.geometryGroups[B].faces3.push(u):s.geometryGroups[B].faces4.push(u);s.geometryGroups[B].vertices=s.geometryGroups[B].vertices+
A}s.geometryGroupsList=[];var J=void 0;for(J in s.geometryGroups){s.geometryGroups[J].id=Ja++;s.geometryGroupsList.push(s.geometryGroups[J])}}for(l in m.geometryGroups){n=m.geometryGroups[l];if(!n.__webglVertexBuffer){var I=n;I.__webglVertexBuffer=k.createBuffer();I.__webglNormalBuffer=k.createBuffer();I.__webglTangentBuffer=k.createBuffer();I.__webglColorBuffer=k.createBuffer();I.__webglUVBuffer=k.createBuffer();I.__webglUV2Buffer=k.createBuffer();I.__webglSkinIndicesBuffer=k.createBuffer();I.__webglSkinWeightsBuffer=
k.createBuffer();I.__webglFaceBuffer=k.createBuffer();I.__webglLineBuffer=k.createBuffer();var K=void 0,V=void 0;if(I.numMorphTargets){I.__webglMorphTargetsBuffers=[];K=0;for(V=I.numMorphTargets;K<V;K++)I.__webglMorphTargetsBuffers.push(k.createBuffer())}if(I.numMorphNormals){I.__webglMorphNormalsBuffers=[];K=0;for(V=I.numMorphNormals;K<V;K++)I.__webglMorphNormalsBuffers.push(k.createBuffer())}Q.info.memory.geometries++;var F=n,M=i,N=M.geometry,O=F.faces3,ea=F.faces4,U=O.length*3+ea.length*4,ha=O.length*
1+ea.length*2,W=O.length*3+ea.length*4,$=c(M,F),da=f($),ja=d($),ga=$.vertexColors?$.vertexColors:false;F.__vertexArray=new Float32Array(U*3);if(ja)F.__normalArray=new Float32Array(U*3);if(N.hasTangents)F.__tangentArray=new Float32Array(U*4);if(ga)F.__colorArray=new Float32Array(U*3);if(da){if(N.faceUvs.length>0||N.faceVertexUvs.length>0)F.__uvArray=new Float32Array(U*2);if(N.faceUvs.length>1||N.faceVertexUvs.length>1)F.__uv2Array=new Float32Array(U*2)}if(M.geometry.skinWeights.length&&M.geometry.skinIndices.length){F.__skinIndexArray=
new Float32Array(U*4);F.__skinWeightArray=new Float32Array(U*4)}F.__faceArray=new Uint16Array(ha*3);F.__lineArray=new Uint16Array(W*2);var Z=void 0,qa=void 0;if(F.numMorphTargets){F.__morphTargetsArrays=[];Z=0;for(qa=F.numMorphTargets;Z<qa;Z++)F.__morphTargetsArrays.push(new Float32Array(U*3))}if(F.numMorphNormals){F.__morphNormalsArrays=[];Z=0;for(qa=F.numMorphNormals;Z<qa;Z++)F.__morphNormalsArrays.push(new Float32Array(U*3))}F.__webglFaceCount=ha*3;F.__webglLineCount=W*2;if($.attributes){if(F.__webglCustomAttributesList===
void 0)F.__webglCustomAttributesList=[];var va=void 0;for(va in $.attributes){var Da=$.attributes[va],ka={},Ka;for(Ka in Da)ka[Ka]=Da[Ka];if(!ka.__webglInitialized||ka.createUniqueBuffers){ka.__webglInitialized=true;var ua=1;ka.type==="v2"?ua=2:ka.type==="v3"?ua=3:ka.type==="v4"?ua=4:ka.type==="c"&&(ua=3);ka.size=ua;ka.array=new Float32Array(U*ua);ka.buffer=k.createBuffer();ka.buffer.belongsToAttribute=va;Da.needsUpdate=true;ka.__original=Da}F.__webglCustomAttributesList.push(ka)}}F.__inittedArrays=
true;m.verticesNeedUpdate=true;m.morphTargetsNeedUpdate=true;m.elementsNeedUpdate=true;m.uvsNeedUpdate=true;m.normalsNeedUpdate=true;m.tangentsNeedUpdate=true;m.colorsNeedUpdate=true}}}else m instanceof THREE.BufferGeometry&&e(m)}else if(i instanceof THREE.Ribbon){m=i.geometry;if(!m.__webglVertexBuffer){var Ea=m;Ea.__webglVertexBuffer=k.createBuffer();Ea.__webglColorBuffer=k.createBuffer();Q.info.memory.geometries++;var ya=m,Ha=ya.vertices.length;ya.__vertexArray=new Float32Array(Ha*3);ya.__colorArray=
new Float32Array(Ha*3);ya.__webglVertexCount=Ha;m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}}else if(i instanceof THREE.Line){m=i.geometry;if(!m.__webglVertexBuffer){var Qa=m;Qa.__webglVertexBuffer=k.createBuffer();Qa.__webglColorBuffer=k.createBuffer();Q.info.memory.geometries++;var Ga=m,Ra=i,Sa=Ga.vertices.length;Ga.__vertexArray=new Float32Array(Sa*3);Ga.__colorArray=new Float32Array(Sa*3);Ga.__webglLineCount=Sa;b(Ga,Ra);m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}}else if(i instanceof
THREE.ParticleSystem){m=i.geometry;if(!m.__webglVertexBuffer)if(m instanceof THREE.Geometry){var Za=m;Za.__webglVertexBuffer=k.createBuffer();Za.__webglColorBuffer=k.createBuffer();Q.info.memory.geometries++;var $a=m,rb=i,hb=$a.vertices.length;$a.__vertexArray=new Float32Array(hb*3);$a.__colorArray=new Float32Array(hb*3);$a.__sortArray=[];$a.__webglParticleCount=hb;b($a,rb);m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}else m instanceof THREE.BufferGeometry&&e(m)}}if(!i.__webglActive){if(i instanceof
...
THREE.LensFlare&&j.__webglFlares.push(i);i.__webglActive=true}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var nb=a.__objectsRemoved[0],bb=a;nb instanceof THREE.Mesh||nb instanceof THREE.ParticleSystem||nb instanceof THREE.Ribbon||nb instanceof THREE.Line?r(bb.__webglObjects,nb):nb instanceof THREE.Sprite?t(bb.__webglSprites,nb):nb instanceof THREE.LensFlare?t(bb.__webglFlares,nb):(nb instanceof THREE.ImmediateRenderObject||nb.immediateRenderCallback)&&r(bb.__webglObjectsImmediate,
nb);nb.__webglActive=false;a.__objectsRemoved.splice(0,1)}for(var jb=0,tb=a.__webglObjects.length;jb<tb;jb++){var vb=a.__webglObjects[jb].object,fa=vb.geometry,db=void 0,cb=void 0,eb=void 0;if(vb instanceof THREE.Mesh)if(fa instanceof THREE.BufferGeometry){(fa.verticesNeedUpdate||fa.elementsNeedUpdate||fa.uvsNeedUpdate||fa.normalsNeedUpdate||fa.colorsNeedUpdate||fa.tangentsNeedUpdate)&&h(fa,k.DYNAMIC_DRAW,!fa.dynamic);fa.verticesNeedUpdate=false;fa.elementsNeedUpdate=false;fa.uvsNeedUpdate=false;
fa.normalsNeedUpdate=false;fa.colorsNeedUpdate=false;fa.tangentsNeedUpdate=false}else{for(var sb=0,xb=fa.geometryGroupsList.length;sb<xb;sb++){db=fa.geometryGroupsList[sb];eb=c(vb,db);cb=eb.attributes&&p(eb);if(fa.verticesNeedUpdate||fa.morphTargetsNeedUpdate||fa.elementsNeedUpdate||fa.uvsNeedUpdate||fa.normalsNeedUpdate||fa.colorsNeedUpdate||fa.tangentsNeedUpdate||cb){var ma=db,yb=vb,ob=k.DYNAMIC_DRAW,zb=!fa.dynamic,ib=eb;if(ma.__inittedArrays){var Qb=d(ib),fc=ib.vertexColors?ib.vertexColors:false,
jc=f(ib),Gc=Qb===THREE.SmoothShading,C=void 0,X=void 0,Yb=void 0,P=void 0,lc=void 0,Zb=void 0,wb=void 0,Hc=void 0,Rb=void 0,mc=void 0,nc=void 0,R=void 0,S=void 0,T=void 0,la=void 0,Ab=void 0,Bb=void 0,Cb=void 0,tc=void 0,Db=void 0,Eb=void 0,Fb=void 0,uc=void 0,Gb=void 0,Hb=void 0,Ib=void 0,vc=void 0,Jb=void 0,Kb=void 0,Lb=void 0,wc=void 0,Mb=void 0,Nb=void 0,Ob=void 0,xc=void 0,ra=void 0,rc=void 0,$b=void 0,oc=void 0,pc=void 0,Ta=void 0,sc=void 0,Oa=void 0,Pa=void 0,ac=void 0,Sb=void 0,Ia=0,Na=0,
Tb=0,Ub=0,pb=0,Xa=0,ta=0,ab=0,Ma=0,ba=0,ia=0,y=0,sa=void 0,Ua=ma.__vertexArray,yc=ma.__uvArray,zc=ma.__uv2Array,qb=ma.__normalArray,za=ma.__tangentArray,Va=ma.__colorArray,Aa=ma.__skinIndexArray,Ba=ma.__skinWeightArray,Vc=ma.__morphTargetsArrays,Wc=ma.__morphNormalsArrays,Xc=ma.__webglCustomAttributesList,x=void 0,Pb=ma.__faceArray,kb=ma.__lineArray,fb=yb.geometry,Ec=fb.elementsNeedUpdate,bd=fb.uvsNeedUpdate,Sc=fb.normalsNeedUpdate,Tc=fb.tangentsNeedUpdate,id=fb.colorsNeedUpdate,jd=fb.morphTargetsNeedUpdate,
hc=fb.vertices,na=ma.faces3,oa=ma.faces4,Ya=fb.faces,Yc=fb.faceVertexUvs[0],Zc=fb.faceVertexUvs[1],ic=fb.skinIndices,bc=fb.skinWeights,cc=fb.morphTargets,Ic=fb.morphNormals;if(fb.verticesNeedUpdate){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];R=hc[P.a];S=hc[P.b];T=hc[P.c];Ua[Na]=R.x;Ua[Na+1]=R.y;Ua[Na+2]=R.z;Ua[Na+3]=S.x;Ua[Na+4]=S.y;Ua[Na+5]=S.z;Ua[Na+6]=T.x;Ua[Na+7]=T.y;Ua[Na+8]=T.z;Na=Na+9}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];R=hc[P.a];S=hc[P.b];T=hc[P.c];la=hc[P.d];Ua[Na]=R.x;Ua[Na+1]=R.y;Ua[Na+
2]=R.z;Ua[Na+3]=S.x;Ua[Na+4]=S.y;Ua[Na+5]=S.z;Ua[Na+6]=T.x;Ua[Na+7]=T.y;Ua[Na+8]=T.z;Ua[Na+9]=la.x;Ua[Na+10]=la.y;Ua[Na+11]=la.z;Na=Na+12}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Ua,ob)}if(jd){Ta=0;for(sc=cc.length;Ta<sc;Ta++){C=ia=0;for(X=na.length;C<X;C++){ac=na[C];P=Ya[ac];R=cc[Ta].vertices[P.a];S=cc[Ta].vertices[P.b];T=cc[Ta].vertices[P.c];Oa=Vc[Ta];Oa[ia]=R.x;Oa[ia+1]=R.y;Oa[ia+2]=R.z;Oa[ia+3]=S.x;Oa[ia+4]=S.y;Oa[ia+5]=S.z;Oa[ia+6]=T.x;Oa[ia+7]=T.y;Oa[ia+
8]=T.z;if(ib.morphNormals){if(Gc){Sb=Ic[Ta].vertexNormals[ac];Db=Sb.a;Eb=Sb.b;Fb=Sb.c}else Fb=Eb=Db=Ic[Ta].faceNormals[ac];Pa=Wc[Ta];Pa[ia]=Db.x;Pa[ia+1]=Db.y;Pa[ia+2]=Db.z;Pa[ia+3]=Eb.x;Pa[ia+4]=Eb.y;Pa[ia+5]=Eb.z;Pa[ia+6]=Fb.x;Pa[ia+7]=Fb.y;Pa[ia+8]=Fb.z}ia=ia+9}C=0;for(X=oa.length;C<X;C++){ac=oa[C];P=Ya[ac];R=cc[Ta].vertices[P.a];S=cc[Ta].vertices[P.b];T=cc[Ta].vertices[P.c];la=cc[Ta].vertices[P.d];Oa=Vc[Ta];Oa[ia]=R.x;Oa[ia+1]=R.y;Oa[ia+2]=R.z;Oa[ia+3]=S.x;Oa[ia+4]=S.y;Oa[ia+5]=S.z;Oa[ia+6]=T.x;
Oa[ia+7]=T.y;Oa[ia+8]=T.z;Oa[ia+9]=la.x;Oa[ia+10]=la.y;Oa[ia+11]=la.z;if(ib.morphNormals){if(Gc){Sb=Ic[Ta].vertexNormals[ac];Db=Sb.a;Eb=Sb.b;Fb=Sb.c;uc=Sb.d}else uc=Fb=Eb=Db=Ic[Ta].faceNormals[ac];Pa=Wc[Ta];Pa[ia]=Db.x;Pa[ia+1]=Db.y;Pa[ia+2]=Db.z;Pa[ia+3]=Eb.x;Pa[ia+4]=Eb.y;Pa[ia+5]=Eb.z;Pa[ia+6]=Fb.x;Pa[ia+7]=Fb.y;Pa[ia+8]=Fb.z;Pa[ia+9]=uc.x;Pa[ia+10]=uc.y;Pa[ia+11]=uc.z}ia=ia+12}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglMorphTargetsBuffers[Ta]);k.bufferData(k.ARRAY_BUFFER,Vc[Ta],ob);if(ib.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,
ma.__webglMorphNormalsBuffers[Ta]);k.bufferData(k.ARRAY_BUFFER,Wc[Ta],ob)}}}if(bc.length){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];Jb=bc[P.a];Kb=bc[P.b];Lb=bc[P.c];Ba[ba]=Jb.x;Ba[ba+1]=Jb.y;Ba[ba+2]=Jb.z;Ba[ba+3]=Jb.w;Ba[ba+4]=Kb.x;Ba[ba+5]=Kb.y;Ba[ba+6]=Kb.z;Ba[ba+7]=Kb.w;Ba[ba+8]=Lb.x;Ba[ba+9]=Lb.y;Ba[ba+10]=Lb.z;Ba[ba+11]=Lb.w;Mb=ic[P.a];Nb=ic[P.b];Ob=ic[P.c];Aa[ba]=Mb.x;Aa[ba+1]=Mb.y;Aa[ba+2]=Mb.z;Aa[ba+3]=Mb.w;Aa[ba+4]=Nb.x;Aa[ba+5]=Nb.y;Aa[ba+6]=Nb.z;Aa[ba+7]=Nb.w;Aa[ba+8]=Ob.x;Aa[ba+9]=Ob.y;
Aa[ba+10]=Ob.z;Aa[ba+11]=Ob.w;ba=ba+12}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];Jb=bc[P.a];Kb=bc[P.b];Lb=bc[P.c];wc=bc[P.d];Ba[ba]=Jb.x;Ba[ba+1]=Jb.y;Ba[ba+2]=Jb.z;Ba[ba+3]=Jb.w;Ba[ba+4]=Kb.x;Ba[ba+5]=Kb.y;Ba[ba+6]=Kb.z;Ba[ba+7]=Kb.w;Ba[ba+8]=Lb.x;Ba[ba+9]=Lb.y;Ba[ba+10]=Lb.z;Ba[ba+11]=Lb.w;Ba[ba+12]=wc.x;Ba[ba+13]=wc.y;Ba[ba+14]=wc.z;Ba[ba+15]=wc.w;Mb=ic[P.a];Nb=ic[P.b];Ob=ic[P.c];xc=ic[P.d];Aa[ba]=Mb.x;Aa[ba+1]=Mb.y;Aa[ba+2]=Mb.z;Aa[ba+3]=Mb.w;Aa[ba+4]=Nb.x;Aa[ba+5]=Nb.y;Aa[ba+6]=Nb.z;Aa[ba+7]=
Nb.w;Aa[ba+8]=Ob.x;Aa[ba+9]=Ob.y;Aa[ba+10]=Ob.z;Aa[ba+11]=Ob.w;Aa[ba+12]=xc.x;Aa[ba+13]=xc.y;Aa[ba+14]=xc.z;Aa[ba+15]=xc.w;ba=ba+16}if(ba>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglSkinIndicesBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,ob);k.bindBuffer(k.ARRAY_BUFFER,ma.__webglSkinWeightsBuffer);k.bufferData(k.ARRAY_BUFFER,Ba,ob)}}if(id&&fc){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];wb=P.vertexColors;Hc=P.color;if(wb.length===3&&fc===THREE.VertexColors){Gb=wb[0];Hb=wb[1];Ib=wb[2]}else Ib=Hb=Gb=Hc;Va[Ma]=
Gb.r;Va[Ma+1]=Gb.g;Va[Ma+2]=Gb.b;Va[Ma+3]=Hb.r;Va[Ma+4]=Hb.g;Va[Ma+5]=Hb.b;Va[Ma+6]=Ib.r;Va[Ma+7]=Ib.g;Va[Ma+8]=Ib.b;Ma=Ma+9}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];wb=P.vertexColors;Hc=P.color;if(wb.length===4&&fc===THREE.VertexColors){Gb=wb[0];Hb=wb[1];Ib=wb[2];vc=wb[3]}else vc=Ib=Hb=Gb=Hc;Va[Ma]=Gb.r;Va[Ma+1]=Gb.g;Va[Ma+2]=Gb.b;Va[Ma+3]=Hb.r;Va[Ma+4]=Hb.g;Va[Ma+5]=Hb.b;Va[Ma+6]=Ib.r;Va[Ma+7]=Ib.g;Va[Ma+8]=Ib.b;Va[Ma+9]=vc.r;Va[Ma+10]=vc.g;Va[Ma+11]=vc.b;Ma=Ma+12}if(Ma>0){k.bindBuffer(k.ARRAY_BUFFER,
ma.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Va,ob)}}if(Tc&&fb.hasTangents){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];Rb=P.vertexTangents;Ab=Rb[0];Bb=Rb[1];Cb=Rb[2];za[ta]=Ab.x;za[ta+1]=Ab.y;za[ta+2]=Ab.z;za[ta+3]=Ab.w;za[ta+4]=Bb.x;za[ta+5]=Bb.y;za[ta+6]=Bb.z;za[ta+7]=Bb.w;za[ta+8]=Cb.x;za[ta+9]=Cb.y;za[ta+10]=Cb.z;za[ta+11]=Cb.w;ta=ta+12}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];Rb=P.vertexTangents;Ab=Rb[0];Bb=Rb[1];Cb=Rb[2];tc=Rb[3];za[ta]=Ab.x;za[ta+1]=Ab.y;za[ta+2]=Ab.z;za[ta+3]=Ab.w;za[ta+
4]=Bb.x;za[ta+5]=Bb.y;za[ta+6]=Bb.z;za[ta+7]=Bb.w;za[ta+8]=Cb.x;za[ta+9]=Cb.y;za[ta+10]=Cb.z;za[ta+11]=Cb.w;za[ta+12]=tc.x;za[ta+13]=tc.y;za[ta+14]=tc.z;za[ta+15]=tc.w;ta=ta+16}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,za,ob)}if(Sc&&Qb){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];lc=P.vertexNormals;Zb=P.normal;if(lc.length===3&&Gc)for(ra=0;ra<3;ra++){$b=lc[ra];qb[Xa]=$b.x;qb[Xa+1]=$b.y;qb[Xa+2]=$b.z;Xa=Xa+3}else for(ra=0;ra<3;ra++){qb[Xa]=Zb.x;qb[Xa+1]=Zb.y;qb[Xa+
2]=Zb.z;Xa=Xa+3}}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];lc=P.vertexNormals;Zb=P.normal;if(lc.length===4&&Gc)for(ra=0;ra<4;ra++){$b=lc[ra];qb[Xa]=$b.x;qb[Xa+1]=$b.y;qb[Xa+2]=$b.z;Xa=Xa+3}else for(ra=0;ra<4;ra++){qb[Xa]=Zb.x;qb[Xa+1]=Zb.y;qb[Xa+2]=Zb.z;Xa=Xa+3}}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,qb,ob)}if(bd&&Yc&&jc){C=0;for(X=na.length;C<X;C++){Yb=na[C];mc=Yc[Yb];if(mc!==void 0)for(ra=0;ra<3;ra++){oc=mc[ra];yc[Tb]=oc.u;yc[Tb+1]=oc.v;Tb=Tb+2}}C=0;for(X=
oa.length;C<X;C++){Yb=oa[C];mc=Yc[Yb];if(mc!==void 0)for(ra=0;ra<4;ra++){oc=mc[ra];yc[Tb]=oc.u;yc[Tb+1]=oc.v;Tb=Tb+2}}if(Tb>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglUVBuffer);k.bufferData(k.ARRAY_BUFFER,yc,ob)}}if(bd&&Zc&&jc){C=0;for(X=na.length;C<X;C++){Yb=na[C];nc=Zc[Yb];if(nc!==void 0)for(ra=0;ra<3;ra++){pc=nc[ra];zc[Ub]=pc.u;zc[Ub+1]=pc.v;Ub=Ub+2}}C=0;for(X=oa.length;C<X;C++){Yb=oa[C];nc=Zc[Yb];if(nc!==void 0)for(ra=0;ra<4;ra++){pc=nc[ra];zc[Ub]=pc.u;zc[Ub+1]=pc.v;Ub=Ub+2}}if(Ub>0){k.bindBuffer(k.ARRAY_BUFFER,
ma.__webglUV2Buffer);k.bufferData(k.ARRAY_BUFFER,zc,ob)}}if(Ec){C=0;for(X=na.length;C<X;C++){Pb[pb]=Ia;Pb[pb+1]=Ia+1;Pb[pb+2]=Ia+2;pb=pb+3;kb[ab]=Ia;kb[ab+1]=Ia+1;kb[ab+2]=Ia;kb[ab+3]=Ia+2;kb[ab+4]=Ia+1;kb[ab+5]=Ia+2;ab=ab+6;Ia=Ia+3}C=0;for(X=oa.length;C<X;C++){Pb[pb]=Ia;Pb[pb+1]=Ia+1;Pb[pb+2]=Ia+3;Pb[pb+3]=Ia+1;Pb[pb+4]=Ia+2;Pb[pb+5]=Ia+3;pb=pb+6;kb[ab]=Ia;kb[ab+1]=Ia+1;kb[ab+2]=Ia;kb[ab+3]=Ia+3;kb[ab+4]=Ia+1;kb[ab+5]=Ia+2;kb[ab+6]=Ia+2;kb[ab+7]=Ia+3;ab=ab+8;Ia=Ia+4}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,
ma.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Pb,ob);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ma.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,kb,ob)}if(Xc){ra=0;for(rc=Xc.length;ra<rc;ra++){x=Xc[ra];if(x.__original.needsUpdate){y=0;if(x.size===1)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];x.array[y]=x.value[P.a];x.array[y+1]=x.value[P.b];x.array[y+2]=x.value[P.c];y=y+3}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];x.array[y]=x.value[P.a];x.array[y+
1]=x.value[P.b];x.array[y+2]=x.value[P.c];x.array[y+3]=x.value[P.d];y=y+4}}else{if(x.boundTo==="faces"){C=0;for(X=na.length;C<X;C++){sa=x.value[na[C]];x.array[y]=sa;x.array[y+1]=sa;x.array[y+2]=sa;y=y+3}C=0;for(X=oa.length;C<X;C++){sa=x.value[oa[C]];x.array[y]=sa;x.array[y+1]=sa;x.array[y+2]=sa;x.array[y+3]=sa;y=y+4}}}else if(x.size===2)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];x.array[y]=R.x;x.array[y+1]=R.y;
x.array[y+2]=S.x;x.array[y+3]=S.y;x.array[y+4]=T.x;x.array[y+5]=T.y;y=y+6}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];la=x.value[P.d];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=S.x;x.array[y+3]=S.y;x.array[y+4]=T.x;x.array[y+5]=T.y;x.array[y+6]=la.x;x.array[y+7]=la.y;y=y+8}}else{if(x.boundTo==="faces"){C=0;for(X=na.length;C<X;C++){T=S=R=sa=x.value[na[C]];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=S.x;x.array[y+3]=S.y;x.array[y+4]=T.x;x.array[y+5]=T.y;
y=y+6}C=0;for(X=oa.length;C<X;C++){la=T=S=R=sa=x.value[oa[C]];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=S.x;x.array[y+3]=S.y;x.array[y+4]=T.x;x.array[y+5]=T.y;x.array[y+6]=la.x;x.array[y+7]=la.y;y=y+8}}}else if(x.size===3){var aa;aa=x.type==="c"?["r","g","b"]:["x","y","z"];if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];x.array[y]=R[aa[0]];x.array[y+1]=R[aa[1]];x.array[y+2]=R[aa[2]];x.array[y+3]=S[aa[0]];x.array[y+
4]=S[aa[1]];x.array[y+5]=S[aa[2]];x.array[y+6]=T[aa[0]];x.array[y+7]=T[aa[1]];x.array[y+8]=T[aa[2]];y=y+9}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];la=x.value[P.d];x.array[y]=R[aa[0]];x.array[y+1]=R[aa[1]];x.array[y+2]=R[aa[2]];x.array[y+3]=S[aa[0]];x.array[y+4]=S[aa[1]];x.array[y+5]=S[aa[2]];x.array[y+6]=T[aa[0]];x.array[y+7]=T[aa[1]];x.array[y+8]=T[aa[2]];x.array[y+9]=la[aa[0]];x.array[y+10]=la[aa[1]];x.array[y+11]=la[aa[2]];y=y+12}}else if(x.boundTo===
"faces"){C=0;for(X=na.length;C<X;C++){T=S=R=sa=x.value[na[C]];x.array[y]=R[aa[0]];x.array[y+1]=R[aa[1]];x.array[y+2]=R[aa[2]];x.array[y+3]=S[aa[0]];x.array[y+4]=S[aa[1]];x.array[y+5]=S[aa[2]];x.array[y+6]=T[aa[0]];x.array[y+7]=T[aa[1]];x.array[y+8]=T[aa[2]];y=y+9}C=0;for(X=oa.length;C<X;C++){la=T=S=R=sa=x.value[oa[C]];x.array[y]=R[aa[0]];x.array[y+1]=R[aa[1]];x.array[y+2]=R[aa[2]];x.array[y+3]=S[aa[0]];x.array[y+4]=S[aa[1]];x.array[y+5]=S[aa[2]];x.array[y+6]=T[aa[0]];x.array[y+7]=T[aa[1]];x.array[y+
8]=T[aa[2]];x.array[y+9]=la[aa[0]];x.array[y+10]=la[aa[1]];x.array[y+11]=la[aa[2]];y=y+12}}else if(x.boundTo==="faceVertices"){C=0;for(X=na.length;C<X;C++){sa=x.value[na[C]];R=sa[0];S=sa[1];T=sa[2];x.array[y]=R[aa[0]];x.array[y+1]=R[aa[1]];x.array[y+2]=R[aa[2]];x.array[y+3]=S[aa[0]];x.array[y+4]=S[aa[1]];x.array[y+5]=S[aa[2]];x.array[y+6]=T[aa[0]];x.array[y+7]=T[aa[1]];x.array[y+8]=T[aa[2]];y=y+9}C=0;for(X=oa.length;C<X;C++){sa=x.value[oa[C]];R=sa[0];S=sa[1];T=sa[2];la=sa[3];x.array[y]=R[aa[0]];x.array[y+
1]=R[aa[1]];x.array[y+2]=R[aa[2]];x.array[y+3]=S[aa[0]];x.array[y+4]=S[aa[1]];x.array[y+5]=S[aa[2]];x.array[y+6]=T[aa[0]];x.array[y+7]=T[aa[1]];x.array[y+8]=T[aa[2]];x.array[y+9]=la[aa[0]];x.array[y+10]=la[aa[1]];x.array[y+11]=la[aa[2]];y=y+12}}}else if(x.size===4)if(x.boundTo===void 0||x.boundTo==="vertices"){C=0;for(X=na.length;C<X;C++){P=Ya[na[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+
6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;y=y+12}C=0;for(X=oa.length;C<X;C++){P=Ya[oa[C]];R=x.value[P.a];S=x.value[P.b];T=x.value[P.c];la=x.value[P.d];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;x.array[y+12]=la.x;x.array[y+13]=la.y;x.array[y+14]=la.z;x.array[y+15]=la.w;y=y+16}}else if(x.boundTo===
"faces"){C=0;for(X=na.length;C<X;C++){T=S=R=sa=x.value[na[C]];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;y=y+12}C=0;for(X=oa.length;C<X;C++){la=T=S=R=sa=x.value[oa[C]];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+
10]=T.z;x.array[y+11]=T.w;x.array[y+12]=la.x;x.array[y+13]=la.y;x.array[y+14]=la.z;x.array[y+15]=la.w;y=y+16}}else if(x.boundTo==="faceVertices"){C=0;for(X=na.length;C<X;C++){sa=x.value[na[C]];R=sa[0];S=sa[1];T=sa[2];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;y=y+12}C=0;for(X=oa.length;C<X;C++){sa=x.value[oa[C]];R=sa[0];S=sa[1];T=sa[2];la=
sa[3];x.array[y]=R.x;x.array[y+1]=R.y;x.array[y+2]=R.z;x.array[y+3]=R.w;x.array[y+4]=S.x;x.array[y+5]=S.y;x.array[y+6]=S.z;x.array[y+7]=S.w;x.array[y+8]=T.x;x.array[y+9]=T.y;x.array[y+10]=T.z;x.array[y+11]=T.w;x.array[y+12]=la.x;x.array[y+13]=la.y;x.array[y+14]=la.z;x.array[y+15]=la.w;y=y+16}}k.bindBuffer(k.ARRAY_BUFFER,x.buffer);k.bufferData(k.ARRAY_BUFFER,x.array,ob)}}}if(zb){delete ma.__inittedArrays;delete ma.__colorArray;delete ma.__normalArray;delete ma.__tangentArray;delete ma.__uvArray;delete ma.__uv2Array;
delete ma.__faceArray;delete ma.__vertexArray;delete ma.__lineArray;delete ma.__skinIndexArray;delete ma.__skinWeightArray}}}}fa.verticesNeedUpdate=false;fa.morphTargetsNeedUpdate=false;fa.elementsNeedUpdate=false;fa.uvsNeedUpdate=false;fa.normalsNeedUpdate=false;fa.colorsNeedUpdate=false;fa.tangentsNeedUpdate=false;eb.attributes&&o(eb)}else if(vb instanceof THREE.Ribbon){if(fa.verticesNeedUpdate||fa.colorsNeedUpdate){var dc=fa,cd=k.DYNAMIC_DRAW,Ac=void 0,Bc=void 0,Jc=void 0,ec=void 0,Kc=void 0,dd=
dc.vertices,ed=dc.colors,kd=dd.length,ld=ed.length,Lc=dc.__vertexArray,Mc=dc.__colorArray,md=dc.colorsNeedUpdate;if(dc.verticesNeedUpdate){for(Ac=0;Ac<kd;Ac++){Jc=dd[Ac];ec=Ac*3;Lc[ec]=Jc.x;Lc[ec+1]=Jc.y;Lc[ec+2]=Jc.z}k.bindBuffer(k.ARRAY_BUFFER,dc.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Lc,cd)}if(md){for(Bc=0;Bc<ld;Bc++){Kc=ed[Bc];ec=Bc*3;Mc[ec]=Kc.r;Mc[ec+1]=Kc.g;Mc[ec+2]=Kc.b}k.bindBuffer(k.ARRAY_BUFFER,dc.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Mc,cd)}}fa.verticesNeedUpdate=false;
fa.colorsNeedUpdate=false}else if(vb instanceof THREE.Line){eb=c(vb,db);cb=eb.attributes&&p(eb);if(fa.verticesNeedUpdate||fa.colorsNeedUpdate||cb){var Vb=fa,$c=k.DYNAMIC_DRAW,Cc=void 0,Dc=void 0,Nc=void 0,Ca=void 0,Oc=void 0,fd=Vb.vertices,gd=Vb.colors,nd=fd.length,od=gd.length,Pc=Vb.__vertexArray,Qc=Vb.__colorArray,pd=Vb.colorsNeedUpdate,ad=Vb.__webglCustomAttributesList,Rc=void 0,hd=void 0,Wa=void 0,qc=void 0,gb=void 0,xa=void 0;if(Vb.verticesNeedUpdate){for(Cc=0;Cc<nd;Cc++){Nc=fd[Cc];Ca=Cc*3;Pc[Ca]=
Nc.x;Pc[Ca+1]=Nc.y;Pc[Ca+2]=Nc.z}k.bindBuffer(k.ARRAY_BUFFER,Vb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Pc,$c)}if(pd){for(Dc=0;Dc<od;Dc++){Oc=gd[Dc];Ca=Dc*3;Qc[Ca]=Oc.r;Qc[Ca+1]=Oc.g;Qc[Ca+2]=Oc.b}k.bindBuffer(k.ARRAY_BUFFER,Vb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Qc,$c)}if(ad){Rc=0;for(hd=ad.length;Rc<hd;Rc++){xa=ad[Rc];if(xa.needsUpdate&&(xa.boundTo===void 0||xa.boundTo==="vertices")){Ca=0;qc=xa.value.length;if(xa.size===1)for(Wa=0;Wa<qc;Wa++)xa.array[Wa]=xa.value[Wa];else if(xa.size===
...
v+j;if(s[w]>=0){k.enableVertexAttribArray(s[w]);a.numSupportedMorphNormals++}}}a.uniformsList=[];for(i in a.uniforms)a.uniformsList.push([a.uniforms[i],i])};this.setFaceCulling=function(a,b){if(a){!b||b==="ccw"?k.frontFace(k.CCW):k.frontFace(k.CW);a==="back"?k.cullFace(k.BACK):a==="front"?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK);k.enable(k.CULL_FACE)}else k.disable(k.CULL_FACE)};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,a=a.side===THREE.BackSide;if(va!==b){b?k.disable(k.CULL_FACE):
k.enable(k.CULL_FACE);va=b}if(Da!==a){a?k.frontFace(k.CW):k.frontFace(k.CCW);Da=a}};this.setDepthTest=function(a){if(Qa!==a){a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST);Qa=a}};this.setDepthWrite=function(a){if($a!==a){k.depthMask(a);$a=a}};this.setBlending=function(a,b,c,d){if(a!==Ka){if(a===THREE.NoBlending)k.disable(k.BLEND);else if(a===THREE.AdditiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE)}else if(a===THREE.SubtractiveBlending){k.enable(k.BLEND);
k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)}else if(a===THREE.MultiplyBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.SRC_COLOR)}else if(a===THREE.CustomBlending)k.enable(k.BLEND);else{k.enable(k.BLEND);k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD);k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)}Ka=a}if(a===THREE.CustomBlending){if(b!==Za){k.blendEquation(J(b));Za=b}if(c!==ka||d!==rb){k.blendFunc(J(c),J(d));
ka=c;rb=d}}else rb=ka=Za=null};this.setTexture=function(a,b){if(a.needsUpdate){if(!a.__webglInit){a.__webglInit=true;a.__webglTexture=k.createTexture();Q.info.memory.textures++}k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=(c.width&c.width-1)===0&&(c.height&c.height-1)===0,f=J(a.format),e=J(a.type);H(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var e=
...
if(a&&!a.__webglFramebuffer){if(a.depthBuffer===void 0)a.depthBuffer=true;if(a.stencilBuffer===void 0)a.stencilBuffer=true;a.__webglTexture=k.createTexture();var c=(a.width&a.width-1)===0&&(a.height&a.height-1)===0,d=J(a.format),f=J(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);H(k.TEXTURE_CUBE_MAP,a,c);for(var e=0;e<6;e++){a.__webglFramebuffer[e]=k.createFramebuffer();a.__webglRenderbuffer[e]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+
e,0,d,a.width,a.height,0,d,f,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+e;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[e]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);B(a.__webglRenderbuffer[e],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);H(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,f,null);d=
k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);B(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;f=d=0}else{b=null;c=Ha;a=bb;d=ya;f=sb}if(b!==ha){k.bindFramebuffer(k.FRAMEBUFFER,
b);k.viewport(d,f,c,a);ha=b}tb=c;Ea=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
(function(a){var b=function(a){for(var b=a.length,f=0,e=b-1,g=0;g<b;e=g++)f=f+(a[e].x*a[g].y-a[g].x*a[e].y);return f*0.5};a.Triangulate=function(a,d){var f=a.length;if(f<3)return null;var e=[],g=[],h=[],i,j,l;if(b(a)>0)for(j=0;j<f;j++)g[j]=j;else for(j=0;j<f;j++)g[j]=f-1-j;var n=2*f;for(j=f-1;f>2;){if(n--<=0){console.log("Warning, unable to triangulate polygon!");break}i=j;f<=i&&(i=0);j=i+1;f<=j&&(j=0);l=j+1;f<=l&&(l=0);var m;a:{m=a;var q=i,p=j,o=l,r=f,t=g,u=void 0,v=void 0,s=void 0,z=void 0,w=void 0,
A=void 0,L=void 0,D=void 0,H=void 0,v=m[t[q]].x,s=m[t[q]].y,z=m[t[p]].x,w=m[t[p]].y,A=m[t[o]].x,L=m[t[o]].y;if(1E-10>(z-v)*(L-s)-(w-s)*(A-v))m=false;else{for(u=0;u<r;u++)if(!(u==q||u==p||u==o)){var D=m[t[u]].x,H=m[t[u]].y,B=void 0,E=void 0,J=void 0,O=void 0,F=void 0,K=void 0,I=void 0,M=void 0,W=void 0,Z=void 0,da=void 0,N=void 0,B=J=F=void 0,B=A-z,E=L-w,J=v-A,O=s-L,F=z-v,K=w-s,I=D-v,M=H-s,W=D-z,Z=H-w,da=D-A,N=H-L,B=B*Z-E*W,F=F*M-K*I,J=J*N-O*da;if(B>=0&&J>=0&&F>=0){m=false;break a}}m=true}}if(m){e.push([a[g[i]],
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function i(a,b,c,g,h,i,l,m){var n,o=d||1,p=f||1,q=h/2,r=i/2,t=j.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=e||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=e||1}var u=o+1,v=p+1,Z=h/o,da=i/p,N=new THREE.Vector3;N[n]=l>0?1:-1;for(h=0;h<v;h++)for(i=0;i<u;i++){var $=new THREE.Vector3;$[a]=(i*Z-q)*c;$[b]=(h*da-r)*g;$[n]=l;j.vertices.push($)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
u*h+t,i+u*(h+1)+t,i+1+u*(h+1)+t,i+1+u*h+t);a.normal.copy(N);a.vertexNormals.push(N.clone(),N.clone(),N.clone(),N.clone());a.materialIndex=m;j.faces.push(a);j.faceVertexUvs[0].push([new THREE.UV(i/o,1-h/p),new THREE.UV(i/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-h/p)])}}THREE.Geometry.call(this);var j=this,l=a/2,n=b/2,m=c/2,q,p,o,r,t,u;if(g!==void 0){if(g instanceof Array)this.materials=g;else{this.materials=[];for(q=0;q<6;q++)this.materials.push(g)}q=0;r=1;p=2;t=3;o=4;u=
...
this.vertices[j[0][h+1]].clone()}else{n=this.vertices[j[1][h]].clone();m=this.vertices[j[1][h+1]].clone()}n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<f;i++){var q=j[i][h],p=j[i+1][h],o=j[i+1][h+1],r=j[i][h+1],t=n.clone(),u=n.clone(),v=m.clone(),s=m.clone(),z=l[i][h].clone(),w=l[i+1][h].clone(),A=l[i+1][h+1].clone(),L=l[i][h+1].clone();this.faces.push(new THREE.Face4(q,p,o,r,[t,u,v,s]));this.faceVertexUvs[0].push([z,w,A,L])}}if(!e&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){q=j[0][h];p=j[0][h+1];o=this.vertices.length-1;t=new THREE.Vector3(0,1,0);u=new THREE.Vector3(0,1,0);v=new THREE.Vector3(0,1,0);z=l[0][h].clone();w=l[0][h+1].clone();A=new THREE.UV(w.u,0);this.faces.push(new THREE.Face3(q,p,o,[t,u,v]));this.faceVertexUvs[0].push([z,w,A])}}if(!e&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){q=j[i][h+1];p=j[i][h];o=this.vertices.length-1;t=new THREE.Vector3(0,-1,0);u=new THREE.Vector3(0,
-1,0);v=new THREE.Vector3(0,-1,0);z=l[i][h+1].clone();w=l[i][h].clone();A=new THREE.UV(w.u,1);this.faces.push(new THREE.Face3(q,p,o,[t,u,v]));this.faceVertexUvs[0].push([z,w,A])}}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
c.length-1);for(var g=0,h=m+l*2,g=0;g<h;g++){var i=W*g,j=W*(g+1),n=d+e+i,i=d+f+i,o=d+f+j,j=d+e+j,p=c,q=g,r=h,s=e,v=f,n=n+B,i=i+B,o=o+B,j=j+B;H.faces.push(new THREE.Face4(n,i,o,j,null,null,t));n=u.generateSideWallUV(H,a,p,b,n,i,o,j,q,r,s,v);H.faceVertexUvs[0].push(n)}}}function e(a,b,c){H.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+B;d=d+B;e=e+B;H.faces.push(new THREE.Face3(c,d,e,null,null,r));c=f?u.generateBottomUV(H,a,b,c,d,e):u.generateTopUV(H,a,b,c,d,e);H.faceVertexUvs[0].push(c)}
var h=b.amount!==void 0?b.amount:100,i=b.bevelThickness!==void 0?b.bevelThickness:6,j=b.bevelSize!==void 0?b.bevelSize:i-2,l=b.bevelSegments!==void 0?b.bevelSegments:3,n=b.bevelEnabled!==void 0?b.bevelEnabled:true,m=b.steps!==void 0?b.steps:1,q=b.extrudePath,p,o=false,r=b.material,t=b.extrudeMaterial,u=b.UVGenerator!==void 0?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,v,s,z,w;if(q){p=q.getSpacedPoints(m);o=true;n=false;v=b.frames!==void 0?b.frames:new THREE.TubeGeometry.FrenetFrames(q,m,
false);s=new THREE.Vector3;z=new THREE.Vector3;w=new THREE.Vector3}if(!n)j=i=l=0;var A,L,D,H=this,B=this.vertices.length,q=a.extractPoints(),E=q.shape,q=q.holes,J=!THREE.Shape.Utils.isClockWise(E);if(J){E=E.reverse();L=0;for(D=q.length;L<D;L++){A=q[L];THREE.Shape.Utils.isClockWise(A)&&(q[L]=A.reverse())}J=false}var O=THREE.Shape.Utils.triangulateShape(E,q),J=E;L=0;for(D=q.length;L<D;L++){A=q[L];E=E.concat(A)}var F,K,I,M,W=E.length,Z=O.length,da=[],N=0,$=J.length;F=$-1;for(K=N+1;N<$;N++,F++,K++){F===
$&&(F=0);K===$&&(K=0);da[N]=d(J[N],J[F],J[K])}var Q=[],ga,ua=da.concat();L=0;for(D=q.length;L<D;L++){A=q[L];ga=[];N=0;$=A.length;F=$-1;for(K=N+1;N<$;N++,F++,K++){F===$&&(F=0);K===$&&(K=0);ga[N]=d(A[N],A[F],A[K])}Q.push(ga);ua=ua.concat(ga)}for(F=0;F<l;F++){A=F/l;I=i*(1-A);K=j*Math.sin(A*Math.PI/2);N=0;for($=J.length;N<$;N++){M=c(J[N],da[N],K);e(M.x,M.y,-I)}L=0;for(D=q.length;L<D;L++){A=q[L];ga=Q[L];N=0;for($=A.length;N<$;N++){M=c(A[N],ga[N],K);e(M.x,M.y,-I)}}}K=j;for(N=0;N<W;N++){M=n?c(E[N],ua[N],
K):E[N];if(o){z.copy(v.normals[0]).multiplyScalar(M.x);s.copy(v.binormals[0]).multiplyScalar(M.y);w.copy(p[0]).addSelf(z).addSelf(s);e(w.x,w.y,w.z)}else e(M.x,M.y,0)}for(A=1;A<=m;A++)for(N=0;N<W;N++){M=n?c(E[N],ua[N],K):E[N];if(o){z.copy(v.normals[A]).multiplyScalar(M.x);s.copy(v.binormals[A]).multiplyScalar(M.y);w.copy(p[A]).addSelf(z).addSelf(s);e(w.x,w.y,w.z)}else e(M.x,M.y,h/m*A)}for(F=l-1;F>=0;F--){A=F/l;I=i*(1-A);K=j*Math.sin(A*Math.PI/2);N=0;for($=J.length;N<$;N++){M=c(J[N],da[N],K);e(M.x,
M.y,h+I)}L=0;for(D=q.length;L<D;L++){A=q[L];ga=Q[L];N=0;for($=A.length;N<$;N++){M=c(A[N],ga[N],K);o?e(M.x,M.y+p[m-1].y,p[m-1].x+I):e(M.x,M.y,h+I)}}}if(n){i=W*0;for(N=0;N<Z;N++){h=O[N];g(h[2]+i,h[1]+i,h[0]+i,true)}i=W*(m+l*2);for(N=0;N<Z;N++){h=O[N];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(N=0;N<Z;N++){h=O[N];g(h[2],h[1],h[0],true)}for(N=0;N<Z;N++){h=O[N];g(h[0]+W*m,h[1]+W*m,h[2]+W*m,false)}}h=0;f(J,h);h=h+J.length;L=0;for(D=q.length;L<D;L++){A=q[L];f(A,h);h=h+A.length}};
...
c,"key",e,t[e]):t[e]=c}var h=[],i=[],j=[],l=this,n=a.vertices,m=a.faces,q=n.length,h=n.concat(),p=[],o={},r={},t={},u,v,s,z,w,A=a.faceVertexUvs[0],L;c("originalFaces, uvs, originalVerticesLength",m.length,A.length,q);if(l.supportUVs){u=0;for(v=A.length;u<v;u++){s=0;for(z=A[u].length;s<z;s++){L=m[u]["abcd".charAt(s)];g(L,u,A[u][s])}}}if(A.length==0)l.supportUVs=false;u=0;for(var D in t)u++;if(!u){l.supportUVs=false;c("no uvs")}u=0;for(v=m.length;u<v;u++){w=m[u];p.push(w.centroid);h.push(w.centroid);
if(l.supportUVs){z=new THREE.UV;if(w instanceof THREE.Face3){z.u=e(w.a,u).u+e(w.b,u).u+e(w.c,u).u;z.v=e(w.a,u).v+e(w.b,u).v+e(w.c,u).v;z.u=z.u/3;z.v=z.v/3}else if(w instanceof THREE.Face4){z.u=e(w.a,u).u+e(w.b,u).u+e(w.c,u).u+e(w.d,u).u;z.v=e(w.a,u).v+e(w.b,u).v+e(w.c,u).v+e(w.d,u).v;z.u=z.u/4;z.v=z.v/4}g(q+u,"",z)}}D=G.computeEdgeFaces(a);var H,B;v=0;var E,J,A={};L={};for(u in D){H=D[u];E=u.split("_");J=E[0];E=E[1];s=J;w=[J,E];A[s]===void 0&&(A[s]=[]);A[s].push(w);s=E;w=[J,E];A[s]===void 0&&(A[s]=
[]);A[s].push(w);s=0;for(z=H.length;s<z;s++){w=H[s];B=J;var O=w,F=u;L[B]===void 0&&(L[B]={});L[B][O]=F;B=E;O=u;L[B]===void 0&&(L[B]={});L[B][w]=O}H.length<2&&(r[u]=true)}for(u in D){H=D[u];w=H[0];B=H[1];E=u.split("_");J=E[0];E=E[1];z=new THREE.Vector3;b(H.length>0,"an edge without faces?!");if(H.length==1){z.addSelf(n[J]);z.addSelf(n[E]);z.multiplyScalar(0.5)}else{z.addSelf(p[w]);z.addSelf(p[B]);z.addSelf(n[J]);z.addSelf(n[E]);z.multiplyScalar(0.25)}o[u]=q+m.length+v;h.push(z);v++;if(l.supportUVs){z=
new THREE.UV;z.u=e(J,w).u+e(E,w).u;z.v=e(J,w).v+e(E,w).v;z.u=z.u/2;z.v=z.v/2;g(o[u],w,z);if(H.length>=2){b(H.length==2,"did we plan for more than 2 edges?");z=new THREE.UV;z.u=e(J,B).u+e(E,B).u;z.v=e(J,B).v+e(E,B).v;z.u=z.u/2;z.v=z.v/2;g(o[u],B,z)}}}c("-- Step 2 done");console.log("facePoints",p,"edgePoints",o);console.log("edgeFaceMap",D,"vertexEdgeMap",A);var K,I;z=["123","12","2","23"];B=["123","23","3","31"];var O=["123","31","1","12"],F=["1234","12","2","23"],M=["1234","23","3","34"],W=["1234",
"34","4","41"],Z=["1234","41","1","12"];u=0;for(v=p.length;u<v;u++){w=m[u];H=q+u;if(w instanceof THREE.Face3){J=orderedKey(w.a,w.b);E=orderedKey(w.b,w.c);K=orderedKey(w.c,w.a);f(H,o[J],w.b,o[E],w,z,u);f(H,o[E],w.c,o[K],w,B,u);f(H,o[K],w.a,o[J],w,O,u)}else if(w instanceof THREE.Face4){J=orderedKey(w.a,w.b);E=orderedKey(w.b,w.c);K=orderedKey(w.c,w.d);I=orderedKey(w.d,w.a);f(H,o[J],w.b,o[E],w,F,u);f(H,o[E],w.c,o[K],w,M,u);f(H,o[K],w.d,o[I],w,W,u);f(H,o[I],w.a,o[J],w,Z,u)}else c("face should be a face!",
w)}o=new THREE.Vector3;w=new THREE.Vector3;u=0;for(v=n.length;u<v;u++)if(A[u]!==void 0){o.set(0,0,0);w.set(0,0,0);E=new THREE.Vector3(0,0,0);H=0;for(s in L[u]){o.addSelf(p[s]);H++}B=0;J=A[u].length;z=H!=J;for(s=0;s<J;s++)r[orderedKey(A[u][s][0],A[u][s][1])]&&B++;o.divideScalar(H);B=0;if(z){for(s=0;s<J;s++){H=A[u][s];if(O=D[orderedKey(H[0],H[1])].length==1){H=n[H[0]].clone().addSelf(n[H[1]]).divideScalar(2);w.addSelf(H);B++}}w.divideScalar(4);b(B==2,"should have only 2 boundary edges")}else{for(s=
0;s<J;s++){H=A[u][s];H=n[H[0]].clone().addSelf(n[H[1]]).divideScalar(2);w.addSelf(H)}w.divideScalar(J)}E.addSelf(n[u]);if(z){E.divideScalar(2);E.addSelf(w)}else{E.multiplyScalar(J-3);E.addSelf(o);E.addSelf(w.multiplyScalar(2));E.divideScalar(J)}h[u]=E}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=j;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};
...
"color");m.scale=b.getUniformLocation(l,"scale");m.rotation=b.getUniformLocation(l,"rotation");m.screenPosition=b.getUniformLocation(l,"screenPosition");q=false};this.render=function(a,d,f,t){var a=a.__webglFlares,u=a.length;if(u){var v=new THREE.Vector3,s=t/f,z=f*0.5,w=t*0.5,A=16/t,L=new THREE.Vector2(A*s,A),D=new THREE.Vector3(1,1,0),H=new THREE.Vector2(1,1),B=m,A=n;b.useProgram(l);if(!q){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);q=true}b.uniform1i(B.occlusionMap,0);b.uniform1i(B.map,
1);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(A.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(A.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var E,J,O,F,K;for(E=0;E<u;E++){A=16/t;L.set(A*s,A);F=a[E];v.set(F.matrixWorld.elements[12],F.matrixWorld.elements[13],F.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(v);d.projectionMatrix.multiplyVector3(v);D.copy(v);H.x=D.x*z+z;H.y=D.y*w+w;if(j||H.x>0&&H.x<f&&H.y>0&&
H.y<t){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,H.x-8,H.y-8,16,16,0);b.uniform1i(B.renderType,0);b.uniform2f(B.scale,L.x,L.y);b.uniform3f(B.screenPosition,D.x,D.y,D.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,H.x-8,H.y-8,16,16,0);b.uniform1i(B.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);F.positionScreen.copy(D);F.customUpdateCallback?F.customUpdateCallback(F):F.updateLensFlares();b.uniform1i(B.renderType,2);b.enable(b.BLEND);J=0;for(O=F.lensFlares.length;J<O;J++){K=F.lensFlares[J];if(K.opacity>0.001&&K.scale>0.001){D.x=K.x;D.y=K.y;D.z=K.z;A=K.size*K.scale/t;L.x=A*s;L.y=A;b.uniform3f(B.screenPosition,D.x,D.y,D.z);b.uniform2f(B.scale,L.x,L.y);b.uniform1f(B.rotation,K.rotation);b.uniform1f(B.opacity,K.opacity);
...
vertexShader:g.vertexShader,uniforms:h,skinning:true});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:true,skinning:true});c._shadowPass=true;d._shadowPass=true;f._shadowPass=true;e._shadowPass=true};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,n){var m,q,p,o,r,t,u,v,s,z=[];o=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(true);m=0;for(q=l.__lights.length;m<q;m++){p=l.__lights[m];if(p.castShadow)if(p instanceof THREE.DirectionalLight&&p.shadowCascade)for(r=0;r<p.shadowCascadeCount;r++){var w;if(p.shadowCascadeArray[r])w=p.shadowCascadeArray[r];else{s=p;u=r;w=new THREE.DirectionalLight;w.isVirtual=true;w.onlyShadow=true;w.castShadow=true;w.shadowCameraNear=s.shadowCameraNear;w.shadowCameraFar=s.shadowCameraFar;w.shadowCameraLeft=s.shadowCameraLeft;w.shadowCameraRight=
...
t[1].set(1,-1,v);t[2].set(-1,1,v);t[3].set(1,1,v);t[4].set(-1,-1,s);t[5].set(1,-1,s);t[6].set(-1,1,s);t[7].set(1,1,s);w.originalCamera=n;t=new THREE.Gyroscope;t.position=p.shadowCascadeOffset;t.add(w);t.add(w.target);n.add(t);p.shadowCascadeArray[r]=w;console.log("Created virtualLight",w)}u=p;v=r;s=u.shadowCascadeArray[v];s.position.copy(u.position);s.target.position.copy(u.target.position);s.lookAt(s.target);s.shadowCameraVisible=u.shadowCameraVisible;s.shadowDarkness=u.shadowDarkness;s.shadowBias=
u.shadowCascadeBias[v];t=u.shadowCascadeNearZ[v];u=u.shadowCascadeFarZ[v];s=s.pointsFrustum;s[0].z=t;s[1].z=t;s[2].z=t;s[3].z=t;s[4].z=u;s[5].z=u;s[6].z=u;s[7].z=u;z[o]=w;o++}else{z[o]=p;o++}}m=0;for(q=z.length;m<q;m++){p=z[m];if(!p.shadowMap){p.shadowMap=new THREE.WebGLRenderTarget(p.shadowMapWidth,p.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});p.shadowMapSize=new THREE.Vector2(p.shadowMapWidth,p.shadowMapHeight);p.shadowMatrix=new THREE.Matrix4}if(!p.shadowCamera){if(p instanceof
...
g.contains(t))){t._modelViewMatrix.multiply(r.matrixWorldInverse,t.matrixWorld);u.render=true}}p=0;for(o=s.length;p<o;p++){u=s[p];if(u.render){t=u.object;u=u.buffer;v=t.customDepthMaterial?t.customDepthMaterial:t instanceof THREE.SkinnedMesh?t.geometry.morphTargets.length?e:f:t.geometry.morphTargets.length?d:c;u instanceof THREE.BufferGeometry?b.renderBufferDirect(r,l.__lights,null,v,u,t):b.renderBuffer(r,l.__lights,null,v,u,t)}}s=l.__webglObjectsImmediate;p=0;for(o=s.length;p<o;p++){u=s[p];t=u.object;
...
g);b.uniformMatrix4fv(t.projectionMatrix,false,f._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(t.map,0);for(var z,w=[],r=0;r<o;r++){z=d[r];if(z.visible&&z.opacity!==0)if(z.useScreenCoordinates)z.z=-z.position.z;else{z._modelViewMatrix.multiply(f.matrixWorldInverse,z.matrixWorld);z.z=-z._modelViewMatrix.elements[14]}}d.sort(a);for(r=0;r<o;r++){z=d[r];if(z.visible&&z.opacity!==0&&z.map&&z.map.image&&z.map.image.width){if(z.useScreenCoordinates){b.uniform1i(t.useScreenCoordinates,1);
b.uniform3f(t.screenPosition,(z.position.x-q)/q,(v-z.position.y)/v,Math.max(0,Math.min(1,z.position.z)))}else{b.uniform1i(t.useScreenCoordinates,0);b.uniform1i(t.affectedByDistance,z.affectedByDistance?1:0);b.uniformMatrix4fv(t.modelViewMatrix,false,z._modelViewMatrix.elements)}f=z.map.image.width/(z.scaleByViewport?p:1);w[0]=f*u*z.scale.x;w[1]=f*z.scale.y;b.uniform2f(t.uvScale,z.uvScale.x,z.uvScale.y);b.uniform2f(t.uvOffset,z.uvOffset.x,z.uvOffset.y);b.uniform2f(t.alignment,z.alignment.x,z.alignment.y);
