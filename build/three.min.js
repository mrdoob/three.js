...
c*b[2]+d*b[6]+e*b[10];a.normalize();return a},crossVector:function(a){var b=this.elements,c=new THREE.Vector4;c.x=b[0]*a.x+b[4]*a.y+b[8]*a.z+b[12]*a.w;c.y=b[1]*a.x+b[5]*a.y+b[9]*a.z+b[13]*a.w;c.z=b[2]*a.x+b[6]*a.y+b[10]*a.z+b[14]*a.w;c.w=a.w?b[3]*a.x+b[7]*a.y+b[11]*a.z+b[15]*a.w:1;return c},determinant:function(){var a=this.elements,b=a[0],c=a[4],d=a[8],e=a[12],f=a[1],g=a[5],h=a[9],i=a[13],k=a[2],m=a[6],p=a[10],n=a[14];return a[3]*(+e*h*m-d*i*m-e*g*p+c*i*p+d*g*n-c*h*n)+a[7]*(+b*h*n-b*i*p+e*f*p-d*
f*n+d*i*k-e*h*k)+a[11]*(+b*i*m-b*g*n-e*f*m+c*f*n+e*g*k-c*i*k)+a[15]*(-d*g*k-b*h*m+b*g*p+d*f*m-c*f*p+c*h*k)},transpose:function(){var a=this.elements,b;b=a[1];a[1]=a[4];a[4]=b;b=a[2];a[2]=a[8];a[8]=b;b=a[6];a[6]=a[9];a[9]=b;b=a[3];a[3]=a[12];a[12]=b;b=a[7];a[7]=a[13];a[13]=b;b=a[11];a[11]=a[14];a[14]=b;return this},flattenToArray:function(a){var b=this.elements;a[0]=b[0];a[1]=b[1];a[2]=b[2];a[3]=b[3];a[4]=b[4];a[5]=b[5];a[6]=b[6];a[7]=b[7];a[8]=b[8];a[9]=b[9];a[10]=b[10];a[11]=b[11];a[12]=b[12];a[13]=
...
void 0,s=a[g[i]].x,q=a[g[i]].y,l=a[g[k]].x,r=a[g[k]].y,t=a[g[m]].x,x=a[g[m]].y;if(1E-10>(l-s)*(x-q)-(r-q)*(t-s))n=!1;else{var I=void 0,F=void 0,C=void 0,y=void 0,E=void 0,G=void 0,H=void 0,X=void 0,A=void 0,W=void 0,A=X=H=w=z=void 0,I=t-l,F=x-r,C=s-t,y=q-x,E=l-s,G=r-q;for(n=0;n<e;n++)if(!(n===i||n===k||n===m))if(z=a[g[n]].x,w=a[g[n]].y,H=z-s,X=w-q,A=z-l,W=w-r,z-=t,w-=x,A=I*W-F*A,H=E*X-G*H,X=C*w-y*z,0<=A&&0<=X&&0<=H){n=!1;break a}n=!0}}if(n){f.push([a[g[i]],a[g[k]],a[g[m]]]);h.push([g[i],g[k],g[m]]);
...
b.uniform1i(H.occlusionMap,0);b.uniform1i(H.map,1);b.bindBuffer(b.ARRAY_BUFFER,g);b.vertexAttribPointer(C.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(C.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,h);b.disable(b.CULL_FACE);b.depthMask(!1);var X,A,W,B,K;for(X=0;X<x;X++)if(C=16/f,y.set(C*w,C),B=a[X],z.set(B.matrixWorld.elements[12],B.matrixWorld.elements[13],B.matrixWorld.elements[14]),z.applyMatrix4(d.matrixWorldInverse),z.applyMatrix4(d.projectionMatrix),E.copy(z),G.x=E.x*I+I,G.y=
