...
c)};this.projectScene=function(g,i,p,V){var Q=!1,Y,S,Z,O,T,aa,ca,da,va,Da,ga,wa,za;k=q=r=s=0;C.elements.length=0;!0===g.autoUpdate&&g.updateMatrixWorld();void 0===i.parent&&i.updateMatrixWorld();D.copy(i.matrixWorldInverse.getInverse(i.matrixWorld));L.multiplyMatrices(i.projectionMatrix,D);P.getNormalMatrix(D);X.setFromMatrix(L);f=0;C.objects.length=0;C.sprites.length=0;C.lights.length=0;var ja=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof
...
f,null!==f.renderDepth?e.z=f.renderDepth:(N.getPositionFromMatrix(f.matrixWorld),N.applyProjection(L),e.z=N.z),C.objects.push(e));ja(f)}}};ja(g);!0===p&&C.objects.sort(c);g=0;for(p=C.objects.length;g<p;g++)if(da=C.objects[g].object,K=da.matrixWorld,j=0,da instanceof THREE.Mesh){va=da.geometry;Z=va.vertices;Da=va.faces;va=va.faceVertexUvs;M.getNormalMatrix(K);wa=da.material instanceof THREE.MeshFaceMaterial;za=!0===wa?da.material:null;Y=0;for(S=Z.length;Y<S;Y++)h=b(),h.positionWorld.copy(Z[Y]).applyMatrix4(K),
h.positionScreen.copy(h.positionWorld).applyMatrix4(L),h.positionScreen.x/=h.positionScreen.w,h.positionScreen.y/=h.positionScreen.w,h.positionScreen.z/=h.positionScreen.w,h.visible=!(-1>h.positionScreen.x||1<h.positionScreen.x||-1>h.positionScreen.y||1<h.positionScreen.y||-1>h.positionScreen.z||1<h.positionScreen.z);Z=0;for(Y=Da.length;Z<Y;Z++){S=Da[Z];var Aa=!0===wa?za.materials[S.materialIndex]:da.material;if(void 0!==Aa){aa=Aa.side;if(S instanceof THREE.Face3)if(O=l[S.a],T=l[S.b],ca=l[S.c],H[0]=
O.positionScreen,H[1]=T.positionScreen,H[2]=ca.positionScreen,!0===O.visible||!0===T.visible||!0===ca.visible||I.isIntersectionBox(E.setFromPoints(H)))if(Q=0>(ca.positionScreen.x-O.positionScreen.x)*(T.positionScreen.y-O.positionScreen.y)-(ca.positionScreen.y-O.positionScreen.y)*(T.positionScreen.x-O.positionScreen.x),aa===THREE.DoubleSide||Q===(aa===THREE.FrontSide))s===m?(ga=new THREE.RenderableFace3,v.push(ga),m++,s++,n=ga):n=v[s++],n.v1.copy(O),n.v2.copy(T),n.v3.copy(ca);else continue;else continue;
else if(S instanceof THREE.Face4)if(O=l[S.a],T=l[S.b],ca=l[S.c],ga=l[S.d],t[0]=O.positionScreen,t[1]=T.positionScreen,t[2]=ca.positionScreen,t[3]=ga.positionScreen,!0===O.visible||!0===T.visible||!0===ca.visible||!0===ga.visible||I.isIntersectionBox(E.setFromPoints(t)))if(Q=0>(ga.positionScreen.x-O.positionScreen.x)*(T.positionScreen.y-O.positionScreen.y)-(ga.positionScreen.y-O.positionScreen.y)*(T.positionScreen.x-O.positionScreen.x)||0>(T.positionScreen.x-ca.positionScreen.x)*(ga.positionScreen.y-
ca.positionScreen.y)-(T.positionScreen.y-ca.positionScreen.y)*(ga.positionScreen.x-ca.positionScreen.x),aa===THREE.DoubleSide||Q===(aa===THREE.FrontSide)){if(r===u){var Ia=new THREE.RenderableFace4;w.push(Ia);u++;r++;n=Ia}else n=w[r++];n.v1.copy(O);n.v2.copy(T);n.v3.copy(ca);n.v4.copy(ga)}else continue;else continue;n.normalModel.copy(S.normal);!1===Q&&(aa===THREE.BackSide||aa===THREE.DoubleSide)&&n.normalModel.negate();n.normalModel.applyMatrix3(M).normalize();n.normalModelView.copy(n.normalModel).applyMatrix3(P);
n.centroidModel.copy(S.centroid).applyMatrix4(K);ca=S.vertexNormals;O=0;for(T=ca.length;O<T;O++)ga=n.vertexNormalsModel[O],ga.copy(ca[O]),!1===Q&&(aa===THREE.BackSide||aa===THREE.DoubleSide)&&ga.negate(),ga.applyMatrix3(M).normalize(),n.vertexNormalsModelView[O].copy(ga).applyMatrix3(P);n.vertexNormalsLength=ca.length;O=0;for(T=va.length;O<T;O++)if(ga=va[O][Z],void 0!==ga){aa=0;for(ca=ga.length;aa<ca;aa++)n.uvs[O][aa]=ga[aa]}n.color=S.color;n.material=Aa;$.copy(n.centroidModel).applyProjection(L);
n.z=$.z;C.elements.push(n)}}}else if(da instanceof THREE.Line){x.multiplyMatrices(L,K);Z=da.geometry.vertices;O=b();O.positionScreen.copy(Z[0]).applyMatrix4(x);Da=da.type===THREE.LinePieces?2:1;Y=1;for(S=Z.length;Y<S;Y++)O=b(),O.positionScreen.copy(Z[Y]).applyMatrix4(x),0<(Y+1)%Da||(T=l[j-2],W.copy(O.positionScreen),ea.copy(T.positionScreen),!0===d(W,ea)&&(W.multiplyScalar(1/W.w),ea.multiplyScalar(1/ea.w),q===F?(va=new THREE.RenderableLine,A.push(va),F++,q++,y=va):y=A[q++],y.v1.positionScreen.copy(W),
...
THREE.SmartSpotLight=function(a){"undefined"===typeof a&&(a={});var b=a.color instanceof THREE.Color?a.color:new THREE.Color(16777215),c="number"===typeof a.main_intensity&&!(0>a.main_intensity)?a.main_intensity:1,d="number"===typeof a.main_distance&&!(0>=a.main_distance)?a.main_distance:1,e="constant"===a.fade_type||"linear"===a.fade_type||"quadratic"===a.fade_type?a.fade_type:"constant",f="number"===typeof a.fade_distance&&!(0>=a.fade_distance)?a.fade_distance:1,g="number"===typeof a.near_distance&&
!(0>=a.near_distance)?a.near_distance:1,i="number"===typeof a.angle&&0<a.angle&&a.angle<=Math.PI/2?a.angle:Math.PI/3,a="number"===typeof a.exponent&&0<=a.exponent?a.exponent:10,h,b=b.getHex();"quadratic"===e?(e=g,c*=Math.pow(d/g,2),h=!0):"linear"===e?(e=d+f,c*=1+d/f):e=0;THREE.SpotLight.call(this,b,c,e,i,a,h)};THREE.SmartSpotLight.prototype=Object.create(THREE.SpotLight.prototype);THREE.Loader=function(a){this.statusDomElement=(this.showStatus=a)?THREE.Loader.prototype.addStatusElement():null;this.onLoadStart=function(){};this.onLoadProgress=function(){};this.onLoadComplete=function(){}};
...
aa=new THREE.Color,ca=new THREE.Color,da=new THREE.Color,va=new THREE.Color,Da={},ga={},wa,za,ja,Aa,Ia,Ma,Na,Oa,Pa,Qa,Ba=new THREE.Box2,ha=new THREE.Box2,fa=new THREE.Box2,sa=new THREE.Color,Ga=new THREE.Color,Ha=new THREE.Color,ka=new THREE.Vector3,xa,ta,Ca,oa,Ea,Fa,ia=16;xa=document.createElement("canvas");xa.width=xa.height=2;ta=xa.getContext("2d");ta.fillStyle="rgba(0,0,0,1)";ta.fillRect(0,0,2,2);Ca=ta.getImageData(0,0,2,2);oa=Ca.data;Ea=document.createElement("canvas");Ea.width=Ea.height=ia;
Fa=Ea.getContext("2d");Fa.translate(-ia/2,-ia/2);Fa.scale(ia,ia);ia--;void 0===q.setLineDash&&(q.setLineDash=void 0!==q.mozDash?function(a){q.mozDash=null!==a[0]?a:null}:function(){});this.domElement=m;this.devicePixelRatio=void 0!==a.devicePixelRatio?a.devicePixelRatio:void 0!==window.devicePixelRatio?window.devicePixelRatio:1;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.supportsVertexTextures=function(){};this.setFaceCulling=function(){};this.setSize=
function(a,b,c){r=a*this.devicePixelRatio;w=b*this.devicePixelRatio;u=Math.floor(r/2);y=Math.floor(w/2);m.width=r;m.height=w;1!==this.devicePixelRatio&&!1!==c&&(m.style.width=a+"px",m.style.height=b+"px");Ba.set(new THREE.Vector2(-u,-y),new THREE.Vector2(u,y));ha.set(new THREE.Vector2(-u,-y),new THREE.Vector2(u,y));G=1;k=0;z=N=C=B=J=null};this.setClearColor=function(a,b){A.set(a);F=void 0!==b?b:1;ha.set(new THREE.Vector2(-u,-y),new THREE.Vector2(u,y))};this.setClearColorHex=function(a,b){console.warn("DEPRECATED: .setClearColorHex() is being removed. Use .setClearColor() instead.");
this.setClearColor(a,b)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){q.setTransform(1,0,0,-1,u,y);!1===ha.empty()&&(ha.intersect(Ba),ha.expandByScalar(2),1>F&&q.clearRect(ha.min.x|0,ha.min.y|0,ha.max.x-ha.min.x|0,ha.max.y-ha.min.y|0),0<F&&(c(THREE.NormalBlending),b(1),i("rgba("+Math.floor(255*A.r)+","+Math.floor(255*A.g)+","+Math.floor(255*A.b)+","+F+")"),q.fillRect(ha.min.x|0,ha.min.y|0,ha.max.x-ha.min.x|0,ha.max.y-ha.min.y|0)),ha.makeEmpty())};this.render=function(a,k){function m(a,
b,c){for(var d=0,e=s.length;d<e;d++){var f=s[d];va.copy(f.color);if(f instanceof THREE.DirectionalLight){var g=ka.getPositionFromMatrix(f.matrixWorld).normalize(),i=b.dot(g);0>=i||(i*=f.intensity,c.add(va.multiplyScalar(i)))}else f instanceof THREE.PointLight&&(g=ka.getPositionFromMatrix(f.matrixWorld),i=b.dot(ka.subVectors(g,a).normalize()),0>=i||(i*=0==f.distance?1:1-Math.min(a.distanceTo(g)/f.distance,1),0!=i&&(i*=f.intensity,c.add(va.multiplyScalar(i)))))}}function r(a,d,e,f,g,i,h,n){l.info.render.vertices+=
3;l.info.render.faces++;b(n.opacity);c(n.blending);M=a.positionScreen.x;P=a.positionScreen.y;$=d.positionScreen.x;X=d.positionScreen.y;W=e.positionScreen.x;ea=e.positionScreen.y;w(M,P,$,X,W,ea);(n instanceof THREE.MeshLambertMaterial||n instanceof THREE.MeshPhongMaterial)&&null===n.map?(ca.copy(n.color),da.copy(n.emissive),n.vertexColors===THREE.FaceColors&&ca.multiply(h.color),!1===n.wireframe&&n.shading==THREE.SmoothShading&&3==h.vertexNormalsLength?(Z.copy(sa),O.copy(sa),T.copy(sa),m(h.v1.positionWorld,
h.vertexNormalsModel[0],Z),m(h.v2.positionWorld,h.vertexNormalsModel[1],O),m(h.v3.positionWorld,h.vertexNormalsModel[2],T),Z.multiply(ca).add(da),O.multiply(ca).add(da),T.multiply(ca).add(da),aa.addColors(O,T).multiplyScalar(0.5),ja=E(Z,O,T,aa),C(M,P,$,X,W,ea,0,0,1,0,0,1,ja)):(S.copy(sa),m(h.centroidModel,h.normalModel,S),S.multiply(ca).add(da),!0===n.wireframe?A(S,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):B(S))):n instanceof THREE.MeshBasicMaterial||n instanceof THREE.MeshLambertMaterial||
n instanceof THREE.MeshPhongMaterial?null!==n.map?n.map.mapping instanceof THREE.UVMapping&&(Aa=h.uvs[0],F(M,P,$,X,W,ea,Aa[f].x,Aa[f].y,Aa[g].x,Aa[g].y,Aa[i].x,Aa[i].y,n.map)):null!==n.envMap?n.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(ka.copy(h.vertexNormalsModelView[f]),Ia=0.5*ka.x+0.5,Ma=0.5*ka.y+0.5,ka.copy(h.vertexNormalsModelView[g]),Na=0.5*ka.x+0.5,Oa=0.5*ka.y+0.5,ka.copy(h.vertexNormalsModelView[i]),Pa=0.5*ka.x+0.5,Qa=0.5*ka.y+0.5,F(M,P,$,X,W,ea,Ia,Ma,Na,Oa,Pa,Qa,n.envMap)):
(S.copy(n.color),n.vertexColors===THREE.FaceColors&&S.multiply(h.color),!0===n.wireframe?A(S,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):B(S)):n instanceof THREE.MeshDepthMaterial?(wa=k.near,za=k.far,Z.r=Z.g=Z.b=1-j(a.positionScreen.z*a.positionScreen.w,wa,za),O.r=O.g=O.b=1-j(d.positionScreen.z*d.positionScreen.w,wa,za),T.r=T.g=T.b=1-j(e.positionScreen.z*e.positionScreen.w,wa,za),aa.addColors(O,T).multiplyScalar(0.5),ja=E(Z,O,T,aa),C(M,P,$,X,W,ea,0,0,1,0,0,1,ja)):n instanceof THREE.MeshNormalMaterial&&
...
T).multiplyScalar(0.5),ja=E(Z,O,T,aa),C(M,P,$,X,W,ea,0,0,1,0,0,1,ja)))}function w(a,b,c,d,e,f){q.beginPath();q.moveTo(a,b);q.lineTo(c,d);q.lineTo(e,f);q.closePath()}function z(a,b,c,d,e,f,g,i){q.beginPath();q.moveTo(a,b);q.lineTo(c,d);q.lineTo(e,f);q.lineTo(g,i);q.closePath()}function A(a,b,c,i){d(b);e(c);f(i);g(a.getStyle());q.stroke();fa.expandByScalar(2*b)}function B(a){i(a.getStyle());q.fill()}function F(a,b,c,d,e,f,g,h,j,k,l,n,m){if(!(m instanceof THREE.DataTexture||void 0===m.image||0==m.image.width)){if(!0===
m.needsUpdate){var p=m.wrapS==THREE.RepeatWrapping,O=m.wrapT==THREE.RepeatWrapping;Da[m.id]=q.createPattern(m.image,!0===p&&!0===O?"repeat":!0===p&&!1===O?"repeat-x":!1===p&&!0===O?"repeat-y":"no-repeat");m.needsUpdate=!1}void 0===Da[m.id]?i("rgba(0,0,0,1)"):i(Da[m.id]);var p=m.offset.x/m.repeat.x,O=m.offset.y/m.repeat.y,s=m.image.width*m.repeat.x,r=m.image.height*m.repeat.y,g=(g+p)*s,h=(1-h+O)*r,c=c-a,d=d-b,e=e-a,f=f-b,j=(j+p)*s-g,k=(1-k+O)*r-h,l=(l+p)*s-g,n=(1-n+O)*r-h,p=j*n-l*k;0===p?(void 0===
ga[m.id]&&(b=document.createElement("canvas"),b.width=m.image.width,b.height=m.image.height,b=b.getContext("2d"),b.drawImage(m.image,0,0),ga[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data),b=ga[m.id],g=4*(Math.floor(g)+Math.floor(h)*m.image.width),S.setRGB(b[g]/255,b[g+1]/255,b[g+2]/255),B(S)):(p=1/p,m=(n*c-k*e)*p,k=(n*d-k*f)*p,c=(j*e-l*c)*p,d=(j*f-l*d)*p,a=a-m*g-c*h,g=b-k*g-d*h,q.save(),q.transform(m,k,c,d,a,g),q.fill(),q.restore())}}function C(a,b,c,d,e,f,g,i,h,j,k,l,n){var m,p;m=n.width-
1;p=n.height-1;g*=m;i*=p;c-=a;d-=b;e-=a;f-=b;h=h*m-g;j=j*p-i;k=k*m-g;l=l*p-i;p=1/(h*l-k*j);m=(l*c-j*e)*p;j=(l*d-j*f)*p;c=(h*e-k*c)*p;d=(h*f-k*d)*p;a=a-m*g-c*i;b=b-j*g-d*i;q.save();q.transform(m,j,c,d,a,b);q.clip();q.drawImage(n,0,0);q.restore()}function E(a,b,c,d){oa[0]=255*a.r|0;oa[1]=255*a.g|0;oa[2]=255*a.b|0;oa[4]=255*b.r|0;oa[5]=255*b.g|0;oa[6]=255*b.b|0;oa[8]=255*c.r|0;oa[9]=255*c.g|0;oa[10]=255*c.b|0;oa[12]=255*d.r|0;oa[13]=255*d.g|0;oa[14]=255*d.b|0;ta.putImageData(Ca,0,0);Fa.drawImage(xa,
0,0);return Ea}function G(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===k instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{!0===this.autoClear&&this.clear();q.setTransform(1,0,0,-1,u,y);l.info.render.vertices=0;l.info.render.faces=0;p=v.projectScene(a,k,this.sortObjects,this.sortElements);n=p.elements;s=p.lights;sa.setRGB(0,0,0);Ga.setRGB(0,0,0);Ha.setRGB(0,0,0);for(var J=
0,N=s.length;J<N;J++){var I=s[J],R=I.color;I instanceof THREE.AmbientLight?sa.add(R):I instanceof THREE.DirectionalLight?Ga.add(R):I instanceof THREE.PointLight&&Ha.add(R)}J=0;for(N=n.length;J<N;J++){var U=n[J],I=U.material;if(!(void 0===I||!1===I.visible)){fa.makeEmpty();if(U instanceof THREE.RenderableParticle){H=U;H.x*=u;H.y*=y;R=H;b(I.opacity);c(I.blending);var la=void 0,ma=void 0,ua=void 0,ya=void 0,ia=void 0,Ka=void 0,La=void 0;I instanceof THREE.ParticleBasicMaterial?null===I.map?(ua=U.object.scale.x,
ya=U.object.scale.y,ua*=U.scale.x*u,ya*=U.scale.y*y,fa.min.set(R.x-ua,R.y-ya),fa.max.set(R.x+ua,R.y+ya),!1===Ba.isIntersectionBox(fa)?fa.makeEmpty():(i(I.color.getStyle()),q.save(),q.translate(R.x,R.y),q.rotate(-U.rotation),q.scale(ua,ya),q.fillRect(-1,-1,2,2),q.restore())):(ia=I.map.image,Ka=ia.width>>1,La=ia.height>>1,ua=U.scale.x*u,ya=U.scale.y*y,la=ua*Ka,ma=ya*La,fa.min.set(R.x-la,R.y-ma),fa.max.set(R.x+la,R.y+ma),!1===Ba.isIntersectionBox(fa)?fa.makeEmpty():(q.save(),q.translate(R.x,R.y),q.rotate(-U.rotation),
q.scale(ua,-ya),q.translate(-Ka,-La),q.drawImage(ia,0,0),q.restore())):I instanceof THREE.ParticleCanvasMaterial&&(la=U.scale.x*u,ma=U.scale.y*y,fa.min.set(R.x-la,R.y-ma),fa.max.set(R.x+la,R.y+ma),!1===Ba.isIntersectionBox(fa)?fa.makeEmpty():(g(I.color.getStyle()),i(I.color.getStyle()),q.save(),q.translate(R.x,R.y),q.rotate(-U.rotation),q.scale(la,ma),I.program(q),q.restore()))}else if(U instanceof THREE.RenderableLine){if(H=U.v1,t=U.v2,H.positionScreen.x*=u,H.positionScreen.y*=y,t.positionScreen.x*=
u,t.positionScreen.y*=y,fa.setFromPoints([H.positionScreen,t.positionScreen]),!0===Ba.isIntersectionBox(fa))if(R=H,la=t,b(I.opacity),c(I.blending),q.beginPath(),q.moveTo(R.positionScreen.x,R.positionScreen.y),q.lineTo(la.positionScreen.x,la.positionScreen.y),I instanceof THREE.LineBasicMaterial){d(I.linewidth);e(I.linecap);f(I.linejoin);if(I.vertexColors!==THREE.VertexColors)g(I.color.getStyle());else if(ma=U.vertexColors[0].getStyle(),U=U.vertexColors[1].getStyle(),ma===U)g(ma);else{try{var Ja=q.createLinearGradient(R.positionScreen.x,
R.positionScreen.y,la.positionScreen.x,la.positionScreen.y);Ja.addColorStop(0,ma);Ja.addColorStop(1,U)}catch(Ra){Ja=ma}g(Ja)}q.stroke();fa.expandByScalar(2*I.linewidth)}else I instanceof THREE.LineDashedMaterial&&(d(I.linewidth),e(I.linecap),f(I.linejoin),g(I.color.getStyle()),h(I.dashSize,I.gapSize),q.stroke(),fa.expandByScalar(2*I.linewidth),h(null,null))}else if(U instanceof THREE.RenderableFace3){H=U.v1;t=U.v2;D=U.v3;if(-1>H.positionScreen.z||1<H.positionScreen.z)continue;if(-1>t.positionScreen.z||
1<t.positionScreen.z)continue;if(-1>D.positionScreen.z||1<D.positionScreen.z)continue;H.positionScreen.x*=u;H.positionScreen.y*=y;t.positionScreen.x*=u;t.positionScreen.y*=y;D.positionScreen.x*=u;D.positionScreen.y*=y;!0===I.overdraw&&(G(H.positionScreen,t.positionScreen),G(t.positionScreen,D.positionScreen),G(D.positionScreen,H.positionScreen));fa.setFromPoints([H.positionScreen,t.positionScreen,D.positionScreen]);!0===Ba.isIntersectionBox(fa)&&r(H,t,D,0,1,2,U,I)}else if(U instanceof THREE.RenderableFace4){H=
...
!0===I.overdraw&&(G(H.positionScreen,t.positionScreen),G(t.positionScreen,L.positionScreen),G(L.positionScreen,H.positionScreen),G(D.positionScreen,K.positionScreen),G(D.positionScreen,x.positionScreen));fa.setFromPoints([H.positionScreen,t.positionScreen,D.positionScreen,L.positionScreen]);!0===Ba.isIntersectionBox(fa)&&(R=H,la=t,ma=D,ua=L,ya=K,ia=x,l.info.render.vertices+=4,l.info.render.faces++,b(I.opacity),c(I.blending),void 0!==I.map&&null!==I.map||void 0!==I.envMap&&null!==I.envMap?(r(R,la,
ua,0,1,3,U,I),r(ya,ma,ia,1,2,3,U,I)):(M=R.positionScreen.x,P=R.positionScreen.y,$=la.positionScreen.x,X=la.positionScreen.y,W=ma.positionScreen.x,ea=ma.positionScreen.y,na=ua.positionScreen.x,pa=ua.positionScreen.y,qa=ya.positionScreen.x,V=ya.positionScreen.y,Q=ia.positionScreen.x,Y=ia.positionScreen.y,I instanceof THREE.MeshLambertMaterial||I instanceof THREE.MeshPhongMaterial?(ca.copy(I.color),da.copy(I.emissive),I.vertexColors===THREE.FaceColors&&ca.multiply(U.color),!1===I.wireframe&&I.shading==
THREE.SmoothShading&&4==U.vertexNormalsLength?(Z.copy(sa),O.copy(sa),T.copy(sa),aa.copy(sa),m(U.v1.positionWorld,U.vertexNormalsModel[0],Z),m(U.v2.positionWorld,U.vertexNormalsModel[1],O),m(U.v4.positionWorld,U.vertexNormalsModel[3],T),m(U.v3.positionWorld,U.vertexNormalsModel[2],aa),Z.multiply(ca).add(da),O.multiply(ca).add(da),T.multiply(ca).add(da),aa.multiply(ca).add(da),ja=E(Z,O,T,aa),w(M,P,$,X,na,pa),C(M,P,$,X,na,pa,0,0,1,0,0,1,ja),w(qa,V,W,ea,Q,Y),C(qa,V,W,ea,Q,Y,1,0,1,1,0,1,ja)):(S.copy(sa),
...
ja=E(Z,O,T,aa),w(M,P,$,X,na,pa),C(M,P,$,X,na,pa,0,0,1,0,0,1,ja),w(qa,V,W,ea,Q,Y),C(qa,V,W,ea,Q,Y,1,0,1,1,0,1,ja))):I instanceof THREE.MeshDepthMaterial&&(wa=k.near,za=k.far,Z.r=Z.g=Z.b=1-j(R.positionScreen.z*R.positionScreen.w,wa,za),O.r=O.g=O.b=1-j(la.positionScreen.z*la.positionScreen.w,wa,za),T.r=T.g=T.b=1-j(ua.positionScreen.z*ua.positionScreen.w,wa,za),aa.r=aa.g=aa.b=1-j(ma.positionScreen.z*ma.positionScreen.w,wa,za),ja=E(Z,O,T,aa),w(M,P,$,X,na,pa),C(M,P,$,X,na,pa,0,0,1,0,0,1,ja),w(qa,V,W,ea,
Q,Y),C(qa,V,W,ea,Q,Y,1,0,1,1,0,1,ja))))}ha.union(fa)}}q.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
(h.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(x){for(var k,l=j=0,n=0,m,p,s,t,v=M,y=v.directional.colors,z=v.directional.positions,A=v.point.colors,F=v.point.positions,E=v.point.distances,G=v.point.quadratics,D=v.spot.colors,J=v.spot.positions,P=v.spot.distances,$=v.spot.directions,Ba=v.spot.anglesCos,ha=v.spot.exponents,fa=v.spot.quadratics,sa=v.hemi.skyColors,Ga=v.hemi.groundColors,Ha=v.hemi.positions,ka=0,xa=0,ta=0,
Ca=0,oa=0,Ea=0,Fa=0,ia=0,ra=k=0,c=s=ra=0,f=b.length;c<f;c++)k=b[c],k.onlyShadow||(m=k.color,p=k.intensity,s=k.distance,t=k.quadratic,k instanceof THREE.AmbientLight?k.visible&&(B.gammaInput?(j+=m.r*m.r,l+=m.g*m.g,n+=m.b*m.b):(j+=m.r,l+=m.g,n+=m.b)):k instanceof THREE.DirectionalLight?(oa+=1,k.visible&&(K.getPositionFromMatrix(k.matrixWorld),L.getPositionFromMatrix(k.target.matrixWorld),K.sub(L),K.normalize(),0===K.x&&0===K.y&&0===K.z||(k=3*ka,z[k]=K.x,z[k+1]=K.y,z[k+2]=K.z,B.gammaInput?w(y,k,m,p*
p):u(y,k,m,p),ka+=1))):k instanceof THREE.PointLight?(Ea+=1,k.visible&&(ra=3*xa,B.gammaInput?w(A,ra,m,p*p):u(A,ra,m,p),L.getPositionFromMatrix(k.matrixWorld),F[ra]=L.x,F[ra+1]=L.y,F[ra+2]=L.z,E[xa]=s,G[xa]=t,xa+=1)):k instanceof THREE.SpotLight?(Fa+=1,k.visible&&(ra=3*ta,B.gammaInput?w(D,ra,m,p*p):u(D,ra,m,p),L.getPositionFromMatrix(k.matrixWorld),J[ra]=L.x,J[ra+1]=L.y,J[ra+2]=L.z,P[ta]=s,K.copy(L),L.getPositionFromMatrix(k.target.matrixWorld),K.sub(L),K.normalize(),$[ra]=K.x,$[ra+1]=K.y,$[ra+2]=
K.z,Ba[ta]=Math.cos(k.angle),ha[ta]=k.exponent,fa[ta]=t,ta+=1)):k instanceof THREE.HemisphereLight&&(ia+=1,k.visible&&(K.getPositionFromMatrix(k.matrixWorld),K.normalize(),0===K.x&&0===K.y&&0===K.z||(s=3*Ca,Ha[s]=K.x,Ha[s+1]=K.y,Ha[s+2]=K.z,m=k.color,k=k.groundColor,B.gammaInput?(p*=p,w(sa,s,m,p),w(Ga,s,k,p)):(u(sa,s,m,p),u(Ga,s,k,p)),Ca+=1))));c=3*ka;for(f=Math.max(y.length,3*oa);c<f;c++)y[c]=0;c=3*xa;for(f=Math.max(A.length,3*Ea);c<f;c++)A[c]=0;c=3*ta;for(f=Math.max(D.length,3*Fa);c<f;c++)D[c]=
0;c=3*Ca;for(f=Math.max(sa.length,3*ia);c<f;c++)sa[c]=0;c=3*Ca;for(f=Math.max(Ga.length,3*ia);c<f;c++)Ga[c]=0;v.directional.length=ka;v.point.length=xa;v.spot.length=ta;v.hemi.length=Ca;v.ambient[0]=j;v.ambient[1]=l;v.ambient[2]=n;x=!1}c=M;h.ambientLightColor.value=c.ambient;h.directionalLightColor.value=c.directional.colors;h.directionalLightDirection.value=c.directional.positions;h.pointLightColor.value=c.point.colors;h.pointLightPosition.value=c.point.positions;h.pointLightDistance.value=c.point.distances;
h.pointLightQuadratic.value=c.point.quadratics;h.spotLightColor.value=c.spot.colors;h.spotLightPosition.value=c.spot.positions;h.spotLightDistance.value=c.spot.distances;h.spotLightDirection.value=c.spot.directions;h.spotLightAngleCos.value=c.spot.anglesCos;h.spotLightExponent.value=c.spot.exponents;h.spotLightQuadratic.value=c.spot.quadratics;h.hemisphereLightSkyColor.value=c.hemi.skyColors;h.hemisphereLightGroundColor.value=c.hemi.groundColors;h.hemisphereLightDirection.value=c.hemi.positions}if(d instanceof
...
ba=d.normalMap:d.bumpMap&&(ba=d.bumpMap);void 0!==ba&&(c=ba.offset,ba=ba.repeat,h.offsetRepeat.value.set(c.x,c.y,ba.x,ba.y));h.envMap.value=d.envMap;h.flipEnvMap.value=d.envMap instanceof THREE.WebGLRenderTargetCube?1:-1;h.reflectivity.value=d.reflectivity;h.refractionRatio.value=d.refractionRatio;h.combine.value=d.combine;h.useRefract.value=d.envMap&&d.envMap.mapping instanceof THREE.CubeRefractionMapping}d instanceof THREE.LineBasicMaterial?(h.diffuse.value=d.color,h.opacity.value=d.opacity):d instanceof
THREE.LineDashedMaterial?(h.diffuse.value=d.color,h.opacity.value=d.opacity,h.dashSize.value=d.dashSize,h.totalSize.value=d.dashSize+d.gapSize,h.scale.value=d.scale):d instanceof THREE.ParticleBasicMaterial?(h.psColor.value=d.color,h.opacity.value=d.opacity,h.size.value=d.size,h.scale.value=q.getDomElement().height/2,h.map.value=d.map):d instanceof THREE.MeshPhongMaterial?(h.shininess.value=d.shininess,B.gammaInput?(h.ambient.value.copyGammaToLinear(d.ambient),h.emissive.value.copyGammaToLinear(d.emissive),
h.specular.value.copyGammaToLinear(d.specular)):(h.ambient.value=d.ambient,h.emissive.value=d.emissive,h.specular.value=d.specular),d.wrapAround&&h.wrapRGB.value.copy(d.wrapRGB)):d instanceof THREE.MeshLambertMaterial?(B.gammaInput?(h.ambient.value.copyGammaToLinear(d.ambient),h.emissive.value.copyGammaToLinear(d.emissive)):(h.ambient.value=d.ambient,h.emissive.value=d.emissive),d.wrapAround&&h.wrapRGB.value.copy(d.wrapRGB)):d instanceof THREE.MeshDepthMaterial?(h.mNear.value=a.near,h.mFar.value=
a.far,h.opacity.value=d.opacity):d instanceof THREE.MeshNormalMaterial&&(h.opacity.value=d.opacity);if(e.receiveShadow&&!d._shadowPass&&h.shadowMatrix){c=ba=0;for(f=b.length;c<f;c++)if(j=b[c],j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade))h.shadowMap.value[ba]=j.shadowMap,h.shadowMapSize.value[ba]=j.shadowMapSize,h.shadowMatrix.value[ba]=j.shadowMatrix,h.shadowDarkness.value[ba]=j.shadowDarkness,h.shadowBias.value[ba]=j.shadowBias,ba++}b=d.uniformsList;
c=0;for(f=b.length;c<f;c++)if(ba=g.uniforms[b[c][1]])if(h=b[c][0],j=h.type,n=h.value,"i"===j)q.uniform1i(ba,n);else if("f"===j)q.uniform1f(ba,n);else if("v2"===j)q.uniform2f(ba,n.x,n.y);else if("v3"===j)q.uniform3f(ba,n.x,n.y,n.z);else if("v4"===j)q.uniform4f(ba,n.x,n.y,n.z,n.w);else if("c"===j)q.uniform3f(ba,n.r,n.g,n.b);else if("iv1"===j)q.uniform1iv(ba,n);else if("iv"===j)q.uniform3iv(ba,n);else if("fv1"===j)q.uniform1fv(ba,n);else if("fv"===j)q.uniform3fv(ba,n);else if("v2v"===j){void 0===h._array&&
(h._array=new Float32Array(2*n.length));j=0;for(l=n.length;j<l;j++)v=2*j,h._array[v]=n[j].x,h._array[v+1]=n[j].y;q.uniform2fv(ba,h._array)}else if("v3v"===j){void 0===h._array&&(h._array=new Float32Array(3*n.length));j=0;for(l=n.length;j<l;j++)v=3*j,h._array[v]=n[j].x,h._array[v+1]=n[j].y,h._array[v+2]=n[j].z;q.uniform3fv(ba,h._array)}else if("v4v"===j){void 0===h._array&&(h._array=new Float32Array(4*n.length));j=0;for(l=n.length;j<l;j++)v=4*j,h._array[v]=n[j].x,h._array[v+1]=n[j].y,h._array[v+2]=
n[j].z,h._array[v+3]=n[j].w;q.uniform4fv(ba,h._array)}else if("m4"===j)void 0===h._array&&(h._array=new Float32Array(16)),n.flattenToArray(h._array),q.uniformMatrix4fv(ba,h._array);else if("m4v"===j){void 0===h._array&&(h._array=new Float32Array(16*n.length));j=0;for(l=n.length;j<l;j++)n[j].flattenToArrayOffset(h._array,16*j);q.uniformMatrix4fv(ba,h._array)}else if("t"===j)v=r(),q.uniform1i(ba,v),n&&(n.image instanceof Array&&6===n.image.length?q.setCubeTexture(n,v):n instanceof THREE.WebGLRenderTargetCube?
q.setCubeTextureDynamic(n,v):q.setTexture(n,v));else if("tv"===j){void 0===h._array&&(h._array=[]);j=0;for(l=h.value.length;j<l;j++)h._array[j]=r();q.uniform1iv(ba,h._array);j=0;for(l=h.value.length;j<l;j++)n=h.value[j],v=h._array[j],n&&q.setTexture(n,v)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==i.cameraPosition)L.getPositionFromMatrix(a.matrixWorld),q.uniform3f(i.cameraPosition,L.x,L.y,L.z);(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||
d instanceof THREE.ShaderMaterial||d.skinning)&&null!==i.viewMatrix&&q.uniformMatrix4fv(i.viewMatrix,a.matrixWorldInverse.elements)}q.uniformMatrix4fv(i.modelViewMatrix,e._modelViewMatrix.elements);i.normalMatrix&&q.uniformMatrix3fv(i.normalMatrix,e._normalMatrix.elements);null!==i.modelMatrix&&q.uniformMatrix4fv(i.modelMatrix,e.matrixWorld.elements);return g}function r(){var a=H;a>=q.maxTextures&&console.warn("WebGLRenderer: trying to use "+a+" texture units while this GPU supports only "+q.maxTextures);
H+=1;return a}function w(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function u(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},y={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}},q=new THREE.WebGLRenderer.LowLevelRenderer(a),A=new THREE.WebGLRenderer.MeshRenderer(q,y),F=new THREE.WebGLRenderer.ParticleRenderer(q,y),G=new THREE.WebGLRenderer.LineRenderer(q,y),k=new THREE.WebGLRenderer.RibbonRenderer(q,
y),J=new THREE.WebGLRenderer.ShaderBuilder(q,y);this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapAutoUpdate=!0;this.shadowMapType=THREE.PCFShadowMap;this.shadowMapCullFace=THREE.CullFaceFront;this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=
[];this.renderPluginsPost=[];this.info=y;var B=this,C=null,N=-1,z=null,I=null,E=0,H=0,t=new THREE.Frustum,D=new THREE.Matrix4;new THREE.Matrix4;var L=new THREE.Vector3,K=new THREE.Vector3,x=!0,M={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[],quadratics:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[],quadratics:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}};this.context=
q.getContext();this.domElement=q.getDomElement();this.getPrecision=this.getPrecision=q.getPrecision;this.getContext=q.getContext;this.supportsVertexTextures=q.supportsVertexTextures;this.supportsFloatTextures=q.supportsFloatTextures;this.supportsStandardDerivatives=q.supportsStandardDerivatives;this.supportsCompressedTextureS3TC=q.supportsCompressedTextureS3TC;this.getMaxAnisotropy=q.getMaxAnisotropy;this.setSize=q.setSize;this.setViewport=q.setViewport;this.setScissor=q.setScissor;this.enableScissorTest=
q.enableScissorTest;this.setDepthWrite=q.setDepthWrite;this.setDepthTest=q.setDepthTest;this.setRenderTarget=q.setRenderTarget;this.setBlending=q.setBlending;this.setTexture=q.setTexture;this.setMaterialFaces=q.setMaterialFaces;this.setFaceCulling=q.setFaceCulling;this.setClearColorHex=q.setClearColorHex;this.setClearColor=q.setClearColor;this.getClearColor=q.getClearColor;this.getClearAlpha=q.getClearAlpha;this.clear=q.clear;this.clearTarget=q.clearTarget;this.addPostPlugin=function(a){a.init(this);
...
q.deleteBuffer(a.__webglLineDistanceBuffer);if(void 0!==a.geometryGroups)for(var e in a.geometryGroups){var f=a.geometryGroups[e];if(void 0!==f.numMorphTargets){c=0;for(d=f.numMorphTargets;c<d;c++)q.deleteBuffer(f.__webglMorphTargetsBuffers[c])}if(void 0!==f.numMorphNormals){c=0;for(d=f.numMorphNormals;c<d;c++)q.deleteBuffer(f.__webglMorphNormalsBuffers[c])}b(f)}b(a);B.info.memory.geometries--},$=function(a){a=a.target;a.removeEventListener("dispose",$);X(a)},X=function(a){var b=a.program;void 0!==
b&&(a.program=void 0,J.removeProgram(b))};this.renderBufferImmediate=function(a,b,c){a.hasPositions&&!a.__webglVertexBuffer&&(a.__webglVertexBuffer=q.createBuffer());a.hasNormals&&!a.__webglNormalBuffer&&(a.__webglNormalBuffer=q.createBuffer());a.hasUvs&&!a.__webglUvBuffer&&(a.__webglUvBuffer=q.createBuffer());a.hasColors&&!a.__webglColorBuffer&&(a.__webglColorBuffer=q.createBuffer());a.hasPositions&&(q.setDynamicArrayBuffer(a.__webglVertexBuffer,a.positionArray),q.setFloatAttribute(b.attributes.position,
a.__webglVertexBuffer,3,0));if(a.hasNormals){if(c.shading===THREE.FlatShading){var d,e,f,g,h,i,j,k,l,n,m,p=3*a.count;for(m=0;m<p;m+=9)n=a.normalArray,d=n[m],e=n[m+1],f=n[m+2],g=n[m+3],i=n[m+4],k=n[m+5],h=n[m+6],j=n[m+7],l=n[m+8],d=(d+g+h)/3,e=(e+i+j)/3,f=(f+k+l)/3,n[m]=d,n[m+1]=e,n[m+2]=f,n[m+3]=d,n[m+4]=e,n[m+5]=f,n[m+6]=d,n[m+7]=e,n[m+8]=f}q.setDynamicArrayBuffer(a.__webglNormalBuffer,a.normalArray);q.setFloatAttribute(b.attributes.normal,a.__webglNormalBuffer,3,0)}a.hasUvs&&c.map&&(q.setDynamicArrayBuffer(a.__webglUvBuffer,
a.uvArray),q.setFloatAttribute(b.attributes.uv,a.__webglUvBuffer,2,0));a.hasColors&&c.vertexColors!==THREE.NoColors&&(q.setDynamicArrayBuffer(a.__webglColorBuffer,a.colorArray),q.setFloatAttribute(b.attributes.color,a.__webglColorBuffer,3,0));q.drawTriangles(a.count);a.count=0};this.renderBufferDirect=function(a,b,c,d,e,f){if(!1!==d.visible){var g,h,i;g=m(a,b,c,d,f);a=g.attributes;b=e.attributes;c=!1;g=16777215*e.id+2*g.id+(d.wireframe?1:0);g!==z&&(z=g,c=!0);c&&q.disableAttributes();if(f instanceof
THREE.Mesh)if(d=b.index){e=e.offsets;1<e.length&&(c=!0);for(var j=0,k=e.length;j<k;j++){var l=e[j].index;if(c)for(h in b)"index"!==h&&(g=a[h],f=b[h],i=f.itemSize,0<=g&&q.setFloatAttribute(g,f.buffer,i,4*l*i));q.drawTriangleElements(d.buffer,e[j].count,2*e[j].start);B.info.render.calls++;B.info.render.vertices+=e[j].count;B.info.render.faces+=e[j].count/3}}else{if(c)for(h in b)g=a[h],f=b[h],i=f.itemSize,0<=g&&q.setFloatAttribute(g,f.buffer,i,0);h=e.attributes.position;q.drawTriangles(h.numItems/3);
B.info.render.calls++;B.info.render.vertices+=h.numItems/3;B.info.render.faces+=h.numItems/3/3}else if(f instanceof THREE.ParticleSystem){if(c){for(h in b)g=a[h],f=b[h],i=f.itemSize,0<=g&&q.setFloatAttribute(g,f.buffer,i,0);h=b.position;q.drawPoints(h.numItems/3);B.info.render.calls++;B.info.render.points+=h.numItems/3}}else if(f instanceof THREE.Line&&c){for(h in b)g=a[h],f=b[h],i=f.itemSize,0<=g&&q.setFloatAttribute(g,f.buffer,i,0);h=b.position;q.setLineWidth(d.linewidth);q.drawLineStrip(h.numItems/
3);B.info.render.calls++;B.info.render.points+=h.numItems}}};this.renderBuffer=function(a,b,c,d,e,f){if(!1!==d.visible){var h,c=m(a,b,c,d,f),a=c.attributes,b=!1,c=16777215*e.id+2*c.id+(d.wireframe?1:0);c!==z&&(z=c,b=!0);b&&q.disableAttributes();if(!d.morphTargets&&0<=a.position)b&&q.setFloatAttribute(a.position,e.__webglVertexBuffer,3,0);else if(f.morphTargetBase){c=d.program.attributes;-1!==f.morphTargetBase&&0<=c.position?q.setFloatAttribute(c.position,e.__webglMorphTargetsBuffers[f.morphTargetBase],
3,0):0<=c.position&&q.setFloatAttribute(c.position,e.__webglVertexBuffer,3,0);if(f.morphTargetForcedOrder.length){var i=0,j=f.morphTargetForcedOrder;for(h=f.morphTargetInfluences;i<d.numSupportedMorphTargets&&i<j.length;)0<=c["morphTarget"+i]&&q.setFloatAttribute(c["morphTarget"+i],e.__webglMorphTargetsBuffers[j[i]],3,0),0<=c["morphNormal"+i]&&d.morphNormals&&q.setFloatAttribute(c["morphNormal"+i],e.__webglMorphNormalsBuffers[j[i]],3,0),f.__webglMorphTargetInfluences[i]=h[j[i]],i++}else{j=[];h=f.morphTargetInfluences;
var k,l=h.length;for(k=0;k<l;k++)i=h[k],0<i&&j.push([i,k]);j.length>d.numSupportedMorphTargets?(j.sort(g),j.length=d.numSupportedMorphTargets):j.length>d.numSupportedMorphNormals?j.sort(g):0===j.length&&j.push([0,0]);for(i=0;i<d.numSupportedMorphTargets;)j[i]?(k=j[i][1],0<=c["morphTarget"+i]&&q.setFloatAttribute(c["morphTarget"+i],e.__webglMorphTargetsBuffers[k],3,0),0<=c["morphNormal"+i]&&d.morphNormals&&q.setFloatAttribute(c["morphNormal"+i],e.__webglMorphNormalsBuffers[k],3,0),f.__webglMorphTargetInfluences[i]=
h[k]):f.__webglMorphTargetInfluences[i]=0,i++}null!==d.program.uniforms.morphTargetInfluences&&q.uniform1fv(d.program.uniforms.morphTargetInfluences,f.__webglMorphTargetInfluences)}if(b){if(e.__webglCustomAttributesList){c=0;for(h=e.__webglCustomAttributesList.length;c<h;c++)b=e.__webglCustomAttributesList[c],0<=a[b.buffer.belongsToAttribute]&&q.setFloatAttribute(a[b.buffer.belongsToAttribute],b.buffer,b.size,0)}0<=a.color&&q.setFloatAttribute(a.color,e.__webglColorBuffer,3,0);0<=a.normal&&q.setFloatAttribute(a.normal,
e.__webglNormalBuffer,3,0);0<=a.tangent&&q.setFloatAttribute(a.tangent,e.__webglTangentBuffer,4,0);0<=a.uv&&q.setFloatAttribute(a.uv,e.__webglUVBuffer,2,0);0<=a.uv2&&q.setFloatAttribute(a.uv2,e.__webglUV2Buffer,2,0);d.skinning&&(0<=a.skinIndex&&0<=a.skinWeight)&&(q.setFloatAttribute(a.skinIndex,e.__webglSkinIndicesBuffer,4,0),q.setFloatAttribute(a.skinWeight,e.__webglSkinWeightsBuffer,4,0));0<=a.lineDistance&&q.setFloatAttribute(a.lineDistance,e.__webglLineDistanceBuffer,1,0)}f instanceof THREE.Mesh?
(d.wireframe?(q.setLineWidth(d.wireframeLinewidth),q.drawLineElements(e.__webglLineBuffer,e.__webglLineCount,0)):q.drawTriangleElements(e.__webglFaceBuffer,e.__webglFaceCount,0),B.info.render.calls++,B.info.render.vertices+=e.__webglFaceCount,B.info.render.faces+=e.__webglFaceCount/3):f instanceof THREE.Line?(q.setLineWidth(d.linewidth),f.type===THREE.LineStrip?q.drawLineStrip(e.__webglLineCount):q.drawLines(e.__webglLineCount),B.info.render.calls++):f instanceof THREE.ParticleSystem?(q.drawPoints(e.__webglParticleCount),
B.info.render.calls++,B.info.render.points+=e.__webglParticleCount):f instanceof THREE.Ribbon&&(q.drawTriangleStrip(e.__webglVertexCount),B.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,g,k,l,n=a.__lights,m=a.fog;N=-1;x=!0;!0===a.autoUpdate&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b.matrixWorldInverse.getInverse(b.matrixWorld);D.multiplyMatrices(b.projectionMatrix,
b.matrixWorldInverse);t.setFromMatrix(D);this.autoUpdateObjects&&this.initWebGLObjects(a);i(this.renderPluginsPre,a,b);B.info.render.calls=0;B.info.render.vertices=0;B.info.render.faces=0;B.info.render.points=0;q.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);l=a.__webglObjects;d=0;for(e=l.length;d<e;d++)if(g=l[d],k=g.object,g.id=d,g.render=!1,k.visible&&(!(k instanceof THREE.Mesh||k instanceof THREE.ParticleSystem)||!k.frustumCulled||
t.intersectsObject(k))){var p=k;p._modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,p.matrixWorld);p._normalMatrix.getNormalMatrix(p._modelViewMatrix);var p=g,s=p.buffer,r=void 0,u=r=void 0,u=p.object.material;if(u instanceof THREE.MeshFaceMaterial)r=s.materialIndex,r=u.materials[r],r.transparent?(p.transparent=r,p.opaque=null):(p.opaque=r,p.transparent=null);else if(r=u)r.transparent?(p.transparent=r,p.opaque=null):(p.opaque=r,p.transparent=null);g.render=!0;!0===this.sortObjects&&(null!==k.renderDepth?
g.z=k.renderDepth:(L.getPositionFromMatrix(k.matrixWorld),L.applyProjection(D),g.z=L.z))}this.sortObjects&&l.sort(f);l=a.__webglObjectsImmediate;d=0;for(e=l.length;d<e;d++)g=l[d],k=g.object,k.visible&&(k._modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,k.matrixWorld),k._normalMatrix.getNormalMatrix(k._modelViewMatrix),k=g.object.material,k.transparent?(g.transparent=k,g.opaque=null):(g.opaque=k,g.transparent=null));a.overrideMaterial?(d=a.overrideMaterial,q.setBlending(d.blending,d.blendEquation,
d.blendSrc,d.blendDst),q.setDepthTest(d.depthTest),q.setDepthWrite(d.depthWrite),q.setPolygonOffset(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits),h(a.__webglObjects,!1,"",b,n,m,!0,d),j(a.__webglObjectsImmediate,"",b,n,m,!1,d)):(d=null,q.setBlending(THREE.NoBlending),h(a.__webglObjects,!0,"opaque",b,n,m,!1,d),j(a.__webglObjectsImmediate,"opaque",b,n,m,!1,d),h(a.__webglObjects,!1,"transparent",b,n,m,!0,d),j(a.__webglObjectsImmediate,"transparent",b,n,m,!0,d));i(this.renderPluginsPost,
a,b);c&&(c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&c.minFilter!==THREE.LinearFilter)&&q.updateRenderTargetMipmap(c);q.setDepthTest(!0);q.setDepthWrite(!0)}};this.renderImmediateObject=function(a,b,c,d,e){var f=m(a,b,c,d,e);z=-1;q.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,q.getContext(),t):e.render(function(a){B.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=
[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=a.__objectsAdded[0],f=a,g=void 0,h=void 0,i=void 0,j=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,void 0!==b.geometry&&void 0===b.geometry.__webglInit&&(b.geometry.__webglInit=!0,b.geometry.addEventListener("dispose",P)),b instanceof THREE.Mesh)if(h=b.geometry,i=b.material,h instanceof THREE.Geometry){if(void 0===h.geometryGroups){var j=h,m=void 0,q=void 0,r=void 0,O=
void 0,t=void 0,u=void 0,w={},y=j.morphTargets.length,x=j.morphNormals.length,i=i instanceof THREE.MeshFaceMaterial;j.geometryGroups={};m=0;for(q=j.faces.length;m<q;m++)r=j.faces[m],O=i?r.materialIndex:0,void 0===w[O]&&(w[O]={hash:O,counter:0}),u=w[O].hash+"_"+w[O].counter,void 0===j.geometryGroups[u]&&(j.geometryGroups[u]={faces3:[],faces4:[],materialIndex:O,vertices:0,numMorphTargets:y,numMorphNormals:x}),t=r instanceof THREE.Face3?3:4,65535<j.geometryGroups[u].vertices+t&&(w[O].counter+=1,u=w[O].hash+
"_"+w[O].counter,void 0===j.geometryGroups[u]&&(j.geometryGroups[u]={faces3:[],faces4:[],materialIndex:O,vertices:0,numMorphTargets:y,numMorphNormals:x})),r instanceof THREE.Face3?j.geometryGroups[u].faces3.push(m):j.geometryGroups[u].faces4.push(m),j.geometryGroups[u].vertices+=t;j.geometryGroupsList=[];m=void 0;for(m in j.geometryGroups)j.geometryGroups[m].id=E++,j.geometryGroupsList.push(j.geometryGroups[m])}for(g in h.geometryGroups)j=h.geometryGroups[g],j.__webglVertexBuffer||(A.createBuffers(j),
A.initBuffers(j,b),h.verticesNeedUpdate=!0,h.morphTargetsNeedUpdate=!0,h.elementsNeedUpdate=!0,h.uvsNeedUpdate=!0,h.normalsNeedUpdate=!0,h.tangentsNeedUpdate=!0,h.colorsNeedUpdate=!0)}else h instanceof THREE.BufferGeometry&&d(h);else b instanceof THREE.Ribbon?(h=b.geometry,h.__webglVertexBuffer||(k.createBuffers(h),k.initBuffers(h,b),h.verticesNeedUpdate=!0,h.colorsNeedUpdate=!0,h.normalsNeedUpdate=!0)):b instanceof THREE.Line?(h=b.geometry,h.__webglVertexBuffer||(h instanceof THREE.Geometry?(G.createBuffers(h),
