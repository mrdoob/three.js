...
function(a){a.init(this);this.renderPluginsPre.push(a)};this.updateShadowMap=function(a,b){ea=null;ja=Z=pb=db=sa=-1;ec=!0;Ua=Da=-1;this.shadowMapPlugin.update(a,b)};var zb=function(a){a=a.target;a.removeEventListener("deallocate",zb);a.__webglInit=void 0;void 0!==a.__webglVertexBuffer&&j.deleteBuffer(a.__webglVertexBuffer);void 0!==a.__webglNormalBuffer&&j.deleteBuffer(a.__webglNormalBuffer);void 0!==a.__webglTangentBuffer&&j.deleteBuffer(a.__webglTangentBuffer);void 0!==a.__webglColorBuffer&&j.deleteBuffer(a.__webglColorBuffer);
void 0!==a.__webglUVBuffer&&j.deleteBuffer(a.__webglUVBuffer);void 0!==a.__webglUV2Buffer&&j.deleteBuffer(a.__webglUV2Buffer);void 0!==a.__webglSkinIndicesBuffer&&j.deleteBuffer(a.__webglSkinIndicesBuffer);void 0!==a.__webglSkinWeightsBuffer&&j.deleteBuffer(a.__webglSkinWeightsBuffer);void 0!==a.__webglFaceBuffer&&j.deleteBuffer(a.__webglFaceBuffer);void 0!==a.__webglLineBuffer&&j.deleteBuffer(a.__webglLineBuffer);void 0!==a.__webglLineDistanceBuffer&&j.deleteBuffer(a.__webglLineDistanceBuffer);if(void 0!==
a.geometryGroups)for(var c in a.geometryGroups){var d=a.geometryGroups[c];if(void 0!==d.numMorphTargets)for(var e=0,f=d.numMorphTargets;e<f;e++)j.deleteBuffer(d.__webglMorphTargetsBuffers[e]);if(void 0!==d.numMorphNormals){e=0;for(f=d.numMorphNormals;e<f;e++)j.deleteBuffer(d.__webglMorphNormalsBuffers[e])}b(d)}b(a);N.info.memory.geometries--},Wa=function(a){a=a.target;a.removeEventListener("deallocate",Wa);a.image&&a.image.__webglTextureCube?j.deleteTexture(a.image.__webglTextureCube):a.__webglInit&&
(a.__webglInit=!1,j.deleteTexture(a.__webglTexture));N.info.memory.textures--},nb=function(a){a=a.target;a.removeEventListener("deallocate",nb);if(a&&a.__webglTexture)if(j.deleteTexture(a.__webglTexture),a instanceof THREE.WebGLRenderTargetCube)for(var b=0;6>b;b++)j.deleteFramebuffer(a.__webglFramebuffer[b]),j.deleteRenderbuffer(a.__webglRenderbuffer[b]);else j.deleteFramebuffer(a.__webglFramebuffer),j.deleteRenderbuffer(a.__webglRenderbuffer);N.info.memory.textures--},hb=function(a){a=a.target;a.removeEventListener("deallocate",
...
k,n,m,l,p,r=3*a.count;for(p=0;p<r;p+=9)l=a.normalArray,d=l[p],e=l[p+1],f=l[p+2],g=l[p+3],i=l[p+4],n=l[p+5],h=l[p+6],k=l[p+7],m=l[p+8],d=(d+g+h)/3,e=(e+i+k)/3,f=(f+n+m)/3,l[p]=d,l[p+1]=e,l[p+2]=f,l[p+3]=d,l[p+4]=e,l[p+5]=f,l[p+6]=d,l[p+7]=e,l[p+8]=f}j.bufferData(j.ARRAY_BUFFER,a.normalArray,j.DYNAMIC_DRAW);j.enableVertexAttribArray(b.attributes.normal);j.vertexAttribPointer(b.attributes.normal,3,j.FLOAT,!1,0,0)}a.hasUvs&&c.map&&(j.bindBuffer(j.ARRAY_BUFFER,a.__webglUvBuffer),j.bufferData(j.ARRAY_BUFFER,
...
F(a,b,c,d,f),a=c.attributes,b=!1,d=16777215*e.id+2*c.id+(d.wireframe?1:0),d!==Z&&(Z=d,b=!0),b&&n(),f instanceof THREE.Mesh)if(f=e.attributes.index){d=e.offsets;1<d.length&&(b=!0);for(var c=0,g=d.length;c<g;c++){var h=d[c].index;if(b){var i=e.attributes.position,m=i.itemSize;j.bindBuffer(j.ARRAY_BUFFER,i.buffer);k(a.position);j.vertexAttribPointer(a.position,m,j.FLOAT,!1,0,4*h*m);m=e.attributes.normal;if(0<=a.normal&&m){var l=m.itemSize;j.bindBuffer(j.ARRAY_BUFFER,m.buffer);k(a.normal);j.vertexAttribPointer(a.normal,
l,j.FLOAT,!1,0,4*h*l)}m=e.attributes.uv;0<=a.uv&&m&&(l=m.itemSize,j.bindBuffer(j.ARRAY_BUFFER,m.buffer),k(a.uv),j.vertexAttribPointer(a.uv,l,j.FLOAT,!1,0,4*h*l));m=e.attributes.color;0<=a.color&&m&&(l=m.itemSize,j.bindBuffer(j.ARRAY_BUFFER,m.buffer),k(a.color),j.vertexAttribPointer(a.color,l,j.FLOAT,!1,0,4*h*l));m=e.attributes.tangent;0<=a.tangent&&m&&(l=m.itemSize,j.bindBuffer(j.ARRAY_BUFFER,m.buffer),k(a.tangent),j.vertexAttribPointer(a.tangent,l,j.FLOAT,!1,0,4*h*l));j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,
f.buffer)}j.drawElements(j.TRIANGLES,d[c].count,j.UNSIGNED_SHORT,2*d[c].start);N.info.render.calls++;N.info.render.vertices+=d[c].count;N.info.render.faces+=d[c].count/3}}else b&&(i=e.attributes.position,m=i.itemSize,j.bindBuffer(j.ARRAY_BUFFER,i.buffer),k(a.position),j.vertexAttribPointer(a.position,m,j.FLOAT,!1,0,0),m=e.attributes.normal,0<=a.normal&&m&&(l=m.itemSize,j.bindBuffer(j.ARRAY_BUFFER,m.buffer),k(a.normal),j.vertexAttribPointer(a.normal,l,j.FLOAT,!1,0,0)),m=e.attributes.uv,0<=a.uv&&m&&
(l=m.itemSize,j.bindBuffer(j.ARRAY_BUFFER,m.buffer),k(a.uv),j.vertexAttribPointer(a.uv,l,j.FLOAT,!1,0,0)),m=e.attributes.color,0<=a.color&&m&&(l=m.itemSize,j.bindBuffer(j.ARRAY_BUFFER,m.buffer),k(a.color),j.vertexAttribPointer(a.color,l,j.FLOAT,!1,0,0)),m=e.attributes.tangent,0<=a.tangent&&m&&(l=m.itemSize,j.bindBuffer(j.ARRAY_BUFFER,m.buffer),k(a.tangent),j.vertexAttribPointer(a.tangent,l,j.FLOAT,!1,0,0))),j.drawArrays(j.TRIANGLES,0,i.numItems/3),N.info.render.calls++,N.info.render.vertices+=i.numItems/
...
(j.bindBuffer(j.ARRAY_BUFFER,e.__webglMorphNormalsBuffers[h[i]]),k(c["morphNormal"+i]),j.vertexAttribPointer(c["morphNormal"+i],3,j.FLOAT,!1,0,0)),f.__webglMorphTargetInfluences[i]=g[h[i]],i++}else{h=[];g=f.morphTargetInfluences;var l,p=g.length;for(l=0;l<p;l++)i=g[l],0<i&&h.push([i,l]);h.length>d.numSupportedMorphTargets?(h.sort(m),h.length=d.numSupportedMorphTargets):h.length>d.numSupportedMorphNormals?h.sort(m):0===h.length&&h.push([0,0]);for(i=0;i<d.numSupportedMorphTargets;)h[i]?(l=h[i][1],0<=
c["morphTarget"+i]&&(j.bindBuffer(j.ARRAY_BUFFER,e.__webglMorphTargetsBuffers[l]),k(c["morphTarget"+i]),j.vertexAttribPointer(c["morphTarget"+i],3,j.FLOAT,!1,0,0)),0<=c["morphNormal"+i]&&d.morphNormals&&(j.bindBuffer(j.ARRAY_BUFFER,e.__webglMorphNormalsBuffers[l]),k(c["morphNormal"+i]),j.vertexAttribPointer(c["morphNormal"+i],3,j.FLOAT,!1,0,0)),f.__webglMorphTargetInfluences[i]=g[l]):f.__webglMorphTargetInfluences[i]=0,i++}null!==d.program.uniforms.morphTargetInfluences&&j.uniform1fv(d.program.uniforms.morphTargetInfluences,
...
e.__webglSkinIndicesBuffer),k(b.skinIndex),j.vertexAttribPointer(b.skinIndex,4,j.FLOAT,!1,0,0),j.bindBuffer(j.ARRAY_BUFFER,e.__webglSkinWeightsBuffer),k(b.skinWeight),j.vertexAttribPointer(b.skinWeight,4,j.FLOAT,!1,0,0));0<=b.lineDistance&&(j.bindBuffer(j.ARRAY_BUFFER,e.__webglLineDistanceBuffer),k(b.lineDistance),j.vertexAttribPointer(b.lineDistance,1,j.FLOAT,!1,0,0))}f instanceof THREE.Mesh?(d.wireframe?(d=d.wireframeLinewidth,d!==ma&&(j.lineWidth(d),ma=d),a&&j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,
e.__webglLineBuffer),j.drawElements(j.LINES,e.__webglLineCount,j.UNSIGNED_SHORT,0)):(a&&j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,e.__webglFaceBuffer),j.drawElements(j.TRIANGLES,e.__webglFaceCount,j.UNSIGNED_SHORT,0)),N.info.render.calls++,N.info.render.vertices+=e.__webglFaceCount,N.info.render.faces+=e.__webglFaceCount/3):f instanceof THREE.Line?(f=f.type===THREE.LineStrip?j.LINE_STRIP:j.LINES,d=d.linewidth,d!==ma&&(j.lineWidth(d),ma=d),j.drawArrays(f,0,e.__webglLineCount),N.info.render.calls++):f instanceof
THREE.ParticleSystem?(j.drawArrays(j.POINTS,0,e.__webglParticleCount),N.info.render.calls++,N.info.render.points+=e.__webglParticleCount):f instanceof THREE.Ribbon&&(j.drawArrays(j.TRIANGLE_STRIP,0,e.__webglVertexCount),N.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,i=a.__lights,k=a.fog;ja=-1;ec=!0;this.autoUpdateScene&&a.updateMatrixWorld();void 0===b.parent&&
...
[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=a.__objectsAdded[0],k=a,n=void 0,l=void 0,p=void 0,r=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,void 0!==b.geometry&&void 0===b.geometry.__webglInit&&(b.geometry.__webglInit=!0,b.geometry.addEventListener("deallocate",zb)),b instanceof THREE.Mesh)if(l=b.geometry,p=b.material,l instanceof THREE.Geometry){if(void 0===l.geometryGroups){var s=
l,y=void 0,z=void 0,A=void 0,C=void 0,D=void 0,F=void 0,G={},O=s.morphTargets.length,H=s.morphNormals.length,I=p instanceof THREE.MeshFaceMaterial;s.geometryGroups={};y=0;for(z=s.faces.length;y<z;y++)A=s.faces[y],C=I?A.materialIndex:0,void 0===G[C]&&(G[C]={hash:C,counter:0}),F=G[C].hash+"_"+G[C].counter,void 0===s.geometryGroups[F]&&(s.geometryGroups[F]={faces3:[],faces4:[],materialIndex:C,vertices:0,numMorphTargets:O,numMorphNormals:H}),D=A instanceof THREE.Face3?3:4,65535<s.geometryGroups[F].vertices+
D&&(G[C].counter+=1,F=G[C].hash+"_"+G[C].counter,void 0===s.geometryGroups[F]&&(s.geometryGroups[F]={faces3:[],faces4:[],materialIndex:C,vertices:0,numMorphTargets:O,numMorphNormals:H})),A instanceof THREE.Face3?s.geometryGroups[F].faces3.push(y):s.geometryGroups[F].faces4.push(y),s.geometryGroups[F].vertices+=D;s.geometryGroupsList=[];var K=void 0;for(K in s.geometryGroups)s.geometryGroups[K].id=oa++,s.geometryGroupsList.push(s.geometryGroups[K])}for(n in l.geometryGroups)if(r=l.geometryGroups[n],
!r.__webglVertexBuffer){var J=r;J.__webglVertexBuffer=j.createBuffer();J.__webglNormalBuffer=j.createBuffer();J.__webglTangentBuffer=j.createBuffer();J.__webglColorBuffer=j.createBuffer();J.__webglUVBuffer=j.createBuffer();J.__webglUV2Buffer=j.createBuffer();J.__webglSkinIndicesBuffer=j.createBuffer();J.__webglSkinWeightsBuffer=j.createBuffer();J.__webglFaceBuffer=j.createBuffer();J.__webglLineBuffer=j.createBuffer();var L=void 0,V=void 0;if(J.numMorphTargets){J.__webglMorphTargetsBuffers=[];L=0;
for(V=J.numMorphTargets;L<V;L++)J.__webglMorphTargetsBuffers.push(j.createBuffer())}if(J.numMorphNormals){J.__webglMorphNormalsBuffers=[];L=0;for(V=J.numMorphNormals;L<V;L++)J.__webglMorphNormalsBuffers.push(j.createBuffer())}N.info.memory.geometries++;d(r,b);l.verticesNeedUpdate=!0;l.morphTargetsNeedUpdate=!0;l.elementsNeedUpdate=!0;l.uvsNeedUpdate=!0;l.normalsNeedUpdate=!0;l.tangentsNeedUpdate=!0;l.colorsNeedUpdate=!0}}else l instanceof THREE.BufferGeometry&&h(l);else if(b instanceof THREE.Ribbon){if(l=
b.geometry,!l.__webglVertexBuffer){var M=l;M.__webglVertexBuffer=j.createBuffer();M.__webglColorBuffer=j.createBuffer();M.__webglNormalBuffer=j.createBuffer();N.info.memory.geometries++;var aa=l,Z=b,ea=aa.vertices.length;aa.__vertexArray=new Float32Array(3*ea);aa.__colorArray=new Float32Array(3*ea);aa.__normalArray=new Float32Array(3*ea);aa.__webglVertexCount=ea;c(aa,Z);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=!0;l.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(l=b.geometry,!l.__webglVertexBuffer){var R=
l;R.__webglVertexBuffer=j.createBuffer();R.__webglColorBuffer=j.createBuffer();R.__webglLineDistanceBuffer=j.createBuffer();N.info.memory.geometries++;var P=l,fa=b,X=P.vertices.length;P.__vertexArray=new Float32Array(3*X);P.__colorArray=new Float32Array(3*X);P.__lineDistanceArray=new Float32Array(1*X);P.__webglLineCount=X;c(P,fa);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=!0;l.lineDistancesNeedUpdate=!0}}else if(b instanceof THREE.ParticleSystem&&(l=b.geometry,!l.__webglVertexBuffer))if(l instanceof
THREE.Geometry){var $=l;$.__webglVertexBuffer=j.createBuffer();$.__webglColorBuffer=j.createBuffer();N.info.memory.geometries++;var ja=l,la=b,ka=ja.vertices.length;ja.__vertexArray=new Float32Array(3*ka);ja.__colorArray=new Float32Array(3*ka);ja.__sortArray=[];ja.__webglParticleCount=ka;c(ja,la);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=!0}else l instanceof THREE.BufferGeometry&&h(l);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(l=b.geometry,l instanceof THREE.BufferGeometry)q(k.__webglObjects,
l,b);else for(n in l.geometryGroups)r=l.geometryGroups[n],q(k.__webglObjects,r,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(l=b.geometry,q(k.__webglObjects,l,b)):b instanceof THREE.ImmediateRenderObject||b.immediateRenderCallback?k.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof THREE.Sprite?k.__webglSprites.push(b):b instanceof THREE.LensFlare&&k.__webglFlares.push(b);b.__webglActive=!0}a.__objectsAdded.splice(0,
1)}for(;a.__objectsRemoved.length;){var ca=a.__objectsRemoved[0],pa=a;ca instanceof THREE.Mesh||ca instanceof THREE.ParticleSystem||ca instanceof THREE.Ribbon||ca instanceof THREE.Line?x(pa.__webglObjects,ca):ca instanceof THREE.Sprite?t(pa.__webglSprites,ca):ca instanceof THREE.LensFlare?t(pa.__webglFlares,ca):(ca instanceof THREE.ImmediateRenderObject||ca.immediateRenderCallback)&&x(pa.__webglObjectsImmediate,ca);ca.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var sa=0,ya=a.__webglObjects.length;sa<
ya;sa++){var za=a.__webglObjects[sa].object,W=za.geometry,xa=void 0,Da=void 0,ma=void 0;if(za instanceof THREE.Mesh)if(W instanceof THREE.BufferGeometry)(W.verticesNeedUpdate||W.elementsNeedUpdate||W.uvsNeedUpdate||W.normalsNeedUpdate||W.colorsNeedUpdate||W.tangentsNeedUpdate)&&i(W,j.DYNAMIC_DRAW,!W.dynamic),W.verticesNeedUpdate=!1,W.elementsNeedUpdate=!1,W.uvsNeedUpdate=!1,W.normalsNeedUpdate=!1,W.colorsNeedUpdate=!1,W.tangentsNeedUpdate=!1;else{for(var Ea=0,Oa=W.geometryGroupsList.length;Ea<Oa;Ea++)if(xa=
W.geometryGroupsList[Ea],ma=e(za,xa),W.buffersNeedUpdate&&d(xa,za),Da=ma.attributes&&u(ma),W.verticesNeedUpdate||W.morphTargetsNeedUpdate||W.elementsNeedUpdate||W.uvsNeedUpdate||W.normalsNeedUpdate||W.colorsNeedUpdate||W.tangentsNeedUpdate||Da){var ta=xa,Ua=za,ua=j.DYNAMIC_DRAW,Ra=!W.dynamic,Ha=ma;if(ta.__inittedArrays){var Sa=f(Ha),mb=Ha.vertexColors?Ha.vertexColors:!1,nb=g(Ha),hb=Sa===THREE.SmoothShading,E=void 0,Y=void 0,Wa=void 0,Q=void 0,ob=void 0,cb=void 0,Va=void 0,Cb=void 0,db=void 0,pb=void 0,
qb=void 0,S=void 0,T=void 0,U=void 0,ra=void 0,Za=void 0,eb=void 0,fb=void 0,tb=void 0,gb=void 0,Pb=void 0,Qb=void 0,yb=void 0,Rb=void 0,Sb=void 0,Tb=void 0,Ab=void 0,Ub=void 0,Vb=void 0,Wb=void 0,Db=void 0,Xb=void 0,Yb=void 0,Zb=void 0,Eb=void 0,Aa=void 0,ec=void 0,mc=void 0,Fb=void 0,Gb=void 0,$a=void 0,kc=void 0,Xa=void 0,Ya=void 0,nc=void 0,fc=void 0,Pa=0,Ta=0,gc=0,hc=0,Hb=0,kb=0,Fa=0,rb=0,Qa=0,da=0,na=0,w=0,Ba=void 0,ab=ta.__vertexArray,Ob=ta.__uvArray,Ac=ta.__uv2Array,Ib=ta.__normalArray,Ka=
ta.__tangentArray,bb=ta.__colorArray,La=ta.__skinIndexArray,Ma=ta.__skinWeightArray,rc=ta.__morphTargetsArrays,cd=ta.__morphNormalsArrays,dd=ta.__webglCustomAttributesList,v=void 0,$b=ta.__faceArray,Bb=ta.__lineArray,ub=Ua.geometry,Ic=ub.elementsNeedUpdate,zc=ub.uvsNeedUpdate,Jc=ub.normalsNeedUpdate,$c=ub.tangentsNeedUpdate,ad=ub.colorsNeedUpdate,bd=ub.morphTargetsNeedUpdate,sc=ub.vertices,va=ta.faces3,wa=ta.faces4,lb=ub.faces,ed=ub.faceVertexUvs[0],fd=ub.faceVertexUvs[1],tc=ub.skinIndices,oc=ub.skinWeights,
pc=ub.morphTargets,Kc=ub.morphNormals;if(ub.verticesNeedUpdate){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],S=sc[Q.a],T=sc[Q.b],U=sc[Q.c],ab[Ta]=S.x,ab[Ta+1]=S.y,ab[Ta+2]=S.z,ab[Ta+3]=T.x,ab[Ta+4]=T.y,ab[Ta+5]=T.z,ab[Ta+6]=U.x,ab[Ta+7]=U.y,ab[Ta+8]=U.z,Ta+=9;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],S=sc[Q.a],T=sc[Q.b],U=sc[Q.c],ra=sc[Q.d],ab[Ta]=S.x,ab[Ta+1]=S.y,ab[Ta+2]=S.z,ab[Ta+3]=T.x,ab[Ta+4]=T.y,ab[Ta+5]=T.z,ab[Ta+6]=U.x,ab[Ta+7]=U.y,ab[Ta+8]=U.z,ab[Ta+9]=ra.x,ab[Ta+10]=ra.y,ab[Ta+11]=ra.z,Ta+=12;
j.bindBuffer(j.ARRAY_BUFFER,ta.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,ab,ua)}if(bd){$a=0;for(kc=pc.length;$a<kc;$a++){E=na=0;for(Y=va.length;E<Y;E++)nc=va[E],Q=lb[nc],S=pc[$a].vertices[Q.a],T=pc[$a].vertices[Q.b],U=pc[$a].vertices[Q.c],Xa=rc[$a],Xa[na]=S.x,Xa[na+1]=S.y,Xa[na+2]=S.z,Xa[na+3]=T.x,Xa[na+4]=T.y,Xa[na+5]=T.z,Xa[na+6]=U.x,Xa[na+7]=U.y,Xa[na+8]=U.z,Ha.morphNormals&&(hb?(fc=Kc[$a].vertexNormals[nc],gb=fc.a,Pb=fc.b,Qb=fc.c):Qb=Pb=gb=Kc[$a].faceNormals[nc],Ya=cd[$a],Ya[na]=gb.x,Ya[na+
1]=gb.y,Ya[na+2]=gb.z,Ya[na+3]=Pb.x,Ya[na+4]=Pb.y,Ya[na+5]=Pb.z,Ya[na+6]=Qb.x,Ya[na+7]=Qb.y,Ya[na+8]=Qb.z),na+=9;E=0;for(Y=wa.length;E<Y;E++)nc=wa[E],Q=lb[nc],S=pc[$a].vertices[Q.a],T=pc[$a].vertices[Q.b],U=pc[$a].vertices[Q.c],ra=pc[$a].vertices[Q.d],Xa=rc[$a],Xa[na]=S.x,Xa[na+1]=S.y,Xa[na+2]=S.z,Xa[na+3]=T.x,Xa[na+4]=T.y,Xa[na+5]=T.z,Xa[na+6]=U.x,Xa[na+7]=U.y,Xa[na+8]=U.z,Xa[na+9]=ra.x,Xa[na+10]=ra.y,Xa[na+11]=ra.z,Ha.morphNormals&&(hb?(fc=Kc[$a].vertexNormals[nc],gb=fc.a,Pb=fc.b,Qb=fc.c,yb=fc.d):
yb=Qb=Pb=gb=Kc[$a].faceNormals[nc],Ya=cd[$a],Ya[na]=gb.x,Ya[na+1]=gb.y,Ya[na+2]=gb.z,Ya[na+3]=Pb.x,Ya[na+4]=Pb.y,Ya[na+5]=Pb.z,Ya[na+6]=Qb.x,Ya[na+7]=Qb.y,Ya[na+8]=Qb.z,Ya[na+9]=yb.x,Ya[na+10]=yb.y,Ya[na+11]=yb.z),na+=12;j.bindBuffer(j.ARRAY_BUFFER,ta.__webglMorphTargetsBuffers[$a]);j.bufferData(j.ARRAY_BUFFER,rc[$a],ua);Ha.morphNormals&&(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglMorphNormalsBuffers[$a]),j.bufferData(j.ARRAY_BUFFER,cd[$a],ua))}}if(oc.length){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],Ub=
oc[Q.a],Vb=oc[Q.b],Wb=oc[Q.c],Ma[da]=Ub.x,Ma[da+1]=Ub.y,Ma[da+2]=Ub.z,Ma[da+3]=Ub.w,Ma[da+4]=Vb.x,Ma[da+5]=Vb.y,Ma[da+6]=Vb.z,Ma[da+7]=Vb.w,Ma[da+8]=Wb.x,Ma[da+9]=Wb.y,Ma[da+10]=Wb.z,Ma[da+11]=Wb.w,Xb=tc[Q.a],Yb=tc[Q.b],Zb=tc[Q.c],La[da]=Xb.x,La[da+1]=Xb.y,La[da+2]=Xb.z,La[da+3]=Xb.w,La[da+4]=Yb.x,La[da+5]=Yb.y,La[da+6]=Yb.z,La[da+7]=Yb.w,La[da+8]=Zb.x,La[da+9]=Zb.y,La[da+10]=Zb.z,La[da+11]=Zb.w,da+=12;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],Ub=oc[Q.a],Vb=oc[Q.b],Wb=oc[Q.c],Db=oc[Q.d],Ma[da]=Ub.x,
Ma[da+1]=Ub.y,Ma[da+2]=Ub.z,Ma[da+3]=Ub.w,Ma[da+4]=Vb.x,Ma[da+5]=Vb.y,Ma[da+6]=Vb.z,Ma[da+7]=Vb.w,Ma[da+8]=Wb.x,Ma[da+9]=Wb.y,Ma[da+10]=Wb.z,Ma[da+11]=Wb.w,Ma[da+12]=Db.x,Ma[da+13]=Db.y,Ma[da+14]=Db.z,Ma[da+15]=Db.w,Xb=tc[Q.a],Yb=tc[Q.b],Zb=tc[Q.c],Eb=tc[Q.d],La[da]=Xb.x,La[da+1]=Xb.y,La[da+2]=Xb.z,La[da+3]=Xb.w,La[da+4]=Yb.x,La[da+5]=Yb.y,La[da+6]=Yb.z,La[da+7]=Yb.w,La[da+8]=Zb.x,La[da+9]=Zb.y,La[da+10]=Zb.z,La[da+11]=Zb.w,La[da+12]=Eb.x,La[da+13]=Eb.y,La[da+14]=Eb.z,La[da+15]=Eb.w,da+=16;0<da&&
(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglSkinIndicesBuffer),j.bufferData(j.ARRAY_BUFFER,La,ua),j.bindBuffer(j.ARRAY_BUFFER,ta.__webglSkinWeightsBuffer),j.bufferData(j.ARRAY_BUFFER,Ma,ua))}if(ad&&mb){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],Va=Q.vertexColors,Cb=Q.color,3===Va.length&&mb===THREE.VertexColors?(Rb=Va[0],Sb=Va[1],Tb=Va[2]):Tb=Sb=Rb=Cb,bb[Qa]=Rb.r,bb[Qa+1]=Rb.g,bb[Qa+2]=Rb.b,bb[Qa+3]=Sb.r,bb[Qa+4]=Sb.g,bb[Qa+5]=Sb.b,bb[Qa+6]=Tb.r,bb[Qa+7]=Tb.g,bb[Qa+8]=Tb.b,Qa+=9;E=0;for(Y=wa.length;E<Y;E++)Q=
lb[wa[E]],Va=Q.vertexColors,Cb=Q.color,4===Va.length&&mb===THREE.VertexColors?(Rb=Va[0],Sb=Va[1],Tb=Va[2],Ab=Va[3]):Ab=Tb=Sb=Rb=Cb,bb[Qa]=Rb.r,bb[Qa+1]=Rb.g,bb[Qa+2]=Rb.b,bb[Qa+3]=Sb.r,bb[Qa+4]=Sb.g,bb[Qa+5]=Sb.b,bb[Qa+6]=Tb.r,bb[Qa+7]=Tb.g,bb[Qa+8]=Tb.b,bb[Qa+9]=Ab.r,bb[Qa+10]=Ab.g,bb[Qa+11]=Ab.b,Qa+=12;0<Qa&&(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglColorBuffer),j.bufferData(j.ARRAY_BUFFER,bb,ua))}if($c&&ub.hasTangents){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],db=Q.vertexTangents,Za=db[0],eb=db[1],
fb=db[2],Ka[Fa]=Za.x,Ka[Fa+1]=Za.y,Ka[Fa+2]=Za.z,Ka[Fa+3]=Za.w,Ka[Fa+4]=eb.x,Ka[Fa+5]=eb.y,Ka[Fa+6]=eb.z,Ka[Fa+7]=eb.w,Ka[Fa+8]=fb.x,Ka[Fa+9]=fb.y,Ka[Fa+10]=fb.z,Ka[Fa+11]=fb.w,Fa+=12;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],db=Q.vertexTangents,Za=db[0],eb=db[1],fb=db[2],tb=db[3],Ka[Fa]=Za.x,Ka[Fa+1]=Za.y,Ka[Fa+2]=Za.z,Ka[Fa+3]=Za.w,Ka[Fa+4]=eb.x,Ka[Fa+5]=eb.y,Ka[Fa+6]=eb.z,Ka[Fa+7]=eb.w,Ka[Fa+8]=fb.x,Ka[Fa+9]=fb.y,Ka[Fa+10]=fb.z,Ka[Fa+11]=fb.w,Ka[Fa+12]=tb.x,Ka[Fa+13]=tb.y,Ka[Fa+14]=tb.z,Ka[Fa+15]=
tb.w,Fa+=16;j.bindBuffer(j.ARRAY_BUFFER,ta.__webglTangentBuffer);j.bufferData(j.ARRAY_BUFFER,Ka,ua)}if(Jc&&Sa){E=0;for(Y=va.length;E<Y;E++)if(Q=lb[va[E]],ob=Q.vertexNormals,cb=Q.normal,3===ob.length&&hb)for(Aa=0;3>Aa;Aa++)mc=ob[Aa],Ib[kb]=mc.x,Ib[kb+1]=mc.y,Ib[kb+2]=mc.z,kb+=3;else for(Aa=0;3>Aa;Aa++)Ib[kb]=cb.x,Ib[kb+1]=cb.y,Ib[kb+2]=cb.z,kb+=3;E=0;for(Y=wa.length;E<Y;E++)if(Q=lb[wa[E]],ob=Q.vertexNormals,cb=Q.normal,4===ob.length&&hb)for(Aa=0;4>Aa;Aa++)mc=ob[Aa],Ib[kb]=mc.x,Ib[kb+1]=mc.y,Ib[kb+
2]=mc.z,kb+=3;else for(Aa=0;4>Aa;Aa++)Ib[kb]=cb.x,Ib[kb+1]=cb.y,Ib[kb+2]=cb.z,kb+=3;j.bindBuffer(j.ARRAY_BUFFER,ta.__webglNormalBuffer);j.bufferData(j.ARRAY_BUFFER,Ib,ua)}if(zc&&ed&&nb){E=0;for(Y=va.length;E<Y;E++)if(Wa=va[E],pb=ed[Wa],void 0!==pb)for(Aa=0;3>Aa;Aa++)Fb=pb[Aa],Ob[gc]=Fb.x,Ob[gc+1]=Fb.y,gc+=2;E=0;for(Y=wa.length;E<Y;E++)if(Wa=wa[E],pb=ed[Wa],void 0!==pb)for(Aa=0;4>Aa;Aa++)Fb=pb[Aa],Ob[gc]=Fb.x,Ob[gc+1]=Fb.y,gc+=2;0<gc&&(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglUVBuffer),j.bufferData(j.ARRAY_BUFFER,
Ob,ua))}if(zc&&fd&&nb){E=0;for(Y=va.length;E<Y;E++)if(Wa=va[E],qb=fd[Wa],void 0!==qb)for(Aa=0;3>Aa;Aa++)Gb=qb[Aa],Ac[hc]=Gb.x,Ac[hc+1]=Gb.y,hc+=2;E=0;for(Y=wa.length;E<Y;E++)if(Wa=wa[E],qb=fd[Wa],void 0!==qb)for(Aa=0;4>Aa;Aa++)Gb=qb[Aa],Ac[hc]=Gb.x,Ac[hc+1]=Gb.y,hc+=2;0<hc&&(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglUV2Buffer),j.bufferData(j.ARRAY_BUFFER,Ac,ua))}if(Ic){E=0;for(Y=va.length;E<Y;E++)$b[Hb]=Pa,$b[Hb+1]=Pa+1,$b[Hb+2]=Pa+2,Hb+=3,Bb[rb]=Pa,Bb[rb+1]=Pa+1,Bb[rb+2]=Pa,Bb[rb+3]=Pa+2,Bb[rb+4]=Pa+
1,Bb[rb+5]=Pa+2,rb+=6,Pa+=3;E=0;for(Y=wa.length;E<Y;E++)$b[Hb]=Pa,$b[Hb+1]=Pa+1,$b[Hb+2]=Pa+3,$b[Hb+3]=Pa+1,$b[Hb+4]=Pa+2,$b[Hb+5]=Pa+3,Hb+=6,Bb[rb]=Pa,Bb[rb+1]=Pa+1,Bb[rb+2]=Pa,Bb[rb+3]=Pa+3,Bb[rb+4]=Pa+1,Bb[rb+5]=Pa+2,Bb[rb+6]=Pa+2,Bb[rb+7]=Pa+3,rb+=8,Pa+=4;j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,ta.__webglFaceBuffer);j.bufferData(j.ELEMENT_ARRAY_BUFFER,$b,ua);j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,ta.__webglLineBuffer);j.bufferData(j.ELEMENT_ARRAY_BUFFER,Bb,ua)}if(dd){Aa=0;for(ec=dd.length;Aa<ec;Aa++)if(v=
dd[Aa],v.__original.needsUpdate){w=0;if(1===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],v.array[w]=v.value[Q.a],v.array[w+1]=v.value[Q.b],v.array[w+2]=v.value[Q.c],w+=3;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],v.array[w]=v.value[Q.a],v.array[w+1]=v.value[Q.b],v.array[w+2]=v.value[Q.c],v.array[w+3]=v.value[Q.d],w+=4}else{if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],v.array[w]=Ba,v.array[w+1]=Ba,v.array[w+2]=Ba,w+=3;E=0;for(Y=
wa.length;E<Y;E++)Ba=v.value[wa[E]],v.array[w]=Ba,v.array[w+1]=Ba,v.array[w+2]=Ba,v.array[w+3]=Ba,w+=4}}else if(2===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=U.x,v.array[w+5]=U.y,w+=6;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],ra=v.value[Q.d],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+
2]=T.x,v.array[w+3]=T.y,v.array[w+4]=U.x,v.array[w+5]=U.y,v.array[w+6]=ra.x,v.array[w+7]=ra.y,w+=8}else{if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)U=T=S=Ba=v.value[va[E]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=U.x,v.array[w+5]=U.y,w+=6;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=U.x,v.array[w+5]=U.y,v.array[w+6]=ra.x,v.array[w+7]=ra.y,w+=8}}else if(3===v.size){var ba;
ba="c"===v.type?["r","g","b"]:["x","y","z"];if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],w+=9;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],ra=v.value[Q.d],v.array[w]=S[ba[0]],v.array[w+
1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],v.array[w+9]=ra[ba[0]],v.array[w+10]=ra[ba[1]],v.array[w+11]=ra[ba[2]],w+=12}else if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)U=T=S=Ba=v.value[va[E]],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+
8]=U[ba[2]],w+=9;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],v.array[w+9]=ra[ba[0]],v.array[w+10]=ra[ba[1]],v.array[w+11]=ra[ba[2]],w+=12}else if("faceVertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],S=Ba[0],T=Ba[1],U=Ba[2],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+
2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],w+=9;E=0;for(Y=wa.length;E<Y;E++)Ba=v.value[wa[E]],S=Ba[0],T=Ba[1],U=Ba[2],ra=Ba[3],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],v.array[w+9]=ra[ba[0]],v.array[w+10]=ra[ba[1]],v.array[w+11]=ra[ba[2]],w+=12}}else if(4===
v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,w+=12;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],ra=v.value[Q.d],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+
...
11]=U.w,w+=12;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,v.array[w+12]=ra.x,v.array[w+13]=ra.y,v.array[w+14]=ra.z,v.array[w+15]=ra.w,w+=16}else if("faceVertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],S=Ba[0],T=Ba[1],U=Ba[2],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+
2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,w+=12;E=0;for(Y=wa.length;E<Y;E++)Ba=v.value[wa[E]],S=Ba[0],T=Ba[1],U=Ba[2],ra=Ba[3],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,v.array[w+12]=ra.x,v.array[w+13]=ra.y,v.array[w+14]=
ra.z,v.array[w+15]=ra.w,w+=16}j.bindBuffer(j.ARRAY_BUFFER,v.buffer);j.bufferData(j.ARRAY_BUFFER,v.array,ua)}}Ra&&(delete ta.__inittedArrays,delete ta.__colorArray,delete ta.__normalArray,delete ta.__tangentArray,delete ta.__uvArray,delete ta.__uv2Array,delete ta.__faceArray,delete ta.__vertexArray,delete ta.__lineArray,delete ta.__skinIndexArray,delete ta.__skinWeightArray)}}W.verticesNeedUpdate=!1;W.morphTargetsNeedUpdate=!1;W.elementsNeedUpdate=!1;W.uvsNeedUpdate=!1;W.normalsNeedUpdate=!1;W.colorsNeedUpdate=
!1;W.tangentsNeedUpdate=!1;W.buffersNeedUpdate=!1;ma.attributes&&B(ma)}else if(za instanceof THREE.Ribbon){ma=e(za,W);Da=ma.attributes&&u(ma);if(W.verticesNeedUpdate||W.colorsNeedUpdate||W.normalsNeedUpdate||Da){var Jb=W,Lc=j.DYNAMIC_DRAW,Bc=void 0,Cc=void 0,Dc=void 0,Mc=void 0,Ca=void 0,Nc=void 0,Oc=void 0,Pc=void 0,ld=void 0,ib=void 0,wc=void 0,Ia=void 0,vb=void 0,md=Jb.vertices,nd=Jb.colors,od=Jb.normals,xd=md.length,yd=nd.length,zd=od.length,Qc=Jb.__vertexArray,Rc=Jb.__colorArray,Sc=Jb.__normalArray,
Ad=Jb.colorsNeedUpdate,Bd=Jb.normalsNeedUpdate,gd=Jb.__webglCustomAttributesList;if(Jb.verticesNeedUpdate){for(Bc=0;Bc<xd;Bc++)Mc=md[Bc],Ca=3*Bc,Qc[Ca]=Mc.x,Qc[Ca+1]=Mc.y,Qc[Ca+2]=Mc.z;j.bindBuffer(j.ARRAY_BUFFER,Jb.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,Qc,Lc)}if(Ad){for(Cc=0;Cc<yd;Cc++)Nc=nd[Cc],Ca=3*Cc,Rc[Ca]=Nc.r,Rc[Ca+1]=Nc.g,Rc[Ca+2]=Nc.b;j.bindBuffer(j.ARRAY_BUFFER,Jb.__webglColorBuffer);j.bufferData(j.ARRAY_BUFFER,Rc,Lc)}if(Bd){for(Dc=0;Dc<zd;Dc++)Oc=od[Dc],Ca=3*Dc,Sc[Ca]=Oc.x,Sc[Ca+
1]=Oc.y,Sc[Ca+2]=Oc.z;j.bindBuffer(j.ARRAY_BUFFER,Jb.__webglNormalBuffer);j.bufferData(j.ARRAY_BUFFER,Sc,Lc)}if(gd){Pc=0;for(ld=gd.length;Pc<ld;Pc++)if(Ia=gd[Pc],Ia.needsUpdate&&(void 0===Ia.boundTo||"vertices"===Ia.boundTo)){Ca=0;wc=Ia.value.length;if(1===Ia.size)for(ib=0;ib<wc;ib++)Ia.array[ib]=Ia.value[ib];else if(2===Ia.size)for(ib=0;ib<wc;ib++)vb=Ia.value[ib],Ia.array[Ca]=vb.x,Ia.array[Ca+1]=vb.y,Ca+=2;else if(3===Ia.size)if("c"===Ia.type)for(ib=0;ib<wc;ib++)vb=Ia.value[ib],Ia.array[Ca]=vb.r,
Ia.array[Ca+1]=vb.g,Ia.array[Ca+2]=vb.b,Ca+=3;else for(ib=0;ib<wc;ib++)vb=Ia.value[ib],Ia.array[Ca]=vb.x,Ia.array[Ca+1]=vb.y,Ia.array[Ca+2]=vb.z,Ca+=3;else if(4===Ia.size)for(ib=0;ib<wc;ib++)vb=Ia.value[ib],Ia.array[Ca]=vb.x,Ia.array[Ca+1]=vb.y,Ia.array[Ca+2]=vb.z,Ia.array[Ca+3]=vb.w,Ca+=4;j.bindBuffer(j.ARRAY_BUFFER,Ia.buffer);j.bufferData(j.ARRAY_BUFFER,Ia.array,Lc)}}}W.verticesNeedUpdate=!1;W.colorsNeedUpdate=!1;W.normalsNeedUpdate=!1;ma.attributes&&B(ma)}else if(za instanceof THREE.Line){ma=e(za,
W);Da=ma.attributes&&u(ma);if(W.verticesNeedUpdate||W.colorsNeedUpdate||W.lineDistancesNeedUpdate||Da){var Kb=W,Tc=j.DYNAMIC_DRAW,Ec=void 0,Fc=void 0,Gc=void 0,Uc=void 0,Na=void 0,Vc=void 0,pd=Kb.vertices,qd=Kb.colors,rd=Kb.lineDistances,Cd=pd.length,Dd=qd.length,Ed=rd.length,Wc=Kb.__vertexArray,Xc=Kb.__colorArray,sd=Kb.__lineDistanceArray,Fd=Kb.colorsNeedUpdate,Gd=Kb.lineDistancesNeedUpdate,hd=Kb.__webglCustomAttributesList,Yc=void 0,td=void 0,jb=void 0,xc=void 0,wb=void 0,Ja=void 0;if(Kb.verticesNeedUpdate){for(Ec=
0;Ec<Cd;Ec++)Uc=pd[Ec],Na=3*Ec,Wc[Na]=Uc.x,Wc[Na+1]=Uc.y,Wc[Na+2]=Uc.z;j.bindBuffer(j.ARRAY_BUFFER,Kb.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,Wc,Tc)}if(Fd){for(Fc=0;Fc<Dd;Fc++)Vc=qd[Fc],Na=3*Fc,Xc[Na]=Vc.r,Xc[Na+1]=Vc.g,Xc[Na+2]=Vc.b;j.bindBuffer(j.ARRAY_BUFFER,Kb.__webglColorBuffer);j.bufferData(j.ARRAY_BUFFER,Xc,Tc)}if(Gd){for(Gc=0;Gc<Ed;Gc++)sd[Gc]=rd[Gc];j.bindBuffer(j.ARRAY_BUFFER,Kb.__webglLineDistanceBuffer);j.bufferData(j.ARRAY_BUFFER,sd,Tc)}if(hd){Yc=0;for(td=hd.length;Yc<td;Yc++)if(Ja=
hd[Yc],Ja.needsUpdate&&(void 0===Ja.boundTo||"vertices"===Ja.boundTo)){Na=0;xc=Ja.value.length;if(1===Ja.size)for(jb=0;jb<xc;jb++)Ja.array[jb]=Ja.value[jb];else if(2===Ja.size)for(jb=0;jb<xc;jb++)wb=Ja.value[jb],Ja.array[Na]=wb.x,Ja.array[Na+1]=wb.y,Na+=2;else if(3===Ja.size)if("c"===Ja.type)for(jb=0;jb<xc;jb++)wb=Ja.value[jb],Ja.array[Na]=wb.r,Ja.array[Na+1]=wb.g,Ja.array[Na+2]=wb.b,Na+=3;else for(jb=0;jb<xc;jb++)wb=Ja.value[jb],Ja.array[Na]=wb.x,Ja.array[Na+1]=wb.y,Ja.array[Na+2]=wb.z,Na+=3;else if(4===
Ja.size)for(jb=0;jb<xc;jb++)wb=Ja.value[jb],Ja.array[Na]=wb.x,Ja.array[Na+1]=wb.y,Ja.array[Na+2]=wb.z,Ja.array[Na+3]=wb.w,Na+=4;j.bindBuffer(j.ARRAY_BUFFER,Ja.buffer);j.bufferData(j.ARRAY_BUFFER,Ja.array,Tc)}}}W.verticesNeedUpdate=!1;W.colorsNeedUpdate=!1;W.lineDistancesNeedUpdate=!1;ma.attributes&&B(ma)}else if(za instanceof THREE.ParticleSystem)if(W instanceof THREE.BufferGeometry)(W.verticesNeedUpdate||W.colorsNeedUpdate)&&i(W,j.DYNAMIC_DRAW,!W.dynamic),W.verticesNeedUpdate=!1,W.colorsNeedUpdate=
!1;else{ma=e(za,W);Da=ma.attributes&&u(ma);if(W.verticesNeedUpdate||W.colorsNeedUpdate||za.sortParticles||Da){var ac=W,id=j.DYNAMIC_DRAW,Hc=za,xb=void 0,bc=void 0,cc=void 0,ia=void 0,dc=void 0,qc=void 0,Zc=ac.vertices,jd=Zc.length,kd=ac.colors,ud=kd.length,uc=ac.__vertexArray,vc=ac.__colorArray,ic=ac.__sortArray,vd=ac.verticesNeedUpdate,wd=ac.colorsNeedUpdate,jc=ac.__webglCustomAttributesList,Mb=void 0,yc=void 0,qa=void 0,Nb=void 0,Ga=void 0,ga=void 0;if(Hc.sortParticles){sb.copy(lc);sb.multiplySelf(Hc.matrixWorld);
for(xb=0;xb<jd;xb++)cc=Zc[xb],Lb.copy(cc),sb.multiplyVector3(Lb),ic[xb]=[Lb.z,xb];ic.sort(m);for(xb=0;xb<jd;xb++)cc=Zc[ic[xb][1]],ia=3*xb,uc[ia]=cc.x,uc[ia+1]=cc.y,uc[ia+2]=cc.z;for(bc=0;bc<ud;bc++)ia=3*bc,qc=kd[ic[bc][1]],vc[ia]=qc.r,vc[ia+1]=qc.g,vc[ia+2]=qc.b;if(jc){Mb=0;for(yc=jc.length;Mb<yc;Mb++)if(ga=jc[Mb],void 0===ga.boundTo||"vertices"===ga.boundTo)if(ia=0,Nb=ga.value.length,1===ga.size)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],ga.array[qa]=ga.value[dc];else if(2===ga.size)for(qa=0;qa<Nb;qa++)dc=
ic[qa][1],Ga=ga.value[dc],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ia+=2;else if(3===ga.size)if("c"===ga.type)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ia]=Ga.r,ga.array[ia+1]=Ga.g,ga.array[ia+2]=Ga.b,ia+=3;else for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ga.array[ia+2]=Ga.z,ia+=3;else if(4===ga.size)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ga.array[ia+2]=Ga.z,ga.array[ia+3]=Ga.w,ia+=4}}else{if(vd)for(xb=
0;xb<jd;xb++)cc=Zc[xb],ia=3*xb,uc[ia]=cc.x,uc[ia+1]=cc.y,uc[ia+2]=cc.z;if(wd)for(bc=0;bc<ud;bc++)qc=kd[bc],ia=3*bc,vc[ia]=qc.r,vc[ia+1]=qc.g,vc[ia+2]=qc.b;if(jc){Mb=0;for(yc=jc.length;Mb<yc;Mb++)if(ga=jc[Mb],ga.needsUpdate&&(void 0===ga.boundTo||"vertices"===ga.boundTo))if(Nb=ga.value.length,ia=0,1===ga.size)for(qa=0;qa<Nb;qa++)ga.array[qa]=ga.value[qa];else if(2===ga.size)for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ia+=2;else if(3===ga.size)if("c"===ga.type)for(qa=0;qa<
Nb;qa++)Ga=ga.value[qa],ga.array[ia]=Ga.r,ga.array[ia+1]=Ga.g,ga.array[ia+2]=Ga.b,ia+=3;else for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ga.array[ia+2]=Ga.z,ia+=3;else if(4===ga.size)for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ga.array[ia+2]=Ga.z,ga.array[ia+3]=Ga.w,ia+=4}}if(vd||Hc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,ac.__webglVertexBuffer),j.bufferData(j.ARRAY_BUFFER,uc,id);if(wd||Hc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,ac.__webglColorBuffer),
j.bufferData(j.ARRAY_BUFFER,vc,id);if(jc){Mb=0;for(yc=jc.length;Mb<yc;Mb++)if(ga=jc[Mb],ga.needsUpdate||Hc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,ga.buffer),j.bufferData(j.ARRAY_BUFFER,ga.array,id)}}W.verticesNeedUpdate=!1;W.colorsNeedUpdate=!1;ma.attributes&&B(ma)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h;a.addEventListener("deallocate",hb);var i,k,m,n,l;a instanceof THREE.MeshDepthMaterial?l="depth":a instanceof THREE.MeshNormalMaterial?l="normal":a instanceof THREE.MeshBasicMaterial?
l="basic":a instanceof THREE.MeshLambertMaterial?l="lambert":a instanceof THREE.MeshPhongMaterial?l="phong":a instanceof THREE.LineBasicMaterial?l="basic":a instanceof THREE.LineDashedMaterial?l="dashed":a instanceof THREE.ParticleBasicMaterial&&(l="particle_basic");if(l){var p=THREE.ShaderLib[l];a.uniforms=THREE.UniformsUtils.clone(p.uniforms);a.vertexShader=p.vertexShader;a.fragmentShader=p.fragmentShader}var r,s,q;e=g=s=q=p=0;for(f=b.length;e<f;e++)r=b[e],r.onlyShadow||(r instanceof THREE.DirectionalLight&&
g++,r instanceof THREE.PointLight&&s++,r instanceof THREE.SpotLight&&q++,r instanceof THREE.HemisphereLight&&p++);e=g;f=s;g=q;h=p;p=r=0;for(q=b.length;p<q;p++)s=b[p],s.castShadow&&(s instanceof THREE.SpotLight&&r++,s instanceof THREE.DirectionalLight&&!s.shadowCascade&&r++);n=r;Va&&d&&d.useVertexTexture?m=1024:(b=j.getParameter(j.MAX_VERTEX_UNIFORM_VECTORS),b=Math.floor((b-20)/4),void 0!==d&&d instanceof THREE.SkinnedMesh&&(b=Math.min(d.bones.length,b),b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+
d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")),m=b);a:{s=a.fragmentShader;q=a.vertexShader;p=a.uniforms;b=a.attributes;r=a.defines;var c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,fogExp:c instanceof THREE.FogExp2,sizeAttenuation:a.sizeAttenuation,skinning:a.skinning,maxBones:m,useVertexTexture:Va&&d&&d.useVertexTexture,boneTextureWidth:d&&
...
doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,x,d=[];l?d.push(l):(d.push(s),d.push(q));for(u in r)d.push(u),d.push(r[u]);for(t in c)d.push(t),d.push(c[t]);l=d.join();t=0;for(u=O.length;t<u;t++)if(d=O[t],d.code===l){d.usedTimes++;k=d.program;break a}t="SHADOWMAP_TYPE_BASIC";c.shadowMapType===THREE.PCFShadowMap?t="SHADOWMAP_TYPE_PCF":c.shadowMapType===THREE.PCFSoftShadowMap&&(t="SHADOWMAP_TYPE_PCF_SOFT");u=[];for(x in r)d=r[x],!1!==d&&(d="#define "+x+" "+d,u.push(d));
