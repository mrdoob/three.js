...
m;g++)if(oa=J.objects[g].object,eb=oa.matrixWorld,j=0,oa instanceof THREE.Mesh){Ma=oa.geometry;ia=Ma.vertices;za=Ma.faces;Ma=Ma.faceVertexUvs;M.getInverse(eb);M.transpose();Sa=oa.material instanceof THREE.MeshFaceMaterial;fb=!0===Sa?oa.material:null;H=0;for(ca=ia.length;H<ca;H++)i=b(),i.positionWorld.copy(ia[H]),eb.multiplyVector3(i.positionWorld),i.positionScreen.copy(i.positionWorld),L.multiplyVector4(i.positionScreen),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,
i.visible=i.positionScreen.z>aa&&i.positionScreen.z<ga;ia=0;for(H=za.length;ia<H;ia++)if(ca=za[ia],vb=!0===Sa?fb.materials[ca.materialIndex]:oa.material,void 0!==vb){da=vb.side;if(ca instanceof THREE.Face3)if(Z=l[ca.a],ja=l[ca.b],ba=l[ca.c],!0===Z.visible&&!0===ja.visible&&!0===ba.visible)if(Ia=0>(ba.positionScreen.x-Z.positionScreen.x)*(ja.positionScreen.y-Z.positionScreen.y)-(ba.positionScreen.y-Z.positionScreen.y)*(ja.positionScreen.x-Z.positionScreen.x),da===THREE.DoubleSide||Ia===(da===THREE.FrontSide))p===
...
eb.multiplyVector3(n.centroidWorld);n.centroidScreen.copy(n.centroidWorld);L.multiplyVector3(n.centroidScreen);ba=ca.vertexNormals;Z=0;for(ja=ba.length;Z<ja;Z++)qa=n.vertexNormalsWorld[Z],qa.copy(ba[Z]),!1===Ia&&(da===THREE.BackSide||da===THREE.DoubleSide)&&qa.negate(),M.multiplyVector3(qa).normalize();n.vertexNormalsLength=ba.length;Z=0;for(ja=Ma.length;Z<ja;Z++)if(qa=Ma[Z][ia],void 0!==qa){da=0;for(ba=qa.length;da<ba;da++)n.uvs[Z][da]=qa[da]}n.color=ca.color;n.material=vb;n.z=n.centroidScreen.z;
J.elements.push(n)}}else if(oa instanceof THREE.Line){I.multiply(L,eb);ia=oa.geometry.vertices;Z=b();Z.positionScreen.copy(ia[0]);I.multiplyVector4(Z.positionScreen);eb=oa.type===THREE.LinePieces?2:1;H=1;for(ca=ia.length;H<ca;H++)Z=b(),Z.positionScreen.copy(ia[H]),I.multiplyVector4(Z.positionScreen),0<(H+1)%eb||(ja=l[j-2],O.copy(Z.positionScreen),R.copy(ja.positionScreen),!0===d(O,R)&&(O.multiplyScalar(1/O.w),R.multiplyScalar(1/R.w),s===A?(za=new THREE.RenderableLine,F.push(za),A++,s++,x=za):x=F[s++],
x.v1.positionScreen.copy(O),x.v2.positionScreen.copy(R),x.z=Math.max(O.z,R.z),x.material=oa.material,J.elements.push(x)))}g=0;for(m=J.sprites.length;g<m;g++)oa=J.sprites[g].object,eb=oa.matrixWorld,oa instanceof THREE.Particle&&(C.set(eb.elements[12],eb.elements[13],eb.elements[14],1),L.multiplyVector4(C),C.z/=C.w,0<C.z&&1>C.z&&(z===B?(aa=new THREE.RenderableParticle,E.push(aa),B++,z++,v=aa):v=E[z++],v.object=oa,v.x=C.x/C.w,v.y=C.y/C.w,v.z=C.z,v.rotation=oa.rotation.z,v.scale.x=oa.scale.x*Math.abs(v.x-
...
document.createElement("canvas"),m,n,p,q,r=l.getContext("2d"),u=new THREE.Color(0),t=0,D=1,x=0,s=null,F=null,A=null,v=null,z=null,E,B,J,K,C=new THREE.RenderableVertex,L=new THREE.RenderableVertex,I,M,Q,O,R,T,N,P,S,aa,ga,Ia,H=new THREE.Color,ca=new THREE.Color,ia=new THREE.Color,Z=new THREE.Color,ja=new THREE.Color,da=new THREE.Color,ba=new THREE.Color,oa={},eb={},Ma,za,qa,Sa,fb,vb,rb,nb,mb,ac,qb=new THREE.Rectangle,Ta=new THREE.Rectangle,ra=new THREE.Rectangle,ob=!1,la=new THREE.Color,sb=new THREE.Color,
gb=new THREE.Color,Ba=new THREE.Vector3,tb,Wa,wb,Xa,ab,cb,a=16;tb=document.createElement("canvas");tb.width=tb.height=2;Wa=tb.getContext("2d");Wa.fillStyle="rgba(0,0,0,1)";Wa.fillRect(0,0,2,2);wb=Wa.getImageData(0,0,2,2);Xa=wb.data;ab=document.createElement("canvas");ab.width=ab.height=a;cb=ab.getContext("2d");cb.translate(-a/2,-a/2);cb.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){m=a;n=b;p=
...
n.repeat.x,q=n.image.height*n.repeat.y,h=(h+m)*p,k=(1-k+ib)*q,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+m)*p-h,j=(1-j+ib)*q-k,l=(l+m)*p-h,hb=(1-hb+ib)*q-k,m=i*hb-l*j;0===m?(void 0===eb[n.id]&&(b=document.createElement("canvas"),b.width=n.image.width,b.height=n.image.height,b=b.getContext("2d"),b.drawImage(n.image,0,0),eb[n.id]=b.getImageData(0,0,n.image.width,n.image.height).data),b=eb[n.id],h=4*(Math.floor(h)+Math.floor(k)*n.image.width),H.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),u(H)):(m=1/m,n=(hb*c-j*f)*m,j=
(hb*d-j*g)*m,c=(i*f-l*c)*m,d=(i*g-l*d)*m,a=a-n*h-c*k,h=b-j*h-d*k,r.save(),r.transform(n,j,c,d,a,h),r.fill(),r.restore())}}function D(a,b,c,d,e,f,g,h,k,i,j,l,hb){var n,m;n=hb.width-1;m=hb.height-1;g*=n;h*=m;c-=a;d-=b;e-=a;f-=b;k=k*n-g;i=i*m-h;j=j*n-g;l=l*m-h;m=1/(k*l-j*i);n=(l*c-i*e)*m;i=(l*d-i*f)*m;c=(k*e-j*c)*m;d=(k*f-j*d)*m;a=a-n*g-c*h;b=b-i*g-d*h;r.save();r.transform(n,i,c,d,a,b);r.clip();r.drawImage(hb,0,0);r.restore()}function F(a,b,c,d){Xa[0]=255*a.r|0;Xa[1]=255*a.g|0;Xa[2]=255*a.b|0;Xa[4]=
255*b.r|0;Xa[5]=255*b.g|0;Xa[6]=255*b.b|0;Xa[8]=255*c.r|0;Xa[9]=255*c.g|0;Xa[10]=255*c.b|0;Xa[12]=255*d.r|0;Xa[13]=255*d.g|0;Xa[14]=255*d.b|0;Wa.putImageData(wb,0,0);cb.drawImage(tb,0,0);return ab}function Ya(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function hb(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function bc(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===l instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
else{var ib,zc,ma,ea;!0===this.autoClear?this.clear():r.setTransform(1,0,0,-1,p,q);f.info.render.vertices=0;f.info.render.faces=0;g=j.projectScene(a,l,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;ob=0<i.length;if(!0===ob){la.setRGB(0,0,0);sb.setRGB(0,0,0);gb.setRGB(0,0,0);ib=0;for(zc=i.length;ib<zc;ib++){ea=i[ib];var na=ea.color;ea instanceof THREE.AmbientLight?(la.r+=na.r,la.g+=na.g,la.b+=na.b):ea instanceof THREE.DirectionalLight?(sb.r+=na.r,sb.g+=na.g,sb.b+=na.b):ea instanceof THREE.PointLight&&
(gb.r+=na.r,gb.g+=na.g,gb.b+=na.b)}}ib=0;for(zc=h.length;ib<zc;ib++)if(ma=h[ib],ea=ma.material,!(void 0===ea||!1===ea.visible)){ra.empty();if(ma instanceof THREE.RenderableParticle){E=ma;E.x*=p;E.y*=q;var na=E,bb=ma;b(ea.opacity);c(ea.blending);var Fb=void 0,Gb=void 0,xb=void 0,yb=void 0,jc=ma=void 0,Rc=void 0;ea instanceof THREE.ParticleBasicMaterial?null===ea.map?(xb=bb.object.scale.x,yb=bb.object.scale.y,xb*=bb.scale.x*p,yb*=bb.scale.y*q,ra.set(na.x-xb,na.y-yb,na.x+xb,na.y+yb),!1!==qb.intersects(ra)&&
(e(ea.color.getContextStyle()),r.save(),r.translate(na.x,na.y),r.rotate(-bb.rotation),r.scale(xb,yb),r.fillRect(-1,-1,2,2),r.restore())):(ma=ea.map.image,jc=ma.width>>1,Rc=ma.height>>1,xb=bb.scale.x*p,yb=bb.scale.y*q,Fb=xb*jc,Gb=yb*Rc,ra.set(na.x-Fb,na.y-Gb,na.x+Fb,na.y+Gb),!1!==qb.intersects(ra)&&(r.save(),r.translate(na.x,na.y),r.rotate(-bb.rotation),r.scale(xb,-yb),r.translate(-jc,-Rc),r.drawImage(ma,0,0),r.restore())):ea instanceof THREE.ParticleCanvasMaterial&&(Fb=bb.scale.x*p,Gb=bb.scale.y*
q,ra.set(na.x-Fb,na.y-Gb,na.x+Fb,na.y+Gb),!1!==qb.intersects(ra)&&(d(ea.color.getContextStyle()),e(ea.color.getContextStyle()),r.save(),r.translate(na.x,na.y),r.rotate(-bb.rotation),r.scale(Fb,Gb),ea.program(r),r.restore()))}else ma instanceof THREE.RenderableLine?(E=ma.v1,B=ma.v2,E.positionScreen.x*=p,E.positionScreen.y*=q,B.positionScreen.x*=p,B.positionScreen.y*=q,ra.addPoint(E.positionScreen.x,E.positionScreen.y),ra.addPoint(B.positionScreen.x,B.positionScreen.y),!0===qb.intersects(ra)&&(na=E,
bb=B,b(ea.opacity),c(ea.blending),r.beginPath(),r.moveTo(na.positionScreen.x,na.positionScreen.y),r.lineTo(bb.positionScreen.x,bb.positionScreen.y),ea instanceof THREE.LineBasicMaterial&&(na=ea.linewidth,A!==na&&(A=r.lineWidth=na),na=ea.linecap,v!==na&&(v=r.lineCap=na),na=ea.linejoin,z!==na&&(z=r.lineJoin=na),d(ea.color.getContextStyle()),r.stroke(),ra.inflate(2*ea.linewidth)))):ma instanceof THREE.RenderableFace3?(E=ma.v1,B=ma.v2,J=ma.v3,E.positionScreen.x*=p,E.positionScreen.y*=q,B.positionScreen.x*=
...
ra.addPoint(J.positionScreen.x,J.positionScreen.y),ra.addPoint(K.positionScreen.x,K.positionScreen.y),!0===qb.intersects(ra)&&(na=E,bb=B,Fb=J,Gb=K,xb=C,yb=L,jc=a,f.info.render.vertices+=4,f.info.render.faces++,b(ea.opacity),c(ea.blending),void 0!==ea.map&&null!==ea.map||void 0!==ea.envMap&&null!==ea.envMap?(k(na,bb,Gb,0,1,3,ma,ea,jc),k(xb,Fb,yb,1,2,3,ma,ea,jc)):(I=na.positionScreen.x,M=na.positionScreen.y,Q=bb.positionScreen.x,O=bb.positionScreen.y,R=Fb.positionScreen.x,T=Fb.positionScreen.y,N=Gb.positionScreen.x,
...
ia.b=1-Ya(bb.positionScreen.z,Ma,za),Z.r=Z.g=Z.b=1-Ya(Gb.positionScreen.z,Ma,za),ja.r=ja.g=ja.b=1-Ya(Fb.positionScreen.z,Ma,za),qa=F(ca,ia,Z,ja),m(I,M,Q,O,N,P),D(I,M,Q,O,N,P,0,0,1,0,0,1,qa),m(S,aa,R,T,ga,Ia),D(S,aa,R,T,ga,Ia,1,0,1,1,0,1,qa)))));Ta.addRectangle(ra)}r.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
p=a.verticesNeedUpdate,q=a.colorsNeedUpdate,r=a.__webglCustomAttributesList;if(c.sortParticles){ab.copy(Xa);ab.multiplySelf(c.matrixWorld);for(d=0;d<g;d++)e=h[d],cb.copy(e),ab.multiplyVector3(cb),m[d]=[cb.z,d];m.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++)e=h[m[d][1]],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;for(d=0;d<j;d++)f=3*d,e=i[m[d][1]],n[f]=e.r,n[f+1]=e.g,n[f+2]=e.b;if(r){i=0;for(j=r.length;i<j;i++)if(h=r[i],void 0===h.boundTo||"vertices"===h.boundTo)if(f=0,e=h.value.length,1===h.size)for(d=
...
k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)H.autoScaleCubemaps&&!f?(n=j,m=l,t=c.image[l],u=Qc,t.width<=u&&t.height<=u||(x=Math.max(t.width,t.height),s=Math.floor(t.width*u/x),u=Math.floor(t.height*u/x),x=document.createElement("canvas"),x.width=s,x.height=u,x.getContext("2d").drawImage(t,0,0,t.width,t.height,0,0,s,u),t=x),n[m]=t):j[l]=c.image[l];l=j[0];n=0===(l.width&l.width-1)&&0===(l.height&l.height-1);m=Q(c.format);t=Q(c.type);L(k.TEXTURE_CUBE_MAP,
c,n);for(l=0;6>l;l++)if(f){u=j[l].mipmaps;x=0;for(z=u.length;x<z;x++)s=u[x],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,x,m,s.width,s.height,0,s.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,m,m,t,j[l]);c.generateMipmaps&&n&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else m instanceof THREE.WebGLRenderTargetCube?(c=m,k.activeTexture(k.TEXTURE0+
...
this.shadowMapSoft=this.shadowMapAutoUpdate=!0;this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var H=this,ca=[],ia=0,Z=null,ja=null,da=-1,ba=null,oa=null,eb=0,Ma=0,za=-1,qa=-1,Sa=-1,fb=-1,vb=-1,rb=-1,nb=-1,mb=-1,ac=null,qb=null,Ta=null,ra=null,ob=0,la=0,sb=0,gb=0,Ba=0,tb=0,Wa={},
wb=new THREE.Frustum,Xa=new THREE.Matrix4,ab=new THREE.Matrix4,cb=new THREE.Vector4,Aa=new THREE.Vector3,Db=!0,xc={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Eb,ub;try{if(!(k=O.getContext("experimental-webgl",{alpha:T,premultipliedAlpha:N,antialias:P,stencil:S,preserveDrawingBuffer:aa})))throw"Error creating WebGL context.";
...
a===THREE.MultiplyBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.SRC_COLOR)):a===THREE.CustomBlending?k.enable(k.BLEND):(k.enable(k.BLEND),k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD),k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)),Sa=a);if(a===THREE.CustomBlending){if(b!==fb&&(k.blendEquation(Q(b)),fb=b),c!==vb||d!==rb)k.blendFunc(Q(c),Q(d)),vb=c,rb=d}else rb=vb=fb=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||
...
void 0===a.stencilBuffer&&(a.stencilBuffer=!0);a.__webglTexture=k.createTexture();var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=Q(a.format),e=Q(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);L(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+
f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);I(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=k.createFramebuffer(),a.__webglRenderbuffer=k.createRenderbuffer(),k.bindTexture(k.TEXTURE_2D,a.__webglTexture),L(k.TEXTURE_2D,a,c),k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=k.TEXTURE_2D,k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),k.framebufferTexture2D(k.FRAMEBUFFER,
k.COLOR_ATTACHMENT0,d,a.__webglTexture,0),I(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=sb,a=gb,d=ob,e=la);b!==ja&&(k.bindFramebuffer(k.FRAMEBUFFER,b),k.viewport(d,e,c,a),ja=b);Ba=c;tb=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;
...
!0);e.format=a.format;e.mipmaps=a.mipmaps;e.image.width=a.width;e.image.height=a.height;e.generateMipmaps=!1;e.needsUpdate=!0;c&&c(e)};f.onerror=d;f.open("GET",a,!0);f.responseType="arraybuffer";f.send(null);return e},loadTextureCube:function(a,b,c,d){var e=[];e.loadCount=0;var f=new THREE.Texture;f.image=e;void 0!==b&&(f.mapping=b);f.flipY=!1;for(var b=0,g=a.length;b<g;++b){var h=new Image;e[b]=h;h.onload=function(){e.loadCount+=1;6===e.loadCount&&(f.needsUpdate=!0,c&&c())};h.onerror=d;h.crossOrigin=
this.crossOrigin;h.src=a[b]}return f},loadCompressedTextureCube:function(a,b,c,d){var e=[];e.loadCount=0;var f=new THREE.CompressedTexture;f.image=e;void 0!==b&&(f.mapping=b);f.flipY=!1;f.generateMipmaps=!1;for(var b=function(a,b){return function(){var d=THREE.ImageUtils.parseDDS(a.response,!0);b.format=d.format;b.mipmaps=d.mipmaps;b.width=d.width;b.height=d.height;e.loadCount+=1;6===e.loadCount&&(f.format=d.format,f.needsUpdate=!0,c&&c())}},g=0,h=a.length;g<h;++g){var i={};e[g]=i;var j=new XMLHttpRequest;
...
0>m-1?0:m-1,p=m+1>e-1?e-1:m+1,q=0>l-1?0:l-1,r=l+1>d-1?d-1:l+1,u=[],t=[0,0,h[4*(m*d+l)]/255*b];u.push([-1,0,h[4*(m*d+q)]/255*b]);u.push([-1,-1,h[4*(n*d+q)]/255*b]);u.push([0,-1,h[4*(n*d+l)]/255*b]);u.push([1,-1,h[4*(n*d+r)]/255*b]);u.push([1,0,h[4*(m*d+r)]/255*b]);u.push([1,1,h[4*(p*d+r)]/255*b]);u.push([0,1,h[4*(p*d+l)]/255*b]);u.push([-1,1,h[4*(p*d+q)]/255*b]);n=[];q=u.length;for(p=0;p<q;p++){var r=u[p],D=u[(p+1)%q],r=[r[0]-t[0],r[1]-t[1],r[2]-t[2]],D=[D[0]-t[0],D[1]-t[1],D[2]-t[2]];n.push(c([r[1]*
D[2]-r[2]*D[1],r[2]*D[0]-r[0]*D[2],r[0]*D[1]-r[1]*D[0]]))}u=[0,0,0];for(p=0;p<n.length;p++)u[0]+=n[p][0],u[1]+=n[p][1],u[2]+=n[p][2];u[0]/=n.length;u[1]/=n.length;u[2]/=n.length;t=4*(m*d+l);j[t]=255*((u[0]+1)/2)|0;j[t+1]=255*((u[1]+1)/2)|0;j[t+2]=255*u[2]|0;j[t+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+1]=g,e[3*h+2]=c;a=new THREE.DataTexture(e,
...
i,j,l])}this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.TorusKnotGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.TubeGeometry=function(a,b,c,d,e,f){THREE.Geometry.call(this);this.path=a;this.segments=b||64;this.radius=c||1;this.radiusSegments=d||8;this.closed=e||!1;f&&(this.debug=new THREE.Object3D);this.grid=[];var g,h,f=this.segments+1,i,j,l,m=new THREE.Vector3,n,p,q,b=new THREE.TubeGeometry.FrenetFrames(a,b,e);n=b.tangents;p=b.normals;q=b.binormals;this.tangents=n;this.normals=p;this.binormals=q;for(b=0;b<f;b++){this.grid[b]=[];d=b/(f-1);l=a.getPointAt(d);d=n[b];g=p[b];h=q[b];this.debug&&(this.debug.add(new THREE.ArrowHelper(d,
...
c=this.grid[f][d],f=this.grid[f][m],m=this.grid[b][m],n=new THREE.UV(b/this.segments,d/this.radiusSegments),p=new THREE.UV((b+1)/this.segments,d/this.radiusSegments),q=new THREE.UV((b+1)/this.segments,(d+1)/this.radiusSegments),g=new THREE.UV(b/this.segments,(d+1)/this.radiusSegments),this.faces.push(new THREE.Face4(a,c,f,m)),this.faceVertexUvs[0].push([n,p,q,g]);this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.TubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
