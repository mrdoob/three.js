...
'use strict';var THREE=THREE||{REVISION:"52dev"};self.console=self.console||{info:function(){},log:function(){},debug:function(){},warn:function(){},error:function(){}};self.Int32Array=self.Int32Array||Array;self.Float32Array=self.Float32Array||Array;String.prototype.startsWith=String.prototype.startsWith||function(a){return this.slice(0,a.length)===a};String.prototype.endsWith=String.prototype.endsWith||function(a){var a=String(a),b=this.lastIndexOf(a);return(-1<b&&b)===this.length-a.length};
...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],n=c[9],m=c[13],p=c[2],o=c[6],q=c[10],r=c[14],t=c[3],u=c[7],v=c[11],c=c[15],s=d[0],A=d[4],w=d[8],
z=d[12],I=d[1],D=d[5],F=d[9],B=d[13],E=d[2],H=d[6],Q=d[10],L=d[14],K=d[3],J=d[7],M=d[11],d=d[15];e[0]=f*s+g*I+h*E+i*K;e[4]=f*A+g*D+h*H+i*J;e[8]=f*w+g*F+h*Q+i*M;e[12]=f*z+g*B+h*L+i*d;e[1]=j*s+l*I+n*E+m*K;e[5]=j*A+l*D+n*H+m*J;e[9]=j*w+l*F+n*Q+m*M;e[13]=j*z+l*B+n*L+m*d;e[2]=p*s+o*I+q*E+r*K;e[6]=p*A+o*D+q*H+r*J;e[10]=p*w+o*F+q*Q+r*M;e[14]=p*z+o*B+q*L+r*d;e[3]=t*s+u*I+v*E+c*K;e[7]=t*A+u*D+v*H+c*J;e[11]=t*w+u*F+v*Q+c*M;e[15]=t*z+u*B+v*L+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),l=Math.sin(b),n=1-j,m=d*e*n,p=d*f*n,n=e*f*n,d=d*l,o=e*l,l=f*l,f=g+(1-g)*j,g=m+l,e=p-o,m=m-l,h=h+(1-h)*j,l=n+d,p=p+o,n=n-d,i=i+(1-i)*j,j=c[0],d=c[1],o=c[2],q=c[3],r=c[4],t=c[5],u=c[6],v=c[7],s=c[8],A=c[9],w=c[10],z=c[11];c[0]=f*j+g*r+e*s;c[1]=f*d+g*t+e*A;c[2]=f*o+g*u+e*w;c[3]=f*q+g*v+e*z;c[4]=m*j+h*r+l*s;c[5]=m*d+h*t+l*A;c[6]=m*o+h*u+l*w;c[7]=m*q+h*v+l*z;c[8]=p*j+n*r+i*s;c[9]=p*d+n*t+i*A;c[10]=p*o+n*u+i*w;c[11]=p*q+n*v+i*z;
...
b);var a=j.dot(j),b=j.dot(l),c=j.dot(n),e=l.dot(l),d=l.dot(n),f=1/(a*e-b*b),e=(e*c-b*d)*f,a=(a*d-b*c)*f;return 0<=e&&0<=a&&1>e+a},o=function(i,l,j){var n,o;if(i instanceof a.Particle){n=m(l.origin,l.direction,i.matrixWorld.getPosition());if(n>i.scale.x)return j;o={distance:n,point:i.position,face:null,object:i};j.push(o)}else if(i instanceof a.Mesh){var q=i.geometry.boundingSphere.radius*i.matrixWorld.getMaxScaleOnAxis();n=m(l.origin,l.direction,i.matrixWorld.getPosition());if(n>q)return j;var w,
z,I=i.geometry,D=I.vertices,F,B,E;F=i.geometry.materials;B=i.material instanceof a.MeshFaceMaterial;var H,Q=l.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(l.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(l.direction);h.rotateAxis(d).normalize();q=0;for(w=I.faces.length;q<w;q++)if(o=I.faces[q],n=!0===B?F[o.materialIndex]:i.material,void 0!==n&&(E=n.side,e.sub(o.centroid,c),f=o.normal,n=d.dot(f),!(Math.abs(n)<Q)&&(z=f.dot(e)/n,!(0>z)&&(E===a.DoubleSide||
(E===a.FrontSide?0>n:0<n)))))if(g.add(c,d.multiplyScalar(z)),o instanceof a.Face3)n=D[o.a],z=D[o.b],E=D[o.c],p(g,n,z,E)&&(z=i.matrixWorld.multiplyVector3(g.clone()),n=b.distanceTo(z),n<l.near||n>l.far||(o={distance:n,point:z,face:o,faceIndex:q,object:i},j.push(o)));else if(o instanceof a.Face4&&(n=D[o.a],z=D[o.b],E=D[o.c],H=D[o.d],p(g,n,z,H)||p(g,z,E,H)))z=i.matrixWorld.multiplyVector3(g.clone()),n=b.distanceTo(z),n<l.near||n>l.far||(o={distance:n,point:z,face:o,faceIndex:q,object:i},j.push(o))}},
...
c)return!1;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return!0}var e,f,g=[],h=0,i,j,l=[],n=0,m,p,o=[],q=0,r,t=[],u=0,v,s,A=[],w=0,z,I,D=[],F=0,B={objects:[],sprites:[],lights:[],elements:[]},E=new THREE.Vector3,H=new THREE.Vector4,Q=new THREE.Matrix4,L=new THREE.Matrix4,K=new THREE.Frustum,J=new THREE.Vector4,M=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);Q.multiply(b.projectionMatrix,b.matrixWorldInverse);Q.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);Q.multiply(b.matrixWorld,b.projectionMatrixInverse);Q.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n,N){var fa=h.near,S=h.far,ra=!1,wa,O,ga,P,X,ia,$,ca,Ja,ua,La,Wa,oa,Xa,kb,Ta;I=s=r=p=0;B.elements.length=0;g.updateMatrixWorld();void 0===
h.parent&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);Q.multiply(h.projectionMatrix,h.matrixWorldInverse);K.setFromMatrix(Q);f=0;B.objects.length=0;B.sprites.length=0;B.lights.length=0;var gb=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof THREE.Light)B.lights.push(f);else if(f instanceof THREE.Mesh||f instanceof THREE.Line){if(!1===f.frustumCulled||!0===K.contains(f))e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:
(E.copy(f.matrixWorld.getPosition()),Q.multiplyVector3(E),e.z=E.z),B.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(E.copy(f.matrixWorld.getPosition()),Q.multiplyVector3(E),e.z=E.z),B.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(E.copy(f.matrixWorld.getPosition()),Q.multiplyVector3(E),e.z=E.z),B.objects.push(e));gb(f)}}};gb(g);!0===n&&B.objects.sort(c);g=0;for(n=B.objects.length;g<
...
i.visible=i.positionScreen.z>fa&&i.positionScreen.z<S;ga=0;for(wa=Wa.length;ga<wa;ga++)if(O=Wa[ga],Ta=!0===kb?La[O.materialIndex]:ca.material,void 0!==Ta){ia=Ta.side;if(O instanceof THREE.Face3)if(P=l[O.a],X=l[O.b],$=l[O.c],!0===P.visible&&!0===X.visible&&!0===$.visible)if(ra=0>($.positionScreen.x-P.positionScreen.x)*(X.positionScreen.y-P.positionScreen.y)-($.positionScreen.y-P.positionScreen.y)*(X.positionScreen.x-P.positionScreen.x),ia===THREE.DoubleSide||ra===(ia===THREE.FrontSide))p===q?(oa=new THREE.RenderableFace3,
o.push(oa),q++,p++,m=oa):m=o[p++],m.v1.copy(P),m.v2.copy(X),m.v3.copy($);else continue;else continue;else if(O instanceof THREE.Face4)if(P=l[O.a],X=l[O.b],$=l[O.c],oa=l[O.d],!0===P.visible&&!0===X.visible&&!0===$.visible&&!0===oa.visible)if(ra=0>(oa.positionScreen.x-P.positionScreen.x)*(X.positionScreen.y-P.positionScreen.y)-(oa.positionScreen.y-P.positionScreen.y)*(X.positionScreen.x-P.positionScreen.x)||0>(X.positionScreen.x-$.positionScreen.x)*(oa.positionScreen.y-$.positionScreen.y)-(X.positionScreen.y-
...
b();P.positionScreen.copy(ga[0]);L.multiplyVector4(P.positionScreen);Ja=ca.type===THREE.LinePieces?2:1;wa=1;for(O=ga.length;wa<O;wa++)P=b(),P.positionScreen.copy(ga[wa]),L.multiplyVector4(P.positionScreen),0<(wa+1)%Ja||(X=l[j-2],J.copy(P.positionScreen),M.copy(X.positionScreen),!0===d(J,M)&&(J.multiplyScalar(1/J.w),M.multiplyScalar(1/M.w),s===w?(La=new THREE.RenderableLine,A.push(La),w++,s++,v=La):v=A[s++],v.v1.positionScreen.copy(J),v.v2.positionScreen.copy(M),v.z=Math.max(J.z,M.z),v.material=ca.material,
B.elements.push(v)))}g=0;for(n=B.sprites.length;g<n;g++)ca=B.sprites[g].object,Ja=ca.matrixWorld,ca instanceof THREE.Particle&&(H.set(Ja.elements[12],Ja.elements[13],Ja.elements[14],1),Q.multiplyVector4(H),H.z/=H.w,0<H.z&&1>H.z&&(I===F?(fa=new THREE.RenderableParticle,D.push(fa),F++,I++,z=fa):z=D[I++],z.object=ca,z.x=H.x/H.w,z.y=H.y/H.w,z.z=H.z,z.rotation=ca.rotation.z,z.scale.x=ca.scale.x*Math.abs(z.x-(H.x+h.projectionMatrix.elements[0])/(H.w+h.projectionMatrix.elements[12])),z.scale.y=ca.scale.y*
Math.abs(z.y-(H.y+h.projectionMatrix.elements[5])/(H.w+h.projectionMatrix.elements[13])),z.material=ca.material,B.elements.push(z)));!0===N&&B.elements.sort(c);return B}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=void 0!==d?d:1};
...
i.copy(e.normal),e instanceof THREE.Face3?(j.a.copy(e.vertexNormals[0]),j.b.copy(e.vertexNormals[1]),j.c.copy(e.vertexNormals[2])):(j.a.copy(e.vertexNormals[0]),j.b.copy(e.vertexNormals[1]),j.c.copy(e.vertexNormals[2]),j.d.copy(e.vertexNormals[3]))}c=0;for(d=this.faces.length;c<d;c++)e=this.faces[c],e.normal=e.__originalFaceNormal,e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,H){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];l=g[e];n=g[f];m=g[H];p=i.x-
h.x;o=j.x-h.x;q=i.y-h.y;r=j.y-h.y;t=i.z-h.z;u=j.z-h.z;v=n.u-l.u;s=m.u-l.u;A=n.v-l.v;w=m.v-l.v;z=1/(v*w-s*A);B.set((w*p-A*o)*z,(w*q-A*r)*z,(w*t-A*u)*z);E.set((v*o-s*p)*z,(v*r-s*q)*z,(v*u-s*t)*z);D[b].addSelf(B);D[c].addSelf(B);D[d].addSelf(B);F[b].addSelf(E);F[c].addSelf(E);F[d].addSelf(E)}var b,c,d,e,f,g,h,i,j,l,n,m,p,o,q,r,t,u,v,s,A,w,z,I,D=[],F=[],B=new THREE.Vector3,E=new THREE.Vector3,H=new THREE.Vector3,Q=new THREE.Vector3,L=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)D[b]=new THREE.Vector3,
F[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var K=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<f.vertexNormals.length;d++)L.copy(f.vertexNormals[d]),e=f[K[d]],I=D[e],H.copy(I),H.subSelf(L.multiplyScalar(L.dot(I))).normalize(),Q.cross(f.vertexNormals[d],I),e=Q.dot(F[e]),e=0>e?
...
g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,n,m,p,o=new THREE.Vector3,q=new THREE.Vector3,r=new THREE.Vector3,t=new THREE.Vector3,u=new THREE.Vector3;c=0;for(d=e.length;c<d;++c){b=e[c].start;i=e[c].count;var v=e[c].index;a=b;for(b+=i;a<b;a+=3)i=v+f[a],j=v+f[a+1],l=v+f[a+2],n=g[3*i],m=g[3*i+1],p=g[3*i+2],o.set(n,m,p),n=g[3*j],m=g[3*j+1],p=g[3*j+2],q.set(n,m,p),n=g[3*l],m=g[3*l+1],p=g[3*l+2],r.set(n,m,p),t.sub(r,q),u.sub(o,q),t.crossSelf(u),h[3*i]+=t.x,h[3*i+1]+=t.y,h[3*i+
2]+=t.z,h[3*j]+=t.x,h[3*j+1]+=t.y,h[3*j+2]+=t.z,h[3*l]+=t.x,h[3*l+1]+=t.y,h[3*l+2]+=t.z}a=0;for(b=h.length;a<b;a+=3)n=h[a],m=h[a+1],p=h[a+2],c=1/Math.sqrt(n*n+m*m+p*p),h[a]*=c,h[a+1]*=c,h[a+2]*=c;this.normalsNeedUpdate=!0}},computeTangents:function(){function a(a){Z.x=d[3*a];Z.y=d[3*a+1];Z.z=d[3*a+2];ea.copy(Z);fa=i[a];M.copy(fa);M.subSelf(Z.multiplyScalar(Z.dot(fa))).normalize();T.cross(ea,fa);S=T.dot(j[a]);N=0>S?-1:1;h[4*a]=M.x;h[4*a+1]=M.y;h[4*a+2]=M.z;h[4*a+3]=N}if(void 0===this.attributes.index||
...
i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,n,m,p,o,q,r,t,u,v,s,A,w,z,I,f=new THREE.Vector3,g=new THREE.Vector3,D,F,B,E,H,Q,L,K=this.offsets;B=0;for(E=K.length;B<E;++B){F=K[B].start;H=K[B].count;var J=K[B].index;D=F;for(F+=H;D<F;D+=3)H=J+b[D],Q=J+b[D+1],L=J+b[D+2],l=c[3*H],n=c[3*H+1],m=c[3*H+2],p=c[3*Q],o=c[3*Q+1],q=c[3*Q+2],r=c[3*L],t=c[3*L+1],u=c[3*L+2],v=e[2*H],s=e[2*H+1],A=e[2*Q],w=e[2*Q+1],z=e[2*L],I=e[2*L+1],p-=l,l=r-l,o-=n,n=t-n,q-=m,m=u-m,A-=v,v=z-v,w-=s,s=I-
s,I=1/(A*s-v*w),f.set((s*p-w*l)*I,(s*o-w*n)*I,(s*q-w*m)*I),g.set((A*l-v*p)*I,(A*n-v*o)*I,(A*m-v*q)*I),i[H].addSelf(f),i[Q].addSelf(f),i[L].addSelf(f),j[H].addSelf(g),j[Q].addSelf(g),j[L].addSelf(g)}var M=new THREE.Vector3,T=new THREE.Vector3,Z=new THREE.Vector3,ea=new THREE.Vector3,N,fa,S;B=0;for(E=K.length;B<E;++B){F=K[B].start;H=K[B].count;J=K[B].index;D=F;for(F+=H;D<F;D+=3)H=J+b[D],Q=J+b[D+1],L=J+b[D+2],a(H),a(Q),a(L)}this.tangentsNeedUpdate=this.hasTangents=!0}}};
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(b){var c,e,i,j,l,n,m,p,o,q,r,t,u,v,s;function A(a){return a%4?4-a%4:0}function w(a,b){return(new Uint8Array(a,b,1))[0]}function z(a,b){return(new Uint32Array(a,b,1))[0]}function I(b,c){var d,e,f,g,h,i,l,j,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){e=n[3*d];f=n[3*d+1];g=n[3*d+2];h=J[2*e];e=J[2*e+1];i=J[2*f];l=J[2*f+1];f=J[2*g];j=J[2*g+1];g=Q.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,e));m.push(new THREE.UV(i,l));m.push(new THREE.UV(f,
j));g.push(m)}}function D(b,c){var d,e,f,g,h,i,l,j,n,m,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){e=o[4*d];f=o[4*d+1];g=o[4*d+2];h=o[4*d+3];i=J[2*e];e=J[2*e+1];l=J[2*f];n=J[2*f+1];j=J[2*g];m=J[2*g+1];g=J[2*h];f=J[2*h+1];h=Q.faceVertexUvs[0];var q=[];q.push(new THREE.UV(i,e));q.push(new THREE.UV(l,n));q.push(new THREE.UV(j,m));q.push(new THREE.UV(g,f));h.push(q)}}function F(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],
Q.faces.push(new THREE.Face3(e,f,g,null,null,h))}function B(b,c,d){for(var e,f,g,h,i,c=new Uint32Array(a,c,4*b),l=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[4*d],f=c[4*d+1],g=c[4*d+2],h=c[4*d+3],i=l[d],Q.faces.push(new THREE.Face4(e,f,g,h,null,null,i))}function E(b,c,d,e){for(var f,g,h,i,l,j,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[3*e];g=c[3*e+1];h=c[3*e+2];l=d[3*e];j=d[3*e+1];n=d[3*e+2];i=m[e];var o=K[3*j],q=K[3*j+1];j=K[3*j+2];var p=K[3*n],r=
K[3*n+1];n=K[3*n+2];Q.faces.push(new THREE.Face3(f,g,h,[new THREE.Vector3(K[3*l],K[3*l+1],K[3*l+2]),new THREE.Vector3(o,q,j),new THREE.Vector3(p,r,n)],null,i))}}function H(b,c,d,e){for(var f,g,h,i,l,j,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),q=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];j=d[4*e];n=d[4*e+1];m=d[4*e+2];o=d[4*e+3];l=q[e];var p=K[3*n],r=K[3*n+1];n=K[3*n+2];var s=K[3*m],t=K[3*m+1];m=K[3*m+2];var v=K[3*o],w=K[3*o+1];o=K[3*o+2];Q.faces.push(new THREE.Face4(f,
g,h,i,[new THREE.Vector3(K[3*j],K[3*j+1],K[3*j+2]),new THREE.Vector3(p,r,n),new THREE.Vector3(s,t,m),new THREE.Vector3(v,w,o)],null,l))}}var Q=this,L=0,K=[],J=[],M,T,Z;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(Q,d,b);s=a;T=L;b=new Uint8Array(s,T,12);q="";for(u=0;12>u;u++)q+=String.fromCharCode(b[T+u]);c=w(s,T+12);w(s,T+13);w(s,T+14);w(s,T+15);e=w(s,T+16);i=w(s,T+17);j=w(s,T+18);l=w(s,T+19);n=z(s,T+20);m=z(s,T+20+4);p=z(s,T+20+8);o=z(s,T+20+12);q=z(s,T+20+16);r=z(s,T+20+20);t=
z(s,T+20+24);u=z(s,T+20+28);b=z(s,T+20+32);v=z(s,T+20+36);s=z(s,T+20+40);L+=c;T=3*e+l;Z=4*e+l;M=o*T;c=q*(T+3*i);e=r*(T+3*j);l=t*(T+3*i+3*j);T=u*Z;i=b*(Z+4*i);j=v*(Z+4*j);Z=L;var L=new Float32Array(a,L,3*n),ea,N,fa,S;for(ea=0;ea<n;ea++)N=L[3*ea],fa=L[3*ea+1],S=L[3*ea+2],Q.vertices.push(new THREE.Vector3(N,fa,S));n=L=Z+3*n*Float32Array.BYTES_PER_ELEMENT;if(m){L=new Int8Array(a,L,3*m);for(Z=0;Z<m;Z++)ea=L[3*Z],N=L[3*Z+1],fa=L[3*Z+2],K.push(ea/127,N/127,fa/127)}L=n+3*m*Int8Array.BYTES_PER_ELEMENT;m=L+=
A(3*m);if(p){L=new Float32Array(a,L,2*p);for(n=0;n<p;n++)Z=L[2*n],ea=L[2*n+1],J.push(Z,ea)}p=L=m+2*p*Float32Array.BYTES_PER_ELEMENT;M=p+M+A(2*o);m=M+c+A(2*q);c=m+e+A(2*r);e=c+l+A(2*t);T=e+T+A(2*u);l=T+i+A(2*b);i=l+j+A(2*v);r&&(j=m+3*r*Uint32Array.BYTES_PER_ELEMENT,F(r,m,j+3*r*Uint32Array.BYTES_PER_ELEMENT),I(r,j));t&&(r=c+3*t*Uint32Array.BYTES_PER_ELEMENT,j=r+3*t*Uint32Array.BYTES_PER_ELEMENT,E(t,c,r,j+3*t*Uint32Array.BYTES_PER_ELEMENT),I(t,j));v&&(t=l+4*v*Uint32Array.BYTES_PER_ELEMENT,B(v,l,t+4*
v*Uint32Array.BYTES_PER_ELEMENT),D(v,t));s&&(v=i+4*s*Uint32Array.BYTES_PER_ELEMENT,t=v+4*s*Uint32Array.BYTES_PER_ELEMENT,H(s,i,v,t+4*s*Uint32Array.BYTES_PER_ELEMENT),D(s,t));o&&F(o,p,p+3*o*Uint32Array.BYTES_PER_ELEMENT);q&&(o=M+3*q*Uint32Array.BYTES_PER_ELEMENT,E(q,M,o,o+3*q*Uint32Array.BYTES_PER_ELEMENT));u&&B(u,e,e+4*u*Uint32Array.BYTES_PER_ELEMENT);b&&(q=T+4*b*Uint32Array.BYTES_PER_ELEMENT,H(b,T,q,q+4*b*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1;this.initMaterials(d,a.materials,c);var f,g,h,i,j,l,n,m,p,o,q,r,t,u,v=a.faces;p=a.vertices;var s=a.normals,A=a.colors,w=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&w++;for(f=0;f<w;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];c=0;for(i=p.length;c<i;)j=new THREE.Vector3,j.x=p[c++]*e,j.y=p[c++]*e,j.z=p[c++]*e,d.vertices.push(j);c=0;for(i=v.length;c<i;){p=v[c++];j=p&1;h=p&2;f=p&4;g=p&8;n=p&16;
l=p&32;o=p&64;p&=128;j?(q=new THREE.Face4,q.a=v[c++],q.b=v[c++],q.c=v[c++],q.d=v[c++],j=4):(q=new THREE.Face3,q.a=v[c++],q.b=v[c++],q.c=v[c++],j=3);h&&(h=v[c++],q.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<w;f++)r=a.uvs[f],m=v[c++],u=r[2*m],m=r[2*m+1],d.faceUvs[f][h]=new THREE.UV(u,m);if(g)for(f=0;f<w;f++){r=a.uvs[f];t=[];for(g=0;g<j;g++)m=v[c++],u=r[2*m],m=r[2*m+1],t[g]=new THREE.UV(u,m);d.faceVertexUvs[f][h]=t}n&&(n=3*v[c++],g=new THREE.Vector3,g.x=s[n++],g.y=s[n++],g.z=s[n],q.normal=g);if(l)for(f=
0;f<j;f++)n=3*v[c++],g=new THREE.Vector3,g.x=s[n++],g.y=s[n++],g.z=s[n],q.vertexNormals.push(g);o&&(l=v[c++],l=new THREE.Color(A[l]),q.color=l);if(p)for(f=0;f<j;f++)l=v[c++],l=new THREE.Color(A[l]),q.vertexColors.push(l);d.faces.push(q)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c+=2)v=a.skinWeights[c],s=a.skinWeights[c+1],d.skinWeights.push(new THREE.Vector4(v,s,0,0))}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c+=2)v=a.skinIndices[c],s=a.skinIndices[c+1],d.skinIndices.push(new THREE.Vector4(v,
s,0,0))}d.bones=a.bones;d.animation=a.animation;if(void 0!==a.morphTargets){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];A=d.morphTargets[c].vertices;w=a.morphTargets[c].vertices;v=0;for(s=w.length;v<s;v+=3)p=new THREE.Vector3,p.x=w[v]*e,p.y=w[v+1]*e,p.z=w[v+2]*e,A.push(p)}}if(void 0!==a.morphColors){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=
[];s=d.morphColors[c].colors;A=a.morphColors[c].colors;e=0;for(v=A.length;e<v;e+=3)w=new THREE.Color(16755200),w.setRGB(A[e],A[e+1],A[e+2]),s.push(w)}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};THREE.LoadingMonitor=function(){THREE.EventTarget.call(this);var a=this,b=0,c=0,d=function(){b++;a.dispatchEvent({type:"progress",loaded:b,total:c});b===c&&a.dispatchEvent({type:"load"})};this.add=function(a){c++;a.addEventListener("load",d,!1)}};
...
m=a.normals,j=a.colors,l=0;if(a.uvs)for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&l++;for(f=0;f<l;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];n=0;for(p=o.length;n<p;){var q=new THREE.Vector3;q.x=o[n++]*e;q.y=o[n++]*e;q.z=o[n++]*e;d.vertices.push(q)}n=0;for(p=g.length;n<p;){var r=g[n++],t=r&2,f=r&4,u=r&8,v=r&16,o=r&32,s=r&64,q=r&128;if(r&1){r=new THREE.Face4;r.a=g[n++];r.b=g[n++];r.c=g[n++];r.d=g[n++];var A=4}else r=new THREE.Face3,r.a=g[n++],r.b=g[n++],r.c=g[n++],A=3;t&&(t=g[n++],r.materialIndex=t);var w=
d.faces.length;if(f)for(f=0;f<l;f++){var z=a.uvs[f],t=g[n++],I=z[2*t],t=z[2*t+1];d.faceUvs[f][w]=new THREE.UV(I,t)}if(u)for(f=0;f<l;f++){for(var z=a.uvs[f],u=[],D=0;D<A;D++)t=g[n++],I=z[2*t],t=z[2*t+1],u[D]=new THREE.UV(I,t);d.faceVertexUvs[f][w]=u}v&&(v=3*g[n++],t=new THREE.Vector3,t.x=m[v++],t.y=m[v++],t.z=m[v],r.normal=t);if(o)for(f=0;f<A;f++)v=3*g[n++],t=new THREE.Vector3,t.x=m[v++],t.y=m[v++],t.z=m[v],r.vertexNormals.push(t);s&&(o=g[n++],r.color=new THREE.Color(j[o]));if(q)for(f=0;f<A;f++)o=
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return"relativeToHTML"==b?a:j+"/"+a}function e(a,b){for(var c in b)if(void 0===J.objects[c]){var d=b[c],f=null;if(void 0!==d.geometry){if(I=J.geometries[d.geometry])f=!1,D=J.materials[d.materials[0]],(f=D instanceof THREE.ShaderMaterial)&&I.computeTangents(),u=d.position,v=d.rotation,s=d.quaternion,A=d.scale,r=d.matrix,s=0,0===d.materials.length&&(D=new THREE.MeshFaceMaterial),1<d.materials.length&&(D=new THREE.MeshFaceMaterial),d.morph?
(f=new THREE.MorphAnimMesh(I,D),void 0!==d.duration&&(f.duration=d.duration),void 0!==d.time&&(f.time=d.time),void 0!==d.mirroredLoop&&(f.mirroredLoop=d.mirroredLoop),D.morphNormals&&I.computeMorphNormals()):f=new THREE.Mesh(I,D),f.name=c,r?(f.matrixAutoUpdate=!1,f.matrix.set(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15])):(f.position.set(u[0],u[1],u[2]),s?(f.quaternion.set(s[0],s[1],s[2],s[3]),f.useQuaternion=!0):f.rotation.set(v[0],v[1],v[2]),f.scale.set(A[0],
A[1],A[2])),f.visible=d.visible,f.castShadow=d.castShadow,f.receiveShadow=d.receiveShadow,a.add(f),J.objects[c]=f}else u=d.position,v=d.rotation,s=d.quaternion,A=d.scale,s=0,f=new THREE.Object3D,f.name=c,f.position.set(u[0],u[1],u[2]),s?(f.quaternion.set(s[0],s[1],s[2],s[3]),f.useQuaternion=!0):f.rotation.set(v[0],v[1],v[2]),f.scale.set(A[0],A[1],A[2]),f.visible=void 0!==d.visible?d.visible:!1,a.add(f),J.objects[c]=f,J.empties[c]=f;if(f){if(void 0!==d.properties)for(var g in d.properties)f.properties[g]=
d.properties[g];void 0!==d.children&&e(f,d.children)}}}function f(a){return function(b){J.geometries[a]=b;e(J.scene,M.objects);H-=1;i.onLoadComplete();h()}}function g(a){return function(b){J.geometries[a]=b}}function h(){i.callbackProgress({totalModels:L,totalTextures:K,loadedModels:L-H,loadedTextures:K-Q},J);i.onLoadProgress();0===H&&0===Q&&b(J)}var i=this,j=THREE.Loader.prototype.extractUrlBase(c),l,n,m,p,o,q,r,t,u,v,s,A,w,z,I,D,F,B,E,H,Q,L,K,J,M=a;for(w in this.geometryHandlerMap)this.geometryHandlerMap[w].loaderObject=
new this.geometryHandlerMap[w].loaderClass;Q=H=0;J={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(M.transform&&(a=M.transform.position,c=M.transform.rotation,w=M.transform.scale,a&&J.scene.position.set(a[0],a[1],a[2]),c&&J.scene.rotation.set(c[0],c[1],c[2]),w&&J.scene.scale.set(w[0],w[1],w[2]),a||c||w))J.scene.updateMatrix(),J.scene.updateMatrixWorld();a=function(a){return function(){Q-=a;h();i.onLoadComplete()}};for(p in M.cameras)w=
M.cameras[p],"perspective"===w.type?F=new THREE.PerspectiveCamera(w.fov,w.aspect,w.near,w.far):"ortho"===w.type&&(F=new THREE.OrthographicCamera(w.left,w.right,w.top,w.bottom,w.near,w.far)),u=w.position,c=w.target,w=w.up,F.position.set(u[0],u[1],u[2]),F.target=new THREE.Vector3(c[0],c[1],c[2]),w&&F.up.set(w[0],w[1],w[2]),J.cameras[p]=F;for(m in M.lights)c=M.lights[m],p=void 0!==c.color?c.color:16777215,F=void 0!==c.intensity?c.intensity:1,"directional"===c.type?(u=c.direction,t=new THREE.DirectionalLight(p,
F),t.position.set(u[0],u[1],u[2]),t.position.normalize()):"point"===c.type?(u=c.position,t=c.distance,t=new THREE.PointLight(p,F,t),t.position.set(u[0],u[1],u[2])):"ambient"===c.type&&(t=new THREE.AmbientLight(p)),J.scene.add(t),J.lights[m]=t;for(o in M.fogs)m=M.fogs[o],"linear"===m.type?B=new THREE.Fog(0,m.near,m.far):"exp2"===m.type&&(B=new THREE.FogExp2(0,m.density)),w=m.color,B.color.setRGB(w[0],w[1],w[2]),J.fogs[o]=B;J.cameras&&M.defaults.camera&&(J.currentCamera=J.cameras[M.defaults.camera]);
...
o.subdivisions),J.geometries[l]=I;else if(o.type in this.geometryHandlerMap){B={};for(E in o)"type"!==E&&"url"!==E&&(B[E]=o[E]);this.geometryHandlerMap[o.type].loaderObject.load(d(o.url,M.urlBaseType),f(l),B)}else"embedded"===o.type&&(o=M.embeds[o.id],o.metadata=M.metadata,o&&this.geometryHandlerMap.ascii.loaderObject.createModel(o,g(l),""));for(q in M.textures)if(l=M.textures[q],l.url instanceof Array){Q+=l.url.length;for(E=0;E<l.url.length;E++)i.onLoadStart()}else Q+=1,i.onLoadStart();K=Q;for(q in M.textures){l=
M.textures[q];void 0!==l.mapping&&void 0!==THREE[l.mapping]&&(l.mapping=new THREE[l.mapping]);if(l.url instanceof Array){o=l.url.length;B=[];for(E=0;E<o;E++)B[E]=d(l.url[E],M.urlBaseType);E=(E=B[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(B,l.mapping,a(o)):THREE.ImageUtils.loadTextureCube(B,l.mapping,a(o))}else{E=l.url.toLowerCase().endsWith(".dds");o=d(l.url,M.urlBaseType);B=a(1);E=E?THREE.ImageUtils.loadCompressedTexture(o,l.mapping,B):THREE.ImageUtils.loadTexture(o,l.mapping,
...
o[l.wrap[1]]}J.textures[q]=E}for(n in M.materials){r=M.materials[n];for(z in r.parameters)"envMap"===z||"map"===z||"lightMap"===z||"bumpMap"===z?r.parameters[z]=J.textures[r.parameters[z]]:"shading"===z?r.parameters[z]="flat"===r.parameters[z]?THREE.FlatShading:THREE.SmoothShading:"side"===z?r.parameters[z]="double"==r.parameters[z]?THREE.DoubleSide:"back"==r.parameters[z]?THREE.BackSide:THREE.FrontSide:"blending"===z?r.parameters[z]=r.parameters[z]in THREE?THREE[r.parameters[z]]:THREE.NormalBlending:
"combine"===z?r.parameters[z]="MixOperation"==r.parameters[z]?THREE.MixOperation:THREE.MultiplyOperation:"vertexColors"===z?"face"==r.parameters[z]?r.parameters[z]=THREE.FaceColors:r.parameters[z]&&(r.parameters[z]=THREE.VertexColors):"wrapRGB"===z&&(q=r.parameters[z],r.parameters[z]=new THREE.Vector3(q[0],q[1],q[2]));void 0!==r.parameters.opacity&&1>r.parameters.opacity&&(r.parameters.transparent=!0);r.parameters.normalMap?(q=THREE.ShaderUtils.lib.normal,a=THREE.UniformsUtils.clone(q.uniforms),l=
...
(a.uOpacity.value=r.parameters.opacity),D=new THREE.ShaderMaterial({fragmentShader:q.fragmentShader,vertexShader:q.vertexShader,uniforms:a,lights:!0,fog:!0})):D=new THREE[r.type](r.parameters);J.materials[n]=D}e(J.scene,M.objects);i.callbackSync(J);h()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
THREE.CanvasRenderer=function(a){function b(a){u!==a&&(u=q.globalAlpha=a)}function c(a){v!==a&&(a===THREE.NormalBlending?q.globalCompositeOperation="source-over":a===THREE.AdditiveBlending?q.globalCompositeOperation="lighter":a===THREE.SubtractiveBlending&&(q.globalCompositeOperation="darker"),v=a)}function d(a){s!==a&&(s=q.strokeStyle=a)}function e(a){A!==a&&(A=q.fillStyle=a)}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},f=this,g,h,i,j=new THREE.Projector,l=void 0!==a.canvas?a.canvas:
document.createElement("canvas"),n,m,p,o,q=l.getContext("2d"),r=new THREE.Color(0),t=0,u=1,v=0,s=null,A=null,w=null,z=null,I=null,D,F,B,E,H=new THREE.RenderableVertex,Q=new THREE.RenderableVertex,L,K,J,M,T,Z,ea,N,fa,S,ra,wa,O=new THREE.Color,ga=new THREE.Color,P=new THREE.Color,X=new THREE.Color,ia=new THREE.Color,$=new THREE.Color,ca=new THREE.Color,Ja={},ua={},La,Wa,oa,Xa,kb,Ta,gb,rb,Rb,fb,bb=new THREE.Rectangle,Ma=new THREE.Rectangle,za=new THREE.Rectangle,yb=!1,Ga=new THREE.Color,sb=new THREE.Color,
hb=new THREE.Color,xa=new THREE.Vector3,ib,ab,Ya,Ha,zb,k,a=16;ib=document.createElement("canvas");ib.width=ib.height=2;ab=ib.getContext("2d");ab.fillStyle="rgba(0,0,0,1)";ab.fillRect(0,0,2,2);Ya=ab.getImageData(0,0,2,2);Ha=Ya.data;zb=document.createElement("canvas");zb.width=zb.height=a;k=zb.getContext("2d");k.translate(-a/2,-a/2);k.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){n=a;m=b;p=Math.floor(n/
2);o=Math.floor(m/2);l.width=n;l.height=m;bb.set(-p,-o,p,o);Ma.set(-p,-o,p,o);u=1;v=0;I=z=w=A=s=null};this.setClearColor=function(a,b){r.copy(a);t=void 0!==b?b:1;Ma.set(-p,-o,p,o)};this.setClearColorHex=function(a,b){r.setHex(a);t=void 0!==b?b:1;Ma.set(-p,-o,p,o)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){q.setTransform(1,0,0,-1,p,o);!1===Ma.isEmpty()&&(Ma.minSelf(bb),Ma.inflate(2),1>t&&q.clearRect(Math.floor(Ma.getX()),Math.floor(Ma.getY()),Math.floor(Ma.getWidth()),Math.floor(Ma.getHeight())),
0<t&&(c(THREE.NormalBlending),b(1),e("rgba("+Math.floor(255*r.r)+","+Math.floor(255*r.g)+","+Math.floor(255*r.b)+","+t+")"),q.fillRect(Math.floor(Ma.getX()),Math.floor(Ma.getY()),Math.floor(Ma.getWidth()),Math.floor(Ma.getHeight()))),Ma.empty())};this.render=function(a,l){function n(a,b,c){for(var d=0,e=i.length;d<e;d++){var f=i[d],g=f.color;if(f instanceof THREE.DirectionalLight){var h=f.matrixWorld.getPosition().normalize(),k=b.dot(h);0>=k||(k*=f.intensity,c.r+=g.r*k,c.g+=g.g*k,c.b+=g.b*k)}else f instanceof
THREE.PointLight&&(h=f.matrixWorld.getPosition(),k=b.dot(xa.sub(h,a).normalize()),0>=k||(k*=0==f.distance?1:1-Math.min(a.distanceTo(h)/f.distance,1),0!=k&&(k*=f.intensity,c.r+=g.r*k,c.g+=g.g*k,c.b+=g.b*k)))}}function m(a,d,e,g,h,k,i,j){f.info.render.vertices+=3;f.info.render.faces++;b(j.opacity);c(j.blending);L=a.positionScreen.x;K=a.positionScreen.y;J=d.positionScreen.x;M=d.positionScreen.y;T=e.positionScreen.x;Z=e.positionScreen.y;r(L,K,J,M,T,Z);(j instanceof THREE.MeshLambertMaterial||j instanceof
THREE.MeshPhongMaterial)&&null===j.map&&null===j.map?($.copy(j.color),ca.copy(j.emissive),j.vertexColors===THREE.FaceColors&&($.r*=i.color.r,$.g*=i.color.g,$.b*=i.color.b),!0===yb)?!1===j.wireframe&&j.shading==THREE.SmoothShading&&3==i.vertexNormalsLength?(ga.r=P.r=X.r=Ga.r,ga.g=P.g=X.g=Ga.g,ga.b=P.b=X.b=Ga.b,n(i.v1.positionWorld,i.vertexNormalsWorld[0],ga),n(i.v2.positionWorld,i.vertexNormalsWorld[1],P),n(i.v3.positionWorld,i.vertexNormalsWorld[2],X),ga.r=ga.r*$.r+ca.r,ga.g=ga.g*$.g+ca.g,ga.b=ga.b*
$.b+ca.b,P.r=P.r*$.r+ca.r,P.g=P.g*$.g+ca.g,P.b=P.b*$.b+ca.b,X.r=X.r*$.r+ca.r,X.g=X.g*$.g+ca.g,X.b=X.b*$.b+ca.b,ia.r=0.5*(P.r+X.r),ia.g=0.5*(P.g+X.g),ia.b=0.5*(P.b+X.b),oa=Ec(ga,P,X,ia),ic(L,K,J,M,T,Z,0,0,1,0,0,1,oa)):(O.r=Ga.r,O.g=Ga.g,O.b=Ga.b,n(i.centroidWorld,i.normalWorld,O),O.r=O.r*$.r+ca.r,O.g=O.g*$.g+ca.g,O.b=O.b*$.b+ca.b,!0===j.wireframe?t(O,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):v(O)):!0===j.wireframe?t(j.color,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):
v(j.color):j instanceof THREE.MeshBasicMaterial||j instanceof THREE.MeshLambertMaterial||j instanceof THREE.MeshPhongMaterial?null!==j.map?j.map.mapping instanceof THREE.UVMapping&&(Xa=i.uvs[0],Ea(L,K,J,M,T,Z,Xa[g].u,Xa[g].v,Xa[h].u,Xa[h].v,Xa[k].u,Xa[k].v,j.map)):null!==j.envMap?j.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=l.matrixWorldInverse,xa.copy(i.vertexNormalsWorld[g]),kb=0.5*(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])+0.5,Ta=0.5*(xa.x*a.elements[1]+xa.y*
a.elements[5]+xa.z*a.elements[9])+0.5,xa.copy(i.vertexNormalsWorld[h]),gb=0.5*(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])+0.5,rb=0.5*(xa.x*a.elements[1]+xa.y*a.elements[5]+xa.z*a.elements[9])+0.5,xa.copy(i.vertexNormalsWorld[k]),Rb=0.5*(xa.x*a.elements[0]+xa.y*a.elements[4]+xa.z*a.elements[8])+0.5,fb=0.5*(xa.x*a.elements[1]+xa.y*a.elements[5]+xa.z*a.elements[9])+0.5,Ea(L,K,J,M,T,Z,kb,Ta,gb,rb,Rb,fb,j.envMap)):(O.copy(j.color),j.vertexColors===THREE.FaceColors&&(O.r*=i.color.r,O.g*=
i.color.g,O.b*=i.color.b),!0===j.wireframe?t(O,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):v(O)):j instanceof THREE.MeshDepthMaterial?(La=l.near,Wa=l.far,ga.r=ga.g=ga.b=1-vb(a.positionScreen.z,La,Wa),P.r=P.g=P.b=1-vb(d.positionScreen.z,La,Wa),X.r=X.g=X.b=1-vb(e.positionScreen.z,La,Wa),ia.r=0.5*(P.r+X.r),ia.g=0.5*(P.g+X.g),ia.b=0.5*(P.b+X.b),oa=Ec(ga,P,X,ia),ic(L,K,J,M,T,Z,0,0,1,0,0,1,oa)):j instanceof THREE.MeshNormalMaterial&&(O.r=u(i.normalWorld.x),O.g=u(i.normalWorld.y),O.b=u(i.normalWorld.z),
!0===j.wireframe?t(O,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):v(O))}function r(a,b,c,d,e,f){q.beginPath();q.moveTo(a,b);q.lineTo(c,d);q.lineTo(e,f);q.closePath()}function s(a,b,c,d,e,f,g,h){q.beginPath();q.moveTo(a,b);q.lineTo(c,d);q.lineTo(e,f);q.lineTo(g,h);q.closePath()}function t(a,b,c,e){w!==b&&(w=q.lineWidth=b);z!==c&&(z=q.lineCap=c);I!==e&&(I=q.lineJoin=e);d(a.getContextStyle());q.stroke();za.inflate(2*b)}function v(a){e(a.getContextStyle());q.fill()}function Ea(a,b,c,d,
f,g,h,k,i,j,l,n,m){if(!(m instanceof THREE.DataTexture||void 0===m.image||0==m.image.width)){if(!0===m.needsUpdate){var Ea=m.wrapS==THREE.RepeatWrapping,o=m.wrapT==THREE.RepeatWrapping;Ja[m.id]=q.createPattern(m.image,!0===Ea&&!0===o?"repeat":!0===Ea&&!1===o?"repeat-x":!1===Ea&&!0===o?"repeat-y":"no-repeat");m.needsUpdate=!1}void 0===Ja[m.id]?e("rgba(0,0,0,1)"):e(Ja[m.id]);var Ea=m.offset.x/m.repeat.x,o=m.offset.y/m.repeat.y,p=m.image.width*m.repeat.x,vb=m.image.height*m.repeat.y,h=(h+Ea)*p,k=(1-
k+o)*vb,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+Ea)*p-h,j=(1-j+o)*vb-k,l=(l+Ea)*p-h,n=(1-n+o)*vb-k,Ea=i*n-l*j;0===Ea?(void 0===ua[m.id]&&(b=document.createElement("canvas"),b.width=m.image.width,b.height=m.image.height,b=b.getContext("2d"),b.drawImage(m.image,0,0),ua[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data),b=ua[m.id],h=4*(Math.floor(h)+Math.floor(k)*m.image.width),O.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),v(O)):(Ea=1/Ea,m=(n*c-j*f)*Ea,j=(n*d-j*g)*Ea,c=(i*f-l*c)*Ea,d=(i*g-l*d)*Ea,a=a-m*h-
c*k,h=b-j*h-d*k,q.save(),q.transform(m,j,c,d,a,h),q.fill(),q.restore())}}function ic(a,b,c,d,e,f,g,h,k,i,j,l,m){var n,Ea;n=m.width-1;Ea=m.height-1;g*=n;h*=Ea;c-=a;d-=b;e-=a;f-=b;k=k*n-g;i=i*Ea-h;j=j*n-g;l=l*Ea-h;Ea=1/(k*l-j*i);n=(l*c-i*e)*Ea;i=(l*d-i*f)*Ea;c=(k*e-j*c)*Ea;d=(k*f-j*d)*Ea;a=a-n*g-c*h;b=b-i*g-d*h;q.save();q.transform(n,i,c,d,a,b);q.clip();q.drawImage(m,0,0);q.restore()}function Ec(a,b,c,d){Ha[0]=255*a.r|0;Ha[1]=255*a.g|0;Ha[2]=255*a.b|0;Ha[4]=255*b.r|0;Ha[5]=255*b.g|0;Ha[6]=255*b.b|0;
Ha[8]=255*c.r|0;Ha[9]=255*c.g|0;Ha[10]=255*c.b|0;Ha[12]=255*d.r|0;Ha[13]=255*d.g|0;Ha[14]=255*d.b|0;ab.putImageData(Ya,0,0);k.drawImage(ib,0,0);return zb}function vb(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function u(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function Yb(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===l instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{var A,
Gc,ka,aa;!0===this.autoClear?this.clear():q.setTransform(1,0,0,-1,p,o);f.info.render.vertices=0;f.info.render.faces=0;g=j.projectScene(a,l,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;yb=0<i.length;if(!0===yb){Ga.setRGB(0,0,0);sb.setRGB(0,0,0);hb.setRGB(0,0,0);A=0;for(Gc=i.length;A<Gc;A++){aa=i[A];var la=aa.color;aa instanceof THREE.AmbientLight?(Ga.r+=la.r,Ga.g+=la.g,Ga.b+=la.b):aa instanceof THREE.DirectionalLight?(sb.r+=la.r,sb.g+=la.g,sb.b+=la.b):aa instanceof THREE.PointLight&&
(hb.r+=la.r,hb.g+=la.g,hb.b+=la.b)}}A=0;for(Gc=h.length;A<Gc;A++)if(ka=h[A],aa=ka.material,!(void 0===aa||!1===aa.visible)){za.empty();if(ka instanceof THREE.RenderableParticle){D=ka;D.x*=p;D.y*=o;var la=D,Za=ka;b(aa.opacity);c(aa.blending);var tb=void 0,ub=void 0,lb=void 0,mb=void 0,lc=ka=void 0,Vc=void 0;aa instanceof THREE.ParticleBasicMaterial?null===aa.map?(lb=Za.object.scale.x,mb=Za.object.scale.y,lb*=Za.scale.x*p,mb*=Za.scale.y*o,za.set(la.x-lb,la.y-mb,la.x+lb,la.y+mb),!1!==bb.intersects(za)&&
(e(aa.color.getContextStyle()),q.save(),q.translate(la.x,la.y),q.rotate(-Za.rotation),q.scale(lb,mb),q.fillRect(-1,-1,2,2),q.restore())):(ka=aa.map.image,lc=ka.width>>1,Vc=ka.height>>1,lb=Za.scale.x*p,mb=Za.scale.y*o,tb=lb*lc,ub=mb*Vc,za.set(la.x-tb,la.y-ub,la.x+tb,la.y+ub),!1!==bb.intersects(za)&&(q.save(),q.translate(la.x,la.y),q.rotate(-Za.rotation),q.scale(lb,-mb),q.translate(-lc,-Vc),q.drawImage(ka,0,0),q.restore())):aa instanceof THREE.ParticleCanvasMaterial&&(tb=Za.scale.x*p,ub=Za.scale.y*
o,za.set(la.x-tb,la.y-ub,la.x+tb,la.y+ub),!1!==bb.intersects(za)&&(d(aa.color.getContextStyle()),e(aa.color.getContextStyle()),q.save(),q.translate(la.x,la.y),q.rotate(-Za.rotation),q.scale(tb,ub),aa.program(q),q.restore()))}else if(ka instanceof THREE.RenderableLine){if(D=ka.v1,F=ka.v2,D.positionScreen.x*=p,D.positionScreen.y*=o,F.positionScreen.x*=p,F.positionScreen.y*=o,za.addPoint(D.positionScreen.x,D.positionScreen.y),za.addPoint(F.positionScreen.x,F.positionScreen.y),!0===bb.intersects(za)&&
(la=D,Za=F,b(aa.opacity),c(aa.blending),q.beginPath(),q.moveTo(la.positionScreen.x,la.positionScreen.y),q.lineTo(Za.positionScreen.x,Za.positionScreen.y),aa instanceof THREE.LineBasicMaterial))la=aa.linewidth,w!==la&&(w=q.lineWidth=la),la=aa.linecap,z!==la&&(z=q.lineCap=la),la=aa.linejoin,I!==la&&(I=q.lineJoin=la),d(aa.color.getContextStyle()),q.stroke(),za.inflate(2*aa.linewidth)}else if(ka instanceof THREE.RenderableFace3)D=ka.v1,F=ka.v2,B=ka.v3,D.positionScreen.x*=p,D.positionScreen.y*=o,F.positionScreen.x*=
p,F.positionScreen.y*=o,B.positionScreen.x*=p,B.positionScreen.y*=o,!0===aa.overdraw&&(Yb(D.positionScreen,F.positionScreen),Yb(F.positionScreen,B.positionScreen),Yb(B.positionScreen,D.positionScreen)),za.add3Points(D.positionScreen.x,D.positionScreen.y,F.positionScreen.x,F.positionScreen.y,B.positionScreen.x,B.positionScreen.y),!0===bb.intersects(za)&&m(D,F,B,0,1,2,ka,aa,a);else if(ka instanceof THREE.RenderableFace4&&(D=ka.v1,F=ka.v2,B=ka.v3,E=ka.v4,D.positionScreen.x*=p,D.positionScreen.y*=o,F.positionScreen.x*=
p,F.positionScreen.y*=o,B.positionScreen.x*=p,B.positionScreen.y*=o,E.positionScreen.x*=p,E.positionScreen.y*=o,H.positionScreen.copy(F.positionScreen),Q.positionScreen.copy(E.positionScreen),!0===aa.overdraw&&(Yb(D.positionScreen,F.positionScreen),Yb(F.positionScreen,E.positionScreen),Yb(E.positionScreen,D.positionScreen),Yb(B.positionScreen,H.positionScreen),Yb(B.positionScreen,Q.positionScreen)),za.addPoint(D.positionScreen.x,D.positionScreen.y),za.addPoint(F.positionScreen.x,F.positionScreen.y),
za.addPoint(B.positionScreen.x,B.positionScreen.y),za.addPoint(E.positionScreen.x,E.positionScreen.y),!0===bb.intersects(za)))(la=D,Za=F,tb=B,ub=E,lb=H,mb=Q,lc=a,f.info.render.vertices+=4,f.info.render.faces++,b(aa.opacity),c(aa.blending),void 0!==aa.map&&null!==aa.map||void 0!==aa.envMap&&null!==aa.envMap)?(m(la,Za,ub,0,1,3,ka,aa,lc),m(lb,tb,mb,1,2,3,ka,aa,lc)):(L=la.positionScreen.x,K=la.positionScreen.y,J=Za.positionScreen.x,M=Za.positionScreen.y,T=tb.positionScreen.x,Z=tb.positionScreen.y,ea=
ub.positionScreen.x,N=ub.positionScreen.y,fa=lb.positionScreen.x,S=lb.positionScreen.y,ra=mb.positionScreen.x,wa=mb.positionScreen.y,aa instanceof THREE.MeshLambertMaterial||aa instanceof THREE.MeshPhongMaterial)?($.copy(aa.color),ca.copy(aa.emissive),aa.vertexColors===THREE.FaceColors&&($.r*=ka.color.r,$.g*=ka.color.g,$.b*=ka.color.b),!0===yb)?!1===aa.wireframe&&aa.shading==THREE.SmoothShading&&4==ka.vertexNormalsLength?(ga.r=P.r=X.r=ia.r=Ga.r,ga.g=P.g=X.g=ia.g=Ga.g,ga.b=P.b=X.b=ia.b=Ga.b,n(ka.v1.positionWorld,
ka.vertexNormalsWorld[0],ga),n(ka.v2.positionWorld,ka.vertexNormalsWorld[1],P),n(ka.v4.positionWorld,ka.vertexNormalsWorld[3],X),n(ka.v3.positionWorld,ka.vertexNormalsWorld[2],ia),ga.r=ga.r*$.r+ca.r,ga.g=ga.g*$.g+ca.g,ga.b=ga.b*$.b+ca.b,P.r=P.r*$.r+ca.r,P.g=P.g*$.g+ca.g,P.b=P.b*$.b+ca.b,X.r=X.r*$.r+ca.r,X.g=X.g*$.g+ca.g,X.b=X.b*$.b+ca.b,ia.r=ia.r*$.r+ca.r,ia.g=ia.g*$.g+ca.g,ia.b=ia.b*$.b+ca.b,oa=Ec(ga,P,X,ia),r(L,K,J,M,ea,N),ic(L,K,J,M,ea,N,0,0,1,0,0,1,oa),r(fa,S,T,Z,ra,wa),ic(fa,S,T,Z,ra,wa,1,0,
1,1,0,1,oa)):(O.r=Ga.r,O.g=Ga.g,O.b=Ga.b,n(ka.centroidWorld,ka.normalWorld,O),O.r=O.r*$.r+ca.r,O.g=O.g*$.g+ca.g,O.b=O.b*$.b+ca.b,s(L,K,J,M,T,Z,ea,N),!0===aa.wireframe?t(O,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):v(O)):(O.r=$.r+ca.r,O.g=$.g+ca.g,O.b=$.b+ca.b,s(L,K,J,M,T,Z,ea,N),!0===aa.wireframe?t(O,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):v(O)):aa instanceof THREE.MeshBasicMaterial?(O.copy(aa.color),aa.vertexColors===THREE.FaceColors&&(O.r*=ka.color.r,
O.g*=ka.color.g,O.b*=ka.color.b),s(L,K,J,M,T,Z,ea,N),!0===aa.wireframe?t(O,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):v(O)):aa instanceof THREE.MeshNormalMaterial?(O.r=u(ka.normalWorld.x),O.g=u(ka.normalWorld.y),O.b=u(ka.normalWorld.z),s(L,K,J,M,T,Z,ea,N),!0===aa.wireframe?t(O,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):v(O)):aa instanceof THREE.MeshDepthMaterial&&(La=l.near,Wa=l.far,ga.r=ga.g=ga.b=1-vb(la.positionScreen.z,La,Wa),P.r=P.g=P.b=1-vb(Za.positionScreen.z,
La,Wa),X.r=X.g=X.b=1-vb(ub.positionScreen.z,La,Wa),ia.r=ia.g=ia.b=1-vb(tb.positionScreen.z,La,Wa),oa=Ec(ga,P,X,ia),r(L,K,J,M,ea,N),ic(L,K,J,M,ea,N,0,0,1,0,0,1,oa),r(fa,S,T,Z,ra,wa),ic(fa,S,T,Z,ra,wa,1,0,1,1,0,1,oa));Ma.addRectangle(za)}q.setTransform(1,0,0,1,0,0)}}};
...
c,d;for(b in a.attributes)d="index"===b?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER,c=a.attributes[b],c.buffer=k.createBuffer(),k.bindBuffer(d,c.buffer),k.bufferData(d,c.array,k.STATIC_DRAW)}function g(a,b,c){var d,e,f,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,o=a.verticesNeedUpdate,q=a.colorsNeedUpdate,p=a.__webglCustomAttributesList;if(c.sortParticles){ib.copy(xa);ib.multiplySelf(c.matrixWorld);for(d=0;d<g;d++)e=h[d],ab.copy(e),ib.multiplyVector3(ab),
n[d]=[ab.z,d];n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++)e=h[n[d][1]],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;for(d=0;d<j;d++)f=3*d,e=i[n[d][1]],m[f]=e.r,m[f+1]=e.g,m[f+2]=e.b;if(p){i=0;for(j=p.length;i<j;i++)if(h=p[i],void 0===h.boundTo||"vertices"===h.boundTo)if(f=0,e=h.value.length,1===h.size)for(d=0;d<e;d++)g=n[d][1],h.array[d]=h.value[g];else if(2===h.size)for(d=0;d<e;d++)g=n[d][1],g=h.value[g],h.array[f]=g.x,h.array[f+1]=g.y,f+=2;else if(3===h.size)if("c"===h.type)for(d=0;d<e;d++)g=
n[d][1],g=h.value[g],h.array[f]=g.r,h.array[f+1]=g.g,h.array[f+2]=g.b,f+=3;else for(d=0;d<e;d++)g=n[d][1],g=h.value[g],h.array[f]=g.x,h.array[f+1]=g.y,h.array[f+2]=g.z,f+=3;else if(4===h.size)for(d=0;d<e;d++)g=n[d][1],g=h.value[g],h.array[f]=g.x,h.array[f+1]=g.y,h.array[f+2]=g.z,h.array[f+3]=g.w,f+=4}}else{if(o)for(d=0;d<g;d++)e=h[d],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;if(q)for(d=0;d<j;d++)e=i[d],f=3*d,m[f]=e.r,m[f+1]=e.g,m[f+2]=e.b;if(p){i=0;for(j=p.length;i<j;i++)if(h=p[i],h.needsUpdate&&(void 0===
...
k.bufferData(k.ARRAY_BUFFER,i.array,b));a.tangentsNeedUpdate&&void 0!==d&&(k.bindBuffer(k.ARRAY_BUFFER,d.buffer),k.bufferData(k.ARRAY_BUFFER,d.array,b));if(c)for(var j in a.attributes)delete a.attributes[j].array}function i(a,b){return b.z-a.z}function j(a,b){return b[1]-a[1]}function l(a,b,c){if(a.length)for(var d=0,f=a.length;d<f;d++)ia=O=null,P=X=ua=Ja=Ta=kb=La=-1,Ha=!0,a[d].render(b,c,Ga,sb),ia=O=null,P=X=ua=Ja=Ta=kb=La=-1,Ha=!0}function n(a,b,c,d,f,e,g,h){var k,i,j,l;b?(i=a.length-1,l=b=-1):
(i=0,b=a.length,l=1);for(var m=i;m!==b;m+=l)if(k=a[m],k.render){i=k.object;j=k.buffer;if(h)k=h;else{k=k[c];if(!k)continue;g&&S.setBlending(k.blending,k.blendEquation,k.blendSrc,k.blendDst);S.setDepthTest(k.depthTest);S.setDepthWrite(k.depthWrite);z(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits)}S.setMaterialFaces(k);j instanceof THREE.BufferGeometry?S.renderBufferDirect(d,f,e,k,j,i):S.renderBuffer(d,f,e,k,j,i)}}function m(a,b,c,d,f,e,g){for(var h,k,i=0,j=a.length;i<j;i++)if(h=a[i],k=
h.object,k.visible){if(g)h=g;else{h=h[b];if(!h)continue;e&&S.setBlending(h.blending,h.blendEquation,h.blendSrc,h.blendDst);S.setDepthTest(h.depthTest);S.setDepthWrite(h.depthWrite);z(h.polygonOffset,h.polygonOffsetFactor,h.polygonOffsetUnits)}S.renderImmediateObject(c,d,f,h,k)}}function p(a,b,c){a.push({buffer:b,object:c,opaque:null,transparent:null})}function o(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return!0;return!1}function q(a){for(var b in a.attributes)a.attributes[b].needsUpdate=
!1}function r(a,b){for(var c=a.length-1;0<=c;c--)a[c].object===b&&a.splice(c,1)}function t(a,b){for(var c=a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function u(a,b,c,d,f){ca=0;d.needsUpdate&&(d.program&&S.deallocateMaterial(d),S.initMaterial(d,b,c,f),d.needsUpdate=!1);d.morphTargets&&!f.__webglMorphTargetInfluences&&(f.__webglMorphTargetInfluences=new Float32Array(S.maxMorphTargets));var e=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==O&&(k.useProgram(g),O=g,e=!0);d.id!==P&&(P=d.id,e=!0);if(e||a!==
ia)k.uniformMatrix4fv(h.projectionMatrix,!1,a._projectionMatrixArray),a!==ia&&(ia=a);if(d.skinning)if(kc&&f.useVertexTexture){if(null!==h.boneTexture){var j=v();k.uniform1i(h.boneTexture,j);S.setTexture(f.boneTexture,j)}}else null!==h.boneGlobalMatrices&&k.uniformMatrix4fv(h.boneGlobalMatrices,!1,f.boneMatrices);if(e){c&&d.fog&&(i.fogColor.value=c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||
d instanceof THREE.MeshLambertMaterial||d.lights){if(Ha){for(var l=0,m=0,n=0,o,q,p,r,s=zb,t=s.directional.colors,u=s.directional.positions,z=s.point.colors,D=s.point.positions,E=s.point.distances,B=s.spot.colors,I=s.spot.positions,K=s.spot.distances,J=s.spot.directions,L=s.spot.angles,M=s.spot.exponents,N=s.hemi.skyColors,X=s.hemi.groundColors,$=s.hemi.positions,ga=0,T=0,ea=0,fa=0,c=o=p=p=q=0,e=b.length;c<e;c++)j=b[c],!j.onlyShadow&&j.visible&&(o=j.color,r=j.intensity,q=j.distance,j instanceof THREE.AmbientLight?
S.gammaInput?(l+=o.r*o.r,m+=o.g*o.g,n+=o.b*o.b):(l+=o.r,m+=o.g,n+=o.b):j instanceof THREE.DirectionalLight?(q=3*ga,S.gammaInput?A(t,q,o,r*r):w(t,q,o,r),Ya.copy(j.matrixWorld.getPosition()),Ya.subSelf(j.target.matrixWorld.getPosition()),Ya.normalize(),u[q]=Ya.x,u[q+1]=Ya.y,u[q+2]=Ya.z,ga+=1):j instanceof THREE.PointLight?(p=3*T,S.gammaInput?A(z,p,o,r*r):w(z,p,o,r),r=j.matrixWorld.getPosition(),D[p]=r.x,D[p+1]=r.y,D[p+2]=r.z,E[T]=q,T+=1):j instanceof THREE.SpotLight?(p=3*ea,S.gammaInput?A(B,p,o,r*r):
w(B,p,o,r),r=j.matrixWorld.getPosition(),I[p]=r.x,I[p+1]=r.y,I[p+2]=r.z,K[ea]=q,Ya.copy(r),Ya.subSelf(j.target.matrixWorld.getPosition()),Ya.normalize(),J[p]=Ya.x,J[p+1]=Ya.y,J[p+2]=Ya.z,L[ea]=Math.cos(j.angle),M[ea]=j.exponent,ea+=1):j instanceof THREE.HemisphereLight&&(q=j.color,p=j.groundColor,o=3*fa,S.gammaInput?(r*=r,A(N,o,q,r),A(X,o,p,r)):(w(N,o,q,r),w(X,o,p,r)),r=j.matrixWorld.getPosition(),$[o]=r.x,$[o+1]=r.y,$[o+2]=r.z,fa+=1));c=3*ga;for(e=t.length;c<e;c++)t[c]=0;c=3*T;for(e=z.length;c<e;c++)z[c]=
0;c=3*ea;for(e=B.length;c<e;c++)B[c]=0;c=3*fa;for(e=N.length;c<e;c++)N[c]=0;c=3*fa;for(e=X.length;c<e;c++)X[c]=0;s.directional.length=ga;s.point.length=T;s.spot.length=ea;s.hemi.length=fa;s.ambient[0]=l;s.ambient[1]=m;s.ambient[2]=n;Ha=!1}c=zb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;
...
j);else if("iv"===l)k.uniform3iv(e,j);else if("fv1"===l)k.uniform1fv(e,j);else if("fv"===l)k.uniform3fv(e,j);else if("v2v"===l){void 0===c._array&&(c._array=new Float32Array(2*j.length));l=0;for(m=j.length;l<m;l++)n=2*l,c._array[n]=j[l].x,c._array[n+1]=j[l].y;k.uniform2fv(e,c._array)}else if("v3v"===l){void 0===c._array&&(c._array=new Float32Array(3*j.length));l=0;for(m=j.length;l<m;l++)n=3*l,c._array[n]=j[l].x,c._array[n+1]=j[l].y,c._array[n+2]=j[l].z;k.uniform3fv(e,c._array)}else if("v4v"===l){void 0===
c._array&&(c._array=new Float32Array(4*j.length));l=0;for(m=j.length;l<m;l++)n=4*l,c._array[n]=j[l].x,c._array[n+1]=j[l].y,c._array[n+2]=j[l].z,c._array[n+3]=j[l].w;k.uniform4fv(e,c._array)}else if("m4"===l)void 0===c._array&&(c._array=new Float32Array(16)),j.flattenToArray(c._array),k.uniformMatrix4fv(e,!1,c._array);else if("m4v"===l){void 0===c._array&&(c._array=new Float32Array(16*j.length));l=0;for(m=j.length;l<m;l++)j[l].flattenToArrayOffset(c._array,16*l);k.uniformMatrix4fv(e,!1,c._array)}else if("t"===
l){if(n=j,j=v(),k.uniform1i(e,j),n)if(n.image instanceof Array&&6===n.image.length){if(c=n,e=j,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=k.createTexture());k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);e=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)S.autoScaleCubemaps&&!e?(m=j,n=l,s=c.image[l],u=Uc,s.width<=u&&s.height<=u||(z=Math.max(s.width,s.height),
t=Math.floor(s.width*u/z),u=Math.floor(s.height*u/z),z=document.createElement("canvas"),z.width=t,z.height=u,z.getContext("2d").drawImage(s,0,0,s.width,s.height,0,0,t,u),s=z),m[n]=s):j[l]=c.image[l];l=j[0];m=0===(l.width&l.width-1)&&0===(l.height&l.height-1);n=H(c.format);s=H(c.type);F(k.TEXTURE_CUBE_MAP,c,m);for(l=0;6>l;l++)if(e){u=j[l].mipmaps;z=0;for(D=u.length;z<D;z++)t=u[z],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,z,n,t.width,t.height,0,t.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+
l,0,n,n,s,j[l]);c.generateMipmaps&&m&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+e),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else n instanceof THREE.WebGLRenderTargetCube?(c=n,k.activeTexture(k.TEXTURE0+j),k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)):S.setTexture(n,j)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(m=c.value.length;l<m;l++)c._array[l]=v();k.uniform1iv(e,c._array);l=0;for(m=
...
h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,!1,f._normalMatrix.elements);null!==h.modelMatrix&&k.uniformMatrix4fv(h.modelMatrix,!1,f.matrixWorld.elements);return g}function v(){var a=ca;a>=sc&&console.warn("Trying to use "+a+" texture units while this GPU supports only "+sc);ca+=1;return a}function s(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function A(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*
d;a[b+2]=c.b*c.b*d}function w(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function z(a,b,c){gb!==a&&(a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL),gb=a);if(a&&(rb!==b||Rb!==c))k.polygonOffset(b,c),rb=b,Rb=c}function I(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function D(a,b){var c;"fragment"===a?c=k.createShader(k.FRAGMENT_SHADER):"vertex"===a&&(c=k.createShader(k.VERTEX_SHADER));k.shaderSource(c,b);k.compileShader(c);return!k.getShaderParameter(c,
...
[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var S=this,ra=[],wa=0,O=null,ga=null,P=-1,X=null,ia=null,$=0,ca=0,Ja=-1,ua=-1,La=-1,Wa=-1,oa=-1,Xa=-1,kb=-1,Ta=-1,gb=null,rb=null,Rb=null,fb=null,bb=0,Ma=0,za=0,yb=0,Ga=0,sb=0,hb=new THREE.Frustum,xa=new THREE.Matrix4,ib=new THREE.Matrix4,ab=new THREE.Vector4,Ya=new THREE.Vector3,Ha=!0,zb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],
positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],angles:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Sb,Ab;try{if(!(k=Q.getContext("experimental-webgl",{alpha:K,premultipliedAlpha:J,antialias:M,stencil:T,preserveDrawingBuffer:Z})))throw"Error creating WebGL context.";}catch(Tc){console.error(Tc)}a=k.getExtension("OES_texture_float");K=k.getExtension("OES_standard_derivatives");Sb=k.getExtension("EXT_texture_filter_anisotropic")||
k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");Ab=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");a||console.log("THREE.WebGLRenderer: Float textures not supported.");K||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");Sb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");Ab||
...
var Uc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),Fc=Sb?k.getParameter(Sb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,jc=0<K,kc=jc&&a;Ab&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};this.supportsVertexTextures=function(){return jc};this.getMaxAnisotropy=function(){return Fc};this.setSize=function(a,b){Q.width=a;Q.height=b;this.setViewport(0,0,Q.width,Q.height)};this.setViewport=function(a,b,c,d){bb=void 0!==a?a:0;Ma=void 0!==b?b:0;za=void 0!==c?c:Q.width;yb=void 0!==d?
d:Q.height;k.viewport(bb,Ma,za,yb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){ea.setHex(a);N=b;k.clearColor(ea.r,ea.g,ea.b,N)};this.setClearColor=function(a,b){ea.copy(a);N=b;k.clearColor(ea.r,ea.g,ea.b,N)};this.getClearColor=function(){return ea};this.getClearAlpha=function(){return N};this.clear=function(a,b,c){var d=0;if(void 0===a||a)d|=k.COLOR_BUFFER_BIT;if(void 0===
...
0;for(e=c.numMorphTargets;d<e;d++)k.deleteBuffer(c.__webglMorphTargetsBuffers[d])}if(c.numMorphNormals){d=0;for(e=c.numMorphNormals;d<e;d++)k.deleteBuffer(c.__webglMorphNormalsBuffers[d])}if(c.__webglCustomAttributesList)for(d in d=void 0,c.__webglCustomAttributesList)k.deleteBuffer(c.__webglCustomAttributesList[d].buffer);S.info.memory.geometries--}else a instanceof THREE.Ribbon?(a=a.geometry,k.deleteBuffer(a.__webglVertexBuffer),k.deleteBuffer(a.__webglColorBuffer),S.info.memory.geometries--):a instanceof
THREE.Line?(a=a.geometry,k.deleteBuffer(a.__webglVertexBuffer),k.deleteBuffer(a.__webglColorBuffer),S.info.memory.geometries--):a instanceof THREE.ParticleSystem&&(a=a.geometry,k.deleteBuffer(a.__webglVertexBuffer),k.deleteBuffer(a.__webglColorBuffer),S.info.memory.geometries--)};this.deallocateTexture=function(a){a.__webglInit&&(a.__webglInit=!1,k.deleteTexture(a.__webglTexture),S.info.memory.textures--)};this.deallocateRenderTarget=function(a){if(a&&a.__webglTexture)if(k.deleteTexture(a.__webglTexture),
...
S.info.render.calls++,S.info.render.vertices+=e.__webglFaceCount,S.info.render.faces+=e.__webglFaceCount/3):f instanceof THREE.Line?(f=f.type===THREE.LineStrip?k.LINE_STRIP:k.LINES,d=d.linewidth,d!==fb&&(k.lineWidth(d),fb=d),k.drawArrays(f,0,e.__webglLineCount),S.info.render.calls++):f instanceof THREE.ParticleSystem?(k.drawArrays(k.POINTS,0,e.__webglParticleCount),S.info.render.calls++,S.info.render.points+=e.__webglParticleCount):f instanceof THREE.Ribbon&&(k.drawArrays(k.TRIANGLE_STRIP,0,e.__webglVertexCount),
S.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,j=a.__lights,o=a.fog;P=-1;Ha=!0;this.autoUpdateScene&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b._viewMatrixArray||(b._viewMatrixArray=new Float32Array(16));b._projectionMatrixArray||(b._projectionMatrixArray=new Float32Array(16));b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);
b.projectionMatrix.flattenToArray(b._projectionMatrixArray);xa.multiply(b.projectionMatrix,b.matrixWorldInverse);hb.setFromMatrix(xa);this.autoUpdateObjects&&this.initWebGLObjects(a);l(this.renderPluginsPre,a,b);S.info.render.calls=0;S.info.render.vertices=0;S.info.render.faces=0;S.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.render=!1,
g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||hb.contains(g))){s(g,b);var p=f,q=p.object,r=p.buffer,t=void 0,t=t=void 0,t=q.material;t instanceof THREE.MeshFaceMaterial?(t=r.materialIndex,0<=t&&(t=q.geometry.materials[t],t.transparent?(p.transparent=t,p.opaque=null):(p.opaque=t,p.transparent=null))):t&&(t.transparent?(p.transparent=t,p.opaque=null):(p.opaque=t,p.transparent=null));f.render=!0;!0===this.sortObjects&&(null!==g.renderDepth?f.z=g.renderDepth:
(ab.copy(g.matrixWorld.getPosition()),xa.multiplyVector3(ab),f.z=ab.z))}this.sortObjects&&h.sort(i);h=a.__webglObjectsImmediate;d=0;for(e=h.length;d<e;d++)f=h[d],g=f.object,g.visible&&(s(g,b),g=f.object.material,g.transparent?(f.transparent=g,f.opaque=null):(f.opaque=g,f.transparent=null));a.overrideMaterial?(d=a.overrideMaterial,this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst),this.setDepthTest(d.depthTest),this.setDepthWrite(d.depthWrite),z(d.polygonOffset,d.polygonOffsetFactor,
...
c.__webglTexture),k.generateMipmap(k.TEXTURE_CUBE_MAP),k.bindTexture(k.TEXTURE_CUBE_MAP,null)):(k.bindTexture(k.TEXTURE_2D,c.__webglTexture),k.generateMipmap(k.TEXTURE_2D),k.bindTexture(k.TEXTURE_2D,null)));this.setDepthTest(!0);this.setDepthWrite(!0)}};this.renderImmediateObject=function(a,b,c,d,e){var f=u(a,b,c,d,e);X=-1;S.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,hb):e.render(function(a){S.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||
(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var i=a.__objectsAdded[0],j=a,l=void 0,m=void 0,n=void 0;if(!i.__webglInit)if(i.__webglInit=!0,i._modelViewMatrix=new THREE.Matrix4,i._normalMatrix=new THREE.Matrix3,i instanceof THREE.Mesh)if(m=i.geometry,m instanceof THREE.Geometry){if(void 0===m.geometryGroups){var s=m,u=void 0,v=void 0,w=void 0,z=void 0,A=void 0,D=void 0,B=void 0,E={},F=s.morphTargets.length,H=s.morphNormals.length;
s.geometryGroups={};u=0;for(v=s.faces.length;u<v;u++)w=s.faces[u],z=w.materialIndex,D=void 0!==z?z:-1,void 0===E[D]&&(E[D]={hash:D,counter:0}),B=E[D].hash+"_"+E[D].counter,void 0===s.geometryGroups[B]&&(s.geometryGroups[B]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:F,numMorphNormals:H}),A=w instanceof THREE.Face3?3:4,65535<s.geometryGroups[B].vertices+A&&(E[D].counter+=1,B=E[D].hash+"_"+E[D].counter,void 0===s.geometryGroups[B]&&(s.geometryGroups[B]={faces3:[],faces4:[],materialIndex:z,
vertices:0,numMorphTargets:F,numMorphNormals:H})),w instanceof THREE.Face3?s.geometryGroups[B].faces3.push(u):s.geometryGroups[B].faces4.push(u),s.geometryGroups[B].vertices+=A;s.geometryGroupsList=[];var I=void 0;for(I in s.geometryGroups)s.geometryGroups[I].id=$++,s.geometryGroupsList.push(s.geometryGroups[I])}for(l in m.geometryGroups)if(n=m.geometryGroups[l],!n.__webglVertexBuffer){var O=n;O.__webglVertexBuffer=k.createBuffer();O.__webglNormalBuffer=k.createBuffer();O.__webglTangentBuffer=k.createBuffer();
...
K;J++)O.__webglMorphNormalsBuffers.push(k.createBuffer())}S.info.memory.geometries++;var P=n,L=i,M=L.geometry,N=P.faces3,Q=P.faces4,X=3*N.length+4*Q.length,ca=1*N.length+2*Q.length,ga=3*N.length+4*Q.length,T=c(L,P),Z=e(T),ea=d(T),fa=T.vertexColors?T.vertexColors:!1;P.__vertexArray=new Float32Array(3*X);ea&&(P.__normalArray=new Float32Array(3*X));M.hasTangents&&(P.__tangentArray=new Float32Array(4*X));fa&&(P.__colorArray=new Float32Array(3*X));if(Z){if(0<M.faceUvs.length||0<M.faceVertexUvs.length)P.__uvArray=
...
wa;ua.array=new Float32Array(X*wa);ua.buffer=k.createBuffer();ua.buffer.belongsToAttribute=Ja;oa.needsUpdate=!0;ua.__original=oa}P.__webglCustomAttributesList.push(ua)}}P.__inittedArrays=!0;m.verticesNeedUpdate=!0;m.morphTargetsNeedUpdate=!0;m.elementsNeedUpdate=!0;m.uvsNeedUpdate=!0;m.normalsNeedUpdate=!0;m.tangentsNeedUpdate=!0;m.colorsNeedUpdate=!0}}else m instanceof THREE.BufferGeometry&&f(m);else if(i instanceof THREE.Ribbon){if(m=i.geometry,!m.__webglVertexBuffer){var La=m;La.__webglVertexBuffer=
k.createBuffer();La.__webglColorBuffer=k.createBuffer();S.info.memory.geometries++;var za=m,Ga=za.vertices.length;za.__vertexArray=new Float32Array(3*Ga);za.__colorArray=new Float32Array(3*Ga);za.__webglVertexCount=Ga;m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}}else if(i instanceof THREE.Line){if(m=i.geometry,!m.__webglVertexBuffer){var Ma=m;Ma.__webglVertexBuffer=k.createBuffer();Ma.__webglColorBuffer=k.createBuffer();S.info.memory.geometries++;var Ha=m,Wa=i,Xa=Ha.vertices.length;Ha.__vertexArray=
new Float32Array(3*Xa);Ha.__colorArray=new Float32Array(3*Xa);Ha.__webglLineCount=Xa;b(Ha,Wa);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}}else if(i instanceof THREE.ParticleSystem&&(m=i.geometry,!m.__webglVertexBuffer))if(m instanceof THREE.Geometry){var Ya=m;Ya.__webglVertexBuffer=k.createBuffer();Ya.__webglColorBuffer=k.createBuffer();S.info.memory.geometries++;var Ta=m,kb=i,bb=Ta.vertices.length;Ta.__vertexArray=new Float32Array(3*bb);Ta.__colorArray=new Float32Array(3*bb);Ta.__sortArray=[];
Ta.__webglParticleCount=bb;b(Ta,kb);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}else m instanceof THREE.BufferGeometry&&f(m);if(!i.__webglActive){if(i instanceof THREE.Mesh)if(m=i.geometry,m instanceof THREE.BufferGeometry)p(j.__webglObjects,m,i);else for(l in m.geometryGroups)n=m.geometryGroups[l],p(j.__webglObjects,n,i);else i instanceof THREE.Ribbon||i instanceof THREE.Line||i instanceof THREE.ParticleSystem?(m=i.geometry,p(j.__webglObjects,m,i)):i instanceof THREE.ImmediateRenderObject||i.immediateRenderCallback?
j.__webglObjectsImmediate.push({object:i,opaque:null,transparent:null}):i instanceof THREE.Sprite?j.__webglSprites.push(i):i instanceof THREE.LensFlare&&j.__webglFlares.push(i);i.__webglActive=!0}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var nb=a.__objectsRemoved[0],ab=a;nb instanceof THREE.Mesh||nb instanceof THREE.ParticleSystem||nb instanceof THREE.Ribbon||nb instanceof THREE.Line?r(ab.__webglObjects,nb):nb instanceof THREE.Sprite?t(ab.__webglSprites,nb):nb instanceof THREE.LensFlare?
t(ab.__webglFlares,nb):(nb instanceof THREE.ImmediateRenderObject||nb.immediateRenderCallback)&&r(ab.__webglObjectsImmediate,nb);nb.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var hb=0,sb=a.__webglObjects.length;hb<sb;hb++){var wb=a.__webglObjects[hb].object,ha=wb.geometry,ib=void 0,gb=void 0,cb=void 0;if(wb instanceof THREE.Mesh)if(ha instanceof THREE.BufferGeometry)(ha.verticesNeedUpdate||ha.elementsNeedUpdate||ha.uvsNeedUpdate||ha.normalsNeedUpdate||ha.colorsNeedUpdate||ha.tangentsNeedUpdate)&&
h(ha,k.DYNAMIC_DRAW,!ha.dynamic),ha.verticesNeedUpdate=!1,ha.elementsNeedUpdate=!1,ha.uvsNeedUpdate=!1,ha.normalsNeedUpdate=!1,ha.colorsNeedUpdate=!1,ha.tangentsNeedUpdate=!1;else{for(var rb=0,yb=ha.geometryGroupsList.length;rb<yb;rb++)if(ib=ha.geometryGroupsList[rb],cb=c(wb,ib),gb=cb.attributes&&o(cb),ha.verticesNeedUpdate||ha.morphTargetsNeedUpdate||ha.elementsNeedUpdate||ha.uvsNeedUpdate||ha.normalsNeedUpdate||ha.colorsNeedUpdate||ha.tangentsNeedUpdate||gb){var na=ib,zb=wb,ob=k.DYNAMIC_DRAW,Ab=
!ha.dynamic,fb=cb;if(na.__inittedArrays){var Sb=d(fb),Rb=fb.vertexColors?fb.vertexColors:!1,jc=e(fb),Hc=Sb===THREE.SmoothShading,C=void 0,Y=void 0,Zb=void 0,R=void 0,mc=void 0,$b=void 0,xb=void 0,Ic=void 0,Tb=void 0,nc=void 0,oc=void 0,U=void 0,V=void 0,W=void 0,ma=void 0,Bb=void 0,Cb=void 0,Db=void 0,tc=void 0,Eb=void 0,Fb=void 0,Gb=void 0,uc=void 0,Hb=void 0,Ib=void 0,Jb=void 0,vc=void 0,Kb=void 0,Lb=void 0,Mb=void 0,wc=void 0,Nb=void 0,Ob=void 0,Pb=void 0,xc=void 0,sa=void 0,kc=void 0,ac=void 0,
pc=void 0,qc=void 0,Pa=void 0,sc=void 0,Na=void 0,Oa=void 0,bc=void 0,Ub=void 0,Fa=0,Ka=0,Vb=0,Wb=0,pb=0,Ua=0,va=0,$a=0,Ia=0,da=0,ja=0,y=0,ta=void 0,Qa=na.__vertexArray,yc=na.__uvArray,zc=na.__uv2Array,qb=na.__normalArray,Aa=na.__tangentArray,Ra=na.__colorArray,Ba=na.__skinIndexArray,Ca=na.__skinWeightArray,Wc=na.__morphTargetsArrays,Xc=na.__morphNormalsArrays,Yc=na.__webglCustomAttributesList,x=void 0,Qb=na.__faceArray,jb=na.__lineArray,db=zb.geometry,Fc=db.elementsNeedUpdate,cd=db.uvsNeedUpdate,
Tc=db.normalsNeedUpdate,Uc=db.tangentsNeedUpdate,jd=db.colorsNeedUpdate,kd=db.morphTargetsNeedUpdate,gc=db.vertices,pa=na.faces3,qa=na.faces4,Va=db.faces,Zc=db.faceVertexUvs[0],$c=db.faceVertexUvs[1],hc=db.skinIndices,cc=db.skinWeights,dc=db.morphTargets,Jc=db.morphNormals;if(db.verticesNeedUpdate){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],U=gc[R.a],V=gc[R.b],W=gc[R.c],Qa[Ka]=U.x,Qa[Ka+1]=U.y,Qa[Ka+2]=U.z,Qa[Ka+3]=V.x,Qa[Ka+4]=V.y,Qa[Ka+5]=V.z,Qa[Ka+6]=W.x,Qa[Ka+7]=W.y,Qa[Ka+8]=W.z,Ka+=9;C=0;for(Y=
qa.length;C<Y;C++)R=Va[qa[C]],U=gc[R.a],V=gc[R.b],W=gc[R.c],ma=gc[R.d],Qa[Ka]=U.x,Qa[Ka+1]=U.y,Qa[Ka+2]=U.z,Qa[Ka+3]=V.x,Qa[Ka+4]=V.y,Qa[Ka+5]=V.z,Qa[Ka+6]=W.x,Qa[Ka+7]=W.y,Qa[Ka+8]=W.z,Qa[Ka+9]=ma.x,Qa[Ka+10]=ma.y,Qa[Ka+11]=ma.z,Ka+=12;k.bindBuffer(k.ARRAY_BUFFER,na.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Qa,ob)}if(kd){Pa=0;for(sc=dc.length;Pa<sc;Pa++){C=ja=0;for(Y=pa.length;C<Y;C++)bc=pa[C],R=Va[bc],U=dc[Pa].vertices[R.a],V=dc[Pa].vertices[R.b],W=dc[Pa].vertices[R.c],Na=Wc[Pa],Na[ja]=U.x,
Na[ja+1]=U.y,Na[ja+2]=U.z,Na[ja+3]=V.x,Na[ja+4]=V.y,Na[ja+5]=V.z,Na[ja+6]=W.x,Na[ja+7]=W.y,Na[ja+8]=W.z,fb.morphNormals&&(Hc?(Ub=Jc[Pa].vertexNormals[bc],Eb=Ub.a,Fb=Ub.b,Gb=Ub.c):Gb=Fb=Eb=Jc[Pa].faceNormals[bc],Oa=Xc[Pa],Oa[ja]=Eb.x,Oa[ja+1]=Eb.y,Oa[ja+2]=Eb.z,Oa[ja+3]=Fb.x,Oa[ja+4]=Fb.y,Oa[ja+5]=Fb.z,Oa[ja+6]=Gb.x,Oa[ja+7]=Gb.y,Oa[ja+8]=Gb.z),ja+=9;C=0;for(Y=qa.length;C<Y;C++)bc=qa[C],R=Va[bc],U=dc[Pa].vertices[R.a],V=dc[Pa].vertices[R.b],W=dc[Pa].vertices[R.c],ma=dc[Pa].vertices[R.d],Na=Wc[Pa],
Na[ja]=U.x,Na[ja+1]=U.y,Na[ja+2]=U.z,Na[ja+3]=V.x,Na[ja+4]=V.y,Na[ja+5]=V.z,Na[ja+6]=W.x,Na[ja+7]=W.y,Na[ja+8]=W.z,Na[ja+9]=ma.x,Na[ja+10]=ma.y,Na[ja+11]=ma.z,fb.morphNormals&&(Hc?(Ub=Jc[Pa].vertexNormals[bc],Eb=Ub.a,Fb=Ub.b,Gb=Ub.c,uc=Ub.d):uc=Gb=Fb=Eb=Jc[Pa].faceNormals[bc],Oa=Xc[Pa],Oa[ja]=Eb.x,Oa[ja+1]=Eb.y,Oa[ja+2]=Eb.z,Oa[ja+3]=Fb.x,Oa[ja+4]=Fb.y,Oa[ja+5]=Fb.z,Oa[ja+6]=Gb.x,Oa[ja+7]=Gb.y,Oa[ja+8]=Gb.z,Oa[ja+9]=uc.x,Oa[ja+10]=uc.y,Oa[ja+11]=uc.z),ja+=12;k.bindBuffer(k.ARRAY_BUFFER,na.__webglMorphTargetsBuffers[Pa]);
k.bufferData(k.ARRAY_BUFFER,Wc[Pa],ob);fb.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,na.__webglMorphNormalsBuffers[Pa]),k.bufferData(k.ARRAY_BUFFER,Xc[Pa],ob))}}if(cc.length){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],Kb=cc[R.a],Lb=cc[R.b],Mb=cc[R.c],Ca[da]=Kb.x,Ca[da+1]=Kb.y,Ca[da+2]=Kb.z,Ca[da+3]=Kb.w,Ca[da+4]=Lb.x,Ca[da+5]=Lb.y,Ca[da+6]=Lb.z,Ca[da+7]=Lb.w,Ca[da+8]=Mb.x,Ca[da+9]=Mb.y,Ca[da+10]=Mb.z,Ca[da+11]=Mb.w,Nb=hc[R.a],Ob=hc[R.b],Pb=hc[R.c],Ba[da]=Nb.x,Ba[da+1]=Nb.y,Ba[da+2]=Nb.z,Ba[da+3]=Nb.w,
Ba[da+4]=Ob.x,Ba[da+5]=Ob.y,Ba[da+6]=Ob.z,Ba[da+7]=Ob.w,Ba[da+8]=Pb.x,Ba[da+9]=Pb.y,Ba[da+10]=Pb.z,Ba[da+11]=Pb.w,da+=12;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],Kb=cc[R.a],Lb=cc[R.b],Mb=cc[R.c],wc=cc[R.d],Ca[da]=Kb.x,Ca[da+1]=Kb.y,Ca[da+2]=Kb.z,Ca[da+3]=Kb.w,Ca[da+4]=Lb.x,Ca[da+5]=Lb.y,Ca[da+6]=Lb.z,Ca[da+7]=Lb.w,Ca[da+8]=Mb.x,Ca[da+9]=Mb.y,Ca[da+10]=Mb.z,Ca[da+11]=Mb.w,Ca[da+12]=wc.x,Ca[da+13]=wc.y,Ca[da+14]=wc.z,Ca[da+15]=wc.w,Nb=hc[R.a],Ob=hc[R.b],Pb=hc[R.c],xc=hc[R.d],Ba[da]=Nb.x,Ba[da+1]=Nb.y,
Ba[da+2]=Nb.z,Ba[da+3]=Nb.w,Ba[da+4]=Ob.x,Ba[da+5]=Ob.y,Ba[da+6]=Ob.z,Ba[da+7]=Ob.w,Ba[da+8]=Pb.x,Ba[da+9]=Pb.y,Ba[da+10]=Pb.z,Ba[da+11]=Pb.w,Ba[da+12]=xc.x,Ba[da+13]=xc.y,Ba[da+14]=xc.z,Ba[da+15]=xc.w,da+=16;0<da&&(k.bindBuffer(k.ARRAY_BUFFER,na.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ba,ob),k.bindBuffer(k.ARRAY_BUFFER,na.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ca,ob))}if(jd&&Rb){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],xb=R.vertexColors,Ic=R.color,3===xb.length&&Rb===
THREE.VertexColors?(Hb=xb[0],Ib=xb[1],Jb=xb[2]):Jb=Ib=Hb=Ic,Ra[Ia]=Hb.r,Ra[Ia+1]=Hb.g,Ra[Ia+2]=Hb.b,Ra[Ia+3]=Ib.r,Ra[Ia+4]=Ib.g,Ra[Ia+5]=Ib.b,Ra[Ia+6]=Jb.r,Ra[Ia+7]=Jb.g,Ra[Ia+8]=Jb.b,Ia+=9;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],xb=R.vertexColors,Ic=R.color,4===xb.length&&Rb===THREE.VertexColors?(Hb=xb[0],Ib=xb[1],Jb=xb[2],vc=xb[3]):vc=Jb=Ib=Hb=Ic,Ra[Ia]=Hb.r,Ra[Ia+1]=Hb.g,Ra[Ia+2]=Hb.b,Ra[Ia+3]=Ib.r,Ra[Ia+4]=Ib.g,Ra[Ia+5]=Ib.b,Ra[Ia+6]=Jb.r,Ra[Ia+7]=Jb.g,Ra[Ia+8]=Jb.b,Ra[Ia+9]=vc.r,Ra[Ia+10]=vc.g,
Ra[Ia+11]=vc.b,Ia+=12;0<Ia&&(k.bindBuffer(k.ARRAY_BUFFER,na.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Ra,ob))}if(Uc&&db.hasTangents){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],Tb=R.vertexTangents,Bb=Tb[0],Cb=Tb[1],Db=Tb[2],Aa[va]=Bb.x,Aa[va+1]=Bb.y,Aa[va+2]=Bb.z,Aa[va+3]=Bb.w,Aa[va+4]=Cb.x,Aa[va+5]=Cb.y,Aa[va+6]=Cb.z,Aa[va+7]=Cb.w,Aa[va+8]=Db.x,Aa[va+9]=Db.y,Aa[va+10]=Db.z,Aa[va+11]=Db.w,va+=12;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],Tb=R.vertexTangents,Bb=Tb[0],Cb=Tb[1],Db=Tb[2],tc=Tb[3],Aa[va]=
Bb.x,Aa[va+1]=Bb.y,Aa[va+2]=Bb.z,Aa[va+3]=Bb.w,Aa[va+4]=Cb.x,Aa[va+5]=Cb.y,Aa[va+6]=Cb.z,Aa[va+7]=Cb.w,Aa[va+8]=Db.x,Aa[va+9]=Db.y,Aa[va+10]=Db.z,Aa[va+11]=Db.w,Aa[va+12]=tc.x,Aa[va+13]=tc.y,Aa[va+14]=tc.z,Aa[va+15]=tc.w,va+=16;k.bindBuffer(k.ARRAY_BUFFER,na.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,ob)}if(Tc&&Sb){C=0;for(Y=pa.length;C<Y;C++)if(R=Va[pa[C]],mc=R.vertexNormals,$b=R.normal,3===mc.length&&Hc)for(sa=0;3>sa;sa++)ac=mc[sa],qb[Ua]=ac.x,qb[Ua+1]=ac.y,qb[Ua+2]=ac.z,Ua+=3;else for(sa=
0;3>sa;sa++)qb[Ua]=$b.x,qb[Ua+1]=$b.y,qb[Ua+2]=$b.z,Ua+=3;C=0;for(Y=qa.length;C<Y;C++)if(R=Va[qa[C]],mc=R.vertexNormals,$b=R.normal,4===mc.length&&Hc)for(sa=0;4>sa;sa++)ac=mc[sa],qb[Ua]=ac.x,qb[Ua+1]=ac.y,qb[Ua+2]=ac.z,Ua+=3;else for(sa=0;4>sa;sa++)qb[Ua]=$b.x,qb[Ua+1]=$b.y,qb[Ua+2]=$b.z,Ua+=3;k.bindBuffer(k.ARRAY_BUFFER,na.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,qb,ob)}if(cd&&Zc&&jc){C=0;for(Y=pa.length;C<Y;C++)if(Zb=pa[C],nc=Zc[Zb],void 0!==nc)for(sa=0;3>sa;sa++)pc=nc[sa],yc[Vb]=pc.u,yc[Vb+
1]=pc.v,Vb+=2;C=0;for(Y=qa.length;C<Y;C++)if(Zb=qa[C],nc=Zc[Zb],void 0!==nc)for(sa=0;4>sa;sa++)pc=nc[sa],yc[Vb]=pc.u,yc[Vb+1]=pc.v,Vb+=2;0<Vb&&(k.bindBuffer(k.ARRAY_BUFFER,na.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,yc,ob))}if(cd&&$c&&jc){C=0;for(Y=pa.length;C<Y;C++)if(Zb=pa[C],oc=$c[Zb],void 0!==oc)for(sa=0;3>sa;sa++)qc=oc[sa],zc[Wb]=qc.u,zc[Wb+1]=qc.v,Wb+=2;C=0;for(Y=qa.length;C<Y;C++)if(Zb=qa[C],oc=$c[Zb],void 0!==oc)for(sa=0;4>sa;sa++)qc=oc[sa],zc[Wb]=qc.u,zc[Wb+1]=qc.v,Wb+=2;0<Wb&&(k.bindBuffer(k.ARRAY_BUFFER,
na.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,zc,ob))}if(Fc){C=0;for(Y=pa.length;C<Y;C++)Qb[pb]=Fa,Qb[pb+1]=Fa+1,Qb[pb+2]=Fa+2,pb+=3,jb[$a]=Fa,jb[$a+1]=Fa+1,jb[$a+2]=Fa,jb[$a+3]=Fa+2,jb[$a+4]=Fa+1,jb[$a+5]=Fa+2,$a+=6,Fa+=3;C=0;for(Y=qa.length;C<Y;C++)Qb[pb]=Fa,Qb[pb+1]=Fa+1,Qb[pb+2]=Fa+3,Qb[pb+3]=Fa+1,Qb[pb+4]=Fa+2,Qb[pb+5]=Fa+3,pb+=6,jb[$a]=Fa,jb[$a+1]=Fa+1,jb[$a+2]=Fa,jb[$a+3]=Fa+3,jb[$a+4]=Fa+1,jb[$a+5]=Fa+2,jb[$a+6]=Fa+2,jb[$a+7]=Fa+3,$a+=8,Fa+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,na.__webglFaceBuffer);
k.bufferData(k.ELEMENT_ARRAY_BUFFER,Qb,ob);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,na.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,jb,ob)}if(Yc){sa=0;for(kc=Yc.length;sa<kc;sa++)if(x=Yc[sa],x.__original.needsUpdate){y=0;if(1===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],x.array[y]=x.value[R.a],x.array[y+1]=x.value[R.b],x.array[y+2]=x.value[R.c],y+=3;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],x.array[y]=x.value[R.a],x.array[y+1]=x.value[R.b],x.array[y+
2]=x.value[R.c],x.array[y+3]=x.value[R.d],y+=4}else{if("faces"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)ta=x.value[pa[C]],x.array[y]=ta,x.array[y+1]=ta,x.array[y+2]=ta,y+=3;C=0;for(Y=qa.length;C<Y;C++)ta=x.value[qa[C]],x.array[y]=ta,x.array[y+1]=ta,x.array[y+2]=ta,x.array[y+3]=ta,y+=4}}else if(2===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],U=x.value[R.a],V=x.value[R.b],W=x.value[R.c],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=V.x,x.array[y+3]=V.y,
x.array[y+4]=W.x,x.array[y+5]=W.y,y+=6;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],U=x.value[R.a],V=x.value[R.b],W=x.value[R.c],ma=x.value[R.d],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=V.x,x.array[y+3]=V.y,x.array[y+4]=W.x,x.array[y+5]=W.y,x.array[y+6]=ma.x,x.array[y+7]=ma.y,y+=8}else{if("faces"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)W=V=U=ta=x.value[pa[C]],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=V.x,x.array[y+3]=V.y,x.array[y+4]=W.x,x.array[y+5]=W.y,y+=6;C=0;for(Y=qa.length;C<Y;C++)ma=W=V=
U=ta=x.value[qa[C]],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=V.x,x.array[y+3]=V.y,x.array[y+4]=W.x,x.array[y+5]=W.y,x.array[y+6]=ma.x,x.array[y+7]=ma.y,y+=8}}else if(3===x.size){var ba;ba="c"===x.type?["r","g","b"]:["x","y","z"];if(void 0===x.boundTo||"vertices"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],U=x.value[R.a],V=x.value[R.b],W=x.value[R.c],x.array[y]=U[ba[0]],x.array[y+1]=U[ba[1]],x.array[y+2]=U[ba[2]],x.array[y+3]=V[ba[0]],x.array[y+4]=V[ba[1]],x.array[y+5]=V[ba[2]],x.array[y+
6]=W[ba[0]],x.array[y+7]=W[ba[1]],x.array[y+8]=W[ba[2]],y+=9;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],U=x.value[R.a],V=x.value[R.b],W=x.value[R.c],ma=x.value[R.d],x.array[y]=U[ba[0]],x.array[y+1]=U[ba[1]],x.array[y+2]=U[ba[2]],x.array[y+3]=V[ba[0]],x.array[y+4]=V[ba[1]],x.array[y+5]=V[ba[2]],x.array[y+6]=W[ba[0]],x.array[y+7]=W[ba[1]],x.array[y+8]=W[ba[2]],x.array[y+9]=ma[ba[0]],x.array[y+10]=ma[ba[1]],x.array[y+11]=ma[ba[2]],y+=12}else if("faces"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)W=V=U=ta=
x.value[pa[C]],x.array[y]=U[ba[0]],x.array[y+1]=U[ba[1]],x.array[y+2]=U[ba[2]],x.array[y+3]=V[ba[0]],x.array[y+4]=V[ba[1]],x.array[y+5]=V[ba[2]],x.array[y+6]=W[ba[0]],x.array[y+7]=W[ba[1]],x.array[y+8]=W[ba[2]],y+=9;C=0;for(Y=qa.length;C<Y;C++)ma=W=V=U=ta=x.value[qa[C]],x.array[y]=U[ba[0]],x.array[y+1]=U[ba[1]],x.array[y+2]=U[ba[2]],x.array[y+3]=V[ba[0]],x.array[y+4]=V[ba[1]],x.array[y+5]=V[ba[2]],x.array[y+6]=W[ba[0]],x.array[y+7]=W[ba[1]],x.array[y+8]=W[ba[2]],x.array[y+9]=ma[ba[0]],x.array[y+10]=
ma[ba[1]],x.array[y+11]=ma[ba[2]],y+=12}else if("faceVertices"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)ta=x.value[pa[C]],U=ta[0],V=ta[1],W=ta[2],x.array[y]=U[ba[0]],x.array[y+1]=U[ba[1]],x.array[y+2]=U[ba[2]],x.array[y+3]=V[ba[0]],x.array[y+4]=V[ba[1]],x.array[y+5]=V[ba[2]],x.array[y+6]=W[ba[0]],x.array[y+7]=W[ba[1]],x.array[y+8]=W[ba[2]],y+=9;C=0;for(Y=qa.length;C<Y;C++)ta=x.value[qa[C]],U=ta[0],V=ta[1],W=ta[2],ma=ta[3],x.array[y]=U[ba[0]],x.array[y+1]=U[ba[1]],x.array[y+2]=U[ba[2]],x.array[y+3]=
V[ba[0]],x.array[y+4]=V[ba[1]],x.array[y+5]=V[ba[2]],x.array[y+6]=W[ba[0]],x.array[y+7]=W[ba[1]],x.array[y+8]=W[ba[2]],x.array[y+9]=ma[ba[0]],x.array[y+10]=ma[ba[1]],x.array[y+11]=ma[ba[2]],y+=12}}else if(4===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],U=x.value[R.a],V=x.value[R.b],W=x.value[R.c],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=U.z,x.array[y+3]=U.w,x.array[y+4]=V.x,x.array[y+5]=V.y,x.array[y+6]=V.z,x.array[y+7]=V.w,x.array[y+8]=W.x,x.array[y+
9]=W.y,x.array[y+10]=W.z,x.array[y+11]=W.w,y+=12;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],U=x.value[R.a],V=x.value[R.b],W=x.value[R.c],ma=x.value[R.d],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=U.z,x.array[y+3]=U.w,x.array[y+4]=V.x,x.array[y+5]=V.y,x.array[y+6]=V.z,x.array[y+7]=V.w,x.array[y+8]=W.x,x.array[y+9]=W.y,x.array[y+10]=W.z,x.array[y+11]=W.w,x.array[y+12]=ma.x,x.array[y+13]=ma.y,x.array[y+14]=ma.z,x.array[y+15]=ma.w,y+=16}else if("faces"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)W=V=U=ta=
x.value[pa[C]],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=U.z,x.array[y+3]=U.w,x.array[y+4]=V.x,x.array[y+5]=V.y,x.array[y+6]=V.z,x.array[y+7]=V.w,x.array[y+8]=W.x,x.array[y+9]=W.y,x.array[y+10]=W.z,x.array[y+11]=W.w,y+=12;C=0;for(Y=qa.length;C<Y;C++)ma=W=V=U=ta=x.value[qa[C]],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=U.z,x.array[y+3]=U.w,x.array[y+4]=V.x,x.array[y+5]=V.y,x.array[y+6]=V.z,x.array[y+7]=V.w,x.array[y+8]=W.x,x.array[y+9]=W.y,x.array[y+10]=W.z,x.array[y+11]=W.w,x.array[y+12]=ma.x,
x.array[y+13]=ma.y,x.array[y+14]=ma.z,x.array[y+15]=ma.w,y+=16}else if("faceVertices"===x.boundTo){C=0;for(Y=pa.length;C<Y;C++)ta=x.value[pa[C]],U=ta[0],V=ta[1],W=ta[2],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=U.z,x.array[y+3]=U.w,x.array[y+4]=V.x,x.array[y+5]=V.y,x.array[y+6]=V.z,x.array[y+7]=V.w,x.array[y+8]=W.x,x.array[y+9]=W.y,x.array[y+10]=W.z,x.array[y+11]=W.w,y+=12;C=0;for(Y=qa.length;C<Y;C++)ta=x.value[qa[C]],U=ta[0],V=ta[1],W=ta[2],ma=ta[3],x.array[y]=U.x,x.array[y+1]=U.y,x.array[y+2]=
U.z,x.array[y+3]=U.w,x.array[y+4]=V.x,x.array[y+5]=V.y,x.array[y+6]=V.z,x.array[y+7]=V.w,x.array[y+8]=W.x,x.array[y+9]=W.y,x.array[y+10]=W.z,x.array[y+11]=W.w,x.array[y+12]=ma.x,x.array[y+13]=ma.y,x.array[y+14]=ma.z,x.array[y+15]=ma.w,y+=16}k.bindBuffer(k.ARRAY_BUFFER,x.buffer);k.bufferData(k.ARRAY_BUFFER,x.array,ob)}}Ab&&(delete na.__inittedArrays,delete na.__colorArray,delete na.__normalArray,delete na.__tangentArray,delete na.__uvArray,delete na.__uv2Array,delete na.__faceArray,delete na.__vertexArray,
delete na.__lineArray,delete na.__skinIndexArray,delete na.__skinWeightArray)}}ha.verticesNeedUpdate=!1;ha.morphTargetsNeedUpdate=!1;ha.elementsNeedUpdate=!1;ha.uvsNeedUpdate=!1;ha.normalsNeedUpdate=!1;ha.colorsNeedUpdate=!1;ha.tangentsNeedUpdate=!1;cb.attributes&&q(cb)}else if(wb instanceof THREE.Ribbon){if(ha.verticesNeedUpdate||ha.colorsNeedUpdate){var ec=ha,dd=k.DYNAMIC_DRAW,Ac=void 0,Bc=void 0,Kc=void 0,fc=void 0,Lc=void 0,ed=ec.vertices,fd=ec.colors,ld=ed.length,md=fd.length,Mc=ec.__vertexArray,
Nc=ec.__colorArray,nd=ec.colorsNeedUpdate;if(ec.verticesNeedUpdate){for(Ac=0;Ac<ld;Ac++)Kc=ed[Ac],fc=3*Ac,Mc[fc]=Kc.x,Mc[fc+1]=Kc.y,Mc[fc+2]=Kc.z;k.bindBuffer(k.ARRAY_BUFFER,ec.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Mc,dd)}if(nd){for(Bc=0;Bc<md;Bc++)Lc=fd[Bc],fc=3*Bc,Nc[fc]=Lc.r,Nc[fc+1]=Lc.g,Nc[fc+2]=Lc.b;k.bindBuffer(k.ARRAY_BUFFER,ec.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Nc,dd)}}ha.verticesNeedUpdate=!1;ha.colorsNeedUpdate=!1}else if(wb instanceof THREE.Line){cb=c(wb,ib);gb=
cb.attributes&&o(cb);if(ha.verticesNeedUpdate||ha.colorsNeedUpdate||gb){var Xb=ha,ad=k.DYNAMIC_DRAW,Cc=void 0,Dc=void 0,Oc=void 0,Da=void 0,Pc=void 0,gd=Xb.vertices,hd=Xb.colors,od=gd.length,pd=hd.length,Qc=Xb.__vertexArray,Rc=Xb.__colorArray,qd=Xb.colorsNeedUpdate,bd=Xb.__webglCustomAttributesList,Sc=void 0,id=void 0,Sa=void 0,rc=void 0,eb=void 0,ya=void 0;if(Xb.verticesNeedUpdate){for(Cc=0;Cc<od;Cc++)Oc=gd[Cc],Da=3*Cc,Qc[Da]=Oc.x,Qc[Da+1]=Oc.y,Qc[Da+2]=Oc.z;k.bindBuffer(k.ARRAY_BUFFER,Xb.__webglVertexBuffer);
k.bufferData(k.ARRAY_BUFFER,Qc,ad)}if(qd){for(Dc=0;Dc<pd;Dc++)Pc=hd[Dc],Da=3*Dc,Rc[Da]=Pc.r,Rc[Da+1]=Pc.g,Rc[Da+2]=Pc.b;k.bindBuffer(k.ARRAY_BUFFER,Xb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Rc,ad)}if(bd){Sc=0;for(id=bd.length;Sc<id;Sc++)if(ya=bd[Sc],ya.needsUpdate&&(void 0===ya.boundTo||"vertices"===ya.boundTo)){Da=0;rc=ya.value.length;if(1===ya.size)for(Sa=0;Sa<rc;Sa++)ya.array[Sa]=ya.value[Sa];else if(2===ya.size)for(Sa=0;Sa<rc;Sa++)eb=ya.value[Sa],ya.array[Da]=eb.x,ya.array[Da+1]=eb.y,
Da+=2;else if(3===ya.size)if("c"===ya.type)for(Sa=0;Sa<rc;Sa++)eb=ya.value[Sa],ya.array[Da]=eb.r,ya.array[Da+1]=eb.g,ya.array[Da+2]=eb.b,Da+=3;else for(Sa=0;Sa<rc;Sa++)eb=ya.value[Sa],ya.array[Da]=eb.x,ya.array[Da+1]=eb.y,ya.array[Da+2]=eb.z,Da+=3;else if(4===ya.size)for(Sa=0;Sa<rc;Sa++)eb=ya.value[Sa],ya.array[Da]=eb.x,ya.array[Da+1]=eb.y,ya.array[Da+2]=eb.z,ya.array[Da+3]=eb.w,Da+=4;k.bindBuffer(k.ARRAY_BUFFER,ya.buffer);k.bufferData(k.ARRAY_BUFFER,ya.array,ad)}}}ha.verticesNeedUpdate=!1;ha.colorsNeedUpdate=
!1;cb.attributes&&q(cb)}else wb instanceof THREE.ParticleSystem&&(ha instanceof THREE.BufferGeometry?((ha.verticesNeedUpdate||ha.colorsNeedUpdate)&&h(ha,k.DYNAMIC_DRAW,!ha.dynamic),ha.verticesNeedUpdate=!1,ha.colorsNeedUpdate=!1):(cb=c(wb,ib),gb=cb.attributes&&o(cb),(ha.verticesNeedUpdate||ha.colorsNeedUpdate||wb.sortParticles||gb)&&g(ha,k.DYNAMIC_DRAW,wb),ha.verticesNeedUpdate=!1,ha.colorsNeedUpdate=!1,cb.attributes&&q(cb)))}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,m,n;a instanceof
THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var o=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,q,r;e=p=q=r=o=
0;for(f=b.length;e<f;e++)g=b[e],g.onlyShadow||(g instanceof THREE.DirectionalLight&&p++,g instanceof THREE.PointLight&&q++,g instanceof THREE.SpotLight&&r++,g instanceof THREE.HemisphereLight&&o++);q+r+p+o<=fa?e=p:(e=Math.ceil(fa*p/(q+p)),r=q=fa-e,o=e);f=q;g=r;h=o;o=p=0;for(r=b.length;o<r;o++)q=b[o],q.castShadow&&(q instanceof THREE.SpotLight&&p++,q instanceof THREE.DirectionalLight&&!q.shadowCascade&&p++);m=p;kc&&d&&d.useVertexTexture?l=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),b=Math.floor((b-
...
w);for(w=0;w<c.maxMorphNormals;w++)t.push("morphNormal"+w);for(s in b)t.push(s);s=t;w=0;for(t=s.length;w<t;w++)u=s[w],v.attributes[u]=k.getAttribLocation(v,u);v.id=wa++;ra.push({program:v,code:n,usedTimes:1});S.info.memory.programs=ra.length;s=v}a.program=s;s=a.program.attributes;0<=s.position&&k.enableVertexAttribArray(s.position);0<=s.color&&k.enableVertexAttribArray(s.color);0<=s.normal&&k.enableVertexAttribArray(s.normal);0<=s.tangent&&k.enableVertexAttribArray(s.tangent);a.skinning&&(0<=s.skinIndex&&
...
a.numSupportedMorphNormals++)}a.uniformsList=[];for(i in a.uniforms)a.uniformsList.push([a.uniforms[i],i])};this.setFaceCulling=function(a,b){a?(!b||"ccw"===b?k.frontFace(k.CCW):k.frontFace(k.CW),"back"===a?k.cullFace(k.BACK):"front"===a?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK),k.enable(k.CULL_FACE)):k.disable(k.CULL_FACE)};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,a=a.side===THREE.BackSide;Ja!==b&&(b?k.disable(k.CULL_FACE):k.enable(k.CULL_FACE),Ja=b);ua!==a&&(a?k.frontFace(k.CW):
k.frontFace(k.CCW),ua=a)};this.setDepthTest=function(a){kb!==a&&(a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST),kb=a)};this.setDepthWrite=function(a){Ta!==a&&(k.depthMask(a),Ta=a)};this.setBlending=function(a,b,c,d){a!==La&&(a===THREE.NoBlending?k.disable(k.BLEND):a===THREE.AdditiveBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.SRC_ALPHA,k.ONE)):a===THREE.SubtractiveBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?
(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.SRC_COLOR)):a===THREE.CustomBlending?k.enable(k.BLEND):(k.enable(k.BLEND),k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD),k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)),La=a);if(a===THREE.CustomBlending){if(b!==Wa&&(k.blendEquation(H(b)),Wa=b),c!==oa||d!==Xa)k.blendFunc(H(c),H(d)),oa=c,Xa=d}else Xa=oa=Wa=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.__webglTexture=
k.createTexture(),S.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=H(a.format),f=H(a.type);F(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var f=a.mipmaps,g=0,h=f.length;g<h;g++)c=f[g],k.compressedTexImage2D(k.TEXTURE_2D,g,e,c.width,c.height,0,c.data);
...
!0);a.__webglTexture=k.createTexture();var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=H(a.format),e=H(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);F(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+f;k.bindFramebuffer(k.FRAMEBUFFER,
a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);B(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=k.createFramebuffer(),a.__webglRenderbuffer=k.createRenderbuffer(),k.bindTexture(k.TEXTURE_2D,a.__webglTexture),F(k.TEXTURE_2D,a,c),k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=k.TEXTURE_2D,k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,
d,a.__webglTexture,0),B(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=za,a=yb,d=bb,e=Ma);b!==ga&&(k.bindFramebuffer(k.FRAMEBUFFER,b),k.viewport(d,e,c,a),ga=b);Ga=c;sb=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);
...
r,t,u=g.vertexNormals,v=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+e,g.b+e,g.c+e):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+e,g.b+e,g.c+e,g.d+e));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(q=u.length;h<q;h++)t=u[h].clone(),d&&d.multiplyVector3(t),r.vertexNormals.push(t);r.color.copy(g.color);h=0;for(q=v.length;h<q;h++)t=v[h],r.vertexColors.push(t.clone());void 0!==g.materialIndex&&(h=f.materials[g.materialIndex],q=h.id,v=m[q],void 0===v&&(v=a.materials.length,
m[q]=v,a.materials.push(h)),r.materialIndex=v);r.centroid.copy(g.centroid);c&&c.multiplyVector3(r.centroid);i.push(r)}p=0;for(o=n.length;p<o;p++){c=n[p];d=[];h=0;for(q=c.length;h<q;h++)d.push(new THREE.UV(c[h].u,c[h].v));l.push(d)}},clone:function(a){var b=new THREE.Geometry,c,d=a.vertices,e=a.faces,f=a.faceVertexUvs[0];a.materials&&(b.materials=a.materials.slice());a=0;for(c=d.length;a<c;a++)b.vertices.push(d[a].clone());a=0;for(c=e.length;a<c;a++)b.faces.push(e[a].clone());a=0;for(c=f.length;a<
...
b.push(g.clone()),b.push(h.clone()),b.push(i.clone()),f.a=e,f.b=e+1,f.c=e+2}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,e,f,g,h,i,j,l,n,m,p,o,q,r,t,u,v,s,A=[],w=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)w[c]=[];c=0;for(d=a.faces.length;c<d;c++)if(e=a.faces[c],e instanceof THREE.Face3)if(f=e.a,g=e.b,h=e.c,j=a.vertices[f],l=a.vertices[g],n=a.vertices[h],p=j.distanceTo(l),o=l.distanceTo(n),m=j.distanceTo(n),p>b||o>b||m>b){i=a.vertices.length;v=e.clone();s=e.clone();p>=o&&
p>=m?(j=j.clone(),j.lerpSelf(l,0.5),v.a=f,v.b=i,v.c=h,s.a=i,s.b=g,s.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),v.vertexNormals[1].copy(f),s.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),v.vertexColors[1].copy(f),s.vertexColors[0].copy(f)),e=0):o>=p&&o>=m?(j=l.clone(),j.lerpSelf(n,0.5),v.a=f,v.b=g,v.c=i,s.a=i,s.b=h,s.c=f,3===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),
f.lerpSelf(e.vertexNormals[2],0.5),v.vertexNormals[2].copy(f),s.vertexNormals[0].copy(f),s.vertexNormals[1].copy(e.vertexNormals[2]),s.vertexNormals[2].copy(e.vertexNormals[0])),3===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),v.vertexColors[2].copy(f),s.vertexColors[0].copy(f),s.vertexColors[1].copy(e.vertexColors[2]),s.vertexColors[2].copy(e.vertexColors[0])),e=1):(j=j.clone(),j.lerpSelf(n,0.5),v.a=f,v.b=g,v.c=i,s.a=i,s.b=g,s.c=h,3===e.vertexNormals.length&&
(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[2],0.5),v.vertexNormals[2].copy(f),s.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[2],0.5),v.vertexColors[2].copy(f),s.vertexColors[0].copy(f)),e=2);A.push(v,s);a.vertices.push(j);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],s=j[0],h=j[1],v=j[2],0===e?(l=s.clone(),l.lerpSelf(h,0.5),j=[s.clone(),l.clone(),v.clone()],h=[l.clone(),h.clone(),
v.clone()]):1===e?(l=h.clone(),l.lerpSelf(v,0.5),j=[s.clone(),h.clone(),l.clone()],h=[l.clone(),v.clone(),s.clone()]):(l=s.clone(),l.lerpSelf(v,0.5),j=[s.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),v.clone()]),w[f].push(j,h))}else{A.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)w[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,j=a.vertices[f],l=a.vertices[g],n=a.vertices[h],m=a.vertices[i],p=j.distanceTo(l),o=l.distanceTo(n),q=n.distanceTo(m),r=j.distanceTo(m),p>b||o>b||
q>b||r>b){t=a.vertices.length;u=a.vertices.length+1;v=e.clone();s=e.clone();p>=o&&p>=q&&p>=r||q>=o&&q>=p&&q>=r?(p=j.clone(),p.lerpSelf(l,0.5),l=n.clone(),l.lerpSelf(m,0.5),v.a=f,v.b=t,v.c=u,v.d=i,s.a=t,s.b=g,s.c=h,s.d=u,4===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[1],0.5),g=e.vertexNormals[2].clone(),g.lerpSelf(e.vertexNormals[3],0.5),v.vertexNormals[1].copy(f),v.vertexNormals[2].copy(g),s.vertexNormals[0].copy(f),s.vertexNormals[3].copy(g)),4===e.vertexColors.length&&
(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[1],0.5),g=e.vertexColors[2].clone(),g.lerpSelf(e.vertexColors[3],0.5),v.vertexColors[1].copy(f),v.vertexColors[2].copy(g),s.vertexColors[0].copy(f),s.vertexColors[3].copy(g)),e=0):(p=l.clone(),p.lerpSelf(n,0.5),l=m.clone(),l.lerpSelf(j,0.5),v.a=f,v.b=g,v.c=t,v.d=u,s.a=u,s.b=t,s.c=h,s.d=i,4===e.vertexNormals.length&&(f=e.vertexNormals[1].clone(),f.lerpSelf(e.vertexNormals[2],0.5),g=e.vertexNormals[3].clone(),g.lerpSelf(e.vertexNormals[0],0.5),
v.vertexNormals[2].copy(f),v.vertexNormals[3].copy(g),s.vertexNormals[0].copy(g),s.vertexNormals[1].copy(f)),4===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),g=e.vertexColors[3].clone(),g.lerpSelf(e.vertexColors[0],0.5),v.vertexColors[2].copy(f),v.vertexColors[3].copy(g),s.vertexColors[0].copy(g),s.vertexColors[1].copy(f)),e=1);A.push(v,s);a.vertices.push(p,l);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],s=j[0],
h=j[1],v=j[2],j=j[3],0===e?(l=s.clone(),l.lerpSelf(h,0.5),n=v.clone(),n.lerpSelf(j,0.5),s=[s.clone(),l.clone(),n.clone(),j.clone()],h=[l.clone(),h.clone(),v.clone(),n.clone()]):(l=h.clone(),l.lerpSelf(v,0.5),n=j.clone(),n.lerpSelf(s,0.5),s=[s.clone(),h.clone(),l.clone(),n.clone()],h=[n.clone(),l.clone(),v.clone(),j.clone()]),w[f].push(s,h))}else{A.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)w[f].push(a.faceVertexUvs[f][c])}a.faces=A;a.faceVertexUvs=w}};THREE.GeometryUtils.random=THREE.Math.random16;
...
0>n-1?0:n-1,p=n+1>e-1?e-1:n+1,o=0>l-1?0:l-1,q=l+1>d-1?d-1:l+1,r=[],t=[0,0,h[4*(n*d+l)]/255*b];r.push([-1,0,h[4*(n*d+o)]/255*b]);r.push([-1,-1,h[4*(m*d+o)]/255*b]);r.push([0,-1,h[4*(m*d+l)]/255*b]);r.push([1,-1,h[4*(m*d+q)]/255*b]);r.push([1,0,h[4*(n*d+q)]/255*b]);r.push([1,1,h[4*(p*d+q)]/255*b]);r.push([0,1,h[4*(p*d+l)]/255*b]);r.push([-1,1,h[4*(p*d+o)]/255*b]);m=[];o=r.length;for(p=0;p<o;p++){var q=r[p],u=r[(p+1)%o],q=[q[0]-t[0],q[1]-t[1],q[2]-t[2]],u=[u[0]-t[0],u[1]-t[1],u[2]-t[2]];m.push(c([q[1]*
u[2]-q[2]*u[1],q[2]*u[0]-q[0]*u[2],q[0]*u[1]-q[1]*u[0]]))}r=[0,0,0];for(p=0;p<m.length;p++)r[0]+=m[p][0],r[1]+=m[p][1],r[2]+=m[p][2];r[0]/=m.length;r[1]/=m.length;r[2]/=m.length;t=4*(n*d+l);j[t]=255*((r[0]+1)/2)|0;j[t+1]=255*((r[1]+1)/2)|0;j[t+2]=255*r[2]|0;j[t+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+1]=g,e[3*h+2]=c;a=new THREE.DataTexture(e,
...
0,e=String(a).split(""),f=e.length,g=[],a=0;a<f;a++){var h=new THREE.Path,h=this.extractGlyphPoints(e[a],b,c,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(a,b,c,d,e){var f=[],g,h,i,j,l,n,m,p,o,q,r,t=b.glyphs[a]||b.glyphs["?"];if(t){if(t.o){b=t._cachedOutline||(t._cachedOutline=t.o.split(" "));j=b.length;for(a=0;a<j;){i=b[a++];switch(i){case "m":i=b[a++]*c+d;l=b[a++]*c;e.moveTo(i,l);break;case "l":i=b[a++]*c+d;l=b[a++]*c;e.lineTo(i,l);break;case "q":i=b[a++]*
c+d;l=b[a++]*c;p=b[a++]*c+d;o=b[a++]*c;e.quadraticCurveTo(p,o,i,l);if(g=f[f.length-1]){n=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++){var u=g/h;THREE.Shape.Utils.b2(u,n,p,i);THREE.Shape.Utils.b2(u,m,o,l)}}break;case "b":i=b[a++]*c+d;l=b[a++]*c;p=b[a++]*c+d;o=b[a++]*-c;q=b[a++]*c+d;r=b[a++]*-c;e.bezierCurveTo(i,l,p,o,q,r);if(g=f[f.length-1]){n=g.x;m=g.y;g=1;for(h=this.divisions;g<=h;g++){u=g/h;THREE.Shape.Utils.b3(u,n,p,q,i);THREE.Shape.Utils.b3(u,m,o,r,l)}}}}}return{offset:t.ha*c,path:e}}}};
...
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e=e+(a[f].x*a[g].y-a[g].x*a[f].y);return e*0.5};a.Triangulate=function(a,d){var e=a.length;if(e<3)return null;var f=[],g=[],h=[],i,j,l;if(b(a)>0)for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var n=2*e;for(j=e-1;e>2;){if(n--<=0){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);l=j+1;e<=l&&(l=0);var m;a:{m=a;var p=i,o=j,q=l,r=e,t=g,u=void 0,v=void 0,s=void 0,A=void 0,w=void 0,
z=void 0,I=void 0,D=void 0,F=void 0,v=m[t[p]].x,s=m[t[p]].y,A=m[t[o]].x,w=m[t[o]].y,z=m[t[q]].x,I=m[t[q]].y;if(1E-10>(A-v)*(I-s)-(w-s)*(z-v))m=false;else{for(u=0;u<r;u++)if(!(u==p||u==o||u==q)){var D=m[t[u]].x,F=m[t[u]].y,B=void 0,E=void 0,H=void 0,Q=void 0,L=void 0,K=void 0,J=void 0,M=void 0,T=void 0,Z=void 0,ea=void 0,N=void 0,B=H=L=void 0,B=z-A,E=I-w,H=v-z,Q=s-I,L=A-v,K=w-s,J=D-v,M=F-s,T=D-A,Z=F-w,ea=D-z,N=F-I,B=B*Z-E*T,L=L*M-K*J,H=H*N-Q*ea;if(B>=0&&H>=0&&L>=0){m=false;break a}}m=true}}if(m){f.push([a[g[i]],
...
THREE.CubeGeometry=function(a,b,c,d,e,f,g,h){function i(a,b,c,g,h,i,l,m){var n,o=d||1,p=e||1,q=h/2,r=i/2,t=j.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=f||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=f||1}var u=o+1,v=p+1,Z=h/o,ea=i/p,N=new THREE.Vector3;N[n]=l>0?1:-1;for(h=0;h<v;h++)for(i=0;i<u;i++){var fa=new THREE.Vector3;fa[a]=(i*Z-q)*c;fa[b]=(h*ea-r)*g;fa[n]=l;j.vertices.push(fa)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
u*h+t,i+u*(h+1)+t,i+1+u*(h+1)+t,i+1+u*h+t);a.normal.copy(N);a.vertexNormals.push(N.clone(),N.clone(),N.clone(),N.clone());a.materialIndex=m;j.faces.push(a);j.faceVertexUvs[0].push([new THREE.UV(i/o,1-h/p),new THREE.UV(i/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-h/p)])}}THREE.Geometry.call(this);var j=this,l=a/2,n=b/2,m=c/2,p,o,q,r,t,u;if(g!==void 0){if(g instanceof Array)this.materials=g;else{this.materials=[];for(p=0;p<6;p++)this.materials.push(g)}p=0;r=1;o=2;t=3;q=4;u=
5}else this.materials=[];this.sides={px:true,nx:true,py:true,ny:true,pz:true,nz:true};if(h!=void 0)for(var v in h)this.sides[v]!==void 0&&(this.sides[v]=h[v]);this.sides.px&&i("z","y",-1,-1,c,b,l,p);this.sides.nx&&i("z","y",1,-1,c,b,-l,r);this.sides.py&&i("x","z",1,1,a,c,n,o);this.sides.ny&&i("x","z",1,-1,a,c,-n,t);this.sides.pz&&i("x","y",1,-1,a,b,m,q);this.sides.nz&&i("x","y",-1,-1,a,b,-m,u);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
this.vertices[j[0][h+1]].clone()}else{n=this.vertices[j[1][h]].clone();m=this.vertices[j[1][h+1]].clone()}n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<e;i++){var p=j[i][h],o=j[i+1][h],q=j[i+1][h+1],r=j[i][h+1],t=n.clone(),u=n.clone(),v=m.clone(),s=m.clone(),A=l[i][h].clone(),w=l[i+1][h].clone(),z=l[i+1][h+1].clone(),I=l[i][h+1].clone();this.faces.push(new THREE.Face4(p,o,q,r,[t,u,v,s]));this.faceVertexUvs[0].push([A,w,z,I])}}if(!f&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){p=j[0][h];o=j[0][h+1];q=this.vertices.length-1;t=new THREE.Vector3(0,1,0);u=new THREE.Vector3(0,1,0);v=new THREE.Vector3(0,1,0);A=l[0][h].clone();w=l[0][h+1].clone();z=new THREE.UV(w.u,0);this.faces.push(new THREE.Face3(p,o,q,[t,u,v]));this.faceVertexUvs[0].push([A,w,z])}}if(!f&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){p=j[i][h+1];o=j[i][h];q=this.vertices.length-1;t=new THREE.Vector3(0,-1,0);u=new THREE.Vector3(0,
-1,0);v=new THREE.Vector3(0,-1,0);A=l[i][h+1].clone();w=l[i][h].clone();z=new THREE.UV(w.u,1);this.faces.push(new THREE.Face3(p,o,q,[t,u,v]));this.faceVertexUvs[0].push([A,w,z])}}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
c.length-1);for(var g=0,h=m+l*2,g=0;g<h;g++){var i=T*g,j=T*(g+1),n=d+e+i,i=d+f+i,o=d+f+j,j=d+e+j,p=c,q=g,r=h,s=e,v=f,n=n+B,i=i+B,o=o+B,j=j+B;F.faces.push(new THREE.Face4(n,i,o,j,null,null,t));n=u.generateSideWallUV(F,a,p,b,n,i,o,j,q,r,s,v);F.faceVertexUvs[0].push(n)}}}function f(a,b,c){F.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+B;d=d+B;e=e+B;F.faces.push(new THREE.Face3(c,d,e,null,null,r));c=f?u.generateBottomUV(F,a,b,c,d,e):u.generateTopUV(F,a,b,c,d,e);F.faceVertexUvs[0].push(c)}
var h=b.amount!==void 0?b.amount:100,i=b.bevelThickness!==void 0?b.bevelThickness:6,j=b.bevelSize!==void 0?b.bevelSize:i-2,l=b.bevelSegments!==void 0?b.bevelSegments:3,n=b.bevelEnabled!==void 0?b.bevelEnabled:true,m=b.steps!==void 0?b.steps:1,p=b.extrudePath,o,q=false,r=b.material,t=b.extrudeMaterial,u=b.UVGenerator!==void 0?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,v,s,A,w;if(p){o=p.getSpacedPoints(m);q=true;n=false;v=b.frames!==void 0?b.frames:new THREE.TubeGeometry.FrenetFrames(p,m,
false);s=new THREE.Vector3;A=new THREE.Vector3;w=new THREE.Vector3}if(!n)j=i=l=0;var z,I,D,F=this,B=this.vertices.length,p=a.extractPoints(),E=p.shape,p=p.holes,H=!THREE.Shape.Utils.isClockWise(E);if(H){E=E.reverse();I=0;for(D=p.length;I<D;I++){z=p[I];THREE.Shape.Utils.isClockWise(z)&&(p[I]=z.reverse())}H=false}var Q=THREE.Shape.Utils.triangulateShape(E,p),H=E;I=0;for(D=p.length;I<D;I++){z=p[I];E=E.concat(z)}var L,K,J,M,T=E.length,Z=Q.length,ea=[],N=0,fa=H.length;L=fa-1;for(K=N+1;N<fa;N++,L++,K++){L===
fa&&(L=0);K===fa&&(K=0);ea[N]=d(H[N],H[L],H[K])}var S=[],ra,wa=ea.concat();I=0;for(D=p.length;I<D;I++){z=p[I];ra=[];N=0;fa=z.length;L=fa-1;for(K=N+1;N<fa;N++,L++,K++){L===fa&&(L=0);K===fa&&(K=0);ra[N]=d(z[N],z[L],z[K])}S.push(ra);wa=wa.concat(ra)}for(L=0;L<l;L++){z=L/l;J=i*(1-z);K=j*Math.sin(z*Math.PI/2);N=0;for(fa=H.length;N<fa;N++){M=c(H[N],ea[N],K);f(M.x,M.y,-J)}I=0;for(D=p.length;I<D;I++){z=p[I];ra=S[I];N=0;for(fa=z.length;N<fa;N++){M=c(z[N],ra[N],K);f(M.x,M.y,-J)}}}K=j;for(N=0;N<T;N++){M=n?c(E[N],
wa[N],K):E[N];if(q){A.copy(v.normals[0]).multiplyScalar(M.x);s.copy(v.binormals[0]).multiplyScalar(M.y);w.copy(o[0]).addSelf(A).addSelf(s);f(w.x,w.y,w.z)}else f(M.x,M.y,0)}for(z=1;z<=m;z++)for(N=0;N<T;N++){M=n?c(E[N],wa[N],K):E[N];if(q){A.copy(v.normals[z]).multiplyScalar(M.x);s.copy(v.binormals[z]).multiplyScalar(M.y);w.copy(o[z]).addSelf(A).addSelf(s);f(w.x,w.y,w.z)}else f(M.x,M.y,h/m*z)}for(L=l-1;L>=0;L--){z=L/l;J=i*(1-z);K=j*Math.sin(z*Math.PI/2);N=0;for(fa=H.length;N<fa;N++){M=c(H[N],ea[N],K);
f(M.x,M.y,h+J)}I=0;for(D=p.length;I<D;I++){z=p[I];ra=S[I];N=0;for(fa=z.length;N<fa;N++){M=c(z[N],ra[N],K);q?f(M.x,M.y+o[m-1].y,o[m-1].x+J):f(M.x,M.y,h+J)}}}if(n){i=T*0;for(N=0;N<Z;N++){h=Q[N];g(h[2]+i,h[1]+i,h[0]+i,true)}i=T*(m+l*2);for(N=0;N<Z;N++){h=Q[N];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(N=0;N<Z;N++){h=Q[N];g(h[2],h[1],h[0],true)}for(N=0;N<Z;N++){h=Q[N];g(h[0]+T*m,h[1]+T*m,h[2]+T*m,false)}}h=0;e(H,h);h=h+H.length;I=0;for(D=p.length;I<D;I++){z=p[I];e(z,h);h=h+z.length}};
...
THREE.SphereGeometry=function(a,b,c,d,e,f,g){THREE.Geometry.call(this);var a=a||50,d=d!==void 0?d:0,e=e!==void 0?e:Math.PI*2,f=f!==void 0?f:0,g=g!==void 0?g:Math.PI,b=Math.max(3,Math.floor(b)||8),c=Math.max(2,Math.floor(c)||6),h,i,j=[],l=[];for(i=0;i<=c;i++){var n=[],m=[];for(h=0;h<=b;h++){var p=h/b,o=i/c,q=new THREE.Vector3;q.x=-a*Math.cos(d+p*e)*Math.sin(f+o*g);q.y=a*Math.cos(f+o*g);q.z=a*Math.sin(d+p*e)*Math.sin(f+o*g);this.vertices.push(q);n.push(this.vertices.length-1);m.push(new THREE.UV(p,
1-o))}j.push(n);l.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=j[i][h+1],e=j[i][h],f=j[i+1][h],g=j[i+1][h+1],n=this.vertices[d].clone().normalize(),m=this.vertices[e].clone().normalize(),p=this.vertices[f].clone().normalize(),o=this.vertices[g].clone().normalize(),q=l[i][h+1].clone(),r=l[i][h].clone(),t=l[i+1][h].clone(),u=l[i+1][h+1].clone();if(Math.abs(this.vertices[d].y)==a){this.faces.push(new THREE.Face3(d,f,g,[n,p,o]));this.faceVertexUvs[0].push([q,t,u])}else if(Math.abs(this.vertices[f].y)==
a){this.faces.push(new THREE.Face3(d,e,f,[n,m,p]));this.faceVertexUvs[0].push([q,r,t])}else{this.faces.push(new THREE.Face4(d,e,f,g,[n,m,p,o]));this.faceVertexUvs[0].push([q,r,t,u])}}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:a}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.TubeGeometry=function(a,b,c,d,e,f){THREE.Geometry.call(this);this.path=a;this.segments=b||64;this.radius=c||1;this.segmentsRadius=d||8;this.closed=e||false;if(f)this.debug=new THREE.Object3D;this.grid=[];var g,h,f=this.segments+1,i,j,l,n=new THREE.Vector3,m,p,o,b=new THREE.TubeGeometry.FrenetFrames(a,b,e);m=b.tangents;p=b.normals;o=b.binormals;this.tangents=m;this.normals=p;this.binormals=o;for(b=0;b<f;b++){this.grid[b]=[];d=b/(f-1);l=a.getPointAt(d);d=m[b];g=p[b];h=o[b];if(this.debug){this.debug.add(new THREE.ArrowHelper(d,
...
a=this.grid[b][d];c=this.grid[f][d];f=this.grid[f][n];n=this.grid[b][n];m=new THREE.UV(b/this.segments,d/this.segmentsRadius);p=new THREE.UV((b+1)/this.segments,d/this.segmentsRadius);o=new THREE.UV((b+1)/this.segments,(d+1)/this.segmentsRadius);g=new THREE.UV(b/this.segments,(d+1)/this.segmentsRadius);this.faces.push(new THREE.Face4(a,c,f,n));this.faceVertexUvs[0].push([m,p,o,g])}this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.TubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
var G={computeEdgeFaces:function(a){function b(a,b){g[a]===void 0&&(g[a]=[]);g[a].push(b)}var c,d,e,f,g={};c=0;for(d=a.faces.length;c<d;c++){e=a.faces[c];if(e instanceof THREE.Face3){f=orderedKey(e.a,e.b);b(f,c);f=orderedKey(e.b,e.c);b(f,c);f=orderedKey(e.c,e.a);b(f,c)}else if(e instanceof THREE.Face4){f=orderedKey(e.a,e.b);b(f,c);f=orderedKey(e.b,e.c);b(f,c);f=orderedKey(e.c,e.d);b(f,c);f=orderedKey(e.d,e.a);b(f,c)}}return g}};
...
1];o.r=o.r+p.r;o.g=o.g+p.g;o.b=o.b+p.b}o.r=o.r/q.length;o.g=o.g/q.length;o.b=o.b/q.length;n.vertexColors[r]=o}}i.push(n);if(l.supportUVs){g=[f(a,""),f(b,m),f(d,m),f(e,m)];g[0]?g[1]?g[2]?g[3]?j.push(g):c("d :( ",e+":"+m):c("c :( ",d+":"+m):c("b :( ",b+":"+m):c("a :( ",a+":"+m)}}function f(a,b){var e=a+":"+b,f=t[e];if(!f){a>=p&&a<p+m.length?c("face pt"):c("edge pt");d("warning, UV not found for",e);return null}return f}function g(a,b,c){var e=a+":"+b;e in t?d("dup vertexNo",a,"oldFaceNo",b,"value",
c,"key",e,t[e]):t[e]=c}var h=[],i=[],j=[],l=this,n=a.vertices,m=a.faces,p=n.length,h=n.concat(),o=[],q={},r={},t={},u,v,s,A,w,z=a.faceVertexUvs[0],I;c("originalFaces, uvs, originalVerticesLength",m.length,z.length,p);if(l.supportUVs){u=0;for(v=z.length;u<v;u++){s=0;for(A=z[u].length;s<A;s++){I=m[u]["abcd".charAt(s)];g(I,u,z[u][s])}}}if(z.length==0)l.supportUVs=false;u=0;for(var D in t)u++;if(!u){l.supportUVs=false;c("no uvs")}u=0;for(v=m.length;u<v;u++){w=m[u];o.push(w.centroid);h.push(w.centroid);
if(l.supportUVs){A=new THREE.UV;if(w instanceof THREE.Face3){A.u=f(w.a,u).u+f(w.b,u).u+f(w.c,u).u;A.v=f(w.a,u).v+f(w.b,u).v+f(w.c,u).v;A.u=A.u/3;A.v=A.v/3}else if(w instanceof THREE.Face4){A.u=f(w.a,u).u+f(w.b,u).u+f(w.c,u).u+f(w.d,u).u;A.v=f(w.a,u).v+f(w.b,u).v+f(w.c,u).v+f(w.d,u).v;A.u=A.u/4;A.v=A.v/4}g(p+u,"",A)}}D=G.computeEdgeFaces(a);var F,B;v=0;var E,H,z={};I={};for(u in D){F=D[u];E=u.split("_");H=E[0];E=E[1];s=H;w=[H,E];z[s]===void 0&&(z[s]=[]);z[s].push(w);s=E;w=[H,E];z[s]===void 0&&(z[s]=
[]);z[s].push(w);s=0;for(A=F.length;s<A;s++){w=F[s];B=H;var Q=w,L=u;I[B]===void 0&&(I[B]={});I[B][Q]=L;B=E;Q=u;I[B]===void 0&&(I[B]={});I[B][w]=Q}F.length<2&&(r[u]=true)}for(u in D){F=D[u];w=F[0];B=F[1];E=u.split("_");H=E[0];E=E[1];A=new THREE.Vector3;b(F.length>0,"an edge without faces?!");if(F.length==1){A.addSelf(n[H]);A.addSelf(n[E]);A.multiplyScalar(0.5)}else{A.addSelf(o[w]);A.addSelf(o[B]);A.addSelf(n[H]);A.addSelf(n[E]);A.multiplyScalar(0.25)}q[u]=p+m.length+v;h.push(A);v++;if(l.supportUVs){A=
new THREE.UV;A.u=f(H,w).u+f(E,w).u;A.v=f(H,w).v+f(E,w).v;A.u=A.u/2;A.v=A.v/2;g(q[u],w,A);if(F.length>=2){b(F.length==2,"did we plan for more than 2 edges?");A=new THREE.UV;A.u=f(H,B).u+f(E,B).u;A.v=f(H,B).v+f(E,B).v;A.u=A.u/2;A.v=A.v/2;g(q[u],B,A)}}}c("-- Step 2 done");console.log("facePoints",o,"edgePoints",q);console.log("edgeFaceMap",D,"vertexEdgeMap",z);var K,J;A=["123","12","2","23"];B=["123","23","3","31"];var Q=["123","31","1","12"],L=["1234","12","2","23"],M=["1234","23","3","34"],T=["1234",
"34","4","41"],Z=["1234","41","1","12"];u=0;for(v=o.length;u<v;u++){w=m[u];F=p+u;if(w instanceof THREE.Face3){H=orderedKey(w.a,w.b);E=orderedKey(w.b,w.c);K=orderedKey(w.c,w.a);e(F,q[H],w.b,q[E],w,A,u);e(F,q[E],w.c,q[K],w,B,u);e(F,q[K],w.a,q[H],w,Q,u)}else if(w instanceof THREE.Face4){H=orderedKey(w.a,w.b);E=orderedKey(w.b,w.c);K=orderedKey(w.c,w.d);J=orderedKey(w.d,w.a);e(F,q[H],w.b,q[E],w,L,u);e(F,q[E],w.c,q[K],w,M,u);e(F,q[K],w.d,q[J],w,T,u);e(F,q[J],w.a,q[H],w,Z,u)}else c("face should be a face!",
w)}q=new THREE.Vector3;w=new THREE.Vector3;u=0;for(v=n.length;u<v;u++)if(z[u]!==void 0){q.set(0,0,0);w.set(0,0,0);E=new THREE.Vector3(0,0,0);F=0;for(s in I[u]){q.addSelf(o[s]);F++}B=0;H=z[u].length;A=F!=H;for(s=0;s<H;s++)r[orderedKey(z[u][s][0],z[u][s][1])]&&B++;q.divideScalar(F);B=0;if(A){for(s=0;s<H;s++){F=z[u][s];if(Q=D[orderedKey(F[0],F[1])].length==1){F=n[F[0]].clone().addSelf(n[F[1]]).divideScalar(2);w.addSelf(F);B++}}w.divideScalar(4);b(B==2,"should have only 2 boundary edges")}else{for(s=
0;s<H;s++){F=z[u][s];F=n[F[0]].clone().addSelf(n[F[1]]).divideScalar(2);w.addSelf(F)}w.divideScalar(H)}E.addSelf(n[u]);if(A){E.divideScalar(2);E.addSelf(w)}else{E.multiplyScalar(H-3);E.addSelf(q);E.addSelf(w.multiplyScalar(2));E.divideScalar(H)}h[u]=E}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=j;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};
...
"color");m.scale=b.getUniformLocation(l,"scale");m.rotation=b.getUniformLocation(l,"rotation");m.screenPosition=b.getUniformLocation(l,"screenPosition");p=false};this.render=function(a,d,e,t){var a=a.__webglFlares,u=a.length;if(u){var v=new THREE.Vector3,s=t/e,A=e*0.5,w=t*0.5,z=16/t,I=new THREE.Vector2(z*s,z),D=new THREE.Vector3(1,1,0),F=new THREE.Vector2(1,1),B=m,z=n;b.useProgram(l);if(!p){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);p=true}b.uniform1i(B.occlusionMap,0);b.uniform1i(B.map,
1);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(z.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(z.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var E,H,Q,L,K;for(E=0;E<u;E++){z=16/t;I.set(z*s,z);L=a[E];v.set(L.matrixWorld.elements[12],L.matrixWorld.elements[13],L.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(v);d.projectionMatrix.multiplyVector3(v);D.copy(v);F.x=D.x*A+A;F.y=D.y*w+w;if(j||F.x>0&&F.x<e&&F.y>0&&
...
vertexShader:g.vertexShader,uniforms:h,skinning:true});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:true,skinning:true});c._shadowPass=true;d._shadowPass=true;e._shadowPass=true;f._shadowPass=true};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,n){var m,p,o,q,r,t,u,v,s,A=[];q=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(true);m=0;for(p=l.__lights.length;m<p;m++){o=l.__lights[m];if(o.castShadow)if(o instanceof THREE.DirectionalLight&&o.shadowCascade)for(r=0;r<o.shadowCascadeCount;r++){var w;if(o.shadowCascadeArray[r])w=o.shadowCascadeArray[r];else{s=o;u=r;w=new THREE.DirectionalLight;w.isVirtual=true;w.onlyShadow=true;w.castShadow=true;w.shadowCameraNear=s.shadowCameraNear;w.shadowCameraFar=s.shadowCameraFar;w.shadowCameraLeft=s.shadowCameraLeft;w.shadowCameraRight=
s.shadowCameraRight;w.shadowCameraBottom=s.shadowCameraBottom;w.shadowCameraTop=s.shadowCameraTop;w.shadowCameraVisible=s.shadowCameraVisible;w.shadowDarkness=s.shadowDarkness;w.shadowBias=s.shadowCascadeBias[u];w.shadowMapWidth=s.shadowCascadeWidth[u];w.shadowMapHeight=s.shadowCascadeHeight[u];w.pointsWorld=[];w.pointsFrustum=[];v=w.pointsWorld;t=w.pointsFrustum;for(var z=0;z<8;z++){v[z]=new THREE.Vector3;t[z]=new THREE.Vector3}v=s.shadowCascadeNearZ[u];s=s.shadowCascadeFarZ[u];t[0].set(-1,-1,v);
...
u.shadowCascadeBias[v];t=u.shadowCascadeNearZ[v];u=u.shadowCascadeFarZ[v];s=s.pointsFrustum;s[0].z=t;s[1].z=t;s[2].z=t;s[3].z=t;s[4].z=u;s[5].z=u;s[6].z=u;s[7].z=u;A[q]=w;q++}else{A[q]=o;q++}}m=0;for(p=A.length;m<p;m++){o=A[m];if(!o.shadowMap){o.shadowMap=new THREE.WebGLRenderTarget(o.shadowMapWidth,o.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});o.shadowMapSize=new THREE.Vector2(o.shadowMapWidth,o.shadowMapHeight);o.shadowMatrix=new THREE.Matrix4}if(!o.shadowCamera){if(o instanceof
...
!o.cameraHelper){o.cameraHelper=new THREE.CameraHelper(o.shadowCamera);o.shadowCamera.add(o.cameraHelper)}if(o.isVirtual&&w.originalCamera==n){r=n;q=o.shadowCamera;t=o.pointsFrustum;s=o.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(u=0;u<8;u++){v=s[u];v.copy(t[u]);THREE.ShadowMapPlugin.__projector.unprojectVector(v,r);q.matrixWorldInverse.multiplyVector3(v);if(v.x<i.x)i.x=v.x;if(v.x>j.x)j.x=v.x;if(v.y<i.y)i.y=v.y;if(v.y>j.y)j.y=v.y;if(v.z<i.z)i.z=v.z;if(v.z>
j.z)j.z=v.z}q.left=i.x;q.right=j.x;q.top=j.y;q.bottom=i.y;q.updateProjectionMatrix()}q=o.shadowMap;t=o.shadowMatrix;r=o.shadowCamera;r.position.copy(o.matrixWorld.getPosition());r.lookAt(o.target.matrixWorld.getPosition());r.updateMatrixWorld();r.matrixWorldInverse.getInverse(r.matrixWorld);if(o.cameraHelper)o.cameraHelper.visible=o.shadowCameraVisible;o.shadowCameraVisible&&o.cameraHelper.update();t.set(0.5,0,0,0.5,0,0.5,0,0.5,0,0,0.5,0.5,0,0,0,1);t.multiplySelf(r.projectionMatrix);t.multiplySelf(r.matrixWorldInverse);
if(!r._viewMatrixArray)r._viewMatrixArray=new Float32Array(16);if(!r._projectionMatrixArray)r._projectionMatrixArray=new Float32Array(16);r.matrixWorldInverse.flattenToArray(r._viewMatrixArray);r.projectionMatrix.flattenToArray(r._projectionMatrixArray);h.multiply(r.projectionMatrix,r.matrixWorldInverse);g.setFromMatrix(h);b.setRenderTarget(q);b.clear();s=l.__webglObjects;o=0;for(q=s.length;o<q;o++){u=s[o];t=u.object;u.render=false;if(t.visible&&t.castShadow&&(!(t instanceof THREE.Mesh)||!t.frustumCulled||
g.contains(t))){t._modelViewMatrix.multiply(r.matrixWorldInverse,t.matrixWorld);u.render=true}}o=0;for(q=s.length;o<q;o++){u=s[o];if(u.render){t=u.object;u=u.buffer;z=t.material instanceof THREE.MeshFaceMaterial?t.geometry.materials[0]:t.material;v=t.geometry.morphTargets.length>0&&z.morphTargets;z=t instanceof THREE.SkinnedMesh&&z.skinning;v=t.customDepthMaterial?t.customDepthMaterial:z?v?f:e:v?d:c;u instanceof THREE.BufferGeometry?b.renderBufferDirect(r,l.__lights,null,v,u,t):b.renderBuffer(r,l.__lights,
null,v,u,t)}}s=l.__webglObjectsImmediate;o=0;for(q=s.length;o<q;o++){u=s[o];t=u.object;if(t.visible&&t.castShadow){t._modelViewMatrix.multiply(r.matrixWorldInverse,t.matrixWorld);b.renderImmediateObject(r,l.__lights,null,c,t)}}}m=b.getClearColor();p=b.getClearAlpha();a.clearColor(m.r,m.g,m.b,p);a.enable(a.BLEND);b.shadowMapCullFrontFaces&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;
...
j.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");l=false};this.render=function(d,e,p,o){var d=d.__webglSprites,q=d.length;if(q){var r=i,t=j,u=o/p,p=p*0.5,v=o*0.5,s=true;b.useProgram(h);if(!l){b.enableVertexAttribArray(r.position);b.enableVertexAttribArray(r.uv);l=true}b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(true);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(r.position,2,b.FLOAT,false,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
g);b.uniformMatrix4fv(t.projectionMatrix,false,e._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(t.map,0);for(var A,w=[],r=0;r<q;r++){A=d[r];if(A.visible&&A.opacity!==0)if(A.useScreenCoordinates)A.z=-A.position.z;else{A._modelViewMatrix.multiply(e.matrixWorldInverse,A.matrixWorld);A.z=-A._modelViewMatrix.elements[14]}}d.sort(a);for(r=0;r<q;r++){A=d[r];if(A.visible&&A.opacity!==0&&A.map&&A.map.image&&A.map.image.width){if(A.useScreenCoordinates){b.uniform1i(t.useScreenCoordinates,1);
b.uniform3f(t.screenPosition,(A.position.x-p)/p,(v-A.position.y)/v,Math.max(0,Math.min(1,A.position.z)))}else{b.uniform1i(t.useScreenCoordinates,0);b.uniform1i(t.affectedByDistance,A.affectedByDistance?1:0);b.uniformMatrix4fv(t.modelViewMatrix,false,A._modelViewMatrix.elements)}e=A.map.image.width/(A.scaleByViewport?o:1);w[0]=e*u*A.scale.x;w[1]=e*A.scale.y;b.uniform2f(t.uvScale,A.uvScale.x,A.uvScale.y);b.uniform2f(t.uvOffset,A.uvOffset.x,A.uvOffset.y);b.uniform2f(t.alignment,A.alignment.x,A.alignment.y);
b.uniform1f(t.opacity,A.opacity);b.uniform3f(t.color,A.color.r,A.color.g,A.color.b);b.uniform1f(t.rotation,A.rotation);b.uniform2fv(t.scale,w);if(A.mergeWith3D&&!s){b.enable(b.DEPTH_TEST);s=true}else if(!A.mergeWith3D&&s){b.disable(b.DEPTH_TEST);s=false}c.setBlending(A.blending,A.blendEquation,A.blendSrc,A.blendDst);c.setTexture(A.map,0);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
...
d:c;l instanceof THREE.BufferGeometry?b.renderBufferDirect(h,g.__lights,null,n,l,m):b.renderBuffer(h,g.__lights,null,n,l,m)}}p=g.__webglObjectsImmediate;i=0;for(j=p.length;i<j;i++){l=p[i];m=l.object;if(m.visible&&m.castShadow){m._modelViewMatrix.multiply(h.matrixWorldInverse,m.matrixWorld);b.renderImmediateObject(h,g.__lights,null,c,m)}}i=b.getClearColor();j=b.getClearAlpha();a.clearColor(i.r,i.g,i.b,j);a.enable(a.BLEND)}};
