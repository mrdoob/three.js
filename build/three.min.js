...
f,null!==f.renderDepth?e.z=f.renderDepth:(L.getPositionFromMatrix(f.matrixWorld),L.applyProjection(ea),e.z=L.z),G.objects.push(e));Aa(f)}}};Aa(g);!0===p&&G.objects.sort(c);g=0;for(p=G.objects.length;g<p;g++)if(ka=G.objects[g].object,xa=ka.matrixWorld,j=0,ka instanceof THREE.Mesh){Qa=ka.geometry;la=Qa.vertices;jb=Qa.faces;Qa=Qa.faceVertexUvs;A.getNormalMatrix(xa);Wa=ka.material instanceof THREE.MeshFaceMaterial;Ra=!0===Wa?ka.material:null;ta=0;for(Z=la.length;ta<Z;ta++)i=b(),i.positionWorld.copy(la[ta]).applyMatrix4(xa),
i.positionScreen.copy(i.positionWorld).applyMatrix4(ea),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,i.positionScreen.z/=i.positionScreen.w,i.visible=!(-1>i.positionScreen.x||1<i.positionScreen.x||-1>i.positionScreen.y||1<i.positionScreen.y||-1>i.positionScreen.z||1<i.positionScreen.z);la=0;for(ta=jb.length;la<ta;la++){Z=jb[la];var Sa=!0===Wa?Ra.materials[Z.materialIndex]:ka.material;if(void 0!==Sa){ia=Sa.side;if(Z instanceof THREE.Face3)if(W=m[Z.a],V=m[Z.b],ga=m[Z.c],
...
l.centroidModel.copy(Z.centroid).applyMatrix4(xa);ga=Z.vertexNormals;W=0;for(V=ga.length;W<V;W++)oa=l.vertexNormalsModel[W],oa.copy(ga[W]),!1===pa&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&oa.negate(),oa.applyMatrix3(A).normalize(),l.vertexNormalsModelView[W].copy(oa).applyMatrix3(ca);l.vertexNormalsLength=ga.length;W=0;for(V=Qa.length;W<V;W++)if(oa=Qa[W][la],void 0!==oa){ia=0;for(ga=oa.length;ia<ga;ia++)l.uvs[W][ia]=oa[ia]}l.color=Z.color;l.material=Sa;ha.copy(l.centroidModel).applyProjection(ea);
l.z=ha.z;G.elements.push(l)}}}else if(ka instanceof THREE.Line){Ma.multiplyMatrices(ea,xa);la=ka.geometry.vertices;W=b();W.positionScreen.copy(la[0]).applyMatrix4(Ma);jb=ka.type===THREE.LinePieces?2:1;ta=1;for(Z=la.length;ta<Z;ta++)W=b(),W.positionScreen.copy(la[ta]).applyMatrix4(Ma),0<(ta+1)%jb||(V=m[j-2],N.copy(W.positionScreen),fa.copy(V.positionScreen),!0===d(N,fa)&&(N.multiplyScalar(1/N.w),fa.multiplyScalar(1/fa.w),t===J?(Qa=new THREE.RenderableLine,E.push(Qa),J++,t++,x=Qa):x=E[t++],x.v1.positionScreen.copy(N),
...
b){if(P!==a||C!==b)t.setLineDash([a,b]),P=a,C=b}console.log("THREE.CanvasRenderer",THREE.REVISION);var j=THREE.Math.smoothstep,a=a||{},m=this,p,l,r,s=new THREE.Projector,n=void 0!==a.canvas?a.canvas:document.createElement("canvas"),q,y,u,x,t=n.getContext("2d"),E=new THREE.Color(0),J=0,F=1,z=0,H=null,K=null,G=null,L=null,B=null,P=null,C=0,I,M,U,ea,xa=new THREE.RenderableVertex,Ma=new THREE.RenderableVertex,A,ca,ha,na,N,fa,ib,Za,db,Ka,pa,ta,Z=new THREE.Color,la=new THREE.Color,W=new THREE.Color,V=new THREE.Color,
ia=new THREE.Color,ga=new THREE.Color,ka=new THREE.Color,Qa=new THREE.Color,jb={},oa={},Wa,Ra,Aa,Sa,rb,Ob,Lb,Pb,Tb,Ub,Ta=new THREE.Box2,va=new THREE.Box2,Ja=new THREE.Box2,sb=new THREE.Color,Na=new THREE.Color,qa=new THREE.Color,$a=new THREE.Vector3,Bb,k,Cb,Ua,kb,Va,Db=16;Bb=document.createElement("canvas");Bb.width=Bb.height=2;k=Bb.getContext("2d");k.fillStyle="rgba(0,0,0,1)";k.fillRect(0,0,2,2);Cb=k.getImageData(0,0,2,2);Ua=Cb.data;kb=document.createElement("canvas");kb.width=kb.height=Db;Va=kb.getContext("2d");
Va.translate(-Db/2,-Db/2);Va.scale(Db,Db);Db--;void 0===t.setLineDash&&(t.setLineDash=void 0!==t.mozDash?function(a){t.mozDash=null!==a[0]?a:null}:function(){});this.domElement=n;this.devicePixelRatio=void 0!==a.devicePixelRatio?a.devicePixelRatio:void 0!==window.devicePixelRatio?window.devicePixelRatio:1;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.supportsVertexTextures=function(){};this.setFaceCulling=function(){};this.setSize=function(a,b){q=
...
this.setClearColor(a,b)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){t.setTransform(1,0,0,-1,u,x);!1===va.empty()&&(va.intersect(Ta),va.expandByScalar(2),1>J&&t.clearRect(va.min.x|0,va.min.y|0,va.max.x-va.min.x|0,va.max.y-va.min.y|0),0<J&&(c(THREE.NormalBlending),b(1),h("rgba("+Math.floor(255*E.r)+","+Math.floor(255*E.g)+","+Math.floor(255*E.b)+","+J+")"),t.fillRect(va.min.x|0,va.min.y|0,va.max.x-va.min.x|0,va.max.y-va.min.y|0)),va.makeEmpty())};this.render=function(a,n){function q(a,
b,c){for(var d=0,e=r.length;d<e;d++){var f=r[d];Qa.copy(f.color);if(f instanceof THREE.DirectionalLight){var g=$a.getPositionFromMatrix(f.matrixWorld).normalize(),h=b.dot(g);0>=h||(h*=f.intensity,c.add(Qa.multiplyScalar(h)))}else f instanceof THREE.PointLight&&(g=$a.getPositionFromMatrix(f.matrixWorld),h=b.dot($a.subVectors(g,a).normalize()),0>=h||(h*=0==f.distance?1:1-Math.min(a.distanceTo(g)/f.distance,1),0!=h&&(h*=f.intensity,c.add(Qa.multiplyScalar(h)))))}}function z(a,d,e,f,g,h,k,i){m.info.render.vertices+=
...
i instanceof THREE.MeshPhongMaterial?null!==i.map?i.map.mapping instanceof THREE.UVMapping&&(Sa=k.uvs[0],C(A,ca,ha,na,N,fa,Sa[f].x,Sa[f].y,Sa[g].x,Sa[g].y,Sa[h].x,Sa[h].y,i.map)):null!==i.envMap?i.envMap.mapping instanceof THREE.SphericalReflectionMapping&&($a.copy(k.vertexNormalsModelView[f]),rb=0.5*$a.x+0.5,Ob=0.5*$a.y+0.5,$a.copy(k.vertexNormalsModelView[g]),Lb=0.5*$a.x+0.5,Pb=0.5*$a.y+0.5,$a.copy(k.vertexNormalsModelView[h]),Tb=0.5*$a.x+0.5,Ub=0.5*$a.y+0.5,C(A,ca,ha,na,N,fa,rb,Ob,Lb,Pb,Tb,Ub,
i.envMap)):(Z.copy(i.color),i.vertexColors===THREE.FaceColors&&Z.multiply(k.color),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z)):i instanceof THREE.MeshDepthMaterial?(Wa=n.near,Ra=n.far,la.r=la.g=la.b=1-j(a.positionScreen.z*a.positionScreen.w,Wa,Ra),W.r=W.g=W.b=1-j(d.positionScreen.z*d.positionScreen.w,Wa,Ra),V.r=V.g=V.b=1-j(e.positionScreen.z*e.positionScreen.w,Wa,Ra),ia.addColors(W,V).multiplyScalar(0.5),Aa=H(la,W,V,ia),J(A,ca,ha,na,N,fa,0,0,1,0,0,1,Aa)):
...
b,c,d,e,f,g,h,i,k,ua,j,m){var l,p;l=m.width-1;p=m.height-1;g*=l;h*=p;c-=a;d-=b;e-=a;f-=b;i=i*l-g;k=k*p-h;ua=ua*l-g;j=j*p-h;p=1/(i*j-ua*k);l=(j*c-k*e)*p;k=(j*d-k*f)*p;c=(i*e-ua*c)*p;d=(i*f-ua*d)*p;a=a-l*g-c*h;b=b-k*g-d*h;t.save();t.transform(l,k,c,d,a,b);t.clip();t.drawImage(m,0,0);t.restore()}function H(a,b,c,d){Ua[0]=255*a.r|0;Ua[1]=255*a.g|0;Ua[2]=255*a.b|0;Ua[4]=255*b.r|0;Ua[5]=255*b.g|0;Ua[6]=255*b.b|0;Ua[8]=255*c.r|0;Ua[9]=255*c.g|0;Ua[10]=255*c.b|0;Ua[12]=255*d.r|0;Ua[13]=255*d.g|0;Ua[14]=255*
d.b|0;k.putImageData(Cb,0,0);Va.drawImage(Bb,0,0);return kb}function G(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===n instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{!0===this.autoClear&&this.clear();t.setTransform(1,0,0,-1,u,x);m.info.render.vertices=0;m.info.render.faces=0;p=s.projectScene(a,n,this.sortObjects,this.sortElements);l=p.elements;r=p.lights;sb.setRGB(0,
0,0);Na.setRGB(0,0,0);qa.setRGB(0,0,0);for(var K=0,P=r.length;K<P;K++){var R=r[K],L=R.color;R instanceof THREE.AmbientLight?sb.add(L):R instanceof THREE.DirectionalLight?Na.add(L):R instanceof THREE.PointLight&&qa.add(L)}K=0;for(P=l.length;K<P;K++){var da=l[K],R=da.material;if(!(void 0===R||!1===R.visible)){Ja.makeEmpty();if(da instanceof THREE.RenderableParticle){I=da;I.x*=u;I.y*=x;var L=I,ua=da;b(R.opacity);c(R.blending);var ub=void 0,mb=void 0,vb=void 0,wb=void 0,Nc=da=void 0,Oc=void 0;R instanceof
THREE.ParticleBasicMaterial?null===R.map?(vb=ua.object.scale.x,wb=ua.object.scale.y,vb*=ua.scale.x*u,wb*=ua.scale.y*x,Ja.min.set(L.x-vb,L.y-wb),Ja.max.set(L.x+vb,L.y+wb),!1===Ta.isIntersectionBox(Ja)?Ja.makeEmpty():(h(R.color.getStyle()),t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(vb,wb),t.fillRect(-1,-1,2,2),t.restore())):(da=R.map.image,Nc=da.width>>1,Oc=da.height>>1,vb=ua.scale.x*u,wb=ua.scale.y*x,ub=vb*Nc,mb=wb*Oc,Ja.min.set(L.x-ub,L.y-mb),Ja.max.set(L.x+ub,L.y+mb),!1===Ta.isIntersectionBox(Ja)?
Ja.makeEmpty():(t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(vb,-wb),t.translate(-Nc,-Oc),t.drawImage(da,0,0),t.restore())):R instanceof THREE.ParticleCanvasMaterial&&(ub=ua.scale.x*u,mb=ua.scale.y*x,Ja.min.set(L.x-ub,L.y-mb),Ja.max.set(L.x+ub,L.y+mb),!1===Ta.isIntersectionBox(Ja)?Ja.makeEmpty():(g(R.color.getStyle()),h(R.color.getStyle()),t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(ub,mb),R.program(t),t.restore()))}else if(da instanceof THREE.RenderableLine)I=da.v1,
M=da.v2,I.positionScreen.x*=u,I.positionScreen.y*=x,M.positionScreen.x*=u,M.positionScreen.y*=x,Ja.setFromPoints([I.positionScreen,M.positionScreen]),!0===Ta.isIntersectionBox(Ja)&&(L=I,ua=M,b(R.opacity),c(R.blending),t.beginPath(),t.moveTo(L.positionScreen.x,L.positionScreen.y),t.lineTo(ua.positionScreen.x,ua.positionScreen.y),R instanceof THREE.LineBasicMaterial?(d(R.linewidth),e(R.linecap),f(R.linejoin),g(R.color.getStyle()),t.stroke(),Ja.expandByScalar(2*R.linewidth)):R instanceof THREE.LineDashedMaterial&&
(d(R.linewidth),e(R.linecap),f(R.linejoin),g(R.color.getStyle()),i(R.dashSize,R.gapSize),t.stroke(),Ja.expandByScalar(2*R.linewidth),i(null,null)));else if(da instanceof THREE.RenderableFace3){I=da.v1;M=da.v2;U=da.v3;if(-1>I.positionScreen.z||1<I.positionScreen.z)continue;if(-1>M.positionScreen.z||1<M.positionScreen.z)continue;if(-1>U.positionScreen.z||1<U.positionScreen.z)continue;I.positionScreen.x*=u;I.positionScreen.y*=x;M.positionScreen.x*=u;M.positionScreen.y*=x;U.positionScreen.x*=u;U.positionScreen.y*=
x;!0===R.overdraw&&(G(I.positionScreen,M.positionScreen),G(M.positionScreen,U.positionScreen),G(U.positionScreen,I.positionScreen));Ja.setFromPoints([I.positionScreen,M.positionScreen,U.positionScreen]);!0===Ta.isIntersectionBox(Ja)&&z(I,M,U,0,1,2,da,R)}else if(da instanceof THREE.RenderableFace4){I=da.v1;M=da.v2;U=da.v3;ea=da.v4;if(-1>I.positionScreen.z||1<I.positionScreen.z)continue;if(-1>M.positionScreen.z||1<M.positionScreen.z)continue;if(-1>U.positionScreen.z||1<U.positionScreen.z)continue;if(-1>
ea.positionScreen.z||1<ea.positionScreen.z)continue;I.positionScreen.x*=u;I.positionScreen.y*=x;M.positionScreen.x*=u;M.positionScreen.y*=x;U.positionScreen.x*=u;U.positionScreen.y*=x;ea.positionScreen.x*=u;ea.positionScreen.y*=x;xa.positionScreen.copy(M.positionScreen);Ma.positionScreen.copy(ea.positionScreen);!0===R.overdraw&&(G(I.positionScreen,M.positionScreen),G(M.positionScreen,ea.positionScreen),G(ea.positionScreen,I.positionScreen),G(U.positionScreen,xa.positionScreen),G(U.positionScreen,
Ma.positionScreen));Ja.setFromPoints([I.positionScreen,M.positionScreen,U.positionScreen,ea.positionScreen]);!0===Ta.isIntersectionBox(Ja)&&(L=I,ua=M,ub=U,mb=ea,vb=xa,wb=Ma,m.info.render.vertices+=4,m.info.render.faces++,b(R.opacity),c(R.blending),void 0!==R.map&&null!==R.map||void 0!==R.envMap&&null!==R.envMap?(z(L,ua,mb,0,1,3,da,R),z(vb,ub,wb,1,2,3,da,R)):(A=L.positionScreen.x,ca=L.positionScreen.y,ha=ua.positionScreen.x,na=ua.positionScreen.y,N=ub.positionScreen.x,fa=ub.positionScreen.y,ib=mb.positionScreen.x,
Za=mb.positionScreen.y,db=vb.positionScreen.x,Ka=vb.positionScreen.y,pa=wb.positionScreen.x,ta=wb.positionScreen.y,R instanceof THREE.MeshLambertMaterial||R instanceof THREE.MeshPhongMaterial?(ga.copy(R.color),ka.copy(R.emissive),R.vertexColors===THREE.FaceColors&&ga.multiply(da.color),!1===R.wireframe&&R.shading==THREE.SmoothShading&&4==da.vertexNormalsLength?(la.copy(sb),W.copy(sb),V.copy(sb),ia.copy(sb),q(da.v1.positionWorld,da.vertexNormalsModel[0],la),q(da.v2.positionWorld,da.vertexNormalsModel[1],
W),q(da.v4.positionWorld,da.vertexNormalsModel[3],V),q(da.v3.positionWorld,da.vertexNormalsModel[2],ia),la.multiply(ga).add(ka),W.multiply(ga).add(ka),V.multiply(ga).add(ka),ia.multiply(ga).add(ka),Aa=H(la,W,V,ia),y(A,ca,ha,na,ib,Za),J(A,ca,ha,na,ib,Za,0,0,1,0,0,1,Aa),y(db,Ka,N,fa,pa,ta),J(db,Ka,N,fa,pa,ta,1,0,1,1,0,1,Aa)):(Z.copy(sb),q(da.centroidModel,da.normalModel,Z),Z.multiply(ga).add(ka),B(A,ca,ha,na,N,fa,ib,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):
F(Z))):R instanceof THREE.MeshBasicMaterial?(Z.copy(R.color),R.vertexColors===THREE.FaceColors&&Z.multiply(da.color),B(A,ca,ha,na,N,fa,ib,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R instanceof THREE.MeshNormalMaterial?(L=void 0,R.shading==THREE.FlatShading?(L=da.normalModelView,Z.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),B(A,ca,ha,na,N,fa,ib,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R.shading==
THREE.SmoothShading&&(L=da.vertexNormalsModelView[0],la.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[1],W.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[3],V.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[2],ia.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),Aa=H(la,W,V,ia),y(A,ca,ha,na,ib,Za),J(A,ca,ha,na,ib,Za,0,0,1,0,0,1,Aa),y(db,Ka,N,fa,pa,ta),J(db,Ka,N,fa,pa,ta,1,0,1,1,0,1,Aa))):
R instanceof THREE.MeshDepthMaterial&&(Wa=n.near,Ra=n.far,la.r=la.g=la.b=1-j(L.positionScreen.z*L.positionScreen.w,Wa,Ra),W.r=W.g=W.b=1-j(ua.positionScreen.z*ua.positionScreen.w,Wa,Ra),V.r=V.g=V.b=1-j(mb.positionScreen.z*mb.positionScreen.w,Wa,Ra),ia.r=ia.g=ia.b=1-j(ub.positionScreen.z*ub.positionScreen.w,Wa,Ra),Aa=H(la,W,V,ia),y(A,ca,ha,na,ib,Za),J(A,ca,ha,na,ib,Za,0,0,1,0,0,1,Aa),y(db,Ka,N,fa,pa,ta),J(db,Ka,N,fa,pa,ta,1,0,1,1,0,1,Aa))))}va.union(Ja)}}t.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
(e.__webglMorphTargetInfluences=new Float32Array(N.maxMorphTargets));var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==Za&&(k.useProgram(g),Za=g,f=!0);d.id!==Ka&&(Ka=d.id,f=!0);if(f||a!==ta)k.uniformMatrix4fv(h.projectionMatrix,!1,a.projectionMatrix.elements),a!==ta&&(ta=a);if(d.skinning)if(Vb&&e.useVertexTexture){if(null!==h.boneTexture){var j=J();k.uniform1i(h.boneTexture,j);N.setTexture(e.boneTexture,j)}}else null!==h.boneGlobalMatrices&&k.uniformMatrix4fv(h.boneGlobalMatrices,!1,e.boneMatrices);
...
a+" texture units while this GPU supports only "+cc);la+=1;return a}function F(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function z(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function H(a){a!==Sa&&(k.lineWidth(a),Sa=a)}function K(a,b,c){Wa!==a&&(a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL),Wa=a);if(a&&(Ra!==b||Aa!==c))k.polygonOffset(b,c),Ra=b,Aa=c}function G(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function L(a,
...
!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var N=this,fa=[],ib=0,Za=null,db=null,Ka=-1,pa=null,ta=null,Z=0,la=0,W=-1,V=-1,ia=-1,ga=-1,ka=-1,Qa=-1,jb=-1,oa=-1,Wa=null,Ra=null,Aa=null,Sa=null,rb=0,Ob=0,Lb=0,Pb=0,Tb=0,Ub=0,Ta={},va=new THREE.Frustum,Ja=new THREE.Matrix4,sb=new THREE.Matrix4,Na=new THREE.Vector3,qa=new THREE.Vector3,
$a=!0,Bb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Cb,Ua,kb,Va;try{if(!(k=M.getContext("experimental-webgl",{alpha:ea,premultipliedAlpha:xa,antialias:Ma,stencil:A,preserveDrawingBuffer:ca})))throw"Error creating WebGL context.";}catch(Db){console.error(Db)}Cb=k.getExtension("OES_texture_float");
Ua=k.getExtension("OES_standard_derivatives");kb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");Va=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");Cb||console.log("THREE.WebGLRenderer: Float textures not supported.");Ua||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");
kb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");Va||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");void 0===k.getShaderPrecisionFormat&&(k.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}});k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,
k.ONE_MINUS_SRC_ALPHA);k.clearColor(ha.r,ha.g,ha.b,na);this.context=k;var cc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),Gc=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Hc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),dc=kb?k.getParameter(kb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,ec=0<Gc,Vb=ec&&Cb;Va&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);var Kc=k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.HIGH_FLOAT),Lc=k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.MEDIUM_FLOAT);
...
0,e.__webglVertexCount),N.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,i=a.__lights,m=a.fog;Ka=-1;$a=!0;!0===a.autoUpdate&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b.matrixWorldInverse.getInverse(b.matrixWorld);Ja.multiplyMatrices(b.projectionMatrix,b.matrixWorldInverse);va.setFromMatrix(Ja);this.autoUpdateObjects&&this.initWebGLObjects(a);
...
ca=void 0,da=void 0,Za=void 0,ea=void 0,ga=void 0,ia=void 0,ib=void 0,ha=void 0,ka=void 0,pa=void 0,na=void 0,oa=void 0,Ka=void 0,db=void 0,xa=void 0,qa=void 0,va=void 0,Aa=void 0,Qa=void 0,wa=void 0,$a=void 0,Ma=void 0,Ua=void 0,Wa=void 0,ab=void 0,jb=void 0,Xa=void 0,Ya=void 0,Ra=void 0,Sa=void 0,La=0,Pa=0,Ta=0,Va=0,xb=0,gb=0,Ba=0,lb=0,Oa=0,Y=0,ja=0,w=0,ya=void 0,bb=C.__vertexArray,kb=C.__uvArray,rb=C.__uv2Array,yb=C.__normalArray,Fa=C.__tangentArray,cb=C.__colorArray,Ga=C.__skinIndexArray,Ha=C.__skinWeightArray,
...
A;D++)O=hb[ra[D]],S=Wb[O.a],T=Wb[O.b],Q=Wb[O.c],bb[Pa]=S.x,bb[Pa+1]=S.y,bb[Pa+2]=S.z,bb[Pa+3]=T.x,bb[Pa+4]=T.y,bb[Pa+5]=T.z,bb[Pa+6]=Q.x,bb[Pa+7]=Q.y,bb[Pa+8]=Q.z,Pa+=9;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=Wb[O.a],T=Wb[O.b],Q=Wb[O.c],aa=Wb[O.d],bb[Pa]=S.x,bb[Pa+1]=S.y,bb[Pa+2]=S.z,bb[Pa+3]=T.x,bb[Pa+4]=T.y,bb[Pa+5]=T.z,bb[Pa+6]=Q.x,bb[Pa+7]=Q.y,bb[Pa+8]=Q.z,bb[Pa+9]=aa.x,bb[Pa+10]=aa.y,bb[Pa+11]=aa.z,Pa+=12;k.bindBuffer(k.ARRAY_BUFFER,C.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,bb,G)}if(ec){ab=
0;for(jb=Rb.length;ab<jb;ab++){D=ja=0;for(A=ra.length;D<A;D++)Ra=ra[D],O=hb[Ra],S=Rb[ab].vertices[O.a],T=Rb[ab].vertices[O.b],Q=Rb[ab].vertices[O.c],Xa=Bb[ab],Xa[ja]=S.x,Xa[ja+1]=S.y,Xa[ja+2]=S.z,Xa[ja+3]=T.x,Xa[ja+4]=T.y,Xa[ja+5]=T.z,Xa[ja+6]=Q.x,Xa[ja+7]=Q.y,Xa[ja+8]=Q.z,H.morphNormals&&(M?(Sa=qc[ab].vertexNormals[Ra],ea=Sa.a,ga=Sa.b,ia=Sa.c):ia=ga=ea=qc[ab].faceNormals[Ra],Ya=Cb[ab],Ya[ja]=ea.x,Ya[ja+1]=ea.y,Ya[ja+2]=ea.z,Ya[ja+3]=ga.x,Ya[ja+4]=ga.y,Ya[ja+5]=ga.z,Ya[ja+6]=ia.x,Ya[ja+7]=ia.y,Ya[ja+
8]=ia.z),ja+=9;D=0;for(A=sa.length;D<A;D++)Ra=sa[D],O=hb[Ra],S=Rb[ab].vertices[O.a],T=Rb[ab].vertices[O.b],Q=Rb[ab].vertices[O.c],aa=Rb[ab].vertices[O.d],Xa=Bb[ab],Xa[ja]=S.x,Xa[ja+1]=S.y,Xa[ja+2]=S.z,Xa[ja+3]=T.x,Xa[ja+4]=T.y,Xa[ja+5]=T.z,Xa[ja+6]=Q.x,Xa[ja+7]=Q.y,Xa[ja+8]=Q.z,Xa[ja+9]=aa.x,Xa[ja+10]=aa.y,Xa[ja+11]=aa.z,H.morphNormals&&(M?(Sa=qc[ab].vertexNormals[Ra],ea=Sa.a,ga=Sa.b,ia=Sa.c,ib=Sa.d):ib=ia=ga=ea=qc[ab].faceNormals[Ra],Ya=Cb[ab],Ya[ja]=ea.x,Ya[ja+1]=ea.y,Ya[ja+2]=ea.z,Ya[ja+3]=ga.x,
Ya[ja+4]=ga.y,Ya[ja+5]=ga.z,Ya[ja+6]=ia.x,Ya[ja+7]=ia.y,Ya[ja+8]=ia.z,Ya[ja+9]=ib.x,Ya[ja+10]=ib.y,Ya[ja+11]=ib.z),ja+=12;k.bindBuffer(k.ARRAY_BUFFER,C.__webglMorphTargetsBuffers[ab]);k.bufferData(k.ARRAY_BUFFER,Bb[ab],G);H.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglMorphNormalsBuffers[ab]),k.bufferData(k.ARRAY_BUFFER,Cb[ab],G))}}if(Qb.length){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],oa=Qb[O.a],Ka=Qb[O.b],db=Qb[O.c],Ha[Y]=oa.x,Ha[Y+1]=oa.y,Ha[Y+2]=oa.z,Ha[Y+3]=oa.w,Ha[Y+4]=Ka.x,Ha[Y+5]=Ka.y,
Ha[Y+6]=Ka.z,Ha[Y+7]=Ka.w,Ha[Y+8]=db.x,Ha[Y+9]=db.y,Ha[Y+10]=db.z,Ha[Y+11]=db.w,qa=Xb[O.a],va=Xb[O.b],Aa=Xb[O.c],Ga[Y]=qa.x,Ga[Y+1]=qa.y,Ga[Y+2]=qa.z,Ga[Y+3]=qa.w,Ga[Y+4]=va.x,Ga[Y+5]=va.y,Ga[Y+6]=va.z,Ga[Y+7]=va.w,Ga[Y+8]=Aa.x,Ga[Y+9]=Aa.y,Ga[Y+10]=Aa.z,Ga[Y+11]=Aa.w,Y+=12;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],oa=Qb[O.a],Ka=Qb[O.b],db=Qb[O.c],xa=Qb[O.d],Ha[Y]=oa.x,Ha[Y+1]=oa.y,Ha[Y+2]=oa.z,Ha[Y+3]=oa.w,Ha[Y+4]=Ka.x,Ha[Y+5]=Ka.y,Ha[Y+6]=Ka.z,Ha[Y+7]=Ka.w,Ha[Y+8]=db.x,Ha[Y+9]=db.y,Ha[Y+10]=db.z,
Ha[Y+11]=db.w,Ha[Y+12]=xa.x,Ha[Y+13]=xa.y,Ha[Y+14]=xa.z,Ha[Y+15]=xa.w,qa=Xb[O.a],va=Xb[O.b],Aa=Xb[O.c],Qa=Xb[O.d],Ga[Y]=qa.x,Ga[Y+1]=qa.y,Ga[Y+2]=qa.z,Ga[Y+3]=qa.w,Ga[Y+4]=va.x,Ga[Y+5]=va.y,Ga[Y+6]=va.z,Ga[Y+7]=va.w,Ga[Y+8]=Aa.x,Ga[Y+9]=Aa.y,Ga[Y+10]=Aa.z,Ga[Y+11]=Aa.w,Ga[Y+12]=Qa.x,Ga[Y+13]=Qa.y,Ga[Y+14]=Qa.z,Ga[Y+15]=Qa.w,Y+=16;0<Y&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ga,G),k.bindBuffer(k.ARRAY_BUFFER,C.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,
Ha,G))}if(Ub&&K){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],P=O.vertexColors,W=O.color,3===P.length&&K===THREE.VertexColors?(ha=P[0],ka=P[1],pa=P[2]):pa=ka=ha=W,cb[Oa]=ha.r,cb[Oa+1]=ha.g,cb[Oa+2]=ha.b,cb[Oa+3]=ka.r,cb[Oa+4]=ka.g,cb[Oa+5]=ka.b,cb[Oa+6]=pa.r,cb[Oa+7]=pa.g,cb[Oa+8]=pa.b,Oa+=9;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],P=O.vertexColors,W=O.color,4===P.length&&K===THREE.VertexColors?(ha=P[0],ka=P[1],pa=P[2],na=P[3]):na=pa=ka=ha=W,cb[Oa]=ha.r,cb[Oa+1]=ha.g,cb[Oa+2]=ha.b,cb[Oa+3]=ka.r,cb[Oa+4]=
ka.g,cb[Oa+5]=ka.b,cb[Oa+6]=pa.r,cb[Oa+7]=pa.g,cb[Oa+8]=pa.b,cb[Oa+9]=na.r,cb[Oa+10]=na.g,cb[Oa+11]=na.b,Oa+=12;0<Oa&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,cb,G))}if(Tb&&nb.hasTangents){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Ba+=12;D=0;for(A=sa.length;D<
A;D++)O=hb[sa[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Za=V[3],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Fa[Ba+12]=Za.x,Fa[Ba+13]=Za.y,Fa[Ba+14]=Za.z,Fa[Ba+15]=Za.w,Ba+=16;k.bindBuffer(k.ARRAY_BUFFER,C.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Fa,G)}if(Pb&&L){D=0;for(A=ra.length;D<A;D++)if(O=hb[ra[D]],U=O.vertexNormals,R=O.normal,3===U.length&&M)for(wa=0;3>wa;wa++)Ma=
U[wa],yb[gb]=Ma.x,yb[gb+1]=Ma.y,yb[gb+2]=Ma.z,gb+=3;else for(wa=0;3>wa;wa++)yb[gb]=R.x,yb[gb+1]=R.y,yb[gb+2]=R.z,gb+=3;D=0;for(A=sa.length;D<A;D++)if(O=hb[sa[D]],U=O.vertexNormals,R=O.normal,4===U.length&&M)for(wa=0;4>wa;wa++)Ma=U[wa],yb[gb]=Ma.x,yb[gb+1]=Ma.y,yb[gb+2]=Ma.z,gb+=3;else for(wa=0;4>wa;wa++)yb[gb]=R.x,yb[gb+1]=R.y,yb[gb+2]=R.z,gb+=3;k.bindBuffer(k.ARRAY_BUFFER,C.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yb,G)}if(Lb&&Vb&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],Z=Vb[fa],void 0!==
Z)for(wa=0;3>wa;wa++)Ua=Z[wa],kb[Ta]=Ua.x,kb[Ta+1]=Ua.y,Ta+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],Z=Vb[fa],void 0!==Z)for(wa=0;4>wa;wa++)Ua=Z[wa],kb[Ta]=Ua.x,kb[Ta+1]=Ua.y,Ta+=2;0<Ta&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,kb,G))}if(Lb&&Pc&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],la=Pc[fa],void 0!==la)for(wa=0;3>wa;wa++)Wa=la[wa],rb[Va]=Wa.x,rb[Va+1]=Wa.y,Va+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],la=Pc[fa],void 0!==la)for(wa=0;4>wa;wa++)Wa=la[wa],rb[Va]=
Wa.x,rb[Va+1]=Wa.y,Va+=2;0<Va&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,rb,G))}if(Ob){D=0;for(A=ra.length;D<A;D++)Gb[xb]=La,Gb[xb+1]=La+1,Gb[xb+2]=La+2,xb+=3,tb[lb]=La,tb[lb+1]=La+1,tb[lb+2]=La,tb[lb+3]=La+2,tb[lb+4]=La+1,tb[lb+5]=La+2,lb+=6,La+=3;D=0;for(A=sa.length;D<A;D++)Gb[xb]=La,Gb[xb+1]=La+1,Gb[xb+2]=La+3,Gb[xb+3]=La+1,Gb[xb+4]=La+2,Gb[xb+5]=La+3,xb+=6,tb[lb]=La,tb[lb+1]=La+1,tb[lb+2]=La,tb[lb+3]=La+3,tb[lb+4]=La+1,tb[lb+5]=La+2,tb[lb+6]=La+2,tb[lb+7]=La+
3,lb+=8,La+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Gb,G);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,tb,G)}if(Db){wa=0;for($a=Db.length;wa<$a;wa++)if(v=Db[wa],v.__original.needsUpdate){w=0;if(1===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],w+=3;D=0;for(A=sa.length;D<A;D++)O=
