...
f=THREE.Matrix4.__v1,e=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();if(g.length()===0)g.z=1;f.cross(c,g).normalize();if(f.length()===0){g.x=g.x+1E-4;f.cross(c,g).normalize()}e.cross(g,f);d[0]=f.x;d[4]=e.x;d[8]=g.x;d[1]=f.y;d[5]=e.y;d[9]=g.y;d[2]=f.z;d[6]=e.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,f=this.elements,e=c[0],g=c[4],h=c[8],i=c[12],l=c[1],j=c[5],o=c[9],m=c[13],p=c[2],q=c[6],n=c[10],t=c[14],r=c[3],u=c[7],v=c[11],c=c[15],s=d[0],B=d[4],
y=d[8],A=d[12],G=d[1],x=d[5],I=d[9],F=d[13],L=d[2],H=d[6],M=d[10],C=d[14],E=d[3],P=d[7],N=d[11],d=d[15];f[0]=e*s+g*G+h*L+i*E;f[4]=e*B+g*x+h*H+i*P;f[8]=e*y+g*I+h*M+i*N;f[12]=e*A+g*F+h*C+i*d;f[1]=l*s+j*G+o*L+m*E;f[5]=l*B+j*x+o*H+m*P;f[9]=l*y+j*I+o*M+m*N;f[13]=l*A+j*F+o*C+m*d;f[2]=p*s+q*G+n*L+t*E;f[6]=p*B+q*x+n*H+t*P;f[10]=p*y+q*I+n*M+t*N;f[14]=p*A+q*F+n*C+t*d;f[3]=r*s+u*G+v*L+c*E;f[7]=r*B+u*x+v*H+c*P;f[11]=r*y+u*I+v*M+c*N;f[15]=r*A+u*F+v*C+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
a[9],a[10])},getInverse:function(a){var b=this.elements,c=a.elements,d=c[0],f=c[4],e=c[8],g=c[12],h=c[1],i=c[5],l=c[9],j=c[13],o=c[2],m=c[6],p=c[10],q=c[14],n=c[3],t=c[7],r=c[11],c=c[15];b[0]=l*q*t-j*p*t+j*m*r-i*q*r-l*m*c+i*p*c;b[4]=g*p*t-e*q*t-g*m*r+f*q*r+e*m*c-f*p*c;b[8]=e*j*t-g*l*t+g*i*r-f*j*r-e*i*c+f*l*c;b[12]=g*l*m-e*j*m-g*i*p+f*j*p+e*i*q-f*l*q;b[1]=j*p*n-l*q*n-j*o*r+h*q*r+l*o*c-h*p*c;b[5]=e*q*n-g*p*n+g*o*r-d*q*r-e*o*c+d*p*c;b[9]=g*l*n-e*j*n-g*h*r+d*j*r+e*h*c-d*l*c;b[13]=e*j*o-g*l*o+g*h*p-d*
j*p-e*h*q+d*l*q;b[2]=i*q*n-j*m*n+j*o*t-h*q*t-i*o*c+h*m*c;b[6]=g*m*n-f*q*n-g*o*t+d*q*t+f*o*c-d*m*c;b[10]=f*j*n-g*i*n+g*h*t-d*j*t-f*h*c+d*i*c;b[14]=g*i*o-f*j*o-g*h*m+d*j*m+f*h*q-d*i*q;b[3]=l*m*n-i*p*n-l*o*t+h*p*t+i*o*r-h*m*r;b[7]=f*p*n-e*m*n+e*o*t-d*p*t-f*o*r+d*m*r;b[11]=e*i*n-f*l*n-e*h*t+d*l*t+f*h*r-d*i*r;b[15]=f*l*o-e*i*o+e*h*m-d*l*m-f*h*p+d*i*p;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,f=a.y,e=a.z,g=Math.cos(d),d=Math.sin(d),
...
b);var a=l.dot(l),b=l.dot(j),c=l.dot(o),f=j.dot(j),d=j.dot(o),e=1/(a*f-b*b),f=(f*c-b*d)*e,a=(a*d-b*c)*e;return f>=0&&a>=0&&f+a<1},q=function(i,j,l){var o,n;if(i instanceof a.Particle){o=m(j.origin,j.direction,i.matrixWorld.getPosition());if(o>i.scale.x)return l;n={distance:o,point:i.position,face:null,object:i};l.push(n)}else if(i instanceof a.Mesh){var q=i.geometry.boundingSphere.radius*i.matrixWorld.getMaxScaleOnAxis();o=m(j.origin,j.direction,i.matrixWorld.getPosition());if(o>q)return l;var y,
A,G=i.geometry,x=G.vertices,I,F,L;I=i.geometry.materials;F=i.material instanceof a.MeshFaceMaterial;var H,M=j.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(j.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(j.direction);h.rotateAxis(d).normalize();q=0;for(y=G.faces.length;q<y;q++){n=G.faces[q];o=F===true?I[n.materialIndex]:i.material;if(o!==void 0){L=o.side;f.sub(n.centroid,c);e=n.normal;o=d.dot(e);if(!(Math.abs(o)<M)){A=e.dot(f)/o;if(!(A<0)&&(L===
a.DoubleSide||(L===a.FrontSide?o<0:o>0))){g.add(c,d.multiplyScalar(A));if(n instanceof a.Face3){o=x[n.a];A=x[n.b];L=x[n.c];if(p(g,o,A,L)){A=i.matrixWorld.multiplyVector3(g.clone());o=b.distanceTo(A);if(!(o<j.near||o>j.far)){n={distance:o,point:A,face:n,faceIndex:q,object:i};l.push(n)}}}else if(n instanceof a.Face4){o=x[n.a];A=x[n.b];L=x[n.c];H=x[n.d];if(p(g,o,A,H)||p(g,A,L,H)){A=i.matrixWorld.multiplyVector3(g.clone());o=b.distanceTo(A);if(!(o<j.near||o>j.far)){n={distance:o,point:A,face:n,faceIndex:q,
object:i};l.push(n)}}}}}}}}},n=function(a,b,c){for(var a=a.getDescendants(),b=0,d=a.length;b<d;b++)q(a[b],this,c)};a.Ray.prototype.precision=1E-4;a.Ray.prototype.set=function(a,b){this.origin=a;this.direction=b};a.Ray.prototype.intersectObject=function(a,b){var c=[];b===true&&n(a,this,c);q(a,this,c);c.sort(i);return c};a.Ray.prototype.intersectObjects=function(a,b){for(var c=[],d=0,f=a.length;d<f;d++){q(a[d],this,c);b===true&&n(a[d],this,c)}c.sort(i);return c}})(THREE);
...
M.multiplyVector3(L);f=a();f.object=b;f.z=L.z;F.sprites.push(f)}else b instanceof THREE.Light&&F.lights.push(b);for(var c=0,d=b.children.length;c<d;c++)pb(b.children[c])}};pb(g);g=0;for(ra=F.objects.length;g<ra;g++){pa=F.objects[g].object;ta=pa.matrixWorld;l=0;if(pa instanceof THREE.Mesh){Da=pa.geometry;Ia=pa.geometry.materials;ba=Da.vertices;Xa=Da.faces;ob=Da.faceVertexUvs;Da=pa.matrixRotationWorld.extractRotation(ta);Ya=pa.material instanceof THREE.MeshFaceMaterial;wa=0;for(ca=ba.length;wa<ca;wa++){i=
b();i.positionWorld.copy(ba[wa]);ta.multiplyVector3(i.positionWorld);i.positionScreen.copy(i.positionWorld);M.multiplyVector4(i.positionScreen);i.positionScreen.x=i.positionScreen.x/i.positionScreen.w;i.positionScreen.y=i.positionScreen.y/i.positionScreen.w;i.visible=i.positionScreen.z>K&&i.positionScreen.z<ea}ba=0;for(wa=Xa.length;ba<wa;ba++){ha=Xa[ba];ca=Ya===true?Ia[ha.materialIndex]:pa.material;if(ca!==void 0){ga=ca.side;if(ha instanceof THREE.Face3){W=j[ha.a];V=j[ha.b];ja=j[ha.c];if(W.visible===
true&&V.visible===true&&ja.visible===true){O=(ja.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(ja.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x)<0;if(ga===THREE.DoubleSide||O===(ga===THREE.FrontSide)){if(p===n){Na=new THREE.RenderableFace3;q.push(Na);n++;p++;m=Na}else m=q[p++];m.v1.copy(W);m.v2.copy(V);m.v3.copy(ja)}else continue}else continue}else if(ha instanceof THREE.Face4){W=j[ha.a];V=j[ha.b];ja=j[ha.c];Na=j[ha.d];if(W.visible===true&&
V.visible===true&&ja.visible===true&&Na.visible===true){O=(Na.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(Na.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x)<0||(V.positionScreen.x-ja.positionScreen.x)*(Na.positionScreen.y-ja.positionScreen.y)-(V.positionScreen.y-ja.positionScreen.y)*(Na.positionScreen.x-ja.positionScreen.x)<0;if(ga===THREE.DoubleSide||O===(ga===THREE.FrontSide)){if(t===u){var vb=new THREE.RenderableFace4;r.push(vb);u++;
t++;m=vb}else m=r[t++];m.v1.copy(W);m.v2.copy(V);m.v3.copy(ja);m.v4.copy(Na)}else continue}else continue}m.normalWorld.copy(ha.normal);O===false&&(ga===THREE.BackSide||ga===THREE.DoubleSide)&&m.normalWorld.negate();Da.multiplyVector3(m.normalWorld);m.centroidWorld.copy(ha.centroid);ta.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);M.multiplyVector3(m.centroidScreen);ha=ha.vertexNormals;W=0;for(V=ha.length;W<V;W++){ja=m.vertexNormalsWorld[W];ja.copy(ha[W]);O===false&&(ga===
THREE.BackSide||ga===THREE.DoubleSide)&&ja.negate();Da.multiplyVector3(ja)}m.vertexNormalsLength=ha.length;W=0;for(V=ob.length;W<V;W++){ja=ob[W][ba];if(ja!==void 0){ga=0;for(ha=ja.length;ga<ha;ga++)m.uvs[W][ga]=ja[ga]}}m.material=ca;m.z=m.centroidScreen.z;F.elements.push(m)}}}else if(pa instanceof THREE.Line){C.multiply(M,ta);ba=pa.geometry.vertices;W=b();W.positionScreen.copy(ba[0]);C.multiplyVector4(W.positionScreen);ta=pa.type===THREE.LinePieces?2:1;wa=1;for(ca=ba.length;wa<ca;wa++){W=b();W.positionScreen.copy(ba[wa]);
C.multiplyVector4(W.positionScreen);if(!((wa+1)%ta>0)){V=j[l-2];P.copy(W.positionScreen);N.copy(V.positionScreen);if(d(P,N)===true){P.multiplyScalar(1/P.w);N.multiplyScalar(1/N.w);if(s===y){Ia=new THREE.RenderableLine;B.push(Ia);y++;s++;v=Ia}else v=B[s++];v.v1.positionScreen.copy(P);v.v2.positionScreen.copy(N);v.z=Math.max(P.z,N.z);v.material=pa.material;F.elements.push(v)}}}}}g=0;for(ra=F.sprites.length;g<ra;g++){pa=F.sprites[g].object;ta=pa.matrixWorld;if(pa instanceof THREE.Particle){H.set(ta.elements[12],
ta.elements[13],ta.elements[14],1);M.multiplyVector4(H);H.z=H.z/H.w;if(H.z>0&&H.z<1){if(G===I){K=new THREE.RenderableParticle;x.push(K);I++;G++;A=K}else A=x[G++];A.object=pa;A.x=H.x/H.w;A.y=H.y/H.w;A.z=H.z;A.rotation=pa.rotation.z;A.scale.x=pa.scale.x*Math.abs(A.x-(H.x+h.projectionMatrix.elements[0])/(H.w+h.projectionMatrix.elements[12]));A.scale.y=pa.scale.y*Math.abs(A.y-(H.y+h.projectionMatrix.elements[5])/(H.w+h.projectionMatrix.elements[13]));A.material=pa.material;F.elements.push(A)}}}o&&F.elements.sort(c);
...
l=a.vertices[d];j=g[f];o=g[e];m=g[C];p=i.x-h.x;q=l.x-h.x;n=i.y-h.y;t=l.y-h.y;r=i.z-h.z;u=l.z-h.z;v=o.u-j.u;s=m.u-j.u;B=o.v-j.v;y=m.v-j.v;A=1/(v*y-s*B);F.set((y*p-B*q)*A,(y*n-B*t)*A,(y*r-B*u)*A);L.set((v*q-s*p)*A,(v*t-s*n)*A,(v*u-s*r)*A);x[b].addSelf(F);x[c].addSelf(F);x[d].addSelf(F);I[b].addSelf(L);I[c].addSelf(L);I[d].addSelf(L)}var b,c,d,f,e,g,h,i,l,j,o,m,p,q,n,t,r,u,v,s,B,y,A,G,x=[],I=[],F=new THREE.Vector3,L=new THREE.Vector3,H=new THREE.Vector3,M=new THREE.Vector3,C=new THREE.Vector3;b=0;for(c=
...
0}var f=this.offsets,e=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,l,j,o,m,p,q=new THREE.Vector3,n=new THREE.Vector3,t=new THREE.Vector3,r=new THREE.Vector3,u=new THREE.Vector3;c=0;for(d=f.length;c<d;++c){b=f[c].start;i=f[c].count;var v=f[c].index;a=b;for(b=b+i;a<b;a=a+3){i=v+e[a];l=v+e[a+1];j=v+e[a+2];o=g[i*3];m=g[i*3+1];p=g[i*3+2];q.set(o,m,p);o=g[l*3];m=g[l*3+1];p=g[l*3+2];n.set(o,m,p);o=g[j*3];m=g[j*3+1];p=g[j*3+2];t.set(o,m,p);r.sub(t,n);u.sub(q,
n);r.crossSelf(u);h[i*3]=h[i*3]+r.x;h[i*3+1]=h[i*3+1]+r.y;h[i*3+2]=h[i*3+2]+r.z;h[l*3]=h[l*3]+r.x;h[l*3+1]=h[l*3+1]+r.y;h[l*3+2]=h[l*3+2]+r.z;h[j*3]=h[j*3]+r.x;h[j*3+1]=h[j*3+1]+r.y;h[j*3+2]=h[j*3+2]+r.z}}a=0;for(b=h.length;a<b;a=a+3){o=h[a];m=h[a+1];p=h[a+2];c=1/Math.sqrt(o*o+m*m+p*p);h[a]=h[a]*c;h[a+1]=h[a+1]*c;h[a+2]=h[a+2]*c}this.normalsNeedUpdate=true}},computeTangents:function(){function a(a){Z.x=d[a*3];Z.y=d[a*3+1];Z.z=d[a*3+2];J.copy(Z);ea=i[a];N.copy(ea);N.subSelf(Z.multiplyScalar(Z.dot(ea))).normalize();
Q.cross(J,ea);O=Q.dot(l[a]);K=O<0?-1:1;h[a*4]=N.x;h[a*4+1]=N.y;h[a*4+2]=N.z;h[a*4+3]=K}if(this.attributes.index===void 0||this.attributes.position===void 0||this.attributes.normal===void 0||this.attributes.uv===void 0)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,e=c.length/3;if(this.attributes.tangent===
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],l=[],g=0;g<e;g++){i[g]=new THREE.Vector3;l[g]=new THREE.Vector3}var j,o,m,p,q,n,t,r,u,v,s,B,y,A,G,e=new THREE.Vector3,g=new THREE.Vector3,x,I,F,L,H,M,C,E=this.offsets;F=0;for(L=E.length;F<L;++F){I=E[F].start;H=E[F].count;var P=E[F].index;x=I;for(I=I+H;x<I;x=x+3){H=P+b[x];M=P+b[x+1];C=P+b[x+2];j=c[H*3];o=c[H*3+1];m=c[H*3+2];p=c[M*3];q=c[M*3+1];n=c[M*3+2];t=c[C*3];
r=c[C*3+1];u=c[C*3+2];v=f[H*2];s=f[H*2+1];B=f[M*2];y=f[M*2+1];A=f[C*2];G=f[C*2+1];p=p-j;j=t-j;q=q-o;o=r-o;n=n-m;m=u-m;B=B-v;v=A-v;y=y-s;s=G-s;G=1/(B*s-v*y);e.set((s*p-y*j)*G,(s*q-y*o)*G,(s*n-y*m)*G);g.set((B*j-v*p)*G,(B*o-v*q)*G,(B*m-v*n)*G);i[H].addSelf(e);i[M].addSelf(e);i[C].addSelf(e);l[H].addSelf(g);l[M].addSelf(g);l[C].addSelf(g)}}var N=new THREE.Vector3,Q=new THREE.Vector3,Z=new THREE.Vector3,J=new THREE.Vector3,K,ea,O;F=0;for(L=E.length;F<L;++F){I=E[F].start;H=E[F].count;P=E[F].index;x=I;
...
Math.log(a)/Math.LN2;return Math.floor(a)==a}function d(a){a=Math.log(a)/Math.LN2;return Math.pow(2,Math.round(a))}function f(a,f,e,h,i,l){var t=document.createElement("canvas");a[f]=new THREE.Texture(t);a[f].sourceFile=e;if(h){a[f].repeat.set(h[0],h[1]);if(h[0]!==1)a[f].wrapS=THREE.RepeatWrapping;if(h[1]!==1)a[f].wrapT=THREE.RepeatWrapping}i&&a[f].offset.set(i[0],i[1]);if(l){h={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(h[l[0]]!==void 0)a[f].wrapS=h[l[0]];if(h[l[1]]!==void 0)a[f].wrapT=
h[l[1]]}var r=a[f],a=b+"/"+e,f=new Image;f.onload=function(){if(!c(this.width)||!c(this.height)){var a=d(this.width),b=d(this.height);r.image.width=a;r.image.height=b;r.image.getContext("2d").drawImage(this,0,0,a,b)}else r.image=this;r.needsUpdate=true};f.crossOrigin=g.crossOrigin;f.src=a}function e(a){return(a[0]*255<<16)+(a[1]*255<<8)+a[2]*255}var g=this,h="MeshLambertMaterial",i={color:15658734,opacity:1,map:null,lightMap:null,normalMap:null,bumpMap:null,wireframe:false};if(a.shading){var l=a.shading.toLowerCase();
l==="phong"?h="MeshPhongMaterial":l==="basic"&&(h="MeshBasicMaterial")}if(a.blending!==void 0&&THREE[a.blending]!==void 0)i.blending=THREE[a.blending];if(a.transparent!==void 0||a.opacity<1)i.transparent=a.transparent;if(a.depthTest!==void 0)i.depthTest=a.depthTest;if(a.depthWrite!==void 0)i.depthWrite=a.depthWrite;if(a.visible!==void 0)i.visible=a.visible;if(a.flipSided!==void 0)i.side=THREE.BackSide;if(a.doubleSided!==void 0)i.side=THREE.DoubleSide;if(a.wireframe!==void 0)i.wireframe=a.wireframe;
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,l,j,o,m,p,q,n,t,r,u,v,s;function B(a){return a%4?4-a%4:0}function y(a,b){return(new Uint8Array(a,b,1))[0]}function A(a,b){return(new Uint32Array(a,b,1))[0]}function G(b,c){var d,f,e,g,h,i,j,l,o=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=o[d*3];e=o[d*3+1];g=o[d*3+2];h=P[f*2];f=P[f*2+1];i=P[e*2];j=P[e*2+1];e=P[g*2];l=P[g*2+1];g=M.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,j));m.push(new THREE.UV(e,
l));g.push(m)}}function x(b,c){var d,f,e,g,h,i,j,l,o,m,n=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){f=n[d*4];e=n[d*4+1];g=n[d*4+2];h=n[d*4+3];i=P[f*2];f=P[f*2+1];j=P[e*2];o=P[e*2+1];l=P[g*2];m=P[g*2+1];g=P[h*2];e=P[h*2+1];h=M.faceVertexUvs[0];var q=[];q.push(new THREE.UV(i,f));q.push(new THREE.UV(j,o));q.push(new THREE.UV(l,m));q.push(new THREE.UV(g,e));h.push(q)}}function I(b,c,d){for(var f,e,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*3];e=c[d*3+1];g=c[d*3+2];h=i[d];
M.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function F(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=j[d];M.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function L(b,c,d,f){for(var e,g,h,i,j,l,o,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];j=d[f*3];l=d[f*3+1];o=d[f*3+2];i=m[f];var n=E[l*3],q=E[l*3+1];l=E[l*3+2];var p=E[o*3],
s=E[o*3+1];o=E[o*3+2];M.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(E[j*3],E[j*3+1],E[j*3+2]),new THREE.Vector3(n,q,l),new THREE.Vector3(p,s,o)],null,i))}}function H(b,c,d,f){for(var e,g,h,i,j,l,o,m,n,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),q=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];l=d[f*4];o=d[f*4+1];m=d[f*4+2];n=d[f*4+3];j=q[f];var p=E[o*3],s=E[o*3+1];o=E[o*3+2];var r=E[m*3],t=E[m*3+1];m=E[m*3+2];var u=E[n*3],v=E[n*3+1];n=E[n*3+2];M.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(E[l*3],E[l*3+1],E[l*3+2]),new THREE.Vector3(p,s,o),new THREE.Vector3(r,t,m),new THREE.Vector3(u,v,n)],null,j))}}var M=this,C=0,E=[],P=[],N,Q,Z;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(M,d,b);s=a;Q=C;b=new Uint8Array(s,Q,12);n="";for(u=0;u<12;u++)n=n+String.fromCharCode(b[Q+u]);c=y(s,Q+12);y(s,Q+13);y(s,Q+14);y(s,Q+15);f=y(s,Q+16);i=y(s,Q+17);l=y(s,Q+18);j=y(s,Q+19);o=A(s,Q+20);m=A(s,Q+20+4);p=A(s,Q+20+8);q=A(s,Q+20+12);n=A(s,Q+20+16);t=A(s,Q+20+20);r=
A(s,Q+20+24);u=A(s,Q+20+28);b=A(s,Q+20+32);v=A(s,Q+20+36);s=A(s,Q+20+40);C=C+c;Q=f*3+j;Z=f*4+j;N=q*Q;c=n*(Q+i*3);f=t*(Q+l*3);j=r*(Q+i*3+l*3);Q=u*Z;i=b*(Z+i*4);l=v*(Z+l*4);Z=C;var C=new Float32Array(a,C,o*3),J,K,ea,O;for(J=0;J<o;J++){K=C[J*3];ea=C[J*3+1];O=C[J*3+2];M.vertices.push(new THREE.Vector3(K,ea,O))}o=C=Z+o*3*Float32Array.BYTES_PER_ELEMENT;if(m){C=new Int8Array(a,C,m*3);for(Z=0;Z<m;Z++){J=C[Z*3];K=C[Z*3+1];ea=C[Z*3+2];E.push(J/127,K/127,ea/127)}}C=o+m*3*Int8Array.BYTES_PER_ELEMENT;m=C=C+B(m*
3);if(p){C=new Float32Array(a,C,p*2);for(o=0;o<p;o++){Z=C[o*2];J=C[o*2+1];P.push(Z,J)}}p=C=m+p*2*Float32Array.BYTES_PER_ELEMENT;N=p+N+B(q*2);m=N+c+B(n*2);c=m+f+B(t*2);f=c+j+B(r*2);Q=f+Q+B(u*2);j=Q+i+B(b*2);i=j+l+B(v*2);if(t){l=m+t*Uint32Array.BYTES_PER_ELEMENT*3;I(t,m,l+t*Uint32Array.BYTES_PER_ELEMENT*3);G(t,l)}if(r){t=c+r*Uint32Array.BYTES_PER_ELEMENT*3;l=t+r*Uint32Array.BYTES_PER_ELEMENT*3;L(r,c,t,l+r*Uint32Array.BYTES_PER_ELEMENT*3);G(r,l)}if(v){r=j+v*Uint32Array.BYTES_PER_ELEMENT*4;F(v,j,r+v*
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,l,j,o,m,p,q,n,t,r,u,v=a.faces;p=a.vertices;var s=a.normals,B=a.colors,y=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&y++;for(e=0;e<y;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}c=0;for(i=p.length;c<i;){l=new THREE.Vector3;l.x=p[c++]*f;l.y=p[c++]*f;l.z=p[c++]*f;d.vertices.push(l)}c=0;for(i=v.length;c<i;){p=v[c++];l=p&1;h=p&2;e=p&4;g=p&8;o=p&
16;j=p&32;q=p&64;p=p&128;if(l){n=new THREE.Face4;n.a=v[c++];n.b=v[c++];n.c=v[c++];n.d=v[c++];l=4}else{n=new THREE.Face3;n.a=v[c++];n.b=v[c++];n.c=v[c++];l=3}if(h){h=v[c++];n.materialIndex=h}h=d.faces.length;if(e)for(e=0;e<y;e++){t=a.uvs[e];m=v[c++];u=t[m*2];m=t[m*2+1];d.faceUvs[e][h]=new THREE.UV(u,m)}if(g)for(e=0;e<y;e++){t=a.uvs[e];r=[];for(g=0;g<l;g++){m=v[c++];u=t[m*2];m=t[m*2+1];r[g]=new THREE.UV(u,m)}d.faceVertexUvs[e][h]=r}if(o){o=v[c++]*3;g=new THREE.Vector3;g.x=s[o++];g.y=s[o++];g.z=s[o];
n.normal=g}if(j)for(e=0;e<l;e++){o=v[c++]*3;g=new THREE.Vector3;g.x=s[o++];g.y=s[o++];g.z=s[o];n.vertexNormals.push(g)}if(q){j=v[c++];j=new THREE.Color(B[j]);n.color=j}if(p)for(e=0;e<l;e++){j=v[c++];j=new THREE.Color(B[j]);n.vertexColors.push(j)}d.faces.push(n)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c=c+2){v=a.skinWeights[c];s=a.skinWeights[c+1];d.skinWeights.push(new THREE.Vector4(v,s,0,0))}}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c=c+2){v=a.skinIndices[c];s=a.skinIndices[c+
1];d.skinIndices.push(new THREE.Vector4(v,s,0,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets!==void 0){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];B=d.morphTargets[c].vertices;y=a.morphTargets[c].vertices;v=0;for(s=y.length;v<s;v=v+3){p=new THREE.Vector3;p.x=y[v]*f;p.y=y[v+1]*f;p.z=y[v+2]*f;B.push(p)}}}if(a.morphColors!==void 0){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};
d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=[];s=d.morphColors[c].colors;B=a.morphColors[c].colors;f=0;for(v=B.length;f<v;f=f+3){y=new THREE.Color(16755200);y.setRGB(B[f],B[f+1],B[f+2]);s.push(y)}}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};THREE.GeometryLoader=function(){THREE.EventTarget.call(this);this.path=this.crossOrigin=null};
...
g.mapLightWrap);g.mapBump&&l(m,"bumpMap",g.mapBump,g.mapBumpRepeat,g.mapBumpOffset,g.mapBumpWrap);g.mapNormal&&l(m,"normalMap",g.mapNormal,g.mapNormalRepeat,g.mapNormalOffset,g.mapNormalWrap);g.mapSpecular&&l(m,"specularMap",g.mapSpecular,g.mapSpecularRepeat,g.mapSpecularOffset,g.mapSpecularWrap);if(g.mapNormal){l=THREE.ShaderUtils.lib.normal;j=THREE.UniformsUtils.clone(l.uniforms);j.tNormal.value=m.normalMap;if(g.mapNormalFactor)j.uNormalScale.value=g.mapNormalFactor;if(m.map){j.tDiffuse.value=m.map;
j.enableDiffuse.value=true}if(m.specularMap){j.tSpecular.value=m.specularMap;j.enableSpecular.value=true}if(m.lightMap){j.tAO.value=m.lightMap;j.enableAO.value=true}j.uDiffuseColor.value.setHex(m.color);j.uSpecularColor.value.setHex(m.specular);j.uAmbientColor.value.setHex(m.ambient);j.uShininess.value=m.shininess;if(m.opacity!==void 0)j.uOpacity.value=m.opacity;m=new THREE.ShaderMaterial({fragmentShader:l.fragmentShader,vertexShader:l.vertexShader,uniforms:j,lights:true,fog:true})}else m=new THREE[o](m);
if(g.DbgName!==void 0)m.name=g.DbgName;d.materials[e]=m}}var g=a.faces,q=a.vertices,m=a.normals,l=a.colors,j=0;if(a.uvs)for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&j++;for(e=0;e<j;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}o=0;for(p=q.length;o<p;){var n=new THREE.Vector3;n.x=q[o++]*f;n.y=q[o++]*f;n.z=q[o++]*f;d.vertices.push(n)}o=0;for(p=g.length;o<p;){var t=g[o++],r=t&2,e=t&4,u=t&8,v=t&16,q=t&32,s=t&64,n=t&128;if(t&1){t=new THREE.Face4;t.a=g[o++];t.b=g[o++];t.c=g[o++];t.d=g[o++];var B=4}else{t=new THREE.Face3;
t.a=g[o++];t.b=g[o++];t.c=g[o++];B=3}if(r){r=g[o++];t.materialIndex=r}var y=d.faces.length;if(e)for(e=0;e<j;e++){var A=a.uvs[e],r=g[o++],G=A[r*2],r=A[r*2+1];d.faceUvs[e][y]=new THREE.UV(G,r)}if(u)for(e=0;e<j;e++){for(var A=a.uvs[e],u=[],x=0;x<B;x++){r=g[o++];G=A[r*2];r=A[r*2+1];u[x]=new THREE.UV(G,r)}d.faceVertexUvs[e][y]=u}if(v){v=g[o++]*3;r=new THREE.Vector3;r.x=m[v++];r.y=m[v++];r.z=m[v];t.normal=r}if(q)for(e=0;e<B;e++){v=g[o++]*3;r=new THREE.Vector3;r.x=m[v++];r.y=m[v++];r.z=m[v];t.vertexNormals.push(r)}if(s){q=
g[o++];t.color=new THREE.Color(l[q])}if(n)for(e=0;e<B;e++){q=g[o++];t.vertexColors.push(new THREE.Color(l[q]))}d.faces.push(t)}if(a.skinWeights){e=0;for(g=a.skinWeights.length;e<g;e=e+2)d.skinWeights.push(new THREE.Vector4(a.skinWeights[e],a.skinWeights[e+1],0,0))}if(a.skinIndices){e=0;for(g=a.skinIndices.length;e<g;e=e+2){m=0;d.skinIndices.push(new THREE.Vector4(a.skinIndices[e],a.skinIndices[e+1],m,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets){e=0;for(g=a.morphTargets.length;e<
g;e++){d.morphTargets[e]={};d.morphTargets[e].name=a.morphTargets[e].name;d.morphTargets[e].vertices=[];m=d.morphTargets[e].vertices;l=a.morphTargets[e].vertices;r=0;for(j=l.length;r<j;r=r+3){n=new THREE.Vector3;n.x=l[r]*f;n.y=l[r+1]*f;n.z=l[r+2]*f;m.push(n)}}}if(a.morphColors){e=0;for(g=a.morphColors.length;e<g;e++){d.morphColors[e]={};d.morphColors[e].name=a.morphColors[e].name;d.morphColors[e].colors=[];f=d.morphColors[e].colors;l=a.morphColors[e].colors;m=0;for(j=l.length;m<j;m=m+3){o=new THREE.Color(16755200);
...
THREE.SceneLoader.prototype.createScene=function(a,b,c){function d(a,b){return b=="relativeToHTML"?a:l+"/"+a}function f(a,b){var c;for(m in b)if(J.objects[m]===void 0){r=b[m];if(r.geometry!==void 0){if(F=J.geometries[r.geometry]){c=false;L=J.materials[r.materials[0]];(c=L instanceof THREE.ShaderMaterial)&&F.computeTangents();B=r.position;y=r.rotation;A=r.quaternion;G=r.scale;u=r.matrix;A=0;r.materials.length==0&&(L=new THREE.MeshFaceMaterial);r.materials.length>1&&(L=new THREE.MeshFaceMaterial);c=
new THREE.Mesh(F,L);c.name=m;if(u){c.matrixAutoUpdate=false;c.matrix.set(u[0],u[1],u[2],u[3],u[4],u[5],u[6],u[7],u[8],u[9],u[10],u[11],u[12],u[13],u[14],u[15])}else{c.position.set(B[0],B[1],B[2]);if(A){c.quaternion.set(A[0],A[1],A[2],A[3]);c.useQuaternion=true}else c.rotation.set(y[0],y[1],y[2]);c.scale.set(G[0],G[1],G[2])}c.visible=r.visible;c.castShadow=r.castShadow;c.receiveShadow=r.receiveShadow;a.add(c);J.objects[m]=c}}else{B=r.position;y=r.rotation;A=r.quaternion;G=r.scale;A=0;c=new THREE.Object3D;
c.name=m;c.position.set(B[0],B[1],B[2]);if(A){c.quaternion.set(A[0],A[1],A[2],A[3]);c.useQuaternion=true}else c.rotation.set(y[0],y[1],y[2]);c.scale.set(G[0],G[1],G[2]);c.visible=r.visible!==void 0?r.visible:false;a.add(c);J.objects[m]=c;J.empties[m]=c}if(r.properties!==void 0)for(var d in r.properties)c.properties[d]=r.properties[d];r.children!==void 0&&f(c,r.children)}}function e(a){return function(b){J.geometries[a]=b;f(J.scene,C.objects);P=P-1;i.onLoadComplete();h()}}function g(a){return function(b){J.geometries[a]=
b}}function h(){i.callbackProgress({totalModels:Q,totalTextures:Z,loadedModels:Q-P,loadedTextures:Z-N},J);i.onLoadProgress();P===0&&N===0&&b(J)}var i=this,l=THREE.Loader.prototype.extractUrlBase(c),j,o,m,p,q,n,t,r,u,v,s,B,y,A,G,x,I,F,L,H,M,C,E,P,N,Q,Z,J;C=a;c=new THREE.BinaryLoader;E=new THREE.JSONLoader;N=P=0;J={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(C.transform){a=C.transform.position;v=C.transform.rotation;x=C.transform.scale;
a&&J.scene.position.set(a[0],a[1],a[2]);v&&J.scene.rotation.set(v[0],v[1],v[2]);x&&J.scene.scale.set(x[0],x[1],x[2]);if(a||v||x){J.scene.updateMatrix();J.scene.updateMatrixWorld()}}a=function(a){return function(){N=N-a;h();i.onLoadComplete()}};for(q in C.cameras){x=C.cameras[q];x.type==="perspective"?H=new THREE.PerspectiveCamera(x.fov,x.aspect,x.near,x.far):x.type==="ortho"&&(H=new THREE.OrthographicCamera(x.left,x.right,x.top,x.bottom,x.near,x.far));B=x.position;v=x.target;x=x.up;H.position.set(B[0],
B[1],B[2]);H.target=new THREE.Vector3(v[0],v[1],v[2]);x&&H.up.set(x[0],x[1],x[2]);J.cameras[q]=H}for(p in C.lights){v=C.lights[p];q=v.color!==void 0?v.color:16777215;H=v.intensity!==void 0?v.intensity:1;if(v.type==="directional"){B=v.direction;s=new THREE.DirectionalLight(q,H);s.position.set(B[0],B[1],B[2]);s.position.normalize()}else if(v.type==="point"){B=v.position;s=v.distance;s=new THREE.PointLight(q,H,s);s.position.set(B[0],B[1],B[2])}else v.type==="ambient"&&(s=new THREE.AmbientLight(q));J.scene.add(s);
...
"bin_mesh"||n.type=="ascii_mesh"){P=P+1;i.onLoadStart()}}Q=P;for(j in C.geometries){n=C.geometries[j];if(n.type==="cube"){F=new THREE.CubeGeometry(n.width,n.height,n.depth,n.segmentsWidth,n.segmentsHeight,n.segmentsDepth,null,n.flipped,n.sides);J.geometries[j]=F}else if(n.type==="plane"){F=new THREE.PlaneGeometry(n.width,n.height,n.segmentsWidth,n.segmentsHeight);J.geometries[j]=F}else if(n.type==="sphere"){F=new THREE.SphereGeometry(n.radius,n.segmentsWidth,n.segmentsHeight);J.geometries[j]=F}else if(n.type===
...
n.metadata=C.metadata;n&&E.createModel(n,g(j),"")}}for(t in C.textures){j=C.textures[t];if(j.url instanceof Array){N=N+j.url.length;for(n=0;n<j.url.length;n++)i.onLoadStart()}else{N=N+1;i.onLoadStart()}}Z=N;for(t in C.textures){j=C.textures[t];if(j.mapping!==void 0&&THREE[j.mapping]!==void 0)j.mapping=new THREE[j.mapping];if(j.url instanceof Array){n=j.url.length;M=[];for(c=0;c<n;c++)M[c]=d(j.url[c],C.urlBaseType);n=THREE.ImageUtils.loadTextureCube(M,j.mapping,a(n))}else{n=THREE.ImageUtils.loadTexture(d(j.url,
C.urlBaseType),j.mapping,a(1));if(THREE[j.minFilter]!==void 0)n.minFilter=THREE[j.minFilter];if(THREE[j.magFilter]!==void 0)n.magFilter=THREE[j.magFilter];if(j.repeat){n.repeat.set(j.repeat[0],j.repeat[1]);if(j.repeat[0]!==1)n.wrapS=THREE.RepeatWrapping;if(j.repeat[1]!==1)n.wrapT=THREE.RepeatWrapping}j.offset&&n.offset.set(j.offset[0],j.offset[1]);if(j.wrap){M={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(M[j.wrap[0]]!==void 0)n.wrapS=M[j.wrap[0]];if(M[j.wrap[1]]!==void 0)n.wrapT=
M[j.wrap[1]]}}J.textures[t]=n}for(o in C.materials){u=C.materials[o];for(I in u.parameters)if(I==="envMap"||I==="map"||I==="lightMap")u.parameters[I]=J.textures[u.parameters[I]];else if(I==="shading")u.parameters[I]=u.parameters[I]=="flat"?THREE.FlatShading:THREE.SmoothShading;else if(I==="blending")u.parameters[I]=u.parameters[I]in THREE?THREE[u.parameters[I]]:THREE.NormalBlending;else if(I==="combine")u.parameters[I]=u.parameters[I]=="MixOperation"?THREE.MixOperation:THREE.MultiplyOperation;else if(I===
"vertexColors")if(u.parameters[I]=="face")u.parameters[I]=THREE.FaceColors;else if(u.parameters[I])u.parameters[I]=THREE.VertexColors;if(u.parameters.opacity!==void 0&&u.parameters.opacity<1)u.parameters.transparent=true;if(u.parameters.normalMap){t=THREE.ShaderUtils.lib.normal;a=THREE.UniformsUtils.clone(t.uniforms);j=u.parameters.color;n=u.parameters.specular;M=u.parameters.ambient;c=u.parameters.shininess;a.tNormal.value=J.textures[u.parameters.normalMap];if(u.parameters.normalMapFactor)a.uNormalScale.value=
u.parameters.normalMapFactor;if(u.parameters.map){a.tDiffuse.value=u.parameters.map;a.enableDiffuse.value=true}if(u.parameters.lightMap){a.tAO.value=u.parameters.lightMap;a.enableAO.value=true}if(u.parameters.specularMap){a.tSpecular.value=J.textures[u.parameters.specularMap];a.enableSpecular.value=true}a.uDiffuseColor.value.setHex(j);a.uSpecularColor.value.setHex(n);a.uAmbientColor.value.setHex(M);a.uShininess.value=c;if(u.parameters.opacity)a.uOpacity.value=u.parameters.opacity;L=new THREE.ShaderMaterial({fragmentShader:t.fragmentShader,
...
THREE.CanvasRenderer=function(a){function b(a){if(u!==a)u=n.globalAlpha=a}function c(a){if(v!==a){if(a===THREE.NormalBlending)n.globalCompositeOperation="source-over";else if(a===THREE.AdditiveBlending)n.globalCompositeOperation="lighter";else if(a===THREE.SubtractiveBlending)n.globalCompositeOperation="darker";v=a}}function d(a){if(s!==a)s=n.strokeStyle=a}function f(a){if(B!==a)B=n.fillStyle=a}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},e=this,g,h,i,l=new THREE.Projector,j=a.canvas!==
void 0?a.canvas:document.createElement("canvas"),o,m,p,q,n=j.getContext("2d"),t=new THREE.Color(0),r=0,u=1,v=0,s=null,B=null,y=null,A=null,G=null,x,I,F,L,H=new THREE.RenderableVertex,M=new THREE.RenderableVertex,C,E,P,N,Q,Z,J,K,ea,O,ra,wa,ca=new THREE.Color,ba=new THREE.Color,W=new THREE.Color,V=new THREE.Color,ga=new THREE.Color,ha=[],pa=[],ta,Da,Ia,Xa,ja,ob,Na,Ya,pb,vb,fb=new THREE.Rectangle,Fa=new THREE.Rectangle,ya=new THREE.Rectangle,wb=false,Ga=new THREE.Color,$a=new THREE.Color,qb=new THREE.Color,
Ea=new THREE.Vector3,ab,bb,Ob,Oa,Pa,gb,a=16;ab=document.createElement("canvas");ab.width=ab.height=2;bb=ab.getContext("2d");bb.fillStyle="rgba(0,0,0,1)";bb.fillRect(0,0,2,2);Ob=bb.getImageData(0,0,2,2);Oa=Ob.data;Pa=document.createElement("canvas");Pa.width=Pa.height=a;gb=Pa.getContext("2d");gb.translate(-a/2,-a/2);gb.scale(a,a);a--;this.domElement=j;this.sortElements=this.sortObjects=this.autoClear=true;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){o=a;m=b;p=Math.floor(o/2);
q=Math.floor(m/2);j.width=o;j.height=m;fb.set(-p,-q,p,q);Fa.set(-p,-q,p,q);u=1;v=0;G=A=y=B=s=null};this.setClearColor=function(a,b){t.copy(a);r=b!==void 0?b:1;Fa.set(-p,-q,p,q)};this.setClearColorHex=function(a,b){t.setHex(a);r=b!==void 0?b:1;Fa.set(-p,-q,p,q)};this.clear=function(){n.setTransform(1,0,0,-1,p,q);if(Fa.isEmpty()===false){Fa.minSelf(fb);Fa.inflate(2);r<1&&n.clearRect(Math.floor(Fa.getX()),Math.floor(Fa.getY()),Math.floor(Fa.getWidth()),Math.floor(Fa.getHeight()));if(r>0){c(THREE.NormalBlending);
b(1);f("rgba("+Math.floor(t.r*255)+","+Math.floor(t.g*255)+","+Math.floor(t.b*255)+","+r+")");n.fillRect(Math.floor(Fa.getX()),Math.floor(Fa.getY()),Math.floor(Fa.getWidth()),Math.floor(Fa.getHeight()))}Fa.empty()}};this.render=function(a,k){function j(a,b,c){for(var d=0,f=i.length;d<f;d++){var e=i[d],g=e.color;if(e instanceof THREE.DirectionalLight){var h=e.matrixWorld.getPosition().normalize(),k=b.dot(h);if(!(k<=0)){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}else if(e instanceof
THREE.PointLight){h=e.matrixWorld.getPosition();k=b.dot(Ea.sub(h,a).normalize());if(!(k<=0)){k=k*(e.distance==0?1:1-Math.min(a.distanceTo(h)/e.distance,1));if(k!=0){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}}}}function o(a,d,f,g,h,i,l,n){e.info.render.vertices=e.info.render.vertices+3;e.info.render.faces++;b(n.opacity);c(n.blending);C=a.positionScreen.x;E=a.positionScreen.y;P=d.positionScreen.x;N=d.positionScreen.y;Q=f.positionScreen.x;Z=f.positionScreen.y;m(C,E,P,N,Q,Z);if(n instanceof
THREE.MeshBasicMaterial)if(n.map!==null){if(n.map.mapping instanceof THREE.UVMapping){Xa=l.uvs[0];u(C,E,P,N,Q,Z,Xa[g].u,Xa[g].v,Xa[h].u,Xa[h].v,Xa[i].u,Xa[i].v,n.map)}}else if(n.envMap!==null){if(n.envMap.mapping instanceof THREE.SphericalReflectionMapping){a=k.matrixWorldInverse;Ea.copy(l.vertexNormalsWorld[g]);ja=(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;ob=(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;Ea.copy(l.vertexNormalsWorld[h]);Na=(Ea.x*a.elements[0]+
Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;Ya=(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;Ea.copy(l.vertexNormalsWorld[i]);pb=(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;vb=(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;u(C,E,P,N,Q,Z,ja,ob,Na,Ya,pb,vb,n.envMap)}}else n.wireframe===true?r(n.color,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):t(n.color);else if(n instanceof THREE.MeshLambertMaterial)if(wb===true)if(n.wireframe===
false&&n.shading==THREE.SmoothShading&&l.vertexNormalsLength==3){ba.r=W.r=V.r=Ga.r;ba.g=W.g=V.g=Ga.g;ba.b=W.b=V.b=Ga.b;j(l.v1.positionWorld,l.vertexNormalsWorld[0],ba);j(l.v2.positionWorld,l.vertexNormalsWorld[1],W);j(l.v3.positionWorld,l.vertexNormalsWorld[2],V);ba.r=Math.max(0,Math.min(n.color.r*ba.r,1));ba.g=Math.max(0,Math.min(n.color.g*ba.g,1));ba.b=Math.max(0,Math.min(n.color.b*ba.b,1));W.r=Math.max(0,Math.min(n.color.r*W.r,1));W.g=Math.max(0,Math.min(n.color.g*W.g,1));W.b=Math.max(0,Math.min(n.color.b*
W.b,1));V.r=Math.max(0,Math.min(n.color.r*V.r,1));V.g=Math.max(0,Math.min(n.color.g*V.g,1));V.b=Math.max(0,Math.min(n.color.b*V.b,1));ga.r=(W.r+V.r)*0.5;ga.g=(W.g+V.g)*0.5;ga.b=(W.b+V.b)*0.5;Ia=Ec(ba,W,V,ga);ua(C,E,P,N,Q,Z,0,0,1,0,0,1,Ia)}else{ca.r=Ga.r;ca.g=Ga.g;ca.b=Ga.b;j(l.centroidWorld,l.normalWorld,ca);ca.r=Math.max(0,Math.min(n.color.r*ca.r,1));ca.g=Math.max(0,Math.min(n.color.g*ca.g,1));ca.b=Math.max(0,Math.min(n.color.b*ca.b,1));n.wireframe===true?r(ca,n.wireframeLinewidth,n.wireframeLinecap,
n.wireframeLinejoin):t(ca)}else n.wireframe===true?r(n.color,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):t(n.color);else if(n instanceof THREE.MeshDepthMaterial){ta=k.near;Da=k.far;ba.r=ba.g=ba.b=1-ec(a.positionScreen.z,ta,Da);W.r=W.g=W.b=1-ec(d.positionScreen.z,ta,Da);V.r=V.g=V.b=1-ec(f.positionScreen.z,ta,Da);ga.r=(W.r+V.r)*0.5;ga.g=(W.g+V.g)*0.5;ga.b=(W.b+V.b)*0.5;Ia=Ec(ba,W,V,ga);ua(C,E,P,N,Q,Z,0,0,1,0,0,1,Ia)}else if(n instanceof THREE.MeshNormalMaterial){ca.r=xb(l.normalWorld.x);
ca.g=xb(l.normalWorld.y);ca.b=xb(l.normalWorld.z);n.wireframe===true?r(ca,n.wireframeLinewidth,n.wireframeLinecap,n.wireframeLinejoin):t(ca)}}function m(a,b,c,d,f,e){n.beginPath();n.moveTo(a,b);n.lineTo(c,d);n.lineTo(f,e);n.closePath()}function s(a,b,c,d,f,e,g,h){n.beginPath();n.moveTo(a,b);n.lineTo(c,d);n.lineTo(f,e);n.lineTo(g,h);n.closePath()}function r(a,b,c,f){if(y!==b)y=n.lineWidth=b;if(A!==c)A=n.lineCap=c;if(G!==f)G=n.lineJoin=f;d(a.getContextStyle());n.stroke();ya.inflate(b*2)}function t(a){f(a.getContextStyle());
n.fill()}function u(a,b,c,d,e,g,h,i,k,j,l,o,m){if(!(m.image===void 0||m.image.width===0)){if(m.needsUpdate===true||ha[m.id]===void 0){var ua=m.wrapS==THREE.RepeatWrapping,q=m.wrapT==THREE.RepeatWrapping;ha[m.id]=n.createPattern(m.image,ua===true&&q===true?"repeat":ua===true&&q===false?"repeat-x":ua===false&&q===true?"repeat-y":"no-repeat");m.needsUpdate=false}f(ha[m.id]);var ua=m.offset.x/m.repeat.x,q=m.offset.y/m.repeat.y,p=m.image.width*m.repeat.x,xb=m.image.height*m.repeat.y,h=(h+ua)*p,i=(1-i+
q)*xb,c=c-a,d=d-b,e=e-a,g=g-b,k=(k+ua)*p-h,j=(1-j+q)*xb-i,l=(l+ua)*p-h,o=(1-o+q)*xb-i,ua=k*o-l*j;if(ua===0){if(pa[m.id]===void 0){b=document.createElement("canvas");b.width=m.image.width;b.height=m.image.height;b=b.getContext("2d");b.drawImage(m.image,0,0);pa[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data}b=pa[m.id];h=(Math.floor(h)+Math.floor(i)*m.image.width)*4;ca.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255);t(ca)}else{ua=1/ua;m=(o*c-j*e)*ua;j=(o*d-j*g)*ua;c=(k*e-l*c)*ua;d=(k*g-l*d)*ua;a=
a-m*h-c*i;h=b-j*h-d*i;n.save();n.transform(m,j,c,d,a,h);n.fill();n.restore()}}}function ua(a,b,c,d,f,e,g,h,i,k,j,l,m){var o,ua;o=m.width-1;ua=m.height-1;g=g*o;h=h*ua;c=c-a;d=d-b;f=f-a;e=e-b;i=i*o-g;k=k*ua-h;j=j*o-g;l=l*ua-h;ua=1/(i*l-j*k);o=(l*c-k*f)*ua;k=(l*d-k*e)*ua;c=(i*f-j*c)*ua;d=(i*e-j*d)*ua;a=a-o*g-c*h;b=b-k*g-d*h;n.save();n.transform(o,k,c,d,a,b);n.clip();n.drawImage(m,0,0);n.restore()}function Ec(a,b,c,d){var f=a.r*255|0,e=a.g*255|0,a=a.b*255|0,g=b.r*255|0,h=b.g*255|0,b=b.b*255|0,i=c.r*255|
0,k=c.g*255|0,c=c.b*255|0,j=d.r*255|0,l=d.g*255|0,d=d.b*255|0;Oa[0]=f<0?0:f>255?255:f;Oa[1]=e<0?0:e>255?255:e;Oa[2]=a<0?0:a>255?255:a;Oa[4]=g<0?0:g>255?255:g;Oa[5]=h<0?0:h>255?255:h;Oa[6]=b<0?0:b>255?255:b;Oa[8]=i<0?0:i>255?255:i;Oa[9]=k<0?0:k>255?255:k;Oa[10]=c<0?0:c>255?255:c;Oa[12]=j<0?0:j>255?255:j;Oa[13]=l<0?0:l>255?255:l;Oa[14]=d<0?0:d>255?255:d;bb.putImageData(Ob,0,0);gb.drawImage(ab,0,0);return Pa}function ec(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function xb(a){a=(a+1)*0.5;return a<0?0:
a>1?1:a}function v(a,b){var c=b.x-a.x,d=b.y-a.y,f=c*c+d*d;if(f!==0){f=1/Math.sqrt(f);c=c*f;d=d*f;b.x=b.x+c;b.y=b.y+d;a.x=a.x-c;a.y=a.y-d}}if(k instanceof THREE.Camera===false)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{var Vb,B,la,X;this.autoClear===true?this.clear():n.setTransform(1,0,0,-1,p,q);e.info.render.vertices=0;e.info.render.faces=0;g=l.projectScene(a,k,this.sortElements);h=g.elements;i=g.lights;wb=i.length>0;if(wb===true){Ga.setRGB(0,0,0);
$a.setRGB(0,0,0);qb.setRGB(0,0,0);Vb=0;for(B=i.length;Vb<B;Vb++){X=i[Vb];var ia=X.color;if(X instanceof THREE.AmbientLight){Ga.r=Ga.r+ia.r;Ga.g=Ga.g+ia.g;Ga.b=Ga.b+ia.b}else if(X instanceof THREE.DirectionalLight){$a.r=$a.r+ia.r;$a.g=$a.g+ia.g;$a.b=$a.b+ia.b}else if(X instanceof THREE.PointLight){qb.r=qb.r+ia.r;qb.g=qb.g+ia.g;qb.b=qb.b+ia.b}}}Vb=0;for(B=h.length;Vb<B;Vb++){la=h[Vb];X=la.material;if(!(X===void 0||X.visible===false)){ya.empty();if(la instanceof THREE.RenderableParticle){x=la;x.x=x.x*
p;x.y=x.y*q;var ia=x,Wa=la;b(X.opacity);c(X.blending);var rb=void 0,sb=void 0,ib=void 0,jb=void 0,jc=la=void 0,Tc=void 0;if(X instanceof THREE.ParticleBasicMaterial)if(X.map===null){ib=Wa.object.scale.x;jb=Wa.object.scale.y;ib=ib*Wa.scale.x*p;jb=jb*Wa.scale.y*q;ya.set(ia.x-ib,ia.y-jb,ia.x+ib,ia.y+jb);if(fb.intersects(ya)!==false){f(X.color.getContextStyle());n.save();n.translate(ia.x,ia.y);n.rotate(-Wa.rotation);n.scale(ib,jb);n.fillRect(-1,-1,2,2);n.restore()}}else{la=X.map.image;jc=la.width>>1;
Tc=la.height>>1;ib=Wa.scale.x*p;jb=Wa.scale.y*q;rb=ib*jc;sb=jb*Tc;ya.set(ia.x-rb,ia.y-sb,ia.x+rb,ia.y+sb);if(fb.intersects(ya)!==false){n.save();n.translate(ia.x,ia.y);n.rotate(-Wa.rotation);n.scale(ib,-jb);n.translate(-jc,-Tc);n.drawImage(la,0,0);n.restore()}}else if(X instanceof THREE.ParticleCanvasMaterial){rb=Wa.scale.x*p;sb=Wa.scale.y*q;ya.set(ia.x-rb,ia.y-sb,ia.x+rb,ia.y+sb);if(fb.intersects(ya)!==false){d(X.color.getContextStyle());f(X.color.getContextStyle());n.save();n.translate(ia.x,ia.y);
n.rotate(-Wa.rotation);n.scale(rb,sb);X.program(n);n.restore()}}}else if(la instanceof THREE.RenderableLine){x=la.v1;I=la.v2;x.positionScreen.x=x.positionScreen.x*p;x.positionScreen.y=x.positionScreen.y*q;I.positionScreen.x=I.positionScreen.x*p;I.positionScreen.y=I.positionScreen.y*q;ya.addPoint(x.positionScreen.x,x.positionScreen.y);ya.addPoint(I.positionScreen.x,I.positionScreen.y);if(fb.intersects(ya)===true){ia=x;Wa=I;b(X.opacity);c(X.blending);n.beginPath();n.moveTo(ia.positionScreen.x,ia.positionScreen.y);
n.lineTo(Wa.positionScreen.x,Wa.positionScreen.y);if(X instanceof THREE.LineBasicMaterial){ia=X.linewidth;if(y!==ia)y=n.lineWidth=ia;ia=X.linecap;if(A!==ia)A=n.lineCap=ia;ia=X.linejoin;if(G!==ia)G=n.lineJoin=ia;d(X.color.getContextStyle());n.stroke();ya.inflate(X.linewidth*2)}}}else if(la instanceof THREE.RenderableFace3){x=la.v1;I=la.v2;F=la.v3;x.positionScreen.x=x.positionScreen.x*p;x.positionScreen.y=x.positionScreen.y*q;I.positionScreen.x=I.positionScreen.x*p;I.positionScreen.y=I.positionScreen.y*
q;F.positionScreen.x=F.positionScreen.x*p;F.positionScreen.y=F.positionScreen.y*q;if(X.overdraw===true){v(x.positionScreen,I.positionScreen);v(I.positionScreen,F.positionScreen);v(F.positionScreen,x.positionScreen)}ya.add3Points(x.positionScreen.x,x.positionScreen.y,I.positionScreen.x,I.positionScreen.y,F.positionScreen.x,F.positionScreen.y);fb.intersects(ya)===true&&o(x,I,F,0,1,2,la,X,a)}else if(la instanceof THREE.RenderableFace4){x=la.v1;I=la.v2;F=la.v3;L=la.v4;x.positionScreen.x=x.positionScreen.x*
p;x.positionScreen.y=x.positionScreen.y*q;I.positionScreen.x=I.positionScreen.x*p;I.positionScreen.y=I.positionScreen.y*q;F.positionScreen.x=F.positionScreen.x*p;F.positionScreen.y=F.positionScreen.y*q;L.positionScreen.x=L.positionScreen.x*p;L.positionScreen.y=L.positionScreen.y*q;H.positionScreen.copy(I.positionScreen);M.positionScreen.copy(L.positionScreen);if(X.overdraw===true){v(x.positionScreen,I.positionScreen);v(I.positionScreen,L.positionScreen);v(L.positionScreen,x.positionScreen);v(F.positionScreen,
H.positionScreen);v(F.positionScreen,M.positionScreen)}ya.addPoint(x.positionScreen.x,x.positionScreen.y);ya.addPoint(I.positionScreen.x,I.positionScreen.y);ya.addPoint(F.positionScreen.x,F.positionScreen.y);ya.addPoint(L.positionScreen.x,L.positionScreen.y);if(fb.intersects(ya)===true){ia=x;Wa=I;rb=F;sb=L;ib=H;jb=M;jc=a;e.info.render.vertices=e.info.render.vertices+4;e.info.render.faces++;b(X.opacity);c(X.blending);if(X.map!==void 0&&X.map!==null||X.envMap!==void 0&&X.envMap!==null){o(ia,Wa,sb,0,
1,3,la,X,jc);o(ib,rb,jb,1,2,3,la,X,jc)}else{C=ia.positionScreen.x;E=ia.positionScreen.y;P=Wa.positionScreen.x;N=Wa.positionScreen.y;Q=rb.positionScreen.x;Z=rb.positionScreen.y;J=sb.positionScreen.x;K=sb.positionScreen.y;ea=ib.positionScreen.x;O=ib.positionScreen.y;ra=jb.positionScreen.x;wa=jb.positionScreen.y;if(X instanceof THREE.MeshBasicMaterial){s(C,E,P,N,Q,Z,J,K);X.wireframe===true?r(X.color,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):t(X.color)}else if(X instanceof THREE.MeshLambertMaterial)if(wb===
true)if(X.wireframe===false&&X.shading==THREE.SmoothShading&&la.vertexNormalsLength==4){ba.r=W.r=V.r=ga.r=Ga.r;ba.g=W.g=V.g=ga.g=Ga.g;ba.b=W.b=V.b=ga.b=Ga.b;j(la.v1.positionWorld,la.vertexNormalsWorld[0],ba);j(la.v2.positionWorld,la.vertexNormalsWorld[1],W);j(la.v4.positionWorld,la.vertexNormalsWorld[3],V);j(la.v3.positionWorld,la.vertexNormalsWorld[2],ga);ba.r=Math.max(0,Math.min(X.color.r*ba.r,1));ba.g=Math.max(0,Math.min(X.color.g*ba.g,1));ba.b=Math.max(0,Math.min(X.color.b*ba.b,1));W.r=Math.max(0,
Math.min(X.color.r*W.r,1));W.g=Math.max(0,Math.min(X.color.g*W.g,1));W.b=Math.max(0,Math.min(X.color.b*W.b,1));V.r=Math.max(0,Math.min(X.color.r*V.r,1));V.g=Math.max(0,Math.min(X.color.g*V.g,1));V.b=Math.max(0,Math.min(X.color.b*V.b,1));ga.r=Math.max(0,Math.min(X.color.r*ga.r,1));ga.g=Math.max(0,Math.min(X.color.g*ga.g,1));ga.b=Math.max(0,Math.min(X.color.b*ga.b,1));Ia=Ec(ba,W,V,ga);m(C,E,P,N,J,K);ua(C,E,P,N,J,K,0,0,1,0,0,1,Ia);m(ea,O,Q,Z,ra,wa);ua(ea,O,Q,Z,ra,wa,1,0,1,1,0,1,Ia)}else{ca.r=Ga.r;ca.g=
Ga.g;ca.b=Ga.b;j(la.centroidWorld,la.normalWorld,ca);ca.r=Math.max(0,Math.min(X.color.r*ca.r,1));ca.g=Math.max(0,Math.min(X.color.g*ca.g,1));ca.b=Math.max(0,Math.min(X.color.b*ca.b,1));s(C,E,P,N,Q,Z,J,K);X.wireframe===true?r(ca,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):t(ca)}else{s(C,E,P,N,Q,Z,J,K);X.wireframe===true?r(X.color,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):t(X.color)}else if(X instanceof THREE.MeshNormalMaterial){ca.r=xb(la.normalWorld.x);ca.g=xb(la.normalWorld.y);
ca.b=xb(la.normalWorld.z);s(C,E,P,N,Q,Z,J,K);X.wireframe===true?r(ca,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):t(ca)}else if(X instanceof THREE.MeshDepthMaterial){ta=k.near;Da=k.far;ba.r=ba.g=ba.b=1-ec(ia.positionScreen.z,ta,Da);W.r=W.g=W.b=1-ec(Wa.positionScreen.z,ta,Da);V.r=V.g=V.b=1-ec(sb.positionScreen.z,ta,Da);ga.r=ga.g=ga.b=1-ec(rb.positionScreen.z,ta,Da);Ia=Ec(ba,W,V,ga);m(C,E,P,N,J,K);ua(C,E,P,N,J,K,0,0,1,0,0,1,Ia);m(ea,O,Q,Z,ra,wa);ua(ea,O,Q,Z,ra,wa,1,0,1,1,0,1,Ia)}}}}Fa.addRectangle(ya)}}n.setTransform(1,
0,0,1,0,0)}}};
...
c,d;for(b in a.attributes){d=b==="index"?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;c=a.attributes[b];c.buffer=k.createBuffer();k.bindBuffer(d,c.buffer);k.bufferData(d,c.array,k.STATIC_DRAW)}}function g(a,b,c){var d,f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,o=a.verticesNeedUpdate,q=a.colorsNeedUpdate,p=a.__webglCustomAttributesList;if(c.sortParticles){Ob.copy(bb);Ob.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];Oa.copy(f);Ob.multiplyVector3(Oa);
n[d]=[Oa.z,d]}n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[n[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[n[d][1]];m[e]=f.r;m[e+1]=f.g;m[e+2]=f.b}if(p){i=0;for(j=p.length;i<j;i++){h=p[i];if(h.boundTo===void 0||h.boundTo==="vertices"){e=0;f=h.value.length;if(h.size===1)for(d=0;d<f;d++){g=n[d][1];h.array[d]=h.value[g]}else if(h.size===2)for(d=0;d<f;d++){g=n[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;e=e+2}else if(h.size===3)if(h.type==="c")for(d=0;d<
...
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(gb){for(var l=0,m=0,n=0,o,q,p,s,r=qc,t=r.directional.colors,u=r.directional.positions,x=r.point.colors,A=r.point.positions,C=r.point.distances,G=r.spot.colors,F=r.spot.positions,K=r.spot.distances,E=r.spot.directions,J=r.spot.angles,L=r.spot.exponents,N=r.hemi.skyColors,V=r.hemi.groundColors,P=r.hemi.positions,Q=0,ba=0,Z=0,ea=0,c=o=p=p=q=0,e=b.length;c<e;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=
j.color;s=j.intensity;q=j.distance;if(j instanceof THREE.AmbientLight)if(O.gammaInput){l=l+o.r*o.r;m=m+o.g*o.g;n=n+o.b*o.b}else{l=l+o.r;m=m+o.g;n=n+o.b}else if(j instanceof THREE.DirectionalLight){q=Q*3;O.gammaInput?B(t,q,o,s*s):y(t,q,o,s);Pa.copy(j.matrixWorld.getPosition());Pa.subSelf(j.target.matrixWorld.getPosition());Pa.normalize();u[q]=Pa.x;u[q+1]=Pa.y;u[q+2]=Pa.z;Q=Q+1}else if(j instanceof THREE.PointLight){p=ba*3;O.gammaInput?B(x,p,o,s*s):y(x,p,o,s);s=j.matrixWorld.getPosition();A[p]=s.x;
A[p+1]=s.y;A[p+2]=s.z;C[ba]=q;ba=ba+1}else if(j instanceof THREE.SpotLight){p=Z*3;O.gammaInput?B(G,p,o,s*s):y(G,p,o,s);s=j.matrixWorld.getPosition();F[p]=s.x;F[p+1]=s.y;F[p+2]=s.z;K[Z]=q;Pa.copy(s);Pa.subSelf(j.target.matrixWorld.getPosition());Pa.normalize();E[p]=Pa.x;E[p+1]=Pa.y;E[p+2]=Pa.z;J[Z]=Math.cos(j.angle);L[Z]=j.exponent;Z=Z+1}else if(j instanceof THREE.HemisphereLight){q=j.color;p=j.groundColor;o=ea*3;if(O.gammaInput){s=s*s;B(N,o,q,s);B(V,o,p,s)}else{y(N,o,q,s);y(V,o,p,s)}s=j.matrixWorld.getPosition();
...
null&&k.uniformMatrix4fv(h.viewMatrix,false,a._viewMatrixArray)}k.uniformMatrix4fv(h.modelViewMatrix,false,f._modelViewMatrix.elements);h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,false,f._normalMatrix.elements);h.modelMatrix!==null&&k.uniformMatrix4fv(h.modelMatrix,false,f.matrixWorld.elements);return g}function v(){var a=pa;a>=rc&&console.warn("Trying to use "+a+" texture units while this GPU supports only "+rc);pa=pa+1;return a}function s(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,
a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function B(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function y(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function A(a,b,c){if(pb!==a){a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL);pb=a}if(a&&(vb!==b||fb!==c)){k.polygonOffset(b,c);vb=b;fb=c}}function G(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function x(a,b){var c;a==="fragment"?
...
THREE.AddEquation?k.FUNC_ADD:a===THREE.SubtractEquation?k.FUNC_SUBTRACT:a===THREE.ReverseSubtractEquation?k.FUNC_REVERSE_SUBTRACT:a===THREE.ZeroFactor?k.ZERO:a===THREE.OneFactor?k.ONE:a===THREE.SrcColorFactor?k.SRC_COLOR:a===THREE.OneMinusSrcColorFactor?k.ONE_MINUS_SRC_COLOR:a===THREE.SrcAlphaFactor?k.SRC_ALPHA:a===THREE.OneMinusSrcAlphaFactor?k.ONE_MINUS_SRC_ALPHA:a===THREE.DstAlphaFactor?k.DST_ALPHA:a===THREE.OneMinusDstAlphaFactor?k.ONE_MINUS_DST_ALPHA:a===THREE.DstColorFactor?k.DST_COLOR:a===
THREE.OneMinusDstColorFactor?k.ONE_MINUS_DST_COLOR:a===THREE.SrcAlphaSaturateFactor?k.SRC_ALPHA_SATURATE:0}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},M=a.canvas!==void 0?a.canvas:document.createElement("canvas"),C=a.precision!==void 0?a.precision:"highp",E=a.alpha!==void 0?a.alpha:true,P=a.premultipliedAlpha!==void 0?a.premultipliedAlpha:true,N=a.antialias!==void 0?a.antialias:false,Q=a.stencil!==void 0?a.stencil:true,Z=a.preserveDrawingBuffer!==void 0?a.preserveDrawingBuffer:false,
J=a.clearColor!==void 0?new THREE.Color(a.clearColor):new THREE.Color(0),K=a.clearAlpha!==void 0?a.clearAlpha:0,ea=a.maxLights!==void 0?a.maxLights:4;this.domElement=M;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=this.autoClear=true;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=false;this.shadowMapCullFrontFaces=this.shadowMapSoft=this.shadowMapAutoUpdate=true;this.shadowMapCascade=
this.shadowMapDebug=false;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=true;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var O=this,ra=[],wa=0,ca=null,ba=null,W=-1,V=null,ga=null,ha=0,pa=0,ta=-1,Da=-1,Ia=-1,Xa=-1,ja=-1,ob=-1,Na=-1,Ya=-1,pb=null,vb=null,fb=null,Fa=null,ya=0,wb=0,Ga=0,$a=0,qb=0,Ea=0,ab=new THREE.Frustum,bb=new THREE.Matrix4,Ob=new THREE.Matrix4,Oa=new THREE.Vector4,
Pa=new THREE.Vector3,gb=true,qc={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],angles:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Pb;try{if(!(k=M.getContext("experimental-webgl",{alpha:E,premultipliedAlpha:P,antialias:N,stencil:Q,preserveDrawingBuffer:Z})))throw"Error creating WebGL context.";}catch(Rc){console.error(Rc)}a=k.getExtension("OES_texture_float");
E=k.getExtension("OES_standard_derivatives");Pb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");a||console.log("THREE.WebGLRenderer: Float textures not supported.");E||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");Pb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);
k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(J.r,J.g,J.b,K);this.context=k;var rc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),E=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Sc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),Dc=Pb?k.getParameter(Pb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,ic=E>0,dc=ic&&a;this.getContext=function(){return k};
this.supportsVertexTextures=function(){return ic};this.getMaxAnisotropy=function(){return Dc};this.setSize=function(a,b){M.width=a;M.height=b;this.setViewport(0,0,M.width,M.height)};this.setViewport=function(a,b,c,d){ya=a!==void 0?a:0;wb=b!==void 0?b:0;Ga=c!==void 0?c:M.width;$a=d!==void 0?d:M.height;k.viewport(ya,wb,Ga,$a)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,
b){J.setHex(a);K=b;k.clearColor(J.r,J.g,J.b,K)};this.setClearColor=function(a,b){J.copy(a);K=b;k.clearColor(J.r,J.g,J.b,K)};this.getClearColor=function(){return J};this.getClearAlpha=function(){return K};this.clear=function(a,b,c){var d=0;if(a===void 0||a)d=d|k.COLOR_BUFFER_BIT;if(b===void 0||b)d=d|k.DEPTH_BUFFER_BIT;if(c===void 0||c)d=d|k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};
...
e.__webglSkinWeightsBuffer);k.vertexAttribPointer(b.skinWeight,4,k.FLOAT,false,0,0)}}if(f instanceof THREE.Mesh){if(d.wireframe){d=d.wireframeLinewidth;if(d!==Fa){k.lineWidth(d);Fa=d}a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglLineBuffer);k.drawElements(k.LINES,e.__webglLineCount,k.UNSIGNED_SHORT,0)}else{a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglFaceBuffer);k.drawElements(k.TRIANGLES,e.__webglFaceCount,k.UNSIGNED_SHORT,0)}O.info.render.calls++;O.info.render.vertices=O.info.render.vertices+
e.__webglFaceCount;O.info.render.faces=O.info.render.faces+e.__webglFaceCount/3}else if(f instanceof THREE.Line){f=f.type===THREE.LineStrip?k.LINE_STRIP:k.LINES;d=d.linewidth;if(d!==Fa){k.lineWidth(d);Fa=d}k.drawArrays(f,0,e.__webglLineCount);O.info.render.calls++}else if(f instanceof THREE.ParticleSystem){k.drawArrays(k.POINTS,0,e.__webglParticleCount);O.info.render.calls++;O.info.render.points=O.info.render.points+e.__webglParticleCount}else if(f instanceof THREE.Ribbon){k.drawArrays(k.TRIANGLE_STRIP,
0,e.__webglVertexCount);O.info.render.calls++}}};this.render=function(a,b,c,d){if(b instanceof THREE.Camera===false)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,l=a.__lights,n=a.fog;W=-1;gb=true;this.autoUpdateScene&&a.updateMatrixWorld();b.parent===void 0&&b.updateMatrixWorld();if(!b._viewMatrixArray)b._viewMatrixArray=new Float32Array(16);if(!b._projectionMatrixArray)b._projectionMatrixArray=new Float32Array(16);b.matrixWorldInverse.getInverse(b.matrixWorld);
b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);bb.multiply(b.projectionMatrix,b.matrixWorldInverse);ab.setFromMatrix(bb);this.autoUpdateObjects&&this.initWebGLObjects(a);j(this.renderPluginsPre,a,b);O.info.render.calls=0;O.info.render.vertices=0;O.info.render.faces=0;O.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;
for(e=h.length;d<e;d++){f=h[d];g=f.object;f.render=false;if(g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||ab.contains(g))){s(g,b);var q=f,p=q.object,r=q.buffer,t=void 0,t=t=void 0,t=p.material;if(t instanceof THREE.MeshFaceMaterial){t=r.materialIndex;if(t>=0){t=p.geometry.materials[t];if(t.transparent){q.transparent=t;q.opaque=null}else{q.opaque=t;q.transparent=null}}}else if(t)if(t.transparent){q.transparent=t;q.opaque=null}else{q.opaque=t;q.transparent=
null}f.render=true;if(this.sortObjects)if(g.renderDepth)f.z=g.renderDepth;else{Oa.copy(g.matrixWorld.getPosition());bb.multiplyVector3(Oa);f.z=Oa.z}}}this.sortObjects&&h.sort(i);h=a.__webglObjectsImmediate;d=0;for(e=h.length;d<e;d++){f=h[d];g=f.object;if(g.visible){s(g,b);g=f.object.material;if(g.transparent){f.transparent=g;f.opaque=null}else{f.opaque=g;f.transparent=null}}}if(a.overrideMaterial){d=a.overrideMaterial;this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst);this.setDepthTest(d.depthTest);
this.setDepthWrite(d.depthWrite);A(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits);o(a.__webglObjects,false,"",b,l,n,true,d);m(a.__webglObjectsImmediate,"",b,l,n,false,d)}else{this.setBlending(THREE.NormalBlending);o(a.__webglObjects,true,"opaque",b,l,n,false);m(a.__webglObjectsImmediate,"opaque",b,l,n,false);o(a.__webglObjects,false,"transparent",b,l,n,true);m(a.__webglObjectsImmediate,"transparent",b,l,n,true)}j(this.renderPluginsPost,a,b);if(c&&c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&
...
k,ab):e.render(function(a){O.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){if(!a.__webglObjects){a.__webglObjects=[];a.__webglObjectsImmediate=[];a.__webglSprites=[];a.__webglFlares=[]}for(;a.__objectsAdded.length;){var i=a.__objectsAdded[0],j=a,l=void 0,m=void 0,o=void 0;if(!i.__webglInit){i.__webglInit=true;i._modelViewMatrix=new THREE.Matrix4;i._normalMatrix=new THREE.Matrix3;if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.Geometry){if(m.geometryGroups===void 0){var s=
m,u=void 0,v=void 0,x=void 0,y=void 0,B=void 0,A=void 0,C=void 0,G={},H=s.morphTargets.length,F=s.morphNormals.length;s.geometryGroups={};u=0;for(v=s.faces.length;u<v;u++){x=s.faces[u];y=x.materialIndex;A=y!==void 0?y:-1;G[A]===void 0&&(G[A]={hash:A,counter:0});C=G[A].hash+"_"+G[A].counter;s.geometryGroups[C]===void 0&&(s.geometryGroups[C]={faces3:[],faces4:[],materialIndex:y,vertices:0,numMorphTargets:H,numMorphNormals:F});B=x instanceof THREE.Face3?3:4;if(s.geometryGroups[C].vertices+B>65535){G[A].counter=
G[A].counter+1;C=G[A].hash+"_"+G[A].counter;s.geometryGroups[C]===void 0&&(s.geometryGroups[C]={faces3:[],faces4:[],materialIndex:y,vertices:0,numMorphTargets:H,numMorphNormals:F})}x instanceof THREE.Face3?s.geometryGroups[C].faces3.push(u):s.geometryGroups[C].faces4.push(u);s.geometryGroups[C].vertices=s.geometryGroups[C].vertices+B}s.geometryGroupsList=[];var I=void 0;for(I in s.geometryGroups){s.geometryGroups[I].id=ha++;s.geometryGroupsList.push(s.geometryGroups[I])}}for(l in m.geometryGroups){o=
m.geometryGroups[l];if(!o.__webglVertexBuffer){var E=o;E.__webglVertexBuffer=k.createBuffer();E.__webglNormalBuffer=k.createBuffer();E.__webglTangentBuffer=k.createBuffer();E.__webglColorBuffer=k.createBuffer();E.__webglUVBuffer=k.createBuffer();E.__webglUV2Buffer=k.createBuffer();E.__webglSkinIndicesBuffer=k.createBuffer();E.__webglSkinWeightsBuffer=k.createBuffer();E.__webglFaceBuffer=k.createBuffer();E.__webglLineBuffer=k.createBuffer();var K=void 0,W=void 0;if(E.numMorphTargets){E.__webglMorphTargetsBuffers=
[];K=0;for(W=E.numMorphTargets;K<W;K++)E.__webglMorphTargetsBuffers.push(k.createBuffer())}if(E.numMorphNormals){E.__webglMorphNormalsBuffers=[];K=0;for(W=E.numMorphNormals;K<W;K++)E.__webglMorphNormalsBuffers.push(k.createBuffer())}O.info.memory.geometries++;var J=o,L=i,M=L.geometry,N=J.faces3,ca=J.faces4,V=N.length*3+ca.length*4,P=N.length*1+ca.length*2,ba=N.length*3+ca.length*4,Q=c(L,J),Z=f(Q),ga=d(Q),ea=Q.vertexColors?Q.vertexColors:false;J.__vertexArray=new Float32Array(V*3);if(ga)J.__normalArray=
new Float32Array(V*3);if(M.hasTangents)J.__tangentArray=new Float32Array(V*4);if(ea)J.__colorArray=new Float32Array(V*3);if(Z){if(M.faceUvs.length>0||M.faceVertexUvs.length>0)J.__uvArray=new Float32Array(V*2);if(M.faceUvs.length>1||M.faceVertexUvs.length>1)J.__uv2Array=new Float32Array(V*2)}if(L.geometry.skinWeights.length&&L.geometry.skinIndices.length){J.__skinIndexArray=new Float32Array(V*4);J.__skinWeightArray=new Float32Array(V*4)}J.__faceArray=new Uint16Array(P*3);J.__lineArray=new Uint16Array(ba*
2);var pa=void 0,ta=void 0;if(J.numMorphTargets){J.__morphTargetsArrays=[];pa=0;for(ta=J.numMorphTargets;pa<ta;pa++)J.__morphTargetsArrays.push(new Float32Array(V*3))}if(J.numMorphNormals){J.__morphNormalsArrays=[];pa=0;for(ta=J.numMorphNormals;pa<ta;pa++)J.__morphNormalsArrays.push(new Float32Array(V*3))}J.__webglFaceCount=P*3;J.__webglLineCount=ba*2;if(Q.attributes){if(J.__webglCustomAttributesList===void 0)J.__webglCustomAttributesList=[];var ra=void 0;for(ra in Q.attributes){var Da=Q.attributes[ra],
ja={},Ia;for(Ia in Da)ja[Ia]=Da[Ia];if(!ja.__webglInitialized||ja.createUniqueBuffers){ja.__webglInitialized=true;var wa=1;ja.type==="v2"?wa=2:ja.type==="v3"?wa=3:ja.type==="v4"?wa=4:ja.type==="c"&&(wa=3);ja.size=wa;ja.array=new Float32Array(V*wa);ja.buffer=k.createBuffer();ja.buffer.belongsToAttribute=ra;Da.needsUpdate=true;ja.__original=Da}J.__webglCustomAttributesList.push(ja)}}J.__inittedArrays=true;m.verticesNeedUpdate=true;m.morphTargetsNeedUpdate=true;m.elementsNeedUpdate=true;m.uvsNeedUpdate=
true;m.normalsNeedUpdate=true;m.tangentsNeedUpdate=true;m.colorsNeedUpdate=true}}}else m instanceof THREE.BufferGeometry&&e(m)}else if(i instanceof THREE.Ribbon){m=i.geometry;if(!m.__webglVertexBuffer){var Ea=m;Ea.__webglVertexBuffer=k.createBuffer();Ea.__webglColorBuffer=k.createBuffer();O.info.memory.geometries++;var ya=m,Ga=ya.vertices.length;ya.__vertexArray=new Float32Array(Ga*3);ya.__colorArray=new Float32Array(Ga*3);ya.__webglVertexCount=Ga;m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}}else if(i instanceof
THREE.Line){m=i.geometry;if(!m.__webglVertexBuffer){var Na=m;Na.__webglVertexBuffer=k.createBuffer();Na.__webglColorBuffer=k.createBuffer();O.info.memory.geometries++;var Fa=m,Oa=i,Pa=Fa.vertices.length;Fa.__vertexArray=new Float32Array(Pa*3);Fa.__colorArray=new Float32Array(Pa*3);Fa.__webglLineCount=Pa;b(Fa,Oa);m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}}else if(i instanceof THREE.ParticleSystem){m=i.geometry;if(!m.__webglVertexBuffer)if(m instanceof THREE.Geometry){var Xa=m;Xa.__webglVertexBuffer=
k.createBuffer();Xa.__webglColorBuffer=k.createBuffer();O.info.geometries++;var Ya=m,ob=i,fb=Ya.vertices.length;Ya.__vertexArray=new Float32Array(fb*3);Ya.__colorArray=new Float32Array(fb*3);Ya.__sortArray=[];Ya.__webglParticleCount=fb;b(Ya,ob);m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}else m instanceof THREE.BufferGeometry&&e(m)}}if(!i.__webglActive){if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.BufferGeometry)p(j.__webglObjects,m,i);else for(l in m.geometryGroups){o=m.geometryGroups[l];
p(j.__webglObjects,o,i)}}else if(i instanceof THREE.Ribbon||i instanceof THREE.Line||i instanceof THREE.ParticleSystem){m=i.geometry;p(j.__webglObjects,m,i)}else i instanceof THREE.ImmediateRenderObject||i.immediateRenderCallback?j.__webglObjectsImmediate.push({object:i,opaque:null,transparent:null}):i instanceof THREE.Sprite?j.__webglSprites.push(i):i instanceof THREE.LensFlare&&j.__webglFlares.push(i);i.__webglActive=true}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var kb=a.__objectsRemoved[0],
$a=a;kb instanceof THREE.Mesh||kb instanceof THREE.ParticleSystem||kb instanceof THREE.Ribbon||kb instanceof THREE.Line?t($a.__webglObjects,kb):kb instanceof THREE.Sprite?r($a.__webglSprites,kb):kb instanceof THREE.LensFlare?r($a.__webglFlares,kb):(kb instanceof THREE.ImmediateRenderObject||kb.immediateRenderCallback)&&t($a.__webglObjectsImmediate,kb);kb.__webglActive=false;a.__objectsRemoved.splice(0,1)}for(var gb=0,qb=a.__webglObjects.length;gb<qb;gb++){var tb=a.__webglObjects[gb].object,da=tb.geometry,
bb=void 0,ab=void 0,cb=void 0;if(tb instanceof THREE.Mesh)if(da instanceof THREE.BufferGeometry){(da.verticesNeedUpdate||da.elementsNeedUpdate||da.uvsNeedUpdate||da.normalsNeedUpdate||da.colorsNeedUpdate||da.tangentsNeedUpdate)&&h(da,k.DYNAMIC_DRAW,!da.dynamic);da.verticesNeedUpdate=false;da.elementsNeedUpdate=false;da.uvsNeedUpdate=false;da.normalsNeedUpdate=false;da.colorsNeedUpdate=false;da.tangentsNeedUpdate=false}else{for(var pb=0,vb=da.geometryGroupsList.length;pb<vb;pb++){bb=da.geometryGroupsList[pb];
cb=c(tb,bb);ab=cb.attributes&&q(cb);if(da.verticesNeedUpdate||da.morphTargetsNeedUpdate||da.elementsNeedUpdate||da.uvsNeedUpdate||da.normalsNeedUpdate||da.colorsNeedUpdate||da.tangentsNeedUpdate||ab){var ma=bb,wb=tb,lb=k.DYNAMIC_DRAW,Ob=!da.dynamic,fc=cb;if(ma.__inittedArrays){var Pb=d(fc),dc=fc.vertexColors?fc.vertexColors:false,ic=f(fc),Fc=Pb===THREE.SmoothShading,D=void 0,Y=void 0,Wb=void 0,R=void 0,kc=void 0,Xb=void 0,ub=void 0,Gc=void 0,Qb=void 0,lc=void 0,mc=void 0,S=void 0,T=void 0,U=void 0,
ka=void 0,yb=void 0,zb=void 0,Ab=void 0,sc=void 0,Bb=void 0,Cb=void 0,Db=void 0,tc=void 0,Eb=void 0,Fb=void 0,Gb=void 0,uc=void 0,Hb=void 0,Ib=void 0,Jb=void 0,vc=void 0,Kb=void 0,Lb=void 0,Mb=void 0,wc=void 0,qa=void 0,qc=void 0,Yb=void 0,nc=void 0,oc=void 0,Qa=void 0,rc=void 0,La=void 0,Ma=void 0,Zb=void 0,Rb=void 0,Ha=0,Ka=0,Sb=0,Tb=0,mb=0,Ua=0,va=0,Za=0,Ja=0,aa=0,fa=0,z=0,sa=void 0,Ra=ma.__vertexArray,xc=ma.__uvArray,yc=ma.__uv2Array,nb=ma.__normalArray,za=ma.__tangentArray,Sa=ma.__colorArray,
Aa=ma.__skinIndexArray,Ba=ma.__skinWeightArray,Uc=ma.__morphTargetsArrays,Vc=ma.__morphNormalsArrays,Wc=ma.__webglCustomAttributesList,w=void 0,Nb=ma.__faceArray,hb=ma.__lineArray,db=wb.geometry,Dc=db.elementsNeedUpdate,ad=db.uvsNeedUpdate,Rc=db.normalsNeedUpdate,Sc=db.tangentsNeedUpdate,hd=db.colorsNeedUpdate,id=db.morphTargetsNeedUpdate,gc=db.vertices,na=ma.faces3,oa=ma.faces4,Va=db.faces,Xc=db.faceVertexUvs[0],Yc=db.faceVertexUvs[1],hc=db.skinIndices,$b=db.skinWeights,ac=db.morphTargets,Hc=db.morphNormals;
if(db.verticesNeedUpdate){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];S=gc[R.a];T=gc[R.b];U=gc[R.c];Ra[Ka]=S.x;Ra[Ka+1]=S.y;Ra[Ka+2]=S.z;Ra[Ka+3]=T.x;Ra[Ka+4]=T.y;Ra[Ka+5]=T.z;Ra[Ka+6]=U.x;Ra[Ka+7]=U.y;Ra[Ka+8]=U.z;Ka=Ka+9}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];S=gc[R.a];T=gc[R.b];U=gc[R.c];ka=gc[R.d];Ra[Ka]=S.x;Ra[Ka+1]=S.y;Ra[Ka+2]=S.z;Ra[Ka+3]=T.x;Ra[Ka+4]=T.y;Ra[Ka+5]=T.z;Ra[Ka+6]=U.x;Ra[Ka+7]=U.y;Ra[Ka+8]=U.z;Ra[Ka+9]=ka.x;Ra[Ka+10]=ka.y;Ra[Ka+11]=ka.z;Ka=Ka+12}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglVertexBuffer);
k.bufferData(k.ARRAY_BUFFER,Ra,lb)}if(id){Qa=0;for(rc=ac.length;Qa<rc;Qa++){D=fa=0;for(Y=na.length;D<Y;D++){Zb=na[D];R=Va[Zb];S=ac[Qa].vertices[R.a];T=ac[Qa].vertices[R.b];U=ac[Qa].vertices[R.c];La=Uc[Qa];La[fa]=S.x;La[fa+1]=S.y;La[fa+2]=S.z;La[fa+3]=T.x;La[fa+4]=T.y;La[fa+5]=T.z;La[fa+6]=U.x;La[fa+7]=U.y;La[fa+8]=U.z;if(fc.morphNormals){if(Fc){Rb=Hc[Qa].vertexNormals[Zb];Bb=Rb.a;Cb=Rb.b;Db=Rb.c}else Db=Cb=Bb=Hc[Qa].faceNormals[Zb];Ma=Vc[Qa];Ma[fa]=Bb.x;Ma[fa+1]=Bb.y;Ma[fa+2]=Bb.z;Ma[fa+3]=Cb.x;Ma[fa+
4]=Cb.y;Ma[fa+5]=Cb.z;Ma[fa+6]=Db.x;Ma[fa+7]=Db.y;Ma[fa+8]=Db.z}fa=fa+9}D=0;for(Y=oa.length;D<Y;D++){Zb=oa[D];R=Va[Zb];S=ac[Qa].vertices[R.a];T=ac[Qa].vertices[R.b];U=ac[Qa].vertices[R.c];ka=ac[Qa].vertices[R.d];La=Uc[Qa];La[fa]=S.x;La[fa+1]=S.y;La[fa+2]=S.z;La[fa+3]=T.x;La[fa+4]=T.y;La[fa+5]=T.z;La[fa+6]=U.x;La[fa+7]=U.y;La[fa+8]=U.z;La[fa+9]=ka.x;La[fa+10]=ka.y;La[fa+11]=ka.z;if(fc.morphNormals){if(Fc){Rb=Hc[Qa].vertexNormals[Zb];Bb=Rb.a;Cb=Rb.b;Db=Rb.c;tc=Rb.d}else tc=Db=Cb=Bb=Hc[Qa].faceNormals[Zb];
Ma=Vc[Qa];Ma[fa]=Bb.x;Ma[fa+1]=Bb.y;Ma[fa+2]=Bb.z;Ma[fa+3]=Cb.x;Ma[fa+4]=Cb.y;Ma[fa+5]=Cb.z;Ma[fa+6]=Db.x;Ma[fa+7]=Db.y;Ma[fa+8]=Db.z;Ma[fa+9]=tc.x;Ma[fa+10]=tc.y;Ma[fa+11]=tc.z}fa=fa+12}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglMorphTargetsBuffers[Qa]);k.bufferData(k.ARRAY_BUFFER,Uc[Qa],lb);if(fc.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglMorphNormalsBuffers[Qa]);k.bufferData(k.ARRAY_BUFFER,Vc[Qa],lb)}}}if($b.length){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];Hb=$b[R.a];Ib=$b[R.b];Jb=$b[R.c];
Ba[aa]=Hb.x;Ba[aa+1]=Hb.y;Ba[aa+2]=Hb.z;Ba[aa+3]=Hb.w;Ba[aa+4]=Ib.x;Ba[aa+5]=Ib.y;Ba[aa+6]=Ib.z;Ba[aa+7]=Ib.w;Ba[aa+8]=Jb.x;Ba[aa+9]=Jb.y;Ba[aa+10]=Jb.z;Ba[aa+11]=Jb.w;Kb=hc[R.a];Lb=hc[R.b];Mb=hc[R.c];Aa[aa]=Kb.x;Aa[aa+1]=Kb.y;Aa[aa+2]=Kb.z;Aa[aa+3]=Kb.w;Aa[aa+4]=Lb.x;Aa[aa+5]=Lb.y;Aa[aa+6]=Lb.z;Aa[aa+7]=Lb.w;Aa[aa+8]=Mb.x;Aa[aa+9]=Mb.y;Aa[aa+10]=Mb.z;Aa[aa+11]=Mb.w;aa=aa+12}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];Hb=$b[R.a];Ib=$b[R.b];Jb=$b[R.c];vc=$b[R.d];Ba[aa]=Hb.x;Ba[aa+1]=Hb.y;Ba[aa+2]=Hb.z;
Ba[aa+3]=Hb.w;Ba[aa+4]=Ib.x;Ba[aa+5]=Ib.y;Ba[aa+6]=Ib.z;Ba[aa+7]=Ib.w;Ba[aa+8]=Jb.x;Ba[aa+9]=Jb.y;Ba[aa+10]=Jb.z;Ba[aa+11]=Jb.w;Ba[aa+12]=vc.x;Ba[aa+13]=vc.y;Ba[aa+14]=vc.z;Ba[aa+15]=vc.w;Kb=hc[R.a];Lb=hc[R.b];Mb=hc[R.c];wc=hc[R.d];Aa[aa]=Kb.x;Aa[aa+1]=Kb.y;Aa[aa+2]=Kb.z;Aa[aa+3]=Kb.w;Aa[aa+4]=Lb.x;Aa[aa+5]=Lb.y;Aa[aa+6]=Lb.z;Aa[aa+7]=Lb.w;Aa[aa+8]=Mb.x;Aa[aa+9]=Mb.y;Aa[aa+10]=Mb.z;Aa[aa+11]=Mb.w;Aa[aa+12]=wc.x;Aa[aa+13]=wc.y;Aa[aa+14]=wc.z;Aa[aa+15]=wc.w;aa=aa+16}if(aa>0){k.bindBuffer(k.ARRAY_BUFFER,
ma.__webglSkinIndicesBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,lb);k.bindBuffer(k.ARRAY_BUFFER,ma.__webglSkinWeightsBuffer);k.bufferData(k.ARRAY_BUFFER,Ba,lb)}}if(hd&&dc){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];ub=R.vertexColors;Gc=R.color;if(ub.length===3&&dc===THREE.VertexColors){Eb=ub[0];Fb=ub[1];Gb=ub[2]}else Gb=Fb=Eb=Gc;Sa[Ja]=Eb.r;Sa[Ja+1]=Eb.g;Sa[Ja+2]=Eb.b;Sa[Ja+3]=Fb.r;Sa[Ja+4]=Fb.g;Sa[Ja+5]=Fb.b;Sa[Ja+6]=Gb.r;Sa[Ja+7]=Gb.g;Sa[Ja+8]=Gb.b;Ja=Ja+9}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];ub=
R.vertexColors;Gc=R.color;if(ub.length===4&&dc===THREE.VertexColors){Eb=ub[0];Fb=ub[1];Gb=ub[2];uc=ub[3]}else uc=Gb=Fb=Eb=Gc;Sa[Ja]=Eb.r;Sa[Ja+1]=Eb.g;Sa[Ja+2]=Eb.b;Sa[Ja+3]=Fb.r;Sa[Ja+4]=Fb.g;Sa[Ja+5]=Fb.b;Sa[Ja+6]=Gb.r;Sa[Ja+7]=Gb.g;Sa[Ja+8]=Gb.b;Sa[Ja+9]=uc.r;Sa[Ja+10]=uc.g;Sa[Ja+11]=uc.b;Ja=Ja+12}if(Ja>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Sa,lb)}}if(Sc&&db.hasTangents){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];Qb=R.vertexTangents;yb=Qb[0];zb=Qb[1];Ab=
Qb[2];za[va]=yb.x;za[va+1]=yb.y;za[va+2]=yb.z;za[va+3]=yb.w;za[va+4]=zb.x;za[va+5]=zb.y;za[va+6]=zb.z;za[va+7]=zb.w;za[va+8]=Ab.x;za[va+9]=Ab.y;za[va+10]=Ab.z;za[va+11]=Ab.w;va=va+12}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];Qb=R.vertexTangents;yb=Qb[0];zb=Qb[1];Ab=Qb[2];sc=Qb[3];za[va]=yb.x;za[va+1]=yb.y;za[va+2]=yb.z;za[va+3]=yb.w;za[va+4]=zb.x;za[va+5]=zb.y;za[va+6]=zb.z;za[va+7]=zb.w;za[va+8]=Ab.x;za[va+9]=Ab.y;za[va+10]=Ab.z;za[va+11]=Ab.w;za[va+12]=sc.x;za[va+13]=sc.y;za[va+14]=sc.z;za[va+15]=
sc.w;va=va+16}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,za,lb)}if(Rc&&Pb){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];kc=R.vertexNormals;Xb=R.normal;if(kc.length===3&&Fc)for(qa=0;qa<3;qa++){Yb=kc[qa];nb[Ua]=Yb.x;nb[Ua+1]=Yb.y;nb[Ua+2]=Yb.z;Ua=Ua+3}else for(qa=0;qa<3;qa++){nb[Ua]=Xb.x;nb[Ua+1]=Xb.y;nb[Ua+2]=Xb.z;Ua=Ua+3}}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];kc=R.vertexNormals;Xb=R.normal;if(kc.length===4&&Fc)for(qa=0;qa<4;qa++){Yb=kc[qa];nb[Ua]=Yb.x;nb[Ua+1]=
Yb.y;nb[Ua+2]=Yb.z;Ua=Ua+3}else for(qa=0;qa<4;qa++){nb[Ua]=Xb.x;nb[Ua+1]=Xb.y;nb[Ua+2]=Xb.z;Ua=Ua+3}}k.bindBuffer(k.ARRAY_BUFFER,ma.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,nb,lb)}if(ad&&Xc&&ic){D=0;for(Y=na.length;D<Y;D++){Wb=na[D];lc=Xc[Wb];if(lc!==void 0)for(qa=0;qa<3;qa++){nc=lc[qa];xc[Sb]=nc.u;xc[Sb+1]=nc.v;Sb=Sb+2}}D=0;for(Y=oa.length;D<Y;D++){Wb=oa[D];lc=Xc[Wb];if(lc!==void 0)for(qa=0;qa<4;qa++){nc=lc[qa];xc[Sb]=nc.u;xc[Sb+1]=nc.v;Sb=Sb+2}}if(Sb>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglUVBuffer);
k.bufferData(k.ARRAY_BUFFER,xc,lb)}}if(ad&&Yc&&ic){D=0;for(Y=na.length;D<Y;D++){Wb=na[D];mc=Yc[Wb];if(mc!==void 0)for(qa=0;qa<3;qa++){oc=mc[qa];yc[Tb]=oc.u;yc[Tb+1]=oc.v;Tb=Tb+2}}D=0;for(Y=oa.length;D<Y;D++){Wb=oa[D];mc=Yc[Wb];if(mc!==void 0)for(qa=0;qa<4;qa++){oc=mc[qa];yc[Tb]=oc.u;yc[Tb+1]=oc.v;Tb=Tb+2}}if(Tb>0){k.bindBuffer(k.ARRAY_BUFFER,ma.__webglUV2Buffer);k.bufferData(k.ARRAY_BUFFER,yc,lb)}}if(Dc){D=0;for(Y=na.length;D<Y;D++){Nb[mb]=Ha;Nb[mb+1]=Ha+1;Nb[mb+2]=Ha+2;mb=mb+3;hb[Za]=Ha;hb[Za+1]=
Ha+1;hb[Za+2]=Ha;hb[Za+3]=Ha+2;hb[Za+4]=Ha+1;hb[Za+5]=Ha+2;Za=Za+6;Ha=Ha+3}D=0;for(Y=oa.length;D<Y;D++){Nb[mb]=Ha;Nb[mb+1]=Ha+1;Nb[mb+2]=Ha+3;Nb[mb+3]=Ha+1;Nb[mb+4]=Ha+2;Nb[mb+5]=Ha+3;mb=mb+6;hb[Za]=Ha;hb[Za+1]=Ha+1;hb[Za+2]=Ha;hb[Za+3]=Ha+3;hb[Za+4]=Ha+1;hb[Za+5]=Ha+2;hb[Za+6]=Ha+2;hb[Za+7]=Ha+3;Za=Za+8;Ha=Ha+4}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ma.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Nb,lb);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ma.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,
hb,lb)}if(Wc){qa=0;for(qc=Wc.length;qa<qc;qa++){w=Wc[qa];if(w.__original.needsUpdate){z=0;if(w.size===1)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];w.array[z]=w.value[R.a];w.array[z+1]=w.value[R.b];w.array[z+2]=w.value[R.c];z=z+3}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];w.array[z]=w.value[R.a];w.array[z+1]=w.value[R.b];w.array[z+2]=w.value[R.c];w.array[z+3]=w.value[R.d];z=z+4}}else{if(w.boundTo==="faces"){D=0;for(Y=na.length;D<Y;D++){sa=w.value[na[D]];w.array[z]=
sa;w.array[z+1]=sa;w.array[z+2]=sa;z=z+3}D=0;for(Y=oa.length;D<Y;D++){sa=w.value[oa[D]];w.array[z]=sa;w.array[z+1]=sa;w.array[z+2]=sa;w.array[z+3]=sa;z=z+4}}}else if(w.size===2)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];S=w.value[R.a];T=w.value[R.b];U=w.value[R.c];w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=T.x;w.array[z+3]=T.y;w.array[z+4]=U.x;w.array[z+5]=U.y;z=z+6}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];S=w.value[R.a];T=w.value[R.b];U=w.value[R.c];
ka=w.value[R.d];w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=T.x;w.array[z+3]=T.y;w.array[z+4]=U.x;w.array[z+5]=U.y;w.array[z+6]=ka.x;w.array[z+7]=ka.y;z=z+8}}else{if(w.boundTo==="faces"){D=0;for(Y=na.length;D<Y;D++){U=T=S=sa=w.value[na[D]];w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=T.x;w.array[z+3]=T.y;w.array[z+4]=U.x;w.array[z+5]=U.y;z=z+6}D=0;for(Y=oa.length;D<Y;D++){ka=U=T=S=sa=w.value[oa[D]];w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=T.x;w.array[z+3]=T.y;w.array[z+4]=U.x;w.array[z+5]=U.y;
w.array[z+6]=ka.x;w.array[z+7]=ka.y;z=z+8}}}else if(w.size===3){var $;$=w.type==="c"?["r","g","b"]:["x","y","z"];if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];S=w.value[R.a];T=w.value[R.b];U=w.value[R.c];w.array[z]=S[$[0]];w.array[z+1]=S[$[1]];w.array[z+2]=S[$[2]];w.array[z+3]=T[$[0]];w.array[z+4]=T[$[1]];w.array[z+5]=T[$[2]];w.array[z+6]=U[$[0]];w.array[z+7]=U[$[1]];w.array[z+8]=U[$[2]];z=z+9}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];S=w.value[R.a];T=w.value[R.b];
U=w.value[R.c];ka=w.value[R.d];w.array[z]=S[$[0]];w.array[z+1]=S[$[1]];w.array[z+2]=S[$[2]];w.array[z+3]=T[$[0]];w.array[z+4]=T[$[1]];w.array[z+5]=T[$[2]];w.array[z+6]=U[$[0]];w.array[z+7]=U[$[1]];w.array[z+8]=U[$[2]];w.array[z+9]=ka[$[0]];w.array[z+10]=ka[$[1]];w.array[z+11]=ka[$[2]];z=z+12}}else if(w.boundTo==="faces"){D=0;for(Y=na.length;D<Y;D++){U=T=S=sa=w.value[na[D]];w.array[z]=S[$[0]];w.array[z+1]=S[$[1]];w.array[z+2]=S[$[2]];w.array[z+3]=T[$[0]];w.array[z+4]=T[$[1]];w.array[z+5]=T[$[2]];w.array[z+
6]=U[$[0]];w.array[z+7]=U[$[1]];w.array[z+8]=U[$[2]];z=z+9}D=0;for(Y=oa.length;D<Y;D++){ka=U=T=S=sa=w.value[oa[D]];w.array[z]=S[$[0]];w.array[z+1]=S[$[1]];w.array[z+2]=S[$[2]];w.array[z+3]=T[$[0]];w.array[z+4]=T[$[1]];w.array[z+5]=T[$[2]];w.array[z+6]=U[$[0]];w.array[z+7]=U[$[1]];w.array[z+8]=U[$[2]];w.array[z+9]=ka[$[0]];w.array[z+10]=ka[$[1]];w.array[z+11]=ka[$[2]];z=z+12}}else if(w.boundTo==="faceVertices"){D=0;for(Y=na.length;D<Y;D++){sa=w.value[na[D]];S=sa[0];T=sa[1];U=sa[2];w.array[z]=S[$[0]];
w.array[z+1]=S[$[1]];w.array[z+2]=S[$[2]];w.array[z+3]=T[$[0]];w.array[z+4]=T[$[1]];w.array[z+5]=T[$[2]];w.array[z+6]=U[$[0]];w.array[z+7]=U[$[1]];w.array[z+8]=U[$[2]];z=z+9}D=0;for(Y=oa.length;D<Y;D++){sa=w.value[oa[D]];S=sa[0];T=sa[1];U=sa[2];ka=sa[3];w.array[z]=S[$[0]];w.array[z+1]=S[$[1]];w.array[z+2]=S[$[2]];w.array[z+3]=T[$[0]];w.array[z+4]=T[$[1]];w.array[z+5]=T[$[2]];w.array[z+6]=U[$[0]];w.array[z+7]=U[$[1]];w.array[z+8]=U[$[2]];w.array[z+9]=ka[$[0]];w.array[z+10]=ka[$[1]];w.array[z+11]=ka[$[2]];
z=z+12}}}else if(w.size===4)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(Y=na.length;D<Y;D++){R=Va[na[D]];S=w.value[R.a];T=w.value[R.b];U=w.value[R.c];w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=S.z;w.array[z+3]=S.w;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=T.z;w.array[z+7]=T.w;w.array[z+8]=U.x;w.array[z+9]=U.y;w.array[z+10]=U.z;w.array[z+11]=U.w;z=z+12}D=0;for(Y=oa.length;D<Y;D++){R=Va[oa[D]];S=w.value[R.a];T=w.value[R.b];U=w.value[R.c];ka=w.value[R.d];w.array[z]=S.x;w.array[z+1]=
S.y;w.array[z+2]=S.z;w.array[z+3]=S.w;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=T.z;w.array[z+7]=T.w;w.array[z+8]=U.x;w.array[z+9]=U.y;w.array[z+10]=U.z;w.array[z+11]=U.w;w.array[z+12]=ka.x;w.array[z+13]=ka.y;w.array[z+14]=ka.z;w.array[z+15]=ka.w;z=z+16}}else if(w.boundTo==="faces"){D=0;for(Y=na.length;D<Y;D++){U=T=S=sa=w.value[na[D]];w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=S.z;w.array[z+3]=S.w;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=T.z;w.array[z+7]=T.w;w.array[z+8]=U.x;w.array[z+
9]=U.y;w.array[z+10]=U.z;w.array[z+11]=U.w;z=z+12}D=0;for(Y=oa.length;D<Y;D++){ka=U=T=S=sa=w.value[oa[D]];w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=S.z;w.array[z+3]=S.w;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=T.z;w.array[z+7]=T.w;w.array[z+8]=U.x;w.array[z+9]=U.y;w.array[z+10]=U.z;w.array[z+11]=U.w;w.array[z+12]=ka.x;w.array[z+13]=ka.y;w.array[z+14]=ka.z;w.array[z+15]=ka.w;z=z+16}}else if(w.boundTo==="faceVertices"){D=0;for(Y=na.length;D<Y;D++){sa=w.value[na[D]];S=sa[0];T=sa[1];U=sa[2];
w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=S.z;w.array[z+3]=S.w;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=T.z;w.array[z+7]=T.w;w.array[z+8]=U.x;w.array[z+9]=U.y;w.array[z+10]=U.z;w.array[z+11]=U.w;z=z+12}D=0;for(Y=oa.length;D<Y;D++){sa=w.value[oa[D]];S=sa[0];T=sa[1];U=sa[2];ka=sa[3];w.array[z]=S.x;w.array[z+1]=S.y;w.array[z+2]=S.z;w.array[z+3]=S.w;w.array[z+4]=T.x;w.array[z+5]=T.y;w.array[z+6]=T.z;w.array[z+7]=T.w;w.array[z+8]=U.x;w.array[z+9]=U.y;w.array[z+10]=U.z;w.array[z+11]=U.w;w.array[z+
12]=ka.x;w.array[z+13]=ka.y;w.array[z+14]=ka.z;w.array[z+15]=ka.w;z=z+16}}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,lb)}}}if(Ob){delete ma.__inittedArrays;delete ma.__colorArray;delete ma.__normalArray;delete ma.__tangentArray;delete ma.__uvArray;delete ma.__uv2Array;delete ma.__faceArray;delete ma.__vertexArray;delete ma.__lineArray;delete ma.__skinIndexArray;delete ma.__skinWeightArray}}}}da.verticesNeedUpdate=false;da.morphTargetsNeedUpdate=false;da.elementsNeedUpdate=
false;da.uvsNeedUpdate=false;da.normalsNeedUpdate=false;da.colorsNeedUpdate=false;da.tangentsNeedUpdate=false;cb.attributes&&n(cb)}else if(tb instanceof THREE.Ribbon){if(da.verticesNeedUpdate||da.colorsNeedUpdate){var bc=da,bd=k.DYNAMIC_DRAW,zc=void 0,Ac=void 0,Ic=void 0,cc=void 0,Jc=void 0,cd=bc.vertices,dd=bc.colors,jd=cd.length,kd=dd.length,Kc=bc.__vertexArray,Lc=bc.__colorArray,ld=bc.colorsNeedUpdate;if(bc.verticesNeedUpdate){for(zc=0;zc<jd;zc++){Ic=cd[zc];cc=zc*3;Kc[cc]=Ic.x;Kc[cc+1]=Ic.y;Kc[cc+
2]=Ic.z}k.bindBuffer(k.ARRAY_BUFFER,bc.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Kc,bd)}if(ld){for(Ac=0;Ac<kd;Ac++){Jc=dd[Ac];cc=Ac*3;Lc[cc]=Jc.r;Lc[cc+1]=Jc.g;Lc[cc+2]=Jc.b}k.bindBuffer(k.ARRAY_BUFFER,bc.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Lc,bd)}}da.verticesNeedUpdate=false;da.colorsNeedUpdate=false}else if(tb instanceof THREE.Line){cb=c(tb,bb);ab=cb.attributes&&q(cb);if(da.verticesNeedUpdate||da.colorsNeedUpdate||ab){var Ub=da,Zc=k.DYNAMIC_DRAW,Bc=void 0,Cc=void 0,Mc=void 0,
Ca=void 0,Nc=void 0,ed=Ub.vertices,fd=Ub.colors,md=ed.length,nd=fd.length,Oc=Ub.__vertexArray,Pc=Ub.__colorArray,od=Ub.colorsNeedUpdate,$c=Ub.__webglCustomAttributesList,Qc=void 0,gd=void 0,Ta=void 0,pc=void 0,eb=void 0,xa=void 0;if(Ub.verticesNeedUpdate){for(Bc=0;Bc<md;Bc++){Mc=ed[Bc];Ca=Bc*3;Oc[Ca]=Mc.x;Oc[Ca+1]=Mc.y;Oc[Ca+2]=Mc.z}k.bindBuffer(k.ARRAY_BUFFER,Ub.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Oc,Zc)}if(od){for(Cc=0;Cc<nd;Cc++){Nc=fd[Cc];Ca=Cc*3;Pc[Ca]=Nc.r;Pc[Ca+1]=Nc.g;Pc[Ca+2]=
Nc.b}k.bindBuffer(k.ARRAY_BUFFER,Ub.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Pc,Zc)}if($c){Qc=0;for(gd=$c.length;Qc<gd;Qc++){xa=$c[Qc];if(xa.needsUpdate&&(xa.boundTo===void 0||xa.boundTo==="vertices")){Ca=0;pc=xa.value.length;if(xa.size===1)for(Ta=0;Ta<pc;Ta++)xa.array[Ta]=xa.value[Ta];else if(xa.size===2)for(Ta=0;Ta<pc;Ta++){eb=xa.value[Ta];xa.array[Ca]=eb.x;xa.array[Ca+1]=eb.y;Ca=Ca+2}else if(xa.size===3)if(xa.type==="c")for(Ta=0;Ta<pc;Ta++){eb=xa.value[Ta];xa.array[Ca]=eb.r;xa.array[Ca+
1]=eb.g;xa.array[Ca+2]=eb.b;Ca=Ca+3}else for(Ta=0;Ta<pc;Ta++){eb=xa.value[Ta];xa.array[Ca]=eb.x;xa.array[Ca+1]=eb.y;xa.array[Ca+2]=eb.z;Ca=Ca+3}else if(xa.size===4)for(Ta=0;Ta<pc;Ta++){eb=xa.value[Ta];xa.array[Ca]=eb.x;xa.array[Ca+1]=eb.y;xa.array[Ca+2]=eb.z;xa.array[Ca+3]=eb.w;Ca=Ca+4}k.bindBuffer(k.ARRAY_BUFFER,xa.buffer);k.bufferData(k.ARRAY_BUFFER,xa.array,Zc)}}}}da.verticesNeedUpdate=false;da.colorsNeedUpdate=false;cb.attributes&&n(cb)}else if(tb instanceof THREE.ParticleSystem)if(da instanceof
THREE.BufferGeometry){(da.verticesNeedUpdate||da.colorsNeedUpdate)&&h(da,k.DYNAMIC_DRAW,!da.dynamic);da.verticesNeedUpdate=false;da.colorsNeedUpdate=false}else{cb=c(tb,bb);ab=cb.attributes&&q(cb);(da.verticesNeedUpdate||da.colorsNeedUpdate||tb.sortParticles||ab)&&g(da,k.DYNAMIC_DRAW,tb);da.verticesNeedUpdate=false;da.colorsNeedUpdate=false;cb.attributes&&n(cb)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,m,n;a instanceof THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?
n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var o=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var q,p;q=h=f=e=o=0;for(g=b.length;q<g;q++){p=b[q];if(!p.onlyShadow){p instanceof THREE.DirectionalLight&&
h++;p instanceof THREE.PointLight&&f++;p instanceof THREE.SpotLight&&e++;p instanceof THREE.HemisphereLight&&o++}}if(f+e+h+o<=ea){q=h;g=e}else{q=Math.ceil(ea*h/(f+h));g=f=ea-q;o=q}e=q;h=o;o=m=0;for(q=b.length;o<q;o++){p=b[o];if(p.castShadow){p instanceof THREE.SpotLight&&m++;p instanceof THREE.DirectionalLight&&!p.shadowCascade&&m++}}if(dc&&d&&d.useVertexTexture)l=1024;else{b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS);b=Math.floor((b-20)/4);if(d!==void 0&&d instanceof THREE.SkinnedMesh){b=Math.min(d.bones.length,
b);b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")}l=b}var s;a:{p=a.fragmentShader;q=a.vertexShader;var o=a.uniforms,b=a.attributes,c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,sizeAttenuation:a.sizeAttenuation,skinning:a.skinning,maxBones:l,useVertexTexture:dc&&d&&d.useVertexTexture,
...
wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},r,d=[];if(n)d.push(n);else{d.push(p);d.push(q)}for(r in c){d.push(r);d.push(c[r])}n=d.join();r=0;for(d=ra.length;r<d;r++){e=ra[r];if(e.code===n){e.usedTimes++;s=e.program;break a}}r=k.createProgram();d=["precision "+C+" float;",ic?"#define VERTEX_TEXTURES":"",O.gammaInput?"#define GAMMA_INPUT":"",O.gammaOutput?"#define GAMMA_OUTPUT":"",O.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS "+
...
"#define FLIP_SIDED":"",c.shadowMapEnabled?"#define USE_SHADOWMAP":"",c.shadowMapSoft?"#define SHADOWMAP_SOFT":"",c.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",c.shadowMapCascade?"#define SHADOWMAP_CASCADE":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;",""];e=e.join("\n");e=x("fragment",e+p);d=x("vertex",d+q);k.attachShader(r,d);k.attachShader(r,e);k.linkProgram(r);k.getProgramParameter(r,k.LINK_STATUS)||console.error("Could not initialise shader\nVALIDATE_STATUS: "+k.getProgramParameter(r,
k.VALIDATE_STATUS)+", gl error ["+k.getError()+"]");k.deleteShader(e);k.deleteShader(d);r.uniforms={};r.attributes={};var t,d=["viewMatrix","modelViewMatrix","projectionMatrix","normalMatrix","modelMatrix","cameraPosition","morphTargetInfluences"];c.useVertexTexture?d.push("boneTexture"):d.push("boneGlobalMatrices");for(t in o)d.push(t);t=d;d=0;for(o=t.length;d<o;d++){e=t[d];r.uniforms[e]=k.getUniformLocation(r,e)}d=["position","normal","uv","uv2","tangent","color","skinIndex","skinWeight"];for(t=
0;t<c.maxMorphTargets;t++)d.push("morphTarget"+t);for(t=0;t<c.maxMorphNormals;t++)d.push("morphNormal"+t);for(s in b)d.push(s);s=d;t=0;for(c=s.length;t<c;t++){d=s[t];r.attributes[d]=k.getAttribLocation(r,d)}r.id=wa++;ra.push({program:r,code:n,usedTimes:1});O.info.memory.programs=ra.length;s=r}a.program=s;s=a.program.attributes;s.position>=0&&k.enableVertexAttribArray(s.position);s.color>=0&&k.enableVertexAttribArray(s.color);s.normal>=0&&k.enableVertexAttribArray(s.normal);s.tangent>=0&&k.enableVertexAttribArray(s.tangent);
...
k.enable(k.CULL_FACE);ta=b}if(Da!==a){a?k.frontFace(k.CW):k.frontFace(k.CCW);Da=a}};this.setDepthTest=function(a){if(Na!==a){a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST);Na=a}};this.setDepthWrite=function(a){if(Ya!==a){k.depthMask(a);Ya=a}};this.setBlending=function(a,b,c,d){if(a!==Ia){if(a===THREE.NoBlending)k.disable(k.BLEND);else if(a===THREE.AdditiveBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE)}else if(a===THREE.SubtractiveBlending){k.enable(k.BLEND);
k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)}else if(a===THREE.MultiplyBlending){k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.ZERO,k.SRC_COLOR)}else if(a===THREE.CustomBlending)k.enable(k.BLEND);else{k.enable(k.BLEND);k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD);k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)}Ia=a}if(a===THREE.CustomBlending){if(b!==Xa){k.blendEquation(H(b));Xa=b}if(c!==ja||d!==ob){k.blendFunc(H(c),H(d));
ja=c;ob=d}}else ob=ja=Xa=null};this.setTexture=function(a,b){if(a.needsUpdate){if(!a.__webglInit){a.__webglInit=true;a.__webglTexture=k.createTexture();O.info.memory.textures++}k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=(c.width&c.width-1)===0&&(c.height&c.height-1)===0,e=H(a.format),f=H(a.type);I(k.TEXTURE_2D,a,d);a instanceof THREE.DataTexture?
...
k.createTexture();var c=(a.width&a.width-1)===0&&(a.height&a.height-1)===0,d=H(a.format),e=H(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);I(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;f<6;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);
k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);F(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);I(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null);d=k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,
0);F(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;e=d=0}else{b=null;c=Ga;a=$a;d=ya;e=wb}if(b!==ba){k.bindFramebuffer(k.FRAMEBUFFER,b);k.viewport(d,e,c,a);ba=b}qb=c;Ea=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);
...
l[p],t,r,u=g.vertexNormals,v=g.vertexColors;g instanceof THREE.Face3?t=new THREE.Face3(g.a+f,g.b+f,g.c+f):g instanceof THREE.Face4&&(t=new THREE.Face4(g.a+f,g.b+f,g.c+f,g.d+f));t.normal.copy(g.normal);d&&d.multiplyVector3(t.normal);h=0;for(n=u.length;h<n;h++){r=u[h].clone();d&&d.multiplyVector3(r);t.vertexNormals.push(r)}t.color.copy(g.color);h=0;for(n=v.length;h<n;h++){r=v[h];t.vertexColors.push(r.clone())}if(g.materialIndex!==void 0){h=e.materials[g.materialIndex];n=h.id;v=m[n];if(v===void 0){v=
...
l.lerpSelf(o,0.5);v.a=e;v.b=g;v.c=i;s.a=i;s.b=g;s.c=h;if(f.vertexNormals.length===3){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[2],0.5);v.vertexNormals[2].copy(e);s.vertexNormals[0].copy(e)}if(f.vertexColors.length===3){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[2],0.5);v.vertexColors[2].copy(e);s.vertexColors[0].copy(e)}f=2}B.push(v,s);a.vertices.push(l);e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){l=a.faceVertexUvs[e][c];s=l[0];h=l[1];v=l[2];if(f===
0){j=s.clone();j.lerpSelf(h,0.5);l=[s.clone(),j.clone(),v.clone()];h=[j.clone(),h.clone(),v.clone()]}else if(f===1){j=h.clone();j.lerpSelf(v,0.5);l=[s.clone(),h.clone(),j.clone()];h=[j.clone(),v.clone(),s.clone()]}else{j=s.clone();j.lerpSelf(v,0.5);l=[s.clone(),h.clone(),j.clone()];h=[j.clone(),h.clone(),v.clone()]}y[e].push(l,h)}}else{B.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)y[e].push(a.faceVertexUvs[e][c])}}else{e=f.a;g=f.b;h=f.c;i=f.d;l=a.vertices[e];j=a.vertices[g];o=a.vertices[h];m=
a.vertices[i];p=l.distanceTo(j);q=j.distanceTo(o);n=o.distanceTo(m);t=l.distanceTo(m);if(p>b||q>b||n>b||t>b){r=a.vertices.length;u=a.vertices.length+1;v=f.clone();s=f.clone();if(p>=q&&p>=n&&p>=t||n>=q&&n>=p&&n>=t){p=l.clone();p.lerpSelf(j,0.5);j=o.clone();j.lerpSelf(m,0.5);v.a=e;v.b=r;v.c=u;v.d=i;s.a=r;s.b=g;s.c=h;s.d=u;if(f.vertexNormals.length===4){e=f.vertexNormals[0].clone();e.lerpSelf(f.vertexNormals[1],0.5);g=f.vertexNormals[2].clone();g.lerpSelf(f.vertexNormals[3],0.5);v.vertexNormals[1].copy(e);
v.vertexNormals[2].copy(g);s.vertexNormals[0].copy(e);s.vertexNormals[3].copy(g)}if(f.vertexColors.length===4){e=f.vertexColors[0].clone();e.lerpSelf(f.vertexColors[1],0.5);g=f.vertexColors[2].clone();g.lerpSelf(f.vertexColors[3],0.5);v.vertexColors[1].copy(e);v.vertexColors[2].copy(g);s.vertexColors[0].copy(e);s.vertexColors[3].copy(g)}f=0}else{p=j.clone();p.lerpSelf(o,0.5);j=m.clone();j.lerpSelf(l,0.5);v.a=e;v.b=g;v.c=r;v.d=u;s.a=u;s.b=r;s.c=h;s.d=i;if(f.vertexNormals.length===4){e=f.vertexNormals[1].clone();
e.lerpSelf(f.vertexNormals[2],0.5);g=f.vertexNormals[3].clone();g.lerpSelf(f.vertexNormals[0],0.5);v.vertexNormals[2].copy(e);v.vertexNormals[3].copy(g);s.vertexNormals[0].copy(g);s.vertexNormals[1].copy(e)}if(f.vertexColors.length===4){e=f.vertexColors[1].clone();e.lerpSelf(f.vertexColors[2],0.5);g=f.vertexColors[3].clone();g.lerpSelf(f.vertexColors[0],0.5);v.vertexColors[2].copy(e);v.vertexColors[3].copy(g);s.vertexColors[0].copy(g);s.vertexColors[1].copy(e)}f=1}B.push(v,s);a.vertices.push(p,j);
e=0;for(g=a.faceVertexUvs.length;e<g;e++)if(a.faceVertexUvs[e].length){l=a.faceVertexUvs[e][c];s=l[0];h=l[1];v=l[2];l=l[3];if(f===0){j=s.clone();j.lerpSelf(h,0.5);o=v.clone();o.lerpSelf(l,0.5);s=[s.clone(),j.clone(),o.clone(),l.clone()];h=[j.clone(),h.clone(),v.clone(),o.clone()]}else{j=h.clone();j.lerpSelf(v,0.5);o=l.clone();o.lerpSelf(s,0.5);s=[s.clone(),h.clone(),j.clone(),o.clone()];h=[o.clone(),j.clone(),v.clone(),l.clone()]}y[e].push(s,h)}}else{B.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)y[e].push(a.faceVertexUvs[e][c])}}}a.faces=
B;a.faceVertexUvs=y}};THREE.GeometryUtils.random=THREE.Math.random16;THREE.GeometryUtils.__v1=new THREE.Vector3;
...
f.loadCount+1;if(f.loadCount===6){e.needsUpdate=true;c&&c()}};f[b].crossOrigin=this.crossOrigin;f[b].src=a[b]}return e},getNormalMap:function(a,b){var c=function(a){var b=Math.sqrt(a[0]*a[0]+a[1]*a[1]+a[2]*a[2]);return[a[0]/b,a[1]/b,a[2]/b]},b=b|1,d=a.width,f=a.height,e=document.createElement("canvas");e.width=d;e.height=f;var g=e.getContext("2d");g.drawImage(a,0,0);for(var h=g.getImageData(0,0,d,f).data,i=g.createImageData(d,f),l=i.data,j=0;j<d;j++)for(var o=0;o<f;o++){var m=o-1<0?0:o-1,p=o+1>f-
1?f-1:o+1,q=j-1<0?0:j-1,n=j+1>d-1?d-1:j+1,t=[],r=[0,0,h[(o*d+j)*4]/255*b];t.push([-1,0,h[(o*d+q)*4]/255*b]);t.push([-1,-1,h[(m*d+q)*4]/255*b]);t.push([0,-1,h[(m*d+j)*4]/255*b]);t.push([1,-1,h[(m*d+n)*4]/255*b]);t.push([1,0,h[(o*d+n)*4]/255*b]);t.push([1,1,h[(p*d+n)*4]/255*b]);t.push([0,1,h[(p*d+j)*4]/255*b]);t.push([-1,1,h[(p*d+q)*4]/255*b]);m=[];q=t.length;for(p=0;p<q;p++){var n=t[p],u=t[(p+1)%q],n=[n[0]-r[0],n[1]-r[1],n[2]-r[2]],u=[u[0]-r[0],u[1]-r[1],u[2]-r[2]];m.push(c([n[1]*u[2]-n[2]*u[1],n[2]*
u[0]-n[0]*u[2],n[0]*u[1]-n[1]*u[0]]))}t=[0,0,0];for(p=0;p<m.length;p++){t[0]=t[0]+m[p][0];t[1]=t[1]+m[p][1];t[2]=t[2]+m[p][2]}t[0]=t[0]/m.length;t[1]=t[1]/m.length;t[2]=t[2]/m.length;r=(o*d+j)*4;l[r]=(t[0]+1)/2*255|0;l[r+1]=(t[1]+1)/2*255|0;l[r+2]=t[2]*255|0;l[r+3]=255}g.putImageData(i,0,0);return e},generateDataTexture:function(a,b,c){for(var d=a*b,f=new Uint8Array(3*d),e=Math.floor(c.r*255),g=Math.floor(c.g*255),c=Math.floor(c.b*255),h=0;h<d;h++){f[h*3]=e;f[h*3+1]=g;f[h*3+2]=c}a=new THREE.DataTexture(f,
...
(function(a){var b=function(a){for(var b=a.length,f=0,e=b-1,g=0;g<b;e=g++)f=f+(a[e].x*a[g].y-a[g].x*a[e].y);return f*0.5};a.Triangulate=function(a,d){var f=a.length;if(f<3)return null;var e=[],g=[],h=[],i,l,j;if(b(a)>0)for(l=0;l<f;l++)g[l]=l;else for(l=0;l<f;l++)g[l]=f-1-l;var o=2*f;for(l=f-1;f>2;){if(o--<=0){console.log("Warning, unable to triangulate polygon!");break}i=l;f<=i&&(i=0);l=i+1;f<=l&&(l=0);j=l+1;f<=j&&(j=0);var m;a:{m=a;var p=i,q=l,n=j,t=f,r=g,u=void 0,v=void 0,s=void 0,B=void 0,y=void 0,
A=void 0,G=void 0,x=void 0,I=void 0,v=m[r[p]].x,s=m[r[p]].y,B=m[r[q]].x,y=m[r[q]].y,A=m[r[n]].x,G=m[r[n]].y;if(1E-10>(B-v)*(G-s)-(y-s)*(A-v))m=false;else{for(u=0;u<t;u++)if(!(u==p||u==q||u==n)){var x=m[r[u]].x,I=m[r[u]].y,F=void 0,L=void 0,H=void 0,M=void 0,C=void 0,E=void 0,P=void 0,N=void 0,Q=void 0,Z=void 0,J=void 0,K=void 0,F=H=C=void 0,F=A-B,L=G-y,H=v-A,M=s-G,C=B-v,E=y-s,P=x-v,N=I-s,Q=x-B,Z=I-y,J=x-A,K=I-G,F=F*Z-L*Q,C=C*N-E*P,H=H*K-M*J;if(F>=0&&H>=0&&C>=0){m=false;break a}}m=true}}if(m){e.push([a[g[i]],
...
THREE.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*e.autoRotateSpeed}function d(a){a.preventDefault();if(u===r.ROTATE){i.set(a.clientX,a.clientY);l.sub(i,h);e.rotateLeft(2*Math.PI*l.x/g*e.userRotateSpeed);e.rotateUp(2*Math.PI*l.y/g*e.userRotateSpeed);h.copy(i)}else if(u===r.ZOOM){o.set(a.clientX,a.clientY);m.sub(o,j);m.y>0?e.zoomIn():e.zoomOut();j.copy(o)}}function f(){if(e.userRotate){document.removeEventListener("mousemove",d,false);document.removeEventListener("mouseup",f,false);
u=r.NONE}}THREE.EventTarget.call(this);this.object=a;this.domElement=b!==void 0?b:document;this.center=new THREE.Vector3;this.userZoom=true;this.userZoomSpeed=1;this.userRotate=true;this.userRotateSpeed=1;this.autoRotate=false;this.autoRotateSpeed=2;var e=this,g=1800,h=new THREE.Vector2,i=new THREE.Vector2,l=new THREE.Vector2,j=new THREE.Vector2,o=new THREE.Vector2,m=new THREE.Vector2,p=0,q=0,n=1,t=new THREE.Vector3,r={NONE:-1,ROTATE:0,ZOOM:1},u=r.NONE,v={type:"change"};this.rotateLeft=function(a){a===
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function i(a,b,c,g,h,i,j,m){var o,n=d||1,p=f||1,q=h/2,r=i/2,t=l.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")o="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){o="y";p=e||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){o="x";n=e||1}var u=n+1,v=p+1,Z=h/n,J=i/p,K=new THREE.Vector3;K[o]=j>0?1:-1;for(h=0;h<v;h++)for(i=0;i<u;i++){var ea=new THREE.Vector3;ea[a]=(i*Z-q)*c;ea[b]=(h*J-r)*g;ea[o]=j;l.vertices.push(ea)}for(h=0;h<p;h++)for(i=0;i<n;i++){a=new THREE.Face4(i+
u*h+t,i+u*(h+1)+t,i+1+u*(h+1)+t,i+1+u*h+t);a.normal.copy(K);a.vertexNormals.push(K.clone(),K.clone(),K.clone(),K.clone());a.materialIndex=m;l.faces.push(a);l.faceVertexUvs[0].push([new THREE.UV(i/n,1-h/p),new THREE.UV(i/n,1-(h+1)/p),new THREE.UV((i+1)/n,1-(h+1)/p),new THREE.UV((i+1)/n,1-h/p)])}}THREE.Geometry.call(this);var l=this,j=a/2,o=b/2,m=c/2,p,q,n,t,r,u;if(g!==void 0){if(g instanceof Array)this.materials=g;else{this.materials=[];for(p=0;p<6;p++)this.materials.push(g)}p=0;t=1;q=2;r=3;n=4;u=
5}else this.materials=[];this.sides={px:true,nx:true,py:true,ny:true,pz:true,nz:true};if(h!=void 0)for(var v in h)this.sides[v]!==void 0&&(this.sides[v]=h[v]);this.sides.px&&i("z","y",-1,-1,c,b,j,p);this.sides.nx&&i("z","y",1,-1,c,b,-j,t);this.sides.py&&i("x","z",1,1,a,c,o,q);this.sides.ny&&i("x","z",1,-1,a,c,-o,r);this.sides.pz&&i("x","y",1,-1,a,b,m,n);this.sides.nz&&i("x","y",-1,-1,a,b,-m,u);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
this.vertices[l[0][h+1]].clone()}else{o=this.vertices[l[1][h]].clone();m=this.vertices[l[1][h+1]].clone()}o.setY(Math.sqrt(o.x*o.x+o.z*o.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<f;i++){var p=l[i][h],q=l[i+1][h],n=l[i+1][h+1],t=l[i][h+1],r=o.clone(),u=o.clone(),v=m.clone(),s=m.clone(),B=j[i][h].clone(),y=j[i+1][h].clone(),A=j[i+1][h+1].clone(),G=j[i][h+1].clone();this.faces.push(new THREE.Face4(p,q,n,t,[r,u,v,s]));this.faceVertexUvs[0].push([B,y,A,G])}}if(!e&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){p=l[0][h];q=l[0][h+1];n=this.vertices.length-1;r=new THREE.Vector3(0,1,0);u=new THREE.Vector3(0,1,0);v=new THREE.Vector3(0,1,0);B=j[0][h].clone();y=j[0][h+1].clone();A=new THREE.UV(y.u,0);this.faces.push(new THREE.Face3(p,q,n,[r,u,v]));this.faceVertexUvs[0].push([B,y,A])}}if(!e&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){p=l[i][h+1];q=l[i][h];n=this.vertices.length-1;r=new THREE.Vector3(0,-1,0);u=new THREE.Vector3(0,
-1,0);v=new THREE.Vector3(0,-1,0);B=j[i][h+1].clone();y=j[i][h].clone();A=new THREE.UV(y.u,1);this.faces.push(new THREE.Face3(p,q,n,[r,u,v]));this.faceVertexUvs[0].push([B,y,A])}}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
c.length-1);for(var g=0,h=m+j*2,g=0;g<h;g++){var i=Q*g,l=Q*(g+1),o=d+e+i,i=d+f+i,n=d+f+l,l=d+e+l,p=c,q=g,t=h,s=e,v=f,o=o+F,i=i+F,n=n+F,l=l+F;I.faces.push(new THREE.Face4(o,i,n,l,null,null,r));o=u.generateSideWallUV(I,a,p,b,o,i,n,l,q,t,s,v);I.faceVertexUvs[0].push(o)}}}function e(a,b,c){I.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+F;d=d+F;e=e+F;I.faces.push(new THREE.Face3(c,d,e,null,null,t));c=f?u.generateBottomUV(I,a,b,c,d,e):u.generateTopUV(I,a,b,c,d,e);I.faceVertexUvs[0].push(c)}
var h=b.amount!==void 0?b.amount:100,i=b.bevelThickness!==void 0?b.bevelThickness:6,l=b.bevelSize!==void 0?b.bevelSize:i-2,j=b.bevelSegments!==void 0?b.bevelSegments:3,o=b.bevelEnabled!==void 0?b.bevelEnabled:true,m=b.steps!==void 0?b.steps:1,p=b.extrudePath,q,n=false,t=b.material,r=b.extrudeMaterial,u=b.UVGenerator!==void 0?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,v,s,B,y;if(p){q=p.getSpacedPoints(m);n=true;o=false;v=b.frames!==void 0?b.frames:new THREE.TubeGeometry.FrenetFrames(p,m,
false);s=new THREE.Vector3;B=new THREE.Vector3;y=new THREE.Vector3}if(!o)l=i=j=0;var A,G,x,I=this,F=this.vertices.length,p=a.extractPoints(),L=p.shape,p=p.holes,H=!THREE.Shape.Utils.isClockWise(L);if(H){L=L.reverse();G=0;for(x=p.length;G<x;G++){A=p[G];THREE.Shape.Utils.isClockWise(A)&&(p[G]=A.reverse())}H=false}var M=THREE.Shape.Utils.triangulateShape(L,p),H=L;G=0;for(x=p.length;G<x;G++){A=p[G];L=L.concat(A)}var C,E,P,N,Q=L.length,Z=M.length,J=[],K=0,ea=H.length;C=ea-1;for(E=K+1;K<ea;K++,C++,E++){C===
ea&&(C=0);E===ea&&(E=0);J[K]=d(H[K],H[C],H[E])}var O=[],ra,wa=J.concat();G=0;for(x=p.length;G<x;G++){A=p[G];ra=[];K=0;ea=A.length;C=ea-1;for(E=K+1;K<ea;K++,C++,E++){C===ea&&(C=0);E===ea&&(E=0);ra[K]=d(A[K],A[C],A[E])}O.push(ra);wa=wa.concat(ra)}for(C=0;C<j;C++){A=C/j;P=i*(1-A);E=l*Math.sin(A*Math.PI/2);K=0;for(ea=H.length;K<ea;K++){N=c(H[K],J[K],E);e(N.x,N.y,-P)}G=0;for(x=p.length;G<x;G++){A=p[G];ra=O[G];K=0;for(ea=A.length;K<ea;K++){N=c(A[K],ra[K],E);e(N.x,N.y,-P)}}}E=l;for(K=0;K<Q;K++){N=o?c(L[K],
wa[K],E):L[K];if(n){B.copy(v.normals[0]).multiplyScalar(N.x);s.copy(v.binormals[0]).multiplyScalar(N.y);y.copy(q[0]).addSelf(B).addSelf(s);e(y.x,y.y,y.z)}else e(N.x,N.y,0)}for(A=1;A<=m;A++)for(K=0;K<Q;K++){N=o?c(L[K],wa[K],E):L[K];if(n){B.copy(v.normals[A]).multiplyScalar(N.x);s.copy(v.binormals[A]).multiplyScalar(N.y);y.copy(q[A]).addSelf(B).addSelf(s);e(y.x,y.y,y.z)}else e(N.x,N.y,h/m*A)}for(C=j-1;C>=0;C--){A=C/j;P=i*(1-A);E=l*Math.sin(A*Math.PI/2);K=0;for(ea=H.length;K<ea;K++){N=c(H[K],J[K],E);
e(N.x,N.y,h+P)}G=0;for(x=p.length;G<x;G++){A=p[G];ra=O[G];K=0;for(ea=A.length;K<ea;K++){N=c(A[K],ra[K],E);n?e(N.x,N.y+q[m-1].y,q[m-1].x+P):e(N.x,N.y,h+P)}}}if(o){i=Q*0;for(K=0;K<Z;K++){h=M[K];g(h[2]+i,h[1]+i,h[0]+i,true)}i=Q*(m+j*2);for(K=0;K<Z;K++){h=M[K];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(K=0;K<Z;K++){h=M[K];g(h[2],h[1],h[0],true)}for(K=0;K<Z;K++){h=M[K];g(h[0]+Q*m,h[1]+Q*m,h[2]+Q*m,false)}}h=0;f(H,h);h=h+H.length;G=0;for(x=p.length;G<x;G++){A=p[G];f(A,h);h=h+A.length}};
...
1-q))}l.push(o);j.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=l[i][h+1],f=l[i][h],e=l[i+1][h],g=l[i+1][h+1],o=this.vertices[d].clone().normalize(),m=this.vertices[f].clone().normalize(),p=this.vertices[e].clone().normalize(),q=this.vertices[g].clone().normalize(),n=j[i][h+1].clone(),t=j[i][h].clone(),r=j[i+1][h].clone(),u=j[i+1][h+1].clone();if(Math.abs(this.vertices[d].y)==a){this.faces.push(new THREE.Face3(d,e,g,[o,p,q]));this.faceVertexUvs[0].push([n,r,u])}else if(Math.abs(this.vertices[e].y)==
...
THREE.SubdivisionModifier.prototype.smooth=function(a){function b(){j.debug&&console.log.apply(console,arguments)}function c(){console&&console.log.apply(console,arguments)}function d(a,c,d,f,g,h,m){var o=new THREE.Face4(a,c,d,f,null,g.color,g.materialIndex);if(j.useOldVertexColors){o.vertexColors=[];for(var n,p,q,r=0;r<4;r++){q=h[r];n=new THREE.Color;n.setRGB(0,0,0);for(var t=0;t<q.length;t++){p=g.vertexColors[q[t]-1];n.r=n.r+p.r;n.g=n.g+p.g;n.b=n.b+p.b}n.r=n.r/q.length;n.g=n.g/q.length;n.b=n.b/
...
[],i=[],l=[],j=this,o=a.vertices,m=a.faces,h=o.concat(),p=[],q={},n={},t={},r=o.length,u,v,s,B,y,A=a.faceVertexUvs[0];b("originalFaces, uvs, originalVerticesLength",m.length,A.length,r);if(j.supportUVs){u=0;for(v=A.length;u<v;u++){s=0;for(B=A[u].length;s<B;s++){y=m[u]["abcd".charAt(s)];g(y,u,A[u][s])}}}if(A.length==0)j.supportUVs=false;u=0;for(var G in t)u++;if(!u){j.supportUVs=false;b("no uvs")}b("-- Original Faces + Vertices UVs completed",t,"vs",A.length);var x;u=0;for(v=m.length;u<v;u++){y=m[u];
p.push(y.centroid);h.push(y.centroid);if(j.supportUVs){x=new THREE.UV;if(y instanceof THREE.Face3){x.u=e(y.a,u).u+e(y.b,u).u+e(y.c,u).u;x.v=e(y.a,u).v+e(y.b,u).v+e(y.c,u).v;x.u=x.u/3;x.v=x.v/3}else if(y instanceof THREE.Face4){x.u=e(y.a,u).u+e(y.b,u).u+e(y.c,u).u+e(y.d,u).u;x.v=e(y.a,u).v+e(y.b,u).v+e(y.c,u).v+e(y.d,u).v;x.u=x.u/4;x.v=x.v/4}g(r+u,"",x)}}b("-- added UVs for new Faces",t);G=function(a,b){I[a]===void 0&&(I[a]=[]);I[a].push(b)};var I={},A=0;for(v=a.faces.length;A<v;A++){y=a.faces[A];
if(y instanceof THREE.Face3){x=f(y.a,y.b);G(x,A);x=f(y.b,y.c);G(x,A);x=f(y.c,y.a);G(x,A)}else if(y instanceof THREE.Face4){x=f(y.a,y.b);G(x,A);x=f(y.b,y.c);G(x,A);x=f(y.c,y.d);G(x,A);x=f(y.d,y.a);G(x,A)}}v=I;var F=0,L,H;G={};A={};for(u in v){x=v[u];L=u.split("_");H=L[0];L=L[1];s=H;y=[H,L];G[s]===void 0&&(G[s]=[]);G[s].push(y);s=L;y=[H,L];G[s]===void 0&&(G[s]=[]);G[s].push(y);s=0;for(B=x.length;s<B;s++){y=x[s];var M=H,C=y,E=u;A[M]===void 0&&(A[M]={});A[M][C]=E;M=L;C=u;A[M]===void 0&&(A[M]={});A[M][y]=
C}x.length<2&&(n[u]=true)}b("vertexEdgeMap",G,"vertexFaceMap",A);for(u in v){x=v[u];y=x[0];B=x[1];L=u.split("_");H=L[0];L=L[1];x=new THREE.Vector3;if(n[u]){x.addSelf(o[H]);x.addSelf(o[L]);x.multiplyScalar(0.5)}else{x.addSelf(p[y]);x.addSelf(p[B]);x.addSelf(o[H]);x.addSelf(o[L]);x.multiplyScalar(0.25)}q[u]=r+m.length+F;h.push(x);F++;if(j.supportUVs){x=new THREE.UV;x.u=e(H,y).u+e(L,y).u;x.v=e(H,y).v+e(L,y).v;x.u=x.u/2;x.v=x.v/2;g(q[u],y,x);if(!n[u]){x=new THREE.UV;x.u=e(H,B).u+e(L,B).u;x.v=e(H,B).v+
e(L,B).v;x.u=x.u/2;x.v=x.v/2;g(q[u],B,x)}}}b("-- Step 2 done");var P,N;L=["123","12","2","23"];B=["123","23","3","31"];var M=["123","31","1","12"],C=["1234","12","2","23"],E=["1234","23","3","34"],Q=["1234","34","4","41"],Z=["1234","41","1","12"];u=0;for(v=p.length;u<v;u++){y=m[u];x=r+u;if(y instanceof THREE.Face3){F=f(y.a,y.b);H=f(y.b,y.c);P=f(y.c,y.a);d(x,q[F],y.b,q[H],y,L,u);d(x,q[H],y.c,q[P],y,B,u);d(x,q[P],y.a,q[F],y,M,u)}else if(y instanceof THREE.Face4){F=f(y.a,y.b);H=f(y.b,y.c);P=f(y.c,y.d);
N=f(y.d,y.a);d(x,q[F],y.b,q[H],y,C,u);d(x,q[H],y.c,q[P],y,E,u);d(x,q[P],y.d,q[N],y,Q,u);d(x,q[N],y.a,q[F],y,Z,u)}else b("face should be a face!",y)}q=new THREE.Vector3;y=new THREE.Vector3;u=0;for(v=o.length;u<v;u++)if(G[u]!==void 0){q.set(0,0,0);y.set(0,0,0);H=new THREE.Vector3(0,0,0);x=0;for(s in A[u]){q.addSelf(p[s]);x++}L=0;F=G[u].length;for(s=0;s<F;s++)n[f(G[u][s][0],G[u][s][1])]&&L++;if(L!=2){q.divideScalar(x);for(s=0;s<F;s++){x=G[u][s];x=o[x[0]].clone().addSelf(o[x[1]]).divideScalar(2);y.addSelf(x)}y.divideScalar(F);
H.addSelf(o[u]);H.multiplyScalar(F-3);H.addSelf(q);H.addSelf(y.multiplyScalar(2));H.divideScalar(F);h[u]=H}}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=l;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);
...
"color");m.scale=b.getUniformLocation(j,"scale");m.rotation=b.getUniformLocation(j,"rotation");m.screenPosition=b.getUniformLocation(j,"screenPosition");p=false};this.render=function(a,d,f,r){var a=a.__webglFlares,u=a.length;if(u){var v=new THREE.Vector3,s=r/f,B=f*0.5,y=r*0.5,A=16/r,G=new THREE.Vector2(A*s,A),x=new THREE.Vector3(1,1,0),I=new THREE.Vector2(1,1),F=m,A=o;b.useProgram(j);if(!p){b.enableVertexAttribArray(o.vertex);b.enableVertexAttribArray(o.uv);p=true}b.uniform1i(F.occlusionMap,0);b.uniform1i(F.map,
1);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(A.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(A.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var L,H,M,C,E;for(L=0;L<u;L++){A=16/r;G.set(A*s,A);C=a[L];v.set(C.matrixWorld.elements[12],C.matrixWorld.elements[13],C.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(v);d.projectionMatrix.multiplyVector3(v);x.copy(v);I.x=x.x*B+B;I.y=x.y*y+y;if(l||I.x>0&&I.x<f&&I.y>0&&
...
u.shadowCascadeBias[v];r=u.shadowCascadeNearZ[v];u=u.shadowCascadeFarZ[v];s=s.pointsFrustum;s[0].z=r;s[1].z=r;s[2].z=r;s[3].z=r;s[4].z=u;s[5].z=u;s[6].z=u;s[7].z=u;B[n]=y;n++}else{B[n]=q;n++}}m=0;for(p=B.length;m<p;m++){q=B[m];if(!q.shadowMap){q.shadowMap=new THREE.WebGLRenderTarget(q.shadowMapWidth,q.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});q.shadowMapSize=new THREE.Vector2(q.shadowMapWidth,q.shadowMapHeight);q.shadowMatrix=new THREE.Matrix4}if(!q.shadowCamera){if(q instanceof
...
l.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");j=false};this.render=function(d,f,p,q){var d=d.__webglSprites,n=d.length;if(n){var t=i,r=l,u=q/p,p=p*0.5,v=q*0.5,s=true;b.useProgram(h);if(!j){b.enableVertexAttribArray(t.position);b.enableVertexAttribArray(t.uv);j=true}b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(true);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(t.position,2,b.FLOAT,false,16,0);b.vertexAttribPointer(t.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,
g);b.uniformMatrix4fv(r.projectionMatrix,false,f._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(r.map,0);for(var B,y=[],t=0;t<n;t++){B=d[t];if(B.visible&&B.opacity!==0)if(B.useScreenCoordinates)B.z=-B.position.z;else{B._modelViewMatrix.multiply(f.matrixWorldInverse,B.matrixWorld);B.z=-B._modelViewMatrix.elements[14]}}d.sort(a);for(t=0;t<n;t++){B=d[t];if(B.visible&&B.opacity!==0&&B.map&&B.map.image&&B.map.image.width){if(B.useScreenCoordinates){b.uniform1i(r.useScreenCoordinates,1);
b.uniform3f(r.screenPosition,(B.position.x-p)/p,(v-B.position.y)/v,Math.max(0,Math.min(1,B.position.z)))}else{b.uniform1i(r.useScreenCoordinates,0);b.uniform1i(r.affectedByDistance,B.affectedByDistance?1:0);b.uniformMatrix4fv(r.modelViewMatrix,false,B._modelViewMatrix.elements)}f=B.map.image.width/(B.scaleByViewport?q:1);y[0]=f*u*B.scale.x;y[1]=f*B.scale.y;b.uniform2f(r.uvScale,B.uvScale.x,B.uvScale.y);b.uniform2f(r.uvOffset,B.uvOffset.x,B.uvOffset.y);b.uniform2f(r.alignment,B.alignment.x,B.alignment.y);
b.uniform1f(r.opacity,B.opacity);b.uniform3f(r.color,B.color.r,B.color.g,B.color.b);b.uniform1f(r.rotation,B.rotation);b.uniform2fv(r.scale,y);if(B.mergeWith3D&&!s){b.enable(b.DEPTH_TEST);s=true}else if(!B.mergeWith3D&&s){b.disable(b.DEPTH_TEST);s=false}c.setBlending(B.blending,B.blendEquation,B.blendSrc,B.blendDst);c.setTexture(B.map,0);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
