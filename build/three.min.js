...
w=d[12],v=d[1],C=d[5],E=d[9],H=d[13],O=d[2],B=d[6],L=d[10],I=d[14],G=d[3],Q=d[7],N=d[11],d=d[15];e[0]=f*s+g*v+h*O+i*G;e[4]=f*D+g*C+h*B+i*Q;e[8]=f*z+g*E+h*L+i*N;e[12]=f*w+g*H+h*I+i*d;e[1]=j*s+m*v+n*O+l*G;e[5]=j*D+m*C+n*B+l*Q;e[9]=j*z+m*E+n*L+l*N;e[13]=j*w+m*H+n*I+l*d;e[2]=o*s+p*v+q*O+t*G;e[6]=o*D+p*C+q*B+t*Q;e[10]=o*z+p*E+q*L+t*N;e[14]=o*w+p*H+q*I+t*d;e[3]=r*s+A*v+u*O+c*G;e[7]=r*D+A*C+u*B+c*Q;e[11]=r*z+A*E+u*L+c*N;e[15]=r*w+A*H+u*I+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
p=o.vertices,D=h.geometry.materials,z=h.material instanceof a.MeshFaceMaterial,m=h.material.side,w,v,C,E=i.precision;h.matrixRotationWorld.extractRotation(h.matrixWorld);b.copy(i.origin);g.getInverse(h.matrixWorld);c.copy(b);g.multiplyVector3(c);d.copy(i.direction);g.rotateAxis(d).normalize();for(var H=0,O=o.faces.length;H<O;H++){var B=o.faces[H],m=!0===z?D[B.materialIndex]:h.material;if(void 0!==m&&(m=m.side,e.sub(B.centroid,c),v=B.normal,w=d.dot(v),!(Math.abs(w)<E)&&(v=v.dot(e)/w,!(0>v)&&(m===a.DoubleSide||
(m===a.FrontSide?0>w:0<w)))))if(f.add(c,d.multiplyScalar(v)),B instanceof a.Face3)m=p[B.a],w=p[B.b],v=p[B.c],l(f,m,w,v)&&(w=h.matrixWorld.multiplyVector3(f.clone()),m=b.distanceTo(w),m<i.near||m>i.far||j.push({distance:m,point:w,face:B,faceIndex:H,object:h}));else if(B instanceof a.Face4&&(m=p[B.a],w=p[B.b],v=p[B.c],C=p[B.d],l(f,m,w,C)||l(f,w,v,C)))w=h.matrixWorld.multiplyVector3(f.clone()),m=b.distanceTo(w),m<i.near||m>i.far||j.push({distance:m,point:w,face:B,faceIndex:H,object:h})}}},p=function(a,
...
c)return!1;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return!0}var e,f,g=[],h=0,i,j,m=[],n=0,l,o,p=[],q=0,t,r=[],A=0,u,s,D=[],z=0,w,v,C=[],E=0,H={objects:[],sprites:[],lights:[],elements:[]},O=new THREE.Vector3,B=new THREE.Vector4,L=new THREE.Matrix4,I=new THREE.Matrix4,G=new THREE.Frustum,Q=new THREE.Vector4,N=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);L.multiply(b.projectionMatrix,b.matrixWorldInverse);L.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);L.multiply(b.matrixWorld,b.projectionMatrixInverse);L.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n,M){var R=h.near,T=h.far,J=!1,ra,S,ha,V,ba,ia,Z,fa,Ma,Pa,Aa,Ta,ua,cb,wb,Ua;v=s=t=o=0;H.elements.length=0;g.updateMatrixWorld();void 0===h.parent&&
...
(O.copy(f.matrixWorld.getPosition()),L.multiplyVector3(O),e.z=O.z),H.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(O.copy(f.matrixWorld.getPosition()),L.multiplyVector3(O),e.z=O.z),H.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(O.copy(f.matrixWorld.getPosition()),L.multiplyVector3(O),e.z=O.z),H.objects.push(e));fb(f)}}};fb(g);!0===n&&H.objects.sort(c);g=0;for(n=H.objects.length;g<
n;g++)if(fa=H.objects[g].object,Ma=fa.matrixWorld,j=0,fa instanceof THREE.Mesh){Pa=fa.geometry;Aa=fa.geometry.materials;ha=Pa.vertices;Ta=Pa.faces;cb=Pa.faceVertexUvs;Pa=fa.matrixRotationWorld.extractRotation(Ma);wb=fa.material instanceof THREE.MeshFaceMaterial;ra=0;for(S=ha.length;ra<S;ra++)i=b(),i.positionWorld.copy(ha[ra]),Ma.multiplyVector3(i.positionWorld),i.positionScreen.copy(i.positionWorld),L.multiplyVector4(i.positionScreen),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,
i.visible=i.positionScreen.z>R&&i.positionScreen.z<T;ha=0;for(ra=Ta.length;ha<ra;ha++)if(S=Ta[ha],Ua=!0===wb?Aa[S.materialIndex]:fa.material,void 0!==Ua){ia=Ua.side;if(S instanceof THREE.Face3)if(V=m[S.a],ba=m[S.b],Z=m[S.c],!0===V.visible&&!0===ba.visible&&!0===Z.visible)if(J=0>(Z.positionScreen.x-V.positionScreen.x)*(ba.positionScreen.y-V.positionScreen.y)-(Z.positionScreen.y-V.positionScreen.y)*(ba.positionScreen.x-V.positionScreen.x),ia===THREE.DoubleSide||J===(ia===THREE.FrontSide))o===q?(ua=
new THREE.RenderableFace3,p.push(ua),q++,o++,l=ua):l=p[o++],l.v1.copy(V),l.v2.copy(ba),l.v3.copy(Z);else continue;else continue;else if(S instanceof THREE.Face4)if(V=m[S.a],ba=m[S.b],Z=m[S.c],ua=m[S.d],!0===V.visible&&!0===ba.visible&&!0===Z.visible&&!0===ua.visible)if(J=0>(ua.positionScreen.x-V.positionScreen.x)*(ba.positionScreen.y-V.positionScreen.y)-(ua.positionScreen.y-V.positionScreen.y)*(ba.positionScreen.x-V.positionScreen.x)||0>(ba.positionScreen.x-Z.positionScreen.x)*(ua.positionScreen.y-
Z.positionScreen.y)-(ba.positionScreen.y-Z.positionScreen.y)*(ua.positionScreen.x-Z.positionScreen.x),ia===THREE.DoubleSide||J===(ia===THREE.FrontSide)){if(t===A){var kb=new THREE.RenderableFace4;r.push(kb);A++;t++;l=kb}else l=r[t++];l.v1.copy(V);l.v2.copy(ba);l.v3.copy(Z);l.v4.copy(ua)}else continue;else continue;l.normalWorld.copy(S.normal);!1===J&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&l.normalWorld.negate();Pa.multiplyVector3(l.normalWorld);l.centroidWorld.copy(S.centroid);Ma.multiplyVector3(l.centroidWorld);
l.centroidScreen.copy(l.centroidWorld);L.multiplyVector3(l.centroidScreen);Z=S.vertexNormals;V=0;for(ba=Z.length;V<ba;V++)ua=l.vertexNormalsWorld[V],ua.copy(Z[V]),!1===J&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&ua.negate(),Pa.multiplyVector3(ua);l.vertexNormalsLength=Z.length;V=0;for(ba=cb.length;V<ba;V++)if(ua=cb[V][ha],void 0!==ua){ia=0;for(Z=ua.length;ia<Z;ia++)l.uvs[V][ia]=ua[ia]}l.color=S.color;l.material=Ua;l.z=l.centroidScreen.z;H.elements.push(l)}}else if(fa instanceof THREE.Line){I.multiply(L,
Ma);ha=fa.geometry.vertices;V=b();V.positionScreen.copy(ha[0]);I.multiplyVector4(V.positionScreen);Ma=fa.type===THREE.LinePieces?2:1;ra=1;for(S=ha.length;ra<S;ra++)V=b(),V.positionScreen.copy(ha[ra]),I.multiplyVector4(V.positionScreen),0<(ra+1)%Ma||(ba=m[j-2],Q.copy(V.positionScreen),N.copy(ba.positionScreen),!0===d(Q,N)&&(Q.multiplyScalar(1/Q.w),N.multiplyScalar(1/N.w),s===z?(Aa=new THREE.RenderableLine,D.push(Aa),z++,s++,u=Aa):u=D[s++],u.v1.positionScreen.copy(Q),u.v2.positionScreen.copy(N),u.z=
Math.max(Q.z,N.z),u.material=fa.material,H.elements.push(u)))}g=0;for(n=H.sprites.length;g<n;g++)fa=H.sprites[g].object,Ma=fa.matrixWorld,fa instanceof THREE.Particle&&(B.set(Ma.elements[12],Ma.elements[13],Ma.elements[14],1),L.multiplyVector4(B),B.z/=B.w,0<B.z&&1>B.z&&(v===E?(R=new THREE.RenderableParticle,C.push(R),E++,v++,w=R):w=C[v++],w.object=fa,w.x=B.x/B.w,w.y=B.y/B.w,w.z=B.z,w.rotation=fa.rotation.z,w.scale.x=fa.scale.x*Math.abs(w.x-(B.x+h.projectionMatrix.elements[0])/(B.w+h.projectionMatrix.elements[12])),
w.scale.y=fa.scale.y*Math.abs(w.y-(B.y+h.projectionMatrix.elements[5])/(B.w+h.projectionMatrix.elements[13])),w.material=fa.material,H.elements.push(w)));!0===M&&H.elements.sort(c);return H}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=void 0!==d?d:1};
...
2]+=r.z,h[3*j]+=r.x,h[3*j+1]+=r.y,h[3*j+2]+=r.z,h[3*m]+=r.x,h[3*m+1]+=r.y,h[3*m+2]+=r.z}a=0;for(b=h.length;a<b;a+=3)n=h[a],l=h[a+1],o=h[a+2],c=1/Math.sqrt(n*n+l*l+o*o),h[a]*=c,h[a+1]*=c,h[a+2]*=c;this.normalsNeedUpdate=!0}},computeTangents:function(){function a(a){aa.x=d[3*a];aa.y=d[3*a+1];aa.z=d[3*a+2];P.copy(aa);R=i[a];N.copy(R);N.subSelf(aa.multiplyScalar(aa.dot(R))).normalize();K.cross(P,R);T=K.dot(j[a]);M=0>T?-1:1;h[4*a]=N.x;h[4*a+1]=N.y;h[4*a+2]=N.z;h[4*a+3]=M}if(void 0===this.attributes.index||
...
i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var m,n,l,o,p,q,t,r,A,u,s,D,z,w,v,f=new THREE.Vector3,g=new THREE.Vector3,C,E,H,O,B,L,I,G=this.offsets;H=0;for(O=G.length;H<O;++H){E=G[H].start;B=G[H].count;var Q=G[H].index;C=E;for(E+=B;C<E;C+=3)B=Q+b[C],L=Q+b[C+1],I=Q+b[C+2],m=c[3*B],n=c[3*B+1],l=c[3*B+2],o=c[3*L],p=c[3*L+1],q=c[3*L+2],t=c[3*I],r=c[3*I+1],A=c[3*I+2],u=e[2*B],s=e[2*B+1],D=e[2*L],z=e[2*L+1],w=e[2*I],v=e[2*I+1],o-=m,m=t-m,p-=n,n=r-n,q-=l,l=A-l,D-=u,u=w-u,z-=s,s=v-
s,v=1/(D*s-u*z),f.set((s*o-z*m)*v,(s*p-z*n)*v,(s*q-z*l)*v),g.set((D*m-u*o)*v,(D*n-u*p)*v,(D*l-u*q)*v),i[B].addSelf(f),i[L].addSelf(f),i[I].addSelf(f),j[B].addSelf(g),j[L].addSelf(g),j[I].addSelf(g)}var N=new THREE.Vector3,K=new THREE.Vector3,aa=new THREE.Vector3,P=new THREE.Vector3,M,R,T;H=0;for(O=G.length;H<O;++H){E=G[H].start;B=G[H].count;Q=G[H].index;C=E;for(E+=B;C<E;C+=3)B=Q+b[C],L=Q+b[C+1],I=Q+b[C+2],a(B),a(L),a(I)}this.tangentsNeedUpdate=this.hasTangents=!0}},deallocate:function(){var a=THREE.GeometryLibrary.indexOf(this);
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(b){var c,e,i,j,m,n,l,o,p,q,t,r,A,u,s;function D(a){return a%4?4-a%4:0}function z(a,b){return(new Uint8Array(a,b,1))[0]}function w(a,b){return(new Uint32Array(a,b,1))[0]}function v(b,c){var d,e,f,g,h,i,j,m,l=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){e=l[3*d];f=l[3*d+1];g=l[3*d+2];h=Q[2*e];e=Q[2*e+1];i=Q[2*f];j=Q[2*f+1];f=Q[2*g];m=Q[2*g+1];g=L.faceVertexUvs[0];var n=[];n.push(new THREE.UV(h,e));n.push(new THREE.UV(i,j));n.push(new THREE.UV(f,
m));g.push(n)}}function C(b,c){var d,e,f,g,h,i,j,m,l,n,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){e=o[4*d];f=o[4*d+1];g=o[4*d+2];h=o[4*d+3];i=Q[2*e];e=Q[2*e+1];j=Q[2*f];l=Q[2*f+1];m=Q[2*g];n=Q[2*g+1];g=Q[2*h];f=Q[2*h+1];h=L.faceVertexUvs[0];var p=[];p.push(new THREE.UV(i,e));p.push(new THREE.UV(j,l));p.push(new THREE.UV(m,n));p.push(new THREE.UV(g,f));h.push(p)}}function E(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],
...
G[3*l+1];l=G[3*l+2];L.faces.push(new THREE.Face3(f,g,h,[new THREE.Vector3(G[3*j],G[3*j+1],G[3*j+2]),new THREE.Vector3(o,p,m),new THREE.Vector3(q,r,l)],null,i))}}function B(b,c,d,e){for(var f,g,h,i,j,m,l,n,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];m=d[4*e];l=d[4*e+1];n=d[4*e+2];o=d[4*e+3];j=p[e];var q=G[3*l],r=G[3*l+1];l=G[3*l+2];var t=G[3*n],s=G[3*n+1];n=G[3*n+2];var u=G[3*o],v=G[3*o+1];o=G[3*o+2];L.faces.push(new THREE.Face4(f,
g,h,i,[new THREE.Vector3(G[3*m],G[3*m+1],G[3*m+2]),new THREE.Vector3(q,r,l),new THREE.Vector3(t,s,n),new THREE.Vector3(u,v,o)],null,j))}}var L=this,I=0,G=[],Q=[],N,K,aa;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(L,d,b);s=a;K=I;b=new Uint8Array(s,K,12);q="";for(A=0;12>A;A++)q+=String.fromCharCode(b[K+A]);c=z(s,K+12);z(s,K+13);z(s,K+14);z(s,K+15);e=z(s,K+16);i=z(s,K+17);j=z(s,K+18);m=z(s,K+19);n=w(s,K+20);l=w(s,K+20+4);o=w(s,K+20+8);p=w(s,K+20+12);q=w(s,K+20+16);t=w(s,K+20+20);r=
w(s,K+20+24);A=w(s,K+20+28);b=w(s,K+20+32);u=w(s,K+20+36);s=w(s,K+20+40);I+=c;K=3*e+m;aa=4*e+m;N=p*K;c=q*(K+3*i);e=t*(K+3*j);m=r*(K+3*i+3*j);K=A*aa;i=b*(aa+4*i);j=u*(aa+4*j);aa=I;var I=new Float32Array(a,I,3*n),P,M,R,T;for(P=0;P<n;P++)M=I[3*P],R=I[3*P+1],T=I[3*P+2],L.vertices.push(new THREE.Vector3(M,R,T));n=I=aa+3*n*Float32Array.BYTES_PER_ELEMENT;if(l){I=new Int8Array(a,I,3*l);for(aa=0;aa<l;aa++)P=I[3*aa],M=I[3*aa+1],R=I[3*aa+2],G.push(P/127,M/127,R/127)}I=n+3*l*Int8Array.BYTES_PER_ELEMENT;l=I+=
D(3*l);if(o){I=new Float32Array(a,I,2*o);for(n=0;n<o;n++)aa=I[2*n],P=I[2*n+1],Q.push(aa,P)}o=I=l+2*o*Float32Array.BYTES_PER_ELEMENT;N=o+N+D(2*p);l=N+c+D(2*q);c=l+e+D(2*t);e=c+m+D(2*r);K=e+K+D(2*A);m=K+i+D(2*b);i=m+j+D(2*u);t&&(j=l+3*t*Uint32Array.BYTES_PER_ELEMENT,E(t,l,j+3*t*Uint32Array.BYTES_PER_ELEMENT),v(t,j));r&&(t=c+3*r*Uint32Array.BYTES_PER_ELEMENT,j=t+3*r*Uint32Array.BYTES_PER_ELEMENT,O(r,c,t,j+3*r*Uint32Array.BYTES_PER_ELEMENT),v(r,j));u&&(r=m+4*u*Uint32Array.BYTES_PER_ELEMENT,H(u,m,r+4*
u*Uint32Array.BYTES_PER_ELEMENT),C(u,r));s&&(u=i+4*s*Uint32Array.BYTES_PER_ELEMENT,r=u+4*s*Uint32Array.BYTES_PER_ELEMENT,B(s,i,u,r+4*s*Uint32Array.BYTES_PER_ELEMENT),C(s,r));p&&E(p,o,o+3*p*Uint32Array.BYTES_PER_ELEMENT);q&&(p=N+3*q*Uint32Array.BYTES_PER_ELEMENT,O(q,N,p,p+3*q*Uint32Array.BYTES_PER_ELEMENT));A&&H(A,e,e+4*A*Uint32Array.BYTES_PER_ELEMENT);b&&(q=K+4*b*Uint32Array.BYTES_PER_ELEMENT,B(b,K,q,q+4*b*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return"relativeToHTML"==b?a:n+"/"+a}function e(){f(P.scene,R.objects)}function f(a,b){for(var c in b)if(void 0===P.objects[c]){var e=b[c],g=null;if(e.type&&e.type in m.hierarchyHandlerMap&&void 0===e.loading){var i={},j;for(j in t)"type"!==j&&"url"!==j&&(i[j]=t[j]);E=P.materials[e.materials[0]];e.loading=!0;var l=m.hierarchyHandlerMap[e.type].loaderObject;l.addEventListener?(l.addEventListener("load",h(c,a,E,e)),l.load(d(e.url,R.urlBaseType))):
l.options?l.load(d(e.url,R.urlBaseType),h(c,a,E,e)):l.load(d(e.url,R.urlBaseType),h(c,a,E,e),i)}else if(void 0!==e.geometry){if(C=P.geometries[e.geometry])g=!1,E=P.materials[e.materials[0]],(g=E instanceof THREE.ShaderMaterial)&&C.computeTangents(),u=e.position,s=e.rotation,D=e.quaternion,z=e.scale,r=e.matrix,D=0,0===e.materials.length&&(E=new THREE.MeshFaceMaterial),1<e.materials.length&&(E=new THREE.MeshFaceMaterial),e.skin?g=new THREE.SkinnedMesh(C,E):e.morph?(g=new THREE.MorphAnimMesh(C,E),void 0!==
...
e.castShadow,g.receiveShadow=e.receiveShadow,a.add(g),P.objects[c]=g}else"DirectionalLight"===e.type||"PointLight"===e.type||"AmbientLight"===e.type?(I=void 0!==e.color?e.color:16777215,G=void 0!==e.intensity?e.intensity:1,"DirectionalLight"===e.type?(u=e.direction,L=new THREE.DirectionalLight(I,G),L.position.set(u[0],u[1],u[2]),e.target&&(M.push({object:L,targetName:e.target}),L.target=null)):"PointLight"===e.type?(u=e.position,A=e.distance,L=new THREE.PointLight(I,G,A),L.position.set(u[0],u[1],
u[2])):"AmbientLight"===e.type&&(L=new THREE.AmbientLight(I)),a.add(L),L.name=c,P.lights[c]=L,P.objects[c]=L):"PerspectiveCamera"===e.type||"OrthographicCamera"===e.type?("PerspectiveCamera"===e.type?H=new THREE.PerspectiveCamera(e.fov,e.aspect,e.near,e.far):"OrthographicCamera"===e.type&&(H=new THREE.OrthographicCamera(w.left,w.right,w.top,w.bottom,w.near,w.far)),u=e.position,H.position.set(u[0],u[1],u[2]),a.add(H),H.name=c,P.cameras[c]=H,P.objects[c]=H):(u=e.position,s=e.rotation,D=e.quaternion,
z=e.scale,D=0,g=new THREE.Object3D,g.name=c,g.position.set(u[0],u[1],u[2]),D?(g.quaternion.set(D[0],D[1],D[2],D[3]),g.useQuaternion=!0):g.rotation.set(s[0],s[1],s[2]),g.scale.set(z[0],z[1],z[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),P.objects[c]=g,P.empties[c]=g);if(g){if(void 0!==e.properties)for(var n in e.properties)g.properties[n]=e.properties[n];void 0!==e.children&&f(g,e.children)}}}function g(a){return function(b){P.geometries[a]=b;e();Q-=1;m.onLoadComplete();j()}}function h(a,
b,c,d){return function(f){var f=f.content?f.content:f.dae?f.scene:f,g=d.position,h=d.rotation,i=d.quaternion,l=d.scale;f.position.set(g[0],g[1],g[2]);i?(f.quaternion.set(i[0],i[1],i[2],i[3]),f.useQuaternion=!0):f.rotation.set(h[0],h[1],h[2]);f.scale.set(l[0],l[1],l[2]);c&&f.traverse(function(a){a.material=c});b.add(f);P.objects[a]=f;e();Q-=1;m.onLoadComplete();j()}}function i(a){return function(b){P.geometries[a]=b}}function j(){m.callbackProgress({totalModels:K,totalTextures:aa,loadedModels:K-Q,
loadedTextures:aa-N},P);m.onLoadProgress();if(0===Q&&0===N){for(var a=0;a<M.length;a++){var c=M[a],d=P.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,P.scene.add(c.object.target));c.object.target.properties.targetInverse=c.object}b(P)}}var m=this,n=THREE.Loader.prototype.extractUrlBase(c),l,o,p,q,t,r,A,u,s,D,z,w,v,C,E,H,O,B,L,I,G,Q,N,K,aa,P,M=[],R=a,T;for(T in this.geometryHandlerMap)a=this.geometryHandlerMap[T].loaderClass,this.geometryHandlerMap[T].loaderObject=new a;
for(T in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[T].loaderClass,this.hierarchyHandlerMap[T].loaderObject=new a;N=Q=0;P={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(R.transform&&(T=R.transform.position,a=R.transform.rotation,c=R.transform.scale,T&&P.scene.position.set(T[0],T[1],T[2]),a&&P.scene.rotation.set(a[0],a[1],a[2]),c&&P.scene.scale.set(c[0],c[1],c[2]),T||a||c))P.scene.updateMatrix(),P.scene.updateMatrixWorld();
T=function(a){return function(){N-=a;j();m.onLoadComplete()}};for(p in R.fogs)a=R.fogs[p],"linear"===a.type?O=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(O=new THREE.FogExp2(0,a.density)),w=a.color,O.color.setRGB(w[0],w[1],w[2]),P.fogs[p]=O;for(l in R.geometries)t=R.geometries[l],t.type in this.geometryHandlerMap&&(Q+=1,m.onLoadStart());for(var J in R.objects)p=R.objects[J],p.type&&p.type in this.hierarchyHandlerMap&&(Q+=1,m.onLoadStart());K=Q;for(l in R.geometries)if(t=R.geometries[l],"cube"===
t.type)C=new THREE.CubeGeometry(t.width,t.height,t.depth,t.widthSegments,t.heightSegments,t.depthSegments,null,t.flipped,t.sides),P.geometries[l]=C;else if("plane"===t.type)C=new THREE.PlaneGeometry(t.width,t.height,t.widthSegments,t.heightSegments),P.geometries[l]=C;else if("sphere"===t.type)C=new THREE.SphereGeometry(t.radius,t.widthSegments,t.heightSegments),P.geometries[l]=C;else if("cylinder"===t.type)C=new THREE.CylinderGeometry(t.topRad,t.botRad,t.height,t.radSegs,t.heightSegs),P.geometries[l]=
C;else if("torus"===t.type)C=new THREE.TorusGeometry(t.radius,t.tube,t.segmentsR,t.segmentsT),P.geometries[l]=C;else if("icosahedron"===t.type)C=new THREE.IcosahedronGeometry(t.radius,t.subdivisions),P.geometries[l]=C;else if(t.type in this.geometryHandlerMap){J={};for(B in t)"type"!==B&&"url"!==B&&(J[B]=t[B]);this.geometryHandlerMap[t.type].loaderObject.load(d(t.url,R.urlBaseType),g(l),J)}else"embedded"===t.type&&(J=R.embeds[t.id],J.metadata=R.metadata,J&&this.geometryHandlerMap.ascii.loaderObject.createModel(J,
i(l),""));for(q in R.textures)if(l=R.textures[q],l.url instanceof Array){N+=l.url.length;for(B=0;B<l.url.length;B++)m.onLoadStart()}else N+=1,m.onLoadStart();aa=N;for(q in R.textures){l=R.textures[q];void 0!==l.mapping&&void 0!==THREE[l.mapping]&&(l.mapping=new THREE[l.mapping]);if(l.url instanceof Array){J=l.url.length;p=[];for(B=0;B<J;B++)p[B]=d(l.url[B],R.urlBaseType);B=(B=p[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(p,l.mapping,T(J)):THREE.ImageUtils.loadTextureCube(p,l.mapping,
T(J))}else{B=l.url.toLowerCase().endsWith(".dds");J=d(l.url,R.urlBaseType);p=T(1);B=B?THREE.ImageUtils.loadCompressedTexture(J,l.mapping,p):THREE.ImageUtils.loadTexture(J,l.mapping,p);void 0!==THREE[l.minFilter]&&(B.minFilter=THREE[l.minFilter]);void 0!==THREE[l.magFilter]&&(B.magFilter=THREE[l.magFilter]);l.anisotropy&&(B.anisotropy=l.anisotropy);if(l.repeat&&(B.repeat.set(l.repeat[0],l.repeat[1]),1!==l.repeat[0]&&(B.wrapS=THREE.RepeatWrapping),1!==l.repeat[1]))B.wrapT=THREE.RepeatWrapping;l.offset&&
B.offset.set(l.offset[0],l.offset[1]);if(l.wrap&&(J={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==J[l.wrap[0]]&&(B.wrapS=J[l.wrap[0]]),void 0!==J[l.wrap[1]]))B.wrapT=J[l.wrap[1]]}P.textures[q]=B}for(o in R.materials){r=R.materials[o];for(v in r.parameters)"envMap"===v||"map"===v||"lightMap"===v||"bumpMap"===v?r.parameters[v]=P.textures[r.parameters[v]]:"shading"===v?r.parameters[v]="flat"===r.parameters[v]?THREE.FlatShading:THREE.SmoothShading:"side"===v?r.parameters[v]=
...
q[1],q[2]));void 0!==r.parameters.opacity&&1>r.parameters.opacity&&(r.parameters.transparent=!0);r.parameters.normalMap?(q=THREE.ShaderUtils.lib.normal,T=THREE.UniformsUtils.clone(q.uniforms),l=r.parameters.color,B=r.parameters.specular,J=r.parameters.ambient,p=r.parameters.shininess,T.tNormal.value=P.textures[r.parameters.normalMap],r.parameters.normalScale&&T.uNormalScale.value.set(r.parameters.normalScale[0],r.parameters.normalScale[1]),r.parameters.map&&(T.tDiffuse.value=r.parameters.map,T.enableDiffuse.value=
!0),r.parameters.envMap&&(T.tCube.value=r.parameters.envMap,T.enableReflection.value=!0,T.uReflectivity.value=r.parameters.reflectivity),r.parameters.lightMap&&(T.tAO.value=r.parameters.lightMap,T.enableAO.value=!0),r.parameters.specularMap&&(T.tSpecular.value=P.textures[r.parameters.specularMap],T.enableSpecular.value=!0),r.parameters.displacementMap&&(T.tDisplacement.value=P.textures[r.parameters.displacementMap],T.enableDisplacement.value=!0,T.uDisplacementBias.value=r.parameters.displacementBias,
T.uDisplacementScale.value=r.parameters.displacementScale),T.uDiffuseColor.value.setHex(l),T.uSpecularColor.value.setHex(B),T.uAmbientColor.value.setHex(J),T.uShininess.value=p,r.parameters.opacity&&(T.uOpacity.value=r.parameters.opacity),E=new THREE.ShaderMaterial({fragmentShader:q.fragmentShader,vertexShader:q.vertexShader,uniforms:T,lights:!0,fog:!0})):E=new THREE[r.type](r.parameters);P.materials[o]=E}e();P.cameras&&R.defaults.camera&&(P.currentCamera=P.cameras[R.defaults.camera]);P.fogs&&R.defaults.fog&&
(P.scene.fog=P.fogs[R.defaults.fog]);w=R.defaults.bgcolor;P.bgColor=new THREE.Color;P.bgColor.setRGB(w[0],w[1],w[2]);P.bgColorAlpha=R.defaults.bgalpha;m.callbackSync(P);j()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
document.createElement("canvas"),n,l,o,p,q=m.getContext("2d"),t=new THREE.Color(0),r=0,A=1,u=0,s=null,D=null,z=null,w=null,v=null,C,E,H,O,B=new THREE.RenderableVertex,L=new THREE.RenderableVertex,I,G,Q,N,K,aa,P,M,R,T,J,ra,S=new THREE.Color,ha=new THREE.Color,V=new THREE.Color,ba=new THREE.Color,ia=new THREE.Color,Z=new THREE.Color,fa=new THREE.Color,Ma={},Pa={},Aa,Ta,ua,cb,wb,Ua,fb,kb,Ab,Bb,eb=new THREE.Rectangle,va=new THREE.Rectangle,Ha=new THREE.Rectangle,lb=!1,Ka=new THREE.Color,Za=new THREE.Color,
db=new THREE.Color,ja=new THREE.Vector3,$a,ab,mb,ma,gb,pb,a=16;$a=document.createElement("canvas");$a.width=$a.height=2;ab=$a.getContext("2d");ab.fillStyle="rgba(0,0,0,1)";ab.fillRect(0,0,2,2);mb=ab.getImageData(0,0,2,2);ma=mb.data;gb=document.createElement("canvas");gb.width=gb.height=a;pb=gb.getContext("2d");pb.translate(-a/2,-a/2);pb.scale(a,a);a--;this.domElement=m;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){n=a;l=b;o=
...
c.g+=g.g*k,c.b+=g.b*k)}else f instanceof THREE.PointLight&&(h=f.matrixWorld.getPosition(),k=b.dot(ja.sub(h,a).normalize()),0>=k||(k*=0==f.distance?1:1-Math.min(a.distanceTo(h)/f.distance,1),0!=k&&(k*=f.intensity,c.r+=g.r*k,c.g+=g.g*k,c.b+=g.b*k)))}}function n(a,d,e,g,h,k,i,j){f.info.render.vertices+=3;f.info.render.faces++;b(j.opacity);c(j.blending);I=a.positionScreen.x;G=a.positionScreen.y;Q=d.positionScreen.x;N=d.positionScreen.y;K=e.positionScreen.x;aa=e.positionScreen.y;r(I,G,Q,N,K,aa);(j instanceof
THREE.MeshLambertMaterial||j instanceof THREE.MeshPhongMaterial)&&null===j.map&&null===j.map?(Z.copy(j.color),fa.copy(j.emissive),j.vertexColors===THREE.FaceColors&&(Z.r*=i.color.r,Z.g*=i.color.g,Z.b*=i.color.b),!0===lb)?!1===j.wireframe&&j.shading==THREE.SmoothShading&&3==i.vertexNormalsLength?(ha.r=V.r=ba.r=Ka.r,ha.g=V.g=ba.g=Ka.g,ha.b=V.b=ba.b=Ka.b,m(i.v1.positionWorld,i.vertexNormalsWorld[0],ha),m(i.v2.positionWorld,i.vertexNormalsWorld[1],V),m(i.v3.positionWorld,i.vertexNormalsWorld[2],ba),ha.r=
ha.r*Z.r+fa.r,ha.g=ha.g*Z.g+fa.g,ha.b=ha.b*Z.b+fa.b,V.r=V.r*Z.r+fa.r,V.g=V.g*Z.g+fa.g,V.b=V.b*Z.b+fa.b,ba.r=ba.r*Z.r+fa.r,ba.g=ba.g*Z.g+fa.g,ba.b=ba.b*Z.b+fa.b,ia.r=0.5*(V.r+ba.r),ia.g=0.5*(V.g+ba.g),ia.b=0.5*(V.b+ba.b),ua=wc(ha,V,ba,ia),la(I,G,Q,N,K,aa,0,0,1,0,0,1,ua)):(S.r=Ka.r,S.g=Ka.g,S.b=Ka.b,m(i.centroidWorld,i.normalWorld,S),S.r=S.r*Z.r+fa.r,S.g=S.g*Z.g+fa.g,S.b=S.b*Z.b+fa.b,!0===j.wireframe?s(S,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):u(S)):!0===j.wireframe?s(j.color,j.wireframeLinewidth,
j.wireframeLinecap,j.wireframeLinejoin):u(j.color):j instanceof THREE.MeshBasicMaterial||j instanceof THREE.MeshLambertMaterial||j instanceof THREE.MeshPhongMaterial?null!==j.map?j.map.mapping instanceof THREE.UVMapping&&(cb=i.uvs[0],A(I,G,Q,N,K,aa,cb[g].u,cb[g].v,cb[h].u,cb[h].v,cb[k].u,cb[k].v,j.map)):null!==j.envMap?j.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=l.matrixWorldInverse,ja.copy(i.vertexNormalsWorld[g]),wb=0.5*(ja.x*a.elements[0]+ja.y*a.elements[4]+ja.z*a.elements[8])+
0.5,Ua=0.5*(ja.x*a.elements[1]+ja.y*a.elements[5]+ja.z*a.elements[9])+0.5,ja.copy(i.vertexNormalsWorld[h]),fb=0.5*(ja.x*a.elements[0]+ja.y*a.elements[4]+ja.z*a.elements[8])+0.5,kb=0.5*(ja.x*a.elements[1]+ja.y*a.elements[5]+ja.z*a.elements[9])+0.5,ja.copy(i.vertexNormalsWorld[k]),Ab=0.5*(ja.x*a.elements[0]+ja.y*a.elements[4]+ja.z*a.elements[8])+0.5,Bb=0.5*(ja.x*a.elements[1]+ja.y*a.elements[5]+ja.z*a.elements[9])+0.5,A(I,G,Q,N,K,aa,wb,Ua,fb,kb,Ab,Bb,j.envMap)):(S.copy(j.color),j.vertexColors===THREE.FaceColors&&
(S.r*=i.color.r,S.g*=i.color.g,S.b*=i.color.b),!0===j.wireframe?s(S,j.wireframeLinewidth,j.wireframeLinecap,j.wireframeLinejoin):u(S)):j instanceof THREE.MeshDepthMaterial?(Aa=l.near,Ta=l.far,ha.r=ha.g=ha.b=1-Cb(a.positionScreen.z,Aa,Ta),V.r=V.g=V.b=1-Cb(d.positionScreen.z,Aa,Ta),ba.r=ba.g=ba.b=1-Cb(e.positionScreen.z,Aa,Ta),ia.r=0.5*(V.r+ba.r),ia.g=0.5*(V.g+ba.g),ia.b=0.5*(V.b+ba.b),ua=wc(ha,V,ba,ia),la(I,G,Q,N,K,aa,0,0,1,0,0,1,ua)):j instanceof THREE.MeshNormalMaterial&&(S.r=gc(i.normalWorld.x),
...
q.fill()}function A(a,b,c,d,f,g,h,k,i,j,l,m,la){if(!(la instanceof THREE.DataTexture||void 0===la.image||0==la.image.width)){if(!0===la.needsUpdate){var n=la.wrapS==THREE.RepeatWrapping,o=la.wrapT==THREE.RepeatWrapping;Ma[la.id]=q.createPattern(la.image,!0===n&&!0===o?"repeat":!0===n&&!1===o?"repeat-x":!1===n&&!0===o?"repeat-y":"no-repeat");la.needsUpdate=!1}void 0===Ma[la.id]?e("rgba(0,0,0,1)"):e(Ma[la.id]);var n=la.offset.x/la.repeat.x,o=la.offset.y/la.repeat.y,p=la.image.width*la.repeat.x,Cb=la.image.height*
la.repeat.y,h=(h+n)*p,k=(1-k+o)*Cb,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+n)*p-h,j=(1-j+o)*Cb-k,l=(l+n)*p-h,m=(1-m+o)*Cb-k,n=i*m-l*j;0===n?(void 0===Pa[la.id]&&(b=document.createElement("canvas"),b.width=la.image.width,b.height=la.image.height,b=b.getContext("2d"),b.drawImage(la.image,0,0),Pa[la.id]=b.getImageData(0,0,la.image.width,la.image.height).data),b=Pa[la.id],h=4*(Math.floor(h)+Math.floor(k)*la.image.width),S.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),u(S)):(n=1/n,la=(m*c-j*f)*n,j=(m*d-j*g)*n,c=(i*f-l*
...
255*b.g|0;ma[6]=255*b.b|0;ma[8]=255*c.r|0;ma[9]=255*c.g|0;ma[10]=255*c.b|0;ma[12]=255*d.r|0;ma[13]=255*d.g|0;ma[14]=255*d.b|0;ab.putImageData(mb,0,0);pb.drawImage($a,0,0);return gb}function Cb(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function gc(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function Xb(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===l instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
else{var Yb,xc,na,ca;!0===this.autoClear?this.clear():q.setTransform(1,0,0,-1,o,p);f.info.render.vertices=0;f.info.render.faces=0;g=j.projectScene(a,l,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;lb=0<i.length;if(!0===lb){Ka.setRGB(0,0,0);Za.setRGB(0,0,0);db.setRGB(0,0,0);Yb=0;for(xc=i.length;Yb<xc;Yb++){ca=i[Yb];var oa=ca.color;ca instanceof THREE.AmbientLight?(Ka.r+=oa.r,Ka.g+=oa.g,Ka.b+=oa.b):ca instanceof THREE.DirectionalLight?(Za.r+=oa.r,Za.g+=oa.g,Za.b+=oa.b):ca instanceof THREE.PointLight&&
(db.r+=oa.r,db.g+=oa.g,db.b+=oa.b)}}Yb=0;for(xc=h.length;Yb<xc;Yb++)if(na=h[Yb],ca=na.material,!(void 0===ca||!1===ca.visible)){Ha.empty();if(na instanceof THREE.RenderableParticle){C=na;C.x*=o;C.y*=p;var oa=C,D=na;b(ca.opacity);c(ca.blending);var yb=void 0,zb=void 0,qb=void 0,rb=void 0,hc=na=void 0,Pc=void 0;ca instanceof THREE.ParticleBasicMaterial?null===ca.map?(qb=D.object.scale.x,rb=D.object.scale.y,qb*=D.scale.x*o,rb*=D.scale.y*p,Ha.set(oa.x-qb,oa.y-rb,oa.x+qb,oa.y+rb),!1!==eb.intersects(Ha)&&
(e(ca.color.getContextStyle()),q.save(),q.translate(oa.x,oa.y),q.rotate(-D.rotation),q.scale(qb,rb),q.fillRect(-1,-1,2,2),q.restore())):(na=ca.map.image,hc=na.width>>1,Pc=na.height>>1,qb=D.scale.x*o,rb=D.scale.y*p,yb=qb*hc,zb=rb*Pc,Ha.set(oa.x-yb,oa.y-zb,oa.x+yb,oa.y+zb),!1!==eb.intersects(Ha)&&(q.save(),q.translate(oa.x,oa.y),q.rotate(-D.rotation),q.scale(qb,-rb),q.translate(-hc,-Pc),q.drawImage(na,0,0),q.restore())):ca instanceof THREE.ParticleCanvasMaterial&&(yb=D.scale.x*o,zb=D.scale.y*p,Ha.set(oa.x-
yb,oa.y-zb,oa.x+yb,oa.y+zb),!1!==eb.intersects(Ha)&&(d(ca.color.getContextStyle()),e(ca.color.getContextStyle()),q.save(),q.translate(oa.x,oa.y),q.rotate(-D.rotation),q.scale(yb,zb),ca.program(q),q.restore()))}else if(na instanceof THREE.RenderableLine){if(C=na.v1,E=na.v2,C.positionScreen.x*=o,C.positionScreen.y*=p,E.positionScreen.x*=o,E.positionScreen.y*=p,Ha.addPoint(C.positionScreen.x,C.positionScreen.y),Ha.addPoint(E.positionScreen.x,E.positionScreen.y),!0===eb.intersects(Ha)&&(oa=C,D=E,b(ca.opacity),
c(ca.blending),q.beginPath(),q.moveTo(oa.positionScreen.x,oa.positionScreen.y),q.lineTo(D.positionScreen.x,D.positionScreen.y),ca instanceof THREE.LineBasicMaterial))oa=ca.linewidth,z!==oa&&(z=q.lineWidth=oa),oa=ca.linecap,w!==oa&&(w=q.lineCap=oa),oa=ca.linejoin,v!==oa&&(v=q.lineJoin=oa),d(ca.color.getContextStyle()),q.stroke(),Ha.inflate(2*ca.linewidth)}else if(na instanceof THREE.RenderableFace3)C=na.v1,E=na.v2,H=na.v3,C.positionScreen.x*=o,C.positionScreen.y*=p,E.positionScreen.x*=o,E.positionScreen.y*=
p,H.positionScreen.x*=o,H.positionScreen.y*=p,!0===ca.overdraw&&(Xb(C.positionScreen,E.positionScreen),Xb(E.positionScreen,H.positionScreen),Xb(H.positionScreen,C.positionScreen)),Ha.add3Points(C.positionScreen.x,C.positionScreen.y,E.positionScreen.x,E.positionScreen.y,H.positionScreen.x,H.positionScreen.y),!0===eb.intersects(Ha)&&n(C,E,H,0,1,2,na,ca,a);else if(na instanceof THREE.RenderableFace4&&(C=na.v1,E=na.v2,H=na.v3,O=na.v4,C.positionScreen.x*=o,C.positionScreen.y*=p,E.positionScreen.x*=o,E.positionScreen.y*=
p,H.positionScreen.x*=o,H.positionScreen.y*=p,O.positionScreen.x*=o,O.positionScreen.y*=p,B.positionScreen.copy(E.positionScreen),L.positionScreen.copy(O.positionScreen),!0===ca.overdraw&&(Xb(C.positionScreen,E.positionScreen),Xb(E.positionScreen,O.positionScreen),Xb(O.positionScreen,C.positionScreen),Xb(H.positionScreen,B.positionScreen),Xb(H.positionScreen,L.positionScreen)),Ha.addPoint(C.positionScreen.x,C.positionScreen.y),Ha.addPoint(E.positionScreen.x,E.positionScreen.y),Ha.addPoint(H.positionScreen.x,
H.positionScreen.y),Ha.addPoint(O.positionScreen.x,O.positionScreen.y),!0===eb.intersects(Ha)))(oa=C,D=E,yb=H,zb=O,qb=B,rb=L,hc=a,f.info.render.vertices+=4,f.info.render.faces++,b(ca.opacity),c(ca.blending),void 0!==ca.map&&null!==ca.map||void 0!==ca.envMap&&null!==ca.envMap)?(n(oa,D,zb,0,1,3,na,ca,hc),n(qb,yb,rb,1,2,3,na,ca,hc)):(I=oa.positionScreen.x,G=oa.positionScreen.y,Q=D.positionScreen.x,N=D.positionScreen.y,K=yb.positionScreen.x,aa=yb.positionScreen.y,P=zb.positionScreen.x,M=zb.positionScreen.y,
R=qb.positionScreen.x,T=qb.positionScreen.y,J=rb.positionScreen.x,ra=rb.positionScreen.y,ca instanceof THREE.MeshLambertMaterial||ca instanceof THREE.MeshPhongMaterial)?(Z.copy(ca.color),fa.copy(ca.emissive),ca.vertexColors===THREE.FaceColors&&(Z.r*=na.color.r,Z.g*=na.color.g,Z.b*=na.color.b),!0===lb)?!1===ca.wireframe&&ca.shading==THREE.SmoothShading&&4==na.vertexNormalsLength?(ha.r=V.r=ba.r=ia.r=Ka.r,ha.g=V.g=ba.g=ia.g=Ka.g,ha.b=V.b=ba.b=ia.b=Ka.b,m(na.v1.positionWorld,na.vertexNormalsWorld[0],
ha),m(na.v2.positionWorld,na.vertexNormalsWorld[1],V),m(na.v4.positionWorld,na.vertexNormalsWorld[3],ba),m(na.v3.positionWorld,na.vertexNormalsWorld[2],ia),ha.r=ha.r*Z.r+fa.r,ha.g=ha.g*Z.g+fa.g,ha.b=ha.b*Z.b+fa.b,V.r=V.r*Z.r+fa.r,V.g=V.g*Z.g+fa.g,V.b=V.b*Z.b+fa.b,ba.r=ba.r*Z.r+fa.r,ba.g=ba.g*Z.g+fa.g,ba.b=ba.b*Z.b+fa.b,ia.r=ia.r*Z.r+fa.r,ia.g=ia.g*Z.g+fa.g,ia.b=ia.b*Z.b+fa.b,ua=wc(ha,V,ba,ia),r(I,G,Q,N,P,M),la(I,G,Q,N,P,M,0,0,1,0,0,1,ua),r(R,T,K,aa,J,ra),la(R,T,K,aa,J,ra,1,0,1,1,0,1,ua)):(S.r=Ka.r,
S.g=Ka.g,S.b=Ka.b,m(na.centroidWorld,na.normalWorld,S),S.r=S.r*Z.r+fa.r,S.g=S.g*Z.g+fa.g,S.b=S.b*Z.b+fa.b,t(I,G,Q,N,K,aa,P,M),!0===ca.wireframe?s(S,ca.wireframeLinewidth,ca.wireframeLinecap,ca.wireframeLinejoin):u(S)):(S.r=Z.r+fa.r,S.g=Z.g+fa.g,S.b=Z.b+fa.b,t(I,G,Q,N,K,aa,P,M),!0===ca.wireframe?s(S,ca.wireframeLinewidth,ca.wireframeLinecap,ca.wireframeLinejoin):u(S)):ca instanceof THREE.MeshBasicMaterial?(S.copy(ca.color),ca.vertexColors===THREE.FaceColors&&(S.r*=na.color.r,S.g*=na.color.g,S.b*=na.color.b),
t(I,G,Q,N,K,aa,P,M),!0===ca.wireframe?s(S,ca.wireframeLinewidth,ca.wireframeLinecap,ca.wireframeLinejoin):u(S)):ca instanceof THREE.MeshNormalMaterial?(S.r=gc(na.normalWorld.x),S.g=gc(na.normalWorld.y),S.b=gc(na.normalWorld.z),t(I,G,Q,N,K,aa,P,M),!0===ca.wireframe?s(S,ca.wireframeLinewidth,ca.wireframeLinecap,ca.wireframeLinejoin):u(S)):ca instanceof THREE.MeshDepthMaterial&&(Aa=l.near,Ta=l.far,ha.r=ha.g=ha.b=1-Cb(oa.positionScreen.z,Aa,Ta),V.r=V.g=V.b=1-Cb(D.positionScreen.z,Aa,Ta),ba.r=ba.g=ba.b=
1-Cb(zb.positionScreen.z,Aa,Ta),ia.r=ia.g=ia.b=1-Cb(yb.positionScreen.z,Aa,Ta),ua=wc(ha,V,ba,ia),r(I,G,Q,N,P,M),la(I,G,Q,N,P,M,0,0,1,0,0,1,ua),r(R,T,K,aa,J,ra),la(R,T,K,aa,J,ra,1,0,1,1,0,1,ua));va.addRectangle(Ha)}q.setTransform(1,0,0,1,0,0)}}};
...
!1);d.morphTargets&&!e.__webglMorphTargetInfluences&&(e.__webglMorphTargetInfluences=new Float32Array(J.maxMorphTargets));var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==ha&&(k.useProgram(g),ha=g,f=!0);d.id!==ba&&(ba=d.id,f=!0);if(f||a!==Z)k.uniformMatrix4fv(h.projectionMatrix,!1,a._projectionMatrixArray),a!==Z&&(Z=a);if(d.skinning)if(fc&&e.useVertexTexture){if(null!==h.boneTexture){var j=D();k.uniform1i(h.boneTexture,j);J.setTexture(e.boneTexture,j)}}else null!==h.boneGlobalMatrices&&k.uniformMatrix4fv(h.boneGlobalMatrices,
...
r.spot.angles,L=r.spot.exponents,M=r.hemi.skyColors,V=r.hemi.groundColors,R=r.hemi.positions,N=0,Q=0,P=0,fa=0,K=p=0,c=K=K=0,f=b.length;c<f;c++)j=b[c],!j.onlyShadow&&j.visible&&(o=j.color,q=j.intensity,p=j.distance,j instanceof THREE.AmbientLight?J.gammaInput?(l+=o.r*o.r,m+=o.g*o.g,n+=o.b*o.b):(l+=o.r,m+=o.g,n+=o.b):j instanceof THREE.DirectionalLight?(p=3*N,J.gammaInput?w(t,p,o,q*q):v(t,p,o,q),ma.copy(j.matrixWorld.getPosition()),ma.subSelf(j.target.matrixWorld.getPosition()),ma.normalize(),s[p]=
ma.x,s[p+1]=ma.y,s[p+2]=ma.z,N+=1):j instanceof THREE.PointLight?(K=3*Q,J.gammaInput?w(u,K,o,q*q):v(u,K,o,q),q=j.matrixWorld.getPosition(),z[K]=q.x,z[K+1]=q.y,z[K+2]=q.z,A[Q]=p,Q+=1):j instanceof THREE.SpotLight?(K=3*P,J.gammaInput?w(B,K,o,q*q):v(B,K,o,q),q=j.matrixWorld.getPosition(),C[K]=q.x,C[K+1]=q.y,C[K+2]=q.z,E[P]=p,ma.copy(q),ma.subSelf(j.target.matrixWorld.getPosition()),ma.normalize(),H[K]=ma.x,H[K+1]=ma.y,H[K+2]=ma.z,S[P]=Math.cos(j.angle),L[P]=j.exponent,P+=1):j instanceof THREE.HemisphereLight&&
(o=j.color,p=j.groundColor,K=3*fa,J.gammaInput?(q*=q,w(M,K,o,q),w(V,K,p,q)):(v(M,K,o,q),v(V,K,p,q)),ma.copy(j.matrixWorld.getPosition()),ma.normalize(),R[K]=ma.x,R[K+1]=ma.y,R[K+2]=ma.z,fa+=1));c=3*N;for(f=t.length;c<f;c++)t[c]=0;c=3*Q;for(f=u.length;c<f;c++)u[c]=0;c=3*P;for(f=B.length;c<f;c++)B[c]=0;c=3*fa;for(f=M.length;c<f;c++)M[c]=0;c=3*fa;for(f=V.length;c<f;c++)V[c]=0;r.directional.length=N;r.point.length=Q;r.spot.length=P;r.hemi.length=fa;r.ambient[0]=l;r.ambient[1]=m;r.ambient[2]=n;gb=!1}c=
pb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=c.spot.directions;i.spotLightAngle.value=c.spot.angles;i.spotLightExponent.value=
...
(i.ambient.value=d.ambient,i.emissive.value=d.emissive),d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)):d instanceof THREE.MeshDepthMaterial?(i.mNear.value=a.near,i.mFar.value=a.far,i.opacity.value=d.opacity):d instanceof THREE.MeshNormalMaterial&&(i.opacity.value=d.opacity);if(e.receiveShadow&&!d._shadowPass&&i.shadowMatrix){c=T=0;for(f=b.length;c<f;c++)if(j=b[c],j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade))i.shadowMap.value[T]=j.shadowMap,i.shadowMapSize.value[T]=
j.shadowMapSize,i.shadowMatrix.value[T]=j.shadowMatrix,i.shadowDarkness.value[T]=j.shadowDarkness,i.shadowBias.value[T]=j.shadowBias,T++}b=d.uniformsList;i=0;for(T=b.length;i<T;i++)if(f=g.uniforms[b[i][1]])if(c=b[i][0],l=c.type,j=c.value,"i"===l)k.uniform1i(f,j);else if("f"===l)k.uniform1f(f,j);else if("v2"===l)k.uniform2f(f,j.x,j.y);else if("v3"===l)k.uniform3f(f,j.x,j.y,j.z);else if("v4"===l)k.uniform4f(f,j.x,j.y,j.z,j.w);else if("c"===l)k.uniform3f(f,j.r,j.g,j.b);else if("iv1"===l)k.uniform1iv(f,
j);else if("iv"===l)k.uniform3iv(f,j);else if("fv1"===l)k.uniform1fv(f,j);else if("fv"===l)k.uniform3fv(f,j);else if("v2v"===l){void 0===c._array&&(c._array=new Float32Array(2*j.length));l=0;for(m=j.length;l<m;l++)n=2*l,c._array[n]=j[l].x,c._array[n+1]=j[l].y;k.uniform2fv(f,c._array)}else if("v3v"===l){void 0===c._array&&(c._array=new Float32Array(3*j.length));l=0;for(m=j.length;l<m;l++)n=3*l,c._array[n]=j[l].x,c._array[n+1]=j[l].y,c._array[n+2]=j[l].z;k.uniform3fv(f,c._array)}else if("v4v"===l){void 0===
c._array&&(c._array=new Float32Array(4*j.length));l=0;for(m=j.length;l<m;l++)n=4*l,c._array[n]=j[l].x,c._array[n+1]=j[l].y,c._array[n+2]=j[l].z,c._array[n+3]=j[l].w;k.uniform4fv(f,c._array)}else if("m4"===l)void 0===c._array&&(c._array=new Float32Array(16)),j.flattenToArray(c._array),k.uniformMatrix4fv(f,!1,c._array);else if("m4v"===l){void 0===c._array&&(c._array=new Float32Array(16*j.length));l=0;for(m=j.length;l<m;l++)j[l].flattenToArrayOffset(c._array,16*l);k.uniformMatrix4fv(f,!1,c._array)}else if("t"===
l){if(n=j,j=D(),k.uniform1i(f,j),n)if(n.image instanceof Array&&6===n.image.length){if(c=n,f=j,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=k.createTexture());k.activeTexture(k.TEXTURE0+f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)J.autoScaleCubemaps&&!f?(m=j,n=l,r=c.image[l],s=Oc,r.width<=s&&r.height<=s||(u=Math.max(r.width,r.height),
t=Math.floor(r.width*s/u),s=Math.floor(r.height*s/u),u=document.createElement("canvas"),u.width=t,u.height=s,u.getContext("2d").drawImage(r,0,0,r.width,r.height,0,0,t,s),r=u),m[n]=r):j[l]=c.image[l];l=j[0];m=0===(l.width&l.width-1)&&0===(l.height&l.height-1);n=I(c.format);r=I(c.type);O(k.TEXTURE_CUBE_MAP,c,m);for(l=0;6>l;l++)if(f){s=j[l].mipmaps;u=0;for(z=s.length;u<z;u++)t=s[u],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,u,n,t.width,t.height,0,t.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+
l,0,n,n,r,j[l]);c.generateMipmaps&&m&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else n instanceof THREE.WebGLRenderTargetCube?(c=n,k.activeTexture(k.TEXTURE0+j),k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)):J.setTexture(n,j)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(m=c.value.length;l<m;l++)c._array[l]=D();k.uniform1iv(f,c._array);l=0;for(m=
c.value.length;l<m;l++)n=c.value[l],j=c._array[l],n&&J.setTexture(n,j)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==h.cameraPosition)b=a.matrixWorld.getPosition(),k.uniform3f(h.cameraPosition,b.x,b.y,b.z);(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&null!==h.viewMatrix&&k.uniformMatrix4fv(h.viewMatrix,!1,a._viewMatrixArray)}k.uniformMatrix4fv(h.modelViewMatrix,!1,e._modelViewMatrix.elements);
h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,!1,e._normalMatrix.elements);null!==h.modelMatrix&&k.uniformMatrix4fv(h.modelMatrix,!1,e.matrixWorld.elements);return g}function D(){var a=Ma;a>=vc&&console.warn("Trying to use "+a+" texture units while this GPU supports only "+vc);Ma+=1;return a}function z(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function w(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*
d;a[b+2]=c.b*c.b*d}function v(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function C(a,b,c){kb!==a&&(a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL),kb=a);if(a&&(Ab!==b||Bb!==c))k.polygonOffset(b,c),Ab=b,Bb=c}function E(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function H(a,b){var c;"fragment"===a?c=k.createShader(k.FRAGMENT_SHADER):"vertex"===a&&(c=k.createShader(k.VERTEX_SHADER));k.shaderSource(c,b);k.compileShader(c);return!k.getShaderParameter(c,
k.COMPILE_STATUS)?(console.error(k.getShaderInfoLog(c)),console.error(E(b)),null):c}function O(a,b,c){c?(k.texParameteri(a,k.TEXTURE_WRAP_S,I(b.wrapS)),k.texParameteri(a,k.TEXTURE_WRAP_T,I(b.wrapT)),k.texParameteri(a,k.TEXTURE_MAG_FILTER,I(b.magFilter)),k.texParameteri(a,k.TEXTURE_MIN_FILTER,I(b.minFilter))):(k.texParameteri(a,k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE),k.texParameteri(a,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE),k.texParameteri(a,k.TEXTURE_MAG_FILTER,L(b.magFilter)),k.texParameteri(a,k.TEXTURE_MIN_FILTER,
L(b.minFilter)));if(xb&&b.type!==THREE.FloatType&&(1<b.anisotropy||b.__oldAnisotropy))k.texParameterf(a,xb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,mc)),b.__oldAnisotropy=b.anisotropy}function B(a,b){k.bindRenderbuffer(k.RENDERBUFFER,a);b.depthBuffer&&!b.stencilBuffer?(k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_COMPONENT16,b.width,b.height),k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_ATTACHMENT,k.RENDERBUFFER,a)):b.depthBuffer&&b.stencilBuffer?(k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_STENCIL,
b.width,b.height),k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_STENCIL_ATTACHMENT,k.RENDERBUFFER,a)):k.renderbufferStorage(k.RENDERBUFFER,k.RGBA4,b.width,b.height)}function L(a){return a===THREE.NearestFilter||a===THREE.NearestMipMapNearestFilter||a===THREE.NearestMipMapLinearFilter?k.NEAREST:k.LINEAR}function I(a){if(a===THREE.RepeatWrapping)return k.REPEAT;if(a===THREE.ClampToEdgeWrapping)return k.CLAMP_TO_EDGE;if(a===THREE.MirroredRepeatWrapping)return k.MIRRORED_REPEAT;if(a===THREE.NearestFilter)return k.NEAREST;
...
if(a===THREE.OneMinusDstAlphaFactor)return k.ONE_MINUS_DST_ALPHA;if(a===THREE.DstColorFactor)return k.DST_COLOR;if(a===THREE.OneMinusDstColorFactor)return k.ONE_MINUS_DST_COLOR;if(a===THREE.SrcAlphaSaturateFactor)return k.SRC_ALPHA_SATURATE;if(void 0!==ob){if(a===THREE.RGB_S3TC_DXT1_Format)return ob.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT1_Format)return ob.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT3_Format)return ob.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===THREE.RGBA_S3TC_DXT5_Format)return ob.COMPRESSED_RGBA_S3TC_DXT5_EXT}return 0}
console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},G=void 0!==a.canvas?a.canvas:document.createElement("canvas"),Q=void 0!==a.precision?a.precision:"highp",N=void 0!==a.alpha?a.alpha:!0,K=void 0!==a.premultipliedAlpha?a.premultipliedAlpha:!0,aa=void 0!==a.antialias?a.antialias:!1,P=void 0!==a.stencil?a.stencil:!0,M=void 0!==a.preserveDrawingBuffer?a.preserveDrawingBuffer:!1,R=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),T=void 0!==a.clearAlpha?a.clearAlpha:0;this.domElement=
...
{memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var J=this,ra=[],S=0,ha=null,V=null,ba=-1,ia=null,Z=null,fa=0,Ma=0,Pa=-1,Aa=-1,Ta=-1,ua=-1,cb=-1,wb=-1,Ua=-1,fb=-1,kb=null,Ab=null,Bb=null,eb=null,va=0,Ha=0,lb=0,Ka=0,Za=0,db=0,ja=new THREE.Frustum,$a=new THREE.Matrix4,ab=new THREE.Matrix4,mb=new THREE.Vector4,ma=new THREE.Vector3,gb=!0,pb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,
colors:[],positions:[],distances:[],directions:[],angles:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,xb,ob;try{if(!(k=G.getContext("experimental-webgl",{alpha:N,premultipliedAlpha:K,antialias:aa,stencil:P,preserveDrawingBuffer:M})))throw"Error creating WebGL context.";}catch(Nc){console.error(Nc)}a=k.getExtension("OES_texture_float");N=k.getExtension("OES_standard_derivatives");xb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||
k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");ob=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");a||console.log("THREE.WebGLRenderer: Float textures not supported.");N||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");xb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");ob||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");
k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(R.r,R.g,R.b,T);this.context=k;var vc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),N=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Oc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),mc=xb?k.getParameter(xb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):
0,ec=0<N,fc=ec&&a;ob&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};this.supportsVertexTextures=function(){return ec};this.getMaxAnisotropy=function(){return mc};this.setSize=function(a,b){G.width=a;G.height=b;this.setViewport(0,0,G.width,G.height)};this.setViewport=function(a,b,c,d){va=void 0!==a?a:0;Ha=void 0!==b?b:0;lb=void 0!==c?c:G.width;Ka=void 0!==d?d:G.height;k.viewport(va,Ha,lb,Ka)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=
function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){R.setHex(a);T=b;k.clearColor(R.r,R.g,R.b,T)};this.setClearColor=function(a,b){R.copy(a);T=b;k.clearColor(R.r,R.g,R.b,T)};this.getClearColor=function(){return R};this.getClearAlpha=function(){return T};this.clear=function(a,b,c){var d=0;if(void 0===a||a)d|=k.COLOR_BUFFER_BIT;if(void 0===b||b)d|=k.DEPTH_BUFFER_BIT;if(void 0===c||c)d|=k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,
...
else k.deleteFramebuffer(a.__webglFramebuffer),k.deleteRenderbuffer(a.__webglRenderbuffer)};this.deallocateMaterial=function(a){var b=a.program;if(b){a.program=void 0;var c,d,e=!1,a=0;for(c=ra.length;a<c;a++)if(d=ra[a],d.program===b){d.usedTimes--;0===d.usedTimes&&(e=!0);break}if(e){e=[];a=0;for(c=ra.length;a<c;a++)d=ra[a],d.program!==b&&e.push(d);ra=e;k.deleteProgram(b);J.info.memory.programs--}}};this.updateShadowMap=function(a,b){ha=null;ba=ia=fb=Ua=Ta=-1;gb=!0;Aa=Pa=-1;this.shadowMapPlugin.update(a,
...
c.__webglTexture),k.generateMipmap(k.TEXTURE_2D),k.bindTexture(k.TEXTURE_2D,null)));this.setDepthTest(!0);this.setDepthWrite(!0)}};this.renderImmediateObject=function(a,b,c,d,e){var f=s(a,b,c,d,e);ia=-1;J.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,ja):e.render(function(a){J.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=
a.__objectsAdded[0],l=a,m=void 0,n=void 0,o=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,b instanceof THREE.Mesh)if(n=b.geometry,n instanceof THREE.Geometry){if(void 0===n.geometryGroups){var p=n,s=void 0,v=void 0,w=void 0,z=void 0,B=void 0,D=void 0,C=void 0,E={},H=p.morphTargets.length,I=p.morphNormals.length;p.geometryGroups={};s=0;for(v=p.faces.length;s<v;s++)w=p.faces[s],z=w.materialIndex,D=void 0!==z?z:-1,void 0===E[D]&&(E[D]=
{hash:D,counter:0}),C=E[D].hash+"_"+E[D].counter,void 0===p.geometryGroups[C]&&(p.geometryGroups[C]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:H,numMorphNormals:I}),B=w instanceof THREE.Face3?3:4,65535<p.geometryGroups[C].vertices+B&&(E[D].counter+=1,C=E[D].hash+"_"+E[D].counter,void 0===p.geometryGroups[C]&&(p.geometryGroups[C]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:H,numMorphNormals:I})),w instanceof THREE.Face3?p.geometryGroups[C].faces3.push(s):p.geometryGroups[C].faces4.push(s),
p.geometryGroups[C].vertices+=B;p.geometryGroupsList=[];var S=void 0;for(S in p.geometryGroups)p.geometryGroups[S].id=fa++,p.geometryGroupsList.push(p.geometryGroups[S])}for(m in n.geometryGroups)if(o=n.geometryGroups[m],!o.__webglVertexBuffer){var G=o;G.__webglVertexBuffer=k.createBuffer();G.__webglNormalBuffer=k.createBuffer();G.__webglTangentBuffer=k.createBuffer();G.__webglColorBuffer=k.createBuffer();G.__webglUVBuffer=k.createBuffer();G.__webglUV2Buffer=k.createBuffer();G.__webglSkinIndicesBuffer=
k.createBuffer();G.__webglSkinWeightsBuffer=k.createBuffer();G.__webglFaceBuffer=k.createBuffer();G.__webglLineBuffer=k.createBuffer();var M=void 0,L=void 0;if(G.numMorphTargets){G.__webglMorphTargetsBuffers=[];M=0;for(L=G.numMorphTargets;M<L;M++)G.__webglMorphTargetsBuffers.push(k.createBuffer())}if(G.numMorphNormals){G.__webglMorphNormalsBuffers=[];M=0;for(L=G.numMorphNormals;M<L;M++)G.__webglMorphNormalsBuffers.push(k.createBuffer())}J.info.memory.geometries++;d(o,b);n.verticesNeedUpdate=!0;n.morphTargetsNeedUpdate=
!0;n.elementsNeedUpdate=!0;n.uvsNeedUpdate=!0;n.normalsNeedUpdate=!0;n.tangentsNeedUpdate=!0;n.colorsNeedUpdate=!0}}else n instanceof THREE.BufferGeometry&&h(n);else if(b instanceof THREE.Ribbon){if(n=b.geometry,!n.__webglVertexBuffer){var K=n;K.__webglVertexBuffer=k.createBuffer();K.__webglColorBuffer=k.createBuffer();K.__webglNormalBuffer=k.createBuffer();J.info.memory.geometries++;var V=n,R=b,O=V.vertices.length;V.__vertexArray=new Float32Array(3*O);V.__colorArray=new Float32Array(3*O);V.__normalArray=
new Float32Array(3*O);V.__webglVertexCount=O;c(V,R);n.verticesNeedUpdate=!0;n.colorsNeedUpdate=!0;n.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(n=b.geometry,!n.__webglVertexBuffer){var N=n;N.__webglVertexBuffer=k.createBuffer();N.__webglColorBuffer=k.createBuffer();N.__webglLineDistanceBuffer=k.createBuffer();J.info.memory.geometries++;var ba=n,Q=b,P=ba.vertices.length;ba.__vertexArray=new Float32Array(3*P);ba.__colorArray=new Float32Array(3*P);ba.__lineDistanceArray=new Float32Array(1*
P);ba.__webglLineCount=P;c(ba,Q);n.verticesNeedUpdate=!0;n.colorsNeedUpdate=!0;n.lineDistancesNeedUpdate=!0}}else if(b instanceof THREE.ParticleSystem&&(n=b.geometry,!n.__webglVertexBuffer))if(n instanceof THREE.Geometry){var T=n;T.__webglVertexBuffer=k.createBuffer();T.__webglColorBuffer=k.createBuffer();J.info.memory.geometries++;var Z=n,ha=b,ia=Z.vertices.length;Z.__vertexArray=new Float32Array(3*ia);Z.__colorArray=new Float32Array(3*ia);Z.__sortArray=[];Z.__webglParticleCount=ia;c(Z,ha);n.verticesNeedUpdate=
!0;n.colorsNeedUpdate=!0}else n instanceof THREE.BufferGeometry&&h(n);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(n=b.geometry,n instanceof THREE.BufferGeometry)q(l.__webglObjects,n,b);else for(m in n.geometryGroups)o=n.geometryGroups[m],q(l.__webglObjects,o,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(n=b.geometry,q(l.__webglObjects,n,b)):b instanceof THREE.ImmediateRenderObject||b.immediateRenderCallback?l.__webglObjectsImmediate.push({object:b,
opaque:null,transparent:null}):b instanceof THREE.Sprite?l.__webglSprites.push(b):b instanceof THREE.LensFlare&&l.__webglFlares.push(b);b.__webglActive=!0}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var aa=a.__objectsRemoved[0],ra=a;aa instanceof THREE.Mesh||aa instanceof THREE.ParticleSystem||aa instanceof THREE.Ribbon||aa instanceof THREE.Line?A(ra.__webglObjects,aa):aa instanceof THREE.Sprite?u(ra.__webglSprites,aa):aa instanceof THREE.LensFlare?u(ra.__webglFlares,aa):(aa instanceof
THREE.ImmediateRenderObject||aa.immediateRenderCallback)&&A(ra.__webglObjectsImmediate,aa);aa.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var Ma=0,ua=a.__webglObjects.length;Ma<ua;Ma++){var ma=a.__webglObjects[Ma].object,ea=ma.geometry,Pa=void 0,Aa=void 0,ja=void 0;if(ma instanceof THREE.Mesh)if(ea instanceof THREE.BufferGeometry)(ea.verticesNeedUpdate||ea.elementsNeedUpdate||ea.uvsNeedUpdate||ea.normalsNeedUpdate||ea.colorsNeedUpdate||ea.tangentsNeedUpdate)&&j(ea,k.DYNAMIC_DRAW,!ea.dynamic),
ea.verticesNeedUpdate=!1,ea.elementsNeedUpdate=!1,ea.uvsNeedUpdate=!1,ea.normalsNeedUpdate=!1,ea.colorsNeedUpdate=!1,ea.tangentsNeedUpdate=!1;else{for(var Ha=0,Ka=ea.geometryGroupsList.length;Ha<Ka;Ha++)if(Pa=ea.geometryGroupsList[Ha],ja=e(ma,Pa),ea.buffersNeedUpdate&&d(Pa,ma),Aa=ja.attributes&&t(ja),ea.verticesNeedUpdate||ea.morphTargetsNeedUpdate||ea.elementsNeedUpdate||ea.uvsNeedUpdate||ea.normalsNeedUpdate||ea.colorsNeedUpdate||ea.tangentsNeedUpdate||Aa){var qa=Pa,Ta=ma,va=k.DYNAMIC_DRAW,cb=!ea.dynamic,
Ua=ja;if(qa.__inittedArrays){var eb=f(Ua),gb=Ua.vertexColors?Ua.vertexColors:!1,wb=g(Ua),fb=eb===THREE.SmoothShading,F=void 0,$=void 0,Za=void 0,U=void 0,db=void 0,$a=void 0,Db=void 0,mb=void 0,ab=void 0,kb=void 0,lb=void 0,W=void 0,X=void 0,Y=void 0,pa=void 0,Eb=void 0,Fb=void 0,Gb=void 0,ob=void 0,Hb=void 0,Ib=void 0,Jb=void 0,pb=void 0,Kb=void 0,Lb=void 0,Mb=void 0,xb=void 0,Nb=void 0,Ob=void 0,Pb=void 0,Ab=void 0,Qb=void 0,Rb=void 0,Sb=void 0,Bb=void 0,wa=void 0,ec=void 0,Zb=void 0,ic=void 0,
jc=void 0,Qa=void 0,fc=void 0,Na=void 0,Oa=void 0,$b=void 0,Ub=void 0,Ia=0,La=0,Vb=0,Wb=0,sb=0,Xa=0,za=0,bb=0,Ja=0,ga=0,ka=0,y=0,xa=void 0,Ra=qa.__vertexArray,nc=qa.__uvArray,oc=qa.__uv2Array,tb=qa.__normalArray,Da=qa.__tangentArray,Sa=qa.__colorArray,Ea=qa.__skinIndexArray,Fa=qa.__skinWeightArray,Qc=qa.__morphTargetsArrays,Rc=qa.__morphNormalsArrays,Sc=qa.__webglCustomAttributesList,x=void 0,Tb=qa.__faceArray,nb=qa.__lineArray,hb=Ta.geometry,vc=hb.elementsNeedUpdate,mc=hb.uvsNeedUpdate,Nc=hb.normalsNeedUpdate,
Oc=hb.tangentsNeedUpdate,fd=hb.colorsNeedUpdate,gd=hb.morphTargetsNeedUpdate,cc=hb.vertices,sa=qa.faces3,ta=qa.faces4,Ya=hb.faces,Tc=hb.faceVertexUvs[0],Uc=hb.faceVertexUvs[1],dc=hb.skinIndices,ac=hb.skinWeights,bc=hb.morphTargets,yc=hb.morphNormals;if(hb.verticesNeedUpdate){F=0;for($=sa.length;F<$;F++)U=Ya[sa[F]],W=cc[U.a],X=cc[U.b],Y=cc[U.c],Ra[La]=W.x,Ra[La+1]=W.y,Ra[La+2]=W.z,Ra[La+3]=X.x,Ra[La+4]=X.y,Ra[La+5]=X.z,Ra[La+6]=Y.x,Ra[La+7]=Y.y,Ra[La+8]=Y.z,La+=9;F=0;for($=ta.length;F<$;F++)U=Ya[ta[F]],
W=cc[U.a],X=cc[U.b],Y=cc[U.c],pa=cc[U.d],Ra[La]=W.x,Ra[La+1]=W.y,Ra[La+2]=W.z,Ra[La+3]=X.x,Ra[La+4]=X.y,Ra[La+5]=X.z,Ra[La+6]=Y.x,Ra[La+7]=Y.y,Ra[La+8]=Y.z,Ra[La+9]=pa.x,Ra[La+10]=pa.y,Ra[La+11]=pa.z,La+=12;k.bindBuffer(k.ARRAY_BUFFER,qa.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Ra,va)}if(gd){Qa=0;for(fc=bc.length;Qa<fc;Qa++){F=ka=0;for($=sa.length;F<$;F++)$b=sa[F],U=Ya[$b],W=bc[Qa].vertices[U.a],X=bc[Qa].vertices[U.b],Y=bc[Qa].vertices[U.c],Na=Qc[Qa],Na[ka]=W.x,Na[ka+1]=W.y,Na[ka+2]=W.z,Na[ka+
3]=X.x,Na[ka+4]=X.y,Na[ka+5]=X.z,Na[ka+6]=Y.x,Na[ka+7]=Y.y,Na[ka+8]=Y.z,Ua.morphNormals&&(fb?(Ub=yc[Qa].vertexNormals[$b],Hb=Ub.a,Ib=Ub.b,Jb=Ub.c):Jb=Ib=Hb=yc[Qa].faceNormals[$b],Oa=Rc[Qa],Oa[ka]=Hb.x,Oa[ka+1]=Hb.y,Oa[ka+2]=Hb.z,Oa[ka+3]=Ib.x,Oa[ka+4]=Ib.y,Oa[ka+5]=Ib.z,Oa[ka+6]=Jb.x,Oa[ka+7]=Jb.y,Oa[ka+8]=Jb.z),ka+=9;F=0;for($=ta.length;F<$;F++)$b=ta[F],U=Ya[$b],W=bc[Qa].vertices[U.a],X=bc[Qa].vertices[U.b],Y=bc[Qa].vertices[U.c],pa=bc[Qa].vertices[U.d],Na=Qc[Qa],Na[ka]=W.x,Na[ka+1]=W.y,Na[ka+2]=
W.z,Na[ka+3]=X.x,Na[ka+4]=X.y,Na[ka+5]=X.z,Na[ka+6]=Y.x,Na[ka+7]=Y.y,Na[ka+8]=Y.z,Na[ka+9]=pa.x,Na[ka+10]=pa.y,Na[ka+11]=pa.z,Ua.morphNormals&&(fb?(Ub=yc[Qa].vertexNormals[$b],Hb=Ub.a,Ib=Ub.b,Jb=Ub.c,pb=Ub.d):pb=Jb=Ib=Hb=yc[Qa].faceNormals[$b],Oa=Rc[Qa],Oa[ka]=Hb.x,Oa[ka+1]=Hb.y,Oa[ka+2]=Hb.z,Oa[ka+3]=Ib.x,Oa[ka+4]=Ib.y,Oa[ka+5]=Ib.z,Oa[ka+6]=Jb.x,Oa[ka+7]=Jb.y,Oa[ka+8]=Jb.z,Oa[ka+9]=pb.x,Oa[ka+10]=pb.y,Oa[ka+11]=pb.z),ka+=12;k.bindBuffer(k.ARRAY_BUFFER,qa.__webglMorphTargetsBuffers[Qa]);k.bufferData(k.ARRAY_BUFFER,
Qc[Qa],va);Ua.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,qa.__webglMorphNormalsBuffers[Qa]),k.bufferData(k.ARRAY_BUFFER,Rc[Qa],va))}}if(ac.length){F=0;for($=sa.length;F<$;F++)U=Ya[sa[F]],Nb=ac[U.a],Ob=ac[U.b],Pb=ac[U.c],Fa[ga]=Nb.x,Fa[ga+1]=Nb.y,Fa[ga+2]=Nb.z,Fa[ga+3]=Nb.w,Fa[ga+4]=Ob.x,Fa[ga+5]=Ob.y,Fa[ga+6]=Ob.z,Fa[ga+7]=Ob.w,Fa[ga+8]=Pb.x,Fa[ga+9]=Pb.y,Fa[ga+10]=Pb.z,Fa[ga+11]=Pb.w,Qb=dc[U.a],Rb=dc[U.b],Sb=dc[U.c],Ea[ga]=Qb.x,Ea[ga+1]=Qb.y,Ea[ga+2]=Qb.z,Ea[ga+3]=Qb.w,Ea[ga+4]=Rb.x,Ea[ga+5]=Rb.y,
Ea[ga+6]=Rb.z,Ea[ga+7]=Rb.w,Ea[ga+8]=Sb.x,Ea[ga+9]=Sb.y,Ea[ga+10]=Sb.z,Ea[ga+11]=Sb.w,ga+=12;F=0;for($=ta.length;F<$;F++)U=Ya[ta[F]],Nb=ac[U.a],Ob=ac[U.b],Pb=ac[U.c],Ab=ac[U.d],Fa[ga]=Nb.x,Fa[ga+1]=Nb.y,Fa[ga+2]=Nb.z,Fa[ga+3]=Nb.w,Fa[ga+4]=Ob.x,Fa[ga+5]=Ob.y,Fa[ga+6]=Ob.z,Fa[ga+7]=Ob.w,Fa[ga+8]=Pb.x,Fa[ga+9]=Pb.y,Fa[ga+10]=Pb.z,Fa[ga+11]=Pb.w,Fa[ga+12]=Ab.x,Fa[ga+13]=Ab.y,Fa[ga+14]=Ab.z,Fa[ga+15]=Ab.w,Qb=dc[U.a],Rb=dc[U.b],Sb=dc[U.c],Bb=dc[U.d],Ea[ga]=Qb.x,Ea[ga+1]=Qb.y,Ea[ga+2]=Qb.z,Ea[ga+3]=Qb.w,
Ea[ga+4]=Rb.x,Ea[ga+5]=Rb.y,Ea[ga+6]=Rb.z,Ea[ga+7]=Rb.w,Ea[ga+8]=Sb.x,Ea[ga+9]=Sb.y,Ea[ga+10]=Sb.z,Ea[ga+11]=Sb.w,Ea[ga+12]=Bb.x,Ea[ga+13]=Bb.y,Ea[ga+14]=Bb.z,Ea[ga+15]=Bb.w,ga+=16;0<ga&&(k.bindBuffer(k.ARRAY_BUFFER,qa.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ea,va),k.bindBuffer(k.ARRAY_BUFFER,qa.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Fa,va))}if(fd&&gb){F=0;for($=sa.length;F<$;F++)U=Ya[sa[F]],Db=U.vertexColors,mb=U.color,3===Db.length&&gb===THREE.VertexColors?(Kb=Db[0],
Lb=Db[1],Mb=Db[2]):Mb=Lb=Kb=mb,Sa[Ja]=Kb.r,Sa[Ja+1]=Kb.g,Sa[Ja+2]=Kb.b,Sa[Ja+3]=Lb.r,Sa[Ja+4]=Lb.g,Sa[Ja+5]=Lb.b,Sa[Ja+6]=Mb.r,Sa[Ja+7]=Mb.g,Sa[Ja+8]=Mb.b,Ja+=9;F=0;for($=ta.length;F<$;F++)U=Ya[ta[F]],Db=U.vertexColors,mb=U.color,4===Db.length&&gb===THREE.VertexColors?(Kb=Db[0],Lb=Db[1],Mb=Db[2],xb=Db[3]):xb=Mb=Lb=Kb=mb,Sa[Ja]=Kb.r,Sa[Ja+1]=Kb.g,Sa[Ja+2]=Kb.b,Sa[Ja+3]=Lb.r,Sa[Ja+4]=Lb.g,Sa[Ja+5]=Lb.b,Sa[Ja+6]=Mb.r,Sa[Ja+7]=Mb.g,Sa[Ja+8]=Mb.b,Sa[Ja+9]=xb.r,Sa[Ja+10]=xb.g,Sa[Ja+11]=xb.b,Ja+=12;0<Ja&&
(k.bindBuffer(k.ARRAY_BUFFER,qa.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Sa,va))}if(Oc&&hb.hasTangents){F=0;for($=sa.length;F<$;F++)U=Ya[sa[F]],ab=U.vertexTangents,Eb=ab[0],Fb=ab[1],Gb=ab[2],Da[za]=Eb.x,Da[za+1]=Eb.y,Da[za+2]=Eb.z,Da[za+3]=Eb.w,Da[za+4]=Fb.x,Da[za+5]=Fb.y,Da[za+6]=Fb.z,Da[za+7]=Fb.w,Da[za+8]=Gb.x,Da[za+9]=Gb.y,Da[za+10]=Gb.z,Da[za+11]=Gb.w,za+=12;F=0;for($=ta.length;F<$;F++)U=Ya[ta[F]],ab=U.vertexTangents,Eb=ab[0],Fb=ab[1],Gb=ab[2],ob=ab[3],Da[za]=Eb.x,Da[za+1]=Eb.y,Da[za+
2]=Eb.z,Da[za+3]=Eb.w,Da[za+4]=Fb.x,Da[za+5]=Fb.y,Da[za+6]=Fb.z,Da[za+7]=Fb.w,Da[za+8]=Gb.x,Da[za+9]=Gb.y,Da[za+10]=Gb.z,Da[za+11]=Gb.w,Da[za+12]=ob.x,Da[za+13]=ob.y,Da[za+14]=ob.z,Da[za+15]=ob.w,za+=16;k.bindBuffer(k.ARRAY_BUFFER,qa.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Da,va)}if(Nc&&eb){F=0;for($=sa.length;F<$;F++)if(U=Ya[sa[F]],db=U.vertexNormals,$a=U.normal,3===db.length&&fb)for(wa=0;3>wa;wa++)Zb=db[wa],tb[Xa]=Zb.x,tb[Xa+1]=Zb.y,tb[Xa+2]=Zb.z,Xa+=3;else for(wa=0;3>wa;wa++)tb[Xa]=$a.x,
tb[Xa+1]=$a.y,tb[Xa+2]=$a.z,Xa+=3;F=0;for($=ta.length;F<$;F++)if(U=Ya[ta[F]],db=U.vertexNormals,$a=U.normal,4===db.length&&fb)for(wa=0;4>wa;wa++)Zb=db[wa],tb[Xa]=Zb.x,tb[Xa+1]=Zb.y,tb[Xa+2]=Zb.z,Xa+=3;else for(wa=0;4>wa;wa++)tb[Xa]=$a.x,tb[Xa+1]=$a.y,tb[Xa+2]=$a.z,Xa+=3;k.bindBuffer(k.ARRAY_BUFFER,qa.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,tb,va)}if(mc&&Tc&&wb){F=0;for($=sa.length;F<$;F++)if(Za=sa[F],kb=Tc[Za],void 0!==kb)for(wa=0;3>wa;wa++)ic=kb[wa],nc[Vb]=ic.u,nc[Vb+1]=ic.v,Vb+=2;F=0;for($=
ta.length;F<$;F++)if(Za=ta[F],kb=Tc[Za],void 0!==kb)for(wa=0;4>wa;wa++)ic=kb[wa],nc[Vb]=ic.u,nc[Vb+1]=ic.v,Vb+=2;0<Vb&&(k.bindBuffer(k.ARRAY_BUFFER,qa.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,nc,va))}if(mc&&Uc&&wb){F=0;for($=sa.length;F<$;F++)if(Za=sa[F],lb=Uc[Za],void 0!==lb)for(wa=0;3>wa;wa++)jc=lb[wa],oc[Wb]=jc.u,oc[Wb+1]=jc.v,Wb+=2;F=0;for($=ta.length;F<$;F++)if(Za=ta[F],lb=Uc[Za],void 0!==lb)for(wa=0;4>wa;wa++)jc=lb[wa],oc[Wb]=jc.u,oc[Wb+1]=jc.v,Wb+=2;0<Wb&&(k.bindBuffer(k.ARRAY_BUFFER,qa.__webglUV2Buffer),
k.bufferData(k.ARRAY_BUFFER,oc,va))}if(vc){F=0;for($=sa.length;F<$;F++)Tb[sb]=Ia,Tb[sb+1]=Ia+1,Tb[sb+2]=Ia+2,sb+=3,nb[bb]=Ia,nb[bb+1]=Ia+1,nb[bb+2]=Ia,nb[bb+3]=Ia+2,nb[bb+4]=Ia+1,nb[bb+5]=Ia+2,bb+=6,Ia+=3;F=0;for($=ta.length;F<$;F++)Tb[sb]=Ia,Tb[sb+1]=Ia+1,Tb[sb+2]=Ia+3,Tb[sb+3]=Ia+1,Tb[sb+4]=Ia+2,Tb[sb+5]=Ia+3,sb+=6,nb[bb]=Ia,nb[bb+1]=Ia+1,nb[bb+2]=Ia,nb[bb+3]=Ia+3,nb[bb+4]=Ia+1,nb[bb+5]=Ia+2,nb[bb+6]=Ia+2,nb[bb+7]=Ia+3,bb+=8,Ia+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,qa.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,
Tb,va);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,qa.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,nb,va)}if(Sc){wa=0;for(ec=Sc.length;wa<ec;wa++)if(x=Sc[wa],x.__original.needsUpdate){y=0;if(1===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){F=0;for($=sa.length;F<$;F++)U=Ya[sa[F]],x.array[y]=x.value[U.a],x.array[y+1]=x.value[U.b],x.array[y+2]=x.value[U.c],y+=3;F=0;for($=ta.length;F<$;F++)U=Ya[ta[F]],x.array[y]=x.value[U.a],x.array[y+1]=x.value[U.b],x.array[y+2]=x.value[U.c],x.array[y+3]=
x.value[U.d],y+=4}else{if("faces"===x.boundTo){F=0;for($=sa.length;F<$;F++)xa=x.value[sa[F]],x.array[y]=xa,x.array[y+1]=xa,x.array[y+2]=xa,y+=3;F=0;for($=ta.length;F<$;F++)xa=x.value[ta[F]],x.array[y]=xa,x.array[y+1]=xa,x.array[y+2]=xa,x.array[y+3]=xa,y+=4}}else if(2===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){F=0;for($=sa.length;F<$;F++)U=Ya[sa[F]],W=x.value[U.a],X=x.value[U.b],Y=x.value[U.c],x.array[y]=W.x,x.array[y+1]=W.y,x.array[y+2]=X.x,x.array[y+3]=X.y,x.array[y+4]=Y.x,x.array[y+
5]=Y.y,y+=6;F=0;for($=ta.length;F<$;F++)U=Ya[ta[F]],W=x.value[U.a],X=x.value[U.b],Y=x.value[U.c],pa=x.value[U.d],x.array[y]=W.x,x.array[y+1]=W.y,x.array[y+2]=X.x,x.array[y+3]=X.y,x.array[y+4]=Y.x,x.array[y+5]=Y.y,x.array[y+6]=pa.x,x.array[y+7]=pa.y,y+=8}else{if("faces"===x.boundTo){F=0;for($=sa.length;F<$;F++)Y=X=W=xa=x.value[sa[F]],x.array[y]=W.x,x.array[y+1]=W.y,x.array[y+2]=X.x,x.array[y+3]=X.y,x.array[y+4]=Y.x,x.array[y+5]=Y.y,y+=6;F=0;for($=ta.length;F<$;F++)pa=Y=X=W=xa=x.value[ta[F]],x.array[y]=
W.x,x.array[y+1]=W.y,x.array[y+2]=X.x,x.array[y+3]=X.y,x.array[y+4]=Y.x,x.array[y+5]=Y.y,x.array[y+6]=pa.x,x.array[y+7]=pa.y,y+=8}}else if(3===x.size){var da;da="c"===x.type?["r","g","b"]:["x","y","z"];if(void 0===x.boundTo||"vertices"===x.boundTo){F=0;for($=sa.length;F<$;F++)U=Ya[sa[F]],W=x.value[U.a],X=x.value[U.b],Y=x.value[U.c],x.array[y]=W[da[0]],x.array[y+1]=W[da[1]],x.array[y+2]=W[da[2]],x.array[y+3]=X[da[0]],x.array[y+4]=X[da[1]],x.array[y+5]=X[da[2]],x.array[y+6]=Y[da[0]],x.array[y+7]=Y[da[1]],
x.array[y+8]=Y[da[2]],y+=9;F=0;for($=ta.length;F<$;F++)U=Ya[ta[F]],W=x.value[U.a],X=x.value[U.b],Y=x.value[U.c],pa=x.value[U.d],x.array[y]=W[da[0]],x.array[y+1]=W[da[1]],x.array[y+2]=W[da[2]],x.array[y+3]=X[da[0]],x.array[y+4]=X[da[1]],x.array[y+5]=X[da[2]],x.array[y+6]=Y[da[0]],x.array[y+7]=Y[da[1]],x.array[y+8]=Y[da[2]],x.array[y+9]=pa[da[0]],x.array[y+10]=pa[da[1]],x.array[y+11]=pa[da[2]],y+=12}else if("faces"===x.boundTo){F=0;for($=sa.length;F<$;F++)Y=X=W=xa=x.value[sa[F]],x.array[y]=W[da[0]],
x.array[y+1]=W[da[1]],x.array[y+2]=W[da[2]],x.array[y+3]=X[da[0]],x.array[y+4]=X[da[1]],x.array[y+5]=X[da[2]],x.array[y+6]=Y[da[0]],x.array[y+7]=Y[da[1]],x.array[y+8]=Y[da[2]],y+=9;F=0;for($=ta.length;F<$;F++)pa=Y=X=W=xa=x.value[ta[F]],x.array[y]=W[da[0]],x.array[y+1]=W[da[1]],x.array[y+2]=W[da[2]],x.array[y+3]=X[da[0]],x.array[y+4]=X[da[1]],x.array[y+5]=X[da[2]],x.array[y+6]=Y[da[0]],x.array[y+7]=Y[da[1]],x.array[y+8]=Y[da[2]],x.array[y+9]=pa[da[0]],x.array[y+10]=pa[da[1]],x.array[y+11]=pa[da[2]],
y+=12}else if("faceVertices"===x.boundTo){F=0;for($=sa.length;F<$;F++)xa=x.value[sa[F]],W=xa[0],X=xa[1],Y=xa[2],x.array[y]=W[da[0]],x.array[y+1]=W[da[1]],x.array[y+2]=W[da[2]],x.array[y+3]=X[da[0]],x.array[y+4]=X[da[1]],x.array[y+5]=X[da[2]],x.array[y+6]=Y[da[0]],x.array[y+7]=Y[da[1]],x.array[y+8]=Y[da[2]],y+=9;F=0;for($=ta.length;F<$;F++)xa=x.value[ta[F]],W=xa[0],X=xa[1],Y=xa[2],pa=xa[3],x.array[y]=W[da[0]],x.array[y+1]=W[da[1]],x.array[y+2]=W[da[2]],x.array[y+3]=X[da[0]],x.array[y+4]=X[da[1]],x.array[y+
5]=X[da[2]],x.array[y+6]=Y[da[0]],x.array[y+7]=Y[da[1]],x.array[y+8]=Y[da[2]],x.array[y+9]=pa[da[0]],x.array[y+10]=pa[da[1]],x.array[y+11]=pa[da[2]],y+=12}}else if(4===x.size)if(void 0===x.boundTo||"vertices"===x.boundTo){F=0;for($=sa.length;F<$;F++)U=Ya[sa[F]],W=x.value[U.a],X=x.value[U.b],Y=x.value[U.c],x.array[y]=W.x,x.array[y+1]=W.y,x.array[y+2]=W.z,x.array[y+3]=W.w,x.array[y+4]=X.x,x.array[y+5]=X.y,x.array[y+6]=X.z,x.array[y+7]=X.w,x.array[y+8]=Y.x,x.array[y+9]=Y.y,x.array[y+10]=Y.z,x.array[y+
11]=Y.w,y+=12;F=0;for($=ta.length;F<$;F++)U=Ya[ta[F]],W=x.value[U.a],X=x.value[U.b],Y=x.value[U.c],pa=x.value[U.d],x.array[y]=W.x,x.array[y+1]=W.y,x.array[y+2]=W.z,x.array[y+3]=W.w,x.array[y+4]=X.x,x.array[y+5]=X.y,x.array[y+6]=X.z,x.array[y+7]=X.w,x.array[y+8]=Y.x,x.array[y+9]=Y.y,x.array[y+10]=Y.z,x.array[y+11]=Y.w,x.array[y+12]=pa.x,x.array[y+13]=pa.y,x.array[y+14]=pa.z,x.array[y+15]=pa.w,y+=16}else if("faces"===x.boundTo){F=0;for($=sa.length;F<$;F++)Y=X=W=xa=x.value[sa[F]],x.array[y]=W.x,x.array[y+
1]=W.y,x.array[y+2]=W.z,x.array[y+3]=W.w,x.array[y+4]=X.x,x.array[y+5]=X.y,x.array[y+6]=X.z,x.array[y+7]=X.w,x.array[y+8]=Y.x,x.array[y+9]=Y.y,x.array[y+10]=Y.z,x.array[y+11]=Y.w,y+=12;F=0;for($=ta.length;F<$;F++)pa=Y=X=W=xa=x.value[ta[F]],x.array[y]=W.x,x.array[y+1]=W.y,x.array[y+2]=W.z,x.array[y+3]=W.w,x.array[y+4]=X.x,x.array[y+5]=X.y,x.array[y+6]=X.z,x.array[y+7]=X.w,x.array[y+8]=Y.x,x.array[y+9]=Y.y,x.array[y+10]=Y.z,x.array[y+11]=Y.w,x.array[y+12]=pa.x,x.array[y+13]=pa.y,x.array[y+14]=pa.z,
x.array[y+15]=pa.w,y+=16}else if("faceVertices"===x.boundTo){F=0;for($=sa.length;F<$;F++)xa=x.value[sa[F]],W=xa[0],X=xa[1],Y=xa[2],x.array[y]=W.x,x.array[y+1]=W.y,x.array[y+2]=W.z,x.array[y+3]=W.w,x.array[y+4]=X.x,x.array[y+5]=X.y,x.array[y+6]=X.z,x.array[y+7]=X.w,x.array[y+8]=Y.x,x.array[y+9]=Y.y,x.array[y+10]=Y.z,x.array[y+11]=Y.w,y+=12;F=0;for($=ta.length;F<$;F++)xa=x.value[ta[F]],W=xa[0],X=xa[1],Y=xa[2],pa=xa[3],x.array[y]=W.x,x.array[y+1]=W.y,x.array[y+2]=W.z,x.array[y+3]=W.w,x.array[y+4]=X.x,
x.array[y+5]=X.y,x.array[y+6]=X.z,x.array[y+7]=X.w,x.array[y+8]=Y.x,x.array[y+9]=Y.y,x.array[y+10]=Y.z,x.array[y+11]=Y.w,x.array[y+12]=pa.x,x.array[y+13]=pa.y,x.array[y+14]=pa.z,x.array[y+15]=pa.w,y+=16}k.bindBuffer(k.ARRAY_BUFFER,x.buffer);k.bufferData(k.ARRAY_BUFFER,x.array,va)}}cb&&(delete qa.__inittedArrays,delete qa.__colorArray,delete qa.__normalArray,delete qa.__tangentArray,delete qa.__uvArray,delete qa.__uv2Array,delete qa.__faceArray,delete qa.__vertexArray,delete qa.__lineArray,delete qa.__skinIndexArray,
delete qa.__skinWeightArray)}}ea.verticesNeedUpdate=!1;ea.morphTargetsNeedUpdate=!1;ea.elementsNeedUpdate=!1;ea.uvsNeedUpdate=!1;ea.normalsNeedUpdate=!1;ea.colorsNeedUpdate=!1;ea.tangentsNeedUpdate=!1;ea.buffersNeedUpdate=!1;ja.attributes&&r(ja)}else if(ma instanceof THREE.Ribbon){ja=e(ma,ea);Aa=ja.attributes&&t(ja);if(ea.verticesNeedUpdate||ea.colorsNeedUpdate||ea.normalsNeedUpdate||Aa){var ub=ea,zc=k.DYNAMIC_DRAW,pc=void 0,qc=void 0,rc=void 0,Ac=void 0,ya=void 0,Bc=void 0,Cc=void 0,Dc=void 0,Xc=
void 0,Va=void 0,kc=void 0,Ba=void 0,ib=void 0,Yc=ub.vertices,Zc=ub.colors,$c=ub.normals,hd=Yc.length,id=Zc.length,jd=$c.length,Ec=ub.__vertexArray,Fc=ub.__colorArray,Gc=ub.__normalArray,kd=ub.colorsNeedUpdate,ld=ub.normalsNeedUpdate,Vc=ub.__webglCustomAttributesList;if(ub.verticesNeedUpdate){for(pc=0;pc<hd;pc++)Ac=Yc[pc],ya=3*pc,Ec[ya]=Ac.x,Ec[ya+1]=Ac.y,Ec[ya+2]=Ac.z;k.bindBuffer(k.ARRAY_BUFFER,ub.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Ec,zc)}if(kd){for(qc=0;qc<id;qc++)Bc=Zc[qc],ya=3*
...
else if(2===Ba.size)for(Va=0;Va<kc;Va++)ib=Ba.value[Va],Ba.array[ya]=ib.x,Ba.array[ya+1]=ib.y,ya+=2;else if(3===Ba.size)if("c"===Ba.type)for(Va=0;Va<kc;Va++)ib=Ba.value[Va],Ba.array[ya]=ib.r,Ba.array[ya+1]=ib.g,Ba.array[ya+2]=ib.b,ya+=3;else for(Va=0;Va<kc;Va++)ib=Ba.value[Va],Ba.array[ya]=ib.x,Ba.array[ya+1]=ib.y,Ba.array[ya+2]=ib.z,ya+=3;else if(4===Ba.size)for(Va=0;Va<kc;Va++)ib=Ba.value[Va],Ba.array[ya]=ib.x,Ba.array[ya+1]=ib.y,Ba.array[ya+2]=ib.z,Ba.array[ya+3]=ib.w,ya+=4;k.bindBuffer(k.ARRAY_BUFFER,
Ba.buffer);k.bufferData(k.ARRAY_BUFFER,Ba.array,zc)}}}ea.verticesNeedUpdate=!1;ea.colorsNeedUpdate=!1;ea.normalsNeedUpdate=!1;ja.attributes&&r(ja)}else if(ma instanceof THREE.Line){ja=e(ma,ea);Aa=ja.attributes&&t(ja);if(ea.verticesNeedUpdate||ea.colorsNeedUpdate||ea.lineDistancesNeedUpdate||Aa){var vb=ea,Hc=k.DYNAMIC_DRAW,sc=void 0,tc=void 0,uc=void 0,Ic=void 0,Ga=void 0,Jc=void 0,ad=vb.vertices,bd=vb.colors,cd=vb.lineDistances,md=ad.length,nd=bd.length,od=cd.length,Kc=vb.__vertexArray,Lc=vb.__colorArray,
dd=vb.__lineDistanceArray,pd=vb.colorsNeedUpdate,qd=vb.lineDistancesNeedUpdate,Wc=vb.__webglCustomAttributesList,Mc=void 0,ed=void 0,Wa=void 0,lc=void 0,jb=void 0,Ca=void 0;if(vb.verticesNeedUpdate){for(sc=0;sc<md;sc++)Ic=ad[sc],Ga=3*sc,Kc[Ga]=Ic.x,Kc[Ga+1]=Ic.y,Kc[Ga+2]=Ic.z;k.bindBuffer(k.ARRAY_BUFFER,vb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Kc,Hc)}if(pd){for(tc=0;tc<nd;tc++)Jc=bd[tc],Ga=3*tc,Lc[Ga]=Jc.r,Lc[Ga+1]=Jc.g,Lc[Ga+2]=Jc.b;k.bindBuffer(k.ARRAY_BUFFER,vb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,
Lc,Hc)}if(qd){for(uc=0;uc<od;uc++)dd[uc]=cd[uc];k.bindBuffer(k.ARRAY_BUFFER,vb.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,dd,Hc)}if(Wc){Mc=0;for(ed=Wc.length;Mc<ed;Mc++)if(Ca=Wc[Mc],Ca.needsUpdate&&(void 0===Ca.boundTo||"vertices"===Ca.boundTo)){Ga=0;lc=Ca.value.length;if(1===Ca.size)for(Wa=0;Wa<lc;Wa++)Ca.array[Wa]=Ca.value[Wa];else if(2===Ca.size)for(Wa=0;Wa<lc;Wa++)jb=Ca.value[Wa],Ca.array[Ga]=jb.x,Ca.array[Ga+1]=jb.y,Ga+=2;else if(3===Ca.size)if("c"===Ca.type)for(Wa=0;Wa<lc;Wa++)jb=
Ca.value[Wa],Ca.array[Ga]=jb.r,Ca.array[Ga+1]=jb.g,Ca.array[Ga+2]=jb.b,Ga+=3;else for(Wa=0;Wa<lc;Wa++)jb=Ca.value[Wa],Ca.array[Ga]=jb.x,Ca.array[Ga+1]=jb.y,Ca.array[Ga+2]=jb.z,Ga+=3;else if(4===Ca.size)for(Wa=0;Wa<lc;Wa++)jb=Ca.value[Wa],Ca.array[Ga]=jb.x,Ca.array[Ga+1]=jb.y,Ca.array[Ga+2]=jb.z,Ca.array[Ga+3]=jb.w,Ga+=4;k.bindBuffer(k.ARRAY_BUFFER,Ca.buffer);k.bufferData(k.ARRAY_BUFFER,Ca.array,Hc)}}}ea.verticesNeedUpdate=!1;ea.colorsNeedUpdate=!1;ea.lineDistancesNeedUpdate=!1;ja.attributes&&r(ja)}else ma instanceof
THREE.ParticleSystem&&(ea instanceof THREE.BufferGeometry?((ea.verticesNeedUpdate||ea.colorsNeedUpdate)&&j(ea,k.DYNAMIC_DRAW,!ea.dynamic),ea.verticesNeedUpdate=!1,ea.colorsNeedUpdate=!1):(ja=e(ma,ea),Aa=ja.attributes&&t(ja),(ea.verticesNeedUpdate||ea.colorsNeedUpdate||ma.sortParticles||Aa)&&i(ea,k.DYNAMIC_DRAW,ma),ea.verticesNeedUpdate=!1,ea.colorsNeedUpdate=!1,ja.attributes&&r(ja)))}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,n,m;a instanceof THREE.MeshDepthMaterial?m="depth":a instanceof
THREE.MeshNormalMaterial?m="normal":a instanceof THREE.MeshBasicMaterial?m="basic":a instanceof THREE.MeshLambertMaterial?m="lambert":a instanceof THREE.MeshPhongMaterial?m="phong":a instanceof THREE.LineBasicMaterial?m="basic":a instanceof THREE.LineDashedMaterial?m="dashed":a instanceof THREE.ParticleBasicMaterial&&(m="particle_basic");if(m){var o=THREE.ShaderLib[m];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,q,r;e=p=q=r=
...
alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,v,d=[];m?d.push(m):(d.push(q),d.push(r));for(u in p)d.push(u),d.push(p[u]);for(t in c)d.push(t),d.push(c[t]);m=d.join();t=0;for(u=ra.length;t<u;t++)if(d=ra[t],d.code===m){d.usedTimes++;s=d.program;break a}t=[];for(v in p)u=p[v],!1!==u&&(u="#define "+v+" "+u,t.push(u));u=t.join("\n");v=k.createProgram();t=["precision "+Q+" float;",u,ec?"#define VERTEX_TEXTURES":
...
w);for(w=0;w<c.maxMorphNormals;w++)t.push("morphNormal"+w);for(s in b)t.push(s);s=t;w=0;for(b=s.length;w<b;w++)t=s[w],v.attributes[t]=k.getAttribLocation(v,t);v.id=S++;ra.push({program:v,code:m,usedTimes:1});J.info.memory.programs=ra.length;s=v}a.program=s;s=a.program.attributes;0<=s.position&&k.enableVertexAttribArray(s.position);0<=s.color&&k.enableVertexAttribArray(s.color);0<=s.normal&&k.enableVertexAttribArray(s.normal);0<=s.tangent&&k.enableVertexAttribArray(s.tangent);0<=s.lineDistance&&k.enableVertexAttribArray(s.lineDistance);
...
k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.SRC_COLOR)):a===THREE.CustomBlending?k.enable(k.BLEND):(k.enable(k.BLEND),k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD),k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)),Ta=a);if(a===THREE.CustomBlending){if(b!==ua&&(k.blendEquation(I(b)),ua=b),c!==cb||d!==wb)k.blendFunc(I(c),I(d)),cb=c,wb=d}else wb=cb=ua=null};this.setTexture=
function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.__webglTexture=k.createTexture(),J.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=I(a.format),f=I(a.type);O(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var f=a.mipmaps,g=0,h=f.length;g<
...
a.depthBuffer&&(a.depthBuffer=!0);void 0===a.stencilBuffer&&(a.stencilBuffer=!0);a.__webglTexture=k.createTexture();var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=I(a.format),e=I(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);O(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,
a.height,0,d,e,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);B(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=k.createFramebuffer(),a.__webglRenderbuffer=k.createRenderbuffer(),k.bindTexture(k.TEXTURE_2D,a.__webglTexture),O(k.TEXTURE_2D,a,c),k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=k.TEXTURE_2D,
k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0),B(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=lb,a=Ka,d=va,e=Ha);b!==V&&(k.bindFramebuffer(k.FRAMEBUFFER,
b),k.viewport(d,e,c,a),V=b);Za=c;db=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
w=void 0,v=void 0,C=void 0,E=void 0,u=l[r[o]].x,s=l[r[o]].y,D=l[r[p]].x,z=l[r[p]].y,w=l[r[q]].x,v=l[r[q]].y;if(1E-10>(D-u)*(v-s)-(z-s)*(w-u))l=false;else{for(A=0;A<t;A++)if(!(A==o||A==p||A==q)){var C=l[r[A]].x,E=l[r[A]].y,H=void 0,O=void 0,B=void 0,L=void 0,I=void 0,G=void 0,Q=void 0,N=void 0,K=void 0,aa=void 0,P=void 0,M=void 0,H=B=I=void 0,H=w-D,O=v-z,B=u-w,L=s-v,I=D-u,G=z-s,Q=C-u,N=E-s,K=C-D,aa=E-z,P=C-w,M=E-v,H=H*aa-O*K,I=I*N-G*Q,B=B*M-L*P;if(H>=0&&B>=0&&I>=0){l=false;break a}}l=true}}if(l){f.push([a[g[i]],
...
THREE.CubeGeometry=function(a,b,c,d,e,f,g,h){function i(a,b,c,d,e,f,g,h){var i,l=j.widthSegments,m=j.heightSegments,n=e/2,o=f/2,p=j.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")i="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){i="y";m=j.depthSegments}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){i="x";l=j.depthSegments}var q=l+1,t=m+1,Q=e/l,N=f/m,K=new THREE.Vector3;K[i]=g>0?1:-1;for(e=0;e<t;e++)for(f=0;f<q;f++){var aa=new THREE.Vector3;aa[a]=(f*Q-n)*c;aa[b]=(e*N-o)*d;aa[i]=g;j.vertices.push(aa)}for(e=
0;e<m;e++)for(f=0;f<l;f++){a=new THREE.Face4(f+q*e+p,f+q*(e+1)+p,f+1+q*(e+1)+p,f+1+q*e+p);a.normal.copy(K);a.vertexNormals.push(K.clone(),K.clone(),K.clone(),K.clone());a.materialIndex=h;j.faces.push(a);j.faceVertexUvs[0].push([new THREE.UV(f/l,1-e/m),new THREE.UV(f/l,1-(e+1)/m),new THREE.UV((f+1)/l,1-(e+1)/m),new THREE.UV((f+1)/l,1-e/m)])}}THREE.Geometry.call(this);var j=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;var a=this.width/
...
false);s=new THREE.Vector3;D=new THREE.Vector3;z=new THREE.Vector3}if(!n)j=i=m=0;var w,v,C,E=this,H=this.vertices.length,o=a.extractPoints(),O=o.shape,o=o.holes,B=!THREE.Shape.Utils.isClockWise(O);if(B){O=O.reverse();v=0;for(C=o.length;v<C;v++){w=o[v];THREE.Shape.Utils.isClockWise(w)&&(o[v]=w.reverse())}B=false}var L=THREE.Shape.Utils.triangulateShape(O,o),B=O;v=0;for(C=o.length;v<C;v++){w=o[v];O=O.concat(w)}var I,G,Q,N,K=O.length,aa=L.length,P=[],M=0,R=B.length;I=R-1;for(G=M+1;M<R;M++,I++,G++){I===
R&&(I=0);G===R&&(G=0);P[M]=d(B[M],B[I],B[G])}var T=[],J,ra=P.concat();v=0;for(C=o.length;v<C;v++){w=o[v];J=[];M=0;R=w.length;I=R-1;for(G=M+1;M<R;M++,I++,G++){I===R&&(I=0);G===R&&(G=0);J[M]=d(w[M],w[I],w[G])}T.push(J);ra=ra.concat(J)}for(I=0;I<m;I++){w=I/m;Q=i*(1-w);G=j*Math.sin(w*Math.PI/2);M=0;for(R=B.length;M<R;M++){N=c(B[M],P[M],G);f(N.x,N.y,-Q)}v=0;for(C=o.length;v<C;v++){w=o[v];J=T[v];M=0;for(R=w.length;M<R;M++){N=c(w[M],J[M],G);f(N.x,N.y,-Q)}}}G=j;for(M=0;M<K;M++){N=n?c(O[M],ra[M],G):O[M];if(q){D.copy(u.normals[0]).multiplyScalar(N.x);
s.copy(u.binormals[0]).multiplyScalar(N.y);z.copy(p[0]).addSelf(D).addSelf(s);f(z.x,z.y,z.z)}else f(N.x,N.y,0)}for(w=1;w<=l;w++)for(M=0;M<K;M++){N=n?c(O[M],ra[M],G):O[M];if(q){D.copy(u.normals[w]).multiplyScalar(N.x);s.copy(u.binormals[w]).multiplyScalar(N.y);z.copy(p[w]).addSelf(D).addSelf(s);f(z.x,z.y,z.z)}else f(N.x,N.y,h/l*w)}for(I=m-1;I>=0;I--){w=I/m;Q=i*(1-w);G=j*Math.sin(w*Math.PI/2);M=0;for(R=B.length;M<R;M++){N=c(B[M],P[M],G);f(N.x,N.y,h+Q)}v=0;for(C=o.length;v<C;v++){w=o[v];J=T[v];M=0;for(R=
w.length;M<R;M++){N=c(w[M],J[M],G);q?f(N.x,N.y+p[l-1].y,p[l-1].x+Q):f(N.x,N.y,h+Q)}}}if(n){i=K*0;for(M=0;M<aa;M++){h=L[M];g(h[2]+i,h[1]+i,h[0]+i,true)}i=K*(l+m*2);for(M=0;M<aa;M++){h=L[M];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(M=0;M<aa;M++){h=L[M];g(h[2],h[1],h[0],true)}for(M=0;M<aa;M++){h=L[M];g(h[0]+K*l,h[1]+K*l,h[2]+K*l,false)}}h=0;e(B,h);h=h+B.length;v=0;for(C=o.length;v<C;v++){w=o[v];e(w,h);h=h+w.length}};
...
THREE.DirectionalLightHelper=function(a,b,c){THREE.Object3D.call(this);this.light=a;this.position=a.position;this.direction=new THREE.Vector3;this.direction.sub(a.target.position,a.position);this.color=a.color.clone();var d=THREE.Math.clamp(a.intensity,0,1);this.color.r=this.color.r*d;this.color.g=this.color.g*d;this.color.b=this.color.b*d;var d=this.color.getHex(),e=new THREE.SphereGeometry(b,16,8),f=new THREE.AsteriskGeometry(b*1.25,b*2.25),g=new THREE.MeshBasicMaterial({color:d,fog:false}),h=new THREE.LineBasicMaterial({color:d,
...
THREE.SpotLightHelper=function(a,b,c){THREE.Object3D.call(this);this.light=a;this.position=a.position;this.direction=new THREE.Vector3;this.direction.sub(a.target.position,a.position);this.color=a.color.clone();var d=THREE.Math.clamp(a.intensity,0,1);this.color.r=this.color.r*d;this.color.g=this.color.g*d;this.color.b=this.color.b*d;var d=this.color.getHex(),e=new THREE.SphereGeometry(b,16,8),f=new THREE.AsteriskGeometry(b*1.25,b*2.25),g=new THREE.CylinderGeometry(1E-4,1,1,32,1,true),h=new THREE.Matrix4;
h.rotateX(-Math.PI/2);h.translate(new THREE.Vector3(0,-0.5,0));g.applyMatrix(h);var i=new THREE.MeshBasicMaterial({color:d,fog:false}),h=new THREE.LineBasicMaterial({color:d,fog:false}),j=new THREE.MeshBasicMaterial({color:d,fog:false,wireframe:true,opacity:0.3,transparent:true});this.lightArrow=new THREE.ArrowHelper(this.direction,null,c,d);this.lightSphere=new THREE.Mesh(e,i);this.lightCone=new THREE.Mesh(g,j);c=a.distance?a.distance:1E4;e=c*Math.tan(a.angle*0.5)*2;this.lightCone.scale.set(e,e,
c);this.lightArrow.cone.material.fog=false;this.lightArrow.line.material.fog=false;this.lightRays=new THREE.Line(f,h,THREE.LinePieces);this.gyroscope=new THREE.Gyroscope;this.gyroscope.add(this.lightArrow);this.gyroscope.add(this.lightSphere);this.gyroscope.add(this.lightRays);this.add(this.gyroscope);this.add(this.lightCone);this.lookAt(a.target.position);this.lightSphere.properties.isGizmo=true;this.lightSphere.properties.gizmoSubject=a;this.lightSphere.properties.gizmoRoot=this;this.targetSphere=
null;if(a.target.properties.targetInverse){b=new THREE.SphereGeometry(b,8,4);f=new THREE.MeshBasicMaterial({color:d,wireframe:true,fog:false});this.targetSphere=new THREE.Mesh(b,f);this.targetSphere.position=a.target.position;this.targetSphere.properties.isGizmo=true;this.targetSphere.properties.gizmoSubject=a.target;this.targetSphere.properties.gizmoRoot=this.targetSphere;a=new THREE.LineDashedMaterial({color:d,dashSize:4,gapSize:4,opacity:0.75,transparent:true,fog:false});d=new THREE.Geometry;d.vertices.push(this.position.clone());
d.vertices.push(this.targetSphere.position.clone());d.computeLineDistances();this.targetLine=new THREE.Line(d,a);this.targetLine.properties.isGizmo=true}this.properties.isGizmo=true};THREE.SpotLightHelper.prototype=Object.create(THREE.Object3D.prototype);
THREE.SpotLightHelper.prototype.update=function(){this.direction.sub(this.light.target.position,this.light.position);this.lightArrow.setDirection(this.direction);this.lookAt(this.light.target.position);var a=this.light.distance?this.light.distance:1E4,b=a*Math.tan(this.light.angle*0.5)*2;this.lightCone.scale.set(b,b,a);this.color.copy(this.light.color);a=THREE.Math.clamp(this.light.intensity,0,1);this.color.r=this.color.r*a;this.color.g=this.color.g*a;this.color.b=this.color.b*a;this.lightArrow.setColor(this.color.getHex());
...
0;for(D=p.length;s<D;s++){v=p[s];t.push(v.centroid);h.push(v.centroid);if(m.supportUVs){w=new THREE.UV;if(v instanceof THREE.Face3){w.u=f(v.a,s).u+f(v.b,s).u+f(v.c,s).u;w.v=f(v.a,s).v+f(v.b,s).v+f(v.c,s).v;w.u=w.u/3;w.v=w.v/3}else if(v instanceof THREE.Face4){w.u=f(v.a,s).u+f(v.b,s).u+f(v.c,s).u+f(v.d,s).u;w.v=f(v.a,s).v+f(v.b,s).v+f(v.c,s).v+f(v.d,s).v;w.u=w.u/4;w.v=w.v/4}g(q+s,"",w)}}var l=l(a),O;D=0;var B,L;H={};C={};for(s in l){E=l[s];B=s.split("_");L=B[0];B=B[1];z=L;v=[L,B];H[z]===void 0&&(H[z]=
[]);H[z].push(v);z=B;v=[L,B];H[z]===void 0&&(H[z]=[]);H[z].push(v);z=0;for(w=E.length;z<w;z++){v=E[z];O=L;var I=v,G=s;C[O]===void 0&&(C[O]={});C[O][I]=G;O=B;I=s;C[O]===void 0&&(C[O]={});C[O][v]=I}E.length<2&&(A[s]=true)}for(s in l){E=l[s];v=E[0];O=E[1];B=s.split("_");L=B[0];B=B[1];w=new THREE.Vector3;b(E.length>0,"an edge without faces?!");if(E.length==1){w.addSelf(o[L]);w.addSelf(o[B]);w.multiplyScalar(0.5)}else{w.addSelf(t[v]);w.addSelf(t[O]);w.addSelf(o[L]);w.addSelf(o[B]);w.multiplyScalar(0.25)}r[s]=
q+p.length+D;h.push(w);D++;if(m.supportUVs){w=new THREE.UV;w.u=f(L,v).u+f(B,v).u;w.v=f(L,v).v+f(B,v).v;w.u=w.u/2;w.v=w.v/2;g(r[s],v,w);if(E.length>=2){b(E.length==2,"did we plan for more than 2 edges?");w=new THREE.UV;w.u=f(L,O).u+f(B,O).u;w.v=f(L,O).v+f(B,O).v;w.u=w.u/2;w.v=w.v/2;g(r[s],O,w)}}}c("-- Step 2 done");var Q,N;w=["123","12","2","23"];O=["123","23","3","31"];var I=["123","31","1","12"],G=["1234","12","2","23"],K=["1234","23","3","34"],aa=["1234","34","4","41"],P=["1234","41","1","12"];
s=0;for(D=t.length;s<D;s++){v=p[s];E=q+s;if(v instanceof THREE.Face3){L=n(v.a,v.b);B=n(v.b,v.c);Q=n(v.c,v.a);e(E,r[L],v.b,r[B],v,w,s);e(E,r[B],v.c,r[Q],v,O,s);e(E,r[Q],v.a,r[L],v,I,s)}else if(v instanceof THREE.Face4){L=n(v.a,v.b);B=n(v.b,v.c);Q=n(v.c,v.d);N=n(v.d,v.a);e(E,r[L],v.b,r[B],v,G,s);e(E,r[B],v.c,r[Q],v,K,s);e(E,r[Q],v.d,r[N],v,aa,s);e(E,r[N],v.a,r[L],v,P,s)}else c("face should be a face!",v)}r=new THREE.Vector3;v=new THREE.Vector3;s=0;for(D=o.length;s<D;s++)if(H[s]!==void 0){r.set(0,0,
0);v.set(0,0,0);B=new THREE.Vector3(0,0,0);E=0;for(z in C[s]){r.addSelf(t[z]);E++}O=0;L=H[s].length;w=E!=L;for(z=0;z<L;z++)A[n(H[s][z][0],H[s][z][1])]&&O++;r.divideScalar(E);O=0;if(w){for(z=0;z<L;z++){E=H[s][z];if(I=l[n(E[0],E[1])].length==1){E=o[E[0]].clone().addSelf(o[E[1]]).divideScalar(2);v.addSelf(E);O++}}v.divideScalar(4);b(O==2,"should have only 2 boundary edges")}else{for(z=0;z<L;z++){E=H[s][z];E=o[E[0]].clone().addSelf(o[E[1]]).divideScalar(2);v.addSelf(E)}v.divideScalar(L)}B.addSelf(o[s]);
if(w){B.divideScalar(2);B.addSelf(v)}else{B.multiplyScalar(L-3);B.addSelf(r);B.addSelf(v.multiplyScalar(2));B.divideScalar(L)}h[s]=B}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=j;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);
...
"color");l.scale=b.getUniformLocation(m,"scale");l.rotation=b.getUniformLocation(m,"rotation");l.screenPosition=b.getUniformLocation(m,"screenPosition");o=false};this.render=function(a,d,e,r){var a=a.__webglFlares,A=a.length;if(A){var u=new THREE.Vector3,s=r/e,D=e*0.5,z=r*0.5,w=16/r,v=new THREE.Vector2(w*s,w),C=new THREE.Vector3(1,1,0),E=new THREE.Vector2(1,1),H=l,w=n;b.useProgram(m);if(!o){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);o=true}b.uniform1i(H.occlusionMap,0);b.uniform1i(H.map,
1);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(w.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(w.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var O,B,L,I,G;for(O=0;O<A;O++){w=16/r;v.set(w*s,w);I=a[O];u.set(I.matrixWorld.elements[12],I.matrixWorld.elements[13],I.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(u);d.projectionMatrix.multiplyVector3(u);C.copy(u);E.x=C.x*D+D;E.y=C.y*z+z;if(j||E.x>0&&E.x<e&&E.y>0&&
E.y<r){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,E.x-8,E.y-8,16,16,0);b.uniform1i(H.renderType,0);b.uniform2f(H.scale,v.x,v.y);b.uniform3f(H.screenPosition,C.x,C.y,C.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,E.x-8,E.y-8,16,16,0);b.uniform1i(H.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);I.positionScreen.copy(C);I.customUpdateCallback?I.customUpdateCallback(I):I.updateLensFlares();b.uniform1i(H.renderType,2);b.enable(b.BLEND);B=0;for(L=I.lensFlares.length;B<L;B++){G=I.lensFlares[B];if(G.opacity>0.001&&G.scale>0.001){C.x=G.x;C.y=G.y;C.z=G.z;w=G.size*G.scale/r;v.x=w*s;v.y=w;b.uniform3f(H.screenPosition,C.x,C.y,C.z);b.uniform2f(H.scale,v.x,v.y);b.uniform1f(H.rotation,G.rotation);b.uniform1f(H.opacity,G.opacity);
