...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,j,l,n,m,q,p,o,r,t,u,w,s;function B(a){return a%4?4-a%4:0}function v(a,b){return(new Uint8Array(a,b,1))[0]}function A(a,b){return(new Uint32Array(a,b,1))[0]}function E(b,c){var d,f,e,g,h,i,l,j,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=I[f*2];f=I[f*2+1];i=I[e*2];l=I[e*2+1];e=I[g*2];j=I[g*2+1];g=O.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,l));m.push(new THREE.UV(e,
j));g.push(m)}}function z(b,c){var d,f,e,g,h,i,l,j,n,m,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){f=o[d*4];e=o[d*4+1];g=o[d*4+2];h=o[d*4+3];i=I[f*2];f=I[f*2+1];l=I[e*2];n=I[e*2+1];j=I[g*2];m=I[g*2+1];g=I[h*2];e=I[h*2+1];h=O.faceVertexUvs[0];var p=[];p.push(new THREE.UV(i,f));p.push(new THREE.UV(l,n));p.push(new THREE.UV(j,m));p.push(new THREE.UV(g,e));h.push(p)}}function M(b,c,d){for(var f,e,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*3];e=c[d*3+1];g=c[d*3+2];h=i[d];
O.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function D(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),l=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=l[d];O.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function G(b,c,d,f){for(var e,g,h,i,l,j,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];l=d[f*3];j=d[f*3+1];n=d[f*3+2];i=m[f];var o=J[j*3],p=J[j*3+1];j=J[j*3+2];var q=J[n*3],
r=J[n*3+1];n=J[n*3+2];O.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(J[l*3],J[l*3+1],J[l*3+2]),new THREE.Vector3(o,p,j),new THREE.Vector3(q,r,n)],null,i))}}function H(b,c,d,f){for(var e,g,h,i,l,j,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];j=d[f*4];n=d[f*4+1];m=d[f*4+2];o=d[f*4+3];l=p[f];var q=J[n*3],r=J[n*3+1];n=J[n*3+2];var s=J[m*3],t=J[m*3+1];m=J[m*3+2];var v=J[o*3],u=J[o*3+1];o=J[o*3+2];O.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(J[j*3],J[j*3+1],J[j*3+2]),new THREE.Vector3(q,r,n),new THREE.Vector3(s,t,m),new THREE.Vector3(v,u,o)],null,l))}}var O=this,F=0,J=[],I=[],K,V,Y;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(O,d,b);s=a;V=F;b=new Uint8Array(s,V,12);o="";for(u=0;u<12;u++)o=o+String.fromCharCode(b[V+u]);c=v(s,V+12);v(s,V+13);v(s,V+14);v(s,V+15);f=v(s,V+16);i=v(s,V+17);j=v(s,V+18);l=v(s,V+19);n=A(s,V+20);m=A(s,V+20+4);q=A(s,V+20+8);p=A(s,V+20+12);o=A(s,V+20+16);r=A(s,V+20+20);t=
...
a,true);d.send(null);var f=new THREE.LoadingMonitor;f.addEventListener("load",function(){b.dispatchEvent({type:"load",content:c})});f.add(d)},parse:function(a,b){var c=this,d=new THREE.Geometry,f=a.scale!==void 0?1/a.scale:1;if(a.materials){d.materials=[];for(var e=0;e<a.materials.length;++e){var g=a.materials[e],h=function(a){a=Math.log(a)/Math.LN2;return Math.floor(a)==a},i=function(a){a=Math.log(a)/Math.LN2;return Math.pow(2,Math.round(a))},j=function(a,d,f,e,g,l){a[d]=new THREE.Texture;a[d].sourceFile=
f;if(e){a[d].repeat.set(e[0],e[1]);if(e[0]!==1)a[d].wrapS=THREE.RepeatWrapping;if(e[1]!==1)a[d].wrapT=THREE.RepeatWrapping}g&&a[d].offset.set(g[0],g[1]);if(l){e={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(e[l[0]]!==void 0)a[d].wrapS=e[l[0]];if(e[l[1]]!==void 0)a[d].wrapT=e[l[1]]}var j=a[d],a=new THREE.ImageLoader;a.addEventListener("load",function(a){a=a.content;if(!h(a.width)||!h(a.height)){var b=i(a.width),c=i(a.height);j.image=document.createElement("canvas");j.image.width=
...
O;for(o in K.textures){l=K.textures[o];if(l.mapping!==void 0&&THREE[l.mapping]!==void 0)l.mapping=new THREE[l.mapping];if(l.url instanceof Array){G=l.url.length;p=[];for(D=0;D<G;D++)p[D]=d(l.url[D],K.urlBaseType);G=THREE.ImageUtils.loadTextureCube(p,l.mapping,a(G))}else{G=l.url.toLowerCase().endsWith(".dds");p=d(l.url,K.urlBaseType);D=a(1);G=G?THREE.ImageUtils.loadCompressedTexture(p,l.mapping,D):THREE.ImageUtils.loadTexture(p,l.mapping,D);if(THREE[l.minFilter]!==void 0)G.minFilter=THREE[l.minFilter];
if(THREE[l.magFilter]!==void 0)G.magFilter=THREE[l.magFilter];if(l.anisotropy)G.anisotropy=l.anisotropy;if(l.repeat){G.repeat.set(l.repeat[0],l.repeat[1]);if(l.repeat[0]!==1)G.wrapS=THREE.RepeatWrapping;if(l.repeat[1]!==1)G.wrapT=THREE.RepeatWrapping}l.offset&&G.offset.set(l.offset[0],l.offset[1]);if(l.wrap){p={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(p[l.wrap[0]]!==void 0)G.wrapS=p[l.wrap[0]];if(p[l.wrap[1]]!==void 0)G.wrapT=p[l.wrap[1]]}}I.textures[o]=G}for(n in K.materials){r=
...
k.deleteRenderbuffer(a.__webglRenderbuffer[b])}else{k.deleteFramebuffer(a.__webglFramebuffer);k.deleteRenderbuffer(a.__webglRenderbuffer)}}};this.deallocateMaterial=function(a){var b=a.program;if(b){a.program=void 0;var c,d,f=false,a=0;for(c=fa.length;a<c;a++){d=fa[a];if(d.program===b){d.usedTimes--;d.usedTimes===0&&(f=true);break}}if(f){f=[];a=0;for(c=fa.length;a<c;a++){d=fa[a];d.program!==b&&f.push(d)}fa=f;k.deleteProgram(b);Q.info.memory.programs--}}};this.updateShadowMap=function(a,b){da=null;
...
f.__webglFaceBuffer);k.drawElements(k.TRIANGLES,f.__webglFaceCount,k.UNSIGNED_SHORT,0)}Q.info.render.calls++;Q.info.render.vertices=Q.info.render.vertices+f.__webglFaceCount;Q.info.render.faces=Q.info.render.faces+f.__webglFaceCount/3}else if(e instanceof THREE.Line){e=e.type===THREE.LineStrip?k.LINE_STRIP:k.LINES;d=d.linewidth;if(d!==Fa){k.lineWidth(d);Fa=d}k.drawArrays(e,0,f.__webglLineCount);Q.info.render.calls++}else if(e instanceof THREE.ParticleSystem){k.drawArrays(k.POINTS,0,f.__webglParticleCount);
Q.info.render.calls++;Q.info.render.points=Q.info.render.points+f.__webglParticleCount}else if(e instanceof THREE.Ribbon){k.drawArrays(k.TRIANGLE_STRIP,0,f.__webglVertexCount);Q.info.render.calls++}}};this.render=function(a,b,c,d){if(b instanceof THREE.Camera===false)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var f,e,g,h,j=a.__lights,o=a.fog;N=-1;hb=true;this.autoUpdateScene&&a.updateMatrixWorld();b.parent===void 0&&b.updateMatrixWorld();if(!b._viewMatrixArray)b._viewMatrixArray=
...
this.setDepthWrite(true)}};this.renderImmediateObject=function(a,b,c,d,f){var e=u(a,b,c,d,f);U=-1;Q.setMaterialFaces(d);f.immediateRenderCallback?f.immediateRenderCallback(e,k,ab):f.render(function(a){Q.renderBufferImmediate(a,e,d)})};this.initWebGLObjects=function(a){if(!a.__webglObjects){a.__webglObjects=[];a.__webglObjectsImmediate=[];a.__webglSprites=[];a.__webglFlares=[]}for(;a.__objectsAdded.length;){var i=a.__objectsAdded[0],j=a,l=void 0,m=void 0,n=void 0;if(!i.__webglInit){i.__webglInit=true;
i._modelViewMatrix=new THREE.Matrix4;i._normalMatrix=new THREE.Matrix3;if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.Geometry){if(m.geometryGroups===void 0){var s=m,u=void 0,v=void 0,w=void 0,z=void 0,A=void 0,B=void 0,E=void 0,D={},H=s.morphTargets.length,G=s.morphNormals.length;s.geometryGroups={};u=0;for(v=s.faces.length;u<v;u++){w=s.faces[u];z=w.materialIndex;B=z!==void 0?z:-1;D[B]===void 0&&(D[B]={hash:B,counter:0});E=D[B].hash+"_"+D[B].counter;s.geometryGroups[E]===void 0&&
(s.geometryGroups[E]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:H,numMorphNormals:G});A=w instanceof THREE.Face3?3:4;if(s.geometryGroups[E].vertices+A>65535){D[B].counter=D[B].counter+1;E=D[B].hash+"_"+D[B].counter;s.geometryGroups[E]===void 0&&(s.geometryGroups[E]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:H,numMorphNormals:G})}w instanceof THREE.Face3?s.geometryGroups[E].faces3.push(u):s.geometryGroups[E].faces4.push(u);s.geometryGroups[E].vertices=s.geometryGroups[E].vertices+
...
ja=c;pb=d}}else pb=ja=Xa=null};this.setTexture=function(a,b){if(a.needsUpdate){if(!a.__webglInit){a.__webglInit=true;a.__webglTexture=k.createTexture();Q.info.memory.textures++}k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=(c.width&c.width-1)===0&&(c.height&c.height-1)===0,f=H(a.format),e=H(a.type);M(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var e=
...
if(a&&!a.__webglFramebuffer){if(a.depthBuffer===void 0)a.depthBuffer=true;if(a.stencilBuffer===void 0)a.stencilBuffer=true;a.__webglTexture=k.createTexture();var c=(a.width&a.width-1)===0&&(a.height&a.height-1)===0,d=H(a.format),f=H(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);M(k.TEXTURE_CUBE_MAP,a,c);for(var e=0;e<6;e++){a.__webglFramebuffer[e]=k.createFramebuffer();a.__webglRenderbuffer[e]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+
e,0,d,a.width,a.height,0,d,f,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+e;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[e]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);D(a.__webglRenderbuffer[e],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);M(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,f,null);d=
k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);D(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;f=d=0}else{b=null;c=Ga;a=$a;d=xa;f=qb}if(b!==ga){k.bindFramebuffer(k.FRAMEBUFFER,
b);k.viewport(d,f,c,a);ga=b}rb=c;Da=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
