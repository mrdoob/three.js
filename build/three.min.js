...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],m=c[9],n=c[13],p=c[2],o=c[6],s=c[10],t=c[14],r=c[3],z=c[7],x=c[11],c=c[15],q=d[0],F=d[4],A=d[8],
v=d[12],u=d[1],D=d[5],C=d[9],G=d[13],L=d[2],B=d[6],K=d[10],H=d[14],I=d[3],O=d[7],N=d[11],d=d[15];e[0]=f*q+g*u+h*L+i*I;e[4]=f*F+g*D+h*B+i*O;e[8]=f*A+g*C+h*K+i*N;e[12]=f*v+g*G+h*H+i*d;e[1]=j*q+l*u+m*L+n*I;e[5]=j*F+l*D+m*B+n*O;e[9]=j*A+l*C+m*K+n*N;e[13]=j*v+l*G+m*H+n*d;e[2]=p*q+o*u+s*L+t*I;e[6]=p*F+o*D+s*B+t*O;e[10]=p*A+o*C+s*K+t*N;e[14]=p*v+o*G+s*H+t*d;e[3]=r*q+z*u+x*L+c*I;e[7]=r*F+z*D+x*B+c*O;e[11]=r*A+z*C+x*K+c*N;e[15]=r*v+z*G+x*H+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),l=Math.sin(b),m=1-j,n=d*e*m,p=d*f*m,m=e*f*m,d=d*l,o=e*l,l=f*l,f=g+(1-g)*j,g=n+l,e=p-o,n=n-l,h=h+(1-h)*j,l=m+d,p=p+o,m=m-d,i=i+(1-i)*j,j=c[0],d=c[1],o=c[2],s=c[3],t=c[4],r=c[5],z=c[6],x=c[7],q=c[8],F=c[9],A=c[10],v=c[11];c[0]=f*j+g*t+e*q;c[1]=f*d+g*r+e*F;c[2]=f*o+g*z+e*A;c[3]=f*s+g*x+e*v;c[4]=n*j+h*t+l*q;c[5]=n*d+h*r+l*F;c[6]=n*o+h*z+l*A;c[7]=n*s+h*x+l*v;c[8]=p*j+m*t+i*q;c[9]=p*d+m*r+i*F;c[10]=p*o+m*z+i*A;c[11]=p*s+m*x+i*v;
...
p=o.vertices,F=h.material instanceof a.MeshFaceMaterial,A=!0===F?h.material.materials:null,l=h.material.side,v,u,D,C=i.precision;h.matrixRotationWorld.extractRotation(h.matrixWorld);b.copy(i.origin);g.getInverse(h.matrixWorld);c.copy(b);g.multiplyVector3(c);d.copy(i.direction);g.rotateAxis(d).normalize();for(var G=0,L=o.faces.length;G<L;G++){var B=o.faces[G],l=!0===F?A[B.materialIndex]:h.material;if(void 0!==l&&(l=l.side,e.sub(B.centroid,c),u=B.normal,v=d.dot(u),!(Math.abs(v)<C)&&(u=u.dot(e)/v,!(0>
...
c)return!1;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return!0}var e,f,g=[],h=0,i,j,l=[],m=0,n,p,o=[],s=0,t,r=[],z=0,x,q,F=[],A=0,v,u,D=[],C=0,G={objects:[],sprites:[],lights:[],elements:[]},L=new THREE.Vector3,B=new THREE.Vector4,K=new THREE.Matrix4,H=new THREE.Matrix4,I=new THREE.Matrix3,O=new THREE.Frustum,N=new THREE.Vector4,P=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);K.multiply(b.projectionMatrix,b.matrixWorldInverse);K.multiplyVector3(a);return a};
this.unprojectVector=function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);K.multiply(b.matrixWorld,b.projectionMatrixInverse);K.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,m,T){var $=h.near,da=h.far,S=!1,Q,ca,ia,aa,ja,Z,fa,Ka,Na,La,Ga,pa,Ba,db,qb;u=q=t=p=0;G.elements.length=0;g.updateMatrixWorld();
...
e.z=f.renderDepth:(L.copy(f.matrixWorld.getPosition()),K.multiplyVector3(L),e.z=L.z),G.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(L.copy(f.matrixWorld.getPosition()),K.multiplyVector3(L),e.z=L.z),G.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(L.copy(f.matrixWorld.getPosition()),K.multiplyVector3(L),e.z=L.z),G.objects.push(e));jb(f)}}};jb(g);!0===m&&G.objects.sort(c);g=0;for(m=G.objects.length;g<
m;g++)if(Ka=G.objects[g].object,Na=Ka.matrixWorld,j=0,Ka instanceof THREE.Mesh){La=Ka.geometry;ia=La.vertices;Ga=La.faces;La=La.faceVertexUvs;I.getInverse(Na);I.transpose();Ba=Ka.material instanceof THREE.MeshFaceMaterial;db=!0===Ba?Ka.material:null;Q=0;for(ca=ia.length;Q<ca;Q++)i=b(),i.positionWorld.copy(ia[Q]),Na.multiplyVector3(i.positionWorld),i.positionScreen.copy(i.positionWorld),K.multiplyVector4(i.positionScreen),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,
i.visible=i.positionScreen.z>$&&i.positionScreen.z<da;ia=0;for(Q=Ga.length;ia<Q;ia++)if(ca=Ga[ia],qb=!0===Ba?db.materials[ca.materialIndex]:Ka.material,void 0!==qb){Z=qb.side;if(ca instanceof THREE.Face3)if(aa=l[ca.a],ja=l[ca.b],fa=l[ca.c],!0===aa.visible&&!0===ja.visible&&!0===fa.visible)if(S=0>(fa.positionScreen.x-aa.positionScreen.x)*(ja.positionScreen.y-aa.positionScreen.y)-(fa.positionScreen.y-aa.positionScreen.y)*(ja.positionScreen.x-aa.positionScreen.x),Z===THREE.DoubleSide||S===(Z===THREE.FrontSide))p===
s?(pa=new THREE.RenderableFace3,o.push(pa),s++,p++,n=pa):n=o[p++],n.v1.copy(aa),n.v2.copy(ja),n.v3.copy(fa);else continue;else continue;else if(ca instanceof THREE.Face4)if(aa=l[ca.a],ja=l[ca.b],fa=l[ca.c],pa=l[ca.d],!0===aa.visible&&!0===ja.visible&&!0===fa.visible&&!0===pa.visible)if(S=0>(pa.positionScreen.x-aa.positionScreen.x)*(ja.positionScreen.y-aa.positionScreen.y)-(pa.positionScreen.y-aa.positionScreen.y)*(ja.positionScreen.x-aa.positionScreen.x)||0>(ja.positionScreen.x-fa.positionScreen.x)*
(pa.positionScreen.y-fa.positionScreen.y)-(ja.positionScreen.y-fa.positionScreen.y)*(pa.positionScreen.x-fa.positionScreen.x),Z===THREE.DoubleSide||S===(Z===THREE.FrontSide)){if(t===z){var ob=new THREE.RenderableFace4;r.push(ob);z++;t++;n=ob}else n=r[t++];n.v1.copy(aa);n.v2.copy(ja);n.v3.copy(fa);n.v4.copy(pa)}else continue;else continue;n.normalWorld.copy(ca.normal);!1===S&&(Z===THREE.BackSide||Z===THREE.DoubleSide)&&n.normalWorld.negate();I.multiplyVector3(n.normalWorld).normalize();n.centroidWorld.copy(ca.centroid);
Na.multiplyVector3(n.centroidWorld);n.centroidScreen.copy(n.centroidWorld);K.multiplyVector3(n.centroidScreen);fa=ca.vertexNormals;aa=0;for(ja=fa.length;aa<ja;aa++)pa=n.vertexNormalsWorld[aa],pa.copy(fa[aa]),!1===S&&(Z===THREE.BackSide||Z===THREE.DoubleSide)&&pa.negate(),I.multiplyVector3(pa).normalize();n.vertexNormalsLength=fa.length;aa=0;for(ja=La.length;aa<ja;aa++)if(pa=La[aa][ia],void 0!==pa){Z=0;for(fa=pa.length;Z<fa;Z++)n.uvs[aa][Z]=pa[Z]}n.color=ca.color;n.material=qb;n.z=n.centroidScreen.z;
G.elements.push(n)}}else if(Ka instanceof THREE.Line){H.multiply(K,Na);ia=Ka.geometry.vertices;aa=b();aa.positionScreen.copy(ia[0]);H.multiplyVector4(aa.positionScreen);Na=Ka.type===THREE.LinePieces?2:1;Q=1;for(ca=ia.length;Q<ca;Q++)aa=b(),aa.positionScreen.copy(ia[Q]),H.multiplyVector4(aa.positionScreen),0<(Q+1)%Na||(ja=l[j-2],N.copy(aa.positionScreen),P.copy(ja.positionScreen),!0===d(N,P)&&(N.multiplyScalar(1/N.w),P.multiplyScalar(1/P.w),q===A?(Ga=new THREE.RenderableLine,F.push(Ga),A++,q++,x=Ga):
x=F[q++],x.v1.positionScreen.copy(N),x.v2.positionScreen.copy(P),x.z=Math.max(N.z,P.z),x.material=Ka.material,G.elements.push(x)))}g=0;for(m=G.sprites.length;g<m;g++)Ka=G.sprites[g].object,Na=Ka.matrixWorld,Ka instanceof THREE.Particle&&(B.set(Na.elements[12],Na.elements[13],Na.elements[14],1),K.multiplyVector4(B),B.z/=B.w,0<B.z&&1>B.z&&(u===C?($=new THREE.RenderableParticle,D.push($),C++,u++,v=$):v=D[u++],v.object=Ka,v.x=B.x/B.w,v.y=B.y/B.w,v.z=B.z,v.rotation=Ka.rotation.z,v.scale.x=Ka.scale.x*Math.abs(v.x-
(B.x+h.projectionMatrix.elements[0])/(B.w+h.projectionMatrix.elements[12])),v.scale.y=Ka.scale.y*Math.abs(v.y-(B.y+h.projectionMatrix.elements[5])/(B.w+h.projectionMatrix.elements[13])),v.material=Ka.material,G.elements.push(v)));!0===T&&G.elements.sort(c);return G}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=void 0!==d?d:1};
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,u){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];l=g[e];m=g[f];n=g[u];p=i.x-h.x;o=j.x-h.x;s=i.y-h.y;t=j.y-h.y;r=i.z-h.z;z=j.z-h.z;x=m.u-l.u;q=n.u-l.u;F=m.v-l.v;A=n.v-l.v;v=1/(x*A-q*F);G.set((A*p-F*o)*v,(A*s-F*t)*v,(A*r-F*z)*v);L.set((x*o-q*p)*v,(x*t-q*s)*v,(x*z-q*r)*v);D[b].addSelf(G);D[c].addSelf(G);D[d].addSelf(G);C[b].addSelf(L);C[c].addSelf(L);C[d].addSelf(L)}var b,c,d,e,f,g,h,i,j,l,m,n,p,o,s,t,r,z,
x,q,F,A,v,u,D=[],C=[],G=new THREE.Vector3,L=new THREE.Vector3,B=new THREE.Vector3,K=new THREE.Vector3,H=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)D[b]=new THREE.Vector3,C[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var I=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<
...
s),r.crossSelf(z),h[3*i]+=r.x,h[3*i+1]+=r.y,h[3*i+2]+=r.z,h[3*j]+=r.x,h[3*j+1]+=r.y,h[3*j+2]+=r.z,h[3*l]+=r.x,h[3*l+1]+=r.y,h[3*l+2]+=r.z}this.normalizeNormals();this.normalsNeedUpdate=!0}},normalizeNormals:function(){for(var a=this.attributes.normal.array,b,c,d,e=0,f=a.length;e<f;e+=3)b=a[e],c=a[e+1],d=a[e+2],b=1/Math.sqrt(b*b+c*c+d*d),a[e]*=b,a[e+1]*=b,a[e+2]*=b},computeTangents:function(){function a(a){Y.x=d[3*a];Y.y=d[3*a+1];Y.z=d[3*a+2];M.copy(Y);T=i[a];N.copy(T);N.subSelf(Y.multiplyScalar(Y.dot(T))).normalize();
P.cross(M,T);$=P.dot(j[a]);J=0>$?-1:1;h[4*a]=N.x;h[4*a+1]=N.y;h[4*a+2]=N.z;h[4*a+3]=J}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===this.attributes.uv)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,e=this.attributes.uv.array,f=c.length/3;if(void 0===this.attributes.tangent){var g=
4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,m,n,p,o,s,t,r,z,x,q,F,A,v,u,f=new THREE.Vector3,g=new THREE.Vector3,D,C,G,L,B,K,H,I=this.offsets;G=0;for(L=I.length;G<L;++G){C=I[G].start;B=I[G].count;var O=I[G].index;D=C;for(C+=B;D<C;D+=3)B=O+b[D],K=O+b[D+1],H=O+b[D+2],l=c[3*B],m=c[3*B+1],n=c[3*B+2],p=c[3*K],o=c[3*K+1],s=c[3*K+2],t=c[3*H],r=c[3*H+1],z=c[3*
H+2],x=e[2*B],q=e[2*B+1],F=e[2*K],A=e[2*K+1],v=e[2*H],u=e[2*H+1],p-=l,l=t-l,o-=m,m=r-m,s-=n,n=z-n,F-=x,x=v-x,A-=q,q=u-q,u=1/(F*q-x*A),f.set((q*p-A*l)*u,(q*o-A*m)*u,(q*s-A*n)*u),g.set((F*l-x*p)*u,(F*m-x*o)*u,(F*n-x*s)*u),i[B].addSelf(f),i[K].addSelf(f),i[H].addSelf(f),j[B].addSelf(g),j[K].addSelf(g),j[H].addSelf(g)}var N=new THREE.Vector3,P=new THREE.Vector3,Y=new THREE.Vector3,M=new THREE.Vector3,J,T,$;G=0;for(L=I.length;G<L;++G){C=I[G].start;B=I[G].count;O=I[G].index;D=C;for(C+=B;D<C;D+=3)B=O+b[D],
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,j,l,m,n,p,o,s,t,r,z,x,q;function F(a){return a%4?4-a%4:0}function A(a,b){return(new Uint8Array(a,b,1))[0]}function v(a,b){return(new Uint32Array(a,b,1))[0]}function u(b,c){var d,e,f,g,h,i,j,l=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=l[3*d],f=l[3*d+1],g=l[3*d+2],h=O[2*e],e=O[2*e+1],i=O[2*f],j=O[2*f+1],f=O[2*g],g=O[2*g+1],K.faceVertexUvs[0].push([new THREE.UV(h,e),new THREE.UV(i,j),new THREE.UV(f,g)])}function D(b,
...
r,n),new THREE.Vector3(q,t,m),new THREE.Vector3(u,v,o)],null,j))}}var K=this,H=0,I=[],O=[],N,P,Y;THREE.Geometry.call(this);q=a;P=H;z=new Uint8Array(q,P,12);o="";for(r=0;12>r;r++)o+=String.fromCharCode(z[P+r]);b=A(q,P+12);A(q,P+13);A(q,P+14);A(q,P+15);c=A(q,P+16);d=A(q,P+17);e=A(q,P+18);j=A(q,P+19);l=v(q,P+20);m=v(q,P+20+4);n=v(q,P+20+8);p=v(q,P+20+12);o=v(q,P+20+16);s=v(q,P+20+20);t=v(q,P+20+24);r=v(q,P+20+28);z=v(q,P+20+32);x=v(q,P+20+36);q=v(q,P+20+40);H+=b;P=3*c+j;Y=4*c+j;N=p*P;b=o*(P+3*d);c=s*
(P+3*e);j=t*(P+3*d+3*e);P=r*Y;d=z*(Y+4*d);e=x*(Y+4*e);Y=H;var H=new Float32Array(a,H,3*l),M,J,T,$;for(M=0;M<l;M++)J=H[3*M],T=H[3*M+1],$=H[3*M+2],K.vertices.push(new THREE.Vector3(J,T,$));l=H=Y+3*l*Float32Array.BYTES_PER_ELEMENT;if(m){H=new Int8Array(a,H,3*m);for(Y=0;Y<m;Y++)M=H[3*Y],J=H[3*Y+1],T=H[3*Y+2],I.push(M/127,J/127,T/127)}H=l+3*m*Int8Array.BYTES_PER_ELEMENT;m=H+=F(3*m);if(n){l=new Float32Array(a,H,2*n);for(H=0;H<n;H++)Y=l[2*H],M=l[2*H+1],O.push(Y,M)}n=H=m+2*n*Float32Array.BYTES_PER_ELEMENT;
N=n+N+F(2*p);m=N+b+F(2*o);b=m+c+F(2*s);c=b+j+F(2*t);P=c+P+F(2*r);j=P+d+F(2*z);d=j+e+F(2*x);s&&(e=m+3*s*Uint32Array.BYTES_PER_ELEMENT,C(s,m,e+3*s*Uint32Array.BYTES_PER_ELEMENT),u(s,e));t&&(s=b+3*t*Uint32Array.BYTES_PER_ELEMENT,e=s+3*t*Uint32Array.BYTES_PER_ELEMENT,L(t,b,s,e+3*t*Uint32Array.BYTES_PER_ELEMENT),u(t,e));x&&(t=j+4*x*Uint32Array.BYTES_PER_ELEMENT,G(x,j,t+4*x*Uint32Array.BYTES_PER_ELEMENT),D(x,t));q&&(x=d+4*q*Uint32Array.BYTES_PER_ELEMENT,t=x+4*q*Uint32Array.BYTES_PER_ELEMENT,B(q,d,x,t+4*
q*Uint32Array.BYTES_PER_ELEMENT),D(q,t));p&&C(p,n,n+3*p*Uint32Array.BYTES_PER_ELEMENT);o&&(p=N+3*o*Uint32Array.BYTES_PER_ELEMENT,L(o,N,p,p+3*o*Uint32Array.BYTES_PER_ELEMENT));r&&G(r,c,c+4*r*Uint32Array.BYTES_PER_ELEMENT);z&&(o=P+4*z*Uint32Array.BYTES_PER_ELEMENT,B(z,P,o,o+4*z*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals()};e.prototype=Object.create(THREE.Geometry.prototype);e=new e(c);c=this.initMaterials(d,c);this.needsTangents(c)&&e.computeTangents();b(e,c)};
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,j,l,m,n,p,o,s,t,r,z,x,q=a.faces;o=a.vertices;var F=a.normals,A=a.colors,v=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&v++;for(f=0;f<v;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(j=o.length;i<j;)l=new THREE.Vector3,l.x=o[i++]*e,l.y=o[i++]*e,l.z=o[i++]*e,d.vertices.push(l);i=0;for(j=q.length;i<j;){o=q[i++];l=o&1;h=o&2;f=o&4;g=o&8;n=o&16;m=o&32;s=o&64;o&=128;l?(t=new THREE.Face4,
t.a=q[i++],t.b=q[i++],t.c=q[i++],t.d=q[i++],l=4):(t=new THREE.Face3,t.a=q[i++],t.b=q[i++],t.c=q[i++],l=3);h&&(h=q[i++],t.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<v;f++)r=a.uvs[f],p=q[i++],x=r[2*p],p=r[2*p+1],d.faceUvs[f][h]=new THREE.UV(x,p);if(g)for(f=0;f<v;f++){r=a.uvs[f];z=[];for(g=0;g<l;g++)p=q[i++],x=r[2*p],p=r[2*p+1],z[g]=new THREE.UV(x,p);d.faceVertexUvs[f][h]=z}n&&(n=3*q[i++],g=new THREE.Vector3,g.x=F[n++],g.y=F[n++],g.z=F[n],t.normal=g);if(m)for(f=0;f<l;f++)n=3*q[i++],g=new THREE.Vector3,
g.x=F[n++],g.y=F[n++],g.z=F[n],t.vertexNormals.push(g);s&&(m=q[i++],m=new THREE.Color(A[m]),t.color=m);if(o)for(f=0;f<l;f++)m=q[i++],m=new THREE.Color(A[m]),t.vertexColors.push(m);d.faces.push(t)}if(a.skinWeights){i=0;for(j=a.skinWeights.length;i<j;i+=2)q=a.skinWeights[i],F=a.skinWeights[i+1],d.skinWeights.push(new THREE.Vector4(q,F,0,0))}if(a.skinIndices){i=0;for(j=a.skinIndices.length;i<j;i+=2)q=a.skinIndices[i],F=a.skinIndices[i+1],d.skinIndices.push(new THREE.Vector4(q,F,0,0))}d.bones=a.bones;
d.animation=a.animation;if(void 0!==a.morphTargets){i=0;for(j=a.morphTargets.length;i<j;i++){d.morphTargets[i]={};d.morphTargets[i].name=a.morphTargets[i].name;d.morphTargets[i].vertices=[];A=d.morphTargets[i].vertices;v=a.morphTargets[i].vertices;q=0;for(F=v.length;q<F;q+=3)o=new THREE.Vector3,o.x=v[q]*e,o.y=v[q+1]*e,o.z=v[q+2]*e,A.push(o)}}if(void 0!==a.morphColors){i=0;for(j=a.morphColors.length;i<j;i++){d.morphColors[i]={};d.morphColors[i].name=a.morphColors[i].name;d.morphColors[i].colors=[];
F=d.morphColors[i].colors;A=a.morphColors[i].colors;e=0;for(q=A.length;e<q;e+=3)v=new THREE.Color(16755200),v.setRGB(A[e],A[e+1],A[e+2]),F.push(v)}}d.computeCentroids();d.computeFaceNormals();a=this.initMaterials(a.materials,c);this.needsTangents(a)&&d.computeTangents();b(d,a)};
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return"relativeToHTML"==b?a:m+"/"+a}function e(){f(M.scene,T.objects)}function f(a,b){for(var c in b)if(void 0===M.objects[c]){var e=b[c],g=null;if(e.type&&e.type in l.hierarchyHandlerMap&&void 0===e.loading){var i={},j;for(j in t)"type"!==j&&"url"!==j&&(i[j]=t[j]);C=M.materials[e.material];e.loading=!0;var n=l.hierarchyHandlerMap[e.type].loaderObject;n.addEventListener?(n.addEventListener("load",h(c,a,C,e)),n.load(d(e.url,T.urlBaseType))):
n.options?n.load(d(e.url,T.urlBaseType),h(c,a,C,e)):n.load(d(e.url,T.urlBaseType),h(c,a,C,e),i)}else if(void 0!==e.geometry){if(D=M.geometries[e.geometry]){g=!1;C=M.materials[e.material];g=C instanceof THREE.ShaderMaterial;x=e.position;q=e.rotation;F=e.quaternion;A=e.scale;r=e.matrix;F=0;e.material||(C=new THREE.MeshFaceMaterial(M.face_materials[e.geometry]));C instanceof THREE.MeshFaceMaterial&&0===C.materials.length&&(C=new THREE.MeshFaceMaterial(M.face_materials[e.geometry]));if(C instanceof THREE.MeshFaceMaterial)for(i=
...
r[15])):(g.position.set(x[0],x[1],x[2]),F?(g.quaternion.set(F[0],F[1],F[2],F[3]),g.useQuaternion=!0):g.rotation.set(q[0],q[1],q[2]),g.scale.set(A[0],A[1],A[2]));g.visible=e.visible;g.castShadow=e.castShadow;g.receiveShadow=e.receiveShadow;a.add(g);M.objects[c]=g}}else"DirectionalLight"===e.type||"PointLight"===e.type||"AmbientLight"===e.type?(H=void 0!==e.color?e.color:16777215,I=void 0!==e.intensity?e.intensity:1,"DirectionalLight"===e.type?(x=e.direction,K=new THREE.DirectionalLight(H,I),K.position.set(x[0],
x[1],x[2]),e.target&&(J.push({object:K,targetName:e.target}),K.target=null)):"PointLight"===e.type?(x=e.position,z=e.distance,K=new THREE.PointLight(H,I,z),K.position.set(x[0],x[1],x[2])):"AmbientLight"===e.type&&(K=new THREE.AmbientLight(H)),a.add(K),K.name=c,M.lights[c]=K,M.objects[c]=K):"PerspectiveCamera"===e.type||"OrthographicCamera"===e.type?("PerspectiveCamera"===e.type?G=new THREE.PerspectiveCamera(e.fov,e.aspect,e.near,e.far):"OrthographicCamera"===e.type&&(G=new THREE.OrthographicCamera(v.left,
v.right,v.top,v.bottom,v.near,v.far)),x=e.position,G.position.set(x[0],x[1],x[2]),a.add(G),G.name=c,M.cameras[c]=G,M.objects[c]=G):(x=e.position,q=e.rotation,F=e.quaternion,A=e.scale,F=0,g=new THREE.Object3D,g.name=c,g.position.set(x[0],x[1],x[2]),F?(g.quaternion.set(F[0],F[1],F[2],F[3]),g.useQuaternion=!0):g.rotation.set(q[0],q[1],q[2]),g.scale.set(A[0],A[1],A[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),M.objects[c]=g,M.empties[c]=g);if(g){if(void 0!==e.properties)for(var m in e.properties)g.properties[m]=
...
f;e();O-=1;l.onLoadComplete();j()}}function i(a){return function(b,c){M.geometries[a]=b;M.face_materials[a]=c}}function j(){l.callbackProgress({totalModels:P,totalTextures:Y,loadedModels:P-O,loadedTextures:Y-N},M);l.onLoadProgress();if(0===O&&0===N){for(var a=0;a<J.length;a++){var c=J[a],d=M.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,M.scene.add(c.object.target));c.object.target.properties.targetInverse=c.object}b(M)}}var l=this,m=THREE.Loader.prototype.extractUrlBase(c),
n,p,o,s,t,r,z,x,q,F,A,v,u,D,C,G,L,B,K,H,I,O,N,P,Y,M,J=[],T=a,$;for($ in this.geometryHandlerMap)a=this.geometryHandlerMap[$].loaderClass,this.geometryHandlerMap[$].loaderObject=new a;for($ in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[$].loaderClass,this.hierarchyHandlerMap[$].loaderObject=new a;N=O=0;M={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(T.transform&&($=T.transform.position,a=T.transform.rotation,
c=T.transform.scale,$&&M.scene.position.set($[0],$[1],$[2]),a&&M.scene.rotation.set(a[0],a[1],a[2]),c&&M.scene.scale.set(c[0],c[1],c[2]),$||a||c))M.scene.updateMatrix(),M.scene.updateMatrixWorld();$=function(a){return function(){N-=a;j();l.onLoadComplete()}};for(o in T.fogs)a=T.fogs[o],"linear"===a.type?L=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(L=new THREE.FogExp2(0,a.density)),v=a.color,L.color.setRGB(v[0],v[1],v[2]),M.fogs[o]=L;for(n in T.geometries)t=T.geometries[n],t.type in this.geometryHandlerMap&&
(O+=1,l.onLoadStart());for(var da in T.objects)o=T.objects[da],o.type&&o.type in this.hierarchyHandlerMap&&(O+=1,l.onLoadStart());P=O;for(n in T.geometries)if(t=T.geometries[n],"cube"===t.type)D=new THREE.CubeGeometry(t.width,t.height,t.depth,t.widthSegments,t.heightSegments,t.depthSegments),M.geometries[n]=D;else if("plane"===t.type)D=new THREE.PlaneGeometry(t.width,t.height,t.widthSegments,t.heightSegments),M.geometries[n]=D;else if("sphere"===t.type)D=new THREE.SphereGeometry(t.radius,t.widthSegments,
t.heightSegments),M.geometries[n]=D;else if("cylinder"===t.type)D=new THREE.CylinderGeometry(t.topRad,t.botRad,t.height,t.radSegs,t.heightSegs),M.geometries[n]=D;else if("torus"===t.type)D=new THREE.TorusGeometry(t.radius,t.tube,t.segmentsR,t.segmentsT),M.geometries[n]=D;else if("icosahedron"===t.type)D=new THREE.IcosahedronGeometry(t.radius,t.subdivisions),M.geometries[n]=D;else if(t.type in this.geometryHandlerMap){da={};for(B in t)"type"!==B&&"url"!==B&&(da[B]=t[B]);this.geometryHandlerMap[t.type].loaderObject.load(d(t.url,
T.urlBaseType),g(n),da)}else"embedded"===t.type&&(da=T.embeds[t.id],da.metadata=T.metadata,da&&this.geometryHandlerMap.ascii.loaderObject.createModel(da,i(n),""));for(s in T.textures)if(n=T.textures[s],n.url instanceof Array){N+=n.url.length;for(B=0;B<n.url.length;B++)l.onLoadStart()}else N+=1,l.onLoadStart();Y=N;for(s in T.textures){n=T.textures[s];void 0!==n.mapping&&void 0!==THREE[n.mapping]&&(n.mapping=new THREE[n.mapping]);if(n.url instanceof Array){da=n.url.length;o=[];for(B=0;B<da;B++)o[B]=
d(n.url[B],T.urlBaseType);B=(B=o[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(o,n.mapping,$(da)):THREE.ImageUtils.loadTextureCube(o,n.mapping,$(da))}else{B=n.url.toLowerCase().endsWith(".dds");da=d(n.url,T.urlBaseType);o=$(1);B=B?THREE.ImageUtils.loadCompressedTexture(da,n.mapping,o):THREE.ImageUtils.loadTexture(da,n.mapping,o);void 0!==THREE[n.minFilter]&&(B.minFilter=THREE[n.minFilter]);void 0!==THREE[n.magFilter]&&(B.magFilter=THREE[n.magFilter]);n.anisotropy&&(B.anisotropy=
n.anisotropy);if(n.repeat&&(B.repeat.set(n.repeat[0],n.repeat[1]),1!==n.repeat[0]&&(B.wrapS=THREE.RepeatWrapping),1!==n.repeat[1]))B.wrapT=THREE.RepeatWrapping;n.offset&&B.offset.set(n.offset[0],n.offset[1]);if(n.wrap&&(da={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==da[n.wrap[0]]&&(B.wrapS=da[n.wrap[0]]),void 0!==da[n.wrap[1]]))B.wrapT=da[n.wrap[1]]}M.textures[s]=B}for(p in T.materials){r=T.materials[p];for(u in r.parameters)"envMap"===u||"map"===u||"lightMap"===u||
...
!0),r.parameters.displacementMap&&($.tDisplacement.value=M.textures[r.parameters.displacementMap],$.enableDisplacement.value=!0,$.uDisplacementBias.value=r.parameters.displacementBias,$.uDisplacementScale.value=r.parameters.displacementScale),$.uDiffuseColor.value.setHex(n),$.uSpecularColor.value.setHex(B),$.uAmbientColor.value.setHex(da),$.uShininess.value=o,r.parameters.opacity&&($.uOpacity.value=r.parameters.opacity),C=new THREE.ShaderMaterial({fragmentShader:s.fragmentShader,vertexShader:s.vertexShader,
uniforms:$,lights:!0,fog:!0})):C=new THREE[r.type](r.parameters);M.materials[p]=C}for(p in T.materials)if(r=T.materials[p],r.parameters.materials){u=[];for(B=0;B<r.parameters.materials.length;B++)u.push(M.materials[r.parameters.materials[B]]);M.materials[p].materials=u}e();M.cameras&&T.defaults.camera&&(M.currentCamera=M.cameras[T.defaults.camera]);M.fogs&&T.defaults.fog&&(M.scene.fog=M.fogs[T.defaults.fog]);v=T.defaults.bgcolor;M.bgColor=new THREE.Color;M.bgColor.setRGB(v[0],v[1],v[2]);M.bgColorAlpha=
T.defaults.bgalpha;l.callbackSync(M);j()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
THREE.CanvasRenderer=function(a){function b(a){z!==a&&(z=s.globalAlpha=a)}function c(a){x!==a&&(a===THREE.NormalBlending?s.globalCompositeOperation="source-over":a===THREE.AdditiveBlending?s.globalCompositeOperation="lighter":a===THREE.SubtractiveBlending&&(s.globalCompositeOperation="darker"),x=a)}function d(a){q!==a&&(q=s.strokeStyle=a)}function e(a){F!==a&&(F=s.fillStyle=a)}console.log("THREE.CanvasRenderer",THREE.REVISION);var a=a||{},f=this,g,h,i,j=new THREE.Projector,l=void 0!==a.canvas?a.canvas:
document.createElement("canvas"),m,n,p,o,s=l.getContext("2d"),t=new THREE.Color(0),r=0,z=1,x=0,q=null,F=null,A=null,v=null,u=null,D,C,G,L,B=new THREE.RenderableVertex,K=new THREE.RenderableVertex,H,I,O,N,P,Y,M,J,T,$,da,S,Q=new THREE.Color,ca=new THREE.Color,ia=new THREE.Color,aa=new THREE.Color,ja=new THREE.Color,Z=new THREE.Color,fa=new THREE.Color,Ka={},Na={},La,Ga,pa,Ba,db,qb,jb,ob,Cb,Db,nb=new THREE.Rectangle,Oa=new THREE.Rectangle,va=new THREE.Rectangle,kb=!1,la=new THREE.Color,fb=new THREE.Color,
eb=new THREE.Color,qa=new THREE.Vector3,pb,ab,rb,Ra,Ha,Ya,a=16;pb=document.createElement("canvas");pb.width=pb.height=2;ab=pb.getContext("2d");ab.fillStyle="rgba(0,0,0,1)";ab.fillRect(0,0,2,2);rb=ab.getImageData(0,0,2,2);Ra=rb.data;Ha=document.createElement("canvas");Ha.width=Ha.height=a;Ya=Ha.getContext("2d");Ya.translate(-a/2,-a/2);Ya.scale(a,a);a--;this.domElement=l;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){m=a;n=b;p=
Math.floor(m/2);o=Math.floor(n/2);l.width=m;l.height=n;nb.set(-p,-o,p,o);Oa.set(-p,-o,p,o);z=1;x=0;u=v=A=F=q=null};this.setClearColor=function(a,b){t.copy(a);r=void 0!==b?b:1;Oa.set(-p,-o,p,o)};this.setClearColorHex=function(a,b){t.setHex(a);r=void 0!==b?b:1;Oa.set(-p,-o,p,o)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){s.setTransform(1,0,0,-1,p,o);!1===Oa.isEmpty()&&(Oa.minSelf(nb),Oa.inflate(2),1>r&&s.clearRect(Math.floor(Oa.getX()),Math.floor(Oa.getY()),Math.floor(Oa.getWidth()),
...
c.g+=g.g*k,c.b+=g.b*k)}else f instanceof THREE.PointLight&&(h=f.matrixWorld.getPosition(),k=b.dot(qa.sub(h,a).normalize()),0>=k||(k*=0==f.distance?1:1-Math.min(a.distanceTo(h)/f.distance,1),0!=k&&(k*=f.intensity,c.r+=g.r*k,c.g+=g.g*k,c.b+=g.b*k)))}}function n(a,d,e,g,h,i,j,o){f.info.render.vertices+=3;f.info.render.faces++;b(o.opacity);c(o.blending);H=a.positionScreen.x;I=a.positionScreen.y;O=d.positionScreen.x;N=d.positionScreen.y;P=e.positionScreen.x;Y=e.positionScreen.y;m(H,I,O,N,P,Y);(o instanceof
THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)&&null===o.map&&null===o.map?(Z.copy(o.color),fa.copy(o.emissive),o.vertexColors===THREE.FaceColors&&(Z.r*=j.color.r,Z.g*=j.color.g,Z.b*=j.color.b),!0===kb)?!1===o.wireframe&&o.shading==THREE.SmoothShading&&3==j.vertexNormalsLength?(ca.r=ia.r=aa.r=la.r,ca.g=ia.g=aa.g=la.g,ca.b=ia.b=aa.b=la.b,l(j.v1.positionWorld,j.vertexNormalsWorld[0],ca),l(j.v2.positionWorld,j.vertexNormalsWorld[1],ia),l(j.v3.positionWorld,j.vertexNormalsWorld[2],aa),
ca.r=ca.r*Z.r+fa.r,ca.g=ca.g*Z.g+fa.g,ca.b=ca.b*Z.b+fa.b,ia.r=ia.r*Z.r+fa.r,ia.g=ia.g*Z.g+fa.g,ia.b=ia.b*Z.b+fa.b,aa.r=aa.r*Z.r+fa.r,aa.g=aa.g*Z.g+fa.g,aa.b=aa.b*Z.b+fa.b,ja.r=0.5*(ia.r+aa.r),ja.g=0.5*(ia.g+aa.g),ja.b=0.5*(ia.b+aa.b),pa=F(ca,ia,aa,ja),z(H,I,O,N,P,Y,0,0,1,0,0,1,pa)):(Q.r=la.r,Q.g=la.g,Q.b=la.b,l(j.centroidWorld,j.normalWorld,Q),Q.r=Q.r*Z.r+fa.r,Q.g=Q.g*Z.g+fa.g,Q.b=Q.b*Z.b+fa.b,!0===o.wireframe?q(Q,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(Q)):!0===o.wireframe?
q(o.color,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(o.color):o instanceof THREE.MeshBasicMaterial||o instanceof THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial?null!==o.map?o.map.mapping instanceof THREE.UVMapping&&(Ba=j.uvs[0],x(H,I,O,N,P,Y,Ba[g].u,Ba[g].v,Ba[h].u,Ba[h].v,Ba[i].u,Ba[i].v,o.map)):null!==o.envMap?o.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=k.matrixWorldInverse,qa.copy(j.vertexNormalsWorld[g]),db=0.5*(qa.x*a.elements[0]+qa.y*
a.elements[4]+qa.z*a.elements[8])+0.5,qb=0.5*(qa.x*a.elements[1]+qa.y*a.elements[5]+qa.z*a.elements[9])+0.5,qa.copy(j.vertexNormalsWorld[h]),jb=0.5*(qa.x*a.elements[0]+qa.y*a.elements[4]+qa.z*a.elements[8])+0.5,ob=0.5*(qa.x*a.elements[1]+qa.y*a.elements[5]+qa.z*a.elements[9])+0.5,qa.copy(j.vertexNormalsWorld[i]),Cb=0.5*(qa.x*a.elements[0]+qa.y*a.elements[4]+qa.z*a.elements[8])+0.5,Db=0.5*(qa.x*a.elements[1]+qa.y*a.elements[5]+qa.z*a.elements[9])+0.5,x(H,I,O,N,P,Y,db,qb,jb,ob,Cb,Db,o.envMap)):(Q.copy(o.color),
o.vertexColors===THREE.FaceColors&&(Q.r*=j.color.r,Q.g*=j.color.g,Q.b*=j.color.b),!0===o.wireframe?q(Q,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(Q)):o instanceof THREE.MeshDepthMaterial?(La=k.near,Ga=k.far,ca.r=ca.g=ca.b=1-Va(a.positionScreen.z,La,Ga),ia.r=ia.g=ia.b=1-Va(d.positionScreen.z,La,Ga),aa.r=aa.g=aa.b=1-Va(e.positionScreen.z,La,Ga),ja.r=0.5*(ia.r+aa.r),ja.g=0.5*(ia.g+aa.g),ja.b=0.5*(ia.b+aa.b),pa=F(ca,ia,aa,ja),z(H,I,O,N,P,Y,0,0,1,0,0,1,pa)):o instanceof THREE.MeshNormalMaterial&&
(Q.r=ic(j.normalWorld.x),Q.g=ic(j.normalWorld.y),Q.b=ic(j.normalWorld.z),!0===o.wireframe?q(Q,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(Q))}function m(a,b,c,d,e,f){s.beginPath();s.moveTo(a,b);s.lineTo(c,d);s.lineTo(e,f);s.closePath()}function r(a,b,c,d,e,f,g,h){s.beginPath();s.moveTo(a,b);s.lineTo(c,d);s.lineTo(e,f);s.lineTo(g,h);s.closePath()}function q(a,b,c,e){A!==b&&(A=s.lineWidth=b);v!==c&&(v=s.lineCap=c);u!==e&&(u=s.lineJoin=e);d(a.getContextStyle());s.stroke();va.inflate(2*
b)}function t(a){e(a.getContextStyle());s.fill()}function x(a,b,c,d,f,g,h,k,i,j,l,Va,n){if(!(n instanceof THREE.DataTexture||void 0===n.image||0==n.image.width)){if(!0===n.needsUpdate){var m=n.wrapS==THREE.RepeatWrapping,o=n.wrapT==THREE.RepeatWrapping;Ka[n.id]=s.createPattern(n.image,!0===m&&!0===o?"repeat":!0===m&&!1===o?"repeat-x":!1===m&&!0===o?"repeat-y":"no-repeat");n.needsUpdate=!1}void 0===Ka[n.id]?e("rgba(0,0,0,1)"):e(Ka[n.id]);var m=n.offset.x/n.repeat.x,o=n.offset.y/n.repeat.y,zb=n.image.width*
n.repeat.x,p=n.image.height*n.repeat.y,h=(h+m)*zb,k=(1-k+o)*p,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+m)*zb-h,j=(1-j+o)*p-k,l=(l+m)*zb-h,Va=(1-Va+o)*p-k,m=i*Va-l*j;0===m?(void 0===Na[n.id]&&(b=document.createElement("canvas"),b.width=n.image.width,b.height=n.image.height,b=b.getContext("2d"),b.drawImage(n.image,0,0),Na[n.id]=b.getImageData(0,0,n.image.width,n.image.height).data),b=Na[n.id],h=4*(Math.floor(h)+Math.floor(k)*n.image.width),Q.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),t(Q)):(m=1/m,n=(Va*c-j*f)*m,j=
(Va*d-j*g)*m,c=(i*f-l*c)*m,d=(i*g-l*d)*m,a=a-n*h-c*k,h=b-j*h-d*k,s.save(),s.transform(n,j,c,d,a,h),s.fill(),s.restore())}}function z(a,b,c,d,e,f,g,h,k,i,j,l,n){var Va,m;Va=n.width-1;m=n.height-1;g*=Va;h*=m;c-=a;d-=b;e-=a;f-=b;k=k*Va-g;i=i*m-h;j=j*Va-g;l=l*m-h;m=1/(k*l-j*i);Va=(l*c-i*e)*m;i=(l*d-i*f)*m;c=(k*e-j*c)*m;d=(k*f-j*d)*m;a=a-Va*g-c*h;b=b-i*g-d*h;s.save();s.transform(Va,i,c,d,a,b);s.clip();s.drawImage(n,0,0);s.restore()}function F(a,b,c,d){Ra[0]=255*a.r|0;Ra[1]=255*a.g|0;Ra[2]=255*a.b|0;Ra[4]=
255*b.r|0;Ra[5]=255*b.g|0;Ra[6]=255*b.b|0;Ra[8]=255*c.r|0;Ra[9]=255*c.g|0;Ra[10]=255*c.b|0;Ra[12]=255*d.r|0;Ra[13]=255*d.g|0;Ra[14]=255*d.b|0;ab.putImageData(rb,0,0);Ya.drawImage(pb,0,0);return Ha}function Va(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function ic(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function zb(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===k instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
else{var Zb,Ac,ma,ea;!0===this.autoClear?this.clear():s.setTransform(1,0,0,-1,p,o);f.info.render.vertices=0;f.info.render.faces=0;g=j.projectScene(a,k,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;kb=0<i.length;if(!0===kb){la.setRGB(0,0,0);fb.setRGB(0,0,0);eb.setRGB(0,0,0);Zb=0;for(Ac=i.length;Zb<Ac;Zb++){ea=i[Zb];var na=ea.color;ea instanceof THREE.AmbientLight?(la.r+=na.r,la.g+=na.g,la.b+=na.b):ea instanceof THREE.DirectionalLight?(fb.r+=na.r,fb.g+=na.g,fb.b+=na.b):ea instanceof THREE.PointLight&&
(eb.r+=na.r,eb.g+=na.g,eb.b+=na.b)}}Zb=0;for(Ac=h.length;Zb<Ac;Zb++)if(ma=h[Zb],ea=ma.material,!(void 0===ea||!1===ea.visible)){va.empty();if(ma instanceof THREE.RenderableParticle){D=ma;D.x*=p;D.y*=o;var na=D,bb=ma;b(ea.opacity);c(ea.blending);var Ab=void 0,Bb=void 0,sb=void 0,tb=void 0,jc=ma=void 0,Sc=void 0;ea instanceof THREE.ParticleBasicMaterial?null===ea.map?(sb=bb.object.scale.x,tb=bb.object.scale.y,sb*=bb.scale.x*p,tb*=bb.scale.y*o,va.set(na.x-sb,na.y-tb,na.x+sb,na.y+tb),!1!==nb.intersects(va)&&
(e(ea.color.getContextStyle()),s.save(),s.translate(na.x,na.y),s.rotate(-bb.rotation),s.scale(sb,tb),s.fillRect(-1,-1,2,2),s.restore())):(ma=ea.map.image,jc=ma.width>>1,Sc=ma.height>>1,sb=bb.scale.x*p,tb=bb.scale.y*o,Ab=sb*jc,Bb=tb*Sc,va.set(na.x-Ab,na.y-Bb,na.x+Ab,na.y+Bb),!1!==nb.intersects(va)&&(s.save(),s.translate(na.x,na.y),s.rotate(-bb.rotation),s.scale(sb,-tb),s.translate(-jc,-Sc),s.drawImage(ma,0,0),s.restore())):ea instanceof THREE.ParticleCanvasMaterial&&(Ab=bb.scale.x*p,Bb=bb.scale.y*
o,va.set(na.x-Ab,na.y-Bb,na.x+Ab,na.y+Bb),!1!==nb.intersects(va)&&(d(ea.color.getContextStyle()),e(ea.color.getContextStyle()),s.save(),s.translate(na.x,na.y),s.rotate(-bb.rotation),s.scale(Ab,Bb),ea.program(s),s.restore()))}else if(ma instanceof THREE.RenderableLine){if(D=ma.v1,C=ma.v2,D.positionScreen.x*=p,D.positionScreen.y*=o,C.positionScreen.x*=p,C.positionScreen.y*=o,va.addPoint(D.positionScreen.x,D.positionScreen.y),va.addPoint(C.positionScreen.x,C.positionScreen.y),!0===nb.intersects(va)&&
(na=D,bb=C,b(ea.opacity),c(ea.blending),s.beginPath(),s.moveTo(na.positionScreen.x,na.positionScreen.y),s.lineTo(bb.positionScreen.x,bb.positionScreen.y),ea instanceof THREE.LineBasicMaterial))na=ea.linewidth,A!==na&&(A=s.lineWidth=na),na=ea.linecap,v!==na&&(v=s.lineCap=na),na=ea.linejoin,u!==na&&(u=s.lineJoin=na),d(ea.color.getContextStyle()),s.stroke(),va.inflate(2*ea.linewidth)}else if(ma instanceof THREE.RenderableFace3)D=ma.v1,C=ma.v2,G=ma.v3,D.positionScreen.x*=p,D.positionScreen.y*=o,C.positionScreen.x*=
p,C.positionScreen.y*=o,G.positionScreen.x*=p,G.positionScreen.y*=o,!0===ea.overdraw&&(zb(D.positionScreen,C.positionScreen),zb(C.positionScreen,G.positionScreen),zb(G.positionScreen,D.positionScreen)),va.add3Points(D.positionScreen.x,D.positionScreen.y,C.positionScreen.x,C.positionScreen.y,G.positionScreen.x,G.positionScreen.y),!0===nb.intersects(va)&&n(D,C,G,0,1,2,ma,ea,a);else if(ma instanceof THREE.RenderableFace4&&(D=ma.v1,C=ma.v2,G=ma.v3,L=ma.v4,D.positionScreen.x*=p,D.positionScreen.y*=o,C.positionScreen.x*=
p,C.positionScreen.y*=o,G.positionScreen.x*=p,G.positionScreen.y*=o,L.positionScreen.x*=p,L.positionScreen.y*=o,B.positionScreen.copy(C.positionScreen),K.positionScreen.copy(L.positionScreen),!0===ea.overdraw&&(zb(D.positionScreen,C.positionScreen),zb(C.positionScreen,L.positionScreen),zb(L.positionScreen,D.positionScreen),zb(G.positionScreen,B.positionScreen),zb(G.positionScreen,K.positionScreen)),va.addPoint(D.positionScreen.x,D.positionScreen.y),va.addPoint(C.positionScreen.x,C.positionScreen.y),
va.addPoint(G.positionScreen.x,G.positionScreen.y),va.addPoint(L.positionScreen.x,L.positionScreen.y),!0===nb.intersects(va)))(na=D,bb=C,Ab=G,Bb=L,sb=B,tb=K,jc=a,f.info.render.vertices+=4,f.info.render.faces++,b(ea.opacity),c(ea.blending),void 0!==ea.map&&null!==ea.map||void 0!==ea.envMap&&null!==ea.envMap)?(n(na,bb,Bb,0,1,3,ma,ea,jc),n(sb,Ab,tb,1,2,3,ma,ea,jc)):(H=na.positionScreen.x,I=na.positionScreen.y,O=bb.positionScreen.x,N=bb.positionScreen.y,P=Ab.positionScreen.x,Y=Ab.positionScreen.y,M=Bb.positionScreen.x,
J=Bb.positionScreen.y,T=sb.positionScreen.x,$=sb.positionScreen.y,da=tb.positionScreen.x,S=tb.positionScreen.y,ea instanceof THREE.MeshLambertMaterial||ea instanceof THREE.MeshPhongMaterial)?(Z.copy(ea.color),fa.copy(ea.emissive),ea.vertexColors===THREE.FaceColors&&(Z.r*=ma.color.r,Z.g*=ma.color.g,Z.b*=ma.color.b),!0===kb)?!1===ea.wireframe&&ea.shading==THREE.SmoothShading&&4==ma.vertexNormalsLength?(ca.r=ia.r=aa.r=ja.r=la.r,ca.g=ia.g=aa.g=ja.g=la.g,ca.b=ia.b=aa.b=ja.b=la.b,l(ma.v1.positionWorld,
ma.vertexNormalsWorld[0],ca),l(ma.v2.positionWorld,ma.vertexNormalsWorld[1],ia),l(ma.v4.positionWorld,ma.vertexNormalsWorld[3],aa),l(ma.v3.positionWorld,ma.vertexNormalsWorld[2],ja),ca.r=ca.r*Z.r+fa.r,ca.g=ca.g*Z.g+fa.g,ca.b=ca.b*Z.b+fa.b,ia.r=ia.r*Z.r+fa.r,ia.g=ia.g*Z.g+fa.g,ia.b=ia.b*Z.b+fa.b,aa.r=aa.r*Z.r+fa.r,aa.g=aa.g*Z.g+fa.g,aa.b=aa.b*Z.b+fa.b,ja.r=ja.r*Z.r+fa.r,ja.g=ja.g*Z.g+fa.g,ja.b=ja.b*Z.b+fa.b,pa=F(ca,ia,aa,ja),m(H,I,O,N,M,J),z(H,I,O,N,M,J,0,0,1,0,0,1,pa),m(T,$,P,Y,da,S),z(T,$,P,Y,da,
S,1,0,1,1,0,1,pa)):(Q.r=la.r,Q.g=la.g,Q.b=la.b,l(ma.centroidWorld,ma.normalWorld,Q),Q.r=Q.r*Z.r+fa.r,Q.g=Q.g*Z.g+fa.g,Q.b=Q.b*Z.b+fa.b,r(H,I,O,N,P,Y,M,J),!0===ea.wireframe?q(Q,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):t(Q)):(Q.r=Z.r+fa.r,Q.g=Z.g+fa.g,Q.b=Z.b+fa.b,r(H,I,O,N,P,Y,M,J),!0===ea.wireframe?q(Q,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):t(Q)):ea instanceof THREE.MeshBasicMaterial?(Q.copy(ea.color),ea.vertexColors===THREE.FaceColors&&(Q.r*=ma.color.r,
Q.g*=ma.color.g,Q.b*=ma.color.b),r(H,I,O,N,P,Y,M,J),!0===ea.wireframe?q(Q,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):t(Q)):ea instanceof THREE.MeshNormalMaterial?(Q.r=ic(ma.normalWorld.x),Q.g=ic(ma.normalWorld.y),Q.b=ic(ma.normalWorld.z),r(H,I,O,N,P,Y,M,J),!0===ea.wireframe?q(Q,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):t(Q)):ea instanceof THREE.MeshDepthMaterial&&(La=k.near,Ga=k.far,ca.r=ca.g=ca.b=1-Va(na.positionScreen.z,La,Ga),ia.r=ia.g=ia.b=1-Va(bb.positionScreen.z,
La,Ga),aa.r=aa.g=aa.b=1-Va(Bb.positionScreen.z,La,Ga),ja.r=ja.g=ja.b=1-Va(Ab.positionScreen.z,La,Ga),pa=F(ca,ia,aa,ja),m(H,I,O,N,M,J),z(H,I,O,N,M,J,0,0,1,0,0,1,pa),m(T,$,P,Y,da,S),z(T,$,P,Y,da,S,1,0,1,1,0,1,pa));Oa.addRectangle(va)}s.setTransform(1,0,0,1,0,0)}}};
...
o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,s=a.__webglCustomAttributesList;if(c.sortParticles){rb.copy(ab);rb.multiplySelf(c.matrixWorld);for(d=0;d<g;d++)e=h[d],Ra.copy(e),rb.multiplyVector3(Ra),m[d]=[Ra.z,d];m.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++)e=h[m[d][1]],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;for(d=0;d<j;d++)f=3*d,e=i[m[d][1]],n[f]=e.r,n[f+1]=e.g,n[f+2]=e.b;if(s){i=0;for(j=s.length;i<j;i++)if(h=s[i],void 0===h.boundTo||"vertices"===h.boundTo)if(f=0,e=h.value.length,1===h.size)for(d=
...
0,e=a.length;d<e;d++)fa=ia=null,ja=Z=Ga=La=ob=jb=pa=-1,Ya=!0,a[d].render(b,c,eb,qa),fa=ia=null,ja=Z=Ga=La=ob=jb=pa=-1,Ya=!0}function p(a,b,c,d,e,f,g,h){var i,k,j,l;b?(k=a.length-1,l=b=-1):(k=0,b=a.length,l=1);for(var n=k;n!==b;n+=l)if(i=a[n],i.render){k=i.object;j=i.buffer;if(h)i=h;else{i=i[c];if(!i)continue;g&&S.setBlending(i.blending,i.blendEquation,i.blendSrc,i.blendDst);S.setDepthTest(i.depthTest);S.setDepthWrite(i.depthWrite);D(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits)}S.setMaterialFaces(i);
j instanceof THREE.BufferGeometry?S.renderBufferDirect(d,e,f,i,j,k):S.renderBuffer(d,e,f,i,j,k)}}function o(a,b,c,d,e,f,g){for(var h,i,k=0,j=a.length;k<j;k++)if(h=a[k],i=h.object,i.visible){if(g)h=g;else{h=h[b];if(!h)continue;f&&S.setBlending(h.blending,h.blendEquation,h.blendSrc,h.blendDst);S.setDepthTest(h.depthTest);S.setDepthWrite(h.depthWrite);D(h.polygonOffset,h.polygonOffsetFactor,h.polygonOffsetUnits)}S.renderImmediateObject(c,d,e,h,i)}}function s(a,b,c){a.push({buffer:b,object:c,opaque:null,
transparent:null})}function t(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return!0;return!1}function r(a){for(var b in a.attributes)a.attributes[b].needsUpdate=!1}function z(a,b){for(var c=a.length-1;0<=c;c--)a[c].object===b&&a.splice(c,1)}function x(a,b){for(var c=a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function q(a,b,c,d,e){Na=0;d.needsUpdate&&(d.program&&S.deallocateMaterial(d),S.initMaterial(d,b,c,e),d.needsUpdate=!1);d.morphTargets&&!e.__webglMorphTargetInfluences&&(e.__webglMorphTargetInfluences=
new Float32Array(S.maxMorphTargets));var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==ia&&(k.useProgram(g),ia=g,f=!0);d.id!==ja&&(ja=d.id,f=!0);if(f||a!==fa)k.uniformMatrix4fv(h.projectionMatrix,!1,a._projectionMatrixArray),a!==fa&&(fa=a);if(d.skinning)if(hc&&e.useVertexTexture){if(null!==h.boneTexture){var j=F();k.uniform1i(h.boneTexture,j);S.setTexture(e.boneTexture,j)}}else null!==h.boneGlobalMatrices&&k.uniformMatrix4fv(h.boneGlobalMatrices,!1,e.boneMatrices);if(f){c&&d.fog&&(i.fogColor.value=
c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(Ya){for(var l=0,n=0,m=0,o,p,s,r=yc,q=r.directional.colors,t=r.directional.positions,x=r.point.colors,z=r.point.positions,A=r.point.distances,B=r.spot.colors,C=r.spot.positions,D=r.spot.distances,G=r.spot.directions,Q=r.spot.anglesCos,I=r.spot.exponents,aa=r.hemi.skyColors,
J=r.hemi.groundColors,K=r.hemi.positions,M=0,N=0,ca=0,Z=0,T=0,$=0,P=0,da=0,Y=p=0,c=Y=Y=0,f=b.length;c<f;c++)j=b[c],j.onlyShadow||(o=j.color,s=j.intensity,p=j.distance,j instanceof THREE.AmbientLight?j.visible&&(S.gammaInput?(l+=o.r*o.r,n+=o.g*o.g,m+=o.b*o.b):(l+=o.r,n+=o.g,m+=o.b)):j instanceof THREE.DirectionalLight?(T+=1,j.visible&&(p=3*M,S.gammaInput?v(q,p,o,s*s):u(q,p,o,s),Ha.copy(j.matrixWorld.getPosition()),Ha.subSelf(j.target.matrixWorld.getPosition()),Ha.normalize(),t[p]=Ha.x,t[p+1]=Ha.y,
t[p+2]=Ha.z,M+=1)):j instanceof THREE.PointLight?($+=1,j.visible&&(Y=3*N,S.gammaInput?v(x,Y,o,s*s):u(x,Y,o,s),s=j.matrixWorld.getPosition(),z[Y]=s.x,z[Y+1]=s.y,z[Y+2]=s.z,A[N]=p,N+=1)):j instanceof THREE.SpotLight?(P+=1,j.visible&&(Y=3*ca,S.gammaInput?v(B,Y,o,s*s):u(B,Y,o,s),s=j.matrixWorld.getPosition(),C[Y]=s.x,C[Y+1]=s.y,C[Y+2]=s.z,D[ca]=p,Ha.copy(s),Ha.subSelf(j.target.matrixWorld.getPosition()),Ha.normalize(),G[Y]=Ha.x,G[Y+1]=Ha.y,G[Y+2]=Ha.z,Q[ca]=Math.cos(j.angle),I[ca]=j.exponent,ca+=1)):
j instanceof THREE.HemisphereLight&&(da+=1,j.visible&&(o=j.color,p=j.groundColor,Y=3*Z,S.gammaInput?(s*=s,v(aa,Y,o,s),v(J,Y,p,s)):(u(aa,Y,o,s),u(J,Y,p,s)),Ha.copy(j.matrixWorld.getPosition()),Ha.normalize(),K[Y]=Ha.x,K[Y+1]=Ha.y,K[Y+2]=Ha.z,Z+=1)));c=3*M;for(f=Math.max(q.length,3*T);c<f;c++)q[c]=0;c=3*M;for(f=Math.max(t.length,3*T);c<f;c++)t[c]=0;c=3*N;for(f=Math.max(x.length,3*$);c<f;c++)x[c]=0;c=3*N;for(f=Math.max(z.length,3*$);c<f;c++)z[c]=0;c=N;for(f=Math.max(A.length,$);c<f;c++)A[c]=0;c=3*ca;
for(f=Math.max(B.length,3*P);c<f;c++)B[c]=0;c=3*ca;for(f=Math.max(C.length,3*P);c<f;c++)C[c]=0;c=3*ca;for(f=Math.max(G.length,3*P);c<f;c++)G[c]=0;c=ca;for(f=Math.max(Q.length,P);c<f;c++)Q[c]=0;c=ca;for(f=Math.max(I.length,P);c<f;c++)I[c]=0;c=ca;for(f=Math.max(D.length,P);c<f;c++)D[c]=0;c=3*Z;for(f=Math.max(aa.length,3*da);c<f;c++)aa[c]=0;c=3*Z;for(f=Math.max(J.length,3*da);c<f;c++)J[c]=0;c=3*Z;for(f=Math.max(K.length,3*da);c<f;c++)K[c]=0;r.directional.length=M;r.point.length=N;r.spot.length=ca;r.hemi.length=
Z;r.ambient[0]=l;r.ambient[1]=n;r.ambient[2]=m;Ya=!1}c=yc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=c.spot.directions;i.spotLightAngleCos.value=
c.spot.anglesCos;i.spotLightExponent.value=c.spot.exponents;i.hemisphereLightSkyColor.value=c.hemi.skyColors;i.hemisphereLightGroundColor.value=c.hemi.groundColors;i.hemisphereLightDirection.value=c.hemi.positions}if(d instanceof THREE.MeshBasicMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.MeshPhongMaterial){i.opacity.value=d.opacity;S.gammaInput?i.diffuse.value.copyGammaToLinear(d.color):i.diffuse.value=d.color;i.map.value=d.map;i.lightMap.value=d.lightMap;i.specularMap.value=
...
d.size,i.scale.value=O.height/2,i.map.value=d.map):d instanceof THREE.MeshPhongMaterial?(i.shininess.value=d.shininess,S.gammaInput?(i.ambient.value.copyGammaToLinear(d.ambient),i.emissive.value.copyGammaToLinear(d.emissive),i.specular.value.copyGammaToLinear(d.specular)):(i.ambient.value=d.ambient,i.emissive.value=d.emissive,i.specular.value=d.specular),d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)):d instanceof THREE.MeshLambertMaterial?(S.gammaInput?(i.ambient.value.copyGammaToLinear(d.ambient),
i.emissive.value.copyGammaToLinear(d.emissive)):(i.ambient.value=d.ambient,i.emissive.value=d.emissive),d.wrapAround&&i.wrapRGB.value.copy(d.wrapRGB)):d instanceof THREE.MeshDepthMaterial?(i.mNear.value=a.near,i.mFar.value=a.far,i.opacity.value=d.opacity):d instanceof THREE.MeshNormalMaterial&&(i.opacity.value=d.opacity);if(e.receiveShadow&&!d._shadowPass&&i.shadowMatrix){c=U=0;for(f=b.length;c<f;c++)if(j=b[c],j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade))i.shadowMap.value[U]=
j.shadowMap,i.shadowMapSize.value[U]=j.shadowMapSize,i.shadowMatrix.value[U]=j.shadowMatrix,i.shadowDarkness.value[U]=j.shadowDarkness,i.shadowBias.value[U]=j.shadowBias,U++}b=d.uniformsList;i=0;for(U=b.length;i<U;i++)if(f=g.uniforms[b[i][1]])if(c=b[i][0],l=c.type,j=c.value,"i"===l)k.uniform1i(f,j);else if("f"===l)k.uniform1f(f,j);else if("v2"===l)k.uniform2f(f,j.x,j.y);else if("v3"===l)k.uniform3f(f,j.x,j.y,j.z);else if("v4"===l)k.uniform4f(f,j.x,j.y,j.z,j.w);else if("c"===l)k.uniform3f(f,j.r,j.g,
...
l);k.uniformMatrix4fv(f,!1,c._array)}else if("t"===l){if(m=j,j=F(),k.uniform1i(f,j),m)if(m.image instanceof Array&&6===m.image.length){if(c=m,f=j,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=k.createTexture());k.activeTexture(k.TEXTURE0+f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)S.autoScaleCubemaps&&!f?(n=j,m=l,r=c.image[l],t=
Qc,r.width<=t&&r.height<=t||(x=Math.max(r.width,r.height),q=Math.floor(r.width*t/x),t=Math.floor(r.height*t/x),x=document.createElement("canvas"),x.width=q,x.height=t,x.getContext("2d").drawImage(r,0,0,r.width,r.height,0,0,q,t),r=x),n[m]=r):j[l]=c.image[l];l=j[0];n=0===(l.width&l.width-1)&&0===(l.height&l.height-1);m=H(c.format);r=H(c.type);L(k.TEXTURE_CUBE_MAP,c,n);for(l=0;6>l;l++)if(f){t=j[l].mipmaps;x=0;for(z=t.length;x<z;x++)q=t[x],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,x,m,q.width,
q.height,0,q.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,m,m,r,j[l]);c.generateMipmaps&&n&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else m instanceof THREE.WebGLRenderTargetCube?(c=m,k.activeTexture(k.TEXTURE0+j),k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)):S.setTexture(m,j)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(n=c.value.length;l<
n;l++)c._array[l]=F();k.uniform1iv(f,c._array);l=0;for(n=c.value.length;l<n;l++)m=c.value[l],j=c._array[l],m&&S.setTexture(m,j)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==h.cameraPosition)b=a.matrixWorld.getPosition(),k.uniform3f(h.cameraPosition,b.x,b.y,b.z);(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&null!==h.viewMatrix&&k.uniformMatrix4fv(h.viewMatrix,!1,a._viewMatrixArray)}k.uniformMatrix4fv(h.modelViewMatrix,
!1,e._modelViewMatrix.elements);h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,!1,e._normalMatrix.elements);null!==h.modelMatrix&&k.uniformMatrix4fv(h.modelMatrix,!1,e.matrixWorld.elements);return g}function F(){var a=Na;a>=oc&&console.warn("Trying to use "+a+" texture units while this GPU supports only "+oc);Na+=1;return a}function A(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function v(a,b,c,
d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function u(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function D(a,b,c){Cb!==a&&(a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL),Cb=a);if(a&&(Db!==b||nb!==c))k.polygonOffset(b,c),Db=b,nb=c}function C(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function G(a,b){var c;"fragment"===a?c=k.createShader(k.FRAGMENT_SHADER):"vertex"===a&&(c=k.createShader(k.VERTEX_SHADER));k.shaderSource(c,
b);k.compileShader(c);return!k.getShaderParameter(c,k.COMPILE_STATUS)?(console.error(k.getShaderInfoLog(c)),console.error(C(b)),null):c}function L(a,b,c){c?(k.texParameteri(a,k.TEXTURE_WRAP_S,H(b.wrapS)),k.texParameteri(a,k.TEXTURE_WRAP_T,H(b.wrapT)),k.texParameteri(a,k.TEXTURE_MAG_FILTER,H(b.magFilter)),k.texParameteri(a,k.TEXTURE_MIN_FILTER,H(b.minFilter))):(k.texParameteri(a,k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE),k.texParameteri(a,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE),k.texParameteri(a,k.TEXTURE_MAG_FILTER,
K(b.magFilter)),k.texParameteri(a,k.TEXTURE_MIN_FILTER,K(b.minFilter)));if(yb&&b.type!==THREE.FloatType&&(1<b.anisotropy||b.__oldAnisotropy))k.texParameterf(a,yb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,zc)),b.__oldAnisotropy=b.anisotropy}function B(a,b){k.bindRenderbuffer(k.RENDERBUFFER,a);b.depthBuffer&&!b.stencilBuffer?(k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_COMPONENT16,b.width,b.height),k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_ATTACHMENT,k.RENDERBUFFER,a)):b.depthBuffer&&
...
if(a===THREE.OneMinusDstAlphaFactor)return k.ONE_MINUS_DST_ALPHA;if(a===THREE.DstColorFactor)return k.DST_COLOR;if(a===THREE.OneMinusDstColorFactor)return k.ONE_MINUS_DST_COLOR;if(a===THREE.SrcAlphaSaturateFactor)return k.SRC_ALPHA_SATURATE;if(void 0!==lb){if(a===THREE.RGB_S3TC_DXT1_Format)return lb.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT1_Format)return lb.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT3_Format)return lb.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===THREE.RGBA_S3TC_DXT5_Format)return lb.COMPRESSED_RGBA_S3TC_DXT5_EXT}return 0}
function I(a){return O.getContext(a,{alpha:P,premultipliedAlpha:Y,antialias:M,stencil:J,preserveDrawingBuffer:T})}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},O=void 0!==a.canvas?a.canvas:document.createElement("canvas"),N=void 0!==a.precision?a.precision:"highp",P=void 0!==a.alpha?a.alpha:!0,Y=void 0!==a.premultipliedAlpha?a.premultipliedAlpha:!0,M=void 0!==a.antialias?a.antialias:!1,J=void 0!==a.stencil?a.stencil:!0,T=void 0!==a.preserveDrawingBuffer?a.preserveDrawingBuffer:!1,
$=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),da=void 0!==a.clearAlpha?a.clearAlpha:0;this.domElement=O;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapCullFrontFaces=this.shadowMapSoft=this.shadowMapAutoUpdate=!0;this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=
8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var S=this,Q=[],ca=0,ia=null,aa=null,ja=-1,Z=null,fa=null,Ka=0,Na=0,La=-1,Ga=-1,pa=-1,Ba=-1,db=-1,qb=-1,jb=-1,ob=-1,Cb=null,Db=null,nb=null,Oa=null,va=0,kb=0,la=0,fb=0,eb=0,qa=0,pb=new THREE.Frustum,ab=new THREE.Matrix4,rb=new THREE.Matrix4,Ra=new THREE.Vector4,Ha=new THREE.Vector3,Ya=!0,yc={ambient:[0,
0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,dc,yb,lb;try{if(!(k=I("experimental-webgl")||!(k=I("webgl"))))throw"Error creating WebGL context.";}catch(Rc){console.error(Rc)}a=k.getExtension("OES_texture_float");dc=k.getExtension("OES_standard_derivatives");yb=k.getExtension("EXT_texture_filter_anisotropic")||
k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");lb=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");a||console.log("THREE.WebGLRenderer: Float textures not supported.");dc||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");yb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");lb||
console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor($.r,$.g,$.b,da);this.context=k;var oc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS);dc=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);
var Qc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),zc=yb?k.getParameter(yb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,ec=0<dc,hc=ec&&a;lb&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};this.supportsVertexTextures=function(){return ec};this.getMaxAnisotropy=function(){return zc};this.setSize=function(a,b){O.width=a;O.height=b;this.setViewport(0,0,O.width,O.height)};this.setViewport=function(a,b,c,d){va=void 0!==a?a:0;kb=void 0!==b?b:0;la=void 0!==c?c:O.width;fb=void 0!==
d?d:O.height;k.viewport(va,kb,la,fb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){$.setHex(a);da=b;k.clearColor($.r,$.g,$.b,da)};this.setClearColor=function(a,b){$.copy(a);da=b;k.clearColor($.r,$.g,$.b,da)};this.getClearColor=function(){return $};this.getClearAlpha=function(){return da};this.clear=function(a,b,c){var d=0;if(void 0===a||a)d|=k.COLOR_BUFFER_BIT;if(void 0===
...
k.vertexAttribPointer(b.skinWeight,4,k.FLOAT,!1,0,0));0<=b.lineDistance&&(k.bindBuffer(k.ARRAY_BUFFER,e.__webglLineDistanceBuffer),k.vertexAttribPointer(b.lineDistance,1,k.FLOAT,!1,0,0))}f instanceof THREE.Mesh?(d.wireframe?(d=d.wireframeLinewidth,d!==Oa&&(k.lineWidth(d),Oa=d),a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglLineBuffer),k.drawElements(k.LINES,e.__webglLineCount,k.UNSIGNED_SHORT,0)):(a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglFaceBuffer),k.drawElements(k.TRIANGLES,e.__webglFaceCount,
k.UNSIGNED_SHORT,0)),S.info.render.calls++,S.info.render.vertices+=e.__webglFaceCount,S.info.render.faces+=e.__webglFaceCount/3):f instanceof THREE.Line?(f=f.type===THREE.LineStrip?k.LINE_STRIP:k.LINES,d=d.linewidth,d!==Oa&&(k.lineWidth(d),Oa=d),k.drawArrays(f,0,e.__webglLineCount),S.info.render.calls++):f instanceof THREE.ParticleSystem?(k.drawArrays(k.POINTS,0,e.__webglParticleCount),S.info.render.calls++,S.info.render.points+=e.__webglParticleCount):f instanceof THREE.Ribbon&&(k.drawArrays(k.TRIANGLE_STRIP,
0,e.__webglVertexCount),S.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,i=a.__lights,j=a.fog;ja=-1;Ya=!0;this.autoUpdateScene&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b._viewMatrixArray||(b._viewMatrixArray=new Float32Array(16));b._projectionMatrixArray||(b._projectionMatrixArray=new Float32Array(16));b.matrixWorldInverse.getInverse(b.matrixWorld);
b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);b.projectionMatrix.flattenToArray(b._projectionMatrixArray);ab.multiply(b.projectionMatrix,b.matrixWorldInverse);pb.setFromMatrix(ab);this.autoUpdateObjects&&this.initWebGLObjects(a);n(this.renderPluginsPre,a,b);S.info.render.calls=0;S.info.render.vertices=0;S.info.render.faces=0;S.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;
for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.render=!1,g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||pb.contains(g))){A(g,b);var m=f,s=m.buffer,r=void 0,q=r=void 0,q=m.object.material;if(q instanceof THREE.MeshFaceMaterial)r=s.materialIndex,0<=r&&(r=q.materials[r],r.transparent?(m.transparent=r,m.opaque=null):(m.opaque=r,m.transparent=null));else if(r=q)r.transparent?(m.transparent=r,m.opaque=null):(m.opaque=r,m.transparent=null);f.render=!0;!0===this.sortObjects&&
(null!==g.renderDepth?f.z=g.renderDepth:(Ra.copy(g.matrixWorld.getPosition()),ab.multiplyVector3(Ra),f.z=Ra.z),f.id=g.id)}this.sortObjects&&h.sort(l);h=a.__webglObjectsImmediate;d=0;for(e=h.length;d<e;d++)f=h[d],g=f.object,g.visible&&(A(g,b),g=f.object.material,g.transparent?(f.transparent=g,f.opaque=null):(f.opaque=g,f.transparent=null));a.overrideMaterial?(d=a.overrideMaterial,this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst),this.setDepthTest(d.depthTest),this.setDepthWrite(d.depthWrite),
D(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits),p(a.__webglObjects,!1,"",b,i,j,!0,d),o(a.__webglObjectsImmediate,"",b,i,j,!1,d)):(this.setBlending(THREE.NormalBlending),p(a.__webglObjects,!0,"opaque",b,i,j,!1),o(a.__webglObjectsImmediate,"opaque",b,i,j,!1),p(a.__webglObjects,!1,"transparent",b,i,j,!0),o(a.__webglObjectsImmediate,"transparent",b,i,j,!0));n(this.renderPluginsPost,a,b);c&&(c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&c.minFilter!==THREE.LinearFilter)&&(c instanceof
THREE.WebGLRenderTargetCube?(k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture),k.generateMipmap(k.TEXTURE_CUBE_MAP),k.bindTexture(k.TEXTURE_CUBE_MAP,null)):(k.bindTexture(k.TEXTURE_2D,c.__webglTexture),k.generateMipmap(k.TEXTURE_2D),k.bindTexture(k.TEXTURE_2D,null)));this.setDepthTest(!0);this.setDepthWrite(!0)}};this.renderImmediateObject=function(a,b,c,d,e){var f=q(a,b,c,d,e);Z=-1;S.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,pb):e.render(function(a){S.renderBufferImmediate(a,
f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=a.__objectsAdded[0],l=a,n=void 0,m=void 0,o=void 0,p=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,b instanceof THREE.Mesh)if(m=b.geometry,o=b.material,m instanceof THREE.Geometry){if(void 0===m.geometryGroups){var q=m,u=void 0,v=void 0,A=void 0,
B=void 0,C=void 0,D=void 0,F=void 0,G={},H=q.morphTargets.length,Q=q.morphNormals.length,I=o instanceof THREE.MeshFaceMaterial;q.geometryGroups={};u=0;for(v=q.faces.length;u<v;u++)A=q.faces[u],B=I?A.materialIndex:void 0,D=void 0!==B?B:-1,void 0===G[D]&&(G[D]={hash:D,counter:0}),F=G[D].hash+"_"+G[D].counter,void 0===q.geometryGroups[F]&&(q.geometryGroups[F]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:H,numMorphNormals:Q}),C=A instanceof THREE.Face3?3:4,65535<q.geometryGroups[F].vertices+
C&&(G[D].counter+=1,F=G[D].hash+"_"+G[D].counter,void 0===q.geometryGroups[F]&&(q.geometryGroups[F]={faces3:[],faces4:[],materialIndex:B,vertices:0,numMorphTargets:H,numMorphNormals:Q})),A instanceof THREE.Face3?q.geometryGroups[F].faces3.push(u):q.geometryGroups[F].faces4.push(u),q.geometryGroups[F].vertices+=C;q.geometryGroupsList=[];var aa=void 0;for(aa in q.geometryGroups)q.geometryGroups[aa].id=Ka++,q.geometryGroupsList.push(q.geometryGroups[aa])}for(n in m.geometryGroups)if(p=m.geometryGroups[n],
!p.__webglVertexBuffer){var J=p;J.__webglVertexBuffer=k.createBuffer();J.__webglNormalBuffer=k.createBuffer();J.__webglTangentBuffer=k.createBuffer();J.__webglColorBuffer=k.createBuffer();J.__webglUVBuffer=k.createBuffer();J.__webglUV2Buffer=k.createBuffer();J.__webglSkinIndicesBuffer=k.createBuffer();J.__webglSkinWeightsBuffer=k.createBuffer();J.__webglFaceBuffer=k.createBuffer();J.__webglLineBuffer=k.createBuffer();var K=void 0,ca=void 0;if(J.numMorphTargets){J.__webglMorphTargetsBuffers=[];K=0;
for(ca=J.numMorphTargets;K<ca;K++)J.__webglMorphTargetsBuffers.push(k.createBuffer())}if(J.numMorphNormals){J.__webglMorphNormalsBuffers=[];K=0;for(ca=J.numMorphNormals;K<ca;K++)J.__webglMorphNormalsBuffers.push(k.createBuffer())}S.info.memory.geometries++;d(p,b);m.verticesNeedUpdate=!0;m.morphTargetsNeedUpdate=!0;m.elementsNeedUpdate=!0;m.uvsNeedUpdate=!0;m.normalsNeedUpdate=!0;m.tangentsNeedUpdate=!0;m.colorsNeedUpdate=!0}}else m instanceof THREE.BufferGeometry&&h(m);else if(b instanceof THREE.Ribbon){if(m=
b.geometry,!m.__webglVertexBuffer){var M=m;M.__webglVertexBuffer=k.createBuffer();M.__webglColorBuffer=k.createBuffer();M.__webglNormalBuffer=k.createBuffer();S.info.memory.geometries++;var L=m,N=b,Z=L.vertices.length;L.__vertexArray=new Float32Array(3*Z);L.__colorArray=new Float32Array(3*Z);L.__normalArray=new Float32Array(3*Z);L.__webglVertexCount=Z;c(L,N);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(m=b.geometry,!m.__webglVertexBuffer){var P=
m;P.__webglVertexBuffer=k.createBuffer();P.__webglColorBuffer=k.createBuffer();P.__webglLineDistanceBuffer=k.createBuffer();S.info.memory.geometries++;var O=m,$=b,T=O.vertices.length;O.__vertexArray=new Float32Array(3*T);O.__colorArray=new Float32Array(3*T);O.__lineDistanceArray=new Float32Array(1*T);O.__webglLineCount=T;c(O,$);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.lineDistancesNeedUpdate=!0}}else if(b instanceof THREE.ParticleSystem&&(m=b.geometry,!m.__webglVertexBuffer))if(m instanceof
THREE.Geometry){var ia=m;ia.__webglVertexBuffer=k.createBuffer();ia.__webglColorBuffer=k.createBuffer();S.info.memory.geometries++;var fa=m,Y=b,ja=fa.vertices.length;fa.__vertexArray=new Float32Array(3*ja);fa.__colorArray=new Float32Array(3*ja);fa.__sortArray=[];fa.__webglParticleCount=ja;c(fa,Y);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}else m instanceof THREE.BufferGeometry&&h(m);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(m=b.geometry,m instanceof THREE.BufferGeometry)s(l.__webglObjects,
m,b);else for(n in m.geometryGroups)p=m.geometryGroups[n],s(l.__webglObjects,p,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(m=b.geometry,s(l.__webglObjects,m,b)):b instanceof THREE.ImmediateRenderObject||b.immediateRenderCallback?l.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof THREE.Sprite?l.__webglSprites.push(b):b instanceof THREE.LensFlare&&l.__webglFlares.push(b);b.__webglActive=!0}a.__objectsAdded.splice(0,
1)}for(;a.__objectsRemoved.length;){var da=a.__objectsRemoved[0],pa=a;da instanceof THREE.Mesh||da instanceof THREE.ParticleSystem||da instanceof THREE.Ribbon||da instanceof THREE.Line?z(pa.__webglObjects,da):da instanceof THREE.Sprite?x(pa.__webglSprites,da):da instanceof THREE.LensFlare?x(pa.__webglFlares,da):(da instanceof THREE.ImmediateRenderObject||da.immediateRenderCallback)&&z(pa.__webglObjectsImmediate,da);da.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var Na=0,La=a.__webglObjects.length;Na<
La;Na++){var qa=a.__webglObjects[Na].object,U=qa.geometry,Ga=void 0,va=void 0,la=void 0;if(qa instanceof THREE.Mesh)if(U instanceof THREE.BufferGeometry)(U.verticesNeedUpdate||U.elementsNeedUpdate||U.uvsNeedUpdate||U.normalsNeedUpdate||U.colorsNeedUpdate||U.tangentsNeedUpdate)&&j(U,k.DYNAMIC_DRAW,!U.dynamic),U.verticesNeedUpdate=!1,U.elementsNeedUpdate=!1,U.uvsNeedUpdate=!1,U.normalsNeedUpdate=!1,U.colorsNeedUpdate=!1,U.tangentsNeedUpdate=!1;else{for(var Ha=0,Oa=U.geometryGroupsList.length;Ha<Oa;Ha++)if(Ga=
U.geometryGroupsList[Ha],la=e(qa,Ga),U.buffersNeedUpdate&&d(Ga,qa),va=la.attributes&&t(la),U.verticesNeedUpdate||U.morphTargetsNeedUpdate||U.elementsNeedUpdate||U.uvsNeedUpdate||U.normalsNeedUpdate||U.colorsNeedUpdate||U.tangentsNeedUpdate||va){var ra=Ga,Ra=qa,Ba=k.DYNAMIC_DRAW,qb=!U.dynamic,db=la;if(ra.__inittedArrays){var nb=f(db),jb=db.vertexColors?db.vertexColors:!1,ob=g(db),fb=nb===THREE.SmoothShading,E=void 0,ba=void 0,Ya=void 0,R=void 0,eb=void 0,ab=void 0,Eb=void 0,pb=void 0,Vb=void 0,kb=
void 0,lb=void 0,V=void 0,W=void 0,X=void 0,oa=void 0,Fb=void 0,Gb=void 0,Hb=void 0,rb=void 0,Ib=void 0,Jb=void 0,Kb=void 0,yb=void 0,Lb=void 0,Mb=void 0,Nb=void 0,Cb=void 0,Ob=void 0,Pb=void 0,Qb=void 0,Db=void 0,Rb=void 0,Sb=void 0,Tb=void 0,pc=void 0,ua=void 0,dc=void 0,$b=void 0,kc=void 0,lc=void 0,Sa=void 0,hc=void 0,Pa=void 0,Qa=void 0,ac=void 0,Wb=void 0,Ia=0,Ma=0,Xb=0,Yb=0,ub=0,Za=0,ya=0,cb=0,Ja=0,ha=0,ka=0,y=0,wa=void 0,Ta=ra.__vertexArray,qc=ra.__uvArray,rc=ra.__uv2Array,vb=ra.__normalArray,
Ca=ra.__tangentArray,Ua=ra.__colorArray,Da=ra.__skinIndexArray,Ea=ra.__skinWeightArray,ec=ra.__morphTargetsArrays,Tc=ra.__morphNormalsArrays,Uc=ra.__webglCustomAttributesList,w=void 0,Ub=ra.__faceArray,mb=ra.__lineArray,gb=Ra.geometry,yc=gb.elementsNeedUpdate,oc=gb.uvsNeedUpdate,zc=gb.normalsNeedUpdate,Qc=gb.tangentsNeedUpdate,Rc=gb.colorsNeedUpdate,hd=gb.morphTargetsNeedUpdate,fc=gb.vertices,sa=ra.faces3,ta=ra.faces4,$a=gb.faces,Vc=gb.faceVertexUvs[0],Wc=gb.faceVertexUvs[1],gc=gb.skinIndices,bc=
gb.skinWeights,cc=gb.morphTargets,Bc=gb.morphNormals;if(gb.verticesNeedUpdate){E=0;for(ba=sa.length;E<ba;E++)R=$a[sa[E]],V=fc[R.a],W=fc[R.b],X=fc[R.c],Ta[Ma]=V.x,Ta[Ma+1]=V.y,Ta[Ma+2]=V.z,Ta[Ma+3]=W.x,Ta[Ma+4]=W.y,Ta[Ma+5]=W.z,Ta[Ma+6]=X.x,Ta[Ma+7]=X.y,Ta[Ma+8]=X.z,Ma+=9;E=0;for(ba=ta.length;E<ba;E++)R=$a[ta[E]],V=fc[R.a],W=fc[R.b],X=fc[R.c],oa=fc[R.d],Ta[Ma]=V.x,Ta[Ma+1]=V.y,Ta[Ma+2]=V.z,Ta[Ma+3]=W.x,Ta[Ma+4]=W.y,Ta[Ma+5]=W.z,Ta[Ma+6]=X.x,Ta[Ma+7]=X.y,Ta[Ma+8]=X.z,Ta[Ma+9]=oa.x,Ta[Ma+10]=oa.y,Ta[Ma+
11]=oa.z,Ma+=12;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Ta,Ba)}if(hd){Sa=0;for(hc=cc.length;Sa<hc;Sa++){E=ka=0;for(ba=sa.length;E<ba;E++)ac=sa[E],R=$a[ac],V=cc[Sa].vertices[R.a],W=cc[Sa].vertices[R.b],X=cc[Sa].vertices[R.c],Pa=ec[Sa],Pa[ka]=V.x,Pa[ka+1]=V.y,Pa[ka+2]=V.z,Pa[ka+3]=W.x,Pa[ka+4]=W.y,Pa[ka+5]=W.z,Pa[ka+6]=X.x,Pa[ka+7]=X.y,Pa[ka+8]=X.z,db.morphNormals&&(fb?(Wb=Bc[Sa].vertexNormals[ac],Ib=Wb.a,Jb=Wb.b,Kb=Wb.c):Kb=Jb=Ib=Bc[Sa].faceNormals[ac],Qa=Tc[Sa],
Qa[ka]=Ib.x,Qa[ka+1]=Ib.y,Qa[ka+2]=Ib.z,Qa[ka+3]=Jb.x,Qa[ka+4]=Jb.y,Qa[ka+5]=Jb.z,Qa[ka+6]=Kb.x,Qa[ka+7]=Kb.y,Qa[ka+8]=Kb.z),ka+=9;E=0;for(ba=ta.length;E<ba;E++)ac=ta[E],R=$a[ac],V=cc[Sa].vertices[R.a],W=cc[Sa].vertices[R.b],X=cc[Sa].vertices[R.c],oa=cc[Sa].vertices[R.d],Pa=ec[Sa],Pa[ka]=V.x,Pa[ka+1]=V.y,Pa[ka+2]=V.z,Pa[ka+3]=W.x,Pa[ka+4]=W.y,Pa[ka+5]=W.z,Pa[ka+6]=X.x,Pa[ka+7]=X.y,Pa[ka+8]=X.z,Pa[ka+9]=oa.x,Pa[ka+10]=oa.y,Pa[ka+11]=oa.z,db.morphNormals&&(fb?(Wb=Bc[Sa].vertexNormals[ac],Ib=Wb.a,Jb=
Wb.b,Kb=Wb.c,yb=Wb.d):yb=Kb=Jb=Ib=Bc[Sa].faceNormals[ac],Qa=Tc[Sa],Qa[ka]=Ib.x,Qa[ka+1]=Ib.y,Qa[ka+2]=Ib.z,Qa[ka+3]=Jb.x,Qa[ka+4]=Jb.y,Qa[ka+5]=Jb.z,Qa[ka+6]=Kb.x,Qa[ka+7]=Kb.y,Qa[ka+8]=Kb.z,Qa[ka+9]=yb.x,Qa[ka+10]=yb.y,Qa[ka+11]=yb.z),ka+=12;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglMorphTargetsBuffers[Sa]);k.bufferData(k.ARRAY_BUFFER,ec[Sa],Ba);db.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglMorphNormalsBuffers[Sa]),k.bufferData(k.ARRAY_BUFFER,Tc[Sa],Ba))}}if(bc.length){E=0;for(ba=sa.length;E<
ba;E++)R=$a[sa[E]],Ob=bc[R.a],Pb=bc[R.b],Qb=bc[R.c],Ea[ha]=Ob.x,Ea[ha+1]=Ob.y,Ea[ha+2]=Ob.z,Ea[ha+3]=Ob.w,Ea[ha+4]=Pb.x,Ea[ha+5]=Pb.y,Ea[ha+6]=Pb.z,Ea[ha+7]=Pb.w,Ea[ha+8]=Qb.x,Ea[ha+9]=Qb.y,Ea[ha+10]=Qb.z,Ea[ha+11]=Qb.w,Rb=gc[R.a],Sb=gc[R.b],Tb=gc[R.c],Da[ha]=Rb.x,Da[ha+1]=Rb.y,Da[ha+2]=Rb.z,Da[ha+3]=Rb.w,Da[ha+4]=Sb.x,Da[ha+5]=Sb.y,Da[ha+6]=Sb.z,Da[ha+7]=Sb.w,Da[ha+8]=Tb.x,Da[ha+9]=Tb.y,Da[ha+10]=Tb.z,Da[ha+11]=Tb.w,ha+=12;E=0;for(ba=ta.length;E<ba;E++)R=$a[ta[E]],Ob=bc[R.a],Pb=bc[R.b],Qb=bc[R.c],
Db=bc[R.d],Ea[ha]=Ob.x,Ea[ha+1]=Ob.y,Ea[ha+2]=Ob.z,Ea[ha+3]=Ob.w,Ea[ha+4]=Pb.x,Ea[ha+5]=Pb.y,Ea[ha+6]=Pb.z,Ea[ha+7]=Pb.w,Ea[ha+8]=Qb.x,Ea[ha+9]=Qb.y,Ea[ha+10]=Qb.z,Ea[ha+11]=Qb.w,Ea[ha+12]=Db.x,Ea[ha+13]=Db.y,Ea[ha+14]=Db.z,Ea[ha+15]=Db.w,Rb=gc[R.a],Sb=gc[R.b],Tb=gc[R.c],pc=gc[R.d],Da[ha]=Rb.x,Da[ha+1]=Rb.y,Da[ha+2]=Rb.z,Da[ha+3]=Rb.w,Da[ha+4]=Sb.x,Da[ha+5]=Sb.y,Da[ha+6]=Sb.z,Da[ha+7]=Sb.w,Da[ha+8]=Tb.x,Da[ha+9]=Tb.y,Da[ha+10]=Tb.z,Da[ha+11]=Tb.w,Da[ha+12]=pc.x,Da[ha+13]=pc.y,Da[ha+14]=pc.z,Da[ha+
15]=pc.w,ha+=16;0<ha&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Da,Ba),k.bindBuffer(k.ARRAY_BUFFER,ra.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ea,Ba))}if(Rc&&jb){E=0;for(ba=sa.length;E<ba;E++)R=$a[sa[E]],Eb=R.vertexColors,pb=R.color,3===Eb.length&&jb===THREE.VertexColors?(Lb=Eb[0],Mb=Eb[1],Nb=Eb[2]):Nb=Mb=Lb=pb,Ua[Ja]=Lb.r,Ua[Ja+1]=Lb.g,Ua[Ja+2]=Lb.b,Ua[Ja+3]=Mb.r,Ua[Ja+4]=Mb.g,Ua[Ja+5]=Mb.b,Ua[Ja+6]=Nb.r,Ua[Ja+7]=Nb.g,Ua[Ja+8]=Nb.b,Ja+=9;E=
0;for(ba=ta.length;E<ba;E++)R=$a[ta[E]],Eb=R.vertexColors,pb=R.color,4===Eb.length&&jb===THREE.VertexColors?(Lb=Eb[0],Mb=Eb[1],Nb=Eb[2],Cb=Eb[3]):Cb=Nb=Mb=Lb=pb,Ua[Ja]=Lb.r,Ua[Ja+1]=Lb.g,Ua[Ja+2]=Lb.b,Ua[Ja+3]=Mb.r,Ua[Ja+4]=Mb.g,Ua[Ja+5]=Mb.b,Ua[Ja+6]=Nb.r,Ua[Ja+7]=Nb.g,Ua[Ja+8]=Nb.b,Ua[Ja+9]=Cb.r,Ua[Ja+10]=Cb.g,Ua[Ja+11]=Cb.b,Ja+=12;0<Ja&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Ua,Ba))}if(Qc&&gb.hasTangents){E=0;for(ba=sa.length;E<ba;E++)R=$a[sa[E]],Vb=R.vertexTangents,
Fb=Vb[0],Gb=Vb[1],Hb=Vb[2],Ca[ya]=Fb.x,Ca[ya+1]=Fb.y,Ca[ya+2]=Fb.z,Ca[ya+3]=Fb.w,Ca[ya+4]=Gb.x,Ca[ya+5]=Gb.y,Ca[ya+6]=Gb.z,Ca[ya+7]=Gb.w,Ca[ya+8]=Hb.x,Ca[ya+9]=Hb.y,Ca[ya+10]=Hb.z,Ca[ya+11]=Hb.w,ya+=12;E=0;for(ba=ta.length;E<ba;E++)R=$a[ta[E]],Vb=R.vertexTangents,Fb=Vb[0],Gb=Vb[1],Hb=Vb[2],rb=Vb[3],Ca[ya]=Fb.x,Ca[ya+1]=Fb.y,Ca[ya+2]=Fb.z,Ca[ya+3]=Fb.w,Ca[ya+4]=Gb.x,Ca[ya+5]=Gb.y,Ca[ya+6]=Gb.z,Ca[ya+7]=Gb.w,Ca[ya+8]=Hb.x,Ca[ya+9]=Hb.y,Ca[ya+10]=Hb.z,Ca[ya+11]=Hb.w,Ca[ya+12]=rb.x,Ca[ya+13]=rb.y,Ca[ya+
14]=rb.z,Ca[ya+15]=rb.w,ya+=16;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Ca,Ba)}if(zc&&nb){E=0;for(ba=sa.length;E<ba;E++)if(R=$a[sa[E]],eb=R.vertexNormals,ab=R.normal,3===eb.length&&fb)for(ua=0;3>ua;ua++)$b=eb[ua],vb[Za]=$b.x,vb[Za+1]=$b.y,vb[Za+2]=$b.z,Za+=3;else for(ua=0;3>ua;ua++)vb[Za]=ab.x,vb[Za+1]=ab.y,vb[Za+2]=ab.z,Za+=3;E=0;for(ba=ta.length;E<ba;E++)if(R=$a[ta[E]],eb=R.vertexNormals,ab=R.normal,4===eb.length&&fb)for(ua=0;4>ua;ua++)$b=eb[ua],vb[Za]=$b.x,
vb[Za+1]=$b.y,vb[Za+2]=$b.z,Za+=3;else for(ua=0;4>ua;ua++)vb[Za]=ab.x,vb[Za+1]=ab.y,vb[Za+2]=ab.z,Za+=3;k.bindBuffer(k.ARRAY_BUFFER,ra.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,vb,Ba)}if(oc&&Vc&&ob){E=0;for(ba=sa.length;E<ba;E++)if(Ya=sa[E],kb=Vc[Ya],void 0!==kb)for(ua=0;3>ua;ua++)kc=kb[ua],qc[Xb]=kc.u,qc[Xb+1]=kc.v,Xb+=2;E=0;for(ba=ta.length;E<ba;E++)if(Ya=ta[E],kb=Vc[Ya],void 0!==kb)for(ua=0;4>ua;ua++)kc=kb[ua],qc[Xb]=kc.u,qc[Xb+1]=kc.v,Xb+=2;0<Xb&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglUVBuffer),
k.bufferData(k.ARRAY_BUFFER,qc,Ba))}if(oc&&Wc&&ob){E=0;for(ba=sa.length;E<ba;E++)if(Ya=sa[E],lb=Wc[Ya],void 0!==lb)for(ua=0;3>ua;ua++)lc=lb[ua],rc[Yb]=lc.u,rc[Yb+1]=lc.v,Yb+=2;E=0;for(ba=ta.length;E<ba;E++)if(Ya=ta[E],lb=Wc[Ya],void 0!==lb)for(ua=0;4>ua;ua++)lc=lb[ua],rc[Yb]=lc.u,rc[Yb+1]=lc.v,Yb+=2;0<Yb&&(k.bindBuffer(k.ARRAY_BUFFER,ra.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,rc,Ba))}if(yc){E=0;for(ba=sa.length;E<ba;E++)Ub[ub]=Ia,Ub[ub+1]=Ia+1,Ub[ub+2]=Ia+2,ub+=3,mb[cb]=Ia,mb[cb+1]=Ia+1,mb[cb+
2]=Ia,mb[cb+3]=Ia+2,mb[cb+4]=Ia+1,mb[cb+5]=Ia+2,cb+=6,Ia+=3;E=0;for(ba=ta.length;E<ba;E++)Ub[ub]=Ia,Ub[ub+1]=Ia+1,Ub[ub+2]=Ia+3,Ub[ub+3]=Ia+1,Ub[ub+4]=Ia+2,Ub[ub+5]=Ia+3,ub+=6,mb[cb]=Ia,mb[cb+1]=Ia+1,mb[cb+2]=Ia,mb[cb+3]=Ia+3,mb[cb+4]=Ia+1,mb[cb+5]=Ia+2,mb[cb+6]=Ia+2,mb[cb+7]=Ia+3,cb+=8,Ia+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ra.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Ub,Ba);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,ra.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,mb,Ba)}if(Uc){ua=
0;for(dc=Uc.length;ua<dc;ua++)if(w=Uc[ua],w.__original.needsUpdate){y=0;if(1===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)R=$a[sa[E]],w.array[y]=w.value[R.a],w.array[y+1]=w.value[R.b],w.array[y+2]=w.value[R.c],y+=3;E=0;for(ba=ta.length;E<ba;E++)R=$a[ta[E]],w.array[y]=w.value[R.a],w.array[y+1]=w.value[R.b],w.array[y+2]=w.value[R.c],w.array[y+3]=w.value[R.d],y+=4}else{if("faces"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)wa=w.value[sa[E]],w.array[y]=wa,w.array[y+
1]=wa,w.array[y+2]=wa,y+=3;E=0;for(ba=ta.length;E<ba;E++)wa=w.value[ta[E]],w.array[y]=wa,w.array[y+1]=wa,w.array[y+2]=wa,w.array[y+3]=wa,y+=4}}else if(2===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)R=$a[sa[E]],V=w.value[R.a],W=w.value[R.b],X=w.value[R.c],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=W.x,w.array[y+3]=W.y,w.array[y+4]=X.x,w.array[y+5]=X.y,y+=6;E=0;for(ba=ta.length;E<ba;E++)R=$a[ta[E]],V=w.value[R.a],W=w.value[R.b],X=w.value[R.c],oa=w.value[R.d],
w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=W.x,w.array[y+3]=W.y,w.array[y+4]=X.x,w.array[y+5]=X.y,w.array[y+6]=oa.x,w.array[y+7]=oa.y,y+=8}else{if("faces"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)X=W=V=wa=w.value[sa[E]],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=W.x,w.array[y+3]=W.y,w.array[y+4]=X.x,w.array[y+5]=X.y,y+=6;E=0;for(ba=ta.length;E<ba;E++)oa=X=W=V=wa=w.value[ta[E]],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=W.x,w.array[y+3]=W.y,w.array[y+4]=X.x,w.array[y+5]=X.y,w.array[y+6]=oa.x,
w.array[y+7]=oa.y,y+=8}}else if(3===w.size){var ga;ga="c"===w.type?["r","g","b"]:["x","y","z"];if(void 0===w.boundTo||"vertices"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)R=$a[sa[E]],V=w.value[R.a],W=w.value[R.b],X=w.value[R.c],w.array[y]=V[ga[0]],w.array[y+1]=V[ga[1]],w.array[y+2]=V[ga[2]],w.array[y+3]=W[ga[0]],w.array[y+4]=W[ga[1]],w.array[y+5]=W[ga[2]],w.array[y+6]=X[ga[0]],w.array[y+7]=X[ga[1]],w.array[y+8]=X[ga[2]],y+=9;E=0;for(ba=ta.length;E<ba;E++)R=$a[ta[E]],V=w.value[R.a],W=w.value[R.b],
X=w.value[R.c],oa=w.value[R.d],w.array[y]=V[ga[0]],w.array[y+1]=V[ga[1]],w.array[y+2]=V[ga[2]],w.array[y+3]=W[ga[0]],w.array[y+4]=W[ga[1]],w.array[y+5]=W[ga[2]],w.array[y+6]=X[ga[0]],w.array[y+7]=X[ga[1]],w.array[y+8]=X[ga[2]],w.array[y+9]=oa[ga[0]],w.array[y+10]=oa[ga[1]],w.array[y+11]=oa[ga[2]],y+=12}else if("faces"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)X=W=V=wa=w.value[sa[E]],w.array[y]=V[ga[0]],w.array[y+1]=V[ga[1]],w.array[y+2]=V[ga[2]],w.array[y+3]=W[ga[0]],w.array[y+4]=W[ga[1]],w.array[y+
5]=W[ga[2]],w.array[y+6]=X[ga[0]],w.array[y+7]=X[ga[1]],w.array[y+8]=X[ga[2]],y+=9;E=0;for(ba=ta.length;E<ba;E++)oa=X=W=V=wa=w.value[ta[E]],w.array[y]=V[ga[0]],w.array[y+1]=V[ga[1]],w.array[y+2]=V[ga[2]],w.array[y+3]=W[ga[0]],w.array[y+4]=W[ga[1]],w.array[y+5]=W[ga[2]],w.array[y+6]=X[ga[0]],w.array[y+7]=X[ga[1]],w.array[y+8]=X[ga[2]],w.array[y+9]=oa[ga[0]],w.array[y+10]=oa[ga[1]],w.array[y+11]=oa[ga[2]],y+=12}else if("faceVertices"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)wa=w.value[sa[E]],V=wa[0],
W=wa[1],X=wa[2],w.array[y]=V[ga[0]],w.array[y+1]=V[ga[1]],w.array[y+2]=V[ga[2]],w.array[y+3]=W[ga[0]],w.array[y+4]=W[ga[1]],w.array[y+5]=W[ga[2]],w.array[y+6]=X[ga[0]],w.array[y+7]=X[ga[1]],w.array[y+8]=X[ga[2]],y+=9;E=0;for(ba=ta.length;E<ba;E++)wa=w.value[ta[E]],V=wa[0],W=wa[1],X=wa[2],oa=wa[3],w.array[y]=V[ga[0]],w.array[y+1]=V[ga[1]],w.array[y+2]=V[ga[2]],w.array[y+3]=W[ga[0]],w.array[y+4]=W[ga[1]],w.array[y+5]=W[ga[2]],w.array[y+6]=X[ga[0]],w.array[y+7]=X[ga[1]],w.array[y+8]=X[ga[2]],w.array[y+
9]=oa[ga[0]],w.array[y+10]=oa[ga[1]],w.array[y+11]=oa[ga[2]],y+=12}}else if(4===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)R=$a[sa[E]],V=w.value[R.a],W=w.value[R.b],X=w.value[R.c],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=V.z,w.array[y+3]=V.w,w.array[y+4]=W.x,w.array[y+5]=W.y,w.array[y+6]=W.z,w.array[y+7]=W.w,w.array[y+8]=X.x,w.array[y+9]=X.y,w.array[y+10]=X.z,w.array[y+11]=X.w,y+=12;E=0;for(ba=ta.length;E<ba;E++)R=$a[ta[E]],V=w.value[R.a],W=w.value[R.b],
X=w.value[R.c],oa=w.value[R.d],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=V.z,w.array[y+3]=V.w,w.array[y+4]=W.x,w.array[y+5]=W.y,w.array[y+6]=W.z,w.array[y+7]=W.w,w.array[y+8]=X.x,w.array[y+9]=X.y,w.array[y+10]=X.z,w.array[y+11]=X.w,w.array[y+12]=oa.x,w.array[y+13]=oa.y,w.array[y+14]=oa.z,w.array[y+15]=oa.w,y+=16}else if("faces"===w.boundTo){E=0;for(ba=sa.length;E<ba;E++)X=W=V=wa=w.value[sa[E]],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=V.z,w.array[y+3]=V.w,w.array[y+4]=W.x,w.array[y+5]=W.y,w.array[y+
6]=W.z,w.array[y+7]=W.w,w.array[y+8]=X.x,w.array[y+9]=X.y,w.array[y+10]=X.z,w.array[y+11]=X.w,y+=12;E=0;for(ba=ta.length;E<ba;E++)oa=X=W=V=wa=w.value[ta[E]],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=V.z,w.array[y+3]=V.w,w.array[y+4]=W.x,w.array[y+5]=W.y,w.array[y+6]=W.z,w.array[y+7]=W.w,w.array[y+8]=X.x,w.array[y+9]=X.y,w.array[y+10]=X.z,w.array[y+11]=X.w,w.array[y+12]=oa.x,w.array[y+13]=oa.y,w.array[y+14]=oa.z,w.array[y+15]=oa.w,y+=16}else if("faceVertices"===w.boundTo){E=0;for(ba=sa.length;E<
ba;E++)wa=w.value[sa[E]],V=wa[0],W=wa[1],X=wa[2],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=V.z,w.array[y+3]=V.w,w.array[y+4]=W.x,w.array[y+5]=W.y,w.array[y+6]=W.z,w.array[y+7]=W.w,w.array[y+8]=X.x,w.array[y+9]=X.y,w.array[y+10]=X.z,w.array[y+11]=X.w,y+=12;E=0;for(ba=ta.length;E<ba;E++)wa=w.value[ta[E]],V=wa[0],W=wa[1],X=wa[2],oa=wa[3],w.array[y]=V.x,w.array[y+1]=V.y,w.array[y+2]=V.z,w.array[y+3]=V.w,w.array[y+4]=W.x,w.array[y+5]=W.y,w.array[y+6]=W.z,w.array[y+7]=W.w,w.array[y+8]=X.x,w.array[y+
9]=X.y,w.array[y+10]=X.z,w.array[y+11]=X.w,w.array[y+12]=oa.x,w.array[y+13]=oa.y,w.array[y+14]=oa.z,w.array[y+15]=oa.w,y+=16}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,Ba)}}qb&&(delete ra.__inittedArrays,delete ra.__colorArray,delete ra.__normalArray,delete ra.__tangentArray,delete ra.__uvArray,delete ra.__uv2Array,delete ra.__faceArray,delete ra.__vertexArray,delete ra.__lineArray,delete ra.__skinIndexArray,delete ra.__skinWeightArray)}}U.verticesNeedUpdate=!1;U.morphTargetsNeedUpdate=
!1;U.elementsNeedUpdate=!1;U.uvsNeedUpdate=!1;U.normalsNeedUpdate=!1;U.colorsNeedUpdate=!1;U.tangentsNeedUpdate=!1;U.buffersNeedUpdate=!1;la.attributes&&r(la)}else if(qa instanceof THREE.Ribbon){la=e(qa,U);va=la.attributes&&t(la);if(U.verticesNeedUpdate||U.colorsNeedUpdate||U.normalsNeedUpdate||va){var wb=U,Cc=k.DYNAMIC_DRAW,sc=void 0,tc=void 0,uc=void 0,Dc=void 0,xa=void 0,Ec=void 0,Fc=void 0,Gc=void 0,Zc=void 0,Wa=void 0,mc=void 0,za=void 0,hb=void 0,$c=wb.vertices,ad=wb.colors,bd=wb.normals,id=
$c.length,jd=ad.length,kd=bd.length,Hc=wb.__vertexArray,Ic=wb.__colorArray,Jc=wb.__normalArray,ld=wb.colorsNeedUpdate,md=wb.normalsNeedUpdate,Xc=wb.__webglCustomAttributesList;if(wb.verticesNeedUpdate){for(sc=0;sc<id;sc++)Dc=$c[sc],xa=3*sc,Hc[xa]=Dc.x,Hc[xa+1]=Dc.y,Hc[xa+2]=Dc.z;k.bindBuffer(k.ARRAY_BUFFER,wb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Hc,Cc)}if(ld){for(tc=0;tc<jd;tc++)Ec=ad[tc],xa=3*tc,Ic[xa]=Ec.r,Ic[xa+1]=Ec.g,Ic[xa+2]=Ec.b;k.bindBuffer(k.ARRAY_BUFFER,wb.__webglColorBuffer);
k.bufferData(k.ARRAY_BUFFER,Ic,Cc)}if(md){for(uc=0;uc<kd;uc++)Fc=bd[uc],xa=3*uc,Jc[xa]=Fc.x,Jc[xa+1]=Fc.y,Jc[xa+2]=Fc.z;k.bindBuffer(k.ARRAY_BUFFER,wb.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,Jc,Cc)}if(Xc){Gc=0;for(Zc=Xc.length;Gc<Zc;Gc++)if(za=Xc[Gc],za.needsUpdate&&(void 0===za.boundTo||"vertices"===za.boundTo)){xa=0;mc=za.value.length;if(1===za.size)for(Wa=0;Wa<mc;Wa++)za.array[Wa]=za.value[Wa];else if(2===za.size)for(Wa=0;Wa<mc;Wa++)hb=za.value[Wa],za.array[xa]=hb.x,za.array[xa+1]=hb.y,
xa+=2;else if(3===za.size)if("c"===za.type)for(Wa=0;Wa<mc;Wa++)hb=za.value[Wa],za.array[xa]=hb.r,za.array[xa+1]=hb.g,za.array[xa+2]=hb.b,xa+=3;else for(Wa=0;Wa<mc;Wa++)hb=za.value[Wa],za.array[xa]=hb.x,za.array[xa+1]=hb.y,za.array[xa+2]=hb.z,xa+=3;else if(4===za.size)for(Wa=0;Wa<mc;Wa++)hb=za.value[Wa],za.array[xa]=hb.x,za.array[xa+1]=hb.y,za.array[xa+2]=hb.z,za.array[xa+3]=hb.w,xa+=4;k.bindBuffer(k.ARRAY_BUFFER,za.buffer);k.bufferData(k.ARRAY_BUFFER,za.array,Cc)}}}U.verticesNeedUpdate=!1;U.colorsNeedUpdate=
!1;U.normalsNeedUpdate=!1;la.attributes&&r(la)}else if(qa instanceof THREE.Line){la=e(qa,U);va=la.attributes&&t(la);if(U.verticesNeedUpdate||U.colorsNeedUpdate||U.lineDistancesNeedUpdate||va){var xb=U,Kc=k.DYNAMIC_DRAW,vc=void 0,wc=void 0,xc=void 0,Lc=void 0,Fa=void 0,Mc=void 0,cd=xb.vertices,dd=xb.colors,ed=xb.lineDistances,nd=cd.length,od=dd.length,pd=ed.length,Nc=xb.__vertexArray,Oc=xb.__colorArray,fd=xb.__lineDistanceArray,qd=xb.colorsNeedUpdate,rd=xb.lineDistancesNeedUpdate,Yc=xb.__webglCustomAttributesList,
Pc=void 0,gd=void 0,Xa=void 0,nc=void 0,ib=void 0,Aa=void 0;if(xb.verticesNeedUpdate){for(vc=0;vc<nd;vc++)Lc=cd[vc],Fa=3*vc,Nc[Fa]=Lc.x,Nc[Fa+1]=Lc.y,Nc[Fa+2]=Lc.z;k.bindBuffer(k.ARRAY_BUFFER,xb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Nc,Kc)}if(qd){for(wc=0;wc<od;wc++)Mc=dd[wc],Fa=3*wc,Oc[Fa]=Mc.r,Oc[Fa+1]=Mc.g,Oc[Fa+2]=Mc.b;k.bindBuffer(k.ARRAY_BUFFER,xb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Oc,Kc)}if(rd){for(xc=0;xc<pd;xc++)fd[xc]=ed[xc];k.bindBuffer(k.ARRAY_BUFFER,xb.__webglLineDistanceBuffer);
k.bufferData(k.ARRAY_BUFFER,fd,Kc)}if(Yc){Pc=0;for(gd=Yc.length;Pc<gd;Pc++)if(Aa=Yc[Pc],Aa.needsUpdate&&(void 0===Aa.boundTo||"vertices"===Aa.boundTo)){Fa=0;nc=Aa.value.length;if(1===Aa.size)for(Xa=0;Xa<nc;Xa++)Aa.array[Xa]=Aa.value[Xa];else if(2===Aa.size)for(Xa=0;Xa<nc;Xa++)ib=Aa.value[Xa],Aa.array[Fa]=ib.x,Aa.array[Fa+1]=ib.y,Fa+=2;else if(3===Aa.size)if("c"===Aa.type)for(Xa=0;Xa<nc;Xa++)ib=Aa.value[Xa],Aa.array[Fa]=ib.r,Aa.array[Fa+1]=ib.g,Aa.array[Fa+2]=ib.b,Fa+=3;else for(Xa=0;Xa<nc;Xa++)ib=
Aa.value[Xa],Aa.array[Fa]=ib.x,Aa.array[Fa+1]=ib.y,Aa.array[Fa+2]=ib.z,Fa+=3;else if(4===Aa.size)for(Xa=0;Xa<nc;Xa++)ib=Aa.value[Xa],Aa.array[Fa]=ib.x,Aa.array[Fa+1]=ib.y,Aa.array[Fa+2]=ib.z,Aa.array[Fa+3]=ib.w,Fa+=4;k.bindBuffer(k.ARRAY_BUFFER,Aa.buffer);k.bufferData(k.ARRAY_BUFFER,Aa.array,Kc)}}}U.verticesNeedUpdate=!1;U.colorsNeedUpdate=!1;U.lineDistancesNeedUpdate=!1;la.attributes&&r(la)}else qa instanceof THREE.ParticleSystem&&(U instanceof THREE.BufferGeometry?((U.verticesNeedUpdate||U.colorsNeedUpdate)&&
j(U,k.DYNAMIC_DRAW,!U.dynamic),U.verticesNeedUpdate=!1,U.colorsNeedUpdate=!1):(la=e(qa,U),va=la.attributes&&t(la),(U.verticesNeedUpdate||U.colorsNeedUpdate||qa.sortParticles||va)&&i(U,k.DYNAMIC_DRAW,qa),U.verticesNeedUpdate=!1,U.colorsNeedUpdate=!1,la.attributes&&r(la)))}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,m,n;a instanceof THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?
n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.LineDashedMaterial?n="dashed":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var o=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,s,r;e=p=s=r=o=0;for(f=b.length;e<f;e++)g=b[e],g.onlyShadow||(g instanceof THREE.DirectionalLight&&p++,g instanceof THREE.PointLight&&
s++,g instanceof THREE.SpotLight&&r++,g instanceof THREE.HemisphereLight&&o++);e=p;f=s;g=r;h=o;o=p=0;for(r=b.length;o<r;o++)s=b[o],s.castShadow&&(s instanceof THREE.SpotLight&&p++,s instanceof THREE.DirectionalLight&&!s.shadowCascade&&p++);m=p;hc&&d&&d.useVertexTexture?l=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),b=Math.floor((b-20)/4),void 0!==d&&d instanceof THREE.SkinnedMesh&&(b=Math.min(d.bones.length,b),b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+
", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")),l=b);var q;a:{s=a.fragmentShader;r=a.vertexShader;o=a.uniforms;b=a.attributes;p=a.defines;var c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,fogExp:c instanceof THREE.FogExp2,sizeAttenuation:a.sizeAttenuation,skinning:a.skinning,maxBones:l,useVertexTexture:hc&&d&&d.useVertexTexture,boneTextureWidth:d&&d.boneTextureWidth,
...
THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,v,d=[];n?d.push(n):(d.push(s),d.push(r));for(u in p)d.push(u),d.push(p[u]);for(t in c)d.push(t),d.push(c[t]);n=d.join();t=0;for(u=Q.length;t<u;t++)if(d=Q[t],d.code===n){d.usedTimes++;q=d.program;break a}t=[];for(v in p)u=p[v],!1!==u&&(u="#define "+v+" "+u,t.push(u));u=t.join("\n");v=k.createProgram();t=["precision "+N+" float;",u,ec?"#define VERTEX_TEXTURES":"",S.gammaInput?"#define GAMMA_INPUT":"",S.gammaOutput?"#define GAMMA_OUTPUT":"",S.physicallyBasedShading?
...
x);for(x=0;x<c.maxMorphNormals;x++)t.push("morphNormal"+x);for(q in b)t.push(q);q=t;x=0;for(b=q.length;x<b;x++)t=q[x],v.attributes[t]=k.getAttribLocation(v,t);v.id=ca++;Q.push({program:v,code:n,usedTimes:1});S.info.memory.programs=Q.length;q=v}a.program=q;q=a.program.attributes;0<=q.position&&k.enableVertexAttribArray(q.position);0<=q.color&&k.enableVertexAttribArray(q.color);0<=q.normal&&k.enableVertexAttribArray(q.normal);0<=q.tangent&&k.enableVertexAttribArray(q.tangent);0<=q.lineDistance&&k.enableVertexAttribArray(q.lineDistance);
...
k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.SRC_COLOR)):a===THREE.CustomBlending?k.enable(k.BLEND):(k.enable(k.BLEND),k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD),k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)),pa=a);if(a===THREE.CustomBlending){if(b!==Ba&&(k.blendEquation(H(b)),Ba=b),c!==db||d!==qb)k.blendFunc(H(c),H(d)),db=c,qb=d}else qb=db=Ba=null};this.setTexture=
function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.__webglTexture=k.createTexture(),S.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=H(a.format),f=H(a.type);L(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var f=a.mipmaps,g=0,h=f.length;g<
...
k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0),B(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=la,a=fb,d=va,e=kb);b!==aa&&(k.bindFramebuffer(k.FRAMEBUFFER,
...
e=1):(j=j.clone(),j.lerpSelf(m,0.5),x.a=f,x.b=g,x.c=i,q.a=i,q.b=g,q.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[2],0.5),x.vertexNormals[2].copy(f),q.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[2],0.5),x.vertexColors[2].copy(f),q.vertexColors[0].copy(f)),e=2);F.push(x,q);a.vertices.push(j);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],q=j[0],h=
j[1],x=j[2],0===e?(l=q.clone(),l.lerpSelf(h,0.5),j=[q.clone(),l.clone(),x.clone()],h=[l.clone(),h.clone(),x.clone()]):1===e?(l=h.clone(),l.lerpSelf(x,0.5),j=[q.clone(),h.clone(),l.clone()],h=[l.clone(),x.clone(),q.clone()]):(l=q.clone(),l.lerpSelf(x,0.5),j=[q.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),x.clone()]),A[f].push(j,h))}else{F.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,j=a.vertices[f],l=a.vertices[g],m=a.vertices[h],
...
f.lerpSelf(e.vertexNormals[2],0.5),g=e.vertexNormals[3].clone(),g.lerpSelf(e.vertexNormals[0],0.5),x.vertexNormals[2].copy(f),x.vertexNormals[3].copy(g),q.vertexNormals[0].copy(g),q.vertexNormals[1].copy(f)),4===e.vertexColors.length&&(f=e.vertexColors[1].clone(),f.lerpSelf(e.vertexColors[2],0.5),g=e.vertexColors[3].clone(),g.lerpSelf(e.vertexColors[0],0.5),x.vertexColors[2].copy(f),x.vertexColors[3].copy(g),q.vertexColors[0].copy(g),q.vertexColors[1].copy(f)),e=1);F.push(x,q);a.vertices.push(p,l);
f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],q=j[0],h=j[1],x=j[2],j=j[3],0===e?(l=q.clone(),l.lerpSelf(h,0.5),m=x.clone(),m.lerpSelf(j,0.5),q=[q.clone(),l.clone(),m.clone(),j.clone()],h=[l.clone(),h.clone(),x.clone(),m.clone()]):(l=h.clone(),l.lerpSelf(x,0.5),m=j.clone(),m.lerpSelf(q,0.5),q=[q.clone(),h.clone(),l.clone(),m.clone()],h=[m.clone(),l.clone(),x.clone(),j.clone()]),A[f].push(q,h))}else{F.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)A[f].push(a.faceVertexUvs[f][c])}a.faces=
F;a.faceVertexUvs=A}};THREE.GeometryUtils.random=THREE.Math.random16;THREE.GeometryUtils.__v1=new THREE.Vector3;
...
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],g=[],h=[],i,j,l;if(0<b(a))for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var m=2*e;for(j=e-1;2<e;){if(0>=m--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);l=j+1;e<=l&&(l=0);var n;a:{n=a;var p=i,o=j,s=l,t=e,r=g,z=void 0,x=void 0,q=void 0,F=void 0,A=void 0,
v=void 0,u=void 0,D=void 0,C=void 0,x=n[r[p]].x,q=n[r[p]].y,F=n[r[o]].x,A=n[r[o]].y,v=n[r[s]].x,u=n[r[s]].y;if(1E-10>(F-x)*(u-q)-(A-q)*(v-x))n=!1;else{for(z=0;z<t;z++)if(!(z==p||z==o||z==s)){var D=n[r[z]].x,C=n[r[z]].y,G=void 0,L=void 0,B=void 0,K=void 0,H=void 0,I=void 0,O=void 0,N=void 0,P=void 0,Y=void 0,M=void 0,J=void 0,G=B=H=void 0,G=v-F,L=u-A,B=x-v,K=q-u,H=F-x,I=A-q,O=D-x,N=C-q,P=D-F,Y=C-A,M=D-v,J=C-u,G=G*Y-L*P,H=H*N-I*O,B=B*J-K*M;if(0<=G&&0<=B&&0<=H){n=!1;break a}}n=!0}}if(n){f.push([a[g[i]],
...
THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,s){var t,r=h.widthSegments,z=h.heightSegments,x=e/2,q=f/2,F=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)t="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)t="y",z=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)t="x",r=h.depthSegments;var A=r+1,v=z+1,u=e/r,D=f/z,C=new THREE.Vector3;C[t]=0<g?1:-1;for(e=0;e<v;e++)for(f=0;f<A;f++){var G=new THREE.Vector3;G[a]=(f*u-x)*c;G[b]=(e*D-q)*d;G[t]=g;h.vertices.push(G)}for(e=
0;e<z;e++)for(f=0;f<r;f++)a=new THREE.Face4(f+A*e+F,f+A*(e+1)+F,f+1+A*(e+1)+F,f+1+A*e+F),a.normal.copy(C),a.vertexNormals.push(C.clone(),C.clone(),C.clone(),C.clone()),a.materialIndex=s,h.faces.push(a),h.faceVertexUvs[0].push([new THREE.UV(f/r,1-e/z),new THREE.UV(f/r,1-(e+1)/z),new THREE.UV((f+1)/r,1-(e+1)/z),new THREE.UV((f+1)/r,1-e/z)])}THREE.Geometry.call(this);var h=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;a=this.width/
...
1]].clone()):(m=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var p=j[i][h],o=j[i+1][h],s=j[i+1][h+1],t=j[i][h+1],r=m.clone(),z=m.clone(),x=n.clone(),q=n.clone(),F=l[i][h].clone(),A=l[i+1][h].clone(),v=l[i+1][h+1].clone(),u=l[i][h+1].clone();this.faces.push(new THREE.Face4(p,o,s,t,[r,z,x,q]));this.faceVertexUvs[0].push([F,A,v,u])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
g,0));for(h=0;h<d;h++)p=j[0][h],o=j[0][h+1],s=this.vertices.length-1,r=new THREE.Vector3(0,1,0),z=new THREE.Vector3(0,1,0),x=new THREE.Vector3(0,1,0),F=l[0][h].clone(),A=l[0][h+1].clone(),v=new THREE.UV(A.u,0),this.faces.push(new THREE.Face3(p,o,s,[r,z,x])),this.faceVertexUvs[0].push([F,A,v])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)p=j[i][h+1],o=j[i][h],s=this.vertices.length-1,r=new THREE.Vector3(0,-1,0),z=new THREE.Vector3(0,-1,0),x=new THREE.Vector3(0,-1,0),F=
l[i][h+1].clone(),A=l[i][h].clone(),v=new THREE.UV(A.u,1),this.faces.push(new THREE.Face3(p,o,s,[r,z,x])),this.faceVertexUvs[0].push([F,A,v])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};
...
b.amount?b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,l=void 0!==b.bevelSegments?b.bevelSegments:3,m=void 0!==b.bevelEnabled?b.bevelEnabled:!0,n=void 0!==b.steps?b.steps:1,p=b.extrudePath,o,s=!1,t=b.material,r=b.extrudeMaterial,z=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,x,q,F,A;p&&(o=p.getSpacedPoints(n),s=!0,m=!1,x=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(p,n,!1),q=new THREE.Vector3,F=new THREE.Vector3,
A=new THREE.Vector3);m||(j=i=l=0);var v,u,D,C=this,G=this.vertices.length,p=a.extractPoints(),L=p.shape,p=p.holes,B=!THREE.Shape.Utils.isClockWise(L);if(B){L=L.reverse();u=0;for(D=p.length;u<D;u++)v=p[u],THREE.Shape.Utils.isClockWise(v)&&(p[u]=v.reverse());B=!1}var K=THREE.Shape.Utils.triangulateShape(L,p),B=L;u=0;for(D=p.length;u<D;u++)v=p[u],L=L.concat(v);var H,I,O,N,P=L.length,Y=K.length,M=[],J=0,T=B.length;H=T-1;for(I=J+1;J<T;J++,H++,I++)H===T&&(H=0),I===T&&(I=0),M[J]=d(B[J],B[H],B[I]);var $=
[],da,S=M.concat();u=0;for(D=p.length;u<D;u++){v=p[u];da=[];J=0;T=v.length;H=T-1;for(I=J+1;J<T;J++,H++,I++)H===T&&(H=0),I===T&&(I=0),da[J]=d(v[J],v[H],v[I]);$.push(da);S=S.concat(da)}for(H=0;H<l;H++){v=H/l;O=i*(1-v);I=j*Math.sin(v*Math.PI/2);J=0;for(T=B.length;J<T;J++)N=c(B[J],M[J],I),f(N.x,N.y,-O);u=0;for(D=p.length;u<D;u++){v=p[u];da=$[u];J=0;for(T=v.length;J<T;J++)N=c(v[J],da[J],I),f(N.x,N.y,-O)}}I=j;for(J=0;J<P;J++)N=m?c(L[J],S[J],I):L[J],s?(F.copy(x.normals[0]).multiplyScalar(N.x),q.copy(x.binormals[0]).multiplyScalar(N.y),
A.copy(o[0]).addSelf(F).addSelf(q),f(A.x,A.y,A.z)):f(N.x,N.y,0);for(v=1;v<=n;v++)for(J=0;J<P;J++)N=m?c(L[J],S[J],I):L[J],s?(F.copy(x.normals[v]).multiplyScalar(N.x),q.copy(x.binormals[v]).multiplyScalar(N.y),A.copy(o[v]).addSelf(F).addSelf(q),f(A.x,A.y,A.z)):f(N.x,N.y,h/n*v);for(H=l-1;0<=H;H--){v=H/l;O=i*(1-v);I=j*Math.sin(v*Math.PI/2);J=0;for(T=B.length;J<T;J++)N=c(B[J],M[J],I),f(N.x,N.y,h+O);u=0;for(D=p.length;u<D;u++){v=p[u];da=$[u];J=0;for(T=v.length;J<T;J++)N=c(v[J],da[J],I),s?f(N.x,N.y+o[n-
1].y,o[n-1].x+O):f(N.x,N.y,h+O)}}if(m){i=0*P;for(J=0;J<Y;J++)h=K[J],g(h[2]+i,h[1]+i,h[0]+i,!0);i=P*(n+2*l);for(J=0;J<Y;J++)h=K[J],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(J=0;J<Y;J++)h=K[J],g(h[2],h[1],h[0],!0);for(J=0;J<Y;J++)h=K[J],g(h[0]+P*n,h[1]+P*n,h[2]+P*n,!1)}h=0;e(B,h);h+=B.length;u=0;for(D=p.length;u<D;u++)v=p[u],e(v,h),h+=v.length};
...
i=[],j=[],l=this,m=THREE.GeometryUtils.orderedKey,n=THREE.GeometryUtils.computeEdgeFaces,p=a.vertices,o=a.faces,s=p.length,h=p.concat(),t=[],r={},z={},x={},q,F,A,v,u,D=a.faceVertexUvs[0],C;c("originalFaces, uvs, originalVerticesLength",o.length,D.length,s);if(l.supportUVs){q=0;for(F=D.length;q<F;q++){A=0;for(v=D[q].length;A<v;A++)C=o[q]["abcd".charAt(A)],g(C,q,D[q][A])}}0==D.length&&(l.supportUVs=!1);q=0;for(var G in x)q++;q||(l.supportUVs=!1,c("no uvs"));q=0;for(F=o.length;q<F;q++)u=o[q],t.push(u.centroid),
h.push(u.centroid),l.supportUVs&&(v=new THREE.UV,u instanceof THREE.Face3?(v.u=f(u.a,q).u+f(u.b,q).u+f(u.c,q).u,v.v=f(u.a,q).v+f(u.b,q).v+f(u.c,q).v,v.u/=3,v.v/=3):u instanceof THREE.Face4&&(v.u=f(u.a,q).u+f(u.b,q).u+f(u.c,q).u+f(u.d,q).u,v.v=f(u.a,q).v+f(u.b,q).v+f(u.c,q).v+f(u.d,q).v,v.u/=4,v.v/=4),g(s+q,"",v));var n=n(a),L;F=0;var B,K;G={};D={};for(q in n){C=n[q];B=q.split("_");K=B[0];B=B[1];A=K;u=[K,B];void 0===G[A]&&(G[A]=[]);G[A].push(u);A=B;u=[K,B];void 0===G[A]&&(G[A]=[]);G[A].push(u);A=0;
for(v=C.length;A<v;A++){u=C[A];L=K;var H=u,I=q;void 0===D[L]&&(D[L]={});D[L][H]=I;L=B;H=q;void 0===D[L]&&(D[L]={});D[L][u]=H}2>C.length&&(z[q]=!0)}for(q in n)if(C=n[q],u=C[0],L=C[1],B=q.split("_"),K=B[0],B=B[1],v=new THREE.Vector3,b(0<C.length,"an edge without faces?!"),1==C.length?(v.addSelf(p[K]),v.addSelf(p[B]),v.multiplyScalar(0.5)):(v.addSelf(t[u]),v.addSelf(t[L]),v.addSelf(p[K]),v.addSelf(p[B]),v.multiplyScalar(0.25)),r[q]=s+o.length+F,h.push(v),F++,l.supportUVs)v=new THREE.UV,v.u=f(K,u).u+
f(B,u).u,v.v=f(K,u).v+f(B,u).v,v.u/=2,v.v/=2,g(r[q],u,v),2<=C.length&&(b(2==C.length,"did we plan for more than 2 edges?"),v=new THREE.UV,v.u=f(K,L).u+f(B,L).u,v.v=f(K,L).v+f(B,L).v,v.u/=2,v.v/=2,g(r[q],L,v));c("-- Step 2 done");var O,N;v=["123","12","2","23"];L=["123","23","3","31"];var H=["123","31","1","12"],I=["1234","12","2","23"],P=["1234","23","3","34"],Y=["1234","34","4","41"],M=["1234","41","1","12"];q=0;for(F=t.length;q<F;q++)u=o[q],C=s+q,u instanceof THREE.Face3?(K=m(u.a,u.b),B=m(u.b,u.c),
O=m(u.c,u.a),e(C,r[K],u.b,r[B],u,v,q),e(C,r[B],u.c,r[O],u,L,q),e(C,r[O],u.a,r[K],u,H,q)):u instanceof THREE.Face4?(K=m(u.a,u.b),B=m(u.b,u.c),O=m(u.c,u.d),N=m(u.d,u.a),e(C,r[K],u.b,r[B],u,I,q),e(C,r[B],u.c,r[O],u,P,q),e(C,r[O],u.d,r[N],u,Y,q),e(C,r[N],u.a,r[K],u,M,q)):c("face should be a face!",u);r=new THREE.Vector3;u=new THREE.Vector3;q=0;for(F=p.length;q<F;q++)if(void 0!==G[q]){r.set(0,0,0);u.set(0,0,0);B=new THREE.Vector3(0,0,0);C=0;for(A in D[q])r.addSelf(t[A]),C++;L=0;K=G[q].length;v=C!=K;for(A=
0;A<K;A++)z[m(G[q][A][0],G[q][A][1])]&&L++;r.divideScalar(C);L=0;if(v){for(A=0;A<K;A++)if(C=G[q][A],H=1==n[m(C[0],C[1])].length)C=p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2),u.addSelf(C),L++;u.divideScalar(4);b(2==L,"should have only 2 boundary edges")}else{for(A=0;A<K;A++)C=G[q][A],C=p[C[0]].clone().addSelf(p[C[1]]).divideScalar(2),u.addSelf(C);u.divideScalar(K)}B.addSelf(p[q]);v?(B.divideScalar(2),B.addSelf(u)):(B.multiplyScalar(K-3),B.addSelf(r),B.addSelf(u.multiplyScalar(2)),B.divideScalar(K));
...
h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);H.positionScreen.copy(D);H.customUpdateCallback?H.customUpdateCallback(H):H.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);B=0;for(K=H.lensFlares.length;B<K;B++)I=H.lensFlares[B],0.0010<I.opacity&&0.0010<I.scale&&(D.x=I.x,D.y=I.y,D.z=I.z,v=I.size*I.scale/r,u.x=v*q,u.y=v,b.uniform3f(G.screenPosition,D.x,D.y,D.z),b.uniform2f(G.scale,u.x,u.y),b.uniform1f(G.rotation,I.rotation),b.uniform1f(G.opacity,I.opacity),b.uniform3f(G.color,I.color.r,
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,m){var n,p,o,s,t,r,z,x,q,F=[];s=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
...
A.shadowCameraBottom=q.shadowCameraBottom;A.shadowCameraTop=q.shadowCameraTop;A.shadowCameraVisible=q.shadowCameraVisible;A.shadowDarkness=q.shadowDarkness;A.shadowBias=q.shadowCascadeBias[z];A.shadowMapWidth=q.shadowCascadeWidth[z];A.shadowMapHeight=q.shadowCascadeHeight[z];A.pointsWorld=[];A.pointsFrustum=[];x=A.pointsWorld;r=A.pointsFrustum;for(var v=0;8>v;v++)x[v]=new THREE.Vector3,r[v]=new THREE.Vector3;x=q.shadowCascadeNearZ[z];q=q.shadowCascadeFarZ[z];r[0].set(-1,-1,x);r[1].set(1,-1,x);r[2].set(-1,
...
z=z.shadowCascadeFarZ[x];q=q.pointsFrustum;q[0].z=r;q[1].z=r;q[2].z=r;q[3].z=r;q[4].z=z;q[5].z=z;q[6].z=z;q[7].z=z;F[s]=A;s++}else F[s]=o,s++;n=0;for(p=F.length;n<p;n++){o=F[n];o.shadowMap||(o.shadowMap=new THREE.WebGLRenderTarget(o.shadowMapWidth,o.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat}),o.shadowMapSize=new THREE.Vector2(o.shadowMapWidth,o.shadowMapHeight),o.shadowMatrix=new THREE.Matrix4);if(!o.shadowCamera){if(o instanceof THREE.SpotLight)o.shadowCamera=
...
!r.frustumCulled||g.contains(r)))r._modelViewMatrix.multiply(t.matrixWorldInverse,r.matrixWorld),z.render=!0;o=0;for(s=q.length;o<s;o++)z=q[o],z.render&&(r=z.object,z=z.buffer,v=r.material instanceof THREE.MeshFaceMaterial?r.material.materials[0]:r.material,x=0<r.geometry.morphTargets.length&&v.morphTargets,v=r instanceof THREE.SkinnedMesh&&v.skinning,x=r.customDepthMaterial?r.customDepthMaterial:v?x?f:e:x?d:c,z instanceof THREE.BufferGeometry?b.renderBufferDirect(t,l.__lights,null,x,z,r):b.renderBuffer(t,
...
(b.uniform1i(z.useScreenCoordinates,1),b.uniform3f(z.screenPosition,(u.position.x-p)/p,(q-u.position.y)/q,Math.max(0,Math.min(1,u.position.z)))):(b.uniform1i(z.useScreenCoordinates,0),b.uniform1i(z.affectedByDistance,u.affectedByDistance?1:0),b.uniformMatrix4fv(z.modelViewMatrix,!1,u._modelViewMatrix.elements)),e=d.fog&&u.fog?A:0,r!==e&&(b.uniform1i(z.fogType,e),r=e),e=1/(u.scaleByViewport?o:1),D[0]=e*x*u.scale.x,D[1]=e*u.scale.y,b.uniform2f(z.uvScale,u.uvScale.x,u.uvScale.y),b.uniform2f(z.uvOffset,
u.uvOffset.x,u.uvOffset.y),b.uniform2f(z.alignment,u.alignment.x,u.alignment.y),b.uniform1f(z.opacity,u.opacity),b.uniform3f(z.color,u.color.r,u.color.g,u.color.b),b.uniform1f(z.rotation,u.rotation),b.uniform2fv(z.scale,D),u.mergeWith3D&&!F?(b.enable(b.DEPTH_TEST),F=!0):!u.mergeWith3D&&F&&(b.disable(b.DEPTH_TEST),F=!1),c.setBlending(u.blending,u.blendEquation,u.blendSrc,u.blendDst),c.setTexture(u.map,0),b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);
b.depthMask(!0)}}};
