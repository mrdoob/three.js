...
THREE.Vector3.prototype={constructor:THREE.Vector3,set:function(a,b,c){this.x=a;this.y=b;this.z=c;return this},setX:function(a){this.x=a;return this},setY:function(a){this.y=a;return this},setZ:function(a){this.z=a;return this},setScalar:function(a){this.z=this.y=this.x=a;return this},copy:function(a){this.x=a.x;this.y=a.y;this.z=a.z;return this},add:function(a,b){this.x=a.x+b.x;this.y=a.y+b.y;this.z=a.z+b.z;return this},addSelf:function(a){this.x+=a.x;this.y+=a.y;this.z+=a.z;return this},addScalar:function(a){this.x+=
...
(this.x/=a,this.y/=a,this.z/=a):this.z=this.y=this.x=0;return this},negate:function(){return this.multiplyScalar(-1)},dot:function(a){return this.x*a.x+this.y*a.y+this.z*a.z},lengthSq:function(){return this.x*this.x+this.y*this.y+this.z*this.z},length:function(){return Math.sqrt(this.lengthSq())},lengthManhattan:function(){return Math.abs(this.x)+Math.abs(this.y)+Math.abs(this.z)},normalize:function(){return this.divideScalar(this.length())},setLength:function(a){return this.normalize().multiplyScalar(a)},
lerpSelf:function(a,b){this.x+=(a.x-this.x)*b;this.y+=(a.y-this.y)*b;this.z+=(a.z-this.z)*b;return this},cross:function(a,b){this.x=a.y*b.z-a.z*b.y;this.y=a.z*b.x-a.x*b.z;this.z=a.x*b.y-a.y*b.x;return this},crossSelf:function(a){var b=this.x,c=this.y,d=this.z;this.x=c*a.z-d*a.y;this.y=d*a.x-b*a.z;this.z=b*a.y-c*a.x;return this},distanceTo:function(a){return Math.sqrt(this.distanceToSquared(a))},distanceToSquared:function(a){return(new THREE.Vector3).sub(this,a).lengthSq()},getPositionFromMatrix:function(a){this.x=
a.elements[12];this.y=a.elements[13];this.z=a.elements[14];return this},setEulerFromRotationMatrix:function(a,b){function c(a){return Math.min(Math.max(a,-1),1)}var d=a.elements,f=d[0],e=d[4],g=d[8],h=d[1],i=d[5],j=d[9],l=d[2],n=d[6],d=d[10];void 0===b||"XYZ"===b?(this.y=Math.asin(c(g)),0.99999>Math.abs(g)?(this.x=Math.atan2(-j,d),this.z=Math.atan2(-e,f)):(this.x=Math.atan2(n,i),this.z=0)):"YXZ"===b?(this.x=Math.asin(-c(j)),0.99999>Math.abs(j)?(this.y=Math.atan2(g,d),this.z=Math.atan2(h,i)):(this.y=
Math.atan2(-l,f),this.z=0)):"ZXY"===b?(this.x=Math.asin(c(n)),0.99999>Math.abs(n)?(this.y=Math.atan2(-l,d),this.z=Math.atan2(-e,i)):(this.y=0,this.z=Math.atan2(h,f))):"ZYX"===b?(this.y=Math.asin(-c(l)),0.99999>Math.abs(l)?(this.x=Math.atan2(n,d),this.z=Math.atan2(h,f)):(this.x=0,this.z=Math.atan2(-e,i))):"YZX"===b?(this.z=Math.asin(c(h)),0.99999>Math.abs(h)?(this.x=Math.atan2(-j,i),this.y=Math.atan2(-l,f)):(this.x=0,this.y=Math.atan2(g,d))):"XZY"===b&&(this.z=Math.asin(-c(e)),0.99999>Math.abs(e)?
(this.x=Math.atan2(n,i),this.y=Math.atan2(g,f)):(this.x=Math.atan2(-j,d),this.y=0));return this},setEulerFromQuaternion:function(a,b){function c(a){return Math.min(Math.max(a,-1),1)}var d=a.x*a.x,f=a.y*a.y,e=a.z*a.z,g=a.w*a.w;void 0===b||"XYZ"===b?(this.x=Math.atan2(2*(a.x*a.w-a.y*a.z),g-d-f+e),this.y=Math.asin(c(2*(a.x*a.z+a.y*a.w))),this.z=Math.atan2(2*(a.z*a.w-a.x*a.y),g+d-f-e)):"YXZ"===b?(this.x=Math.asin(c(2*(a.x*a.w-a.y*a.z))),this.y=Math.atan2(2*(a.x*a.z+a.y*a.w),g-d-f+e),this.z=Math.atan2(2*
(a.x*a.y+a.z*a.w),g-d+f-e)):"ZXY"===b?(this.x=Math.asin(c(2*(a.x*a.w+a.y*a.z))),this.y=Math.atan2(2*(a.y*a.w-a.z*a.x),g-d-f+e),this.z=Math.atan2(2*(a.z*a.w-a.x*a.y),g-d+f-e)):"ZYX"===b?(this.x=Math.atan2(2*(a.x*a.w+a.z*a.y),g-d-f+e),this.y=Math.asin(c(2*(a.y*a.w-a.x*a.z))),this.z=Math.atan2(2*(a.x*a.y+a.z*a.w),g+d-f-e)):"YZX"===b?(this.x=Math.atan2(2*(a.x*a.w-a.z*a.y),g-d+f-e),this.y=Math.atan2(2*(a.y*a.w-a.x*a.z),g+d-f-e),this.z=Math.asin(c(2*(a.x*a.y+a.z*a.w)))):"XZY"===b&&(this.x=Math.atan2(2*
(a.x*a.w+a.y*a.z),g-d+f-e),this.y=Math.atan2(2*(a.x*a.z+a.y*a.w),g+d-f-e),this.z=Math.asin(c(2*(a.z*a.w-a.x*a.y))));return this},getScaleFromMatrix:function(a){var b=this.set(a.elements[0],a.elements[1],a.elements[2]).length(),c=this.set(a.elements[4],a.elements[5],a.elements[6]).length(),a=this.set(a.elements[8],a.elements[9],a.elements[10]).length();this.x=b;this.y=c;this.z=a;return this},equals:function(a){return a.x===this.x&&a.y===this.y&&a.z===this.z},isZero:function(a){return this.lengthSq()<
(void 0!==a?a:1E-4)},clone:function(){return new THREE.Vector3(this.x,this.y,this.z)}};THREE.Vector4=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=void 0!==d?d:1};
...
g=Math.sqrt(d*d+f*f+e*e),d=d/g,f=f/g,e=e/g,g=d*d,h=f*f,i=e*e,j=Math.cos(b),l=Math.sin(b),n=1-j,m=d*f*n,q=d*e*n,n=f*e*n,d=d*l,o=f*l,l=e*l,e=g+(1-g)*j,g=m+l,f=q-o,m=m-l,h=h+(1-h)*j,l=n+d,q=q+o,n=n-d,i=i+(1-i)*j,j=c[0],d=c[1],o=c[2],p=c[3],r=c[4],t=c[5],u=c[6],v=c[7],s=c[8],z=c[9],w=c[10],A=c[11];c[0]=e*j+g*r+f*s;c[1]=e*d+g*t+f*z;c[2]=e*o+g*u+f*w;c[3]=e*p+g*v+f*A;c[4]=m*j+h*r+l*s;c[5]=m*d+h*t+l*z;c[6]=m*o+h*u+l*w;c[7]=m*p+h*v+l*A;c[8]=q*j+n*r+i*s;c[9]=q*d+n*t+i*z;c[10]=q*o+n*u+i*w;c[11]=q*p+n*v+i*A;
...
THREE.Frustum.prototype.setFromMatrix=function(a){var b=this.planes,c=a.elements,a=c[0],d=c[1],f=c[2],e=c[3],g=c[4],h=c[5],i=c[6],j=c[7],l=c[8],n=c[9],m=c[10],q=c[11],o=c[12],p=c[13],r=c[14],c=c[15];b[0].set(e-a,j-g,q-l,c-o);b[1].set(e+a,j+g,q+l,c+o);b[2].set(e+d,j+h,q+n,c+p);b[3].set(e-d,j-h,q-n,c-p);b[4].set(e-f,j-i,q-m,c-r);b[5].set(e+f,j+i,q+m,c+r);for(d=0;6>d;d++)a=b[d],a.divideScalar(Math.sqrt(a.x*a.x+a.y*a.y+a.z*a.z))};
THREE.Frustum.prototype.contains=function(a){for(var b=0,c=this.planes,d=-a.getBoundRadius(),a=a.getCentroid(),f=0;6>f;f++)if(b=c[f].x*a.x+c[f].y*a.y+c[f].z*a.z+c[f].w,b<=d)return!1;return!0};THREE.Frustum.__v1=new THREE.Vector3;
...
b);var a=j.dot(j),b=j.dot(l),c=j.dot(n),f=l.dot(l),d=l.dot(n),e=1/(a*f-b*b),f=(f*c-b*d)*e,a=(a*d-b*c)*e;return 0<=f&&0<=a&&1>f+a},o=function(i,j,l){var n,p;if(i instanceof a.Particle){n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>i.scale.x)return l;p={distance:n,point:i.position,face:null,object:i};l.push(p)}else if(i instanceof a.Mesh){var o=i.getBoundRadius();n=m(j.origin,j.direction,i.getCentroid());if(n>o)return l;var w,A,I=i.geometry,D=I.vertices,F,B,E;F=i.geometry.materials;B=i.material instanceof
a.MeshFaceMaterial;var H,Q=j.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(j.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(j.direction);h.rotateAxis(d).normalize();o=0;for(w=I.faces.length;o<w;o++)if(p=I.faces[o],n=!0===B?F[p.materialIndex]:i.material,void 0!==n&&(E=n.side,f.sub(p.centroid,c),e=p.normal,n=d.dot(e),!(Math.abs(n)<Q)&&(A=e.dot(f)/n,!(0>A)&&(E===a.DoubleSide||(E===a.FrontSide?0>n:0<n)))))if(g.add(c,d.multiplyScalar(A)),p instanceof a.Face3)n=
D[p.a],A=D[p.b],E=D[p.c],q(g,n,A,E)&&(A=i.matrixWorld.multiplyVector3(g.clone()),n=b.distanceTo(A),n<j.near||n>j.far||(p={distance:n,point:A,face:p,faceIndex:o,object:i},l.push(p)));else if(p instanceof a.Face4&&(n=D[p.a],A=D[p.b],E=D[p.c],H=D[p.d],q(g,n,A,H)||q(g,A,E,H)))A=i.matrixWorld.multiplyVector3(g.clone()),n=b.distanceTo(A),n<j.near||n>j.far||(p={distance:n,point:A,face:p,faceIndex:o,object:i},l.push(p))}},p=function(a,b,c){for(var a=a.getDescendants(),d=0,f=a.length;d<f;d++)o(a[d],b,c)};
a.Ray.prototype.precision=1E-4;a.Ray.prototype.set=function(a,b){this.origin=a;this.direction=b};a.Ray.prototype.intersectObject=function(a,b){var c=[];!0===b&&p(a,this,c);o(a,this,c);c.sort(i);return c};a.Ray.prototype.intersectObjects=function(a,b){for(var c=[],d=0,f=a.length;d<f;d++)o(a[d],this,c),!0===b&&p(a[d],this,c);c.sort(i);return c}})(THREE);
...
g?f:g);a()};this.add3Points=function(e,g,l,n,m,q){!0===h?(h=!1,b=e<l?e<m?e:m:l<m?l:m,c=g<n?g<q?g:q:n<q?n:q,d=e>l?e>m?e:m:l>m?l:m,f=g>n?g>q?g:q:n>q?n:q):(b=e<l?e<m?e<b?e:b:m<b?m:b:l<m?l<b?l:b:m<b?m:b,c=g<n?g<q?g<c?g:c:q<c?q:c:n<q?n<c?n:c:q<c?q:c,d=e>l?e>m?e>d?e:d:m>d?m:d:l>m?l>d?l:d:m>d?m:d,f=g>n?g>q?g>f?g:f:q>f?q:f:n>q?n>f?n:f:q>f?q:f);a()};this.addRectangle=function(e){!0===h?(h=!1,b=e.getLeft(),c=e.getTop(),d=e.getRight(),f=e.getBottom()):(b=b<e.getLeft()?b:e.getLeft(),c=c<e.getTop()?c:e.getTop(),
...
THREE.Object3D=function(){this.id=THREE.Object3DCount++;this.name="";this.properties={};this.parent=void 0;this.children=[];this.up=new THREE.Vector3(0,1,0);this.position=new THREE.Vector3;this.rotation=new THREE.Vector3;this.eulerOrder=THREE.Object3D.defaultEulerOrder;this.scale=new THREE.Vector3(1,1,1);this.renderDepth=null;this.rotationAutoUpdate=!0;this.matrix=new THREE.Matrix4;this.matrixWorld=new THREE.Matrix4;this.matrixRotationWorld=new THREE.Matrix4;this.matrixWorldNeedsUpdate=this.matrixAutoUpdate=
!0;this.quaternion=new THREE.Quaternion;this.useQuaternion=!1;this.boundCenter=null;this.boundRadius=0;this.boundRadiusScaleWorld=this.boundRadiusScale=1;this.visible=!0;this.receiveShadow=this.castShadow=!1;this.frustumCulled=!0;this._vector=new THREE.Vector3};
...
if(1!==this.scale.x||1!==this.scale.y||1!==this.scale.z)this.matrix.scale(this.scale),this.boundRadiusScale=Math.max(this.scale.x,Math.max(this.scale.y,this.scale.z));this.matrixWorldNeedsUpdate=!0},updateMatrixWorld:function(a){!0===this.matrixAutoUpdate&&this.updateMatrix();if(!0===this.matrixWorldNeedsUpdate||!0===a)void 0===this.parent?(this.matrixWorld.copy(this.matrix),this.boundRadiusScaleWorld=this.boundRadiusScale):(this.matrixWorld.multiply(this.parent.matrixWorld,this.matrix),this.boundRadiusScaleWorld=
this.parent.boundRadiusScaleWorld*this.boundRadiusScale),this.matrixWorldNeedsUpdate=!1,a=!0;for(var b=0,c=this.children.length;b<c;b++)this.children[b].updateMatrixWorld(a)},getCentroid:function(){this.matrixWorldNeedsUpdate&&this.updateMatrixWorld(!1);if(!this.boundCenter)return this.matrixWorld.getPosition();void 0===this.__offset?this.__offset=this.boundCenter.clone():this.__offset.copy(this.boundCenter);return this.matrixWorld.multiplyVector3(this.__offset)},getBoundRadius:function(){this.matrixWorldNeedsUpdate&&
this.updateMatrixWorld(!1);return this.boundRadius*this.boundRadiusScaleWorld},clone:function(a){void 0===a&&(a=new THREE.Object3D);a.name=this.name;a.up.copy(this.up);a.position.copy(this.position);a.rotation instanceof THREE.Vector3&&a.rotation.copy(this.rotation);a.eulerOrder=this.eulerOrder;a.scale.copy(this.scale);a.renderDepth=this.renderDepth;a.rotationAutoUpdate=this.rotationAutoUpdate;a.matrix.copy(this.matrix);a.matrixWorld.copy(this.matrixWorld);a.matrixRotationWorld.copy(this.matrixRotationWorld);
...
c.z&&(c.z=a.z)}else this.boundingBox.min.set(0,0,0),this.boundingBox.max.set(0,0,0)},computeBoundingSphere:function(){null===this.boundingSphere&&(this.boundingSphere={radius:0,origin:null});if(0<this.vertices.length){var a=0,b=new THREE.Vector3(0,0,0),c,d=this.vertices.length;for(c=0;c<d;c++)b.addSelf(this.vertices[c]);b.divideScalar(d);var f,e,g,h=b.x,i=b.y,j=b.z;for(c=0;c<d;c++)f=this.vertices[c],e=f.x-h,g=f.y-i,f=f.z-j,e=e*e+g*g+f*f,e>a&&(a=e);this.boundingSphere.radius=Math.sqrt(a);this.boundingSphere.origin=
b}},mergeVertices:function(){var a={},b=[],c=[],d,f=Math.pow(10,4),e,g,h,i;e=0;for(g=this.vertices.length;e<g;e++)d=this.vertices[e],d=[Math.round(d.x*f),Math.round(d.y*f),Math.round(d.z*f)].join("_"),void 0===a[d]?(a[d]=e,b.push(this.vertices[e]),c[e]=b.length-1):c[e]=c[a[d]];e=0;for(g=this.faces.length;e<g;e++)if(a=this.faces[e],a instanceof THREE.Face3)a.a=c[a.a],a.b=c[a.b],a.c=c[a.c];else if(a instanceof THREE.Face4){a.a=c[a.a];a.b=c[a.b];a.c=c[a.c];a.d=c[a.d];d=[a.a,a.b,a.c,a.d];for(f=3;0<f;f--)if(d.indexOf(a["abcd"[f]])!==
f){d.splice(f,1);this.faces[e]=new THREE.Face3(d[0],d[1],d[2],a.normal,a.color,a.materialIndex);d=0;for(h=this.faceVertexUvs.length;d<h;d++)(i=this.faceVertexUvs[d][e])&&i.splice(f,1);this.faces[e].vertexColors=a.vertexColors;break}}c=this.vertices.length-b.length;this.vertices=b;return c},clone:function(){}};THREE.GeometryCount=0;
THREE.BufferGeometry=function(){this.id=THREE.GeometryCount++;this.attributes={};this.dynamic=!1;this.boundingSphere=this.boundingBox=null;this.hasTangents=!1;this.morphTargets=[]};
...
var a=this.attributes.position.array;if(0<a.length){var b,c=0,d,f,e=0,g=0,h=0,i,j=a.length;for(i=0;i<j;i+=3)e+=a[i+0],g+=a[i+1],h+=a[i+2];h=new THREE.Vector3(e,g,h);h.divideScalar(j);e=h.x;g=h.y;h=h.z;for(i=0;i<j;i+=3)b=a[i+0]-e,d=a[i+1]-g,f=a[i+2]-h,b=b*b+d*d+f*f,b>c&&(c=b);this.boundingSphere.origin=new THREE.Vector3(e,g,h);this.boundingSphere.radius=Math.sqrt(c)}},computeVertexNormals:function(){if(this.attributes.position&&this.attributes.index){var a,b,c,d;a=this.attributes.position.array.length;
if(void 0===this.attributes.normal)this.attributes.normal={itemSize:3,array:new Float32Array(a),numItems:a};else{a=0;for(b=this.attributes.normal.array.length;a<b;a++)this.attributes.normal.array[a]=0}var f=this.offsets,e=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,n,m,q,o=new THREE.Vector3,p=new THREE.Vector3,r=new THREE.Vector3,t=new THREE.Vector3,u=new THREE.Vector3;c=0;for(d=f.length;c<d;++c){b=f[c].start;i=f[c].count;var v=f[c].index;a=b;
for(b+=i;a<b;a+=3)i=v+e[a],j=v+e[a+1],l=v+e[a+2],n=g[3*i],m=g[3*i+1],q=g[3*i+2],o.set(n,m,q),n=g[3*j],m=g[3*j+1],q=g[3*j+2],p.set(n,m,q),n=g[3*l],m=g[3*l+1],q=g[3*l+2],r.set(n,m,q),t.sub(r,p),u.sub(o,p),t.crossSelf(u),h[3*i]+=t.x,h[3*i+1]+=t.y,h[3*i+2]+=t.z,h[3*j]+=t.x,h[3*j+1]+=t.y,h[3*j+2]+=t.z,h[3*l]+=t.x,h[3*l+1]+=t.y,h[3*l+2]+=t.z}a=0;for(b=h.length;a<b;a+=3)n=h[a],m=h[a+1],q=h[a+2],c=1/Math.sqrt(n*n+m*m+q*q),h[a]*=c,h[a+1]*=c,h[a+2]*=c;this.normalsNeedUpdate=!0}},computeTangents:function(){function a(a){Z.x=
d[3*a];Z.y=d[3*a+1];Z.z=d[3*a+2];ea.copy(Z);fa=i[a];M.copy(fa);M.subSelf(Z.multiplyScalar(Z.dot(fa))).normalize();T.cross(ea,fa);S=T.dot(j[a]);N=0>S?-1:1;h[4*a]=M.x;h[4*a+1]=M.y;h[4*a+2]=M.z;h[4*a+3]=N}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===this.attributes.uv)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,
d=this.attributes.normal.array,f=this.attributes.uv.array,e=c.length/3;if(void 0===this.attributes.tangent){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<e;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,n,m,q,o,p,r,t,u,v,s,z,w,A,I,e=new THREE.Vector3,g=new THREE.Vector3,D,F,B,E,H,Q,L,K=this.offsets;B=0;for(E=K.length;B<E;++B){F=K[B].start;H=K[B].count;var J=K[B].index;D=F;for(F+=H;D<F;D+=3)H=J+b[D],
Q=J+b[D+1],L=J+b[D+2],l=c[3*H],n=c[3*H+1],m=c[3*H+2],q=c[3*Q],o=c[3*Q+1],p=c[3*Q+2],r=c[3*L],t=c[3*L+1],u=c[3*L+2],v=f[2*H],s=f[2*H+1],z=f[2*Q],w=f[2*Q+1],A=f[2*L],I=f[2*L+1],q-=l,l=r-l,o-=n,n=t-n,p-=m,m=u-m,z-=v,v=A-v,w-=s,s=I-s,I=1/(z*s-v*w),e.set((s*q-w*l)*I,(s*o-w*n)*I,(s*p-w*m)*I),g.set((z*l-v*q)*I,(z*n-v*o)*I,(z*m-v*p)*I),i[H].addSelf(e),i[Q].addSelf(e),i[L].addSelf(e),j[H].addSelf(g),j[Q].addSelf(g),j[L].addSelf(g)}var M=new THREE.Vector3,T=new THREE.Vector3,Z=new THREE.Vector3,ea=new THREE.Vector3,
N,fa,S;B=0;for(E=K.length;B<E;++B){F=K[B].start;H=K[B].count;J=K[B].index;D=F;for(F+=H;D<F;D+=3)H=J+b[D],Q=J+b[D+1],L=J+b[D+2],a(H),a(Q),a(L)}this.tangentsNeedUpdate=this.hasTangents=!0}}};
...
mirror:THREE.MirroredRepeatWrapping},void 0!==e[j[0]]&&(a[f].wrapS=e[j[0]]),void 0!==e[j[1]]))a[f].wrapT=e[j[1]];r&&(a[f].anisotropy=r);if(!t){var s=a[f],a=new Image;a.onload=function(){if(!c(this.width)||!c(this.height)){var a=d(this.width),b=d(this.height);s.image.width=a;s.image.height=b;s.image.getContext("2d").drawImage(this,0,0,a,b)}else s.image=this;s.needsUpdate=true};a.crossOrigin=g.crossOrigin;a.src=u}}function e(a){return(255*a[0]<<16)+(255*a[1]<<8)+255*a[2]}var g=this,h="MeshLambertMaterial",
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,f=void 0!==a.scale?1/a.scale:1;this.initMaterials(d,a.materials,c);var e,g,h,i,j,l,n,m,q,o,p,r,t,u,v=a.faces;q=a.vertices;var s=a.normals,z=a.colors,w=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&w++;for(e=0;e<w;e++)d.faceUvs[e]=[],d.faceVertexUvs[e]=[];c=0;for(i=q.length;c<i;)j=new THREE.Vector3,j.x=q[c++]*f,j.y=q[c++]*f,j.z=q[c++]*f,d.vertices.push(j);c=0;for(i=v.length;c<i;){q=v[c++];j=q&1;h=q&2;e=q&4;g=q&8;n=q&16;
l=q&32;o=q&64;q&=128;j?(p=new THREE.Face4,p.a=v[c++],p.b=v[c++],p.c=v[c++],p.d=v[c++],j=4):(p=new THREE.Face3,p.a=v[c++],p.b=v[c++],p.c=v[c++],j=3);h&&(h=v[c++],p.materialIndex=h);h=d.faces.length;if(e)for(e=0;e<w;e++)r=a.uvs[e],m=v[c++],u=r[2*m],m=r[2*m+1],d.faceUvs[e][h]=new THREE.UV(u,m);if(g)for(e=0;e<w;e++){r=a.uvs[e];t=[];for(g=0;g<j;g++)m=v[c++],u=r[2*m],m=r[2*m+1],t[g]=new THREE.UV(u,m);d.faceVertexUvs[e][h]=t}n&&(n=3*v[c++],g=new THREE.Vector3,g.x=s[n++],g.y=s[n++],g.z=s[n],p.normal=g);if(l)for(e=
0;e<j;e++)n=3*v[c++],g=new THREE.Vector3,g.x=s[n++],g.y=s[n++],g.z=s[n],p.vertexNormals.push(g);o&&(l=v[c++],l=new THREE.Color(z[l]),p.color=l);if(q)for(e=0;e<j;e++)l=v[c++],l=new THREE.Color(z[l]),p.vertexColors.push(l);d.faces.push(p)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c+=2)v=a.skinWeights[c],s=a.skinWeights[c+1],d.skinWeights.push(new THREE.Vector4(v,s,0,0))}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c+=2)v=a.skinIndices[c],s=a.skinIndices[c+1],d.skinIndices.push(new THREE.Vector4(v,
s,0,0))}d.bones=a.bones;d.animation=a.animation;if(void 0!==a.morphTargets){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];z=d.morphTargets[c].vertices;w=a.morphTargets[c].vertices;v=0;for(s=w.length;v<s;v+=3)q=new THREE.Vector3,q.x=w[v]*f,q.y=w[v+1]*f,q.z=w[v+2]*f,z.push(q)}}if(void 0!==a.morphColors){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=
[];s=d.morphColors[c].colors;z=a.morphColors[c].colors;f=0;for(v=z.length;f<v;f+=3)w=new THREE.Color(16755200),w.setRGB(z[f],z[f+1],z[f+2]),s.push(w)}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};THREE.LoadingMonitor=function(){THREE.EventTarget.call(this);var a=this,b=0,c=0,d=function(){b++;a.dispatchEvent({type:"progress",loaded:b,total:c});b===c&&a.dispatchEvent({type:"load"})};this.add=function(a){c++;a.addEventListener("load",d,!1)}};
...
b;l.image.height=c;l.image.getContext("2d").drawImage(a,0,0,b,c)}else l.image=a;l.needsUpdate=!0});a.crossOrigin=c.crossOrigin;a.load(c.path+"/"+f);b&&b.add(a)},l=function(a){return(255*a[0]<<16)+(255*a[1]<<8)+255*a[2]},n="MeshLambertMaterial",m={color:15658734,opacity:1,map:null,lightMap:null,normalMap:null,bumpMap:null,wireframe:!1};if(g.shading){var q=g.shading.toLowerCase();"phong"===q?n="MeshPhongMaterial":"basic"===q&&(n="MeshBasicMaterial")}void 0!==g.blending&&void 0!==THREE[g.blending]&&
...
THREE.Particle.prototype.clone=function(a){void 0===a&&(a=new THREE.Particle(this.material));THREE.Object3D.prototype.clone.call(this,a);return a};
THREE.ParticleSystem=function(a,b){THREE.Object3D.call(this);this.geometry=a;this.material=void 0!==b?b:new THREE.ParticleBasicMaterial({color:16777215*Math.random()});this.sortParticles=!1;this.geometry&&(null===this.geometry.boundingSphere&&this.geometry.computeBoundingSphere(),this.boundRadius=a.boundingSphere.radius,this.boundCenter=a.boundingSphere.origin);this.frustumCulled=!1};THREE.ParticleSystem.prototype=Object.create(THREE.Object3D.prototype);
THREE.ParticleSystem.prototype.clone=function(a){void 0===a&&(a=new THREE.ParticleSystem(this.geometry,this.material));a.sortParticles=this.sortParticles;THREE.Object3D.prototype.clone.call(this,a);return a};
THREE.Line=function(a,b,c){THREE.Object3D.call(this);this.geometry=a;this.material=void 0!==b?b:new THREE.LineBasicMaterial({color:16777215*Math.random()});this.type=void 0!==c?c:THREE.LineStrip;this.geometry&&(this.geometry.boundingSphere||this.geometry.computeBoundingSphere(),this.boundRadius=a.boundingSphere.radius,this.boundCenter=a.boundingSphere.origin)};THREE.LineStrip=0;THREE.LinePieces=1;THREE.Line.prototype=Object.create(THREE.Object3D.prototype);
...
THREE.Ribbon=function(a,b){THREE.Object3D.call(this);this.geometry=a;this.material=b;this.geometry&&(this.geometry.boundingSphere||this.geometry.computeBoundingSphere(),this.boundRadius=a.boundingSphere.radius,this.boundCenter=a.boundingSphere.origin)};THREE.Ribbon.prototype=Object.create(THREE.Object3D.prototype);THREE.Ribbon.prototype.clone=function(a){void 0===a&&(a=new THREE.Ribbon(this.geometry,this.material));THREE.Object3D.prototype.clone.call(this,a);return a};
THREE.LOD=function(){THREE.Object3D.call(this);this.LODs=[]};THREE.LOD.prototype=Object.create(THREE.Object3D.prototype);THREE.LOD.prototype.addLevel=function(a,b){void 0===b&&(b=0);for(var b=Math.abs(b),c=0;c<this.LODs.length&&!(b<this.LODs[c].visibleAtDistance);c++);this.LODs.splice(c,0,{visibleAtDistance:b,object3D:a});this.add(a)};
...
n[d]=[ab.z,d];n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++)f=h[n[d][1]],e=3*d,l[e]=f.x,l[e+1]=f.y,l[e+2]=f.z;for(d=0;d<j;d++)e=3*d,f=i[n[d][1]],m[e]=f.r,m[e+1]=f.g,m[e+2]=f.b;if(q){i=0;for(j=q.length;i<j;i++)if(h=q[i],void 0===h.boundTo||"vertices"===h.boundTo)if(e=0,f=h.value.length,1===h.size)for(d=0;d<f;d++)g=n[d][1],h.array[d]=h.value[g];else if(2===h.size)for(d=0;d<f;d++)g=n[d][1],g=h.value[g],h.array[e]=g.x,h.array[e+1]=g.y,e+=2;else if(3===h.size)if("c"===h.type)for(d=0;d<f;d++)g=
n[d][1],g=h.value[g],h.array[e]=g.r,h.array[e+1]=g.g,h.array[e+2]=g.b,e+=3;else for(d=0;d<f;d++)g=n[d][1],g=h.value[g],h.array[e]=g.x,h.array[e+1]=g.y,h.array[e+2]=g.z,e+=3;else if(4===h.size)for(d=0;d<f;d++)g=n[d][1],g=h.value[g],h.array[e]=g.x,h.array[e+1]=g.y,h.array[e+2]=g.z,h.array[e+3]=g.w,e+=4}}else{if(p)for(d=0;d<g;d++)f=h[d],e=3*d,l[e]=f.x,l[e+1]=f.y,l[e+2]=f.z;if(o)for(d=0;d<j;d++)f=i[d],e=3*d,m[e]=f.r,m[e+1]=f.g,m[e+2]=f.b;if(q){i=0;for(j=q.length;i<j;i++)if(h=q[i],h.needsUpdate&&(void 0===
...
j.shadowMapSize,i.shadowMatrix.value[Z]=j.shadowMatrix,i.shadowDarkness.value[Z]=j.shadowDarkness,i.shadowBias.value[Z]=j.shadowBias,Z++}b=d.uniformsList;i=0;for(Z=b.length;i<Z;i++)if(f=g.uniforms[b[i][1]])if(c=b[i][0],l=c.type,j=c.value,"i"===l)k.uniform1i(f,j);else if("f"===l)k.uniform1f(f,j);else if("v2"===l)k.uniform2f(f,j.x,j.y);else if("v3"===l)k.uniform3f(f,j.x,j.y,j.z);else if("v4"===l)k.uniform4f(f,j.x,j.y,j.z,j.w);else if("c"===l)k.uniform3f(f,j.r,j.g,j.b);else if("iv1"===l)k.uniform1iv(f,
...
l){if(n=j,j=v(),k.uniform1i(f,j),n)if(n.image instanceof Array&&6===n.image.length){if(c=n,f=j,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=k.createTexture());k.activeTexture(k.TEXTURE0+f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)S.autoScaleCubemaps&&!f?(m=j,n=l,s=c.image[l],u=Uc,s.width<=u&&s.height<=u||(A=Math.max(s.width,s.height),
t=Math.floor(s.width*u/A),u=Math.floor(s.height*u/A),A=document.createElement("canvas"),A.width=t,A.height=u,A.getContext("2d").drawImage(s,0,0,s.width,s.height,0,0,t,u),s=A),m[n]=s):j[l]=c.image[l];l=j[0];m=0===(l.width&l.width-1)&&0===(l.height&l.height-1);n=H(c.format);s=H(c.type);F(k.TEXTURE_CUBE_MAP,c,m);for(l=0;6>l;l++)if(f){u=j[l].mipmaps;A=0;for(D=u.length;A<D;A++)t=u[A],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,A,n,t.width,t.height,0,t.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+
...
i++}else{h=[];g=e.morphTargetInfluences;var l,m=g.length;for(l=0;l<m;l++)i=g[l],0<i&&h.push([l,i]);h.length>d.numSupportedMorphTargets?(h.sort(j),h.length=d.numSupportedMorphTargets):h.length>d.numSupportedMorphNormals?h.sort(j):0===h.length&&h.push([0,0]);for(i=0;i<d.numSupportedMorphTargets;)h[i]?(l=h[i][0],k.bindBuffer(k.ARRAY_BUFFER,f.__webglMorphTargetsBuffers[l]),k.vertexAttribPointer(c["morphTarget"+i],3,k.FLOAT,!1,0,0),d.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,f.__webglMorphNormalsBuffers[l]),
k.vertexAttribPointer(c["morphNormal"+i],3,k.FLOAT,!1,0,0)),e.__webglMorphTargetInfluences[i]=g[l]):(k.vertexAttribPointer(c["morphTarget"+i],3,k.FLOAT,!1,0,0),d.morphNormals&&k.vertexAttribPointer(c["morphNormal"+i],3,k.FLOAT,!1,0,0),e.__webglMorphTargetInfluences[i]=0),i++}null!==d.program.uniforms.morphTargetInfluences&&k.uniform1fv(d.program.uniforms.morphTargetInfluences,e.__webglMorphTargetInfluences)}if(a){if(f.__webglCustomAttributesList){g=0;for(h=f.__webglCustomAttributesList.length;g<h;g++)c=
...
k.vertexAttribPointer(b.skinIndex,4,k.FLOAT,!1,0,0),k.bindBuffer(k.ARRAY_BUFFER,f.__webglSkinWeightsBuffer),k.vertexAttribPointer(b.skinWeight,4,k.FLOAT,!1,0,0))}e instanceof THREE.Mesh?(d.wireframe?(d=d.wireframeLinewidth,d!==fb&&(k.lineWidth(d),fb=d),a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,f.__webglLineBuffer),k.drawElements(k.LINES,f.__webglLineCount,k.UNSIGNED_SHORT,0)):(a&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,f.__webglFaceBuffer),k.drawElements(k.TRIANGLES,f.__webglFaceCount,k.UNSIGNED_SHORT,0)),
S.info.render.calls++,S.info.render.vertices+=f.__webglFaceCount,S.info.render.faces+=f.__webglFaceCount/3):e instanceof THREE.Line?(e=e.type===THREE.LineStrip?k.LINE_STRIP:k.LINES,d=d.linewidth,d!==fb&&(k.lineWidth(d),fb=d),k.drawArrays(e,0,f.__webglLineCount),S.info.render.calls++):e instanceof THREE.ParticleSystem?(k.drawArrays(k.POINTS,0,f.__webglParticleCount),S.info.render.calls++,S.info.render.points+=f.__webglParticleCount):e instanceof THREE.Ribbon&&(k.drawArrays(k.TRIANGLE_STRIP,0,f.__webglVertexCount),
S.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var f,e,g,h,j=a.__lights,p=a.fog;P=-1;Ha=!0;this.autoUpdateScene&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b._viewMatrixArray||(b._viewMatrixArray=new Float32Array(16));b._projectionMatrixArray||(b._projectionMatrixArray=new Float32Array(16));b.matrixWorldInverse.getInverse(b.matrixWorld);b.matrixWorldInverse.flattenToArray(b._viewMatrixArray);
...
g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||hb.contains(g))){s(g,b);var o=e,q=o.object,r=o.buffer,t=void 0,t=t=void 0,t=q.material;t instanceof THREE.MeshFaceMaterial?(t=r.materialIndex,0<=t&&(t=q.geometry.materials[t],t.transparent?(o.transparent=t,o.opaque=null):(o.opaque=t,o.transparent=null))):t&&(t.transparent?(o.transparent=t,o.opaque=null):(o.opaque=t,o.transparent=null));e.render=!0;!0===this.sortObjects&&(null!==g.renderDepth?e.z=g.renderDepth:
...
Ta.__webglParticleCount=bb;b(Ta,kb);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}else m instanceof THREE.BufferGeometry&&e(m);if(!i.__webglActive){if(i instanceof THREE.Mesh)if(m=i.geometry,m instanceof THREE.BufferGeometry)q(j.__webglObjects,m,i);else for(l in m.geometryGroups)n=m.geometryGroups[l],q(j.__webglObjects,n,i);else i instanceof THREE.Ribbon||i instanceof THREE.Line||i instanceof THREE.ParticleSystem?(m=i.geometry,q(j.__webglObjects,m,i)):i instanceof THREE.ImmediateRenderObject||i.immediateRenderCallback?
...
h(ha,k.DYNAMIC_DRAW,!ha.dynamic),ha.verticesNeedUpdate=!1,ha.elementsNeedUpdate=!1,ha.uvsNeedUpdate=!1,ha.normalsNeedUpdate=!1,ha.colorsNeedUpdate=!1,ha.tangentsNeedUpdate=!1;else{for(var rb=0,xb=ha.geometryGroupsList.length;rb<xb;rb++)if(ib=ha.geometryGroupsList[rb],cb=c(vb,ib),gb=cb.attributes&&o(cb),ha.verticesNeedUpdate||ha.morphTargetsNeedUpdate||ha.elementsNeedUpdate||ha.uvsNeedUpdate||ha.normalsNeedUpdate||ha.colorsNeedUpdate||ha.tangentsNeedUpdate||gb){var na=ib,yb=vb,ob=k.DYNAMIC_DRAW,zb=
!ha.dynamic,fb=cb;if(na.__inittedArrays){var Rb=d(fb),Qb=fb.vertexColors?fb.vertexColors:!1,jc=f(fb),Hc=Rb===THREE.SmoothShading,C=void 0,Y=void 0,Yb=void 0,R=void 0,mc=void 0,Zb=void 0,wb=void 0,Ic=void 0,Sb=void 0,nc=void 0,oc=void 0,U=void 0,V=void 0,W=void 0,ma=void 0,Ab=void 0,Bb=void 0,Cb=void 0,tc=void 0,Db=void 0,Eb=void 0,Fb=void 0,uc=void 0,Gb=void 0,Hb=void 0,Ib=void 0,vc=void 0,Jb=void 0,Kb=void 0,Lb=void 0,wc=void 0,Mb=void 0,Nb=void 0,Ob=void 0,xc=void 0,sa=void 0,kc=void 0,$b=void 0,
pc=void 0,qc=void 0,Pa=void 0,sc=void 0,Na=void 0,Oa=void 0,ac=void 0,Tb=void 0,Fa=0,Ka=0,Ub=0,Vb=0,pb=0,Ua=0,va=0,$a=0,Ia=0,da=0,ja=0,y=0,ta=void 0,Qa=na.__vertexArray,yc=na.__uvArray,zc=na.__uv2Array,qb=na.__normalArray,Aa=na.__tangentArray,Ra=na.__colorArray,Ba=na.__skinIndexArray,Ca=na.__skinWeightArray,Wc=na.__morphTargetsArrays,Xc=na.__morphNormalsArrays,Yc=na.__webglCustomAttributesList,x=void 0,Pb=na.__faceArray,jb=na.__lineArray,db=yb.geometry,Fc=db.elementsNeedUpdate,cd=db.uvsNeedUpdate,
...
qa.length;C<Y;C++)R=Va[qa[C]],U=gc[R.a],V=gc[R.b],W=gc[R.c],ma=gc[R.d],Qa[Ka]=U.x,Qa[Ka+1]=U.y,Qa[Ka+2]=U.z,Qa[Ka+3]=V.x,Qa[Ka+4]=V.y,Qa[Ka+5]=V.z,Qa[Ka+6]=W.x,Qa[Ka+7]=W.y,Qa[Ka+8]=W.z,Qa[Ka+9]=ma.x,Qa[Ka+10]=ma.y,Qa[Ka+11]=ma.z,Ka+=12;k.bindBuffer(k.ARRAY_BUFFER,na.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Qa,ob)}if(kd){Pa=0;for(sc=cc.length;Pa<sc;Pa++){C=ja=0;for(Y=pa.length;C<Y;C++)ac=pa[C],R=Va[ac],U=cc[Pa].vertices[R.a],V=cc[Pa].vertices[R.b],W=cc[Pa].vertices[R.c],Na=Wc[Pa],Na[ja]=U.x,
Na[ja+1]=U.y,Na[ja+2]=U.z,Na[ja+3]=V.x,Na[ja+4]=V.y,Na[ja+5]=V.z,Na[ja+6]=W.x,Na[ja+7]=W.y,Na[ja+8]=W.z,fb.morphNormals&&(Hc?(Tb=Jc[Pa].vertexNormals[ac],Db=Tb.a,Eb=Tb.b,Fb=Tb.c):Fb=Eb=Db=Jc[Pa].faceNormals[ac],Oa=Xc[Pa],Oa[ja]=Db.x,Oa[ja+1]=Db.y,Oa[ja+2]=Db.z,Oa[ja+3]=Eb.x,Oa[ja+4]=Eb.y,Oa[ja+5]=Eb.z,Oa[ja+6]=Fb.x,Oa[ja+7]=Fb.y,Oa[ja+8]=Fb.z),ja+=9;C=0;for(Y=qa.length;C<Y;C++)ac=qa[C],R=Va[ac],U=cc[Pa].vertices[R.a],V=cc[Pa].vertices[R.b],W=cc[Pa].vertices[R.c],ma=cc[Pa].vertices[R.d],Na=Wc[Pa],
Na[ja]=U.x,Na[ja+1]=U.y,Na[ja+2]=U.z,Na[ja+3]=V.x,Na[ja+4]=V.y,Na[ja+5]=V.z,Na[ja+6]=W.x,Na[ja+7]=W.y,Na[ja+8]=W.z,Na[ja+9]=ma.x,Na[ja+10]=ma.y,Na[ja+11]=ma.z,fb.morphNormals&&(Hc?(Tb=Jc[Pa].vertexNormals[ac],Db=Tb.a,Eb=Tb.b,Fb=Tb.c,uc=Tb.d):uc=Fb=Eb=Db=Jc[Pa].faceNormals[ac],Oa=Xc[Pa],Oa[ja]=Db.x,Oa[ja+1]=Db.y,Oa[ja+2]=Db.z,Oa[ja+3]=Eb.x,Oa[ja+4]=Eb.y,Oa[ja+5]=Eb.z,Oa[ja+6]=Fb.x,Oa[ja+7]=Fb.y,Oa[ja+8]=Fb.z,Oa[ja+9]=uc.x,Oa[ja+10]=uc.y,Oa[ja+11]=uc.z),ja+=12;k.bindBuffer(k.ARRAY_BUFFER,na.__webglMorphTargetsBuffers[Pa]);
k.bufferData(k.ARRAY_BUFFER,Wc[Pa],ob);fb.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,na.__webglMorphNormalsBuffers[Pa]),k.bufferData(k.ARRAY_BUFFER,Xc[Pa],ob))}}if(bc.length){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],Jb=bc[R.a],Kb=bc[R.b],Lb=bc[R.c],Ca[da]=Jb.x,Ca[da+1]=Jb.y,Ca[da+2]=Jb.z,Ca[da+3]=Jb.w,Ca[da+4]=Kb.x,Ca[da+5]=Kb.y,Ca[da+6]=Kb.z,Ca[da+7]=Kb.w,Ca[da+8]=Lb.x,Ca[da+9]=Lb.y,Ca[da+10]=Lb.z,Ca[da+11]=Lb.w,Mb=hc[R.a],Nb=hc[R.b],Ob=hc[R.c],Ba[da]=Mb.x,Ba[da+1]=Mb.y,Ba[da+2]=Mb.z,Ba[da+3]=Mb.w,
Ba[da+4]=Nb.x,Ba[da+5]=Nb.y,Ba[da+6]=Nb.z,Ba[da+7]=Nb.w,Ba[da+8]=Ob.x,Ba[da+9]=Ob.y,Ba[da+10]=Ob.z,Ba[da+11]=Ob.w,da+=12;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],Jb=bc[R.a],Kb=bc[R.b],Lb=bc[R.c],wc=bc[R.d],Ca[da]=Jb.x,Ca[da+1]=Jb.y,Ca[da+2]=Jb.z,Ca[da+3]=Jb.w,Ca[da+4]=Kb.x,Ca[da+5]=Kb.y,Ca[da+6]=Kb.z,Ca[da+7]=Kb.w,Ca[da+8]=Lb.x,Ca[da+9]=Lb.y,Ca[da+10]=Lb.z,Ca[da+11]=Lb.w,Ca[da+12]=wc.x,Ca[da+13]=wc.y,Ca[da+14]=wc.z,Ca[da+15]=wc.w,Mb=hc[R.a],Nb=hc[R.b],Ob=hc[R.c],xc=hc[R.d],Ba[da]=Mb.x,Ba[da+1]=Mb.y,
Ba[da+2]=Mb.z,Ba[da+3]=Mb.w,Ba[da+4]=Nb.x,Ba[da+5]=Nb.y,Ba[da+6]=Nb.z,Ba[da+7]=Nb.w,Ba[da+8]=Ob.x,Ba[da+9]=Ob.y,Ba[da+10]=Ob.z,Ba[da+11]=Ob.w,Ba[da+12]=xc.x,Ba[da+13]=xc.y,Ba[da+14]=xc.z,Ba[da+15]=xc.w,da+=16;0<da&&(k.bindBuffer(k.ARRAY_BUFFER,na.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ba,ob),k.bindBuffer(k.ARRAY_BUFFER,na.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ca,ob))}if(jd&&Qb){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],wb=R.vertexColors,Ic=R.color,3===wb.length&&Qb===
THREE.VertexColors?(Gb=wb[0],Hb=wb[1],Ib=wb[2]):Ib=Hb=Gb=Ic,Ra[Ia]=Gb.r,Ra[Ia+1]=Gb.g,Ra[Ia+2]=Gb.b,Ra[Ia+3]=Hb.r,Ra[Ia+4]=Hb.g,Ra[Ia+5]=Hb.b,Ra[Ia+6]=Ib.r,Ra[Ia+7]=Ib.g,Ra[Ia+8]=Ib.b,Ia+=9;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],wb=R.vertexColors,Ic=R.color,4===wb.length&&Qb===THREE.VertexColors?(Gb=wb[0],Hb=wb[1],Ib=wb[2],vc=wb[3]):vc=Ib=Hb=Gb=Ic,Ra[Ia]=Gb.r,Ra[Ia+1]=Gb.g,Ra[Ia+2]=Gb.b,Ra[Ia+3]=Hb.r,Ra[Ia+4]=Hb.g,Ra[Ia+5]=Hb.b,Ra[Ia+6]=Ib.r,Ra[Ia+7]=Ib.g,Ra[Ia+8]=Ib.b,Ra[Ia+9]=vc.r,Ra[Ia+10]=vc.g,
Ra[Ia+11]=vc.b,Ia+=12;0<Ia&&(k.bindBuffer(k.ARRAY_BUFFER,na.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Ra,ob))}if(Uc&&db.hasTangents){C=0;for(Y=pa.length;C<Y;C++)R=Va[pa[C]],Sb=R.vertexTangents,Ab=Sb[0],Bb=Sb[1],Cb=Sb[2],Aa[va]=Ab.x,Aa[va+1]=Ab.y,Aa[va+2]=Ab.z,Aa[va+3]=Ab.w,Aa[va+4]=Bb.x,Aa[va+5]=Bb.y,Aa[va+6]=Bb.z,Aa[va+7]=Bb.w,Aa[va+8]=Cb.x,Aa[va+9]=Cb.y,Aa[va+10]=Cb.z,Aa[va+11]=Cb.w,va+=12;C=0;for(Y=qa.length;C<Y;C++)R=Va[qa[C]],Sb=R.vertexTangents,Ab=Sb[0],Bb=Sb[1],Cb=Sb[2],tc=Sb[3],Aa[va]=
Ab.x,Aa[va+1]=Ab.y,Aa[va+2]=Ab.z,Aa[va+3]=Ab.w,Aa[va+4]=Bb.x,Aa[va+5]=Bb.y,Aa[va+6]=Bb.z,Aa[va+7]=Bb.w,Aa[va+8]=Cb.x,Aa[va+9]=Cb.y,Aa[va+10]=Cb.z,Aa[va+11]=Cb.w,Aa[va+12]=tc.x,Aa[va+13]=tc.y,Aa[va+14]=tc.z,Aa[va+15]=tc.w,va+=16;k.bindBuffer(k.ARRAY_BUFFER,na.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,ob)}if(Tc&&Rb){C=0;for(Y=pa.length;C<Y;C++)if(R=Va[pa[C]],mc=R.vertexNormals,Zb=R.normal,3===mc.length&&Hc)for(sa=0;3>sa;sa++)$b=mc[sa],qb[Ua]=$b.x,qb[Ua+1]=$b.y,qb[Ua+2]=$b.z,Ua+=3;else for(sa=
0;3>sa;sa++)qb[Ua]=Zb.x,qb[Ua+1]=Zb.y,qb[Ua+2]=Zb.z,Ua+=3;C=0;for(Y=qa.length;C<Y;C++)if(R=Va[qa[C]],mc=R.vertexNormals,Zb=R.normal,4===mc.length&&Hc)for(sa=0;4>sa;sa++)$b=mc[sa],qb[Ua]=$b.x,qb[Ua+1]=$b.y,qb[Ua+2]=$b.z,Ua+=3;else for(sa=0;4>sa;sa++)qb[Ua]=Zb.x,qb[Ua+1]=Zb.y,qb[Ua+2]=Zb.z,Ua+=3;k.bindBuffer(k.ARRAY_BUFFER,na.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,qb,ob)}if(cd&&Zc&&jc){C=0;for(Y=pa.length;C<Y;C++)if(Yb=pa[C],nc=Zc[Yb],void 0!==nc)for(sa=0;3>sa;sa++)pc=nc[sa],yc[Ub]=pc.u,yc[Ub+
1]=pc.v,Ub+=2;C=0;for(Y=qa.length;C<Y;C++)if(Yb=qa[C],nc=Zc[Yb],void 0!==nc)for(sa=0;4>sa;sa++)pc=nc[sa],yc[Ub]=pc.u,yc[Ub+1]=pc.v,Ub+=2;0<Ub&&(k.bindBuffer(k.ARRAY_BUFFER,na.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,yc,ob))}if(cd&&$c&&jc){C=0;for(Y=pa.length;C<Y;C++)if(Yb=pa[C],oc=$c[Yb],void 0!==oc)for(sa=0;3>sa;sa++)qc=oc[sa],zc[Vb]=qc.u,zc[Vb+1]=qc.v,Vb+=2;C=0;for(Y=qa.length;C<Y;C++)if(Yb=qa[C],oc=$c[Yb],void 0!==oc)for(sa=0;4>sa;sa++)qc=oc[sa],zc[Vb]=qc.u,zc[Vb+1]=qc.v,Vb+=2;0<Vb&&(k.bindBuffer(k.ARRAY_BUFFER,
na.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,zc,ob))}if(Fc){C=0;for(Y=pa.length;C<Y;C++)Pb[pb]=Fa,Pb[pb+1]=Fa+1,Pb[pb+2]=Fa+2,pb+=3,jb[$a]=Fa,jb[$a+1]=Fa+1,jb[$a+2]=Fa,jb[$a+3]=Fa+2,jb[$a+4]=Fa+1,jb[$a+5]=Fa+2,$a+=6,Fa+=3;C=0;for(Y=qa.length;C<Y;C++)Pb[pb]=Fa,Pb[pb+1]=Fa+1,Pb[pb+2]=Fa+3,Pb[pb+3]=Fa+1,Pb[pb+4]=Fa+2,Pb[pb+5]=Fa+3,pb+=6,jb[$a]=Fa,jb[$a+1]=Fa+1,jb[$a+2]=Fa,jb[$a+3]=Fa+3,jb[$a+4]=Fa+1,jb[$a+5]=Fa+2,jb[$a+6]=Fa+2,jb[$a+7]=Fa+3,$a+=8,Fa+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,na.__webglFaceBuffer);
...
!1;cb.attributes&&p(cb)}else vb instanceof THREE.ParticleSystem&&(ha instanceof THREE.BufferGeometry?((ha.verticesNeedUpdate||ha.colorsNeedUpdate)&&h(ha,k.DYNAMIC_DRAW,!ha.dynamic),ha.verticesNeedUpdate=!1,ha.colorsNeedUpdate=!1):(cb=c(vb,ib),gb=cb.attributes&&o(cb),(ha.verticesNeedUpdate||ha.colorsNeedUpdate||vb.sortParticles||gb)&&g(ha,k.DYNAMIC_DRAW,vb),ha.verticesNeedUpdate=!1,ha.colorsNeedUpdate=!1,cb.attributes&&p(cb)))}};this.initMaterial=function(a,b,c,d){var f,e,g,h,i,j,l,m,n;a instanceof
...
0;for(e=b.length;f<e;f++)g=b[f],g.onlyShadow||(g instanceof THREE.DirectionalLight&&o++,g instanceof THREE.PointLight&&q++,g instanceof THREE.SpotLight&&r++,g instanceof THREE.HemisphereLight&&p++);q+r+o+p<=fa?f=o:(f=Math.ceil(fa*o/(q+o)),r=q=fa-f,p=f);e=q;g=r;h=p;p=o=0;for(r=b.length;p<r;p++)q=b[p],q.castShadow&&(q instanceof THREE.SpotLight&&o++,q instanceof THREE.DirectionalLight&&!q.shadowCascade&&o++);m=o;kc&&d&&d.useVertexTexture?l=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),b=Math.floor((b-
...
alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,v,d=[];n?d.push(n):(d.push(q),d.push(r));for(u in o)d.push(u),d.push(o[u]);for(t in c)d.push(t),d.push(c[t]);n=d.join();t=0;for(u=ra.length;t<u;t++)if(d=ra[t],d.code===n){d.usedTimes++;s=d.program;break a}t=[];for(v in o)u=o[v],!1!==u&&(u="#define "+v+" "+u,t.push(u));u=t.join("\n");v=k.createProgram();t=["precision "+L+" float;",u,jc?"#define VERTEX_TEXTURES":
...
k.createTexture(),S.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),f=H(a.format),e=H(a.type);F(k.TEXTURE_2D,a,d);if(a instanceof THREE.CompressedTexture)for(var e=a.mipmaps,g=0,h=e.length;g<h;g++)c=e[g],k.compressedTexImage2D(k.TEXTURE_2D,g,f,c.width,c.height,0,c.data);
...
!0);a.__webglTexture=k.createTexture();var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=H(a.format),f=H(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);F(k.TEXTURE_CUBE_MAP,a,c);for(var e=0;6>e;e++){a.__webglFramebuffer[e]=k.createFramebuffer();a.__webglRenderbuffer[e]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+e,0,d,a.width,a.height,0,d,f,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+e;k.bindFramebuffer(k.FRAMEBUFFER,
a.__webglFramebuffer[e]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);B(a.__webglRenderbuffer[e],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=k.createFramebuffer(),a.__webglRenderbuffer=k.createRenderbuffer(),k.bindTexture(k.TEXTURE_2D,a.__webglTexture),F(k.TEXTURE_2D,a,c),k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,f,null),d=k.TEXTURE_2D,k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,
d,a.__webglTexture,0),B(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,f=d=0):(b=null,c=za,a=xb,d=bb,f=Ma);b!==ga&&(k.bindFramebuffer(k.FRAMEBUFFER,b),k.viewport(d,f,c,a),ga=b);Ga=c;sb=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);
...
THREE.GeometryUtils={merge:function(a,b){for(var c,d,f=a.vertices.length,e=b instanceof THREE.Mesh?b.geometry:b,g=a.vertices,h=e.vertices,i=a.faces,j=e.faces,l=a.faceVertexUvs[0],n=e.faceVertexUvs[0],m={},q=0;q<a.materials.length;q++)m[a.materials[q].id]=q;b instanceof THREE.Mesh&&(b.matrixAutoUpdate&&b.updateMatrix(),c=b.matrix,d=new THREE.Matrix4,d.extractRotation(c,b.scale));for(var q=0,o=h.length;q<o;q++){var p=h[q].clone();c&&c.multiplyVector3(p);g.push(p)}q=0;for(o=j.length;q<o;q++){var g=j[q],
r,t,u=g.vertexNormals,v=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+f,g.b+f,g.c+f):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+f,g.b+f,g.c+f,g.d+f));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(p=u.length;h<p;h++)t=u[h].clone(),d&&d.multiplyVector3(t),r.vertexNormals.push(t);r.color.copy(g.color);h=0;for(p=v.length;h<p;h++)t=v[h],r.vertexColors.push(t.clone());void 0!==g.materialIndex&&(h=e.materials[g.materialIndex],p=h.id,v=m[p],void 0===v&&(v=a.materials.length,
m[p]=v,a.materials.push(h)),r.materialIndex=v);r.centroid.copy(g.centroid);c&&c.multiplyVector3(r.centroid);i.push(r)}q=0;for(o=n.length;q<o;q++){c=n[q];d=[];h=0;for(p=c.length;h<p;h++)d.push(new THREE.UV(c[h].u,c[h].v));l.push(d)}},clone:function(a){var b=new THREE.Geometry,c,d=a.vertices,f=a.faces,e=a.faceVertexUvs[0];a.materials&&(b.materials=a.materials.slice());a=0;for(c=d.length;a<c;a++)b.vertices.push(d[a].clone());a=0;for(c=f.length;a<c;a++)b.faces.push(f[a].clone());a=0;for(c=e.length;a<
...
b.push(g.clone()),b.push(h.clone()),b.push(i.clone()),e.a=f,e.b=f+1,e.c=f+2}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,f,e,g,h,i,j,l,n,m,q,o,p,r,t,u,v,s,z=[],w=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)w[c]=[];c=0;for(d=a.faces.length;c<d;c++)if(f=a.faces[c],f instanceof THREE.Face3)if(e=f.a,g=f.b,h=f.c,j=a.vertices[e],l=a.vertices[g],n=a.vertices[h],q=j.distanceTo(l),o=l.distanceTo(n),m=j.distanceTo(n),q>b||o>b||m>b){i=a.vertices.length;v=f.clone();s=f.clone();q>=o&&
q>=m?(j=j.clone(),j.lerpSelf(l,0.5),v.a=e,v.b=i,v.c=h,s.a=i,s.b=g,s.c=h,3===f.vertexNormals.length&&(e=f.vertexNormals[0].clone(),e.lerpSelf(f.vertexNormals[1],0.5),v.vertexNormals[1].copy(e),s.vertexNormals[0].copy(e)),3===f.vertexColors.length&&(e=f.vertexColors[0].clone(),e.lerpSelf(f.vertexColors[1],0.5),v.vertexColors[1].copy(e),s.vertexColors[0].copy(e)),f=0):o>=q&&o>=m?(j=l.clone(),j.lerpSelf(n,0.5),v.a=e,v.b=g,v.c=i,s.a=i,s.b=h,s.c=e,3===f.vertexNormals.length&&(e=f.vertexNormals[1].clone(),
e.lerpSelf(f.vertexNormals[2],0.5),v.vertexNormals[2].copy(e),s.vertexNormals[0].copy(e),s.vertexNormals[1].copy(f.vertexNormals[2]),s.vertexNormals[2].copy(f.vertexNormals[0])),3===f.vertexColors.length&&(e=f.vertexColors[1].clone(),e.lerpSelf(f.vertexColors[2],0.5),v.vertexColors[2].copy(e),s.vertexColors[0].copy(e),s.vertexColors[1].copy(f.vertexColors[2]),s.vertexColors[2].copy(f.vertexColors[0])),f=1):(j=j.clone(),j.lerpSelf(n,0.5),v.a=e,v.b=g,v.c=i,s.a=i,s.b=g,s.c=h,3===f.vertexNormals.length&&
(e=f.vertexNormals[0].clone(),e.lerpSelf(f.vertexNormals[2],0.5),v.vertexNormals[2].copy(e),s.vertexNormals[0].copy(e)),3===f.vertexColors.length&&(e=f.vertexColors[0].clone(),e.lerpSelf(f.vertexColors[2],0.5),v.vertexColors[2].copy(e),s.vertexColors[0].copy(e)),f=2);z.push(v,s);a.vertices.push(j);e=0;for(g=a.faceVertexUvs.length;e<g;e++)a.faceVertexUvs[e].length&&(j=a.faceVertexUvs[e][c],s=j[0],h=j[1],v=j[2],0===f?(l=s.clone(),l.lerpSelf(h,0.5),j=[s.clone(),l.clone(),v.clone()],h=[l.clone(),h.clone(),
v.clone()]):1===f?(l=h.clone(),l.lerpSelf(v,0.5),j=[s.clone(),h.clone(),l.clone()],h=[l.clone(),v.clone(),s.clone()]):(l=s.clone(),l.lerpSelf(v,0.5),j=[s.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),v.clone()]),w[e].push(j,h))}else{z.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)w[e].push(a.faceVertexUvs[e][c])}else if(e=f.a,g=f.b,h=f.c,i=f.d,j=a.vertices[e],l=a.vertices[g],n=a.vertices[h],m=a.vertices[i],q=j.distanceTo(l),o=l.distanceTo(n),p=n.distanceTo(m),r=j.distanceTo(m),q>b||o>b||
p>b||r>b){t=a.vertices.length;u=a.vertices.length+1;v=f.clone();s=f.clone();q>=o&&q>=p&&q>=r||p>=o&&p>=q&&p>=r?(q=j.clone(),q.lerpSelf(l,0.5),l=n.clone(),l.lerpSelf(m,0.5),v.a=e,v.b=t,v.c=u,v.d=i,s.a=t,s.b=g,s.c=h,s.d=u,4===f.vertexNormals.length&&(e=f.vertexNormals[0].clone(),e.lerpSelf(f.vertexNormals[1],0.5),g=f.vertexNormals[2].clone(),g.lerpSelf(f.vertexNormals[3],0.5),v.vertexNormals[1].copy(e),v.vertexNormals[2].copy(g),s.vertexNormals[0].copy(e),s.vertexNormals[3].copy(g)),4===f.vertexColors.length&&
(e=f.vertexColors[0].clone(),e.lerpSelf(f.vertexColors[1],0.5),g=f.vertexColors[2].clone(),g.lerpSelf(f.vertexColors[3],0.5),v.vertexColors[1].copy(e),v.vertexColors[2].copy(g),s.vertexColors[0].copy(e),s.vertexColors[3].copy(g)),f=0):(q=l.clone(),q.lerpSelf(n,0.5),l=m.clone(),l.lerpSelf(j,0.5),v.a=e,v.b=g,v.c=t,v.d=u,s.a=u,s.b=t,s.c=h,s.d=i,4===f.vertexNormals.length&&(e=f.vertexNormals[1].clone(),e.lerpSelf(f.vertexNormals[2],0.5),g=f.vertexNormals[3].clone(),g.lerpSelf(f.vertexNormals[0],0.5),
v.vertexNormals[2].copy(e),v.vertexNormals[3].copy(g),s.vertexNormals[0].copy(g),s.vertexNormals[1].copy(e)),4===f.vertexColors.length&&(e=f.vertexColors[1].clone(),e.lerpSelf(f.vertexColors[2],0.5),g=f.vertexColors[3].clone(),g.lerpSelf(f.vertexColors[0],0.5),v.vertexColors[2].copy(e),v.vertexColors[3].copy(g),s.vertexColors[0].copy(g),s.vertexColors[1].copy(e)),f=1);z.push(v,s);a.vertices.push(q,l);e=0;for(g=a.faceVertexUvs.length;e<g;e++)a.faceVertexUvs[e].length&&(j=a.faceVertexUvs[e][c],s=j[0],
h=j[1],v=j[2],j=j[3],0===f?(l=s.clone(),l.lerpSelf(h,0.5),n=v.clone(),n.lerpSelf(j,0.5),s=[s.clone(),l.clone(),n.clone(),j.clone()],h=[l.clone(),h.clone(),v.clone(),n.clone()]):(l=h.clone(),l.lerpSelf(v,0.5),n=j.clone(),n.lerpSelf(s,0.5),s=[s.clone(),h.clone(),l.clone(),n.clone()],h=[n.clone(),l.clone(),v.clone(),j.clone()]),w[e].push(s,h))}else{z.push(f);e=0;for(g=a.faceVertexUvs.length;e<g;e++)w[e].push(a.faceVertexUvs[e][c])}a.faces=z;a.faceVertexUvs=w}};THREE.GeometryUtils.random=THREE.Math.random16;
...
0>n-1?0:n-1,q=n+1>f-1?f-1:n+1,o=0>l-1?0:l-1,p=l+1>d-1?d-1:l+1,r=[],t=[0,0,h[4*(n*d+l)]/255*b];r.push([-1,0,h[4*(n*d+o)]/255*b]);r.push([-1,-1,h[4*(m*d+o)]/255*b]);r.push([0,-1,h[4*(m*d+l)]/255*b]);r.push([1,-1,h[4*(m*d+p)]/255*b]);r.push([1,0,h[4*(n*d+p)]/255*b]);r.push([1,1,h[4*(q*d+p)]/255*b]);r.push([0,1,h[4*(q*d+l)]/255*b]);r.push([-1,1,h[4*(q*d+o)]/255*b]);m=[];o=r.length;for(q=0;q<o;q++){var p=r[q],u=r[(q+1)%o],p=[p[0]-t[0],p[1]-t[1],p[2]-t[2]],u=[u[0]-t[0],u[1]-t[1],u[2]-t[2]];m.push(c([p[1]*
u[2]-p[2]*u[1],p[2]*u[0]-p[0]*u[2],p[0]*u[1]-p[1]*u[0]]))}r=[0,0,0];for(q=0;q<m.length;q++)r[0]+=m[q][0],r[1]+=m[q][1],r[2]+=m[q][2];r[0]/=m.length;r[1]/=m.length;r[2]/=m.length;t=4*(n*d+l);j[t]=255*((r[0]+1)/2)|0;j[t+1]=255*((r[1]+1)/2)|0;j[t+2]=255*r[2]|0;j[t+3]=255}g.putImageData(i,0,0);return e},generateDataTexture:function(a,b,c){for(var d=a*b,f=new Uint8Array(3*d),e=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)f[3*h]=e,f[3*h+1]=g,f[3*h+2]=c;a=new THREE.DataTexture(f,
