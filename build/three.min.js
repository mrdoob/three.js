...
b){var c=this.elements,d=a.x,e=a.y,f=a.z,g=Math.cos(d),d=Math.sin(d),h=Math.cos(e),e=Math.sin(e),i=Math.cos(f),f=Math.sin(f);if(void 0===b||"XYZ"===b){var j=g*i,m=g*f,p=d*i,l=d*f;c[0]=h*i;c[4]=-h*f;c[8]=e;c[1]=m+p*e;c[5]=j-l*e;c[9]=-d*h;c[2]=l-j*e;c[6]=p+m*e;c[10]=g*h}else"YXZ"===b?(j=h*i,m=h*f,p=e*i,l=e*f,c[0]=j+l*d,c[4]=p*d-m,c[8]=g*e,c[1]=g*f,c[5]=g*i,c[9]=-d,c[2]=m*d-p,c[6]=l+j*d,c[10]=g*h):"ZXY"===b?(j=h*i,m=h*f,p=e*i,l=e*f,c[0]=j-l*d,c[4]=-g*f,c[8]=p+m*d,c[1]=m+p*d,c[5]=g*i,c[9]=l-j*d,c[2]=
-g*e,c[6]=d,c[10]=g*h):"ZYX"===b?(j=g*i,m=g*f,p=d*i,l=d*f,c[0]=h*i,c[4]=p*e-m,c[8]=j*e+l,c[1]=h*f,c[5]=l*e+j,c[9]=m*e-p,c[2]=-e,c[6]=d*h,c[10]=g*h):"YZX"===b?(j=g*h,m=g*e,p=d*h,l=d*e,c[0]=h*i,c[4]=l-j*f,c[8]=p*f+m,c[1]=f,c[5]=g*i,c[9]=-d*i,c[2]=-e*i,c[6]=m*f+p,c[10]=j-l*f):"XZY"===b&&(j=g*h,m=g*e,p=d*h,l=d*e,c[0]=h*i,c[4]=-f,c[8]=e*i,c[1]=j*f+l,c[5]=g*i,c[9]=m*f-p,c[2]=p*f-m,c[6]=d*i,c[10]=l*f+j);return this},setRotationFromQuaternion:function(a){var b=this.elements,c=a.x,d=a.y,e=a.z,f=a.w,g=c+c,
...
THREE.Object3D.defaultEulerOrder="XYZ";THREE.Object3DIdCount=0;THREE.Projector=function(){function a(){if(f===h){var a=new THREE.RenderableObject;g.push(a);h++;f++;return a}return g[f++]}function b(){if(j===p){var a=new THREE.RenderableVertex;m.push(a);p++;j++;return a}return m[j++]}function c(a,b){return b.z-a.z}function d(a,b){var c=0,d=1,e=a.z+a.w,f=b.z+b.w,g=-a.z+a.w,h=-b.z+b.w;if(0<=e&&0<=f&&0<=g&&0<=h)return!0;if(0>e&&0>f||0>g&&0>h)return!1;0>e?c=Math.max(c,e/(e-f)):0>f&&(d=Math.min(d,e/(e-f)));0>g?c=Math.max(c,g/(g-h)):0>h&&(d=Math.min(d,g/(g-h)));if(d<
c)return!1;a.lerp(b,c);b.lerp(a,1-d);return!0}var e,f,g=[],h=0,i,j,m=[],p=0,l,r,s=[],n=0,q,y=[],u=0,x,t,E=[],J=0,F,z,H=[],K=0,G={objects:[],sprites:[],lights:[],elements:[]},L=new THREE.Vector3,B=new THREE.Vector4,P=new THREE.Box3(new THREE.Vector3(-1,-1,-1),new THREE.Vector3(1,1,1)),C=new THREE.Box3,I=Array(3),M=Array(4),U=new THREE.Matrix4,ea=new THREE.Matrix4,xa,La=new THREE.Matrix4,A=new THREE.Matrix3,ca=new THREE.Matrix3,ha=new THREE.Vector3,na=new THREE.Frustum,N=new THREE.Vector4,fa=new THREE.Vector4;
...
I[0]=W.positionScreen,I[1]=V.positionScreen,I[2]=ga.positionScreen,!0===W.visible||!0===V.visible||!0===ga.visible||P.isIntersectionBox(C.setFromPoints(I)))if(pa=0>(ga.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(ga.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x),ia===THREE.DoubleSide||pa===(ia===THREE.FrontSide))r===n?(oa=new THREE.RenderableFace3,s.push(oa),n++,r++,l=oa):l=s[r++],l.v1.copy(W),l.v2.copy(V),l.v3.copy(ga);else continue;
...
ga.positionScreen.y)-(V.positionScreen.y-ga.positionScreen.y)*(oa.positionScreen.x-ga.positionScreen.x),ia===THREE.DoubleSide||pa===(ia===THREE.FrontSide)){if(q===u){var rb=new THREE.RenderableFace4;y.push(rb);u++;q++;l=rb}else l=y[q++];l.v1.copy(W);l.v2.copy(V);l.v3.copy(ga);l.v4.copy(oa)}else continue;else continue;l.normalModel.copy(Z.normal);!1===pa&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&l.normalModel.negate();l.normalModel.applyMatrix3(A).normalize();l.normalModelView.copy(l.normalModel).applyMatrix3(ca);
l.centroidModel.copy(Z.centroid).applyMatrix4(xa);ga=Z.vertexNormals;W=0;for(V=ga.length;W<V;W++)oa=l.vertexNormalsModel[W],oa.copy(ga[W]),!1===pa&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&oa.negate(),oa.applyMatrix3(A).normalize(),l.vertexNormalsModelView[W].copy(oa).applyMatrix3(ca);l.vertexNormalsLength=ga.length;W=0;for(V=Pa.length;W<V;W++)if(oa=Pa[W][la],void 0!==oa){ia=0;for(ga=oa.length;ia<ga;ia++)l.uvs[W][ia]=oa[ia]}l.color=Z.color;l.material=Ra;ha.copy(l.centroidModel).applyProjection(ea);
l.z=ha.z;G.elements.push(l)}}}else if(ka instanceof THREE.Line){La.multiplyMatrices(ea,xa);la=ka.geometry.vertices;W=b();W.positionScreen.copy(la[0]).applyMatrix4(La);jb=ka.type===THREE.LinePieces?2:1;ta=1;for(Z=la.length;ta<Z;ta++)W=b(),W.positionScreen.copy(la[ta]).applyMatrix4(La),0<(ta+1)%jb||(V=m[j-2],N.copy(W.positionScreen),fa.copy(V.positionScreen),!0===d(N,fa)&&(N.multiplyScalar(1/N.w),fa.multiplyScalar(1/fa.w),t===J?(Pa=new THREE.RenderableLine,E.push(Pa),J++,t++,x=Pa):x=E[t++],x.v1.positionScreen.copy(N),
x.v2.positionScreen.copy(fa),x.z=Math.max(N.z,fa.z),x.material=ka.material,G.elements.push(x)))}g=0;for(p=G.sprites.length;g<p;g++)ka=G.sprites[g].object,xa=ka.matrixWorld,ka instanceof THREE.Particle&&(B.set(xa.elements[12],xa.elements[13],xa.elements[14],1),B.applyMatrix4(ea),B.z/=B.w,0<B.z&&1>B.z&&(z===K?(pa=new THREE.RenderableParticle,H.push(pa),K++,z++,F=pa):F=H[z++],F.object=ka,F.x=B.x/B.w,F.y=B.y/B.w,F.z=B.z,F.rotation=ka.rotation.z,F.scale.x=ka.scale.x*Math.abs(F.x-(B.x+h.projectionMatrix.elements[0])/
...
P=M+b[H+1],C=M+b[H+2],m=c[3*B],p=c[3*B+1],l=c[3*B+2],r=c[3*P],s=c[3*P+1],n=c[3*P+2],q=c[3*C],y=c[3*C+1],u=c[3*C+2],x=e[2*B],t=e[2*B+1],E=e[2*P],J=e[2*P+1],F=e[2*C],z=e[2*C+1],r-=m,m=q-m,s-=p,p=y-p,n-=l,l=u-l,E-=x,x=F-x,J-=t,t=z-t,z=1/(E*t-x*J),f.set((t*r-J*m)*z,(t*s-J*p)*z,(t*n-J*l)*z),g.set((E*m-x*r)*z,(E*p-x*s)*z,(E*l-x*n)*z),i[B].add(f),i[P].add(f),i[C].add(f),j[B].add(g),j[P].add(g),j[C].add(g)}var U=new THREE.Vector3,ea=new THREE.Vector3,xa=new THREE.Vector3,La=new THREE.Vector3,A,ca,ha;G=0;
...
q.type&&(s=new THREE.OrthographicCamera(q.left,q.right,q.top,q.bottom,q.near,q.far)),g=q.position,s.position.set(g[0],g[1],g[2]),a.add(s),s.name=n,z.cameras[n]=s,z.objects[n]=s):(g=q.position,i=q.rotation,j=q.scale,p=q.quaternion,t=new THREE.Object3D,t.name=n,t.position.set(g[0],g[1],g[2]),p?(t.quaternion.set(p[0],p[1],p[2],p[3]),t.useQuaternion=!0):t.rotation.set(i[0],i[1],i[2]),t.scale.set(j[0],j[1],j[2]),t.visible=void 0!==q.visible?q.visible:!1,a.add(t),z.objects[n]=t,z.empties[n]=t);if(t){if(void 0!==
...
if(0===t&&0===E){for(var a=0;a<H.length;a++){var c=H[a],d=z.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,z.scene.add(c.object.target));c.object.target.userData.targetInverse=c.object}b(z)}}var m=this,p=THREE.Loader.prototype.extractUrlBase(c),l,r,s,n,q,y,u,x,t,E,J,F,z,H=[],K=a,G;for(G in this.geometryHandlerMap)a=this.geometryHandlerMap[G].loaderClass,this.geometryHandlerMap[G].loaderObject=new a;for(G in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[G].loaderClass,
...
for(var L in K.fogs)a=K.fogs[L],"linear"===a.type?n=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(n=new THREE.FogExp2(0,a.density)),a=a.color,n.color.setRGB(a[0],a[1],a[2]),z.fogs[L]=n;for(var B in K.geometries)n=K.geometries[B],n.type in this.geometryHandlerMap&&(t+=1,m.onLoadStart());for(var P in K.objects)n=K.objects[P],n.type&&n.type in this.hierarchyHandlerMap&&(t+=1,m.onLoadStart());J=t;for(B in K.geometries)if(n=K.geometries[B],"cube"===n.type)l=new THREE.CubeGeometry(n.width,n.height,n.depth,
n.widthSegments,n.heightSegments,n.depthSegments),l.name=B,z.geometries[B]=l;else if("plane"===n.type)l=new THREE.PlaneGeometry(n.width,n.height,n.widthSegments,n.heightSegments),l.name=B,z.geometries[B]=l;else if("sphere"===n.type)l=new THREE.SphereGeometry(n.radius,n.widthSegments,n.heightSegments),l.name=B,z.geometries[B]=l;else if("cylinder"===n.type)l=new THREE.CylinderGeometry(n.topRad,n.botRad,n.height,n.radSegs,n.heightSegs),l.name=B,z.geometries[B]=l;else if("torus"===n.type)l=new THREE.TorusGeometry(n.radius,
n.tube,n.segmentsR,n.segmentsT),l.name=B,z.geometries[B]=l;else if("icosahedron"===n.type)l=new THREE.IcosahedronGeometry(n.radius,n.subdivisions),l.name=B,z.geometries[B]=l;else if(n.type in this.geometryHandlerMap){P={};for(q in n)"type"!==q&&"url"!==q&&(P[q]=n[q]);this.geometryHandlerMap[n.type].loaderObject.load(d(n.url,K.urlBaseType),g(B),P)}else"embedded"===n.type&&(P=K.embeds[n.id],P.metadata=K.metadata,P&&(P=this.geometryHandlerMap.ascii.loaderObject.parse(P,""),i(B)(P.geometry,P.materials)));
...
b){if(P!==a||C!==b)t.setLineDash([a,b]),P=a,C=b}console.log("THREE.CanvasRenderer",THREE.REVISION);var j=THREE.Math.smoothstep,a=a||{},m=this,p,l,r,s=new THREE.Projector,n=void 0!==a.canvas?a.canvas:document.createElement("canvas"),q,y,u,x,t=n.getContext("2d"),E=new THREE.Color(0),J=0,F=1,z=0,H=null,K=null,G=null,L=null,B=null,P=null,C=0,I,M,U,ea,xa=new THREE.RenderableVertex,La=new THREE.RenderableVertex,A,ca,ha,na,N,fa,ib,Ya,db,Ja,pa,ta,Z=new THREE.Color,la=new THREE.Color,W=new THREE.Color,V=new THREE.Color,
...
!1),E=new THREE.Vector3,J=new THREE.Vector3,F=new THREE.Vector3);p||(j=i=m=0);var z,H,K,G=this,L=this.vertices.length,l=a.extractPoints(l),B=l.shape,l=l.holes;if(s=!THREE.Shape.Utils.isClockWise(B)){B=B.reverse();H=0;for(K=l.length;H<K;H++)z=l[H],THREE.Shape.Utils.isClockWise(z)&&(l[H]=z.reverse());s=!1}var P=THREE.Shape.Utils.triangulateShape(B,l),s=B;H=0;for(K=l.length;H<K;H++)z=l[H],B=B.concat(z);var C,I,M,U,ea=B.length,xa=P.length,La=[],A=0,ca=s.length;C=ca-1;for(I=A+1;A<ca;A++,C++,I++)C===ca&&
(C=0),I===ca&&(I=0),La[A]=d(s[A],s[C],s[I]);var ha=[],na,N=La.concat();H=0;for(K=l.length;H<K;H++){z=l[H];na=[];A=0;ca=z.length;C=ca-1;for(I=A+1;A<ca;A++,C++,I++)C===ca&&(C=0),I===ca&&(I=0),na[A]=d(z[A],z[C],z[I]);ha.push(na);N=N.concat(na)}for(C=0;C<m;C++){z=C/m;M=i*(1-z);I=j*Math.sin(z*Math.PI/2);A=0;for(ca=s.length;A<ca;A++)U=c(s[A],La[A],I),f(U.x,U.y,-M);H=0;for(K=l.length;H<K;H++){z=l[H];na=ha[H];A=0;for(ca=z.length;A<ca;A++)U=c(z[A],na[A],I),f(U.x,U.y,-M)}}I=j;for(A=0;A<ea;A++)U=p?c(B[A],N[A],
I):B[A],q?(J.copy(t.normals[0]).multiplyScalar(U.x),E.copy(t.binormals[0]).multiplyScalar(U.y),F.copy(n[0]).add(J).add(E),f(F.x,F.y,F.z)):f(U.x,U.y,0);for(z=1;z<=r;z++)for(A=0;A<ea;A++)U=p?c(B[A],N[A],I):B[A],q?(J.copy(t.normals[z]).multiplyScalar(U.x),E.copy(t.binormals[z]).multiplyScalar(U.y),F.copy(n[z]).add(J).add(E),f(F.x,F.y,F.z)):f(U.x,U.y,h/r*z);for(C=m-1;0<=C;C--){z=C/m;M=i*(1-z);I=j*Math.sin(z*Math.PI/2);A=0;for(ca=s.length;A<ca;A++)U=c(s[A],La[A],I),f(U.x,U.y,h+M);H=0;for(K=l.length;H<
K;H++){z=l[H];na=ha[H];A=0;for(ca=z.length;A<ca;A++)U=c(z[A],na[A],I),q?f(U.x,U.y+n[r-1].y,n[r-1].x+M):f(U.x,U.y,h+M)}}if(p){i=0*ea;for(A=0;A<xa;A++)h=P[A],g(h[2]+i,h[1]+i,h[0]+i,!0);i=ea*(r+2*m);for(A=0;A<xa;A++)h=P[A],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(A=0;A<xa;A++)h=P[A],g(h[2],h[1],h[0],!0);for(A=0;A<xa;A++)h=P[A],g(h[0]+ea*r,h[1]+ea*r,h[2]+ea*r,!1)}h=0;e(s,h);h+=s.length;H=0;for(K=l.length;H<K;H++)z=l[H],e(z,h),h+=z.length};
...
a,d),g(b.uv,b,d),g(c.uv,c,d)])}function g(a,b,c){0>c&&1===a.x&&(a=new THREE.Vector2(a.x-1,a.y));0===b.x&&0===b.z&&(a=new THREE.Vector2(c/2/Math.PI+0.5,a.y));return a}THREE.Geometry.call(this);for(var c=c||1,d=d||0,h=this,i=0,j=a.length;i<j;i++)e(new THREE.Vector3(a[i][0],a[i][1],a[i][2]));for(var m=this.vertices,a=[],i=0,j=b.length;i<j;i++){var p=m[b[i][0]],l=m[b[i][1]],r=m[b[i][2]];a[i]=new THREE.Face3(p.index,l.index,r.index,[p.clone(),l.clone(),r.clone()])}i=0;for(j=a.length;i<j;i++){l=a[i];m=
d;b=Math.pow(2,m);Math.pow(4,m);for(var m=e(h.vertices[l.a]),p=e(h.vertices[l.b]),s=e(h.vertices[l.c]),l=[],r=0;r<=b;r++){l[r]=[];for(var n=e(m.clone().lerp(s,r/b)),q=e(p.clone().lerp(s,r/b)),y=b-r,u=0;u<=y;u++)l[r][u]=0==u&&r==b?n:e(n.clone().lerp(q,u/y))}for(r=0;r<b;r++)for(u=0;u<2*(b-r)-1;u++)m=Math.floor(u/2),0==u%2?f(l[r][m+1],l[r+1][m],l[r][m]):f(l[r][m+1],l[r+1][m+1],l[r+1][m])}this.mergeVertices();i=0;for(j=this.vertices.length;i<j;i++)this.vertices[i].multiplyScalar(c);this.computeCentroids();
