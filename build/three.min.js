...
la.vertexNormalsWorld[0],ba),n(la.v2.positionWorld,la.vertexNormalsWorld[1],ha),n(la.v4.positionWorld,la.vertexNormalsWorld[3],Y),n(la.v3.positionWorld,la.vertexNormalsWorld[2],ia),ba.r=ba.r*ca.r+aa.r,ba.g=ba.g*ca.g+aa.g,ba.b=ba.b*ca.b+aa.b,ha.r=ha.r*ca.r+aa.r,ha.g=ha.g*ca.g+aa.g,ha.b=ha.b*ca.b+aa.b,Y.r=Y.r*ca.r+aa.r,Y.g=Y.g*ca.g+aa.g,Y.b=Y.b*ca.b+aa.b,ia.r=ia.r*ca.r+aa.r,ia.g=ia.g*ca.g+aa.g,ia.b=ia.b*ca.b+aa.b,pa=H(ba,ha,Y,ia),m(F,L,P,N,M,O),C(F,L,P,N,M,O,0,0,1,0,0,1,pa),m(R,$,Q,S,fa,Ha),C(R,$,Q,
S,fa,Ha,1,0,1,1,0,1,pa)):(G.r=ka.r,G.g=ka.g,G.b=ka.b,n(la.centroidWorld,la.normalWorld,G),G.r=G.r*ca.r+aa.r,G.g=G.g*ca.g+aa.g,G.b=G.b*ca.b+aa.b,r(F,L,P,N,Q,S,M,O),!0===da.wireframe?s(G,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):t(G)):(G.r=ca.r+aa.r,G.g=ca.g+aa.g,G.b=ca.b+aa.b,r(F,L,P,N,Q,S,M,O),!0===da.wireframe?s(G,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):t(G)):da instanceof THREE.MeshBasicMaterial?(G.copy(da.color),da.vertexColors===THREE.FaceColors&&
(G.r*=la.color.r,G.g*=la.color.g,G.b*=la.color.b),r(F,L,P,N,Q,S,M,O),!0===da.wireframe?s(G,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):t(G)):da instanceof THREE.MeshNormalMaterial?(G.r=Ya(la.normalWorld.x),G.g=Ya(la.normalWorld.y),G.b=Ya(la.normalWorld.z),r(F,L,P,N,Q,S,M,O),!0===da.wireframe?s(G,da.wireframeLinewidth,da.wireframeLinecap,da.wireframeLinejoin):t(G)):da instanceof THREE.MeshDepthMaterial&&(La=l.near,ya=l.far,ba.r=ba.g=ba.b=1-Xa(ma.positionScreen.z,La,ya),ha.r=ha.g=
ha.b=1-Xa(bb.positionScreen.z,La,ya),Y.r=Y.g=Y.b=1-Xa(Fb.positionScreen.z,La,ya),ia.r=ia.g=ia.b=1-Xa(Eb.positionScreen.z,La,ya),pa=H(ba,ha,Y,ia),m(F,L,P,N,M,O),C(F,L,P,N,M,O,0,0,1,0,0,1,pa),m(R,$,Q,S,fa,Ha),C(R,$,Q,S,fa,Ha,1,0,1,1,0,1,pa));Sa.addRectangle(qa)}q.setTransform(1,0,0,1,0,0)}}};
...
S);Q.__lineDistanceArray=new Float32Array(1*S);Q.__webglLineCount=S;c(Q,ha);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.lineDistancesNeedUpdate=!0}}else if(b instanceof THREE.ParticleSystem&&(m=b.geometry,!m.__webglVertexBuffer))if(m instanceof THREE.Geometry){var ca=m;ca.__webglVertexBuffer=k.createBuffer();ca.__webglColorBuffer=k.createBuffer();G.info.memory.geometries++;var $=m,fa=b,ia=$.vertices.length;$.__vertexArray=new Float32Array(3*ia);$.__colorArray=new Float32Array(3*ia);$.__sortArray=
...
f;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);F(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=k.createFramebuffer(),a.__webglRenderbuffer=k.createRenderbuffer(),k.bindTexture(k.TEXTURE_2D,a.__webglTexture),K(k.TEXTURE_2D,a,c),k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=k.TEXTURE_2D,k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),k.framebufferTexture2D(k.FRAMEBUFFER,
k.COLOR_ATTACHMENT0,d,a.__webglTexture,0),F(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=rb,a=gb,d=nb,e=ka);b!==ia&&(k.bindFramebuffer(k.FRAMEBUFFER,b),k.viewport(d,e,c,a),ia=b);Aa=c;sb=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;
