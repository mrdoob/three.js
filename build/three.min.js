...
q=c[3],w=c[7],y=c[11],c=c[15],D=d[0],F=d[4],H=d[8],I=d[12],G=d[1],B=d[5],C=d[9],A=d[13],J=d[2],N=d[6],z=d[10],L=d[14],v=d[3],Z=d[7],K=d[11],d=d[15];e[0]=f*D+h*G+g*J+i*v;e[4]=f*F+h*B+g*N+i*Z;e[8]=f*H+h*C+g*z+i*K;e[12]=f*I+h*A+g*L+i*d;e[1]=j*D+m*G+p*J+l*v;e[5]=j*F+m*B+p*N+l*Z;e[9]=j*H+m*C+p*z+l*K;e[13]=j*I+m*A+p*L+l*d;e[2]=r*D+t*G+n*J+s*v;e[6]=r*F+t*B+n*N+s*Z;e[10]=r*H+t*C+n*z+s*K;e[14]=r*I+t*A+n*L+s*d;e[3]=q*D+w*G+y*J+c*v;e[7]=q*F+w*B+y*N+c*Z;e[11]=q*H+w*C+y*z+c*K;e[15]=q*I+w*A+y*L+c*d;return this},
...
b[12]=a.x;b[13]=a.y;b[14]=a.z;return this},getInverse:function(a,b){var c=this.elements,d=a.elements,e=d[0],f=d[4],h=d[8],g=d[12],i=d[1],j=d[5],m=d[9],p=d[13],l=d[2],r=d[6],t=d[10],n=d[14],s=d[3],q=d[7],w=d[11],y=d[15];c[0]=m*n*q-p*t*q+p*r*w-j*n*w-m*r*y+j*t*y;c[4]=g*t*q-h*n*q-g*r*w+f*n*w+h*r*y-f*t*y;c[8]=h*p*q-g*m*q+g*j*w-f*p*w-h*j*y+f*m*y;c[12]=g*m*r-h*p*r-g*j*t+f*p*t+h*j*n-f*m*n;c[1]=p*t*s-m*n*s-p*l*w+i*n*w+m*l*y-i*t*y;c[5]=h*n*s-g*t*s+g*l*w-e*n*w-h*l*y+e*t*y;c[9]=g*m*s-h*p*s-g*i*w+e*p*w+h*i*y-
e*m*y;c[13]=h*p*l-g*m*l+g*i*t-e*p*t-h*i*n+e*m*n;c[2]=j*n*s-p*r*s+p*l*q-i*n*q-j*l*y+i*r*y;c[6]=g*r*s-f*n*s-g*l*q+e*n*q+f*l*y-e*r*y;c[10]=f*p*s-g*j*s+g*i*q-e*p*q-f*i*y+e*j*y;c[14]=g*j*l-f*p*l-g*i*r+e*p*r+f*i*n-e*j*n;c[3]=m*r*s-j*t*s-m*l*q+i*t*q+j*l*w-i*r*w;c[7]=f*t*s-h*r*s+h*l*q-e*t*q-f*l*w+e*r*w;c[11]=h*j*s-f*m*s-h*i*q+e*m*q+f*i*w-e*j*w;c[15]=f*m*l-h*j*l+h*i*r-e*m*r-f*i*t+e*j*t;c=d[0]*c[0]+d[1]*c[4]+d[2]*c[8]+d[3]*c[12];if(0==c){if(b)throw Error("Matrix4.getInverse(): can't invert matrix, determinant is 0");
...
a.LOD)f.getPositionFromMatrix(g.matrixWorld),r=j.ray.origin.distanceTo(f),i(g.getObjectForDistance(r),j,l);else if(g instanceof a.Mesh){f.getPositionFromMatrix(g.matrixWorld);b.set(f,g.geometry.boundingSphere.radius*g.matrixWorld.getMaxScaleOnAxis());if(!j.ray.isIntersectionSphere(b))return l;var r=g.geometry,t=r.vertices,n=g.material instanceof a.MeshFaceMaterial,s=!0===n?g.material.materials:null,q=g.material.side,w,y,D,F=j.precision;h.getInverse(g.matrixWorld);c.copy(j.ray).applyMatrix4(h);for(var H=
0,I=r.faces.length;H<I;H++){var G=r.faces[H],q=!0===n?s[G.materialIndex]:g.material;if(void 0!==q){d.setFromNormalAndCoplanarPoint(G.normal,t[G.a]);var B=c.distanceToPlane(d);if(!(Math.abs(B)<F)&&!(0>B)){q=q.side;if(q!==a.DoubleSide&&(w=c.direction.dot(d.normal),!(q===a.FrontSide?0>w:0<w)))continue;if(!(B<j.near||B>j.far)){e=c.at(B,e);if(G instanceof a.Face3){if(q=t[G.a],w=t[G.b],y=t[G.c],!a.Triangle.containsPoint(e,q,w,y))continue}else if(G instanceof a.Face4){if(q=t[G.a],w=t[G.b],y=t[G.c],D=t[G.d],
!a.Triangle.containsPoint(e,q,w,D)&&!a.Triangle.containsPoint(e,w,y,D))continue}else throw Error("face type not supported");l.push({distance:B,point:j.ray.at(B),face:G,faceIndex:H,object:g})}}}}}},j=function(a,b,c){for(var a=a.getDescendants(),d=0,e=a.length;d<e;d++)i(a[d],b,c)};a.Raycaster.prototype.precision=1E-4;a.Raycaster.prototype.set=function(a,b){this.ray.set(a,b);0<this.ray.direction.length()&&this.ray.direction.normalize()};a.Raycaster.prototype.intersectObject=function(a,b){var c=[];!0===
...
q=0,w,y,D=[],F=0,H,I,G=[],B=0,C={objects:[],sprites:[],lights:[],elements:[]},A=new THREE.Vector3,J=new THREE.Vector4,N=new THREE.Box3(new THREE.Vector3(-1,-1,-1),new THREE.Vector3(1,1,1)),z=new THREE.Box3,L=Array(3),v=Array(4),Z=new THREE.Matrix4,K=new THREE.Matrix4,oa,Pa=new THREE.Matrix4,Va=new THREE.Matrix3,O=new THREE.Matrix3,qa=new THREE.Vector3,Fa=new THREE.Frustum,wa=new THREE.Vector4,M=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);K.multiplyMatrices(b.projectionMatrix,
...
1)%bb||(aa=j[i-2],wa.copy(T.positionScreen),M.copy(aa.positionScreen),!0===c(wa,M)&&(wa.multiplyScalar(1/wa.w),M.multiplyScalar(1/M.w),y===F?(xa=new THREE.RenderableLine,D.push(xa),F++,y++,w=xa):w=D[y++],w.v1.positionScreen.copy(wa),w.v2.positionScreen.copy(M),w.z=Math.max(wa.z,M.z),w.material=ma.material,ma.material.vertexColors===THREE.VertexColors&&(w.vertexColors[0].copy(ma.geometry.colors[A]),w.vertexColors[1].copy(ma.geometry.colors[A-1])),C.elements.push(w)))}d=0;for(h=C.sprites.length;d<h;d++)ma=
...
j.b.copy(e.vertexNormals[1]),j.c.copy(e.vertexNormals[2]),j.d.copy(e.vertexNormals[3]))}c=0;for(d=this.faces.length;c<d;c++)e=this.faces[c],e.normal=e.__originalFaceNormal,e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,z){g=a.vertices[b];i=a.vertices[c];j=a.vertices[d];m=h[e];p=h[f];l=h[z];r=i.x-g.x;t=j.x-g.x;n=i.y-g.y;s=j.y-g.y;q=i.z-g.z;w=j.z-g.z;y=p.x-m.x;D=l.x-m.x;F=p.y-m.y;H=l.y-m.y;I=1/(y*H-D*F);A.set((H*r-F*t)*I,(H*n-F*s)*I,(H*q-F*w)*I);J.set((y*
t-D*r)*I,(y*s-D*n)*I,(y*w-D*q)*I);B[b].add(A);B[c].add(A);B[d].add(A);C[b].add(J);C[c].add(J);C[d].add(J)}var b,c,d,e,f,h,g,i,j,m,p,l,r,t,n,s,q,w,y,D,F,H,I,G,B=[],C=[],A=new THREE.Vector3,J=new THREE.Vector3,N=new THREE.Vector3,z=new THREE.Vector3,L=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)B[b]=new THREE.Vector3,C[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],h=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&
(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var v=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<f.vertexNormals.length;d++)L.copy(f.vertexNormals[d]),e=f[v[d]],G=B[e],N.copy(G),N.sub(L.multiplyScalar(L.dot(G))).normalize(),z.crossVectors(f.vertexNormals[d],G),e=z.dot(C[e]),e=0>e?-1:1,f.vertexTangents[d]=new THREE.Vector4(N.x,N.y,N.z,e)}this.hasTangents=!0},computeLineDistances:function(){for(var a=0,b=this.vertices,c=0,d=b.length;c<d;c++)0<c&&(a+=b[c].distanceTo(b[c-
...
b,c,d;a=this.attributes.position.array.length;if(void 0===this.attributes.normal)this.attributes.normal={itemSize:3,array:new Float32Array(a),numItems:a};else{a=0;for(b=this.attributes.normal.array.length;a<b;a++)this.attributes.normal.array[a]=0}var e=this.attributes.position.array,f=this.attributes.normal.array,h,g,i,j,m,p,l=new THREE.Vector3,r=new THREE.Vector3,t=new THREE.Vector3,n=new THREE.Vector3,s=new THREE.Vector3;if(this.attributes.index){var q=this.attributes.index.array,w=this.offsets;
c=0;for(d=w.length;c<d;++c){b=w[c].start;h=w[c].count;var y=w[c].index;a=b;for(b+=h;a<b;a+=3)h=y+q[a],g=y+q[a+1],i=y+q[a+2],j=e[3*h],m=e[3*h+1],p=e[3*h+2],l.set(j,m,p),j=e[3*g],m=e[3*g+1],p=e[3*g+2],r.set(j,m,p),j=e[3*i],m=e[3*i+1],p=e[3*i+2],t.set(j,m,p),n.subVectors(t,r),s.subVectors(l,r),n.cross(s),f[3*h]+=n.x,f[3*h+1]+=n.y,f[3*h+2]+=n.z,f[3*g]+=n.x,f[3*g+1]+=n.y,f[3*g+2]+=n.z,f[3*i]+=n.x,f[3*i+1]+=n.y,f[3*i+2]+=n.z}}else{a=0;for(b=e.length;a<b;a+=9)j=e[a],m=e[a+1],p=e[a+2],l.set(j,m,p),j=e[a+
...
d=this.attributes.normal.array,e=this.attributes.uv.array,f=c.length/3;if(void 0===this.attributes.tangent){var h=4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(h),numItems:h}}for(var g=this.attributes.tangent.array,i=[],j=[],h=0;h<f;h++)i[h]=new THREE.Vector3,j[h]=new THREE.Vector3;var m,p,l,r,t,n,s,q,w,y,D,F,H,I,G,f=new THREE.Vector3,h=new THREE.Vector3,B,C,A,J,N,z,L,v=this.offsets;A=0;for(J=v.length;A<J;++A){C=v[A].start;N=v[A].count;var Z=v[A].index;B=C;for(C+=N;B<C;B+=3)N=Z+b[B],
z=Z+b[B+1],L=Z+b[B+2],m=c[3*N],p=c[3*N+1],l=c[3*N+2],r=c[3*z],t=c[3*z+1],n=c[3*z+2],s=c[3*L],q=c[3*L+1],w=c[3*L+2],y=e[2*N],D=e[2*N+1],F=e[2*z],H=e[2*z+1],I=e[2*L],G=e[2*L+1],r-=m,m=s-m,t-=p,p=q-p,n-=l,l=w-l,F-=y,y=I-y,H-=D,D=G-D,G=1/(F*D-y*H),f.set((D*r-H*m)*G,(D*t-H*p)*G,(D*n-H*l)*G),h.set((F*m-y*r)*G,(F*p-y*t)*G,(F*l-y*n)*G),i[N].add(f),i[z].add(f),i[L].add(f),j[N].add(h),j[z].add(h),j[L].add(h)}var K=new THREE.Vector3,oa=new THREE.Vector3,Pa=new THREE.Vector3,Va=new THREE.Vector3,O,qa,Fa;A=0;
for(J=v.length;A<J;++A){C=v[A].start;N=v[A].count;Z=v[A].index;B=C;for(C+=N;B<C;B+=3)N=Z+b[B],z=Z+b[B+1],L=Z+b[B+2],a(N),a(z),a(L)}this.tangentsNeedUpdate=this.hasTangents=!0}},dispose:function(){this.dispatchEvent({type:"dispose"})}};THREE.Camera=function(){THREE.Object3D.call(this);this.matrixWorldInverse=new THREE.Matrix4;this.projectionMatrix=new THREE.Matrix4;this.projectionMatrixInverse=new THREE.Matrix4};THREE.Camera.prototype=Object.create(THREE.Object3D.prototype);THREE.Camera.prototype.lookAt=function(){var a=new THREE.Matrix4;return function(b){a.lookAt(this.position,b,this.up);!0===this.useQuaternion?this.quaternion.setFromRotationMatrix(a):this.rotation.setEulerFromRotationMatrix(a,this.eulerOrder)}}();THREE.OrthographicCamera=function(a,b,c,d,e,f){THREE.Camera.call(this);this.left=a;this.right=b;this.top=c;this.bottom=d;this.near=void 0!==e?e:0.1;this.far=void 0!==f?f:2E3;this.updateProjectionMatrix()};THREE.OrthographicCamera.prototype=Object.create(THREE.Camera.prototype);THREE.OrthographicCamera.prototype.updateProjectionMatrix=function(){this.projectionMatrix.makeOrthographic(this.left,this.right,this.top,this.bottom,this.near,this.far)};THREE.PerspectiveCamera=function(a,b,c,d){THREE.Camera.call(this);this.fov=void 0!==a?a:50;this.aspect=void 0!==b?b:1;this.near=void 0!==c?c:0.1;this.far=void 0!==d?d:2E3;this.updateProjectionMatrix()};THREE.PerspectiveCamera.prototype=Object.create(THREE.Camera.prototype);THREE.PerspectiveCamera.prototype.setLens=function(a,b){void 0===b&&(b=24);this.fov=2*THREE.Math.radToDeg(Math.atan(b/(2*a)));this.updateProjectionMatrix()};
...
THREE.JSONLoader.prototype.parse=function(a,b){var c=new THREE.Geometry,d=void 0!==a.scale?1/a.scale:1,e,f,h,g,i,j,m,p,l,r,t,n,s,q,w,y=a.faces;r=a.vertices;var D=a.normals,F=a.colors,H=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&H++;for(e=0;e<H;e++)c.faceUvs[e]=[],c.faceVertexUvs[e]=[];g=0;for(i=r.length;g<i;)j=new THREE.Vector3,j.x=r[g++]*d,j.y=r[g++]*d,j.z=r[g++]*d,c.vertices.push(j);g=0;for(i=y.length;g<i;){r=y[g++];j=r&1;h=r&2;e=r&4;f=r&8;p=r&16;m=r&32;t=r&64;r&=128;j?(n=new THREE.Face4,n.a=
y[g++],n.b=y[g++],n.c=y[g++],n.d=y[g++],j=4):(n=new THREE.Face3,n.a=y[g++],n.b=y[g++],n.c=y[g++],j=3);h&&(h=y[g++],n.materialIndex=h);h=c.faces.length;if(e)for(e=0;e<H;e++)s=a.uvs[e],l=y[g++],w=s[2*l],l=s[2*l+1],c.faceUvs[e][h]=new THREE.Vector2(w,l);if(f)for(e=0;e<H;e++){s=a.uvs[e];q=[];for(f=0;f<j;f++)l=y[g++],w=s[2*l],l=s[2*l+1],q[f]=new THREE.Vector2(w,l);c.faceVertexUvs[e][h]=q}p&&(p=3*y[g++],f=new THREE.Vector3,f.x=D[p++],f.y=D[p++],f.z=D[p],n.normal=f);if(m)for(e=0;e<j;e++)p=3*y[g++],f=new THREE.Vector3,
...
c[7],c[8],c[9],c[10],c[11],c[12],c[13],c[14],c[15])):(s.position.fromArray(h),m?(s.quaternion.fromArray(m),s.useQuaternion=!0):s.rotation.fromArray(i),s.scale.fromArray(j));s.visible=q.visible;s.castShadow=q.castShadow;s.receiveShadow=q.receiveShadow;a.add(s);B.objects[l]=s}}else"DirectionalLight"===q.type||"PointLight"===q.type||"AmbientLight"===q.type?(y=void 0!==q.color?q.color:16777215,D=void 0!==q.intensity?q.intensity:1,"DirectionalLight"===q.type?(h=q.direction,w=new THREE.DirectionalLight(y,
D),w.position.fromArray(h),q.target&&(C.push({object:w,targetName:q.target}),w.target=null)):"PointLight"===q.type?(h=q.position,e=q.distance,w=new THREE.PointLight(y,D,e),w.position.fromArray(h)):"AmbientLight"===q.type&&(w=new THREE.AmbientLight(y)),a.add(w),w.name=l,B.lights[l]=w,B.objects[l]=w):"PerspectiveCamera"===q.type||"OrthographicCamera"===q.type?(h=q.position,i=q.rotation,m=q.quaternion,"PerspectiveCamera"===q.type?n=new THREE.PerspectiveCamera(q.fov,q.aspect,q.near,q.far):"OrthographicCamera"===
...
H},B);p.onLoadProgress();if(0===F&&0===H){for(var a=0;a<C.length;a++){var c=C[a],d=B.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,B.scene.add(c.object.target));c.object.target.userData.targetInverse=c.object}b(B)}}function m(a,b){b(a);if(void 0!==a.children)for(var c in a.children)m(a.children[c],b)}var p=this,l=THREE.Loader.prototype.extractUrlBase(c),r,t,n,s,q,w,y,D,F,H,I,G,B,C=[],A=a,J;for(J in this.geometryHandlerMap)a=this.geometryHandlerMap[J].loaderClass,this.geometryHandlerMap[J].loaderObject=
...
L&&(L=this.geometryHandlerMap.ascii.loaderObject.parse(L,""),i(z)(L.geometry,L.materials)));for(var v in A.textures)if(z=A.textures[v],z.url instanceof Array){H+=z.url.length;for(q=0;q<z.url.length;q++)p.onLoadStart()}else H+=1,p.onLoadStart();G=H;for(v in A.textures){z=A.textures[v];void 0!==z.mapping&&void 0!==THREE[z.mapping]&&(z.mapping=new THREE[z.mapping]);if(z.url instanceof Array){L=z.url.length;s=[];for(q=0;q<L;q++)s[q]=d(z.url[q],A.urlBaseType);q=(q=/\.dds$/i.test(s[0]))?THREE.ImageUtils.loadCompressedTextureCube(s,
...
(q.wrapT=THREE.RepeatWrapping)),z.offset&&q.offset.set(z.offset[0],z.offset[1]),z.wrap&&(L={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==L[z.wrap[0]]&&(q.wrapS=L[z.wrap[0]]),void 0!==L[z.wrap[1]]&&(q.wrapT=L[z.wrap[1]]));B.textures[v]=q}var Z,K;for(Z in A.materials){v=A.materials[Z];for(K in v.parameters)"envMap"===K||"map"===K||"lightMap"===K||"bumpMap"===K?v.parameters[K]=B.textures[v.parameters[K]]:"shading"===K?v.parameters[K]="flat"===v.parameters[K]?THREE.FlatShading:
THREE.SmoothShading:"side"===K?v.parameters[K]="double"==v.parameters[K]?THREE.DoubleSide:"back"==v.parameters[K]?THREE.BackSide:THREE.FrontSide:"blending"===K?v.parameters[K]=v.parameters[K]in THREE?THREE[v.parameters[K]]:THREE.NormalBlending:"combine"===K?v.parameters[K]=v.parameters[K]in THREE?THREE[v.parameters[K]]:THREE.MultiplyOperation:"vertexColors"===K?"face"==v.parameters[K]?v.parameters[K]=THREE.FaceColors:v.parameters[K]&&(v.parameters[K]=THREE.VertexColors):"wrapRGB"===K&&(J=v.parameters[K],
v.parameters[K]=new THREE.Vector3(J[0],J[1],J[2]));void 0!==v.parameters.opacity&&1>v.parameters.opacity&&(v.parameters.transparent=!0);v.parameters.normalMap?(J=THREE.ShaderLib.normalmap,z=THREE.UniformsUtils.clone(J.uniforms),q=v.parameters.color,L=v.parameters.specular,s=v.parameters.ambient,N=v.parameters.shininess,z.tNormal.value=B.textures[v.parameters.normalMap],v.parameters.normalScale&&z.uNormalScale.value.set(v.parameters.normalScale[0],v.parameters.normalScale[1]),v.parameters.map&&(z.tDiffuse.value=
v.parameters.map,z.enableDiffuse.value=!0),v.parameters.envMap&&(z.tCube.value=v.parameters.envMap,z.enableReflection.value=!0,z.uReflectivity.value=v.parameters.reflectivity),v.parameters.lightMap&&(z.tAO.value=v.parameters.lightMap,z.enableAO.value=!0),v.parameters.specularMap&&(z.tSpecular.value=B.textures[v.parameters.specularMap],z.enableSpecular.value=!0),v.parameters.displacementMap&&(z.tDisplacement.value=B.textures[v.parameters.displacementMap],z.enableDisplacement.value=!0,z.uDisplacementBias.value=
v.parameters.displacementBias,z.uDisplacementScale.value=v.parameters.displacementScale),z.uDiffuseColor.value.setHex(q),z.uSpecularColor.value.setHex(L),z.uAmbientColor.value.setHex(s),z.uShininess.value=N,v.parameters.opacity&&(z.uOpacity.value=v.parameters.opacity),t=new THREE.ShaderMaterial({fragmentShader:J.fragmentShader,vertexShader:J.vertexShader,uniforms:z,lights:!0,fog:!0})):t=new THREE[v.type](v.parameters);t.name=Z;B.materials[Z]=t}for(Z in A.materials)if(v=A.materials[Z],v.parameters.materials){K=
[];for(q=0;q<v.parameters.materials.length;q++)K.push(B.materials[v.parameters.materials[q]]);B.materials[Z].materials=K}e();B.cameras&&A.defaults.camera&&(B.currentCamera=B.cameras[A.defaults.camera]);B.fogs&&A.defaults.fog&&(B.scene.fog=B.fogs[A.defaults.fog]);p.callbackSync(B);j()};THREE.TextureLoader=function(){this.crossOrigin=null};
...
-N),new THREE.Vector2(J,N));Z=1;K=0;qa=O=Va=Pa=oa=null};this.setClearColor=function(a,b){L.set(a);v=void 0!==b?b:1;na.set(new THREE.Vector2(-J,-N),new THREE.Vector2(J,N))};this.setClearColorHex=function(a,b){console.warn("DEPRECATED: .setClearColorHex() is being removed. Use .setClearColor() instead.");this.setClearColor(a,b)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){z.setTransform(1,0,0,-1,J,N);!1===na.empty()&&(na.intersect(fb),na.expandByScalar(2),1>v&&z.clearRect(na.min.x|
0,na.min.y|0,na.max.x-na.min.x|0,na.max.y-na.min.y|0),0<v&&(l(THREE.NormalBlending),p(1),q("rgba("+Math.floor(255*L.r)+","+Math.floor(255*L.g)+","+Math.floor(255*L.b)+","+v+")"),z.fillRect(na.min.x|0,na.min.y|0,na.max.x-na.min.x|0,na.max.y-na.min.y|0)),na.makeEmpty())};this.render=function(a,g){if(!1===g instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{!0===this.autoClear&&this.clear();z.setTransform(1,0,0,-1,J,N);D.info.render.vertices=
0;D.info.render.faces=0;F=G.projectScene(a,g,this.sortObjects,this.sortElements);H=F.elements;I=F.lights;M=g;ib.setRGB(0,0,0);Tb.setRGB(0,0,0);Ub.setRGB(0,0,0);for(var k=0,B=I.length;k<B;k++){var v=I[k],A=v.color;v instanceof THREE.AmbientLight?ib.add(A):v instanceof THREE.DirectionalLight?Tb.add(A):v instanceof THREE.PointLight&&Ub.add(A)}k=0;for(B=H.length;k<B;k++){var U=H[k],v=U.material;if(!(void 0===v||!1===v.visible)){va.makeEmpty();if(U instanceof THREE.RenderableParticle){V=U;V.x*=J;V.y*=
N;A=V;p(v.opacity);l(v.blending);var mb=void 0,nb=void 0,vb=void 0,zb=void 0,Zb=void 0,Jc=void 0,Kc=void 0;v instanceof THREE.ParticleBasicMaterial?null===v.map?(vb=U.object.scale.x,zb=U.object.scale.y,vb*=U.scale.x*J,zb*=U.scale.y*N,va.min.set(A.x-vb,A.y-zb),va.max.set(A.x+vb,A.y+zb),!1===fb.isIntersectionBox(va)?va.makeEmpty():(q(v.color.getStyle()),z.save(),z.translate(A.x,A.y),z.rotate(-U.rotation),z.scale(vb,zb),z.fillRect(-1,-1,2,2),z.restore())):(Zb=v.map.image,Jc=Zb.width>>1,Kc=Zb.height>>
1,vb=U.scale.x*J,zb=U.scale.y*N,mb=vb*Jc,nb=zb*Kc,va.min.set(A.x-mb,A.y-nb),va.max.set(A.x+mb,A.y+nb),!1===fb.isIntersectionBox(va)?va.makeEmpty():(z.save(),z.translate(A.x,A.y),z.rotate(-U.rotation),z.scale(vb,-zb),z.translate(-Jc,-Kc),z.drawImage(Zb,0,0),z.restore())):v instanceof THREE.ParticleCanvasMaterial&&(mb=U.scale.x*J,nb=U.scale.y*N,va.min.set(A.x-mb,A.y-nb),va.max.set(A.x+mb,A.y+nb),!1===fb.isIntersectionBox(va)?va.makeEmpty():(s(v.color.getStyle()),q(v.color.getStyle()),z.save(),z.translate(A.x,
A.y),z.rotate(-U.rotation),z.scale(mb,nb),v.program(z),z.restore()))}else if(U instanceof THREE.RenderableLine){if(V=U.v1,ea=U.v2,V.positionScreen.x*=J,V.positionScreen.y*=N,ea.positionScreen.x*=J,ea.positionScreen.y*=N,va.setFromPoints([V.positionScreen,ea.positionScreen]),!0===fb.isIntersectionBox(va))if(A=V,mb=ea,p(v.opacity),l(v.blending),z.beginPath(),z.moveTo(A.positionScreen.x,A.positionScreen.y),z.lineTo(mb.positionScreen.x,mb.positionScreen.y),v instanceof THREE.LineBasicMaterial){r(v.linewidth);
t(v.linecap);n(v.linejoin);if(v.vertexColors!==THREE.VertexColors)s(v.color.getStyle());else if(nb=U.vertexColors[0].getStyle(),U=U.vertexColors[1].getStyle(),nb===U)s(nb);else{try{var wc=z.createLinearGradient(A.positionScreen.x,A.positionScreen.y,mb.positionScreen.x,mb.positionScreen.y);wc.addColorStop(0,nb);wc.addColorStop(1,U)}catch(fd){wc=nb}s(wc)}z.stroke();va.expandByScalar(2*v.linewidth)}else v instanceof THREE.LineDashedMaterial&&(r(v.linewidth),t(v.linecap),n(v.linejoin),s(v.color.getStyle()),
w(v.dashSize,v.gapSize),z.stroke(),va.expandByScalar(2*v.linewidth),w(null,null))}else if(U instanceof THREE.RenderableFace3){V=U.v1;ea=U.v2;pa=U.v3;if(-1>V.positionScreen.z||1<V.positionScreen.z)continue;if(-1>ea.positionScreen.z||1<ea.positionScreen.z)continue;if(-1>pa.positionScreen.z||1<pa.positionScreen.z)continue;V.positionScreen.x*=J;V.positionScreen.y*=N;ea.positionScreen.x*=J;ea.positionScreen.y*=N;pa.positionScreen.x*=J;pa.positionScreen.y*=N;0<v.overdraw&&(m(V.positionScreen,ea.positionScreen,
v.overdraw),m(ea.positionScreen,pa.positionScreen,v.overdraw),m(pa.positionScreen,V.positionScreen,v.overdraw));va.setFromPoints([V.positionScreen,ea.positionScreen,pa.positionScreen]);!0===fb.isIntersectionBox(va)&&c(V,ea,pa,0,1,2,U,v)}else if(U instanceof THREE.RenderableFace4){V=U.v1;ea=U.v2;pa=U.v3;Ua=U.v4;if(-1>V.positionScreen.z||1<V.positionScreen.z)continue;if(-1>ea.positionScreen.z||1<ea.positionScreen.z)continue;if(-1>pa.positionScreen.z||1<pa.positionScreen.z)continue;if(-1>Ua.positionScreen.z||
1<Ua.positionScreen.z)continue;V.positionScreen.x*=J;V.positionScreen.y*=N;ea.positionScreen.x*=J;ea.positionScreen.y*=N;pa.positionScreen.x*=J;pa.positionScreen.y*=N;Ua.positionScreen.x*=J;Ua.positionScreen.y*=N;pb.positionScreen.copy(ea.positionScreen);ub.positionScreen.copy(Ua.positionScreen);0<v.overdraw&&(m(V.positionScreen,ea.positionScreen,v.overdraw),m(ea.positionScreen,Ua.positionScreen,v.overdraw),m(Ua.positionScreen,V.positionScreen,v.overdraw),m(pa.positionScreen,pb.positionScreen,v.overdraw),
m(pa.positionScreen,ub.positionScreen,v.overdraw));va.setFromPoints([V.positionScreen,ea.positionScreen,pa.positionScreen,Ua.positionScreen]);!0===fb.isIntersectionBox(va)&&(A=V,mb=ea,nb=pa,vb=Ua,zb=pb,Zb=ub,D.info.render.vertices+=4,D.info.render.faces++,p(v.opacity),l(v.blending),void 0!==v.map&&null!==v.map||void 0!==v.envMap&&null!==v.envMap?(c(A,mb,vb,0,1,3,U,v),c(zb,nb,Zb,1,2,3,U,v)):(ya=A.positionScreen.x,Ha=A.positionScreen.y,fa=mb.positionScreen.x,da=mb.positionScreen.y,T=nb.positionScreen.x,
aa=nb.positionScreen.y,la=vb.positionScreen.x,Y=vb.positionScreen.y,ma=zb.positionScreen.x,xa=zb.positionScreen.y,bb=Zb.positionScreen.x,ia=Zb.positionScreen.y,v instanceof THREE.MeshLambertMaterial||v instanceof THREE.MeshPhongMaterial?(Qa.copy(v.color),Ya.copy(v.emissive),v.vertexColors===THREE.FaceColors&&Qa.multiply(U.color),!1===v.wireframe&&v.shading==THREE.SmoothShading&&4==U.vertexNormalsLength?(ra.copy(ib),ka.copy(ib),ua.copy(ib),Ra.copy(ib),b(U.v1.positionWorld,U.vertexNormalsModel[0],ra),
b(U.v2.positionWorld,U.vertexNormalsModel[1],ka),b(U.v4.positionWorld,U.vertexNormalsModel[3],ua),b(U.v3.positionWorld,U.vertexNormalsModel[2],Ra),ra.multiply(Qa).add(Ya),ka.multiply(Qa).add(Ya),ua.multiply(Qa).add(Ya),Ra.multiply(Qa).add(Ya),lb=j(ra,ka,ua,Ra),d(ya,Ha,fa,da,la,Y),i(ya,Ha,fa,da,la,Y,0,0,1,0,0,1,lb),d(ma,xa,T,aa,bb,ia),i(ma,xa,T,aa,bb,ia,1,0,1,1,0,1,lb)):(ha.copy(ib),b(U.centroidModel,U.normalModel,ha),ha.multiply(Qa).add(Ya),e(ya,Ha,fa,da,T,aa,la,Y),!0===v.wireframe?f(ha,v.wireframeLinewidth,
v.wireframeLinecap,v.wireframeLinejoin):h(ha))):v instanceof THREE.MeshBasicMaterial?(ha.copy(v.color),v.vertexColors===THREE.FaceColors&&ha.multiply(U.color),e(ya,Ha,fa,da,T,aa,la,Y),!0===v.wireframe?f(ha,v.wireframeLinewidth,v.wireframeLinecap,v.wireframeLinejoin):h(ha)):v instanceof THREE.MeshNormalMaterial?(A=void 0,v.shading==THREE.FlatShading?(A=U.normalModelView,ha.setRGB(A.x,A.y,A.z).multiplyScalar(0.5).addScalar(0.5),e(ya,Ha,fa,da,T,aa,la,Y),!0===v.wireframe?f(ha,v.wireframeLinewidth,v.wireframeLinecap,
v.wireframeLinejoin):h(ha)):v.shading==THREE.SmoothShading&&(A=U.vertexNormalsModelView[0],ra.setRGB(A.x,A.y,A.z).multiplyScalar(0.5).addScalar(0.5),A=U.vertexNormalsModelView[1],ka.setRGB(A.x,A.y,A.z).multiplyScalar(0.5).addScalar(0.5),A=U.vertexNormalsModelView[3],ua.setRGB(A.x,A.y,A.z).multiplyScalar(0.5).addScalar(0.5),A=U.vertexNormalsModelView[2],Ra.setRGB(A.x,A.y,A.z).multiplyScalar(0.5).addScalar(0.5),lb=j(ra,ka,ua,Ra),d(ya,Ha,fa,da,la,Y),i(ya,Ha,fa,da,la,Y,0,0,1,0,0,1,lb),d(ma,xa,T,aa,bb,
ia),i(ma,xa,T,aa,bb,ia,1,0,1,1,0,1,lb))):v instanceof THREE.MeshDepthMaterial&&(Sa=M.near,xb=M.far,ra.r=ra.g=ra.b=1-y(A.positionScreen.z*A.positionScreen.w,Sa,xb),ka.r=ka.g=ka.b=1-y(mb.positionScreen.z*mb.positionScreen.w,Sa,xb),ua.r=ua.g=ua.b=1-y(vb.positionScreen.z*vb.positionScreen.w,Sa,xb),Ra.r=Ra.g=Ra.b=1-y(nb.positionScreen.z*nb.positionScreen.w,Sa,xb),lb=j(ra,ka,ua,Ra),d(ya,Ha,fa,da,la,Y),i(ya,Ha,fa,da,la,Y,0,0,1,0,0,1,lb),d(ma,xa,T,aa,bb,ia),i(ma,xa,T,aa,bb,ia,1,0,1,1,0,1,lb))))}na.union(va)}}z.setTransform(1,
...
f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)M.autoScaleCubemaps&&!f?(m=j,q=l,t=c.image[l],y=Ub,t.width<=y&&t.height<=y||(z=Math.max(t.width,t.height),w=Math.floor(t.width*y/z),y=Math.floor(t.height*y/z),z=document.createElement("canvas"),z.width=w,z.height=y,z.getContext("2d").drawImage(t,0,0,t.width,t.height,0,0,w,y),t=z),m[q]=t):j[l]=c.image[l];l=j[0];m=0===(l.width&l.width-
1)&&0===(l.height&l.height-1);q=v(c.format);t=v(c.type);N(k.TEXTURE_CUBE_MAP,c,m);for(l=0;6>l;l++)if(f){y=j[l].mipmaps;z=0;for(A=y.length;z<A;z++)w=y[z],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,z,q,w.width,w.height,0,w.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,q,q,t,j[l]);c.generateMipmaps&&m&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else q instanceof
...
metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,w,y,d=[];m?d.push(m):(d.push(s),d.push(q));for(w in r)d.push(w),d.push(r[w]);for(t in c)d.push(t),d.push(c[t]);m=d.join();t=0;for(w=V.length;t<w;t++)if(d=V[t],d.code===m){d.usedTimes++;j=d.program;break a}t="SHADOWMAP_TYPE_BASIC";c.shadowMapType===THREE.PCFShadowMap?t="SHADOWMAP_TYPE_PCF":c.shadowMapType===THREE.PCFSoftShadowMap&&(t="SHADOWMAP_TYPE_PCF_SOFT");w=[];for(y in r)d=
r[y],!1!==d&&(d="#define "+y+" "+d,w.push(d));d=w.join("\n");y=k.createProgram();w=["precision "+K+" float;",d,Gb?"#define VERTEX_TEXTURES":"",M.gammaInput?"#define GAMMA_INPUT":"",M.gammaOutput?"#define GAMMA_OUTPUT":"",M.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_HEMI_LIGHTS "+c.maxHemiLights,"#define MAX_SHADOWS "+c.maxShadows,"#define MAX_BONES "+
...
"",c.shadowMapEnabled?"#define USE_SHADOWMAP":"",c.shadowMapEnabled?"#define "+t:"",c.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",c.shadowMapCascade?"#define SHADOWMAP_CASCADE":"","uniform mat4 viewMatrix;\nuniform vec3 cameraPosition;\n"].join("\n");w=J("vertex",w+q);t=J("fragment",t+s);k.attachShader(y,w);k.attachShader(y,t);k.linkProgram(y);k.getProgramParameter(y,k.LINK_STATUS)||console.error("Could not initialise shader\nVALIDATE_STATUS: "+k.getProgramParameter(y,k.VALIDATE_STATUS)+", gl error ["+
k.getError()+"]");k.deleteShader(t);k.deleteShader(w);y.uniforms={};y.attributes={};var v;t="viewMatrix modelViewMatrix projectionMatrix normalMatrix modelMatrix cameraPosition morphTargetInfluences".split(" ");c.useVertexTexture?t.push("boneTexture"):t.push("boneGlobalMatrices");for(v in n)t.push(v);v=t;t=0;for(w=v.length;t<w;t++)n=v[t],y.uniforms[n]=k.getUniformLocation(y,n);t="position normal uv uv2 tangent color skinIndex skinWeight lineDistance".split(" ");for(v=0;v<c.maxMorphTargets;v++)t.push("morphTarget"+
v);for(v=0;v<c.maxMorphNormals;v++)t.push("morphNormal"+v);for(j in b)t.push(j);j=t;v=0;for(b=j.length;v<b;v++)t=j[v],y.attributes[t]=k.getAttribLocation(y,t);y.id=ea++;V.push({program:y,code:m,usedTimes:1});M.info.memory.programs=V.length;j=y}a.program=j;v=a.program.attributes;if(a.morphTargets){a.numSupportedMorphTargets=0;b="morphTarget";for(j=0;j<this.maxMorphTargets;j++)y=b+j,0<=v[y]&&a.numSupportedMorphTargets++}if(a.morphNormals){a.numSupportedMorphNormals=0;b="morphNormal";for(j=0;j<this.maxMorphNormals;j++)y=
b+j,0<=v[y]&&a.numSupportedMorphNormals++}a.uniformsList=[];for(i in a.uniforms)a.uniformsList.push([a.uniforms[i],i])};this.setFaceCulling=function(a,b){a===THREE.CullFaceNone?k.disable(k.CULL_FACE):(b===THREE.FrontFaceDirectionCW?k.frontFace(k.CW):k.frontFace(k.CCW),a===THREE.CullFaceBack?k.cullFace(k.BACK):a===THREE.CullFaceFront?k.cullFace(k.FRONT):k.cullFace(k.FRONT_AND_BACK),k.enable(k.CULL_FACE))};this.setMaterialFaces=function(a){var b=a.side===THREE.DoubleSide,a=a.side===THREE.BackSide;da!==
...
la=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.addEventListener("dispose",lc),a.__webglTexture=k.createTexture(),M.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);k.pixelStorei(k.UNPACK_ALIGNMENT,a.unpackAlignment);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=v(a.format),
...
k.createTexture();M.info.memory.textures++;var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=v(a.format),e=v(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];k.bindTexture(k.TEXTURE_CUBE_MAP,a.__webglTexture);N(k.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=k.createFramebuffer();a.__webglRenderbuffer[f]=k.createRenderbuffer();k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var h=a,g=k.TEXTURE_CUBE_MAP_POSITIVE_X+f;k.bindFramebuffer(k.FRAMEBUFFER,
...
c+d;m=b[a++]*c;r=b[a++]*c+d;t=b[a++]*c;e.quadraticCurveTo(r,t,i,m);if(h=f[f.length-1]){p=h.x;l=h.y;h=1;for(g=this.divisions;h<=g;h++){var w=h/g;THREE.Shape.Utils.b2(w,p,r,i);THREE.Shape.Utils.b2(w,l,t,m)}}break;case "b":if(i=b[a++]*c+d,m=b[a++]*c,r=b[a++]*c+d,t=b[a++]*-c,n=b[a++]*c+d,s=b[a++]*-c,e.bezierCurveTo(i,m,r,t,n,s),h=f[f.length-1]){p=h.x;l=h.y;h=1;for(g=this.divisions;h<=g;h++)w=h/g,THREE.Shape.Utils.b3(w,p,r,n,i),THREE.Shape.Utils.b3(w,l,t,s,m)}}}return{offset:q.ha*c,path:e}}}};
THREE.FontUtils.generateShapes=function(a,b){var b=b||{},c=void 0!==b.curveSegments?b.curveSegments:4,d=void 0!==b.font?b.font:"helvetiker",e=void 0!==b.weight?b.weight:"normal",f=void 0!==b.style?b.style:"normal";THREE.FontUtils.size=void 0!==b.size?b.size:100;THREE.FontUtils.divisions=c;THREE.FontUtils.face=d;THREE.FontUtils.weight=e;THREE.FontUtils.style=f;c=THREE.FontUtils.drawText(a).paths;d=[];e=0;for(f=c.length;e<f;e++)Array.prototype.push.apply(d,c[e].toShapes());return d};
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,h=0;h<b;f=h++)e+=a[f].x*a[h].y-a[h].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],h=[],g=[],i,j,m;if(0<b(a))for(j=0;j<e;j++)h[j]=j;else for(j=0;j<e;j++)h[j]=e-1-j;var p=2*e;for(j=e-1;2<e;){if(0>=p--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);m=j+1;e<=m&&(m=0);var l;a:{var r=l=void 0,t=void 0,n=void 0,s=void 0,q=void 0,w=void 0,y=void 0,D=
void 0,r=a[h[i]].x,t=a[h[i]].y,n=a[h[j]].x,s=a[h[j]].y,q=a[h[m]].x,w=a[h[m]].y;if(1E-10>(n-r)*(w-t)-(s-t)*(q-r))l=!1;else{var F=void 0,H=void 0,I=void 0,G=void 0,B=void 0,C=void 0,A=void 0,J=void 0,N=void 0,z=void 0,N=J=A=D=y=void 0,F=q-n,H=w-s,I=r-q,G=t-w,B=n-r,C=s-t;for(l=0;l<e;l++)if(!(l===i||l===j||l===m))if(y=a[h[l]].x,D=a[h[l]].y,A=y-r,J=D-t,N=y-n,z=D-s,y-=q,D-=w,N=F*z-H*N,A=B*J-C*A,J=I*D-G*y,0<=N&&0<=J&&0<=A){l=!1;break a}l=!0}}if(l){f.push([a[h[i]],a[h[j]],a[h[m]]]);g.push([h[i],h[j],h[m]]);
...
f[e+1],h]);this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,a)};THREE.CircleGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CubeGeometry=function(a,b,c,d,e,f){function h(a,b,c,d,e,f,h,n){var s,q=g.widthSegments,w=g.heightSegments,y=e/2,D=f/2,F=g.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)s="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)s="y",w=g.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)s="x",q=g.depthSegments;var H=q+1,I=w+1,G=e/q,B=f/w,C=new THREE.Vector3;C[s]=0<h?1:-1;for(e=0;e<I;e++)for(f=0;f<H;f++){var A=new THREE.Vector3;A[a]=(f*G-y)*c;A[b]=(e*B-D)*d;A[s]=h;g.vertices.push(A)}for(e=
0;e<w;e++)for(f=0;f<q;f++)a=new THREE.Face4(f+H*e+F,f+H*(e+1)+F,f+1+H*(e+1)+F,f+1+H*e+F),a.normal.copy(C),a.vertexNormals.push(C.clone(),C.clone(),C.clone(),C.clone()),a.materialIndex=n,g.faces.push(a),g.faceVertexUvs[0].push([new THREE.Vector2(f/q,1-e/w),new THREE.Vector2(f/q,1-(e+1)/w),new THREE.Vector2((f+1)/q,1-(e+1)/w),new THREE.Vector2((f+1)/q,1-e/w)])}THREE.Geometry.call(this);var g=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=
...
1-r))}j.push(p);m.push(l)}c=(b-a)/c;for(g=0;g<d;g++){0!==a?(p=this.vertices[j[0][g]].clone(),l=this.vertices[j[0][g+1]].clone()):(p=this.vertices[j[1][g]].clone(),l=this.vertices[j[1][g+1]].clone());p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();l.setY(Math.sqrt(l.x*l.x+l.z*l.z)*c).normalize();for(i=0;i<e;i++){var r=j[i][g],t=j[i+1][g],n=j[i+1][g+1],s=j[i][g+1],q=p.clone(),w=p.clone(),y=l.clone(),D=l.clone(),F=m[i][g].clone(),H=m[i+1][g].clone(),I=m[i+1][g+1].clone(),G=m[i][g+1].clone();this.faces.push(new THREE.Face4(r,
t,n,s,[q,w,y,D]));this.faceVertexUvs[0].push([F,H,I,G])}}if(!1===f&&0<a){this.vertices.push(new THREE.Vector3(0,h,0));for(g=0;g<d;g++)r=j[0][g],t=j[0][g+1],n=this.vertices.length-1,q=new THREE.Vector3(0,1,0),w=new THREE.Vector3(0,1,0),y=new THREE.Vector3(0,1,0),F=m[0][g].clone(),H=m[0][g+1].clone(),I=new THREE.Vector2(H.u,0),this.faces.push(new THREE.Face3(r,t,n,[q,w,y])),this.faceVertexUvs[0].push([F,H,I])}if(!1===f&&0<b){this.vertices.push(new THREE.Vector3(0,-h,0));for(g=0;g<d;g++)r=j[i][g+1],
t=j[i][g],n=this.vertices.length-1,q=new THREE.Vector3(0,-1,0),w=new THREE.Vector3(0,-1,0),y=new THREE.Vector3(0,-1,0),F=m[i][g+1].clone(),H=m[i][g].clone(),I=new THREE.Vector2(H.u,1),this.faces.push(new THREE.Face3(r,t,n,[q,w,y])),this.faceVertexUvs[0].push([F,H,I])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(a,b){for(var c=a.length,d=0;d<c;d++)this.addShape(a[d],b)};
...
g=0;g<h;g++){var i=oa*g,j=oa*(g+1),l=d+e+i,i=d+f+i,p=d+f+j,j=d+e+j,n=c,q=g,s=h,t=e,v=f,l=l+J,i=i+J,p=p+J,j=j+J;A.faces.push(new THREE.Face4(l,i,p,j,null,null,w));l=y.generateSideWallUV(A,a,n,b,l,i,p,j,q,s,t,v);A.faceVertexUvs[0].push(l)}}}function f(a,b,c){A.vertices.push(new THREE.Vector3(a,b,c))}function h(c,d,e,f){c+=J;d+=J;e+=J;A.faces.push(new THREE.Face3(c,d,e,null,null,q));c=f?y.generateBottomUV(A,a,b,c,d,e):y.generateTopUV(A,a,b,c,d,e);A.faceVertexUvs[0].push(c)}var g=void 0!==b.amount?b.amount:
100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,m=void 0!==b.bevelSegments?b.bevelSegments:3,p=void 0!==b.bevelEnabled?b.bevelEnabled:!0,l=void 0!==b.curveSegments?b.curveSegments:12,r=void 0!==b.steps?b.steps:1,t=b.extrudePath,n,s=!1,q=b.material,w=b.extrudeMaterial,y=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,D,F,H,I;t&&(n=t.getSpacedPoints(r),s=!0,p=!1,D=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(t,r,
!1),F=new THREE.Vector3,H=new THREE.Vector3,I=new THREE.Vector3);p||(j=i=m=0);var G,B,C,A=this,J=this.vertices.length,l=a.extractPoints(l),N=l.shape,l=l.holes;if(t=!THREE.Shape.Utils.isClockWise(N)){N=N.reverse();B=0;for(C=l.length;B<C;B++)G=l[B],THREE.Shape.Utils.isClockWise(G)&&(l[B]=G.reverse());t=!1}var z=THREE.Shape.Utils.triangulateShape(N,l),t=N;B=0;for(C=l.length;B<C;B++)G=l[B],N=N.concat(G);var L,v,Z,K,oa=N.length,Pa=z.length,Va=[],O=0,qa=t.length;L=qa-1;for(v=O+1;O<qa;O++,L++,v++)L===qa&&
(L=0),v===qa&&(v=0),Va[O]=d(t[O],t[L],t[v]);var Fa=[],wa,M=Va.concat();B=0;for(C=l.length;B<C;B++){G=l[B];wa=[];O=0;qa=G.length;L=qa-1;for(v=O+1;O<qa;O++,L++,v++)L===qa&&(L=0),v===qa&&(v=0),wa[O]=d(G[O],G[L],G[v]);Fa.push(wa);M=M.concat(wa)}for(L=0;L<m;L++){G=L/m;Z=i*(1-G);v=j*Math.sin(G*Math.PI/2);O=0;for(qa=t.length;O<qa;O++)K=c(t[O],Va[O],v),f(K.x,K.y,-Z);B=0;for(C=l.length;B<C;B++){G=l[B];wa=Fa[B];O=0;for(qa=G.length;O<qa;O++)K=c(G[O],wa[O],v),f(K.x,K.y,-Z)}}v=j;for(O=0;O<oa;O++)K=p?c(N[O],M[O],
v):N[O],s?(H.copy(D.normals[0]).multiplyScalar(K.x),F.copy(D.binormals[0]).multiplyScalar(K.y),I.copy(n[0]).add(H).add(F),f(I.x,I.y,I.z)):f(K.x,K.y,0);for(G=1;G<=r;G++)for(O=0;O<oa;O++)K=p?c(N[O],M[O],v):N[O],s?(H.copy(D.normals[G]).multiplyScalar(K.x),F.copy(D.binormals[G]).multiplyScalar(K.y),I.copy(n[G]).add(H).add(F),f(I.x,I.y,I.z)):f(K.x,K.y,g/r*G);for(L=m-1;0<=L;L--){G=L/m;Z=i*(1-G);v=j*Math.sin(G*Math.PI/2);O=0;for(qa=t.length;O<qa;O++)K=c(t[O],Va[O],v),f(K.x,K.y,g+Z);B=0;for(C=l.length;B<
C;B++){G=l[B];wa=Fa[B];O=0;for(qa=G.length;O<qa;O++)K=c(G[O],wa[O],v),s?f(K.x,K.y+n[r-1].y,n[r-1].x+Z):f(K.x,K.y,g+Z)}}if(p){i=0*oa;for(O=0;O<Pa;O++)g=z[O],h(g[2]+i,g[1]+i,g[0]+i,!0);i=oa*(r+2*m);for(O=0;O<Pa;O++)g=z[O],h(g[0]+i,g[1]+i,g[2]+i,!1)}else{for(O=0;O<Pa;O++)g=z[O],h(g[2],g[1],g[0],!0);for(O=0;O<Pa;O++)g=z[O],h(g[0]+oa*r,g[1]+oa*r,g[2]+oa*r,!1)}g=0;e(t,g);g+=t.length;B=0;for(C=l.length;B<C;B++)G=l[B],e(G,g),g+=G.length};
...
m);Math.pow(4,m);for(var m=e(g.vertices[l.a]),p=e(g.vertices[l.b]),t=e(g.vertices[l.c]),l=[],r=0;r<=b;r++){l[r]=[];for(var n=e(m.clone().lerp(t,r/b)),s=e(p.clone().lerp(t,r/b)),q=b-r,w=0;w<=q;w++)l[r][w]=0==w&&r==b?n:e(n.clone().lerp(s,w/q))}for(r=0;r<b;r++)for(w=0;w<2*(b-r)-1;w++)m=Math.floor(w/2),0==w%2?f(l[r][m+1],l[r+1][m],l[r][m]):f(l[r][m+1],l[r+1][m+1],l[r+1][m])}i=0;for(j=this.faceVertexUvs[0].length;i<j;i++)d=this.faceVertexUvs[0][i],a=d[0].x,b=d[1].x,m=d[2].x,p=Math.max(a,Math.max(b,m)),
...
b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,i);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);L.positionScreen.copy(B);L.customUpdateCallback?L.customUpdateCallback(L):L.updateLensFlares();b.uniform1i(A.renderType,2);b.enable(b.BLEND);N=0;for(z=L.lensFlares.length;N<z;N++)v=L.lensFlares[N],0.001<v.opacity&&0.001<v.scale&&(B.x=v.x,B.y=v.y,B.z=v.z,I=v.size*v.scale/f,G.x=I*D,G.y=I,b.uniform3f(A.screenPosition,B.x,B.y,B.z),b.uniform2f(A.scale,G.x,G.y),b.uniform1f(A.rotation,v.rotation),b.uniform1f(A.opacity,
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(p,l){var r,t,n,s,q,w,y,D,F,H=[];s=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFace===THREE.CullFaceFront?
...
I.shadowCameraBottom=F.shadowCameraBottom;I.shadowCameraTop=F.shadowCameraTop;I.shadowCameraVisible=F.shadowCameraVisible;I.shadowDarkness=F.shadowDarkness;I.shadowBias=F.shadowCascadeBias[y];I.shadowMapWidth=F.shadowCascadeWidth[y];I.shadowMapHeight=F.shadowCascadeHeight[y];I.pointsWorld=[];I.pointsFrustum=[];D=I.pointsWorld;w=I.pointsFrustum;for(var G=0;8>G;G++)D[G]=new THREE.Vector3,w[G]=new THREE.Vector3;D=F.shadowCascadeNearZ[y];F=F.shadowCascadeFarZ[y];w[0].set(-1,-1,D);w[1].set(1,-1,D);w[2].set(-1,
1,D);w[3].set(1,1,D);w[4].set(-1,-1,F);w[5].set(1,-1,F);w[6].set(-1,1,F);w[7].set(1,1,F);I.originalCamera=l;w=new THREE.Gyroscope;w.position=n.shadowCascadeOffset;w.add(I);w.add(I.target);l.add(w);n.shadowCascadeArray[q]=I;console.log("Created virtualLight",I)}y=n;D=q;F=y.shadowCascadeArray[D];F.position.copy(y.position);F.target.position.copy(y.target.position);F.lookAt(F.target);F.shadowCameraVisible=y.shadowCameraVisible;F.shadowDarkness=y.shadowDarkness;F.shadowBias=y.shadowCascadeBias[D];w=y.shadowCascadeNearZ[D];
y=y.shadowCascadeFarZ[D];F=F.pointsFrustum;F[0].z=w;F[1].z=w;F[2].z=w;F[3].z=w;F[4].z=y;F[5].z=y;F[6].z=y;F[7].z=y;H[s]=I;s++}else H[s]=n,s++;r=0;for(t=H.length;r<t;r++){n=H[r];n.shadowMap||(q=THREE.LinearFilter,b.shadowMapType===THREE.PCFSoftShadowMap&&(q=THREE.NearestFilter),n.shadowMap=new THREE.WebGLRenderTarget(n.shadowMapWidth,n.shadowMapHeight,{minFilter:q,magFilter:q,format:THREE.RGBAFormat}),n.shadowMapSize=new THREE.Vector2(n.shadowMapWidth,n.shadowMapHeight),n.shadowMatrix=new THREE.Matrix4);
...
!n.cameraHelper&&(n.cameraHelper=new THREE.CameraHelper(n.shadowCamera),n.shadowCamera.add(n.cameraHelper));if(n.isVirtual&&I.originalCamera==l){q=l;s=n.shadowCamera;w=n.pointsFrustum;F=n.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(y=0;8>y;y++)D=F[y],D.copy(w[y]),THREE.ShadowMapPlugin.__projector.unprojectVector(D,q),D.applyMatrix4(s.matrixWorldInverse),D.x<i.x&&(i.x=D.x),D.x>j.x&&(j.x=D.x),D.y<i.y&&(i.y=D.y),D.y>j.y&&(j.y=D.y),D.z<i.z&&(i.z=D.z),D.z>j.z&&
(j.z=D.z);s.left=i.x;s.right=j.x;s.top=j.y;s.bottom=i.y;s.updateProjectionMatrix()}s=n.shadowMap;w=n.shadowMatrix;q=n.shadowCamera;q.position.getPositionFromMatrix(n.matrixWorld);m.getPositionFromMatrix(n.target.matrixWorld);q.lookAt(m);q.updateMatrixWorld();q.matrixWorldInverse.getInverse(q.matrixWorld);n.cameraHelper&&(n.cameraHelper.visible=n.shadowCameraVisible);n.shadowCameraVisible&&n.cameraHelper.update();w.set(0.5,0,0,0.5,0,0.5,0,0.5,0,0,0.5,0.5,0,0,0,1);w.multiply(q.projectionMatrix);w.multiply(q.matrixWorldInverse);
g.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse);h.setFromMatrix(g);b.setRenderTarget(s);b.clear();F=p.__webglObjects;n=0;for(s=F.length;n<s;n++)if(y=F[n],w=y.object,y.render=!1,w.visible&&w.castShadow&&(!(w instanceof THREE.Mesh||w instanceof THREE.ParticleSystem)||!w.frustumCulled||h.intersectsObject(w)))w._modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,w.matrixWorld),y.render=!0;n=0;for(s=F.length;n<s;n++)y=F[n],y.render&&(w=y.object,y=y.buffer,G=w.material instanceof THREE.MeshFaceMaterial?
w.material.materials[0]:w.material,D=0<w.geometry.morphTargets.length&&G.morphTargets,G=w instanceof THREE.SkinnedMesh&&G.skinning,D=w.customDepthMaterial?w.customDepthMaterial:G?D?f:e:D?d:c,y instanceof THREE.BufferGeometry?b.renderBufferDirect(q,p.__lights,null,D,y,w):b.renderBuffer(q,p.__lights,null,D,y,w));F=p.__webglObjectsImmediate;n=0;for(s=F.length;n<s;n++)y=F[n],w=y.object,w.visible&&w.castShadow&&(w._modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,w.matrixWorld),b.renderImmediateObject(q,
p.__lights,null,c,w))}r=b.getClearColor();t=b.getClearAlpha();a.clearColor(r.r,r.g,r.b,t);a.enable(a.BLEND);b.shadowMapCullFace===THREE.CullFaceFront&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;THREE.SpritePlugin=function(){function a(a,b){return a.z!==b.z?b.z-a.z:b.id-a.id}var b,c,d,e,f,h,g,i,j,m;this.init=function(a){b=a.context;c=a;d=a.getPrecision();e=new Float32Array(16);f=new Uint16Array(6);a=0;e[a++]=-1;e[a++]=-1;e[a++]=0;e[a++]=0;e[a++]=1;e[a++]=-1;e[a++]=1;e[a++]=0;e[a++]=1;e[a++]=1;e[a++]=1;e[a++]=1;e[a++]=-1;e[a++]=1;e[a++]=0;e[a++]=1;a=0;f[a++]=0;f[a++]=1;f[a++]=2;f[a++]=0;f[a++]=2;f[a++]=3;h=b.createBuffer();g=b.createBuffer();b.bindBuffer(b.ARRAY_BUFFER,h);b.bufferData(b.ARRAY_BUFFER,
...
"screenPosition");m.modelViewMatrix=b.getUniformLocation(i,"modelViewMatrix");m.projectionMatrix=b.getUniformLocation(i,"projectionMatrix");m.fogType=b.getUniformLocation(i,"fogType");m.fogDensity=b.getUniformLocation(i,"fogDensity");m.fogNear=b.getUniformLocation(i,"fogNear");m.fogFar=b.getUniformLocation(i,"fogFar");m.fogColor=b.getUniformLocation(i,"fogColor");m.alphaTest=b.getUniformLocation(i,"alphaTest")};this.render=function(d,e,f,t){var n=d.__webglSprites,s=n.length;if(s){var q=j,w=m,y=t/
f,f=0.5*f,D=0.5*t;b.useProgram(i);b.enableVertexAttribArray(q.position);b.enableVertexAttribArray(q.uv);b.disable(b.CULL_FACE);b.enable(b.BLEND);b.bindBuffer(b.ARRAY_BUFFER,h);b.vertexAttribPointer(q.position,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(q.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.uniformMatrix4fv(w.projectionMatrix,!1,e.projectionMatrix.elements);b.activeTexture(b.TEXTURE0);b.uniform1i(w.map,0);var F=q=0,H=d.fog;H?(b.uniform3f(w.fogColor,H.color.r,H.color.g,H.color.b),
H instanceof THREE.Fog?(b.uniform1f(w.fogNear,H.near),b.uniform1f(w.fogFar,H.far),b.uniform1i(w.fogType,1),F=q=1):H instanceof THREE.FogExp2&&(b.uniform1f(w.fogDensity,H.density),b.uniform1i(w.fogType,2),F=q=2)):(b.uniform1i(w.fogType,0),F=q=0);for(var I,G,B=[],H=0;H<s;H++)I=n[H],G=I.material,I.visible&&0!==G.opacity&&(G.useScreenCoordinates?I.z=-I.position.z:(I._modelViewMatrix.multiplyMatrices(e.matrixWorldInverse,I.matrixWorld),I.z=-I._modelViewMatrix.elements[14]));n.sort(a);for(H=0;H<s;H++)I=
n[H],G=I.material,I.visible&&0!==G.opacity&&(G.map&&G.map.image&&G.map.image.width)&&(b.uniform1f(w.alphaTest,G.alphaTest),!0===G.useScreenCoordinates?(b.uniform1i(w.useScreenCoordinates,1),b.uniform3f(w.screenPosition,(I.position.x*c.devicePixelRatio-f)/f,(D-I.position.y*c.devicePixelRatio)/D,Math.max(0,Math.min(1,I.position.z))),B[0]=c.devicePixelRatio,B[1]=c.devicePixelRatio):(b.uniform1i(w.useScreenCoordinates,0),b.uniform1i(w.sizeAttenuation,G.sizeAttenuation?1:0),b.uniformMatrix4fv(w.modelViewMatrix,
!1,I._modelViewMatrix.elements),B[0]=1,B[1]=1),e=d.fog&&G.fog?F:0,q!==e&&(b.uniform1i(w.fogType,e),q=e),e=1/(G.scaleByViewport?t:1),B[0]*=e*y*I.scale.x,B[1]*=e*I.scale.y,b.uniform2f(w.uvScale,G.uvScale.x,G.uvScale.y),b.uniform2f(w.uvOffset,G.uvOffset.x,G.uvOffset.y),b.uniform2f(w.alignment,G.alignment.x,G.alignment.y),b.uniform1f(w.opacity,G.opacity),b.uniform3f(w.color,G.color.r,G.color.g,G.color.b),b.uniform1f(w.rotation,I.rotation),b.uniform2fv(w.scale,B),c.setBlending(G.blending,G.blendEquation,
