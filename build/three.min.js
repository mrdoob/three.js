...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],j=c[1],l=c[5],m=c[9],n=c[13],p=c[2],o=c[6],q=c[10],t=c[14],r=c[3],A=c[7],u=c[11],c=c[15],s=d[0],D=d[4],z=d[8],
w=d[12],v=d[1],C=d[5],E=d[9],G=d[13],P=d[2],B=d[6],J=d[10],H=d[14],I=d[3],L=d[7],N=d[11],d=d[15];e[0]=f*s+g*v+h*P+i*I;e[4]=f*D+g*C+h*B+i*L;e[8]=f*z+g*E+h*J+i*N;e[12]=f*w+g*G+h*H+i*d;e[1]=j*s+l*v+m*P+n*I;e[5]=j*D+l*C+m*B+n*L;e[9]=j*z+l*E+m*J+n*N;e[13]=j*w+l*G+m*H+n*d;e[2]=p*s+o*v+q*P+t*I;e[6]=p*D+o*C+q*B+t*L;e[10]=p*z+o*E+q*J+t*N;e[14]=p*w+o*G+q*H+t*d;e[3]=r*s+A*v+u*P+c*I;e[7]=r*D+A*C+u*B+c*L;e[11]=r*z+A*E+u*J+c*N;e[15]=r*w+A*G+u*H+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),l=Math.sin(b),m=1-j,n=d*e*m,p=d*f*m,m=e*f*m,d=d*l,o=e*l,l=f*l,f=g+(1-g)*j,g=n+l,e=p-o,n=n-l,h=h+(1-h)*j,l=m+d,p=p+o,m=m-d,i=i+(1-i)*j,j=c[0],d=c[1],o=c[2],q=c[3],t=c[4],r=c[5],A=c[6],u=c[7],s=c[8],D=c[9],z=c[10],w=c[11];c[0]=f*j+g*t+e*s;c[1]=f*d+g*r+e*D;c[2]=f*o+g*A+e*z;c[3]=f*q+g*u+e*w;c[4]=n*j+h*t+l*s;c[5]=n*d+h*r+l*D;c[6]=n*o+h*A+l*z;c[7]=n*q+h*u+l*w;c[8]=p*j+m*t+i*s;c[9]=p*d+m*r+i*D;c[10]=p*o+m*A+i*z;c[11]=p*q+m*u+i*w;
...
p=o.vertices,D=h.material instanceof a.MeshFaceMaterial,z=D&&0<h.material.materials.length?h.material.materials:h.geometry.materials,l=h.material.side,w,v,C,E=i.precision;h.matrixRotationWorld.extractRotation(h.matrixWorld);b.copy(i.origin);g.getInverse(h.matrixWorld);c.copy(b);g.multiplyVector3(c);d.copy(i.direction);g.rotateAxis(d).normalize();for(var G=0,P=o.faces.length;G<P;G++){var B=o.faces[G],l=!0===D?z[B.materialIndex]:h.material;if(void 0!==l&&(l=l.side,e.sub(B.centroid,c),v=B.normal,w=d.dot(v),
!(Math.abs(w)<E)&&(v=v.dot(e)/w,!(0>v)&&(l===a.DoubleSide||(l===a.FrontSide?0>w:0<w)))))if(f.add(c,d.multiplyScalar(v)),B instanceof a.Face3)l=p[B.a],w=p[B.b],v=p[B.c],n(f,l,w,v)&&(w=h.matrixWorld.multiplyVector3(f.clone()),l=b.distanceTo(w),l<i.near||l>i.far||j.push({distance:l,point:w,face:B,faceIndex:G,object:h}));else if(B instanceof a.Face4&&(l=p[B.a],w=p[B.b],v=p[B.c],C=p[B.d],n(f,l,w,C)||n(f,w,v,C)))w=h.matrixWorld.multiplyVector3(f.clone()),l=b.distanceTo(w),l<i.near||l>i.far||j.push({distance:l,
...
c)return!1;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return!0}var e,f,g=[],h=0,i,j,l=[],m=0,n,p,o=[],q=0,t,r=[],A=0,u,s,D=[],z=0,w,v,C=[],E=0,G={objects:[],sprites:[],lights:[],elements:[]},P=new THREE.Vector3,B=new THREE.Vector4,J=new THREE.Matrix4,H=new THREE.Matrix4,I=new THREE.Matrix3,L=new THREE.Frustum,N=new THREE.Vector4,S=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);J.multiply(b.projectionMatrix,b.matrixWorldInverse);J.multiplyVector3(a);return a};
this.unprojectVector=function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);J.multiply(b.matrixWorld,b.projectionMatrixInverse);J.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,m,Q){var $=h.near,K=h.far,ja=!1,R,ha,da,Y,aa,ba,ia,wa,ua,Ca,Ka,va,cb,wb,Ua;v=s=t=p=0;G.elements.length=0;g.updateMatrixWorld();
void 0===h.parent&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);J.multiply(h.projectionMatrix,h.matrixWorldInverse);L.setFromMatrix(J);f=0;G.objects.length=0;G.sprites.length=0;G.lights.length=0;var fb=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof THREE.Light)G.lights.push(f);else if(f instanceof THREE.Mesh||f instanceof THREE.Line){if(!1===f.frustumCulled||!0===L.contains(f))e=a(),e.object=f,null!==f.renderDepth?
e.z=f.renderDepth:(P.copy(f.matrixWorld.getPosition()),J.multiplyVector3(P),e.z=P.z),G.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(P.copy(f.matrixWorld.getPosition()),J.multiplyVector3(P),e.z=P.z),G.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(P.copy(f.matrixWorld.getPosition()),J.multiplyVector3(P),e.z=P.z),G.objects.push(e));fb(f)}}};fb(g);!0===m&&G.objects.sort(c);g=0;for(m=G.objects.length;g<
m;g++)if(wa=G.objects[g].object,ua=wa.matrixWorld,j=0,wa instanceof THREE.Mesh){Ca=wa.geometry;da=Ca.vertices;Ka=Ca.faces;cb=Ca.faceVertexUvs;I.getInverse(ua);I.transpose();Ca=(wb=wa.material instanceof THREE.MeshFaceMaterial)&&0<wa.material.materials.length?wa.material.materials:wa.geometry.materials;R=0;for(ha=da.length;R<ha;R++)i=b(),i.positionWorld.copy(da[R]),ua.multiplyVector3(i.positionWorld),i.positionScreen.copy(i.positionWorld),J.multiplyVector4(i.positionScreen),i.positionScreen.x/=i.positionScreen.w,
i.positionScreen.y/=i.positionScreen.w,i.visible=i.positionScreen.z>$&&i.positionScreen.z<K;da=0;for(R=Ka.length;da<R;da++)if(ha=Ka[da],Ua=!0===wb?Ca[ha.materialIndex]:wa.material,void 0!==Ua){ba=Ua.side;if(ha instanceof THREE.Face3)if(Y=l[ha.a],aa=l[ha.b],ia=l[ha.c],!0===Y.visible&&!0===aa.visible&&!0===ia.visible)if(ja=0>(ia.positionScreen.x-Y.positionScreen.x)*(aa.positionScreen.y-Y.positionScreen.y)-(ia.positionScreen.y-Y.positionScreen.y)*(aa.positionScreen.x-Y.positionScreen.x),ba===THREE.DoubleSide||
ja===(ba===THREE.FrontSide))p===q?(va=new THREE.RenderableFace3,o.push(va),q++,p++,n=va):n=o[p++],n.v1.copy(Y),n.v2.copy(aa),n.v3.copy(ia);else continue;else continue;else if(ha instanceof THREE.Face4)if(Y=l[ha.a],aa=l[ha.b],ia=l[ha.c],va=l[ha.d],!0===Y.visible&&!0===aa.visible&&!0===ia.visible&&!0===va.visible)if(ja=0>(va.positionScreen.x-Y.positionScreen.x)*(aa.positionScreen.y-Y.positionScreen.y)-(va.positionScreen.y-Y.positionScreen.y)*(aa.positionScreen.x-Y.positionScreen.x)||0>(aa.positionScreen.x-
ia.positionScreen.x)*(va.positionScreen.y-ia.positionScreen.y)-(aa.positionScreen.y-ia.positionScreen.y)*(va.positionScreen.x-ia.positionScreen.x),ba===THREE.DoubleSide||ja===(ba===THREE.FrontSide)){if(t===A){var kb=new THREE.RenderableFace4;r.push(kb);A++;t++;n=kb}else n=r[t++];n.v1.copy(Y);n.v2.copy(aa);n.v3.copy(ia);n.v4.copy(va)}else continue;else continue;n.normalWorld.copy(ha.normal);!1===ja&&(ba===THREE.BackSide||ba===THREE.DoubleSide)&&n.normalWorld.negate();I.multiplyVector3(n.normalWorld).normalize();
n.centroidWorld.copy(ha.centroid);ua.multiplyVector3(n.centroidWorld);n.centroidScreen.copy(n.centroidWorld);J.multiplyVector3(n.centroidScreen);ia=ha.vertexNormals;Y=0;for(aa=ia.length;Y<aa;Y++)va=n.vertexNormalsWorld[Y],va.copy(ia[Y]),!1===ja&&(ba===THREE.BackSide||ba===THREE.DoubleSide)&&va.negate(),I.multiplyVector3(va).normalize();n.vertexNormalsLength=ia.length;Y=0;for(aa=cb.length;Y<aa;Y++)if(va=cb[Y][da],void 0!==va){ba=0;for(ia=va.length;ba<ia;ba++)n.uvs[Y][ba]=va[ba]}n.color=ha.color;n.material=
Ua;n.z=n.centroidScreen.z;G.elements.push(n)}}else if(wa instanceof THREE.Line){H.multiply(J,ua);da=wa.geometry.vertices;Y=b();Y.positionScreen.copy(da[0]);H.multiplyVector4(Y.positionScreen);ua=wa.type===THREE.LinePieces?2:1;R=1;for(ha=da.length;R<ha;R++)Y=b(),Y.positionScreen.copy(da[R]),H.multiplyVector4(Y.positionScreen),0<(R+1)%ua||(aa=l[j-2],N.copy(Y.positionScreen),S.copy(aa.positionScreen),!0===d(N,S)&&(N.multiplyScalar(1/N.w),S.multiplyScalar(1/S.w),s===z?(Ka=new THREE.RenderableLine,D.push(Ka),
z++,s++,u=Ka):u=D[s++],u.v1.positionScreen.copy(N),u.v2.positionScreen.copy(S),u.z=Math.max(N.z,S.z),u.material=wa.material,G.elements.push(u)))}g=0;for(m=G.sprites.length;g<m;g++)wa=G.sprites[g].object,ua=wa.matrixWorld,wa instanceof THREE.Particle&&(B.set(ua.elements[12],ua.elements[13],ua.elements[14],1),J.multiplyVector4(B),B.z/=B.w,0<B.z&&1>B.z&&(v===E?($=new THREE.RenderableParticle,C.push($),E++,v++,w=$):w=C[v++],w.object=wa,w.x=B.x/B.w,w.y=B.y/B.w,w.z=B.z,w.rotation=wa.rotation.z,w.scale.x=
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,v){h=a.vertices[b];i=a.vertices[c];j=a.vertices[d];l=g[e];m=g[f];n=g[v];p=i.x-h.x;o=j.x-h.x;q=i.y-h.y;t=j.y-h.y;r=i.z-h.z;A=j.z-h.z;u=m.u-l.u;s=n.u-l.u;D=m.v-l.v;z=n.v-l.v;w=1/(u*z-s*D);G.set((z*p-D*o)*w,(z*q-D*t)*w,(z*r-D*A)*w);P.set((u*o-s*p)*w,(u*t-s*q)*w,(u*A-s*r)*w);C[b].addSelf(G);C[c].addSelf(G);C[d].addSelf(G);E[b].addSelf(P);E[c].addSelf(P);E[d].addSelf(P)}var b,c,d,e,f,g,h,i,j,l,m,n,p,o,q,t,r,A,
u,s,D,z,w,v,C=[],E=[],G=new THREE.Vector3,P=new THREE.Vector3,B=new THREE.Vector3,J=new THREE.Vector3,H=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)C[b]=new THREE.Vector3,E[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var I=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<
...
0}var e=this.offsets,f=this.attributes.index.array,g=this.attributes.position.array,h=this.attributes.normal.array,i,j,l,m,n,p,o=new THREE.Vector3,q=new THREE.Vector3,t=new THREE.Vector3,r=new THREE.Vector3,A=new THREE.Vector3;c=0;for(d=e.length;c<d;++c){b=e[c].start;i=e[c].count;var u=e[c].index;a=b;for(b+=i;a<b;a+=3)i=u+f[a],j=u+f[a+1],l=u+f[a+2],m=g[3*i],n=g[3*i+1],p=g[3*i+2],o.set(m,n,p),m=g[3*j],n=g[3*j+1],p=g[3*j+2],q.set(m,n,p),m=g[3*l],n=g[3*l+1],p=g[3*l+2],t.set(m,n,p),r.sub(t,q),A.sub(o,
q),r.crossSelf(A),h[3*i]+=r.x,h[3*i+1]+=r.y,h[3*i+2]+=r.z,h[3*j]+=r.x,h[3*j+1]+=r.y,h[3*j+2]+=r.z,h[3*l]+=r.x,h[3*l+1]+=r.y,h[3*l+2]+=r.z}this.normalizeNormals();this.normalsNeedUpdate=!0}},normalizeNormals:function(){for(var a=this.attributes.normal.array,b,c,d,e=0,f=a.length;e<f;e+=3)b=a[e],c=a[e+1],d=a[e+2],b=1/Math.sqrt(b*b+c*c+d*d),a[e]*=b,a[e+1]*=b,a[e+2]*=b},computeTangents:function(){function a(a){T.x=d[3*a];T.y=d[3*a+1];T.z=d[3*a+2];M.copy(T);Q=i[a];N.copy(Q);N.subSelf(T.multiplyScalar(T.dot(Q))).normalize();
S.cross(M,Q);$=S.dot(j[a]);O=0>$?-1:1;h[4*a]=N.x;h[4*a+1]=N.y;h[4*a+2]=N.z;h[4*a+3]=O}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===this.attributes.uv)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,e=this.attributes.uv.array,f=c.length/3;if(void 0===this.attributes.tangent){var g=
4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var l,m,n,p,o,q,t,r,A,u,s,D,z,w,v,f=new THREE.Vector3,g=new THREE.Vector3,C,E,G,P,B,J,H,I=this.offsets;G=0;for(P=I.length;G<P;++G){E=I[G].start;B=I[G].count;var L=I[G].index;C=E;for(E+=B;C<E;C+=3)B=L+b[C],J=L+b[C+1],H=L+b[C+2],l=c[3*B],m=c[3*B+1],n=c[3*B+2],p=c[3*J],o=c[3*J+1],q=c[3*J+2],t=c[3*H],r=c[3*H+1],A=c[3*
H+2],u=e[2*B],s=e[2*B+1],D=e[2*J],z=e[2*J+1],w=e[2*H],v=e[2*H+1],p-=l,l=t-l,o-=m,m=r-m,q-=n,n=A-n,D-=u,u=w-u,z-=s,s=v-s,v=1/(D*s-u*z),f.set((s*p-z*l)*v,(s*o-z*m)*v,(s*q-z*n)*v),g.set((D*l-u*p)*v,(D*m-u*o)*v,(D*n-u*q)*v),i[B].addSelf(f),i[J].addSelf(f),i[H].addSelf(f),j[B].addSelf(g),j[J].addSelf(g),j[H].addSelf(g)}var N=new THREE.Vector3,S=new THREE.Vector3,T=new THREE.Vector3,M=new THREE.Vector3,O,Q,$;G=0;for(P=I.length;G<P;++G){E=I[G].start;B=I[G].count;L=I[G].index;C=E;for(E+=B;C<E;C+=3)B=L+b[C],
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(b){var c,e,i,j,l,m,n,p,o,q,t,r,A,u,s;function D(a){return a%4?4-a%4:0}function z(a,b){return(new Uint8Array(a,b,1))[0]}function w(a,b){return(new Uint32Array(a,b,1))[0]}function v(b,c){var d,e,f,g,h,i,j,l,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){e=n[3*d];f=n[3*d+1];g=n[3*d+2];h=L[2*e];e=L[2*e+1];i=L[2*f];j=L[2*f+1];f=L[2*g];l=L[2*g+1];g=J.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,e));m.push(new THREE.UV(i,j));m.push(new THREE.UV(f,
l));g.push(m)}}function C(b,c){var d,e,f,g,h,i,j,l,n,m,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){e=o[4*d];f=o[4*d+1];g=o[4*d+2];h=o[4*d+3];i=L[2*e];e=L[2*e+1];j=L[2*f];n=L[2*f+1];l=L[2*g];m=L[2*g+1];g=L[2*h];f=L[2*h+1];h=J.faceVertexUvs[0];var p=[];p.push(new THREE.UV(i,e));p.push(new THREE.UV(j,n));p.push(new THREE.UV(l,m));p.push(new THREE.UV(g,f));h.push(p)}}function E(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],
...
I[3*n+1];n=I[3*n+2];J.faces.push(new THREE.Face3(f,g,h,[new THREE.Vector3(I[3*j],I[3*j+1],I[3*j+2]),new THREE.Vector3(o,p,l),new THREE.Vector3(q,r,n)],null,i))}}function B(b,c,d,e){for(var f,g,h,i,j,l,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];l=d[4*e];n=d[4*e+1];m=d[4*e+2];o=d[4*e+3];j=p[e];var q=I[3*n],r=I[3*n+1];n=I[3*n+2];var t=I[3*m],s=I[3*m+1];m=I[3*m+2];var v=I[3*o],u=I[3*o+1];o=I[3*o+2];J.faces.push(new THREE.Face4(f,
g,h,i,[new THREE.Vector3(I[3*l],I[3*l+1],I[3*l+2]),new THREE.Vector3(q,r,n),new THREE.Vector3(t,s,m),new THREE.Vector3(v,u,o)],null,j))}}var J=this,H=0,I=[],L=[],N,S,T;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(J,d,b);s=a;S=H;b=new Uint8Array(s,S,12);q="";for(A=0;12>A;A++)q+=String.fromCharCode(b[S+A]);c=z(s,S+12);z(s,S+13);z(s,S+14);z(s,S+15);e=z(s,S+16);i=z(s,S+17);j=z(s,S+18);l=z(s,S+19);m=w(s,S+20);n=w(s,S+20+4);p=w(s,S+20+8);o=w(s,S+20+12);q=w(s,S+20+16);t=w(s,S+20+20);r=
w(s,S+20+24);A=w(s,S+20+28);b=w(s,S+20+32);u=w(s,S+20+36);s=w(s,S+20+40);H+=c;S=3*e+l;T=4*e+l;N=o*S;c=q*(S+3*i);e=t*(S+3*j);l=r*(S+3*i+3*j);S=A*T;i=b*(T+4*i);j=u*(T+4*j);T=H;var H=new Float32Array(a,H,3*m),M,O,Q,$;for(M=0;M<m;M++)O=H[3*M],Q=H[3*M+1],$=H[3*M+2],J.vertices.push(new THREE.Vector3(O,Q,$));m=H=T+3*m*Float32Array.BYTES_PER_ELEMENT;if(n){H=new Int8Array(a,H,3*n);for(T=0;T<n;T++)M=H[3*T],O=H[3*T+1],Q=H[3*T+2],I.push(M/127,O/127,Q/127)}H=m+3*n*Int8Array.BYTES_PER_ELEMENT;n=H+=D(3*n);if(p){H=
new Float32Array(a,H,2*p);for(m=0;m<p;m++)T=H[2*m],M=H[2*m+1],L.push(T,M)}p=H=n+2*p*Float32Array.BYTES_PER_ELEMENT;N=p+N+D(2*o);n=N+c+D(2*q);c=n+e+D(2*t);e=c+l+D(2*r);S=e+S+D(2*A);l=S+i+D(2*b);i=l+j+D(2*u);t&&(j=n+3*t*Uint32Array.BYTES_PER_ELEMENT,E(t,n,j+3*t*Uint32Array.BYTES_PER_ELEMENT),v(t,j));r&&(t=c+3*r*Uint32Array.BYTES_PER_ELEMENT,j=t+3*r*Uint32Array.BYTES_PER_ELEMENT,P(r,c,t,j+3*r*Uint32Array.BYTES_PER_ELEMENT),v(r,j));u&&(r=l+4*u*Uint32Array.BYTES_PER_ELEMENT,G(u,l,r+4*u*Uint32Array.BYTES_PER_ELEMENT),
C(u,r));s&&(u=i+4*s*Uint32Array.BYTES_PER_ELEMENT,r=u+4*s*Uint32Array.BYTES_PER_ELEMENT,B(s,i,u,r+4*s*Uint32Array.BYTES_PER_ELEMENT),C(s,r));o&&E(o,p,p+3*o*Uint32Array.BYTES_PER_ELEMENT);q&&(o=N+3*q*Uint32Array.BYTES_PER_ELEMENT,P(q,N,o,o+3*q*Uint32Array.BYTES_PER_ELEMENT));A&&G(A,e,e+4*A*Uint32Array.BYTES_PER_ELEMENT);b&&(q=S+4*b*Uint32Array.BYTES_PER_ELEMENT,B(b,S,q,q+4*b*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&this.computeTangents()};
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1;this.initMaterials(d,a.materials,c);var f,g,h,i,j,l,m,n,p,o,q,t,r,A,u=a.faces;p=a.vertices;var s=a.normals,D=a.colors,z=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&z++;for(f=0;f<z;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];c=0;for(i=p.length;c<i;)j=new THREE.Vector3,j.x=p[c++]*e,j.y=p[c++]*e,j.z=p[c++]*e,d.vertices.push(j);c=0;for(i=u.length;c<i;){p=u[c++];j=p&1;h=p&2;f=p&4;g=p&8;m=p&16;
l=p&32;o=p&64;p&=128;j?(q=new THREE.Face4,q.a=u[c++],q.b=u[c++],q.c=u[c++],q.d=u[c++],j=4):(q=new THREE.Face3,q.a=u[c++],q.b=u[c++],q.c=u[c++],j=3);h&&(h=u[c++],q.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<z;f++)t=a.uvs[f],n=u[c++],A=t[2*n],n=t[2*n+1],d.faceUvs[f][h]=new THREE.UV(A,n);if(g)for(f=0;f<z;f++){t=a.uvs[f];r=[];for(g=0;g<j;g++)n=u[c++],A=t[2*n],n=t[2*n+1],r[g]=new THREE.UV(A,n);d.faceVertexUvs[f][h]=r}m&&(m=3*u[c++],g=new THREE.Vector3,g.x=s[m++],g.y=s[m++],g.z=s[m],q.normal=g);if(l)for(f=
0;f<j;f++)m=3*u[c++],g=new THREE.Vector3,g.x=s[m++],g.y=s[m++],g.z=s[m],q.vertexNormals.push(g);o&&(l=u[c++],l=new THREE.Color(D[l]),q.color=l);if(p)for(f=0;f<j;f++)l=u[c++],l=new THREE.Color(D[l]),q.vertexColors.push(l);d.faces.push(q)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c+=2)u=a.skinWeights[c],s=a.skinWeights[c+1],d.skinWeights.push(new THREE.Vector4(u,s,0,0))}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c+=2)u=a.skinIndices[c],s=a.skinIndices[c+1],d.skinIndices.push(new THREE.Vector4(u,
...
n=a.normals,j=a.colors,l=0;if(a.uvs)for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&l++;for(f=0;f<l;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];m=0;for(p=o.length;m<p;){var q=new THREE.Vector3;q.x=o[m++]*e;q.y=o[m++]*e;q.z=o[m++]*e;d.vertices.push(q)}m=0;for(p=g.length;m<p;){var t=g[m++],r=t&2,f=t&4,A=t&8,u=t&16,o=t&32,s=t&64,q=t&128;if(t&1){t=new THREE.Face4;t.a=g[m++];t.b=g[m++];t.c=g[m++];t.d=g[m++];var D=4}else t=new THREE.Face3,t.a=g[m++],t.b=g[m++],t.c=g[m++],D=3;r&&(r=g[m++],t.materialIndex=r);var z=
d.faces.length;if(f)for(f=0;f<l;f++){var w=a.uvs[f],r=g[m++],v=w[2*r],r=w[2*r+1];d.faceUvs[f][z]=new THREE.UV(v,r)}if(A)for(f=0;f<l;f++){for(var w=a.uvs[f],A=[],C=0;C<D;C++)r=g[m++],v=w[2*r],r=w[2*r+1],A[C]=new THREE.UV(v,r);d.faceVertexUvs[f][z]=A}u&&(u=3*g[m++],r=new THREE.Vector3,r.x=n[u++],r.y=n[u++],r.z=n[u],t.normal=r);if(o)for(f=0;f<D;f++)u=3*g[m++],r=new THREE.Vector3,r.x=n[u++],r.y=n[u++],r.z=n[u],t.vertexNormals.push(r);s&&(o=g[m++],t.color=new THREE.Color(j[o]));if(q)for(f=0;f<D;f++)o=
...
d.morphTargets[f].vertices=[];n=d.morphTargets[f].vertices;j=a.morphTargets[f].vertices;r=0;for(l=j.length;r<l;r+=3)q=new THREE.Vector3,q.x=j[r]*e,q.y=j[r+1]*e,q.z=j[r+2]*e,n.push(q)}}if(a.morphColors){f=0;for(g=a.morphColors.length;f<g;f++){d.morphColors[f]={};d.morphColors[f].name=a.morphColors[f].name;d.morphColors[f].colors=[];e=d.morphColors[f].colors;j=a.morphColors[f].colors;n=0;for(l=j.length;n<l;n+=3)m=new THREE.Color(16755200),m.setRGB(j[n],j[n+1],j[n+2]),e.push(m)}}d.computeCentroids();
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return"relativeToHTML"==b?a:m+"/"+a}function e(){f(M.scene,Q.objects)}function f(a,b){for(var c in b)if(void 0===M.objects[c]){var e=b[c],g=null;if(e.type&&e.type in l.hierarchyHandlerMap&&void 0===e.loading){var i={},j;for(j in t)"type"!==j&&"url"!==j&&(i[j]=t[j]);E=M.materials[e.material];e.loading=!0;var n=l.hierarchyHandlerMap[e.type].loaderObject;n.addEventListener?(n.addEventListener("load",h(c,a,E,e)),n.load(d(e.url,Q.urlBaseType))):
n.options?n.load(d(e.url,Q.urlBaseType),h(c,a,E,e)):n.load(d(e.url,Q.urlBaseType),h(c,a,E,e),i)}else if(void 0!==e.geometry){if(C=M.geometries[e.geometry])g=!1,E=M.materials[e.material],(g=E instanceof THREE.ShaderMaterial)&&C.computeTangents(),u=e.position,s=e.rotation,D=e.quaternion,z=e.scale,r=e.matrix,D=0,e.material||(E=new THREE.MeshFaceMaterial),e.skin?g=new THREE.SkinnedMesh(C,E):e.morph?(g=new THREE.MorphAnimMesh(C,E),void 0!==e.duration&&(g.duration=e.duration),void 0!==e.time&&(g.time=e.time),
void 0!==e.mirroredLoop&&(g.mirroredLoop=e.mirroredLoop),E.morphNormals&&C.computeMorphNormals()):g=new THREE.Mesh(C,E),g.name=c,r?(g.matrixAutoUpdate=!1,g.matrix.set(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15])):(g.position.set(u[0],u[1],u[2]),D?(g.quaternion.set(D[0],D[1],D[2],D[3]),g.useQuaternion=!0):g.rotation.set(s[0],s[1],s[2]),g.scale.set(z[0],z[1],z[2])),g.visible=e.visible,g.castShadow=e.castShadow,g.receiveShadow=e.receiveShadow,a.add(g),M.objects[c]=
g}else"DirectionalLight"===e.type||"PointLight"===e.type||"AmbientLight"===e.type?(H=void 0!==e.color?e.color:16777215,I=void 0!==e.intensity?e.intensity:1,"DirectionalLight"===e.type?(u=e.direction,J=new THREE.DirectionalLight(H,I),J.position.set(u[0],u[1],u[2]),e.target&&(O.push({object:J,targetName:e.target}),J.target=null)):"PointLight"===e.type?(u=e.position,A=e.distance,J=new THREE.PointLight(H,I,A),J.position.set(u[0],u[1],u[2])):"AmbientLight"===e.type&&(J=new THREE.AmbientLight(H)),a.add(J),
J.name=c,M.lights[c]=J,M.objects[c]=J):"PerspectiveCamera"===e.type||"OrthographicCamera"===e.type?("PerspectiveCamera"===e.type?G=new THREE.PerspectiveCamera(e.fov,e.aspect,e.near,e.far):"OrthographicCamera"===e.type&&(G=new THREE.OrthographicCamera(w.left,w.right,w.top,w.bottom,w.near,w.far)),u=e.position,G.position.set(u[0],u[1],u[2]),a.add(G),G.name=c,M.cameras[c]=G,M.objects[c]=G):(u=e.position,s=e.rotation,D=e.quaternion,z=e.scale,D=0,g=new THREE.Object3D,g.name=c,g.position.set(u[0],u[1],u[2]),
D?(g.quaternion.set(D[0],D[1],D[2],D[3]),g.useQuaternion=!0):g.rotation.set(s[0],s[1],s[2]),g.scale.set(z[0],z[1],z[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),M.objects[c]=g,M.empties[c]=g);if(g){if(void 0!==e.properties)for(var m in e.properties)g.properties[m]=e.properties[m];void 0!==e.children&&f(g,e.children)}}}function g(a){return function(b){M.geometries[a]=b;e();L-=1;l.onLoadComplete();j()}}function h(a,b,c,d){return function(f){var f=f.content?f.content:f.dae?f.scene:f,g=d.position,
h=d.rotation,i=d.quaternion,n=d.scale;f.position.set(g[0],g[1],g[2]);i?(f.quaternion.set(i[0],i[1],i[2],i[3]),f.useQuaternion=!0):f.rotation.set(h[0],h[1],h[2]);f.scale.set(n[0],n[1],n[2]);c&&f.traverse(function(a){a.material=c});b.add(f);M.objects[a]=f;e();L-=1;l.onLoadComplete();j()}}function i(a){return function(b){M.geometries[a]=b}}function j(){l.callbackProgress({totalModels:S,totalTextures:T,loadedModels:S-L,loadedTextures:T-N},M);l.onLoadProgress();if(0===L&&0===N){for(var a=0;a<O.length;a++){var c=
O[a],d=M.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,M.scene.add(c.object.target));c.object.target.properties.targetInverse=c.object}b(M)}}var l=this,m=THREE.Loader.prototype.extractUrlBase(c),n,p,o,q,t,r,A,u,s,D,z,w,v,C,E,G,P,B,J,H,I,L,N,S,T,M,O=[],Q=a,$;for($ in this.geometryHandlerMap)a=this.geometryHandlerMap[$].loaderClass,this.geometryHandlerMap[$].loaderObject=new a;for($ in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[$].loaderClass,this.hierarchyHandlerMap[$].loaderObject=
new a;N=L=0;M={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(Q.transform&&($=Q.transform.position,a=Q.transform.rotation,c=Q.transform.scale,$&&M.scene.position.set($[0],$[1],$[2]),a&&M.scene.rotation.set(a[0],a[1],a[2]),c&&M.scene.scale.set(c[0],c[1],c[2]),$||a||c))M.scene.updateMatrix(),M.scene.updateMatrixWorld();$=function(a){return function(){N-=a;j();l.onLoadComplete()}};for(o in Q.fogs)a=Q.fogs[o],"linear"===a.type?P=new THREE.Fog(0,
a.near,a.far):"exp2"===a.type&&(P=new THREE.FogExp2(0,a.density)),w=a.color,P.color.setRGB(w[0],w[1],w[2]),M.fogs[o]=P;for(n in Q.geometries)t=Q.geometries[n],t.type in this.geometryHandlerMap&&(L+=1,l.onLoadStart());for(var K in Q.objects)o=Q.objects[K],o.type&&o.type in this.hierarchyHandlerMap&&(L+=1,l.onLoadStart());S=L;for(n in Q.geometries)if(t=Q.geometries[n],"cube"===t.type)C=new THREE.CubeGeometry(t.width,t.height,t.depth,t.widthSegments,t.heightSegments,t.depthSegments,null,t.flipped,t.sides),
M.geometries[n]=C;else if("plane"===t.type)C=new THREE.PlaneGeometry(t.width,t.height,t.widthSegments,t.heightSegments),M.geometries[n]=C;else if("sphere"===t.type)C=new THREE.SphereGeometry(t.radius,t.widthSegments,t.heightSegments),M.geometries[n]=C;else if("cylinder"===t.type)C=new THREE.CylinderGeometry(t.topRad,t.botRad,t.height,t.radSegs,t.heightSegs),M.geometries[n]=C;else if("torus"===t.type)C=new THREE.TorusGeometry(t.radius,t.tube,t.segmentsR,t.segmentsT),M.geometries[n]=C;else if("icosahedron"===
t.type)C=new THREE.IcosahedronGeometry(t.radius,t.subdivisions),M.geometries[n]=C;else if(t.type in this.geometryHandlerMap){K={};for(B in t)"type"!==B&&"url"!==B&&(K[B]=t[B]);this.geometryHandlerMap[t.type].loaderObject.load(d(t.url,Q.urlBaseType),g(n),K)}else"embedded"===t.type&&(K=Q.embeds[t.id],K.metadata=Q.metadata,K&&this.geometryHandlerMap.ascii.loaderObject.createModel(K,i(n),""));for(q in Q.textures)if(n=Q.textures[q],n.url instanceof Array){N+=n.url.length;for(B=0;B<n.url.length;B++)l.onLoadStart()}else N+=
1,l.onLoadStart();T=N;for(q in Q.textures){n=Q.textures[q];void 0!==n.mapping&&void 0!==THREE[n.mapping]&&(n.mapping=new THREE[n.mapping]);if(n.url instanceof Array){K=n.url.length;o=[];for(B=0;B<K;B++)o[B]=d(n.url[B],Q.urlBaseType);B=(B=o[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(o,n.mapping,$(K)):THREE.ImageUtils.loadTextureCube(o,n.mapping,$(K))}else{B=n.url.toLowerCase().endsWith(".dds");K=d(n.url,Q.urlBaseType);o=$(1);B=B?THREE.ImageUtils.loadCompressedTexture(K,n.mapping,
...
$.uShininess.value=o,r.parameters.opacity&&($.uOpacity.value=r.parameters.opacity),E=new THREE.ShaderMaterial({fragmentShader:q.fragmentShader,vertexShader:q.vertexShader,uniforms:$,lights:!0,fog:!0})):E=new THREE[r.type](r.parameters);M.materials[p]=E}for(p in Q.materials)if(r=Q.materials[p],r.parameters.materials){v=[];for(B=0;B<r.parameters.materials.length;B++)v.push(M.materials[r.parameters.materials[B]]);M.materials[p].materials=v}e();M.cameras&&Q.defaults.camera&&(M.currentCamera=M.cameras[Q.defaults.camera]);
M.fogs&&Q.defaults.fog&&(M.scene.fog=M.fogs[Q.defaults.fog]);w=Q.defaults.bgcolor;M.bgColor=new THREE.Color;M.bgColor.setRGB(w[0],w[1],w[2]);M.bgColorAlpha=Q.defaults.bgalpha;l.callbackSync(M);j()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
document.createElement("canvas"),m,n,p,o,q=l.getContext("2d"),t=new THREE.Color(0),r=0,A=1,u=0,s=null,D=null,z=null,w=null,v=null,C,E,G,P,B=new THREE.RenderableVertex,J=new THREE.RenderableVertex,H,I,L,N,S,T,M,O,Q,$,K,ja,R=new THREE.Color,ha=new THREE.Color,da=new THREE.Color,Y=new THREE.Color,aa=new THREE.Color,ba=new THREE.Color,ia=new THREE.Color,wa={},ua={},Ca,Ka,va,cb,wb,Ua,fb,kb,Ab,Bb,eb=new THREE.Rectangle,xa=new THREE.Rectangle,La=new THREE.Rectangle,lb=!1,Na=new THREE.Color,Za=new THREE.Color,
...
o,G.positionScreen.x*=p,G.positionScreen.y*=o,!0===ea.overdraw&&(Xb(C.positionScreen,E.positionScreen),Xb(E.positionScreen,G.positionScreen),Xb(G.positionScreen,C.positionScreen)),La.add3Points(C.positionScreen.x,C.positionScreen.y,E.positionScreen.x,E.positionScreen.y,G.positionScreen.x,G.positionScreen.y),!0===eb.intersects(La)&&m(C,E,G,0,1,2,na,ea,a);else if(na instanceof THREE.RenderableFace4&&(C=na.v1,E=na.v2,G=na.v3,P=na.v4,C.positionScreen.x*=p,C.positionScreen.y*=o,E.positionScreen.x*=p,E.positionScreen.y*=
o,G.positionScreen.x*=p,G.positionScreen.y*=o,P.positionScreen.x*=p,P.positionScreen.y*=o,B.positionScreen.copy(E.positionScreen),J.positionScreen.copy(P.positionScreen),!0===ea.overdraw&&(Xb(C.positionScreen,E.positionScreen),Xb(E.positionScreen,P.positionScreen),Xb(P.positionScreen,C.positionScreen),Xb(G.positionScreen,B.positionScreen),Xb(G.positionScreen,J.positionScreen)),La.addPoint(C.positionScreen.x,C.positionScreen.y),La.addPoint(E.positionScreen.x,E.positionScreen.y),La.addPoint(G.positionScreen.x,
G.positionScreen.y),La.addPoint(P.positionScreen.x,P.positionScreen.y),!0===eb.intersects(La)))(oa=C,D=E,yb=G,zb=P,qb=B,rb=J,hc=a,f.info.render.vertices+=4,f.info.render.faces++,b(ea.opacity),c(ea.blending),void 0!==ea.map&&null!==ea.map||void 0!==ea.envMap&&null!==ea.envMap)?(m(oa,D,zb,0,1,3,na,ea,hc),m(qb,yb,rb,1,2,3,na,ea,hc)):(H=oa.positionScreen.x,I=oa.positionScreen.y,L=D.positionScreen.x,N=D.positionScreen.y,S=yb.positionScreen.x,T=yb.positionScreen.y,M=zb.positionScreen.x,O=zb.positionScreen.y,
Q=qb.positionScreen.x,$=qb.positionScreen.y,K=rb.positionScreen.x,ja=rb.positionScreen.y,ea instanceof THREE.MeshLambertMaterial||ea instanceof THREE.MeshPhongMaterial)?(ba.copy(ea.color),ia.copy(ea.emissive),ea.vertexColors===THREE.FaceColors&&(ba.r*=na.color.r,ba.g*=na.color.g,ba.b*=na.color.b),!0===lb)?!1===ea.wireframe&&ea.shading==THREE.SmoothShading&&4==na.vertexNormalsLength?(ha.r=da.r=Y.r=aa.r=Na.r,ha.g=da.g=Y.g=aa.g=Na.g,ha.b=da.b=Y.b=aa.b=Na.b,n(na.v1.positionWorld,na.vertexNormalsWorld[0],
ha),n(na.v2.positionWorld,na.vertexNormalsWorld[1],da),n(na.v4.positionWorld,na.vertexNormalsWorld[3],Y),n(na.v3.positionWorld,na.vertexNormalsWorld[2],aa),ha.r=ha.r*ba.r+ia.r,ha.g=ha.g*ba.g+ia.g,ha.b=ha.b*ba.b+ia.b,da.r=da.r*ba.r+ia.r,da.g=da.g*ba.g+ia.g,da.b=da.b*ba.b+ia.b,Y.r=Y.r*ba.r+ia.r,Y.g=Y.g*ba.g+ia.g,Y.b=Y.b*ba.b+ia.b,aa.r=aa.r*ba.r+ia.r,aa.g=aa.g*ba.g+ia.g,aa.b=aa.b*ba.b+ia.b,va=wc(ha,da,Y,aa),r(H,I,L,N,M,O),ma(H,I,L,N,M,O,0,0,1,0,0,1,va),r(Q,$,S,T,K,ja),ma(Q,$,S,T,K,ja,1,0,1,1,0,1,va)):
(R.r=Na.r,R.g=Na.g,R.b=Na.b,n(na.centroidWorld,na.normalWorld,R),R.r=R.r*ba.r+ia.r,R.g=R.g*ba.g+ia.g,R.b=R.b*ba.b+ia.b,t(H,I,L,N,S,T,M,O),!0===ea.wireframe?s(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):u(R)):(R.r=ba.r+ia.r,R.g=ba.g+ia.g,R.b=ba.b+ia.b,t(H,I,L,N,S,T,M,O),!0===ea.wireframe?s(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):u(R)):ea instanceof THREE.MeshBasicMaterial?(R.copy(ea.color),ea.vertexColors===THREE.FaceColors&&(R.r*=na.color.r,R.g*=na.color.g,
R.b*=na.color.b),t(H,I,L,N,S,T,M,O),!0===ea.wireframe?s(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):u(R)):ea instanceof THREE.MeshNormalMaterial?(R.r=gc(na.normalWorld.x),R.g=gc(na.normalWorld.y),R.b=gc(na.normalWorld.z),t(H,I,L,N,S,T,M,O),!0===ea.wireframe?s(R,ea.wireframeLinewidth,ea.wireframeLinecap,ea.wireframeLinejoin):u(R)):ea instanceof THREE.MeshDepthMaterial&&(Ca=l.near,Ka=l.far,ha.r=ha.g=ha.b=1-Cb(oa.positionScreen.z,Ca,Ka),da.r=da.g=da.b=1-Cb(D.positionScreen.z,Ca,
Ka),Y.r=Y.g=Y.b=1-Cb(zb.positionScreen.z,Ca,Ka),aa.r=aa.g=aa.b=1-Cb(yb.positionScreen.z,Ca,Ka),va=wc(ha,da,Y,aa),r(H,I,L,N,M,O),ma(H,I,L,N,M,O,0,0,1,0,0,1,va),r(Q,$,S,T,K,ja),ma(Q,$,S,T,K,ja,1,0,1,1,0,1,va));xa.addRectangle(La)}q.setTransform(1,0,0,1,0,0)}}};
...
a.colors,j=i.length,l=a.__vertexArray,n=a.__colorArray,m=a.__sortArray,o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){ab.copy($a);ab.multiplySelf(c.matrixWorld);for(d=0;d<g;d++)e=h[d],mb.copy(e),ab.multiplyVector3(mb),m[d]=[mb.z,d];m.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++)e=h[m[d][1]],f=3*d,l[f]=e.x,l[f+1]=e.y,l[f+2]=e.z;for(d=0;d<j;d++)f=3*d,e=i[m[d][1]],n[f]=e.r,n[f+1]=e.g,n[f+2]=e.b;if(q){i=0;for(j=q.length;i<j;i++)if(h=q[i],void 0===
h.boundTo||"vertices"===h.boundTo)if(f=0,e=h.value.length,1===h.size)for(d=0;d<e;d++)g=m[d][1],h.array[d]=h.value[g];else if(2===h.size)for(d=0;d<e;d++)g=m[d][1],g=h.value[g],h.array[f]=g.x,h.array[f+1]=g.y,f+=2;else if(3===h.size)if("c"===h.type)for(d=0;d<e;d++)g=m[d][1],g=h.value[g],h.array[f]=g.r,h.array[f+1]=g.g,h.array[f+2]=g.b,f+=3;else for(d=0;d<e;d++)g=m[d][1],g=h.value[g],h.array[f]=g.x,h.array[f+1]=g.y,h.array[f+2]=g.z,f+=3;else if(4===h.size)for(d=0;d<e;d++)g=m[d][1],g=h.value[g],h.array[f]=
...
!1,e.boneMatrices);if(f){c&&d.fog&&(i.fogColor.value=c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(gb){for(var l=0,n=0,m=0,o,p,q,r=pb,s=r.directional.colors,t=r.directional.positions,u=r.point.colors,z=r.point.positions,A=r.point.distances,B=r.spot.colors,C=r.spot.positions,E=r.spot.distances,G=r.spot.directions,R=
r.spot.anglesCos,J=r.spot.exponents,O=r.hemi.skyColors,Q=r.hemi.groundColors,N=r.hemi.positions,S=0,M=0,L=0,da=0,ia=0,$=0,aa=0,ca=0,T=p=0,c=T=T=0,f=b.length;c<f;c++)j=b[c],j.onlyShadow||(o=j.color,q=j.intensity,p=j.distance,j instanceof THREE.AmbientLight?j.visible&&(K.gammaInput?(l+=o.r*o.r,n+=o.g*o.g,m+=o.b*o.b):(l+=o.r,n+=o.g,m+=o.b)):j instanceof THREE.DirectionalLight?(ia+=1,j.visible&&(p=3*S,K.gammaInput?w(s,p,o,q*q):v(s,p,o,q),ta.copy(j.matrixWorld.getPosition()),ta.subSelf(j.target.matrixWorld.getPosition()),
ta.normalize(),t[p]=ta.x,t[p+1]=ta.y,t[p+2]=ta.z,S+=1)):j instanceof THREE.PointLight?($+=1,j.visible&&(T=3*M,K.gammaInput?w(u,T,o,q*q):v(u,T,o,q),q=j.matrixWorld.getPosition(),z[T]=q.x,z[T+1]=q.y,z[T+2]=q.z,A[M]=p,M+=1)):j instanceof THREE.SpotLight?(aa+=1,j.visible&&(T=3*L,K.gammaInput?w(B,T,o,q*q):v(B,T,o,q),q=j.matrixWorld.getPosition(),C[T]=q.x,C[T+1]=q.y,C[T+2]=q.z,E[L]=p,ta.copy(q),ta.subSelf(j.target.matrixWorld.getPosition()),ta.normalize(),G[T]=ta.x,G[T+1]=ta.y,G[T+2]=ta.z,R[L]=Math.cos(j.angle),
J[L]=j.exponent,L+=1)):j instanceof THREE.HemisphereLight&&(ca+=1,j.visible&&(o=j.color,p=j.groundColor,T=3*da,K.gammaInput?(q*=q,w(O,T,o,q),w(Q,T,p,q)):(v(O,T,o,q),v(Q,T,p,q)),ta.copy(j.matrixWorld.getPosition()),ta.normalize(),N[T]=ta.x,N[T+1]=ta.y,N[T+2]=ta.z,da+=1)));c=3*S;for(f=Math.max(s.length,3*ia);c<f;c++)s[c]=0;c=3*S;for(f=Math.max(t.length,3*ia);c<f;c++)t[c]=0;c=3*M;for(f=Math.max(u.length,3*$);c<f;c++)u[c]=0;c=3*M;for(f=Math.max(z.length,3*$);c<f;c++)z[c]=0;c=M;for(f=Math.max(A.length,
$);c<f;c++)A[c]=0;c=3*L;for(f=Math.max(B.length,3*aa);c<f;c++)B[c]=0;c=3*L;for(f=Math.max(C.length,3*aa);c<f;c++)C[c]=0;c=3*L;for(f=Math.max(G.length,3*aa);c<f;c++)G[c]=0;c=L;for(f=Math.max(R.length,aa);c<f;c++)R[c]=0;c=L;for(f=Math.max(J.length,aa);c<f;c++)J[c]=0;c=L;for(f=Math.max(E.length,aa);c<f;c++)E[c]=0;c=3*da;for(f=Math.max(O.length,3*ca);c<f;c++)O[c]=0;c=3*da;for(f=Math.max(Q.length,3*ca);c<f;c++)Q[c]=0;c=3*da;for(f=Math.max(N.length,3*ca);c<f;c++)N[c]=0;r.directional.length=S;r.point.length=
M;r.spot.length=L;r.hemi.length=da;r.ambient[0]=l;r.ambient[1]=n;r.ambient[2]=m;gb=!1}c=pb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=
...
else if("v4"===l)k.uniform4f(f,j.x,j.y,j.z,j.w);else if("c"===l)k.uniform3f(f,j.r,j.g,j.b);else if("iv1"===l)k.uniform1iv(f,j);else if("iv"===l)k.uniform3iv(f,j);else if("fv1"===l)k.uniform1fv(f,j);else if("fv"===l)k.uniform3fv(f,j);else if("v2v"===l){void 0===c._array&&(c._array=new Float32Array(2*j.length));l=0;for(n=j.length;l<n;l++)m=2*l,c._array[m]=j[l].x,c._array[m+1]=j[l].y;k.uniform2fv(f,c._array)}else if("v3v"===l){void 0===c._array&&(c._array=new Float32Array(3*j.length));l=0;for(n=j.length;l<
n;l++)m=3*l,c._array[m]=j[l].x,c._array[m+1]=j[l].y,c._array[m+2]=j[l].z;k.uniform3fv(f,c._array)}else if("v4v"===l){void 0===c._array&&(c._array=new Float32Array(4*j.length));l=0;for(n=j.length;l<n;l++)m=4*l,c._array[m]=j[l].x,c._array[m+1]=j[l].y,c._array[m+2]=j[l].z,c._array[m+3]=j[l].w;k.uniform4fv(f,c._array)}else if("m4"===l)void 0===c._array&&(c._array=new Float32Array(16)),j.flattenToArray(c._array),k.uniformMatrix4fv(f,!1,c._array);else if("m4v"===l){void 0===c._array&&(c._array=new Float32Array(16*
j.length));l=0;for(n=j.length;l<n;l++)j[l].flattenToArrayOffset(c._array,16*l);k.uniformMatrix4fv(f,!1,c._array)}else if("t"===l){if(m=j,j=D(),k.uniform1i(f,j),m)if(m.image instanceof Array&&6===m.image.length){if(c=m,f=j,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=k.createTexture());k.activeTexture(k.TEXTURE0+f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;
j=[];for(l=0;6>l;l++)K.autoScaleCubemaps&&!f?(n=j,m=l,r=c.image[l],t=Oc,r.width<=t&&r.height<=t||(u=Math.max(r.width,r.height),s=Math.floor(r.width*t/u),t=Math.floor(r.height*t/u),u=document.createElement("canvas"),u.width=s,u.height=t,u.getContext("2d").drawImage(r,0,0,r.width,r.height,0,0,s,t),r=u),n[m]=r):j[l]=c.image[l];l=j[0];n=0===(l.width&l.width-1)&&0===(l.height&l.height-1);m=H(c.format);r=H(c.type);P(k.TEXTURE_CUBE_MAP,c,n);for(l=0;6>l;l++)if(f){t=j[l].mipmaps;u=0;for(z=t.length;u<z;u++)s=
t[u],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,u,m,s.width,s.height,0,s.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,m,m,r,j[l]);c.generateMipmaps&&n&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else m instanceof THREE.WebGLRenderTargetCube?(c=m,k.activeTexture(k.TEXTURE0+j),k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)):K.setTexture(m,
j)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(n=c.value.length;l<n;l++)c._array[l]=D();k.uniform1iv(f,c._array);l=0;for(n=c.value.length;l<n;l++)m=c.value[l],j=c._array[l],m&&K.setTexture(m,j)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==h.cameraPosition)b=a.matrixWorld.getPosition(),k.uniform3f(h.cameraPosition,b.x,b.y,b.z);(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||
...
if(a===THREE.RGBA_S3TC_DXT3_Format)return ob.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===THREE.RGBA_S3TC_DXT5_Format)return ob.COMPRESSED_RGBA_S3TC_DXT5_EXT}return 0}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},I=void 0!==a.canvas?a.canvas:document.createElement("canvas"),L=void 0!==a.precision?a.precision:"highp",N=void 0!==a.alpha?a.alpha:!0,S=void 0!==a.premultipliedAlpha?a.premultipliedAlpha:!0,T=void 0!==a.antialias?a.antialias:!1,M=void 0!==a.stencil?a.stencil:!0,O=void 0!==a.preserveDrawingBuffer?
a.preserveDrawingBuffer:!1,Q=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),$=void 0!==a.clearAlpha?a.clearAlpha:0;this.domElement=I;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapCullFrontFaces=this.shadowMapSoft=this.shadowMapAutoUpdate=!0;this.shadowMapCascade=this.shadowMapDebug=
!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var K=this,ja=[],R=0,ha=null,da=null,Y=-1,aa=null,ba=null,ia=0,wa=0,ua=-1,Ca=-1,Ka=-1,va=-1,cb=-1,wb=-1,Ua=-1,fb=-1,kb=null,Ab=null,Bb=null,eb=null,xa=0,La=0,lb=0,Na=0,Za=0,db=0,ka=new THREE.Frustum,$a=new THREE.Matrix4,ab=new THREE.Matrix4,mb=new THREE.Vector4,ta=new THREE.Vector3,
gb=!0,pb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,xb,ob;try{if(!(k=I.getContext("experimental-webgl",{alpha:N,premultipliedAlpha:S,antialias:T,stencil:M,preserveDrawingBuffer:O})))throw"Error creating WebGL context.";}catch(Nc){console.error(Nc)}a=k.getExtension("OES_texture_float");
...
(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=0;for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.render=!1,g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||ka.contains(g))){z(g,b);var m=f,q=m.object,r=m.buffer,t=void 0,s=t=void 0,s=q.material;if(s instanceof THREE.MeshFaceMaterial)t=r.materialIndex,0<=t&&(t=0<s.materials.length?s.materials[t]:q.geometry.materials[t],t.transparent?(m.transparent=
t,m.opaque=null):(m.opaque=t,m.transparent=null));else if(t=s)t.transparent?(m.transparent=t,m.opaque=null):(m.opaque=t,m.transparent=null);f.render=!0;!0===this.sortObjects&&(null!==g.renderDepth?f.z=g.renderDepth:(mb.copy(g.matrixWorld.getPosition()),$a.multiplyVector3(mb),f.z=mb.z),f.id=g.id)}this.sortObjects&&h.sort(l);h=a.__webglObjectsImmediate;d=0;for(e=h.length;d<e;d++)f=h[d],g=f.object,g.visible&&(z(g,b),g=f.object.material,g.transparent?(f.transparent=g,f.opaque=null):(f.opaque=g,f.transparent=
...
"transparent",b,i,j,!0));n(this.renderPluginsPost,a,b);c&&(c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&c.minFilter!==THREE.LinearFilter)&&(c instanceof THREE.WebGLRenderTargetCube?(k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture),k.generateMipmap(k.TEXTURE_CUBE_MAP),k.bindTexture(k.TEXTURE_CUBE_MAP,null)):(k.bindTexture(k.TEXTURE_2D,c.__webglTexture),k.generateMipmap(k.TEXTURE_2D),k.bindTexture(k.TEXTURE_2D,null)));this.setDepthTest(!0);this.setDepthWrite(!0)}};this.renderImmediateObject=
function(a,b,c,d,e){var f=s(a,b,c,d,e);aa=-1;K.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,ka):e.render(function(a){K.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=a.__objectsAdded[0],l=a,n=void 0,m=void 0,o=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=
new THREE.Matrix3,b instanceof THREE.Mesh)if(m=b.geometry,m instanceof THREE.Geometry){if(void 0===m.geometryGroups){var p=m,s=void 0,v=void 0,w=void 0,z=void 0,B=void 0,D=void 0,C=void 0,E={},G=p.morphTargets.length,H=p.morphNormals.length;p.geometryGroups={};s=0;for(v=p.faces.length;s<v;s++)w=p.faces[s],z=w.materialIndex,D=void 0!==z?z:-1,void 0===E[D]&&(E[D]={hash:D,counter:0}),C=E[D].hash+"_"+E[D].counter,void 0===p.geometryGroups[C]&&(p.geometryGroups[C]={faces3:[],faces4:[],materialIndex:z,
...
ia++,p.geometryGroupsList.push(p.geometryGroups[I])}for(n in m.geometryGroups)if(o=m.geometryGroups[n],!o.__webglVertexBuffer){var R=o;R.__webglVertexBuffer=k.createBuffer();R.__webglNormalBuffer=k.createBuffer();R.__webglTangentBuffer=k.createBuffer();R.__webglColorBuffer=k.createBuffer();R.__webglUVBuffer=k.createBuffer();R.__webglUV2Buffer=k.createBuffer();R.__webglSkinIndicesBuffer=k.createBuffer();R.__webglSkinWeightsBuffer=k.createBuffer();R.__webglFaceBuffer=k.createBuffer();R.__webglLineBuffer=
k.createBuffer();var J=void 0,Y=void 0;if(R.numMorphTargets){R.__webglMorphTargetsBuffers=[];J=0;for(Y=R.numMorphTargets;J<Y;J++)R.__webglMorphTargetsBuffers.push(k.createBuffer())}if(R.numMorphNormals){R.__webglMorphNormalsBuffers=[];J=0;for(Y=R.numMorphNormals;J<Y;J++)R.__webglMorphNormalsBuffers.push(k.createBuffer())}K.info.memory.geometries++;d(o,b);m.verticesNeedUpdate=!0;m.morphTargetsNeedUpdate=!0;m.elementsNeedUpdate=!0;m.uvsNeedUpdate=!0;m.normalsNeedUpdate=!0;m.tangentsNeedUpdate=!0;m.colorsNeedUpdate=
!0}}else m instanceof THREE.BufferGeometry&&h(m);else if(b instanceof THREE.Ribbon){if(m=b.geometry,!m.__webglVertexBuffer){var O=m;O.__webglVertexBuffer=k.createBuffer();O.__webglColorBuffer=k.createBuffer();O.__webglNormalBuffer=k.createBuffer();K.info.memory.geometries++;var Q=m,P=b,L=Q.vertices.length;Q.__vertexArray=new Float32Array(3*L);Q.__colorArray=new Float32Array(3*L);Q.__normalArray=new Float32Array(3*L);Q.__webglVertexCount=L;c(Q,P);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.normalsNeedUpdate=
!0}}else if(b instanceof THREE.Line){if(m=b.geometry,!m.__webglVertexBuffer){var N=m;N.__webglVertexBuffer=k.createBuffer();N.__webglColorBuffer=k.createBuffer();N.__webglLineDistanceBuffer=k.createBuffer();K.info.memory.geometries++;var M=m,S=b,da=M.vertices.length;M.__vertexArray=new Float32Array(3*da);M.__colorArray=new Float32Array(3*da);M.__lineDistanceArray=new Float32Array(1*da);M.__webglLineCount=da;c(M,S);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0;m.lineDistancesNeedUpdate=!0}}else if(b instanceof
THREE.ParticleSystem&&(m=b.geometry,!m.__webglVertexBuffer))if(m instanceof THREE.Geometry){var ha=m;ha.__webglVertexBuffer=k.createBuffer();ha.__webglColorBuffer=k.createBuffer();K.info.memory.geometries++;var T=m,$=b,ba=T.vertices.length;T.__vertexArray=new Float32Array(3*ba);T.__colorArray=new Float32Array(3*ba);T.__sortArray=[];T.__webglParticleCount=ba;c(T,$);m.verticesNeedUpdate=!0;m.colorsNeedUpdate=!0}else m instanceof THREE.BufferGeometry&&h(m);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(m=
b.geometry,m instanceof THREE.BufferGeometry)q(l.__webglObjects,m,b);else for(n in m.geometryGroups)o=m.geometryGroups[n],q(l.__webglObjects,o,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(m=b.geometry,q(l.__webglObjects,m,b)):b instanceof THREE.ImmediateRenderObject||b.immediateRenderCallback?l.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof THREE.Sprite?l.__webglSprites.push(b):b instanceof THREE.LensFlare&&l.__webglFlares.push(b);
...
n="lambert":a instanceof THREE.MeshPhongMaterial?n="phong":a instanceof THREE.LineBasicMaterial?n="basic":a instanceof THREE.LineDashedMaterial?n="dashed":a instanceof THREE.ParticleBasicMaterial&&(n="particle_basic");if(n){var o=THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var p,q,r;e=p=q=r=o=0;for(f=b.length;e<f;e++)g=b[e],g.onlyShadow||(g instanceof THREE.DirectionalLight&&p++,g instanceof THREE.PointLight&&
...
THREE.DoubleSide,flipSided:a.side===THREE.BackSide},s,u,v,d=[];n?d.push(n):(d.push(q),d.push(r));for(u in p)d.push(u),d.push(p[u]);for(s in c)d.push(s),d.push(c[s]);n=d.join();s=0;for(u=ja.length;s<u;s++)if(d=ja[s],d.code===n){d.usedTimes++;t=d.program;break a}s=[];for(v in p)u=p[v],!1!==u&&(u="#define "+v+" "+u,s.push(u));u=s.join("\n");v=k.createProgram();s=["precision "+L+" float;",u,ec?"#define VERTEX_TEXTURES":"",K.gammaInput?"#define GAMMA_INPUT":"",K.gammaOutput?"#define GAMMA_OUTPUT":"",K.physicallyBasedShading?
...
THREE.GeometryUtils={merge:function(a,b){for(var c,d,e=a.vertices.length,f=b instanceof THREE.Mesh?b.geometry:b,g=a.vertices,h=f.vertices,i=a.faces,j=f.faces,l=a.faceVertexUvs[0],f=f.faceVertexUvs[0],m=0;m<a.materials.length;m++);b instanceof THREE.Mesh&&(b.matrixAutoUpdate&&b.updateMatrix(),c=b.matrix,d=new THREE.Matrix4,d.extractRotation(c,b.scale));for(var m=0,n=h.length;m<n;m++){var p=h[m].clone();c&&c.multiplyVector3(p);g.push(p)}m=0;for(n=j.length;m<n;m++){var p=j[m],o,q,t=p.vertexNormals,r=
p.vertexColors;p instanceof THREE.Face3?o=new THREE.Face3(p.a+e,p.b+e,p.c+e):p instanceof THREE.Face4&&(o=new THREE.Face4(p.a+e,p.b+e,p.c+e,p.d+e));o.normal.copy(p.normal);d&&d.multiplyVector3(o.normal);g=0;for(h=t.length;g<h;g++)q=t[g].clone(),d&&d.multiplyVector3(q),o.vertexNormals.push(q);o.color.copy(p.color);g=0;for(h=r.length;g<h;g++)q=r[g],o.vertexColors.push(q.clone());void 0!==p.materialIndex&&(o.materialIndex=p.materialIndex);o.centroid.copy(p.centroid);c&&c.multiplyVector3(o.centroid);
i.push(o)}m=0;for(n=f.length;m<n;m++){c=f[m];d=[];g=0;for(h=c.length;g<h;g++)d.push(new THREE.UV(c[g].u,c[g].v));l.push(d)}},clone:function(a){var b=new THREE.Geometry,c,d=a.vertices,e=a.faces,f=a.faceVertexUvs[0];a.materials&&(b.materials=a.materials.slice());a=0;for(c=d.length;a<c;a++)b.vertices.push(d[a].clone());a=0;for(c=e.length;a<c;a++)b.faces.push(e[a].clone());a=0;for(c=f.length;a<c;a++){for(var d=f[a],e=[],g=0,h=d.length;g<h;g++)e.push(new THREE.UV(d[g].u,d[g].v));b.faceVertexUvs[0].push(e)}return b},
...
c.y,c.z));a.computeBoundingBox();return c},normalizeUVs:function(a){for(var a=a.faceVertexUvs[0],b=0,c=a.length;b<c;b++)for(var d=a[b],e=0,f=d.length;e<f;e++)if(1!==d[e].u&&(d[e].u-=Math.floor(d[e].u)),1!==d[e].v)d[e].v-=Math.floor(d[e].v)},triangulateQuads:function(a){var b,c,d,e,f=[],g=[],h=[];b=0;for(c=a.faceUvs.length;b<c;b++)g[b]=[];b=0;for(c=a.faceVertexUvs.length;b<c;b++)h[b]=[];b=0;for(c=a.faces.length;b<c;b++)if(d=a.faces[b],d instanceof THREE.Face4){e=d.a;var i=d.b,j=d.c,l=d.d,m=new THREE.Face3,
n=new THREE.Face3;m.color.copy(d.color);n.color.copy(d.color);m.materialIndex=d.materialIndex;n.materialIndex=d.materialIndex;m.a=e;m.b=i;m.c=l;n.a=i;n.b=j;n.c=l;4===d.vertexColors.length&&(m.vertexColors[0]=d.vertexColors[0].clone(),m.vertexColors[1]=d.vertexColors[1].clone(),m.vertexColors[2]=d.vertexColors[3].clone(),n.vertexColors[0]=d.vertexColors[1].clone(),n.vertexColors[1]=d.vertexColors[2].clone(),n.vertexColors[2]=d.vertexColors[3].clone());f.push(m,n);d=0;for(e=a.faceVertexUvs.length;d<
e;d++)a.faceVertexUvs[d].length&&(m=a.faceVertexUvs[d][b],i=m[1],j=m[2],l=m[3],m=[m[0].clone(),i.clone(),l.clone()],i=[i.clone(),j.clone(),l.clone()],h[d].push(m,i));d=0;for(e=a.faceUvs.length;d<e;d++)a.faceUvs[d].length&&(i=a.faceUvs[d][b],g[d].push(i,i))}else{f.push(d);d=0;for(e=a.faceUvs.length;d<e;d++)g[d].push(a.faceUvs[d][b]);d=0;for(e=a.faceVertexUvs.length;d<e;d++)h[d].push(a.faceVertexUvs[d][b])}a.faces=f;a.faceUvs=g;a.faceVertexUvs=h;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals();
...
b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,e,f,g,h,i,j,l,m,n,p,o,q,t,r,A,u,s,D=[],z=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)z[c]=[];c=0;for(d=a.faces.length;c<d;c++)if(e=a.faces[c],e instanceof THREE.Face3)if(f=e.a,g=e.b,h=e.c,j=a.vertices[f],l=a.vertices[g],m=a.vertices[h],p=j.distanceTo(l),o=l.distanceTo(m),n=j.distanceTo(m),p>b||o>b||n>b){i=a.vertices.length;u=e.clone();s=e.clone();p>=o&&p>=n?(j=j.clone(),j.lerpSelf(l,0.5),u.a=f,u.b=i,u.c=h,s.a=i,s.b=g,s.c=h,3===e.vertexNormals.length&&
...
0>m-1?0:m-1,p=m+1>e-1?e-1:m+1,o=0>l-1?0:l-1,q=l+1>d-1?d-1:l+1,t=[],r=[0,0,h[4*(m*d+l)]/255*b];t.push([-1,0,h[4*(m*d+o)]/255*b]);t.push([-1,-1,h[4*(n*d+o)]/255*b]);t.push([0,-1,h[4*(n*d+l)]/255*b]);t.push([1,-1,h[4*(n*d+q)]/255*b]);t.push([1,0,h[4*(m*d+q)]/255*b]);t.push([1,1,h[4*(p*d+q)]/255*b]);t.push([0,1,h[4*(p*d+l)]/255*b]);t.push([-1,1,h[4*(p*d+o)]/255*b]);n=[];o=t.length;for(p=0;p<o;p++){var q=t[p],A=t[(p+1)%o],q=[q[0]-r[0],q[1]-r[1],q[2]-r[2]],A=[A[0]-r[0],A[1]-r[1],A[2]-r[2]];n.push(c([q[1]*
A[2]-q[2]*A[1],q[2]*A[0]-q[0]*A[2],q[0]*A[1]-q[1]*A[0]]))}t=[0,0,0];for(p=0;p<n.length;p++)t[0]+=n[p][0],t[1]+=n[p][1],t[2]+=n[p][2];t[0]/=n.length;t[1]/=n.length;t[2]/=n.length;r=4*(m*d+l);j[r]=255*((t[0]+1)/2)|0;j[r+1]=255*((t[1]+1)/2)|0;j[r+2]=255*t[2]|0;j[r+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+1]=g,e[3*h+2]=c;a=new THREE.DataTexture(e,
...
0,e=String(a).split(""),f=e.length,g=[],a=0;a<f;a++){var h=new THREE.Path,h=this.extractGlyphPoints(e[a],b,c,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(a,b,c,d,e){var f=[],g,h,i,j,l,m,n,p,o,q,t,r=b.glyphs[a]||b.glyphs["?"];if(r){if(r.o){b=r._cachedOutline||(r._cachedOutline=r.o.split(" "));j=b.length;for(a=0;a<j;)switch(i=b[a++],i){case "m":i=b[a++]*c+d;l=b[a++]*c;e.moveTo(i,l);break;case "l":i=b[a++]*c+d;l=b[a++]*c;e.lineTo(i,l);break;case "q":i=b[a++]*
c+d;l=b[a++]*c;p=b[a++]*c+d;o=b[a++]*c;e.quadraticCurveTo(p,o,i,l);if(g=f[f.length-1]){m=g.x;n=g.y;g=1;for(h=this.divisions;g<=h;g++){var A=g/h;THREE.Shape.Utils.b2(A,m,p,i);THREE.Shape.Utils.b2(A,n,o,l)}}break;case "b":if(i=b[a++]*c+d,l=b[a++]*c,p=b[a++]*c+d,o=b[a++]*-c,q=b[a++]*c+d,t=b[a++]*-c,e.bezierCurveTo(i,l,p,o,q,t),g=f[f.length-1]){m=g.x;n=g.y;g=1;for(h=this.divisions;g<=h;g++)A=g/h,THREE.Shape.Utils.b3(A,m,p,q,i),THREE.Shape.Utils.b3(A,n,o,t,l)}}}return{offset:r.ha*c,path:e}}}};
THREE.FontUtils.generateShapes=function(a,b){var b=b||{},c=void 0!==b.curveSegments?b.curveSegments:4,d=void 0!==b.font?b.font:"helvetiker",e=void 0!==b.weight?b.weight:"normal",f=void 0!==b.style?b.style:"normal";THREE.FontUtils.size=void 0!==b.size?b.size:100;THREE.FontUtils.divisions=c;THREE.FontUtils.face=d;THREE.FontUtils.weight=e;THREE.FontUtils.style=f;c=THREE.FontUtils.drawText(a).paths;d=[];e=0;for(f=c.length;e<f;e++)Array.prototype.push.apply(d,c[e].toShapes());return d};
(function(a){var b=function(a){for(var b=a.length,e=0,f=b-1,g=0;g<b;f=g++)e+=a[f].x*a[g].y-a[g].x*a[f].y;return 0.5*e};a.Triangulate=function(a,d){var e=a.length;if(3>e)return null;var f=[],g=[],h=[],i,j,l;if(0<b(a))for(j=0;j<e;j++)g[j]=j;else for(j=0;j<e;j++)g[j]=e-1-j;var m=2*e;for(j=e-1;2<e;){if(0>=m--){console.log("Warning, unable to triangulate polygon!");break}i=j;e<=i&&(i=0);j=i+1;e<=j&&(j=0);l=j+1;e<=l&&(l=0);var n;a:{n=a;var p=i,o=j,q=l,t=e,r=g,A=void 0,u=void 0,s=void 0,D=void 0,z=void 0,
w=void 0,v=void 0,C=void 0,E=void 0,u=n[r[p]].x,s=n[r[p]].y,D=n[r[o]].x,z=n[r[o]].y,w=n[r[q]].x,v=n[r[q]].y;if(1E-10>(D-u)*(v-s)-(z-s)*(w-u))n=!1;else{for(A=0;A<t;A++)if(!(A==p||A==o||A==q)){var C=n[r[A]].x,E=n[r[A]].y,G=void 0,P=void 0,B=void 0,J=void 0,H=void 0,I=void 0,L=void 0,N=void 0,S=void 0,T=void 0,M=void 0,O=void 0,G=B=H=void 0,G=w-D,P=v-z,B=u-w,J=s-v,H=D-u,I=z-s,L=C-u,N=E-s,S=C-D,T=E-z,M=C-w,O=E-v,G=G*T-P*S,H=H*N-I*L,B=B*O-J*M;if(0<=G&&0<=B&&0<=H){n=!1;break a}}n=!0}}if(n){f.push([a[g[i]],
...
THREE.CubeGeometry=function(a,b,c,d,e,f,g,h){function i(a,b,c,d,e,f,g,h){var i,l=j.widthSegments,n=j.heightSegments,m=e/2,o=f/2,p=j.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)i="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)i="y",n=j.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)i="x",l=j.depthSegments;var q=l+1,t=n+1,L=e/l,N=f/n,S=new THREE.Vector3;S[i]=0<g?1:-1;for(e=0;e<t;e++)for(f=0;f<q;f++){var T=new THREE.Vector3;T[a]=(f*L-m)*c;T[b]=(e*N-o)*d;T[i]=g;j.vertices.push(T)}for(e=
0;e<n;e++)for(f=0;f<l;f++)a=new THREE.Face4(f+q*e+p,f+q*(e+1)+p,f+1+q*(e+1)+p,f+1+q*e+p),a.normal.copy(S),a.vertexNormals.push(S.clone(),S.clone(),S.clone(),S.clone()),a.materialIndex=h,j.faces.push(a),j.faceVertexUvs[0].push([new THREE.UV(f/l,1-e/n),new THREE.UV(f/l,1-(e+1)/n),new THREE.UV((f+1)/l,1-(e+1)/n),new THREE.UV((f+1)/l,1-e/n)])}THREE.Geometry.call(this);var j=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;var a=this.width/
2,b=this.height/2,c=this.depth/2,l,m,n,p,o,q;if(void 0!==g){if(g instanceof Array)this.materials=g;else{this.materials=[];for(l=0;6>l;l++)this.materials.push(g)}l=0;p=1;m=2;o=3;n=4;q=5}else this.materials=[];this.sides={px:!0,nx:!0,py:!0,ny:!0,pz:!0,nz:!0};if(void 0!=h)for(var t in h)void 0!==this.sides[t]&&(this.sides[t]=h[t]);this.sides.px&&i("z","y",-1,-1,this.depth,this.height,a,l);this.sides.nx&&i("z","y",1,-1,this.depth,this.height,-a,p);this.sides.py&&i("x","z",1,1,this.width,this.depth,b,
m);this.sides.ny&&i("x","z",1,-1,this.width,this.depth,-b,o);this.sides.pz&&i("x","y",1,-1,this.width,this.height,c,n);this.sides.nz&&i("x","y",-1,-1,this.width,this.height,-c,q);this.computeCentroids();this.mergeVertices()};THREE.CubeGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
1]].clone()):(m=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var p=j[i][h],o=j[i+1][h],q=j[i+1][h+1],t=j[i][h+1],r=m.clone(),A=m.clone(),u=n.clone(),s=n.clone(),D=l[i][h].clone(),z=l[i+1][h].clone(),w=l[i+1][h+1].clone(),v=l[i][h+1].clone();this.faces.push(new THREE.Face4(p,o,q,t,[r,A,u,s]));this.faceVertexUvs[0].push([D,z,w,v])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
...
for(var g=0,h=n+2*l,g=0;g<h;g++){var i=S*g,j=S*(g+1),m=d+e+i,i=d+f+i,o=d+f+j,j=d+e+j,p=c,q=g,t=h,s=e,u=f,m=m+G,i=i+G,o=o+G,j=j+G;E.faces.push(new THREE.Face4(m,i,o,j,null,null,r));m=A.generateSideWallUV(E,a,p,b,m,i,o,j,q,t,s,u);E.faceVertexUvs[0].push(m)}}}function f(a,b,c){E.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=G;d+=G;e+=G;E.faces.push(new THREE.Face3(c,d,e,null,null,t));c=f?A.generateBottomUV(E,a,b,c,d,e):A.generateTopUV(E,a,b,c,d,e);E.faceVertexUvs[0].push(c)}var h=void 0!==
b.amount?b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,l=void 0!==b.bevelSegments?b.bevelSegments:3,m=void 0!==b.bevelEnabled?b.bevelEnabled:!0,n=void 0!==b.steps?b.steps:1,p=b.extrudePath,o,q=!1,t=b.material,r=b.extrudeMaterial,A=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,u,s,D,z;p&&(o=p.getSpacedPoints(n),q=!0,m=!1,u=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(p,n,!1),s=new THREE.Vector3,D=new THREE.Vector3,
z=new THREE.Vector3);m||(j=i=l=0);var w,v,C,E=this,G=this.vertices.length,p=a.extractPoints(),P=p.shape,p=p.holes,B=!THREE.Shape.Utils.isClockWise(P);if(B){P=P.reverse();v=0;for(C=p.length;v<C;v++)w=p[v],THREE.Shape.Utils.isClockWise(w)&&(p[v]=w.reverse());B=!1}var J=THREE.Shape.Utils.triangulateShape(P,p),B=P;v=0;for(C=p.length;v<C;v++)w=p[v],P=P.concat(w);var H,I,L,N,S=P.length,T=J.length,M=[],O=0,Q=B.length;H=Q-1;for(I=O+1;O<Q;O++,H++,I++)H===Q&&(H=0),I===Q&&(I=0),M[O]=d(B[O],B[H],B[I]);var $=
[],K,ja=M.concat();v=0;for(C=p.length;v<C;v++){w=p[v];K=[];O=0;Q=w.length;H=Q-1;for(I=O+1;O<Q;O++,H++,I++)H===Q&&(H=0),I===Q&&(I=0),K[O]=d(w[O],w[H],w[I]);$.push(K);ja=ja.concat(K)}for(H=0;H<l;H++){w=H/l;L=i*(1-w);I=j*Math.sin(w*Math.PI/2);O=0;for(Q=B.length;O<Q;O++)N=c(B[O],M[O],I),f(N.x,N.y,-L);v=0;for(C=p.length;v<C;v++){w=p[v];K=$[v];O=0;for(Q=w.length;O<Q;O++)N=c(w[O],K[O],I),f(N.x,N.y,-L)}}I=j;for(O=0;O<S;O++)N=m?c(P[O],ja[O],I):P[O],q?(D.copy(u.normals[0]).multiplyScalar(N.x),s.copy(u.binormals[0]).multiplyScalar(N.y),
z.copy(o[0]).addSelf(D).addSelf(s),f(z.x,z.y,z.z)):f(N.x,N.y,0);for(w=1;w<=n;w++)for(O=0;O<S;O++)N=m?c(P[O],ja[O],I):P[O],q?(D.copy(u.normals[w]).multiplyScalar(N.x),s.copy(u.binormals[w]).multiplyScalar(N.y),z.copy(o[w]).addSelf(D).addSelf(s),f(z.x,z.y,z.z)):f(N.x,N.y,h/n*w);for(H=l-1;0<=H;H--){w=H/l;L=i*(1-w);I=j*Math.sin(w*Math.PI/2);O=0;for(Q=B.length;O<Q;O++)N=c(B[O],M[O],I),f(N.x,N.y,h+L);v=0;for(C=p.length;v<C;v++){w=p[v];K=$[v];O=0;for(Q=w.length;O<Q;O++)N=c(w[O],K[O],I),q?f(N.x,N.y+o[n-1].y,
o[n-1].x+L):f(N.x,N.y,h+L)}}if(m){i=0*S;for(O=0;O<T;O++)h=J[O],g(h[2]+i,h[1]+i,h[0]+i,!0);i=S*(n+2*l);for(O=0;O<T;O++)h=J[O],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(O=0;O<T;O++)h=J[O],g(h[2],h[1],h[0],!0);for(O=0;O<T;O++)h=J[O],g(h[0]+S*n,h[1]+S*n,h[2]+S*n,!1)}h=0;e(B,h);h+=B.length;v=0;for(C=p.length;v<C;v++)w=p[v],e(w,h),h+=w.length};
...
1],o.r+=p.r,o.g+=p.g,o.b+=p.b;o.r/=q.length;o.g/=q.length;o.b/=q.length;n.vertexColors[r]=o}}i.push(n);l.supportUVs&&(g=[f(a,""),f(b,m),f(d,m),f(e,m)],g[0]?g[1]?g[2]?g[3]?j.push(g):c("d :( ",e+":"+m):c("c :( ",d+":"+m):c("b :( ",b+":"+m):c("a :( ",a+":"+m))}function f(a,b){var e=a+":"+b,f=u[e];return!f?(a>=q&&a<q+o.length?c("face pt"):c("edge pt"),d("warning, UV not found for",e),null):f}function g(a,b,c){var e=a+":"+b;e in u?d("dup vertexNo",a,"oldFaceNo",b,"value",c,"key",e,u[e]):u[e]=c}var h=[],
i=[],j=[],l=this,m=THREE.GeometryUtils.orderedKey,n=THREE.GeometryUtils.computeEdgeFaces,p=a.vertices,o=a.faces,q=p.length,h=p.concat(),t=[],r={},A={},u={},s,D,z,w,v,C=a.faceVertexUvs[0],E;c("originalFaces, uvs, originalVerticesLength",o.length,C.length,q);if(l.supportUVs){s=0;for(D=C.length;s<D;s++){z=0;for(w=C[s].length;z<w;z++)E=o[s]["abcd".charAt(z)],g(E,s,C[s][z])}}0==C.length&&(l.supportUVs=!1);s=0;for(var G in u)s++;s||(l.supportUVs=!1,c("no uvs"));s=0;for(D=o.length;s<D;s++)v=o[s],t.push(v.centroid),
h.push(v.centroid),l.supportUVs&&(w=new THREE.UV,v instanceof THREE.Face3?(w.u=f(v.a,s).u+f(v.b,s).u+f(v.c,s).u,w.v=f(v.a,s).v+f(v.b,s).v+f(v.c,s).v,w.u/=3,w.v/=3):v instanceof THREE.Face4&&(w.u=f(v.a,s).u+f(v.b,s).u+f(v.c,s).u+f(v.d,s).u,w.v=f(v.a,s).v+f(v.b,s).v+f(v.c,s).v+f(v.d,s).v,w.u/=4,w.v/=4),g(q+s,"",w));var n=n(a),P;D=0;var B,J;G={};C={};for(s in n){E=n[s];B=s.split("_");J=B[0];B=B[1];z=J;v=[J,B];void 0===G[z]&&(G[z]=[]);G[z].push(v);z=B;v=[J,B];void 0===G[z]&&(G[z]=[]);G[z].push(v);z=0;
for(w=E.length;z<w;z++){v=E[z];P=J;var H=v,I=s;void 0===C[P]&&(C[P]={});C[P][H]=I;P=B;H=s;void 0===C[P]&&(C[P]={});C[P][v]=H}2>E.length&&(A[s]=!0)}for(s in n)if(E=n[s],v=E[0],P=E[1],B=s.split("_"),J=B[0],B=B[1],w=new THREE.Vector3,b(0<E.length,"an edge without faces?!"),1==E.length?(w.addSelf(p[J]),w.addSelf(p[B]),w.multiplyScalar(0.5)):(w.addSelf(t[v]),w.addSelf(t[P]),w.addSelf(p[J]),w.addSelf(p[B]),w.multiplyScalar(0.25)),r[s]=q+o.length+D,h.push(w),D++,l.supportUVs)w=new THREE.UV,w.u=f(J,v).u+
f(B,v).u,w.v=f(J,v).v+f(B,v).v,w.u/=2,w.v/=2,g(r[s],v,w),2<=E.length&&(b(2==E.length,"did we plan for more than 2 edges?"),w=new THREE.UV,w.u=f(J,P).u+f(B,P).u,w.v=f(J,P).v+f(B,P).v,w.u/=2,w.v/=2,g(r[s],P,w));c("-- Step 2 done");var L,N;w=["123","12","2","23"];P=["123","23","3","31"];var H=["123","31","1","12"],I=["1234","12","2","23"],S=["1234","23","3","34"],T=["1234","34","4","41"],M=["1234","41","1","12"];s=0;for(D=t.length;s<D;s++)v=o[s],E=q+s,v instanceof THREE.Face3?(J=m(v.a,v.b),B=m(v.b,v.c),
L=m(v.c,v.a),e(E,r[J],v.b,r[B],v,w,s),e(E,r[B],v.c,r[L],v,P,s),e(E,r[L],v.a,r[J],v,H,s)):v instanceof THREE.Face4?(J=m(v.a,v.b),B=m(v.b,v.c),L=m(v.c,v.d),N=m(v.d,v.a),e(E,r[J],v.b,r[B],v,I,s),e(E,r[B],v.c,r[L],v,S,s),e(E,r[L],v.d,r[N],v,T,s),e(E,r[N],v.a,r[J],v,M,s)):c("face should be a face!",v);r=new THREE.Vector3;v=new THREE.Vector3;s=0;for(D=p.length;s<D;s++)if(void 0!==G[s]){r.set(0,0,0);v.set(0,0,0);B=new THREE.Vector3(0,0,0);E=0;for(z in C[s])r.addSelf(t[z]),E++;P=0;J=G[s].length;w=E!=J;for(z=
0;z<J;z++)A[m(G[s][z][0],G[s][z][1])]&&P++;r.divideScalar(E);P=0;if(w){for(z=0;z<J;z++)if(E=G[s][z],H=1==n[m(E[0],E[1])].length)E=p[E[0]].clone().addSelf(p[E[1]]).divideScalar(2),v.addSelf(E),P++;v.divideScalar(4);b(2==P,"should have only 2 boundary edges")}else{for(z=0;z<J;z++)E=G[s][z],E=p[E[0]].clone().addSelf(p[E[1]]).divideScalar(2),v.addSelf(E);v.divideScalar(J)}B.addSelf(p[s]);w?(B.divideScalar(2),B.addSelf(v)):(B.multiplyScalar(J-3),B.addSelf(r),B.addSelf(v.multiplyScalar(2)),B.divideScalar(J));
...
"color");n.scale=b.getUniformLocation(l,"scale");n.rotation=b.getUniformLocation(l,"rotation");n.screenPosition=b.getUniformLocation(l,"screenPosition");p=!1};this.render=function(a,d,e,r){var a=a.__webglFlares,A=a.length;if(A){var u=new THREE.Vector3,s=r/e,D=0.5*e,z=0.5*r,w=16/r,v=new THREE.Vector2(w*s,w),C=new THREE.Vector3(1,1,0),E=new THREE.Vector2(1,1),G=n,w=m;b.useProgram(l);p||(b.enableVertexAttribArray(m.vertex),b.enableVertexAttribArray(m.uv),p=!0);b.uniform1i(G.occlusionMap,0);b.uniform1i(G.map,
1);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(w.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(w.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var P,B,J,H,I;for(P=0;P<A;P++)if(w=16/r,v.set(w*s,w),H=a[P],u.set(H.matrixWorld.elements[12],H.matrixWorld.elements[13],H.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(u),d.projectionMatrix.multiplyVector3(u),C.copy(u),E.x=C.x*D+D,E.y=C.y*z+z,j||0<E.x&&E.x<e&&0<E.y&&E.y<r){b.activeTexture(b.TEXTURE1);
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,m){var n,p,o,q,t,r,A,u,s,D=[];q=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(!0);n=0;for(p=l.__lights.length;n<p;n++)if(o=l.__lights[n],o.castShadow)if(o instanceof THREE.DirectionalLight&&o.shadowCascade)for(t=0;t<o.shadowCascadeCount;t++){var z;if(o.shadowCascadeArray[t])z=o.shadowCascadeArray[t];else{s=o;A=t;z=new THREE.DirectionalLight;z.isVirtual=!0;z.onlyShadow=!0;z.castShadow=!0;z.shadowCameraNear=s.shadowCameraNear;z.shadowCameraFar=s.shadowCameraFar;z.shadowCameraLeft=s.shadowCameraLeft;z.shadowCameraRight=s.shadowCameraRight;
...
1,u);r[3].set(1,1,u);r[4].set(-1,-1,s);r[5].set(1,-1,s);r[6].set(-1,1,s);r[7].set(1,1,s);z.originalCamera=m;r=new THREE.Gyroscope;r.position=o.shadowCascadeOffset;r.add(z);r.add(z.target);m.add(r);o.shadowCascadeArray[t]=z;console.log("Created virtualLight",z)}A=o;u=t;s=A.shadowCascadeArray[u];s.position.copy(A.position);s.target.position.copy(A.target.position);s.lookAt(s.target);s.shadowCameraVisible=A.shadowCameraVisible;s.shadowDarkness=A.shadowDarkness;s.shadowBias=A.shadowCascadeBias[u];r=A.shadowCascadeNearZ[u];
A=A.shadowCascadeFarZ[u];s=s.pointsFrustum;s[0].z=r;s[1].z=r;s[2].z=r;s[3].z=r;s[4].z=A;s[5].z=A;s[6].z=A;s[7].z=A;D[q]=z;q++}else D[q]=o,q++;n=0;for(p=D.length;n<p;n++){o=D[n];o.shadowMap||(o.shadowMap=new THREE.WebGLRenderTarget(o.shadowMapWidth,o.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat}),o.shadowMapSize=new THREE.Vector2(o.shadowMapWidth,o.shadowMapHeight),o.shadowMatrix=new THREE.Matrix4);if(!o.shadowCamera){if(o instanceof THREE.SpotLight)o.shadowCamera=
...
new THREE.CameraHelper(o.shadowCamera),o.shadowCamera.add(o.cameraHelper));if(o.isVirtual&&z.originalCamera==m){t=m;q=o.shadowCamera;r=o.pointsFrustum;s=o.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(A=0;8>A;A++)if(u=s[A],u.copy(r[A]),THREE.ShadowMapPlugin.__projector.unprojectVector(u,t),q.matrixWorldInverse.multiplyVector3(u),u.x<i.x&&(i.x=u.x),u.x>j.x&&(j.x=u.x),u.y<i.y&&(i.y=u.y),u.y>j.y&&(j.y=u.y),u.z<i.z&&(i.z=u.z),u.z>j.z)j.z=u.z;q.left=i.x;q.right=
