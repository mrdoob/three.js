...
0;g[8]=0;g[12]=-((b+a)/h);g[1]=0;g[5]=2/i;g[9]=0;g[13]=-((c+d)/i);g[2]=0;g[6]=0;g[10]=-2/j;g[14]=-((f+e)/j);g[3]=0;g[7]=0;g[11]=0;g[15]=1;return this},clone:function(){var a=this.elements;return new THREE.Matrix4(a[0],a[4],a[8],a[12],a[1],a[5],a[9],a[13],a[2],a[6],a[10],a[14],a[3],a[7],a[11],a[15])}};
...
a.LOD)f.getPositionFromMatrix(h.matrixWorld),r=j.ray.origin.distanceTo(f),i(h.getObjectForDistance(r),j,p);else if(h instanceof a.Mesh){f.getPositionFromMatrix(h.matrixWorld);b.set(f,h.geometry.boundingSphere.radius*h.matrixWorld.getMaxScaleOnAxis());if(!j.ray.isIntersectionSphere(b))return p;var r=h.geometry,s=r.vertices,n=h.material instanceof a.MeshFaceMaterial,q=!0===n?h.material.materials:null,y=h.material.side,u,x,t,E=j.precision;g.getInverse(h.matrixWorld);c.copy(j.ray).applyMatrix4(g);for(var J=
...
c)};this.projectScene=function(g,h,l,Ja){var pa=!1,ta,Z,la,W,V,ha,ga,ka,Pa,jb,na,Ua,Qa;z=t=q=r=0;G.elements.length=0;g.updateMatrixWorld();void 0===h.parent&&h.updateMatrixWorld();U.copy(h.matrixWorldInverse.getInverse(h.matrixWorld));ea.multiplyMatrices(h.projectionMatrix,U);ca.getNormalMatrix(U);oa.setFromMatrix(ea);f=0;G.objects.length=0;G.sprites.length=0;G.lights.length=0;var Aa=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof THREE.Light)G.lights.push(f);
else if(f instanceof THREE.Mesh||f instanceof THREE.Line){if(!1===f.frustumCulled||!0===oa.intersectsObject(f))e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(L.getPositionFromMatrix(f.matrixWorld),L.applyProjection(ea),e.z=L.z),G.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(L.getPositionFromMatrix(f.matrixWorld),L.applyProjection(ea),e.z=L.z),G.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?
e.z=f.renderDepth:(L.getPositionFromMatrix(f.matrixWorld),L.applyProjection(ea),e.z=L.z),G.objects.push(e));Aa(f)}}};Aa(g);!0===l&&G.objects.sort(c);g=0;for(l=G.objects.length;g<l;g++)if(ka=G.objects[g].object,xa=ka.matrixWorld,j=0,ka instanceof THREE.Mesh){Pa=ka.geometry;la=Pa.vertices;jb=Pa.faces;Pa=Pa.faceVertexUvs;A.getNormalMatrix(xa);Ua=ka.material instanceof THREE.MeshFaceMaterial;Qa=!0===Ua?ka.material:null;ta=0;for(Z=la.length;ta<Z;ta++)i=b(),i.positionWorld.copy(la[ta]).applyMatrix4(xa),
i.positionScreen.copy(i.positionWorld).applyMatrix4(ea),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,i.positionScreen.z/=i.positionScreen.w,i.visible=!(-1>i.positionScreen.x||1<i.positionScreen.x||-1>i.positionScreen.y||1<i.positionScreen.y||-1>i.positionScreen.z||1<i.positionScreen.z);la=0;for(ta=jb.length;la<ta;la++){Z=jb[la];var Ra=!0===Ua?Qa.materials[Z.materialIndex]:ka.material;if(void 0!==Ra){ha=Ra.side;if(Z instanceof THREE.Face3)if(W=m[Z.a],V=m[Z.b],ga=m[Z.c],
I[0]=W.positionScreen,I[1]=V.positionScreen,I[2]=ga.positionScreen,!0===W.visible||!0===V.visible||!0===ga.visible||P.isIntersectionBox(C.setFromPoints(I)))if(pa=0>(ga.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(ga.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x),ha===THREE.DoubleSide||pa===(ha===THREE.FrontSide))r===n?(na=new THREE.RenderableFace3,s.push(na),n++,r++,p=na):p=s[r++],p.v1.copy(W),p.v2.copy(V),p.v3.copy(ga);else continue;
else continue;else if(Z instanceof THREE.Face4)if(W=m[Z.a],V=m[Z.b],ga=m[Z.c],na=m[Z.d],M[0]=W.positionScreen,M[1]=V.positionScreen,M[2]=ga.positionScreen,M[3]=na.positionScreen,!0===W.visible||!0===V.visible||!0===ga.visible||!0===na.visible||P.isIntersectionBox(C.setFromPoints(M)))if(pa=0>(na.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(na.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x)||0>(V.positionScreen.x-ga.positionScreen.x)*(na.positionScreen.y-
ga.positionScreen.y)-(V.positionScreen.y-ga.positionScreen.y)*(na.positionScreen.x-ga.positionScreen.x),ha===THREE.DoubleSide||pa===(ha===THREE.FrontSide)){if(q===u){var rb=new THREE.RenderableFace4;y.push(rb);u++;q++;p=rb}else p=y[q++];p.v1.copy(W);p.v2.copy(V);p.v3.copy(ga);p.v4.copy(na)}else continue;else continue;p.normalModel.copy(Z.normal);!1===pa&&(ha===THREE.BackSide||ha===THREE.DoubleSide)&&p.normalModel.negate();p.normalModel.applyMatrix3(A).normalize();p.normalModelView.copy(p.normalModel).applyMatrix3(ca);
p.centroidModel.copy(Z.centroid).applyMatrix4(xa);ga=Z.vertexNormals;W=0;for(V=ga.length;W<V;W++)na=p.vertexNormalsModel[W],na.copy(ga[W]),!1===pa&&(ha===THREE.BackSide||ha===THREE.DoubleSide)&&na.negate(),na.applyMatrix3(A).normalize(),p.vertexNormalsModelView[W].copy(na).applyMatrix3(ca);p.vertexNormalsLength=ga.length;W=0;for(V=Pa.length;W<V;W++)if(na=Pa[W][la],void 0!==na){ha=0;for(ga=na.length;ha<ga;ha++)p.uvs[W][ha]=na[ha]}p.color=Z.color;p.material=Ra;ia.copy(p.centroidModel).applyProjection(ea);
p.z=ia.z;G.elements.push(p)}}}else if(ka instanceof THREE.Line){La.multiplyMatrices(ea,xa);la=ka.geometry.vertices;W=b();W.positionScreen.copy(la[0]).applyMatrix4(La);jb=ka.type===THREE.LinePieces?2:1;ta=1;for(Z=la.length;ta<Z;ta++)W=b(),W.positionScreen.copy(la[ta]).applyMatrix4(La),0<(ta+1)%jb||(V=m[j-2],N.copy(W.positionScreen),fa.copy(V.positionScreen),!0===d(N,fa)&&(N.multiplyScalar(1/N.w),fa.multiplyScalar(1/fa.w),t===J?(Pa=new THREE.RenderableLine,E.push(Pa),J++,t++,x=Pa):x=E[t++],x.v1.positionScreen.copy(N),
x.v2.positionScreen.copy(fa),x.z=Math.max(N.z,fa.z),x.material=ka.material,G.elements.push(x)))}g=0;for(l=G.sprites.length;g<l;g++)ka=G.sprites[g].object,xa=ka.matrixWorld,ka instanceof THREE.Particle&&(B.set(xa.elements[12],xa.elements[13],xa.elements[14],1),B.applyMatrix4(ea),B.z/=B.w,0<B.z&&1>B.z&&(z===K?(pa=new THREE.RenderableParticle,H.push(pa),K++,z++,F=pa):F=H[z++],F.object=ka,F.x=B.x/B.w,F.y=B.y/B.w,F.z=B.z,F.rotation=ka.rotation.z,F.scale.x=ka.scale.x*Math.abs(F.x-(B.x+h.projectionMatrix.elements[0])/
(B.w+h.projectionMatrix.elements[12])),F.scale.y=ka.scale.y*Math.abs(F.y-(B.y+h.projectionMatrix.elements[5])/(B.w+h.projectionMatrix.elements[13])),F.material=ka.material,G.elements.push(F)));!0===Ja&&G.elements.sort(c);return G}};THREE.Face3=function(a,b,c,d,e,f){this.a=a;this.b=b;this.c=c;this.normal=d instanceof THREE.Vector3?d:new THREE.Vector3;this.vertexNormals=d instanceof Array?d:[];this.color=e instanceof THREE.Color?e:new THREE.Color;this.vertexColors=e instanceof Array?e:[];this.vertexTangents=[];this.materialIndex=void 0!==f?f:0;this.centroid=new THREE.Vector3};
...
b,c,d;a=this.attributes.position.array.length;if(void 0===this.attributes.normal)this.attributes.normal={itemSize:3,array:new Float32Array(a),numItems:a};else{a=0;for(b=this.attributes.normal.array.length;a<b;a++)this.attributes.normal.array[a]=0}var e=this.attributes.position.array,f=this.attributes.normal.array,g,h,i,j,m,l,p=new THREE.Vector3,r=new THREE.Vector3,s=new THREE.Vector3,n=new THREE.Vector3,q=new THREE.Vector3;if(this.attributes.index){var y=this.attributes.index.array,u=this.offsets;
c=0;for(d=u.length;c<d;++c){b=u[c].start;g=u[c].count;var x=u[c].index;a=b;for(b+=g;a<b;a+=3)g=x+y[a],h=x+y[a+1],i=x+y[a+2],j=e[3*g],m=e[3*g+1],l=e[3*g+2],p.set(j,m,l),j=e[3*h],m=e[3*h+1],l=e[3*h+2],r.set(j,m,l),j=e[3*i],m=e[3*i+1],l=e[3*i+2],s.set(j,m,l),n.subVectors(s,r),q.subVectors(p,r),n.cross(q),f[3*g]+=n.x,f[3*g+1]+=n.y,f[3*g+2]+=n.z,f[3*h]+=n.x,f[3*h+1]+=n.y,f[3*h+2]+=n.z,f[3*i]+=n.x,f[3*i+1]+=n.y,f[3*i+2]+=n.z}}else{a=0;for(b=e.length;a<b;a+=9)j=e[a],m=e[a+1],l=e[a+2],p.set(j,m,l),j=e[a+
3],m=e[a+4],l=e[a+5],r.set(j,m,l),j=e[a+6],m=e[a+7],l=e[a+8],s.set(j,m,l),n.subVectors(s,r),q.subVectors(p,r),n.cross(q),f[a]=n.x,f[a+1]=n.y,f[a+2]=n.z,f[a+3]=n.x,f[a+4]=n.y,f[a+5]=n.z,f[a+6]=n.x,f[a+7]=n.y,f[a+8]=n.z}this.normalizeNormals();this.normalsNeedUpdate=!0}},normalizeNormals:function(){for(var a=this.attributes.normal.array,b,c,d,e=0,f=a.length;e<f;e+=3)b=a[e],c=a[e+1],d=a[e+2],b=1/Math.sqrt(b*b+c*c+d*d),a[e]*=b,a[e+1]*=b,a[e+2]*=b},computeTangents:function(){function a(a){xa.x=d[3*a];
xa.y=d[3*a+1];xa.z=d[3*a+2];La.copy(xa);ca=i[a];U.copy(ca);U.sub(xa.multiplyScalar(xa.dot(ca))).normalize();ea.crossVectors(La,ca);ia=ea.dot(j[a]);A=0>ia?-1:1;h[4*a]=U.x;h[4*a+1]=U.y;h[4*a+2]=U.z;h[4*a+3]=A}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===this.attributes.uv)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,
d=this.attributes.normal.array,e=this.attributes.uv.array,f=c.length/3;if(void 0===this.attributes.tangent){var g=4*f;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var m,l,p,r,s,n,q,y,u,x,t,E,J,F,z,f=new THREE.Vector3,g=new THREE.Vector3,H,K,G,L,B,P,C,I=this.offsets;G=0;for(L=I.length;G<L;++G){K=I[G].start;B=I[G].count;var M=I[G].index;H=K;for(K+=B;H<K;H+=3)B=M+b[H],
P=M+b[H+1],C=M+b[H+2],m=c[3*B],l=c[3*B+1],p=c[3*B+2],r=c[3*P],s=c[3*P+1],n=c[3*P+2],q=c[3*C],y=c[3*C+1],u=c[3*C+2],x=e[2*B],t=e[2*B+1],E=e[2*P],J=e[2*P+1],F=e[2*C],z=e[2*C+1],r-=m,m=q-m,s-=l,l=y-l,n-=p,p=u-p,E-=x,x=F-x,J-=t,t=z-t,z=1/(E*t-x*J),f.set((t*r-J*m)*z,(t*s-J*l)*z,(t*n-J*p)*z),g.set((E*m-x*r)*z,(E*l-x*s)*z,(E*p-x*n)*z),i[B].add(f),i[P].add(f),i[C].add(f),j[B].add(g),j[P].add(g),j[C].add(g)}var U=new THREE.Vector3,ea=new THREE.Vector3,xa=new THREE.Vector3,La=new THREE.Vector3,A,ca,ia;G=0;
for(L=I.length;G<L;++G){K=I[G].start;B=I[G].count;M=I[G].index;H=K;for(K+=B;H<K;H+=3)B=M+b[H],P=M+b[H+1],C=M+b[H+2],a(B),a(P),a(C)}this.tangentsNeedUpdate=this.hasTangents=!0}},dispose:function(){this.dispatchEvent({type:"dispose"})}};THREE.Camera=function(){THREE.Object3D.call(this);this.matrixWorldInverse=new THREE.Matrix4;this.projectionMatrix=new THREE.Matrix4;this.projectionMatrixInverse=new THREE.Matrix4};THREE.Camera.prototype=Object.create(THREE.Object3D.prototype);THREE.Camera.prototype.lookAt=function(){var a=new THREE.Matrix4;return function(b){a.lookAt(this.position,b,this.up);!0===this.useQuaternion?this.quaternion.setFromRotationMatrix(a):this.rotation.setEulerFromRotationMatrix(a,this.eulerOrder)}}();THREE.OrthographicCamera=function(a,b,c,d,e,f){THREE.Camera.call(this);this.left=a;this.right=b;this.top=c;this.bottom=d;this.near=void 0!==e?e:0.1;this.far=void 0!==f?f:2E3;this.updateProjectionMatrix()};THREE.OrthographicCamera.prototype=Object.create(THREE.Camera.prototype);THREE.OrthographicCamera.prototype.updateProjectionMatrix=function(){this.projectionMatrix.makeOrthographic(this.left,this.right,this.top,this.bottom,this.near,this.far)};THREE.PerspectiveCamera=function(a,b,c,d){THREE.Camera.call(this);this.fov=void 0!==a?a:50;this.aspect=void 0!==b?b:1;this.near=void 0!==c?c:0.1;this.far=void 0!==d?d:2E3;this.updateProjectionMatrix()};THREE.PerspectiveCamera.prototype=Object.create(THREE.Camera.prototype);THREE.PerspectiveCamera.prototype.setLens=function(a,b){void 0===b&&(b=24);this.fov=2*THREE.Math.radToDeg(Math.atan(b/(2*a)));this.updateProjectionMatrix()};
...
THREE.JSONLoader.prototype.parse=function(a,b){var c=new THREE.Geometry,d=void 0!==a.scale?1/a.scale:1,e,f,g,h,i,j,m,l,p,r,s,n,q,y,u,x=a.faces;r=a.vertices;var t=a.normals,E=a.colors,J=0;for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&J++;for(e=0;e<J;e++)c.faceUvs[e]=[],c.faceVertexUvs[e]=[];h=0;for(i=r.length;h<i;)j=new THREE.Vector3,j.x=r[h++]*d,j.y=r[h++]*d,j.z=r[h++]*d,c.vertices.push(j);h=0;for(i=x.length;h<i;){r=x[h++];j=r&1;g=r&2;e=r&4;f=r&8;l=r&16;m=r&32;s=r&64;r&=128;j?(n=new THREE.Face4,n.a=
...
f.x=t[l++],f.y=t[l++],f.z=t[l],n.vertexNormals.push(f);s&&(m=x[h++],m=new THREE.Color(E[m]),n.color=m);if(r)for(e=0;e<j;e++)m=x[h++],m=new THREE.Color(E[m]),n.vertexColors.push(m);c.faces.push(n)}if(a.skinWeights){h=0;for(i=a.skinWeights.length;h<i;h+=2)x=a.skinWeights[h],t=a.skinWeights[h+1],c.skinWeights.push(new THREE.Vector4(x,t,0,0))}if(a.skinIndices){h=0;for(i=a.skinIndices.length;h<i;h+=2)x=a.skinIndices[h],t=a.skinIndices[h+1],c.skinIndices.push(new THREE.Vector4(x,t,0,0))}c.bones=a.bones;
...
i?(f.quaternion.set(i[0],i[1],i[2],i[3]),f.useQuaternion=!0):f.rotation.set(h[0],h[1],h[2]);f.scale.set(p[0],p[1],p[2]);c&&f.traverse(function(a){a.material=c});var l=void 0!==d.visible?d.visible:!0;f.traverse(function(a){a.visible=l});b.add(f);f.name=a;z.objects[a]=f;e();t-=1;m.onLoadComplete();j()}}function i(a){return function(b,c){b.name=a;z.geometries[a]=b;z.face_materials[a]=c}}function j(){m.callbackProgress({totalModels:J,totalTextures:F,loadedModels:J-t,loadedTextures:F-E},z);m.onLoadProgress();
if(0===t&&0===E){for(var a=0;a<H.length;a++){var c=H[a],d=z.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,z.scene.add(c.object.target));c.object.target.userData.targetInverse=c.object}b(z)}}var m=this,l=THREE.Loader.prototype.extractUrlBase(c),p,r,s,n,q,y,u,x,t,E,J,F,z,H=[],K=a,G;for(G in this.geometryHandlerMap)a=this.geometryHandlerMap[G].loaderClass,this.geometryHandlerMap[G].loaderObject=new a;for(G in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[G].loaderClass,
this.hierarchyHandlerMap[G].loaderObject=new a;E=t=0;z={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{},groups:{}};if(K.transform&&(G=K.transform.position,a=K.transform.rotation,c=K.transform.scale,G&&z.scene.position.set(G[0],G[1],G[2]),a&&z.scene.rotation.set(a[0],a[1],a[2]),c&&z.scene.scale.set(c[0],c[1],c[2]),G||a||c))z.scene.updateMatrix(),z.scene.updateMatrixWorld();G=function(a){return function(){E-=a;j();m.onLoadComplete()}};
for(var L in K.fogs)a=K.fogs[L],"linear"===a.type?n=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(n=new THREE.FogExp2(0,a.density)),a=a.color,n.color.setRGB(a[0],a[1],a[2]),z.fogs[L]=n;for(var B in K.geometries)n=K.geometries[B],n.type in this.geometryHandlerMap&&(t+=1,m.onLoadStart());for(var P in K.objects)n=K.objects[P],n.type&&n.type in this.hierarchyHandlerMap&&(t+=1,m.onLoadStart());J=t;for(B in K.geometries)if(n=K.geometries[B],"cube"===n.type)p=new THREE.CubeGeometry(n.width,n.height,n.depth,
n.widthSegments,n.heightSegments,n.depthSegments),p.name=B,z.geometries[B]=p;else if("plane"===n.type)p=new THREE.PlaneGeometry(n.width,n.height,n.widthSegments,n.heightSegments),p.name=B,z.geometries[B]=p;else if("sphere"===n.type)p=new THREE.SphereGeometry(n.radius,n.widthSegments,n.heightSegments),p.name=B,z.geometries[B]=p;else if("cylinder"===n.type)p=new THREE.CylinderGeometry(n.topRad,n.botRad,n.height,n.radSegs,n.heightSegs),p.name=B,z.geometries[B]=p;else if("torus"===n.type)p=new THREE.TorusGeometry(n.radius,
n.tube,n.segmentsR,n.segmentsT),p.name=B,z.geometries[B]=p;else if("icosahedron"===n.type)p=new THREE.IcosahedronGeometry(n.radius,n.subdivisions),p.name=B,z.geometries[B]=p;else if(n.type in this.geometryHandlerMap){P={};for(q in n)"type"!==q&&"url"!==q&&(P[q]=n[q]);this.geometryHandlerMap[n.type].loaderObject.load(d(n.url,K.urlBaseType),g(B),P)}else"embedded"===n.type&&(P=K.embeds[n.id],P.metadata=K.metadata,P&&(P=this.geometryHandlerMap.ascii.loaderObject.parse(P,""),i(B)(P.geometry,P.materials)));
for(var C in K.textures)if(B=K.textures[C],B.url instanceof Array){E+=B.url.length;for(q=0;q<B.url.length;q++)m.onLoadStart()}else E+=1,m.onLoadStart();F=E;for(C in K.textures){B=K.textures[C];void 0!==B.mapping&&void 0!==THREE[B.mapping]&&(B.mapping=new THREE[B.mapping]);if(B.url instanceof Array){P=B.url.length;n=[];for(q=0;q<P;q++)n[q]=d(B.url[q],K.urlBaseType);q=(q=/\.dds$/i.test(n[0]))?THREE.ImageUtils.loadCompressedTextureCube(n,B.mapping,G(P)):THREE.ImageUtils.loadTextureCube(n,B.mapping,G(P))}else q=
/\.dds$/i.test(B.url),P=d(B.url,K.urlBaseType),n=G(1),q=q?THREE.ImageUtils.loadCompressedTexture(P,B.mapping,n):THREE.ImageUtils.loadTexture(P,B.mapping,n),void 0!==THREE[B.minFilter]&&(q.minFilter=THREE[B.minFilter]),void 0!==THREE[B.magFilter]&&(q.magFilter=THREE[B.magFilter]),B.anisotropy&&(q.anisotropy=B.anisotropy),B.repeat&&(q.repeat.set(B.repeat[0],B.repeat[1]),1!==B.repeat[0]&&(q.wrapS=THREE.RepeatWrapping),1!==B.repeat[1]&&(q.wrapT=THREE.RepeatWrapping)),B.offset&&q.offset.set(B.offset[0],
B.offset[1]),B.wrap&&(P={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==P[B.wrap[0]]&&(q.wrapS=P[B.wrap[0]]),void 0!==P[B.wrap[1]]&&(q.wrapT=P[B.wrap[1]]));z.textures[C]=q}var I,M;for(I in K.materials){C=K.materials[I];for(M in C.parameters)"envMap"===M||"map"===M||"lightMap"===M||"bumpMap"===M?C.parameters[M]=z.textures[C.parameters[M]]:"shading"===M?C.parameters[M]="flat"===C.parameters[M]?THREE.FlatShading:THREE.SmoothShading:"side"===M?C.parameters[M]="double"==C.parameters[M]?
THREE.DoubleSide:"back"==C.parameters[M]?THREE.BackSide:THREE.FrontSide:"blending"===M?C.parameters[M]=C.parameters[M]in THREE?THREE[C.parameters[M]]:THREE.NormalBlending:"combine"===M?C.parameters[M]=C.parameters[M]in THREE?THREE[C.parameters[M]]:THREE.MultiplyOperation:"vertexColors"===M?"face"==C.parameters[M]?C.parameters[M]=THREE.FaceColors:C.parameters[M]&&(C.parameters[M]=THREE.VertexColors):"wrapRGB"===M&&(G=C.parameters[M],C.parameters[M]=new THREE.Vector3(G[0],G[1],G[2]));void 0!==C.parameters.opacity&&
1>C.parameters.opacity&&(C.parameters.transparent=!0);C.parameters.normalMap?(G=THREE.ShaderLib.normalmap,B=THREE.UniformsUtils.clone(G.uniforms),q=C.parameters.color,P=C.parameters.specular,n=C.parameters.ambient,L=C.parameters.shininess,B.tNormal.value=z.textures[C.parameters.normalMap],C.parameters.normalScale&&B.uNormalScale.value.set(C.parameters.normalScale[0],C.parameters.normalScale[1]),C.parameters.map&&(B.tDiffuse.value=C.parameters.map,B.enableDiffuse.value=!0),C.parameters.envMap&&(B.tCube.value=
C.parameters.envMap,B.enableReflection.value=!0,B.uReflectivity.value=C.parameters.reflectivity),C.parameters.lightMap&&(B.tAO.value=C.parameters.lightMap,B.enableAO.value=!0),C.parameters.specularMap&&(B.tSpecular.value=z.textures[C.parameters.specularMap],B.enableSpecular.value=!0),C.parameters.displacementMap&&(B.tDisplacement.value=z.textures[C.parameters.displacementMap],B.enableDisplacement.value=!0,B.uDisplacementBias.value=C.parameters.displacementBias,B.uDisplacementScale.value=C.parameters.displacementScale),
B.uDiffuseColor.value.setHex(q),B.uSpecularColor.value.setHex(P),B.uAmbientColor.value.setHex(n),B.uShininess.value=L,C.parameters.opacity&&(B.uOpacity.value=C.parameters.opacity),r=new THREE.ShaderMaterial({fragmentShader:G.fragmentShader,vertexShader:G.vertexShader,uniforms:B,lights:!0,fog:!0})):r=new THREE[C.type](C.parameters);r.name=I;z.materials[I]=r}for(I in K.materials)if(C=K.materials[I],C.parameters.materials){M=[];for(q=0;q<C.parameters.materials.length;q++)M.push(z.materials[C.parameters.materials[q]]);
z.materials[I].materials=M}e();z.cameras&&K.defaults.camera&&(z.currentCamera=z.cameras[K.defaults.camera]);z.fogs&&K.defaults.fog&&(z.scene.fog=z.fogs[K.defaults.fog]);m.callbackSync(z);j()};THREE.TextureLoader=function(){this.crossOrigin=null};
...
THREE.Color&&c instanceof THREE.Color?d.copy(c):d instanceof THREE.Color?d.set(c):d instanceof THREE.Vector3&&c instanceof THREE.Vector3?d.copy(c):this[b]=c}}},clone:function(a){void 0===a&&(a=new THREE.Material);a.name=this.name;a.side=this.side;a.opacity=this.opacity;a.transparent=this.transparent;a.blending=this.blending;a.blendSrc=this.blendSrc;a.blendDst=this.blendDst;a.blendEquation=this.blendEquation;a.depthTest=this.depthTest;a.depthWrite=this.depthWrite;a.polygonOffset=this.polygonOffset;
...
b){if(P!==a||C!==b)t.setLineDash([a,b]),P=a,C=b}console.log("THREE.CanvasRenderer",THREE.REVISION);var j=THREE.Math.smoothstep,a=a||{},m=this,l,p,r,s=new THREE.Projector,n=void 0!==a.canvas?a.canvas:document.createElement("canvas"),q,y,u,x,t=n.getContext("2d"),E=new THREE.Color(0),J=0,F=1,z=0,H=null,K=null,G=null,L=null,B=null,P=null,C=0,I,M,U,ea,xa=new THREE.RenderableVertex,La=new THREE.RenderableVertex,A,ca,ia,oa,N,fa,ib,Ya,db,Ja,pa,ta,Z=new THREE.Color,la=new THREE.Color,W=new THREE.Color,V=new THREE.Color,
ha=new THREE.Color,ga=new THREE.Color,ka=new THREE.Color,Pa=new THREE.Color,jb={},na={},Ua,Qa,Aa,Ra,rb,Ob,Lb,Pb,Tb,Ub,Za=new THREE.Box2,va=new THREE.Box2,Va=new THREE.Box2,sb=new THREE.Color,Ma=new THREE.Color,qa=new THREE.Color,$a=new THREE.Vector3,Bb,k,Cb,Sa,kb,Ta,Db=16;Bb=document.createElement("canvas");Bb.width=Bb.height=2;k=Bb.getContext("2d");k.fillStyle="rgba(0,0,0,1)";k.fillRect(0,0,2,2);Cb=k.getImageData(0,0,2,2);Sa=Cb.data;kb=document.createElement("canvas");kb.width=kb.height=Db;Ta=kb.getContext("2d");
Ta.translate(-Db/2,-Db/2);Ta.scale(Db,Db);Db--;void 0===t.setLineDash&&(t.setLineDash=void 0!==t.mozDash?function(a){t.mozDash=null!==a[0]?a:null}:function(){});this.domElement=n;this.devicePixelRatio=void 0!==a.devicePixelRatio?a.devicePixelRatio:void 0!==window.devicePixelRatio?window.devicePixelRatio:1;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.supportsVertexTextures=function(){};this.setFaceCulling=function(){};this.setSize=function(a,b){q=
a*this.devicePixelRatio;y=b*this.devicePixelRatio;u=Math.floor(q/2);x=Math.floor(y/2);n.width=q;n.height=y;n.style.width=a+"px";n.style.height=b+"px";Za.set(new THREE.Vector2(-u,-x),new THREE.Vector2(u,x));va.set(new THREE.Vector2(-u,-x),new THREE.Vector2(u,x));F=1;z=0;B=L=G=K=H=null};this.setClearColor=function(a,b){E.set(a);J=void 0!==b?b:1;va.set(new THREE.Vector2(-u,-x),new THREE.Vector2(u,x))};this.setClearColorHex=function(a,b){console.warn("DEPRECATED: .setClearColorHex() is being removed. Use .setClearColor() instead.");
this.setClearColor(a,b)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){t.setTransform(1,0,0,-1,u,x);!1===va.empty()&&(va.intersect(Za),va.expandByScalar(2),1>J&&t.clearRect(va.min.x|0,va.min.y|0,va.max.x-va.min.x|0,va.max.y-va.min.y|0),0<J&&(c(THREE.NormalBlending),b(1),h("rgba("+Math.floor(255*E.r)+","+Math.floor(255*E.g)+","+Math.floor(255*E.b)+","+J+")"),t.fillRect(va.min.x|0,va.min.y|0,va.max.x-va.min.x|0,va.max.y-va.min.y|0)),va.makeEmpty())};this.render=function(a,n){function q(a,
b,c){for(var d=0,e=r.length;d<e;d++){var f=r[d];Pa.copy(f.color);if(f instanceof THREE.DirectionalLight){var g=$a.getPositionFromMatrix(f.matrixWorld).normalize(),h=b.dot(g);0>=h||(h*=f.intensity,c.add(Pa.multiplyScalar(h)))}else f instanceof THREE.PointLight&&(g=$a.getPositionFromMatrix(f.matrixWorld),h=b.dot($a.subVectors(g,a).normalize()),0>=h||(h*=0==f.distance?1:1-Math.min(a.distanceTo(g)/f.distance,1),0!=h&&(h*=f.intensity,c.add(Pa.multiplyScalar(h)))))}}function z(a,d,e,f,g,h,k,i){m.info.render.vertices+=
3;m.info.render.faces++;b(i.opacity);c(i.blending);A=a.positionScreen.x;ca=a.positionScreen.y;ia=d.positionScreen.x;oa=d.positionScreen.y;N=e.positionScreen.x;fa=e.positionScreen.y;y(A,ca,ia,oa,N,fa);(i instanceof THREE.MeshLambertMaterial||i instanceof THREE.MeshPhongMaterial)&&null===i.map?(ga.copy(i.color),ka.copy(i.emissive),i.vertexColors===THREE.FaceColors&&ga.multiply(k.color),!1===i.wireframe&&i.shading==THREE.SmoothShading&&3==k.vertexNormalsLength?(la.copy(sb),W.copy(sb),V.copy(sb),q(k.v1.positionWorld,
k.vertexNormalsModel[0],la),q(k.v2.positionWorld,k.vertexNormalsModel[1],W),q(k.v3.positionWorld,k.vertexNormalsModel[2],V),la.multiply(ga).add(ka),W.multiply(ga).add(ka),V.multiply(ga).add(ka),ha.addColors(W,V).multiplyScalar(0.5),Aa=H(la,W,V,ha),J(A,ca,ia,oa,N,fa,0,0,1,0,0,1,Aa)):(Z.copy(sb),q(k.centroidModel,k.normalModel,Z),Z.multiply(ga).add(ka),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z))):i instanceof THREE.MeshBasicMaterial||i instanceof THREE.MeshLambertMaterial||
i instanceof THREE.MeshPhongMaterial?null!==i.map?i.map.mapping instanceof THREE.UVMapping&&(Ra=k.uvs[0],C(A,ca,ia,oa,N,fa,Ra[f].x,Ra[f].y,Ra[g].x,Ra[g].y,Ra[h].x,Ra[h].y,i.map)):null!==i.envMap?i.envMap.mapping instanceof THREE.SphericalReflectionMapping&&($a.copy(k.vertexNormalsModelView[f]),rb=0.5*$a.x+0.5,Ob=0.5*$a.y+0.5,$a.copy(k.vertexNormalsModelView[g]),Lb=0.5*$a.x+0.5,Pb=0.5*$a.y+0.5,$a.copy(k.vertexNormalsModelView[h]),Tb=0.5*$a.x+0.5,Ub=0.5*$a.y+0.5,C(A,ca,ia,oa,N,fa,rb,Ob,Lb,Pb,Tb,Ub,
i.envMap)):(Z.copy(i.color),i.vertexColors===THREE.FaceColors&&Z.multiply(k.color),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z)):i instanceof THREE.MeshDepthMaterial?(Ua=n.near,Qa=n.far,la.r=la.g=la.b=1-j(a.positionScreen.z*a.positionScreen.w,Ua,Qa),W.r=W.g=W.b=1-j(d.positionScreen.z*d.positionScreen.w,Ua,Qa),V.r=V.g=V.b=1-j(e.positionScreen.z*e.positionScreen.w,Ua,Qa),ha.addColors(W,V).multiplyScalar(0.5),Aa=H(la,W,V,ha),J(A,ca,ia,oa,N,fa,0,0,1,0,0,1,Aa)):
i instanceof THREE.MeshNormalMaterial&&(i.shading==THREE.FlatShading?(a=k.normalModelView,Z.setRGB(a.x,a.y,a.z).multiplyScalar(0.5).addScalar(0.5),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z)):i.shading==THREE.SmoothShading&&(a=k.vertexNormalsModelView[f],la.setRGB(a.x,a.y,a.z).multiplyScalar(0.5).addScalar(0.5),a=k.vertexNormalsModelView[g],W.setRGB(a.x,a.y,a.z).multiplyScalar(0.5).addScalar(0.5),a=k.vertexNormalsModelView[h],V.setRGB(a.x,a.y,a.z).multiplyScalar(0.5).addScalar(0.5),
ha.addColors(W,V).multiplyScalar(0.5),Aa=H(la,W,V,ha),J(A,ca,ia,oa,N,fa,0,0,1,0,0,1,Aa)))}function y(a,b,c,d,e,f){t.beginPath();t.moveTo(a,b);t.lineTo(c,d);t.lineTo(e,f);t.closePath()}function B(a,b,c,d,e,f,g,h){t.beginPath();t.moveTo(a,b);t.lineTo(c,d);t.lineTo(e,f);t.lineTo(g,h);t.closePath()}function E(a,b,c,h){d(b);e(c);f(h);g(a.getStyle());t.stroke();Va.expandByScalar(2*b)}function F(a){h(a.getStyle());t.fill()}function C(a,b,c,d,e,f,g,k,i,ua,j,p,m){if(!(m instanceof THREE.DataTexture||void 0===
m.image||0==m.image.width)){if(!0===m.needsUpdate){var l=m.wrapS==THREE.RepeatWrapping,n=m.wrapT==THREE.RepeatWrapping;jb[m.id]=t.createPattern(m.image,!0===l&&!0===n?"repeat":!0===l&&!1===n?"repeat-x":!1===l&&!0===n?"repeat-y":"no-repeat");m.needsUpdate=!1}void 0===jb[m.id]?h("rgba(0,0,0,1)"):h(jb[m.id]);var l=m.offset.x/m.repeat.x,n=m.offset.y/m.repeat.y,mb=m.image.width*m.repeat.x,q=m.image.height*m.repeat.y,g=(g+l)*mb,k=(1-k+n)*q,c=c-a,d=d-b,e=e-a,f=f-b,i=(i+l)*mb-g,ua=(1-ua+n)*q-k,j=(j+l)*mb-
g,p=(1-p+n)*q-k,l=i*p-j*ua;0===l?(void 0===na[m.id]&&(b=document.createElement("canvas"),b.width=m.image.width,b.height=m.image.height,b=b.getContext("2d"),b.drawImage(m.image,0,0),na[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data),b=na[m.id],g=4*(Math.floor(g)+Math.floor(k)*m.image.width),Z.setRGB(b[g]/255,b[g+1]/255,b[g+2]/255),F(Z)):(l=1/l,m=(p*c-ua*e)*l,ua=(p*d-ua*f)*l,c=(i*e-j*c)*l,d=(i*f-j*d)*l,a=a-m*g-c*k,g=b-ua*g-d*k,t.save(),t.transform(m,ua,c,d,a,g),t.fill(),t.restore())}}function J(a,
b,c,d,e,f,g,h,k,i,ua,j,m){var p,l;p=m.width-1;l=m.height-1;g*=p;h*=l;c-=a;d-=b;e-=a;f-=b;k=k*p-g;i=i*l-h;ua=ua*p-g;j=j*l-h;l=1/(k*j-ua*i);p=(j*c-i*e)*l;i=(j*d-i*f)*l;c=(k*e-ua*c)*l;d=(k*f-ua*d)*l;a=a-p*g-c*h;b=b-i*g-d*h;t.save();t.transform(p,i,c,d,a,b);t.clip();t.drawImage(m,0,0);t.restore()}function H(a,b,c,d){Sa[0]=255*a.r|0;Sa[1]=255*a.g|0;Sa[2]=255*a.b|0;Sa[4]=255*b.r|0;Sa[5]=255*b.g|0;Sa[6]=255*b.b|0;Sa[8]=255*c.r|0;Sa[9]=255*c.g|0;Sa[10]=255*c.b|0;Sa[12]=255*d.r|0;Sa[13]=255*d.g|0;Sa[14]=255*
d.b|0;k.putImageData(Cb,0,0);Ta.drawImage(Bb,0,0);return kb}function G(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===n instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{!0===this.autoClear&&this.clear();t.setTransform(1,0,0,-1,u,x);m.info.render.vertices=0;m.info.render.faces=0;l=s.projectScene(a,n,this.sortObjects,this.sortElements);p=l.elements;r=l.lights;sb.setRGB(0,
0,0);Ma.setRGB(0,0,0);qa.setRGB(0,0,0);for(var K=0,P=r.length;K<P;K++){var R=r[K],L=R.color;R instanceof THREE.AmbientLight?sb.add(L):R instanceof THREE.DirectionalLight?Ma.add(L):R instanceof THREE.PointLight&&qa.add(L)}K=0;for(P=p.length;K<P;K++){var da=p[K],R=da.material;if(!(void 0===R||!1===R.visible)){Va.makeEmpty();if(da instanceof THREE.RenderableParticle){I=da;I.x*=u;I.y*=x;var L=I,ua=da;b(R.opacity);c(R.blending);var ub=void 0,mb=void 0,vb=void 0,wb=void 0,Nc=da=void 0,Oc=void 0;R instanceof
THREE.ParticleBasicMaterial?null===R.map?(vb=ua.object.scale.x,wb=ua.object.scale.y,vb*=ua.scale.x*u,wb*=ua.scale.y*x,Va.min.set(L.x-vb,L.y-wb),Va.max.set(L.x+vb,L.y+wb),!1!==Za.isIntersectionBox(Va)&&(h(R.color.getStyle()),t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(vb,wb),t.fillRect(-1,-1,2,2),t.restore())):(da=R.map.image,Nc=da.width>>1,Oc=da.height>>1,vb=ua.scale.x*u,wb=ua.scale.y*x,ub=vb*Nc,mb=wb*Oc,Va.min.set(L.x-ub,L.y-mb),Va.max.set(L.x+ub,L.y+mb),!1!==Za.isIntersectionBox(Va)&&
(t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(vb,-wb),t.translate(-Nc,-Oc),t.drawImage(da,0,0),t.restore())):R instanceof THREE.ParticleCanvasMaterial&&(ub=ua.scale.x*u,mb=ua.scale.y*x,Va.min.set(L.x-ub,L.y-mb),Va.max.set(L.x+ub,L.y+mb),!1!==Za.isIntersectionBox(Va)&&(g(R.color.getStyle()),h(R.color.getStyle()),t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(ub,mb),R.program(t),t.restore()))}else if(da instanceof THREE.RenderableLine)I=da.v1,M=da.v2,I.positionScreen.x*=
u,I.positionScreen.y*=x,M.positionScreen.x*=u,M.positionScreen.y*=x,Va.setFromPoints([I.positionScreen,M.positionScreen]),!0===Za.isIntersectionBox(Va)&&(L=I,ua=M,b(R.opacity),c(R.blending),t.beginPath(),t.moveTo(L.positionScreen.x,L.positionScreen.y),t.lineTo(ua.positionScreen.x,ua.positionScreen.y),R instanceof THREE.LineBasicMaterial?(d(R.linewidth),e(R.linecap),f(R.linejoin),g(R.color.getStyle()),t.stroke(),Va.expandByScalar(2*R.linewidth)):R instanceof THREE.LineDashedMaterial&&(d(R.linewidth),
e(R.linecap),f(R.linejoin),g(R.color.getStyle()),i(R.dashSize,R.gapSize),t.stroke(),Va.expandByScalar(2*R.linewidth),i(null,null)));else if(da instanceof THREE.RenderableFace3){I=da.v1;M=da.v2;U=da.v3;if(-1>I.positionScreen.z||1<I.positionScreen.z)continue;if(-1>M.positionScreen.z||1<M.positionScreen.z)continue;if(-1>U.positionScreen.z||1<U.positionScreen.z)continue;I.positionScreen.x*=u;I.positionScreen.y*=x;M.positionScreen.x*=u;M.positionScreen.y*=x;U.positionScreen.x*=u;U.positionScreen.y*=x;
!0===R.overdraw&&(G(I.positionScreen,M.positionScreen),G(M.positionScreen,U.positionScreen),G(U.positionScreen,I.positionScreen));Va.setFromPoints([I.positionScreen,M.positionScreen,U.positionScreen]);z(I,M,U,0,1,2,da,R)}else if(da instanceof THREE.RenderableFace4){I=da.v1;M=da.v2;U=da.v3;ea=da.v4;if(-1>I.positionScreen.z||1<I.positionScreen.z)continue;if(-1>M.positionScreen.z||1<M.positionScreen.z)continue;if(-1>U.positionScreen.z||1<U.positionScreen.z)continue;if(-1>ea.positionScreen.z||1<ea.positionScreen.z)continue;
I.positionScreen.x*=u;I.positionScreen.y*=x;M.positionScreen.x*=u;M.positionScreen.y*=x;U.positionScreen.x*=u;U.positionScreen.y*=x;ea.positionScreen.x*=u;ea.positionScreen.y*=x;xa.positionScreen.copy(M.positionScreen);La.positionScreen.copy(ea.positionScreen);!0===R.overdraw&&(G(I.positionScreen,M.positionScreen),G(M.positionScreen,ea.positionScreen),G(ea.positionScreen,I.positionScreen),G(U.positionScreen,xa.positionScreen),G(U.positionScreen,La.positionScreen));Va.setFromPoints([I.positionScreen,
M.positionScreen,U.positionScreen,ea.positionScreen]);L=I;ua=M;ub=U;mb=ea;vb=xa;wb=La;m.info.render.vertices+=4;m.info.render.faces++;b(R.opacity);c(R.blending);void 0!==R.map&&null!==R.map||void 0!==R.envMap&&null!==R.envMap?(z(L,ua,mb,0,1,3,da,R),z(vb,ub,wb,1,2,3,da,R)):(A=L.positionScreen.x,ca=L.positionScreen.y,ia=ua.positionScreen.x,oa=ua.positionScreen.y,N=ub.positionScreen.x,fa=ub.positionScreen.y,ib=mb.positionScreen.x,Ya=mb.positionScreen.y,db=vb.positionScreen.x,Ja=vb.positionScreen.y,pa=
wb.positionScreen.x,ta=wb.positionScreen.y,R instanceof THREE.MeshLambertMaterial||R instanceof THREE.MeshPhongMaterial?(ga.copy(R.color),ka.copy(R.emissive),R.vertexColors===THREE.FaceColors&&ga.multiply(da.color),!1===R.wireframe&&R.shading==THREE.SmoothShading&&4==da.vertexNormalsLength?(la.copy(sb),W.copy(sb),V.copy(sb),ha.copy(sb),q(da.v1.positionWorld,da.vertexNormalsModel[0],la),q(da.v2.positionWorld,da.vertexNormalsModel[1],W),q(da.v4.positionWorld,da.vertexNormalsModel[3],V),q(da.v3.positionWorld,
da.vertexNormalsModel[2],ha),la.multiply(ga).add(ka),W.multiply(ga).add(ka),V.multiply(ga).add(ka),ha.multiply(ga).add(ka),Aa=H(la,W,V,ha),y(A,ca,ia,oa,ib,Ya),J(A,ca,ia,oa,ib,Ya,0,0,1,0,0,1,Aa),y(db,Ja,N,fa,pa,ta),J(db,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa)):(Z.copy(sb),q(da.centroidModel,da.normalModel,Z),Z.multiply(ga).add(ka),B(A,ca,ia,oa,N,fa,ib,Ya),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z))):R instanceof THREE.MeshBasicMaterial?(Z.copy(R.color),R.vertexColors===
THREE.FaceColors&&Z.multiply(da.color),B(A,ca,ia,oa,N,fa,ib,Ya),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R instanceof THREE.MeshNormalMaterial?(L=void 0,R.shading==THREE.FlatShading?(L=da.normalModelView,Z.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),B(A,ca,ia,oa,N,fa,ib,Ya),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R.shading==THREE.SmoothShading&&(L=da.vertexNormalsModelView[0],la.setRGB(L.x,L.y,
L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[1],W.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[3],V.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[2],ha.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),Aa=H(la,W,V,ha),y(A,ca,ia,oa,ib,Ya),J(A,ca,ia,oa,ib,Ya,0,0,1,0,0,1,Aa),y(db,Ja,N,fa,pa,ta),J(db,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa))):R instanceof THREE.MeshDepthMaterial&&(Ua=n.near,Qa=n.far,la.r=la.g=
la.b=1-j(L.positionScreen.z*L.positionScreen.w,Ua,Qa),W.r=W.g=W.b=1-j(ua.positionScreen.z*ua.positionScreen.w,Ua,Qa),V.r=V.g=V.b=1-j(mb.positionScreen.z*mb.positionScreen.w,Ua,Qa),ha.r=ha.g=ha.b=1-j(ub.positionScreen.z*ub.positionScreen.w,Ua,Qa),Aa=H(la,W,V,ha),y(A,ca,ia,oa,ib,Ya),J(A,ca,ia,oa,ib,Ya,0,0,1,0,0,1,Aa),y(db,Ja,N,fa,pa,ta),J(db,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa)))}va.union(Va)}}t.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
THREE.SmoothShading?THREE.SmoothShading:THREE.FlatShading}function g(a){return a.map||a.lightMap||a.bumpMap||a.normalMap||a.specularMap||a instanceof THREE.ShaderMaterial?!0:!1}function h(a){Za[a]||(k.enableVertexAttribArray(a),Za[a]=!0)}function i(){for(var a in Za)Za[a]&&(k.disableVertexAttribArray(a),Za[a]=!1)}function j(a,b){return a.z!==b.z?b.z-a.z:a.id-b.id}function m(a,b){return b[0]-a[0]}function l(a,b,c){if(a.length)for(var d=0,e=a.length;d<e;d++)ta=Ya=null,Ja=pa=V=W=na=jb=ha=-1,$a=!0,a[d].render(b,
c,Tb,Ub),ta=Ya=null,Ja=pa=V=W=na=jb=ha=-1,$a=!0}function p(a,b,c,d,e,f,g,h){var i,k,j,m;b?(k=a.length-1,m=b=-1):(k=0,b=a.length,m=1);for(var p=k;p!==b;p+=m)if(i=a[p],i.render){k=i.object;j=i.buffer;if(h)i=h;else{i=i[c];if(!i)continue;g&&N.setBlending(i.blending,i.blendEquation,i.blendSrc,i.blendDst);N.setDepthTest(i.depthTest);N.setDepthWrite(i.depthWrite);K(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits)}N.setMaterialFaces(i);j instanceof THREE.BufferGeometry?N.renderBufferDirect(d,e,
...
(i.geometryGroups[r]={faces3:[],faces4:[],materialIndex:l,vertices:0,numMorphTargets:s,numMorphNormals:t})),p instanceof THREE.Face3?i.geometryGroups[r].faces3.push(g):i.geometryGroups[r].faces4.push(g),i.geometryGroups[r].vertices+=q;i.geometryGroupsList=[];for(h in i.geometryGroups)i.geometryGroups[h].id=Z++,i.geometryGroupsList.push(i.geometryGroups[h])}for(e in f.geometryGroups)if(h=f.geometryGroups[e],!h.__webglVertexBuffer){i=h;i.__webglVertexBuffer=k.createBuffer();i.__webglNormalBuffer=k.createBuffer();
...
a):a instanceof THREE.Sprite?t(b.__webglSprites,a):a instanceof THREE.LensFlare?t(b.__webglFlares,a):(a instanceof THREE.ImmediateRenderObject||a.immediateRenderCallback)&&x(b.__webglObjectsImmediate,a);delete a.__webglActive}function x(a,b){for(var c=a.length-1;0<=c;c--)a[c].object===b&&a.splice(c,1)}function t(a,b){for(var c=a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function E(a,b,c,d,e){la=0;d.needsUpdate&&(d.program&&da(d),N.initMaterial(d,b,c,e),d.needsUpdate=!1);d.morphTargets&&!e.__webglMorphTargetInfluences&&
(e.__webglMorphTargetInfluences=new Float32Array(N.maxMorphTargets));var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==Ya&&(k.useProgram(g),Ya=g,f=!0);d.id!==Ja&&(Ja=d.id,f=!0);if(f||a!==ta)k.uniformMatrix4fv(h.projectionMatrix,!1,a.projectionMatrix.elements),a!==ta&&(ta=a);if(d.skinning)if(Vb&&e.useVertexTexture){if(null!==h.boneTexture){var j=J();k.uniform1i(h.boneTexture,j);N.setTexture(e.boneTexture,j)}}else null!==h.boneGlobalMatrices&&k.uniformMatrix4fv(h.boneGlobalMatrices,!1,e.boneMatrices);
if(f){c&&d.fog&&(i.fogColor.value=c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if($a){for(var m,l=j=0,p=0,n,q,r,s=Bb,t=s.directional.colors,u=s.directional.positions,x=s.point.colors,y=s.point.positions,E=s.point.distances,C=s.spot.colors,G=s.spot.positions,H=s.spot.distances,D=s.spot.directions,L=s.spot.anglesCos,K=
s.spot.exponents,O=s.hemi.skyColors,A=s.hemi.groundColors,R=s.hemi.positions,U=0,P=0,fa=0,W=0,Z=0,S=0,T=0,Q=0,aa=m=0,c=r=aa=0,f=b.length;c<f;c++)m=b[c],m.onlyShadow||(n=m.color,q=m.intensity,r=m.distance,m instanceof THREE.AmbientLight?m.visible&&(N.gammaInput?(j+=n.r*n.r,l+=n.g*n.g,p+=n.b*n.b):(j+=n.r,l+=n.g,p+=n.b)):m instanceof THREE.DirectionalLight?(Z+=1,m.visible&&(qa.getPositionFromMatrix(m.matrixWorld),Ma.getPositionFromMatrix(m.target.matrixWorld),qa.sub(Ma),qa.normalize(),0===qa.x&&0===
qa.y&&0===qa.z||(m=3*U,u[m]=qa.x,u[m+1]=qa.y,u[m+2]=qa.z,N.gammaInput?F(t,m,n,q*q):z(t,m,n,q),U+=1))):m instanceof THREE.PointLight?(S+=1,m.visible&&(aa=3*P,N.gammaInput?F(x,aa,n,q*q):z(x,aa,n,q),Ma.getPositionFromMatrix(m.matrixWorld),y[aa]=Ma.x,y[aa+1]=Ma.y,y[aa+2]=Ma.z,E[P]=r,P+=1)):m instanceof THREE.SpotLight?(T+=1,m.visible&&(aa=3*fa,N.gammaInput?F(C,aa,n,q*q):z(C,aa,n,q),Ma.getPositionFromMatrix(m.matrixWorld),G[aa]=Ma.x,G[aa+1]=Ma.y,G[aa+2]=Ma.z,H[fa]=r,qa.copy(Ma),Ma.getPositionFromMatrix(m.target.matrixWorld),
qa.sub(Ma),qa.normalize(),D[aa]=qa.x,D[aa+1]=qa.y,D[aa+2]=qa.z,L[fa]=Math.cos(m.angle),K[fa]=m.exponent,fa+=1)):m instanceof THREE.HemisphereLight&&(Q+=1,m.visible&&(qa.getPositionFromMatrix(m.matrixWorld),qa.normalize(),0===qa.x&&0===qa.y&&0===qa.z||(r=3*W,R[r]=qa.x,R[r+1]=qa.y,R[r+2]=qa.z,n=m.color,m=m.groundColor,N.gammaInput?(q*=q,F(O,r,n,q),F(A,r,m,q)):(z(O,r,n,q),z(A,r,m,q)),W+=1))));c=3*U;for(f=Math.max(t.length,3*Z);c<f;c++)t[c]=0;c=3*P;for(f=Math.max(x.length,3*S);c<f;c++)x[c]=0;c=3*fa;for(f=
Math.max(C.length,3*T);c<f;c++)C[c]=0;c=3*W;for(f=Math.max(O.length,3*Q);c<f;c++)O[c]=0;c=3*W;for(f=Math.max(A.length,3*Q);c<f;c++)A[c]=0;s.directional.length=U;s.point.length=P;s.spot.length=fa;s.hemi.length=W;s.ambient[0]=j;s.ambient[1]=l;s.ambient[2]=p;$a=!1}c=Bb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=
...
j.flattenToArray(c._array),k.uniformMatrix4fv(f,!1,c._array);else if("m4v"===l){void 0===c._array&&(c._array=new Float32Array(16*j.length));l=0;for(p=j.length;l<p;l++)j[l].flattenToArrayOffset(c._array,16*l);k.uniformMatrix4fv(f,!1,c._array)}else if("t"===l){if(s=j,j=J(),k.uniform1i(f,j),s)if(s.image instanceof Array&&6===s.image.length){if(c=s,f=j,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=k.createTexture(),N.info.memory.textures++);k.activeTexture(k.TEXTURE0+
f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)N.autoScaleCubemaps&&!f?(p=j,s=l,t=c.image[l],x=Hc,t.width<=x&&t.height<=x||(y=Math.max(t.width,t.height),u=Math.floor(t.width*x/y),x=Math.floor(t.height*x/y),y=document.createElement("canvas"),y.width=u,y.height=x,y.getContext("2d").drawImage(t,0,0,t.width,t.height,0,0,u,x),t=y),p[s]=t):j[l]=c.image[l];l=j[0];p=0===(l.width&l.width-
1)&&0===(l.height&l.height-1);s=I(c.format);t=I(c.type);B(k.TEXTURE_CUBE_MAP,c,p);for(l=0;6>l;l++)if(f){x=j[l].mipmaps;y=0;for(E=x.length;y<E;y++)u=x[y],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,y,s,u.width,u.height,0,u.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,s,s,t,j[l]);c.generateMipmaps&&p&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else s instanceof
THREE.WebGLRenderTargetCube?(c=s,k.activeTexture(k.TEXTURE0+j),k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)):N.setTexture(s,j)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(p=c.value.length;l<p;l++)c._array[l]=J();k.uniform1iv(f,c._array);l=0;for(p=c.value.length;l<p;l++)s=c.value[l],j=c._array[l],s&&N.setTexture(s,j)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==h.cameraPosition)Ma.getPositionFromMatrix(a.matrixWorld),k.uniform3f(h.cameraPosition,
Ma.x,Ma.y,Ma.z);(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&null!==h.viewMatrix&&k.uniformMatrix4fv(h.viewMatrix,!1,a.matrixWorldInverse.elements)}k.uniformMatrix4fv(h.modelViewMatrix,!1,e._modelViewMatrix.elements);h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,!1,e._normalMatrix.elements);null!==h.modelMatrix&&k.uniformMatrix4fv(h.modelMatrix,!1,e.matrixWorld.elements);return g}function J(){var a=la;a>=cc&&console.warn("WebGLRenderer: trying to use "+
a+" texture units while this GPU supports only "+cc);la+=1;return a}function F(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function z(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function H(a){a!==Ra&&(k.lineWidth(a),Ra=a)}function K(a,b,c){Ua!==a&&(a?k.enable(k.POLYGON_OFFSET_FILL):k.disable(k.POLYGON_OFFSET_FILL),Ua=a);if(a&&(Qa!==b||Aa!==c))k.polygonOffset(b,c),Qa=b,Aa=c}function G(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function L(a,
...
k.TEXTURE_WRAP_S,k.CLAMP_TO_EDGE),k.texParameteri(a,k.TEXTURE_WRAP_T,k.CLAMP_TO_EDGE),k.texParameteri(a,k.TEXTURE_MAG_FILTER,C(b.magFilter)),k.texParameteri(a,k.TEXTURE_MIN_FILTER,C(b.minFilter)));if(kb&&b.type!==THREE.FloatType&&(1<b.anisotropy||b.__oldAnisotropy))k.texParameterf(a,kb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,dc)),b.__oldAnisotropy=b.anisotropy}function P(a,b){k.bindRenderbuffer(k.RENDERBUFFER,a);b.depthBuffer&&!b.stencilBuffer?(k.renderbufferStorage(k.RENDERBUFFER,k.DEPTH_COMPONENT16,
...
if(a===THREE.RGBA_S3TC_DXT1_Format)return Ta.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT3_Format)return Ta.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===THREE.RGBA_S3TC_DXT5_Format)return Ta.COMPRESSED_RGBA_S3TC_DXT5_EXT}return 0}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},M=void 0!==a.canvas?a.canvas:document.createElement("canvas"),U=void 0!==a.precision?a.precision:"highp",ea=void 0!==a.alpha?a.alpha:!0,xa=void 0!==a.premultipliedAlpha?a.premultipliedAlpha:!0,La=void 0!==
a.antialias?a.antialias:!1,A=void 0!==a.stencil?a.stencil:!0,ca=void 0!==a.preserveDrawingBuffer?a.preserveDrawingBuffer:!1,ia=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),oa=void 0!==a.clearAlpha?a.clearAlpha:0;this.domElement=M;this.context=null;this.devicePixelRatio=void 0!==a.devicePixelRatio?a.devicePixelRatio:void 0!==window.devicePixelRatio?window.devicePixelRatio:1;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=
this.autoClearColor=this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapAutoUpdate=!0;this.shadowMapType=THREE.PCFShadowMap;this.shadowMapCullFace=THREE.CullFaceFront;this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};
var N=this,fa=[],ib=0,Ya=null,db=null,Ja=-1,pa=null,ta=null,Z=0,la=0,W=-1,V=-1,ha=-1,ga=-1,ka=-1,Pa=-1,jb=-1,na=-1,Ua=null,Qa=null,Aa=null,Ra=null,rb=0,Ob=0,Lb=0,Pb=0,Tb=0,Ub=0,Za={},va=new THREE.Frustum,Va=new THREE.Matrix4,sb=new THREE.Matrix4,Ma=new THREE.Vector3,qa=new THREE.Vector3,$a=!0,Bb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},
hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Cb,Sa,kb,Ta;try{if(!(k=M.getContext("experimental-webgl",{alpha:ea,premultipliedAlpha:xa,antialias:La,stencil:A,preserveDrawingBuffer:ca})))throw"Error creating WebGL context.";}catch(Db){console.error(Db)}Cb=k.getExtension("OES_texture_float");Sa=k.getExtension("OES_standard_derivatives");kb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
Ta=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");Cb||console.log("THREE.WebGLRenderer: Float textures not supported.");Sa||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");kb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");Ta||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");void 0===k.getShaderPrecisionFormat&&
(k.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}});k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(ia.r,ia.g,ia.b,oa);this.context=k;var cc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),Gc=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);
var Hc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),dc=kb?k.getParameter(kb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,ec=0<Gc,Vb=ec&&Cb;Ta&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);var Kc=k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.HIGH_FLOAT),Lc=k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.MEDIUM_FLOAT);k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.LOW_FLOAT);var Mc=k.getShaderPrecisionFormat(k.FRAGMENT_SHADER,k.HIGH_FLOAT),Jc=k.getShaderPrecisionFormat(k.FRAGMENT_SHADER,k.MEDIUM_FLOAT);k.getShaderPrecisionFormat(k.FRAGMENT_SHADER,
k.LOW_FLOAT);k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.HIGH_INT);k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.MEDIUM_INT);k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.LOW_INT);k.getShaderPrecisionFormat(k.FRAGMENT_SHADER,k.HIGH_INT);k.getShaderPrecisionFormat(k.FRAGMENT_SHADER,k.MEDIUM_INT);k.getShaderPrecisionFormat(k.FRAGMENT_SHADER,k.LOW_INT);var Ic=0<Kc.precision&&0<Mc.precision,fc=0<Lc.precision&&0<Jc.precision;"highp"===U&&!Ic&&(fc?(U="mediump",console.warn("WebGLRenderer: highp not supported, using mediump")):
(U="lowp",console.warn("WebGLRenderer: highp and mediump not supported, using lowp")));"mediump"===U&&!fc&&(U="lowp",console.warn("WebGLRenderer: mediump not supported, using lowp"));this.getContext=function(){return k};this.supportsVertexTextures=function(){return ec};this.supportsFloatTextures=function(){return Cb};this.supportsStandardDerivatives=function(){return Sa};this.supportsCompressedTextureS3TC=function(){return Ta};this.getMaxAnisotropy=function(){return dc};this.getPrecision=function(){return U};
this.setSize=function(a,b){M.width=a*this.devicePixelRatio;M.height=b*this.devicePixelRatio;M.style.width=a+"px";M.style.height=b+"px";this.setViewport(0,0,M.width,M.height)};this.setViewport=function(a,b,c,d){rb=void 0!==a?a:0;Ob=void 0!==b?b:0;Lb=void 0!==c?c:M.width;Pb=void 0!==d?d:M.height;k.viewport(rb,Ob,Lb,Pb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColor=function(a,b){ia.set(a);
oa=void 0!==b?b:1;k.clearColor(ia.r,ia.g,ia.b,oa)};this.setClearColorHex=function(a,b){console.warn("DEPRECATED: .setClearColorHex() is being removed. Use .setClearColor() instead.");this.setClearColor(a,b)};this.getClearColor=function(){return ia};this.getClearAlpha=function(){return oa};this.clear=function(a,b,c){var d=0;if(void 0===a||a)d|=k.COLOR_BUFFER_BIT;if(void 0===b||b)d|=k.DEPTH_BUFFER_BIT;if(void 0===c||c)d|=k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);
this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};this.addPrePlugin=function(a){a.init(this);this.renderPluginsPre.push(a)};this.updateShadowMap=function(a,b){Ya=null;Ja=pa=na=jb=ha=-1;$a=!0;V=W=-1;this.shadowMapPlugin.update(a,b)};var gc=function(a){a=a.target;a.removeEventListener("dispose",gc);a.__webglInit=void 0;void 0!==a.__webglVertexBuffer&&k.deleteBuffer(a.__webglVertexBuffer);void 0!==a.__webglNormalBuffer&&k.deleteBuffer(a.__webglNormalBuffer);
...
a.__webglLineBuffer&&k.deleteBuffer(a.__webglLineBuffer);void 0!==a.__webglLineDistanceBuffer&&k.deleteBuffer(a.__webglLineDistanceBuffer);if(void 0!==a.geometryGroups)for(var c in a.geometryGroups){var d=a.geometryGroups[c];if(void 0!==d.numMorphTargets)for(var e=0,f=d.numMorphTargets;e<f;e++)k.deleteBuffer(d.__webglMorphTargetsBuffers[e]);if(void 0!==d.numMorphNormals){e=0;for(f=d.numMorphNormals;e<f;e++)k.deleteBuffer(d.__webglMorphNormalsBuffers[e])}b(d)}b(a);N.info.memory.geometries--},oc=function(a){a=
a.target;a.removeEventListener("dispose",oc);a.image&&a.image.__webglTextureCube?k.deleteTexture(a.image.__webglTextureCube):a.__webglInit&&(a.__webglInit=!1,k.deleteTexture(a.__webglTexture));N.info.memory.textures--},R=function(a){a=a.target;a.removeEventListener("dispose",R);if(a&&a.__webglTexture)if(k.deleteTexture(a.__webglTexture),a instanceof THREE.WebGLRenderTargetCube)for(var b=0;6>b;b++)k.deleteFramebuffer(a.__webglFramebuffer[b]),k.deleteRenderbuffer(a.__webglRenderbuffer[b]);else k.deleteFramebuffer(a.__webglFramebuffer),
k.deleteRenderbuffer(a.__webglRenderbuffer);N.info.memory.textures--},pc=function(a){a=a.target;a.removeEventListener("dispose",pc);da(a)},da=function(a){var b=a.program;if(void 0!==b){a.program=void 0;var c,d,e=!1,a=0;for(c=fa.length;a<c;a++)if(d=fa[a],d.program===b){d.usedTimes--;0===d.usedTimes&&(e=!0);break}if(!0===e){e=[];a=0;for(c=fa.length;a<c;a++)d=fa[a],d.program!==b&&e.push(d);fa=e;k.deleteProgram(b);N.info.memory.programs--}}};this.renderBufferImmediate=function(a,b,c){a.hasPositions&&
...
0,a.count);a.count=0};this.renderBufferDirect=function(a,b,c,d,e,f){if(!1!==d.visible){var g,j,l;g=E(a,b,c,d,f);a=g.attributes;b=e.attributes;c=!1;g=16777215*e.id+2*g.id+(d.wireframe?1:0);g!==pa&&(pa=g,c=!0);c&&i();if(f instanceof THREE.Mesh)if(d=b.index){e=e.offsets;1<e.length&&(c=!0);for(var m=0,p=e.length;m<p;m++){var n=e[m].index;if(c){for(j in b)"index"!==j&&(g=a[j],f=b[j],l=f.itemSize,0<=g&&(k.bindBuffer(k.ARRAY_BUFFER,f.buffer),h(g),k.vertexAttribPointer(g,l,k.FLOAT,!1,0,4*n*l)));k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,
d.buffer)}k.drawElements(k.TRIANGLES,e[m].count,k.UNSIGNED_SHORT,2*e[m].start);N.info.render.calls++;N.info.render.vertices+=e[m].count;N.info.render.faces+=e[m].count/3}}else{if(c)for(j in b)"index"!==j&&(g=a[j],f=b[j],l=f.itemSize,0<=g&&(k.bindBuffer(k.ARRAY_BUFFER,f.buffer),h(g),k.vertexAttribPointer(g,l,k.FLOAT,!1,0,0)));j=e.attributes.position;k.drawArrays(k.TRIANGLES,0,j.numItems/3);N.info.render.calls++;N.info.render.vertices+=j.numItems/3;N.info.render.faces+=j.numItems/3/3}else if(f instanceof
THREE.ParticleSystem){if(c){for(j in b)g=a[j],f=b[j],l=f.itemSize,0<=g&&(k.bindBuffer(k.ARRAY_BUFFER,f.buffer),h(g),k.vertexAttribPointer(g,l,k.FLOAT,!1,0,0));j=b.position;k.drawArrays(k.POINTS,0,j.numItems/3);N.info.render.calls++;N.info.render.points+=j.numItems/3}}else if(f instanceof THREE.Line&&c){for(j in b)g=a[j],f=b[j],l=f.itemSize,0<=g&&(k.bindBuffer(k.ARRAY_BUFFER,f.buffer),h(g),k.vertexAttribPointer(g,l,k.FLOAT,!1,0,0));H(d.linewidth);j=b.position;k.drawArrays(k.LINE_STRIP,0,j.numItems/
3);N.info.render.calls++;N.info.render.points+=j.numItems}}};this.renderBuffer=function(a,b,c,d,e,f){if(!1!==d.visible){var g,j,c=E(a,b,c,d,f),a=c.attributes,b=!1,c=16777215*e.id+2*c.id+(d.wireframe?1:0);c!==pa&&(pa=c,b=!0);b&&i();if(!d.morphTargets&&0<=a.position)b&&(k.bindBuffer(k.ARRAY_BUFFER,e.__webglVertexBuffer),h(a.position),k.vertexAttribPointer(a.position,3,k.FLOAT,!1,0,0));else if(f.morphTargetBase){c=d.program.attributes;-1!==f.morphTargetBase&&0<=c.position?(k.bindBuffer(k.ARRAY_BUFFER,
...
(H(d.wireframeLinewidth),b&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglLineBuffer),k.drawElements(k.LINES,e.__webglLineCount,k.UNSIGNED_SHORT,0)):(b&&k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,e.__webglFaceBuffer),k.drawElements(k.TRIANGLES,e.__webglFaceCount,k.UNSIGNED_SHORT,0)),N.info.render.calls++,N.info.render.vertices+=e.__webglFaceCount,N.info.render.faces+=e.__webglFaceCount/3):f instanceof THREE.Line?(f=f.type===THREE.LineStrip?k.LINE_STRIP:k.LINES,H(d.linewidth),k.drawArrays(f,0,e.__webglLineCount),
N.info.render.calls++):f instanceof THREE.ParticleSystem?(k.drawArrays(k.POINTS,0,e.__webglParticleCount),N.info.render.calls++,N.info.render.points+=e.__webglParticleCount):f instanceof THREE.Ribbon&&(k.drawArrays(k.TRIANGLE_STRIP,0,e.__webglVertexCount),N.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,i=a.__lights,m=a.fog;Ja=-1;$a=!0;this.autoUpdateScene&&
a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b.matrixWorldInverse.getInverse(b.matrixWorld);Va.multiplyMatrices(b.projectionMatrix,b.matrixWorldInverse);va.setFromMatrix(Va);this.autoUpdateObjects&&this.initWebGLObjects(a);l(this.renderPluginsPre,a,b);N.info.render.calls=0;N.info.render.vertices=0;N.info.render.faces=0;N.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,this.autoClearStencil);h=a.__webglObjects;d=
0;for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.id=d,f.render=!1,g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||va.intersectsObject(g))){var n=g;n._modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,n.matrixWorld);n._normalMatrix.getNormalMatrix(n._modelViewMatrix);var n=f,q=n.buffer,s=void 0,t=s=void 0,t=n.object.material;if(t instanceof THREE.MeshFaceMaterial)s=q.materialIndex,s=t.materials[s],s.transparent?(n.transparent=s,n.opaque=null):(n.opaque=
s,n.transparent=null);else if(s=t)s.transparent?(n.transparent=s,n.opaque=null):(n.opaque=s,n.transparent=null);f.render=!0;!0===this.sortObjects&&(null!==g.renderDepth?f.z=g.renderDepth:(Ma.getPositionFromMatrix(g.matrixWorld),Ma.applyProjection(Va),f.z=Ma.z))}this.sortObjects&&h.sort(j);h=a.__webglObjectsImmediate;d=0;for(e=h.length;d<e;d++)f=h[d],g=f.object,g.visible&&(g._modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,g.matrixWorld),g._normalMatrix.getNormalMatrix(g._modelViewMatrix),g=
f.object.material,g.transparent?(f.transparent=g,f.opaque=null):(f.opaque=g,f.transparent=null));a.overrideMaterial?(d=a.overrideMaterial,this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst),this.setDepthTest(d.depthTest),this.setDepthWrite(d.depthWrite),K(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits),p(a.__webglObjects,!1,"",b,i,m,!0,d),r(a.__webglObjectsImmediate,"",b,i,m,!1,d)):(d=null,this.setBlending(THREE.NoBlending),p(a.__webglObjects,!0,"opaque",b,i,m,!1,d),r(a.__webglObjectsImmediate,
...
null)));this.setDepthTest(!0);this.setDepthWrite(!0)}};this.renderImmediateObject=function(a,b,c,d,e){var f=E(a,b,c,d,e);pa=-1;N.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,va):e.render(function(a){N.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;)s(a.__objectsAdded[0],a),a.__objectsAdded.splice(0,1);for(;a.__objectsRemoved.length;)u(a.__objectsRemoved[0],
a),a.__objectsRemoved.splice(0,1);for(var b=0,c=a.__webglObjects.length;b<c;b++){var h=a.__webglObjects[b].object;void 0===h.__webglInit&&(void 0!==h.__webglActive&&u(h,a),s(h,a));var i=h,j=i.geometry,l=void 0,p=void 0,n=void 0;if(j instanceof THREE.BufferGeometry){var r=k.DYNAMIC_DRAW,t=!j.dynamic,x=j.attributes,z=void 0,B=void 0;for(z in x)B=x[z],B.needsUpdate&&("index"===z?(k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,B.buffer),k.bufferData(k.ELEMENT_ARRAY_BUFFER,B.array,r)):(k.bindBuffer(k.ARRAY_BUFFER,
B.buffer),k.bufferData(k.ARRAY_BUFFER,B.array,r)),B.needsUpdate=!1),t&&!B.dynamic&&delete B.array}else if(i instanceof THREE.Mesh){for(var E=0,F=j.geometryGroupsList.length;E<F;E++)if(l=j.geometryGroupsList[E],n=e(i,l),j.buffersNeedUpdate&&d(l,i),p=n.attributes&&q(n),j.verticesNeedUpdate||j.morphTargetsNeedUpdate||j.elementsNeedUpdate||j.uvsNeedUpdate||j.normalsNeedUpdate||j.colorsNeedUpdate||j.tangentsNeedUpdate||p){var C=l,J=i,G=k.DYNAMIC_DRAW,I=!j.dynamic,H=n;if(C.__inittedArrays){var L=f(H),K=
H.vertexColors?H.vertexColors:!1,N=g(H),M=L===THREE.SmoothShading,D=void 0,A=void 0,fa=void 0,O=void 0,U=void 0,R=void 0,P=void 0,W=void 0,V=void 0,Z=void 0,la=void 0,S=void 0,T=void 0,Q=void 0,aa=void 0,ta=void 0,ca=void 0,da=void 0,Ya=void 0,ea=void 0,ga=void 0,ha=void 0,ib=void 0,ka=void 0,pa=void 0,ia=void 0,oa=void 0,na=void 0,Ja=void 0,db=void 0,xa=void 0,qa=void 0,va=void 0,Aa=void 0,Pa=void 0,wa=void 0,$a=void 0,La=void 0,Sa=void 0,Ua=void 0,ab=void 0,jb=void 0,Wa=void 0,Xa=void 0,Qa=void 0,
Ra=void 0,Ka=0,Oa=0,Ta=0,Za=0,xb=0,gb=0,Ba=0,lb=0,Na=0,Y=0,ja=0,w=0,ya=void 0,bb=C.__vertexArray,kb=C.__uvArray,rb=C.__uv2Array,yb=C.__normalArray,Fa=C.__tangentArray,cb=C.__colorArray,Ga=C.__skinIndexArray,Ha=C.__skinWeightArray,Bb=C.__morphTargetsArrays,Cb=C.__morphNormalsArrays,Db=C.__webglCustomAttributesList,v=void 0,Gb=C.__faceArray,tb=C.__lineArray,nb=J.geometry,Ob=nb.elementsNeedUpdate,Lb=nb.uvsNeedUpdate,Pb=nb.normalsNeedUpdate,Tb=nb.tangentsNeedUpdate,Ub=nb.colorsNeedUpdate,ec=nb.morphTargetsNeedUpdate,
Wb=nb.vertices,ra=C.faces3,sa=C.faces4,hb=nb.faces,Vb=nb.faceVertexUvs[0],Pc=nb.faceVertexUvs[1],Xb=nb.skinIndices,Qb=nb.skinWeights,Rb=nb.morphTargets,qc=nb.morphNormals;if(nb.verticesNeedUpdate){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],S=Wb[O.a],T=Wb[O.b],Q=Wb[O.c],bb[Oa]=S.x,bb[Oa+1]=S.y,bb[Oa+2]=S.z,bb[Oa+3]=T.x,bb[Oa+4]=T.y,bb[Oa+5]=T.z,bb[Oa+6]=Q.x,bb[Oa+7]=Q.y,bb[Oa+8]=Q.z,Oa+=9;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=Wb[O.a],T=Wb[O.b],Q=Wb[O.c],aa=Wb[O.d],bb[Oa]=S.x,bb[Oa+1]=S.y,bb[Oa+2]=
S.z,bb[Oa+3]=T.x,bb[Oa+4]=T.y,bb[Oa+5]=T.z,bb[Oa+6]=Q.x,bb[Oa+7]=Q.y,bb[Oa+8]=Q.z,bb[Oa+9]=aa.x,bb[Oa+10]=aa.y,bb[Oa+11]=aa.z,Oa+=12;k.bindBuffer(k.ARRAY_BUFFER,C.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,bb,G)}if(ec){ab=0;for(jb=Rb.length;ab<jb;ab++){D=ja=0;for(A=ra.length;D<A;D++)Qa=ra[D],O=hb[Qa],S=Rb[ab].vertices[O.a],T=Rb[ab].vertices[O.b],Q=Rb[ab].vertices[O.c],Wa=Bb[ab],Wa[ja]=S.x,Wa[ja+1]=S.y,Wa[ja+2]=S.z,Wa[ja+3]=T.x,Wa[ja+4]=T.y,Wa[ja+5]=T.z,Wa[ja+6]=Q.x,Wa[ja+7]=Q.y,Wa[ja+8]=Q.z,
H.morphNormals&&(M?(Ra=qc[ab].vertexNormals[Qa],ea=Ra.a,ga=Ra.b,ha=Ra.c):ha=ga=ea=qc[ab].faceNormals[Qa],Xa=Cb[ab],Xa[ja]=ea.x,Xa[ja+1]=ea.y,Xa[ja+2]=ea.z,Xa[ja+3]=ga.x,Xa[ja+4]=ga.y,Xa[ja+5]=ga.z,Xa[ja+6]=ha.x,Xa[ja+7]=ha.y,Xa[ja+8]=ha.z),ja+=9;D=0;for(A=sa.length;D<A;D++)Qa=sa[D],O=hb[Qa],S=Rb[ab].vertices[O.a],T=Rb[ab].vertices[O.b],Q=Rb[ab].vertices[O.c],aa=Rb[ab].vertices[O.d],Wa=Bb[ab],Wa[ja]=S.x,Wa[ja+1]=S.y,Wa[ja+2]=S.z,Wa[ja+3]=T.x,Wa[ja+4]=T.y,Wa[ja+5]=T.z,Wa[ja+6]=Q.x,Wa[ja+7]=Q.y,Wa[ja+
8]=Q.z,Wa[ja+9]=aa.x,Wa[ja+10]=aa.y,Wa[ja+11]=aa.z,H.morphNormals&&(M?(Ra=qc[ab].vertexNormals[Qa],ea=Ra.a,ga=Ra.b,ha=Ra.c,ib=Ra.d):ib=ha=ga=ea=qc[ab].faceNormals[Qa],Xa=Cb[ab],Xa[ja]=ea.x,Xa[ja+1]=ea.y,Xa[ja+2]=ea.z,Xa[ja+3]=ga.x,Xa[ja+4]=ga.y,Xa[ja+5]=ga.z,Xa[ja+6]=ha.x,Xa[ja+7]=ha.y,Xa[ja+8]=ha.z,Xa[ja+9]=ib.x,Xa[ja+10]=ib.y,Xa[ja+11]=ib.z),ja+=12;k.bindBuffer(k.ARRAY_BUFFER,C.__webglMorphTargetsBuffers[ab]);k.bufferData(k.ARRAY_BUFFER,Bb[ab],G);H.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglMorphNormalsBuffers[ab]),
k.bufferData(k.ARRAY_BUFFER,Cb[ab],G))}}if(Qb.length){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],na=Qb[O.a],Ja=Qb[O.b],db=Qb[O.c],Ha[Y]=na.x,Ha[Y+1]=na.y,Ha[Y+2]=na.z,Ha[Y+3]=na.w,Ha[Y+4]=Ja.x,Ha[Y+5]=Ja.y,Ha[Y+6]=Ja.z,Ha[Y+7]=Ja.w,Ha[Y+8]=db.x,Ha[Y+9]=db.y,Ha[Y+10]=db.z,Ha[Y+11]=db.w,qa=Xb[O.a],va=Xb[O.b],Aa=Xb[O.c],Ga[Y]=qa.x,Ga[Y+1]=qa.y,Ga[Y+2]=qa.z,Ga[Y+3]=qa.w,Ga[Y+4]=va.x,Ga[Y+5]=va.y,Ga[Y+6]=va.z,Ga[Y+7]=va.w,Ga[Y+8]=Aa.x,Ga[Y+9]=Aa.y,Ga[Y+10]=Aa.z,Ga[Y+11]=Aa.w,Y+=12;D=0;for(A=sa.length;D<A;D++)O=
hb[sa[D]],na=Qb[O.a],Ja=Qb[O.b],db=Qb[O.c],xa=Qb[O.d],Ha[Y]=na.x,Ha[Y+1]=na.y,Ha[Y+2]=na.z,Ha[Y+3]=na.w,Ha[Y+4]=Ja.x,Ha[Y+5]=Ja.y,Ha[Y+6]=Ja.z,Ha[Y+7]=Ja.w,Ha[Y+8]=db.x,Ha[Y+9]=db.y,Ha[Y+10]=db.z,Ha[Y+11]=db.w,Ha[Y+12]=xa.x,Ha[Y+13]=xa.y,Ha[Y+14]=xa.z,Ha[Y+15]=xa.w,qa=Xb[O.a],va=Xb[O.b],Aa=Xb[O.c],Pa=Xb[O.d],Ga[Y]=qa.x,Ga[Y+1]=qa.y,Ga[Y+2]=qa.z,Ga[Y+3]=qa.w,Ga[Y+4]=va.x,Ga[Y+5]=va.y,Ga[Y+6]=va.z,Ga[Y+7]=va.w,Ga[Y+8]=Aa.x,Ga[Y+9]=Aa.y,Ga[Y+10]=Aa.z,Ga[Y+11]=Aa.w,Ga[Y+12]=Pa.x,Ga[Y+13]=Pa.y,Ga[Y+14]=
Pa.z,Ga[Y+15]=Pa.w,Y+=16;0<Y&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ga,G),k.bindBuffer(k.ARRAY_BUFFER,C.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ha,G))}if(Ub&&K){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],P=O.vertexColors,W=O.color,3===P.length&&K===THREE.VertexColors?(ka=P[0],pa=P[1],ia=P[2]):ia=pa=ka=W,cb[Na]=ka.r,cb[Na+1]=ka.g,cb[Na+2]=ka.b,cb[Na+3]=pa.r,cb[Na+4]=pa.g,cb[Na+5]=pa.b,cb[Na+6]=ia.r,cb[Na+7]=ia.g,cb[Na+8]=ia.b,Na+=9;D=0;for(A=
sa.length;D<A;D++)O=hb[sa[D]],P=O.vertexColors,W=O.color,4===P.length&&K===THREE.VertexColors?(ka=P[0],pa=P[1],ia=P[2],oa=P[3]):oa=ia=pa=ka=W,cb[Na]=ka.r,cb[Na+1]=ka.g,cb[Na+2]=ka.b,cb[Na+3]=pa.r,cb[Na+4]=pa.g,cb[Na+5]=pa.b,cb[Na+6]=ia.r,cb[Na+7]=ia.g,cb[Na+8]=ia.b,cb[Na+9]=oa.r,cb[Na+10]=oa.g,cb[Na+11]=oa.b,Na+=12;0<Na&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,cb,G))}if(Tb&&nb.hasTangents){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],V=O.vertexTangents,ta=V[0],ca=
V[1],da=V[2],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Ba+=12;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Ya=V[3],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Fa[Ba+12]=Ya.x,Fa[Ba+13]=Ya.y,Fa[Ba+14]=Ya.z,Fa[Ba+15]=
Ya.w,Ba+=16;k.bindBuffer(k.ARRAY_BUFFER,C.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Fa,G)}if(Pb&&L){D=0;for(A=ra.length;D<A;D++)if(O=hb[ra[D]],U=O.vertexNormals,R=O.normal,3===U.length&&M)for(wa=0;3>wa;wa++)La=U[wa],yb[gb]=La.x,yb[gb+1]=La.y,yb[gb+2]=La.z,gb+=3;else for(wa=0;3>wa;wa++)yb[gb]=R.x,yb[gb+1]=R.y,yb[gb+2]=R.z,gb+=3;D=0;for(A=sa.length;D<A;D++)if(O=hb[sa[D]],U=O.vertexNormals,R=O.normal,4===U.length&&M)for(wa=0;4>wa;wa++)La=U[wa],yb[gb]=La.x,yb[gb+1]=La.y,yb[gb+2]=La.z,gb+=3;else for(wa=
0;4>wa;wa++)yb[gb]=R.x,yb[gb+1]=R.y,yb[gb+2]=R.z,gb+=3;k.bindBuffer(k.ARRAY_BUFFER,C.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yb,G)}if(Lb&&Vb&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],Z=Vb[fa],void 0!==Z)for(wa=0;3>wa;wa++)Sa=Z[wa],kb[Ta]=Sa.x,kb[Ta+1]=Sa.y,Ta+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],Z=Vb[fa],void 0!==Z)for(wa=0;4>wa;wa++)Sa=Z[wa],kb[Ta]=Sa.x,kb[Ta+1]=Sa.y,Ta+=2;0<Ta&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,kb,G))}if(Lb&&Pc&&N){D=0;
for(A=ra.length;D<A;D++)if(fa=ra[D],la=Pc[fa],void 0!==la)for(wa=0;3>wa;wa++)Ua=la[wa],rb[Za]=Ua.x,rb[Za+1]=Ua.y,Za+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],la=Pc[fa],void 0!==la)for(wa=0;4>wa;wa++)Ua=la[wa],rb[Za]=Ua.x,rb[Za+1]=Ua.y,Za+=2;0<Za&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,rb,G))}if(Ob){D=0;for(A=ra.length;D<A;D++)Gb[xb]=Ka,Gb[xb+1]=Ka+1,Gb[xb+2]=Ka+2,xb+=3,tb[lb]=Ka,tb[lb+1]=Ka+1,tb[lb+2]=Ka,tb[lb+3]=Ka+2,tb[lb+4]=Ka+1,tb[lb+5]=Ka+2,lb+=6,Ka+=3;
D=0;for(A=sa.length;D<A;D++)Gb[xb]=Ka,Gb[xb+1]=Ka+1,Gb[xb+2]=Ka+3,Gb[xb+3]=Ka+1,Gb[xb+4]=Ka+2,Gb[xb+5]=Ka+3,xb+=6,tb[lb]=Ka,tb[lb+1]=Ka+1,tb[lb+2]=Ka,tb[lb+3]=Ka+3,tb[lb+4]=Ka+1,tb[lb+5]=Ka+2,tb[lb+6]=Ka+2,tb[lb+7]=Ka+3,lb+=8,Ka+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Gb,G);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,tb,G)}if(Db){wa=0;for($a=Db.length;wa<$a;wa++)if(v=Db[wa],v.__original.needsUpdate){w=
0;if(1===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],w+=3;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],v.array[w+3]=v.value[O.d],w+=4}else{if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],v.array[w]=ya,v.array[w+1]=ya,v.array[w+2]=ya,w+=3;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],
v.array[w]=ya,v.array[w+1]=ya,v.array[w+2]=ya,v.array[w+3]=ya,w+=4}}else if(2===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,w+=6;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+
4]=Q.x,v.array[w+5]=Q.y,v.array[w+6]=aa.x,v.array[w+7]=aa.y,w+=8}else{if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,w+=6;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,v.array[w+6]=aa.x,v.array[w+7]=aa.y,w+=8}}else if(3===v.size){var X;X="c"===v.type?["r","g","b"]:
["x","y","z"];if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+
3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}else if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=
v.value[sa[D]],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}else if("faceVertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],S=ya[0],T=ya[1],Q=ya[2],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],
v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],S=ya[0],T=ya[1],Q=ya[2],aa=ya[3],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}}else if(4===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=
hb[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+
8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,v.array[w+12]=aa.x,v.array[w+13]=aa.y,v.array[w+14]=aa.z,v.array[w+15]=aa.w,w+=16}else if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S.x,
v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,v.array[w+12]=aa.x,v.array[w+13]=aa.y,v.array[w+14]=aa.z,v.array[w+15]=aa.w,w+=16}else if("faceVertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],S=ya[0],T=ya[1],Q=ya[2],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+
7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],S=ya[0],T=ya[1],Q=ya[2],aa=ya[3],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,v.array[w+12]=aa.x,v.array[w+13]=aa.y,v.array[w+14]=aa.z,v.array[w+15]=aa.w,w+=16}k.bindBuffer(k.ARRAY_BUFFER,v.buffer);k.bufferData(k.ARRAY_BUFFER,
v.array,G)}}I&&(delete C.__inittedArrays,delete C.__colorArray,delete C.__normalArray,delete C.__tangentArray,delete C.__uvArray,delete C.__uv2Array,delete C.__faceArray,delete C.__vertexArray,delete C.__lineArray,delete C.__skinIndexArray,delete C.__skinWeightArray)}}j.verticesNeedUpdate=!1;j.morphTargetsNeedUpdate=!1;j.elementsNeedUpdate=!1;j.uvsNeedUpdate=!1;j.normalsNeedUpdate=!1;j.colorsNeedUpdate=!1;j.tangentsNeedUpdate=!1;j.buffersNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof THREE.Ribbon){n=
e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||j.colorsNeedUpdate||j.normalsNeedUpdate||p){var zb=j,rc=k.DYNAMIC_DRAW,hc=void 0,ic=void 0,jc=void 0,sc=void 0,za=void 0,tc=void 0,uc=void 0,vc=void 0,cc=void 0,eb=void 0,$b=void 0,Da=void 0,ob=void 0,dc=zb.vertices,fc=zb.colors,gc=zb.normals,oc=dc.length,pc=fc.length,Gc=gc.length,wc=zb.__vertexArray,xc=zb.__colorArray,yc=zb.__normalArray,Hc=zb.colorsNeedUpdate,Ic=zb.normalsNeedUpdate,Qc=zb.__webglCustomAttributesList;if(zb.verticesNeedUpdate){for(hc=
0;hc<oc;hc++)sc=dc[hc],za=3*hc,wc[za]=sc.x,wc[za+1]=sc.y,wc[za+2]=sc.z;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,wc,rc)}if(Hc){for(ic=0;ic<pc;ic++)tc=fc[ic],za=3*ic,xc[za]=tc.r,xc[za+1]=tc.g,xc[za+2]=tc.b;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,xc,rc)}if(Ic){for(jc=0;jc<Gc;jc++)uc=gc[jc],za=3*jc,yc[za]=uc.x,yc[za+1]=uc.y,yc[za+2]=uc.z;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yc,rc)}if(Qc){vc=
0;for(cc=Qc.length;vc<cc;vc++)if(Da=Qc[vc],Da.needsUpdate&&(void 0===Da.boundTo||"vertices"===Da.boundTo)){za=0;$b=Da.value.length;if(1===Da.size)for(eb=0;eb<$b;eb++)Da.array[eb]=Da.value[eb];else if(2===Da.size)for(eb=0;eb<$b;eb++)ob=Da.value[eb],Da.array[za]=ob.x,Da.array[za+1]=ob.y,za+=2;else if(3===Da.size)if("c"===Da.type)for(eb=0;eb<$b;eb++)ob=Da.value[eb],Da.array[za]=ob.r,Da.array[za+1]=ob.g,Da.array[za+2]=ob.b,za+=3;else for(eb=0;eb<$b;eb++)ob=Da.value[eb],Da.array[za]=ob.x,Da.array[za+1]=
ob.y,Da.array[za+2]=ob.z,za+=3;else if(4===Da.size)for(eb=0;eb<$b;eb++)ob=Da.value[eb],Da.array[za]=ob.x,Da.array[za+1]=ob.y,Da.array[za+2]=ob.z,Da.array[za+3]=ob.w,za+=4;k.bindBuffer(k.ARRAY_BUFFER,Da.buffer);k.bufferData(k.ARRAY_BUFFER,Da.array,rc)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.normalsNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof THREE.Line){n=e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||j.colorsNeedUpdate||j.lineDistancesNeedUpdate||p){var Ab=j,zc=k.DYNAMIC_DRAW,
kc=void 0,lc=void 0,mc=void 0,Ac=void 0,Ia=void 0,Bc=void 0,Vc=Ab.vertices,Wc=Ab.colors,Xc=Ab.lineDistances,Jc=Vc.length,Kc=Wc.length,Lc=Xc.length,Cc=Ab.__vertexArray,Dc=Ab.__colorArray,Yc=Ab.__lineDistanceArray,Mc=Ab.colorsNeedUpdate,cd=Ab.lineDistancesNeedUpdate,Rc=Ab.__webglCustomAttributesList,Ec=void 0,Zc=void 0,fb=void 0,ac=void 0,pb=void 0,Ea=void 0;if(Ab.verticesNeedUpdate){for(kc=0;kc<Jc;kc++)Ac=Vc[kc],Ia=3*kc,Cc[Ia]=Ac.x,Cc[Ia+1]=Ac.y,Cc[Ia+2]=Ac.z;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglVertexBuffer);
k.bufferData(k.ARRAY_BUFFER,Cc,zc)}if(Mc){for(lc=0;lc<Kc;lc++)Bc=Wc[lc],Ia=3*lc,Dc[Ia]=Bc.r,Dc[Ia+1]=Bc.g,Dc[Ia+2]=Bc.b;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Dc,zc)}if(cd){for(mc=0;mc<Lc;mc++)Yc[mc]=Xc[mc];k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,Yc,zc)}if(Rc){Ec=0;for(Zc=Rc.length;Ec<Zc;Ec++)if(Ea=Rc[Ec],Ea.needsUpdate&&(void 0===Ea.boundTo||"vertices"===Ea.boundTo)){Ia=0;ac=Ea.value.length;if(1===Ea.size)for(fb=
0;fb<ac;fb++)Ea.array[fb]=Ea.value[fb];else if(2===Ea.size)for(fb=0;fb<ac;fb++)pb=Ea.value[fb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ia+=2;else if(3===Ea.size)if("c"===Ea.type)for(fb=0;fb<ac;fb++)pb=Ea.value[fb],Ea.array[Ia]=pb.r,Ea.array[Ia+1]=pb.g,Ea.array[Ia+2]=pb.b,Ia+=3;else for(fb=0;fb<ac;fb++)pb=Ea.value[fb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ea.array[Ia+2]=pb.z,Ia+=3;else if(4===Ea.size)for(fb=0;fb<ac;fb++)pb=Ea.value[fb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ea.array[Ia+2]=pb.z,Ea.array[Ia+
3]=pb.w,Ia+=4;k.bindBuffer(k.ARRAY_BUFFER,Ea.buffer);k.bufferData(k.ARRAY_BUFFER,Ea.array,zc)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.lineDistancesNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof THREE.ParticleSystem){n=e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||j.colorsNeedUpdate||i.sortParticles||p){var Hb=j,Sc=k.DYNAMIC_DRAW,nc=i,qb=void 0,Ib=void 0,Jb=void 0,ba=void 0,Kb=void 0,Sb=void 0,Fc=Hb.vertices,Tc=Fc.length,Uc=Hb.colors,$c=Uc.length,Yb=Hb.__vertexArray,Zb=Hb.__colorArray,
Mb=Hb.__sortArray,ad=Hb.verticesNeedUpdate,bd=Hb.colorsNeedUpdate,Nb=Hb.__webglCustomAttributesList,Eb=void 0,bc=void 0,ma=void 0,Fb=void 0,Ca=void 0,$=void 0;if(nc.sortParticles){sb.copy(Va);sb.multiply(nc.matrixWorld);for(qb=0;qb<Tc;qb++)Jb=Fc[qb],Ma.copy(Jb),Ma.applyProjection(sb),Mb[qb]=[Ma.z,qb];Mb.sort(m);for(qb=0;qb<Tc;qb++)Jb=Fc[Mb[qb][1]],ba=3*qb,Yb[ba]=Jb.x,Yb[ba+1]=Jb.y,Yb[ba+2]=Jb.z;for(Ib=0;Ib<$c;Ib++)ba=3*Ib,Sb=Uc[Mb[Ib][1]],Zb[ba]=Sb.r,Zb[ba+1]=Sb.g,Zb[ba+2]=Sb.b;if(Nb){Eb=0;for(bc=
Nb.length;Eb<bc;Eb++)if($=Nb[Eb],void 0===$.boundTo||"vertices"===$.boundTo)if(ba=0,Fb=$.value.length,1===$.size)for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],$.array[ma]=$.value[Kb];else if(2===$.size)for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,ba+=2;else if(3===$.size)if("c"===$.type)for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],Ca=$.value[Kb],$.array[ba]=Ca.r,$.array[ba+1]=Ca.g,$.array[ba+2]=Ca.b,ba+=3;else for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+
1]=Ca.y,$.array[ba+2]=Ca.z,ba+=3;else if(4===$.size)for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,$.array[ba+3]=Ca.w,ba+=4}}else{if(ad)for(qb=0;qb<Tc;qb++)Jb=Fc[qb],ba=3*qb,Yb[ba]=Jb.x,Yb[ba+1]=Jb.y,Yb[ba+2]=Jb.z;if(bd)for(Ib=0;Ib<$c;Ib++)Sb=Uc[Ib],ba=3*Ib,Zb[ba]=Sb.r,Zb[ba+1]=Sb.g,Zb[ba+2]=Sb.b;if(Nb){Eb=0;for(bc=Nb.length;Eb<bc;Eb++)if($=Nb[Eb],$.needsUpdate&&(void 0===$.boundTo||"vertices"===$.boundTo))if(Fb=$.value.length,ba=0,1===$.size)for(ma=
0;ma<Fb;ma++)$.array[ma]=$.value[ma];else if(2===$.size)for(ma=0;ma<Fb;ma++)Ca=$.value[ma],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,ba+=2;else if(3===$.size)if("c"===$.type)for(ma=0;ma<Fb;ma++)Ca=$.value[ma],$.array[ba]=Ca.r,$.array[ba+1]=Ca.g,$.array[ba+2]=Ca.b,ba+=3;else for(ma=0;ma<Fb;ma++)Ca=$.value[ma],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,ba+=3;else if(4===$.size)for(ma=0;ma<Fb;ma++)Ca=$.value[ma],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,$.array[ba+3]=Ca.w,ba+=4}}if(ad||
nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,Hb.__webglVertexBuffer),k.bufferData(k.ARRAY_BUFFER,Yb,Sc);if(bd||nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,Hb.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Zb,Sc);if(Nb){Eb=0;for(bc=Nb.length;Eb<bc;Eb++)if($=Nb[Eb],$.needsUpdate||nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,$.buffer),k.bufferData(k.ARRAY_BUFFER,$.array,Sc)}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;n.attributes&&y(n)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h;a.addEventListener("dispose",
pc);var i,j,l,m,p;a instanceof THREE.MeshDepthMaterial?p="depth":a instanceof THREE.MeshNormalMaterial?p="normal":a instanceof THREE.MeshBasicMaterial?p="basic":a instanceof THREE.MeshLambertMaterial?p="lambert":a instanceof THREE.MeshPhongMaterial?p="phong":a instanceof THREE.LineBasicMaterial?p="basic":a instanceof THREE.LineDashedMaterial?p="dashed":a instanceof THREE.ParticleBasicMaterial&&(p="particle_basic");if(p){var n=THREE.ShaderLib[p];a.uniforms=THREE.UniformsUtils.clone(n.uniforms);a.vertexShader=
n.vertexShader;a.fragmentShader=n.fragmentShader}var q,r,s;e=g=r=s=n=0;for(f=b.length;e<f;e++)q=b[e],q.onlyShadow||(q instanceof THREE.DirectionalLight&&g++,q instanceof THREE.PointLight&&r++,q instanceof THREE.SpotLight&&s++,q instanceof THREE.HemisphereLight&&n++);e=g;f=r;g=s;h=n;n=q=0;for(s=b.length;n<s;n++)r=b[n],r.castShadow&&(r instanceof THREE.SpotLight&&q++,r instanceof THREE.DirectionalLight&&!r.shadowCascade&&q++);m=q;Vb&&d&&d.useVertexTexture?l=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),
...
fogExp:c instanceof THREE.FogExp2,sizeAttenuation:a.sizeAttenuation,skinning:a.skinning,maxBones:l,useVertexTexture:Vb&&d&&d.useVertexTexture,boneTextureWidth:d&&d.boneTextureWidth,boneTextureHeight:d&&d.boneTextureHeight,morphTargets:a.morphTargets,morphNormals:a.morphNormals,maxMorphTargets:this.maxMorphTargets,maxMorphNormals:this.maxMorphNormals,maxDirLights:e,maxPointLights:f,maxSpotLights:g,maxHemiLights:h,maxShadows:m,shadowMapEnabled:this.shadowMapEnabled&&d.receiveShadow,shadowMapType:this.shadowMapType,
shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,x,u,d=[];p?d.push(p):(d.push(s),d.push(r));for(x in q)d.push(x),d.push(q[x]);for(t in c)d.push(t),d.push(c[t]);p=d.join();t=0;for(x=fa.length;t<x;t++)if(d=fa[t],d.code===p){d.usedTimes++;j=d.program;break a}t="SHADOWMAP_TYPE_BASIC";c.shadowMapType===THREE.PCFShadowMap?t="SHADOWMAP_TYPE_PCF":
c.shadowMapType===THREE.PCFSoftShadowMap&&(t="SHADOWMAP_TYPE_PCF_SOFT");x=[];for(u in q)d=q[u],!1!==d&&(d="#define "+u+" "+d,x.push(d));d=x.join("\n");u=k.createProgram();x=["precision "+U+" float;",d,ec?"#define VERTEX_TEXTURES":"",N.gammaInput?"#define GAMMA_INPUT":"",N.gammaOutput?"#define GAMMA_OUTPUT":"",N.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,
...
y);for(y=0;y<c.maxMorphNormals;y++)t.push("morphNormal"+y);for(j in b)t.push(j);j=t;y=0;for(b=j.length;y<b;y++)t=j[y],u.attributes[t]=k.getAttribLocation(u,t);u.id=ib++;fa.push({program:u,code:p,usedTimes:1});N.info.memory.programs=fa.length;j=u}a.program=j;y=a.program.attributes;if(a.morphTargets){a.numSupportedMorphTargets=0;b="morphTarget";for(j=0;j<this.maxMorphTargets;j++)u=b+j,0<=y[u]&&a.numSupportedMorphTargets++}if(a.morphNormals){a.numSupportedMorphNormals=0;b="morphNormal";for(j=0;j<this.maxMorphNormals;j++)u=
...
b&&(b?k.disable(k.CULL_FACE):k.enable(k.CULL_FACE),W=b);V!==a&&(a?k.frontFace(k.CW):k.frontFace(k.CCW),V=a)};this.setDepthTest=function(a){jb!==a&&(a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST),jb=a)};this.setDepthWrite=function(a){na!==a&&(k.depthMask(a),na=a)};this.setBlending=function(a,b,c,d){a!==ha&&(a===THREE.NoBlending?k.disable(k.BLEND):a===THREE.AdditiveBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.SRC_ALPHA,k.ONE)):a===THREE.SubtractiveBlending?(k.enable(k.BLEND),
k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.SRC_COLOR)):a===THREE.CustomBlending?k.enable(k.BLEND):(k.enable(k.BLEND),k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD),k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)),ha=a);if(a===THREE.CustomBlending){if(b!==ga&&(k.blendEquation(I(b)),ga=b),c!==ka||d!==Pa)k.blendFunc(I(c),I(d)),ka=c,Pa=d}else Pa=
ka=ga=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.addEventListener("dispose",oc),a.__webglTexture=k.createTexture(),N.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);k.pixelStorei(k.UNPACK_ALIGNMENT,a.unpackAlignment);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=I(a.format),
...
a.__webglFramebuffer[f]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);P(a.__webglRenderbuffer[f],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=k.createFramebuffer(),a.__webglRenderbuffer=a.shareDepthFrom?a.shareDepthFrom.__webglRenderbuffer:k.createRenderbuffer(),k.bindTexture(k.TEXTURE_2D,a.__webglTexture),B(k.TEXTURE_2D,a,c),k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=k.TEXTURE_2D,k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer),
k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0),a.shareDepthFrom?a.depthBuffer&&!a.stencilBuffer?k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_ATTACHMENT,k.RENDERBUFFER,a.__webglRenderbuffer):a.depthBuffer&&a.stencilBuffer&&k.framebufferRenderbuffer(k.FRAMEBUFFER,k.DEPTH_STENCIL_ATTACHMENT,k.RENDERBUFFER,a.__webglRenderbuffer):P(a.__webglRenderbuffer,a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,
null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=Lb,a=Pb,d=rb,e=Ob);b!==db&&(k.bindFramebuffer(k.FRAMEBUFFER,b),k.viewport(d,e,c,a),db=b);Tb=c;Ub=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};THREE.WebGLRenderTarget=function(a,b,c){this.width=a;this.height=b;c=c||{};this.wrapS=void 0!==c.wrapS?c.wrapS:THREE.ClampToEdgeWrapping;this.wrapT=void 0!==c.wrapT?c.wrapT:THREE.ClampToEdgeWrapping;this.magFilter=void 0!==c.magFilter?c.magFilter:THREE.LinearFilter;this.minFilter=void 0!==c.minFilter?c.minFilter:THREE.LinearMipMapLinearFilter;this.anisotropy=void 0!==c.anisotropy?c.anisotropy:1;this.offset=new THREE.Vector2(0,0);this.repeat=new THREE.Vector2(1,1);this.format=void 0!==c.format?c.format:
...
void 0,r=a[g[i]].x,s=a[g[i]].y,n=a[g[j]].x,q=a[g[j]].y,y=a[g[m]].x,u=a[g[m]].y;if(1E-10>(n-r)*(u-s)-(q-s)*(y-r))p=!1;else{var E=void 0,J=void 0,F=void 0,z=void 0,H=void 0,K=void 0,G=void 0,L=void 0,B=void 0,P=void 0,B=L=G=t=x=void 0,E=y-n,J=u-q,F=r-y,z=s-u,H=n-r,K=q-s;for(p=0;p<e;p++)if(!(p===i||p===j||p===m))if(x=a[g[p]].x,t=a[g[p]].y,G=x-r,L=t-s,B=x-n,P=t-q,x-=y,t-=u,B=E*P-J*B,G=H*L-K*G,L=F*t-z*x,0<=B&&0<=L&&0<=G){p=!1;break a}p=!0}}if(p){f.push([a[g[i]],a[g[j]],a[g[m]]]);h.push([g[i],g[j],g[m]]);
...
1-r))}j.push(l);m.push(p)}c=(b-a)/c;for(h=0;h<d;h++){0!==a?(l=this.vertices[j[0][h]].clone(),p=this.vertices[j[0][h+1]].clone()):(l=this.vertices[j[1][h]].clone(),p=this.vertices[j[1][h+1]].clone());l.setY(Math.sqrt(l.x*l.x+l.z*l.z)*c).normalize();p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();for(i=0;i<e;i++){var r=j[i][h],s=j[i+1][h],n=j[i+1][h+1],q=j[i][h+1],y=l.clone(),u=l.clone(),x=p.clone(),t=p.clone(),E=m[i][h].clone(),J=m[i+1][h].clone(),F=m[i+1][h+1].clone(),z=m[i][h+1].clone();this.faces.push(new THREE.Face4(r,
...
100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,m=void 0!==b.bevelSegments?b.bevelSegments:3,l=void 0!==b.bevelEnabled?b.bevelEnabled:!0,p=void 0!==b.curveSegments?b.curveSegments:12,r=void 0!==b.steps?b.steps:1,s=b.extrudePath,n,q=!1,y=b.material,u=b.extrudeMaterial,x=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,t,E,J,F;s&&(n=s.getSpacedPoints(r),q=!0,l=!1,t=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(s,r,
!1),E=new THREE.Vector3,J=new THREE.Vector3,F=new THREE.Vector3);l||(j=i=m=0);var z,H,K,G=this,L=this.vertices.length,p=a.extractPoints(p),B=p.shape,p=p.holes;if(s=!THREE.Shape.Utils.isClockWise(B)){B=B.reverse();H=0;for(K=p.length;H<K;H++)z=p[H],THREE.Shape.Utils.isClockWise(z)&&(p[H]=z.reverse());s=!1}var P=THREE.Shape.Utils.triangulateShape(B,p),s=B;H=0;for(K=p.length;H<K;H++)z=p[H],B=B.concat(z);var C,I,M,U,ea=B.length,xa=P.length,La=[],A=0,ca=s.length;C=ca-1;for(I=A+1;A<ca;A++,C++,I++)C===ca&&
(C=0),I===ca&&(I=0),La[A]=d(s[A],s[C],s[I]);var ia=[],oa,N=La.concat();H=0;for(K=p.length;H<K;H++){z=p[H];oa=[];A=0;ca=z.length;C=ca-1;for(I=A+1;A<ca;A++,C++,I++)C===ca&&(C=0),I===ca&&(I=0),oa[A]=d(z[A],z[C],z[I]);ia.push(oa);N=N.concat(oa)}for(C=0;C<m;C++){z=C/m;M=i*(1-z);I=j*Math.sin(z*Math.PI/2);A=0;for(ca=s.length;A<ca;A++)U=c(s[A],La[A],I),f(U.x,U.y,-M);H=0;for(K=p.length;H<K;H++){z=p[H];oa=ia[H];A=0;for(ca=z.length;A<ca;A++)U=c(z[A],oa[A],I),f(U.x,U.y,-M)}}I=j;for(A=0;A<ea;A++)U=l?c(B[A],N[A],
I):B[A],q?(J.copy(t.normals[0]).multiplyScalar(U.x),E.copy(t.binormals[0]).multiplyScalar(U.y),F.copy(n[0]).add(J).add(E),f(F.x,F.y,F.z)):f(U.x,U.y,0);for(z=1;z<=r;z++)for(A=0;A<ea;A++)U=l?c(B[A],N[A],I):B[A],q?(J.copy(t.normals[z]).multiplyScalar(U.x),E.copy(t.binormals[z]).multiplyScalar(U.y),F.copy(n[z]).add(J).add(E),f(F.x,F.y,F.z)):f(U.x,U.y,h/r*z);for(C=m-1;0<=C;C--){z=C/m;M=i*(1-z);I=j*Math.sin(z*Math.PI/2);A=0;for(ca=s.length;A<ca;A++)U=c(s[A],La[A],I),f(U.x,U.y,h+M);H=0;for(K=p.length;H<
K;H++){z=p[H];oa=ia[H];A=0;for(ca=z.length;A<ca;A++)U=c(z[A],oa[A],I),q?f(U.x,U.y+n[r-1].y,n[r-1].x+M):f(U.x,U.y,h+M)}}if(l){i=0*ea;for(A=0;A<xa;A++)h=P[A],g(h[2]+i,h[1]+i,h[0]+i,!0);i=ea*(r+2*m);for(A=0;A<xa;A++)h=P[A],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(A=0;A<xa;A++)h=P[A],g(h[2],h[1],h[0],!0);for(A=0;A<xa;A++)h=P[A],g(h[0]+ea*r,h[1]+ea*r,h[2]+ea*r,!1)}h=0;e(s,h);h+=s.length;H=0;for(K=p.length;H<K;H++)z=p[H],e(z,h),h+=z.length};
...
THREE.ArrowHelper.prototype.setLength=function(a){this.scale.set(a,a,a)};THREE.ArrowHelper.prototype.setColor=function(a){this.line.material.color.setHex(a);this.cone.material.color.setHex(a)};THREE.ArrowHelper.__v1=new THREE.Vector3;THREE.ArrowHelper.__v2=new THREE.Vector3;THREE.ArrowHelper.__q1=new THREE.Quaternion;THREE.BoxHelper=function(a){var a=a||1,b=new THREE.Geometry,a=[new THREE.Vector3(a,a,a),new THREE.Vector3(-a,a,a),new THREE.Vector3(-a,-a,a),new THREE.Vector3(a,-a,a),new THREE.Vector3(a,a,-a),new THREE.Vector3(-a,a,-a),new THREE.Vector3(-a,-a,-a),new THREE.Vector3(a,-a,-a)];b.vertices.push(a[0],a[1],a[1],a[2],a[2],a[3],a[3],a[0],a[4],a[5],a[5],a[6],a[6],a[7],a[7],a[4],a[0],a[4],a[1],a[5],a[2],a[6],a[3],a[7]);this.vertices=a;THREE.Line.call(this,b,new THREE.LineBasicMaterial,THREE.LinePieces)};
THREE.BoxHelper.prototype=Object.create(THREE.Line.prototype);
THREE.BoxHelper.prototype.update=function(a){var b=a.geometry;null===b.boundingBox&&b.computeBoundingBox();var c=b.boundingBox.min,b=b.boundingBox.max,d=this.vertices;d[0].set(b.x,b.y,b.z);d[1].set(c.x,b.y,b.z);d[2].set(c.x,c.y,b.z);d[3].set(b.x,c.y,b.z);d[4].set(b.x,b.y,c.z);d[5].set(c.x,b.y,c.z);d[6].set(c.x,c.y,c.z);d[7].set(b.x,c.y,c.z);this.geometry.computeBoundingSphere();this.geometry.verticesNeedUpdate=!0;this.matrixAutoUpdate=!1;this.matrixWorld=a.matrixWorld};THREE.CameraHelper=function(a){function b(a,b,d){c(a,d);c(b,d)}function c(a,b){d.geometry.vertices.push(new THREE.Vector3);d.geometry.colors.push(new THREE.Color(b));void 0===d.pointMap[a]&&(d.pointMap[a]=[]);d.pointMap[a].push(d.geometry.vertices.length-1)}THREE.Line.call(this);var d=this;this.geometry=new THREE.Geometry;this.material=new THREE.LineBasicMaterial({color:16777215,vertexColors:THREE.FaceColors});this.type=THREE.LinePieces;this.matrixWorld=a.matrixWorld;this.matrixAutoUpdate=!1;this.pointMap=
...
b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,i);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);C.positionScreen.copy(H);C.customUpdateCallback?C.customUpdateCallback(C):C.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);B=0;for(P=C.lensFlares.length;B<P;B++)I=C.lensFlares[B],0.001<I.opacity&&0.001<I.scale&&(H.x=I.x,H.y=I.y,H.z=I.z,F=I.size*I.scale/f,z.x=F*t,z.y=F,b.uniform3f(G.screenPosition,H.x,H.y,H.z),b.uniform2f(G.scale,z.x,z.y),b.uniform1f(G.rotation,I.rotation),b.uniform1f(G.opacity,
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(l,p){var r,s,n,q,y,u,x,t,E,J=[];q=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFace===THREE.CullFaceFront?
...
!n.cameraHelper&&(n.cameraHelper=new THREE.CameraHelper(n.shadowCamera),n.shadowCamera.add(n.cameraHelper));if(n.isVirtual&&F.originalCamera==p){y=p;q=n.shadowCamera;u=n.pointsFrustum;E=n.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(x=0;8>x;x++)t=E[x],t.copy(u[x]),THREE.ShadowMapPlugin.__projector.unprojectVector(t,y),t.applyMatrix4(q.matrixWorldInverse),t.x<i.x&&(i.x=t.x),t.x>j.x&&(j.x=t.x),t.y<i.y&&(i.y=t.y),t.y>j.y&&(j.y=t.y),t.z<i.z&&(i.z=t.z),t.z>j.z&&
