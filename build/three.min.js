...
this.elements,b=a[0],c=a[4],d=a[8],e=a[12],f=a[1],g=a[5],h=a[9],i=a[13],j=a[2],l=a[6],m=a[10],n=a[14],o=a[3],p=a[7],q=a[11],a=a[15];return e*h*l*o-d*i*l*o-e*g*m*o+c*i*m*o+d*g*n*o-c*h*n*o-e*h*j*p+d*i*j*p+e*f*m*p-b*i*m*p-d*f*n*p+b*h*n*p+e*g*j*q-c*i*j*q-e*f*l*q+b*i*l*q+c*f*n*q-b*g*n*q-d*g*j*a+c*h*j*a+d*f*l*a-b*h*l*a-c*f*m*a+b*g*m*a},transpose:function(){var a=this.elements,b;b=a[1];a[1]=a[4];a[4]=b;b=a[2];a[2]=a[8];a[8]=b;b=a[6];a[6]=a[9];a[9]=b;b=a[3];a[3]=a[12];a[12]=b;b=a[7];a[7]=a[13];a[13]=b;b=
...
this.elements,c=a.elements,d=c[0],e=c[4],f=c[8],g=c[12],h=c[1],i=c[5],j=c[9],l=c[13],m=c[2],n=c[6],o=c[10],p=c[14],q=c[3],t=c[7],r=c[11],c=c[15];b[0]=j*p*t-l*o*t+l*n*r-i*p*r-j*n*c+i*o*c;b[4]=g*o*t-f*p*t-g*n*r+e*p*r+f*n*c-e*o*c;b[8]=f*l*t-g*j*t+g*i*r-e*l*r-f*i*c+e*j*c;b[12]=g*j*n-f*l*n-g*i*o+e*l*o+f*i*p-e*j*p;b[1]=l*o*q-j*p*q-l*m*r+h*p*r+j*m*c-h*o*c;b[5]=f*p*q-g*o*q+g*m*r-d*p*r-f*m*c+d*o*c;b[9]=g*j*q-f*l*q-g*h*r+d*l*r+f*h*c-d*j*c;b[13]=f*l*m-g*j*m+g*h*o-d*l*o-f*h*p+d*j*p;b[2]=i*p*q-l*n*q+l*m*t-h*p*
t-i*m*c+h*n*c;b[6]=g*n*q-e*p*q-g*m*t+d*p*t+e*m*c-d*n*c;b[10]=e*l*q-g*i*q+g*h*t-d*l*t-e*h*c+d*i*c;b[14]=g*i*m-e*l*m-g*h*n+d*l*n+e*h*p-d*i*p;b[3]=j*n*q-i*o*q-j*m*t+h*o*t+i*m*r-h*n*r;b[7]=e*o*q-f*n*q+f*m*t-d*o*t-e*m*r+d*n*r;b[11]=f*i*q-e*j*q-f*h*t+d*j*t+e*h*r-d*i*r;b[15]=e*j*m-f*i*m+f*h*n-d*j*n-e*h*o+d*i*o;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,e=a.y,f=a.z,g=Math.cos(d),d=Math.sin(d),h=Math.cos(e),e=Math.sin(e),i=Math.cos(f),f=
...
THREE.EventTarget=function(){var a={};this.addEventListener=function(b,c){void 0===a[b]&&(a[b]=[]);-1===a[b].indexOf(c)&&a[b].push(c)};this.dispatchEvent=function(b){var c=a[b.type];if(void 0!==c)for(var d=0,e=c.length;d<e;d++)c[d](b)};this.removeEventListener=function(b,c){var d=a[b].indexOf(c);-1!==d&&a[b].splice(d,1)}};THREE.Frustum=function(){this.planes=[new THREE.Vector4,new THREE.Vector4,new THREE.Vector4,new THREE.Vector4,new THREE.Vector4,new THREE.Vector4]};
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,j,l,m,n,o,p,q,t,r,C,w,s=a.faces;p=a.vertices;var E=a.normals,z=a.colors,u=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&u++;for(f=0;f<u;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(j=p.length;i<j;)l=new THREE.Vector3,l.x=p[i++]*e,l.y=p[i++]*e,l.z=p[i++]*e,d.vertices.push(l);i=0;for(j=s.length;i<j;){p=s[i++];l=p&1;h=p&2;f=p&4;g=p&8;n=p&16;m=p&32;q=p&64;p&=128;l?(t=new THREE.Face4,
t.a=s[i++],t.b=s[i++],t.c=s[i++],t.d=s[i++],l=4):(t=new THREE.Face3,t.a=s[i++],t.b=s[i++],t.c=s[i++],l=3);h&&(h=s[i++],t.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<u;f++)r=a.uvs[f],o=s[i++],w=r[2*o],o=r[2*o+1],d.faceUvs[f][h]=new THREE.UV(w,o);if(g)for(f=0;f<u;f++){r=a.uvs[f];C=[];for(g=0;g<l;g++)o=s[i++],w=r[2*o],o=r[2*o+1],C[g]=new THREE.UV(w,o);d.faceVertexUvs[f][h]=C}n&&(n=3*s[i++],g=new THREE.Vector3,g.x=E[n++],g.y=E[n++],g.z=E[n],t.normal=g);if(m)for(f=0;f<l;f++)n=3*s[i++],g=new THREE.Vector3,
g.x=E[n++],g.y=E[n++],g.z=E[n],t.vertexNormals.push(g);q&&(m=s[i++],m=new THREE.Color(z[m]),t.color=m);if(p)for(f=0;f<l;f++)m=s[i++],m=new THREE.Color(z[m]),t.vertexColors.push(m);d.faces.push(t)}if(a.skinWeights){i=0;for(j=a.skinWeights.length;i<j;i+=2)s=a.skinWeights[i],E=a.skinWeights[i+1],d.skinWeights.push(new THREE.Vector4(s,E,0,0))}if(a.skinIndices){i=0;for(j=a.skinIndices.length;i<j;i+=2)s=a.skinIndices[i],E=a.skinIndices[i+1],d.skinIndices.push(new THREE.Vector4(s,E,0,0))}d.bones=a.bones;
d.animation=a.animation;if(void 0!==a.morphTargets){i=0;for(j=a.morphTargets.length;i<j;i++){d.morphTargets[i]={};d.morphTargets[i].name=a.morphTargets[i].name;d.morphTargets[i].vertices=[];z=d.morphTargets[i].vertices;u=a.morphTargets[i].vertices;s=0;for(E=u.length;s<E;s+=3)p=new THREE.Vector3,p.x=u[s]*e,p.y=u[s+1]*e,p.z=u[s+2]*e,z.push(p)}}if(void 0!==a.morphColors){i=0;for(j=a.morphColors.length;i<j;i++){d.morphColors[i]={};d.morphColors[i].name=a.morphColors[i].name;d.morphColors[i].colors=[];
E=d.morphColors[i].colors;z=a.morphColors[i].colors;e=0;for(s=z.length;e<s;e+=3)u=new THREE.Color(16755200),u.setRGB(z[e],z[e+1],z[e+2]),E.push(u)}}d.computeCentroids();d.computeFaceNormals();a=this.initMaterials(a.materials,c);this.needsTangents(a)&&d.computeTangents();b(d,a)};
...
THREE.GeometryUtils={merge:function(a,b){var c,d,e=a.vertices.length,f=b instanceof THREE.Mesh?b.geometry:b,g=a.vertices,h=f.vertices,i=a.faces,j=f.faces,l=a.faceVertexUvs[0],f=f.faceVertexUvs[0];b instanceof THREE.Mesh&&(b.matrixAutoUpdate&&b.updateMatrix(),c=b.matrix,d=new THREE.Matrix4,d.extractRotation(c,b.scale));for(var m=0,n=h.length;m<n;m++){var o=h[m].clone();c&&c.multiplyVector3(o);g.push(o)}m=0;for(n=j.length;m<n;m++){var o=j[m],p,q,t=o.vertexNormals,r=o.vertexColors;o instanceof THREE.Face3?
p=new THREE.Face3(o.a+e,o.b+e,o.c+e):o instanceof THREE.Face4&&(p=new THREE.Face4(o.a+e,o.b+e,o.c+e,o.d+e));p.normal.copy(o.normal);d&&d.multiplyVector3(p.normal);g=0;for(h=t.length;g<h;g++)q=t[g].clone(),d&&d.multiplyVector3(q),p.vertexNormals.push(q);p.color.copy(o.color);g=0;for(h=r.length;g<h;g++)q=r[g],p.vertexColors.push(q.clone());p.materialIndex=o.materialIndex;p.centroid.copy(o.centroid);c&&c.multiplyVector3(p.centroid);i.push(p)}m=0;for(n=f.length;m<n;m++){c=f[m];d=[];g=0;for(h=c.length;g<
...
e=1):(j=j.clone(),j.lerpSelf(m,0.5),w.a=f,w.b=g,w.c=i,s.a=i,s.b=g,s.c=h,3===e.vertexNormals.length&&(f=e.vertexNormals[0].clone(),f.lerpSelf(e.vertexNormals[2],0.5),w.vertexNormals[2].copy(f),s.vertexNormals[0].copy(f)),3===e.vertexColors.length&&(f=e.vertexColors[0].clone(),f.lerpSelf(e.vertexColors[2],0.5),w.vertexColors[2].copy(f),s.vertexColors[0].copy(f)),e=2);E.push(w,s);a.vertices.push(j);f=0;for(g=a.faceVertexUvs.length;f<g;f++)a.faceVertexUvs[f].length&&(j=a.faceVertexUvs[f][c],s=j[0],h=
j[1],w=j[2],0===e?(l=s.clone(),l.lerpSelf(h,0.5),j=[s.clone(),l.clone(),w.clone()],h=[l.clone(),h.clone(),w.clone()]):1===e?(l=h.clone(),l.lerpSelf(w,0.5),j=[s.clone(),h.clone(),l.clone()],h=[l.clone(),w.clone(),s.clone()]):(l=s.clone(),l.lerpSelf(w,0.5),j=[s.clone(),h.clone(),l.clone()],h=[l.clone(),h.clone(),w.clone()]),z[f].push(j,h))}else{E.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)z[f].push(a.faceVertexUvs[f][c])}else if(f=e.a,g=e.b,h=e.c,i=e.d,j=a.vertices[f],l=a.vertices[g],m=a.vertices[h],
...
0>m-1?0:m-1,o=m+1>e-1?e-1:m+1,p=0>l-1?0:l-1,q=l+1>d-1?d-1:l+1,t=[],r=[0,0,h[4*(m*d+l)]/255*b];t.push([-1,0,h[4*(m*d+p)]/255*b]);t.push([-1,-1,h[4*(n*d+p)]/255*b]);t.push([0,-1,h[4*(n*d+l)]/255*b]);t.push([1,-1,h[4*(n*d+q)]/255*b]);t.push([1,0,h[4*(m*d+q)]/255*b]);t.push([1,1,h[4*(o*d+q)]/255*b]);t.push([0,1,h[4*(o*d+l)]/255*b]);t.push([-1,1,h[4*(o*d+p)]/255*b]);n=[];p=t.length;for(o=0;o<p;o++){var q=t[o],C=t[(o+1)%p],q=[q[0]-r[0],q[1]-r[1],q[2]-r[2]],C=[C[0]-r[0],C[1]-r[1],C[2]-r[2]];n.push(c([q[1]*
C[2]-q[2]*C[1],q[2]*C[0]-q[0]*C[2],q[0]*C[1]-q[1]*C[0]]))}t=[0,0,0];for(o=0;o<n.length;o++)t[0]+=n[o][0],t[1]+=n[o][1],t[2]+=n[o][2];t[0]/=n.length;t[1]/=n.length;t[2]/=n.length;r=4*(m*d+l);j[r]=255*((t[0]+1)/2)|0;j[r+1]=255*((t[1]+1)/2)|0;j[r+2]=255*t[2]|0;j[r+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+1]=g,e[3*h+2]=c;a=new THREE.DataTexture(e,
...
THREE.Path.prototype.getPoints=function(a,b){if(this.useSpacedPoints)return console.log("tata"),this.getSpacedPoints(a,b);var a=a||12,c=[],d,e,f,g,h,i,j,l,m,n,o,p,q;d=0;for(e=this.actions.length;d<e;d++)switch(f=this.actions[d],g=f.action,f=f.args,g){case THREE.PathActions.MOVE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.LINE_TO:c.push(new THREE.Vector2(f[0],f[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=f[2];i=f[3];m=f[0];n=f[1];0<c.length?(g=c[c.length-1],o=g.x,
p=g.y):(g=this.actions[d-1].args,o=g[g.length-2],p=g[g.length-1]);for(f=1;f<=a;f++)q=f/a,g=THREE.Shape.Utils.b2(q,o,m,h),q=THREE.Shape.Utils.b2(q,p,n,i),c.push(new THREE.Vector2(g,q));break;case THREE.PathActions.BEZIER_CURVE_TO:h=f[4];i=f[5];m=f[0];n=f[1];j=f[2];l=f[3];0<c.length?(g=c[c.length-1],o=g.x,p=g.y):(g=this.actions[d-1].args,o=g[g.length-2],p=g[g.length-1]);for(f=1;f<=a;f++)q=f/a,g=THREE.Shape.Utils.b3(q,o,m,j,h),q=THREE.Shape.Utils.b3(q,p,n,l,i),c.push(new THREE.Vector2(g,q));break;case THREE.PathActions.CSPLINE_THRU:g=
this.actions[d-1].args;q=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=a*f[0].length;q=q.concat(f[0]);q=new THREE.SplineCurve(q);for(f=1;f<=g;f++)c.push(q.getPointAt(f/g));break;case THREE.PathActions.ARC:h=f[0];i=f[1];n=f[2];j=f[3];g=f[4];m=!!f[5];o=g-j;p=2*a;for(f=1;f<=p;f++)q=f/p,m||(q=1-q),q=j+q*o,g=h+n*Math.cos(q),q=i+n*Math.sin(q),c.push(new THREE.Vector2(g,q));break;case THREE.PathActions.ELLIPSE:h=f[0];i=f[1];n=f[2];l=f[3];j=f[4];g=f[5];m=!!f[6];o=g-j;p=2*a;for(f=1;f<=p;f++)q=f/p,m||
(q=1-q),q=j+q*o,g=h+n*Math.cos(q),q=i+l*Math.sin(q),c.push(new THREE.Vector2(g,q))}d=c[c.length-1];1E-10>Math.abs(d.x-c[0].x)&&1E-10>Math.abs(d.y-c[0].y)&&c.splice(c.length-1,1);b&&c.push(c[0]);return c};
...
THREE.Shape.Utils={removeHoles:function(a,b){var c=a.concat(),d=c.concat(),e,f,g,h,i,j,l,m,n,o,p=[];for(i=0;i<b.length;i++){j=b[i];Array.prototype.push.apply(d,j);f=Number.POSITIVE_INFINITY;for(e=0;e<j.length;e++){n=j[e];o=[];for(m=0;m<c.length;m++)l=c[m],l=n.distanceToSquared(l),o.push(l),l<f&&(f=l,g=e,h=m)}e=0<=h-1?h-1:c.length-1;f=0<=g-1?g-1:j.length-1;var q=[j[g],c[h],c[e]];m=THREE.FontUtils.Triangulate.area(q);var t=[j[g],j[f],c[h]];n=THREE.FontUtils.Triangulate.area(t);o=h;l=g;h+=1;g+=-1;0>
...
THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,q){var t,r=h.widthSegments,C=h.heightSegments,w=e/2,s=f/2,E=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)t="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)t="y",C=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)t="x",r=h.depthSegments;var z=r+1,u=C+1,y=e/r,D=f/C,A=new THREE.Vector3;A[t]=0<g?1:-1;for(e=0;e<u;e++)for(f=0;f<z;f++){var I=new THREE.Vector3;I[a]=(f*y-w)*c;I[b]=(e*D-s)*d;I[t]=g;h.vertices.push(I)}for(e=
0;e<C;e++)for(f=0;f<r;f++)a=new THREE.Face4(f+z*e+E,f+z*(e+1)+E,f+1+z*(e+1)+E,f+1+z*e+E),a.normal.copy(A),a.vertexNormals.push(A.clone(),A.clone(),A.clone(),A.clone()),a.materialIndex=q,h.faces.push(a),h.faceVertexUvs[0].push([new THREE.UV(f/r,1-e/C),new THREE.UV(f/r,1-(e+1)/C),new THREE.UV((f+1)/r,1-(e+1)/C),new THREE.UV((f+1)/r,1-e/C)])}THREE.Geometry.call(this);var h=this;this.width=a;this.height=b;this.depth=c;this.widthSegments=d||1;this.heightSegments=e||1;this.depthSegments=f||1;a=this.width/
...
1]].clone()):(m=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var o=j[i][h],p=j[i+1][h],q=j[i+1][h+1],t=j[i][h+1],r=m.clone(),C=m.clone(),w=n.clone(),s=n.clone(),E=l[i][h].clone(),z=l[i+1][h].clone(),u=l[i+1][h+1].clone(),y=l[i][h+1].clone();this.faces.push(new THREE.Face4(o,p,q,t,[r,C,w,s]));this.faceVertexUvs[0].push([E,z,u,y])}}if(!f&&0<a){this.vertices.push(new THREE.Vector3(0,
g,0));for(h=0;h<d;h++)o=j[0][h],p=j[0][h+1],q=this.vertices.length-1,r=new THREE.Vector3(0,1,0),C=new THREE.Vector3(0,1,0),w=new THREE.Vector3(0,1,0),E=l[0][h].clone(),z=l[0][h+1].clone(),u=new THREE.UV(z.u,0),this.faces.push(new THREE.Face3(o,p,q,[r,C,w])),this.faceVertexUvs[0].push([E,z,u])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)o=j[i][h+1],p=j[i][h],q=this.vertices.length-1,r=new THREE.Vector3(0,-1,0),C=new THREE.Vector3(0,-1,0),w=new THREE.Vector3(0,-1,0),E=
l[i][h+1].clone(),z=l[i][h].clone(),u=new THREE.UV(z.u,1),this.faces.push(new THREE.Face3(o,p,q,[r,C,w])),this.faceVertexUvs[0].push([E,z,u])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};
...
Math.cos(f+m*g);n.z=this.radius*Math.sin(d+l*e)*Math.sin(f+m*g);this.vertices.push(n);i.push(this.vertices.length-1);j.push(new THREE.UV(l,1-m))}c.push(i);h.push(j)}for(b=0;b<this.heightSegments;b++)for(a=0;a<this.widthSegments;a++){var d=c[b][a+1],e=c[b][a],f=c[b+1][a],g=c[b+1][a+1],i=this.vertices[d].clone().normalize(),j=this.vertices[e].clone().normalize(),l=this.vertices[f].clone().normalize(),m=this.vertices[g].clone().normalize(),n=h[b][a+1].clone(),o=h[b][a].clone(),p=h[b+1][a].clone(),q=
h[b+1][a+1].clone();Math.abs(this.vertices[d].y)===this.radius?(this.faces.push(new THREE.Face3(d,f,g,[i,l,m])),this.faceVertexUvs[0].push([n,p,q])):Math.abs(this.vertices[f].y)===this.radius?(this.faces.push(new THREE.Face3(d,e,f,[i,j,l])),this.faceVertexUvs[0].push([n,o,p])):(this.faces.push(new THREE.Face4(d,e,f,g,[i,j,l,m])),this.faceVertexUvs[0].push([n,o,p,q]))}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:this.radius}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.ParametricGeometry=function(a,b,c,d){THREE.Geometry.call(this);var e=this.vertices,f=this.faces,g=this.faceVertexUvs[0],d=void 0===d?!1:d,h,i,j,l,m=b+1;for(h=0;h<=c;h++){l=h/c;for(i=0;i<=b;i++)j=i/b,j=a(j,l),e.push(j)}var n,o,p,q;for(h=0;h<c;h++)for(i=0;i<b;i++)a=h*m+i,e=h*m+i+1,l=(h+1)*m+i,j=(h+1)*m+i+1,n=new THREE.UV(i/b,h/c),o=new THREE.UV((i+1)/b,h/c),p=new THREE.UV(i/b,(h+1)/c),q=new THREE.UV((i+1)/b,(h+1)/c),d?(f.push(new THREE.Face3(a,e,l)),f.push(new THREE.Face3(e,j,l)),g.push([n,o,
p]),g.push([o,q,p])):(f.push(new THREE.Face4(a,e,j,l)),g.push([n,o,q,p]));this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.ParametricGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.ConvexGeometry=function(a){function b(a){var b=a.length();return new THREE.UV(a.x/b,a.y/b)}THREE.Geometry.call(this);for(var c=[[0,1,2],[0,2,1]],d=3;d<a.length;d++){var e=d,f=a[e].clone(),g=f.length();f.x+=g*2E-6*(Math.random()-0.5);f.y+=g*2E-6*(Math.random()-0.5);f.z+=g*2E-6*(Math.random()-0.5);for(var g=[],h=0;h<c.length;){var i=c[h],j=f,l=a[i[0]],m;m=l;var n=a[i[1]],o=a[i[2]],p=new THREE.Vector3,q=new THREE.Vector3;p.sub(o,n);q.sub(m,n);p.crossSelf(q);p.normalize();m=p;l=m.dot(l);if(m.dot(j)>=
...
C=C.shadowCascadeFarZ[w];s=s.pointsFrustum;s[0].z=r;s[1].z=r;s[2].z=r;s[3].z=r;s[4].z=C;s[5].z=C;s[6].z=C;s[7].z=C;E[q]=z;q++}else E[q]=p,q++;n=0;for(o=E.length;n<o;n++){p=E[n];p.shadowMap||(p.shadowMap=new THREE.WebGLRenderTarget(p.shadowMapWidth,p.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat}),p.shadowMapSize=new THREE.Vector2(p.shadowMapWidth,p.shadowMapHeight),p.shadowMatrix=new THREE.Matrix4);if(!p.shadowCamera){if(p instanceof THREE.SpotLight)p.shadowCamera=
...
b.getUniformLocation(h,"modelViewMatrix");j.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");j.fogType=b.getUniformLocation(h,"fogType");j.fogDensity=b.getUniformLocation(h,"fogDensity");j.fogNear=b.getUniformLocation(h,"fogNear");j.fogFar=b.getUniformLocation(h,"fogFar");j.fogColor=b.getUniformLocation(h,"fogColor");j.alphaTest=b.getUniformLocation(h,"alphaTest")};this.render=function(d,e,n,o){var p=d.__webglSprites,q=p.length;if(q){var t=i,r=j,C=o/n,n=0.5*n,w=0.5*o;b.useProgram(h);b.enableVertexAttribArray(t.position);
b.enableVertexAttribArray(t.uv);b.disable(b.CULL_FACE);b.enable(b.BLEND);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(t.position,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(t.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.uniformMatrix4fv(r.projectionMatrix,!1,e._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(r.map,0);var s=t=0,E=d.fog;E?(b.uniform3f(r.fogColor,E.color.r,E.color.g,E.color.b),E instanceof THREE.Fog?(b.uniform1f(r.fogNear,E.near),b.uniform1f(r.fogFar,
E.far),b.uniform1i(r.fogType,1),s=t=1):E instanceof THREE.FogExp2&&(b.uniform1f(r.fogDensity,E.density),b.uniform1i(r.fogType,2),s=t=2)):(b.uniform1i(r.fogType,0),s=t=0);for(var z,u,y=[],E=0;E<q;E++)z=p[E],u=z.material,z.visible&&0!==u.opacity&&(u.useScreenCoordinates?z.z=-z.position.z:(z._modelViewMatrix.multiply(e.matrixWorldInverse,z.matrixWorld),z.z=-z._modelViewMatrix.elements[14]));p.sort(a);for(E=0;E<q;E++)if(z=p[E],u=z.material,z.visible&&0!==u.opacity&&u.map&&u.map.image&&u.map.image.width)b.uniform1f(r.alphaTest,
u.alphaTest),u.useScreenCoordinates?(b.uniform1i(r.useScreenCoordinates,1),b.uniform3f(r.screenPosition,(z.position.x-n)/n,(w-z.position.y)/w,Math.max(0,Math.min(1,z.position.z)))):(b.uniform1i(r.useScreenCoordinates,0),b.uniform1i(r.sizeAttenuation,u.sizeAttenuation?1:0),b.uniformMatrix4fv(r.modelViewMatrix,!1,z._modelViewMatrix.elements)),e=d.fog&&u.fog?s:0,t!==e&&(b.uniform1i(r.fogType,e),t=e),e=1/(u.scaleByViewport?o:1),y[0]=e*C*z.scale.x,y[1]=e*z.scale.y,b.uniform2f(r.uvScale,u.uvScale.x,u.uvScale.y),
b.uniform2f(r.uvOffset,u.uvOffset.x,u.uvOffset.y),b.uniform2f(r.alignment,u.alignment.x,u.alignment.y),b.uniform1f(r.opacity,u.opacity),b.uniform3f(r.color,u.color.r,u.color.g,u.color.b),b.uniform1f(r.rotation,z.rotation),b.uniform2fv(r.scale,y),c.setBlending(u.blending,u.blendEquation,u.blendSrc,u.blendDst),c.setDepthTest(u.depthTest),c.setDepthWrite(u.depthWrite),c.setTexture(u.map,0),b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.enable(b.CULL_FACE)}}};
