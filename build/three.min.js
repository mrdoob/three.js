...
0.99999){this.y=Math.atan2(g,d);this.z=Math.atan2(h,i)}else{this.y=Math.atan2(-j,e);this.z=0}}else if(b==="ZXY"){this.x=Math.asin(c(n));if(Math.abs(n)<0.99999){this.y=Math.atan2(-j,d);this.z=Math.atan2(-f,i)}else{this.y=0;this.z=Math.atan2(g,e)}}else if(b==="ZYX"){this.y=Math.asin(-c(j));if(Math.abs(j)<0.99999){this.x=Math.atan2(n,d);this.z=Math.atan2(h,e)}else{this.x=0;this.z=Math.atan2(-f,i)}}else if(b==="YZX"){this.z=Math.asin(c(h));if(Math.abs(h)<0.99999){this.x=Math.atan2(-l,i);this.y=Math.atan2(-j,
e)}else{this.x=0;this.y=Math.atan2(j,d)}}else if(b==="XZY"){this.z=Math.asin(-c(f));if(Math.abs(f)<0.99999){this.x=Math.atan2(n,i);this.y=Math.atan2(g,e)}else{this.x=Math.atan2(-g,d);this.y=0}}return this},setEulerFromQuaternion:function(a,b){function c(a){return Math.min(Math.max(a,-1),1)}var d=a.x*a.x,e=a.y*a.y,f=a.z*a.z,g=a.w*a.w;if(b===void 0||b==="XYZ"){this.x=Math.atan2(2*(a.x*a.w-a.y*a.z),g-d-e+f);this.y=Math.asin(c(2*(a.x*a.z+a.y*a.w)));this.z=Math.atan2(2*(a.z*a.w-a.x*a.y),g+d-e-f)}else if(b===
...
a.z+b[15]*a.w:1;return c},determinant:function(){var a=this.elements,b=a[0],c=a[4],d=a[8],e=a[12],f=a[1],g=a[5],h=a[9],i=a[13],l=a[2],j=a[6],n=a[10],m=a[14],q=a[3],p=a[7],o=a[11],a=a[15];return e*h*j*q-d*i*j*q-e*g*n*q+c*i*n*q+d*g*m*q-c*h*m*q-e*h*l*p+d*i*l*p+e*f*n*p-b*i*n*p-d*f*m*p+b*h*m*p+e*g*l*o-c*i*l*o-e*f*j*o+b*i*j*o+c*f*m*o-b*g*m*o-d*g*l*a+c*h*l*a+d*f*j*a-b*h*j*a-c*f*n*a+b*g*n*a},transpose:function(){var a=this.elements,b;b=a[1];a[1]=a[4];a[4]=b;b=a[2];a[2]=a[8];a[8]=b;b=a[6];a[6]=a[9];a[9]=b;
...
a[9],a[10])},getInverse:function(a){var b=this.elements,c=a.elements,d=c[0],e=c[4],f=c[8],g=c[12],h=c[1],i=c[5],l=c[9],j=c[13],n=c[2],m=c[6],q=c[10],p=c[14],o=c[3],r=c[7],t=c[11],c=c[15];b[0]=l*p*r-j*q*r+j*m*t-i*p*t-l*m*c+i*q*c;b[4]=g*q*r-f*p*r-g*m*t+e*p*t+f*m*c-e*q*c;b[8]=f*j*r-g*l*r+g*i*t-e*j*t-f*i*c+e*l*c;b[12]=g*l*m-f*j*m-g*i*q+e*j*q+f*i*p-e*l*p;b[1]=j*q*o-l*p*o-j*n*t+h*p*t+l*n*c-h*q*c;b[5]=f*p*o-g*q*o+g*n*t-d*p*t-f*n*c+d*q*c;b[9]=g*l*o-f*j*o-g*h*t+d*j*t+f*h*c-d*l*c;b[13]=f*j*n-g*l*n+g*h*q-d*
j*q-f*h*p+d*l*p;b[2]=i*p*o-j*m*o+j*n*r-h*p*r-i*n*c+h*m*c;b[6]=g*m*o-e*p*o-g*n*r+d*p*r+e*n*c-d*m*c;b[10]=e*j*o-g*i*o+g*h*r-d*j*r-e*h*c+d*i*c;b[14]=g*i*n-e*j*n-g*h*m+d*j*m+e*h*p-d*i*p;b[3]=l*m*o-i*q*o-l*n*r+h*q*r+i*n*t-h*m*t;b[7]=e*q*o-f*m*o+f*n*r-d*q*r-e*n*t+d*m*t;b[11]=f*i*o-e*l*o-f*h*r+d*l*r+e*h*t-d*i*t;b[15]=e*l*n-f*i*n+f*h*m-d*l*m-e*h*q+d*i*q;this.multiplyScalar(1/a.determinant());return this},setRotationFromEuler:function(a,b){var c=this.elements,d=a.x,e=a.y,f=a.z,g=Math.cos(d),d=Math.sin(d),
h=Math.cos(e),e=Math.sin(e),i=Math.cos(f),f=Math.sin(f);if(b===void 0||b==="XYZ"){var l=g*i,j=g*f,n=d*i,m=d*f;c[0]=h*i;c[4]=-h*f;c[8]=e;c[1]=j+n*e;c[5]=l-m*e;c[9]=-d*h;c[2]=m-l*e;c[6]=n+j*e;c[10]=g*h}else if(b==="YXZ"){l=h*i;j=h*f;n=e*i;m=e*f;c[0]=l+m*d;c[4]=n*d-j;c[8]=g*e;c[1]=g*f;c[5]=g*i;c[9]=-d;c[2]=j*d-n;c[6]=m+l*d;c[10]=g*h}else if(b==="ZXY"){l=h*i;j=h*f;n=e*i;m=e*f;c[0]=l-m*d;c[4]=-g*f;c[8]=n+j*d;c[1]=j+n*d;c[5]=g*i;c[9]=m-l*d;c[2]=-g*e;c[6]=d;c[10]=g*h}else if(b==="ZYX"){l=g*i;j=g*f;n=d*i;
m=d*f;c[0]=h*i;c[4]=n*e-j;c[8]=l*e+m;c[1]=h*f;c[5]=m*e+l;c[9]=j*e-n;c[2]=-e;c[6]=d*h;c[10]=g*h}else if(b==="YZX"){l=g*h;j=g*e;n=d*h;m=d*e;c[0]=h*i;c[4]=m-l*f;c[8]=n*f+j;c[1]=f;c[5]=g*i;c[9]=-d*i;c[2]=-e*i;c[6]=j*f+n;c[10]=l-m*f}else if(b==="XZY"){l=g*h;j=g*e;n=d*h;m=d*e;c[0]=h*i;c[4]=-f;c[8]=e*i;c[1]=l*f+m;c[5]=g*i;c[9]=j*f-n;c[2]=n*f-j;c[6]=d*i;c[10]=m*f+l}return this},setRotationFromQuaternion:function(a){var b=this.elements,c=a.x,d=a.y,e=a.z,f=a.w,g=c+c,h=d+d,i=e+e,a=c*g,l=c*h,c=c*i,j=d*h,d=d*
...
void 0)i.side=THREE.BackSide;if(a.doubleSided!==void 0)i.side=THREE.DoubleSide;if(a.wireframe!==void 0)i.wireframe=a.wireframe;if(a.vertexColors!==void 0)if(a.vertexColors==="face")i.vertexColors=THREE.FaceColors;else if(a.vertexColors)i.vertexColors=THREE.VertexColors;if(a.colorDiffuse)i.color=f(a.colorDiffuse);else if(a.DbgColor)i.color=a.DbgColor;if(a.colorSpecular)i.specular=f(a.colorSpecular);if(a.colorAmbient)i.ambient=f(a.colorAmbient);if(a.transparency)i.opacity=a.transparency;if(a.specularCoef)i.shininess=
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=a.scale!==void 0?1/a.scale:1;this.initMaterials(d,a.materials,c);var f,g,h,i,l,j,n,m,q,p,o,r,t,u,w=a.faces;q=a.vertices;var s=a.normals,B=a.colors,v=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&v++;for(f=0;f<v;f++){d.faceUvs[f]=[];d.faceVertexUvs[f]=[]}c=0;for(i=q.length;c<i;){l=new THREE.Vector3;l.x=q[c++]*e;l.y=q[c++]*e;l.z=q[c++]*e;d.vertices.push(l)}c=0;for(i=w.length;c<i;){q=w[c++];l=q&1;h=q&2;f=q&4;g=q&8;n=q&
16;j=q&32;p=q&64;q=q&128;if(l){o=new THREE.Face4;o.a=w[c++];o.b=w[c++];o.c=w[c++];o.d=w[c++];l=4}else{o=new THREE.Face3;o.a=w[c++];o.b=w[c++];o.c=w[c++];l=3}if(h){h=w[c++];o.materialIndex=h}h=d.faces.length;if(f)for(f=0;f<v;f++){r=a.uvs[f];m=w[c++];u=r[m*2];m=r[m*2+1];d.faceUvs[f][h]=new THREE.UV(u,m)}if(g)for(f=0;f<v;f++){r=a.uvs[f];t=[];for(g=0;g<l;g++){m=w[c++];u=r[m*2];m=r[m*2+1];t[g]=new THREE.UV(u,m)}d.faceVertexUvs[f][h]=t}if(n){n=w[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];
o.normal=g}if(j)for(f=0;f<l;f++){n=w[c++]*3;g=new THREE.Vector3;g.x=s[n++];g.y=s[n++];g.z=s[n];o.vertexNormals.push(g)}if(p){j=w[c++];j=new THREE.Color(B[j]);o.color=j}if(q)for(f=0;f<l;f++){j=w[c++];j=new THREE.Color(B[j]);o.vertexColors.push(j)}d.faces.push(o)}if(a.skinWeights){c=0;for(i=a.skinWeights.length;c<i;c=c+2){w=a.skinWeights[c];s=a.skinWeights[c+1];d.skinWeights.push(new THREE.Vector4(w,s,0,0))}}if(a.skinIndices){c=0;for(i=a.skinIndices.length;c<i;c=c+2){w=a.skinIndices[c];s=a.skinIndices[c+
1];d.skinIndices.push(new THREE.Vector4(w,s,0,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets!==void 0){c=0;for(i=a.morphTargets.length;c<i;c++){d.morphTargets[c]={};d.morphTargets[c].name=a.morphTargets[c].name;d.morphTargets[c].vertices=[];B=d.morphTargets[c].vertices;v=a.morphTargets[c].vertices;w=0;for(s=v.length;w<s;w=w+3){q=new THREE.Vector3;q.x=v[w]*e;q.y=v[w+1]*e;q.z=v[w+2]*e;B.push(q)}}}if(a.morphColors!==void 0){c=0;for(i=a.morphColors.length;c<i;c++){d.morphColors[c]={};
d.morphColors[c].name=a.morphColors[c].name;d.morphColors[c].colors=[];s=d.morphColors[c].colors;B=a.morphColors[c].colors;e=0;for(w=B.length;e<w;e=e+3){v=new THREE.Color(16755200);v.setRGB(B[e],B[e+1],B[e+2]);s.push(v)}}}d.computeCentroids();d.computeFaceNormals();this.hasNormals(d)&&d.computeTangents();b(d)};THREE.GeometryLoader=function(){THREE.EventTarget.call(this);this.path=this.crossOrigin=null};
...
255|0;Pa[12]=d.r*255|0;Pa[13]=d.g*255|0;Pa[14]=d.b*255|0;bb.putImageData(gb,0,0);hb.drawImage(ab,0,0);return Qa}function fc(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function jc(a){a=(a+1)*0.5;return a<0?0:a>1?1:a}function sb(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;if(e!==0){e=1/Math.sqrt(e);c=c*e;d=d*e;b.x=b.x+c;b.y=b.y+d;a.x=a.x-c;a.y=a.y-d}}if(k instanceof THREE.Camera===false)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{var Vb,Ec,B,X;this.autoClear===
true?this.clear():o.setTransform(1,0,0,-1,q,p);f.info.render.vertices=0;f.info.render.faces=0;g=l.projectScene(a,k,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;qb=i.length>0;if(qb===true){Ga.setRGB(0,0,0);$a.setRGB(0,0,0);rb.setRGB(0,0,0);Vb=0;for(Ec=i.length;Vb<Ec;Vb++){X=i[Vb];var ca=X.color;if(X instanceof THREE.AmbientLight){Ga.r=Ga.r+ca.r;Ga.g=Ga.g+ca.g;Ga.b=Ga.b+ca.b}else if(X instanceof THREE.DirectionalLight){$a.r=$a.r+ca.r;$a.g=$a.g+ca.g;$a.b=$a.b+ca.b}else if(X instanceof
...
c,d;for(b in a.attributes){d=b==="index"?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;c=a.attributes[b];c.buffer=k.createBuffer();k.bindBuffer(d,c.buffer);k.bufferData(d,c.array,k.STATIC_DRAW)}}function g(a,b,c){var d,e,f,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,o=a.verticesNeedUpdate,p=a.colorsNeedUpdate,q=a.__webglCustomAttributesList;if(c.sortParticles){gb.copy(bb);gb.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){e=h[d];Pa.copy(e);gb.multiplyVector3(Pa);
n[d]=[Pa.z,d]}n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){e=h[n[d][1]];f=d*3;l[f]=e.x;l[f+1]=e.y;l[f+2]=e.z}for(d=0;d<j;d++){f=d*3;e=i[n[d][1]];m[f]=e.r;m[f+1]=e.g;m[f+2]=e.b}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.boundTo===void 0||h.boundTo==="vertices"){f=0;e=h.value.length;if(h.size===1)for(d=0;d<e;d++){g=n[d][1];h.array[d]=h.value[g]}else if(h.size===2)for(d=0;d<e;d++){g=n[d][1];g=h.value[g];h.array[f]=g.x;h.array[f+1]=g.y;f=f+2}else if(h.size===3)if(h.type==="c")for(d=0;d<
e;d++){g=n[d][1];g=h.value[g];h.array[f]=g.r;h.array[f+1]=g.g;h.array[f+2]=g.b;f=f+3}else for(d=0;d<e;d++){g=n[d][1];g=h.value[g];h.array[f]=g.x;h.array[f+1]=g.y;h.array[f+2]=g.z;f=f+3}else if(h.size===4)for(d=0;d<e;d++){g=n[d][1];g=h.value[g];h.array[f]=g.x;h.array[f+1]=g.y;h.array[f+2]=g.z;h.array[f+3]=g.w;f=f+4}}}}}else{if(o)for(d=0;d<g;d++){e=h[d];f=d*3;l[f]=e.x;l[f+1]=e.y;l[f+2]=e.z}if(p)for(d=0;d<j;d++){e=i[d];f=d*3;m[f]=e.r;m[f+1]=e.g;m[f+2]=e.b}if(q){i=0;for(j=q.length;i<j;i++){h=q[i];if(h.needsUpdate&&
...
true}else m instanceof THREE.BufferGeometry&&f(m)}}if(!i.__webglActive){if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.BufferGeometry)q(j.__webglObjects,m,i);else for(l in m.geometryGroups){n=m.geometryGroups[l];q(j.__webglObjects,n,i)}}else if(i instanceof THREE.Ribbon||i instanceof THREE.Line||i instanceof THREE.ParticleSystem){m=i.geometry;q(j.__webglObjects,m,i)}else i instanceof THREE.ImmediateRenderObject||i.immediateRenderCallback?j.__webglObjectsImmediate.push({object:i,opaque:null,
...
THREE.GeometryUtils={merge:function(a,b){for(var c,d,e=a.vertices.length,f=b instanceof THREE.Mesh?b.geometry:b,g=a.vertices,h=f.vertices,i=a.faces,l=f.faces,j=a.faceVertexUvs[0],n=f.faceVertexUvs[0],m={},q=0;q<a.materials.length;q++)m[a.materials[q].id]=q;if(b instanceof THREE.Mesh){b.matrixAutoUpdate&&b.updateMatrix();c=b.matrix;d=new THREE.Matrix4;d.extractRotation(c,b.scale)}for(var q=0,p=h.length;q<p;q++){var o=h[q].clone();c&&c.multiplyVector3(o);g.push(o)}q=0;for(p=l.length;q<p;q++){var g=
l[q],r,t,u=g.vertexNormals,w=g.vertexColors;g instanceof THREE.Face3?r=new THREE.Face3(g.a+e,g.b+e,g.c+e):g instanceof THREE.Face4&&(r=new THREE.Face4(g.a+e,g.b+e,g.c+e,g.d+e));r.normal.copy(g.normal);d&&d.multiplyVector3(r.normal);h=0;for(o=u.length;h<o;h++){t=u[h].clone();d&&d.multiplyVector3(t);r.vertexNormals.push(t)}r.color.copy(g.color);h=0;for(o=w.length;h<o;h++){t=w[h];r.vertexColors.push(t.clone())}if(g.materialIndex!==void 0){h=f.materials[g.materialIndex];o=h.id;w=m[o];if(w===void 0){w=
...
c;b++)h[b]=[];b=0;for(c=a.faces.length;b<c;b++){d=a.faces[b];if(d instanceof THREE.Face4){e=d.a;var i=d.b,l=d.c,j=d.d,n=new THREE.Face3,m=new THREE.Face3;n.color.copy(d.color);m.color.copy(d.color);n.materialIndex=d.materialIndex;m.materialIndex=d.materialIndex;n.a=e;n.b=i;n.c=j;m.a=i;m.b=l;m.c=j;if(d.vertexColors.length===4){n.vertexColors[0]=d.vertexColors[0].clone();n.vertexColors[1]=d.vertexColors[1].clone();n.vertexColors[2]=d.vertexColors[3].clone();m.vertexColors[0]=d.vertexColors[1].clone();
m.vertexColors[1]=d.vertexColors[2].clone();m.vertexColors[2]=d.vertexColors[3].clone()}f.push(n,m);d=0;for(e=a.faceVertexUvs.length;d<e;d++)if(a.faceVertexUvs[d].length){n=a.faceVertexUvs[d][b];i=n[1];l=n[2];j=n[3];n=[n[0].clone(),i.clone(),j.clone()];i=[i.clone(),l.clone(),j.clone()];h[d].push(n,i)}d=0;for(e=a.faceUvs.length;d<e;d++)if(a.faceUvs[d].length){i=a.faceUvs[d][b];g[d].push(i,i)}}else{f.push(d);d=0;for(e=a.faceUvs.length;d<e;d++)g[d].push(a.faceUvs[d][b]);d=0;for(e=a.faceVertexUvs.length;d<
...
f.a;h=f.b;i=f.c;g=a.vertices[g];h=a.vertices[h];i=a.vertices[i];b.push(g.clone());b.push(h.clone());b.push(i.clone());f.a=e;f.b=e+1;f.c=e+2}}a.vertices=b;delete a.__tmpVertices},tessellate:function(a,b){var c,d,e,f,g,h,i,l,j,n,m,q,p,o,r,t,u,w,s,B=[],v=[];c=0;for(d=a.faceVertexUvs.length;c<d;c++)v[c]=[];c=0;for(d=a.faces.length;c<d;c++){e=a.faces[c];if(e instanceof THREE.Face3){f=e.a;g=e.b;h=e.c;l=a.vertices[f];j=a.vertices[g];n=a.vertices[h];q=l.distanceTo(j);p=j.distanceTo(n);m=l.distanceTo(n);if(q>
b||p>b||m>b){i=a.vertices.length;w=e.clone();s=e.clone();if(q>=p&&q>=m){l=l.clone();l.lerpSelf(j,0.5);w.a=f;w.b=i;w.c=h;s.a=i;s.b=g;s.c=h;if(e.vertexNormals.length===3){f=e.vertexNormals[0].clone();f.lerpSelf(e.vertexNormals[1],0.5);w.vertexNormals[1].copy(f);s.vertexNormals[0].copy(f)}if(e.vertexColors.length===3){f=e.vertexColors[0].clone();f.lerpSelf(e.vertexColors[1],0.5);w.vertexColors[1].copy(f);s.vertexColors[0].copy(f)}e=0}else if(p>=q&&p>=m){l=j.clone();l.lerpSelf(n,0.5);w.a=f;w.b=g;w.c=
...
l.lerpSelf(n,0.5);w.a=f;w.b=g;w.c=i;s.a=i;s.b=g;s.c=h;if(e.vertexNormals.length===3){f=e.vertexNormals[0].clone();f.lerpSelf(e.vertexNormals[2],0.5);w.vertexNormals[2].copy(f);s.vertexNormals[0].copy(f)}if(e.vertexColors.length===3){f=e.vertexColors[0].clone();f.lerpSelf(e.vertexColors[2],0.5);w.vertexColors[2].copy(f);s.vertexColors[0].copy(f)}e=2}B.push(w,s);a.vertices.push(l);f=0;for(g=a.faceVertexUvs.length;f<g;f++)if(a.faceVertexUvs[f].length){l=a.faceVertexUvs[f][c];s=l[0];h=l[1];w=l[2];if(e===
0){j=s.clone();j.lerpSelf(h,0.5);l=[s.clone(),j.clone(),w.clone()];h=[j.clone(),h.clone(),w.clone()]}else if(e===1){j=h.clone();j.lerpSelf(w,0.5);l=[s.clone(),h.clone(),j.clone()];h=[j.clone(),w.clone(),s.clone()]}else{j=s.clone();j.lerpSelf(w,0.5);l=[s.clone(),h.clone(),j.clone()];h=[j.clone(),h.clone(),w.clone()]}v[f].push(l,h)}}else{B.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)v[f].push(a.faceVertexUvs[f][c])}}else{f=e.a;g=e.b;h=e.c;i=e.d;l=a.vertices[f];j=a.vertices[g];n=a.vertices[h];m=
a.vertices[i];q=l.distanceTo(j);p=j.distanceTo(n);o=n.distanceTo(m);r=l.distanceTo(m);if(q>b||p>b||o>b||r>b){t=a.vertices.length;u=a.vertices.length+1;w=e.clone();s=e.clone();if(q>=p&&q>=o&&q>=r||o>=p&&o>=q&&o>=r){q=l.clone();q.lerpSelf(j,0.5);j=n.clone();j.lerpSelf(m,0.5);w.a=f;w.b=t;w.c=u;w.d=i;s.a=t;s.b=g;s.c=h;s.d=u;if(e.vertexNormals.length===4){f=e.vertexNormals[0].clone();f.lerpSelf(e.vertexNormals[1],0.5);g=e.vertexNormals[2].clone();g.lerpSelf(e.vertexNormals[3],0.5);w.vertexNormals[1].copy(f);
w.vertexNormals[2].copy(g);s.vertexNormals[0].copy(f);s.vertexNormals[3].copy(g)}if(e.vertexColors.length===4){f=e.vertexColors[0].clone();f.lerpSelf(e.vertexColors[1],0.5);g=e.vertexColors[2].clone();g.lerpSelf(e.vertexColors[3],0.5);w.vertexColors[1].copy(f);w.vertexColors[2].copy(g);s.vertexColors[0].copy(f);s.vertexColors[3].copy(g)}e=0}else{q=j.clone();q.lerpSelf(n,0.5);j=m.clone();j.lerpSelf(l,0.5);w.a=f;w.b=g;w.c=t;w.d=u;s.a=u;s.b=t;s.c=h;s.d=i;if(e.vertexNormals.length===4){f=e.vertexNormals[1].clone();
f.lerpSelf(e.vertexNormals[2],0.5);g=e.vertexNormals[3].clone();g.lerpSelf(e.vertexNormals[0],0.5);w.vertexNormals[2].copy(f);w.vertexNormals[3].copy(g);s.vertexNormals[0].copy(g);s.vertexNormals[1].copy(f)}if(e.vertexColors.length===4){f=e.vertexColors[1].clone();f.lerpSelf(e.vertexColors[2],0.5);g=e.vertexColors[3].clone();g.lerpSelf(e.vertexColors[0],0.5);w.vertexColors[2].copy(f);w.vertexColors[3].copy(g);s.vertexColors[0].copy(g);s.vertexColors[1].copy(f)}e=1}B.push(w,s);a.vertices.push(q,j);
f=0;for(g=a.faceVertexUvs.length;f<g;f++)if(a.faceVertexUvs[f].length){l=a.faceVertexUvs[f][c];s=l[0];h=l[1];w=l[2];l=l[3];if(e===0){j=s.clone();j.lerpSelf(h,0.5);n=w.clone();n.lerpSelf(l,0.5);s=[s.clone(),j.clone(),n.clone(),l.clone()];h=[j.clone(),h.clone(),w.clone(),n.clone()]}else{j=h.clone();j.lerpSelf(w,0.5);n=l.clone();n.lerpSelf(s,0.5);s=[s.clone(),h.clone(),j.clone(),n.clone()];h=[n.clone(),j.clone(),w.clone(),l.clone()]}v[f].push(s,h)}}else{B.push(e);f=0;for(g=a.faceVertexUvs.length;f<g;f++)v[f].push(a.faceVertexUvs[f][c])}}}a.faces=
...
h,l),width:f,height:g};d.mipmaps.push(j);h=h+l;f=Math.max(f*0.5,1);g=Math.max(g*0.5,1)}return d},getNormalMap:function(a,b){var c=function(a){var b=Math.sqrt(a[0]*a[0]+a[1]*a[1]+a[2]*a[2]);return[a[0]/b,a[1]/b,a[2]/b]},b=b|1,d=a.width,e=a.height,f=document.createElement("canvas");f.width=d;f.height=e;var g=f.getContext("2d");g.drawImage(a,0,0);for(var h=g.getImageData(0,0,d,e).data,i=g.createImageData(d,e),l=i.data,j=0;j<d;j++)for(var n=0;n<e;n++){var m=n-1<0?0:n-1,q=n+1>e-1?e-1:n+1,p=j-1<0?0:j-1,
...
o[1]*u[0]]))}r=[0,0,0];for(q=0;q<m.length;q++){r[0]=r[0]+m[q][0];r[1]=r[1]+m[q][1];r[2]=r[2]+m[q][2]}r[0]=r[0]/m.length;r[1]=r[1]/m.length;r[2]=r[2]/m.length;t=(n*d+j)*4;l[t]=(r[0]+1)/2*255|0;l[t+1]=(r[1]+1)/2*255|0;l[t+2]=r[2]*255|0;l[t+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(c.r*255),g=Math.floor(c.g*255),c=Math.floor(c.b*255),h=0;h<d;h++){e[h*3]=f;e[h*3+1]=g;e[h*3+2]=c}a=new THREE.DataTexture(e,a,b,THREE.RGBFormat);
...
0,e=String(a).split(""),f=e.length,g=[],a=0;a<f;a++){var h=new THREE.Path,h=this.extractGlyphPoints(e[a],b,c,d,h),d=d+h.offset;g.push(h.path)}return{paths:g,offset:d/2}},extractGlyphPoints:function(a,b,c,d,e){var f=[],g,h,i,l,j,n,m,q,p,o,r,t=b.glyphs[a]||b.glyphs["?"];if(t){if(t.o){b=t._cachedOutline||(t._cachedOutline=t.o.split(" "));l=b.length;for(a=0;a<l;){i=b[a++];switch(i){case "m":i=b[a++]*c+d;j=b[a++]*c;e.moveTo(i,j);break;case "l":i=b[a++]*c+d;j=b[a++]*c;e.lineTo(i,j);break;case "q":i=b[a++]*
...
THREE.CurvePath.prototype.getBoundingBox=function(){var a=this.getPoints(),b,c,d,e,f,g;b=c=Number.NEGATIVE_INFINITY;e=f=Number.POSITIVE_INFINITY;var h,i,l,j,n=a[0]instanceof THREE.Vector3;j=n?new THREE.Vector3:new THREE.Vector2;i=0;for(l=a.length;i<l;i++){h=a[i];if(h.x>b)b=h.x;else if(h.x<e)e=h.x;if(h.y>c)c=h.y;else if(h.y<f)f=h.y;if(n)if(h.z>d)d=h.z;else if(h.z<g)g=h.z;j.addSelf(h)}a={minX:e,minY:f,maxX:b,maxY:c,centroid:j.divideScalar(l)};if(n){a.maxZ=d;a.minZ=g}return a};
...
THREE.Shape.Utils={removeHoles:function(a,b){var c=a.concat(),d=c.concat(),e,f,g,h,i,l,j,n,m,q,p=[];for(i=0;i<b.length;i++){l=b[i];Array.prototype.push.apply(d,l);f=Number.POSITIVE_INFINITY;for(e=0;e<l.length;e++){m=l[e];q=[];for(n=0;n<c.length;n++){j=c[n];j=m.distanceToSquared(j);q.push(j);if(j<f){f=j;g=e;h=n}}}e=h-1>=0?h-1:c.length-1;f=g-1>=0?g-1:l.length-1;var o=[l[g],c[h],c[e]];n=THREE.FontUtils.Triangulate.area(o);var r=[l[g],l[f],c[h]];m=THREE.FontUtils.Triangulate.area(r);q=h;j=g;h=h+1;g=g+
-1;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+l.length);g=g%l.length;e=h-1>=0?h-1:c.length-1;f=g-1>=0?g-1:l.length-1;o=[l[g],c[h],c[e]];o=THREE.FontUtils.Triangulate.area(o);r=[l[g],l[f],c[h]];r=THREE.FontUtils.Triangulate.area(r);if(n+m>o+r){h=q;g=j;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+l.length);g=g%l.length;e=h-1>=0?h-1:c.length-1;f=g-1>=0?g-1:l.length-1}n=c.slice(0,h);m=c.slice(h);q=l.slice(g);j=l.slice(0,g);f=[l[g],l[f],c[h]];p.push([l[g],c[h],c[e]]);p.push(f);c=n.concat(q).concat(j).concat(m)}return{shape:c,
...
THREE.RollControls=function(a,b){this.object=a;this.domElement=b!==void 0?b:document;this.mouseLook=true;this.autoForward=false;this.rollSpeed=this.movementSpeed=this.lookSpeed=1;this.constrainVertical=[-0.9,0.9];this.object.matrixAutoUpdate=false;this.forward=new THREE.Vector3(0,0,1);this.roll=0;var c=new THREE.Vector3,d=new THREE.Vector3,e=new THREE.Vector3,f=new THREE.Matrix4,g=false,h=1,i=0,l=0,j=0,n=0,m=0,q=0,p=0;this.handleResize=function(){q=window.innerWidth/2;p=window.innerHeight/2};this.update=
...
0){d.dispatchEvent(p);e.copy(d.object.position)}};this.domElement.addEventListener("contextmenu",function(a){a.preventDefault()},false);this.domElement.addEventListener("mousemove",function(a){if(d.enabled){if(f){i=l=d.getMouseProjectionOnBall(a.clientX,a.clientY);j=n=d.getMouseOnScreen(a.clientX,a.clientY);m=q=d.getMouseOnScreen(a.clientX,a.clientY);f=false}g!==-1&&(g===0&&!d.noRotate?l=d.getMouseProjectionOnBall(a.clientX,a.clientY):g===1&&!d.noZoom?n=d.getMouseOnScreen(a.clientX,a.clientY):g===
...
THREE.OrbitControls=function(a,b){function c(){return 2*Math.PI/60/60*f.autoRotateSpeed}function d(a){a.preventDefault();if(u===t.ROTATE){i.set(a.clientX,a.clientY);l.sub(i,h);f.rotateLeft(2*Math.PI*l.x/g*f.userRotateSpeed);f.rotateUp(2*Math.PI*l.y/g*f.userRotateSpeed);h.copy(i)}else if(u===t.ZOOM){n.set(a.clientX,a.clientY);m.sub(n,j);m.y>0?f.zoomIn():f.zoomOut();j.copy(n)}}function e(){if(f.userRotate){document.removeEventListener("mousemove",d,false);document.removeEventListener("mouseup",e,false);
...
void 0&&(a=c());p=p-a};this.rotateRight=function(a){a===void 0&&(a=c());p=p+a};this.rotateUp=function(a){a===void 0&&(a=c());q=q-a};this.rotateDown=function(a){a===void 0&&(a=c());q=q+a};this.zoomIn=function(a){a===void 0&&(a=Math.pow(0.95,f.userZoomSpeed));o=o/a};this.zoomOut=function(a){a===void 0&&(a=Math.pow(0.95,f.userZoomSpeed));o=o*a};this.update=function(){var a=this.object.position,b=a.clone().subSelf(this.center),d=Math.atan2(b.x,b.z),e=Math.atan2(Math.sqrt(b.x*b.x+b.z*b.z),b.y);this.autoRotate&&
...
if(a.button===0||a.button===2){u=t.ROTATE;h.set(a.clientX,a.clientY)}else if(a.button===1){u=t.ZOOM;j.set(a.clientX,a.clientY)}document.addEventListener("mousemove",d,false);document.addEventListener("mouseup",e,false)}},false);this.domElement.addEventListener("mousewheel",function(a){f.userZoom&&(a.wheelDelta>0?f.zoomOut():f.zoomIn())},false)};
...
THREE.CubeGeometry=function(a,b,c,d,e,f,g,h){function i(a,b,c,g,h,i,j,m){var n,o=d||1,p=e||1,q=h/2,r=i/2,t=l.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=f||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=f||1}var u=o+1,w=p+1,Y=h/o,$=i/p,L=new THREE.Vector3;L[n]=j>0?1:-1;for(h=0;h<w;h++)for(i=0;i<u;i++){var ba=new THREE.Vector3;ba[a]=(i*Y-q)*c;ba[b]=(h*$-r)*g;ba[n]=j;l.vertices.push(ba)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
...
THREE.SphereGeometry=function(a,b,c,d,e,f,g){THREE.Geometry.call(this);var a=a||50,d=d!==void 0?d:0,e=e!==void 0?e:Math.PI*2,f=f!==void 0?f:0,g=g!==void 0?g:Math.PI,b=Math.max(3,Math.floor(b)||8),c=Math.max(2,Math.floor(c)||6),h,i,l=[],j=[];for(i=0;i<=c;i++){var n=[],m=[];for(h=0;h<=b;h++){var q=h/b,p=i/c,o=new THREE.Vector3;o.x=-a*Math.cos(d+q*e)*Math.sin(f+p*g);o.y=a*Math.cos(f+p*g);o.z=a*Math.sin(d+q*e)*Math.sin(f+p*g);this.vertices.push(o);n.push(this.vertices.length-1);m.push(new THREE.UV(q,
1-p))}l.push(n);j.push(m)}for(i=0;i<c;i++)for(h=0;h<b;h++){var d=l[i][h+1],e=l[i][h],f=l[i+1][h],g=l[i+1][h+1],n=this.vertices[d].clone().normalize(),m=this.vertices[e].clone().normalize(),q=this.vertices[f].clone().normalize(),p=this.vertices[g].clone().normalize(),o=j[i][h+1].clone(),r=j[i][h].clone(),t=j[i+1][h].clone(),u=j[i+1][h+1].clone();if(Math.abs(this.vertices[d].y)==a){this.faces.push(new THREE.Face3(d,f,g,[n,q,p]));this.faceVertexUvs[0].push([o,t,u])}else if(Math.abs(this.vertices[f].y)==
a){this.faces.push(new THREE.Face3(d,e,f,[n,m,q]));this.faceVertexUvs[0].push([o,r,t])}else{this.faces.push(new THREE.Face4(d,e,f,g,[n,m,q,p]));this.faceVertexUvs[0].push([o,r,t,u])}}this.computeCentroids();this.computeFaceNormals();this.boundingSphere={radius:a}};THREE.SphereGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.TubeGeometry=function(a,b,c,d,e,f){THREE.Geometry.call(this);this.path=a;this.segments=b||64;this.radius=c||1;this.segmentsRadius=d||8;this.closed=e||false;if(f)this.debug=new THREE.Object3D;this.grid=[];var g,h,f=this.segments+1,i,l,j,n=new THREE.Vector3,m,q,p,b=new THREE.TubeGeometry.FrenetFrames(a,b,e);m=b.tangents;q=b.normals;p=b.binormals;this.tangents=m;this.normals=q;this.binormals=p;for(b=0;b<f;b++){this.grid[b]=[];d=b/(f-1);j=a.getPointAt(d);d=m[b];g=q[b];h=p[b];if(this.debug){this.debug.add(new THREE.ArrowHelper(d,
...
for(var c=c||1,d=d||0,i=this,l=0,j=a.length;l<j;l++)e(new THREE.Vector3(a[l][0],a[l][1],a[l][2]));for(var n=[],a=this.vertices,l=0,j=b.length;l<j;l++)f(a[b[l][0]],a[b[l][1]],a[b[l][2]],d);this.mergeVertices();l=0;for(j=this.vertices.length;l<j;l++)this.vertices[l].multiplyScalar(c);this.computeCentroids();this.boundingSphere={radius:c}};THREE.PolyhedronGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
THREE.ParametricGeometry=function(a,b,c,d){THREE.Geometry.call(this);var e=this.vertices,f=this.faces,g=this.faceVertexUvs[0],d=d===void 0?false:d,h,i,l,j,n=b+1;for(h=0;h<=c;h++){j=h/c;for(i=0;i<=b;i++){l=i/b;l=a(l,j);e.push(l)}}var m,q,p,o;for(h=0;h<c;h++)for(i=0;i<b;i++){a=h*n+i;e=h*n+i+1;j=(h+1)*n+i;l=(h+1)*n+i+1;m=new THREE.UV(i/b,h/c);q=new THREE.UV((i+1)/b,h/c);p=new THREE.UV(i/b,(h+1)/c);o=new THREE.UV((i+1)/b,(h+1)/c);if(d){f.push(new THREE.Face3(a,e,j));f.push(new THREE.Face3(e,l,j));g.push([m,
q,p]);g.push([q,o,p])}else{f.push(new THREE.Face4(a,e,l,j));g.push([m,q,o,p])}}this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.ParametricGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.ConvexGeometry=function(a){function b(a){var b=a.length();return new THREE.UV(a.x/b,a.y/b)}THREE.Geometry.call(this);for(var c=[[0,1,2],[0,2,1]],d=3;d<a.length;d++){var e=d,f=a[e].clone(),g=f.length();f.x=f.x+g*(Math.random()-0.5)*2E-6;f.y=f.y+g*(Math.random()-0.5)*2E-6;f.z=f.z+g*(Math.random()-0.5)*2E-6;for(var g=[],h=0;h<c.length;){var i=c[h],l=f,j=a[i[0]],n;n=j;var m=a[i[1]],q=a[i[2]],p=new THREE.Vector3,o=new THREE.Vector3;p.sub(q,m);o.sub(n,m);p.crossSelf(o);p.isZero()||p.normalize();n=
p;j=n.dot(j);if(n.dot(l)>=j){for(l=0;l<3;l++){j=[i[l],i[(l+1)%3]];n=true;for(m=0;m<g.length;m++)if(g[m][0]===j[1]&&g[m][1]===j[0]){g[m]=g[g.length-1];g.pop();n=false;break}n&&g.push(j)}c[h]=c[c.length-1];c.pop()}else h++}for(m=0;m<g.length;m++)c.push([g[m][0],g[m][1],e])}e=0;f=Array(a.length);for(d=0;d<c.length;d++){g=c[d];for(h=0;h<3;h++){if(f[g[h]]===void 0){f[g[h]]=e++;this.vertices.push(a[g[h]])}g[h]=f[g[h]]}}for(d=0;d<c.length;d++)this.faces.push(new THREE.Face3(c[d][0],c[d][1],c[d][2]));for(d=
...
THREE.LensFlarePlugin=function(){function a(a){var c=b.createProgram(),d=b.createShader(b.FRAGMENT_SHADER),e=b.createShader(b.VERTEX_SHADER);b.shaderSource(d,a.fragmentShader);b.shaderSource(e,a.vertexShader);b.compileShader(d);b.compileShader(e);b.attachShader(c,d);b.attachShader(c,e);b.linkProgram(c);return c}var b,c,d,e,f,g,h,i,l,j,n,m,q;this.init=function(p){b=p.context;c=p;d=new Float32Array(16);e=new Uint16Array(6);p=0;d[p++]=-1;d[p++]=-1;d[p++]=0;d[p++]=0;d[p++]=1;d[p++]=-1;d[p++]=1;d[p++]=
