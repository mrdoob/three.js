...
i.visible=i.positionScreen.z>ya&&i.positionScreen.z<ua;ea=0;for(O=Ua.length;ea<O;ea++)if(aa=Ua[ea],ob=!0===mb?Cb.materials[aa.materialIndex]:oa.material,void 0!==ob){Z=ob.side;if(aa instanceof THREE.Face3)if(V=n[aa.a],ja=n[aa.b],fa=n[aa.c],!0===V.visible&&!0===ja.visible&&!0===fa.visible)if(N=0>(fa.positionScreen.x-V.positionScreen.x)*(ja.positionScreen.y-V.positionScreen.y)-(fa.positionScreen.y-V.positionScreen.y)*(ja.positionScreen.x-V.positionScreen.x),Z===THREE.DoubleSide||N===(Z===THREE.FrontSide))r===
l?(sa=new THREE.RenderableFace3,s.push(sa),l++,r++,m=sa):m=s[r++],m.v1.copy(V),m.v2.copy(ja),m.v3.copy(fa);else continue;else continue;else if(aa instanceof THREE.Face4)if(V=n[aa.a],ja=n[aa.b],fa=n[aa.c],sa=n[aa.d],!0===V.visible&&!0===ja.visible&&!0===fa.visible&&!0===sa.visible)if(N=0>(sa.positionScreen.x-V.positionScreen.x)*(ja.positionScreen.y-V.positionScreen.y)-(sa.positionScreen.y-V.positionScreen.y)*(ja.positionScreen.x-V.positionScreen.x)||0>(ja.positionScreen.x-fa.positionScreen.x)*(sa.positionScreen.y-
fa.positionScreen.y)-(ja.positionScreen.y-fa.positionScreen.y)*(sa.positionScreen.x-fa.positionScreen.x),Z===THREE.DoubleSide||N===(Z===THREE.FrontSide)){if(q===B){var pb=new THREE.RenderableFace4;u.push(pb);B++;q++;m=pb}else m=u[q++];m.v1.copy(V);m.v2.copy(ja);m.v3.copy(fa);m.v4.copy(sa)}else continue;else continue;m.normalWorld.copy(aa.normal);!1===N&&(Z===THREE.BackSide||Z===THREE.DoubleSide)&&m.normalWorld.negate();K.multiplyVector3(m.normalWorld).normalize();m.centroidWorld.copy(aa.centroid);
za.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);L.multiplyVector3(m.centroidScreen);fa=aa.vertexNormals;V=0;for(ja=fa.length;V<ja;V++)sa=m.vertexNormalsWorld[V],sa.copy(fa[V]),!1===N&&(Z===THREE.BackSide||Z===THREE.DoubleSide)&&sa.negate(),K.multiplyVector3(sa).normalize();m.vertexNormalsLength=fa.length;V=0;for(ja=Da.length;V<ja;V++)if(sa=Da[V][ea],void 0!==sa){Z=0;for(fa=sa.length;Z<fa;Z++)m.uvs[V][Z]=sa[Z]}m.color=aa.color;m.material=ob;m.z=m.centroidScreen.z;I.elements.push(m)}}else if(oa instanceof
...
document.createElement("canvas"),p,m,r,s,l=n.getContext("2d"),q=new THREE.Color(0),u=0,B=1,x=0,t=null,F=null,C=null,z=null,A=null,H,G,I,$,D=new THREE.RenderableVertex,L=new THREE.RenderableVertex,y,K,J,R,P,ca,xa,M,pa,ya,ua,N,O=new THREE.Color,aa=new THREE.Color,ea=new THREE.Color,V=new THREE.Color,ja=new THREE.Color,Z=new THREE.Color,fa=new THREE.Color,oa={},za={},Da,Ua,sa,mb,Cb,ob,db,pb,kc,Ob,cb=new THREE.Box2,ma=new THREE.Box2,Ra=new THREE.Box2,Db=!1,Ha=new THREE.Color,qb=new THREE.Color,eb=new THREE.Color,
...
j,c.b+=g.b*j)}else f instanceof THREE.PointLight&&(h=f.matrixWorld.getPosition(),j=b.dot(Oa.sub(h,a).normalize()),0>=j||(j*=0==f.distance?1:1-Math.min(a.distanceTo(h)/f.distance,1),0!=j&&(j*=f.intensity,c.r+=g.r*j,c.g+=g.g*j,c.b+=g.b*j)))}}function m(a,d,e,g,h,i,k,ha){f.info.render.vertices+=3;f.info.render.faces++;b(ha.opacity);c(ha.blending);y=a.positionScreen.x;K=a.positionScreen.y;J=d.positionScreen.x;R=d.positionScreen.y;P=e.positionScreen.x;ca=e.positionScreen.y;p(y,K,J,R,P,ca);(ha instanceof
THREE.MeshLambertMaterial||ha instanceof THREE.MeshPhongMaterial)&&null===ha.map&&null===ha.map?(Z.copy(ha.color),fa.copy(ha.emissive),ha.vertexColors===THREE.FaceColors&&(Z.r*=k.color.r,Z.g*=k.color.g,Z.b*=k.color.b),!0===Db?!1===ha.wireframe&&ha.shading==THREE.SmoothShading&&3==k.vertexNormalsLength?(aa.r=ea.r=V.r=Ha.r,aa.g=ea.g=V.g=Ha.g,aa.b=ea.b=V.b=Ha.b,j(k.v1.positionWorld,k.vertexNormalsWorld[0],aa),j(k.v2.positionWorld,k.vertexNormalsWorld[1],ea),j(k.v3.positionWorld,k.vertexNormalsWorld[2],
V),aa.r=aa.r*Z.r+fa.r,aa.g=aa.g*Z.g+fa.g,aa.b=aa.b*Z.b+fa.b,ea.r=ea.r*Z.r+fa.r,ea.g=ea.g*Z.g+fa.g,ea.b=ea.b*Z.b+fa.b,V.r=V.r*Z.r+fa.r,V.g=V.g*Z.g+fa.g,V.b=V.b*Z.b+fa.b,ja.r=0.5*(ea.r+V.r),ja.g=0.5*(ea.g+V.g),ja.b=0.5*(ea.b+V.b),sa=F(aa,ea,V,ja),B(y,K,J,R,P,ca,0,0,1,0,0,1,sa)):(O.r=Ha.r,O.g=Ha.g,O.b=Ha.b,j(k.centroidWorld,k.normalWorld,O),O.r=O.r*Z.r+fa.r,O.g=O.g*Z.g+fa.g,O.b=O.b*Z.b+fa.b,!0===ha.wireframe?t(O,ha.wireframeLinewidth,ha.wireframeLinecap,ha.wireframeLinejoin):u(O)):!0===ha.wireframe?
t(ha.color,ha.wireframeLinewidth,ha.wireframeLinecap,ha.wireframeLinejoin):u(ha.color)):ha instanceof THREE.MeshBasicMaterial||ha instanceof THREE.MeshLambertMaterial||ha instanceof THREE.MeshPhongMaterial?null!==ha.map?ha.map.mapping instanceof THREE.UVMapping&&(mb=k.uvs[0],x(y,K,J,R,P,ca,mb[g].x,mb[g].y,mb[h].x,mb[h].y,mb[i].x,mb[i].y,ha.map)):null!==ha.envMap?ha.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=n.matrixWorldInverse,Oa.copy(k.vertexNormalsWorld[g]),Cb=0.5*(Oa.x*a.elements[0]+
Oa.y*a.elements[4]+Oa.z*a.elements[8])+0.5,ob=0.5*(Oa.x*a.elements[1]+Oa.y*a.elements[5]+Oa.z*a.elements[9])+0.5,Oa.copy(k.vertexNormalsWorld[h]),db=0.5*(Oa.x*a.elements[0]+Oa.y*a.elements[4]+Oa.z*a.elements[8])+0.5,pb=0.5*(Oa.x*a.elements[1]+Oa.y*a.elements[5]+Oa.z*a.elements[9])+0.5,Oa.copy(k.vertexNormalsWorld[i]),kc=0.5*(Oa.x*a.elements[0]+Oa.y*a.elements[4]+Oa.z*a.elements[8])+0.5,Ob=0.5*(Oa.x*a.elements[1]+Oa.y*a.elements[5]+Oa.z*a.elements[9])+0.5,x(y,K,J,R,P,ca,Cb,ob,db,pb,kc,Ob,ha.envMap)):
(O.copy(ha.color),ha.vertexColors===THREE.FaceColors&&(O.r*=k.color.r,O.g*=k.color.g,O.b*=k.color.b),!0===ha.wireframe?t(O,ha.wireframeLinewidth,ha.wireframeLinecap,ha.wireframeLinejoin):u(O)):ha instanceof THREE.MeshDepthMaterial?(Da=n.near,Ua=n.far,aa.r=aa.g=aa.b=1-fb(a.positionScreen.z,Da,Ua),ea.r=ea.g=ea.b=1-fb(d.positionScreen.z,Da,Ua),V.r=V.g=V.b=1-fb(e.positionScreen.z,Da,Ua),ja.r=0.5*(ea.r+V.r),ja.g=0.5*(ea.g+V.g),ja.b=0.5*(ea.b+V.b),sa=F(aa,ea,V,ja),B(y,K,J,R,P,ca,0,0,1,0,0,1,sa)):ha instanceof
THREE.MeshNormalMaterial&&(O.r=tb(k.normalWorld.x),O.g=tb(k.normalWorld.y),O.b=tb(k.normalWorld.z),!0===ha.wireframe?t(O,ha.wireframeLinewidth,ha.wireframeLinecap,ha.wireframeLinejoin):u(O))}function p(a,b,c,d,e,f){l.beginPath();l.moveTo(a,b);l.lineTo(c,d);l.lineTo(e,f);l.closePath()}function q(a,b,c,d,e,f,g,h){l.beginPath();l.moveTo(a,b);l.lineTo(c,d);l.lineTo(e,f);l.lineTo(g,h);l.closePath()}function t(a,b,c,e){C!==b&&(C=l.lineWidth=b);z!==c&&(z=l.lineCap=c);A!==e&&(A=l.lineJoin=e);d(a.getStyle());
...
(Z.copy(X.color),fa.copy(X.emissive),X.vertexColors===THREE.FaceColors&&(Z.r*=la.color.r,Z.g*=la.color.g,Z.b*=la.color.b),!0===Db?!1===X.wireframe&&X.shading==THREE.SmoothShading&&4==la.vertexNormalsLength?(aa.r=ea.r=V.r=ja.r=Ha.r,aa.g=ea.g=V.g=ja.g=Ha.g,aa.b=ea.b=V.b=ja.b=Ha.b,j(la.v1.positionWorld,la.vertexNormalsWorld[0],aa),j(la.v2.positionWorld,la.vertexNormalsWorld[1],ea),j(la.v4.positionWorld,la.vertexNormalsWorld[3],V),j(la.v3.positionWorld,la.vertexNormalsWorld[2],ja),aa.r=aa.r*Z.r+fa.r,
...
var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==ea&&(j.useProgram(g),ea=g,f=!0);d.id!==ja&&(ja=d.id,f=!0);if(f||a!==fa)j.uniformMatrix4fv(h.projectionMatrix,!1,a.projectionMatrix.elements),a!==fa&&(fa=a);if(d.skinning)if(Va&&e.useVertexTexture){if(null!==h.boneTexture){var k=C();j.uniform1i(h.boneTexture,k);N.setTexture(e.boneTexture,k)}}else null!==h.boneGlobalMatrices&&j.uniformMatrix4fv(h.boneGlobalMatrices,!1,e.boneMatrices);if(f){c&&d.fog&&(i.fogColor.value=c.color,c instanceof THREE.Fog?
...
i(W,j.DYNAMIC_DRAW,!W.dynamic),W.verticesNeedUpdate=!1,W.colorsNeedUpdate=!1;else{ma=e(za,W);Da=ma.attributes&&u(ma);if(W.verticesNeedUpdate||W.colorsNeedUpdate||za.sortParticles||Da){var ac=W,id=j.DYNAMIC_DRAW,Hc=za,xb=void 0,bc=void 0,cc=void 0,ia=void 0,dc=void 0,qc=void 0,Zc=ac.vertices,jd=Zc.length,kd=ac.colors,ud=kd.length,uc=ac.__vertexArray,vc=ac.__colorArray,ic=ac.__sortArray,vd=ac.verticesNeedUpdate,wd=ac.colorsNeedUpdate,jc=ac.__webglCustomAttributesList,Mb=void 0,yc=void 0,qa=void 0,Nb=
void 0,Ga=void 0,ga=void 0;if(Hc.sortParticles){sb.copy(lc);sb.multiplySelf(Hc.matrixWorld);for(xb=0;xb<jd;xb++)cc=Zc[xb],Lb.copy(cc),sb.multiplyVector3(Lb),ic[xb]=[Lb.z,xb];ic.sort(m);for(xb=0;xb<jd;xb++)cc=Zc[ic[xb][1]],ia=3*xb,uc[ia]=cc.x,uc[ia+1]=cc.y,uc[ia+2]=cc.z;for(bc=0;bc<ud;bc++)ia=3*bc,qc=kd[ic[bc][1]],vc[ia]=qc.r,vc[ia+1]=qc.g,vc[ia+2]=qc.b;if(jc){Mb=0;for(yc=jc.length;Mb<yc;Mb++)if(ga=jc[Mb],void 0===ga.boundTo||"vertices"===ga.boundTo)if(ia=0,Nb=ga.value.length,1===ga.size)for(qa=0;qa<
Nb;qa++)dc=ic[qa][1],ga.array[qa]=ga.value[dc];else if(2===ga.size)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ia+=2;else if(3===ga.size)if("c"===ga.type)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ia]=Ga.r,ga.array[ia+1]=Ga.g,ga.array[ia+2]=Ga.b,ia+=3;else for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ga.array[ia+2]=Ga.z,ia+=3;else if(4===ga.size)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ia]=
Ga.x,ga.array[ia+1]=Ga.y,ga.array[ia+2]=Ga.z,ga.array[ia+3]=Ga.w,ia+=4}}else{if(vd)for(xb=0;xb<jd;xb++)cc=Zc[xb],ia=3*xb,uc[ia]=cc.x,uc[ia+1]=cc.y,uc[ia+2]=cc.z;if(wd)for(bc=0;bc<ud;bc++)qc=kd[bc],ia=3*bc,vc[ia]=qc.r,vc[ia+1]=qc.g,vc[ia+2]=qc.b;if(jc){Mb=0;for(yc=jc.length;Mb<yc;Mb++)if(ga=jc[Mb],ga.needsUpdate&&(void 0===ga.boundTo||"vertices"===ga.boundTo))if(Nb=ga.value.length,ia=0,1===ga.size)for(qa=0;qa<Nb;qa++)ga.array[qa]=ga.value[qa];else if(2===ga.size)for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],
ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ia+=2;else if(3===ga.size)if("c"===ga.type)for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ia]=Ga.r,ga.array[ia+1]=Ga.g,ga.array[ia+2]=Ga.b,ia+=3;else for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ga.array[ia+2]=Ga.z,ia+=3;else if(4===ga.size)for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ia]=Ga.x,ga.array[ia+1]=Ga.y,ga.array[ia+2]=Ga.z,ga.array[ia+3]=Ga.w,ia+=4}}if(vd||Hc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,ac.__webglVertexBuffer),
