...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],j=c[1],m=c[5],n=c[9],l=c[13],p=c[2],o=c[6],q=c[10],s=c[14],r=c[3],z=c[7],u=c[11],c=c[15],t=d[0],E=d[4],A=d[8],
v=d[12],x=d[1],B=d[5],F=d[9],H=d[13],J=d[2],I=d[6],L=d[10],C=d[14],G=d[3],R=d[7],P=d[11],d=d[15];e[0]=f*t+g*x+h*J+i*G;e[4]=f*E+g*B+h*I+i*R;e[8]=f*A+g*F+h*L+i*P;e[12]=f*v+g*H+h*C+i*d;e[1]=j*t+m*x+n*J+l*G;e[5]=j*E+m*B+n*I+l*R;e[9]=j*A+m*F+n*L+l*P;e[13]=j*v+m*H+n*C+l*d;e[2]=p*t+o*x+q*J+s*G;e[6]=p*E+o*B+q*I+s*R;e[10]=p*A+o*F+q*L+s*P;e[14]=p*v+o*H+q*C+s*d;e[3]=r*t+z*x+u*J+c*G;e[7]=r*E+z*B+u*I+c*R;e[11]=r*A+z*F+u*L+c*P;e[15]=r*v+z*H+u*C+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),m=Math.sin(b),n=1-j,l=d*e*n,p=d*f*n,n=e*f*n,d=d*m,o=e*m,m=f*m,f=g+(1-g)*j,g=l+m,e=p-o,l=l-m,h=h+(1-h)*j,m=n+d,p=p+o,n=n-d,i=i+(1-i)*j,j=c[0],d=c[1],o=c[2],q=c[3],s=c[4],r=c[5],z=c[6],u=c[7],t=c[8],E=c[9],A=c[10],v=c[11];c[0]=f*j+g*s+e*t;c[1]=f*d+g*r+e*E;c[2]=f*o+g*z+e*A;c[3]=f*q+g*u+e*v;c[4]=l*j+h*s+m*t;c[5]=l*d+h*r+m*E;c[6]=l*o+h*z+m*A;c[7]=l*q+h*u+m*v;c[8]=p*j+n*s+i*t;c[9]=p*d+n*r+i*E;c[10]=p*o+n*z+i*A;c[11]=p*q+n*u+i*v;
...
c)return!1;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return!0}var e,f,g=[],h=0,i,j,m=[],n=0,l,p,o=[],q=0,s,r=[],z=0,u,t,E=[],A=0,v,x,B=[],F=0,H={objects:[],sprites:[],lights:[],elements:[]},J=new THREE.Vector3,I=new THREE.Vector4,L=new THREE.Matrix4,C=new THREE.Matrix4,G=new THREE.Frustum,R=new THREE.Vector4,P=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);L.multiply(b.projectionMatrix,b.matrixWorldInverse);L.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);L.multiply(b.matrixWorld,b.projectionMatrixInverse);L.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n,N){var M=h.near,ga=h.far,S=!1,K,O,ha,Z,aa,ia,U,da,eb,Aa,Ja,Ta,ra,Ma,qb,nb;x=t=s=p=0;H.elements.length=0;g.updateMatrixWorld();void 0===h.parent&&
...
n;g++)if(da=H.objects[g].object,eb=da.matrixWorld,j=0,da instanceof THREE.Mesh){Aa=da.geometry;Ja=da.geometry.materials;ha=Aa.vertices;Ta=Aa.faces;Ma=Aa.faceVertexUvs;Aa=da.matrixRotationWorld.extractRotation(eb);qb=da.material instanceof THREE.MeshFaceMaterial;K=0;for(O=ha.length;K<O;K++)i=b(),i.positionWorld.copy(ha[K]),eb.multiplyVector3(i.positionWorld),i.positionScreen.copy(i.positionWorld),L.multiplyVector4(i.positionScreen),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,
i.visible=i.positionScreen.z>M&&i.positionScreen.z<ga;ha=0;for(K=Ta.length;ha<K;ha++)if(O=Ta[ha],nb=!0===qb?Ja[O.materialIndex]:da.material,void 0!==nb){ia=nb.side;if(O instanceof THREE.Face3)if(Z=m[O.a],aa=m[O.b],U=m[O.c],!0===Z.visible&&!0===aa.visible&&!0===U.visible)if(S=0>(U.positionScreen.x-Z.positionScreen.x)*(aa.positionScreen.y-Z.positionScreen.y)-(U.positionScreen.y-Z.positionScreen.y)*(aa.positionScreen.x-Z.positionScreen.x),ia===THREE.DoubleSide||S===(ia===THREE.FrontSide))p===q?(ra=new THREE.RenderableFace3,
...
U.positionScreen.y)*(ra.positionScreen.x-U.positionScreen.x),ia===THREE.DoubleSide||S===(ia===THREE.FrontSide)){if(s===z){var Wa=new THREE.RenderableFace4;r.push(Wa);z++;s++;l=Wa}else l=r[s++];l.v1.copy(Z);l.v2.copy(aa);l.v3.copy(U);l.v4.copy(ra)}else continue;else continue;l.normalWorld.copy(O.normal);!1===S&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&l.normalWorld.negate();Aa.multiplyVector3(l.normalWorld);l.centroidWorld.copy(O.centroid);eb.multiplyVector3(l.centroidWorld);l.centroidScreen.copy(l.centroidWorld);
L.multiplyVector3(l.centroidScreen);U=O.vertexNormals;Z=0;for(aa=U.length;Z<aa;Z++)ra=l.vertexNormalsWorld[Z],ra.copy(U[Z]),!1===S&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&ra.negate(),Aa.multiplyVector3(ra);l.vertexNormalsLength=U.length;Z=0;for(aa=Ma.length;Z<aa;Z++)if(ra=Ma[Z][ha],void 0!==ra){ia=0;for(U=ra.length;ia<U;ia++)l.uvs[Z][ia]=ra[ia]}l.color=O.color;l.material=nb;l.z=l.centroidScreen.z;H.elements.push(l)}}else if(da instanceof THREE.Line){C.multiply(L,eb);ha=da.geometry.vertices;
Z=b();Z.positionScreen.copy(ha[0]);C.multiplyVector4(Z.positionScreen);eb=da.type===THREE.LinePieces?2:1;K=1;for(O=ha.length;K<O;K++)Z=b(),Z.positionScreen.copy(ha[K]),C.multiplyVector4(Z.positionScreen),0<(K+1)%eb||(aa=m[j-2],R.copy(Z.positionScreen),P.copy(aa.positionScreen),!0===d(R,P)&&(R.multiplyScalar(1/R.w),P.multiplyScalar(1/P.w),t===A?(Ja=new THREE.RenderableLine,E.push(Ja),A++,t++,u=Ja):u=E[t++],u.v1.positionScreen.copy(R),u.v2.positionScreen.copy(P),u.z=Math.max(R.z,P.z),u.material=da.material,
H.elements.push(u)))}g=0;for(n=H.sprites.length;g<n;g++)da=H.sprites[g].object,eb=da.matrixWorld,da instanceof THREE.Particle&&(I.set(eb.elements[12],eb.elements[13],eb.elements[14],1),L.multiplyVector4(I),I.z/=I.w,0<I.z&&1>I.z&&(x===F?(M=new THREE.RenderableParticle,B.push(M),F++,x++,v=M):v=B[x++],v.object=da,v.x=I.x/I.w,v.y=I.y/I.w,v.z=I.z,v.rotation=da.rotation.z,v.scale.x=da.scale.x*Math.abs(v.x-(I.x+h.projectionMatrix.elements[0])/(I.w+h.projectionMatrix.elements[12])),v.scale.y=da.scale.y*Math.abs(v.y-
(I.y+h.projectionMatrix.elements[5])/(I.w+h.projectionMatrix.elements[13])),v.material=da.material,H.elements.push(v)));!0===N&&H.elements.sort(c);return H}};THREE.Quaternion=function(a,b,c,d){this.x=a||0;this.y=b||0;this.z=c||0;this.w=void 0!==d?d:1};
...
h.x;o=j.x-h.x;q=i.y-h.y;s=j.y-h.y;r=i.z-h.z;z=j.z-h.z;u=n.u-m.u;t=l.u-m.u;E=n.v-m.v;A=l.v-m.v;v=1/(u*A-t*E);H.set((A*p-E*o)*v,(A*q-E*s)*v,(A*r-E*z)*v);J.set((u*o-t*p)*v,(u*s-t*q)*v,(u*z-t*r)*v);B[b].addSelf(H);B[c].addSelf(H);B[d].addSelf(H);F[b].addSelf(J);F[c].addSelf(J);F[d].addSelf(J)}var b,c,d,e,f,g,h,i,j,m,n,l,p,o,q,s,r,z,u,t,E,A,v,x,B=[],F=[],H=new THREE.Vector3,J=new THREE.Vector3,I=new THREE.Vector3,L=new THREE.Vector3,C=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)B[b]=new THREE.Vector3,
...
g=this.attributes.position.array,h=this.attributes.normal.array,i,j,m,n,l,p,o=new THREE.Vector3,q=new THREE.Vector3,s=new THREE.Vector3,r=new THREE.Vector3,z=new THREE.Vector3;c=0;for(d=e.length;c<d;++c){b=e[c].start;i=e[c].count;var u=e[c].index;a=b;for(b+=i;a<b;a+=3)i=u+f[a],j=u+f[a+1],m=u+f[a+2],n=g[3*i],l=g[3*i+1],p=g[3*i+2],o.set(n,l,p),n=g[3*j],l=g[3*j+1],p=g[3*j+2],q.set(n,l,p),n=g[3*m],l=g[3*m+1],p=g[3*m+2],s.set(n,l,p),r.sub(s,q),z.sub(o,q),r.crossSelf(z),h[3*i]+=r.x,h[3*i+1]+=r.y,h[3*i+
2]+=r.z,h[3*j]+=r.x,h[3*j+1]+=r.y,h[3*j+2]+=r.z,h[3*m]+=r.x,h[3*m+1]+=r.y,h[3*m+2]+=r.z}a=0;for(b=h.length;a<b;a+=3)n=h[a],l=h[a+1],p=h[a+2],c=1/Math.sqrt(n*n+l*l+p*p),h[a]*=c,h[a+1]*=c,h[a+2]*=c;this.normalsNeedUpdate=!0}},computeTangents:function(){function a(a){Y.x=d[3*a];Y.y=d[3*a+1];Y.z=d[3*a+2];oa.copy(Y);M=i[a];P.copy(M);P.subSelf(Y.multiplyScalar(Y.dot(M))).normalize();Q.cross(oa,M);ga=Q.dot(j[a]);N=0>ga?-1:1;h[4*a]=P.x;h[4*a+1]=P.y;h[4*a+2]=P.z;h[4*a+3]=N}if(void 0===this.attributes.index||
...
i=[],j=[],g=0;g<f;g++)i[g]=new THREE.Vector3,j[g]=new THREE.Vector3;var m,n,l,p,o,q,s,r,z,u,t,E,A,v,x,f=new THREE.Vector3,g=new THREE.Vector3,B,F,H,J,I,L,C,G=this.offsets;H=0;for(J=G.length;H<J;++H){F=G[H].start;I=G[H].count;var R=G[H].index;B=F;for(F+=I;B<F;B+=3)I=R+b[B],L=R+b[B+1],C=R+b[B+2],m=c[3*I],n=c[3*I+1],l=c[3*I+2],p=c[3*L],o=c[3*L+1],q=c[3*L+2],s=c[3*C],r=c[3*C+1],z=c[3*C+2],u=e[2*I],t=e[2*I+1],E=e[2*L],A=e[2*L+1],v=e[2*C],x=e[2*C+1],p-=m,m=s-m,o-=n,n=r-n,q-=l,l=z-l,E-=u,u=v-u,A-=t,t=x-
t,x=1/(E*t-u*A),f.set((t*p-A*m)*x,(t*o-A*n)*x,(t*q-A*l)*x),g.set((E*m-u*p)*x,(E*n-u*o)*x,(E*l-u*q)*x),i[I].addSelf(f),i[L].addSelf(f),i[C].addSelf(f),j[I].addSelf(g),j[L].addSelf(g),j[C].addSelf(g)}var P=new THREE.Vector3,Q=new THREE.Vector3,Y=new THREE.Vector3,oa=new THREE.Vector3,N,M,ga;H=0;for(J=G.length;H<J;++H){F=G[H].start;I=G[H].count;R=G[H].index;B=F;for(F+=I;B<F;B+=3)I=R+b[B],L=R+b[B+1],C=R+b[B+2],a(I),a(L),a(C)}this.tangentsNeedUpdate=this.hasTangents=!0}}};
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(b){var c,e,i,j,m,n,l,p,o,q,s,r,z,u,t;function E(a){return a%4?4-a%4:0}function A(a,b){return(new Uint8Array(a,b,1))[0]}function v(a,b){return(new Uint32Array(a,b,1))[0]}function x(b,c){var d,e,f,g,h,i,j,l,m=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){e=m[3*d];f=m[3*d+1];g=m[3*d+2];h=R[2*e];e=R[2*e+1];i=R[2*f];j=R[2*f+1];f=R[2*g];l=R[2*g+1];g=L.faceVertexUvs[0];var n=[];n.push(new THREE.UV(h,e));n.push(new THREE.UV(i,j));n.push(new THREE.UV(f,
...
G[3*m+1];m=G[3*m+2];L.faces.push(new THREE.Face3(f,g,h,[new THREE.Vector3(G[3*j],G[3*j+1],G[3*j+2]),new THREE.Vector3(o,p,l),new THREE.Vector3(q,r,m)],null,i))}}function I(b,c,d,e){for(var f,g,h,i,j,l,m,n,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];l=d[4*e];m=d[4*e+1];n=d[4*e+2];o=d[4*e+3];j=p[e];var q=G[3*m],r=G[3*m+1];m=G[3*m+2];var s=G[3*n],t=G[3*n+1];n=G[3*n+2];var u=G[3*o],v=G[3*o+1];o=G[3*o+2];L.faces.push(new THREE.Face4(f,
g,h,i,[new THREE.Vector3(G[3*l],G[3*l+1],G[3*l+2]),new THREE.Vector3(q,r,m),new THREE.Vector3(s,t,n),new THREE.Vector3(u,v,o)],null,j))}}var L=this,C=0,G=[],R=[],P,Q,Y;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(L,d,b);t=a;Q=C;b=new Uint8Array(t,Q,12);q="";for(z=0;12>z;z++)q+=String.fromCharCode(b[Q+z]);c=A(t,Q+12);A(t,Q+13);A(t,Q+14);A(t,Q+15);e=A(t,Q+16);i=A(t,Q+17);j=A(t,Q+18);m=A(t,Q+19);n=v(t,Q+20);l=v(t,Q+20+4);p=v(t,Q+20+8);o=v(t,Q+20+12);q=v(t,Q+20+16);s=v(t,Q+20+20);r=
v(t,Q+20+24);z=v(t,Q+20+28);b=v(t,Q+20+32);u=v(t,Q+20+36);t=v(t,Q+20+40);C+=c;Q=3*e+m;Y=4*e+m;P=o*Q;c=q*(Q+3*i);e=s*(Q+3*j);m=r*(Q+3*i+3*j);Q=z*Y;i=b*(Y+4*i);j=u*(Y+4*j);Y=C;var C=new Float32Array(a,C,3*n),oa,N,M,ga;for(oa=0;oa<n;oa++)N=C[3*oa],M=C[3*oa+1],ga=C[3*oa+2],L.vertices.push(new THREE.Vector3(N,M,ga));n=C=Y+3*n*Float32Array.BYTES_PER_ELEMENT;if(l){C=new Int8Array(a,C,3*l);for(Y=0;Y<l;Y++)oa=C[3*Y],N=C[3*Y+1],M=C[3*Y+2],G.push(oa/127,N/127,M/127)}C=n+3*l*Int8Array.BYTES_PER_ELEMENT;l=C+=
E(3*l);if(p){C=new Float32Array(a,C,2*p);for(n=0;n<p;n++)Y=C[2*n],oa=C[2*n+1],R.push(Y,oa)}p=C=l+2*p*Float32Array.BYTES_PER_ELEMENT;P=p+P+E(2*o);l=P+c+E(2*q);c=l+e+E(2*s);e=c+m+E(2*r);Q=e+Q+E(2*z);m=Q+i+E(2*b);i=m+j+E(2*u);s&&(j=l+3*s*Uint32Array.BYTES_PER_ELEMENT,F(s,l,j+3*s*Uint32Array.BYTES_PER_ELEMENT),x(s,j));r&&(s=c+3*r*Uint32Array.BYTES_PER_ELEMENT,j=s+3*r*Uint32Array.BYTES_PER_ELEMENT,J(r,c,s,j+3*r*Uint32Array.BYTES_PER_ELEMENT),x(r,j));u&&(r=m+4*u*Uint32Array.BYTES_PER_ELEMENT,H(u,m,r+4*
u*Uint32Array.BYTES_PER_ELEMENT),B(u,r));t&&(u=i+4*t*Uint32Array.BYTES_PER_ELEMENT,r=u+4*t*Uint32Array.BYTES_PER_ELEMENT,I(t,i,u,r+4*t*Uint32Array.BYTES_PER_ELEMENT),B(t,r));o&&F(o,p,p+3*o*Uint32Array.BYTES_PER_ELEMENT);q&&(o=P+3*q*Uint32Array.BYTES_PER_ELEMENT,J(q,P,o,o+3*q*Uint32Array.BYTES_PER_ELEMENT));z&&H(z,e,e+4*z*Uint32Array.BYTES_PER_ELEMENT);b&&(q=Q+4*b*Uint32Array.BYTES_PER_ELEMENT,I(b,Q,q,q+4*b*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals();THREE.Loader.prototype.hasNormals(this)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1;this.initMaterials(d,a.materials,c);var f,g,h,i,j,m,n,l,p,o,q,s,r,z,u=a.faces;p=a.vertices;var t=a.normals,E=a.colors,A=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&A++;for(f=0;f<A;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];c=0;for(i=p.length;c<i;)j=new THREE.Vector3,j.x=p[c++]*e,j.y=p[c++]*e,j.z=p[c++]*e,d.vertices.push(j);c=0;for(i=u.length;c<i;){p=u[c++];j=p&1;h=p&2;f=p&4;g=p&8;n=p&16;
m=p&32;o=p&64;p&=128;j?(q=new THREE.Face4,q.a=u[c++],q.b=u[c++],q.c=u[c++],q.d=u[c++],j=4):(q=new THREE.Face3,q.a=u[c++],q.b=u[c++],q.c=u[c++],j=3);h&&(h=u[c++],q.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<A;f++)s=a.uvs[f],l=u[c++],z=s[2*l],l=s[2*l+1],d.faceUvs[f][h]=new THREE.UV(z,l);if(g)for(f=0;f<A;f++){s=a.uvs[f];r=[];for(g=0;g<j;g++)l=u[c++],z=s[2*l],l=s[2*l+1],r[g]=new THREE.UV(z,l);d.faceVertexUvs[f][h]=r}n&&(n=3*u[c++],g=new THREE.Vector3,g.x=t[n++],g.y=t[n++],g.z=t[n],q.normal=g);if(m)for(f=
...
l=a.normals,j=a.colors,m=0;if(a.uvs)for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&m++;for(f=0;f<m;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];n=0;for(p=o.length;n<p;){var q=new THREE.Vector3;q.x=o[n++]*e;q.y=o[n++]*e;q.z=o[n++]*e;d.vertices.push(q)}n=0;for(p=g.length;n<p;){var s=g[n++],r=s&2,f=s&4,z=s&8,u=s&16,o=s&32,t=s&64,q=s&128;if(s&1){s=new THREE.Face4;s.a=g[n++];s.b=g[n++];s.c=g[n++];s.d=g[n++];var E=4}else s=new THREE.Face3,s.a=g[n++],s.b=g[n++],s.c=g[n++],E=3;r&&(r=g[n++],s.materialIndex=r);var A=
d.faces.length;if(f)for(f=0;f<m;f++){var v=a.uvs[f],r=g[n++],x=v[2*r],r=v[2*r+1];d.faceUvs[f][A]=new THREE.UV(x,r)}if(z)for(f=0;f<m;f++){for(var v=a.uvs[f],z=[],B=0;B<E;B++)r=g[n++],x=v[2*r],r=v[2*r+1],z[B]=new THREE.UV(x,r);d.faceVertexUvs[f][A]=z}u&&(u=3*g[n++],r=new THREE.Vector3,r.x=l[u++],r.y=l[u++],r.z=l[u],s.normal=r);if(o)for(f=0;f<E;f++)u=3*g[n++],r=new THREE.Vector3,r.x=l[u++],r.y=l[u++],r.z=l[u],s.vertexNormals.push(r);t&&(o=g[n++],s.color=new THREE.Color(j[o]));if(q)for(f=0;f<E;f++)o=
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return"relativeToHTML"==b?a:n+"/"+a}function e(){f(M.scene,ga.objects)}function f(a,b){for(var c in b)if(void 0===M.objects[c]){var e=b[c],g=null;if(e.type&&e.type in m.hierarchyHandlerMap&&void 0===e.loading){for(var i in s);J=M.materials[e.materials[0]];e.loading=!0;var j=m.hierarchyHandlerMap[e.type].loaderObject;j.addEventListener("load",h(c,a,J,e));j.load(d(e.url,ga.urlBaseType))}else if(void 0!==e.geometry){if(H=M.geometries[e.geometry])g=
!1,J=M.materials[e.materials[0]],(g=J instanceof THREE.ShaderMaterial)&&H.computeTangents(),u=e.position,t=e.rotation,E=e.quaternion,A=e.scale,r=e.matrix,E=0,0===e.materials.length&&(J=new THREE.MeshFaceMaterial),1<e.materials.length&&(J=new THREE.MeshFaceMaterial),e.skin?g=new THREE.SkinnedMesh(H,J):e.morph?(g=new THREE.MorphAnimMesh(H,J),void 0!==e.duration&&(g.duration=e.duration),void 0!==e.time&&(g.time=e.time),void 0!==e.mirroredLoop&&(g.mirroredLoop=e.mirroredLoop),J.morphNormals&&H.computeMorphNormals()):
g=new THREE.Mesh(H,J),g.name=c,r?(g.matrixAutoUpdate=!1,g.matrix.set(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15])):(g.position.set(u[0],u[1],u[2]),E?(g.quaternion.set(E[0],E[1],E[2],E[3]),g.useQuaternion=!0):g.rotation.set(t[0],t[1],t[2]),g.scale.set(A[0],A[1],A[2])),g.visible=e.visible,g.castShadow=e.castShadow,g.receiveShadow=e.receiveShadow,a.add(g),M.objects[c]=g}else"DirectionalLight"===e.type||"PointLight"===e.type||"AmbientLight"===e.type?(R=void 0!==
e.color?e.color:16777215,P=void 0!==e.intensity?e.intensity:1,"DirectionalLight"===e.type?(u=e.direction,G=new THREE.DirectionalLight(R,P),G.position.set(u[0],u[1],u[2]),G.position.normalize()):"PointLight"===e.type?(u=e.position,z=e.distance,G=new THREE.PointLight(R,P,z),G.position.set(u[0],u[1],u[2])):"AmbientLight"===e.type&&(G=new THREE.AmbientLight(R)),a.add(G),G.name=c,M.lights[c]=G,M.objects[c]=G):"PerspectiveCamera"===e.type||"OrthographicCamera"===e.type?("PerspectiveCamera"===e.type?I=new THREE.PerspectiveCamera(e.fov,
e.aspect,e.near,e.far):"OrthographicCamera"===e.type&&(I=new THREE.OrthographicCamera(v.left,v.right,v.top,v.bottom,v.near,v.far)),u=e.position,x=e.target,F=e.up,I.position.set(u[0],u[1],u[2]),I.target=new THREE.Vector3(x[0],x[1],x[2]),F&&I.up.set(F[0],F[1],F[2]),a.add(I),I.name=c,M.cameras[c]=I,M.objects[c]=I):(u=e.position,t=e.rotation,E=e.quaternion,A=e.scale,E=0,g=new THREE.Object3D,g.name=c,g.position.set(u[0],u[1],u[2]),E?(g.quaternion.set(E[0],E[1],E[2],E[3]),g.useQuaternion=!0):g.rotation.set(t[0],
t[1],t[2]),g.scale.set(A[0],A[1],A[2]),g.visible=void 0!==e.visible?e.visible:!1,a.add(g),M.objects[c]=g,M.empties[c]=g);if(g){if(void 0!==e.properties)for(var l in e.properties)g.properties[l]=e.properties[l];void 0!==e.children&&f(g,e.children)}}}function g(a){return function(b){M.geometries[a]=b;e();Q-=1;m.onLoadComplete();j()}}function h(a,b,c,d){return function(f){var f=f.content,g=d.position,h=d.rotation,i=d.quaternion,l=d.scale;f.position.set(g[0],g[1],g[2]);i?(f.quaternion.set(i[0],i[1],i[2],
i[3]),f.useQuaternion=!0):f.rotation.set(h[0],h[1],h[2]);f.scale.set(l[0],l[1],l[2]);c&&f.traverse(function(a){a.material=c});b.add(f);M.objects[a]=f;e();Q-=1;m.onLoadComplete();j()}}function i(a){return function(b){M.geometries[a]=b}}function j(){m.callbackProgress({totalModels:oa,totalTextures:N,loadedModels:oa-Q,loadedTextures:N-Y},M);m.onLoadProgress();0===Q&&0===Y&&b(M)}var m=this,n=THREE.Loader.prototype.extractUrlBase(c),l,p,o,q,s,r,z,u,t,E,A,v,x,B,F,H,J,I,L,C,G,R,P,Q,Y,oa,N,M,ga=a,S;for(S in this.geometryHandlerMap)a=
this.geometryHandlerMap[S].loaderClass,this.geometryHandlerMap[S].loaderObject=new a;for(S in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[S].loaderClass,this.hierarchyHandlerMap[S].loaderObject=new a;Y=Q=0;M={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(ga.transform&&(S=ga.transform.position,a=ga.transform.rotation,c=ga.transform.scale,S&&M.scene.position.set(S[0],S[1],S[2]),a&&M.scene.rotation.set(a[0],a[1],a[2]),c&&M.scene.scale.set(c[0],
c[1],c[2]),S||a||c))M.scene.updateMatrix(),M.scene.updateMatrixWorld();S=function(a){return function(){Y-=a;j();m.onLoadComplete()}};for(o in ga.fogs)a=ga.fogs[o],"linear"===a.type?L=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(L=new THREE.FogExp2(0,a.density)),v=a.color,L.color.setRGB(v[0],v[1],v[2]),M.fogs[o]=L;for(l in ga.geometries)s=ga.geometries[l],s.type in this.geometryHandlerMap&&(Q+=1,m.onLoadStart());for(var K in ga.objects)o=ga.objects[K],o.type&&o.type in this.hierarchyHandlerMap&&
(Q+=1,m.onLoadStart());oa=Q;for(l in ga.geometries)if(s=ga.geometries[l],"cube"===s.type)H=new THREE.CubeGeometry(s.width,s.height,s.depth,s.widthSegments,s.heightSegments,s.depthSegments,null,s.flipped,s.sides),M.geometries[l]=H;else if("plane"===s.type)H=new THREE.PlaneGeometry(s.width,s.height,s.widthSegments,s.heightSegments),M.geometries[l]=H;else if("sphere"===s.type)H=new THREE.SphereGeometry(s.radius,s.widthSegments,s.heightSegments),M.geometries[l]=H;else if("cylinder"===s.type)H=new THREE.CylinderGeometry(s.topRad,
s.botRad,s.height,s.radSegs,s.heightSegs),M.geometries[l]=H;else if("torus"===s.type)H=new THREE.TorusGeometry(s.radius,s.tube,s.segmentsR,s.segmentsT),M.geometries[l]=H;else if("icosahedron"===s.type)H=new THREE.IcosahedronGeometry(s.radius,s.subdivisions),M.geometries[l]=H;else if(s.type in this.geometryHandlerMap){K={};for(C in s)"type"!==C&&"url"!==C&&(K[C]=s[C]);this.geometryHandlerMap[s.type].loaderObject.load(d(s.url,ga.urlBaseType),g(l),K)}else"embedded"===s.type&&(K=ga.embeds[s.id],K.metadata=
ga.metadata,K&&this.geometryHandlerMap.ascii.loaderObject.createModel(K,i(l),""));for(q in ga.textures)if(l=ga.textures[q],l.url instanceof Array){Y+=l.url.length;for(C=0;C<l.url.length;C++)m.onLoadStart()}else Y+=1,m.onLoadStart();N=Y;for(q in ga.textures){l=ga.textures[q];void 0!==l.mapping&&void 0!==THREE[l.mapping]&&(l.mapping=new THREE[l.mapping]);if(l.url instanceof Array){K=l.url.length;o=[];for(C=0;C<K;C++)o[C]=d(l.url[C],ga.urlBaseType);C=(C=o[0].endsWith(".dds"))?THREE.ImageUtils.loadCompressedTextureCube(o,
l.mapping,S(K)):THREE.ImageUtils.loadTextureCube(o,l.mapping,S(K))}else{C=l.url.toLowerCase().endsWith(".dds");K=d(l.url,ga.urlBaseType);o=S(1);C=C?THREE.ImageUtils.loadCompressedTexture(K,l.mapping,o):THREE.ImageUtils.loadTexture(K,l.mapping,o);void 0!==THREE[l.minFilter]&&(C.minFilter=THREE[l.minFilter]);void 0!==THREE[l.magFilter]&&(C.magFilter=THREE[l.magFilter]);l.anisotropy&&(C.anisotropy=l.anisotropy);if(l.repeat&&(C.repeat.set(l.repeat[0],l.repeat[1]),1!==l.repeat[0]&&(C.wrapS=THREE.RepeatWrapping),
1!==l.repeat[1]))C.wrapT=THREE.RepeatWrapping;l.offset&&C.offset.set(l.offset[0],l.offset[1]);if(l.wrap&&(K={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping},void 0!==K[l.wrap[0]]&&(C.wrapS=K[l.wrap[0]]),void 0!==K[l.wrap[1]]))C.wrapT=K[l.wrap[1]]}M.textures[q]=C}for(p in ga.materials){r=ga.materials[p];for(B in r.parameters)"envMap"===B||"map"===B||"lightMap"===B||"bumpMap"===B?r.parameters[B]=M.textures[r.parameters[B]]:"shading"===B?r.parameters[B]="flat"===r.parameters[B]?THREE.FlatShading:
THREE.SmoothShading:"side"===B?r.parameters[B]="double"==r.parameters[B]?THREE.DoubleSide:"back"==r.parameters[B]?THREE.BackSide:THREE.FrontSide:"blending"===B?r.parameters[B]=r.parameters[B]in THREE?THREE[r.parameters[B]]:THREE.NormalBlending:"combine"===B?r.parameters[B]="MixOperation"==r.parameters[B]?THREE.MixOperation:THREE.MultiplyOperation:"vertexColors"===B?"face"==r.parameters[B]?r.parameters[B]=THREE.FaceColors:r.parameters[B]&&(r.parameters[B]=THREE.VertexColors):"wrapRGB"===B&&(q=r.parameters[B],
r.parameters[B]=new THREE.Vector3(q[0],q[1],q[2]));void 0!==r.parameters.opacity&&1>r.parameters.opacity&&(r.parameters.transparent=!0);r.parameters.normalMap?(q=THREE.ShaderUtils.lib.normal,S=THREE.UniformsUtils.clone(q.uniforms),l=r.parameters.color,C=r.parameters.specular,K=r.parameters.ambient,o=r.parameters.shininess,S.tNormal.value=M.textures[r.parameters.normalMap],r.parameters.normalScale&&S.uNormalScale.value.set(r.parameters.normalScale[0],r.parameters.normalScale[1]),r.parameters.map&&
(S.tDiffuse.value=r.parameters.map,S.enableDiffuse.value=!0),r.parameters.envMap&&(S.tCube.value=r.parameters.envMap,S.enableReflection.value=!0,S.uReflectivity.value=r.parameters.reflectivity),r.parameters.lightMap&&(S.tAO.value=r.parameters.lightMap,S.enableAO.value=!0),r.parameters.specularMap&&(S.tSpecular.value=M.textures[r.parameters.specularMap],S.enableSpecular.value=!0),r.parameters.displacementMap&&(S.tDisplacement.value=M.textures[r.parameters.displacementMap],S.enableDisplacement.value=
!0,S.uDisplacementBias.value=r.parameters.displacementBias,S.uDisplacementScale.value=r.parameters.displacementScale),S.uDiffuseColor.value.setHex(l),S.uSpecularColor.value.setHex(C),S.uAmbientColor.value.setHex(K),S.uShininess.value=o,r.parameters.opacity&&(S.uOpacity.value=r.parameters.opacity),J=new THREE.ShaderMaterial({fragmentShader:q.fragmentShader,vertexShader:q.vertexShader,uniforms:S,lights:!0,fog:!0})):J=new THREE[r.type](r.parameters);M.materials[p]=J}e();M.cameras&&ga.defaults.camera&&
(M.currentCamera=M.cameras[ga.defaults.camera]);M.fogs&&ga.defaults.fog&&(M.scene.fog=M.fogs[ga.defaults.fog]);v=ga.defaults.bgcolor;M.bgColor=new THREE.Color;M.bgColor.setRGB(v[0],v[1],v[2]);M.bgColorAlpha=ga.defaults.bgalpha;m.callbackSync(M);j()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
document.createElement("canvas"),n,l,p,o,q=m.getContext("2d"),s=new THREE.Color(0),r=0,z=1,u=0,t=null,E=null,A=null,v=null,x=null,B,F,H,J,I=new THREE.RenderableVertex,L=new THREE.RenderableVertex,C,G,R,P,Q,Y,oa,N,M,ga,S,K,O=new THREE.Color,ha=new THREE.Color,Z=new THREE.Color,aa=new THREE.Color,ia=new THREE.Color,U=new THREE.Color,da=new THREE.Color,eb={},Aa={},Ja,Ta,ra,Ma,qb,nb,fb,Wa,zb,Ab,ob=new THREE.Rectangle,Na=new THREE.Rectangle,ka=new THREE.Rectangle,kb=!1,Ha=new THREE.Color,cb=new THREE.Color,
...
Math.floor(n/2);o=Math.floor(l/2);m.width=n;m.height=l;ob.set(-p,-o,p,o);Na.set(-p,-o,p,o);z=1;u=0;x=v=A=E=t=null};this.setClearColor=function(a,b){s.copy(a);r=void 0!==b?b:1;Na.set(-p,-o,p,o)};this.setClearColorHex=function(a,b){s.setHex(a);r=void 0!==b?b:1;Na.set(-p,-o,p,o)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){q.setTransform(1,0,0,-1,p,o);!1===Na.isEmpty()&&(Na.minSelf(ob),Na.inflate(2),1>r&&q.clearRect(Math.floor(Na.getX()),Math.floor(Na.getY()),Math.floor(Na.getWidth()),
Math.floor(Na.getHeight())),0<r&&(c(THREE.NormalBlending),b(1),e("rgba("+Math.floor(255*s.r)+","+Math.floor(255*s.g)+","+Math.floor(255*s.b)+","+r+")"),q.fillRect(Math.floor(Na.getX()),Math.floor(Na.getY()),Math.floor(Na.getWidth()),Math.floor(Na.getHeight()))),Na.empty())};this.render=function(a,k){function l(a,b,c){for(var d=0,e=i.length;d<e;d++){var f=i[d],g=f.color;if(f instanceof THREE.DirectionalLight){var h=f.matrixWorld.getPosition().normalize(),k=b.dot(h);0>=k||(k*=f.intensity,c.r+=g.r*k,
...
THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)&&null===o.map&&null===o.map?(U.copy(o.color),da.copy(o.emissive),o.vertexColors===THREE.FaceColors&&(U.r*=j.color.r,U.g*=j.color.g,U.b*=j.color.b),!0===kb)?!1===o.wireframe&&o.shading==THREE.SmoothShading&&3==j.vertexNormalsLength?(ha.r=Z.r=aa.r=Ha.r,ha.g=Z.g=aa.g=Ha.g,ha.b=Z.b=aa.b=Ha.b,l(j.v1.positionWorld,j.vertexNormalsWorld[0],ha),l(j.v2.positionWorld,j.vertexNormalsWorld[1],Z),l(j.v3.positionWorld,j.vertexNormalsWorld[2],aa),ha.r=
ha.r*U.r+da.r,ha.g=ha.g*U.g+da.g,ha.b=ha.b*U.b+da.b,Z.r=Z.r*U.r+da.r,Z.g=Z.g*U.g+da.g,Z.b=Z.b*U.b+da.b,aa.r=aa.r*U.r+da.r,aa.g=aa.g*U.g+da.g,aa.b=aa.b*U.b+da.b,ia.r=0.5*(Z.r+aa.r),ia.g=0.5*(Z.g+aa.g),ia.b=0.5*(Z.b+aa.b),ra=na(ha,Z,aa,ia),z(C,G,R,P,Q,Y,0,0,1,0,0,1,ra)):(O.r=Ha.r,O.g=Ha.g,O.b=Ha.b,l(j.centroidWorld,j.normalWorld,O),O.r=O.r*U.r+da.r,O.g=O.g*U.g+da.g,O.b=O.b*U.b+da.b,!0===o.wireframe?s(O,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(O)):!0===o.wireframe?s(o.color,o.wireframeLinewidth,
...
M=sb.positionScreen.x,ga=sb.positionScreen.y,S=tb.positionScreen.x,K=tb.positionScreen.y,ba instanceof THREE.MeshLambertMaterial||ba instanceof THREE.MeshPhongMaterial)?(U.copy(ba.color),da.copy(ba.emissive),ba.vertexColors===THREE.FaceColors&&(U.r*=la.color.r,U.g*=la.color.g,U.b*=la.color.b),!0===kb)?!1===ba.wireframe&&ba.shading==THREE.SmoothShading&&4==la.vertexNormalsLength?(ha.r=Z.r=aa.r=ia.r=Ha.r,ha.g=Z.g=aa.g=ia.g=Ha.g,ha.b=Z.b=aa.b=ia.b=Ha.b,l(la.v1.positionWorld,la.vertexNormalsWorld[0],
ha),l(la.v2.positionWorld,la.vertexNormalsWorld[1],Z),l(la.v4.positionWorld,la.vertexNormalsWorld[3],aa),l(la.v3.positionWorld,la.vertexNormalsWorld[2],ia),ha.r=ha.r*U.r+da.r,ha.g=ha.g*U.g+da.g,ha.b=ha.b*U.b+da.b,Z.r=Z.r*U.r+da.r,Z.g=Z.g*U.g+da.g,Z.b=Z.b*U.b+da.b,aa.r=aa.r*U.r+da.r,aa.g=aa.g*U.g+da.g,aa.b=aa.b*U.b+da.b,ia.r=ia.r*U.r+da.r,ia.g=ia.g*U.g+da.g,ia.b=ia.b*U.b+da.b,ra=na(ha,Z,aa,ia),n(C,G,R,P,oa,N),z(C,G,R,P,oa,N,0,0,1,0,0,1,ra),n(M,ga,Q,Y,S,K),z(M,ga,Q,Y,S,K,1,0,1,1,0,1,ra)):(O.r=Ha.r,
O.g=Ha.g,O.b=Ha.b,l(la.centroidWorld,la.normalWorld,O),O.r=O.r*U.r+da.r,O.g=O.g*U.g+da.g,O.b=O.b*U.b+da.b,r(C,G,R,P,Q,Y,oa,N),!0===ba.wireframe?s(O,ba.wireframeLinewidth,ba.wireframeLinecap,ba.wireframeLinejoin):t(O)):(O.r=U.r+da.r,O.g=U.g+da.g,O.b=U.b+da.b,r(C,G,R,P,Q,Y,oa,N),!0===ba.wireframe?s(O,ba.wireframeLinewidth,ba.wireframeLinecap,ba.wireframeLinejoin):t(O)):ba instanceof THREE.MeshBasicMaterial?(O.copy(ba.color),ba.vertexColors===THREE.FaceColors&&(O.r*=la.color.r,O.g*=la.color.g,O.b*=la.color.b),
r(C,G,R,P,Q,Y,oa,N),!0===ba.wireframe?s(O,ba.wireframeLinewidth,ba.wireframeLinecap,ba.wireframeLinejoin):t(O)):ba instanceof THREE.MeshNormalMaterial?(O.r=Cb(la.normalWorld.x),O.g=Cb(la.normalWorld.y),O.b=Cb(la.normalWorld.z),r(C,G,R,P,Q,Y,oa,N),!0===ba.wireframe?s(O,ba.wireframeLinewidth,ba.wireframeLinecap,ba.wireframeLinejoin):t(O)):ba instanceof THREE.MeshDepthMaterial&&(Ja=k.near,Ta=k.far,ha.r=ha.g=ha.b=1-cc(ma.positionScreen.z,Ja,Ta),Z.r=Z.g=Z.b=1-cc(bb.positionScreen.z,Ja,Ta),aa.r=aa.g=aa.b=
1-cc(yb.positionScreen.z,Ja,Ta),ia.r=ia.g=ia.b=1-cc(E.positionScreen.z,Ja,Ta),ra=na(ha,Z,aa,ia),n(C,G,R,P,oa,N),z(C,G,R,P,oa,N,0,0,1,0,0,1,ra),n(M,ga,Q,Y,S,K),z(M,ga,Q,Y,S,K,1,0,1,1,0,1,ra));Na.addRectangle(ka)}q.setTransform(1,0,0,1,0,0)}}};
...
b,c){a.push({buffer:b,object:c,opaque:null,transparent:null})}function s(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return!0;return!1}function r(a){for(var b in a.attributes)a.attributes[b].needsUpdate=!1}function z(a,b){for(var c=a.length-1;0<=c;c--)a[c].object===b&&a.splice(c,1)}function u(a,b){for(var c=a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function t(a,b,c,d,e){Aa=0;d.needsUpdate&&(d.program&&K.deallocateMaterial(d),K.initMaterial(d,b,c,e),d.needsUpdate=!1);d.morphTargets&&
!e.__webglMorphTargetInfluences&&(e.__webglMorphTargetInfluences=new Float32Array(K.maxMorphTargets));var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==Z&&(k.useProgram(g),Z=g,f=!0);d.id!==ia&&(ia=d.id,f=!0);if(f||a!==da)k.uniformMatrix4fv(h.projectionMatrix,!1,a._projectionMatrixArray),a!==da&&(da=a);if(d.skinning)if(fc&&e.useVertexTexture){if(null!==h.boneTexture){var j=E();k.uniform1i(h.boneTexture,j);K.setTexture(e.boneTexture,j)}}else null!==h.boneGlobalMatrices&&k.uniformMatrix4fv(h.boneGlobalMatrices,
!1,e.boneMatrices);if(f){c&&d.fog&&(i.fogColor.value=c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(Za){for(var l=0,m=0,n=0,o,p,q,r,s=uc,t=s.directional.colors,u=s.directional.positions,z=s.point.colors,A=s.point.positions,B=s.point.distances,F=s.spot.colors,H=s.spot.positions,I=s.spot.distances,O=s.spot.directions,
M=s.spot.angles,N=s.spot.exponents,L=s.hemi.skyColors,aa=s.hemi.groundColors,Q=s.hemi.positions,U=0,P=0,R=0,ha=0,c=o=q=q=p=0,f=b.length;c<f;c++)j=b[c],!j.onlyShadow&&j.visible&&(o=j.color,r=j.intensity,p=j.distance,j instanceof THREE.AmbientLight?K.gammaInput?(l+=o.r*o.r,m+=o.g*o.g,n+=o.b*o.b):(l+=o.r,m+=o.g,n+=o.b):j instanceof THREE.DirectionalLight?(p=3*U,K.gammaInput?v(t,p,o,r*r):x(t,p,o,r),Ya.copy(j.matrixWorld.getPosition()),Ya.subSelf(j.target.matrixWorld.getPosition()),Ya.normalize(),u[p]=
Ya.x,u[p+1]=Ya.y,u[p+2]=Ya.z,U+=1):j instanceof THREE.PointLight?(q=3*P,K.gammaInput?v(z,q,o,r*r):x(z,q,o,r),r=j.matrixWorld.getPosition(),A[q]=r.x,A[q+1]=r.y,A[q+2]=r.z,B[P]=p,P+=1):j instanceof THREE.SpotLight?(q=3*R,K.gammaInput?v(F,q,o,r*r):x(F,q,o,r),r=j.matrixWorld.getPosition(),H[q]=r.x,H[q+1]=r.y,H[q+2]=r.z,I[R]=p,Ya.copy(r),Ya.subSelf(j.target.matrixWorld.getPosition()),Ya.normalize(),O[q]=Ya.x,O[q+1]=Ya.y,O[q+2]=Ya.z,M[R]=Math.cos(j.angle),N[R]=j.exponent,R+=1):j instanceof THREE.HemisphereLight&&
(p=j.color,q=j.groundColor,o=3*ha,K.gammaInput?(r*=r,v(L,o,p,r),v(aa,o,q,r)):(x(L,o,p,r),x(aa,o,q,r)),r=j.matrixWorld.getPosition(),Q[o]=r.x,Q[o+1]=r.y,Q[o+2]=r.z,ha+=1));c=3*U;for(f=t.length;c<f;c++)t[c]=0;c=3*P;for(f=z.length;c<f;c++)z[c]=0;c=3*R;for(f=F.length;c<f;c++)F[c]=0;c=3*ha;for(f=L.length;c<f;c++)L[c]=0;c=3*ha;for(f=aa.length;c<f;c++)aa[c]=0;s.directional.length=U;s.point.length=P;s.spot.length=R;s.hemi.length=ha;s.ambient[0]=l;s.ambient[1]=m;s.ambient[2]=n;Za=!1}c=uc;i.ambientLightColor.value=
...
f);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;j=[];for(l=0;6>l;l++)K.autoScaleCubemaps&&!f?(m=j,n=l,s=c.image[l],u=Mc,s.width<=u&&s.height<=u||(z=Math.max(s.width,s.height),t=Math.floor(s.width*u/z),u=Math.floor(s.height*u/z),z=document.createElement("canvas"),z.width=t,z.height=u,z.getContext("2d").drawImage(s,0,0,s.width,s.height,0,0,t,u),s=z),m[n]=s):j[l]=c.image[l];l=j[0];m=0===(l.width&l.width-
1)&&0===(l.height&l.height-1);n=C(c.format);s=C(c.type);J(k.TEXTURE_CUBE_MAP,c,m);for(l=0;6>l;l++)if(f){u=j[l].mipmaps;z=0;for(A=u.length;z<A;z++)t=u[z],k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,z,n,t.width,t.height,0,t.data)}else k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,n,n,s,j[l]);c.generateMipmaps&&m&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else k.activeTexture(k.TEXTURE0+f),k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else n instanceof
...
a.alpha?a.alpha:!0,Q=void 0!==a.premultipliedAlpha?a.premultipliedAlpha:!0,Y=void 0!==a.antialias?a.antialias:!1,oa=void 0!==a.stencil?a.stencil:!0,N=void 0!==a.preserveDrawingBuffer?a.preserveDrawingBuffer:!1,M=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),ga=void 0!==a.clearAlpha?a.clearAlpha:0,S=void 0!==a.maxLights?a.maxLights:4;this.domElement=G;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=
this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapCullFrontFaces=this.shadowMapSoft=this.shadowMapAutoUpdate=!0;this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var K=this,O=[],ha=0,Z=null,aa=null,ia=-1,U=null,da=
...
k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(M.r,M.g,M.b,ga);this.context=k;var vc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),P=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Mc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),mc=xb?k.getParameter(xb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,gc=0<P,fc=gc&&a;pb&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};
...
b){M.setHex(a);ga=b;k.clearColor(M.r,M.g,M.b,ga)};this.setClearColor=function(a,b){M.copy(a);ga=b;k.clearColor(M.r,M.g,M.b,ga)};this.getClearColor=function(){return M};this.getClearAlpha=function(){return ga};this.clear=function(a,b,c){var d=0;if(void 0===a||a)d|=k.COLOR_BUFFER_BIT;if(void 0===b||b)d|=k.DEPTH_BUFFER_BIT;if(void 0===c||c)d|=k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};
...
qa.__webglMorphTargetsBuffers[Qa]);k.bufferData(k.ARRAY_BUFFER,Oc[Qa],va);Ma.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,qa.__webglMorphNormalsBuffers[Qa]),k.bufferData(k.ARRAY_BUFFER,Pc[Qa],va))}}if(ac.length){D=0;for($=sa.length;D<$;D++)T=ab[sa[D]],Mb=ac[T.a],Nb=ac[T.b],Ob=ac[T.c],Fa[fa]=Mb.x,Fa[fa+1]=Mb.y,Fa[fa+2]=Mb.z,Fa[fa+3]=Mb.w,Fa[fa+4]=Nb.x,Fa[fa+5]=Nb.y,Fa[fa+6]=Nb.z,Fa[fa+7]=Nb.w,Fa[fa+8]=Ob.x,Fa[fa+9]=Ob.y,Fa[fa+10]=Ob.z,Fa[fa+11]=Ob.w,Pb=ec[T.a],Qb=ec[T.b],Rb=ec[T.c],Ea[fa]=Pb.x,Ea[fa+
1]=Pb.y,Ea[fa+2]=Pb.z,Ea[fa+3]=Pb.w,Ea[fa+4]=Qb.x,Ea[fa+5]=Qb.y,Ea[fa+6]=Qb.z,Ea[fa+7]=Qb.w,Ea[fa+8]=Rb.x,Ea[fa+9]=Rb.y,Ea[fa+10]=Rb.z,Ea[fa+11]=Rb.w,fa+=12;D=0;for($=ta.length;D<$;D++)T=ab[ta[D]],Mb=ac[T.a],Nb=ac[T.b],Ob=ac[T.c],zb=ac[T.d],Fa[fa]=Mb.x,Fa[fa+1]=Mb.y,Fa[fa+2]=Mb.z,Fa[fa+3]=Mb.w,Fa[fa+4]=Nb.x,Fa[fa+5]=Nb.y,Fa[fa+6]=Nb.z,Fa[fa+7]=Nb.w,Fa[fa+8]=Ob.x,Fa[fa+9]=Ob.y,Fa[fa+10]=Ob.z,Fa[fa+11]=Ob.w,Fa[fa+12]=zb.x,Fa[fa+13]=zb.y,Fa[fa+14]=zb.z,Fa[fa+15]=zb.w,Pb=ec[T.a],Qb=ec[T.b],Rb=ec[T.c],
Ab=ec[T.d],Ea[fa]=Pb.x,Ea[fa+1]=Pb.y,Ea[fa+2]=Pb.z,Ea[fa+3]=Pb.w,Ea[fa+4]=Qb.x,Ea[fa+5]=Qb.y,Ea[fa+6]=Qb.z,Ea[fa+7]=Qb.w,Ea[fa+8]=Rb.x,Ea[fa+9]=Rb.y,Ea[fa+10]=Rb.z,Ea[fa+11]=Rb.w,Ea[fa+12]=Ab.x,Ea[fa+13]=Ab.y,Ea[fa+14]=Ab.z,Ea[fa+15]=Ab.w,fa+=16;0<fa&&(k.bindBuffer(k.ARRAY_BUFFER,qa.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ea,va),k.bindBuffer(k.ARRAY_BUFFER,qa.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Fa,va))}if(Mc&&qb){D=0;for($=sa.length;D<$;D++)T=ab[sa[D]],Bb=T.vertexColors,
...
delete qa.__uvArray,delete qa.__uv2Array,delete qa.__faceArray,delete qa.__vertexArray,delete qa.__lineArray,delete qa.__skinIndexArray,delete qa.__skinWeightArray)}}ea.verticesNeedUpdate=!1;ea.morphTargetsNeedUpdate=!1;ea.elementsNeedUpdate=!1;ea.uvsNeedUpdate=!1;ea.normalsNeedUpdate=!1;ea.colorsNeedUpdate=!1;ea.tangentsNeedUpdate=!1;ea.buffersNeedUpdate=!1;ka.attributes&&r(ka)}else if(Aa instanceof THREE.Ribbon){ka=e(Aa,ea);ua=ka.attributes&&s(ka);if(ea.verticesNeedUpdate||ea.colorsNeedUpdate||
ea.normalsNeedUpdate||ua){var wb=ea,yc=k.DYNAMIC_DRAW,pc=void 0,qc=void 0,rc=void 0,zc=void 0,ya=void 0,Ac=void 0,Bc=void 0,Cc=void 0,Wc=void 0,Ua=void 0,kc=void 0,Ba=void 0,ib=void 0,Xc=wb.vertices,Yc=wb.colors,Zc=wb.normals,dd=Xc.length,ed=Yc.length,fd=Zc.length,Dc=wb.__vertexArray,Ec=wb.__colorArray,Fc=wb.__normalArray,gd=wb.colorsNeedUpdate,hd=wb.normalsNeedUpdate,Tc=wb.__webglCustomAttributesList;if(wb.verticesNeedUpdate){for(pc=0;pc<dd;pc++)zc=Xc[pc],ya=3*pc,Dc[ya]=zc.x,Dc[ya+1]=zc.y,Dc[ya+
...
0;Ua<kc;Ua++)ib=Ba.value[Ua],Ba.array[ya]=ib.x,Ba.array[ya+1]=ib.y,Ba.array[ya+2]=ib.z,Ba.array[ya+3]=ib.w,ya+=4;k.bindBuffer(k.ARRAY_BUFFER,Ba.buffer);k.bufferData(k.ARRAY_BUFFER,Ba.array,yc)}}}ea.verticesNeedUpdate=!1;ea.colorsNeedUpdate=!1;ea.normalsNeedUpdate=!1;ka.attributes&&r(ka)}else if(Aa instanceof THREE.Line){ka=e(Aa,ea);ua=ka.attributes&&s(ka);if(ea.verticesNeedUpdate||ea.colorsNeedUpdate||ua){var Wb=ea,Uc=k.DYNAMIC_DRAW,sc=void 0,tc=void 0,Gc=void 0,Ga=void 0,Hc=void 0,$c=Wb.vertices,
...
Ca.value[Va],Ca.array[Ga]=jb.x,Ca.array[Ga+1]=jb.y,Ca.array[Ga+2]=jb.z,Ga+=3;else if(4===Ca.size)for(Va=0;Va<lc;Va++)jb=Ca.value[Va],Ca.array[Ga]=jb.x,Ca.array[Ga+1]=jb.y,Ca.array[Ga+2]=jb.z,Ca.array[Ga+3]=jb.w,Ga+=4;k.bindBuffer(k.ARRAY_BUFFER,Ca.buffer);k.bufferData(k.ARRAY_BUFFER,Ca.array,Uc)}}}ea.verticesNeedUpdate=!1;ea.colorsNeedUpdate=!1;ka.attributes&&r(ka)}else Aa instanceof THREE.ParticleSystem&&(ea instanceof THREE.BufferGeometry?((ea.verticesNeedUpdate||ea.colorsNeedUpdate)&&j(ea,k.DYNAMIC_DRAW,
!ea.dynamic),ea.verticesNeedUpdate=!1,ea.colorsNeedUpdate=!1):(ka=e(Aa,ea),ua=ka.attributes&&s(ka),(ea.verticesNeedUpdate||ea.colorsNeedUpdate||Aa.sortParticles||ua)&&i(ea,k.DYNAMIC_DRAW,Aa),ea.verticesNeedUpdate=!1,ea.colorsNeedUpdate=!1,ka.attributes&&r(ka)))}};this.initMaterial=function(a,b,c,d){var e,f,g,h,i,j,l,m,n;a instanceof THREE.MeshDepthMaterial?n="depth":a instanceof THREE.MeshNormalMaterial?n="normal":a instanceof THREE.MeshBasicMaterial?n="basic":a instanceof THREE.MeshLambertMaterial?
...
d=[];n?d.push(n):(d.push(q),d.push(r));for(u in p)d.push(u),d.push(p[u]);for(t in c)d.push(t),d.push(c[t]);n=d.join();t=0;for(u=O.length;t<u;t++)if(d=O[t],d.code===n){d.usedTimes++;s=d.program;break a}t=[];for(v in p)u=p[v],!1!==u&&(u="#define "+v+" "+u,t.push(u));u=t.join("\n");v=k.createProgram();t=["precision "+R+" float;",u,gc?"#define VERTEX_TEXTURES":"",K.gammaInput?"#define GAMMA_INPUT":"",K.gammaOutput?"#define GAMMA_OUTPUT":"",K.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"",
...
x);for(x=0;x<c.maxMorphNormals;x++)t.push("morphNormal"+x);for(s in b)t.push(s);s=t;x=0;for(t=s.length;x<t;x++)u=s[x],v.attributes[u]=k.getAttribLocation(v,u);v.id=ha++;O.push({program:v,code:n,usedTimes:1});K.info.memory.programs=O.length;s=v}a.program=s;s=a.program.attributes;0<=s.position&&k.enableVertexAttribArray(s.position);0<=s.color&&k.enableVertexAttribArray(s.color);0<=s.normal&&k.enableVertexAttribArray(s.normal);0<=s.tangent&&k.enableVertexAttribArray(s.tangent);a.skinning&&(0<=s.skinIndex&&
...
s,r,z=g.vertexNormals,u=g.vertexColors;g instanceof THREE.Face3?s=new THREE.Face3(g.a+e,g.b+e,g.c+e):g instanceof THREE.Face4&&(s=new THREE.Face4(g.a+e,g.b+e,g.c+e,g.d+e));s.normal.copy(g.normal);d&&d.multiplyVector3(s.normal);h=0;for(q=z.length;h<q;h++)r=z[h].clone(),d&&d.multiplyVector3(r),s.vertexNormals.push(r);s.color.copy(g.color);h=0;for(q=u.length;h<q;h++)r=u[h],s.vertexColors.push(r.clone());void 0!==g.materialIndex&&(h=f.materials[g.materialIndex],q=h.id,u=l[q],void 0===u&&(u=a.materials.length,
...
0>n-1?0:n-1,p=n+1>e-1?e-1:n+1,o=0>m-1?0:m-1,q=m+1>d-1?d-1:m+1,s=[],r=[0,0,h[4*(n*d+m)]/255*b];s.push([-1,0,h[4*(n*d+o)]/255*b]);s.push([-1,-1,h[4*(l*d+o)]/255*b]);s.push([0,-1,h[4*(l*d+m)]/255*b]);s.push([1,-1,h[4*(l*d+q)]/255*b]);s.push([1,0,h[4*(n*d+q)]/255*b]);s.push([1,1,h[4*(p*d+q)]/255*b]);s.push([0,1,h[4*(p*d+m)]/255*b]);s.push([-1,1,h[4*(p*d+o)]/255*b]);l=[];o=s.length;for(p=0;p<o;p++){var q=s[p],z=s[(p+1)%o],q=[q[0]-r[0],q[1]-r[1],q[2]-r[2]],z=[z[0]-r[0],z[1]-r[1],z[2]-r[2]];l.push(c([q[1]*
z[2]-q[2]*z[1],q[2]*z[0]-q[0]*z[2],q[0]*z[1]-q[1]*z[0]]))}s=[0,0,0];for(p=0;p<l.length;p++)s[0]+=l[p][0],s[1]+=l[p][1],s[2]+=l[p][2];s[0]/=l.length;s[1]/=l.length;s[2]/=l.length;r=4*(n*d+m);j[r]=255*((s[0]+1)/2)|0;j[r+1]=255*((s[1]+1)/2)|0;j[r+2]=255*s[2]|0;j[r+3]=255}g.putImageData(i,0,0);return f},generateDataTexture:function(a,b,c){for(var d=a*b,e=new Uint8Array(3*d),f=Math.floor(255*c.r),g=Math.floor(255*c.g),c=Math.floor(255*c.b),h=0;h<d;h++)e[3*h]=f,e[3*h+1]=g,e[3*h+2]=c;a=new THREE.DataTexture(e,
...
c+d;m=b[a++]*c;p=b[a++]*c+d;o=b[a++]*c;e.quadraticCurveTo(p,o,i,m);if(g=f[f.length-1]){n=g.x;l=g.y;g=1;for(h=this.divisions;g<=h;g++){var z=g/h;THREE.Shape.Utils.b2(z,n,p,i);THREE.Shape.Utils.b2(z,l,o,m)}}break;case "b":i=b[a++]*c+d;m=b[a++]*c;p=b[a++]*c+d;o=b[a++]*-c;q=b[a++]*c+d;s=b[a++]*-c;e.bezierCurveTo(i,m,p,o,q,s);if(g=f[f.length-1]){n=g.x;l=g.y;g=1;for(h=this.divisions;g<=h;g++){z=g/h;THREE.Shape.Utils.b3(z,n,p,q,i);THREE.Shape.Utils.b3(z,l,o,s,m)}}}}}return{offset:r.ha*c,path:e}}}};
...
THREE.CubeGeometry=function(a,b,c,d,e,f,g,h){function i(a,b,c,d,e,f,g,h){var i,l=j.widthSegments,m=j.heightSegments,n=e/2,o=f/2,p=j.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")i="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){i="y";m=j.depthSegments}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){i="x";l=j.depthSegments}var q=l+1,s=m+1,R=e/l,P=f/m,Q=new THREE.Vector3;Q[i]=g>0?1:-1;for(e=0;e<s;e++)for(f=0;f<q;f++){var Y=new THREE.Vector3;Y[a]=(f*R-n)*c;Y[b]=(e*P-o)*d;Y[i]=g;j.vertices.push(Y)}for(e=
...
this.vertices[j[0][h+1]].clone()}else{n=this.vertices[j[1][h]].clone();l=this.vertices[j[1][h+1]].clone()}n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();l.setY(Math.sqrt(l.x*l.x+l.z*l.z)*c).normalize();for(i=0;i<e;i++){var p=j[i][h],o=j[i+1][h],q=j[i+1][h+1],s=j[i][h+1],r=n.clone(),z=n.clone(),u=l.clone(),t=l.clone(),E=m[i][h].clone(),A=m[i+1][h].clone(),v=m[i+1][h+1].clone(),x=m[i][h+1].clone();this.faces.push(new THREE.Face4(p,o,q,s,[r,z,u,t]));this.faceVertexUvs[0].push([E,A,v,x])}}if(!f&&a>
0){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++){p=j[0][h];o=j[0][h+1];q=this.vertices.length-1;r=new THREE.Vector3(0,1,0);z=new THREE.Vector3(0,1,0);u=new THREE.Vector3(0,1,0);E=m[0][h].clone();A=m[0][h+1].clone();v=new THREE.UV(A.u,0);this.faces.push(new THREE.Face3(p,o,q,[r,z,u]));this.faceVertexUvs[0].push([E,A,v])}}if(!f&&b>0){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++){p=j[i][h+1];o=j[i][h];q=this.vertices.length-1;r=new THREE.Vector3(0,-1,0);z=new THREE.Vector3(0,
-1,0);u=new THREE.Vector3(0,-1,0);E=m[i][h+1].clone();A=m[i][h].clone();v=new THREE.UV(A.u,1);this.faces.push(new THREE.Face3(p,o,q,[r,z,u]));this.faceVertexUvs[0].push([E,A,v])}}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);
...
c.length-1);for(var g=0,h=l+m*2,g=0;g<h;g++){var i=Q*g,j=Q*(g+1),n=d+e+i,i=d+f+i,o=d+f+j,j=d+e+j,p=c,q=g,s=h,t=e,u=f,n=n+H,i=i+H,o=o+H,j=j+H;F.faces.push(new THREE.Face4(n,i,o,j,null,null,r));n=z.generateSideWallUV(F,a,p,b,n,i,o,j,q,s,t,u);F.faceVertexUvs[0].push(n)}}}function f(a,b,c){F.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+H;d=d+H;e=e+H;F.faces.push(new THREE.Face3(c,d,e,null,null,s));c=f?z.generateBottomUV(F,a,b,c,d,e):z.generateTopUV(F,a,b,c,d,e);F.faceVertexUvs[0].push(c)}
var h=b.amount!==void 0?b.amount:100,i=b.bevelThickness!==void 0?b.bevelThickness:6,j=b.bevelSize!==void 0?b.bevelSize:i-2,m=b.bevelSegments!==void 0?b.bevelSegments:3,n=b.bevelEnabled!==void 0?b.bevelEnabled:true,l=b.steps!==void 0?b.steps:1,p=b.extrudePath,o,q=false,s=b.material,r=b.extrudeMaterial,z=b.UVGenerator!==void 0?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,u,t,E,A;if(p){o=p.getSpacedPoints(l);q=true;n=false;u=b.frames!==void 0?b.frames:new THREE.TubeGeometry.FrenetFrames(p,l,
...
M&&(C=0);G===M&&(G=0);oa[N]=d(I[N],I[C],I[G])}var ga=[],S,K=oa.concat();x=0;for(B=p.length;x<B;x++){v=p[x];S=[];N=0;M=v.length;C=M-1;for(G=N+1;N<M;N++,C++,G++){C===M&&(C=0);G===M&&(G=0);S[N]=d(v[N],v[C],v[G])}ga.push(S);K=K.concat(S)}for(C=0;C<m;C++){v=C/m;R=i*(1-v);G=j*Math.sin(v*Math.PI/2);N=0;for(M=I.length;N<M;N++){P=c(I[N],oa[N],G);f(P.x,P.y,-R)}x=0;for(B=p.length;x<B;x++){v=p[x];S=ga[x];N=0;for(M=v.length;N<M;N++){P=c(v[N],S[N],G);f(P.x,P.y,-R)}}}G=j;for(N=0;N<Q;N++){P=n?c(J[N],K[N],G):J[N];
...
0;for(B=p.length;x<B;x++){v=p[x];S=ga[x];N=0;for(M=v.length;N<M;N++){P=c(v[N],S[N],G);q?f(P.x,P.y+o[l-1].y,o[l-1].x+R):f(P.x,P.y,h+R)}}}if(n){i=Q*0;for(N=0;N<Y;N++){h=L[N];g(h[2]+i,h[1]+i,h[0]+i,true)}i=Q*(l+m*2);for(N=0;N<Y;N++){h=L[N];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(N=0;N<Y;N++){h=L[N];g(h[2],h[1],h[0],true)}for(N=0;N<Y;N++){h=L[N];g(h[0]+Q*l,h[1]+Q*l,h[2]+Q*l,false)}}h=0;e(I,h);h=h+I.length;x=0;for(B=p.length;x<B;x++){v=p[x];e(v,h);h=h+v.length}};
...
c,"key",e,u[e]):u[e]=c}var h=[],i=[],j=[],m=this,n=THREE.GeometryUtils.orderedKey,l=THREE.GeometryUtils.computeEdgeFaces,p=a.vertices,o=a.faces,q=p.length,h=p.concat(),s=[],r={},z={},u={},t,E,A,v,x,B=a.faceVertexUvs[0],F;c("originalFaces, uvs, originalVerticesLength",o.length,B.length,q);if(m.supportUVs){t=0;for(E=B.length;t<E;t++){A=0;for(v=B[t].length;A<v;A++){F=o[t]["abcd".charAt(A)];g(F,t,B[t][A])}}}if(B.length==0)m.supportUVs=false;t=0;for(var H in u)t++;if(!t){m.supportUVs=false;c("no uvs")}t=
0;for(E=o.length;t<E;t++){x=o[t];s.push(x.centroid);h.push(x.centroid);if(m.supportUVs){v=new THREE.UV;if(x instanceof THREE.Face3){v.u=f(x.a,t).u+f(x.b,t).u+f(x.c,t).u;v.v=f(x.a,t).v+f(x.b,t).v+f(x.c,t).v;v.u=v.u/3;v.v=v.v/3}else if(x instanceof THREE.Face4){v.u=f(x.a,t).u+f(x.b,t).u+f(x.c,t).u+f(x.d,t).u;v.v=f(x.a,t).v+f(x.b,t).v+f(x.c,t).v+f(x.d,t).v;v.u=v.u/4;v.v=v.v/4}g(q+t,"",v)}}var l=l(a),J;E=0;var I,L;H={};B={};for(t in l){F=l[t];I=t.split("_");L=I[0];I=I[1];A=L;x=[L,I];H[A]===void 0&&(H[A]=
[]);H[A].push(x);A=I;x=[L,I];H[A]===void 0&&(H[A]=[]);H[A].push(x);A=0;for(v=F.length;A<v;A++){x=F[A];J=L;var C=x,G=t;B[J]===void 0&&(B[J]={});B[J][C]=G;J=I;C=t;B[J]===void 0&&(B[J]={});B[J][x]=C}F.length<2&&(z[t]=true)}for(t in l){F=l[t];x=F[0];J=F[1];I=t.split("_");L=I[0];I=I[1];v=new THREE.Vector3;b(F.length>0,"an edge without faces?!");if(F.length==1){v.addSelf(p[L]);v.addSelf(p[I]);v.multiplyScalar(0.5)}else{v.addSelf(s[x]);v.addSelf(s[J]);v.addSelf(p[L]);v.addSelf(p[I]);v.multiplyScalar(0.25)}r[t]=
q+o.length+E;h.push(v);E++;if(m.supportUVs){v=new THREE.UV;v.u=f(L,x).u+f(I,x).u;v.v=f(L,x).v+f(I,x).v;v.u=v.u/2;v.v=v.v/2;g(r[t],x,v);if(F.length>=2){b(F.length==2,"did we plan for more than 2 edges?");v=new THREE.UV;v.u=f(L,J).u+f(I,J).u;v.v=f(L,J).v+f(I,J).v;v.u=v.u/2;v.v=v.v/2;g(r[t],J,v)}}}c("-- Step 2 done");var R,P;v=["123","12","2","23"];J=["123","23","3","31"];var C=["123","31","1","12"],G=["1234","12","2","23"],Q=["1234","23","3","34"],Y=["1234","34","4","41"],oa=["1234","41","1","12"];
t=0;for(E=s.length;t<E;t++){x=o[t];F=q+t;if(x instanceof THREE.Face3){L=n(x.a,x.b);I=n(x.b,x.c);R=n(x.c,x.a);e(F,r[L],x.b,r[I],x,v,t);e(F,r[I],x.c,r[R],x,J,t);e(F,r[R],x.a,r[L],x,C,t)}else if(x instanceof THREE.Face4){L=n(x.a,x.b);I=n(x.b,x.c);R=n(x.c,x.d);P=n(x.d,x.a);e(F,r[L],x.b,r[I],x,G,t);e(F,r[I],x.c,r[R],x,Q,t);e(F,r[R],x.d,r[P],x,Y,t);e(F,r[P],x.a,r[L],x,oa,t)}else c("face should be a face!",x)}r=new THREE.Vector3;x=new THREE.Vector3;t=0;for(E=p.length;t<E;t++)if(H[t]!==void 0){r.set(0,0,
0);x.set(0,0,0);I=new THREE.Vector3(0,0,0);F=0;for(A in B[t]){r.addSelf(s[A]);F++}J=0;L=H[t].length;v=F!=L;for(A=0;A<L;A++)z[n(H[t][A][0],H[t][A][1])]&&J++;r.divideScalar(F);J=0;if(v){for(A=0;A<L;A++){F=H[t][A];if(C=l[n(F[0],F[1])].length==1){F=p[F[0]].clone().addSelf(p[F[1]]).divideScalar(2);x.addSelf(F);J++}}x.divideScalar(4);b(J==2,"should have only 2 boundary edges")}else{for(A=0;A<L;A++){F=H[t][A];F=p[F[0]].clone().addSelf(p[F[1]]).divideScalar(2);x.addSelf(F)}x.divideScalar(L)}I.addSelf(p[t]);
if(v){I.divideScalar(2);I.addSelf(x)}else{I.multiplyScalar(L-3);I.addSelf(r);I.addSelf(x.multiplyScalar(2));I.divideScalar(L)}h[t]=I}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=j;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);
...
"color");l.scale=b.getUniformLocation(m,"scale");l.rotation=b.getUniformLocation(m,"rotation");l.screenPosition=b.getUniformLocation(m,"screenPosition");p=false};this.render=function(a,d,e,r){var a=a.__webglFlares,z=a.length;if(z){var u=new THREE.Vector3,t=r/e,E=e*0.5,A=r*0.5,v=16/r,x=new THREE.Vector2(v*t,v),B=new THREE.Vector3(1,1,0),F=new THREE.Vector2(1,1),H=l,v=n;b.useProgram(m);if(!p){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);p=true}b.uniform1i(H.occlusionMap,0);b.uniform1i(H.map,
1);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(v.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(v.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var J,I,L,C,G;for(J=0;J<z;J++){v=16/r;x.set(v*t,v);C=a[J];u.set(C.matrixWorld.elements[12],C.matrixWorld.elements[13],C.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(u);d.projectionMatrix.multiplyVector3(u);B.copy(u);F.x=B.x*E+E;F.y=B.y*A+A;if(j||F.x>0&&F.x<e&&F.y>0&&
...
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);C.positionScreen.copy(B);C.customUpdateCallback?C.customUpdateCallback(C):C.updateLensFlares();b.uniform1i(H.renderType,2);b.enable(b.BLEND);I=0;for(L=C.lensFlares.length;I<L;I++){G=C.lensFlares[I];if(G.opacity>0.001&&G.scale>0.001){B.x=G.x;B.y=G.y;B.z=G.z;v=G.size*G.scale/r;x.x=v*t;x.y=v;b.uniform3f(H.screenPosition,B.x,B.y,B.z);b.uniform2f(H.scale,x.x,x.y);b.uniform1f(H.rotation,G.rotation);b.uniform1f(H.opacity,G.opacity);
...
vertexShader:g.vertexShader,uniforms:h,skinning:true});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:true,skinning:true});c._shadowPass=true;d._shadowPass=true;e._shadowPass=true;f._shadowPass=true};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(m,n){var l,p,o,q,s,r,z,u,t,E=[];q=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFrontFaces?
a.cullFace(a.FRONT):a.cullFace(a.BACK);b.setDepthTest(true);l=0;for(p=m.__lights.length;l<p;l++){o=m.__lights[l];if(o.castShadow)if(o instanceof THREE.DirectionalLight&&o.shadowCascade)for(s=0;s<o.shadowCascadeCount;s++){var A;if(o.shadowCascadeArray[s])A=o.shadowCascadeArray[s];else{t=o;z=s;A=new THREE.DirectionalLight;A.isVirtual=true;A.onlyShadow=true;A.castShadow=true;A.shadowCameraNear=t.shadowCameraNear;A.shadowCameraFar=t.shadowCameraFar;A.shadowCameraLeft=t.shadowCameraLeft;A.shadowCameraRight=
t.shadowCameraRight;A.shadowCameraBottom=t.shadowCameraBottom;A.shadowCameraTop=t.shadowCameraTop;A.shadowCameraVisible=t.shadowCameraVisible;A.shadowDarkness=t.shadowDarkness;A.shadowBias=t.shadowCascadeBias[z];A.shadowMapWidth=t.shadowCascadeWidth[z];A.shadowMapHeight=t.shadowCascadeHeight[z];A.pointsWorld=[];A.pointsFrustum=[];u=A.pointsWorld;r=A.pointsFrustum;for(var v=0;v<8;v++){u[v]=new THREE.Vector3;r[v]=new THREE.Vector3}u=t.shadowCascadeNearZ[z];t=t.shadowCascadeFarZ[z];r[0].set(-1,-1,u);
r[1].set(1,-1,u);r[2].set(-1,1,u);r[3].set(1,1,u);r[4].set(-1,-1,t);r[5].set(1,-1,t);r[6].set(-1,1,t);r[7].set(1,1,t);A.originalCamera=n;r=new THREE.Gyroscope;r.position=o.shadowCascadeOffset;r.add(A);r.add(A.target);n.add(r);o.shadowCascadeArray[s]=A;console.log("Created virtualLight",A)}z=o;u=s;t=z.shadowCascadeArray[u];t.position.copy(z.position);t.target.position.copy(z.target.position);t.lookAt(t.target);t.shadowCameraVisible=z.shadowCameraVisible;t.shadowDarkness=z.shadowDarkness;t.shadowBias=
z.shadowCascadeBias[u];r=z.shadowCascadeNearZ[u];z=z.shadowCascadeFarZ[u];t=t.pointsFrustum;t[0].z=r;t[1].z=r;t[2].z=r;t[3].z=r;t[4].z=z;t[5].z=z;t[6].z=z;t[7].z=z;E[q]=A;q++}else{E[q]=o;q++}}l=0;for(p=E.length;l<p;l++){o=E[l];if(!o.shadowMap){o.shadowMap=new THREE.WebGLRenderTarget(o.shadowMapWidth,o.shadowMapHeight,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});o.shadowMapSize=new THREE.Vector2(o.shadowMapWidth,o.shadowMapHeight);o.shadowMatrix=new THREE.Matrix4}if(!o.shadowCamera){if(o instanceof
...
!o.cameraHelper){o.cameraHelper=new THREE.CameraHelper(o.shadowCamera);o.shadowCamera.add(o.cameraHelper)}if(o.isVirtual&&A.originalCamera==n){s=n;q=o.shadowCamera;r=o.pointsFrustum;t=o.pointsWorld;i.set(Infinity,Infinity,Infinity);j.set(-Infinity,-Infinity,-Infinity);for(z=0;z<8;z++){u=t[z];u.copy(r[z]);THREE.ShadowMapPlugin.__projector.unprojectVector(u,s);q.matrixWorldInverse.multiplyVector3(u);if(u.x<i.x)i.x=u.x;if(u.x>j.x)j.x=u.x;if(u.y<i.y)i.y=u.y;if(u.y>j.y)j.y=u.y;if(u.z<i.z)i.z=u.z;if(u.z>
...
if(!s._viewMatrixArray)s._viewMatrixArray=new Float32Array(16);if(!s._projectionMatrixArray)s._projectionMatrixArray=new Float32Array(16);s.matrixWorldInverse.flattenToArray(s._viewMatrixArray);s.projectionMatrix.flattenToArray(s._projectionMatrixArray);h.multiply(s.projectionMatrix,s.matrixWorldInverse);g.setFromMatrix(h);b.setRenderTarget(q);b.clear();t=m.__webglObjects;o=0;for(q=t.length;o<q;o++){z=t[o];r=z.object;z.render=false;if(r.visible&&r.castShadow&&(!(r instanceof THREE.Mesh)||!r.frustumCulled||
g.contains(r))){r._modelViewMatrix.multiply(s.matrixWorldInverse,r.matrixWorld);z.render=true}}o=0;for(q=t.length;o<q;o++){z=t[o];if(z.render){r=z.object;z=z.buffer;v=r.material instanceof THREE.MeshFaceMaterial?r.geometry.materials[0]:r.material;u=r.geometry.morphTargets.length>0&&v.morphTargets;v=r instanceof THREE.SkinnedMesh&&v.skinning;u=r.customDepthMaterial?r.customDepthMaterial:v?u?f:e:u?d:c;z instanceof THREE.BufferGeometry?b.renderBufferDirect(s,m.__lights,null,u,z,r):b.renderBuffer(s,m.__lights,
null,u,z,r)}}t=m.__webglObjectsImmediate;o=0;for(q=t.length;o<q;o++){z=t[o];r=z.object;if(r.visible&&r.castShadow){r._modelViewMatrix.multiply(s.matrixWorldInverse,r.matrixWorld);b.renderImmediateObject(s,m.__lights,null,c,r)}}}l=b.getClearColor();p=b.getClearAlpha();a.clearColor(l.r,l.g,l.b,p);a.enable(a.BLEND);b.shadowMapCullFrontFaces&&a.cullFace(a.BACK)}};THREE.ShadowMapPlugin.__projector=new THREE.Projector;
...
j.projectionMatrix=b.getUniformLocation(h,"projectionMatrix");j.fogType=b.getUniformLocation(h,"fogType");j.fogDensity=b.getUniformLocation(h,"fogDensity");j.fogNear=b.getUniformLocation(h,"fogNear");j.fogFar=b.getUniformLocation(h,"fogFar");j.fogColor=b.getUniformLocation(h,"fogColor");m=false};this.render=function(d,e,p,o){var q=d.__webglSprites,s=q.length;if(s){var r=i,z=j,u=o/p,p=p*0.5,t=o*0.5,E=true;b.useProgram(h);if(!m){b.enableVertexAttribArray(r.position);b.enableVertexAttribArray(r.uv);
m=true}b.disable(b.CULL_FACE);b.enable(b.BLEND);b.depthMask(true);b.bindBuffer(b.ARRAY_BUFFER,f);b.vertexAttribPointer(r.position,2,b.FLOAT,false,16,0);b.vertexAttribPointer(r.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.uniformMatrix4fv(z.projectionMatrix,false,e._projectionMatrixArray);b.activeTexture(b.TEXTURE0);b.uniform1i(z.map,0);var A=r=0,v=d.fog;if(v){b.uniform3f(z.fogColor,v.color.r,v.color.g,v.color.b);if(v instanceof THREE.Fog){b.uniform1f(z.fogNear,v.near);b.uniform1f(z.fogFar,
v.far);b.uniform1i(z.fogType,1);A=r=1}else if(v instanceof THREE.FogExp2){b.uniform1f(z.fogDensity,v.density);b.uniform1i(z.fogType,2);A=r=2}}else{b.uniform1i(z.fogType,0);A=r=0}for(var x,B=[],v=0;v<s;v++){x=q[v];if(x.visible&&x.opacity!==0)if(x.useScreenCoordinates)x.z=-x.position.z;else{x._modelViewMatrix.multiply(e.matrixWorldInverse,x.matrixWorld);x.z=-x._modelViewMatrix.elements[14]}}q.sort(a);for(v=0;v<s;v++){x=q[v];if(x.visible&&x.opacity!==0&&x.map&&x.map.image&&x.map.image.width){if(x.useScreenCoordinates){b.uniform1i(z.useScreenCoordinates,
1);b.uniform3f(z.screenPosition,(x.position.x-p)/p,(t-x.position.y)/t,Math.max(0,Math.min(1,x.position.z)))}else{b.uniform1i(z.useScreenCoordinates,0);b.uniform1i(z.affectedByDistance,x.affectedByDistance?1:0);b.uniformMatrix4fv(z.modelViewMatrix,false,x._modelViewMatrix.elements)}e=d.fog&&x.fog?A:0;if(r!==e){b.uniform1i(z.fogType,e);r=e}e=1/(x.scaleByViewport?o:1);B[0]=e*u*x.scale.x;B[1]=e*x.scale.y;b.uniform2f(z.uvScale,x.uvScale.x,x.uvScale.y);b.uniform2f(z.uvOffset,x.uvOffset.x,x.uvOffset.y);
