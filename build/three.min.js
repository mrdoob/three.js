...
c)};this.projectScene=function(g,h,l,Ja){var pa=!1,ta,Z,ka,W,V,la,ha,ja,Pa,jb,oa,Va,Qa;z=t=q=r=0;G.elements.length=0;g.updateMatrixWorld();void 0===h.parent&&h.updateMatrixWorld();U.copy(h.matrixWorldInverse.getInverse(h.matrixWorld));ea.multiplyMatrices(h.projectionMatrix,U);ca.getNormalMatrix(U);ma.setFromMatrix(ea);f=0;G.objects.length=0;G.sprites.length=0;G.lights.length=0;var Aa=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof THREE.Light)G.lights.push(f);
else if(f instanceof THREE.Mesh||f instanceof THREE.Line){if(!1===f.frustumCulled||!0===ma.intersectsObject(f))e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(L.getPositionFromMatrix(f.matrixWorld),L.applyProjection(ea),e.z=L.z),G.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(L.getPositionFromMatrix(f.matrixWorld),L.applyProjection(ea),e.z=L.z),G.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?
e.z=f.renderDepth:(L.getPositionFromMatrix(f.matrixWorld),L.applyProjection(ea),e.z=L.z),G.objects.push(e));Aa(f)}}};Aa(g);!0===l&&G.objects.sort(c);g=0;for(l=G.objects.length;g<l;g++)if(ja=G.objects[g].object,xa=ja.matrixWorld,j=0,ja instanceof THREE.Mesh){Pa=ja.geometry;ka=Pa.vertices;jb=Pa.faces;Pa=Pa.faceVertexUvs;A.getNormalMatrix(xa);Va=ja.material instanceof THREE.MeshFaceMaterial;Qa=!0===Va?ja.material:null;ta=0;for(Z=ka.length;ta<Z;ta++)i=b(),i.positionWorld.copy(ka[ta]).applyMatrix4(xa),
i.positionScreen.copy(i.positionWorld).applyMatrix4(ea),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,i.positionScreen.z/=i.positionScreen.w,i.visible=!(-1>i.positionScreen.x||1<i.positionScreen.x||-1>i.positionScreen.y||1<i.positionScreen.y||-1>i.positionScreen.z||1<i.positionScreen.z);ka=0;for(ta=jb.length;ka<ta;ka++){Z=jb[ka];var Ra=!0===Va?Qa.materials[Z.materialIndex]:ja.material;if(void 0!==Ra){la=Ra.side;if(Z instanceof THREE.Face3)if(W=m[Z.a],V=m[Z.b],ha=m[Z.c],
I[0]=W.positionScreen,I[1]=V.positionScreen,I[2]=ha.positionScreen,!0===W.visible||!0===V.visible||!0===ha.visible||P.isIntersectionBox(C.setFromPoints(I)))if(pa=0>(ha.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(ha.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x),la===THREE.DoubleSide||pa===(la===THREE.FrontSide))r===n?(oa=new THREE.RenderableFace3,s.push(oa),n++,r++,p=oa):p=s[r++],p.v1.copy(W),p.v2.copy(V),p.v3.copy(ha);else continue;
else continue;else if(Z instanceof THREE.Face4)if(W=m[Z.a],V=m[Z.b],ha=m[Z.c],oa=m[Z.d],M[0]=W.positionScreen,M[1]=V.positionScreen,M[2]=ha.positionScreen,M[3]=oa.positionScreen,!0===W.visible||!0===V.visible||!0===ha.visible||!0===oa.visible||P.isIntersectionBox(C.setFromPoints(M)))if(pa=0>(oa.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(oa.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x)||0>(V.positionScreen.x-ha.positionScreen.x)*(oa.positionScreen.y-
ha.positionScreen.y)-(V.positionScreen.y-ha.positionScreen.y)*(oa.positionScreen.x-ha.positionScreen.x),la===THREE.DoubleSide||pa===(la===THREE.FrontSide)){if(q===u){var rb=new THREE.RenderableFace4;y.push(rb);u++;q++;p=rb}else p=y[q++];p.v1.copy(W);p.v2.copy(V);p.v3.copy(ha);p.v4.copy(oa)}else continue;else continue;p.normalModel.copy(Z.normal);!1===pa&&(la===THREE.BackSide||la===THREE.DoubleSide)&&p.normalModel.negate();p.normalModel.applyMatrix3(A).normalize();p.normalModelView.copy(p.normalModel).applyMatrix3(ca);
p.centroidModel.copy(Z.centroid).applyMatrix4(xa);ha=Z.vertexNormals;W=0;for(V=ha.length;W<V;W++)oa=p.vertexNormalsModel[W],oa.copy(ha[W]),!1===pa&&(la===THREE.BackSide||la===THREE.DoubleSide)&&oa.negate(),oa.applyMatrix3(A).normalize(),p.vertexNormalsModelView[W].copy(oa).applyMatrix3(ca);p.vertexNormalsLength=ha.length;W=0;for(V=Pa.length;W<V;W++)if(oa=Pa[W][ka],void 0!==oa){la=0;for(ha=oa.length;la<ha;la++)p.uvs[W][la]=oa[la]}p.color=Z.color;p.material=Ra;ga.copy(p.centroidModel).applyProjection(ea);
p.z=ga.z;G.elements.push(p)}}}else if(ja instanceof THREE.Line){La.multiplyMatrices(ea,xa);ka=ja.geometry.vertices;W=b();W.positionScreen.copy(ka[0]).applyMatrix4(La);jb=ja.type===THREE.LinePieces?2:1;ta=1;for(Z=ka.length;ta<Z;ta++)W=b(),W.positionScreen.copy(ka[ta]).applyMatrix4(La),0<(ta+1)%jb||(V=m[j-2],N.copy(W.positionScreen),fa.copy(V.positionScreen),!0===d(N,fa)&&(N.multiplyScalar(1/N.w),fa.multiplyScalar(1/fa.w),t===J?(Pa=new THREE.RenderableLine,E.push(Pa),J++,t++,x=Pa):x=E[t++],x.v1.positionScreen.copy(N),
x.v2.positionScreen.copy(fa),x.z=Math.max(N.z,fa.z),x.material=ja.material,G.elements.push(x)))}g=0;for(l=G.sprites.length;g<l;g++)ja=G.sprites[g].object,xa=ja.matrixWorld,ja instanceof THREE.Particle&&(B.set(xa.elements[12],xa.elements[13],xa.elements[14],1),B.applyMatrix4(ea),B.z/=B.w,0<B.z&&1>B.z&&(z===K?(pa=new THREE.RenderableParticle,H.push(pa),K++,z++,F=pa):F=H[z++],F.object=ja,F.x=B.x/B.w,F.y=B.y/B.w,F.z=B.z,F.rotation=ja.rotation.z,F.scale.x=ja.scale.x*Math.abs(F.x-(B.x+h.projectionMatrix.elements[0])/
...
a*this.devicePixelRatio;y=b*this.devicePixelRatio;u=Math.floor(q/2);x=Math.floor(y/2);n.width=q;n.height=y;n.style.width=a+"px";n.style.height=b+"px";$a.set(new THREE.Vector2(-u,-x),new THREE.Vector2(u,x));ua.set(new THREE.Vector2(-u,-x),new THREE.Vector2(u,x));F=1;z=0;B=L=G=K=H=null};this.setClearColor=function(a,b){E.copy(a);J=void 0!==b?b:1;ua.set(new THREE.Vector2(-u,-x),new THREE.Vector2(u,x))};this.setClearColorHex=function(a,b){E.setHex(a);J=void 0!==b?b:1;ua.set(new THREE.Vector2(-u,-x),new THREE.Vector2(u,
x))};this.getMaxAnisotropy=function(){return 0};this.clear=function(){t.setTransform(1,0,0,-1,u,x);!1===ua.empty()&&(ua.intersect($a),ua.expandByScalar(2),1>J&&t.clearRect(ua.min.x|0,ua.min.y|0,ua.max.x-ua.min.x|0,ua.max.y-ua.min.y|0),0<J&&(c(THREE.NormalBlending),b(1),h("rgba("+Math.floor(255*E.r)+","+Math.floor(255*E.g)+","+Math.floor(255*E.b)+","+J+")"),t.fillRect(ua.min.x|0,ua.min.y|0,ua.max.x-ua.min.x|0,ua.max.y-ua.min.y|0)),ua.makeEmpty())};this.render=function(a,n){function q(a,b,c){for(var d=
0,e=r.length;d<e;d++){var f=r[d];Pa.copy(f.color);if(f instanceof THREE.DirectionalLight){var g=ab.getPositionFromMatrix(f.matrixWorld).normalize(),h=b.dot(g);0>=h||(h*=f.intensity,c.add(Pa.multiplyScalar(h)))}else f instanceof THREE.PointLight&&(g=ab.getPositionFromMatrix(f.matrixWorld),h=b.dot(ab.subVectors(g,a).normalize()),0>=h||(h*=0==f.distance?1:1-Math.min(a.distanceTo(g)/f.distance,1),0!=h&&(h*=f.intensity,c.add(Pa.multiplyScalar(h)))))}}function z(a,d,e,f,g,h,k,i){m.info.render.vertices+=
3;m.info.render.faces++;b(i.opacity);c(i.blending);A=a.positionScreen.x;ca=a.positionScreen.y;ga=d.positionScreen.x;ma=d.positionScreen.y;N=e.positionScreen.x;fa=e.positionScreen.y;y(A,ca,ga,ma,N,fa);(i instanceof THREE.MeshLambertMaterial||i instanceof THREE.MeshPhongMaterial)&&null===i.map?(ha.copy(i.color),ja.copy(i.emissive),i.vertexColors===THREE.FaceColors&&ha.multiply(k.color),!1===i.wireframe&&i.shading==THREE.SmoothShading&&3==k.vertexNormalsLength?(ka.copy(sb),W.copy(sb),V.copy(sb),q(k.v1.positionWorld,
k.vertexNormalsModel[0],ka),q(k.v2.positionWorld,k.vertexNormalsModel[1],W),q(k.v3.positionWorld,k.vertexNormalsModel[2],V),ka.multiply(ha).add(ja),W.multiply(ha).add(ja),V.multiply(ha).add(ja),la.addColors(W,V).multiplyScalar(0.5),Aa=H(ka,W,V,la),J(A,ca,ga,ma,N,fa,0,0,1,0,0,1,Aa)):(Z.copy(sb),q(k.centroidModel,k.normalModel,Z),Z.multiply(ha).add(ja),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z))):i instanceof THREE.MeshBasicMaterial||i instanceof THREE.MeshLambertMaterial||
i instanceof THREE.MeshPhongMaterial?null!==i.map?i.map.mapping instanceof THREE.UVMapping&&(Ra=k.uvs[0],C(A,ca,ga,ma,N,fa,Ra[f].x,Ra[f].y,Ra[g].x,Ra[g].y,Ra[h].x,Ra[h].y,i.map)):null!==i.envMap?i.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(ab.copy(k.vertexNormalsModelView[f]),rb=0.5*ab.x+0.5,Ob=0.5*ab.y+0.5,ab.copy(k.vertexNormalsModelView[g]),Lb=0.5*ab.x+0.5,Pb=0.5*ab.y+0.5,ab.copy(k.vertexNormalsModelView[h]),Tb=0.5*ab.x+0.5,Ub=0.5*ab.y+0.5,C(A,ca,ga,ma,N,fa,rb,Ob,Lb,Pb,Tb,Ub,
i.envMap)):(Z.copy(i.color),i.vertexColors===THREE.FaceColors&&Z.multiply(k.color),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z)):i instanceof THREE.MeshDepthMaterial?(Va=n.near,Qa=n.far,ka.r=ka.g=ka.b=1-j(a.positionScreen.z*a.positionScreen.w,Va,Qa),W.r=W.g=W.b=1-j(d.positionScreen.z*d.positionScreen.w,Va,Qa),V.r=V.g=V.b=1-j(e.positionScreen.z*e.positionScreen.w,Va,Qa),la.addColors(W,V).multiplyScalar(0.5),Aa=H(ka,W,V,la),J(A,ca,ga,ma,N,fa,0,0,1,0,0,1,Aa)):
i instanceof THREE.MeshNormalMaterial&&(i.shading==THREE.FlatShading?(a=k.normalModelView,Z.setRGB(a.x,a.y,a.z).multiplyScalar(0.5).addScalar(0.5),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z)):i.shading==THREE.SmoothShading&&(a=k.vertexNormalsModelView[f],ka.setRGB(a.x,a.y,a.z).multiplyScalar(0.5).addScalar(0.5),a=k.vertexNormalsModelView[g],W.setRGB(a.x,a.y,a.z).multiplyScalar(0.5).addScalar(0.5),a=k.vertexNormalsModelView[h],V.setRGB(a.x,a.y,a.z).multiplyScalar(0.5).addScalar(0.5),
la.addColors(W,V).multiplyScalar(0.5),Aa=H(ka,W,V,la),J(A,ca,ga,ma,N,fa,0,0,1,0,0,1,Aa)))}function y(a,b,c,d,e,f){t.beginPath();t.moveTo(a,b);t.lineTo(c,d);t.lineTo(e,f);t.closePath()}function B(a,b,c,d,e,f,g,h){t.beginPath();t.moveTo(a,b);t.lineTo(c,d);t.lineTo(e,f);t.lineTo(g,h);t.closePath()}function E(a,b,c,h){d(b);e(c);f(h);g(a.getStyle());t.stroke();Wa.expandByScalar(2*b)}function F(a){h(a.getStyle());t.fill()}function C(a,b,c,d,e,f,g,k,i,va,j,p,m){if(!(m instanceof THREE.DataTexture||void 0===
...
0,0);Ma.setRGB(0,0,0);qa.setRGB(0,0,0);for(var K=0,P=r.length;K<P;K++){var R=r[K],L=R.color;R instanceof THREE.AmbientLight?sb.add(L):R instanceof THREE.DirectionalLight?Ma.add(L):R instanceof THREE.PointLight&&qa.add(L)}K=0;for(P=p.length;K<P;K++){var da=p[K],R=da.material;if(!(void 0===R||!1===R.visible)){Wa.makeEmpty();if(da instanceof THREE.RenderableParticle){I=da;I.x*=u;I.y*=x;var L=I,va=da;b(R.opacity);c(R.blending);var ub=void 0,mb=void 0,vb=void 0,wb=void 0,Nc=da=void 0,Oc=void 0;R instanceof
THREE.ParticleBasicMaterial?null===R.map?(vb=va.object.scale.x,wb=va.object.scale.y,vb*=va.scale.x*u,wb*=va.scale.y*x,Wa.min.set(L.x-vb,L.y-wb),Wa.max.set(L.x+vb,L.y+wb),!1!==$a.isIntersectionBox(Wa)&&(h(R.color.getStyle()),t.save(),t.translate(L.x,L.y),t.rotate(-va.rotation),t.scale(vb,wb),t.fillRect(-1,-1,2,2),t.restore())):(da=R.map.image,Nc=da.width>>1,Oc=da.height>>1,vb=va.scale.x*u,wb=va.scale.y*x,ub=vb*Nc,mb=wb*Oc,Wa.min.set(L.x-ub,L.y-mb),Wa.max.set(L.x+ub,L.y+mb),!1!==$a.isIntersectionBox(Wa)&&
(t.save(),t.translate(L.x,L.y),t.rotate(-va.rotation),t.scale(vb,-wb),t.translate(-Nc,-Oc),t.drawImage(da,0,0),t.restore())):R instanceof THREE.ParticleCanvasMaterial&&(ub=va.scale.x*u,mb=va.scale.y*x,Wa.min.set(L.x-ub,L.y-mb),Wa.max.set(L.x+ub,L.y+mb),!1!==$a.isIntersectionBox(Wa)&&(g(R.color.getStyle()),h(R.color.getStyle()),t.save(),t.translate(L.x,L.y),t.rotate(-va.rotation),t.scale(ub,mb),R.program(t),t.restore()))}else if(da instanceof THREE.RenderableLine)I=da.v1,M=da.v2,I.positionScreen.x*=
u,I.positionScreen.y*=x,M.positionScreen.x*=u,M.positionScreen.y*=x,Wa.setFromPoints([I.positionScreen,M.positionScreen]),!0===$a.isIntersectionBox(Wa)&&(L=I,va=M,b(R.opacity),c(R.blending),t.beginPath(),t.moveTo(L.positionScreen.x,L.positionScreen.y),t.lineTo(va.positionScreen.x,va.positionScreen.y),R instanceof THREE.LineBasicMaterial?(d(R.linewidth),e(R.linecap),f(R.linejoin),g(R.color.getStyle()),t.stroke(),Wa.expandByScalar(2*R.linewidth)):R instanceof THREE.LineDashedMaterial&&(d(R.linewidth),
e(R.linecap),f(R.linejoin),g(R.color.getStyle()),i(R.dashSize,R.gapSize),t.stroke(),Wa.expandByScalar(2*R.linewidth),i(null,null)));else if(da instanceof THREE.RenderableFace3){I=da.v1;M=da.v2;U=da.v3;if(-1>I.positionScreen.z||1<I.positionScreen.z)continue;if(-1>M.positionScreen.z||1<M.positionScreen.z)continue;if(-1>U.positionScreen.z||1<U.positionScreen.z)continue;I.positionScreen.x*=u;I.positionScreen.y*=x;M.positionScreen.x*=u;M.positionScreen.y*=x;U.positionScreen.x*=u;U.positionScreen.y*=x;
!0===R.overdraw&&(G(I.positionScreen,M.positionScreen),G(M.positionScreen,U.positionScreen),G(U.positionScreen,I.positionScreen));Wa.setFromPoints([I.positionScreen,M.positionScreen,U.positionScreen]);z(I,M,U,0,1,2,da,R)}else if(da instanceof THREE.RenderableFace4){I=da.v1;M=da.v2;U=da.v3;ea=da.v4;if(-1>I.positionScreen.z||1<I.positionScreen.z)continue;if(-1>M.positionScreen.z||1<M.positionScreen.z)continue;if(-1>U.positionScreen.z||1<U.positionScreen.z)continue;if(-1>ea.positionScreen.z||1<ea.positionScreen.z)continue;
I.positionScreen.x*=u;I.positionScreen.y*=x;M.positionScreen.x*=u;M.positionScreen.y*=x;U.positionScreen.x*=u;U.positionScreen.y*=x;ea.positionScreen.x*=u;ea.positionScreen.y*=x;xa.positionScreen.copy(M.positionScreen);La.positionScreen.copy(ea.positionScreen);!0===R.overdraw&&(G(I.positionScreen,M.positionScreen),G(M.positionScreen,ea.positionScreen),G(ea.positionScreen,I.positionScreen),G(U.positionScreen,xa.positionScreen),G(U.positionScreen,La.positionScreen));Wa.setFromPoints([I.positionScreen,
M.positionScreen,U.positionScreen,ea.positionScreen]);L=I;va=M;ub=U;mb=ea;vb=xa;wb=La;m.info.render.vertices+=4;m.info.render.faces++;b(R.opacity);c(R.blending);void 0!==R.map&&null!==R.map||void 0!==R.envMap&&null!==R.envMap?(z(L,va,mb,0,1,3,da,R),z(vb,ub,wb,1,2,3,da,R)):(A=L.positionScreen.x,ca=L.positionScreen.y,ga=va.positionScreen.x,ma=va.positionScreen.y,N=ub.positionScreen.x,fa=ub.positionScreen.y,Ua=mb.positionScreen.x,Za=mb.positionScreen.y,eb=vb.positionScreen.x,Ja=vb.positionScreen.y,pa=
wb.positionScreen.x,ta=wb.positionScreen.y,R instanceof THREE.MeshLambertMaterial||R instanceof THREE.MeshPhongMaterial?(ha.copy(R.color),ja.copy(R.emissive),R.vertexColors===THREE.FaceColors&&ha.multiply(da.color),!1===R.wireframe&&R.shading==THREE.SmoothShading&&4==da.vertexNormalsLength?(ka.copy(sb),W.copy(sb),V.copy(sb),la.copy(sb),q(da.v1.positionWorld,da.vertexNormalsModel[0],ka),q(da.v2.positionWorld,da.vertexNormalsModel[1],W),q(da.v4.positionWorld,da.vertexNormalsModel[3],V),q(da.v3.positionWorld,
da.vertexNormalsModel[2],la),ka.multiply(ha).add(ja),W.multiply(ha).add(ja),V.multiply(ha).add(ja),la.multiply(ha).add(ja),Aa=H(ka,W,V,la),y(A,ca,ga,ma,Ua,Za),J(A,ca,ga,ma,Ua,Za,0,0,1,0,0,1,Aa),y(eb,Ja,N,fa,pa,ta),J(eb,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa)):(Z.copy(sb),q(da.centroidModel,da.normalModel,Z),Z.multiply(ha).add(ja),B(A,ca,ga,ma,N,fa,Ua,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z))):R instanceof THREE.MeshBasicMaterial?(Z.copy(R.color),R.vertexColors===
THREE.FaceColors&&Z.multiply(da.color),B(A,ca,ga,ma,N,fa,Ua,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R instanceof THREE.MeshNormalMaterial?(L=void 0,R.shading==THREE.FlatShading?(L=da.normalModelView,Z.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),B(A,ca,ga,ma,N,fa,Ua,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R.shading==THREE.SmoothShading&&(L=da.vertexNormalsModelView[0],ka.setRGB(L.x,L.y,
L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[1],W.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[3],V.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[2],la.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),Aa=H(ka,W,V,la),y(A,ca,ga,ma,Ua,Za),J(A,ca,ga,ma,Ua,Za,0,0,1,0,0,1,Aa),y(eb,Ja,N,fa,pa,ta),J(eb,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa))):R instanceof THREE.MeshDepthMaterial&&(Va=n.near,Qa=n.far,ka.r=ka.g=
ka.b=1-j(L.positionScreen.z*L.positionScreen.w,Va,Qa),W.r=W.g=W.b=1-j(va.positionScreen.z*va.positionScreen.w,Va,Qa),V.r=V.g=V.b=1-j(mb.positionScreen.z*mb.positionScreen.w,Va,Qa),la.r=la.g=la.b=1-j(ub.positionScreen.z*ub.positionScreen.w,Va,Qa),Aa=H(ka,W,V,la),y(A,ca,ga,ma,Ua,Za),J(A,ca,ga,ma,Ua,Za,0,0,1,0,0,1,Aa),y(eb,Ja,N,fa,pa,ta),J(eb,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa)))}ua.union(Wa)}}t.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
THREE.SmoothShading?THREE.SmoothShading:THREE.FlatShading}function g(a){return a.map||a.lightMap||a.bumpMap||a.normalMap||a.specularMap||a instanceof THREE.ShaderMaterial?!0:!1}function h(a){$a[a]||(k.enableVertexAttribArray(a),$a[a]=!0)}function i(){for(var a in $a)$a[a]&&(k.disableVertexAttribArray(a),$a[a]=!1)}function j(a,b){return a.z!==b.z?b.z-a.z:a.id-b.id}function m(a,b){return b[0]-a[0]}function l(a,b,c){if(a.length)for(var d=0,e=a.length;d<e;d++)ta=Za=null,Ja=pa=V=W=oa=jb=la=-1,ab=!0,a[d].render(b,
c,Tb,Ub),ta=Za=null,Ja=pa=V=W=oa=jb=la=-1,ab=!0}function p(a,b,c,d,e,f,g,h){var i,k,j,m;b?(k=a.length-1,m=b=-1):(k=0,b=a.length,m=1);for(var p=k;p!==b;p+=m)if(i=a[p],i.render){k=i.object;j=i.buffer;if(h)i=h;else{i=i[c];if(!i)continue;g&&N.setBlending(i.blending,i.blendEquation,i.blendSrc,i.blendDst);N.setDepthTest(i.depthTest);N.setDepthWrite(i.depthWrite);K(i.polygonOffset,i.polygonOffsetFactor,i.polygonOffsetUnits)}N.setMaterialFaces(i);j instanceof THREE.BufferGeometry?N.renderBufferDirect(d,e,
...
a.antialias?a.antialias:!1,A=void 0!==a.stencil?a.stencil:!0,ca=void 0!==a.preserveDrawingBuffer?a.preserveDrawingBuffer:!1,ga=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),ma=void 0!==a.clearAlpha?a.clearAlpha:0;this.domElement=M;this.context=null;this.devicePixelRatio=void 0!==a.devicePixelRatio?a.devicePixelRatio:void 0!==window.devicePixelRatio?window.devicePixelRatio:1;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=
this.autoClearColor=this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapAutoUpdate=!0;this.shadowMapType=THREE.PCFShadowMap;this.shadowMapCullFace=THREE.CullFaceFront;this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};
var N=this,fa=[],Ua=0,Za=null,eb=null,Ja=-1,pa=null,ta=null,Z=0,ka=0,W=-1,V=-1,la=-1,ha=-1,ja=-1,Pa=-1,jb=-1,oa=-1,Va=null,Qa=null,Aa=null,Ra=null,rb=0,Ob=0,Lb=0,Pb=0,Tb=0,Ub=0,$a={},ua=new THREE.Frustum,Wa=new THREE.Matrix4,sb=new THREE.Matrix4,Ma=new THREE.Vector3,qa=new THREE.Vector3,ab=!0,Bb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},
...
(k.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}});k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(ga.r,ga.g,ga.b,ma);this.context=k;var cc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),Gc=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);
...
this.setSize=function(a,b){M.width=a*this.devicePixelRatio;M.height=b*this.devicePixelRatio;M.style.width=a+"px";M.style.height=b+"px";this.setViewport(0,0,M.width,M.height)};this.setViewport=function(a,b,c,d){rb=void 0!==a?a:0;Ob=void 0!==b?b:0;Lb=void 0!==c?c:M.width;Pb=void 0!==d?d:M.height;k.viewport(rb,Ob,Lb,Pb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){ga.setHex(a);
ma=b;k.clearColor(ga.r,ga.g,ga.b,ma)};this.setClearColor=function(a,b){ga.copy(a);ma=b;k.clearColor(ga.r,ga.g,ga.b,ma)};this.getClearColor=function(){return ga};this.getClearAlpha=function(){return ma};this.clear=function(a,b,c){var d=0;if(void 0===a||a)d|=k.COLOR_BUFFER_BIT;if(void 0===b||b)d|=k.DEPTH_BUFFER_BIT;if(void 0===c||c)d|=k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};
this.addPrePlugin=function(a){a.init(this);this.renderPluginsPre.push(a)};this.updateShadowMap=function(a,b){Za=null;Ja=pa=oa=jb=la=-1;ab=!0;V=W=-1;this.shadowMapPlugin.update(a,b)};var gc=function(a){a=a.target;a.removeEventListener("dispose",gc);a.__webglInit=void 0;void 0!==a.__webglVertexBuffer&&k.deleteBuffer(a.__webglVertexBuffer);void 0!==a.__webglNormalBuffer&&k.deleteBuffer(a.__webglNormalBuffer);void 0!==a.__webglTangentBuffer&&k.deleteBuffer(a.__webglTangentBuffer);void 0!==a.__webglColorBuffer&&
k.deleteBuffer(a.__webglColorBuffer);void 0!==a.__webglUVBuffer&&k.deleteBuffer(a.__webglUVBuffer);void 0!==a.__webglUV2Buffer&&k.deleteBuffer(a.__webglUV2Buffer);void 0!==a.__webglSkinIndicesBuffer&&k.deleteBuffer(a.__webglSkinIndicesBuffer);void 0!==a.__webglSkinWeightsBuffer&&k.deleteBuffer(a.__webglSkinWeightsBuffer);void 0!==a.__webglFaceBuffer&&k.deleteBuffer(a.__webglFaceBuffer);void 0!==a.__webglLineBuffer&&k.deleteBuffer(a.__webglLineBuffer);void 0!==a.__webglLineDistanceBuffer&&k.deleteBuffer(a.__webglLineDistanceBuffer);
if(void 0!==a.geometryGroups)for(var c in a.geometryGroups){var d=a.geometryGroups[c];if(void 0!==d.numMorphTargets)for(var e=0,f=d.numMorphTargets;e<f;e++)k.deleteBuffer(d.__webglMorphTargetsBuffers[e]);if(void 0!==d.numMorphNormals){e=0;for(f=d.numMorphNormals;e<f;e++)k.deleteBuffer(d.__webglMorphNormalsBuffers[e])}b(d)}b(a);N.info.memory.geometries--},oc=function(a){a=a.target;a.removeEventListener("dispose",oc);a.image&&a.image.__webglTextureCube?k.deleteTexture(a.image.__webglTextureCube):a.__webglInit&&
(a.__webglInit=!1,k.deleteTexture(a.__webglTexture));N.info.memory.textures--},R=function(a){a=a.target;a.removeEventListener("dispose",R);if(a&&a.__webglTexture)if(k.deleteTexture(a.__webglTexture),a instanceof THREE.WebGLRenderTargetCube)for(var b=0;6>b;b++)k.deleteFramebuffer(a.__webglFramebuffer[b]),k.deleteRenderbuffer(a.__webglRenderbuffer[b]);else k.deleteFramebuffer(a.__webglFramebuffer),k.deleteRenderbuffer(a.__webglRenderbuffer);N.info.memory.textures--},pc=function(a){a=a.target;a.removeEventListener("dispose",
pc);da(a)},da=function(a){var b=a.program;if(void 0!==b){a.program=void 0;var c,d,e=!1,a=0;for(c=fa.length;a<c;a++)if(d=fa[a],d.program===b){d.usedTimes--;0===d.usedTimes&&(e=!0);break}if(!0===e){e=[];a=0;for(c=fa.length;a<c;a++)d=fa[a],d.program!==b&&e.push(d);fa=e;k.deleteProgram(b);N.info.memory.programs--}}};this.renderBufferImmediate=function(a,b,c){a.hasPositions&&!a.__webglVertexBuffer&&(a.__webglVertexBuffer=k.createBuffer());a.hasNormals&&!a.__webglNormalBuffer&&(a.__webglNormalBuffer=k.createBuffer());
a.hasUvs&&!a.__webglUvBuffer&&(a.__webglUvBuffer=k.createBuffer());a.hasColors&&!a.__webglColorBuffer&&(a.__webglColorBuffer=k.createBuffer());a.hasPositions&&(k.bindBuffer(k.ARRAY_BUFFER,a.__webglVertexBuffer),k.bufferData(k.ARRAY_BUFFER,a.positionArray,k.DYNAMIC_DRAW),k.enableVertexAttribArray(b.attributes.position),k.vertexAttribPointer(b.attributes.position,3,k.FLOAT,!1,0,0));if(a.hasNormals){k.bindBuffer(k.ARRAY_BUFFER,a.__webglNormalBuffer);if(c.shading===THREE.FlatShading){var d,e,f,g,h,i,
...
i,m,!0,d));l(this.renderPluginsPost,a,b);c&&(c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&c.minFilter!==THREE.LinearFilter)&&(c instanceof THREE.WebGLRenderTargetCube?(k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture),k.generateMipmap(k.TEXTURE_CUBE_MAP),k.bindTexture(k.TEXTURE_CUBE_MAP,null)):(k.bindTexture(k.TEXTURE_2D,c.__webglTexture),k.generateMipmap(k.TEXTURE_2D),k.bindTexture(k.TEXTURE_2D,null)));this.setDepthTest(!0);this.setDepthWrite(!0)}};this.renderImmediateObject=function(a,
b,c,d,e){var f=E(a,b,c,d,e);pa=-1;N.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,k,ua):e.render(function(a){N.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;)s(a.__objectsAdded[0],a),a.__objectsAdded.splice(0,1);for(;a.__objectsRemoved.length;)u(a.__objectsRemoved[0],a),a.__objectsRemoved.splice(0,1);for(var b=0,c=
...
r)),B.needsUpdate=!1),t&&!B.dynamic&&delete B.array}else if(i instanceof THREE.Mesh){for(var E=0,F=j.geometryGroupsList.length;E<F;E++)if(l=j.geometryGroupsList[E],n=e(i,l),j.buffersNeedUpdate&&d(l,i),p=n.attributes&&q(n),j.verticesNeedUpdate||j.morphTargetsNeedUpdate||j.elementsNeedUpdate||j.uvsNeedUpdate||j.normalsNeedUpdate||j.colorsNeedUpdate||j.tangentsNeedUpdate||p){var C=l,J=i,G=k.DYNAMIC_DRAW,I=!j.dynamic,H=n;if(C.__inittedArrays){var L=f(H),K=H.vertexColors?H.vertexColors:!1,N=g(H),M=L===
THREE.SmoothShading,D=void 0,A=void 0,fa=void 0,O=void 0,U=void 0,R=void 0,P=void 0,W=void 0,V=void 0,Z=void 0,ka=void 0,S=void 0,T=void 0,Q=void 0,aa=void 0,ta=void 0,ca=void 0,da=void 0,Za=void 0,ea=void 0,ga=void 0,ha=void 0,la=void 0,Ua=void 0,ja=void 0,pa=void 0,ma=void 0,oa=void 0,Ja=void 0,eb=void 0,xa=void 0,qa=void 0,ua=void 0,Aa=void 0,Pa=void 0,wa=void 0,ab=void 0,La=void 0,Sa=void 0,Va=void 0,bb=void 0,jb=void 0,Xa=void 0,Ya=void 0,Qa=void 0,Ra=void 0,Ka=0,Oa=0,Ta=0,$a=0,xb=0,hb=0,Ba=
0,lb=0,Na=0,Y=0,ia=0,w=0,ya=void 0,cb=C.__vertexArray,kb=C.__uvArray,rb=C.__uv2Array,yb=C.__normalArray,Fa=C.__tangentArray,db=C.__colorArray,Ga=C.__skinIndexArray,Ha=C.__skinWeightArray,Bb=C.__morphTargetsArrays,Cb=C.__morphNormalsArrays,Db=C.__webglCustomAttributesList,v=void 0,Gb=C.__faceArray,tb=C.__lineArray,nb=J.geometry,Ob=nb.elementsNeedUpdate,Lb=nb.uvsNeedUpdate,Pb=nb.normalsNeedUpdate,Tb=nb.tangentsNeedUpdate,Ub=nb.colorsNeedUpdate,ec=nb.morphTargetsNeedUpdate,Wb=nb.vertices,ra=C.faces3,
sa=C.faces4,ib=nb.faces,Vb=nb.faceVertexUvs[0],Pc=nb.faceVertexUvs[1],Xb=nb.skinIndices,Qb=nb.skinWeights,Rb=nb.morphTargets,qc=nb.morphNormals;if(nb.verticesNeedUpdate){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],S=Wb[O.a],T=Wb[O.b],Q=Wb[O.c],cb[Oa]=S.x,cb[Oa+1]=S.y,cb[Oa+2]=S.z,cb[Oa+3]=T.x,cb[Oa+4]=T.y,cb[Oa+5]=T.z,cb[Oa+6]=Q.x,cb[Oa+7]=Q.y,cb[Oa+8]=Q.z,Oa+=9;D=0;for(A=sa.length;D<A;D++)O=ib[sa[D]],S=Wb[O.a],T=Wb[O.b],Q=Wb[O.c],aa=Wb[O.d],cb[Oa]=S.x,cb[Oa+1]=S.y,cb[Oa+2]=S.z,cb[Oa+3]=T.x,cb[Oa+4]=
T.y,cb[Oa+5]=T.z,cb[Oa+6]=Q.x,cb[Oa+7]=Q.y,cb[Oa+8]=Q.z,cb[Oa+9]=aa.x,cb[Oa+10]=aa.y,cb[Oa+11]=aa.z,Oa+=12;k.bindBuffer(k.ARRAY_BUFFER,C.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,cb,G)}if(ec){bb=0;for(jb=Rb.length;bb<jb;bb++){D=ia=0;for(A=ra.length;D<A;D++)Qa=ra[D],O=ib[Qa],S=Rb[bb].vertices[O.a],T=Rb[bb].vertices[O.b],Q=Rb[bb].vertices[O.c],Xa=Bb[bb],Xa[ia]=S.x,Xa[ia+1]=S.y,Xa[ia+2]=S.z,Xa[ia+3]=T.x,Xa[ia+4]=T.y,Xa[ia+5]=T.z,Xa[ia+6]=Q.x,Xa[ia+7]=Q.y,Xa[ia+8]=Q.z,H.morphNormals&&(M?(Ra=qc[bb].vertexNormals[Qa],
ea=Ra.a,ga=Ra.b,ha=Ra.c):ha=ga=ea=qc[bb].faceNormals[Qa],Ya=Cb[bb],Ya[ia]=ea.x,Ya[ia+1]=ea.y,Ya[ia+2]=ea.z,Ya[ia+3]=ga.x,Ya[ia+4]=ga.y,Ya[ia+5]=ga.z,Ya[ia+6]=ha.x,Ya[ia+7]=ha.y,Ya[ia+8]=ha.z),ia+=9;D=0;for(A=sa.length;D<A;D++)Qa=sa[D],O=ib[Qa],S=Rb[bb].vertices[O.a],T=Rb[bb].vertices[O.b],Q=Rb[bb].vertices[O.c],aa=Rb[bb].vertices[O.d],Xa=Bb[bb],Xa[ia]=S.x,Xa[ia+1]=S.y,Xa[ia+2]=S.z,Xa[ia+3]=T.x,Xa[ia+4]=T.y,Xa[ia+5]=T.z,Xa[ia+6]=Q.x,Xa[ia+7]=Q.y,Xa[ia+8]=Q.z,Xa[ia+9]=aa.x,Xa[ia+10]=aa.y,Xa[ia+11]=
aa.z,H.morphNormals&&(M?(Ra=qc[bb].vertexNormals[Qa],ea=Ra.a,ga=Ra.b,ha=Ra.c,la=Ra.d):la=ha=ga=ea=qc[bb].faceNormals[Qa],Ya=Cb[bb],Ya[ia]=ea.x,Ya[ia+1]=ea.y,Ya[ia+2]=ea.z,Ya[ia+3]=ga.x,Ya[ia+4]=ga.y,Ya[ia+5]=ga.z,Ya[ia+6]=ha.x,Ya[ia+7]=ha.y,Ya[ia+8]=ha.z,Ya[ia+9]=la.x,Ya[ia+10]=la.y,Ya[ia+11]=la.z),ia+=12;k.bindBuffer(k.ARRAY_BUFFER,C.__webglMorphTargetsBuffers[bb]);k.bufferData(k.ARRAY_BUFFER,Bb[bb],G);H.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglMorphNormalsBuffers[bb]),k.bufferData(k.ARRAY_BUFFER,
Cb[bb],G))}}if(Qb.length){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],oa=Qb[O.a],Ja=Qb[O.b],eb=Qb[O.c],Ha[Y]=oa.x,Ha[Y+1]=oa.y,Ha[Y+2]=oa.z,Ha[Y+3]=oa.w,Ha[Y+4]=Ja.x,Ha[Y+5]=Ja.y,Ha[Y+6]=Ja.z,Ha[Y+7]=Ja.w,Ha[Y+8]=eb.x,Ha[Y+9]=eb.y,Ha[Y+10]=eb.z,Ha[Y+11]=eb.w,qa=Xb[O.a],ua=Xb[O.b],Aa=Xb[O.c],Ga[Y]=qa.x,Ga[Y+1]=qa.y,Ga[Y+2]=qa.z,Ga[Y+3]=qa.w,Ga[Y+4]=ua.x,Ga[Y+5]=ua.y,Ga[Y+6]=ua.z,Ga[Y+7]=ua.w,Ga[Y+8]=Aa.x,Ga[Y+9]=Aa.y,Ga[Y+10]=Aa.z,Ga[Y+11]=Aa.w,Y+=12;D=0;for(A=sa.length;D<A;D++)O=ib[sa[D]],oa=Qb[O.a],
Ja=Qb[O.b],eb=Qb[O.c],xa=Qb[O.d],Ha[Y]=oa.x,Ha[Y+1]=oa.y,Ha[Y+2]=oa.z,Ha[Y+3]=oa.w,Ha[Y+4]=Ja.x,Ha[Y+5]=Ja.y,Ha[Y+6]=Ja.z,Ha[Y+7]=Ja.w,Ha[Y+8]=eb.x,Ha[Y+9]=eb.y,Ha[Y+10]=eb.z,Ha[Y+11]=eb.w,Ha[Y+12]=xa.x,Ha[Y+13]=xa.y,Ha[Y+14]=xa.z,Ha[Y+15]=xa.w,qa=Xb[O.a],ua=Xb[O.b],Aa=Xb[O.c],Pa=Xb[O.d],Ga[Y]=qa.x,Ga[Y+1]=qa.y,Ga[Y+2]=qa.z,Ga[Y+3]=qa.w,Ga[Y+4]=ua.x,Ga[Y+5]=ua.y,Ga[Y+6]=ua.z,Ga[Y+7]=ua.w,Ga[Y+8]=Aa.x,Ga[Y+9]=Aa.y,Ga[Y+10]=Aa.z,Ga[Y+11]=Aa.w,Ga[Y+12]=Pa.x,Ga[Y+13]=Pa.y,Ga[Y+14]=Pa.z,Ga[Y+15]=Pa.w,
Y+=16;0<Y&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ga,G),k.bindBuffer(k.ARRAY_BUFFER,C.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ha,G))}if(Ub&&K){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],P=O.vertexColors,W=O.color,3===P.length&&K===THREE.VertexColors?(Ua=P[0],ja=P[1],pa=P[2]):pa=ja=Ua=W,db[Na]=Ua.r,db[Na+1]=Ua.g,db[Na+2]=Ua.b,db[Na+3]=ja.r,db[Na+4]=ja.g,db[Na+5]=ja.b,db[Na+6]=pa.r,db[Na+7]=pa.g,db[Na+8]=pa.b,Na+=9;D=0;for(A=sa.length;D<A;D++)O=
ib[sa[D]],P=O.vertexColors,W=O.color,4===P.length&&K===THREE.VertexColors?(Ua=P[0],ja=P[1],pa=P[2],ma=P[3]):ma=pa=ja=Ua=W,db[Na]=Ua.r,db[Na+1]=Ua.g,db[Na+2]=Ua.b,db[Na+3]=ja.r,db[Na+4]=ja.g,db[Na+5]=ja.b,db[Na+6]=pa.r,db[Na+7]=pa.g,db[Na+8]=pa.b,db[Na+9]=ma.r,db[Na+10]=ma.g,db[Na+11]=ma.b,Na+=12;0<Na&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,db,G))}if(Tb&&nb.hasTangents){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Fa[Ba]=
ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Ba+=12;D=0;for(A=sa.length;D<A;D++)O=ib[sa[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Za=V[3],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Fa[Ba+12]=Za.x,Fa[Ba+13]=Za.y,Fa[Ba+14]=Za.z,Fa[Ba+15]=Za.w,Ba+=16;k.bindBuffer(k.ARRAY_BUFFER,
C.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Fa,G)}if(Pb&&L){D=0;for(A=ra.length;D<A;D++)if(O=ib[ra[D]],U=O.vertexNormals,R=O.normal,3===U.length&&M)for(wa=0;3>wa;wa++)La=U[wa],yb[hb]=La.x,yb[hb+1]=La.y,yb[hb+2]=La.z,hb+=3;else for(wa=0;3>wa;wa++)yb[hb]=R.x,yb[hb+1]=R.y,yb[hb+2]=R.z,hb+=3;D=0;for(A=sa.length;D<A;D++)if(O=ib[sa[D]],U=O.vertexNormals,R=O.normal,4===U.length&&M)for(wa=0;4>wa;wa++)La=U[wa],yb[hb]=La.x,yb[hb+1]=La.y,yb[hb+2]=La.z,hb+=3;else for(wa=0;4>wa;wa++)yb[hb]=R.x,yb[hb+1]=
R.y,yb[hb+2]=R.z,hb+=3;k.bindBuffer(k.ARRAY_BUFFER,C.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yb,G)}if(Lb&&Vb&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],Z=Vb[fa],void 0!==Z)for(wa=0;3>wa;wa++)Sa=Z[wa],kb[Ta]=Sa.x,kb[Ta+1]=Sa.y,Ta+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],Z=Vb[fa],void 0!==Z)for(wa=0;4>wa;wa++)Sa=Z[wa],kb[Ta]=Sa.x,kb[Ta+1]=Sa.y,Ta+=2;0<Ta&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,kb,G))}if(Lb&&Pc&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],
ka=Pc[fa],void 0!==ka)for(wa=0;3>wa;wa++)Va=ka[wa],rb[$a]=Va.x,rb[$a+1]=Va.y,$a+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],ka=Pc[fa],void 0!==ka)for(wa=0;4>wa;wa++)Va=ka[wa],rb[$a]=Va.x,rb[$a+1]=Va.y,$a+=2;0<$a&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,rb,G))}if(Ob){D=0;for(A=ra.length;D<A;D++)Gb[xb]=Ka,Gb[xb+1]=Ka+1,Gb[xb+2]=Ka+2,xb+=3,tb[lb]=Ka,tb[lb+1]=Ka+1,tb[lb+2]=Ka,tb[lb+3]=Ka+2,tb[lb+4]=Ka+1,tb[lb+5]=Ka+2,lb+=6,Ka+=3;D=0;for(A=sa.length;D<A;D++)Gb[xb]=Ka,
Gb[xb+1]=Ka+1,Gb[xb+2]=Ka+3,Gb[xb+3]=Ka+1,Gb[xb+4]=Ka+2,Gb[xb+5]=Ka+3,xb+=6,tb[lb]=Ka,tb[lb+1]=Ka+1,tb[lb+2]=Ka,tb[lb+3]=Ka+3,tb[lb+4]=Ka+1,tb[lb+5]=Ka+2,tb[lb+6]=Ka+2,tb[lb+7]=Ka+3,lb+=8,Ka+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Gb,G);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,tb,G)}if(Db){wa=0;for(ab=Db.length;wa<ab;wa++)if(v=Db[wa],v.__original.needsUpdate){w=0;if(1===v.size)if(void 0===v.boundTo||
"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],w+=3;D=0;for(A=sa.length;D<A;D++)O=ib[sa[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],v.array[w+3]=v.value[O.d],w+=4}else{if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],v.array[w]=ya,v.array[w+1]=ya,v.array[w+2]=ya,w+=3;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],v.array[w]=ya,v.array[w+1]=ya,v.array[w+
2]=ya,v.array[w+3]=ya,w+=4}}else if(2===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,w+=6;D=0;for(A=sa.length;D<A;D++)O=ib[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,v.array[w+6]=aa.x,
v.array[w+7]=aa.y,w+=8}else{if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,w+=6;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,v.array[w+6]=aa.x,v.array[w+7]=aa.y,w+=8}}else if(3===v.size){var X;X="c"===v.type?["r","g","b"]:["x","y","z"];if(void 0===v.boundTo||"vertices"===
v.boundTo){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)O=ib[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+
5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}else if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S[X[0]],v.array[w+
1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}else if("faceVertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],S=ya[0],T=ya[1],Q=ya[2],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],
v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],S=ya[0],T=ya[1],Q=ya[2],aa=ya[3],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}}else if(4===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],S=v.value[O.a],T=v.value[O.b],
Q=v.value[O.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)O=ib[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+
10]=Q.z,v.array[w+11]=Q.w,v.array[w+12]=aa.x,v.array[w+13]=aa.y,v.array[w+14]=aa.z,v.array[w+15]=aa.w,w+=16}else if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,
v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,v.array[w+12]=aa.x,v.array[w+13]=aa.y,v.array[w+14]=aa.z,v.array[w+15]=aa.w,w+=16}else if("faceVertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],S=ya[0],T=ya[1],Q=ya[2],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+
9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],S=ya[0],T=ya[1],Q=ya[2],aa=ya[3],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,v.array[w+12]=aa.x,v.array[w+13]=aa.y,v.array[w+14]=aa.z,v.array[w+15]=aa.w,w+=16}k.bindBuffer(k.ARRAY_BUFFER,v.buffer);k.bufferData(k.ARRAY_BUFFER,v.array,G)}}I&&(delete C.__inittedArrays,
delete C.__colorArray,delete C.__normalArray,delete C.__tangentArray,delete C.__uvArray,delete C.__uv2Array,delete C.__faceArray,delete C.__vertexArray,delete C.__lineArray,delete C.__skinIndexArray,delete C.__skinWeightArray)}}j.verticesNeedUpdate=!1;j.morphTargetsNeedUpdate=!1;j.elementsNeedUpdate=!1;j.uvsNeedUpdate=!1;j.normalsNeedUpdate=!1;j.colorsNeedUpdate=!1;j.tangentsNeedUpdate=!1;j.buffersNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof THREE.Ribbon){n=e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||
j.colorsNeedUpdate||j.normalsNeedUpdate||p){var zb=j,rc=k.DYNAMIC_DRAW,hc=void 0,ic=void 0,jc=void 0,sc=void 0,za=void 0,tc=void 0,uc=void 0,vc=void 0,cc=void 0,fb=void 0,$b=void 0,Da=void 0,ob=void 0,dc=zb.vertices,fc=zb.colors,gc=zb.normals,oc=dc.length,pc=fc.length,Gc=gc.length,wc=zb.__vertexArray,xc=zb.__colorArray,yc=zb.__normalArray,Hc=zb.colorsNeedUpdate,Ic=zb.normalsNeedUpdate,Qc=zb.__webglCustomAttributesList;if(zb.verticesNeedUpdate){for(hc=0;hc<oc;hc++)sc=dc[hc],za=3*hc,wc[za]=sc.x,wc[za+
1]=sc.y,wc[za+2]=sc.z;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,wc,rc)}if(Hc){for(ic=0;ic<pc;ic++)tc=fc[ic],za=3*ic,xc[za]=tc.r,xc[za+1]=tc.g,xc[za+2]=tc.b;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,xc,rc)}if(Ic){for(jc=0;jc<Gc;jc++)uc=gc[jc],za=3*jc,yc[za]=uc.x,yc[za+1]=uc.y,yc[za+2]=uc.z;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yc,rc)}if(Qc){vc=0;for(cc=Qc.length;vc<cc;vc++)if(Da=Qc[vc],
Da.needsUpdate&&(void 0===Da.boundTo||"vertices"===Da.boundTo)){za=0;$b=Da.value.length;if(1===Da.size)for(fb=0;fb<$b;fb++)Da.array[fb]=Da.value[fb];else if(2===Da.size)for(fb=0;fb<$b;fb++)ob=Da.value[fb],Da.array[za]=ob.x,Da.array[za+1]=ob.y,za+=2;else if(3===Da.size)if("c"===Da.type)for(fb=0;fb<$b;fb++)ob=Da.value[fb],Da.array[za]=ob.r,Da.array[za+1]=ob.g,Da.array[za+2]=ob.b,za+=3;else for(fb=0;fb<$b;fb++)ob=Da.value[fb],Da.array[za]=ob.x,Da.array[za+1]=ob.y,Da.array[za+2]=ob.z,za+=3;else if(4===
Da.size)for(fb=0;fb<$b;fb++)ob=Da.value[fb],Da.array[za]=ob.x,Da.array[za+1]=ob.y,Da.array[za+2]=ob.z,Da.array[za+3]=ob.w,za+=4;k.bindBuffer(k.ARRAY_BUFFER,Da.buffer);k.bufferData(k.ARRAY_BUFFER,Da.array,rc)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.normalsNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof THREE.Line){n=e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||j.colorsNeedUpdate||j.lineDistancesNeedUpdate||p){var Ab=j,zc=k.DYNAMIC_DRAW,kc=void 0,lc=void 0,mc=void 0,Ac=void 0,
Ia=void 0,Bc=void 0,Vc=Ab.vertices,Wc=Ab.colors,Xc=Ab.lineDistances,Jc=Vc.length,Kc=Wc.length,Lc=Xc.length,Cc=Ab.__vertexArray,Dc=Ab.__colorArray,Yc=Ab.__lineDistanceArray,Mc=Ab.colorsNeedUpdate,cd=Ab.lineDistancesNeedUpdate,Rc=Ab.__webglCustomAttributesList,Ec=void 0,Zc=void 0,gb=void 0,ac=void 0,pb=void 0,Ea=void 0;if(Ab.verticesNeedUpdate){for(kc=0;kc<Jc;kc++)Ac=Vc[kc],Ia=3*kc,Cc[Ia]=Ac.x,Cc[Ia+1]=Ac.y,Cc[Ia+2]=Ac.z;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,
Cc,zc)}if(Mc){for(lc=0;lc<Kc;lc++)Bc=Wc[lc],Ia=3*lc,Dc[Ia]=Bc.r,Dc[Ia+1]=Bc.g,Dc[Ia+2]=Bc.b;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Dc,zc)}if(cd){for(mc=0;mc<Lc;mc++)Yc[mc]=Xc[mc];k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,Yc,zc)}if(Rc){Ec=0;for(Zc=Rc.length;Ec<Zc;Ec++)if(Ea=Rc[Ec],Ea.needsUpdate&&(void 0===Ea.boundTo||"vertices"===Ea.boundTo)){Ia=0;ac=Ea.value.length;if(1===Ea.size)for(gb=0;gb<ac;gb++)Ea.array[gb]=
Ea.value[gb];else if(2===Ea.size)for(gb=0;gb<ac;gb++)pb=Ea.value[gb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ia+=2;else if(3===Ea.size)if("c"===Ea.type)for(gb=0;gb<ac;gb++)pb=Ea.value[gb],Ea.array[Ia]=pb.r,Ea.array[Ia+1]=pb.g,Ea.array[Ia+2]=pb.b,Ia+=3;else for(gb=0;gb<ac;gb++)pb=Ea.value[gb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ea.array[Ia+2]=pb.z,Ia+=3;else if(4===Ea.size)for(gb=0;gb<ac;gb++)pb=Ea.value[gb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ea.array[Ia+2]=pb.z,Ea.array[Ia+3]=pb.w,Ia+=4;k.bindBuffer(k.ARRAY_BUFFER,
Ea.buffer);k.bufferData(k.ARRAY_BUFFER,Ea.array,zc)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.lineDistancesNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof THREE.ParticleSystem){n=e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||j.colorsNeedUpdate||i.sortParticles||p){var Hb=j,Sc=k.DYNAMIC_DRAW,nc=i,qb=void 0,Ib=void 0,Jb=void 0,ba=void 0,Kb=void 0,Sb=void 0,Fc=Hb.vertices,Tc=Fc.length,Uc=Hb.colors,$c=Uc.length,Yb=Hb.__vertexArray,Zb=Hb.__colorArray,Mb=Hb.__sortArray,ad=Hb.verticesNeedUpdate,
bd=Hb.colorsNeedUpdate,Nb=Hb.__webglCustomAttributesList,Eb=void 0,bc=void 0,na=void 0,Fb=void 0,Ca=void 0,$=void 0;if(nc.sortParticles){sb.copy(Wa);sb.multiply(nc.matrixWorld);for(qb=0;qb<Tc;qb++)Jb=Fc[qb],Ma.copy(Jb),Ma.applyProjection(sb),Mb[qb]=[Ma.z,qb];Mb.sort(m);for(qb=0;qb<Tc;qb++)Jb=Fc[Mb[qb][1]],ba=3*qb,Yb[ba]=Jb.x,Yb[ba+1]=Jb.y,Yb[ba+2]=Jb.z;for(Ib=0;Ib<$c;Ib++)ba=3*Ib,Sb=Uc[Mb[Ib][1]],Zb[ba]=Sb.r,Zb[ba+1]=Sb.g,Zb[ba+2]=Sb.b;if(Nb){Eb=0;for(bc=Nb.length;Eb<bc;Eb++)if($=Nb[Eb],void 0===
$.boundTo||"vertices"===$.boundTo)if(ba=0,Fb=$.value.length,1===$.size)for(na=0;na<Fb;na++)Kb=Mb[na][1],$.array[na]=$.value[Kb];else if(2===$.size)for(na=0;na<Fb;na++)Kb=Mb[na][1],Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,ba+=2;else if(3===$.size)if("c"===$.type)for(na=0;na<Fb;na++)Kb=Mb[na][1],Ca=$.value[Kb],$.array[ba]=Ca.r,$.array[ba+1]=Ca.g,$.array[ba+2]=Ca.b,ba+=3;else for(na=0;na<Fb;na++)Kb=Mb[na][1],Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,ba+=3;else if(4===
$.size)for(na=0;na<Fb;na++)Kb=Mb[na][1],Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,$.array[ba+3]=Ca.w,ba+=4}}else{if(ad)for(qb=0;qb<Tc;qb++)Jb=Fc[qb],ba=3*qb,Yb[ba]=Jb.x,Yb[ba+1]=Jb.y,Yb[ba+2]=Jb.z;if(bd)for(Ib=0;Ib<$c;Ib++)Sb=Uc[Ib],ba=3*Ib,Zb[ba]=Sb.r,Zb[ba+1]=Sb.g,Zb[ba+2]=Sb.b;if(Nb){Eb=0;for(bc=Nb.length;Eb<bc;Eb++)if($=Nb[Eb],$.needsUpdate&&(void 0===$.boundTo||"vertices"===$.boundTo))if(Fb=$.value.length,ba=0,1===$.size)for(na=0;na<Fb;na++)$.array[na]=$.value[na];
else if(2===$.size)for(na=0;na<Fb;na++)Ca=$.value[na],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,ba+=2;else if(3===$.size)if("c"===$.type)for(na=0;na<Fb;na++)Ca=$.value[na],$.array[ba]=Ca.r,$.array[ba+1]=Ca.g,$.array[ba+2]=Ca.b,ba+=3;else for(na=0;na<Fb;na++)Ca=$.value[na],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,ba+=3;else if(4===$.size)for(na=0;na<Fb;na++)Ca=$.value[na],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,$.array[ba+3]=Ca.w,ba+=4}}if(ad||nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,
Hb.__webglVertexBuffer),k.bufferData(k.ARRAY_BUFFER,Yb,Sc);if(bd||nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,Hb.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Zb,Sc);if(Nb){Eb=0;for(bc=Nb.length;Eb<bc;Eb++)if($=Nb[Eb],$.needsUpdate||nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,$.buffer),k.bufferData(k.ARRAY_BUFFER,$.array,Sc)}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;n.attributes&&y(n)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h;a.addEventListener("dispose",pc);var i,j,l,m,p;a instanceof
THREE.MeshDepthMaterial?p="depth":a instanceof THREE.MeshNormalMaterial?p="normal":a instanceof THREE.MeshBasicMaterial?p="basic":a instanceof THREE.MeshLambertMaterial?p="lambert":a instanceof THREE.MeshPhongMaterial?p="phong":a instanceof THREE.LineBasicMaterial?p="basic":a instanceof THREE.LineDashedMaterial?p="dashed":a instanceof THREE.ParticleBasicMaterial&&(p="particle_basic");if(p){var n=THREE.ShaderLib[p];a.uniforms=THREE.UniformsUtils.clone(n.uniforms);a.vertexShader=n.vertexShader;a.fragmentShader=
n.fragmentShader}var q,r,s;e=g=r=s=n=0;for(f=b.length;e<f;e++)q=b[e],q.onlyShadow||(q instanceof THREE.DirectionalLight&&g++,q instanceof THREE.PointLight&&r++,q instanceof THREE.SpotLight&&s++,q instanceof THREE.HemisphereLight&&n++);e=g;f=r;g=s;h=n;n=q=0;for(s=b.length;n<s;n++)r=b[n],r.castShadow&&(r instanceof THREE.SpotLight&&q++,r instanceof THREE.DirectionalLight&&!r.shadowCascade&&q++);m=q;Vb&&d&&d.useVertexTexture?l=1024:(b=k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS),b=Math.floor((b-20)/
...
y);for(y=0;y<c.maxMorphNormals;y++)t.push("morphNormal"+y);for(j in b)t.push(j);j=t;y=0;for(b=j.length;y<b;y++)t=j[y],u.attributes[t]=k.getAttribLocation(u,t);u.id=Ua++;fa.push({program:u,code:p,usedTimes:1});N.info.memory.programs=fa.length;j=u}a.program=j;y=a.program.attributes;if(a.morphTargets){a.numSupportedMorphTargets=0;b="morphTarget";for(j=0;j<this.maxMorphTargets;j++)u=b+j,0<=y[u]&&a.numSupportedMorphTargets++}if(a.morphNormals){a.numSupportedMorphNormals=0;b="morphNormal";for(j=0;j<this.maxMorphNormals;j++)u=
...
b&&(b?k.disable(k.CULL_FACE):k.enable(k.CULL_FACE),W=b);V!==a&&(a?k.frontFace(k.CW):k.frontFace(k.CCW),V=a)};this.setDepthTest=function(a){jb!==a&&(a?k.enable(k.DEPTH_TEST):k.disable(k.DEPTH_TEST),jb=a)};this.setDepthWrite=function(a){oa!==a&&(k.depthMask(a),oa=a)};this.setBlending=function(a,b,c,d){a!==la&&(a===THREE.NoBlending?k.disable(k.BLEND):a===THREE.AdditiveBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.SRC_ALPHA,k.ONE)):a===THREE.SubtractiveBlending?(k.enable(k.BLEND),
k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?(k.enable(k.BLEND),k.blendEquation(k.FUNC_ADD),k.blendFunc(k.ZERO,k.SRC_COLOR)):a===THREE.CustomBlending?k.enable(k.BLEND):(k.enable(k.BLEND),k.blendEquationSeparate(k.FUNC_ADD,k.FUNC_ADD),k.blendFuncSeparate(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA,k.ONE,k.ONE_MINUS_SRC_ALPHA)),la=a);if(a===THREE.CustomBlending){if(b!==ha&&(k.blendEquation(I(b)),ha=b),c!==ja||d!==Pa)k.blendFunc(I(c),I(d)),ja=c,Pa=d}else Pa=
ja=ha=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.addEventListener("dispose",oc),a.__webglTexture=k.createTexture(),N.info.memory.textures++);k.activeTexture(k.TEXTURE0+b);k.bindTexture(k.TEXTURE_2D,a.__webglTexture);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,a.flipY);k.pixelStorei(k.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);k.pixelStorei(k.UNPACK_ALIGNMENT,a.unpackAlignment);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=I(a.format),
...
(C=0),I===ca&&(I=0),La[A]=d(s[A],s[C],s[I]);var ga=[],ma,N=La.concat();H=0;for(K=p.length;H<K;H++){z=p[H];ma=[];A=0;ca=z.length;C=ca-1;for(I=A+1;A<ca;A++,C++,I++)C===ca&&(C=0),I===ca&&(I=0),ma[A]=d(z[A],z[C],z[I]);ga.push(ma);N=N.concat(ma)}for(C=0;C<m;C++){z=C/m;M=i*(1-z);I=j*Math.sin(z*Math.PI/2);A=0;for(ca=s.length;A<ca;A++)U=c(s[A],La[A],I),f(U.x,U.y,-M);H=0;for(K=p.length;H<K;H++){z=p[H];ma=ga[H];A=0;for(ca=z.length;A<ca;A++)U=c(z[A],ma[A],I),f(U.x,U.y,-M)}}I=j;for(A=0;A<ea;A++)U=l?c(B[A],N[A],
...
K;H++){z=p[H];ma=ga[H];A=0;for(ca=z.length;A<ca;A++)U=c(z[A],ma[A],I),q?f(U.x,U.y+n[r-1].y,n[r-1].x+M):f(U.x,U.y,h+M)}}if(l){i=0*ea;for(A=0;A<xa;A++)h=P[A],g(h[2]+i,h[1]+i,h[0]+i,!0);i=ea*(r+2*m);for(A=0;A<xa;A++)h=P[A],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(A=0;A<xa;A++)h=P[A],g(h[2],h[1],h[0],!0);for(A=0;A<xa;A++)h=P[A],g(h[0]+ea*r,h[1]+ea*r,h[2]+ea*r,!1)}h=0;e(s,h);h+=s.length;H=0;for(K=p.length;H<K;H++)z=p[H],e(z,h),h+=z.length};
