...
c)return!1;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return!0}var e,f,g=[],h=0,i,k,n=[],p=0,m,r,s=[],l=0,q,u=[],B=0,x,t,F=[],C=0,z,A,H=[],G=0,I={objects:[],sprites:[],lights:[],elements:[]},$=new THREE.Vector3,D=new THREE.Vector4,L=new THREE.Matrix4,y=new THREE.Matrix4,K=new THREE.Matrix3,J=new THREE.Frustum,R=new THREE.Vector4,P=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);L.multiply(b.projectionMatrix,b.matrixWorldInverse);L.multiplyVector3(a);return a};
this.unprojectVector=function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);L.multiply(b.matrixWorld,b.projectionMatrixInverse);L.multiplyVector3(a);return a};this.pickingRay=function(a,b){a.z=-1;var c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Raycaster(a,c)};this.projectScene=function(g,h,p,pa){var ya=h.near,ua=h.far,N=!1,O,aa,ea,V,ia,Z,fa,oa,za,Da,Ua,sa,mb,Cb,ob;A=t=q=r=0;I.elements.length=0;g.updateMatrixWorld();
void 0===h.parent&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);L.multiply(h.projectionMatrix,h.matrixWorldInverse);J.setFromMatrix(L);f=0;I.objects.length=0;I.sprites.length=0;I.lights.length=0;var db=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof THREE.Light)I.lights.push(f);else if(f instanceof THREE.Mesh||f instanceof THREE.Line){if(!1===f.frustumCulled||!0===J.contains(f))e=a(),e.object=f,null!==f.renderDepth?
e.z=f.renderDepth:($.copy(f.matrixWorld.getPosition()),L.multiplyVector3($),e.z=$.z),I.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:($.copy(f.matrixWorld.getPosition()),L.multiplyVector3($),e.z=$.z),I.sprites.push(e)):(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:($.copy(f.matrixWorld.getPosition()),L.multiplyVector3($),e.z=$.z),I.objects.push(e));db(f)}}};db(g);!0===p&&I.objects.sort(c);g=0;for(p=I.objects.length;g<
p;g++)if(oa=I.objects[g].object,za=oa.matrixWorld,k=0,oa instanceof THREE.Mesh){Da=oa.geometry;ea=Da.vertices;Ua=Da.faces;Da=Da.faceVertexUvs;K.getInverse(za);K.transpose();mb=oa.material instanceof THREE.MeshFaceMaterial;Cb=!0===mb?oa.material:null;O=0;for(aa=ea.length;O<aa;O++)i=b(),i.positionWorld.copy(ea[O]),za.multiplyVector3(i.positionWorld),i.positionScreen.copy(i.positionWorld),L.multiplyVector4(i.positionScreen),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,
i.visible=i.positionScreen.z>ya&&i.positionScreen.z<ua;ea=0;for(O=Ua.length;ea<O;ea++)if(aa=Ua[ea],ob=!0===mb?Cb.materials[aa.materialIndex]:oa.material,void 0!==ob){Z=ob.side;if(aa instanceof THREE.Face3)if(V=n[aa.a],ia=n[aa.b],fa=n[aa.c],!0===V.visible&&!0===ia.visible&&!0===fa.visible)if(N=0>(fa.positionScreen.x-V.positionScreen.x)*(ia.positionScreen.y-V.positionScreen.y)-(fa.positionScreen.y-V.positionScreen.y)*(ia.positionScreen.x-V.positionScreen.x),Z===THREE.DoubleSide||N===(Z===THREE.FrontSide))r===
l?(sa=new THREE.RenderableFace3,s.push(sa),l++,r++,m=sa):m=s[r++],m.v1.copy(V),m.v2.copy(ia),m.v3.copy(fa);else continue;else continue;else if(aa instanceof THREE.Face4)if(V=n[aa.a],ia=n[aa.b],fa=n[aa.c],sa=n[aa.d],!0===V.visible&&!0===ia.visible&&!0===fa.visible&&!0===sa.visible)if(N=0>(sa.positionScreen.x-V.positionScreen.x)*(ia.positionScreen.y-V.positionScreen.y)-(sa.positionScreen.y-V.positionScreen.y)*(ia.positionScreen.x-V.positionScreen.x)||0>(ia.positionScreen.x-fa.positionScreen.x)*(sa.positionScreen.y-
fa.positionScreen.y)-(ia.positionScreen.y-fa.positionScreen.y)*(sa.positionScreen.x-fa.positionScreen.x),Z===THREE.DoubleSide||N===(Z===THREE.FrontSide)){if(q===B){var pb=new THREE.RenderableFace4;u.push(pb);B++;q++;m=pb}else m=u[q++];m.v1.copy(V);m.v2.copy(ia);m.v3.copy(fa);m.v4.copy(sa)}else continue;else continue;m.normalWorld.copy(aa.normal);!1===N&&(Z===THREE.BackSide||Z===THREE.DoubleSide)&&m.normalWorld.negate();K.multiplyVector3(m.normalWorld).normalize();m.centroidWorld.copy(aa.centroid);
za.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);L.multiplyVector3(m.centroidScreen);fa=aa.vertexNormals;V=0;for(ia=fa.length;V<ia;V++)sa=m.vertexNormalsWorld[V],sa.copy(fa[V]),!1===N&&(Z===THREE.BackSide||Z===THREE.DoubleSide)&&sa.negate(),K.multiplyVector3(sa).normalize();m.vertexNormalsLength=fa.length;V=0;for(ia=Da.length;V<ia;V++)if(sa=Da[V][ea],void 0!==sa){Z=0;for(fa=sa.length;Z<fa;Z++)m.uvs[V][Z]=sa[Z]}m.color=aa.color;m.material=ob;m.z=m.centroidScreen.z;I.elements.push(m)}}else if(oa instanceof
THREE.Line){y.multiply(L,za);ea=oa.geometry.vertices;V=b();V.positionScreen.copy(ea[0]);y.multiplyVector4(V.positionScreen);za=oa.type===THREE.LinePieces?2:1;O=1;for(aa=ea.length;O<aa;O++)V=b(),V.positionScreen.copy(ea[O]),y.multiplyVector4(V.positionScreen),0<(O+1)%za||(ia=n[k-2],R.copy(V.positionScreen),P.copy(ia.positionScreen),!0===d(R,P)&&(R.multiplyScalar(1/R.w),P.multiplyScalar(1/P.w),t===C?(Ua=new THREE.RenderableLine,F.push(Ua),C++,t++,x=Ua):x=F[t++],x.v1.positionScreen.copy(R),x.v2.positionScreen.copy(P),
x.z=Math.max(R.z,P.z),x.material=oa.material,I.elements.push(x)))}g=0;for(p=I.sprites.length;g<p;g++)oa=I.sprites[g].object,za=oa.matrixWorld,oa instanceof THREE.Particle&&(D.set(za.elements[12],za.elements[13],za.elements[14],1),L.multiplyVector4(D),D.z/=D.w,0<D.z&&1>D.z&&(A===G?(ya=new THREE.RenderableParticle,H.push(ya),G++,A++,z=ya):z=H[A++],z.object=oa,z.x=D.x/D.w,z.y=D.y/D.w,z.z=D.z,z.rotation=oa.rotation.z,z.scale.x=oa.scale.x*Math.abs(z.x-(D.x+h.projectionMatrix.elements[0])/(D.w+h.projectionMatrix.elements[12])),
z.scale.y=oa.scale.y*Math.abs(z.y-(D.y+h.projectionMatrix.elements[5])/(D.w+h.projectionMatrix.elements[13])),z.material=oa.material,I.elements.push(z)));!0===pa&&I.elements.sort(c);return I}};THREE.Face3=function(a,b,c,d,e,f){this.a=a;this.b=b;this.c=c;this.normal=d instanceof THREE.Vector3?d:new THREE.Vector3;this.vertexNormals=d instanceof Array?d:[];this.color=e instanceof THREE.Color?e:new THREE.Color;this.vertexColors=e instanceof Array?e:[];this.vertexTangents=[];this.materialIndex=void 0!==f?f:0;this.centroid=new THREE.Vector3};
...
e.vertexNormals=e.__originalVertexNormals},computeTangents:function(){function a(a,b,c,d,e,f,y){h=a.vertices[b];i=a.vertices[c];k=a.vertices[d];n=g[e];p=g[f];m=g[y];r=i.x-h.x;s=k.x-h.x;l=i.y-h.y;q=k.y-h.y;u=i.z-h.z;B=k.z-h.z;x=p.x-n.x;t=m.x-n.x;F=p.y-n.y;C=m.y-n.y;z=1/(x*C-t*F);I.set((C*r-F*s)*z,(C*l-F*q)*z,(C*u-F*B)*z);$.set((x*s-t*r)*z,(x*q-t*l)*z,(x*B-t*u)*z);H[b].addSelf(I);H[c].addSelf(I);H[d].addSelf(I);G[b].addSelf($);G[c].addSelf($);G[d].addSelf($)}var b,c,d,e,f,g,h,i,k,n,p,m,r,s,l,q,u,B,
x,t,F,C,z,A,H=[],G=[],I=new THREE.Vector3,$=new THREE.Vector3,D=new THREE.Vector3,L=new THREE.Vector3,y=new THREE.Vector3;b=0;for(c=this.vertices.length;b<c;b++)H[b]=new THREE.Vector3,G[b]=new THREE.Vector3;b=0;for(c=this.faces.length;b<c;b++)f=this.faces[b],g=this.faceVertexUvs[0][b],f instanceof THREE.Face3?a(this,f.a,f.b,f.c,0,1,2):f instanceof THREE.Face4&&(a(this,f.a,f.b,f.d,0,1,3),a(this,f.b,f.c,f.d,1,2,3));var K=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){f=this.faces[b];for(d=0;d<
f.vertexNormals.length;d++)y.copy(f.vertexNormals[d]),e=f[K[d]],A=H[e],D.copy(A),D.subSelf(y.multiplyScalar(y.dot(A))).normalize(),L.cross(f.vertexNormals[d],A),e=L.dot(G[e]),e=0>e?-1:1,f.vertexTangents[d]=new THREE.Vector4(D.x,D.y,D.z,e)}this.hasTangents=!0},computeLineDistances:function(){for(var a=0,b=this.vertices,c=0,d=b.length;c<d;c++)0<c&&(a+=b[c].distanceTo(b[c-1])),this.lineDistances[c]=a},computeBoundingBox:function(){null===this.boundingBox&&(this.boundingBox=new THREE.Box3);this.boundingBox.setFromPoints(this.vertices)},
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,k,n,p,m,r,s,l,q,u,B,x,t;function F(a){return a%4?4-a%4:0}function C(a,b){return(new Uint8Array(a,b,1))[0]}function z(a,b){return(new Uint32Array(a,b,1))[0]}function A(b,c){var d,e,f,g,h,i,k,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=n[3*d],f=n[3*d+1],g=n[3*d+2],h=J[2*e],e=J[2*e+1],i=J[2*f],k=J[2*f+1],f=J[2*g],g=J[2*g+1],L.faceVertexUvs[0].push([new THREE.Vector2(h,e),new THREE.Vector2(i,k),new THREE.Vector2(f,
g)])}function H(b,c){var d,e,f,g,h,i,k,n,m,p=new Uint32Array(a,c,4*b);for(d=0;d<b;d++)e=p[4*d],f=p[4*d+1],g=p[4*d+2],h=p[4*d+3],i=J[2*e],e=J[2*e+1],k=J[2*f],n=J[2*f+1],f=J[2*g],m=J[2*g+1],g=J[2*h],h=J[2*h+1],L.faceVertexUvs[0].push([new THREE.Vector2(i,e),new THREE.Vector2(k,n),new THREE.Vector2(f,m),new THREE.Vector2(g,h)])}function G(b,c,d){for(var e,f,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[3*d],f=c[3*d+1],g=c[3*d+2],h=i[d],L.faces.push(new THREE.Face3(e,f,g,null,
null,h))}function I(b,c,d){for(var e,f,g,h,i,c=new Uint32Array(a,c,4*b),k=new Uint16Array(a,d,b),d=0;d<b;d++)e=c[4*d],f=c[4*d+1],g=c[4*d+2],h=c[4*d+3],i=k[d],L.faces.push(new THREE.Face4(e,f,g,h,null,null,i))}function $(b,c,d,e){for(var f,g,h,i,k,n,m,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),p=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[3*e];g=c[3*e+1];h=c[3*e+2];k=d[3*e];n=d[3*e+1];m=d[3*e+2];i=p[e];var r=K[3*n],l=K[3*n+1];n=K[3*n+2];var s=K[3*m],q=K[3*m+1];m=K[3*m+2];L.faces.push(new THREE.Face3(f,
g,h,[new THREE.Vector3(K[3*k],K[3*k+1],K[3*k+2]),new THREE.Vector3(r,l,n),new THREE.Vector3(s,q,m)],null,i))}}function D(b,c,d,e){for(var f,g,h,i,k,n,m,p,r,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),l=new Uint16Array(a,e,b),e=0;e<b;e++){f=c[4*e];g=c[4*e+1];h=c[4*e+2];i=c[4*e+3];n=d[4*e];m=d[4*e+1];p=d[4*e+2];r=d[4*e+3];k=l[e];var s=K[3*m],q=K[3*m+1];m=K[3*m+2];var t=K[3*p],u=K[3*p+1];p=K[3*p+2];var x=K[3*r],y=K[3*r+1];r=K[3*r+2];L.faces.push(new THREE.Face4(f,g,h,i,[new THREE.Vector3(K[3*
n],K[3*n+1],K[3*n+2]),new THREE.Vector3(s,q,m),new THREE.Vector3(t,u,p),new THREE.Vector3(x,y,r)],null,k))}}var L=this,y=0,K=[],J=[],R,P,ca;THREE.Geometry.call(this);t=a;P=y;B=new Uint8Array(t,P,12);s="";for(u=0;12>u;u++)s+=String.fromCharCode(B[P+u]);b=C(t,P+12);C(t,P+13);C(t,P+14);C(t,P+15);c=C(t,P+16);d=C(t,P+17);e=C(t,P+18);k=C(t,P+19);n=z(t,P+20);p=z(t,P+20+4);m=z(t,P+20+8);r=z(t,P+20+12);s=z(t,P+20+16);l=z(t,P+20+20);q=z(t,P+20+24);u=z(t,P+20+28);B=z(t,P+20+32);x=z(t,P+20+36);t=z(t,P+20+40);
y+=b;P=3*c+k;ca=4*c+k;R=r*P;b=s*(P+3*d);c=l*(P+3*e);k=q*(P+3*d+3*e);P=u*ca;d=B*(ca+4*d);e=x*(ca+4*e);ca=y;var y=new Float32Array(a,y,3*n),xa,M,pa,ya;for(xa=0;xa<n;xa++)M=y[3*xa],pa=y[3*xa+1],ya=y[3*xa+2],L.vertices.push(new THREE.Vector3(M,pa,ya));n=y=ca+3*n*Float32Array.BYTES_PER_ELEMENT;if(p){y=new Int8Array(a,y,3*p);for(ca=0;ca<p;ca++)xa=y[3*ca],M=y[3*ca+1],pa=y[3*ca+2],K.push(xa/127,M/127,pa/127)}y=n+3*p*Int8Array.BYTES_PER_ELEMENT;p=y+=F(3*p);if(m){n=new Float32Array(a,y,2*m);for(y=0;y<m;y++)ca=
n[2*y],xa=n[2*y+1],J.push(ca,xa)}m=y=p+2*m*Float32Array.BYTES_PER_ELEMENT;R=m+R+F(2*r);p=R+b+F(2*s);b=p+c+F(2*l);c=b+k+F(2*q);P=c+P+F(2*u);k=P+d+F(2*B);d=k+e+F(2*x);l&&(e=p+3*l*Uint32Array.BYTES_PER_ELEMENT,G(l,p,e+3*l*Uint32Array.BYTES_PER_ELEMENT),A(l,e));q&&(l=b+3*q*Uint32Array.BYTES_PER_ELEMENT,e=l+3*q*Uint32Array.BYTES_PER_ELEMENT,$(q,b,l,e+3*q*Uint32Array.BYTES_PER_ELEMENT),A(q,e));x&&(q=k+4*x*Uint32Array.BYTES_PER_ELEMENT,I(x,k,q+4*x*Uint32Array.BYTES_PER_ELEMENT),H(x,q));t&&(x=d+4*t*Uint32Array.BYTES_PER_ELEMENT,
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,k,n,p,m,r,s,l,q,u,B,x,t=a.faces;s=a.vertices;var F=a.normals,C=a.colors,z=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&z++;for(f=0;f<z;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(k=s.length;i<k;)n=new THREE.Vector3,n.x=s[i++]*e,n.y=s[i++]*e,n.z=s[i++]*e,d.vertices.push(n);i=0;for(k=t.length;i<k;){s=t[i++];n=s&1;h=s&2;f=s&4;g=s&8;m=s&16;p=s&32;l=s&64;s&=128;n?(q=new THREE.Face4,
q.a=t[i++],q.b=t[i++],q.c=t[i++],q.d=t[i++],n=4):(q=new THREE.Face3,q.a=t[i++],q.b=t[i++],q.c=t[i++],n=3);h&&(h=t[i++],q.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<z;f++)u=a.uvs[f],r=t[i++],x=u[2*r],r=u[2*r+1],d.faceUvs[f][h]=new THREE.Vector2(x,r);if(g)for(f=0;f<z;f++){u=a.uvs[f];B=[];for(g=0;g<n;g++)r=t[i++],x=u[2*r],r=u[2*r+1],B[g]=new THREE.Vector2(x,r);d.faceVertexUvs[f][h]=B}m&&(m=3*t[i++],g=new THREE.Vector3,g.x=F[m++],g.y=F[m++],g.z=F[m],q.normal=g);if(p)for(f=0;f<n;f++)m=3*t[i++],g=
...
a.bones;d.animation=a.animation;if(void 0!==a.morphTargets){i=0;for(k=a.morphTargets.length;i<k;i++){d.morphTargets[i]={};d.morphTargets[i].name=a.morphTargets[i].name;d.morphTargets[i].vertices=[];C=d.morphTargets[i].vertices;z=a.morphTargets[i].vertices;t=0;for(F=z.length;t<F;t+=3)s=new THREE.Vector3,s.x=z[t]*e,s.y=z[t+1]*e,s.z=z[t+2]*e,C.push(s)}}if(void 0!==a.morphColors){i=0;for(k=a.morphColors.length;i<k;i++){d.morphColors[i]={};d.morphColors[i].name=a.morphColors[i].name;d.morphColors[i].colors=
[];F=d.morphColors[i].colors;C=a.morphColors[i].colors;e=0;for(t=C.length;e<t;e+=3)z=new THREE.Color(16755200),z.setRGB(C[e],C[e+1],C[e+2]),F.push(z)}}d.computeCentroids();d.computeFaceNormals();a=this.initMaterials(a.materials,c);this.needsTangents(a)&&d.computeTangents();b(d,a)};THREE.LoadingMonitor=function(){THREE.EventTarget.call(this);var a=this,b=0,c=0,d=function(){b++;a.dispatchEvent({type:"progress",loaded:b,total:c});b===c&&a.dispatchEvent({type:"load"})};this.add=function(a){c++;a.addEventListener("load",d,!1)}};THREE.SceneLoader=function(){this.onLoadStart=function(){};this.onLoadProgress=function(){};this.onLoadComplete=function(){};this.callbackSync=function(){};this.callbackProgress=function(){};this.geometryHandlerMap={};this.hierarchyHandlerMap={};this.addGeometryHandler("ascii",THREE.JSONLoader);this.addGeometryHandler("binary",THREE.BinaryLoader)};THREE.SceneLoader.prototype.constructor=THREE.SceneLoader;
...
document.createElement("canvas"),p,m,r,s,l=n.getContext("2d"),q=new THREE.Color(0),u=0,B=1,x=0,t=null,F=null,C=null,z=null,A=null,H,G,I,$,D=new THREE.RenderableVertex,L=new THREE.RenderableVertex,y,K,J,R,P,ca,xa,M,pa,ya,ua,N,O=new THREE.Color,aa=new THREE.Color,ea=new THREE.Color,V=new THREE.Color,ia=new THREE.Color,Z=new THREE.Color,fa=new THREE.Color,oa={},za={},Da,Ua,sa,mb,Cb,ob,db,pb,kc,Ob,cb=new THREE.Box2,ma=new THREE.Box2,Ra=new THREE.Box2,Db=!1,Ha=new THREE.Color,qb=new THREE.Color,eb=new THREE.Color,
Oa=new THREE.Vector3,Za,yb,lc,sb,Lb,Ea,a=16;Za=document.createElement("canvas");Za.width=Za.height=2;yb=Za.getContext("2d");yb.fillStyle="rgba(0,0,0,1)";yb.fillRect(0,0,2,2);lc=yb.getImageData(0,0,2,2);sb=lc.data;Lb=document.createElement("canvas");Lb.width=Lb.height=a;Ea=Lb.getContext("2d");Ea.translate(-a/2,-a/2);Ea.scale(a,a);a--;this.domElement=n;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){p=a;m=b;r=Math.floor(p/2);s=
Math.floor(m/2);n.width=p;n.height=m;cb.min.set(-r,-s);cb.max.set(r,s);ma.min.set(-r,-s);ma.max.set(r,s);B=1;x=0;A=z=C=F=t=null};this.setClearColor=function(a,b){q.copy(a);u=void 0!==b?b:1;ma.min.set(-r,-s);ma.max.set(r,s)};this.setClearColorHex=function(a,b){q.setHex(a);u=void 0!==b?b:1;ma.min.set(-r,-s);ma.max.set(r,s)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){l.setTransform(1,0,0,-1,r,s);!1===ma.empty()&&(ma.intersect(cb),ma.expandByScalar(2),1>u&&l.clearRect(ma.min.x|0,
ma.min.y|0,ma.max.x-ma.min.x|0,ma.max.y-ma.min.y|0),0<u&&(c(THREE.NormalBlending),b(1),e("rgba("+Math.floor(255*q.r)+","+Math.floor(255*q.g)+","+Math.floor(255*q.b)+","+u+")"),l.fillRect(ma.min.x|0,ma.min.y|0,ma.max.x-ma.min.x|0,ma.max.y-ma.min.y|0)),ma.makeEmpty())};this.render=function(a,n){function j(a,b,c){for(var d=0,e=i.length;d<e;d++){var f=i[d],g=f.color;if(f instanceof THREE.DirectionalLight){var h=f.matrixWorld.getPosition().normalize(),j=b.dot(h);0>=j||(j*=f.intensity,c.r+=g.r*j,c.g+=g.g*
j,c.b+=g.b*j)}else f instanceof THREE.PointLight&&(h=f.matrixWorld.getPosition(),j=b.dot(Oa.sub(h,a).normalize()),0>=j||(j*=0==f.distance?1:1-Math.min(a.distanceTo(h)/f.distance,1),0!=j&&(j*=f.intensity,c.r+=g.r*j,c.g+=g.g*j,c.b+=g.b*j)))}}function m(a,d,e,g,h,i,k,ja){f.info.render.vertices+=3;f.info.render.faces++;b(ja.opacity);c(ja.blending);y=a.positionScreen.x;K=a.positionScreen.y;J=d.positionScreen.x;R=d.positionScreen.y;P=e.positionScreen.x;ca=e.positionScreen.y;p(y,K,J,R,P,ca);(ja instanceof
THREE.MeshLambertMaterial||ja instanceof THREE.MeshPhongMaterial)&&null===ja.map&&null===ja.map?(Z.copy(ja.color),fa.copy(ja.emissive),ja.vertexColors===THREE.FaceColors&&(Z.r*=k.color.r,Z.g*=k.color.g,Z.b*=k.color.b),!0===Db?!1===ja.wireframe&&ja.shading==THREE.SmoothShading&&3==k.vertexNormalsLength?(aa.r=ea.r=V.r=Ha.r,aa.g=ea.g=V.g=Ha.g,aa.b=ea.b=V.b=Ha.b,j(k.v1.positionWorld,k.vertexNormalsWorld[0],aa),j(k.v2.positionWorld,k.vertexNormalsWorld[1],ea),j(k.v3.positionWorld,k.vertexNormalsWorld[2],
V),aa.r=aa.r*Z.r+fa.r,aa.g=aa.g*Z.g+fa.g,aa.b=aa.b*Z.b+fa.b,ea.r=ea.r*Z.r+fa.r,ea.g=ea.g*Z.g+fa.g,ea.b=ea.b*Z.b+fa.b,V.r=V.r*Z.r+fa.r,V.g=V.g*Z.g+fa.g,V.b=V.b*Z.b+fa.b,ia.r=0.5*(ea.r+V.r),ia.g=0.5*(ea.g+V.g),ia.b=0.5*(ea.b+V.b),sa=F(aa,ea,V,ia),B(y,K,J,R,P,ca,0,0,1,0,0,1,sa)):(O.r=Ha.r,O.g=Ha.g,O.b=Ha.b,j(k.centroidWorld,k.normalWorld,O),O.r=O.r*Z.r+fa.r,O.g=O.g*Z.g+fa.g,O.b=O.b*Z.b+fa.b,!0===ja.wireframe?t(O,ja.wireframeLinewidth,ja.wireframeLinecap,ja.wireframeLinejoin):u(O)):!0===ja.wireframe?
t(ja.color,ja.wireframeLinewidth,ja.wireframeLinecap,ja.wireframeLinejoin):u(ja.color)):ja instanceof THREE.MeshBasicMaterial||ja instanceof THREE.MeshLambertMaterial||ja instanceof THREE.MeshPhongMaterial?null!==ja.map?ja.map.mapping instanceof THREE.UVMapping&&(mb=k.uvs[0],x(y,K,J,R,P,ca,mb[g].x,mb[g].y,mb[h].x,mb[h].y,mb[i].x,mb[i].y,ja.map)):null!==ja.envMap?ja.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=n.matrixWorldInverse,Oa.copy(k.vertexNormalsWorld[g]),Cb=0.5*(Oa.x*a.elements[0]+
Oa.y*a.elements[4]+Oa.z*a.elements[8])+0.5,ob=0.5*(Oa.x*a.elements[1]+Oa.y*a.elements[5]+Oa.z*a.elements[9])+0.5,Oa.copy(k.vertexNormalsWorld[h]),db=0.5*(Oa.x*a.elements[0]+Oa.y*a.elements[4]+Oa.z*a.elements[8])+0.5,pb=0.5*(Oa.x*a.elements[1]+Oa.y*a.elements[5]+Oa.z*a.elements[9])+0.5,Oa.copy(k.vertexNormalsWorld[i]),kc=0.5*(Oa.x*a.elements[0]+Oa.y*a.elements[4]+Oa.z*a.elements[8])+0.5,Ob=0.5*(Oa.x*a.elements[1]+Oa.y*a.elements[5]+Oa.z*a.elements[9])+0.5,x(y,K,J,R,P,ca,Cb,ob,db,pb,kc,Ob,ja.envMap)):
(O.copy(ja.color),ja.vertexColors===THREE.FaceColors&&(O.r*=k.color.r,O.g*=k.color.g,O.b*=k.color.b),!0===ja.wireframe?t(O,ja.wireframeLinewidth,ja.wireframeLinecap,ja.wireframeLinejoin):u(O)):ja instanceof THREE.MeshDepthMaterial?(Da=n.near,Ua=n.far,aa.r=aa.g=aa.b=1-fb(a.positionScreen.z,Da,Ua),ea.r=ea.g=ea.b=1-fb(d.positionScreen.z,Da,Ua),V.r=V.g=V.b=1-fb(e.positionScreen.z,Da,Ua),ia.r=0.5*(ea.r+V.r),ia.g=0.5*(ea.g+V.g),ia.b=0.5*(ea.b+V.b),sa=F(aa,ea,V,ia),B(y,K,J,R,P,ca,0,0,1,0,0,1,sa)):ja instanceof
THREE.MeshNormalMaterial&&(O.r=tb(k.normalWorld.x),O.g=tb(k.normalWorld.y),O.b=tb(k.normalWorld.z),!0===ja.wireframe?t(O,ja.wireframeLinewidth,ja.wireframeLinecap,ja.wireframeLinejoin):u(O))}function p(a,b,c,d,e,f){l.beginPath();l.moveTo(a,b);l.lineTo(c,d);l.lineTo(e,f);l.closePath()}function q(a,b,c,d,e,f,g,h){l.beginPath();l.moveTo(a,b);l.lineTo(c,d);l.lineTo(e,f);l.lineTo(g,h);l.closePath()}function t(a,b,c,e){C!==b&&(C=l.lineWidth=b);z!==c&&(z=l.lineCap=c);A!==e&&(A=l.lineJoin=e);d(a.getStyle());
l.stroke();Ra.expandByScalar(2*b)}function u(a){e(a.getStyle());l.fill()}function x(a,b,c,d,f,g,h,j,i,k,n,ja,m){if(!(m instanceof THREE.DataTexture||void 0===m.image||0==m.image.width)){if(!0===m.needsUpdate){var p=m.wrapS==THREE.RepeatWrapping,r=m.wrapT==THREE.RepeatWrapping;oa[m.id]=l.createPattern(m.image,!0===p&&!0===r?"repeat":!0===p&&!1===r?"repeat-x":!1===p&&!0===r?"repeat-y":"no-repeat");m.needsUpdate=!1}void 0===oa[m.id]?e("rgba(0,0,0,1)"):e(oa[m.id]);var p=m.offset.x/m.repeat.x,r=m.offset.y/
m.repeat.y,s=m.image.width*m.repeat.x,q=m.image.height*m.repeat.y,h=(h+p)*s,j=(1-j+r)*q,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+p)*s-h,k=(1-k+r)*q-j,n=(n+p)*s-h,ja=(1-ja+r)*q-j,p=i*ja-n*k;0===p?(void 0===za[m.id]&&(b=document.createElement("canvas"),b.width=m.image.width,b.height=m.image.height,b=b.getContext("2d"),b.drawImage(m.image,0,0),za[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data),b=za[m.id],h=4*(Math.floor(h)+Math.floor(j)*m.image.width),O.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),u(O)):
(p=1/p,m=(ja*c-k*f)*p,k=(ja*d-k*g)*p,c=(i*f-n*c)*p,d=(i*g-n*d)*p,a=a-m*h-c*j,h=b-k*h-d*j,l.save(),l.transform(m,k,c,d,a,h),l.fill(),l.restore())}}function B(a,b,c,d,e,f,g,h,j,i,k,n,ja){var m,p;m=ja.width-1;p=ja.height-1;g*=m;h*=p;c-=a;d-=b;e-=a;f-=b;j=j*m-g;i=i*p-h;k=k*m-g;n=n*p-h;p=1/(j*n-k*i);m=(n*c-i*e)*p;i=(n*d-i*f)*p;c=(j*e-k*c)*p;d=(j*f-k*d)*p;a=a-m*g-c*h;b=b-i*g-d*h;l.save();l.transform(m,i,c,d,a,b);l.clip();l.drawImage(ja,0,0);l.restore()}function F(a,b,c,d){sb[0]=255*a.r|0;sb[1]=255*a.g|
0;sb[2]=255*a.b|0;sb[4]=255*b.r|0;sb[5]=255*b.g|0;sb[6]=255*b.b|0;sb[8]=255*c.r|0;sb[9]=255*c.g|0;sb[10]=255*c.b|0;sb[12]=255*d.r|0;sb[13]=255*d.g|0;sb[14]=255*d.b|0;yb.putImageData(lc,0,0);Ea.drawImage(Za,0,0);return Lb}function fb(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function tb(a){a=0.5*(a+1);return 0>a?0:1<a?1:a}function Va(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===n instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
else{var gb,Gb,la,X;!0===this.autoClear?this.clear():l.setTransform(1,0,0,-1,r,s);f.info.render.vertices=0;f.info.render.faces=0;g=k.projectScene(a,n,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;Db=0<i.length;if(!0===Db){Ha.setRGB(0,0,0);qb.setRGB(0,0,0);eb.setRGB(0,0,0);gb=0;for(Gb=i.length;gb<Gb;gb++){X=i[gb];var ka=X.color;X instanceof THREE.AmbientLight?(Ha.r+=ka.r,Ha.g+=ka.g,Ha.b+=ka.b):X instanceof THREE.DirectionalLight?(qb.r+=ka.r,qb.g+=ka.g,qb.b+=ka.b):X instanceof THREE.PointLight&&
(eb.r+=ka.r,eb.g+=ka.g,eb.b+=ka.b)}}gb=0;for(Gb=h.length;gb<Gb;gb++)if(la=h[gb],X=la.material,!(void 0===X||!1===X.visible)){Ra.makeEmpty();if(la instanceof THREE.RenderableParticle){H=la;H.x*=r;H.y*=s;var ka=H,Sa=la;b(X.opacity);c(X.blending);var zb=void 0,Wa=void 0,nb=void 0,hb=void 0,Ab=la=void 0,ja=void 0;X instanceof THREE.ParticleBasicMaterial?null===X.map?(nb=Sa.object.scale.x,hb=Sa.object.scale.y,nb*=Sa.scale.x*r,hb*=Sa.scale.y*s,Ra.min.set(ka.x-nb,ka.y-hb),Ra.max.set(ka.x+nb,ka.y+hb),!1!==
cb.isIntersectionBox(Ra)&&(e(X.color.getStyle()),l.save(),l.translate(ka.x,ka.y),l.rotate(-Sa.rotation),l.scale(nb,hb),l.fillRect(-1,-1,2,2),l.restore())):(la=X.map.image,Ab=la.width>>1,ja=la.height>>1,nb=Sa.scale.x*r,hb=Sa.scale.y*s,zb=nb*Ab,Wa=hb*ja,Ra.min.set(ka.x-zb,ka.y-Wa),Ra.max.set(ka.x+zb,ka.y+Wa),!1!==cb.isIntersectionBox(Ra)&&(l.save(),l.translate(ka.x,ka.y),l.rotate(-Sa.rotation),l.scale(nb,-hb),l.translate(-Ab,-ja),l.drawImage(la,0,0),l.restore())):X instanceof THREE.ParticleCanvasMaterial&&
(zb=Sa.scale.x*r,Wa=Sa.scale.y*s,Ra.min.set(ka.x-zb,ka.y-Wa),Ra.max.set(ka.x+zb,ka.y+Wa),!1!==cb.isIntersectionBox(Ra)&&(d(X.color.getStyle()),e(X.color.getStyle()),l.save(),l.translate(ka.x,ka.y),l.rotate(-Sa.rotation),l.scale(zb,Wa),X.program(l),l.restore()))}else la instanceof THREE.RenderableLine?(H=la.v1,G=la.v2,H.positionScreen.x*=r,H.positionScreen.y*=s,G.positionScreen.x*=r,G.positionScreen.y*=s,Ra.setFromPoints([H.positionScreen,G.positionScreen]),!0===cb.isIntersectionBox(Ra)&&(ka=H,Sa=
G,b(X.opacity),c(X.blending),l.beginPath(),l.moveTo(ka.positionScreen.x,ka.positionScreen.y),l.lineTo(Sa.positionScreen.x,Sa.positionScreen.y),X instanceof THREE.LineBasicMaterial&&(ka=X.linewidth,C!==ka&&(C=l.lineWidth=ka),ka=X.linecap,z!==ka&&(z=l.lineCap=ka),ka=X.linejoin,A!==ka&&(A=l.lineJoin=ka),d(X.color.getStyle()),l.stroke(),Ra.expandByScalar(2*X.linewidth)))):la instanceof THREE.RenderableFace3?(H=la.v1,G=la.v2,I=la.v3,H.positionScreen.x*=r,H.positionScreen.y*=s,G.positionScreen.x*=r,G.positionScreen.y*=
s,I.positionScreen.x*=r,I.positionScreen.y*=s,!0===X.overdraw&&(Va(H.positionScreen,G.positionScreen),Va(G.positionScreen,I.positionScreen),Va(I.positionScreen,H.positionScreen)),Ra.setFromPoints([H.positionScreen,G.positionScreen,I.positionScreen]),!0===cb.isIntersectionBox(Ra)&&m(H,G,I,0,1,2,la,X,a)):la instanceof THREE.RenderableFace4&&(H=la.v1,G=la.v2,I=la.v3,$=la.v4,H.positionScreen.x*=r,H.positionScreen.y*=s,G.positionScreen.x*=r,G.positionScreen.y*=s,I.positionScreen.x*=r,I.positionScreen.y*=
s,$.positionScreen.x*=r,$.positionScreen.y*=s,D.positionScreen.copy(G.positionScreen),L.positionScreen.copy($.positionScreen),!0===X.overdraw&&(Va(H.positionScreen,G.positionScreen),Va(G.positionScreen,$.positionScreen),Va($.positionScreen,H.positionScreen),Va(I.positionScreen,D.positionScreen),Va(I.positionScreen,L.positionScreen)),Ra.setFromPoints([H.positionScreen,G.positionScreen,I.positionScreen,$.positionScreen]),!0===cb.isIntersectionBox(Ra)&&(ka=H,Sa=G,zb=I,Wa=$,nb=D,hb=L,Ab=a,f.info.render.vertices+=
4,f.info.render.faces++,b(X.opacity),c(X.blending),void 0!==X.map&&null!==X.map||void 0!==X.envMap&&null!==X.envMap?(m(ka,Sa,Wa,0,1,3,la,X,Ab),m(nb,zb,hb,1,2,3,la,X,Ab)):(y=ka.positionScreen.x,K=ka.positionScreen.y,J=Sa.positionScreen.x,R=Sa.positionScreen.y,P=zb.positionScreen.x,ca=zb.positionScreen.y,xa=Wa.positionScreen.x,M=Wa.positionScreen.y,pa=nb.positionScreen.x,ya=nb.positionScreen.y,ua=hb.positionScreen.x,N=hb.positionScreen.y,X instanceof THREE.MeshLambertMaterial||X instanceof THREE.MeshPhongMaterial?
(Z.copy(X.color),fa.copy(X.emissive),X.vertexColors===THREE.FaceColors&&(Z.r*=la.color.r,Z.g*=la.color.g,Z.b*=la.color.b),!0===Db?!1===X.wireframe&&X.shading==THREE.SmoothShading&&4==la.vertexNormalsLength?(aa.r=ea.r=V.r=ia.r=Ha.r,aa.g=ea.g=V.g=ia.g=Ha.g,aa.b=ea.b=V.b=ia.b=Ha.b,j(la.v1.positionWorld,la.vertexNormalsWorld[0],aa),j(la.v2.positionWorld,la.vertexNormalsWorld[1],ea),j(la.v4.positionWorld,la.vertexNormalsWorld[3],V),j(la.v3.positionWorld,la.vertexNormalsWorld[2],ia),aa.r=aa.r*Z.r+fa.r,
aa.g=aa.g*Z.g+fa.g,aa.b=aa.b*Z.b+fa.b,ea.r=ea.r*Z.r+fa.r,ea.g=ea.g*Z.g+fa.g,ea.b=ea.b*Z.b+fa.b,V.r=V.r*Z.r+fa.r,V.g=V.g*Z.g+fa.g,V.b=V.b*Z.b+fa.b,ia.r=ia.r*Z.r+fa.r,ia.g=ia.g*Z.g+fa.g,ia.b=ia.b*Z.b+fa.b,sa=F(aa,ea,V,ia),p(y,K,J,R,xa,M),B(y,K,J,R,xa,M,0,0,1,0,0,1,sa),p(pa,ya,P,ca,ua,N),B(pa,ya,P,ca,ua,N,1,0,1,1,0,1,sa)):(O.r=Ha.r,O.g=Ha.g,O.b=Ha.b,j(la.centroidWorld,la.normalWorld,O),O.r=O.r*Z.r+fa.r,O.g=O.g*Z.g+fa.g,O.b=O.b*Z.b+fa.b,q(y,K,J,R,P,ca,xa,M),!0===X.wireframe?t(O,X.wireframeLinewidth,X.wireframeLinecap,
X.wireframeLinejoin):u(O)):(O.r=Z.r+fa.r,O.g=Z.g+fa.g,O.b=Z.b+fa.b,q(y,K,J,R,P,ca,xa,M),!0===X.wireframe?t(O,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):u(O))):X instanceof THREE.MeshBasicMaterial?(O.copy(X.color),X.vertexColors===THREE.FaceColors&&(O.r*=la.color.r,O.g*=la.color.g,O.b*=la.color.b),q(y,K,J,R,P,ca,xa,M),!0===X.wireframe?t(O,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):u(O)):X instanceof THREE.MeshNormalMaterial?(O.r=tb(la.normalWorld.x),O.g=tb(la.normalWorld.y),
O.b=tb(la.normalWorld.z),q(y,K,J,R,P,ca,xa,M),!0===X.wireframe?t(O,X.wireframeLinewidth,X.wireframeLinecap,X.wireframeLinejoin):u(O)):X instanceof THREE.MeshDepthMaterial&&(Da=n.near,Ua=n.far,aa.r=aa.g=aa.b=1-fb(ka.positionScreen.z,Da,Ua),ea.r=ea.g=ea.b=1-fb(Sa.positionScreen.z,Da,Ua),V.r=V.g=V.b=1-fb(Wa.positionScreen.z,Da,Ua),ia.r=ia.g=ia.b=1-fb(zb.positionScreen.z,Da,Ua),sa=F(aa,ea,V,ia),p(y,K,J,R,xa,M),B(y,K,J,R,xa,M,0,0,1,0,0,1,sa),p(pa,ya,P,ca,ua,N),B(pa,ya,P,ca,ua,N,1,0,1,1,0,1,sa)))));ma.union(Ra)}l.setTransform(1,
...
function u(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return!0;return!1}function B(a){for(var b in a.attributes)a.attributes[b].needsUpdate=!1}function x(a,b){for(var c=a.length-1;0<=c;c--)a[c].object===b&&a.splice(c,1)}function t(a,b){for(var c=a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function F(a,b,c,d,e){za=0;d.needsUpdate&&(d.program&&Ab(d),N.initMaterial(d,b,c,e),d.needsUpdate=!1);d.morphTargets&&!e.__webglMorphTargetInfluences&&(e.__webglMorphTargetInfluences=new Float32Array(N.maxMorphTargets));
var f=!1,g=d.program,h=g.uniforms,i=d.uniforms;g!==ea&&(j.useProgram(g),ea=g,f=!0);d.id!==ia&&(ia=d.id,f=!0);if(f||a!==fa)j.uniformMatrix4fv(h.projectionMatrix,!1,a.projectionMatrix.elements),a!==fa&&(fa=a);if(d.skinning)if(Va&&e.useVertexTexture){if(null!==h.boneTexture){var k=C();j.uniform1i(h.boneTexture,k);N.setTexture(e.boneTexture,k)}}else null!==h.boneGlobalMatrices&&j.uniformMatrix4fv(h.boneGlobalMatrices,!1,e.boneMatrices);if(f){c&&d.fog&&(i.fogColor.value=c.color,c instanceof THREE.Fog?
(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(ec){for(var n,m=k=0,l=0,p,r,s,q=Ic,t=q.directional.colors,u=q.directional.positions,x=q.point.colors,y=q.point.positions,B=q.point.distances,z=q.spot.colors,F=q.spot.positions,G=q.spot.distances,O=q.spot.directions,I=q.spot.anglesCos,L=q.spot.exponents,V=q.hemi.skyColors,M=q.hemi.groundColors,Z=q.hemi.positions,
aa=0,R=0,P=0,X=0,$=0,la=0,ka=0,ca=0,W=n=0,c=s=W=0,f=b.length;c<f;c++)n=b[c],n.onlyShadow||(p=n.color,r=n.intensity,s=n.distance,n instanceof THREE.AmbientLight?n.visible&&(N.gammaInput?(k+=p.r*p.r,m+=p.g*p.g,l+=p.b*p.b):(k+=p.r,m+=p.g,l+=p.b)):n instanceof THREE.DirectionalLight?($+=1,n.visible&&(Ea.copy(n.matrixWorld.getPosition()),Ea.subSelf(n.target.matrixWorld.getPosition()),Ea.normalize(),0===Ea.x&&0===Ea.y&&0===Ea.z||(n=3*aa,u[n]=Ea.x,u[n+1]=Ea.y,u[n+2]=Ea.z,N.gammaInput?A(t,n,p,r*r):H(t,n,
p,r),aa+=1))):n instanceof THREE.PointLight?(la+=1,n.visible&&(W=3*R,N.gammaInput?A(x,W,p,r*r):H(x,W,p,r),r=n.matrixWorld.getPosition(),y[W]=r.x,y[W+1]=r.y,y[W+2]=r.z,B[R]=s,R+=1)):n instanceof THREE.SpotLight?(ka+=1,n.visible&&(W=3*P,N.gammaInput?A(z,W,p,r*r):H(z,W,p,r),r=n.matrixWorld.getPosition(),F[W]=r.x,F[W+1]=r.y,F[W+2]=r.z,G[P]=s,Ea.copy(r),Ea.subSelf(n.target.matrixWorld.getPosition()),Ea.normalize(),O[W]=Ea.x,O[W+1]=Ea.y,O[W+2]=Ea.z,I[P]=Math.cos(n.angle),L[P]=n.exponent,P+=1)):n instanceof
THREE.HemisphereLight&&(ca+=1,n.visible&&(Ea.copy(n.matrixWorld.getPosition()),Ea.normalize(),0===Ea.x&&0===Ea.y&&0===Ea.z||(s=3*X,Z[s]=Ea.x,Z[s+1]=Ea.y,Z[s+2]=Ea.z,p=n.color,n=n.groundColor,N.gammaInput?(r*=r,A(V,s,p,r),A(M,s,n,r)):(H(V,s,p,r),H(M,s,n,r)),X+=1))));c=3*aa;for(f=Math.max(t.length,3*$);c<f;c++)t[c]=0;c=3*R;for(f=Math.max(x.length,3*la);c<f;c++)x[c]=0;c=3*P;for(f=Math.max(z.length,3*ka);c<f;c++)z[c]=0;c=3*X;for(f=Math.max(V.length,3*ca);c<f;c++)V[c]=0;c=3*X;for(f=Math.max(M.length,3*
ca);c<f;c++)M[c]=0;q.directional.length=aa;q.point.length=R;q.spot.length=P;q.hemi.length=X;q.ambient[0]=k;q.ambient[1]=m;q.ambient[2]=l;ec=!1}c=Ic;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;
...
j.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;k=[];for(m=0;6>m;m++)N.autoScaleCubemaps&&!f?(l=k,q=m,t=c.image[m],x=$c,t.width<=x&&t.height<=x||(y=Math.max(t.width,t.height),u=Math.floor(t.width*x/y),x=Math.floor(t.height*x/y),y=document.createElement("canvas"),y.width=u,y.height=x,y.getContext("2d").drawImage(t,0,0,t.width,t.height,0,0,u,x),t=y),l[q]=t):k[m]=c.image[m];m=k[0];l=0===(m.width&m.width-1)&&0===(m.height&m.height-1);q=K(c.format);t=K(c.type);D(j.TEXTURE_CUBE_MAP,
...
c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function $(a,b){var c;"fragment"===a?c=j.createShader(j.FRAGMENT_SHADER):"vertex"===a&&(c=j.createShader(j.VERTEX_SHADER));j.shaderSource(c,b);j.compileShader(c);return!j.getShaderParameter(c,j.COMPILE_STATUS)?(console.error(j.getShaderInfoLog(c)),console.error(I(b)),null):c}function D(a,b,c){c?(j.texParameteri(a,j.TEXTURE_WRAP_S,K(b.wrapS)),j.texParameteri(a,j.TEXTURE_WRAP_T,K(b.wrapT)),j.texParameteri(a,j.TEXTURE_MAG_FILTER,K(b.magFilter)),j.texParameteri(a,
j.TEXTURE_MIN_FILTER,K(b.minFilter))):(j.texParameteri(a,j.TEXTURE_WRAP_S,j.CLAMP_TO_EDGE),j.texParameteri(a,j.TEXTURE_WRAP_T,j.CLAMP_TO_EDGE),j.texParameteri(a,j.TEXTURE_MAG_FILTER,y(b.magFilter)),j.texParameteri(a,j.TEXTURE_MIN_FILTER,y(b.minFilter)));if(Fb&&b.type!==THREE.FloatType&&(1<b.anisotropy||b.__oldAnisotropy))j.texParameterf(a,Fb.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,fb)),b.__oldAnisotropy=b.anisotropy}function L(a,b){j.bindRenderbuffer(j.RENDERBUFFER,a);b.depthBuffer&&!b.stencilBuffer?
...
if(a===THREE.RGBA_S3TC_DXT1_Format)return Eb.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT3_Format)return Eb.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===THREE.RGBA_S3TC_DXT5_Format)return Eb.COMPRESSED_RGBA_S3TC_DXT5_EXT}return 0}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},J=void 0!==a.canvas?a.canvas:document.createElement("canvas"),R=void 0!==a.precision?a.precision:"highp",P=void 0!==a.alpha?a.alpha:!0,ca=void 0!==a.premultipliedAlpha?a.premultipliedAlpha:!0,xa=void 0!==a.antialias?
a.antialias:!1,M=void 0!==a.stencil?a.stencil:!0,pa=void 0!==a.preserveDrawingBuffer?a.preserveDrawingBuffer:!1,ya=void 0!==a.clearColor?new THREE.Color(a.clearColor):new THREE.Color(0),ua=void 0!==a.clearAlpha?a.clearAlpha:0;this.domElement=J;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapAutoUpdate=
!0;this.shadowMapType=THREE.PCFShadowMap;this.shadowMapCullFace=THREE.CullFaceFront;this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var N=this,O=[],aa=0,ea=null,V=null,ia=-1,Z=null,fa=null,oa=0,za=0,Da=-1,Ua=-1,sa=-1,mb=-1,Cb=-1,ob=-1,db=-1,pb=-1,kc=null,Ob=null,cb=null,ma=null,Ra=
0,Db=0,Ha=0,qb=0,eb=0,Oa=0,Za={},yb=new THREE.Frustum,lc=new THREE.Matrix4,sb=new THREE.Matrix4,Lb=new THREE.Vector3,Ea=new THREE.Vector3,ec=!0,Ic={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},j,rc,zc,Fb,Eb;try{if(!(j=J.getContext("experimental-webgl",{alpha:P,premultipliedAlpha:ca,
antialias:xa,stencil:M,preserveDrawingBuffer:pa})))throw"Error creating WebGL context.";}catch(bd){console.error(bd)}rc=j.getExtension("OES_texture_float");zc=j.getExtension("OES_standard_derivatives");Fb=j.getExtension("EXT_texture_filter_anisotropic")||j.getExtension("MOZ_EXT_texture_filter_anisotropic")||j.getExtension("WEBKIT_EXT_texture_filter_anisotropic");Eb=j.getExtension("WEBGL_compressed_texture_s3tc")||j.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||j.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");
rc||console.log("THREE.WebGLRenderer: Float textures not supported.");zc||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");Fb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");Eb||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");j.clearColor(0,0,0,1);j.clearDepth(1);j.clearStencil(0);j.enable(j.DEPTH_TEST);j.depthFunc(j.LEQUAL);j.frontFace(j.CCW);j.cullFace(j.BACK);j.enable(j.CULL_FACE);j.enable(j.BLEND);j.blendEquation(j.FUNC_ADD);
j.blendFunc(j.SRC_ALPHA,j.ONE_MINUS_SRC_ALPHA);j.clearColor(ya.r,ya.g,ya.b,ua);this.context=j;var Jc=j.getParameter(j.MAX_TEXTURE_IMAGE_UNITS),ad=j.getParameter(j.MAX_VERTEX_TEXTURE_IMAGE_UNITS);j.getParameter(j.MAX_TEXTURE_SIZE);var $c=j.getParameter(j.MAX_CUBE_MAP_TEXTURE_SIZE),fb=Fb?j.getParameter(Fb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,tb=0<ad,Va=tb&&rc;Eb&&j.getParameter(j.COMPRESSED_TEXTURE_FORMATS);var gb=j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.HIGH_FLOAT),Gb=j.getShaderPrecisionFormat(j.VERTEX_SHADER,
j.MEDIUM_FLOAT);j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.LOW_FLOAT);var la=j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.HIGH_FLOAT),X=j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.MEDIUM_FLOAT);j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.LOW_FLOAT);j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.HIGH_INT);j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.MEDIUM_INT);j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.LOW_INT);j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.HIGH_INT);j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,
j.MEDIUM_INT);j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.LOW_INT);var ka=0<gb.precision&&0<la.precision,Sa=0<Gb.precision&&0<X.precision;"highp"===R&&!ka&&(Sa?(R="mediump",console.warn("WebGLRenderer: highp not supported, using mediump")):(R="lowp",console.warn("WebGLRenderer: highp and mediump not supported, using lowp")));"mediump"===R&&!Sa&&(R="lowp",console.warn("WebGLRenderer: mediump not supported, using lowp"));this.getContext=function(){return j};this.supportsVertexTextures=function(){return tb};
this.getMaxAnisotropy=function(){return fb};this.setSize=function(a,b){J.width=a;J.height=b;this.setViewport(0,0,J.width,J.height)};this.setViewport=function(a,b,c,d){Ra=void 0!==a?a:0;Db=void 0!==b?b:0;Ha=void 0!==c?c:J.width;qb=void 0!==d?d:J.height;j.viewport(Ra,Db,Ha,qb)};this.setScissor=function(a,b,c,d){j.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?j.enable(j.SCISSOR_TEST):j.disable(j.SCISSOR_TEST)};this.setClearColorHex=function(a,b){ya.setHex(a);ua=b;j.clearColor(ya.r,ya.g,ya.b,
ua)};this.setClearColor=function(a,b){ya.copy(a);ua=b;j.clearColor(ya.r,ya.g,ya.b,ua)};this.getClearColor=function(){return ya};this.getClearAlpha=function(){return ua};this.clear=function(a,b,c){var d=0;if(void 0===a||a)d|=j.COLOR_BUFFER_BIT;if(void 0===b||b)d|=j.DEPTH_BUFFER_BIT;if(void 0===c||c)d|=j.STENCIL_BUFFER_BIT;j.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};this.addPrePlugin=
function(a){a.init(this);this.renderPluginsPre.push(a)};this.updateShadowMap=function(a,b){ea=null;ia=Z=pb=db=sa=-1;ec=!0;Ua=Da=-1;this.shadowMapPlugin.update(a,b)};var zb=function(){this.removeEventListener("deallocate",zb);this.__webglInit=void 0;void 0!==this.__webglVertexBuffer&&j.deleteBuffer(this.__webglVertexBuffer);void 0!==this.__webglNormalBuffer&&j.deleteBuffer(this.__webglNormalBuffer);void 0!==this.__webglTangentBuffer&&j.deleteBuffer(this.__webglTangentBuffer);void 0!==this.__webglColorBuffer&&
j.deleteBuffer(this.__webglColorBuffer);void 0!==this.__webglUVBuffer&&j.deleteBuffer(this.__webglUVBuffer);void 0!==this.__webglUV2Buffer&&j.deleteBuffer(this.__webglUV2Buffer);void 0!==this.__webglSkinIndicesBuffer&&j.deleteBuffer(this.__webglSkinIndicesBuffer);void 0!==this.__webglSkinWeightsBuffer&&j.deleteBuffer(this.__webglSkinWeightsBuffer);void 0!==this.__webglFaceBuffer&&j.deleteBuffer(this.__webglFaceBuffer);void 0!==this.__webglLineBuffer&&j.deleteBuffer(this.__webglLineBuffer);void 0!==
this.__webglLineDistanceBuffer&&j.deleteBuffer(this.__webglLineDistanceBuffer);if(void 0!==this.geometryGroups)for(var a in this.geometryGroups){var c=this.geometryGroups[a];if(void 0!==c.numMorphTargets)for(var d=0,e=c.numMorphTargets;d<e;d++)j.deleteBuffer(c.__webglMorphTargetsBuffers[d]);if(void 0!==c.numMorphNormals){d=0;for(e=c.numMorphNormals;d<e;d++)j.deleteBuffer(c.__webglMorphNormalsBuffers[d])}b(c)}b(this);N.info.memory.geometries--},Wa=function(){this.removeEventListener("deallocate",Wa);
this.image&&this.image.__webglTextureCube?j.deleteTexture(this.image.__webglTextureCube):this.__webglInit&&(this.__webglInit=!1,j.deleteTexture(this.__webglTexture));N.info.memory.textures--},nb=function(){this.removeEventListener("deallocate",nb);if(this&&this.__webglTexture)if(j.deleteTexture(this.__webglTexture),this instanceof THREE.WebGLRenderTargetCube)for(var a=0;6>a;a++)j.deleteFramebuffer(this.__webglFramebuffer[a]),j.deleteRenderbuffer(this.__webglRenderbuffer[a]);else j.deleteFramebuffer(this.__webglFramebuffer),
j.deleteRenderbuffer(this.__webglRenderbuffer);N.info.memory.textures--},hb=function(){this.removeEventListener("deallocate",hb);Ab(this)},Ab=function(a){var b=a.program;if(void 0!==b){a.program=void 0;var c,d,e=!1,a=0;for(c=O.length;a<c;a++)if(d=O[a],d.program===b){d.usedTimes--;0===d.usedTimes&&(e=!0);break}if(!0===e){e=[];a=0;for(c=O.length;a<c;a++)d=O[a],d.program!==b&&e.push(d);O=e;j.deleteProgram(b);N.info.memory.programs--}}};this.renderBufferImmediate=function(a,b,c){a.hasPositions&&!a.__webglVertexBuffer&&
...
if(a.hasNormals){j.bindBuffer(j.ARRAY_BUFFER,a.__webglNormalBuffer);if(c.shading===THREE.FlatShading){var d,e,f,g,h,i,k,n,m,l,p,r=3*a.count;for(p=0;p<r;p+=9)l=a.normalArray,d=l[p],e=l[p+1],f=l[p+2],g=l[p+3],i=l[p+4],n=l[p+5],h=l[p+6],k=l[p+7],m=l[p+8],d=(d+g+h)/3,e=(e+i+k)/3,f=(f+n+m)/3,l[p]=d,l[p+1]=e,l[p+2]=f,l[p+3]=d,l[p+4]=e,l[p+5]=f,l[p+6]=d,l[p+7]=e,l[p+8]=f}j.bufferData(j.ARRAY_BUFFER,a.normalArray,j.DYNAMIC_DRAW);j.enableVertexAttribArray(b.attributes.normal);j.vertexAttribPointer(b.attributes.normal,
...
0,a.count);a.count=0};this.renderBufferDirect=function(a,b,c,d,e,f){if(!1!==d.visible)if(c=F(a,b,c,d,f),a=c.attributes,b=!1,d=16777215*e.id+2*c.id+(d.wireframe?1:0),d!==Z&&(Z=d,b=!0),b&&n(),f instanceof THREE.Mesh)if(f=e.attributes.index){d=e.offsets;1<d.length&&(b=!0);for(var c=0,g=d.length;c<g;c++){var h=d[c].index;if(b){var i=e.attributes.position,m=i.itemSize;j.bindBuffer(j.ARRAY_BUFFER,i.buffer);k(a.position);j.vertexAttribPointer(a.position,m,j.FLOAT,!1,0,4*h*m);m=e.attributes.normal;if(0<=
...
m.buffer),k(a.tangent),j.vertexAttribPointer(a.tangent,l,j.FLOAT,!1,0,4*h*l));j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,f.buffer)}j.drawElements(j.TRIANGLES,d[c].count,j.UNSIGNED_SHORT,2*d[c].start);N.info.render.calls++;N.info.render.vertices+=d[c].count;N.info.render.faces+=d[c].count/3}}else b&&(i=e.attributes.position,m=i.itemSize,j.bindBuffer(j.ARRAY_BUFFER,i.buffer),k(a.position),j.vertexAttribPointer(a.position,m,j.FLOAT,!1,0,0),m=e.attributes.normal,0<=a.normal&&m&&(l=m.itemSize,j.bindBuffer(j.ARRAY_BUFFER,
...
(d=d.wireframeLinewidth,d!==ma&&(j.lineWidth(d),ma=d),a&&j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,e.__webglLineBuffer),j.drawElements(j.LINES,e.__webglLineCount,j.UNSIGNED_SHORT,0)):(a&&j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,e.__webglFaceBuffer),j.drawElements(j.TRIANGLES,e.__webglFaceCount,j.UNSIGNED_SHORT,0)),N.info.render.calls++,N.info.render.vertices+=e.__webglFaceCount,N.info.render.faces+=e.__webglFaceCount/3):f instanceof THREE.Line?(f=f.type===THREE.LineStrip?j.LINE_STRIP:j.LINES,d=d.linewidth,d!==
ma&&(j.lineWidth(d),ma=d),j.drawArrays(f,0,e.__webglLineCount),N.info.render.calls++):f instanceof THREE.ParticleSystem?(j.drawArrays(j.POINTS,0,e.__webglParticleCount),N.info.render.calls++,N.info.render.points+=e.__webglParticleCount):f instanceof THREE.Ribbon&&(j.drawArrays(j.TRIANGLE_STRIP,0,e.__webglVertexCount),N.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,
f,g,h,i=a.__lights,k=a.fog;ia=-1;ec=!0;this.autoUpdateScene&&a.updateMatrixWorld();void 0===b.parent&&b.updateMatrixWorld();b.matrixWorldInverse.getInverse(b.matrixWorld);lc.multiply(b.projectionMatrix,b.matrixWorldInverse);yb.setFromMatrix(lc);this.autoUpdateObjects&&this.initWebGLObjects(a);r(this.renderPluginsPre,a,b);N.info.render.calls=0;N.info.render.vertices=0;N.info.render.faces=0;N.info.render.points=0;this.setRenderTarget(c);(this.autoClear||d)&&this.clear(this.autoClearColor,this.autoClearDepth,
this.autoClearStencil);h=a.__webglObjects;d=0;for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.render=!1,g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||yb.contains(g))){z(g,b);var m=f,n=m.buffer,q=void 0,t=q=void 0,t=m.object.material;if(t instanceof THREE.MeshFaceMaterial)q=n.materialIndex,q=t.materials[q],q.transparent?(m.transparent=q,m.opaque=null):(m.opaque=q,m.transparent=null);else if(q=t)q.transparent?(m.transparent=q,m.opaque=null):(m.opaque=q,m.transparent=
null);f.render=!0;!0===this.sortObjects&&(null!==g.renderDepth?f.z=g.renderDepth:(Lb.copy(g.matrixWorld.getPosition()),lc.multiplyVector3(Lb),f.z=Lb.z),f.id=g.id)}this.sortObjects&&h.sort(p);h=a.__webglObjectsImmediate;d=0;for(e=h.length;d<e;d++)f=h[d],g=f.object,g.visible&&(z(g,b),g=f.object.material,g.transparent?(f.transparent=g,f.opaque=null):(f.opaque=g,f.transparent=null));a.overrideMaterial?(d=a.overrideMaterial,this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst),this.setDepthTest(d.depthTest),
this.setDepthWrite(d.depthWrite),G(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits),s(a.__webglObjects,!1,"",b,i,k,!0,d),l(a.__webglObjectsImmediate,"",b,i,k,!1,d)):(d=null,this.setBlending(THREE.NoBlending),s(a.__webglObjects,!0,"opaque",b,i,k,!1,d),l(a.__webglObjectsImmediate,"opaque",b,i,k,!1,d),s(a.__webglObjects,!1,"transparent",b,i,k,!0,d),l(a.__webglObjectsImmediate,"transparent",b,i,k,!0,d));r(this.renderPluginsPost,a,b);c&&(c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&
c.minFilter!==THREE.LinearFilter)&&(c instanceof THREE.WebGLRenderTargetCube?(j.bindTexture(j.TEXTURE_CUBE_MAP,c.__webglTexture),j.generateMipmap(j.TEXTURE_CUBE_MAP),j.bindTexture(j.TEXTURE_CUBE_MAP,null)):(j.bindTexture(j.TEXTURE_2D,c.__webglTexture),j.generateMipmap(j.TEXTURE_2D),j.bindTexture(j.TEXTURE_2D,null)));this.setDepthTest(!0);this.setDepthWrite(!0)}};this.renderImmediateObject=function(a,b,c,d,e){var f=F(a,b,c,d,e);Z=-1;N.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,
j,yb):e.render(function(a){N.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=a.__objectsAdded[0],k=a,n=void 0,l=void 0,p=void 0,r=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,void 0!==b.geometry&&void 0===b.geometry.__webglInit&&(b.geometry.__webglInit=!0,b.geometry.addEventListener("deallocate",
zb)),b instanceof THREE.Mesh)if(l=b.geometry,p=b.material,l instanceof THREE.Geometry){if(void 0===l.geometryGroups){var s=l,y=void 0,z=void 0,A=void 0,C=void 0,D=void 0,F=void 0,G={},O=s.morphTargets.length,H=s.morphNormals.length,I=p instanceof THREE.MeshFaceMaterial;s.geometryGroups={};y=0;for(z=s.faces.length;y<z;y++)A=s.faces[y],C=I?A.materialIndex:0,void 0===G[C]&&(G[C]={hash:C,counter:0}),F=G[C].hash+"_"+G[C].counter,void 0===s.geometryGroups[F]&&(s.geometryGroups[F]={faces3:[],faces4:[],materialIndex:C,
vertices:0,numMorphTargets:O,numMorphNormals:H}),D=A instanceof THREE.Face3?3:4,65535<s.geometryGroups[F].vertices+D&&(G[C].counter+=1,F=G[C].hash+"_"+G[C].counter,void 0===s.geometryGroups[F]&&(s.geometryGroups[F]={faces3:[],faces4:[],materialIndex:C,vertices:0,numMorphTargets:O,numMorphNormals:H})),A instanceof THREE.Face3?s.geometryGroups[F].faces3.push(y):s.geometryGroups[F].faces4.push(y),s.geometryGroups[F].vertices+=D;s.geometryGroupsList=[];var K=void 0;for(K in s.geometryGroups)s.geometryGroups[K].id=
oa++,s.geometryGroupsList.push(s.geometryGroups[K])}for(n in l.geometryGroups)if(r=l.geometryGroups[n],!r.__webglVertexBuffer){var J=r;J.__webglVertexBuffer=j.createBuffer();J.__webglNormalBuffer=j.createBuffer();J.__webglTangentBuffer=j.createBuffer();J.__webglColorBuffer=j.createBuffer();J.__webglUVBuffer=j.createBuffer();J.__webglUV2Buffer=j.createBuffer();J.__webglSkinIndicesBuffer=j.createBuffer();J.__webglSkinWeightsBuffer=j.createBuffer();J.__webglFaceBuffer=j.createBuffer();J.__webglLineBuffer=
j.createBuffer();var L=void 0,V=void 0;if(J.numMorphTargets){J.__webglMorphTargetsBuffers=[];L=0;for(V=J.numMorphTargets;L<V;L++)J.__webglMorphTargetsBuffers.push(j.createBuffer())}if(J.numMorphNormals){J.__webglMorphNormalsBuffers=[];L=0;for(V=J.numMorphNormals;L<V;L++)J.__webglMorphNormalsBuffers.push(j.createBuffer())}N.info.memory.geometries++;d(r,b);l.verticesNeedUpdate=!0;l.morphTargetsNeedUpdate=!0;l.elementsNeedUpdate=!0;l.uvsNeedUpdate=!0;l.normalsNeedUpdate=!0;l.tangentsNeedUpdate=!0;l.colorsNeedUpdate=
!0}}else l instanceof THREE.BufferGeometry&&h(l);else if(b instanceof THREE.Ribbon){if(l=b.geometry,!l.__webglVertexBuffer){var M=l;M.__webglVertexBuffer=j.createBuffer();M.__webglColorBuffer=j.createBuffer();M.__webglNormalBuffer=j.createBuffer();N.info.memory.geometries++;var aa=l,Z=b,ea=aa.vertices.length;aa.__vertexArray=new Float32Array(3*ea);aa.__colorArray=new Float32Array(3*ea);aa.__normalArray=new Float32Array(3*ea);aa.__webglVertexCount=ea;c(aa,Z);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=
!0;l.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(l=b.geometry,!l.__webglVertexBuffer){var R=l;R.__webglVertexBuffer=j.createBuffer();R.__webglColorBuffer=j.createBuffer();R.__webglLineDistanceBuffer=j.createBuffer();N.info.memory.geometries++;var P=l,fa=b,X=P.vertices.length;P.__vertexArray=new Float32Array(3*X);P.__colorArray=new Float32Array(3*X);P.__lineDistanceArray=new Float32Array(1*X);P.__webglLineCount=X;c(P,fa);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=!0;l.lineDistancesNeedUpdate=
!0}}else if(b instanceof THREE.ParticleSystem&&(l=b.geometry,!l.__webglVertexBuffer))if(l instanceof THREE.Geometry){var $=l;$.__webglVertexBuffer=j.createBuffer();$.__webglColorBuffer=j.createBuffer();N.info.memory.geometries++;var ia=l,la=b,ka=ia.vertices.length;ia.__vertexArray=new Float32Array(3*ka);ia.__colorArray=new Float32Array(3*ka);ia.__sortArray=[];ia.__webglParticleCount=ka;c(ia,la);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=!0}else l instanceof THREE.BufferGeometry&&h(l);if(!b.__webglActive){if(b instanceof
THREE.Mesh)if(l=b.geometry,l instanceof THREE.BufferGeometry)q(k.__webglObjects,l,b);else for(n in l.geometryGroups)r=l.geometryGroups[n],q(k.__webglObjects,r,b);else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(l=b.geometry,q(k.__webglObjects,l,b)):b instanceof THREE.ImmediateRenderObject||b.immediateRenderCallback?k.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof THREE.Sprite?k.__webglSprites.push(b):b instanceof THREE.LensFlare&&
k.__webglFlares.push(b);b.__webglActive=!0}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var ca=a.__objectsRemoved[0],pa=a;ca instanceof THREE.Mesh||ca instanceof THREE.ParticleSystem||ca instanceof THREE.Ribbon||ca instanceof THREE.Line?x(pa.__webglObjects,ca):ca instanceof THREE.Sprite?t(pa.__webglSprites,ca):ca instanceof THREE.LensFlare?t(pa.__webglFlares,ca):(ca instanceof THREE.ImmediateRenderObject||ca.immediateRenderCallback)&&x(pa.__webglObjectsImmediate,ca);ca.__webglActive=
!1;a.__objectsRemoved.splice(0,1)}for(var sa=0,ya=a.__webglObjects.length;sa<ya;sa++){var za=a.__webglObjects[sa].object,W=za.geometry,xa=void 0,Da=void 0,ma=void 0;if(za instanceof THREE.Mesh)if(W instanceof THREE.BufferGeometry)(W.verticesNeedUpdate||W.elementsNeedUpdate||W.uvsNeedUpdate||W.normalsNeedUpdate||W.colorsNeedUpdate||W.tangentsNeedUpdate)&&i(W,j.DYNAMIC_DRAW,!W.dynamic),W.verticesNeedUpdate=!1,W.elementsNeedUpdate=!1,W.uvsNeedUpdate=!1,W.normalsNeedUpdate=!1,W.colorsNeedUpdate=!1,W.tangentsNeedUpdate=
!1;else{for(var Ea=0,Oa=W.geometryGroupsList.length;Ea<Oa;Ea++)if(xa=W.geometryGroupsList[Ea],ma=e(za,xa),W.buffersNeedUpdate&&d(xa,za),Da=ma.attributes&&u(ma),W.verticesNeedUpdate||W.morphTargetsNeedUpdate||W.elementsNeedUpdate||W.uvsNeedUpdate||W.normalsNeedUpdate||W.colorsNeedUpdate||W.tangentsNeedUpdate||Da){var ta=xa,Ua=za,ua=j.DYNAMIC_DRAW,Ra=!W.dynamic,Ha=ma;if(ta.__inittedArrays){var Sa=f(Ha),mb=Ha.vertexColors?Ha.vertexColors:!1,nb=g(Ha),hb=Sa===THREE.SmoothShading,E=void 0,Y=void 0,Wa=void 0,
Q=void 0,ob=void 0,cb=void 0,Va=void 0,Cb=void 0,db=void 0,pb=void 0,qb=void 0,S=void 0,T=void 0,U=void 0,ra=void 0,Za=void 0,eb=void 0,fb=void 0,tb=void 0,gb=void 0,Pb=void 0,Qb=void 0,yb=void 0,Rb=void 0,Sb=void 0,Tb=void 0,Ab=void 0,Ub=void 0,Vb=void 0,Wb=void 0,Db=void 0,Xb=void 0,Yb=void 0,Zb=void 0,Eb=void 0,Aa=void 0,ec=void 0,mc=void 0,Fb=void 0,Gb=void 0,$a=void 0,kc=void 0,Xa=void 0,Ya=void 0,nc=void 0,fc=void 0,Pa=0,Ta=0,gc=0,hc=0,Hb=0,kb=0,Fa=0,rb=0,Qa=0,da=0,na=0,w=0,Ba=void 0,ab=ta.__vertexArray,
Ob=ta.__uvArray,Ac=ta.__uv2Array,Ib=ta.__normalArray,Ka=ta.__tangentArray,bb=ta.__colorArray,La=ta.__skinIndexArray,Ma=ta.__skinWeightArray,rc=ta.__morphTargetsArrays,cd=ta.__morphNormalsArrays,dd=ta.__webglCustomAttributesList,v=void 0,$b=ta.__faceArray,Bb=ta.__lineArray,ub=Ua.geometry,Ic=ub.elementsNeedUpdate,zc=ub.uvsNeedUpdate,Jc=ub.normalsNeedUpdate,$c=ub.tangentsNeedUpdate,ad=ub.colorsNeedUpdate,bd=ub.morphTargetsNeedUpdate,sc=ub.vertices,va=ta.faces3,wa=ta.faces4,lb=ub.faces,ed=ub.faceVertexUvs[0],
fd=ub.faceVertexUvs[1],tc=ub.skinIndices,oc=ub.skinWeights,pc=ub.morphTargets,Kc=ub.morphNormals;if(ub.verticesNeedUpdate){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],S=sc[Q.a],T=sc[Q.b],U=sc[Q.c],ab[Ta]=S.x,ab[Ta+1]=S.y,ab[Ta+2]=S.z,ab[Ta+3]=T.x,ab[Ta+4]=T.y,ab[Ta+5]=T.z,ab[Ta+6]=U.x,ab[Ta+7]=U.y,ab[Ta+8]=U.z,Ta+=9;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],S=sc[Q.a],T=sc[Q.b],U=sc[Q.c],ra=sc[Q.d],ab[Ta]=S.x,ab[Ta+1]=S.y,ab[Ta+2]=S.z,ab[Ta+3]=T.x,ab[Ta+4]=T.y,ab[Ta+5]=T.z,ab[Ta+6]=U.x,ab[Ta+7]=U.y,ab[Ta+
8]=U.z,ab[Ta+9]=ra.x,ab[Ta+10]=ra.y,ab[Ta+11]=ra.z,Ta+=12;j.bindBuffer(j.ARRAY_BUFFER,ta.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,ab,ua)}if(bd){$a=0;for(kc=pc.length;$a<kc;$a++){E=na=0;for(Y=va.length;E<Y;E++)nc=va[E],Q=lb[nc],S=pc[$a].vertices[Q.a],T=pc[$a].vertices[Q.b],U=pc[$a].vertices[Q.c],Xa=rc[$a],Xa[na]=S.x,Xa[na+1]=S.y,Xa[na+2]=S.z,Xa[na+3]=T.x,Xa[na+4]=T.y,Xa[na+5]=T.z,Xa[na+6]=U.x,Xa[na+7]=U.y,Xa[na+8]=U.z,Ha.morphNormals&&(hb?(fc=Kc[$a].vertexNormals[nc],gb=fc.a,Pb=fc.b,Qb=fc.c):
Qb=Pb=gb=Kc[$a].faceNormals[nc],Ya=cd[$a],Ya[na]=gb.x,Ya[na+1]=gb.y,Ya[na+2]=gb.z,Ya[na+3]=Pb.x,Ya[na+4]=Pb.y,Ya[na+5]=Pb.z,Ya[na+6]=Qb.x,Ya[na+7]=Qb.y,Ya[na+8]=Qb.z),na+=9;E=0;for(Y=wa.length;E<Y;E++)nc=wa[E],Q=lb[nc],S=pc[$a].vertices[Q.a],T=pc[$a].vertices[Q.b],U=pc[$a].vertices[Q.c],ra=pc[$a].vertices[Q.d],Xa=rc[$a],Xa[na]=S.x,Xa[na+1]=S.y,Xa[na+2]=S.z,Xa[na+3]=T.x,Xa[na+4]=T.y,Xa[na+5]=T.z,Xa[na+6]=U.x,Xa[na+7]=U.y,Xa[na+8]=U.z,Xa[na+9]=ra.x,Xa[na+10]=ra.y,Xa[na+11]=ra.z,Ha.morphNormals&&(hb?
(fc=Kc[$a].vertexNormals[nc],gb=fc.a,Pb=fc.b,Qb=fc.c,yb=fc.d):yb=Qb=Pb=gb=Kc[$a].faceNormals[nc],Ya=cd[$a],Ya[na]=gb.x,Ya[na+1]=gb.y,Ya[na+2]=gb.z,Ya[na+3]=Pb.x,Ya[na+4]=Pb.y,Ya[na+5]=Pb.z,Ya[na+6]=Qb.x,Ya[na+7]=Qb.y,Ya[na+8]=Qb.z,Ya[na+9]=yb.x,Ya[na+10]=yb.y,Ya[na+11]=yb.z),na+=12;j.bindBuffer(j.ARRAY_BUFFER,ta.__webglMorphTargetsBuffers[$a]);j.bufferData(j.ARRAY_BUFFER,rc[$a],ua);Ha.morphNormals&&(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglMorphNormalsBuffers[$a]),j.bufferData(j.ARRAY_BUFFER,cd[$a],
ua))}}if(oc.length){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],Ub=oc[Q.a],Vb=oc[Q.b],Wb=oc[Q.c],Ma[da]=Ub.x,Ma[da+1]=Ub.y,Ma[da+2]=Ub.z,Ma[da+3]=Ub.w,Ma[da+4]=Vb.x,Ma[da+5]=Vb.y,Ma[da+6]=Vb.z,Ma[da+7]=Vb.w,Ma[da+8]=Wb.x,Ma[da+9]=Wb.y,Ma[da+10]=Wb.z,Ma[da+11]=Wb.w,Xb=tc[Q.a],Yb=tc[Q.b],Zb=tc[Q.c],La[da]=Xb.x,La[da+1]=Xb.y,La[da+2]=Xb.z,La[da+3]=Xb.w,La[da+4]=Yb.x,La[da+5]=Yb.y,La[da+6]=Yb.z,La[da+7]=Yb.w,La[da+8]=Zb.x,La[da+9]=Zb.y,La[da+10]=Zb.z,La[da+11]=Zb.w,da+=12;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],
Ub=oc[Q.a],Vb=oc[Q.b],Wb=oc[Q.c],Db=oc[Q.d],Ma[da]=Ub.x,Ma[da+1]=Ub.y,Ma[da+2]=Ub.z,Ma[da+3]=Ub.w,Ma[da+4]=Vb.x,Ma[da+5]=Vb.y,Ma[da+6]=Vb.z,Ma[da+7]=Vb.w,Ma[da+8]=Wb.x,Ma[da+9]=Wb.y,Ma[da+10]=Wb.z,Ma[da+11]=Wb.w,Ma[da+12]=Db.x,Ma[da+13]=Db.y,Ma[da+14]=Db.z,Ma[da+15]=Db.w,Xb=tc[Q.a],Yb=tc[Q.b],Zb=tc[Q.c],Eb=tc[Q.d],La[da]=Xb.x,La[da+1]=Xb.y,La[da+2]=Xb.z,La[da+3]=Xb.w,La[da+4]=Yb.x,La[da+5]=Yb.y,La[da+6]=Yb.z,La[da+7]=Yb.w,La[da+8]=Zb.x,La[da+9]=Zb.y,La[da+10]=Zb.z,La[da+11]=Zb.w,La[da+12]=Eb.x,La[da+
13]=Eb.y,La[da+14]=Eb.z,La[da+15]=Eb.w,da+=16;0<da&&(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglSkinIndicesBuffer),j.bufferData(j.ARRAY_BUFFER,La,ua),j.bindBuffer(j.ARRAY_BUFFER,ta.__webglSkinWeightsBuffer),j.bufferData(j.ARRAY_BUFFER,Ma,ua))}if(ad&&mb){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],Va=Q.vertexColors,Cb=Q.color,3===Va.length&&mb===THREE.VertexColors?(Rb=Va[0],Sb=Va[1],Tb=Va[2]):Tb=Sb=Rb=Cb,bb[Qa]=Rb.r,bb[Qa+1]=Rb.g,bb[Qa+2]=Rb.b,bb[Qa+3]=Sb.r,bb[Qa+4]=Sb.g,bb[Qa+5]=Sb.b,bb[Qa+6]=Tb.r,bb[Qa+7]=
Tb.g,bb[Qa+8]=Tb.b,Qa+=9;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],Va=Q.vertexColors,Cb=Q.color,4===Va.length&&mb===THREE.VertexColors?(Rb=Va[0],Sb=Va[1],Tb=Va[2],Ab=Va[3]):Ab=Tb=Sb=Rb=Cb,bb[Qa]=Rb.r,bb[Qa+1]=Rb.g,bb[Qa+2]=Rb.b,bb[Qa+3]=Sb.r,bb[Qa+4]=Sb.g,bb[Qa+5]=Sb.b,bb[Qa+6]=Tb.r,bb[Qa+7]=Tb.g,bb[Qa+8]=Tb.b,bb[Qa+9]=Ab.r,bb[Qa+10]=Ab.g,bb[Qa+11]=Ab.b,Qa+=12;0<Qa&&(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglColorBuffer),j.bufferData(j.ARRAY_BUFFER,bb,ua))}if($c&&ub.hasTangents){E=0;for(Y=va.length;E<Y;E++)Q=
lb[va[E]],db=Q.vertexTangents,Za=db[0],eb=db[1],fb=db[2],Ka[Fa]=Za.x,Ka[Fa+1]=Za.y,Ka[Fa+2]=Za.z,Ka[Fa+3]=Za.w,Ka[Fa+4]=eb.x,Ka[Fa+5]=eb.y,Ka[Fa+6]=eb.z,Ka[Fa+7]=eb.w,Ka[Fa+8]=fb.x,Ka[Fa+9]=fb.y,Ka[Fa+10]=fb.z,Ka[Fa+11]=fb.w,Fa+=12;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],db=Q.vertexTangents,Za=db[0],eb=db[1],fb=db[2],tb=db[3],Ka[Fa]=Za.x,Ka[Fa+1]=Za.y,Ka[Fa+2]=Za.z,Ka[Fa+3]=Za.w,Ka[Fa+4]=eb.x,Ka[Fa+5]=eb.y,Ka[Fa+6]=eb.z,Ka[Fa+7]=eb.w,Ka[Fa+8]=fb.x,Ka[Fa+9]=fb.y,Ka[Fa+10]=fb.z,Ka[Fa+11]=fb.w,Ka[Fa+
12]=tb.x,Ka[Fa+13]=tb.y,Ka[Fa+14]=tb.z,Ka[Fa+15]=tb.w,Fa+=16;j.bindBuffer(j.ARRAY_BUFFER,ta.__webglTangentBuffer);j.bufferData(j.ARRAY_BUFFER,Ka,ua)}if(Jc&&Sa){E=0;for(Y=va.length;E<Y;E++)if(Q=lb[va[E]],ob=Q.vertexNormals,cb=Q.normal,3===ob.length&&hb)for(Aa=0;3>Aa;Aa++)mc=ob[Aa],Ib[kb]=mc.x,Ib[kb+1]=mc.y,Ib[kb+2]=mc.z,kb+=3;else for(Aa=0;3>Aa;Aa++)Ib[kb]=cb.x,Ib[kb+1]=cb.y,Ib[kb+2]=cb.z,kb+=3;E=0;for(Y=wa.length;E<Y;E++)if(Q=lb[wa[E]],ob=Q.vertexNormals,cb=Q.normal,4===ob.length&&hb)for(Aa=0;4>Aa;Aa++)mc=
ob[Aa],Ib[kb]=mc.x,Ib[kb+1]=mc.y,Ib[kb+2]=mc.z,kb+=3;else for(Aa=0;4>Aa;Aa++)Ib[kb]=cb.x,Ib[kb+1]=cb.y,Ib[kb+2]=cb.z,kb+=3;j.bindBuffer(j.ARRAY_BUFFER,ta.__webglNormalBuffer);j.bufferData(j.ARRAY_BUFFER,Ib,ua)}if(zc&&ed&&nb){E=0;for(Y=va.length;E<Y;E++)if(Wa=va[E],pb=ed[Wa],void 0!==pb)for(Aa=0;3>Aa;Aa++)Fb=pb[Aa],Ob[gc]=Fb.x,Ob[gc+1]=Fb.y,gc+=2;E=0;for(Y=wa.length;E<Y;E++)if(Wa=wa[E],pb=ed[Wa],void 0!==pb)for(Aa=0;4>Aa;Aa++)Fb=pb[Aa],Ob[gc]=Fb.x,Ob[gc+1]=Fb.y,gc+=2;0<gc&&(j.bindBuffer(j.ARRAY_BUFFER,
ta.__webglUVBuffer),j.bufferData(j.ARRAY_BUFFER,Ob,ua))}if(zc&&fd&&nb){E=0;for(Y=va.length;E<Y;E++)if(Wa=va[E],qb=fd[Wa],void 0!==qb)for(Aa=0;3>Aa;Aa++)Gb=qb[Aa],Ac[hc]=Gb.x,Ac[hc+1]=Gb.y,hc+=2;E=0;for(Y=wa.length;E<Y;E++)if(Wa=wa[E],qb=fd[Wa],void 0!==qb)for(Aa=0;4>Aa;Aa++)Gb=qb[Aa],Ac[hc]=Gb.x,Ac[hc+1]=Gb.y,hc+=2;0<hc&&(j.bindBuffer(j.ARRAY_BUFFER,ta.__webglUV2Buffer),j.bufferData(j.ARRAY_BUFFER,Ac,ua))}if(Ic){E=0;for(Y=va.length;E<Y;E++)$b[Hb]=Pa,$b[Hb+1]=Pa+1,$b[Hb+2]=Pa+2,Hb+=3,Bb[rb]=Pa,Bb[rb+
1]=Pa+1,Bb[rb+2]=Pa,Bb[rb+3]=Pa+2,Bb[rb+4]=Pa+1,Bb[rb+5]=Pa+2,rb+=6,Pa+=3;E=0;for(Y=wa.length;E<Y;E++)$b[Hb]=Pa,$b[Hb+1]=Pa+1,$b[Hb+2]=Pa+3,$b[Hb+3]=Pa+1,$b[Hb+4]=Pa+2,$b[Hb+5]=Pa+3,Hb+=6,Bb[rb]=Pa,Bb[rb+1]=Pa+1,Bb[rb+2]=Pa,Bb[rb+3]=Pa+3,Bb[rb+4]=Pa+1,Bb[rb+5]=Pa+2,Bb[rb+6]=Pa+2,Bb[rb+7]=Pa+3,rb+=8,Pa+=4;j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,ta.__webglFaceBuffer);j.bufferData(j.ELEMENT_ARRAY_BUFFER,$b,ua);j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,ta.__webglLineBuffer);j.bufferData(j.ELEMENT_ARRAY_BUFFER,
Bb,ua)}if(dd){Aa=0;for(ec=dd.length;Aa<ec;Aa++)if(v=dd[Aa],v.__original.needsUpdate){w=0;if(1===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],v.array[w]=v.value[Q.a],v.array[w+1]=v.value[Q.b],v.array[w+2]=v.value[Q.c],w+=3;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],v.array[w]=v.value[Q.a],v.array[w+1]=v.value[Q.b],v.array[w+2]=v.value[Q.c],v.array[w+3]=v.value[Q.d],w+=4}else{if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],v.array[w]=
Ba,v.array[w+1]=Ba,v.array[w+2]=Ba,w+=3;E=0;for(Y=wa.length;E<Y;E++)Ba=v.value[wa[E]],v.array[w]=Ba,v.array[w+1]=Ba,v.array[w+2]=Ba,v.array[w+3]=Ba,w+=4}}else if(2===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=U.x,v.array[w+5]=U.y,w+=6;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],ra=v.value[Q.d],
v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=U.x,v.array[w+5]=U.y,v.array[w+6]=ra.x,v.array[w+7]=ra.y,w+=8}else{if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)U=T=S=Ba=v.value[va[E]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=U.x,v.array[w+5]=U.y,w+=6;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=U.x,v.array[w+5]=U.y,v.array[w+6]=ra.x,v.array[w+
7]=ra.y,w+=8}}else if(3===v.size){var ba;ba="c"===v.type?["r","g","b"]:["x","y","z"];if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],w+=9;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],
ra=v.value[Q.d],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],v.array[w+9]=ra[ba[0]],v.array[w+10]=ra[ba[1]],v.array[w+11]=ra[ba[2]],w+=12}else if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)U=T=S=Ba=v.value[va[E]],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+
6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],w+=9;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],v.array[w+9]=ra[ba[0]],v.array[w+10]=ra[ba[1]],v.array[w+11]=ra[ba[2]],w+=12}else if("faceVertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],S=Ba[0],T=Ba[1],U=Ba[2],v.array[w]=
S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],w+=9;E=0;for(Y=wa.length;E<Y;E++)Ba=v.value[wa[E]],S=Ba[0],T=Ba[1],U=Ba[2],ra=Ba[3],v.array[w]=S[ba[0]],v.array[w+1]=S[ba[1]],v.array[w+2]=S[ba[2]],v.array[w+3]=T[ba[0]],v.array[w+4]=T[ba[1]],v.array[w+5]=T[ba[2]],v.array[w+6]=U[ba[0]],v.array[w+7]=U[ba[1]],v.array[w+8]=U[ba[2]],v.array[w+9]=ra[ba[0]],v.array[w+10]=
ra[ba[1]],v.array[w+11]=ra[ba[2]],w+=12}}else if(4===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Q=lb[va[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,w+=12;E=0;for(Y=wa.length;E<Y;E++)Q=lb[wa[E]],S=v.value[Q.a],T=v.value[Q.b],U=v.value[Q.c],ra=v.value[Q.d],
v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,v.array[w+12]=ra.x,v.array[w+13]=ra.y,v.array[w+14]=ra.z,v.array[w+15]=ra.w,w+=16}else if("faces"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)U=T=S=Ba=v.value[va[E]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,
v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,w+=12;E=0;for(Y=wa.length;E<Y;E++)ra=U=T=S=Ba=v.value[wa[E]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,v.array[w+12]=ra.x,v.array[w+13]=ra.y,v.array[w+14]=ra.z,v.array[w+15]=ra.w,w+=16}else if("faceVertices"===v.boundTo){E=0;for(Y=va.length;E<Y;E++)Ba=v.value[va[E]],S=
Ba[0],T=Ba[1],U=Ba[2],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+11]=U.w,w+=12;E=0;for(Y=wa.length;E<Y;E++)Ba=v.value[wa[E]],S=Ba[0],T=Ba[1],U=Ba[2],ra=Ba[3],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=U.x,v.array[w+9]=U.y,v.array[w+10]=U.z,v.array[w+
11]=U.w,v.array[w+12]=ra.x,v.array[w+13]=ra.y,v.array[w+14]=ra.z,v.array[w+15]=ra.w,w+=16}j.bindBuffer(j.ARRAY_BUFFER,v.buffer);j.bufferData(j.ARRAY_BUFFER,v.array,ua)}}Ra&&(delete ta.__inittedArrays,delete ta.__colorArray,delete ta.__normalArray,delete ta.__tangentArray,delete ta.__uvArray,delete ta.__uv2Array,delete ta.__faceArray,delete ta.__vertexArray,delete ta.__lineArray,delete ta.__skinIndexArray,delete ta.__skinWeightArray)}}W.verticesNeedUpdate=!1;W.morphTargetsNeedUpdate=!1;W.elementsNeedUpdate=
!1;W.uvsNeedUpdate=!1;W.normalsNeedUpdate=!1;W.colorsNeedUpdate=!1;W.tangentsNeedUpdate=!1;W.buffersNeedUpdate=!1;ma.attributes&&B(ma)}else if(za instanceof THREE.Ribbon){ma=e(za,W);Da=ma.attributes&&u(ma);if(W.verticesNeedUpdate||W.colorsNeedUpdate||W.normalsNeedUpdate||Da){var Jb=W,Lc=j.DYNAMIC_DRAW,Bc=void 0,Cc=void 0,Dc=void 0,Mc=void 0,Ca=void 0,Nc=void 0,Oc=void 0,Pc=void 0,ld=void 0,ib=void 0,wc=void 0,Ia=void 0,vb=void 0,md=Jb.vertices,nd=Jb.colors,od=Jb.normals,xd=md.length,yd=nd.length,
zd=od.length,Qc=Jb.__vertexArray,Rc=Jb.__colorArray,Sc=Jb.__normalArray,Ad=Jb.colorsNeedUpdate,Bd=Jb.normalsNeedUpdate,gd=Jb.__webglCustomAttributesList;if(Jb.verticesNeedUpdate){for(Bc=0;Bc<xd;Bc++)Mc=md[Bc],Ca=3*Bc,Qc[Ca]=Mc.x,Qc[Ca+1]=Mc.y,Qc[Ca+2]=Mc.z;j.bindBuffer(j.ARRAY_BUFFER,Jb.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,Qc,Lc)}if(Ad){for(Cc=0;Cc<yd;Cc++)Nc=nd[Cc],Ca=3*Cc,Rc[Ca]=Nc.r,Rc[Ca+1]=Nc.g,Rc[Ca+2]=Nc.b;j.bindBuffer(j.ARRAY_BUFFER,Jb.__webglColorBuffer);j.bufferData(j.ARRAY_BUFFER,
Rc,Lc)}if(Bd){for(Dc=0;Dc<zd;Dc++)Oc=od[Dc],Ca=3*Dc,Sc[Ca]=Oc.x,Sc[Ca+1]=Oc.y,Sc[Ca+2]=Oc.z;j.bindBuffer(j.ARRAY_BUFFER,Jb.__webglNormalBuffer);j.bufferData(j.ARRAY_BUFFER,Sc,Lc)}if(gd){Pc=0;for(ld=gd.length;Pc<ld;Pc++)if(Ia=gd[Pc],Ia.needsUpdate&&(void 0===Ia.boundTo||"vertices"===Ia.boundTo)){Ca=0;wc=Ia.value.length;if(1===Ia.size)for(ib=0;ib<wc;ib++)Ia.array[ib]=Ia.value[ib];else if(2===Ia.size)for(ib=0;ib<wc;ib++)vb=Ia.value[ib],Ia.array[Ca]=vb.x,Ia.array[Ca+1]=vb.y,Ca+=2;else if(3===Ia.size)if("c"===
Ia.type)for(ib=0;ib<wc;ib++)vb=Ia.value[ib],Ia.array[Ca]=vb.r,Ia.array[Ca+1]=vb.g,Ia.array[Ca+2]=vb.b,Ca+=3;else for(ib=0;ib<wc;ib++)vb=Ia.value[ib],Ia.array[Ca]=vb.x,Ia.array[Ca+1]=vb.y,Ia.array[Ca+2]=vb.z,Ca+=3;else if(4===Ia.size)for(ib=0;ib<wc;ib++)vb=Ia.value[ib],Ia.array[Ca]=vb.x,Ia.array[Ca+1]=vb.y,Ia.array[Ca+2]=vb.z,Ia.array[Ca+3]=vb.w,Ca+=4;j.bindBuffer(j.ARRAY_BUFFER,Ia.buffer);j.bufferData(j.ARRAY_BUFFER,Ia.array,Lc)}}}W.verticesNeedUpdate=!1;W.colorsNeedUpdate=!1;W.normalsNeedUpdate=
!1;ma.attributes&&B(ma)}else if(za instanceof THREE.Line){ma=e(za,W);Da=ma.attributes&&u(ma);if(W.verticesNeedUpdate||W.colorsNeedUpdate||W.lineDistancesNeedUpdate||Da){var Kb=W,Tc=j.DYNAMIC_DRAW,Ec=void 0,Fc=void 0,Gc=void 0,Uc=void 0,Na=void 0,Vc=void 0,pd=Kb.vertices,qd=Kb.colors,rd=Kb.lineDistances,Cd=pd.length,Dd=qd.length,Ed=rd.length,Wc=Kb.__vertexArray,Xc=Kb.__colorArray,sd=Kb.__lineDistanceArray,Fd=Kb.colorsNeedUpdate,Gd=Kb.lineDistancesNeedUpdate,hd=Kb.__webglCustomAttributesList,Yc=void 0,
td=void 0,jb=void 0,xc=void 0,wb=void 0,Ja=void 0;if(Kb.verticesNeedUpdate){for(Ec=0;Ec<Cd;Ec++)Uc=pd[Ec],Na=3*Ec,Wc[Na]=Uc.x,Wc[Na+1]=Uc.y,Wc[Na+2]=Uc.z;j.bindBuffer(j.ARRAY_BUFFER,Kb.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,Wc,Tc)}if(Fd){for(Fc=0;Fc<Dd;Fc++)Vc=qd[Fc],Na=3*Fc,Xc[Na]=Vc.r,Xc[Na+1]=Vc.g,Xc[Na+2]=Vc.b;j.bindBuffer(j.ARRAY_BUFFER,Kb.__webglColorBuffer);j.bufferData(j.ARRAY_BUFFER,Xc,Tc)}if(Gd){for(Gc=0;Gc<Ed;Gc++)sd[Gc]=rd[Gc];j.bindBuffer(j.ARRAY_BUFFER,Kb.__webglLineDistanceBuffer);
j.bufferData(j.ARRAY_BUFFER,sd,Tc)}if(hd){Yc=0;for(td=hd.length;Yc<td;Yc++)if(Ja=hd[Yc],Ja.needsUpdate&&(void 0===Ja.boundTo||"vertices"===Ja.boundTo)){Na=0;xc=Ja.value.length;if(1===Ja.size)for(jb=0;jb<xc;jb++)Ja.array[jb]=Ja.value[jb];else if(2===Ja.size)for(jb=0;jb<xc;jb++)wb=Ja.value[jb],Ja.array[Na]=wb.x,Ja.array[Na+1]=wb.y,Na+=2;else if(3===Ja.size)if("c"===Ja.type)for(jb=0;jb<xc;jb++)wb=Ja.value[jb],Ja.array[Na]=wb.r,Ja.array[Na+1]=wb.g,Ja.array[Na+2]=wb.b,Na+=3;else for(jb=0;jb<xc;jb++)wb=
Ja.value[jb],Ja.array[Na]=wb.x,Ja.array[Na+1]=wb.y,Ja.array[Na+2]=wb.z,Na+=3;else if(4===Ja.size)for(jb=0;jb<xc;jb++)wb=Ja.value[jb],Ja.array[Na]=wb.x,Ja.array[Na+1]=wb.y,Ja.array[Na+2]=wb.z,Ja.array[Na+3]=wb.w,Na+=4;j.bindBuffer(j.ARRAY_BUFFER,Ja.buffer);j.bufferData(j.ARRAY_BUFFER,Ja.array,Tc)}}}W.verticesNeedUpdate=!1;W.colorsNeedUpdate=!1;W.lineDistancesNeedUpdate=!1;ma.attributes&&B(ma)}else if(za instanceof THREE.ParticleSystem)if(W instanceof THREE.BufferGeometry)(W.verticesNeedUpdate||W.colorsNeedUpdate)&&
i(W,j.DYNAMIC_DRAW,!W.dynamic),W.verticesNeedUpdate=!1,W.colorsNeedUpdate=!1;else{ma=e(za,W);Da=ma.attributes&&u(ma);if(W.verticesNeedUpdate||W.colorsNeedUpdate||za.sortParticles||Da){var ac=W,id=j.DYNAMIC_DRAW,Hc=za,xb=void 0,bc=void 0,cc=void 0,ha=void 0,dc=void 0,qc=void 0,Zc=ac.vertices,jd=Zc.length,kd=ac.colors,ud=kd.length,uc=ac.__vertexArray,vc=ac.__colorArray,ic=ac.__sortArray,vd=ac.verticesNeedUpdate,wd=ac.colorsNeedUpdate,jc=ac.__webglCustomAttributesList,Mb=void 0,yc=void 0,qa=void 0,Nb=
void 0,Ga=void 0,ga=void 0;if(Hc.sortParticles){sb.copy(lc);sb.multiplySelf(Hc.matrixWorld);for(xb=0;xb<jd;xb++)cc=Zc[xb],Lb.copy(cc),sb.multiplyVector3(Lb),ic[xb]=[Lb.z,xb];ic.sort(m);for(xb=0;xb<jd;xb++)cc=Zc[ic[xb][1]],ha=3*xb,uc[ha]=cc.x,uc[ha+1]=cc.y,uc[ha+2]=cc.z;for(bc=0;bc<ud;bc++)ha=3*bc,qc=kd[ic[bc][1]],vc[ha]=qc.r,vc[ha+1]=qc.g,vc[ha+2]=qc.b;if(jc){Mb=0;for(yc=jc.length;Mb<yc;Mb++)if(ga=jc[Mb],void 0===ga.boundTo||"vertices"===ga.boundTo)if(ha=0,Nb=ga.value.length,1===ga.size)for(qa=0;qa<
Nb;qa++)dc=ic[qa][1],ga.array[qa]=ga.value[dc];else if(2===ga.size)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ha]=Ga.x,ga.array[ha+1]=Ga.y,ha+=2;else if(3===ga.size)if("c"===ga.type)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ha]=Ga.r,ga.array[ha+1]=Ga.g,ga.array[ha+2]=Ga.b,ha+=3;else for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ha]=Ga.x,ga.array[ha+1]=Ga.y,ga.array[ha+2]=Ga.z,ha+=3;else if(4===ga.size)for(qa=0;qa<Nb;qa++)dc=ic[qa][1],Ga=ga.value[dc],ga.array[ha]=
Ga.x,ga.array[ha+1]=Ga.y,ga.array[ha+2]=Ga.z,ga.array[ha+3]=Ga.w,ha+=4}}else{if(vd)for(xb=0;xb<jd;xb++)cc=Zc[xb],ha=3*xb,uc[ha]=cc.x,uc[ha+1]=cc.y,uc[ha+2]=cc.z;if(wd)for(bc=0;bc<ud;bc++)qc=kd[bc],ha=3*bc,vc[ha]=qc.r,vc[ha+1]=qc.g,vc[ha+2]=qc.b;if(jc){Mb=0;for(yc=jc.length;Mb<yc;Mb++)if(ga=jc[Mb],ga.needsUpdate&&(void 0===ga.boundTo||"vertices"===ga.boundTo))if(Nb=ga.value.length,ha=0,1===ga.size)for(qa=0;qa<Nb;qa++)ga.array[qa]=ga.value[qa];else if(2===ga.size)for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],
ga.array[ha]=Ga.x,ga.array[ha+1]=Ga.y,ha+=2;else if(3===ga.size)if("c"===ga.type)for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ha]=Ga.r,ga.array[ha+1]=Ga.g,ga.array[ha+2]=Ga.b,ha+=3;else for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ha]=Ga.x,ga.array[ha+1]=Ga.y,ga.array[ha+2]=Ga.z,ha+=3;else if(4===ga.size)for(qa=0;qa<Nb;qa++)Ga=ga.value[qa],ga.array[ha]=Ga.x,ga.array[ha+1]=Ga.y,ga.array[ha+2]=Ga.z,ga.array[ha+3]=Ga.w,ha+=4}}if(vd||Hc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,ac.__webglVertexBuffer),
j.bufferData(j.ARRAY_BUFFER,uc,id);if(wd||Hc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,ac.__webglColorBuffer),j.bufferData(j.ARRAY_BUFFER,vc,id);if(jc){Mb=0;for(yc=jc.length;Mb<yc;Mb++)if(ga=jc[Mb],ga.needsUpdate||Hc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,ga.buffer),j.bufferData(j.ARRAY_BUFFER,ga.array,id)}}W.verticesNeedUpdate=!1;W.colorsNeedUpdate=!1;ma.attributes&&B(ma)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h;a.addEventListener("deallocate",hb);var i,k,m,n,l;a instanceof THREE.MeshDepthMaterial?
...
skinning:a.skinning,maxBones:m,useVertexTexture:Va&&d&&d.useVertexTexture,boneTextureWidth:d&&d.boneTextureWidth,boneTextureHeight:d&&d.boneTextureHeight,morphTargets:a.morphTargets,morphNormals:a.morphNormals,maxMorphTargets:this.maxMorphTargets,maxMorphNormals:this.maxMorphNormals,maxDirLights:e,maxPointLights:f,maxSpotLights:g,maxHemiLights:h,maxShadows:n,shadowMapEnabled:this.shadowMapEnabled&&d.receiveShadow,shadowMapType:this.shadowMapType,shadowMapDebug:this.shadowMapDebug,shadowMapCascade:this.shadowMapCascade,
alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide},t,u,x,d=[];l?d.push(l):(d.push(s),d.push(q));for(u in r)d.push(u),d.push(r[u]);for(t in c)d.push(t),d.push(c[t]);l=d.join();t=0;for(u=O.length;t<u;t++)if(d=O[t],d.code===l){d.usedTimes++;k=d.program;break a}t="SHADOWMAP_TYPE_BASIC";c.shadowMapType===THREE.PCFShadowMap?t="SHADOWMAP_TYPE_PCF":c.shadowMapType===THREE.PCFSoftShadowMap&&(t="SHADOWMAP_TYPE_PCF_SOFT");
u=[];for(x in r)d=r[x],!1!==d&&(d="#define "+x+" "+d,u.push(d));d=u.join("\n");x=j.createProgram();u=["precision "+R+" float;",d,tb?"#define VERTEX_TEXTURES":"",N.gammaInput?"#define GAMMA_INPUT":"",N.gammaOutput?"#define GAMMA_OUTPUT":"",N.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS "+c.maxDirLights,"#define MAX_POINT_LIGHTS "+c.maxPointLights,"#define MAX_SPOT_LIGHTS "+c.maxSpotLights,"#define MAX_HEMI_LIGHTS "+c.maxHemiLights,"#define MAX_SHADOWS "+c.maxShadows,
...
b&&(b?j.disable(j.CULL_FACE):j.enable(j.CULL_FACE),Da=b);Ua!==a&&(a?j.frontFace(j.CW):j.frontFace(j.CCW),Ua=a)};this.setDepthTest=function(a){db!==a&&(a?j.enable(j.DEPTH_TEST):j.disable(j.DEPTH_TEST),db=a)};this.setDepthWrite=function(a){pb!==a&&(j.depthMask(a),pb=a)};this.setBlending=function(a,b,c,d){a!==sa&&(a===THREE.NoBlending?j.disable(j.BLEND):a===THREE.AdditiveBlending?(j.enable(j.BLEND),j.blendEquation(j.FUNC_ADD),j.blendFunc(j.SRC_ALPHA,j.ONE)):a===THREE.SubtractiveBlending?(j.enable(j.BLEND),
j.blendEquation(j.FUNC_ADD),j.blendFunc(j.ZERO,j.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?(j.enable(j.BLEND),j.blendEquation(j.FUNC_ADD),j.blendFunc(j.ZERO,j.SRC_COLOR)):a===THREE.CustomBlending?j.enable(j.BLEND):(j.enable(j.BLEND),j.blendEquationSeparate(j.FUNC_ADD,j.FUNC_ADD),j.blendFuncSeparate(j.SRC_ALPHA,j.ONE_MINUS_SRC_ALPHA,j.ONE,j.ONE_MINUS_SRC_ALPHA)),sa=a);if(a===THREE.CustomBlending){if(b!==mb&&(j.blendEquation(K(b)),mb=b),c!==Cb||d!==ob)j.blendFunc(K(c),K(d)),Cb=c,ob=d}else ob=
Cb=mb=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.addEventListener("deallocate",Wa),a.__webglTexture=j.createTexture(),N.info.memory.textures++);j.activeTexture(j.TEXTURE0+b);j.bindTexture(j.TEXTURE_2D,a.__webglTexture);j.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,a.flipY);j.pixelStorei(j.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);j.pixelStorei(j.UNPACK_ALIGNMENT,a.unpackAlignment);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=K(a.format),
...
h,e,e,f,c);a.generateMipmaps=!1}else j.texImage2D(j.TEXTURE_2D,0,e,e,f,a.image);a.generateMipmaps&&d&&j.generateMipmap(j.TEXTURE_2D);a.needsUpdate=!1;if(a.onUpdate)a.onUpdate()}else j.activeTexture(j.TEXTURE0+b),j.bindTexture(j.TEXTURE_2D,a.__webglTexture)};this.setRenderTarget=function(a){var b=a instanceof THREE.WebGLRenderTargetCube;if(a&&!a.__webglFramebuffer){void 0===a.depthBuffer&&(a.depthBuffer=!0);void 0===a.stencilBuffer&&(a.stencilBuffer=!0);a.addEventListener("deallocate",nb);a.__webglTexture=
j.createTexture();N.info.memory.textures++;var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=K(a.format),e=K(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];j.bindTexture(j.TEXTURE_CUBE_MAP,a.__webglTexture);D(j.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=j.createFramebuffer();a.__webglRenderbuffer[f]=j.createRenderbuffer();j.texImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var g=a,h=j.TEXTURE_CUBE_MAP_POSITIVE_X+f;j.bindFramebuffer(j.FRAMEBUFFER,
a.__webglFramebuffer[f]);j.framebufferTexture2D(j.FRAMEBUFFER,j.COLOR_ATTACHMENT0,h,g.__webglTexture,0);L(a.__webglRenderbuffer[f],a)}c&&j.generateMipmap(j.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=j.createFramebuffer(),a.__webglRenderbuffer=j.createRenderbuffer(),j.bindTexture(j.TEXTURE_2D,a.__webglTexture),D(j.TEXTURE_2D,a,c),j.texImage2D(j.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=j.TEXTURE_2D,j.bindFramebuffer(j.FRAMEBUFFER,a.__webglFramebuffer),j.framebufferTexture2D(j.FRAMEBUFFER,j.COLOR_ATTACHMENT0,
d,a.__webglTexture,0),L(a.__webglRenderbuffer,a),c&&j.generateMipmap(j.TEXTURE_2D);b?j.bindTexture(j.TEXTURE_CUBE_MAP,null):j.bindTexture(j.TEXTURE_2D,null);j.bindRenderbuffer(j.RENDERBUFFER,null);j.bindFramebuffer(j.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=Ha,a=qb,d=Ra,e=Db);b!==V&&(j.bindFramebuffer(j.FRAMEBUFFER,b),j.viewport(d,e,c,a),V=b);eb=c;Oa=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);
this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};THREE.WebGLRenderTarget=function(a,b,c){THREE.EventTarget.call(this);this.width=a;this.height=b;c=c||{};this.wrapS=void 0!==c.wrapS?c.wrapS:THREE.ClampToEdgeWrapping;this.wrapT=void 0!==c.wrapT?c.wrapT:THREE.ClampToEdgeWrapping;this.magFilter=void 0!==c.magFilter?c.magFilter:THREE.LinearFilter;this.minFilter=void 0!==c.minFilter?c.minFilter:THREE.LinearMipMapLinearFilter;this.anisotropy=void 0!==c.anisotropy?c.anisotropy:1;this.offset=new THREE.Vector2(0,0);this.repeat=new THREE.Vector2(1,1);this.format=
void 0!==c.format?c.format:THREE.RGBAFormat;this.type=void 0!==c.type?c.type:THREE.UnsignedByteType;this.depthBuffer=void 0!==c.depthBuffer?c.depthBuffer:!0;this.stencilBuffer=void 0!==c.stencilBuffer?c.stencilBuffer:!0;this.generateMipmaps=!0};
THREE.WebGLRenderTarget.prototype.clone=function(){var a=new THREE.WebGLRenderTarget(this.width,this.height);a.wrapS=this.wrapS;a.wrapT=this.wrapT;a.magFilter=this.magFilter;a.minFilter=this.minFilter;a.anisotropy=this.anisotropy;a.offset.copy(this.offset);a.repeat.copy(this.repeat);a.format=this.format;a.type=this.type;a.depthBuffer=this.depthBuffer;a.stencilBuffer=this.stencilBuffer;a.generateMipmaps=this.generateMipmaps;return a};THREE.WebGLRenderTarget.prototype.deallocate=function(){this.dispatchEvent({type:"deallocate"})};THREE.WebGLRenderTargetCube=function(a,b,c){THREE.WebGLRenderTarget.call(this,a,b,c);this.activeCubeFace=0};THREE.WebGLRenderTargetCube.prototype=Object.create(THREE.WebGLRenderTarget.prototype);THREE.RenderableVertex=function(){this.positionWorld=new THREE.Vector3;this.positionScreen=new THREE.Vector4;this.visible=!0};THREE.RenderableVertex.prototype.copy=function(a){this.positionWorld.copy(a.positionWorld);this.positionScreen.copy(a.positionScreen)};THREE.RenderableFace3=function(){this.v1=new THREE.RenderableVertex;this.v2=new THREE.RenderableVertex;this.v3=new THREE.RenderableVertex;this.centroidWorld=new THREE.Vector3;this.centroidScreen=new THREE.Vector3;this.normalWorld=new THREE.Vector3;this.vertexNormalsWorld=[new THREE.Vector3,new THREE.Vector3,new THREE.Vector3];this.vertexNormalsLength=0;this.material=this.color=null;this.uvs=[[]];this.z=null};THREE.RenderableFace4=function(){this.v1=new THREE.RenderableVertex;this.v2=new THREE.RenderableVertex;this.v3=new THREE.RenderableVertex;this.v4=new THREE.RenderableVertex;this.centroidWorld=new THREE.Vector3;this.centroidScreen=new THREE.Vector3;this.normalWorld=new THREE.Vector3;this.vertexNormalsWorld=[new THREE.Vector3,new THREE.Vector3,new THREE.Vector3,new THREE.Vector3];this.vertexNormalsLength=0;this.material=this.color=null;this.uvs=[[]];this.z=null};THREE.RenderableObject=function(){this.z=this.object=null};THREE.RenderableParticle=function(){this.rotation=this.z=this.y=this.x=this.object=null;this.scale=new THREE.Vector2;this.material=null};THREE.RenderableLine=function(){this.z=null;this.v1=new THREE.RenderableVertex;this.v2=new THREE.RenderableVertex;this.material=null};THREE.ColorUtils={adjustHSV:function(a,b,c,d){var e=THREE.ColorUtils.__hsv;a.getHSV(e);e.h=THREE.Math.clamp(e.h+b,0,1);e.s=THREE.Math.clamp(e.s+c,0,1);e.v=THREE.Math.clamp(e.v+d,0,1);a.setHSV(e.h,e.s,e.v)}};THREE.ColorUtils.__hsv={h:0,s:0,v:0};THREE.GeometryUtils={merge:function(a,b){var c,d,e=a.vertices.length,f=b instanceof THREE.Mesh?b.geometry:b,g=a.vertices,h=f.vertices,i=a.faces,k=f.faces,n=a.faceVertexUvs[0],f=f.faceVertexUvs[0];b instanceof THREE.Mesh&&(b.matrixAutoUpdate&&b.updateMatrix(),c=b.matrix,d=new THREE.Matrix4,d.extractRotation(c,b.scale));for(var p=0,m=h.length;p<m;p++){var r=h[p].clone();c&&c.multiplyVector3(r);g.push(r)}p=0;for(m=k.length;p<m;p++){var r=k[p],s,l,q=r.vertexNormals,u=r.vertexColors;r instanceof THREE.Face3?
...
void 0,r=a[g[i]].x,s=a[g[i]].y,l=a[g[k]].x,q=a[g[k]].y,u=a[g[n]].x,B=a[g[n]].y;if(1E-10>(l-r)*(B-s)-(q-s)*(u-r))m=!1;else{var F=void 0,C=void 0,z=void 0,A=void 0,H=void 0,G=void 0,I=void 0,$=void 0,D=void 0,L=void 0,D=$=I=t=x=void 0,F=u-l,C=B-q,z=r-u,A=s-B,H=l-r,G=q-s;for(m=0;m<e;m++)if(!(m===i||m===k||m===n))if(x=a[g[m]].x,t=a[g[m]].y,I=x-r,$=t-s,D=x-l,L=t-q,x-=u,t-=B,D=F*L-C*D,I=H*$-G*I,$=z*t-A*x,0<=D&&0<=$&&0<=I){m=!1;break a}m=!0}}if(m){f.push([a[g[i]],a[g[k]],a[g[n]]]);h.push([g[i],g[k],g[n]]);
...
this.faceVertexUvs[0].push([f[e],f[e+1],g]);this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,a)};THREE.CircleGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,l){var q,u=h.widthSegments,B=h.heightSegments,x=e/2,t=f/2,F=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)q="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)q="y",B=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)q="x",u=h.depthSegments;var C=u+1,z=B+1,A=e/u,H=f/B,G=new THREE.Vector3;G[q]=0<g?1:-1;for(e=0;e<z;e++)for(f=0;f<C;f++){var I=new THREE.Vector3;I[a]=(f*A-x)*c;I[b]=(e*H-t)*d;I[q]=g;h.vertices.push(I)}for(e=
...
m=this.vertices[k[0][h+1]].clone()):(p=this.vertices[k[1][h]].clone(),m=this.vertices[k[1][h+1]].clone());p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();m.setY(Math.sqrt(m.x*m.x+m.z*m.z)*c).normalize();for(i=0;i<e;i++){var r=k[i][h],s=k[i+1][h],l=k[i+1][h+1],q=k[i][h+1],u=p.clone(),B=p.clone(),x=m.clone(),t=m.clone(),F=n[i][h].clone(),C=n[i+1][h].clone(),z=n[i+1][h+1].clone(),A=n[i][h+1].clone();this.faces.push(new THREE.Face4(r,s,l,q,[u,B,x,t]));this.faceVertexUvs[0].push([F,C,z,A])}}if(!f&&0<
a){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++)r=k[0][h],s=k[0][h+1],l=this.vertices.length-1,u=new THREE.Vector3(0,1,0),B=new THREE.Vector3(0,1,0),x=new THREE.Vector3(0,1,0),F=n[0][h].clone(),C=n[0][h+1].clone(),z=new THREE.Vector2(C.u,0),this.faces.push(new THREE.Face3(r,s,l,[u,B,x])),this.faceVertexUvs[0].push([F,C,z])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)r=k[i][h+1],s=k[i][h],l=this.vertices.length-1,u=new THREE.Vector3(0,-1,0),B=new THREE.Vector3(0,
-1,0),x=new THREE.Vector3(0,-1,0),F=n[i][h+1].clone(),C=n[i][h].clone(),z=new THREE.Vector2(C.u,1),this.faces.push(new THREE.Face3(r,s,l,[u,B,x])),this.faceVertexUvs[0].push([F,C,z])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(a,b){for(var c=a.length,d=0;d<c;d++)this.addShape(a[d],b)};
...
b.amount?b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,k=void 0!==b.bevelSize?b.bevelSize:i-2,n=void 0!==b.bevelSegments?b.bevelSegments:3,p=void 0!==b.bevelEnabled?b.bevelEnabled:!0,m=void 0!==b.curveSegments?b.curveSegments:12,r=void 0!==b.steps?b.steps:1,s=b.extrudePath,l,q=!1,u=b.material,B=b.extrudeMaterial,x=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,t,F,C,z;s&&(l=s.getSpacedPoints(r),q=!0,p=!1,t=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(s,
r,!1),F=new THREE.Vector3,C=new THREE.Vector3,z=new THREE.Vector3);p||(k=i=n=0);var A,H,G,I=this,$=this.vertices.length,m=a.extractPoints(m),D=m.shape,m=m.holes;if(s=!THREE.Shape.Utils.isClockWise(D)){D=D.reverse();H=0;for(G=m.length;H<G;H++)A=m[H],THREE.Shape.Utils.isClockWise(A)&&(m[H]=A.reverse());s=!1}var L=THREE.Shape.Utils.triangulateShape(D,m),s=D;H=0;for(G=m.length;H<G;H++)A=m[H],D=D.concat(A);var y,K,J,R,P=D.length,ca=L.length,xa=[],M=0,pa=s.length;y=pa-1;for(K=M+1;M<pa;M++,y++,K++)y===pa&&
(y=0),K===pa&&(K=0),xa[M]=d(s[M],s[y],s[K]);var ya=[],ua,N=xa.concat();H=0;for(G=m.length;H<G;H++){A=m[H];ua=[];M=0;pa=A.length;y=pa-1;for(K=M+1;M<pa;M++,y++,K++)y===pa&&(y=0),K===pa&&(K=0),ua[M]=d(A[M],A[y],A[K]);ya.push(ua);N=N.concat(ua)}for(y=0;y<n;y++){A=y/n;J=i*(1-A);K=k*Math.sin(A*Math.PI/2);M=0;for(pa=s.length;M<pa;M++)R=c(s[M],xa[M],K),f(R.x,R.y,-J);H=0;for(G=m.length;H<G;H++){A=m[H];ua=ya[H];M=0;for(pa=A.length;M<pa;M++)R=c(A[M],ua[M],K),f(R.x,R.y,-J)}}K=k;for(M=0;M<P;M++)R=p?c(D[M],N[M],
K):D[M],q?(C.copy(t.normals[0]).multiplyScalar(R.x),F.copy(t.binormals[0]).multiplyScalar(R.y),z.copy(l[0]).addSelf(C).addSelf(F),f(z.x,z.y,z.z)):f(R.x,R.y,0);for(A=1;A<=r;A++)for(M=0;M<P;M++)R=p?c(D[M],N[M],K):D[M],q?(C.copy(t.normals[A]).multiplyScalar(R.x),F.copy(t.binormals[A]).multiplyScalar(R.y),z.copy(l[A]).addSelf(C).addSelf(F),f(z.x,z.y,z.z)):f(R.x,R.y,h/r*A);for(y=n-1;0<=y;y--){A=y/n;J=i*(1-A);K=k*Math.sin(A*Math.PI/2);M=0;for(pa=s.length;M<pa;M++)R=c(s[M],xa[M],K),f(R.x,R.y,h+J);H=0;for(G=
m.length;H<G;H++){A=m[H];ua=ya[H];M=0;for(pa=A.length;M<pa;M++)R=c(A[M],ua[M],K),q?f(R.x,R.y+l[r-1].y,l[r-1].x+J):f(R.x,R.y,h+J)}}if(p){i=0*P;for(M=0;M<ca;M++)h=L[M],g(h[2]+i,h[1]+i,h[0]+i,!0);i=P*(r+2*n);for(M=0;M<ca;M++)h=L[M],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(M=0;M<ca;M++)h=L[M],g(h[2],h[1],h[0],!0);for(M=0;M<ca;M++)h=L[M],g(h[0]+P*r,h[1]+P*r,h[2]+P*r,!1)}h=0;e(s,h);h+=s.length;H=0;for(G=m.length;H<G;H++)A=m[H],e(A,h),h+=A.length};
...
f);b.vertexAttribPointer(C.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(C.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var I,$,D,L,y;for(I=0;I<u;I++)if(C=16/q,z.set(C*x,C),L=a[I],B.set(L.matrixWorld.elements[12],L.matrixWorld.elements[13],L.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(B),d.projectionMatrix.multiplyVector3(B),A.copy(B),H.x=A.x*t+t,H.y=A.y*F+F,k||0<H.x&&H.x<e&&0<H.y&&H.y<q){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,
h);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGB,H.x-8,H.y-8,16,16,0);b.uniform1i(G.renderType,0);b.uniform2f(G.scale,z.x,z.y);b.uniform3f(G.screenPosition,A.x,A.y,A.z);b.disable(b.BLEND);b.enable(b.DEPTH_TEST);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);b.activeTexture(b.TEXTURE0);b.bindTexture(b.TEXTURE_2D,i);b.copyTexImage2D(b.TEXTURE_2D,0,b.RGBA,H.x-8,H.y-8,16,16,0);b.uniform1i(G.renderType,1);b.disable(b.DEPTH_TEST);b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,
6,b.UNSIGNED_SHORT,0);L.positionScreen.copy(A);L.customUpdateCallback?L.customUpdateCallback(L):L.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);$=0;for(D=L.lensFlares.length;$<D;$++)y=L.lensFlares[$],0.001<y.opacity&&0.001<y.scale&&(A.x=y.x,A.y=y.y,A.z=y.z,C=y.size*y.scale/q,z.x=C*x,z.y=C,b.uniform3f(G.screenPosition,A.x,A.y,A.z),b.uniform2f(G.scale,z.x,z.y),b.uniform1f(G.rotation,y.rotation),b.uniform1f(G.opacity,y.opacity),b.uniform3f(G.color,y.color.r,y.color.g,y.color.b),c.setBlending(y.blending,
...
F.far),b.uniform1i(u.fogType,1),t=q=1):F instanceof THREE.FogExp2&&(b.uniform1f(u.fogDensity,F.density),b.uniform1i(u.fogType,2),t=q=2)):(b.uniform1i(u.fogType,0),t=q=0);for(var C,z,A=[],F=0;F<l;F++)C=s[F],z=C.material,C.visible&&0!==z.opacity&&(z.useScreenCoordinates?C.z=-C.position.z:(C._modelViewMatrix.multiply(e.matrixWorldInverse,C.matrixWorld),C.z=-C._modelViewMatrix.elements[14]));s.sort(a);for(F=0;F<l;F++)C=s[F],z=C.material,C.visible&&0!==z.opacity&&(z.map&&z.map.image&&z.map.image.width)&&
(b.uniform1f(u.alphaTest,z.alphaTest),z.useScreenCoordinates?(b.uniform1i(u.useScreenCoordinates,1),b.uniform3f(u.screenPosition,(C.position.x-m)/m,(x-C.position.y)/x,Math.max(0,Math.min(1,C.position.z)))):(b.uniform1i(u.useScreenCoordinates,0),b.uniform1i(u.sizeAttenuation,z.sizeAttenuation?1:0),b.uniformMatrix4fv(u.modelViewMatrix,!1,C._modelViewMatrix.elements)),e=d.fog&&z.fog?t:0,q!==e&&(b.uniform1i(u.fogType,e),q=e),e=1/(z.scaleByViewport?r:1),A[0]=e*B*C.scale.x,A[1]=e*C.scale.y,b.uniform2f(u.uvScale,
z.uvScale.x,z.uvScale.y),b.uniform2f(u.uvOffset,z.uvOffset.x,z.uvOffset.y),b.uniform2f(u.alignment,z.alignment.x,z.alignment.y),b.uniform1f(u.opacity,z.opacity),b.uniform3f(u.color,z.color.r,z.color.g,z.color.b),b.uniform1f(u.rotation,C.rotation),b.uniform2fv(u.scale,A),c.setBlending(z.blending,z.blendEquation,z.blendSrc,z.blendDst),c.setDepthTest(z.depthTest),c.setDepthWrite(z.depthWrite),c.setTexture(z.map,0),b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0));b.enable(b.CULL_FACE)}}};THREE.DepthPassPlugin=function(){this.enabled=!1;this.renderTarget=null;var a,b,c,d,e,f,g=new THREE.Frustum,h=new THREE.Matrix4;this.init=function(g){a=g.context;b=g;var g=THREE.ShaderLib.depthRGBA,h=THREE.UniformsUtils.clone(g.uniforms);c=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h});d=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0});e=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,
