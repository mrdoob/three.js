...
x=d[8],B=d[12],C=d[1],z=d[5],F=d[9],G=d[13],L=d[2],E=d[6],M=d[10],J=d[14],H=d[3],R=d[7],Q=d[11],d=d[15];f[0]=e*r+g*C+h*L+i*H;f[4]=e*A+g*z+h*E+i*R;f[8]=e*x+g*F+h*M+i*Q;f[12]=e*B+g*G+h*J+i*d;f[1]=l*r+j*C+n*L+m*H;f[5]=l*A+j*z+n*E+m*R;f[9]=l*x+j*F+n*M+m*Q;f[13]=l*B+j*G+n*J+m*d;f[2]=p*r+q*C+o*L+t*H;f[6]=p*A+q*z+o*E+t*R;f[10]=p*x+q*F+o*M+t*Q;f[14]=p*B+q*G+o*J+t*d;f[3]=s*r+u*C+v*L+c*H;f[7]=s*A+u*z+v*E+c*R;f[11]=s*x+u*F+v*M+c*Q;f[15]=s*B+u*G+v*J+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
THREE.Frustum.prototype.setFromMatrix=function(a){var b=this.planes,c=a.elements,a=c[0],d=c[1],f=c[2],e=c[3],g=c[4],h=c[5],i=c[6],l=c[7],j=c[8],n=c[9],m=c[10],p=c[11],q=c[12],o=c[13],t=c[14],c=c[15];b[0].set(e-a,l-g,p-j,c-q);b[1].set(e+a,l+g,p+j,c+q);b[2].set(e+d,l+h,p+n,c+o);b[3].set(e-d,l-h,p-n,c-o);b[4].set(e-f,l-i,p-m,c-t);b[5].set(e+f,l+i,p+m,c+t);for(d=0;d<6;d++){a=b[d];a.divideScalar(Math.sqrt(a.x*a.x+a.y*a.y+a.z*a.z))}};
...
(function(a){a.Ray=function(b,c,d,f){this.origin=b||new a.Vector3;this.direction=c||new a.Vector3;this.near=d||0;this.far=f||Infinity};var b=new a.Vector3,c=new a.Vector3,d=new a.Vector3,f=new a.Vector3,e=new a.Vector3,g=new a.Vector3,h=new a.Matrix4,i=function(a,b){return a.distance-b.distance},l=new a.Vector3,j=new a.Vector3,n=new a.Vector3,m=function(a,b,c){l.sub(c,a);var d=l.dot(b),a=j.add(a,n.copy(b).multiplyScalar(d));return c.distanceTo(a)},p=function(a,b,c,d){l.sub(d,b);j.sub(c,b);n.sub(a,
b);var a=l.dot(l),b=l.dot(j),c=l.dot(n),f=j.dot(j),d=j.dot(n),e=1/(a*f-b*b),f=(f*c-b*d)*e,a=(a*d-b*c)*e;return f>=0&&a>=0&&f+a<1},q=function(i,j,l){var n,o;if(i instanceof a.Particle){n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>i.scale.x)return l;o={distance:n,point:i.position,face:null,object:i};l.push(o)}else if(i instanceof a.Mesh){var q=i.geometry.boundingSphere.radius*i.matrixWorld.getMaxScaleOnAxis();n=m(j.origin,j.direction,i.matrixWorld.getPosition());if(n>q)return l;var x,
B,C=i.geometry,z=C.vertices,F,G,L;F=i.geometry.materials;G=i.material instanceof a.MeshFaceMaterial;var E,M=j.precision;i.matrixRotationWorld.extractRotation(i.matrixWorld);b.copy(j.origin);h.getInverse(i.matrixWorld);c.copy(b);h.multiplyVector3(c);d.copy(j.direction);h.rotateAxis(d).normalize();q=0;for(x=C.faces.length;q<x;q++){o=C.faces[q];n=G===true?F[o.materialIndex]:i.material;if(n!==void 0){L=n.side;f.sub(o.centroid,c);e=o.normal;n=d.dot(e);if(!(Math.abs(n)<M)){B=e.dot(f)/n;if(!(B<0)&&(L===
a.DoubleSide||(L===a.FrontSide?n<0:n>0))){g.add(c,d.multiplyScalar(B));if(o instanceof a.Face3){n=z[o.a];B=z[o.b];L=z[o.c];if(p(g,n,B,L)){B=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(B);if(!(n<j.near||n>j.far)){o={distance:n,point:B,face:o,faceIndex:q,object:i};l.push(o)}}}else if(o instanceof a.Face4){n=z[o.a];B=z[o.b];L=z[o.c];E=z[o.d];if(p(g,n,B,E)||p(g,B,L,E)){B=i.matrixWorld.multiplyVector3(g.clone());n=b.distanceTo(B);if(!(n<j.near||n>j.far)){o={distance:n,point:B,face:o,faceIndex:q,
object:i};l.push(o)}}}}}}}}},o=function(a,b,c){for(var a=a.getDescendants(),d=0,f=a.length;d<f;d++)q(a[d],b,c)};a.Ray.prototype.precision=1E-4;a.Ray.prototype.set=function(a,b){this.origin=a;this.direction=b};a.Ray.prototype.intersectObject=function(a,b){var c=[];b===true&&o(a,this,c);q(a,this,c);c.sort(i);return c};a.Ray.prototype.intersectObjects=function(a,b){for(var c=[],d=0,f=a.length;d<f;d++){q(a[d],this,c);b===true&&o(a[d],this,c)}c.sort(i);return c}})(THREE);
...
g;d=d>e?d:e;f=f>g?f:g}a()};this.add3Points=function(e,g,j,n,m,p){if(h===true){h=false;b=e<j?e<m?e:m:j<m?j:m;c=g<n?g<p?g:p:n<p?n:p;d=e>j?e>m?e:m:j>m?j:m;f=g>n?g>p?g:p:n>p?n:p}else{b=e<j?e<m?e<b?e:b:m<b?m:b:j<m?j<b?j:b:m<b?m:b;c=g<n?g<p?g<c?g:c:p<c?p:c:n<p?n<c?n:c:p<c?p:c;d=e>j?e>m?e>d?e:d:m>d?m:d:j>m?j>d?j:d:m>d?m:d;f=g>n?g>p?g>f?g:f:p>f?p:f:n>p?n>f?n:f:p>f?p:f}a()};this.addRectangle=function(e){if(h===true){h=false;b=e.getLeft();c=e.getTop();d=e.getRight();f=e.getBottom()}else{b=b<e.getLeft()?b:e.getLeft();
...
if(d<c)return false;a.lerpSelf(b,c);b.lerpSelf(a,1-d);return true}var f,e,g=[],h=0,i,l,j=[],n=0,m,p,q=[],o=0,t,s=[],u=0,v,r,A=[],x=0,B,C,z=[],F=0,G={objects:[],sprites:[],lights:[],elements:[]},L=new THREE.Vector3,E=new THREE.Vector4,M=new THREE.Matrix4,J=new THREE.Matrix4,H=new THREE.Frustum,R=new THREE.Vector4,Q=new THREE.Vector4;this.projectVector=function(a,b){b.matrixWorldInverse.getInverse(b.matrixWorld);M.multiply(b.projectionMatrix,b.matrixWorldInverse);M.multiplyVector3(a);return a};this.unprojectVector=
function(a,b){b.projectionMatrixInverse.getInverse(b.projectionMatrix);M.multiply(b.matrixWorld,b.projectionMatrixInverse);M.multiplyVector3(a);return a};this.pickingRay=function(a,b){var c;a.z=-1;c=new THREE.Vector3(a.x,a.y,1);this.unprojectVector(a,b);this.unprojectVector(c,b);c.subSelf(a).normalize();return new THREE.Ray(a,c)};this.projectScene=function(g,h,n){var I=h.near,fa=h.far,O=false,ra,va,da,$,V,X,ha,ia,oa,ta,Da,Ja,Xa,ja,pb,Oa,Ya;C=r=t=p=0;G.elements.length=0;g.updateMatrixWorld();h.parent===
void 0&&h.updateMatrixWorld();h.matrixWorldInverse.getInverse(h.matrixWorld);M.multiply(h.projectionMatrix,h.matrixWorldInverse);H.setFromMatrix(M);e=0;G.objects.length=0;G.sprites.length=0;G.lights.length=0;var qb=function(b){if(b.visible!==false){if((b instanceof THREE.Mesh||b instanceof THREE.Line)&&(b.frustumCulled===false||H.contains(b)===true)){L.copy(b.matrixWorld.getPosition());M.multiplyVector3(L);f=a();f.object=b;f.z=L.z;G.objects.push(f)}else if(b instanceof THREE.Sprite||b instanceof THREE.Particle){L.copy(b.matrixWorld.getPosition());
M.multiplyVector3(L);f=a();f.object=b;f.z=L.z;G.sprites.push(f)}else b instanceof THREE.Light&&G.lights.push(b);for(var c=0,d=b.children.length;c<d;c++)qb(b.children[c])}};qb(g);g=0;for(ra=G.objects.length;g<ra;g++){oa=G.objects[g].object;ta=oa.matrixWorld;l=0;if(oa instanceof THREE.Mesh){Da=oa.geometry;Ja=oa.geometry.materials;$=Da.vertices;Xa=Da.faces;pb=Da.faceVertexUvs;Da=oa.matrixRotationWorld.extractRotation(ta);Ya=oa.material instanceof THREE.MeshFaceMaterial;va=0;for(da=$.length;va<da;va++){i=
b();i.positionWorld.copy($[va]);ta.multiplyVector3(i.positionWorld);i.positionScreen.copy(i.positionWorld);M.multiplyVector4(i.positionScreen);i.positionScreen.x=i.positionScreen.x/i.positionScreen.w;i.positionScreen.y=i.positionScreen.y/i.positionScreen.w;i.visible=i.positionScreen.z>I&&i.positionScreen.z<fa}$=0;for(va=Xa.length;$<va;$++){ia=Xa[$];da=Ya===true?Ja[ia.materialIndex]:oa.material;if(da!==void 0){ha=da.side;if(ia instanceof THREE.Face3){V=j[ia.a];X=j[ia.b];ja=j[ia.c];if(V.visible===true&&
X.visible===true&&ja.visible===true){O=(ja.positionScreen.x-V.positionScreen.x)*(X.positionScreen.y-V.positionScreen.y)-(ja.positionScreen.y-V.positionScreen.y)*(X.positionScreen.x-V.positionScreen.x)<0;if(ha===THREE.DoubleSide||O===(ha===THREE.FrontSide)){if(p===o){Oa=new THREE.RenderableFace3;q.push(Oa);o++;p++;m=Oa}else m=q[p++];m.v1.copy(V);m.v2.copy(X);m.v3.copy(ja)}else continue}else continue}else if(ia instanceof THREE.Face4){V=j[ia.a];X=j[ia.b];ja=j[ia.c];Oa=j[ia.d];if(V.visible===true&&X.visible===
true&&ja.visible===true&&Oa.visible===true){O=(Oa.positionScreen.x-V.positionScreen.x)*(X.positionScreen.y-V.positionScreen.y)-(Oa.positionScreen.y-V.positionScreen.y)*(X.positionScreen.x-V.positionScreen.x)<0||(X.positionScreen.x-ja.positionScreen.x)*(Oa.positionScreen.y-ja.positionScreen.y)-(X.positionScreen.y-ja.positionScreen.y)*(Oa.positionScreen.x-ja.positionScreen.x)<0;if(ha===THREE.DoubleSide||O===(ha===THREE.FrontSide)){if(t===u){var wb=new THREE.RenderableFace4;s.push(wb);u++;t++;m=wb}else m=
s[t++];m.v1.copy(V);m.v2.copy(X);m.v3.copy(ja);m.v4.copy(Oa)}else continue}else continue}m.normalWorld.copy(ia.normal);O===false&&(ha===THREE.BackSide||ha===THREE.DoubleSide)&&m.normalWorld.negate();Da.multiplyVector3(m.normalWorld);m.centroidWorld.copy(ia.centroid);ta.multiplyVector3(m.centroidWorld);m.centroidScreen.copy(m.centroidWorld);M.multiplyVector3(m.centroidScreen);ia=ia.vertexNormals;V=0;for(X=ia.length;V<X;V++){ja=m.vertexNormalsWorld[V];ja.copy(ia[V]);O===false&&(ha===THREE.BackSide||
ha===THREE.DoubleSide)&&ja.negate();Da.multiplyVector3(ja)}m.vertexNormalsLength=ia.length;V=0;for(X=pb.length;V<X;V++){ja=pb[V][$];if(ja!==void 0){ha=0;for(ia=ja.length;ha<ia;ha++)m.uvs[V][ha]=ja[ha]}}m.material=da;m.z=m.centroidScreen.z;G.elements.push(m)}}}else if(oa instanceof THREE.Line){J.multiply(M,ta);$=oa.geometry.vertices;V=b();V.positionScreen.copy($[0]);J.multiplyVector4(V.positionScreen);ta=oa.type===THREE.LinePieces?2:1;va=1;for(da=$.length;va<da;va++){V=b();V.positionScreen.copy($[va]);
J.multiplyVector4(V.positionScreen);if(!((va+1)%ta>0)){X=j[l-2];R.copy(V.positionScreen);Q.copy(X.positionScreen);if(d(R,Q)===true){R.multiplyScalar(1/R.w);Q.multiplyScalar(1/Q.w);if(r===x){Ja=new THREE.RenderableLine;A.push(Ja);x++;r++;v=Ja}else v=A[r++];v.v1.positionScreen.copy(R);v.v2.positionScreen.copy(Q);v.z=Math.max(R.z,Q.z);v.material=oa.material;G.elements.push(v)}}}}}g=0;for(ra=G.sprites.length;g<ra;g++){oa=G.sprites[g].object;ta=oa.matrixWorld;if(oa instanceof THREE.Particle){E.set(ta.elements[12],
ta.elements[13],ta.elements[14],1);M.multiplyVector4(E);E.z=E.z/E.w;if(E.z>0&&E.z<1){if(C===F){I=new THREE.RenderableParticle;z.push(I);F++;C++;B=I}else B=z[C++];B.object=oa;B.x=E.x/E.w;B.y=E.y/E.w;B.z=E.z;B.rotation=oa.rotation.z;B.scale.x=oa.scale.x*Math.abs(B.x-(E.x+h.projectionMatrix.elements[0])/(E.w+h.projectionMatrix.elements[12]));B.scale.y=oa.scale.y*Math.abs(B.y-(E.y+h.projectionMatrix.elements[5])/(E.w+h.projectionMatrix.elements[13]));B.material=oa.material;G.elements.push(B)}}}n&&G.elements.sort(c);
...
l=a.vertices[d];j=g[f];n=g[e];m=g[C];p=i.x-h.x;q=l.x-h.x;o=i.y-h.y;t=l.y-h.y;s=i.z-h.z;u=l.z-h.z;v=n.u-j.u;r=m.u-j.u;A=n.v-j.v;x=m.v-j.v;B=1/(v*x-r*A);G.set((x*p-A*q)*B,(x*o-A*t)*B,(x*s-A*u)*B);L.set((v*q-r*p)*B,(v*t-r*o)*B,(v*u-r*s)*B);z[b].addSelf(G);z[c].addSelf(G);z[d].addSelf(G);F[b].addSelf(L);F[c].addSelf(L);F[d].addSelf(L)}var b,c,d,f,e,g,h,i,l,j,n,m,p,q,o,t,s,u,v,r,A,x,B,C,z=[],F=[],G=new THREE.Vector3,L=new THREE.Vector3,E=new THREE.Vector3,M=new THREE.Vector3,J=new THREE.Vector3;b=0;for(c=
this.vertices.length;b<c;b++){z[b]=new THREE.Vector3;F[b]=new THREE.Vector3}b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];g=this.faceVertexUvs[0][b];if(e instanceof THREE.Face3)a(this,e.a,e.b,e.c,0,1,2);else if(e instanceof THREE.Face4){a(this,e.a,e.b,e.d,0,1,3);a(this,e.b,e.c,e.d,1,2,3)}}var H=["a","b","c","d"];b=0;for(c=this.faces.length;b<c;b++){e=this.faces[b];for(d=0;d<e.vertexNormals.length;d++){J.copy(e.vertexNormals[d]);f=e[H[d]];C=z[f];E.copy(C);E.subSelf(J.multiplyScalar(J.dot(C))).normalize();
M.cross(e.vertexNormals[d],C);f=M.dot(F[f]);f=f<0?-1:1;e.vertexTangents[d]=new THREE.Vector4(E.x,E.y,E.z,f)}}this.hasTangents=true},computeBoundingBox:function(){if(!this.boundingBox)this.boundingBox={min:new THREE.Vector3,max:new THREE.Vector3};if(this.vertices.length>0){var a;a=this.vertices[0];this.boundingBox.min.copy(a);this.boundingBox.max.copy(a);for(var b=this.boundingBox.min,c=this.boundingBox.max,d=1,f=this.vertices.length;d<f;d++){a=this.vertices[d];if(a.x<b.x)b.x=a.x;else if(a.x>c.x)c.x=
...
o);s.crossSelf(u);h[i*3]=h[i*3]+s.x;h[i*3+1]=h[i*3+1]+s.y;h[i*3+2]=h[i*3+2]+s.z;h[l*3]=h[l*3]+s.x;h[l*3+1]=h[l*3+1]+s.y;h[l*3+2]=h[l*3+2]+s.z;h[j*3]=h[j*3]+s.x;h[j*3+1]=h[j*3+1]+s.y;h[j*3+2]=h[j*3+2]+s.z}}a=0;for(b=h.length;a<b;a=a+3){n=h[a];m=h[a+1];p=h[a+2];c=1/Math.sqrt(n*n+m*m+p*p);h[a]=h[a]*c;h[a+1]=h[a+1]*c;h[a+2]=h[a+2]*c}this.normalsNeedUpdate=true}},computeTangents:function(){function a(a){N.x=d[a*3];N.y=d[a*3+1];N.z=d[a*3+2];ba.copy(N);fa=i[a];Q.copy(fa);Q.subSelf(N.multiplyScalar(N.dot(fa))).normalize();
K.cross(ba,fa);O=K.dot(l[a]);I=O<0?-1:1;h[a*4]=Q.x;h[a*4+1]=Q.y;h[a*4+2]=Q.z;h[a*4+3]=I}if(this.attributes.index===void 0||this.attributes.position===void 0||this.attributes.normal===void 0||this.attributes.uv===void 0)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");else{var b=this.attributes.index.array,c=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,e=c.length/3;if(this.attributes.tangent===
void 0){var g=4*e;this.attributes.tangent={itemSize:4,array:new Float32Array(g),numItems:g}}for(var h=this.attributes.tangent.array,i=[],l=[],g=0;g<e;g++){i[g]=new THREE.Vector3;l[g]=new THREE.Vector3}var j,n,m,p,q,o,t,s,u,v,r,A,x,B,C,e=new THREE.Vector3,g=new THREE.Vector3,z,F,G,L,E,M,J,H=this.offsets;G=0;for(L=H.length;G<L;++G){F=H[G].start;E=H[G].count;var R=H[G].index;z=F;for(F=F+E;z<F;z=z+3){E=R+b[z];M=R+b[z+1];J=R+b[z+2];j=c[E*3];n=c[E*3+1];m=c[E*3+2];p=c[M*3];q=c[M*3+1];o=c[M*3+2];t=c[J*3];
s=c[J*3+1];u=c[J*3+2];v=f[E*2];r=f[E*2+1];A=f[M*2];x=f[M*2+1];B=f[J*2];C=f[J*2+1];p=p-j;j=t-j;q=q-n;n=s-n;o=o-m;m=u-m;A=A-v;v=B-v;x=x-r;r=C-r;C=1/(A*r-v*x);e.set((r*p-x*j)*C,(r*q-x*n)*C,(r*o-x*m)*C);g.set((A*j-v*p)*C,(A*n-v*q)*C,(A*m-v*o)*C);i[E].addSelf(e);i[M].addSelf(e);i[J].addSelf(e);l[E].addSelf(g);l[M].addSelf(g);l[J].addSelf(g)}}var Q=new THREE.Vector3,K=new THREE.Vector3,N=new THREE.Vector3,ba=new THREE.Vector3,I,fa,O;G=0;for(L=H.length;G<L;++G){F=H[G].start;E=H[G].count;R=H[G].index;z=F;
for(F=F+E;z<F;z=z+3){E=R+b[z];M=R+b[z+1];J=R+b[z+2];a(E);a(M);a(J)}}this.tangentsNeedUpdate=this.hasTangents=true}}};
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,i,l,j,n,m,p,q,o,t,s,u,v,r;function A(a){return a%4?4-a%4:0}function x(a,b){return(new Uint8Array(a,b,1))[0]}function B(a,b){return(new Uint32Array(a,b,1))[0]}function C(b,c){var d,f,e,g,h,i,j,l,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[d*3];e=n[d*3+1];g=n[d*3+2];h=R[f*2];f=R[f*2+1];i=R[e*2];j=R[e*2+1];e=R[g*2];l=R[g*2+1];g=M.faceVertexUvs[0];var m=[];m.push(new THREE.UV(h,f));m.push(new THREE.UV(i,j));m.push(new THREE.UV(e,
l));g.push(m)}}function z(b,c){var d,f,e,g,h,i,j,l,n,m,o=new Uint32Array(a,c,4*b);for(d=0;d<b;d++){f=o[d*4];e=o[d*4+1];g=o[d*4+2];h=o[d*4+3];i=R[f*2];f=R[f*2+1];j=R[e*2];n=R[e*2+1];l=R[g*2];m=R[g*2+1];g=R[h*2];e=R[h*2+1];h=M.faceVertexUvs[0];var q=[];q.push(new THREE.UV(i,f));q.push(new THREE.UV(j,n));q.push(new THREE.UV(l,m));q.push(new THREE.UV(g,e));h.push(q)}}function F(b,c,d){for(var f,e,g,h,c=new Uint32Array(a,c,3*b),i=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*3];e=c[d*3+1];g=c[d*3+2];h=i[d];
M.faces.push(new THREE.Face3(f,e,g,null,null,h))}}function G(b,c,d){for(var f,e,g,h,i,c=new Uint32Array(a,c,4*b),j=new Uint16Array(a,d,b),d=0;d<b;d++){f=c[d*4];e=c[d*4+1];g=c[d*4+2];h=c[d*4+3];i=j[d];M.faces.push(new THREE.Face4(f,e,g,h,null,null,i))}}function L(b,c,d,f){for(var e,g,h,i,j,l,n,c=new Uint32Array(a,c,3*b),d=new Uint32Array(a,d,3*b),m=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*3];g=c[f*3+1];h=c[f*3+2];j=d[f*3];l=d[f*3+1];n=d[f*3+2];i=m[f];var o=H[l*3],q=H[l*3+1];l=H[l*3+2];var p=H[n*3],
r=H[n*3+1];n=H[n*3+2];M.faces.push(new THREE.Face3(e,g,h,[new THREE.Vector3(H[j*3],H[j*3+1],H[j*3+2]),new THREE.Vector3(o,q,l),new THREE.Vector3(p,r,n)],null,i))}}function E(b,c,d,f){for(var e,g,h,i,j,l,n,m,o,c=new Uint32Array(a,c,4*b),d=new Uint32Array(a,d,4*b),q=new Uint16Array(a,f,b),f=0;f<b;f++){e=c[f*4];g=c[f*4+1];h=c[f*4+2];i=c[f*4+3];l=d[f*4];n=d[f*4+1];m=d[f*4+2];o=d[f*4+3];j=q[f];var p=H[n*3],r=H[n*3+1];n=H[n*3+2];var s=H[m*3],t=H[m*3+1];m=H[m*3+2];var u=H[o*3],v=H[o*3+1];o=H[o*3+2];M.faces.push(new THREE.Face4(e,
g,h,i,[new THREE.Vector3(H[l*3],H[l*3+1],H[l*3+2]),new THREE.Vector3(p,r,n),new THREE.Vector3(s,t,m),new THREE.Vector3(u,v,o)],null,j))}}var M=this,J=0,H=[],R=[],Q,K,N;THREE.Geometry.call(this);THREE.Loader.prototype.initMaterials(M,d,b);r=a;K=J;b=new Uint8Array(r,K,12);o="";for(u=0;u<12;u++)o=o+String.fromCharCode(b[K+u]);c=x(r,K+12);x(r,K+13);x(r,K+14);x(r,K+15);f=x(r,K+16);i=x(r,K+17);l=x(r,K+18);j=x(r,K+19);n=B(r,K+20);m=B(r,K+20+4);p=B(r,K+20+8);q=B(r,K+20+12);o=B(r,K+20+16);t=B(r,K+20+20);s=
B(r,K+20+24);u=B(r,K+20+28);b=B(r,K+20+32);v=B(r,K+20+36);r=B(r,K+20+40);J=J+c;K=f*3+j;N=f*4+j;Q=q*K;c=o*(K+i*3);f=t*(K+l*3);j=s*(K+i*3+l*3);K=u*N;i=b*(N+i*4);l=v*(N+l*4);N=J;var J=new Float32Array(a,J,n*3),ba,I,fa,O;for(ba=0;ba<n;ba++){I=J[ba*3];fa=J[ba*3+1];O=J[ba*3+2];M.vertices.push(new THREE.Vector3(I,fa,O))}n=J=N+n*3*Float32Array.BYTES_PER_ELEMENT;if(m){J=new Int8Array(a,J,m*3);for(N=0;N<m;N++){ba=J[N*3];I=J[N*3+1];fa=J[N*3+2];H.push(ba/127,I/127,fa/127)}}J=n+m*3*Int8Array.BYTES_PER_ELEMENT;
m=J=J+A(m*3);if(p){J=new Float32Array(a,J,p*2);for(n=0;n<p;n++){N=J[n*2];ba=J[n*2+1];R.push(N,ba)}}p=J=m+p*2*Float32Array.BYTES_PER_ELEMENT;Q=p+Q+A(q*2);m=Q+c+A(o*2);c=m+f+A(t*2);f=c+j+A(s*2);K=f+K+A(u*2);j=K+i+A(b*2);i=j+l+A(v*2);if(t){l=m+t*Uint32Array.BYTES_PER_ELEMENT*3;F(t,m,l+t*Uint32Array.BYTES_PER_ELEMENT*3);C(t,l)}if(s){t=c+s*Uint32Array.BYTES_PER_ELEMENT*3;l=t+s*Uint32Array.BYTES_PER_ELEMENT*3;L(s,c,t,l+s*Uint32Array.BYTES_PER_ELEMENT*3);C(s,l)}if(v){s=j+v*Uint32Array.BYTES_PER_ELEMENT*
4;G(v,j,s+v*Uint32Array.BYTES_PER_ELEMENT*4);z(v,s)}if(r){v=i+r*Uint32Array.BYTES_PER_ELEMENT*4;s=v+r*Uint32Array.BYTES_PER_ELEMENT*4;E(r,i,v,s+r*Uint32Array.BYTES_PER_ELEMENT*4);z(r,s)}q&&F(q,p,p+q*Uint32Array.BYTES_PER_ELEMENT*3);if(o){q=Q+o*Uint32Array.BYTES_PER_ELEMENT*3;L(o,Q,q,q+o*Uint32Array.BYTES_PER_ELEMENT*3)}u&&G(u,f,f+u*Uint32Array.BYTES_PER_ELEMENT*4);if(b){o=K+b*Uint32Array.BYTES_PER_ELEMENT*4;E(b,K,o,o+b*Uint32Array.BYTES_PER_ELEMENT*4)}this.computeCentroids();this.computeFaceNormals();
...
i(a.height);l.image=document.createElement("canvas");l.image.width=b;l.image.height=c;l.image.getContext("2d").drawImage(a,0,0,b,c)}else l.image=a;l.needsUpdate=true});a.crossOrigin=c.crossOrigin;a.load(c.path+"/"+f);b&&b.add(a)},j=function(a){return(a[0]*255<<16)+(a[1]*255<<8)+a[2]*255},n="MeshLambertMaterial",m={color:15658734,opacity:1,map:null,lightMap:null,normalMap:null,bumpMap:null,wireframe:false};if(g.shading){var p=g.shading.toLowerCase();p==="phong"?n="MeshPhongMaterial":p==="basic"&&(n=
...
THREE.SceneLoader.prototype.parse=function(a,b,c){function d(a,b){return b=="relativeToHTML"?a:l+"/"+a}function f(a,b){var c;for(m in b)if(K.objects[m]===void 0){s=b[m];if(s.geometry!==void 0){if(F=K.geometries[s.geometry]){c=false;G=K.materials[s.materials[0]];(c=G instanceof THREE.ShaderMaterial)&&F.computeTangents();r=s.position;A=s.rotation;x=s.quaternion;B=s.scale;u=s.matrix;x=0;s.materials.length==0&&(G=new THREE.MeshFaceMaterial);s.materials.length>1&&(G=new THREE.MeshFaceMaterial);c=new THREE.Mesh(F,
G);c.name=m;if(u){c.matrixAutoUpdate=false;c.matrix.set(u[0],u[1],u[2],u[3],u[4],u[5],u[6],u[7],u[8],u[9],u[10],u[11],u[12],u[13],u[14],u[15])}else{c.position.set(r[0],r[1],r[2]);if(x){c.quaternion.set(x[0],x[1],x[2],x[3]);c.useQuaternion=true}else c.rotation.set(A[0],A[1],A[2]);c.scale.set(B[0],B[1],B[2])}c.visible=s.visible;c.castShadow=s.castShadow;c.receiveShadow=s.receiveShadow;a.add(c);K.objects[m]=c}}else{r=s.position;A=s.rotation;x=s.quaternion;B=s.scale;x=0;c=new THREE.Object3D;c.name=m;
c.position.set(r[0],r[1],r[2]);if(x){c.quaternion.set(x[0],x[1],x[2],x[3]);c.useQuaternion=true}else c.rotation.set(A[0],A[1],A[2]);c.scale.set(B[0],B[1],B[2]);c.visible=s.visible!==void 0?s.visible:false;a.add(c);K.objects[m]=c;K.empties[m]=c}if(s.properties!==void 0)for(var d in s.properties)c.properties[d]=s.properties[d];s.children!==void 0&&f(c,s.children)}}function e(a){return function(b){K.geometries[a]=b;f(K.scene,N.objects);J=J-1;i.onLoadComplete();h()}}function g(a){return function(b){K.geometries[a]=
b}}function h(){i.callbackProgress({totalModels:R,totalTextures:Q,loadedModels:R-J,loadedTextures:Q-H},K);i.onLoadProgress();J===0&&H===0&&b(K)}var i=this,l=THREE.Loader.prototype.extractUrlBase(c),j,n,m,p,q,o,t,s,u,v,r,A,x,B,C,z,F,G,L,E,M,J,H,R,Q,K,N=a;for(C in this.geometryHandlerMap)this.geometryHandlerMap[C].loaderObject=new this.geometryHandlerMap[C].loaderClass;H=J=0;K={scene:new THREE.Scene,geometries:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(N.transform){a=
N.transform.position;c=N.transform.rotation;C=N.transform.scale;a&&K.scene.position.set(a[0],a[1],a[2]);c&&K.scene.rotation.set(c[0],c[1],c[2]);C&&K.scene.scale.set(C[0],C[1],C[2]);if(a||c||C){K.scene.updateMatrix();K.scene.updateMatrixWorld()}}a=function(a){return function(){H=H-a;h();i.onLoadComplete()}};for(q in N.cameras){C=N.cameras[q];C.type==="perspective"?L=new THREE.PerspectiveCamera(C.fov,C.aspect,C.near,C.far):C.type==="ortho"&&(L=new THREE.OrthographicCamera(C.left,C.right,C.top,C.bottom,
C.near,C.far));r=C.position;c=C.target;C=C.up;L.position.set(r[0],r[1],r[2]);L.target=new THREE.Vector3(c[0],c[1],c[2]);C&&L.up.set(C[0],C[1],C[2]);K.cameras[q]=L}for(p in N.lights){c=N.lights[p];q=c.color!==void 0?c.color:16777215;L=c.intensity!==void 0?c.intensity:1;if(c.type==="directional"){r=c.direction;v=new THREE.DirectionalLight(q,L);v.position.set(r[0],r[1],r[2]);v.position.normalize()}else if(c.type==="point"){r=c.position;v=c.distance;v=new THREE.PointLight(q,L,v);v.position.set(r[0],r[1],
r[2])}else c.type==="ambient"&&(v=new THREE.AmbientLight(q));K.scene.add(v);K.lights[p]=v}for(o in N.fogs){p=N.fogs[o];p.type==="linear"?E=new THREE.Fog(0,p.near,p.far):p.type==="exp2"&&(E=new THREE.FogExp2(0,p.density));C=p.color;E.color.setRGB(C[0],C[1],C[2]);K.fogs[o]=E}if(K.cameras&&N.defaults.camera)K.currentCamera=K.cameras[N.defaults.camera];if(K.fogs&&N.defaults.fog)K.scene.fog=K.fogs[N.defaults.fog];C=N.defaults.bgcolor;K.bgColor=new THREE.Color;K.bgColor.setRGB(C[0],C[1],C[2]);K.bgColorAlpha=
N.defaults.bgalpha;for(j in N.geometries){o=N.geometries[j];if(o.type in this.geometryHandlerMap){J=J+1;i.onLoadStart()}}R=J;for(j in N.geometries){o=N.geometries[j];if(o.type==="cube"){F=new THREE.CubeGeometry(o.width,o.height,o.depth,o.segmentsWidth,o.segmentsHeight,o.segmentsDepth,null,o.flipped,o.sides);K.geometries[j]=F}else if(o.type==="plane"){F=new THREE.PlaneGeometry(o.width,o.height,o.segmentsWidth,o.segmentsHeight);K.geometries[j]=F}else if(o.type==="sphere"){F=new THREE.SphereGeometry(o.radius,
o.segmentsWidth,o.segmentsHeight);K.geometries[j]=F}else if(o.type==="cylinder"){F=new THREE.CylinderGeometry(o.topRad,o.botRad,o.height,o.radSegs,o.heightSegs);K.geometries[j]=F}else if(o.type==="torus"){F=new THREE.TorusGeometry(o.radius,o.tube,o.segmentsR,o.segmentsT);K.geometries[j]=F}else if(o.type==="icosahedron"){F=new THREE.IcosahedronGeometry(o.radius,o.subdivisions);K.geometries[j]=F}else if(o.type in this.geometryHandlerMap){E={};for(M in o)M!=="type"&&M!=="url"&&(E[M]=o[M]);this.geometryHandlerMap[o.type].loaderObject.load(d(o.url,
N.urlBaseType),e(j),E)}else if(o.type==="embedded_mesh"){o=N.embeds[o.id];o.metadata=N.metadata;o&&this.geometryHandlerMap.ascii_mesh.loaderObject.createModel(o,g(j),"")}}for(t in N.textures){j=N.textures[t];if(j.url instanceof Array){H=H+j.url.length;for(M=0;M<j.url.length;M++)i.onLoadStart()}else{H=H+1;i.onLoadStart()}}Q=H;for(t in N.textures){j=N.textures[t];if(j.mapping!==void 0&&THREE[j.mapping]!==void 0)j.mapping=new THREE[j.mapping];if(j.url instanceof Array){M=j.url.length;o=[];for(E=0;E<
M;E++)o[E]=d(j.url[E],N.urlBaseType);M=THREE.ImageUtils.loadTextureCube(o,j.mapping,a(M))}else{M=THREE.ImageUtils.loadTexture(d(j.url,N.urlBaseType),j.mapping,a(1));if(THREE[j.minFilter]!==void 0)M.minFilter=THREE[j.minFilter];if(THREE[j.magFilter]!==void 0)M.magFilter=THREE[j.magFilter];if(j.anisotropy)M.anisotropy=j.anisotropy;if(j.repeat){M.repeat.set(j.repeat[0],j.repeat[1]);if(j.repeat[0]!==1)M.wrapS=THREE.RepeatWrapping;if(j.repeat[1]!==1)M.wrapT=THREE.RepeatWrapping}j.offset&&M.offset.set(j.offset[0],
j.offset[1]);if(j.wrap){o={repeat:THREE.RepeatWrapping,mirror:THREE.MirroredRepeatWrapping};if(o[j.wrap[0]]!==void 0)M.wrapS=o[j.wrap[0]];if(o[j.wrap[1]]!==void 0)M.wrapT=o[j.wrap[1]]}}K.textures[t]=M}for(n in N.materials){u=N.materials[n];for(z in u.parameters)if(z==="envMap"||z==="map"||z==="lightMap"||z==="bumpMap")u.parameters[z]=K.textures[u.parameters[z]];else if(z==="shading")u.parameters[z]=u.parameters[z]=="flat"?THREE.FlatShading:THREE.SmoothShading;else if(z==="blending")u.parameters[z]=
...
j=u.parameters.color;M=u.parameters.specular;o=u.parameters.ambient;E=u.parameters.shininess;a.tNormal.value=K.textures[u.parameters.normalMap];u.parameters.normalScale&&a.uNormalScale.value.set(u.parameters.normalScale[0],u.parameters.normalScale[1]);if(u.parameters.map){a.tDiffuse.value=u.parameters.map;a.enableDiffuse.value=true}if(u.parameters.envMap){a.tCube.value=u.parameters.envMap;a.enableReflection.value=true;a.uReflectivity.value=u.parameters.reflectivity}if(u.parameters.lightMap){a.tAO.value=
u.parameters.lightMap;a.enableAO.value=true}if(u.parameters.specularMap){a.tSpecular.value=K.textures[u.parameters.specularMap];a.enableSpecular.value=true}if(u.parameters.displacementMap){a.tDisplacement.value=K.textures[u.parameters.displacementMap];a.enableDisplacement.value=true;a.uDisplacementBias.value=u.parameters.displacementBias;a.uDisplacementScale.value=u.parameters.displacementScale}a.uDiffuseColor.value.setHex(j);a.uSpecularColor.value.setHex(M);a.uAmbientColor.value.setHex(o);a.uShininess.value=
E;if(u.parameters.opacity)a.uOpacity.value=u.parameters.opacity;G=new THREE.ShaderMaterial({fragmentShader:t.fragmentShader,vertexShader:t.vertexShader,uniforms:a,lights:true,fog:true})}else G=new THREE[u.type](u.parameters);K.materials[n]=G}f(K.scene,N.objects);i.callbackSync(K);h()};THREE.TextureLoader=function(){THREE.EventTarget.call(this);this.crossOrigin=null};
...
THREE.TextureCount=0;THREE.CompressedTexture=function(a,b,c,d,f,e,g,h,i,l){THREE.Texture.call(this,null,e,g,h,i,l,d,f);this.image={width:b,height:c};this.mipmaps=a};THREE.CompressedTexture.prototype=Object.create(THREE.Texture.prototype);
...
void 0?a.canvas:document.createElement("canvas"),n,m,p,q,o=j.getContext("2d"),t=new THREE.Color(0),s=0,u=1,v=0,r=null,A=null,x=null,B=null,C=null,z,F,G,L,E=new THREE.RenderableVertex,M=new THREE.RenderableVertex,J,H,R,Q,K,N,ba,I,fa,O,ra,va,da=new THREE.Color,$=new THREE.Color,V=new THREE.Color,X=new THREE.Color,ha=new THREE.Color,ia={},oa={},ta,Da,Ja,Xa,ja,pb,Oa,Ya,qb,wb,fb=new THREE.Rectangle,Ga=new THREE.Rectangle,ya=new THREE.Rectangle,xb=false,Ha=new THREE.Color,$a=new THREE.Color,rb=new THREE.Color,
...
q=Math.floor(m/2);j.width=n;j.height=m;fb.set(-p,-q,p,q);Ga.set(-p,-q,p,q);u=1;v=0;C=B=x=A=r=null};this.setClearColor=function(a,b){t.copy(a);s=b!==void 0?b:1;Ga.set(-p,-q,p,q)};this.setClearColorHex=function(a,b){t.setHex(a);s=b!==void 0?b:1;Ga.set(-p,-q,p,q)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){o.setTransform(1,0,0,-1,p,q);if(Ga.isEmpty()===false){Ga.minSelf(fb);Ga.inflate(2);s<1&&o.clearRect(Math.floor(Ga.getX()),Math.floor(Ga.getY()),Math.floor(Ga.getWidth()),Math.floor(Ga.getHeight()));
if(s>0){c(THREE.NormalBlending);b(1);f("rgba("+Math.floor(t.r*255)+","+Math.floor(t.g*255)+","+Math.floor(t.b*255)+","+s+")");o.fillRect(Math.floor(Ga.getX()),Math.floor(Ga.getY()),Math.floor(Ga.getWidth()),Math.floor(Ga.getHeight()))}Ga.empty()}};this.render=function(a,k){function j(a,b,c){for(var d=0,f=i.length;d<f;d++){var e=i[d],g=e.color;if(e instanceof THREE.DirectionalLight){var h=e.matrixWorld.getPosition().normalize(),k=b.dot(h);if(!(k<=0)){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=
c.b+g.b*k}}else if(e instanceof THREE.PointLight){h=e.matrixWorld.getPosition();k=b.dot(Ea.sub(h,a).normalize());if(!(k<=0)){k=k*(e.distance==0?1:1-Math.min(a.distanceTo(h)/e.distance,1));if(k!=0){k=k*e.intensity;c.r=c.r+g.r*k;c.g=c.g+g.g*k;c.b=c.b+g.b*k}}}}}function n(a,d,f,g,h,i,l,o){e.info.render.vertices=e.info.render.vertices+3;e.info.render.faces++;b(o.opacity);c(o.blending);J=a.positionScreen.x;H=a.positionScreen.y;R=d.positionScreen.x;Q=d.positionScreen.y;K=f.positionScreen.x;N=f.positionScreen.y;
m(J,H,R,Q,K,N);if((o instanceof THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)&&o.map===null&&o.map===null)if(xb===true){g=o.color;h=o.emissive;if(o.wireframe===false&&o.shading==THREE.SmoothShading&&l.vertexNormalsLength==3){$.r=V.r=X.r=Ha.r;$.g=V.g=X.g=Ha.g;$.b=V.b=X.b=Ha.b;j(l.v1.positionWorld,l.vertexNormalsWorld[0],$);j(l.v2.positionWorld,l.vertexNormalsWorld[1],V);j(l.v3.positionWorld,l.vertexNormalsWorld[2],X);$.r=g.r*$.r+h.r;$.g=g.g*$.g+h.g;$.b=g.b*$.b+h.b;V.r=g.r*V.r+h.r;
V.g=g.g*V.g+h.g;V.b=g.b*V.b+h.b;X.r=g.r*X.r+h.r;X.g=g.g*X.g+h.g;X.b=g.b*X.b+h.b;ha.r=(V.r+X.r)*0.5;ha.g=(V.g+X.g)*0.5;ha.b=(V.b+X.b)*0.5;Ja=wa($,V,X,ha);v(J,H,R,Q,K,N,0,0,1,0,0,1,Ja)}else{da.r=Ha.r;da.g=Ha.g;da.b=Ha.b;j(l.centroidWorld,l.normalWorld,da);da.r=g.r*da.r+h.r;da.g=g.g*da.g+h.g;da.b=g.b*da.b+h.b;o.wireframe===true?s(da,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(da)}}else o.wireframe===true?s(o.color,o.wireframeLinewidth,o.wireframeLinecap,o.wireframeLinejoin):t(o.color);
else if(o instanceof THREE.MeshBasicMaterial||o instanceof THREE.MeshLambertMaterial||o instanceof THREE.MeshPhongMaterial)if(o.map!==null){if(o.map.mapping instanceof THREE.UVMapping){Xa=l.uvs[0];u(J,H,R,Q,K,N,Xa[g].u,Xa[g].v,Xa[h].u,Xa[h].v,Xa[i].u,Xa[i].v,o.map)}}else if(o.envMap!==null){if(o.envMap.mapping instanceof THREE.SphericalReflectionMapping){a=k.matrixWorldInverse;Ea.copy(l.vertexNormalsWorld[g]);ja=(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;pb=(Ea.x*a.elements[1]+
Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;Ea.copy(l.vertexNormalsWorld[h]);Oa=(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;Ya=(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;Ea.copy(l.vertexNormalsWorld[i]);qb=(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])*0.5+0.5;wb=(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])*0.5+0.5;u(J,H,R,Q,K,N,ja,pb,Oa,Ya,qb,wb,o.envMap)}}else o.wireframe===true?s(o.color,o.wireframeLinewidth,o.wireframeLinecap,
o.wireframeLinejoin):t(o.color);else if(o instanceof THREE.MeshDepthMaterial){ta=k.near;Da=k.far;$.r=$.g=$.b=1-fc(a.positionScreen.z,ta,Da);V.r=V.g=V.b=1-fc(d.positionScreen.z,ta,Da);X.r=X.g=X.b=1-fc(f.positionScreen.z,ta,Da);ha.r=(V.r+X.r)*0.5;ha.g=(V.g+X.g)*0.5;ha.b=(V.b+X.b)*0.5;Ja=wa($,V,X,ha);v(J,H,R,Q,K,N,0,0,1,0,0,1,Ja)}else if(o instanceof THREE.MeshNormalMaterial){da.r=jc(l.normalWorld.x);da.g=jc(l.normalWorld.y);da.b=jc(l.normalWorld.z);o.wireframe===true?s(da,o.wireframeLinewidth,o.wireframeLinecap,
o.wireframeLinejoin):t(da)}}function m(a,b,c,d,f,e){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.closePath()}function r(a,b,c,d,f,e,g,h){o.beginPath();o.moveTo(a,b);o.lineTo(c,d);o.lineTo(f,e);o.lineTo(g,h);o.closePath()}function s(a,b,c,f){if(x!==b)x=o.lineWidth=b;if(B!==c)B=o.lineCap=c;if(C!==f)C=o.lineJoin=f;d(a.getContextStyle());o.stroke();ya.inflate(b*2)}function t(a){f(a.getContextStyle());o.fill()}function u(a,b,c,d,e,g,h,i,k,j,l,n,m){if(!(m instanceof THREE.DataTexture||m.image===
void 0||m.image.width==0)){if(m.needsUpdate===true||ia[m.id]===void 0){var wa=m.wrapS==THREE.RepeatWrapping,q=m.wrapT==THREE.RepeatWrapping;ia[m.id]=o.createPattern(m.image,wa===true&&q===true?"repeat":wa===true&&q===false?"repeat-x":wa===false&&q===true?"repeat-y":"no-repeat");m.needsUpdate=false}f(ia[m.id]);var wa=m.offset.x/m.repeat.x,q=m.offset.y/m.repeat.y,p=m.image.width*m.repeat.x,sb=m.image.height*m.repeat.y,h=(h+wa)*p,i=(1-i+q)*sb,c=c-a,d=d-b,e=e-a,g=g-b,k=(k+wa)*p-h,j=(1-j+q)*sb-i,l=(l+
wa)*p-h,n=(1-n+q)*sb-i,wa=k*n-l*j;if(wa===0){if(oa[m.id]===void 0){b=document.createElement("canvas");b.width=m.image.width;b.height=m.image.height;b=b.getContext("2d");b.drawImage(m.image,0,0);oa[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data}b=oa[m.id];h=(Math.floor(h)+Math.floor(i)*m.image.width)*4;da.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255);t(da)}else{wa=1/wa;m=(n*c-j*e)*wa;j=(n*d-j*g)*wa;c=(k*e-l*c)*wa;d=(k*g-l*d)*wa;a=a-m*h-c*i;h=b-j*h-d*i;o.save();o.transform(m,j,c,d,a,h);o.fill();
...
o.setTransform(1,0,0,-1,p,q);e.info.render.vertices=0;e.info.render.faces=0;g=l.projectScene(a,k,this.sortElements);h=g.elements;i=g.lights;xb=i.length>0;if(xb===true){Ha.setRGB(0,0,0);$a.setRGB(0,0,0);rb.setRGB(0,0,0);Vb=0;for(Ec=i.length;Vb<Ec;Vb++){Y=i[Vb];var ca=Y.color;if(Y instanceof THREE.AmbientLight){Ha.r=Ha.r+ca.r;Ha.g=Ha.g+ca.g;Ha.b=Ha.b+ca.b}else if(Y instanceof THREE.DirectionalLight){$a.r=$a.r+ca.r;$a.g=$a.g+ca.g;$a.b=$a.b+ca.b}else if(Y instanceof THREE.PointLight){rb.r=rb.r+ca.r;rb.g=
rb.g+ca.g;rb.b=rb.b+ca.b}}}Vb=0;for(Ec=h.length;Vb<Ec;Vb++){A=h[Vb];Y=A.material;if(!(Y===void 0||Y.visible===false)){ya.empty();if(A instanceof THREE.RenderableParticle){z=A;z.x=z.x*p;z.y=z.y*q;var ca=z,pa=A;b(Y.opacity);c(Y.blending);var Fa=void 0,tb=void 0,jb=void 0,kb=void 0,Wb=void 0,Tc=A=void 0;if(Y instanceof THREE.ParticleBasicMaterial)if(Y.map===null){jb=pa.object.scale.x;kb=pa.object.scale.y;jb=jb*pa.scale.x*p;kb=kb*pa.scale.y*q;ya.set(ca.x-jb,ca.y-kb,ca.x+jb,ca.y+kb);if(fb.intersects(ya)!==
false){f(Y.color.getContextStyle());o.save();o.translate(ca.x,ca.y);o.rotate(-pa.rotation);o.scale(jb,kb);o.fillRect(-1,-1,2,2);o.restore()}}else{Wb=Y.map.image;A=Wb.width>>1;Tc=Wb.height>>1;jb=pa.scale.x*p;kb=pa.scale.y*q;Fa=jb*A;tb=kb*Tc;ya.set(ca.x-Fa,ca.y-tb,ca.x+Fa,ca.y+tb);if(fb.intersects(ya)!==false){o.save();o.translate(ca.x,ca.y);o.rotate(-pa.rotation);o.scale(jb,-kb);o.translate(-A,-Tc);o.drawImage(Wb,0,0);o.restore()}}else if(Y instanceof THREE.ParticleCanvasMaterial){Fa=pa.scale.x*p;
tb=pa.scale.y*q;ya.set(ca.x-Fa,ca.y-tb,ca.x+Fa,ca.y+tb);if(fb.intersects(ya)!==false){d(Y.color.getContextStyle());f(Y.color.getContextStyle());o.save();o.translate(ca.x,ca.y);o.rotate(-pa.rotation);o.scale(Fa,tb);Y.program(o);o.restore()}}}else if(A instanceof THREE.RenderableLine){z=A.v1;F=A.v2;z.positionScreen.x=z.positionScreen.x*p;z.positionScreen.y=z.positionScreen.y*q;F.positionScreen.x=F.positionScreen.x*p;F.positionScreen.y=F.positionScreen.y*q;ya.addPoint(z.positionScreen.x,z.positionScreen.y);
ya.addPoint(F.positionScreen.x,F.positionScreen.y);if(fb.intersects(ya)===true){ca=z;pa=F;b(Y.opacity);c(Y.blending);o.beginPath();o.moveTo(ca.positionScreen.x,ca.positionScreen.y);o.lineTo(pa.positionScreen.x,pa.positionScreen.y);if(Y instanceof THREE.LineBasicMaterial){ca=Y.linewidth;if(x!==ca)x=o.lineWidth=ca;ca=Y.linecap;if(B!==ca)B=o.lineCap=ca;ca=Y.linejoin;if(C!==ca)C=o.lineJoin=ca;d(Y.color.getContextStyle());o.stroke();ya.inflate(Y.linewidth*2)}}}else if(A instanceof THREE.RenderableFace3){z=
A.v1;F=A.v2;G=A.v3;z.positionScreen.x=z.positionScreen.x*p;z.positionScreen.y=z.positionScreen.y*q;F.positionScreen.x=F.positionScreen.x*p;F.positionScreen.y=F.positionScreen.y*q;G.positionScreen.x=G.positionScreen.x*p;G.positionScreen.y=G.positionScreen.y*q;if(Y.overdraw===true){sb(z.positionScreen,F.positionScreen);sb(F.positionScreen,G.positionScreen);sb(G.positionScreen,z.positionScreen)}ya.add3Points(z.positionScreen.x,z.positionScreen.y,F.positionScreen.x,F.positionScreen.y,G.positionScreen.x,
G.positionScreen.y);fb.intersects(ya)===true&&n(z,F,G,0,1,2,A,Y,a)}else if(A instanceof THREE.RenderableFace4){z=A.v1;F=A.v2;G=A.v3;L=A.v4;z.positionScreen.x=z.positionScreen.x*p;z.positionScreen.y=z.positionScreen.y*q;F.positionScreen.x=F.positionScreen.x*p;F.positionScreen.y=F.positionScreen.y*q;G.positionScreen.x=G.positionScreen.x*p;G.positionScreen.y=G.positionScreen.y*q;L.positionScreen.x=L.positionScreen.x*p;L.positionScreen.y=L.positionScreen.y*q;E.positionScreen.copy(F.positionScreen);M.positionScreen.copy(L.positionScreen);
if(Y.overdraw===true){sb(z.positionScreen,F.positionScreen);sb(F.positionScreen,L.positionScreen);sb(L.positionScreen,z.positionScreen);sb(G.positionScreen,E.positionScreen);sb(G.positionScreen,M.positionScreen)}ya.addPoint(z.positionScreen.x,z.positionScreen.y);ya.addPoint(F.positionScreen.x,F.positionScreen.y);ya.addPoint(G.positionScreen.x,G.positionScreen.y);ya.addPoint(L.positionScreen.x,L.positionScreen.y);if(fb.intersects(ya)===true){pa=z;Fa=F;tb=G;jb=L;kb=E;Wb=M;ca=A;A=a;e.info.render.vertices=
e.info.render.vertices+4;e.info.render.faces++;b(Y.opacity);c(Y.blending);if(Y.map!==void 0&&Y.map!==null||Y.envMap!==void 0&&Y.envMap!==null){n(pa,Fa,jb,0,1,3,ca,Y,A);n(kb,tb,Wb,1,2,3,ca,Y,A)}else{J=pa.positionScreen.x;H=pa.positionScreen.y;R=Fa.positionScreen.x;Q=Fa.positionScreen.y;K=tb.positionScreen.x;N=tb.positionScreen.y;ba=jb.positionScreen.x;I=jb.positionScreen.y;fa=kb.positionScreen.x;O=kb.positionScreen.y;ra=Wb.positionScreen.x;va=Wb.positionScreen.y;if(Y instanceof THREE.MeshLambertMaterial||
Y instanceof THREE.MeshPhongMaterial)if(xb===true){pa=Y.color;Fa=Y.emissive;if(Y.wireframe===false&&Y.shading==THREE.SmoothShading&&ca.vertexNormalsLength==4){$.r=V.r=X.r=ha.r=Ha.r;$.g=V.g=X.g=ha.g=Ha.g;$.b=V.b=X.b=ha.b=Ha.b;j(ca.v1.positionWorld,ca.vertexNormalsWorld[0],$);j(ca.v2.positionWorld,ca.vertexNormalsWorld[1],V);j(ca.v4.positionWorld,ca.vertexNormalsWorld[3],X);j(ca.v3.positionWorld,ca.vertexNormalsWorld[2],ha);$.r=pa.r*$.r+Fa.r;$.g=pa.g*$.g+Fa.g;$.b=pa.b*$.b+Fa.b;V.r=pa.r*V.r+Fa.r;V.g=
pa.g*V.g+Fa.g;V.b=pa.b*V.b+Fa.b;X.r=pa.r*X.r+Fa.r;X.g=pa.g*X.g+Fa.g;X.b=pa.b*X.b+Fa.b;ha.r=pa.r*ha.r+Fa.r;ha.g=pa.g*ha.g+Fa.g;ha.b=pa.b*ha.b+Fa.b;Ja=wa($,V,X,ha);m(J,H,R,Q,ba,I);v(J,H,R,Q,ba,I,0,0,1,0,0,1,Ja);m(fa,O,K,N,ra,va);v(fa,O,K,N,ra,va,1,0,1,1,0,1,Ja)}else{da.r=Ha.r;da.g=Ha.g;da.b=Ha.b;j(ca.centroidWorld,ca.normalWorld,da);da.r=pa.r*da.r+Fa.r;da.g=pa.g*da.g+Fa.g;da.b=pa.b*da.b+Fa.b;r(J,H,R,Q,K,N,ba,I);Y.wireframe===true?s(da,Y.wireframeLinewidth,Y.wireframeLinecap,Y.wireframeLinejoin):t(da)}}else{r(J,
H,R,Q,K,N,ba,I);Y.wireframe===true?s(Y.color,Y.wireframeLinewidth,Y.wireframeLinecap,Y.wireframeLinejoin):t(Y.color)}else if(Y instanceof THREE.MeshBasicMaterial){r(J,H,R,Q,K,N,ba,I);Y.wireframe===true?s(Y.color,Y.wireframeLinewidth,Y.wireframeLinecap,Y.wireframeLinejoin):t(Y.color)}else if(Y instanceof THREE.MeshNormalMaterial){da.r=jc(ca.normalWorld.x);da.g=jc(ca.normalWorld.y);da.b=jc(ca.normalWorld.z);r(J,H,R,Q,K,N,ba,I);Y.wireframe===true?s(da,Y.wireframeLinewidth,Y.wireframeLinecap,Y.wireframeLinejoin):
t(da)}else if(Y instanceof THREE.MeshDepthMaterial){ta=k.near;Da=k.far;$.r=$.g=$.b=1-fc(pa.positionScreen.z,ta,Da);V.r=V.g=V.b=1-fc(Fa.positionScreen.z,ta,Da);X.r=X.g=X.b=1-fc(jb.positionScreen.z,ta,Da);ha.r=ha.g=ha.b=1-fc(tb.positionScreen.z,ta,Da);Ja=wa($,V,X,ha);m(J,H,R,Q,ba,I);v(J,H,R,Q,ba,I,0,0,1,0,0,1,Ja);m(fa,O,K,N,ra,va);v(fa,O,K,N,ra,va,1,0,1,1,0,1,Ja)}}}}Ga.addRectangle(ya)}}o.setTransform(1,0,0,1,0,0)}}};
...
c,d;for(b in a.attributes){d=b==="index"?k.ELEMENT_ARRAY_BUFFER:k.ARRAY_BUFFER;c=a.attributes[b];c.buffer=k.createBuffer();k.bindBuffer(d,c.buffer);k.bufferData(d,c.array,k.STATIC_DRAW)}}function g(a,b,c){var d,f,e,g,h=a.vertices;g=h.length;var i=a.colors,j=i.length,l=a.__vertexArray,m=a.__colorArray,n=a.__sortArray,o=a.verticesNeedUpdate,q=a.colorsNeedUpdate,p=a.__webglCustomAttributesList;if(c.sortParticles){gb.copy(bb);gb.multiplySelf(c.matrixWorld);for(d=0;d<g;d++){f=h[d];Pa.copy(f);gb.multiplyVector3(Pa);
n[d]=[Pa.z,d]}n.sort(function(a,b){return b[0]-a[0]});for(d=0;d<g;d++){f=h[n[d][1]];e=d*3;l[e]=f.x;l[e+1]=f.y;l[e+2]=f.z}for(d=0;d<j;d++){e=d*3;f=i[n[d][1]];m[e]=f.r;m[e+1]=f.g;m[e+2]=f.b}if(p){i=0;for(j=p.length;i<j;i++){h=p[i];if(h.boundTo===void 0||h.boundTo==="vertices"){e=0;f=h.value.length;if(h.size===1)for(d=0;d<f;d++){g=n[d][1];h.array[d]=h.value[g]}else if(h.size===2)for(d=0;d<f;d++){g=n[d][1];g=h.value[g];h.array[e]=g.x;h.array[e+1]=g.y;e=e+2}else if(h.size===3)if(h.type==="c")for(d=0;d<
...
i.buffer);k.bufferData(k.ARRAY_BUFFER,i.array,b)}if(a.tangentsNeedUpdate&&d!==void 0){k.bindBuffer(k.ARRAY_BUFFER,d.buffer);k.bufferData(k.ARRAY_BUFFER,d.array,b)}if(c)for(var j in a.attributes)delete a.attributes[j].array}function i(a,b){return b.z-a.z}function l(a,b){return b[1]-a[1]}function j(a,b,c){if(a.length)for(var d=0,f=a.length;d<f;d++){ha=da=null;V=X=Da=ta=Ya=Oa=Ja=-1;hb=true;a[d].render(b,c,rb,Ea);ha=da=null;V=X=Da=ta=Ya=Oa=Ja=-1;hb=true}}function n(a,b,c,d,f,e,g,h){var i,k,j,l;if(b){k=
...
c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(hb){for(var l=0,m=0,n=0,o,q,p,r,s=qc,t=s.directional.colors,u=s.directional.positions,z=s.point.colors,B=s.point.positions,C=s.point.distances,G=s.spot.colors,H=s.spot.positions,J=s.spot.distances,I=s.spot.directions,K=s.spot.angles,L=s.spot.exponents,X=s.hemi.skyColors,N=s.hemi.groundColors,Q=s.hemi.positions,R=0,$=0,ba=0,fa=0,c=o=p=p=q=0,e=b.length;c<e;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=
j.color;r=j.intensity;q=j.distance;if(j instanceof THREE.AmbientLight)if(O.gammaInput){l=l+o.r*o.r;m=m+o.g*o.g;n=n+o.b*o.b}else{l=l+o.r;m=m+o.g;n=n+o.b}else if(j instanceof THREE.DirectionalLight){q=R*3;O.gammaInput?A(t,q,o,r*r):x(t,q,o,r);Qa.copy(j.matrixWorld.getPosition());Qa.subSelf(j.target.matrixWorld.getPosition());Qa.normalize();u[q]=Qa.x;u[q+1]=Qa.y;u[q+2]=Qa.z;R=R+1}else if(j instanceof THREE.PointLight){p=$*3;O.gammaInput?A(z,p,o,r*r):x(z,p,o,r);r=j.matrixWorld.getPosition();B[p]=r.x;B[p+
1]=r.y;B[p+2]=r.z;C[$]=q;$=$+1}else if(j instanceof THREE.SpotLight){p=ba*3;O.gammaInput?A(G,p,o,r*r):x(G,p,o,r);r=j.matrixWorld.getPosition();H[p]=r.x;H[p+1]=r.y;H[p+2]=r.z;J[ba]=q;Qa.copy(r);Qa.subSelf(j.target.matrixWorld.getPosition());Qa.normalize();I[p]=Qa.x;I[p+1]=Qa.y;I[p+2]=Qa.z;K[ba]=Math.cos(j.angle);L[ba]=j.exponent;ba=ba+1}else if(j instanceof THREE.HemisphereLight){q=j.color;p=j.groundColor;o=fa*3;if(O.gammaInput){r=r*r;A(X,o,q,r);A(N,o,p,r)}else{x(X,o,q,r);x(N,o,p,r)}r=j.matrixWorld.getPosition();
Q[o]=r.x;Q[o+1]=r.y;Q[o+2]=r.z;fa=fa+1}}}c=R*3;for(e=t.length;c<e;c++)t[c]=0;c=$*3;for(e=z.length;c<e;c++)z[c]=0;c=ba*3;for(e=G.length;c<e;c++)G[c]=0;c=fa*3;for(e=X.length;c<e;c++)X[c]=0;c=fa*3;for(e=N.length;c<e;c++)N[c]=0;s.directional.length=R;s.point.length=$;s.spot.length=ba;s.hemi.length=fa;s.ambient[0]=l;s.ambient[1]=m;s.ambient[2]=n;hb=false}c=qc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;
...
m=E(c.format);n=E(c.type);F(k.TEXTURE_CUBE_MAP,c,l);for(j=0;j<6;j++)k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,m,m,n,e[j]);c.generateMipmaps&&l&&k.generateMipmap(k.TEXTURE_CUBE_MAP);c.needsUpdate=false;if(c.onUpdate)c.onUpdate()}else{k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}}else if(n instanceof THREE.WebGLRenderTargetCube){c=n;k.activeTexture(k.TEXTURE0+j);k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)}else O.setTexture(n,j)}else if(l==="tv"){if(c._array===
...
if(a===THREE.RGBA_S3TC_DXT1_Format)return yb.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===THREE.RGBA_S3TC_DXT3_Format)return yb.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===THREE.RGBA_S3TC_DXT5_Format)return yb.COMPRESSED_RGBA_S3TC_DXT5_EXT}return 0}console.log("THREE.WebGLRenderer",THREE.REVISION);var a=a||{},M=a.canvas!==void 0?a.canvas:document.createElement("canvas"),J=a.precision!==void 0?a.precision:"highp",H=a.alpha!==void 0?a.alpha:true,R=a.premultipliedAlpha!==void 0?a.premultipliedAlpha:true,Q=a.antialias!==
void 0?a.antialias:false,K=a.stencil!==void 0?a.stencil:true,N=a.preserveDrawingBuffer!==void 0?a.preserveDrawingBuffer:false,ba=a.clearColor!==void 0?new THREE.Color(a.clearColor):new THREE.Color(0),I=a.clearAlpha!==void 0?a.clearAlpha:0,fa=a.maxLights!==void 0?a.maxLights:4;this.domElement=M;this.context=null;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=this.autoClear=true;this.shadowMapEnabled=this.physicallyBasedShading=
this.gammaOutput=this.gammaInput=false;this.shadowMapCullFrontFaces=this.shadowMapSoft=this.shadowMapAutoUpdate=true;this.shadowMapCascade=this.shadowMapDebug=false;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=true;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var O=this,ra=[],va=0,da=null,$=null,V=-1,X=null,ha=null,ia=0,oa=0,ta=-1,Da=-1,Ja=-1,Xa=-1,ja=-1,pb=-1,Oa=-1,Ya=
-1,qb=null,wb=null,fb=null,Ga=null,ya=0,xb=0,Ha=0,$a=0,rb=0,Ea=0,ab=new THREE.Frustum,bb=new THREE.Matrix4,gb=new THREE.Matrix4,Pa=new THREE.Vector4,Qa=new THREE.Vector3,hb=true,qc={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],angles:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Pb,yb;try{if(!(k=M.getContext("experimental-webgl",{alpha:H,
premultipliedAlpha:R,antialias:Q,stencil:K,preserveDrawingBuffer:N})))throw"Error creating WebGL context.";}catch(Rc){console.error(Rc)}a=k.getExtension("OES_texture_float");H=k.getExtension("OES_standard_derivatives");Pb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");yb=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");
a||console.log("THREE.WebGLRenderer: Float textures not supported.");H||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");Pb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");yb||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);
k.blendFunc(k.SRC_ALPHA,k.ONE_MINUS_SRC_ALPHA);k.clearColor(ba.r,ba.g,ba.b,I);this.context=k;var Dc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),H=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Sc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),rc=Pb?k.getParameter(Pb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,ic=H>0,ec=ic&&a;yb&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);this.getContext=function(){return k};this.supportsVertexTextures=function(){return ic};this.getMaxAnisotropy=
function(){return rc};this.setSize=function(a,b){M.width=a;M.height=b;this.setViewport(0,0,M.width,M.height)};this.setViewport=function(a,b,c,d){ya=a!==void 0?a:0;xb=b!==void 0?b:0;Ha=c!==void 0?c:M.width;$a=d!==void 0?d:M.height;k.viewport(ya,xb,Ha,$a)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColorHex=function(a,b){ba.setHex(a);I=b;k.clearColor(ba.r,ba.g,ba.b,I)};this.setClearColor=
function(a,b){ba.copy(a);I=b;k.clearColor(ba.r,ba.g,ba.b,I)};this.getClearColor=function(){return ba};this.getClearAlpha=function(){return I};this.clear=function(a,b,c){var d=0;if(a===void 0||a)d=d|k.COLOR_BUFFER_BIT;if(b===void 0||b)d=d|k.DEPTH_BUFFER_BIT;if(c===void 0||c)d=d|k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};this.addPrePlugin=function(a){a.init(this);
...
c.__webglTexture);k.generateMipmap(k.TEXTURE_2D);k.bindTexture(k.TEXTURE_2D,null)}this.setDepthTest(true);this.setDepthWrite(true)}};this.renderImmediateObject=function(a,b,c,d,f){var e=u(a,b,c,d,f);X=-1;O.setMaterialFaces(d);f.immediateRenderCallback?f.immediateRenderCallback(e,k,ab):f.render(function(a){O.renderBufferImmediate(a,e,d)})};this.initWebGLObjects=function(a){if(!a.__webglObjects){a.__webglObjects=[];a.__webglObjectsImmediate=[];a.__webglSprites=[];a.__webglFlares=[]}for(;a.__objectsAdded.length;){var i=
a.__objectsAdded[0],j=a,l=void 0,m=void 0,n=void 0;if(!i.__webglInit){i.__webglInit=true;i._modelViewMatrix=new THREE.Matrix4;i._normalMatrix=new THREE.Matrix3;if(i instanceof THREE.Mesh){m=i.geometry;if(m instanceof THREE.Geometry){if(m.geometryGroups===void 0){var r=m,u=void 0,v=void 0,x=void 0,z=void 0,A=void 0,B=void 0,C=void 0,E={},G=r.morphTargets.length,H=r.morphNormals.length;r.geometryGroups={};u=0;for(v=r.faces.length;u<v;u++){x=r.faces[u];z=x.materialIndex;B=z!==void 0?z:-1;E[B]===void 0&&
(E[B]={hash:B,counter:0});C=E[B].hash+"_"+E[B].counter;r.geometryGroups[C]===void 0&&(r.geometryGroups[C]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:G,numMorphNormals:H});A=x instanceof THREE.Face3?3:4;if(r.geometryGroups[C].vertices+A>65535){E[B].counter=E[B].counter+1;C=E[B].hash+"_"+E[B].counter;r.geometryGroups[C]===void 0&&(r.geometryGroups[C]={faces3:[],faces4:[],materialIndex:z,vertices:0,numMorphTargets:G,numMorphNormals:H})}x instanceof THREE.Face3?r.geometryGroups[C].faces3.push(u):
...
I.__webglUV2Buffer=k.createBuffer();I.__webglSkinIndicesBuffer=k.createBuffer();I.__webglSkinWeightsBuffer=k.createBuffer();I.__webglFaceBuffer=k.createBuffer();I.__webglLineBuffer=k.createBuffer();var K=void 0,V=void 0;if(I.numMorphTargets){I.__webglMorphTargetsBuffers=[];K=0;for(V=I.numMorphTargets;K<V;K++)I.__webglMorphTargetsBuffers.push(k.createBuffer())}if(I.numMorphNormals){I.__webglMorphNormalsBuffers=[];K=0;for(V=I.numMorphNormals;K<V;K++)I.__webglMorphNormalsBuffers.push(k.createBuffer())}O.info.memory.geometries++;
var F=n,M=i,L=M.geometry,da=F.faces3,X=F.faces4,N=da.length*3+X.length*4,Q=da.length*1+X.length*2,R=da.length*3+X.length*4,$=c(M,F),ba=f($),ha=d($),fa=$.vertexColors?$.vertexColors:false;F.__vertexArray=new Float32Array(N*3);if(ha)F.__normalArray=new Float32Array(N*3);if(L.hasTangents)F.__tangentArray=new Float32Array(N*4);if(fa)F.__colorArray=new Float32Array(N*3);if(ba){if(L.faceUvs.length>0||L.faceVertexUvs.length>0)F.__uvArray=new Float32Array(N*2);if(L.faceUvs.length>1||L.faceVertexUvs.length>
1)F.__uv2Array=new Float32Array(N*2)}if(M.geometry.skinWeights.length&&M.geometry.skinIndices.length){F.__skinIndexArray=new Float32Array(N*4);F.__skinWeightArray=new Float32Array(N*4)}F.__faceArray=new Uint16Array(Q*3);F.__lineArray=new Uint16Array(R*2);var oa=void 0,ta=void 0;if(F.numMorphTargets){F.__morphTargetsArrays=[];oa=0;for(ta=F.numMorphTargets;oa<ta;oa++)F.__morphTargetsArrays.push(new Float32Array(N*3))}if(F.numMorphNormals){F.__morphNormalsArrays=[];oa=0;for(ta=F.numMorphNormals;oa<ta;oa++)F.__morphNormalsArrays.push(new Float32Array(N*
3))}F.__webglFaceCount=Q*3;F.__webglLineCount=R*2;if($.attributes){if(F.__webglCustomAttributesList===void 0)F.__webglCustomAttributesList=[];var ra=void 0;for(ra in $.attributes){var Da=$.attributes[ra],ja={},Ja;for(Ja in Da)ja[Ja]=Da[Ja];if(!ja.__webglInitialized||ja.createUniqueBuffers){ja.__webglInitialized=true;var va=1;ja.type==="v2"?va=2:ja.type==="v3"?va=3:ja.type==="v4"?va=4:ja.type==="c"&&(va=3);ja.size=va;ja.array=new Float32Array(N*va);ja.buffer=k.createBuffer();ja.buffer.belongsToAttribute=
ra;Da.needsUpdate=true;ja.__original=Da}F.__webglCustomAttributesList.push(ja)}}F.__inittedArrays=true;m.verticesNeedUpdate=true;m.morphTargetsNeedUpdate=true;m.elementsNeedUpdate=true;m.uvsNeedUpdate=true;m.normalsNeedUpdate=true;m.tangentsNeedUpdate=true;m.colorsNeedUpdate=true}}}else m instanceof THREE.BufferGeometry&&e(m)}else if(i instanceof THREE.Ribbon){m=i.geometry;if(!m.__webglVertexBuffer){var Ea=m;Ea.__webglVertexBuffer=k.createBuffer();Ea.__webglColorBuffer=k.createBuffer();O.info.memory.geometries++;
var ya=m,Ha=ya.vertices.length;ya.__vertexArray=new Float32Array(Ha*3);ya.__colorArray=new Float32Array(Ha*3);ya.__webglVertexCount=Ha;m.verticesNeedUpdate=true;m.colorsNeedUpdate=true}}else if(i instanceof THREE.Line){m=i.geometry;if(!m.__webglVertexBuffer){var Oa=m;Oa.__webglVertexBuffer=k.createBuffer();Oa.__webglColorBuffer=k.createBuffer();O.info.memory.geometries++;var Ga=m,Pa=i,Qa=Ga.vertices.length;Ga.__vertexArray=new Float32Array(Qa*3);Ga.__colorArray=new Float32Array(Qa*3);Ga.__webglLineCount=
...
d(gb),ec=gb.vertexColors?gb.vertexColors:false,ic=f(gb),Fc=Pb===THREE.SmoothShading,D=void 0,W=void 0,Xb=void 0,P=void 0,kc=void 0,Yb=void 0,vb=void 0,Gc=void 0,Qb=void 0,lc=void 0,mc=void 0,S=void 0,T=void 0,U=void 0,ka=void 0,zb=void 0,Ab=void 0,Bb=void 0,sc=void 0,Cb=void 0,Db=void 0,Eb=void 0,tc=void 0,Fb=void 0,Gb=void 0,Hb=void 0,uc=void 0,Ib=void 0,Jb=void 0,Kb=void 0,vc=void 0,Lb=void 0,Mb=void 0,Nb=void 0,wc=void 0,qa=void 0,qc=void 0,Zb=void 0,nc=void 0,oc=void 0,Ra=void 0,rc=void 0,Ma=
void 0,Na=void 0,$b=void 0,Rb=void 0,Ia=0,La=0,Sb=0,Tb=0,nb=0,Va=0,ua=0,Za=0,Ka=0,aa=0,ga=0,y=0,sa=void 0,Sa=la.__vertexArray,xc=la.__uvArray,yc=la.__uv2Array,ob=la.__normalArray,za=la.__tangentArray,Ta=la.__colorArray,Aa=la.__skinIndexArray,Ba=la.__skinWeightArray,Uc=la.__morphTargetsArrays,Vc=la.__morphNormalsArrays,Wc=la.__webglCustomAttributesList,w=void 0,Ob=la.__faceArray,ib=la.__lineArray,db=xb.geometry,Dc=db.elementsNeedUpdate,ad=db.uvsNeedUpdate,Rc=db.normalsNeedUpdate,Sc=db.tangentsNeedUpdate,
hd=db.colorsNeedUpdate,id=db.morphTargetsNeedUpdate,gc=db.vertices,ma=la.faces3,na=la.faces4,Wa=db.faces,Xc=db.faceVertexUvs[0],Yc=db.faceVertexUvs[1],hc=db.skinIndices,ac=db.skinWeights,bc=db.morphTargets,Hc=db.morphNormals;if(db.verticesNeedUpdate){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];S=gc[P.a];T=gc[P.b];U=gc[P.c];Sa[La]=S.x;Sa[La+1]=S.y;Sa[La+2]=S.z;Sa[La+3]=T.x;Sa[La+4]=T.y;Sa[La+5]=T.z;Sa[La+6]=U.x;Sa[La+7]=U.y;Sa[La+8]=U.z;La=La+9}D=0;for(W=na.length;D<W;D++){P=Wa[na[D]];S=gc[P.a];T=gc[P.b];
U=gc[P.c];ka=gc[P.d];Sa[La]=S.x;Sa[La+1]=S.y;Sa[La+2]=S.z;Sa[La+3]=T.x;Sa[La+4]=T.y;Sa[La+5]=T.z;Sa[La+6]=U.x;Sa[La+7]=U.y;Sa[La+8]=U.z;Sa[La+9]=ka.x;Sa[La+10]=ka.y;Sa[La+11]=ka.z;La=La+12}k.bindBuffer(k.ARRAY_BUFFER,la.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Sa,mb)}if(id){Ra=0;for(rc=bc.length;Ra<rc;Ra++){D=ga=0;for(W=ma.length;D<W;D++){$b=ma[D];P=Wa[$b];S=bc[Ra].vertices[P.a];T=bc[Ra].vertices[P.b];U=bc[Ra].vertices[P.c];Ma=Uc[Ra];Ma[ga]=S.x;Ma[ga+1]=S.y;Ma[ga+2]=S.z;Ma[ga+3]=T.x;Ma[ga+
4]=T.y;Ma[ga+5]=T.z;Ma[ga+6]=U.x;Ma[ga+7]=U.y;Ma[ga+8]=U.z;if(gb.morphNormals){if(Fc){Rb=Hc[Ra].vertexNormals[$b];Cb=Rb.a;Db=Rb.b;Eb=Rb.c}else Eb=Db=Cb=Hc[Ra].faceNormals[$b];Na=Vc[Ra];Na[ga]=Cb.x;Na[ga+1]=Cb.y;Na[ga+2]=Cb.z;Na[ga+3]=Db.x;Na[ga+4]=Db.y;Na[ga+5]=Db.z;Na[ga+6]=Eb.x;Na[ga+7]=Eb.y;Na[ga+8]=Eb.z}ga=ga+9}D=0;for(W=na.length;D<W;D++){$b=na[D];P=Wa[$b];S=bc[Ra].vertices[P.a];T=bc[Ra].vertices[P.b];U=bc[Ra].vertices[P.c];ka=bc[Ra].vertices[P.d];Ma=Uc[Ra];Ma[ga]=S.x;Ma[ga+1]=S.y;Ma[ga+2]=S.z;
Ma[ga+3]=T.x;Ma[ga+4]=T.y;Ma[ga+5]=T.z;Ma[ga+6]=U.x;Ma[ga+7]=U.y;Ma[ga+8]=U.z;Ma[ga+9]=ka.x;Ma[ga+10]=ka.y;Ma[ga+11]=ka.z;if(gb.morphNormals){if(Fc){Rb=Hc[Ra].vertexNormals[$b];Cb=Rb.a;Db=Rb.b;Eb=Rb.c;tc=Rb.d}else tc=Eb=Db=Cb=Hc[Ra].faceNormals[$b];Na=Vc[Ra];Na[ga]=Cb.x;Na[ga+1]=Cb.y;Na[ga+2]=Cb.z;Na[ga+3]=Db.x;Na[ga+4]=Db.y;Na[ga+5]=Db.z;Na[ga+6]=Eb.x;Na[ga+7]=Eb.y;Na[ga+8]=Eb.z;Na[ga+9]=tc.x;Na[ga+10]=tc.y;Na[ga+11]=tc.z}ga=ga+12}k.bindBuffer(k.ARRAY_BUFFER,la.__webglMorphTargetsBuffers[Ra]);k.bufferData(k.ARRAY_BUFFER,
Uc[Ra],mb);if(gb.morphNormals){k.bindBuffer(k.ARRAY_BUFFER,la.__webglMorphNormalsBuffers[Ra]);k.bufferData(k.ARRAY_BUFFER,Vc[Ra],mb)}}}if(ac.length){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];Ib=ac[P.a];Jb=ac[P.b];Kb=ac[P.c];Ba[aa]=Ib.x;Ba[aa+1]=Ib.y;Ba[aa+2]=Ib.z;Ba[aa+3]=Ib.w;Ba[aa+4]=Jb.x;Ba[aa+5]=Jb.y;Ba[aa+6]=Jb.z;Ba[aa+7]=Jb.w;Ba[aa+8]=Kb.x;Ba[aa+9]=Kb.y;Ba[aa+10]=Kb.z;Ba[aa+11]=Kb.w;Lb=hc[P.a];Mb=hc[P.b];Nb=hc[P.c];Aa[aa]=Lb.x;Aa[aa+1]=Lb.y;Aa[aa+2]=Lb.z;Aa[aa+3]=Lb.w;Aa[aa+4]=Mb.x;Aa[aa+5]=
Mb.y;Aa[aa+6]=Mb.z;Aa[aa+7]=Mb.w;Aa[aa+8]=Nb.x;Aa[aa+9]=Nb.y;Aa[aa+10]=Nb.z;Aa[aa+11]=Nb.w;aa=aa+12}D=0;for(W=na.length;D<W;D++){P=Wa[na[D]];Ib=ac[P.a];Jb=ac[P.b];Kb=ac[P.c];vc=ac[P.d];Ba[aa]=Ib.x;Ba[aa+1]=Ib.y;Ba[aa+2]=Ib.z;Ba[aa+3]=Ib.w;Ba[aa+4]=Jb.x;Ba[aa+5]=Jb.y;Ba[aa+6]=Jb.z;Ba[aa+7]=Jb.w;Ba[aa+8]=Kb.x;Ba[aa+9]=Kb.y;Ba[aa+10]=Kb.z;Ba[aa+11]=Kb.w;Ba[aa+12]=vc.x;Ba[aa+13]=vc.y;Ba[aa+14]=vc.z;Ba[aa+15]=vc.w;Lb=hc[P.a];Mb=hc[P.b];Nb=hc[P.c];wc=hc[P.d];Aa[aa]=Lb.x;Aa[aa+1]=Lb.y;Aa[aa+2]=Lb.z;Aa[aa+
3]=Lb.w;Aa[aa+4]=Mb.x;Aa[aa+5]=Mb.y;Aa[aa+6]=Mb.z;Aa[aa+7]=Mb.w;Aa[aa+8]=Nb.x;Aa[aa+9]=Nb.y;Aa[aa+10]=Nb.z;Aa[aa+11]=Nb.w;Aa[aa+12]=wc.x;Aa[aa+13]=wc.y;Aa[aa+14]=wc.z;Aa[aa+15]=wc.w;aa=aa+16}if(aa>0){k.bindBuffer(k.ARRAY_BUFFER,la.__webglSkinIndicesBuffer);k.bufferData(k.ARRAY_BUFFER,Aa,mb);k.bindBuffer(k.ARRAY_BUFFER,la.__webglSkinWeightsBuffer);k.bufferData(k.ARRAY_BUFFER,Ba,mb)}}if(hd&&ec){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];vb=P.vertexColors;Gc=P.color;if(vb.length===3&&ec===THREE.VertexColors){Fb=
vb[0];Gb=vb[1];Hb=vb[2]}else Hb=Gb=Fb=Gc;Ta[Ka]=Fb.r;Ta[Ka+1]=Fb.g;Ta[Ka+2]=Fb.b;Ta[Ka+3]=Gb.r;Ta[Ka+4]=Gb.g;Ta[Ka+5]=Gb.b;Ta[Ka+6]=Hb.r;Ta[Ka+7]=Hb.g;Ta[Ka+8]=Hb.b;Ka=Ka+9}D=0;for(W=na.length;D<W;D++){P=Wa[na[D]];vb=P.vertexColors;Gc=P.color;if(vb.length===4&&ec===THREE.VertexColors){Fb=vb[0];Gb=vb[1];Hb=vb[2];uc=vb[3]}else uc=Hb=Gb=Fb=Gc;Ta[Ka]=Fb.r;Ta[Ka+1]=Fb.g;Ta[Ka+2]=Fb.b;Ta[Ka+3]=Gb.r;Ta[Ka+4]=Gb.g;Ta[Ka+5]=Gb.b;Ta[Ka+6]=Hb.r;Ta[Ka+7]=Hb.g;Ta[Ka+8]=Hb.b;Ta[Ka+9]=uc.r;Ta[Ka+10]=uc.g;Ta[Ka+
11]=uc.b;Ka=Ka+12}if(Ka>0){k.bindBuffer(k.ARRAY_BUFFER,la.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,Ta,mb)}}if(Sc&&db.hasTangents){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];Qb=P.vertexTangents;zb=Qb[0];Ab=Qb[1];Bb=Qb[2];za[ua]=zb.x;za[ua+1]=zb.y;za[ua+2]=zb.z;za[ua+3]=zb.w;za[ua+4]=Ab.x;za[ua+5]=Ab.y;za[ua+6]=Ab.z;za[ua+7]=Ab.w;za[ua+8]=Bb.x;za[ua+9]=Bb.y;za[ua+10]=Bb.z;za[ua+11]=Bb.w;ua=ua+12}D=0;for(W=na.length;D<W;D++){P=Wa[na[D]];Qb=P.vertexTangents;zb=Qb[0];Ab=Qb[1];Bb=Qb[2];sc=Qb[3];za[ua]=
zb.x;za[ua+1]=zb.y;za[ua+2]=zb.z;za[ua+3]=zb.w;za[ua+4]=Ab.x;za[ua+5]=Ab.y;za[ua+6]=Ab.z;za[ua+7]=Ab.w;za[ua+8]=Bb.x;za[ua+9]=Bb.y;za[ua+10]=Bb.z;za[ua+11]=Bb.w;za[ua+12]=sc.x;za[ua+13]=sc.y;za[ua+14]=sc.z;za[ua+15]=sc.w;ua=ua+16}k.bindBuffer(k.ARRAY_BUFFER,la.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,za,mb)}if(Rc&&Pb){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];kc=P.vertexNormals;Yb=P.normal;if(kc.length===3&&Fc)for(qa=0;qa<3;qa++){Zb=kc[qa];ob[Va]=Zb.x;ob[Va+1]=Zb.y;ob[Va+2]=Zb.z;Va=Va+3}else for(qa=
...
yc[Tb+1]=oc.v;Tb=Tb+2}}if(Tb>0){k.bindBuffer(k.ARRAY_BUFFER,la.__webglUV2Buffer);k.bufferData(k.ARRAY_BUFFER,yc,mb)}}if(Dc){D=0;for(W=ma.length;D<W;D++){Ob[nb]=Ia;Ob[nb+1]=Ia+1;Ob[nb+2]=Ia+2;nb=nb+3;ib[Za]=Ia;ib[Za+1]=Ia+1;ib[Za+2]=Ia;ib[Za+3]=Ia+2;ib[Za+4]=Ia+1;ib[Za+5]=Ia+2;Za=Za+6;Ia=Ia+3}D=0;for(W=na.length;D<W;D++){Ob[nb]=Ia;Ob[nb+1]=Ia+1;Ob[nb+2]=Ia+3;Ob[nb+3]=Ia+1;Ob[nb+4]=Ia+2;Ob[nb+5]=Ia+3;nb=nb+6;ib[Za]=Ia;ib[Za+1]=Ia+1;ib[Za+2]=Ia;ib[Za+3]=Ia+3;ib[Za+4]=Ia+1;ib[Za+5]=Ia+2;ib[Za+6]=Ia+2;
ib[Za+7]=Ia+3;Za=Za+8;Ia=Ia+4}k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,la.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Ob,mb);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,la.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,ib,mb)}if(Wc){qa=0;for(qc=Wc.length;qa<qc;qa++){w=Wc[qa];if(w.__original.needsUpdate){y=0;if(w.size===1)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];w.array[y]=w.value[P.a];w.array[y+1]=w.value[P.b];w.array[y+2]=w.value[P.c];y=y+3}D=
0;for(W=na.length;D<W;D++){P=Wa[na[D]];w.array[y]=w.value[P.a];w.array[y+1]=w.value[P.b];w.array[y+2]=w.value[P.c];w.array[y+3]=w.value[P.d];y=y+4}}else{if(w.boundTo==="faces"){D=0;for(W=ma.length;D<W;D++){sa=w.value[ma[D]];w.array[y]=sa;w.array[y+1]=sa;w.array[y+2]=sa;y=y+3}D=0;for(W=na.length;D<W;D++){sa=w.value[na[D]];w.array[y]=sa;w.array[y+1]=sa;w.array[y+2]=sa;w.array[y+3]=sa;y=y+4}}}else if(w.size===2)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];S=
w.value[P.a];T=w.value[P.b];U=w.value[P.c];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=T.x;w.array[y+3]=T.y;w.array[y+4]=U.x;w.array[y+5]=U.y;y=y+6}D=0;for(W=na.length;D<W;D++){P=Wa[na[D]];S=w.value[P.a];T=w.value[P.b];U=w.value[P.c];ka=w.value[P.d];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=T.x;w.array[y+3]=T.y;w.array[y+4]=U.x;w.array[y+5]=U.y;w.array[y+6]=ka.x;w.array[y+7]=ka.y;y=y+8}}else{if(w.boundTo==="faces"){D=0;for(W=ma.length;D<W;D++){U=T=S=sa=w.value[ma[D]];w.array[y]=S.x;w.array[y+
1]=S.y;w.array[y+2]=T.x;w.array[y+3]=T.y;w.array[y+4]=U.x;w.array[y+5]=U.y;y=y+6}D=0;for(W=na.length;D<W;D++){ka=U=T=S=sa=w.value[na[D]];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=T.x;w.array[y+3]=T.y;w.array[y+4]=U.x;w.array[y+5]=U.y;w.array[y+6]=ka.x;w.array[y+7]=ka.y;y=y+8}}}else if(w.size===3){var Z;Z=w.type==="c"?["r","g","b"]:["x","y","z"];if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];S=w.value[P.a];T=w.value[P.b];U=w.value[P.c];w.array[y]=S[Z[0]];
w.array[y+1]=S[Z[1]];w.array[y+2]=S[Z[2]];w.array[y+3]=T[Z[0]];w.array[y+4]=T[Z[1]];w.array[y+5]=T[Z[2]];w.array[y+6]=U[Z[0]];w.array[y+7]=U[Z[1]];w.array[y+8]=U[Z[2]];y=y+9}D=0;for(W=na.length;D<W;D++){P=Wa[na[D]];S=w.value[P.a];T=w.value[P.b];U=w.value[P.c];ka=w.value[P.d];w.array[y]=S[Z[0]];w.array[y+1]=S[Z[1]];w.array[y+2]=S[Z[2]];w.array[y+3]=T[Z[0]];w.array[y+4]=T[Z[1]];w.array[y+5]=T[Z[2]];w.array[y+6]=U[Z[0]];w.array[y+7]=U[Z[1]];w.array[y+8]=U[Z[2]];w.array[y+9]=ka[Z[0]];w.array[y+10]=ka[Z[1]];
w.array[y+11]=ka[Z[2]];y=y+12}}else if(w.boundTo==="faces"){D=0;for(W=ma.length;D<W;D++){U=T=S=sa=w.value[ma[D]];w.array[y]=S[Z[0]];w.array[y+1]=S[Z[1]];w.array[y+2]=S[Z[2]];w.array[y+3]=T[Z[0]];w.array[y+4]=T[Z[1]];w.array[y+5]=T[Z[2]];w.array[y+6]=U[Z[0]];w.array[y+7]=U[Z[1]];w.array[y+8]=U[Z[2]];y=y+9}D=0;for(W=na.length;D<W;D++){ka=U=T=S=sa=w.value[na[D]];w.array[y]=S[Z[0]];w.array[y+1]=S[Z[1]];w.array[y+2]=S[Z[2]];w.array[y+3]=T[Z[0]];w.array[y+4]=T[Z[1]];w.array[y+5]=T[Z[2]];w.array[y+6]=U[Z[0]];
w.array[y+7]=U[Z[1]];w.array[y+8]=U[Z[2]];w.array[y+9]=ka[Z[0]];w.array[y+10]=ka[Z[1]];w.array[y+11]=ka[Z[2]];y=y+12}}else if(w.boundTo==="faceVertices"){D=0;for(W=ma.length;D<W;D++){sa=w.value[ma[D]];S=sa[0];T=sa[1];U=sa[2];w.array[y]=S[Z[0]];w.array[y+1]=S[Z[1]];w.array[y+2]=S[Z[2]];w.array[y+3]=T[Z[0]];w.array[y+4]=T[Z[1]];w.array[y+5]=T[Z[2]];w.array[y+6]=U[Z[0]];w.array[y+7]=U[Z[1]];w.array[y+8]=U[Z[2]];y=y+9}D=0;for(W=na.length;D<W;D++){sa=w.value[na[D]];S=sa[0];T=sa[1];U=sa[2];ka=sa[3];w.array[y]=
S[Z[0]];w.array[y+1]=S[Z[1]];w.array[y+2]=S[Z[2]];w.array[y+3]=T[Z[0]];w.array[y+4]=T[Z[1]];w.array[y+5]=T[Z[2]];w.array[y+6]=U[Z[0]];w.array[y+7]=U[Z[1]];w.array[y+8]=U[Z[2]];w.array[y+9]=ka[Z[0]];w.array[y+10]=ka[Z[1]];w.array[y+11]=ka[Z[2]];y=y+12}}}else if(w.size===4)if(w.boundTo===void 0||w.boundTo==="vertices"){D=0;for(W=ma.length;D<W;D++){P=Wa[ma[D]];S=w.value[P.a];T=w.value[P.b];U=w.value[P.c];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=
T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;y=y+12}D=0;for(W=na.length;D<W;D++){P=Wa[na[D]];S=w.value[P.a];T=w.value[P.b];U=w.value[P.c];ka=w.value[P.d];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;w.array[y+12]=ka.x;w.array[y+13]=ka.y;w.array[y+14]=ka.z;w.array[y+15]=ka.w;y=y+
16}}else if(w.boundTo==="faces"){D=0;for(W=ma.length;D<W;D++){U=T=S=sa=w.value[ma[D]];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;y=y+12}D=0;for(W=na.length;D<W;D++){ka=U=T=S=sa=w.value[na[D]];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;
w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;w.array[y+12]=ka.x;w.array[y+13]=ka.y;w.array[y+14]=ka.z;w.array[y+15]=ka.w;y=y+16}}else if(w.boundTo==="faceVertices"){D=0;for(W=ma.length;D<W;D++){sa=w.value[ma[D]];S=sa[0];T=sa[1];U=sa[2];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;y=y+12}D=0;for(W=na.length;D<W;D++){sa=w.value[na[D]];
S=sa[0];T=sa[1];U=sa[2];ka=sa[3];w.array[y]=S.x;w.array[y+1]=S.y;w.array[y+2]=S.z;w.array[y+3]=S.w;w.array[y+4]=T.x;w.array[y+5]=T.y;w.array[y+6]=T.z;w.array[y+7]=T.w;w.array[y+8]=U.x;w.array[y+9]=U.y;w.array[y+10]=U.z;w.array[y+11]=U.w;w.array[y+12]=ka.x;w.array[y+13]=ka.y;w.array[y+14]=ka.z;w.array[y+15]=ka.w;y=y+16}}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,mb)}}}if(yb){delete la.__inittedArrays;delete la.__colorArray;delete la.__normalArray;delete la.__tangentArray;
...
Ca+4}k.bindBuffer(k.ARRAY_BUFFER,xa.buffer);k.bufferData(k.ARRAY_BUFFER,xa.array,Zc)}}}}ea.verticesNeedUpdate=false;ea.colorsNeedUpdate=false;cb.attributes&&o(cb)}else if(ub instanceof THREE.ParticleSystem)if(ea instanceof THREE.BufferGeometry){(ea.verticesNeedUpdate||ea.colorsNeedUpdate)&&h(ea,k.DYNAMIC_DRAW,!ea.dynamic);ea.verticesNeedUpdate=false;ea.colorsNeedUpdate=false}else{cb=c(ub,bb);ab=cb.attributes&&q(cb);(ea.verticesNeedUpdate||ea.colorsNeedUpdate||ub.sortParticles||ab)&&g(ea,k.DYNAMIC_DRAW,
...
THREE.ShaderLib[n];a.uniforms=THREE.UniformsUtils.clone(o.uniforms);a.vertexShader=o.vertexShader;a.fragmentShader=o.fragmentShader}var q,p;q=h=e=f=o=0;for(g=b.length;q<g;q++){p=b[q];if(!p.onlyShadow){p instanceof THREE.DirectionalLight&&h++;p instanceof THREE.PointLight&&e++;p instanceof THREE.SpotLight&&f++;p instanceof THREE.HemisphereLight&&o++}}if(e+f+h+o<=fa){q=h;g=f}else{q=Math.ceil(fa*h/(e+h));g=e=fa-q;o=q}f=q;h=o;o=m=0;for(q=b.length;o<q;o++){p=b[o];if(p.castShadow){p instanceof THREE.SpotLight&&
...
0;s<c.maxMorphTargets;s++)d.push("morphTarget"+s);for(s=0;s<c.maxMorphNormals;s++)d.push("morphNormal"+s);for(r in b)d.push(r);r=d;s=0;for(c=r.length;s<c;s++){d=r[s];t.attributes[d]=k.getAttribLocation(t,d)}t.id=va++;ra.push({program:t,code:n,usedTimes:1});O.info.memory.programs=ra.length;r=t}a.program=r;r=a.program.attributes;r.position>=0&&k.enableVertexAttribArray(r.position);r.color>=0&&k.enableVertexAttribArray(r.color);r.normal>=0&&k.enableVertexAttribArray(r.normal);r.tangent>=0&&k.enableVertexAttribArray(r.tangent);
...
k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);G(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;f=d=0}else{b=null;c=Ha;a=$a;d=ya;f=xb}if(b!==$){k.bindFramebuffer(k.FRAMEBUFFER,
b);k.viewport(d,f,c,a);$=b}rb=c;Ea=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
...
B=void 0,C=void 0,z=void 0,F=void 0,v=m[s[p]].x,r=m[s[p]].y,A=m[s[q]].x,x=m[s[q]].y,B=m[s[o]].x,C=m[s[o]].y;if(1E-10>(A-v)*(C-r)-(x-r)*(B-v))m=false;else{for(u=0;u<t;u++)if(!(u==p||u==q||u==o)){var z=m[s[u]].x,F=m[s[u]].y,G=void 0,L=void 0,E=void 0,M=void 0,J=void 0,H=void 0,R=void 0,Q=void 0,K=void 0,N=void 0,ba=void 0,I=void 0,G=E=J=void 0,G=B-A,L=C-x,E=v-B,M=r-C,J=A-v,H=x-r,R=z-v,Q=F-r,K=z-A,N=F-x,ba=z-B,I=F-C,G=G*N-L*K,J=J*Q-H*R,E=E*I-M*ba;if(G>=0&&E>=0&&J>=0){m=false;break a}}m=true}}if(m){e.push([a[g[i]],
...
THREE.Path.prototype.getPoints=function(a,b){if(this.useSpacedPoints){console.log("tata");return this.getSpacedPoints(a,b)}var a=a||12,c=[],d,f,e,g,h,i,l,j,n,m,p,q,o;d=0;for(f=this.actions.length;d<f;d++){e=this.actions[d];g=e.action;e=e.args;switch(g){case THREE.PathActions.MOVE_TO:c.push(new THREE.Vector2(e[0],e[1]));break;case THREE.PathActions.LINE_TO:c.push(new THREE.Vector2(e[0],e[1]));break;case THREE.PathActions.QUADRATIC_CURVE_TO:h=e[2];i=e[3];n=e[0];m=e[1];if(c.length>0){g=c[c.length-1];
p=g.x;q=g.y}else{g=this.actions[d-1].args;p=g[g.length-2];q=g[g.length-1]}for(e=1;e<=a;e++){o=e/a;g=THREE.Shape.Utils.b2(o,p,n,h);o=THREE.Shape.Utils.b2(o,q,m,i);c.push(new THREE.Vector2(g,o))}break;case THREE.PathActions.BEZIER_CURVE_TO:h=e[4];i=e[5];n=e[0];m=e[1];l=e[2];j=e[3];if(c.length>0){g=c[c.length-1];p=g.x;q=g.y}else{g=this.actions[d-1].args;p=g[g.length-2];q=g[g.length-1]}for(e=1;e<=a;e++){o=e/a;g=THREE.Shape.Utils.b3(o,p,n,l,h);o=THREE.Shape.Utils.b3(o,q,m,j,i);c.push(new THREE.Vector2(g,
o))}break;case THREE.PathActions.CSPLINE_THRU:g=this.actions[d-1].args;o=[new THREE.Vector2(g[g.length-2],g[g.length-1])];g=a*e[0].length;o=o.concat(e[0]);o=new THREE.SplineCurve(o);for(e=1;e<=g;e++)c.push(o.getPointAt(e/g));break;case THREE.PathActions.ARC:h=e[0];i=e[1];m=e[2];l=e[3];g=e[4];n=!!e[5];p=g-l;q=a*2;for(e=1;e<=q;e++){o=e/q;n||(o=1-o);o=l+o*p;g=h+m*Math.cos(o);o=i+m*Math.sin(o);c.push(new THREE.Vector2(g,o))}break;case THREE.PathActions.ELLIPSE:h=e[0];i=e[1];m=e[2];j=e[3];l=e[4];g=e[5];
n=!!e[6];p=g-l;q=a*2;for(e=1;e<=q;e++){o=e/q;n||(o=1-o);o=l+o*p;g=h+m*Math.cos(o);o=i+j*Math.sin(o);c.push(new THREE.Vector2(g,o))}}}d=c[c.length-1];Math.abs(d.x-c[0].x)<1E-10&&Math.abs(d.y-c[0].y)<1E-10&&c.splice(c.length-1,1);b&&c.push(c[0]);return c};
...
THREE.Shape.Utils={removeHoles:function(a,b){var c=a.concat(),d=c.concat(),f,e,g,h,i,l,j,n,m,p,q=[];for(i=0;i<b.length;i++){l=b[i];Array.prototype.push.apply(d,l);e=Number.POSITIVE_INFINITY;for(f=0;f<l.length;f++){m=l[f];p=[];for(n=0;n<c.length;n++){j=c[n];j=m.distanceToSquared(j);p.push(j);if(j<e){e=j;g=f;h=n}}}f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:l.length-1;var o=[l[g],c[h],c[f]];n=THREE.FontUtils.Triangulate.area(o);var t=[l[g],l[e],c[h]];m=THREE.FontUtils.Triangulate.area(t);p=h;j=g;h=h+1;g=g+
-1;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+l.length);g=g%l.length;f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:l.length-1;o=[l[g],c[h],c[f]];o=THREE.FontUtils.Triangulate.area(o);t=[l[g],l[e],c[h]];t=THREE.FontUtils.Triangulate.area(t);if(n+m>o+t){h=p;g=j;h<0&&(h=h+c.length);h=h%c.length;g<0&&(g=g+l.length);g=g%l.length;f=h-1>=0?h-1:c.length-1;e=g-1>=0?g-1:l.length-1}n=c.slice(0,h);m=c.slice(h);p=l.slice(g);j=l.slice(0,g);e=[l[g],l[e],c[h]];q.push([l[g],c[h],c[f]]);q.push(e);c=n.concat(p).concat(j).concat(m)}return{shape:c,
...
THREE.RollControls=function(a,b){this.object=a;this.domElement=b!==void 0?b:document;this.mouseLook=true;this.autoForward=false;this.rollSpeed=this.movementSpeed=this.lookSpeed=1;this.constrainVertical=[-0.9,0.9];this.object.matrixAutoUpdate=false;this.forward=new THREE.Vector3(0,0,1);this.roll=0;var c=new THREE.Vector3,d=new THREE.Vector3,f=new THREE.Vector3,e=new THREE.Matrix4,g=false,h=1,i=0,l=0,j=0,n=0,m=0,p=0,q=0;this.handleResize=function(){p=window.innerWidth/2;q=window.innerHeight/2};this.update=
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function i(a,b,c,g,h,i,j,m){var n,o=d||1,p=f||1,q=h/2,s=i/2,t=l.vertices.length;if(a==="x"&&b==="y"||a==="y"&&b==="x")n="z";else if(a==="x"&&b==="z"||a==="z"&&b==="x"){n="y";p=e||1}else if(a==="z"&&b==="y"||a==="y"&&b==="z"){n="x";o=e||1}var u=o+1,v=p+1,N=h/o,ba=i/p,I=new THREE.Vector3;I[n]=j>0?1:-1;for(h=0;h<v;h++)for(i=0;i<u;i++){var fa=new THREE.Vector3;fa[a]=(i*N-q)*c;fa[b]=(h*ba-s)*g;fa[n]=j;l.vertices.push(fa)}for(h=0;h<p;h++)for(i=0;i<o;i++){a=new THREE.Face4(i+
u*h+t,i+u*(h+1)+t,i+1+u*(h+1)+t,i+1+u*h+t);a.normal.copy(I);a.vertexNormals.push(I.clone(),I.clone(),I.clone(),I.clone());a.materialIndex=m;l.faces.push(a);l.faceVertexUvs[0].push([new THREE.UV(i/o,1-h/p),new THREE.UV(i/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-(h+1)/p),new THREE.UV((i+1)/o,1-h/p)])}}THREE.Geometry.call(this);var l=this,j=a/2,n=b/2,m=c/2,p,q,o,t,s,u;if(g!==void 0){if(g instanceof Array)this.materials=g;else{this.materials=[];for(p=0;p<6;p++)this.materials.push(g)}p=0;t=1;q=2;s=3;o=4;u=
...
c.length-1);for(var g=0,h=m+j*2,g=0;g<h;g++){var i=K*g,l=K*(g+1),n=d+e+i,i=d+f+i,o=d+f+l,l=d+e+l,p=c,q=g,t=h,r=e,v=f,n=n+G,i=i+G,o=o+G,l=l+G;F.faces.push(new THREE.Face4(n,i,o,l,null,null,s));n=u.generateSideWallUV(F,a,p,b,n,i,o,l,q,t,r,v);F.faceVertexUvs[0].push(n)}}}function e(a,b,c){F.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c=c+G;d=d+G;e=e+G;F.faces.push(new THREE.Face3(c,d,e,null,null,t));c=f?u.generateBottomUV(F,a,b,c,d,e):u.generateTopUV(F,a,b,c,d,e);F.faceVertexUvs[0].push(c)}
...
false);r=new THREE.Vector3;A=new THREE.Vector3;x=new THREE.Vector3}if(!n)l=i=j=0;var B,C,z,F=this,G=this.vertices.length,p=a.extractPoints(),L=p.shape,p=p.holes,E=!THREE.Shape.Utils.isClockWise(L);if(E){L=L.reverse();C=0;for(z=p.length;C<z;C++){B=p[C];THREE.Shape.Utils.isClockWise(B)&&(p[C]=B.reverse())}E=false}var M=THREE.Shape.Utils.triangulateShape(L,p),E=L;C=0;for(z=p.length;C<z;C++){B=p[C];L=L.concat(B)}var J,H,R,Q,K=L.length,N=M.length,ba=[],I=0,fa=E.length;J=fa-1;for(H=I+1;I<fa;I++,J++,H++){J===
fa&&(J=0);H===fa&&(H=0);ba[I]=d(E[I],E[J],E[H])}var O=[],ra,va=ba.concat();C=0;for(z=p.length;C<z;C++){B=p[C];ra=[];I=0;fa=B.length;J=fa-1;for(H=I+1;I<fa;I++,J++,H++){J===fa&&(J=0);H===fa&&(H=0);ra[I]=d(B[I],B[J],B[H])}O.push(ra);va=va.concat(ra)}for(J=0;J<j;J++){B=J/j;R=i*(1-B);H=l*Math.sin(B*Math.PI/2);I=0;for(fa=E.length;I<fa;I++){Q=c(E[I],ba[I],H);e(Q.x,Q.y,-R)}C=0;for(z=p.length;C<z;C++){B=p[C];ra=O[C];I=0;for(fa=B.length;I<fa;I++){Q=c(B[I],ra[I],H);e(Q.x,Q.y,-R)}}}H=l;for(I=0;I<K;I++){Q=n?c(L[I],
va[I],H):L[I];if(o){A.copy(v.normals[0]).multiplyScalar(Q.x);r.copy(v.binormals[0]).multiplyScalar(Q.y);x.copy(q[0]).addSelf(A).addSelf(r);e(x.x,x.y,x.z)}else e(Q.x,Q.y,0)}for(B=1;B<=m;B++)for(I=0;I<K;I++){Q=n?c(L[I],va[I],H):L[I];if(o){A.copy(v.normals[B]).multiplyScalar(Q.x);r.copy(v.binormals[B]).multiplyScalar(Q.y);x.copy(q[B]).addSelf(A).addSelf(r);e(x.x,x.y,x.z)}else e(Q.x,Q.y,h/m*B)}for(J=j-1;J>=0;J--){B=J/j;R=i*(1-B);H=l*Math.sin(B*Math.PI/2);I=0;for(fa=E.length;I<fa;I++){Q=c(E[I],ba[I],H);
e(Q.x,Q.y,h+R)}C=0;for(z=p.length;C<z;C++){B=p[C];ra=O[C];I=0;for(fa=B.length;I<fa;I++){Q=c(B[I],ra[I],H);o?e(Q.x,Q.y+q[m-1].y,q[m-1].x+R):e(Q.x,Q.y,h+R)}}}if(n){i=K*0;for(I=0;I<N;I++){h=M[I];g(h[2]+i,h[1]+i,h[0]+i,true)}i=K*(m+j*2);for(I=0;I<N;I++){h=M[I];g(h[0]+i,h[1]+i,h[2]+i,false)}}else{for(I=0;I<N;I++){h=M[I];g(h[2],h[1],h[0],true)}for(I=0;I<N;I++){h=M[I];g(h[0]+K*m,h[1]+K*m,h[2]+K*m,false)}}h=0;f(E,h);h=h+E.length;C=0;for(z=p.length;C<z;C++){B=p[C];f(B,h);h=h+B.length}};
...
THREE.TubeGeometry=function(a,b,c,d,f,e){THREE.Geometry.call(this);this.path=a;this.segments=b||64;this.radius=c||1;this.segmentsRadius=d||8;this.closed=f||false;if(e)this.debug=new THREE.Object3D;this.grid=[];var g,h,e=this.segments+1,i,l,j,n=new THREE.Vector3,m,p,q,b=new THREE.TubeGeometry.FrenetFrames(a,b,f);m=b.tangents;p=b.normals;q=b.binormals;this.tangents=m;this.normals=p;this.binormals=q;for(b=0;b<e;b++){this.grid[b]=[];d=b/(e-1);j=a.getPointAt(d);d=m[b];g=p[b];h=q[b];if(this.debug){this.debug.add(new THREE.ArrowHelper(d,
...
THREE.ParametricGeometry=function(a,b,c,d){THREE.Geometry.call(this);var f=this.vertices,e=this.faces,g=this.faceVertexUvs[0],d=d===void 0?false:d,h,i,l,j,n=b+1;for(h=0;h<=c;h++){j=h/c;for(i=0;i<=b;i++){l=i/b;l=a(l,j);f.push(l)}}var m,p,q,o;for(h=0;h<c;h++)for(i=0;i<b;i++){a=h*n+i;f=h*n+i+1;j=(h+1)*n+i;l=(h+1)*n+i+1;m=new THREE.UV(i/b,h/c);p=new THREE.UV((i+1)/b,h/c);q=new THREE.UV(i/b,(h+1)/c);o=new THREE.UV((i+1)/b,(h+1)/c);if(d){e.push(new THREE.Face3(a,f,j));e.push(new THREE.Face3(f,l,j));g.push([m,
p,q]);g.push([p,o,q])}else{e.push(new THREE.Face4(a,f,l,j));g.push([m,p,o,q])}}this.computeCentroids();this.computeFaceNormals();this.computeVertexNormals()};THREE.ParametricGeometry.prototype=Object.create(THREE.Geometry.prototype);
THREE.ConvexGeometry=function(a){function b(a){var b=a.length();return new THREE.UV(a.x/b,a.y/b)}THREE.Geometry.call(this);for(var c=[[0,1,2],[0,2,1]],d=3;d<a.length;d++){var f=d,e=a[f].clone(),g=e.length();e.x=e.x+g*(Math.random()-0.5)*2E-6;e.y=e.y+g*(Math.random()-0.5)*2E-6;e.z=e.z+g*(Math.random()-0.5)*2E-6;for(var g=[],h=0;h<c.length;){var i=c[h],l=e,j=a[i[0]],n;n=j;var m=a[i[1]],p=a[i[2]],q=new THREE.Vector3,o=new THREE.Vector3;q.sub(p,m);o.sub(n,m);q.crossSelf(o);q.isZero()||q.normalize();n=
...
if(x instanceof THREE.Face3){z=f(x.a,x.b);C(z,B);z=f(x.b,x.c);C(z,B);z=f(x.c,x.a);C(z,B)}else if(x instanceof THREE.Face4){z=f(x.a,x.b);C(z,B);z=f(x.b,x.c);C(z,B);z=f(x.c,x.d);C(z,B);z=f(x.d,x.a);C(z,B)}}v=F;var G=0,L,E;C={};B={};for(u in v){z=v[u];L=u.split("_");E=L[0];L=L[1];r=E;x=[E,L];C[r]===void 0&&(C[r]=[]);C[r].push(x);r=L;x=[E,L];C[r]===void 0&&(C[r]=[]);C[r].push(x);r=0;for(A=z.length;r<A;r++){x=z[r];var M=E,J=x,H=u;B[M]===void 0&&(B[M]={});B[M][J]=H;M=L;J=u;B[M]===void 0&&(B[M]={});B[M][x]=
J}z.length<2&&(o[u]=true)}b("vertexEdgeMap",C,"vertexFaceMap",B);for(u in v){z=v[u];x=z[0];A=z[1];L=u.split("_");E=L[0];L=L[1];z=new THREE.Vector3;if(o[u]){z.addSelf(n[E]);z.addSelf(n[L]);z.multiplyScalar(0.5)}else{z.addSelf(p[x]);z.addSelf(p[A]);z.addSelf(n[E]);z.addSelf(n[L]);z.multiplyScalar(0.25)}q[u]=s+m.length+G;h.push(z);G++;if(j.supportUVs){z=new THREE.UV;z.u=e(E,x).u+e(L,x).u;z.v=e(E,x).v+e(L,x).v;z.u=z.u/2;z.v=z.v/2;g(q[u],x,z);if(!o[u]){z=new THREE.UV;z.u=e(E,A).u+e(L,A).u;z.v=e(E,A).v+
e(L,A).v;z.u=z.u/2;z.v=z.v/2;g(q[u],A,z)}}}b("-- Step 2 done");var R,Q;L=["123","12","2","23"];A=["123","23","3","31"];var M=["123","31","1","12"],J=["1234","12","2","23"],H=["1234","23","3","34"],K=["1234","34","4","41"],N=["1234","41","1","12"];u=0;for(v=p.length;u<v;u++){x=m[u];z=s+u;if(x instanceof THREE.Face3){G=f(x.a,x.b);E=f(x.b,x.c);R=f(x.c,x.a);d(z,q[G],x.b,q[E],x,L,u);d(z,q[E],x.c,q[R],x,A,u);d(z,q[R],x.a,q[G],x,M,u)}else if(x instanceof THREE.Face4){G=f(x.a,x.b);E=f(x.b,x.c);R=f(x.c,x.d);
Q=f(x.d,x.a);d(z,q[G],x.b,q[E],x,J,u);d(z,q[E],x.c,q[R],x,H,u);d(z,q[R],x.d,q[Q],x,K,u);d(z,q[Q],x.a,q[G],x,N,u)}else b("face should be a face!",x)}q=new THREE.Vector3;x=new THREE.Vector3;u=0;for(v=n.length;u<v;u++)if(C[u]!==void 0){q.set(0,0,0);x.set(0,0,0);E=new THREE.Vector3(0,0,0);z=0;for(r in B[u]){q.addSelf(p[r]);z++}L=0;G=C[u].length;for(r=0;r<G;r++)o[f(C[u][r][0],C[u][r][1])]&&L++;if(L!=2){q.divideScalar(z);for(r=0;r<G;r++){z=C[u][r];z=n[z[0]].clone().addSelf(n[z[1]]).divideScalar(2);x.addSelf(z)}x.divideScalar(G);
E.addSelf(n[u]);E.multiplyScalar(G-3);E.addSelf(q);E.addSelf(x.multiplyScalar(2));E.divideScalar(G);h[u]=E}}a.vertices=h;a.faces=i;a.faceVertexUvs[0]=l;delete a.__tmpVertices;a.computeCentroids();a.computeFaceNormals();a.computeVertexNormals()};THREE.ImmediateRenderObject=function(){THREE.Object3D.call(this);this.render=function(){}};THREE.ImmediateRenderObject.prototype=Object.create(THREE.Object3D.prototype);
...
THREE.LensFlarePlugin=function(){function a(a){var c=b.createProgram(),d=b.createShader(b.FRAGMENT_SHADER),e=b.createShader(b.VERTEX_SHADER);b.shaderSource(d,a.fragmentShader);b.shaderSource(e,a.vertexShader);b.compileShader(d);b.compileShader(e);b.attachShader(c,d);b.attachShader(c,e);b.linkProgram(c);return c}var b,c,d,f,e,g,h,i,l,j,n,m,p;this.init=function(q){b=q.context;c=q;d=new Float32Array(16);f=new Uint16Array(6);q=0;d[q++]=-1;d[q++]=-1;d[q++]=0;d[q++]=0;d[q++]=1;d[q++]=-1;d[q++]=1;d[q++]=
...
"color");m.scale=b.getUniformLocation(j,"scale");m.rotation=b.getUniformLocation(j,"rotation");m.screenPosition=b.getUniformLocation(j,"screenPosition");p=false};this.render=function(a,d,f,s){var a=a.__webglFlares,u=a.length;if(u){var v=new THREE.Vector3,r=s/f,A=f*0.5,x=s*0.5,B=16/s,C=new THREE.Vector2(B*r,B),z=new THREE.Vector3(1,1,0),F=new THREE.Vector2(1,1),G=m,B=n;b.useProgram(j);if(!p){b.enableVertexAttribArray(n.vertex);b.enableVertexAttribArray(n.uv);p=true}b.uniform1i(G.occlusionMap,0);b.uniform1i(G.map,
1);b.bindBuffer(b.ARRAY_BUFFER,e);b.vertexAttribPointer(B.vertex,2,b.FLOAT,false,16,0);b.vertexAttribPointer(B.uv,2,b.FLOAT,false,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(false);var L,E,M,J,H;for(L=0;L<u;L++){B=16/s;C.set(B*r,B);J=a[L];v.set(J.matrixWorld.elements[12],J.matrixWorld.elements[13],J.matrixWorld.elements[14]);d.matrixWorldInverse.multiplyVector3(v);d.projectionMatrix.multiplyVector3(v);z.copy(v);F.x=z.x*A+A;F.y=z.y*x+x;if(l||F.x>0&&F.x<f&&F.y>0&&
...
b.bindTexture(b.TEXTURE_2D,h);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0);J.positionScreen.copy(z);J.customUpdateCallback?J.customUpdateCallback(J):J.updateLensFlares();b.uniform1i(G.renderType,2);b.enable(b.BLEND);E=0;for(M=J.lensFlares.length;E<M;E++){H=J.lensFlares[E];if(H.opacity>0.001&&H.scale>0.001){z.x=H.x;z.y=H.y;z.z=H.z;B=H.size*H.scale/s;C.x=B*r;C.y=B;b.uniform3f(G.screenPosition,z.x,z.y,z.z);b.uniform2f(G.scale,C.x,C.y);b.uniform1f(G.rotation,H.rotation);b.uniform1f(G.opacity,H.opacity);
b.uniform3f(G.color,H.color.r,H.color.g,H.color.b);c.setBlending(H.blending,H.blendEquation,H.blendSrc,H.blendDst);c.setTexture(H.texture,1);b.drawElements(b.TRIANGLES,6,b.UNSIGNED_SHORT,0)}}}}b.enable(b.CULL_FACE);b.enable(b.DEPTH_TEST);b.depthMask(true)}}};
...
d:c;j instanceof THREE.BufferGeometry?b.renderBufferDirect(h,g.__lights,null,n,j,m):b.renderBuffer(h,g.__lights,null,n,j,m)}}p=g.__webglObjectsImmediate;i=0;for(l=p.length;i<l;i++){j=p[i];m=j.object;if(m.visible&&m.castShadow){m._modelViewMatrix.multiply(h.matrixWorldInverse,m.matrixWorld);b.renderImmediateObject(h,g.__lights,null,c,m)}}i=b.getClearColor();l=b.getClearAlpha();a.clearColor(i.r,i.g,i.b,l);a.enable(a.BLEND)}};
