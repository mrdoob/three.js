...
e=THREE.Matrix4.__v1,f=THREE.Matrix4.__v2,g=THREE.Matrix4.__v3;g.sub(a,b).normalize();0===g.length()&&(g.z=1);e.cross(c,g).normalize();0===e.length()&&(g.x+=1E-4,e.cross(c,g).normalize());f.cross(g,e);d[0]=e.x;d[4]=f.x;d[8]=g.x;d[1]=e.y;d[5]=f.y;d[9]=g.y;d[2]=e.z;d[6]=f.z;d[10]=g.z;return this},multiply:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],j=c[1],m=c[5],p=c[9],n=c[13],r=c[2],s=c[6],l=c[10],t=c[14],u=c[3],E=c[7],y=c[11],c=c[15],q=d[0],G=d[4],A=d[8],
z=d[12],v=d[1],I=d[5],D=d[9],F=d[13],M=d[2],B=d[6],J=d[10],C=d[14],L=d[3],K=d[7],U=d[11],d=d[15];e[0]=f*q+g*v+h*M+i*L;e[4]=f*G+g*I+h*B+i*K;e[8]=f*A+g*D+h*J+i*U;e[12]=f*z+g*F+h*C+i*d;e[1]=j*q+m*v+p*M+n*L;e[5]=j*G+m*I+p*B+n*K;e[9]=j*A+m*D+p*J+n*U;e[13]=j*z+m*F+p*C+n*d;e[2]=r*q+s*v+l*M+t*L;e[6]=r*G+s*I+l*B+t*K;e[10]=r*A+s*D+l*J+t*U;e[14]=r*z+s*F+l*C+t*d;e[3]=u*q+E*v+y*M+c*L;e[7]=u*G+E*I+y*B+c*K;e[11]=u*A+E*D+y*J+c*U;e[15]=u*z+E*F+y*C+c*d;return this},multiplySelf:function(a){return this.multiply(this,
...
g=Math.sqrt(d*d+e*e+f*f),d=d/g,e=e/g,f=f/g,g=d*d,h=e*e,i=f*f,j=Math.cos(b),m=Math.sin(b),p=1-j,n=d*e*p,r=d*f*p,p=e*f*p,d=d*m,s=e*m,m=f*m,f=g+(1-g)*j,g=n+m,e=r-s,n=n-m,h=h+(1-h)*j,m=p+d,r=r+s,p=p-d,i=i+(1-i)*j,j=c[0],d=c[1],s=c[2],l=c[3],t=c[4],u=c[5],E=c[6],y=c[7],q=c[8],G=c[9],A=c[10],z=c[11];c[0]=f*j+g*t+e*q;c[1]=f*d+g*u+e*G;c[2]=f*s+g*E+e*A;c[3]=f*l+g*y+e*z;c[4]=n*j+h*t+m*q;c[5]=n*d+h*u+m*G;c[6]=n*s+h*E+m*A;c[7]=n*l+h*y+m*z;c[8]=r*j+p*t+i*q;c[9]=r*d+p*u+i*G;c[10]=r*s+p*E+i*A;c[11]=r*l+p*y+i*z;
...
e&&0<=a&&1>e+a},p=function(g,h,i){if(g instanceof a.Particle){h=h.ray.distanceToPoint(g.matrixWorld.getPosition());if(h>g.scale.x)return i;i.push({distance:h,point:g.position,face:null,object:g})}else if(g instanceof a.Mesh){b.set(g.matrixWorld.getPosition(),g.geometry.boundingSphere.radius*g.matrixWorld.getMaxScaleOnAxis());if(!h.ray.isIntersectionSphere(b))return i;var j=g.geometry,n=j.vertices,p=g.material instanceof a.MeshFaceMaterial,y=!0===p?g.material.materials:null,q=g.material.side,G,A,z,
v=h.precision;g.matrixRotationWorld.extractRotation(g.matrixWorld);f.getInverse(g.matrixWorld);c.copy(h.ray).transformSelf(f);for(var I=0,D=j.faces.length;I<D;I++){var F=j.faces[I],q=!0===p?y[F.materialIndex]:g.material;if(void 0!==q){d.setFromNormalAndCoplanarPoint(F.normal,F.centroid);var M=c.distanceToPlane(d);if(!(Math.abs(M)<v)&&!(0>M)){q=q.side;if(q!==a.DoubleSide&&(G=c.direction.dot(d.normal),!(q===a.FrontSide?0>G:0<G)))continue;if(!(M<h.near||M>h.far)){e=c.at(M,e);if(F instanceof a.Face3){if(q=
n[F.a],G=n[F.b],A=n[F.c],!m(e,q,G,A))continue}else if(F instanceof a.Face4){if(q=n[F.a],G=n[F.b],A=n[F.c],z=n[F.d],!m(e,q,G,z)&&!m(e,G,A,z))continue}else throw Error("face type not supported");i.push({distance:M,point:h.ray.at(M),face:F,faceIndex:I,object:g})}}}}}},n=function(a,b,c){for(var a=a.getDescendants(),d=0,e=a.length;d<e;d++)p(a[d],b,c)};a.Raycaster.prototype.precision=1E-4;a.Raycaster.prototype.set=function(a,b){this.ray.set(a,b);0<this.ray.direction.length()&&this.ray.direction.normalize()};
...
ga.positionScreen.y)-(ja.positionScreen.y-ga.positionScreen.y)*(ea.positionScreen.x-ga.positionScreen.x),Y===THREE.DoubleSide||Q===(Y===THREE.FrontSide)){if(t===E){var ub=new THREE.RenderableFace4;u.push(ub);E++;t++;n=ub}else n=u[t++];n.v1.copy(P);n.v2.copy(ja);n.v3.copy(ga);n.v4.copy(ea)}else continue;else continue;n.normalWorld.copy(ba.normal);!1===Q&&(Y===THREE.BackSide||Y===THREE.DoubleSide)&&n.normalWorld.negate();L.multiplyVector3(n.normalWorld).normalize();n.centroidWorld.copy(ba.centroid);
Va.multiplyVector3(n.centroidWorld);n.centroidScreen.copy(n.centroidWorld);J.multiplyVector3(n.centroidScreen);ga=ba.vertexNormals;P=0;for(ja=ga.length;P<ja;P++)ea=n.vertexNormalsWorld[P],ea.copy(ga[P]),!1===Q&&(Y===THREE.BackSide||Y===THREE.DoubleSide)&&ea.negate(),L.multiplyVector3(ea).normalize();n.vertexNormalsLength=ga.length;P=0;for(ja=ta.length;P<ja;P++)if(ea=ta[P][da],void 0!==ea){Y=0;for(ga=ea.length;Y<ga;Y++)n.uvs[P][Y]=ea[Y]}n.color=ba.color;n.material=vb;n.z=n.centroidScreen.z;F.elements.push(n)}}else if(Ca instanceof
THREE.Line){C.multiply(J,Va);da=Ca.geometry.vertices;P=b();P.positionScreen.copy(da[0]);C.multiplyVector4(P.positionScreen);Va=Ca.type===THREE.LinePieces?2:1;R=1;for(ba=da.length;R<ba;R++)P=b(),P.positionScreen.copy(da[R]),C.multiplyVector4(P.positionScreen),0<(R+1)%Va||(ja=m[j-2],U.copy(P.positionScreen),O.copy(ja.positionScreen),!0===d(U,O)&&(U.multiplyScalar(1/U.w),O.multiplyScalar(1/O.w),q===A?(Da=new THREE.RenderableLine,G.push(Da),A++,q++,y=Da):y=G[q++],y.v1.positionScreen.copy(U),y.v2.positionScreen.copy(O),
y.z=Math.max(U.z,O.z),y.material=Ca.material,F.elements.push(y)))}g=0;for(p=F.sprites.length;g<p;g++)Ca=F.sprites[g].object,Va=Ca.matrixWorld,Ca instanceof THREE.Particle&&(B.set(Va.elements[12],Va.elements[13],Va.elements[14],1),J.multiplyVector4(B),B.z/=B.w,0<B.z&&1>B.z&&(v===D?(la=new THREE.RenderableParticle,I.push(la),D++,v++,z=la):z=I[v++],z.object=Ca,z.x=B.x/B.w,z.y=B.y/B.w,z.z=B.z,z.rotation=Ca.rotation.z,z.scale.x=Ca.scale.x*Math.abs(z.x-(B.x+h.projectionMatrix.elements[0])/(B.w+h.projectionMatrix.elements[12])),
z.scale.y=Ca.scale.y*Math.abs(z.y-(B.y+h.projectionMatrix.elements[5])/(B.w+h.projectionMatrix.elements[13])),z.material=Ca.material,F.elements.push(z)));!0===na&&F.elements.sort(c);return F}};THREE.Face3=function(a,b,c,d,e,f){this.a=a;this.b=b;this.c=c;this.normal=d instanceof THREE.Vector3?d:new THREE.Vector3;this.vertexNormals=d instanceof Array?d:[];this.color=e instanceof THREE.Color?e:new THREE.Color;this.vertexColors=e instanceof Array?e:[];this.vertexTangents=[];this.materialIndex=void 0!==f?f:0;this.centroid=new THREE.Vector3};
...
this.attributes.normal.array,b,c,d,e=0,f=a.length;e<f;e+=3)b=a[e],c=a[e+1],d=a[e+2],b=1/Math.sqrt(b*b+c*c+d*d),a[e]*=b,a[e+1]*=b,a[e+2]*=b},computeTangents:function(){function a(a){$.x=d[3*a];$.y=d[3*a+1];$.z=d[3*a+2];wa.copy($);na=i[a];U.copy(na);U.subSelf($.multiplyScalar($.dot(na))).normalize();O.cross(wa,na);la=O.dot(j[a]);N=0>la?-1:1;h[4*a]=U.x;h[4*a+1]=U.y;h[4*a+2]=U.z;h[4*a+3]=N}if(void 0===this.attributes.index||void 0===this.attributes.position||void 0===this.attributes.normal||void 0===
...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var e=function(){var b,c,d,e,j,m,p,n,r,s,l,t,u,E,y,q;function G(a){return a%4?4-a%4:0}function A(a,b){return(new Uint8Array(a,b,1))[0]}function z(a,b){return(new Uint32Array(a,b,1))[0]}function v(b,c){var d,e,f,g,h,i,j,m=new Uint32Array(a,c,3*b);for(d=0;d<b;d++)e=m[3*d],f=m[3*d+1],g=m[3*d+2],h=K[2*e],e=K[2*e+1],i=K[2*f],j=K[2*f+1],f=K[2*g],g=K[2*g+1],J.faceVertexUvs[0].push([new THREE.Vector2(h,e),new THREE.Vector2(i,j),new THREE.Vector2(f,
...
C+=b;O=3*c+j;$=4*c+j;U=r*O;b=s*(O+3*d);c=l*(O+3*e);j=t*(O+3*d+3*e);O=u*$;d=E*($+4*d);e=y*($+4*e);$=C;var C=new Float32Array(a,C,3*m),wa,N,na,la;for(wa=0;wa<m;wa++)N=C[3*wa],na=C[3*wa+1],la=C[3*wa+2],J.vertices.push(new THREE.Vector3(N,na,la));m=C=$+3*m*Float32Array.BYTES_PER_ELEMENT;if(p){C=new Int8Array(a,C,3*p);for($=0;$<p;$++)wa=C[3*$],N=C[3*$+1],na=C[3*$+2],L.push(wa/127,N/127,na/127)}C=m+3*p*Int8Array.BYTES_PER_ELEMENT;p=C+=G(3*p);if(n){m=new Float32Array(a,C,2*n);for(C=0;C<n;C++)$=m[2*C],wa=
m[2*C+1],K.push($,wa)}n=C=p+2*n*Float32Array.BYTES_PER_ELEMENT;U=n+U+G(2*r);p=U+b+G(2*s);b=p+c+G(2*l);c=b+j+G(2*t);O=c+O+G(2*u);j=O+d+G(2*E);d=j+e+G(2*y);l&&(e=p+3*l*Uint32Array.BYTES_PER_ELEMENT,D(l,p,e+3*l*Uint32Array.BYTES_PER_ELEMENT),v(l,e));t&&(l=b+3*t*Uint32Array.BYTES_PER_ELEMENT,e=l+3*t*Uint32Array.BYTES_PER_ELEMENT,M(t,b,l,e+3*t*Uint32Array.BYTES_PER_ELEMENT),v(t,e));y&&(t=j+4*y*Uint32Array.BYTES_PER_ELEMENT,F(y,j,t+4*y*Uint32Array.BYTES_PER_ELEMENT),I(y,t));q&&(y=d+4*q*Uint32Array.BYTES_PER_ELEMENT,
t=y+4*q*Uint32Array.BYTES_PER_ELEMENT,B(q,d,y,t+4*q*Uint32Array.BYTES_PER_ELEMENT),I(q,t));r&&D(r,n,n+3*r*Uint32Array.BYTES_PER_ELEMENT);s&&(r=U+3*s*Uint32Array.BYTES_PER_ELEMENT,M(s,U,r,r+3*s*Uint32Array.BYTES_PER_ELEMENT));u&&F(u,c,c+4*u*Uint32Array.BYTES_PER_ELEMENT);E&&(s=O+4*E*Uint32Array.BYTES_PER_ELEMENT,B(E,O,s,s+4*E*Uint32Array.BYTES_PER_ELEMENT));this.computeCentroids();this.computeFaceNormals()};e.prototype=Object.create(THREE.Geometry.prototype);e=new e(c);c=this.initMaterials(d,c);this.needsTangents(c)&&
...
THREE.JSONLoader.prototype.createModel=function(a,b,c){var d=new THREE.Geometry,e=void 0!==a.scale?1/a.scale:1,f,g,h,i,j,m,p,n,r,s,l,t,u,E,y,q=a.faces;s=a.vertices;var G=a.normals,A=a.colors,z=0;for(f=0;f<a.uvs.length;f++)a.uvs[f].length&&z++;for(f=0;f<z;f++)d.faceUvs[f]=[],d.faceVertexUvs[f]=[];i=0;for(j=s.length;i<j;)m=new THREE.Vector3,m.x=s[i++]*e,m.y=s[i++]*e,m.z=s[i++]*e,d.vertices.push(m);i=0;for(j=q.length;i<j;){s=q[i++];m=s&1;h=s&2;f=s&4;g=s&8;n=s&16;p=s&32;l=s&64;s&=128;m?(t=new THREE.Face4,
t.a=q[i++],t.b=q[i++],t.c=q[i++],t.d=q[i++],m=4):(t=new THREE.Face3,t.a=q[i++],t.b=q[i++],t.c=q[i++],m=3);h&&(h=q[i++],t.materialIndex=h);h=d.faces.length;if(f)for(f=0;f<z;f++)u=a.uvs[f],r=q[i++],y=u[2*r],r=u[2*r+1],d.faceUvs[f][h]=new THREE.Vector2(y,r);if(g)for(f=0;f<z;f++){u=a.uvs[f];E=[];for(g=0;g<m;g++)r=q[i++],y=u[2*r],r=u[2*r+1],E[g]=new THREE.Vector2(y,r);d.faceVertexUvs[f][h]=E}n&&(n=3*q[i++],g=new THREE.Vector3,g.x=G[n++],g.y=G[n++],g.z=G[n],t.normal=g);if(p)for(f=0;f<m;f++)n=3*q[i++],g=
new THREE.Vector3,g.x=G[n++],g.y=G[n++],g.z=G[n],t.vertexNormals.push(g);l&&(p=q[i++],p=new THREE.Color(A[p]),t.color=p);if(s)for(f=0;f<m;f++)p=q[i++],p=new THREE.Color(A[p]),t.vertexColors.push(p);d.faces.push(t)}if(a.skinWeights){i=0;for(j=a.skinWeights.length;i<j;i+=2)q=a.skinWeights[i],G=a.skinWeights[i+1],d.skinWeights.push(new THREE.Vector4(q,G,0,0))}if(a.skinIndices){i=0;for(j=a.skinIndices.length;i<j;i+=2)q=a.skinIndices[i],G=a.skinIndices[i+1],d.skinIndices.push(new THREE.Vector4(q,G,0,0))}d.bones=
a.bones;d.animation=a.animation;if(void 0!==a.morphTargets){i=0;for(j=a.morphTargets.length;i<j;i++){d.morphTargets[i]={};d.morphTargets[i].name=a.morphTargets[i].name;d.morphTargets[i].vertices=[];A=d.morphTargets[i].vertices;z=a.morphTargets[i].vertices;q=0;for(G=z.length;q<G;q+=3)s=new THREE.Vector3,s.x=z[q]*e,s.y=z[q+1]*e,s.z=z[q+2]*e,A.push(s)}}if(void 0!==a.morphColors){i=0;for(j=a.morphColors.length;i<j;i++){d.morphColors[i]={};d.morphColors[i].name=a.morphColors[i].name;d.morphColors[i].colors=
[];G=d.morphColors[i].colors;A=a.morphColors[i].colors;e=0;for(q=A.length;e<q;e+=3)z=new THREE.Color(16755200),z.setRGB(A[e],A[e+1],A[e+2]),G.push(z)}}d.computeCentroids();d.computeFaceNormals();a=this.initMaterials(a.materials,c);this.needsTangents(a)&&d.computeTangents();b(d,a)};THREE.LoadingMonitor=function(){THREE.EventTarget.call(this);var a=this,b=0,c=0,d=function(){b++;a.dispatchEvent({type:"progress",loaded:b,total:c});b===c&&a.dispatchEvent({type:"load"})};this.add=function(a){c++;a.addEventListener("load",d,!1)}};THREE.SceneLoader=function(){this.onLoadStart=function(){};this.onLoadProgress=function(){};this.onLoadComplete=function(){};this.callbackSync=function(){};this.callbackProgress=function(){};this.geometryHandlerMap={};this.hierarchyHandlerMap={};this.addGeometryHandler("ascii",THREE.JSONLoader);this.addGeometryHandler("binary",THREE.BinaryLoader)};THREE.SceneLoader.prototype.constructor=THREE.SceneLoader;
...
f.useQuaternion=!0):f.rotation.set(h[0],h[1],h[2]);f.scale.set(n[0],n[1],n[2]);c&&f.traverse(function(a){a.material=c});b.add(f);v.objects[a]=f;e();q-=1;m.onLoadComplete();j()}}function i(a){return function(b,c){v.geometries[a]=b;v.face_materials[a]=c}}function j(){m.callbackProgress({totalModels:A,totalTextures:z,loadedModels:A-q,loadedTextures:z-G},v);m.onLoadProgress();if(0===q&&0===G){for(var a=0;a<I.length;a++){var c=I[a],d=v.objects[c.targetName];d?c.object.target=d:(c.object.target=new THREE.Object3D,
v.scene.add(c.object.target));c.object.target.properties.targetInverse=c.object}b(v)}}var m=this,p=THREE.Loader.prototype.extractUrlBase(c),n,r,s,l,t,u,E,y,q,G,A,z,v,I=[],D=a,F;for(F in this.geometryHandlerMap)a=this.geometryHandlerMap[F].loaderClass,this.geometryHandlerMap[F].loaderObject=new a;for(F in this.hierarchyHandlerMap)a=this.hierarchyHandlerMap[F].loaderClass,this.hierarchyHandlerMap[F].loaderObject=new a;G=q=0;v={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},
objects:{},cameras:{},lights:{},fogs:{},empties:{}};if(D.transform&&(F=D.transform.position,a=D.transform.rotation,c=D.transform.scale,F&&v.scene.position.set(F[0],F[1],F[2]),a&&v.scene.rotation.set(a[0],a[1],a[2]),c&&v.scene.scale.set(c[0],c[1],c[2]),F||a||c))v.scene.updateMatrix(),v.scene.updateMatrixWorld();F=function(a){return function(){G-=a;j();m.onLoadComplete()}};for(var M in D.fogs)a=D.fogs[M],"linear"===a.type?l=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(l=new THREE.FogExp2(0,a.density)),
...
document.createElement("canvas"),p,n,r,s,l=m.getContext("2d"),t=new THREE.Color(0),u=0,E=1,y=0,q=null,G=null,A=null,z=null,v=null,I,D,F,M,B=new THREE.RenderableVertex,J=new THREE.RenderableVertex,C,L,K,U,O,$,wa,N,na,la,Ma,Q,R=new THREE.Color,ba=new THREE.Color,da=new THREE.Color,P=new THREE.Color,ja=new THREE.Color,Y=new THREE.Color,ga=new THREE.Color,Ca={},Va={},ta,Da,ea,Ha,gb,vb,qb,ub,Kb,Lb,tb=new THREE.Rectangle,Sa=new THREE.Rectangle,ma=new THREE.Rectangle,xb=!1,Na=new THREE.Color,kb=new THREE.Color,
hb=new THREE.Color,Ea=new THREE.Vector3,ab,eb,mc,ib,Eb,Ra,a=16;ab=document.createElement("canvas");ab.width=ab.height=2;eb=ab.getContext("2d");eb.fillStyle="rgba(0,0,0,1)";eb.fillRect(0,0,2,2);mc=eb.getImageData(0,0,2,2);ib=mc.data;Eb=document.createElement("canvas");Eb.width=Eb.height=a;Ra=Eb.getContext("2d");Ra.translate(-a/2,-a/2);Ra.scale(a,a);a--;this.domElement=m;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.setSize=function(a,b){p=a;n=b;r=
Math.floor(p/2);s=Math.floor(n/2);m.width=p;m.height=n;tb.set(-r,-s,r,s);Sa.set(-r,-s,r,s);E=1;y=0;v=z=A=G=q=null};this.setClearColor=function(a,b){t.copy(a);u=void 0!==b?b:1;Sa.set(-r,-s,r,s)};this.setClearColorHex=function(a,b){t.setHex(a);u=void 0!==b?b:1;Sa.set(-r,-s,r,s)};this.getMaxAnisotropy=function(){return 0};this.clear=function(){l.setTransform(1,0,0,-1,r,s);!1===Sa.isEmpty()&&(Sa.minSelf(tb),Sa.inflate(2),1>u&&l.clearRect(Math.floor(Sa.getX()),Math.floor(Sa.getY()),Math.floor(Sa.getWidth()),
...
c.g+=g.g*k,c.b+=g.b*k)}else f instanceof THREE.PointLight&&(h=f.matrixWorld.getPosition(),k=b.dot(Ea.sub(h,a).normalize()),0>=k||(k*=0==f.distance?1:1-Math.min(a.distanceTo(h)/f.distance,1),0!=k&&(k*=f.intensity,c.r+=g.r*k,c.g+=g.g*k,c.b+=g.b*k)))}}function n(a,d,e,g,h,i,j,l){f.info.render.vertices+=3;f.info.render.faces++;b(l.opacity);c(l.blending);C=a.positionScreen.x;L=a.positionScreen.y;K=d.positionScreen.x;U=d.positionScreen.y;O=e.positionScreen.x;$=e.positionScreen.y;p(C,L,K,U,O,$);(l instanceof
THREE.MeshLambertMaterial||l instanceof THREE.MeshPhongMaterial)&&null===l.map&&null===l.map?(Y.copy(l.color),ga.copy(l.emissive),l.vertexColors===THREE.FaceColors&&(Y.r*=j.color.r,Y.g*=j.color.g,Y.b*=j.color.b),!0===xb?!1===l.wireframe&&l.shading==THREE.SmoothShading&&3==j.vertexNormalsLength?(ba.r=da.r=P.r=Na.r,ba.g=da.g=P.g=Na.g,ba.b=da.b=P.b=Na.b,k(j.v1.positionWorld,j.vertexNormalsWorld[0],ba),k(j.v2.positionWorld,j.vertexNormalsWorld[1],da),k(j.v3.positionWorld,j.vertexNormalsWorld[2],P),ba.r=
ba.r*Y.r+ga.r,ba.g=ba.g*Y.g+ga.g,ba.b=ba.b*Y.b+ga.b,da.r=da.r*Y.r+ga.r,da.g=da.g*Y.g+ga.g,da.b=da.b*Y.b+ga.b,P.r=P.r*Y.r+ga.r,P.g=P.g*Y.g+ga.g,P.b=P.b*Y.b+ga.b,ja.r=0.5*(da.r+P.r),ja.g=0.5*(da.g+P.g),ja.b=0.5*(da.b+P.b),ea=G(ba,da,P,ja),E(C,L,K,U,O,$,0,0,1,0,0,1,ea)):(R.r=Na.r,R.g=Na.g,R.b=Na.b,k(j.centroidWorld,j.normalWorld,R),R.r=R.r*Y.r+ga.r,R.g=R.g*Y.g+ga.g,R.b=R.b*Y.b+ga.b,!0===l.wireframe?t(R,l.wireframeLinewidth,l.wireframeLinecap,l.wireframeLinejoin):u(R)):!0===l.wireframe?t(l.color,l.wireframeLinewidth,
l.wireframeLinecap,l.wireframeLinejoin):u(l.color)):l instanceof THREE.MeshBasicMaterial||l instanceof THREE.MeshLambertMaterial||l instanceof THREE.MeshPhongMaterial?null!==l.map?l.map.mapping instanceof THREE.UVMapping&&(Ha=j.uvs[0],y(C,L,K,U,O,$,Ha[g].x,Ha[g].y,Ha[h].x,Ha[h].y,Ha[i].x,Ha[i].y,l.map)):null!==l.envMap?l.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(a=m.matrixWorldInverse,Ea.copy(j.vertexNormalsWorld[g]),gb=0.5*(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])+
0.5,vb=0.5*(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])+0.5,Ea.copy(j.vertexNormalsWorld[h]),qb=0.5*(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])+0.5,ub=0.5*(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])+0.5,Ea.copy(j.vertexNormalsWorld[i]),Kb=0.5*(Ea.x*a.elements[0]+Ea.y*a.elements[4]+Ea.z*a.elements[8])+0.5,Lb=0.5*(Ea.x*a.elements[1]+Ea.y*a.elements[5]+Ea.z*a.elements[9])+0.5,y(C,L,K,U,O,$,gb,vb,qb,ub,Kb,Lb,l.envMap)):(R.copy(l.color),l.vertexColors===THREE.FaceColors&&
(R.r*=j.color.r,R.g*=j.color.g,R.b*=j.color.b),!0===l.wireframe?t(R,l.wireframeLinewidth,l.wireframeLinecap,l.wireframeLinejoin):u(R)):l instanceof THREE.MeshDepthMaterial?(ta=m.near,Da=m.far,ba.r=ba.g=ba.b=1-jb(a.positionScreen.z,ta,Da),da.r=da.g=da.b=1-jb(d.positionScreen.z,ta,Da),P.r=P.g=P.b=1-jb(e.positionScreen.z,ta,Da),ja.r=0.5*(da.r+P.r),ja.g=0.5*(da.g+P.g),ja.b=0.5*(da.b+P.b),ea=G(ba,da,P,ja),E(C,L,K,U,O,$,0,0,1,0,0,1,ea)):l instanceof THREE.MeshNormalMaterial&&(R.r=zc(j.normalWorld.x),R.g=
zc(j.normalWorld.y),R.b=zc(j.normalWorld.z),!0===l.wireframe?t(R,l.wireframeLinewidth,l.wireframeLinecap,l.wireframeLinejoin):u(R))}function p(a,b,c,d,e,f){l.beginPath();l.moveTo(a,b);l.lineTo(c,d);l.lineTo(e,f);l.closePath()}function q(a,b,c,d,e,f,g,h){l.beginPath();l.moveTo(a,b);l.lineTo(c,d);l.lineTo(e,f);l.lineTo(g,h);l.closePath()}function t(a,b,c,e){A!==b&&(A=l.lineWidth=b);z!==c&&(z=l.lineCap=c);v!==e&&(v=l.lineJoin=e);d(a.getStyle());l.stroke();ma.inflate(2*b)}function u(a){e(a.getStyle());
l.fill()}function y(a,b,c,d,f,g,h,k,i,j,m,jb,n){if(!(n instanceof THREE.DataTexture||void 0===n.image||0==n.image.width)){if(!0===n.needsUpdate){var p=n.wrapS==THREE.RepeatWrapping,lb=n.wrapT==THREE.RepeatWrapping;Ca[n.id]=l.createPattern(n.image,!0===p&&!0===lb?"repeat":!0===p&&!1===lb?"repeat-x":!1===p&&!0===lb?"repeat-y":"no-repeat");n.needsUpdate=!1}void 0===Ca[n.id]?e("rgba(0,0,0,1)"):e(Ca[n.id]);var p=n.offset.x/n.repeat.x,lb=n.offset.y/n.repeat.y,r=n.image.width*n.repeat.x,s=n.image.height*
n.repeat.y,h=(h+p)*r,k=(1-k+lb)*s,c=c-a,d=d-b,f=f-a,g=g-b,i=(i+p)*r-h,j=(1-j+lb)*s-k,m=(m+p)*r-h,jb=(1-jb+lb)*s-k,p=i*jb-m*j;0===p?(void 0===Va[n.id]&&(b=document.createElement("canvas"),b.width=n.image.width,b.height=n.image.height,b=b.getContext("2d"),b.drawImage(n.image,0,0),Va[n.id]=b.getImageData(0,0,n.image.width,n.image.height).data),b=Va[n.id],h=4*(Math.floor(h)+Math.floor(k)*n.image.width),R.setRGB(b[h]/255,b[h+1]/255,b[h+2]/255),u(R)):(p=1/p,n=(jb*c-j*f)*p,j=(jb*d-j*g)*p,c=(i*f-m*c)*p,d=
...
else{var nc,Uc,oa,aa;!0===this.autoClear?this.clear():l.setTransform(1,0,0,-1,r,s);f.info.render.vertices=0;f.info.render.faces=0;g=j.projectScene(a,m,this.sortObjects,this.sortElements);h=g.elements;i=g.lights;xb=0<i.length;if(!0===xb){Na.setRGB(0,0,0);kb.setRGB(0,0,0);hb.setRGB(0,0,0);nc=0;for(Uc=i.length;nc<Uc;nc++){aa=i[nc];var pa=aa.color;aa instanceof THREE.AmbientLight?(Na.r+=pa.r,Na.g+=pa.g,Na.b+=pa.b):aa instanceof THREE.DirectionalLight?(kb.r+=pa.r,kb.g+=pa.g,kb.b+=pa.b):aa instanceof THREE.PointLight&&
(hb.r+=pa.r,hb.g+=pa.g,hb.b+=pa.b)}}nc=0;for(Uc=h.length;nc<Uc;nc++)if(oa=h[nc],aa=oa.material,!(void 0===aa||!1===aa.visible)){ma.empty();if(oa instanceof THREE.RenderableParticle){I=oa;I.x*=r;I.y*=s;var pa=I,db=oa;b(aa.opacity);c(aa.blending);var Gb=void 0,Hb=void 0,yb=void 0,zb=void 0,Ac=oa=void 0,md=void 0;aa instanceof THREE.ParticleBasicMaterial?null===aa.map?(yb=db.object.scale.x,zb=db.object.scale.y,yb*=db.scale.x*r,zb*=db.scale.y*s,ma.set(pa.x-yb,pa.y-zb,pa.x+yb,pa.y+zb),!1!==tb.intersects(ma)&&
(e(aa.color.getStyle()),l.save(),l.translate(pa.x,pa.y),l.rotate(-db.rotation),l.scale(yb,zb),l.fillRect(-1,-1,2,2),l.restore())):(oa=aa.map.image,Ac=oa.width>>1,md=oa.height>>1,yb=db.scale.x*r,zb=db.scale.y*s,Gb=yb*Ac,Hb=zb*md,ma.set(pa.x-Gb,pa.y-Hb,pa.x+Gb,pa.y+Hb),!1!==tb.intersects(ma)&&(l.save(),l.translate(pa.x,pa.y),l.rotate(-db.rotation),l.scale(yb,-zb),l.translate(-Ac,-md),l.drawImage(oa,0,0),l.restore())):aa instanceof THREE.ParticleCanvasMaterial&&(Gb=db.scale.x*r,Hb=db.scale.y*s,ma.set(pa.x-
Gb,pa.y-Hb,pa.x+Gb,pa.y+Hb),!1!==tb.intersects(ma)&&(d(aa.color.getStyle()),e(aa.color.getStyle()),l.save(),l.translate(pa.x,pa.y),l.rotate(-db.rotation),l.scale(Gb,Hb),aa.program(l),l.restore()))}else oa instanceof THREE.RenderableLine?(I=oa.v1,D=oa.v2,I.positionScreen.x*=r,I.positionScreen.y*=s,D.positionScreen.x*=r,D.positionScreen.y*=s,ma.addPoint(I.positionScreen.x,I.positionScreen.y),ma.addPoint(D.positionScreen.x,D.positionScreen.y),!0===tb.intersects(ma)&&(pa=I,db=D,b(aa.opacity),c(aa.blending),
l.beginPath(),l.moveTo(pa.positionScreen.x,pa.positionScreen.y),l.lineTo(db.positionScreen.x,db.positionScreen.y),aa instanceof THREE.LineBasicMaterial&&(pa=aa.linewidth,A!==pa&&(A=l.lineWidth=pa),pa=aa.linecap,z!==pa&&(z=l.lineCap=pa),pa=aa.linejoin,v!==pa&&(v=l.lineJoin=pa),d(aa.color.getStyle()),l.stroke(),ma.inflate(2*aa.linewidth)))):oa instanceof THREE.RenderableFace3?(I=oa.v1,D=oa.v2,F=oa.v3,I.positionScreen.x*=r,I.positionScreen.y*=s,D.positionScreen.x*=r,D.positionScreen.y*=s,F.positionScreen.x*=
r,F.positionScreen.y*=s,!0===aa.overdraw&&(lb(I.positionScreen,D.positionScreen),lb(D.positionScreen,F.positionScreen),lb(F.positionScreen,I.positionScreen)),ma.add3Points(I.positionScreen.x,I.positionScreen.y,D.positionScreen.x,D.positionScreen.y,F.positionScreen.x,F.positionScreen.y),!0===tb.intersects(ma)&&n(I,D,F,0,1,2,oa,aa,a)):oa instanceof THREE.RenderableFace4&&(I=oa.v1,D=oa.v2,F=oa.v3,M=oa.v4,I.positionScreen.x*=r,I.positionScreen.y*=s,D.positionScreen.x*=r,D.positionScreen.y*=s,F.positionScreen.x*=
r,F.positionScreen.y*=s,M.positionScreen.x*=r,M.positionScreen.y*=s,B.positionScreen.copy(D.positionScreen),J.positionScreen.copy(M.positionScreen),!0===aa.overdraw&&(lb(I.positionScreen,D.positionScreen),lb(D.positionScreen,M.positionScreen),lb(M.positionScreen,I.positionScreen),lb(F.positionScreen,B.positionScreen),lb(F.positionScreen,J.positionScreen)),ma.addPoint(I.positionScreen.x,I.positionScreen.y),ma.addPoint(D.positionScreen.x,D.positionScreen.y),ma.addPoint(F.positionScreen.x,F.positionScreen.y),
ma.addPoint(M.positionScreen.x,M.positionScreen.y),!0===tb.intersects(ma)&&(pa=I,db=D,Gb=F,Hb=M,yb=B,zb=J,Ac=a,f.info.render.vertices+=4,f.info.render.faces++,b(aa.opacity),c(aa.blending),void 0!==aa.map&&null!==aa.map||void 0!==aa.envMap&&null!==aa.envMap?(n(pa,db,Hb,0,1,3,oa,aa,Ac),n(yb,Gb,zb,1,2,3,oa,aa,Ac)):(C=pa.positionScreen.x,L=pa.positionScreen.y,K=db.positionScreen.x,U=db.positionScreen.y,O=Gb.positionScreen.x,$=Gb.positionScreen.y,wa=Hb.positionScreen.x,N=Hb.positionScreen.y,na=yb.positionScreen.x,
la=yb.positionScreen.y,Ma=zb.positionScreen.x,Q=zb.positionScreen.y,aa instanceof THREE.MeshLambertMaterial||aa instanceof THREE.MeshPhongMaterial?(Y.copy(aa.color),ga.copy(aa.emissive),aa.vertexColors===THREE.FaceColors&&(Y.r*=oa.color.r,Y.g*=oa.color.g,Y.b*=oa.color.b),!0===xb?!1===aa.wireframe&&aa.shading==THREE.SmoothShading&&4==oa.vertexNormalsLength?(ba.r=da.r=P.r=ja.r=Na.r,ba.g=da.g=P.g=ja.g=Na.g,ba.b=da.b=P.b=ja.b=Na.b,k(oa.v1.positionWorld,oa.vertexNormalsWorld[0],ba),k(oa.v2.positionWorld,
oa.vertexNormalsWorld[1],da),k(oa.v4.positionWorld,oa.vertexNormalsWorld[3],P),k(oa.v3.positionWorld,oa.vertexNormalsWorld[2],ja),ba.r=ba.r*Y.r+ga.r,ba.g=ba.g*Y.g+ga.g,ba.b=ba.b*Y.b+ga.b,da.r=da.r*Y.r+ga.r,da.g=da.g*Y.g+ga.g,da.b=da.b*Y.b+ga.b,P.r=P.r*Y.r+ga.r,P.g=P.g*Y.g+ga.g,P.b=P.b*Y.b+ga.b,ja.r=ja.r*Y.r+ga.r,ja.g=ja.g*Y.g+ga.g,ja.b=ja.b*Y.b+ga.b,ea=G(ba,da,P,ja),p(C,L,K,U,wa,N),E(C,L,K,U,wa,N,0,0,1,0,0,1,ea),p(na,la,O,$,Ma,Q),E(na,la,O,$,Ma,Q,1,0,1,1,0,1,ea)):(R.r=Na.r,R.g=Na.g,R.b=Na.b,k(oa.centroidWorld,
oa.normalWorld,R),R.r=R.r*Y.r+ga.r,R.g=R.g*Y.g+ga.g,R.b=R.b*Y.b+ga.b,q(C,L,K,U,O,$,wa,N),!0===aa.wireframe?t(R,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(R)):(R.r=Y.r+ga.r,R.g=Y.g+ga.g,R.b=Y.b+ga.b,q(C,L,K,U,O,$,wa,N),!0===aa.wireframe?t(R,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(R))):aa instanceof THREE.MeshBasicMaterial?(R.copy(aa.color),aa.vertexColors===THREE.FaceColors&&(R.r*=oa.color.r,R.g*=oa.color.g,R.b*=oa.color.b),q(C,L,K,U,O,$,wa,N),!0===
aa.wireframe?t(R,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(R)):aa instanceof THREE.MeshNormalMaterial?(R.r=zc(oa.normalWorld.x),R.g=zc(oa.normalWorld.y),R.b=zc(oa.normalWorld.z),q(C,L,K,U,O,$,wa,N),!0===aa.wireframe?t(R,aa.wireframeLinewidth,aa.wireframeLinecap,aa.wireframeLinejoin):u(R)):aa instanceof THREE.MeshDepthMaterial&&(ta=m.near,Da=m.far,ba.r=ba.g=ba.b=1-jb(pa.positionScreen.z,ta,Da),da.r=da.g=da.b=1-jb(db.positionScreen.z,ta,Da),P.r=P.g=P.b=1-jb(Hb.positionScreen.z,
ta,Da),ja.r=ja.g=ja.b=1-jb(Gb.positionScreen.z,ta,Da),ea=G(ba,da,P,ja),p(C,L,K,U,wa,N),E(C,L,K,U,wa,N,0,0,1,0,0,1,ea),p(na,la,O,$,Ma,Q),E(na,la,O,$,Ma,Q,1,0,1,1,0,1,ea)))));Sa.addRectangle(ma)}l.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
function u(a){for(var b in a.attributes)if(a.attributes[b].needsUpdate)return!0;return!1}function E(a){for(var b in a.attributes)a.attributes[b].needsUpdate=!1}function y(a,b){for(var c=a.length-1;0<=c;c--)a[c].object===b&&a.splice(c,1)}function q(a,b){for(var c=a.length-1;0<=c;c--)a[c]===b&&a.splice(c,1)}function G(a,b,c,d,e){Va=0;d.needsUpdate&&(d.program&&Q.deallocateMaterial(d),Q.initMaterial(d,b,c,e),d.needsUpdate=!1);d.morphTargets&&!e.__webglMorphTargetInfluences&&(e.__webglMorphTargetInfluences=
...
c.color,c instanceof THREE.Fog?(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(wb){for(var m=0,n=0,l=0,p,r,s,q=Sc,t=q.directional.colors,u=q.directional.positions,y=q.point.colors,z=q.point.positions,D=q.point.distances,C=q.spot.colors,E=q.spot.positions,G=q.spot.distances,F=q.spot.directions,J=q.spot.anglesCos,R=q.spot.exponents,P=q.hemi.skyColors,
M=q.hemi.groundColors,N=q.hemi.positions,ba=0,Y=0,O=0,U=0,$=0,na=0,la=0,Ca=0,S=r=0,c=S=S=0,f=b.length;c<f;c++)j=b[c],j.onlyShadow||(p=j.color,s=j.intensity,r=j.distance,j instanceof THREE.AmbientLight?j.visible&&(Q.gammaInput?(m+=p.r*p.r,n+=p.g*p.g,l+=p.b*p.b):(m+=p.r,n+=p.g,l+=p.b)):j instanceof THREE.DirectionalLight?($+=1,j.visible&&(r=3*ba,Q.gammaInput?v(t,r,p,s*s):I(t,r,p,s),Ra.copy(j.matrixWorld.getPosition()),Ra.subSelf(j.target.matrixWorld.getPosition()),Ra.normalize(),u[r]=Ra.x,u[r+1]=Ra.y,
u[r+2]=Ra.z,ba+=1)):j instanceof THREE.PointLight?(na+=1,j.visible&&(S=3*Y,Q.gammaInput?v(y,S,p,s*s):I(y,S,p,s),s=j.matrixWorld.getPosition(),z[S]=s.x,z[S+1]=s.y,z[S+2]=s.z,D[Y]=r,Y+=1)):j instanceof THREE.SpotLight?(la+=1,j.visible&&(S=3*O,Q.gammaInput?v(C,S,p,s*s):I(C,S,p,s),s=j.matrixWorld.getPosition(),E[S]=s.x,E[S+1]=s.y,E[S+2]=s.z,G[O]=r,Ra.copy(s),Ra.subSelf(j.target.matrixWorld.getPosition()),Ra.normalize(),F[S]=Ra.x,F[S+1]=Ra.y,F[S+2]=Ra.z,J[O]=Math.cos(j.angle),R[O]=j.exponent,O+=1)):j instanceof
THREE.HemisphereLight&&(Ca+=1,j.visible&&(p=j.color,r=j.groundColor,S=3*U,Q.gammaInput?(s*=s,v(P,S,p,s),v(M,S,r,s)):(I(P,S,p,s),I(M,S,r,s)),Ra.copy(j.matrixWorld.getPosition()),Ra.normalize(),N[S]=Ra.x,N[S+1]=Ra.y,N[S+2]=Ra.z,U+=1)));c=3*ba;for(f=Math.max(t.length,3*$);c<f;c++)t[c]=0;c=3*ba;for(f=Math.max(u.length,3*$);c<f;c++)u[c]=0;c=3*Y;for(f=Math.max(y.length,3*na);c<f;c++)y[c]=0;c=3*Y;for(f=Math.max(z.length,3*na);c<f;c++)z[c]=0;c=Y;for(f=Math.max(D.length,na);c<f;c++)D[c]=0;c=3*O;for(f=Math.max(C.length,
3*la);c<f;c++)C[c]=0;c=3*O;for(f=Math.max(E.length,3*la);c<f;c++)E[c]=0;c=3*O;for(f=Math.max(F.length,3*la);c<f;c++)F[c]=0;c=O;for(f=Math.max(J.length,la);c<f;c++)J[c]=0;c=O;for(f=Math.max(R.length,la);c<f;c++)R[c]=0;c=O;for(f=Math.max(G.length,la);c<f;c++)G[c]=0;c=3*U;for(f=Math.max(P.length,3*Ca);c<f;c++)P[c]=0;c=3*U;for(f=Math.max(M.length,3*Ca);c<f;c++)M[c]=0;c=3*U;for(f=Math.max(N.length,3*Ca);c<f;c++)N[c]=0;q.directional.length=ba;q.point.length=Y;q.spot.length=O;q.hemi.length=U;q.ambient[0]=
m;q.ambient[1]=n;q.ambient[2]=l;wb=!1}c=Sc;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;i.spotLightDistance.value=c.spot.distances;i.spotLightDirection.value=c.spot.directions;i.spotLightAngleCos.value=
...
this.shadowMapCascade=this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var Q=this,R=[],ba=0,da=null,P=null,ja=-1,Y=null,ga=null,Ca=0,Va=0,ta=-1,Da=-1,ea=-1,Ha=-1,gb=-1,vb=-1,qb=-1,ub=-1,Kb=null,Lb=null,tb=null,Sa=null,ma=0,xb=0,Na=0,kb=0,hb=0,Ea=0,ab={},eb=new THREE.Frustum,mc=new THREE.Matrix4,ib=new THREE.Matrix4,
Eb=new THREE.Vector3,Ra=new THREE.Vector3,wb=!0,Sc={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Fb,rb;try{if(!(k=K.getContext("experimental-webgl",{alpha:O,premultipliedAlpha:$,antialias:wa,stencil:N,preserveDrawingBuffer:na})))throw"Error creating WebGL context.";}catch(ld){console.error(ld)}a=
...
s.geometryGroups[C].faces3.push(v):s.geometryGroups[C].faces4.push(v),s.geometryGroups[C].vertices+=D;s.geometryGroupsList=[];var R=void 0;for(R in s.geometryGroups)s.geometryGroups[R].id=Ca++,s.geometryGroupsList.push(s.geometryGroups[R])}for(m in l.geometryGroups)if(r=l.geometryGroups[m],!r.__webglVertexBuffer){var P=r;P.__webglVertexBuffer=k.createBuffer();P.__webglNormalBuffer=k.createBuffer();P.__webglTangentBuffer=k.createBuffer();P.__webglColorBuffer=k.createBuffer();P.__webglUVBuffer=k.createBuffer();
...
THREE.LensFlare?q(Ma.__webglFlares,$):($ instanceof THREE.ImmediateRenderObject||$.immediateRenderCallback)&&y(Ma.__webglObjectsImmediate,$);$.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var wa=0,Va=a.__webglObjects.length;wa<Va;wa++){var ta=a.__webglObjects[wa].object,S=ta.geometry,Ea=void 0,Da=void 0,ma=void 0;if(ta instanceof THREE.Mesh)if(S instanceof THREE.BufferGeometry)(S.verticesNeedUpdate||S.elementsNeedUpdate||S.uvsNeedUpdate||S.normalsNeedUpdate||S.colorsNeedUpdate||S.tangentsNeedUpdate)&&
i(S,k.DYNAMIC_DRAW,!S.dynamic),S.verticesNeedUpdate=!1,S.elementsNeedUpdate=!1,S.uvsNeedUpdate=!1,S.normalsNeedUpdate=!1,S.colorsNeedUpdate=!1,S.tangentsNeedUpdate=!1;else{for(var Na=0,Ra=S.geometryGroupsList.length;Na<Ra;Na++)if(Ea=S.geometryGroupsList[Na],ma=e(ta,Ea),S.buffersNeedUpdate&&d(Ea,ta),Da=ma.attributes&&u(ma),S.verticesNeedUpdate||S.morphTargetsNeedUpdate||S.elementsNeedUpdate||S.uvsNeedUpdate||S.normalsNeedUpdate||S.colorsNeedUpdate||S.tangentsNeedUpdate||Da){var sa=Ea,Sa=ta,Ha=k.DYNAMIC_DRAW,
vb=!S.dynamic,gb=ma;if(sa.__inittedArrays){var tb=f(gb),qb=gb.vertexColors?gb.vertexColors:!1,ub=g(gb),kb=tb===THREE.SmoothShading,H=void 0,Z=void 0,ab=void 0,T=void 0,hb=void 0,eb=void 0,Mb=void 0,xb=void 0,gc=void 0,rb=void 0,wb=void 0,V=void 0,W=void 0,X=void 0,ra=void 0,Nb=void 0,Ob=void 0,Pb=void 0,Fb=void 0,Qb=void 0,Rb=void 0,Sb=void 0,Kb=void 0,Tb=void 0,Ub=void 0,Vb=void 0,Lb=void 0,Wb=void 0,Xb=void 0,Yb=void 0,Hc=void 0,Zb=void 0,$b=void 0,ac=void 0,Ic=void 0,xa=void 0,xc=void 0,oc=void 0,
Bc=void 0,Cc=void 0,Wa=void 0,yc=void 0,Ta=void 0,Ua=void 0,pc=void 0,hc=void 0,Oa=0,Qa=0,ic=0,jc=0,Ab=0,bb=0,Aa=0,fb=0,Pa=0,fa=0,ka=0,x=0,ya=void 0,Xa=sa.__vertexArray,Jc=sa.__uvArray,Kc=sa.__uv2Array,Bb=sa.__normalArray,Ia=sa.__tangentArray,Ya=sa.__colorArray,Ja=sa.__skinIndexArray,Ka=sa.__skinWeightArray,nd=sa.__morphTargetsArrays,od=sa.__morphNormalsArrays,pd=sa.__webglCustomAttributesList,w=void 0,bc=sa.__faceArray,sb=sa.__lineArray,mb=Sa.geometry,Sc=mb.elementsNeedUpdate,Gc=mb.uvsNeedUpdate,
Tc=mb.normalsNeedUpdate,kd=mb.tangentsNeedUpdate,ld=mb.colorsNeedUpdate,Jd=mb.morphTargetsNeedUpdate,tc=mb.vertices,ua=sa.faces3,va=sa.faces4,cb=mb.faces,qd=mb.faceVertexUvs[0],rd=mb.faceVertexUvs[1],uc=mb.skinIndices,qc=mb.skinWeights,rc=mb.morphTargets,Vc=mb.morphNormals;if(mb.verticesNeedUpdate){H=0;for(Z=ua.length;H<Z;H++)T=cb[ua[H]],V=tc[T.a],W=tc[T.b],X=tc[T.c],Xa[Qa]=V.x,Xa[Qa+1]=V.y,Xa[Qa+2]=V.z,Xa[Qa+3]=W.x,Xa[Qa+4]=W.y,Xa[Qa+5]=W.z,Xa[Qa+6]=X.x,Xa[Qa+7]=X.y,Xa[Qa+8]=X.z,Qa+=9;H=0;for(Z=
va.length;H<Z;H++)T=cb[va[H]],V=tc[T.a],W=tc[T.b],X=tc[T.c],ra=tc[T.d],Xa[Qa]=V.x,Xa[Qa+1]=V.y,Xa[Qa+2]=V.z,Xa[Qa+3]=W.x,Xa[Qa+4]=W.y,Xa[Qa+5]=W.z,Xa[Qa+6]=X.x,Xa[Qa+7]=X.y,Xa[Qa+8]=X.z,Xa[Qa+9]=ra.x,Xa[Qa+10]=ra.y,Xa[Qa+11]=ra.z,Qa+=12;k.bindBuffer(k.ARRAY_BUFFER,sa.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Xa,Ha)}if(Jd){Wa=0;for(yc=rc.length;Wa<yc;Wa++){H=ka=0;for(Z=ua.length;H<Z;H++)pc=ua[H],T=cb[pc],V=rc[Wa].vertices[T.a],W=rc[Wa].vertices[T.b],X=rc[Wa].vertices[T.c],Ta=nd[Wa],Ta[ka]=V.x,
Ta[ka+1]=V.y,Ta[ka+2]=V.z,Ta[ka+3]=W.x,Ta[ka+4]=W.y,Ta[ka+5]=W.z,Ta[ka+6]=X.x,Ta[ka+7]=X.y,Ta[ka+8]=X.z,gb.morphNormals&&(kb?(hc=Vc[Wa].vertexNormals[pc],Qb=hc.a,Rb=hc.b,Sb=hc.c):Sb=Rb=Qb=Vc[Wa].faceNormals[pc],Ua=od[Wa],Ua[ka]=Qb.x,Ua[ka+1]=Qb.y,Ua[ka+2]=Qb.z,Ua[ka+3]=Rb.x,Ua[ka+4]=Rb.y,Ua[ka+5]=Rb.z,Ua[ka+6]=Sb.x,Ua[ka+7]=Sb.y,Ua[ka+8]=Sb.z),ka+=9;H=0;for(Z=va.length;H<Z;H++)pc=va[H],T=cb[pc],V=rc[Wa].vertices[T.a],W=rc[Wa].vertices[T.b],X=rc[Wa].vertices[T.c],ra=rc[Wa].vertices[T.d],Ta=nd[Wa],
Ta[ka]=V.x,Ta[ka+1]=V.y,Ta[ka+2]=V.z,Ta[ka+3]=W.x,Ta[ka+4]=W.y,Ta[ka+5]=W.z,Ta[ka+6]=X.x,Ta[ka+7]=X.y,Ta[ka+8]=X.z,Ta[ka+9]=ra.x,Ta[ka+10]=ra.y,Ta[ka+11]=ra.z,gb.morphNormals&&(kb?(hc=Vc[Wa].vertexNormals[pc],Qb=hc.a,Rb=hc.b,Sb=hc.c,Kb=hc.d):Kb=Sb=Rb=Qb=Vc[Wa].faceNormals[pc],Ua=od[Wa],Ua[ka]=Qb.x,Ua[ka+1]=Qb.y,Ua[ka+2]=Qb.z,Ua[ka+3]=Rb.x,Ua[ka+4]=Rb.y,Ua[ka+5]=Rb.z,Ua[ka+6]=Sb.x,Ua[ka+7]=Sb.y,Ua[ka+8]=Sb.z,Ua[ka+9]=Kb.x,Ua[ka+10]=Kb.y,Ua[ka+11]=Kb.z),ka+=12;k.bindBuffer(k.ARRAY_BUFFER,sa.__webglMorphTargetsBuffers[Wa]);
k.bufferData(k.ARRAY_BUFFER,nd[Wa],Ha);gb.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,sa.__webglMorphNormalsBuffers[Wa]),k.bufferData(k.ARRAY_BUFFER,od[Wa],Ha))}}if(qc.length){H=0;for(Z=ua.length;H<Z;H++)T=cb[ua[H]],Wb=qc[T.a],Xb=qc[T.b],Yb=qc[T.c],Ka[fa]=Wb.x,Ka[fa+1]=Wb.y,Ka[fa+2]=Wb.z,Ka[fa+3]=Wb.w,Ka[fa+4]=Xb.x,Ka[fa+5]=Xb.y,Ka[fa+6]=Xb.z,Ka[fa+7]=Xb.w,Ka[fa+8]=Yb.x,Ka[fa+9]=Yb.y,Ka[fa+10]=Yb.z,Ka[fa+11]=Yb.w,Zb=uc[T.a],$b=uc[T.b],ac=uc[T.c],Ja[fa]=Zb.x,Ja[fa+1]=Zb.y,Ja[fa+2]=Zb.z,Ja[fa+3]=Zb.w,
Ja[fa+4]=$b.x,Ja[fa+5]=$b.y,Ja[fa+6]=$b.z,Ja[fa+7]=$b.w,Ja[fa+8]=ac.x,Ja[fa+9]=ac.y,Ja[fa+10]=ac.z,Ja[fa+11]=ac.w,fa+=12;H=0;for(Z=va.length;H<Z;H++)T=cb[va[H]],Wb=qc[T.a],Xb=qc[T.b],Yb=qc[T.c],Hc=qc[T.d],Ka[fa]=Wb.x,Ka[fa+1]=Wb.y,Ka[fa+2]=Wb.z,Ka[fa+3]=Wb.w,Ka[fa+4]=Xb.x,Ka[fa+5]=Xb.y,Ka[fa+6]=Xb.z,Ka[fa+7]=Xb.w,Ka[fa+8]=Yb.x,Ka[fa+9]=Yb.y,Ka[fa+10]=Yb.z,Ka[fa+11]=Yb.w,Ka[fa+12]=Hc.x,Ka[fa+13]=Hc.y,Ka[fa+14]=Hc.z,Ka[fa+15]=Hc.w,Zb=uc[T.a],$b=uc[T.b],ac=uc[T.c],Ic=uc[T.d],Ja[fa]=Zb.x,Ja[fa+1]=Zb.y,
Ja[fa+2]=Zb.z,Ja[fa+3]=Zb.w,Ja[fa+4]=$b.x,Ja[fa+5]=$b.y,Ja[fa+6]=$b.z,Ja[fa+7]=$b.w,Ja[fa+8]=ac.x,Ja[fa+9]=ac.y,Ja[fa+10]=ac.z,Ja[fa+11]=ac.w,Ja[fa+12]=Ic.x,Ja[fa+13]=Ic.y,Ja[fa+14]=Ic.z,Ja[fa+15]=Ic.w,fa+=16;0<fa&&(k.bindBuffer(k.ARRAY_BUFFER,sa.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ja,Ha),k.bindBuffer(k.ARRAY_BUFFER,sa.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,Ka,Ha))}if(ld&&qb){H=0;for(Z=ua.length;H<Z;H++)T=cb[ua[H]],Mb=T.vertexColors,xb=T.color,3===Mb.length&&qb===
THREE.VertexColors?(Tb=Mb[0],Ub=Mb[1],Vb=Mb[2]):Vb=Ub=Tb=xb,Ya[Pa]=Tb.r,Ya[Pa+1]=Tb.g,Ya[Pa+2]=Tb.b,Ya[Pa+3]=Ub.r,Ya[Pa+4]=Ub.g,Ya[Pa+5]=Ub.b,Ya[Pa+6]=Vb.r,Ya[Pa+7]=Vb.g,Ya[Pa+8]=Vb.b,Pa+=9;H=0;for(Z=va.length;H<Z;H++)T=cb[va[H]],Mb=T.vertexColors,xb=T.color,4===Mb.length&&qb===THREE.VertexColors?(Tb=Mb[0],Ub=Mb[1],Vb=Mb[2],Lb=Mb[3]):Lb=Vb=Ub=Tb=xb,Ya[Pa]=Tb.r,Ya[Pa+1]=Tb.g,Ya[Pa+2]=Tb.b,Ya[Pa+3]=Ub.r,Ya[Pa+4]=Ub.g,Ya[Pa+5]=Ub.b,Ya[Pa+6]=Vb.r,Ya[Pa+7]=Vb.g,Ya[Pa+8]=Vb.b,Ya[Pa+9]=Lb.r,Ya[Pa+10]=Lb.g,
Ya[Pa+11]=Lb.b,Pa+=12;0<Pa&&(k.bindBuffer(k.ARRAY_BUFFER,sa.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Ya,Ha))}if(kd&&mb.hasTangents){H=0;for(Z=ua.length;H<Z;H++)T=cb[ua[H]],gc=T.vertexTangents,Nb=gc[0],Ob=gc[1],Pb=gc[2],Ia[Aa]=Nb.x,Ia[Aa+1]=Nb.y,Ia[Aa+2]=Nb.z,Ia[Aa+3]=Nb.w,Ia[Aa+4]=Ob.x,Ia[Aa+5]=Ob.y,Ia[Aa+6]=Ob.z,Ia[Aa+7]=Ob.w,Ia[Aa+8]=Pb.x,Ia[Aa+9]=Pb.y,Ia[Aa+10]=Pb.z,Ia[Aa+11]=Pb.w,Aa+=12;H=0;for(Z=va.length;H<Z;H++)T=cb[va[H]],gc=T.vertexTangents,Nb=gc[0],Ob=gc[1],Pb=gc[2],Fb=gc[3],Ia[Aa]=
Nb.x,Ia[Aa+1]=Nb.y,Ia[Aa+2]=Nb.z,Ia[Aa+3]=Nb.w,Ia[Aa+4]=Ob.x,Ia[Aa+5]=Ob.y,Ia[Aa+6]=Ob.z,Ia[Aa+7]=Ob.w,Ia[Aa+8]=Pb.x,Ia[Aa+9]=Pb.y,Ia[Aa+10]=Pb.z,Ia[Aa+11]=Pb.w,Ia[Aa+12]=Fb.x,Ia[Aa+13]=Fb.y,Ia[Aa+14]=Fb.z,Ia[Aa+15]=Fb.w,Aa+=16;k.bindBuffer(k.ARRAY_BUFFER,sa.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Ia,Ha)}if(Tc&&tb){H=0;for(Z=ua.length;H<Z;H++)if(T=cb[ua[H]],hb=T.vertexNormals,eb=T.normal,3===hb.length&&kb)for(xa=0;3>xa;xa++)oc=hb[xa],Bb[bb]=oc.x,Bb[bb+1]=oc.y,Bb[bb+2]=oc.z,bb+=3;else for(xa=
0;3>xa;xa++)Bb[bb]=eb.x,Bb[bb+1]=eb.y,Bb[bb+2]=eb.z,bb+=3;H=0;for(Z=va.length;H<Z;H++)if(T=cb[va[H]],hb=T.vertexNormals,eb=T.normal,4===hb.length&&kb)for(xa=0;4>xa;xa++)oc=hb[xa],Bb[bb]=oc.x,Bb[bb+1]=oc.y,Bb[bb+2]=oc.z,bb+=3;else for(xa=0;4>xa;xa++)Bb[bb]=eb.x,Bb[bb+1]=eb.y,Bb[bb+2]=eb.z,bb+=3;k.bindBuffer(k.ARRAY_BUFFER,sa.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,Bb,Ha)}if(Gc&&qd&&ub){H=0;for(Z=ua.length;H<Z;H++)if(ab=ua[H],rb=qd[ab],void 0!==rb)for(xa=0;3>xa;xa++)Bc=rb[xa],Jc[ic]=Bc.x,Jc[ic+
1]=Bc.y,ic+=2;H=0;for(Z=va.length;H<Z;H++)if(ab=va[H],rb=qd[ab],void 0!==rb)for(xa=0;4>xa;xa++)Bc=rb[xa],Jc[ic]=Bc.x,Jc[ic+1]=Bc.y,ic+=2;0<ic&&(k.bindBuffer(k.ARRAY_BUFFER,sa.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,Jc,Ha))}if(Gc&&rd&&ub){H=0;for(Z=ua.length;H<Z;H++)if(ab=ua[H],wb=rd[ab],void 0!==wb)for(xa=0;3>xa;xa++)Cc=wb[xa],Kc[jc]=Cc.x,Kc[jc+1]=Cc.y,jc+=2;H=0;for(Z=va.length;H<Z;H++)if(ab=va[H],wb=rd[ab],void 0!==wb)for(xa=0;4>xa;xa++)Cc=wb[xa],Kc[jc]=Cc.x,Kc[jc+1]=Cc.y,jc+=2;0<jc&&(k.bindBuffer(k.ARRAY_BUFFER,
sa.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,Kc,Ha))}if(Sc){H=0;for(Z=ua.length;H<Z;H++)bc[Ab]=Oa,bc[Ab+1]=Oa+1,bc[Ab+2]=Oa+2,Ab+=3,sb[fb]=Oa,sb[fb+1]=Oa+1,sb[fb+2]=Oa,sb[fb+3]=Oa+2,sb[fb+4]=Oa+1,sb[fb+5]=Oa+2,fb+=6,Oa+=3;H=0;for(Z=va.length;H<Z;H++)bc[Ab]=Oa,bc[Ab+1]=Oa+1,bc[Ab+2]=Oa+3,bc[Ab+3]=Oa+1,bc[Ab+4]=Oa+2,bc[Ab+5]=Oa+3,Ab+=6,sb[fb]=Oa,sb[fb+1]=Oa+1,sb[fb+2]=Oa,sb[fb+3]=Oa+3,sb[fb+4]=Oa+1,sb[fb+5]=Oa+2,sb[fb+6]=Oa+2,sb[fb+7]=Oa+3,fb+=8,Oa+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,sa.__webglFaceBuffer);
k.bufferData(k.ELEMENT_ARRAY_BUFFER,bc,Ha);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,sa.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,sb,Ha)}if(pd){xa=0;for(xc=pd.length;xa<xc;xa++)if(w=pd[xa],w.__original.needsUpdate){x=0;if(1===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)T=cb[ua[H]],w.array[x]=w.value[T.a],w.array[x+1]=w.value[T.b],w.array[x+2]=w.value[T.c],x+=3;H=0;for(Z=va.length;H<Z;H++)T=cb[va[H]],w.array[x]=w.value[T.a],w.array[x+1]=w.value[T.b],w.array[x+
2]=w.value[T.c],w.array[x+3]=w.value[T.d],x+=4}else{if("faces"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)ya=w.value[ua[H]],w.array[x]=ya,w.array[x+1]=ya,w.array[x+2]=ya,x+=3;H=0;for(Z=va.length;H<Z;H++)ya=w.value[va[H]],w.array[x]=ya,w.array[x+1]=ya,w.array[x+2]=ya,w.array[x+3]=ya,x+=4}}else if(2===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)T=cb[ua[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=W.x,w.array[x+3]=W.y,
w.array[x+4]=X.x,w.array[x+5]=X.y,x+=6;H=0;for(Z=va.length;H<Z;H++)T=cb[va[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],ra=w.value[T.d],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=W.x,w.array[x+3]=W.y,w.array[x+4]=X.x,w.array[x+5]=X.y,w.array[x+6]=ra.x,w.array[x+7]=ra.y,x+=8}else{if("faces"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)X=W=V=ya=w.value[ua[H]],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=W.x,w.array[x+3]=W.y,w.array[x+4]=X.x,w.array[x+5]=X.y,x+=6;H=0;for(Z=va.length;H<Z;H++)ra=X=W=
V=ya=w.value[va[H]],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=W.x,w.array[x+3]=W.y,w.array[x+4]=X.x,w.array[x+5]=X.y,w.array[x+6]=ra.x,w.array[x+7]=ra.y,x+=8}}else if(3===w.size){var ca;ca="c"===w.type?["r","g","b"]:["x","y","z"];if(void 0===w.boundTo||"vertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)T=cb[ua[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+
6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],x+=9;H=0;for(Z=va.length;H<Z;H++)T=cb[va[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],ra=w.value[T.d],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],w.array[x+9]=ra[ca[0]],w.array[x+10]=ra[ca[1]],w.array[x+11]=ra[ca[2]],x+=12}else if("faces"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)X=W=V=ya=
w.value[ua[H]],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],x+=9;H=0;for(Z=va.length;H<Z;H++)ra=X=W=V=ya=w.value[va[H]],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],w.array[x+9]=ra[ca[0]],w.array[x+10]=
ra[ca[1]],w.array[x+11]=ra[ca[2]],x+=12}else if("faceVertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)ya=w.value[ua[H]],V=ya[0],W=ya[1],X=ya[2],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],x+=9;H=0;for(Z=va.length;H<Z;H++)ya=w.value[va[H]],V=ya[0],W=ya[1],X=ya[2],ra=ya[3],w.array[x]=V[ca[0]],w.array[x+1]=V[ca[1]],w.array[x+2]=V[ca[2]],w.array[x+3]=
W[ca[0]],w.array[x+4]=W[ca[1]],w.array[x+5]=W[ca[2]],w.array[x+6]=X[ca[0]],w.array[x+7]=X[ca[1]],w.array[x+8]=X[ca[2]],w.array[x+9]=ra[ca[0]],w.array[x+10]=ra[ca[1]],w.array[x+11]=ra[ca[2]],x+=12}}else if(4===w.size)if(void 0===w.boundTo||"vertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)T=cb[ua[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+
9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,x+=12;H=0;for(Z=va.length;H<Z;H++)T=cb[va[H]],V=w.value[T.a],W=w.value[T.b],X=w.value[T.c],ra=w.value[T.d],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,w.array[x+12]=ra.x,w.array[x+13]=ra.y,w.array[x+14]=ra.z,w.array[x+15]=ra.w,x+=16}else if("faces"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)X=W=V=ya=
w.value[ua[H]],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,x+=12;H=0;for(Z=va.length;H<Z;H++)ra=X=W=V=ya=w.value[va[H]],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,w.array[x+12]=ra.x,
w.array[x+13]=ra.y,w.array[x+14]=ra.z,w.array[x+15]=ra.w,x+=16}else if("faceVertices"===w.boundTo){H=0;for(Z=ua.length;H<Z;H++)ya=w.value[ua[H]],V=ya[0],W=ya[1],X=ya[2],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,x+=12;H=0;for(Z=va.length;H<Z;H++)ya=w.value[va[H]],V=ya[0],W=ya[1],X=ya[2],ra=ya[3],w.array[x]=V.x,w.array[x+1]=V.y,w.array[x+2]=
V.z,w.array[x+3]=V.w,w.array[x+4]=W.x,w.array[x+5]=W.y,w.array[x+6]=W.z,w.array[x+7]=W.w,w.array[x+8]=X.x,w.array[x+9]=X.y,w.array[x+10]=X.z,w.array[x+11]=X.w,w.array[x+12]=ra.x,w.array[x+13]=ra.y,w.array[x+14]=ra.z,w.array[x+15]=ra.w,x+=16}k.bindBuffer(k.ARRAY_BUFFER,w.buffer);k.bufferData(k.ARRAY_BUFFER,w.array,Ha)}}vb&&(delete sa.__inittedArrays,delete sa.__colorArray,delete sa.__normalArray,delete sa.__tangentArray,delete sa.__uvArray,delete sa.__uv2Array,delete sa.__faceArray,delete sa.__vertexArray,
delete sa.__lineArray,delete sa.__skinIndexArray,delete sa.__skinWeightArray)}}S.verticesNeedUpdate=!1;S.morphTargetsNeedUpdate=!1;S.elementsNeedUpdate=!1;S.uvsNeedUpdate=!1;S.normalsNeedUpdate=!1;S.colorsNeedUpdate=!1;S.tangentsNeedUpdate=!1;S.buffersNeedUpdate=!1;ma.attributes&&E(ma)}else if(ta instanceof THREE.Ribbon){ma=e(ta,S);Da=ma.attributes&&u(ma);if(S.verticesNeedUpdate||S.colorsNeedUpdate||S.normalsNeedUpdate||Da){var Cb=S,Wc=k.DYNAMIC_DRAW,Lc=void 0,Mc=void 0,Nc=void 0,Xc=void 0,za=void 0,
Yc=void 0,Zc=void 0,$c=void 0,xd=void 0,Za=void 0,Dc=void 0,Fa=void 0,nb=void 0,yd=Cb.vertices,zd=Cb.colors,Ad=Cb.normals,Kd=yd.length,Ld=zd.length,Md=Ad.length,ad=Cb.__vertexArray,bd=Cb.__colorArray,cd=Cb.__normalArray,Nd=Cb.colorsNeedUpdate,Od=Cb.normalsNeedUpdate,sd=Cb.__webglCustomAttributesList;if(Cb.verticesNeedUpdate){for(Lc=0;Lc<Kd;Lc++)Xc=yd[Lc],za=3*Lc,ad[za]=Xc.x,ad[za+1]=Xc.y,ad[za+2]=Xc.z;k.bindBuffer(k.ARRAY_BUFFER,Cb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,ad,Wc)}if(Nd){for(Mc=
0;Mc<Ld;Mc++)Yc=zd[Mc],za=3*Mc,bd[za]=Yc.r,bd[za+1]=Yc.g,bd[za+2]=Yc.b;k.bindBuffer(k.ARRAY_BUFFER,Cb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,bd,Wc)}if(Od){for(Nc=0;Nc<Md;Nc++)Zc=Ad[Nc],za=3*Nc,cd[za]=Zc.x,cd[za+1]=Zc.y,cd[za+2]=Zc.z;k.bindBuffer(k.ARRAY_BUFFER,Cb.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,cd,Wc)}if(sd){$c=0;for(xd=sd.length;$c<xd;$c++)if(Fa=sd[$c],Fa.needsUpdate&&(void 0===Fa.boundTo||"vertices"===Fa.boundTo)){za=0;Dc=Fa.value.length;if(1===Fa.size)for(Za=0;Za<Dc;Za++)Fa.array[Za]=
Fa.value[Za];else if(2===Fa.size)for(Za=0;Za<Dc;Za++)nb=Fa.value[Za],Fa.array[za]=nb.x,Fa.array[za+1]=nb.y,za+=2;else if(3===Fa.size)if("c"===Fa.type)for(Za=0;Za<Dc;Za++)nb=Fa.value[Za],Fa.array[za]=nb.r,Fa.array[za+1]=nb.g,Fa.array[za+2]=nb.b,za+=3;else for(Za=0;Za<Dc;Za++)nb=Fa.value[Za],Fa.array[za]=nb.x,Fa.array[za+1]=nb.y,Fa.array[za+2]=nb.z,za+=3;else if(4===Fa.size)for(Za=0;Za<Dc;Za++)nb=Fa.value[Za],Fa.array[za]=nb.x,Fa.array[za+1]=nb.y,Fa.array[za+2]=nb.z,Fa.array[za+3]=nb.w,za+=4;k.bindBuffer(k.ARRAY_BUFFER,
Fa.buffer);k.bufferData(k.ARRAY_BUFFER,Fa.array,Wc)}}}S.verticesNeedUpdate=!1;S.colorsNeedUpdate=!1;S.normalsNeedUpdate=!1;ma.attributes&&E(ma)}else if(ta instanceof THREE.Line){ma=e(ta,S);Da=ma.attributes&&u(ma);if(S.verticesNeedUpdate||S.colorsNeedUpdate||S.lineDistancesNeedUpdate||Da){var Db=S,dd=k.DYNAMIC_DRAW,Oc=void 0,Pc=void 0,Qc=void 0,ed=void 0,La=void 0,fd=void 0,Bd=Db.vertices,Cd=Db.colors,Dd=Db.lineDistances,Pd=Bd.length,Qd=Cd.length,Rd=Dd.length,gd=Db.__vertexArray,hd=Db.__colorArray,
Ed=Db.__lineDistanceArray,Sd=Db.colorsNeedUpdate,Td=Db.lineDistancesNeedUpdate,td=Db.__webglCustomAttributesList,id=void 0,Fd=void 0,$a=void 0,Ec=void 0,ob=void 0,Ga=void 0;if(Db.verticesNeedUpdate){for(Oc=0;Oc<Pd;Oc++)ed=Bd[Oc],La=3*Oc,gd[La]=ed.x,gd[La+1]=ed.y,gd[La+2]=ed.z;k.bindBuffer(k.ARRAY_BUFFER,Db.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,gd,dd)}if(Sd){for(Pc=0;Pc<Qd;Pc++)fd=Cd[Pc],La=3*Pc,hd[La]=fd.r,hd[La+1]=fd.g,hd[La+2]=fd.b;k.bindBuffer(k.ARRAY_BUFFER,Db.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,
...
Ga.value[$a],Ga.array[La]=ob.r,Ga.array[La+1]=ob.g,Ga.array[La+2]=ob.b,La+=3;else for($a=0;$a<Ec;$a++)ob=Ga.value[$a],Ga.array[La]=ob.x,Ga.array[La+1]=ob.y,Ga.array[La+2]=ob.z,La+=3;else if(4===Ga.size)for($a=0;$a<Ec;$a++)ob=Ga.value[$a],Ga.array[La]=ob.x,Ga.array[La+1]=ob.y,Ga.array[La+2]=ob.z,Ga.array[La+3]=ob.w,La+=4;k.bindBuffer(k.ARRAY_BUFFER,Ga.buffer);k.bufferData(k.ARRAY_BUFFER,Ga.array,dd)}}}S.verticesNeedUpdate=!1;S.colorsNeedUpdate=!1;S.lineDistancesNeedUpdate=!1;ma.attributes&&E(ma)}else if(ta instanceof
THREE.ParticleSystem)if(S instanceof THREE.BufferGeometry)(S.verticesNeedUpdate||S.colorsNeedUpdate)&&i(S,k.DYNAMIC_DRAW,!S.dynamic),S.verticesNeedUpdate=!1,S.colorsNeedUpdate=!1;else{ma=e(ta,S);Da=ma.attributes&&u(ma);if(S.verticesNeedUpdate||S.colorsNeedUpdate||ta.sortParticles||Da){var cc=S,ud=k.DYNAMIC_DRAW,Rc=ta,pb=void 0,dc=void 0,ec=void 0,ia=void 0,fc=void 0,sc=void 0,jd=cc.vertices,vd=jd.length,wd=cc.colors,Gd=wd.length,vc=cc.__vertexArray,wc=cc.__colorArray,kc=cc.__sortArray,Hd=cc.verticesNeedUpdate,
Id=cc.colorsNeedUpdate,lc=cc.__webglCustomAttributesList,Ib=void 0,Fc=void 0,qa=void 0,Jb=void 0,Ba=void 0,ha=void 0;if(Rc.sortParticles){ib.copy(mc);ib.multiplySelf(Rc.matrixWorld);for(pb=0;pb<vd;pb++)ec=jd[pb],Eb.copy(ec),ib.multiplyVector3(Eb),kc[pb]=[Eb.z,pb];kc.sort(n);for(pb=0;pb<vd;pb++)ec=jd[kc[pb][1]],ia=3*pb,vc[ia]=ec.x,vc[ia+1]=ec.y,vc[ia+2]=ec.z;for(dc=0;dc<Gd;dc++)ia=3*dc,sc=wd[kc[dc][1]],wc[ia]=sc.r,wc[ia+1]=sc.g,wc[ia+2]=sc.b;if(lc){Ib=0;for(Fc=lc.length;Ib<Fc;Ib++)if(ha=lc[Ib],void 0===
ha.boundTo||"vertices"===ha.boundTo)if(ia=0,Jb=ha.value.length,1===ha.size)for(qa=0;qa<Jb;qa++)fc=kc[qa][1],ha.array[qa]=ha.value[fc];else if(2===ha.size)for(qa=0;qa<Jb;qa++)fc=kc[qa][1],Ba=ha.value[fc],ha.array[ia]=Ba.x,ha.array[ia+1]=Ba.y,ia+=2;else if(3===ha.size)if("c"===ha.type)for(qa=0;qa<Jb;qa++)fc=kc[qa][1],Ba=ha.value[fc],ha.array[ia]=Ba.r,ha.array[ia+1]=Ba.g,ha.array[ia+2]=Ba.b,ia+=3;else for(qa=0;qa<Jb;qa++)fc=kc[qa][1],Ba=ha.value[fc],ha.array[ia]=Ba.x,ha.array[ia+1]=Ba.y,ha.array[ia+
2]=Ba.z,ia+=3;else if(4===ha.size)for(qa=0;qa<Jb;qa++)fc=kc[qa][1],Ba=ha.value[fc],ha.array[ia]=Ba.x,ha.array[ia+1]=Ba.y,ha.array[ia+2]=Ba.z,ha.array[ia+3]=Ba.w,ia+=4}}else{if(Hd)for(pb=0;pb<vd;pb++)ec=jd[pb],ia=3*pb,vc[ia]=ec.x,vc[ia+1]=ec.y,vc[ia+2]=ec.z;if(Id)for(dc=0;dc<Gd;dc++)sc=wd[dc],ia=3*dc,wc[ia]=sc.r,wc[ia+1]=sc.g,wc[ia+2]=sc.b;if(lc){Ib=0;for(Fc=lc.length;Ib<Fc;Ib++)if(ha=lc[Ib],ha.needsUpdate&&(void 0===ha.boundTo||"vertices"===ha.boundTo))if(Jb=ha.value.length,ia=0,1===ha.size)for(qa=
0;qa<Jb;qa++)ha.array[qa]=ha.value[qa];else if(2===ha.size)for(qa=0;qa<Jb;qa++)Ba=ha.value[qa],ha.array[ia]=Ba.x,ha.array[ia+1]=Ba.y,ia+=2;else if(3===ha.size)if("c"===ha.type)for(qa=0;qa<Jb;qa++)Ba=ha.value[qa],ha.array[ia]=Ba.r,ha.array[ia+1]=Ba.g,ha.array[ia+2]=Ba.b,ia+=3;else for(qa=0;qa<Jb;qa++)Ba=ha.value[qa],ha.array[ia]=Ba.x,ha.array[ia+1]=Ba.y,ha.array[ia+2]=Ba.z,ia+=3;else if(4===ha.size)for(qa=0;qa<Jb;qa++)Ba=ha.value[qa],ha.array[ia]=Ba.x,ha.array[ia+1]=Ba.y,ha.array[ia+2]=Ba.z,ha.array[ia+
3]=Ba.w,ia+=4}}if(Hd||Rc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,cc.__webglVertexBuffer),k.bufferData(k.ARRAY_BUFFER,vc,ud);if(Id||Rc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,cc.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,wc,ud);if(lc){Ib=0;for(Fc=lc.length;Ib<Fc;Ib++)if(ha=lc[Ib],ha.needsUpdate||Rc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,ha.buffer),k.bufferData(k.ARRAY_BUFFER,ha.array,ud)}}S.verticesNeedUpdate=!1;S.colorsNeedUpdate=!1;ma.attributes&&E(ma)}}};this.initMaterial=function(a,
...
a),c&&k.generateMipmap(k.TEXTURE_2D);b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}a?(b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer,c=a.width,a=a.height,e=d=0):(b=null,c=Na,a=kb,d=ma,e=xb);b!==P&&(k.bindFramebuffer(k.FRAMEBUFFER,b),k.viewport(d,e,c,a),P=b);hb=c;Ea=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);
...
void 0,r=a[g[i]].x,s=a[g[i]].y,l=a[g[j]].x,t=a[g[j]].y,u=a[g[m]].x,E=a[g[m]].y;if(1E-10>(l-r)*(E-s)-(t-s)*(u-r))n=!1;else{var G=void 0,A=void 0,z=void 0,v=void 0,I=void 0,D=void 0,F=void 0,M=void 0,B=void 0,J=void 0,B=M=F=q=y=void 0,G=u-l,A=E-t,z=r-u,v=s-E,I=l-r,D=t-s;for(n=0;n<e;n++)if(!(n===i||n===j||n===m))if(y=a[g[n]].x,q=a[g[n]].y,F=y-r,M=q-s,B=y-l,J=q-t,y-=u,q-=E,B=G*J-A*B,F=I*M-D*F,M=z*q-v*y,0<=B&&0<=M&&0<=F){n=!1;break a}n=!0}}if(n){f.push([a[g[i]],a[g[j]],a[g[m]]]);h.push([g[i],g[j],g[m]]);
...
this.faceVertexUvs[0].push([f[e],f[e+1],g]);this.computeCentroids();this.computeFaceNormals();this.boundingSphere=new THREE.Sphere(new THREE.Vector3,a)};THREE.CircleGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.CubeGeometry=function(a,b,c,d,e,f){function g(a,b,c,d,e,f,g,l){var t,u=h.widthSegments,E=h.heightSegments,y=e/2,q=f/2,G=h.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)t="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)t="y",E=h.depthSegments;else if("z"===a&&"y"===b||"y"===a&&"z"===b)t="x",u=h.depthSegments;var A=u+1,z=E+1,v=e/u,I=f/E,D=new THREE.Vector3;D[t]=0<g?1:-1;for(e=0;e<z;e++)for(f=0;f<A;f++){var F=new THREE.Vector3;F[a]=(f*v-y)*c;F[b]=(e*I-q)*d;F[t]=g;h.vertices.push(F)}for(e=
...
n=this.vertices[j[0][h+1]].clone()):(p=this.vertices[j[1][h]].clone(),n=this.vertices[j[1][h+1]].clone());p.setY(Math.sqrt(p.x*p.x+p.z*p.z)*c).normalize();n.setY(Math.sqrt(n.x*n.x+n.z*n.z)*c).normalize();for(i=0;i<e;i++){var r=j[i][h],s=j[i+1][h],l=j[i+1][h+1],t=j[i][h+1],u=p.clone(),E=p.clone(),y=n.clone(),q=n.clone(),G=m[i][h].clone(),A=m[i+1][h].clone(),z=m[i+1][h+1].clone(),v=m[i][h+1].clone();this.faces.push(new THREE.Face4(r,s,l,t,[u,E,y,q]));this.faceVertexUvs[0].push([G,A,z,v])}}if(!f&&0<
a){this.vertices.push(new THREE.Vector3(0,g,0));for(h=0;h<d;h++)r=j[0][h],s=j[0][h+1],l=this.vertices.length-1,u=new THREE.Vector3(0,1,0),E=new THREE.Vector3(0,1,0),y=new THREE.Vector3(0,1,0),G=m[0][h].clone(),A=m[0][h+1].clone(),z=new THREE.Vector2(A.u,0),this.faces.push(new THREE.Face3(r,s,l,[u,E,y])),this.faceVertexUvs[0].push([G,A,z])}if(!f&&0<b){this.vertices.push(new THREE.Vector3(0,-g,0));for(h=0;h<d;h++)r=j[i][h+1],s=j[i][h],l=this.vertices.length-1,u=new THREE.Vector3(0,-1,0),E=new THREE.Vector3(0,
-1,0),y=new THREE.Vector3(0,-1,0),G=m[i][h+1].clone(),A=m[i][h].clone(),z=new THREE.Vector2(A.u,1),this.faces.push(new THREE.Face3(r,s,l,[u,E,y])),this.faceVertexUvs[0].push([G,A,z])}this.computeCentroids();this.computeFaceNormals()};THREE.CylinderGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry=function(a,b){"undefined"!==typeof a&&(THREE.Geometry.call(this),a=a instanceof Array?a:[a],this.shapebb=a[a.length-1].getBoundingBox(),this.addShapeList(a,b),this.computeCentroids(),this.computeFaceNormals())};THREE.ExtrudeGeometry.prototype=Object.create(THREE.Geometry.prototype);THREE.ExtrudeGeometry.prototype.addShapeList=function(a,b){for(var c=a.length,d=0;d<c;d++)this.addShape(a[d],b)};
...
for(var g=0,h=r+2*m,g=0;g<h;g++){var i=O*g,j=O*(g+1),l=d+e+i,i=d+f+i,n=d+f+j,j=d+e+j,p=c,s=g,q=h,t=e,u=f,l=l+M,i=i+M,n=n+M,j=j+M;F.faces.push(new THREE.Face4(l,i,n,j,null,null,E));l=y.generateSideWallUV(F,a,p,b,l,i,n,j,s,q,t,u);F.faceVertexUvs[0].push(l)}}}function f(a,b,c){F.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=M;d+=M;e+=M;F.faces.push(new THREE.Face3(c,d,e,null,null,u));c=f?y.generateBottomUV(F,a,b,c,d,e):y.generateTopUV(F,a,b,c,d,e);F.faceVertexUvs[0].push(c)}var h=void 0!==
b.amount?b.amount:100,i=void 0!==b.bevelThickness?b.bevelThickness:6,j=void 0!==b.bevelSize?b.bevelSize:i-2,m=void 0!==b.bevelSegments?b.bevelSegments:3,p=void 0!==b.bevelEnabled?b.bevelEnabled:!0,n=void 0!==b.curveSegments?b.curveSegments:12,r=void 0!==b.steps?b.steps:1,s=b.extrudePath,l,t=!1,u=b.material,E=b.extrudeMaterial,y=void 0!==b.UVGenerator?b.UVGenerator:THREE.ExtrudeGeometry.WorldUVGenerator,q,G,A,z;s&&(l=s.getSpacedPoints(r),t=!0,p=!1,q=void 0!==b.frames?b.frames:new THREE.TubeGeometry.FrenetFrames(s,
r,!1),G=new THREE.Vector3,A=new THREE.Vector3,z=new THREE.Vector3);p||(j=i=m=0);var v,I,D,F=this,M=this.vertices.length,n=a.extractPoints(n),B=n.shape,n=n.holes;if(s=!THREE.Shape.Utils.isClockWise(B)){B=B.reverse();I=0;for(D=n.length;I<D;I++)v=n[I],THREE.Shape.Utils.isClockWise(v)&&(n[I]=v.reverse());s=!1}var J=THREE.Shape.Utils.triangulateShape(B,n),s=B;I=0;for(D=n.length;I<D;I++)v=n[I],B=B.concat(v);var C,L,K,U,O=B.length,$=J.length,wa=[],N=0,na=s.length;C=na-1;for(L=N+1;N<na;N++,C++,L++)C===na&&
(C=0),L===na&&(L=0),wa[N]=d(s[N],s[C],s[L]);var la=[],Ma,Q=wa.concat();I=0;for(D=n.length;I<D;I++){v=n[I];Ma=[];N=0;na=v.length;C=na-1;for(L=N+1;N<na;N++,C++,L++)C===na&&(C=0),L===na&&(L=0),Ma[N]=d(v[N],v[C],v[L]);la.push(Ma);Q=Q.concat(Ma)}for(C=0;C<m;C++){v=C/m;K=i*(1-v);L=j*Math.sin(v*Math.PI/2);N=0;for(na=s.length;N<na;N++)U=c(s[N],wa[N],L),f(U.x,U.y,-K);I=0;for(D=n.length;I<D;I++){v=n[I];Ma=la[I];N=0;for(na=v.length;N<na;N++)U=c(v[N],Ma[N],L),f(U.x,U.y,-K)}}L=j;for(N=0;N<O;N++)U=p?c(B[N],Q[N],
L):B[N],t?(A.copy(q.normals[0]).multiplyScalar(U.x),G.copy(q.binormals[0]).multiplyScalar(U.y),z.copy(l[0]).addSelf(A).addSelf(G),f(z.x,z.y,z.z)):f(U.x,U.y,0);for(v=1;v<=r;v++)for(N=0;N<O;N++)U=p?c(B[N],Q[N],L):B[N],t?(A.copy(q.normals[v]).multiplyScalar(U.x),G.copy(q.binormals[v]).multiplyScalar(U.y),z.copy(l[v]).addSelf(A).addSelf(G),f(z.x,z.y,z.z)):f(U.x,U.y,h/r*v);for(C=m-1;0<=C;C--){v=C/m;K=i*(1-v);L=j*Math.sin(v*Math.PI/2);N=0;for(na=s.length;N<na;N++)U=c(s[N],wa[N],L),f(U.x,U.y,h+K);I=0;for(D=
n.length;I<D;I++){v=n[I];Ma=la[I];N=0;for(na=v.length;N<na;N++)U=c(v[N],Ma[N],L),t?f(U.x,U.y+l[r-1].y,l[r-1].x+K):f(U.x,U.y,h+K)}}if(p){i=0*O;for(N=0;N<$;N++)h=J[N],g(h[2]+i,h[1]+i,h[0]+i,!0);i=O*(r+2*m);for(N=0;N<$;N++)h=J[N],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(N=0;N<$;N++)h=J[N],g(h[2],h[1],h[0],!0);for(N=0;N<$;N++)h=J[N],g(h[0]+O*r,h[1]+O*r,h[2]+O*r,!1)}h=0;e(s,h);h+=s.length;I=0;for(D=n.length;I<D;I++)v=n[I],e(v,h),h+=v.length};
...
i=[],j=[],m=this,p=THREE.GeometryUtils.orderedKey,n=THREE.GeometryUtils.computeEdgeFaces,r=a.vertices,s=a.faces,l=r.length,h=r.concat(),t=[],u={},E={},y={},q,G,A,z,v,I=a.faceVertexUvs[0],D;c("originalFaces, uvs, originalVerticesLength",s.length,I.length,l);if(m.supportUVs){q=0;for(G=I.length;q<G;q++){A=0;for(z=I[q].length;A<z;A++)D=s[q]["abcd".charAt(A)],g(D,q,I[q][A])}}0==I.length&&(m.supportUVs=!1);q=0;for(var F in y)q++;q||(m.supportUVs=!1,c("no uvs"));q=0;for(G=s.length;q<G;q++)v=s[q],t.push(v.centroid),
h.push(v.centroid),m.supportUVs&&(z=new THREE.Vector2,v instanceof THREE.Face3?(z.x=f(v.a,q).x+f(v.b,q).x+f(v.c,q).x,z.y=f(v.a,q).y+f(v.b,q).y+f(v.c,q).y,z.x/=3,z.y/=3):v instanceof THREE.Face4&&(z.x=f(v.a,q).x+f(v.b,q).x+f(v.c,q).x+f(v.d,q).x,z.y=f(v.a,q).y+f(v.b,q).y+f(v.c,q).y+f(v.d,q).y,z.x/=4,z.y/=4),g(l+q,"",z));var n=n(a),M;G=0;var B,J;F={};I={};for(q in n){D=n[q];B=q.split("_");J=B[0];B=B[1];A=J;v=[J,B];void 0===F[A]&&(F[A]=[]);F[A].push(v);A=B;v=[J,B];void 0===F[A]&&(F[A]=[]);F[A].push(v);
A=0;for(z=D.length;A<z;A++){v=D[A];M=J;var C=v,L=q;void 0===I[M]&&(I[M]={});I[M][C]=L;M=B;C=q;void 0===I[M]&&(I[M]={});I[M][v]=C}2>D.length&&(E[q]=!0)}for(q in n)D=n[q],v=D[0],M=D[1],B=q.split("_"),J=B[0],B=B[1],z=new THREE.Vector3,b(0<D.length,"an edge without faces?!"),1==D.length?(z.addSelf(r[J]),z.addSelf(r[B]),z.multiplyScalar(0.5)):(z.addSelf(t[v]),z.addSelf(t[M]),z.addSelf(r[J]),z.addSelf(r[B]),z.multiplyScalar(0.25)),u[q]=l+s.length+G,h.push(z),G++,m.supportUVs&&(z=new THREE.Vector2,z.x=f(J,
v).x+f(B,v).x,z.y=f(J,v).y+f(B,v).y,z.x/=2,z.y/=2,g(u[q],v,z),2<=D.length&&(b(2==D.length,"did we plan for more than 2 edges?"),z=new THREE.Vector2,z.x=f(J,M).x+f(B,M).x,z.y=f(J,M).y+f(B,M).y,z.x/=2,z.y/=2,g(u[q],M,z)));c("-- Step 2 done");var K,U;z=["123","12","2","23"];M=["123","23","3","31"];var C=["123","31","1","12"],L=["1234","12","2","23"],O=["1234","23","3","34"],$=["1234","34","4","41"],wa=["1234","41","1","12"];q=0;for(G=t.length;q<G;q++)v=s[q],D=l+q,v instanceof THREE.Face3?(J=p(v.a,v.b),
...
z=D!=J;for(A=0;A<J;A++)E[p(F[q][A][0],F[q][A][1])]&&M++;u.divideScalar(D);M=0;if(z){for(A=0;A<J;A++)if(D=F[q][A],C=1==n[p(D[0],D[1])].length)D=r[D[0]].clone().addSelf(r[D[1]]).divideScalar(2),v.addSelf(D),M++;v.divideScalar(4);b(2==M,"should have only 2 boundary edges")}else{for(A=0;A<J;A++)D=F[q][A],D=r[D[0]].clone().addSelf(r[D[1]]).divideScalar(2),v.addSelf(D);v.divideScalar(J)}B.addSelf(r[q]);z?(B.divideScalar(2),B.addSelf(v)):(B.multiplyScalar(J-3),B.addSelf(u),B.addSelf(v.multiplyScalar(2)),
...
"color");n.scale=b.getUniformLocation(m,"scale");n.rotation=b.getUniformLocation(m,"rotation");n.screenPosition=b.getUniformLocation(m,"screenPosition")};this.render=function(a,d,e,t){var a=a.__webglFlares,u=a.length;if(u){var E=new THREE.Vector3,y=t/e,q=0.5*e,G=0.5*t,A=16/t,z=new THREE.Vector2(A*y,A),v=new THREE.Vector3(1,1,0),I=new THREE.Vector2(1,1),D=n,A=p;b.useProgram(m);b.enableVertexAttribArray(p.vertex);b.enableVertexAttribArray(p.uv);b.uniform1i(D.occlusionMap,0);b.uniform1i(D.map,1);b.bindBuffer(b.ARRAY_BUFFER,
f);b.vertexAttribPointer(A.vertex,2,b.FLOAT,!1,16,0);b.vertexAttribPointer(A.uv,2,b.FLOAT,!1,16,8);b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,g);b.disable(b.CULL_FACE);b.depthMask(!1);var F,M,B,J,C;for(F=0;F<u;F++)if(A=16/t,z.set(A*y,A),J=a[F],E.set(J.matrixWorld.elements[12],J.matrixWorld.elements[13],J.matrixWorld.elements[14]),d.matrixWorldInverse.multiplyVector3(E),d.projectionMatrix.multiplyVector3(E),v.copy(E),I.x=v.x*q+q,I.y=v.y*G+G,j||0<I.x&&I.x<e&&0<I.y&&I.y<t){b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,
...
vertexShader:g.vertexShader,uniforms:h,skinning:!0});f=new THREE.ShaderMaterial({fragmentShader:g.fragmentShader,vertexShader:g.vertexShader,uniforms:h,morphTargets:!0,skinning:!0});c._shadowPass=!0;d._shadowPass=!0;e._shadowPass=!0;f._shadowPass=!0};this.render=function(a,c){b.shadowMapEnabled&&b.shadowMapAutoUpdate&&this.update(a,c)};this.update=function(m,p){var n,r,s,l,t,u,E,y,q,G=[];l=0;a.clearColor(1,1,1,1);a.disable(a.BLEND);a.enable(a.CULL_FACE);a.frontFace(a.CCW);b.shadowMapCullFace===THREE.CullFaceFront?
...
E=E.shadowCascadeFarZ[y];q=q.pointsFrustum;q[0].z=u;q[1].z=u;q[2].z=u;q[3].z=u;q[4].z=E;q[5].z=E;q[6].z=E;q[7].z=E;G[l]=A;l++}else G[l]=s,l++;n=0;for(r=G.length;n<r;n++){s=G[n];s.shadowMap||(t=THREE.LinearFilter,b.shadowMapType===THREE.PCFSoftShadowMap&&(t=THREE.NearestFilter),s.shadowMap=new THREE.WebGLRenderTarget(s.shadowMapWidth,s.shadowMapHeight,{minFilter:t,magFilter:t,format:THREE.RGBAFormat}),s.shadowMapSize=new THREE.Vector2(s.shadowMapWidth,s.shadowMapHeight),s.shadowMatrix=new THREE.Matrix4);
...
G.far),b.uniform1i(u.fogType,1),q=t=1):G instanceof THREE.FogExp2&&(b.uniform1f(u.fogDensity,G.density),b.uniform1i(u.fogType,2),q=t=2)):(b.uniform1i(u.fogType,0),q=t=0);for(var A,z,v=[],G=0;G<l;G++)A=s[G],z=A.material,A.visible&&0!==z.opacity&&(z.useScreenCoordinates?A.z=-A.position.z:(A._modelViewMatrix.multiply(e.matrixWorldInverse,A.matrixWorld),A.z=-A._modelViewMatrix.elements[14]));s.sort(a);for(G=0;G<l;G++)A=s[G],z=A.material,A.visible&&0!==z.opacity&&(z.map&&z.map.image&&z.map.image.width)&&
