...
i.positionScreen.copy(i.positionWorld).applyMatrix4(ea),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,i.positionScreen.z/=i.positionScreen.w,i.visible=!(-1>i.positionScreen.x||1<i.positionScreen.x||-1>i.positionScreen.y||1<i.positionScreen.y||-1>i.positionScreen.z||1<i.positionScreen.z);la=0;for(ta=jb.length;la<ta;la++){Z=jb[la];var Ra=!0===Ua?Qa.materials[Z.materialIndex]:ka.material;if(void 0!==Ra){ia=Ra.side;if(Z instanceof THREE.Face3)if(W=m[Z.a],V=m[Z.b],ga=m[Z.c],
I[0]=W.positionScreen,I[1]=V.positionScreen,I[2]=ga.positionScreen,!0===W.visible||!0===V.visible||!0===ga.visible||P.isIntersectionBox(C.setFromPoints(I)))if(pa=0>(ga.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(ga.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x),ia===THREE.DoubleSide||pa===(ia===THREE.FrontSide))r===n?(oa=new THREE.RenderableFace3,s.push(oa),n++,r++,p=oa):p=s[r++],p.v1.copy(W),p.v2.copy(V),p.v3.copy(ga);else continue;
else continue;else if(Z instanceof THREE.Face4)if(W=m[Z.a],V=m[Z.b],ga=m[Z.c],oa=m[Z.d],M[0]=W.positionScreen,M[1]=V.positionScreen,M[2]=ga.positionScreen,M[3]=oa.positionScreen,!0===W.visible||!0===V.visible||!0===ga.visible||!0===oa.visible||P.isIntersectionBox(C.setFromPoints(M)))if(pa=0>(oa.positionScreen.x-W.positionScreen.x)*(V.positionScreen.y-W.positionScreen.y)-(oa.positionScreen.y-W.positionScreen.y)*(V.positionScreen.x-W.positionScreen.x)||0>(V.positionScreen.x-ga.positionScreen.x)*(oa.positionScreen.y-
ga.positionScreen.y)-(V.positionScreen.y-ga.positionScreen.y)*(oa.positionScreen.x-ga.positionScreen.x),ia===THREE.DoubleSide||pa===(ia===THREE.FrontSide)){if(q===u){var rb=new THREE.RenderableFace4;y.push(rb);u++;q++;p=rb}else p=y[q++];p.v1.copy(W);p.v2.copy(V);p.v3.copy(ga);p.v4.copy(oa)}else continue;else continue;p.normalModel.copy(Z.normal);!1===pa&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&p.normalModel.negate();p.normalModel.applyMatrix3(A).normalize();p.normalModelView.copy(p.normalModel).applyMatrix3(ca);
p.centroidModel.copy(Z.centroid).applyMatrix4(xa);ga=Z.vertexNormals;W=0;for(V=ga.length;W<V;W++)oa=p.vertexNormalsModel[W],oa.copy(ga[W]),!1===pa&&(ia===THREE.BackSide||ia===THREE.DoubleSide)&&oa.negate(),oa.applyMatrix3(A).normalize(),p.vertexNormalsModelView[W].copy(oa).applyMatrix3(ca);p.vertexNormalsLength=ga.length;W=0;for(V=Pa.length;W<V;W++)if(oa=Pa[W][la],void 0!==oa){ia=0;for(ga=oa.length;ia<ga;ia++)p.uvs[W][ia]=oa[ia]}p.color=Z.color;p.material=Ra;ha.copy(p.centroidModel).applyProjection(ea);
p.z=ha.z;G.elements.push(p)}}}else if(ka instanceof THREE.Line){La.multiplyMatrices(ea,xa);la=ka.geometry.vertices;W=b();W.positionScreen.copy(la[0]).applyMatrix4(La);jb=ka.type===THREE.LinePieces?2:1;ta=1;for(Z=la.length;ta<Z;ta++)W=b(),W.positionScreen.copy(la[ta]).applyMatrix4(La),0<(ta+1)%jb||(V=m[j-2],N.copy(W.positionScreen),fa.copy(V.positionScreen),!0===d(N,fa)&&(N.multiplyScalar(1/N.w),fa.multiplyScalar(1/fa.w),t===J?(Pa=new THREE.RenderableLine,E.push(Pa),J++,t++,x=Pa):x=E[t++],x.v1.positionScreen.copy(N),
...
3;m.info.render.faces++;b(i.opacity);c(i.blending);A=a.positionScreen.x;ca=a.positionScreen.y;ha=d.positionScreen.x;na=d.positionScreen.y;N=e.positionScreen.x;fa=e.positionScreen.y;y(A,ca,ha,na,N,fa);(i instanceof THREE.MeshLambertMaterial||i instanceof THREE.MeshPhongMaterial)&&null===i.map?(ga.copy(i.color),ka.copy(i.emissive),i.vertexColors===THREE.FaceColors&&ga.multiply(k.color),!1===i.wireframe&&i.shading==THREE.SmoothShading&&3==k.vertexNormalsLength?(la.copy(sb),W.copy(sb),V.copy(sb),q(k.v1.positionWorld,
k.vertexNormalsModel[0],la),q(k.v2.positionWorld,k.vertexNormalsModel[1],W),q(k.v3.positionWorld,k.vertexNormalsModel[2],V),la.multiply(ga).add(ka),W.multiply(ga).add(ka),V.multiply(ga).add(ka),ia.addColors(W,V).multiplyScalar(0.5),Aa=H(la,W,V,ia),J(A,ca,ha,na,N,fa,0,0,1,0,0,1,Aa)):(Z.copy(sb),q(k.centroidModel,k.normalModel,Z),Z.multiply(ga).add(ka),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z))):i instanceof THREE.MeshBasicMaterial||i instanceof THREE.MeshLambertMaterial||
i instanceof THREE.MeshPhongMaterial?null!==i.map?i.map.mapping instanceof THREE.UVMapping&&(Ra=k.uvs[0],C(A,ca,ha,na,N,fa,Ra[f].x,Ra[f].y,Ra[g].x,Ra[g].y,Ra[h].x,Ra[h].y,i.map)):null!==i.envMap?i.envMap.mapping instanceof THREE.SphericalReflectionMapping&&($a.copy(k.vertexNormalsModelView[f]),rb=0.5*$a.x+0.5,Ob=0.5*$a.y+0.5,$a.copy(k.vertexNormalsModelView[g]),Lb=0.5*$a.x+0.5,Pb=0.5*$a.y+0.5,$a.copy(k.vertexNormalsModelView[h]),Tb=0.5*$a.x+0.5,Ub=0.5*$a.y+0.5,C(A,ca,ha,na,N,fa,rb,Ob,Lb,Pb,Tb,Ub,
i.envMap)):(Z.copy(i.color),i.vertexColors===THREE.FaceColors&&Z.multiply(k.color),!0===i.wireframe?E(Z,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):F(Z)):i instanceof THREE.MeshDepthMaterial?(Ua=n.near,Qa=n.far,la.r=la.g=la.b=1-j(a.positionScreen.z*a.positionScreen.w,Ua,Qa),W.r=W.g=W.b=1-j(d.positionScreen.z*d.positionScreen.w,Ua,Qa),V.r=V.g=V.b=1-j(e.positionScreen.z*e.positionScreen.w,Ua,Qa),ia.addColors(W,V).multiplyScalar(0.5),Aa=H(la,W,V,ia),J(A,ca,ha,na,N,fa,0,0,1,0,0,1,Aa)):
...
g,p=(1-p+n)*q-k,l=i*p-j*ua;0===l?(void 0===oa[m.id]&&(b=document.createElement("canvas"),b.width=m.image.width,b.height=m.image.height,b=b.getContext("2d"),b.drawImage(m.image,0,0),oa[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data),b=oa[m.id],g=4*(Math.floor(g)+Math.floor(k)*m.image.width),Z.setRGB(b[g]/255,b[g+1]/255,b[g+2]/255),F(Z)):(l=1/l,m=(p*c-ua*e)*l,ua=(p*d-ua*f)*l,c=(i*e-j*c)*l,d=(i*f-j*d)*l,a=a-m*g-c*k,g=b-ua*g-d*k,t.save(),t.transform(m,ua,c,d,a,g),t.fill(),t.restore())}}function J(a,
...
M.positionScreen,U.positionScreen,ea.positionScreen]);L=I;ua=M;ub=U;mb=ea;vb=xa;wb=La;m.info.render.vertices+=4;m.info.render.faces++;b(R.opacity);c(R.blending);void 0!==R.map&&null!==R.map||void 0!==R.envMap&&null!==R.envMap?(z(L,ua,mb,0,1,3,da,R),z(vb,ub,wb,1,2,3,da,R)):(A=L.positionScreen.x,ca=L.positionScreen.y,ha=ua.positionScreen.x,na=ua.positionScreen.y,N=ub.positionScreen.x,fa=ub.positionScreen.y,ib=mb.positionScreen.x,Ya=mb.positionScreen.y,db=vb.positionScreen.x,Ja=vb.positionScreen.y,pa=
wb.positionScreen.x,ta=wb.positionScreen.y,R instanceof THREE.MeshLambertMaterial||R instanceof THREE.MeshPhongMaterial?(ga.copy(R.color),ka.copy(R.emissive),R.vertexColors===THREE.FaceColors&&ga.multiply(da.color),!1===R.wireframe&&R.shading==THREE.SmoothShading&&4==da.vertexNormalsLength?(la.copy(sb),W.copy(sb),V.copy(sb),ia.copy(sb),q(da.v1.positionWorld,da.vertexNormalsModel[0],la),q(da.v2.positionWorld,da.vertexNormalsModel[1],W),q(da.v4.positionWorld,da.vertexNormalsModel[3],V),q(da.v3.positionWorld,
da.vertexNormalsModel[2],ia),la.multiply(ga).add(ka),W.multiply(ga).add(ka),V.multiply(ga).add(ka),ia.multiply(ga).add(ka),Aa=H(la,W,V,ia),y(A,ca,ha,na,ib,Ya),J(A,ca,ha,na,ib,Ya,0,0,1,0,0,1,Aa),y(db,Ja,N,fa,pa,ta),J(db,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa)):(Z.copy(sb),q(da.centroidModel,da.normalModel,Z),Z.multiply(ga).add(ka),B(A,ca,ha,na,N,fa,ib,Ya),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z))):R instanceof THREE.MeshBasicMaterial?(Z.copy(R.color),R.vertexColors===
THREE.FaceColors&&Z.multiply(da.color),B(A,ca,ha,na,N,fa,ib,Ya),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R instanceof THREE.MeshNormalMaterial?(L=void 0,R.shading==THREE.FlatShading?(L=da.normalModelView,Z.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),B(A,ca,ha,na,N,fa,ib,Ya),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R.shading==THREE.SmoothShading&&(L=da.vertexNormalsModelView[0],la.setRGB(L.x,L.y,
L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[1],W.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[3],V.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[2],ia.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),Aa=H(la,W,V,ia),y(A,ca,ha,na,ib,Ya),J(A,ca,ha,na,ib,Ya,0,0,1,0,0,1,Aa),y(db,Ja,N,fa,pa,ta),J(db,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa))):R instanceof THREE.MeshDepthMaterial&&(Ua=n.near,Qa=n.far,la.r=la.g=
la.b=1-j(L.positionScreen.z*L.positionScreen.w,Ua,Qa),W.r=W.g=W.b=1-j(ua.positionScreen.z*ua.positionScreen.w,Ua,Qa),V.r=V.g=V.b=1-j(mb.positionScreen.z*mb.positionScreen.w,Ua,Qa),ia.r=ia.g=ia.b=1-j(ub.positionScreen.z*ub.positionScreen.w,Ua,Qa),Aa=H(la,W,V,ia),y(A,ca,ha,na,ib,Ya),J(A,ca,ha,na,ib,Ya,0,0,1,0,0,1,Aa),y(db,Ja,N,fa,pa,ta),J(db,Ja,N,fa,pa,ta,1,0,1,1,0,1,Aa)))}va.union(Va)}}t.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
a.antialias?a.antialias:!1,A=void 0!==a.stencil?a.stencil:!0,ca=void 0!==a.preserveDrawingBuffer?a.preserveDrawingBuffer:!1,ha=new THREE.Color(0),na=0;void 0!==a.clearColor&&(console.warn("DEPRECATED: clearColor in WebGLRenderer constructor parameters is being removed. Use .setClearColor() instead."),ha.setHex(a.clearColor));void 0!==a.clearAlpha&&(console.warn("DEPRECATED: clearAlpha in WebGLRenderer constructor parameters is being removed. Use .setClearColor() instead."),na=a.clearAlpha);this.domElement=
M;this.context=null;this.devicePixelRatio=void 0!==a.devicePixelRatio?a.devicePixelRatio:void 0!==window.devicePixelRatio?window.devicePixelRatio:1;this.autoUpdateScene=this.autoUpdateObjects=this.sortObjects=this.autoClearStencil=this.autoClearDepth=this.autoClearColor=this.autoClear=!0;this.shadowMapEnabled=this.physicallyBasedShading=this.gammaOutput=this.gammaInput=!1;this.shadowMapAutoUpdate=!0;this.shadowMapType=THREE.PCFShadowMap;this.shadowMapCullFace=THREE.CullFaceFront;this.shadowMapCascade=
this.shadowMapDebug=!1;this.maxMorphTargets=8;this.maxMorphNormals=4;this.autoScaleCubemaps=!0;this.renderPluginsPre=[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var N=this,fa=[],ib=0,Ya=null,db=null,Ja=-1,pa=null,ta=null,Z=0,la=0,W=-1,V=-1,ia=-1,ga=-1,ka=-1,Pa=-1,jb=-1,oa=-1,Ua=null,Qa=null,Aa=null,Ra=null,rb=0,Ob=0,Lb=0,Pb=0,Tb=0,Ub=0,Za={},va=new THREE.Frustum,Va=new THREE.Matrix4,sb=new THREE.Matrix4,Ma=new THREE.Vector3,
qa=new THREE.Vector3,$a=!0,Bb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,colors:[],positions:[],distances:[]},spot:{length:0,colors:[],positions:[],distances:[],directions:[],anglesCos:[],exponents:[]},hemi:{length:0,skyColors:[],groundColors:[],positions:[]}},k,Cb,Sa,kb,Ta;try{if(!(k=M.getContext("experimental-webgl",{alpha:ea,premultipliedAlpha:xa,antialias:La,stencil:A,preserveDrawingBuffer:ca})))throw"Error creating WebGL context.";}catch(Db){console.error(Db)}Cb=
k.getExtension("OES_texture_float");Sa=k.getExtension("OES_standard_derivatives");kb=k.getExtension("EXT_texture_filter_anisotropic")||k.getExtension("MOZ_EXT_texture_filter_anisotropic")||k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");Ta=k.getExtension("WEBGL_compressed_texture_s3tc")||k.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||k.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");Cb||console.log("THREE.WebGLRenderer: Float textures not supported.");Sa||console.log("THREE.WebGLRenderer: Standard derivatives not supported.");
kb||console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");Ta||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");void 0===k.getShaderPrecisionFormat&&(k.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}});k.clearColor(0,0,0,1);k.clearDepth(1);k.clearStencil(0);k.enable(k.DEPTH_TEST);k.depthFunc(k.LEQUAL);k.frontFace(k.CCW);k.cullFace(k.BACK);k.enable(k.CULL_FACE);k.enable(k.BLEND);k.blendEquation(k.FUNC_ADD);k.blendFunc(k.SRC_ALPHA,
k.ONE_MINUS_SRC_ALPHA);k.clearColor(ha.r,ha.g,ha.b,na);this.context=k;var cc=k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS),Gc=k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);k.getParameter(k.MAX_TEXTURE_SIZE);var Hc=k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),dc=kb?k.getParameter(kb.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,ec=0<Gc,Vb=ec&&Cb;Ta&&k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);var Kc=k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.HIGH_FLOAT),Lc=k.getShaderPrecisionFormat(k.VERTEX_SHADER,k.MEDIUM_FLOAT);
...
this.supportsFloatTextures=function(){return Cb};this.supportsStandardDerivatives=function(){return Sa};this.supportsCompressedTextureS3TC=function(){return Ta};this.getMaxAnisotropy=function(){return dc};this.getPrecision=function(){return U};this.setSize=function(a,b){M.width=a*this.devicePixelRatio;M.height=b*this.devicePixelRatio;M.style.width=a+"px";M.style.height=b+"px";this.setViewport(0,0,M.width,M.height)};this.setViewport=function(a,b,c,d){rb=void 0!==a?a:0;Ob=void 0!==b?b:0;Lb=void 0!==
c?c:M.width;Pb=void 0!==d?d:M.height;k.viewport(rb,Ob,Lb,Pb)};this.setScissor=function(a,b,c,d){k.scissor(a,b,c,d)};this.enableScissorTest=function(a){a?k.enable(k.SCISSOR_TEST):k.disable(k.SCISSOR_TEST)};this.setClearColor=function(a,b){ha.set(a);na=void 0!==b?b:1;k.clearColor(ha.r,ha.g,ha.b,na)};this.setClearColorHex=function(a,b){console.warn("DEPRECATED: .setClearColorHex() is being removed. Use .setClearColor() instead.");this.setClearColor(a,b)};this.getClearColor=function(){return ha};this.getClearAlpha=
function(){return na};this.clear=function(a,b,c){var d=0;if(void 0===a||a)d|=k.COLOR_BUFFER_BIT;if(void 0===b||b)d|=k.DEPTH_BUFFER_BIT;if(void 0===c||c)d|=k.STENCIL_BUFFER_BIT;k.clear(d)};this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};this.addPrePlugin=function(a){a.init(this);this.renderPluginsPre.push(a)};this.updateShadowMap=function(a,b){Ya=null;Ja=pa=oa=jb=ia=-1;$a=!0;V=W=-1;this.shadowMapPlugin.update(a,
b)};var gc=function(a){a=a.target;a.removeEventListener("dispose",gc);a.__webglInit=void 0;void 0!==a.__webglVertexBuffer&&k.deleteBuffer(a.__webglVertexBuffer);void 0!==a.__webglNormalBuffer&&k.deleteBuffer(a.__webglNormalBuffer);void 0!==a.__webglTangentBuffer&&k.deleteBuffer(a.__webglTangentBuffer);void 0!==a.__webglColorBuffer&&k.deleteBuffer(a.__webglColorBuffer);void 0!==a.__webglUVBuffer&&k.deleteBuffer(a.__webglUVBuffer);void 0!==a.__webglUV2Buffer&&k.deleteBuffer(a.__webglUV2Buffer);void 0!==
a.__webglSkinIndicesBuffer&&k.deleteBuffer(a.__webglSkinIndicesBuffer);void 0!==a.__webglSkinWeightsBuffer&&k.deleteBuffer(a.__webglSkinWeightsBuffer);void 0!==a.__webglFaceBuffer&&k.deleteBuffer(a.__webglFaceBuffer);void 0!==a.__webglLineBuffer&&k.deleteBuffer(a.__webglLineBuffer);void 0!==a.__webglLineDistanceBuffer&&k.deleteBuffer(a.__webglLineDistanceBuffer);if(void 0!==a.geometryGroups)for(var c in a.geometryGroups){var d=a.geometryGroups[c];if(void 0!==d.numMorphTargets)for(var e=0,f=d.numMorphTargets;e<
f;e++)k.deleteBuffer(d.__webglMorphTargetsBuffers[e]);if(void 0!==d.numMorphNormals){e=0;for(f=d.numMorphNormals;e<f;e++)k.deleteBuffer(d.__webglMorphNormalsBuffers[e])}b(d)}b(a);N.info.memory.geometries--},oc=function(a){a=a.target;a.removeEventListener("dispose",oc);a.image&&a.image.__webglTextureCube?k.deleteTexture(a.image.__webglTextureCube):a.__webglInit&&(a.__webglInit=!1,k.deleteTexture(a.__webglTexture));N.info.memory.textures--},R=function(a){a=a.target;a.removeEventListener("dispose",R);
if(a&&a.__webglTexture)if(k.deleteTexture(a.__webglTexture),a instanceof THREE.WebGLRenderTargetCube)for(var b=0;6>b;b++)k.deleteFramebuffer(a.__webglFramebuffer[b]),k.deleteRenderbuffer(a.__webglRenderbuffer[b]);else k.deleteFramebuffer(a.__webglFramebuffer),k.deleteRenderbuffer(a.__webglRenderbuffer);N.info.memory.textures--},pc=function(a){a=a.target;a.removeEventListener("dispose",pc);da(a)},da=function(a){var b=a.program;if(void 0!==b){a.program=void 0;var c,d,e=!1,a=0;for(c=fa.length;a<c;a++)if(d=
fa[a],d.program===b){d.usedTimes--;0===d.usedTimes&&(e=!0);break}if(!0===e){e=[];a=0;for(c=fa.length;a<c;a++)d=fa[a],d.program!==b&&e.push(d);fa=e;k.deleteProgram(b);N.info.memory.programs--}}};this.renderBufferImmediate=function(a,b,c){a.hasPositions&&!a.__webglVertexBuffer&&(a.__webglVertexBuffer=k.createBuffer());a.hasNormals&&!a.__webglNormalBuffer&&(a.__webglNormalBuffer=k.createBuffer());a.hasUvs&&!a.__webglUvBuffer&&(a.__webglUvBuffer=k.createBuffer());a.hasColors&&!a.__webglColorBuffer&&(a.__webglColorBuffer=
k.createBuffer());a.hasPositions&&(k.bindBuffer(k.ARRAY_BUFFER,a.__webglVertexBuffer),k.bufferData(k.ARRAY_BUFFER,a.positionArray,k.DYNAMIC_DRAW),k.enableVertexAttribArray(b.attributes.position),k.vertexAttribPointer(b.attributes.position,3,k.FLOAT,!1,0,0));if(a.hasNormals){k.bindBuffer(k.ARRAY_BUFFER,a.__webglNormalBuffer);if(c.shading===THREE.FlatShading){var d,e,f,g,h,i,j,l,m,p,n,q=3*a.count;for(n=0;n<q;n+=9)p=a.normalArray,d=p[n],e=p[n+1],f=p[n+2],g=p[n+3],i=p[n+4],l=p[n+5],h=p[n+6],j=p[n+7],
m=p[n+8],d=(d+g+h)/3,e=(e+i+j)/3,f=(f+l+m)/3,p[n]=d,p[n+1]=e,p[n+2]=f,p[n+3]=d,p[n+4]=e,p[n+5]=f,p[n+6]=d,p[n+7]=e,p[n+8]=f}k.bufferData(k.ARRAY_BUFFER,a.normalArray,k.DYNAMIC_DRAW);k.enableVertexAttribArray(b.attributes.normal);k.vertexAttribPointer(b.attributes.normal,3,k.FLOAT,!1,0,0)}a.hasUvs&&c.map&&(k.bindBuffer(k.ARRAY_BUFFER,a.__webglUvBuffer),k.bufferData(k.ARRAY_BUFFER,a.uvArray,k.DYNAMIC_DRAW),k.enableVertexAttribArray(b.attributes.uv),k.vertexAttribPointer(b.attributes.uv,2,k.FLOAT,!1,
...
i();if(f instanceof THREE.Mesh)if(d=b.index){e=e.offsets;1<e.length&&(c=!0);for(var m=0,p=e.length;m<p;m++){var n=e[m].index;if(c){for(j in b)"index"!==j&&(g=a[j],f=b[j],l=f.itemSize,0<=g&&(k.bindBuffer(k.ARRAY_BUFFER,f.buffer),h(g),k.vertexAttribPointer(g,l,k.FLOAT,!1,0,4*n*l)));k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,d.buffer)}k.drawElements(k.TRIANGLES,e[m].count,k.UNSIGNED_SHORT,2*e[m].start);N.info.render.calls++;N.info.render.vertices+=e[m].count;N.info.render.faces+=e[m].count/3}}else{if(c)for(j in b)"index"!==
...
n=e(i,l),j.buffersNeedUpdate&&d(l,i),p=n.attributes&&q(n),j.verticesNeedUpdate||j.morphTargetsNeedUpdate||j.elementsNeedUpdate||j.uvsNeedUpdate||j.normalsNeedUpdate||j.colorsNeedUpdate||j.tangentsNeedUpdate||p){var C=l,J=i,G=k.DYNAMIC_DRAW,I=!j.dynamic,H=n;if(C.__inittedArrays){var L=f(H),K=H.vertexColors?H.vertexColors:!1,N=g(H),M=L===THREE.SmoothShading,D=void 0,A=void 0,fa=void 0,O=void 0,U=void 0,R=void 0,P=void 0,W=void 0,V=void 0,Z=void 0,la=void 0,S=void 0,T=void 0,Q=void 0,aa=void 0,ta=void 0,
ca=void 0,da=void 0,Ya=void 0,ea=void 0,ga=void 0,ia=void 0,ib=void 0,ha=void 0,ka=void 0,pa=void 0,na=void 0,oa=void 0,Ja=void 0,db=void 0,xa=void 0,qa=void 0,va=void 0,Aa=void 0,Pa=void 0,wa=void 0,$a=void 0,La=void 0,Sa=void 0,Ua=void 0,ab=void 0,jb=void 0,Wa=void 0,Xa=void 0,Qa=void 0,Ra=void 0,Ka=0,Oa=0,Ta=0,Za=0,xb=0,gb=0,Ba=0,lb=0,Na=0,Y=0,ja=0,w=0,ya=void 0,bb=C.__vertexArray,kb=C.__uvArray,rb=C.__uv2Array,yb=C.__normalArray,Fa=C.__tangentArray,cb=C.__colorArray,Ga=C.__skinIndexArray,Ha=C.__skinWeightArray,
Bb=C.__morphTargetsArrays,Cb=C.__morphNormalsArrays,Db=C.__webglCustomAttributesList,v=void 0,Gb=C.__faceArray,tb=C.__lineArray,nb=J.geometry,Ob=nb.elementsNeedUpdate,Lb=nb.uvsNeedUpdate,Pb=nb.normalsNeedUpdate,Tb=nb.tangentsNeedUpdate,Ub=nb.colorsNeedUpdate,ec=nb.morphTargetsNeedUpdate,Wb=nb.vertices,ra=C.faces3,sa=C.faces4,hb=nb.faces,Vb=nb.faceVertexUvs[0],Pc=nb.faceVertexUvs[1],Xb=nb.skinIndices,Qb=nb.skinWeights,Rb=nb.morphTargets,qc=nb.morphNormals;if(nb.verticesNeedUpdate){D=0;for(A=ra.length;D<
A;D++)O=hb[ra[D]],S=Wb[O.a],T=Wb[O.b],Q=Wb[O.c],bb[Oa]=S.x,bb[Oa+1]=S.y,bb[Oa+2]=S.z,bb[Oa+3]=T.x,bb[Oa+4]=T.y,bb[Oa+5]=T.z,bb[Oa+6]=Q.x,bb[Oa+7]=Q.y,bb[Oa+8]=Q.z,Oa+=9;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=Wb[O.a],T=Wb[O.b],Q=Wb[O.c],aa=Wb[O.d],bb[Oa]=S.x,bb[Oa+1]=S.y,bb[Oa+2]=S.z,bb[Oa+3]=T.x,bb[Oa+4]=T.y,bb[Oa+5]=T.z,bb[Oa+6]=Q.x,bb[Oa+7]=Q.y,bb[Oa+8]=Q.z,bb[Oa+9]=aa.x,bb[Oa+10]=aa.y,bb[Oa+11]=aa.z,Oa+=12;k.bindBuffer(k.ARRAY_BUFFER,C.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,bb,G)}if(ec){ab=
0;for(jb=Rb.length;ab<jb;ab++){D=ja=0;for(A=ra.length;D<A;D++)Qa=ra[D],O=hb[Qa],S=Rb[ab].vertices[O.a],T=Rb[ab].vertices[O.b],Q=Rb[ab].vertices[O.c],Wa=Bb[ab],Wa[ja]=S.x,Wa[ja+1]=S.y,Wa[ja+2]=S.z,Wa[ja+3]=T.x,Wa[ja+4]=T.y,Wa[ja+5]=T.z,Wa[ja+6]=Q.x,Wa[ja+7]=Q.y,Wa[ja+8]=Q.z,H.morphNormals&&(M?(Ra=qc[ab].vertexNormals[Qa],ea=Ra.a,ga=Ra.b,ia=Ra.c):ia=ga=ea=qc[ab].faceNormals[Qa],Xa=Cb[ab],Xa[ja]=ea.x,Xa[ja+1]=ea.y,Xa[ja+2]=ea.z,Xa[ja+3]=ga.x,Xa[ja+4]=ga.y,Xa[ja+5]=ga.z,Xa[ja+6]=ia.x,Xa[ja+7]=ia.y,Xa[ja+
8]=ia.z),ja+=9;D=0;for(A=sa.length;D<A;D++)Qa=sa[D],O=hb[Qa],S=Rb[ab].vertices[O.a],T=Rb[ab].vertices[O.b],Q=Rb[ab].vertices[O.c],aa=Rb[ab].vertices[O.d],Wa=Bb[ab],Wa[ja]=S.x,Wa[ja+1]=S.y,Wa[ja+2]=S.z,Wa[ja+3]=T.x,Wa[ja+4]=T.y,Wa[ja+5]=T.z,Wa[ja+6]=Q.x,Wa[ja+7]=Q.y,Wa[ja+8]=Q.z,Wa[ja+9]=aa.x,Wa[ja+10]=aa.y,Wa[ja+11]=aa.z,H.morphNormals&&(M?(Ra=qc[ab].vertexNormals[Qa],ea=Ra.a,ga=Ra.b,ia=Ra.c,ib=Ra.d):ib=ia=ga=ea=qc[ab].faceNormals[Qa],Xa=Cb[ab],Xa[ja]=ea.x,Xa[ja+1]=ea.y,Xa[ja+2]=ea.z,Xa[ja+3]=ga.x,
Xa[ja+4]=ga.y,Xa[ja+5]=ga.z,Xa[ja+6]=ia.x,Xa[ja+7]=ia.y,Xa[ja+8]=ia.z,Xa[ja+9]=ib.x,Xa[ja+10]=ib.y,Xa[ja+11]=ib.z),ja+=12;k.bindBuffer(k.ARRAY_BUFFER,C.__webglMorphTargetsBuffers[ab]);k.bufferData(k.ARRAY_BUFFER,Bb[ab],G);H.morphNormals&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglMorphNormalsBuffers[ab]),k.bufferData(k.ARRAY_BUFFER,Cb[ab],G))}}if(Qb.length){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],oa=Qb[O.a],Ja=Qb[O.b],db=Qb[O.c],Ha[Y]=oa.x,Ha[Y+1]=oa.y,Ha[Y+2]=oa.z,Ha[Y+3]=oa.w,Ha[Y+4]=Ja.x,Ha[Y+5]=Ja.y,
Ha[Y+6]=Ja.z,Ha[Y+7]=Ja.w,Ha[Y+8]=db.x,Ha[Y+9]=db.y,Ha[Y+10]=db.z,Ha[Y+11]=db.w,qa=Xb[O.a],va=Xb[O.b],Aa=Xb[O.c],Ga[Y]=qa.x,Ga[Y+1]=qa.y,Ga[Y+2]=qa.z,Ga[Y+3]=qa.w,Ga[Y+4]=va.x,Ga[Y+5]=va.y,Ga[Y+6]=va.z,Ga[Y+7]=va.w,Ga[Y+8]=Aa.x,Ga[Y+9]=Aa.y,Ga[Y+10]=Aa.z,Ga[Y+11]=Aa.w,Y+=12;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],oa=Qb[O.a],Ja=Qb[O.b],db=Qb[O.c],xa=Qb[O.d],Ha[Y]=oa.x,Ha[Y+1]=oa.y,Ha[Y+2]=oa.z,Ha[Y+3]=oa.w,Ha[Y+4]=Ja.x,Ha[Y+5]=Ja.y,Ha[Y+6]=Ja.z,Ha[Y+7]=Ja.w,Ha[Y+8]=db.x,Ha[Y+9]=db.y,Ha[Y+10]=db.z,
Ha[Y+11]=db.w,Ha[Y+12]=xa.x,Ha[Y+13]=xa.y,Ha[Y+14]=xa.z,Ha[Y+15]=xa.w,qa=Xb[O.a],va=Xb[O.b],Aa=Xb[O.c],Pa=Xb[O.d],Ga[Y]=qa.x,Ga[Y+1]=qa.y,Ga[Y+2]=qa.z,Ga[Y+3]=qa.w,Ga[Y+4]=va.x,Ga[Y+5]=va.y,Ga[Y+6]=va.z,Ga[Y+7]=va.w,Ga[Y+8]=Aa.x,Ga[Y+9]=Aa.y,Ga[Y+10]=Aa.z,Ga[Y+11]=Aa.w,Ga[Y+12]=Pa.x,Ga[Y+13]=Pa.y,Ga[Y+14]=Pa.z,Ga[Y+15]=Pa.w,Y+=16;0<Y&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglSkinIndicesBuffer),k.bufferData(k.ARRAY_BUFFER,Ga,G),k.bindBuffer(k.ARRAY_BUFFER,C.__webglSkinWeightsBuffer),k.bufferData(k.ARRAY_BUFFER,
Ha,G))}if(Ub&&K){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],P=O.vertexColors,W=O.color,3===P.length&&K===THREE.VertexColors?(ha=P[0],ka=P[1],pa=P[2]):pa=ka=ha=W,cb[Na]=ha.r,cb[Na+1]=ha.g,cb[Na+2]=ha.b,cb[Na+3]=ka.r,cb[Na+4]=ka.g,cb[Na+5]=ka.b,cb[Na+6]=pa.r,cb[Na+7]=pa.g,cb[Na+8]=pa.b,Na+=9;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],P=O.vertexColors,W=O.color,4===P.length&&K===THREE.VertexColors?(ha=P[0],ka=P[1],pa=P[2],na=P[3]):na=pa=ka=ha=W,cb[Na]=ha.r,cb[Na+1]=ha.g,cb[Na+2]=ha.b,cb[Na+3]=ka.r,cb[Na+4]=
ka.g,cb[Na+5]=ka.b,cb[Na+6]=pa.r,cb[Na+7]=pa.g,cb[Na+8]=pa.b,cb[Na+9]=na.r,cb[Na+10]=na.g,cb[Na+11]=na.b,Na+=12;0<Na&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,cb,G))}if(Tb&&nb.hasTangents){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Ba+=12;D=0;for(A=sa.length;D<
A;D++)O=hb[sa[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Ya=V[3],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Fa[Ba+12]=Ya.x,Fa[Ba+13]=Ya.y,Fa[Ba+14]=Ya.z,Fa[Ba+15]=Ya.w,Ba+=16;k.bindBuffer(k.ARRAY_BUFFER,C.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Fa,G)}if(Pb&&L){D=0;for(A=ra.length;D<A;D++)if(O=hb[ra[D]],U=O.vertexNormals,R=O.normal,3===U.length&&M)for(wa=0;3>wa;wa++)La=
U[wa],yb[gb]=La.x,yb[gb+1]=La.y,yb[gb+2]=La.z,gb+=3;else for(wa=0;3>wa;wa++)yb[gb]=R.x,yb[gb+1]=R.y,yb[gb+2]=R.z,gb+=3;D=0;for(A=sa.length;D<A;D++)if(O=hb[sa[D]],U=O.vertexNormals,R=O.normal,4===U.length&&M)for(wa=0;4>wa;wa++)La=U[wa],yb[gb]=La.x,yb[gb+1]=La.y,yb[gb+2]=La.z,gb+=3;else for(wa=0;4>wa;wa++)yb[gb]=R.x,yb[gb+1]=R.y,yb[gb+2]=R.z,gb+=3;k.bindBuffer(k.ARRAY_BUFFER,C.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yb,G)}if(Lb&&Vb&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],Z=Vb[fa],void 0!==
Z)for(wa=0;3>wa;wa++)Sa=Z[wa],kb[Ta]=Sa.x,kb[Ta+1]=Sa.y,Ta+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],Z=Vb[fa],void 0!==Z)for(wa=0;4>wa;wa++)Sa=Z[wa],kb[Ta]=Sa.x,kb[Ta+1]=Sa.y,Ta+=2;0<Ta&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,kb,G))}if(Lb&&Pc&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],la=Pc[fa],void 0!==la)for(wa=0;3>wa;wa++)Ua=la[wa],rb[Za]=Ua.x,rb[Za+1]=Ua.y,Za+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],la=Pc[fa],void 0!==la)for(wa=0;4>wa;wa++)Ua=la[wa],rb[Za]=
Ua.x,rb[Za+1]=Ua.y,Za+=2;0<Za&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,rb,G))}if(Ob){D=0;for(A=ra.length;D<A;D++)Gb[xb]=Ka,Gb[xb+1]=Ka+1,Gb[xb+2]=Ka+2,xb+=3,tb[lb]=Ka,tb[lb+1]=Ka+1,tb[lb+2]=Ka,tb[lb+3]=Ka+2,tb[lb+4]=Ka+1,tb[lb+5]=Ka+2,lb+=6,Ka+=3;D=0;for(A=sa.length;D<A;D++)Gb[xb]=Ka,Gb[xb+1]=Ka+1,Gb[xb+2]=Ka+3,Gb[xb+3]=Ka+1,Gb[xb+4]=Ka+2,Gb[xb+5]=Ka+3,xb+=6,tb[lb]=Ka,tb[lb+1]=Ka+1,tb[lb+2]=Ka,tb[lb+3]=Ka+3,tb[lb+4]=Ka+1,tb[lb+5]=Ka+2,tb[lb+6]=Ka+2,tb[lb+7]=Ka+
3,lb+=8,Ka+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Gb,G);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,tb,G)}if(Db){wa=0;for($a=Db.length;wa<$a;wa++)if(v=Db[wa],v.__original.needsUpdate){w=0;if(1===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],w+=3;D=0;for(A=sa.length;D<A;D++)O=
hb[sa[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],v.array[w+3]=v.value[O.d],w+=4}else{if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],v.array[w]=ya,v.array[w+1]=ya,v.array[w+2]=ya,w+=3;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],v.array[w]=ya,v.array[w+1]=ya,v.array[w+2]=ya,v.array[w+3]=ya,w+=4}}else if(2===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],
v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,w+=6;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,v.array[w+6]=aa.x,v.array[w+7]=aa.y,w+=8}else{if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+
4]=Q.x,v.array[w+5]=Q.y,w+=6;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,v.array[w+6]=aa.x,v.array[w+7]=aa.y,w+=8}}else if(3===v.size){var X;X="c"===v.type?["r","g","b"]:["x","y","z"];if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=
T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}else if("faces"===v.boundTo){D=
0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],
v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}else if("faceVertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],S=ya[0],T=ya[1],Q=ya[2],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],w+=9;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],S=ya[0],T=ya[1],Q=ya[2],aa=ya[3],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=
T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}}else if(4===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=hb[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=
Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)O=hb[sa[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],aa=v.value[O.d],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,v.array[w+12]=aa.x,v.array[w+13]=aa.y,v.array[w+14]=aa.z,v.array[w+15]=aa.w,w+=16}else if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)Q=T=S=ya=v.value[ra[D]],
v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,v.array[w+12]=aa.x,v.array[w+13]=
aa.y,v.array[w+14]=aa.z,v.array[w+15]=aa.w,w+=16}else if("faceVertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],S=ya[0],T=ya[1],Q=ya[2],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=Q.y,v.array[w+10]=Q.z,v.array[w+11]=Q.w,w+=12;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],S=ya[0],T=ya[1],Q=ya[2],aa=ya[3],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+
...
delete C.__skinIndexArray,delete C.__skinWeightArray)}}j.verticesNeedUpdate=!1;j.morphTargetsNeedUpdate=!1;j.elementsNeedUpdate=!1;j.uvsNeedUpdate=!1;j.normalsNeedUpdate=!1;j.colorsNeedUpdate=!1;j.tangentsNeedUpdate=!1;j.buffersNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof THREE.Ribbon){n=e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||j.colorsNeedUpdate||j.normalsNeedUpdate||p){var zb=j,rc=k.DYNAMIC_DRAW,hc=void 0,ic=void 0,jc=void 0,sc=void 0,za=void 0,tc=void 0,uc=void 0,vc=void 0,
cc=void 0,eb=void 0,$b=void 0,Da=void 0,ob=void 0,dc=zb.vertices,fc=zb.colors,gc=zb.normals,oc=dc.length,pc=fc.length,Gc=gc.length,wc=zb.__vertexArray,xc=zb.__colorArray,yc=zb.__normalArray,Hc=zb.colorsNeedUpdate,Ic=zb.normalsNeedUpdate,Qc=zb.__webglCustomAttributesList;if(zb.verticesNeedUpdate){for(hc=0;hc<oc;hc++)sc=dc[hc],za=3*hc,wc[za]=sc.x,wc[za+1]=sc.y,wc[za+2]=sc.z;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,wc,rc)}if(Hc){for(ic=0;ic<pc;ic++)tc=fc[ic],za=
3*ic,xc[za]=tc.r,xc[za+1]=tc.g,xc[za+2]=tc.b;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,xc,rc)}if(Ic){for(jc=0;jc<Gc;jc++)uc=gc[jc],za=3*jc,yc[za]=uc.x,yc[za+1]=uc.y,yc[za+2]=uc.z;k.bindBuffer(k.ARRAY_BUFFER,zb.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yc,rc)}if(Qc){vc=0;for(cc=Qc.length;vc<cc;vc++)if(Da=Qc[vc],Da.needsUpdate&&(void 0===Da.boundTo||"vertices"===Da.boundTo)){za=0;$b=Da.value.length;if(1===Da.size)for(eb=0;eb<$b;eb++)Da.array[eb]=Da.value[eb];
else if(2===Da.size)for(eb=0;eb<$b;eb++)ob=Da.value[eb],Da.array[za]=ob.x,Da.array[za+1]=ob.y,za+=2;else if(3===Da.size)if("c"===Da.type)for(eb=0;eb<$b;eb++)ob=Da.value[eb],Da.array[za]=ob.r,Da.array[za+1]=ob.g,Da.array[za+2]=ob.b,za+=3;else for(eb=0;eb<$b;eb++)ob=Da.value[eb],Da.array[za]=ob.x,Da.array[za+1]=ob.y,Da.array[za+2]=ob.z,za+=3;else if(4===Da.size)for(eb=0;eb<$b;eb++)ob=Da.value[eb],Da.array[za]=ob.x,Da.array[za+1]=ob.y,Da.array[za+2]=ob.z,Da.array[za+3]=ob.w,za+=4;k.bindBuffer(k.ARRAY_BUFFER,
Da.buffer);k.bufferData(k.ARRAY_BUFFER,Da.array,rc)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.normalsNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof THREE.Line){n=e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||j.colorsNeedUpdate||j.lineDistancesNeedUpdate||p){var Ab=j,zc=k.DYNAMIC_DRAW,kc=void 0,lc=void 0,mc=void 0,Ac=void 0,Ia=void 0,Bc=void 0,Vc=Ab.vertices,Wc=Ab.colors,Xc=Ab.lineDistances,Jc=Vc.length,Kc=Wc.length,Lc=Xc.length,Cc=Ab.__vertexArray,Dc=Ab.__colorArray,Yc=Ab.__lineDistanceArray,
Mc=Ab.colorsNeedUpdate,cd=Ab.lineDistancesNeedUpdate,Rc=Ab.__webglCustomAttributesList,Ec=void 0,Zc=void 0,fb=void 0,ac=void 0,pb=void 0,Ea=void 0;if(Ab.verticesNeedUpdate){for(kc=0;kc<Jc;kc++)Ac=Vc[kc],Ia=3*kc,Cc[Ia]=Ac.x,Cc[Ia+1]=Ac.y,Cc[Ia+2]=Ac.z;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Cc,zc)}if(Mc){for(lc=0;lc<Kc;lc++)Bc=Wc[lc],Ia=3*lc,Dc[Ia]=Bc.r,Dc[Ia+1]=Bc.g,Dc[Ia+2]=Bc.b;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,
Dc,zc)}if(cd){for(mc=0;mc<Lc;mc++)Yc[mc]=Xc[mc];k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,Yc,zc)}if(Rc){Ec=0;for(Zc=Rc.length;Ec<Zc;Ec++)if(Ea=Rc[Ec],Ea.needsUpdate&&(void 0===Ea.boundTo||"vertices"===Ea.boundTo)){Ia=0;ac=Ea.value.length;if(1===Ea.size)for(fb=0;fb<ac;fb++)Ea.array[fb]=Ea.value[fb];else if(2===Ea.size)for(fb=0;fb<ac;fb++)pb=Ea.value[fb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ia+=2;else if(3===Ea.size)if("c"===Ea.type)for(fb=0;fb<ac;fb++)pb=
Ea.value[fb],Ea.array[Ia]=pb.r,Ea.array[Ia+1]=pb.g,Ea.array[Ia+2]=pb.b,Ia+=3;else for(fb=0;fb<ac;fb++)pb=Ea.value[fb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ea.array[Ia+2]=pb.z,Ia+=3;else if(4===Ea.size)for(fb=0;fb<ac;fb++)pb=Ea.value[fb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ea.array[Ia+2]=pb.z,Ea.array[Ia+3]=pb.w,Ia+=4;k.bindBuffer(k.ARRAY_BUFFER,Ea.buffer);k.bufferData(k.ARRAY_BUFFER,Ea.array,zc)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.lineDistancesNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof
THREE.ParticleSystem){n=e(i,j);p=n.attributes&&q(n);if(j.verticesNeedUpdate||j.colorsNeedUpdate||i.sortParticles||p){var Hb=j,Sc=k.DYNAMIC_DRAW,nc=i,qb=void 0,Ib=void 0,Jb=void 0,ba=void 0,Kb=void 0,Sb=void 0,Fc=Hb.vertices,Tc=Fc.length,Uc=Hb.colors,$c=Uc.length,Yb=Hb.__vertexArray,Zb=Hb.__colorArray,Mb=Hb.__sortArray,ad=Hb.verticesNeedUpdate,bd=Hb.colorsNeedUpdate,Nb=Hb.__webglCustomAttributesList,Eb=void 0,bc=void 0,ma=void 0,Fb=void 0,Ca=void 0,$=void 0;if(nc.sortParticles){sb.copy(Va);sb.multiply(nc.matrixWorld);
for(qb=0;qb<Tc;qb++)Jb=Fc[qb],Ma.copy(Jb),Ma.applyProjection(sb),Mb[qb]=[Ma.z,qb];Mb.sort(m);for(qb=0;qb<Tc;qb++)Jb=Fc[Mb[qb][1]],ba=3*qb,Yb[ba]=Jb.x,Yb[ba+1]=Jb.y,Yb[ba+2]=Jb.z;for(Ib=0;Ib<$c;Ib++)ba=3*Ib,Sb=Uc[Mb[Ib][1]],Zb[ba]=Sb.r,Zb[ba+1]=Sb.g,Zb[ba+2]=Sb.b;if(Nb){Eb=0;for(bc=Nb.length;Eb<bc;Eb++)if($=Nb[Eb],void 0===$.boundTo||"vertices"===$.boundTo)if(ba=0,Fb=$.value.length,1===$.size)for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],$.array[ma]=$.value[Kb];else if(2===$.size)for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],
Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,ba+=2;else if(3===$.size)if("c"===$.type)for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],Ca=$.value[Kb],$.array[ba]=Ca.r,$.array[ba+1]=Ca.g,$.array[ba+2]=Ca.b,ba+=3;else for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,ba+=3;else if(4===$.size)for(ma=0;ma<Fb;ma++)Kb=Mb[ma][1],Ca=$.value[Kb],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,$.array[ba+3]=Ca.w,ba+=4}}else{if(ad)for(qb=0;qb<Tc;qb++)Jb=Fc[qb],
ba=3*qb,Yb[ba]=Jb.x,Yb[ba+1]=Jb.y,Yb[ba+2]=Jb.z;if(bd)for(Ib=0;Ib<$c;Ib++)Sb=Uc[Ib],ba=3*Ib,Zb[ba]=Sb.r,Zb[ba+1]=Sb.g,Zb[ba+2]=Sb.b;if(Nb){Eb=0;for(bc=Nb.length;Eb<bc;Eb++)if($=Nb[Eb],$.needsUpdate&&(void 0===$.boundTo||"vertices"===$.boundTo))if(Fb=$.value.length,ba=0,1===$.size)for(ma=0;ma<Fb;ma++)$.array[ma]=$.value[ma];else if(2===$.size)for(ma=0;ma<Fb;ma++)Ca=$.value[ma],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,ba+=2;else if(3===$.size)if("c"===$.type)for(ma=0;ma<Fb;ma++)Ca=$.value[ma],$.array[ba]=
Ca.r,$.array[ba+1]=Ca.g,$.array[ba+2]=Ca.b,ba+=3;else for(ma=0;ma<Fb;ma++)Ca=$.value[ma],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,ba+=3;else if(4===$.size)for(ma=0;ma<Fb;ma++)Ca=$.value[ma],$.array[ba]=Ca.x,$.array[ba+1]=Ca.y,$.array[ba+2]=Ca.z,$.array[ba+3]=Ca.w,ba+=4}}if(ad||nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,Hb.__webglVertexBuffer),k.bufferData(k.ARRAY_BUFFER,Yb,Sc);if(bd||nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,Hb.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,Zb,
Sc);if(Nb){Eb=0;for(bc=Nb.length;Eb<bc;Eb++)if($=Nb[Eb],$.needsUpdate||nc.sortParticles)k.bindBuffer(k.ARRAY_BUFFER,$.buffer),k.bufferData(k.ARRAY_BUFFER,$.array,Sc)}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;n.attributes&&y(n)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h;a.addEventListener("dispose",pc);var i,j,l,m,p;a instanceof THREE.MeshDepthMaterial?p="depth":a instanceof THREE.MeshNormalMaterial?p="normal":a instanceof THREE.MeshBasicMaterial?p="basic":a instanceof THREE.MeshLambertMaterial?
p="lambert":a instanceof THREE.MeshPhongMaterial?p="phong":a instanceof THREE.LineBasicMaterial?p="basic":a instanceof THREE.LineDashedMaterial?p="dashed":a instanceof THREE.ParticleBasicMaterial&&(p="particle_basic");if(p){var n=THREE.ShaderLib[p];a.uniforms=THREE.UniformsUtils.clone(n.uniforms);a.vertexShader=n.vertexShader;a.fragmentShader=n.fragmentShader}var q,r,s;e=g=r=s=n=0;for(f=b.length;e<f;e++)q=b[e],q.onlyShadow||(q instanceof THREE.DirectionalLight&&g++,q instanceof THREE.PointLight&&
...
(C=0),I===ca&&(I=0),La[A]=d(s[A],s[C],s[I]);var ha=[],na,N=La.concat();H=0;for(K=p.length;H<K;H++){z=p[H];na=[];A=0;ca=z.length;C=ca-1;for(I=A+1;A<ca;A++,C++,I++)C===ca&&(C=0),I===ca&&(I=0),na[A]=d(z[A],z[C],z[I]);ha.push(na);N=N.concat(na)}for(C=0;C<m;C++){z=C/m;M=i*(1-z);I=j*Math.sin(z*Math.PI/2);A=0;for(ca=s.length;A<ca;A++)U=c(s[A],La[A],I),f(U.x,U.y,-M);H=0;for(K=p.length;H<K;H++){z=p[H];na=ha[H];A=0;for(ca=z.length;A<ca;A++)U=c(z[A],na[A],I),f(U.x,U.y,-M)}}I=j;for(A=0;A<ea;A++)U=l?c(B[A],N[A],
...
K;H++){z=p[H];na=ha[H];A=0;for(ca=z.length;A<ca;A++)U=c(z[A],na[A],I),q?f(U.x,U.y+n[r-1].y,n[r-1].x+M):f(U.x,U.y,h+M)}}if(l){i=0*ea;for(A=0;A<xa;A++)h=P[A],g(h[2]+i,h[1]+i,h[0]+i,!0);i=ea*(r+2*m);for(A=0;A<xa;A++)h=P[A],g(h[0]+i,h[1]+i,h[2]+i,!1)}else{for(A=0;A<xa;A++)h=P[A],g(h[2],h[1],h[0],!0);for(A=0;A<xa;A++)h=P[A],g(h[0]+ea*r,h[1]+ea*r,h[2]+ea*r,!1)}h=0;e(s,h);h+=s.length;H=0;for(K=p.length;H<K;H++)z=p[H],e(z,h),h+=z.length};
