...
g.mapLightWrap);g.mapBump&&j(m,"bumpMap",g.mapBump,g.mapBumpRepeat,g.mapBumpOffset,g.mapBumpWrap);g.mapNormal&&j(m,"normalMap",g.mapNormal,g.mapNormalRepeat,g.mapNormalOffset,g.mapNormalWrap);g.mapSpecular&&j(m,"specularMap",g.mapSpecular,g.mapSpecularRepeat,g.mapSpecularOffset,g.mapSpecularWrap);if(g.mapNormal){j=THREE.ShaderUtils.lib.normal;l=THREE.UniformsUtils.clone(j.uniforms);l.tNormal.texture=m.normalMap;if(g.mapNormalFactor)l.uNormalScale.value=g.mapNormalFactor;if(m.map){l.tDiffuse.texture=
m.map;l.enableDiffuse.value=true}if(m.specularMap){l.tSpecular.texture=m.specularMap;l.enableSpecular.value=true}if(m.lightMap){l.tAO.texture=m.lightMap;l.enableAO.value=true}l.uDiffuseColor.value.setHex(m.color);l.uSpecularColor.value.setHex(m.specular);l.uAmbientColor.value.setHex(m.ambient);l.uShininess.value=m.shininess;if(m.opacity!==void 0)l.uOpacity.value=m.opacity;m=new THREE.ShaderMaterial({fragmentShader:j.fragmentShader,vertexShader:j.vertexShader,uniforms:l,lights:true,fog:true})}else m=
new THREE[n](m);if(g.DbgName!==void 0)m.name=g.DbgName;d.materials[e]=m}}var g=a.faces,p=a.vertices,m=a.normals,j=a.colors,l=0;if(a.uvs)for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&l++;for(e=0;e<l;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}n=0;for(q=p.length;n<q;){var o=new THREE.Vector3;o.x=p[n++]*f;o.y=p[n++]*f;o.z=p[n++]*f;d.vertices.push(o)}n=0;for(q=g.length;n<q;){var r=g[n++],t=r&2,e=r&4,u=r&8,v=r&16,p=r&32,s=r&64,o=r&128;if(r&1){r=new THREE.Face4;r.a=g[n++];r.b=g[n++];r.c=g[n++];r.d=g[n++];
var A=4}else{r=new THREE.Face3;r.a=g[n++];r.b=g[n++];r.c=g[n++];A=3}if(t){t=g[n++];r.materialIndex=t}var y=d.faces.length;if(e)for(e=0;e<l;e++){var B=a.uvs[e],t=g[n++],I=B[t*2],t=B[t*2+1];d.faceUvs[e][y]=new THREE.UV(I,t)}if(u)for(e=0;e<l;e++){for(var B=a.uvs[e],u=[],x=0;x<A;x++){t=g[n++];I=B[t*2];t=B[t*2+1];u[x]=new THREE.UV(I,t)}d.faceVertexUvs[e][y]=u}if(v){v=g[n++]*3;t=new THREE.Vector3;t.x=m[v++];t.y=m[v++];t.z=m[v];r.normal=t}if(p)for(e=0;e<A;e++){v=g[n++]*3;t=new THREE.Vector3;t.x=m[v++];t.y=
m[v++];t.z=m[v];r.vertexNormals.push(t)}if(s){p=g[n++];r.color=new THREE.Color(j[p])}if(o)for(e=0;e<A;e++){p=g[n++];r.vertexColors.push(new THREE.Color(j[p]))}d.faces.push(r)}if(a.skinWeights){e=0;for(g=a.skinWeights.length;e<g;e=e+2)d.skinWeights.push(new THREE.Vector4(a.skinWeights[e],a.skinWeights[e+1],0,0))}if(a.skinIndices){e=0;for(g=a.skinIndices.length;e<g;e=e+2){m=0;d.skinIndices.push(new THREE.Vector4(a.skinIndices[e],a.skinIndices[e+1],m,0))}}d.bones=a.bones;d.animation=a.animation;if(a.morphTargets){e=
0;for(g=a.morphTargets.length;e<g;e++){d.morphTargets[e]={};d.morphTargets[e].name=a.morphTargets[e].name;d.morphTargets[e].vertices=[];m=d.morphTargets[e].vertices;j=a.morphTargets[e].vertices;t=0;for(l=j.length;t<l;t=t+3){o=new THREE.Vector3;o.x=j[t]*f;o.y=j[t+1]*f;o.z=j[t+2]*f;m.push(o)}}}if(a.morphColors){e=0;for(g=a.morphColors.length;e<g;e++){d.morphColors[e]={};d.morphColors[e].name=a.morphColors[e].name;d.morphColors[e].colors=[];f=d.morphColors[e].colors;j=a.morphColors[e].colors;m=0;for(l=
j.length;m<l;m=m+3){n=new THREE.Color(16755200);n.setRGB(j[m],j[m+1],j[m+2]);f.push(n)}}}d.computeCentroids();d.computeFaceNormals();return d}};THREE.SceneLoader=function(){this.onLoadStart=function(){};this.onLoadProgress=function(){};this.onLoadComplete=function(){};this.callbackSync=function(){};this.callbackProgress=function(){}};THREE.SceneLoader.prototype.constructor=THREE.SceneLoader;
...
e=true}if(e||a!==aa){k.uniformMatrix4fv(h.projectionMatrix,false,a._projectionMatrixArray);a!==aa&&(aa=a)}if(e){if(c&&d.fog){i.fogColor.value=c.color;if(c instanceof THREE.Fog){i.fogNear.value=c.near;i.fogFar.value=c.far}else if(c instanceof THREE.FogExp2)i.fogDensity.value=c.density}if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if(Va){for(var j,l=0,m=0,n=0,o,p,q,s=ib,r=s.directional.colors,u=s.directional.positions,v=s.point.colors,A=s.point.positions,
B=s.point.distances,C=s.spot.colors,I=s.spot.positions,G=s.spot.distances,E=s.spot.directions,O=s.spot.angles,L=s.spot.exponents,F=0,N=0,P=0,J=q=0,c=J=0,e=b.length;c<e;c++){j=b[c];if(!j.onlyShadow&&j.visible){o=j.color;p=j.intensity;q=j.distance;if(j instanceof THREE.AmbientLight)if(K.gammaInput){l=l+o.r*o.r;m=m+o.g*o.g;n=n+o.b*o.b}else{l=l+o.r;m=m+o.g;n=n+o.b}else if(j instanceof THREE.DirectionalLight){q=F*3;if(K.gammaInput){r[q]=o.r*o.r*p*p;r[q+1]=o.g*o.g*p*p;r[q+2]=o.b*o.b*p*p}else{r[q]=o.r*p;
r[q+1]=o.g*p;r[q+2]=o.b*p}Ka.copy(j.matrixWorld.getPosition());Ka.subSelf(j.target.matrixWorld.getPosition());Ka.normalize();u[q]=Ka.x;u[q+1]=Ka.y;u[q+2]=Ka.z;F=F+1}else if(j instanceof THREE.PointLight){J=N*3;if(K.gammaInput){v[J]=o.r*o.r*p*p;v[J+1]=o.g*o.g*p*p;v[J+2]=o.b*o.b*p*p}else{v[J]=o.r*p;v[J+1]=o.g*p;v[J+2]=o.b*p}o=j.matrixWorld.getPosition();A[J]=o.x;A[J+1]=o.y;A[J+2]=o.z;B[N]=q;N=N+1}else if(j instanceof THREE.SpotLight){J=P*3;if(K.gammaInput){C[J]=o.r*o.r*p*p;C[J+1]=o.g*o.g*p*p;C[J+2]=
o.b*o.b*p*p}else{C[J]=o.r*p;C[J+1]=o.g*p;C[J+2]=o.b*p}o=j.matrixWorld.getPosition();I[J]=o.x;I[J+1]=o.y;I[J+2]=o.z;G[P]=q;Ka.copy(o);Ka.subSelf(j.target.matrixWorld.getPosition());Ka.normalize();E[J]=Ka.x;E[J+1]=Ka.y;E[J+2]=Ka.z;O[P]=Math.cos(j.angle);L[P]=j.exponent;P=P+1}}}c=F*3;for(e=r.length;c<e;c++)r[c]=0;c=N*3;for(e=v.length;c<e;c++)v[c]=0;c=P*3;for(e=C.length;c<e;c++)C[c]=0;s.directional.length=F;s.point.length=N;s.spot.length=P;s.ambient[0]=l;s.ambient[1]=m;s.ambient[2]=n;Va=false}c=ib;i.ambientLightColor.value=
...
!j.shadowCascade)){i.shadowMap.value[M]=j.shadowMap;i.shadowMapSize.value[M]=j.shadowMapSize;i.shadowMatrix.value[M]=j.shadowMatrix;i.shadowDarkness.value[M]=j.shadowDarkness;i.shadowBias.value[M]=j.shadowBias;M++}}}b=d.uniformsList;i=0;for(M=b.length;i<M;i++)if(e=g.uniforms[b[i][1]]){c=b[i][0];l=c.type;j=c.value;if(l==="i")k.uniform1i(e,j);else if(l==="f")k.uniform1f(e,j);else if(l==="v2")k.uniform2f(e,j.x,j.y);else if(l==="v3")k.uniform3f(e,j.x,j.y,j.z);else if(l==="v4")k.uniform4f(e,j.x,j.y,j.z,
j.w);else if(l==="c")k.uniform3f(e,j.r,j.g,j.b);else if(l==="iv1")k.uniform1iv(e,j);else if(l==="iv")k.uniform3iv(e,j);else if(l==="fv1")k.uniform1fv(e,j);else if(l==="fv")k.uniform3fv(e,j);else if(l==="v2v"){if(c._array===void 0)c._array=new Float32Array(2*j.length);l=0;for(m=j.length;l<m;l++){n=l*2;c._array[n]=j[l].x;c._array[n+1]=j[l].y}k.uniform2fv(e,c._array)}else if(l==="v3v"){if(c._array===void 0)c._array=new Float32Array(3*j.length);l=0;for(m=j.length;l<m;l++){n=l*3;c._array[n]=j[l].x;c._array[n+
1]=j[l].y;c._array[n+2]=j[l].z}k.uniform3fv(e,c._array)}else if(l==="v4v"){if(c._array===void 0)c._array=new Float32Array(4*j.length);l=0;for(m=j.length;l<m;l++){n=l*4;c._array[n]=j[l].x;c._array[n+1]=j[l].y;c._array[n+2]=j[l].z;c._array[n+3]=j[l].w}k.uniform4fv(e,c._array)}else if(l==="m4"){if(c._array===void 0)c._array=new Float32Array(16);j.flattenToArray(c._array);k.uniformMatrix4fv(e,false,c._array)}else if(l==="m4v"){if(c._array===void 0)c._array=new Float32Array(16*j.length);l=0;for(m=j.length;l<
m;l++)j[l].flattenToArrayOffset(c._array,l*16);k.uniformMatrix4fv(e,false,c._array)}else if(l==="t"){n=j;j=t();k.uniform1i(e,j);if(n)if(n.image instanceof Array&&n.image.length===6){c=n;e=j;if(c.image.length===6)if(c.needsUpdate){if(!c.image.__webglTextureCube)c.image.__webglTextureCube=k.createTexture();k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);k.pixelStorei(k.UNPACK_FLIP_Y_WEBGL,c.flipY);e=[];for(j=0;j<6;j++)if(K.autoScaleCubemaps){l=e;m=j;n=c.image[j];
r=Rc;if(!(n.width<=r&&n.height<=r)){u=Math.max(n.width,n.height);s=Math.floor(n.width*r/u);r=Math.floor(n.height*r/u);u=document.createElement("canvas");u.width=s;u.height=r;u.getContext("2d").drawImage(n,0,0,n.width,n.height,0,0,s,r);n=u}l[m]=n}else e[j]=c.image[j];j=e[0];l=(j.width&j.width-1)===0&&(j.height&j.height-1)===0;m=x(c.format);n=x(c.type);y(k.TEXTURE_CUBE_MAP,c,l);for(j=0;j<6;j++)k.texImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,m,m,n,e[j]);c.generateMipmaps&&l&&k.generateMipmap(k.TEXTURE_CUBE_MAP);
c.needsUpdate=false;if(c.onUpdate)c.onUpdate()}else{k.activeTexture(k.TEXTURE0+e);k.bindTexture(k.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}}else if(n instanceof THREE.WebGLRenderTargetCube){c=n;k.activeTexture(k.TEXTURE0+j);k.bindTexture(k.TEXTURE_CUBE_MAP,c.__webglTexture)}else K.setTexture(n,j)}else if(l==="tv"){if(c._array===void 0){c._array=[];l=0;for(m=c.value.length;l<m;l++)c._array[l]=t()}k.uniform1iv(e,c._array);l=0;for(m=c.value.length;l<m;l++){n=c.value[l];j=c._array[l];n&&K.setTexture(n,
j)}}}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&h.cameraPosition!==null){b=a.matrixWorld.getPosition();k.uniform3f(h.cameraPosition,b.x,b.y,b.z)}(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d instanceof THREE.ShaderMaterial||d.skinning)&&h.viewMatrix!==null&&k.uniformMatrix4fv(h.viewMatrix,false,a._viewMatrixArray)}if(d.skinning)if(dc&&f.useVertexTexture){if(h.boneTexture!==null){a=t();k.uniform1i(h.boneTexture,a);K.setTexture(f.boneTexture,
a)}}else h.boneGlobalMatrices!==null&&k.uniformMatrix4fv(h.boneGlobalMatrices,false,f.boneMatrices);k.uniformMatrix4fv(h.modelViewMatrix,false,f._modelViewMatrix.elements);h.normalMatrix&&k.uniformMatrix3fv(h.normalMatrix,false,f._normalMatrix.elements);h.modelMatrix!==null&&k.uniformMatrix4fv(h.modelMatrix,false,f.matrixWorld.elements);return g}function t(){var a=U;a>=qc&&console.warn("Trying to use "+a+" texture units while this GPU supports only "+qc);U=U+1;return a}function u(a,b){a._modelViewMatrix.multiply(b.matrixWorldInverse,
