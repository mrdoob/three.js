...
b?(console.warn("DEPRECATED: Matrix4's .multiply() now only accepts one argument. Use .multiplyMatrices( a, b ) instead."),this.multiplyMatrices(a,b)):this.multiplyMatrices(this,a)},multiplyMatrices:function(a,b){var c=a.elements,d=b.elements,e=this.elements,f=c[0],g=c[4],h=c[8],i=c[12],k=c[1],m=c[5],n=c[9],l=c[13],s=c[2],r=c[6],p=c[10],q=c[14],z=c[3],t=c[7],y=c[11],c=c[15],u=d[0],B=d[4],I=d[8],F=d[12],w=d[1],H=d[5],J=d[9],E=d[13],Z=d[2],A=d[6],S=d[10],D=d[14],G=d[3],K=d[7],N=d[11],d=d[15];e[0]=f*
u+g*w+h*Z+i*G;e[4]=f*B+g*H+h*A+i*K;e[8]=f*I+g*J+h*S+i*N;e[12]=f*F+g*E+h*D+i*d;e[1]=k*u+m*w+n*Z+l*G;e[5]=k*B+m*H+n*A+l*K;e[9]=k*I+m*J+n*S+l*N;e[13]=k*F+m*E+n*D+l*d;e[2]=s*u+r*w+p*Z+q*G;e[6]=s*B+r*H+p*A+q*K;e[10]=s*I+r*J+p*S+q*N;e[14]=s*F+r*E+p*D+q*d;e[3]=z*u+t*w+y*Z+c*G;e[7]=z*B+t*H+y*A+c*K;e[11]=z*I+t*J+y*S+c*N;e[15]=z*F+t*E+y*D+c*d;return this},multiplyToArray:function(a,b,c){var d=this.elements;this.multiplyMatrices(a,b);c[0]=d[0];c[1]=d[1];c[2]=d[2];c[3]=d[3];c[4]=d[4];c[5]=d[5];c[6]=d[6];c[7]=
...
a.Mesh){f.getPositionFromMatrix(h.matrixWorld);b.set(f,h.geometry.boundingSphere.radius*h.matrixWorld.getMaxScaleOnAxis());if(!i.ray.isIntersectionSphere(b))return k;var s=h.geometry,r=s.vertices,p=h.material instanceof a.MeshFaceMaterial,q=!0===p?h.material.materials:null,z=h.material.side,t,y,u,B=i.precision;h.matrixRotationWorld.copyRotation(h.matrixWorld);g.getInverse(h.matrixWorld);c.copy(i.ray).applyMatrix4(g);for(var I=0,F=s.faces.length;I<F;I++){var w=s.faces[I],z=!0===p?q[w.materialIndex]:
