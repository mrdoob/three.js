...
l.z=ha.z;G.elements.push(l)}}}else if(ka instanceof THREE.Line){Ma.multiplyMatrices(ea,xa);la=ka.geometry.vertices;W=b();W.positionScreen.copy(la[0]).applyMatrix4(Ma);kb=ka.type===THREE.LinePieces?2:1;ta=1;for(Z=la.length;ta<Z;ta++)W=b(),W.positionScreen.copy(la[ta]).applyMatrix4(Ma),0<(ta+1)%kb||(V=m[j-2],N.copy(W.positionScreen),fa.copy(V.positionScreen),!0===d(N,fa)&&(N.multiplyScalar(1/N.w),fa.multiplyScalar(1/fa.w),t===J?(Qa=new THREE.RenderableLine,E.push(Qa),J++,t++,x=Qa):x=E[t++],x.v1.positionScreen.copy(N),
...
b){if(P!==a||C!==b)t.setLineDash([a,b]),P=a,C=b}console.log("THREE.CanvasRenderer",THREE.REVISION);var j=THREE.Math.smoothstep,a=a||{},m=this,p,l,r,s=new THREE.Projector,n=void 0!==a.canvas?a.canvas:document.createElement("canvas"),q,y,u,x,t=n.getContext("2d"),E=new THREE.Color(0),J=0,F=1,z=0,H=null,K=null,G=null,L=null,B=null,P=null,C=0,I,M,U,ea,xa=new THREE.RenderableVertex,Ma=new THREE.RenderableVertex,A,ca,ha,na,N,fa,jb,Za,db,Ka,pa,ta,Z=new THREE.Color,la=new THREE.Color,W=new THREE.Color,V=new THREE.Color,
ia=new THREE.Color,ga=new THREE.Color,ka=new THREE.Color,Qa=new THREE.Color,kb={},oa={},Wa,Ra,Aa,Sa,rb,Ob,Lb,Pb,Tb,Ub,Ta=new THREE.Box2,va=new THREE.Box2,Ja=new THREE.Box2,sb=new THREE.Color,Na=new THREE.Color,qa=new THREE.Color,$a=new THREE.Vector3,Bb,k,Cb,Ua,lb,Va,Db=16;Bb=document.createElement("canvas");Bb.width=Bb.height=2;k=Bb.getContext("2d");k.fillStyle="rgba(0,0,0,1)";k.fillRect(0,0,2,2);Cb=k.getImageData(0,0,2,2);Ua=Cb.data;lb=document.createElement("canvas");lb.width=lb.height=Db;Va=lb.getContext("2d");
...
0;Ua[14]=255*d.b|0;k.putImageData(Cb,0,0);Va.drawImage(Bb,0,0);return lb}function G(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===n instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{!0===this.autoClear&&this.clear();t.setTransform(1,0,0,-1,u,x);m.info.render.vertices=0;m.info.render.faces=0;p=s.projectScene(a,n,this.sortObjects,this.sortElements);l=p.elements;r=p.lights;
sb.setRGB(0,0,0);Na.setRGB(0,0,0);qa.setRGB(0,0,0);for(var K=0,P=r.length;K<P;K++){var R=r[K],L=R.color;R instanceof THREE.AmbientLight?sb.add(L):R instanceof THREE.DirectionalLight?Na.add(L):R instanceof THREE.PointLight&&qa.add(L)}K=0;for(P=l.length;K<P;K++){var da=l[K],R=da.material;if(!(void 0===R||!1===R.visible)){Ja.makeEmpty();if(da instanceof THREE.RenderableParticle){I=da;I.x*=u;I.y*=x;var L=I,ua=da;b(R.opacity);c(R.blending);var ub=void 0,eb=void 0,vb=void 0,wb=void 0,Nc=da=void 0,Oc=void 0;
R instanceof THREE.ParticleBasicMaterial?null===R.map?(vb=ua.object.scale.x,wb=ua.object.scale.y,vb*=ua.scale.x*u,wb*=ua.scale.y*x,Ja.min.set(L.x-vb,L.y-wb),Ja.max.set(L.x+vb,L.y+wb),!1===Ta.isIntersectionBox(Ja)?Ja.makeEmpty():(h(R.color.getStyle()),t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(vb,wb),t.fillRect(-1,-1,2,2),t.restore())):(da=R.map.image,Nc=da.width>>1,Oc=da.height>>1,vb=ua.scale.x*u,wb=ua.scale.y*x,ub=vb*Nc,eb=wb*Oc,Ja.min.set(L.x-ub,L.y-eb),Ja.max.set(L.x+ub,L.y+eb),
!1===Ta.isIntersectionBox(Ja)?Ja.makeEmpty():(t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(vb,-wb),t.translate(-Nc,-Oc),t.drawImage(da,0,0),t.restore())):R instanceof THREE.ParticleCanvasMaterial&&(ub=ua.scale.x*u,eb=ua.scale.y*x,Ja.min.set(L.x-ub,L.y-eb),Ja.max.set(L.x+ub,L.y+eb),!1===Ta.isIntersectionBox(Ja)?Ja.makeEmpty():(g(R.color.getStyle()),h(R.color.getStyle()),t.save(),t.translate(L.x,L.y),t.rotate(-ua.rotation),t.scale(ub,eb),R.program(t),t.restore()))}else if(da instanceof
THREE.RenderableLine)I=da.v1,M=da.v2,I.positionScreen.x*=u,I.positionScreen.y*=x,M.positionScreen.x*=u,M.positionScreen.y*=x,Ja.setFromPoints([I.positionScreen,M.positionScreen]),!0===Ta.isIntersectionBox(Ja)&&(L=I,ua=M,b(R.opacity),c(R.blending),t.beginPath(),t.moveTo(L.positionScreen.x,L.positionScreen.y),t.lineTo(ua.positionScreen.x,ua.positionScreen.y),R instanceof THREE.LineBasicMaterial?(d(R.linewidth),e(R.linecap),f(R.linejoin),g(R.color.getStyle()),t.stroke(),Ja.expandByScalar(2*R.linewidth)):
R instanceof THREE.LineDashedMaterial&&(d(R.linewidth),e(R.linecap),f(R.linejoin),g(R.color.getStyle()),i(R.dashSize,R.gapSize),t.stroke(),Ja.expandByScalar(2*R.linewidth),i(null,null)));else if(da instanceof THREE.RenderableFace3){I=da.v1;M=da.v2;U=da.v3;if(-1>I.positionScreen.z||1<I.positionScreen.z)continue;if(-1>M.positionScreen.z||1<M.positionScreen.z)continue;if(-1>U.positionScreen.z||1<U.positionScreen.z)continue;I.positionScreen.x*=u;I.positionScreen.y*=x;M.positionScreen.x*=u;M.positionScreen.y*=
x;U.positionScreen.x*=u;U.positionScreen.y*=x;!0===R.overdraw&&(G(I.positionScreen,M.positionScreen),G(M.positionScreen,U.positionScreen),G(U.positionScreen,I.positionScreen));Ja.setFromPoints([I.positionScreen,M.positionScreen,U.positionScreen]);!0===Ta.isIntersectionBox(Ja)&&z(I,M,U,0,1,2,da,R)}else if(da instanceof THREE.RenderableFace4){I=da.v1;M=da.v2;U=da.v3;ea=da.v4;if(-1>I.positionScreen.z||1<I.positionScreen.z)continue;if(-1>M.positionScreen.z||1<M.positionScreen.z)continue;if(-1>U.positionScreen.z||
1<U.positionScreen.z)continue;if(-1>ea.positionScreen.z||1<ea.positionScreen.z)continue;I.positionScreen.x*=u;I.positionScreen.y*=x;M.positionScreen.x*=u;M.positionScreen.y*=x;U.positionScreen.x*=u;U.positionScreen.y*=x;ea.positionScreen.x*=u;ea.positionScreen.y*=x;xa.positionScreen.copy(M.positionScreen);Ma.positionScreen.copy(ea.positionScreen);!0===R.overdraw&&(G(I.positionScreen,M.positionScreen),G(M.positionScreen,ea.positionScreen),G(ea.positionScreen,I.positionScreen),G(U.positionScreen,xa.positionScreen),
G(U.positionScreen,Ma.positionScreen));Ja.setFromPoints([I.positionScreen,M.positionScreen,U.positionScreen,ea.positionScreen]);!0===Ta.isIntersectionBox(Ja)&&(L=I,ua=M,ub=U,eb=ea,vb=xa,wb=Ma,m.info.render.vertices+=4,m.info.render.faces++,b(R.opacity),c(R.blending),void 0!==R.map&&null!==R.map||void 0!==R.envMap&&null!==R.envMap?(z(L,ua,eb,0,1,3,da,R),z(vb,ub,wb,1,2,3,da,R)):(A=L.positionScreen.x,ca=L.positionScreen.y,ha=ua.positionScreen.x,na=ua.positionScreen.y,N=ub.positionScreen.x,fa=ub.positionScreen.y,
jb=eb.positionScreen.x,Za=eb.positionScreen.y,db=vb.positionScreen.x,Ka=vb.positionScreen.y,pa=wb.positionScreen.x,ta=wb.positionScreen.y,R instanceof THREE.MeshLambertMaterial||R instanceof THREE.MeshPhongMaterial?(ga.copy(R.color),ka.copy(R.emissive),R.vertexColors===THREE.FaceColors&&ga.multiply(da.color),!1===R.wireframe&&R.shading==THREE.SmoothShading&&4==da.vertexNormalsLength?(la.copy(sb),W.copy(sb),V.copy(sb),ia.copy(sb),q(da.v1.positionWorld,da.vertexNormalsModel[0],la),q(da.v2.positionWorld,
da.vertexNormalsModel[1],W),q(da.v4.positionWorld,da.vertexNormalsModel[3],V),q(da.v3.positionWorld,da.vertexNormalsModel[2],ia),la.multiply(ga).add(ka),W.multiply(ga).add(ka),V.multiply(ga).add(ka),ia.multiply(ga).add(ka),Aa=H(la,W,V,ia),y(A,ca,ha,na,jb,Za),J(A,ca,ha,na,jb,Za,0,0,1,0,0,1,Aa),y(db,Ka,N,fa,pa,ta),J(db,Ka,N,fa,pa,ta,1,0,1,1,0,1,Aa)):(Z.copy(sb),q(da.centroidModel,da.normalModel,Z),Z.multiply(ga).add(ka),B(A,ca,ha,na,N,fa,jb,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,
R.wireframeLinejoin):F(Z))):R instanceof THREE.MeshBasicMaterial?(Z.copy(R.color),R.vertexColors===THREE.FaceColors&&Z.multiply(da.color),B(A,ca,ha,na,N,fa,jb,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):F(Z)):R instanceof THREE.MeshNormalMaterial?(L=void 0,R.shading==THREE.FlatShading?(L=da.normalModelView,Z.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),B(A,ca,ha,na,N,fa,jb,Za),!0===R.wireframe?E(Z,R.wireframeLinewidth,R.wireframeLinecap,R.wireframeLinejoin):
F(Z)):R.shading==THREE.SmoothShading&&(L=da.vertexNormalsModelView[0],la.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[1],W.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[3],V.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),L=da.vertexNormalsModelView[2],ia.setRGB(L.x,L.y,L.z).multiplyScalar(0.5).addScalar(0.5),Aa=H(la,W,V,ia),y(A,ca,ha,na,jb,Za),J(A,ca,ha,na,jb,Za,0,0,1,0,0,1,Aa),y(db,Ka,N,fa,pa,ta),J(db,Ka,N,fa,pa,ta,
1,0,1,1,0,1,Aa))):R instanceof THREE.MeshDepthMaterial&&(Wa=n.near,Ra=n.far,la.r=la.g=la.b=1-j(L.positionScreen.z*L.positionScreen.w,Wa,Ra),W.r=W.g=W.b=1-j(ua.positionScreen.z*ua.positionScreen.w,Wa,Ra),V.r=V.g=V.b=1-j(eb.positionScreen.z*eb.positionScreen.w,Wa,Ra),ia.r=ia.g=ia.b=1-j(ub.positionScreen.z*ub.positionScreen.w,Wa,Ra),Aa=H(la,W,V,ia),y(A,ca,ha,na,jb,Za),J(A,ca,ha,na,jb,Za,0,0,1,0,0,1,Aa),y(db,Ka,N,fa,pa,ta),J(db,Ka,N,fa,pa,ta,1,0,1,1,0,1,Aa))))}va.union(Ja)}}t.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
f=d.numMorphTargets;e<f;e++)k.deleteBuffer(d.__webglMorphTargetsBuffers[e]);if(void 0!==d.numMorphNormals){e=0;for(f=d.numMorphNormals;e<f;e++)k.deleteBuffer(d.__webglMorphNormalsBuffers[e])}b(d)}b(a);N.info.memory.geometries--},oc=function(a){a=a.target;a.removeEventListener("dispose",oc);a.image&&a.image.__webglTextureCube?k.deleteTexture(a.image.__webglTextureCube):a.__webglInit&&(a.__webglInit=!1,k.deleteTexture(a.__webglTexture));N.info.memory.textures--},R=function(a){a=a.target;a.removeEventListener("dispose",
R);if(a&&a.__webglTexture)if(k.deleteTexture(a.__webglTexture),a instanceof THREE.WebGLRenderTargetCube)for(var b=0;6>b;b++)k.deleteFramebuffer(a.__webglFramebuffer[b]),k.deleteRenderbuffer(a.__webglRenderbuffer[b]);else k.deleteFramebuffer(a.__webglFramebuffer),k.deleteRenderbuffer(a.__webglRenderbuffer);N.info.memory.textures--},pc=function(a){a=a.target;a.removeEventListener("dispose",pc);da(a)},da=function(a){var b=a.program;if(void 0!==b){a.program=void 0;var c,d,e=!1,a=0;for(c=fa.length;a<c;a++)if(d=
...
Ha,G))}if(Ub&&K){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],P=O.vertexColors,W=O.color,3===P.length&&K===THREE.VertexColors?(ha=P[0],ka=P[1],pa=P[2]):pa=ka=ha=W,cb[Oa]=ha.r,cb[Oa+1]=ha.g,cb[Oa+2]=ha.b,cb[Oa+3]=ka.r,cb[Oa+4]=ka.g,cb[Oa+5]=ka.b,cb[Oa+6]=pa.r,cb[Oa+7]=pa.g,cb[Oa+8]=pa.b,Oa+=9;D=0;for(A=sa.length;D<A;D++)O=ib[sa[D]],P=O.vertexColors,W=O.color,4===P.length&&K===THREE.VertexColors?(ha=P[0],ka=P[1],pa=P[2],na=P[3]):na=pa=ka=ha=W,cb[Oa]=ha.r,cb[Oa+1]=ha.g,cb[Oa+2]=ha.b,cb[Oa+3]=ka.r,cb[Oa+4]=
ka.g,cb[Oa+5]=ka.b,cb[Oa+6]=pa.r,cb[Oa+7]=pa.g,cb[Oa+8]=pa.b,cb[Oa+9]=na.r,cb[Oa+10]=na.g,cb[Oa+11]=na.b,Oa+=12;0<Oa&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglColorBuffer),k.bufferData(k.ARRAY_BUFFER,cb,G))}if(Tb&&nb.hasTangents){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Ba+=12;D=0;for(A=sa.length;D<
A;D++)O=ib[sa[D]],V=O.vertexTangents,ta=V[0],ca=V[1],da=V[2],Za=V[3],Fa[Ba]=ta.x,Fa[Ba+1]=ta.y,Fa[Ba+2]=ta.z,Fa[Ba+3]=ta.w,Fa[Ba+4]=ca.x,Fa[Ba+5]=ca.y,Fa[Ba+6]=ca.z,Fa[Ba+7]=ca.w,Fa[Ba+8]=da.x,Fa[Ba+9]=da.y,Fa[Ba+10]=da.z,Fa[Ba+11]=da.w,Fa[Ba+12]=Za.x,Fa[Ba+13]=Za.y,Fa[Ba+14]=Za.z,Fa[Ba+15]=Za.w,Ba+=16;k.bindBuffer(k.ARRAY_BUFFER,C.__webglTangentBuffer);k.bufferData(k.ARRAY_BUFFER,Fa,G)}if(Pb&&L){D=0;for(A=ra.length;D<A;D++)if(O=ib[ra[D]],U=O.vertexNormals,R=O.normal,3===U.length&&M)for(wa=0;3>wa;wa++)Ma=
U[wa],yb[hb]=Ma.x,yb[hb+1]=Ma.y,yb[hb+2]=Ma.z,hb+=3;else for(wa=0;3>wa;wa++)yb[hb]=R.x,yb[hb+1]=R.y,yb[hb+2]=R.z,hb+=3;D=0;for(A=sa.length;D<A;D++)if(O=ib[sa[D]],U=O.vertexNormals,R=O.normal,4===U.length&&M)for(wa=0;4>wa;wa++)Ma=U[wa],yb[hb]=Ma.x,yb[hb+1]=Ma.y,yb[hb+2]=Ma.z,hb+=3;else for(wa=0;4>wa;wa++)yb[hb]=R.x,yb[hb+1]=R.y,yb[hb+2]=R.z,hb+=3;k.bindBuffer(k.ARRAY_BUFFER,C.__webglNormalBuffer);k.bufferData(k.ARRAY_BUFFER,yb,G)}if(Lb&&Vb&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],Z=Vb[fa],void 0!==
Z)for(wa=0;3>wa;wa++)Ua=Z[wa],lb[Ta]=Ua.x,lb[Ta+1]=Ua.y,Ta+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],Z=Vb[fa],void 0!==Z)for(wa=0;4>wa;wa++)Ua=Z[wa],lb[Ta]=Ua.x,lb[Ta+1]=Ua.y,Ta+=2;0<Ta&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUVBuffer),k.bufferData(k.ARRAY_BUFFER,lb,G))}if(Lb&&Pc&&N){D=0;for(A=ra.length;D<A;D++)if(fa=ra[D],la=Pc[fa],void 0!==la)for(wa=0;3>wa;wa++)Wa=la[wa],rb[Va]=Wa.x,rb[Va+1]=Wa.y,Va+=2;D=0;for(A=sa.length;D<A;D++)if(fa=sa[D],la=Pc[fa],void 0!==la)for(wa=0;4>wa;wa++)Wa=la[wa],rb[Va]=
Wa.x,rb[Va+1]=Wa.y,Va+=2;0<Va&&(k.bindBuffer(k.ARRAY_BUFFER,C.__webglUV2Buffer),k.bufferData(k.ARRAY_BUFFER,rb,G))}if(Ob){D=0;for(A=ra.length;D<A;D++)Gb[xb]=La,Gb[xb+1]=La+1,Gb[xb+2]=La+2,xb+=3,tb[mb]=La,tb[mb+1]=La+1,tb[mb+2]=La,tb[mb+3]=La+2,tb[mb+4]=La+1,tb[mb+5]=La+2,mb+=6,La+=3;D=0;for(A=sa.length;D<A;D++)Gb[xb]=La,Gb[xb+1]=La+1,Gb[xb+2]=La+3,Gb[xb+3]=La+1,Gb[xb+4]=La+2,Gb[xb+5]=La+3,xb+=6,tb[mb]=La,tb[mb+1]=La+1,tb[mb+2]=La,tb[mb+3]=La+3,tb[mb+4]=La+1,tb[mb+5]=La+2,tb[mb+6]=La+2,tb[mb+7]=La+
3,mb+=8,La+=4;k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglFaceBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,Gb,G);k.bindBuffer(k.ELEMENT_ARRAY_BUFFER,C.__webglLineBuffer);k.bufferData(k.ELEMENT_ARRAY_BUFFER,tb,G)}if(Db){wa=0;for($a=Db.length;wa<$a;wa++)if(v=Db[wa],v.__original.needsUpdate){w=0;if(1===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],w+=3;D=0;for(A=sa.length;D<A;D++)O=
ib[sa[D]],v.array[w]=v.value[O.a],v.array[w+1]=v.value[O.b],v.array[w+2]=v.value[O.c],v.array[w+3]=v.value[O.d],w+=4}else{if("faces"===v.boundTo){D=0;for(A=ra.length;D<A;D++)ya=v.value[ra[D]],v.array[w]=ya,v.array[w+1]=ya,v.array[w+2]=ya,w+=3;D=0;for(A=sa.length;D<A;D++)ya=v.value[sa[D]],v.array[w]=ya,v.array[w+1]=ya,v.array[w+2]=ya,v.array[w+3]=ya,w+=4}}else if(2===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],
...
4]=Q.x,v.array[w+5]=Q.y,w+=6;D=0;for(A=sa.length;D<A;D++)aa=Q=T=S=ya=v.value[sa[D]],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=T.x,v.array[w+3]=T.y,v.array[w+4]=Q.x,v.array[w+5]=Q.y,v.array[w+6]=aa.x,v.array[w+7]=aa.y,w+=8}}else if(3===v.size){var X;X="c"===v.type?["r","g","b"]:["x","y","z"];if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S[X[0]],v.array[w+1]=S[X[1]],v.array[w+2]=S[X[2]],v.array[w+3]=
...
T[X[0]],v.array[w+4]=T[X[1]],v.array[w+5]=T[X[2]],v.array[w+6]=Q[X[0]],v.array[w+7]=Q[X[1]],v.array[w+8]=Q[X[2]],v.array[w+9]=aa[X[0]],v.array[w+10]=aa[X[1]],v.array[w+11]=aa[X[2]],w+=12}}else if(4===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){D=0;for(A=ra.length;D<A;D++)O=ib[ra[D]],S=v.value[O.a],T=v.value[O.b],Q=v.value[O.c],v.array[w]=S.x,v.array[w+1]=S.y,v.array[w+2]=S.z,v.array[w+3]=S.w,v.array[w+4]=T.x,v.array[w+5]=T.y,v.array[w+6]=T.z,v.array[w+7]=T.w,v.array[w+8]=Q.x,v.array[w+9]=
...
Mc=Ab.colorsNeedUpdate,cd=Ab.lineDistancesNeedUpdate,Rc=Ab.__webglCustomAttributesList,Ec=void 0,Zc=void 0,gb=void 0,ac=void 0,pb=void 0,Ea=void 0;if(Ab.verticesNeedUpdate){for(kc=0;kc<Jc;kc++)Ac=Vc[kc],Ia=3*kc,Cc[Ia]=Ac.x,Cc[Ia+1]=Ac.y,Cc[Ia+2]=Ac.z;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglVertexBuffer);k.bufferData(k.ARRAY_BUFFER,Cc,zc)}if(Mc){for(lc=0;lc<Kc;lc++)Bc=Wc[lc],Ia=3*lc,Dc[Ia]=Bc.r,Dc[Ia+1]=Bc.g,Dc[Ia+2]=Bc.b;k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglColorBuffer);k.bufferData(k.ARRAY_BUFFER,
Dc,zc)}if(cd){for(mc=0;mc<Lc;mc++)Yc[mc]=Xc[mc];k.bindBuffer(k.ARRAY_BUFFER,Ab.__webglLineDistanceBuffer);k.bufferData(k.ARRAY_BUFFER,Yc,zc)}if(Rc){Ec=0;for(Zc=Rc.length;Ec<Zc;Ec++)if(Ea=Rc[Ec],Ea.needsUpdate&&(void 0===Ea.boundTo||"vertices"===Ea.boundTo)){Ia=0;ac=Ea.value.length;if(1===Ea.size)for(gb=0;gb<ac;gb++)Ea.array[gb]=Ea.value[gb];else if(2===Ea.size)for(gb=0;gb<ac;gb++)pb=Ea.value[gb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ia+=2;else if(3===Ea.size)if("c"===Ea.type)for(gb=0;gb<ac;gb++)pb=
Ea.value[gb],Ea.array[Ia]=pb.r,Ea.array[Ia+1]=pb.g,Ea.array[Ia+2]=pb.b,Ia+=3;else for(gb=0;gb<ac;gb++)pb=Ea.value[gb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ea.array[Ia+2]=pb.z,Ia+=3;else if(4===Ea.size)for(gb=0;gb<ac;gb++)pb=Ea.value[gb],Ea.array[Ia]=pb.x,Ea.array[Ia+1]=pb.y,Ea.array[Ia+2]=pb.z,Ea.array[Ia+3]=pb.w,Ia+=4;k.bindBuffer(k.ARRAY_BUFFER,Ea.buffer);k.bufferData(k.ARRAY_BUFFER,Ea.array,zc)}}}j.verticesNeedUpdate=!1;j.colorsNeedUpdate=!1;j.lineDistancesNeedUpdate=!1;n.attributes&&y(n)}else if(i instanceof
...
y);for(y=0;y<c.maxMorphNormals;y++)t.push("morphNormal"+y);for(j in b)t.push(j);j=t;y=0;for(b=j.length;y<b;y++)t=j[y],u.attributes[t]=k.getAttribLocation(u,t);u.id=jb++;fa.push({program:u,code:p,usedTimes:1});N.info.memory.programs=fa.length;j=u}a.program=j;y=a.program.attributes;if(a.morphTargets){a.numSupportedMorphTargets=0;b="morphTarget";for(j=0;j<this.maxMorphTargets;j++)u=b+j,0<=y[u]&&a.numSupportedMorphTargets++}if(a.morphNormals){a.numSupportedMorphNormals=0;b="morphNormal";for(j=0;j<this.maxMorphNormals;j++)u=
