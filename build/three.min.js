...
m}}var g=a.faces,q=a.vertices,m=a.normals,l=a.colors,j=0;if(a.uvs)for(e=0;e<a.uvs.length;e++)a.uvs[e].length&&j++;for(e=0;e<j;e++){d.faceUvs[e]=[];d.faceVertexUvs[e]=[]}n=0;for(p=q.length;n<p;){var o=new THREE.Vector3;o.x=q[n++]*f;o.y=q[n++]*f;o.z=q[n++]*f;d.vertices.push(o)}n=0;for(p=g.length;n<p;){var t=g[n++],r=t&2,e=t&4,u=t&8,v=t&16,q=t&32,s=t&64,o=t&128;if(t&1){t=new THREE.Face4;t.a=g[n++];t.b=g[n++];t.c=g[n++];t.d=g[n++];var A=4}else{t=new THREE.Face3;t.a=g[n++];t.b=g[n++];t.c=g[n++];A=3}if(r){r=
g[n++];t.materialIndex=r}var x=d.faces.length;if(e)for(e=0;e<j;e++){var B=a.uvs[e],r=g[n++],C=B[r*2],r=B[r*2+1];d.faceUvs[e][x]=new THREE.UV(C,r)}if(u)for(e=0;e<j;e++){for(var B=a.uvs[e],u=[],z=0;z<A;z++){r=g[n++];C=B[r*2];r=B[r*2+1];u[z]=new THREE.UV(C,r)}d.faceVertexUvs[e][x]=u}if(v){v=g[n++]*3;r=new THREE.Vector3;r.x=m[v++];r.y=m[v++];r.z=m[v];t.normal=r}if(q)for(e=0;e<A;e++){v=g[n++]*3;r=new THREE.Vector3;r.x=m[v++];r.y=m[v++];r.z=m[v];t.vertexNormals.push(r)}if(s){q=g[n++];t.color=new THREE.Color(l[q])}if(o)for(e=
...
a.morphTargets[e].name;d.morphTargets[e].vertices=[];m=d.morphTargets[e].vertices;l=a.morphTargets[e].vertices;r=0;for(j=l.length;r<j;r=r+3){o=new THREE.Vector3;o.x=l[r]*f;o.y=l[r+1]*f;o.z=l[r+2]*f;m.push(o)}}}if(a.morphColors){e=0;for(g=a.morphColors.length;e<g;e++){d.morphColors[e]={};d.morphColors[e].name=a.morphColors[e].name;d.morphColors[e].colors=[];f=d.morphColors[e].colors;l=a.morphColors[e].colors;m=0;for(j=l.length;m<j;m=m+3){n=new THREE.Color(16755200);n.setRGB(l[m],l[m+1],l[m+2]);f.push(n)}}}d.computeCentroids();
...
false){f(Y.color.getContextStyle());o.save();o.translate(da.x,da.y);o.rotate(-oa.rotation);o.scale(jb,kb);o.fillRect(-1,-1,2,2);o.restore()}}else{Wb=Y.map.image;A=Wb.width>>1;Tc=Wb.height>>1;jb=oa.scale.x*p;kb=oa.scale.y*q;Ea=jb*A;tb=kb*Tc;xa.set(da.x-Ea,da.y-tb,da.x+Ea,da.y+tb);if(fb.intersects(xa)!==false){o.save();o.translate(da.x,da.y);o.rotate(-oa.rotation);o.scale(jb,-kb);o.translate(-A,-Tc);o.drawImage(Wb,0,0);o.restore()}}else if(Y instanceof THREE.ParticleCanvasMaterial){Ea=oa.scale.x*p;
tb=oa.scale.y*q;xa.set(da.x-Ea,da.y-tb,da.x+Ea,da.y+tb);if(fb.intersects(xa)!==false){d(Y.color.getContextStyle());f(Y.color.getContextStyle());o.save();o.translate(da.x,da.y);o.rotate(-oa.rotation);o.scale(Ea,tb);Y.program(o);o.restore()}}}else if(A instanceof THREE.RenderableLine){z=A.v1;F=A.v2;z.positionScreen.x=z.positionScreen.x*p;z.positionScreen.y=z.positionScreen.y*q;F.positionScreen.x=F.positionScreen.x*p;F.positionScreen.y=F.positionScreen.y*q;xa.addPoint(z.positionScreen.x,z.positionScreen.y);
xa.addPoint(F.positionScreen.x,F.positionScreen.y);if(fb.intersects(xa)===true){da=z;oa=F;b(Y.opacity);c(Y.blending);o.beginPath();o.moveTo(da.positionScreen.x,da.positionScreen.y);o.lineTo(oa.positionScreen.x,oa.positionScreen.y);if(Y instanceof THREE.LineBasicMaterial){da=Y.linewidth;if(x!==da)x=o.lineWidth=da;da=Y.linecap;if(B!==da)B=o.lineCap=da;da=Y.linejoin;if(C!==da)C=o.lineJoin=da;d(Y.color.getContextStyle());o.stroke();xa.inflate(Y.linewidth*2)}}}else if(A instanceof THREE.RenderableFace3){z=
...
H.positionScreen.y);fb.intersects(xa)===true&&n(z,F,H,0,1,2,A,Y,a)}else if(A instanceof THREE.RenderableFace4){z=A.v1;F=A.v2;H=A.v3;K=A.v4;z.positionScreen.x=z.positionScreen.x*p;z.positionScreen.y=z.positionScreen.y*q;F.positionScreen.x=F.positionScreen.x*p;F.positionScreen.y=F.positionScreen.y*q;H.positionScreen.x=H.positionScreen.x*p;H.positionScreen.y=H.positionScreen.y*q;K.positionScreen.x=K.positionScreen.x*p;K.positionScreen.y=K.positionScreen.y*q;E.positionScreen.copy(F.positionScreen);L.positionScreen.copy(K.positionScreen);
...
if(f.receiveShadow&&!d._shadowPass&&i.shadowMatrix){c=ba=0;for(e=b.length;c<e;c++){j=b[c];if(j.castShadow&&(j instanceof THREE.SpotLight||j instanceof THREE.DirectionalLight&&!j.shadowCascade)){i.shadowMap.value[ba]=j.shadowMap;i.shadowMapSize.value[ba]=j.shadowMapSize;i.shadowMatrix.value[ba]=j.shadowMatrix;i.shadowDarkness.value[ba]=j.shadowDarkness;i.shadowBias.value[ba]=j.shadowBias;ba++}}}b=d.uniformsList;i=0;for(ba=b.length;i<ba;i++)if(e=g.uniforms[b[i][1]]){c=b[i][0];l=c.type;j=c.value;if(l===
...
false,a=0;for(c=ba.length;a<c;a++){d=ba[a];if(d.program===b){d.usedTimes--;d.usedTimes===0&&(f=true);break}}if(f){f=[];a=0;for(c=ba.length;a<c;a++){d=ba[a];d.program!==b&&f.push(d)}ba=f;k.deleteProgram(b);Q.info.memory.programs--}}};this.updateShadowMap=function(a,b){fa=null;S=X=Ya=Oa=Ja=-1;hb=true;Ca=ua=-1;this.shadowMapPlugin.update(a,b)};this.renderBufferImmediate=function(a,b,c){if(a.hasPositions&&!a.__webglVertexBuffer)a.__webglVertexBuffer=k.createBuffer();if(a.hasNormals&&!a.__webglNormalBuffer)a.__webglNormalBuffer=
...
f.attributes.index.buffer)}k.drawElements(k.TRIANGLES,e[d].count,k.UNSIGNED_SHORT,e[d].start*2);Q.info.render.calls++;Q.info.render.vertices=Q.info.render.vertices+e[d].count;Q.info.render.faces=Q.info.render.faces+e[d].count/3}}else if(e instanceof THREE.ParticleSystem&&b){h=f.attributes.position;i=h.itemSize;k.bindBuffer(k.ARRAY_BUFFER,h.buffer);k.vertexAttribPointer(a.position,i,k.FLOAT,false,0,0);i=f.attributes.color;if(a.color>=0&&i){j=i.itemSize;k.bindBuffer(k.ARRAY_BUFFER,i.buffer);k.vertexAttribPointer(a.color,
...
e,0,d,a.width,a.height,0,d,f,null);var g=a,h=k.TEXTURE_CUBE_MAP_POSITIVE_X+e;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer[e]);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,h,g.__webglTexture,0);H(a.__webglRenderbuffer[e],a)}c&&k.generateMipmap(k.TEXTURE_CUBE_MAP)}else{a.__webglFramebuffer=k.createFramebuffer();a.__webglRenderbuffer=k.createRenderbuffer();k.bindTexture(k.TEXTURE_2D,a.__webglTexture);F(k.TEXTURE_2D,a,c);k.texImage2D(k.TEXTURE_2D,0,d,a.width,a.height,0,d,f,null);d=
k.TEXTURE_2D;k.bindFramebuffer(k.FRAMEBUFFER,a.__webglFramebuffer);k.framebufferTexture2D(k.FRAMEBUFFER,k.COLOR_ATTACHMENT0,d,a.__webglTexture,0);H(a.__webglRenderbuffer,a);c&&k.generateMipmap(k.TEXTURE_2D)}b?k.bindTexture(k.TEXTURE_CUBE_MAP,null):k.bindTexture(k.TEXTURE_2D,null);k.bindRenderbuffer(k.RENDERBUFFER,null);k.bindFramebuffer(k.FRAMEBUFFER,null)}if(a){b=b?a.__webglFramebuffer[a.activeCubeFace]:a.__webglFramebuffer;c=a.width;a=a.height;f=d=0}else{b=null;c=Ga;a=$a;d=xa;f=xb}if(b!==$){k.bindFramebuffer(k.FRAMEBUFFER,
b);k.viewport(d,f,c,a);$=b}rb=c;Da=a};this.shadowMapPlugin=new THREE.ShadowMapPlugin;this.addPrePlugin(this.shadowMapPlugin);this.addPostPlugin(new THREE.SpritePlugin);this.addPostPlugin(new THREE.LensFlarePlugin)};
