var onDocumentLoad = function ( event ) {
	...
	text = text.replace(/\[page:(\w+) ([\w|\.\s]+)\]/gi, "<a href=\"javascript:window.parent.goTo('$1')\" title=\"$1\" id=\"$2\">$2</a>" ); // [page:name title]
	...
	text = text.replace(/\[member:([\w\.]+) ([\w\.\s]+)\]/gi, "<a href=\"javascript:window.parent.goTo('$1')\" title=\"$1\">$2</a>" );
