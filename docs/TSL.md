...
| `instance( matrices, colors = null )` | Applies standard instancing setup with explicit instance matrix and optional color buffers. | `void` |
| `instancedMesh( instancedMesh )` | Applies standard instancing setup for an InstancedMesh. | `void` |
